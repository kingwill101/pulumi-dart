...
Future<void> main() async {
  final code = await DeploymentImpl.run(() {
    stderr.writeln(
        "[PROGRAM_STEP1] Creating Component with replacementTrigger='test'");

    final options = ComponentResourceOptions(replacementTrigger: 'test');
    stderr.writeln('[PROGRAM_STEP1] Options created');
    ...
    stderr.writeln('[PROGRAM_STEP1] Component created');
  });
