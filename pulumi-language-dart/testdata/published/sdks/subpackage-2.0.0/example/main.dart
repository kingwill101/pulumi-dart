...
import 'package:pulumi_subpackage/providers.dart' as provider;

class SubpackageStack extends pulumi.Stack {
  SubpackageStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => SubpackageStack());
}
