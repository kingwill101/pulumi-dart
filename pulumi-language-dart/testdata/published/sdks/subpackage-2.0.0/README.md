...
Dart SDK for the Pulumi subpackage provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/subpackage/)
...
~~~sh
dart pub add pulumi_subpackage
~~~
...
import 'package:pulumi_subpackage/pulumi_subpackage.dart' as provider;
~~~
