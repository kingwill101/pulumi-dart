...
import 'package:pulumi_reservednames/providers.dart' as provider;

class ReservednamesStack extends pulumi.Stack {
  ReservednamesStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => ReservednamesStack());
}
