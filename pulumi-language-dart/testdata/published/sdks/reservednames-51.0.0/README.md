...
Dart SDK for the Pulumi reservednames provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/reservednames/)
...
~~~sh
dart pub add pulumi_reservednames
~~~
...
import 'package:pulumi_reservednames/pulumi_reservednames.dart' as provider;
~~~
...
dependencies:
  pulumi_reservednames:
    git:
      ...
      path: packages/sdks/reservednames
      ref: master
~~~
