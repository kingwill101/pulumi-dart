...
Dart SDK for the Pulumi nestedcollections provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/nestedcollections/)
...
~~~sh
dart pub add pulumi_nestedcollections
~~~
...
dependencies:
  pulumi_nestedcollections:
    git:
      ...
      path: packages/sdks/nestedcollections
      ref: master
~~~
