...
import 'package:pulumi_component_property_deps/providers.dart' as provider;

class ComponentPropertyDepsStack extends pulumi.Stack {
  ComponentPropertyDepsStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => ComponentPropertyDepsStack());
}
