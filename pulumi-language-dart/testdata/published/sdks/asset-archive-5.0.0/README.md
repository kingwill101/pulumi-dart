...
Dart SDK for the Pulumi asset-archive provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/asset-archive/)
...
~~~sh
dart pub add pulumi_asset_archive
~~~
...
import 'package:pulumi_asset_archive/pulumi_asset_archive.dart' as provider;
~~~
...
dependencies:
  pulumi_asset_archive:
    git:
      ...
      path: packages/sdks/asset-archive
      ref: master
~~~
