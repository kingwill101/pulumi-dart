...
Dart SDK for the Pulumi configurer provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/configurer/)
...
~~~sh
dart pub add pulumi_configurer
~~~
