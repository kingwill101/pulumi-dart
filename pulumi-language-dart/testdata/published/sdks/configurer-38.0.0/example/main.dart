...
import 'package:pulumi_configurer/providers.dart' as provider;

class ConfigurerStack extends pulumi.Stack {
  ConfigurerStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => ConfigurerStack());
}
