...
class ToSecretArgs {
  ...
  factory ToSecretArgs.fromMap(Map<String, dynamic> map) {
    return ToSecretArgs(
      ...
      int1: (() { final guardedValue = map['int1']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      int2: (() { final guardedValue = map['int2']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      int3: (() { final guardedValue = map['int3']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      secretInt1: (() { final guardedValue = map['secretInt1']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      secretInt2: (() { final guardedValue = map['secretInt2']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      secretInt3: (() { final guardedValue = map['secretInt3']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
