...
Dart SDK for the Pulumi config-grpc provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/config-grpc/)
...
~~~sh
dart pub add pulumi_config_grpc
~~~
...
dependencies:
  pulumi_config_grpc:
    git:
      ...
      path: packages/sdks/config-grpc
      ref: master
~~~
