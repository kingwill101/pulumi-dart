# pulumi_discriminated_union_many

Dart SDK for the Pulumi discriminated-union-many provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/discriminated-union-many/)
...
~~~sh
dart pub add pulumi_discriminated_union_many
~~~
...
dependencies:
  pulumi_discriminated_union_many:
    git:
      ...
      path: packages/sdks/discriminated-union-many
      ref: master
~~~
