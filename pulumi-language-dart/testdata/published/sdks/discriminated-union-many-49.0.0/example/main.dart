...
import 'package:pulumi_discriminated_union_many/providers.dart' as provider;

class DiscriminatedUnionManyStack extends pulumi.Stack {
  DiscriminatedUnionManyStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => DiscriminatedUnionManyStack());
}
