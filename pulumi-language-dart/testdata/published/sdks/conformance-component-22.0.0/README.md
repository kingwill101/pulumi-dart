# pulumi_conformance_component

Dart SDK for the Pulumi conformance-component provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/conformance-component/)
...
~~~sh
dart pub add pulumi_conformance_component
~~~
...
dependencies:
  pulumi_conformance_component:
    git:
      ...
      path: packages/sdks/conformance-component
      ref: master
~~~
