...
import 'package:pulumi_conformance_component/providers.dart' as provider;

class ConformanceComponentStack extends pulumi.Stack {
  ConformanceComponentStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => ConformanceComponentStack());
}
