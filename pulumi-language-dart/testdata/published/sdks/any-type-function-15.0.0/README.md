# pulumi_any_type_function

Dart SDK for the Pulumi any-type-function provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/any-type-function/)
...
~~~sh
dart pub add pulumi_any_type_function
~~~
...
import 'package:pulumi_any_type_function/pulumi_any_type_function.dart' as provider;
~~~
...
dependencies:
  pulumi_any_type_function:
    git:
      ...
      path: packages/sdks/any-type-function
      ref: master
~~~
