...
Dart SDK for the Pulumi plaincomponent provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/plaincomponent/)
...
~~~sh
dart pub add pulumi_plaincomponent
~~~
...
dependencies:
  pulumi_plaincomponent:
    git:
      ...
      path: packages/sdks/plaincomponent
      ref: master
~~~
