...
Dart SDK for the Pulumi optionalprimitive provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/optionalprimitive/)
...
~~~sh
dart pub add pulumi_optionalprimitive
~~~
...
dependencies:
  pulumi_optionalprimitive:
    git:
      ...
      path: packages/sdks/optionalprimitive
      ref: master
~~~
