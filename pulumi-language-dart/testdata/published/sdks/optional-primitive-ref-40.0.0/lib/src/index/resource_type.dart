...
class ResourceType extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Data?> optionalData;
  ...
  ResourceType(
    ...
    optionalData = registerOutput<Data?>('optionalData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return Data.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
