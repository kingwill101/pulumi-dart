...
import 'package:pulumi_optional_primitive_ref/providers.dart' as provider;

class OptionalPrimitiveRefStack extends pulumi.Stack {
  OptionalPrimitiveRefStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => OptionalPrimitiveRefStack());
}
