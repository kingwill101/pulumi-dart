...
Dart SDK for the Pulumi primitive-ref provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/primitive-ref/)
...
~~~sh
dart pub add pulumi_primitive_ref
~~~
...
dependencies:
  pulumi_primitive_ref:
    git:
      ...
      path: packages/sdks/primitive-ref
      ref: master
~~~
