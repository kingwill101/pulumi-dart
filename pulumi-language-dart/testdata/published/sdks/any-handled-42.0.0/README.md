...
Dart SDK for the Pulumi any-handled provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/any-handled/)
...
~~~sh
dart pub add pulumi_any_handled
~~~
...
import 'package:pulumi_any_handled/pulumi_any_handled.dart' as provider;
~~~
...
dependencies:
  pulumi_any_handled:
    git:
      ...
      path: packages/sdks/any-handled
      ref: master
~~~
