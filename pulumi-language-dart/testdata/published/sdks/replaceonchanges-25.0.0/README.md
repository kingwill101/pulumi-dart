# pulumi_replaceonchanges

Dart SDK for the Pulumi replaceonchanges provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/replaceonchanges/)
...
~~~sh
dart pub add pulumi_replaceonchanges
~~~
...
dependencies:
  pulumi_replaceonchanges:
    git:
      ...
      path: packages/sdks/replaceonchanges
      ref: master
~~~
