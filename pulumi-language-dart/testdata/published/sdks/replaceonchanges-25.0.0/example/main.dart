...
import 'package:pulumi_replaceonchanges/providers.dart' as provider;

class ReplaceonchangesStack extends pulumi.Stack {
  ReplaceonchangesStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => ReplaceonchangesStack());
}
