# pulumi_scalar_returns

Dart SDK for the Pulumi scalar-returns provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/scalar-returns/)
...
~~~sh
dart pub add pulumi_scalar_returns
~~~
...
dependencies:
  pulumi_scalar_returns:
    git:
      ...
      path: packages/sdks/scalar-returns
      ref: master
~~~
