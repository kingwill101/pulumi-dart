...
import 'package:pulumi_bytesource/providers.dart' as provider;

class BytesourceStack extends pulumi.Stack {
  BytesourceStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => BytesourceStack());
}
