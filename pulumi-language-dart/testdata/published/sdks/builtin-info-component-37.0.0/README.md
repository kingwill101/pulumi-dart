...
Dart SDK for the Pulumi builtin-info-component provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/builtin-info-component/)
...
~~~sh
dart pub add pulumi_builtin_info_component
~~~
...
dependencies:
  pulumi_builtin_info_component:
    git:
      ...
      path: packages/sdks/builtin-info-component
      ref: master
~~~
