...
import 'package:pulumi_builtin_info_component/providers.dart' as provider;

class BuiltinInfoComponentStack extends pulumi.Stack {
  BuiltinInfoComponentStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => BuiltinInfoComponentStack());
}
