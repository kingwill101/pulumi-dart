...
import 'package:pulumi_multi_argument_invoke/providers.dart' as provider;

class MultiArgumentInvokeStack extends pulumi.Stack {
  MultiArgumentInvokeStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => MultiArgumentInvokeStack());
}
