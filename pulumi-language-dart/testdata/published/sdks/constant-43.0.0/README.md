...
Dart SDK for the Pulumi constant provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/constant/)
...
import 'package:pulumi_constant/pulumi_constant.dart' as provider;
~~~
