...
import 'package:pulumi_simple_invoke/providers.dart' as provider;

class SimpleInvokeStack extends pulumi.Stack {
  SimpleInvokeStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => SimpleInvokeStack());
}
