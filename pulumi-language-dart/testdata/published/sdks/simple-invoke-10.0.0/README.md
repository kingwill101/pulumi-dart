# pulumi_simple_invoke

Dart SDK for the Pulumi simple-invoke provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/simple-invoke/)
...
~~~sh
dart pub add pulumi_simple_invoke
~~~
...
import 'package:pulumi_simple_invoke/pulumi_simple_invoke.dart' as provider;
~~~
...
dependencies:
  pulumi_simple_invoke:
    git:
      ...
      path: packages/sdks/simple-invoke
      ref: master
~~~
