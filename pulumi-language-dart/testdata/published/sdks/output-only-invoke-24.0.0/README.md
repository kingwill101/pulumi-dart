...
Dart SDK for the Pulumi output-only-invoke provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/output-only-invoke/)
...
~~~sh
dart pub add pulumi_output_only_invoke
~~~
...
dependencies:
  pulumi_output_only_invoke:
    git:
      ...
      path: packages/sdks/output-only-invoke
      ref: master
~~~
