...
import 'package:pulumi_output_only_invoke/providers.dart' as provider;

class OutputOnlyInvokeStack extends pulumi.Stack {
  OutputOnlyInvokeStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => OutputOnlyInvokeStack());
}
