...
Dart SDK for the Pulumi config provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/config/)
...
import 'package:pulumi_config/pulumi_config.dart' as provider;
~~~
