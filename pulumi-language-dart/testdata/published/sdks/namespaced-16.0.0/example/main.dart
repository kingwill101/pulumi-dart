...
import 'package:pulumi_a_namespace_namespaced/providers.dart' as provider;

class ANamespaceNamespacedStack extends pulumi.Stack {
  ANamespaceNamespacedStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => ANamespaceNamespacedStack());
}
