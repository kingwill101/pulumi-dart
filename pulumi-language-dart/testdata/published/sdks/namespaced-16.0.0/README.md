# pulumi_a_namespace_namespaced

Dart SDK for the Pulumi namespaced provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/namespaced/)
...
~~~sh
dart pub add pulumi_a_namespace_namespaced
~~~
