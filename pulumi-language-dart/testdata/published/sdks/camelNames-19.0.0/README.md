...
Dart SDK for the Pulumi camelNames provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/camelNames/)
...
~~~sh
dart pub add pulumi_camelnames
~~~
