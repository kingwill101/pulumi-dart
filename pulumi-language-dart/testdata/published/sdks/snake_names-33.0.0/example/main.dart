...
import 'package:pulumi_snake_names/providers.dart' as provider;

class SnakeNamesStack extends pulumi.Stack {
  SnakeNamesStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => SnakeNamesStack());
}
