...
Dart SDK for the Pulumi snake_names provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/snake_names/)
...
~~~sh
dart pub add pulumi_snake_names
~~~
...
dependencies:
  pulumi_snake_names:
    git:
      ...
      path: packages/sdks/snake_names
      ref: master
~~~
