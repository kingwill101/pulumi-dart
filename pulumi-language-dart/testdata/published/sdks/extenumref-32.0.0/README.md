...
Dart SDK for the Pulumi extenumref provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/extenumref/)
...
~~~sh
dart pub add pulumi_extenumref
~~~
...
import 'package:pulumi_extenumref/pulumi_extenumref.dart' as provider;
~~~
