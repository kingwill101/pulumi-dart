...
import 'package:pulumi_extenumref/providers.dart' as provider;

class ExtenumrefStack extends pulumi.Stack {
  ExtenumrefStack() {
...
Future<void> main() async {
  await pulumi.Deployment.runOrThrow(() => ExtenumrefStack());
}
