# pulumi_simple_invoke_with_scalar_return

Dart SDK for the Pulumi simple-invoke-with-scalar-return provider.

Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/simple-invoke-with-scalar-return/)
...
~~~sh
dart pub add pulumi_simple_invoke_with_scalar_return
~~~
...
dependencies:
  pulumi_simple_invoke_with_scalar_return:
    git:
      ...
      path: packages/sdks/simple-invoke-with-scalar-return
      ref: master
~~~
