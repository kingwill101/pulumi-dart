...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    _outputProperties = [
      pulumi.OutputProperty('inv', pulumi.output(pulumi_simple_invoke_index.myInvokeOutput(pulumi_simple_invoke_index.MyInvokeArgs(value: ('test').input())).apply<dynamic>((value) => value.result)).apply<Object?>((value) => value)),
    ];
  }
