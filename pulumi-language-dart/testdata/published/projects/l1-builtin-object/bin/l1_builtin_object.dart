...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    _outputProperties = [
      ...
      pulumi.OutputProperty('names', pulumi.output([for (final entry in (pulumi.mapEntries(alternativeNames) as Iterable)) pulumi.indexValue(entry, 'value')]).apply<Object?>((value) => value)),
    ];
  }
