...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    final res = pulumi_conformance_component_index.Simple('res', args: pulumi_conformance_component_index.SimpleArgs(value: (true).input(), ), options: pulumi.ComponentResourceOptions(replacementTrigger: 'trigger-value', ));
