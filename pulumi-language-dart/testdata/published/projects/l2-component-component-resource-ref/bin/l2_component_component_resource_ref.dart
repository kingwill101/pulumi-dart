...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    final custom1 = component_index.Custom('custom1', args: component_index.CustomArgs(value: (pulumi.output(component2.inputRef.apply<dynamic>((value) => value?.value)).apply<String>((value) => value as String)).input(), ));
    final custom2 = component_index.Custom('custom2', args: component_index.CustomArgs(value: (pulumi.output(component2.outputRef.apply<dynamic>((value) => value?.value)).apply<String>((value) => value as String)).input(), ));
