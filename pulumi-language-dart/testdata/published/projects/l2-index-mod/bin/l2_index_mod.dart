...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    _outputProperties = [
      ...
      pulumi.OutputProperty('out2', pulumi.output(pulumi.output(res2.call(args: pulumi_index_mod_index_mine.ResourceCallArgs(input: ('xx').input()))).apply((value) => value.output)).apply<Object?>((value) => value)),
    ];
  }
