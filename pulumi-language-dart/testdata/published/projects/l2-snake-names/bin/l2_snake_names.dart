...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    final third = pulumi_snake_names_cool_module.AnotherResource('third', args: pulumi_snake_names_cool_module.AnotherResourceArgs(theInput: pulumi.Input.asInput(pulumi.output(pulumi_snake_names_cool_module.someDataOutput(pulumi_snake_names_cool_module.SomeDataArgs(theInput: (pulumi.output(pulumi.output(first.theOutput.apply<dynamic>((value) => pulumi.indexValue(pulumi.indexValue(value, 'someKey'), 0)?.nestedOutput)).apply<String>((value) => (value).toString())).apply<String>((value) => value as String)).input(), nested: (pulumi.output(<pulumi_snake_names_cool_module.Entry>[pulumi_snake_names_cool_module.Entry(value: ('fuzz').input())]).apply<List<Entry>>((value) => (value as List).cast<Entry>())).input())).apply<dynamic>((value) => pulumi.indexValue(pulumi.indexValue(value.nestedOutput, 0), 'key').value)).apply<String>((value) => (value).toString())), ));
