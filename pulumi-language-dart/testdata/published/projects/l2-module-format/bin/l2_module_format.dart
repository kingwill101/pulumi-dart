...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    final res1 = pulumi_module_format_mod_resource.ResourceType('res1', args: pulumi_module_format_mod_resource.ResourceArgs(text: (pulumi.output(pulumi_module_format_mod_concat_world.concatWorldOutput(pulumi_module_format_mod_concat_world.ConcatWorldArgs(value: ('hello').input())).apply((value) => value.result)).apply<String>((value) => (value).toString())).input(), ));
    final res2 = pulumi_module_format_mod_resource.ResourceType('res2', args: pulumi_module_format_mod_resource.ResourceArgs(text: (pulumi.output(pulumi_module_format_mod_concat_world.concatWorldOutput(pulumi_module_format_mod_concat_world.ConcatWorldArgs(value: ('goodbye').input())).apply((value) => value.result)).apply<String>((value) => (value).toString())).input(), ));
    final res3 = pulumi_module_format_mod.ResourceType('res3', args: pulumi_module_format_mod.ResourceArgs(text: (pulumi.output(pulumi_module_format_mod.concatWorldOutput(pulumi_module_format_mod.ConcatWorldArgs(value: ('hello').input())).apply((value) => value.result)).apply<String>((value) => (value).toString())).input(), ));
    final res4 = pulumi_module_format_mod.ResourceType('res4', args: pulumi_module_format_mod.ResourceArgs(text: (pulumi.output(pulumi_module_format_mod.concatWorldOutput(pulumi_module_format_mod.ConcatWorldArgs(value: ('goodbye').input())).apply((value) => value.result)).apply<String>((value) => (value).toString())).input(), ));
    final res5 = pulumi_module_format_index_resource.ResourceType('res5', args: pulumi_module_format_index_resource.ResourceArgs(text: (pulumi.output(pulumi_module_format_index_concat_world.concatWorldOutput(pulumi_module_format_index_concat_world.ConcatWorldArgs(value: ('bonjour').input())).apply((value) => value.result)).apply<String>((value) => (value).toString())).input(), ));
    final res6 = pulumi_module_format_index_resource.ResourceType('res6', args: pulumi_module_format_index_resource.ResourceArgs(text: (pulumi.output(pulumi_module_format_index_concat_world.concatWorldOutput(pulumi_module_format_index_concat_world.ConcatWorldArgs(value: ('youkoso').input())).apply((value) => value.result)).apply<String>((value) => (value).toString())).input(), ));
    final res7 = pulumi_module_format_index_resource.ResourceType('res7', args: pulumi_module_format_index_resource.ResourceArgs(text: (pulumi.output(pulumi_module_format_index_concat_world.concatWorldOutput(pulumi_module_format_index_concat_world.ConcatWorldArgs(value: ('guten tag').input())).apply((value) => value.result)).apply<String>((value) => (value).toString())).input(), ));
