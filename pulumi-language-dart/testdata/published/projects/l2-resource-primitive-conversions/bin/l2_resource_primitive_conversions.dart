...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    final invokeResult = pulumi_primitive_index.invokeOutput(pulumi_primitive_index.InvokeArgs(boolean: (pulumi.output(bool.parse(plainString)).apply<bool>((value) => value as bool)).input(), float: (pulumi.output((plainInteger).toDouble()).apply<double>((value) => value as double)).input(), integer: (pulumi.output(int.parse(plainNumericString)).apply<int>((value) => value as int)).input(), string_: (pulumi.output((plainBool).toString()).apply<String>((value) => value as String)).input(), numberArray: (pulumi.output(<double>[(plainInteger).toDouble(), double.parse(plainNumericString), (plainNumber).toDouble()]).apply<List<double>>((value) => (value as List).cast<double>())).input(), booleanMap: (pulumi.output(<String, bool>{'fromBool': plainBool, 'fromString': bool.parse(plainString)}).apply<Map<String, bool>>((value) => (value as Map).cast<String, bool>())).input()));
