...
class KeywordComponent extends pulumi.ComponentResource {
  ...
  KeywordComponent(String name, {required KeywordComponentArgs args, pulumi.ComponentResourceOptions? options})
      : super('components:index:KeywordComponent', name, pulumi.Input.mapToInputs(args.toMap()), options) {
...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    final comp = KeywordComponent('comp', args: KeywordComponentArgs(input: (pulumi.output(true).apply<bool>((value) => value as bool)).input(), ));
