...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    final custom1 = pulumi_component_property_deps_index.Custom('custom1', args: pulumi_component_property_deps_index.CustomArgs(value: ('hello').input(), ));
    final custom2 = pulumi_component_property_deps_index.Custom('custom2', args: pulumi_component_property_deps_index.CustomArgs(value: ('world').input(), ));
    final component1 = pulumi_component_property_deps_index.Component('component1', args: pulumi_component_property_deps_index.ComponentArgs(resource: (pulumi.output(custom1).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input(), resourceList: (pulumi.inputList<pulumi_component_property_deps_index.Custom>(<pulumi.Input<pulumi_component_property_deps_index.Custom>>[(pulumi.output(custom1).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input(), (pulumi.output(custom2).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input()]) as pulumi.Input<List<pulumi_component_property_deps_index.Custom>>).input(), resourceMap: (pulumi.inputMap<pulumi_component_property_deps_index.Custom>(<String, pulumi.Input<pulumi_component_property_deps_index.Custom>>{'one': (pulumi.output(custom1).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input(), 'two': (pulumi.output(custom2).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input()}) as pulumi.Input<Map<String, pulumi_component_property_deps_index.Custom>>).input(), ));

    _outputProperties = [
      pulumi.OutputProperty('propertyDepsFromCall', pulumi.output(pulumi.output(component1.refs(args: pulumi_component_property_deps_index.ComponentRefsArgs(resource: (pulumi.output(custom1).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input(), resourceList: (pulumi.inputList<pulumi_component_property_deps_index.Custom>(<pulumi.Input<pulumi_component_property_deps_index.Custom>>[(pulumi.output(custom1).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input(), (pulumi.output(custom2).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input()]) as pulumi.Input<List<pulumi_component_property_deps_index.Custom>>).input(), resourceMap: (pulumi.inputMap<pulumi_component_property_deps_index.Custom>(<String, pulumi.Input<pulumi_component_property_deps_index.Custom>>{'one': (pulumi.output(custom1).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input(), 'two': (pulumi.output(custom2).apply<pulumi_component_property_deps_index.Custom>((value) => value!)).input()}) as pulumi.Input<Map<String, pulumi_component_property_deps_index.Custom>>).input()))).apply((value) => value.result)).apply<Object?>((value) => value)),
    ];
  }
