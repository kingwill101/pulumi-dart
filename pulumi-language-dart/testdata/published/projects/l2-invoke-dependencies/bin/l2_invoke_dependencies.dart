...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    final data = pulumi_simple_invoke_index.getTextOutput(pulumi_simple_invoke_index.GetTextArgs(text: (pulumi.output(pulumi.output(third.text).apply<String>((value) => (value).toString())).apply<String>((value) => value as String)).input()));
