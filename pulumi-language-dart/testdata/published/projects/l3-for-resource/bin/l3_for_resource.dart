...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    final mapped = pulumi_nestedobject_index.MapContainer('mapped', args: pulumi_nestedobject_index.MapContainerArgs(tags: pulumi.Input.asInput(pulumi.output(pulumi.output(source.details).apply((collection) => {for (final (resource3, detail3) in (collection as Iterable).indexed) detail3.key: detail3.value})).apply<Map<String, String>>((value) => (value as Map).cast<String, String>())), ));
