...
class GeneratedStack extends pulumi.Stack {
  ...
  GeneratedStack() {
    ...
    _outputProperties = [
      ...
      pulumi.OutputProperty('firstSecret', pulumi.output(pulumi_simple_invoke_index.secretInvokeOutput(pulumi_simple_invoke_index.SecretInvokeArgs(value: ('hello').input(), secretResponse: (pulumi.output(pulumi.output(res.value).apply<bool>((value) => value is String ? bool.parse((value).toString()) : value as bool)).apply<bool>((value) => value as bool)).input())).apply<dynamic>((value) => value.response)).apply<Object?>((value) => value)),
      pulumi.OutputProperty('secondSecret', pulumi.output(pulumi_simple_invoke_index.secretInvokeOutput(pulumi_simple_invoke_index.SecretInvokeArgs(value: (pulumi.output(pulumi.output(pulumi.secret('goodbye')).apply<String>((value) => (value).toString())).apply<String>((value) => value as String)).input(), secretResponse: (false).input())).apply<dynamic>((value) => value.response)).apply<Object?>((value) => value)),
    ];
  }
