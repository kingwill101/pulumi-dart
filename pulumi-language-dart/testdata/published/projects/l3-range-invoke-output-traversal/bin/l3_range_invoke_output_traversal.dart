...
class GeneratedStack extends pulumi.Stack {
  ...
  Future<void> initialize() async {
    ...
    final values = pulumi_nestedobject_index.getValuesOutput(pulumi_nestedobject_index.GetValuesArgs(names: (pulumi.output(pulumi.output(source.inputs).apply<List<String>>((value) => (value as List).cast<String>())).apply<List<String>>((value) => (value as List).cast<String>())).input()));
