...
// DeterminePulumiPackages takes a map of dependencies and returns a slice of slices, where each inner slice contains the name and version of any Pulumi or Pulumi-related packages found in the dependencies.
