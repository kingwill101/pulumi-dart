...
func TestDotNetAliasesRename(t *testing.T) {
	testDartProgram(t, aliasesTestOptions("rename"))
}

func TestDotNetAliasesAdoptIntoComponent(t *testing.T) {
	testDartProgram(t, aliasesTestOptions("adopt_into_component"))
}

func TestDotNetAliasesRenameComponentAndChild(t *testing.T) {
	testDartProgram(t, aliasesTestOptions("rename_component_and_child"))
}

func TestDotNetAliasesRetypeComponent(t *testing.T) {
	testDartProgram(t, aliasesTestOptions("retype_component"))
}

func TestDotNetAliasesRenameComponent(t *testing.T) {
	testDartProgram(t, aliasesTestOptions("rename_component"))
}

func TestDotNetAliasesRetypeParents(t *testing.T) {
	testDartProgram(t, aliasesTestOptions("retype_parents"))
}
