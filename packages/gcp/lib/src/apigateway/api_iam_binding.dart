...
import 'api_iam_binding_args.dart';
...
class ApiIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ApiIamBindingCondition?> condition;
  ...
  /// Creates a new [ApiIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApiIamBinding]. {@macro pulumi_apigateway_api_iam_binding_api_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ApiIamBinding(
    String name, {
    ApiIamBindingArgs? args,
    ...
    this.condition = registerOutput<ApiIamBindingCondition?>('condition');
