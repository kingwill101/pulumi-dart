...
class ApiConfigArgs {
  ...
  ApiConfigArgs({
    ...
    String? project,
        ...
        apiConfigIdPrefix =
            pulumi.Input.asOptionalInput<String>(apiConfigIdPrefix),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        gatewayConfig =
            pulumi.Input.asOptionalInput<ApiConfigGatewayConfig>(gatewayConfig),
  ...
  factory ApiConfigArgs.fromMap(Map<String, dynamic> map) {
    return ApiConfigArgs(
      ...
      apiConfigId:
          map['apiConfigId'] == null ? null : map['apiConfigId'] as String,
      apiConfigIdPrefix: map['apiConfigIdPrefix'] == null
          ? null
          : map['apiConfigIdPrefix'] as String,
      displayName:
