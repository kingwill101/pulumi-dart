...
class ApiConfigArgs {
  ...
  ApiConfigArgs({
    required String api,
    String? apiConfigId,
    String? apiConfigIdPrefix,
    String? displayName,
    ApiConfigGatewayConfig? gatewayConfig,
    List<ApiConfigGrpcService>? grpcServices,
    Map<String, String>? labels,
    List<ApiConfigManagedServiceConfig>? managedServiceConfigs,
    List<ApiConfigOpenapiDocument>? openapiDocuments,
    String? project,
  }) :
  ...
  factory ApiConfigArgs.fromMap(Map<String, dynamic> map) {
    return ApiConfigArgs(
      ...
      apiConfigId: map['apiConfigId'] == null ? null : map['apiConfigId'] as String,
      apiConfigIdPrefix: map['apiConfigIdPrefix'] == null ? null : map['apiConfigIdPrefix'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      gatewayConfig: map['gatewayConfig'] == null ? null : ApiConfigGatewayConfig.fromMap((map['gatewayConfig'] as Map).cast<String, dynamic>()),
      grpcServices: map['grpcServices'] == null ? null : pulumi.Input.decodeList<ApiConfigGrpcService>(map['grpcServices'], (value) => ApiConfigGrpcService.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      managedServiceConfigs: map['managedServiceConfigs'] == null ? null : pulumi.Input.decodeList<ApiConfigManagedServiceConfig>(map['managedServiceConfigs'], (value) => ApiConfigManagedServiceConfig.fromMap((value as Map).cast<String, dynamic>())),
      openapiDocuments: map['openapiDocuments'] == null ? null : pulumi.Input.decodeList<ApiConfigOpenapiDocument>(map['openapiDocuments'], (value) => ApiConfigOpenapiDocument.fromMap((value as Map).cast<String, dynamic>())),
