...
class ApiConfig extends pulumi.CustomResource {
  ...
  ApiConfig(
    ...
    this.gatewayConfig = registerOutput<ApiConfigGatewayConfig?>(
      'gatewayConfig',
    );
    this.grpcServices = registerOutput<List<ApiConfigGrpcService>?>(
      'grpcServices',
    );
    ...
    this.openapiDocuments = registerOutput<List<ApiConfigOpenapiDocument>?>(
      'openapiDocuments',
    );
