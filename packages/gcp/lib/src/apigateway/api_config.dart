...
class ApiConfig extends pulumi.CustomResource {
  ...
  ApiConfig(
    ...
    this.gatewayConfig = registerOutput<ApiConfigGatewayConfig?>('gatewayConfig');
    this.grpcServices = registerOutput<List<ApiConfigGrpcService>?>('grpcServices');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.managedServiceConfigs = registerOutput<List<ApiConfigManagedServiceConfig>?>('managedServiceConfigs');
    this.name = registerOutput<String>('name');
    this.openapiDocuments = registerOutput<List<ApiConfigOpenapiDocument>?>('openapiDocuments');
