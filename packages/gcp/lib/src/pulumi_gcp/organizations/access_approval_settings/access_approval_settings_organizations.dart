...
import 'access_approval_settings_organizations_args.dart';
...
/// ```
class AccessApprovalSettingsOrganizations extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<AccessApprovalSettingsEnrolledServiceOrganizations>>
      enrolledServices;
  ...
  AccessApprovalSettingsOrganizations(
    String name, {
    AccessApprovalSettingsOrganizationsArgs? args,
    ...
    this.enrolledServices = registerOutput<
