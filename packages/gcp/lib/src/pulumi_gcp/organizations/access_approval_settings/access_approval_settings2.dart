...
class AccessApprovalSettings2 extends CustomResource {
  ...
  /// "> active_key_version
  /// </span>configured on this Organization (e.g. it doesn't exist or the Access Approval service account doesn't have the
  ...
  AccessApprovalSettings2(
    ...
    this.enrolledServices =
        Output.createUnknown<List<AccessApprovalSettingsEnrolledService2>>();
