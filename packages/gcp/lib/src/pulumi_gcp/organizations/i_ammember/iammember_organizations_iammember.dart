...
import 'iammember_organizations_iammember_args.dart';
...
/// ```
class IAMMemberOrganizationsIAmmember extends pulumi.CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<IAMMemberConditionOrganizations?> condition;
  ...
  IAMMemberOrganizationsIAmmember(
    String name, {
    IAMMemberOrganizationsIAmmemberArgs? args,
    ...
    this.condition =
        registerOutput<IAMMemberConditionOrganizations?>('condition');
