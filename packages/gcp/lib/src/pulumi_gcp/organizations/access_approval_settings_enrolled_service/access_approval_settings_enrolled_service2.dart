...
class AccessApprovalSettingsEnrolledService2 {
  ...
  AccessApprovalSettingsEnrolledService2({
  ...
  factory AccessApprovalSettingsEnrolledService2.fromMap(
      Map<String, dynamic> map) {
    return AccessApprovalSettingsEnrolledService2(
