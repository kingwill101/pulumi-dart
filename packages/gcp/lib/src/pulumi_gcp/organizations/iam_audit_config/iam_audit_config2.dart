...
import 'iam_audit_config_args2.dart';
...
/// ```
class IamAuditConfig2 extends CustomResource {
  /// The configuration for logging of each type of permission.  This can be specified multiple times.  Structure is documented below.
  late final Output<List<IamAuditConfigAuditLogConfig2>> auditLogConfigs;
