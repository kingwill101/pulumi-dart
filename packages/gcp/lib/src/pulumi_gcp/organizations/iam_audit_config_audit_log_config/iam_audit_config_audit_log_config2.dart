...
class IamAuditConfigAuditLogConfig2 {
  ...
  factory IamAuditConfigAuditLogConfig2.fromMap(Map<String, dynamic> map) {
    return IamAuditConfigAuditLogConfig2(
