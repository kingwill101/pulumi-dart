...
class IamAuditConfigAuditLogConfigOrganizations {
  ...
  factory IamAuditConfigAuditLogConfigOrganizations.fromMap(
      Map<String, dynamic> map) {
    return IamAuditConfigAuditLogConfigOrganizations(
