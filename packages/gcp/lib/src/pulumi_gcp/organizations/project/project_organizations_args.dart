...
class ProjectOrganizationsArgs {
  ...
  factory ProjectOrganizationsArgs.fromMap(Map<String, dynamic> map) {
    return ProjectOrganizationsArgs(
      autoCreateNetwork:
          pulumi.Input.asOptionalInput<bool>(map['autoCreateNetwork']),
      billingAccount:
          pulumi.Input.asOptionalInput<String>(map['billingAccount']),
      deletionPolicy:
          pulumi.Input.asOptionalInput<String>(map['deletionPolicy']),
      folderId: pulumi.Input.asOptionalInput<String>(map['folderId']),
