...
class Trigger2 extends CustomResource {
  ...
  late final Output<TriggerDestination> destination;
  ...
  /// Structure is documented below.
  late final Output<List<TriggerMatchingCriteria>> matchingCriterias;
  ...
  /// Structure is documented below.
  late final Output<TriggerRetryPolicy?> retryPolicy;
  ...
  /// Structure is documented below.
  late final Output<TriggerTransport> transport;
