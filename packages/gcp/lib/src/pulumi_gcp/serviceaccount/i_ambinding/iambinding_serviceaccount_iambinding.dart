...
import 'iambinding_serviceaccount_iambinding_args.dart';
...
/// ```
class IAMBindingServiceaccountIAmbinding extends pulumi.CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<IAMBindingConditionServiceaccount?> condition;
  ...
  IAMBindingServiceaccountIAmbinding(
    String name, {
    IAMBindingServiceaccountIAmbindingArgs? args,
    ...
    this.condition =
        registerOutput<IAMBindingConditionServiceaccount?>('condition');
