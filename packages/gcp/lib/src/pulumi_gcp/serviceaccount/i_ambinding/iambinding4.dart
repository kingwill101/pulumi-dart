...
/// ```
class IAMBinding4 extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<IAMBindingCondition4?> condition;
  ...
  IAMBinding4(
    ...
    this.condition = registerOutput<IAMBindingCondition4?>('condition');
