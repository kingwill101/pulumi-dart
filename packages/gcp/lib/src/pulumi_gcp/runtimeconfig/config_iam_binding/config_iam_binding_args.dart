...
import '../config_iam_binding_condition/config_iam_binding_condition.dart';

/// The set of arguments for ConfigIamBinding.
class ConfigIamBindingArgs {
  final Input<ConfigIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<ConfigIamBindingCondition,
  ...
  factory ConfigIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConfigIamBindingArgs(
      condition:
          Input.asOptionalInput<ConfigIamBindingCondition>(map['condition']),
