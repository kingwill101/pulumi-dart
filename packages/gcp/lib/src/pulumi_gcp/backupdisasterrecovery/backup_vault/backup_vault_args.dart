...
class BackupVaultArgs {
  ...
  factory BackupVaultArgs.fromMap(Map<String, dynamic> map) {
    return BackupVaultArgs(
      accessRestriction:
          pulumi.Input.asOptionalInput<String>(map['accessRestriction']),
      allowMissing: pulumi.Input.asOptionalInput<bool>(map['allowMissing']),
      annotations:
      ...
      backupRetentionInheritance: pulumi.Input.asOptionalInput<String>(
          map['backupRetentionInheritance']),
      backupVaultId: pulumi.Input.asInput<String>(map['backupVaultId']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      effectiveTime: pulumi.Input.asOptionalInput<String>(map['effectiveTime']),
      encryptionConfig:
      ...
      ignoreBackupPlanReferences:
          pulumi.Input.asOptionalInput<bool>(map['ignoreBackupPlanReferences']),
      ignoreInactiveDatasources:
          pulumi.Input.asOptionalInput<bool>(map['ignoreInactiveDatasources']),
