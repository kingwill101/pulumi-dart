...
class GetGroupLookupArgs {
  ...
  final Input<GetGroupLookupGroupKey> groupKey;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['groupKey'] =
        Input.mapInputValue<GetGroupLookupGroupKey, Map<String, dynamic>>(
  ...
  factory GetGroupLookupArgs.fromMap(Map<String, dynamic> map) {
    return GetGroupLookupArgs(
      groupKey: Input.asInput<GetGroupLookupGroupKey>(map['groupKey']),
    );
  }
}
