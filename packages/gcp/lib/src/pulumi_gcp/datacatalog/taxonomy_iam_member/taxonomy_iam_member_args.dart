...
class TaxonomyIamMemberArgs {
  final Input<TaxonomyIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<TaxonomyIamMemberCondition,
  ...
  factory TaxonomyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return TaxonomyIamMemberArgs(
      condition:
          Input.asOptionalInput<TaxonomyIamMemberCondition>(map['condition']),
