...
/// > **Warning:** <span pulumi-lang-nodejs="`gcp.datacatalog.Entry`" pulumi-lang-dotnet="`gcp.datacatalog.Entry`" pulumi-lang-go="`datacatalog.Entry`" pulumi-lang-python="`datacatalog.Entry`" pulumi-lang-yaml="`gcp.datacatalog.Entry`" pulumi-lang-java="`gcp.datacatalog.Entry`">`gcp.datacatalog.Entry`</span> is deprecated and will be removed in a future major release. Data Catalog is deprecated and will be discontinued on January 30, 2026. For steps to transition your Data Catalog users, workloads, and content to Dataplex Catalog, see https://cloud.google.com/dataplex/docs/transition-to-dataplex-catalog.
///
...
class Entry extends CustomResource {
  ...
  late final Output<List<EntryBigqueryDateShardedSpec>>
      bigqueryDateShardedSpecs;

  /// Specification that applies to a BigQuery table. This is only valid on entries of type TABLE.
  /// Structure is documented below.
  late final Output<List<EntryBigqueryTableSpec>> bigqueryTableSpecs;
  ...
  /// Structure is documented below.
  late final Output<EntryGcsFilesetSpec?> gcsFilesetSpec;
