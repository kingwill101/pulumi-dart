...
/// > **Warning:** <span pulumi-lang-nodejs="`gcp.datacatalog.Tag`" pulumi-lang-dotnet="`gcp.datacatalog.Tag`" pulumi-lang-go="`datacatalog.Tag`" pulumi-lang-python="`datacatalog.Tag`" pulumi-lang-yaml="`gcp.datacatalog.Tag`" pulumi-lang-java="`gcp.datacatalog.Tag`">`gcp.datacatalog.Tag`</span> is deprecated and will be removed in a future major release. For steps to transition your Data Catalog users, workloads, and content to Dataplex Catalog, see https://cloud.google.com/dataplex/docs/transition-to-dataplex-catalog.
///
...
class Tag extends CustomResource {
  ...
  /// where<span pulumi-lang-nodejs=" tagId " pulumi-lang-dotnet=" TagId " pulumi-lang-go=" tagId " pulumi-lang-python=" tag_id " pulumi-lang-yaml=" tagId " pulumi-lang-java=" tagId "> tag_id </span>is a system-generated identifier. Note that this Tag may not actually be stored in the location in this name.
