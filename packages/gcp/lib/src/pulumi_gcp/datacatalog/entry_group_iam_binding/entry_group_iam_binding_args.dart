...
import '../entry_group_iam_binding_condition/entry_group_iam_binding_condition.dart';

/// The set of arguments for EntryGroupIamBinding.
class EntryGroupIamBindingArgs {
  final Input<EntryGroupIamBindingCondition>? condition;
  ...
  factory EntryGroupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamBindingArgs(
      condition: Input.asOptionalInput<EntryGroupIamBindingCondition>(
          map['condition']),
