...
class EntryGroupIamBinding extends CustomResource {
  late final Output<EntryGroupIamBindingCondition?> condition;
  ...
  EntryGroupIamBinding(
    ...
    this.condition = Output.createUnknown<EntryGroupIamBindingCondition?>();
