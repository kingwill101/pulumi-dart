...
import '../get_service_template/get_service_template_cloudrunv2.dart';
import '../get_service_terminal_condition/get_service_terminal_condition.dart';
import '../get_service_traffic/get_service_traffic_cloudrunv2.dart';
import '../get_service_traffic_status/get_service_traffic_status.dart';

/// Result data returned by getService.
class GetServiceCloudrunv2Result {
  ...
  final List<GetServiceTemplateCloudrunv2> templates;
  final List<GetServiceTerminalCondition> terminalConditions;
  final List<GetServiceTrafficStatus> trafficStatuses;
  final List<GetServiceTrafficCloudrunv2> traffics;
  final String uid;
  final String updateTime;
  final String uri;
  final List<String> urls;

  GetServiceCloudrunv2Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['templates'] = pulumi.Input.encodeList<GetServiceTemplateCloudrunv2,
        Map<String, dynamic>>(templates, (value) => value.toMap());
    ...
    map['traffics'] = pulumi.Input.encodeList<GetServiceTrafficCloudrunv2,
        Map<String, dynamic>>(traffics, (value) => value.toMap());
    map['uid'] = uid;
  ...
  factory GetServiceCloudrunv2Result.fromMap(Map<String, dynamic> map) {
    return GetServiceCloudrunv2Result(
      ...
      scalings: pulumi.Input.decodeList<GetServiceScaling>(
          ...
          (value) => GetServiceScaling.fromMap(
              (value as Map).cast<String, dynamic>())),
      templates: pulumi.Input.decodeList<GetServiceTemplateCloudrunv2>(
          map['templates'],
          (value) => GetServiceTemplateCloudrunv2.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      trafficStatuses: pulumi.Input.decodeList<GetServiceTrafficStatus>(
          ...
          (value) => GetServiceTrafficStatus.fromMap(
              (value as Map).cast<String, dynamic>())),
      traffics: pulumi.Input.decodeList<GetServiceTrafficCloudrunv2>(
          map['traffics'],
          (value) => GetServiceTrafficCloudrunv2.fromMap(
              (value as Map).cast<String, dynamic>())),
