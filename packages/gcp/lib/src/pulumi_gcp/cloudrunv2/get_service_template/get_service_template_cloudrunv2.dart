...
class GetServiceTemplateCloudrunv2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['containers'] = pulumi.Input.encodeList<GetServiceTemplateContainer,
    ...
    map['scalings'] = pulumi.Input.encodeList<GetServiceTemplateScaling,
        Map<String, dynamic>>(scalings, (value) => value.toMap());
    map['serviceAccount'] = serviceAccount;
    map['serviceMeshes'] = pulumi.Input.encodeList<
        GetServiceTemplateServiceMesh,
        Map<String, dynamic>>(serviceMeshes, (value) => value.toMap());
    map['sessionAffinity'] = sessionAffinity;
    map['timeout'] = timeout;
    map['volumes'] =
        pulumi.Input.encodeList<GetServiceTemplateVolume, Map<String, dynamic>>(
            volumes, (value) => value.toMap());
    map['vpcAccesses'] = pulumi.Input.encodeList<GetServiceTemplateVpcAccess,
        Map<String, dynamic>>(vpcAccesses, (value) => value.toMap());
    return map;
  }

  factory GetServiceTemplateCloudrunv2.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateCloudrunv2(
