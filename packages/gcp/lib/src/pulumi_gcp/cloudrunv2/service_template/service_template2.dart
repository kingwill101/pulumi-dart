...
class ServiceTemplate2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (containersValue != null) {
      map['containers'] =
          Input.encodeList<ServiceTemplateContainer, Map<String, dynamic>>(
    ...
    if (volumesValue != null) {
      map['volumes'] =
          Input.encodeList<ServiceTemplateVolume, Map<String, dynamic>>(
  ...
  factory ServiceTemplate2.fromMap(Map<String, dynamic> map) {
    return ServiceTemplate2(
      ...
      containers: map['containers'] == null
          ? null
          : Input.decodeList<ServiceTemplateContainer>(
              map['containers'],
      ...
      volumes: map['volumes'] == null
          ? null
          : Input.decodeList<ServiceTemplateVolume>(
              map['volumes'],
