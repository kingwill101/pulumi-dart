...
class WorkerPoolCloudrunv2Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (instanceSplitsValue != null) {
      map['instanceSplits'] = pulumi.Input.mapOptionalInputValue<
              List<WorkerPoolInstanceSplit>, List<Map<String, dynamic>>>(
          instanceSplitsValue,
          (value) => pulumi.Input.encodeList<WorkerPoolInstanceSplit,
    ...
    if (scalingValue != null) {
      map['scaling'] = pulumi.Input.mapOptionalInputValue<WorkerPoolScaling,
  ...
  factory WorkerPoolCloudrunv2Args.fromMap(Map<String, dynamic> map) {
    return WorkerPoolCloudrunv2Args(
      annotations:
          pulumi.Input.asOptionalInput<Map<String, String>>(map['annotations']),
      binaryAuthorization:
          pulumi.Input.asOptionalInput<WorkerPoolBinaryAuthorization>(
      ...
      instanceSplits:
          pulumi.Input.asOptionalInput<List<WorkerPoolInstanceSplit>>(
              map['instanceSplits']),
      ...
      scaling: pulumi.Input.asOptionalInput<WorkerPoolScaling>(map['scaling']),
      template: pulumi.Input.asInput<WorkerPoolTemplate>(map['template']),
    );
  }
}
