...
class ServiceIamMemberArgs {
  final Input<ServiceIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<ServiceIamMemberCondition,
  ...
  factory ServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberArgs(
      condition:
          Input.asOptionalInput<ServiceIamMemberCondition>(map['condition']),
