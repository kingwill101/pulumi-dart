...
import '../service_iam_member_condition/service_iam_member_condition.dart';
...
class ServiceIamMember extends CustomResource {
  late final Output<ServiceIamMemberCondition?> condition;
  ...
  /// <span pulumi-lang-nodejs="`gcp.cloudrunv2.ServiceIamBinding`" pulumi-lang-dotnet="`gcp.cloudrunv2.ServiceIamBinding`" pulumi-lang-go="`cloudrunv2.ServiceIamBinding`" pulumi-lang-python="`cloudrunv2.ServiceIamBinding`" pulumi-lang-yaml="`gcp.cloudrunv2.ServiceIamBinding`" pulumi-lang-java="`gcp.cloudrunv2.ServiceIamBinding`">`gcp.cloudrunv2.ServiceIamBinding`</span> can be used per role. Note that custom roles must be of the format
  ...
  ServiceIamMember(
    ...
    this.condition = registerOutput<ServiceIamMemberCondition?>('condition');
