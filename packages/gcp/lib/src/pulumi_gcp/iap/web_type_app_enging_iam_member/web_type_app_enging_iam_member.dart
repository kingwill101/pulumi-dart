...
import '../web_type_app_enging_iam_member_condition/web_type_app_enging_iam_member_condition.dart';
...
class WebTypeAppEngingIamMember extends pulumi.CustomResource {
  ...
  WebTypeAppEngingIamMember(
    ...
    this.condition =
        registerOutput<WebTypeAppEngingIamMemberCondition?>('condition');
