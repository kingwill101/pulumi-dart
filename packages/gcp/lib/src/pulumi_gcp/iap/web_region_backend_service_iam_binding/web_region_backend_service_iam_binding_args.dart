...
import '../web_region_backend_service_iam_binding_condition/web_region_backend_service_iam_binding_condition.dart';
  ...
  factory WebRegionBackendServiceIamBindingArgs.fromMap(
    ...
    return WebRegionBackendServiceIamBindingArgs(
      condition: pulumi.Input.asOptionalInput<
          WebRegionBackendServiceIamBindingCondition>(map['condition']),
