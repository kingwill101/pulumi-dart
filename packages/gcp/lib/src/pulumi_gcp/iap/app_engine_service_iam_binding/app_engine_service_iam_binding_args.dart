...
import '../app_engine_service_iam_binding_condition/app_engine_service_iam_binding_condition.dart';
...
class AppEngineServiceIamBindingArgs {
  ...
  factory AppEngineServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AppEngineServiceIamBindingArgs(
      ...
      condition: Input.asOptionalInput<AppEngineServiceIamBindingCondition>(
          map['condition']),
