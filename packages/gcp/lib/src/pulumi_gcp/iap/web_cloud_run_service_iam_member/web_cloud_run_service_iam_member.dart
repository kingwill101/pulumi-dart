...
import 'web_cloud_run_service_iam_member_args.dart';
...
class WebCloudRunServiceIamMember extends CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final Output<String> cloudRunServiceName;

  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<WebCloudRunServiceIamMemberCondition?> condition;
  ...
  WebCloudRunServiceIamMember(
    String name, {
    WebCloudRunServiceIamMemberArgs? args,
