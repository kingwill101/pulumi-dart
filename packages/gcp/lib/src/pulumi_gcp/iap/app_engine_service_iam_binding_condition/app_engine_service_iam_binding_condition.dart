...
class AppEngineServiceIamBindingCondition {
  ...
  factory AppEngineServiceIamBindingCondition.fromMap(
      Map<String, dynamic> map) {
    return AppEngineServiceIamBindingCondition(
      description:
