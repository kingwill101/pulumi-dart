...
import '../web_type_app_enging_iam_binding_condition/web_type_app_enging_iam_binding_condition.dart';
...
class WebTypeAppEngingIamBindingArgs {
  ...
  final Input<WebTypeAppEngingIamBindingCondition>? condition;
  ...
  factory WebTypeAppEngingIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WebTypeAppEngingIamBindingArgs(
      ...
      condition: Input.asOptionalInput<WebTypeAppEngingIamBindingCondition>(
          map['condition']),
