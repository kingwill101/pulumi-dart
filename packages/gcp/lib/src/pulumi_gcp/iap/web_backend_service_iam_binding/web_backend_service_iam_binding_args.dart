...
import '../web_backend_service_iam_binding_condition/web_backend_service_iam_binding_condition.dart';

/// The set of arguments for WebBackendServiceIamBinding.
class WebBackendServiceIamBindingArgs {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  final Input<WebBackendServiceIamBindingCondition>? condition;
  ...
  factory WebBackendServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WebBackendServiceIamBindingArgs(
      condition: Input.asOptionalInput<WebBackendServiceIamBindingCondition>(
          map['condition']),
