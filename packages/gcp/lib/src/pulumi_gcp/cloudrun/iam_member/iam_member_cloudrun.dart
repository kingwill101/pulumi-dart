...
import 'iam_member_cloudrun_args.dart';
...
class IamMemberCloudrun extends pulumi.CustomResource {
  late final pulumi.Output<IamMemberConditionCloudrun?> condition;
  ...
  IamMemberCloudrun(
    ...
    this.condition = registerOutput<IamMemberConditionCloudrun?>('condition');
