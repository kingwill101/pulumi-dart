...
import '../iam_member_condition/iam_member_condition_cloudrun.dart';

/// The set of arguments for IamMember.
class IamMemberCloudrunArgs {
  final pulumi.Input<IamMemberConditionCloudrun>? condition;
  ...
  factory IamMemberCloudrunArgs.fromMap(Map<String, dynamic> map) {
    return IamMemberCloudrunArgs(
      condition: pulumi.Input.asOptionalInput<IamMemberConditionCloudrun>(
          map['condition']),
