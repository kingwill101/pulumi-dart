...
///
/// > **Warning:** We recommend using the <span pulumi-lang-nodejs="`gcp.cloudrunv2.Service`" pulumi-lang-dotnet="`gcp.cloudrunv2.Service`" pulumi-lang-go="`cloudrunv2.Service`" pulumi-lang-python="`cloudrunv2.Service`" pulumi-lang-yaml="`gcp.cloudrunv2.Service`" pulumi-lang-java="`gcp.cloudrunv2.Service`">`gcp.cloudrunv2.Service`</span> resource which offers a better
