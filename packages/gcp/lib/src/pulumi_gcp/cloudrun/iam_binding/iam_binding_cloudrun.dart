...
import 'iam_binding_cloudrun_args.dart';
...
class IamBindingCloudrun extends pulumi.CustomResource {
  late final pulumi.Output<IamBindingConditionCloudrun?> condition;
  ...
  IamBindingCloudrun(
    ...
    this.condition = registerOutput<IamBindingConditionCloudrun?>('condition');
