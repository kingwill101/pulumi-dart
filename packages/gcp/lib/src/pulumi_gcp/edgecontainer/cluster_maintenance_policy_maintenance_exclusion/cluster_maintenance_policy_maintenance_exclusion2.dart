...
class ClusterMaintenancePolicyMaintenanceExclusion2 {
  ...
  factory ClusterMaintenancePolicyMaintenanceExclusion2.fromMap(
      Map<String, dynamic> map) {
    return ClusterMaintenancePolicyMaintenanceExclusion2(
