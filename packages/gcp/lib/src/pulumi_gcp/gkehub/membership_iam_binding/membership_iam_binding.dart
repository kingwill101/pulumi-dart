...
class MembershipIamBinding extends CustomResource {
  late final Output<MembershipIamBindingCondition?> condition;
  ...
  MembershipIamBinding(
    ...
    this.condition = Output.createUnknown<MembershipIamBindingCondition?>();
