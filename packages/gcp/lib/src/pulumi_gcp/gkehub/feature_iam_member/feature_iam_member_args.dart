...
class FeatureIamMemberArgs {
  final Input<FeatureIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<FeatureIamMemberCondition,
  ...
  factory FeatureIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return FeatureIamMemberArgs(
      condition:
          Input.asOptionalInput<FeatureIamMemberCondition>(map['condition']),
