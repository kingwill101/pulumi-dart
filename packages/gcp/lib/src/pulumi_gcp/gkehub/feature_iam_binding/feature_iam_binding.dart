...
import 'feature_iam_binding_args.dart';
...
class FeatureIamBinding extends CustomResource {
  late final Output<FeatureIamBindingCondition?> condition;
  ...
  FeatureIamBinding(
    ...
    this.condition = registerOutput<FeatureIamBindingCondition?>('condition');
