...
///
/// Quotes (`""`) must be added around your <span pulumi-lang-nodejs="`rrdatas`" pulumi-lang-dotnet="`Rrdatas`" pulumi-lang-go="`rrdatas`" pulumi-lang-python="`rrdatas`" pulumi-lang-yaml="`rrdatas`" pulumi-lang-java="`rrdatas`">`rrdatas`</span> for a SPF record. Otherwise <span pulumi-lang-nodejs="`rrdatas`" pulumi-lang-dotnet="`Rrdatas`" pulumi-lang-go="`rrdatas`" pulumi-lang-python="`rrdatas`" pulumi-lang-yaml="`rrdatas`" pulumi-lang-java="`rrdatas`">`rrdatas`</span> string gets split on spaces.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
///
/// The list of <span pulumi-lang-nodejs="`rrdatas`" pulumi-lang-dotnet="`Rrdatas`" pulumi-lang-go="`rrdatas`" pulumi-lang-python="`rrdatas`" pulumi-lang-yaml="`rrdatas`" pulumi-lang-java="`rrdatas`">`rrdatas`</span> should only contain a single string corresponding to the Canonical Name intended.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
