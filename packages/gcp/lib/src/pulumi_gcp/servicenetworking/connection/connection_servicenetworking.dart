...
import 'connection_servicenetworking_args.dart';
...
/// ```
class ConnectionServicenetworking extends pulumi.CustomResource {
  ...
  ConnectionServicenetworking(
    String name, {
    ConnectionServicenetworkingArgs? args,
