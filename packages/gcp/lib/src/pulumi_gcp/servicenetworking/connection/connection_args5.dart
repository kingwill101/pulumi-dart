...
class ConnectionArgs5 {
  ...
  final Input<List<String>> reservedPeeringRanges;
  ...
  final Input<bool>? updateOnCreationFail;
  ...
  factory ConnectionArgs5.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs5(
      ...
      reservedPeeringRanges:
          Input.asInput<List<String>>(map['reservedPeeringRanges']),
      service: Input.asInput<String>(map['service']),
      updateOnCreationFail:
          Input.asOptionalInput<bool>(map['updateOnCreationFail']),
    );
  }
}
