...
class Automation extends CustomResource {
  ...
  /// The<span pulumi-lang-nodejs=" deliveryPipeline " pulumi-lang-dotnet=" DeliveryPipeline " pulumi-lang-go=" deliveryPipeline " pulumi-lang-python=" delivery_pipeline " pulumi-lang-yaml=" deliveryPipeline " pulumi-lang-java=" deliveryPipeline "> delivery_pipeline </span>for the resource
  late final Output<String> deliveryPipeline;
  ...
  late final Output<List<AutomationRule>> rules;

  /// Required. Selected resources to which the automation will be applied.
  /// Structure is documented below.
  late final Output<AutomationSelector> selector;
  ...
  Automation(
    ...
    this.deliveryPipeline = Output.createUnknown<String>();
    ...
    this.rules = Output.createUnknown<List<AutomationRule>>();
    this.selector = Output.createUnknown<AutomationSelector>();
