...
import '../automation_rule_advance_rollout_rule/automation_rule_advance_rollout_rule.dart';
import '../automation_rule_promote_release_rule/automation_rule_promote_release_rule.dart';
import '../automation_rule_repair_rollout_rule/automation_rule_repair_rollout_rule.dart';
import '../automation_rule_timed_promote_release_rule/automation_rule_timed_promote_release_rule.dart';
...
class AutomationRule {
  ...
  Map<String, dynamic> toMap() {
    ...
    final timedPromoteReleaseRuleValue = timedPromoteReleaseRule;
    if (timedPromoteReleaseRuleValue != null) {
      map['timedPromoteReleaseRule'] = timedPromoteReleaseRuleValue.toMap();
    }
    return map;
  }
