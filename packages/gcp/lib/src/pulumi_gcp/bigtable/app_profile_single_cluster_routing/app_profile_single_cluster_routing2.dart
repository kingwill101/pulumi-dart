...
class AppProfileSingleClusterRouting2 {
  ...
  AppProfileSingleClusterRouting2({
  ...
  factory AppProfileSingleClusterRouting2.fromMap(Map<String, dynamic> map) {
    return AppProfileSingleClusterRouting2(
