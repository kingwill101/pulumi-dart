...
/// ```
class TableIamBinding extends CustomResource {
  late final Output<TableIamBindingCondition?> condition;
  ...
  TableIamBinding(
    ...
    this.condition = Output.createUnknown<TableIamBindingCondition?>();
