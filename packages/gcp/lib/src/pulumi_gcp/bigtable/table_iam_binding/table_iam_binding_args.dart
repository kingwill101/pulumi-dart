...
class TableIamBindingArgs {
  final Input<TableIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<TableIamBindingCondition,
  ...
  factory TableIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TableIamBindingArgs(
      condition:
          Input.asOptionalInput<TableIamBindingCondition>(map['condition']),
