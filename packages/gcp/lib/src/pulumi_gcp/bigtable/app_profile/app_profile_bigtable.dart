...
import 'app_profile_bigtable_args.dart';
...
/// ```
class AppProfileBigtable extends pulumi.CustomResource {
  /// The unique name of the app profile in the form `[_a-zA-Z0-9][-_.a-zA-Z0-9]*`.
  late final pulumi.Output<String> appProfileId;

  /// Specifies that this app profile is intended for read-only usage via the Data Boost feature.
  /// Structure is documented below.
  late final pulumi.Output<AppProfileDataBoostIsolationReadOnlyBigtable?>
  ...
  /// Structure is documented below.
  late final pulumi.Output<AppProfileSingleClusterRoutingBigtable?>
      singleClusterRouting;

  /// The standard options used for isolating this app profile's traffic from other use cases.
  /// Structure is documented below.
  late final pulumi.Output<AppProfileStandardIsolationBigtable>
      standardIsolation;

  AppProfileBigtable(
    String name, {
    AppProfileBigtableArgs? args,
    ...
    this.dataBoostIsolationReadOnly =
        registerOutput<AppProfileDataBoostIsolationReadOnlyBigtable?>(
            'dataBoostIsolationReadOnly');
    ...
    this.singleClusterRouting =
        registerOutput<AppProfileSingleClusterRoutingBigtable?>(
            'singleClusterRouting');
    this.standardIsolation =
        registerOutput<AppProfileStandardIsolationBigtable>(
            'standardIsolation');
  }
}
