...
import '../app_profile_data_boost_isolation_read_only/app_profile_data_boost_isolation_read_only_bigtable.dart';
import '../app_profile_single_cluster_routing/app_profile_single_cluster_routing_bigtable.dart';
import '../app_profile_standard_isolation/app_profile_standard_isolation_bigtable.dart';

/// The set of arguments for AppProfile.
class AppProfileBigtableArgs {
  /// The unique name of the app profile in the form `[_a-zA-Z0-9][-_.a-zA-Z0-9]*`.
  final pulumi.Input<String> appProfileId;

  /// Specifies that this app profile is intended for read-only usage via the Data Boost feature.
  /// Structure is documented below.
  final pulumi.Input<AppProfileDataBoostIsolationReadOnlyBigtable>?
  ...
  /// Structure is documented below.
  final pulumi.Input<AppProfileSingleClusterRoutingBigtable>?
      singleClusterRouting;

  /// The standard options used for isolating this app profile's traffic from other use cases.
  /// Structure is documented below.
  final pulumi.Input<AppProfileStandardIsolationBigtable>? standardIsolation;

  AppProfileBigtableArgs({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (singleClusterRoutingValue != null) {
      map['singleClusterRouting'] = pulumi.Input.mapOptionalInputValue<
              AppProfileSingleClusterRoutingBigtable, Map<String, dynamic>>(
    ...
    if (standardIsolationValue != null) {
      map['standardIsolation'] = pulumi.Input.mapOptionalInputValue<
              AppProfileStandardIsolationBigtable, Map<String, dynamic>>(
          standardIsolationValue, (value) => value.toMap());
    }
    return map;
  }

  factory AppProfileBigtableArgs.fromMap(Map<String, dynamic> map) {
    return AppProfileBigtableArgs(
      appProfileId: pulumi.Input.asInput<String>(map['appProfileId']),
      dataBoostIsolationReadOnly: pulumi.Input.asOptionalInput<
              AppProfileDataBoostIsolationReadOnlyBigtable>(
      ...
      singleClusterRouting:
          pulumi.Input.asOptionalInput<AppProfileSingleClusterRoutingBigtable>(
              map['singleClusterRouting']),
      standardIsolation:
          pulumi.Input.asOptionalInput<AppProfileStandardIsolationBigtable>(
