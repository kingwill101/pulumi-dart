...
/// ```
class AppProfile2 extends CustomResource {
  /// The unique name of the app profile in the form `[_a-zA-Z0-9][-_.a-zA-Z0-9]*`.
  late final Output<String> appProfileId;

  /// Specifies that this app profile is intended for read-only usage via the Data Boost feature.
  /// Structure is documented below.
  late final Output<AppProfileDataBoostIsolationReadOnly2?>
  ...
  late final Output<List<String>?> multiClusterRoutingClusterIds;

  /// If true, read/write requests are routed to the nearest cluster in the instance, and will fail over to the nearest cluster that is available
  /// in the event of transient errors or delays. Clusters in a region are considered equidistant. Choosing this option sacrifices read-your-writes
  /// consistency to improve availability.
  late final Output<bool?> multiClusterRoutingUseAny;
  ...
  late final Output<bool?> rowAffinity;

  /// Use a single-cluster routing policy.
  /// Structure is documented below.
  late final Output<AppProfileSingleClusterRouting2?> singleClusterRouting;

  /// The standard options used for isolating this app profile's traffic from other use cases.
  /// Structure is documented below.
  late final Output<AppProfileStandardIsolation2> standardIsolation;

  AppProfile2(
    String name, {
    AppProfileArgs2? args,
    ...
    this.dataBoostIsolationReadOnly =
        Output.createUnknown<AppProfileDataBoostIsolationReadOnly2?>();
    ...
    this.singleClusterRouting =
        Output.createUnknown<AppProfileSingleClusterRouting2?>();
    this.standardIsolation =
        Output.createUnknown<AppProfileStandardIsolation2>();
  }
}
