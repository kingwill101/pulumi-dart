...
class Table3 extends CustomResource {
  ...
  ///
  /// -----
  late final Output<TableAutomatedBackupPolicy> automatedBackupPolicy;

  /// Duration to retain change stream data for the table. Set to 0 to disable. Must be between 1 and 7 days.
  late final Output<String> changeStreamRetention;

  /// A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below.
  late final Output<List<TableColumnFamily>?> columnFamilies;
  ...
  late final Output<String?> rowKeySchema;

  /// A list of predefined keys to split the table on.
  /// !> **Warning:** Modifying the `split_keys` of an existing table will cause the provider
  /// to delete/recreate the entire `gcp.bigtable.Table` resource.
  late final Output<List<String>?> splitKeys;
