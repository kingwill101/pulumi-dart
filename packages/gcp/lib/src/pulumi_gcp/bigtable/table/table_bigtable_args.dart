...
class TableBigtableArgs {
  ...
  factory TableBigtableArgs.fromMap(Map<String, dynamic> map) {
    return TableBigtableArgs(
      automatedBackupPolicy:
          pulumi.Input.asOptionalInput<TableAutomatedBackupPolicy>(
              map['automatedBackupPolicy']),
      changeStreamRetention:
          pulumi.Input.asOptionalInput<String>(map['changeStreamRetention']),
      ...
      rowKeySchema: pulumi.Input.asOptionalInput<String>(map['rowKeySchema']),
      splitKeys: pulumi.Input.asOptionalInput<List<String>>(map['splitKeys']),
    );
  }
}
