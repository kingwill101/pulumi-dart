...
class InstanceBigtableArgs {
  ...
  factory InstanceBigtableArgs.fromMap(Map<String, dynamic> map) {
    return InstanceBigtableArgs(
      clusters:
          pulumi.Input.asOptionalInput<List<InstanceCluster>>(map['clusters']),
      deletionProtection:
