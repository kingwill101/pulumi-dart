...
import 'environment_composer_args.dart';
...
/// ```
class EnvironmentComposer extends pulumi.CustomResource {
  ...
  EnvironmentComposer(
    ...
    this.storageConfig =
        registerOutput<EnvironmentStorageConfig>('storageConfig');
  }
}
