...
import '../get_environment_config_data_retention_config/get_environment_config_data_retention_config.dart';
import '../get_environment_config_database_config/get_environment_config_database_config.dart';
import '../get_environment_config_encryption_config/get_environment_config_encryption_config.dart';
import '../get_environment_config_maintenance_window/get_environment_config_maintenance_window.dart';
import '../get_environment_config_master_authorized_networks_config/get_environment_config_master_authorized_networks_config.dart';
import '../get_environment_config_node_config/get_environment_config_node_config.dart';
import '../get_environment_config_private_environment_config/get_environment_config_private_environment_config.dart';
import '../get_environment_config_recovery_config/get_environment_config_recovery_config.dart';
import '../get_environment_config_software_config/get_environment_config_software_config.dart';
import '../get_environment_config_web_server_config/get_environment_config_web_server_config.dart';
import '../get_environment_config_web_server_network_access_control/get_environment_config_web_server_network_access_control.dart';
import '../get_environment_config_workloads_config/get_environment_config_workloads_config.dart';
  ...
  factory GetEnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfig(
      ...
      dataRetentionConfigs:
          Input.decodeList<GetEnvironmentConfigDataRetentionConfig>(
              map['dataRetentionConfigs'],
              (value) => GetEnvironmentConfigDataRetentionConfig.fromMap(
                  (value as Map).cast<String, dynamic>())),
      databaseConfigs: Input.decodeList<GetEnvironmentConfigDatabaseConfig>(
          map['databaseConfigs'],
      ...
      encryptionConfigs: Input.decodeList<GetEnvironmentConfigEncryptionConfig>(
