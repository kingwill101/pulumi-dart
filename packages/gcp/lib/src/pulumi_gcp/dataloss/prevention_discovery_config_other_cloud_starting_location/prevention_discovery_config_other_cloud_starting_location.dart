...
import '../prevention_discovery_config_other_cloud_starting_location_aws_location/prevention_discovery_config_other_cloud_starting_location_aws_location.dart';
...
class PreventionDiscoveryConfigOtherCloudStartingLocation {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (awsLocationValue != null) {
      map['awsLocation'] = awsLocationValue.toMap();
    }
    return map;
  }
    ...
    return PreventionDiscoveryConfigOtherCloudStartingLocation(
      awsLocation: map['awsLocation'] == null
          ...
          : PreventionDiscoveryConfigOtherCloudStartingLocationAwsLocation
              .fromMap((map['awsLocation'] as Map).cast<String, dynamic>()),
    );
  }
}
