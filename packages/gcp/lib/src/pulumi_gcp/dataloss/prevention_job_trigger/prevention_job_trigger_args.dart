...
class PreventionJobTriggerArgs {
  ...
  final Input<PreventionJobTriggerInspectJob>? inspectJob;
  ...
  /// Structure is documented below.
  final Input<List<PreventionJobTriggerTrigger>> triggers;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['triggers'] = Input.mapInputValue<List<PreventionJobTriggerTrigger>,
            List<Map<String, dynamic>>>(
        triggers,
        (value) =>
            Input.encodeList<PreventionJobTriggerTrigger, Map<String, dynamic>>(
  ...
  factory PreventionJobTriggerArgs.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerArgs(
      ...
      inspectJob: Input.asOptionalInput<PreventionJobTriggerInspectJob>(
          map['inspectJob']),
      parent: Input.asInput<String>(map['parent']),
      status: Input.asOptionalInput<String>(map['status']),
      triggerId: Input.asOptionalInput<String>(map['triggerId']),
      triggers:
          Input.asInput<List<PreventionJobTriggerTrigger>>(map['triggers']),
    );
  }
}
