...
import '../note_iam_binding_condition/note_iam_binding_condition.dart';

/// The set of arguments for NoteIamBinding.
class NoteIamBindingArgs {
  final Input<NoteIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<NoteIamBindingCondition,
  ...
  factory NoteIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NoteIamBindingArgs(
      condition:
          Input.asOptionalInput<NoteIamBindingCondition>(map['condition']),
