...
class NoteIamMemberArgs {
  final Input<NoteIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<NoteIamMemberCondition,
  ...
  factory NoteIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NoteIamMemberArgs(
      condition:
          Input.asOptionalInput<NoteIamMemberCondition>(map['condition']),
