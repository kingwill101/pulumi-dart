...
import '../note_iam_member_condition/note_iam_member_condition.dart';
import 'note_iam_member_args.dart';
...
class NoteIamMember extends CustomResource {
  late final Output<NoteIamMemberCondition?> condition;
  ...
  /// <span pulumi-lang-nodejs="`gcp.containeranalysis.NoteIamBinding`" pulumi-lang-dotnet="`gcp.containeranalysis.NoteIamBinding`" pulumi-lang-go="`containeranalysis.NoteIamBinding`" pulumi-lang-python="`containeranalysis.NoteIamBinding`" pulumi-lang-yaml="`gcp.containeranalysis.NoteIamBinding`" pulumi-lang-java="`gcp.containeranalysis.NoteIamBinding`">`gcp.containeranalysis.NoteIamBinding`</span> can be used per role. Note that custom roles must be of the format
  /// `[projects|organizations]/{parent-name}/roles/{role-name}`.
  late final Output<String> role;

  NoteIamMember(
    String name, {
    NoteIamMemberArgs? args,
    ...
    this.condition = Output.createUnknown<NoteIamMemberCondition?>();
    this.etag = Output.createUnknown<String>();
    this.member = Output.createUnknown<String>();
    this.note = Output.createUnknown<String>();
