...
class PatchDeploymentArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (oneTimeScheduleValue != null) {
      map['oneTimeSchedule'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (recurringScheduleValue != null) {
      map['recurringSchedule'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory PatchDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentArgs(
      ...
      instanceFilter: pulumi.Input.asInput<PatchDeploymentInstanceFilter>(
          map['instanceFilter']),
      oneTimeSchedule:
          pulumi.Input.asOptionalInput<PatchDeploymentOneTimeSchedule>(
              map['oneTimeSchedule']),
      patchConfig: pulumi.Input.asOptionalInput<PatchDeploymentPatchConfig>(
          map['patchConfig']),
      patchDeploymentId: pulumi.Input.asInput<String>(map['patchDeploymentId']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      recurringSchedule:
          pulumi.Input.asOptionalInput<PatchDeploymentRecurringSchedule>(
              map['recurringSchedule']),
      rollout:
          pulumi.Input.asOptionalInput<PatchDeploymentRollout>(map['rollout']),
    );
  }
}
