...
class PatchDeployment extends CustomResource {
  ...
  late final Output<PatchDeploymentInstanceFilter> instanceFilter;
  ...
  /// Structure is documented below.
  late final Output<PatchDeploymentOneTimeSchedule?> oneTimeSchedule;

  /// Patch configuration that is applied.
  /// Structure is documented below.
  late final Output<PatchDeploymentPatchConfig?> patchConfig;
  ...
  /// Structure is documented below.
  late final Output<PatchDeploymentRecurringSchedule?> recurringSchedule;

  /// Rollout strategy of the patch job.
  /// Structure is documented below.
  late final Output<PatchDeploymentRollout?> rollout;
