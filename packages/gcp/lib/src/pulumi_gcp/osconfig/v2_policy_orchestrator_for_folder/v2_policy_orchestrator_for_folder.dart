...
/// ```
class V2PolicyOrchestratorForFolder extends CustomResource {
  ...
  late final Output<V2PolicyOrchestratorForFolderOrchestratedResource>
      orchestratedResource;

  /// Defines a set of selectors which drive which resources are in scope of policy
  /// orchestration.
  /// Structure is documented below.
  late final Output<V2PolicyOrchestratorForFolderOrchestrationScope?>
      orchestrationScope;

  /// Describes the state of the orchestration process.
  /// Structure is documented below.
  late final Output<List<V2PolicyOrchestratorForFolderOrchestrationState>>
      orchestrationStates;
