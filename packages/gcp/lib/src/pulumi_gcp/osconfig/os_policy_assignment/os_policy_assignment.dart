...
class OsPolicyAssignment extends CustomResource {
  ...
  /// a value of <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span> for this field.
  ...
  /// for the revision. This value is <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span> when the <span pulumi-lang-nodejs="`rolloutState`" pulumi-lang-dotnet="`RolloutState`" pulumi-lang-go="`rolloutState`" pulumi-lang-python="`rollout_state`" pulumi-lang-yaml="`rolloutState`" pulumi-lang-java="`rolloutState`">`rollout_state`</span> is one of:
