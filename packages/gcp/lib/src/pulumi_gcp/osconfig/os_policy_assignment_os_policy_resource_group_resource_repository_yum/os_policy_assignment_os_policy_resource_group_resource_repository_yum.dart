...
class OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYum {
  ...
  /// `repo id` in the yum config file and also the <span pulumi-lang-nodejs="`displayName`" pulumi-lang-dotnet="`DisplayName`" pulumi-lang-go="`displayName`" pulumi-lang-python="`display_name`" pulumi-lang-yaml="`displayName`" pulumi-lang-java="`displayName`">`display_name`</span> if
