...
import '../patch_deployment_patch_config_pre_step_windows_exec_step_config_gcs_object/patch_deployment_patch_config_pre_step_windows_exec_step_config_gcs_object.dart';
...
class PatchDeploymentPatchConfigPreStepWindowsExecStepConfig {
  ...
  final PatchDeploymentPatchConfigPreStepWindowsExecStepConfigGcsObject?
      gcsObject;
  ...
  factory PatchDeploymentPatchConfigPreStepWindowsExecStepConfig.fromMap(
