...
class V2PolicyOrchestratorForOrganizationArgs {
  ...
  final Input<V2PolicyOrchestratorForOrganizationOrchestratedResource>
      orchestratedResource;

  /// Defines a set of selectors which drive which resources are in scope of policy
  /// orchestration.
  /// Structure is documented below.
  final Input<V2PolicyOrchestratorForOrganizationOrchestrationScope>?
      orchestrationScope;

  /// Part of <span pulumi-lang-nodejs="`parent`" pulumi-lang-dotnet="`Parent`" pulumi-lang-go="`parent`" pulumi-lang-python="`parent`" pulumi-lang-yaml="`parent`" pulumi-lang-java="`parent`">`parent`</span>. Required. The parent resource name in the form of:
  ...
  factory V2PolicyOrchestratorForOrganizationArgs.fromMap(
    ...
    return V2PolicyOrchestratorForOrganizationArgs(
      ...
      orchestratedResource: Input.asInput<
              V2PolicyOrchestratorForOrganizationOrchestratedResource>(
