...
class RolloutKindArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (errorBudgetValue != null) {
      map['errorBudget'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory RolloutKindArgs.fromMap(Map<String, dynamic> map) {
    return RolloutKindArgs(
      ...
      rolloutKindId: pulumi.Input.asInput<String>(map['rolloutKindId']),
      rolloutOrchestrationStrategy: pulumi.Input.asOptionalInput<String>(
          map['rolloutOrchestrationStrategy']),
      unitFilter: pulumi.Input.asOptionalInput<String>(map['unitFilter']),
      unitKind: pulumi.Input.asInput<String>(map['unitKind']),
      updateUnitKindStrategy:
          pulumi.Input.asOptionalInput<String>(map['updateUnitKindStrategy']),
    );
  }
}
