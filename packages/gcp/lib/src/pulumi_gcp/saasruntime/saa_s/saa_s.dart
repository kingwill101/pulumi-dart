...
/// ```
class SaaS extends CustomResource {
  ...
  late final Output<List<SaaSLocation>?> locations;
  ...
  late final Output<String> saasId;
  ...
  SaaS(
    ...
    this.locations = Output.createUnknown<List<SaaSLocation>?>();
    this.name = Output.createUnknown<String>();
    this.project = Output.createUnknown<String>();
    this.pulumiLabels = Output.createUnknown<Map<String, String>>();
    this.saasId = Output.createUnknown<String>();
