...
///
/// <span pulumi-lang-nodejs="`gcp.siteverification.Owner`" pulumi-lang-dotnet="`gcp.siteverification.Owner`" pulumi-lang-go="`siteverification.Owner`" pulumi-lang-python="`siteverification.Owner`" pulumi-lang-yaml="`gcp.siteverification.Owner`" pulumi-lang-java="`gcp.siteverification.Owner`">`gcp.siteverification.Owner`</span> creates additional owners. If your web site
/// was verified using the
/// <span pulumi-lang-nodejs="`gcp.siteverification.WebResource`" pulumi-lang-dotnet="`gcp.siteverification.WebResource`" pulumi-lang-go="`siteverification.WebResource`" pulumi-lang-python="`siteverification.WebResource`" pulumi-lang-yaml="`gcp.siteverification.WebResource`" pulumi-lang-java="`gcp.siteverification.WebResource`">`gcp.siteverification.WebResource`</span>
...
/// added as a verified owner, and the <span pulumi-lang-nodejs="`gcp.siteverification.Owner`" pulumi-lang-dotnet="`gcp.siteverification.Owner`" pulumi-lang-go="`siteverification.Owner`" pulumi-lang-python="`siteverification.Owner`" pulumi-lang-yaml="`gcp.siteverification.Owner`" pulumi-lang-java="`gcp.siteverification.Owner`">`gcp.siteverification.Owner`</span> resource will add
