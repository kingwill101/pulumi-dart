...
///
/// > **Note:** The verification data (DNS `TXT` record, HTML file, <span pulumi-lang-nodejs="`meta`" pulumi-lang-dotnet="`Meta`" pulumi-lang-go="`meta`" pulumi-lang-python="`meta`" pulumi-lang-yaml="`meta`" pulumi-lang-java="`meta`">`meta`</span> tag, etc.)
