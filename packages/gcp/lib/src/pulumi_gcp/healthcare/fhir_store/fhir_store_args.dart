...
class FhirStoreArgs {
  ...
  factory FhirStoreArgs.fromMap(Map<String, dynamic> map) {
    return FhirStoreArgs(
      ...
      enableHistoryImport:
          pulumi.Input.asOptionalInput<bool>(map['enableHistoryImport']),
      enableHistoryModifications:
          pulumi.Input.asOptionalInput<bool>(map['enableHistoryModifications']),
      enableUpdateCreate:
      ...
      streamConfigs: pulumi.Input.asOptionalInput<List<FhirStoreStreamConfig>>(
          map['streamConfigs']),
      validationConfig: pulumi.Input.asOptionalInput<FhirStoreValidationConfig>(
