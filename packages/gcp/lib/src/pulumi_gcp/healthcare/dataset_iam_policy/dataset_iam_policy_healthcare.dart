...
import 'dataset_iam_policy_healthcare_args.dart';
...
/// ```
class DatasetIamPolicyHealthcare extends pulumi.CustomResource {
  ...
  DatasetIamPolicyHealthcare(
    String name, {
    DatasetIamPolicyHealthcareArgs? args,
