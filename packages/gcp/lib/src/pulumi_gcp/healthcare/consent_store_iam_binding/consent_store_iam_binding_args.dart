...
import '../consent_store_iam_binding_condition/consent_store_iam_binding_condition.dart';

/// The set of arguments for ConsentStoreIamBinding.
class ConsentStoreIamBindingArgs {
  final Input<ConsentStoreIamBindingCondition>? condition;
  ...
  factory ConsentStoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConsentStoreIamBindingArgs(
      condition: Input.asOptionalInput<ConsentStoreIamBindingCondition>(
          map['condition']),
