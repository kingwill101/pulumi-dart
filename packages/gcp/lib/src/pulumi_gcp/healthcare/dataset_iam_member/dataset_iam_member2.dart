...
import 'dataset_iam_member_args2.dart';
...
/// ```
class DatasetIamMember2 extends CustomResource {
  late final Output<DatasetIamMemberCondition2?> condition;
