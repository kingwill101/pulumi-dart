...
import 'dataset_iam_member_healthcare_args.dart';
...
/// ```
class DatasetIamMemberHealthcare extends pulumi.CustomResource {
  late final pulumi.Output<DatasetIamMemberConditionHealthcare?> condition;
  ...
  DatasetIamMemberHealthcare(
    String name, {
    DatasetIamMemberHealthcareArgs? args,
    ...
    this.condition =
        registerOutput<DatasetIamMemberConditionHealthcare?>('condition');
