...
class AuthorityArgs {
  ...
  factory AuthorityArgs.fromMap(Map<String, dynamic> map) {
    return AuthorityArgs(
      ...
      config: pulumi.Input.asInput<AuthorityConfig>(map['config']),
      deletionProtection:
      ...
      ignoreActiveCertificatesOnDeletion: pulumi.Input.asOptionalInput<bool>(
          map['ignoreActiveCertificatesOnDeletion']),
      keySpec: pulumi.Input.asInput<AuthorityKeySpec>(map['keySpec']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      lifetime: pulumi.Input.asOptionalInput<String>(map['lifetime']),
      location: pulumi.Input.asInput<String>(map['location']),
      pemCaCertificate:
          pulumi.Input.asOptionalInput<String>(map['pemCaCertificate']),
      pool: pulumi.Input.asInput<String>(map['pool']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      skipGracePeriod:
          pulumi.Input.asOptionalInput<bool>(map['skipGracePeriod']),
      subordinateConfig:
