...
class CertificateTemplate extends CustomResource {
  ...
  CertificateTemplate(
    ...
    this.identityConstraints =
        Output.createUnknown<CertificateTemplateIdentityConstraints?>();
    this.labels = Output.createUnknown<Map<String, String>?>();
    this.location = Output.createUnknown<String>();
    this.maximumLifetime = Output.createUnknown<String?>();
    this.name = Output.createUnknown<String>();
    this.passthroughExtensions =
        Output.createUnknown<CertificateTemplatePassthroughExtensions?>();
    this.predefinedValues =
        Output.createUnknown<CertificateTemplatePredefinedValues?>();
