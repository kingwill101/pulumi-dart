...
class CertificateTemplateIamMember extends CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final Output<String> certificateTemplate;

  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<CertificateTemplateIamMemberCondition?> condition;
  ...
  CertificateTemplateIamMember(
    ...
    this.condition =
        Output.createUnknown<CertificateTemplateIamMemberCondition?>();
