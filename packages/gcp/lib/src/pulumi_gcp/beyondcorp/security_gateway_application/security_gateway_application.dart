...
/// ```
class SecurityGatewayApplication extends CustomResource {
  ...
  late final Output<List<SecurityGatewayApplicationEndpointMatcher>?>
      endpointMatchers;
  ...
  /// Structure is documented below.
  late final Output<List<SecurityGatewayApplicationUpstream>?> upstreams;
