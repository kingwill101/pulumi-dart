...
import 'service_iam_binding_endpoints_args.dart';
...
///
/// full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
class ServiceIamBindingEndpoints extends pulumi.CustomResource {
  late final pulumi.Output<ServiceIamBindingConditionEndpoints?> condition;
  ...
  ServiceIamBindingEndpoints(
    String name, {
    ServiceIamBindingEndpointsArgs? args,
    ...
    this.condition =
        registerOutput<ServiceIamBindingConditionEndpoints?>('condition');
