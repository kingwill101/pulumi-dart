...
class ServiceIamMemberArgs2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<ServiceIamMemberCondition2,
  ...
  factory ServiceIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberArgs2(
      condition:
          Input.asOptionalInput<ServiceIamMemberCondition2>(map['condition']),
