...
import 'service_iam_member_endpoints_args.dart';
...
///
/// full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
class ServiceIamMemberEndpoints extends pulumi.CustomResource {
  late final pulumi.Output<ServiceIamMemberConditionEndpoints?> condition;
  ...
  ServiceIamMemberEndpoints(
    String name, {
    ServiceIamMemberEndpointsArgs? args,
    ...
    this.condition =
        registerOutput<ServiceIamMemberConditionEndpoints?>('condition');
