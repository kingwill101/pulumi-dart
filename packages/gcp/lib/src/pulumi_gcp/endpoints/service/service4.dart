...
class Service4 extends CustomResource {
  ...
  late final Output<List<ServiceApi>> apis;
  ...
  late final Output<String> dnsAddress;

  /// A list of Endpoint objects; structure is documented below.
  late final Output<List<ServiceEndpoint>> endpoints;
  ...
  late final Output<String?> grpcConfig;
  ...
  late final Output<String?> openapiConfig;
  ...
  late final Output<String?> protocOutputBase64;
