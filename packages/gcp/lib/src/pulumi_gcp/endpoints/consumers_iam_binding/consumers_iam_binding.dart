...
class ConsumersIamBinding extends CustomResource {
  late final Output<ConsumersIamBindingCondition?> condition;
  ...
  ConsumersIamBinding(
    ...
    this.condition = Output.createUnknown<ConsumersIamBindingCondition?>();
