...
class OrganizationFeedArgs {
  ...
  final Input<OrganizationFeedCondition>? condition;
  ...
  /// Structure is documented below.
  final Input<OrganizationFeedFeedOutputConfig> feedOutputConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<OrganizationFeedCondition,
    ...
    map['feedId'] = feedId;
    map['feedOutputConfig'] = Input.mapInputValue<
  ...
  factory OrganizationFeedArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationFeedArgs(
      ...
      condition:
          Input.asOptionalInput<OrganizationFeedCondition>(map['condition']),
      contentType: Input.asOptionalInput<String>(map['contentType']),
      feedId: Input.asInput<String>(map['feedId']),
      feedOutputConfig: Input.asInput<OrganizationFeedFeedOutputConfig>(
