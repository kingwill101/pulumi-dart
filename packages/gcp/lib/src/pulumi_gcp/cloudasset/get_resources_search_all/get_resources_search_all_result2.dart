...
class GetResourcesSearchAllResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['results'] =
        Input.encodeList<GetResourcesSearchAllResult, Map<String, dynamic>>(
            results, (value) => value.toMap());
    map['scope'] = scope;
    return map;
  }

  factory GetResourcesSearchAllResult2.fromMap(Map<String, dynamic> map) {
    return GetResourcesSearchAllResult2(
      assetTypes: map['assetTypes'] == null
          ? null
          : (map['assetTypes'] as List).cast<String>(),
      id: map['id'] as String,
      query: map['query'] == null ? null : map['query'] as String,
      results: Input.decodeList<GetResourcesSearchAllResult>(
          map['results'],
