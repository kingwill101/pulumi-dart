...
class FlexibleAppVersion extends CustomResource {
  ...
  late final Output<FlexibleAppVersionApiConfig?> apiConfig;

  /// Automatic scaling is based on request rate, response latencies, and other application metrics.
  /// Structure is documented below.
  late final Output<FlexibleAppVersionAutomaticScaling?> automaticScaling;
  ...
  /// Structure is documented below.
  late final Output<FlexibleAppVersionDeployment?> deployment;

  /// Code and application artifacts that make up this version.
  /// Structure is documented below.
  late final Output<FlexibleAppVersionEndpointsApiService?> endpointsApiService;

  /// The entrypoint for the application.
  /// Structure is documented below.
  late final Output<FlexibleAppVersionEntrypoint?> entrypoint;
  ...
  /// Structure is documented below.
  late final Output<FlexibleAppVersionFlexibleRuntimeSettings?>
      flexibleRuntimeSettings;

  /// An ordered list of URL-matching patterns that should be applied to incoming requests.
  /// The first matching URL handles the request and other request handlers are not attempted.
  /// Structure is documented below.
  late final Output<List<FlexibleAppVersionHandler>> handlers;
  ...
  /// Structure is documented below.
  late final Output<FlexibleAppVersionLivenessCheck> livenessCheck;

  /// A service with manual scaling runs continuously, allowing you to perform complex initialization and rely on the state of its memory over time.
  /// Structure is documented below.
  late final Output<FlexibleAppVersionManualScaling?> manualScaling;
  ...
  /// Structure is documented below.
  late final Output<FlexibleAppVersionNetwork?> network;
  ...
  /// Structure is documented below.
  late final Output<FlexibleAppVersionReadinessCheck> readinessCheck;

  /// Machine resources for a version.
  /// Structure is documented below.
  late final Output<FlexibleAppVersionResources?> resources;
  ...
  /// Structure is documented below.
  late final Output<FlexibleAppVersionVpcAccessConnector?> vpcAccessConnector;
