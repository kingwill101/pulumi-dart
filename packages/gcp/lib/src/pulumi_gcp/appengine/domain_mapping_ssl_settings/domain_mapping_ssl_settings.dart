...
class DomainMappingSslSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final pendingManagedCertificateIdValue = pendingManagedCertificateId;
    if (pendingManagedCertificateIdValue != null) {
      map['pendingManagedCertificateId'] = pendingManagedCertificateIdValue;
    }
