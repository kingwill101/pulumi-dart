...
/// ```
class Field extends CustomResource {
  ...
  late final Output<FieldIndexConfig?> indexConfig;
  ...
  /// Structure is documented below.
  late final Output<FieldTtlConfig?> ttlConfig;
