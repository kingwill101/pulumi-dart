...
/// <span pulumi-lang-nodejs="`gcp.appengine.Application`" pulumi-lang-dotnet="`gcp.appengine.Application`" pulumi-lang-go="`appengine.Application`" pulumi-lang-python="`appengine.Application`" pulumi-lang-yaml="`gcp.appengine.Application`" pulumi-lang-java="`gcp.appengine.Application`">`gcp.appengine.Application`</span>
/// resource instead. If you were previously using the <span pulumi-lang-nodejs="`gcp.appengine.Application`" pulumi-lang-dotnet="`gcp.appengine.Application`" pulumi-lang-go="`appengine.Application`" pulumi-lang-python="`appengine.Application`" pulumi-lang-yaml="`gcp.appengine.Application`" pulumi-lang-java="`gcp.appengine.Application`">`gcp.appengine.Application`</span> resource exclusively for managing a Firestore database
/// and would like to use the <span pulumi-lang-nodejs="`gcp.firestore.Database`" pulumi-lang-dotnet="`gcp.firestore.Database`" pulumi-lang-go="`firestore.Database`" pulumi-lang-python="`firestore.Database`" pulumi-lang-yaml="`gcp.firestore.Database`" pulumi-lang-java="`gcp.firestore.Database`">`gcp.firestore.Database`</span> resource instead, please follow the instructions
...
class Database2 extends CustomResource {
  ...
  /// This value may be empty in which case the appid to use for URL-encoded keys is the<span pulumi-lang-nodejs=" projectId " pulumi-lang-dotnet=" ProjectId " pulumi-lang-go=" projectId " pulumi-lang-python=" project_id " pulumi-lang-yaml=" projectId " pulumi-lang-java=" projectId "> project_id </span>(eg: foo instead of v~foo).
