...
/// create a <span pulumi-lang-nodejs="`gcp.firestore.Database`" pulumi-lang-dotnet="`gcp.firestore.Database`" pulumi-lang-go="`firestore.Database`" pulumi-lang-python="`firestore.Database`" pulumi-lang-yaml="`gcp.firestore.Database`" pulumi-lang-java="`gcp.firestore.Database`">`gcp.firestore.Database`</span> resource with <span pulumi-lang-nodejs="`type`" pulumi-lang-dotnet="`Type`" pulumi-lang-go="`type`" pulumi-lang-python="`type`" pulumi-lang-yaml="`type`" pulumi-lang-java="`type`">`type`</span> set to
/// `"FIRESTORE_NATIVE"` and <span pulumi-lang-nodejs="`locationId`" pulumi-lang-dotnet="`LocationId`" pulumi-lang-go="`locationId`" pulumi-lang-python="`location_id`" pulumi-lang-yaml="`locationId`" pulumi-lang-java="`locationId`">`location_id`</span> set to your chosen location.
/// If you wish to use App Engine, you may instead create a
/// <span pulumi-lang-nodejs="`gcp.appengine.Application`" pulumi-lang-dotnet="`gcp.appengine.Application`" pulumi-lang-go="`appengine.Application`" pulumi-lang-python="`appengine.Application`" pulumi-lang-yaml="`gcp.appengine.Application`" pulumi-lang-java="`gcp.appengine.Application`">`gcp.appengine.Application`</span> resource with <span pulumi-lang-nodejs="`databaseType`" pulumi-lang-dotnet="`DatabaseType`" pulumi-lang-go="`databaseType`" pulumi-lang-python="`database_type`" pulumi-lang-yaml="`databaseType`" pulumi-lang-java="`databaseType`">`database_type`</span> set to
