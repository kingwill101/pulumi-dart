...
class NodePool extends CustomResource {
  ...
  late final Output<List<String>> managedInstanceGroupUrls;

  /// Node management configuration, wherein auto-repair and
  /// auto-upgrade is configured. Structure is documented below.
  late final Output<NodePoolManagement> management;
  ...
  late final Output<int> maxPodsPerNode;
  ...
  late final Output<List<NodePoolNodeDrainConfig>> nodeDrainConfigs;
  ...
  /// nodes.
  late final Output<NodePoolPlacementPolicy?> placementPolicy;
