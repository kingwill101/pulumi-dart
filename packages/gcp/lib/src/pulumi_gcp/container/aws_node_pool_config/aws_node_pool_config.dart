...
import '../aws_node_pool_config_proxy_config/aws_node_pool_config_proxy_config.dart';
import '../aws_node_pool_config_root_volume/aws_node_pool_config_root_volume.dart';
import '../aws_node_pool_config_spot_config/aws_node_pool_config_spot_config.dart';
import '../aws_node_pool_config_ssh_config/aws_node_pool_config_ssh_config.dart';
import '../aws_node_pool_config_taint/aws_node_pool_config_taint.dart';
...
class AwsNodePoolConfig {
  ...
  /// Optional. When specified, the node pool will provision Spot instances from the set of spot_config.instance_types. This field is mutually exclusive with <span pulumi-lang-nodejs="`instanceType`" pulumi-lang-dotnet="`InstanceType`" pulumi-lang-go="`instanceType`" pulumi-lang-python="`instance_type`" pulumi-lang-yaml="`instanceType`" pulumi-lang-java="`instanceType`">`instance_type`</span>
