...
class ClusterNodePoolNetworkConfig {
  ...
  /// The IP address range for pod IPs in this node pool. Only applicable if<span pulumi-lang-nodejs=" createPodRange " pulumi-lang-dotnet=" CreatePodRange " pulumi-lang-go=" createPodRange " pulumi-lang-python=" create_pod_range " pulumi-lang-yaml=" createPodRange " pulumi-lang-java=" createPodRange "> create_pod_range </span>is true. Set to blank to have a range chosen with the default size. Set to /netmask (e.g. /14) to have a range chosen with a specific netmask. Set to a CIDR notation (e.g. 10.96.0.0/14) to pick a specific range to use.
