...
import 'instance_iam_binding_notebooks_args.dart';
...
class InstanceIamBindingNotebooks extends pulumi.CustomResource {
  late final pulumi.Output<InstanceIamBindingConditionNotebooks?> condition;
  ...
  InstanceIamBindingNotebooks(
    String name, {
    InstanceIamBindingNotebooksArgs? args,
    ...
    this.condition =
        registerOutput<InstanceIamBindingConditionNotebooks?>('condition');
