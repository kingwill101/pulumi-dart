...
class InstanceReservationAffinityNotebooks {
  ...
  InstanceReservationAffinityNotebooks({
  ...
  factory InstanceReservationAffinityNotebooks.fromMap(
      Map<String, dynamic> map) {
    return InstanceReservationAffinityNotebooks(
