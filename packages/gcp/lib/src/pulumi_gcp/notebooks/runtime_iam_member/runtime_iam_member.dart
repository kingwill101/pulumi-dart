...
class RuntimeIamMember extends CustomResource {
  late final Output<RuntimeIamMemberCondition?> condition;
  ...
  RuntimeIamMember(
    ...
    this.condition = Output.createUnknown<RuntimeIamMemberCondition?>();
    this.etag = Output.createUnknown<String>();
    this.location = Output.createUnknown<String>();
    this.member = Output.createUnknown<String>();
    this.project = Output.createUnknown<String>();
    this.role = Output.createUnknown<String>();
    this.runtimeName = Output.createUnknown<String>();
  }
}
