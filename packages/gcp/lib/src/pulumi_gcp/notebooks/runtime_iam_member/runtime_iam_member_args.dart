...
import '../runtime_iam_member_condition/runtime_iam_member_condition.dart';

/// The set of arguments for RuntimeIamMember.
class RuntimeIamMemberArgs {
  final Input<RuntimeIamMemberCondition>? condition;
  ...
  final Input<String> runtimeName;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<RuntimeIamMemberCondition,
  ...
  factory RuntimeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeIamMemberArgs(
      condition:
          Input.asOptionalInput<RuntimeIamMemberCondition>(map['condition']),
      location: Input.asOptionalInput<String>(map['location']),
      member: Input.asInput<String>(map['member']),
      project: Input.asOptionalInput<String>(map['project']),
      role: Input.asInput<String>(map['role']),
      runtimeName: Input.asInput<String>(map['runtimeName']),
    );
  }
}
