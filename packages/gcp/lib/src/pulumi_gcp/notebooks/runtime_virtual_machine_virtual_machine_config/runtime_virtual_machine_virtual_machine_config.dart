...
import '../runtime_virtual_machine_virtual_machine_config_encryption_config/runtime_virtual_machine_virtual_machine_config_encryption_config.dart';
import '../runtime_virtual_machine_virtual_machine_config_shielded_instance_config/runtime_virtual_machine_virtual_machine_config_shielded_instance_config.dart';

class RuntimeVirtualMachineVirtualMachineConfig {
  /// The Compute Engine accelerator configuration for this runtime.
  /// Structure is documented below.
  final RuntimeVirtualMachineVirtualMachineConfigAcceleratorConfig?
      acceleratorConfig;

  /// Use a list of container images to start the notebook instance.
  /// Structure is documented below.
  final List<RuntimeVirtualMachineVirtualMachineConfigContainerImage>?
      containerImages;
  ...
  /// Structure is documented below.
  final RuntimeVirtualMachineVirtualMachineConfigEncryptionConfig?
      encryptionConfig;
  ...
  /// Structure is documented below.
  final RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfig?
  ...
  Map<String, dynamic> toMap() {
    ...
    final guestAttributesValue = guestAttributes;
    if (guestAttributesValue != null) {
      map['guestAttributes'] = guestAttributesValue;
    }
  ...
  factory RuntimeVirtualMachineVirtualMachineConfig.fromMap(
      Map<String, dynamic> map) {
    return RuntimeVirtualMachineVirtualMachineConfig(
      acceleratorConfig: map['acceleratorConfig'] == null
          ? null
          : RuntimeVirtualMachineVirtualMachineConfigAcceleratorConfig.fromMap(
      ...
      dataDisk: RuntimeVirtualMachineVirtualMachineConfigDataDisk.fromMap(
          (map['dataDisk'] as Map).cast<String, dynamic>()),
      encryptionConfig: map['encryptionConfig'] == null
          ? null
          : RuntimeVirtualMachineVirtualMachineConfigEncryptionConfig.fromMap(
              (map['encryptionConfig'] as Map).cast<String, dynamic>()),
      guestAttributes: map['guestAttributes'] == null
          ? null
          : (map['guestAttributes'] as Map).cast<String, String>(),
      internalIpOnly:
