...
import 'instance_iam_policy_notebooks_args.dart';
...
class InstanceIamPolicyNotebooks extends pulumi.CustomResource {
  ...
  InstanceIamPolicyNotebooks(
    String name, {
    InstanceIamPolicyNotebooksArgs? args,
