...
class InstanceShieldedInstanceConfigNotebooks {
  ...
  InstanceShieldedInstanceConfigNotebooks({
  ...
  factory InstanceShieldedInstanceConfigNotebooks.fromMap(
      Map<String, dynamic> map) {
    return InstanceShieldedInstanceConfigNotebooks(
