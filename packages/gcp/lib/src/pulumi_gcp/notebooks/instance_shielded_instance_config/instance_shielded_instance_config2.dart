...
class InstanceShieldedInstanceConfig2 {
  ...
  InstanceShieldedInstanceConfig2({
  ...
  factory InstanceShieldedInstanceConfig2.fromMap(Map<String, dynamic> map) {
    return InstanceShieldedInstanceConfig2(
