...
class RuntimeIamBindingArgs {
  final Input<RuntimeIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<RuntimeIamBindingCondition,
  ...
  factory RuntimeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeIamBindingArgs(
      condition:
          Input.asOptionalInput<RuntimeIamBindingCondition>(map['condition']),
