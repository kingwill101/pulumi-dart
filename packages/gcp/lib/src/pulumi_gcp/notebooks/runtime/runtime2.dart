...
/// > **Warning:** <span pulumi-lang-nodejs="`googleNotebookRuntime`" pulumi-lang-dotnet="`GoogleNotebookRuntime`" pulumi-lang-go="`googleNotebookRuntime`" pulumi-lang-python="`google_notebook_runtime`" pulumi-lang-yaml="`googleNotebookRuntime`" pulumi-lang-java="`googleNotebookRuntime`">`google_notebook_runtime`</span> is deprecated and will be removed in a future major release. Use <span pulumi-lang-nodejs="`gcp.workbench.Instance`" pulumi-lang-dotnet="`gcp.workbench.Instance`" pulumi-lang-go="`workbench.Instance`" pulumi-lang-python="`workbench.Instance`" pulumi-lang-yaml="`gcp.workbench.Instance`" pulumi-lang-java="`gcp.workbench.Instance`">`gcp.workbench.Instance`</span> instead.
///
