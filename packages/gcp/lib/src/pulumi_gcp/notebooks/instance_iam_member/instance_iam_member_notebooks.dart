...
import 'instance_iam_member_notebooks_args.dart';
...
class InstanceIamMemberNotebooks extends pulumi.CustomResource {
  late final pulumi.Output<InstanceIamMemberConditionNotebooks?> condition;
  ...
  InstanceIamMemberNotebooks(
    String name, {
    InstanceIamMemberNotebooksArgs? args,
    ...
    this.condition =
        registerOutput<InstanceIamMemberConditionNotebooks?>('condition');
