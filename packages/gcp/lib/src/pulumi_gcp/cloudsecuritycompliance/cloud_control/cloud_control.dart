...
/// ```
class CloudControl extends CustomResource {
  ...
  late final Output<String> cloudControlId;

  /// The last updated time of the cloud control.
  /// The<span pulumi-lang-nodejs=" createTime " pulumi-lang-dotnet=" CreateTime " pulumi-lang-go=" createTime " pulumi-lang-python=" create_time " pulumi-lang-yaml=" createTime " pulumi-lang-java=" createTime "> create_time </span>is used because a new CC is created whenever we update an
  /// existing CC.
  ...
  /// characters.
  late final Output<String?> findingCategory;
