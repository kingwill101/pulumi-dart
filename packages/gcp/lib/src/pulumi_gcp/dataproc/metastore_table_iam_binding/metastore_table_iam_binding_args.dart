...
/// The set of arguments for MetastoreTableIamBinding.
class MetastoreTableIamBindingArgs {
  final Input<MetastoreTableIamBindingCondition>? condition;
  ...
  factory MetastoreTableIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return MetastoreTableIamBindingArgs(
      condition: Input.asOptionalInput<MetastoreTableIamBindingCondition>(
          map['condition']),
