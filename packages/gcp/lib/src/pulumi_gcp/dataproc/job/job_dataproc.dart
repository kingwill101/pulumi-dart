...
import '../job_status/job_status_dataproc.dart';
import 'job_dataproc_args.dart';
...
class JobDataproc extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<JobStatusDataproc>> statuses;

  JobDataproc(
    String name, {
    JobDataprocArgs? args,
    ...
    this.statuses = registerOutput<List<JobStatusDataproc>>('statuses');
  }
}
