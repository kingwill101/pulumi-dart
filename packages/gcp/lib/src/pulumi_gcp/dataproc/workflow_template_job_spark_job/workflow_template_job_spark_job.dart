...
import '../workflow_template_job_spark_job_logging_config/workflow_template_job_spark_job_logging_config.dart';
  ...
  factory WorkflowTemplateJobSparkJob.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateJobSparkJob(
      ...
      loggingConfig: map['loggingConfig'] == null
          ? null
          : WorkflowTemplateJobSparkJobLoggingConfig.fromMap(
