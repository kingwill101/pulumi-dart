...
/// <span pulumi-lang-nodejs="`labels`" pulumi-lang-dotnet="`Labels`" pulumi-lang-go="`labels`" pulumi-lang-python="`labels`" pulumi-lang-yaml="`labels`" pulumi-lang-java="`labels`">`labels`</span>,`cluster_config.worker_config.num_instances` and `cluster_config.preemptible_worker_config.num_instances` are non-updatable. Changing `cluster_config.worker_config.min_num_instances` will be ignored. Changing others will cause recreation of the
/// whole cluster!
///
/// ## Example Usage
///
...
class Cluster3 extends CustomResource {
  ...
  late final Output<ClusterClusterConfig> clusterConfig;

  /// The list of labels (key/value pairs) to be applied to
  /// instances in the cluster. GCP generates some itself including `goog-dataproc-cluster-name`
  /// which is the name of the cluster.
  late final Output<Map<String, String>> effectiveLabels;
  late final Output<String?> gracefulDecommissionTimeout;
  ...
  /// Structure defined below.
  late final Output<ClusterVirtualClusterConfig> virtualClusterConfig;
