...
import '../autoscaling_policy_iam_binding_condition/autoscaling_policy_iam_binding_condition.dart';

/// The set of arguments for AutoscalingPolicyIamBinding.
class AutoscalingPolicyIamBindingArgs {
  final Input<AutoscalingPolicyIamBindingCondition>? condition;
  ...
  AutoscalingPolicyIamBindingArgs({
    this.condition,
    this.location,
  ...
  factory AutoscalingPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyIamBindingArgs(
      condition: Input.asOptionalInput<AutoscalingPolicyIamBindingCondition>(
          map['condition']),
