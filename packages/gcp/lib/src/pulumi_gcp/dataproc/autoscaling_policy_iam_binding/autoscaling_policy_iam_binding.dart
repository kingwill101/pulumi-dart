...
class AutoscalingPolicyIamBinding extends CustomResource {
  late final Output<AutoscalingPolicyIamBindingCondition?> condition;
  ...
  AutoscalingPolicyIamBinding(
    ...
    this.condition =
        registerOutput<AutoscalingPolicyIamBindingCondition?>('condition');
