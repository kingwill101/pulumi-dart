...
class MetastoreDatabaseIamMember extends CustomResource {
  late final Output<MetastoreDatabaseIamMemberCondition?> condition;
  ...
  MetastoreDatabaseIamMember(
    ...
    this.condition =
        registerOutput<MetastoreDatabaseIamMemberCondition?>('condition');
