...
class IcebergCatalogIamBinding extends CustomResource {
  late final Output<IcebergCatalogIamBindingCondition?> condition;
  ...
  IcebergCatalogIamBinding(
    ...
    this.condition = Output.createUnknown<IcebergCatalogIamBindingCondition?>();
