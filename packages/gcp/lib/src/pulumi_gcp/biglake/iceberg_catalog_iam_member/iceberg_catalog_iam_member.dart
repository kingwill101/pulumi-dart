...
class IcebergCatalogIamMember extends CustomResource {
  late final Output<IcebergCatalogIamMemberCondition?> condition;
  ...
  IcebergCatalogIamMember(
    ...
    this.condition = Output.createUnknown<IcebergCatalogIamMemberCondition?>();
