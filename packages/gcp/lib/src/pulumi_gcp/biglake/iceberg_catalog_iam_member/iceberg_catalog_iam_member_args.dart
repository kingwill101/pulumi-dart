...
import '../iceberg_catalog_iam_member_condition/iceberg_catalog_iam_member_condition.dart';
...
class IcebergCatalogIamMemberArgs {
  ...
  factory IcebergCatalogIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return IcebergCatalogIamMemberArgs(
      condition: pulumi.Input.asOptionalInput<IcebergCatalogIamMemberCondition>(
          map['condition']),
