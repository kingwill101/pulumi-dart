...
import '../get_autonomous_databases_autonomous_database_property_customer_contact/get_autonomous_databases_autonomous_database_property_customer_contact.dart';
import '../get_autonomous_databases_autonomous_database_property_local_standby_db/get_autonomous_databases_autonomous_database_property_local_standby_db.dart';
import '../get_autonomous_databases_autonomous_database_property_scheduled_operation_detail/get_autonomous_databases_autonomous_database_property_scheduled_operation_detail.dart';
...
class GetAutonomousDatabasesAutonomousDatabaseProperty {
  ...
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail>
      apexDetails;
  ...
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString>
      connectionStrings;

  /// The URLs for accessing Oracle Application Express (APEX) and SQL Developer
  /// Web with a browser from a Compute instance.
  /// https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/datatypes/AutonomousDatabaseConnectionUrls
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl>
      connectionUrls;
  ...
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact>
      customerContacts;
  ...
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb>
      localStandbyDbs;
