...
import '../autonomous_database_properties_customer_contact/autonomous_database_properties_customer_contact.dart';
import '../autonomous_database_properties_local_standby_db/autonomous_database_properties_local_standby_db.dart';
import '../autonomous_database_properties_scheduled_operation_detail/autonomous_database_properties_scheduled_operation_detail.dart';
...
class AutonomousDatabaseProperties {
  ...
  /// Database.
  /// Structure is documented below.
  final List<AutonomousDatabasePropertiesScheduledOperationDetail>?
  ...
  Map<String, dynamic> toMap() {
    ...
    final actualUsedDataStorageSizeTbValue = actualUsedDataStorageSizeTb;
    if (actualUsedDataStorageSizeTbValue != null) {
      map['actualUsedDataStorageSizeTb'] = actualUsedDataStorageSizeTbValue;
    }
    final allocatedStorageSizeTbValue = allocatedStorageSizeTb;
    if (allocatedStorageSizeTbValue != null) {
      map['allocatedStorageSizeTb'] = allocatedStorageSizeTbValue;
    }
    ...
    final arePrimaryAllowlistedIpsUsedValue = arePrimaryAllowlistedIpsUsed;
    if (arePrimaryAllowlistedIpsUsedValue != null) {
      map['arePrimaryAllowlistedIpsUsed'] = arePrimaryAllowlistedIpsUsedValue;
    }
    final autonomousContainerDatabaseIdValue = autonomousContainerDatabaseId;
    if (autonomousContainerDatabaseIdValue != null) {
      map['autonomousContainerDatabaseId'] = autonomousContainerDatabaseIdValue;
    }
    final availableUpgradeVersionsValue = availableUpgradeVersions;
    if (availableUpgradeVersionsValue != null) {
      map['availableUpgradeVersions'] = availableUpgradeVersionsValue;
    }
    final backupRetentionPeriodDaysValue = backupRetentionPeriodDays;
    if (backupRetentionPeriodDaysValue != null) {
      map['backupRetentionPeriodDays'] = backupRetentionPeriodDaysValue;
    }
    ...
    final cpuCoreCountValue = cpuCoreCount;
    if (cpuCoreCountValue != null) {
      map['cpuCoreCount'] = cpuCoreCountValue;
    }
    ...
    final dataSafeStateValue = dataSafeState;
    if (dataSafeStateValue != null) {
      map['dataSafeState'] = dataSafeStateValue;
    }
    ...
    final databaseManagementStateValue = databaseManagementState;
    if (databaseManagementStateValue != null) {
      map['databaseManagementState'] = databaseManagementStateValue;
    }
    final dbEditionValue = dbEdition;
    if (dbEditionValue != null) {
      map['dbEdition'] = dbEditionValue;
    }
    final dbVersionValue = dbVersion;
    if (dbVersionValue != null) {
      map['dbVersion'] = dbVersionValue;
    }
    map['dbWorkload'] = dbWorkload;
    final failedDataRecoveryDurationValue = failedDataRecoveryDuration;
    if (failedDataRecoveryDurationValue != null) {
      map['failedDataRecoveryDuration'] = failedDataRecoveryDurationValue;
    }
    final isAutoScalingEnabledValue = isAutoScalingEnabled;
    if (isAutoScalingEnabledValue != null) {
      map['isAutoScalingEnabled'] = isAutoScalingEnabledValue;
    }
    final isLocalDataGuardEnabledValue = isLocalDataGuardEnabled;
    if (isLocalDataGuardEnabledValue != null) {
      map['isLocalDataGuardEnabled'] = isLocalDataGuardEnabledValue;
    }
    final isStorageAutoScalingEnabledValue = isStorageAutoScalingEnabled;
    if (isStorageAutoScalingEnabledValue != null) {
      map['isStorageAutoScalingEnabled'] = isStorageAutoScalingEnabledValue;
    }
    ...
    final localAdgAutoFailoverMaxDataLossLimitValue =
        localAdgAutoFailoverMaxDataLossLimit;
    if (localAdgAutoFailoverMaxDataLossLimitValue != null) {
      map['localAdgAutoFailoverMaxDataLossLimit'] =
          localAdgAutoFailoverMaxDataLossLimitValue;
    }
    final localDisasterRecoveryTypeValue = localDisasterRecoveryType;
    if (localDisasterRecoveryTypeValue != null) {
      map['localDisasterRecoveryType'] = localDisasterRecoveryTypeValue;
    }
    ...
    final maintenanceBeginTimeValue = maintenanceBeginTime;
    if (maintenanceBeginTimeValue != null) {
      map['maintenanceBeginTime'] = maintenanceBeginTimeValue;
    }
    final maintenanceEndTimeValue = maintenanceEndTime;
    if (maintenanceEndTimeValue != null) {
      map['maintenanceEndTime'] = maintenanceEndTimeValue;
    }
    final maintenanceScheduleTypeValue = maintenanceScheduleType;
    if (maintenanceScheduleTypeValue != null) {
      map['maintenanceScheduleType'] = maintenanceScheduleTypeValue;
    }
    final memoryPerOracleComputeUnitGbsValue = memoryPerOracleComputeUnitGbs;
    if (memoryPerOracleComputeUnitGbsValue != null) {
      map['memoryPerOracleComputeUnitGbs'] = memoryPerOracleComputeUnitGbsValue;
    }
    final memoryTableGbsValue = memoryTableGbs;
    if (memoryTableGbsValue != null) {
      map['memoryTableGbs'] = memoryTableGbsValue;
    }
    final mtlsConnectionRequiredValue = mtlsConnectionRequired;
    if (mtlsConnectionRequiredValue != null) {
      map['mtlsConnectionRequired'] = mtlsConnectionRequiredValue;
    }
    final nCharacterSetValue = nCharacterSet;
    if (nCharacterSetValue != null) {
      map['nCharacterSet'] = nCharacterSetValue;
    }
    final nextLongTermBackupTimeValue = nextLongTermBackupTime;
    if (nextLongTermBackupTimeValue != null) {
      map['nextLongTermBackupTime'] = nextLongTermBackupTimeValue;
    }
    ...
    final openModeValue = openMode;
    if (openModeValue != null) {
      map['openMode'] = openModeValue;
    }
    final operationsInsightsStateValue = operationsInsightsState;
    if (operationsInsightsStateValue != null) {
      map['operationsInsightsState'] = operationsInsightsStateValue;
    }
    final peerDbIdsValue = peerDbIds;
    if (peerDbIdsValue != null) {
      map['peerDbIds'] = peerDbIdsValue;
    }
    final permissionLevelValue = permissionLevel;
    if (permissionLevelValue != null) {
      map['permissionLevel'] = permissionLevelValue;
    }
    final privateEndpointValue = privateEndpoint;
    if (privateEndpointValue != null) {
      map['privateEndpoint'] = privateEndpointValue;
    }
    final privateEndpointIpValue = privateEndpointIp;
    if (privateEndpointIpValue != null) {
      map['privateEndpointIp'] = privateEndpointIpValue;
    }
    final privateEndpointLabelValue = privateEndpointLabel;
    if (privateEndpointLabelValue != null) {
      map['privateEndpointLabel'] = privateEndpointLabelValue;
    }
    final refreshableModeValue = refreshableMode;
    if (refreshableModeValue != null) {
      map['refreshableMode'] = refreshableModeValue;
    }
    final refreshableStateValue = refreshableState;
    if (refreshableStateValue != null) {
      map['refreshableState'] = refreshableStateValue;
    }
    ...
    final sqlWebDeveloperUrlValue = sqlWebDeveloperUrl;
    if (sqlWebDeveloperUrlValue != null) {
      map['sqlWebDeveloperUrl'] = sqlWebDeveloperUrlValue;
    }
    final stateValue = state;
    if (stateValue != null) {
      map['state'] = stateValue;
    }
    final supportedCloneRegionsValue = supportedCloneRegions;
    if (supportedCloneRegionsValue != null) {
      map['supportedCloneRegions'] = supportedCloneRegionsValue;
    }
    final totalAutoBackupStorageSizeGbsValue = totalAutoBackupStorageSizeGbs;
    if (totalAutoBackupStorageSizeGbsValue != null) {
      map['totalAutoBackupStorageSizeGbs'] = totalAutoBackupStorageSizeGbsValue;
    }
    final usedDataStorageSizeTbsValue = usedDataStorageSizeTbs;
    if (usedDataStorageSizeTbsValue != null) {
      map['usedDataStorageSizeTbs'] = usedDataStorageSizeTbsValue;
    }
    final vaultIdValue = vaultId;
    if (vaultIdValue != null) {
      map['vaultId'] = vaultIdValue;
    }
    return map;
  }
  ...
  factory AutonomousDatabaseProperties.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseProperties(
      actualUsedDataStorageSizeTb: map['actualUsedDataStorageSizeTb'] == null
          ? null
          : map['actualUsedDataStorageSizeTb'] as double,
      allocatedStorageSizeTb: map['allocatedStorageSizeTb'] == null
          ? null
      ...
      arePrimaryAllowlistedIpsUsed: map['arePrimaryAllowlistedIpsUsed'] == null
          ? null
          : map['arePrimaryAllowlistedIpsUsed'] as bool,
      autonomousContainerDatabaseId:
          map['autonomousContainerDatabaseId'] == null
              ? null
              : map['autonomousContainerDatabaseId'] as String,
      availableUpgradeVersions: map['availableUpgradeVersions'] == null
          ? null
          : (map['availableUpgradeVersions'] as List).cast<String>(),
      backupRetentionPeriodDays: map['backupRetentionPeriodDays'] == null
          ? null
      ...
      customerContacts: map['customerContacts'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => AutonomousDatabasePropertiesCustomerContact.fromMap(
                  (value as Map).cast<String, dynamic>())),
      dataSafeState:
          map['dataSafeState'] == null ? null : map['dataSafeState'] as String,
      ...
      databaseManagementState: map['databaseManagementState'] == null
          ? null
      ...
      failedDataRecoveryDuration: map['failedDataRecoveryDuration'] == null
          ? null
          : map['failedDataRecoveryDuration'] as String,
      isAutoScalingEnabled: map['isAutoScalingEnabled'] == null
          ? null
          : map['isAutoScalingEnabled'] as bool,
      isLocalDataGuardEnabled: map['isLocalDataGuardEnabled'] == null
          ? null
          : map['isLocalDataGuardEnabled'] as bool,
      isStorageAutoScalingEnabled: map['isStorageAutoScalingEnabled'] == null
          ? null
      ...
      localAdgAutoFailoverMaxDataLossLimit:
          map['localAdgAutoFailoverMaxDataLossLimit'] == null
              ? null
              : map['localAdgAutoFailoverMaxDataLossLimit'] as int,
      localDisasterRecoveryType: map['localDisasterRecoveryType'] == null
          ? null
      ...
      localStandbyDbs: map['localStandbyDbs'] == null
          ...
          : pulumi.Input.decodeList<AutonomousDatabasePropertiesLocalStandbyDb>(
              ...
              (value) => AutonomousDatabasePropertiesLocalStandbyDb.fromMap(
                  (value as Map).cast<String, dynamic>())),
      maintenanceBeginTime: map['maintenanceBeginTime'] == null
          ? null
          : map['maintenanceBeginTime'] as String,
      maintenanceEndTime: map['maintenanceEndTime'] == null
          ? null
          : map['maintenanceEndTime'] as String,
      maintenanceScheduleType: map['maintenanceScheduleType'] == null
          ? null
          : map['maintenanceScheduleType'] as String,
      memoryPerOracleComputeUnitGbs:
          map['memoryPerOracleComputeUnitGbs'] == null
              ? null
              : map['memoryPerOracleComputeUnitGbs'] as int,
      memoryTableGbs:
          map['memoryTableGbs'] == null ? null : map['memoryTableGbs'] as int,
      mtlsConnectionRequired: map['mtlsConnectionRequired'] == null
          ? null
          : map['mtlsConnectionRequired'] as bool,
      nCharacterSet:
          map['nCharacterSet'] == null ? null : map['nCharacterSet'] as String,
      nextLongTermBackupTime: map['nextLongTermBackupTime'] == null
          ? null
      ...
      operationsInsightsState: map['operationsInsightsState'] == null
          ? null
          : map['operationsInsightsState'] as String,
      peerDbIds: map['peerDbIds'] == null
          ? null
          : (map['peerDbIds'] as List).cast<String>(),
      permissionLevel: map['permissionLevel'] == null
          ? null
          : map['permissionLevel'] as String,
      privateEndpoint: map['privateEndpoint'] == null
          ? null
          : map['privateEndpoint'] as String,
      privateEndpointIp: map['privateEndpointIp'] == null
          ? null
          : map['privateEndpointIp'] as String,
      privateEndpointLabel: map['privateEndpointLabel'] == null
          ? null
          : map['privateEndpointLabel'] as String,
      refreshableMode: map['refreshableMode'] == null
          ? null
          : map['refreshableMode'] as String,
      refreshableState: map['refreshableState'] == null
          ? null
      ...
      sqlWebDeveloperUrl: map['sqlWebDeveloperUrl'] == null
          ? null
          : map['sqlWebDeveloperUrl'] as String,
      state: map['state'] == null ? null : map['state'] as String,
      supportedCloneRegions: map['supportedCloneRegions'] == null
          ? null
          : (map['supportedCloneRegions'] as List).cast<String>(),
      totalAutoBackupStorageSizeGbs:
          map['totalAutoBackupStorageSizeGbs'] == null
              ? null
              : map['totalAutoBackupStorageSizeGbs'] as double,
      usedDataStorageSizeTbs: map['usedDataStorageSizeTbs'] == null
          ? null
