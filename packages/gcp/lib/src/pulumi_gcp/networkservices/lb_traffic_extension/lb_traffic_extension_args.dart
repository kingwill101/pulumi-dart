...
class LbTrafficExtensionArgs {
  ...
  final Input<List<LbTrafficExtensionExtensionChain>> extensionChains;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['extensionChains'] = Input.mapInputValue<
        ...
        extensionChains,
        (value) => Input.encodeList<LbTrafficExtensionExtensionChain,
  ...
  factory LbTrafficExtensionArgs.fromMap(Map<String, dynamic> map) {
    return LbTrafficExtensionArgs(
      ...
      extensionChains: Input.asInput<List<LbTrafficExtensionExtensionChain>>(
          map['extensionChains']),
