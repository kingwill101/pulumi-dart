...
/// ```
class MulticastDomainGroup extends CustomResource {
  ...
  /// UPDATE_FAILED
  /// INACTIVE
  late final Output<List<MulticastDomainGroupState>> states;
  ...
  MulticastDomainGroup(
    ...
    this.multicastDomainGroupId = Output.createUnknown<String>();
    this.multicastDomains = Output.createUnknown<List<String>>();
    this.name = Output.createUnknown<String>();
    this.project = Output.createUnknown<String>();
    this.pulumiLabels = Output.createUnknown<Map<String, String>>();
    this.states = Output.createUnknown<List<MulticastDomainGroupState>>();
