...
/// ```
class WasmPlugin extends CustomResource {
  ...
  late final Output<WasmPluginLogConfig?> logConfig;
  ...
  late final Output<String> mainVersionId;
  ...
  /// Structure is documented below.
  late final Output<List<WasmPluginUsedBy>> usedBies;
  ...
  /// Structure is documented below.
  late final Output<List<WasmPluginVersion>> versions;
