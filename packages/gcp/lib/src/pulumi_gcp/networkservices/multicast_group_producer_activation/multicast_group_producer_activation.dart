...
class MulticastGroupProducerActivation extends CustomResource {
  ...
  MulticastGroupProducerActivation(
    ...
    this.multicastGroupProducerActivationId = Output.createUnknown<String>();
    this.multicastGroupRangeActivation = Output.createUnknown<String>();
    this.multicastProducerAssociation = Output.createUnknown<String>();
    this.name = Output.createUnknown<String>();
    this.project = Output.createUnknown<String>();
    this.pulumiLabels = Output.createUnknown<Map<String, String>>();
    this.states =
        Output.createUnknown<List<MulticastGroupProducerActivationState>>();
