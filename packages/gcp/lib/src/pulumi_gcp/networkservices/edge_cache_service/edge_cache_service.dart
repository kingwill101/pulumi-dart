...
/// ```
class EdgeCacheService extends CustomResource {
  ...
  late final Output<bool?> disableHttp2;

  /// HTTP/3 (IETF QUIC) and Google QUIC are enabled by default.
  late final Output<bool> disableQuic;
  ...
  late final Output<List<String>?> edgeSslCertificates;

  /// All of labels (key/value pairs) present on the resource in GCP, including the labels configured through Pulumi, other clients and services.
  late final Output<Map<String, String>> effectiveLabels;

  /// The IPv4 addresses associated with this service. Addresses are static for the lifetime of the service.
  late final Output<List<String>> ipv4Addresses;
  ...
  late final Output<EdgeCacheServiceLogConfig?> logConfig;
  ...
  /// Structure is documented below.
  late final Output<EdgeCacheServiceRouting> routing;
