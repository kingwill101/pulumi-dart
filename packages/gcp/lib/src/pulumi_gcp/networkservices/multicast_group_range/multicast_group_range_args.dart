...
class MulticastGroupRangeArgs {
  ...
  factory MulticastGroupRangeArgs.fromMap(Map<String, dynamic> map) {
    return MulticastGroupRangeArgs(
      ...
      distributionScope:
          pulumi.Input.asOptionalInput<String>(map['distributionScope']),
      ...
      multicastGroupRangeId:
          pulumi.Input.asInput<String>(map['multicastGroupRangeId']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      requireExplicitAccept:
          pulumi.Input.asOptionalInput<bool>(map['requireExplicitAccept']),
      reservedInternalRange:
          pulumi.Input.asInput<String>(map['reservedInternalRange']),
    );
  }
}
