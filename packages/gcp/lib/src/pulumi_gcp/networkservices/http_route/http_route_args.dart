...
class HttpRouteArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = pulumi.Input.mapInputValue<List<HttpRouteRule>,
            List<Map<String, dynamic>>>(
        rules,
        (value) => pulumi.Input.encodeList<HttpRouteRule, Map<String, dynamic>>(
  ...
  factory HttpRouteArgs.fromMap(Map<String, dynamic> map) {
    return HttpRouteArgs(
      ...
      rules: pulumi.Input.asInput<List<HttpRouteRule>>(map['rules']),
    );
  }
}
