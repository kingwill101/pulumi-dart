...
class MulticastGroupConsumerActivation extends CustomResource {
  ...
  MulticastGroupConsumerActivation(
    ...
    this.logConfig =
        Output.createUnknown<MulticastGroupConsumerActivationLogConfig?>();
    this.multicastConsumerAssociation = Output.createUnknown<String>();
    this.multicastGroupConsumerActivationId = Output.createUnknown<String>();
    this.multicastGroupRangeActivation = Output.createUnknown<String>();
    this.name = Output.createUnknown<String>();
    this.project = Output.createUnknown<String>();
    this.pulumiLabels = Output.createUnknown<Map<String, String>>();
    this.states =
        Output.createUnknown<List<MulticastGroupConsumerActivationState>>();
