...
class BackupNetappArgs {
  ...
  factory BackupNetappArgs.fromMap(Map<String, dynamic> map) {
    return BackupNetappArgs(
      ...
      sourceVolume: pulumi.Input.asOptionalInput<String>(map['sourceVolume']),
