...
class VolumeTieringPolicy {
  ...
  Map<String, dynamic> toMap() {
    ...
    final hotTierBypassModeEnabledValue = hotTierBypassModeEnabled;
    if (hotTierBypassModeEnabledValue != null) {
      map['hotTierBypassModeEnabled'] = hotTierBypassModeEnabledValue;
    }
