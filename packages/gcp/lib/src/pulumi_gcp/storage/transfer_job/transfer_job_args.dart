...
class TransferJobArgs {
  ...
  /// Specifies the Event-driven transfer options. Event-driven transfers listen to an event stream to transfer updated files. Structure documented below Either <span pulumi-lang-nodejs="`eventStream`" pulumi-lang-dotnet="`EventStream`" pulumi-lang-go="`eventStream`" pulumi-lang-python="`event_stream`" pulumi-lang-yaml="`eventStream`" pulumi-lang-java="`eventStream`">`event_stream`</span> or <span pulumi-lang-nodejs="`schedule`" pulumi-lang-dotnet="`Schedule`" pulumi-lang-go="`schedule`" pulumi-lang-python="`schedule`" pulumi-lang-yaml="`schedule`" pulumi-lang-java="`schedule`">`schedule`</span> must be set.
  ...
  /// Replication specification. Structure documented below. User should not configure <span pulumi-lang-nodejs="`schedule`" pulumi-lang-dotnet="`Schedule`" pulumi-lang-go="`schedule`" pulumi-lang-python="`schedule`" pulumi-lang-yaml="`schedule`" pulumi-lang-java="`schedule`">`schedule`</span>, <span pulumi-lang-nodejs="`eventStream`" pulumi-lang-dotnet="`EventStream`" pulumi-lang-go="`eventStream`" pulumi-lang-python="`event_stream`" pulumi-lang-yaml="`eventStream`" pulumi-lang-java="`eventStream`">`event_stream`</span> with this argument. One of <span pulumi-lang-nodejs="`transferSpec`" pulumi-lang-dotnet="`TransferSpec`" pulumi-lang-go="`transferSpec`" pulumi-lang-python="`transfer_spec`" pulumi-lang-yaml="`transferSpec`" pulumi-lang-java="`transferSpec`">`transfer_spec`</span>, or <span pulumi-lang-nodejs="`replicationSpec`" pulumi-lang-dotnet="`ReplicationSpec`" pulumi-lang-go="`replicationSpec`" pulumi-lang-python="`replication_spec`" pulumi-lang-yaml="`replicationSpec`" pulumi-lang-java="`replicationSpec`">`replication_spec`</span> must be specified.
  ///
  /// - - -
  final Input<TransferJobReplicationSpec>? replicationSpec;

  /// Schedule specification defining when the Transfer Job should be scheduled to start, end and what time to run. Structure documented below. Either <span pulumi-lang-nodejs="`schedule`" pulumi-lang-dotnet="`Schedule`" pulumi-lang-go="`schedule`" pulumi-lang-python="`schedule`" pulumi-lang-yaml="`schedule`" pulumi-lang-java="`schedule`">`schedule`</span> or <span pulumi-lang-nodejs="`eventStream`" pulumi-lang-dotnet="`EventStream`" pulumi-lang-go="`eventStream`" pulumi-lang-python="`event_stream`" pulumi-lang-yaml="`eventStream`" pulumi-lang-java="`eventStream`">`event_stream`</span> must be set.
  ...
  /// Transfer specification. Structure documented below. One of <span pulumi-lang-nodejs="`transferSpec`" pulumi-lang-dotnet="`TransferSpec`" pulumi-lang-go="`transferSpec`" pulumi-lang-python="`transfer_spec`" pulumi-lang-yaml="`transferSpec`" pulumi-lang-java="`transferSpec`">`transfer_spec`</span>, or <span pulumi-lang-nodejs="`replicationSpec`" pulumi-lang-dotnet="`ReplicationSpec`" pulumi-lang-go="`replicationSpec`" pulumi-lang-python="`replication_spec`" pulumi-lang-yaml="`replicationSpec`" pulumi-lang-java="`replicationSpec`">`replication_spec`</span> can be specified.
