...
///
/// > Want fine-grained control over default object ACLs? Use <span pulumi-lang-nodejs="`gcp.storage.DefaultObjectAccessControl`" pulumi-lang-dotnet="`gcp.storage.DefaultObjectAccessControl`" pulumi-lang-go="`storage.DefaultObjectAccessControl`" pulumi-lang-python="`storage.DefaultObjectAccessControl`" pulumi-lang-yaml="`gcp.storage.DefaultObjectAccessControl`" pulumi-lang-java="`gcp.storage.DefaultObjectAccessControl`">`gcp.storage.DefaultObjectAccessControl`</span>
