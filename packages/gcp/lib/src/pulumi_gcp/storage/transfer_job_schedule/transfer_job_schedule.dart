...
class TransferJobSchedule {
  ...
  /// The last day the recurring transfer will be run. If <span pulumi-lang-nodejs="`scheduleEndDate`" pulumi-lang-dotnet="`ScheduleEndDate`" pulumi-lang-go="`scheduleEndDate`" pulumi-lang-python="`schedule_end_date`" pulumi-lang-yaml="`scheduleEndDate`" pulumi-lang-java="`scheduleEndDate`">`schedule_end_date`</span> is the same as <span pulumi-lang-nodejs="`scheduleStartDate`" pulumi-lang-dotnet="`ScheduleStartDate`" pulumi-lang-go="`scheduleStartDate`" pulumi-lang-python="`schedule_start_date`" pulumi-lang-yaml="`scheduleStartDate`" pulumi-lang-java="`scheduleStartDate`">`schedule_start_date`</span>, the transfer will be executed only once. Structure documented below.
  final TransferJobScheduleScheduleEndDate? scheduleEndDate;

  /// The first day the recurring transfer is scheduled to run. If <span pulumi-lang-nodejs="`scheduleStartDate`" pulumi-lang-dotnet="`ScheduleStartDate`" pulumi-lang-go="`scheduleStartDate`" pulumi-lang-python="`schedule_start_date`" pulumi-lang-yaml="`scheduleStartDate`" pulumi-lang-java="`scheduleStartDate`">`schedule_start_date`</span> is in the past, the transfer will run for the first time on the following day. Structure documented below.
