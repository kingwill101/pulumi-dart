...
/// [<span pulumi-lang-nodejs="`gcp.storage.getProjectServiceAccount`" pulumi-lang-dotnet="`gcp.storage.getProjectServiceAccount`" pulumi-lang-go="`storage.getProjectServiceAccount`" pulumi-lang-python="`storage_get_project_service_account`" pulumi-lang-yaml="`gcp.storage.getProjectServiceAccount`" pulumi-lang-java="`gcp.storage.getProjectServiceAccount`">`gcp.storage.getProjectServiceAccount`</span>](https://www.terraform.io/docs/providers/google/d/storage_project_service_account.html)
/// datasource's <span pulumi-lang-nodejs="`emailAddress`" pulumi-lang-dotnet="`EmailAddress`" pulumi-lang-go="`emailAddress`" pulumi-lang-python="`email_address`" pulumi-lang-yaml="`emailAddress`" pulumi-lang-java="`emailAddress`">`email_address`</span> value, and see below for an example of enabling notifications by granting the correct IAM permission.
...
/// making this resource dependent on those IAM resources via <span pulumi-lang-nodejs="`dependsOn`" pulumi-lang-dotnet="`DependsOn`" pulumi-lang-go="`dependsOn`" pulumi-lang-python="`depends_on`" pulumi-lang-yaml="`dependsOn`" pulumi-lang-java="`dependsOn`">`depends_on`</span>. This will safeguard against errors due to IAM race conditions.
///
/// ## Example Usage
///
