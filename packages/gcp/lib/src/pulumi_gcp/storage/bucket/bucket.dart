...
/// When creating a life cycle condition that does not also include an <span pulumi-lang-nodejs="`age`" pulumi-lang-dotnet="`Age`" pulumi-lang-go="`age`" pulumi-lang-python="`age`" pulumi-lang-yaml="`age`" pulumi-lang-java="`age`">`age`</span> field, a default <span pulumi-lang-nodejs="`age`" pulumi-lang-dotnet="`Age`" pulumi-lang-go="`age`" pulumi-lang-python="`age`" pulumi-lang-yaml="`age`" pulumi-lang-java="`age`">`age`</span> of 0 will be set. Set the <span pulumi-lang-nodejs="`sendAgeIfZero`" pulumi-lang-dotnet="`SendAgeIfZero`" pulumi-lang-go="`sendAgeIfZero`" pulumi-lang-python="`send_age_if_zero`" pulumi-lang-yaml="`sendAgeIfZero`" pulumi-lang-java="`sendAgeIfZero`">`send_age_if_zero`</span> flag to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span> to prevent this and avoid any potentially unintended interactions.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
class Bucket extends CustomResource {
  ...
  late final Output<BucketAutoclass?> autoclass;

  /// The bucket's [Cross-Origin Resource Sharing (CORS)](https://www.w3.org/TR/cors/) configuration. Multiple blocks of this type are permitted. Structure is documented below.
  late final Output<List<BucketCor>?> cors;

  /// The bucket's custom location configuration, which specifies the individual regions that comprise a dual-region bucket. If the bucket is designated a single or multi-region, the parameters are empty. Structure is documented below.
  late final Output<BucketCustomPlacementConfig?> customPlacementConfig;
  ...
  late final Output<BucketEncryption?> encryption;
  ...
  late final Output<BucketHierarchicalNamespace?> hierarchicalNamespace;
  ...
  late final Output<BucketIpFilter?> ipFilter;
  ...
  late final Output<int> projectNumber;
  ...
  late final Output<String> publicAccessPrevention;
  ...
  late final Output<BucketRetentionPolicy?> retentionPolicy;
  ...
  late final Output<BucketSoftDeletePolicy> softDeletePolicy;
  ...
  late final Output<bool> uniformBucketLevelAccess;
