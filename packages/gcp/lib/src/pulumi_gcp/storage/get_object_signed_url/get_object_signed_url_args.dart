...
class GetObjectSignedUrlArgs {
  ...
  factory GetObjectSignedUrlArgs.fromMap(Map<String, dynamic> map) {
    return GetObjectSignedUrlArgs(
      ...
      contentMd5: pulumi.Input.asOptionalInput<String>(map['contentMd5']),
      ...
      extensionHeaders: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['extensionHeaders']),
      httpMethod: pulumi.Input.asOptionalInput<String>(map['httpMethod']),
