...
import 'get_project_service_account_storage_args.dart';
import 'get_project_service_account_storage_result.dart';
...
///
/// ### Cloud KMS Keys
Future<GetProjectServiceAccountStorageResult> getProjectServiceAccountStorage(
  GetProjectServiceAccountStorageArgs args, {
  ...
  return GetProjectServiceAccountStorageResult.fromMap(result);
}
