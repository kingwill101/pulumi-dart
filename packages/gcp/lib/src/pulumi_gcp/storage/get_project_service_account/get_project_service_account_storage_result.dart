...
class GetProjectServiceAccountStorageResult {
  ...
  GetProjectServiceAccountStorageResult({
  ...
  factory GetProjectServiceAccountStorageResult.fromMap(
      Map<String, dynamic> map) {
    return GetProjectServiceAccountStorageResult(
