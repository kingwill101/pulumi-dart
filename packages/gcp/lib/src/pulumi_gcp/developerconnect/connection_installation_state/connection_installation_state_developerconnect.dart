...
class ConnectionInstallationStateDeveloperconnect {
  ...
  ConnectionInstallationStateDeveloperconnect({
    this.actionUri,
    this.message,
    this.stage,
  });
  ...
  factory ConnectionInstallationStateDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionInstallationStateDeveloperconnect(
