...
class ConnectionInstallationState2 {
  ...
  factory ConnectionInstallationState2.fromMap(Map<String, dynamic> map) {
    return ConnectionInstallationState2(
