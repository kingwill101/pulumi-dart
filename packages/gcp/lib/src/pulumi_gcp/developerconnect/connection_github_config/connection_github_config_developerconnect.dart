...
import '../connection_github_config_authorizer_credential/connection_github_config_authorizer_credential_developerconnect.dart';

class ConnectionGithubConfigDeveloperconnect {
  ...
  final ConnectionGithubConfigAuthorizerCredentialDeveloperconnect?
  ...
  factory ConnectionGithubConfigDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionGithubConfigDeveloperconnect(
      ...
      authorizerCredential: map['authorizerCredential'] == null
          ? null
          : ConnectionGithubConfigAuthorizerCredentialDeveloperconnect.fromMap(
