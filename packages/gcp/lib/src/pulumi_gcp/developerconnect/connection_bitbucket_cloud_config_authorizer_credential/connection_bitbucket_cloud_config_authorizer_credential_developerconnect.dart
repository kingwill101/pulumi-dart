...
class ConnectionBitbucketCloudConfigAuthorizerCredentialDeveloperconnect {
  ...
  factory ConnectionBitbucketCloudConfigAuthorizerCredentialDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionBitbucketCloudConfigAuthorizerCredentialDeveloperconnect(
