...
class ConnectionBitbucketDataCenterConfigReadAuthorizerCredentialDeveloperconnect {
  ...
  factory ConnectionBitbucketDataCenterConfigReadAuthorizerCredentialDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionBitbucketDataCenterConfigReadAuthorizerCredentialDeveloperconnect(
