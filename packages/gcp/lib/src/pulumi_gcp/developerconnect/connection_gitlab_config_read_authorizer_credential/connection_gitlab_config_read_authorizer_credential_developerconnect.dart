...
class ConnectionGitlabConfigReadAuthorizerCredentialDeveloperconnect {
  ...
  factory ConnectionGitlabConfigReadAuthorizerCredentialDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionGitlabConfigReadAuthorizerCredentialDeveloperconnect(
