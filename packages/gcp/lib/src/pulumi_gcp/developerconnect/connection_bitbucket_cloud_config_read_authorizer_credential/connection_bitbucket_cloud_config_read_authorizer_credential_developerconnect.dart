...
class ConnectionBitbucketCloudConfigReadAuthorizerCredentialDeveloperconnect {
  ...
  factory ConnectionBitbucketCloudConfigReadAuthorizerCredentialDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionBitbucketCloudConfigReadAuthorizerCredentialDeveloperconnect(
