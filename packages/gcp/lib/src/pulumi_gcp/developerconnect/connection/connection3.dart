...
import '../connection_installation_state/connection_installation_state2.dart';
...
class Connection3 extends CustomResource {
  ...
  late final Output<ConnectionBitbucketCloudConfig2?> bitbucketCloudConfig;

  /// Configuration for connections to an instance of Bitbucket Data Center.
  /// Structure is documented below.
  late final Output<ConnectionBitbucketDataCenterConfig2?>
  ...
  /// Structure is documented below.
  late final Output<ConnectionCryptoKeyConfig?> cryptoKeyConfig;
  ...
  /// Structure is documented below.
  late final Output<ConnectionGithubConfig2?> githubConfig;

  /// Configuration for connections to an instance of GitHub Enterprise.
  /// Structure is documented below.
  late final Output<ConnectionGithubEnterpriseConfig2?> githubEnterpriseConfig;

  /// Configuration for connections to gitlab.com.
  /// Structure is documented below.
  late final Output<ConnectionGitlabConfig2?> gitlabConfig;

  /// Configuration for connections to an instance of GitLab Enterprise.
  /// Structure is documented below.
  late final Output<ConnectionGitlabEnterpriseConfig?> gitlabEnterpriseConfig;

  /// Describes stage and necessary actions to be taken by the
  /// user to complete the installation. Used for GitHub and GitHub Enterprise
  /// based connections.
  /// Structure is documented below.
  late final Output<List<ConnectionInstallationState2>> installationStates;
