...
import '../connection_github_enterprise_config_service_directory_config/connection_github_enterprise_config_service_directory_config2.dart';

class ConnectionGithubEnterpriseConfig2 {
  ...
  final ConnectionGithubEnterpriseConfigServiceDirectoryConfig2?
  ...
  ConnectionGithubEnterpriseConfig2({
    this.appId,
  ...
  factory ConnectionGithubEnterpriseConfig2.fromMap(Map<String, dynamic> map) {
    return ConnectionGithubEnterpriseConfig2(
      ...
      serviceDirectoryConfig: map['serviceDirectoryConfig'] == null
          ? null
          : ConnectionGithubEnterpriseConfigServiceDirectoryConfig2.fromMap(
