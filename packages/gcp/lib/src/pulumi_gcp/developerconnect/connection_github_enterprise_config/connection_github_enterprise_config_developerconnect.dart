...
import '../connection_github_enterprise_config_service_directory_config/connection_github_enterprise_config_service_directory_config_developerconnect.dart';

class ConnectionGithubEnterpriseConfigDeveloperconnect {
  ...
  final ConnectionGithubEnterpriseConfigServiceDirectoryConfigDeveloperconnect?
  ...
  factory ConnectionGithubEnterpriseConfigDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionGithubEnterpriseConfigDeveloperconnect(
