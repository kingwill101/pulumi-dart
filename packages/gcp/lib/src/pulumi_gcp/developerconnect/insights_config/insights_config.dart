...
class InsightsConfig extends CustomResource {
  ...
  /// Each error will be in the format: `field_name:<span pulumi-lang-nodejs=" errorMessage`" pulumi-lang-dotnet=" ErrorMessage`" pulumi-lang-go=" errorMessage`" pulumi-lang-python=" error_message`" pulumi-lang-yaml=" errorMessage`" pulumi-lang-java=" errorMessage`"> error_message`</span>, e.g.
