...
class ConnectionBitbucketDataCenterConfigAuthorizerCredentialDeveloperconnect {
  ...
  factory ConnectionBitbucketDataCenterConfigAuthorizerCredentialDeveloperconnect.fromMap(
      Map<String, dynamic> map) {
    return ConnectionBitbucketDataCenterConfigAuthorizerCredentialDeveloperconnect(
