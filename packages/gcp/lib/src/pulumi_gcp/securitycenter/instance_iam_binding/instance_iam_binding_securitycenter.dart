...
import 'instance_iam_binding_securitycenter_args.dart';
...
/// ```
class InstanceIamBindingSecuritycenter extends pulumi.CustomResource {
  late final pulumi.Output<InstanceIamBindingConditionSecuritycenter?>
      condition;
  ...
  InstanceIamBindingSecuritycenter(
    String name, {
    InstanceIamBindingSecuritycenterArgs? args,
    ...
    this.condition =
        registerOutput<InstanceIamBindingConditionSecuritycenter?>('condition');
