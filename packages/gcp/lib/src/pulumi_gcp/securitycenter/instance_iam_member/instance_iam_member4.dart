...
import 'instance_iam_member_args4.dart';
...
/// ```
class InstanceIamMember4 extends CustomResource {
  late final Output<InstanceIamMemberCondition4?> condition;
  ...
  InstanceIamMember4(
    ...
    this.condition = registerOutput<InstanceIamMemberCondition4?>('condition');
