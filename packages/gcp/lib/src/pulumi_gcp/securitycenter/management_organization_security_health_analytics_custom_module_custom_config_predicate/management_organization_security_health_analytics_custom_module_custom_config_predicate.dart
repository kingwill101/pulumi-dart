...
class ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigPredicate {
  ...
  factory ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigPredicate.fromMap(
      Map<String, dynamic> map) {
    return ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigPredicate(
      description:
