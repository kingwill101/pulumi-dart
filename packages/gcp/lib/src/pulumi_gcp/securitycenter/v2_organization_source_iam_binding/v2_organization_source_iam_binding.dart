...
import '../v2_organization_source_iam_binding_condition/v2_organization_source_iam_binding_condition.dart';
...
///
/// full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
class V2OrganizationSourceIamBinding extends CustomResource {
  late final Output<V2OrganizationSourceIamBindingCondition?> condition;
