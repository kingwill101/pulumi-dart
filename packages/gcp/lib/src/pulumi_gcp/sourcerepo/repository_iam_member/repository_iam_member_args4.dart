...
class RepositoryIamMemberArgs4 {
  final Input<RepositoryIamMemberCondition4>? condition;
  ...
  factory RepositoryIamMemberArgs4.fromMap(Map<String, dynamic> map) {
    return RepositoryIamMemberArgs4(
      condition: Input.asOptionalInput<RepositoryIamMemberCondition4>(
          map['condition']),
