...
import '../repository_iam_member_condition/repository_iam_member_condition4.dart';
import 'repository_iam_member_args4.dart';
...
class RepositoryIamMember4 extends CustomResource {
  late final Output<RepositoryIamMemberCondition4?> condition;
  ...
  RepositoryIamMember4(
    String name, {
    RepositoryIamMemberArgs4? args,
    ...
    this.condition = Output.createUnknown<RepositoryIamMemberCondition4?>();
