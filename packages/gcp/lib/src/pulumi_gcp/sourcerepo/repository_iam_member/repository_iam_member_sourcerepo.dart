...
import 'repository_iam_member_sourcerepo_args.dart';
...
class RepositoryIamMemberSourcerepo extends pulumi.CustomResource {
  late final pulumi.Output<RepositoryIamMemberConditionSourcerepo?> condition;
  ...
  RepositoryIamMemberSourcerepo(
    String name, {
    RepositoryIamMemberSourcerepoArgs? args,
    ...
    this.condition =
        registerOutput<RepositoryIamMemberConditionSourcerepo?>('condition');
