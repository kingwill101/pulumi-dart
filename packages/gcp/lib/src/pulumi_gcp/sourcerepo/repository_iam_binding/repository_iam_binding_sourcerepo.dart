...
import 'repository_iam_binding_sourcerepo_args.dart';
...
class RepositoryIamBindingSourcerepo extends pulumi.CustomResource {
  late final pulumi.Output<RepositoryIamBindingConditionSourcerepo?> condition;
  ...
  RepositoryIamBindingSourcerepo(
    String name, {
    RepositoryIamBindingSourcerepoArgs? args,
    ...
    this.condition =
        registerOutput<RepositoryIamBindingConditionSourcerepo?>('condition');
