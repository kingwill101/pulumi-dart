...
class RepositoryIamBindingArgs4 {
  ...
  factory RepositoryIamBindingArgs4.fromMap(Map<String, dynamic> map) {
    return RepositoryIamBindingArgs4(
      condition: Input.asOptionalInput<RepositoryIamBindingCondition4>(
          map['condition']),
