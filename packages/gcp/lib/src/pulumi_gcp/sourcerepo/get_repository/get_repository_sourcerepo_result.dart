...
class GetRepositorySourcerepoResult {
  ...
  factory GetRepositorySourcerepoResult.fromMap(Map<String, dynamic> map) {
    return GetRepositorySourcerepoResult(
