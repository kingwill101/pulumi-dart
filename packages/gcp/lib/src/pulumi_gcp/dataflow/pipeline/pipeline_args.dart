...
class PipelineArgs {
  ...
  final Input<PipelineScheduleInfo>? scheduleInfo;
  ...
  /// Structure is documented below.
  final Input<PipelineWorkload>? workload;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (scheduleInfoValue != null) {
      map['scheduleInfo'] = Input.mapOptionalInputValue<PipelineScheduleInfo,
    ...
    if (workloadValue != null) {
      map['workload'] =
          Input.mapOptionalInputValue<PipelineWorkload, Map<String, dynamic>>(
              workloadValue, (value) => value.toMap());
    }
    return map;
  }
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      ...
      scheduleInfo:
          Input.asOptionalInput<PipelineScheduleInfo>(map['scheduleInfo']),
      schedulerServiceAccountEmail:
          Input.asOptionalInput<String>(map['schedulerServiceAccountEmail']),
      state: Input.asInput<String>(map['state']),
      type: Input.asInput<String>(map['type']),
      workload: Input.asOptionalInput<PipelineWorkload>(map['workload']),
    );
  }
}
