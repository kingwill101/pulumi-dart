...
///
/// A Dataflow job which is 'destroyed' may be "cancelled" or "drained".  If "cancelled", the job terminates - any data written remains where it is, but no new data will be processed.  If "drained", no new data will enter the pipeline, but any data currently in the pipeline will finish being processed.  The default is "drain". When <span pulumi-lang-nodejs="`onDelete`" pulumi-lang-dotnet="`OnDelete`" pulumi-lang-go="`onDelete`" pulumi-lang-python="`on_delete`" pulumi-lang-yaml="`onDelete`" pulumi-lang-java="`onDelete`">`on_delete`</span> is set to `"drain"` in the configuration, you may experience a long wait for your `pulumi destroy` to complete.
///
/// You can potentially short-circuit the wait by setting <span pulumi-lang-nodejs="`skipWaitOnJobTermination`" pulumi-lang-dotnet="`SkipWaitOnJobTermination`" pulumi-lang-go="`skipWaitOnJobTermination`" pulumi-lang-python="`skip_wait_on_job_termination`" pulumi-lang-yaml="`skipWaitOnJobTermination`" pulumi-lang-java="`skipWaitOnJobTermination`">`skip_wait_on_job_termination`</span> to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>, but beware that unless you take active steps to ensure that the job <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span> parameter changes between instances, the name will conflict and the launch of the new job will fail. One way to do this is with a<span pulumi-lang-nodejs=" randomId " pulumi-lang-dotnet=" RandomId " pulumi-lang-go=" randomId " pulumi-lang-python=" random_id " pulumi-lang-yaml=" randomId " pulumi-lang-java=" randomId "> random_id </span>resource, for example:
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
