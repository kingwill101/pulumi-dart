...
class JobDataflowArgs {
  ...
  factory JobDataflowArgs.fromMap(Map<String, dynamic> map) {
    return JobDataflowArgs(
      ...
      tempGcsLocation: pulumi.Input.asInput<String>(map['tempGcsLocation']),
      templateGcsPath: pulumi.Input.asInput<String>(map['templateGcsPath']),
