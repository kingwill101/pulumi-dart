...
class TaskIamMemberArgs {
  final Input<TaskIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<TaskIamMemberCondition,
  ...
  factory TaskIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return TaskIamMemberArgs(
      condition:
          Input.asOptionalInput<TaskIamMemberCondition>(map['condition']),
