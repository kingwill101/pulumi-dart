...
class TaskIamBindingArgs {
  final Input<TaskIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<TaskIamBindingCondition,
  ...
  factory TaskIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TaskIamBindingArgs(
      condition:
          Input.asOptionalInput<TaskIamBindingCondition>(map['condition']),
