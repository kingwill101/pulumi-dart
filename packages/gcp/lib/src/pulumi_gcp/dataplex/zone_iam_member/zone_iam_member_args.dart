...
class ZoneIamMemberArgs {
  final Input<ZoneIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<ZoneIamMemberCondition,
  ...
  factory ZoneIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ZoneIamMemberArgs(
      condition:
          Input.asOptionalInput<ZoneIamMemberCondition>(map['condition']),
