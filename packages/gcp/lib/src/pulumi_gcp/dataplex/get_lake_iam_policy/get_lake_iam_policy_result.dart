...
class GetLakeIamPolicyResult {
  ...
  /// (Required only by <span pulumi-lang-nodejs="`gcp.dataplex.LakeIamPolicy`" pulumi-lang-dotnet="`gcp.dataplex.LakeIamPolicy`" pulumi-lang-go="`dataplex.LakeIamPolicy`" pulumi-lang-python="`dataplex.LakeIamPolicy`" pulumi-lang-yaml="`gcp.dataplex.LakeIamPolicy`" pulumi-lang-java="`gcp.dataplex.LakeIamPolicy`">`gcp.dataplex.LakeIamPolicy`</span>) The policy data generated by
