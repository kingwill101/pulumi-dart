...
class LakeIamMemberArgs {
  final Input<LakeIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<LakeIamMemberCondition,
  ...
  factory LakeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LakeIamMemberArgs(
      condition:
          Input.asOptionalInput<LakeIamMemberCondition>(map['condition']),
