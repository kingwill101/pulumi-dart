...
class Datascan extends CustomResource {
  ...
  /// The relative resource name of the scan, of the form: projects/{project}/locations/{locationId}/dataScans/{datascan_id}, where project refers to a<span pulumi-lang-nodejs=" projectId " pulumi-lang-dotnet=" ProjectId " pulumi-lang-go=" projectId " pulumi-lang-python=" project_id " pulumi-lang-yaml=" projectId " pulumi-lang-java=" projectId "> project_id </span>or<span pulumi-lang-nodejs=" projectNumber " pulumi-lang-dotnet=" ProjectNumber " pulumi-lang-go=" projectNumber " pulumi-lang-python=" project_number " pulumi-lang-yaml=" projectNumber " pulumi-lang-java=" projectNumber "> project_number </span>and locationId refers to a GCP region.
  ...
  Datascan(
    ...
    this.data = Output.createUnknown<DatascanData>();
    this.dataDiscoverySpec = Output.createUnknown<DatascanDataDiscoverySpec?>();
    this.dataDocumentationSpec = Output.createUnknown<Map<String, dynamic>?>();
    this.dataProfileSpec = Output.createUnknown<DatascanDataProfileSpec?>();
    this.dataQualitySpec = Output.createUnknown<DatascanDataQualitySpec?>();
    this.dataScanId = Output.createUnknown<String>();
    this.description = Output.createUnknown<String?>();
    this.displayName = Output.createUnknown<String?>();
    this.effectiveLabels = Output.createUnknown<Map<String, String>>();
    this.executionSpec = Output.createUnknown<DatascanExecutionSpec>();
    this.executionStatuses =
        Output.createUnknown<List<DatascanExecutionStatus>>();
