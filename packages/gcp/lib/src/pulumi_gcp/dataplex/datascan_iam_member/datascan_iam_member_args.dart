...
class DatascanIamMemberArgs {
  final Input<DatascanIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<DatascanIamMemberCondition,
  ...
  factory DatascanIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DatascanIamMemberArgs(
      condition:
          Input.asOptionalInput<DatascanIamMemberCondition>(map['condition']),
