...
class LakeIamBindingArgs {
  final Input<LakeIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<LakeIamBindingCondition,
  ...
  factory LakeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LakeIamBindingArgs(
      condition:
          Input.asOptionalInput<LakeIamBindingCondition>(map['condition']),
