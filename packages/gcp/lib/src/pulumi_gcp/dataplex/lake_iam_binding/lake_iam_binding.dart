...
import '../lake_iam_binding_condition/lake_iam_binding_condition.dart';
...
class LakeIamBinding extends CustomResource {
  late final Output<LakeIamBindingCondition?> condition;
  ...
  LakeIamBinding(
    ...
    this.condition = registerOutput<LakeIamBindingCondition?>('condition');
