...
class EntryGroupIamBindingArgs2 {
  final Input<EntryGroupIamBindingCondition2>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<
          EntryGroupIamBindingCondition2,
  ...
  factory EntryGroupIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamBindingArgs2(
      condition: Input.asOptionalInput<EntryGroupIamBindingCondition2>(
          map['condition']),
