...
import 'entry_group_iam_binding_dataplex_args.dart';
...
class EntryGroupIamBindingDataplex extends pulumi.CustomResource {
  late final pulumi.Output<EntryGroupIamBindingConditionDataplex?> condition;
  ...
  EntryGroupIamBindingDataplex(
    String name, {
    EntryGroupIamBindingDataplexArgs? args,
    ...
    this.condition =
        registerOutput<EntryGroupIamBindingConditionDataplex?>('condition');
