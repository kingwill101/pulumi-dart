...
import 'entry_group_iam_member_dataplex_args.dart';
...
class EntryGroupIamMemberDataplex extends pulumi.CustomResource {
  late final pulumi.Output<EntryGroupIamMemberConditionDataplex?> condition;
  ...
  EntryGroupIamMemberDataplex(
    String name, {
    EntryGroupIamMemberDataplexArgs? args,
    ...
    this.condition =
        registerOutput<EntryGroupIamMemberConditionDataplex?>('condition');
