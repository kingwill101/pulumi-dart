...
class EntryGroupIamMemberArgs2 {
  final Input<EntryGroupIamMemberCondition2>? condition;
  ...
  factory EntryGroupIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamMemberArgs2(
      condition: Input.asOptionalInput<EntryGroupIamMemberCondition2>(
          map['condition']),
