...
import '../entry_group_iam_member_condition/entry_group_iam_member_condition2.dart';
import 'entry_group_iam_member_args2.dart';
...
class EntryGroupIamMember2 extends CustomResource {
  late final Output<EntryGroupIamMemberCondition2?> condition;
  ...
  EntryGroupIamMember2(
    String name, {
    EntryGroupIamMemberArgs2? args,
    ...
    this.condition = Output.createUnknown<EntryGroupIamMemberCondition2?>();
