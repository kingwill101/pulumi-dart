...
import '../aspect_type_iam_member_condition/aspect_type_iam_member_condition.dart';
import 'aspect_type_iam_member_args.dart';
...
class AspectTypeIamMember extends CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final Output<String> aspectTypeId;
  late final Output<AspectTypeIamMemberCondition?> condition;
  ...
  AspectTypeIamMember(
    ...
    this.condition = registerOutput<AspectTypeIamMemberCondition?>('condition');
