...
import 'entry_group_iam_policy_dataplex_args.dart';
...
class EntryGroupIamPolicyDataplex extends pulumi.CustomResource {
  ...
  EntryGroupIamPolicyDataplex(
    String name, {
    EntryGroupIamPolicyDataplexArgs? args,
