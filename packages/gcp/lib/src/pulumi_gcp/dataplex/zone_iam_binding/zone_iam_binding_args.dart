...
class ZoneIamBindingArgs {
  final Input<ZoneIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<ZoneIamBindingCondition,
  ...
  factory ZoneIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ZoneIamBindingArgs(
      condition:
          Input.asOptionalInput<ZoneIamBindingCondition>(map['condition']),
