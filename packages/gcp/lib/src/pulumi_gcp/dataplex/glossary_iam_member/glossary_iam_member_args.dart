...
class GlossaryIamMemberArgs {
  final Input<GlossaryIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<GlossaryIamMemberCondition,
  ...
  factory GlossaryIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return GlossaryIamMemberArgs(
      condition:
          Input.asOptionalInput<GlossaryIamMemberCondition>(map['condition']),
