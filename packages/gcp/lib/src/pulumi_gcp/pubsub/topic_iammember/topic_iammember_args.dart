...
class TopicIAMMemberArgs {
  final Input<TopicIAMMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<TopicIAMMemberCondition,
  ...
  factory TopicIAMMemberArgs.fromMap(Map<String, dynamic> map) {
    return TopicIAMMemberArgs(
      condition:
          Input.asOptionalInput<TopicIAMMemberCondition>(map['condition']),
