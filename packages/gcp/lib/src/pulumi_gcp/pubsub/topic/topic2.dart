...
class Topic2 extends CustomResource {
  ...
  late final Output<TopicIngestionDataSourceSettings?>
      ingestionDataSourceSettings;
  ...
  /// Structure is documented below.
  late final Output<TopicMessageStoragePolicy> messageStoragePolicy;

  /// Transforms to be applied to messages published to the topic. Transforms are applied in the
  /// order specified.
  /// Structure is documented below.
  late final Output<List<TopicMessageTransform>?> messageTransforms;
  ...
  /// Structure is documented below.
  late final Output<TopicSchemaSettings?> schemaSettings;
