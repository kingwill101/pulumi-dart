...
class TopicArgs2 {
  ...
  final Input<TopicIngestionDataSourceSettings>? ingestionDataSourceSettings;
  ...
  /// Structure is documented below.
  final Input<TopicMessageStoragePolicy>? messageStoragePolicy;

  /// Transforms to be applied to messages published to the topic. Transforms are applied in the
  /// order specified.
  /// Structure is documented below.
  final Input<List<TopicMessageTransform>>? messageTransforms;
  ...
  /// Structure is documented below.
  final Input<TopicSchemaSettings>? schemaSettings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ingestionDataSourceSettingsValue != null) {
      map['ingestionDataSourceSettings'] = Input.mapOptionalInputValue<
    ...
    if (messageStoragePolicyValue != null) {
      map['messageStoragePolicy'] = Input.mapOptionalInputValue<
    ...
    if (messageTransformsValue != null) {
      map['messageTransforms'] = Input.mapOptionalInputValue<
          ...
          (value) =>
              Input.encodeList<TopicMessageTransform, Map<String, dynamic>>(
    ...
    if (schemaSettingsValue != null) {
      map['schemaSettings'] = Input.mapOptionalInputValue<TopicSchemaSettings,
  ...
  factory TopicArgs2.fromMap(Map<String, dynamic> map) {
    return TopicArgs2(
      ingestionDataSourceSettings:
          Input.asOptionalInput<TopicIngestionDataSourceSettings>(
      ...
      messageStoragePolicy: Input.asOptionalInput<TopicMessageStoragePolicy>(
          map['messageStoragePolicy']),
      messageTransforms: Input.asOptionalInput<List<TopicMessageTransform>>(
          map['messageTransforms']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      schemaSettings:
          Input.asOptionalInput<TopicSchemaSettings>(map['schemaSettings']),
