...
class SchemaIamBindingArgs {
  final Input<SchemaIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<SchemaIamBindingCondition,
  ...
  factory SchemaIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return SchemaIamBindingArgs(
      condition:
          Input.asOptionalInput<SchemaIamBindingCondition>(map['condition']),
