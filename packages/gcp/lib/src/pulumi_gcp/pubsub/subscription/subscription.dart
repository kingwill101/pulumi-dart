...
/// by using the <span pulumi-lang-nodejs="`gcp.projects.ServiceIdentity`" pulumi-lang-dotnet="`gcp.projects.ServiceIdentity`" pulumi-lang-go="`projects.ServiceIdentity`" pulumi-lang-python="`projects.ServiceIdentity`" pulumi-lang-yaml="`gcp.projects.ServiceIdentity`" pulumi-lang-java="`gcp.projects.ServiceIdentity`">`gcp.projects.ServiceIdentity`</span> resource.
///
/// ## Example Usage
///
