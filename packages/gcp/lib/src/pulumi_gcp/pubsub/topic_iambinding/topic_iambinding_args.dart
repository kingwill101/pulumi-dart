...
class TopicIAMBindingArgs {
  final Input<TopicIAMBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<TopicIAMBindingCondition,
  ...
  factory TopicIAMBindingArgs.fromMap(Map<String, dynamic> map) {
    return TopicIAMBindingArgs(
      condition:
          Input.asOptionalInput<TopicIAMBindingCondition>(map['condition']),
