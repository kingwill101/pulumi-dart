...
/// > **Warning:** [Pubsub Lite is deprecated and will be turned down effective March 18, 2026](https://cloud.google.com/pubsub/lite/docs/release-notes#June_17_2024). The resource will be removed in a future major release, please use <span pulumi-lang-nodejs="`gcp.pubsub.Subscription`" pulumi-lang-dotnet="`gcp.pubsub.Subscription`" pulumi-lang-go="`pubsub.Subscription`" pulumi-lang-python="`pubsub.Subscription`" pulumi-lang-yaml="`gcp.pubsub.Subscription`" pulumi-lang-java="`gcp.pubsub.Subscription`">`gcp.pubsub.Subscription`</span> instead.
///
