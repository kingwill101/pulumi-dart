...
class MulticloudDataTransferConfig extends CustomResource {
  ...
  MulticloudDataTransferConfig(
    ...
    this.destinationsActiveCount = Output.createUnknown<int>();
    this.destinationsCount = Output.createUnknown<int>();
    ...
    this.services =
        Output.createUnknown<List<MulticloudDataTransferConfigService>?>();
