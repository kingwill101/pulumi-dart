...
class InternalRange extends CustomResource {
  ...
  late final Output<InternalRangeAllocationOptions?> allocationOptions;
  ...
  /// Structure is documented below.
  late final Output<InternalRangeMigration?> migration;
  ...
  late final Output<List<String>?> targetCidrRanges;
