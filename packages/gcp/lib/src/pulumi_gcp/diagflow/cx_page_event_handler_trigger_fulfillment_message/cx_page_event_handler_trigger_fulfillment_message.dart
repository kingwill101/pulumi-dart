...
import '../cx_page_event_handler_trigger_fulfillment_message_conversation_success/cx_page_event_handler_trigger_fulfillment_message_conversation_success.dart';
import '../cx_page_event_handler_trigger_fulfillment_message_live_agent_handoff/cx_page_event_handler_trigger_fulfillment_message_live_agent_handoff.dart';
import '../cx_page_event_handler_trigger_fulfillment_message_output_audio_text/cx_page_event_handler_trigger_fulfillment_message_output_audio_text.dart';
import '../cx_page_event_handler_trigger_fulfillment_message_play_audio/cx_page_event_handler_trigger_fulfillment_message_play_audio.dart';
import '../cx_page_event_handler_trigger_fulfillment_message_telephony_transfer_call/cx_page_event_handler_trigger_fulfillment_message_telephony_transfer_call.dart';
import '../cx_page_event_handler_trigger_fulfillment_message_text/cx_page_event_handler_trigger_fulfillment_message_text.dart';
...
class CxPageEventHandlerTriggerFulfillmentMessage {
  ...
  final CxPageEventHandlerTriggerFulfillmentMessageConversationSuccess?
      conversationSuccess;
  ...
  /// This field is part of a union field <span pulumi-lang-nodejs="`message`" pulumi-lang-dotnet="`Message`" pulumi-lang-go="`message`" pulumi-lang-python="`message`" pulumi-lang-yaml="`message`" pulumi-lang-java="`message`">`message`</span>: Only one of <span pulumi-lang-nodejs="`text`" pulumi-lang-dotnet="`Text`" pulumi-lang-go="`text`" pulumi-lang-python="`text`" pulumi-lang-yaml="`text`" pulumi-lang-java="`text`">`text`</span>, <span pulumi-lang-nodejs="`payload`" pulumi-lang-dotnet="`Payload`" pulumi-lang-go="`payload`" pulumi-lang-python="`payload`" pulumi-lang-yaml="`payload`" pulumi-lang-java="`payload`">`payload`</span>, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
  /// Structure is documented below.
  final CxPageEventHandlerTriggerFulfillmentMessageLiveAgentHandoff?
      liveAgentHandoff;

  /// A text or ssml response that is preferentially used for TTS output audio synthesis, as described in the comment on the ResponseMessage message.
  /// This field is part of a union field <span pulumi-lang-nodejs="`message`" pulumi-lang-dotnet="`Message`" pulumi-lang-go="`message`" pulumi-lang-python="`message`" pulumi-lang-yaml="`message`" pulumi-lang-java="`message`">`message`</span>: Only one of <span pulumi-lang-nodejs="`text`" pulumi-lang-dotnet="`Text`" pulumi-lang-go="`text`" pulumi-lang-python="`text`" pulumi-lang-yaml="`text`" pulumi-lang-java="`text`">`text`</span>, <span pulumi-lang-nodejs="`payload`" pulumi-lang-dotnet="`Payload`" pulumi-lang-go="`payload`" pulumi-lang-python="`payload`" pulumi-lang-yaml="`payload`" pulumi-lang-java="`payload`">`payload`</span>, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
  /// Structure is documented below.
  final CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText?
      outputAudioText;
  ...
  /// This field is part of a union field <span pulumi-lang-nodejs="`message`" pulumi-lang-dotnet="`Message`" pulumi-lang-go="`message`" pulumi-lang-python="`message`" pulumi-lang-yaml="`message`" pulumi-lang-java="`message`">`message`</span>: Only one of <span pulumi-lang-nodejs="`text`" pulumi-lang-dotnet="`Text`" pulumi-lang-go="`text`" pulumi-lang-python="`text`" pulumi-lang-yaml="`text`" pulumi-lang-java="`text`">`text`</span>, <span pulumi-lang-nodejs="`payload`" pulumi-lang-dotnet="`Payload`" pulumi-lang-go="`payload`" pulumi-lang-python="`payload`" pulumi-lang-yaml="`payload`" pulumi-lang-java="`payload`">`payload`</span>, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
  /// Structure is documented below.
  final CxPageEventHandlerTriggerFulfillmentMessageTelephonyTransferCall?
  ...
  factory CxPageEventHandlerTriggerFulfillmentMessage.fromMap(
    ...
    return CxPageEventHandlerTriggerFulfillmentMessage(
      ...
      liveAgentHandoff: map['liveAgentHandoff'] == null
          ? null
          : CxPageEventHandlerTriggerFulfillmentMessageLiveAgentHandoff.fromMap(
              (map['liveAgentHandoff'] as Map).cast<String, dynamic>()),
      outputAudioText: map['outputAudioText'] == null
          ? null
          : CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText.fromMap(
      ...
      playAudio: map['playAudio'] == null
          ? null
          : CxPageEventHandlerTriggerFulfillmentMessagePlayAudio.fromMap(
      ...
      text: map['text'] == null
          ? null
          : CxPageEventHandlerTriggerFulfillmentMessageText.fromMap(
