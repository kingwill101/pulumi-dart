...
class CxFlowArgs {
  ...
  final Input<CxFlowAdvancedSettings>? advancedSettings;
  ...
  /// Structure is documented below.
  final Input<CxFlowKnowledgeConnectorSettings>? knowledgeConnectorSettings;
  ...
  /// Structure is documented below.
  final Input<CxFlowNluSettings>? nluSettings;
  ...
  /// Structure is documented below.
  final Input<List<CxFlowTransitionRoute>>? transitionRoutes;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (eventHandlersValue != null) {
      map['eventHandlers'] = Input.mapOptionalInputValue<
          ...
          eventHandlersValue,
          (value) => Input.encodeList<CxFlowEventHandler, Map<String, dynamic>>(
    ...
    if (nluSettingsValue != null) {
      map['nluSettings'] =
          Input.mapOptionalInputValue<CxFlowNluSettings, Map<String, dynamic>>(
              nluSettingsValue, (value) => value.toMap());
    }
    ...
    if (transitionRoutesValue != null) {
      map['transitionRoutes'] = Input.mapOptionalInputValue<
          ...
          (value) =>
              Input.encodeList<CxFlowTransitionRoute, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    return map;
  }
  ...
  factory CxFlowArgs.fromMap(Map<String, dynamic> map) {
    return CxFlowArgs(
      advancedSettings: Input.asOptionalInput<CxFlowAdvancedSettings>(
          map['advancedSettings']),
      description: Input.asOptionalInput<String>(map['description']),
      displayName: Input.asInput<String>(map['displayName']),
      eventHandlers:
          Input.asOptionalInput<List<CxFlowEventHandler>>(map['eventHandlers']),
      isDefaultStartFlow:
          Input.asOptionalInput<bool>(map['isDefaultStartFlow']),
      knowledgeConnectorSettings:
          Input.asOptionalInput<CxFlowKnowledgeConnectorSettings>(
              map['knowledgeConnectorSettings']),
      languageCode: Input.asOptionalInput<String>(map['languageCode']),
      nluSettings: Input.asOptionalInput<CxFlowNluSettings>(map['nluSettings']),
      parent: Input.asOptionalInput<String>(map['parent']),
      transitionRouteGroups:
          Input.asOptionalInput<List<String>>(map['transitionRouteGroups']),
      transitionRoutes: Input.asOptionalInput<List<CxFlowTransitionRoute>>(
