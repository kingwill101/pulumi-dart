...
import '../conversation_profile_tts_config_voice/conversation_profile_tts_config_voice.dart';
...
class ConversationProfileTtsConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final effectsProfileIdsValue = effectsProfileIds;
    if (effectsProfileIdsValue != null) {
      map['effectsProfileIds'] = effectsProfileIdsValue;
    }
