...
class CxSecuritySettingsArgs {
  ...
  factory CxSecuritySettingsArgs.fromMap(Map<String, dynamic> map) {
    return CxSecuritySettingsArgs(
      ...
      purgeDataTypes:
          pulumi.Input.asOptionalInput<List<String>>(map['purgeDataTypes']),
      redactionScope:
          pulumi.Input.asOptionalInput<String>(map['redactionScope']),
      redactionStrategy:
          pulumi.Input.asOptionalInput<String>(map['redactionStrategy']),
      retentionStrategy:
          pulumi.Input.asOptionalInput<String>(map['retentionStrategy']),
      retentionWindowDays:
