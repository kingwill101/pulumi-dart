...
/// ```
class CxTestCase extends CustomResource {
  ...
  late final Output<List<CxTestCaseLastTestResult>> lastTestResults;
  ...
  /// Structure is documented below.
  late final Output<List<CxTestCaseTestCaseConversationTurn>?>
      testCaseConversationTurns;

  /// Config for the test case.
  /// Structure is documented below.
  late final Output<CxTestCaseTestConfig?> testConfig;
