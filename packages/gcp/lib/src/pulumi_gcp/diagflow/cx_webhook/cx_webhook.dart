...
/// ```
class CxWebhook extends CustomResource {
  ...
  late final Output<CxWebhookGenericWebService?> genericWebService;
  ...
  /// Structure is documented below.
  late final Output<CxWebhookServiceDirectory?> serviceDirectory;
