...
/// ```
class CxPage extends CustomResource {
  /// Hierarchical advanced settings for this page. The settings exposed at the lower level overrides the settings exposed at the higher level.
  /// Hierarchy: Agent->Flow->Page->Fulfillment/Parameter.
  /// Structure is documented below.
  late final Output<CxPageAdvancedSettings?> advancedSettings;
  ...
  /// Structure is documented below.
  late final Output<CxPageEntryFulfillment?> entryFulfillment;

  /// Handlers associated with the page to handle events such as webhook errors, no match or no input.
  /// Structure is documented below.
  late final Output<List<CxPageEventHandler>?> eventHandlers;

  /// The form associated with the page, used for collecting parameters relevant to the page.
  /// Structure is documented below.
  late final Output<CxPageForm?> form;

  /// Knowledge connector configuration.
  /// Structure is documented below.
  late final Output<CxPageKnowledgeConnectorSettings?>
      knowledgeConnectorSettings;
  ...
  /// Structure is documented below.
  late final Output<List<CxPageTransitionRoute>?> transitionRoutes;
