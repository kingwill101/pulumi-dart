...
class CxPageFormParameterFillBehavior {
  ...
  Map<String, dynamic> toMap() {
    ...
    final initialPromptFulfillmentValue = initialPromptFulfillment;
    if (initialPromptFulfillmentValue != null) {
      map['initialPromptFulfillment'] = initialPromptFulfillmentValue.toMap();
    }
