...
class CxGenerativeSettingsKnowledgeConnectorSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final agentIdentityValue = agentIdentity;
    if (agentIdentityValue != null) {
      map['agentIdentity'] = agentIdentityValue;
    }
    final agentScopeValue = agentScope;
    if (agentScopeValue != null) {
      map['agentScope'] = agentScopeValue;
    }
    final businessValue = business;
    if (businessValue != null) {
      map['business'] = businessValue;
    }
    final businessDescriptionValue = businessDescription;
    if (businessDescriptionValue != null) {
      map['businessDescription'] = businessDescriptionValue;
    }
    final disableDataStoreFallbackValue = disableDataStoreFallback;
    if (disableDataStoreFallbackValue != null) {
      map['disableDataStoreFallback'] = disableDataStoreFallbackValue;
    }
    return map;
  }
  ...
  factory CxGenerativeSettingsKnowledgeConnectorSettings.fromMap(
    ...
    return CxGenerativeSettingsKnowledgeConnectorSettings(
      ...
      agentIdentity:
          map['agentIdentity'] == null ? null : map['agentIdentity'] as String,
      agentScope:
          map['agentScope'] == null ? null : map['agentScope'] as String,
