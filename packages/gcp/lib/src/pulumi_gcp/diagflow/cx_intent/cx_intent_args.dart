  ...
  Map<String, dynamic> toMap() {
    ...
    if (parametersValue != null) {
      map['parameters'] = pulumi.Input.mapOptionalInputValue<
              List<CxIntentParameter>, List<Map<String, dynamic>>>(
          parametersValue,
          (value) =>
              pulumi.Input.encodeList<CxIntentParameter, Map<String, dynamic>>(
    ...
    if (trainingPhrasesValue != null) {
      map['trainingPhrases'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<CxIntentTrainingPhrase,
  ...
  factory CxIntentArgs.fromMap(Map<String, dynamic> map) {
    return CxIntentArgs(
      ...
      isDefaultNegativeIntent:
          pulumi.Input.asOptionalInput<bool>(map['isDefaultNegativeIntent']),
      isDefaultWelcomeIntent:
          pulumi.Input.asOptionalInput<bool>(map['isDefaultWelcomeIntent']),
      ...
      parameters: pulumi.Input.asOptionalInput<List<CxIntentParameter>>(
          map['parameters']),
      parent: pulumi.Input.asOptionalInput<String>(map['parent']),
      priority: pulumi.Input.asOptionalInput<int>(map['priority']),
      trainingPhrases:
          pulumi.Input.asOptionalInput<List<CxIntentTrainingPhrase>>(
              map['trainingPhrases']),
    );
  }
}
