...
class AgentDiagflowArgs {
  ...
  factory AgentDiagflowArgs.fromMap(Map<String, dynamic> map) {
    return AgentDiagflowArgs(
      ...
      classificationThreshold:
          pulumi.Input.asOptionalInput<double>(map['classificationThreshold']),
      defaultLanguageCode:
      ...
      matchMode: pulumi.Input.asOptionalInput<String>(map['matchMode']),
