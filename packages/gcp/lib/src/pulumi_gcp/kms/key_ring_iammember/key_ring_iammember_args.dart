...
class KeyRingIAMMemberArgs {
  ...
  final Input<KeyRingIAMMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<KeyRingIAMMemberCondition,
  ...
  factory KeyRingIAMMemberArgs.fromMap(Map<String, dynamic> map) {
    return KeyRingIAMMemberArgs(
      condition:
          Input.asOptionalInput<KeyRingIAMMemberCondition>(map['condition']),
