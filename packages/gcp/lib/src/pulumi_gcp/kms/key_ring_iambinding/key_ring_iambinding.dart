...
///
/// * <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMPolicy`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMPolicy`" pulumi-lang-go="`kms.KeyRingIAMPolicy`" pulumi-lang-python="`kms.KeyRingIAMPolicy`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMPolicy`" pulumi-lang-java="`gcp.kms.KeyRingIAMPolicy`">`gcp.kms.KeyRingIAMPolicy`</span>: Authoritative. Sets the IAM policy for the key ring and replaces any existing policy already attached.
/// * <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-go="`kms.KeyRingIAMBinding`" pulumi-lang-python="`kms.KeyRingIAMBinding`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-java="`gcp.kms.KeyRingIAMBinding`">`gcp.kms.KeyRingIAMBinding`</span>: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the key ring are preserved.
/// * <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMMember`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMMember`" pulumi-lang-go="`kms.KeyRingIAMMember`" pulumi-lang-python="`kms.KeyRingIAMMember`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMMember`" pulumi-lang-java="`gcp.kms.KeyRingIAMMember`">`gcp.kms.KeyRingIAMMember`</span>: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the key ring are preserved.
///
/// > **Note:** <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMPolicy`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMPolicy`" pulumi-lang-go="`kms.KeyRingIAMPolicy`" pulumi-lang-python="`kms.KeyRingIAMPolicy`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMPolicy`" pulumi-lang-java="`gcp.kms.KeyRingIAMPolicy`">`gcp.kms.KeyRingIAMPolicy`</span> **cannot** be used in conjunction with <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-go="`kms.KeyRingIAMBinding`" pulumi-lang-python="`kms.KeyRingIAMBinding`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-java="`gcp.kms.KeyRingIAMBinding`">`gcp.kms.KeyRingIAMBinding`</span> and <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMMember`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMMember`" pulumi-lang-go="`kms.KeyRingIAMMember`" pulumi-lang-python="`kms.KeyRingIAMMember`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMMember`" pulumi-lang-java="`gcp.kms.KeyRingIAMMember`">`gcp.kms.KeyRingIAMMember`</span> or they will fight over what your policy should be.
///
/// > **Note:** <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-go="`kms.KeyRingIAMBinding`" pulumi-lang-python="`kms.KeyRingIAMBinding`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMBinding`" pulumi-lang-java="`gcp.kms.KeyRingIAMBinding`">`gcp.kms.KeyRingIAMBinding`</span> resources **can be** used in conjunction with <span pulumi-lang-nodejs="`gcp.kms.KeyRingIAMMember`" pulumi-lang-dotnet="`gcp.kms.KeyRingIAMMember`" pulumi-lang-go="`kms.KeyRingIAMMember`" pulumi-lang-python="`kms.KeyRingIAMMember`" pulumi-lang-yaml="`gcp.kms.KeyRingIAMMember`" pulumi-lang-java="`gcp.kms.KeyRingIAMMember`">`gcp.kms.KeyRingIAMMember`</span> resources **only if** they do not grant privilege to the same role.
///
/// ##<span pulumi-lang-nodejs=" gcp.kms.KeyRingIAMPolicy
...
/// <!--End PulumiCodeChooser -->
///
/// ##<span pulumi-lang-nodejs=" gcp.kms.KeyRingIAMBinding
...
/// <!--End PulumiCodeChooser -->
///
/// ##<span pulumi-lang-nodejs=" gcp.kms.KeyRingIAMMember
...
class KeyRingIAMBinding extends CustomResource {
  ...
  KeyRingIAMBinding(
    ...
    this.condition = Output.createUnknown<KeyRingIAMBindingCondition?>();
