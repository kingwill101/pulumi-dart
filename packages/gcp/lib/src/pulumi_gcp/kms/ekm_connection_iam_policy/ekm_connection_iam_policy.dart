...
///
/// * <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-go="`kms.EkmConnectionIamPolicy`" pulumi-lang-python="`kms.EkmConnectionIamPolicy`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-java="`gcp.kms.EkmConnectionIamPolicy`">`gcp.kms.EkmConnectionIamPolicy`</span>: Authoritative. Sets the IAM policy for the ekmconnection and replaces any existing policy already attached.
/// * <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-go="`kms.EkmConnectionIamBinding`" pulumi-lang-python="`kms.EkmConnectionIamBinding`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-java="`gcp.kms.EkmConnectionIamBinding`">`gcp.kms.EkmConnectionIamBinding`</span>: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the ekmconnection are preserved.
/// * <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-go="`kms.EkmConnectionIamMember`" pulumi-lang-python="`kms.EkmConnectionIamMember`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-java="`gcp.kms.EkmConnectionIamMember`">`gcp.kms.EkmConnectionIamMember`</span>: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the ekmconnection are preserved.
///
/// A data source can be used to retrieve policy data in advent you do not need creation
///
/// * <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-go="`kms.EkmConnectionIamPolicy`" pulumi-lang-python="`kms.EkmConnectionIamPolicy`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-java="`gcp.kms.EkmConnectionIamPolicy`">`gcp.kms.EkmConnectionIamPolicy`</span>: Retrieves the IAM policy for the ekmconnection
///
/// > **Note:** <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-go="`kms.EkmConnectionIamPolicy`" pulumi-lang-python="`kms.EkmConnectionIamPolicy`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamPolicy`" pulumi-lang-java="`gcp.kms.EkmConnectionIamPolicy`">`gcp.kms.EkmConnectionIamPolicy`</span> **cannot** be used in conjunction with <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-go="`kms.EkmConnectionIamBinding`" pulumi-lang-python="`kms.EkmConnectionIamBinding`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-java="`gcp.kms.EkmConnectionIamBinding`">`gcp.kms.EkmConnectionIamBinding`</span> and <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-go="`kms.EkmConnectionIamMember`" pulumi-lang-python="`kms.EkmConnectionIamMember`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-java="`gcp.kms.EkmConnectionIamMember`">`gcp.kms.EkmConnectionIamMember`</span> or they will fight over what your policy should be.
///
/// > **Note:** <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-go="`kms.EkmConnectionIamBinding`" pulumi-lang-python="`kms.EkmConnectionIamBinding`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamBinding`" pulumi-lang-java="`gcp.kms.EkmConnectionIamBinding`">`gcp.kms.EkmConnectionIamBinding`</span> resources **can be** used in conjunction with <span pulumi-lang-nodejs="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-dotnet="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-go="`kms.EkmConnectionIamMember`" pulumi-lang-python="`kms.EkmConnectionIamMember`" pulumi-lang-yaml="`gcp.kms.EkmConnectionIamMember`" pulumi-lang-java="`gcp.kms.EkmConnectionIamMember`">`gcp.kms.EkmConnectionIamMember`</span> resources **only if** they do not grant privilege to the same role.
///
/// > **Note:**  This resource supports IAM Conditions but they have some known limitations which can be found [here](https://cloud.google.com/iam/docs/conditions-overview#limitations). Please review this article if you are having issues with IAM Conditions.
///
///
/// ##<span pulumi-lang-nodejs=" gcp.kms.EkmConnectionIamPolicy
/// " pulumi-lang-dotnet=" gcp.kms.EkmConnectionIamPolicy
/// " pulumi-lang-go=" kms.EkmConnectionIamPolicy
/// " pulumi-lang-python=" kms.EkmConnectionIamPolicy
/// " pulumi-lang-yaml=" gcp.kms.EkmConnectionIamPolicy
/// " pulumi-lang-java=" gcp.kms.EkmConnectionIamPolicy
...
/// ```
/// <!--End PulumiCodeChooser -->
/// ##<span pulumi-lang-nodejs=" gcp.kms.EkmConnectionIamBinding
/// " pulumi-lang-dotnet=" gcp.kms.EkmConnectionIamBinding
/// " pulumi-lang-go=" kms.EkmConnectionIamBinding
/// " pulumi-lang-python=" kms.EkmConnectionIamBinding
/// " pulumi-lang-yaml=" gcp.kms.EkmConnectionIamBinding
/// " pulumi-lang-java=" gcp.kms.EkmConnectionIamBinding
