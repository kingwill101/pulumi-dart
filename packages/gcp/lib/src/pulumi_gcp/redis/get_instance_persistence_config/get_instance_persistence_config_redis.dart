...
class GetInstancePersistenceConfigRedis {
  ...
  GetInstancePersistenceConfigRedis({
  ...
  factory GetInstancePersistenceConfigRedis.fromMap(Map<String, dynamic> map) {
    return GetInstancePersistenceConfigRedis(
