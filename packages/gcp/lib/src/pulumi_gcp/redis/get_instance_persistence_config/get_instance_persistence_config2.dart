...
class GetInstancePersistenceConfig2 {
  ...
  factory GetInstancePersistenceConfig2.fromMap(Map<String, dynamic> map) {
    return GetInstancePersistenceConfig2(
