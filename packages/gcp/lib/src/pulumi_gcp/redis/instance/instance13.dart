...
import '../instance_maintenance_schedule/instance_maintenance_schedule3.dart';
...
class Instance13 extends CustomResource {
  ...
  /// AUTH String set on the instance. This field will only be populated if<span pulumi-lang-nodejs=" authEnabled " pulumi-lang-dotnet=" AuthEnabled " pulumi-lang-go=" authEnabled " pulumi-lang-python=" auth_enabled " pulumi-lang-yaml=" authEnabled " pulumi-lang-java=" authEnabled "> auth_enabled </span>is true.
  late final Output<String> authString;
  ...
  late final Output<InstanceMaintenancePolicy3?> maintenancePolicy;

  /// Upcoming maintenance schedule.
  /// Structure is documented below.
  late final Output<List<InstanceMaintenanceSchedule3>> maintenanceSchedules;
  ...
  /// Structure is documented below.
  late final Output<List<InstanceNode>> nodes;

  /// Persistence configuration for an instance.
  /// Structure is documented below.
  late final Output<InstancePersistenceConfig2> persistenceConfig;
  ...
  /// Structure is documented below.
  late final Output<List<InstanceServerCaCert>> serverCaCerts;
  ...
  Instance13(
    ...
    this.authString = Output.createUnknown<String>();
    ...
    this.maintenancePolicy =
        Output.createUnknown<InstanceMaintenancePolicy3?>();
    this.maintenanceSchedules =
        Output.createUnknown<List<InstanceMaintenanceSchedule3>>();
    this.maintenanceVersion = Output.createUnknown<String>();
    this.memorySizeGb = Output.createUnknown<int>();
    this.name = Output.createUnknown<String>();
    this.nodes = Output.createUnknown<List<InstanceNode>>();
    this.persistenceConfig = Output.createUnknown<InstancePersistenceConfig2>();
    ...
    this.serverCaCerts = Output.createUnknown<List<InstanceServerCaCert>>();
