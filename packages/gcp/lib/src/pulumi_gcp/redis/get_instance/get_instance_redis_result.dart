...
import '../get_instance_maintenance_policy/get_instance_maintenance_policy_redis.dart';
import '../get_instance_maintenance_schedule/get_instance_maintenance_schedule_redis.dart';
import '../get_instance_node/get_instance_node.dart';
import '../get_instance_persistence_config/get_instance_persistence_config_redis.dart';
import '../get_instance_server_ca_cert/get_instance_server_ca_cert.dart';

/// Result data returned by getInstance.
class GetInstanceRedisResult {
  ...
  final List<GetInstanceMaintenancePolicyRedis> maintenancePolicies;
  final List<GetInstanceMaintenanceScheduleRedis> maintenanceSchedules;
  final String maintenanceVersion;
  final int memorySizeGb;
  final String name;
  final List<GetInstanceNode> nodes;
  final List<GetInstancePersistenceConfigRedis> persistenceConfigs;
  ...
  factory GetInstanceRedisResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceRedisResult(
      ...
      maintenancePolicies:
          pulumi.Input.decodeList<GetInstanceMaintenancePolicyRedis>(
              map['maintenancePolicies'],
              (value) => GetInstanceMaintenancePolicyRedis.fromMap(
                  (value as Map).cast<String, dynamic>())),
      maintenanceSchedules:
          pulumi.Input.decodeList<GetInstanceMaintenanceScheduleRedis>(
              map['maintenanceSchedules'],
              (value) => GetInstanceMaintenanceScheduleRedis.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      persistenceConfigs:
          pulumi.Input.decodeList<GetInstancePersistenceConfigRedis>(
              map['persistenceConfigs'],
              (value) => GetInstancePersistenceConfigRedis.fromMap(
                  (value as Map).cast<String, dynamic>())),
