...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeRedis {
  ...
  InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeRedis({
    this.hours,
    this.minutes,
    this.nanos,
    this.seconds,
  ...
  factory InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeRedis.fromMap(
      Map<String, dynamic> map) {
    return InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeRedis(
