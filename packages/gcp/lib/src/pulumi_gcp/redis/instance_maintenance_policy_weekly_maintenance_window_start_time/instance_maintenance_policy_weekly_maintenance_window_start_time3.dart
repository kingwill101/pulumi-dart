...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime3 {
  ...
  InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime3({
    this.hours,
    this.minutes,
    this.nanos,
    this.seconds,
  ...
  factory InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime3.fromMap(
      Map<String, dynamic> map) {
    return InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime3(
