...
class Cluster6 extends CustomResource {
  ...
  late final Output<ClusterAutomatedBackupConfig?> automatedBackupConfig;
  ...
  /// Structure is documented below.
  late final Output<ClusterCrossClusterReplicationConfig>
      crossClusterReplicationConfig;
  ...
  /// Structure is documented below.
  late final Output<List<ClusterDiscoveryEndpoint>> discoveryEndpoints;
  ...
  /// Structure is documented below.
  late final Output<ClusterGcsSource?> gcsSource;
  ...
  /// Structure is documented below.
  late final Output<ClusterMaintenancePolicy3?> maintenancePolicy;

  /// Upcoming maintenance schedule.
  /// Structure is documented below.
  late final Output<List<ClusterMaintenanceSchedule>> maintenanceSchedules;
  ...
  /// Structure is documented below.
  late final Output<ClusterManagedBackupSource?> managedBackupSource;

  /// Cluster's Certificate Authority. This field will only be populated if Redis Cluster's<span pulumi-lang-nodejs=" transitEncryptionMode " pulumi-lang-dotnet=" TransitEncryptionMode " pulumi-lang-go=" transitEncryptionMode " pulumi-lang-python=" transit_encryption_mode " pulumi-lang-yaml=" transitEncryptionMode " pulumi-lang-java=" transitEncryptionMode "> transit_encryption_mode </span>is TRANSIT_ENCRYPTION_MODE_SERVER_AUTHENTICATION
  /// Structure is documented below.
  late final Output<List<ClusterManagedServerCa>> managedServerCas;
  ...
  /// Structure is documented below.
  late final Output<ClusterPersistenceConfig> persistenceConfig;

  /// Output only. Redis memory precise size in GB for the entire cluster.
  late final Output<double> preciseSizeGb;
  ...
  /// Structure is documented below.
  late final Output<List<ClusterPscConfig2>?> pscConfigs;

  /// Output only. PSC connections for discovery of the cluster topology and accessing the cluster.
  /// Structure is documented below.
  late final Output<List<ClusterPscConnection>> pscConnections;

  /// Service attachment details to configure Psc connections.
  /// Structure is documented below.
  late final Output<List<ClusterPscServiceAttachment>> pscServiceAttachments;
  ...
  /// Structure is documented below.
  late final Output<List<ClusterStateInfo>> stateInfos;
  ...
  /// Structure is documented below.
  late final Output<ClusterZoneDistributionConfig> zoneDistributionConfig;
