...
class InstanceMaintenanceScheduleRedis {
  /// (Output)
  ...
  InstanceMaintenanceScheduleRedis({
    this.endTime,
  ...
  factory InstanceMaintenanceScheduleRedis.fromMap(Map<String, dynamic> map) {
    return InstanceMaintenanceScheduleRedis(
