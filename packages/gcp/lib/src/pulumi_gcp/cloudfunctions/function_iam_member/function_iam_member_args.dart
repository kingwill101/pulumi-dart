...
import '../function_iam_member_condition/function_iam_member_condition.dart';

/// The set of arguments for FunctionIamMember.
class FunctionIamMemberArgs {
  /// Used to find the parent resource to bind the IAM policy to
  final Input<String> cloudFunction;
  final Input<FunctionIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<FunctionIamMemberCondition,
  ...
  factory FunctionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return FunctionIamMemberArgs(
      ...
      condition:
          Input.asOptionalInput<FunctionIamMemberCondition>(map['condition']),
