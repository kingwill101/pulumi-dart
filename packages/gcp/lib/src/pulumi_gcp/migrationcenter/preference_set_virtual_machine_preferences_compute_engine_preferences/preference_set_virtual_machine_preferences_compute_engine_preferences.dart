...
import '../preference_set_virtual_machine_preferences_compute_engine_preferences_machine_preferences/preference_set_virtual_machine_preferences_compute_engine_preferences_machine_preferences.dart';
...
class PreferenceSetVirtualMachinePreferencesComputeEnginePreferences {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (licenseTypeValue != null) {
      map['licenseType'] = licenseTypeValue;
    }
  ...
  factory PreferenceSetVirtualMachinePreferencesComputeEnginePreferences.fromMap(
    ...
    return PreferenceSetVirtualMachinePreferencesComputeEnginePreferences(
      licenseType:
          map['licenseType'] == null ? null : map['licenseType'] as String,
