...
import '../database_instance_settings_connection_pool_config/database_instance_settings_connection_pool_config.dart';
import '../database_instance_settings_data_cache_config/database_instance_settings_data_cache_config.dart';
import '../database_instance_settings_database_flag/database_instance_settings_database_flag.dart';
import '../database_instance_settings_deny_maintenance_period/database_instance_settings_deny_maintenance_period.dart';
import '../database_instance_settings_final_backup_config/database_instance_settings_final_backup_config.dart';
import '../database_instance_settings_insights_config/database_instance_settings_insights_config.dart';
import '../database_instance_settings_ip_configuration/database_instance_settings_ip_configuration.dart';
import '../database_instance_settings_location_preference/database_instance_settings_location_preference.dart';
import '../database_instance_settings_maintenance_window/database_instance_settings_maintenance_window.dart';
import '../database_instance_settings_password_validation_policy/database_instance_settings_password_validation_policy.dart';
import '../database_instance_settings_read_pool_auto_scale_config/database_instance_settings_read_pool_auto_scale_config.dart';
import '../database_instance_settings_sql_server_audit_config/database_instance_settings_sql_server_audit_config.dart';
...
class DatabaseInstanceSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (connectorEnforcementValue != null) {
      map['connectorEnforcement'] = connectorEnforcementValue;
    }
    final dataCacheConfigValue = dataCacheConfig;
    if (dataCacheConfigValue != null) {
      map['dataCacheConfig'] = dataCacheConfigValue.toMap();
    }
    final dataDiskProvisionedIopsValue = dataDiskProvisionedIops;
    if (dataDiskProvisionedIopsValue != null) {
      map['dataDiskProvisionedIops'] = dataDiskProvisionedIopsValue;
    }
    final dataDiskProvisionedThroughputValue = dataDiskProvisionedThroughput;
    if (dataDiskProvisionedThroughputValue != null) {
      map['dataDiskProvisionedThroughput'] = dataDiskProvisionedThroughputValue;
    }
    ...
    if (denyMaintenancePeriodValue != null) {
      map['denyMaintenancePeriod'] = denyMaintenancePeriodValue.toMap();
    }
    final diskAutoresizeValue = diskAutoresize;
    if (diskAutoresizeValue != null) {
      map['diskAutoresize'] = diskAutoresizeValue;
    }
    final diskAutoresizeLimitValue = diskAutoresizeLimit;
    if (diskAutoresizeLimitValue != null) {
      map['diskAutoresizeLimit'] = diskAutoresizeLimitValue;
    }
    ...
    final effectiveAvailabilityTypeValue = effectiveAvailabilityType;
    if (effectiveAvailabilityTypeValue != null) {
      map['effectiveAvailabilityType'] = effectiveAvailabilityTypeValue;
    }
    final enableDataplexIntegrationValue = enableDataplexIntegration;
    if (enableDataplexIntegrationValue != null) {
      map['enableDataplexIntegration'] = enableDataplexIntegrationValue;
    }
    final enableGoogleMlIntegrationValue = enableGoogleMlIntegration;
    if (enableGoogleMlIntegrationValue != null) {
      map['enableGoogleMlIntegration'] = enableGoogleMlIntegrationValue;
    }
    final finalBackupConfigValue = finalBackupConfig;
    if (finalBackupConfigValue != null) {
      map['finalBackupConfig'] = finalBackupConfigValue.toMap();
    }
    ...
    final readPoolAutoScaleConfigValue = readPoolAutoScaleConfig;
    if (readPoolAutoScaleConfigValue != null) {
      map['readPoolAutoScaleConfig'] = readPoolAutoScaleConfigValue.toMap();
    }
    final retainBackupsOnDeleteValue = retainBackupsOnDelete;
    if (retainBackupsOnDeleteValue != null) {
      map['retainBackupsOnDelete'] = retainBackupsOnDeleteValue;
    }
  ...
  factory DatabaseInstanceSettings.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSettings(
      ...
      diskAutoresize:
          map['diskAutoresize'] == null ? null : map['diskAutoresize'] as bool,
