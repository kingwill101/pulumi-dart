...
class DatabaseInstanceSqlArgs {
  ...
  factory DatabaseInstanceSqlArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSqlArgs(
      backupdrBackup:
          pulumi.Input.asOptionalInput<String>(map['backupdrBackup']),
      clone: pulumi.Input.asOptionalInput<DatabaseInstanceClone>(map['clone']),
      databaseVersion: pulumi.Input.asInput<String>(map['databaseVersion']),
      deletionProtection:
          pulumi.Input.asOptionalInput<bool>(map['deletionProtection']),
      encryptionKeyName:
          pulumi.Input.asOptionalInput<String>(map['encryptionKeyName']),
      finalBackupDescription:
          pulumi.Input.asOptionalInput<String>(map['finalBackupDescription']),
      ...
      rootPasswordWo:
          pulumi.Input.asOptionalInput<String>(map['rootPasswordWo']),
      rootPasswordWoVersion:
          pulumi.Input.asOptionalInput<String>(map['rootPasswordWoVersion']),
