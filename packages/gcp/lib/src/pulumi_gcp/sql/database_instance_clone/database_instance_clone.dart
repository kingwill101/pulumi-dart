...
class DatabaseInstanceClone {
  ...
  /// (SQL Server only, use with <span pulumi-lang-nodejs="`pointInTime`" pulumi-lang-dotnet="`PointInTime`" pulumi-lang-go="`pointInTime`" pulumi-lang-python="`point_in_time`" pulumi-lang-yaml="`pointInTime`" pulumi-lang-java="`pointInTime`">`point_in_time`</span>) Clone only the specified databases from the source instance. Clone all databases if empty.
  ...
  Map<String, dynamic> toMap() {
    ...
    final databaseNamesValue = databaseNames;
    if (databaseNamesValue != null) {
      map['databaseNames'] = databaseNamesValue;
    }
    final pointInTimeValue = pointInTime;
    if (pointInTimeValue != null) {
      map['pointInTime'] = pointInTimeValue;
    }
    final preferredZoneValue = preferredZone;
    if (preferredZoneValue != null) {
      map['preferredZone'] = preferredZoneValue;
    }
    ...
    map['sourceInstanceName'] = sourceInstanceName;
    return map;
  }
  ...
  factory DatabaseInstanceClone.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceClone(
      ...
      databaseNames: map['databaseNames'] == null
          ? null
          : (map['databaseNames'] as List).cast<String>(),
      pointInTime:
          map['pointInTime'] == null ? null : map['pointInTime'] as String,
      preferredZone:
          map['preferredZone'] == null ? null : map['preferredZone'] as String,
