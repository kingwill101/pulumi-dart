...
class GetDatabaseInstancePointInTimeRestoreContext {
  ...
  GetDatabaseInstancePointInTimeRestoreContext({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['preferredZone'] = preferredZone;
    map['targetInstance'] = targetInstance;
    return map;
  }

  factory GetDatabaseInstancePointInTimeRestoreContext.fromMap(
      Map<String, dynamic> map) {
    return GetDatabaseInstancePointInTimeRestoreContext(
