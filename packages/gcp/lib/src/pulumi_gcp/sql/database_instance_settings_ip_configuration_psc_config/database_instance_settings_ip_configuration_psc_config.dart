...
class DatabaseInstanceSettingsIpConfigurationPscConfig {
  ...
  final List<DatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnection>?
      pscAutoConnections;
  ...
  Map<String, dynamic> toMap() {
    ...
    final networkAttachmentUriValue = networkAttachmentUri;
    if (networkAttachmentUriValue != null) {
      map['networkAttachmentUri'] = networkAttachmentUriValue;
    }
  ...
  factory DatabaseInstanceSettingsIpConfigurationPscConfig.fromMap(
    ...
    return DatabaseInstanceSettingsIpConfigurationPscConfig(
      ...
      networkAttachmentUri: map['networkAttachmentUri'] == null
          ? null
