...
class GetRepositoryCleanupPolicy {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['action'] = action;
    map['conditions'] = Input.encodeList<GetRepositoryCleanupPolicyCondition,
        Map<String, dynamic>>(conditions, (value) => value.toMap());
    map['id'] = id;
    map['mostRecentVersions'] = Input.encodeList<
  ...
  factory GetRepositoryCleanupPolicy.fromMap(Map<String, dynamic> map) {
    return GetRepositoryCleanupPolicy(
      ...
      conditions: Input.decodeList<GetRepositoryCleanupPolicyCondition>(
          map['conditions'],
          (value) => GetRepositoryCleanupPolicyCondition.fromMap(
              (value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      mostRecentVersions:
          Input.decodeList<GetRepositoryCleanupPolicyMostRecentVersion>(
