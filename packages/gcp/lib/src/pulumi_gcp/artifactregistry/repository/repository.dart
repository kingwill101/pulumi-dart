...
class Repository extends CustomResource {
  ...
  late final Output<List<RepositoryCleanupPolicy>?> cleanupPolicies;

  /// If true, the cleanup pipeline is prevented from deleting versions in this
  /// repository.
  late final Output<bool?> cleanupPolicyDryRun;
  ...
  /// Structure is documented below.
  late final Output<RepositoryDockerConfig?> dockerConfig;
  ...
  /// format type.
  /// Structure is documented below.
  late final Output<RepositoryMavenConfig?> mavenConfig;
  ...
  late final Output<String> registryUri;

  /// Configuration specific for a Remote Repository.
  /// Structure is documented below.
  late final Output<RepositoryRemoteRepositoryConfig?> remoteRepositoryConfig;
  ...
  /// Structure is documented below.
  late final Output<RepositoryVirtualRepositoryConfig?> virtualRepositoryConfig;

  /// Configuration for vulnerability scanning of artifacts stored in this repository.
  /// Structure is documented below.
  late final Output<RepositoryVulnerabilityScanningConfig>
      vulnerabilityScanningConfig;
