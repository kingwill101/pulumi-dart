...
import '../repository_iam_member_condition/repository_iam_member_condition.dart';
...
class RepositoryIamMember extends CustomResource {
  late final Output<RepositoryIamMemberCondition?> condition;
  ...
  RepositoryIamMember(
    ...
    this.condition = Output.createUnknown<RepositoryIamMemberCondition?>();
