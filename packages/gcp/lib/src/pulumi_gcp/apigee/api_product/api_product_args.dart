...
class ApiProductArgs {
  ...
  final Input<List<ApiProductAttribute>>? attributes;
  ...
  /// Structure is documented below.
  final Input<ApiProductGraphqlOperationGroup>? graphqlOperationGroup;
  ...
  /// Structure is documented below.
  final Input<ApiProductGrpcOperationGroup>? grpcOperationGroup;
  ...
  /// Structure is documented below.
  final Input<ApiProductOperationGroup>? operationGroup;
  ...
  final Input<String>? quotaCounterScope;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (attributesValue != null) {
      map['attributes'] = Input.mapOptionalInputValue<List<ApiProductAttribute>,
              List<Map<String, dynamic>>>(
          attributesValue,
          (value) =>
              Input.encodeList<ApiProductAttribute, Map<String, dynamic>>(
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      ...
      attributes:
          Input.asOptionalInput<List<ApiProductAttribute>>(map['attributes']),
      description: Input.asOptionalInput<String>(map['description']),
      displayName: Input.asInput<String>(map['displayName']),
      environments: Input.asOptionalInput<List<String>>(map['environments']),
      graphqlOperationGroup:
          Input.asOptionalInput<ApiProductGraphqlOperationGroup>(
              map['graphqlOperationGroup']),
      grpcOperationGroup: Input.asOptionalInput<ApiProductGrpcOperationGroup>(
          map['grpcOperationGroup']),
      name: Input.asOptionalInput<String>(map['name']),
      operationGroup: Input.asOptionalInput<ApiProductOperationGroup>(
          map['operationGroup']),
      ...
      quotaCounterScope:
          Input.asOptionalInput<String>(map['quotaCounterScope']),
      ...
      space: Input.asOptionalInput<String>(map['space']),
    );
  }
}
