...
/// ```
class KeystoresAliasesSelfSignedCert extends CustomResource {
  ...
  late final Output<int?> certValidityInDays;

  /// Chain of certificates under this alias.
  /// Structure is documented below.
  late final Output<List<KeystoresAliasesSelfSignedCertCertsInfo>> certsInfos;

  /// The Apigee environment name
  late final Output<String> environment;

  /// Key size. Default and maximum value is 2048 bits.
  late final Output<String?> keySize;
  ...
  late final Output<String> sigAlg;

  /// Subject details.
  /// Structure is documented below.
  late final Output<KeystoresAliasesSelfSignedCertSubject> subject;

  /// List of alternative host names. Maximum length is 255 characters for each value.
  /// Structure is documented below.
  late final Output<KeystoresAliasesSelfSignedCertSubjectAlternativeDnsNames?>
