...
import '../connection_profile_postgresql_ssl/connection_profile_postgresql_ssl.dart';
...
class ConnectionProfilePostgresql {
  ...
  Map<String, dynamic> toMap() {
    ...
    final networkArchitectureValue = networkArchitecture;
    if (networkArchitectureValue != null) {
      map['networkArchitecture'] = networkArchitectureValue;
    }
  ...
  factory ConnectionProfilePostgresql.fromMap(Map<String, dynamic> map) {
    return ConnectionProfilePostgresql(
      ...
      networkArchitecture: map['networkArchitecture'] == null
          ? null
