...
class ControlArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (boostActionValue != null) {
      map['boostAction'] = pulumi.Input.mapOptionalInputValue<
          ControlBoostAction,
          Map<String, dynamic>>(boostActionValue, (value) => value.toMap());
    }
    ...
    if (conditionsValue != null) {
      map['conditions'] = pulumi.Input.mapOptionalInputValue<
              List<ControlCondition>, List<Map<String, dynamic>>>(
          conditionsValue,
          (value) =>
    ...
    if (filterActionValue != null) {
      map['filterAction'] = pulumi.Input.mapOptionalInputValue<
          ControlFilterAction,
    ...
    if (promoteActionValue != null) {
      map['promoteAction'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (redirectActionValue != null) {
      map['redirectAction'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (synonymsActionValue != null) {
      map['synonymsAction'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory ControlArgs.fromMap(Map<String, dynamic> map) {
    return ControlArgs(
      boostAction:
          pulumi.Input.asOptionalInput<ControlBoostAction>(map['boostAction']),
      ...
      redirectAction: pulumi.Input.asOptionalInput<ControlRedirectAction>(
          map['redirectAction']),
      solutionType: pulumi.Input.asInput<String>(map['solutionType']),
      synonymsAction: pulumi.Input.asOptionalInput<ControlSynonymsAction>(
          map['synonymsAction']),
      useCases: pulumi.Input.asOptionalInput<List<String>>(map['useCases']),
    );
  }
}
