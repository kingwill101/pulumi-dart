...
class Control extends CustomResource {
  ...
  late final Output<ControlBoostAction?> boostAction;
  ...
  /// Structure is documented below.
  late final Output<List<ControlCondition>?> conditions;
  ...
  /// Structure is documented below.
  late final Output<ControlFilterAction?> filterAction;
  ...
  /// Structure is documented below.
  late final Output<ControlPromoteAction?> promoteAction;

  /// Redirects to a specified URI.
  /// Structure is documented below.
  late final Output<ControlRedirectAction?> redirectAction;
