...
class LicenseConfigArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (endDateValue != null) {
      map['endDate'] = pulumi.Input.mapOptionalInputValue<LicenseConfigEndDate,
    ...
    map['startDate'] = pulumi.Input.mapInputValue<LicenseConfigStartDate,
        Map<String, dynamic>>(startDate, (value) => value.toMap());
  ...
  factory LicenseConfigArgs.fromMap(Map<String, dynamic> map) {
    return LicenseConfigArgs(
      ...
      endDate:
          pulumi.Input.asOptionalInput<LicenseConfigEndDate>(map['endDate']),
      freeTrial: pulumi.Input.asOptionalInput<bool>(map['freeTrial']),
      licenseConfigId: pulumi.Input.asInput<String>(map['licenseConfigId']),
      licenseCount: pulumi.Input.asInput<int>(map['licenseCount']),
      location: pulumi.Input.asInput<String>(map['location']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      startDate: pulumi.Input.asInput<LicenseConfigStartDate>(map['startDate']),
      subscriptionTerm: pulumi.Input.asInput<String>(map['subscriptionTerm']),
      subscriptionTier: pulumi.Input.asInput<String>(map['subscriptionTier']),
    );
  }
}
