...
import '../control_boost_action_interpolation_boost_spec/control_boost_action_interpolation_boost_spec.dart';
...
class ControlBoostAction {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['filter'] = filter;
    final fixedBoostValue = fixedBoost;
    if (fixedBoostValue != null) {
      map['fixedBoost'] = fixedBoostValue;
    }
    final interpolationBoostSpecValue = interpolationBoostSpec;
    if (interpolationBoostSpecValue != null) {
      map['interpolationBoostSpec'] = interpolationBoostSpecValue.toMap();
    }
    return map;
  }
  ...
  factory ControlBoostAction.fromMap(Map<String, dynamic> map) {
    return ControlBoostAction(
      ...
      fixedBoost:
          map['fixedBoost'] == null ? null : map['fixedBoost'] as double,
