...
/// ```
class DataConnector extends CustomResource {
  ...
  late final Output<String> actionState;

  /// Indicates whether full syncs are paused for this connector
  late final Output<bool?> autoRunDisabled;
  ...
  late final Output<List<String>> blockingReasons;

  /// The display name of the Collection.
  /// Should be human readable, used to display collections in the Console
  /// Dashboard. UTF-8 encoded string with limit of 1024 characters.
  late final Output<String> collectionDisplayName;
  ...
  late final Output<List<String>?> connectorModes;
  ...
  late final Output<List<DataConnectorEntity>?> entities;

  /// The errors from initialization or from the latest connector run.
  /// Structure is documented below.
  late final Output<List<DataConnectorError>> errors;
  ...
  late final Output<String?> incrementalRefreshInterval;

  /// Indicates whether incremental syncs are paused for this connector.
  late final Output<bool?> incrementalSyncDisabled;

  /// Params needed to access the source in the format of json string.
  late final Output<String?> jsonParams;
  ...
  /// triggered.
  late final Output<String> latestPauseTime;
  ...
  late final Output<String> privateConnectivityProjectId;
  ...
  /// 'STATE_UNSPECIFIED', 'CREATING', 'ACTIVE', 'FAILED', 'RUNNING', 'WARNING',
  /// 'INITIALIZATION_FAILED', 'UPDATING'.
  late final Output<String> realtimeState;
  ...
  /// set to the same value as the incremental refresh interval, incremental
  /// sync will be disabled.
  late final Output<String> refreshInterval;
  ...
  late final Output<List<String>> staticIpAddresses;

  /// Whether customer has enabled static IP addresses for this connector.
  late final Output<bool?> staticIpEnabled;

  /// The data synchronization mode supported by the data connector. The possible value can be:
  /// 'PERIODIC', 'STREAMING'.
  late final Output<String?> syncMode;
