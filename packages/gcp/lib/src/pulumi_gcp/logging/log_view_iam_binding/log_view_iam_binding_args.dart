...
class LogViewIamBindingArgs {
  ...
  final Input<LogViewIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<LogViewIamBindingCondition,
  ...
  factory LogViewIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LogViewIamBindingArgs(
      ...
      condition:
          Input.asOptionalInput<LogViewIamBindingCondition>(map['condition']),
