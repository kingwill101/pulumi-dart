...
class MetricArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bucketOptionsValue != null) {
      map['bucketOptions'] = pulumi.Input.mapOptionalInputValue<
          MetricBucketOptions,
  ...
  factory MetricArgs.fromMap(Map<String, dynamic> map) {
    return MetricArgs(
      ...
      bucketOptions: pulumi.Input.asOptionalInput<MetricBucketOptions>(
          map['bucketOptions']),
      ...
      labelExtractors: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['labelExtractors']),
      metricDescriptor: pulumi.Input.asOptionalInput<MetricMetricDescriptor>(
          map['metricDescriptor']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      valueExtractor:
          pulumi.Input.asOptionalInput<String>(map['valueExtractor']),
    );
  }
}
