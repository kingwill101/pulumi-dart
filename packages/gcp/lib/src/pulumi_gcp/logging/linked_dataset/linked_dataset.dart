...
/// ```
class LinkedDataset extends CustomResource {
  ...
  late final Output<List<LinkedDatasetBigqueryDataset>> bigqueryDatasets;
  ...
  LinkedDataset(
    ...
    this.bigqueryDatasets =
        Output.createUnknown<List<LinkedDatasetBigqueryDataset>>();
