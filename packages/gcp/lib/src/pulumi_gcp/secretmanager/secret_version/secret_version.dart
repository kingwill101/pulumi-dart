...
///
///
/// > **Note:**  All arguments marked as write-only values will not be stored in the state: <span pulumi-lang-nodejs="`secretDataWo`" pulumi-lang-dotnet="`SecretDataWo`" pulumi-lang-go="`secretDataWo`" pulumi-lang-python="`secret_data_wo`" pulumi-lang-yaml="`secretDataWo`" pulumi-lang-java="`secretDataWo`">`secret_data_wo`</span>.
