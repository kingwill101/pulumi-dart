...
import '../regional_secret_iam_member_condition/regional_secret_iam_member_condition.dart';

/// The set of arguments for RegionalSecretIamMember.
class RegionalSecretIamMemberArgs {
  ...
  factory RegionalSecretIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionalSecretIamMemberArgs(
      condition: pulumi.Input.asOptionalInput<RegionalSecretIamMemberCondition>(
          map['condition']),
