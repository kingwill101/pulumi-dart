...
class GetSecretVersionSecretmanagerResult {
  ...
  GetSecretVersionSecretmanagerResult({
  ...
  factory GetSecretVersionSecretmanagerResult.fromMap(
      Map<String, dynamic> map) {
    return GetSecretVersionSecretmanagerResult(
