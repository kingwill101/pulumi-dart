...
class SecretArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (rotationValue != null) {
      map['rotation'] = pulumi.Input.mapOptionalInputValue<SecretRotation,
    ...
    if (topicsValue != null) {
      map['topics'] = pulumi.Input.mapOptionalInputValue<List<SecretTopic>,
              List<Map<String, dynamic>>>(
          topicsValue,
          (value) => pulumi.Input.encodeList<SecretTopic, Map<String, dynamic>>(
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      replication: pulumi.Input.asInput<SecretReplication>(map['replication']),
      rotation: pulumi.Input.asOptionalInput<SecretRotation>(map['rotation']),
      secretId: pulumi.Input.asOptionalInput<String>(map['secretId']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      topics: pulumi.Input.asOptionalInput<List<SecretTopic>>(map['topics']),
