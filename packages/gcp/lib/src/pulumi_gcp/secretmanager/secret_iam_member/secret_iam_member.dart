...
import 'secret_iam_member_args.dart';
...
class SecretIamMember extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<SecretIamMemberCondition?> condition;
  ...
  SecretIamMember(
    ...
    this.condition = registerOutput<SecretIamMemberCondition?>('condition');
