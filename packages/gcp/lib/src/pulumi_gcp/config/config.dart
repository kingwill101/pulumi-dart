...
class GcpConfig {
  ...
  bool get accessApprovalCustomEndpointIsSecret =>
      _isSecret('accessApprovalCustomEndpoint');
  ...
  bool get accessContextManagerCustomEndpointIsSecret =>
      _isSecret('accessContextManagerCustomEndpoint');
  ...
  bool get activeDirectoryCustomEndpointIsSecret =>
      _isSecret('activeDirectoryCustomEndpoint');
  ...
  bool get addPulumiAttributionLabelIsSecret =>
      _isSecret('addPulumiAttributionLabel');
  ...
  bool get apiGatewayCustomEndpointIsSecret =>
      _isSecret('apiGatewayCustomEndpoint');
  ...
  bool get appEngineCustomEndpointIsSecret =>
      _isSecret('appEngineCustomEndpoint');
  ...
  bool get artifactRegistryCustomEndpointIsSecret =>
      _isSecret('artifactRegistryCustomEndpoint');
  ...
  bool get assuredWorkloadsCustomEndpointIsSecret =>
      _isSecret('assuredWorkloadsCustomEndpoint');
  ...
  bool get backupDrCustomEndpointIsSecret =>
      _isSecret('backupDrCustomEndpoint');

  Batching? get batching {
    final raw = _raw('batching');
    return raw == null
        ? null
        : Batching.fromMap((jsonDecode(raw) as Map).cast<String, dynamic>());
  }
  ...
  bool get beyondcorpCustomEndpointIsSecret =>
      _isSecret('beyondcorpCustomEndpoint');
  ...
  bool get bigQueryCustomEndpointIsSecret =>
      _isSecret('bigQueryCustomEndpoint');
  ...
  bool get biglakeIcebergCustomEndpointIsSecret =>
      _isSecret('biglakeIcebergCustomEndpoint');
  ...
  bool get bigqueryAnalyticsHubCustomEndpointIsSecret =>
      _isSecret('bigqueryAnalyticsHubCustomEndpoint');
  ...
  bool get bigqueryConnectionCustomEndpointIsSecret =>
      _isSecret('bigqueryConnectionCustomEndpoint');
  ...
  bool get bigqueryDataTransferCustomEndpointIsSecret =>
      _isSecret('bigqueryDataTransferCustomEndpoint');
  ...
  bool get bigqueryDatapolicyCustomEndpointIsSecret =>
      _isSecret('bigqueryDatapolicyCustomEndpoint');
  ...
  bool get bigqueryDatapolicyv2CustomEndpointIsSecret =>
      _isSecret('bigqueryDatapolicyv2CustomEndpoint');
  ...
  bool get bigqueryReservationCustomEndpointIsSecret =>
      _isSecret('bigqueryReservationCustomEndpoint');
  ...
  bool get bigtableCustomEndpointIsSecret =>
      _isSecret('bigtableCustomEndpoint');
  ...
  bool get binaryAuthorizationCustomEndpointIsSecret =>
      _isSecret('binaryAuthorizationCustomEndpoint');
  ...
  bool get blockchainNodeEngineCustomEndpointIsSecret =>
      _isSecret('blockchainNodeEngineCustomEndpoint');
  ...
  bool get certificateManagerCustomEndpointIsSecret =>
      _isSecret('certificateManagerCustomEndpoint');
  ...
  bool get chronicleCustomEndpointIsSecret =>
      _isSecret('chronicleCustomEndpoint');
  ...
  bool get cloudAssetCustomEndpointIsSecret =>
      _isSecret('cloudAssetCustomEndpoint');
  ...
  bool get cloudBillingCustomEndpointIsSecret =>
      _isSecret('cloudBillingCustomEndpoint');
  ...
  bool get cloudBuildCustomEndpointIsSecret =>
      _isSecret('cloudBuildCustomEndpoint');
  ...
  bool get cloudFunctionsCustomEndpointIsSecret =>
      _isSecret('cloudFunctionsCustomEndpoint');
  ...
  bool get cloudIdentityCustomEndpointIsSecret =>
      _isSecret('cloudIdentityCustomEndpoint');
  ...
  bool get cloudIdsCustomEndpointIsSecret =>
      _isSecret('cloudIdsCustomEndpoint');
  ...
  bool get cloudQuotasCustomEndpointIsSecret =>
      _isSecret('cloudQuotasCustomEndpoint');
  ...
  bool get cloudResourceManagerCustomEndpointIsSecret =>
      _isSecret('cloudResourceManagerCustomEndpoint');
  ...
  bool get cloudRunCustomEndpointIsSecret =>
      _isSecret('cloudRunCustomEndpoint');
  ...
  bool get cloudRunV2CustomEndpointIsSecret =>
      _isSecret('cloudRunV2CustomEndpoint');
  ...
  bool get cloudSchedulerCustomEndpointIsSecret =>
      _isSecret('cloudSchedulerCustomEndpoint');
  ...
  bool get cloudSecurityComplianceCustomEndpointIsSecret =>
      _isSecret('cloudSecurityComplianceCustomEndpoint');
  ...
  bool get cloudTasksCustomEndpointIsSecret =>
      _isSecret('cloudTasksCustomEndpoint');
  ...
  bool get cloudbuildv2CustomEndpointIsSecret =>
      _isSecret('cloudbuildv2CustomEndpoint');
  ...
  bool get clouddeployCustomEndpointIsSecret =>
      _isSecret('clouddeployCustomEndpoint');
  ...
  bool get clouddomainsCustomEndpointIsSecret =>
      _isSecret('clouddomainsCustomEndpoint');
  ...
  bool get cloudfunctions2CustomEndpointIsSecret =>
      _isSecret('cloudfunctions2CustomEndpoint');
  ...
  bool get composerCustomEndpointIsSecret =>
      _isSecret('composerCustomEndpoint');
  ...
  bool get contactCenterInsightsCustomEndpointIsSecret =>
      _isSecret('contactCenterInsightsCustomEndpoint');
  ...
  bool get containerAnalysisCustomEndpointIsSecret =>
      _isSecret('containerAnalysisCustomEndpoint');
  ...
  bool get containerAttachedCustomEndpointIsSecret =>
      _isSecret('containerAttachedCustomEndpoint');
  ...
  bool get containerAwsCustomEndpointIsSecret =>
      _isSecret('containerAwsCustomEndpoint');
  ...
  bool get containerAzureCustomEndpointIsSecret =>
      _isSecret('containerAzureCustomEndpoint');
  ...
  bool get containerCustomEndpointIsSecret =>
      _isSecret('containerCustomEndpoint');
  ...
  bool get coreBillingCustomEndpointIsSecret =>
      _isSecret('coreBillingCustomEndpoint');
  ...
  bool get dataCatalogCustomEndpointIsSecret =>
      _isSecret('dataCatalogCustomEndpoint');
  ...
  bool get dataFusionCustomEndpointIsSecret =>
      _isSecret('dataFusionCustomEndpoint');
  ...
  bool get dataLossPreventionCustomEndpointIsSecret =>
      _isSecret('dataLossPreventionCustomEndpoint');
  ...
  bool get dataPipelineCustomEndpointIsSecret =>
      _isSecret('dataPipelineCustomEndpoint');
  ...
  bool get databaseMigrationServiceCustomEndpointIsSecret =>
      _isSecret('databaseMigrationServiceCustomEndpoint');
  ...
  bool get dataflowCustomEndpointIsSecret =>
      _isSecret('dataflowCustomEndpoint');
  ...
  bool get dataformCustomEndpointIsSecret =>
      _isSecret('dataformCustomEndpoint');
  ...
  bool get dataplexCustomEndpointIsSecret =>
      _isSecret('dataplexCustomEndpoint');
  ...
  bool get dataprocCustomEndpointIsSecret =>
      _isSecret('dataprocCustomEndpoint');
  ...
  bool get dataprocGdcCustomEndpointIsSecret =>
      _isSecret('dataprocGdcCustomEndpoint');
  ...
  bool get dataprocMetastoreCustomEndpointIsSecret =>
      _isSecret('dataprocMetastoreCustomEndpoint');
  ...
  bool get datastreamCustomEndpointIsSecret =>
      _isSecret('datastreamCustomEndpoint');
  ...
  bool get deploymentManagerCustomEndpointIsSecret =>
      _isSecret('deploymentManagerCustomEndpoint');
  ...
  bool get developerConnectCustomEndpointIsSecret =>
      _isSecret('developerConnectCustomEndpoint');
  ...
  bool get dialogflowCustomEndpointIsSecret =>
      _isSecret('dialogflowCustomEndpoint');
  ...
  bool get dialogflowCxCustomEndpointIsSecret =>
      _isSecret('dialogflowCxCustomEndpoint');
  ...
  bool get disableGlobalProjectWarningIsSecret =>
      _isSecret('disableGlobalProjectWarning');
  ...
  bool get disableGooglePartnerNameIsSecret =>
      _isSecret('disableGooglePartnerName');
  ...
  bool get discoveryEngineCustomEndpointIsSecret =>
      _isSecret('discoveryEngineCustomEndpoint');
  ...
  bool get documentAiCustomEndpointIsSecret =>
      _isSecret('documentAiCustomEndpoint');
  ...
  bool get documentAiWarehouseCustomEndpointIsSecret =>
      _isSecret('documentAiWarehouseCustomEndpoint');
  ...
  bool get edgecontainerCustomEndpointIsSecret =>
      _isSecret('edgecontainerCustomEndpoint');
  ...
  bool get edgenetworkCustomEndpointIsSecret =>
      _isSecret('edgenetworkCustomEndpoint');
  ...
  bool get essentialContactsCustomEndpointIsSecret =>
      _isSecret('essentialContactsCustomEndpoint');
  ...
  bool get eventarcCustomEndpointIsSecret =>
      _isSecret('eventarcCustomEndpoint');

  ExternalCredentials? get externalCredentials {
    final raw = _raw('externalCredentials');
    return raw == null
        ? null
        : ExternalCredentials.fromMap(
  ...
  bool get filestoreCustomEndpointIsSecret =>
      _isSecret('filestoreCustomEndpoint');
  ...
  bool get firebaseAiLogicCustomEndpointIsSecret =>
      _isSecret('firebaseAiLogicCustomEndpoint');
  ...
  bool get firebaseAppCheckCustomEndpointIsSecret =>
      _isSecret('firebaseAppCheckCustomEndpoint');
  ...
  bool get firebaseAppHostingCustomEndpointIsSecret =>
      _isSecret('firebaseAppHostingCustomEndpoint');
  ...
  bool get firebaseCustomEndpointIsSecret =>
      _isSecret('firebaseCustomEndpoint');
  ...
  bool get firebaseDataConnectCustomEndpointIsSecret =>
      _isSecret('firebaseDataConnectCustomEndpoint');
  ...
  bool get firebaseDatabaseCustomEndpointIsSecret =>
      _isSecret('firebaseDatabaseCustomEndpoint');
  ...
  bool get firebaseExtensionsCustomEndpointIsSecret =>
      _isSecret('firebaseExtensionsCustomEndpoint');
  ...
  bool get firebaseHostingCustomEndpointIsSecret =>
      _isSecret('firebaseHostingCustomEndpoint');
  ...
  bool get firebaseStorageCustomEndpointIsSecret =>
      _isSecret('firebaseStorageCustomEndpoint');
  ...
  bool get firebaserulesCustomEndpointIsSecret =>
      _isSecret('firebaserulesCustomEndpoint');
  ...
  bool get firestoreCustomEndpointIsSecret =>
      _isSecret('firestoreCustomEndpoint');
  ...
  bool get gkeBackupCustomEndpointIsSecret =>
      _isSecret('gkeBackupCustomEndpoint');
  ...
  bool get gkeonpremCustomEndpointIsSecret =>
      _isSecret('gkeonpremCustomEndpoint');
  ...
  bool get healthcareCustomEndpointIsSecret =>
      _isSecret('healthcareCustomEndpoint');
  ...
  bool get iamCredentialsCustomEndpointIsSecret =>
      _isSecret('iamCredentialsCustomEndpoint');
  ...
  bool get iamWorkforcePoolCustomEndpointIsSecret =>
      _isSecret('iamWorkforcePoolCustomEndpoint');
  ...
  bool get identityPlatformCustomEndpointIsSecret =>
      _isSecret('identityPlatformCustomEndpoint');
  ...
  bool get impersonateServiceAccountIsSecret =>
      _isSecret('impersonateServiceAccount');
  ...
  bool get impersonateServiceAccountDelegatesIsSecret =>
      _isSecret('impersonateServiceAccountDelegates');
  ...
  bool get integrationConnectorsCustomEndpointIsSecret =>
      _isSecret('integrationConnectorsCustomEndpoint');
  ...
  bool get integrationsCustomEndpointIsSecret =>
      _isSecret('integrationsCustomEndpoint');
  ...
  bool get managedKafkaCustomEndpointIsSecret =>
      _isSecret('managedKafkaCustomEndpoint');
  ...
  bool get memcacheCustomEndpointIsSecret =>
      _isSecret('memcacheCustomEndpoint');
  ...
  bool get memorystoreCustomEndpointIsSecret =>
      _isSecret('memorystoreCustomEndpoint');
  ...
  bool get migrationCenterCustomEndpointIsSecret =>
      _isSecret('migrationCenterCustomEndpoint');
  ...
  bool get mlEngineCustomEndpointIsSecret =>
      _isSecret('mlEngineCustomEndpoint');
  ...
  bool get modelArmorCustomEndpointIsSecret =>
      _isSecret('modelArmorCustomEndpoint');
  ...
  bool get modelArmorGlobalCustomEndpointIsSecret =>
      _isSecret('modelArmorGlobalCustomEndpoint');
  ...
  bool get monitoringCustomEndpointIsSecret =>
      _isSecret('monitoringCustomEndpoint');
  ...
  bool get networkConnectivityCustomEndpointIsSecret =>
      _isSecret('networkConnectivityCustomEndpoint');
  ...
  bool get networkConnectivityv1CustomEndpointIsSecret =>
      _isSecret('networkConnectivityv1CustomEndpoint');
  ...
  bool get networkManagementCustomEndpointIsSecret =>
      _isSecret('networkManagementCustomEndpoint');
  ...
  bool get networkSecurityCustomEndpointIsSecret =>
      _isSecret('networkSecurityCustomEndpoint');
  ...
  bool get networkServicesCustomEndpointIsSecret =>
      _isSecret('networkServicesCustomEndpoint');
  ...
  bool get notebooksCustomEndpointIsSecret =>
      _isSecret('notebooksCustomEndpoint');
  ...
  bool get observabilityCustomEndpointIsSecret =>
      _isSecret('observabilityCustomEndpoint');
  ...
  bool get oracleDatabaseCustomEndpointIsSecret =>
      _isSecret('oracleDatabaseCustomEndpoint');
  ...
  bool get orgPolicyCustomEndpointIsSecret =>
      _isSecret('orgPolicyCustomEndpoint');
  ...
  bool get osConfigCustomEndpointIsSecret =>
      _isSecret('osConfigCustomEndpoint');
  ...
  bool get osConfigV2CustomEndpointIsSecret =>
      _isSecret('osConfigV2CustomEndpoint');
  ...
  bool get parallelstoreCustomEndpointIsSecret =>
      _isSecret('parallelstoreCustomEndpoint');
  ...
  bool get parameterManagerCustomEndpointIsSecret =>
      _isSecret('parameterManagerCustomEndpoint');
  ...
  bool get parameterManagerRegionalCustomEndpointIsSecret =>
      _isSecret('parameterManagerRegionalCustomEndpoint');
  ...
  bool get privatecaCustomEndpointIsSecret =>
      _isSecret('privatecaCustomEndpoint');
  ...
  bool get privilegedAccessManagerCustomEndpointIsSecret =>
      _isSecret('privilegedAccessManagerCustomEndpoint');
  ...
  bool get publicCaCustomEndpointIsSecret =>
      _isSecret('publicCaCustomEndpoint');
  ...
  bool get pubsubLiteCustomEndpointIsSecret =>
      _isSecret('pubsubLiteCustomEndpoint');
  ...
  bool get pulumiAttributionLabelAdditionStrategyIsSecret =>
      _isSecret('pulumiAttributionLabelAdditionStrategy');
  ...
  bool get recaptchaEnterpriseCustomEndpointIsSecret =>
      _isSecret('recaptchaEnterpriseCustomEndpoint');
  ...
  bool get resourceManager3CustomEndpointIsSecret =>
      _isSecret('resourceManager3CustomEndpoint');
  ...
  bool get resourceManagerCustomEndpointIsSecret =>
      _isSecret('resourceManagerCustomEndpoint');
  ...
  bool get resourceManagerV3CustomEndpointIsSecret =>
      _isSecret('resourceManagerV3CustomEndpoint');
  ...
  bool get runtimeConfigCustomEndpointIsSecret =>
      _isSecret('runtimeConfigCustomEndpoint');
  ...
  bool get saasRuntimeCustomEndpointIsSecret =>
      _isSecret('saasRuntimeCustomEndpoint');
  ...
  bool get secretManagerCustomEndpointIsSecret =>
      _isSecret('secretManagerCustomEndpoint');
  ...
  bool get secretManagerRegionalCustomEndpointIsSecret =>
      _isSecret('secretManagerRegionalCustomEndpoint');
  ...
  bool get secureSourceManagerCustomEndpointIsSecret =>
      _isSecret('secureSourceManagerCustomEndpoint');
  ...
  bool get securityCenterCustomEndpointIsSecret =>
      _isSecret('securityCenterCustomEndpoint');
  ...
  bool get securityCenterManagementCustomEndpointIsSecret =>
      _isSecret('securityCenterManagementCustomEndpoint');
  ...
  bool get securityCenterV2CustomEndpointIsSecret =>
      _isSecret('securityCenterV2CustomEndpoint');
  ...
  bool get securityScannerCustomEndpointIsSecret =>
      _isSecret('securityScannerCustomEndpoint');
  ...
  bool get securitypostureCustomEndpointIsSecret =>
      _isSecret('securitypostureCustomEndpoint');
  ...
  bool get serviceDirectoryCustomEndpointIsSecret =>
      _isSecret('serviceDirectoryCustomEndpoint');
  ...
  bool get serviceManagementCustomEndpointIsSecret =>
      _isSecret('serviceManagementCustomEndpoint');
  ...
  bool get serviceNetworkingCustomEndpointIsSecret =>
      _isSecret('serviceNetworkingCustomEndpoint');
  ...
  bool get serviceUsageCustomEndpointIsSecret =>
      _isSecret('serviceUsageCustomEndpoint');
  ...
  bool get siteVerificationCustomEndpointIsSecret =>
      _isSecret('siteVerificationCustomEndpoint');
  ...
  bool get sourceRepoCustomEndpointIsSecret =>
      _isSecret('sourceRepoCustomEndpoint');
  ...
  bool get storageBatchOperationsCustomEndpointIsSecret =>
      _isSecret('storageBatchOperationsCustomEndpoint');
  ...
  bool get storageControlCustomEndpointIsSecret =>
      _isSecret('storageControlCustomEndpoint');
  ...
  bool get storageInsightsCustomEndpointIsSecret =>
      _isSecret('storageInsightsCustomEndpoint');
  ...
  bool get storageTransferCustomEndpointIsSecret =>
      _isSecret('storageTransferCustomEndpoint');
  ...
  bool get tagsLocationCustomEndpointIsSecret =>
      _isSecret('tagsLocationCustomEndpoint');
  ...
  bool get transcoderCustomEndpointIsSecret =>
      _isSecret('transcoderCustomEndpoint');
  ...
  bool get vertexAiCustomEndpointIsSecret =>
      _isSecret('vertexAiCustomEndpoint');
  ...
  bool get vmwareengineCustomEndpointIsSecret =>
      _isSecret('vmwareengineCustomEndpoint');
  ...
  bool get vpcAccessCustomEndpointIsSecret =>
      _isSecret('vpcAccessCustomEndpoint');
  ...
  bool get workbenchCustomEndpointIsSecret =>
      _isSecret('workbenchCustomEndpoint');
  ...
  bool get workflowsCustomEndpointIsSecret =>
      _isSecret('workflowsCustomEndpoint');
  ...
  bool get workstationsCustomEndpointIsSecret =>
      _isSecret('workstationsCustomEndpoint');
