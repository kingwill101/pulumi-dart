...
import '../listing_iam_binding_condition/listing_iam_binding_condition.dart';

/// The set of arguments for ListingIamBinding.
class ListingIamBindingArgs {
  final Input<ListingIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<ListingIamBindingCondition,
  ...
  factory ListingIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ListingIamBindingArgs(
      condition:
          Input.asOptionalInput<ListingIamBindingCondition>(map['condition']),
