...
class QueueIamMemberArgs {
  final Input<QueueIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<QueueIamMemberCondition,
  ...
  factory QueueIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return QueueIamMemberArgs(
      condition:
          Input.asOptionalInput<QueueIamMemberCondition>(map['condition']),
