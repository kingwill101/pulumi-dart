...
class QueueArgs {
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      ...
      httpTarget:
          pulumi.Input.asOptionalInput<QueueHttpTarget>(map['httpTarget']),
      location: pulumi.Input.asInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      rateLimits:
          pulumi.Input.asOptionalInput<QueueRateLimits>(map['rateLimits']),
      retryConfig:
          pulumi.Input.asOptionalInput<QueueRetryConfig>(map['retryConfig']),
