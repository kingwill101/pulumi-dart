...
import '../queue_http_target_uri_override_path_override/queue_http_target_uri_override_path_override.dart';
import '../queue_http_target_uri_override_query_override/queue_http_target_uri_override_query_override.dart';
...
class QueueHttpTargetUriOverride {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (uriOverrideEnforceModeValue != null) {
      map['uriOverrideEnforceMode'] = uriOverrideEnforceModeValue;
    }
    return map;
  }
  ...
  factory QueueHttpTargetUriOverride.fromMap(Map<String, dynamic> map) {
    return QueueHttpTargetUriOverride(
      ...
      pathOverride: map['pathOverride'] == null
          ? null
          : QueueHttpTargetUriOverridePathOverride.fromMap(
              (map['pathOverride'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as String,
      queryOverride: map['queryOverride'] == null
          ? null
          : QueueHttpTargetUriOverrideQueryOverride.fromMap(
