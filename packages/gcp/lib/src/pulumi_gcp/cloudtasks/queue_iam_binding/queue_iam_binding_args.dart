...
import '../queue_iam_binding_condition/queue_iam_binding_condition.dart';

/// The set of arguments for QueueIamBinding.
class QueueIamBindingArgs {
  final Input<QueueIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<QueueIamBindingCondition,
  ...
  factory QueueIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return QueueIamBindingArgs(
      condition:
          Input.asOptionalInput<QueueIamBindingCondition>(map['condition']),
