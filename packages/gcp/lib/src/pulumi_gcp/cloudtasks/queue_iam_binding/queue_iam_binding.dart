...
class QueueIamBinding extends CustomResource {
  late final Output<QueueIamBindingCondition?> condition;
  ...
  QueueIamBinding(
    ...
    this.condition = registerOutput<QueueIamBindingCondition?>('condition');
