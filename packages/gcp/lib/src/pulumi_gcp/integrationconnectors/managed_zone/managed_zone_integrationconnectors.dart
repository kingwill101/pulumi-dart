...
import 'managed_zone_integrationconnectors_args.dart';
...
/// ```
class ManagedZoneIntegrationconnectors extends pulumi.CustomResource {
  ...
  ManagedZoneIntegrationconnectors(
    String name, {
    ManagedZoneIntegrationconnectorsArgs? args,
