...
import 'connection_integrationconnectors_args.dart';
...
/// ```
class ConnectionIntegrationconnectors extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<ConnectionConnectorVersionInfraConfig>>
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<ConnectionDestinationConfig>?>
      destinationConfigs;
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<ConnectionEventingRuntimeData>>
  ...
  ConnectionIntegrationconnectors(
    String name, {
    ConnectionIntegrationconnectorsArgs? args,
