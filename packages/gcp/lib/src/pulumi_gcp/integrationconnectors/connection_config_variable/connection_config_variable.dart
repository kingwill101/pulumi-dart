...
import '../connection_config_variable_encryption_key_value/connection_config_variable_encryption_key_value.dart';
import '../connection_config_variable_secret_value/connection_config_variable_secret_value.dart';

class ConnectionConfigVariable {
  /// Boolean Value of configVariable
  final bool? booleanValue;

  /// Encryption key value of configVariable.
  /// Structure is documented below.
  final ConnectionConfigVariableEncryptionKeyValue? encryptionKeyValue;
  ...
  /// Structure is documented below.
  final ConnectionConfigVariableSecretValue? secretValue;
  ...
  factory ConnectionConfigVariable.fromMap(Map<String, dynamic> map) {
    return ConnectionConfigVariable(
      ...
      encryptionKeyValue: map['encryptionKeyValue'] == null
          ? null
          : ConnectionConfigVariableEncryptionKeyValue.fromMap(
      ...
      secretValue: map['secretValue'] == null
          ? null
          : ConnectionConfigVariableSecretValue.fromMap(
