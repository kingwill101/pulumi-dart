...
class InstanceDatafusionArgs {
  ...
  /// Structure is documented below.
  final pulumi.Input<InstanceNetworkConfigDatafusion>? networkConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkConfigValue != null) {
      map['networkConfig'] = pulumi.Input.mapOptionalInputValue<
          InstanceNetworkConfigDatafusion,
  ...
  factory InstanceDatafusionArgs.fromMap(Map<String, dynamic> map) {
    return InstanceDatafusionArgs(
      ...
      networkConfig:
          pulumi.Input.asOptionalInput<InstanceNetworkConfigDatafusion>(
              map['networkConfig']),
      options:
