...
class Instance5 extends CustomResource {
  ...
  late final Output<List<InstanceAccelerator>?> accelerators;
  ...
  /// Structure is documented below.
  late final Output<InstanceCryptoKeyConfig?> cryptoKeyConfig;
  ...
  /// Structure is documented below.
  late final Output<InstanceEventPublishConfig?> eventPublishConfig;
  ...
  /// Structure is documented below.
  late final Output<InstanceNetworkConfig2?> networkConfig;
