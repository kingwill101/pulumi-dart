...
class ApiIamBinding extends CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final Output<String> api;
  late final Output<ApiIamBindingCondition?> condition;
  ...
  ApiIamBinding(
    ...
    this.condition = Output.createUnknown<ApiIamBindingCondition?>();
