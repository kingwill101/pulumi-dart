...
class GatewayIamMemberArgs {
  final Input<GatewayIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<GatewayIamMemberCondition,
  ...
  factory GatewayIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return GatewayIamMemberArgs(
      condition:
          Input.asOptionalInput<GatewayIamMemberCondition>(map['condition']),
