...
class GatewayIamBindingArgs {
  final Input<GatewayIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<GatewayIamBindingCondition,
  ...
  factory GatewayIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return GatewayIamBindingArgs(
      condition:
          Input.asOptionalInput<GatewayIamBindingCondition>(map['condition']),
