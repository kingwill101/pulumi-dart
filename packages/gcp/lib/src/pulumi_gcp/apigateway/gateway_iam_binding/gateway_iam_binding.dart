...
import '../gateway_iam_binding_condition/gateway_iam_binding_condition.dart';
...
class GatewayIamBinding extends CustomResource {
  late final Output<GatewayIamBindingCondition?> condition;
  ...
  GatewayIamBinding(
    ...
    this.condition = registerOutput<GatewayIamBindingCondition?>('condition');
