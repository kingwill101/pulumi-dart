...
class ApiIamMemberArgs {
  ...
  final Input<ApiIamMemberCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<ApiIamMemberCondition,
  ...
  factory ApiIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApiIamMemberArgs(
      ...
      condition: Input.asOptionalInput<ApiIamMemberCondition>(map['condition']),
