...
class InstanceLookerArgs {
  ...
  factory InstanceLookerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceLookerArgs(
      ...
      controlledEgressEnabled:
          pulumi.Input.asOptionalInput<bool>(map['controlledEgressEnabled']),
      ...
      encryptionConfig: pulumi.Input.asOptionalInput<InstanceEncryptionConfig>(
          map['encryptionConfig']),
      fipsEnabled: pulumi.Input.asOptionalInput<bool>(map['fipsEnabled']),
      geminiEnabled: pulumi.Input.asOptionalInput<bool>(map['geminiEnabled']),
      maintenanceWindow:
          pulumi.Input.asOptionalInput<InstanceMaintenanceWindow>(
              map['maintenanceWindow']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      oauthConfig:
          pulumi.Input.asInput<InstanceOauthConfig>(map['oauthConfig']),
      periodicExportConfig:
          pulumi.Input.asOptionalInput<InstancePeriodicExportConfig>(
              map['periodicExportConfig']),
      platformEdition:
          pulumi.Input.asOptionalInput<String>(map['platformEdition']),
      privateIpEnabled:
          pulumi.Input.asOptionalInput<bool>(map['privateIpEnabled']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      pscConfig:
          pulumi.Input.asOptionalInput<InstancePscConfig>(map['pscConfig']),
      pscEnabled: pulumi.Input.asOptionalInput<bool>(map['pscEnabled']),
      publicIpEnabled:
