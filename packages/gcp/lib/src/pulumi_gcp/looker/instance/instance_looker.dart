...
import 'instance_looker_args.dart';
...
/// ```
class InstanceLooker extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<InstanceUserMetadata?> userMetadata;

  InstanceLooker(
    String name, {
    InstanceLookerArgs? args,
