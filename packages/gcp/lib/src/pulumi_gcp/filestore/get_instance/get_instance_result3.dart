...
class GetInstanceResult3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['directoryServices'] =
        Input.encodeList<GetInstanceDirectoryService, Map<String, dynamic>>(
            directoryServices, (value) => value.toMap());
    map['effectiveLabels'] = effectiveLabels;
    map['effectiveReplications'] =
        Input.encodeList<GetInstanceEffectiveReplication, Map<String, dynamic>>(
            effectiveReplications, (value) => value.toMap());
    map['etag'] = etag;
    map['fileShares'] =
        Input.encodeList<GetInstanceFileShare, Map<String, dynamic>>(
            fileShares, (value) => value.toMap());
    map['id'] = id;
    map['initialReplications'] =
        Input.encodeList<GetInstanceInitialReplication, Map<String, dynamic>>(
            initialReplications, (value) => value.toMap());
    ...
    map['name'] = name;
    map['networks'] =
        Input.encodeList<GetInstanceNetwork, Map<String, dynamic>>(
            networks, (value) => value.toMap());
    map['performanceConfigs'] =
        Input.encodeList<GetInstancePerformanceConfig, Map<String, dynamic>>(
            performanceConfigs, (value) => value.toMap());
  ...
  factory GetInstanceResult3.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult3(
      ...
      directoryServices: Input.decodeList<GetInstanceDirectoryService>(
          map['directoryServices'],
          (value) => GetInstanceDirectoryService.fromMap(
              (value as Map).cast<String, dynamic>())),
      effectiveLabels: (map['effectiveLabels'] as Map).cast<String, String>(),
      effectiveReplications: Input.decodeList<GetInstanceEffectiveReplication>(
          map['effectiveReplications'],
          (value) => GetInstanceEffectiveReplication.fromMap(
              (value as Map).cast<String, dynamic>())),
      etag: map['etag'] as String,
      fileShares: Input.decodeList<GetInstanceFileShare>(
          map['fileShares'],
          (value) => GetInstanceFileShare.fromMap(
              (value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      initialReplications: Input.decodeList<GetInstanceInitialReplication>(
          map['initialReplications'],
      ...
      networks: Input.decodeList<GetInstanceNetwork>(
          map['networks'],
          (value) => GetInstanceNetwork.fromMap(
              (value as Map).cast<String, dynamic>())),
      performanceConfigs: Input.decodeList<GetInstancePerformanceConfig>(
          map['performanceConfigs'],
