...
class RuntimeTemplateIamMember extends CustomResource {
  late final Output<RuntimeTemplateIamMemberCondition?> condition;
  ...
  RuntimeTemplateIamMember(
    ...
    this.condition = Output.createUnknown<RuntimeTemplateIamMemberCondition?>();
