...
/// Allows configuring a single GCP resource that should be inside of the <span pulumi-lang-nodejs="`spec`" pulumi-lang-dotnet="`Spec`" pulumi-lang-go="`spec`" pulumi-lang-python="`spec`" pulumi-lang-yaml="`spec`" pulumi-lang-java="`spec`">`spec`</span> block of a dry run service perimeter.
...
/// If your perimeter is NOT in dry-run mode use <span pulumi-lang-nodejs="`gcp.accesscontextmanager.ServicePerimeterResource`" pulumi-lang-dotnet="`gcp.accesscontextmanager.ServicePerimeterResource`" pulumi-lang-go="`accesscontextmanager.ServicePerimeterResource`" pulumi-lang-python="`accesscontextmanager.ServicePerimeterResource`" pulumi-lang-yaml="`gcp.accesscontextmanager.ServicePerimeterResource`" pulumi-lang-java="`gcp.accesscontextmanager.ServicePerimeterResource`">`gcp.accesscontextmanager.ServicePerimeterResource`</span> instead.
///
