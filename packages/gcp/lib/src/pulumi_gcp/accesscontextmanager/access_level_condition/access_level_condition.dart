...
/// of conditions to include in a <span pulumi-lang-nodejs="`gcp.accesscontextmanager.AccessLevel`" pulumi-lang-dotnet="`gcp.accesscontextmanager.AccessLevel`" pulumi-lang-go="`accesscontextmanager.AccessLevel`" pulumi-lang-python="`accesscontextmanager.AccessLevel`" pulumi-lang-yaml="`gcp.accesscontextmanager.AccessLevel`" pulumi-lang-java="`gcp.accesscontextmanager.AccessLevel`">`gcp.accesscontextmanager.AccessLevel`</span> resource,
/// to enable them to be added separately.
///
/// > **Note:** If this resource is used alongside a <span pulumi-lang-nodejs="`gcp.accesscontextmanager.AccessLevel`" pulumi-lang-dotnet="`gcp.accesscontextmanager.AccessLevel`" pulumi-lang-go="`accesscontextmanager.AccessLevel`" pulumi-lang-python="`accesscontextmanager.AccessLevel`" pulumi-lang-yaml="`gcp.accesscontextmanager.AccessLevel`" pulumi-lang-java="`gcp.accesscontextmanager.AccessLevel`">`gcp.accesscontextmanager.AccessLevel`</span> resource,
/// the access level resource must have a <span pulumi-lang-nodejs="`lifecycle`" pulumi-lang-dotnet="`Lifecycle`" pulumi-lang-go="`lifecycle`" pulumi-lang-python="`lifecycle`" pulumi-lang-yaml="`lifecycle`" pulumi-lang-java="`lifecycle`">`lifecycle`</span> block with <span pulumi-lang-nodejs="`ignoreChanges " pulumi-lang-dotnet="`IgnoreChanges " pulumi-lang-go="`ignoreChanges " pulumi-lang-python="`ignore_changes " pulumi-lang-yaml="`ignoreChanges " pulumi-lang-java="`ignoreChanges ">`ignore_changes </span>= [basic[0].conditions]` so
