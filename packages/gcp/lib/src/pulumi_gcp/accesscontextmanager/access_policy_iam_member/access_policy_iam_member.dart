...
import '../access_policy_iam_member_condition/access_policy_iam_member_condition.dart';
...
///
/// full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
class AccessPolicyIamMember extends CustomResource {
  late final Output<AccessPolicyIamMemberCondition?> condition;
  ...
  AccessPolicyIamMember(
    ...
    this.condition = Output.createUnknown<AccessPolicyIamMemberCondition?>();
