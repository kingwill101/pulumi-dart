...
import '../ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_exec/ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_exec.dart';
import '../ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_grpc/ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_grpc.dart';
import '../ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_http_get/ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_http_get.dart';
import '../ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_tcp_socket/ai_endpoint_with_model_garden_deployment_model_config_container_spec_liveness_probe_tcp_socket.dart';

class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe {
  /// ExecAction specifies a command to execute.
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeExec?
      exec;
  ...
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeGrpc?
      grpc;

  /// HttpGetAction describes an action based on HTTP Get requests.
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGet?
      httpGet;
  ...
  /// connection.
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeTcpSocket?
      tcpSocket;
  ...
  factory AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe.fromMap(
