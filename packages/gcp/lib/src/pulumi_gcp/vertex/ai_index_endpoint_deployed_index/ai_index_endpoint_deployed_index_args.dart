...
class AiIndexEndpointDeployedIndexArgs {
  ...
  factory AiIndexEndpointDeployedIndexArgs.fromMap(Map<String, dynamic> map) {
    return AiIndexEndpointDeployedIndexArgs(
      ...
      deployedIndexId: pulumi.Input.asInput<String>(map['deployedIndexId']),
      deploymentGroup:
          pulumi.Input.asOptionalInput<String>(map['deploymentGroup']),
      displayName: pulumi.Input.asOptionalInput<String>(map['displayName']),
      enableAccessLogging:
          pulumi.Input.asOptionalInput<bool>(map['enableAccessLogging']),
      index: pulumi.Input.asInput<String>(map['index']),
      indexEndpoint: pulumi.Input.asInput<String>(map['indexEndpoint']),
