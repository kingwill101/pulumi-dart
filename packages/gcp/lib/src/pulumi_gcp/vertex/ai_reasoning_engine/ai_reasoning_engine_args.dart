...
class AiReasoningEngineArgs {
  ...
  final Input<AiReasoningEngineEncryptionSpec>? encryptionSpec;
  ...
  /// Structure is documented below.
  final Input<AiReasoningEngineSpec>? spec;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (specValue != null) {
      map['spec'] = Input.mapOptionalInputValue<AiReasoningEngineSpec,
  ...
  factory AiReasoningEngineArgs.fromMap(Map<String, dynamic> map) {
    return AiReasoningEngineArgs(
      ...
      encryptionSpec: Input.asOptionalInput<AiReasoningEngineEncryptionSpec>(
          map['encryptionSpec']),
      project: Input.asOptionalInput<String>(map['project']),
      region: Input.asOptionalInput<String>(map['region']),
      spec: Input.asOptionalInput<AiReasoningEngineSpec>(map['spec']),
    );
  }
}
