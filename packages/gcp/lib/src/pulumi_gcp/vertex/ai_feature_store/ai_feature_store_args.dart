...
class AiFeatureStoreArgs {
  ...
  final Input<AiFeatureStoreEncryptionSpec>? encryptionSpec;
  ...
  /// Structure is documented below.
  final Input<AiFeatureStoreOnlineServingConfig>? onlineServingConfig;
  ...
  factory AiFeatureStoreArgs.fromMap(Map<String, dynamic> map) {
    return AiFeatureStoreArgs(
      encryptionSpec: Input.asOptionalInput<AiFeatureStoreEncryptionSpec>(
          map['encryptionSpec']),
      forceDestroy: Input.asOptionalInput<bool>(map['forceDestroy']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      name: Input.asOptionalInput<String>(map['name']),
      onlineServingConfig:
          Input.asOptionalInput<AiFeatureStoreOnlineServingConfig>(
