...
import '../ai_feature_store_iam_binding_condition/ai_feature_store_iam_binding_condition.dart';

/// The set of arguments for AiFeatureStoreIamBinding.
class AiFeatureStoreIamBindingArgs {
  final Input<AiFeatureStoreIamBindingCondition>? condition;
  ...
  factory AiFeatureStoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AiFeatureStoreIamBindingArgs(
      condition: Input.asOptionalInput<AiFeatureStoreIamBindingCondition>(
          map['condition']),
