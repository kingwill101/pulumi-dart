...
import '../ai_endpoint_private_service_connect_config_psc_automation_config/ai_endpoint_private_service_connect_config_psc_automation_config.dart';
...
class AiEndpointPrivateServiceConnectConfig {
  ...
  final List<AiEndpointPrivateServiceConnectConfigPscAutomationConfig>?
  ...
  Map<String, dynamic> toMap() {
    ...
    final enableSecurePrivateServiceConnectValue =
        enableSecurePrivateServiceConnect;
    if (enableSecurePrivateServiceConnectValue != null) {
      map['enableSecurePrivateServiceConnect'] =
          enableSecurePrivateServiceConnectValue;
    }
  ...
  factory AiEndpointPrivateServiceConnectConfig.fromMap(
      Map<String, dynamic> map) {
    return AiEndpointPrivateServiceConnectConfig(
      enablePrivateServiceConnect: map['enablePrivateServiceConnect'] as bool,
      enableSecurePrivateServiceConnect:
          map['enableSecurePrivateServiceConnect'] == null
              ? null
              : map['enableSecurePrivateServiceConnect'] as bool,
