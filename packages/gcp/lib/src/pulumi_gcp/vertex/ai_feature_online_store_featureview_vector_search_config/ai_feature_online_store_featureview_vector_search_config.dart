...
import '../ai_feature_online_store_featureview_vector_search_config_tree_ah_config/ai_feature_online_store_featureview_vector_search_config_tree_ah_config.dart';
...
class AiFeatureOnlineStoreFeatureviewVectorSearchConfig {
  ...
  final AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfig?
      treeAhConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['embeddingColumn'] = embeddingColumn;
  ...
  factory AiFeatureOnlineStoreFeatureviewVectorSearchConfig.fromMap(
