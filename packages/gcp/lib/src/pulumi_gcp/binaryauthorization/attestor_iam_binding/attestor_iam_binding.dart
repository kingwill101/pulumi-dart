...
import '../attestor_iam_binding_condition/attestor_iam_binding_condition.dart';
import 'attestor_iam_binding_args.dart';
...
class AttestorIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AttestorIamBindingCondition?> condition;
  ...
  AttestorIamBinding(
    ...
    this.condition = registerOutput<AttestorIamBindingCondition?>('condition');
