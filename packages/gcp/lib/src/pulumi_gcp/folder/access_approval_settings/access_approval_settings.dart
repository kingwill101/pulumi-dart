...
/// ```
class AccessApprovalSettings extends CustomResource {
  ...
  late final Output<List<AccessApprovalSettingsEnrolledService>>
      enrolledServices;

  /// ID of the folder of the access approval settings.
  late final Output<String> folderId;

  /// If the field is true, that indicates that there is some configuration issue with the<span pulumi-lang-nodejs=" activeKeyVersion
  /// " pulumi-lang-dotnet=" ActiveKeyVersion
  /// " pulumi-lang-go=" activeKeyVersion
  /// " pulumi-lang-python=" active_key_version
  /// " pulumi-lang-yaml=" activeKeyVersion
  /// " pulumi-lang-java=" activeKeyVersion
  /// "> active_key_version
  /// </span>configured on this Folder (e.g. it doesn't exist or the Access Approval service account doesn't have the
  ...
  AccessApprovalSettings(
    ...
    this.enrolledServices =
        Output.createUnknown<List<AccessApprovalSettingsEnrolledService>>();
