...
import '../get_organization_policy_boolean_policy/get_organization_policy_boolean_policy.dart';
import '../get_organization_policy_list_policy/get_organization_policy_list_policy.dart';
import '../get_organization_policy_restore_policy/get_organization_policy_restore_policy.dart';
...
class GetOrganizationPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['id'] = id;
    map['listPolicies'] =
        Input.encodeList<GetOrganizationPolicyListPolicy, Map<String, dynamic>>(
  ...
  factory GetOrganizationPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetOrganizationPolicyResult(
      booleanPolicies: Input.decodeList<GetOrganizationPolicyBooleanPolicy>(
          map['booleanPolicies'],
      ...
      id: map['id'] as String,
      listPolicies: Input.decodeList<GetOrganizationPolicyListPolicy>(
          map['listPolicies'],
          (value) => GetOrganizationPolicyListPolicy.fromMap(
              (value as Map).cast<String, dynamic>())),
      restorePolicies: Input.decodeList<GetOrganizationPolicyRestorePolicy>(
          map['restorePolicies'],
