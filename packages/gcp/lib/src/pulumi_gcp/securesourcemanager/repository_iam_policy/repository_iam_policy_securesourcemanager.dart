...
import 'repository_iam_policy_securesourcemanager_args.dart';
...
class RepositoryIamPolicySecuresourcemanager extends pulumi.CustomResource {
  ...
  RepositoryIamPolicySecuresourcemanager(
    String name, {
    RepositoryIamPolicySecuresourcemanagerArgs? args,
