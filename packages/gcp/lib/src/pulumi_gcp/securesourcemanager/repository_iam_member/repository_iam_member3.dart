...
import '../repository_iam_member_condition/repository_iam_member_condition3.dart';
...
class RepositoryIamMember3 extends CustomResource {
  late final Output<RepositoryIamMemberCondition3?> condition;
  ...
  RepositoryIamMember3(
    ...
    this.condition = Output.createUnknown<RepositoryIamMemberCondition3?>();
