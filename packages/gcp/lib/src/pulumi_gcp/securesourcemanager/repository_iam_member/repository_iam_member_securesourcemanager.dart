...
import 'repository_iam_member_securesourcemanager_args.dart';
...
class RepositoryIamMemberSecuresourcemanager extends pulumi.CustomResource {
  late final pulumi.Output<RepositoryIamMemberConditionSecuresourcemanager?>
      condition;
  ...
  RepositoryIamMemberSecuresourcemanager(
    String name, {
    RepositoryIamMemberSecuresourcemanagerArgs? args,
    ...
    this.condition =
        registerOutput<RepositoryIamMemberConditionSecuresourcemanager?>(
            'condition');
