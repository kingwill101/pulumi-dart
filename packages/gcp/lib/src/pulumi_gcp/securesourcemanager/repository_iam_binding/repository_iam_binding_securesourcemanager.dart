...
import 'repository_iam_binding_securesourcemanager_args.dart';
...
class RepositoryIamBindingSecuresourcemanager extends pulumi.CustomResource {
  late final pulumi.Output<RepositoryIamBindingConditionSecuresourcemanager?>
      condition;
  ...
  RepositoryIamBindingSecuresourcemanager(
    String name, {
    RepositoryIamBindingSecuresourcemanagerArgs? args,
    ...
    this.condition =
        registerOutput<RepositoryIamBindingConditionSecuresourcemanager?>(
            'condition');
