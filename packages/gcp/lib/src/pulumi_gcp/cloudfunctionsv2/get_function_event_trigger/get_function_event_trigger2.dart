...
class GetFunctionEventTrigger2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['eventFilters'] = Input.encodeList<GetFunctionEventTriggerEventFilter,
  ...
  factory GetFunctionEventTrigger2.fromMap(Map<String, dynamic> map) {
    return GetFunctionEventTrigger2(
      eventFilters: Input.decodeList<GetFunctionEventTriggerEventFilter>(
          map['eventFilters'],
