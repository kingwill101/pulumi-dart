...
import '../get_function_event_trigger/get_function_event_trigger_cloudfunctionsv2.dart';
...
class GetFunctionCloudfunctionsv2Result {
  ...
  final List<GetFunctionEventTriggerCloudfunctionsv2> eventTriggers;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['eventTriggers'] = pulumi.Input.encodeList<
        GetFunctionEventTriggerCloudfunctionsv2,
        Map<String, dynamic>>(eventTriggers, (value) => value.toMap());
    map['id'] = id;
  ...
  factory GetFunctionCloudfunctionsv2Result.fromMap(Map<String, dynamic> map) {
    return GetFunctionCloudfunctionsv2Result(
      ...
      eventTriggers:
          pulumi.Input.decodeList<GetFunctionEventTriggerCloudfunctionsv2>(
              map['eventTriggers'],
              (value) => GetFunctionEventTriggerCloudfunctionsv2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
