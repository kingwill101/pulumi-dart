...
import '../function_iam_binding_condition/function_iam_binding_condition_cloudfunctionsv2.dart';

/// The set of arguments for FunctionIamBinding.
class FunctionIamBindingCloudfunctionsv2Args {
  /// Used to find the parent resource to bind the IAM policy to
  final pulumi.Input<String> cloudFunction;
  final pulumi.Input<FunctionIamBindingConditionCloudfunctionsv2>? condition;
  ...
  FunctionIamBindingCloudfunctionsv2Args({
  ...
  factory FunctionIamBindingCloudfunctionsv2Args.fromMap(
    ...
    return FunctionIamBindingCloudfunctionsv2Args(
      ...
      condition: pulumi.Input.asOptionalInput<
          FunctionIamBindingConditionCloudfunctionsv2>(map['condition']),
