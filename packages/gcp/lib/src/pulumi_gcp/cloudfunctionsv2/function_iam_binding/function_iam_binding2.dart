...
import '../function_iam_binding_condition/function_iam_binding_condition2.dart';
import 'function_iam_binding_args2.dart';
...
class FunctionIamBinding2 extends CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final Output<String> cloudFunction;
  late final Output<FunctionIamBindingCondition2?> condition;
