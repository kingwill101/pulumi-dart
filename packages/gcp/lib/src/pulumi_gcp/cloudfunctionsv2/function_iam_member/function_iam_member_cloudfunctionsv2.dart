...
import '../function_iam_member_condition/function_iam_member_condition_cloudfunctionsv2.dart';
import 'function_iam_member_cloudfunctionsv2_args.dart';
...
class FunctionIamMemberCloudfunctionsv2 extends pulumi.CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final pulumi.Output<String> cloudFunction;
  late final pulumi.Output<FunctionIamMemberConditionCloudfunctionsv2?>
      condition;
  ...
  FunctionIamMemberCloudfunctionsv2(
    String name, {
    FunctionIamMemberCloudfunctionsv2Args? args,
    ...
    this.condition =
        registerOutput<FunctionIamMemberConditionCloudfunctionsv2?>(
            'condition');
