...
import 'function_iam_member_args2.dart';
...
class FunctionIamMember2 extends CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final Output<String> cloudFunction;
  late final Output<FunctionIamMemberCondition2?> condition;
  ...
  FunctionIamMember2(
    ...
    this.condition = registerOutput<FunctionIamMemberCondition2?>('condition');
