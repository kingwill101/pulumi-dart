...
import '../function_build_config_on_deploy_update_policy/function_build_config_on_deploy_update_policy.dart';
import '../function_build_config_source/function_build_config_source.dart';
...
class FunctionBuildConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (onDeployUpdatePolicyValue != null) {
      map['onDeployUpdatePolicy'] = onDeployUpdatePolicyValue.toMap();
    }
