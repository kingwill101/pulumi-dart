...
class Certificate2 extends CustomResource {
  ...
  late final Output<CertificateManaged?> managed;
  ...
  /// Structure is documented below.
  late final Output<CertificateSelfManaged?> selfManaged;
