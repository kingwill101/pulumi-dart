...
class BackupScheduleSpannerArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (specValue != null) {
      map['spec'] = pulumi.Input.mapOptionalInputValue<BackupScheduleSpec,
          Map<String, dynamic>>(specValue, (value) => value.toMap());
    }
    return map;
  }

  factory BackupScheduleSpannerArgs.fromMap(Map<String, dynamic> map) {
    return BackupScheduleSpannerArgs(
      ...
      fullBackupSpec: pulumi.Input.asOptionalInput<Map<String, dynamic>>(
          map['fullBackupSpec']),
      incrementalBackupSpec: pulumi.Input.asOptionalInput<Map<String, dynamic>>(
          map['incrementalBackupSpec']),
      instance: pulumi.Input.asInput<String>(map['instance']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      retentionDuration: pulumi.Input.asInput<String>(map['retentionDuration']),
      spec: pulumi.Input.asOptionalInput<BackupScheduleSpec>(map['spec']),
    );
  }
}
