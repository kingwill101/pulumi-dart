...
class InstanceIAMBindingSpannerArgs {
  final pulumi.Input<InstanceIAMBindingConditionSpanner>? condition;
  ...
  factory InstanceIAMBindingSpannerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceIAMBindingSpannerArgs(
      condition:
          pulumi.Input.asOptionalInput<InstanceIAMBindingConditionSpanner>(
              map['condition']),
