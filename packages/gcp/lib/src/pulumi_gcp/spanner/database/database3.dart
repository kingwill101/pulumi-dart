...
/// On older versions, it is strongly recommended to set `lifecycle {<span pulumi-lang-nodejs=" preventDestroy " pulumi-lang-dotnet=" PreventDestroy " pulumi-lang-go=" preventDestroy " pulumi-lang-python=" prevent_destroy " pulumi-lang-yaml=" preventDestroy " pulumi-lang-java=" preventDestroy "> prevent_destroy </span>= true }`
...
class Database3 extends CustomResource {
  ...
  late final Output<DatabaseEncryptionConfig?> encryptionConfig;
