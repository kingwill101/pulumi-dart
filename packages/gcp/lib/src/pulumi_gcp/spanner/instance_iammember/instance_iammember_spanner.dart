...
import 'instance_iammember_spanner_args.dart';
...
/// ```
class InstanceIAMMemberSpanner extends pulumi.CustomResource {
  late final pulumi.Output<InstanceIAMMemberConditionSpanner?> condition;
  ...
  InstanceIAMMemberSpanner(
    String name, {
    InstanceIAMMemberSpannerArgs? args,
    ...
    this.condition =
        registerOutput<InstanceIAMMemberConditionSpanner?>('condition');
