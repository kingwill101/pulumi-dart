...
import '../instance_iammember_condition/instance_iammember_condition_spanner.dart';

/// The set of arguments for InstanceIAMMember.
class InstanceIAMMemberSpannerArgs {
  final pulumi.Input<InstanceIAMMemberConditionSpanner>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = pulumi.Input.mapOptionalInputValue<
          InstanceIAMMemberConditionSpanner,
  ...
  factory InstanceIAMMemberSpannerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceIAMMemberSpannerArgs(
      condition:
          pulumi.Input.asOptionalInput<InstanceIAMMemberConditionSpanner>(
              map['condition']),
