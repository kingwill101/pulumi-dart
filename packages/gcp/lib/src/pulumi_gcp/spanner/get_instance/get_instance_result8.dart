...
class GetInstanceResult8 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['autoscalingConfigs'] =
        Input.encodeList<GetInstanceAutoscalingConfig, Map<String, dynamic>>(
  ...
  factory GetInstanceResult8.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult8(
      autoscalingConfigs: Input.decodeList<GetInstanceAutoscalingConfig>(
          map['autoscalingConfigs'],
