...
///
/// > **Note:** Recreating a <span pulumi-lang-nodejs="`gcp.compute.RegionBackendService`" pulumi-lang-dotnet="`gcp.compute.RegionBackendService`" pulumi-lang-go="`compute.RegionBackendService`" pulumi-lang-python="`compute.RegionBackendService`" pulumi-lang-yaml="`gcp.compute.RegionBackendService`" pulumi-lang-java="`gcp.compute.RegionBackendService`">`gcp.compute.RegionBackendService`</span> that references other dependent resources like <span pulumi-lang-nodejs="`gcp.compute.InstanceGroup`" pulumi-lang-dotnet="`gcp.compute.InstanceGroup`" pulumi-lang-go="`compute.InstanceGroup`" pulumi-lang-python="`compute.InstanceGroup`" pulumi-lang-yaml="`gcp.compute.InstanceGroup`" pulumi-lang-java="`gcp.compute.InstanceGroup`">`gcp.compute.InstanceGroup`</span> will give a `resourceInUseByAnotherResource` error, when decreasing the number of other dependent resources.
