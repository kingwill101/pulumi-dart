...
class GetStoragePoolResourceStatus {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['poolUsedCapacityBytes'] = poolUsedCapacityBytes;
    map['poolUsedIops'] = poolUsedIops;
    map['poolUsedThroughput'] = poolUsedThroughput;
    map['poolUserWrittenBytes'] = poolUserWrittenBytes;
    map['totalProvisionedDiskCapacityGb'] = totalProvisionedDiskCapacityGb;
    map['totalProvisionedDiskIops'] = totalProvisionedDiskIops;
    map['totalProvisionedDiskThroughput'] = totalProvisionedDiskThroughput;
    return map;
  }

  factory GetStoragePoolResourceStatus.fromMap(Map<String, dynamic> map) {
    return GetStoragePoolResourceStatus(
