...
import '../machine_image_iam_member_condition/machine_image_iam_member_condition.dart';
import 'machine_image_iam_member_args.dart';
...
class MachineImageIamMember extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<MachineImageIamMemberCondition?> condition;
  ...
  MachineImageIamMember(
    String name, {
    MachineImageIamMemberArgs? args,
