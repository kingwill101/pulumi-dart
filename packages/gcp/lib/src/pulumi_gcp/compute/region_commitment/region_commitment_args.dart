...
class RegionCommitmentArgs {
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      category: pulumi.Input.asOptionalInput<String>(map['category']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      existingReservations:
          pulumi.Input.asOptionalInput<String>(map['existingReservations']),
      licenseResource:
      ...
      resources: pulumi.Input.asOptionalInput<List<RegionCommitmentResource>>(
          map['resources']),
