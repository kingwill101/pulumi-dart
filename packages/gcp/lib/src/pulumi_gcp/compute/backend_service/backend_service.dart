...
///
/// > **Note:** Recreating a <span pulumi-lang-nodejs="`gcp.compute.BackendService`" pulumi-lang-dotnet="`gcp.compute.BackendService`" pulumi-lang-go="`compute.BackendService`" pulumi-lang-python="`compute.BackendService`" pulumi-lang-yaml="`gcp.compute.BackendService`" pulumi-lang-java="`gcp.compute.BackendService`">`gcp.compute.BackendService`</span> that references other dependent resources like <span pulumi-lang-nodejs="`gcp.compute.URLMap`" pulumi-lang-dotnet="`gcp.compute.URLMap`" pulumi-lang-go="`compute.URLMap`" pulumi-lang-python="`compute.URLMap`" pulumi-lang-yaml="`gcp.compute.URLMap`" pulumi-lang-java="`gcp.compute.URLMap`">`gcp.compute.URLMap`</span> will give a `resourceInUseByAnotherResource` error, when modifying the number of other dependent resources.
