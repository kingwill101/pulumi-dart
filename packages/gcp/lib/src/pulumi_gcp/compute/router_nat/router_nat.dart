...
///
/// > **Note:** Recreating a <span pulumi-lang-nodejs="`gcp.compute.Address`" pulumi-lang-dotnet="`gcp.compute.Address`" pulumi-lang-go="`compute.Address`" pulumi-lang-python="`compute.Address`" pulumi-lang-yaml="`gcp.compute.Address`" pulumi-lang-java="`gcp.compute.Address`">`gcp.compute.Address`</span> that is being used by <span pulumi-lang-nodejs="`gcp.compute.RouterNat`" pulumi-lang-dotnet="`gcp.compute.RouterNat`" pulumi-lang-go="`compute.RouterNat`" pulumi-lang-python="`compute.RouterNat`" pulumi-lang-yaml="`gcp.compute.RouterNat`" pulumi-lang-java="`gcp.compute.RouterNat`">`gcp.compute.RouterNat`</span> will give a `resourceInUseByAnotherResource` error.
