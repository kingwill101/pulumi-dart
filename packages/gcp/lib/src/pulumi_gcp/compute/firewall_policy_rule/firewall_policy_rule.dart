...
/// ```
class FirewallPolicyRule extends CustomResource {
  ...
  late final Output<FirewallPolicyRuleMatch> match;
  ...
  late final Output<List<String>?> targetResources;
  ...
  /// Structure is documented below.
  late final Output<List<FirewallPolicyRuleTargetSecureTag>?> targetSecureTags;
