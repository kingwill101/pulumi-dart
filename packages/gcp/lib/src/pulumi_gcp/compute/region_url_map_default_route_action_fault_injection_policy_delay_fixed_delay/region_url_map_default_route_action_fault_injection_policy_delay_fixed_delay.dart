...
class RegionUrlMapDefaultRouteActionFaultInjectionPolicyDelayFixedDelay {
  ...
  factory RegionUrlMapDefaultRouteActionFaultInjectionPolicyDelayFixedDelay.fromMap(
      Map<String, dynamic> map) {
    return RegionUrlMapDefaultRouteActionFaultInjectionPolicyDelayFixedDelay(
