...
class URLMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay {
  ...
  factory URLMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay.fromMap(
      Map<String, dynamic> map) {
    return URLMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay(
