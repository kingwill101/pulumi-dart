...
class NetworkFirewallPolicyRuleArgs {
  ...
  final Input<NetworkFirewallPolicyRuleMatch> match;
  ...
  /// Structure is documented below.
  final Input<List<NetworkFirewallPolicyRuleTargetSecureTag>>? targetSecureTags;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['match'] = Input.mapInputValue<NetworkFirewallPolicyRuleMatch,
    ...
    if (targetSecureTagsValue != null) {
      map['targetSecureTags'] = Input.mapOptionalInputValue<
          ...
          (value) => Input.encodeList<NetworkFirewallPolicyRuleTargetSecureTag,
  ...
  factory NetworkFirewallPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyRuleArgs(
      ...
      match: Input.asInput<NetworkFirewallPolicyRuleMatch>(map['match']),
      ...
      targetSecureTags:
          Input.asOptionalInput<List<NetworkFirewallPolicyRuleTargetSecureTag>>(
