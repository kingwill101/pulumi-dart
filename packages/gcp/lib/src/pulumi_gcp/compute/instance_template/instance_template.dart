...
/// You can achieve this by using the <span pulumi-lang-nodejs="`gcp.compute.Image`" pulumi-lang-dotnet="`gcp.compute.Image`" pulumi-lang-go="`compute.Image`" pulumi-lang-python="`compute.Image`" pulumi-lang-yaml="`gcp.compute.Image`" pulumi-lang-java="`gcp.compute.Image`">`gcp.compute.Image`</span>
