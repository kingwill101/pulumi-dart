...
class InstanceTemplate extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InstanceTemplateAdvancedMachineFeatures?>
  ...
  late final pulumi.Output<InstanceTemplateConfidentialInstanceConfig>
  ...
  late final pulumi.Output<List<InstanceTemplateGuestAccelerator>?>
      guestAccelerators;
  ...
  late final pulumi.Output<List<InstanceTemplateNetworkInterface>?>
      networkInterfaces;
  ...
  late final pulumi.Output<InstanceTemplateNetworkPerformanceConfig?>
  ...
  /// Structure is documented below.
  late final pulumi.Output<InstanceTemplateReservationAffinity?>
      reservationAffinity;
  ...
  late final pulumi.Output<InstanceTemplateShieldedInstanceConfig>
