...
import '../subnetwork_iambinding_condition/subnetwork_iambinding_condition.dart';
...
class SubnetworkIAMBinding extends CustomResource {
  ...
  late final Output<SubnetworkIAMBindingCondition?> condition;
  ...
  SubnetworkIAMBinding(
    ...
    this.condition = Output.createUnknown<SubnetworkIAMBindingCondition?>();
