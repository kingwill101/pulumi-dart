...
///
/// > **Note:** This resource does not support regional disks (<span pulumi-lang-nodejs="`gcp.compute.RegionDisk`" pulumi-lang-dotnet="`gcp.compute.RegionDisk`" pulumi-lang-go="`compute.RegionDisk`" pulumi-lang-python="`compute.RegionDisk`" pulumi-lang-yaml="`gcp.compute.RegionDisk`" pulumi-lang-java="`gcp.compute.RegionDisk`">`gcp.compute.RegionDisk`</span>). For regional disks, please refer to the <span pulumi-lang-nodejs="`gcp.compute.RegionDiskResourcePolicyAttachment`" pulumi-lang-dotnet="`gcp.compute.RegionDiskResourcePolicyAttachment`" pulumi-lang-go="`compute.RegionDiskResourcePolicyAttachment`" pulumi-lang-python="`compute.RegionDiskResourcePolicyAttachment`" pulumi-lang-yaml="`gcp.compute.RegionDiskResourcePolicyAttachment`" pulumi-lang-java="`gcp.compute.RegionDiskResourcePolicyAttachment`">`gcp.compute.RegionDiskResourcePolicyAttachment`</span> resource.
///
///
/// ## Example Usage
///
