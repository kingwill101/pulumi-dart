...
import '../instance_from_template_scheduling_graceful_shutdown/instance_from_template_scheduling_graceful_shutdown.dart';
import '../instance_from_template_scheduling_local_ssd_recovery_timeout/instance_from_template_scheduling_local_ssd_recovery_timeout.dart';
import '../instance_from_template_scheduling_max_run_duration/instance_from_template_scheduling_max_run_duration.dart';
import '../instance_from_template_scheduling_node_affinity/instance_from_template_scheduling_node_affinity.dart';
import '../instance_from_template_scheduling_on_instance_stop_action/instance_from_template_scheduling_on_instance_stop_action.dart';
...
class InstanceFromTemplateScheduling {
  ...
  /// hour.
  final InstanceFromTemplateSchedulingLocalSsdRecoveryTimeout?
  ...
  final InstanceFromTemplateSchedulingOnInstanceStopAction?
  ...
  factory InstanceFromTemplateScheduling.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateScheduling(
      ...
      nodeAffinities: map['nodeAffinities'] == null
          ? null
          : Input.decodeList<InstanceFromTemplateSchedulingNodeAffinity>(
              map['nodeAffinities'],
