...
class BackendBucketIamBinding extends CustomResource {
  late final Output<BackendBucketIamBindingCondition?> condition;
  ...
  BackendBucketIamBinding(
    ...
    this.condition = Output.createUnknown<BackendBucketIamBindingCondition?>();
