...
import '../router_status_best_routes_for_router_warning_data/router_status_best_routes_for_router_warning_data.dart';
...
class RouterStatusBestRoutesForRouterWarning {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['code'] = code;
    map['datas'] = Input.encodeList<RouterStatusBestRoutesForRouterWarningData,
  ...
  factory RouterStatusBestRoutesForRouterWarning.fromMap(
    ...
    return RouterStatusBestRoutesForRouterWarning(
      ...
      datas: Input.decodeList<RouterStatusBestRoutesForRouterWarningData>(
          map['datas'],
