...
import '../instance_template_disk_disk_encryption_key/instance_template_disk_disk_encryption_key.dart';
import '../instance_template_disk_source_image_encryption_key/instance_template_disk_source_image_encryption_key.dart';
...
class InstanceTemplateDisk {
  ...
  final InstanceTemplateDiskDiskEncryptionKey? diskEncryptionKey;
  ...
  /// documented below.
  final InstanceTemplateDiskSourceSnapshotEncryptionKey?
  ...
  factory InstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateDisk(
      ...
      diskEncryptionKey: map['diskEncryptionKey'] == null
          ? null
          : InstanceTemplateDiskDiskEncryptionKey.fromMap(
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null
          ? null
          : InstanceTemplateDiskSourceImageEncryptionKey.fromMap(
      ...
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null
          ? null
          : InstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap(
