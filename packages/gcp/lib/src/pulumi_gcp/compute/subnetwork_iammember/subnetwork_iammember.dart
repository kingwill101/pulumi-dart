...
import '../subnetwork_iammember_condition/subnetwork_iammember_condition.dart';
...
class SubnetworkIAMMember extends CustomResource {
  ...
  late final Output<SubnetworkIAMMemberCondition?> condition;
  ...
  SubnetworkIAMMember(
    ...
    this.condition = registerOutput<SubnetworkIAMMemberCondition?>('condition');
