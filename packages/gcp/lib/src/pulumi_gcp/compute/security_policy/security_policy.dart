...
/// A scenario example that won't cause any conflict between <span pulumi-lang-nodejs="`enforceOnKey`" pulumi-lang-dotnet="`EnforceOnKey`" pulumi-lang-go="`enforceOnKey`" pulumi-lang-python="`enforce_on_key`" pulumi-lang-yaml="`enforceOnKey`" pulumi-lang-java="`enforceOnKey`">`enforce_on_key`</span> and <span pulumi-lang-nodejs="`enforceOnKeyConfigs`" pulumi-lang-dotnet="`EnforceOnKeyConfigs`" pulumi-lang-go="`enforceOnKeyConfigs`" pulumi-lang-python="`enforce_on_key_configs`" pulumi-lang-yaml="`enforceOnKeyConfigs`" pulumi-lang-java="`enforceOnKeyConfigs`">`enforce_on_key_configs`</span>, because <span pulumi-lang-nodejs="`enforceOnKey`" pulumi-lang-dotnet="`EnforceOnKey`" pulumi-lang-go="`enforceOnKey`" pulumi-lang-python="`enforce_on_key`" pulumi-lang-yaml="`enforceOnKey`" pulumi-lang-java="`enforceOnKey`">`enforce_on_key`</span> was specified as an empty string:
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
