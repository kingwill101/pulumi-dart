...
class RouterPeerArgs {
  ...
  factory RouterPeerArgs.fromMap(Map<String, dynamic> map) {
    return RouterPeerArgs(
      advertiseMode: pulumi.Input.asOptionalInput<String>(map['advertiseMode']),
      advertisedGroups:
          pulumi.Input.asOptionalInput<List<String>>(map['advertisedGroups']),
      advertisedIpRanges:
          pulumi.Input.asOptionalInput<List<RouterPeerAdvertisedIpRange>>(
              map['advertisedIpRanges']),
      advertisedRoutePriority:
          pulumi.Input.asOptionalInput<int>(map['advertisedRoutePriority']),
      bfd: pulumi.Input.asOptionalInput<RouterPeerBfd>(map['bfd']),
      customLearnedIpRanges:
          pulumi.Input.asOptionalInput<List<RouterPeerCustomLearnedIpRange>>(
              map['customLearnedIpRanges']),
      customLearnedRoutePriority:
          pulumi.Input.asOptionalInput<int>(map['customLearnedRoutePriority']),
      enable: pulumi.Input.asOptionalInput<bool>(map['enable']),
      enableIpv4: pulumi.Input.asOptionalInput<bool>(map['enableIpv4']),
      enableIpv6: pulumi.Input.asOptionalInput<bool>(map['enableIpv6']),
      exportPolicies:
          pulumi.Input.asOptionalInput<List<String>>(map['exportPolicies']),
      importPolicies:
          pulumi.Input.asOptionalInput<List<String>>(map['importPolicies']),
      interface: pulumi.Input.asInput<String>(map['interface']),
      ipAddress: pulumi.Input.asOptionalInput<String>(map['ipAddress']),
      ipv4NexthopAddress:
          pulumi.Input.asOptionalInput<String>(map['ipv4NexthopAddress']),
      ipv6NexthopAddress:
          pulumi.Input.asOptionalInput<String>(map['ipv6NexthopAddress']),
      md5AuthenticationKey:
          pulumi.Input.asOptionalInput<RouterPeerMd5AuthenticationKey>(
              map['md5AuthenticationKey']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      peerAsn: pulumi.Input.asInput<int>(map['peerAsn']),
      peerIpAddress: pulumi.Input.asOptionalInput<String>(map['peerIpAddress']),
      peerIpv4NexthopAddress:
          pulumi.Input.asOptionalInput<String>(map['peerIpv4NexthopAddress']),
      peerIpv6NexthopAddress:
          pulumi.Input.asOptionalInput<String>(map['peerIpv6NexthopAddress']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      router: pulumi.Input.asInput<String>(map['router']),
      routerApplianceInstance:
          pulumi.Input.asOptionalInput<String>(map['routerApplianceInstance']),
      zeroAdvertisedRoutePriority: pulumi.Input.asOptionalInput<bool>(
          map['zeroAdvertisedRoutePriority']),
      zeroCustomLearnedRoutePriority: pulumi.Input.asOptionalInput<bool>(
          map['zeroCustomLearnedRoutePriority']),
    );
  }
}
