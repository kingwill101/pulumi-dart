...
class GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader {
  ...
  factory GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader.fromMap(
      Map<String, dynamic> map) {
    return GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader(
