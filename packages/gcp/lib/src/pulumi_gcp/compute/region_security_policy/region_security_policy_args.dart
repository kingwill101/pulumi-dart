...
class RegionSecurityPolicyArgs {
  ...
  final Input<RegionSecurityPolicyAdvancedOptionsConfig>? advancedOptionsConfig;

  /// Configuration for Google Cloud Armor DDOS Proctection Config.
  /// Structure is documented below.
  final Input<RegionSecurityPolicyDdosProtectionConfig>? ddosProtectionConfig;
  ...
  /// Structure is documented below.
  final Input<List<RegionSecurityPolicyRule>>? rules;
  ...
  /// Structure is documented below.
  final Input<List<RegionSecurityPolicyUserDefinedField>>? userDefinedFields;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (rulesValue != null) {
      map['rules'] = Input.mapOptionalInputValue<List<RegionSecurityPolicyRule>,
              List<Map<String, dynamic>>>(
          rulesValue,
          (value) =>
              Input.encodeList<RegionSecurityPolicyRule, Map<String, dynamic>>(
    ...
    if (userDefinedFieldsValue != null) {
      map['userDefinedFields'] = Input.mapOptionalInputValue<
          ...
          (value) => Input.encodeList<RegionSecurityPolicyUserDefinedField,
  ...
  factory RegionSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyArgs(
      advancedOptionsConfig:
          Input.asOptionalInput<RegionSecurityPolicyAdvancedOptionsConfig>(
              map['advancedOptionsConfig']),
      ddosProtectionConfig:
          Input.asOptionalInput<RegionSecurityPolicyDdosProtectionConfig>(
      ...
      rules:
          Input.asOptionalInput<List<RegionSecurityPolicyRule>>(map['rules']),
      type: Input.asOptionalInput<String>(map['type']),
      userDefinedFields:
          Input.asOptionalInput<List<RegionSecurityPolicyUserDefinedField>>(
