...
///
/// > **Note:** Use <span pulumi-lang-nodejs="[gcp.compute.RegionInstanceGroupManager]" pulumi-lang-dotnet="[gcp.compute.RegionInstanceGroupManager]" pulumi-lang-go="[compute.RegionInstanceGroupManager]" pulumi-lang-python="[compute.RegionInstanceGroupManager]" pulumi-lang-yaml="[gcp.compute.RegionInstanceGroupManager]" pulumi-lang-java="[gcp.compute.RegionInstanceGroupManager]">[gcp.compute.RegionInstanceGroupManager]</span>(https://www.terraform.io/docs/providers/google/r/compute_region_instance_group_manager.html) to create a regional (multi-zone) instance group manager.
///
/// ## Example Usage
///
