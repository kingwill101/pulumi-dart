...
import '../instance_from_machine_image_boot_disk_initialize_params/instance_from_machine_image_boot_disk_initialize_params.dart';
...
class InstanceFromMachineImageBootDisk {
  ...
  final InstanceFromMachineImageBootDiskInitializeParams? initializeParams;
  ...
  factory InstanceFromMachineImageBootDisk.fromMap(Map<String, dynamic> map) {
    return InstanceFromMachineImageBootDisk(
      ...
      initializeParams: map['initializeParams'] == null
          ? null
          : InstanceFromMachineImageBootDiskInitializeParams.fromMap(
