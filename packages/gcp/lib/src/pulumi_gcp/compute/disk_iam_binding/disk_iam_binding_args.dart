...
import '../disk_iam_binding_condition/disk_iam_binding_condition.dart';

/// The set of arguments for DiskIamBinding.
class DiskIamBindingArgs {
  final Input<DiskIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<DiskIamBindingCondition,
  ...
  factory DiskIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DiskIamBindingArgs(
      condition:
          Input.asOptionalInput<DiskIamBindingCondition>(map['condition']),
