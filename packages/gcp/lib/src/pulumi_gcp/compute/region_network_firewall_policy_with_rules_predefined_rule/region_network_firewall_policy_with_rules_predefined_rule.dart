...
class RegionNetworkFirewallPolicyWithRulesPredefinedRule {
  ...
  final List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch>? matches;
  ...
  /// Structure is documented below.
  final List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag>?
      targetSecureTags;
  ...
  factory RegionNetworkFirewallPolicyWithRulesPredefinedRule.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyWithRulesPredefinedRule(
