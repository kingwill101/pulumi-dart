...
class URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout {
  ...
  factory URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout.fromMap(
      Map<String, dynamic> map) {
    return URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout(
