...
import 'region_backend_service_iam_binding_args.dart';
...
class RegionBackendServiceIamBinding extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<RegionBackendServiceIamBindingCondition?> condition;
  ...
  RegionBackendServiceIamBinding(
    String name, {
    RegionBackendServiceIamBindingArgs? args,
