...
class RegionDiskIamBinding extends CustomResource {
  late final Output<RegionDiskIamBindingCondition?> condition;
  ...
  RegionDiskIamBinding(
    ...
    this.condition = Output.createUnknown<RegionDiskIamBindingCondition?>();
