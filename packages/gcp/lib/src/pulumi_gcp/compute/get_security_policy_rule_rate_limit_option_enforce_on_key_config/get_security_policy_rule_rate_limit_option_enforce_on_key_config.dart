...
class GetSecurityPolicyRuleRateLimitOptionEnforceOnKeyConfig {
  ...
  /// Determines the key to enforce the<span pulumi-lang-nodejs=" rateLimitThreshold " pulumi-lang-dotnet=" RateLimitThreshold " pulumi-lang-go=" rateLimitThreshold " pulumi-lang-python=" rate_limit_threshold " pulumi-lang-yaml=" rateLimitThreshold " pulumi-lang-java=" rateLimitThreshold "> rate_limit_threshold </span>on
