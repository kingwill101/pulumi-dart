...
/// ```
class RegionSecurityPolicyRule2 extends CustomResource {
  ...
  late final Output<RegionSecurityPolicyRuleMatch?> match;
  ...
  /// Structure is documented below.
  late final Output<RegionSecurityPolicyRuleNetworkMatch?> networkMatch;

  /// Preconfigured WAF configuration to be applied for the rule.
  /// If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  /// Structure is documented below.
  late final Output<RegionSecurityPolicyRulePreconfiguredWafConfig?>
      preconfiguredWafConfig;
  ...
  /// Structure is documented below.
  late final Output<RegionSecurityPolicyRuleRateLimitOptions?> rateLimitOptions;
