...
///
/// > **NOTE** You can use this resource instead of the <span pulumi-lang-nodejs="`instances`" pulumi-lang-dotnet="`Instances`" pulumi-lang-go="`instances`" pulumi-lang-python="`instances`" pulumi-lang-yaml="`instances`" pulumi-lang-java="`instances`">`instances`</span> field in the
/// <span pulumi-lang-nodejs="`gcp.compute.InstanceGroup`" pulumi-lang-dotnet="`gcp.compute.InstanceGroup`" pulumi-lang-go="`compute.InstanceGroup`" pulumi-lang-python="`compute.InstanceGroup`" pulumi-lang-yaml="`gcp.compute.InstanceGroup`" pulumi-lang-java="`gcp.compute.InstanceGroup`">`gcp.compute.InstanceGroup`</span>, however it's not recommended to use it alongside this field.
...
/// ```
class InstanceGroupMembership extends CustomResource {
