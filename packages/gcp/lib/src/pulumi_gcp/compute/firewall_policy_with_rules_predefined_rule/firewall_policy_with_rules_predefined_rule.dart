...
class FirewallPolicyWithRulesPredefinedRule {
  ...
  /// Structure is documented below.
  final List<FirewallPolicyWithRulesPredefinedRuleTargetSecureTag>?
      targetSecureTags;
  ...
  factory FirewallPolicyWithRulesPredefinedRule.fromMap(
    ...
    return FirewallPolicyWithRulesPredefinedRule(
      ...
      targetSecureTags: map['targetSecureTags'] == null
          ...
          : Input.decodeList<
              ...
              (value) =>
                  FirewallPolicyWithRulesPredefinedRuleTargetSecureTag.fromMap(
                      (value as Map).cast<String, dynamic>())),
