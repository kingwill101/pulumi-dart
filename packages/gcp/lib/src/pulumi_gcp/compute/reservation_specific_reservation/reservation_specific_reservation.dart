...
import '../reservation_specific_reservation_instance_properties/reservation_specific_reservation_instance_properties.dart';
...
class ReservationSpecificReservation {
  ...
  Map<String, dynamic> toMap() {
    ...
    final assuredCountValue = assuredCount;
    if (assuredCountValue != null) {
      map['assuredCount'] = assuredCountValue;
    }
    map['count'] = count;
    final inUseCountValue = inUseCount;
    if (inUseCountValue != null) {
      map['inUseCount'] = inUseCountValue;
    }
  ...
  factory ReservationSpecificReservation.fromMap(Map<String, dynamic> map) {
    return ReservationSpecificReservation(
      assuredCount:
          map['assuredCount'] == null ? null : map['assuredCount'] as int,
