...
///
/// > **Note:** This resource does not support zonal disks (<span pulumi-lang-nodejs="`gcp.compute.Disk`" pulumi-lang-dotnet="`gcp.compute.Disk`" pulumi-lang-go="`compute.Disk`" pulumi-lang-python="`compute.Disk`" pulumi-lang-yaml="`gcp.compute.Disk`" pulumi-lang-java="`gcp.compute.Disk`">`gcp.compute.Disk`</span>). For zonal disks, please refer to the <span pulumi-lang-nodejs="`gcp.compute.DiskResourcePolicyAttachment`" pulumi-lang-dotnet="`gcp.compute.DiskResourcePolicyAttachment`" pulumi-lang-go="`compute.DiskResourcePolicyAttachment`" pulumi-lang-python="`compute.DiskResourcePolicyAttachment`" pulumi-lang-yaml="`gcp.compute.DiskResourcePolicyAttachment`" pulumi-lang-java="`gcp.compute.DiskResourcePolicyAttachment`">`gcp.compute.DiskResourcePolicyAttachment`</span> resource.
///
///
///
///
