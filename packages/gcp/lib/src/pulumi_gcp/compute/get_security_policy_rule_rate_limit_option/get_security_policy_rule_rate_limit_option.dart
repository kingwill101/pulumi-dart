...
import '../get_security_policy_rule_rate_limit_option_rate_limit_threshold/get_security_policy_rule_rate_limit_option_rate_limit_threshold.dart';

class GetSecurityPolicyRuleRateLimitOption {
  /// Can only be specified if the action for the rule is <span pulumi-lang-nodejs=""rateBasedBan"" pulumi-lang-dotnet=""RateBasedBan"" pulumi-lang-go=""rateBasedBan"" pulumi-lang-python=""rate_based_ban"" pulumi-lang-yaml=""rateBasedBan"" pulumi-lang-java=""rateBasedBan"">"rate_based_ban"</span>. If specified, determines the time (in seconds) the traffic will continue to be banned by the rate limit after the rate falls below the threshold.
