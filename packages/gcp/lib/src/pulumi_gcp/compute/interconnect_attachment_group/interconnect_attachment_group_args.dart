  ...
  factory InterconnectAttachmentGroupArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentGroupArgs(
      attachments: pulumi.Input.asOptionalInput<
          List<InterconnectAttachmentGroupAttachment>>(map['attachments']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      intent: pulumi.Input.asInput<InterconnectAttachmentGroupIntent>(
          map['intent']),
      interconnectGroup:
          pulumi.Input.asOptionalInput<String>(map['interconnectGroup']),
