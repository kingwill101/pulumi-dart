...
import '../instant_snapshot_iam_member_condition/instant_snapshot_iam_member_condition.dart';
...
class InstantSnapshotIamMember extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<InstantSnapshotIamMemberCondition?> condition;
  ...
  InstantSnapshotIamMember(
    ...
    this.condition = Output.createUnknown<InstantSnapshotIamMemberCondition?>();
