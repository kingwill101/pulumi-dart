...
class RegionHealthCheck extends CustomResource {
  ...
  late final Output<RegionHealthCheckGrpcHealthCheck?> grpcHealthCheck;

  /// A nested object resource.
  /// Structure is documented below.
  late final Output<RegionHealthCheckGrpcTlsHealthCheck?> grpcTlsHealthCheck;

  /// The unique identifier number for the resource. This identifier is defined by the server.
  late final Output<int> healthCheckId;
  ...
  /// A nested object resource.
  /// Structure is documented below.
  late final Output<RegionHealthCheckHttp2HealthCheck?> http2HealthCheck;

  /// A nested object resource.
  /// Structure is documented below.
  late final Output<RegionHealthCheckHttpHealthCheck?> httpHealthCheck;

  /// A nested object resource.
  /// Structure is documented below.
  late final Output<RegionHealthCheckHttpsHealthCheck?> httpsHealthCheck;

  /// Configure logging on this health check.
  /// Structure is documented below.
  late final Output<RegionHealthCheckLogConfig> logConfig;
  ...
  /// A nested object resource.
  /// Structure is documented below.
  late final Output<RegionHealthCheckSslHealthCheck?> sslHealthCheck;

  /// A nested object resource.
  /// Structure is documented below.
  late final Output<RegionHealthCheckTcpHealthCheck?> tcpHealthCheck;
