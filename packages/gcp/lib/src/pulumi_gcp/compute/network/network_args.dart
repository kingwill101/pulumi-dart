...
class NetworkArgs {
  ...
  final Input<String>? networkFirewallPolicyEnforcementOrder;
  ...
  final Input<NetworkParams>? params;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (paramsValue != null) {
      map['params'] =
          Input.mapOptionalInputValue<NetworkParams, Map<String, dynamic>>(
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      ...
      bgpAlwaysCompareMed:
          Input.asOptionalInput<bool>(map['bgpAlwaysCompareMed']),
      bgpBestPathSelectionMode:
          Input.asOptionalInput<String>(map['bgpBestPathSelectionMode']),
      bgpInterRegionCost:
          Input.asOptionalInput<String>(map['bgpInterRegionCost']),
      deleteBgpAlwaysCompareMed:
          Input.asOptionalInput<bool>(map['deleteBgpAlwaysCompareMed']),
      deleteDefaultRoutesOnCreate:
          Input.asOptionalInput<bool>(map['deleteDefaultRoutesOnCreate']),
      ...
      networkFirewallPolicyEnforcementOrder: Input.asOptionalInput<String>(
          map['networkFirewallPolicyEnforcementOrder']),
      networkProfile: Input.asOptionalInput<String>(map['networkProfile']),
      params: Input.asOptionalInput<NetworkParams>(map['params']),
