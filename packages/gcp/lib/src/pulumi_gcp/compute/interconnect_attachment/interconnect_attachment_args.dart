...
class InterconnectAttachmentArgs {
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      bandwidth: pulumi.Input.asOptionalInput<String>(map['bandwidth']),
      candidateCloudRouterIpAddress: pulumi.Input.asOptionalInput<String>(
          map['candidateCloudRouterIpAddress']),
      ...
      candidateCustomerRouterIpAddress: pulumi.Input.asOptionalInput<String>(
          map['candidateCustomerRouterIpAddress']),
      candidateCustomerRouterIpv6Address: pulumi.Input.asOptionalInput<String>(
          map['candidateCustomerRouterIpv6Address']),
      candidateSubnets:
          pulumi.Input.asOptionalInput<List<String>>(map['candidateSubnets']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      edgeAvailabilityDomain:
          pulumi.Input.asOptionalInput<String>(map['edgeAvailabilityDomain']),
      encryption: pulumi.Input.asOptionalInput<String>(map['encryption']),
      ...
      mtu: pulumi.Input.asOptionalInput<String>(map['mtu']),
