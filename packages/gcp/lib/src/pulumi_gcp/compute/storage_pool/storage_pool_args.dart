  ...
  factory StoragePoolArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolArgs(
      capacityProvisioningType:
          pulumi.Input.asOptionalInput<String>(map['capacityProvisioningType']),
      deletionProtection:
      ...
      poolProvisionedCapacityGb:
          pulumi.Input.asInput<String>(map['poolProvisionedCapacityGb']),
      poolProvisionedIops:
          pulumi.Input.asOptionalInput<String>(map['poolProvisionedIops']),
      poolProvisionedThroughput:
          pulumi.Input.asInput<String>(map['poolProvisionedThroughput']),
