...
class GetInstanceComputeResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['attachedDisks'] =
        pulumi.Input.encodeList<GetInstanceAttachedDisk, Map<String, dynamic>>(
            attachedDisks, (value) => value.toMap());
    map['bootDisks'] =
        pulumi.Input.encodeList<GetInstanceBootDisk, Map<String, dynamic>>(
    ...
    map['id'] = id;
    map['instanceEncryptionKeys'] = pulumi.Input.encodeList<
    ...
    map['params'] =
        pulumi.Input.encodeList<GetInstanceParam, Map<String, dynamic>>(
    ...
    map['schedulings'] =
        pulumi.Input.encodeList<GetInstanceScheduling, Map<String, dynamic>>(
            schedulings, (value) => value.toMap());
    map['scratchDisks'] =
        pulumi.Input.encodeList<GetInstanceScratchDisk, Map<String, dynamic>>(
            scratchDisks, (value) => value.toMap());
    final selfLinkValue = selfLink;
    if (selfLinkValue != null) {
      map['selfLink'] = selfLinkValue;
    }
    map['serviceAccounts'] = pulumi.Input.encodeList<GetInstanceServiceAccount,
  ...
  factory GetInstanceComputeResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceComputeResult(
      advancedMachineFeatures:
          pulumi.Input.decodeList<GetInstanceAdvancedMachineFeature>(
      ...
      attachedDisks: pulumi.Input.decodeList<GetInstanceAttachedDisk>(
          map['attachedDisks'],
          (value) => GetInstanceAttachedDisk.fromMap(
              (value as Map).cast<String, dynamic>())),
      bootDisks: pulumi.Input.decodeList<GetInstanceBootDisk>(
          map['bootDisks'],
          (value) => GetInstanceBootDisk.fromMap(
              (value as Map).cast<String, dynamic>())),
      canIpForward: map['canIpForward'] as bool,
      confidentialInstanceConfigs:
          pulumi.Input.decodeList<GetInstanceConfidentialInstanceConfig>(
      ...
      guestAccelerators: pulumi.Input.decodeList<GetInstanceGuestAccelerator>(
      ...
      instanceEncryptionKeys:
          pulumi.Input.decodeList<GetInstanceInstanceEncryptionKey>(
      ...
      networkInterfaces: pulumi.Input.decodeList<GetInstanceNetworkInterface>(
          map['networkInterfaces'],
          (value) => GetInstanceNetworkInterface.fromMap(
              (value as Map).cast<String, dynamic>())),
      networkPerformanceConfigs:
          pulumi.Input.decodeList<GetInstanceNetworkPerformanceConfig>(
              map['networkPerformanceConfigs'],
              (value) => GetInstanceNetworkPerformanceConfig.fromMap(
                  (value as Map).cast<String, dynamic>())),
      params: pulumi.Input.decodeList<GetInstanceParam>(
          map['params'],
          (value) =>
      ...
      reservationAffinities:
          pulumi.Input.decodeList<GetInstanceReservationAffinity>(
      ...
      schedulings: pulumi.Input.decodeList<GetInstanceScheduling>(
          map['schedulings'],
          (value) => GetInstanceScheduling.fromMap(
              (value as Map).cast<String, dynamic>())),
      scratchDisks: pulumi.Input.decodeList<GetInstanceScratchDisk>(
          map['scratchDisks'],
          (value) => GetInstanceScratchDisk.fromMap(
              (value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] == null ? null : map['selfLink'] as String,
      serviceAccounts: pulumi.Input.decodeList<GetInstanceServiceAccount>(
          map['serviceAccounts'],
          (value) => GetInstanceServiceAccount.fromMap(
              (value as Map).cast<String, dynamic>())),
      shieldedInstanceConfigs:
          pulumi.Input.decodeList<GetInstanceShieldedInstanceConfig>(
