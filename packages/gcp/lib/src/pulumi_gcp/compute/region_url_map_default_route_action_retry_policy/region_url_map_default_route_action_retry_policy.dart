...
import '../region_url_map_default_route_action_retry_policy_per_try_timeout/region_url_map_default_route_action_retry_policy_per_try_timeout.dart';
...
class RegionUrlMapDefaultRouteActionRetryPolicy {
  ...
  final RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout? perTryTimeout;
  ...
  factory RegionUrlMapDefaultRouteActionRetryPolicy.fromMap(
    ...
    return RegionUrlMapDefaultRouteActionRetryPolicy(
      ...
      perTryTimeout: map['perTryTimeout'] == null
          ? null
          : RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout.fromMap(
