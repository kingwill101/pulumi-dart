...
class NetworkEndpointListArgs {
  ...
  final Input<List<NetworkEndpointListNetworkEndpoint>>? networkEndpoints;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkEndpointsValue != null) {
      map['networkEndpoints'] = Input.mapOptionalInputValue<
              List<NetworkEndpointListNetworkEndpoint>,
              List<Map<String, dynamic>>>(
          networkEndpointsValue,
          (value) => Input.encodeList<NetworkEndpointListNetworkEndpoint,
  ...
  factory NetworkEndpointListArgs.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointListArgs(
      ...
      networkEndpoints:
          Input.asOptionalInput<List<NetworkEndpointListNetworkEndpoint>>(
