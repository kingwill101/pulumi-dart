...
class BackendServiceIamMember extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<BackendServiceIamMemberCondition?> condition;
  ...
  BackendServiceIamMember(
    ...
    this.condition = Output.createUnknown<BackendServiceIamMemberCondition?>();
