...
import '../instance_iammember_condition/instance_iammember_condition.dart';
...
class InstanceIAMMember extends CustomResource {
  ...
  late final Output<InstanceIAMMemberCondition?> condition;
  ...
  /// <span pulumi-lang-nodejs="`gcp.compute.InstanceIAMBinding`" pulumi-lang-dotnet="`gcp.compute.InstanceIAMBinding`" pulumi-lang-go="`compute.InstanceIAMBinding`" pulumi-lang-python="`compute.InstanceIAMBinding`" pulumi-lang-yaml="`gcp.compute.InstanceIAMBinding`" pulumi-lang-java="`gcp.compute.InstanceIAMBinding`">`gcp.compute.InstanceIAMBinding`</span> can be used per role. Note that custom roles must be of the format
