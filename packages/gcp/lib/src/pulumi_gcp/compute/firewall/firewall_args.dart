...
class FirewallArgs {
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allows: pulumi.Input.asOptionalInput<List<FirewallAllow>>(map['allows']),
      denies: pulumi.Input.asOptionalInput<List<FirewallDeny>>(map['denies']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      destinationRanges:
          pulumi.Input.asOptionalInput<List<String>>(map['destinationRanges']),
      direction: pulumi.Input.asOptionalInput<String>(map['direction']),
      disabled: pulumi.Input.asOptionalInput<bool>(map['disabled']),
      enableLogging: pulumi.Input.asOptionalInput<bool>(map['enableLogging']),
      logConfig:
          pulumi.Input.asOptionalInput<FirewallLogConfig>(map['logConfig']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      network: pulumi.Input.asInput<String>(map['network']),
      params: pulumi.Input.asOptionalInput<FirewallParams>(map['params']),
