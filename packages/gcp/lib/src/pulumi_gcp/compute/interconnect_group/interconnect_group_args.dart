...
class InterconnectGroupArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['intent'] = pulumi.Input.mapInputValue<InterconnectGroupIntent,
        Map<String, dynamic>>(intent, (value) => value.toMap());
    final interconnectsValue = interconnects;
    if (interconnectsValue != null) {
      map['interconnects'] = pulumi.Input.mapOptionalInputValue<
              List<InterconnectGroupInterconnect>, List<Map<String, dynamic>>>(
          interconnectsValue,
          (value) => pulumi.Input.encodeList<InterconnectGroupInterconnect,
  ...
  factory InterconnectGroupArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectGroupArgs(
      ...
      intent: pulumi.Input.asInput<InterconnectGroupIntent>(map['intent']),
      interconnects:
