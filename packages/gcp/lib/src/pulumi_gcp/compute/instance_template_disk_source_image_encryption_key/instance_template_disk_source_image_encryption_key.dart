...
class InstanceTemplateDiskSourceImageEncryptionKey {
  ...
  factory InstanceTemplateDiskSourceImageEncryptionKey.fromMap(
      Map<String, dynamic> map) {
    return InstanceTemplateDiskSourceImageEncryptionKey(
