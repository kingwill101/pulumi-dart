...
/// the<span pulumi-lang-nodejs=" nextHop " pulumi-lang-dotnet=" NextHop " pulumi-lang-go=" nextHop " pulumi-lang-python=" next_hop " pulumi-lang-yaml=" nextHop " pulumi-lang-java=" nextHop "> next_hop </span>field of the winning route -- either to another virtual
...
class Route extends CustomResource {
  ...
  late final Output<List<RouteAsPath>> asPaths;
  ...
  /// Structure is documented below.
  late final Output<RouteParams?> params;
  ...
  /// Structure is documented below.
  late final Output<List<RouteWarning>> warnings;
