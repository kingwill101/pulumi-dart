...
class InterconnectArgs {
  ...
  factory InterconnectArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs(
      aaiEnabled: pulumi.Input.asOptionalInput<bool>(map['aaiEnabled']),
      ...
      interconnectType: pulumi.Input.asInput<String>(map['interconnectType']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      linkType: pulumi.Input.asInput<String>(map['linkType']),
      ...
      params: pulumi.Input.asOptionalInput<InterconnectParams>(map['params']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      remoteLocation:
          pulumi.Input.asOptionalInput<String>(map['remoteLocation']),
      requestedFeatures:
          pulumi.Input.asOptionalInput<List<String>>(map['requestedFeatures']),
      requestedLinkCount: pulumi.Input.asInput<int>(map['requestedLinkCount']),
    );
  }
}
