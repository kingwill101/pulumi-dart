...
class RegionBackendServiceIamMember extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<RegionBackendServiceIamMemberCondition?> condition;
  ...
  RegionBackendServiceIamMember(
    ...
    this.condition =
        Output.createUnknown<RegionBackendServiceIamMemberCondition?>();
