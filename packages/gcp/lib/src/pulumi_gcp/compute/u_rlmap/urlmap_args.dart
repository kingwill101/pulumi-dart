...
class URLMapArgs {
  ...
  final Input<URLMapDefaultCustomErrorResponsePolicy>?
  ...
  /// Structure is documented below.
  final Input<URLMapDefaultRouteAction>? defaultRouteAction;
  ...
  /// Structure is documented below.
  final Input<URLMapDefaultUrlRedirect>? defaultUrlRedirect;
  ...
  /// Structure is documented below.
  final Input<URLMapHeaderAction>? headerAction;

  /// The list of HostRules to use against the URL.
  /// Structure is documented below.
  final Input<List<URLMapHostRule>>? hostRules;
  ...
  /// Structure is documented below.
  final Input<List<URLMapPathMatcher>>? pathMatchers;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headerActionValue != null) {
      map['headerAction'] =
          Input.mapOptionalInputValue<URLMapHeaderAction, Map<String, dynamic>>(
              headerActionValue, (value) => value.toMap());
    }
    final hostRulesValue = hostRules;
    if (hostRulesValue != null) {
      map['hostRules'] = Input.mapOptionalInputValue<List<URLMapHostRule>,
              List<Map<String, dynamic>>>(
          hostRulesValue,
          (value) => Input.encodeList<URLMapHostRule, Map<String, dynamic>>(
    ...
    if (pathMatchersValue != null) {
      map['pathMatchers'] = Input.mapOptionalInputValue<List<URLMapPathMatcher>,
              List<Map<String, dynamic>>>(
          pathMatchersValue,
          (value) => Input.encodeList<URLMapPathMatcher, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory URLMapArgs.fromMap(Map<String, dynamic> map) {
    return URLMapArgs(
      defaultCustomErrorResponsePolicy:
          Input.asOptionalInput<URLMapDefaultCustomErrorResponsePolicy>(
              map['defaultCustomErrorResponsePolicy']),
      defaultRouteAction: Input.asOptionalInput<URLMapDefaultRouteAction>(
          map['defaultRouteAction']),
      defaultService: Input.asOptionalInput<String>(map['defaultService']),
      defaultUrlRedirect: Input.asOptionalInput<URLMapDefaultUrlRedirect>(
          map['defaultUrlRedirect']),
      description: Input.asOptionalInput<String>(map['description']),
      headerAction:
          Input.asOptionalInput<URLMapHeaderAction>(map['headerAction']),
      hostRules: Input.asOptionalInput<List<URLMapHostRule>>(map['hostRules']),
      name: Input.asOptionalInput<String>(map['name']),
      pathMatchers:
          Input.asOptionalInput<List<URLMapPathMatcher>>(map['pathMatchers']),
