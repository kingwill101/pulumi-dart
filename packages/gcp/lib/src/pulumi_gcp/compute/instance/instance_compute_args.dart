...
class InstanceComputeArgs {
  ...
  factory InstanceComputeArgs.fromMap(Map<String, dynamic> map) {
    return InstanceComputeArgs(
      ...
      attachedDisks: pulumi.Input.asOptionalInput<List<InstanceAttachedDisk>>(
          map['attachedDisks']),
      bootDisk: pulumi.Input.asInput<InstanceBootDisk>(map['bootDisk']),
      ...
      networkInterfaces: pulumi.Input.asInput<List<InstanceNetworkInterface>>(
      ...
      scheduling:
          pulumi.Input.asOptionalInput<InstanceScheduling>(map['scheduling']),
