...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final detectionAbsoluteQpsValue = detectionAbsoluteQps;
    if (detectionAbsoluteQpsValue != null) {
      map['detectionAbsoluteQps'] = detectionAbsoluteQpsValue;
    }
    final detectionLoadThresholdValue = detectionLoadThreshold;
    if (detectionLoadThresholdValue != null) {
      map['detectionLoadThreshold'] = detectionLoadThresholdValue;
    }
    final detectionRelativeToBaselineQpsValue = detectionRelativeToBaselineQps;
    if (detectionRelativeToBaselineQpsValue != null) {
      map['detectionRelativeToBaselineQps'] =
          detectionRelativeToBaselineQpsValue;
    }
    map['name'] = name;
