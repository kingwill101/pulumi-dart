...
import '../get_region_disk_source_snapshot_encryption_key/get_region_disk_source_snapshot_encryption_key.dart';
...
class GetRegionDiskResult {
  ...
  final List<GetRegionDiskSourceSnapshotEncryptionKey>
