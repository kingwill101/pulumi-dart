...
class DatabaseInstance extends CustomResource {
  ...
  /// The current database state. Set<span pulumi-lang-nodejs=" desiredState " pulumi-lang-dotnet=" DesiredState " pulumi-lang-go=" desiredState " pulumi-lang-python=" desired_state " pulumi-lang-yaml=" desiredState " pulumi-lang-java=" desiredState "> desired_state </span>to :DISABLED to disable the database and :ACTIVE to reenable the database
