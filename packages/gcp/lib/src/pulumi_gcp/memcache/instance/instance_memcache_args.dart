...
class InstanceMemcacheArgs {
  ...
  factory InstanceMemcacheArgs.fromMap(Map<String, dynamic> map) {
    return InstanceMemcacheArgs(
      authorizedNetwork:
      ...
      memcacheVersion:
          pulumi.Input.asOptionalInput<String>(map['memcacheVersion']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      nodeConfig: pulumi.Input.asInput<InstanceNodeConfig>(map['nodeConfig']),
      nodeCount: pulumi.Input.asInput<int>(map['nodeCount']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      reservedIpRangeIds:
          pulumi.Input.asOptionalInput<List<String>>(map['reservedIpRangeIds']),
