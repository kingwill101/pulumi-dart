...
import 'get_instance_memcache_args.dart';
import 'get_instance_memcache_result.dart';
...
Future<GetInstanceMemcacheResult> getInstanceMemcache(
  GetInstanceMemcacheArgs args, {
  ...
  return GetInstanceMemcacheResult.fromMap(result);
}
