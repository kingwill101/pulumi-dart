...
import '../get_instance_maintenance_policy/get_instance_maintenance_policy.dart';
import '../get_instance_maintenance_schedule/get_instance_maintenance_schedule.dart';
import '../get_instance_memcache_node/get_instance_memcache_node.dart';
import '../get_instance_memcache_parameter/get_instance_memcache_parameter.dart';
import '../get_instance_node_config/get_instance_node_config.dart';
...
class GetInstanceResult5 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['maintenancePolicies'] =
        Input.encodeList<GetInstanceMaintenancePolicy, Map<String, dynamic>>(
            maintenancePolicies, (value) => value.toMap());
    map['maintenanceSchedules'] =
        Input.encodeList<GetInstanceMaintenanceSchedule, Map<String, dynamic>>(
            maintenanceSchedules, (value) => value.toMap());
    map['memcacheFullVersion'] = memcacheFullVersion;
    map['memcacheNodes'] =
        Input.encodeList<GetInstanceMemcacheNode, Map<String, dynamic>>(
            memcacheNodes, (value) => value.toMap());
    map['memcacheParameters'] =
        Input.encodeList<GetInstanceMemcacheParameter, Map<String, dynamic>>(
            memcacheParameters, (value) => value.toMap());
    map['memcacheVersion'] = memcacheVersion;
    map['name'] = name;
    map['nodeConfigs'] =
        Input.encodeList<GetInstanceNodeConfig, Map<String, dynamic>>(
  ...
  factory GetInstanceResult5.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult5(
      ...
      maintenancePolicies: Input.decodeList<GetInstanceMaintenancePolicy>(
          map['maintenancePolicies'],
          (value) => GetInstanceMaintenancePolicy.fromMap(
              (value as Map).cast<String, dynamic>())),
      maintenanceSchedules: Input.decodeList<GetInstanceMaintenanceSchedule>(
          map['maintenanceSchedules'],
          (value) => GetInstanceMaintenanceSchedule.fromMap(
              (value as Map).cast<String, dynamic>())),
      memcacheFullVersion: map['memcacheFullVersion'] as String,
      memcacheNodes: Input.decodeList<GetInstanceMemcacheNode>(
          map['memcacheNodes'],
          (value) => GetInstanceMemcacheNode.fromMap(
              (value as Map).cast<String, dynamic>())),
      memcacheParameters: Input.decodeList<GetInstanceMemcacheParameter>(
          map['memcacheParameters'],
          (value) => GetInstanceMemcacheParameter.fromMap(
              (value as Map).cast<String, dynamic>())),
      memcacheVersion: map['memcacheVersion'] as String,
      name: map['name'] as String,
      nodeConfigs: Input.decodeList<GetInstanceNodeConfig>(
          map['nodeConfigs'],
