...
class DocumentAiWarehouseLocationArgs {
  ...
  factory DocumentAiWarehouseLocationArgs.fromMap(Map<String, dynamic> map) {
    return DocumentAiWarehouseLocationArgs(
      accessControlMode: pulumi.Input.asInput<String>(map['accessControlMode']),
      databaseType: pulumi.Input.asInput<String>(map['databaseType']),
      documentCreatorDefaultRole: pulumi.Input.asOptionalInput<String>(
          map['documentCreatorDefaultRole']),
