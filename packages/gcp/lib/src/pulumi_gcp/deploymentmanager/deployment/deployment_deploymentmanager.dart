...
import 'deployment_deploymentmanager_args.dart';
...
/// ```
class DeploymentDeploymentmanager extends pulumi.CustomResource {
  ...
  DeploymentDeploymentmanager(
    String name, {
    DeploymentDeploymentmanagerArgs? args,
