...
import 'interconnect_attachment_edgenetwork_args.dart';
...
/// ```
class InterconnectAttachmentEdgenetwork extends pulumi.CustomResource {
  ...
  InterconnectAttachmentEdgenetwork(
    String name, {
    InterconnectAttachmentEdgenetworkArgs? args,
