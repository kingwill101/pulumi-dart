...
import 'iammember_projects_iammember_args.dart';
...
/// ```
class IAMMemberProjectsIAmmember extends pulumi.CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<IAMMemberConditionProjects?> condition;
  ...
  IAMMemberProjectsIAmmember(
    String name, {
    IAMMemberProjectsIAmmemberArgs? args,
    ...
    this.condition = registerOutput<IAMMemberConditionProjects?>('condition');
