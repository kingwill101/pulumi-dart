...
/// ```
class IAMMember3 extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<IAMMemberCondition3?> condition;
  ...
  IAMMember3(
    ...
    this.condition = registerOutput<IAMMemberCondition3?>('condition');
