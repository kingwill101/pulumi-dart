...
class DefaultServiceAccounts extends CustomResource {
  ...
  /// The Service Accounts changed by this resource. It is used for `REVERT` the <span pulumi-lang-nodejs="`action`" pulumi-lang-dotnet="`Action`" pulumi-lang-go="`action`" pulumi-lang-python="`action`" pulumi-lang-yaml="`action`" pulumi-lang-java="`action`">`action`</span> on the destroy.
