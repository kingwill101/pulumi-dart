...
class AccessApprovalSettingsEnrolledService3 {
  ...
  AccessApprovalSettingsEnrolledService3({
  ...
  factory AccessApprovalSettingsEnrolledService3.fromMap(
      Map<String, dynamic> map) {
    return AccessApprovalSettingsEnrolledService3(
