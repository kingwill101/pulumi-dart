...
import 'iambinding_projects_iambinding_args.dart';
...
/// ```
class IAMBindingProjectsIAmbinding extends pulumi.CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<IAMBindingConditionProjects?> condition;
  ...
  IAMBindingProjectsIAmbinding(
    String name, {
    IAMBindingProjectsIAmbindingArgs? args,
    ...
    this.condition = registerOutput<IAMBindingConditionProjects?>('condition');
