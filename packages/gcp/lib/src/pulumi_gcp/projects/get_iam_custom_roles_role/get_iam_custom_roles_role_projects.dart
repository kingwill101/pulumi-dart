...
class GetIamCustomRolesRoleProjects {
  ...
  factory GetIamCustomRolesRoleProjects.fromMap(Map<String, dynamic> map) {
    return GetIamCustomRolesRoleProjects(
