...
class AppArgs {
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      globalInstruction:
          pulumi.Input.asOptionalInput<String>(map['globalInstruction']),
      ...
      modelSettings:
          pulumi.Input.asOptionalInput<AppModelSettings>(map['modelSettings']),
      pinned: pulumi.Input.asOptionalInput<bool>(map['pinned']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      rootAgent: pulumi.Input.asOptionalInput<String>(map['rootAgent']),
