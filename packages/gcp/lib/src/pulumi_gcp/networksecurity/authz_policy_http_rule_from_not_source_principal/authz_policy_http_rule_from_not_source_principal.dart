...
import '../authz_policy_http_rule_from_not_source_principal_principal/authz_policy_http_rule_from_not_source_principal_principal.dart';
...
class AuthzPolicyHttpRuleFromNotSourcePrincipal {
  ...
  Map<String, dynamic> toMap() {
    ...
    final principalSelectorValue = principalSelector;
    if (principalSelectorValue != null) {
      map['principalSelector'] = principalSelectorValue;
    }
