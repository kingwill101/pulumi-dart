...
class DnsThreatDetectorArgs {
  ...
  final Input<List<String>>? excludedNetworks;
  ...
  final Input<String>? threatDetectorProvider;
  ...
  factory DnsThreatDetectorArgs.fromMap(Map<String, dynamic> map) {
    return DnsThreatDetectorArgs(
      excludedNetworks:
          Input.asOptionalInput<List<String>>(map['excludedNetworks']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      threatDetectorProvider:
          Input.asOptionalInput<String>(map['threatDetectorProvider']),
    );
  }
}
