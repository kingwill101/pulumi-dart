  ...
  factory SecurityProfileGroupArgs.fromMap(Map<String, dynamic> map) {
    return SecurityProfileGroupArgs(
      customInterceptProfile:
          pulumi.Input.asOptionalInput<String>(map['customInterceptProfile']),
      customMirroringProfile:
          pulumi.Input.asOptionalInput<String>(map['customMirroringProfile']),
      ...
      urlFilteringProfile:
          pulumi.Input.asOptionalInput<String>(map['urlFilteringProfile']),
    );
  }
}
