...
class SecurityProfileGroup extends CustomResource {
  ...
  SecurityProfileGroup(
    ...
    this.customInterceptProfile = Output.createUnknown<String?>();
    this.customMirroringProfile = Output.createUnknown<String?>();
    ...
    this.urlFilteringProfile = Output.createUnknown<String?>();
  }
}
