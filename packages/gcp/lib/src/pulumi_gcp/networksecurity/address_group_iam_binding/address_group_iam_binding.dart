...
class AddressGroupIamBinding extends CustomResource {
  late final Output<AddressGroupIamBindingCondition?> condition;
  ...
  AddressGroupIamBinding(
    ...
    this.condition = Output.createUnknown<AddressGroupIamBindingCondition?>();
