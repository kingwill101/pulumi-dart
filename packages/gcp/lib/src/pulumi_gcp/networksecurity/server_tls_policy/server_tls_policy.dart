...
class ServerTlsPolicy extends CustomResource {
  ...
  late final Output<ServerTlsPolicyMtlsPolicy?> mtlsPolicy;
  ...
  /// Structure is documented below.
  late final Output<ServerTlsPolicyServerCertificate?> serverCertificate;
  ...
  ServerTlsPolicy(
    ...
    this.mtlsPolicy = Output.createUnknown<ServerTlsPolicyMtlsPolicy?>();
    this.name = Output.createUnknown<String>();
    this.project = Output.createUnknown<String>();
    this.pulumiLabels = Output.createUnknown<Map<String, String>>();
    this.serverCertificate =
        Output.createUnknown<ServerTlsPolicyServerCertificate?>();
