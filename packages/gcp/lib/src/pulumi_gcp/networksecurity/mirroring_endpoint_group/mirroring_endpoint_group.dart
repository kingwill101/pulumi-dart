...
/// ```
class MirroringEndpointGroup extends CustomResource {
  /// List of associations to this endpoint group.
  /// Structure is documented below.
  late final Output<List<MirroringEndpointGroupAssociation>> associations;

  /// List of details about the connected deployment groups to this endpoint
  /// group.
  /// Structure is documented below.
  late final Output<List<MirroringEndpointGroupConnectedDeploymentGroup>>
  ...
  /// `projects/123456789/locations/global/mirroringDeploymentGroups/my-dg`.
  /// See https://google.aip.dev/124.
  late final Output<List<String>?> mirroringDeploymentGroups;

  /// The ID to use for the endpoint group, which will become the final component
  /// of the endpoint group's resource name.
  late final Output<String> mirroringEndpointGroupId;
