...
import '../authz_policy_custom_provider_authz_extension/authz_policy_custom_provider_authz_extension.dart';
import '../authz_policy_custom_provider_cloud_iap/authz_policy_custom_provider_cloud_iap.dart';
...
class AuthzPolicyCustomProvider {
  ...
  Map<String, dynamic> toMap() {
    ...
    final authzExtensionValue = authzExtension;
    if (authzExtensionValue != null) {
      map['authzExtension'] = authzExtensionValue.toMap();
    }
    final cloudIapValue = cloudIap;
    if (cloudIapValue != null) {
      map['cloudIap'] = cloudIapValue.toMap();
    }
    return map;
  }
