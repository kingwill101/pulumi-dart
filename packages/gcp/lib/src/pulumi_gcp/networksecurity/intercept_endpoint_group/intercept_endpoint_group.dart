...
class InterceptEndpointGroup extends CustomResource {
  ...
  InterceptEndpointGroup(
    ...
    this.associations =
        Output.createUnknown<List<InterceptEndpointGroupAssociation>>();
    ...
    this.interceptDeploymentGroup = Output.createUnknown<String>();
    this.interceptEndpointGroupId = Output.createUnknown<String>();
