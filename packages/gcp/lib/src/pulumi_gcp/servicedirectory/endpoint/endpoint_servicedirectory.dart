...
import 'endpoint_servicedirectory_args.dart';
...
/// ```
class EndpointServicedirectory extends pulumi.CustomResource {
  ...
  EndpointServicedirectory(
    String name, {
    EndpointServicedirectoryArgs? args,
