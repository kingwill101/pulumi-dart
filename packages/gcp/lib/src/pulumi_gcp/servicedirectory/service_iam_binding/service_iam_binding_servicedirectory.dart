...
import 'service_iam_binding_servicedirectory_args.dart';
...
///
/// full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
class ServiceIamBindingServicedirectory extends pulumi.CustomResource {
  late final pulumi.Output<ServiceIamBindingConditionServicedirectory?>
      condition;
  ...
  ServiceIamBindingServicedirectory(
    String name, {
    ServiceIamBindingServicedirectoryArgs? args,
    ...
    this.condition =
        registerOutput<ServiceIamBindingConditionServicedirectory?>(
            'condition');
