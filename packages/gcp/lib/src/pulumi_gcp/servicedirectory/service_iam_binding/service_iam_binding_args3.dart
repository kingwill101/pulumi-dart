...
class ServiceIamBindingArgs3 {
  final Input<ServiceIamBindingCondition3>? condition;
  ...
  factory ServiceIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return ServiceIamBindingArgs3(
      condition:
          Input.asOptionalInput<ServiceIamBindingCondition3>(map['condition']),
