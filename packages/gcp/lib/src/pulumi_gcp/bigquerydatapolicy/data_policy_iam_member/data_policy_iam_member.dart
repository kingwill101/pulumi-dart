...
import '../data_policy_iam_member_condition/data_policy_iam_member_condition.dart';
...
class DataPolicyIamMember extends CustomResource {
  late final Output<DataPolicyIamMemberCondition?> condition;
  ...
  DataPolicyIamMember(
    ...
    this.condition = registerOutput<DataPolicyIamMemberCondition?>('condition');
