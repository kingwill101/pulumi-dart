...
class ConfigSignInHashConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final memoryCostValue = memoryCost;
    if (memoryCostValue != null) {
      map['memoryCost'] = memoryCostValue;
    }
    final roundsValue = rounds;
    if (roundsValue != null) {
      map['rounds'] = roundsValue;
    }
    final saltSeparatorValue = saltSeparator;
    if (saltSeparatorValue != null) {
      map['saltSeparator'] = saltSeparatorValue;
    }
    final signerKeyValue = signerKey;
    if (signerKeyValue != null) {
      map['signerKey'] = signerKeyValue;
    }
    return map;
  }
  ...
  factory ConfigSignInHashConfig.fromMap(Map<String, dynamic> map) {
    return ConfigSignInHashConfig(
      ...
      saltSeparator:
          map['saltSeparator'] == null ? null : map['saltSeparator'] as String,
