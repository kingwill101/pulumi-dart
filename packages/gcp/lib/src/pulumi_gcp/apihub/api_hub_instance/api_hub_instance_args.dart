...
class ApiHubInstanceArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['config'] =
        pulumi.Input.mapInputValue<ApiHubInstanceConfig, Map<String, dynamic>>(
  ...
  factory ApiHubInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ApiHubInstanceArgs(
      apiHubInstanceId:
          pulumi.Input.asOptionalInput<String>(map['apiHubInstanceId']),
      config: pulumi.Input.asInput<ApiHubInstanceConfig>(map['config']),
