...
class RepositoryGroupIamMember extends CustomResource {
  ...
  late final Output<RepositoryGroupIamMemberCondition?> condition;
  ...
  RepositoryGroupIamMember(
    ...
    this.condition = Output.createUnknown<RepositoryGroupIamMemberCondition?>();
