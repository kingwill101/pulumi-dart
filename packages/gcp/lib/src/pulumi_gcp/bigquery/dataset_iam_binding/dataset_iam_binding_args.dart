...
class DatasetIamBindingArgs {
  ...
  final Input<DatasetIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<DatasetIamBindingCondition,
  ...
  factory DatasetIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DatasetIamBindingArgs(
      condition:
          Input.asOptionalInput<DatasetIamBindingCondition>(map['condition']),
