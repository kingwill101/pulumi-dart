...
class AppProfile extends CustomResource {
  ...
  late final Output<AppProfileDataBoostIsolationReadOnly?>
  ...
  /// Structure is documented below.
  late final Output<AppProfileSingleClusterRouting?> singleClusterRouting;

  /// The standard options used for isolating this app profile's traffic from other use cases.
  /// Structure is documented below.
  late final Output<AppProfileStandardIsolation> standardIsolation;
