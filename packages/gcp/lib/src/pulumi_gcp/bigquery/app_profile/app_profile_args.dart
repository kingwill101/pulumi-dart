...
class AppProfileArgs {
  ...
  final Input<AppProfileDataBoostIsolationReadOnly>? dataBoostIsolationReadOnly;
  ...
  /// Structure is documented below.
  final Input<AppProfileSingleClusterRouting>? singleClusterRouting;

  /// The standard options used for isolating this app profile's traffic from other use cases.
  /// Structure is documented below.
  final Input<AppProfileStandardIsolation>? standardIsolation;
  ...
  factory AppProfileArgs.fromMap(Map<String, dynamic> map) {
    return AppProfileArgs(
      ...
      dataBoostIsolationReadOnly:
          Input.asOptionalInput<AppProfileDataBoostIsolationReadOnly>(
      ...
      singleClusterRouting:
          Input.asOptionalInput<AppProfileSingleClusterRouting>(
              map['singleClusterRouting']),
      standardIsolation: Input.asOptionalInput<AppProfileStandardIsolation>(
