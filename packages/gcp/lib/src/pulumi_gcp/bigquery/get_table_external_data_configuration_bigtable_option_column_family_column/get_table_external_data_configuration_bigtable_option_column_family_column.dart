...
class GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['qualifierEncoded'] = qualifierEncoded;
    map['qualifierString'] = qualifierString;
    map['type'] = type;
    return map;
  }

  factory GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn.fromMap(
    ...
    return GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn(
      ...
      qualifierEncoded: map['qualifierEncoded'] as String,
      qualifierString: map['qualifierString'] as String,
