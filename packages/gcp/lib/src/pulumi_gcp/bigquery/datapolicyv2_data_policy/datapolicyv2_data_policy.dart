...
class Datapolicyv2DataPolicy extends CustomResource {
  ...
  /// `projects/{project_number}/locations/{location_id}/taxonomies/{taxonomy_id}/policyTags/{policyTag_id}`.<span pulumi-lang-nodejs="
  /// policyTag " pulumi-lang-dotnet="
  /// PolicyTag " pulumi-lang-go="
  /// policyTag " pulumi-lang-python="
  /// policy_tag " pulumi-lang-yaml="
  /// policyTag " pulumi-lang-java="
  /// policyTag ">
  /// policy_tag </span>is supported only for V1 data policies.
