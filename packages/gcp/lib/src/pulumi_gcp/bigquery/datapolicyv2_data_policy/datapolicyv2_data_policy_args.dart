...
class Datapolicyv2DataPolicyArgs {
  ...
  final pulumi.Input<Datapolicyv2DataPolicyDataMaskingPolicy>?
      dataMaskingPolicy;
  ...
  factory Datapolicyv2DataPolicyArgs.fromMap(Map<String, dynamic> map) {
    return Datapolicyv2DataPolicyArgs(
      dataMaskingPolicy:
          pulumi.Input.asOptionalInput<Datapolicyv2DataPolicyDataMaskingPolicy>(
              map['dataMaskingPolicy']),
      dataPolicyId: pulumi.Input.asInput<String>(map['dataPolicyId']),
      dataPolicyType: pulumi.Input.asInput<String>(map['dataPolicyType']),
