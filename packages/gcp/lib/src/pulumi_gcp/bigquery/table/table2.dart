...
class Table2 extends CustomResource {
  ...
  Table2(
    ...
    this.biglakeConfiguration =
        Output.createUnknown<TableBiglakeConfiguration?>();
    this.clusterings = Output.createUnknown<List<String>?>();
    ...
    this.expirationTime = Output.createUnknown<int>();
    this.externalCatalogTableOptions =
        Output.createUnknown<TableExternalCatalogTableOptions?>();
    this.externalDataConfiguration =
        Output.createUnknown<TableExternalDataConfiguration?>();
    this.friendlyName = Output.createUnknown<String?>();
    this.generatedSchemaColumns = Output.createUnknown<String>();
    this.ignoreAutoGeneratedSchema = Output.createUnknown<bool?>();
    this.ignoreSchemaChanges = Output.createUnknown<List<String>?>();
    this.labels = Output.createUnknown<Map<String, String>?>();
    this.lastModifiedTime = Output.createUnknown<int>();
    this.location = Output.createUnknown<String>();
    this.materializedView = Output.createUnknown<TableMaterializedView?>();
    this.maxStaleness = Output.createUnknown<String>();
    this.numBytes = Output.createUnknown<int>();
    this.numLongTermBytes = Output.createUnknown<int>();
    this.numRows = Output.createUnknown<int>();
    this.project = Output.createUnknown<String>();
    this.pulumiLabels = Output.createUnknown<Map<String, String>>();
    this.rangePartitioning = Output.createUnknown<TableRangePartitioning?>();
    ...
    this.schemaForeignTypeInfo =
        Output.createUnknown<TableSchemaForeignTypeInfo?>();
    this.selfLink = Output.createUnknown<String>();
    this.tableConstraints = Output.createUnknown<TableTableConstraints?>();
    this.tableId = Output.createUnknown<String>();
    this.tableMetadataView = Output.createUnknown<String?>();
    this.tableReplicationInfo =
        Output.createUnknown<TableTableReplicationInfo?>();
    this.timePartitioning = Output.createUnknown<TableTimePartitioning?>();
    this.type = Output.createUnknown<String>();
    this.view = Output.createUnknown<TableView?>();
  }
}
