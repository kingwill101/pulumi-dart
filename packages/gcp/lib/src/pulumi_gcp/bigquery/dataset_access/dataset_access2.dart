...
class DatasetAccess2 extends CustomResource {
  /// If true, represents that that the<span pulumi-lang-nodejs=" iamMember " pulumi-lang-dotnet=" IamMember " pulumi-lang-go=" iamMember " pulumi-lang-python=" iam_member " pulumi-lang-yaml=" iamMember " pulumi-lang-java=" iamMember "> iam_member </span>in the config was translated to a different member type by the API, and is stored in state as a different member type
