...
class GetTableTableConstraint {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['foreignKeys'] = Input.encodeList<GetTableTableConstraintForeignKey,
        Map<String, dynamic>>(foreignKeys, (value) => value.toMap());
    map['primaryKeys'] = Input.encodeList<GetTableTableConstraintPrimaryKey,
  ...
  factory GetTableTableConstraint.fromMap(Map<String, dynamic> map) {
    return GetTableTableConstraint(
      foreignKeys: Input.decodeList<GetTableTableConstraintForeignKey>(
          map['foreignKeys'],
          (value) => GetTableTableConstraintForeignKey.fromMap(
              (value as Map).cast<String, dynamic>())),
      primaryKeys: Input.decodeList<GetTableTableConstraintPrimaryKey>(
          map['primaryKeys'],
