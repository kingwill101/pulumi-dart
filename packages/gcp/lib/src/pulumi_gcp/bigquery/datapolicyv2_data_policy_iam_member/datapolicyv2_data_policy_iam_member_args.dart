...
import '../datapolicyv2_data_policy_iam_member_condition/datapolicyv2_data_policy_iam_member_condition.dart';

/// The set of arguments for Datapolicyv2DataPolicyIamMember.
class Datapolicyv2DataPolicyIamMemberArgs {
  final Input<Datapolicyv2DataPolicyIamMemberCondition>? condition;
  ...
  factory Datapolicyv2DataPolicyIamMemberArgs.fromMap(
      Map<String, dynamic> map) {
    return Datapolicyv2DataPolicyIamMemberArgs(
      condition:
          Input.asOptionalInput<Datapolicyv2DataPolicyIamMemberCondition>(
              map['condition']),
