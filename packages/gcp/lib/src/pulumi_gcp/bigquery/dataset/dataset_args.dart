...
class DatasetArgs {
  ...
  factory DatasetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetArgs(
      accesses:
          pulumi.Input.asOptionalInput<List<DatasetAccess>>(map['accesses']),
      datasetId: pulumi.Input.asInput<String>(map['datasetId']),
      defaultCollation:
          pulumi.Input.asOptionalInput<String>(map['defaultCollation']),
      defaultEncryptionConfiguration:
      ...
      defaultTableExpirationMs:
          pulumi.Input.asOptionalInput<int>(map['defaultTableExpirationMs']),
      deleteContentsOnDestroy:
          pulumi.Input.asOptionalInput<bool>(map['deleteContentsOnDestroy']),
