...
class BareMetalNodePool extends CustomResource {
  ...
  BareMetalNodePool(
    ...
    this.bareMetalCluster = Output.createUnknown<String>();
    ...
    this.nodePoolConfig =
        Output.createUnknown<BareMetalNodePoolNodePoolConfig>();
    this.project = Output.createUnknown<String>();
    this.reconciling = Output.createUnknown<bool>();
    this.state = Output.createUnknown<String>();
    this.statuses = Output.createUnknown<List<BareMetalNodePoolStatus>>();
