...
import '../vmware_admin_cluster_network_config_dhcp_ip_config/vmware_admin_cluster_network_config_dhcp_ip_config.dart';
import '../vmware_admin_cluster_network_config_ha_control_plane_config/vmware_admin_cluster_network_config_ha_control_plane_config.dart';
import '../vmware_admin_cluster_network_config_host_config/vmware_admin_cluster_network_config_host_config.dart';
import '../vmware_admin_cluster_network_config_static_ip_config/vmware_admin_cluster_network_config_static_ip_config.dart';
...
class VmwareAdminClusterNetworkConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final haControlPlaneConfigValue = haControlPlaneConfig;
    if (haControlPlaneConfigValue != null) {
      map['haControlPlaneConfig'] = haControlPlaneConfigValue.toMap();
    }
