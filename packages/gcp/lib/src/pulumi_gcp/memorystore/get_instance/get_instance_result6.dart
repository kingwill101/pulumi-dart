...
import '../get_instance_maintenance_policy/get_instance_maintenance_policy2.dart';
import '../get_instance_maintenance_schedule/get_instance_maintenance_schedule2.dart';
...
import '../get_instance_node_config/get_instance_node_config2.dart';
...
class GetInstanceResult6 {
  ...
  final List<GetInstanceMaintenancePolicy2> maintenancePolicies;
  final List<GetInstanceMaintenanceSchedule2> maintenanceSchedules;
  ...
  final String mode;
  final String name;
  final List<GetInstanceNodeConfig2> nodeConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['automatedBackupConfigs'] = Input.encodeList<
    ...
    map['crossInstanceReplicationConfigs'] = Input.encodeList<
    ...
    map['maintenancePolicies'] =
        Input.encodeList<GetInstanceMaintenancePolicy2, Map<String, dynamic>>(
            maintenancePolicies, (value) => value.toMap());
    map['maintenanceSchedules'] =
        Input.encodeList<GetInstanceMaintenanceSchedule2, Map<String, dynamic>>(
            maintenanceSchedules, (value) => value.toMap());
    map['maintenanceVersion'] = maintenanceVersion;
    map['managedBackupSources'] =
        Input.encodeList<GetInstanceManagedBackupSource, Map<String, dynamic>>(
            managedBackupSources, (value) => value.toMap());
    map['managedServerCas'] =
        Input.encodeList<GetInstanceManagedServerCa, Map<String, dynamic>>(
            managedServerCas, (value) => value.toMap());
    map['mode'] = mode;
    map['name'] = name;
    map['nodeConfigs'] =
        Input.encodeList<GetInstanceNodeConfig2, Map<String, dynamic>>(
            nodeConfigs, (value) => value.toMap());
    map['nodeType'] = nodeType;
    map['persistenceConfigs'] =
        Input.encodeList<GetInstancePersistenceConfig, Map<String, dynamic>>(
    ...
    map['pscAttachmentDetails'] =
        Input.encodeList<GetInstancePscAttachmentDetail, Map<String, dynamic>>(
            pscAttachmentDetails, (value) => value.toMap());
    map['pscAutoConnections'] =
        Input.encodeList<GetInstancePscAutoConnection, Map<String, dynamic>>(
    ...
    map['state'] = state;
    map['stateInfos'] =
        Input.encodeList<GetInstanceStateInfo, Map<String, dynamic>>(
  ...
  factory GetInstanceResult6.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult6(
      authorizationMode: map['authorizationMode'] as String,
      automatedBackupConfigs:
          Input.decodeList<GetInstanceAutomatedBackupConfig>(
      ...
      crossInstanceReplicationConfigs:
          Input.decodeList<GetInstanceCrossInstanceReplicationConfig>(
      ...
      maintenancePolicies: Input.decodeList<GetInstanceMaintenancePolicy2>(
          map['maintenancePolicies'],
          (value) => GetInstanceMaintenancePolicy2.fromMap(
              (value as Map).cast<String, dynamic>())),
      maintenanceSchedules: Input.decodeList<GetInstanceMaintenanceSchedule2>(
          map['maintenanceSchedules'],
          (value) => GetInstanceMaintenanceSchedule2.fromMap(
              (value as Map).cast<String, dynamic>())),
      maintenanceVersion: map['maintenanceVersion'] as String,
      managedBackupSources: Input.decodeList<GetInstanceManagedBackupSource>(
          map['managedBackupSources'],
          (value) => GetInstanceManagedBackupSource.fromMap(
              (value as Map).cast<String, dynamic>())),
      managedServerCas: Input.decodeList<GetInstanceManagedServerCa>(
          map['managedServerCas'],
          (value) => GetInstanceManagedServerCa.fromMap(
              (value as Map).cast<String, dynamic>())),
      mode: map['mode'] as String,
      name: map['name'] as String,
      nodeConfigs: Input.decodeList<GetInstanceNodeConfig2>(
          map['nodeConfigs'],
          (value) => GetInstanceNodeConfig2.fromMap(
              (value as Map).cast<String, dynamic>())),
      nodeType: map['nodeType'] as String,
      persistenceConfigs: Input.decodeList<GetInstancePersistenceConfig>(
          map['persistenceConfigs'],
          (value) => GetInstancePersistenceConfig.fromMap(
              (value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      pscAttachmentDetails: Input.decodeList<GetInstancePscAttachmentDetail>(
          map['pscAttachmentDetails'],
          (value) => GetInstancePscAttachmentDetail.fromMap(
              (value as Map).cast<String, dynamic>())),
      pscAutoConnections: Input.decodeList<GetInstancePscAutoConnection>(
          map['pscAutoConnections'],
      ...
      stateInfos: Input.decodeList<GetInstanceStateInfo>(
          map['stateInfos'],
      ...
      zoneDistributionConfigs:
          Input.decodeList<GetInstanceZoneDistributionConfig>(
