...
class Instance10 extends CustomResource {
  ...
  /// Instance's Certificate Authority. This field will only be populated if instance's<span pulumi-lang-nodejs=" transitEncryptionMode " pulumi-lang-dotnet=" TransitEncryptionMode " pulumi-lang-go=" transitEncryptionMode " pulumi-lang-python=" transit_encryption_mode " pulumi-lang-yaml=" transitEncryptionMode " pulumi-lang-java=" transitEncryptionMode "> transit_encryption_mode </span>is SERVER_AUTHENTICATION
  /// Structure is documented below.
