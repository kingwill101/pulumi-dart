...
import '../instance_maintenance_schedule/instance_maintenance_schedule_memorystore.dart';
...
import '../instance_node_config/instance_node_config_memorystore.dart';
...
import 'instance_memorystore_args.dart';
...
/// ```
class InstanceMemorystore extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InstanceDesiredAutoCreatedEndpoint>?>
  ...
  late final pulumi.Output<List<InstanceDesiredPscAutoConnection>?>
  ...
  /// Structure is documented below.
  late final pulumi.Output<InstanceMaintenancePolicyMemorystore?>
      maintenancePolicy;

  /// Upcoming maintenance schedule.
  /// Structure is documented below.
  late final pulumi.Output<List<InstanceMaintenanceScheduleMemorystore>>
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<InstanceNodeConfigMemorystore>> nodeConfigs;
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<InstancePscAttachmentDetail>>
  ...
  InstanceMemorystore(
    ...
    this.maintenancePolicy =
        registerOutput<InstanceMaintenancePolicyMemorystore?>(
            'maintenancePolicy');
    this.maintenanceSchedules =
        registerOutput<List<InstanceMaintenanceScheduleMemorystore>>(
            'maintenanceSchedules');
    ...
    this.nodeConfigs =
        registerOutput<List<InstanceNodeConfigMemorystore>>('nodeConfigs');
