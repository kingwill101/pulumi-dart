...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeMemorystore {
  ...
  factory InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeMemorystore.fromMap(
      Map<String, dynamic> map) {
    return InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeMemorystore(
