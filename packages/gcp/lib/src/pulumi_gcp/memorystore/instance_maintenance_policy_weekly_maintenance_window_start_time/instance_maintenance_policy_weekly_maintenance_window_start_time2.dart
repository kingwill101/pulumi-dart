...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime2 {
  ...
  InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime2({
    this.hours,
    this.minutes,
    this.nanos,
    this.seconds,
  ...
  factory InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime2.fromMap(
      Map<String, dynamic> map) {
    return InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime2(
