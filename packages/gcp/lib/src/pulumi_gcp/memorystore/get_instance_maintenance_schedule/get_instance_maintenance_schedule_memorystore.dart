...
class GetInstanceMaintenanceScheduleMemorystore {
  ...
  factory GetInstanceMaintenanceScheduleMemorystore.fromMap(
      Map<String, dynamic> map) {
    return GetInstanceMaintenanceScheduleMemorystore(
