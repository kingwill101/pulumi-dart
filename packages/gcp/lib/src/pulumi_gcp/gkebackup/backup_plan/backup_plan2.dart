...
/// ```
class BackupPlan2 extends CustomResource {
  /// Defines the configuration of Backups created via this BackupPlan.
  /// Structure is documented below.
  late final Output<BackupPlanBackupConfig?> backupConfig;

  /// Defines a schedule for automatic Backup creation via this BackupPlan.
  /// Structure is documented below.
  late final Output<BackupPlanBackupSchedule?> backupSchedule;
  ...
  /// Structure is documented below.
  late final Output<BackupPlanRetentionPolicy?> retentionPolicy;
