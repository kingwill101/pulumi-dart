...
class BackupPlanIamMember extends CustomResource {
  late final Output<BackupPlanIamMemberCondition?> condition;
  ...
  BackupPlanIamMember(
    ...
    this.condition = Output.createUnknown<BackupPlanIamMemberCondition?>();
