...
class BackupPlanRetentionPolicy {
  ...
  Map<String, dynamic> toMap() {
    ...
    final backupDeleteLockDaysValue = backupDeleteLockDays;
    if (backupDeleteLockDaysValue != null) {
      map['backupDeleteLockDays'] = backupDeleteLockDaysValue;
    }
    final backupRetainDaysValue = backupRetainDays;
    if (backupRetainDaysValue != null) {
      map['backupRetainDays'] = backupRetainDaysValue;
    }
