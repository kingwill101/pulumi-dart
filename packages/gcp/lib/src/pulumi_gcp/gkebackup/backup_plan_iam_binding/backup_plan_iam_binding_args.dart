...
import '../backup_plan_iam_binding_condition/backup_plan_iam_binding_condition.dart';

/// The set of arguments for BackupPlanIamBinding.
class BackupPlanIamBindingArgs {
  final Input<BackupPlanIamBindingCondition>? condition;
  ...
  factory BackupPlanIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanIamBindingArgs(
      condition: Input.asOptionalInput<BackupPlanIamBindingCondition>(
          map['condition']),
