...
class BackupPlanIamBinding extends CustomResource {
  late final Output<BackupPlanIamBindingCondition?> condition;
  ...
  BackupPlanIamBinding(
    ...
    this.condition = Output.createUnknown<BackupPlanIamBindingCondition?>();
