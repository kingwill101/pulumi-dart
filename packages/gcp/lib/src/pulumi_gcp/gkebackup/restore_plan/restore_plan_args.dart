...
class RestorePlanArgs {
  ...
  final Input<RestorePlanRestoreConfig> restoreConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['restoreConfig'] =
        Input.mapInputValue<RestorePlanRestoreConfig, Map<String, dynamic>>(
  ...
  factory RestorePlanArgs.fromMap(Map<String, dynamic> map) {
    return RestorePlanArgs(
      ...
      restoreConfig:
          Input.asInput<RestorePlanRestoreConfig>(map['restoreConfig']),
    );
  }
}
