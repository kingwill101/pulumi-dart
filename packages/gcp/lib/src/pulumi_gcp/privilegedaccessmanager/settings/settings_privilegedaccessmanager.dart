...
import 'settings_privilegedaccessmanager_args.dart';
...
/// ```
class SettingsPrivilegedaccessmanager extends pulumi.CustomResource {
  ...
  SettingsPrivilegedaccessmanager(
    String name, {
    SettingsPrivilegedaccessmanagerArgs? args,
