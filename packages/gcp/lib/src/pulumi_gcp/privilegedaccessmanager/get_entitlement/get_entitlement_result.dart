...
class GetEntitlementResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['additionalNotificationTargets'] = pulumi.Input.encodeList<
            GetEntitlementAdditionalNotificationTarget, Map<String, dynamic>>(
        additionalNotificationTargets, (value) => value.toMap());
    map['approvalWorkflows'] = pulumi.Input.encodeList<
        GetEntitlementApprovalWorkflow,
        Map<String, dynamic>>(approvalWorkflows, (value) => value.toMap());
    map['createTime'] = createTime;
    map['eligibleUsers'] = pulumi.Input.encodeList<GetEntitlementEligibleUser,
        Map<String, dynamic>>(eligibleUsers, (value) => value.toMap());
    ...
    map['privilegedAccesses'] = pulumi.Input.encodeList<
        GetEntitlementPrivilegedAccess,
        Map<String, dynamic>>(privilegedAccesses, (value) => value.toMap());
    map['requesterJustificationConfigs'] = pulumi.Input.encodeList<
