...
import '../get_entitlement_approval_workflow_manual_approval/get_entitlement_approval_workflow_manual_approval.dart';
...
class GetEntitlementApprovalWorkflow {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['manualApprovals'] = Input.encodeList<
  ...
  factory GetEntitlementApprovalWorkflow.fromMap(Map<String, dynamic> map) {
    return GetEntitlementApprovalWorkflow(
      manualApprovals:
          Input.decodeList<GetEntitlementApprovalWorkflowManualApproval>(
              map['manualApprovals'],
