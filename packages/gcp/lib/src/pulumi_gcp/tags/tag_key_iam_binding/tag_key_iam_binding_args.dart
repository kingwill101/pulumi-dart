...
class TagKeyIamBindingArgs {
  final Input<TagKeyIamBindingCondition>? condition;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionValue != null) {
      map['condition'] = Input.mapOptionalInputValue<TagKeyIamBindingCondition,
  ...
  factory TagKeyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TagKeyIamBindingArgs(
      condition:
          Input.asOptionalInput<TagKeyIamBindingCondition>(map['condition']),
