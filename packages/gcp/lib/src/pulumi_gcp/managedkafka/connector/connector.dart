...
class Connector extends CustomResource {
  ...
  late final Output<String> connectCluster;
  ...
  /// The name of the connector. The <span pulumi-lang-nodejs="`connector`" pulumi-lang-dotnet="`Connector`" pulumi-lang-go="`connector`" pulumi-lang-python="`connector`" pulumi-lang-yaml="`connector`" pulumi-lang-java="`connector`">`connector`</span> segment is used when connecting directly to the connect cluster. Structured like: `projects/PROJECT_ID/locations/LOCATION/connectClusters/CONNECT_CLUSTER/connectors/CONNECTOR_ID`.
  ...
  late final Output<ConnectorTaskRestartPolicy?> taskRestartPolicy;
