...
class ConnectorArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (taskRestartPolicyValue != null) {
      map['taskRestartPolicy'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      connectCluster: pulumi.Input.asInput<String>(map['connectCluster']),
      connectorId: pulumi.Input.asInput<String>(map['connectorId']),
      location: pulumi.Input.asInput<String>(map['location']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      taskRestartPolicy:
          pulumi.Input.asOptionalInput<ConnectorTaskRestartPolicy>(
