...
class ConnectClusterArgs {
  ...
  final Input<ConnectClusterCapacityConfig> capacityConfig;
  ...
  final Input<String> kafkaCluster;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['capacityConfig'] =
        Input.mapInputValue<ConnectClusterCapacityConfig, Map<String, dynamic>>(
            capacityConfig, (value) => value.toMap());
    map['connectClusterId'] = connectClusterId;
    map['gcpConfig'] =
        Input.mapInputValue<ConnectClusterGcpConfig, Map<String, dynamic>>(
  ...
  factory ConnectClusterArgs.fromMap(Map<String, dynamic> map) {
    return ConnectClusterArgs(
      capacityConfig:
          Input.asInput<ConnectClusterCapacityConfig>(map['capacityConfig']),
      connectClusterId: Input.asInput<String>(map['connectClusterId']),
      gcpConfig: Input.asInput<ConnectClusterGcpConfig>(map['gcpConfig']),
      kafkaCluster: Input.asInput<String>(map['kafkaCluster']),
