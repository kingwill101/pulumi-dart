...
class ConnectClusterGcpConfigAccessConfigNetworkConfig {
  ...
  final List<String>? additionalSubnets;
  ...
  final List<String>? dnsDomainNames;
  ...
  Map<String, dynamic> toMap() {
    ...
    final additionalSubnetsValue = additionalSubnets;
    if (additionalSubnetsValue != null) {
      map['additionalSubnets'] = additionalSubnetsValue;
    }
    final dnsDomainNamesValue = dnsDomainNames;
    if (dnsDomainNamesValue != null) {
      map['dnsDomainNames'] = dnsDomainNamesValue;
    }
    map['primarySubnet'] = primarySubnet;
    return map;
  }

  factory ConnectClusterGcpConfigAccessConfigNetworkConfig.fromMap(
      Map<String, dynamic> map) {
    return ConnectClusterGcpConfigAccessConfigNetworkConfig(
      additionalSubnets: map['additionalSubnets'] == null
          ? null
          : (map['additionalSubnets'] as List).cast<String>(),
      dnsDomainNames: map['dnsDomainNames'] == null
          ? null
          : (map['dnsDomainNames'] as List).cast<String>(),
