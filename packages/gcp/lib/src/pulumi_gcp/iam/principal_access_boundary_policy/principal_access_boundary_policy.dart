...
/// ```
class PrincipalAccessBoundaryPolicy extends CustomResource {
  ...
  late final Output<PrincipalAccessBoundaryPolicyDetails> details;
  ...
  late final Output<String> principalAccessBoundaryPolicyId;
  ...
  PrincipalAccessBoundaryPolicy(
    ...
    this.details = Output.createUnknown<PrincipalAccessBoundaryPolicyDetails>();
    ...
    this.principalAccessBoundaryPolicyId = Output.createUnknown<String>();
