...
class ProjectsPolicyBindingArgs {
  ...
  final Input<ProjectsPolicyBindingCondition>? condition;
  ...
  /// Structure is documented below.
  final Input<ProjectsPolicyBindingTarget> target;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['target'] =
        Input.mapInputValue<ProjectsPolicyBindingTarget, Map<String, dynamic>>(
  ...
  factory ProjectsPolicyBindingArgs.fromMap(Map<String, dynamic> map) {
    return ProjectsPolicyBindingArgs(
      ...
      condition: Input.asOptionalInput<ProjectsPolicyBindingCondition>(
          map['condition']),
      ...
      target: Input.asInput<ProjectsPolicyBindingTarget>(map['target']),
    );
  }
}
