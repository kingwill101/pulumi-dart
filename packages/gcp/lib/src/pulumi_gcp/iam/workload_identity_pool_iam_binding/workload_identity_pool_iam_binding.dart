...
import '../workload_identity_pool_iam_binding_condition/workload_identity_pool_iam_binding_condition.dart';
...
class WorkloadIdentityPoolIamBinding extends CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final Output<WorkloadIdentityPoolIamBindingCondition?> condition;
  ...
  WorkloadIdentityPoolIamBinding(
    ...
    this.condition =
        registerOutput<WorkloadIdentityPoolIamBindingCondition?>('condition');
