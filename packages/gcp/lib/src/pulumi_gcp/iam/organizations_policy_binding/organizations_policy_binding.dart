...
/// ```
class OrganizationsPolicyBinding extends CustomResource {
  ...
  late final Output<OrganizationsPolicyBindingCondition?> condition;
  ...
  /// Structure is documented below.
  late final Output<OrganizationsPolicyBindingTarget> target;
  ...
  OrganizationsPolicyBinding(
    ...
    this.condition =
        Output.createUnknown<OrganizationsPolicyBindingCondition?>();
    ...
    this.target = Output.createUnknown<OrganizationsPolicyBindingTarget>();
