...
class GetClusterVmwareengineResult {
  ...
  factory GetClusterVmwareengineResult.fromMap(Map<String, dynamic> map) {
    return GetClusterVmwareengineResult(
      autoscalingSettings:
