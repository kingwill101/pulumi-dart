...
class PrivateCloudNetworkConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final dnsServerIpValue = dnsServerIp;
    if (dnsServerIpValue != null) {
      map['dnsServerIp'] = dnsServerIpValue;
    }
    map['managementCidr'] = managementCidr;
    final managementIpAddressLayoutVersionValue =
        managementIpAddressLayoutVersion;
    if (managementIpAddressLayoutVersionValue != null) {
      map['managementIpAddressLayoutVersion'] =
          managementIpAddressLayoutVersionValue;
    }
    ...
    final vmwareEngineNetworkCanonicalValue = vmwareEngineNetworkCanonical;
    if (vmwareEngineNetworkCanonicalValue != null) {
      map['vmwareEngineNetworkCanonical'] = vmwareEngineNetworkCanonicalValue;
    }
    return map;
  }
  ...
  factory PrivateCloudNetworkConfig.fromMap(Map<String, dynamic> map) {
    return PrivateCloudNetworkConfig(
      dnsServerIp:
          map['dnsServerIp'] == null ? null : map['dnsServerIp'] as String,
