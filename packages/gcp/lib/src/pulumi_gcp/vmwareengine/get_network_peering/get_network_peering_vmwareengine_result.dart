...
class GetNetworkPeeringVmwareengineResult {
  ...
  GetNetworkPeeringVmwareengineResult({
  ...
  factory GetNetworkPeeringVmwareengineResult.fromMap(
      Map<String, dynamic> map) {
    return GetNetworkPeeringVmwareengineResult(
