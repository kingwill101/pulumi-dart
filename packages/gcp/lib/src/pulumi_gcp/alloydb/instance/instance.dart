...
class Instance extends CustomResource {
  ...
  /// Possible values are: `ACTIVATION_POLICY_UNSPECIFIED`, `ALWAYS`, `NEVER`.
  late final Output<String> activationPolicy;
  ...
  late final Output<InstanceClientConnectionConfig> clientConnectionConfig;
  ...
  /// Structure is documented below.
  late final Output<InstanceConnectionPoolConfig?> connectionPoolConfig;
  ...
  /// Structure is documented below.
  late final Output<InstanceMachineConfig> machineConfig;
  ...
  /// Structure is documented below.
  late final Output<InstanceNetworkConfig> networkConfig;

  /// Configuration for enhanced query insights.
  /// Structure is documented below.
  late final Output<InstanceObservabilityConfig> observabilityConfig;

  /// The outbound public IP addresses for the instance. This is available ONLY when
  /// networkConfig.enableOutboundPublicIp is set to true. These IP addresses are used
  /// for outbound connections.
  late final Output<List<String>> outboundPublicIpAddresses;

  /// Configuration for Private Service Connect (PSC) for the instance.
  /// Structure is documented below.
  late final Output<InstancePscInstanceConfig> pscInstanceConfig;
  ...
  /// Structure is documented below.
  late final Output<InstanceQueryInsightsConfig> queryInsightsConfig;

  /// Read pool specific config. If the instance type is READ_POOL, this configuration must be provided.
  /// Structure is documented below.
  late final Output<InstanceReadPoolConfig?> readPoolConfig;
