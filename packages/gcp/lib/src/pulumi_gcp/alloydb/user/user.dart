...
///
///
/// > **Note:**  All arguments marked as write-only values will not be stored in the state: <span pulumi-lang-nodejs="`passwordWo`" pulumi-lang-dotnet="`PasswordWo`" pulumi-lang-go="`passwordWo`" pulumi-lang-python="`password_wo`" pulumi-lang-yaml="`passwordWo`" pulumi-lang-java="`passwordWo`">`password_wo`</span>.
...
class User extends CustomResource {
  ...
  late final Output<String?> passwordWoVersion;
