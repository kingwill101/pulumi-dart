...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      initialUser:
          pulumi.Input.asOptionalInput<ClusterInitialUser>(map['initialUser']),
      ...
      pscConfig:
          pulumi.Input.asOptionalInput<ClusterPscConfig>(map['pscConfig']),
      restoreBackupSource:
      ...
      skipAwaitMajorVersionUpgrade: pulumi.Input.asOptionalInput<bool>(
          map['skipAwaitMajorVersionUpgrade']),
      subscriptionType:
          pulumi.Input.asOptionalInput<String>(map['subscriptionType']),
    );
  }
}
