...
class Instance16 extends CustomResource {
  ...
  late final Output<bool?> enableManagedEuc;

  /// Flag that specifies that a notebook can be accessed with third party
  /// identity provider.
  late final Output<bool?> enableThirdPartyIdentity;

  /// The definition of how to configure a VM instance outside of Resources and Identity.
  /// Structure is documented below.
  late final Output<InstanceGceSetup> gceSetup;

  /// 'Output only. Additional information about instance health. Example:
  /// healthInfo": { <span pulumi-lang-nodejs=""dockerProxyAgentStatus"" pulumi-lang-dotnet=""DockerProxyAgentStatus"" pulumi-lang-go=""dockerProxyAgentStatus"" pulumi-lang-python=""docker_proxy_agent_status"" pulumi-lang-yaml=""dockerProxyAgentStatus"" pulumi-lang-java=""dockerProxyAgentStatus"">"docker_proxy_agent_status"</span>: "1", <span pulumi-lang-nodejs=""dockerStatus"" pulumi-lang-dotnet=""DockerStatus"" pulumi-lang-go=""dockerStatus"" pulumi-lang-python=""docker_status"" pulumi-lang-yaml=""dockerStatus"" pulumi-lang-java=""dockerStatus"">"docker_status"</span>: "1", <span pulumi-lang-nodejs=""jupyterlabApiStatus"" pulumi-lang-dotnet=""JupyterlabApiStatus"" pulumi-lang-go=""jupyterlabApiStatus"" pulumi-lang-python=""jupyterlab_api_status"" pulumi-lang-yaml=""jupyterlabApiStatus"" pulumi-lang-java=""jupyterlabApiStatus"">"jupyterlab_api_status"</span>:
  /// "-1", <span pulumi-lang-nodejs=""jupyterlabStatus"" pulumi-lang-dotnet=""JupyterlabStatus"" pulumi-lang-go=""jupyterlabStatus"" pulumi-lang-python=""jupyterlab_status"" pulumi-lang-yaml=""jupyterlabStatus"" pulumi-lang-java=""jupyterlabStatus"">"jupyterlab_status"</span>: "-1", "updated": "2020-10-18 09:40:03.573409" }'
  late final Output<List<Map<String, dynamic>>> healthInfos;
  ...
  /// Structure is documented below.
  late final Output<List<InstanceUpgradeHistory>> upgradeHistories;
