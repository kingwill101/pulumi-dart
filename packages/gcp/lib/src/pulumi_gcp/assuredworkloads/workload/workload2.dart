...
import '../workload_compliance_status/workload_compliance_status.dart';
import '../workload_ekm_provisioning_response/workload_ekm_provisioning_response.dart';
...
import '../workload_resource/workload_resource.dart';
import '../workload_resource_setting/workload_resource_setting.dart';
import '../workload_saa_enrollment_response/workload_saa_enrollment_response.dart';
import '../workload_workload_options/workload_workload_options.dart';
import 'workload_args2.dart';
...
/// ```
class Workload2 extends CustomResource {
  ...
  late final Output<List<WorkloadComplianceStatus>> complianceStatuses;
  ...
  late final Output<List<WorkloadEkmProvisioningResponse>>
  ...
  late final Output<WorkloadKmsSettings?> kmsSettings;
  ...
  late final Output<WorkloadPartnerPermissions?> partnerPermissions;

  /// Optional. Input only. Billing account necessary for purchasing services from Sovereign Partners. This field is required for creating SIA/PSN/CNTXT partner workloads. The caller should have 'billing.resourceAssociations.create' IAM permission on this billing-account. The format of this string is billingAccounts/AAAAAA-BBBBBB-CCCCCC.
  late final Output<String?> partnerServicesBillingAccount;
  ...
  late final Output<List<WorkloadResourceSetting>?> resourceSettings;

  /// Output only. The resources associated with this workload. These resources will be created when creating the workload. If any of the projects already exist, the workload creation will fail. Always read only.
  late final Output<List<WorkloadResource>> resources;
  ...
  late final Output<List<WorkloadSaaEnrollmentResponse>> saaEnrollmentResponses;
  ...
  late final Output<WorkloadWorkloadOptions?> workloadOptions;
