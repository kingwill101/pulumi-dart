...
import 'workload_assuredworkloads_args.dart';
...
/// ```
class WorkloadAssuredworkloads extends pulumi.CustomResource {
  ...
  WorkloadAssuredworkloads(
    String name, {
    WorkloadAssuredworkloadsArgs? args,
