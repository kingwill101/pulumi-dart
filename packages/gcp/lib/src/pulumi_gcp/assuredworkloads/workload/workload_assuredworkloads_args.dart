...
class WorkloadAssuredworkloadsArgs {
  ...
  factory WorkloadAssuredworkloadsArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadAssuredworkloadsArgs(
      billingAccount:
          pulumi.Input.asOptionalInput<String>(map['billingAccount']),
      complianceRegime: pulumi.Input.asInput<String>(map['complianceRegime']),
      displayName: pulumi.Input.asInput<String>(map['displayName']),
      enableSovereignControls:
          pulumi.Input.asOptionalInput<bool>(map['enableSovereignControls']),
      kmsSettings:
          pulumi.Input.asOptionalInput<WorkloadKmsSettings>(map['kmsSettings']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asInput<String>(map['location']),
      organization: pulumi.Input.asInput<String>(map['organization']),
      partner: pulumi.Input.asOptionalInput<String>(map['partner']),
      partnerPermissions:
      ...
      partnerServicesBillingAccount: pulumi.Input.asOptionalInput<String>(
          map['partnerServicesBillingAccount']),
