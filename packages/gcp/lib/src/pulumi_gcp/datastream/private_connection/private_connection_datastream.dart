...
import '../private_connection_error/private_connection_error_datastream.dart';
...
import 'private_connection_datastream_args.dart';
...
/// ```
class PrivateConnectionDatastream extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PrivateConnectionErrorDatastream>> errors;
  ...
  /// Structure is documented below.
  late final pulumi.Output<PrivateConnectionPscInterfaceConfig?>
      pscInterfaceConfig;
  ...
  /// Structure is documented below.
  late final pulumi.Output<PrivateConnectionVpcPeeringConfigDatastream?>
      vpcPeeringConfig;

  PrivateConnectionDatastream(
    String name, {
    PrivateConnectionDatastreamArgs? args,
    ...
    this.errors =
        registerOutput<List<PrivateConnectionErrorDatastream>>('errors');
    ...
    this.vpcPeeringConfig =
        registerOutput<PrivateConnectionVpcPeeringConfigDatastream?>(
            'vpcPeeringConfig');
  }
}
