...
import 'connection_profile_datastream_args.dart';
...
/// ```
class ConnectionProfileDatastream extends pulumi.CustomResource {
  ...
  ConnectionProfileDatastream(
    String name, {
    ConnectionProfileDatastreamArgs? args,
