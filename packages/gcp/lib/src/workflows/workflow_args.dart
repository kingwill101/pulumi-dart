...
class WorkflowArgs {
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      callLogLevel: map['callLogLevel'] == null ? null : map['callLogLevel'] as String,
      ...
      executionHistoryLevel: map['executionHistoryLevel'] == null ? null : map['executionHistoryLevel'] as String,
      ...
      userEnvVars: map['userEnvVars'] == null ? null : (map['userEnvVars'] as Map).cast<String, String>(),
    );
  }
}
