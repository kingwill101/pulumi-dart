...
/// {@template pulumi_workstations_workstation_iam_binding_workstation_iam_binding_args_doc}
/// The set of arguments for WorkstationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_workstations_workstation_iam_binding_workstation_iam_binding_args_doc}
class WorkstationIamBindingArgs {
  final pulumi.Input<WorkstationIamBindingCondition>? condition;
  ...
  /// Creates a new [WorkstationIamBindingArgs].
  /// [condition] Optional.
  ...
  WorkstationIamBindingArgs({
    WorkstationIamBindingCondition? condition,
    String? location,
    ...
    required String workstationId,
      ...
      condition = pulumi.Input.asOptionalInput<WorkstationIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<WorkstationIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'members': members,
      'project': ?project,
      'role': role,
  ...
  factory WorkstationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationIamBindingArgs(
      condition: map['condition'] == null ? null : WorkstationIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
