...
class WorkstationConfigArgs {
  ...
  factory WorkstationConfigArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigArgs(
      allowedPorts: map['allowedPorts'] == null ? null : pulumi.Input.decodeList<WorkstationConfigAllowedPort>(map['allowedPorts'], (value) => WorkstationConfigAllowedPort.fromMap((value as Map).cast<String, dynamic>())),
      annotations: map['annotations'] == null ? null : (map['annotations'] as Map).cast<String, String>(),
      container: map['container'] == null ? null : WorkstationConfigContainer.fromMap((map['container'] as Map).cast<String, dynamic>()),
      disableTcpConnections: map['disableTcpConnections'] == null ? null : map['disableTcpConnections'] as bool,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      enableAuditAgent: map['enableAuditAgent'] == null ? null : map['enableAuditAgent'] as bool,
      encryptionKey: map['encryptionKey'] == null ? null : WorkstationConfigEncryptionKey.fromMap((map['encryptionKey'] as Map).cast<String, dynamic>()),
      ephemeralDirectories: map['ephemeralDirectories'] == null ? null : pulumi.Input.decodeList<WorkstationConfigEphemeralDirectory>(map['ephemeralDirectories'], (value) => WorkstationConfigEphemeralDirectory.fromMap((value as Map).cast<String, dynamic>())),
      host: map['host'] == null ? null : WorkstationConfigHost.fromMap((map['host'] as Map).cast<String, dynamic>()),
      idleTimeout: map['idleTimeout'] == null ? null : map['idleTimeout'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      maxUsableWorkstations: map['maxUsableWorkstations'] == null ? null : map['maxUsableWorkstations'] as int,
      persistentDirectories: map['persistentDirectories'] == null ? null : pulumi.Input.decodeList<WorkstationConfigPersistentDirectory>(map['persistentDirectories'], (value) => WorkstationConfigPersistentDirectory.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      readinessChecks: map['readinessChecks'] == null ? null : pulumi.Input.decodeList<WorkstationConfigReadinessCheck>(map['readinessChecks'], (value) => WorkstationConfigReadinessCheck.fromMap((value as Map).cast<String, dynamic>())),
