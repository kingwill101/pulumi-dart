...
class WorkstationClusterArgs {
  ...
  factory WorkstationClusterArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationClusterArgs(
      ...
      domainConfig: map['domainConfig'] == null ? null : WorkstationClusterDomainConfig.fromMap((map['domainConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      network: map['network'] as String,
      privateClusterConfig: map['privateClusterConfig'] == null ? null : WorkstationClusterPrivateClusterConfig.fromMap((map['privateClusterConfig'] as Map).cast<String, dynamic>()),
