...
import 'workstation_config_iam_member_args.dart';
...
class WorkstationConfigIamMember extends pulumi.CustomResource {
  late final pulumi.Output<WorkstationConfigIamMemberCondition?> condition;
  ...
  /// Creates a new [WorkstationConfigIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkstationConfigIamMember]. {@macro pulumi_workstations_workstation_config_iam_member_workstation_config_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkstationConfigIamMember(
    String name, {
    WorkstationConfigIamMemberArgs? args,
    ...
    this.condition = registerOutput<WorkstationConfigIamMemberCondition?>('condition');
