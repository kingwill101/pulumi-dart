...
class WorkstationConfigIamMemberArgs {
  ...
  WorkstationConfigIamMemberArgs({
    WorkstationConfigIamMemberCondition? condition,
    String? location,
  ...
  factory WorkstationConfigIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigIamMemberArgs(
      condition: map['condition'] == null ? null : WorkstationConfigIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
