...
class WorkstationConfig extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<WorkstationConfigEphemeralDirectory>>
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<WorkstationConfigPersistentDirectory>>
  persistentDirectories;
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<WorkstationConfigReadinessCheck>?>
  readinessChecks;
  ...
  WorkstationConfig(
    ...
    this.allowedPorts = registerOutput<List<WorkstationConfigAllowedPort>>(
      'allowedPorts',
    );
    this.annotations = registerOutput<Map<String, String>?>('annotations');
    this.conditions = registerOutput<List<WorkstationConfigCondition>>(
      'conditions',
    );
    ...
    this.encryptionKey = registerOutput<WorkstationConfigEncryptionKey?>(
      'encryptionKey',
    );
