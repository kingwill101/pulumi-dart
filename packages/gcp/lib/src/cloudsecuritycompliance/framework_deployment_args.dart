...
class FrameworkDeploymentArgs {
  ...
  FrameworkDeploymentArgs({
    required List<FrameworkDeploymentCloudControlMetadata> cloudControlMetadatas,
    String? description,
  ...
  factory FrameworkDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return FrameworkDeploymentArgs(
      cloudControlMetadatas: pulumi.Input.decodeList<FrameworkDeploymentCloudControlMetadata>(map['cloudControlMetadatas'], (value) => FrameworkDeploymentCloudControlMetadata.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      framework: FrameworkDeploymentFramework.fromMap((map['framework'] as Map).cast<String, dynamic>()),
      frameworkDeploymentId: map['frameworkDeploymentId'] as String,
      location: map['location'] as String,
      organization: map['organization'] as String,
      targetResourceConfig: FrameworkDeploymentTargetResourceConfig.fromMap((map['targetResourceConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
