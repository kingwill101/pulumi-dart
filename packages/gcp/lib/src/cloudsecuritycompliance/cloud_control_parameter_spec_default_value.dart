...
class CloudControlParameterSpecDefaultValue {
  ...
  factory CloudControlParameterSpecDefaultValue.fromMap(Map<String, dynamic> map) {
    return CloudControlParameterSpecDefaultValue(
      ...
      oneofValue: map['oneofValue'] == null ? null : CloudControlParameterSpecDefaultValueOneofValue.fromMap((map['oneofValue'] as Map).cast<String, dynamic>()),
      stringListValue: map['stringListValue'] == null ? null : CloudControlParameterSpecDefaultValueStringListValue.fromMap((map['stringListValue'] as Map).cast<String, dynamic>()),
