...
class EntitlementArgs {
  ...
  EntitlementArgs({
    ...
    required EntitlementRequesterJustificationConfig requesterJustificationConfig,
  }) :
  ...
  factory EntitlementArgs.fromMap(Map<String, dynamic> map) {
    return EntitlementArgs(
      additionalNotificationTargets: map['additionalNotificationTargets'] == null ? null : EntitlementAdditionalNotificationTargets.fromMap((map['additionalNotificationTargets'] as Map).cast<String, dynamic>()),
      approvalWorkflow: map['approvalWorkflow'] == null ? null : EntitlementApprovalWorkflow.fromMap((map['approvalWorkflow'] as Map).cast<String, dynamic>()),
      eligibleUsers: pulumi.Input.decodeList<EntitlementEligibleUser>(map['eligibleUsers'], (value) => EntitlementEligibleUser.fromMap((value as Map).cast<String, dynamic>())),
      entitlementId: map['entitlementId'] as String,
      location: map['location'] as String,
      maxRequestDuration: map['maxRequestDuration'] as String,
      parent: map['parent'] as String,
      privilegedAccess: EntitlementPrivilegedAccess.fromMap((map['privilegedAccess'] as Map).cast<String, dynamic>()),
      requesterJustificationConfig: EntitlementRequesterJustificationConfig.fromMap((map['requesterJustificationConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
