...
class Entitlement extends pulumi.CustomResource {
  ...
  Entitlement(
    ...
    this.approvalWorkflow = registerOutput<EntitlementApprovalWorkflow?>(
      'approvalWorkflow',
    );
    this.createTime = registerOutput<String>('createTime');
    this.eligibleUsers = registerOutput<List<EntitlementEligibleUser>>(
      'eligibleUsers',
    );
    ...
    this.privilegedAccess = registerOutput<EntitlementPrivilegedAccess>(
      'privilegedAccess',
    );
