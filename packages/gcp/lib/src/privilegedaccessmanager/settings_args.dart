...
class SettingsArgs {
  ...
  factory SettingsArgs.fromMap(Map<String, dynamic> map) {
    return SettingsArgs(
      emailNotificationSettings: map['emailNotificationSettings'] == null ? null : SettingsEmailNotificationSettings.fromMap((map['emailNotificationSettings'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      parent: map['parent'] as String,
      serviceAccountApproverSettings: map['serviceAccountApproverSettings'] == null ? null : SettingsServiceAccountApproverSettings.fromMap((map['serviceAccountApproverSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
