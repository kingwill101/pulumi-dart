...
class ClusterAutomatedBackupPolicyWeeklySchedule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTimes': pulumi.Input.encodeList<ClusterAutomatedBackupPolicyWeeklyScheduleStartTime, Map<String, dynamic>>(startTimes, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterAutomatedBackupPolicyWeeklySchedule.fromMap(Map<String, dynamic> map) {
    return ClusterAutomatedBackupPolicyWeeklySchedule(
      ...
      startTimes: pulumi.Input.decodeList<ClusterAutomatedBackupPolicyWeeklyScheduleStartTime>(map['startTimes'], (value) => ClusterAutomatedBackupPolicyWeeklyScheduleStartTime.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
