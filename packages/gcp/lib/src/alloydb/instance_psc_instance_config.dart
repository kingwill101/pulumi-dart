...
class InstancePscInstanceConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscAutoConnections': ?pscAutoConnections == null ? null : pulumi.Input.encodeList<InstancePscInstanceConfigPscAutoConnection, Map<String, dynamic>>(pscAutoConnections!, (value) => value.toMap()),
      'pscDnsName': ?pscDnsName,
      'pscInterfaceConfigs': ?pscInterfaceConfigs == null ? null : pulumi.Input.encodeList<InstancePscInstanceConfigPscInterfaceConfig, Map<String, dynamic>>(pscInterfaceConfigs!, (value) => value.toMap()),
  ...
  factory InstancePscInstanceConfig.fromMap(Map<String, dynamic> map) {
    return InstancePscInstanceConfig(
      ...
      pscAutoConnections: map['pscAutoConnections'] == null ? null : pulumi.Input.decodeList<InstancePscInstanceConfigPscAutoConnection>(map['pscAutoConnections'], (value) => InstancePscInstanceConfigPscAutoConnection.fromMap((value as Map).cast<String, dynamic>())),
      pscDnsName: map['pscDnsName'] == null ? null : map['pscDnsName'] as String,
      pscInterfaceConfigs: map['pscInterfaceConfigs'] == null ? null : pulumi.Input.decodeList<InstancePscInstanceConfigPscInterfaceConfig>(map['pscInterfaceConfigs'], (value) => InstancePscInstanceConfigPscInterfaceConfig.fromMap((value as Map).cast<String, dynamic>())),
      serviceAttachmentLink: map['serviceAttachmentLink'] == null ? null : map['serviceAttachmentLink'] as String,
    );
  }
}
