...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.automatedBackupPolicy = registerOutput<ClusterAutomatedBackupPolicy>(
      'automatedBackupPolicy',
    );
    this.backupSources = registerOutput<List<ClusterBackupSource>>(
      'backupSources',
    );
    this.clusterId = registerOutput<String>('clusterId');
    this.clusterType = registerOutput<String?>('clusterType');
    this.continuousBackupConfig = registerOutput<ClusterContinuousBackupConfig>(
      'continuousBackupConfig',
    );
    ...
    this.encryptionConfig = registerOutput<ClusterEncryptionConfig?>(
      'encryptionConfig',
    );
    this.encryptionInfos = registerOutput<List<ClusterEncryptionInfo>>(
      'encryptionInfos',
    );
    ...
    this.migrationSources = registerOutput<List<ClusterMigrationSource>>(
      'migrationSources',
    );
    ...
    this.restoreBackupSource = registerOutput<ClusterRestoreBackupSource?>(
      'restoreBackupSource',
    );
    ...
    this.secondaryConfig = registerOutput<ClusterSecondaryConfig?>(
      'secondaryConfig',
    );
    this.skipAwaitMajorVersionUpgrade = registerOutput<bool?>(
      'skipAwaitMajorVersionUpgrade',
    );
    this.state = registerOutput<String>('state');
    this.subscriptionType = registerOutput<String>('subscriptionType');
    this.trialMetadatas = registerOutput<List<ClusterTrialMetadata>>(
      'trialMetadatas',
    );
