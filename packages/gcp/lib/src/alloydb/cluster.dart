...
class Cluster extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Cluster]. {@macro pulumi_alloydb_cluster_cluster_args_doc}
  ...
  Cluster(
    ...
    this.automatedBackupPolicy = registerOutput<ClusterAutomatedBackupPolicy>('automatedBackupPolicy');
    this.backupSources = registerOutput<List<ClusterBackupSource>>('backupSources');
    this.clusterId = registerOutput<String>('clusterId');
    this.clusterType = registerOutput<String?>('clusterType');
    this.continuousBackupConfig = registerOutput<ClusterContinuousBackupConfig>('continuousBackupConfig');
    this.continuousBackupInfos = registerOutput<List<ClusterContinuousBackupInfo>>('continuousBackupInfos');
    ...
    this.encryptionInfos = registerOutput<List<ClusterEncryptionInfo>>('encryptionInfos');
    this.etag = registerOutput<String?>('etag');
    this.initialUser = registerOutput<ClusterInitialUser?>('initialUser');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.maintenanceUpdatePolicy = registerOutput<ClusterMaintenanceUpdatePolicy?>('maintenanceUpdatePolicy');
    this.migrationSources = registerOutput<List<ClusterMigrationSource>>('migrationSources');
    ...
    this.restoreBackupSource = registerOutput<ClusterRestoreBackupSource?>('restoreBackupSource');
    this.restoreContinuousBackupSource = registerOutput<ClusterRestoreContinuousBackupSource?>('restoreContinuousBackupSource');
    this.secondaryConfig = registerOutput<ClusterSecondaryConfig?>('secondaryConfig');
    this.skipAwaitMajorVersionUpgrade = registerOutput<bool?>('skipAwaitMajorVersionUpgrade');
    this.state = registerOutput<String>('state');
    this.subscriptionType = registerOutput<String>('subscriptionType');
    this.trialMetadatas = registerOutput<List<ClusterTrialMetadata>>('trialMetadatas');
