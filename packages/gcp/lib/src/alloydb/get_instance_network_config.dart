...
class GetInstanceNetworkConfig {
  ...
  /// true.
  final List<GetInstanceNetworkConfigAuthorizedExternalNetwork> authorizedExternalNetworks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedExternalNetworks': pulumi.Input.encodeList<GetInstanceNetworkConfigAuthorizedExternalNetwork, Map<String, dynamic>>(authorizedExternalNetworks, (value) => value.toMap()),
  ...
  factory GetInstanceNetworkConfig.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkConfig(
      ...
      authorizedExternalNetworks: pulumi.Input.decodeList<GetInstanceNetworkConfigAuthorizedExternalNetwork>(map['authorizedExternalNetworks'], (value) => GetInstanceNetworkConfigAuthorizedExternalNetwork.fromMap((value as Map).cast<String, dynamic>())),
