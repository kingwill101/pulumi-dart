...
class GetSupportedDatabaseFlagsSupportedDatabaseFlag {
  ...
  final GetSupportedDatabaseFlagsSupportedDatabaseFlagIntegerRestrictions integerRestrictions;
  ...
  final GetSupportedDatabaseFlagsSupportedDatabaseFlagStringRestrictions stringRestrictions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'flagName': flagName,
      'integerRestrictions': integerRestrictions.toMap(),
      'name': name,
      'requiresDbRestart': requiresDbRestart,
      'stringRestrictions': stringRestrictions.toMap(),
  ...
  factory GetSupportedDatabaseFlagsSupportedDatabaseFlag.fromMap(Map<String, dynamic> map) {
    return GetSupportedDatabaseFlagsSupportedDatabaseFlag(
      ...
      integerRestrictions: GetSupportedDatabaseFlagsSupportedDatabaseFlagIntegerRestrictions.fromMap((map['integerRestrictions'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      requiresDbRestart: map['requiresDbRestart'] as bool,
      stringRestrictions: GetSupportedDatabaseFlagsSupportedDatabaseFlagStringRestrictions.fromMap((map['stringRestrictions'] as Map).cast<String, dynamic>()),
