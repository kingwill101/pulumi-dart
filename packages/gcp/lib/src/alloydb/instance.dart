...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.connectionPoolConfig = registerOutput<InstanceConnectionPoolConfig?>(
    ...
    this.observabilityConfig = registerOutput<InstanceObservabilityConfig>(
      'observabilityConfig',
    );
    this.outboundPublicIpAddresses = registerOutput<List<String>>(
      'outboundPublicIpAddresses',
    );
    this.pscInstanceConfig = registerOutput<InstancePscInstanceConfig>(
      'pscInstanceConfig',
    );
    this.publicIpAddress = registerOutput<String>('publicIpAddress');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.queryInsightsConfig = registerOutput<InstanceQueryInsightsConfig>(
      'queryInsightsConfig',
    );
    this.readPoolConfig = registerOutput<InstanceReadPoolConfig?>(
      'readPoolConfig',
    );
