...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    InstanceUserMetadata? userMetadata,
  }) : adminSettings = pulumi.Input.asOptionalInput<InstanceAdminSettings>(
         adminSettings,
       ),
       ...
       controlledEgressEnabled = pulumi.Input.asOptionalInput<bool>(
         controlledEgressEnabled,
       ),
       customDomain = pulumi.Input.asOptionalInput<InstanceCustomDomain>(
         customDomain,
       ),
       ...
       encryptionConfig = pulumi
           .Input.asOptionalInput<InstanceEncryptionConfig>(encryptionConfig),
       fipsEnabled = pulumi.Input.asOptionalInput<bool>(fipsEnabled),
       geminiEnabled = pulumi.Input.asOptionalInput<bool>(geminiEnabled),
       maintenanceWindow = pulumi
           .Input.asOptionalInput<InstanceMaintenanceWindow>(maintenanceWindow),
       ...
       userMetadata = pulumi.Input.asOptionalInput<InstanceUserMetadata>(
         userMetadata,
       );
    ...
    return <String, dynamic>{
      ...
      'controlledEgressConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(controlledEgressConfig, (value) => value.toMap()),
      ...
      'periodicExportConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(periodicExportConfig, (value) => value.toMap()),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      geminiEnabled: map['geminiEnabled'] == null
          ? null
          : map['geminiEnabled'] as bool,
