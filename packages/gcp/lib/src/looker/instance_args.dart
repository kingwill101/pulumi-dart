...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      adminSettings: map['adminSettings'] == null ? null : InstanceAdminSettings.fromMap((map['adminSettings'] as Map).cast<String, dynamic>()),
      consumerNetwork: map['consumerNetwork'] == null ? null : map['consumerNetwork'] as String,
      controlledEgressConfig: map['controlledEgressConfig'] == null ? null : InstanceControlledEgressConfig.fromMap((map['controlledEgressConfig'] as Map).cast<String, dynamic>()),
      controlledEgressEnabled: map['controlledEgressEnabled'] == null ? null : map['controlledEgressEnabled'] as bool,
      customDomain: map['customDomain'] == null ? null : InstanceCustomDomain.fromMap((map['customDomain'] as Map).cast<String, dynamic>()),
      deletionPolicy: map['deletionPolicy'] == null ? null : map['deletionPolicy'] as String,
      denyMaintenancePeriod: map['denyMaintenancePeriod'] == null ? null : InstanceDenyMaintenancePeriod.fromMap((map['denyMaintenancePeriod'] as Map).cast<String, dynamic>()),
      encryptionConfig: map['encryptionConfig'] == null ? null : InstanceEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      fipsEnabled: map['fipsEnabled'] == null ? null : map['fipsEnabled'] as bool,
      geminiEnabled: map['geminiEnabled'] == null ? null : map['geminiEnabled'] as bool,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : InstanceMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      oauthConfig: InstanceOauthConfig.fromMap((map['oauthConfig'] as Map).cast<String, dynamic>()),
      periodicExportConfig: map['periodicExportConfig'] == null ? null : InstancePeriodicExportConfig.fromMap((map['periodicExportConfig'] as Map).cast<String, dynamic>()),
      platformEdition: map['platformEdition'] == null ? null : map['platformEdition'] as String,
      privateIpEnabled: map['privateIpEnabled'] == null ? null : map['privateIpEnabled'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      pscConfig: map['pscConfig'] == null ? null : InstancePscConfig.fromMap((map['pscConfig'] as Map).cast<String, dynamic>()),
      ...
      userMetadata: map['userMetadata'] == null ? null : InstanceUserMetadata.fromMap((map['userMetadata'] as Map).cast<String, dynamic>()),
    );
  }
}
