...
class InstanceArgs {
  ...
  InstanceArgs({
    InstanceAdminSettings? adminSettings,
    String? consumerNetwork,
    InstanceControlledEgressConfig? controlledEgressConfig,
    bool? controlledEgressEnabled,
    InstanceCustomDomain? customDomain,
    String? deletionPolicy,
    InstanceDenyMaintenancePeriod? denyMaintenancePeriod,
    InstanceEncryptionConfig? encryptionConfig,
    bool? fipsEnabled,
    bool? geminiEnabled,
    InstanceMaintenanceWindow? maintenanceWindow,
    String? name,
    required InstanceOauthConfig oauthConfig,
    InstancePeriodicExportConfig? periodicExportConfig,
    String? platformEdition,
    bool? privateIpEnabled,
    String? project,
    InstancePscConfig? pscConfig,
    bool? pscEnabled,
    bool? publicIpEnabled,
    String? region,
    String? reservedRange,
    InstanceUserMetadata? userMetadata,
  })  : adminSettings =
            pulumi.Input.asOptionalInput<InstanceAdminSettings>(adminSettings),
        consumerNetwork = pulumi.Input.asOptionalInput<String>(consumerNetwork),
        controlledEgressConfig =
            pulumi.Input.asOptionalInput<InstanceControlledEgressConfig>(
                controlledEgressConfig),
        controlledEgressEnabled =
            pulumi.Input.asOptionalInput<bool>(controlledEgressEnabled),
        customDomain =
            pulumi.Input.asOptionalInput<InstanceCustomDomain>(customDomain),
        deletionPolicy = pulumi.Input.asOptionalInput<String>(deletionPolicy),
        denyMaintenancePeriod =
            pulumi.Input.asOptionalInput<InstanceDenyMaintenancePeriod>(
                denyMaintenancePeriod),
        encryptionConfig =
            pulumi.Input.asOptionalInput<InstanceEncryptionConfig>(
                encryptionConfig),
        fipsEnabled = pulumi.Input.asOptionalInput<bool>(fipsEnabled),
        geminiEnabled = pulumi.Input.asOptionalInput<bool>(geminiEnabled),
        maintenanceWindow =
            pulumi.Input.asOptionalInput<InstanceMaintenanceWindow>(
                maintenanceWindow),
        name = pulumi.Input.asOptionalInput<String>(name),
        oauthConfig = pulumi.Input.asInput<InstanceOauthConfig>(oauthConfig),
        periodicExportConfig =
            pulumi.Input.asOptionalInput<InstancePeriodicExportConfig>(
                periodicExportConfig),
        ...
        userMetadata =
            pulumi.Input.asOptionalInput<InstanceUserMetadata>(userMetadata);

  Map<String, dynamic> toMap() {
    final map = <String, dynamic>{};
    final adminSettingsValue = adminSettings;
    if (adminSettingsValue != null) {
      map['adminSettings'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (controlledEgressConfigValue != null) {
      map['controlledEgressConfig'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (customDomainValue != null) {
      map['customDomain'] = pulumi.Input.mapOptionalInputValue<
    ...
    map['oauthConfig'] =
        pulumi.Input.mapInputValue<InstanceOauthConfig, Map<String, dynamic>>(
            oauthConfig, (value) => value.toMap());
    final periodicExportConfigValue = periodicExportConfig;
    if (periodicExportConfigValue != null) {
      map['periodicExportConfig'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (pscConfigValue != null) {
      map['pscConfig'] = pulumi.Input.mapOptionalInputValue<InstancePscConfig,
    ...
    if (userMetadataValue != null) {
      map['userMetadata'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      adminSettings: map['adminSettings'] == null
          ? null
          : InstanceAdminSettings.fromMap(
              (map['adminSettings'] as Map).cast<String, dynamic>()),
      consumerNetwork: map['consumerNetwork'] == null
          ? null
          : map['consumerNetwork'] as String,
      controlledEgressConfig: map['controlledEgressConfig'] == null
          ? null
          : InstanceControlledEgressConfig.fromMap(
              (map['controlledEgressConfig'] as Map).cast<String, dynamic>()),
      controlledEgressEnabled: map['controlledEgressEnabled'] == null
          ? null
          : map['controlledEgressEnabled'] as bool,
      customDomain: map['customDomain'] == null
          ? null
          : InstanceCustomDomain.fromMap(
      ...
      denyMaintenancePeriod: map['denyMaintenancePeriod'] == null
          ? null
          : InstanceDenyMaintenancePeriod.fromMap(
              (map['denyMaintenancePeriod'] as Map).cast<String, dynamic>()),
      encryptionConfig: map['encryptionConfig'] == null
          ? null
          : InstanceEncryptionConfig.fromMap(
              (map['encryptionConfig'] as Map).cast<String, dynamic>()),
      fipsEnabled:
          map['fipsEnabled'] == null ? null : map['fipsEnabled'] as bool,
      geminiEnabled:
          map['geminiEnabled'] == null ? null : map['geminiEnabled'] as bool,
      maintenanceWindow: map['maintenanceWindow'] == null
          ? null
          : InstanceMaintenanceWindow.fromMap(
              (map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      oauthConfig: InstanceOauthConfig.fromMap(
          (map['oauthConfig'] as Map).cast<String, dynamic>()),
      periodicExportConfig: map['periodicExportConfig'] == null
          ? null
          : InstancePeriodicExportConfig.fromMap(
              (map['periodicExportConfig'] as Map).cast<String, dynamic>()),
      platformEdition: map['platformEdition'] == null
          ? null
          : map['platformEdition'] as String,
