...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.adminSettings = registerOutput<InstanceAdminSettings?>(
      'adminSettings',
    );
    ...
    this.controlledEgressEnabled = registerOutput<bool?>(
      'controlledEgressEnabled',
    );
    this.createTime = registerOutput<String>('createTime');
    this.customDomain = registerOutput<InstanceCustomDomain?>('customDomain');
    this.deletionPolicy = registerOutput<String?>('deletionPolicy');
    this.denyMaintenancePeriod = registerOutput<InstanceDenyMaintenancePeriod?>(
      'denyMaintenancePeriod',
    );
    this.egressPublicIp = registerOutput<String>('egressPublicIp');
    this.encryptionConfig = registerOutput<InstanceEncryptionConfig>(
      'encryptionConfig',
    );
    ...
    this.maintenanceWindow = registerOutput<InstanceMaintenanceWindow?>(
      'maintenanceWindow',
    );
    this.name = registerOutput<String>('name');
    this.oauthConfig = registerOutput<InstanceOauthConfig>('oauthConfig');
    this.periodicExportConfig = registerOutput<InstancePeriodicExportConfig?>(
