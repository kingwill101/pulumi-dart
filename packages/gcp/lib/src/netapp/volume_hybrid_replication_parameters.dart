...
class VolumeHybridReplicationParameters {
  ...
  Map<String, dynamic> toMap() {
    ...
    final clusterLocationValue = clusterLocation;
    if (clusterLocationValue != null) {
      map['clusterLocation'] = clusterLocationValue;
    }
    final descriptionValue = description;
    if (descriptionValue != null) {
      map['description'] = descriptionValue;
    }
    final hybridReplicationTypeValue = hybridReplicationType;
    if (hybridReplicationTypeValue != null) {
      map['hybridReplicationType'] = hybridReplicationTypeValue;
    }
    final labelsValue = labels;
    if (labelsValue != null) {
      map['labels'] = labelsValue;
    }
    final largeVolumeConstituentCountValue = largeVolumeConstituentCount;
    if (largeVolumeConstituentCountValue != null) {
      map['largeVolumeConstituentCount'] = largeVolumeConstituentCountValue;
    }
    ...
    final replicationValue = replication;
    if (replicationValue != null) {
      map['replication'] = replicationValue;
    }
    final replicationScheduleValue = replicationSchedule;
    if (replicationScheduleValue != null) {
      map['replicationSchedule'] = replicationScheduleValue;
    }
    return map;
  }
  ...
  factory VolumeHybridReplicationParameters.fromMap(Map<String, dynamic> map) {
    return VolumeHybridReplicationParameters(
      ...
      replication:
          map['replication'] == null ? null : map['replication'] as String,
