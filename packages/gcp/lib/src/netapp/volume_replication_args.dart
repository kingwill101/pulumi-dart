...
class VolumeReplicationArgs {
  ...
  VolumeReplicationArgs({
    ...
    bool? waitForMirror,
            ...
            pulumi.Input.asOptionalInput<bool>(deleteDestinationVolume),
        ...
        replicationEnabled =
            pulumi.Input.asOptionalInput<bool>(replicationEnabled),
  ...
  factory VolumeReplicationArgs.fromMap(Map<String, dynamic> map) {
    return VolumeReplicationArgs(
      ...
      destinationVolumeParameters: map['destinationVolumeParameters'] == null
          ...
          : VolumeReplicationDestinationVolumeParameters.fromMap(
              (map['destinationVolumeParameters'] as Map)
                  .cast<String, dynamic>()),
      forceStopping:
          map['forceStopping'] == null ? null : map['forceStopping'] as bool,
      ...
      waitForMirror:
          map['waitForMirror'] == null ? null : map['waitForMirror'] as bool,
    );
  }
}
