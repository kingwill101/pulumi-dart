...
class VolumeReplicationArgs {
  ...
  factory VolumeReplicationArgs.fromMap(Map<String, dynamic> map) {
    return VolumeReplicationArgs(
      deleteDestinationVolume: map['deleteDestinationVolume'] == null ? null : map['deleteDestinationVolume'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      destinationVolumeParameters: map['destinationVolumeParameters'] == null ? null : VolumeReplicationDestinationVolumeParameters.fromMap((map['destinationVolumeParameters'] as Map).cast<String, dynamic>()),
      forceStopping: map['forceStopping'] == null ? null : map['forceStopping'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      replicationEnabled: map['replicationEnabled'] == null ? null : map['replicationEnabled'] as bool,
      replicationSchedule: map['replicationSchedule'] as String,
      volumeName: map['volumeName'] as String,
      waitForMirror: map['waitForMirror'] == null ? null : map['waitForMirror'] as bool,
    );
  }
}
