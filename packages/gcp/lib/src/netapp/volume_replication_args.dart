...
class VolumeReplicationArgs {
  ...
  VolumeReplicationArgs({
    bool? deleteDestinationVolume,
    String? description,
    VolumeReplicationDestinationVolumeParameters? destinationVolumeParameters,
    bool? forceStopping,
    ...
    required String replicationSchedule,
    required String volumeName,
    bool? waitForMirror,
  }) : deleteDestinationVolume = pulumi.Input.asOptionalInput<bool>(
       ...
       replicationEnabled = pulumi.Input.asOptionalInput<bool>(
         replicationEnabled,
       ),
  ...
  factory VolumeReplicationArgs.fromMap(Map<String, dynamic> map) {
    return VolumeReplicationArgs(
      deleteDestinationVolume: map['deleteDestinationVolume'] == null
          ? null
          : map['deleteDestinationVolume'] as bool,
      description: map['description'] == null
          ? null
          : map['description'] as String,
      destinationVolumeParameters: map['destinationVolumeParameters'] == null
          ? null
          : VolumeReplicationDestinationVolumeParameters.fromMap(
              (map['destinationVolumeParameters'] as Map)
                  .cast<String, dynamic>(),
            ),
      forceStopping: map['forceStopping'] == null
          ? null
          : map['forceStopping'] as bool,
      ...
      replicationEnabled: map['replicationEnabled'] == null
          ? null
          : map['replicationEnabled'] as bool,
      replicationSchedule: map['replicationSchedule'] as String,
      volumeName: map['volumeName'] as String,
      waitForMirror: map['waitForMirror'] == null
          ? null
          : map['waitForMirror'] as bool,
    );
  }
}
