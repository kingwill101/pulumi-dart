...
class StoragePool extends pulumi.CustomResource {
  ...
  StoragePool(
    ...
    this.availableThroughputMibps = registerOutput<double>('availableThroughputMibps');
    this.capacityGib = registerOutput<String>('capacityGib');
    this.coldTierSizeUsedGib = registerOutput<String>('coldTierSizeUsedGib');
    this.customPerformanceEnabled = registerOutput<bool>('customPerformanceEnabled');
    this.description = registerOutput<String?>('description');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.enableHotTierAutoResize = registerOutput<bool?>('enableHotTierAutoResize');
