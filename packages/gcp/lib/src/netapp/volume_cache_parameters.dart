...
class VolumeCacheParameters {
  ...
  factory VolumeCacheParameters.fromMap(Map<String, dynamic> map) {
    return VolumeCacheParameters(
      cacheConfig: map['cacheConfig'] == null ? null : VolumeCacheParametersCacheConfig.fromMap((map['cacheConfig'] as Map).cast<String, dynamic>()),
      cacheState: map['cacheState'] == null ? null : map['cacheState'] as String,
      command: map['command'] == null ? null : map['command'] as String,
      enableGlobalFileLock: map['enableGlobalFileLock'] == null ? null : map['enableGlobalFileLock'] as bool,
      ...
      peerIpAddresses: map['peerIpAddresses'] == null ? null : (map['peerIpAddresses'] as List).cast<String>(),
      ...
      peeringCommandExpiryTime: map['peeringCommandExpiryTime'] == null ? null : map['peeringCommandExpiryTime'] as String,
      stateDetails: map['stateDetails'] == null ? null : map['stateDetails'] as String,
    );
  }
}
