...
class Volume extends pulumi.CustomResource {
  ...
  Volume(
    ...
    this.blockDevices = registerOutput<List<VolumeBlockDevice>?>('blockDevices');
    this.cacheParameters = registerOutput<VolumeCacheParameters?>('cacheParameters');
    ...
    this.hybridReplicationParameters = registerOutput<VolumeHybridReplicationParameters?>('hybridReplicationParameters');
    ...
    this.restoreParameters = registerOutput<VolumeRestoreParameters?>('restoreParameters');
    ...
    this.snapshotPolicy = registerOutput<VolumeSnapshotPolicy?>('snapshotPolicy');
