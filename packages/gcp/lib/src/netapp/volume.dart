...
class Volume extends pulumi.CustomResource {
  ...
  Volume(String name, {VolumeArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.blockDevices = registerOutput<List<VolumeBlockDevice>?>(
      'blockDevices',
    );
    this.cacheParameters = registerOutput<VolumeCacheParameters?>(
      'cacheParameters',
    );
    ...
    this.restoreParameters = registerOutput<VolumeRestoreParameters?>(
      'restoreParameters',
    );
    ...
    this.snapshotPolicy = registerOutput<VolumeSnapshotPolicy?>(
      'snapshotPolicy',
    );
