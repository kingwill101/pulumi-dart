...
class StoragePoolArgs {
  ...
  StoragePoolArgs({
    ...
    String? zone,
        ...
        customPerformanceEnabled =
            pulumi.Input.asOptionalInput<bool>(customPerformanceEnabled),
        description = pulumi.Input.asOptionalInput<String>(description),
        enableHotTierAutoResize =
            pulumi.Input.asOptionalInput<bool>(enableHotTierAutoResize),
        ...
        totalThroughputMibps =
            pulumi.Input.asOptionalInput<String>(totalThroughputMibps),
  ...
  factory StoragePoolArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolArgs(
      ...
      ldapEnabled:
          map['ldapEnabled'] == null ? null : map['ldapEnabled'] as bool,
      ...
      replicaZone:
          map['replicaZone'] == null ? null : map['replicaZone'] as String,
