...
class StoragePoolArgs {
  ...
  StoragePoolArgs({
    ...
    String? zone,
       ...
       customPerformanceEnabled = pulumi.Input.asOptionalInput<bool>(
         customPerformanceEnabled,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       enableHotTierAutoResize = pulumi.Input.asOptionalInput<bool>(
       ...
       totalThroughputMibps = pulumi.Input.asOptionalInput<String>(
  ...
  factory StoragePoolArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolArgs(
      activeDirectory: map['activeDirectory'] == null
          ? null
          : map['activeDirectory'] as String,
      allowAutoTiering: map['allowAutoTiering'] == null
          ? null
          : map['allowAutoTiering'] as bool,
      capacityGib: map['capacityGib'] as String,
      customPerformanceEnabled: map['customPerformanceEnabled'] == null
          ? null
          : map['customPerformanceEnabled'] as bool,
      description: map['description'] == null
          ? null
          : map['description'] as String,
      enableHotTierAutoResize: map['enableHotTierAutoResize'] == null
          ? null
          : map['enableHotTierAutoResize'] as bool,
      hotTierSizeGib: map['hotTierSizeGib'] == null
          ? null
          : map['hotTierSizeGib'] as String,
      kmsConfig: map['kmsConfig'] == null ? null : map['kmsConfig'] as String,
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      ldapEnabled: map['ldapEnabled'] == null
          ? null
          : map['ldapEnabled'] as bool,
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      qosType: map['qosType'] == null ? null : map['qosType'] as String,
      replicaZone: map['replicaZone'] == null
          ? null
          : map['replicaZone'] as String,
      serviceLevel: map['serviceLevel'] as String,
      totalIops: map['totalIops'] == null ? null : map['totalIops'] as String,
      totalThroughputMibps: map['totalThroughputMibps'] == null
          ? null
          : map['totalThroughputMibps'] as String,
