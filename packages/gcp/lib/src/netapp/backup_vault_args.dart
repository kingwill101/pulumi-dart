...
class BackupVaultArgs {
  ...
  factory BackupVaultArgs.fromMap(Map<String, dynamic> map) {
    return BackupVaultArgs(
      backupRegion: map['backupRegion'] == null ? null : map['backupRegion'] as String,
      backupRetentionPolicy: map['backupRetentionPolicy'] == null ? null : BackupVaultBackupRetentionPolicy.fromMap((map['backupRetentionPolicy'] as Map).cast<String, dynamic>()),
      backupVaultType: map['backupVaultType'] == null ? null : map['backupVaultType'] as String,
