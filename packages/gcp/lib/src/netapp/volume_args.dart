...
class VolumeArgs {
  ...
  VolumeArgs({
    ...
    String? unixPermissions,
  }) : backupConfig = pulumi.Input.asOptionalInput<VolumeBackupConfig>(
         backupConfig,
       ),
       ...
       exportPolicy = pulumi.Input.asOptionalInput<VolumeExportPolicy>(
         exportPolicy,
       ),
       hybridReplicationParameters =
       ...
       multipleEndpoints = pulumi.Input.asOptionalInput<bool>(
         multipleEndpoints,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       project = pulumi.Input.asOptionalInput<String>(project),
       protocols = pulumi.Input.asInput<List<String>>(protocols),
       restoreParameters = pulumi
           .Input.asOptionalInput<VolumeRestoreParameters>(restoreParameters),
       restrictedActions = pulumi.Input.asOptionalInput<List<String>>(
         restrictedActions,
       ),
       ...
       snapshotDirectory = pulumi.Input.asOptionalInput<bool>(
         snapshotDirectory,
       ),
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      ...
      largeCapacity: map['largeCapacity'] == null
          ? null
          : map['largeCapacity'] as bool,
      ...
      securityStyle: map['securityStyle'] == null
          ? null
          : map['securityStyle'] as String,
