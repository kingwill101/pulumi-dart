...
class VolumeArgs {
  ...
  VolumeArgs({
    ...
    List<VolumeBlockDevice>? blockDevices,
    VolumeCacheParameters? cacheParameters,
    required String capacityGib,
    String? deletionPolicy,
    String? description,
    VolumeExportPolicy? exportPolicy,
    VolumeHybridReplicationParameters? hybridReplicationParameters,
    ...
    VolumeRestoreParameters? restoreParameters,
    List<String>? restrictedActions,
    String? securityStyle,
    String? shareName,
    List<String>? smbSettings,
    bool? snapshotDirectory,
    VolumeSnapshotPolicy? snapshotPolicy,
    required String storagePool,
    double? throughputMibps,
    VolumeTieringPolicy? tieringPolicy,
    String? unixPermissions,
  })  : backupConfig =
            pulumi.Input.asOptionalInput<VolumeBackupConfig>(backupConfig),
        blockDevices =
            pulumi.Input.asOptionalInput<List<VolumeBlockDevice>>(blockDevices),
        ...
        exportPolicy =
            pulumi.Input.asOptionalInput<VolumeExportPolicy>(exportPolicy),
        hybridReplicationParameters =
        ...
        multipleEndpoints =
            pulumi.Input.asOptionalInput<bool>(multipleEndpoints),
        name = pulumi.Input.asOptionalInput<String>(name),
        project = pulumi.Input.asOptionalInput<String>(project),
        protocols = pulumi.Input.asInput<List<String>>(protocols),
        restoreParameters =
            pulumi.Input.asOptionalInput<VolumeRestoreParameters>(
                restoreParameters),
        restrictedActions =
            pulumi.Input.asOptionalInput<List<String>>(restrictedActions),
        ...
        snapshotDirectory =
            pulumi.Input.asOptionalInput<bool>(snapshotDirectory),
        snapshotPolicy =
            pulumi.Input.asOptionalInput<VolumeSnapshotPolicy>(snapshotPolicy),
        storagePool = pulumi.Input.asInput<String>(storagePool),
        throughputMibps = pulumi.Input.asOptionalInput<double>(throughputMibps),
        tieringPolicy =
            pulumi.Input.asOptionalInput<VolumeTieringPolicy>(tieringPolicy),
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      ...
      blockDevices: map['blockDevices'] == null
          ? null
          : pulumi.Input.decodeList<VolumeBlockDevice>(
              map['blockDevices'],
              (value) => VolumeBlockDevice.fromMap(
                  (value as Map).cast<String, dynamic>())),
      cacheParameters: map['cacheParameters'] == null
          ? null
          : VolumeCacheParameters.fromMap(
              (map['cacheParameters'] as Map).cast<String, dynamic>()),
      ...
      exportPolicy: map['exportPolicy'] == null
          ? null
          : VolumeExportPolicy.fromMap(
              (map['exportPolicy'] as Map).cast<String, dynamic>()),
      hybridReplicationParameters: map['hybridReplicationParameters'] == null
          ? null
          : VolumeHybridReplicationParameters.fromMap(
              (map['hybridReplicationParameters'] as Map)
                  .cast<String, dynamic>()),
      kerberosEnabled: map['kerberosEnabled'] == null
          ? null
          : map['kerberosEnabled'] as bool,
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      largeCapacity:
          map['largeCapacity'] == null ? null : map['largeCapacity'] as bool,
      location: map['location'] as String,
      multipleEndpoints: map['multipleEndpoints'] == null
          ? null
          : map['multipleEndpoints'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      protocols: (map['protocols'] as List).cast<String>(),
      restoreParameters: map['restoreParameters'] == null
          ? null
          : VolumeRestoreParameters.fromMap(
              (map['restoreParameters'] as Map).cast<String, dynamic>()),
      restrictedActions: map['restrictedActions'] == null
          ? null
          : (map['restrictedActions'] as List).cast<String>(),
      securityStyle:
          map['securityStyle'] == null ? null : map['securityStyle'] as String,
      shareName: map['shareName'] == null ? null : map['shareName'] as String,
      smbSettings: map['smbSettings'] == null
          ? null
          : (map['smbSettings'] as List).cast<String>(),
      snapshotDirectory: map['snapshotDirectory'] == null
          ? null
          : map['snapshotDirectory'] as bool,
      snapshotPolicy: map['snapshotPolicy'] == null
          ? null
          : VolumeSnapshotPolicy.fromMap(
              (map['snapshotPolicy'] as Map).cast<String, dynamic>()),
      storagePool: map['storagePool'] as String,
      throughputMibps: map['throughputMibps'] == null
          ? null
          : map['throughputMibps'] as double,
      tieringPolicy: map['tieringPolicy'] == null
          ? null
          : VolumeTieringPolicy.fromMap(
              (map['tieringPolicy'] as Map).cast<String, dynamic>()),
      unixPermissions: map['unixPermissions'] == null
          ? null
          : map['unixPermissions'] as String,
    );
  }
}
