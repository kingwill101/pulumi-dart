...
class ActiveDirectoryArgs {
  ...
  ActiveDirectoryArgs({
    ...
    required String username,
  }) : administrators = pulumi.Input.asOptionalInput<List<String>>(
         administrators,
       ),
       aesEncryption = pulumi.Input.asOptionalInput<bool>(aesEncryption),
       backupOperators = pulumi.Input.asOptionalInput<List<String>>(
         backupOperators,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       dns = pulumi.Input.asInput<String>(dns),
       domain = pulumi.Input.asInput<String>(domain),
       encryptDcConnections = pulumi.Input.asOptionalInput<bool>(
       ...
       organizationalUnit = pulumi.Input.asOptionalInput<String>(
         organizationalUnit,
       ),
       password = pulumi.Input.asInput<String>(password),
       project = pulumi.Input.asOptionalInput<String>(project),
       securityOperators = pulumi.Input.asOptionalInput<List<String>>(
         securityOperators,
       ),
  ...
  factory ActiveDirectoryArgs.fromMap(Map<String, dynamic> map) {
    return ActiveDirectoryArgs(
      ...
      aesEncryption: map['aesEncryption'] == null
          ? null
          : map['aesEncryption'] as bool,
      backupOperators: map['backupOperators'] == null
          ? null
          : (map['backupOperators'] as List).cast<String>(),
      description: map['description'] == null
          ? null
          : map['description'] as String,
      dns: map['dns'] as String,
      domain: map['domain'] as String,
      encryptDcConnections: map['encryptDcConnections'] == null
          ? null
          : map['encryptDcConnections'] as bool,
      kdcHostname: map['kdcHostname'] == null
          ? null
          : map['kdcHostname'] as String,
      kdcIp: map['kdcIp'] == null ? null : map['kdcIp'] as String,
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      ldapSigning: map['ldapSigning'] == null
          ? null
          : map['ldapSigning'] as bool,
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      netBiosPrefix: map['netBiosPrefix'] as String,
      nfsUsersWithLdap: map['nfsUsersWithLdap'] == null
          ? null
          : map['nfsUsersWithLdap'] as bool,
      organizationalUnit: map['organizationalUnit'] == null
          ? null
          : map['organizationalUnit'] as String,
      password: map['password'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      securityOperators: map['securityOperators'] == null
          ? null
          : (map['securityOperators'] as List).cast<String>(),
