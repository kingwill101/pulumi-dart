...
class ActiveDirectoryArgs {
  ...
  ActiveDirectoryArgs({
    ...
    required String username,
            ...
            pulumi.Input.asOptionalInput<List<String>>(administrators),
        aesEncryption = pulumi.Input.asOptionalInput<bool>(aesEncryption),
        backupOperators =
            pulumi.Input.asOptionalInput<List<String>>(backupOperators),
        description = pulumi.Input.asOptionalInput<String>(description),
        dns = pulumi.Input.asInput<String>(dns),
        domain = pulumi.Input.asInput<String>(domain),
        encryptDcConnections =
            pulumi.Input.asOptionalInput<bool>(encryptDcConnections),
        ...
        organizationalUnit =
            pulumi.Input.asOptionalInput<String>(organizationalUnit),
        password = pulumi.Input.asInput<String>(password),
        project = pulumi.Input.asOptionalInput<String>(project),
        securityOperators =
            pulumi.Input.asOptionalInput<List<String>>(securityOperators),
  ...
  factory ActiveDirectoryArgs.fromMap(Map<String, dynamic> map) {
    return ActiveDirectoryArgs(
      ...
      aesEncryption:
          map['aesEncryption'] == null ? null : map['aesEncryption'] as bool,
      ...
      kdcHostname:
          map['kdcHostname'] == null ? null : map['kdcHostname'] as String,
      kdcIp: map['kdcIp'] == null ? null : map['kdcIp'] as String,
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      ldapSigning:
          map['ldapSigning'] == null ? null : map['ldapSigning'] as bool,
