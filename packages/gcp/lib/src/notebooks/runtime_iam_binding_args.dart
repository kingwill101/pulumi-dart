...
/// {@template pulumi_notebooks_runtime_iam_binding_runtime_iam_binding_args_doc}
/// The set of arguments for RuntimeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_notebooks_runtime_iam_binding_runtime_iam_binding_args_doc}
class RuntimeIamBindingArgs {
  ...
  RuntimeIamBindingArgs({
    RuntimeIamBindingCondition? condition,
    String? location,
  ...
  factory RuntimeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeIamBindingArgs(
      condition: map['condition'] == null ? null : RuntimeIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
