...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      acceleratorConfig: map['acceleratorConfig'] == null ? null : InstanceAcceleratorConfig.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>()),
      ...
      containerImage: map['containerImage'] == null ? null : InstanceContainerImage.fromMap((map['containerImage'] as Map).cast<String, dynamic>()),
      ...
      vmImage: map['vmImage'] == null ? null : InstanceVmImage.fromMap((map['vmImage'] as Map).cast<String, dynamic>()),
    );
  }
}
