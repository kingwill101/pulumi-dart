...
import 'runtime_iam_member_args.dart';
...
class RuntimeIamMember extends pulumi.CustomResource {
  late final pulumi.Output<RuntimeIamMemberCondition?> condition;
  ...
  /// Creates a new [RuntimeIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RuntimeIamMember]. {@macro pulumi_notebooks_runtime_iam_member_runtime_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RuntimeIamMember(
    String name, {
    RuntimeIamMemberArgs? args,
    ...
    this.condition = registerOutput<RuntimeIamMemberCondition?>('condition');
