...
class EnvironmentArgs {
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      containerImage: map['containerImage'] == null ? null : EnvironmentContainerImage.fromMap((map['containerImage'] as Map).cast<String, dynamic>()),
      ...
      vmImage: map['vmImage'] == null ? null : EnvironmentVmImage.fromMap((map['vmImage'] as Map).cast<String, dynamic>()),
    );
  }
}
