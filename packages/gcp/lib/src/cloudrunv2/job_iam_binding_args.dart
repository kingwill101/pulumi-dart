...
import 'job_iam_binding_condition.dart';

/// {@template pulumi_cloudrunv2_job_iam_binding_job_iam_binding_args_doc}
/// The set of arguments for JobIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudrunv2_job_iam_binding_job_iam_binding_args_doc}
class JobIamBindingArgs {
  ...
  factory JobIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return JobIamBindingArgs(
      condition: map['condition'] == null ? null : JobIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
