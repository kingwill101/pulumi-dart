...
class ServiceTemplateContainerStartupProbe {
  ...
  factory ServiceTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateContainerStartupProbe(
      ...
      grpc: map['grpc'] == null ? null : ServiceTemplateContainerStartupProbeGrpc.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: map['httpGet'] == null ? null : ServiceTemplateContainerStartupProbeHttpGet.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : ServiceTemplateContainerStartupProbeTcpSocket.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
