...
class GetJobTemplateTemplateContainer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'envs': pulumi.Input.encodeList<GetJobTemplateTemplateContainerEnv, Map<String, dynamic>>(envs, (value) => value.toMap()),
      'image': image,
      'name': name,
      'ports': pulumi.Input.encodeList<GetJobTemplateTemplateContainerPort, Map<String, dynamic>>(ports, (value) => value.toMap()),
      'resources': pulumi.Input.encodeList<GetJobTemplateTemplateContainerResource, Map<String, dynamic>>(resources, (value) => value.toMap()),
      'startupProbes': pulumi.Input.encodeList<GetJobTemplateTemplateContainerStartupProbe, Map<String, dynamic>>(startupProbes, (value) => value.toMap()),
      'volumeMounts': pulumi.Input.encodeList<GetJobTemplateTemplateContainerVolumeMount, Map<String, dynamic>>(volumeMounts, (value) => value.toMap()),
  ...
  factory GetJobTemplateTemplateContainer.fromMap(Map<String, dynamic> map) {
    return GetJobTemplateTemplateContainer(
      ...
      envs: pulumi.Input.decodeList<GetJobTemplateTemplateContainerEnv>(map['envs'], (value) => GetJobTemplateTemplateContainerEnv.fromMap((value as Map).cast<String, dynamic>())),
      image: map['image'] as String,
      name: map['name'] as String,
      ports: pulumi.Input.decodeList<GetJobTemplateTemplateContainerPort>(map['ports'], (value) => GetJobTemplateTemplateContainerPort.fromMap((value as Map).cast<String, dynamic>())),
      resources: pulumi.Input.decodeList<GetJobTemplateTemplateContainerResource>(map['resources'], (value) => GetJobTemplateTemplateContainerResource.fromMap((value as Map).cast<String, dynamic>())),
      startupProbes: pulumi.Input.decodeList<GetJobTemplateTemplateContainerStartupProbe>(map['startupProbes'], (value) => GetJobTemplateTemplateContainerStartupProbe.fromMap((value as Map).cast<String, dynamic>())),
      volumeMounts: pulumi.Input.decodeList<GetJobTemplateTemplateContainerVolumeMount>(map['volumeMounts'], (value) => GetJobTemplateTemplateContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>())),
