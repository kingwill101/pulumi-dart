...
class GetJobTemplateTemplateVolumeSecret {
  ...
  final List<GetJobTemplateTemplateVolumeSecretItem> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<GetJobTemplateTemplateVolumeSecretItem, Map<String, dynamic>>(items, (value) => value.toMap()),
      'secret': secret,
    };
  }
  ...
  factory GetJobTemplateTemplateVolumeSecret.fromMap(Map<String, dynamic> map) {
    return GetJobTemplateTemplateVolumeSecret(
      ...
      items: pulumi.Input.decodeList<GetJobTemplateTemplateVolumeSecretItem>(map['items'], (value) => GetJobTemplateTemplateVolumeSecretItem.fromMap((value as Map).cast<String, dynamic>())),
