...
import 'worker_pool_iam_member_args.dart';
...
class WorkerPoolIamMember extends pulumi.CustomResource {
  late final pulumi.Output<WorkerPoolIamMemberCondition?> condition;
  ...
  /// Creates a new [WorkerPoolIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkerPoolIamMember]. {@macro pulumi_cloudrunv2_worker_pool_iam_member_worker_pool_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkerPoolIamMember(
    String name, {
    WorkerPoolIamMemberArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
         'gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember',
         name,
         pulumi.Input.mapToInputs(args?.toMap() ?? const {}),
         options ?? pulumi.CustomResourceOptions(),
       ) {
    this.condition = registerOutput<WorkerPoolIamMemberCondition?>('condition');
