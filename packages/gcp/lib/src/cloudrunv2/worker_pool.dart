...
class WorkerPool extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<WorkerPoolInstanceSplitStatus>>
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<WorkerPoolTerminalCondition>>
  terminalConditions;
  ...
  WorkerPool(
    ...
    this.binaryAuthorization = registerOutput<WorkerPoolBinaryAuthorization?>(
      'binaryAuthorization',
    );
    ...
    this.instanceSplits = registerOutput<List<WorkerPoolInstanceSplit>>(
      'instanceSplits',
    );
    ...
    this.terminalConditions = registerOutput<List<WorkerPoolTerminalCondition>>(
      'terminalConditions',
    );
