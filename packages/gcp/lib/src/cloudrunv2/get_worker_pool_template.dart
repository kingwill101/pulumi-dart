...
class GetWorkerPoolTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': pulumi.Input.encodeList<GetWorkerPoolTemplateContainer, Map<String, dynamic>>(containers, (value) => value.toMap()),
      ...
      'labels': labels,
      'nodeSelectors': pulumi.Input.encodeList<GetWorkerPoolTemplateNodeSelector, Map<String, dynamic>>(nodeSelectors, (value) => value.toMap()),
      'revision': revision,
      'serviceAccount': serviceAccount,
      'volumes': pulumi.Input.encodeList<GetWorkerPoolTemplateVolume, Map<String, dynamic>>(volumes, (value) => value.toMap()),
      'vpcAccesses': pulumi.Input.encodeList<GetWorkerPoolTemplateVpcAccess, Map<String, dynamic>>(vpcAccesses, (value) => value.toMap()),
    };
  }
  ...
  factory GetWorkerPoolTemplate.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplate(
      ...
      containers: pulumi.Input.decodeList<GetWorkerPoolTemplateContainer>(map['containers'], (value) => GetWorkerPoolTemplateContainer.fromMap((value as Map).cast<String, dynamic>())),
      encryptionKey: map['encryptionKey'] as String,
      encryptionKeyRevocationAction: map['encryptionKeyRevocationAction'] as String,
      encryptionKeyShutdownDuration: map['encryptionKeyShutdownDuration'] as String,
      gpuZonalRedundancyDisabled: map['gpuZonalRedundancyDisabled'] as bool,
      labels: (map['labels'] as Map).cast<String, String>(),
      nodeSelectors: pulumi.Input.decodeList<GetWorkerPoolTemplateNodeSelector>(map['nodeSelectors'], (value) => GetWorkerPoolTemplateNodeSelector.fromMap((value as Map).cast<String, dynamic>())),
      revision: map['revision'] as String,
      serviceAccount: map['serviceAccount'] as String,
      volumes: pulumi.Input.decodeList<GetWorkerPoolTemplateVolume>(map['volumes'], (value) => GetWorkerPoolTemplateVolume.fromMap((value as Map).cast<String, dynamic>())),
      vpcAccesses: pulumi.Input.decodeList<GetWorkerPoolTemplateVpcAccess>(map['vpcAccesses'], (value) => GetWorkerPoolTemplateVpcAccess.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
