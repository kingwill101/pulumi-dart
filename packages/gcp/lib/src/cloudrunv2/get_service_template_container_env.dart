...
class GetServiceTemplateContainerEnv {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': name,
      'value': value,
      'valueSources': pulumi.Input.encodeList<GetServiceTemplateContainerEnvValueSource, Map<String, dynamic>>(valueSources, (value) => value.toMap()),
    };
  }
  ...
  factory GetServiceTemplateContainerEnv.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateContainerEnv(
      ...
      valueSources: pulumi.Input.decodeList<GetServiceTemplateContainerEnvValueSource>(map['valueSources'], (value) => GetServiceTemplateContainerEnvValueSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
