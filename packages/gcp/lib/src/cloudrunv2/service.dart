...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    this.binaryAuthorization = registerOutput<ServiceBinaryAuthorization?>('binaryAuthorization');
    ...
    this.multiRegionSettings = registerOutput<ServiceMultiRegionSettings?>('multiRegionSettings');
    ...
    this.terminalConditions = registerOutput<List<ServiceTerminalCondition>>('terminalConditions');
    this.trafficStatuses = registerOutput<List<ServiceTrafficStatus>>('trafficStatuses');
