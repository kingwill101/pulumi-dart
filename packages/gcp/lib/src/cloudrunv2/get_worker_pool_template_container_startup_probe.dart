...
class GetWorkerPoolTemplateContainerStartupProbe {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'grpcs': pulumi.Input.encodeList<GetWorkerPoolTemplateContainerStartupProbeGrpc, Map<String, dynamic>>(grpcs, (value) => value.toMap()),
      'httpGets': pulumi.Input.encodeList<GetWorkerPoolTemplateContainerStartupProbeHttpGet, Map<String, dynamic>>(httpGets, (value) => value.toMap()),
      'initialDelaySeconds': initialDelaySeconds,
      'periodSeconds': periodSeconds,
      'tcpSockets': pulumi.Input.encodeList<GetWorkerPoolTemplateContainerStartupProbeTcpSocket, Map<String, dynamic>>(tcpSockets, (value) => value.toMap()),
  ...
  factory GetWorkerPoolTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplateContainerStartupProbe(
      ...
      grpcs: pulumi.Input.decodeList<GetWorkerPoolTemplateContainerStartupProbeGrpc>(map['grpcs'], (value) => GetWorkerPoolTemplateContainerStartupProbeGrpc.fromMap((value as Map).cast<String, dynamic>())),
      httpGets: pulumi.Input.decodeList<GetWorkerPoolTemplateContainerStartupProbeHttpGet>(map['httpGets'], (value) => GetWorkerPoolTemplateContainerStartupProbeHttpGet.fromMap((value as Map).cast<String, dynamic>())),
      initialDelaySeconds: map['initialDelaySeconds'] as int,
      periodSeconds: map['periodSeconds'] as int,
      tcpSockets: pulumi.Input.decodeList<GetWorkerPoolTemplateContainerStartupProbeTcpSocket>(map['tcpSockets'], (value) => GetWorkerPoolTemplateContainerStartupProbeTcpSocket.fromMap((value as Map).cast<String, dynamic>())),
