...
class JobTemplateTemplateContainerStartupProbe {
  ...
  factory JobTemplateTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return JobTemplateTemplateContainerStartupProbe(
      ...
      grpc: map['grpc'] == null ? null : JobTemplateTemplateContainerStartupProbeGrpc.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: map['httpGet'] == null ? null : JobTemplateTemplateContainerStartupProbeHttpGet.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : JobTemplateTemplateContainerStartupProbeTcpSocket.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
