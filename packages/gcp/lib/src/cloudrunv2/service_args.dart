...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      binaryAuthorization: map['binaryAuthorization'] == null ? null : ServiceBinaryAuthorization.fromMap((map['binaryAuthorization'] as Map).cast<String, dynamic>()),
      buildConfig: map['buildConfig'] == null ? null : ServiceBuildConfig.fromMap((map['buildConfig'] as Map).cast<String, dynamic>()),
      ...
      defaultUriDisabled: map['defaultUriDisabled'] == null ? null : map['defaultUriDisabled'] as bool,
      ...
      invokerIamDisabled: map['invokerIamDisabled'] == null ? null : map['invokerIamDisabled'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      launchStage: map['launchStage'] == null ? null : map['launchStage'] as String,
      location: map['location'] as String,
      multiRegionSettings: map['multiRegionSettings'] == null ? null : ServiceMultiRegionSettings.fromMap((map['multiRegionSettings'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      scaling: map['scaling'] == null ? null : ServiceScaling.fromMap((map['scaling'] as Map).cast<String, dynamic>()),
      template: ServiceTemplate.fromMap((map['template'] as Map).cast<String, dynamic>()),
