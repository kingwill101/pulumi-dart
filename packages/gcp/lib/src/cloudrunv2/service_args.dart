...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    List<ServiceTraffic>? traffics,
       ...
       buildConfig = pulumi.Input.asOptionalInput<ServiceBuildConfig>(
         buildConfig,
       ),
       ...
       defaultUriDisabled = pulumi.Input.asOptionalInput<bool>(
         defaultUriDisabled,
       ),
       ...
       invokerIamDisabled = pulumi.Input.asOptionalInput<bool>(
         invokerIamDisabled,
       ),
