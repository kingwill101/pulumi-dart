...
class WorkerPoolArgs {
  ...
  WorkerPoolArgs({
    ...
    WorkerPoolBinaryAuthorization? binaryAuthorization,
    String? client,
    String? clientVersion,
    List<String>? customAudiences,
    bool? deletionProtection,
    String? description,
    List<WorkerPoolInstanceSplit>? instanceSplits,
    Map<String, String>? labels,
    String? launchStage,
    required String location,
    String? name,
    String? project,
    WorkerPoolScaling? scaling,
    required WorkerPoolTemplate template,
  }) :
  ...
  factory WorkerPoolArgs.fromMap(Map<String, dynamic> map) {
    return WorkerPoolArgs(
      ...
      binaryAuthorization: map['binaryAuthorization'] == null ? null : WorkerPoolBinaryAuthorization.fromMap((map['binaryAuthorization'] as Map).cast<String, dynamic>()),
      ...
      instanceSplits: map['instanceSplits'] == null ? null : pulumi.Input.decodeList<WorkerPoolInstanceSplit>(map['instanceSplits'], (value) => WorkerPoolInstanceSplit.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      launchStage: map['launchStage'] == null ? null : map['launchStage'] as String,
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      scaling: map['scaling'] == null ? null : WorkerPoolScaling.fromMap((map['scaling'] as Map).cast<String, dynamic>()),
      template: WorkerPoolTemplate.fromMap((map['template'] as Map).cast<String, dynamic>()),
    );
  }
}
