...
class JobTemplateTemplateContainerStartupProbeHttpGet {
  ...
  final List<JobTemplateTemplateContainerStartupProbeHttpGetHttpHeader>? httpHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpHeaders': ?httpHeaders == null ? null : pulumi.Input.encodeList<JobTemplateTemplateContainerStartupProbeHttpGetHttpHeader, Map<String, dynamic>>(httpHeaders!, (value) => value.toMap()),
      'path': ?path,
      'port': ?port,
    };
  }
  ...
  factory JobTemplateTemplateContainerStartupProbeHttpGet.fromMap(Map<String, dynamic> map) {
    return JobTemplateTemplateContainerStartupProbeHttpGet(
      httpHeaders: map['httpHeaders'] == null ? null : pulumi.Input.decodeList<JobTemplateTemplateContainerStartupProbeHttpGetHttpHeader>(map['httpHeaders'], (value) => JobTemplateTemplateContainerStartupProbeHttpGetHttpHeader.fromMap((value as Map).cast<String, dynamic>())),
