...
class JobArgs {
  ...
  JobArgs({
    ...
    required JobTemplate template,
        ...
        binaryAuthorization =
            pulumi.Input.asOptionalInput<JobBinaryAuthorization>(
                binaryAuthorization),
        ...
        runExecutionToken =
            pulumi.Input.asOptionalInput<String>(runExecutionToken),
        startExecutionToken =
            pulumi.Input.asOptionalInput<String>(startExecutionToken),
