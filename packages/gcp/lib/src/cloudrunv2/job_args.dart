...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      binaryAuthorization: map['binaryAuthorization'] == null ? null : JobBinaryAuthorization.fromMap((map['binaryAuthorization'] as Map).cast<String, dynamic>()),
      ...
      runExecutionToken: map['runExecutionToken'] == null ? null : map['runExecutionToken'] as String,
      startExecutionToken: map['startExecutionToken'] == null ? null : map['startExecutionToken'] as String,
