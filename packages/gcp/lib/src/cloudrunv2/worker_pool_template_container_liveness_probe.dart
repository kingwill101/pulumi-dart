...
class WorkerPoolTemplateContainerLivenessProbe {
  ...
  factory WorkerPoolTemplateContainerLivenessProbe.fromMap(Map<String, dynamic> map) {
    return WorkerPoolTemplateContainerLivenessProbe(
      ...
      grpc: map['grpc'] == null ? null : WorkerPoolTemplateContainerLivenessProbeGrpc.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: map['httpGet'] == null ? null : WorkerPoolTemplateContainerLivenessProbeHttpGet.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : WorkerPoolTemplateContainerLivenessProbeTcpSocket.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
