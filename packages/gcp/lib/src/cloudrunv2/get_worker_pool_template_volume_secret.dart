...
import 'get_worker_pool_template_volume_secret_item.dart';
...
class GetWorkerPoolTemplateVolumeSecret {
  ...
  /// Creates a new [GetWorkerPoolTemplateVolumeSecret].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<GetWorkerPoolTemplateVolumeSecretItem, Map<String, dynamic>>(items, (value) => value.toMap()),
      'secret': secret,
    };
  }
  ...
  factory GetWorkerPoolTemplateVolumeSecret.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplateVolumeSecret(
      ...
      items: pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeSecretItem>(map['items'], (value) => GetWorkerPoolTemplateVolumeSecretItem.fromMap((value as Map).cast<String, dynamic>())),
