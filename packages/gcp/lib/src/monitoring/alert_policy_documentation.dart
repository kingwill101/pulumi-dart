...
class AlertPolicyDocumentation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'content': ?content,
      'links': ?links == null ? null : pulumi.Input.encodeList<AlertPolicyDocumentationLink, Map<String, dynamic>>(links!, (value) => value.toMap()),
      'mimeType': ?mimeType,
      'subject': ?subject,
    };
  }
  ...
  factory AlertPolicyDocumentation.fromMap(Map<String, dynamic> map) {
    return AlertPolicyDocumentation(
      ...
      links: map['links'] == null ? null : pulumi.Input.decodeList<AlertPolicyDocumentationLink>(map['links'], (value) => AlertPolicyDocumentationLink.fromMap((value as Map).cast<String, dynamic>())),
