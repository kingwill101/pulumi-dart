...
class GenericService extends pulumi.CustomResource {
  ...
  /// Creates a new [GenericService].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GenericService]. {@macro pulumi_monitoring_generic_service_generic_service_args_doc}
  ...
  GenericService(
    ...
    this.basicService = registerOutput<GenericServiceBasicService?>(
      'basicService',
    );
    ...
    this.telemetries = registerOutput<List<GenericServiceTelemetry>>(
      'telemetries',
    );
