...
class UptimeCheckConfigHttpCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceptedResponseStatusCodes': ?acceptedResponseStatusCodes == null
          ? null
      ...
      'serviceAgentAuthentication': ?serviceAgentAuthentication == null
          ? null
          : serviceAgentAuthentication!.toMap(),
      'useSsl': ?useSsl,
  ...
  factory UptimeCheckConfigHttpCheck.fromMap(Map<String, dynamic> map) {
    return UptimeCheckConfigHttpCheck(
      ...
      maskHeaders: map['maskHeaders'] == null
          ? null
          : map['maskHeaders'] as bool,
      ...
      validateSsl: map['validateSsl'] == null
          ? null
          : map['validateSsl'] as bool,
    );
  }
}
