...
class AlertPolicyAlertStrategy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoClose': ?autoClose,
      'notificationChannelStrategies': ?notificationChannelStrategies == null
          ? null
          : pulumi.Input.encodeList<
              AlertPolicyAlertStrategyNotificationChannelStrategy,
              Map<String, dynamic>
            >(notificationChannelStrategies!, (value) => value.toMap()),
  ...
  factory AlertPolicyAlertStrategy.fromMap(Map<String, dynamic> map) {
    return AlertPolicyAlertStrategy(
      ...
      notificationChannelStrategies:
          map['notificationChannelStrategies'] == null
          ? null
      ...
      notificationPrompts: map['notificationPrompts'] == null
          ? null
          : (map['notificationPrompts'] as List).cast<String>(),
