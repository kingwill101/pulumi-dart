...
class UptimeCheckConfigArgs {
  ...
  factory UptimeCheckConfigArgs.fromMap(Map<String, dynamic> map) {
    return UptimeCheckConfigArgs(
      checkerType: map['checkerType'] == null ? null : map['checkerType'] as String,
      contentMatchers: map['contentMatchers'] == null ? null : pulumi.Input.decodeList<UptimeCheckConfigContentMatcher>(map['contentMatchers'], (value) => UptimeCheckConfigContentMatcher.fromMap((value as Map).cast<String, dynamic>())),
      displayName: map['displayName'] as String,
      httpCheck: map['httpCheck'] == null ? null : UptimeCheckConfigHttpCheck.fromMap((map['httpCheck'] as Map).cast<String, dynamic>()),
      logCheckFailures: map['logCheckFailures'] == null ? null : map['logCheckFailures'] as bool,
      monitoredResource: map['monitoredResource'] == null ? null : UptimeCheckConfigMonitoredResource.fromMap((map['monitoredResource'] as Map).cast<String, dynamic>()),
      period: map['period'] == null ? null : map['period'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      resourceGroup: map['resourceGroup'] == null ? null : UptimeCheckConfigResourceGroup.fromMap((map['resourceGroup'] as Map).cast<String, dynamic>()),
      selectedRegions: map['selectedRegions'] == null ? null : (map['selectedRegions'] as List).cast<String>(),
      syntheticMonitor: map['syntheticMonitor'] == null ? null : UptimeCheckConfigSyntheticMonitor.fromMap((map['syntheticMonitor'] as Map).cast<String, dynamic>()),
      tcpCheck: map['tcpCheck'] == null ? null : UptimeCheckConfigTcpCheck.fromMap((map['tcpCheck'] as Map).cast<String, dynamic>()),
