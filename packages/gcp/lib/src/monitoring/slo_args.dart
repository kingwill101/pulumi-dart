...
class SloArgs {
  ...
  factory SloArgs.fromMap(Map<String, dynamic> map) {
    return SloArgs(
      basicSli: map['basicSli'] == null ? null : SloBasicSli.fromMap((map['basicSli'] as Map).cast<String, dynamic>()),
      calendarPeriod: map['calendarPeriod'] == null ? null : map['calendarPeriod'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      goal: map['goal'] as double,
      project: map['project'] == null ? null : map['project'] as String,
      requestBasedSli: map['requestBasedSli'] == null ? null : SloRequestBasedSli.fromMap((map['requestBasedSli'] as Map).cast<String, dynamic>()),
      rollingPeriodDays: map['rollingPeriodDays'] == null ? null : map['rollingPeriodDays'] as int,
      ...
      windowsBasedSli: map['windowsBasedSli'] == null ? null : SloWindowsBasedSli.fromMap((map['windowsBasedSli'] as Map).cast<String, dynamic>()),
    );
  }
}
