...
class SloArgs {
  ...
  SloArgs({
    ...
    SloWindowsBasedSli? windowsBasedSli,
        ...
        requestBasedSli =
            pulumi.Input.asOptionalInput<SloRequestBasedSli>(requestBasedSli),
        rollingPeriodDays =
            pulumi.Input.asOptionalInput<int>(rollingPeriodDays),
        service = pulumi.Input.asInput<String>(service),
        sloId = pulumi.Input.asOptionalInput<String>(sloId),
        userLabels =
            pulumi.Input.asOptionalInput<Map<String, String>>(userLabels),
        windowsBasedSli =
            pulumi.Input.asOptionalInput<SloWindowsBasedSli>(windowsBasedSli);
