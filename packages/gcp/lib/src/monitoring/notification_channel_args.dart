...
class NotificationChannelArgs {
  ...
  NotificationChannelArgs({
    ...
    String? project,
    NotificationChannelSensitiveLabels? sensitiveLabels,
  ...
  factory NotificationChannelArgs.fromMap(Map<String, dynamic> map) {
    return NotificationChannelArgs(
      ...
      sensitiveLabels: map['sensitiveLabels'] == null ? null : NotificationChannelSensitiveLabels.fromMap((map['sensitiveLabels'] as Map).cast<String, dynamic>()),
