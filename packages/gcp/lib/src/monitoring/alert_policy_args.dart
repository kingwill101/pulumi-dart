...
class AlertPolicyArgs {
  ...
  AlertPolicyArgs({
    AlertPolicyAlertStrategy? alertStrategy,
    required String combiner,
    required List<AlertPolicyCondition> conditions,
    required String displayName,
    AlertPolicyDocumentation? documentation,
    bool? enabled,
    ...
    Map<String, String>? userLabels,
       ...
       conditions = pulumi.Input.asInput<List<AlertPolicyCondition>>(
         conditions,
       ),
