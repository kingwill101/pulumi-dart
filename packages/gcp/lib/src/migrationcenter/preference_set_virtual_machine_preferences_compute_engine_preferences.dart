...
class PreferenceSetVirtualMachinePreferencesComputeEnginePreferences {
  ...
  final PreferenceSetVirtualMachinePreferencesComputeEnginePreferencesMachinePreferences? machinePreferences;
  ...
  factory PreferenceSetVirtualMachinePreferencesComputeEnginePreferences.fromMap(Map<String, dynamic> map) {
    return PreferenceSetVirtualMachinePreferencesComputeEnginePreferences(
      ...
      machinePreferences: map['machinePreferences'] == null ? null : PreferenceSetVirtualMachinePreferencesComputeEnginePreferencesMachinePreferences.fromMap((map['machinePreferences'] as Map).cast<String, dynamic>()),
    );
  }
}
