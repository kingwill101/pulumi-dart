...
class JobTemplateConfigElementaryStreamVideoStreamH264 {
  ...
  factory JobTemplateConfigElementaryStreamVideoStreamH264.fromMap(
    ...
    return JobTemplateConfigElementaryStreamVideoStreamH264(
      ...
      entropyCoder: map['entropyCoder'] == null
          ? null
          : map['entropyCoder'] as String,
      frameRate: map['frameRate'] as int,
      gopDuration: map['gopDuration'] == null
          ? null
          : map['gopDuration'] as String,
      heightPixels: map['heightPixels'] == null
          ? null
          : map['heightPixels'] as int,
      hlg: map['hlg'] == null
          ? null
          : (map['hlg'] as Map).cast<String, dynamic>(),
      pixelFormat: map['pixelFormat'] == null
          ? null
          : map['pixelFormat'] as String,
      ...
      vbvFullnessBits: map['vbvFullnessBits'] == null
          ? null
          : map['vbvFullnessBits'] as int,
      vbvSizeBits: map['vbvSizeBits'] == null
          ? null
          : map['vbvSizeBits'] as int,
      widthPixels: map['widthPixels'] == null
          ? null
          : map['widthPixels'] as int,
    );
  }
}
