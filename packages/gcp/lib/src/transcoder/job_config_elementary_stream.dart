...
class JobConfigElementaryStream {
  ...
  factory JobConfigElementaryStream.fromMap(Map<String, dynamic> map) {
    return JobConfigElementaryStream(
      audioStream: map['audioStream'] == null ? null : JobConfigElementaryStreamAudioStream.fromMap((map['audioStream'] as Map).cast<String, dynamic>()),
      key: map['key'] == null ? null : map['key'] as String,
      videoStream: map['videoStream'] == null ? null : JobConfigElementaryStreamVideoStream.fromMap((map['videoStream'] as Map).cast<String, dynamic>()),
    );
  }
}
