...
class PipelineArgs {
  ...
  PipelineArgs({
    ...
    required List<PipelineDestination> destinations,
    String? displayName,
    PipelineInputPayloadFormat? inputPayloadFormat,
    Map<String, String>? labels,
    required String location,
    PipelineLoggingConfig? loggingConfig,
    List<PipelineMediation>? mediations,
    ...
    PipelineRetryPolicy? retryPolicy,
       ...
       destinations = pulumi.Input.asInput<List<PipelineDestination>>(
         destinations,
       ),
       ...
       retryPolicy = pulumi.Input.asOptionalInput<PipelineRetryPolicy>(
         retryPolicy,
       );
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      ...
      destinations: pulumi.Input.decodeList<PipelineDestination>(
        map['destinations'],
        (value) =>
            PipelineDestination.fromMap((value as Map).cast<String, dynamic>()),
      ),
