...
class TriggerArgs {
  ...
  TriggerArgs({
    String? channel,
    required TriggerDestination destination,
    String? eventDataContentType,
    Map<String, String>? labels,
    required String location,
    required List<TriggerMatchingCriteria> matchingCriterias,
    String? name,
    String? project,
    TriggerRetryPolicy? retryPolicy,
  ...
  factory TriggerArgs.fromMap(Map<String, dynamic> map) {
    return TriggerArgs(
      ...
      destination: TriggerDestination.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      eventDataContentType: map['eventDataContentType'] == null ? null : map['eventDataContentType'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      matchingCriterias: pulumi.Input.decodeList<TriggerMatchingCriteria>(map['matchingCriterias'], (value) => TriggerMatchingCriteria.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      retryPolicy: map['retryPolicy'] == null ? null : TriggerRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      transport: map['transport'] == null ? null : TriggerTransport.fromMap((map['transport'] as Map).cast<String, dynamic>()),
    );
  }
}
