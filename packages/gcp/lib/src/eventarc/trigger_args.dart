...
class TriggerArgs {
  ...
  TriggerArgs({
    ...
    TriggerTransport? transport,
       ...
       retryPolicy = pulumi.Input.asOptionalInput<TriggerRetryPolicy>(
         retryPolicy,
       ),
  ...
  factory TriggerArgs.fromMap(Map<String, dynamic> map) {
    return TriggerArgs(
      ...
      destination: TriggerDestination.fromMap(
      ...
      matchingCriterias: pulumi.Input.decodeList<TriggerMatchingCriteria>(
        map['matchingCriterias'],
        (value) => TriggerMatchingCriteria.fromMap(
