...
class SpokeArgs {
  ...
  SpokeArgs({
    String? description,
    SpokeGateway? gateway,
    String? group,
    required String hub,
    Map<String, String>? labels,
    SpokeLinkedInterconnectAttachments? linkedInterconnectAttachments,
    SpokeLinkedProducerVpcNetwork? linkedProducerVpcNetwork,
    SpokeLinkedRouterApplianceInstances? linkedRouterApplianceInstances,
    SpokeLinkedVpcNetwork? linkedVpcNetwork,
    SpokeLinkedVpnTunnels? linkedVpnTunnels,
  ...
  factory SpokeArgs.fromMap(Map<String, dynamic> map) {
    return SpokeArgs(
      ...
      gateway: map['gateway'] == null ? null : SpokeGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>()),
      group: map['group'] == null ? null : map['group'] as String,
      hub: map['hub'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linkedInterconnectAttachments: map['linkedInterconnectAttachments'] == null ? null : SpokeLinkedInterconnectAttachments.fromMap((map['linkedInterconnectAttachments'] as Map).cast<String, dynamic>()),
      linkedProducerVpcNetwork: map['linkedProducerVpcNetwork'] == null ? null : SpokeLinkedProducerVpcNetwork.fromMap((map['linkedProducerVpcNetwork'] as Map).cast<String, dynamic>()),
      linkedRouterApplianceInstances: map['linkedRouterApplianceInstances'] == null ? null : SpokeLinkedRouterApplianceInstances.fromMap((map['linkedRouterApplianceInstances'] as Map).cast<String, dynamic>()),
      linkedVpcNetwork: map['linkedVpcNetwork'] == null ? null : SpokeLinkedVpcNetwork.fromMap((map['linkedVpcNetwork'] as Map).cast<String, dynamic>()),
      linkedVpnTunnels: map['linkedVpnTunnels'] == null ? null : SpokeLinkedVpnTunnels.fromMap((map['linkedVpnTunnels'] as Map).cast<String, dynamic>()),
