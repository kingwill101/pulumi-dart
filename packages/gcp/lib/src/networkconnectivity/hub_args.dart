...
class HubArgs {
  ...
  factory HubArgs.fromMap(Map<String, dynamic> map) {
    return HubArgs(
      ...
      exportPsc: map['exportPsc'] == null ? null : map['exportPsc'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      policyMode: map['policyMode'] == null ? null : map['policyMode'] as String,
      presetTopology: map['presetTopology'] == null ? null : map['presetTopology'] as String,
