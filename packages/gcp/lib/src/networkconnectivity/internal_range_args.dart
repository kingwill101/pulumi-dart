...
class InternalRangeArgs {
  ...
  factory InternalRangeArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeArgs(
      allocationOptions: map['allocationOptions'] == null ? null : InternalRangeAllocationOptions.fromMap((map['allocationOptions'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      excludeCidrRanges: map['excludeCidrRanges'] == null ? null : (map['excludeCidrRanges'] as List).cast<String>(),
      ...
      migration: map['migration'] == null ? null : InternalRangeMigration.fromMap((map['migration'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] as String,
      overlaps: map['overlaps'] == null ? null : (map['overlaps'] as List).cast<String>(),
      peering: map['peering'] as String,
      prefixLength: map['prefixLength'] == null ? null : map['prefixLength'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      targetCidrRanges: map['targetCidrRanges'] == null ? null : (map['targetCidrRanges'] as List).cast<String>(),
