...
class PolicyBasedRouteArgs {
  ...
  factory PolicyBasedRouteArgs.fromMap(Map<String, dynamic> map) {
    return PolicyBasedRouteArgs(
      ...
      filter: PolicyBasedRouteFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      interconnectAttachment: map['interconnectAttachment'] == null ? null : PolicyBasedRouteInterconnectAttachment.fromMap((map['interconnectAttachment'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] as String,
      nextHopIlbIp: map['nextHopIlbIp'] == null ? null : map['nextHopIlbIp'] as String,
      nextHopOtherRoutes: map['nextHopOtherRoutes'] == null ? null : map['nextHopOtherRoutes'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      virtualMachine: map['virtualMachine'] == null ? null : PolicyBasedRouteVirtualMachine.fromMap((map['virtualMachine'] as Map).cast<String, dynamic>()),
    );
  }
}
