...
class DomainTrustArgs {
  ...
  DomainTrustArgs({
    ...
    required List<String> targetDnsIpAddresses,
    required String targetDomainName,
    required String trustDirection,
    required String trustHandshakeSecret,
    required String trustType,
  }) : domain = pulumi.Input.asInput<String>(domain),
       project = pulumi.Input.asOptionalInput<String>(project),
       selectiveAuthentication = pulumi.Input.asOptionalInput<bool>(
         selectiveAuthentication,
       ),
       targetDnsIpAddresses = pulumi.Input.asInput<List<String>>(
       ...
       trustHandshakeSecret = pulumi.Input.asInput<String>(
  ...
  factory DomainTrustArgs.fromMap(Map<String, dynamic> map) {
    return DomainTrustArgs(
      ...
      selectiveAuthentication: map['selectiveAuthentication'] == null
          ? null
