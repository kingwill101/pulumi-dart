  ...
  DomainTrustArgs({
    ...
    required String trustType,
        ...
        selectiveAuthentication =
            pulumi.Input.asOptionalInput<bool>(selectiveAuthentication),
        targetDnsIpAddresses =
            pulumi.Input.asInput<List<String>>(targetDnsIpAddresses),
        ...
        trustHandshakeSecret =
            pulumi.Input.asInput<String>(trustHandshakeSecret),
