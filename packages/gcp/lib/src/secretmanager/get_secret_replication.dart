...
class GetSecretReplication {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autos': pulumi.Input.encodeList<GetSecretReplicationAuto, Map<String, dynamic>>(autos, (value) => value.toMap()),
      'userManageds': pulumi.Input.encodeList<GetSecretReplicationUserManaged, Map<String, dynamic>>(userManageds, (value) => value.toMap()),
    };
  }

  factory GetSecretReplication.fromMap(Map<String, dynamic> map) {
    return GetSecretReplication(
      autos: pulumi.Input.decodeList<GetSecretReplicationAuto>(map['autos'], (value) => GetSecretReplicationAuto.fromMap((value as Map).cast<String, dynamic>())),
      userManageds: pulumi.Input.decodeList<GetSecretReplicationUserManaged>(map['userManageds'], (value) => GetSecretReplicationUserManaged.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
