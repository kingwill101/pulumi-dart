...
class RegionalSecretArgs {
  ...
  RegionalSecretArgs({
    ...
    String? versionDestroyTtl,
        ...
        customerManagedEncryption = pulumi.Input.asOptionalInput<
            RegionalSecretCustomerManagedEncryption>(customerManagedEncryption),
        deletionProtection =
        ...
        rotation =
            pulumi.Input.asOptionalInput<RegionalSecretRotation>(rotation),
        secretId = pulumi.Input.asInput<String>(secretId),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        topics =
            pulumi.Input.asOptionalInput<List<RegionalSecretTopic>>(topics),
        ttl = pulumi.Input.asOptionalInput<String>(ttl),
        versionAliases =
            pulumi.Input.asOptionalInput<Map<String, String>>(versionAliases),
        versionDestroyTtl =
            pulumi.Input.asOptionalInput<String>(versionDestroyTtl);
  ...
  factory RegionalSecretArgs.fromMap(Map<String, dynamic> map) {
    return RegionalSecretArgs(
      ...
      versionDestroyTtl: map['versionDestroyTtl'] == null
          ? null
