...
class RegionalSecretArgs {
  ...
  RegionalSecretArgs({
    ...
    RegionalSecretCustomerManagedEncryption? customerManagedEncryption,
    bool? deletionProtection,
    String? expireTime,
    Map<String, String>? labels,
    required String location,
    String? project,
    RegionalSecretRotation? rotation,
    required String secretId,
    Map<String, String>? tags,
    List<RegionalSecretTopic>? topics,
    String? ttl,
  ...
  factory RegionalSecretArgs.fromMap(Map<String, dynamic> map) {
    return RegionalSecretArgs(
      ...
      customerManagedEncryption: map['customerManagedEncryption'] == null ? null : RegionalSecretCustomerManagedEncryption.fromMap((map['customerManagedEncryption'] as Map).cast<String, dynamic>()),
      ...
      rotation: map['rotation'] == null ? null : RegionalSecretRotation.fromMap((map['rotation'] as Map).cast<String, dynamic>()),
      secretId: map['secretId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      topics: map['topics'] == null ? null : pulumi.Input.decodeList<RegionalSecretTopic>(map['topics'], (value) => RegionalSecretTopic.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versionDestroyTtl: map['versionDestroyTtl'] == null ? null : map['versionDestroyTtl'] as String,
    );
  }
}
