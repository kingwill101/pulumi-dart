...
class SecretArgs {
  ...
  SecretArgs({
    ...
    String? project,
    required SecretReplication replication,
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      replication: SecretReplication.fromMap((map['replication'] as Map).cast<String, dynamic>()),
      rotation: map['rotation'] == null ? null : SecretRotation.fromMap((map['rotation'] as Map).cast<String, dynamic>()),
      secretId: map['secretId'] == null ? null : map['secretId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      topics: map['topics'] == null ? null : pulumi.Input.decodeList<SecretTopic>(map['topics'], (value) => SecretTopic.fromMap((value as Map).cast<String, dynamic>())),
