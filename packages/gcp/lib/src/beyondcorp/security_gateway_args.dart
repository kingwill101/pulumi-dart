...
class SecurityGatewayArgs {
  ...
  factory SecurityGatewayArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayArgs(
      ...
      hubs: map['hubs'] == null ? null : pulumi.Input.decodeList<SecurityGatewayHub>(map['hubs'], (value) => SecurityGatewayHub.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      proxyProtocolConfig: map['proxyProtocolConfig'] == null ? null : SecurityGatewayProxyProtocolConfig.fromMap((map['proxyProtocolConfig'] as Map).cast<String, dynamic>()),
      securityGatewayId: map['securityGatewayId'] as String,
      serviceDiscovery: map['serviceDiscovery'] == null ? null : SecurityGatewayServiceDiscovery.fromMap((map['serviceDiscovery'] as Map).cast<String, dynamic>()),
    );
  }
}
