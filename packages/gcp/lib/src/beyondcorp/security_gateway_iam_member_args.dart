...
class SecurityGatewayIamMemberArgs {
  ...
  SecurityGatewayIamMemberArgs({
    SecurityGatewayIamMemberCondition? condition,
    String? location,
  ...
  factory SecurityGatewayIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayIamMemberArgs(
      condition: map['condition'] == null ? null : SecurityGatewayIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
