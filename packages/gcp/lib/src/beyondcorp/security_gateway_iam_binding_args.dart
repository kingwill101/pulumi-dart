...
import 'security_gateway_iam_binding_condition.dart';

/// {@template pulumi_beyondcorp_security_gateway_iam_binding_security_gateway_iam_binding_args_doc}
/// The set of arguments for SecurityGatewayIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_security_gateway_iam_binding_security_gateway_iam_binding_args_doc}
class SecurityGatewayIamBindingArgs {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  final pulumi.Input<SecurityGatewayIamBindingCondition>? condition;
  ...
  /// Creates a new [SecurityGatewayIamBindingArgs].
  ...
  SecurityGatewayIamBindingArgs({
    SecurityGatewayIamBindingCondition? condition,
    String? location,
    ...
    required String securityGatewayId,
      ...
      condition = pulumi.Input.asOptionalInput<SecurityGatewayIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<SecurityGatewayIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'members': members,
      'project': ?project,
      'role': role,
  ...
  factory SecurityGatewayIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayIamBindingArgs(
      condition: map['condition'] == null ? null : SecurityGatewayIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
