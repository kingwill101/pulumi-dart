...
class SecurityGatewayApplicationIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SecurityGatewayApplicationIamBindingCondition?> condition;
  ...
  /// Creates a new [SecurityGatewayApplicationIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SecurityGatewayApplicationIamBinding]. {@macro pulumi_beyondcorp_security_gateway_application_iam_binding_security_gateway_application_iam_binding_args_doc}
  ...
  SecurityGatewayApplicationIamBinding(
    ...
    this.condition = registerOutput<SecurityGatewayApplicationIamBindingCondition?>('condition');
