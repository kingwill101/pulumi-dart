...
class SecurityGatewayApplicationArgs {
  ...
  factory SecurityGatewayApplicationArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayApplicationArgs(
      ...
      endpointMatchers: map['endpointMatchers'] == null ? null : pulumi.Input.decodeList<SecurityGatewayApplicationEndpointMatcher>(map['endpointMatchers'], (value) => SecurityGatewayApplicationEndpointMatcher.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      schema: map['schema'] == null ? null : map['schema'] as String,
      securityGatewayId: map['securityGatewayId'] as String,
      upstreams: map['upstreams'] == null ? null : pulumi.Input.decodeList<SecurityGatewayApplicationUpstream>(map['upstreams'], (value) => SecurityGatewayApplicationUpstream.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
