...
import 'security_gateway_application_iam_binding_condition.dart';

/// {@template pulumi_beyondcorp_security_gateway_application_iam_binding_security_gateway_application_iam_binding_args_doc}
/// The set of arguments for SecurityGatewayApplicationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_security_gateway_application_iam_binding_security_gateway_application_iam_binding_args_doc}
class SecurityGatewayApplicationIamBindingArgs {
  ...
  /// Creates a new [SecurityGatewayApplicationIamBindingArgs].
  ...
  SecurityGatewayApplicationIamBindingArgs({
    required String applicationId,
    SecurityGatewayApplicationIamBindingCondition? condition,
    ...
    required String securityGatewayId,
      ...
      condition = pulumi.Input.asOptionalInput<SecurityGatewayApplicationIamBindingCondition>(condition),
  ...
  factory SecurityGatewayApplicationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayApplicationIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : SecurityGatewayApplicationIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
