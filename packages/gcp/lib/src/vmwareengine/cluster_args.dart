...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    required String parent,
       ...
       nodeTypeConfigs = pulumi
           .Input.asOptionalInput<List<ClusterNodeTypeConfig>>(nodeTypeConfigs),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      autoscalingSettings: map['autoscalingSettings'] == null
          ? null
          : ClusterAutoscalingSettings.fromMap(
              (map['autoscalingSettings'] as Map).cast<String, dynamic>(),
            ),
      name: map['name'] == null ? null : map['name'] as String,
      nodeTypeConfigs: map['nodeTypeConfigs'] == null
          ? null
          : pulumi.Input.decodeList<ClusterNodeTypeConfig>(
              map['nodeTypeConfigs'],
              (value) => ClusterNodeTypeConfig.fromMap(
