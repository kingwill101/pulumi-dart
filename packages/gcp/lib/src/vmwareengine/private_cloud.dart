...
class PrivateCloud extends pulumi.CustomResource {
  ...
  PrivateCloud(
    ...
    this.managementCluster = registerOutput<PrivateCloudManagementCluster>(
      'managementCluster',
    );
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<PrivateCloudNetworkConfig>(
      'networkConfig',
    );
    this.nsxes = registerOutput<List<PrivateCloudNsx>>('nsxes');
    this.project = registerOutput<String>('project');
    this.sendDeletionDelayHoursIfZero = registerOutput<bool?>(
