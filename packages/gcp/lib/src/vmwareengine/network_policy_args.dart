...
class NetworkPolicyArgs {
  ...
  NetworkPolicyArgs({
    String? description,
    required String edgeServicesCidr,
    NetworkPolicyExternalIp? externalIp,
    NetworkPolicyInternetAccess? internetAccess,
    ...
    required String vmwareEngineNetwork,
        ...
        externalIp =
            pulumi.Input.asOptionalInput<NetworkPolicyExternalIp>(externalIp),
        internetAccess =
            pulumi.Input.asOptionalInput<NetworkPolicyInternetAccess>(
                internetAccess),
