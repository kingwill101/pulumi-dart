...
class ClusterAutoscalingSettingsAutoscalingPolicy {
  ...
  final ClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholds? consumedMemoryThresholds;
  ...
  /// Structure is documented below.
  final ClusterAutoscalingSettingsAutoscalingPolicyStorageThresholds? storageThresholds;
  ...
  factory ClusterAutoscalingSettingsAutoscalingPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterAutoscalingSettingsAutoscalingPolicy(
      ...
      consumedMemoryThresholds: map['consumedMemoryThresholds'] == null ? null : ClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholds.fromMap((map['consumedMemoryThresholds'] as Map).cast<String, dynamic>()),
      cpuThresholds: map['cpuThresholds'] == null ? null : ClusterAutoscalingSettingsAutoscalingPolicyCpuThresholds.fromMap((map['cpuThresholds'] as Map).cast<String, dynamic>()),
      nodeTypeId: map['nodeTypeId'] as String,
      scaleOutSize: map['scaleOutSize'] as int,
      storageThresholds: map['storageThresholds'] == null ? null : ClusterAutoscalingSettingsAutoscalingPolicyStorageThresholds.fromMap((map['storageThresholds'] as Map).cast<String, dynamic>()),
    );
  }
}
