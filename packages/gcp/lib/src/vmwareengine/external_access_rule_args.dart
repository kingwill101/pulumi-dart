...
class ExternalAccessRuleArgs {
  ...
  ExternalAccessRuleArgs({
    ...
    String? description,
    required List<ExternalAccessRuleDestinationIpRange> destinationIpRanges,
    required List<String> destinationPorts,
    required String ipProtocol,
    String? name,
    required String parent,
    required int priority,
    required List<ExternalAccessRuleSourceIpRange> sourceIpRanges,
    required List<String> sourcePorts,
  }) :
  ...
  factory ExternalAccessRuleArgs.fromMap(Map<String, dynamic> map) {
    return ExternalAccessRuleArgs(
      ...
      destinationIpRanges: pulumi.Input.decodeList<ExternalAccessRuleDestinationIpRange>(map['destinationIpRanges'], (value) => ExternalAccessRuleDestinationIpRange.fromMap((value as Map).cast<String, dynamic>())),
      destinationPorts: (map['destinationPorts'] as List).cast<String>(),
      ipProtocol: map['ipProtocol'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parent: map['parent'] as String,
      priority: map['priority'] as int,
      sourceIpRanges: pulumi.Input.decodeList<ExternalAccessRuleSourceIpRange>(map['sourceIpRanges'], (value) => ExternalAccessRuleSourceIpRange.fromMap((value as Map).cast<String, dynamic>())),
