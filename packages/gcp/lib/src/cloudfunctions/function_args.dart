...
class FunctionArgs {
  ...
  FunctionArgs({
    ...
    String? vpcConnectorEgressSettings,
  }) : automaticUpdatePolicy = pulumi
           .Input.asOptionalInput<Map<String, dynamic>>(automaticUpdatePolicy),
       availableMemoryMb = pulumi.Input.asOptionalInput<int>(availableMemoryMb),
       buildEnvironmentVariables =
           pulumi.Input.asOptionalInput<Map<String, String>>(
             buildEnvironmentVariables,
           ),
       buildServiceAccount = pulumi.Input.asOptionalInput<String>(
         buildServiceAccount,
       ),
       ...
       dockerRepository = pulumi.Input.asOptionalInput<String>(
         dockerRepository,
       ),
       ...
       sourceArchiveBucket = pulumi.Input.asOptionalInput<String>(
         sourceArchiveBucket,
       ),
       sourceArchiveObject = pulumi.Input.asOptionalInput<String>(
         sourceArchiveObject,
       ),
       sourceRepository = pulumi
           .Input.asOptionalInput<FunctionSourceRepository>(sourceRepository),
    ...
    return <String, dynamic>{
      ...
      'onDeployUpdatePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(onDeployUpdatePolicy, (value) => value.toMap()),
      'project': ?project,
      'region': ?region,
      'runtime': runtime,
      'secretEnvironmentVariables':
  ...
  factory FunctionArgs.fromMap(Map<String, dynamic> map) {
    return FunctionArgs(
      ...
      triggerHttp: map['triggerHttp'] == null
          ? null
          : map['triggerHttp'] as bool,
