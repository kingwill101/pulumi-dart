...
/// {@template pulumi_cloudfunctions_function_function_args_doc}
...
class FunctionArgs {
  ...
  FunctionArgs({
    Map<String, dynamic>? automaticUpdatePolicy,
    ...
    int? minInstances,
    String? name,
    FunctionOnDeployUpdatePolicy? onDeployUpdatePolicy,
    String? project,
    String? region,
    required String runtime,
    List<FunctionSecretEnvironmentVariable>? secretEnvironmentVariables,
    List<FunctionSecretVolume>? secretVolumes,
    String? serviceAccountEmail,
    String? sourceArchiveBucket,
    String? sourceArchiveObject,
    FunctionSourceRepository? sourceRepository,
    int? timeout,
    bool? triggerHttp,
    String? vpcConnector,
    String? vpcConnectorEgressSettings,
            ...
            pulumi.Input.asOptionalInput<Map<String, dynamic>>(
                automaticUpdatePolicy),
        availableMemoryMb =
            pulumi.Input.asOptionalInput<int>(availableMemoryMb),
        buildEnvironmentVariables =
            pulumi.Input.asOptionalInput<Map<String, String>>(
                buildEnvironmentVariables),
        buildServiceAccount =
            pulumi.Input.asOptionalInput<String>(buildServiceAccount),
        ...
        dockerRepository =
            pulumi.Input.asOptionalInput<String>(dockerRepository),
        entryPoint = pulumi.Input.asOptionalInput<String>(entryPoint),
        environmentVariables =
            pulumi.Input.asOptionalInput<Map<String, String>>(
                environmentVariables),
        eventTrigger =
            pulumi.Input.asOptionalInput<FunctionEventTrigger>(eventTrigger),
        httpsTriggerSecurityLevel =
            pulumi.Input.asOptionalInput<String>(httpsTriggerSecurityLevel),
        ...
        secretEnvironmentVariables = pulumi.Input.asOptionalInput<
                List<FunctionSecretEnvironmentVariable>>(
            secretEnvironmentVariables),
        secretVolumes =
            pulumi.Input.asOptionalInput<List<FunctionSecretVolume>>(
                secretVolumes),
        serviceAccountEmail =
            pulumi.Input.asOptionalInput<String>(serviceAccountEmail),
        sourceArchiveBucket =
            pulumi.Input.asOptionalInput<String>(sourceArchiveBucket),
        sourceArchiveObject =
            pulumi.Input.asOptionalInput<String>(sourceArchiveObject),
        sourceRepository =
            pulumi.Input.asOptionalInput<FunctionSourceRepository>(
                sourceRepository),
        ...
        vpcConnectorEgressSettings =
            pulumi.Input.asOptionalInput<String>(vpcConnectorEgressSettings);
  ...
  factory FunctionArgs.fromMap(Map<String, dynamic> map) {
    return FunctionArgs(
      ...
      availableMemoryMb: map['availableMemoryMb'] == null
          ? null
          : map['availableMemoryMb'] as int,
      buildEnvironmentVariables: map['buildEnvironmentVariables'] == null
          ? null
          : (map['buildEnvironmentVariables'] as Map).cast<String, String>(),
      buildServiceAccount: map['buildServiceAccount'] == null
          ? null
          : map['buildServiceAccount'] as String,
      buildWorkerPool: map['buildWorkerPool'] == null
          ? null
          : map['buildWorkerPool'] as String,
      description:
      ...
      httpsTriggerSecurityLevel: map['httpsTriggerSecurityLevel'] == null
          ? null
          : map['httpsTriggerSecurityLevel'] as String,
      httpsTriggerUrl: map['httpsTriggerUrl'] == null
          ? null
          : map['httpsTriggerUrl'] as String,
      ...
      onDeployUpdatePolicy: map['onDeployUpdatePolicy'] == null
          ? null
          : FunctionOnDeployUpdatePolicy.fromMap(
      ...
      secretEnvironmentVariables: map['secretEnvironmentVariables'] == null
          ? null
          : pulumi.Input.decodeList<FunctionSecretEnvironmentVariable>(
              map['secretEnvironmentVariables'],
              (value) => FunctionSecretEnvironmentVariable.fromMap(
                  (value as Map).cast<String, dynamic>())),
      secretVolumes: map['secretVolumes'] == null
          ? null
          : pulumi.Input.decodeList<FunctionSecretVolume>(
              map['secretVolumes'],
              (value) => FunctionSecretVolume.fromMap(
                  (value as Map).cast<String, dynamic>())),
      serviceAccountEmail: map['serviceAccountEmail'] == null
          ? null
          : map['serviceAccountEmail'] as String,
      sourceArchiveBucket: map['sourceArchiveBucket'] == null
          ? null
          : map['sourceArchiveBucket'] as String,
      sourceArchiveObject: map['sourceArchiveObject'] == null
          ? null
          : map['sourceArchiveObject'] as String,
      sourceRepository: map['sourceRepository'] == null
          ? null
          : FunctionSourceRepository.fromMap(
              (map['sourceRepository'] as Map).cast<String, dynamic>()),
      timeout: map['timeout'] == null ? null : map['timeout'] as int,
      triggerHttp:
          map['triggerHttp'] == null ? null : map['triggerHttp'] as bool,
      vpcConnector:
