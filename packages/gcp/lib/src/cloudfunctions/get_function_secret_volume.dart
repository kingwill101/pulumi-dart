...
class GetFunctionSecretVolume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'projectId': projectId,
      'secret': secret,
      'versions': pulumi.Input.encodeList<GetFunctionSecretVolumeVersion, Map<String, dynamic>>(versions, (value) => value.toMap()),
    };
  }
  ...
  factory GetFunctionSecretVolume.fromMap(Map<String, dynamic> map) {
    return GetFunctionSecretVolume(
      ...
      versions: pulumi.Input.decodeList<GetFunctionSecretVolumeVersion>(map['versions'], (value) => GetFunctionSecretVolumeVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
