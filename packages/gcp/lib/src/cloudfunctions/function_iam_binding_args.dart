...
/// {@template pulumi_cloudfunctions_function_iam_binding_function_iam_binding_args_doc}
/// The set of arguments for FunctionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudfunctions_function_iam_binding_function_iam_binding_args_doc}
class FunctionIamBindingArgs {
  ...
  FunctionIamBindingArgs({
    ...
    FunctionIamBindingCondition? condition,
  ...
  factory FunctionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return FunctionIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : FunctionIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
