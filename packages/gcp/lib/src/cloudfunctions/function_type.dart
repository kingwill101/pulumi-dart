...
class FunctionType extends pulumi.CustomResource {
  ...
  FunctionType(
    ...
    this.automaticUpdatePolicy = registerOutput<Map<String, dynamic>>(
      'automaticUpdatePolicy',
    );
    this.availableMemoryMb = registerOutput<int?>('availableMemoryMb');
    this.buildEnvironmentVariables = registerOutput<Map<String, String>?>(
    ...
    this.httpsTriggerSecurityLevel = registerOutput<String>(
    ...
    this.onDeployUpdatePolicy = registerOutput<FunctionOnDeployUpdatePolicy?>(
    ...
    this.secretVolumes = registerOutput<List<FunctionSecretVolume>?>(
      'secretVolumes',
    );
    ...
    this.sourceRepository = registerOutput<FunctionSourceRepository?>(
      'sourceRepository',
    );
    ...
    this.vpcConnectorEgressSettings = registerOutput<String>(
