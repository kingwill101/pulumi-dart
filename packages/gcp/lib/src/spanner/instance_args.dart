...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      autoscalingConfig: map['autoscalingConfig'] == null ? null : InstanceAutoscalingConfig.fromMap((map['autoscalingConfig'] as Map).cast<String, dynamic>()),
      config: map['config'] as String,
      defaultBackupScheduleType: map['defaultBackupScheduleType'] == null ? null : map['defaultBackupScheduleType'] as String,
