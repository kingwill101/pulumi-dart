...
class BackupScheduleArgs {
  ...
  factory BackupScheduleArgs.fromMap(Map<String, dynamic> map) {
    return BackupScheduleArgs(
      ...
      encryptionConfig: map['encryptionConfig'] == null ? null : BackupScheduleEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      fullBackupSpec: map['fullBackupSpec'] == null ? null : (map['fullBackupSpec'] as Map).cast<String, dynamic>(),
      incrementalBackupSpec: map['incrementalBackupSpec'] == null ? null : (map['incrementalBackupSpec'] as Map).cast<String, dynamic>(),
      instance: map['instance'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      retentionDuration: map['retentionDuration'] as String,
      spec: map['spec'] == null ? null : BackupScheduleSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
