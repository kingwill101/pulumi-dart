...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.autoscalingConfig = registerOutput<InstanceAutoscalingConfig?>('autoscalingConfig');
    this.config = registerOutput<String>('config');
    this.defaultBackupScheduleType = registerOutput<String>('defaultBackupScheduleType');
