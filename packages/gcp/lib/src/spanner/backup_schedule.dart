...
class BackupSchedule extends pulumi.CustomResource {
  ...
  BackupSchedule(
    ...
    this.encryptionConfig = registerOutput<BackupScheduleEncryptionConfig>(
      'encryptionConfig',
    );
    this.fullBackupSpec = registerOutput<Map<String, dynamic>?>(
      'fullBackupSpec',
    );
    this.incrementalBackupSpec = registerOutput<Map<String, dynamic>?>(
      'incrementalBackupSpec',
    );
