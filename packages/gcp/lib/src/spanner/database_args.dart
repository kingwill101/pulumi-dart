...
class DatabaseArgs {
  ...
  DatabaseArgs({
    ...
    String? versionRetentionPeriod,
       ...
       enableDropProtection = pulumi.Input.asOptionalInput<bool>(
         enableDropProtection,
       ),
       encryptionConfig = pulumi
           .Input.asOptionalInput<DatabaseEncryptionConfig>(encryptionConfig),
       instance = pulumi.Input.asInput<String>(instance),
       name = pulumi.Input.asOptionalInput<String>(name),
       project = pulumi.Input.asOptionalInput<String>(project),
       versionRetentionPeriod = pulumi.Input.asOptionalInput<String>(
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      databaseDialect: map['databaseDialect'] == null
          ? null
          : map['databaseDialect'] as String,
      ddls: map['ddls'] == null ? null : (map['ddls'] as List).cast<String>(),
      defaultTimeZone: map['defaultTimeZone'] == null
          ? null
          : map['defaultTimeZone'] as String,
      deletionProtection: map['deletionProtection'] == null
          ? null
          : map['deletionProtection'] as bool,
      enableDropProtection: map['enableDropProtection'] == null
          ? null
          : map['enableDropProtection'] as bool,
      ...
      versionRetentionPeriod: map['versionRetentionPeriod'] == null
          ? null
          : map['versionRetentionPeriod'] as String,
    );
  }
}
