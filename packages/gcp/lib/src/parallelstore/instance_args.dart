...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      directoryStripeLevel: map['directoryStripeLevel'] == null ? null : map['directoryStripeLevel'] as String,
      fileStripeLevel: map['fileStripeLevel'] == null ? null : map['fileStripeLevel'] as String,
