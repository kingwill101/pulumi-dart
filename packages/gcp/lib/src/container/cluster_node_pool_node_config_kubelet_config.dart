...
import 'cluster_node_pool_node_config_kubelet_config_memory_manager.dart';
import 'cluster_node_pool_node_config_kubelet_config_topology_manager.dart';
  ...
  factory ClusterNodePoolNodeConfigKubeletConfig.fromMap(
    ...
    return ClusterNodePoolNodeConfigKubeletConfig(
      ...
      evictionMinimumReclaim: map['evictionMinimumReclaim'] == null
          ? null
          : ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim.fromMap(
      ...
      evictionSoftGracePeriod: map['evictionSoftGracePeriod'] == null
          ? null
          : ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod.fromMap(
