...
class NodePoolArgs {
  ...
  factory NodePoolArgs.fromMap(Map<String, dynamic> map) {
    return NodePoolArgs(
      ...
      networkConfig: map['networkConfig'] == null ? null : NodePoolNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: map['nodeConfig'] == null ? null : NodePoolNodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] == null ? null : map['nodeCount'] as int,
      nodeDrainConfigs: map['nodeDrainConfigs'] == null ? null : pulumi.Input.decodeList<NodePoolNodeDrainConfig>(map['nodeDrainConfigs'], (value) => NodePoolNodeDrainConfig.fromMap((value as Map).cast<String, dynamic>())),
      nodeLocations: map['nodeLocations'] == null ? null : (map['nodeLocations'] as List).cast<String>(),
      placementPolicy: map['placementPolicy'] == null ? null : NodePoolPlacementPolicy.fromMap((map['placementPolicy'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      queuedProvisioning: map['queuedProvisioning'] == null ? null : NodePoolQueuedProvisioning.fromMap((map['queuedProvisioning'] as Map).cast<String, dynamic>()),
      upgradeSettings: map['upgradeSettings'] == null ? null : NodePoolUpgradeSettings.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>()),
