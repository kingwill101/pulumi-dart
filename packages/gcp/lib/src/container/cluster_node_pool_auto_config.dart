...
class ClusterNodePoolAutoConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeKubeletConfig': ?nodeKubeletConfig == null ? null : nodeKubeletConfig!.toMap(),
  ...
  factory ClusterNodePoolAutoConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolAutoConfig(
      linuxNodeConfig: map['linuxNodeConfig'] == null ? null : ClusterNodePoolAutoConfigLinuxNodeConfig.fromMap((map['linuxNodeConfig'] as Map).cast<String, dynamic>()),
      networkTags: map['networkTags'] == null ? null : ClusterNodePoolAutoConfigNetworkTags.fromMap((map['networkTags'] as Map).cast<String, dynamic>()),
      nodeKubeletConfig: map['nodeKubeletConfig'] == null ? null : ClusterNodePoolAutoConfigNodeKubeletConfig.fromMap((map['nodeKubeletConfig'] as Map).cast<String, dynamic>()),
