...
class GetClusterNodeConfigEphemeralStorageLocalSsdConfig {
  ...
  /// Creates a new [GetClusterNodeConfigEphemeralStorageLocalSsdConfig].
  ...
  factory GetClusterNodeConfigEphemeralStorageLocalSsdConfig.fromMap(Map<String, dynamic> map) {
