...
class AzureClusterArgs {
  ...
  factory AzureClusterArgs.fromMap(Map<String, dynamic> map) {
    return AzureClusterArgs(
      ...
      authorization: AzureClusterAuthorization.fromMap((map['authorization'] as Map).cast<String, dynamic>()),
      azureRegion: map['azureRegion'] as String,
      azureServicesAuthentication: map['azureServicesAuthentication'] == null ? null : AzureClusterAzureServicesAuthentication.fromMap((map['azureServicesAuthentication'] as Map).cast<String, dynamic>()),
      client: map['client'] == null ? null : map['client'] as String,
      controlPlane: AzureClusterControlPlane.fromMap((map['controlPlane'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      fleet: AzureClusterFleet.fromMap((map['fleet'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      loggingConfig: map['loggingConfig'] == null ? null : AzureClusterLoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networking: AzureClusterNetworking.fromMap((map['networking'] as Map).cast<String, dynamic>()),
