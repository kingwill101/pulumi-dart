...
class ClusterNodeConfigLinuxNodeConfig {
  ...
  final ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading? nodeKernelModuleLoading;
  ...
  factory ClusterNodeConfigLinuxNodeConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigLinuxNodeConfig(
      ...
      hugepagesConfig: map['hugepagesConfig'] == null ? null : ClusterNodeConfigLinuxNodeConfigHugepagesConfig.fromMap((map['hugepagesConfig'] as Map).cast<String, dynamic>()),
      nodeKernelModuleLoading: map['nodeKernelModuleLoading'] == null ? null : ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading.fromMap((map['nodeKernelModuleLoading'] as Map).cast<String, dynamic>()),
