...
class GetClusterNodeConfigLinuxNodeConfig {
  ...
  final List<GetClusterNodeConfigLinuxNodeConfigHugepagesConfig> hugepagesConfigs;
  /// The settings for kernel module loading.
  final List<GetClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading> nodeKernelModuleLoadings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hugepagesConfigs': pulumi.Input.encodeList<GetClusterNodeConfigLinuxNodeConfigHugepagesConfig, Map<String, dynamic>>(hugepagesConfigs, (value) => value.toMap()),
      'nodeKernelModuleLoadings': pulumi.Input.encodeList<GetClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading, Map<String, dynamic>>(nodeKernelModuleLoadings, (value) => value.toMap()),
      'sysctls': sysctls,
  ...
  factory GetClusterNodeConfigLinuxNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfigLinuxNodeConfig(
      ...
      hugepagesConfigs: pulumi.Input.decodeList<GetClusterNodeConfigLinuxNodeConfigHugepagesConfig>(map['hugepagesConfigs'], (value) => GetClusterNodeConfigLinuxNodeConfigHugepagesConfig.fromMap((value as Map).cast<String, dynamic>())),
      nodeKernelModuleLoadings: pulumi.Input.decodeList<GetClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading>(map['nodeKernelModuleLoadings'], (value) => GetClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading.fromMap((value as Map).cast<String, dynamic>())),
