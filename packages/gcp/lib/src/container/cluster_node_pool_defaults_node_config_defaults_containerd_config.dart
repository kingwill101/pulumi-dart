  ...
  factory ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfig.fromMap(
    ...
    return ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfig(
      privateRegistryAccessConfig: map['privateRegistryAccessConfig'] == null
          ? null
          : ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigPrivateRegistryAccessConfig.fromMap(
      ...
      registryHosts: map['registryHosts'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['registryHosts'],
              (value) =>
                  ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHost.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      writableCgroups: map['writableCgroups'] == null
          ? null
          : ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigWritableCgroups.fromMap(
