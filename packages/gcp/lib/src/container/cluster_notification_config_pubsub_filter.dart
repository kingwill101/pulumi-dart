...
class ClusterNotificationConfigPubsubFilter {
  ...
  ClusterNotificationConfigPubsubFilter({required this.eventTypes});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'eventTypes': eventTypes};
  }

  factory ClusterNotificationConfigPubsubFilter.fromMap(
