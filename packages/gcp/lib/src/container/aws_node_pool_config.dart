...
class AwsNodePoolConfig {
  ...
  final AwsNodePoolConfigAutoscalingMetricsCollection? autoscalingMetricsCollection;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricsCollection': ?autoscalingMetricsCollection == null ? null : autoscalingMetricsCollection!.toMap(),
      ...
      'spotConfig': ?spotConfig == null ? null : spotConfig!.toMap(),
      'sshConfig': ?sshConfig == null ? null : sshConfig!.toMap(),
      'tags': ?tags,
      'taints': ?taints == null ? null : pulumi.Input.encodeList<AwsNodePoolConfigTaint, Map<String, dynamic>>(taints!, (value) => value.toMap()),
    };
  }

  factory AwsNodePoolConfig.fromMap(Map<String, dynamic> map) {
    return AwsNodePoolConfig(
      autoscalingMetricsCollection: map['autoscalingMetricsCollection'] == null ? null : AwsNodePoolConfigAutoscalingMetricsCollection.fromMap((map['autoscalingMetricsCollection'] as Map).cast<String, dynamic>()),
      configEncryption: AwsNodePoolConfigConfigEncryption.fromMap((map['configEncryption'] as Map).cast<String, dynamic>()),
      iamInstanceProfile: map['iamInstanceProfile'] as String,
      imageType: map['imageType'] == null ? null : map['imageType'] as String,
      instancePlacement: map['instancePlacement'] == null ? null : AwsNodePoolConfigInstancePlacement.fromMap((map['instancePlacement'] as Map).cast<String, dynamic>()),
      instanceType: map['instanceType'] == null ? null : map['instanceType'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      proxyConfig: map['proxyConfig'] == null ? null : AwsNodePoolConfigProxyConfig.fromMap((map['proxyConfig'] as Map).cast<String, dynamic>()),
      rootVolume: map['rootVolume'] == null ? null : AwsNodePoolConfigRootVolume.fromMap((map['rootVolume'] as Map).cast<String, dynamic>()),
      securityGroupIds: map['securityGroupIds'] == null ? null : (map['securityGroupIds'] as List).cast<String>(),
      spotConfig: map['spotConfig'] == null ? null : AwsNodePoolConfigSpotConfig.fromMap((map['spotConfig'] as Map).cast<String, dynamic>()),
      sshConfig: map['sshConfig'] == null ? null : AwsNodePoolConfigSshConfig.fromMap((map['sshConfig'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<AwsNodePoolConfigTaint>(map['taints'], (value) => AwsNodePoolConfigTaint.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
