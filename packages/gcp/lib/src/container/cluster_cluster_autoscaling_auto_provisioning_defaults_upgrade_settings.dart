...
class ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings {
  ...
  final ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettingsBlueGreenSettings? blueGreenSettings;
  ...
  factory ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings.fromMap(Map<String, dynamic> map) {
    return ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings(
      blueGreenSettings: map['blueGreenSettings'] == null ? null : ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettingsBlueGreenSettings.fromMap((map['blueGreenSettings'] as Map).cast<String, dynamic>()),
