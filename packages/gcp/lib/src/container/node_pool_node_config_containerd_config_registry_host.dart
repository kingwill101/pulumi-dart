...
class NodePoolNodeConfigContainerdConfigRegistryHost {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hosts': ?hosts == null ? null : pulumi.Input.encodeList<NodePoolNodeConfigContainerdConfigRegistryHostHost, Map<String, dynamic>>(hosts!, (value) => value.toMap()),
      'server': server,
    };
  }
  ...
  factory NodePoolNodeConfigContainerdConfigRegistryHost.fromMap(Map<String, dynamic> map) {
    return NodePoolNodeConfigContainerdConfigRegistryHost(
      hosts: map['hosts'] == null ? null : pulumi.Input.decodeList<NodePoolNodeConfigContainerdConfigRegistryHostHost>(map['hosts'], (value) => NodePoolNodeConfigContainerdConfigRegistryHostHost.fromMap((value as Map).cast<String, dynamic>())),
