    ...
    return GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfig(
      privateRegistryAccessConfigs:
          ...
          >(
            ...
            (value) =>
                GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfig.fromMap(
      ...
      registryHosts:
          ...
          >(
            map['registryHosts'],
            (value) =>
                GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHost.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      writableCgroups:
          ...
          >(
            map['writableCgroups'],
            (value) =>
                GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigWritableCgroup.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
    );
