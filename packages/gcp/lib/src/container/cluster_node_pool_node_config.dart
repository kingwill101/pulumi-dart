...
class ClusterNodePoolNodeConfig {
  ...
  final ClusterNodePoolNodeConfigAdvancedMachineFeatures?
  ...
  /// Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk. Structure is documented below.
  final ClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig?
  ...
  final ClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig?
  ...
  factory ClusterNodePoolNodeConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNodeConfig(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null
          ? null
          : ClusterNodePoolNodeConfigAdvancedMachineFeatures.fromMap(
              (map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      bootDisk: map['bootDisk'] == null
          ? null
          : ClusterNodePoolNodeConfigBootDisk.fromMap(
      ...
      confidentialNodes: map['confidentialNodes'] == null
          ? null
          : ClusterNodePoolNodeConfigConfidentialNodes.fromMap(
              (map['confidentialNodes'] as Map).cast<String, dynamic>()),
      containerdConfig: map['containerdConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigContainerdConfig.fromMap(
      ...
      gcfsConfig: map['gcfsConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigGcfsConfig.fromMap(
      ...
      gvnic: map['gvnic'] == null
          ? null
          : ClusterNodePoolNodeConfigGvnic.fromMap(
              (map['gvnic'] as Map).cast<String, dynamic>()),
      hostMaintenancePolicy: map['hostMaintenancePolicy'] == null
          ? null
          : ClusterNodePoolNodeConfigHostMaintenancePolicy.fromMap(
      ...
      kubeletConfig: map['kubeletConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigKubeletConfig.fromMap(
      ...
      linuxNodeConfig: map['linuxNodeConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigLinuxNodeConfig.fromMap(
              (map['linuxNodeConfig'] as Map).cast<String, dynamic>()),
      localNvmeSsdBlockConfig: map['localNvmeSsdBlockConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig.fromMap(
      ...
      reservationAffinity: map['reservationAffinity'] == null
          ? null
          : ClusterNodePoolNodeConfigReservationAffinity.fromMap(
      ...
      sandboxConfig: map['sandboxConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigSandboxConfig.fromMap(
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigShieldedInstanceConfig.fromMap(
              (map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      soleTenantConfig: map['soleTenantConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigSoleTenantConfig.fromMap(
      ...
      windowsNodeConfig: map['windowsNodeConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigWindowsNodeConfig.fromMap(
              (map['windowsNodeConfig'] as Map).cast<String, dynamic>()),
      workloadMetadataConfig: map['workloadMetadataConfig'] == null
          ? null
          : ClusterNodePoolNodeConfigWorkloadMetadataConfig.fromMap(
