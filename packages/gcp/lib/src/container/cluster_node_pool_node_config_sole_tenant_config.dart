...
class ClusterNodePoolNodeConfigSoleTenantConfig {
  ...
  final List<ClusterNodePoolNodeConfigSoleTenantConfigNodeAffinity> nodeAffinities;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities': pulumi.Input.encodeList<ClusterNodePoolNodeConfigSoleTenantConfigNodeAffinity, Map<String, dynamic>>(nodeAffinities, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterNodePoolNodeConfigSoleTenantConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNodeConfigSoleTenantConfig(
      ...
      nodeAffinities: pulumi.Input.decodeList<ClusterNodePoolNodeConfigSoleTenantConfigNodeAffinity>(map['nodeAffinities'], (value) => ClusterNodePoolNodeConfigSoleTenantConfigNodeAffinity.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
