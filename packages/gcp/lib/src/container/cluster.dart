...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.binaryAuthorization = registerOutput<ClusterBinaryAuthorization?>(
      'binaryAuthorization',
    );
    this.clusterAutoscaling = registerOutput<ClusterClusterAutoscaling>(
      'clusterAutoscaling',
    );
    this.clusterIpv4Cidr = registerOutput<String>('clusterIpv4Cidr');
    this.clusterTelemetry = registerOutput<ClusterClusterTelemetry>(
      'clusterTelemetry',
    );
    this.confidentialNodes = registerOutput<ClusterConfidentialNodes>(
      'confidentialNodes',
    );
    ...
    this.costManagementConfig = registerOutput<ClusterCostManagementConfig>(
      'costManagementConfig',
    );
    this.databaseEncryption = registerOutput<ClusterDatabaseEncryption>(
      'databaseEncryption',
    );
    ...
    this.defaultSnatStatus = registerOutput<ClusterDefaultSnatStatus>(
      'defaultSnatStatus',
    );
    this.deletionProtection = registerOutput<bool?>('deletionProtection');
    this.description = registerOutput<String?>('description');
    this.disableL4LbFirewallReconciliation = registerOutput<bool?>(
    ...
    this.enableCiliumClusterwideNetworkPolicy = registerOutput<bool?>(
      'enableCiliumClusterwideNetworkPolicy',
    );
    this.enableFqdnNetworkPolicy = registerOutput<bool?>(
      'enableFqdnNetworkPolicy',
    );
    this.enableIntranodeVisibility = registerOutput<bool>(
      'enableIntranodeVisibility',
    );
    this.enableK8sBetaApis = registerOutput<ClusterEnableK8sBetaApis?>(
      'enableK8sBetaApis',
    );
    ...
    this.enterpriseConfig = registerOutput<ClusterEnterpriseConfig>(
      'enterpriseConfig',
    );
    this.fleet = registerOutput<ClusterFleet?>('fleet');
    this.gatewayApiConfig = registerOutput<ClusterGatewayApiConfig>(
      'gatewayApiConfig',
    );
    this.gkeAutoUpgradeConfig = registerOutput<ClusterGkeAutoUpgradeConfig>(
      'gkeAutoUpgradeConfig',
    );
    this.identityServiceConfig = registerOutput<ClusterIdentityServiceConfig>(
      'identityServiceConfig',
    );
    this.inTransitEncryptionConfig = registerOutput<String?>(
      'inTransitEncryptionConfig',
    );
    this.initialNodeCount = registerOutput<int?>('initialNodeCount');
    this.ipAllocationPolicy = registerOutput<ClusterIpAllocationPolicy>(
      'ipAllocationPolicy',
    );
    ...
    this.meshCertificates = registerOutput<ClusterMeshCertificates>(
      'meshCertificates',
    );
    this.minMasterVersion = registerOutput<String?>('minMasterVersion');
    this.monitoringConfig = registerOutput<ClusterMonitoringConfig>(
      'monitoringConfig',
    );
    ...
    this.nodePoolAutoConfig = registerOutput<ClusterNodePoolAutoConfig>(
      'nodePoolAutoConfig',
    );
    this.nodePoolDefaults = registerOutput<ClusterNodePoolDefaults>(
      'nodePoolDefaults',
    );
    this.nodePools = registerOutput<List<ClusterNodePool>>('nodePools');
    this.nodeVersion = registerOutput<String>('nodeVersion');
    this.notificationConfig = registerOutput<ClusterNotificationConfig>(
      'notificationConfig',
    );
    this.operation = registerOutput<String>('operation');
    this.podAutoscaling = registerOutput<ClusterPodAutoscaling>(
      'podAutoscaling',
    );
    ...
    this.privateClusterConfig = registerOutput<ClusterPrivateClusterConfig>(
    ...
    this.rbacBindingConfig = registerOutput<ClusterRbacBindingConfig>(
      'rbacBindingConfig',
    );
    this.releaseChannel = registerOutput<ClusterReleaseChannel>(
      'releaseChannel',
    );
    this.removeDefaultNodePool = registerOutput<bool?>('removeDefaultNodePool');
    this.resourceLabels = registerOutput<Map<String, String>?>(
      'resourceLabels',
    );
    ...
    this.secretManagerConfig = registerOutput<ClusterSecretManagerConfig?>(
      'secretManagerConfig',
    );
    this.secretSyncConfig = registerOutput<ClusterSecretSyncConfig?>(
      'secretSyncConfig',
    );
    this.securityPostureConfig = registerOutput<ClusterSecurityPostureConfig>(
    ...
    this.userManagedKeysConfig = registerOutput<ClusterUserManagedKeysConfig?>(
      'userManagedKeysConfig',
    );
    this.verticalPodAutoscaling = registerOutput<ClusterVerticalPodAutoscaling>(
      'verticalPodAutoscaling',
    );
    this.workloadAltsConfig = registerOutput<ClusterWorkloadAltsConfig>(
      'workloadAltsConfig',
    );
    this.workloadIdentityConfig = registerOutput<ClusterWorkloadIdentityConfig>(
      'workloadIdentityConfig',
    );
  }
}
