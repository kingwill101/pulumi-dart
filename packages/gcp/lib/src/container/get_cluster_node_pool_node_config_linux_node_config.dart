...
class GetClusterNodePoolNodeConfigLinuxNodeConfig {
  ...
  final List<GetClusterNodePoolNodeConfigLinuxNodeConfigHugepagesConfig>
      hugepagesConfigs;

  /// The settings for kernel module loading.
  final List<GetClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['sysctls'] = sysctls;
    map['transparentHugepageDefrag'] = transparentHugepageDefrag;
    map['transparentHugepageEnabled'] = transparentHugepageEnabled;
    return map;
  }
