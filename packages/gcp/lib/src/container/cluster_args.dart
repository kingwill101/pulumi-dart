...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterWorkloadIdentityConfig? workloadIdentityConfig,
       ...
       confidentialNodes = pulumi
           .Input.asOptionalInput<ClusterConfidentialNodes>(confidentialNodes),
       controlPlaneEndpointsConfig =
       ...
       datapathProvider = pulumi.Input.asOptionalInput<String>(
         datapathProvider,
       ),
       defaultMaxPodsPerNode = pulumi.Input.asOptionalInput<int>(
         defaultMaxPodsPerNode,
       ),
       defaultSnatStatus = pulumi
           .Input.asOptionalInput<ClusterDefaultSnatStatus>(defaultSnatStatus),
       ...
       enableCiliumClusterwideNetworkPolicy = pulumi
           .Input.asOptionalInput<bool>(enableCiliumClusterwideNetworkPolicy),
       enableFqdnNetworkPolicy = pulumi.Input.asOptionalInput<bool>(
         enableFqdnNetworkPolicy,
       ),
       enableIntranodeVisibility = pulumi.Input.asOptionalInput<bool>(
         enableIntranodeVisibility,
       ),
       enableK8sBetaApis = pulumi
           .Input.asOptionalInput<ClusterEnableK8sBetaApis>(enableK8sBetaApis),
       enableKubernetesAlpha = pulumi.Input.asOptionalInput<bool>(
         enableKubernetesAlpha,
       ),
       enableL4IlbSubsetting = pulumi.Input.asOptionalInput<bool>(
         enableL4IlbSubsetting,
       ),
       enableLegacyAbac = pulumi.Input.asOptionalInput<bool>(enableLegacyAbac),
       enableMultiNetworking = pulumi.Input.asOptionalInput<bool>(
         enableMultiNetworking,
       ),
       enableShieldedNodes = pulumi.Input.asOptionalInput<bool>(
         enableShieldedNodes,
       ),
       ...
       minMasterVersion = pulumi.Input.asOptionalInput<String>(
         minMasterVersion,
       ),
       monitoringConfig = pulumi.Input.asOptionalInput<ClusterMonitoringConfig>(
         monitoringConfig,
       ),
       monitoringService = pulumi.Input.asOptionalInput<String>(
         monitoringService,
       ),
       ...
       nodePools = pulumi.Input.asOptionalInput<List<ClusterNodePool>>(
         nodePools,
       ),
       ...
       privateIpv6GoogleAccess = pulumi.Input.asOptionalInput<String>(
       ...
       rbacBindingConfig = pulumi
           .Input.asOptionalInput<ClusterRbacBindingConfig>(rbacBindingConfig),
       releaseChannel = pulumi.Input.asOptionalInput<ClusterReleaseChannel>(
         releaseChannel,
       ),
       removeDefaultNodePool = pulumi.Input.asOptionalInput<bool>(
    ...
    return <String, dynamic>{
      ...
      'anonymousAuthenticationConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(anonymousAuthenticationConfig, (value) => value.toMap()),
      'authenticatorGroupsConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'clusterAutoscaling':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(clusterAutoscaling, (value) => value.toMap()),
      'clusterIpv4Cidr': ?clusterIpv4Cidr,
      'clusterTelemetry':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterClusterTelemetry,
            Map<String, dynamic>
          >(clusterTelemetry, (value) => value.toMap()),
      'confidentialNodes':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'controlPlaneEndpointsConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(controlPlaneEndpointsConfig, (value) => value.toMap()),
      'costManagementConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'gkeAutoUpgradeConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(gkeAutoUpgradeConfig, (value) => value.toMap()),
      'identityServiceConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'managedOpentelemetryConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(managedOpentelemetryConfig, (value) => value.toMap()),
      'masterAuth':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterMasterAuth,
            Map<String, dynamic>
          >(masterAuth, (value) => value.toMap()),
      'masterAuthorizedNetworksConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'podAutoscaling':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(podAutoscaling, (value) => value.toMap()),
      'podSecurityPolicyConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterPodSecurityPolicyConfig,
            Map<String, dynamic>
          >(podSecurityPolicyConfig, (value) => value.toMap()),
      'privateClusterConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'protectConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(protectConfig, (value) => value.toMap()),
      'rbacBindingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterRbacBindingConfig,
            Map<String, dynamic>
          >(rbacBindingConfig, (value) => value.toMap()),
      'releaseChannel':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'secretManagerConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(secretManagerConfig, (value) => value.toMap()),
      'secretSyncConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterSecretSyncConfig,
            Map<String, dynamic>
          >(secretSyncConfig, (value) => value.toMap()),
      'securityPostureConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'tpuConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterTpuConfig,
            Map<String, dynamic>
          >(tpuConfig, (value) => value.toMap()),
      'userManagedKeysConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterUserManagedKeysConfig,
            Map<String, dynamic>
          >(userManagedKeysConfig, (value) => value.toMap()),
      'verticalPodAutoscaling':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'workloadAltsConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(workloadAltsConfig, (value) => value.toMap()),
      'workloadIdentityConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      addonsConfig: map['addonsConfig'] == null
          ? null
          : ClusterAddonsConfig.fromMap(
              (map['addonsConfig'] as Map).cast<String, dynamic>(),
            ),
      allowNetAdmin: map['allowNetAdmin'] == null
          ? null
          : map['allowNetAdmin'] as bool,
      anonymousAuthenticationConfig:
          map['anonymousAuthenticationConfig'] == null
          ? null
          : ClusterAnonymousAuthenticationConfig.fromMap(
              (map['anonymousAuthenticationConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      authenticatorGroupsConfig: map['authenticatorGroupsConfig'] == null
          ? null
          : ClusterAuthenticatorGroupsConfig.fromMap(
              (map['authenticatorGroupsConfig'] as Map).cast<String, dynamic>(),
            ),
      binaryAuthorization: map['binaryAuthorization'] == null
          ? null
          : ClusterBinaryAuthorization.fromMap(
              (map['binaryAuthorization'] as Map).cast<String, dynamic>(),
            ),
      clusterAutoscaling: map['clusterAutoscaling'] == null
          ? null
          : ClusterClusterAutoscaling.fromMap(
              (map['clusterAutoscaling'] as Map).cast<String, dynamic>(),
            ),
      ...
      defaultSnatStatus: map['defaultSnatStatus'] == null
          ? null
          : ClusterDefaultSnatStatus.fromMap(
      ...
      disableL4LbFirewallReconciliation:
          map['disableL4LbFirewallReconciliation'] == null
          ? null
          : map['disableL4LbFirewallReconciliation'] as bool,
      dnsConfig: map['dnsConfig'] == null
          ? null
          : ClusterDnsConfig.fromMap(
              (map['dnsConfig'] as Map).cast<String, dynamic>(),
            ),
      enableAutopilot: map['enableAutopilot'] == null
          ? null
          : map['enableAutopilot'] as bool,
      enableCiliumClusterwideNetworkPolicy:
          map['enableCiliumClusterwideNetworkPolicy'] == null
          ? null
      ...
      enableK8sBetaApis: map['enableK8sBetaApis'] == null
          ? null
          : ClusterEnableK8sBetaApis.fromMap(
      ...
      gatewayApiConfig: map['gatewayApiConfig'] == null
          ? null
          : ClusterGatewayApiConfig.fromMap(
              (map['gatewayApiConfig'] as Map).cast<String, dynamic>(),
            ),
      gkeAutoUpgradeConfig: map['gkeAutoUpgradeConfig'] == null
          ? null
          : ClusterGkeAutoUpgradeConfig.fromMap(
              (map['gkeAutoUpgradeConfig'] as Map).cast<String, dynamic>(),
            ),
      identityServiceConfig: map['identityServiceConfig'] == null
          ? null
          : ClusterIdentityServiceConfig.fromMap(
      ...
      managedOpentelemetryConfig: map['managedOpentelemetryConfig'] == null
          ? null
          : ClusterManagedOpentelemetryConfig.fromMap(
              (map['managedOpentelemetryConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      masterAuth: map['masterAuth'] == null
          ? null
          : ClusterMasterAuth.fromMap(
              (map['masterAuth'] as Map).cast<String, dynamic>(),
            ),
      masterAuthorizedNetworksConfig:
          map['masterAuthorizedNetworksConfig'] == null
          ? null
          : ClusterMasterAuthorizedNetworksConfig.fromMap(
              (map['masterAuthorizedNetworksConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      meshCertificates: map['meshCertificates'] == null
          ? null
          : ClusterMeshCertificates.fromMap(
              (map['meshCertificates'] as Map).cast<String, dynamic>(),
            ),
      minMasterVersion: map['minMasterVersion'] == null
          ? null
          : map['minMasterVersion'] as String,
      monitoringConfig: map['monitoringConfig'] == null
          ? null
          : ClusterMonitoringConfig.fromMap(
      ...
      networkPolicy: map['networkPolicy'] == null
          ? null
          : ClusterNetworkPolicy.fromMap(
              (map['networkPolicy'] as Map).cast<String, dynamic>(),
            ),
      networkingMode: map['networkingMode'] == null
          ? null
          : map['networkingMode'] as String,
      nodeConfig: map['nodeConfig'] == null
          ? null
          : ClusterNodeConfig.fromMap(
      ...
      protectConfig: map['protectConfig'] == null
          ? null
          : ClusterProtectConfig.fromMap(
              (map['protectConfig'] as Map).cast<String, dynamic>(),
            ),
      rbacBindingConfig: map['rbacBindingConfig'] == null
          ? null
          : ClusterRbacBindingConfig.fromMap(
              (map['rbacBindingConfig'] as Map).cast<String, dynamic>(),
            ),
      releaseChannel: map['releaseChannel'] == null
          ? null
          : ClusterReleaseChannel.fromMap(
              (map['releaseChannel'] as Map).cast<String, dynamic>(),
            ),
      removeDefaultNodePool: map['removeDefaultNodePool'] == null
          ? null
          : map['removeDefaultNodePool'] as bool,
      ...
      resourceUsageExportConfig: map['resourceUsageExportConfig'] == null
          ? null
          : ClusterResourceUsageExportConfig.fromMap(
              (map['resourceUsageExportConfig'] as Map).cast<String, dynamic>(),
            ),
      secretManagerConfig: map['secretManagerConfig'] == null
          ? null
          : ClusterSecretManagerConfig.fromMap(
              (map['secretManagerConfig'] as Map).cast<String, dynamic>(),
            ),
      secretSyncConfig: map['secretSyncConfig'] == null
          ? null
          : ClusterSecretSyncConfig.fromMap(
              (map['secretSyncConfig'] as Map).cast<String, dynamic>(),
            ),
      securityPostureConfig: map['securityPostureConfig'] == null
          ? null
          : ClusterSecurityPostureConfig.fromMap(
              (map['securityPostureConfig'] as Map).cast<String, dynamic>(),
            ),
      serviceExternalIpsConfig: map['serviceExternalIpsConfig'] == null
          ? null
          : ClusterServiceExternalIpsConfig.fromMap(
