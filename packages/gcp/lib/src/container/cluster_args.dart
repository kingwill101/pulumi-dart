...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterWorkloadIdentityConfig? workloadIdentityConfig,
            ...
            pulumi.Input.asOptionalInput<ClusterAddonsConfig>(addonsConfig),
        ...
        clusterTelemetry =
            pulumi.Input.asOptionalInput<ClusterClusterTelemetry>(
                clusterTelemetry),
        confidentialNodes =
            pulumi.Input.asOptionalInput<ClusterConfidentialNodes>(
                confidentialNodes),
        controlPlaneEndpointsConfig =
        ...
        databaseEncryption =
            pulumi.Input.asOptionalInput<ClusterDatabaseEncryption>(
                databaseEncryption),
        datapathProvider =
            pulumi.Input.asOptionalInput<String>(datapathProvider),
        defaultMaxPodsPerNode =
            pulumi.Input.asOptionalInput<int>(defaultMaxPodsPerNode),
        defaultSnatStatus =
            pulumi.Input.asOptionalInput<ClusterDefaultSnatStatus>(
                defaultSnatStatus),
        deletionProtection =
        ...
        enableFqdnNetworkPolicy =
            pulumi.Input.asOptionalInput<bool>(enableFqdnNetworkPolicy),
        enableIntranodeVisibility =
            pulumi.Input.asOptionalInput<bool>(enableIntranodeVisibility),
        enableK8sBetaApis =
            pulumi.Input.asOptionalInput<ClusterEnableK8sBetaApis>(
                enableK8sBetaApis),
        enableKubernetesAlpha =
            pulumi.Input.asOptionalInput<bool>(enableKubernetesAlpha),
        enableL4IlbSubsetting =
            pulumi.Input.asOptionalInput<bool>(enableL4IlbSubsetting),
        enableLegacyAbac = pulumi.Input.asOptionalInput<bool>(enableLegacyAbac),
        enableMultiNetworking =
            pulumi.Input.asOptionalInput<bool>(enableMultiNetworking),
        enableShieldedNodes =
            pulumi.Input.asOptionalInput<bool>(enableShieldedNodes),
        enableTpu = pulumi.Input.asOptionalInput<bool>(enableTpu),
        enterpriseConfig =
            pulumi.Input.asOptionalInput<ClusterEnterpriseConfig>(
                enterpriseConfig),
        fleet = pulumi.Input.asOptionalInput<ClusterFleet>(fleet),
        gatewayApiConfig =
            pulumi.Input.asOptionalInput<ClusterGatewayApiConfig>(
                gatewayApiConfig),
        ...
        inTransitEncryptionConfig =
            pulumi.Input.asOptionalInput<String>(inTransitEncryptionConfig),
        ...
        loggingConfig =
            pulumi.Input.asOptionalInput<ClusterLoggingConfig>(loggingConfig),
        ...
        managedOpentelemetryConfig =
            pulumi.Input.asOptionalInput<ClusterManagedOpentelemetryConfig>(
                managedOpentelemetryConfig),
        masterAuth =
            pulumi.Input.asOptionalInput<ClusterMasterAuth>(masterAuth),
        masterAuthorizedNetworksConfig =
            pulumi.Input.asOptionalInput<ClusterMasterAuthorizedNetworksConfig>(
                masterAuthorizedNetworksConfig),
        meshCertificates =
            pulumi.Input.asOptionalInput<ClusterMeshCertificates>(
                meshCertificates),
        minMasterVersion =
            pulumi.Input.asOptionalInput<String>(minMasterVersion),
        monitoringConfig =
            pulumi.Input.asOptionalInput<ClusterMonitoringConfig>(
                monitoringConfig),
        monitoringService =
        ...
        networkPerformanceConfig =
            pulumi.Input.asOptionalInput<ClusterNetworkPerformanceConfig>(
                networkPerformanceConfig),
        networkPolicy =
            pulumi.Input.asOptionalInput<ClusterNetworkPolicy>(networkPolicy),
        networkingMode = pulumi.Input.asOptionalInput<String>(networkingMode),
        nodeConfig =
            pulumi.Input.asOptionalInput<ClusterNodeConfig>(nodeConfig),
        nodeLocations =
            pulumi.Input.asOptionalInput<List<String>>(nodeLocations),
        nodePoolAutoConfig =
            pulumi.Input.asOptionalInput<ClusterNodePoolAutoConfig>(
                nodePoolAutoConfig),
        nodePoolDefaults =
            pulumi.Input.asOptionalInput<ClusterNodePoolDefaults>(
                nodePoolDefaults),
        nodePools =
            pulumi.Input.asOptionalInput<List<ClusterNodePool>>(nodePools),
        nodeVersion = pulumi.Input.asOptionalInput<String>(nodeVersion),
        notificationConfig =
            pulumi.Input.asOptionalInput<ClusterNotificationConfig>(
                notificationConfig),
        podAutoscaling =
            pulumi.Input.asOptionalInput<ClusterPodAutoscaling>(podAutoscaling),
        ...
        privateIpv6GoogleAccess =
            pulumi.Input.asOptionalInput<String>(privateIpv6GoogleAccess),
        project = pulumi.Input.asOptionalInput<String>(project),
        protectConfig =
            pulumi.Input.asOptionalInput<ClusterProtectConfig>(protectConfig),
        rbacBindingConfig =
            pulumi.Input.asOptionalInput<ClusterRbacBindingConfig>(
                rbacBindingConfig),
        releaseChannel =
            pulumi.Input.asOptionalInput<ClusterReleaseChannel>(releaseChannel),
        removeDefaultNodePool =
            pulumi.Input.asOptionalInput<bool>(removeDefaultNodePool),
        resourceLabels =
        ...
        secretManagerConfig =
            pulumi.Input.asOptionalInput<ClusterSecretManagerConfig>(
                secretManagerConfig),
        secretSyncConfig =
            pulumi.Input.asOptionalInput<ClusterSecretSyncConfig>(
                secretSyncConfig),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      nodeVersion:
          map['nodeVersion'] == null ? null : map['nodeVersion'] as String,
