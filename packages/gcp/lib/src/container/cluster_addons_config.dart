...
class ClusterAddonsConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lustreCsiDriverConfig': ?lustreCsiDriverConfig == null
          ? null
          : lustreCsiDriverConfig!.toMap(),
      'networkPolicyConfig': ?networkPolicyConfig == null
          ? null
          : networkPolicyConfig!.toMap(),
      'parallelstoreCsiDriverConfig': ?parallelstoreCsiDriverConfig == null
          ? null
          : parallelstoreCsiDriverConfig!.toMap(),
      'podSnapshotConfig': ?podSnapshotConfig == null
          ? null
          : podSnapshotConfig!.toMap(),
      'rayOperatorConfigs': ?rayOperatorConfigs == null
          ? null
          : pulumi.Input.encodeList<
              ClusterAddonsConfigRayOperatorConfig,
              Map<String, dynamic>
            >(rayOperatorConfigs!, (value) => value.toMap()),
      'statefulHaConfig': ?statefulHaConfig == null
          ? null
          : statefulHaConfig!.toMap(),
    };
  }
