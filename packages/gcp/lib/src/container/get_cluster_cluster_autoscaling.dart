...
class GetClusterClusterAutoscaling {
  ...
  final List<GetClusterClusterAutoscalingAutoProvisioningDefault> autoProvisioningDefaults;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoProvisioningDefaults': pulumi.Input.encodeList<GetClusterClusterAutoscalingAutoProvisioningDefault, Map<String, dynamic>>(autoProvisioningDefaults, (value) => value.toMap()),
      'autoProvisioningLocations': autoProvisioningLocations,
      'autoscalingProfile': autoscalingProfile,
      'defaultComputeClassEnabled': defaultComputeClassEnabled,
      'enabled': enabled,
      'resourceLimits': pulumi.Input.encodeList<GetClusterClusterAutoscalingResourceLimit, Map<String, dynamic>>(resourceLimits, (value) => value.toMap()),
    };
  }

  factory GetClusterClusterAutoscaling.fromMap(Map<String, dynamic> map) {
    return GetClusterClusterAutoscaling(
      autoProvisioningDefaults: pulumi.Input.decodeList<GetClusterClusterAutoscalingAutoProvisioningDefault>(map['autoProvisioningDefaults'], (value) => GetClusterClusterAutoscalingAutoProvisioningDefault.fromMap((value as Map).cast<String, dynamic>())),
      ...
      resourceLimits: pulumi.Input.decodeList<GetClusterClusterAutoscalingResourceLimit>(map['resourceLimits'], (value) => GetClusterClusterAutoscalingResourceLimit.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
