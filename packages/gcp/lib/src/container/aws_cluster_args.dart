...
class AwsClusterArgs {
  ...
  AwsClusterArgs({
    ...
    String? project,
       ...
       authorization = pulumi.Input.asInput<AwsClusterAuthorization>(
         authorization,
       ),
       ...
       controlPlane = pulumi.Input.asInput<AwsClusterControlPlane>(
         controlPlane,
       ),
  ...
  factory AwsClusterArgs.fromMap(Map<String, dynamic> map) {
    return AwsClusterArgs(
      ...
      authorization: AwsClusterAuthorization.fromMap(
      ...
      controlPlane: AwsClusterControlPlane.fromMap(
        (map['controlPlane'] as Map).cast<String, dynamic>(),
      ),
      description: map['description'] == null
          ? null
          : map['description'] as String,
      fleet: AwsClusterFleet.fromMap(
      ...
      networking: AwsClusterNetworking.fromMap(
