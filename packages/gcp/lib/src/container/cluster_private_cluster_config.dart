...
class ClusterPrivateClusterConfig {
  ...
  final ClusterPrivateClusterConfigMasterGlobalAccessConfig? masterGlobalAccessConfig;
  ...
  factory ClusterPrivateClusterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterPrivateClusterConfig(
      ...
      masterGlobalAccessConfig: map['masterGlobalAccessConfig'] == null ? null : ClusterPrivateClusterConfigMasterGlobalAccessConfig.fromMap((map['masterGlobalAccessConfig'] as Map).cast<String, dynamic>()),
      ...
      publicEndpoint: map['publicEndpoint'] == null ? null : map['publicEndpoint'] as String,
    );
  }
}
