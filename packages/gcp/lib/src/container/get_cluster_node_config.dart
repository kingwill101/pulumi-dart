...
class GetClusterNodeConfig {
  ...
  final List<GetClusterNodeConfigAdvancedMachineFeature> advancedMachineFeatures;
  ...
  final List<GetClusterNodeConfigEphemeralStorageConfig> ephemeralStorageConfigs;
  /// Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk.
  final List<GetClusterNodeConfigEphemeralStorageLocalSsdConfig> ephemeralStorageLocalSsdConfigs;
  ...
  final List<GetClusterNodeConfigLocalNvmeSsdBlockConfig> localNvmeSsdBlockConfigs;
  ...
  final List<GetClusterNodeConfigShieldedInstanceConfig> shieldedInstanceConfigs;
  ...
  final List<GetClusterNodeConfigWorkloadMetadataConfig> workloadMetadataConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advancedMachineFeatures': pulumi.Input.encodeList<GetClusterNodeConfigAdvancedMachineFeature, Map<String, dynamic>>(advancedMachineFeatures, (value) => value.toMap()),
      'bootDiskKmsKey': bootDiskKmsKey,
      'bootDisks': pulumi.Input.encodeList<GetClusterNodeConfigBootDisk, Map<String, dynamic>>(bootDisks, (value) => value.toMap()),
      'confidentialNodes': pulumi.Input.encodeList<GetClusterNodeConfigConfidentialNode, Map<String, dynamic>>(confidentialNodes, (value) => value.toMap()),
      'containerdConfigs': pulumi.Input.encodeList<GetClusterNodeConfigContainerdConfig, Map<String, dynamic>>(containerdConfigs, (value) => value.toMap()),
      'diskSizeGb': diskSizeGb,
      'diskType': diskType,
      'effectiveTaints': pulumi.Input.encodeList<GetClusterNodeConfigEffectiveTaint, Map<String, dynamic>>(effectiveTaints, (value) => value.toMap()),
      'enableConfidentialStorage': enableConfidentialStorage,
      'ephemeralStorageConfigs': pulumi.Input.encodeList<GetClusterNodeConfigEphemeralStorageConfig, Map<String, dynamic>>(ephemeralStorageConfigs, (value) => value.toMap()),
      'ephemeralStorageLocalSsdConfigs': pulumi.Input.encodeList<GetClusterNodeConfigEphemeralStorageLocalSsdConfig, Map<String, dynamic>>(ephemeralStorageLocalSsdConfigs, (value) => value.toMap()),
      'fastSockets': pulumi.Input.encodeList<GetClusterNodeConfigFastSocket, Map<String, dynamic>>(fastSockets, (value) => value.toMap()),
      'flexStart': flexStart,
      'gcfsConfigs': pulumi.Input.encodeList<GetClusterNodeConfigGcfsConfig, Map<String, dynamic>>(gcfsConfigs, (value) => value.toMap()),
      'guestAccelerators': pulumi.Input.encodeList<GetClusterNodeConfigGuestAccelerator, Map<String, dynamic>>(guestAccelerators, (value) => value.toMap()),
      'gvnics': pulumi.Input.encodeList<GetClusterNodeConfigGvnic, Map<String, dynamic>>(gvnics, (value) => value.toMap()),
      'hostMaintenancePolicies': pulumi.Input.encodeList<GetClusterNodeConfigHostMaintenancePolicy, Map<String, dynamic>>(hostMaintenancePolicies, (value) => value.toMap()),
      'imageType': imageType,
      'kubeletConfigs': pulumi.Input.encodeList<GetClusterNodeConfigKubeletConfig, Map<String, dynamic>>(kubeletConfigs, (value) => value.toMap()),
      'labels': labels,
      'linuxNodeConfigs': pulumi.Input.encodeList<GetClusterNodeConfigLinuxNodeConfig, Map<String, dynamic>>(linuxNodeConfigs, (value) => value.toMap()),
      'localNvmeSsdBlockConfigs': pulumi.Input.encodeList<GetClusterNodeConfigLocalNvmeSsdBlockConfig, Map<String, dynamic>>(localNvmeSsdBlockConfigs, (value) => value.toMap()),
      ...
      'reservationAffinities': pulumi.Input.encodeList<GetClusterNodeConfigReservationAffinity, Map<String, dynamic>>(reservationAffinities, (value) => value.toMap()),
      'resourceLabels': resourceLabels,
      'resourceManagerTags': resourceManagerTags,
      'sandboxConfigs': pulumi.Input.encodeList<GetClusterNodeConfigSandboxConfig, Map<String, dynamic>>(sandboxConfigs, (value) => value.toMap()),
      'secondaryBootDisks': pulumi.Input.encodeList<GetClusterNodeConfigSecondaryBootDisk, Map<String, dynamic>>(secondaryBootDisks, (value) => value.toMap()),
      'serviceAccount': serviceAccount,
      'shieldedInstanceConfigs': pulumi.Input.encodeList<GetClusterNodeConfigShieldedInstanceConfig, Map<String, dynamic>>(shieldedInstanceConfigs, (value) => value.toMap()),
      'soleTenantConfigs': pulumi.Input.encodeList<GetClusterNodeConfigSoleTenantConfig, Map<String, dynamic>>(soleTenantConfigs, (value) => value.toMap()),
      'spot': spot,
      'storagePools': storagePools,
      'tags': tags,
      'taints': pulumi.Input.encodeList<GetClusterNodeConfigTaint, Map<String, dynamic>>(taints, (value) => value.toMap()),
      'windowsNodeConfigs': pulumi.Input.encodeList<GetClusterNodeConfigWindowsNodeConfig, Map<String, dynamic>>(windowsNodeConfigs, (value) => value.toMap()),
      'workloadMetadataConfigs': pulumi.Input.encodeList<GetClusterNodeConfigWorkloadMetadataConfig, Map<String, dynamic>>(workloadMetadataConfigs, (value) => value.toMap()),
    };
  }

  factory GetClusterNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfig(
      advancedMachineFeatures: pulumi.Input.decodeList<GetClusterNodeConfigAdvancedMachineFeature>(map['advancedMachineFeatures'], (value) => GetClusterNodeConfigAdvancedMachineFeature.fromMap((value as Map).cast<String, dynamic>())),
      bootDiskKmsKey: map['bootDiskKmsKey'] as String,
      bootDisks: pulumi.Input.decodeList<GetClusterNodeConfigBootDisk>(map['bootDisks'], (value) => GetClusterNodeConfigBootDisk.fromMap((value as Map).cast<String, dynamic>())),
      confidentialNodes: pulumi.Input.decodeList<GetClusterNodeConfigConfidentialNode>(map['confidentialNodes'], (value) => GetClusterNodeConfigConfidentialNode.fromMap((value as Map).cast<String, dynamic>())),
      containerdConfigs: pulumi.Input.decodeList<GetClusterNodeConfigContainerdConfig>(map['containerdConfigs'], (value) => GetClusterNodeConfigContainerdConfig.fromMap((value as Map).cast<String, dynamic>())),
      diskSizeGb: map['diskSizeGb'] as int,
      diskType: map['diskType'] as String,
      effectiveTaints: pulumi.Input.decodeList<GetClusterNodeConfigEffectiveTaint>(map['effectiveTaints'], (value) => GetClusterNodeConfigEffectiveTaint.fromMap((value as Map).cast<String, dynamic>())),
      enableConfidentialStorage: map['enableConfidentialStorage'] as bool,
      ephemeralStorageConfigs: pulumi.Input.decodeList<GetClusterNodeConfigEphemeralStorageConfig>(map['ephemeralStorageConfigs'], (value) => GetClusterNodeConfigEphemeralStorageConfig.fromMap((value as Map).cast<String, dynamic>())),
      ephemeralStorageLocalSsdConfigs: pulumi.Input.decodeList<GetClusterNodeConfigEphemeralStorageLocalSsdConfig>(map['ephemeralStorageLocalSsdConfigs'], (value) => GetClusterNodeConfigEphemeralStorageLocalSsdConfig.fromMap((value as Map).cast<String, dynamic>())),
      fastSockets: pulumi.Input.decodeList<GetClusterNodeConfigFastSocket>(map['fastSockets'], (value) => GetClusterNodeConfigFastSocket.fromMap((value as Map).cast<String, dynamic>())),
      flexStart: map['flexStart'] as bool,
      gcfsConfigs: pulumi.Input.decodeList<GetClusterNodeConfigGcfsConfig>(map['gcfsConfigs'], (value) => GetClusterNodeConfigGcfsConfig.fromMap((value as Map).cast<String, dynamic>())),
      guestAccelerators: pulumi.Input.decodeList<GetClusterNodeConfigGuestAccelerator>(map['guestAccelerators'], (value) => GetClusterNodeConfigGuestAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      gvnics: pulumi.Input.decodeList<GetClusterNodeConfigGvnic>(map['gvnics'], (value) => GetClusterNodeConfigGvnic.fromMap((value as Map).cast<String, dynamic>())),
      hostMaintenancePolicies: pulumi.Input.decodeList<GetClusterNodeConfigHostMaintenancePolicy>(map['hostMaintenancePolicies'], (value) => GetClusterNodeConfigHostMaintenancePolicy.fromMap((value as Map).cast<String, dynamic>())),
      imageType: map['imageType'] as String,
      kubeletConfigs: pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfig>(map['kubeletConfigs'], (value) => GetClusterNodeConfigKubeletConfig.fromMap((value as Map).cast<String, dynamic>())),
      labels: (map['labels'] as Map).cast<String, String>(),
      linuxNodeConfigs: pulumi.Input.decodeList<GetClusterNodeConfigLinuxNodeConfig>(map['linuxNodeConfigs'], (value) => GetClusterNodeConfigLinuxNodeConfig.fromMap((value as Map).cast<String, dynamic>())),
      localNvmeSsdBlockConfigs: pulumi.Input.decodeList<GetClusterNodeConfigLocalNvmeSsdBlockConfig>(map['localNvmeSsdBlockConfigs'], (value) => GetClusterNodeConfigLocalNvmeSsdBlockConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      reservationAffinities: pulumi.Input.decodeList<GetClusterNodeConfigReservationAffinity>(map['reservationAffinities'], (value) => GetClusterNodeConfigReservationAffinity.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sandboxConfigs: pulumi.Input.decodeList<GetClusterNodeConfigSandboxConfig>(map['sandboxConfigs'], (value) => GetClusterNodeConfigSandboxConfig.fromMap((value as Map).cast<String, dynamic>())),
      secondaryBootDisks: pulumi.Input.decodeList<GetClusterNodeConfigSecondaryBootDisk>(map['secondaryBootDisks'], (value) => GetClusterNodeConfigSecondaryBootDisk.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] as String,
      shieldedInstanceConfigs: pulumi.Input.decodeList<GetClusterNodeConfigShieldedInstanceConfig>(map['shieldedInstanceConfigs'], (value) => GetClusterNodeConfigShieldedInstanceConfig.fromMap((value as Map).cast<String, dynamic>())),
      soleTenantConfigs: pulumi.Input.decodeList<GetClusterNodeConfigSoleTenantConfig>(map['soleTenantConfigs'], (value) => GetClusterNodeConfigSoleTenantConfig.fromMap((value as Map).cast<String, dynamic>())),
      spot: map['spot'] as bool,
      storagePools: (map['storagePools'] as List).cast<String>(),
      tags: (map['tags'] as List).cast<String>(),
      taints: pulumi.Input.decodeList<GetClusterNodeConfigTaint>(map['taints'], (value) => GetClusterNodeConfigTaint.fromMap((value as Map).cast<String, dynamic>())),
      windowsNodeConfigs: pulumi.Input.decodeList<GetClusterNodeConfigWindowsNodeConfig>(map['windowsNodeConfigs'], (value) => GetClusterNodeConfigWindowsNodeConfig.fromMap((value as Map).cast<String, dynamic>())),
      workloadMetadataConfigs: pulumi.Input.decodeList<GetClusterNodeConfigWorkloadMetadataConfig>(map['workloadMetadataConfigs'], (value) => GetClusterNodeConfigWorkloadMetadataConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
