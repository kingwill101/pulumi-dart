...
class GetClusterNodePoolNodeConfigKubeletConfig {
  ...
  final List<GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim>
  ...
  final List<GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod>
  evictionSoftGracePeriods;

  /// Defines a map of signal names to quantities or percentage that defines soft eviction thresholds.
  final List<GetClusterNodePoolNodeConfigKubeletConfigEvictionSoft>
  evictionSofts;
  ...
  final List<GetClusterNodePoolNodeConfigKubeletConfigMemoryManager>
  memoryManagers;
  ...
  final List<GetClusterNodePoolNodeConfigKubeletConfigTopologyManager>
  topologyManagers;
    ...
    return <String, dynamic>{
      ...
      'evictionSofts':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(evictionSofts, (value) => value.toMap()),
      ...
      'memoryManagers':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(memoryManagers, (value) => value.toMap()),
      ...
      'topologyManagers':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(topologyManagers, (value) => value.toMap()),
    };
  }

  factory GetClusterNodePoolNodeConfigKubeletConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetClusterNodePoolNodeConfigKubeletConfig(
      allowedUnsafeSysctls: (map['allowedUnsafeSysctls'] as List)
          .cast<String>(),
      ...
      evictionMinimumReclaims:
          ...
          >(
            ...
            (value) =>
                GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim.fromMap(
      ...
      evictionSoftGracePeriods:
          ...
          >(
            ...
            (value) =>
                GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      evictionSofts:
          ...
          >(
            map['evictionSofts'],
            (value) =>
                GetClusterNodePoolNodeConfigKubeletConfigEvictionSoft.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      ...
      memoryManagers:
          ...
          >(
            map['memoryManagers'],
            (value) =>
                GetClusterNodePoolNodeConfigKubeletConfigMemoryManager.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      ...
      topologyManagers:
          ...
          >(
            ...
            (value) =>
                GetClusterNodePoolNodeConfigKubeletConfigTopologyManager.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
    );
