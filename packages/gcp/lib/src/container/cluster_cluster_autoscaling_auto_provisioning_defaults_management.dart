...
class ClusterClusterAutoscalingAutoProvisioningDefaultsManagement {
  ...
  final List<ClusterClusterAutoscalingAutoProvisioningDefaultsManagementUpgradeOption>? upgradeOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'upgradeOptions': ?upgradeOptions == null ? null : pulumi.Input.encodeList<ClusterClusterAutoscalingAutoProvisioningDefaultsManagementUpgradeOption, Map<String, dynamic>>(upgradeOptions!, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterClusterAutoscalingAutoProvisioningDefaultsManagement.fromMap(Map<String, dynamic> map) {
    return ClusterClusterAutoscalingAutoProvisioningDefaultsManagement(
      ...
      upgradeOptions: map['upgradeOptions'] == null ? null : pulumi.Input.decodeList<ClusterClusterAutoscalingAutoProvisioningDefaultsManagementUpgradeOption>(map['upgradeOptions'], (value) => ClusterClusterAutoscalingAutoProvisioningDefaultsManagementUpgradeOption.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
