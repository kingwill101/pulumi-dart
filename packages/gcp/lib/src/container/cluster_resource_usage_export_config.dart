...
class ClusterResourceUsageExportConfig {
  ...
  factory ClusterResourceUsageExportConfig.fromMap(Map<String, dynamic> map) {
    return ClusterResourceUsageExportConfig(
      bigqueryDestination: ClusterResourceUsageExportConfigBigqueryDestination.fromMap((map['bigqueryDestination'] as Map).cast<String, dynamic>()),
      enableNetworkEgressMetering: map['enableNetworkEgressMetering'] == null ? null : map['enableNetworkEgressMetering'] as bool,
      enableResourceConsumptionMetering: map['enableResourceConsumptionMetering'] == null ? null : map['enableResourceConsumptionMetering'] as bool,
    );
  }
}
