...
class AzureNodePoolConfig {
  ...
  factory AzureNodePoolConfig.fromMap(Map<String, dynamic> map) {
    return AzureNodePoolConfig(
      ...
      proxyConfig: map['proxyConfig'] == null ? null : AzureNodePoolConfigProxyConfig.fromMap((map['proxyConfig'] as Map).cast<String, dynamic>()),
      rootVolume: map['rootVolume'] == null ? null : AzureNodePoolConfigRootVolume.fromMap((map['rootVolume'] as Map).cast<String, dynamic>()),
      sshConfig: AzureNodePoolConfigSshConfig.fromMap((map['sshConfig'] as Map).cast<String, dynamic>()),
