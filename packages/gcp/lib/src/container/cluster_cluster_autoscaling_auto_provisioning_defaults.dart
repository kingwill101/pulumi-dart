...
class ClusterClusterAutoscalingAutoProvisioningDefaults {
  ...
  final ClusterClusterAutoscalingAutoProvisioningDefaultsShieldedInstanceConfig? shieldedInstanceConfig;
  /// Specifies the upgrade settings for NAP created node pools
  final ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings? upgradeSettings;
  ...
  factory ClusterClusterAutoscalingAutoProvisioningDefaults.fromMap(Map<String, dynamic> map) {
    return ClusterClusterAutoscalingAutoProvisioningDefaults(
      ...
      management: map['management'] == null ? null : ClusterClusterAutoscalingAutoProvisioningDefaultsManagement.fromMap((map['management'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : ClusterClusterAutoscalingAutoProvisioningDefaultsShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      upgradeSettings: map['upgradeSettings'] == null ? null : ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
