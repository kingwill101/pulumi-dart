...
import 'region_url_map_path_matcher_path_rule_route_action_weighted_backend_service_header_action.dart';
...
class RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService {
  ...
  final RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderAction? headerAction;
  /// Specifies the fraction of traffic sent to a backend service, computed as weight / (sum of all weightedBackendService weights in routeAction) .
  /// The selection of a backend service is determined only for new traffic. Once a user's request has been directed to a backend service, subsequent requests are sent to the same backend service as determined by the backend service's session affinity policy.
  /// The value must be from 0 to 1000.
  final int weight;

  /// Creates a new [RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService].
  ...
  factory RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService(
      backendService: map['backendService'] as String,
      headerAction: map['headerAction'] == null ? null : RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderAction.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
