...
class SnapshotArgs {
  ...
  factory SnapshotArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotArgs(
      ...
      snapshotEncryptionKey: map['snapshotEncryptionKey'] == null ? null : SnapshotSnapshotEncryptionKey.fromMap((map['snapshotEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      sourceDiskEncryptionKey: map['sourceDiskEncryptionKey'] == null ? null : SnapshotSourceDiskEncryptionKey.fromMap((map['sourceDiskEncryptionKey'] as Map).cast<String, dynamic>()),
