...
class RegionBackendServiceArgs {
  ...
  RegionBackendServiceArgs({
    ...
    RegionBackendServiceTlsSettings? tlsSettings,
        ...
        backends =
            pulumi.Input.asOptionalInput<List<RegionBackendServiceBackend>>(
                backends),
        ...
        connectionDrainingTimeoutSec =
            pulumi.Input.asOptionalInput<int>(connectionDrainingTimeoutSec),
        ...
        consistentHash =
            pulumi.Input.asOptionalInput<RegionBackendServiceConsistentHash>(
                consistentHash),
        customMetrics = pulumi.Input.asOptionalInput<
            List<RegionBackendServiceCustomMetric>>(customMetrics),
        ...
        ipAddressSelectionPolicy =
            pulumi.Input.asOptionalInput<String>(ipAddressSelectionPolicy),
        loadBalancingScheme =
            pulumi.Input.asOptionalInput<String>(loadBalancingScheme),
        localityLbPolicy =
            pulumi.Input.asOptionalInput<String>(localityLbPolicy),
        ...
        outlierDetection =
            pulumi.Input.asOptionalInput<RegionBackendServiceOutlierDetection>(
                outlierDetection),
        params =
            pulumi.Input.asOptionalInput<RegionBackendServiceParams>(params),
        ...
        strongSessionAffinityCookie = pulumi.Input.asOptionalInput<
            ...
            strongSessionAffinityCookie),
        subsetting =
            pulumi.Input.asOptionalInput<RegionBackendServiceSubsetting>(
                subsetting),
  ...
  factory RegionBackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs(
      ...
      healthChecks:
          map['healthChecks'] == null ? null : map['healthChecks'] as String,
      iap: map['iap'] == null
          ? null
