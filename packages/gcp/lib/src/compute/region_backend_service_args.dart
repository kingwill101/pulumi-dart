...
class RegionBackendServiceArgs {
  ...
  RegionBackendServiceArgs({
    ...
    String? name,
    String? network,
    RegionBackendServiceNetworkPassThroughLbTrafficPolicy? networkPassThroughLbTrafficPolicy,
    ...
    RegionBackendServiceStrongSessionAffinityCookie? strongSessionAffinityCookie,
    ...
    RegionBackendServiceTlsSettings? tlsSettings,
      ...
      backends = pulumi.Input.asOptionalInput<List<RegionBackendServiceBackend>>(backends),
      cdnPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceCdnPolicy>(cdnPolicy),
      circuitBreakers = pulumi.Input.asOptionalInput<RegionBackendServiceCircuitBreakers>(circuitBreakers),
      connectionDrainingTimeoutSec = pulumi.Input.asOptionalInput<int>(connectionDrainingTimeoutSec),
      connectionTrackingPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceConnectionTrackingPolicy>(connectionTrackingPolicy),
      consistentHash = pulumi.Input.asOptionalInput<RegionBackendServiceConsistentHash>(consistentHash),
      customMetrics = pulumi.Input.asOptionalInput<List<RegionBackendServiceCustomMetric>>(customMetrics),
      description = pulumi.Input.asOptionalInput<String>(description),
      dynamicForwarding = pulumi.Input.asOptionalInput<RegionBackendServiceDynamicForwarding>(dynamicForwarding),
      enableCdn = pulumi.Input.asOptionalInput<bool>(enableCdn),
      failoverPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceFailoverPolicy>(failoverPolicy),
      haPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceHaPolicy>(haPolicy),
      ...
      ipAddressSelectionPolicy = pulumi.Input.asOptionalInput<String>(ipAddressSelectionPolicy),
      loadBalancingScheme = pulumi.Input.asOptionalInput<String>(loadBalancingScheme),
      localityLbPolicy = pulumi.Input.asOptionalInput<String>(localityLbPolicy),
      logConfig = pulumi.Input.asOptionalInput<RegionBackendServiceLogConfig>(logConfig),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkPassThroughLbTrafficPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceNetworkPassThroughLbTrafficPolicy>(networkPassThroughLbTrafficPolicy),
      outlierDetection = pulumi.Input.asOptionalInput<RegionBackendServiceOutlierDetection>(outlierDetection),
      params = pulumi.Input.asOptionalInput<RegionBackendServiceParams>(params),
      ...
      strongSessionAffinityCookie = pulumi.Input.asOptionalInput<RegionBackendServiceStrongSessionAffinityCookie>(strongSessionAffinityCookie),
      subsetting = pulumi.Input.asOptionalInput<RegionBackendServiceSubsetting>(subsetting),
      timeoutSec = pulumi.Input.asOptionalInput<int>(timeoutSec),
      tlsSettings = pulumi.Input.asOptionalInput<RegionBackendServiceTlsSettings>(tlsSettings);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'affinityCookieTtlSec': ?affinityCookieTtlSec,
      'backends': ?pulumi.Input.mapOptionalInputValue<List<RegionBackendServiceBackend>, List<Map<String, dynamic>>>(backends, (value) => pulumi.Input.encodeList<RegionBackendServiceBackend, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cdnPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceCdnPolicy, Map<String, dynamic>>(cdnPolicy, (value) => value.toMap()),
      'circuitBreakers': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceCircuitBreakers, Map<String, dynamic>>(circuitBreakers, (value) => value.toMap()),
      'connectionDrainingTimeoutSec': ?connectionDrainingTimeoutSec,
      'connectionTrackingPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceConnectionTrackingPolicy, Map<String, dynamic>>(connectionTrackingPolicy, (value) => value.toMap()),
      'consistentHash': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceConsistentHash, Map<String, dynamic>>(consistentHash, (value) => value.toMap()),
      'customMetrics': ?pulumi.Input.mapOptionalInputValue<List<RegionBackendServiceCustomMetric>, List<Map<String, dynamic>>>(customMetrics, (value) => pulumi.Input.encodeList<RegionBackendServiceCustomMetric, Map<String, dynamic>>(value, (value) => value.toMap())),
      'description': ?description,
      'dynamicForwarding': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceDynamicForwarding, Map<String, dynamic>>(dynamicForwarding, (value) => value.toMap()),
      'enableCdn': ?enableCdn,
      'failoverPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceFailoverPolicy, Map<String, dynamic>>(failoverPolicy, (value) => value.toMap()),
      'haPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceHaPolicy, Map<String, dynamic>>(haPolicy, (value) => value.toMap()),
      'healthChecks': ?healthChecks,
      'iap': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceIap, Map<String, dynamic>>(iap, (value) => value.toMap()),
      'ipAddressSelectionPolicy': ?ipAddressSelectionPolicy,
      'loadBalancingScheme': ?loadBalancingScheme,
      'localityLbPolicy': ?localityLbPolicy,
      'logConfig': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLogConfig, Map<String, dynamic>>(logConfig, (value) => value.toMap()),
      'name': ?name,
      'network': ?network,
      'networkPassThroughLbTrafficPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceNetworkPassThroughLbTrafficPolicy, Map<String, dynamic>>(networkPassThroughLbTrafficPolicy, (value) => value.toMap()),
      'outlierDetection': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceOutlierDetection, Map<String, dynamic>>(outlierDetection, (value) => value.toMap()),
      'params': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceParams, Map<String, dynamic>>(params, (value) => value.toMap()),
      'portName': ?portName,
      'project': ?project,
      'protocol': ?protocol,
      'region': ?region,
      ...
      'strongSessionAffinityCookie': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceStrongSessionAffinityCookie, Map<String, dynamic>>(strongSessionAffinityCookie, (value) => value.toMap()),
      'subsetting': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceSubsetting, Map<String, dynamic>>(subsetting, (value) => value.toMap()),
      'timeoutSec': ?timeoutSec,
      'tlsSettings': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceTlsSettings, Map<String, dynamic>>(tlsSettings, (value) => value.toMap()),
    };
  }

  factory RegionBackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs(
      affinityCookieTtlSec: map['affinityCookieTtlSec'] == null ? null : map['affinityCookieTtlSec'] as int,
      backends: map['backends'] == null ? null : pulumi.Input.decodeList<RegionBackendServiceBackend>(map['backends'], (value) => RegionBackendServiceBackend.fromMap((value as Map).cast<String, dynamic>())),
      cdnPolicy: map['cdnPolicy'] == null ? null : RegionBackendServiceCdnPolicy.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: map['circuitBreakers'] == null ? null : RegionBackendServiceCircuitBreakers.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>()),
      connectionDrainingTimeoutSec: map['connectionDrainingTimeoutSec'] == null ? null : map['connectionDrainingTimeoutSec'] as int,
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : RegionBackendServiceConnectionTrackingPolicy.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: map['consistentHash'] == null ? null : RegionBackendServiceConsistentHash.fromMap((map['consistentHash'] as Map).cast<String, dynamic>()),
      customMetrics: map['customMetrics'] == null ? null : pulumi.Input.decodeList<RegionBackendServiceCustomMetric>(map['customMetrics'], (value) => RegionBackendServiceCustomMetric.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      dynamicForwarding: map['dynamicForwarding'] == null ? null : RegionBackendServiceDynamicForwarding.fromMap((map['dynamicForwarding'] as Map).cast<String, dynamic>()),
      enableCdn: map['enableCdn'] == null ? null : map['enableCdn'] as bool,
      failoverPolicy: map['failoverPolicy'] == null ? null : RegionBackendServiceFailoverPolicy.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>()),
      haPolicy: map['haPolicy'] == null ? null : RegionBackendServiceHaPolicy.fromMap((map['haPolicy'] as Map).cast<String, dynamic>()),
      healthChecks: map['healthChecks'] == null ? null : map['healthChecks'] as String,
      iap: map['iap'] == null ? null : RegionBackendServiceIap.fromMap((map['iap'] as Map).cast<String, dynamic>()),
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : map['ipAddressSelectionPolicy'] as String,
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : map['loadBalancingScheme'] as String,
      localityLbPolicy: map['localityLbPolicy'] == null ? null : map['localityLbPolicy'] as String,
      logConfig: map['logConfig'] == null ? null : RegionBackendServiceLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkPassThroughLbTrafficPolicy: map['networkPassThroughLbTrafficPolicy'] == null ? null : RegionBackendServiceNetworkPassThroughLbTrafficPolicy.fromMap((map['networkPassThroughLbTrafficPolicy'] as Map).cast<String, dynamic>()),
      outlierDetection: map['outlierDetection'] == null ? null : RegionBackendServiceOutlierDetection.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>()),
      params: map['params'] == null ? null : RegionBackendServiceParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      ...
      strongSessionAffinityCookie: map['strongSessionAffinityCookie'] == null ? null : RegionBackendServiceStrongSessionAffinityCookie.fromMap((map['strongSessionAffinityCookie'] as Map).cast<String, dynamic>()),
      subsetting: map['subsetting'] == null ? null : RegionBackendServiceSubsetting.fromMap((map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] == null ? null : map['timeoutSec'] as int,
      tlsSettings: map['tlsSettings'] == null ? null : RegionBackendServiceTlsSettings.fromMap((map['tlsSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
