...
/// {@template pulumi_compute_instant_snapshot_iam_binding_instant_snapshot_iam_binding_args_doc}
/// The set of arguments for InstantSnapshotIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_instant_snapshot_iam_binding_instant_snapshot_iam_binding_args_doc}
class InstantSnapshotIamBindingArgs {
  ...
  /// Creates a new [InstantSnapshotIamBindingArgs].
  ...
  InstantSnapshotIamBindingArgs({
    InstantSnapshotIamBindingCondition? condition,
  ...
  factory InstantSnapshotIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotIamBindingArgs(
      condition: map['condition'] == null ? null : InstantSnapshotIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
