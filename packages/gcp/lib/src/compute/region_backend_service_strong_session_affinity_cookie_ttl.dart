...
class RegionBackendServiceStrongSessionAffinityCookieTtl {
  ...
  factory RegionBackendServiceStrongSessionAffinityCookieTtl.fromMap(
      Map<String, dynamic> map) {
    return RegionBackendServiceStrongSessionAffinityCookieTtl(
