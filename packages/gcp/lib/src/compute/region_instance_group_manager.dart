...
class RegionInstanceGroupManager extends pulumi.CustomResource {
  ...
  RegionInstanceGroupManager(
    ...
    this.distributionPolicyTargetShape = registerOutput<String>(
      'distributionPolicyTargetShape',
    );
    this.distributionPolicyZones = registerOutput<List<String>>(
      'distributionPolicyZones',
    );
    ...
    this.statuses = registerOutput<List<RegionInstanceGroupManagerStatus>>(
      'statuses',
    );
    ...
    this.updatePolicy = registerOutput<RegionInstanceGroupManagerUpdatePolicy>(
      'updatePolicy',
    );
    this.versions = registerOutput<List<RegionInstanceGroupManagerVersion>>(
      'versions',
    );
