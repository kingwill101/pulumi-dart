...
class NetworkArgs {
  ...
  NetworkArgs({
    ...
    String? routingMode,
            ...
            pulumi.Input.asOptionalInput<bool>(autoCreateSubnetworks),
        bgpAlwaysCompareMed =
            pulumi.Input.asOptionalInput<bool>(bgpAlwaysCompareMed),
        bgpBestPathSelectionMode =
            pulumi.Input.asOptionalInput<String>(bgpBestPathSelectionMode),
        bgpInterRegionCost =
            pulumi.Input.asOptionalInput<String>(bgpInterRegionCost),
        deleteBgpAlwaysCompareMed =
            pulumi.Input.asOptionalInput<bool>(deleteBgpAlwaysCompareMed),
        deleteDefaultRoutesOnCreate =
            pulumi.Input.asOptionalInput<bool>(deleteDefaultRoutesOnCreate),
        description = pulumi.Input.asOptionalInput<String>(description),
        enableUlaInternalIpv6 =
            pulumi.Input.asOptionalInput<bool>(enableUlaInternalIpv6),
        internalIpv6Range =
            pulumi.Input.asOptionalInput<String>(internalIpv6Range),
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      ...
      deleteBgpAlwaysCompareMed: map['deleteBgpAlwaysCompareMed'] == null
          ? null
          : map['deleteBgpAlwaysCompareMed'] as bool,
      deleteDefaultRoutesOnCreate: map['deleteDefaultRoutesOnCreate'] == null
          ? null
          : map['deleteDefaultRoutesOnCreate'] as bool,
      description:
