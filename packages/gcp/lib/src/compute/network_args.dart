...
class NetworkArgs {
  ...
  NetworkArgs({
    ...
    String? routingMode,
      ...
      bgpAlwaysCompareMed = pulumi.Input.asOptionalInput<bool>(bgpAlwaysCompareMed),
      bgpBestPathSelectionMode = pulumi.Input.asOptionalInput<String>(bgpBestPathSelectionMode),
      bgpInterRegionCost = pulumi.Input.asOptionalInput<String>(bgpInterRegionCost),
      deleteBgpAlwaysCompareMed = pulumi.Input.asOptionalInput<bool>(deleteBgpAlwaysCompareMed),
      deleteDefaultRoutesOnCreate = pulumi.Input.asOptionalInput<bool>(deleteDefaultRoutesOnCreate),
      ...
      networkFirewallPolicyEnforcementOrder = pulumi.Input.asOptionalInput<String>(networkFirewallPolicyEnforcementOrder),
      networkProfile = pulumi.Input.asOptionalInput<String>(networkProfile),
      params = pulumi.Input.asOptionalInput<NetworkParams>(params),
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      autoCreateSubnetworks: map['autoCreateSubnetworks'] == null ? null : map['autoCreateSubnetworks'] as bool,
      bgpAlwaysCompareMed: map['bgpAlwaysCompareMed'] == null ? null : map['bgpAlwaysCompareMed'] as bool,
      bgpBestPathSelectionMode: map['bgpBestPathSelectionMode'] == null ? null : map['bgpBestPathSelectionMode'] as String,
      bgpInterRegionCost: map['bgpInterRegionCost'] == null ? null : map['bgpInterRegionCost'] as String,
      deleteBgpAlwaysCompareMed: map['deleteBgpAlwaysCompareMed'] == null ? null : map['deleteBgpAlwaysCompareMed'] as bool,
      deleteDefaultRoutesOnCreate: map['deleteDefaultRoutesOnCreate'] == null ? null : map['deleteDefaultRoutesOnCreate'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      enableUlaInternalIpv6: map['enableUlaInternalIpv6'] == null ? null : map['enableUlaInternalIpv6'] as bool,
      internalIpv6Range: map['internalIpv6Range'] == null ? null : map['internalIpv6Range'] as String,
      mtu: map['mtu'] == null ? null : map['mtu'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      networkFirewallPolicyEnforcementOrder: map['networkFirewallPolicyEnforcementOrder'] == null ? null : map['networkFirewallPolicyEnforcementOrder'] as String,
      networkProfile: map['networkProfile'] == null ? null : map['networkProfile'] as String,
      params: map['params'] == null ? null : NetworkParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
