...
class NetworkArgs {
  ...
  NetworkArgs({
    ...
    String? routingMode,
       ...
       bgpAlwaysCompareMed = pulumi.Input.asOptionalInput<bool>(
         bgpAlwaysCompareMed,
       ),
       bgpBestPathSelectionMode = pulumi.Input.asOptionalInput<String>(
         bgpBestPathSelectionMode,
       ),
       bgpInterRegionCost = pulumi.Input.asOptionalInput<String>(
         bgpInterRegionCost,
       ),
       deleteBgpAlwaysCompareMed = pulumi.Input.asOptionalInput<bool>(
