...
class GetRegionBackendServiceTlsSetting {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sni': sni,
      'subjectAltNames': pulumi.Input.encodeList<GetRegionBackendServiceTlsSettingSubjectAltName, Map<String, dynamic>>(subjectAltNames, (value) => value.toMap()),
    };
  }
  ...
  factory GetRegionBackendServiceTlsSetting.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceTlsSetting(
      ...
      subjectAltNames: pulumi.Input.decodeList<GetRegionBackendServiceTlsSettingSubjectAltName>(map['subjectAltNames'], (value) => GetRegionBackendServiceTlsSettingSubjectAltName.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
