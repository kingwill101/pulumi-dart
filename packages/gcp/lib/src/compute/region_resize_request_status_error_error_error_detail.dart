      ...
      errorInfos: map['errorInfos'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['errorInfos'],
              (value) =>
                  RegionResizeRequestStatusErrorErrorErrorDetailErrorInfo.fromMap(
      ...
      localizedMessages: map['localizedMessages'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  RegionResizeRequestStatusErrorErrorErrorDetailLocalizedMessage.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      quotaInfos: map['quotaInfos'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['quotaInfos'],
              (value) =>
                  RegionResizeRequestStatusErrorErrorErrorDetailQuotaInfo.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
    );
