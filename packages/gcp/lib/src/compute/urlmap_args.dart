  ...
  URLMapArgs({
    ...
    List<URLMapTest>? tests,
       ...
       defaultRouteAction = pulumi
           .Input.asOptionalInput<URLMapDefaultRouteAction>(defaultRouteAction),
       defaultService = pulumi.Input.asOptionalInput<String>(defaultService),
       defaultUrlRedirect = pulumi
           .Input.asOptionalInput<URLMapDefaultUrlRedirect>(defaultUrlRedirect),
       description = pulumi.Input.asOptionalInput<String>(description),
       headerAction = pulumi.Input.asOptionalInput<URLMapHeaderAction>(
         headerAction,
       ),
       hostRules = pulumi.Input.asOptionalInput<List<URLMapHostRule>>(
         hostRules,
       ),
  ...
  factory URLMapArgs.fromMap(Map<String, dynamic> map) {
    return URLMapArgs(
      ...
      defaultUrlRedirect: map['defaultUrlRedirect'] == null
          ? null
          : URLMapDefaultUrlRedirect.fromMap(
      ...
      headerAction: map['headerAction'] == null
          ? null
          : URLMapHeaderAction.fromMap(
              (map['headerAction'] as Map).cast<String, dynamic>(),
            ),
      hostRules: map['hostRules'] == null
          ? null
          : pulumi.Input.decodeList<URLMapHostRule>(
              map['hostRules'],
              (value) => URLMapHostRule.fromMap(
      ...
      pathMatchers: map['pathMatchers'] == null
          ? null
          : pulumi.Input.decodeList<URLMapPathMatcher>(
              map['pathMatchers'],
              (value) => URLMapPathMatcher.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
