...
class URLMapArgs {
  ...
  URLMapArgs({
    URLMapDefaultCustomErrorResponsePolicy? defaultCustomErrorResponsePolicy,
    URLMapDefaultRouteAction? defaultRouteAction,
    String? defaultService,
    URLMapDefaultUrlRedirect? defaultUrlRedirect,
    String? description,
  ...
  factory URLMapArgs.fromMap(Map<String, dynamic> map) {
    return URLMapArgs(
      defaultCustomErrorResponsePolicy: map['defaultCustomErrorResponsePolicy'] == null ? null : URLMapDefaultCustomErrorResponsePolicy.fromMap((map['defaultCustomErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      defaultRouteAction: map['defaultRouteAction'] == null ? null : URLMapDefaultRouteAction.fromMap((map['defaultRouteAction'] as Map).cast<String, dynamic>()),
      defaultService: map['defaultService'] == null ? null : map['defaultService'] as String,
      defaultUrlRedirect: map['defaultUrlRedirect'] == null ? null : URLMapDefaultUrlRedirect.fromMap((map['defaultUrlRedirect'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      headerAction: map['headerAction'] == null ? null : URLMapHeaderAction.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      hostRules: map['hostRules'] == null ? null : pulumi.Input.decodeList<URLMapHostRule>(map['hostRules'], (value) => URLMapHostRule.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      pathMatchers: map['pathMatchers'] == null ? null : pulumi.Input.decodeList<URLMapPathMatcher>(map['pathMatchers'], (value) => URLMapPathMatcher.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      tests: map['tests'] == null ? null : pulumi.Input.decodeList<URLMapTest>(map['tests'], (value) => URLMapTest.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
