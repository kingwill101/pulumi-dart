...
class URLMapArgs {
  ...
  URLMapArgs({
    ...
    List<URLMapTest>? tests,
  })  : defaultCustomErrorResponsePolicy = pulumi.Input.asOptionalInput<
        ...
        headerAction =
            pulumi.Input.asOptionalInput<URLMapHeaderAction>(headerAction),
        hostRules =
            pulumi.Input.asOptionalInput<List<URLMapHostRule>>(hostRules),
        name = pulumi.Input.asOptionalInput<String>(name),
        pathMatchers =
            pulumi.Input.asOptionalInput<List<URLMapPathMatcher>>(pathMatchers),
