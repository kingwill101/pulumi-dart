...
class FirewallPolicyWithRulesPredefinedRuleMatch {
  ...
  final List<FirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>?
      layer4Configs;
  ...
  /// Structure is documented below.
  final List<FirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>?
      srcSecureTags;
    ...
    return FirewallPolicyWithRulesPredefinedRuleMatch(
      ...
      layer4Configs: map['layer4Configs'] == null
          ...
          : pulumi.Input.decodeList<
                  FirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>(
              map['layer4Configs'],
              (value) => FirewallPolicyWithRulesPredefinedRuleMatchLayer4Config
      ...
      srcSecureTags: map['srcSecureTags'] == null
          ...
          : pulumi.Input.decodeList<
                  FirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>(
              map['srcSecureTags'],
              (value) => FirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag
                  .fromMap((value as Map).cast<String, dynamic>())),
