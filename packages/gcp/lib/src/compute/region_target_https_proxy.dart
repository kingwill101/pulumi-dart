...
class RegionTargetHttpsProxy extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionTargetHttpsProxy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionTargetHttpsProxy]. {@macro pulumi_compute_region_target_https_proxy_region_target_https_proxy_args_doc}
  ...
  RegionTargetHttpsProxy(
    ...
    this.certificateManagerCertificates = registerOutput<List<String>?>(
