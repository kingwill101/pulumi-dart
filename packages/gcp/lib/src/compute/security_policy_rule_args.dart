...
class SecurityPolicyRuleArgs {
  ...
  /// Structure is documented below.
  final pulumi.Input<SecurityPolicyRulePreconfiguredWafConfig>?
  ...
  SecurityPolicyRuleArgs({
    ...
    String? description,
    SecurityPolicyRuleHeaderAction? headerAction,
    ...
    required String securityPolicy,
        ...
        headerAction =
            pulumi.Input.asOptionalInput<SecurityPolicyRuleHeaderAction>(
                headerAction),
        ...
        rateLimitOptions =
            pulumi.Input.asOptionalInput<SecurityPolicyRuleRateLimitOptions>(
                rateLimitOptions),
        redirectOptions =
            pulumi.Input.asOptionalInput<SecurityPolicyRuleRedirectOptions>(
                redirectOptions),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (matchValue != null) {
      map['match'] = pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleMatch,
    ...
    if (redirectOptionsValue != null) {
      map['redirectOptions'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory SecurityPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleArgs(
      ...
      match: map['match'] == null
          ? null
          : SecurityPolicyRuleMatch.fromMap(
