...
class RegionInstanceGroupManagerUpdatePolicy {
  ...
  factory RegionInstanceGroupManagerUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerUpdatePolicy(
      instanceRedistributionType: map['instanceRedistributionType'] == null ? null : map['instanceRedistributionType'] as String,
      maxSurgeFixed: map['maxSurgeFixed'] == null ? null : map['maxSurgeFixed'] as int,
      maxSurgePercent: map['maxSurgePercent'] == null ? null : map['maxSurgePercent'] as int,
      maxUnavailableFixed: map['maxUnavailableFixed'] == null ? null : map['maxUnavailableFixed'] as int,
      maxUnavailablePercent: map['maxUnavailablePercent'] == null ? null : map['maxUnavailablePercent'] as int,
      ...
      replacementMethod: map['replacementMethod'] == null ? null : map['replacementMethod'] as String,
