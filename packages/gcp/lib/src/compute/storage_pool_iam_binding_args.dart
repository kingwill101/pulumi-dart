...
class StoragePoolIamBindingArgs {
  ...
  StoragePoolIamBindingArgs({
    StoragePoolIamBindingCondition? condition,
  ...
  factory StoragePoolIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolIamBindingArgs(
      condition: map['condition'] == null ? null : StoragePoolIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
