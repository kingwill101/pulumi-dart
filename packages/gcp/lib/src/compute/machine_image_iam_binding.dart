...
class MachineImageIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<MachineImageIamBindingCondition?> condition;
  ...
  /// Creates a new [MachineImageIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MachineImageIamBinding]. {@macro pulumi_compute_machine_image_iam_binding_machine_image_iam_binding_args_doc}
  ...
  MachineImageIamBinding(
    ...
    this.condition = registerOutput<MachineImageIamBindingCondition?>('condition');
