...
class URLMapPathMatcherPathRuleRouteActionCorsPolicy {
  ...
  /// Creates a new [URLMapPathMatcherPathRuleRouteActionCorsPolicy].
  ...
  factory URLMapPathMatcherPathRuleRouteActionCorsPolicy.fromMap(
