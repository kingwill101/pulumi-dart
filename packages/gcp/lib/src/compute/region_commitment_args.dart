  ...
  RegionCommitmentArgs({
    ...
    String? type,
        ...
        existingReservations =
            pulumi.Input.asOptionalInput<String>(existingReservations),
        licenseResource =
            pulumi.Input.asOptionalInput<RegionCommitmentLicenseResource>(
                licenseResource),
        ...
        resources =
            pulumi.Input.asOptionalInput<List<RegionCommitmentResource>>(
                resources),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (resourcesValue != null) {
      map['resources'] = pulumi.Input.mapOptionalInputValue<
          ...
          resourcesValue,
          (value) => pulumi.Input.encodeList<RegionCommitmentResource,
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      existingReservations: map['existingReservations'] == null
          ? null
          : map['existingReservations'] as String,
