...
class RegionInstanceTemplateNetworkInterface {
  ...
  final List<RegionInstanceTemplateNetworkInterfaceIpv6AccessConfig>? ipv6AccessConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': ?accessConfigs == null ? null : pulumi.Input.encodeList<RegionInstanceTemplateNetworkInterfaceAccessConfig, Map<String, dynamic>>(accessConfigs!, (value) => value.toMap()),
      'aliasIpRanges': ?aliasIpRanges == null ? null : pulumi.Input.encodeList<RegionInstanceTemplateNetworkInterfaceAliasIpRange, Map<String, dynamic>>(aliasIpRanges!, (value) => value.toMap()),
      'igmpQuery': ?igmpQuery,
      'internalIpv6PrefixLength': ?internalIpv6PrefixLength,
      'ipv6AccessConfigs': ?ipv6AccessConfigs == null ? null : pulumi.Input.encodeList<RegionInstanceTemplateNetworkInterfaceIpv6AccessConfig, Map<String, dynamic>>(ipv6AccessConfigs!, (value) => value.toMap()),
  ...
  factory RegionInstanceTemplateNetworkInterface.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateNetworkInterface(
      accessConfigs: map['accessConfigs'] == null ? null : pulumi.Input.decodeList<RegionInstanceTemplateNetworkInterfaceAccessConfig>(map['accessConfigs'], (value) => RegionInstanceTemplateNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null ? null : pulumi.Input.decodeList<RegionInstanceTemplateNetworkInterfaceAliasIpRange>(map['aliasIpRanges'], (value) => RegionInstanceTemplateNetworkInterfaceAliasIpRange.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ipv6AccessConfigs: map['ipv6AccessConfigs'] == null ? null : pulumi.Input.decodeList<RegionInstanceTemplateNetworkInterfaceIpv6AccessConfig>(map['ipv6AccessConfigs'], (value) => RegionInstanceTemplateNetworkInterfaceIpv6AccessConfig.fromMap((value as Map).cast<String, dynamic>())),
