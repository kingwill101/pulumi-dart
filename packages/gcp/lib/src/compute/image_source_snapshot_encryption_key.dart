...
class ImageSourceSnapshotEncryptionKey {
  ...
  /// Creates a new [ImageSourceSnapshotEncryptionKey].
  ...
  factory ImageSourceSnapshotEncryptionKey.fromMap(Map<String, dynamic> map) {
