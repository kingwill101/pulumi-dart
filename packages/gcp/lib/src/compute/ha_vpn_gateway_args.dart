...
class HaVpnGatewayArgs {
  ...
  factory HaVpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return HaVpnGatewayArgs(
      ...
      gatewayIpVersion: map['gatewayIpVersion'] == null ? null : map['gatewayIpVersion'] as String,
      ...
      vpnInterfaces: map['vpnInterfaces'] == null ? null : pulumi.Input.decodeList<HaVpnGatewayVpnInterface>(map['vpnInterfaces'], (value) => HaVpnGatewayVpnInterface.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
