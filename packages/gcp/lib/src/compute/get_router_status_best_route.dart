...
import 'get_router_status_best_route_as_path.dart';
import 'get_router_status_best_route_param.dart';
import 'get_router_status_best_route_warning.dart';

class GetRouterStatusBestRoute {
  final List<GetRouterStatusBestRouteAsPath> asPaths;
  ...
  final List<GetRouterStatusBestRouteParam> params;
  ...
  final List<GetRouterStatusBestRouteWarning> warnings;

  /// Creates a new [GetRouterStatusBestRoute].
  /// [asPaths] Required.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asPaths': pulumi.Input.encodeList<GetRouterStatusBestRouteAsPath, Map<String, dynamic>>(asPaths, (value) => value.toMap()),
      ...
      'params': pulumi.Input.encodeList<GetRouterStatusBestRouteParam, Map<String, dynamic>>(params, (value) => value.toMap()),
      'priority': priority,
      'project': project,
      ...
      'selfLink': selfLink,
      'tags': tags,
      'warnings': pulumi.Input.encodeList<GetRouterStatusBestRouteWarning, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }

  factory GetRouterStatusBestRoute.fromMap(Map<String, dynamic> map) {
    return GetRouterStatusBestRoute(
      asPaths: pulumi.Input.decodeList<GetRouterStatusBestRouteAsPath>(map['asPaths'], (value) => GetRouterStatusBestRouteAsPath.fromMap((value as Map).cast<String, dynamic>())),
      ...
      params: pulumi.Input.decodeList<GetRouterStatusBestRouteParam>(map['params'], (value) => GetRouterStatusBestRouteParam.fromMap((value as Map).cast<String, dynamic>())),
      ...
      warnings: pulumi.Input.decodeList<GetRouterStatusBestRouteWarning>(map['warnings'], (value) => GetRouterStatusBestRouteWarning.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
