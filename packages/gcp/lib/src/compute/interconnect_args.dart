...
class InterconnectArgs {
  ...
  factory InterconnectArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs(
      ...
      applicationAwareInterconnect: map['applicationAwareInterconnect'] == null ? null : InterconnectApplicationAwareInterconnect.fromMap((map['applicationAwareInterconnect'] as Map).cast<String, dynamic>()),
      ...
      macsec: map['macsec'] == null ? null : InterconnectMacsec.fromMap((map['macsec'] as Map).cast<String, dynamic>()),
      ...
      params: map['params'] == null ? null : InterconnectParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      remoteLocation: map['remoteLocation'] == null ? null : map['remoteLocation'] as String,
      requestedFeatures: map['requestedFeatures'] == null ? null : (map['requestedFeatures'] as List).cast<String>(),
