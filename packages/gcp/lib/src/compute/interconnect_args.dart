...
class InterconnectArgs {
  ...
  InterconnectArgs({
    ...
    required int requestedLinkCount,
        ...
        applicationAwareInterconnect = pulumi.Input.asOptionalInput<
        ...
        requestedFeatures =
            pulumi.Input.asOptionalInput<List<String>>(requestedFeatures),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (applicationAwareInterconnectValue != null) {
      map['applicationAwareInterconnect'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (paramsValue != null) {
      map['params'] = pulumi.Input.mapOptionalInputValue<InterconnectParams,
