...
class URLMap extends pulumi.CustomResource {
  ...
  URLMap(String name, {URLMapArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.defaultRouteAction = registerOutput<URLMapDefaultRouteAction?>(
      'defaultRouteAction',
    );
    this.defaultService = registerOutput<String?>('defaultService');
    this.defaultUrlRedirect = registerOutput<URLMapDefaultUrlRedirect?>(
      'defaultUrlRedirect',
    );
    ...
    this.pathMatchers = registerOutput<List<URLMapPathMatcher>?>(
      'pathMatchers',
    );
