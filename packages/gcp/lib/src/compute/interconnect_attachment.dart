...
class InterconnectAttachment extends pulumi.CustomResource {
  ...
  InterconnectAttachment(
    ...
    this.candidateCloudRouterIpAddress = registerOutput<String?>(
      'candidateCloudRouterIpAddress',
    );
    this.candidateCloudRouterIpv6Address = registerOutput<String?>(
      'candidateCloudRouterIpv6Address',
    );
    this.candidateCustomerRouterIpAddress = registerOutput<String?>(
      'candidateCustomerRouterIpAddress',
    );
    this.candidateCustomerRouterIpv6Address = registerOutput<String?>(
    ...
    this.l2Forwarding = registerOutput<InterconnectAttachmentL2Forwarding?>(
      'l2Forwarding',
    );
