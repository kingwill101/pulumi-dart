...
class RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelection {
  ...
  final List<RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk>? disks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'disks': ?disks == null ? null : pulumi.Input.encodeList<RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk, Map<String, dynamic>>(disks!, (value) => value.toMap()),
  ...
  factory RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelection.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelection(
      disks: map['disks'] == null ? null : pulumi.Input.decodeList<RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk>(map['disks'], (value) => RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk.fromMap((value as Map).cast<String, dynamic>())),
