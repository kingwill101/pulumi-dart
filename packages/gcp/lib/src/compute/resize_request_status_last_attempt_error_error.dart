...
class ResizeRequestStatusLastAttemptErrorError {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'code': ?code,
      'errorDetails': ?errorDetails == null ? null : pulumi.Input.encodeList<ResizeRequestStatusLastAttemptErrorErrorErrorDetail, Map<String, dynamic>>(errorDetails!, (value) => value.toMap()),
      'location': ?location,
      'message': ?message,
    };
  }
  ...
  factory ResizeRequestStatusLastAttemptErrorError.fromMap(Map<String, dynamic> map) {
    return ResizeRequestStatusLastAttemptErrorError(
      ...
      errorDetails: map['errorDetails'] == null ? null : pulumi.Input.decodeList<ResizeRequestStatusLastAttemptErrorErrorErrorDetail>(map['errorDetails'], (value) => ResizeRequestStatusLastAttemptErrorErrorErrorDetail.fromMap((value as Map).cast<String, dynamic>())),
