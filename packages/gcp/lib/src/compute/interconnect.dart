...
class Interconnect extends pulumi.CustomResource {
  ...
  Interconnect(
    ...
    this.circuitInfos = registerOutput<List<InterconnectCircuitInfo>>(
      'circuitInfos',
    );
    ...
    this.expectedOutages = registerOutput<List<InterconnectExpectedOutage>>(
      'expectedOutages',
    );
    ...
    this.interconnectGroups = registerOutput<List<String>>(
      'interconnectGroups',
    );
