...
class URLMapPathMatcherPathRuleRouteActionTimeout {
  ...
  /// Creates a new [URLMapPathMatcherPathRuleRouteActionTimeout].
  ...
  factory URLMapPathMatcherPathRuleRouteActionTimeout.fromMap(Map<String, dynamic> map) {
