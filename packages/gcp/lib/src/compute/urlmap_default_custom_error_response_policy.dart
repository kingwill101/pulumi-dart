...
class URLMapDefaultCustomErrorResponsePolicy {
  ...
  final List<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule>? errorResponseRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': ?errorResponseRules == null ? null : pulumi.Input.encodeList<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule, Map<String, dynamic>>(errorResponseRules!, (value) => value.toMap()),
  ...
  factory URLMapDefaultCustomErrorResponsePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapDefaultCustomErrorResponsePolicy(
      errorResponseRules: map['errorResponseRules'] == null ? null : pulumi.Input.decodeList<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule>(map['errorResponseRules'], (value) => URLMapDefaultCustomErrorResponsePolicyErrorResponseRule.fromMap((value as Map).cast<String, dynamic>())),
