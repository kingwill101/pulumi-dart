...
class InterconnectAttachmentArgs {
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      candidateCloudRouterIpAddress: map['candidateCloudRouterIpAddress'] == null ? null : map['candidateCloudRouterIpAddress'] as String,
      candidateCloudRouterIpv6Address: map['candidateCloudRouterIpv6Address'] == null ? null : map['candidateCloudRouterIpv6Address'] as String,
      candidateCustomerRouterIpAddress: map['candidateCustomerRouterIpAddress'] == null ? null : map['candidateCustomerRouterIpAddress'] as String,
      candidateCustomerRouterIpv6Address: map['candidateCustomerRouterIpv6Address'] == null ? null : map['candidateCustomerRouterIpv6Address'] as String,
      candidateSubnets: map['candidateSubnets'] == null ? null : (map['candidateSubnets'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : map['edgeAvailabilityDomain'] as String,
      ...
      l2Forwarding: map['l2Forwarding'] == null ? null : InterconnectAttachmentL2Forwarding.fromMap((map['l2Forwarding'] as Map).cast<String, dynamic>()),
