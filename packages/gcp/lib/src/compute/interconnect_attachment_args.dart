...
class InterconnectAttachmentArgs {
  ...
  InterconnectAttachmentArgs({
    ...
    int? vlanTag8021q,
        ...
        candidateCloudRouterIpAddress =
            pulumi.Input.asOptionalInput<String>(candidateCloudRouterIpAddress),
        ...
        edgeAvailabilityDomain =
            pulumi.Input.asOptionalInput<String>(edgeAvailabilityDomain),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (l2ForwardingValue != null) {
      map['l2Forwarding'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      encryption:
          map['encryption'] == null ? null : map['encryption'] as String,
      interconnect:
