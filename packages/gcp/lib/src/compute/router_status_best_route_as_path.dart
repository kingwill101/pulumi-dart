...
class RouterStatusBestRouteAsPath {
  ...
  /// Creates a new [RouterStatusBestRouteAsPath].
  ...
  factory RouterStatusBestRouteAsPath.fromMap(Map<String, dynamic> map) {
    return RouterStatusBestRouteAsPath(
