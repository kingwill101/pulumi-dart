...
class InstanceFromTemplateBootDiskInitializeParams {
  ...
  final InstanceFromTemplateBootDiskInitializeParamsSourceImageEncryptionKey? sourceImageEncryptionKey;
  /// The encryption key used to decrypt the source snapshot.
  final InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey? sourceSnapshotEncryptionKey;
  ...
  factory InstanceFromTemplateBootDiskInitializeParams.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateBootDiskInitializeParams(
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : InstanceFromTemplateBootDiskInitializeParamsSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
