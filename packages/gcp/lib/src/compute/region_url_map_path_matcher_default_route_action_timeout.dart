...
class RegionUrlMapPathMatcherDefaultRouteActionTimeout {
  ...
  /// Creates a new [RegionUrlMapPathMatcherDefaultRouteActionTimeout].
  ...
  RegionUrlMapPathMatcherDefaultRouteActionTimeout({this.nanos, this.seconds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'nanos': ?nanos, 'seconds': ?seconds};
  }

  factory RegionUrlMapPathMatcherDefaultRouteActionTimeout.fromMap(
    Map<String, dynamic> map,
  ) {
    return RegionUrlMapPathMatcherDefaultRouteActionTimeout(
