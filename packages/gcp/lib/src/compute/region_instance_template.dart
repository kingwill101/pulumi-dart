...
class RegionInstanceTemplate extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RegionInstanceTemplateGuestAccelerator>?>
  guestAccelerators;
  ...
  late final pulumi.Output<List<RegionInstanceTemplateNetworkInterface>?>
  networkInterfaces;
  ...
  RegionInstanceTemplate(
    ...
    this.networkInterfaces =
        registerOutput<List<RegionInstanceTemplateNetworkInterface>?>(
          'networkInterfaces',
        );
    ...
    this.resourceManagerTags = registerOutput<Map<String, String>?>(
      'resourceManagerTags',
    );
    this.resourcePolicies = registerOutput<String?>('resourcePolicies');
    this.scheduling = registerOutput<RegionInstanceTemplateScheduling>(
      'scheduling',
    );
    this.selfLink = registerOutput<String>('selfLink');
    this.serviceAccount = registerOutput<RegionInstanceTemplateServiceAccount?>(
      'serviceAccount',
    );
