...
class RegionUrlMap extends pulumi.CustomResource {
  ...
  RegionUrlMap(
    ...
    this.defaultRouteAction = registerOutput<RegionUrlMapDefaultRouteAction?>(
      'defaultRouteAction',
    );
    this.defaultService = registerOutput<String?>('defaultService');
    this.defaultUrlRedirect = registerOutput<RegionUrlMapDefaultUrlRedirect?>(
      'defaultUrlRedirect',
    );
    this.description = registerOutput<String?>('description');
    this.fingerprint = registerOutput<String>('fingerprint');
    this.headerAction = registerOutput<RegionUrlMapHeaderAction?>(
      'headerAction',
    );
    this.hostRules = registerOutput<List<RegionUrlMapHostRule>?>('hostRules');
    this.mapId = registerOutput<int>('mapId');
    this.name = registerOutput<String>('name');
    this.pathMatchers = registerOutput<List<RegionUrlMapPathMatcher>?>(
      'pathMatchers',
    );
