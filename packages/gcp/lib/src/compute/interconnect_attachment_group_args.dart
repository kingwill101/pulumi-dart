...
class InterconnectAttachmentGroupArgs {
  ...
  factory InterconnectAttachmentGroupArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentGroupArgs(
      attachments: map['attachments'] == null ? null : pulumi.Input.decodeList<InterconnectAttachmentGroupAttachment>(map['attachments'], (value) => InterconnectAttachmentGroupAttachment.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      intent: InterconnectAttachmentGroupIntent.fromMap((map['intent'] as Map).cast<String, dynamic>()),
      interconnectGroup: map['interconnectGroup'] == null ? null : map['interconnectGroup'] as String,
