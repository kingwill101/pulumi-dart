...
class RegionUrlMapPathMatcherRouteRuleRouteActionCorsPolicy {
  ...
  /// Creates a new [RegionUrlMapPathMatcherRouteRuleRouteActionCorsPolicy].
  ...
  factory RegionUrlMapPathMatcherRouteRuleRouteActionCorsPolicy.fromMap(Map<String, dynamic> map) {
