  ...
  HealthCheckArgs({
    ...
    int? unhealthyThreshold,
       ...
       grpcHealthCheck = pulumi
           .Input.asOptionalInput<HealthCheckGrpcHealthCheck>(grpcHealthCheck),
       grpcTlsHealthCheck =
       ...
       httpHealthCheck = pulumi
           .Input.asOptionalInput<HealthCheckHttpHealthCheck>(httpHealthCheck),
       httpsHealthCheck =
           pulumi.Input.asOptionalInput<HealthCheckHttpsHealthCheck>(
             httpsHealthCheck,
           ),
       logConfig = pulumi.Input.asOptionalInput<HealthCheckLogConfig>(
         logConfig,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       project = pulumi.Input.asOptionalInput<String>(project),
       sourceRegions = pulumi.Input.asOptionalInput<List<String>>(
         sourceRegions,
       ),
  ...
  factory HealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckArgs(
      ...
      grpcHealthCheck: map['grpcHealthCheck'] == null
          ? null
          : HealthCheckGrpcHealthCheck.fromMap(
              (map['grpcHealthCheck'] as Map).cast<String, dynamic>(),
            ),
      grpcTlsHealthCheck: map['grpcTlsHealthCheck'] == null
          ? null
          : HealthCheckGrpcTlsHealthCheck.fromMap(
              (map['grpcTlsHealthCheck'] as Map).cast<String, dynamic>(),
            ),
