...
class HealthCheckArgs {
  ...
  HealthCheckArgs({
    ...
    String? description,
    HealthCheckGrpcHealthCheck? grpcHealthCheck,
    HealthCheckGrpcTlsHealthCheck? grpcTlsHealthCheck,
    int? healthyThreshold,
    HealthCheckHttp2HealthCheck? http2HealthCheck,
    HealthCheckHttpHealthCheck? httpHealthCheck,
    HealthCheckHttpsHealthCheck? httpsHealthCheck,
    HealthCheckLogConfig? logConfig,
    String? name,
    String? project,
    List<String>? sourceRegions,
    HealthCheckSslHealthCheck? sslHealthCheck,
    HealthCheckTcpHealthCheck? tcpHealthCheck,
    int? timeoutSec,
  ...
  factory HealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckArgs(
      ...
      grpcHealthCheck: map['grpcHealthCheck'] == null ? null : HealthCheckGrpcHealthCheck.fromMap((map['grpcHealthCheck'] as Map).cast<String, dynamic>()),
      grpcTlsHealthCheck: map['grpcTlsHealthCheck'] == null ? null : HealthCheckGrpcTlsHealthCheck.fromMap((map['grpcTlsHealthCheck'] as Map).cast<String, dynamic>()),
      healthyThreshold: map['healthyThreshold'] == null ? null : map['healthyThreshold'] as int,
      http2HealthCheck: map['http2HealthCheck'] == null ? null : HealthCheckHttp2HealthCheck.fromMap((map['http2HealthCheck'] as Map).cast<String, dynamic>()),
      httpHealthCheck: map['httpHealthCheck'] == null ? null : HealthCheckHttpHealthCheck.fromMap((map['httpHealthCheck'] as Map).cast<String, dynamic>()),
      httpsHealthCheck: map['httpsHealthCheck'] == null ? null : HealthCheckHttpsHealthCheck.fromMap((map['httpsHealthCheck'] as Map).cast<String, dynamic>()),
      logConfig: map['logConfig'] == null ? null : HealthCheckLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      sourceRegions: map['sourceRegions'] == null ? null : (map['sourceRegions'] as List).cast<String>(),
      sslHealthCheck: map['sslHealthCheck'] == null ? null : HealthCheckSslHealthCheck.fromMap((map['sslHealthCheck'] as Map).cast<String, dynamic>()),
      tcpHealthCheck: map['tcpHealthCheck'] == null ? null : HealthCheckTcpHealthCheck.fromMap((map['tcpHealthCheck'] as Map).cast<String, dynamic>()),
