...
class HealthCheckArgs {
  ...
  HealthCheckArgs({
    ...
    int? unhealthyThreshold,
        ...
        grpcHealthCheck =
            pulumi.Input.asOptionalInput<HealthCheckGrpcHealthCheck>(
                grpcHealthCheck),
        grpcTlsHealthCheck =
        ...
        http2HealthCheck =
            pulumi.Input.asOptionalInput<HealthCheckHttp2HealthCheck>(
                http2HealthCheck),
        httpHealthCheck =
            pulumi.Input.asOptionalInput<HealthCheckHttpHealthCheck>(
                httpHealthCheck),
        httpsHealthCheck =
        ...
        sslHealthCheck =
            pulumi.Input.asOptionalInput<HealthCheckSslHealthCheck>(
                sslHealthCheck),
        tcpHealthCheck =
            pulumi.Input.asOptionalInput<HealthCheckTcpHealthCheck>(
                tcpHealthCheck),
