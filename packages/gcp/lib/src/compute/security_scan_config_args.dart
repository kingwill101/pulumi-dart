  ...
  SecurityScanConfigArgs({
    ...
    String? userAgent,
        ...
        exportToSecurityCommandCenter =
            pulumi.Input.asOptionalInput<String>(exportToSecurityCommandCenter),
        maxQps = pulumi.Input.asOptionalInput<int>(maxQps),
        project = pulumi.Input.asOptionalInput<String>(project),
        schedule =
            pulumi.Input.asOptionalInput<SecurityScanConfigSchedule>(schedule),
        startingUrls = pulumi.Input.asInput<List<String>>(startingUrls),
        targetPlatforms =
            pulumi.Input.asOptionalInput<List<String>>(targetPlatforms),
  ...
  factory SecurityScanConfigArgs.fromMap(Map<String, dynamic> map) {
    return SecurityScanConfigArgs(
      ...
      targetPlatforms: map['targetPlatforms'] == null
          ? null
          : (map['targetPlatforms'] as List).cast<String>(),
