...
class InterconnectGroupConfiguredTopologyCapability {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'intendedCapabilityBlockers': ?intendedCapabilityBlockers == null
          ? null
          : pulumi.Input.encodeList<
              InterconnectGroupConfiguredTopologyCapabilityIntendedCapabilityBlocker,
              Map<String, dynamic>
            >(intendedCapabilityBlockers!, (value) => value.toMap()),
      ...
      intendedCapabilityBlockers: map['intendedCapabilityBlockers'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  InterconnectGroupConfiguredTopologyCapabilityIntendedCapabilityBlocker.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      supportedSla: map['supportedSla'] == null
          ? null
          : map['supportedSla'] as String,
    );
  }
}
