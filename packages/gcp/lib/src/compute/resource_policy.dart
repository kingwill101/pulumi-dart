...
class ResourcePolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ResourcePolicy]. {@macro pulumi_compute_resource_policy_resource_policy_args_doc}
  ...
  ResourcePolicy(
    ...
    this.workloadPolicy = registerOutput<ResourcePolicyWorkloadPolicy?>(
      'workloadPolicy',
    );
  }
}
