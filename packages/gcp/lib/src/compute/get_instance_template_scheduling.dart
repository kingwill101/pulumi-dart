...
import 'get_instance_template_scheduling_graceful_shutdown.dart';
import 'get_instance_template_scheduling_local_ssd_recovery_timeout.dart';
import 'get_instance_template_scheduling_max_run_duration.dart';
import 'get_instance_template_scheduling_node_affinity.dart';
import 'get_instance_template_scheduling_on_instance_stop_action.dart';

class GetInstanceTemplateScheduling {
  ...
  /// Creates a new [GetInstanceTemplateScheduling].
  ...
  factory GetInstanceTemplateScheduling.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateScheduling(
      ...
      onInstanceStopActions: pulumi.Input.decodeList<
          ...
          (value) => GetInstanceTemplateSchedulingOnInstanceStopAction.fromMap(
              (value as Map).cast<String, dynamic>())),
