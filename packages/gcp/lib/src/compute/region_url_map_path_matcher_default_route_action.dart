...
class RegionUrlMapPathMatcherDefaultRouteAction {
  ...
  /// Structure is documented below.
  final RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicy? faultInjectionPolicy;
  ...
  /// Structure is documented below.
  final RegionUrlMapPathMatcherDefaultRouteActionMaxStreamDuration? maxStreamDuration;
  /// Specifies the policy on how requests intended for the route's backends are shadowed to a separate mirrored backend service.
  /// The load balancer does not wait for responses from the shadow service. Before sending traffic to the shadow service, the host / authority header is suffixed with -shadow.
  /// Not supported when the URL map is bound to a target gRPC proxy that has the validateForProxyless field set to true.
  /// Structure is documented below.
  final RegionUrlMapPathMatcherDefaultRouteActionRequestMirrorPolicy? requestMirrorPolicy;
  ...
  /// Structure is documented below.
  final List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService>? weightedBackendServices;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'weightedBackendServices': ?weightedBackendServices == null ? null : pulumi.Input.encodeList<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService, Map<String, dynamic>>(weightedBackendServices!, (value) => value.toMap()),
    };
  }
  ...
  factory RegionUrlMapPathMatcherDefaultRouteAction.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherDefaultRouteAction(
      corsPolicy: map['corsPolicy'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionCorsPolicy.fromMap((map['corsPolicy'] as Map).cast<String, dynamic>()),
      faultInjectionPolicy: map['faultInjectionPolicy'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicy.fromMap((map['faultInjectionPolicy'] as Map).cast<String, dynamic>()),
      maxStreamDuration: map['maxStreamDuration'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionMaxStreamDuration.fromMap((map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      requestMirrorPolicy: map['requestMirrorPolicy'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionRequestMirrorPolicy.fromMap((map['requestMirrorPolicy'] as Map).cast<String, dynamic>()),
      retryPolicy: map['retryPolicy'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      timeout: map['timeout'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionTimeout.fromMap((map['timeout'] as Map).cast<String, dynamic>()),
      urlRewrite: map['urlRewrite'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionUrlRewrite.fromMap((map['urlRewrite'] as Map).cast<String, dynamic>()),
      weightedBackendServices: map['weightedBackendServices'] == null ? null : pulumi.Input.decodeList<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService>(map['weightedBackendServices'], (value) => RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
