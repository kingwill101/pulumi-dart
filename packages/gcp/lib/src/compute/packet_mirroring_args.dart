...
class PacketMirroringArgs {
  ...
  factory PacketMirroringArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringArgs(
      collectorIlb: PacketMirroringCollectorIlb.fromMap((map['collectorIlb'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      filter: map['filter'] == null ? null : PacketMirroringFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      mirroredResources: PacketMirroringMirroredResources.fromMap((map['mirroredResources'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: PacketMirroringNetwork.fromMap((map['network'] as Map).cast<String, dynamic>()),
