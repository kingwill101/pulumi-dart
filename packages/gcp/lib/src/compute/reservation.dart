...
class Reservation extends pulumi.CustomResource {
  ...
  Reservation(
    ...
    this.deleteAfterDuration = registerOutput<ReservationDeleteAfterDuration?>(
      'deleteAfterDuration',
    );
    this.deleteAtTime = registerOutput<String>('deleteAtTime');
    this.description = registerOutput<String?>('description');
    this.enableEmergentMaintenance = registerOutput<bool?>(
    ...
    this.resourceStatuses = registerOutput<List<ReservationResourceStatus>>(
      'resourceStatuses',
    );
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.selfLink = registerOutput<String>('selfLink');
    this.shareSettings = registerOutput<ReservationShareSettings>(
      'shareSettings',
    );
    this.specificReservation = registerOutput<ReservationSpecificReservation>(
      'specificReservation',
    );
