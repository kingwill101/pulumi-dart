...
class Reservation extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Reservation]. {@macro pulumi_compute_reservation_reservation_args_doc}
  ...
  Reservation(
    ...
    this.deleteAfterDuration = registerOutput<ReservationDeleteAfterDuration?>('deleteAfterDuration');
    this.deleteAtTime = registerOutput<String>('deleteAtTime');
    this.description = registerOutput<String?>('description');
    this.enableEmergentMaintenance = registerOutput<bool?>('enableEmergentMaintenance');
    ...
    this.reservationSharingPolicy = registerOutput<ReservationReservationSharingPolicy>('reservationSharingPolicy');
    this.resourceStatuses = registerOutput<List<ReservationResourceStatus>>('resourceStatuses');
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.selfLink = registerOutput<String>('selfLink');
    this.shareSettings = registerOutput<ReservationShareSettings>('shareSettings');
    this.specificReservation = registerOutput<ReservationSpecificReservation>('specificReservation');
