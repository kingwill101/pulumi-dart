...
class NetworkFirewallPolicyWithRulesPredefinedRule {
  ...
  /// Structure is documented below.
  final List<NetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag>? targetSecureTags;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matches': ?matches == null ? null : pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatch, Map<String, dynamic>>(matches!, (value) => value.toMap()),
      'priority': ?priority,
      'ruleName': ?ruleName,
      'securityProfileGroup': ?securityProfileGroup,
      'targetSecureTags': ?targetSecureTags == null ? null : pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag, Map<String, dynamic>>(targetSecureTags!, (value) => value.toMap()),
  ...
  factory NetworkFirewallPolicyWithRulesPredefinedRule.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesPredefinedRule(
      ...
      matches: map['matches'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatch>(map['matches'], (value) => NetworkFirewallPolicyWithRulesPredefinedRuleMatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag>(map['targetSecureTags'], (value) => NetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>())),
