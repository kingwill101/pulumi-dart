...
class NetworkFirewallPolicyPacketMirroringRuleArgs {
  ...
  NetworkFirewallPolicyPacketMirroringRuleArgs({
    ...
    List<NetworkFirewallPolicyPacketMirroringRuleTargetSecureTag>? targetSecureTags,
    bool? tlsInspect,
  }) :
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'match': pulumi.Input.mapInputValue<NetworkFirewallPolicyPacketMirroringRuleMatch, Map<String, dynamic>>(match, (value) => value.toMap()),
      'priority': priority,
      'project': ?project,
      'ruleName': ?ruleName,
  ...
  factory NetworkFirewallPolicyPacketMirroringRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyPacketMirroringRuleArgs(
      ...
      match: NetworkFirewallPolicyPacketMirroringRuleMatch.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyPacketMirroringRuleTargetSecureTag>(map['targetSecureTags'], (value) => NetworkFirewallPolicyPacketMirroringRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>())),
