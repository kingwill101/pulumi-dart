...
class NetworkFirewallPolicyPacketMirroringRuleArgs {
  ...
  /// Structure is documented below.
  final pulumi
      .Input<List<NetworkFirewallPolicyPacketMirroringRuleTargetSecureTag>>?
      targetSecureTags;
  ...
  NetworkFirewallPolicyPacketMirroringRuleArgs({
    ...
    bool? tlsInspect,
        ...
        match =
            pulumi.Input.asInput<NetworkFirewallPolicyPacketMirroringRuleMatch>(
                match),
    ...
    return NetworkFirewallPolicyPacketMirroringRuleArgs(
      ...
      targetSecureTags: map['targetSecureTags'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => NetworkFirewallPolicyPacketMirroringRuleTargetSecureTag
