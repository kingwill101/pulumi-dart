...
class RegionSecurityPolicyRuleCompute extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<RegionSecurityPolicyRulePreconfiguredWafConfig?> preconfiguredWafConfig;
  ...
  RegionSecurityPolicyRuleCompute(
    ...
    this.networkMatch = registerOutput<RegionSecurityPolicyRuleNetworkMatch?>('networkMatch');
    this.preconfiguredWafConfig = registerOutput<RegionSecurityPolicyRulePreconfiguredWafConfig?>('preconfiguredWafConfig');
    this.preview = registerOutput<bool?>('preview');
    this.priority = registerOutput<int>('priority');
    this.project = registerOutput<String>('project');
    this.rateLimitOptions = registerOutput<RegionSecurityPolicyRuleRateLimitOptions?>('rateLimitOptions');
