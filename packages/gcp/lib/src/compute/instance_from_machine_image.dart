...
class InstanceFromMachineImage extends pulumi.CustomResource {
  ...
  InstanceFromMachineImage(
    ...
    this.advancedMachineFeatures = registerOutput<InstanceFromMachineImageAdvancedMachineFeatures>('advancedMachineFeatures');
    this.allowStoppingForUpdate = registerOutput<bool>('allowStoppingForUpdate');
    this.attachedDisks = registerOutput<List<InstanceFromMachineImageAttachedDisk>>('attachedDisks');
    this.bootDisks = registerOutput<List<InstanceFromMachineImageBootDisk>>('bootDisks');
    this.canIpForward = registerOutput<bool>('canIpForward');
    this.confidentialInstanceConfig = registerOutput<InstanceFromMachineImageConfidentialInstanceConfig>('confidentialInstanceConfig');
    ...
    this.guestAccelerators = registerOutput<List<InstanceFromMachineImageGuestAccelerator>>('guestAccelerators');
    this.hostname = registerOutput<String>('hostname');
    this.instanceEncryptionKey = registerOutput<InstanceFromMachineImageInstanceEncryptionKey>('instanceEncryptionKey');
    ...
    this.networkInterfaces = registerOutput<List<InstanceFromMachineImageNetworkInterface>>('networkInterfaces');
    this.networkPerformanceConfig = registerOutput<InstanceFromMachineImageNetworkPerformanceConfig>('networkPerformanceConfig');
    ...
    this.reservationAffinity = registerOutput<InstanceFromMachineImageReservationAffinity>('reservationAffinity');
    this.resourcePolicies = registerOutput<String>('resourcePolicies');
    this.scheduling = registerOutput<InstanceFromMachineImageScheduling>('scheduling');
    this.scratchDisks = registerOutput<List<InstanceFromMachineImageScratchDisk>>('scratchDisks');
    this.selfLink = registerOutput<String>('selfLink');
    this.serviceAccount = registerOutput<InstanceFromMachineImageServiceAccount>('serviceAccount');
    this.shieldedInstanceConfig = registerOutput<InstanceFromMachineImageShieldedInstanceConfig>('shieldedInstanceConfig');
    this.sourceMachineImage = registerOutput<String>('sourceMachineImage');
    this.sourceMachineImageEncryptionKey = registerOutput<InstanceFromMachineImageSourceMachineImageEncryptionKey?>('sourceMachineImageEncryptionKey');
