...
class GetRegionBackendServiceConsistentHash {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpCookies': pulumi.Input.encodeList<GetRegionBackendServiceConsistentHashHttpCooky, Map<String, dynamic>>(httpCookies, (value) => value.toMap()),
  ...
  factory GetRegionBackendServiceConsistentHash.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceConsistentHash(
      httpCookies: pulumi.Input.decodeList<GetRegionBackendServiceConsistentHashHttpCooky>(map['httpCookies'], (value) => GetRegionBackendServiceConsistentHashHttpCooky.fromMap((value as Map).cast<String, dynamic>())),
