...
class WireGroupArgs {
  ...
  WireGroupArgs({
    bool? adminEnabled,
    required String crossSiteNetwork,
    String? description,
    List<WireGroupEndpoint>? endpoints,
    String? name,
    String? project,
    WireGroupWireGroupProperties? wireGroupProperties,
    WireGroupWireProperties? wireProperties,
  }) :
  ...
  factory WireGroupArgs.fromMap(Map<String, dynamic> map) {
    return WireGroupArgs(
      ...
      crossSiteNetwork: map['crossSiteNetwork'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      endpoints: map['endpoints'] == null ? null : pulumi.Input.decodeList<WireGroupEndpoint>(map['endpoints'], (value) => WireGroupEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      wireGroupProperties: map['wireGroupProperties'] == null ? null : WireGroupWireGroupProperties.fromMap((map['wireGroupProperties'] as Map).cast<String, dynamic>()),
      wireProperties: map['wireProperties'] == null ? null : WireGroupWireProperties.fromMap((map['wireProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
