...
class WireGroupArgs {
  ...
  WireGroupArgs({
    ...
    WireGroupWireProperties? wireProperties,
        ...
        endpoints =
            pulumi.Input.asOptionalInput<List<WireGroupEndpoint>>(endpoints),
  ...
  factory WireGroupArgs.fromMap(Map<String, dynamic> map) {
    return WireGroupArgs(
      ...
      wireGroupProperties: map['wireGroupProperties'] == null
          ? null
          : WireGroupWireGroupProperties.fromMap(
              (map['wireGroupProperties'] as Map).cast<String, dynamic>()),
      wireProperties: map['wireProperties'] == null
          ? null
          : WireGroupWireProperties.fromMap(
              (map['wireProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
