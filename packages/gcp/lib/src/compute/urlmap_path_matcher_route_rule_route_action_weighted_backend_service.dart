...
class URLMapPathMatcherRouteRuleRouteActionWeightedBackendService {
  ...
  final URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderAction? headerAction;
  ...
  factory URLMapPathMatcherRouteRuleRouteActionWeightedBackendService.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherRouteRuleRouteActionWeightedBackendService(
      ...
      headerAction: map['headerAction'] == null ? null : URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderAction.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
