...
class RegionNetworkFirewallPolicyRuleArgs {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<RegionNetworkFirewallPolicyRuleTargetSecureTag>>?
      targetSecureTags;
  ...
  RegionNetworkFirewallPolicyRuleArgs({
    ...
    required RegionNetworkFirewallPolicyRuleMatch match,
    required int priority,
    String? project,
    String? region,
    String? ruleName,
    String? securityProfileGroup,
    List<RegionNetworkFirewallPolicyRuleTargetSecureTag>? targetSecureTags,
    ...
    bool? tlsInspect,
        ...
        match =
            pulumi.Input.asInput<RegionNetworkFirewallPolicyRuleMatch>(match),
        priority = pulumi.Input.asInput<int>(priority),
        project = pulumi.Input.asOptionalInput<String>(project),
        region = pulumi.Input.asOptionalInput<String>(region),
        ruleName = pulumi.Input.asOptionalInput<String>(ruleName),
        securityProfileGroup =
            pulumi.Input.asOptionalInput<String>(securityProfileGroup),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['match'] = pulumi.Input.mapInputValue<
  ...
  factory RegionNetworkFirewallPolicyRuleArgs.fromMap(
    ...
    return RegionNetworkFirewallPolicyRuleArgs(
      ...
      match: RegionNetworkFirewallPolicyRuleMatch.fromMap(
      ...
      targetSecureTags: map['targetSecureTags'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => RegionNetworkFirewallPolicyRuleTargetSecureTag.fromMap(
