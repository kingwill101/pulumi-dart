...
class RegionNetworkFirewallPolicyRuleArgs {
  ...
  RegionNetworkFirewallPolicyRuleArgs({
    ...
    bool? tlsInspect,
      ...
      match = pulumi.Input.asInput<RegionNetworkFirewallPolicyRuleMatch>(match),
  ...
  factory RegionNetworkFirewallPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyRuleArgs(
      ...
      match: RegionNetworkFirewallPolicyRuleMatch.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<RegionNetworkFirewallPolicyRuleTargetSecureTag>(map['targetSecureTags'], (value) => RegionNetworkFirewallPolicyRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>())),
