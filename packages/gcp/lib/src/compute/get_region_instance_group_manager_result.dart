...
class GetRegionInstanceGroupManagerResult {
    ...
    return <String, dynamic>{
      'allInstancesConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(allInstancesConfigs, (value) => value.toMap()),
      'autoHealingPolicies':
          pulumi.Input.encodeList<
      ...
      'standbyPolicies':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(standbyPolicies, (value) => value.toMap()),
      'statefulDisks':
          pulumi.Input.encodeList<
            GetRegionInstanceGroupManagerStatefulDisk,
            Map<String, dynamic>
          >(statefulDisks, (value) => value.toMap()),
      'statefulExternalIps':
          pulumi.Input.encodeList<
            GetRegionInstanceGroupManagerStatefulExternalIp,
            Map<String, dynamic>
          >(statefulExternalIps, (value) => value.toMap()),
      'statefulInternalIps':
          pulumi.Input.encodeList<
            GetRegionInstanceGroupManagerStatefulInternalIp,
            Map<String, dynamic>
          >(statefulInternalIps, (value) => value.toMap()),
      'statuses':
          pulumi.Input.encodeList<
  ...
  factory GetRegionInstanceGroupManagerResult.fromMap(
    ...
    return GetRegionInstanceGroupManagerResult(
      ...
      distributionPolicyZones: (map['distributionPolicyZones'] as List)
          .cast<String>(),
