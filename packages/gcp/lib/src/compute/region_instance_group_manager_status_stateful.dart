...
class RegionInstanceGroupManagerStatusStateful {
  ...
  final List<RegionInstanceGroupManagerStatusStatefulPerInstanceConfig>? perInstanceConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'perInstanceConfigs': ?perInstanceConfigs == null ? null : pulumi.Input.encodeList<RegionInstanceGroupManagerStatusStatefulPerInstanceConfig, Map<String, dynamic>>(perInstanceConfigs!, (value) => value.toMap()),
    };
  }
  ...
  factory RegionInstanceGroupManagerStatusStateful.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerStatusStateful(
      hasStatefulConfig: map['hasStatefulConfig'] == null ? null : map['hasStatefulConfig'] as bool,
      perInstanceConfigs: map['perInstanceConfigs'] == null ? null : pulumi.Input.decodeList<RegionInstanceGroupManagerStatusStatefulPerInstanceConfig>(map['perInstanceConfigs'], (value) => RegionInstanceGroupManagerStatusStatefulPerInstanceConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
