...
class InstanceGroupManagerArgs {
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      allInstancesConfig: map['allInstancesConfig'] == null ? null : InstanceGroupManagerAllInstancesConfig.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>()),
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : InstanceGroupManagerAutoHealingPolicies.fromMap((map['autoHealingPolicies'] as Map).cast<String, dynamic>()),
      baseInstanceName: map['baseInstanceName'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      instanceLifecyclePolicy: map['instanceLifecyclePolicy'] == null ? null : InstanceGroupManagerInstanceLifecyclePolicy.fromMap((map['instanceLifecyclePolicy'] as Map).cast<String, dynamic>()),
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : map['listManagedInstancesResults'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      namedPorts: map['namedPorts'] == null ? null : pulumi.Input.decodeList<InstanceGroupManagerNamedPort>(map['namedPorts'], (value) => InstanceGroupManagerNamedPort.fromMap((value as Map).cast<String, dynamic>())),
      params: map['params'] == null ? null : InstanceGroupManagerParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      resourcePolicies: map['resourcePolicies'] == null ? null : InstanceGroupManagerResourcePolicies.fromMap((map['resourcePolicies'] as Map).cast<String, dynamic>()),
      standbyPolicy: map['standbyPolicy'] == null ? null : InstanceGroupManagerStandbyPolicy.fromMap((map['standbyPolicy'] as Map).cast<String, dynamic>()),
      statefulDisks: map['statefulDisks'] == null ? null : pulumi.Input.decodeList<InstanceGroupManagerStatefulDisk>(map['statefulDisks'], (value) => InstanceGroupManagerStatefulDisk.fromMap((value as Map).cast<String, dynamic>())),
      statefulExternalIps: map['statefulExternalIps'] == null ? null : pulumi.Input.decodeList<InstanceGroupManagerStatefulExternalIp>(map['statefulExternalIps'], (value) => InstanceGroupManagerStatefulExternalIp.fromMap((value as Map).cast<String, dynamic>())),
      statefulInternalIps: map['statefulInternalIps'] == null ? null : pulumi.Input.decodeList<InstanceGroupManagerStatefulInternalIp>(map['statefulInternalIps'], (value) => InstanceGroupManagerStatefulInternalIp.fromMap((value as Map).cast<String, dynamic>())),
      ...
      updatePolicy: map['updatePolicy'] == null ? null : InstanceGroupManagerUpdatePolicy.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>()),
      versions: pulumi.Input.decodeList<InstanceGroupManagerVersion>(map['versions'], (value) => InstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>())),
