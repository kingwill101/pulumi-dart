...
class GetInstanceNetworkInterface {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': pulumi.Input.encodeList<GetInstanceNetworkInterfaceAccessConfig, Map<String, dynamic>>(accessConfigs, (value) => value.toMap()),
      'aliasIpRanges': pulumi.Input.encodeList<GetInstanceNetworkInterfaceAliasIpRange, Map<String, dynamic>>(aliasIpRanges, (value) => value.toMap()),
      'igmpQuery': igmpQuery,
      'internalIpv6PrefixLength': internalIpv6PrefixLength,
      'ipv6AccessConfigs': pulumi.Input.encodeList<GetInstanceNetworkInterfaceIpv6AccessConfig, Map<String, dynamic>>(ipv6AccessConfigs, (value) => value.toMap()),
  ...
  factory GetInstanceNetworkInterface.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkInterface(
      accessConfigs: pulumi.Input.decodeList<GetInstanceNetworkInterfaceAccessConfig>(map['accessConfigs'], (value) => GetInstanceNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: pulumi.Input.decodeList<GetInstanceNetworkInterfaceAliasIpRange>(map['aliasIpRanges'], (value) => GetInstanceNetworkInterfaceAliasIpRange.fromMap((value as Map).cast<String, dynamic>())),
      igmpQuery: map['igmpQuery'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: pulumi.Input.decodeList<GetInstanceNetworkInterfaceIpv6AccessConfig>(map['ipv6AccessConfigs'], (value) => GetInstanceNetworkInterfaceIpv6AccessConfig.fromMap((value as Map).cast<String, dynamic>())),
