...
class RegionInstanceGroupManagerStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allInstancesConfigs': ?allInstancesConfigs == null
          ? null
      ...
      'isStable': ?isStable,
      'statefuls': ?statefuls == null
          ? null
          : pulumi.Input.encodeList<
              RegionInstanceGroupManagerStatusStateful,
              Map<String, dynamic>
            >(statefuls!, (value) => value.toMap()),
      'versionTargets': ?versionTargets == null
          ? null
          : pulumi.Input.encodeList<
              RegionInstanceGroupManagerStatusVersionTarget,
              Map<String, dynamic>
            >(versionTargets!, (value) => value.toMap()),
    };
  }
