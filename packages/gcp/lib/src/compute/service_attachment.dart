...
class ServiceAttachment extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ServiceAttachmentConnectedEndpoint>>
  connectedEndpoints;
  ...
  /// attachment.
  /// Structure is documented below.
  late final pulumi.Output<List<ServiceAttachmentConsumerAcceptList>?>
  consumerAcceptLists;
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<ServiceAttachmentPscServiceAttachmentId>>
  ...
  ServiceAttachment(
    ...
    this.sendPropagatedConnectionLimitIfZero = registerOutput<bool?>(
    ...
    this.tunnelingConfig = registerOutput<ServiceAttachmentTunnelingConfig?>(
      'tunnelingConfig',
    );
  }
}
