...
class RouterPeer extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RouterPeerAdvertisedIpRange>?>
  advertisedIpRanges;
  ...
  /// Structure is documented below.
  late final pulumi.Output<List<RouterPeerCustomLearnedIpRange>?>
  ...
  /// Structure is documented below.
  late final pulumi.Output<RouterPeerMd5AuthenticationKey?>
  md5AuthenticationKey;
  ...
  RouterPeer(
    ...
    this.advertisedRoutePriority = registerOutput<int?>(
    ...
    this.customLearnedRoutePriority = registerOutput<int?>(
    ...
    this.isAdvertisedRoutePrioritySet = registerOutput<bool>(
      'isAdvertisedRoutePrioritySet',
    );
    this.isCustomLearnedPrioritySet = registerOutput<bool>(
      'isCustomLearnedPrioritySet',
    );
    this.managementType = registerOutput<String>('managementType');
    this.md5AuthenticationKey = registerOutput<RouterPeerMd5AuthenticationKey?>(
      'md5AuthenticationKey',
    );
    this.name = registerOutput<String>('name');
    this.peerAsn = registerOutput<int>('peerAsn');
    this.peerIpAddress = registerOutput<String>('peerIpAddress');
    this.peerIpv4NexthopAddress = registerOutput<String>(
      'peerIpv4NexthopAddress',
    );
    this.peerIpv6NexthopAddress = registerOutput<String>(
      'peerIpv6NexthopAddress',
    );
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.router = registerOutput<String>('router');
    this.routerApplianceInstance = registerOutput<String?>(
      'routerApplianceInstance',
    );
    this.zeroAdvertisedRoutePriority = registerOutput<bool?>(
      'zeroAdvertisedRoutePriority',
    );
    this.zeroCustomLearnedRoutePriority = registerOutput<bool?>(
