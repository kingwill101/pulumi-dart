...
class RouteArgs {
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      ...
      nextHopInstanceZone: map['nextHopInstanceZone'] == null ? null : map['nextHopInstanceZone'] as String,
      ...
      params: map['params'] == null ? null : RouteParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
