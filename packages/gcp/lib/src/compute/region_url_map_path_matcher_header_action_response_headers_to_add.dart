...
class RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd {
  ...
  /// Creates a new [RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd].
  ...
  factory RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd.fromMap(
    Map<String, dynamic> map,
  ) {
    return RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd(
