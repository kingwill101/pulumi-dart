...
class SubnetworkArgs {
  ...
  SubnetworkArgs({
    ...
    String? stackType,
        ...
        internalIpv6Prefix =
            pulumi.Input.asOptionalInput<String>(internalIpv6Prefix),
        ...
        logConfig =
            pulumi.Input.asOptionalInput<SubnetworkLogConfig>(logConfig),
        ...
        resolveSubnetMask =
            pulumi.Input.asOptionalInput<String>(resolveSubnetMask),
        role = pulumi.Input.asOptionalInput<String>(role),
        secondaryIpRanges =
            pulumi.Input.asOptionalInput<List<SubnetworkSecondaryIpRange>>(
                secondaryIpRanges),
        sendSecondaryIpRangeIfEmpty =
            pulumi.Input.asOptionalInput<bool>(sendSecondaryIpRangeIfEmpty),
  ...
  factory SubnetworkArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs(
      ...
      internalIpv6Prefix: map['internalIpv6Prefix'] == null
          ? null
          : map['internalIpv6Prefix'] as String,
      ipCidrRange:
      ...
      resolveSubnetMask: map['resolveSubnetMask'] == null
          ? null
          : map['resolveSubnetMask'] as String,
      ...
      sendSecondaryIpRangeIfEmpty: map['sendSecondaryIpRangeIfEmpty'] == null
          ? null
          : map['sendSecondaryIpRangeIfEmpty'] as bool,
