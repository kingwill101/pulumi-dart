...
class SubnetworkArgs {
  ...
  SubnetworkArgs({
    ...
    String? role,
    List<SubnetworkSecondaryIpRange>? secondaryIpRanges,
  ...
  factory SubnetworkArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs(
      ...
      internalIpv6Prefix: map['internalIpv6Prefix'] == null ? null : map['internalIpv6Prefix'] as String,
      ...
      params: map['params'] == null ? null : SubnetworkParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      ...
      resolveSubnetMask: map['resolveSubnetMask'] == null ? null : map['resolveSubnetMask'] as String,
      role: map['role'] == null ? null : map['role'] as String,
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : pulumi.Input.decodeList<SubnetworkSecondaryIpRange>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryIpRange.fromMap((value as Map).cast<String, dynamic>())),
      sendSecondaryIpRangeIfEmpty: map['sendSecondaryIpRangeIfEmpty'] == null ? null : map['sendSecondaryIpRangeIfEmpty'] as bool,
