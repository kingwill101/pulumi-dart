...
class InstanceScheduling {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities': ?nodeAffinities == null ? null : pulumi.Input.encodeList<InstanceSchedulingNodeAffinity, Map<String, dynamic>>(nodeAffinities!, (value) => value.toMap()),
  ...
  factory InstanceScheduling.fromMap(Map<String, dynamic> map) {
    return InstanceScheduling(
      ...
      gracefulShutdown: map['gracefulShutdown'] == null ? null : InstanceSchedulingGracefulShutdown.fromMap((map['gracefulShutdown'] as Map).cast<String, dynamic>()),
      ...
      localSsdRecoveryTimeout: map['localSsdRecoveryTimeout'] == null ? null : InstanceSchedulingLocalSsdRecoveryTimeout.fromMap((map['localSsdRecoveryTimeout'] as Map).cast<String, dynamic>()),
      maintenanceInterval: map['maintenanceInterval'] == null ? null : map['maintenanceInterval'] as String,
      maxRunDuration: map['maxRunDuration'] == null ? null : InstanceSchedulingMaxRunDuration.fromMap((map['maxRunDuration'] as Map).cast<String, dynamic>()),
      minNodeCpus: map['minNodeCpus'] == null ? null : map['minNodeCpus'] as int,
      nodeAffinities: map['nodeAffinities'] == null ? null : pulumi.Input.decodeList<InstanceSchedulingNodeAffinity>(map['nodeAffinities'], (value) => InstanceSchedulingNodeAffinity.fromMap((value as Map).cast<String, dynamic>())),
      onHostMaintenance: map['onHostMaintenance'] == null ? null : map['onHostMaintenance'] as String,
      onInstanceStopAction: map['onInstanceStopAction'] == null ? null : InstanceSchedulingOnInstanceStopAction.fromMap((map['onInstanceStopAction'] as Map).cast<String, dynamic>()),
