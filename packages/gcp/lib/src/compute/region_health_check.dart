...
class RegionHealthCheck extends pulumi.CustomResource {
  ...
  RegionHealthCheck(
    ...
    this.grpcHealthCheck = registerOutput<RegionHealthCheckGrpcHealthCheck?>(
      'grpcHealthCheck',
    );
    ...
    this.http2HealthCheck = registerOutput<RegionHealthCheckHttp2HealthCheck?>(
      'http2HealthCheck',
    );
    this.httpHealthCheck = registerOutput<RegionHealthCheckHttpHealthCheck?>(
      'httpHealthCheck',
    );
    this.httpsHealthCheck = registerOutput<RegionHealthCheckHttpsHealthCheck?>(
      'httpsHealthCheck',
    );
    ...
    this.sslHealthCheck = registerOutput<RegionHealthCheckSslHealthCheck?>(
      'sslHealthCheck',
    );
    this.tcpHealthCheck = registerOutput<RegionHealthCheckTcpHealthCheck?>(
      'tcpHealthCheck',
    );
