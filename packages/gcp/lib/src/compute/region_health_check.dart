...
class RegionHealthCheck extends pulumi.CustomResource {
  ...
  RegionHealthCheck(
    ...
    this.grpcHealthCheck = registerOutput<RegionHealthCheckGrpcHealthCheck?>('grpcHealthCheck');
    this.grpcTlsHealthCheck = registerOutput<RegionHealthCheckGrpcTlsHealthCheck?>('grpcTlsHealthCheck');
    this.healthCheckId = registerOutput<int>('healthCheckId');
    this.healthyThreshold = registerOutput<int?>('healthyThreshold');
    this.http2HealthCheck = registerOutput<RegionHealthCheckHttp2HealthCheck?>('http2HealthCheck');
    this.httpHealthCheck = registerOutput<RegionHealthCheckHttpHealthCheck?>('httpHealthCheck');
    this.httpsHealthCheck = registerOutput<RegionHealthCheckHttpsHealthCheck?>('httpsHealthCheck');
    this.logConfig = registerOutput<RegionHealthCheckLogConfig>('logConfig');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.selfLink = registerOutput<String>('selfLink');
    this.sslHealthCheck = registerOutput<RegionHealthCheckSslHealthCheck?>('sslHealthCheck');
    this.tcpHealthCheck = registerOutput<RegionHealthCheckTcpHealthCheck?>('tcpHealthCheck');
