...
class StoragePoolArgs {
  ...
  StoragePoolArgs({
    ...
    required String poolProvisionedCapacityGb,
    String? poolProvisionedIops,
    required String poolProvisionedThroughput,
    String? project,
    required String storagePoolType,
    String? zone,
  }) : capacityProvisioningType = pulumi.Input.asOptionalInput<String>(
       ...
       performanceProvisioningType = pulumi.Input.asOptionalInput<String>(
         performanceProvisioningType,
       ),
       poolProvisionedCapacityGb = pulumi.Input.asInput<String>(
         poolProvisionedCapacityGb,
       ),
       poolProvisionedIops = pulumi.Input.asOptionalInput<String>(
         poolProvisionedIops,
       ),
       poolProvisionedThroughput = pulumi.Input.asInput<String>(
  ...
  factory StoragePoolArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolArgs(
      ...
      poolProvisionedIops: map['poolProvisionedIops'] == null
          ? null
          : map['poolProvisionedIops'] as String,
