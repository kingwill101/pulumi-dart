...
class StoragePoolArgs {
  ...
  factory StoragePoolArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolArgs(
      capacityProvisioningType: map['capacityProvisioningType'] == null ? null : map['capacityProvisioningType'] as String,
      deletionProtection: map['deletionProtection'] == null ? null : map['deletionProtection'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      performanceProvisioningType: map['performanceProvisioningType'] == null ? null : map['performanceProvisioningType'] as String,
      poolProvisionedCapacityGb: map['poolProvisionedCapacityGb'] as String,
      poolProvisionedIops: map['poolProvisionedIops'] == null ? null : map['poolProvisionedIops'] as String,
