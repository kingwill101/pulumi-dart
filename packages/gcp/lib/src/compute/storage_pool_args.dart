...
class StoragePoolArgs {
  ...
  StoragePoolArgs({
    ...
    String? zone,
            ...
            pulumi.Input.asOptionalInput<String>(capacityProvisioningType),
        deletionProtection =
        ...
        performanceProvisioningType =
            pulumi.Input.asOptionalInput<String>(performanceProvisioningType),
        poolProvisionedCapacityGb =
            pulumi.Input.asInput<String>(poolProvisionedCapacityGb),
        poolProvisionedIops =
            pulumi.Input.asOptionalInput<String>(poolProvisionedIops),
        poolProvisionedThroughput =
            pulumi.Input.asInput<String>(poolProvisionedThroughput),
