...
class GetSecurityPolicyRuleMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'configs': pulumi.Input.encodeList<GetSecurityPolicyRuleMatchConfig, Map<String, dynamic>>(configs, (value) => value.toMap()),
      'exprOptions': pulumi.Input.encodeList<GetSecurityPolicyRuleMatchExprOption, Map<String, dynamic>>(exprOptions, (value) => value.toMap()),
      'exprs': pulumi.Input.encodeList<GetSecurityPolicyRuleMatchExpr, Map<String, dynamic>>(exprs, (value) => value.toMap()),
  ...
  factory GetSecurityPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return GetSecurityPolicyRuleMatch(
      configs: pulumi.Input.decodeList<GetSecurityPolicyRuleMatchConfig>(map['configs'], (value) => GetSecurityPolicyRuleMatchConfig.fromMap((value as Map).cast<String, dynamic>())),
      exprOptions: pulumi.Input.decodeList<GetSecurityPolicyRuleMatchExprOption>(map['exprOptions'], (value) => GetSecurityPolicyRuleMatchExprOption.fromMap((value as Map).cast<String, dynamic>())),
      exprs: pulumi.Input.decodeList<GetSecurityPolicyRuleMatchExpr>(map['exprs'], (value) => GetSecurityPolicyRuleMatchExpr.fromMap((value as Map).cast<String, dynamic>())),
