...
class InstanceFromMachineImageBootDiskInitializeParams {
  ...
  final InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey? sourceImageEncryptionKey;
  /// The encryption key used to decrypt the source snapshot.
  final InstanceFromMachineImageBootDiskInitializeParamsSourceSnapshotEncryptionKey? sourceSnapshotEncryptionKey;
  ...
  factory InstanceFromMachineImageBootDiskInitializeParams.fromMap(Map<String, dynamic> map) {
    return InstanceFromMachineImageBootDiskInitializeParams(
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : InstanceFromMachineImageBootDiskInitializeParamsSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
