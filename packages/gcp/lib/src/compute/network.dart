...
class Network extends pulumi.CustomResource {
  ...
  Network(
    ...
    this.bgpBestPathSelectionMode = registerOutput<String>(
      'bgpBestPathSelectionMode',
    );
    this.bgpInterRegionCost = registerOutput<String>('bgpInterRegionCost');
    this.deleteBgpAlwaysCompareMed = registerOutput<bool?>(
      'deleteBgpAlwaysCompareMed',
    );
    this.deleteDefaultRoutesOnCreate = registerOutput<bool?>(
