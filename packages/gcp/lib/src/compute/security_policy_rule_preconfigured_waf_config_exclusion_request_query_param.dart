...
class SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam {
  ...
  /// Creates a new [SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam].
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam.fromMap(
    Map<String, dynamic> map,
  ) {
    return SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam(
