...
class FirewallArgs {
  ...
  FirewallArgs({
    List<FirewallAllow>? allows,
    List<FirewallDeny>? denies,
    String? description,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (allowsValue != null) {
      map['allows'] = pulumi.Input.mapOptionalInputValue<List<FirewallAllow>,
              List<Map<String, dynamic>>>(
          allowsValue,
          (value) =>
              pulumi.Input.encodeList<FirewallAllow, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    final deniesValue = denies;
    if (deniesValue != null) {
      map['denies'] = pulumi.Input.mapOptionalInputValue<List<FirewallDeny>,
              List<Map<String, dynamic>>>(
          deniesValue,
          (value) =>
              pulumi.Input.encodeList<FirewallDeny, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    ...
    if (logConfigValue != null) {
      map['logConfig'] = pulumi.Input.mapOptionalInputValue<FirewallLogConfig,
    ...
    if (paramsValue != null) {
      map['params'] = pulumi.Input.mapOptionalInputValue<FirewallParams,
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allows: map['allows'] == null
          ? null
          : pulumi.Input.decodeList<FirewallAllow>(
              map['allows'],
              (value) => FirewallAllow.fromMap(
                  (value as Map).cast<String, dynamic>())),
      denies: map['denies'] == null
          ? null
          : pulumi.Input.decodeList<FirewallDeny>(
              map['denies'],
              (value) =>
                  FirewallDeny.fromMap((value as Map).cast<String, dynamic>())),
      description:
