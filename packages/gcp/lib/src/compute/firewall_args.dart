...
class FirewallArgs {
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allows: map['allows'] == null ? null : pulumi.Input.decodeList<FirewallAllow>(map['allows'], (value) => FirewallAllow.fromMap((value as Map).cast<String, dynamic>())),
      denies: map['denies'] == null ? null : pulumi.Input.decodeList<FirewallDeny>(map['denies'], (value) => FirewallDeny.fromMap((value as Map).cast<String, dynamic>())),
      ...
      params: map['params'] == null ? null : FirewallParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
