...
class RegionDisk extends pulumi.CustomResource {
  ...
  RegionDisk(
    ...
    this.asyncPrimaryDisk = registerOutput<RegionDiskAsyncPrimaryDisk?>(
      'asyncPrimaryDisk',
    );
    this.createSnapshotBeforeDestroy = registerOutput<bool?>(
      'createSnapshotBeforeDestroy',
    );
    this.createSnapshotBeforeDestroyPrefix = registerOutput<String?>(
      'createSnapshotBeforeDestroyPrefix',
    );
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.description = registerOutput<String?>('description');
    this.diskEncryptionKey = registerOutput<RegionDiskDiskEncryptionKey?>(
      'diskEncryptionKey',
    );
    ...
    this.guestOsFeatures = registerOutput<List<RegionDiskGuestOsFeature>>(
      'guestOsFeatures',
    );
