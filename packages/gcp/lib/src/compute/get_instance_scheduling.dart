...
class GetInstanceScheduling {
  ...
  /// hour.
  final List<GetInstanceSchedulingLocalSsdRecoveryTimeout> localSsdRecoveryTimeouts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gracefulShutdowns': pulumi.Input.encodeList<GetInstanceSchedulingGracefulShutdown, Map<String, dynamic>>(gracefulShutdowns, (value) => value.toMap()),
      'hostErrorTimeoutSeconds': hostErrorTimeoutSeconds,
      'instanceTerminationAction': instanceTerminationAction,
      'localSsdRecoveryTimeouts': pulumi.Input.encodeList<GetInstanceSchedulingLocalSsdRecoveryTimeout, Map<String, dynamic>>(localSsdRecoveryTimeouts, (value) => value.toMap()),
      'maintenanceInterval': maintenanceInterval,
      'maxRunDurations': pulumi.Input.encodeList<GetInstanceSchedulingMaxRunDuration, Map<String, dynamic>>(maxRunDurations, (value) => value.toMap()),
      'minNodeCpus': minNodeCpus,
      'nodeAffinities': pulumi.Input.encodeList<GetInstanceSchedulingNodeAffinity, Map<String, dynamic>>(nodeAffinities, (value) => value.toMap()),
      'onHostMaintenance': onHostMaintenance,
      'onInstanceStopActions': pulumi.Input.encodeList<GetInstanceSchedulingOnInstanceStopAction, Map<String, dynamic>>(onInstanceStopActions, (value) => value.toMap()),
  ...
  factory GetInstanceScheduling.fromMap(Map<String, dynamic> map) {
    return GetInstanceScheduling(
      ...
      gracefulShutdowns: pulumi.Input.decodeList<GetInstanceSchedulingGracefulShutdown>(map['gracefulShutdowns'], (value) => GetInstanceSchedulingGracefulShutdown.fromMap((value as Map).cast<String, dynamic>())),
      ...
      localSsdRecoveryTimeouts: pulumi.Input.decodeList<GetInstanceSchedulingLocalSsdRecoveryTimeout>(map['localSsdRecoveryTimeouts'], (value) => GetInstanceSchedulingLocalSsdRecoveryTimeout.fromMap((value as Map).cast<String, dynamic>())),
      maintenanceInterval: map['maintenanceInterval'] as String,
      maxRunDurations: pulumi.Input.decodeList<GetInstanceSchedulingMaxRunDuration>(map['maxRunDurations'], (value) => GetInstanceSchedulingMaxRunDuration.fromMap((value as Map).cast<String, dynamic>())),
      minNodeCpus: map['minNodeCpus'] as int,
      nodeAffinities: pulumi.Input.decodeList<GetInstanceSchedulingNodeAffinity>(map['nodeAffinities'], (value) => GetInstanceSchedulingNodeAffinity.fromMap((value as Map).cast<String, dynamic>())),
      onHostMaintenance: map['onHostMaintenance'] as String,
      onInstanceStopActions: pulumi.Input.decodeList<GetInstanceSchedulingOnInstanceStopAction>(map['onInstanceStopActions'], (value) => GetInstanceSchedulingOnInstanceStopAction.fromMap((value as Map).cast<String, dynamic>())),
