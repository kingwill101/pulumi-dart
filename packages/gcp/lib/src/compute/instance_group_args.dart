...
class InstanceGroupArgs {
  ...
  factory InstanceGroupArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupArgs(
      ...
      namedPorts: map['namedPorts'] == null ? null : pulumi.Input.decodeList<InstanceGroupNamedPort>(map['namedPorts'], (value) => InstanceGroupNamedPort.fromMap((value as Map).cast<String, dynamic>())),
