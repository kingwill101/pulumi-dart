...
class RegionBackendService extends pulumi.CustomResource {
  ...
  RegionBackendService(
    ...
    this.backends = registerOutput<List<RegionBackendServiceBackend>?>(
      'backends',
    );
    this.cdnPolicy = registerOutput<RegionBackendServiceCdnPolicy>('cdnPolicy');
    this.circuitBreakers = registerOutput<RegionBackendServiceCircuitBreakers?>(
      'circuitBreakers',
    );
    ...
    this.consistentHash = registerOutput<RegionBackendServiceConsistentHash?>(
      'consistentHash',
    );
    ...
    this.failoverPolicy = registerOutput<RegionBackendServiceFailoverPolicy?>(
      'failoverPolicy',
    );
    ...
    this.subsetting = registerOutput<RegionBackendServiceSubsetting?>(
      'subsetting',
    );
    this.timeoutSec = registerOutput<int>('timeoutSec');
    this.tlsSettings = registerOutput<RegionBackendServiceTlsSettings?>(
      'tlsSettings',
    );
  }
}
