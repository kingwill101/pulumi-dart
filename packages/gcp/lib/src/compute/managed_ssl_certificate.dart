...
class ManagedSslCertificate extends pulumi.CustomResource {
  ...
  /// Creates a new [ManagedSslCertificate].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ManagedSslCertificate]. {@macro pulumi_compute_managed_ssl_certificate_managed_ssl_certificate_args_doc}
