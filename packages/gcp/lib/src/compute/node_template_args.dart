...
class NodeTemplateArgs {
  ...
  factory NodeTemplateArgs.fromMap(Map<String, dynamic> map) {
    return NodeTemplateArgs(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<NodeTemplateAccelerator>(map['accelerators'], (value) => NodeTemplateAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      cpuOvercommitType: map['cpuOvercommitType'] == null ? null : map['cpuOvercommitType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      disks: map['disks'] == null ? null : pulumi.Input.decodeList<NodeTemplateDisk>(map['disks'], (value) => NodeTemplateDisk.fromMap((value as Map).cast<String, dynamic>())),
      ...
      nodeTypeFlexibility: map['nodeTypeFlexibility'] == null ? null : NodeTemplateNodeTypeFlexibility.fromMap((map['nodeTypeFlexibility'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      serverBinding: map['serverBinding'] == null ? null : NodeTemplateServerBinding.fromMap((map['serverBinding'] as Map).cast<String, dynamic>()),
    );
  }
}
