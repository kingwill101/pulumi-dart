...
class GetBackendServiceSecuritySetting {
  ...
  final List<GetBackendServiceSecuritySettingAwsV4Authentication> awsV4Authentications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsV4Authentications': pulumi.Input.encodeList<GetBackendServiceSecuritySettingAwsV4Authentication, Map<String, dynamic>>(awsV4Authentications, (value) => value.toMap()),
  ...
  factory GetBackendServiceSecuritySetting.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceSecuritySetting(
      awsV4Authentications: pulumi.Input.decodeList<GetBackendServiceSecuritySettingAwsV4Authentication>(map['awsV4Authentications'], (value) => GetBackendServiceSecuritySettingAwsV4Authentication.fromMap((value as Map).cast<String, dynamic>())),
