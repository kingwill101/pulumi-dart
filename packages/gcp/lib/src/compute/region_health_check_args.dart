...
class RegionHealthCheckArgs {
  ...
  RegionHealthCheckArgs({
    ...
    String? description,
    RegionHealthCheckGrpcHealthCheck? grpcHealthCheck,
    RegionHealthCheckGrpcTlsHealthCheck? grpcTlsHealthCheck,
    int? healthyThreshold,
    RegionHealthCheckHttp2HealthCheck? http2HealthCheck,
    RegionHealthCheckHttpHealthCheck? httpHealthCheck,
    RegionHealthCheckHttpsHealthCheck? httpsHealthCheck,
    RegionHealthCheckLogConfig? logConfig,
    String? name,
    String? project,
    String? region,
    RegionHealthCheckSslHealthCheck? sslHealthCheck,
    RegionHealthCheckTcpHealthCheck? tcpHealthCheck,
    int? timeoutSec,
  ...
  factory RegionHealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckArgs(
      ...
      grpcHealthCheck: map['grpcHealthCheck'] == null ? null : RegionHealthCheckGrpcHealthCheck.fromMap((map['grpcHealthCheck'] as Map).cast<String, dynamic>()),
      grpcTlsHealthCheck: map['grpcTlsHealthCheck'] == null ? null : RegionHealthCheckGrpcTlsHealthCheck.fromMap((map['grpcTlsHealthCheck'] as Map).cast<String, dynamic>()),
      healthyThreshold: map['healthyThreshold'] == null ? null : map['healthyThreshold'] as int,
      http2HealthCheck: map['http2HealthCheck'] == null ? null : RegionHealthCheckHttp2HealthCheck.fromMap((map['http2HealthCheck'] as Map).cast<String, dynamic>()),
      httpHealthCheck: map['httpHealthCheck'] == null ? null : RegionHealthCheckHttpHealthCheck.fromMap((map['httpHealthCheck'] as Map).cast<String, dynamic>()),
      httpsHealthCheck: map['httpsHealthCheck'] == null ? null : RegionHealthCheckHttpsHealthCheck.fromMap((map['httpsHealthCheck'] as Map).cast<String, dynamic>()),
      logConfig: map['logConfig'] == null ? null : RegionHealthCheckLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sslHealthCheck: map['sslHealthCheck'] == null ? null : RegionHealthCheckSslHealthCheck.fromMap((map['sslHealthCheck'] as Map).cast<String, dynamic>()),
      tcpHealthCheck: map['tcpHealthCheck'] == null ? null : RegionHealthCheckTcpHealthCheck.fromMap((map['tcpHealthCheck'] as Map).cast<String, dynamic>()),
