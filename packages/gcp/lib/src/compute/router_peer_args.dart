...
class RouterPeerArgs {
  ...
  RouterPeerArgs({
    ...
    bool? zeroCustomLearnedRoutePriority,
       ...
       advertisedGroups = pulumi.Input.asOptionalInput<List<String>>(
         advertisedGroups,
       ),
       advertisedIpRanges =
       ...
       advertisedRoutePriority = pulumi.Input.asOptionalInput<int>(
       ...
       customLearnedRoutePriority = pulumi.Input.asOptionalInput<int>(
       ...
       exportPolicies = pulumi.Input.asOptionalInput<List<String>>(
         exportPolicies,
       ),
       importPolicies = pulumi.Input.asOptionalInput<List<String>>(
         importPolicies,
       ),
       interface = pulumi.Input.asInput<String>(interface),
       ipAddress = pulumi.Input.asOptionalInput<String>(ipAddress),
       ipv4NexthopAddress = pulumi.Input.asOptionalInput<String>(
         ipv4NexthopAddress,
       ),
       ipv6NexthopAddress = pulumi.Input.asOptionalInput<String>(
         ipv6NexthopAddress,
       ),
       ...
       peerIpv4NexthopAddress = pulumi.Input.asOptionalInput<String>(
         peerIpv4NexthopAddress,
       ),
       peerIpv6NexthopAddress = pulumi.Input.asOptionalInput<String>(
         peerIpv6NexthopAddress,
       ),
       project = pulumi.Input.asOptionalInput<String>(project),
       region = pulumi.Input.asOptionalInput<String>(region),
       router = pulumi.Input.asInput<String>(router),
       routerApplianceInstance = pulumi.Input.asOptionalInput<String>(
  ...
  factory RouterPeerArgs.fromMap(Map<String, dynamic> map) {
    return RouterPeerArgs(
      ...
      peerIpAddress: map['peerIpAddress'] == null
          ? null
          : map['peerIpAddress'] as String,
