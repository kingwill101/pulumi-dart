...
class RouterPeerArgs {
  ...
  factory RouterPeerArgs.fromMap(Map<String, dynamic> map) {
    return RouterPeerArgs(
      ...
      advertisedIpRanges: map['advertisedIpRanges'] == null ? null : pulumi.Input.decodeList<RouterPeerAdvertisedIpRange>(map['advertisedIpRanges'], (value) => RouterPeerAdvertisedIpRange.fromMap((value as Map).cast<String, dynamic>())),
      advertisedRoutePriority: map['advertisedRoutePriority'] == null ? null : map['advertisedRoutePriority'] as int,
      bfd: map['bfd'] == null ? null : RouterPeerBfd.fromMap((map['bfd'] as Map).cast<String, dynamic>()),
      customLearnedIpRanges: map['customLearnedIpRanges'] == null ? null : pulumi.Input.decodeList<RouterPeerCustomLearnedIpRange>(map['customLearnedIpRanges'], (value) => RouterPeerCustomLearnedIpRange.fromMap((value as Map).cast<String, dynamic>())),
      ...
      md5AuthenticationKey: map['md5AuthenticationKey'] == null ? null : RouterPeerMd5AuthenticationKey.fromMap((map['md5AuthenticationKey'] as Map).cast<String, dynamic>()),
      ...
      zeroAdvertisedRoutePriority: map['zeroAdvertisedRoutePriority'] == null ? null : map['zeroAdvertisedRoutePriority'] as bool,
      zeroCustomLearnedRoutePriority: map['zeroCustomLearnedRoutePriority'] == null ? null : map['zeroCustomLearnedRoutePriority'] as bool,
    );
  }
}
