    ...
    return <String, dynamic>{
      ...
      'instanceEncryptionKeys':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(instanceEncryptionKeys, (value) => value.toMap()),
      ...
      'params': pulumi.Input.encodeList<GetInstanceParam, Map<String, dynamic>>(
        params,
        (value) => value.toMap(),
      ),
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      ...
      bootDisks: pulumi.Input.decodeList<GetInstanceBootDisk>(
        map['bootDisks'],
        (value) =>
            GetInstanceBootDisk.fromMap((value as Map).cast<String, dynamic>()),
      ),
