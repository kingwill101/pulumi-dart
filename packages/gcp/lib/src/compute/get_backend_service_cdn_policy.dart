...
class GetBackendServiceCdnPolicy {
  ...
  final List<GetBackendServiceCdnPolicyBypassCacheOnRequestHeader> bypassCacheOnRequestHeaders;
  ...
  final List<GetBackendServiceCdnPolicyNegativeCachingPolicy> negativeCachingPolicies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.encodeList<GetBackendServiceCdnPolicyBypassCacheOnRequestHeader, Map<String, dynamic>>(bypassCacheOnRequestHeaders, (value) => value.toMap()),
      'cacheKeyPolicies': pulumi.Input.encodeList<GetBackendServiceCdnPolicyCacheKeyPolicy, Map<String, dynamic>>(cacheKeyPolicies, (value) => value.toMap()),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicies': pulumi.Input.encodeList<GetBackendServiceCdnPolicyNegativeCachingPolicy, Map<String, dynamic>>(negativeCachingPolicies, (value) => value.toMap()),
  ...
  factory GetBackendServiceCdnPolicy.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceCdnPolicy(
      bypassCacheOnRequestHeaders: pulumi.Input.decodeList<GetBackendServiceCdnPolicyBypassCacheOnRequestHeader>(map['bypassCacheOnRequestHeaders'], (value) => GetBackendServiceCdnPolicyBypassCacheOnRequestHeader.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicies: pulumi.Input.decodeList<GetBackendServiceCdnPolicyCacheKeyPolicy>(map['cacheKeyPolicies'], (value) => GetBackendServiceCdnPolicyCacheKeyPolicy.fromMap((value as Map).cast<String, dynamic>())),
      ...
      negativeCachingPolicies: pulumi.Input.decodeList<GetBackendServiceCdnPolicyNegativeCachingPolicy>(map['negativeCachingPolicies'], (value) => GetBackendServiceCdnPolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>())),
