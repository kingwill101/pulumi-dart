...
class RegionBackendServiceIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RegionBackendServiceIamBindingCondition?> condition;
  ...
  /// Creates a new [RegionBackendServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionBackendServiceIamBinding]. {@macro pulumi_compute_region_backend_service_iam_binding_region_backend_service_iam_binding_args_doc}
  ...
  RegionBackendServiceIamBinding(
    ...
    this.condition = registerOutput<RegionBackendServiceIamBindingCondition?>('condition');
