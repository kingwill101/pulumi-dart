      ...
      layer4Configs: map['layer4Configs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['layer4Configs'],
              (value) =>
                  RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config.fromMap(
      ...
      srcSecureTags: map['srcSecureTags'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['srcSecureTags'],
              (value) =>
                  RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
