...
class HealthCheck extends pulumi.CustomResource {
  ...
  HealthCheck(
    ...
    this.grpcHealthCheck = registerOutput<HealthCheckGrpcHealthCheck?>(
      'grpcHealthCheck',
    );
    this.grpcTlsHealthCheck = registerOutput<HealthCheckGrpcTlsHealthCheck?>(
      'grpcTlsHealthCheck',
    );
    this.healthyThreshold = registerOutput<int?>('healthyThreshold');
    this.http2HealthCheck = registerOutput<HealthCheckHttp2HealthCheck?>(
      'http2HealthCheck',
    );
    this.httpHealthCheck = registerOutput<HealthCheckHttpHealthCheck?>(
      'httpHealthCheck',
    );
    this.httpsHealthCheck = registerOutput<HealthCheckHttpsHealthCheck?>(
      'httpsHealthCheck',
    );
    ...
    this.sslHealthCheck = registerOutput<HealthCheckSslHealthCheck?>(
      'sslHealthCheck',
    );
    this.tcpHealthCheck = registerOutput<HealthCheckTcpHealthCheck?>(
      'tcpHealthCheck',
    );
