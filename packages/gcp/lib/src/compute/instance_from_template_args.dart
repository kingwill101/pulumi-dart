...
class InstanceFromTemplateArgs {
  ...
  factory InstanceFromTemplateArgs.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateArgs(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : InstanceFromTemplateAdvancedMachineFeatures.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      allowStoppingForUpdate: map['allowStoppingForUpdate'] == null ? null : map['allowStoppingForUpdate'] as bool,
      attachedDisks: map['attachedDisks'] == null ? null : pulumi.Input.decodeList<InstanceFromTemplateAttachedDisk>(map['attachedDisks'], (value) => InstanceFromTemplateAttachedDisk.fromMap((value as Map).cast<String, dynamic>())),
      bootDisk: map['bootDisk'] == null ? null : InstanceFromTemplateBootDisk.fromMap((map['bootDisk'] as Map).cast<String, dynamic>()),
      canIpForward: map['canIpForward'] == null ? null : map['canIpForward'] as bool,
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : InstanceFromTemplateConfidentialInstanceConfig.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>()),
      ...
      guestAccelerators: map['guestAccelerators'] == null ? null : pulumi.Input.decodeList<InstanceFromTemplateGuestAccelerator>(map['guestAccelerators'], (value) => InstanceFromTemplateGuestAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      hostname: map['hostname'] == null ? null : map['hostname'] as String,
      instanceEncryptionKey: map['instanceEncryptionKey'] == null ? null : InstanceFromTemplateInstanceEncryptionKey.fromMap((map['instanceEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<InstanceFromTemplateNetworkInterface>(map['networkInterfaces'], (value) => InstanceFromTemplateNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : InstanceFromTemplateNetworkPerformanceConfig.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      params: map['params'] == null ? null : InstanceFromTemplateParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      partnerMetadata: map['partnerMetadata'] == null ? null : (map['partnerMetadata'] as Map).cast<String, String>(),
      project: map['project'] == null ? null : map['project'] as String,
      reservationAffinity: map['reservationAffinity'] == null ? null : InstanceFromTemplateReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      resourcePolicies: map['resourcePolicies'] == null ? null : map['resourcePolicies'] as String,
      scheduling: map['scheduling'] == null ? null : InstanceFromTemplateScheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      scratchDisks: map['scratchDisks'] == null ? null : pulumi.Input.decodeList<InstanceFromTemplateScratchDisk>(map['scratchDisks'], (value) => InstanceFromTemplateScratchDisk.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] == null ? null : InstanceFromTemplateServiceAccount.fromMap((map['serviceAccount'] as Map).cast<String, dynamic>()),
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : InstanceFromTemplateShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
