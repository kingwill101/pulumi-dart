...
class InstanceTemplateNetworkInterface {
  ...
  final List<InstanceTemplateNetworkInterfaceIpv6AccessConfig>? ipv6AccessConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': ?accessConfigs == null ? null : pulumi.Input.encodeList<InstanceTemplateNetworkInterfaceAccessConfig, Map<String, dynamic>>(accessConfigs!, (value) => value.toMap()),
      'aliasIpRanges': ?aliasIpRanges == null ? null : pulumi.Input.encodeList<InstanceTemplateNetworkInterfaceAliasIpRange, Map<String, dynamic>>(aliasIpRanges!, (value) => value.toMap()),
      'igmpQuery': ?igmpQuery,
      'internalIpv6PrefixLength': ?internalIpv6PrefixLength,
      'ipv6AccessConfigs': ?ipv6AccessConfigs == null ? null : pulumi.Input.encodeList<InstanceTemplateNetworkInterfaceIpv6AccessConfig, Map<String, dynamic>>(ipv6AccessConfigs!, (value) => value.toMap()),
  ...
  factory InstanceTemplateNetworkInterface.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateNetworkInterface(
      accessConfigs: map['accessConfigs'] == null ? null : pulumi.Input.decodeList<InstanceTemplateNetworkInterfaceAccessConfig>(map['accessConfigs'], (value) => InstanceTemplateNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null ? null : pulumi.Input.decodeList<InstanceTemplateNetworkInterfaceAliasIpRange>(map['aliasIpRanges'], (value) => InstanceTemplateNetworkInterfaceAliasIpRange.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ipv6AccessConfigs: map['ipv6AccessConfigs'] == null ? null : pulumi.Input.decodeList<InstanceTemplateNetworkInterfaceIpv6AccessConfig>(map['ipv6AccessConfigs'], (value) => InstanceTemplateNetworkInterfaceIpv6AccessConfig.fromMap((value as Map).cast<String, dynamic>())),
