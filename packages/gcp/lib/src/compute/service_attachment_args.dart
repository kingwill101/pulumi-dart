...
class ServiceAttachmentArgs {
  ...
  factory ServiceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentArgs(
      ...
      consumerAcceptLists: map['consumerAcceptLists'] == null ? null : pulumi.Input.decodeList<ServiceAttachmentConsumerAcceptList>(map['consumerAcceptLists'], (value) => ServiceAttachmentConsumerAcceptList.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sendPropagatedConnectionLimitIfZero: map['sendPropagatedConnectionLimitIfZero'] == null ? null : map['sendPropagatedConnectionLimitIfZero'] as bool,
