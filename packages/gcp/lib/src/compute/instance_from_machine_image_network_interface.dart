...
class InstanceFromMachineImageNetworkInterface {
  ...
  final List<InstanceFromMachineImageNetworkInterfaceAccessConfig>? accessConfigs;
  /// An array of alias IP ranges for this network interface.
  final List<InstanceFromMachineImageNetworkInterfaceAliasIpRange>? aliasIpRanges;
  ...
  final List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig>? ipv6AccessConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': ?accessConfigs == null ? null : pulumi.Input.encodeList<InstanceFromMachineImageNetworkInterfaceAccessConfig, Map<String, dynamic>>(accessConfigs!, (value) => value.toMap()),
      'aliasIpRanges': ?aliasIpRanges == null ? null : pulumi.Input.encodeList<InstanceFromMachineImageNetworkInterfaceAliasIpRange, Map<String, dynamic>>(aliasIpRanges!, (value) => value.toMap()),
      'igmpQuery': ?igmpQuery,
      'internalIpv6PrefixLength': ?internalIpv6PrefixLength,
      'ipv6AccessConfigs': ?ipv6AccessConfigs == null ? null : pulumi.Input.encodeList<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig, Map<String, dynamic>>(ipv6AccessConfigs!, (value) => value.toMap()),
  ...
  factory InstanceFromMachineImageNetworkInterface.fromMap(Map<String, dynamic> map) {
    return InstanceFromMachineImageNetworkInterface(
      accessConfigs: map['accessConfigs'] == null ? null : pulumi.Input.decodeList<InstanceFromMachineImageNetworkInterfaceAccessConfig>(map['accessConfigs'], (value) => InstanceFromMachineImageNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null ? null : pulumi.Input.decodeList<InstanceFromMachineImageNetworkInterfaceAliasIpRange>(map['aliasIpRanges'], (value) => InstanceFromMachineImageNetworkInterfaceAliasIpRange.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ipv6AccessConfigs: map['ipv6AccessConfigs'] == null ? null : pulumi.Input.decodeList<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig>(map['ipv6AccessConfigs'], (value) => InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      subnetworkProject: map['subnetworkProject'] == null ? null : map['subnetworkProject'] as String,
    );
  }
}
