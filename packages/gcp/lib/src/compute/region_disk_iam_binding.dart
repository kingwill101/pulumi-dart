...
import 'region_disk_iam_binding_args.dart';
...
class RegionDiskIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<RegionDiskIamBindingCondition?> condition;
  ...
  /// Creates a new [RegionDiskIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionDiskIamBinding]. {@macro pulumi_compute_region_disk_iam_binding_region_disk_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionDiskIamBinding(
    String name, {
    RegionDiskIamBindingArgs? args,
    ...
    this.condition = registerOutput<RegionDiskIamBindingCondition?>('condition');
