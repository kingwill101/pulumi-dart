...
class FirewallPolicyRuleMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.encodeList<FirewallPolicyRuleMatchLayer4Config, Map<String, dynamic>>(layer4Configs, (value) => value.toMap()),
      ...
      'srcSecureTags': ?srcSecureTags == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleMatchSrcSecureTag, Map<String, dynamic>>(srcSecureTags!, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatch(
      ...
      layer4Configs: pulumi.Input.decodeList<FirewallPolicyRuleMatchLayer4Config>(map['layer4Configs'], (value) => FirewallPolicyRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: map['srcSecureTags'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleMatchSrcSecureTag>(map['srcSecureTags'], (value) => FirewallPolicyRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>())),
