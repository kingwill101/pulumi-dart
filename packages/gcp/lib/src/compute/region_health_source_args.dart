...
class RegionHealthSourceArgs {
  ...
  RegionHealthSourceArgs({
    ...
    String? sources,
        ...
        healthAggregationPolicy =
            pulumi.Input.asOptionalInput<String>(healthAggregationPolicy),
  ...
  factory RegionHealthSourceArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthSourceArgs(
      ...
      healthAggregationPolicy: map['healthAggregationPolicy'] == null
          ? null
          : map['healthAggregationPolicy'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      sourceType: map['sourceType'] as String,
      sources: map['sources'] == null ? null : map['sources'] as String,
    );
  }
}
