...
class RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort {
  ...
  /// Creates a new [RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort].
  ...
  factory RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort(
