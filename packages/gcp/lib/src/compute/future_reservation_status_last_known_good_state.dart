...
class FutureReservationStatusLastKnownGoodState {
  ...
  final FutureReservationStatusLastKnownGoodStateExistingMatchingUsageInfo? existingMatchingUsageInfo;
  /// The previous instance-related properties of the Future Reservation.
  /// Structure is documented below.
  final FutureReservationStatusLastKnownGoodStateFutureReservationSpecs? futureReservationSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'existingMatchingUsageInfo': ?existingMatchingUsageInfo == null ? null : existingMatchingUsageInfo!.toMap(),
      'futureReservationSpecs': ?futureReservationSpecs == null ? null : futureReservationSpecs!.toMap(),
      'lockTime': ?lockTime,
  ...
  factory FutureReservationStatusLastKnownGoodState.fromMap(Map<String, dynamic> map) {
    return FutureReservationStatusLastKnownGoodState(
      ...
      existingMatchingUsageInfo: map['existingMatchingUsageInfo'] == null ? null : FutureReservationStatusLastKnownGoodStateExistingMatchingUsageInfo.fromMap((map['existingMatchingUsageInfo'] as Map).cast<String, dynamic>()),
      futureReservationSpecs: map['futureReservationSpecs'] == null ? null : FutureReservationStatusLastKnownGoodStateFutureReservationSpecs.fromMap((map['futureReservationSpecs'] as Map).cast<String, dynamic>()),
      lockTime: map['lockTime'] == null ? null : map['lockTime'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      procurementStatus: map['procurementStatus'] == null ? null : map['procurementStatus'] as String,
    );
  }
}
