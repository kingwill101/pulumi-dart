...
class InstanceTemplateScheduling {
  ...
  /// hour.
  final List<InstanceTemplateSchedulingLocalSsdRecoveryTimeout>? localSsdRecoveryTimeouts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'localSsdRecoveryTimeouts': ?localSsdRecoveryTimeouts == null ? null : pulumi.Input.encodeList<InstanceTemplateSchedulingLocalSsdRecoveryTimeout, Map<String, dynamic>>(localSsdRecoveryTimeouts!, (value) => value.toMap()),
      'maintenanceInterval': ?maintenanceInterval,
      'maxRunDuration': ?maxRunDuration == null ? null : maxRunDuration!.toMap(),
      'minNodeCpus': ?minNodeCpus,
      'nodeAffinities': ?nodeAffinities == null ? null : pulumi.Input.encodeList<InstanceTemplateSchedulingNodeAffinity, Map<String, dynamic>>(nodeAffinities!, (value) => value.toMap()),
  ...
  factory InstanceTemplateScheduling.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateScheduling(
      ...
      gracefulShutdown: map['gracefulShutdown'] == null ? null : InstanceTemplateSchedulingGracefulShutdown.fromMap((map['gracefulShutdown'] as Map).cast<String, dynamic>()),
      ...
      localSsdRecoveryTimeouts: map['localSsdRecoveryTimeouts'] == null ? null : pulumi.Input.decodeList<InstanceTemplateSchedulingLocalSsdRecoveryTimeout>(map['localSsdRecoveryTimeouts'], (value) => InstanceTemplateSchedulingLocalSsdRecoveryTimeout.fromMap((value as Map).cast<String, dynamic>())),
      maintenanceInterval: map['maintenanceInterval'] == null ? null : map['maintenanceInterval'] as String,
      maxRunDuration: map['maxRunDuration'] == null ? null : InstanceTemplateSchedulingMaxRunDuration.fromMap((map['maxRunDuration'] as Map).cast<String, dynamic>()),
      minNodeCpus: map['minNodeCpus'] == null ? null : map['minNodeCpus'] as int,
      nodeAffinities: map['nodeAffinities'] == null ? null : pulumi.Input.decodeList<InstanceTemplateSchedulingNodeAffinity>(map['nodeAffinities'], (value) => InstanceTemplateSchedulingNodeAffinity.fromMap((value as Map).cast<String, dynamic>())),
      onHostMaintenance: map['onHostMaintenance'] == null ? null : map['onHostMaintenance'] as String,
      onInstanceStopAction: map['onInstanceStopAction'] == null ? null : InstanceTemplateSchedulingOnInstanceStopAction.fromMap((map['onInstanceStopAction'] as Map).cast<String, dynamic>()),
