...
class NetworkFirewallPolicyRuleArgs {
  ...
  factory NetworkFirewallPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyRuleArgs(
      ...
      match: NetworkFirewallPolicyRuleMatch.fromMap(
      ...
      targetSecureTags: map['targetSecureTags'] == null
          ? null
          : pulumi.Input.decodeList<NetworkFirewallPolicyRuleTargetSecureTag>(
              map['targetSecureTags'],
              (value) => NetworkFirewallPolicyRuleTargetSecureTag.fromMap(
