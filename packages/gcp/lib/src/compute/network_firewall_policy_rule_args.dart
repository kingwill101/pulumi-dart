...
class NetworkFirewallPolicyRuleArgs {
  ...
  NetworkFirewallPolicyRuleArgs({
    ...
    required NetworkFirewallPolicyRuleMatch match,
    required int priority,
    String? project,
    String? ruleName,
    String? securityProfileGroup,
    List<NetworkFirewallPolicyRuleTargetSecureTag>? targetSecureTags,
  ...
  factory NetworkFirewallPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyRuleArgs(
      ...
      match: NetworkFirewallPolicyRuleMatch.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyRuleTargetSecureTag>(map['targetSecureTags'], (value) => NetworkFirewallPolicyRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>())),
