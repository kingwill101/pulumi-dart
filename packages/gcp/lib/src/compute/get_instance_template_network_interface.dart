...
class GetInstanceTemplateNetworkInterface {
  ...
  final List<GetInstanceTemplateNetworkInterfaceIpv6AccessConfig> ipv6AccessConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': pulumi.Input.encodeList<GetInstanceTemplateNetworkInterfaceAccessConfig, Map<String, dynamic>>(accessConfigs, (value) => value.toMap()),
      'aliasIpRanges': pulumi.Input.encodeList<GetInstanceTemplateNetworkInterfaceAliasIpRange, Map<String, dynamic>>(aliasIpRanges, (value) => value.toMap()),
      'igmpQuery': igmpQuery,
      'internalIpv6PrefixLength': internalIpv6PrefixLength,
      'ipv6AccessConfigs': pulumi.Input.encodeList<GetInstanceTemplateNetworkInterfaceIpv6AccessConfig, Map<String, dynamic>>(ipv6AccessConfigs, (value) => value.toMap()),
  ...
  factory GetInstanceTemplateNetworkInterface.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateNetworkInterface(
      accessConfigs: pulumi.Input.decodeList<GetInstanceTemplateNetworkInterfaceAccessConfig>(map['accessConfigs'], (value) => GetInstanceTemplateNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: pulumi.Input.decodeList<GetInstanceTemplateNetworkInterfaceAliasIpRange>(map['aliasIpRanges'], (value) => GetInstanceTemplateNetworkInterfaceAliasIpRange.fromMap((value as Map).cast<String, dynamic>())),
      igmpQuery: map['igmpQuery'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: pulumi.Input.decodeList<GetInstanceTemplateNetworkInterfaceIpv6AccessConfig>(map['ipv6AccessConfigs'], (value) => GetInstanceTemplateNetworkInterfaceIpv6AccessConfig.fromMap((value as Map).cast<String, dynamic>())),
