...
class ImageArgs {
  ...
  ImageArgs({
    ...
    List<String>? storageLocations,
       ...
       guestOsFeatures = pulumi
           .Input.asOptionalInput<List<ImageGuestOsFeature>>(guestOsFeatures),
       imageEncryptionKey = pulumi
           .Input.asOptionalInput<ImageImageEncryptionKey>(imageEncryptionKey),
