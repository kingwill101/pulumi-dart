...
class GetInstanceGroupManagerInstanceLifecyclePolicy {
  ...
  final List<GetInstanceGroupManagerInstanceLifecyclePolicyOnRepair> onRepairs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'onRepairs': pulumi.Input.encodeList<GetInstanceGroupManagerInstanceLifecyclePolicyOnRepair, Map<String, dynamic>>(onRepairs, (value) => value.toMap()),
    };
  }
  ...
  factory GetInstanceGroupManagerInstanceLifecyclePolicy.fromMap(Map<String, dynamic> map) {
    return GetInstanceGroupManagerInstanceLifecyclePolicy(
      ...
      onRepairs: pulumi.Input.decodeList<GetInstanceGroupManagerInstanceLifecyclePolicyOnRepair>(map['onRepairs'], (value) => GetInstanceGroupManagerInstanceLifecyclePolicyOnRepair.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
