...
class RegionHealthCheckTcpHealthCheck {
  ...
  /// Creates a new [RegionHealthCheckTcpHealthCheck].
  ...
  factory RegionHealthCheckTcpHealthCheck.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckTcpHealthCheck(
