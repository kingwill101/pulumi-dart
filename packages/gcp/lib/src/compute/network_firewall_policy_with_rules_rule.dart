...
import 'network_firewall_policy_with_rules_rule_match.dart';
import 'network_firewall_policy_with_rules_rule_target_secure_tag.dart';

class NetworkFirewallPolicyWithRulesRule {
  ...
  final NetworkFirewallPolicyWithRulesRuleMatch match;
  ...
  /// Structure is documented below.
  final List<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>?
  targetSecureTags;
  ...
  /// Creates a new [NetworkFirewallPolicyWithRulesRule].
  ...
  factory NetworkFirewallPolicyWithRulesRule.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRule(
      ...
      match: NetworkFirewallPolicyWithRulesRuleMatch.fromMap(
