...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.attachedDisks = registerOutput<List<InstanceAttachedDisk>?>(
      'attachedDisks',
    );
    ...
    this.guestAccelerators = registerOutput<List<InstanceGuestAccelerator>>(
      'guestAccelerators',
    );
    this.hostname = registerOutput<String?>('hostname');
    this.instanceEncryptionKey = registerOutput<InstanceInstanceEncryptionKey?>(
      'instanceEncryptionKey',
    );
    ...
    this.reservationAffinity = registerOutput<InstanceReservationAffinity>(
      'reservationAffinity',
    );
    this.resourcePolicies = registerOutput<String?>('resourcePolicies');
    this.scheduling = registerOutput<InstanceScheduling>('scheduling');
    this.scratchDisks = registerOutput<List<InstanceScratchDisk>?>(
      'scratchDisks',
    );
    this.selfLink = registerOutput<String>('selfLink');
    this.serviceAccount = registerOutput<InstanceServiceAccount?>(
      'serviceAccount',
    );
