...
class URLMapDefaultRouteAction {
  ...
  /// Structure is documented below.
  final List<URLMapDefaultRouteActionWeightedBackendService>?
    ...
    return URLMapDefaultRouteAction(
      ...
      weightedBackendServices: map['weightedBackendServices'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => URLMapDefaultRouteActionWeightedBackendService.fromMap(
