...
class FirewallPolicyWithRulesPredefinedRule {
  ...
  final List<FirewallPolicyWithRulesPredefinedRuleMatch>? matches;
  /// (Output)
  ...
  /// Structure is documented below.
  final List<FirewallPolicyWithRulesPredefinedRuleTargetSecureTag>? targetSecureTags;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matches': ?matches == null ? null : pulumi.Input.encodeList<FirewallPolicyWithRulesPredefinedRuleMatch, Map<String, dynamic>>(matches!, (value) => value.toMap()),
      'priority': ?priority,
      'ruleName': ?ruleName,
      'securityProfileGroup': ?securityProfileGroup,
      'targetResources': ?targetResources,
      'targetSecureTags': ?targetSecureTags == null ? null : pulumi.Input.encodeList<FirewallPolicyWithRulesPredefinedRuleTargetSecureTag, Map<String, dynamic>>(targetSecureTags!, (value) => value.toMap()),
  ...
  factory FirewallPolicyWithRulesPredefinedRule.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyWithRulesPredefinedRule(
      ...
      matches: map['matches'] == null ? null : pulumi.Input.decodeList<FirewallPolicyWithRulesPredefinedRuleMatch>(map['matches'], (value) => FirewallPolicyWithRulesPredefinedRuleMatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<FirewallPolicyWithRulesPredefinedRuleTargetSecureTag>(map['targetSecureTags'], (value) => FirewallPolicyWithRulesPredefinedRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>())),
