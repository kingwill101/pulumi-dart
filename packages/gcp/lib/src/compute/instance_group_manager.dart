...
class InstanceGroupManager extends pulumi.CustomResource {
  ...
  InstanceGroupManager(
    ...
    this.namedPorts = registerOutput<List<InstanceGroupManagerNamedPort>?>(
      'namedPorts',
    );
    ...
    this.standbyPolicy = registerOutput<InstanceGroupManagerStandbyPolicy>(
      'standbyPolicy',
    );
    this.statefulDisks =
    ...
    this.statuses = registerOutput<List<InstanceGroupManagerStatus>>(
      'statuses',
    );
    ...
    this.updatePolicy = registerOutput<InstanceGroupManagerUpdatePolicy>(
      'updatePolicy',
    );
    this.versions = registerOutput<List<InstanceGroupManagerVersion>>(
      'versions',
    );
    this.waitForInstances = registerOutput<bool?>('waitForInstances');
    this.waitForInstancesStatus = registerOutput<String?>(
