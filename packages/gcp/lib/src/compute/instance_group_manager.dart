...
class InstanceGroupManager extends pulumi.CustomResource {
  ...
  InstanceGroupManager(
    ...
    this.allInstancesConfig = registerOutput<InstanceGroupManagerAllInstancesConfig?>('allInstancesConfig');
    this.autoHealingPolicies = registerOutput<InstanceGroupManagerAutoHealingPolicies?>('autoHealingPolicies');
    ...
    this.instanceLifecyclePolicy = registerOutput<InstanceGroupManagerInstanceLifecyclePolicy>('instanceLifecyclePolicy');
    this.listManagedInstancesResults = registerOutput<String?>('listManagedInstancesResults');
    this.name = registerOutput<String>('name');
    this.namedPorts = registerOutput<List<InstanceGroupManagerNamedPort>?>('namedPorts');
    this.operation = registerOutput<String>('operation');
    this.params = registerOutput<InstanceGroupManagerParams?>('params');
    this.project = registerOutput<String>('project');
    this.resourcePolicies = registerOutput<InstanceGroupManagerResourcePolicies?>('resourcePolicies');
    this.selfLink = registerOutput<String>('selfLink');
    this.standbyPolicy = registerOutput<InstanceGroupManagerStandbyPolicy>('standbyPolicy');
    this.statefulDisks = registerOutput<List<InstanceGroupManagerStatefulDisk>?>('statefulDisks');
    this.statefulExternalIps = registerOutput<List<InstanceGroupManagerStatefulExternalIp>?>('statefulExternalIps');
    this.statefulInternalIps = registerOutput<List<InstanceGroupManagerStatefulInternalIp>?>('statefulInternalIps');
    this.statuses = registerOutput<List<InstanceGroupManagerStatus>>('statuses');
    ...
    this.updatePolicy = registerOutput<InstanceGroupManagerUpdatePolicy>('updatePolicy');
    this.versions = registerOutput<List<InstanceGroupManagerVersion>>('versions');
