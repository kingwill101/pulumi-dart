...
class RegionDiskArgs {
  ...
  factory RegionDiskArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs(
      ...
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : RegionDiskAsyncPrimaryDisk.fromMap((map['asyncPrimaryDisk'] as Map).cast<String, dynamic>()),
      ...
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : RegionDiskDiskEncryptionKey.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>()),
      guestOsFeatures: map['guestOsFeatures'] == null ? null : pulumi.Input.decodeList<RegionDiskGuestOsFeature>(map['guestOsFeatures'], (value) => RegionDiskGuestOsFeature.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : RegionDiskSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
