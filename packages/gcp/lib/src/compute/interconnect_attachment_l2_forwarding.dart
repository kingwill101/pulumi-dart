...
class InterconnectAttachmentL2Forwarding {
  ...
  final List<InterconnectAttachmentL2ForwardingApplianceMapping>? applianceMappings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applianceMappings': ?applianceMappings == null ? null : pulumi.Input.encodeList<InterconnectAttachmentL2ForwardingApplianceMapping, Map<String, dynamic>>(applianceMappings!, (value) => value.toMap()),
  ...
  factory InterconnectAttachmentL2Forwarding.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentL2Forwarding(
      applianceMappings: map['applianceMappings'] == null ? null : pulumi.Input.decodeList<InterconnectAttachmentL2ForwardingApplianceMapping>(map['applianceMappings'], (value) => InterconnectAttachmentL2ForwardingApplianceMapping.fromMap((value as Map).cast<String, dynamic>())),
      defaultApplianceIpAddress: map['defaultApplianceIpAddress'] == null ? null : map['defaultApplianceIpAddress'] as String,
      geneveHeader: map['geneveHeader'] == null ? null : InterconnectAttachmentL2ForwardingGeneveHeader.fromMap((map['geneveHeader'] as Map).cast<String, dynamic>()),
      network: map['network'] == null ? null : map['network'] as String,
      tunnelEndpointIpAddress: map['tunnelEndpointIpAddress'] == null ? null : map['tunnelEndpointIpAddress'] as String,
    );
  }
}
