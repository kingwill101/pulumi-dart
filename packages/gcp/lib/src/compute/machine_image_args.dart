...
class MachineImageArgs {
  ...
  factory MachineImageArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageArgs(
      ...
      machineImageEncryptionKey: map['machineImageEncryptionKey'] == null ? null : MachineImageMachineImageEncryptionKey.fromMap((map['machineImageEncryptionKey'] as Map).cast<String, dynamic>()),
