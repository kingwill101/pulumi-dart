...
class InstanceTemplateSchedulingMaxRunDuration {
  ...
  /// Creates a new [InstanceTemplateSchedulingMaxRunDuration].
  ...
  InstanceTemplateSchedulingMaxRunDuration({this.nanos, required this.seconds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'nanos': ?nanos, 'seconds': seconds};
  }

  factory InstanceTemplateSchedulingMaxRunDuration.fromMap(
