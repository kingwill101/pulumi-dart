...
class ResourcePolicyArgs {
  ...
  ResourcePolicyArgs({
    String? description,
    ResourcePolicyDiskConsistencyGroupPolicy? diskConsistencyGroupPolicy,
    ...
    ResourcePolicyWorkloadPolicy? workloadPolicy,
  }) :
  ...
  factory ResourcePolicyArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyArgs(
      ...
      diskConsistencyGroupPolicy: map['diskConsistencyGroupPolicy'] == null ? null : ResourcePolicyDiskConsistencyGroupPolicy.fromMap((map['diskConsistencyGroupPolicy'] as Map).cast<String, dynamic>()),
      groupPlacementPolicy: map['groupPlacementPolicy'] == null ? null : ResourcePolicyGroupPlacementPolicy.fromMap((map['groupPlacementPolicy'] as Map).cast<String, dynamic>()),
      instanceSchedulePolicy: map['instanceSchedulePolicy'] == null ? null : ResourcePolicyInstanceSchedulePolicy.fromMap((map['instanceSchedulePolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      snapshotSchedulePolicy: map['snapshotSchedulePolicy'] == null ? null : ResourcePolicySnapshotSchedulePolicy.fromMap((map['snapshotSchedulePolicy'] as Map).cast<String, dynamic>()),
      workloadPolicy: map['workloadPolicy'] == null ? null : ResourcePolicyWorkloadPolicy.fromMap((map['workloadPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
