...
class ResourcePolicyArgs {
  ...
  ResourcePolicyArgs({
    ...
    ResourcePolicyWorkloadPolicy? workloadPolicy,
       ...
       workloadPolicy = pulumi
           .Input.asOptionalInput<ResourcePolicyWorkloadPolicy>(workloadPolicy);
    ...
    return ResourcePolicyArgs(
      ...
      diskConsistencyGroupPolicy: map['diskConsistencyGroupPolicy'] == null
          ...
          : ResourcePolicyDiskConsistencyGroupPolicy.fromMap(
              (map['diskConsistencyGroupPolicy'] as Map)
                  .cast<String, dynamic>(),
            ),
      ...
      workloadPolicy: map['workloadPolicy'] == null
          ...
          : ResourcePolicyWorkloadPolicy.fromMap(
              (map['workloadPolicy'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
