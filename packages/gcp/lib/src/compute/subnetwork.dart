...
class Subnetwork extends pulumi.CustomResource {
  ...
  Subnetwork(
    ...
    this.secondaryIpRanges = registerOutput<List<SubnetworkSecondaryIpRange>>('secondaryIpRanges');
    this.selfLink = registerOutput<String>('selfLink');
    this.sendSecondaryIpRangeIfEmpty = registerOutput<bool?>('sendSecondaryIpRangeIfEmpty');
