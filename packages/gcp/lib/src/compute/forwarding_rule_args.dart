...
class ForwardingRuleArgs {
  ...
  final pulumi.Input<ForwardingRuleServiceDirectoryRegistrations>?
  ...
  ForwardingRuleArgs({
    ...
    String? region,
    ForwardingRuleServiceDirectoryRegistrations? serviceDirectoryRegistrations,
    String? serviceLabel,
    ...
    String? target,
        ...
        loadBalancingScheme =
            pulumi.Input.asOptionalInput<String>(loadBalancingScheme),
        ...
        recreateClosedPsc =
            pulumi.Input.asOptionalInput<bool>(recreateClosedPsc),
  ...
  Map<String, dynamic> toMap() {
    ...
    final recreateClosedPscValue = recreateClosedPsc;
    if (recreateClosedPscValue != null) {
      map['recreateClosedPsc'] = recreateClosedPscValue;
    }
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      recreateClosedPsc: map['recreateClosedPsc'] == null
          ? null
      ...
      serviceDirectoryRegistrations:
          map['serviceDirectoryRegistrations'] == null
              ? null
              : ForwardingRuleServiceDirectoryRegistrations.fromMap(
                  (map['serviceDirectoryRegistrations'] as Map)
                      .cast<String, dynamic>()),
      serviceLabel:
