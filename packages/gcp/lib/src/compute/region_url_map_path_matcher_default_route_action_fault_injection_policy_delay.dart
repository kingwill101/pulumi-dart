...
class RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelay {
  ...
  final RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay? fixedDelay;
  ...
  factory RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelay.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelay(
      fixedDelay: map['fixedDelay'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay.fromMap((map['fixedDelay'] as Map).cast<String, dynamic>()),
