...
class InstanceTemplate extends pulumi.CustomResource {
  ...
  InstanceTemplate(
    ...
    this.advancedMachineFeatures = registerOutput<InstanceTemplateAdvancedMachineFeatures?>('advancedMachineFeatures');
    this.canIpForward = registerOutput<bool?>('canIpForward');
    this.confidentialInstanceConfig = registerOutput<InstanceTemplateConfidentialInstanceConfig>('confidentialInstanceConfig');
    ...
    this.guestAccelerators = registerOutput<List<InstanceTemplateGuestAccelerator>?>('guestAccelerators');
    ...
    this.networkInterfaces = registerOutput<List<InstanceTemplateNetworkInterface>?>('networkInterfaces');
    this.networkPerformanceConfig = registerOutput<InstanceTemplateNetworkPerformanceConfig?>('networkPerformanceConfig');
    ...
    this.reservationAffinity = registerOutput<InstanceTemplateReservationAffinity?>('reservationAffinity');
    ...
    this.serviceAccount = registerOutput<InstanceTemplateServiceAccount?>('serviceAccount');
    this.shieldedInstanceConfig = registerOutput<InstanceTemplateShieldedInstanceConfig>('shieldedInstanceConfig');
