...
class URLMapPathMatcherPathRuleRouteActionMaxStreamDuration {
  ...
  /// Creates a new [URLMapPathMatcherPathRuleRouteActionMaxStreamDuration].
  ...
  factory URLMapPathMatcherPathRuleRouteActionMaxStreamDuration.fromMap(
      Map<String, dynamic> map) {
    return URLMapPathMatcherPathRuleRouteActionMaxStreamDuration(
