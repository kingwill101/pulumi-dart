...
class NetworkEndpointListArgs {
  ...
  factory NetworkEndpointListArgs.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointListArgs(
      ...
      networkEndpoints: map['networkEndpoints'] == null ? null : pulumi.Input.decodeList<NetworkEndpointListNetworkEndpoint>(map['networkEndpoints'], (value) => NetworkEndpointListNetworkEndpoint.fromMap((value as Map).cast<String, dynamic>())),
