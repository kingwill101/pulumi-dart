...
class InstanceTemplateIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [InstanceTemplateIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceTemplateIamPolicy]. {@macro pulumi_compute_instance_template_iam_policy_instance_template_iam_policy_args_doc}
