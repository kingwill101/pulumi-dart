...
class InstanceArgs {
  ...
  InstanceArgs({
    InstanceAdvancedMachineFeatures? advancedMachineFeatures,
    bool? allowStoppingForUpdate,
    List<InstanceAttachedDisk>? attachedDisks,
    required InstanceBootDisk bootDisk,
    bool? canIpForward,
    InstanceConfidentialInstanceConfig? confidentialInstanceConfig,
    bool? deletionProtection,
    String? description,
    String? desiredStatus,
    bool? enableDisplay,
    List<InstanceGuestAccelerator>? guestAccelerators,
    String? hostname,
    InstanceInstanceEncryptionKey? instanceEncryptionKey,
    ...
    String? name,
    required List<InstanceNetworkInterface> networkInterfaces,
    InstanceNetworkPerformanceConfig? networkPerformanceConfig,
    InstanceParams? params,
    Map<String, String>? partnerMetadata,
    String? project,
    InstanceReservationAffinity? reservationAffinity,
    String? resourcePolicies,
    InstanceScheduling? scheduling,
    List<InstanceScratchDisk>? scratchDisks,
    ...
    String? zone,
       ...
       scheduling = pulumi.Input.asOptionalInput<InstanceScheduling>(
         scheduling,
       ),
