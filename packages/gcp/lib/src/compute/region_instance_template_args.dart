...
class RegionInstanceTemplateArgs {
  ...
  RegionInstanceTemplateArgs({
    RegionInstanceTemplateAdvancedMachineFeatures? advancedMachineFeatures,
    bool? canIpForward,
    RegionInstanceTemplateConfidentialInstanceConfig? confidentialInstanceConfig,
    String? description,
    required List<RegionInstanceTemplateDisk> disks,
    bool? enableDisplay,
    List<RegionInstanceTemplateGuestAccelerator>? guestAccelerators,
    ...
    String? name,
    String? namePrefix,
    List<RegionInstanceTemplateNetworkInterface>? networkInterfaces,
    RegionInstanceTemplateNetworkPerformanceConfig? networkPerformanceConfig,
    Map<String, String>? partnerMetadata,
    String? project,
    String? region,
    RegionInstanceTemplateReservationAffinity? reservationAffinity,
    Map<String, String>? resourceManagerTags,
    String? resourcePolicies,
    RegionInstanceTemplateScheduling? scheduling,
    RegionInstanceTemplateServiceAccount? serviceAccount,
    RegionInstanceTemplateShieldedInstanceConfig? shieldedInstanceConfig,
    List<String>? tags,
  }) :
  ...
  factory RegionInstanceTemplateArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateArgs(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : RegionInstanceTemplateAdvancedMachineFeatures.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      canIpForward: map['canIpForward'] == null ? null : map['canIpForward'] as bool,
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : RegionInstanceTemplateConfidentialInstanceConfig.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      disks: pulumi.Input.decodeList<RegionInstanceTemplateDisk>(map['disks'], (value) => RegionInstanceTemplateDisk.fromMap((value as Map).cast<String, dynamic>())),
      enableDisplay: map['enableDisplay'] == null ? null : map['enableDisplay'] as bool,
      guestAccelerators: map['guestAccelerators'] == null ? null : pulumi.Input.decodeList<RegionInstanceTemplateGuestAccelerator>(map['guestAccelerators'], (value) => RegionInstanceTemplateGuestAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<RegionInstanceTemplateNetworkInterface>(map['networkInterfaces'], (value) => RegionInstanceTemplateNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : RegionInstanceTemplateNetworkPerformanceConfig.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      partnerMetadata: map['partnerMetadata'] == null ? null : (map['partnerMetadata'] as Map).cast<String, String>(),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      reservationAffinity: map['reservationAffinity'] == null ? null : RegionInstanceTemplateReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      ...
      scheduling: map['scheduling'] == null ? null : RegionInstanceTemplateScheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : RegionInstanceTemplateServiceAccount.fromMap((map['serviceAccount'] as Map).cast<String, dynamic>()),
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : RegionInstanceTemplateShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
