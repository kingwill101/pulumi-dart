...
class RegionInstanceTemplateArgs {
  ...
  RegionInstanceTemplateArgs({
    ...
    List<String>? tags,
       ...
       guestAccelerators =
           ...
           >(guestAccelerators),
       instanceDescription = pulumi.Input.asOptionalInput<String>(
         instanceDescription,
       ),
       ...
       scheduling = pulumi
           .Input.asOptionalInput<RegionInstanceTemplateScheduling>(scheduling),
       serviceAccount =
  ...
  factory RegionInstanceTemplateArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateArgs(
      ...
      disks: pulumi.Input.decodeList<RegionInstanceTemplateDisk>(
        map['disks'],
