...
class StoragePool extends pulumi.CustomResource {
  ...
  StoragePool(
    ...
    this.capacityProvisioningType = registerOutput<String>(
    ...
    this.performanceProvisioningType = registerOutput<String>(
      'performanceProvisioningType',
    );
    this.poolProvisionedCapacityGb = registerOutput<String>(
      'poolProvisionedCapacityGb',
    );
    this.poolProvisionedIops = registerOutput<String?>('poolProvisionedIops');
    this.poolProvisionedThroughput = registerOutput<String>(
      'poolProvisionedThroughput',
    );
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.resourceStatuses = registerOutput<List<StoragePoolResourceStatus>>(
      'resourceStatuses',
    );
