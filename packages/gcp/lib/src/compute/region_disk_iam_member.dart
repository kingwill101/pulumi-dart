...
class RegionDiskIamMember extends pulumi.CustomResource {
  late final pulumi.Output<RegionDiskIamMemberCondition?> condition;
  ...
  /// Creates a new [RegionDiskIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionDiskIamMember]. {@macro pulumi_compute_region_disk_iam_member_region_disk_iam_member_args_doc}
