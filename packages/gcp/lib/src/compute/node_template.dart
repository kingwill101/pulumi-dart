...
class NodeTemplate extends pulumi.CustomResource {
  ...
  NodeTemplate(
    ...
    this.accelerators = registerOutput<List<NodeTemplateAccelerator>?>(
      'accelerators',
    );
    ...
    this.nodeTypeFlexibility = registerOutput<NodeTemplateNodeTypeFlexibility?>(
      'nodeTypeFlexibility',
    );
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.selfLink = registerOutput<String>('selfLink');
    this.serverBinding = registerOutput<NodeTemplateServerBinding>(
      'serverBinding',
    );
  }
}
