...
class MachineImageIamMemberArgs {
  ...
  MachineImageIamMemberArgs({
    MachineImageIamMemberCondition? condition,
  ...
  factory MachineImageIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageIamMemberArgs(
      condition: map['condition'] == null ? null : MachineImageIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
