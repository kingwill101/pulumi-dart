...
class FutureReservationArgs {
  ...
  FutureReservationArgs({
    ...
    required FutureReservationTimeWindow timeWindow,
       ...
       timeWindow = pulumi.Input.asInput<FutureReservationTimeWindow>(
         timeWindow,
       );
    ...
    return <String, dynamic>{
      ...
      'commitmentInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(commitmentInfo, (value) => value.toMap()),
  ...
  factory FutureReservationArgs.fromMap(Map<String, dynamic> map) {
    return FutureReservationArgs(
      aggregateReservation: map['aggregateReservation'] == null
          ? null
          : FutureReservationAggregateReservation.fromMap(
      ...
      autoCreatedReservationsDuration:
          ...
          ? null
          : FutureReservationAutoCreatedReservationsDuration.fromMap(
      ...
      commitmentInfo: map['commitmentInfo'] == null
          ? null
          : FutureReservationCommitmentInfo.fromMap(
              (map['commitmentInfo'] as Map).cast<String, dynamic>(),
            ),
      ...
      reservationMode: map['reservationMode'] == null
          ? null
          : map['reservationMode'] as String,
      ...
      shareSettings: map['shareSettings'] == null
          ? null
          : FutureReservationShareSettings.fromMap(
      ...
      timeWindow: FutureReservationTimeWindow.fromMap(
