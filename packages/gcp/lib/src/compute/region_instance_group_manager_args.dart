  ...
  RegionInstanceGroupManagerArgs({
    ...
    String? waitForInstancesStatus,
        ...
        distributionPolicyTargetShape =
            pulumi.Input.asOptionalInput<String>(distributionPolicyTargetShape),
        distributionPolicyZones =
            pulumi.Input.asOptionalInput<List<String>>(distributionPolicyZones),
        ...
        listManagedInstancesResults =
            pulumi.Input.asOptionalInput<String>(listManagedInstancesResults),
        ...
        updatePolicy = pulumi.Input.asOptionalInput<
            RegionInstanceGroupManagerUpdatePolicy>(updatePolicy),
        versions =
            pulumi.Input.asInput<List<RegionInstanceGroupManagerVersion>>(
                versions),
        waitForInstances = pulumi.Input.asOptionalInput<bool>(waitForInstances),
        waitForInstancesStatus =
            pulumi.Input.asOptionalInput<String>(waitForInstancesStatus);
