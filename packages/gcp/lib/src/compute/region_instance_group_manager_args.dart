...
class RegionInstanceGroupManagerArgs {
  ...
  RegionInstanceGroupManagerArgs({
    ...
    RegionInstanceGroupManagerInstanceFlexibilityPolicy? instanceFlexibilityPolicy,
  ...
  factory RegionInstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerArgs(
      allInstancesConfig: map['allInstancesConfig'] == null ? null : RegionInstanceGroupManagerAllInstancesConfig.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>()),
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : RegionInstanceGroupManagerAutoHealingPolicies.fromMap((map['autoHealingPolicies'] as Map).cast<String, dynamic>()),
      baseInstanceName: map['baseInstanceName'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      distributionPolicyTargetShape: map['distributionPolicyTargetShape'] == null ? null : map['distributionPolicyTargetShape'] as String,
      distributionPolicyZones: map['distributionPolicyZones'] == null ? null : (map['distributionPolicyZones'] as List).cast<String>(),
      instanceFlexibilityPolicy: map['instanceFlexibilityPolicy'] == null ? null : RegionInstanceGroupManagerInstanceFlexibilityPolicy.fromMap((map['instanceFlexibilityPolicy'] as Map).cast<String, dynamic>()),
      instanceLifecyclePolicy: map['instanceLifecyclePolicy'] == null ? null : RegionInstanceGroupManagerInstanceLifecyclePolicy.fromMap((map['instanceLifecyclePolicy'] as Map).cast<String, dynamic>()),
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : map['listManagedInstancesResults'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      namedPorts: map['namedPorts'] == null ? null : pulumi.Input.decodeList<RegionInstanceGroupManagerNamedPort>(map['namedPorts'], (value) => RegionInstanceGroupManagerNamedPort.fromMap((value as Map).cast<String, dynamic>())),
      params: map['params'] == null ? null : RegionInstanceGroupManagerParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      standbyPolicy: map['standbyPolicy'] == null ? null : RegionInstanceGroupManagerStandbyPolicy.fromMap((map['standbyPolicy'] as Map).cast<String, dynamic>()),
      statefulDisks: map['statefulDisks'] == null ? null : pulumi.Input.decodeList<RegionInstanceGroupManagerStatefulDisk>(map['statefulDisks'], (value) => RegionInstanceGroupManagerStatefulDisk.fromMap((value as Map).cast<String, dynamic>())),
      statefulExternalIps: map['statefulExternalIps'] == null ? null : pulumi.Input.decodeList<RegionInstanceGroupManagerStatefulExternalIp>(map['statefulExternalIps'], (value) => RegionInstanceGroupManagerStatefulExternalIp.fromMap((value as Map).cast<String, dynamic>())),
      statefulInternalIps: map['statefulInternalIps'] == null ? null : pulumi.Input.decodeList<RegionInstanceGroupManagerStatefulInternalIp>(map['statefulInternalIps'], (value) => RegionInstanceGroupManagerStatefulInternalIp.fromMap((value as Map).cast<String, dynamic>())),
      ...
      targetStoppedSize: map['targetStoppedSize'] == null ? null : map['targetStoppedSize'] as int,
      targetSuspendedSize: map['targetSuspendedSize'] == null ? null : map['targetSuspendedSize'] as int,
      updatePolicy: map['updatePolicy'] == null ? null : RegionInstanceGroupManagerUpdatePolicy.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>()),
      versions: pulumi.Input.decodeList<RegionInstanceGroupManagerVersion>(map['versions'], (value) => RegionInstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>())),
      waitForInstances: map['waitForInstances'] == null ? null : map['waitForInstances'] as bool,
      waitForInstancesStatus: map['waitForInstancesStatus'] == null ? null : map['waitForInstancesStatus'] as String,
    );
  }
}
