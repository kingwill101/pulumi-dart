...
class RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk {
  ...
  final RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskDiskEncryptionKey?
  diskEncryptionKey;
  ...
  final RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskSourceImageEncryptionKey?
  ...
  /// - - -
  final RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskSourceSnapshotEncryptionKey?
  ...
  factory RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk.fromMap(
    ...
    return RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk(
      ...
      diskEncryptionKey: map['diskEncryptionKey'] == null
          ? null
          : RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskDiskEncryptionKey.fromMap(
      ...
      labels: map['labels'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['labels'],
              (value) =>
                  RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskLabel.fromMap(
      ...
      resourceManagerTags: map['resourceManagerTags'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskResourceManagerTag.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null
          ? null
          : RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskSourceImageEncryptionKey.fromMap(
      ...
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null
          ? null
          : RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskSourceSnapshotEncryptionKey.fromMap(
