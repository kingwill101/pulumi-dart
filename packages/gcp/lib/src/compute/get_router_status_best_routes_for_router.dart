...
class GetRouterStatusBestRoutesForRouter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asPaths': pulumi.Input.encodeList<GetRouterStatusBestRoutesForRouterAsPath, Map<String, dynamic>>(asPaths, (value) => value.toMap()),
      ...
      'params': pulumi.Input.encodeList<GetRouterStatusBestRoutesForRouterParam, Map<String, dynamic>>(params, (value) => value.toMap()),
      'priority': priority,
      'project': project,
      ...
      'selfLink': selfLink,
      'tags': tags,
      'warnings': pulumi.Input.encodeList<GetRouterStatusBestRoutesForRouterWarning, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }

  factory GetRouterStatusBestRoutesForRouter.fromMap(Map<String, dynamic> map) {
    return GetRouterStatusBestRoutesForRouter(
      asPaths: pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterAsPath>(map['asPaths'], (value) => GetRouterStatusBestRoutesForRouterAsPath.fromMap((value as Map).cast<String, dynamic>())),
      ...
      params: pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterParam>(map['params'], (value) => GetRouterStatusBestRoutesForRouterParam.fromMap((value as Map).cast<String, dynamic>())),
      ...
      warnings: pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterWarning>(map['warnings'], (value) => GetRouterStatusBestRoutesForRouterWarning.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
