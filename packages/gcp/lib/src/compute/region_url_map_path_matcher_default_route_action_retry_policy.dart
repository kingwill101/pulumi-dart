...
import 'region_url_map_path_matcher_default_route_action_retry_policy_per_try_timeout.dart';
...
class RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy {
  ...
  /// Creates a new [RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy].
  ...
  factory RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy.fromMap(
    ...
    return RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy(
      ...
      perTryTimeout: map['perTryTimeout'] == null
          ? null
          : RegionUrlMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout.fromMap(
