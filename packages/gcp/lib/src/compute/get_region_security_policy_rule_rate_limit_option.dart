...
class GetRegionSecurityPolicyRuleRateLimitOption {
  ...
  final List<GetRegionSecurityPolicyRuleRateLimitOptionBanThreshold>
  banThresholds;
  ...
  final List<GetRegionSecurityPolicyRuleRateLimitOptionEnforceOnKeyConfig>
  enforceOnKeyConfigs;
  ...
  final List<GetRegionSecurityPolicyRuleRateLimitOptionRateLimitThreshold>
  rateLimitThresholds;
  ...
  factory GetRegionSecurityPolicyRuleRateLimitOption.fromMap(
    ...
    return GetRegionSecurityPolicyRuleRateLimitOption(
      ...
      banThresholds:
          ...
          >(
            map['banThresholds'],
            (value) =>
                GetRegionSecurityPolicyRuleRateLimitOptionBanThreshold.fromMap(
      ...
      enforceOnKeyConfigs:
          ...
          >(
            ...
            (value) =>
                GetRegionSecurityPolicyRuleRateLimitOptionEnforceOnKeyConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      ...
      rateLimitThresholds:
          ...
          >(
            ...
            (value) =>
                GetRegionSecurityPolicyRuleRateLimitOptionRateLimitThreshold.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
    );
