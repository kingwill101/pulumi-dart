...
class RegionPerInstanceConfigArgs {
  ...
  RegionPerInstanceConfigArgs({
    ...
    bool? removeInstanceStateOnDestroy,
        ...
        mostDisruptiveAllowedAction =
            pulumi.Input.asOptionalInput<String>(mostDisruptiveAllowedAction),
        ...
        regionInstanceGroupManager =
            pulumi.Input.asInput<String>(regionInstanceGroupManager),
        removeInstanceOnDestroy =
            pulumi.Input.asOptionalInput<bool>(removeInstanceOnDestroy),
        removeInstanceStateOnDestroy =
            pulumi.Input.asOptionalInput<bool>(removeInstanceStateOnDestroy);
  ...
  factory RegionPerInstanceConfigArgs.fromMap(Map<String, dynamic> map) {
    return RegionPerInstanceConfigArgs(
      minimalAction:
          map['minimalAction'] == null ? null : map['minimalAction'] as String,
      ...
      preservedState: map['preservedState'] == null
          ? null
          : RegionPerInstanceConfigPreservedState.fromMap(
