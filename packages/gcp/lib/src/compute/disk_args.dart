...
class DiskArgs {
  ...
  DiskArgs({
    String? accessMode,
    String? architecture,
    DiskAsyncPrimaryDisk? asyncPrimaryDisk,
    bool? createSnapshotBeforeDestroy,
    String? createSnapshotBeforeDestroyPrefix,
    String? description,
    DiskDiskEncryptionKey? diskEncryptionKey,
    bool? enableConfidentialCompute,
    List<DiskGuestOsFeature>? guestOsFeatures,
    String? image,
    String? interface,
    ...
    String? snapshot,
    String? sourceDisk,
    DiskSourceImageEncryptionKey? sourceImageEncryptionKey,
    String? sourceInstantSnapshot,
    DiskSourceSnapshotEncryptionKey? sourceSnapshotEncryptionKey,
  ...
  factory DiskArgs.fromMap(Map<String, dynamic> map) {
    return DiskArgs(
      ...
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : DiskAsyncPrimaryDisk.fromMap((map['asyncPrimaryDisk'] as Map).cast<String, dynamic>()),
      createSnapshotBeforeDestroy: map['createSnapshotBeforeDestroy'] == null ? null : map['createSnapshotBeforeDestroy'] as bool,
      createSnapshotBeforeDestroyPrefix: map['createSnapshotBeforeDestroyPrefix'] == null ? null : map['createSnapshotBeforeDestroyPrefix'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : DiskDiskEncryptionKey.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>()),
      enableConfidentialCompute: map['enableConfidentialCompute'] == null ? null : map['enableConfidentialCompute'] as bool,
      guestOsFeatures: map['guestOsFeatures'] == null ? null : pulumi.Input.decodeList<DiskGuestOsFeature>(map['guestOsFeatures'], (value) => DiskGuestOsFeature.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : DiskSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceInstantSnapshot: map['sourceInstantSnapshot'] == null ? null : map['sourceInstantSnapshot'] as String,
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : DiskSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
