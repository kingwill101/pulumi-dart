...
class DiskArgs {
  ...
  /// key.
  /// Structure is documented below.
  final pulumi.Input<DiskSourceSnapshotEncryptionKey>?
  ...
  DiskArgs({
    ...
    String? zone,
       ...
       asyncPrimaryDisk = pulumi.Input.asOptionalInput<DiskAsyncPrimaryDisk>(
         asyncPrimaryDisk,
       ),
       ...
       diskEncryptionKey = pulumi.Input.asOptionalInput<DiskDiskEncryptionKey>(
         diskEncryptionKey,
       ),
       enableConfidentialCompute = pulumi.Input.asOptionalInput<bool>(
         enableConfidentialCompute,
       ),
       guestOsFeatures = pulumi.Input.asOptionalInput<List<DiskGuestOsFeature>>(
         guestOsFeatures,
       ),
       ...
       physicalBlockSizeBytes = pulumi.Input.asOptionalInput<int>(
         physicalBlockSizeBytes,
       ),
       project = pulumi.Input.asOptionalInput<String>(project),
       provisionedIops = pulumi.Input.asOptionalInput<int>(provisionedIops),
       provisionedThroughput = pulumi.Input.asOptionalInput<int>(
       ...
       sourceImageEncryptionKey =
           pulumi.Input.asOptionalInput<DiskSourceImageEncryptionKey>(
             sourceImageEncryptionKey,
           ),
       ...
       sourceSnapshotEncryptionKey =
           pulumi.Input.asOptionalInput<DiskSourceSnapshotEncryptionKey>(
             sourceSnapshotEncryptionKey,
           ),
  ...
  factory DiskArgs.fromMap(Map<String, dynamic> map) {
    return DiskArgs(
      ...
      guestOsFeatures: map['guestOsFeatures'] == null
          ? null
          : pulumi.Input.decodeList<DiskGuestOsFeature>(
              map['guestOsFeatures'],
              (value) => DiskGuestOsFeature.fromMap(
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null
          ? null
          : DiskSourceImageEncryptionKey.fromMap(
      ...
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null
          ? null
          : DiskSourceSnapshotEncryptionKey.fromMap(
