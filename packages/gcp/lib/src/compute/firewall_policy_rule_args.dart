...
class FirewallPolicyRuleArgs {
  ...
  FirewallPolicyRuleArgs({
    ...
    required FirewallPolicyRuleMatch match,
    required int priority,
    String? securityProfileGroup,
    List<String>? targetResources,
    List<FirewallPolicyRuleTargetSecureTag>? targetSecureTags,
    ...
    bool? tlsInspect,
        ...
        targetResources =
            pulumi.Input.asOptionalInput<List<String>>(targetResources),
  ...
  factory FirewallPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleArgs(
      ...
      match: FirewallPolicyRuleMatch.fromMap(
      ...
      targetSecureTags: map['targetSecureTags'] == null
          ? null
          : pulumi.Input.decodeList<FirewallPolicyRuleTargetSecureTag>(
              map['targetSecureTags'],
              (value) => FirewallPolicyRuleTargetSecureTag.fromMap(
