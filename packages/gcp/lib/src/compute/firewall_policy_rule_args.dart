...
class FirewallPolicyRuleArgs {
  ...
  factory FirewallPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleArgs(
      ...
      match: FirewallPolicyRuleMatch.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleTargetSecureTag>(map['targetSecureTags'], (value) => FirewallPolicyRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>())),
