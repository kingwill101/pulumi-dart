...
class RouterArgs {
  ...
  factory RouterArgs.fromMap(Map<String, dynamic> map) {
    return RouterArgs(
      bgp: map['bgp'] == null ? null : RouterBgp.fromMap((map['bgp'] as Map).cast<String, dynamic>()),
      ...
      md5AuthenticationKeys: map['md5AuthenticationKeys'] == null ? null : RouterMd5AuthenticationKeys.fromMap((map['md5AuthenticationKeys'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      nccGateway: map['nccGateway'] == null ? null : map['nccGateway'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      params: map['params'] == null ? null : RouterParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
