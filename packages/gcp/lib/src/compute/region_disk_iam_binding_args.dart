...
class RegionDiskIamBindingArgs {
  ...
  RegionDiskIamBindingArgs({
    RegionDiskIamBindingCondition? condition,
  ...
  factory RegionDiskIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamBindingArgs(
      condition: map['condition'] == null ? null : RegionDiskIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
