...
class FutureReservationSpecificSkuProperties {
  ...
  final FutureReservationSpecificSkuPropertiesInstanceProperties? instanceProperties;
  ...
  factory FutureReservationSpecificSkuProperties.fromMap(Map<String, dynamic> map) {
    return FutureReservationSpecificSkuProperties(
      instanceProperties: map['instanceProperties'] == null ? null : FutureReservationSpecificSkuPropertiesInstanceProperties.fromMap((map['instanceProperties'] as Map).cast<String, dynamic>()),
