...
class InterconnectCircuitInfo {
  ...
  factory InterconnectCircuitInfo.fromMap(Map<String, dynamic> map) {
    return InterconnectCircuitInfo(
      customerDemarcId: map['customerDemarcId'] == null ? null : map['customerDemarcId'] as String,
      googleCircuitId: map['googleCircuitId'] == null ? null : map['googleCircuitId'] as String,
      googleDemarcId: map['googleDemarcId'] == null ? null : map['googleDemarcId'] as String,
    );
  }
}
