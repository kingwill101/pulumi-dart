...
class VPNTunnelArgs {
  ...
  VPNTunnelArgs({
    ...
    int? vpnGatewayInterface,
       ...
       peerExternalGateway = pulumi.Input.asOptionalInput<String>(
         peerExternalGateway,
       ),
       ...
       sharedSecretWoVersion = pulumi.Input.asOptionalInput<String>(
         sharedSecretWoVersion,
       ),
       targetVpnGateway = pulumi.Input.asOptionalInput<String>(
         targetVpnGateway,
       ),
       vpnGateway = pulumi.Input.asOptionalInput<String>(vpnGateway),
       vpnGatewayInterface = pulumi.Input.asOptionalInput<int>(
         vpnGatewayInterface,
       );
  ...
  factory VPNTunnelArgs.fromMap(Map<String, dynamic> map) {
    return VPNTunnelArgs(
      ...
      sharedSecret: map['sharedSecret'] == null
          ? null
          : map['sharedSecret'] as String,
      ...
      vpnGateway: map['vpnGateway'] == null
          ? null
          : map['vpnGateway'] as String,
