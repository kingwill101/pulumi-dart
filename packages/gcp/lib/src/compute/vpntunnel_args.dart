...
class VPNTunnelArgs {
  ...
  factory VPNTunnelArgs.fromMap(Map<String, dynamic> map) {
    return VPNTunnelArgs(
      cipherSuite: map['cipherSuite'] == null ? null : VPNTunnelCipherSuite.fromMap((map['cipherSuite'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      ikeVersion: map['ikeVersion'] == null ? null : map['ikeVersion'] as int,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      localTrafficSelectors: map['localTrafficSelectors'] == null ? null : (map['localTrafficSelectors'] as List).cast<String>(),
      ...
      remoteTrafficSelectors: map['remoteTrafficSelectors'] == null ? null : (map['remoteTrafficSelectors'] as List).cast<String>(),
      router: map['router'] == null ? null : map['router'] as String,
      sharedSecret: map['sharedSecret'] == null ? null : map['sharedSecret'] as String,
      sharedSecretWo: map['sharedSecretWo'] == null ? null : map['sharedSecretWo'] as String,
      sharedSecretWoVersion: map['sharedSecretWoVersion'] == null ? null : map['sharedSecretWoVersion'] as String,
