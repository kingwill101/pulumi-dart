...
class NodeGroupArgs {
  ...
  factory NodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs(
      ...
      initialSize: map['initialSize'] == null ? null : map['initialSize'] as int,
      ...
      shareSettings: map['shareSettings'] == null ? null : NodeGroupShareSettings.fromMap((map['shareSettings'] as Map).cast<String, dynamic>()),
