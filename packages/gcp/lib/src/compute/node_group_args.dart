...
class NodeGroupArgs {
  ...
  NodeGroupArgs({
    ...
    String? zone,
       ...
       maintenanceInterval = pulumi.Input.asOptionalInput<String>(
         maintenanceInterval,
       ),
       maintenancePolicy = pulumi.Input.asOptionalInput<String>(
         maintenancePolicy,
       ),
       maintenanceWindow =
  ...
  factory NodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs(
      ...
      initialSize: map['initialSize'] == null
          ? null
          : map['initialSize'] as int,
