...
class ReservationResourceStatusReservationMaintenance {
  ...
  final List<ReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance>? upcomingGroupMaintenances;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'upcomingGroupMaintenances': ?upcomingGroupMaintenances == null ? null : pulumi.Input.encodeList<ReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance, Map<String, dynamic>>(upcomingGroupMaintenances!, (value) => value.toMap()),
    };
  }
  ...
  factory ReservationResourceStatusReservationMaintenance.fromMap(Map<String, dynamic> map) {
    return ReservationResourceStatusReservationMaintenance(
      instanceMaintenanceOngoingCount: map['instanceMaintenanceOngoingCount'] == null ? null : map['instanceMaintenanceOngoingCount'] as int,
      instanceMaintenancePendingCount: map['instanceMaintenancePendingCount'] == null ? null : map['instanceMaintenancePendingCount'] as int,
      maintenanceOngoingCount: map['maintenanceOngoingCount'] == null ? null : map['maintenanceOngoingCount'] as int,
      maintenancePendingCount: map['maintenancePendingCount'] == null ? null : map['maintenancePendingCount'] as int,
      schedulingType: map['schedulingType'] == null ? null : map['schedulingType'] as String,
      subblockInfraMaintenanceOngoingCount: map['subblockInfraMaintenanceOngoingCount'] == null ? null : map['subblockInfraMaintenanceOngoingCount'] as int,
      subblockInfraMaintenancePendingCount: map['subblockInfraMaintenancePendingCount'] == null ? null : map['subblockInfraMaintenancePendingCount'] as int,
      upcomingGroupMaintenances: map['upcomingGroupMaintenances'] == null ? null : pulumi.Input.decodeList<ReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance>(map['upcomingGroupMaintenances'], (value) => ReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
