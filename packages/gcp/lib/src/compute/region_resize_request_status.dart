...
class RegionResizeRequestStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errors': ?errors == null ? null : pulumi.Input.encodeList<RegionResizeRequestStatusError, Map<String, dynamic>>(errors!, (value) => value.toMap()),
      'lastAttempts': ?lastAttempts == null ? null : pulumi.Input.encodeList<RegionResizeRequestStatusLastAttempt, Map<String, dynamic>>(lastAttempts!, (value) => value.toMap()),
    };
  }

  factory RegionResizeRequestStatus.fromMap(Map<String, dynamic> map) {
    return RegionResizeRequestStatus(
      errors: map['errors'] == null ? null : pulumi.Input.decodeList<RegionResizeRequestStatusError>(map['errors'], (value) => RegionResizeRequestStatusError.fromMap((value as Map).cast<String, dynamic>())),
      lastAttempts: map['lastAttempts'] == null ? null : pulumi.Input.decodeList<RegionResizeRequestStatusLastAttempt>(map['lastAttempts'], (value) => RegionResizeRequestStatusLastAttempt.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
