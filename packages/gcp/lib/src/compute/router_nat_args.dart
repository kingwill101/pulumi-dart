...
class RouterNatArgs {
  ...
  RouterNatArgs({
    ...
    int? udpIdleTimeoutSec,
       ...
       endpointTypes = pulumi.Input.asOptionalInput<List<String>>(
         endpointTypes,
       ),
       icmpIdleTimeoutSec = pulumi.Input.asOptionalInput<int>(
         icmpIdleTimeoutSec,
       ),
       initialNatIps = pulumi.Input.asOptionalInput<List<String>>(
         initialNatIps,
       ),
       ...
       natIpAllocateOption = pulumi.Input.asOptionalInput<String>(
         natIpAllocateOption,
       ),
       ...
       sourceSubnetworkIpRangesToNat = pulumi.Input.asInput<String>(
       ...
       tcpTimeWaitTimeoutSec = pulumi.Input.asOptionalInput<int>(
         tcpTimeWaitTimeoutSec,
       ),
       tcpTransitoryIdleTimeoutSec = pulumi.Input.asOptionalInput<int>(
    ...
    return RouterNatArgs(
      ...
      rules: map['rules'] == null
          ...
          : pulumi.Input.decodeList<RouterNatRule>(
              map['rules'],
              (value) =>
                  RouterNatRule.fromMap((value as Map).cast<String, dynamic>()),
            ),
      sourceSubnetworkIpRangesToNat:
