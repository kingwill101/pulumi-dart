...
class RouterNatArgs {
  ...
  RouterNatArgs({
    ...
    int? udpIdleTimeoutSec,
      ...
      sourceSubnetworkIpRangesToNat = pulumi.Input.asInput<String>(sourceSubnetworkIpRangesToNat),
  ...
  factory RouterNatArgs.fromMap(Map<String, dynamic> map) {
    return RouterNatArgs(
      autoNetworkTier: map['autoNetworkTier'] == null ? null : map['autoNetworkTier'] as String,
      ...
      endpointTypes: map['endpointTypes'] == null ? null : (map['endpointTypes'] as List).cast<String>(),
      icmpIdleTimeoutSec: map['icmpIdleTimeoutSec'] == null ? null : map['icmpIdleTimeoutSec'] as int,
      initialNatIps: map['initialNatIps'] == null ? null : (map['initialNatIps'] as List).cast<String>(),
      ...
      nat64Subnetworks: map['nat64Subnetworks'] == null ? null : pulumi.Input.decodeList<RouterNatNat64Subnetwork>(map['nat64Subnetworks'], (value) => RouterNatNat64Subnetwork.fromMap((value as Map).cast<String, dynamic>())),
      natIpAllocateOption: map['natIpAllocateOption'] == null ? null : map['natIpAllocateOption'] as String,
      ...
      sourceSubnetworkIpRangesToNat64: map['sourceSubnetworkIpRangesToNat64'] == null ? null : map['sourceSubnetworkIpRangesToNat64'] as String,
      subnetworks: map['subnetworks'] == null ? null : pulumi.Input.decodeList<RouterNatSubnetwork>(map['subnetworks'], (value) => RouterNatSubnetwork.fromMap((value as Map).cast<String, dynamic>())),
