...
class OauthClientArgs {
  ...
  OauthClientArgs({
    ...
    required List<String> allowedRedirectUris,
    ...
    String? project,
            ...
            pulumi.Input.asInput<List<String>>(allowedGrantTypes),
        allowedRedirectUris =
            pulumi.Input.asInput<List<String>>(allowedRedirectUris),
  ...
  factory OauthClientArgs.fromMap(Map<String, dynamic> map) {
    return OauthClientArgs(
      allowedGrantTypes: (map['allowedGrantTypes'] as List).cast<String>(),
      allowedRedirectUris: (map['allowedRedirectUris'] as List).cast<String>(),
      allowedScopes: (map['allowedScopes'] as List).cast<String>(),
      clientType:
          map['clientType'] == null ? null : map['clientType'] as String,
      description:
