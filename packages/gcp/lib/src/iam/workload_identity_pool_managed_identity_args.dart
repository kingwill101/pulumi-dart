...
class WorkloadIdentityPoolManagedIdentityArgs {
  ...
  WorkloadIdentityPoolManagedIdentityArgs({
    List<WorkloadIdentityPoolManagedIdentityAttestationRule>? attestationRules,
    String? description,
    bool? disabled,
    String? project,
    ...
    required String workloadIdentityPoolNamespaceId,
        ...
        workloadIdentityPoolManagedIdentityId =
            pulumi.Input.asInput<String>(workloadIdentityPoolManagedIdentityId),
        workloadIdentityPoolNamespaceId =
            pulumi.Input.asInput<String>(workloadIdentityPoolNamespaceId);
