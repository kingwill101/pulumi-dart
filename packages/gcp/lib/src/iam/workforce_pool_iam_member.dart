...
class WorkforcePoolIamMember extends pulumi.CustomResource {
  late final pulumi.Output<WorkforcePoolIamMemberCondition?> condition;
  ...
  /// Creates a new [WorkforcePoolIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkforcePoolIamMember]. {@macro pulumi_iam_workforce_pool_iam_member_workforce_pool_iam_member_args_doc}
  ...
  WorkforcePoolIamMember(
    ...
    this.condition = registerOutput<WorkforcePoolIamMemberCondition?>('condition');
