...
class FoldersPolicyBindingArgs {
  ...
  FoldersPolicyBindingArgs({
    ...
    FoldersPolicyBindingCondition? condition,
    String? displayName,
    ...
    String? policyKind,
    required FoldersPolicyBindingTarget target,
  }) :
  ...
  factory FoldersPolicyBindingArgs.fromMap(Map<String, dynamic> map) {
    return FoldersPolicyBindingArgs(
      ...
      condition: map['condition'] == null ? null : FoldersPolicyBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      ...
      target: FoldersPolicyBindingTarget.fromMap((map['target'] as Map).cast<String, dynamic>()),
    );
  }
}
