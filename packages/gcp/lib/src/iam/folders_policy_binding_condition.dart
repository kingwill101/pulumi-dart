...
class FoldersPolicyBindingCondition {
  ...
  /// Creates a new [FoldersPolicyBindingCondition].
  ...
  factory FoldersPolicyBindingCondition.fromMap(Map<String, dynamic> map) {
    return FoldersPolicyBindingCondition(
      description:
