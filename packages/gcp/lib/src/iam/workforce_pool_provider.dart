...
class WorkforcePoolProvider extends pulumi.CustomResource {
  ...
  WorkforcePoolProvider(
    ...
    this.extendedAttributesOauth2Client = registerOutput<WorkforcePoolProviderExtendedAttributesOauth2Client?>('extendedAttributesOauth2Client');
    this.extraAttributesOauth2Client = registerOutput<WorkforcePoolProviderExtraAttributesOauth2Client?>('extraAttributesOauth2Client');
