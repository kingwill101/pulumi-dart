...
class WorkloadIdentityPoolIamBindingArgs {
  ...
  WorkloadIdentityPoolIamBindingArgs({
    WorkloadIdentityPoolIamBindingCondition? condition,
  ...
  factory WorkloadIdentityPoolIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadIdentityPoolIamBindingArgs(
      condition: map['condition'] == null ? null : WorkloadIdentityPoolIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
