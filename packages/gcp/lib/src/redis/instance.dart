...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.maintenancePolicy = registerOutput<InstanceMaintenancePolicy?>(
      'maintenancePolicy',
    );
    ...
    this.persistenceConfig = registerOutput<InstancePersistenceConfig>(
      'persistenceConfig',
    );
    ...
    this.serverCaCerts = registerOutput<List<InstanceServerCaCert>>(
      'serverCaCerts',
    );
