...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterAutomatedBackupConfig? automatedBackupConfig,
    ClusterCrossClusterReplicationConfig? crossClusterReplicationConfig,
    bool? deletionProtectionEnabled,
    ClusterGcsSource? gcsSource,
    String? kmsKey,
    Map<String, String>? labels,
    ClusterMaintenancePolicy? maintenancePolicy,
    String? maintenanceVersion,
    ClusterManagedBackupSource? managedBackupSource,
    String? name,
    String? nodeType,
    ClusterPersistenceConfig? persistenceConfig,
    String? project,
    List<ClusterPscConfig>? pscConfigs,
    Map<String, String>? redisConfigs,
    String? region,
    int? replicaCount,
    required int shardCount,
    String? transitEncryptionMode,
    ClusterZoneDistributionConfig? zoneDistributionConfig,
  }) :
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      automatedBackupConfig: map['automatedBackupConfig'] == null ? null : ClusterAutomatedBackupConfig.fromMap((map['automatedBackupConfig'] as Map).cast<String, dynamic>()),
      crossClusterReplicationConfig: map['crossClusterReplicationConfig'] == null ? null : ClusterCrossClusterReplicationConfig.fromMap((map['crossClusterReplicationConfig'] as Map).cast<String, dynamic>()),
      deletionProtectionEnabled: map['deletionProtectionEnabled'] == null ? null : map['deletionProtectionEnabled'] as bool,
      gcsSource: map['gcsSource'] == null ? null : ClusterGcsSource.fromMap((map['gcsSource'] as Map).cast<String, dynamic>()),
      ...
      managedBackupSource: map['managedBackupSource'] == null ? null : ClusterManagedBackupSource.fromMap((map['managedBackupSource'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      nodeType: map['nodeType'] == null ? null : map['nodeType'] as String,
      persistenceConfig: map['persistenceConfig'] == null ? null : ClusterPersistenceConfig.fromMap((map['persistenceConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      pscConfigs: map['pscConfigs'] == null ? null : pulumi.Input.decodeList<ClusterPscConfig>(map['pscConfigs'], (value) => ClusterPscConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      zoneDistributionConfig: map['zoneDistributionConfig'] == null ? null : ClusterZoneDistributionConfig.fromMap((map['zoneDistributionConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
