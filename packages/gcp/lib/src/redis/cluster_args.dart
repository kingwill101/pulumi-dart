...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterZoneDistributionConfig? zoneDistributionConfig,
            ...
            pulumi.Input.asOptionalInput<String>(authorizationMode),
        ...
        persistenceConfig =
            pulumi.Input.asOptionalInput<ClusterPersistenceConfig>(
                persistenceConfig),
        project = pulumi.Input.asOptionalInput<String>(project),
        pscConfigs =
            pulumi.Input.asOptionalInput<List<ClusterPscConfig>>(pscConfigs),
        redisConfigs =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (pscConfigsValue != null) {
      map['pscConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<ClusterPscConfig>, List<Map<String, dynamic>>>(
          pscConfigsValue,
          (value) =>
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      crossClusterReplicationConfig:
          map['crossClusterReplicationConfig'] == null
              ? null
              : ClusterCrossClusterReplicationConfig.fromMap(
                  (map['crossClusterReplicationConfig'] as Map)
                      .cast<String, dynamic>()),
