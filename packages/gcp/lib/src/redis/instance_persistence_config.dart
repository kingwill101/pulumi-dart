...
class InstancePersistenceConfig {
  ...
  factory InstancePersistenceConfig.fromMap(Map<String, dynamic> map) {
    return InstancePersistenceConfig(
      persistenceMode: map['persistenceMode'] == null ? null : map['persistenceMode'] as String,
      rdbNextSnapshotTime: map['rdbNextSnapshotTime'] == null ? null : map['rdbNextSnapshotTime'] as String,
