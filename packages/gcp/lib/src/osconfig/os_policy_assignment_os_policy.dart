...
import 'os_policy_assignment_os_policy_resource_group.dart';

class OsPolicyAssignmentOsPolicy {
  ...
  /// documented below.
  final List<OsPolicyAssignmentOsPolicyResourceGroup> resourceGroups;
