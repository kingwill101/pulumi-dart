...
class PatchDeploymentInstanceFilter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'all': ?all,
      'groupLabels': ?groupLabels == null ? null : pulumi.Input.encodeList<PatchDeploymentInstanceFilterGroupLabel, Map<String, dynamic>>(groupLabels!, (value) => value.toMap()),
  ...
  factory PatchDeploymentInstanceFilter.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentInstanceFilter(
      ...
      groupLabels: map['groupLabels'] == null ? null : pulumi.Input.decodeList<PatchDeploymentInstanceFilterGroupLabel>(map['groupLabels'], (value) => PatchDeploymentInstanceFilterGroupLabel.fromMap((value as Map).cast<String, dynamic>())),
