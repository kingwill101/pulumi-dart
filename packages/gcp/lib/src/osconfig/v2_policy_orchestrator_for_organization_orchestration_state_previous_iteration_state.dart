...
class V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState {
  ...
  final V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError?
  error;
  ...
  factory V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState.fromMap(
    Map<String, dynamic> map,
  ) {
    return V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState(
      error: map['error'] == null
          ? null
          : V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError.fromMap(
