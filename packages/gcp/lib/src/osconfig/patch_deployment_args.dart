...
class PatchDeploymentArgs {
  ...
  PatchDeploymentArgs({
    ...
    PatchDeploymentRollout? rollout,
        ...
        instanceFilter =
            pulumi.Input.asInput<PatchDeploymentInstanceFilter>(instanceFilter),
        oneTimeSchedule =
  ...
  factory PatchDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentArgs(
      ...
      instanceFilter: PatchDeploymentInstanceFilter.fromMap(
          (map['instanceFilter'] as Map).cast<String, dynamic>()),
      oneTimeSchedule: map['oneTimeSchedule'] == null
          ? null
