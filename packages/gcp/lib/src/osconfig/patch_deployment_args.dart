...
class PatchDeploymentArgs {
  ...
  PatchDeploymentArgs({
    String? description,
    String? duration,
    required PatchDeploymentInstanceFilter instanceFilter,
    PatchDeploymentOneTimeSchedule? oneTimeSchedule,
    PatchDeploymentPatchConfig? patchConfig,
    required String patchDeploymentId,
    String? project,
    PatchDeploymentRecurringSchedule? recurringSchedule,
    PatchDeploymentRollout? rollout,
  }) :
  ...
  factory PatchDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentArgs(
      ...
      instanceFilter: PatchDeploymentInstanceFilter.fromMap((map['instanceFilter'] as Map).cast<String, dynamic>()),
      oneTimeSchedule: map['oneTimeSchedule'] == null ? null : PatchDeploymentOneTimeSchedule.fromMap((map['oneTimeSchedule'] as Map).cast<String, dynamic>()),
      patchConfig: map['patchConfig'] == null ? null : PatchDeploymentPatchConfig.fromMap((map['patchConfig'] as Map).cast<String, dynamic>()),
      patchDeploymentId: map['patchDeploymentId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      recurringSchedule: map['recurringSchedule'] == null ? null : PatchDeploymentRecurringSchedule.fromMap((map['recurringSchedule'] as Map).cast<String, dynamic>()),
      rollout: map['rollout'] == null ? null : PatchDeploymentRollout.fromMap((map['rollout'] as Map).cast<String, dynamic>()),
    );
  }
}
