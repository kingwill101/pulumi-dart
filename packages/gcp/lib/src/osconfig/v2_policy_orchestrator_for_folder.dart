...
class V2PolicyOrchestratorForFolder extends pulumi.CustomResource {
  ...
  late final pulumi.Output<V2PolicyOrchestratorForFolderOrchestratedResource> orchestratedResource;
  /// Defines a set of selectors which drive which resources are in scope of policy
  /// orchestration.
  /// Structure is documented below.
  late final pulumi.Output<V2PolicyOrchestratorForFolderOrchestrationScope?> orchestrationScope;
  /// Describes the state of the orchestration process.
  /// Structure is documented below.
  late final pulumi.Output<List<V2PolicyOrchestratorForFolderOrchestrationState>> orchestrationStates;
  ...
  V2PolicyOrchestratorForFolder(
    ...
    this.orchestratedResource = registerOutput<V2PolicyOrchestratorForFolderOrchestratedResource>('orchestratedResource');
    this.orchestrationScope = registerOutput<V2PolicyOrchestratorForFolderOrchestrationScope?>('orchestrationScope');
    this.orchestrationStates = registerOutput<List<V2PolicyOrchestratorForFolderOrchestrationState>>('orchestrationStates');
