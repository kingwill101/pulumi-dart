...
class V2PolicyOrchestrator extends pulumi.CustomResource {
  ...
  late final pulumi.Output<V2PolicyOrchestratorOrchestratedResource> orchestratedResource;
  ...
  V2PolicyOrchestrator(
    ...
    this.orchestratedResource = registerOutput<V2PolicyOrchestratorOrchestratedResource>('orchestratedResource');
    this.orchestrationScope = registerOutput<V2PolicyOrchestratorOrchestrationScope?>('orchestrationScope');
    this.orchestrationStates = registerOutput<List<V2PolicyOrchestratorOrchestrationState>>('orchestrationStates');
