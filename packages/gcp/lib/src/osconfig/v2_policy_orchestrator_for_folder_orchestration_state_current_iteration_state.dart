...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState {
  ...
  final List<V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError>? errors;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errors': ?errors == null ? null : pulumi.Input.encodeList<V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError, Map<String, dynamic>>(errors!, (value) => value.toMap()),
  ...
  factory V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState(
      errors: map['errors'] == null ? null : pulumi.Input.decodeList<V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError>(map['errors'], (value) => V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError.fromMap((value as Map).cast<String, dynamic>())),
