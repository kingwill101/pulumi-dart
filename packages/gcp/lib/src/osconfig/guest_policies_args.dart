...
class GuestPoliciesArgs {
  ...
  factory GuestPoliciesArgs.fromMap(Map<String, dynamic> map) {
    return GuestPoliciesArgs(
      assignment: GuestPoliciesAssignment.fromMap((map['assignment'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      guestPolicyId: map['guestPolicyId'] as String,
      packageRepositories: map['packageRepositories'] == null ? null : pulumi.Input.decodeList<GuestPoliciesPackageRepository>(map['packageRepositories'], (value) => GuestPoliciesPackageRepository.fromMap((value as Map).cast<String, dynamic>())),
      packages: map['packages'] == null ? null : pulumi.Input.decodeList<GuestPoliciesPackage>(map['packages'], (value) => GuestPoliciesPackage.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      recipes: map['recipes'] == null ? null : pulumi.Input.decodeList<GuestPoliciesRecipe>(map['recipes'], (value) => GuestPoliciesRecipe.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
