...
class OsPolicyAssignmentArgs {
  ...
  factory OsPolicyAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentArgs(
      ...
      osPolicies: pulumi.Input.decodeList<OsPolicyAssignmentOsPolicy>(map['osPolicies'], (value) => OsPolicyAssignmentOsPolicy.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      rollout: OsPolicyAssignmentRollout.fromMap((map['rollout'] as Map).cast<String, dynamic>()),
      skipAwaitRollout: map['skipAwaitRollout'] == null ? null : map['skipAwaitRollout'] as bool,
    );
  }
}
