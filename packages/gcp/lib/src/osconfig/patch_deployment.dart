...
class PatchDeployment extends pulumi.CustomResource {
  ...
  PatchDeployment(
    ...
    this.instanceFilter = registerOutput<PatchDeploymentInstanceFilter>(
      'instanceFilter',
    );
    this.lastExecuteTime = registerOutput<String>('lastExecuteTime');
    this.name = registerOutput<String>('name');
    this.oneTimeSchedule = registerOutput<PatchDeploymentOneTimeSchedule?>(
      'oneTimeSchedule',
    );
    this.patchConfig = registerOutput<PatchDeploymentPatchConfig?>(
      'patchConfig',
    );
    this.patchDeploymentId = registerOutput<String>('patchDeploymentId');
    this.project = registerOutput<String>('project');
    this.recurringSchedule = registerOutput<PatchDeploymentRecurringSchedule?>(
      'recurringSchedule',
    );
