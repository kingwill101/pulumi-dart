...
class V2PolicyOrchestratorForFolderOrchestratedResource {
  ...
  final V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload? osPolicyAssignmentV1Payload;
  ...
  factory V2PolicyOrchestratorForFolderOrchestratedResource.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForFolderOrchestratedResource(
      ...
      osPolicyAssignmentV1Payload: map['osPolicyAssignmentV1Payload'] == null ? null : V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload.fromMap((map['osPolicyAssignmentV1Payload'] as Map).cast<String, dynamic>()),
    );
  }
}
