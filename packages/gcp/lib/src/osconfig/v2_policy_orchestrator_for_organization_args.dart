...
class V2PolicyOrchestratorForOrganizationArgs {
  ...
  V2PolicyOrchestratorForOrganizationArgs({
    ...
    required V2PolicyOrchestratorForOrganizationOrchestratedResource orchestratedResource,
    V2PolicyOrchestratorForOrganizationOrchestrationScope? orchestrationScope,
  ...
  factory V2PolicyOrchestratorForOrganizationArgs.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForOrganizationArgs(
      ...
      orchestratedResource: V2PolicyOrchestratorForOrganizationOrchestratedResource.fromMap((map['orchestratedResource'] as Map).cast<String, dynamic>()),
      orchestrationScope: map['orchestrationScope'] == null ? null : V2PolicyOrchestratorForOrganizationOrchestrationScope.fromMap((map['orchestrationScope'] as Map).cast<String, dynamic>()),
