...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1Payload {
  ...
  final V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter instanceFilter;
  ...
  final List<V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy> osPolicies;
  ...
  /// assignment.
  final V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadRollout rollout;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'osPolicies': pulumi.Input.encodeList<V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy, Map<String, dynamic>>(osPolicies, (value) => value.toMap()),
  ...
  factory V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1Payload.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1Payload(
      ...
      instanceFilter: V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter.fromMap((map['instanceFilter'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      osPolicies: pulumi.Input.decodeList<V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy>(map['osPolicies'], (value) => V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rollout: V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadRollout.fromMap((map['rollout'] as Map).cast<String, dynamic>()),
