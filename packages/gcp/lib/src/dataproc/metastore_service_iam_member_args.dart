...
/// {@template pulumi_dataproc_metastore_service_iam_member_metastore_service_iam_member_args_doc}
/// The set of arguments for MetastoreServiceIamMember.
/// {@endtemplate}
...
class MetastoreServiceIamMemberArgs {
  ...
  /// Creates a new [MetastoreServiceIamMemberArgs].
  /// [condition] Optional.
  ...
  MetastoreServiceIamMemberArgs({
    MetastoreServiceIamMemberCondition? condition,
    String? location,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<MetastoreServiceIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'member': member,
      'project': ?project,
      'role': role,
  ...
  factory MetastoreServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return MetastoreServiceIamMemberArgs(
      condition: map['condition'] == null ? null : MetastoreServiceIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
