...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfig {
  ...
  final WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinity? nodeGroupAffinity;
  ...
  final WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinity? reservationAffinity;
  ...
  final WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigShieldedInstanceConfig? shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadata': ?metadata,
      'network': ?network,
      'nodeGroupAffinity': ?nodeGroupAffinity == null ? null : nodeGroupAffinity!.toMap(),
  ...
  factory WorkflowTemplatePlacementManagedClusterConfigGceClusterConfig.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplatePlacementManagedClusterConfigGceClusterConfig(
      ...
      nodeGroupAffinity: map['nodeGroupAffinity'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinity.fromMap((map['nodeGroupAffinity'] as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : map['privateIpv6GoogleAccess'] as String,
      reservationAffinity: map['reservationAffinity'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
