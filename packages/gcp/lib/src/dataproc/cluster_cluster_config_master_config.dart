...
class ClusterClusterConfigMasterConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<ClusterClusterConfigMasterConfigAccelerator, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
  ...
  factory ClusterClusterConfigMasterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterClusterConfigMasterConfig(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<ClusterClusterConfigMasterConfigAccelerator>(map['accelerators'], (value) => ClusterClusterConfigMasterConfigAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      diskConfig: map['diskConfig'] == null ? null : ClusterClusterConfigMasterConfigDiskConfig.fromMap((map['diskConfig'] as Map).cast<String, dynamic>()),
