...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceSelectionLists': ?instanceSelectionLists == null
          ? null
          : pulumi.Input.encodeList<
              ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionList,
              Map<String, dynamic>
            >(instanceSelectionLists!, (value) => value.toMap()),
      'instanceSelectionResults': ?instanceSelectionResults == null
          ? null
          : pulumi.Input.encodeList<
              ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResult,
              Map<String, dynamic>
            >(instanceSelectionResults!, (value) => value.toMap()),
      'provisioningModelMix': ?provisioningModelMix == null
          ? null
          : provisioningModelMix!.toMap(),
    };
  }
