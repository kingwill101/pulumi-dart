...
class MetastoreTableIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<MetastoreTableIamBindingCondition?> condition;
  ...
  /// Creates a new [MetastoreTableIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MetastoreTableIamBinding]. {@macro pulumi_dataproc_metastore_table_iam_binding_metastore_table_iam_binding_args_doc}
  ...
  MetastoreTableIamBinding(
    ...
    this.condition = registerOutput<MetastoreTableIamBindingCondition?>('condition');
