  ...
  MetastoreServiceArgs({
    ...
    String? tier,
       ...
       networkConfig = pulumi
           .Input.asOptionalInput<MetastoreServiceNetworkConfig>(networkConfig),
       port = pulumi.Input.asOptionalInput<int>(port),
       project = pulumi.Input.asOptionalInput<String>(project),
       releaseChannel = pulumi.Input.asOptionalInput<String>(releaseChannel),
       scalingConfig = pulumi
           .Input.asOptionalInput<MetastoreServiceScalingConfig>(scalingConfig),
       scheduledBackup =
    ...
    return <String, dynamic>{
      ...
      'scheduledBackup':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(scheduledBackup, (value) => value.toMap()),
      'serviceId': ?serviceId,
      'tags': ?tags,
      'telemetryConfig':
          ?pulumi.Input.mapOptionalInputValue<
