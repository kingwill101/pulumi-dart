...
class MetastoreServiceArgs {
  ...
  factory MetastoreServiceArgs.fromMap(Map<String, dynamic> map) {
    return MetastoreServiceArgs(
      ...
      encryptionConfig: map['encryptionConfig'] == null ? null : MetastoreServiceEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      hiveMetastoreConfig: map['hiveMetastoreConfig'] == null ? null : MetastoreServiceHiveMetastoreConfig.fromMap((map['hiveMetastoreConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : MetastoreServiceMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      metadataIntegration: map['metadataIntegration'] == null ? null : MetastoreServiceMetadataIntegration.fromMap((map['metadataIntegration'] as Map).cast<String, dynamic>()),
      network: map['network'] == null ? null : map['network'] as String,
      networkConfig: map['networkConfig'] == null ? null : MetastoreServiceNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      releaseChannel: map['releaseChannel'] == null ? null : map['releaseChannel'] as String,
      scalingConfig: map['scalingConfig'] == null ? null : MetastoreServiceScalingConfig.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>()),
      scheduledBackup: map['scheduledBackup'] == null ? null : MetastoreServiceScheduledBackup.fromMap((map['scheduledBackup'] as Map).cast<String, dynamic>()),
      serviceId: map['serviceId'] == null ? null : map['serviceId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      telemetryConfig: map['telemetryConfig'] == null ? null : MetastoreServiceTelemetryConfig.fromMap((map['telemetryConfig'] as Map).cast<String, dynamic>()),
