...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      hadoopConfig: map['hadoopConfig'] == null ? null : JobHadoopConfig.fromMap((map['hadoopConfig'] as Map).cast<String, dynamic>()),
      hiveConfig: map['hiveConfig'] == null ? null : JobHiveConfig.fromMap((map['hiveConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      pigConfig: map['pigConfig'] == null ? null : JobPigConfig.fromMap((map['pigConfig'] as Map).cast<String, dynamic>()),
      placement: JobPlacement.fromMap((map['placement'] as Map).cast<String, dynamic>()),
      prestoConfig: map['prestoConfig'] == null ? null : JobPrestoConfig.fromMap((map['prestoConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      pysparkConfig: map['pysparkConfig'] == null ? null : JobPysparkConfig.fromMap((map['pysparkConfig'] as Map).cast<String, dynamic>()),
      reference: map['reference'] == null ? null : JobReference.fromMap((map['reference'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      scheduling: map['scheduling'] == null ? null : JobScheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      sparkConfig: map['sparkConfig'] == null ? null : JobSparkConfig.fromMap((map['sparkConfig'] as Map).cast<String, dynamic>()),
      sparksqlConfig: map['sparksqlConfig'] == null ? null : JobSparksqlConfig.fromMap((map['sparksqlConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
