...
class JobArgs {
  ...
  JobArgs({
    ...
    JobSparksqlConfig? sparksqlConfig,
        ...
        hadoopConfig =
            pulumi.Input.asOptionalInput<JobHadoopConfig>(hadoopConfig),
        ...
        prestoConfig =
            pulumi.Input.asOptionalInput<JobPrestoConfig>(prestoConfig),
        project = pulumi.Input.asOptionalInput<String>(project),
        pysparkConfig =
            pulumi.Input.asOptionalInput<JobPysparkConfig>(pysparkConfig),
        ...
        sparksqlConfig =
            pulumi.Input.asOptionalInput<JobSparksqlConfig>(sparksqlConfig);
