...
class BatchArgs {
  ...
  BatchArgs({
    ...
    BatchSparkSqlBatch? sparkSqlBatch,
        ...
        environmentConfig =
            pulumi.Input.asOptionalInput<BatchEnvironmentConfig>(
                environmentConfig),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        location = pulumi.Input.asOptionalInput<String>(location),
        project = pulumi.Input.asOptionalInput<String>(project),
        pysparkBatch =
            pulumi.Input.asOptionalInput<BatchPysparkBatch>(pysparkBatch),
        runtimeConfig =
            pulumi.Input.asOptionalInput<BatchRuntimeConfig>(runtimeConfig),
        sparkBatch = pulumi.Input.asOptionalInput<BatchSparkBatch>(sparkBatch),
        sparkRBatch =
            pulumi.Input.asOptionalInput<BatchSparkRBatch>(sparkRBatch),
        sparkSqlBatch =
            pulumi.Input.asOptionalInput<BatchSparkSqlBatch>(sparkSqlBatch);
