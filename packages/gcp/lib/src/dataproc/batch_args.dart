...
class BatchArgs {
  ...
  factory BatchArgs.fromMap(Map<String, dynamic> map) {
    return BatchArgs(
      ...
      environmentConfig: map['environmentConfig'] == null ? null : BatchEnvironmentConfig.fromMap((map['environmentConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pysparkBatch: map['pysparkBatch'] == null ? null : BatchPysparkBatch.fromMap((map['pysparkBatch'] as Map).cast<String, dynamic>()),
      runtimeConfig: map['runtimeConfig'] == null ? null : BatchRuntimeConfig.fromMap((map['runtimeConfig'] as Map).cast<String, dynamic>()),
      sparkBatch: map['sparkBatch'] == null ? null : BatchSparkBatch.fromMap((map['sparkBatch'] as Map).cast<String, dynamic>()),
      sparkRBatch: map['sparkRBatch'] == null ? null : BatchSparkRBatch.fromMap((map['sparkRBatch'] as Map).cast<String, dynamic>()),
      sparkSqlBatch: map['sparkSqlBatch'] == null ? null : BatchSparkSqlBatch.fromMap((map['sparkSqlBatch'] as Map).cast<String, dynamic>()),
    );
  }
}
