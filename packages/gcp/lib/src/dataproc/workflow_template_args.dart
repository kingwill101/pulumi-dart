...
class WorkflowTemplateArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobs': pulumi.Input.mapInputValue<List<WorkflowTemplateJob>, List<Map<String, dynamic>>>(jobs, (value) => pulumi.Input.encodeList<WorkflowTemplateJob, Map<String, dynamic>>(value, (value) => value.toMap())),
      'labels': ?labels,
      'location': location,
      'name': ?name,
  ...
  factory WorkflowTemplateArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateArgs(
      ...
      encryptionConfig: map['encryptionConfig'] == null ? null : WorkflowTemplateEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      jobs: pulumi.Input.decodeList<WorkflowTemplateJob>(map['jobs'], (value) => WorkflowTemplateJob.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<WorkflowTemplateParameter>(map['parameters'], (value) => WorkflowTemplateParameter.fromMap((value as Map).cast<String, dynamic>())),
