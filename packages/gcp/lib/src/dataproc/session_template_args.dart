...
class SessionTemplateArgs {
  ...
  SessionTemplateArgs({
    ...
    Map<String, dynamic>? sparkConnectSession,
       ...
       runtimeConfig = pulumi
           .Input.asOptionalInput<SessionTemplateRuntimeConfig>(runtimeConfig),
  ...
  factory SessionTemplateArgs.fromMap(Map<String, dynamic> map) {
    return SessionTemplateArgs(
      ...
      sparkConnectSession: map['sparkConnectSession'] == null
          ? null
          : (map['sparkConnectSession'] as Map).cast<String, dynamic>(),
    );
  }
}
