...
class MetastoreFederationIamMember extends pulumi.CustomResource {
  late final pulumi.Output<MetastoreFederationIamMemberCondition?> condition;
  ...
  /// Creates a new [MetastoreFederationIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MetastoreFederationIamMember]. {@macro pulumi_dataproc_metastore_federation_iam_member_metastore_federation_iam_member_args_doc}
  ...
  MetastoreFederationIamMember(
    ...
    this.condition = registerOutput<MetastoreFederationIamMemberCondition?>('condition');
