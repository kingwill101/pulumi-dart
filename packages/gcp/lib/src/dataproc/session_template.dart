...
class SessionTemplate extends pulumi.CustomResource {
  ...
  SessionTemplate(
    ...
    this.environmentConfig = registerOutput<SessionTemplateEnvironmentConfig?>(
      'environmentConfig',
    );
    this.jupyterSession = registerOutput<SessionTemplateJupyterSession?>(
      'jupyterSession',
    );
    ...
    this.runtimeConfig = registerOutput<SessionTemplateRuntimeConfig?>(
      'runtimeConfig',
    );
    this.sparkConnectSession = registerOutput<Map<String, dynamic>?>(
      'sparkConnectSession',
    );
