...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfig {
  ...
  final List<WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerator>? accelerators;
  /// Disk option config settings.
  final WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig? diskConfig;
  ...
  final List<WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig>? managedGroupConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerator, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
      'diskConfig': ?diskConfig == null ? null : diskConfig!.toMap(),
      'image': ?image,
      'instanceNames': ?instanceNames,
      'isPreemptible': ?isPreemptible,
      'machineType': ?machineType,
      'managedGroupConfigs': ?managedGroupConfigs == null ? null : pulumi.Input.encodeList<WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig, Map<String, dynamic>>(managedGroupConfigs!, (value) => value.toMap()),
  ...
  factory WorkflowTemplatePlacementManagedClusterConfigMasterConfig.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplatePlacementManagedClusterConfigMasterConfig(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerator>(map['accelerators'], (value) => WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      diskConfig: map['diskConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig.fromMap((map['diskConfig'] as Map).cast<String, dynamic>()),
      ...
      managedGroupConfigs: map['managedGroupConfigs'] == null ? null : pulumi.Input.decodeList<WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig>(map['managedGroupConfigs'], (value) => WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig.fromMap((value as Map).cast<String, dynamic>())),
