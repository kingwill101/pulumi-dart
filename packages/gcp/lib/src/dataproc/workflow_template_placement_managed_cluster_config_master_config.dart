...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'managedGroupConfigs': ?managedGroupConfigs == null
          ? null
          : pulumi.Input.encodeList<
              WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig,
              Map<String, dynamic>
            >(managedGroupConfigs!, (value) => value.toMap()),
  ...
  factory WorkflowTemplatePlacementManagedClusterConfigMasterConfig.fromMap(
    ...
    return WorkflowTemplatePlacementManagedClusterConfigMasterConfig(
      accelerators: map['accelerators'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['accelerators'],
              (value) =>
                  WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerator.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      diskConfig: map['diskConfig'] == null
          ? null
          : WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig.fromMap(
      ...
      isPreemptible: map['isPreemptible'] == null
          ? null
          : map['isPreemptible'] as bool,
      ...
      managedGroupConfigs: map['managedGroupConfigs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
