...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterVirtualClusterConfig? virtualClusterConfig,
            ...
            pulumi.Input.asOptionalInput<ClusterClusterConfig>(clusterConfig),
        gracefulDecommissionTimeout =
            pulumi.Input.asOptionalInput<String>(gracefulDecommissionTimeout),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      clusterConfig: map['clusterConfig'] == null
          ? null
          : ClusterClusterConfig.fromMap(
              (map['clusterConfig'] as Map).cast<String, dynamic>()),
      gracefulDecommissionTimeout: map['gracefulDecommissionTimeout'] == null
          ? null
      ...
      virtualClusterConfig: map['virtualClusterConfig'] == null
          ? null
          : ClusterVirtualClusterConfig.fromMap(
