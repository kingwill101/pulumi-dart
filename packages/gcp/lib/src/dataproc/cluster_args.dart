...
class ClusterArgs {
  ...
  ClusterArgs({
    ClusterClusterConfig? clusterConfig,
    String? gracefulDecommissionTimeout,
    Map<String, String>? labels,
    String? name,
    String? project,
    String? region,
    ClusterVirtualClusterConfig? virtualClusterConfig,
  }) :
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      clusterConfig: map['clusterConfig'] == null ? null : ClusterClusterConfig.fromMap((map['clusterConfig'] as Map).cast<String, dynamic>()),
      gracefulDecommissionTimeout: map['gracefulDecommissionTimeout'] == null ? null : map['gracefulDecommissionTimeout'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      virtualClusterConfig: map['virtualClusterConfig'] == null ? null : ClusterVirtualClusterConfig.fromMap((map['virtualClusterConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
