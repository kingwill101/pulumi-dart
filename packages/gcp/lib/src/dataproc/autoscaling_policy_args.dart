...
class AutoscalingPolicyArgs {
  ...
  factory AutoscalingPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyArgs(
      basicAlgorithm: map['basicAlgorithm'] == null ? null : AutoscalingPolicyBasicAlgorithm.fromMap((map['basicAlgorithm'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      policyId: map['policyId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      secondaryWorkerConfig: map['secondaryWorkerConfig'] == null ? null : AutoscalingPolicySecondaryWorkerConfig.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      workerConfig: map['workerConfig'] == null ? null : AutoscalingPolicyWorkerConfig.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
