...
class WorkflowTemplateJobPigJob {
  ...
  factory WorkflowTemplateJobPigJob.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateJobPigJob(
      ...
      loggingConfig: map['loggingConfig'] == null ? null : WorkflowTemplateJobPigJobLoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>()),
      properties: map['properties'] == null ? null : (map['properties'] as Map).cast<String, String>(),
      queryFileUri: map['queryFileUri'] == null ? null : map['queryFileUri'] as String,
      queryList: map['queryList'] == null ? null : WorkflowTemplateJobPigJobQueryList.fromMap((map['queryList'] as Map).cast<String, dynamic>()),
