...
class GdcSparkApplicationArgs {
  ...
  GdcSparkApplicationArgs({
    ...
    String? version,
       ...
       applicationEnvironment = pulumi.Input.asOptionalInput<String>(
         applicationEnvironment,
       ),
       dependencyImages = pulumi.Input.asOptionalInput<List<String>>(
         dependencyImages,
       ),
    ...
    return <String, dynamic>{
      ...
      'pysparkApplicationConfig':
          ?pulumi.Input.mapOptionalInputValue<
            GdcSparkApplicationPysparkApplicationConfig,
            Map<String, dynamic>
          >(pysparkApplicationConfig, (value) => value.toMap()),
      'serviceinstance': serviceinstance,
      'sparkApplicationConfig':
          ?pulumi.Input.mapOptionalInputValue<
            GdcSparkApplicationSparkApplicationConfig,
            Map<String, dynamic>
          >(sparkApplicationConfig, (value) => value.toMap()),
      'sparkApplicationId': sparkApplicationId,
      'sparkRApplicationConfig':
          ?pulumi.Input.mapOptionalInputValue<
            GdcSparkApplicationSparkRApplicationConfig,
            Map<String, dynamic>
          >(sparkRApplicationConfig, (value) => value.toMap()),
      'sparkSqlApplicationConfig':
          ?pulumi.Input.mapOptionalInputValue<
            GdcSparkApplicationSparkSqlApplicationConfig,
            Map<String, dynamic>
          >(sparkSqlApplicationConfig, (value) => value.toMap()),
      'version': ?version,
    };
  }
  ...
  factory GdcSparkApplicationArgs.fromMap(Map<String, dynamic> map) {
    return GdcSparkApplicationArgs(
      ...
      applicationEnvironment: map['applicationEnvironment'] == null
          ? null
          : map['applicationEnvironment'] as String,
      dependencyImages: map['dependencyImages'] == null
          ? null
          : (map['dependencyImages'] as List).cast<String>(),
      ...
      pysparkApplicationConfig: map['pysparkApplicationConfig'] == null
          ? null
          : GdcSparkApplicationPysparkApplicationConfig.fromMap(
              (map['pysparkApplicationConfig'] as Map).cast<String, dynamic>(),
            ),
      serviceinstance: map['serviceinstance'] as String,
      sparkApplicationConfig: map['sparkApplicationConfig'] == null
          ? null
          : GdcSparkApplicationSparkApplicationConfig.fromMap(
              (map['sparkApplicationConfig'] as Map).cast<String, dynamic>(),
            ),
      sparkApplicationId: map['sparkApplicationId'] as String,
      sparkRApplicationConfig: map['sparkRApplicationConfig'] == null
          ? null
          : GdcSparkApplicationSparkRApplicationConfig.fromMap(
              (map['sparkRApplicationConfig'] as Map).cast<String, dynamic>(),
            ),
      sparkSqlApplicationConfig: map['sparkSqlApplicationConfig'] == null
          ? null
          : GdcSparkApplicationSparkSqlApplicationConfig.fromMap(
              (map['sparkSqlApplicationConfig'] as Map).cast<String, dynamic>(),
            ),
