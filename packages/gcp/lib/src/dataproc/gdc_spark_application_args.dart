  ...
  GdcSparkApplicationArgs({
    ...
    String? version,
        ...
        applicationEnvironment =
            pulumi.Input.asOptionalInput<String>(applicationEnvironment),
        dependencyImages =
            pulumi.Input.asOptionalInput<List<String>>(dependencyImages),
    ...
    return GdcSparkApplicationArgs(
      ...
      sparkSqlApplicationConfig: map['sparkSqlApplicationConfig'] == null
          ...
          : GdcSparkApplicationSparkSqlApplicationConfig.fromMap(
              (map['sparkSqlApplicationConfig'] as Map)
                  .cast<String, dynamic>()),
