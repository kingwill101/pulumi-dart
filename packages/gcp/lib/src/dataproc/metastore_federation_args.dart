...
class MetastoreFederationArgs {
  ...
  final pulumi.Input<List<MetastoreFederationBackendMetastore>>
      backendMetastores;
  ...
  MetastoreFederationArgs({
    ...
    required String version,
            ...
            pulumi.Input.asInput<List<MetastoreFederationBackendMetastore>>(
                backendMetastores),
        deletionProtection =
  ...
  Map<String, dynamic> toMap() {
    ...
    map['backendMetastores'] = pulumi.Input.mapInputValue<
            List<MetastoreFederationBackendMetastore>,
            List<Map<String, dynamic>>>(
        backendMetastores,
        (value) => pulumi.Input.encodeList<MetastoreFederationBackendMetastore,
  ...
  factory MetastoreFederationArgs.fromMap(Map<String, dynamic> map) {
    return MetastoreFederationArgs(
      backendMetastores:
          pulumi.Input.decodeList<MetastoreFederationBackendMetastore>(
              map['backendMetastores'],
              (value) => MetastoreFederationBackendMetastore.fromMap(
