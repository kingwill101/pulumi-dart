...
class GdcApplicationEnvironmentArgs {
  ...
  GdcApplicationEnvironmentArgs({
    ...
    GdcApplicationEnvironmentSparkApplicationEnvironmentConfig?
        ...
        applicationEnvironmentId =
            pulumi.Input.asOptionalInput<String>(applicationEnvironmentId),
  ...
  factory GdcApplicationEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return GdcApplicationEnvironmentArgs(
      ...
      applicationEnvironmentId: map['applicationEnvironmentId'] == null
          ? null
          : map['applicationEnvironmentId'] as String,
      displayName:
      ...
      sparkApplicationEnvironmentConfig:
          map['sparkApplicationEnvironmentConfig'] == null
              ? null
              : GdcApplicationEnvironmentSparkApplicationEnvironmentConfig
                  .fromMap((map['sparkApplicationEnvironmentConfig'] as Map)
                      .cast<String, dynamic>()),
    );
  }
}
