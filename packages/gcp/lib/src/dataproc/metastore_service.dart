...
class MetastoreService extends pulumi.CustomResource {
  ...
  MetastoreService(
    ...
    this.encryptionConfig = registerOutput<MetastoreServiceEncryptionConfig?>(
      'encryptionConfig',
    );
    ...
    this.maintenanceWindow = registerOutput<MetastoreServiceMaintenanceWindow?>(
      'maintenanceWindow',
    );
    ...
    this.networkConfig = registerOutput<MetastoreServiceNetworkConfig?>(
      'networkConfig',
    );
    ...
    this.scalingConfig = registerOutput<MetastoreServiceScalingConfig?>(
      'scalingConfig',
    );
    this.scheduledBackup = registerOutput<MetastoreServiceScheduledBackup?>(
      'scheduledBackup',
    );
    ...
    this.telemetryConfig = registerOutput<MetastoreServiceTelemetryConfig>(
      'telemetryConfig',
    );
