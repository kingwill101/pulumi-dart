...
class MetastoreService extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<MetastoreServiceMaintenanceWindow?> maintenanceWindow;
  /// The setting that defines how metastore metadata should be integrated with external services and systems.
  /// Structure is documented below.
  late final pulumi.Output<MetastoreServiceMetadataIntegration?> metadataIntegration;
  ...
  MetastoreService(
    ...
    this.encryptionConfig = registerOutput<MetastoreServiceEncryptionConfig?>('encryptionConfig');
    this.endpointUri = registerOutput<String>('endpointUri');
    this.hiveMetastoreConfig = registerOutput<MetastoreServiceHiveMetastoreConfig?>('hiveMetastoreConfig');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String?>('location');
    this.maintenanceWindow = registerOutput<MetastoreServiceMaintenanceWindow?>('maintenanceWindow');
    this.metadataIntegration = registerOutput<MetastoreServiceMetadataIntegration?>('metadataIntegration');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig = registerOutput<MetastoreServiceNetworkConfig?>('networkConfig');
    this.port = registerOutput<int>('port');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.releaseChannel = registerOutput<String?>('releaseChannel');
    this.scalingConfig = registerOutput<MetastoreServiceScalingConfig?>('scalingConfig');
    this.scheduledBackup = registerOutput<MetastoreServiceScheduledBackup?>('scheduledBackup');
    this.serviceId = registerOutput<String>('serviceId');
    this.state = registerOutput<String>('state');
    this.stateMessage = registerOutput<String>('stateMessage');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.telemetryConfig = registerOutput<MetastoreServiceTelemetryConfig>('telemetryConfig');
