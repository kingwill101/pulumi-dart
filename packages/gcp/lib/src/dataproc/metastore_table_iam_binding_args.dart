...
/// {@template pulumi_dataproc_metastore_table_iam_binding_metastore_table_iam_binding_args_doc}
...
class MetastoreTableIamBindingArgs {
  ...
  /// Creates a new [MetastoreTableIamBindingArgs].
  /// [condition] Optional.
  ...
  MetastoreTableIamBindingArgs({
    MetastoreTableIamBindingCondition? condition,
    ...
    required String table,
           ...
           .Input.asOptionalInput<MetastoreTableIamBindingCondition>(condition),
