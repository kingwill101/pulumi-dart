...
class GdcServiceInstanceArgs {
  ...
  factory GdcServiceInstanceArgs.fromMap(Map<String, dynamic> map) {
    return GdcServiceInstanceArgs(
      ...
      gdceCluster: map['gdceCluster'] == null ? null : GdcServiceInstanceGdceCluster.fromMap((map['gdceCluster'] as Map).cast<String, dynamic>()),
      ...
      sparkServiceInstanceConfig: map['sparkServiceInstanceConfig'] == null ? null : (map['sparkServiceInstanceConfig'] as Map).cast<String, dynamic>(),
    );
  }
}
