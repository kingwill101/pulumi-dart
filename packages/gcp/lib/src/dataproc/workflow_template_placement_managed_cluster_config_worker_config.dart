...
class WorkflowTemplatePlacementManagedClusterConfigWorkerConfig {
  ...
  final List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator>? accelerators;
  /// Optional. Disk option config settings.
  final WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfig? diskConfig;
  ...
  final List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig>? managedGroupConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
      'diskConfig': ?diskConfig == null ? null : diskConfig!.toMap(),
      'image': ?image,
      'instanceNames': ?instanceNames,
      'isPreemptible': ?isPreemptible,
      'machineType': ?machineType,
      'managedGroupConfigs': ?managedGroupConfigs == null ? null : pulumi.Input.encodeList<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig, Map<String, dynamic>>(managedGroupConfigs!, (value) => value.toMap()),
  ...
  factory WorkflowTemplatePlacementManagedClusterConfigWorkerConfig.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplatePlacementManagedClusterConfigWorkerConfig(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator>(map['accelerators'], (value) => WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      diskConfig: map['diskConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfig.fromMap((map['diskConfig'] as Map).cast<String, dynamic>()),
      ...
      managedGroupConfigs: map['managedGroupConfigs'] == null ? null : pulumi.Input.decodeList<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig>(map['managedGroupConfigs'], (value) => WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig.fromMap((value as Map).cast<String, dynamic>())),
