...
class WorkflowTemplatePlacementManagedClusterConfig {
  ...
  final WorkflowTemplatePlacementManagedClusterConfigAutoscalingConfig? autoscalingConfig;
  /// Encryption settings for the cluster.
  final WorkflowTemplatePlacementManagedClusterConfigEncryptionConfig? encryptionConfig;
  /// Port/endpoint configuration for this cluster
  final WorkflowTemplatePlacementManagedClusterConfigEndpointConfig? endpointConfig;
  /// The shared Compute Engine config settings for all instances in a cluster.
  final WorkflowTemplatePlacementManagedClusterConfigGceClusterConfig? gceClusterConfig;
  ...
  final WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig? gkeClusterConfig;
  /// Commands to execute on each node after config is completed. By default, executables are run on master and all worker nodes. You can test a node's `role` metadata to run an executable on a master or worker node, as shown below using `curl` (you can also use `wget`): ROLE=$(curl -H Metadata-Flavor:Google http://metadata/computeMetadata/v1/instance/attributes/dataproc-role) if ; then ... master specific actions ... else ... worker specific actions ... fi
  final List<WorkflowTemplatePlacementManagedClusterConfigInitializationAction>? initializationActions;
  /// Lifecycle setting for the cluster.
  final WorkflowTemplatePlacementManagedClusterConfigLifecycleConfig? lifecycleConfig;
  ...
  final WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig? metastoreConfig;
  /// The Compute Engine config settings for additional worker instances in a cluster.
  final WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfig? secondaryWorkerConfig;
  /// Security settings for the cluster.
  final WorkflowTemplatePlacementManagedClusterConfigSecurityConfig? securityConfig;
  /// The config settings for software inside the cluster.
  final WorkflowTemplatePlacementManagedClusterConfigSoftwareConfig? softwareConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'initializationActions': ?initializationActions == null ? null : pulumi.Input.encodeList<WorkflowTemplatePlacementManagedClusterConfigInitializationAction, Map<String, dynamic>>(initializationActions!, (value) => value.toMap()),
  ...
  factory WorkflowTemplatePlacementManagedClusterConfig.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplatePlacementManagedClusterConfig(
      autoscalingConfig: map['autoscalingConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigAutoscalingConfig.fromMap((map['autoscalingConfig'] as Map).cast<String, dynamic>()),
      encryptionConfig: map['encryptionConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      endpointConfig: map['endpointConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigEndpointConfig.fromMap((map['endpointConfig'] as Map).cast<String, dynamic>()),
      gceClusterConfig: map['gceClusterConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigGceClusterConfig.fromMap((map['gceClusterConfig'] as Map).cast<String, dynamic>()),
      gkeClusterConfig: map['gkeClusterConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig.fromMap((map['gkeClusterConfig'] as Map).cast<String, dynamic>()),
      initializationActions: map['initializationActions'] == null ? null : pulumi.Input.decodeList<WorkflowTemplatePlacementManagedClusterConfigInitializationAction>(map['initializationActions'], (value) => WorkflowTemplatePlacementManagedClusterConfigInitializationAction.fromMap((value as Map).cast<String, dynamic>())),
      lifecycleConfig: map['lifecycleConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigLifecycleConfig.fromMap((map['lifecycleConfig'] as Map).cast<String, dynamic>()),
      masterConfig: map['masterConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigMasterConfig.fromMap((map['masterConfig'] as Map).cast<String, dynamic>()),
      metastoreConfig: map['metastoreConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig.fromMap((map['metastoreConfig'] as Map).cast<String, dynamic>()),
      secondaryWorkerConfig: map['secondaryWorkerConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfig.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      securityConfig: map['securityConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigSecurityConfig.fromMap((map['securityConfig'] as Map).cast<String, dynamic>()),
      softwareConfig: map['softwareConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigSoftwareConfig.fromMap((map['softwareConfig'] as Map).cast<String, dynamic>()),
      ...
      workerConfig: map['workerConfig'] == null ? null : WorkflowTemplatePlacementManagedClusterConfigWorkerConfig.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
