...
class RuntimeTemplate extends pulumi.CustomResource {
  ...
  RuntimeTemplate(
    ...
    this.encryptionSpec = registerOutput<RuntimeTemplateEncryptionSpec?>(
      'encryptionSpec',
    );
    this.eucConfig = registerOutput<RuntimeTemplateEucConfig>('eucConfig');
    this.idleShutdownConfig = registerOutput<RuntimeTemplateIdleShutdownConfig>(
      'idleShutdownConfig',
    );
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.machineSpec = registerOutput<RuntimeTemplateMachineSpec>(
      'machineSpec',
    );
    this.name = registerOutput<String>('name');
    this.networkSpec = registerOutput<RuntimeTemplateNetworkSpec>(
      'networkSpec',
    );
    this.networkTags = registerOutput<List<String>?>('networkTags');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.shieldedVmConfig = registerOutput<RuntimeTemplateShieldedVmConfig>(
      'shieldedVmConfig',
    );
    this.softwareConfig = registerOutput<RuntimeTemplateSoftwareConfig>(
      'softwareConfig',
    );
  }
}
