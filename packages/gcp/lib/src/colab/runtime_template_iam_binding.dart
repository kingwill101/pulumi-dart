...
import 'runtime_template_iam_binding_condition.dart';
...
class RuntimeTemplateIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<RuntimeTemplateIamBindingCondition?> condition;
  ...
  /// Creates a new [RuntimeTemplateIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RuntimeTemplateIamBinding]. {@macro pulumi_colab_runtime_template_iam_binding_runtime_template_iam_binding_args_doc}
  ...
  RuntimeTemplateIamBinding(
    ...
    this.condition = registerOutput<RuntimeTemplateIamBindingCondition?>('condition');
