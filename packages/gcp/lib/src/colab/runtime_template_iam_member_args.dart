...
class RuntimeTemplateIamMemberArgs {
  ...
  RuntimeTemplateIamMemberArgs({
    RuntimeTemplateIamMemberCondition? condition,
    String? location,
  ...
  factory RuntimeTemplateIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeTemplateIamMemberArgs(
      condition: map['condition'] == null ? null : RuntimeTemplateIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
