...
class RuntimeArgs {
  ...
  factory RuntimeArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeArgs(
      ...
      notebookRuntimeTemplateRef: map['notebookRuntimeTemplateRef'] == null ? null : RuntimeNotebookRuntimeTemplateRef.fromMap((map['notebookRuntimeTemplateRef'] as Map).cast<String, dynamic>()),
