...
class ConnectivityTestArgs {
  ...
  ConnectivityTestArgs({
    ...
    String? description,
    required ConnectivityTestDestination destination,
  ...
  }) : bypassFirewallChecks = pulumi.Input.asOptionalInput<bool>(
         bypassFirewallChecks,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       destination = pulumi.Input.asInput<ConnectivityTestDestination>(
         destination,
       ),
