...
class OrganizationVpcFlowLogsConfigArgs {
  ...
  OrganizationVpcFlowLogsConfigArgs({
    ...
    required String vpcFlowLogsConfigId,
  }) : aggregationInterval = pulumi.Input.asOptionalInput<String>(
         aggregationInterval,
       ),
       crossProjectMetadata = pulumi.Input.asOptionalInput<String>(
       ...
       metadataFields = pulumi.Input.asOptionalInput<List<String>>(
         metadataFields,
       ),
  ...
  factory OrganizationVpcFlowLogsConfigArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationVpcFlowLogsConfigArgs(
      ...
      crossProjectMetadata: map['crossProjectMetadata'] == null
          ? null
          : map['crossProjectMetadata'] as String,
