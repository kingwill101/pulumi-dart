...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      directoryServices: map['directoryServices'] == null ? null : InstanceDirectoryServices.fromMap((map['directoryServices'] as Map).cast<String, dynamic>()),
      fileShares: InstanceFileShares.fromMap((map['fileShares'] as Map).cast<String, dynamic>()),
      initialReplication: map['initialReplication'] == null ? null : InstanceInitialReplication.fromMap((map['initialReplication'] as Map).cast<String, dynamic>()),
      kmsKeyName: map['kmsKeyName'] == null ? null : map['kmsKeyName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networks: pulumi.Input.decodeList<InstanceNetwork>(map['networks'], (value) => InstanceNetwork.fromMap((value as Map).cast<String, dynamic>())),
      performanceConfig: map['performanceConfig'] == null ? null : InstancePerformanceConfig.fromMap((map['performanceConfig'] as Map).cast<String, dynamic>()),
