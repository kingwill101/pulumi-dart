...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.deletionProtectionReason = registerOutput<String?>(
      'deletionProtectionReason',
    );
    this.description = registerOutput<String?>('description');
    this.directoryServices = registerOutput<InstanceDirectoryServices?>(
      'directoryServices',
    );
    ...
    this.initialReplication = registerOutput<InstanceInitialReplication?>(
      'initialReplication',
    );
    ...
    this.performanceConfig = registerOutput<InstancePerformanceConfig?>(
      'performanceConfig',
    );
