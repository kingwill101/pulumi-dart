...
class WorkloadArgs {
  ...
  WorkloadArgs({
    ...
    WorkloadWorkloadOptions? workloadOptions,
        ...
        kmsSettings =
            pulumi.Input.asOptionalInput<WorkloadKmsSettings>(kmsSettings),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        location = pulumi.Input.asInput<String>(location),
        organization = pulumi.Input.asInput<String>(organization),
        partner = pulumi.Input.asOptionalInput<String>(partner),
        partnerPermissions =
            pulumi.Input.asOptionalInput<WorkloadPartnerPermissions>(
                partnerPermissions),
        partnerServicesBillingAccount =
            pulumi.Input.asOptionalInput<String>(partnerServicesBillingAccount),
        provisionedResourcesParent =
            pulumi.Input.asOptionalInput<String>(provisionedResourcesParent),
        resourceSettings =
            pulumi.Input.asOptionalInput<List<WorkloadResourceSetting>>(
                resourceSettings),
        violationNotificationsEnabled =
            pulumi.Input.asOptionalInput<bool>(violationNotificationsEnabled),
        workloadOptions = pulumi.Input.asOptionalInput<WorkloadWorkloadOptions>(
            workloadOptions);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (resourceSettingsValue != null) {
      map['resourceSettings'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<WorkloadResourceSetting,
    ...
    if (workloadOptionsValue != null) {
      map['workloadOptions'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory WorkloadArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadArgs(
      ...
      partnerServicesBillingAccount:
          map['partnerServicesBillingAccount'] == null
              ? null
              : map['partnerServicesBillingAccount'] as String,
      ...
      workloadOptions: map['workloadOptions'] == null
          ? null
          : WorkloadWorkloadOptions.fromMap(
              (map['workloadOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
