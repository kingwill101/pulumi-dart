...
class Workload extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<WorkloadEkmProvisioningResponse>>
  ...
  late final pulumi.Output<List<WorkloadSaaEnrollmentResponse>>
  ...
  Workload(
    ...
    this.complianceStatuses = registerOutput<List<WorkloadComplianceStatus>>(
      'complianceStatuses',
    );
    ...
    this.partnerPermissions = registerOutput<WorkloadPartnerPermissions?>(
      'partnerPermissions',
    );
    this.partnerServicesBillingAccount = registerOutput<String?>(
    ...
    this.resourceSettings = registerOutput<List<WorkloadResourceSetting>?>(
      'resourceSettings',
    );
    ...
    this.workloadOptions = registerOutput<WorkloadWorkloadOptions?>(
      'workloadOptions',
    );
  }
}
