...
class InsightsConfig extends pulumi.CustomResource {
  ...
  InsightsConfig(
    ...
    this.artifactConfigs = registerOutput<List<InsightsConfigArtifactConfig>?>('artifactConfigs');
    ...
    this.runtimeConfigs = registerOutput<List<InsightsConfigRuntimeConfig>>('runtimeConfigs');
