...
class Connection extends pulumi.CustomResource {
  ...
  Connection(
    ...
    this.bitbucketCloudConfig = registerOutput<ConnectionBitbucketCloudConfig?>(
      'bitbucketCloudConfig',
    );
    ...
    this.cryptoKeyConfig = registerOutput<ConnectionCryptoKeyConfig?>(
      'cryptoKeyConfig',
    );
    ...
    this.installationStates = registerOutput<List<ConnectionInstallationState>>(
      'installationStates',
    );
