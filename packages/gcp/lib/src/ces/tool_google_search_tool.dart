...
class ToolGoogleSearchTool {
  ...
  factory ToolGoogleSearchTool.fromMap(Map<String, dynamic> map) {
    return ToolGoogleSearchTool(
      contextUrls: map['contextUrls'] == null ? null : (map['contextUrls'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      excludeDomains: map['excludeDomains'] == null ? null : (map['excludeDomains'] as List).cast<String>(),
      name: map['name'] as String,
      preferredDomains: map['preferredDomains'] == null ? null : (map['preferredDomains'] as List).cast<String>(),
    );
  }
}
