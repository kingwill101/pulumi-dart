...
class AgentArgs {
  ...
  factory AgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentArgs(
      afterAgentCallbacks: map['afterAgentCallbacks'] == null ? null : pulumi.Input.decodeList<AgentAfterAgentCallback>(map['afterAgentCallbacks'], (value) => AgentAfterAgentCallback.fromMap((value as Map).cast<String, dynamic>())),
      afterModelCallbacks: map['afterModelCallbacks'] == null ? null : pulumi.Input.decodeList<AgentAfterModelCallback>(map['afterModelCallbacks'], (value) => AgentAfterModelCallback.fromMap((value as Map).cast<String, dynamic>())),
      afterToolCallbacks: map['afterToolCallbacks'] == null ? null : pulumi.Input.decodeList<AgentAfterToolCallback>(map['afterToolCallbacks'], (value) => AgentAfterToolCallback.fromMap((value as Map).cast<String, dynamic>())),
      agentId: map['agentId'] == null ? null : map['agentId'] as String,
      app: map['app'] as String,
      beforeAgentCallbacks: map['beforeAgentCallbacks'] == null ? null : pulumi.Input.decodeList<AgentBeforeAgentCallback>(map['beforeAgentCallbacks'], (value) => AgentBeforeAgentCallback.fromMap((value as Map).cast<String, dynamic>())),
      beforeModelCallbacks: map['beforeModelCallbacks'] == null ? null : pulumi.Input.decodeList<AgentBeforeModelCallback>(map['beforeModelCallbacks'], (value) => AgentBeforeModelCallback.fromMap((value as Map).cast<String, dynamic>())),
      beforeToolCallbacks: map['beforeToolCallbacks'] == null ? null : pulumi.Input.decodeList<AgentBeforeToolCallback>(map['beforeToolCallbacks'], (value) => AgentBeforeToolCallback.fromMap((value as Map).cast<String, dynamic>())),
      childAgents: map['childAgents'] == null ? null : (map['childAgents'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      guardrails: map['guardrails'] == null ? null : (map['guardrails'] as List).cast<String>(),
      instruction: map['instruction'] == null ? null : map['instruction'] as String,
      llmAgent: map['llmAgent'] == null ? null : (map['llmAgent'] as Map).cast<String, dynamic>(),
      location: map['location'] as String,
      modelSettings: map['modelSettings'] == null ? null : AgentModelSettings.fromMap((map['modelSettings'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      remoteDialogflowAgent: map['remoteDialogflowAgent'] == null ? null : AgentRemoteDialogflowAgent.fromMap((map['remoteDialogflowAgent'] as Map).cast<String, dynamic>()),
      tools: map['tools'] == null ? null : (map['tools'] as List).cast<String>(),
      toolsets: map['toolsets'] == null ? null : pulumi.Input.decodeList<AgentToolset>(map['toolsets'], (value) => AgentToolset.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
