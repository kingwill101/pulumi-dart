...
class ToolArgs {
  ...
  ToolArgs({
    ...
    required String toolId,
        ...
        clientFunction =
            pulumi.Input.asOptionalInput<ToolClientFunction>(clientFunction),
        dataStoreTool =
            pulumi.Input.asOptionalInput<ToolDataStoreTool>(dataStoreTool),
        ...
        pythonFunction =
            pulumi.Input.asOptionalInput<ToolPythonFunction>(pythonFunction),
