...
class ToolArgs {
  ...
  factory ToolArgs.fromMap(Map<String, dynamic> map) {
    return ToolArgs(
      ...
      clientFunction: map['clientFunction'] == null ? null : ToolClientFunction.fromMap((map['clientFunction'] as Map).cast<String, dynamic>()),
      dataStoreTool: map['dataStoreTool'] == null ? null : ToolDataStoreTool.fromMap((map['dataStoreTool'] as Map).cast<String, dynamic>()),
      executionType: map['executionType'] == null ? null : map['executionType'] as String,
      googleSearchTool: map['googleSearchTool'] == null ? null : ToolGoogleSearchTool.fromMap((map['googleSearchTool'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pythonFunction: map['pythonFunction'] == null ? null : ToolPythonFunction.fromMap((map['pythonFunction'] as Map).cast<String, dynamic>()),
