...
class AppVersionSnapshotApp {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audioProcessingConfigs': ?audioProcessingConfigs == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotAppAudioProcessingConfig,
              Map<String, dynamic>
            >(audioProcessingConfigs!, (value) => value.toMap()),
      'clientCertificateSettings': ?clientCertificateSettings == null
          ? null
          : pulumi.Input.encodeList<
      ...
      'dataStoreSettings': ?dataStoreSettings == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotAppDataStoreSetting,
              Map<String, dynamic>
            >(dataStoreSettings!, (value) => value.toMap()),
      'defaultChannelProfiles': ?defaultChannelProfiles == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotAppDefaultChannelProfile,
              Map<String, dynamic>
            >(defaultChannelProfiles!, (value) => value.toMap()),
      'deploymentCount': ?deploymentCount,
      'description': ?description,
      'displayName': ?displayName,
      'etag': ?etag,
      'evaluationMetricsThresholds': ?evaluationMetricsThresholds == null
          ? null
          : pulumi.Input.encodeList<
      ...
      'variableDeclarations': ?variableDeclarations == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotAppVariableDeclaration,
              Map<String, dynamic>
            >(variableDeclarations!, (value) => value.toMap()),
    };
  }
  ...
  factory AppVersionSnapshotApp.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotApp(
      ...
      deploymentCount: map['deploymentCount'] == null
          ? null
          : map['deploymentCount'] as int,
