...
class AppAudioProcessingConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ambientSoundConfig': ?ambientSoundConfig == null
          ? null
          : ambientSoundConfig!.toMap(),
      'bargeInConfig': ?bargeInConfig == null ? null : bargeInConfig!.toMap(),
      'inactivityTimeout': ?inactivityTimeout,
      'synthesizeSpeechConfigs': ?synthesizeSpeechConfigs == null
          ? null
          : pulumi.Input.encodeList<
              AppAudioProcessingConfigSynthesizeSpeechConfig,
              Map<String, dynamic>
            >(synthesizeSpeechConfigs!, (value) => value.toMap()),
    };
  }
