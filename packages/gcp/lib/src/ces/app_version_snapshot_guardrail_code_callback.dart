...
class AppVersionSnapshotGuardrailCodeCallback {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'afterAgentCallbacks': ?afterAgentCallbacks == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotGuardrailCodeCallbackAfterAgentCallback,
              Map<String, dynamic>
            >(afterAgentCallbacks!, (value) => value.toMap()),
      'afterModelCallbacks': ?afterModelCallbacks == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotGuardrailCodeCallbackAfterModelCallback,
              Map<String, dynamic>
            >(afterModelCallbacks!, (value) => value.toMap()),
      'beforeAgentCallbacks': ?beforeAgentCallbacks == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotGuardrailCodeCallbackBeforeAgentCallback,
              Map<String, dynamic>
            >(beforeAgentCallbacks!, (value) => value.toMap()),
      'beforeModelCallbacks': ?beforeModelCallbacks == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotGuardrailCodeCallbackBeforeModelCallback,
              Map<String, dynamic>
            >(beforeModelCallbacks!, (value) => value.toMap()),
    };
  }
      ...
      afterAgentCallbacks: map['afterAgentCallbacks'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  AppVersionSnapshotGuardrailCodeCallbackAfterAgentCallback.fromMap(
      ...
      afterModelCallbacks: map['afterModelCallbacks'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  AppVersionSnapshotGuardrailCodeCallbackAfterModelCallback.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      beforeAgentCallbacks: map['beforeAgentCallbacks'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  AppVersionSnapshotGuardrailCodeCallbackBeforeAgentCallback.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      beforeModelCallbacks: map['beforeModelCallbacks'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  AppVersionSnapshotGuardrailCodeCallbackBeforeModelCallback.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
    );
