  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'expectationLevelMetricsThresholds':
          ...
          ? null
          : expectationLevelMetricsThresholds!.toMap(),
      'turnLevelMetricsThresholds': ?turnLevelMetricsThresholds == null
          ? null
          : turnLevelMetricsThresholds!.toMap(),
    };
  }
    ...
    return AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholds(
      expectationLevelMetricsThresholds:
          ...
          : AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsExpectationLevelMetricsThresholds.fromMap(
              (map['expectationLevelMetricsThresholds'] as Map)
                  .cast<String, dynamic>(),
            ),
      turnLevelMetricsThresholds: map['turnLevelMetricsThresholds'] == null
          ...
          : AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsTurnLevelMetricsThresholds.fromMap(
              (map['turnLevelMetricsThresholds'] as Map)
                  .cast<String, dynamic>(),
            ),
    );
  }
