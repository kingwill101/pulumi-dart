...
class AppVersionSnapshotAppLoggingSetting {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audioRecordingConfigs': ?audioRecordingConfigs == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotAppLoggingSettingAudioRecordingConfig,
              Map<String, dynamic>
            >(audioRecordingConfigs!, (value) => value.toMap()),
      ...
      'redactionConfigs': ?redactionConfigs == null
          ? null
          : pulumi.Input.encodeList<
              AppVersionSnapshotAppLoggingSettingRedactionConfig,
              Map<String, dynamic>
            >(redactionConfigs!, (value) => value.toMap()),
    };
  }
