...
class AppArgs {
  ...
  AppArgs({
    ...
    List<AppVariableDeclaration>? variableDeclarations,
       ...
       globalInstruction = pulumi.Input.asOptionalInput<String>(
         globalInstruction,
       ),
       guardrails = pulumi.Input.asOptionalInput<List<String>>(guardrails),
       languageSettings = pulumi.Input.asOptionalInput<AppLanguageSettings>(
         languageSettings,
       ),
       location = pulumi.Input.asInput<String>(location),
       loggingSettings = pulumi.Input.asOptionalInput<AppLoggingSettings>(
         loggingSettings,
       ),
       metadata = pulumi.Input.asOptionalInput<Map<String, String>>(metadata),
       modelSettings = pulumi.Input.asOptionalInput<AppModelSettings>(
         modelSettings,
       ),
       pinned = pulumi.Input.asOptionalInput<bool>(pinned),
       project = pulumi.Input.asOptionalInput<String>(project),
       rootAgent = pulumi.Input.asOptionalInput<String>(rootAgent),
       timeZoneSettings = pulumi.Input.asOptionalInput<AppTimeZoneSettings>(
         timeZoneSettings,
       ),
    ...
    return AppArgs(
      ...
      clientCertificateSettings: map['clientCertificateSettings'] == null
          ...
          : AppClientCertificateSettings.fromMap(
              (map['clientCertificateSettings'] as Map).cast<String, dynamic>(),
            ),
