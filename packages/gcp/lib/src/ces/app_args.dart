...
class AppArgs {
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      audioProcessingConfig: map['audioProcessingConfig'] == null ? null : AppAudioProcessingConfig.fromMap((map['audioProcessingConfig'] as Map).cast<String, dynamic>()),
      clientCertificateSettings: map['clientCertificateSettings'] == null ? null : AppClientCertificateSettings.fromMap((map['clientCertificateSettings'] as Map).cast<String, dynamic>()),
      dataStoreSettings: map['dataStoreSettings'] == null ? null : AppDataStoreSettings.fromMap((map['dataStoreSettings'] as Map).cast<String, dynamic>()),
      defaultChannelProfile: map['defaultChannelProfile'] == null ? null : AppDefaultChannelProfile.fromMap((map['defaultChannelProfile'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      evaluationMetricsThresholds: map['evaluationMetricsThresholds'] == null ? null : AppEvaluationMetricsThresholds.fromMap((map['evaluationMetricsThresholds'] as Map).cast<String, dynamic>()),
      globalInstruction: map['globalInstruction'] == null ? null : map['globalInstruction'] as String,
      guardrails: map['guardrails'] == null ? null : (map['guardrails'] as List).cast<String>(),
      languageSettings: map['languageSettings'] == null ? null : AppLanguageSettings.fromMap((map['languageSettings'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      loggingSettings: map['loggingSettings'] == null ? null : AppLoggingSettings.fromMap((map['loggingSettings'] as Map).cast<String, dynamic>()),
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      modelSettings: map['modelSettings'] == null ? null : AppModelSettings.fromMap((map['modelSettings'] as Map).cast<String, dynamic>()),
      pinned: map['pinned'] == null ? null : map['pinned'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      rootAgent: map['rootAgent'] == null ? null : map['rootAgent'] as String,
      timeZoneSettings: map['timeZoneSettings'] == null ? null : AppTimeZoneSettings.fromMap((map['timeZoneSettings'] as Map).cast<String, dynamic>()),
      variableDeclarations: map['variableDeclarations'] == null ? null : pulumi.Input.decodeList<AppVariableDeclaration>(map['variableDeclarations'], (value) => AppVariableDeclaration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
