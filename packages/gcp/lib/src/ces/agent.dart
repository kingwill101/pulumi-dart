...
class Agent extends pulumi.CustomResource {
  ...
  Agent(String name, {AgentArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.afterAgentCallbacks = registerOutput<List<AgentAfterAgentCallback>?>(
      'afterAgentCallbacks',
    );
    this.afterModelCallbacks = registerOutput<List<AgentAfterModelCallback>?>(
      'afterModelCallbacks',
    );
    this.afterToolCallbacks = registerOutput<List<AgentAfterToolCallback>?>(
      'afterToolCallbacks',
    );
    this.agentId = registerOutput<String?>('agentId');
    this.app = registerOutput<String>('app');
    this.beforeAgentCallbacks = registerOutput<List<AgentBeforeAgentCallback>?>(
      'beforeAgentCallbacks',
    );
    this.beforeModelCallbacks = registerOutput<List<AgentBeforeModelCallback>?>(
      'beforeModelCallbacks',
    );
    this.beforeToolCallbacks = registerOutput<List<AgentBeforeToolCallback>?>(
      'beforeToolCallbacks',
    );
    ...
    this.remoteDialogflowAgent = registerOutput<AgentRemoteDialogflowAgent?>(
      'remoteDialogflowAgent',
    );
