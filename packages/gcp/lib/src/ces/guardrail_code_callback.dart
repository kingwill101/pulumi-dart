  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'afterAgentCallback': ?afterAgentCallback == null
          ? null
          : afterAgentCallback!.toMap(),
      'afterModelCallback': ?afterModelCallback == null
          ? null
          : afterModelCallback!.toMap(),
      'beforeAgentCallback': ?beforeAgentCallback == null
          ? null
          : beforeAgentCallback!.toMap(),
      'beforeModelCallback': ?beforeModelCallback == null
          ? null
          : beforeModelCallback!.toMap(),
    };
  }
