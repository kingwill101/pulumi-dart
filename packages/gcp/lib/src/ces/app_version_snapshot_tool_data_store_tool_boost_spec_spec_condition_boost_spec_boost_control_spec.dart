...
class AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpec {
  ...
  final List<AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecControlPoint>? controlPoints;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'controlPoints': ?controlPoints == null ? null : pulumi.Input.encodeList<AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecControlPoint, Map<String, dynamic>>(controlPoints!, (value) => value.toMap()),
      'fieldName': ?fieldName,
