...
class App extends pulumi.CustomResource {
  ...
  App(String name, {AppArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.audioProcessingConfig = registerOutput<AppAudioProcessingConfig?>(
      'audioProcessingConfig',
    );
    ...
    this.dataStoreSettings = registerOutput<AppDataStoreSettings?>(
      'dataStoreSettings',
    );
    this.defaultChannelProfile = registerOutput<AppDefaultChannelProfile?>(
      'defaultChannelProfile',
    );
    ...
    this.languageSettings = registerOutput<AppLanguageSettings?>(
      'languageSettings',
    );
    this.location = registerOutput<String>('location');
    this.loggingSettings = registerOutput<AppLoggingSettings?>(
      'loggingSettings',
    );
    ...
    this.timeZoneSettings = registerOutput<AppTimeZoneSettings?>(
      'timeZoneSettings',
    );
    this.updateTime = registerOutput<String>('updateTime');
    this.variableDeclarations = registerOutput<List<AppVariableDeclaration>?>(
      'variableDeclarations',
    );
  }
}
