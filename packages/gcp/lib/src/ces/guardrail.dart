...
class Guardrail extends pulumi.CustomResource {
  ...
  Guardrail(
    ...
    this.contentFilter = registerOutput<GuardrailContentFilter?>('contentFilter');
    ...
    this.llmPromptSecurity = registerOutput<GuardrailLlmPromptSecurity?>('llmPromptSecurity');
