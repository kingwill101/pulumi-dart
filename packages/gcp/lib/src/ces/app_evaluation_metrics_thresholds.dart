...
class AppEvaluationMetricsThresholds {
  ...
  AppEvaluationMetricsThresholds({this.goldenEvaluationMetricsThresholds});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'goldenEvaluationMetricsThresholds':
          ...
          ? null
          : goldenEvaluationMetricsThresholds!.toMap(),
    };
  }
  ...
  factory AppEvaluationMetricsThresholds.fromMap(Map<String, dynamic> map) {
    return AppEvaluationMetricsThresholds(
      goldenEvaluationMetricsThresholds:
          ...
          ? null
          : AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholds.fromMap(
              (map['goldenEvaluationMetricsThresholds'] as Map)
                  .cast<String, dynamic>(),
            ),
    );
  }
