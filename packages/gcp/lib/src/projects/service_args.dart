...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      checkIfServiceHasUsageOnDestroy: map['checkIfServiceHasUsageOnDestroy'] == null ? null : map['checkIfServiceHasUsageOnDestroy'] as bool,
      disableDependentServices: map['disableDependentServices'] == null ? null : map['disableDependentServices'] as bool,
      disableOnDestroy: map['disableOnDestroy'] == null ? null : map['disableOnDestroy'] as bool,
