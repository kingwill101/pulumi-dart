...
class AppEngineServiceIamMemberCondition {
  ...
  /// Creates a new [AppEngineServiceIamMemberCondition].
  ...
  factory AppEngineServiceIamMemberCondition.fromMap(Map<String, dynamic> map) {
    return AppEngineServiceIamMemberCondition(
