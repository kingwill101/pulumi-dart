...
class WebForwardingRuleServiceIamBindingArgs {
  ...
  WebForwardingRuleServiceIamBindingArgs({
    WebForwardingRuleServiceIamBindingCondition? condition,
  ...
  factory WebForwardingRuleServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WebForwardingRuleServiceIamBindingArgs(
      condition: map['condition'] == null ? null : WebForwardingRuleServiceIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
