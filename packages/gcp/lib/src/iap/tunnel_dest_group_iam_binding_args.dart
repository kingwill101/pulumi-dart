...
/// {@template pulumi_iap_tunnel_dest_group_iam_binding_tunnel_dest_group_iam_binding_args_doc}
/// The set of arguments for TunnelDestGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_iap_tunnel_dest_group_iam_binding_tunnel_dest_group_iam_binding_args_doc}
class TunnelDestGroupIamBindingArgs {
  ...
  /// Creates a new [TunnelDestGroupIamBindingArgs].
  ...
  TunnelDestGroupIamBindingArgs({
    TunnelDestGroupIamBindingCondition? condition,
  ...
  factory TunnelDestGroupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TunnelDestGroupIamBindingArgs(
      condition: map['condition'] == null ? null : TunnelDestGroupIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
