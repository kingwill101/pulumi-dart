...
class WebForwardingRuleServiceIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebForwardingRuleServiceIamMemberCondition?> condition;
  ...
  /// Creates a new [WebForwardingRuleServiceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebForwardingRuleServiceIamMember]. {@macro pulumi_iap_web_forwarding_rule_service_iam_member_web_forwarding_rule_service_iam_member_args_doc}
  ...
  WebForwardingRuleServiceIamMember(
    ...
    this.condition = registerOutput<WebForwardingRuleServiceIamMemberCondition?>('condition');
    this.etag = registerOutput<String>('etag');
    this.forwardingRuleServiceName = registerOutput<String>('forwardingRuleServiceName');
