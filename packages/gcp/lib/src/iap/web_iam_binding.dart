...
class WebIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebIamBindingCondition?> condition;
  ...
  /// Creates a new [WebIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebIamBinding]. {@macro pulumi_iap_web_iam_binding_web_iam_binding_args_doc}
  ...
  WebIamBinding(
    ...
    this.condition = registerOutput<WebIamBindingCondition?>('condition');
