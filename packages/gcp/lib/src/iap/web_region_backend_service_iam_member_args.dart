...
import 'web_region_backend_service_iam_member_condition.dart';

/// {@template pulumi_iap_web_region_backend_service_iam_member_web_region_backend_service_iam_member_args_doc}
/// The set of arguments for WebRegionBackendServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_iap_web_region_backend_service_iam_member_web_region_backend_service_iam_member_args_doc}
class WebRegionBackendServiceIamMemberArgs {
  ...
  /// Creates a new [WebRegionBackendServiceIamMemberArgs].
  ...
  WebRegionBackendServiceIamMemberArgs({
    WebRegionBackendServiceIamMemberCondition? condition,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<WebRegionBackendServiceIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'member': member,
      'project': ?project,
      'region': ?region,
      'role': role,
  ...
  factory WebRegionBackendServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WebRegionBackendServiceIamMemberArgs(
      condition: map['condition'] == null ? null : WebRegionBackendServiceIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
