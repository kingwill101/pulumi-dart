...
/// {@template pulumi_iap_web_backend_service_iam_member_web_backend_service_iam_member_args_doc}
/// The set of arguments for WebBackendServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_iap_web_backend_service_iam_member_web_backend_service_iam_member_args_doc}
class WebBackendServiceIamMemberArgs {
  ...
  /// Creates a new [WebBackendServiceIamMemberArgs].
  ...
  WebBackendServiceIamMemberArgs({
    WebBackendServiceIamMemberCondition? condition,
  ...
  factory WebBackendServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WebBackendServiceIamMemberArgs(
      condition: map['condition'] == null ? null : WebBackendServiceIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
