...
class TunnelInstanceIAMBindingArgs {
  ...
  TunnelInstanceIAMBindingArgs({
    TunnelInstanceIAMBindingCondition? condition,
  ...
  factory TunnelInstanceIAMBindingArgs.fromMap(Map<String, dynamic> map) {
    return TunnelInstanceIAMBindingArgs(
      condition: map['condition'] == null ? null : TunnelInstanceIAMBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
