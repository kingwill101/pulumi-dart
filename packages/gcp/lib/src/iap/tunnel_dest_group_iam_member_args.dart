...
/// {@template pulumi_iap_tunnel_dest_group_iam_member_tunnel_dest_group_iam_member_args_doc}
/// The set of arguments for TunnelDestGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_iap_tunnel_dest_group_iam_member_tunnel_dest_group_iam_member_args_doc}
class TunnelDestGroupIamMemberArgs {
  ...
  /// Creates a new [TunnelDestGroupIamMemberArgs].
  ...
  TunnelDestGroupIamMemberArgs({
    TunnelDestGroupIamMemberCondition? condition,
  ...
  factory TunnelDestGroupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return TunnelDestGroupIamMemberArgs(
      condition: map['condition'] == null ? null : TunnelDestGroupIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
