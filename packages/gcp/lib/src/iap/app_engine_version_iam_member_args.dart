...
/// {@template pulumi_iap_app_engine_version_iam_member_app_engine_version_iam_member_args_doc}
/// The set of arguments for AppEngineVersionIamMember.
/// {@endtemplate}
/// {@macro pulumi_iap_app_engine_version_iam_member_app_engine_version_iam_member_args_doc}
class AppEngineVersionIamMemberArgs {
  ...
  /// Creates a new [AppEngineVersionIamMemberArgs].
  ...
  AppEngineVersionIamMemberArgs({
    ...
    AppEngineVersionIamMemberCondition? condition,
  ...
  factory AppEngineVersionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return AppEngineVersionIamMemberArgs(
      ...
      condition: map['condition'] == null ? null : AppEngineVersionIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
