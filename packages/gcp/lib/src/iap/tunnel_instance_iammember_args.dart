...
class TunnelInstanceIAMMemberArgs {
  ...
  TunnelInstanceIAMMemberArgs({
    TunnelInstanceIAMMemberCondition? condition,
  ...
  factory TunnelInstanceIAMMemberArgs.fromMap(Map<String, dynamic> map) {
    return TunnelInstanceIAMMemberArgs(
      condition: map['condition'] == null ? null : TunnelInstanceIAMMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
