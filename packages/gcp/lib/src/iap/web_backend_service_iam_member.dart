...
class WebBackendServiceIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebBackendServiceIamMemberCondition?> condition;
  ...
  /// Creates a new [WebBackendServiceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebBackendServiceIamMember]. {@macro pulumi_iap_web_backend_service_iam_member_web_backend_service_iam_member_args_doc}
  ...
  WebBackendServiceIamMember(
    ...
    this.condition = registerOutput<WebBackendServiceIamMemberCondition?>('condition');
