...
class WebCloudRunServiceIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [WebCloudRunServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebCloudRunServiceIamBinding]. {@macro pulumi_iap_web_cloud_run_service_iam_binding_web_cloud_run_service_iam_binding_args_doc}
  ...
  WebCloudRunServiceIamBinding(
    ...
    this.condition = registerOutput<WebCloudRunServiceIamBindingCondition?>(
      'condition',
    );
