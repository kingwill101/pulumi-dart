...
class SettingsArgs {
  ...
  factory SettingsArgs.fromMap(Map<String, dynamic> map) {
    return SettingsArgs(
      accessSettings: map['accessSettings'] == null ? null : SettingsAccessSettings.fromMap((map['accessSettings'] as Map).cast<String, dynamic>()),
      applicationSettings: map['applicationSettings'] == null ? null : SettingsApplicationSettings.fromMap((map['applicationSettings'] as Map).cast<String, dynamic>()),
