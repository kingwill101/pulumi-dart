...
class SettingsApplicationSettingsCsmSettings {
  ...
  SettingsApplicationSettingsCsmSettings({this.rctokenAud});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'rctokenAud': ?rctokenAud};
  }
  ...
  factory SettingsApplicationSettingsCsmSettings.fromMap(
    ...
    return SettingsApplicationSettingsCsmSettings(
      rctokenAud: map['rctokenAud'] == null
          ? null
          : map['rctokenAud'] as String,
    );
  }
}
