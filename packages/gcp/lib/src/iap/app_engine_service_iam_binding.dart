...
import 'app_engine_service_iam_binding_args.dart';
...
class AppEngineServiceIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AppEngineServiceIamBindingCondition?> condition;
  ...
  /// Creates a new [AppEngineServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppEngineServiceIamBinding]. {@macro pulumi_iap_app_engine_service_iam_binding_app_engine_service_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AppEngineServiceIamBinding(
    String name, {
    AppEngineServiceIamBindingArgs? args,
    ...
    this.condition = registerOutput<AppEngineServiceIamBindingCondition?>('condition');
