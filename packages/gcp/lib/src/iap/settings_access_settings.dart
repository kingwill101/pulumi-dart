...
class SettingsAccessSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedDomainsSettings': ?allowedDomainsSettings == null
          ? null
          : allowedDomainsSettings!.toMap(),
      ...
      'reauthSettings': ?reauthSettings == null
          ? null
          : reauthSettings!.toMap(),
      'workforceIdentitySettings': ?workforceIdentitySettings == null
          ? null
          : workforceIdentitySettings!.toMap(),
    };
  }
    ...
    return SettingsAccessSettings(
      ...
      workforceIdentitySettings: map['workforceIdentitySettings'] == null
          ...
          : SettingsAccessSettingsWorkforceIdentitySettings.fromMap(
              (map['workforceIdentitySettings'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
