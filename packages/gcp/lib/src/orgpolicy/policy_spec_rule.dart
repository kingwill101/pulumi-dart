...
class PolicySpecRule {
  ...
  factory PolicySpecRule.fromMap(Map<String, dynamic> map) {
    return PolicySpecRule(
      ...
      condition: map['condition'] == null ? null : PolicySpecRuleCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      ...
      values: map['values'] == null ? null : PolicySpecRuleValues.fromMap((map['values'] as Map).cast<String, dynamic>()),
    );
  }
}
