...
class PolicyArgs {
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      dryRunSpec: map['dryRunSpec'] == null ? null : PolicyDryRunSpec.fromMap((map['dryRunSpec'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      parent: map['parent'] as String,
      spec: map['spec'] == null ? null : PolicySpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
