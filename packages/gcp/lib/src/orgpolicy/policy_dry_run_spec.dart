...
class PolicyDryRunSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reset': ?reset,
      'rules': ?rules == null ? null : pulumi.Input.encodeList<PolicyDryRunSpecRule, Map<String, dynamic>>(rules!, (value) => value.toMap()),
  ...
  factory PolicyDryRunSpec.fromMap(Map<String, dynamic> map) {
    return PolicyDryRunSpec(
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<PolicyDryRunSpecRule>(map['rules'], (value) => PolicyDryRunSpecRule.fromMap((value as Map).cast<String, dynamic>())),
