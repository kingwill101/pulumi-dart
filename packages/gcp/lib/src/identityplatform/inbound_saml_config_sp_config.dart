...
class InboundSamlConfigSpConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spCertificates': ?spCertificates == null
          ? null
          : pulumi.Input.encodeList<
              InboundSamlConfigSpConfigSpCertificate,
              Map<String, dynamic>
            >(spCertificates!, (value) => value.toMap()),
  ...
  factory InboundSamlConfigSpConfig.fromMap(Map<String, dynamic> map) {
    return InboundSamlConfigSpConfig(
      callbackUri: map['callbackUri'] == null
          ? null
          : map['callbackUri'] as String,
      ...
      spEntityId: map['spEntityId'] == null
          ? null
          : map['spEntityId'] as String,
    );
  }
}
