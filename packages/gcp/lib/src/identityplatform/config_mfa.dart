...
class ConfigMfa {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'providerConfigs': ?providerConfigs == null ? null : pulumi.Input.encodeList<ConfigMfaProviderConfig, Map<String, dynamic>>(providerConfigs!, (value) => value.toMap()),
      'state': ?state,
    };
  }
  ...
  factory ConfigMfa.fromMap(Map<String, dynamic> map) {
    return ConfigMfa(
      enabledProviders: map['enabledProviders'] == null ? null : (map['enabledProviders'] as List).cast<String>(),
      providerConfigs: map['providerConfigs'] == null ? null : pulumi.Input.decodeList<ConfigMfaProviderConfig>(map['providerConfigs'], (value) => ConfigMfaProviderConfig.fromMap((value as Map).cast<String, dynamic>())),
