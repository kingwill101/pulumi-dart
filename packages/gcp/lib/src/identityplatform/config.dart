...
class Config extends pulumi.CustomResource {
  ...
  Config(String name, {ConfigArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.autodeleteAnonymousUsers = registerOutput<bool?>(
      'autodeleteAnonymousUsers',
    );
    this.blockingFunctions = registerOutput<ConfigBlockingFunctions?>(
      'blockingFunctions',
    );
    ...
    this.smsRegionConfig = registerOutput<ConfigSmsRegionConfig>(
      'smsRegionConfig',
    );
  }
}
