...
class InboundSamlConfigArgs {
  ...
  factory InboundSamlConfigArgs.fromMap(Map<String, dynamic> map) {
    return InboundSamlConfigArgs(
      ...
      idpConfig: InboundSamlConfigIdpConfig.fromMap((map['idpConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      spConfig: InboundSamlConfigSpConfig.fromMap((map['spConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
