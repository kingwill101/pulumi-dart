...
class ConfigArgs {
  ...
  ConfigArgs({
    ...
    ConfigBlockingFunctions? blockingFunctions,
    ConfigClient? client,
    ConfigMfa? mfa,
    ConfigMonitoring? monitoring,
    ConfigMultiTenant? multiTenant,
    String? project,
    ConfigQuota? quota,
    ConfigSignIn? signIn,
    ConfigSmsRegionConfig? smsRegionConfig,
  }) : authorizedDomains = pulumi.Input.asOptionalInput<List<String>>(
         authorizedDomains,
       ),
       autodeleteAnonymousUsers = pulumi.Input.asOptionalInput<bool>(
         autodeleteAnonymousUsers,
       ),
       blockingFunctions = pulumi
           .Input.asOptionalInput<ConfigBlockingFunctions>(blockingFunctions),
       ...
       multiTenant = pulumi.Input.asOptionalInput<ConfigMultiTenant>(
         multiTenant,
       ),
