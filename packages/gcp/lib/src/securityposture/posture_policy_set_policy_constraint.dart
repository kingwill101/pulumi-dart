...
class PosturePolicySetPolicyConstraint {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'orgPolicyConstraint': ?orgPolicyConstraint == null
          ? null
          : orgPolicyConstraint!.toMap(),
      'orgPolicyConstraintCustom': ?orgPolicyConstraintCustom == null
          ? null
          : orgPolicyConstraintCustom!.toMap(),
      'securityHealthAnalyticsCustomModule':
          ?securityHealthAnalyticsCustomModule == null
          ? null
          : securityHealthAnalyticsCustomModule!.toMap(),
      'securityHealthAnalyticsModule': ?securityHealthAnalyticsModule == null
          ? null
          : securityHealthAnalyticsModule!.toMap(),
    };
  }
    ...
    return PosturePolicySetPolicyConstraint(
      ...
      orgPolicyConstraintCustom: map['orgPolicyConstraintCustom'] == null
          ...
          : PosturePolicySetPolicyConstraintOrgPolicyConstraintCustom.fromMap(
              (map['orgPolicyConstraintCustom'] as Map).cast<String, dynamic>(),
            ),
      securityHealthAnalyticsCustomModule:
          map['securityHealthAnalyticsCustomModule'] == null
          ? null
          : PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModule.fromMap(
              (map['securityHealthAnalyticsCustomModule'] as Map)
                  .cast<String, dynamic>(),
            ),
      securityHealthAnalyticsModule:
          ...
          : PosturePolicySetPolicyConstraintSecurityHealthAnalyticsModule.fromMap(
              (map['securityHealthAnalyticsModule'] as Map)
                  .cast<String, dynamic>(),
            ),
    );
  }
