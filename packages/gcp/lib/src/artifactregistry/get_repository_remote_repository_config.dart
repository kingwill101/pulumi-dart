    ...
    return <String, dynamic>{
      'aptRepositories':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(aptRepositories, (value) => value.toMap()),
      'commonRepositories':
          pulumi.Input.encodeList<
            GetRepositoryRemoteRepositoryConfigCommonRepository,
            Map<String, dynamic>
          >(commonRepositories, (value) => value.toMap()),
      ...
      'yumRepositories':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(yumRepositories, (value) => value.toMap()),
    };
  }
