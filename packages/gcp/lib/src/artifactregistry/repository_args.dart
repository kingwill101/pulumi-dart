...
class RepositoryArgs {
  ...
  RepositoryArgs({
    ...
    RepositoryVulnerabilityScanningConfig? vulnerabilityScanningConfig,
            ...
            pulumi.Input.asOptionalInput<List<RepositoryCleanupPolicy>>(
                cleanupPolicies),
        cleanupPolicyDryRun =
            pulumi.Input.asOptionalInput<bool>(cleanupPolicyDryRun),
        description = pulumi.Input.asOptionalInput<String>(description),
        dockerConfig =
            pulumi.Input.asOptionalInput<RepositoryDockerConfig>(dockerConfig),
        format = pulumi.Input.asInput<String>(format),
        kmsKeyName = pulumi.Input.asOptionalInput<String>(kmsKeyName),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        location = pulumi.Input.asOptionalInput<String>(location),
        mavenConfig =
            pulumi.Input.asOptionalInput<RepositoryMavenConfig>(mavenConfig),
        mode = pulumi.Input.asOptionalInput<String>(mode),
        project = pulumi.Input.asOptionalInput<String>(project),
        remoteRepositoryConfig =
            pulumi.Input.asOptionalInput<RepositoryRemoteRepositoryConfig>(
                remoteRepositoryConfig),
        repositoryId = pulumi.Input.asInput<String>(repositoryId),
        virtualRepositoryConfig =
            pulumi.Input.asOptionalInput<RepositoryVirtualRepositoryConfig>(
                virtualRepositoryConfig),
        vulnerabilityScanningConfig =
            pulumi.Input.asOptionalInput<RepositoryVulnerabilityScanningConfig>(
                vulnerabilityScanningConfig);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (cleanupPoliciesValue != null) {
      map['cleanupPolicies'] = pulumi.Input.mapOptionalInputValue<
              List<RepositoryCleanupPolicy>, List<Map<String, dynamic>>>(
          cleanupPoliciesValue,
          (value) => pulumi.Input.encodeList<RepositoryCleanupPolicy,
    ...
    if (vulnerabilityScanningConfigValue != null) {
      map['vulnerabilityScanningConfig'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory RepositoryArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryArgs(
      ...
      vulnerabilityScanningConfig: map['vulnerabilityScanningConfig'] == null
          ? null
          : RepositoryVulnerabilityScanningConfig.fromMap(
              (map['vulnerabilityScanningConfig'] as Map)
                  .cast<String, dynamic>()),
    );
  }
}
