...
class RepositoryArgs {
  ...
  RepositoryArgs({
    List<RepositoryCleanupPolicy>? cleanupPolicies,
    bool? cleanupPolicyDryRun,
    String? description,
    RepositoryDockerConfig? dockerConfig,
    required String format,
    String? kmsKeyName,
    Map<String, String>? labels,
    String? location,
    RepositoryMavenConfig? mavenConfig,
    String? mode,
    String? project,
    RepositoryRemoteRepositoryConfig? remoteRepositoryConfig,
    required String repositoryId,
    RepositoryVirtualRepositoryConfig? virtualRepositoryConfig,
    RepositoryVulnerabilityScanningConfig? vulnerabilityScanningConfig,
  }) :
  ...
  factory RepositoryArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryArgs(
      cleanupPolicies: map['cleanupPolicies'] == null ? null : pulumi.Input.decodeList<RepositoryCleanupPolicy>(map['cleanupPolicies'], (value) => RepositoryCleanupPolicy.fromMap((value as Map).cast<String, dynamic>())),
      cleanupPolicyDryRun: map['cleanupPolicyDryRun'] == null ? null : map['cleanupPolicyDryRun'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      dockerConfig: map['dockerConfig'] == null ? null : RepositoryDockerConfig.fromMap((map['dockerConfig'] as Map).cast<String, dynamic>()),
      format: map['format'] as String,
      kmsKeyName: map['kmsKeyName'] == null ? null : map['kmsKeyName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      mavenConfig: map['mavenConfig'] == null ? null : RepositoryMavenConfig.fromMap((map['mavenConfig'] as Map).cast<String, dynamic>()),
      mode: map['mode'] == null ? null : map['mode'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      remoteRepositoryConfig: map['remoteRepositoryConfig'] == null ? null : RepositoryRemoteRepositoryConfig.fromMap((map['remoteRepositoryConfig'] as Map).cast<String, dynamic>()),
      repositoryId: map['repositoryId'] as String,
      virtualRepositoryConfig: map['virtualRepositoryConfig'] == null ? null : RepositoryVirtualRepositoryConfig.fromMap((map['virtualRepositoryConfig'] as Map).cast<String, dynamic>()),
      vulnerabilityScanningConfig: map['vulnerabilityScanningConfig'] == null ? null : RepositoryVulnerabilityScanningConfig.fromMap((map['vulnerabilityScanningConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
