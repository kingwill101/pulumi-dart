...
class ReferenceListArgs {
  ...
  ReferenceListArgs({
    ...
    required List<ReferenceListEntry> entries,
    required String instance,
    required String location,
    String? project,
    required String referenceListId,
    List<ReferenceListScopeInfo>? scopeInfos,
    required String syntaxType,
  }) :
      description = pulumi.Input.asInput<String>(description),
      entries = pulumi.Input.asInput<List<ReferenceListEntry>>(entries),
      instance = pulumi.Input.asInput<String>(instance),
      location = pulumi.Input.asInput<String>(location),
      project = pulumi.Input.asOptionalInput<String>(project),
      referenceListId = pulumi.Input.asInput<String>(referenceListId),
      scopeInfos = pulumi.Input.asOptionalInput<List<ReferenceListScopeInfo>>(scopeInfos),
      syntaxType = pulumi.Input.asInput<String>(syntaxType);
  ...
  factory ReferenceListArgs.fromMap(Map<String, dynamic> map) {
    return ReferenceListArgs(
      ...
      entries: pulumi.Input.decodeList<ReferenceListEntry>(map['entries'], (value) => ReferenceListEntry.fromMap((value as Map).cast<String, dynamic>())),
      instance: map['instance'] as String,
      location: map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      referenceListId: map['referenceListId'] as String,
      scopeInfos: map['scopeInfos'] == null ? null : pulumi.Input.decodeList<ReferenceListScopeInfo>(map['scopeInfos'], (value) => ReferenceListScopeInfo.fromMap((value as Map).cast<String, dynamic>())),
      syntaxType: map['syntaxType'] as String,
    );
  }
}
