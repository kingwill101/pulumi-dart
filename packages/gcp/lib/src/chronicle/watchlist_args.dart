...
class WatchlistArgs {
  ...
  WatchlistArgs({
    ...
    WatchlistWatchlistUserPreferences? watchlistUserPreferences,
      ...
      entityPopulationMechanism = pulumi.Input.asInput<WatchlistEntityPopulationMechanism>(entityPopulationMechanism),
  ...
  factory WatchlistArgs.fromMap(Map<String, dynamic> map) {
    return WatchlistArgs(
      ...
      entityPopulationMechanism: WatchlistEntityPopulationMechanism.fromMap((map['entityPopulationMechanism'] as Map).cast<String, dynamic>()),
      instance: map['instance'] as String,
      location: map['location'] as String,
      multiplyingFactor: map['multiplyingFactor'] == null ? null : map['multiplyingFactor'] as double,
      project: map['project'] == null ? null : map['project'] as String,
      watchlistId: map['watchlistId'] == null ? null : map['watchlistId'] as String,
      watchlistUserPreferences: map['watchlistUserPreferences'] == null ? null : WatchlistWatchlistUserPreferences.fromMap((map['watchlistUserPreferences'] as Map).cast<String, dynamic>()),
    );
  }
}
