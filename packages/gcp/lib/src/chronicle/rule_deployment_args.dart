...
class RuleDeploymentArgs {
  ...
  factory RuleDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return RuleDeploymentArgs(
      alerting: map['alerting'] == null ? null : map['alerting'] as bool,
      archived: map['archived'] == null ? null : map['archived'] as bool,
      ...
      runFrequency:
          map['runFrequency'] == null ? null : map['runFrequency'] as String,
    );
  }
}
