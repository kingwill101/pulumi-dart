...
class PluginArgs {
  ...
  factory PluginArgs.fromMap(Map<String, dynamic> map) {
    return PluginArgs(
      actionsConfigs: map['actionsConfigs'] == null ? null : pulumi.Input.decodeList<PluginActionsConfig>(map['actionsConfigs'], (value) => PluginActionsConfig.fromMap((value as Map).cast<String, dynamic>())),
      configTemplate: map['configTemplate'] == null ? null : PluginConfigTemplate.fromMap((map['configTemplate'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      documentation: map['documentation'] == null ? null : PluginDocumentation.fromMap((map['documentation'] as Map).cast<String, dynamic>()),
      hostingService: map['hostingService'] == null ? null : PluginHostingService.fromMap((map['hostingService'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      pluginCategory: map['pluginCategory'] == null ? null : map['pluginCategory'] as String,
