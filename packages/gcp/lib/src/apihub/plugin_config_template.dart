...
class PluginConfigTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalConfigTemplates': ?additionalConfigTemplates == null
          ? null
          : pulumi.Input.encodeList<
              PluginConfigTemplateAdditionalConfigTemplate,
              Map<String, dynamic>
            >(additionalConfigTemplates!, (value) => value.toMap()),
      'authConfigTemplate': ?authConfigTemplate == null
          ? null
          : authConfigTemplate!.toMap(),
    };
  }
