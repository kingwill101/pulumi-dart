...
class Plugin extends pulumi.CustomResource {
  ...
  Plugin(String name, {PluginArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.actionsConfigs = registerOutput<List<PluginActionsConfig>?>(
      'actionsConfigs',
    );
    this.configTemplate = registerOutput<PluginConfigTemplate>(
      'configTemplate',
    );
    ...
    this.hostingService = registerOutput<PluginHostingService?>(
      'hostingService',
    );
