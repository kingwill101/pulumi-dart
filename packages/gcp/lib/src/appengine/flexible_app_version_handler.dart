...
class FlexibleAppVersionHandler {
  ...
  factory FlexibleAppVersionHandler.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionHandler(
      ...
      script: map['script'] == null ? null : FlexibleAppVersionHandlerScript.fromMap((map['script'] as Map).cast<String, dynamic>()),
      securityLevel: map['securityLevel'] == null ? null : map['securityLevel'] as String,
      staticFiles: map['staticFiles'] == null ? null : FlexibleAppVersionHandlerStaticFiles.fromMap((map['staticFiles'] as Map).cast<String, dynamic>()),
