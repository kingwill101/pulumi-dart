...
class FlexibleAppVersionArgs {
  ...
  FlexibleAppVersionArgs({
    FlexibleAppVersionApiConfig? apiConfig,
    FlexibleAppVersionAutomaticScaling? automaticScaling,
    Map<String, String>? betaSettings,
    String? defaultExpiration,
    bool? deleteServiceOnDestroy,
    FlexibleAppVersionDeployment? deployment,
    FlexibleAppVersionEndpointsApiService? endpointsApiService,
    FlexibleAppVersionEntrypoint? entrypoint,
    Map<String, String>? envVariables,
    FlexibleAppVersionFlexibleRuntimeSettings? flexibleRuntimeSettings,
    List<FlexibleAppVersionHandler>? handlers,
    List<String>? inboundServices,
    String? instanceClass,
    required FlexibleAppVersionLivenessCheck livenessCheck,
    FlexibleAppVersionManualScaling? manualScaling,
    FlexibleAppVersionNetwork? network,
    String? nobuildFilesRegex,
    bool? noopOnDestroy,
    String? project,
    required FlexibleAppVersionReadinessCheck readinessCheck,
    FlexibleAppVersionResources? resources,
    ...
    String? versionId,
    FlexibleAppVersionVpcAccessConnector? vpcAccessConnector,
  }) :
  ...
  factory FlexibleAppVersionArgs.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionArgs(
      apiConfig: map['apiConfig'] == null ? null : FlexibleAppVersionApiConfig.fromMap((map['apiConfig'] as Map).cast<String, dynamic>()),
      automaticScaling: map['automaticScaling'] == null ? null : FlexibleAppVersionAutomaticScaling.fromMap((map['automaticScaling'] as Map).cast<String, dynamic>()),
      ...
      deleteServiceOnDestroy: map['deleteServiceOnDestroy'] == null ? null : map['deleteServiceOnDestroy'] as bool,
      deployment: map['deployment'] == null ? null : FlexibleAppVersionDeployment.fromMap((map['deployment'] as Map).cast<String, dynamic>()),
      endpointsApiService: map['endpointsApiService'] == null ? null : FlexibleAppVersionEndpointsApiService.fromMap((map['endpointsApiService'] as Map).cast<String, dynamic>()),
      entrypoint: map['entrypoint'] == null ? null : FlexibleAppVersionEntrypoint.fromMap((map['entrypoint'] as Map).cast<String, dynamic>()),
      envVariables: map['envVariables'] == null ? null : (map['envVariables'] as Map).cast<String, String>(),
      flexibleRuntimeSettings: map['flexibleRuntimeSettings'] == null ? null : FlexibleAppVersionFlexibleRuntimeSettings.fromMap((map['flexibleRuntimeSettings'] as Map).cast<String, dynamic>()),
      handlers: map['handlers'] == null ? null : pulumi.Input.decodeList<FlexibleAppVersionHandler>(map['handlers'], (value) => FlexibleAppVersionHandler.fromMap((value as Map).cast<String, dynamic>())),
      inboundServices: map['inboundServices'] == null ? null : (map['inboundServices'] as List).cast<String>(),
      instanceClass: map['instanceClass'] == null ? null : map['instanceClass'] as String,
      livenessCheck: FlexibleAppVersionLivenessCheck.fromMap((map['livenessCheck'] as Map).cast<String, dynamic>()),
      manualScaling: map['manualScaling'] == null ? null : FlexibleAppVersionManualScaling.fromMap((map['manualScaling'] as Map).cast<String, dynamic>()),
      network: map['network'] == null ? null : FlexibleAppVersionNetwork.fromMap((map['network'] as Map).cast<String, dynamic>()),
      nobuildFilesRegex: map['nobuildFilesRegex'] == null ? null : map['nobuildFilesRegex'] as String,
      noopOnDestroy: map['noopOnDestroy'] == null ? null : map['noopOnDestroy'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      readinessCheck: FlexibleAppVersionReadinessCheck.fromMap((map['readinessCheck'] as Map).cast<String, dynamic>()),
      resources: map['resources'] == null ? null : FlexibleAppVersionResources.fromMap((map['resources'] as Map).cast<String, dynamic>()),
      ...
      vpcAccessConnector: map['vpcAccessConnector'] == null ? null : FlexibleAppVersionVpcAccessConnector.fromMap((map['vpcAccessConnector'] as Map).cast<String, dynamic>()),
    );
  }
}
