...
class FlexibleAppVersionArgs {
  ...
  FlexibleAppVersionArgs({
    ...
    FlexibleAppVersionVpcAccessConnector? vpcAccessConnector,
       ...
       deleteServiceOnDestroy = pulumi.Input.asOptionalInput<bool>(
       ...
       inboundServices = pulumi.Input.asOptionalInput<List<String>>(
         inboundServices,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'handlers':
          ?pulumi.Input.mapOptionalInputValue<
            List<FlexibleAppVersionHandler>,
  ...
  factory FlexibleAppVersionArgs.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionArgs(
      ...
      flexibleRuntimeSettings: map['flexibleRuntimeSettings'] == null
          ? null
          : FlexibleAppVersionFlexibleRuntimeSettings.fromMap(
              (map['flexibleRuntimeSettings'] as Map).cast<String, dynamic>(),
            ),
      handlers: map['handlers'] == null
          ? null
          : pulumi.Input.decodeList<FlexibleAppVersionHandler>(
              map['handlers'],
              (value) => FlexibleAppVersionHandler.fromMap(
