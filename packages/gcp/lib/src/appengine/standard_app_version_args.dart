...
class StandardAppVersionArgs {
  ...
  StandardAppVersionArgs({
    ...
    StandardAppVersionVpcAccessConnector? vpcAccessConnector,
      ...
      automaticScaling = pulumi.Input.asOptionalInput<StandardAppVersionAutomaticScaling>(automaticScaling),
      basicScaling = pulumi.Input.asOptionalInput<StandardAppVersionBasicScaling>(basicScaling),
      deleteServiceOnDestroy = pulumi.Input.asOptionalInput<bool>(deleteServiceOnDestroy),
      deployment = pulumi.Input.asInput<StandardAppVersionDeployment>(deployment),
      entrypoint = pulumi.Input.asInput<StandardAppVersionEntrypoint>(entrypoint),
      envVariables = pulumi.Input.asOptionalInput<Map<String, String>>(envVariables),
      handlers = pulumi.Input.asOptionalInput<List<StandardAppVersionHandler>>(handlers),
      ...
      libraries = pulumi.Input.asOptionalInput<List<StandardAppVersionLibrary>>(libraries),
      manualScaling = pulumi.Input.asOptionalInput<StandardAppVersionManualScaling>(manualScaling),
      ...
      vpcAccessConnector = pulumi.Input.asOptionalInput<StandardAppVersionVpcAccessConnector>(vpcAccessConnector);
  ...
  factory StandardAppVersionArgs.fromMap(Map<String, dynamic> map) {
    return StandardAppVersionArgs(
      ...
      automaticScaling: map['automaticScaling'] == null ? null : StandardAppVersionAutomaticScaling.fromMap((map['automaticScaling'] as Map).cast<String, dynamic>()),
      basicScaling: map['basicScaling'] == null ? null : StandardAppVersionBasicScaling.fromMap((map['basicScaling'] as Map).cast<String, dynamic>()),
      deleteServiceOnDestroy: map['deleteServiceOnDestroy'] == null ? null : map['deleteServiceOnDestroy'] as bool,
      deployment: StandardAppVersionDeployment.fromMap((map['deployment'] as Map).cast<String, dynamic>()),
      entrypoint: StandardAppVersionEntrypoint.fromMap((map['entrypoint'] as Map).cast<String, dynamic>()),
      envVariables: map['envVariables'] == null ? null : (map['envVariables'] as Map).cast<String, String>(),
      handlers: map['handlers'] == null ? null : pulumi.Input.decodeList<StandardAppVersionHandler>(map['handlers'], (value) => StandardAppVersionHandler.fromMap((value as Map).cast<String, dynamic>())),
      ...
      libraries: map['libraries'] == null ? null : pulumi.Input.decodeList<StandardAppVersionLibrary>(map['libraries'], (value) => StandardAppVersionLibrary.fromMap((value as Map).cast<String, dynamic>())),
      manualScaling: map['manualScaling'] == null ? null : StandardAppVersionManualScaling.fromMap((map['manualScaling'] as Map).cast<String, dynamic>()),
      ...
      vpcAccessConnector: map['vpcAccessConnector'] == null ? null : StandardAppVersionVpcAccessConnector.fromMap((map['vpcAccessConnector'] as Map).cast<String, dynamic>()),
    );
  }
}
