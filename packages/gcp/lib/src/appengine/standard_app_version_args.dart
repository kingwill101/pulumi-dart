...
class StandardAppVersionArgs {
  ...
  StandardAppVersionArgs({
    ...
    StandardAppVersionVpcAccessConnector? vpcAccessConnector,
       ...
       basicScaling = pulumi
           .Input.asOptionalInput<StandardAppVersionBasicScaling>(basicScaling),
       deleteServiceOnDestroy = pulumi.Input.asOptionalInput<bool>(
         deleteServiceOnDestroy,
       ),
       deployment = pulumi.Input.asInput<StandardAppVersionDeployment>(
         deployment,
       ),
       entrypoint = pulumi.Input.asInput<StandardAppVersionEntrypoint>(
         entrypoint,
       ),
       ...
       libraries = pulumi
           .Input.asOptionalInput<List<StandardAppVersionLibrary>>(libraries),
       manualScaling =
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'handlers':
          ?pulumi.Input.mapOptionalInputValue<
            List<StandardAppVersionHandler>,
      ...
      'libraries':
          ?pulumi.Input.mapOptionalInputValue<
            List<StandardAppVersionLibrary>,
            List<Map<String, dynamic>>
          >(
            libraries,
            (value) =>
