...
class StandardAppVersionHandler {
  ...
  factory StandardAppVersionHandler.fromMap(Map<String, dynamic> map) {
    return StandardAppVersionHandler(
      ...
      redirectHttpResponseCode: map['redirectHttpResponseCode'] == null ? null : map['redirectHttpResponseCode'] as String,
      script: map['script'] == null ? null : StandardAppVersionHandlerScript.fromMap((map['script'] as Map).cast<String, dynamic>()),
      securityLevel: map['securityLevel'] == null ? null : map['securityLevel'] as String,
      staticFiles: map['staticFiles'] == null ? null : StandardAppVersionHandlerStaticFiles.fromMap((map['staticFiles'] as Map).cast<String, dynamic>()),
