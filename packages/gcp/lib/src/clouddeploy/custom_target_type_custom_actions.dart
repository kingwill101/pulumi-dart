...
class CustomTargetTypeCustomActions {
  ...
  final List<CustomTargetTypeCustomActionsIncludeSkaffoldModule>? includeSkaffoldModules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'includeSkaffoldModules': ?includeSkaffoldModules == null ? null : pulumi.Input.encodeList<CustomTargetTypeCustomActionsIncludeSkaffoldModule, Map<String, dynamic>>(includeSkaffoldModules!, (value) => value.toMap()),
  ...
  factory CustomTargetTypeCustomActions.fromMap(Map<String, dynamic> map) {
    return CustomTargetTypeCustomActions(
      ...
      includeSkaffoldModules: map['includeSkaffoldModules'] == null ? null : pulumi.Input.decodeList<CustomTargetTypeCustomActionsIncludeSkaffoldModule>(map['includeSkaffoldModules'], (value) => CustomTargetTypeCustomActionsIncludeSkaffoldModule.fromMap((value as Map).cast<String, dynamic>())),
      renderAction: map['renderAction'] == null ? null : map['renderAction'] as String,
    );
  }
}
