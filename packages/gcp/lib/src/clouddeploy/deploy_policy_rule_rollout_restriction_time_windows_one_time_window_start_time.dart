...
class DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartTime {
  ...
  /// Creates a new [DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartTime].
  ...
  factory DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartTime.fromMap(Map<String, dynamic> map) {
    return DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartTime(
