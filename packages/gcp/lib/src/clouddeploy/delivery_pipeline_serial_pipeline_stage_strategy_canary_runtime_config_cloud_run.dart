...
class DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigCloudRun {
  ...
  Map<String, dynamic> toMap() {
    ...
    final automaticTrafficControlValue = automaticTrafficControl;
    if (automaticTrafficControlValue != null) {
      map['automaticTrafficControl'] = automaticTrafficControlValue;
    }
    final canaryRevisionTagsValue = canaryRevisionTags;
    if (canaryRevisionTagsValue != null) {
      map['canaryRevisionTags'] = canaryRevisionTagsValue;
    }
    final priorRevisionTagsValue = priorRevisionTags;
    if (priorRevisionTagsValue != null) {
      map['priorRevisionTags'] = priorRevisionTagsValue;
    }
    final stableRevisionTagsValue = stableRevisionTags;
    if (stableRevisionTagsValue != null) {
      map['stableRevisionTags'] = stableRevisionTagsValue;
    }
    return map;
  }

  factory DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigCloudRun.fromMap(
    ...
    return DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigCloudRun(
      ...
      canaryRevisionTags: map['canaryRevisionTags'] == null
          ? null
          : (map['canaryRevisionTags'] as List).cast<String>(),
      priorRevisionTags: map['priorRevisionTags'] == null
          ? null
          : (map['priorRevisionTags'] as List).cast<String>(),
      stableRevisionTags: map['stableRevisionTags'] == null
          ? null
          : (map['stableRevisionTags'] as List).cast<String>(),
    );
  }
}
