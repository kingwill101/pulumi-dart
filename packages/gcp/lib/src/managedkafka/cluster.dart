...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.brokerCapacityConfig = registerOutput<ClusterBrokerCapacityConfig?>(
      'brokerCapacityConfig',
    );
    this.capacityConfig = registerOutput<ClusterCapacityConfig>(
      'capacityConfig',
    );
    ...
    this.rebalanceConfig = registerOutput<ClusterRebalanceConfig?>(
      'rebalanceConfig',
    );
