...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      brokerCapacityConfig: map['brokerCapacityConfig'] == null ? null : ClusterBrokerCapacityConfig.fromMap((map['brokerCapacityConfig'] as Map).cast<String, dynamic>()),
      capacityConfig: ClusterCapacityConfig.fromMap((map['capacityConfig'] as Map).cast<String, dynamic>()),
      clusterId: map['clusterId'] as String,
      gcpConfig: ClusterGcpConfig.fromMap((map['gcpConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rebalanceConfig: map['rebalanceConfig'] == null ? null : ClusterRebalanceConfig.fromMap((map['rebalanceConfig'] as Map).cast<String, dynamic>()),
      tlsConfig: map['tlsConfig'] == null ? null : ClusterTlsConfig.fromMap((map['tlsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
