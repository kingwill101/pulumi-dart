...
class ConnectClusterArgs {
  ...
  factory ConnectClusterArgs.fromMap(Map<String, dynamic> map) {
    return ConnectClusterArgs(
      capacityConfig: ConnectClusterCapacityConfig.fromMap((map['capacityConfig'] as Map).cast<String, dynamic>()),
      connectClusterId: map['connectClusterId'] as String,
      gcpConfig: ConnectClusterGcpConfig.fromMap((map['gcpConfig'] as Map).cast<String, dynamic>()),
