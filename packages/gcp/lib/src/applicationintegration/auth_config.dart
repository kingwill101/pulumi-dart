...
class AuthConfig extends pulumi.CustomResource {
  ...
  AuthConfig(
    ...
    this.clientCertificate = registerOutput<AuthConfigClientCertificate?>('clientCertificate');
    this.createTime = registerOutput<String>('createTime');
    this.creatorEmail = registerOutput<String>('creatorEmail');
    this.credentialType = registerOutput<String>('credentialType');
    this.decryptedCredential = registerOutput<AuthConfigDecryptedCredential?>('decryptedCredential');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.encryptedCredential = registerOutput<String>('encryptedCredential');
    this.expiryNotificationDurations = registerOutput<List<String>?>('expiryNotificationDurations');
