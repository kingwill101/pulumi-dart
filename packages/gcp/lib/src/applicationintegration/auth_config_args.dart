...
class AuthConfigArgs {
  ...
  factory AuthConfigArgs.fromMap(Map<String, dynamic> map) {
    return AuthConfigArgs(
      clientCertificate: map['clientCertificate'] == null ? null : AuthConfigClientCertificate.fromMap((map['clientCertificate'] as Map).cast<String, dynamic>()),
      decryptedCredential: map['decryptedCredential'] == null ? null : AuthConfigDecryptedCredential.fromMap((map['decryptedCredential'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      expiryNotificationDurations: map['expiryNotificationDurations'] == null ? null : (map['expiryNotificationDurations'] as List).cast<String>(),
      location: map['location'] as String,
      overrideValidTime: map['overrideValidTime'] == null ? null : map['overrideValidTime'] as String,
