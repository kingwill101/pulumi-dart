    ...
    return <String, dynamic>{
      ...
      'activeDirectoryConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(activeDirectoryConfigs, (value) => value.toMap()),
      'advancedMachineFeatures':
          pulumi.Input.encodeList<
      ...
      'backupConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(backupConfigurations, (value) => value.toMap()),
      'collation': collation,
      'connectionPoolConfigs':
          pulumi.Input.encodeList<
      ...
      'dataCacheConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(dataCacheConfigs, (value) => value.toMap()),
      ...
      'finalBackupConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(finalBackupConfigs, (value) => value.toMap()),
      'insightsConfigs':
          pulumi.Input.encodeList<
            GetDatabaseInstanceSettingInsightsConfig,
            Map<String, dynamic>
          >(insightsConfigs, (value) => value.toMap()),
      'ipConfigurations':
          pulumi.Input.encodeList<
      ...
      'locationPreferences':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(locationPreferences, (value) => value.toMap()),
      'maintenanceWindows':
          pulumi.Input.encodeList<
      ...
      'sqlServerAuditConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(sqlServerAuditConfigs, (value) => value.toMap()),
      'tier': tier,
      'timeZone': timeZone,
