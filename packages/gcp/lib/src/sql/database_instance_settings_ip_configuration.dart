...
class DatabaseInstanceSettingsIpConfiguration {
  ...
  final List<DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork>? authorizedNetworks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': ?authorizedNetworks == null ? null : pulumi.Input.encodeList<DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork, Map<String, dynamic>>(authorizedNetworks!, (value) => value.toMap()),
      ...
      'pscConfigs': ?pscConfigs == null ? null : pulumi.Input.encodeList<DatabaseInstanceSettingsIpConfigurationPscConfig, Map<String, dynamic>>(pscConfigs!, (value) => value.toMap()),
  ...
  factory DatabaseInstanceSettingsIpConfiguration.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSettingsIpConfiguration(
      ...
      authorizedNetworks: map['authorizedNetworks'] == null ? null : pulumi.Input.decodeList<DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork>(map['authorizedNetworks'], (value) => DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork.fromMap((value as Map).cast<String, dynamic>())),
      customSubjectAlternativeNames: map['customSubjectAlternativeNames'] == null ? null : (map['customSubjectAlternativeNames'] as List).cast<String>(),
      enablePrivatePathForGoogleCloudServices: map['enablePrivatePathForGoogleCloudServices'] == null ? null : map['enablePrivatePathForGoogleCloudServices'] as bool,
      ...
      pscConfigs: map['pscConfigs'] == null ? null : pulumi.Input.decodeList<DatabaseInstanceSettingsIpConfigurationPscConfig>(map['pscConfigs'], (value) => DatabaseInstanceSettingsIpConfigurationPscConfig.fromMap((value as Map).cast<String, dynamic>())),
      serverCaMode: map['serverCaMode'] == null ? null : map['serverCaMode'] as String,
      serverCaPool: map['serverCaPool'] == null ? null : map['serverCaPool'] as String,
