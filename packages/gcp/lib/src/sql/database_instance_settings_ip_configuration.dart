...
class DatabaseInstanceSettingsIpConfiguration {
  ...
  factory DatabaseInstanceSettingsIpConfiguration.fromMap(
    ...
    return DatabaseInstanceSettingsIpConfiguration(
      ...
      ipv4Enabled: map['ipv4Enabled'] == null
          ? null
          : map['ipv4Enabled'] as bool,
      ...
      serverCaMode: map['serverCaMode'] == null
          ? null
          : map['serverCaMode'] as String,
      serverCaPool: map['serverCaPool'] == null
          ? null
          : map['serverCaPool'] as String,
