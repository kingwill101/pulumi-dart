...
class DatabaseInstanceSettings {
  ...
  final DatabaseInstanceSettingsAdvancedMachineFeatures? advancedMachineFeatures;
  ...
  final List<DatabaseInstanceSettingsConnectionPoolConfig>? connectionPoolConfigs;
  ...
  final DatabaseInstanceSettingsPasswordValidationPolicy? passwordValidationPolicy;
  /// Pricing plan for this instance, can only be `PER_USE`.
  final String? pricingPlan;
  /// Configuration of Read Pool Auto Scale.
  final DatabaseInstanceSettingsReadPoolAutoScaleConfig? readPoolAutoScaleConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'activeDirectoryConfig': ?activeDirectoryConfig == null ? null : activeDirectoryConfig!.toMap(),
      ...
      'collation': ?collation,
      'connectionPoolConfigs': ?connectionPoolConfigs == null ? null : pulumi.Input.encodeList<DatabaseInstanceSettingsConnectionPoolConfig, Map<String, dynamic>>(connectionPoolConfigs!, (value) => value.toMap()),
      'connectorEnforcement': ?connectorEnforcement,
      'dataCacheConfig': ?dataCacheConfig == null ? null : dataCacheConfig!.toMap(),
      'dataDiskProvisionedIops': ?dataDiskProvisionedIops,
      'dataDiskProvisionedThroughput': ?dataDiskProvisionedThroughput,
      'databaseFlags': ?databaseFlags == null ? null : pulumi.Input.encodeList<DatabaseInstanceSettingsDatabaseFlag, Map<String, dynamic>>(databaseFlags!, (value) => value.toMap()),
      'deletionProtectionEnabled': ?deletionProtectionEnabled,
      'denyMaintenancePeriod': ?denyMaintenancePeriod == null ? null : denyMaintenancePeriod!.toMap(),
      ...
      'finalBackupConfig': ?finalBackupConfig == null ? null : finalBackupConfig!.toMap(),
      'insightsConfig': ?insightsConfig == null ? null : insightsConfig!.toMap(),
      'ipConfiguration': ?ipConfiguration == null ? null : ipConfiguration!.toMap(),
      'locationPreference': ?locationPreference == null ? null : locationPreference!.toMap(),
      'maintenanceWindow': ?maintenanceWindow == null ? null : maintenanceWindow!.toMap(),
      'passwordValidationPolicy': ?passwordValidationPolicy == null ? null : passwordValidationPolicy!.toMap(),
      'pricingPlan': ?pricingPlan,
      'readPoolAutoScaleConfig': ?readPoolAutoScaleConfig == null ? null : readPoolAutoScaleConfig!.toMap(),
      'retainBackupsOnDelete': ?retainBackupsOnDelete,
      'sqlServerAuditConfig': ?sqlServerAuditConfig == null ? null : sqlServerAuditConfig!.toMap(),
      'tier': tier,
      'timeZone': ?timeZone,
  ...
  factory DatabaseInstanceSettings.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSettings(
      ...
      activeDirectoryConfig: map['activeDirectoryConfig'] == null ? null : DatabaseInstanceSettingsActiveDirectoryConfig.fromMap((map['activeDirectoryConfig'] as Map).cast<String, dynamic>()),
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : DatabaseInstanceSettingsAdvancedMachineFeatures.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      availabilityType: map['availabilityType'] == null ? null : map['availabilityType'] as String,
      backupConfiguration: map['backupConfiguration'] == null ? null : DatabaseInstanceSettingsBackupConfiguration.fromMap((map['backupConfiguration'] as Map).cast<String, dynamic>()),
      collation: map['collation'] == null ? null : map['collation'] as String,
      connectionPoolConfigs: map['connectionPoolConfigs'] == null ? null : pulumi.Input.decodeList<DatabaseInstanceSettingsConnectionPoolConfig>(map['connectionPoolConfigs'], (value) => DatabaseInstanceSettingsConnectionPoolConfig.fromMap((value as Map).cast<String, dynamic>())),
      connectorEnforcement: map['connectorEnforcement'] == null ? null : map['connectorEnforcement'] as String,
      dataCacheConfig: map['dataCacheConfig'] == null ? null : DatabaseInstanceSettingsDataCacheConfig.fromMap((map['dataCacheConfig'] as Map).cast<String, dynamic>()),
      dataDiskProvisionedIops: map['dataDiskProvisionedIops'] == null ? null : map['dataDiskProvisionedIops'] as int,
      dataDiskProvisionedThroughput: map['dataDiskProvisionedThroughput'] == null ? null : map['dataDiskProvisionedThroughput'] as int,
      databaseFlags: map['databaseFlags'] == null ? null : pulumi.Input.decodeList<DatabaseInstanceSettingsDatabaseFlag>(map['databaseFlags'], (value) => DatabaseInstanceSettingsDatabaseFlag.fromMap((value as Map).cast<String, dynamic>())),
      deletionProtectionEnabled: map['deletionProtectionEnabled'] == null ? null : map['deletionProtectionEnabled'] as bool,
      denyMaintenancePeriod: map['denyMaintenancePeriod'] == null ? null : DatabaseInstanceSettingsDenyMaintenancePeriod.fromMap((map['denyMaintenancePeriod'] as Map).cast<String, dynamic>()),
      diskAutoresize: map['diskAutoresize'] == null ? null : map['diskAutoresize'] as bool,
      diskAutoresizeLimit: map['diskAutoresizeLimit'] == null ? null : map['diskAutoresizeLimit'] as int,
      diskSize: map['diskSize'] == null ? null : map['diskSize'] as int,
      diskType: map['diskType'] == null ? null : map['diskType'] as String,
      edition: map['edition'] == null ? null : map['edition'] as String,
      effectiveAvailabilityType: map['effectiveAvailabilityType'] == null ? null : map['effectiveAvailabilityType'] as String,
      enableDataplexIntegration: map['enableDataplexIntegration'] == null ? null : map['enableDataplexIntegration'] as bool,
      enableGoogleMlIntegration: map['enableGoogleMlIntegration'] == null ? null : map['enableGoogleMlIntegration'] as bool,
      finalBackupConfig: map['finalBackupConfig'] == null ? null : DatabaseInstanceSettingsFinalBackupConfig.fromMap((map['finalBackupConfig'] as Map).cast<String, dynamic>()),
      insightsConfig: map['insightsConfig'] == null ? null : DatabaseInstanceSettingsInsightsConfig.fromMap((map['insightsConfig'] as Map).cast<String, dynamic>()),
      ipConfiguration: map['ipConfiguration'] == null ? null : DatabaseInstanceSettingsIpConfiguration.fromMap((map['ipConfiguration'] as Map).cast<String, dynamic>()),
      locationPreference: map['locationPreference'] == null ? null : DatabaseInstanceSettingsLocationPreference.fromMap((map['locationPreference'] as Map).cast<String, dynamic>()),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : DatabaseInstanceSettingsMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      passwordValidationPolicy: map['passwordValidationPolicy'] == null ? null : DatabaseInstanceSettingsPasswordValidationPolicy.fromMap((map['passwordValidationPolicy'] as Map).cast<String, dynamic>()),
      pricingPlan: map['pricingPlan'] == null ? null : map['pricingPlan'] as String,
      readPoolAutoScaleConfig: map['readPoolAutoScaleConfig'] == null ? null : DatabaseInstanceSettingsReadPoolAutoScaleConfig.fromMap((map['readPoolAutoScaleConfig'] as Map).cast<String, dynamic>()),
      retainBackupsOnDelete: map['retainBackupsOnDelete'] == null ? null : map['retainBackupsOnDelete'] as bool,
      sqlServerAuditConfig: map['sqlServerAuditConfig'] == null ? null : DatabaseInstanceSettingsSqlServerAuditConfig.fromMap((map['sqlServerAuditConfig'] as Map).cast<String, dynamic>()),
