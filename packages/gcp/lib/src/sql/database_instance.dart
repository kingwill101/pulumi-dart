...
class DatabaseInstance extends pulumi.CustomResource {
  ...
  DatabaseInstance(
    ...
    this.finalBackupDescription = registerOutput<String?>('finalBackupDescription');
    this.firstIpAddress = registerOutput<String>('firstIpAddress');
    this.instanceType = registerOutput<String>('instanceType');
    this.ipAddresses = registerOutput<List<DatabaseInstanceIpAddress>>('ipAddresses');
    ...
    this.pointInTimeRestoreContext = registerOutput<DatabaseInstancePointInTimeRestoreContext?>('pointInTimeRestoreContext');
    this.privateIpAddress = registerOutput<String>('privateIpAddress');
    this.project = registerOutput<String>('project');
    this.pscServiceAttachmentLink = registerOutput<String>('pscServiceAttachmentLink');
    this.publicIpAddress = registerOutput<String>('publicIpAddress');
    this.region = registerOutput<String>('region');
    this.replicaConfiguration = registerOutput<DatabaseInstanceReplicaConfiguration>('replicaConfiguration');
    this.replicaNames = registerOutput<List<String>>('replicaNames');
    this.replicationCluster = registerOutput<DatabaseInstanceReplicationCluster>('replicationCluster');
    this.restoreBackupContext = registerOutput<DatabaseInstanceRestoreBackupContext?>('restoreBackupContext');
    this.rootPassword = registerOutput<String?>('rootPassword');
    this.rootPasswordWo = registerOutput<String?>('rootPasswordWo');
    this.rootPasswordWoVersion = registerOutput<String?>('rootPasswordWoVersion');
    this.selfLink = registerOutput<String>('selfLink');
    this.serverCaCerts = registerOutput<List<DatabaseInstanceServerCaCert>>('serverCaCerts');
    this.serviceAccountEmailAddress = registerOutput<String>('serviceAccountEmailAddress');
