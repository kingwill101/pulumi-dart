...
class DatabaseInstance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DatabaseInstancePointInTimeRestoreContext?>
  pointInTimeRestoreContext;
  ...
  /// configuration is detailed below.
  late final pulumi.Output<DatabaseInstanceReplicaConfiguration>
  ...
  late final pulumi.Output<DatabaseInstanceReplicationCluster>
  replicationCluster;
  ...
  late final pulumi.Output<DatabaseInstanceRestoreBackupContext?>
  ...
  DatabaseInstance(
    ...
    this.finalBackupDescription = registerOutput<String?>(
      'finalBackupDescription',
    );
    this.firstIpAddress = registerOutput<String>('firstIpAddress');
    this.instanceType = registerOutput<String>('instanceType');
    this.ipAddresses = registerOutput<List<DatabaseInstanceIpAddress>>(
      'ipAddresses',
    );
    ...
    this.pscServiceAttachmentLink = registerOutput<String>(
    ...
    this.rootPasswordWoVersion = registerOutput<String?>(
      'rootPasswordWoVersion',
    );
    this.selfLink = registerOutput<String>('selfLink');
    this.serverCaCerts = registerOutput<List<DatabaseInstanceServerCaCert>>(
      'serverCaCerts',
    );
    this.serviceAccountEmailAddress = registerOutput<String>(
