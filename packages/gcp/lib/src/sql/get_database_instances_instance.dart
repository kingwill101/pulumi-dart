...
class GetDatabaseInstancesInstance {
  ...
  final List<GetDatabaseInstancesInstancePointInTimeRestoreContext> pointInTimeRestoreContexts;
  ...
  final List<GetDatabaseInstancesInstanceReplicaConfiguration> replicaConfigurations;
  ...
  final List<GetDatabaseInstancesInstanceReplicationCluster> replicationClusters;
  final List<GetDatabaseInstancesInstanceRestoreBackupContext> restoreBackupContexts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clones': pulumi.Input.encodeList<GetDatabaseInstancesInstanceClone, Map<String, dynamic>>(clones, (value) => value.toMap()),
      'connectionName': connectionName,
      'databaseVersion': databaseVersion,
      'deletionProtection': deletionProtection,
      'dnsName': dnsName,
      'dnsNames': pulumi.Input.encodeList<GetDatabaseInstancesInstanceDnsName, Map<String, dynamic>>(dnsNames, (value) => value.toMap()),
      'encryptionKeyName': encryptionKeyName,
      'finalBackupDescription': finalBackupDescription,
      'firstIpAddress': firstIpAddress,
      'instanceType': instanceType,
      'ipAddresses': pulumi.Input.encodeList<GetDatabaseInstancesInstanceIpAddress, Map<String, dynamic>>(ipAddresses, (value) => value.toMap()),
      'maintenanceVersion': maintenanceVersion,
      'masterInstanceName': masterInstanceName,
      'name': name,
      'nodeCount': nodeCount,
      'pointInTimeRestoreContexts': pulumi.Input.encodeList<GetDatabaseInstancesInstancePointInTimeRestoreContext, Map<String, dynamic>>(pointInTimeRestoreContexts, (value) => value.toMap()),
      'privateIpAddress': privateIpAddress,
      'project': project,
      'pscServiceAttachmentLink': pscServiceAttachmentLink,
      'publicIpAddress': publicIpAddress,
      'region': region,
      'replicaConfigurations': pulumi.Input.encodeList<GetDatabaseInstancesInstanceReplicaConfiguration, Map<String, dynamic>>(replicaConfigurations, (value) => value.toMap()),
      'replicaNames': replicaNames,
      'replicationClusters': pulumi.Input.encodeList<GetDatabaseInstancesInstanceReplicationCluster, Map<String, dynamic>>(replicationClusters, (value) => value.toMap()),
      'restoreBackupContexts': pulumi.Input.encodeList<GetDatabaseInstancesInstanceRestoreBackupContext, Map<String, dynamic>>(restoreBackupContexts, (value) => value.toMap()),
      'rootPassword': rootPassword,
      'rootPasswordWo': rootPasswordWo,
      'rootPasswordWoVersion': rootPasswordWoVersion,
      'selfLink': selfLink,
      'serverCaCerts': pulumi.Input.encodeList<GetDatabaseInstancesInstanceServerCaCert, Map<String, dynamic>>(serverCaCerts, (value) => value.toMap()),
      'serviceAccountEmailAddress': serviceAccountEmailAddress,
      'settings': pulumi.Input.encodeList<GetDatabaseInstancesInstanceSetting, Map<String, dynamic>>(settings, (value) => value.toMap()),
    };
  }
  ...
  factory GetDatabaseInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstancesInstance(
      ...
      clones: pulumi.Input.decodeList<GetDatabaseInstancesInstanceClone>(map['clones'], (value) => GetDatabaseInstancesInstanceClone.fromMap((value as Map).cast<String, dynamic>())),
      connectionName: map['connectionName'] as String,
      databaseVersion: map['databaseVersion'] as String,
      deletionProtection: map['deletionProtection'] as bool,
      dnsName: map['dnsName'] as String,
      dnsNames: pulumi.Input.decodeList<GetDatabaseInstancesInstanceDnsName>(map['dnsNames'], (value) => GetDatabaseInstancesInstanceDnsName.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ipAddresses: pulumi.Input.decodeList<GetDatabaseInstancesInstanceIpAddress>(map['ipAddresses'], (value) => GetDatabaseInstancesInstanceIpAddress.fromMap((value as Map).cast<String, dynamic>())),
      maintenanceVersion: map['maintenanceVersion'] as String,
      masterInstanceName: map['masterInstanceName'] as String,
      name: map['name'] as String,
      nodeCount: map['nodeCount'] as int,
      pointInTimeRestoreContexts: pulumi.Input.decodeList<GetDatabaseInstancesInstancePointInTimeRestoreContext>(map['pointInTimeRestoreContexts'], (value) => GetDatabaseInstancesInstancePointInTimeRestoreContext.fromMap((value as Map).cast<String, dynamic>())),
      ...
      replicaConfigurations: pulumi.Input.decodeList<GetDatabaseInstancesInstanceReplicaConfiguration>(map['replicaConfigurations'], (value) => GetDatabaseInstancesInstanceReplicaConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      replicaNames: (map['replicaNames'] as List).cast<String>(),
      replicationClusters: pulumi.Input.decodeList<GetDatabaseInstancesInstanceReplicationCluster>(map['replicationClusters'], (value) => GetDatabaseInstancesInstanceReplicationCluster.fromMap((value as Map).cast<String, dynamic>())),
      restoreBackupContexts: pulumi.Input.decodeList<GetDatabaseInstancesInstanceRestoreBackupContext>(map['restoreBackupContexts'], (value) => GetDatabaseInstancesInstanceRestoreBackupContext.fromMap((value as Map).cast<String, dynamic>())),
      ...
      serverCaCerts: pulumi.Input.decodeList<GetDatabaseInstancesInstanceServerCaCert>(map['serverCaCerts'], (value) => GetDatabaseInstancesInstanceServerCaCert.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccountEmailAddress: map['serviceAccountEmailAddress'] as String,
      settings: pulumi.Input.decodeList<GetDatabaseInstancesInstanceSetting>(map['settings'], (value) => GetDatabaseInstancesInstanceSetting.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
