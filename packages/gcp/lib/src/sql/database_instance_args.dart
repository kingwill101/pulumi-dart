...
class DatabaseInstanceArgs {
  ...
  DatabaseInstanceArgs({
    ...
    DatabaseInstanceSettings? settings,
        ...
        encryptionKeyName =
            pulumi.Input.asOptionalInput<String>(encryptionKeyName),
        finalBackupDescription =
            pulumi.Input.asOptionalInput<String>(finalBackupDescription),
        instanceType = pulumi.Input.asOptionalInput<String>(instanceType),
        maintenanceVersion =
            pulumi.Input.asOptionalInput<String>(maintenanceVersion),
        masterInstanceName =
            pulumi.Input.asOptionalInput<String>(masterInstanceName),
        name = pulumi.Input.asOptionalInput<String>(name),
        nodeCount = pulumi.Input.asOptionalInput<int>(nodeCount),
        pointInTimeRestoreContext = pulumi.Input.asOptionalInput<
                DatabaseInstancePointInTimeRestoreContext>(
            pointInTimeRestoreContext),
        project = pulumi.Input.asOptionalInput<String>(project),
        region = pulumi.Input.asOptionalInput<String>(region),
        replicaConfiguration =
            pulumi.Input.asOptionalInput<DatabaseInstanceReplicaConfiguration>(
                replicaConfiguration),
        replicaNames = pulumi.Input.asOptionalInput<List<String>>(replicaNames),
        replicationCluster =
            pulumi.Input.asOptionalInput<DatabaseInstanceReplicationCluster>(
                replicationCluster),
        restoreBackupContext =
            pulumi.Input.asOptionalInput<DatabaseInstanceRestoreBackupContext>(
                restoreBackupContext),
        ...
        rootPasswordWoVersion =
            pulumi.Input.asOptionalInput<String>(rootPasswordWoVersion),
        settings =
            pulumi.Input.asOptionalInput<DatabaseInstanceSettings>(settings);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (cloneValue != null) {
      map['clone'] = pulumi.Input.mapOptionalInputValue<DatabaseInstanceClone,
    ...
    if (pointInTimeRestoreContextValue != null) {
      map['pointInTimeRestoreContext'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (replicationClusterValue != null) {
      map['replicationCluster'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (restoreBackupContextValue != null) {
      map['restoreBackupContext'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory DatabaseInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceArgs(
      backupdrBackup: map['backupdrBackup'] == null
          ? null
          : map['backupdrBackup'] as String,
      clone: map['clone'] == null
          ? null
          : DatabaseInstanceClone.fromMap(
              (map['clone'] as Map).cast<String, dynamic>()),
      ...
      encryptionKeyName: map['encryptionKeyName'] == null
          ? null
          : map['encryptionKeyName'] as String,
      finalBackupDescription: map['finalBackupDescription'] == null
          ? null
          : map['finalBackupDescription'] as String,
      instanceType:
      ...
      pointInTimeRestoreContext: map['pointInTimeRestoreContext'] == null
          ? null
          : DatabaseInstancePointInTimeRestoreContext.fromMap(
              (map['pointInTimeRestoreContext'] as Map)
                  .cast<String, dynamic>()),
      ...
      replicationCluster: map['replicationCluster'] == null
          ? null
          : DatabaseInstanceReplicationCluster.fromMap(
              (map['replicationCluster'] as Map).cast<String, dynamic>()),
      restoreBackupContext: map['restoreBackupContext'] == null
          ? null
          : DatabaseInstanceRestoreBackupContext.fromMap(
              (map['restoreBackupContext'] as Map).cast<String, dynamic>()),
      rootPassword:
          map['rootPassword'] == null ? null : map['rootPassword'] as String,
      rootPasswordWo: map['rootPasswordWo'] == null
          ? null
          : map['rootPasswordWo'] as String,
      rootPasswordWoVersion: map['rootPasswordWoVersion'] == null
          ? null
          : map['rootPasswordWoVersion'] as String,
