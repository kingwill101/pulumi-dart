...
class DatabaseInstanceArgs {
  ...
  DatabaseInstanceArgs({
    ...
    DatabaseInstanceSettings? settings,
       ...
       encryptionKeyName = pulumi.Input.asOptionalInput<String>(
         encryptionKeyName,
       ),
       finalBackupDescription = pulumi.Input.asOptionalInput<String>(
       ...
       rootPasswordWoVersion = pulumi.Input.asOptionalInput<String>(
         rootPasswordWoVersion,
       ),
       settings = pulumi.Input.asOptionalInput<DatabaseInstanceSettings>(
         settings,
       );
    ...
    return DatabaseInstanceArgs(
      ...
      pointInTimeRestoreContext: map['pointInTimeRestoreContext'] == null
          ...
          : DatabaseInstancePointInTimeRestoreContext.fromMap(
              (map['pointInTimeRestoreContext'] as Map).cast<String, dynamic>(),
            ),
