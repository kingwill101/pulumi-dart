...
class DatabaseInstanceSettingsIpConfigurationPscConfig {
  ...
  final List<DatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnection>? pscAutoConnections;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscAutoConnections': ?pscAutoConnections == null ? null : pulumi.Input.encodeList<DatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnection, Map<String, dynamic>>(pscAutoConnections!, (value) => value.toMap()),
  ...
  factory DatabaseInstanceSettingsIpConfigurationPscConfig.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSettingsIpConfigurationPscConfig(
      ...
      networkAttachmentUri: map['networkAttachmentUri'] == null ? null : map['networkAttachmentUri'] as String,
      pscAutoConnections: map['pscAutoConnections'] == null ? null : pulumi.Input.decodeList<DatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnection>(map['pscAutoConnections'], (value) => DatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnection.fromMap((value as Map).cast<String, dynamic>())),
