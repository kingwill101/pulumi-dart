...
class GetDatabaseInstanceSettingIpConfiguration {
  ...
  final List<GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork> authorizedNetworks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': pulumi.Input.encodeList<GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork, Map<String, dynamic>>(authorizedNetworks, (value) => value.toMap()),
      ...
      'pscConfigs': pulumi.Input.encodeList<GetDatabaseInstanceSettingIpConfigurationPscConfig, Map<String, dynamic>>(pscConfigs, (value) => value.toMap()),
  ...
  factory GetDatabaseInstanceSettingIpConfiguration.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstanceSettingIpConfiguration(
      ...
      authorizedNetworks: pulumi.Input.decodeList<GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork>(map['authorizedNetworks'], (value) => GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pscConfigs: pulumi.Input.decodeList<GetDatabaseInstanceSettingIpConfigurationPscConfig>(map['pscConfigs'], (value) => GetDatabaseInstanceSettingIpConfigurationPscConfig.fromMap((value as Map).cast<String, dynamic>())),
