...
class GetDatabaseInstanceSettingIpConfigurationPscConfig {
  ...
  final List<GetDatabaseInstanceSettingIpConfigurationPscConfigPscAutoConnection> pscAutoConnections;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscAutoConnections': pulumi.Input.encodeList<GetDatabaseInstanceSettingIpConfigurationPscConfigPscAutoConnection, Map<String, dynamic>>(pscAutoConnections, (value) => value.toMap()),
      'pscEnabled': pscEnabled,
    };
  }

  factory GetDatabaseInstanceSettingIpConfigurationPscConfig.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstanceSettingIpConfigurationPscConfig(
      ...
      pscAutoConnections: pulumi.Input.decodeList<GetDatabaseInstanceSettingIpConfigurationPscConfigPscAutoConnection>(map['pscAutoConnections'], (value) => GetDatabaseInstanceSettingIpConfigurationPscConfigPscAutoConnection.fromMap((value as Map).cast<String, dynamic>())),
