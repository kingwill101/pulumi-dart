...
class PolicyTagIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [PolicyTagIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PolicyTagIamMember]. {@macro pulumi_datacatalog_policy_tag_iam_member_policy_tag_iam_member_args_doc}
