...
/// {@template pulumi_datacatalog_entry_group_iam_binding_entry_group_iam_binding_args_doc}
/// The set of arguments for EntryGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_entry_group_iam_binding_entry_group_iam_binding_args_doc}
class EntryGroupIamBindingArgs {
  ...
  EntryGroupIamBindingArgs({
    EntryGroupIamBindingCondition? condition,
  ...
  factory EntryGroupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamBindingArgs(
      condition: map['condition'] == null ? null : EntryGroupIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
