...
class EntryArgs {
  ...
  EntryArgs({
    ...
    EntryGcsFilesetSpec? gcsFilesetSpec,
  ...
  factory EntryArgs.fromMap(Map<String, dynamic> map) {
    return EntryArgs(
      ...
      gcsFilesetSpec: map['gcsFilesetSpec'] == null ? null : EntryGcsFilesetSpec.fromMap((map['gcsFilesetSpec'] as Map).cast<String, dynamic>()),
