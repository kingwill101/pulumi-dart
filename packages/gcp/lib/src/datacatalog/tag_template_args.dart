...
class TagTemplateArgs {
  ...
  TagTemplateArgs({
    String? displayName,
    required List<TagTemplateField> fields,
    bool? forceDelete,
    String? project,
    String? region,
  ...
  factory TagTemplateArgs.fromMap(Map<String, dynamic> map) {
    return TagTemplateArgs(
      ...
      fields: pulumi.Input.decodeList<TagTemplateField>(map['fields'], (value) => TagTemplateField.fromMap((value as Map).cast<String, dynamic>())),
