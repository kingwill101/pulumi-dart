...
class GroupMembershipArgs {
  ...
  factory GroupMembershipArgs.fromMap(Map<String, dynamic> map) {
    return GroupMembershipArgs(
      ...
      memberKey: map['memberKey'] == null ? null : GroupMembershipMemberKey.fromMap((map['memberKey'] as Map).cast<String, dynamic>()),
      preferredMemberKey: map['preferredMemberKey'] == null ? null : GroupMembershipPreferredMemberKey.fromMap((map['preferredMemberKey'] as Map).cast<String, dynamic>()),
      roles: pulumi.Input.decodeList<GroupMembershipRole>(map['roles'], (value) => GroupMembershipRole.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
