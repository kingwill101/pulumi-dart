...
class PrivateConnectionArgs {
  ...
  PrivateConnectionArgs({
    ...
    String? project,
    required PrivateConnectionVpcPeeringConfig vpcPeeringConfig,
  }) :
  ...
  factory PrivateConnectionArgs.fromMap(Map<String, dynamic> map) {
    return PrivateConnectionArgs(
      ...
      vpcPeeringConfig: PrivateConnectionVpcPeeringConfig.fromMap((map['vpcPeeringConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
