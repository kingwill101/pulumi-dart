...
class MigrationJobArgs {
  ...
  MigrationJobArgs({
    ...
    String? displayName,
    MigrationJobDumpFlags? dumpFlags,
    String? dumpPath,
    String? dumpType,
    Map<String, String>? labels,
    String? location,
    required String migrationJobId,
    MigrationJobPerformanceConfig? performanceConfig,
    String? project,
    MigrationJobReverseSshConnectivity? reverseSshConnectivity,
    required String source,
    Map<String, dynamic>? staticIpConnectivity,
    required String type,
    MigrationJobVpcPeeringConnectivity? vpcPeeringConnectivity,
  }) :
  ...
  factory MigrationJobArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobArgs(
      ...
      dumpFlags: map['dumpFlags'] == null ? null : MigrationJobDumpFlags.fromMap((map['dumpFlags'] as Map).cast<String, dynamic>()),
      dumpPath: map['dumpPath'] == null ? null : map['dumpPath'] as String,
      dumpType: map['dumpType'] == null ? null : map['dumpType'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      migrationJobId: map['migrationJobId'] as String,
      performanceConfig: map['performanceConfig'] == null ? null : MigrationJobPerformanceConfig.fromMap((map['performanceConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      reverseSshConnectivity: map['reverseSshConnectivity'] == null ? null : MigrationJobReverseSshConnectivity.fromMap((map['reverseSshConnectivity'] as Map).cast<String, dynamic>()),
      source: map['source'] as String,
      staticIpConnectivity: map['staticIpConnectivity'] == null ? null : (map['staticIpConnectivity'] as Map).cast<String, dynamic>(),
      type: map['type'] as String,
      vpcPeeringConnectivity: map['vpcPeeringConnectivity'] == null ? null : MigrationJobVpcPeeringConnectivity.fromMap((map['vpcPeeringConnectivity'] as Map).cast<String, dynamic>()),
    );
  }
}
