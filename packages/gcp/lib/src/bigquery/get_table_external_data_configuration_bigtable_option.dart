...
class GetTableExternalDataConfigurationBigtableOption {
  ...
  final List<GetTableExternalDataConfigurationBigtableOptionColumnFamily> columnFamilies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columnFamilies': pulumi.Input.encodeList<GetTableExternalDataConfigurationBigtableOptionColumnFamily, Map<String, dynamic>>(columnFamilies, (value) => value.toMap()),
  ...
  factory GetTableExternalDataConfigurationBigtableOption.fromMap(Map<String, dynamic> map) {
    return GetTableExternalDataConfigurationBigtableOption(
      columnFamilies: pulumi.Input.decodeList<GetTableExternalDataConfigurationBigtableOptionColumnFamily>(map['columnFamilies'], (value) => GetTableExternalDataConfigurationBigtableOptionColumnFamily.fromMap((value as Map).cast<String, dynamic>())),
      ignoreUnspecifiedColumnFamilies: map['ignoreUnspecifiedColumnFamilies'] as bool,
