...
class RoutineArgs {
  ...
  RoutineArgs({
    ...
    RoutineSparkOptions? sparkOptions,
            ...
            pulumi.Input.asOptionalInput<List<RoutineArgument>>(arguments),
        dataGovernanceType =
            pulumi.Input.asOptionalInput<String>(dataGovernanceType),
        datasetId = pulumi.Input.asInput<String>(datasetId),
        definitionBody = pulumi.Input.asInput<String>(definitionBody),
        description = pulumi.Input.asOptionalInput<String>(description),
        determinismLevel =
            pulumi.Input.asOptionalInput<String>(determinismLevel),
        ...
        pythonOptions =
            pulumi.Input.asOptionalInput<RoutinePythonOptions>(pythonOptions),
        ...
        sparkOptions =
            pulumi.Input.asOptionalInput<RoutineSparkOptions>(sparkOptions);
  ...
  factory RoutineArgs.fromMap(Map<String, dynamic> map) {
    return RoutineArgs(
      ...
      securityMode:
          map['securityMode'] == null ? null : map['securityMode'] as String,
