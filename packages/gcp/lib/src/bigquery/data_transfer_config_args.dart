...
class DataTransferConfigArgs {
  ...
  DataTransferConfigArgs({
    ...
    String? serviceAccountName,
  }) : dataRefreshWindowDays = pulumi.Input.asOptionalInput<int>(
         dataRefreshWindowDays,
       ),
       dataSourceId = pulumi.Input.asInput<String>(dataSourceId),
       destinationDatasetId = pulumi.Input.asOptionalInput<String>(
       ...
       notificationPubsubTopic = pulumi.Input.asOptionalInput<String>(
       ...
       serviceAccountName = pulumi.Input.asOptionalInput<String>(
         serviceAccountName,
       );
