...
class DataTransferConfigArgs {
  ...
  factory DataTransferConfigArgs.fromMap(Map<String, dynamic> map) {
    return DataTransferConfigArgs(
      ...
      emailPreferences: map['emailPreferences'] == null ? null : DataTransferConfigEmailPreferences.fromMap((map['emailPreferences'] as Map).cast<String, dynamic>()),
      encryptionConfiguration: map['encryptionConfiguration'] == null ? null : DataTransferConfigEncryptionConfiguration.fromMap((map['encryptionConfiguration'] as Map).cast<String, dynamic>()),
      ...
      scheduleOptions: map['scheduleOptions'] == null ? null : DataTransferConfigScheduleOptions.fromMap((map['scheduleOptions'] as Map).cast<String, dynamic>()),
      sensitiveParams: map['sensitiveParams'] == null ? null : DataTransferConfigSensitiveParams.fromMap((map['sensitiveParams'] as Map).cast<String, dynamic>()),
