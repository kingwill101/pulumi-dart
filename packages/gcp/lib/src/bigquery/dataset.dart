...
class Dataset extends pulumi.CustomResource {
  ...
  Dataset(
    ...
    this.defaultEncryptionConfiguration = registerOutput<DatasetDefaultEncryptionConfiguration?>('defaultEncryptionConfiguration');
    this.defaultPartitionExpirationMs = registerOutput<int?>('defaultPartitionExpirationMs');
    this.defaultTableExpirationMs = registerOutput<int?>('defaultTableExpirationMs');
    this.deleteContentsOnDestroy = registerOutput<bool?>('deleteContentsOnDestroy');
    this.description = registerOutput<String?>('description');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.etag = registerOutput<String>('etag');
    this.externalCatalogDatasetOptions = registerOutput<DatasetExternalCatalogDatasetOptions?>('externalCatalogDatasetOptions');
    this.externalDatasetReference = registerOutput<DatasetExternalDatasetReference?>('externalDatasetReference');
