...
class DatasetAccessArgs {
  ...
  DatasetAccessArgs({
    DatasetAccessAuthorizedDataset? authorizedDataset,
    DatasetAccessCondition? condition,
    ...
    String? project,
    String? role,
    DatasetAccessRoutine? routine,
    String? specialGroup,
    String? userByEmail,
    DatasetAccessView? view,
  })  : authorizedDataset =
            pulumi.Input.asOptionalInput<DatasetAccessAuthorizedDataset>(
                authorizedDataset),
        condition =
            pulumi.Input.asOptionalInput<DatasetAccessCondition>(condition),
  ...
  factory DatasetAccessArgs.fromMap(Map<String, dynamic> map) {
    return DatasetAccessArgs(
      authorizedDataset: map['authorizedDataset'] == null
          ? null
          : DatasetAccessAuthorizedDataset.fromMap(
              (map['authorizedDataset'] as Map).cast<String, dynamic>()),
