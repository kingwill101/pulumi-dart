...
/// {@template pulumi_bigquery_app_profile_app_profile_args_doc}
/// The set of arguments for AppProfile.
/// {@endtemplate}
/// {@macro pulumi_bigquery_app_profile_app_profile_args_doc}
class AppProfileArgs {
  ...
  factory AppProfileArgs.fromMap(Map<String, dynamic> map) {
    return AppProfileArgs(
      ...
      dataBoostIsolationReadOnly: map['dataBoostIsolationReadOnly'] == null ? null : AppProfileDataBoostIsolationReadOnly.fromMap((map['dataBoostIsolationReadOnly'] as Map).cast<String, dynamic>()),
      ...
      multiClusterRoutingClusterIds: map['multiClusterRoutingClusterIds'] == null ? null : (map['multiClusterRoutingClusterIds'] as List).cast<String>(),
      multiClusterRoutingUseAny: map['multiClusterRoutingUseAny'] == null ? null : map['multiClusterRoutingUseAny'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      rowAffinity: map['rowAffinity'] == null ? null : map['rowAffinity'] as bool,
      singleClusterRouting: map['singleClusterRouting'] == null ? null : AppProfileSingleClusterRouting.fromMap((map['singleClusterRouting'] as Map).cast<String, dynamic>()),
      standardIsolation: map['standardIsolation'] == null ? null : AppProfileStandardIsolation.fromMap((map['standardIsolation'] as Map).cast<String, dynamic>()),
    );
  }
}
