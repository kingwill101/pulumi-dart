...
/// {@template pulumi_bigquery_datapolicyv2_data_policy_iam_binding_datapolicyv2_data_policy_iam_binding_args_doc}
/// The set of arguments for Datapolicyv2DataPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_bigquery_datapolicyv2_data_policy_iam_binding_datapolicyv2_data_policy_iam_binding_args_doc}
class Datapolicyv2DataPolicyIamBindingArgs {
  ...
  /// Creates a new [Datapolicyv2DataPolicyIamBindingArgs].
  /// [condition] Optional.
  ...
  Datapolicyv2DataPolicyIamBindingArgs({
    Datapolicyv2DataPolicyIamBindingCondition? condition,
  ...
  factory Datapolicyv2DataPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return Datapolicyv2DataPolicyIamBindingArgs(
      condition: map['condition'] == null ? null : Datapolicyv2DataPolicyIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
