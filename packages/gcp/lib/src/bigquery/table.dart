...
class Table extends pulumi.CustomResource {
  ...
  Table(
    ...
    this.biglakeConfiguration = registerOutput<TableBiglakeConfiguration?>('biglakeConfiguration');
    ...
    this.externalCatalogTableOptions = registerOutput<TableExternalCatalogTableOptions?>('externalCatalogTableOptions');
    this.externalDataConfiguration = registerOutput<TableExternalDataConfiguration?>('externalDataConfiguration');
    this.friendlyName = registerOutput<String?>('friendlyName');
    this.generatedSchemaColumns = registerOutput<String>('generatedSchemaColumns');
    this.ignoreAutoGeneratedSchema = registerOutput<bool?>('ignoreAutoGeneratedSchema');
    this.ignoreSchemaChanges = registerOutput<List<String>?>('ignoreSchemaChanges');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.lastModifiedTime = registerOutput<int>('lastModifiedTime');
    this.location = registerOutput<String>('location');
    this.materializedView = registerOutput<TableMaterializedView?>('materializedView');
    ...
    this.rangePartitioning = registerOutput<TableRangePartitioning?>('rangePartitioning');
    this.requirePartitionFilter = registerOutput<bool?>('requirePartitionFilter');
    this.resourceTags = registerOutput<Map<String, String>?>('resourceTags');
    this.schema = registerOutput<String>('schema');
    this.schemaForeignTypeInfo = registerOutput<TableSchemaForeignTypeInfo?>('schemaForeignTypeInfo');
    this.selfLink = registerOutput<String>('selfLink');
    this.tableConstraints = registerOutput<TableTableConstraints?>('tableConstraints');
    this.tableId = registerOutput<String>('tableId');
    this.tableMetadataView = registerOutput<String?>('tableMetadataView');
    this.tableReplicationInfo = registerOutput<TableTableReplicationInfo?>('tableReplicationInfo');
    this.timePartitioning = registerOutput<TableTimePartitioning?>('timePartitioning');
