...
class TableExternalDataConfiguration {
  ...
  final TableExternalDataConfigurationHivePartitioningOptions? hivePartitioningOptions;
  ...
  factory TableExternalDataConfiguration.fromMap(Map<String, dynamic> map) {
    return TableExternalDataConfiguration(
      ...
      avroOptions: map['avroOptions'] == null ? null : TableExternalDataConfigurationAvroOptions.fromMap((map['avroOptions'] as Map).cast<String, dynamic>()),
      bigtableOptions: map['bigtableOptions'] == null ? null : TableExternalDataConfigurationBigtableOptions.fromMap((map['bigtableOptions'] as Map).cast<String, dynamic>()),
      ...
      csvOptions: map['csvOptions'] == null ? null : TableExternalDataConfigurationCsvOptions.fromMap((map['csvOptions'] as Map).cast<String, dynamic>()),
      ...
      googleSheetsOptions: map['googleSheetsOptions'] == null ? null : TableExternalDataConfigurationGoogleSheetsOptions.fromMap((map['googleSheetsOptions'] as Map).cast<String, dynamic>()),
      hivePartitioningOptions: map['hivePartitioningOptions'] == null ? null : TableExternalDataConfigurationHivePartitioningOptions.fromMap((map['hivePartitioningOptions'] as Map).cast<String, dynamic>()),
      ...
      jsonOptions: map['jsonOptions'] == null ? null : TableExternalDataConfigurationJsonOptions.fromMap((map['jsonOptions'] as Map).cast<String, dynamic>()),
      ...
      parquetOptions: map['parquetOptions'] == null ? null : TableExternalDataConfigurationParquetOptions.fromMap((map['parquetOptions'] as Map).cast<String, dynamic>()),
