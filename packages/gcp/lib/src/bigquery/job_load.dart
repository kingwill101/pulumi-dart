...
class JobLoad {
  ...
  factory JobLoad.fromMap(Map<String, dynamic> map) {
    return JobLoad(
      ...
      jsonExtension: map['jsonExtension'] == null
          ? null
          : map['jsonExtension'] as String,
      maxBadRecords: map['maxBadRecords'] == null
          ? null
          : map['maxBadRecords'] as int,
      nullMarker: map['nullMarker'] == null
          ? null
          : map['nullMarker'] as String,
