...
class TableExternalDataConfigurationBigtableOptionsColumnFamily {
  ...
  final List<TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn>? columns;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns': ?columns == null ? null : pulumi.Input.encodeList<TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn, Map<String, dynamic>>(columns!, (value) => value.toMap()),
      'encoding': ?encoding,
      'familyId': ?familyId,
  ...
  factory TableExternalDataConfigurationBigtableOptionsColumnFamily.fromMap(Map<String, dynamic> map) {
    return TableExternalDataConfigurationBigtableOptionsColumnFamily(
      columns: map['columns'] == null ? null : pulumi.Input.decodeList<TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn>(map['columns'], (value) => TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn.fromMap((value as Map).cast<String, dynamic>())),
      encoding: map['encoding'] == null ? null : map['encoding'] as String,
      familyId: map['familyId'] == null ? null : map['familyId'] as String,
      onlyReadLatest: map['onlyReadLatest'] == null ? null : map['onlyReadLatest'] as bool,
