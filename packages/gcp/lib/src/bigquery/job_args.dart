...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      copy: map['copy'] == null
          ? null
          : JobCopy.fromMap((map['copy'] as Map).cast<String, dynamic>()),
      extract: map['extract'] == null
          ? null
          : JobExtract.fromMap((map['extract'] as Map).cast<String, dynamic>()),
      jobId: map['jobId'] as String,
      jobTimeoutMs: map['jobTimeoutMs'] == null
          ? null
          : map['jobTimeoutMs'] as String,
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      load: map['load'] == null
          ? null
          : JobLoad.fromMap((map['load'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      query: map['query'] == null
          ? null
          : JobQuery.fromMap((map['query'] as Map).cast<String, dynamic>()),
      reservation: map['reservation'] == null
          ? null
          : map['reservation'] as String,
    );
  }
}
