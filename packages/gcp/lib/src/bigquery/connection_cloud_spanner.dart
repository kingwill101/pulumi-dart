...
class ConnectionCloudSpanner {
  ...
  factory ConnectionCloudSpanner.fromMap(Map<String, dynamic> map) {
    return ConnectionCloudSpanner(
      ...
      databaseRole: map['databaseRole'] == null
          ? null
          : map['databaseRole'] as String,
      maxParallelism: map['maxParallelism'] == null
          ? null
          : map['maxParallelism'] as int,
      useDataBoost: map['useDataBoost'] == null
          ? null
          : map['useDataBoost'] as bool,
      useParallelism: map['useParallelism'] == null
          ? null
          : map['useParallelism'] as bool,
