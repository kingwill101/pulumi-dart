...
class GetDatasetAccess {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions': pulumi.Input.encodeList<GetDatasetAccessCondition, Map<String, dynamic>>(conditions, (value) => value.toMap()),
      'datasets': pulumi.Input.encodeList<GetDatasetAccessDataset, Map<String, dynamic>>(datasets, (value) => value.toMap()),
      'domain': domain,
      'groupByEmail': groupByEmail,
      'iamMember': iamMember,
      'role': role,
      'routines': pulumi.Input.encodeList<GetDatasetAccessRoutine, Map<String, dynamic>>(routines, (value) => value.toMap()),
      'specialGroup': specialGroup,
      'userByEmail': userByEmail,
      'views': pulumi.Input.encodeList<GetDatasetAccessView, Map<String, dynamic>>(views, (value) => value.toMap()),
    };
  }

  factory GetDatasetAccess.fromMap(Map<String, dynamic> map) {
    return GetDatasetAccess(
      conditions: pulumi.Input.decodeList<GetDatasetAccessCondition>(map['conditions'], (value) => GetDatasetAccessCondition.fromMap((value as Map).cast<String, dynamic>())),
      datasets: pulumi.Input.decodeList<GetDatasetAccessDataset>(map['datasets'], (value) => GetDatasetAccessDataset.fromMap((value as Map).cast<String, dynamic>())),
      domain: map['domain'] as String,
      groupByEmail: map['groupByEmail'] as String,
      iamMember: map['iamMember'] as String,
      role: map['role'] as String,
      routines: pulumi.Input.decodeList<GetDatasetAccessRoutine>(map['routines'], (value) => GetDatasetAccessRoutine.fromMap((value as Map).cast<String, dynamic>())),
      specialGroup: map['specialGroup'] as String,
      userByEmail: map['userByEmail'] as String,
      views: pulumi.Input.decodeList<GetDatasetAccessView>(map['views'], (value) => GetDatasetAccessView.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
