...
class DatasetAccessCondition {
  ...
  /// Creates a new [DatasetAccessCondition].
  ...
  factory DatasetAccessCondition.fromMap(Map<String, dynamic> map) {
    return DatasetAccessCondition(
      description:
