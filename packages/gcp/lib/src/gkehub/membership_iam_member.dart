...
class MembershipIamMember extends pulumi.CustomResource {
  late final pulumi.Output<MembershipIamMemberCondition?> condition;
  ...
  /// Creates a new [MembershipIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MembershipIamMember]. {@macro pulumi_gkehub_membership_iam_member_membership_iam_member_args_doc}
  ...
  MembershipIamMember(
    ...
    this.condition = registerOutput<MembershipIamMemberCondition?>('condition');
