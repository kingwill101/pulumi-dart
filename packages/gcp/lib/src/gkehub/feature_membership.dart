...
class FeatureMembership extends pulumi.CustomResource {
  ...
  /// Creates a new [FeatureMembership].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FeatureMembership]. {@macro pulumi_gkehub_feature_membership_feature_membership_args_doc}
  ...
  FeatureMembership(
    ...
    this.configmanagement = registerOutput<FeatureMembershipConfigmanagement?>(
      'configmanagement',
    );
    ...
    this.policycontroller = registerOutput<FeatureMembershipPolicycontroller?>(
      'policycontroller',
    );
