...
class ScopeRbacRoleBindingArgs {
  ...
  ScopeRbacRoleBindingArgs({
    ...
    String? project,
    required ScopeRbacRoleBindingRole role,
    required String scopeId,
    required String scopeRbacRoleBindingId,
    String? user,
       ...
       scopeRbacRoleBindingId = pulumi.Input.asInput<String>(
  ...
  factory ScopeRbacRoleBindingArgs.fromMap(Map<String, dynamic> map) {
    return ScopeRbacRoleBindingArgs(
      ...
      role: ScopeRbacRoleBindingRole.fromMap(
        (map['role'] as Map).cast<String, dynamic>(),
      ),
      scopeId: map['scopeId'] as String,
      scopeRbacRoleBindingId: map['scopeRbacRoleBindingId'] as String,
