...
class FeatureMembershipArgs {
  ...
  factory FeatureMembershipArgs.fromMap(Map<String, dynamic> map) {
    return FeatureMembershipArgs(
      configmanagement: map['configmanagement'] == null ? null : FeatureMembershipConfigmanagement.fromMap((map['configmanagement'] as Map).cast<String, dynamic>()),
      ...
      mesh: map['mesh'] == null ? null : FeatureMembershipMesh.fromMap((map['mesh'] as Map).cast<String, dynamic>()),
      policycontroller: map['policycontroller'] == null ? null : FeatureMembershipPolicycontroller.fromMap((map['policycontroller'] as Map).cast<String, dynamic>()),
