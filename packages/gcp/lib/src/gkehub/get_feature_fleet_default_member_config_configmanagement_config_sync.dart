...
class GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSync {
  ...
  final List<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit> gits;
  /// The Email of the Google Cloud Service Account (GSA) used for exporting Config Sync metrics to Cloud Monitoring. The GSA should have the Monitoring Metric Writer(roles/monitoring.metricWriter) IAM role. The Kubernetes ServiceAccount 'default' in the namespace 'config-management-monitoring' should be bound to the GSA.
  final String metricsGcpServiceAccountEmail;
  /// OCI repo configuration for the cluster
  final List<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci> ocis;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enabled': enabled,
      'gits': pulumi.Input.encodeList<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit, Map<String, dynamic>>(gits, (value) => value.toMap()),
      'metricsGcpServiceAccountEmail': metricsGcpServiceAccountEmail,
      'ocis': pulumi.Input.encodeList<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci, Map<String, dynamic>>(ocis, (value) => value.toMap()),
  ...
  factory GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSync.fromMap(Map<String, dynamic> map) {
    return GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSync(
      ...
      gits: pulumi.Input.decodeList<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit>(map['gits'], (value) => GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit.fromMap((value as Map).cast<String, dynamic>())),
      metricsGcpServiceAccountEmail: map['metricsGcpServiceAccountEmail'] as String,
      ocis: pulumi.Input.decodeList<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci>(map['ocis'], (value) => GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci.fromMap((value as Map).cast<String, dynamic>())),
