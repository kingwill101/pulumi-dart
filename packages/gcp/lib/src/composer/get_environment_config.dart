    ...
    return <String, dynamic>{
      ...
      'dataRetentionConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(dataRetentionConfigs, (value) => value.toMap()),
      'databaseConfigs':
          pulumi.Input.encodeList<
            GetEnvironmentConfigDatabaseConfig,
            Map<String, dynamic>
          >(databaseConfigs, (value) => value.toMap()),
      ...
      'recoveryConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(recoveryConfigs, (value) => value.toMap()),
      'resilienceMode': resilienceMode,
      'softwareConfigs':
          pulumi.Input.encodeList<
            GetEnvironmentConfigSoftwareConfig,
            Map<String, dynamic>
          >(softwareConfigs, (value) => value.toMap()),
      'webServerConfigs':
          pulumi.Input.encodeList<
            GetEnvironmentConfigWebServerConfig,
            Map<String, dynamic>
          >(webServerConfigs, (value) => value.toMap()),
      'webServerNetworkAccessControls':
          pulumi.Input.encodeList<
      ...
      'workloadsConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(workloadsConfigs, (value) => value.toMap()),
    };
  }
    ...
    return GetEnvironmentConfig(
      ...
      masterAuthorizedNetworksConfigs:
          ...
          >(
            ...
            (value) =>
                GetEnvironmentConfigMasterAuthorizedNetworksConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      ...
      webServerNetworkAccessControls:
          ...
          >(
            ...
            (value) =>
                GetEnvironmentConfigWebServerNetworkAccessControl.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      workloadsConfigs:
