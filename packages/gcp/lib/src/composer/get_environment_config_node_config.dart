...
class GetEnvironmentConfigNodeConfig {
  ...
  final List<GetEnvironmentConfigNodeConfigIpAllocationPolicy> ipAllocationPolicies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAllocationPolicies': pulumi.Input.encodeList<GetEnvironmentConfigNodeConfigIpAllocationPolicy, Map<String, dynamic>>(ipAllocationPolicies, (value) => value.toMap()),
  ...
  factory GetEnvironmentConfigNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfigNodeConfig(
      composerInternalIpv4CidrBlock: map['composerInternalIpv4CidrBlock'] as String,
      ...
      ipAllocationPolicies: pulumi.Input.decodeList<GetEnvironmentConfigNodeConfigIpAllocationPolicy>(map['ipAllocationPolicies'], (value) => GetEnvironmentConfigNodeConfigIpAllocationPolicy.fromMap((value as Map).cast<String, dynamic>())),
