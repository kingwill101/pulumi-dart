...
import 'environment_config_software_config_cloud_data_lineage_integration.dart';
...
class EnvironmentConfigSoftwareConfig {
  ...
  final EnvironmentConfigSoftwareConfigCloudDataLineageIntegration?
  ...
  /// Creates a new [EnvironmentConfigSoftwareConfig].
  ...
  /// [cloudDataLineageIntegration] The configuration for Cloud Data Lineage integration. Supported for Cloud Composer environments in versions composer-2.1.2-airflow-*.*.* and newer
  ...
  Map<String, dynamic> toMap() {
    ...
    final webServerPluginsModeValue = webServerPluginsMode;
    if (webServerPluginsModeValue != null) {
      map['webServerPluginsMode'] = webServerPluginsModeValue;
    }
    return map;
  }
  ...
  factory EnvironmentConfigSoftwareConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigSoftwareConfig(
      ...
      cloudDataLineageIntegration: map['cloudDataLineageIntegration'] == null
          ? null
          : EnvironmentConfigSoftwareConfigCloudDataLineageIntegration.fromMap(
      ...
      webServerPluginsMode: map['webServerPluginsMode'] == null
          ? null
