...
class EnvironmentConfigSoftwareConfig {
  ...
  final EnvironmentConfigSoftwareConfigCloudDataLineageIntegration? cloudDataLineageIntegration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudDataLineageIntegration': ?cloudDataLineageIntegration == null ? null : cloudDataLineageIntegration!.toMap(),
  ...
  factory EnvironmentConfigSoftwareConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigSoftwareConfig(
      airflowConfigOverrides: map['airflowConfigOverrides'] == null ? null : (map['airflowConfigOverrides'] as Map).cast<String, String>(),
      cloudDataLineageIntegration: map['cloudDataLineageIntegration'] == null ? null : EnvironmentConfigSoftwareConfigCloudDataLineageIntegration.fromMap((map['cloudDataLineageIntegration'] as Map).cast<String, dynamic>()),
      ...
      pypiPackages: map['pypiPackages'] == null ? null : (map['pypiPackages'] as Map).cast<String, String>(),
      pythonVersion: map['pythonVersion'] == null ? null : map['pythonVersion'] as String,
      schedulerCount: map['schedulerCount'] == null ? null : map['schedulerCount'] as int,
      webServerPluginsMode: map['webServerPluginsMode'] == null ? null : map['webServerPluginsMode'] as String,
    );
  }
}
