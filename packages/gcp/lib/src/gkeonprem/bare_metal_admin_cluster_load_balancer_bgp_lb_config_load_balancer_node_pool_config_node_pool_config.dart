  ...
  factory BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfig.fromMap(
    ...
    return BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfig(
      kubeletConfig: map['kubeletConfig'] == null
          ? null
          : BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfig.fromMap(
      ...
      nodeConfigs: map['nodeConfigs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['nodeConfigs'],
              (value) =>
                  BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfig.fromMap(
      ...
      taints: map['taints'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['taints'],
              (value) =>
                  BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaint.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
    );
