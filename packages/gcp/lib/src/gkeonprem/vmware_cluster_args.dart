...
class VMwareClusterArgs {
  ...
  factory VMwareClusterArgs.fromMap(Map<String, dynamic> map) {
    return VMwareClusterArgs(
      ...
      antiAffinityGroups: map['antiAffinityGroups'] == null ? null : VMwareClusterAntiAffinityGroups.fromMap((map['antiAffinityGroups'] as Map).cast<String, dynamic>()),
      authorization: map['authorization'] == null ? null : VMwareClusterAuthorization.fromMap((map['authorization'] as Map).cast<String, dynamic>()),
      autoRepairConfig: map['autoRepairConfig'] == null ? null : VMwareClusterAutoRepairConfig.fromMap((map['autoRepairConfig'] as Map).cast<String, dynamic>()),
      controlPlaneNode: VMwareClusterControlPlaneNode.fromMap((map['controlPlaneNode'] as Map).cast<String, dynamic>()),
      dataplaneV2: map['dataplaneV2'] == null ? null : VMwareClusterDataplaneV2.fromMap((map['dataplaneV2'] as Map).cast<String, dynamic>()),
      ...
      loadBalancer: map['loadBalancer'] == null ? null : VMwareClusterLoadBalancer.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: map['networkConfig'] == null ? null : VMwareClusterNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      onPremVersion: map['onPremVersion'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      storage: map['storage'] == null ? null : VMwareClusterStorage.fromMap((map['storage'] as Map).cast<String, dynamic>()),
      ...
      vcenter: map['vcenter'] == null ? null : VMwareClusterVcenter.fromMap((map['vcenter'] as Map).cast<String, dynamic>()),
