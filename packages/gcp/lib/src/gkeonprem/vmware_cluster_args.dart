    ...
    bool? vmTrackingEnabled,
        ...
        antiAffinityGroups =
            pulumi.Input.asOptionalInput<VMwareClusterAntiAffinityGroups>(
                antiAffinityGroups),
        authorization =
            pulumi.Input.asOptionalInput<VMwareClusterAuthorization>(
                authorization),
        autoRepairConfig =
        ...
        controlPlaneNode = pulumi.Input.asInput<VMwareClusterControlPlaneNode>(
            controlPlaneNode),
        dataplaneV2 =
            pulumi.Input.asOptionalInput<VMwareClusterDataplaneV2>(dataplaneV2),
        ...
        networkConfig =
            pulumi.Input.asOptionalInput<VMwareClusterNetworkConfig>(
                networkConfig),
