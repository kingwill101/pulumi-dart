...
class VmwareAdminClusterArgs {
  ...
  VmwareAdminClusterArgs({
    ...
    VmwareAdminClusterVcenter? vcenter,
       ...
       loadBalancer = pulumi
           .Input.asOptionalInput<VmwareAdminClusterLoadBalancer>(loadBalancer),
    ...
    return <String, dynamic>{
      ...
      'platformConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(platformConfig, (value) => value.toMap()),
      'privateRegistryConfig':
          ?pulumi.Input.mapOptionalInputValue<
            VmwareAdminClusterPrivateRegistryConfig,
            Map<String, dynamic>
          >(privateRegistryConfig, (value) => value.toMap()),
      'project': ?project,
      'proxy':
          ?pulumi.Input.mapOptionalInputValue<
