...
class VmwareAdminClusterArgs {
  ...
  VmwareAdminClusterArgs({
    VmwareAdminClusterAddonNode? addonNode,
    Map<String, String>? annotations,
    VmwareAdminClusterAntiAffinityGroups? antiAffinityGroups,
    VmwareAdminClusterAuthorization? authorization,
    VmwareAdminClusterAutoRepairConfig? autoRepairConfig,
    String? bootstrapClusterMembership,
    VmwareAdminClusterControlPlaneNode? controlPlaneNode,
    String? description,
    bool? enableAdvancedCluster,
    String? imageType,
    VmwareAdminClusterLoadBalancer? loadBalancer,
    required String location,
    String? name,
    required VmwareAdminClusterNetworkConfig networkConfig,
    String? onPremVersion,
    VmwareAdminClusterPlatformConfig? platformConfig,
    VmwareAdminClusterPrivateRegistryConfig? privateRegistryConfig,
    String? project,
    VmwareAdminClusterProxy? proxy,
    VmwareAdminClusterVcenter? vcenter,
  }) :
  ...
  factory VmwareAdminClusterArgs.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterArgs(
      addonNode: map['addonNode'] == null ? null : VmwareAdminClusterAddonNode.fromMap((map['addonNode'] as Map).cast<String, dynamic>()),
      annotations: map['annotations'] == null ? null : (map['annotations'] as Map).cast<String, String>(),
      antiAffinityGroups: map['antiAffinityGroups'] == null ? null : VmwareAdminClusterAntiAffinityGroups.fromMap((map['antiAffinityGroups'] as Map).cast<String, dynamic>()),
      authorization: map['authorization'] == null ? null : VmwareAdminClusterAuthorization.fromMap((map['authorization'] as Map).cast<String, dynamic>()),
      autoRepairConfig: map['autoRepairConfig'] == null ? null : VmwareAdminClusterAutoRepairConfig.fromMap((map['autoRepairConfig'] as Map).cast<String, dynamic>()),
      bootstrapClusterMembership: map['bootstrapClusterMembership'] == null ? null : map['bootstrapClusterMembership'] as String,
      controlPlaneNode: map['controlPlaneNode'] == null ? null : VmwareAdminClusterControlPlaneNode.fromMap((map['controlPlaneNode'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enableAdvancedCluster: map['enableAdvancedCluster'] == null ? null : map['enableAdvancedCluster'] as bool,
      imageType: map['imageType'] == null ? null : map['imageType'] as String,
      loadBalancer: map['loadBalancer'] == null ? null : VmwareAdminClusterLoadBalancer.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: VmwareAdminClusterNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      onPremVersion: map['onPremVersion'] == null ? null : map['onPremVersion'] as String,
      platformConfig: map['platformConfig'] == null ? null : VmwareAdminClusterPlatformConfig.fromMap((map['platformConfig'] as Map).cast<String, dynamic>()),
      privateRegistryConfig: map['privateRegistryConfig'] == null ? null : VmwareAdminClusterPrivateRegistryConfig.fromMap((map['privateRegistryConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      proxy: map['proxy'] == null ? null : VmwareAdminClusterProxy.fromMap((map['proxy'] as Map).cast<String, dynamic>()),
      vcenter: map['vcenter'] == null ? null : VmwareAdminClusterVcenter.fromMap((map['vcenter'] as Map).cast<String, dynamic>()),
    );
  }
}
