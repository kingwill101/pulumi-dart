...
class VmwareAdminClusterArgs {
  ...
  VmwareAdminClusterArgs({
    ...
    VmwareAdminClusterVcenter? vcenter,
        ...
        bootstrapClusterMembership =
            pulumi.Input.asOptionalInput<String>(bootstrapClusterMembership),
        controlPlaneNode =
            pulumi.Input.asOptionalInput<VmwareAdminClusterControlPlaneNode>(
                controlPlaneNode),
        description = pulumi.Input.asOptionalInput<String>(description),
        enableAdvancedCluster =
            pulumi.Input.asOptionalInput<bool>(enableAdvancedCluster),
        ...
        platformConfig =
            pulumi.Input.asOptionalInput<VmwareAdminClusterPlatformConfig>(
                platformConfig),
        privateRegistryConfig = pulumi.Input.asOptionalInput<
            VmwareAdminClusterPrivateRegistryConfig>(privateRegistryConfig),
        project = pulumi.Input.asOptionalInput<String>(project),
        proxy = pulumi.Input.asOptionalInput<VmwareAdminClusterProxy>(proxy),
        vcenter =
            pulumi.Input.asOptionalInput<VmwareAdminClusterVcenter>(vcenter);
  ...
  factory VmwareAdminClusterArgs.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterArgs(
      addonNode: map['addonNode'] == null
          ? null
          : VmwareAdminClusterAddonNode.fromMap(
              (map['addonNode'] as Map).cast<String, dynamic>()),
      annotations: map['annotations'] == null
          ? null
          : (map['annotations'] as Map).cast<String, String>(),
      antiAffinityGroups: map['antiAffinityGroups'] == null
          ? null
          : VmwareAdminClusterAntiAffinityGroups.fromMap(
              (map['antiAffinityGroups'] as Map).cast<String, dynamic>()),
      authorization: map['authorization'] == null
          ? null
          : VmwareAdminClusterAuthorization.fromMap(
              (map['authorization'] as Map).cast<String, dynamic>()),
      autoRepairConfig: map['autoRepairConfig'] == null
          ? null
          : VmwareAdminClusterAutoRepairConfig.fromMap(
              (map['autoRepairConfig'] as Map).cast<String, dynamic>()),
      bootstrapClusterMembership: map['bootstrapClusterMembership'] == null
          ? null
          : map['bootstrapClusterMembership'] as String,
      controlPlaneNode: map['controlPlaneNode'] == null
          ? null
          : VmwareAdminClusterControlPlaneNode.fromMap(
      ...
      loadBalancer: map['loadBalancer'] == null
          ? null
          : VmwareAdminClusterLoadBalancer.fromMap(
              (map['loadBalancer'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: VmwareAdminClusterNetworkConfig.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      onPremVersion:
          map['onPremVersion'] == null ? null : map['onPremVersion'] as String,
      platformConfig: map['platformConfig'] == null
          ? null
          : VmwareAdminClusterPlatformConfig.fromMap(
              (map['platformConfig'] as Map).cast<String, dynamic>()),
      privateRegistryConfig: map['privateRegistryConfig'] == null
          ? null
          : VmwareAdminClusterPrivateRegistryConfig.fromMap(
              (map['privateRegistryConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      proxy: map['proxy'] == null
          ? null
          : VmwareAdminClusterProxy.fromMap(
              (map['proxy'] as Map).cast<String, dynamic>()),
      vcenter: map['vcenter'] == null
          ? null
          : VmwareAdminClusterVcenter.fromMap(
