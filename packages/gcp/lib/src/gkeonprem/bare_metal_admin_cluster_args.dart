...
class BareMetalAdminClusterArgs {
  ...
  factory BareMetalAdminClusterArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterArgs(
      ...
      clusterOperations: map['clusterOperations'] == null ? null : BareMetalAdminClusterClusterOperations.fromMap((map['clusterOperations'] as Map).cast<String, dynamic>()),
      controlPlane: map['controlPlane'] == null ? null : BareMetalAdminClusterControlPlane.fromMap((map['controlPlane'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      loadBalancer: map['loadBalancer'] == null ? null : BareMetalAdminClusterLoadBalancer.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      maintenanceConfig: map['maintenanceConfig'] == null ? null : BareMetalAdminClusterMaintenanceConfig.fromMap((map['maintenanceConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: map['networkConfig'] == null ? null : BareMetalAdminClusterNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      nodeAccessConfig: map['nodeAccessConfig'] == null ? null : BareMetalAdminClusterNodeAccessConfig.fromMap((map['nodeAccessConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: map['nodeConfig'] == null ? null : BareMetalAdminClusterNodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      proxy: map['proxy'] == null ? null : BareMetalAdminClusterProxy.fromMap((map['proxy'] as Map).cast<String, dynamic>()),
      securityConfig: map['securityConfig'] == null ? null : BareMetalAdminClusterSecurityConfig.fromMap((map['securityConfig'] as Map).cast<String, dynamic>()),
      storage: map['storage'] == null ? null : BareMetalAdminClusterStorage.fromMap((map['storage'] as Map).cast<String, dynamic>()),
    );
  }
}
