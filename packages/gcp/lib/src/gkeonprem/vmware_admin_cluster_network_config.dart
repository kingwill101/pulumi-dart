...
class VmwareAdminClusterNetworkConfig {
  ...
  /// Structure is documented below.
  final VmwareAdminClusterNetworkConfigHaControlPlaneConfig? haControlPlaneConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'haControlPlaneConfig': ?haControlPlaneConfig == null ? null : haControlPlaneConfig!.toMap(),
  ...
  factory VmwareAdminClusterNetworkConfig.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterNetworkConfig(
      dhcpIpConfig: map['dhcpIpConfig'] == null ? null : VmwareAdminClusterNetworkConfigDhcpIpConfig.fromMap((map['dhcpIpConfig'] as Map).cast<String, dynamic>()),
      haControlPlaneConfig: map['haControlPlaneConfig'] == null ? null : VmwareAdminClusterNetworkConfigHaControlPlaneConfig.fromMap((map['haControlPlaneConfig'] as Map).cast<String, dynamic>()),
      hostConfig: map['hostConfig'] == null ? null : VmwareAdminClusterNetworkConfigHostConfig.fromMap((map['hostConfig'] as Map).cast<String, dynamic>()),
      ...
      staticIpConfig: map['staticIpConfig'] == null ? null : VmwareAdminClusterNetworkConfigStaticIpConfig.fromMap((map['staticIpConfig'] as Map).cast<String, dynamic>()),
