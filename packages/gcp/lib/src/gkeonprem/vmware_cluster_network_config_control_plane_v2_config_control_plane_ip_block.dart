...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock {
  ...
  final List<VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIp>? ips;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gateway': ?gateway,
      'ips': ?ips == null ? null : pulumi.Input.encodeList<VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIp, Map<String, dynamic>>(ips!, (value) => value.toMap()),
      'netmask': ?netmask,
    };
  }
  ...
  factory VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock.fromMap(Map<String, dynamic> map) {
    return VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock(
      ...
      ips: map['ips'] == null ? null : pulumi.Input.decodeList<VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIp>(map['ips'], (value) => VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIp.fromMap((value as Map).cast<String, dynamic>())),
