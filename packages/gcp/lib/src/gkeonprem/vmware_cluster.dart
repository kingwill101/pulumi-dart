...
class VMwareCluster extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [VMwareCluster]. {@macro pulumi_gkeonprem_v_mware_cluster_vmware_cluster_args_doc}
  ...
  VMwareCluster(
    ...
    this.antiAffinityGroups = registerOutput<VMwareClusterAntiAffinityGroups>(
      'antiAffinityGroups',
    );
    this.authorization = registerOutput<VMwareClusterAuthorization?>(
      'authorization',
    );
    this.autoRepairConfig = registerOutput<VMwareClusterAutoRepairConfig>(
      'autoRepairConfig',
    );
    this.controlPlaneNode = registerOutput<VMwareClusterControlPlaneNode>(
      'controlPlaneNode',
    );
    ...
    this.loadBalancer = registerOutput<VMwareClusterLoadBalancer?>(
      'loadBalancer',
    );
    this.localName = registerOutput<String>('localName');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<VMwareClusterNetworkConfig?>(
      'networkConfig',
    );
    ...
    this.upgradePolicy = registerOutput<VMwareClusterUpgradePolicy?>(
      'upgradePolicy',
    );
    this.validationChecks = registerOutput<List<VMwareClusterValidationCheck>>(
      'validationChecks',
    );
