...
class BareMetalCluster extends pulumi.CustomResource {
  ...
  BareMetalCluster(
    ...
    this.clusterOperations = registerOutput<BareMetalClusterClusterOperations?>(
      'clusterOperations',
    );
    this.controlPlane = registerOutput<BareMetalClusterControlPlane>(
      'controlPlane',
    );
    ...
    this.loadBalancer = registerOutput<BareMetalClusterLoadBalancer>(
      'loadBalancer',
    );
    this.localName = registerOutput<String>('localName');
    this.location = registerOutput<String>('location');
    this.maintenanceConfig = registerOutput<BareMetalClusterMaintenanceConfig?>(
      'maintenanceConfig',
    );
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<BareMetalClusterNetworkConfig>(
      'networkConfig',
    );
    this.nodeAccessConfig = registerOutput<BareMetalClusterNodeAccessConfig?>(
      'nodeAccessConfig',
    );
    ...
    this.securityConfig = registerOutput<BareMetalClusterSecurityConfig?>(
      'securityConfig',
    );
    ...
    this.upgradePolicy = registerOutput<BareMetalClusterUpgradePolicy?>(
      'upgradePolicy',
    );
