...
class VmwareAdminClusterPlatformConfigBundle {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'statuses': ?statuses == null ? null : pulumi.Input.encodeList<VmwareAdminClusterPlatformConfigBundleStatus, Map<String, dynamic>>(statuses!, (value) => value.toMap()),
      'version': ?version,
    };
  }
  ...
  factory VmwareAdminClusterPlatformConfigBundle.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterPlatformConfigBundle(
      statuses: map['statuses'] == null ? null : pulumi.Input.decodeList<VmwareAdminClusterPlatformConfigBundleStatus>(map['statuses'], (value) => VmwareAdminClusterPlatformConfigBundleStatus.fromMap((value as Map).cast<String, dynamic>())),
