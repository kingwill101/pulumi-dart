...
/// {@template pulumi_cloudfunctionsv2_function_iam_member_function_iam_member_args_doc}
/// The set of arguments for FunctionIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudfunctionsv2_function_iam_member_function_iam_member_args_doc}
class FunctionIamMemberArgs {
  ...
  FunctionIamMemberArgs({
    ...
    FunctionIamMemberCondition? condition,
    String? location,
    ...
    required String role,
      ...
      condition = pulumi.Input.asOptionalInput<FunctionIamMemberCondition>(condition),
  ...
  factory FunctionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return FunctionIamMemberArgs(
      ...
      condition: map['condition'] == null ? null : FunctionIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
