...
class V2VmArgs {
  ...
  factory V2VmArgs.fromMap(Map<String, dynamic> map) {
    return V2VmArgs(
      acceleratorConfig: map['acceleratorConfig'] == null ? null : V2VmAcceleratorConfig.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>()),
      ...
      dataDisks: map['dataDisks'] == null ? null : pulumi.Input.decodeList<V2VmDataDisk>(map['dataDisks'], (value) => V2VmDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: map['networkConfig'] == null ? null : V2VmNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      networkConfigs: map['networkConfigs'] == null ? null : pulumi.Input.decodeList<V2VmNetworkConfig>(map['networkConfigs'], (value) => V2VmNetworkConfig.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      runtimeVersion: map['runtimeVersion'] as String,
      schedulingConfig: map['schedulingConfig'] == null ? null : V2VmSchedulingConfig.fromMap((map['schedulingConfig'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : V2VmServiceAccount.fromMap((map['serviceAccount'] as Map).cast<String, dynamic>()),
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : V2VmShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
