...
class V2Vm extends pulumi.CustomResource {
  ...
  V2Vm(String name, {V2VmArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.acceleratorConfig = registerOutput<V2VmAcceleratorConfig>(
      'acceleratorConfig',
    );
    ...
    this.networkConfigs = registerOutput<List<V2VmNetworkConfig>?>(
      'networkConfigs',
    );
    this.networkEndpoints = registerOutput<List<V2VmNetworkEndpoint>>(
      'networkEndpoints',
    );
    ...
    this.schedulingConfig = registerOutput<V2VmSchedulingConfig?>(
      'schedulingConfig',
    );
    this.serviceAccount = registerOutput<V2VmServiceAccount>('serviceAccount');
    this.shieldedInstanceConfig = registerOutput<V2VmShieldedInstanceConfig?>(
      'shieldedInstanceConfig',
    );
