...
class RegistrationArgs {
  ...
  factory RegistrationArgs.fromMap(Map<String, dynamic> map) {
    return RegistrationArgs(
      contactNotices: map['contactNotices'] == null ? null : (map['contactNotices'] as List).cast<String>(),
      contactSettings: RegistrationContactSettings.fromMap((map['contactSettings'] as Map).cast<String, dynamic>()),
      dnsSettings: map['dnsSettings'] == null ? null : RegistrationDnsSettings.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      domainName: map['domainName'] as String,
      domainNotices: map['domainNotices'] == null ? null : (map['domainNotices'] as List).cast<String>(),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      managementSettings: map['managementSettings'] == null ? null : RegistrationManagementSettings.fromMap((map['managementSettings'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      yearlyPrice: RegistrationYearlyPrice.fromMap((map['yearlyPrice'] as Map).cast<String, dynamic>()),
    );
  }
}
