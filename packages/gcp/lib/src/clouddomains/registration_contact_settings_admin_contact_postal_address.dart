...
class RegistrationContactSettingsAdminContactPostalAddress {
  ...
  /// Creates a new [RegistrationContactSettingsAdminContactPostalAddress].
  ...
  factory RegistrationContactSettingsAdminContactPostalAddress.fromMap(
