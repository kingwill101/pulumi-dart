...
class Registration extends pulumi.CustomResource {
  ...
  Registration(
    ...
    this.contactSettings = registerOutput<RegistrationContactSettings>('contactSettings');
    ...
    this.managementSettings = registerOutput<RegistrationManagementSettings>('managementSettings');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.registerFailureReason = registerOutput<String>('registerFailureReason');
    this.state = registerOutput<String>('state');
    this.supportedPrivacies = registerOutput<List<String>>('supportedPrivacies');
