...
class Registration extends pulumi.CustomResource {
  ...
  Registration(
    ...
    this.contactSettings = registerOutput<RegistrationContactSettings>(
      'contactSettings',
    );
    ...
    this.managementSettings = registerOutput<RegistrationManagementSettings>(
      'managementSettings',
    );
    ...
    this.supportedPrivacies = registerOutput<List<String>>(
      'supportedPrivacies',
    );
