...
/// {@template pulumi_vertex_ai_feature_store_iam_member_ai_feature_store_iam_member_args_doc}
/// The set of arguments for AiFeatureStoreIamMember.
/// {@endtemplate}
...
class AiFeatureStoreIamMemberArgs {
  ...
  /// Creates a new [AiFeatureStoreIamMemberArgs].
  /// [condition] Optional.
  ...
  AiFeatureStoreIamMemberArgs({
    AiFeatureStoreIamMemberCondition? condition,
    ...
    required String role,
           ...
           .Input.asOptionalInput<AiFeatureStoreIamMemberCondition>(condition),
