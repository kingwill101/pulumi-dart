...
class AiEndpointDeployedModelDedicatedResource {
  ...
  final List<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec>?
  ...
  Map<String, dynamic> toMap() {
    ...
    final minReplicaCountValue = minReplicaCount;
    if (minReplicaCountValue != null) {
      map['minReplicaCount'] = minReplicaCountValue;
    }
    return map;
  }
  ...
  factory AiEndpointDeployedModelDedicatedResource.fromMap(
    ...
    return AiEndpointDeployedModelDedicatedResource(
      ...
      minReplicaCount:
          map['minReplicaCount'] == null ? null : map['minReplicaCount'] as int,
    );
  }
}
