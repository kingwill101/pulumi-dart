...
class AiEndpointDeployedModelDedicatedResource {
  ...
  final List<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec>? autoscalingMetricSpecs;
  /// (Output)
  /// The specification of a single machine used by the prediction.
  /// Structure is documented below.
  final List<AiEndpointDeployedModelDedicatedResourceMachineSpec>? machineSpecs;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricSpecs': ?autoscalingMetricSpecs == null ? null : pulumi.Input.encodeList<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec, Map<String, dynamic>>(autoscalingMetricSpecs!, (value) => value.toMap()),
      'machineSpecs': ?machineSpecs == null ? null : pulumi.Input.encodeList<AiEndpointDeployedModelDedicatedResourceMachineSpec, Map<String, dynamic>>(machineSpecs!, (value) => value.toMap()),
  ...
  factory AiEndpointDeployedModelDedicatedResource.fromMap(Map<String, dynamic> map) {
    return AiEndpointDeployedModelDedicatedResource(
      autoscalingMetricSpecs: map['autoscalingMetricSpecs'] == null ? null : pulumi.Input.decodeList<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec>(map['autoscalingMetricSpecs'], (value) => AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec.fromMap((value as Map).cast<String, dynamic>())),
      machineSpecs: map['machineSpecs'] == null ? null : pulumi.Input.decodeList<AiEndpointDeployedModelDedicatedResourceMachineSpec>(map['machineSpecs'], (value) => AiEndpointDeployedModelDedicatedResourceMachineSpec.fromMap((value as Map).cast<String, dynamic>())),
