...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbe {
  ...
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeExec? exec;
  ...
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeGrpc? grpc;
  /// HttpGetAction describes an action based on HTTP Get requests.
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGet? httpGet;
  ...
  /// connection.
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeTcpSocket? tcpSocket;
  ...
  factory AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbe.fromMap(Map<String, dynamic> map) {
    return AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbe(
      exec: map['exec'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeExec.fromMap((map['exec'] as Map).cast<String, dynamic>()),
      failureThreshold: map['failureThreshold'] == null ? null : map['failureThreshold'] as int,
      grpc: map['grpc'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeGrpc.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: map['httpGet'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGet.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeTcpSocket.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
