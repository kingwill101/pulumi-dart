...
class AiIndexEndpointDeployedIndexArgs {
  ...
  AiIndexEndpointDeployedIndexArgs({
    AiIndexEndpointDeployedIndexAutomaticResources? automaticResources,
    AiIndexEndpointDeployedIndexDedicatedResources? dedicatedResources,
    AiIndexEndpointDeployedIndexDeployedIndexAuthConfig? deployedIndexAuthConfig,
    required String deployedIndexId,
    String? deploymentGroup,
    String? displayName,
    bool? enableAccessLogging,
    required String index,
    required String indexEndpoint,
    String? region,
  ...
  factory AiIndexEndpointDeployedIndexArgs.fromMap(Map<String, dynamic> map) {
    return AiIndexEndpointDeployedIndexArgs(
      automaticResources: map['automaticResources'] == null ? null : AiIndexEndpointDeployedIndexAutomaticResources.fromMap((map['automaticResources'] as Map).cast<String, dynamic>()),
      dedicatedResources: map['dedicatedResources'] == null ? null : AiIndexEndpointDeployedIndexDedicatedResources.fromMap((map['dedicatedResources'] as Map).cast<String, dynamic>()),
      deployedIndexAuthConfig: map['deployedIndexAuthConfig'] == null ? null : AiIndexEndpointDeployedIndexDeployedIndexAuthConfig.fromMap((map['deployedIndexAuthConfig'] as Map).cast<String, dynamic>()),
      deployedIndexId: map['deployedIndexId'] as String,
      deploymentGroup: map['deploymentGroup'] == null ? null : map['deploymentGroup'] as String,
