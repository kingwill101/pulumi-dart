...
class AiIndexEndpointDeployedIndexArgs {
  ...
  AiIndexEndpointDeployedIndexArgs({
    ...
    List<String>? reservedIpRanges,
  })  : automaticResources = pulumi.Input.asOptionalInput<
            AiIndexEndpointDeployedIndexAutomaticResources>(automaticResources),
        dedicatedResources = pulumi.Input.asOptionalInput<
            AiIndexEndpointDeployedIndexDedicatedResources>(dedicatedResources),
        deployedIndexAuthConfig = pulumi.Input.asOptionalInput<
                AiIndexEndpointDeployedIndexDeployedIndexAuthConfig>(
            deployedIndexAuthConfig),
        ...
        enableAccessLogging =
            pulumi.Input.asOptionalInput<bool>(enableAccessLogging),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (automaticResourcesValue != null) {
      map['automaticResources'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (deployedIndexAuthConfigValue != null) {
      map['deployedIndexAuthConfig'] = pulumi.Input.mapOptionalInputValue<
              AiIndexEndpointDeployedIndexDeployedIndexAuthConfig,
              Map<String, dynamic>>(
  ...
  factory AiIndexEndpointDeployedIndexArgs.fromMap(Map<String, dynamic> map) {
    return AiIndexEndpointDeployedIndexArgs(
      ...
      deployedIndexAuthConfig: map['deployedIndexAuthConfig'] == null
          ? null
      ...
      deploymentGroup: map['deploymentGroup'] == null
          ? null
          : map['deploymentGroup'] as String,
      displayName:
          map['displayName'] == null ? null : map['displayName'] as String,
      enableAccessLogging: map['enableAccessLogging'] == null
          ? null
