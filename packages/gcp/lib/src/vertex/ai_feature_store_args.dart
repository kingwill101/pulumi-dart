...
class AiFeatureStoreArgs {
  ...
  factory AiFeatureStoreArgs.fromMap(Map<String, dynamic> map) {
    return AiFeatureStoreArgs(
      encryptionSpec: map['encryptionSpec'] == null ? null : AiFeatureStoreEncryptionSpec.fromMap((map['encryptionSpec'] as Map).cast<String, dynamic>()),
      forceDestroy: map['forceDestroy'] == null ? null : map['forceDestroy'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      onlineServingConfig: map['onlineServingConfig'] == null ? null : AiFeatureStoreOnlineServingConfig.fromMap((map['onlineServingConfig'] as Map).cast<String, dynamic>()),
