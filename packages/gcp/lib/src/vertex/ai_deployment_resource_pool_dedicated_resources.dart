...
class AiDeploymentResourcePoolDedicatedResources {
  ...
  final List<AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec>? autoscalingMetricSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricSpecs': ?autoscalingMetricSpecs == null ? null : pulumi.Input.encodeList<AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec, Map<String, dynamic>>(autoscalingMetricSpecs!, (value) => value.toMap()),
  ...
  factory AiDeploymentResourcePoolDedicatedResources.fromMap(Map<String, dynamic> map) {
    return AiDeploymentResourcePoolDedicatedResources(
      autoscalingMetricSpecs: map['autoscalingMetricSpecs'] == null ? null : pulumi.Input.decodeList<AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec>(map['autoscalingMetricSpecs'], (value) => AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec.fromMap((value as Map).cast<String, dynamic>())),
      machineSpec: AiDeploymentResourcePoolDedicatedResourcesMachineSpec.fromMap((map['machineSpec'] as Map).cast<String, dynamic>()),
