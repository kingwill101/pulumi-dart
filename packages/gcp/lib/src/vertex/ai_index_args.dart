...
class AiIndexArgs {
  ...
  AiIndexArgs({
    ...
    String? region,
        ...
        encryptionSpec =
            pulumi.Input.asOptionalInput<AiIndexEncryptionSpec>(encryptionSpec),
        indexUpdateMethod =
            pulumi.Input.asOptionalInput<String>(indexUpdateMethod),
  ...
  factory AiIndexArgs.fromMap(Map<String, dynamic> map) {
    return AiIndexArgs(
      ...
      metadata: AiIndexMetadata.fromMap(
