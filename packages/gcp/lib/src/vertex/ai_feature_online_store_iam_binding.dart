...
import 'ai_feature_online_store_iam_binding_args.dart';
...
class AiFeatureOnlineStoreIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<AiFeatureOnlineStoreIamBindingCondition?> condition;
  ...
  /// Creates a new [AiFeatureOnlineStoreIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiFeatureOnlineStoreIamBinding]. {@macro pulumi_vertex_ai_feature_online_store_iam_binding_ai_feature_online_store_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AiFeatureOnlineStoreIamBinding(
    String name, {
    AiFeatureOnlineStoreIamBindingArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'gcp:vertex/aiFeatureOnlineStoreIamBinding:AiFeatureOnlineStoreIamBinding',
          name,
          pulumi.Input.mapToInputs(args?.toMap() ?? const {}),
          options ?? pulumi.CustomResourceOptions(),
        ) {
    this.condition = registerOutput<AiFeatureOnlineStoreIamBindingCondition?>('condition');
