...
class AiIndexEndpointArgs {
  ...
  factory AiIndexEndpointArgs.fromMap(Map<String, dynamic> map) {
    return AiIndexEndpointArgs(
      ...
      encryptionSpec: map['encryptionSpec'] == null ? null : AiIndexEndpointEncryptionSpec.fromMap((map['encryptionSpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      network: map['network'] == null ? null : map['network'] as String,
      privateServiceConnectConfig: map['privateServiceConnectConfig'] == null ? null : AiIndexEndpointPrivateServiceConnectConfig.fromMap((map['privateServiceConnectConfig'] as Map).cast<String, dynamic>()),
