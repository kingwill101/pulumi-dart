...
class AiFeatureOnlineStoreArgs {
  ...
  factory AiFeatureOnlineStoreArgs.fromMap(Map<String, dynamic> map) {
    return AiFeatureOnlineStoreArgs(
      bigtable: map['bigtable'] == null ? null : AiFeatureOnlineStoreBigtable.fromMap((map['bigtable'] as Map).cast<String, dynamic>()),
      dedicatedServingEndpoint: map['dedicatedServingEndpoint'] == null ? null : AiFeatureOnlineStoreDedicatedServingEndpoint.fromMap((map['dedicatedServingEndpoint'] as Map).cast<String, dynamic>()),
      embeddingManagement: map['embeddingManagement'] == null ? null : AiFeatureOnlineStoreEmbeddingManagement.fromMap((map['embeddingManagement'] as Map).cast<String, dynamic>()),
      encryptionSpec: map['encryptionSpec'] == null ? null : AiFeatureOnlineStoreEncryptionSpec.fromMap((map['encryptionSpec'] as Map).cast<String, dynamic>()),
