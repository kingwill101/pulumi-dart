...
class AiEndpointWithModelGardenDeploymentArgs {
  ...
  AiEndpointWithModelGardenDeploymentArgs({
    ...
    String? publisherModelName,
       ...
       endpointConfig =
           ...
           >(endpointConfig),
       huggingFaceModelId = pulumi.Input.asOptionalInput<String>(
         huggingFaceModelId,
       ),
       ...
       publisherModelName = pulumi.Input.asOptionalInput<String>(
         publisherModelName,
       );
  ...
  factory AiEndpointWithModelGardenDeploymentArgs.fromMap(
    ...
    return AiEndpointWithModelGardenDeploymentArgs(
      deployConfig: map['deployConfig'] == null
          ? null
          : AiEndpointWithModelGardenDeploymentDeployConfig.fromMap(
              (map['deployConfig'] as Map).cast<String, dynamic>(),
            ),
      ...
      huggingFaceModelId: map['huggingFaceModelId'] == null
          ? null
          : map['huggingFaceModelId'] as String,
      location: map['location'] as String,
      modelConfig: map['modelConfig'] == null
          ? null
          : AiEndpointWithModelGardenDeploymentModelConfig.fromMap(
              (map['modelConfig'] as Map).cast<String, dynamic>(),
            ),
      project: map['project'] == null ? null : map['project'] as String,
      publisherModelName: map['publisherModelName'] == null
          ? null
          : map['publisherModelName'] as String,
    );
  }
}
