...
class AiEndpointWithModelGardenDeploymentArgs {
  ...
  AiEndpointWithModelGardenDeploymentArgs({
    AiEndpointWithModelGardenDeploymentDeployConfig? deployConfig,
    AiEndpointWithModelGardenDeploymentEndpointConfig? endpointConfig,
    String? huggingFaceModelId,
    required String location,
    AiEndpointWithModelGardenDeploymentModelConfig? modelConfig,
    String? project,
  ...
  factory AiEndpointWithModelGardenDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return AiEndpointWithModelGardenDeploymentArgs(
      deployConfig: map['deployConfig'] == null ? null : AiEndpointWithModelGardenDeploymentDeployConfig.fromMap((map['deployConfig'] as Map).cast<String, dynamic>()),
      endpointConfig: map['endpointConfig'] == null ? null : AiEndpointWithModelGardenDeploymentEndpointConfig.fromMap((map['endpointConfig'] as Map).cast<String, dynamic>()),
      huggingFaceModelId: map['huggingFaceModelId'] == null ? null : map['huggingFaceModelId'] as String,
      location: map['location'] as String,
      modelConfig: map['modelConfig'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfig.fromMap((map['modelConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      publisherModelName: map['publisherModelName'] == null ? null : map['publisherModelName'] as String,
    );
  }
}
