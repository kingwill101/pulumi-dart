...
class AiEndpoint extends pulumi.CustomResource {
  ...
  AiEndpoint(
    ...
    this.dedicatedEndpointEnabled = registerOutput<bool?>('dedicatedEndpointEnabled');
    this.deployedModels = registerOutput<List<AiEndpointDeployedModel>>('deployedModels');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.encryptionSpec = registerOutput<AiEndpointEncryptionSpec?>('encryptionSpec');
    ...
    this.predictRequestResponseLoggingConfig = registerOutput<AiEndpointPredictRequestResponseLoggingConfig?>('predictRequestResponseLoggingConfig');
    this.privateServiceConnectConfig = registerOutput<AiEndpointPrivateServiceConnectConfig?>('privateServiceConnectConfig');
