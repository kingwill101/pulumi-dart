...
class AiEndpoint extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<AiEndpointPredictRequestResponseLoggingConfig?>
  predictRequestResponseLoggingConfig;

  /// Configuration for private service connect. `network` and `privateServiceConnectConfig` are mutually exclusive.
  /// Structure is documented below.
  late final pulumi.Output<AiEndpointPrivateServiceConnectConfig?>
  privateServiceConnectConfig;
  ...
  AiEndpoint(
    ...
    this.dedicatedEndpointEnabled = registerOutput<bool?>(
      'dedicatedEndpointEnabled',
    );
    this.deployedModels = registerOutput<List<AiEndpointDeployedModel>>(
      'deployedModels',
    );
    ...
    this.encryptionSpec = registerOutput<AiEndpointEncryptionSpec?>(
      'encryptionSpec',
    );
