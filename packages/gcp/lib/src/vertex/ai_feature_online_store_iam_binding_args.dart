...
class AiFeatureOnlineStoreIamBindingArgs {
  ...
  AiFeatureOnlineStoreIamBindingArgs({
    AiFeatureOnlineStoreIamBindingCondition? condition,
  ...
  factory AiFeatureOnlineStoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AiFeatureOnlineStoreIamBindingArgs(
      condition: map['condition'] == null ? null : AiFeatureOnlineStoreIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
