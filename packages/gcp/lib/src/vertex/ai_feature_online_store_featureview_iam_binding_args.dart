...
class AiFeatureOnlineStoreFeatureviewIamBindingArgs {
  final pulumi.Input<AiFeatureOnlineStoreFeatureviewIamBindingCondition>?
      condition;
  ...
  factory AiFeatureOnlineStoreFeatureviewIamBindingArgs.fromMap(
      Map<String, dynamic> map) {
    return AiFeatureOnlineStoreFeatureviewIamBindingArgs(
      condition: map['condition'] == null
          ? null
          : AiFeatureOnlineStoreFeatureviewIamBindingCondition.fromMap(
