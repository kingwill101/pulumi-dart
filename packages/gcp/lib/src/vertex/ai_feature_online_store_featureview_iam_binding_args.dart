...
/// {@template pulumi_vertex_ai_feature_online_store_featureview_iam_binding_ai_feature_online_store_featureview_iam_binding_args_doc}
/// The set of arguments for AiFeatureOnlineStoreFeatureviewIamBinding.
/// {@endtemplate}
...
class AiFeatureOnlineStoreFeatureviewIamBindingArgs {
  ...
  /// Creates a new [AiFeatureOnlineStoreFeatureviewIamBindingArgs].
  /// [condition] Optional.
  ...
  AiFeatureOnlineStoreFeatureviewIamBindingArgs({
    AiFeatureOnlineStoreFeatureviewIamBindingCondition? condition,
  ...
  factory AiFeatureOnlineStoreFeatureviewIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AiFeatureOnlineStoreFeatureviewIamBindingArgs(
      condition: map['condition'] == null ? null : AiFeatureOnlineStoreFeatureviewIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
