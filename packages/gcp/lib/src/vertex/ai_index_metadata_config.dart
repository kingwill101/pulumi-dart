...
class AiIndexMetadataConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'algorithmConfig': ?algorithmConfig == null ? null : algorithmConfig!.toMap(),
  ...
  factory AiIndexMetadataConfig.fromMap(Map<String, dynamic> map) {
    return AiIndexMetadataConfig(
      algorithmConfig: map['algorithmConfig'] == null ? null : AiIndexMetadataConfigAlgorithmConfig.fromMap((map['algorithmConfig'] as Map).cast<String, dynamic>()),
      approximateNeighborsCount: map['approximateNeighborsCount'] == null ? null : map['approximateNeighborsCount'] as int,
      dimensions: map['dimensions'] as int,
      distanceMeasureType: map['distanceMeasureType'] == null ? null : map['distanceMeasureType'] as String,
      featureNormType: map['featureNormType'] == null ? null : map['featureNormType'] as String,
