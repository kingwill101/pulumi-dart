...
class AiFeatureGroupIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [AiFeatureGroupIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiFeatureGroupIamBinding]. {@macro pulumi_vertex_ai_feature_group_iam_binding_ai_feature_group_iam_binding_args_doc}
  ...
  AiFeatureGroupIamBinding(
    ...
    this.condition = registerOutput<AiFeatureGroupIamBindingCondition?>('condition');
