...
import 'ai_feature_online_store_iam_member_args.dart';
import 'ai_feature_online_store_iam_member_condition.dart';
...
class AiFeatureOnlineStoreIamMember extends pulumi.CustomResource {
  late final pulumi.Output<AiFeatureOnlineStoreIamMemberCondition?> condition;
  ...
  /// Creates a new [AiFeatureOnlineStoreIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiFeatureOnlineStoreIamMember]. {@macro pulumi_vertex_ai_feature_online_store_iam_member_ai_feature_online_store_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AiFeatureOnlineStoreIamMember(
    String name, {
    AiFeatureOnlineStoreIamMemberArgs? args,
    ...
    this.condition = registerOutput<AiFeatureOnlineStoreIamMemberCondition?>('condition');
