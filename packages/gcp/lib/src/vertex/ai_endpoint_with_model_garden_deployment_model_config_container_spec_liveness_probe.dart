...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe {
  ...
  factory AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe.fromMap(
    ...
    return AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe(
      exec: map['exec'] == null
          ? null
          : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeExec.fromMap(
      ...
      grpc: map['grpc'] == null
          ? null
          : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeGrpc.fromMap(
              (map['grpc'] as Map).cast<String, dynamic>(),
            ),
      httpGet: map['httpGet'] == null
          ? null
          : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGet.fromMap(
      ...
      tcpSocket: map['tcpSocket'] == null
          ? null
          : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeTcpSocket.fromMap(
