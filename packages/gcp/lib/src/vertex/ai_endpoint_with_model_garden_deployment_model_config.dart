...
class AiEndpointWithModelGardenDeploymentModelConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final acceptEulaValue = acceptEula;
    if (acceptEulaValue != null) {
      map['acceptEula'] = acceptEulaValue;
    }
    final containerSpecValue = containerSpec;
    if (containerSpecValue != null) {
      map['containerSpec'] = containerSpecValue.toMap();
    }
    final huggingFaceAccessTokenValue = huggingFaceAccessToken;
    if (huggingFaceAccessTokenValue != null) {
      map['huggingFaceAccessToken'] = huggingFaceAccessTokenValue;
    }
    final huggingFaceCacheEnabledValue = huggingFaceCacheEnabled;
    if (huggingFaceCacheEnabledValue != null) {
      map['huggingFaceCacheEnabled'] = huggingFaceCacheEnabledValue;
    }
    final modelDisplayNameValue = modelDisplayName;
    if (modelDisplayNameValue != null) {
      map['modelDisplayName'] = modelDisplayNameValue;
    }
    return map;
  }
