...
class AiEndpointWithModelGardenDeploymentModelConfig {
  ...
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpec? containerSpec;
  ...
  factory AiEndpointWithModelGardenDeploymentModelConfig.fromMap(Map<String, dynamic> map) {
    return AiEndpointWithModelGardenDeploymentModelConfig(
      ...
      containerSpec: map['containerSpec'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpec.fromMap((map['containerSpec'] as Map).cast<String, dynamic>()),
      huggingFaceAccessToken: map['huggingFaceAccessToken'] == null ? null : map['huggingFaceAccessToken'] as String,
      huggingFaceCacheEnabled: map['huggingFaceCacheEnabled'] == null ? null : map['huggingFaceCacheEnabled'] as bool,
      modelDisplayName: map['modelDisplayName'] == null ? null : map['modelDisplayName'] as String,
    );
  }
}
