...
class AiReasoningEngineSpecDeploymentSpecPscInterfaceConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dnsPeeringConfigs': ?dnsPeeringConfigs == null
          ? null
          : pulumi.Input.encodeList<
              AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfig,
              Map<String, dynamic>
            >(dnsPeeringConfigs!, (value) => value.toMap()),
      ...
      dnsPeeringConfigs: map['dnsPeeringConfigs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfig.fromMap(
