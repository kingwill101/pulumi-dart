...
class AiEndpointDeployedModel {
  ...
  Map<String, dynamic> toMap() {
    ...
    final enableContainerLoggingValue = enableContainerLogging;
    if (enableContainerLoggingValue != null) {
      map['enableContainerLogging'] = enableContainerLoggingValue;
    }
    final idValue = id;
    if (idValue != null) {
      map['id'] = idValue;
    ...
    final modelVersionIdValue = modelVersionId;
    if (modelVersionIdValue != null) {
      map['modelVersionId'] = modelVersionIdValue;
    }
    ...
    final sharedResourcesValue = sharedResources;
    if (sharedResourcesValue != null) {
      map['sharedResources'] = sharedResourcesValue;
    }
    return map;
  }
  ...
  factory AiEndpointDeployedModel.fromMap(Map<String, dynamic> map) {
    return AiEndpointDeployedModel(
      ...
      enableContainerLogging: map['enableContainerLogging'] == null
          ? null
          : map['enableContainerLogging'] as bool,
      id: map['id'] == null ? null : map['id'] as String,
      model: map['model'] == null ? null : map['model'] as String,
      modelVersionId: map['modelVersionId'] == null
          ? null
      ...
      sharedResources: map['sharedResources'] == null
          ? null
          : map['sharedResources'] as String,
    );
  }
}
