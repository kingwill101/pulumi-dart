...
class AiFeatureStoreEntityTypeArgs {
  ...
  AiFeatureStoreEntityTypeArgs({
    ...
    AiFeatureStoreEntityTypeMonitoringConfig? monitoringConfig,
    String? name,
  ...
  factory AiFeatureStoreEntityTypeArgs.fromMap(Map<String, dynamic> map) {
    return AiFeatureStoreEntityTypeArgs(
      ...
      monitoringConfig: map['monitoringConfig'] == null ? null : AiFeatureStoreEntityTypeMonitoringConfig.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      offlineStorageTtlDays: map['offlineStorageTtlDays'] == null ? null : map['offlineStorageTtlDays'] as int,
    );
  }
}
