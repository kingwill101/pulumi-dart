...
class JobArgs {
  ...
  JobArgs({
    ...
    String? subnetwork,
    required String tempGcsLocation,
    required String templateGcsPath,
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      tempGcsLocation: map['tempGcsLocation'] as String,
      templateGcsPath: map['templateGcsPath'] as String,
