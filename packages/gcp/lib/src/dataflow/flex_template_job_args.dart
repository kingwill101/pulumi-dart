...
class FlexTemplateJobArgs {
  ...
  FlexTemplateJobArgs({
    ...
    Map<String, String>? transformNameMapping,
       ...
       autoscalingAlgorithm = pulumi.Input.asOptionalInput<String>(
         autoscalingAlgorithm,
       ),
       containerSpecGcsPath = pulumi.Input.asInput<String>(
         containerSpecGcsPath,
       ),
       enableStreamingEngine = pulumi.Input.asOptionalInput<bool>(
         enableStreamingEngine,
       ),
       ipConfiguration = pulumi.Input.asOptionalInput<String>(ipConfiguration),
       kmsKeyName = pulumi.Input.asOptionalInput<String>(kmsKeyName),
       labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
       launcherMachineType = pulumi.Input.asOptionalInput<String>(
         launcherMachineType,
       ),
       ...
       sdkContainerImage = pulumi.Input.asOptionalInput<String>(
         sdkContainerImage,
       ),
       serviceAccountEmail = pulumi.Input.asOptionalInput<String>(
         serviceAccountEmail,
       ),
       skipWaitOnJobTermination = pulumi.Input.asOptionalInput<bool>(
