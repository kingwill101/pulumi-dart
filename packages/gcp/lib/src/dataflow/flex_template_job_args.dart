...
class FlexTemplateJobArgs {
  ...
  factory FlexTemplateJobArgs.fromMap(Map<String, dynamic> map) {
    return FlexTemplateJobArgs(
      ...
      additionalPipelineOptions: map['additionalPipelineOptions'] == null ? null : (map['additionalPipelineOptions'] as List).cast<String>(),
      autoscalingAlgorithm: map['autoscalingAlgorithm'] == null ? null : map['autoscalingAlgorithm'] as String,
      ...
      ipConfiguration: map['ipConfiguration'] == null ? null : map['ipConfiguration'] as String,
      kmsKeyName: map['kmsKeyName'] == null ? null : map['kmsKeyName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      launcherMachineType: map['launcherMachineType'] == null ? null : map['launcherMachineType'] as String,
      ...
      sdkContainerImage: map['sdkContainerImage'] == null ? null : map['sdkContainerImage'] as String,
      serviceAccountEmail: map['serviceAccountEmail'] == null ? null : map['serviceAccountEmail'] as String,
      skipWaitOnJobTermination: map['skipWaitOnJobTermination'] == null ? null : map['skipWaitOnJobTermination'] as bool,
      stagingLocation: map['stagingLocation'] == null ? null : map['stagingLocation'] as String,
      subnetwork: map['subnetwork'] == null ? null : map['subnetwork'] as String,
      tempLocation: map['tempLocation'] == null ? null : map['tempLocation'] as String,
