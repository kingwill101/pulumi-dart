...
class FlexTemplateJobArgs {
  ...
  FlexTemplateJobArgs({
    ...
    required String containerSpecGcsPath,
    ...
    bool? skipWaitOnJobTermination,
    String? stagingLocation,
    String? subnetwork,
    String? tempLocation,
    Map<String, String>? transformNameMapping,
  })  : additionalExperiments =
            pulumi.Input.asOptionalInput<List<String>>(additionalExperiments),
        additionalPipelineOptions = pulumi.Input.asOptionalInput<List<String>>(
            additionalPipelineOptions),
        autoscalingAlgorithm =
            pulumi.Input.asOptionalInput<String>(autoscalingAlgorithm),
        containerSpecGcsPath =
            pulumi.Input.asInput<String>(containerSpecGcsPath),
        enableStreamingEngine =
            pulumi.Input.asOptionalInput<bool>(enableStreamingEngine),
        ipConfiguration = pulumi.Input.asOptionalInput<String>(ipConfiguration),
        kmsKeyName = pulumi.Input.asOptionalInput<String>(kmsKeyName),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        launcherMachineType =
            pulumi.Input.asOptionalInput<String>(launcherMachineType),
        ...
        sdkContainerImage =
            pulumi.Input.asOptionalInput<String>(sdkContainerImage),
        serviceAccountEmail =
            pulumi.Input.asOptionalInput<String>(serviceAccountEmail),
        skipWaitOnJobTermination =
            pulumi.Input.asOptionalInput<bool>(skipWaitOnJobTermination),
  ...
  factory FlexTemplateJobArgs.fromMap(Map<String, dynamic> map) {
    return FlexTemplateJobArgs(
      ...
      additionalPipelineOptions: map['additionalPipelineOptions'] == null
          ? null
          : (map['additionalPipelineOptions'] as List).cast<String>(),
      autoscalingAlgorithm: map['autoscalingAlgorithm'] == null
          ? null
          : map['autoscalingAlgorithm'] as String,
      ...
      launcherMachineType: map['launcherMachineType'] == null
          ? null
          : map['launcherMachineType'] as String,
      machineType:
      ...
      sdkContainerImage: map['sdkContainerImage'] == null
          ? null
          : map['sdkContainerImage'] as String,
      serviceAccountEmail: map['serviceAccountEmail'] == null
          ? null
          : map['serviceAccountEmail'] as String,
      skipWaitOnJobTermination: map['skipWaitOnJobTermination'] == null
          ? null
          : map['skipWaitOnJobTermination'] as bool,
      stagingLocation: map['stagingLocation'] == null
          ? null
          : map['stagingLocation'] as String,
      subnetwork:
