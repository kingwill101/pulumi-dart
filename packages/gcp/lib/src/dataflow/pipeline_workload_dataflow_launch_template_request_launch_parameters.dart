...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParameters {
  ...
  final PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironment?
  environment;
  ...
  factory PipelineWorkloadDataflowLaunchTemplateRequestLaunchParameters.fromMap(
    Map<String, dynamic> map,
  ) {
    return PipelineWorkloadDataflowLaunchTemplateRequestLaunchParameters(
      environment: map['environment'] == null
          ? null
          : PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironment.fromMap(
