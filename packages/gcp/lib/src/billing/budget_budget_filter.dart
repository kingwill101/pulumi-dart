...
class BudgetBudgetFilter {
  ...
  factory BudgetBudgetFilter.fromMap(Map<String, dynamic> map) {
    return BudgetBudgetFilter(
      calendarPeriod: map['calendarPeriod'] == null ? null : map['calendarPeriod'] as String,
      creditTypes: map['creditTypes'] == null ? null : (map['creditTypes'] as List).cast<String>(),
      creditTypesTreatment: map['creditTypesTreatment'] == null ? null : map['creditTypesTreatment'] as String,
      customPeriod: map['customPeriod'] == null ? null : BudgetBudgetFilterCustomPeriod.fromMap((map['customPeriod'] as Map).cast<String, dynamic>()),
