...
class InstanceArgs {
    ...
    List<String>? zones,
        ...
        maintenancePolicy =
            pulumi.Input.asOptionalInput<InstanceMaintenancePolicy>(
                maintenancePolicy),
        memcacheParameters =
            pulumi.Input.asOptionalInput<InstanceMemcacheParameters>(
                memcacheParameters),
        ...
        reservedIpRangeIds =
            pulumi.Input.asOptionalInput<List<String>>(reservedIpRangeIds),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (memcacheParametersValue != null) {
      map['memcacheParameters'] = pulumi.Input.mapOptionalInputValue<
    ...
    map['nodeConfig'] =
        pulumi.Input.mapInputValue<InstanceNodeConfig, Map<String, dynamic>>(
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      memcacheParameters: map['memcacheParameters'] == null
          ? null
          : InstanceMemcacheParameters.fromMap(
              (map['memcacheParameters'] as Map).cast<String, dynamic>()),
      memcacheVersion: map['memcacheVersion'] == null
          ? null
          : map['memcacheVersion'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nodeConfig: InstanceNodeConfig.fromMap(
          (map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      reservedIpRangeIds: map['reservedIpRangeIds'] == null
          ? null
          : (map['reservedIpRangeIds'] as List).cast<String>(),
      zones:
