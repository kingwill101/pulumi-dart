...
class Certificate extends pulumi.CustomResource {
  ...
  Certificate(
    ...
    this.certificateDescriptions = registerOutput<List<CertificateCertificateDescription>>('certificateDescriptions');
    ...
    this.issuerCertificateAuthority = registerOutput<String>('issuerCertificateAuthority');
    ...
    this.pemCertificateChains = registerOutput<List<String>>('pemCertificateChains');
    this.pemCsr = registerOutput<String?>('pemCsr');
    this.pool = registerOutput<String>('pool');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.revocationDetails = registerOutput<List<CertificateRevocationDetail>>('revocationDetails');
