...
class Certificate extends pulumi.CustomResource {
  ...
  Certificate(
    ...
    this.issuerCertificateAuthority = registerOutput<String>(
    ...
    this.pemCertificateChains = registerOutput<List<String>>(
    ...
    this.revocationDetails = registerOutput<List<CertificateRevocationDetail>>(
      'revocationDetails',
    );
