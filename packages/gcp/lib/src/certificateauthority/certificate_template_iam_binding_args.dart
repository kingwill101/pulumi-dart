...
import 'certificate_template_iam_binding_condition.dart';

/// {@template pulumi_certificateauthority_certificate_template_iam_binding_certificate_template_iam_binding_args_doc}
/// The set of arguments for CertificateTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_certificateauthority_certificate_template_iam_binding_certificate_template_iam_binding_args_doc}
class CertificateTemplateIamBindingArgs {
  /// Used to find the parent resource to bind the IAM policy to
  final pulumi.Input<String> certificateTemplate;
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  final pulumi.Input<CertificateTemplateIamBindingCondition>? condition;
  ...
  /// Creates a new [CertificateTemplateIamBindingArgs].
  ...
  CertificateTemplateIamBindingArgs({
    ...
    CertificateTemplateIamBindingCondition? condition,
    String? location,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'condition': ?pulumi.Input.mapOptionalInputValue<CertificateTemplateIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'members': members,
      'project': ?project,
      'role': role,
  ...
  factory CertificateTemplateIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return CertificateTemplateIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : CertificateTemplateIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
