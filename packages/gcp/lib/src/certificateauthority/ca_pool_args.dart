...
class CaPoolArgs {
  ...
  CaPoolArgs({
    ...
    required String tier,
            ...
            pulumi.Input.asOptionalInput<CaPoolEncryptionSpec>(encryptionSpec),
        issuancePolicy =
            pulumi.Input.asOptionalInput<CaPoolIssuancePolicy>(issuancePolicy),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        location = pulumi.Input.asInput<String>(location),
        name = pulumi.Input.asOptionalInput<String>(name),
        project = pulumi.Input.asOptionalInput<String>(project),
        publishingOptions =
            pulumi.Input.asOptionalInput<CaPoolPublishingOptions>(
                publishingOptions),
  ...
  factory CaPoolArgs.fromMap(Map<String, dynamic> map) {
    return CaPoolArgs(
      ...
      issuancePolicy: map['issuancePolicy'] == null
          ? null
      ...
      publishingOptions: map['publishingOptions'] == null
          ? null
