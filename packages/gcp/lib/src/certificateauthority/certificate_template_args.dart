...
class CertificateTemplateArgs {
  ...
  CertificateTemplateArgs({
    String? description,
    CertificateTemplateIdentityConstraints? identityConstraints,
    Map<String, String>? labels,
    required String location,
    String? maximumLifetime,
    String? name,
    CertificateTemplatePassthroughExtensions? passthroughExtensions,
    CertificateTemplatePredefinedValues? predefinedValues,
    String? project,
  }) :
  ...
  factory CertificateTemplateArgs.fromMap(Map<String, dynamic> map) {
    return CertificateTemplateArgs(
      ...
      identityConstraints: map['identityConstraints'] == null ? null : CertificateTemplateIdentityConstraints.fromMap((map['identityConstraints'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      maximumLifetime: map['maximumLifetime'] == null ? null : map['maximumLifetime'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      passthroughExtensions: map['passthroughExtensions'] == null ? null : CertificateTemplatePassthroughExtensions.fromMap((map['passthroughExtensions'] as Map).cast<String, dynamic>()),
      predefinedValues: map['predefinedValues'] == null ? null : CertificateTemplatePredefinedValues.fromMap((map['predefinedValues'] as Map).cast<String, dynamic>()),
