...
class CertificateTemplatePredefinedValuesNameConstraints {
  ...
  /// Creates a new [CertificateTemplatePredefinedValuesNameConstraints].
  ...
  factory CertificateTemplatePredefinedValuesNameConstraints.fromMap(Map<String, dynamic> map) {
