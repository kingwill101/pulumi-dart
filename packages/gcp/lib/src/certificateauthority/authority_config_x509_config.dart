...
class AuthorityConfigX509Config {
  ...
  final List<AuthorityConfigX509ConfigAdditionalExtension>? additionalExtensions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalExtensions': ?additionalExtensions == null ? null : pulumi.Input.encodeList<AuthorityConfigX509ConfigAdditionalExtension, Map<String, dynamic>>(additionalExtensions!, (value) => value.toMap()),
      ...
      'policyIds': ?policyIds == null ? null : pulumi.Input.encodeList<AuthorityConfigX509ConfigPolicyId, Map<String, dynamic>>(policyIds!, (value) => value.toMap()),
    };
  }

  factory AuthorityConfigX509Config.fromMap(Map<String, dynamic> map) {
    return AuthorityConfigX509Config(
      additionalExtensions: map['additionalExtensions'] == null ? null : pulumi.Input.decodeList<AuthorityConfigX509ConfigAdditionalExtension>(map['additionalExtensions'], (value) => AuthorityConfigX509ConfigAdditionalExtension.fromMap((value as Map).cast<String, dynamic>())),
      aiaOcspServers: map['aiaOcspServers'] == null ? null : (map['aiaOcspServers'] as List).cast<String>(),
      caOptions: AuthorityConfigX509ConfigCaOptions.fromMap((map['caOptions'] as Map).cast<String, dynamic>()),
      keyUsage: AuthorityConfigX509ConfigKeyUsage.fromMap((map['keyUsage'] as Map).cast<String, dynamic>()),
      nameConstraints: map['nameConstraints'] == null ? null : AuthorityConfigX509ConfigNameConstraints.fromMap((map['nameConstraints'] as Map).cast<String, dynamic>()),
      policyIds: map['policyIds'] == null ? null : pulumi.Input.decodeList<AuthorityConfigX509ConfigPolicyId>(map['policyIds'], (value) => AuthorityConfigX509ConfigPolicyId.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
