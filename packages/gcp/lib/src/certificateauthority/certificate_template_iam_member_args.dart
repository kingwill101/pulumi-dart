...
class CertificateTemplateIamMemberArgs {
  ...
  CertificateTemplateIamMemberArgs({
    ...
    CertificateTemplateIamMemberCondition? condition,
    String? location,
  ...
  factory CertificateTemplateIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return CertificateTemplateIamMemberArgs(
      ...
      condition: map['condition'] == null ? null : CertificateTemplateIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
