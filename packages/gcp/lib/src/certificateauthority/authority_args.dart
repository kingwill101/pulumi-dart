...
class AuthorityArgs {
  ...
  AuthorityArgs({
    ...
    AuthorityUserDefinedAccessUrls? userDefinedAccessUrls,
        ...
        ignoreActiveCertificatesOnDeletion = pulumi.Input.asOptionalInput<bool>(
        ...
        pemCaCertificate =
            pulumi.Input.asOptionalInput<String>(pemCaCertificate),
        pool = pulumi.Input.asInput<String>(pool),
        project = pulumi.Input.asOptionalInput<String>(project),
        skipGracePeriod = pulumi.Input.asOptionalInput<bool>(skipGracePeriod),
        subordinateConfig =
            pulumi.Input.asOptionalInput<AuthoritySubordinateConfig>(
                subordinateConfig),
        type = pulumi.Input.asOptionalInput<String>(type),
        userDefinedAccessUrls =
            pulumi.Input.asOptionalInput<AuthorityUserDefinedAccessUrls>(
                userDefinedAccessUrls);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (userDefinedAccessUrlsValue != null) {
      map['userDefinedAccessUrls'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory AuthorityArgs.fromMap(Map<String, dynamic> map) {
    return AuthorityArgs(
      ...
      config: AuthorityConfig.fromMap(
      ...
      ignoreActiveCertificatesOnDeletion:
          map['ignoreActiveCertificatesOnDeletion'] == null
              ? null
              : map['ignoreActiveCertificatesOnDeletion'] as bool,
      keySpec: AuthorityKeySpec.fromMap(
      ...
      pemCaCertificate: map['pemCaCertificate'] == null
          ? null
          : map['pemCaCertificate'] as String,
      pool: map['pool'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      skipGracePeriod: map['skipGracePeriod'] == null
          ? null
          : map['skipGracePeriod'] as bool,
      ...
      userDefinedAccessUrls: map['userDefinedAccessUrls'] == null
          ? null
          : AuthorityUserDefinedAccessUrls.fromMap(
              (map['userDefinedAccessUrls'] as Map).cast<String, dynamic>()),
    );
  }
}
