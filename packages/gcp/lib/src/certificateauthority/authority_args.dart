...
class AuthorityArgs {
  ...
  AuthorityArgs({
    ...
    required AuthorityConfig config,
    bool? deletionProtection,
    String? desiredState,
    String? gcsBucket,
    bool? ignoreActiveCertificatesOnDeletion,
    required AuthorityKeySpec keySpec,
    ...
    AuthoritySubordinateConfig? subordinateConfig,
    String? type,
    AuthorityUserDefinedAccessUrls? userDefinedAccessUrls,
  }) :
  ...
  factory AuthorityArgs.fromMap(Map<String, dynamic> map) {
    return AuthorityArgs(
      ...
      config: AuthorityConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      ...
      ignoreActiveCertificatesOnDeletion: map['ignoreActiveCertificatesOnDeletion'] == null ? null : map['ignoreActiveCertificatesOnDeletion'] as bool,
      keySpec: AuthorityKeySpec.fromMap((map['keySpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      lifetime: map['lifetime'] == null ? null : map['lifetime'] as String,
      location: map['location'] as String,
      pemCaCertificate: map['pemCaCertificate'] == null ? null : map['pemCaCertificate'] as String,
      pool: map['pool'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      skipGracePeriod: map['skipGracePeriod'] == null ? null : map['skipGracePeriod'] as bool,
      subordinateConfig: map['subordinateConfig'] == null ? null : AuthoritySubordinateConfig.fromMap((map['subordinateConfig'] as Map).cast<String, dynamic>()),
      type: map['type'] == null ? null : map['type'] as String,
      userDefinedAccessUrls: map['userDefinedAccessUrls'] == null ? null : AuthorityUserDefinedAccessUrls.fromMap((map['userDefinedAccessUrls'] as Map).cast<String, dynamic>()),
    );
  }
}
