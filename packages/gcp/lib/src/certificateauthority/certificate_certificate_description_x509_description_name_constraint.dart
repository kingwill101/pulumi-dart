...
class CertificateCertificateDescriptionX509DescriptionNameConstraint {
  ...
  /// Creates a new [CertificateCertificateDescriptionX509DescriptionNameConstraint].
  ...
  factory CertificateCertificateDescriptionX509DescriptionNameConstraint.fromMap(
    Map<String, dynamic> map,
  ) {
    return CertificateCertificateDescriptionX509DescriptionNameConstraint(
