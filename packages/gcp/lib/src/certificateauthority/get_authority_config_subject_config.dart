...
class GetAuthorityConfigSubjectConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'subjectAltNames': pulumi.Input.encodeList<GetAuthorityConfigSubjectConfigSubjectAltName, Map<String, dynamic>>(subjectAltNames, (value) => value.toMap()),
      'subjects': pulumi.Input.encodeList<GetAuthorityConfigSubjectConfigSubject, Map<String, dynamic>>(subjects, (value) => value.toMap()),
    };
  }

  factory GetAuthorityConfigSubjectConfig.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfigSubjectConfig(
      subjectAltNames: pulumi.Input.decodeList<GetAuthorityConfigSubjectConfigSubjectAltName>(map['subjectAltNames'], (value) => GetAuthorityConfigSubjectConfigSubjectAltName.fromMap((value as Map).cast<String, dynamic>())),
      subjects: pulumi.Input.decodeList<GetAuthorityConfigSubjectConfigSubject>(map['subjects'], (value) => GetAuthorityConfigSubjectConfigSubject.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
