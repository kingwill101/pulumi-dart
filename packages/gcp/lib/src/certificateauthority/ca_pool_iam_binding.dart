...
import 'ca_pool_iam_binding_args.dart';
...
class CaPoolIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CaPoolIamBindingCondition?> condition;
  ...
  /// Creates a new [CaPoolIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CaPoolIamBinding]. {@macro pulumi_certificateauthority_ca_pool_iam_binding_ca_pool_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  CaPoolIamBinding(
    String name, {
    CaPoolIamBindingArgs? args,
    ...
    this.condition = registerOutput<CaPoolIamBindingCondition?>('condition');
