...
class CaPool extends pulumi.CustomResource {
  ...
  CaPool(String name, {CaPoolArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.encryptionSpec = registerOutput<CaPoolEncryptionSpec?>(
      'encryptionSpec',
    );
    this.issuancePolicy = registerOutput<CaPoolIssuancePolicy?>(
      'issuancePolicy',
    );
    ...
    this.publishingOptions = registerOutput<CaPoolPublishingOptions?>(
      'publishingOptions',
    );
