...
class GetAuthorityConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'subjectConfigs': pulumi.Input.encodeList<GetAuthorityConfigSubjectConfig, Map<String, dynamic>>(subjectConfigs, (value) => value.toMap()),
      'subjectKeyIds': pulumi.Input.encodeList<GetAuthorityConfigSubjectKeyId, Map<String, dynamic>>(subjectKeyIds, (value) => value.toMap()),
      'x509Configs': pulumi.Input.encodeList<GetAuthorityConfigX509Config, Map<String, dynamic>>(x509Configs, (value) => value.toMap()),
    };
  }

  factory GetAuthorityConfig.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfig(
      subjectConfigs: pulumi.Input.decodeList<GetAuthorityConfigSubjectConfig>(map['subjectConfigs'], (value) => GetAuthorityConfigSubjectConfig.fromMap((value as Map).cast<String, dynamic>())),
      subjectKeyIds: pulumi.Input.decodeList<GetAuthorityConfigSubjectKeyId>(map['subjectKeyIds'], (value) => GetAuthorityConfigSubjectKeyId.fromMap((value as Map).cast<String, dynamic>())),
      x509Configs: pulumi.Input.decodeList<GetAuthorityConfigX509Config>(map['x509Configs'], (value) => GetAuthorityConfigX509Config.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
