...
class AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage {
  ...
  /// Creates a new [AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage].
  ...
  factory AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage.fromMap(Map<String, dynamic> map) {
    return AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage(
      ...
      codeSigning: map['codeSigning'] == null ? null : map['codeSigning'] as bool,
      emailProtection: map['emailProtection'] == null ? null : map['emailProtection'] as bool,
      ocspSigning: map['ocspSigning'] == null ? null : map['ocspSigning'] as bool,
      serverAuth: map['serverAuth'] == null ? null : map['serverAuth'] as bool,
      timeStamping: map['timeStamping'] == null ? null : map['timeStamping'] as bool,
    );
  }
}
