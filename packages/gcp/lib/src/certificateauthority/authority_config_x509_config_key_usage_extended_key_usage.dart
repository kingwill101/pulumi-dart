...
class AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage {
  ...
  factory AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage.fromMap(
    ...
    return AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage(
      ...
      codeSigning: map['codeSigning'] == null
          ? null
          : map['codeSigning'] as bool,
      emailProtection: map['emailProtection'] == null
          ? null
          : map['emailProtection'] as bool,
      ocspSigning: map['ocspSigning'] == null
          ? null
          : map['ocspSigning'] as bool,
      serverAuth: map['serverAuth'] == null ? null : map['serverAuth'] as bool,
      timeStamping: map['timeStamping'] == null
          ? null
          : map['timeStamping'] as bool,
    );
  }
}
