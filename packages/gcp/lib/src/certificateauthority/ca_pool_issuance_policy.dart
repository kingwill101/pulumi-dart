...
class CaPoolIssuancePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowedKeyTypes': ?allowedKeyTypes == null ? null : pulumi.Input.encodeList<CaPoolIssuancePolicyAllowedKeyType, Map<String, dynamic>>(allowedKeyTypes!, (value) => value.toMap()),
  ...
  factory CaPoolIssuancePolicy.fromMap(Map<String, dynamic> map) {
    return CaPoolIssuancePolicy(
      allowedIssuanceModes: map['allowedIssuanceModes'] == null ? null : CaPoolIssuancePolicyAllowedIssuanceModes.fromMap((map['allowedIssuanceModes'] as Map).cast<String, dynamic>()),
      allowedKeyTypes: map['allowedKeyTypes'] == null ? null : pulumi.Input.decodeList<CaPoolIssuancePolicyAllowedKeyType>(map['allowedKeyTypes'], (value) => CaPoolIssuancePolicyAllowedKeyType.fromMap((value as Map).cast<String, dynamic>())),
      backdateDuration: map['backdateDuration'] == null ? null : map['backdateDuration'] as String,
      baselineValues: map['baselineValues'] == null ? null : CaPoolIssuancePolicyBaselineValues.fromMap((map['baselineValues'] as Map).cast<String, dynamic>()),
      identityConstraints: map['identityConstraints'] == null ? null : CaPoolIssuancePolicyIdentityConstraints.fromMap((map['identityConstraints'] as Map).cast<String, dynamic>()),
