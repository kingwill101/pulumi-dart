...
class GetAuthorityConfigX509ConfigAdditionalExtension {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'critical': critical,
      'objectIds': pulumi.Input.encodeList<GetAuthorityConfigX509ConfigAdditionalExtensionObjectId, Map<String, dynamic>>(objectIds, (value) => value.toMap()),
      'value': value,
    };
  }
  ...
  factory GetAuthorityConfigX509ConfigAdditionalExtension.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfigX509ConfigAdditionalExtension(
      ...
      objectIds: pulumi.Input.decodeList<GetAuthorityConfigX509ConfigAdditionalExtensionObjectId>(map['objectIds'], (value) => GetAuthorityConfigX509ConfigAdditionalExtensionObjectId.fromMap((value as Map).cast<String, dynamic>())),
