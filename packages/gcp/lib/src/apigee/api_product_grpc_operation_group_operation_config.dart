...
class ApiProductGrpcOperationGroupOperationConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiSource': ?apiSource,
      'attributes': ?attributes == null ? null : pulumi.Input.encodeList<ApiProductGrpcOperationGroupOperationConfigAttribute, Map<String, dynamic>>(attributes!, (value) => value.toMap()),
      'methods': ?methods,
  ...
  factory ApiProductGrpcOperationGroupOperationConfig.fromMap(Map<String, dynamic> map) {
    return ApiProductGrpcOperationGroupOperationConfig(
      ...
      attributes: map['attributes'] == null ? null : pulumi.Input.decodeList<ApiProductGrpcOperationGroupOperationConfigAttribute>(map['attributes'], (value) => ApiProductGrpcOperationGroupOperationConfigAttribute.fromMap((value as Map).cast<String, dynamic>())),
      methods: map['methods'] == null ? null : (map['methods'] as List).cast<String>(),
      quota: map['quota'] == null ? null : ApiProductGrpcOperationGroupOperationConfigQuota.fromMap((map['quota'] as Map).cast<String, dynamic>()),
