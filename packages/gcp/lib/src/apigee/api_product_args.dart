...
class ApiProductArgs {
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      ...
      attributes: map['attributes'] == null ? null : pulumi.Input.decodeList<ApiProductAttribute>(map['attributes'], (value) => ApiProductAttribute.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      environments: map['environments'] == null ? null : (map['environments'] as List).cast<String>(),
      graphqlOperationGroup: map['graphqlOperationGroup'] == null ? null : ApiProductGraphqlOperationGroup.fromMap((map['graphqlOperationGroup'] as Map).cast<String, dynamic>()),
      grpcOperationGroup: map['grpcOperationGroup'] == null ? null : ApiProductGrpcOperationGroup.fromMap((map['grpcOperationGroup'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      operationGroup: map['operationGroup'] == null ? null : ApiProductOperationGroup.fromMap((map['operationGroup'] as Map).cast<String, dynamic>()),
      orgId: map['orgId'] as String,
      proxies: map['proxies'] == null ? null : (map['proxies'] as List).cast<String>(),
      quota: map['quota'] == null ? null : map['quota'] as String,
      quotaCounterScope: map['quotaCounterScope'] == null ? null : map['quotaCounterScope'] as String,
