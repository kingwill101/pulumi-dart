...
class ApiProductGraphqlOperationGroupOperationConfig {
  ...
  final List<ApiProductGraphqlOperationGroupOperationConfigAttribute>? attributes;
  ...
  /// Structure is documented below.
  final List<ApiProductGraphqlOperationGroupOperationConfigOperation>? operations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiSource': ?apiSource,
      'attributes': ?attributes == null ? null : pulumi.Input.encodeList<ApiProductGraphqlOperationGroupOperationConfigAttribute, Map<String, dynamic>>(attributes!, (value) => value.toMap()),
      'operations': ?operations == null ? null : pulumi.Input.encodeList<ApiProductGraphqlOperationGroupOperationConfigOperation, Map<String, dynamic>>(operations!, (value) => value.toMap()),
  ...
  factory ApiProductGraphqlOperationGroupOperationConfig.fromMap(Map<String, dynamic> map) {
    return ApiProductGraphqlOperationGroupOperationConfig(
      ...
      attributes: map['attributes'] == null ? null : pulumi.Input.decodeList<ApiProductGraphqlOperationGroupOperationConfigAttribute>(map['attributes'], (value) => ApiProductGraphqlOperationGroupOperationConfigAttribute.fromMap((value as Map).cast<String, dynamic>())),
      operations: map['operations'] == null ? null : pulumi.Input.decodeList<ApiProductGraphqlOperationGroupOperationConfigOperation>(map['operations'], (value) => ApiProductGraphqlOperationGroupOperationConfigOperation.fromMap((value as Map).cast<String, dynamic>())),
      quota: map['quota'] == null ? null : ApiProductGraphqlOperationGroupOperationConfigQuota.fromMap((map['quota'] as Map).cast<String, dynamic>()),
    );
  }
}
