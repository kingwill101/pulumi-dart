...
class OrganizationArgs {
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      analyticsRegion: map['analyticsRegion'] == null ? null : map['analyticsRegion'] as String,
      ...
      properties: map['properties'] == null ? null : OrganizationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
