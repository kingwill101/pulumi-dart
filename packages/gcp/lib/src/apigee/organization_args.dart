...
class OrganizationArgs {
  ...
  OrganizationArgs({
    ...
    String? runtimeType_,
        ...
        properties =
            pulumi.Input.asOptionalInput<OrganizationProperties>(properties),
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      ...
      billingType:
          map['billingType'] == null ? null : map['billingType'] as String,
      controlPlaneEncryptionKeyName:
      ...
      runtimeType_:
          map['runtimeType'] == null ? null : map['runtimeType'] as String,
    );
  }
}
