...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? peeringCidrRange,
       ...
       diskEncryptionKeyName = pulumi.Input.asOptionalInput<String>(
       ...
       peeringCidrRange = pulumi.Input.asOptionalInput<String>(
         peeringCidrRange,
       );
    ...
    return <String, dynamic>{
      'accessLoggingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(accessLoggingConfig, (value) => value.toMap()),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      accessLoggingConfig: map['accessLoggingConfig'] == null
          ? null
          : InstanceAccessLoggingConfig.fromMap(
              (map['accessLoggingConfig'] as Map).cast<String, dynamic>(),
            ),
      ...
      diskEncryptionKeyName: map['diskEncryptionKeyName'] == null
          ? null
          : map['diskEncryptionKeyName'] as String,
      ...
      peeringCidrRange: map['peeringCidrRange'] == null
          ? null
          : map['peeringCidrRange'] as String,
    );
  }
}
