...
class AppGroupArgs {
  ...
  factory AppGroupArgs.fromMap(Map<String, dynamic> map) {
    return AppGroupArgs(
      attributes: map['attributes'] == null ? null : pulumi.Input.decodeList<AppGroupAttribute>(map['attributes'], (value) => AppGroupAttribute.fromMap((value as Map).cast<String, dynamic>())),
      channelId: map['channelId'] == null ? null : map['channelId'] as String,
      channelUri: map['channelUri'] == null ? null : map['channelUri'] as String,
