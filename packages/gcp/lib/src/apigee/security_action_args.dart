...
class SecurityActionArgs {
  ...
  factory SecurityActionArgs.fromMap(Map<String, dynamic> map) {
    return SecurityActionArgs(
      ...
      apiProxies: map['apiProxies'] == null ? null : (map['apiProxies'] as List).cast<String>(),
      conditionConfig: SecurityActionConditionConfig.fromMap((map['conditionConfig'] as Map).cast<String, dynamic>()),
      deny: map['deny'] == null ? null : SecurityActionDeny.fromMap((map['deny'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      envId: map['envId'] as String,
      expireTime: map['expireTime'] == null ? null : map['expireTime'] as String,
      flag: map['flag'] == null ? null : SecurityActionFlag.fromMap((map['flag'] as Map).cast<String, dynamic>()),
