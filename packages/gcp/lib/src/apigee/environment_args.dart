...
class EnvironmentArgs {
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      apiProxyType: map['apiProxyType'] == null ? null : map['apiProxyType'] as String,
      clientIpResolutionConfig: map['clientIpResolutionConfig'] == null ? null : EnvironmentClientIpResolutionConfig.fromMap((map['clientIpResolutionConfig'] as Map).cast<String, dynamic>()),
      ...
      nodeConfig: map['nodeConfig'] == null ? null : EnvironmentNodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      orgId: map['orgId'] as String,
      properties: map['properties'] == null ? null : EnvironmentProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
