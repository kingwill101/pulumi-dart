...
class QueueArgs {
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      appEngineRoutingOverride: map['appEngineRoutingOverride'] == null ? null : QueueAppEngineRoutingOverride.fromMap((map['appEngineRoutingOverride'] as Map).cast<String, dynamic>()),
      desiredState: map['desiredState'] == null ? null : map['desiredState'] as String,
      httpTarget: map['httpTarget'] == null ? null : QueueHttpTarget.fromMap((map['httpTarget'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rateLimits: map['rateLimits'] == null ? null : QueueRateLimits.fromMap((map['rateLimits'] as Map).cast<String, dynamic>()),
      retryConfig: map['retryConfig'] == null ? null : QueueRetryConfig.fromMap((map['retryConfig'] as Map).cast<String, dynamic>()),
      stackdriverLoggingConfig: map['stackdriverLoggingConfig'] == null ? null : QueueStackdriverLoggingConfig.fromMap((map['stackdriverLoggingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
