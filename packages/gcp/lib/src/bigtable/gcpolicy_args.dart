...
class GCPolicyArgs {
  ...
  factory GCPolicyArgs.fromMap(Map<String, dynamic> map) {
    return GCPolicyArgs(
      ...
      maxAge: map['maxAge'] == null ? null : GCPolicyMaxAge.fromMap((map['maxAge'] as Map).cast<String, dynamic>()),
      maxVersions: map['maxVersions'] == null ? null : pulumi.Input.decodeList<GCPolicyMaxVersion>(map['maxVersions'], (value) => GCPolicyMaxVersion.fromMap((value as Map).cast<String, dynamic>())),
