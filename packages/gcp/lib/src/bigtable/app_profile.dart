...
class AppProfile extends pulumi.CustomResource {
  ...
  AppProfile(
    ...
    this.multiClusterRoutingClusterIds = registerOutput<List<String>?>(
      'multiClusterRoutingClusterIds',
    );
    this.multiClusterRoutingUseAny = registerOutput<bool?>(
      'multiClusterRoutingUseAny',
    );
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.rowAffinity = registerOutput<bool?>('rowAffinity');
    this.singleClusterRouting = registerOutput<AppProfileSingleClusterRouting?>(
      'singleClusterRouting',
    );
    this.standardIsolation = registerOutput<AppProfileStandardIsolation>(
      'standardIsolation',
    );
  }
}
