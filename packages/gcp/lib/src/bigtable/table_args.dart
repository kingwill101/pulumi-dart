...
class TableArgs {
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      automatedBackupPolicy: map['automatedBackupPolicy'] == null ? null : TableAutomatedBackupPolicy.fromMap((map['automatedBackupPolicy'] as Map).cast<String, dynamic>()),
      changeStreamRetention: map['changeStreamRetention'] == null ? null : map['changeStreamRetention'] as String,
      columnFamilies: map['columnFamilies'] == null ? null : pulumi.Input.decodeList<TableColumnFamily>(map['columnFamilies'], (value) => TableColumnFamily.fromMap((value as Map).cast<String, dynamic>())),
      deletionProtection: map['deletionProtection'] == null ? null : map['deletionProtection'] as String,
      instanceName: map['instanceName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rowKeySchema: map['rowKeySchema'] == null ? null : map['rowKeySchema'] as String,
      splitKeys: map['splitKeys'] == null ? null : (map['splitKeys'] as List).cast<String>(),
    );
  }
}
