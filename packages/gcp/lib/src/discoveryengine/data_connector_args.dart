...
class DataConnectorArgs {
  ...
  DataConnectorArgs({
    ...
    String? syncMode,
       ...
       collectionDisplayName = pulumi.Input.asInput<String>(
         collectionDisplayName,
       ),
       collectionId = pulumi.Input.asInput<String>(collectionId),
       connectorModes = pulumi.Input.asOptionalInput<List<String>>(
         connectorModes,
       ),
       ...
       incrementalSyncDisabled = pulumi.Input.asOptionalInput<bool>(
  ...
  factory DataConnectorArgs.fromMap(Map<String, dynamic> map) {
    return DataConnectorArgs(
      ...
      jsonParams: map['jsonParams'] == null
          ? null
          : map['jsonParams'] as String,
