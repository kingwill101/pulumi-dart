...
class DataConnectorArgs {
  ...
  DataConnectorArgs({
    ...
    String? syncMode,
      ...
      collectionDisplayName = pulumi.Input.asInput<String>(collectionDisplayName),
  ...
  factory DataConnectorArgs.fromMap(Map<String, dynamic> map) {
    return DataConnectorArgs(
      autoRunDisabled: map['autoRunDisabled'] == null ? null : map['autoRunDisabled'] as bool,
      collectionDisplayName: map['collectionDisplayName'] as String,
      collectionId: map['collectionId'] as String,
      connectorModes: map['connectorModes'] == null ? null : (map['connectorModes'] as List).cast<String>(),
      dataSource: map['dataSource'] as String,
      entities: map['entities'] == null ? null : pulumi.Input.decodeList<DataConnectorEntity>(map['entities'], (value) => DataConnectorEntity.fromMap((value as Map).cast<String, dynamic>())),
      incrementalRefreshInterval: map['incrementalRefreshInterval'] == null ? null : map['incrementalRefreshInterval'] as String,
      incrementalSyncDisabled: map['incrementalSyncDisabled'] == null ? null : map['incrementalSyncDisabled'] as bool,
      ...
      staticIpEnabled: map['staticIpEnabled'] == null ? null : map['staticIpEnabled'] as bool,
