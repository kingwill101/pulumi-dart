...
class AssistantArgs {
  ...
  factory AssistantArgs.fromMap(Map<String, dynamic> map) {
    return AssistantArgs(
      ...
      customerPolicy: map['customerPolicy'] == null ? null : AssistantCustomerPolicy.fromMap((map['customerPolicy'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      engineId: map['engineId'] as String,
      generationConfig: map['generationConfig'] == null ? null : AssistantGenerationConfig.fromMap((map['generationConfig'] as Map).cast<String, dynamic>()),
