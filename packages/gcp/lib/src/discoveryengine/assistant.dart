...
class Assistant extends pulumi.CustomResource {
  ...
  Assistant(
    ...
    this.customerPolicy = registerOutput<AssistantCustomerPolicy?>('customerPolicy');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.engineId = registerOutput<String>('engineId');
    this.generationConfig = registerOutput<AssistantGenerationConfig?>('generationConfig');
