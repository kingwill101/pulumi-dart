  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'chunkingConfig': ?chunkingConfig == null
          ? null
          : chunkingConfig!.toMap(),
      'defaultParsingConfig': ?defaultParsingConfig == null
          ? null
          : defaultParsingConfig!.toMap(),
      'name': ?name,
      'parsingConfigOverrides': ?parsingConfigOverrides == null
          ? null
          : pulumi.Input.encodeList<
              DataStoreDocumentProcessingConfigParsingConfigOverride,
              Map<String, dynamic>
            >(parsingConfigOverrides!, (value) => value.toMap()),
    };
  }
