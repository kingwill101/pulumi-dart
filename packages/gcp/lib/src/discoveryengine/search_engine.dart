...
class SearchEngine extends pulumi.CustomResource {
  ...
  SearchEngine(
    ...
    this.commonConfig = registerOutput<SearchEngineCommonConfig?>('commonConfig');
    ...
    this.searchEngineConfig = registerOutput<SearchEngineSearchEngineConfig>('searchEngineConfig');
