...
class UserStore extends pulumi.CustomResource {
  ...
  UserStore(
    ...
    this.enableExpiredLicenseAutoUpdate = registerOutput<bool?>('enableExpiredLicenseAutoUpdate');
    this.enableLicenseAutoRegister = registerOutput<bool?>('enableLicenseAutoRegister');
