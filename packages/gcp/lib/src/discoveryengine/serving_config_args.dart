...
class ServingConfigArgs {
  ...
  factory ServingConfigArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigArgs(
      ...
      promoteControlIds: map['promoteControlIds'] == null ? null : (map['promoteControlIds'] as List).cast<String>(),
      redirectControlIds: map['redirectControlIds'] == null ? null : (map['redirectControlIds'] as List).cast<String>(),
      servingConfigId: map['servingConfigId'] == null ? null : map['servingConfigId'] as String,
      synonymsControlIds: map['synonymsControlIds'] == null ? null : (map['synonymsControlIds'] as List).cast<String>(),
    );
  }
}
