...
class UserStoreArgs {
  ...
  UserStoreArgs({
    ...
    String? project,
    String? userStoreId,
  }) : defaultLicenseConfig = pulumi.Input.asOptionalInput<String>(
         defaultLicenseConfig,
       ),
       enableExpiredLicenseAutoUpdate = pulumi.Input.asOptionalInput<bool>(
         enableExpiredLicenseAutoUpdate,
       ),
       enableLicenseAutoRegister = pulumi.Input.asOptionalInput<bool>(
  ...
  factory UserStoreArgs.fromMap(Map<String, dynamic> map) {
    return UserStoreArgs(
      ...
      userStoreId: map['userStoreId'] == null
          ? null
          : map['userStoreId'] as String,
    );
  }
}
