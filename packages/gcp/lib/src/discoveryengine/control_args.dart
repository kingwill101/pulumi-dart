...
class ControlArgs {
  ...
  factory ControlArgs.fromMap(Map<String, dynamic> map) {
    return ControlArgs(
      boostAction: map['boostAction'] == null ? null : ControlBoostAction.fromMap((map['boostAction'] as Map).cast<String, dynamic>()),
      collectionId: map['collectionId'] == null ? null : map['collectionId'] as String,
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<ControlCondition>(map['conditions'], (value) => ControlCondition.fromMap((value as Map).cast<String, dynamic>())),
      controlId: map['controlId'] as String,
      displayName: map['displayName'] as String,
      engineId: map['engineId'] as String,
      filterAction: map['filterAction'] == null ? null : ControlFilterAction.fromMap((map['filterAction'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      promoteAction: map['promoteAction'] == null ? null : ControlPromoteAction.fromMap((map['promoteAction'] as Map).cast<String, dynamic>()),
      redirectAction: map['redirectAction'] == null ? null : ControlRedirectAction.fromMap((map['redirectAction'] as Map).cast<String, dynamic>()),
      solutionType: map['solutionType'] as String,
      synonymsAction: map['synonymsAction'] == null ? null : ControlSynonymsAction.fromMap((map['synonymsAction'] as Map).cast<String, dynamic>()),
