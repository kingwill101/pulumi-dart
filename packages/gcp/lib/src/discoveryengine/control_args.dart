...
class ControlArgs {
  ...
  ControlArgs({
    ...
    List<String>? useCases,
            ...
            pulumi.Input.asOptionalInput<ControlBoostAction>(boostAction),
        collectionId = pulumi.Input.asOptionalInput<String>(collectionId),
        conditions =
            pulumi.Input.asOptionalInput<List<ControlCondition>>(conditions),
        controlId = pulumi.Input.asInput<String>(controlId),
        displayName = pulumi.Input.asInput<String>(displayName),
        engineId = pulumi.Input.asInput<String>(engineId),
        filterAction =
            pulumi.Input.asOptionalInput<ControlFilterAction>(filterAction),
        location = pulumi.Input.asInput<String>(location),
        project = pulumi.Input.asOptionalInput<String>(project),
        promoteAction =
            pulumi.Input.asOptionalInput<ControlPromoteAction>(promoteAction),
        redirectAction =
            pulumi.Input.asOptionalInput<ControlRedirectAction>(redirectAction),
        solutionType = pulumi.Input.asInput<String>(solutionType),
        synonymsAction =
            pulumi.Input.asOptionalInput<ControlSynonymsAction>(synonymsAction),
