...
class WidgetConfigArgs {
  ...
  }) : accessSettings = pulumi
           .Input.asOptionalInput<WidgetConfigAccessSettings>(accessSettings),
       collectionId = pulumi.Input.asOptionalInput<String>(collectionId),
       engineId = pulumi.Input.asInput<String>(engineId),
       homepageSetting = pulumi
           .Input.asOptionalInput<WidgetConfigHomepageSetting>(homepageSetting),
    ...
    return <String, dynamic>{
      ...
      'homepageSetting':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(homepageSetting, (value) => value.toMap()),
      'location': location,
      'project': ?project,
      'uiBranding':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(uiBranding, (value) => value.toMap()),
      'uiSettings':
          ?pulumi.Input.mapOptionalInputValue<
            WidgetConfigUiSettings,
            Map<String, dynamic>
          >(uiSettings, (value) => value.toMap()),
