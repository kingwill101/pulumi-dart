...
class WidgetConfigArgs {
  ...
  factory WidgetConfigArgs.fromMap(Map<String, dynamic> map) {
    return WidgetConfigArgs(
      accessSettings: map['accessSettings'] == null ? null : WidgetConfigAccessSettings.fromMap((map['accessSettings'] as Map).cast<String, dynamic>()),
      collectionId: map['collectionId'] == null ? null : map['collectionId'] as String,
      engineId: map['engineId'] as String,
      homepageSetting: map['homepageSetting'] == null ? null : WidgetConfigHomepageSetting.fromMap((map['homepageSetting'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      uiBranding: map['uiBranding'] == null ? null : WidgetConfigUiBranding.fromMap((map['uiBranding'] as Map).cast<String, dynamic>()),
      uiSettings: map['uiSettings'] == null ? null : WidgetConfigUiSettings.fromMap((map['uiSettings'] as Map).cast<String, dynamic>()),
      widgetConfigId: map['widgetConfigId'] == null ? null : map['widgetConfigId'] as String,
    );
  }
}
