...
class ControlBoostAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interpolationBoostSpec': ?interpolationBoostSpec == null ? null : interpolationBoostSpec!.toMap(),
    };
  }
  ...
  factory ControlBoostAction.fromMap(Map<String, dynamic> map) {
    return ControlBoostAction(
      ...
      fixedBoost: map['fixedBoost'] == null ? null : map['fixedBoost'] as double,
      interpolationBoostSpec: map['interpolationBoostSpec'] == null ? null : ControlBoostActionInterpolationBoostSpec.fromMap((map['interpolationBoostSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
