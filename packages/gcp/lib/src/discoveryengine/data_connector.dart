...
class DataConnector extends pulumi.CustomResource {
  ...
  DataConnector(
    ...
    this.collectionDisplayName = registerOutput<String>(
    ...
    this.incrementalRefreshInterval = registerOutput<String?>(
      'incrementalRefreshInterval',
    );
    this.incrementalSyncDisabled = registerOutput<bool?>(
    ...
    this.privateConnectivityProjectId = registerOutput<String>(
