...
class WidgetConfigUiSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final defaultSearchRequestOrderByValue = defaultSearchRequestOrderBy;
    if (defaultSearchRequestOrderByValue != null) {
      map['defaultSearchRequestOrderBy'] = defaultSearchRequestOrderByValue;
    }
    final disableUserEventsCollectionValue = disableUserEventsCollection;
    if (disableUserEventsCollectionValue != null) {
      map['disableUserEventsCollection'] = disableUserEventsCollectionValue;
    }
    final enableAutocompleteValue = enableAutocomplete;
    if (enableAutocompleteValue != null) {
      map['enableAutocomplete'] = enableAutocompleteValue;
    }
    final enableCreateAgentButtonValue = enableCreateAgentButton;
    if (enableCreateAgentButtonValue != null) {
      map['enableCreateAgentButton'] = enableCreateAgentButtonValue;
    }
    final enablePeopleSearchValue = enablePeopleSearch;
    if (enablePeopleSearchValue != null) {
      map['enablePeopleSearch'] = enablePeopleSearchValue;
    }
    final enableQualityFeedbackValue = enableQualityFeedback;
    if (enableQualityFeedbackValue != null) {
      map['enableQualityFeedback'] = enableQualityFeedbackValue;
    }
    final enableSafeSearchValue = enableSafeSearch;
    if (enableSafeSearchValue != null) {
      map['enableSafeSearch'] = enableSafeSearchValue;
    }
    final enableSearchAsYouTypeValue = enableSearchAsYouType;
    if (enableSearchAsYouTypeValue != null) {
      map['enableSearchAsYouType'] = enableSearchAsYouTypeValue;
    }
    final enableVisualContentSummaryValue = enableVisualContentSummary;
    if (enableVisualContentSummaryValue != null) {
      map['enableVisualContentSummary'] = enableVisualContentSummaryValue;
    }
    final generativeAnswerConfigValue = generativeAnswerConfig;
    if (generativeAnswerConfigValue != null) {
      map['generativeAnswerConfig'] = generativeAnswerConfigValue.toMap();
    }
    final interactionTypeValue = interactionType;
    if (interactionTypeValue != null) {
      map['interactionType'] = interactionTypeValue;
    }
    final resultDescriptionTypeValue = resultDescriptionType;
    if (resultDescriptionTypeValue != null) {
      map['resultDescriptionType'] = resultDescriptionTypeValue;
    }
    return map;
  }
