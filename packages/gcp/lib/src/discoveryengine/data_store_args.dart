...
class DataStoreArgs {
  ...
  factory DataStoreArgs.fromMap(Map<String, dynamic> map) {
    return DataStoreArgs(
      advancedSiteSearchConfig: map['advancedSiteSearchConfig'] == null ? null : DataStoreAdvancedSiteSearchConfig.fromMap((map['advancedSiteSearchConfig'] as Map).cast<String, dynamic>()),
      ...
      documentProcessingConfig: map['documentProcessingConfig'] == null ? null : DataStoreDocumentProcessingConfig.fromMap((map['documentProcessingConfig'] as Map).cast<String, dynamic>()),
      ...
      skipDefaultSchemaCreation: map['skipDefaultSchemaCreation'] == null ? null : map['skipDefaultSchemaCreation'] as bool,
      solutionTypes: map['solutionTypes'] == null ? null : (map['solutionTypes'] as List).cast<String>(),
    );
  }
}
