...
class DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig {
  ...
  factory DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig.fromMap(Map<String, dynamic> map) {
    return DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig(
      enableImageAnnotation: map['enableImageAnnotation'] == null ? null : map['enableImageAnnotation'] as bool,
      enableTableAnnotation: map['enableTableAnnotation'] == null ? null : map['enableTableAnnotation'] as bool,
      excludeHtmlClasses: map['excludeHtmlClasses'] == null ? null : (map['excludeHtmlClasses'] as List).cast<String>(),
      excludeHtmlElements: map['excludeHtmlElements'] == null ? null : (map['excludeHtmlElements'] as List).cast<String>(),
      excludeHtmlIds: map['excludeHtmlIds'] == null ? null : (map['excludeHtmlIds'] as List).cast<String>(),
      structuredContentTypes: map['structuredContentTypes'] == null ? null : (map['structuredContentTypes'] as List).cast<String>(),
    );
  }
}
