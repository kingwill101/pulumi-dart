...
class LicenseConfigStartDate {
  ...
  /// Creates a new [LicenseConfigStartDate].
  ...
  LicenseConfigStartDate({this.day, this.month, this.year});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'day': ?day, 'month': ?month, 'year': ?year};
  }

  factory LicenseConfigStartDate.fromMap(Map<String, dynamic> map) {
    return LicenseConfigStartDate(
