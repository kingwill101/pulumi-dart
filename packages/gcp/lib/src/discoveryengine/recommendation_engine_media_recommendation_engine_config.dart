...
class RecommendationEngineMediaRecommendationEngineConfig {
  ...
  final RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfig? engineFeaturesConfig;
  ...
  /// Structure is documented below.
  final RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig? optimizationObjectiveConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'engineFeaturesConfig': ?engineFeaturesConfig == null ? null : engineFeaturesConfig!.toMap(),
      'optimizationObjective': ?optimizationObjective,
      'optimizationObjectiveConfig': ?optimizationObjectiveConfig == null ? null : optimizationObjectiveConfig!.toMap(),
  ...
  factory RecommendationEngineMediaRecommendationEngineConfig.fromMap(Map<String, dynamic> map) {
    return RecommendationEngineMediaRecommendationEngineConfig(
      engineFeaturesConfig: map['engineFeaturesConfig'] == null ? null : RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfig.fromMap((map['engineFeaturesConfig'] as Map).cast<String, dynamic>()),
      optimizationObjective: map['optimizationObjective'] == null ? null : map['optimizationObjective'] as String,
      optimizationObjectiveConfig: map['optimizationObjectiveConfig'] == null ? null : RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig.fromMap((map['optimizationObjectiveConfig'] as Map).cast<String, dynamic>()),
      trainingState: map['trainingState'] == null ? null : map['trainingState'] as String,
