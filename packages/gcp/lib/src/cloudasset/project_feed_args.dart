...
class ProjectFeedArgs {
  ...
  ProjectFeedArgs({
    ...
    String? project,
        ...
        condition =
            pulumi.Input.asOptionalInput<ProjectFeedCondition>(condition),
        contentType = pulumi.Input.asOptionalInput<String>(contentType),
        feedId = pulumi.Input.asInput<String>(feedId),
        feedOutputConfig =
            pulumi.Input.asInput<ProjectFeedFeedOutputConfig>(feedOutputConfig),
  ...
  factory ProjectFeedArgs.fromMap(Map<String, dynamic> map) {
    return ProjectFeedArgs(
      ...
      billingProject: map['billingProject'] == null
          ? null
          : map['billingProject'] as String,
      condition: map['condition'] == null
          ? null
          : ProjectFeedCondition.fromMap(
              (map['condition'] as Map).cast<String, dynamic>()),
      contentType:
          map['contentType'] == null ? null : map['contentType'] as String,
      feedId: map['feedId'] as String,
      feedOutputConfig: ProjectFeedFeedOutputConfig.fromMap(
