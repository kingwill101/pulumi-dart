...
class OrganizationFeedArgs {
  ...
  OrganizationFeedArgs({
    ...
    required String orgId,
        ...
        condition =
            pulumi.Input.asOptionalInput<OrganizationFeedCondition>(condition),
        contentType = pulumi.Input.asOptionalInput<String>(contentType),
        feedId = pulumi.Input.asInput<String>(feedId),
        feedOutputConfig =
            pulumi.Input.asInput<OrganizationFeedFeedOutputConfig>(
                feedOutputConfig),
  ...
  factory OrganizationFeedArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationFeedArgs(
      ...
      feedOutputConfig: OrganizationFeedFeedOutputConfig.fromMap(
