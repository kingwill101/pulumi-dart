...
class OrganizationFeedCondition {
  ...
  /// Creates a new [OrganizationFeedCondition].
  ...
  factory OrganizationFeedCondition.fromMap(Map<String, dynamic> map) {
    return OrganizationFeedCondition(
