...
class HostingCustomDomainCertVerificationDnsDesired {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'records': ?records == null ? null : pulumi.Input.encodeList<HostingCustomDomainCertVerificationDnsDesiredRecord, Map<String, dynamic>>(records!, (value) => value.toMap()),
    };
  }
  ...
  factory HostingCustomDomainCertVerificationDnsDesired.fromMap(Map<String, dynamic> map) {
    return HostingCustomDomainCertVerificationDnsDesired(
      ...
      records: map['records'] == null ? null : pulumi.Input.decodeList<HostingCustomDomainCertVerificationDnsDesiredRecord>(map['records'], (value) => HostingCustomDomainCertVerificationDnsDesiredRecord.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
