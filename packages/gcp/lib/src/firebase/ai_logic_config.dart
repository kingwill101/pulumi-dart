...
class AiLogicConfig extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [AiLogicConfig]. {@macro pulumi_firebase_ai_logic_config_ai_logic_config_args_doc}
  ...
  AiLogicConfig(
    ...
    this.telemetryConfig = registerOutput<AiLogicConfigTelemetryConfig?>(
      'telemetryConfig',
    );
  }
}
