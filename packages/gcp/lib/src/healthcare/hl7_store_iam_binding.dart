...
import 'hl7_store_iam_binding_args.dart';
...
class Hl7StoreIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<Hl7StoreIamBindingCondition?> condition;
  ...
  /// Creates a new [Hl7StoreIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Hl7StoreIamBinding]. {@macro pulumi_healthcare_hl7_store_iam_binding_hl7_store_iam_binding_args_doc}
  ...
  Hl7StoreIamBinding(
    ...
    this.condition = registerOutput<Hl7StoreIamBindingCondition?>('condition');
