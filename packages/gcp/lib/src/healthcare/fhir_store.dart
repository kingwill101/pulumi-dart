...
class FhirStore extends pulumi.CustomResource {
  ...
  FhirStore(
    ...
    this.consentConfig = registerOutput<FhirStoreConsentConfig?>(
      'consentConfig',
    );
    ...
    this.enableHistoryModifications = registerOutput<bool?>(
      'enableHistoryModifications',
    );
    this.enableUpdateCreate = registerOutput<bool?>('enableUpdateCreate');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.name = registerOutput<String>('name');
    this.notificationConfig = registerOutput<FhirStoreNotificationConfig?>(
      'notificationConfig',
    );
    ...
    this.streamConfigs = registerOutput<List<FhirStoreStreamConfig>?>(
      'streamConfigs',
    );
    this.validationConfig = registerOutput<FhirStoreValidationConfig?>(
      'validationConfig',
    );
