    ...
    bool? rejectDuplicateMessage,
        ...
        notificationConfigs =
            pulumi.Input.asOptionalInput<List<Hl7StoreNotificationConfigs>>(
                notificationConfigs),
        parserConfig =
            pulumi.Input.asOptionalInput<Hl7StoreParserConfig>(parserConfig),
