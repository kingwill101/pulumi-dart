...
class FhirStoreArgs {
  ...
  FhirStoreArgs({
    ...
    String? version,
            ...
            complexDataTypeReferenceParsing),
        consentConfig =
            pulumi.Input.asOptionalInput<FhirStoreConsentConfig>(consentConfig),
        ...
        enableHistoryImport =
            pulumi.Input.asOptionalInput<bool>(enableHistoryImport),
        enableHistoryModifications =
            pulumi.Input.asOptionalInput<bool>(enableHistoryModifications),
        enableUpdateCreate =
        ...
        notificationConfigs =
            pulumi.Input.asOptionalInput<List<FhirStoreNotificationConfig>>(
                notificationConfigs),
        streamConfigs =
            pulumi.Input.asOptionalInput<List<FhirStoreStreamConfig>>(
                streamConfigs),
        validationConfig =
            pulumi.Input.asOptionalInput<FhirStoreValidationConfig>(
                validationConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (consentConfigValue != null) {
      map['consentConfig'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (notificationConfigsValue != null) {
      map['notificationConfigs'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<FhirStoreNotificationConfig,
    ...
    if (streamConfigsValue != null) {
      map['streamConfigs'] = pulumi.Input.mapOptionalInputValue<
          ...
          streamConfigsValue,
          (value) => pulumi.Input.encodeList<FhirStoreStreamConfig,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
