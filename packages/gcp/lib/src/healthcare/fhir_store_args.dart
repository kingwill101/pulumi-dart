...
class FhirStoreArgs {
  ...
  FhirStoreArgs({
    ...
    String? version,
      ...
      complexDataTypeReferenceParsing = pulumi.Input.asOptionalInput<String>(complexDataTypeReferenceParsing),
      consentConfig = pulumi.Input.asOptionalInput<FhirStoreConsentConfig>(consentConfig),
      ...
      enableHistoryImport = pulumi.Input.asOptionalInput<bool>(enableHistoryImport),
      enableHistoryModifications = pulumi.Input.asOptionalInput<bool>(enableHistoryModifications),
      enableUpdateCreate = pulumi.Input.asOptionalInput<bool>(enableUpdateCreate),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      name = pulumi.Input.asOptionalInput<String>(name),
      notificationConfig = pulumi.Input.asOptionalInput<FhirStoreNotificationConfig>(notificationConfig),
      notificationConfigs = pulumi.Input.asOptionalInput<List<FhirStoreNotificationConfig>>(notificationConfigs),
      streamConfigs = pulumi.Input.asOptionalInput<List<FhirStoreStreamConfig>>(streamConfigs),
      validationConfig = pulumi.Input.asOptionalInput<FhirStoreValidationConfig>(validationConfig),
  ...
  factory FhirStoreArgs.fromMap(Map<String, dynamic> map) {
    return FhirStoreArgs(
      complexDataTypeReferenceParsing: map['complexDataTypeReferenceParsing'] == null ? null : map['complexDataTypeReferenceParsing'] as String,
      consentConfig: map['consentConfig'] == null ? null : FhirStoreConsentConfig.fromMap((map['consentConfig'] as Map).cast<String, dynamic>()),
      ...
      enableHistoryImport: map['enableHistoryImport'] == null ? null : map['enableHistoryImport'] as bool,
      enableHistoryModifications: map['enableHistoryModifications'] == null ? null : map['enableHistoryModifications'] as bool,
      enableUpdateCreate: map['enableUpdateCreate'] == null ? null : map['enableUpdateCreate'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      notificationConfig: map['notificationConfig'] == null ? null : FhirStoreNotificationConfig.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>()),
      notificationConfigs: map['notificationConfigs'] == null ? null : pulumi.Input.decodeList<FhirStoreNotificationConfig>(map['notificationConfigs'], (value) => FhirStoreNotificationConfig.fromMap((value as Map).cast<String, dynamic>())),
      streamConfigs: map['streamConfigs'] == null ? null : pulumi.Input.decodeList<FhirStoreStreamConfig>(map['streamConfigs'], (value) => FhirStoreStreamConfig.fromMap((value as Map).cast<String, dynamic>())),
      validationConfig: map['validationConfig'] == null ? null : FhirStoreValidationConfig.fromMap((map['validationConfig'] as Map).cast<String, dynamic>()),
