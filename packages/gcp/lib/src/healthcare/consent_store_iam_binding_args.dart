...
class ConsentStoreIamBindingArgs {
  ...
  ConsentStoreIamBindingArgs({
    ConsentStoreIamBindingCondition? condition,
  ...
  factory ConsentStoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConsentStoreIamBindingArgs(
      condition: map['condition'] == null ? null : ConsentStoreIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
