...
class FhirStoreStreamConfigBigqueryDestinationSchemaConfig {
  ...
  final FhirStoreStreamConfigBigqueryDestinationSchemaConfigLastUpdatedPartitionConfig? lastUpdatedPartitionConfig;
  ...
  factory FhirStoreStreamConfigBigqueryDestinationSchemaConfig.fromMap(Map<String, dynamic> map) {
    return FhirStoreStreamConfigBigqueryDestinationSchemaConfig(
      lastUpdatedPartitionConfig: map['lastUpdatedPartitionConfig'] == null ? null : FhirStoreStreamConfigBigqueryDestinationSchemaConfigLastUpdatedPartitionConfig.fromMap((map['lastUpdatedPartitionConfig'] as Map).cast<String, dynamic>()),
