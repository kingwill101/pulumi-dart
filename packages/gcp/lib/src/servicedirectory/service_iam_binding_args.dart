...
/// {@template pulumi_servicedirectory_service_iam_binding_service_iam_binding_args_doc}
/// The set of arguments for ServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_service_iam_binding_service_iam_binding_args_doc}
class ServiceIamBindingArgs {
  ...
  ServiceIamBindingArgs({
    ServiceIamBindingCondition? condition,
  ...
  factory ServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamBindingArgs(
      condition: map['condition'] == null ? null : ServiceIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
