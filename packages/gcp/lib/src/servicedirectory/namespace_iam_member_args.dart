...
/// {@template pulumi_servicedirectory_namespace_iam_member_namespace_iam_member_args_doc}
/// The set of arguments for NamespaceIamMember.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_namespace_iam_member_namespace_iam_member_args_doc}
class NamespaceIamMemberArgs {
  ...
  NamespaceIamMemberArgs({
    NamespaceIamMemberCondition? condition,
  ...
  factory NamespaceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceIamMemberArgs(
      condition: map['condition'] == null ? null : NamespaceIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
