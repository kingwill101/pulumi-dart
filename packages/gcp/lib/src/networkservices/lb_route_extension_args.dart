...
class LbRouteExtensionArgs {
  ...
  LbRouteExtensionArgs({
    String? description,
    required List<LbRouteExtensionExtensionChain> extensionChains,
  ...
  factory LbRouteExtensionArgs.fromMap(Map<String, dynamic> map) {
    return LbRouteExtensionArgs(
      ...
      extensionChains: pulumi.Input.decodeList<LbRouteExtensionExtensionChain>(map['extensionChains'], (value) => LbRouteExtensionExtensionChain.fromMap((value as Map).cast<String, dynamic>())),
