...
class EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction {
  ...
  final List<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAdd>? requestHeaderToAdds;
  /// A list of header names for headers that need to be removed from the request prior to forwarding the request to the origin.
  /// Structure is documented below.
  final List<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemove>? requestHeaderToRemoves;
  /// Headers to add to the response prior to sending it back to the client.
  /// Response headers are only sent to the client, and do not have an effect on the cache serving the response.
  /// Structure is documented below.
  final List<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToAdd>? responseHeaderToAdds;
  /// A list of header names for headers that need to be removed from the request prior to forwarding the request to the origin.
  /// Structure is documented below.
  final List<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemove>? responseHeaderToRemoves;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'requestHeaderToAdds': ?requestHeaderToAdds == null ? null : pulumi.Input.encodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAdd, Map<String, dynamic>>(requestHeaderToAdds!, (value) => value.toMap()),
      'requestHeaderToRemoves': ?requestHeaderToRemoves == null ? null : pulumi.Input.encodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemove, Map<String, dynamic>>(requestHeaderToRemoves!, (value) => value.toMap()),
      'responseHeaderToAdds': ?responseHeaderToAdds == null ? null : pulumi.Input.encodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToAdd, Map<String, dynamic>>(responseHeaderToAdds!, (value) => value.toMap()),
      'responseHeaderToRemoves': ?responseHeaderToRemoves == null ? null : pulumi.Input.encodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemove, Map<String, dynamic>>(responseHeaderToRemoves!, (value) => value.toMap()),
    };
  }
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction(
      requestHeaderToAdds: map['requestHeaderToAdds'] == null ? null : pulumi.Input.decodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAdd>(map['requestHeaderToAdds'], (value) => EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAdd.fromMap((value as Map).cast<String, dynamic>())),
