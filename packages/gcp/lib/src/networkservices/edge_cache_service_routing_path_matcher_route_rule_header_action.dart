...
class EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'requestHeaderToAdds': ?requestHeaderToAdds == null
          ? null
          : pulumi.Input.encodeList<
              EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAdd,
              Map<String, dynamic>
            >(requestHeaderToAdds!, (value) => value.toMap()),
      'requestHeaderToRemoves': ?requestHeaderToRemoves == null
          ? null
          : pulumi.Input.encodeList<
              EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemove,
              Map<String, dynamic>
            >(requestHeaderToRemoves!, (value) => value.toMap()),
      'responseHeaderToAdds': ?responseHeaderToAdds == null
          ? null
          : pulumi.Input.encodeList<
              EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToAdd,
              Map<String, dynamic>
            >(responseHeaderToAdds!, (value) => value.toMap()),
      'responseHeaderToRemoves': ?responseHeaderToRemoves == null
          ? null
          : pulumi.Input.encodeList<
              EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemove,
              Map<String, dynamic>
            >(responseHeaderToRemoves!, (value) => value.toMap()),
    };
  }
      ...
      requestHeaderToAdds: map['requestHeaderToAdds'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAdd.fromMap(
      ...
      requestHeaderToRemoves: map['requestHeaderToRemoves'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemove.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      responseHeaderToAdds: map['responseHeaderToAdds'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToAdd.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      responseHeaderToRemoves: map['responseHeaderToRemoves'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemove.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
    );
