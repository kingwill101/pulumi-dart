...
class MulticastDomainArgs {
  ...
  MulticastDomainArgs({
    ...
    String? project,
        ...
        connectionConfig =
            pulumi.Input.asInput<MulticastDomainConnectionConfig>(
                connectionConfig),
        description = pulumi.Input.asOptionalInput<String>(description),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        location = pulumi.Input.asInput<String>(location),
        multicastDomainGroup =
            pulumi.Input.asOptionalInput<String>(multicastDomainGroup),
  ...
  factory MulticastDomainArgs.fromMap(Map<String, dynamic> map) {
    return MulticastDomainArgs(
      ...
      connectionConfig: MulticastDomainConnectionConfig.fromMap(
      ...
      multicastDomainGroup: map['multicastDomainGroup'] == null
          ? null
          : map['multicastDomainGroup'] as String,
