...
class EdgeCacheOriginArgs {
  ...
  factory EdgeCacheOriginArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheOriginArgs(
      awsV4Authentication: map['awsV4Authentication'] == null ? null : EdgeCacheOriginAwsV4Authentication.fromMap((map['awsV4Authentication'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      failoverOrigin: map['failoverOrigin'] == null ? null : map['failoverOrigin'] as String,
      flexShielding: map['flexShielding'] == null ? null : EdgeCacheOriginFlexShielding.fromMap((map['flexShielding'] as Map).cast<String, dynamic>()),
      ...
      originOverrideAction: map['originOverrideAction'] == null ? null : EdgeCacheOriginOriginOverrideAction.fromMap((map['originOverrideAction'] as Map).cast<String, dynamic>()),
      originRedirect: map['originRedirect'] == null ? null : EdgeCacheOriginOriginRedirect.fromMap((map['originRedirect'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      protocol: map['protocol'] == null ? null : map['protocol'] as String,
      retryConditions: map['retryConditions'] == null ? null : (map['retryConditions'] as List).cast<String>(),
      timeout: map['timeout'] == null ? null : EdgeCacheOriginTimeout.fromMap((map['timeout'] as Map).cast<String, dynamic>()),
    );
  }
}
