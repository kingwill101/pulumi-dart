...
/// {@template pulumi_networkservices_edge_cache_origin_edge_cache_origin_args_doc}
/// The set of arguments for EdgeCacheOrigin.
/// {@endtemplate}
/// {@macro pulumi_networkservices_edge_cache_origin_edge_cache_origin_args_doc}
class EdgeCacheOriginArgs {
  ...
  EdgeCacheOriginArgs({
    EdgeCacheOriginAwsV4Authentication? awsV4Authentication,
    String? description,
    String? failoverOrigin,
    EdgeCacheOriginFlexShielding? flexShielding,
    Map<String, String>? labels,
    int? maxAttempts,
    String? name,
    required String originAddress,
    EdgeCacheOriginOriginOverrideAction? originOverrideAction,
    EdgeCacheOriginOriginRedirect? originRedirect,
    int? port,
    String? project,
    String? protocol,
    List<String>? retryConditions,
    EdgeCacheOriginTimeout? timeout,
  })  : awsV4Authentication =
            pulumi.Input.asOptionalInput<EdgeCacheOriginAwsV4Authentication>(
                awsV4Authentication),
        description = pulumi.Input.asOptionalInput<String>(description),
        failoverOrigin = pulumi.Input.asOptionalInput<String>(failoverOrigin),
        flexShielding =
            pulumi.Input.asOptionalInput<EdgeCacheOriginFlexShielding>(
                flexShielding),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        maxAttempts = pulumi.Input.asOptionalInput<int>(maxAttempts),
        name = pulumi.Input.asOptionalInput<String>(name),
        originAddress = pulumi.Input.asInput<String>(originAddress),
        originOverrideAction =
            pulumi.Input.asOptionalInput<EdgeCacheOriginOriginOverrideAction>(
                originOverrideAction),
        originRedirect =
            pulumi.Input.asOptionalInput<EdgeCacheOriginOriginRedirect>(
                originRedirect),
        port = pulumi.Input.asOptionalInput<int>(port),
        project = pulumi.Input.asOptionalInput<String>(project),
        protocol = pulumi.Input.asOptionalInput<String>(protocol),
        retryConditions =
            pulumi.Input.asOptionalInput<List<String>>(retryConditions),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (awsV4AuthenticationValue != null) {
      map['awsV4Authentication'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (flexShieldingValue != null) {
      map['flexShielding'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (originOverrideActionValue != null) {
      map['originOverrideAction'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (originRedirectValue != null) {
      map['originRedirect'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (timeoutValue != null) {
      map['timeout'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory EdgeCacheOriginArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheOriginArgs(
      ...
      failoverOrigin: map['failoverOrigin'] == null
          ? null
          : map['failoverOrigin'] as String,
      flexShielding: map['flexShielding'] == null
          ? null
          : EdgeCacheOriginFlexShielding.fromMap(
              (map['flexShielding'] as Map).cast<String, dynamic>()),
      ...
      originOverrideAction: map['originOverrideAction'] == null
          ? null
          : EdgeCacheOriginOriginOverrideAction.fromMap(
              (map['originOverrideAction'] as Map).cast<String, dynamic>()),
      originRedirect: map['originRedirect'] == null
          ? null
          : EdgeCacheOriginOriginRedirect.fromMap(
              (map['originRedirect'] as Map).cast<String, dynamic>()),
