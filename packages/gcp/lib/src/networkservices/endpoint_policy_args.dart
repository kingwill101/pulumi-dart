...
class EndpointPolicyArgs {
  ...
  EndpointPolicyArgs({
    ...
    required String type,
      ...
      endpointMatcher = pulumi.Input.asInput<EndpointPolicyEndpointMatcher>(endpointMatcher),
  ...
  factory EndpointPolicyArgs.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyArgs(
      ...
      endpointMatcher: EndpointPolicyEndpointMatcher.fromMap((map['endpointMatcher'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      serverTlsPolicy: map['serverTlsPolicy'] == null ? null : map['serverTlsPolicy'] as String,
      trafficPortSelector: map['trafficPortSelector'] == null ? null : EndpointPolicyTrafficPortSelector.fromMap((map['trafficPortSelector'] as Map).cast<String, dynamic>()),
