...
class EdgeCacheServiceArgs {
  ...
  EdgeCacheServiceArgs({
    ...
    List<String>? edgeSslCertificates,
    Map<String, String>? labels,
    EdgeCacheServiceLogConfig? logConfig,
    String? name,
    String? project,
    bool? requireTls,
    required EdgeCacheServiceRouting routing,
    String? sslPolicy,
  }) :
  ...
  factory EdgeCacheServiceArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceArgs(
      ...
      disableHttp2: map['disableHttp2'] == null ? null : map['disableHttp2'] as bool,
      disableQuic: map['disableQuic'] == null ? null : map['disableQuic'] as bool,
      edgeSecurityPolicy: map['edgeSecurityPolicy'] == null ? null : map['edgeSecurityPolicy'] as String,
      edgeSslCertificates: map['edgeSslCertificates'] == null ? null : (map['edgeSslCertificates'] as List).cast<String>(),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      logConfig: map['logConfig'] == null ? null : EdgeCacheServiceLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requireTls: map['requireTls'] == null ? null : map['requireTls'] as bool,
      routing: EdgeCacheServiceRouting.fromMap((map['routing'] as Map).cast<String, dynamic>()),
