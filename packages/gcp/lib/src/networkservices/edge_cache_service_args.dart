...
class EdgeCacheServiceArgs {
  ...
  EdgeCacheServiceArgs({
    ...
    String? sslPolicy,
       ...
       edgeSecurityPolicy = pulumi.Input.asOptionalInput<String>(
         edgeSecurityPolicy,
       ),
  ...
  factory EdgeCacheServiceArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceArgs(
      ...
      disableHttp2: map['disableHttp2'] == null
          ? null
          : map['disableHttp2'] as bool,
      disableQuic: map['disableQuic'] == null
          ? null
          : map['disableQuic'] as bool,
