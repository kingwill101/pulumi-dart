...
class EdgeCacheServiceArgs {
  ...
  EdgeCacheServiceArgs({
    ...
    String? sslPolicy,
        ...
        edgeSecurityPolicy =
            pulumi.Input.asOptionalInput<String>(edgeSecurityPolicy),
        edgeSslCertificates =
            pulumi.Input.asOptionalInput<List<String>>(edgeSslCertificates),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        logConfig =
            pulumi.Input.asOptionalInput<EdgeCacheServiceLogConfig>(logConfig),
  ...
  factory EdgeCacheServiceArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceArgs(
      ...
      disableHttp2:
          map['disableHttp2'] == null ? null : map['disableHttp2'] as bool,
      disableQuic:
          map['disableQuic'] == null ? null : map['disableQuic'] as bool,
      edgeSecurityPolicy: map['edgeSecurityPolicy'] == null
          ? null
          : map['edgeSecurityPolicy'] as String,
      edgeSslCertificates: map['edgeSslCertificates'] == null
          ? null
          : (map['edgeSslCertificates'] as List).cast<String>(),
      ...
      routing: EdgeCacheServiceRouting.fromMap(
