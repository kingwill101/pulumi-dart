...
class LbEdgeExtension extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [LbEdgeExtension]. {@macro pulumi_networkservices_lb_edge_extension_lb_edge_extension_args_doc}
  ...
  LbEdgeExtension(
    ...
    this.extensionChains = registerOutput<List<LbEdgeExtensionExtensionChain>>(
      'extensionChains',
    );
