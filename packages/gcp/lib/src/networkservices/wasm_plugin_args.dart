...
class WasmPluginArgs {
  ...
  WasmPluginArgs({
    ...
    String? name,
    String? project,
    required List<WasmPluginVersion> versions,
  }) :
  ...
  factory WasmPluginArgs.fromMap(Map<String, dynamic> map) {
    return WasmPluginArgs(
      ...
      logConfig: map['logConfig'] == null ? null : WasmPluginLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      mainVersionId: map['mainVersionId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      versions: pulumi.Input.decodeList<WasmPluginVersion>(map['versions'], (value) => WasmPluginVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
