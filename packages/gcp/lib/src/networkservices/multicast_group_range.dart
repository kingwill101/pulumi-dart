...
class MulticastGroupRange extends pulumi.CustomResource {
  ...
  /// Creates a new [MulticastGroupRange].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MulticastGroupRange]. {@macro pulumi_networkservices_multicast_group_range_multicast_group_range_args_doc}
  ...
  MulticastGroupRange(
    ...
    this.consumerAcceptLists = registerOutput<List<String>?>(
      'consumerAcceptLists',
    );
    ...
    this.multicastGroupRangeId = registerOutput<String>(
