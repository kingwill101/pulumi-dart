...
class MulticastDomainActivationArgs {
  ...
  factory MulticastDomainActivationArgs.fromMap(Map<String, dynamic> map) {
    return MulticastDomainActivationArgs(
      ...
      disablePlacementPolicy: map['disablePlacementPolicy'] == null ? null : map['disablePlacementPolicy'] as bool,
      ...
      trafficSpec: map['trafficSpec'] == null ? null : MulticastDomainActivationTrafficSpec.fromMap((map['trafficSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
