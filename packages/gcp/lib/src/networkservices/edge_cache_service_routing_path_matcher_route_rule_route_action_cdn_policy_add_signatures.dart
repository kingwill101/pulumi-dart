...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures {
  ...
  /// * `PathGlobs`
  final List<String>? copiedParameters;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['actions'] = actions;
    final copiedParametersValue = copiedParameters;
    if (copiedParametersValue != null) {
      map['copiedParameters'] = copiedParametersValue;
    }
    final keysetValue = keyset;
    if (keysetValue != null) {
      map['keyset'] = keysetValue;
    }
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures.fromMap(
      Map<String, dynamic> map) {
    return EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures(
      actions: map['actions'] as String,
      copiedParameters: map['copiedParameters'] == null
          ? null
          : (map['copiedParameters'] as List).cast<String>(),
      keyset: map['keyset'] == null ? null : map['keyset'] as String,
