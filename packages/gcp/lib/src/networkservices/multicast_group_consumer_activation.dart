...
class MulticastGroupConsumerActivation extends pulumi.CustomResource {
  ...
  MulticastGroupConsumerActivation(
    ...
    this.logConfig = registerOutput<MulticastGroupConsumerActivationLogConfig?>('logConfig');
    this.multicastConsumerAssociation = registerOutput<String>('multicastConsumerAssociation');
    this.multicastGroupConsumerActivationId = registerOutput<String>('multicastGroupConsumerActivationId');
    this.multicastGroupRangeActivation = registerOutput<String>('multicastGroupRangeActivation');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.states = registerOutput<List<MulticastGroupConsumerActivationState>>('states');
