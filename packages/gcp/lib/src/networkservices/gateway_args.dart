...
class GatewayArgs {
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      certificateUrls: map['certificateUrls'] == null ? null : (map['certificateUrls'] as List).cast<String>(),
      deleteSwgAutogenRouterOnDestroy: map['deleteSwgAutogenRouterOnDestroy'] == null ? null : map['deleteSwgAutogenRouterOnDestroy'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      envoyHeaders: map['envoyHeaders'] == null ? null : map['envoyHeaders'] as String,
      gatewaySecurityPolicy: map['gatewaySecurityPolicy'] == null ? null : map['gatewaySecurityPolicy'] as String,
