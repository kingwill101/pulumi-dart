...
class MulticastGroupRangeActivation extends pulumi.CustomResource {
  ...
  MulticastGroupRangeActivation(
    ...
    this.logConfig = registerOutput<MulticastGroupRangeActivationLogConfig?>(
      'logConfig',
    );
    this.multicastDomainActivation = registerOutput<String>(
      'multicastDomainActivation',
    );
    this.multicastGroupConsumerActivations = registerOutput<List<String>>(
      'multicastGroupConsumerActivations',
    );
    this.multicastGroupRange = registerOutput<String>('multicastGroupRange');
    this.multicastGroupRangeActivationId = registerOutput<String>(
      'multicastGroupRangeActivationId',
    );
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.states = registerOutput<List<MulticastGroupRangeActivationState>>(
      'states',
    );
