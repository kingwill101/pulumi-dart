...
class MulticastGroupProducerActivation extends pulumi.CustomResource {
  ...
  MulticastGroupProducerActivation(
    ...
    this.multicastGroupProducerActivationId = registerOutput<String>(
      'multicastGroupProducerActivationId',
    );
    this.multicastGroupRangeActivation = registerOutput<String>(
      'multicastGroupRangeActivation',
    );
    this.multicastProducerAssociation = registerOutput<String>(
      'multicastProducerAssociation',
    );
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.states = registerOutput<List<MulticastGroupProducerActivationState>>(
      'states',
    );
