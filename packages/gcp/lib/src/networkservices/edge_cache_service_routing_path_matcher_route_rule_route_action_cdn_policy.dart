...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'signedTokenOptions': ?signedTokenOptions == null
          ? null
          : signedTokenOptions!.toMap(),
    };
  }
    ...
    return EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy(
      addSignatures: map['addSignatures'] == null
          ...
          : EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures.fromMap(
              (map['addSignatures'] as Map).cast<String, dynamic>(),
            ),
      ...
      defaultTtl: map['defaultTtl'] == null
          ? null
          : map['defaultTtl'] as String,
