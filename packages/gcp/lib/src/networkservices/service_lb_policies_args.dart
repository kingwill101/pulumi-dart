...
class ServiceLbPoliciesArgs {
  ...
  factory ServiceLbPoliciesArgs.fromMap(Map<String, dynamic> map) {
    return ServiceLbPoliciesArgs(
      autoCapacityDrain: map['autoCapacityDrain'] == null ? null : ServiceLbPoliciesAutoCapacityDrain.fromMap((map['autoCapacityDrain'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      failoverConfig: map['failoverConfig'] == null ? null : ServiceLbPoliciesFailoverConfig.fromMap((map['failoverConfig'] as Map).cast<String, dynamic>()),
      isolationConfig: map['isolationConfig'] == null ? null : ServiceLbPoliciesIsolationConfig.fromMap((map['isolationConfig'] as Map).cast<String, dynamic>()),
