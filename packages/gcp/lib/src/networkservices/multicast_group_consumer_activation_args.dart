...
class MulticastGroupConsumerActivationArgs {
  ...
  factory MulticastGroupConsumerActivationArgs.fromMap(Map<String, dynamic> map) {
    return MulticastGroupConsumerActivationArgs(
      ...
      logConfig: map['logConfig'] == null ? null : MulticastGroupConsumerActivationLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      multicastConsumerAssociation: map['multicastConsumerAssociation'] as String,
      multicastGroupConsumerActivationId: map['multicastGroupConsumerActivationId'] as String,
