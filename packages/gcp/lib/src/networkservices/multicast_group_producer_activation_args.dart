...
class MulticastGroupProducerActivationArgs {
  ...
  MulticastGroupProducerActivationArgs({
    ...
    String? project,
        ...
        multicastGroupProducerActivationId =
            pulumi.Input.asInput<String>(multicastGroupProducerActivationId),
        multicastGroupRangeActivation =
            pulumi.Input.asInput<String>(multicastGroupRangeActivation),
        multicastProducerAssociation =
            pulumi.Input.asInput<String>(multicastProducerAssociation),
  ...
  factory MulticastGroupProducerActivationArgs.fromMap(
    ...
    return MulticastGroupProducerActivationArgs(
      ...
      multicastGroupProducerActivationId:
          map['multicastGroupProducerActivationId'] as String,
      multicastGroupRangeActivation:
          map['multicastGroupRangeActivation'] as String,
      multicastProducerAssociation:
          map['multicastProducerAssociation'] as String,
