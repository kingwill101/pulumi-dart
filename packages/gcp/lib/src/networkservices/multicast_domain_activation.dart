...
class MulticastDomainActivation extends pulumi.CustomResource {
  ...
  MulticastDomainActivation(
    ...
    this.disablePlacementPolicy = registerOutput<bool>(
    ...
    this.multicastDomainActivationId = registerOutput<String>(
      'multicastDomainActivationId',
    );
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.states = registerOutput<List<MulticastDomainActivationState>>(
      'states',
    );
    this.trafficSpec = registerOutput<MulticastDomainActivationTrafficSpec?>(
      'trafficSpec',
    );
