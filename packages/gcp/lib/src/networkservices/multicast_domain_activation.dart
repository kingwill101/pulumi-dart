...
class MulticastDomainActivation extends pulumi.CustomResource {
  ...
  MulticastDomainActivation(
    ...
    this.disablePlacementPolicy = registerOutput<bool>('disablePlacementPolicy');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.multicastDomain = registerOutput<String>('multicastDomain');
    this.multicastDomainActivationId = registerOutput<String>('multicastDomainActivationId');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.states = registerOutput<List<MulticastDomainActivationState>>('states');
    this.trafficSpec = registerOutput<MulticastDomainActivationTrafficSpec?>('trafficSpec');
