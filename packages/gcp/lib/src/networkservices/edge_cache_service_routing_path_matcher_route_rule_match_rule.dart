...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule {
  ...
  final List<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch>? headerMatches;
  ...
  /// Structure is documented below.
  final List<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch>? queryParameterMatches;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': ?headerMatches == null ? null : pulumi.Input.encodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch, Map<String, dynamic>>(headerMatches!, (value) => value.toMap()),
      'ignoreCase': ?ignoreCase,
      'pathTemplateMatch': ?pathTemplateMatch,
      'prefixMatch': ?prefixMatch,
      'queryParameterMatches': ?queryParameterMatches == null ? null : pulumi.Input.encodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch, Map<String, dynamic>>(queryParameterMatches!, (value) => value.toMap()),
    };
  }
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule(
      ...
      headerMatches: map['headerMatches'] == null ? null : pulumi.Input.decodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch>(map['headerMatches'], (value) => EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      queryParameterMatches: map['queryParameterMatches'] == null ? null : pulumi.Input.decodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch>(map['queryParameterMatches'], (value) => EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
