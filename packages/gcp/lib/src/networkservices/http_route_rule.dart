...
class HttpRouteRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matches': ?matches == null ? null : pulumi.Input.encodeList<HttpRouteRuleMatch, Map<String, dynamic>>(matches!, (value) => value.toMap()),
    };
  }

  factory HttpRouteRule.fromMap(Map<String, dynamic> map) {
    return HttpRouteRule(
      action: map['action'] == null ? null : HttpRouteRuleAction.fromMap((map['action'] as Map).cast<String, dynamic>()),
      matches: map['matches'] == null ? null : pulumi.Input.decodeList<HttpRouteRuleMatch>(map['matches'], (value) => HttpRouteRuleMatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
