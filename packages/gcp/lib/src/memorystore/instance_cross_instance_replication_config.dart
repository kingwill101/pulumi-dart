...
class InstanceCrossInstanceReplicationConfig {
  ...
  /// Structure is documented below.
  final List<InstanceCrossInstanceReplicationConfigSecondaryInstance>? secondaryInstances;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'memberships': ?memberships == null ? null : pulumi.Input.encodeList<InstanceCrossInstanceReplicationConfigMembership, Map<String, dynamic>>(memberships!, (value) => value.toMap()),
      'primaryInstance': ?primaryInstance == null ? null : primaryInstance!.toMap(),
      'secondaryInstances': ?secondaryInstances == null ? null : pulumi.Input.encodeList<InstanceCrossInstanceReplicationConfigSecondaryInstance, Map<String, dynamic>>(secondaryInstances!, (value) => value.toMap()),
  ...
  factory InstanceCrossInstanceReplicationConfig.fromMap(Map<String, dynamic> map) {
    return InstanceCrossInstanceReplicationConfig(
      instanceRole: map['instanceRole'] == null ? null : map['instanceRole'] as String,
      memberships: map['memberships'] == null ? null : pulumi.Input.decodeList<InstanceCrossInstanceReplicationConfigMembership>(map['memberships'], (value) => InstanceCrossInstanceReplicationConfigMembership.fromMap((value as Map).cast<String, dynamic>())),
      primaryInstance: map['primaryInstance'] == null ? null : InstanceCrossInstanceReplicationConfigPrimaryInstance.fromMap((map['primaryInstance'] as Map).cast<String, dynamic>()),
      secondaryInstances: map['secondaryInstances'] == null ? null : pulumi.Input.decodeList<InstanceCrossInstanceReplicationConfigSecondaryInstance>(map['secondaryInstances'], (value) => InstanceCrossInstanceReplicationConfigSecondaryInstance.fromMap((value as Map).cast<String, dynamic>())),
