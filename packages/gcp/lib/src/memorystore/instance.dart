...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.automatedBackupConfig = registerOutput<InstanceAutomatedBackupConfig?>(
      'automatedBackupConfig',
    );
    ...
    this.discoveryEndpoints = registerOutput<List<InstanceDiscoveryEndpoint>>(
      'discoveryEndpoints',
    );
    ...
    this.managedBackupSource = registerOutput<InstanceManagedBackupSource?>(
      'managedBackupSource',
    );
    this.managedServerCas = registerOutput<List<InstanceManagedServerCa>>(
      'managedServerCas',
    );
    ...
    this.pscAutoConnections = registerOutput<List<InstancePscAutoConnection>>(
      'pscAutoConnections',
    );
