...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      authorizationMode: map['authorizationMode'] == null ? null : map['authorizationMode'] as String,
      automatedBackupConfig: map['automatedBackupConfig'] == null ? null : InstanceAutomatedBackupConfig.fromMap((map['automatedBackupConfig'] as Map).cast<String, dynamic>()),
      crossInstanceReplicationConfig: map['crossInstanceReplicationConfig'] == null ? null : InstanceCrossInstanceReplicationConfig.fromMap((map['crossInstanceReplicationConfig'] as Map).cast<String, dynamic>()),
      deletionProtectionEnabled: map['deletionProtectionEnabled'] == null ? null : map['deletionProtectionEnabled'] as bool,
      desiredAutoCreatedEndpoints: map['desiredAutoCreatedEndpoints'] == null ? null : pulumi.Input.decodeList<InstanceDesiredAutoCreatedEndpoint>(map['desiredAutoCreatedEndpoints'], (value) => InstanceDesiredAutoCreatedEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      desiredPscAutoConnections: map['desiredPscAutoConnections'] == null ? null : pulumi.Input.decodeList<InstanceDesiredPscAutoConnection>(map['desiredPscAutoConnections'], (value) => InstanceDesiredPscAutoConnection.fromMap((value as Map).cast<String, dynamic>())),
      engineConfigs: map['engineConfigs'] == null ? null : (map['engineConfigs'] as Map).cast<String, String>(),
      engineVersion: map['engineVersion'] == null ? null : map['engineVersion'] as String,
      gcsSource: map['gcsSource'] == null ? null : InstanceGcsSource.fromMap((map['gcsSource'] as Map).cast<String, dynamic>()),
      ...
      managedBackupSource: map['managedBackupSource'] == null ? null : InstanceManagedBackupSource.fromMap((map['managedBackupSource'] as Map).cast<String, dynamic>()),
      mode: map['mode'] == null ? null : map['mode'] as String,
      nodeType: map['nodeType'] == null ? null : map['nodeType'] as String,
      persistenceConfig: map['persistenceConfig'] == null ? null : InstancePersistenceConfig.fromMap((map['persistenceConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      replicaCount: map['replicaCount'] == null ? null : map['replicaCount'] as int,
      shardCount: map['shardCount'] as int,
      transitEncryptionMode: map['transitEncryptionMode'] == null ? null : map['transitEncryptionMode'] as String,
      zoneDistributionConfig: map['zoneDistributionConfig'] == null ? null : InstanceZoneDistributionConfig.fromMap((map['zoneDistributionConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
