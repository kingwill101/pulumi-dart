    ...
    InstanceZoneDistributionConfig? zoneDistributionConfig,
        ...
        automatedBackupConfig =
            pulumi.Input.asOptionalInput<InstanceAutomatedBackupConfig>(
                automatedBackupConfig),
        crossInstanceReplicationConfig = pulumi.Input.asOptionalInput<
        ...
        desiredAutoCreatedEndpoints = pulumi.Input.asOptionalInput<
            ...
            desiredAutoCreatedEndpoints),
        desiredPscAutoConnections = pulumi.Input.asOptionalInput<
            List<InstanceDesiredPscAutoConnection>>(desiredPscAutoConnections),
        engineConfigs =
            pulumi.Input.asOptionalInput<Map<String, String>>(engineConfigs),
