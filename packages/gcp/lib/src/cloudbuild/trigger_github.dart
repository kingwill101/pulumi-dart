...
class TriggerGithub {
  ...
  factory TriggerGithub.fromMap(Map<String, dynamic> map) {
    return TriggerGithub(
      ...
      pullRequest: map['pullRequest'] == null ? null : TriggerGithubPullRequest.fromMap((map['pullRequest'] as Map).cast<String, dynamic>()),
      push: map['push'] == null ? null : TriggerGithubPush.fromMap((map['push'] as Map).cast<String, dynamic>()),
    );
  }
}
