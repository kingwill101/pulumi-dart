...
class GetTriggerBuild {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'artifacts': pulumi.Input.encodeList<GetTriggerBuildArtifact, Map<String, dynamic>>(artifacts, (value) => value.toMap()),
      'availableSecrets': pulumi.Input.encodeList<GetTriggerBuildAvailableSecret, Map<String, dynamic>>(availableSecrets, (value) => value.toMap()),
      'images': images,
      'logsBucket': logsBucket,
      'options': pulumi.Input.encodeList<GetTriggerBuildOption, Map<String, dynamic>>(options, (value) => value.toMap()),
      'queueTtl': queueTtl,
      'secrets': pulumi.Input.encodeList<GetTriggerBuildSecret, Map<String, dynamic>>(secrets, (value) => value.toMap()),
      'sources': pulumi.Input.encodeList<GetTriggerBuildSource, Map<String, dynamic>>(sources, (value) => value.toMap()),
      'steps': pulumi.Input.encodeList<GetTriggerBuildStep, Map<String, dynamic>>(steps, (value) => value.toMap()),
  ...
  factory GetTriggerBuild.fromMap(Map<String, dynamic> map) {
    return GetTriggerBuild(
      artifacts: pulumi.Input.decodeList<GetTriggerBuildArtifact>(map['artifacts'], (value) => GetTriggerBuildArtifact.fromMap((value as Map).cast<String, dynamic>())),
      availableSecrets: pulumi.Input.decodeList<GetTriggerBuildAvailableSecret>(map['availableSecrets'], (value) => GetTriggerBuildAvailableSecret.fromMap((value as Map).cast<String, dynamic>())),
      images: (map['images'] as List).cast<String>(),
      logsBucket: map['logsBucket'] as String,
      options: pulumi.Input.decodeList<GetTriggerBuildOption>(map['options'], (value) => GetTriggerBuildOption.fromMap((value as Map).cast<String, dynamic>())),
      queueTtl: map['queueTtl'] as String,
      secrets: pulumi.Input.decodeList<GetTriggerBuildSecret>(map['secrets'], (value) => GetTriggerBuildSecret.fromMap((value as Map).cast<String, dynamic>())),
      sources: pulumi.Input.decodeList<GetTriggerBuildSource>(map['sources'], (value) => GetTriggerBuildSource.fromMap((value as Map).cast<String, dynamic>())),
      steps: pulumi.Input.decodeList<GetTriggerBuildStep>(map['steps'], (value) => GetTriggerBuildStep.fromMap((value as Map).cast<String, dynamic>())),
