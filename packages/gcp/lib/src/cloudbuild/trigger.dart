...
class Trigger extends pulumi.CustomResource {
  ...
  Trigger(
    ...
    this.approvalConfig = registerOutput<TriggerApprovalConfig>(
      'approvalConfig',
    );
    ...
    this.repositoryEventConfig = registerOutput<TriggerRepositoryEventConfig?>(
      'repositoryEventConfig',
    );
    ...
    this.triggerTemplate = registerOutput<TriggerTriggerTemplate?>(
      'triggerTemplate',
    );
