...
class Trigger extends pulumi.CustomResource {
  ...
  Trigger(
    ...
    this.approvalConfig = registerOutput<TriggerApprovalConfig>('approvalConfig');
    this.bitbucketServerTriggerConfig = registerOutput<TriggerBitbucketServerTriggerConfig?>('bitbucketServerTriggerConfig');
    this.build = registerOutput<TriggerBuild?>('build');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String?>('description');
    this.developerConnectEventConfig = registerOutput<TriggerDeveloperConnectEventConfig?>('developerConnectEventConfig');
    ...
    this.repositoryEventConfig = registerOutput<TriggerRepositoryEventConfig?>('repositoryEventConfig');
    ...
    this.triggerTemplate = registerOutput<TriggerTriggerTemplate?>('triggerTemplate');
