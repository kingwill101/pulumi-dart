...
class TriggerBuildArtifacts {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'images': ?images,
      'mavenArtifacts': ?mavenArtifacts == null ? null : pulumi.Input.encodeList<TriggerBuildArtifactsMavenArtifact, Map<String, dynamic>>(mavenArtifacts!, (value) => value.toMap()),
      'npmPackages': ?npmPackages == null ? null : pulumi.Input.encodeList<TriggerBuildArtifactsNpmPackage, Map<String, dynamic>>(npmPackages!, (value) => value.toMap()),
      'objects': ?objects == null ? null : objects!.toMap(),
      'pythonPackages': ?pythonPackages == null ? null : pulumi.Input.encodeList<TriggerBuildArtifactsPythonPackage, Map<String, dynamic>>(pythonPackages!, (value) => value.toMap()),
    };
  }
  ...
  factory TriggerBuildArtifacts.fromMap(Map<String, dynamic> map) {
    return TriggerBuildArtifacts(
      ...
      mavenArtifacts: map['mavenArtifacts'] == null ? null : pulumi.Input.decodeList<TriggerBuildArtifactsMavenArtifact>(map['mavenArtifacts'], (value) => TriggerBuildArtifactsMavenArtifact.fromMap((value as Map).cast<String, dynamic>())),
      npmPackages: map['npmPackages'] == null ? null : pulumi.Input.decodeList<TriggerBuildArtifactsNpmPackage>(map['npmPackages'], (value) => TriggerBuildArtifactsNpmPackage.fromMap((value as Map).cast<String, dynamic>())),
      objects: map['objects'] == null ? null : TriggerBuildArtifactsObjects.fromMap((map['objects'] as Map).cast<String, dynamic>()),
      pythonPackages: map['pythonPackages'] == null ? null : pulumi.Input.decodeList<TriggerBuildArtifactsPythonPackage>(map['pythonPackages'], (value) => TriggerBuildArtifactsPythonPackage.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
