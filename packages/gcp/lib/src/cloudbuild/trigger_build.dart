...
class TriggerBuild {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availableSecrets': ?availableSecrets == null ? null : availableSecrets!.toMap(),
      'images': ?images,
      'logsBucket': ?logsBucket,
      'options': ?options == null ? null : options!.toMap(),
      'queueTtl': ?queueTtl,
      'secrets': ?secrets == null ? null : pulumi.Input.encodeList<TriggerBuildSecret, Map<String, dynamic>>(secrets!, (value) => value.toMap()),
      'source': ?source == null ? null : source!.toMap(),
      'steps': pulumi.Input.encodeList<TriggerBuildStep, Map<String, dynamic>>(steps, (value) => value.toMap()),
  ...
  factory TriggerBuild.fromMap(Map<String, dynamic> map) {
    return TriggerBuild(
      artifacts: map['artifacts'] == null ? null : TriggerBuildArtifacts.fromMap((map['artifacts'] as Map).cast<String, dynamic>()),
      availableSecrets: map['availableSecrets'] == null ? null : TriggerBuildAvailableSecrets.fromMap((map['availableSecrets'] as Map).cast<String, dynamic>()),
      images: map['images'] == null ? null : (map['images'] as List).cast<String>(),
      logsBucket: map['logsBucket'] == null ? null : map['logsBucket'] as String,
      options: map['options'] == null ? null : TriggerBuildOptions.fromMap((map['options'] as Map).cast<String, dynamic>()),
      queueTtl: map['queueTtl'] == null ? null : map['queueTtl'] as String,
      secrets: map['secrets'] == null ? null : pulumi.Input.decodeList<TriggerBuildSecret>(map['secrets'], (value) => TriggerBuildSecret.fromMap((value as Map).cast<String, dynamic>())),
      source: map['source'] == null ? null : TriggerBuildSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
      steps: pulumi.Input.decodeList<TriggerBuildStep>(map['steps'], (value) => TriggerBuildStep.fromMap((value as Map).cast<String, dynamic>())),
