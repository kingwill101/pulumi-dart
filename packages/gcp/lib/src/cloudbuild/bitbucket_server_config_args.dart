...
class BitbucketServerConfigArgs {
  ...
  factory BitbucketServerConfigArgs.fromMap(Map<String, dynamic> map) {
    return BitbucketServerConfigArgs(
      ...
      connectedRepositories: map['connectedRepositories'] == null ? null : pulumi.Input.decodeList<BitbucketServerConfigConnectedRepository>(map['connectedRepositories'], (value) => BitbucketServerConfigConnectedRepository.fromMap((value as Map).cast<String, dynamic>())),
      hostUri: map['hostUri'] as String,
      location: map['location'] as String,
      peeredNetwork: map['peeredNetwork'] == null ? null : map['peeredNetwork'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      secrets: BitbucketServerConfigSecrets.fromMap((map['secrets'] as Map).cast<String, dynamic>()),
