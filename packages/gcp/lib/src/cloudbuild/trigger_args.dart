...
class TriggerArgs {
  ...
  TriggerArgs({
    ...
    TriggerWebhookConfig? webhookConfig,
            ...
            pulumi.Input.asOptionalInput<TriggerApprovalConfig>(approvalConfig),
        bitbucketServerTriggerConfig =
        ...
        gitFileSource =
            pulumi.Input.asOptionalInput<TriggerGitFileSource>(gitFileSource),
        ...
        includeBuildLogs =
            pulumi.Input.asOptionalInput<String>(includeBuildLogs),
        includedFiles =
        ...
        pubsubConfig =
            pulumi.Input.asOptionalInput<TriggerPubsubConfig>(pubsubConfig),
        repositoryEventConfig =
            pulumi.Input.asOptionalInput<TriggerRepositoryEventConfig>(
                repositoryEventConfig),
        serviceAccount = pulumi.Input.asOptionalInput<String>(serviceAccount),
        sourceToBuild =
            pulumi.Input.asOptionalInput<TriggerSourceToBuild>(sourceToBuild),
        substitutions =
        ...
        triggerTemplate = pulumi.Input.asOptionalInput<TriggerTriggerTemplate>(
            triggerTemplate),
        webhookConfig =
            pulumi.Input.asOptionalInput<TriggerWebhookConfig>(webhookConfig);
  ...
  factory TriggerArgs.fromMap(Map<String, dynamic> map) {
    return TriggerArgs(
      approvalConfig: map['approvalConfig'] == null
          ? null
          : TriggerApprovalConfig.fromMap(
              (map['approvalConfig'] as Map).cast<String, dynamic>()),
      bitbucketServerTriggerConfig: map['bitbucketServerTriggerConfig'] == null
          ? null
          : TriggerBitbucketServerTriggerConfig.fromMap(
              (map['bitbucketServerTriggerConfig'] as Map)
                  .cast<String, dynamic>()),
      build: map['build'] == null
          ? null
          : TriggerBuild.fromMap((map['build'] as Map).cast<String, dynamic>()),
      description:
          map['description'] == null ? null : map['description'] as String,
      developerConnectEventConfig: map['developerConnectEventConfig'] == null
          ? null
          : TriggerDeveloperConnectEventConfig.fromMap(
              (map['developerConnectEventConfig'] as Map)
                  .cast<String, dynamic>()),
