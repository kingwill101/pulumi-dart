...
class GetTriggerGithub {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'owner': owner,
      'pullRequests': pulumi.Input.encodeList<GetTriggerGithubPullRequest, Map<String, dynamic>>(pullRequests, (value) => value.toMap()),
      'pushes': pulumi.Input.encodeList<GetTriggerGithubPush, Map<String, dynamic>>(pushes, (value) => value.toMap()),
    };
  }
  ...
  factory GetTriggerGithub.fromMap(Map<String, dynamic> map) {
    return GetTriggerGithub(
      ...
      pullRequests: pulumi.Input.decodeList<GetTriggerGithubPullRequest>(map['pullRequests'], (value) => GetTriggerGithubPullRequest.fromMap((value as Map).cast<String, dynamic>())),
      pushes: pulumi.Input.decodeList<GetTriggerGithubPush>(map['pushes'], (value) => GetTriggerGithubPush.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
