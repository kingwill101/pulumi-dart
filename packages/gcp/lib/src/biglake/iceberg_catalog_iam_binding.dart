...
import 'iceberg_catalog_iam_binding_args.dart';
...
class IcebergCatalogIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<IcebergCatalogIamBindingCondition?> condition;
  ...
  /// Creates a new [IcebergCatalogIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IcebergCatalogIamBinding]. {@macro pulumi_biglake_iceberg_catalog_iam_binding_iceberg_catalog_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IcebergCatalogIamBinding(
    String name, {
    IcebergCatalogIamBindingArgs? args,
    ...
    this.condition = registerOutput<IcebergCatalogIamBindingCondition?>('condition');
