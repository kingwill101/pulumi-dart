...
class DatabaseArgs {
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      appEngineIntegrationMode: map['appEngineIntegrationMode'] == null ? null : map['appEngineIntegrationMode'] as String,
      cmekConfig: map['cmekConfig'] == null ? null : DatabaseCmekConfig.fromMap((map['cmekConfig'] as Map).cast<String, dynamic>()),
      concurrencyMode: map['concurrencyMode'] == null ? null : map['concurrencyMode'] as String,
      databaseEdition: map['databaseEdition'] == null ? null : map['databaseEdition'] as String,
      deleteProtectionState: map['deleteProtectionState'] == null ? null : map['deleteProtectionState'] as String,
      deletionPolicy: map['deletionPolicy'] == null ? null : map['deletionPolicy'] as String,
      locationId: map['locationId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      pointInTimeRecoveryEnablement: map['pointInTimeRecoveryEnablement'] == null ? null : map['pointInTimeRecoveryEnablement'] as String,
