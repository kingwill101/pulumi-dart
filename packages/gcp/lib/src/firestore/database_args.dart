...
class DatabaseArgs {
  ...
  DatabaseArgs({
    ...
    required String type,
  }) : appEngineIntegrationMode = pulumi.Input.asOptionalInput<String>(
         appEngineIntegrationMode,
       ),
       cmekConfig = pulumi.Input.asOptionalInput<DatabaseCmekConfig>(
         cmekConfig,
       ),
       ...
       deleteProtectionState = pulumi.Input.asOptionalInput<String>(
