...
class IndexArgs {
  ...
  IndexArgs({
    ...
    bool? unique,
      ...
      fields = pulumi.Input.asInput<List<IndexField>>(fields),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'database': ?database,
      'density': ?density,
      'fields': pulumi.Input.mapInputValue<List<IndexField>, List<Map<String, dynamic>>>(fields, (value) => pulumi.Input.encodeList<IndexField, Map<String, dynamic>>(value, (value) => value.toMap())),
      'multikey': ?multikey,
      'project': ?project,
  ...
  factory IndexArgs.fromMap(Map<String, dynamic> map) {
    return IndexArgs(
      apiScope: map['apiScope'] == null ? null : map['apiScope'] as String,
      collection: map['collection'] as String,
      database: map['database'] == null ? null : map['database'] as String,
      density: map['density'] == null ? null : map['density'] as String,
      fields: pulumi.Input.decodeList<IndexField>(map['fields'], (value) => IndexField.fromMap((value as Map).cast<String, dynamic>())),
      multikey: map['multikey'] == null ? null : map['multikey'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      queryScope: map['queryScope'] == null ? null : map['queryScope'] as String,
