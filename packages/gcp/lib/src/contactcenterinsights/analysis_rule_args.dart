...
class AnalysisRuleArgs {
  ...
  factory AnalysisRuleArgs.fromMap(Map<String, dynamic> map) {
    return AnalysisRuleArgs(
      ...
      analysisPercentage: map['analysisPercentage'] == null ? null : map['analysisPercentage'] as double,
      annotatorSelector: map['annotatorSelector'] == null ? null : AnalysisRuleAnnotatorSelector.fromMap((map['annotatorSelector'] as Map).cast<String, dynamic>()),
      conversationFilter: map['conversationFilter'] == null ? null : map['conversationFilter'] as String,
