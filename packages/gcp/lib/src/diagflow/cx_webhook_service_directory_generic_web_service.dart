...
class CxWebhookServiceDirectoryGenericWebService {
  ...
  /// Structure is documented below.
  final List<CxWebhookServiceDirectoryGenericWebServiceSecretVersionsForRequestHeader>? secretVersionsForRequestHeaders;
  /// Configuration for authentication using a service account.
  /// Structure is documented below.
  final CxWebhookServiceDirectoryGenericWebServiceServiceAccountAuthConfig? serviceAccountAuthConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secretVersionsForRequestHeaders': ?secretVersionsForRequestHeaders == null ? null : pulumi.Input.encodeList<CxWebhookServiceDirectoryGenericWebServiceSecretVersionsForRequestHeader, Map<String, dynamic>>(secretVersionsForRequestHeaders!, (value) => value.toMap()),
  ...
  factory CxWebhookServiceDirectoryGenericWebService.fromMap(Map<String, dynamic> map) {
    return CxWebhookServiceDirectoryGenericWebService(
      ...
      oauthConfig: map['oauthConfig'] == null ? null : CxWebhookServiceDirectoryGenericWebServiceOauthConfig.fromMap((map['oauthConfig'] as Map).cast<String, dynamic>()),
      ...
      serviceAccountAuthConfig: map['serviceAccountAuthConfig'] == null ? null : CxWebhookServiceDirectoryGenericWebServiceServiceAccountAuthConfig.fromMap((map['serviceAccountAuthConfig'] as Map).cast<String, dynamic>()),
