...
class CxAgent extends pulumi.CustomResource {
  ...
  CxAgent(
    ...
    this.advancedSettings = registerOutput<CxAgentAdvancedSettings>(
      'advancedSettings',
    );
    ...
    this.deleteChatEngineOnDestroy = registerOutput<bool?>(
      'deleteChatEngineOnDestroy',
    );
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.enableMultiLanguageTraining = registerOutput<bool?>(
    ...
    this.genAppBuilderSettings = registerOutput<CxAgentGenAppBuilderSettings>(
      'genAppBuilderSettings',
    );
    ...
    this.speechToTextSettings = registerOutput<CxAgentSpeechToTextSettings?>(
      'speechToTextSettings',
    );
    this.startFlow = registerOutput<String>('startFlow');
    this.startPlaybook = registerOutput<String?>('startPlaybook');
    this.supportedLanguageCodes = registerOutput<List<String>?>(
      'supportedLanguageCodes',
    );
    this.textToSpeechSettings = registerOutput<CxAgentTextToSpeechSettings?>(
      'textToSpeechSettings',
    );
