...
class CxAgent extends pulumi.CustomResource {
  ...
  CxAgent(
    ...
    this.advancedSettings = registerOutput<CxAgentAdvancedSettings>('advancedSettings');
    this.answerFeedbackSettings = registerOutput<CxAgentAnswerFeedbackSettings?>('answerFeedbackSettings');
    this.avatarUri = registerOutput<String?>('avatarUri');
    this.clientCertificateSettings = registerOutput<CxAgentClientCertificateSettings?>('clientCertificateSettings');
    this.defaultLanguageCode = registerOutput<String>('defaultLanguageCode');
    this.deleteChatEngineOnDestroy = registerOutput<bool?>('deleteChatEngineOnDestroy');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.enableMultiLanguageTraining = registerOutput<bool?>('enableMultiLanguageTraining');
    ...
    this.genAppBuilderSettings = registerOutput<CxAgentGenAppBuilderSettings>('genAppBuilderSettings');
    this.gitIntegrationSettings = registerOutput<CxAgentGitIntegrationSettings?>('gitIntegrationSettings');
    this.location = registerOutput<String>('location');
    this.locked = registerOutput<bool?>('locked');
    this.name = registerOutput<String>('name');
    this.personalizationSettings = registerOutput<CxAgentPersonalizationSettings?>('personalizationSettings');
    ...
    this.speechToTextSettings = registerOutput<CxAgentSpeechToTextSettings?>('speechToTextSettings');
    ...
    this.textToSpeechSettings = registerOutput<CxAgentTextToSpeechSettings?>('textToSpeechSettings');
