...
class CxToolVersionToolConnectorSpecEndUserAuthConfig {
  ...
  final CxToolVersionToolConnectorSpecEndUserAuthConfigOauth2AuthCodeConfig? oauth2AuthCodeConfig;
  ...
  final CxToolVersionToolConnectorSpecEndUserAuthConfigOauth2JwtBearerConfig? oauth2JwtBearerConfig;
  ...
  factory CxToolVersionToolConnectorSpecEndUserAuthConfig.fromMap(Map<String, dynamic> map) {
    return CxToolVersionToolConnectorSpecEndUserAuthConfig(
      oauth2AuthCodeConfig: map['oauth2AuthCodeConfig'] == null ? null : CxToolVersionToolConnectorSpecEndUserAuthConfigOauth2AuthCodeConfig.fromMap((map['oauth2AuthCodeConfig'] as Map).cast<String, dynamic>()),
      oauth2JwtBearerConfig: map['oauth2JwtBearerConfig'] == null ? null : CxToolVersionToolConnectorSpecEndUserAuthConfigOauth2JwtBearerConfig.fromMap((map['oauth2JwtBearerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
