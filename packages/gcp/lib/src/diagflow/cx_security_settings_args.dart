...
class CxSecuritySettingsArgs {
  ...
  CxSecuritySettingsArgs({
    CxSecuritySettingsAudioExportSettings? audioExportSettings,
    String? deidentifyTemplate,
    required String displayName,
    CxSecuritySettingsInsightsExportSettings? insightsExportSettings,
    ...
    int? retentionWindowDays,
        ...
        purgeDataTypes =
            pulumi.Input.asOptionalInput<List<String>>(purgeDataTypes),
        redactionScope = pulumi.Input.asOptionalInput<String>(redactionScope),
        redactionStrategy =
            pulumi.Input.asOptionalInput<String>(redactionStrategy),
        retentionStrategy =
            pulumi.Input.asOptionalInput<String>(retentionStrategy),
        retentionWindowDays =
