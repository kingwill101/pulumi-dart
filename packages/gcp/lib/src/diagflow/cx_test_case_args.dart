...
class CxTestCaseArgs {
  ...
  factory CxTestCaseArgs.fromMap(Map<String, dynamic> map) {
    return CxTestCaseArgs(
      ...
      testCaseConversationTurns: map['testCaseConversationTurns'] == null ? null : pulumi.Input.decodeList<CxTestCaseTestCaseConversationTurn>(map['testCaseConversationTurns'], (value) => CxTestCaseTestCaseConversationTurn.fromMap((value as Map).cast<String, dynamic>())),
      testConfig: map['testConfig'] == null ? null : CxTestCaseTestConfig.fromMap((map['testConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
