...
class CxGeneratorArgs {
  ...
  factory CxGeneratorArgs.fromMap(Map<String, dynamic> map) {
    return CxGeneratorArgs(
      ...
      llmModelSettings: map['llmModelSettings'] == null ? null : CxGeneratorLlmModelSettings.fromMap((map['llmModelSettings'] as Map).cast<String, dynamic>()),
      modelParameter: map['modelParameter'] == null ? null : CxGeneratorModelParameter.fromMap((map['modelParameter'] as Map).cast<String, dynamic>()),
      parent: map['parent'] == null ? null : map['parent'] as String,
      placeholders: map['placeholders'] == null ? null : pulumi.Input.decodeList<CxGeneratorPlaceholder>(map['placeholders'], (value) => CxGeneratorPlaceholder.fromMap((value as Map).cast<String, dynamic>())),
      promptText: CxGeneratorPromptText.fromMap((map['promptText'] as Map).cast<String, dynamic>()),
    );
  }
}
