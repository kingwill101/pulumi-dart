...
class CxPageKnowledgeConnectorSettingsTriggerFulfillment {
  ...
  final CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings? advancedSettings;
  /// Conditional cases for this fulfillment.
  /// Structure is documented below.
  final List<CxPageKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase>? conditionalCases;
  /// If the flag is true, the agent will utilize LLM to generate a text response. If LLM generation fails, the defined responses in the fulfillment will be respected. This flag is only useful for fulfillments associated with no-match event handlers.
  final bool? enableGenerativeFallback;
  /// The list of rich message responses to present to the user.
  /// Structure is documented below.
  final List<CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage>? messages;
  ...
  /// Structure is documented below.
  final List<CxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction>? setParameterActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionalCases': ?conditionalCases == null ? null : pulumi.Input.encodeList<CxPageKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase, Map<String, dynamic>>(conditionalCases!, (value) => value.toMap()),
      'enableGenerativeFallback': ?enableGenerativeFallback,
      'messages': ?messages == null ? null : pulumi.Input.encodeList<CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage, Map<String, dynamic>>(messages!, (value) => value.toMap()),
      'returnPartialResponses': ?returnPartialResponses,
      'setParameterActions': ?setParameterActions == null ? null : pulumi.Input.encodeList<CxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction, Map<String, dynamic>>(setParameterActions!, (value) => value.toMap()),
      'tag': ?tag,
      'webhook': ?webhook,
    };
  }
  ...
  factory CxPageKnowledgeConnectorSettingsTriggerFulfillment.fromMap(Map<String, dynamic> map) {
    return CxPageKnowledgeConnectorSettingsTriggerFulfillment(
      advancedSettings: map['advancedSettings'] == null ? null : CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>()),
      conditionalCases: map['conditionalCases'] == null ? null : pulumi.Input.decodeList<CxPageKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase>(map['conditionalCases'], (value) => CxPageKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase.fromMap((value as Map).cast<String, dynamic>())),
      enableGenerativeFallback: map['enableGenerativeFallback'] == null ? null : map['enableGenerativeFallback'] as bool,
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage>(map['messages'], (value) => CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage.fromMap((value as Map).cast<String, dynamic>())),
      returnPartialResponses: map['returnPartialResponses'] == null ? null : map['returnPartialResponses'] as bool,
      setParameterActions: map['setParameterActions'] == null ? null : pulumi.Input.decodeList<CxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction>(map['setParameterActions'], (value) => CxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction.fromMap((value as Map).cast<String, dynamic>())),
