...
class CxPlaybook extends pulumi.CustomResource {
  ...
  CxPlaybook(
    ...
    this.llmModelSettings = registerOutput<CxPlaybookLlmModelSettings?>('llmModelSettings');
    ...
    this.referencedPlaybooks = registerOutput<List<String>>('referencedPlaybooks');
