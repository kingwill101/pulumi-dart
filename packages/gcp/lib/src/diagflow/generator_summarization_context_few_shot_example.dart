  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conversationContext': ?conversationContext == null
          ? null
          : conversationContext!.toMap(),
      'extraInfo': ?extraInfo,
      'output': output.toMap(),
      'summarizationSectionList': ?summarizationSectionList == null
          ? null
          : summarizationSectionList!.toMap(),
    };
  }
  ...
  factory GeneratorSummarizationContextFewShotExample.fromMap(
    ...
    return GeneratorSummarizationContextFewShotExample(
      conversationContext: map['conversationContext'] == null
          ? null
          : GeneratorSummarizationContextFewShotExampleConversationContext.fromMap(
      ...
      summarizationSectionList: map['summarizationSectionList'] == null
          ? null
          : GeneratorSummarizationContextFewShotExampleSummarizationSectionList.fromMap(
              (map['summarizationSectionList'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
