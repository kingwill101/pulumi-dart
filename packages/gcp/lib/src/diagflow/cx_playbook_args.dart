...
class CxPlaybookArgs {
  ...
  CxPlaybookArgs({
    ...
    CxPlaybookInstruction? instruction,
    CxPlaybookLlmModelSettings? llmModelSettings,
    String? parent,
    String? playbookType,
    List<String>? referencedTools,
        ...
        instruction =
            pulumi.Input.asOptionalInput<CxPlaybookInstruction>(instruction),
        llmModelSettings =
        ...
        referencedTools =
            pulumi.Input.asOptionalInput<List<String>>(referencedTools);
  ...
  factory CxPlaybookArgs.fromMap(Map<String, dynamic> map) {
    return CxPlaybookArgs(
      ...
      playbookType:
          map['playbookType'] == null ? null : map['playbookType'] as String,
