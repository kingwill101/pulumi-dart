...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutput {
  ...
  final CxTestCaseLastTestResultConversationTurnVirtualAgentOutputCurrentPage? currentPage;
  /// The list of differences between the original run and the replay for this output, if any.
  /// Structure is documented below.
  final List<CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifference>? differences;
  /// The session parameters available to the bot at this point.
  final String? sessionParameters;
  /// Response error from the agent in the test result. If set, other output is empty.
  /// Structure is documented below.
  final CxTestCaseLastTestResultConversationTurnVirtualAgentOutputStatus? status;
  /// The text responses from the agent for the turn.
  /// Structure is documented below.
  final List<CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponse>? textResponses;
  ...
  /// Structure is documented below.
  final CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTriggeredIntent? triggeredIntent;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'differences': ?differences == null ? null : pulumi.Input.encodeList<CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifference, Map<String, dynamic>>(differences!, (value) => value.toMap()),
      'sessionParameters': ?sessionParameters,
      'status': ?status == null ? null : status!.toMap(),
      'textResponses': ?textResponses == null ? null : pulumi.Input.encodeList<CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponse, Map<String, dynamic>>(textResponses!, (value) => value.toMap()),
  ...
  factory CxTestCaseLastTestResultConversationTurnVirtualAgentOutput.fromMap(Map<String, dynamic> map) {
    return CxTestCaseLastTestResultConversationTurnVirtualAgentOutput(
      currentPage: map['currentPage'] == null ? null : CxTestCaseLastTestResultConversationTurnVirtualAgentOutputCurrentPage.fromMap((map['currentPage'] as Map).cast<String, dynamic>()),
      differences: map['differences'] == null ? null : pulumi.Input.decodeList<CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifference>(map['differences'], (value) => CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifference.fromMap((value as Map).cast<String, dynamic>())),
      sessionParameters: map['sessionParameters'] == null ? null : map['sessionParameters'] as String,
      status: map['status'] == null ? null : CxTestCaseLastTestResultConversationTurnVirtualAgentOutputStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
      textResponses: map['textResponses'] == null ? null : pulumi.Input.decodeList<CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponse>(map['textResponses'], (value) => CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponse.fromMap((value as Map).cast<String, dynamic>())),
      triggeredIntent: map['triggeredIntent'] == null ? null : CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTriggeredIntent.fromMap((map['triggeredIntent'] as Map).cast<String, dynamic>()),
    );
  }
}
