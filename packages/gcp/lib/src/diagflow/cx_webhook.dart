...
class CxWebhook extends pulumi.CustomResource {
  ...
  CxWebhook(
    ...
    this.genericWebService = registerOutput<CxWebhookGenericWebService?>('genericWebService');
    this.name = registerOutput<String>('name');
    this.parent = registerOutput<String?>('parent');
    this.securitySettings = registerOutput<String?>('securitySettings');
    this.serviceDirectory = registerOutput<CxWebhookServiceDirectory?>('serviceDirectory');
