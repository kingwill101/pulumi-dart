...
class CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment {
  ...
  final List<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentConditionalCase>? conditionalCases;
  /// The list of rich message responses to present to the user.
  /// Structure is documented below.
  final List<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessage>? messages;
  ...
  /// Structure is documented below.
  final List<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentSetParameterAction>? setParameterActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditionalCases': ?conditionalCases == null ? null : pulumi.Input.encodeList<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentConditionalCase, Map<String, dynamic>>(conditionalCases!, (value) => value.toMap()),
      'messages': ?messages == null ? null : pulumi.Input.encodeList<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessage, Map<String, dynamic>>(messages!, (value) => value.toMap()),
      'returnPartialResponses': ?returnPartialResponses,
      'setParameterActions': ?setParameterActions == null ? null : pulumi.Input.encodeList<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentSetParameterAction, Map<String, dynamic>>(setParameterActions!, (value) => value.toMap()),
      'tag': ?tag,
      'webhook': ?webhook,
    };
  }
  ...
  factory CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment.fromMap(Map<String, dynamic> map) {
    return CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment(
      ...
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessage>(map['messages'], (value) => CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessage.fromMap((value as Map).cast<String, dynamic>())),
