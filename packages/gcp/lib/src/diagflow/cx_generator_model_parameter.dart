...
class CxGeneratorModelParameter {
  ...
  Map<String, dynamic> toMap() {
    ...
    final maxDecodeStepsValue = maxDecodeSteps;
    if (maxDecodeStepsValue != null) {
      map['maxDecodeSteps'] = maxDecodeStepsValue;
    }
  ...
  factory CxGeneratorModelParameter.fromMap(Map<String, dynamic> map) {
    return CxGeneratorModelParameter(
      maxDecodeSteps:
          map['maxDecodeSteps'] == null ? null : map['maxDecodeSteps'] as int,
      temperature:
