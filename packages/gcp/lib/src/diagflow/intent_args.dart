...
class IntentArgs {
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      ...
      defaultResponsePlatforms: map['defaultResponsePlatforms'] == null ? null : (map['defaultResponsePlatforms'] as List).cast<String>(),
      ...
      webhookState: map['webhookState'] == null ? null : map['webhookState'] as String,
    );
  }
}
