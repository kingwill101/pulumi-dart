...
class CxAgentArgs {
  ...
  factory CxAgentArgs.fromMap(Map<String, dynamic> map) {
    return CxAgentArgs(
      advancedSettings: map['advancedSettings'] == null ? null : CxAgentAdvancedSettings.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>()),
      answerFeedbackSettings: map['answerFeedbackSettings'] == null ? null : CxAgentAnswerFeedbackSettings.fromMap((map['answerFeedbackSettings'] as Map).cast<String, dynamic>()),
      avatarUri: map['avatarUri'] == null ? null : map['avatarUri'] as String,
      clientCertificateSettings: map['clientCertificateSettings'] == null ? null : CxAgentClientCertificateSettings.fromMap((map['clientCertificateSettings'] as Map).cast<String, dynamic>()),
      defaultLanguageCode: map['defaultLanguageCode'] as String,
      deleteChatEngineOnDestroy: map['deleteChatEngineOnDestroy'] == null ? null : map['deleteChatEngineOnDestroy'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      enableMultiLanguageTraining: map['enableMultiLanguageTraining'] == null ? null : map['enableMultiLanguageTraining'] as bool,
      ...
      genAppBuilderSettings: map['genAppBuilderSettings'] == null ? null : CxAgentGenAppBuilderSettings.fromMap((map['genAppBuilderSettings'] as Map).cast<String, dynamic>()),
      gitIntegrationSettings: map['gitIntegrationSettings'] == null ? null : CxAgentGitIntegrationSettings.fromMap((map['gitIntegrationSettings'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      locked: map['locked'] == null ? null : map['locked'] as bool,
      personalizationSettings: map['personalizationSettings'] == null ? null : CxAgentPersonalizationSettings.fromMap((map['personalizationSettings'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      securitySettings: map['securitySettings'] == null ? null : map['securitySettings'] as String,
      speechToTextSettings: map['speechToTextSettings'] == null ? null : CxAgentSpeechToTextSettings.fromMap((map['speechToTextSettings'] as Map).cast<String, dynamic>()),
      startPlaybook: map['startPlaybook'] == null ? null : map['startPlaybook'] as String,
      supportedLanguageCodes: map['supportedLanguageCodes'] == null ? null : (map['supportedLanguageCodes'] as List).cast<String>(),
      textToSpeechSettings: map['textToSpeechSettings'] == null ? null : CxAgentTextToSpeechSettings.fromMap((map['textToSpeechSettings'] as Map).cast<String, dynamic>()),
