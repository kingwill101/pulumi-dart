...
class CxPageArgs {
  ...
  factory CxPageArgs.fromMap(Map<String, dynamic> map) {
    return CxPageArgs(
      advancedSettings: map['advancedSettings'] == null ? null : CxPageAdvancedSettings.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      entryFulfillment: map['entryFulfillment'] == null ? null : CxPageEntryFulfillment.fromMap((map['entryFulfillment'] as Map).cast<String, dynamic>()),
      eventHandlers: map['eventHandlers'] == null ? null : pulumi.Input.decodeList<CxPageEventHandler>(map['eventHandlers'], (value) => CxPageEventHandler.fromMap((value as Map).cast<String, dynamic>())),
      form: map['form'] == null ? null : CxPageForm.fromMap((map['form'] as Map).cast<String, dynamic>()),
      knowledgeConnectorSettings: map['knowledgeConnectorSettings'] == null ? null : CxPageKnowledgeConnectorSettings.fromMap((map['knowledgeConnectorSettings'] as Map).cast<String, dynamic>()),
      ...
      transitionRoutes: map['transitionRoutes'] == null ? null : pulumi.Input.decodeList<CxPageTransitionRoute>(map['transitionRoutes'], (value) => CxPageTransitionRoute.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
