...
class CxIntent extends pulumi.CustomResource {
  ...
  CxIntent(
    ...
    this.isDefaultNegativeIntent = registerOutput<bool?>('isDefaultNegativeIntent');
    this.isDefaultWelcomeIntent = registerOutput<bool?>('isDefaultWelcomeIntent');
    ...
    this.trainingPhrases = registerOutput<List<CxIntentTrainingPhrase>?>('trainingPhrases');
  }
}
