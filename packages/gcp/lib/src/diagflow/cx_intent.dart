...
class CxIntent extends pulumi.CustomResource {
  ...
  CxIntent(
    ...
    this.isDefaultNegativeIntent = registerOutput<bool?>(
      'isDefaultNegativeIntent',
    );
    this.isDefaultWelcomeIntent = registerOutput<bool?>(
    ...
    this.trainingPhrases = registerOutput<List<CxIntentTrainingPhrase>?>(
      'trainingPhrases',
    );
  }
}
