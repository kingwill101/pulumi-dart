...
class CxFlowArgs {
  ...
  CxFlowArgs({
    ...
    List<CxFlowTransitionRoute>? transitionRoutes,
        ...
        eventHandlers = pulumi.Input.asOptionalInput<List<CxFlowEventHandler>>(
            eventHandlers),
        isDefaultStartFlow =
            pulumi.Input.asOptionalInput<bool>(isDefaultStartFlow),
        knowledgeConnectorSettings =
            pulumi.Input.asOptionalInput<CxFlowKnowledgeConnectorSettings>(
                knowledgeConnectorSettings),
        languageCode = pulumi.Input.asOptionalInput<String>(languageCode),
        nluSettings =
            pulumi.Input.asOptionalInput<CxFlowNluSettings>(nluSettings),
  ...
  factory CxFlowArgs.fromMap(Map<String, dynamic> map) {
    return CxFlowArgs(
      ...
      isDefaultStartFlow: map['isDefaultStartFlow'] == null
          ? null
          : map['isDefaultStartFlow'] as bool,
