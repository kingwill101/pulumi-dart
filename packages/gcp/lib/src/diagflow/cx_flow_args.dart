...
class CxFlowArgs {
  ...
  CxFlowArgs({
    CxFlowAdvancedSettings? advancedSettings,
    String? description,
    required String displayName,
    List<CxFlowEventHandler>? eventHandlers,
    bool? isDefaultStartFlow,
    CxFlowKnowledgeConnectorSettings? knowledgeConnectorSettings,
    String? languageCode,
    CxFlowNluSettings? nluSettings,
    String? parent,
    List<String>? transitionRouteGroups,
    List<CxFlowTransitionRoute>? transitionRoutes,
  }) :
  ...
  factory CxFlowArgs.fromMap(Map<String, dynamic> map) {
    return CxFlowArgs(
      advancedSettings: map['advancedSettings'] == null ? null : CxFlowAdvancedSettings.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      eventHandlers: map['eventHandlers'] == null ? null : pulumi.Input.decodeList<CxFlowEventHandler>(map['eventHandlers'], (value) => CxFlowEventHandler.fromMap((value as Map).cast<String, dynamic>())),
      isDefaultStartFlow: map['isDefaultStartFlow'] == null ? null : map['isDefaultStartFlow'] as bool,
      knowledgeConnectorSettings: map['knowledgeConnectorSettings'] == null ? null : CxFlowKnowledgeConnectorSettings.fromMap((map['knowledgeConnectorSettings'] as Map).cast<String, dynamic>()),
      languageCode: map['languageCode'] == null ? null : map['languageCode'] as String,
      nluSettings: map['nluSettings'] == null ? null : CxFlowNluSettings.fromMap((map['nluSettings'] as Map).cast<String, dynamic>()),
      ...
      transitionRoutes: map['transitionRoutes'] == null ? null : pulumi.Input.decodeList<CxFlowTransitionRoute>(map['transitionRoutes'], (value) => CxFlowTransitionRoute.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
