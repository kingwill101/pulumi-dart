...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillment {
  ...
  final CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings? advancedSettings;
  /// Conditional cases for this fulfillment.
  /// Structure is documented below.
  final List<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase>? conditionalCases;
  /// If the flag is true, the agent will utilize LLM to generate a text response. If LLM generation fails, the defined responses in the fulfillment will be respected. This flag is only useful for fulfillments associated with no-match event handlers.
  final bool? enableGenerativeFallback;
  /// The list of rich message responses to present to the user.
  /// Structure is documented below.
  final List<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage>? messages;
  ...
  /// Structure is documented below.
  final List<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction>? setParameterActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionalCases': ?conditionalCases == null ? null : pulumi.Input.encodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase, Map<String, dynamic>>(conditionalCases!, (value) => value.toMap()),
      'enableGenerativeFallback': ?enableGenerativeFallback,
      'messages': ?messages == null ? null : pulumi.Input.encodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage, Map<String, dynamic>>(messages!, (value) => value.toMap()),
      'returnPartialResponses': ?returnPartialResponses,
      'setParameterActions': ?setParameterActions == null ? null : pulumi.Input.encodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction, Map<String, dynamic>>(setParameterActions!, (value) => value.toMap()),
      'tag': ?tag,
      'webhook': ?webhook,
    };
  }
  ...
  factory CxFlowKnowledgeConnectorSettingsTriggerFulfillment.fromMap(Map<String, dynamic> map) {
    return CxFlowKnowledgeConnectorSettingsTriggerFulfillment(
      advancedSettings: map['advancedSettings'] == null ? null : CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>()),
      conditionalCases: map['conditionalCases'] == null ? null : pulumi.Input.decodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase>(map['conditionalCases'], (value) => CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase.fromMap((value as Map).cast<String, dynamic>())),
      enableGenerativeFallback: map['enableGenerativeFallback'] == null ? null : map['enableGenerativeFallback'] as bool,
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage>(map['messages'], (value) => CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage.fromMap((value as Map).cast<String, dynamic>())),
      returnPartialResponses: map['returnPartialResponses'] == null ? null : map['returnPartialResponses'] as bool,
      setParameterActions: map['setParameterActions'] == null ? null : pulumi.Input.decodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction>(map['setParameterActions'], (value) => CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction.fromMap((value as Map).cast<String, dynamic>())),
