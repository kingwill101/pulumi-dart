...
class CxIntentArgs {
  ...
  CxIntentArgs({
    ...
    bool? isDefaultNegativeIntent,
    bool? isDefaultWelcomeIntent,
    bool? isFallback,
    Map<String, String>? labels,
    String? languageCode,
    List<CxIntentParameter>? parameters,
    String? parent,
    int? priority,
    List<CxIntentTrainingPhrase>? trainingPhrases,
  }) :
  ...
  factory CxIntentArgs.fromMap(Map<String, dynamic> map) {
    return CxIntentArgs(
      ...
      isDefaultNegativeIntent: map['isDefaultNegativeIntent'] == null ? null : map['isDefaultNegativeIntent'] as bool,
      isDefaultWelcomeIntent: map['isDefaultWelcomeIntent'] == null ? null : map['isDefaultWelcomeIntent'] as bool,
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<CxIntentParameter>(map['parameters'], (value) => CxIntentParameter.fromMap((value as Map).cast<String, dynamic>())),
      parent: map['parent'] == null ? null : map['parent'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      trainingPhrases: map['trainingPhrases'] == null ? null : pulumi.Input.decodeList<CxIntentTrainingPhrase>(map['trainingPhrases'], (value) => CxIntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
