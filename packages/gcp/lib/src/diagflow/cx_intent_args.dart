...
class CxIntentArgs {
  ...
  CxIntentArgs({
    ...
    List<CxIntentTrainingPhrase>? trainingPhrases,
        ...
        isDefaultNegativeIntent =
            pulumi.Input.asOptionalInput<bool>(isDefaultNegativeIntent),
        isDefaultWelcomeIntent =
            pulumi.Input.asOptionalInput<bool>(isDefaultWelcomeIntent),
        isFallback = pulumi.Input.asOptionalInput<bool>(isFallback),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        languageCode = pulumi.Input.asOptionalInput<String>(languageCode),
        parameters =
            pulumi.Input.asOptionalInput<List<CxIntentParameter>>(parameters),
  ...
  factory CxIntentArgs.fromMap(Map<String, dynamic> map) {
    return CxIntentArgs(
      ...
      isDefaultNegativeIntent: map['isDefaultNegativeIntent'] == null
          ? null
          : map['isDefaultNegativeIntent'] as bool,
      isDefaultWelcomeIntent: map['isDefaultWelcomeIntent'] == null
          ? null
          : map['isDefaultWelcomeIntent'] as bool,
