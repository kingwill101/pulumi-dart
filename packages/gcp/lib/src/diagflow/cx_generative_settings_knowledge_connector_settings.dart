...
class CxGenerativeSettingsKnowledgeConnectorSettings {
  ...
  factory CxGenerativeSettingsKnowledgeConnectorSettings.fromMap(Map<String, dynamic> map) {
    return CxGenerativeSettingsKnowledgeConnectorSettings(
      ...
      agentIdentity: map['agentIdentity'] == null ? null : map['agentIdentity'] as String,
      agentScope: map['agentScope'] == null ? null : map['agentScope'] as String,
      business: map['business'] == null ? null : map['business'] as String,
      businessDescription: map['businessDescription'] == null ? null : map['businessDescription'] as String,
      disableDataStoreFallback: map['disableDataStoreFallback'] == null ? null : map['disableDataStoreFallback'] as bool,
    );
  }
}
