...
class CxSecuritySettings extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CxSecuritySettingsAudioExportSettings?> audioExportSettings;
  ...
  /// Structure is documented below.
  late final pulumi.Output<CxSecuritySettingsInsightsExportSettings?> insightsExportSettings;
  ...
  /// [args] Arguments used to configure this [CxSecuritySettings]. {@macro pulumi_diagflow_cx_security_settings_cx_security_settings_args_doc}
  ...
  CxSecuritySettings(
    ...
    this.audioExportSettings = registerOutput<CxSecuritySettingsAudioExportSettings?>('audioExportSettings');
    this.deidentifyTemplate = registerOutput<String?>('deidentifyTemplate');
    this.displayName = registerOutput<String>('displayName');
    this.insightsExportSettings = registerOutput<CxSecuritySettingsInsightsExportSettings?>('insightsExportSettings');
