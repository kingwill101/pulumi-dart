...
class ConversationProfileArgs {
  ...
  ConversationProfileArgs({
    ...
    ConversationProfileNewMessageEventNotificationConfig? newMessageEventNotificationConfig,
    ConversationProfileNewRecognitionResultNotificationConfig? newRecognitionResultNotificationConfig,
  ...
  factory ConversationProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConversationProfileArgs(
      automatedAgentConfig: map['automatedAgentConfig'] == null ? null : ConversationProfileAutomatedAgentConfig.fromMap((map['automatedAgentConfig'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      humanAgentAssistantConfig: map['humanAgentAssistantConfig'] == null ? null : ConversationProfileHumanAgentAssistantConfig.fromMap((map['humanAgentAssistantConfig'] as Map).cast<String, dynamic>()),
      humanAgentHandoffConfig: map['humanAgentHandoffConfig'] == null ? null : ConversationProfileHumanAgentHandoffConfig.fromMap((map['humanAgentHandoffConfig'] as Map).cast<String, dynamic>()),
      languageCode: map['languageCode'] == null ? null : map['languageCode'] as String,
      location: map['location'] as String,
      loggingConfig: map['loggingConfig'] == null ? null : ConversationProfileLoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>()),
      newMessageEventNotificationConfig: map['newMessageEventNotificationConfig'] == null ? null : ConversationProfileNewMessageEventNotificationConfig.fromMap((map['newMessageEventNotificationConfig'] as Map).cast<String, dynamic>()),
      newRecognitionResultNotificationConfig: map['newRecognitionResultNotificationConfig'] == null ? null : ConversationProfileNewRecognitionResultNotificationConfig.fromMap((map['newRecognitionResultNotificationConfig'] as Map).cast<String, dynamic>()),
      notificationConfig: map['notificationConfig'] == null ? null : ConversationProfileNotificationConfig.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      securitySettings: map['securitySettings'] == null ? null : map['securitySettings'] as String,
      sttConfig: map['sttConfig'] == null ? null : ConversationProfileSttConfig.fromMap((map['sttConfig'] as Map).cast<String, dynamic>()),
      timeZone: map['timeZone'] == null ? null : map['timeZone'] as String,
      ttsConfig: map['ttsConfig'] == null ? null : ConversationProfileTtsConfig.fromMap((map['ttsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
