...
class GeneratorArgs {
  ...
  factory GeneratorArgs.fromMap(Map<String, dynamic> map) {
    return GeneratorArgs(
      ...
      generatorId: map['generatorId'] == null ? null : map['generatorId'] as String,
      inferenceParameter: map['inferenceParameter'] == null ? null : GeneratorInferenceParameter.fromMap((map['inferenceParameter'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      publishedModel: map['publishedModel'] == null ? null : map['publishedModel'] as String,
      summarizationContext: GeneratorSummarizationContext.fromMap((map['summarizationContext'] as Map).cast<String, dynamic>()),
      triggerEvent: map['triggerEvent'] == null ? null : map['triggerEvent'] as String,
    );
  }
}
