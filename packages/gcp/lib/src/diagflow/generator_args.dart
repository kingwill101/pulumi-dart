...
class GeneratorArgs {
  ...
  GeneratorArgs({
    ...
    String? triggerEvent,
        ...
        summarizationContext =
            pulumi.Input.asInput<GeneratorSummarizationContext>(
                summarizationContext),
  ...
  factory GeneratorArgs.fromMap(Map<String, dynamic> map) {
    return GeneratorArgs(
      ...
      generatorId:
          map['generatorId'] == null ? null : map['generatorId'] as String,
      ...
      triggerEvent:
          map['triggerEvent'] == null ? null : map['triggerEvent'] as String,
    );
  }
}
