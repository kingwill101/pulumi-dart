...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      appEngineHttpTarget: map['appEngineHttpTarget'] == null ? null : JobAppEngineHttpTarget.fromMap((map['appEngineHttpTarget'] as Map).cast<String, dynamic>()),
      attemptDeadline: map['attemptDeadline'] == null ? null : map['attemptDeadline'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      httpTarget: map['httpTarget'] == null ? null : JobHttpTarget.fromMap((map['httpTarget'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      paused: map['paused'] == null ? null : map['paused'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      pubsubTarget: map['pubsubTarget'] == null ? null : JobPubsubTarget.fromMap((map['pubsubTarget'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      retryConfig: map['retryConfig'] == null ? null : JobRetryConfig.fromMap((map['retryConfig'] as Map).cast<String, dynamic>()),
