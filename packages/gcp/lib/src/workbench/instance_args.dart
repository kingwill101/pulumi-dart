...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      disableProxyAccess: map['disableProxyAccess'] == null ? null : map['disableProxyAccess'] as bool,
      enableManagedEuc: map['enableManagedEuc'] == null ? null : map['enableManagedEuc'] as bool,
      enableThirdPartyIdentity: map['enableThirdPartyIdentity'] == null ? null : map['enableThirdPartyIdentity'] as bool,
      gceSetup: map['gceSetup'] == null ? null : InstanceGceSetup.fromMap((map['gceSetup'] as Map).cast<String, dynamic>()),
