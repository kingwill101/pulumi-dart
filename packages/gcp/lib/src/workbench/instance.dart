...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.enableThirdPartyIdentity = registerOutput<bool?>(
      'enableThirdPartyIdentity',
    );
    this.gceSetup = registerOutput<InstanceGceSetup>('gceSetup');
    this.healthInfos = registerOutput<List<Map<String, dynamic>>>(
      'healthInfos',
    );
    ...
    this.upgradeHistories = registerOutput<List<InstanceUpgradeHistory>>(
      'upgradeHistories',
    );
  }
}
