...
class Floorsetting extends pulumi.CustomResource {
  ...
  /// Creates a new [Floorsetting].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Floorsetting]. {@macro pulumi_modelarmor_floorsetting_floorsetting_args_doc}
  ...
  Floorsetting(
    ...
    this.enableFloorSettingEnforcement = registerOutput<bool?>(
      'enableFloorSettingEnforcement',
    );
    this.filterConfig = registerOutput<FloorsettingFilterConfig>(
      'filterConfig',
    );
    ...
    this.integratedServices = registerOutput<List<String>?>(
      'integratedServices',
    );
