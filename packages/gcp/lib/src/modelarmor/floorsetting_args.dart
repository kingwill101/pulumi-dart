...
class FloorsettingArgs {
  ...
  factory FloorsettingArgs.fromMap(Map<String, dynamic> map) {
    return FloorsettingArgs(
      aiPlatformFloorSetting: map['aiPlatformFloorSetting'] == null ? null : FloorsettingAiPlatformFloorSetting.fromMap((map['aiPlatformFloorSetting'] as Map).cast<String, dynamic>()),
      enableFloorSettingEnforcement: map['enableFloorSettingEnforcement'] == null ? null : map['enableFloorSettingEnforcement'] as bool,
      filterConfig: FloorsettingFilterConfig.fromMap((map['filterConfig'] as Map).cast<String, dynamic>()),
      floorSettingMetadata: map['floorSettingMetadata'] == null ? null : FloorsettingFloorSettingMetadata.fromMap((map['floorSettingMetadata'] as Map).cast<String, dynamic>()),
      googleMcpServerFloorSetting: map['googleMcpServerFloorSetting'] == null ? null : FloorsettingGoogleMcpServerFloorSetting.fromMap((map['googleMcpServerFloorSetting'] as Map).cast<String, dynamic>()),
      integratedServices: map['integratedServices'] == null ? null : (map['integratedServices'] as List).cast<String>(),
