  ...
  FloorsettingArgs({
    ...
    required String parent,
        ...
        enableFloorSettingEnforcement =
            pulumi.Input.asOptionalInput<bool>(enableFloorSettingEnforcement),
        filterConfig =
            pulumi.Input.asInput<FloorsettingFilterConfig>(filterConfig),
        floorSettingMetadata =
            pulumi.Input.asOptionalInput<FloorsettingFloorSettingMetadata>(
                floorSettingMetadata),
        googleMcpServerFloorSetting = pulumi.Input.asOptionalInput<
                FloorsettingGoogleMcpServerFloorSetting>(
            googleMcpServerFloorSetting),
        integratedServices =
            pulumi.Input.asOptionalInput<List<String>>(integratedServices),
