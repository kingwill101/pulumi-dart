...
class BackupPlanArgs {
  ...
  factory BackupPlanArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanArgs(
      ...
      backupRules: pulumi.Input.decodeList<BackupPlanBackupRule>(map['backupRules'], (value) => BackupPlanBackupRule.fromMap((value as Map).cast<String, dynamic>())),
      backupVault: map['backupVault'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      location: map['location'] as String,
      logRetentionDays: map['logRetentionDays'] == null ? null : map['logRetentionDays'] as int,
      maxCustomOnDemandRetentionDays: map['maxCustomOnDemandRetentionDays'] == null ? null : map['maxCustomOnDemandRetentionDays'] as int,
