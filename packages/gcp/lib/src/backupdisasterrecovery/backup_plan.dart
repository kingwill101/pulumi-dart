...
class BackupPlan extends pulumi.CustomResource {
  ...
  BackupPlan(
    ...
    this.backupRules = registerOutput<List<BackupPlanBackupRule>>(
      'backupRules',
    );
    this.backupVault = registerOutput<String>('backupVault');
    this.backupVaultServiceAccount = registerOutput<String>(
    ...
    this.maxCustomOnDemandRetentionDays = registerOutput<int?>(
      'maxCustomOnDemandRetentionDays',
    );
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.resourceType = registerOutput<String>('resourceType');
    this.supportedResourceTypes = registerOutput<List<String>>(
