...
class RestoreWorkload extends pulumi.CustomResource {
  ...
  RestoreWorkload(
    ...
    this.clearOverridesFieldMask = registerOutput<String?>('clearOverridesFieldMask');
    this.computeInstanceRestoreProperties = registerOutput<RestoreWorkloadComputeInstanceRestoreProperties?>('computeInstanceRestoreProperties');
    this.computeInstanceTargetEnvironment = registerOutput<RestoreWorkloadComputeInstanceTargetEnvironment?>('computeInstanceTargetEnvironment');
    this.dataSourceId = registerOutput<String>('dataSourceId');
    this.deleteRestoredInstance = registerOutput<bool?>('deleteRestoredInstance');
    this.diskRestoreProperties = registerOutput<RestoreWorkloadDiskRestoreProperties?>('diskRestoreProperties');
    this.diskTargetEnvironment = registerOutput<RestoreWorkloadDiskTargetEnvironment?>('diskTargetEnvironment');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.regionDiskTargetEnvironment = registerOutput<RestoreWorkloadRegionDiskTargetEnvironment?>('regionDiskTargetEnvironment');
    this.requestId = registerOutput<String?>('requestId');
    this.targetResources = registerOutput<List<RestoreWorkloadTargetResource>>('targetResources');
  }
}
