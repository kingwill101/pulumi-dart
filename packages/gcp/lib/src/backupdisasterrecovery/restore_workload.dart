...
class RestoreWorkload extends pulumi.CustomResource {
  ...
  RestoreWorkload(
    ...
    this.clearOverridesFieldMask = registerOutput<String?>(
    ...
    this.deleteRestoredInstance = registerOutput<bool?>(
    ...
    this.targetResources = registerOutput<List<RestoreWorkloadTargetResource>>(
      'targetResources',
    );
  }
}
