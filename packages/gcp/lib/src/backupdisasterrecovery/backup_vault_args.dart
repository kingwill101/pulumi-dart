...
class BackupVaultArgs {
  ...
  BackupVaultArgs({
    ...
    String? project,
            ...
            pulumi.Input.asOptionalInput<String>(accessRestriction),
        ...
        backupRetentionInheritance =
            pulumi.Input.asOptionalInput<String>(backupRetentionInheritance),
        ...
        ignoreBackupPlanReferences =
            pulumi.Input.asOptionalInput<bool>(ignoreBackupPlanReferences),
        ignoreInactiveDatasources =
            pulumi.Input.asOptionalInput<bool>(ignoreInactiveDatasources),
  ...
  factory BackupVaultArgs.fromMap(Map<String, dynamic> map) {
    return BackupVaultArgs(
      ...
      allowMissing:
          map['allowMissing'] == null ? null : map['allowMissing'] as bool,
