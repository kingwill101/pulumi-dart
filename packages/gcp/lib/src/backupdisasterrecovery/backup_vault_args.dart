...
class BackupVaultArgs {
  ...
  BackupVaultArgs({
    ...
    String? project,
      ...
      backupMinimumEnforcedRetentionDuration = pulumi.Input.asInput<String>(backupMinimumEnforcedRetentionDuration),
  ...
  factory BackupVaultArgs.fromMap(Map<String, dynamic> map) {
    return BackupVaultArgs(
      accessRestriction: map['accessRestriction'] == null ? null : map['accessRestriction'] as String,
      allowMissing: map['allowMissing'] == null ? null : map['allowMissing'] as bool,
      ...
      backupRetentionInheritance: map['backupRetentionInheritance'] == null ? null : map['backupRetentionInheritance'] as String,
      ...
      encryptionConfig: map['encryptionConfig'] == null ? null : BackupVaultEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      ...
      ignoreBackupPlanReferences: map['ignoreBackupPlanReferences'] == null ? null : map['ignoreBackupPlanReferences'] as bool,
      ignoreInactiveDatasources: map['ignoreInactiveDatasources'] == null ? null : map['ignoreInactiveDatasources'] as bool,
