...
class BackupVault extends pulumi.CustomResource {
  ...
  BackupVault(
    ...
    this.backupMinimumEnforcedRetentionDuration = registerOutput<String>(
      'backupMinimumEnforcedRetentionDuration',
    );
    this.backupRetentionInheritance = registerOutput<String?>(
    ...
    this.encryptionConfig = registerOutput<BackupVaultEncryptionConfig?>(
      'encryptionConfig',
    );
    this.etag = registerOutput<String>('etag');
    this.forceDelete = registerOutput<bool?>('forceDelete');
    this.forceUpdate = registerOutput<bool?>('forceUpdate');
    this.ignoreBackupPlanReferences = registerOutput<bool?>(
      'ignoreBackupPlanReferences',
    );
    this.ignoreInactiveDatasources = registerOutput<bool?>(
