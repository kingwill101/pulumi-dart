...
class RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterface {
  ...
  final List<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAccessConfig>? accessConfigs;
  /// Structure is documented below.
  final List<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAliasIpRange>? aliasIpRanges;
  /// Optional. The prefix length of the primary internal IPv6 range.
  final int? internalIpv6PrefixLength;
  /// Optional. An IPv4 internal IP address to assign to the instance.
  final String? ipAddress;
  /// Structure is documented below.
  final List<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceIpv6AccessConfig>? ipv6AccessConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': ?accessConfigs == null ? null : pulumi.Input.encodeList<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAccessConfig, Map<String, dynamic>>(accessConfigs!, (value) => value.toMap()),
      'aliasIpRanges': ?aliasIpRanges == null ? null : pulumi.Input.encodeList<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAliasIpRange, Map<String, dynamic>>(aliasIpRanges!, (value) => value.toMap()),
      'internalIpv6PrefixLength': ?internalIpv6PrefixLength,
      'ipAddress': ?ipAddress,
      'ipv6AccessConfigs': ?ipv6AccessConfigs == null ? null : pulumi.Input.encodeList<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceIpv6AccessConfig, Map<String, dynamic>>(ipv6AccessConfigs!, (value) => value.toMap()),
  ...
  factory RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterface.fromMap(Map<String, dynamic> map) {
    return RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterface(
      accessConfigs: map['accessConfigs'] == null ? null : pulumi.Input.decodeList<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAccessConfig>(map['accessConfigs'], (value) => RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null ? null : pulumi.Input.decodeList<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAliasIpRange>(map['aliasIpRanges'], (value) => RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterfaceAliasIpRange.fromMap((value as Map).cast<String, dynamic>())),
