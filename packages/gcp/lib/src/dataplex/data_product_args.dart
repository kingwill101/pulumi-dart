...
class DataProductArgs {
  ...
  factory DataProductArgs.fromMap(Map<String, dynamic> map) {
    return DataProductArgs(
      accessGroups: map['accessGroups'] == null ? null : pulumi.Input.decodeList<DataProductAccessGroup>(map['accessGroups'], (value) => DataProductAccessGroup.fromMap((value as Map).cast<String, dynamic>())),
