...
class DatascanDataDiscoverySpecStorageConfig {
  ...
  factory DatascanDataDiscoverySpecStorageConfig.fromMap(Map<String, dynamic> map) {
    return DatascanDataDiscoverySpecStorageConfig(
      csvOptions: map['csvOptions'] == null ? null : DatascanDataDiscoverySpecStorageConfigCsvOptions.fromMap((map['csvOptions'] as Map).cast<String, dynamic>()),
      ...
      jsonOptions: map['jsonOptions'] == null ? null : DatascanDataDiscoverySpecStorageConfigJsonOptions.fromMap((map['jsonOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
