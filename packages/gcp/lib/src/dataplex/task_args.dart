...
class TaskArgs {
  ...
  TaskArgs({
    String? description,
    String? displayName,
    required TaskExecutionSpec executionSpec,
    ...
    TaskSpark? spark,
    String? taskId,
    required TaskTriggerSpec triggerSpec,
  }) :
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      ...
      executionSpec: TaskExecutionSpec.fromMap((map['executionSpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      lake: map['lake'] == null ? null : map['lake'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      notebook: map['notebook'] == null ? null : TaskNotebook.fromMap((map['notebook'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      spark: map['spark'] == null ? null : TaskSpark.fromMap((map['spark'] as Map).cast<String, dynamic>()),
      taskId: map['taskId'] == null ? null : map['taskId'] as String,
      triggerSpec: TaskTriggerSpec.fromMap((map['triggerSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
