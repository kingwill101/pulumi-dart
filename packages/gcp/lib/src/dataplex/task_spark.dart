...
class TaskSpark {
  ...
  factory TaskSpark.fromMap(Map<String, dynamic> map) {
    return TaskSpark(
      ...
      infrastructureSpec: map['infrastructureSpec'] == null ? null : TaskSparkInfrastructureSpec.fromMap((map['infrastructureSpec'] as Map).cast<String, dynamic>()),
      ...
      pythonScriptFile: map['pythonScriptFile'] == null ? null : map['pythonScriptFile'] as String,
      sqlScript: map['sqlScript'] == null ? null : map['sqlScript'] as String,
      sqlScriptFile: map['sqlScriptFile'] == null ? null : map['sqlScriptFile'] as String,
    );
  }
}
