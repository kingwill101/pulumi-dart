...
/// {@template pulumi_dataplex_aspect_type_iam_member_aspect_type_iam_member_args_doc}
/// The set of arguments for AspectTypeIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_aspect_type_iam_member_aspect_type_iam_member_args_doc}
class AspectTypeIamMemberArgs {
  ...
  /// Creates a new [AspectTypeIamMemberArgs].
  ...
  AspectTypeIamMemberArgs({
    ...
    AspectTypeIamMemberCondition? condition,
    String? location,
  ...
  factory AspectTypeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return AspectTypeIamMemberArgs(
      ...
      condition: map['condition'] == null ? null : AspectTypeIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
