...
class AspectTypeArgs {
  ...
  AspectTypeArgs({
    ...
    String? project,
        ...
        dataClassification =
            pulumi.Input.asOptionalInput<String>(dataClassification),
        description = pulumi.Input.asOptionalInput<String>(description),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        location = pulumi.Input.asOptionalInput<String>(location),
        metadataTemplate =
            pulumi.Input.asOptionalInput<String>(metadataTemplate),
  ...
  factory AspectTypeArgs.fromMap(Map<String, dynamic> map) {
    return AspectTypeArgs(
      aspectTypeId:
          map['aspectTypeId'] == null ? null : map['aspectTypeId'] as String,
