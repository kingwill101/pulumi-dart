...
class AspectTypeArgs {
  ...
  factory AspectTypeArgs.fromMap(Map<String, dynamic> map) {
    return AspectTypeArgs(
      aspectTypeId: map['aspectTypeId'] == null ? null : map['aspectTypeId'] as String,
      dataClassification: map['dataClassification'] == null ? null : map['dataClassification'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      metadataTemplate: map['metadataTemplate'] == null ? null : map['metadataTemplate'] as String,
