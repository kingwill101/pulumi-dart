...
class DatascanIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<DatascanIamBindingCondition?> condition;
  ...
  /// Creates a new [DatascanIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatascanIamBinding]. {@macro pulumi_dataplex_datascan_iam_binding_datascan_iam_binding_args_doc}
