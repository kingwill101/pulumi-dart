...
class AspectTypeIamBindingArgs {
  ...
  AspectTypeIamBindingArgs({
    ...
    AspectTypeIamBindingCondition? condition,
    String? location,
  ...
  factory AspectTypeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AspectTypeIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : AspectTypeIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
