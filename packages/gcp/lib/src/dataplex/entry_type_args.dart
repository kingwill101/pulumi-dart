...
class EntryTypeArgs {
  ...
  factory EntryTypeArgs.fromMap(Map<String, dynamic> map) {
    return EntryTypeArgs(
      ...
      entryTypeId: map['entryTypeId'] == null ? null : map['entryTypeId'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      platform: map['platform'] == null ? null : map['platform'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requiredAspects: map['requiredAspects'] == null ? null : pulumi.Input.decodeList<EntryTypeRequiredAspect>(map['requiredAspects'], (value) => EntryTypeRequiredAspect.fromMap((value as Map).cast<String, dynamic>())),
      system: map['system'] == null ? null : map['system'] as String,
      typeAliases: map['typeAliases'] == null ? null : (map['typeAliases'] as List).cast<String>(),
    );
  }
}
