...
class EntryGroupIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [EntryGroupIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EntryGroupIamBinding]. {@macro pulumi_dataplex_entry_group_iam_binding_entry_group_iam_binding_args_doc}
  ...
  EntryGroupIamBinding(
    ...
    this.condition = registerOutput<EntryGroupIamBindingCondition?>('condition');
