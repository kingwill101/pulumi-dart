...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      accessRulesOptions: map['accessRulesOptions'] == null ? null : InstanceAccessRulesOptions.fromMap((map['accessRulesOptions'] as Map).cast<String, dynamic>()),
      capacityGib: map['capacityGib'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      filesystem: map['filesystem'] as String,
      gkeSupportEnabled: map['gkeSupportEnabled'] == null ? null : map['gkeSupportEnabled'] as bool,
      ...
      placementPolicy: map['placementPolicy'] == null ? null : map['placementPolicy'] as String,
