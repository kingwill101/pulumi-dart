...
class ServicePerimetersServicePerimeterSpec {
  ...
  /// Structure is documented below.
  final List<ServicePerimetersServicePerimeterSpecIngressPolicy>? ingressPolicies;
  ...
  /// Perimeter.
  /// Structure is documented below.
  final ServicePerimetersServicePerimeterSpecVpcAccessibleServices? vpcAccessibleServices;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'egressPolicies': ?egressPolicies == null ? null : pulumi.Input.encodeList<ServicePerimetersServicePerimeterSpecEgressPolicy, Map<String, dynamic>>(egressPolicies!, (value) => value.toMap()),
      'ingressPolicies': ?ingressPolicies == null ? null : pulumi.Input.encodeList<ServicePerimetersServicePerimeterSpecIngressPolicy, Map<String, dynamic>>(ingressPolicies!, (value) => value.toMap()),
      'resources': ?resources,
  ...
  factory ServicePerimetersServicePerimeterSpec.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpec(
      ...
      egressPolicies: map['egressPolicies'] == null ? null : pulumi.Input.decodeList<ServicePerimetersServicePerimeterSpecEgressPolicy>(map['egressPolicies'], (value) => ServicePerimetersServicePerimeterSpecEgressPolicy.fromMap((value as Map).cast<String, dynamic>())),
      ingressPolicies: map['ingressPolicies'] == null ? null : pulumi.Input.decodeList<ServicePerimetersServicePerimeterSpecIngressPolicy>(map['ingressPolicies'], (value) => ServicePerimetersServicePerimeterSpecIngressPolicy.fromMap((value as Map).cast<String, dynamic>())),
      ...
      vpcAccessibleServices: map['vpcAccessibleServices'] == null ? null : ServicePerimetersServicePerimeterSpecVpcAccessibleServices.fromMap((map['vpcAccessibleServices'] as Map).cast<String, dynamic>()),
    );
  }
}
