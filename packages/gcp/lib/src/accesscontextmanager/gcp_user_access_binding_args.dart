...
class GcpUserAccessBindingArgs {
  ...
  GcpUserAccessBindingArgs({
    ...
    List<GcpUserAccessBindingScopedAccessSetting>? scopedAccessSettings,
    GcpUserAccessBindingSessionSettings? sessionSettings,
  }) :
  ...
  factory GcpUserAccessBindingArgs.fromMap(Map<String, dynamic> map) {
    return GcpUserAccessBindingArgs(
      accessLevels: map['accessLevels'] == null ? null : map['accessLevels'] as String,
      groupKey: map['groupKey'] as String,
      organizationId: map['organizationId'] as String,
      scopedAccessSettings: map['scopedAccessSettings'] == null ? null : pulumi.Input.decodeList<GcpUserAccessBindingScopedAccessSetting>(map['scopedAccessSettings'], (value) => GcpUserAccessBindingScopedAccessSetting.fromMap((value as Map).cast<String, dynamic>())),
      sessionSettings: map['sessionSettings'] == null ? null : GcpUserAccessBindingSessionSettings.fromMap((map['sessionSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
