...
/// {@template pulumi_accesscontextmanager_access_policy_iam_member_access_policy_iam_member_args_doc}
/// The set of arguments for AccessPolicyIamMember.
/// {@endtemplate}
...
class AccessPolicyIamMemberArgs {
  ...
  /// Creates a new [AccessPolicyIamMemberArgs].
  /// [condition] Optional.
  /// [member] Identities that will be granted the privilege in `role`.
  /// [name] Used to find the parent resource to bind the IAM policy to
  /// [role] The role that should be applied. Only one
  AccessPolicyIamMemberArgs({
    AccessPolicyIamMemberCondition? condition,
    required String member,
    String? name,
    required String role,
  }) : condition = pulumi.Input.asOptionalInput<AccessPolicyIamMemberCondition>(
         condition,
       ),
