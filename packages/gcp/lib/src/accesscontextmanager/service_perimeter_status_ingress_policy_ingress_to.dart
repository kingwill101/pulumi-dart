...
class ServicePerimeterStatusIngressPolicyIngressTo {
  ...
  final List<ServicePerimeterStatusIngressPolicyIngressToOperation>? operations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'operations': ?operations == null ? null : pulumi.Input.encodeList<ServicePerimeterStatusIngressPolicyIngressToOperation, Map<String, dynamic>>(operations!, (value) => value.toMap()),
      'resources': ?resources,
      'roles': ?roles,
    };
  }
  ...
  factory ServicePerimeterStatusIngressPolicyIngressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterStatusIngressPolicyIngressTo(
      operations: map['operations'] == null ? null : pulumi.Input.decodeList<ServicePerimeterStatusIngressPolicyIngressToOperation>(map['operations'], (value) => ServicePerimeterStatusIngressPolicyIngressToOperation.fromMap((value as Map).cast<String, dynamic>())),
