...
class ServicePerimetersServicePerimeterStatusEgressPolicyEgressFrom {
  ...
  final List<ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSource>? sources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sources': ?sources == null ? null : pulumi.Input.encodeList<ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSource, Map<String, dynamic>>(sources!, (value) => value.toMap()),
    };
  }
  ...
  factory ServicePerimetersServicePerimeterStatusEgressPolicyEgressFrom.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterStatusEgressPolicyEgressFrom(
      ...
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSource>(map['sources'], (value) => ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
