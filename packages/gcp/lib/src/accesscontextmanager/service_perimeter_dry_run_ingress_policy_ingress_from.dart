...
import 'service_perimeter_dry_run_ingress_policy_ingress_from_source.dart';

class ServicePerimeterDryRunIngressPolicyIngressFrom {
  ...
  final List<ServicePerimeterDryRunIngressPolicyIngressFromSource>? sources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sources': ?sources == null ? null : pulumi.Input.encodeList<ServicePerimeterDryRunIngressPolicyIngressFromSource, Map<String, dynamic>>(sources!, (value) => value.toMap()),
    };
  }
  ...
  factory ServicePerimeterDryRunIngressPolicyIngressFrom.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterDryRunIngressPolicyIngressFrom(
      ...
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<ServicePerimeterDryRunIngressPolicyIngressFromSource>(map['sources'], (value) => ServicePerimeterDryRunIngressPolicyIngressFromSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
