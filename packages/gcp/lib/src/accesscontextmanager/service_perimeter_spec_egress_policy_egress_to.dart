...
import 'service_perimeter_spec_egress_policy_egress_to_operation.dart';
...
class ServicePerimeterSpecEgressPolicyEgressTo {
  ...
  /// Creates a new [ServicePerimeterSpecEgressPolicyEgressTo].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?operations == null ? null : pulumi.Input.encodeList<ServicePerimeterSpecEgressPolicyEgressToOperation, Map<String, dynamic>>(operations!, (value) => value.toMap()),
      'resources': ?resources,
      'roles': ?roles,
    };
  }

  factory ServicePerimeterSpecEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterSpecEgressPolicyEgressTo(
      ...
      operations: map['operations'] == null ? null : pulumi.Input.decodeList<ServicePerimeterSpecEgressPolicyEgressToOperation>(map['operations'], (value) => ServicePerimeterSpecEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>())),
