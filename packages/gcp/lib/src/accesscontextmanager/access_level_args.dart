...
class AccessLevelArgs {
  ...
  factory AccessLevelArgs.fromMap(Map<String, dynamic> map) {
    return AccessLevelArgs(
      basic: map['basic'] == null ? null : AccessLevelBasic.fromMap((map['basic'] as Map).cast<String, dynamic>()),
      custom: map['custom'] == null ? null : AccessLevelCustom.fromMap((map['custom'] as Map).cast<String, dynamic>()),
