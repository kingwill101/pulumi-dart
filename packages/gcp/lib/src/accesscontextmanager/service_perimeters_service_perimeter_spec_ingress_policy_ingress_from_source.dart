...
class ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSource {
  ...
  /// Creates a new [ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSource].
  ...
  factory ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSource.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSource(
