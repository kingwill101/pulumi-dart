...
class ServicePerimeterDryRunIngressPolicyIngressToOperation {
  ...
  final List<ServicePerimeterDryRunIngressPolicyIngressToOperationMethodSelector>? methodSelectors;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'methodSelectors': ?methodSelectors == null ? null : pulumi.Input.encodeList<ServicePerimeterDryRunIngressPolicyIngressToOperationMethodSelector, Map<String, dynamic>>(methodSelectors!, (value) => value.toMap()),
  ...
  factory ServicePerimeterDryRunIngressPolicyIngressToOperation.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterDryRunIngressPolicyIngressToOperation(
      methodSelectors: map['methodSelectors'] == null ? null : pulumi.Input.decodeList<ServicePerimeterDryRunIngressPolicyIngressToOperationMethodSelector>(map['methodSelectors'], (value) => ServicePerimeterDryRunIngressPolicyIngressToOperationMethodSelector.fromMap((value as Map).cast<String, dynamic>())),
