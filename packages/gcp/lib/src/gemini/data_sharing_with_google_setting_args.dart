...
class DataSharingWithGoogleSettingArgs {
  ...
  factory DataSharingWithGoogleSettingArgs.fromMap(Map<String, dynamic> map) {
    return DataSharingWithGoogleSettingArgs(
      ...
      enableDataSharing: map['enableDataSharing'] == null ? null : map['enableDataSharing'] as bool,
      enablePreviewDataSharing: map['enablePreviewDataSharing'] == null ? null : map['enablePreviewDataSharing'] as bool,
