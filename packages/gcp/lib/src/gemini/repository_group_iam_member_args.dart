...
class RepositoryGroupIamMemberArgs {
  ...
  RepositoryGroupIamMemberArgs({
    ...
    RepositoryGroupIamMemberCondition? condition,
    String? location,
  ...
  factory RepositoryGroupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryGroupIamMemberArgs(
      ...
      condition: map['condition'] == null ? null : RepositoryGroupIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
