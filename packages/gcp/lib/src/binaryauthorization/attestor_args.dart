...
class AttestorArgs {
  ...
  AttestorArgs({
    required AttestorAttestationAuthorityNote attestationAuthorityNote,
    String? description,
    String? name,
    String? project,
  }) :
  ...
  factory AttestorArgs.fromMap(Map<String, dynamic> map) {
    return AttestorArgs(
      attestationAuthorityNote: AttestorAttestationAuthorityNote.fromMap((map['attestationAuthorityNote'] as Map).cast<String, dynamic>()),
