...
/// {@template pulumi_binaryauthorization_policy_policy_args_doc}
/// The set of arguments for Policy.
/// {@endtemplate}
/// {@macro pulumi_binaryauthorization_policy_policy_args_doc}
class PolicyArgs {
  ...
  PolicyArgs({
    List<PolicyAdmissionWhitelistPattern>? admissionWhitelistPatterns,
    List<PolicyClusterAdmissionRule>? clusterAdmissionRules,
    required PolicyDefaultAdmissionRule defaultAdmissionRule,
    String? description,
    ...
    String? project,
        ...
        globalPolicyEvaluationMode =
            pulumi.Input.asOptionalInput<String>(globalPolicyEvaluationMode),
