...
class ResponsePolicyArgs {
  ...
  factory ResponsePolicyArgs.fromMap(Map<String, dynamic> map) {
    return ResponsePolicyArgs(
      ...
      gkeClusters: map['gkeClusters'] == null ? null : pulumi.Input.decodeList<ResponsePolicyGkeCluster>(map['gkeClusters'], (value) => ResponsePolicyGkeCluster.fromMap((value as Map).cast<String, dynamic>())),
      networks: map['networks'] == null ? null : pulumi.Input.decodeList<ResponsePolicyNetwork>(map['networks'], (value) => ResponsePolicyNetwork.fromMap((value as Map).cast<String, dynamic>())),
