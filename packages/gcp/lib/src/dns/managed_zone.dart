...
class ManagedZone extends pulumi.CustomResource {
  ...
  ManagedZone(
    ...
    this.cloudLoggingConfig = registerOutput<ManagedZoneCloudLoggingConfig>(
      'cloudLoggingConfig',
    );
    ...
    this.forwardingConfig = registerOutput<ManagedZoneForwardingConfig?>(
      'forwardingConfig',
    );
    ...
    this.peeringConfig = registerOutput<ManagedZonePeeringConfig?>(
      'peeringConfig',
    );
