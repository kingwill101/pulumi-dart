...
class GetKeysZoneSigningKey {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'digests': pulumi.Input.encodeList<GetKeysZoneSigningKeyDigest, Map<String, dynamic>>(digests, (value) => value.toMap()),
      'id': id,
      'isActive': isActive,
      'keyLength': keyLength,
      'keyTag': keyTag,
  ...
  factory GetKeysZoneSigningKey.fromMap(Map<String, dynamic> map) {
    return GetKeysZoneSigningKey(
      ...
      digests: pulumi.Input.decodeList<GetKeysZoneSigningKeyDigest>(map['digests'], (value) => GetKeysZoneSigningKeyDigest.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
