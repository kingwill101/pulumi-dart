...
/// {@template pulumi_dns_dns_managed_zone_iam_member_dns_managed_zone_iam_member_args_doc}
/// The set of arguments for DnsManagedZoneIamMember.
/// {@endtemplate}
/// {@macro pulumi_dns_dns_managed_zone_iam_member_dns_managed_zone_iam_member_args_doc}
class DnsManagedZoneIamMemberArgs {
  ...
  /// Creates a new [DnsManagedZoneIamMemberArgs].
  /// [condition] Optional.
  ...
  factory DnsManagedZoneIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DnsManagedZoneIamMemberArgs(
      condition: map['condition'] == null ? null : DnsManagedZoneIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
