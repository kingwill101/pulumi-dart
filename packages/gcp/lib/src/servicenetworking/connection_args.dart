...
class ConnectionArgs {
  ...
  ConnectionArgs({
    ...
    required List<String> reservedPeeringRanges,
    required String service,
    bool? updateOnCreationFail,
  }) : deletionPolicy = pulumi.Input.asOptionalInput<String>(deletionPolicy),
       network = pulumi.Input.asInput<String>(network),
       reservedPeeringRanges = pulumi.Input.asInput<List<String>>(
         reservedPeeringRanges,
       ),
       service = pulumi.Input.asInput<String>(service),
       updateOnCreationFail = pulumi.Input.asOptionalInput<bool>(
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      ...
      reservedPeeringRanges: (map['reservedPeeringRanges'] as List)
          .cast<String>(),
      service: map['service'] as String,
      updateOnCreationFail: map['updateOnCreationFail'] == null
          ? null
          : map['updateOnCreationFail'] as bool,
    );
  }
}
