...
class ConnectionArgs {
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      ...
      reservedPeeringRanges: (map['reservedPeeringRanges'] as List).cast<String>(),
      service: map['service'] as String,
      updateOnCreationFail: map['updateOnCreationFail'] == null ? null : map['updateOnCreationFail'] as bool,
    );
  }
}
