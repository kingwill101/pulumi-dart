...
class BackupPlanArgs {
  ...
  factory BackupPlanArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanArgs(
      backupConfig: map['backupConfig'] == null ? null : BackupPlanBackupConfig.fromMap((map['backupConfig'] as Map).cast<String, dynamic>()),
      backupSchedule: map['backupSchedule'] == null ? null : BackupPlanBackupSchedule.fromMap((map['backupSchedule'] as Map).cast<String, dynamic>()),
      ...
      retentionPolicy: map['retentionPolicy'] == null ? null : BackupPlanRetentionPolicy.fromMap((map['retentionPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
