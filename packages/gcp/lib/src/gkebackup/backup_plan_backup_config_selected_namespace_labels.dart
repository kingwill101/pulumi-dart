...
class BackupPlanBackupConfigSelectedNamespaceLabels {
  ...
  final List<BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabel> resourceLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'resourceLabels': pulumi.Input.encodeList<BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabel, Map<String, dynamic>>(resourceLabels, (value) => value.toMap()),
    };
  }
  ...
  factory BackupPlanBackupConfigSelectedNamespaceLabels.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupConfigSelectedNamespaceLabels(
      resourceLabels: pulumi.Input.decodeList<BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabel>(map['resourceLabels'], (value) => BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
