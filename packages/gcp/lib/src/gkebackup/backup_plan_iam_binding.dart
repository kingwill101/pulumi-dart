...
import 'backup_plan_iam_binding_args.dart';
...
class BackupPlanIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<BackupPlanIamBindingCondition?> condition;
  ...
  /// Creates a new [BackupPlanIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackupPlanIamBinding]. {@macro pulumi_gkebackup_backup_plan_iam_binding_backup_plan_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BackupPlanIamBinding(
    String name, {
    BackupPlanIamBindingArgs? args,
    ...
    this.condition = registerOutput<BackupPlanIamBindingCondition?>('condition');
