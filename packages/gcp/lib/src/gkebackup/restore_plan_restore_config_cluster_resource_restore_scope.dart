...
class RestorePlanRestoreConfigClusterResourceRestoreScope {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'excludedGroupKinds': ?excludedGroupKinds == null
          ? null
      ...
      'selectedGroupKinds': ?selectedGroupKinds == null
          ? null
          : pulumi.Input.encodeList<
              RestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKind,
              Map<String, dynamic>
  ...
  factory RestorePlanRestoreConfigClusterResourceRestoreScope.fromMap(
    ...
    return RestorePlanRestoreConfigClusterResourceRestoreScope(
      allGroupKinds: map['allGroupKinds'] == null
          ? null
          : map['allGroupKinds'] as bool,
      excludedGroupKinds: map['excludedGroupKinds'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKind.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      noGroupKinds: map['noGroupKinds'] == null
          ? null
          : map['noGroupKinds'] as bool,
      selectedGroupKinds: map['selectedGroupKinds'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  RestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKind.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
    );
