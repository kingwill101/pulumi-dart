...
class BackupPlanIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [BackupPlanIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackupPlanIamMember]. {@macro pulumi_gkebackup_backup_plan_iam_member_backup_plan_iam_member_args_doc}
