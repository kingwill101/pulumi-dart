...
class ConnectionIAMBindingArgs {
  ...
  ConnectionIAMBindingArgs({
    ConnectionIAMBindingCondition? condition,
    String? location,
  ...
  factory ConnectionIAMBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionIAMBindingArgs(
      condition: map['condition'] == null ? null : ConnectionIAMBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
