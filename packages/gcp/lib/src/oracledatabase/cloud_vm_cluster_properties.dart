...
class CloudVmClusterProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diagnosticsDataCollectionOptions':
          ?diagnosticsDataCollectionOptions == null
          ? null
          : diagnosticsDataCollectionOptions!.toMap(),
  ...
  factory CloudVmClusterProperties.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterProperties(
      ...
      compartmentId: map['compartmentId'] == null
          ? null
          : map['compartmentId'] as String,
      ...
      diagnosticsDataCollectionOptions:
          ...
          : CloudVmClusterPropertiesDiagnosticsDataCollectionOptions.fromMap(
              (map['diagnosticsDataCollectionOptions'] as Map)
                  .cast<String, dynamic>(),
            ),
      diskRedundancy: map['diskRedundancy'] == null
          ? null
          : map['diskRedundancy'] as String,
      dnsListenerIp: map['dnsListenerIp'] == null
          ? null
          : map['dnsListenerIp'] as String,
      ...
      storageSizeGb: map['storageSizeGb'] == null
          ? null
          : map['storageSizeGb'] as int,
      systemVersion: map['systemVersion'] == null
          ? null
          : map['systemVersion'] as String,
