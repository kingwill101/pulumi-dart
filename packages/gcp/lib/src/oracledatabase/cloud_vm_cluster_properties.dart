...
class CloudVmClusterProperties {
  ...
  final CloudVmClusterPropertiesDiagnosticsDataCollectionOptions? diagnosticsDataCollectionOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diagnosticsDataCollectionOptions': ?diagnosticsDataCollectionOptions == null ? null : diagnosticsDataCollectionOptions!.toMap(),
  ...
  factory CloudVmClusterProperties.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterProperties(
      ...
      compartmentId: map['compartmentId'] == null ? null : map['compartmentId'] as String,
      ...
      dbServerOcids: map['dbServerOcids'] == null ? null : (map['dbServerOcids'] as List).cast<String>(),
      diagnosticsDataCollectionOptions: map['diagnosticsDataCollectionOptions'] == null ? null : CloudVmClusterPropertiesDiagnosticsDataCollectionOptions.fromMap((map['diagnosticsDataCollectionOptions'] as Map).cast<String, dynamic>()),
      diskRedundancy: map['diskRedundancy'] == null ? null : map['diskRedundancy'] as String,
      dnsListenerIp: map['dnsListenerIp'] == null ? null : map['dnsListenerIp'] as String,
      ...
      localBackupEnabled: map['localBackupEnabled'] == null ? null : map['localBackupEnabled'] as bool,
      ...
      scanDnsRecordId: map['scanDnsRecordId'] == null ? null : map['scanDnsRecordId'] as String,
      scanIpIds: map['scanIpIds'] == null ? null : (map['scanIpIds'] as List).cast<String>(),
      scanListenerPortTcp: map['scanListenerPortTcp'] == null ? null : map['scanListenerPortTcp'] as int,
      scanListenerPortTcpSsl: map['scanListenerPortTcpSsl'] == null ? null : map['scanListenerPortTcpSsl'] as int,
      shape: map['shape'] == null ? null : map['shape'] as String,
      sparseDiskgroupEnabled: map['sparseDiskgroupEnabled'] == null ? null : map['sparseDiskgroupEnabled'] as bool,
      sshPublicKeys: map['sshPublicKeys'] == null ? null : (map['sshPublicKeys'] as List).cast<String>(),
      state: map['state'] == null ? null : map['state'] as String,
      storageSizeGb: map['storageSizeGb'] == null ? null : map['storageSizeGb'] as int,
      systemVersion: map['systemVersion'] == null ? null : map['systemVersion'] as String,
      timeZone: map['timeZone'] == null ? null : CloudVmClusterPropertiesTimeZone.fromMap((map['timeZone'] as Map).cast<String, dynamic>()),
    );
  }
}
