    ...
    return <String, dynamic>{
      'allConnectionStrings':
          pulumi.Input.encodeList<
            GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringAllConnectionString,
            Map<String, dynamic>
          >(allConnectionStrings, (value) => value.toMap()),
      'dedicated': dedicated,
      'high': high,
      'low': low,
      'medium': medium,
    ...
    return GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString(
      allConnectionStrings:
          ...
          >(
            ...
            (value) =>
                GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringAllConnectionString.fromMap(
      ...
      profiles:
          ...
          >(
            map['profiles'],
            (value) =>
                GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringProfile.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
    );
