...
class GetCloudVmClustersCloudVmCluster {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'odbSubnet': odbSubnet,
      'project': project,
      'properties': pulumi.Input.encodeList<GetCloudVmClustersCloudVmClusterProperty, Map<String, dynamic>>(properties, (value) => value.toMap()),
  ...
  factory GetCloudVmClustersCloudVmCluster.fromMap(Map<String, dynamic> map) {
    return GetCloudVmClustersCloudVmCluster(
      ...
      properties: pulumi.Input.decodeList<GetCloudVmClustersCloudVmClusterProperty>(map['properties'], (value) => GetCloudVmClustersCloudVmClusterProperty.fromMap((value as Map).cast<String, dynamic>())),
