...
class ExascaleDbStorageVault extends pulumi.CustomResource {
  ...
  ExascaleDbStorageVault(
    ...
    this.exascaleDbStorageVaultId = registerOutput<String>('exascaleDbStorageVaultId');
    this.gcpOracleZone = registerOutput<String>('gcpOracleZone');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.properties = registerOutput<ExascaleDbStorageVaultProperties>('properties');
