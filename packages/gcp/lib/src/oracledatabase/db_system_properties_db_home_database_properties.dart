...
class DbSystemPropertiesDbHomeDatabaseProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'databaseManagementConfig': ?databaseManagementConfig == null
          ? null
          : databaseManagementConfig!.toMap(),
      'dbBackupConfig': ?dbBackupConfig == null
          ? null
          : dbBackupConfig!.toMap(),
      'dbVersion': dbVersion,
      'state': ?state,
    };
  }
    ...
    return DbSystemPropertiesDbHomeDatabaseProperties(
      databaseManagementConfig: map['databaseManagementConfig'] == null
          ...
          : DbSystemPropertiesDbHomeDatabasePropertiesDatabaseManagementConfig.fromMap(
              (map['databaseManagementConfig'] as Map).cast<String, dynamic>(),
            ),
