...
class CloudVmClusterArgs {
  ...
  CloudVmClusterArgs({
    ...
    CloudVmClusterProperties? properties,
        ...
        backupSubnetCidr =
            pulumi.Input.asOptionalInput<String>(backupSubnetCidr),
        ...
        exadataInfrastructure =
            pulumi.Input.asInput<String>(exadataInfrastructure),
        ...
        properties =
            pulumi.Input.asOptionalInput<CloudVmClusterProperties>(properties);
  ...
  factory CloudVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterArgs(
      backupOdbSubnet: map['backupOdbSubnet'] == null
          ? null
          : map['backupOdbSubnet'] as String,
      backupSubnetCidr: map['backupSubnetCidr'] == null
          ? null
      ...
      odbNetwork:
          map['odbNetwork'] == null ? null : map['odbNetwork'] as String,
      odbSubnet: map['odbSubnet'] == null ? null : map['odbSubnet'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      properties: map['properties'] == null
          ? null
          : CloudVmClusterProperties.fromMap(
