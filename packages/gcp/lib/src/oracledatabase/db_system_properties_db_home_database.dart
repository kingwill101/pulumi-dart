...
class DbSystemPropertiesDbHomeDatabase {
  ...
  factory DbSystemPropertiesDbHomeDatabase.fromMap(Map<String, dynamic> map) {
    return DbSystemPropertiesDbHomeDatabase(
      ...
      dbHomeName: map['dbHomeName'] == null ? null : map['dbHomeName'] as String,
      dbName: map['dbName'] == null ? null : map['dbName'] as String,
      dbUniqueName: map['dbUniqueName'] == null ? null : map['dbUniqueName'] as String,
      ...
      opsInsightsStatus: map['opsInsightsStatus'] == null ? null : map['opsInsightsStatus'] as String,
      properties: map['properties'] == null ? null : DbSystemPropertiesDbHomeDatabaseProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      tdeWalletPassword: map['tdeWalletPassword'] == null ? null : map['tdeWalletPassword'] as String,
    );
  }
}
