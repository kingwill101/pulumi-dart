...
class AutonomousDatabasePropertiesConnectionStringProfile {
  ...
  factory AutonomousDatabasePropertiesConnectionStringProfile.fromMap(
    ...
    return AutonomousDatabasePropertiesConnectionStringProfile(
      consumerGroup: map['consumerGroup'] == null
          ? null
          : map['consumerGroup'] as String,
      displayName: map['displayName'] == null
          ? null
          : map['displayName'] as String,
      hostFormat: map['hostFormat'] == null
          ? null
          : map['hostFormat'] as String,
      isRegional: map['isRegional'] == null ? null : map['isRegional'] as bool,
      protocol: map['protocol'] == null ? null : map['protocol'] as String,
      sessionMode: map['sessionMode'] == null
          ? null
          : map['sessionMode'] as String,
      syntaxFormat: map['syntaxFormat'] == null
          ? null
          : map['syntaxFormat'] as String,
