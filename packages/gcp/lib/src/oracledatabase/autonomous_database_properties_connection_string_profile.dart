...
class AutonomousDatabasePropertiesConnectionStringProfile {
  ...
  factory AutonomousDatabasePropertiesConnectionStringProfile.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabasePropertiesConnectionStringProfile(
      ...
      hostFormat: map['hostFormat'] == null ? null : map['hostFormat'] as String,
      isRegional: map['isRegional'] == null ? null : map['isRegional'] as bool,
      protocol: map['protocol'] == null ? null : map['protocol'] as String,
      sessionMode: map['sessionMode'] == null ? null : map['sessionMode'] as String,
      syntaxFormat: map['syntaxFormat'] == null ? null : map['syntaxFormat'] as String,
      tlsAuthentication: map['tlsAuthentication'] == null ? null : map['tlsAuthentication'] as String,
