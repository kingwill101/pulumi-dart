...
class AutonomousDatabaseArgs {
  ...
  AutonomousDatabaseArgs({
    ...
    AutonomousDatabaseSourceConfig? sourceConfig,
  }) :
  ...
  factory AutonomousDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseArgs(
      ...
      properties: map['properties'] == null ? null : AutonomousDatabaseProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      sourceConfig: map['sourceConfig'] == null ? null : AutonomousDatabaseSourceConfig.fromMap((map['sourceConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
