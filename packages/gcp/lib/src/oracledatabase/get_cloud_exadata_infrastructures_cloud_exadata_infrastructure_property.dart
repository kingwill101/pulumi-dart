...
class GetCloudExadataInfrastructuresCloudExadataInfrastructureProperty {
  ...
  final List<GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyCustomerContact> customerContacts;
  ...
  final List<GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyMaintenanceWindow> maintenanceWindows;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cpuCount': cpuCount,
      'customerContacts': pulumi.Input.encodeList<GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyCustomerContact, Map<String, dynamic>>(customerContacts, (value) => value.toMap()),
      'dataStorageSizeTb': dataStorageSizeTb,
      'dbNodeStorageSizeGb': dbNodeStorageSizeGb,
      'dbServerVersion': dbServerVersion,
      'maintenanceWindows': pulumi.Input.encodeList<GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyMaintenanceWindow, Map<String, dynamic>>(maintenanceWindows, (value) => value.toMap()),
  ...
  factory GetCloudExadataInfrastructuresCloudExadataInfrastructureProperty.fromMap(Map<String, dynamic> map) {
    return GetCloudExadataInfrastructuresCloudExadataInfrastructureProperty(
      ...
      customerContacts: pulumi.Input.decodeList<GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyCustomerContact>(map['customerContacts'], (value) => GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyCustomerContact.fromMap((value as Map).cast<String, dynamic>())),
      ...
      maintenanceWindows: pulumi.Input.decodeList<GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyMaintenanceWindow>(map['maintenanceWindows'], (value) => GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>())),
