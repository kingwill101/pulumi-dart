...
class GetCloudVmClustersCloudVmClusterProperty {
  ...
  final List<GetCloudVmClustersCloudVmClusterPropertyDiagnosticsDataCollectionOption> diagnosticsDataCollectionOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diagnosticsDataCollectionOptions': pulumi.Input.encodeList<GetCloudVmClustersCloudVmClusterPropertyDiagnosticsDataCollectionOption, Map<String, dynamic>>(diagnosticsDataCollectionOptions, (value) => value.toMap()),
      ...
      'timeZones': pulumi.Input.encodeList<GetCloudVmClustersCloudVmClusterPropertyTimeZone, Map<String, dynamic>>(timeZones, (value) => value.toMap()),
    };
  }
  ...
  factory GetCloudVmClustersCloudVmClusterProperty.fromMap(Map<String, dynamic> map) {
    return GetCloudVmClustersCloudVmClusterProperty(
      ...
      diagnosticsDataCollectionOptions: pulumi.Input.decodeList<GetCloudVmClustersCloudVmClusterPropertyDiagnosticsDataCollectionOption>(map['diagnosticsDataCollectionOptions'], (value) => GetCloudVmClustersCloudVmClusterPropertyDiagnosticsDataCollectionOption.fromMap((value as Map).cast<String, dynamic>())),
      ...
      timeZones: pulumi.Input.decodeList<GetCloudVmClustersCloudVmClusterPropertyTimeZone>(map['timeZones'], (value) => GetCloudVmClustersCloudVmClusterPropertyTimeZone.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
