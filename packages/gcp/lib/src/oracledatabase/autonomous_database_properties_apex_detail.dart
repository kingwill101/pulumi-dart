...
class AutonomousDatabasePropertiesApexDetail {
  ...
  AutonomousDatabasePropertiesApexDetail({this.apexVersion, this.ordsVersion});
  ...
  factory AutonomousDatabasePropertiesApexDetail.fromMap(
    ...
    return AutonomousDatabasePropertiesApexDetail(
      apexVersion: map['apexVersion'] == null
          ? null
          : map['apexVersion'] as String,
      ordsVersion: map['ordsVersion'] == null
          ? null
          : map['ordsVersion'] as String,
    );
  }
}
