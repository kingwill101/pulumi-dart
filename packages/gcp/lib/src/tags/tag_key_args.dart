...
class TagKeyArgs {
  ...
  factory TagKeyArgs.fromMap(Map<String, dynamic> map) {
    return TagKeyArgs(
      allowedValuesRegex: map['allowedValuesRegex'] == null ? null : map['allowedValuesRegex'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      parent: map['parent'] as String,
      purpose: map['purpose'] == null ? null : map['purpose'] as String,
      purposeData: map['purposeData'] == null ? null : (map['purposeData'] as Map).cast<String, String>(),
