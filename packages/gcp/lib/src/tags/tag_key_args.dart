...
class TagKeyArgs {
  ...
  }) : allowedValuesRegex = pulumi.Input.asOptionalInput<String>(
         allowedValuesRegex,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       parent = pulumi.Input.asInput<String>(parent),
       purpose = pulumi.Input.asOptionalInput<String>(purpose),
       purposeData = pulumi.Input.asOptionalInput<Map<String, String>>(
         purposeData,
       ),
  ...
  factory TagKeyArgs.fromMap(Map<String, dynamic> map) {
    return TagKeyArgs(
      allowedValuesRegex: map['allowedValuesRegex'] == null
          ? null
          : map['allowedValuesRegex'] as String,
      description: map['description'] == null
          ? null
          : map['description'] as String,
      parent: map['parent'] as String,
      purpose: map['purpose'] == null ? null : map['purpose'] as String,
      purposeData: map['purposeData'] == null
          ? null
          : (map['purposeData'] as Map).cast<String, String>(),
