...
class DnsThreatDetectorArgs {
  ...
  factory DnsThreatDetectorArgs.fromMap(Map<String, dynamic> map) {
    return DnsThreatDetectorArgs(
      excludedNetworks: map['excludedNetworks'] == null ? null : (map['excludedNetworks'] as List).cast<String>(),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      threatDetectorProvider: map['threatDetectorProvider'] == null ? null : map['threatDetectorProvider'] as String,
    );
  }
}
