...
class BackendAuthenticationConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String?> wellKnownRoots;

  /// Creates a new [BackendAuthenticationConfig].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackendAuthenticationConfig]. {@macro pulumi_networksecurity_backend_authentication_config_backend_authentication_config_args_doc}
