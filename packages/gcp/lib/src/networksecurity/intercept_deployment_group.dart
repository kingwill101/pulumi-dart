...
class InterceptDeploymentGroup extends pulumi.CustomResource {
  ...
  InterceptDeploymentGroup(
    ...
    this.connectedEndpointGroups = registerOutput<List<InterceptDeploymentGroupConnectedEndpointGroup>>('connectedEndpointGroups');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String?>('description');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.interceptDeploymentGroupId = registerOutput<String>('interceptDeploymentGroupId');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.locations = registerOutput<List<InterceptDeploymentGroupLocation>>('locations');
