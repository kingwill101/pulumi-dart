...
class SecurityProfileGroupArgs {
  ...
  factory SecurityProfileGroupArgs.fromMap(Map<String, dynamic> map) {
    return SecurityProfileGroupArgs(
      customInterceptProfile: map['customInterceptProfile'] == null ? null : map['customInterceptProfile'] as String,
      customMirroringProfile: map['customMirroringProfile'] == null ? null : map['customMirroringProfile'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parent: map['parent'] == null ? null : map['parent'] as String,
      threatPreventionProfile: map['threatPreventionProfile'] == null ? null : map['threatPreventionProfile'] as String,
