...
class SecurityProfileGroupArgs {
  ...
  SecurityProfileGroupArgs({
    ...
    String? urlFilteringProfile,
            ...
            pulumi.Input.asOptionalInput<String>(customInterceptProfile),
        customMirroringProfile =
            pulumi.Input.asOptionalInput<String>(customMirroringProfile),
        ...
        threatPreventionProfile =
            pulumi.Input.asOptionalInput<String>(threatPreventionProfile),
        urlFilteringProfile =
            pulumi.Input.asOptionalInput<String>(urlFilteringProfile);
