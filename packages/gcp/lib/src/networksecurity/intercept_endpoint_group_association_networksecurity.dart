...
class InterceptEndpointGroupAssociationNetworksecurity
  ...
  late final pulumi.Output<List<InterceptEndpointGroupAssociationLocation>>
  locations;
  ...
  InterceptEndpointGroupAssociationNetworksecurity(
    ...
    this.interceptEndpointGroup = registerOutput<String>(
      'interceptEndpointGroup',
    );
    this.interceptEndpointGroupAssociationId = registerOutput<String?>(
