...
class SecurityProfileCustomMirroringProfile {
  ...
  final List<String>? mirroringDeploymentGroups;
  ...
  final String mirroringEndpointGroup;
  ...
  /// DIRECT
  /// BROKER
  final String? mirroringEndpointGroupType;
  ...
  Map<String, dynamic> toMap() {
    ...
    final mirroringEndpointGroupTypeValue = mirroringEndpointGroupType;
    if (mirroringEndpointGroupTypeValue != null) {
      map['mirroringEndpointGroupType'] = mirroringEndpointGroupTypeValue;
    }
    return map;
  }
  ...
  factory SecurityProfileCustomMirroringProfile.fromMap(
    ...
    return SecurityProfileCustomMirroringProfile(
      ...
      mirroringEndpointGroupType: map['mirroringEndpointGroupType'] == null
          ? null
          : map['mirroringEndpointGroupType'] as String,
    );
  }
}
