...
class InterceptEndpointGroup extends pulumi.CustomResource {
  ...
  InterceptEndpointGroup(
    ...
    this.associations = registerOutput<List<InterceptEndpointGroupAssociation>>('associations');
    this.connectedDeploymentGroups = registerOutput<List<InterceptEndpointGroupConnectedDeploymentGroup>>('connectedDeploymentGroups');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String?>('description');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.interceptDeploymentGroup = registerOutput<String>('interceptDeploymentGroup');
    this.interceptEndpointGroupId = registerOutput<String>('interceptEndpointGroupId');
