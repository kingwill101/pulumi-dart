...
class AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue {
  ...
  /// Creates a new [AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue].
  ...
  factory AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue.fromMap(
    Map<String, dynamic> map,
  ) {
    return AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue(
