...
class ServerTlsPolicyArgs {
  ...
  factory ServerTlsPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyArgs(
      ...
      mtlsPolicy: map['mtlsPolicy'] == null ? null : ServerTlsPolicyMtlsPolicy.fromMap((map['mtlsPolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      serverCertificate: map['serverCertificate'] == null ? null : ServerTlsPolicyServerCertificate.fromMap((map['serverCertificate'] as Map).cast<String, dynamic>()),
    );
  }
}
