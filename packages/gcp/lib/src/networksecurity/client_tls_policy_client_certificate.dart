...
class ClientTlsPolicyClientCertificate {
  ...
  final ClientTlsPolicyClientCertificateCertificateProviderInstance? certificateProviderInstance;
  ...
  factory ClientTlsPolicyClientCertificate.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyClientCertificate(
      certificateProviderInstance: map['certificateProviderInstance'] == null ? null : ClientTlsPolicyClientCertificateCertificateProviderInstance.fromMap((map['certificateProviderInstance'] as Map).cast<String, dynamic>()),
      grpcEndpoint: map['grpcEndpoint'] == null ? null : ClientTlsPolicyClientCertificateGrpcEndpoint.fromMap((map['grpcEndpoint'] as Map).cast<String, dynamic>()),
    );
  }
}
