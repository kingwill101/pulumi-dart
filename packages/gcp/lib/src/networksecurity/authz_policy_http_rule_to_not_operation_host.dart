...
class AuthzPolicyHttpRuleToNotOperationHost {
  ...
  /// Creates a new [AuthzPolicyHttpRuleToNotOperationHost].
  ...
  factory AuthzPolicyHttpRuleToNotOperationHost.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleToNotOperationHost(
