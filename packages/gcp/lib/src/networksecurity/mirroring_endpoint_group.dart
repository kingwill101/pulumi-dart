...
class MirroringEndpointGroup extends pulumi.CustomResource {
  ...
  MirroringEndpointGroup(
    ...
    this.associations = registerOutput<List<MirroringEndpointGroupAssociation>>(
      'associations',
    );
    ...
    this.mirroringDeploymentGroup = registerOutput<String?>(
      'mirroringDeploymentGroup',
    );
    this.mirroringDeploymentGroups = registerOutput<List<String>?>(
      'mirroringDeploymentGroups',
    );
    this.mirroringEndpointGroupId = registerOutput<String>(
