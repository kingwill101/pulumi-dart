...
class MirroringEndpointGroup extends pulumi.CustomResource {
  ...
  MirroringEndpointGroup(
    ...
    this.associations = registerOutput<List<MirroringEndpointGroupAssociation>>('associations');
    this.connectedDeploymentGroups = registerOutput<List<MirroringEndpointGroupConnectedDeploymentGroup>>('connectedDeploymentGroups');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String?>('description');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.mirroringDeploymentGroup = registerOutput<String?>('mirroringDeploymentGroup');
    this.mirroringDeploymentGroups = registerOutput<List<String>?>('mirroringDeploymentGroups');
    this.mirroringEndpointGroupId = registerOutput<String>('mirroringEndpointGroupId');
