...
class FolderSinkArgs {
  ...
  factory FolderSinkArgs.fromMap(Map<String, dynamic> map) {
    return FolderSinkArgs(
      bigqueryOptions: map['bigqueryOptions'] == null ? null : FolderSinkBigqueryOptions.fromMap((map['bigqueryOptions'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      destination: map['destination'] as String,
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      exclusions: map['exclusions'] == null ? null : pulumi.Input.decodeList<FolderSinkExclusion>(map['exclusions'], (value) => FolderSinkExclusion.fromMap((value as Map).cast<String, dynamic>())),
      filter: map['filter'] == null ? null : map['filter'] as String,
      folder: map['folder'] as String,
      includeChildren: map['includeChildren'] == null ? null : map['includeChildren'] as bool,
      interceptChildren: map['interceptChildren'] == null ? null : map['interceptChildren'] as bool,
