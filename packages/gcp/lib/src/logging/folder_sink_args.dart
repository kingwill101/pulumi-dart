...
class FolderSinkArgs {
  ...
  FolderSinkArgs({
    ...
    String? name,
            ...
            pulumi.Input.asOptionalInput<FolderSinkBigqueryOptions>(
                bigqueryOptions),
        description = pulumi.Input.asOptionalInput<String>(description),
        destination = pulumi.Input.asInput<String>(destination),
        disabled = pulumi.Input.asOptionalInput<bool>(disabled),
        exclusions =
            pulumi.Input.asOptionalInput<List<FolderSinkExclusion>>(exclusions),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (exclusionsValue != null) {
      map['exclusions'] = pulumi.Input.mapOptionalInputValue<
              List<FolderSinkExclusion>, List<Map<String, dynamic>>>(
          exclusionsValue,
          (value) => pulumi.Input.encodeList<FolderSinkExclusion,
