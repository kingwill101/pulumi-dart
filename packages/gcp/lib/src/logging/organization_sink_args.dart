...
class OrganizationSinkArgs {
  ...
  factory OrganizationSinkArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSinkArgs(
      bigqueryOptions: map['bigqueryOptions'] == null ? null : OrganizationSinkBigqueryOptions.fromMap((map['bigqueryOptions'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      destination: map['destination'] as String,
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      exclusions: map['exclusions'] == null ? null : pulumi.Input.decodeList<OrganizationSinkExclusion>(map['exclusions'], (value) => OrganizationSinkExclusion.fromMap((value as Map).cast<String, dynamic>())),
