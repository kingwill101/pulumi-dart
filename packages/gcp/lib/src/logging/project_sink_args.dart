...
class ProjectSinkArgs {
  ...
  ProjectSinkArgs({
    ProjectSinkBigqueryOptions? bigqueryOptions,
    String? customWriterIdentity,
    String? description,
    required String destination,
    bool? disabled,
    List<ProjectSinkExclusion>? exclusions,
    String? filter,
    String? name,
    String? project,
    bool? uniqueWriterIdentity,
  }) : bigqueryOptions = pulumi
           .Input.asOptionalInput<ProjectSinkBigqueryOptions>(bigqueryOptions),
  ...
  factory ProjectSinkArgs.fromMap(Map<String, dynamic> map) {
    return ProjectSinkArgs(
      bigqueryOptions: map['bigqueryOptions'] == null
          ? null
          : ProjectSinkBigqueryOptions.fromMap(
      ...
      exclusions: map['exclusions'] == null
          ? null
          : pulumi.Input.decodeList<ProjectSinkExclusion>(
              map['exclusions'],
              (value) => ProjectSinkExclusion.fromMap(
