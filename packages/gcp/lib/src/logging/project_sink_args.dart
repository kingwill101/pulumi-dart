...
class ProjectSinkArgs {
  ...
  factory ProjectSinkArgs.fromMap(Map<String, dynamic> map) {
    return ProjectSinkArgs(
      bigqueryOptions: map['bigqueryOptions'] == null ? null : ProjectSinkBigqueryOptions.fromMap((map['bigqueryOptions'] as Map).cast<String, dynamic>()),
      customWriterIdentity: map['customWriterIdentity'] == null ? null : map['customWriterIdentity'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      destination: map['destination'] as String,
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      exclusions: map['exclusions'] == null ? null : pulumi.Input.decodeList<ProjectSinkExclusion>(map['exclusions'], (value) => ProjectSinkExclusion.fromMap((value as Map).cast<String, dynamic>())),
