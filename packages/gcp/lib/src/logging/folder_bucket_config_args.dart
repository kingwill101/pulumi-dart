...
class FolderBucketConfigArgs {
  ...
  factory FolderBucketConfigArgs.fromMap(Map<String, dynamic> map) {
    return FolderBucketConfigArgs(
      ...
      cmekSettings: map['cmekSettings'] == null ? null : FolderBucketConfigCmekSettings.fromMap((map['cmekSettings'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      folder: map['folder'] as String,
      indexConfigs: map['indexConfigs'] == null ? null : pulumi.Input.decodeList<FolderBucketConfigIndexConfig>(map['indexConfigs'], (value) => FolderBucketConfigIndexConfig.fromMap((value as Map).cast<String, dynamic>())),
