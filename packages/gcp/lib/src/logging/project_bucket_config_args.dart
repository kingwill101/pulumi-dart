...
class ProjectBucketConfigArgs {
  ...
  factory ProjectBucketConfigArgs.fromMap(Map<String, dynamic> map) {
    return ProjectBucketConfigArgs(
      ...
      cmekSettings: map['cmekSettings'] == null ? null : ProjectBucketConfigCmekSettings.fromMap((map['cmekSettings'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enableAnalytics: map['enableAnalytics'] == null ? null : map['enableAnalytics'] as bool,
      indexConfigs: map['indexConfigs'] == null ? null : pulumi.Input.decodeList<ProjectBucketConfigIndexConfig>(map['indexConfigs'], (value) => ProjectBucketConfigIndexConfig.fromMap((value as Map).cast<String, dynamic>())),
