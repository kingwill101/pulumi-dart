...
class BillingAccountSinkArgs {
  ...
  BillingAccountSinkArgs({
    BillingAccountSinkBigqueryOptions? bigqueryOptions,
    required String billingAccount,
    String? description,
    required String destination,
    bool? disabled,
    List<BillingAccountSinkExclusion>? exclusions,
    String? filter,
    String? name,
  }) :
  ...
  factory BillingAccountSinkArgs.fromMap(Map<String, dynamic> map) {
    return BillingAccountSinkArgs(
      bigqueryOptions: map['bigqueryOptions'] == null ? null : BillingAccountSinkBigqueryOptions.fromMap((map['bigqueryOptions'] as Map).cast<String, dynamic>()),
      billingAccount: map['billingAccount'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      destination: map['destination'] as String,
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      exclusions: map['exclusions'] == null ? null : pulumi.Input.decodeList<BillingAccountSinkExclusion>(map['exclusions'], (value) => BillingAccountSinkExclusion.fromMap((value as Map).cast<String, dynamic>())),
