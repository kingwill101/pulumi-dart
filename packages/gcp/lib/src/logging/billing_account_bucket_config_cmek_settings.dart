...
class BillingAccountBucketConfigCmekSettings {
  ...
  /// Creates a new [BillingAccountBucketConfigCmekSettings].
  ...
  factory BillingAccountBucketConfigCmekSettings.fromMap(
