...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      authorization: ClusterAuthorization.fromMap((map['authorization'] as Map).cast<String, dynamic>()),
      controlPlane: map['controlPlane'] == null ? null : ClusterControlPlane.fromMap((map['controlPlane'] as Map).cast<String, dynamic>()),
      controlPlaneEncryption: map['controlPlaneEncryption'] == null ? null : ClusterControlPlaneEncryption.fromMap((map['controlPlaneEncryption'] as Map).cast<String, dynamic>()),
      defaultMaxPodsPerNode: map['defaultMaxPodsPerNode'] == null ? null : map['defaultMaxPodsPerNode'] as int,
      externalLoadBalancerIpv4AddressPools: map['externalLoadBalancerIpv4AddressPools'] == null ? null : (map['externalLoadBalancerIpv4AddressPools'] as List).cast<String>(),
      fleet: ClusterFleet.fromMap((map['fleet'] as Map).cast<String, dynamic>()),
      ...
      networking: ClusterNetworking.fromMap((map['networking'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      releaseChannel: map['releaseChannel'] == null ? null : map['releaseChannel'] as String,
      systemAddonsConfig: map['systemAddonsConfig'] == null ? null : ClusterSystemAddonsConfig.fromMap((map['systemAddonsConfig'] as Map).cast<String, dynamic>()),
