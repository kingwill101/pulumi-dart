...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.controlPlaneEncryption = registerOutput<ClusterControlPlaneEncryption>('controlPlaneEncryption');
    ...
    this.externalLoadBalancerIpv4AddressPools = registerOutput<List<String>>('externalLoadBalancerIpv4AddressPools');
    this.fleet = registerOutput<ClusterFleet>('fleet');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.maintenanceEvents = registerOutput<List<ClusterMaintenanceEvent>>('maintenanceEvents');
    ...
    this.systemAddonsConfig = registerOutput<ClusterSystemAddonsConfig>('systemAddonsConfig');
