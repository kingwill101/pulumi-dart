...
class VpnConnectionArgs {
  ...
  VpnConnectionArgs({
    ...
    VpnConnectionVpcProject? vpcProject,
        ...
        enableHighAvailability =
            pulumi.Input.asOptionalInput<bool>(enableHighAvailability),
        ...
        vpcProject =
            pulumi.Input.asOptionalInput<VpnConnectionVpcProject>(vpcProject);
  ...
  factory VpnConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VpnConnectionArgs(
      ...
      enableHighAvailability: map['enableHighAvailability'] == null
          ? null
          : map['enableHighAvailability'] as bool,
