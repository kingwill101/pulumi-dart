...
class FolderCustomModuleCustomConfigCustomOutputProperty {
  ...
  final FolderCustomModuleCustomConfigCustomOutputPropertyValueExpression?
  valueExpression;
  ...
  factory FolderCustomModuleCustomConfigCustomOutputProperty.fromMap(
    ...
    return FolderCustomModuleCustomConfigCustomOutputProperty(
      ...
      valueExpression: map['valueExpression'] == null
          ? null
          : FolderCustomModuleCustomConfigCustomOutputPropertyValueExpression.fromMap(
