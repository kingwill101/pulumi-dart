...
class V2OrganizationNotificationConfigArgs {
  ...
  V2OrganizationNotificationConfigArgs({
    ...
    required V2OrganizationNotificationConfigStreamingConfig streamingConfig,
        ...
        streamingConfig = pulumi.Input.asInput<
            V2OrganizationNotificationConfigStreamingConfig>(streamingConfig);
  ...
  factory V2OrganizationNotificationConfigArgs.fromMap(
    ...
    return V2OrganizationNotificationConfigArgs(
      ...
      streamingConfig: V2OrganizationNotificationConfigStreamingConfig.fromMap(
