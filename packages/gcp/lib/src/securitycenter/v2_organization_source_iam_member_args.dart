...
import 'v2_organization_source_iam_member_condition.dart';

/// {@template pulumi_securitycenter_v2_organization_source_iam_member_v2_organization_source_iam_member_args_doc}
/// The set of arguments for V2OrganizationSourceIamMember.
/// {@endtemplate}
...
class V2OrganizationSourceIamMemberArgs {
  ...
  /// Creates a new [V2OrganizationSourceIamMemberArgs].
  /// [condition] Optional.
  ...
  V2OrganizationSourceIamMemberArgs({
    V2OrganizationSourceIamMemberCondition? condition,
  ...
  factory V2OrganizationSourceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return V2OrganizationSourceIamMemberArgs(
      condition: map['condition'] == null ? null : V2OrganizationSourceIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
