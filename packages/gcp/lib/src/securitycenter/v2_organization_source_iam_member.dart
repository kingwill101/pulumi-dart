...
class V2OrganizationSourceIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [V2OrganizationSourceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [V2OrganizationSourceIamMember]. {@macro pulumi_securitycenter_v2_organization_source_iam_member_v2_organization_source_iam_member_args_doc}
  ...
  V2OrganizationSourceIamMember(
    ...
    this.condition = registerOutput<V2OrganizationSourceIamMemberCondition?>(
      'condition',
    );
