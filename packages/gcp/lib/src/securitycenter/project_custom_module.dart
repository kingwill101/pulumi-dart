...
class ProjectCustomModule extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ProjectCustomModuleCustomConfig> customConfig;
  ...
  /// Creates a new [ProjectCustomModule].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProjectCustomModule]. {@macro pulumi_securitycenter_project_custom_module_project_custom_module_args_doc}
  ...
  ProjectCustomModule(
    ...
    this.customConfig = registerOutput<ProjectCustomModuleCustomConfig>('customConfig');
