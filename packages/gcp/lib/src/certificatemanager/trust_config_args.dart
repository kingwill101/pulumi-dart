...
class TrustConfigArgs {
  ...
  TrustConfigArgs({
    List<TrustConfigAllowlistedCertificate>? allowlistedCertificates,
    String? description,
    Map<String, String>? labels,
    required String location,
    String? name,
    String? project,
    List<TrustConfigTrustStore>? trustStores,
  }) :
  ...
  factory TrustConfigArgs.fromMap(Map<String, dynamic> map) {
    return TrustConfigArgs(
      allowlistedCertificates: map['allowlistedCertificates'] == null ? null : pulumi.Input.decodeList<TrustConfigAllowlistedCertificate>(map['allowlistedCertificates'], (value) => TrustConfigAllowlistedCertificate.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      trustStores: map['trustStores'] == null ? null : pulumi.Input.decodeList<TrustConfigTrustStore>(map['trustStores'], (value) => TrustConfigTrustStore.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
