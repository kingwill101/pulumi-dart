...
class CertificateIssuanceConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CertificateIssuanceConfigCertificateAuthorityConfig> certificateAuthorityConfig;
  ...
  CertificateIssuanceConfig(
    ...
    this.certificateAuthorityConfig = registerOutput<CertificateIssuanceConfigCertificateAuthorityConfig>('certificateAuthorityConfig');
