...
class Topic extends pulumi.CustomResource {
  ...
  Topic(String name, {TopicArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.messageStoragePolicy = registerOutput<TopicMessageStoragePolicy>(
      'messageStoragePolicy',
    );
    this.messageTransforms = registerOutput<List<TopicMessageTransform>?>(
      'messageTransforms',
    );
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.schemaSettings = registerOutput<TopicSchemaSettings?>(
      'schemaSettings',
    );
