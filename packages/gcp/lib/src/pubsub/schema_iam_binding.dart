...
import 'schema_iam_binding_args.dart';
...
class SchemaIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<SchemaIamBindingCondition?> condition;
  ...
  /// Creates a new [SchemaIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SchemaIamBinding]. {@macro pulumi_pubsub_schema_iam_binding_schema_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SchemaIamBinding(
    String name, {
    SchemaIamBindingArgs? args,
    ...
    this.condition = registerOutput<SchemaIamBindingCondition?>('condition');
