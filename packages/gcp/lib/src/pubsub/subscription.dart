...
class Subscription extends pulumi.CustomResource {
  ...
  Subscription(
    ...
    this.bigqueryConfig = registerOutput<SubscriptionBigqueryConfig?>(
      'bigqueryConfig',
    );
    this.cloudStorageConfig = registerOutput<SubscriptionCloudStorageConfig?>(
      'cloudStorageConfig',
    );
    this.deadLetterPolicy = registerOutput<SubscriptionDeadLetterPolicy?>(
      'deadLetterPolicy',
    );
    ...
    this.expirationPolicy = registerOutput<SubscriptionExpirationPolicy>(
      'expirationPolicy',
    );
