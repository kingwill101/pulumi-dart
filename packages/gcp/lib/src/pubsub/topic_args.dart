...
class TopicArgs {
  ...
  TopicArgs({
    ...
    Map<String, String>? tags,
        ...
        schemaSettings =
            pulumi.Input.asOptionalInput<TopicSchemaSettings>(schemaSettings),
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ingestionDataSourceSettings: map['ingestionDataSourceSettings'] == null
          ? null
          : TopicIngestionDataSourceSettings.fromMap(
              (map['ingestionDataSourceSettings'] as Map)
                  .cast<String, dynamic>()),
      kmsKeyName:
