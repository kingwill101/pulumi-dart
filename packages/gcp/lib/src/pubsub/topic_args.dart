...
class TopicArgs {
  ...
  TopicArgs({
    TopicIngestionDataSourceSettings? ingestionDataSourceSettings,
    String? kmsKeyName,
    Map<String, String>? labels,
    String? messageRetentionDuration,
    TopicMessageStoragePolicy? messageStoragePolicy,
    List<TopicMessageTransform>? messageTransforms,
    String? name,
    String? project,
    TopicSchemaSettings? schemaSettings,
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ingestionDataSourceSettings: map['ingestionDataSourceSettings'] == null ? null : TopicIngestionDataSourceSettings.fromMap((map['ingestionDataSourceSettings'] as Map).cast<String, dynamic>()),
      ...
      messageStoragePolicy: map['messageStoragePolicy'] == null ? null : TopicMessageStoragePolicy.fromMap((map['messageStoragePolicy'] as Map).cast<String, dynamic>()),
      messageTransforms: map['messageTransforms'] == null ? null : pulumi.Input.decodeList<TopicMessageTransform>(map['messageTransforms'], (value) => TopicMessageTransform.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      schemaSettings: map['schemaSettings'] == null ? null : TopicSchemaSettings.fromMap((map['schemaSettings'] as Map).cast<String, dynamic>()),
