...
class TopicIngestionDataSourceSettingsCloudStorage {
  ...
  factory TopicIngestionDataSourceSettingsCloudStorage.fromMap(Map<String, dynamic> map) {
    return TopicIngestionDataSourceSettingsCloudStorage(
      avroFormat: map['avroFormat'] == null ? null : (map['avroFormat'] as Map).cast<String, dynamic>(),
      bucket: map['bucket'] as String,
      matchGlob: map['matchGlob'] == null ? null : map['matchGlob'] as String,
      minimumObjectCreateTime: map['minimumObjectCreateTime'] == null ? null : map['minimumObjectCreateTime'] as String,
      pubsubAvroFormat: map['pubsubAvroFormat'] == null ? null : (map['pubsubAvroFormat'] as Map).cast<String, dynamic>(),
      textFormat: map['textFormat'] == null ? null : TopicIngestionDataSourceSettingsCloudStorageTextFormat.fromMap((map['textFormat'] as Map).cast<String, dynamic>()),
    );
  }
}
