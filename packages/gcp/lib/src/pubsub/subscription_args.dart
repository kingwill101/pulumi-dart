...
class SubscriptionArgs {
  ...
  SubscriptionArgs({
    ...
    required String topic,
        ...
        bigqueryConfig =
            pulumi.Input.asOptionalInput<SubscriptionBigqueryConfig>(
                bigqueryConfig),
        cloudStorageConfig =
        ...
        enableExactlyOnceDelivery =
            pulumi.Input.asOptionalInput<bool>(enableExactlyOnceDelivery),
        enableMessageOrdering =
            pulumi.Input.asOptionalInput<bool>(enableMessageOrdering),
        expirationPolicy =
        ...
        pushConfig =
            pulumi.Input.asOptionalInput<SubscriptionPushConfig>(pushConfig),
        retainAckedMessages =
            pulumi.Input.asOptionalInput<bool>(retainAckedMessages),
        retryPolicy =
            pulumi.Input.asOptionalInput<SubscriptionRetryPolicy>(retryPolicy),
  ...
  factory SubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionArgs(
      ...
      bigqueryConfig: map['bigqueryConfig'] == null
          ? null
          : SubscriptionBigqueryConfig.fromMap(
              (map['bigqueryConfig'] as Map).cast<String, dynamic>()),
      cloudStorageConfig: map['cloudStorageConfig'] == null
          ? null
          : SubscriptionCloudStorageConfig.fromMap(
              (map['cloudStorageConfig'] as Map).cast<String, dynamic>()),
      deadLetterPolicy: map['deadLetterPolicy'] == null
          ? null
          : SubscriptionDeadLetterPolicy.fromMap(
              (map['deadLetterPolicy'] as Map).cast<String, dynamic>()),
      enableExactlyOnceDelivery: map['enableExactlyOnceDelivery'] == null
          ? null
          : map['enableExactlyOnceDelivery'] as bool,
      enableMessageOrdering: map['enableMessageOrdering'] == null
          ? null
          : map['enableMessageOrdering'] as bool,
      expirationPolicy: map['expirationPolicy'] == null
          ? null
      ...
      messageTransforms: map['messageTransforms'] == null
          ? null
      ...
      retainAckedMessages: map['retainAckedMessages'] == null
          ? null
          : map['retainAckedMessages'] as bool,
