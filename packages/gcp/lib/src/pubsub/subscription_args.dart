...
class SubscriptionArgs {
  ...
  SubscriptionArgs({
    ...
    required String topic,
       ...
       bigqueryConfig = pulumi
           .Input.asOptionalInput<SubscriptionBigqueryConfig>(bigqueryConfig),
       cloudStorageConfig =
       ...
       enableExactlyOnceDelivery = pulumi.Input.asOptionalInput<bool>(
         enableExactlyOnceDelivery,
       ),
       enableMessageOrdering = pulumi.Input.asOptionalInput<bool>(
       ...
       retainAckedMessages = pulumi.Input.asOptionalInput<bool>(
         retainAckedMessages,
       ),
