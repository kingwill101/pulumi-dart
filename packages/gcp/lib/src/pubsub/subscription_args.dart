...
/// {@template pulumi_pubsub_subscription_subscription_args_doc}
/// The set of arguments for Subscription.
/// {@endtemplate}
/// {@macro pulumi_pubsub_subscription_subscription_args_doc}
class SubscriptionArgs {
  ...
  SubscriptionArgs({
    ...
    SubscriptionBigqueryConfig? bigqueryConfig,
    SubscriptionCloudStorageConfig? cloudStorageConfig,
    SubscriptionDeadLetterPolicy? deadLetterPolicy,
    bool? enableExactlyOnceDelivery,
    bool? enableMessageOrdering,
    SubscriptionExpirationPolicy? expirationPolicy,
    String? filter,
    Map<String, String>? labels,
    String? messageRetentionDuration,
    List<SubscriptionMessageTransform>? messageTransforms,
    String? name,
    String? project,
    SubscriptionPushConfig? pushConfig,
  ...
  factory SubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionArgs(
      ...
      bigqueryConfig: map['bigqueryConfig'] == null ? null : SubscriptionBigqueryConfig.fromMap((map['bigqueryConfig'] as Map).cast<String, dynamic>()),
      cloudStorageConfig: map['cloudStorageConfig'] == null ? null : SubscriptionCloudStorageConfig.fromMap((map['cloudStorageConfig'] as Map).cast<String, dynamic>()),
      deadLetterPolicy: map['deadLetterPolicy'] == null ? null : SubscriptionDeadLetterPolicy.fromMap((map['deadLetterPolicy'] as Map).cast<String, dynamic>()),
      enableExactlyOnceDelivery: map['enableExactlyOnceDelivery'] == null ? null : map['enableExactlyOnceDelivery'] as bool,
      enableMessageOrdering: map['enableMessageOrdering'] == null ? null : map['enableMessageOrdering'] as bool,
      expirationPolicy: map['expirationPolicy'] == null ? null : SubscriptionExpirationPolicy.fromMap((map['expirationPolicy'] as Map).cast<String, dynamic>()),
      ...
      messageTransforms: map['messageTransforms'] == null ? null : pulumi.Input.decodeList<SubscriptionMessageTransform>(map['messageTransforms'], (value) => SubscriptionMessageTransform.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pushConfig: map['pushConfig'] == null ? null : SubscriptionPushConfig.fromMap((map['pushConfig'] as Map).cast<String, dynamic>()),
      retainAckedMessages: map['retainAckedMessages'] == null ? null : map['retainAckedMessages'] as bool,
      retryPolicy: map['retryPolicy'] == null ? null : SubscriptionRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
