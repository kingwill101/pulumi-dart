...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.accelerators = registerOutput<List<InstanceAccelerator>?>(
      'accelerators',
    );
    this.apiEndpoint = registerOutput<String>('apiEndpoint');
    this.createTime = registerOutput<String>('createTime');
    this.cryptoKeyConfig = registerOutput<InstanceCryptoKeyConfig?>(
      'cryptoKeyConfig',
    );
    ...
    this.eventPublishConfig = registerOutput<InstanceEventPublishConfig?>(
      'eventPublishConfig',
    );
    this.gcsBucket = registerOutput<String>('gcsBucket');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<InstanceNetworkConfig?>(
      'networkConfig',
    );
