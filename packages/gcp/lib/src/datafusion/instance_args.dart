...
class InstanceArgs {
  ...
  InstanceArgs({
    List<InstanceAccelerator>? accelerators,
    InstanceCryptoKeyConfig? cryptoKeyConfig,
    ...
    InstanceEventPublishConfig? eventPublishConfig,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (acceleratorsValue != null) {
      map['accelerators'] = pulumi.Input.mapOptionalInputValue<
          ...
          acceleratorsValue,
          (value) => pulumi.Input.encodeList<InstanceAccelerator,
