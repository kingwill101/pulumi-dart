...
class InstanceNetworkConfigPrivateServiceConnectConfig {
  ...
  factory InstanceNetworkConfigPrivateServiceConnectConfig.fromMap(Map<String, dynamic> map) {
    return InstanceNetworkConfigPrivateServiceConnectConfig(
      effectiveUnreachableCidrBlock: map['effectiveUnreachableCidrBlock'] == null ? null : map['effectiveUnreachableCidrBlock'] as String,
      networkAttachment: map['networkAttachment'] == null ? null : map['networkAttachment'] as String,
      unreachableCidrBlock: map['unreachableCidrBlock'] == null ? null : map['unreachableCidrBlock'] as String,
    );
  }
}
