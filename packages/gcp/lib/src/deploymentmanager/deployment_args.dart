...
class DeploymentArgs {
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<DeploymentLabel>(map['labels'], (value) => DeploymentLabel.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      preview: map['preview'] == null ? null : map['preview'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      target: DeploymentTarget.fromMap((map['target'] as Map).cast<String, dynamic>()),
    );
  }
}
