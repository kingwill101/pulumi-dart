...
class ServiceTemplateSpecContainerStartupProbeHttpGet {
  ...
  final List<ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeader>? httpHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpHeaders': ?httpHeaders == null ? null : pulumi.Input.encodeList<ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeader, Map<String, dynamic>>(httpHeaders!, (value) => value.toMap()),
      'path': ?path,
      'port': ?port,
    };
  }
  ...
  factory ServiceTemplateSpecContainerStartupProbeHttpGet.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateSpecContainerStartupProbeHttpGet(
      httpHeaders: map['httpHeaders'] == null ? null : pulumi.Input.decodeList<ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeader>(map['httpHeaders'], (value) => ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeader.fromMap((value as Map).cast<String, dynamic>())),
