...
class ServiceTemplateSpecContainerStartupProbeGrpc {
  ...
  ServiceTemplateSpecContainerStartupProbeGrpc({this.port, this.service});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'port': ?port, 'service': ?service};
  }

  factory ServiceTemplateSpecContainerStartupProbeGrpc.fromMap(
    Map<String, dynamic> map,
  ) {
    return ServiceTemplateSpecContainerStartupProbeGrpc(
