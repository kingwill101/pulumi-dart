...
class ServiceTemplateSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': ?containers == null ? null : pulumi.Input.encodeList<ServiceTemplateSpecContainer, Map<String, dynamic>>(containers!, (value) => value.toMap()),
      'nodeSelector': ?nodeSelector,
      'serviceAccountName': ?serviceAccountName,
      'servingState': ?servingState,
      'timeoutSeconds': ?timeoutSeconds,
      'volumes': ?volumes == null ? null : pulumi.Input.encodeList<ServiceTemplateSpecVolume, Map<String, dynamic>>(volumes!, (value) => value.toMap()),
    };
  }
  ...
  factory ServiceTemplateSpec.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateSpec(
      ...
      containers: map['containers'] == null ? null : pulumi.Input.decodeList<ServiceTemplateSpecContainer>(map['containers'], (value) => ServiceTemplateSpecContainer.fromMap((value as Map).cast<String, dynamic>())),
      ...
      servingState: map['servingState'] == null ? null : map['servingState'] as String,
      timeoutSeconds: map['timeoutSeconds'] == null ? null : map['timeoutSeconds'] as int,
      volumes: map['volumes'] == null ? null : pulumi.Input.decodeList<ServiceTemplateSpecVolume>(map['volumes'], (value) => ServiceTemplateSpecVolume.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
