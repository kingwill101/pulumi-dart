...
class GetServiceTemplateSpecContainerStartupProbe {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'grpcs': pulumi.Input.encodeList<GetServiceTemplateSpecContainerStartupProbeGrpc, Map<String, dynamic>>(grpcs, (value) => value.toMap()),
      'httpGets': pulumi.Input.encodeList<GetServiceTemplateSpecContainerStartupProbeHttpGet, Map<String, dynamic>>(httpGets, (value) => value.toMap()),
      'initialDelaySeconds': initialDelaySeconds,
      'periodSeconds': periodSeconds,
      'tcpSockets': pulumi.Input.encodeList<GetServiceTemplateSpecContainerStartupProbeTcpSocket, Map<String, dynamic>>(tcpSockets, (value) => value.toMap()),
  ...
  factory GetServiceTemplateSpecContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateSpecContainerStartupProbe(
      ...
      grpcs: pulumi.Input.decodeList<GetServiceTemplateSpecContainerStartupProbeGrpc>(map['grpcs'], (value) => GetServiceTemplateSpecContainerStartupProbeGrpc.fromMap((value as Map).cast<String, dynamic>())),
      httpGets: pulumi.Input.decodeList<GetServiceTemplateSpecContainerStartupProbeHttpGet>(map['httpGets'], (value) => GetServiceTemplateSpecContainerStartupProbeHttpGet.fromMap((value as Map).cast<String, dynamic>())),
      initialDelaySeconds: map['initialDelaySeconds'] as int,
      periodSeconds: map['periodSeconds'] as int,
      tcpSockets: pulumi.Input.decodeList<GetServiceTemplateSpecContainerStartupProbeTcpSocket>(map['tcpSockets'], (value) => GetServiceTemplateSpecContainerStartupProbeTcpSocket.fromMap((value as Map).cast<String, dynamic>())),
