...
class DomainMappingArgs {
  ...
  factory DomainMappingArgs.fromMap(Map<String, dynamic> map) {
    return DomainMappingArgs(
      ...
      metadata: map['metadata'] == null ? null : DomainMappingMetadata.fromMap((map['metadata'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      spec: DomainMappingSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
