...
class UnitArgs {
  ...
  factory UnitArgs.fromMap(Map<String, dynamic> map) {
    return UnitArgs(
      ...
      maintenance: map['maintenance'] == null ? null : UnitMaintenance.fromMap((map['maintenance'] as Map).cast<String, dynamic>()),
      managementMode: map['managementMode'] == null ? null : map['managementMode'] as String,
