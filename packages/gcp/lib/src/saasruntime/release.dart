...
class Release extends pulumi.CustomResource {
  ...
  Release(
    ...
    this.inputVariableDefaults = registerOutput<List<ReleaseInputVariableDefault>?>('inputVariableDefaults');
    this.inputVariables = registerOutput<List<ReleaseInputVariable>>('inputVariables');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.outputVariables = registerOutput<List<ReleaseOutputVariable>>('outputVariables');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.releaseId = registerOutput<String>('releaseId');
    this.releaseRequirements = registerOutput<ReleaseReleaseRequirements?>('releaseRequirements');
