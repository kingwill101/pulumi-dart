...
class Unit extends pulumi.CustomResource {
  ...
  Unit(String name, {UnitArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.inputVariables = registerOutput<List<UnitInputVariable>>(
      'inputVariables',
    );
    ...
    this.outputVariables = registerOutput<List<UnitOutputVariable>>(
      'outputVariables',
    );
    ...
    this.scheduledOperations = registerOutput<List<String>>(
      'scheduledOperations',
    );
