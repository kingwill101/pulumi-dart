...
class UnitKindArgs {
  ...
  factory UnitKindArgs.fromMap(Map<String, dynamic> map) {
    return UnitKindArgs(
      ...
      defaultRelease: map['defaultRelease'] == null ? null : map['defaultRelease'] as String,
      dependencies: map['dependencies'] == null ? null : pulumi.Input.decodeList<UnitKindDependency>(map['dependencies'], (value) => UnitKindDependency.fromMap((value as Map).cast<String, dynamic>())),
      inputVariableMappings: map['inputVariableMappings'] == null ? null : pulumi.Input.decodeList<UnitKindInputVariableMapping>(map['inputVariableMappings'], (value) => UnitKindInputVariableMapping.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      outputVariableMappings: map['outputVariableMappings'] == null ? null : pulumi.Input.decodeList<UnitKindOutputVariableMapping>(map['outputVariableMappings'], (value) => UnitKindOutputVariableMapping.fromMap((value as Map).cast<String, dynamic>())),
