...
class RolloutKindArgs {
  ...
  RolloutKindArgs({
    ...
    RolloutKindErrorBudget? errorBudget,
    Map<String, String>? labels,
    required String location,
    String? project,
    required String rolloutKindId,
    ...
    String? updateUnitKindStrategy,
        ...
        errorBudget =
            pulumi.Input.asOptionalInput<RolloutKindErrorBudget>(errorBudget),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        location = pulumi.Input.asInput<String>(location),
        project = pulumi.Input.asOptionalInput<String>(project),
        rolloutKindId = pulumi.Input.asInput<String>(rolloutKindId),
        rolloutOrchestrationStrategy =
            pulumi.Input.asOptionalInput<String>(rolloutOrchestrationStrategy),
        ...
        updateUnitKindStrategy =
            pulumi.Input.asOptionalInput<String>(updateUnitKindStrategy);
  ...
  factory RolloutKindArgs.fromMap(Map<String, dynamic> map) {
    return RolloutKindArgs(
      ...
      unitFilter:
          map['unitFilter'] == null ? null : map['unitFilter'] as String,
