...
class HookArgs {
  ...
  factory HookArgs.fromMap(Map<String, dynamic> map) {
    return HookArgs(
      ...
      pushOption: map['pushOption'] == null ? null : HookPushOption.fromMap((map['pushOption'] as Map).cast<String, dynamic>()),
      repositoryId: map['repositoryId'] as String,
      sensitiveQueryString: map['sensitiveQueryString'] == null ? null : map['sensitiveQueryString'] as String,
