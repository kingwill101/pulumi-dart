...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? project,
    InstanceWorkforceIdentityFederationConfig? workforceIdentityFederationConfig,
  }) :
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      privateConfig: map['privateConfig'] == null ? null : InstancePrivateConfig.fromMap((map['privateConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      workforceIdentityFederationConfig: map['workforceIdentityFederationConfig'] == null ? null : InstanceWorkforceIdentityFederationConfig.fromMap((map['workforceIdentityFederationConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
