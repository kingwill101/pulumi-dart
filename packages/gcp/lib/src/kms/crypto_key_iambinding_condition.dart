...
class CryptoKeyIAMBindingCondition {
  ...
  /// Creates a new [CryptoKeyIAMBindingCondition].
  ...
  factory CryptoKeyIAMBindingCondition.fromMap(Map<String, dynamic> map) {
    return CryptoKeyIAMBindingCondition(
