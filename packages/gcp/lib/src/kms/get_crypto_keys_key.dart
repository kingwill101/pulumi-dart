...
class GetCryptoKeysKey {
  ...
  final List<GetCryptoKeysKeyKeyAccessJustificationsPolicy> keyAccessJustificationsPolicies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'keyAccessJustificationsPolicies': pulumi.Input.encodeList<GetCryptoKeysKeyKeyAccessJustificationsPolicy, Map<String, dynamic>>(keyAccessJustificationsPolicies, (value) => value.toMap()),
      'keyRing': ?keyRing,
      'labels': labels,
      'name': ?name,
      'primaries': pulumi.Input.encodeList<GetCryptoKeysKeyPrimary, Map<String, dynamic>>(primaries, (value) => value.toMap()),
      'pulumiLabels': pulumiLabels,
      'purpose': purpose,
      'rotationPeriod': rotationPeriod,
      'skipInitialVersionCreation': skipInitialVersionCreation,
      'versionTemplates': pulumi.Input.encodeList<GetCryptoKeysKeyVersionTemplate, Map<String, dynamic>>(versionTemplates, (value) => value.toMap()),
    };
  }
  ...
  factory GetCryptoKeysKey.fromMap(Map<String, dynamic> map) {
    return GetCryptoKeysKey(
      ...
      keyAccessJustificationsPolicies: pulumi.Input.decodeList<GetCryptoKeysKeyKeyAccessJustificationsPolicy>(map['keyAccessJustificationsPolicies'], (value) => GetCryptoKeysKeyKeyAccessJustificationsPolicy.fromMap((value as Map).cast<String, dynamic>())),
      keyRing: map['keyRing'] == null ? null : map['keyRing'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      primaries: pulumi.Input.decodeList<GetCryptoKeysKeyPrimary>(map['primaries'], (value) => GetCryptoKeysKeyPrimary.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versionTemplates: pulumi.Input.decodeList<GetCryptoKeysKeyVersionTemplate>(map['versionTemplates'], (value) => GetCryptoKeysKeyVersionTemplate.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
