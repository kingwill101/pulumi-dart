...
class EkmConnectionServiceResolverServerCertificate {
  ...
  factory EkmConnectionServiceResolverServerCertificate.fromMap(Map<String, dynamic> map) {
    return EkmConnectionServiceResolverServerCertificate(
      ...
      sha256Fingerprint: map['sha256Fingerprint'] == null ? null : map['sha256Fingerprint'] as String,
      subject: map['subject'] == null ? null : map['subject'] as String,
      subjectAlternativeDnsNames: map['subjectAlternativeDnsNames'] == null ? null : (map['subjectAlternativeDnsNames'] as List).cast<String>(),
    );
  }
}
