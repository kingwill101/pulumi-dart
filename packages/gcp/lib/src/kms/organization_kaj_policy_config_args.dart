...
class OrganizationKajPolicyConfigArgs {
  ...
  OrganizationKajPolicyConfigArgs({
    OrganizationKajPolicyConfigDefaultKeyAccessJustificationPolicy? defaultKeyAccessJustificationPolicy,
  ...
  factory OrganizationKajPolicyConfigArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationKajPolicyConfigArgs(
      defaultKeyAccessJustificationPolicy: map['defaultKeyAccessJustificationPolicy'] == null ? null : OrganizationKajPolicyConfigDefaultKeyAccessJustificationPolicy.fromMap((map['defaultKeyAccessJustificationPolicy'] as Map).cast<String, dynamic>()),
