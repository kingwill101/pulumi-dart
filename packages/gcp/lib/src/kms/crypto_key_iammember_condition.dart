...
class CryptoKeyIAMMemberCondition {
  ...
  /// Creates a new [CryptoKeyIAMMemberCondition].
  ...
  factory CryptoKeyIAMMemberCondition.fromMap(Map<String, dynamic> map) {
    return CryptoKeyIAMMemberCondition(
      description:
