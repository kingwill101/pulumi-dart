...
class CryptoKeyArgs {
  ...
  factory CryptoKeyArgs.fromMap(Map<String, dynamic> map) {
    return CryptoKeyArgs(
      ...
      keyAccessJustificationsPolicy: map['keyAccessJustificationsPolicy'] == null ? null : CryptoKeyKeyAccessJustificationsPolicy.fromMap((map['keyAccessJustificationsPolicy'] as Map).cast<String, dynamic>()),
