...
class CryptoKeyVersionArgs {
  ...
  CryptoKeyVersionArgs({
    ...
    CryptoKeyVersionExternalProtectionLevelOptions? externalProtectionLevelOptions,
    String? state,
  }) :
  ...
  factory CryptoKeyVersionArgs.fromMap(Map<String, dynamic> map) {
    return CryptoKeyVersionArgs(
      ...
      externalProtectionLevelOptions: map['externalProtectionLevelOptions'] == null ? null : CryptoKeyVersionExternalProtectionLevelOptions.fromMap((map['externalProtectionLevelOptions'] as Map).cast<String, dynamic>()),
