...
class EkmConnectionArgs {
  ...
  EkmConnectionArgs({
    ...
    String? name,
    String? project,
    required List<EkmConnectionServiceResolver> serviceResolvers,
  }) : cryptoSpacePath = pulumi.Input.asOptionalInput<String>(cryptoSpacePath),
       etag = pulumi.Input.asOptionalInput<String>(etag),
       keyManagementMode = pulumi.Input.asOptionalInput<String>(
         keyManagementMode,
       ),
       location = pulumi.Input.asInput<String>(location),
       name = pulumi.Input.asOptionalInput<String>(name),
       project = pulumi.Input.asOptionalInput<String>(project),
       serviceResolvers = pulumi
           .Input.asInput<List<EkmConnectionServiceResolver>>(serviceResolvers);
  ...
  factory EkmConnectionArgs.fromMap(Map<String, dynamic> map) {
    return EkmConnectionArgs(
      cryptoSpacePath: map['cryptoSpacePath'] == null
          ? null
          : map['cryptoSpacePath'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      keyManagementMode: map['keyManagementMode'] == null
          ? null
          : map['keyManagementMode'] as String,
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      serviceResolvers: pulumi.Input.decodeList<EkmConnectionServiceResolver>(
