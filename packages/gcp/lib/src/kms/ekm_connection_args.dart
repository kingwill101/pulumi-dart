...
class EkmConnectionArgs {
  ...
  factory EkmConnectionArgs.fromMap(Map<String, dynamic> map) {
    return EkmConnectionArgs(
      ...
      keyManagementMode: map['keyManagementMode'] == null ? null : map['keyManagementMode'] as String,
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      serviceResolvers: pulumi.Input.decodeList<EkmConnectionServiceResolver>(map['serviceResolvers'], (value) => EkmConnectionServiceResolver.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
