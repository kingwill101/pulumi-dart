...
class SQuotaPreference extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String?> ignoreSafetyChecks;
  ...
  late final pulumi.Output<SQuotaPreferenceQuotaConfig> quotaConfig;
  /// The id of the quota to which the quota preference is applied. A quota id is unique in the service.
  /// Example: `CPUS-per-project-region`.
  late final pulumi.Output<String> quotaId;
  ...
  /// Creates a new [SQuotaPreference].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SQuotaPreference]. {@macro pulumi_cloudquota_s_quota_preference_squota_preference_args_doc}
  ...
  SQuotaPreference(
    ...
    this.quotaConfig = registerOutput<SQuotaPreferenceQuotaConfig>('quotaConfig');
