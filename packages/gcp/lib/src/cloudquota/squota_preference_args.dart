...
class SQuotaPreferenceArgs {
  ...
  SQuotaPreferenceArgs({
    ...
    String? ignoreSafetyChecks,
    String? justification,
    String? name,
    String? parent,
    required SQuotaPreferenceQuotaConfig quotaConfig,
    String? quotaId,
    String? service,
        ...
        ignoreSafetyChecks =
            pulumi.Input.asOptionalInput<String>(ignoreSafetyChecks),
        justification = pulumi.Input.asOptionalInput<String>(justification),
        name = pulumi.Input.asOptionalInput<String>(name),
        parent = pulumi.Input.asOptionalInput<String>(parent),
        quotaConfig =
            pulumi.Input.asInput<SQuotaPreferenceQuotaConfig>(quotaConfig),
  ...
  factory SQuotaPreferenceArgs.fromMap(Map<String, dynamic> map) {
    return SQuotaPreferenceArgs(
      ...
      ignoreSafetyChecks: map['ignoreSafetyChecks'] == null
          ? null
          : map['ignoreSafetyChecks'] as String,
      justification:
          map['justification'] == null ? null : map['justification'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parent: map['parent'] == null ? null : map['parent'] as String,
      quotaConfig: SQuotaPreferenceQuotaConfig.fromMap(
