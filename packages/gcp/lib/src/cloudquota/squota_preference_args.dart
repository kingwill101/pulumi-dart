...
class SQuotaPreferenceArgs {
  ...
  factory SQuotaPreferenceArgs.fromMap(Map<String, dynamic> map) {
    return SQuotaPreferenceArgs(
      ...
      ignoreSafetyChecks: map['ignoreSafetyChecks'] == null ? null : map['ignoreSafetyChecks'] as String,
      ...
      quotaConfig: SQuotaPreferenceQuotaConfig.fromMap((map['quotaConfig'] as Map).cast<String, dynamic>()),
