...
class SQuotaPreferenceQuotaConfig {
  ...
  factory SQuotaPreferenceQuotaConfig.fromMap(Map<String, dynamic> map) {
    return SQuotaPreferenceQuotaConfig(
      ...
      grantedValue: map['grantedValue'] == null
          ? null
          : map['grantedValue'] as String,
      preferredValue: map['preferredValue'] as String,
      requestOrigin: map['requestOrigin'] == null
          ? null
          : map['requestOrigin'] as String,
      stateDetail: map['stateDetail'] == null
          ? null
          : map['stateDetail'] as String,
