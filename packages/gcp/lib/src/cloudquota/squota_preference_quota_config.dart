...
class SQuotaPreferenceQuotaConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final grantedValueValue = grantedValue;
    if (grantedValueValue != null) {
      map['grantedValue'] = grantedValueValue;
    }
    map['preferredValue'] = preferredValue;
    final requestOriginValue = requestOrigin;
    if (requestOriginValue != null) {
      map['requestOrigin'] = requestOriginValue;
    }
    final stateDetailValue = stateDetail;
    if (stateDetailValue != null) {
      map['stateDetail'] = stateDetailValue;
    }
    final traceIdValue = traceId;
    if (traceIdValue != null) {
      map['traceId'] = traceIdValue;
    }
    return map;
  }
  ...
  factory SQuotaPreferenceQuotaConfig.fromMap(Map<String, dynamic> map) {
    return SQuotaPreferenceQuotaConfig(
      ...
      grantedValue:
          map['grantedValue'] == null ? null : map['grantedValue'] as String,
      preferredValue: map['preferredValue'] as String,
      requestOrigin:
          map['requestOrigin'] == null ? null : map['requestOrigin'] as String,
      stateDetail:
          map['stateDetail'] == null ? null : map['stateDetail'] as String,
      traceId: map['traceId'] == null ? null : map['traceId'] as String,
    );
  }
}
