...
class GetSQuotaInfosQuotaInfoDimensionsInfo {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'details': pulumi.Input.encodeList<GetSQuotaInfosQuotaInfoDimensionsInfoDetail, Map<String, dynamic>>(details, (value) => value.toMap()),
  ...
  factory GetSQuotaInfosQuotaInfoDimensionsInfo.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfosQuotaInfoDimensionsInfo(
      ...
      details: pulumi.Input.decodeList<GetSQuotaInfosQuotaInfoDimensionsInfoDetail>(map['details'], (value) => GetSQuotaInfosQuotaInfoDimensionsInfoDetail.fromMap((value as Map).cast<String, dynamic>())),
