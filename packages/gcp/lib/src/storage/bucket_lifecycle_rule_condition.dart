...
class BucketLifecycleRuleCondition {
  ...
  factory BucketLifecycleRuleCondition.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleRuleCondition(
      ...
      matchesPrefixes: map['matchesPrefixes'] == null ? null : (map['matchesPrefixes'] as List).cast<String>(),
      matchesStorageClasses: map['matchesStorageClasses'] == null ? null : (map['matchesStorageClasses'] as List).cast<String>(),
      matchesSuffixes: map['matchesSuffixes'] == null ? null : (map['matchesSuffixes'] as List).cast<String>(),
      ...
      sendAgeIfZero: map['sendAgeIfZero'] == null ? null : map['sendAgeIfZero'] as bool,
      sendDaysSinceCustomTimeIfZero: map['sendDaysSinceCustomTimeIfZero'] == null ? null : map['sendDaysSinceCustomTimeIfZero'] as bool,
      sendDaysSinceNoncurrentTimeIfZero: map['sendDaysSinceNoncurrentTimeIfZero'] == null ? null : map['sendDaysSinceNoncurrentTimeIfZero'] as bool,
      sendNumNewerVersionsIfZero: map['sendNumNewerVersionsIfZero'] == null ? null : map['sendNumNewerVersionsIfZero'] as bool,
