...
class TransferJobArgs {
  ...
  factory TransferJobArgs.fromMap(Map<String, dynamic> map) {
    return TransferJobArgs(
      ...
      eventStream: map['eventStream'] == null ? null : TransferJobEventStream.fromMap((map['eventStream'] as Map).cast<String, dynamic>()),
      loggingConfig: map['loggingConfig'] == null ? null : TransferJobLoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      notificationConfig: map['notificationConfig'] == null ? null : TransferJobNotificationConfig.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      replicationSpec: map['replicationSpec'] == null ? null : TransferJobReplicationSpec.fromMap((map['replicationSpec'] as Map).cast<String, dynamic>()),
      schedule: map['schedule'] == null ? null : TransferJobSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      transferSpec: map['transferSpec'] == null ? null : TransferJobTransferSpec.fromMap((map['transferSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
