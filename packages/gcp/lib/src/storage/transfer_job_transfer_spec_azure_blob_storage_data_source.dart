...
class TransferJobTransferSpecAzureBlobStorageDataSource {
  ...
  Map<String, dynamic> toMap() {
    ...
    final azureCredentialsValue = azureCredentials;
    if (azureCredentialsValue != null) {
      map['azureCredentials'] = azureCredentialsValue.toMap();
    }
    ...
    final federatedIdentityConfigValue = federatedIdentityConfig;
    if (federatedIdentityConfigValue != null) {
      map['federatedIdentityConfig'] = federatedIdentityConfigValue.toMap();
    }
    ...
    return TransferJobTransferSpecAzureBlobStorageDataSource(
      ...
      federatedIdentityConfig: map['federatedIdentityConfig'] == null
          ...
          : TransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig
              .fromMap((map['federatedIdentityConfig'] as Map)
                  .cast<String, dynamic>()),
