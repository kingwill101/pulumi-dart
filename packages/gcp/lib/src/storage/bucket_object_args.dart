...
class BucketObjectArgs {
  ...
  factory BucketObjectArgs.fromMap(Map<String, dynamic> map) {
    return BucketObjectArgs(
      ...
      contexts: map['contexts'] == null ? null : BucketObjectContexts.fromMap((map['contexts'] as Map).cast<String, dynamic>()),
      ...
      forceEmptyContentType: map['forceEmptyContentType'] == null ? null : map['forceEmptyContentType'] as bool,
      ...
      sourceMd5hash: map['sourceMd5hash'] == null ? null : map['sourceMd5hash'] as String,
