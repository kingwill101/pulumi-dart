...
class BucketArgs {
  ...
  BucketArgs({
    ...
    BucketWebsite? website,
        ...
        defaultEventBasedHold =
            pulumi.Input.asOptionalInput<bool>(defaultEventBasedHold),
        enableObjectRetention =
            pulumi.Input.asOptionalInput<bool>(enableObjectRetention),
        ...
        lifecycleRules =
            pulumi.Input.asOptionalInput<List<BucketLifecycleRule>>(
                lifecycleRules),
        ...
        publicAccessPrevention =
            pulumi.Input.asOptionalInput<String>(publicAccessPrevention),
        ...
        uniformBucketLevelAccess =
            pulumi.Input.asOptionalInput<bool>(uniformBucketLevelAccess),
  ...
  factory BucketArgs.fromMap(Map<String, dynamic> map) {
    return BucketArgs(
      ...
      cors: map['cors'] == null
          ? null
          : pulumi.Input.decodeList<BucketCor>(
              map['cors'],
              (value) =>
                  BucketCor.fromMap((value as Map).cast<String, dynamic>())),
      ...
      hierarchicalNamespace: map['hierarchicalNamespace'] == null
          ? null
          : BucketHierarchicalNamespace.fromMap(
              (map['hierarchicalNamespace'] as Map).cast<String, dynamic>()),
      ipFilter: map['ipFilter'] == null
          ? null
          : BucketIpFilter.fromMap(
              (map['ipFilter'] as Map).cast<String, dynamic>()),
      ...
      uniformBucketLevelAccess: map['uniformBucketLevelAccess'] == null
          ? null
          : map['uniformBucketLevelAccess'] as bool,
