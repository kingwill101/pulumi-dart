...
class InsightsDatasetConfig extends pulumi.CustomResource {
  ...
  InsightsDatasetConfig(
    ...
    this.activityDataRetentionPeriodDays = registerOutput<int>(
    ...
    this.includeNewlyCreatedBuckets = registerOutput<bool?>(
    ...
    this.sourceFolders = registerOutput<InsightsDatasetConfigSourceFolders?>(
      'sourceFolders',
    );
    this.sourceProjects = registerOutput<InsightsDatasetConfigSourceProjects?>(
      'sourceProjects',
    );
