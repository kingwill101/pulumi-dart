...
class TransferJobSchedule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scheduleEndDate': ?scheduleEndDate == null ? null : scheduleEndDate!.toMap(),
      'scheduleStartDate': scheduleStartDate.toMap(),
      'startTimeOfDay': ?startTimeOfDay == null ? null : startTimeOfDay!.toMap(),
    };
  }
  ...
  factory TransferJobSchedule.fromMap(Map<String, dynamic> map) {
    return TransferJobSchedule(
      ...
      scheduleEndDate: map['scheduleEndDate'] == null ? null : TransferJobScheduleScheduleEndDate.fromMap((map['scheduleEndDate'] as Map).cast<String, dynamic>()),
      scheduleStartDate: TransferJobScheduleScheduleStartDate.fromMap((map['scheduleStartDate'] as Map).cast<String, dynamic>()),
      startTimeOfDay: map['startTimeOfDay'] == null ? null : TransferJobScheduleStartTimeOfDay.fromMap((map['startTimeOfDay'] as Map).cast<String, dynamic>()),
    );
  }
}
