...
class BucketObject extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [BucketObject]. {@macro pulumi_storage_bucket_object_bucket_object_args_doc}
  ...
  BucketObject(
    ...
    this.customerEncryption = registerOutput<BucketObjectCustomerEncryption?>(
      'customerEncryption',
    );
