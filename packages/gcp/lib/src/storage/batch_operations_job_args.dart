...
class BatchOperationsJobArgs {
  ...
  factory BatchOperationsJobArgs.fromMap(Map<String, dynamic> map) {
    return BatchOperationsJobArgs(
      bucketList: map['bucketList'] == null ? null : BatchOperationsJobBucketList.fromMap((map['bucketList'] as Map).cast<String, dynamic>()),
      deleteObject: map['deleteObject'] == null ? null : BatchOperationsJobDeleteObject.fromMap((map['deleteObject'] as Map).cast<String, dynamic>()),
      ...
      putMetadata: map['putMetadata'] == null ? null : BatchOperationsJobPutMetadata.fromMap((map['putMetadata'] as Map).cast<String, dynamic>()),
      putObjectHold: map['putObjectHold'] == null ? null : BatchOperationsJobPutObjectHold.fromMap((map['putObjectHold'] as Map).cast<String, dynamic>()),
      rewriteObject: map['rewriteObject'] == null ? null : BatchOperationsJobRewriteObject.fromMap((map['rewriteObject'] as Map).cast<String, dynamic>()),
    );
  }
}
