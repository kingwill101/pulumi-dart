...
class TransferJobTransferSpecAwsS3DataSource {
  ...
  factory TransferJobTransferSpecAwsS3DataSource.fromMap(Map<String, dynamic> map) {
    return TransferJobTransferSpecAwsS3DataSource(
      awsAccessKey: map['awsAccessKey'] == null ? null : TransferJobTransferSpecAwsS3DataSourceAwsAccessKey.fromMap((map['awsAccessKey'] as Map).cast<String, dynamic>()),
      ...
      managedPrivateNetwork: map['managedPrivateNetwork'] == null ? null : map['managedPrivateNetwork'] as bool,
