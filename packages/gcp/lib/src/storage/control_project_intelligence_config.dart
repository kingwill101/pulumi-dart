...
class ControlProjectIntelligenceConfig extends pulumi.CustomResource {
  ...
  ControlProjectIntelligenceConfig(
    ...
    this.effectiveIntelligenceConfigs = registerOutput<List<ControlProjectIntelligenceConfigEffectiveIntelligenceConfig>>('effectiveIntelligenceConfigs');
    this.filter = registerOutput<ControlProjectIntelligenceConfigFilter?>('filter');
    this.name = registerOutput<String>('name');
    this.trialConfigs = registerOutput<List<ControlProjectIntelligenceConfigTrialConfig>>('trialConfigs');
