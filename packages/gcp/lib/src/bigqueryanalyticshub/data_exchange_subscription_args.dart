...
class DataExchangeSubscriptionArgs {
  ...
  DataExchangeSubscriptionArgs({
    ...
    required String subscriptionId,
       ...
       dataExchangeLocation = pulumi.Input.asInput<String>(
       ...
       subscriberContact = pulumi.Input.asOptionalInput<String>(
         subscriberContact,
       ),
  ...
  factory DataExchangeSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeSubscriptionArgs(
      ...
      destinationDataset: map['destinationDataset'] == null
          ? null
      ...
      refreshPolicy: map['refreshPolicy'] == null
          ? null
          : map['refreshPolicy'] as String,
      subscriberContact: map['subscriberContact'] == null
          ? null
          : map['subscriberContact'] as String,
