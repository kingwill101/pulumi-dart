...
class DataExchangeSubscriptionArgs {
  ...
  DataExchangeSubscriptionArgs({
    ...
    required String subscriptionId,
        ...
        dataExchangeLocation =
            pulumi.Input.asInput<String>(dataExchangeLocation),
        ...
        subscriberContact =
            pulumi.Input.asOptionalInput<String>(subscriberContact),
  ...
  factory DataExchangeSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeSubscriptionArgs(
      ...
      refreshPolicy:
          map['refreshPolicy'] == null ? null : map['refreshPolicy'] as String,
