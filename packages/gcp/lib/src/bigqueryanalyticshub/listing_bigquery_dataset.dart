...
class ListingBigqueryDataset {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataset': dataset,
      'effectiveReplicas': ?effectiveReplicas == null
          ? null
          : pulumi.Input.encodeList<
              ListingBigqueryDatasetEffectiveReplica,
              Map<String, dynamic>
            >(effectiveReplicas!, (value) => value.toMap()),
      'replicaLocations': ?replicaLocations,
      'selectedResources': ?selectedResources == null
          ? null
          : pulumi.Input.encodeList<
              ListingBigqueryDatasetSelectedResource,
              Map<String, dynamic>
            >(selectedResources!, (value) => value.toMap()),
    };
  }
