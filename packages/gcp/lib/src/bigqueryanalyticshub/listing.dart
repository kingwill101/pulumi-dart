...
class Listing extends pulumi.CustomResource {
  ...
  Listing(
    ...
    this.allowOnlyMetadataSharing = registerOutput<bool?>('allowOnlyMetadataSharing');
    this.bigqueryDataset = registerOutput<ListingBigqueryDataset?>('bigqueryDataset');
    this.categories = registerOutput<List<String>?>('categories');
    this.commercialInfos = registerOutput<List<ListingCommercialInfo>>('commercialInfos');
    ...
    this.restrictedExportConfig = registerOutput<ListingRestrictedExportConfig?>('restrictedExportConfig');
