...
class ListingArgs {
  ...
  factory ListingArgs.fromMap(Map<String, dynamic> map) {
    return ListingArgs(
      allowOnlyMetadataSharing: map['allowOnlyMetadataSharing'] == null ? null : map['allowOnlyMetadataSharing'] as bool,
      bigqueryDataset: map['bigqueryDataset'] == null ? null : ListingBigqueryDataset.fromMap((map['bigqueryDataset'] as Map).cast<String, dynamic>()),
      categories: map['categories'] == null ? null : (map['categories'] as List).cast<String>(),
      dataExchangeId: map['dataExchangeId'] as String,
      dataProvider: map['dataProvider'] == null ? null : ListingDataProvider.fromMap((map['dataProvider'] as Map).cast<String, dynamic>()),
      deleteCommercial: map['deleteCommercial'] == null ? null : map['deleteCommercial'] as bool,
      ...
      logLinkedDatasetQueryUserEmail: map['logLinkedDatasetQueryUserEmail'] == null ? null : map['logLinkedDatasetQueryUserEmail'] as bool,
      primaryContact: map['primaryContact'] == null ? null : map['primaryContact'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      publisher: map['publisher'] == null ? null : ListingPublisher.fromMap((map['publisher'] as Map).cast<String, dynamic>()),
      pubsubTopic: map['pubsubTopic'] == null ? null : ListingPubsubTopic.fromMap((map['pubsubTopic'] as Map).cast<String, dynamic>()),
      requestAccess: map['requestAccess'] == null ? null : map['requestAccess'] as String,
      restrictedExportConfig: map['restrictedExportConfig'] == null ? null : ListingRestrictedExportConfig.fromMap((map['restrictedExportConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
