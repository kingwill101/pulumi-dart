...
class PreventionJobTriggerInspectJobInspectConfig {
  ...
  final List<PreventionJobTriggerInspectJobInspectConfigCustomInfoType>? customInfoTypes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customInfoTypes': ?customInfoTypes == null ? null : pulumi.Input.encodeList<PreventionJobTriggerInspectJobInspectConfigCustomInfoType, Map<String, dynamic>>(customInfoTypes!, (value) => value.toMap()),
      'excludeInfoTypes': ?excludeInfoTypes,
      'includeQuote': ?includeQuote,
      'infoTypes': ?infoTypes == null ? null : pulumi.Input.encodeList<PreventionJobTriggerInspectJobInspectConfigInfoType, Map<String, dynamic>>(infoTypes!, (value) => value.toMap()),
      'limits': ?limits == null ? null : limits!.toMap(),
      'minLikelihood': ?minLikelihood,
      'ruleSets': ?ruleSets == null ? null : pulumi.Input.encodeList<PreventionJobTriggerInspectJobInspectConfigRuleSet, Map<String, dynamic>>(ruleSets!, (value) => value.toMap()),
    };
  }
  ...
  factory PreventionJobTriggerInspectJobInspectConfig.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobInspectConfig(
      customInfoTypes: map['customInfoTypes'] == null ? null : pulumi.Input.decodeList<PreventionJobTriggerInspectJobInspectConfigCustomInfoType>(map['customInfoTypes'], (value) => PreventionJobTriggerInspectJobInspectConfigCustomInfoType.fromMap((value as Map).cast<String, dynamic>())),
      ...
      infoTypes: map['infoTypes'] == null ? null : pulumi.Input.decodeList<PreventionJobTriggerInspectJobInspectConfigInfoType>(map['infoTypes'], (value) => PreventionJobTriggerInspectJobInspectConfigInfoType.fromMap((value as Map).cast<String, dynamic>())),
      limits: map['limits'] == null ? null : PreventionJobTriggerInspectJobInspectConfigLimits.fromMap((map['limits'] as Map).cast<String, dynamic>()),
      minLikelihood: map['minLikelihood'] == null ? null : map['minLikelihood'] as String,
      ruleSets: map['ruleSets'] == null ? null : pulumi.Input.decodeList<PreventionJobTriggerInspectJobInspectConfigRuleSet>(map['ruleSets'], (value) => PreventionJobTriggerInspectJobInspectConfigRuleSet.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
