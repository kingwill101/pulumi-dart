...
class PreventionDiscoveryConfigArgs {
  ...
  PreventionDiscoveryConfigArgs({
    ...
    PreventionDiscoveryConfigOtherCloudStartingLocation? otherCloudStartingLocation,
  ...
  factory PreventionDiscoveryConfigArgs.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigArgs(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<PreventionDiscoveryConfigAction>(map['actions'], (value) => PreventionDiscoveryConfigAction.fromMap((value as Map).cast<String, dynamic>())),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      inspectTemplates: map['inspectTemplates'] == null ? null : (map['inspectTemplates'] as List).cast<String>(),
      location: map['location'] as String,
      orgConfig: map['orgConfig'] == null ? null : PreventionDiscoveryConfigOrgConfig.fromMap((map['orgConfig'] as Map).cast<String, dynamic>()),
      otherCloudStartingLocation: map['otherCloudStartingLocation'] == null ? null : PreventionDiscoveryConfigOtherCloudStartingLocation.fromMap((map['otherCloudStartingLocation'] as Map).cast<String, dynamic>()),
      parent: map['parent'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<PreventionDiscoveryConfigTarget>(map['targets'], (value) => PreventionDiscoveryConfigTarget.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
