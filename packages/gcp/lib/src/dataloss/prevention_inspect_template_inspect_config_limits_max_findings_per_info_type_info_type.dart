...
class PreventionInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoType {
  ...
  final PreventionInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScore? sensitivityScore;
  ...
  factory PreventionInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoType.fromMap(Map<String, dynamic> map) {
    return PreventionInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoType(
      ...
      sensitivityScore: map['sensitivityScore'] == null ? null : PreventionInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScore.fromMap((map['sensitivityScore'] as Map).cast<String, dynamic>()),
