...
class PreventionDiscoveryConfigTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudSqlTarget': ?cloudSqlTarget == null
          ? null
          : cloudSqlTarget!.toMap(),
      'cloudStorageTarget': ?cloudStorageTarget == null
          ? null
          : cloudStorageTarget!.toMap(),
      'otherCloudTarget': ?otherCloudTarget == null
          ? null
          : otherCloudTarget!.toMap(),
