...
class PreventionDiscoveryConfigTargetCloudStorageTargetFilter {
  ...
  final PreventionDiscoveryConfigTargetCloudStorageTargetFilterCloudStorageResourceReference? cloudStorageResourceReference;
  /// A collection of resources for this filter to apply to.
  /// Structure is documented below.
  final PreventionDiscoveryConfigTargetCloudStorageTargetFilterCollection? collection;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudStorageResourceReference': ?cloudStorageResourceReference == null ? null : cloudStorageResourceReference!.toMap(),
  ...
  factory PreventionDiscoveryConfigTargetCloudStorageTargetFilter.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTargetCloudStorageTargetFilter(
      cloudStorageResourceReference: map['cloudStorageResourceReference'] == null ? null : PreventionDiscoveryConfigTargetCloudStorageTargetFilterCloudStorageResourceReference.fromMap((map['cloudStorageResourceReference'] as Map).cast<String, dynamic>()),
      collection: map['collection'] == null ? null : PreventionDiscoveryConfigTargetCloudStorageTargetFilterCollection.fromMap((map['collection'] as Map).cast<String, dynamic>()),
