...
class PreventionJobTriggerInspectJobInspectConfigRuleSetInfoType {
  ...
  final PreventionJobTriggerInspectJobInspectConfigRuleSetInfoTypeSensitivityScore? sensitivityScore;
  ...
  factory PreventionJobTriggerInspectJobInspectConfigRuleSetInfoType.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobInspectConfigRuleSetInfoType(
      ...
      sensitivityScore: map['sensitivityScore'] == null ? null : PreventionJobTriggerInspectJobInspectConfigRuleSetInfoTypeSensitivityScore.fromMap((map['sensitivityScore'] as Map).cast<String, dynamic>()),
