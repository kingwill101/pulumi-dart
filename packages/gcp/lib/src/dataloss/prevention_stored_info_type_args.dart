...
class PreventionStoredInfoTypeArgs {
  ...
  factory PreventionStoredInfoTypeArgs.fromMap(Map<String, dynamic> map) {
    return PreventionStoredInfoTypeArgs(
      ...
      dictionary: map['dictionary'] == null ? null : PreventionStoredInfoTypeDictionary.fromMap((map['dictionary'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      largeCustomDictionary: map['largeCustomDictionary'] == null ? null : PreventionStoredInfoTypeLargeCustomDictionary.fromMap((map['largeCustomDictionary'] as Map).cast<String, dynamic>()),
      parent: map['parent'] as String,
      regex: map['regex'] == null ? null : PreventionStoredInfoTypeRegex.fromMap((map['regex'] as Map).cast<String, dynamic>()),
