...
class PreventionJobTriggerInspectJobStorageConfigBigQueryOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludedFields': ?excludedFields == null
          ? null
          : pulumi.Input.encodeList<
              PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsExcludedField,
              Map<String, dynamic>
            >(excludedFields!, (value) => value.toMap()),
      ...
      'includedFields': ?includedFields == null
          ? null
          : pulumi.Input.encodeList<
              PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsIncludedField,
              Map<String, dynamic>
            >(includedFields!, (value) => value.toMap()),
      'rowsLimit': ?rowsLimit,
  ...
  factory PreventionJobTriggerInspectJobStorageConfigBigQueryOptions.fromMap(
    ...
    return PreventionJobTriggerInspectJobStorageConfigBigQueryOptions(
      excludedFields: map['excludedFields'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['excludedFields'],
              (value) =>
                  PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsExcludedField.fromMap(
      ...
      identifyingFields: map['identifyingFields'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsIdentifyingField.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      includedFields: map['includedFields'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['includedFields'],
              (value) =>
                  PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsIncludedField.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      ...
      tableReference:
          PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsTableReference.fromMap(
