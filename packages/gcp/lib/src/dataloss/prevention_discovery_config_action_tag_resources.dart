...
class PreventionDiscoveryConfigActionTagResources {
  ...
  final List<PreventionDiscoveryConfigActionTagResourcesTagCondition>? tagConditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tagConditions': ?tagConditions == null ? null : pulumi.Input.encodeList<PreventionDiscoveryConfigActionTagResourcesTagCondition, Map<String, dynamic>>(tagConditions!, (value) => value.toMap()),
    };
  }
  ...
  factory PreventionDiscoveryConfigActionTagResources.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigActionTagResources(
      lowerDataRiskToLow: map['lowerDataRiskToLow'] == null ? null : map['lowerDataRiskToLow'] as bool,
      profileGenerationsToTags: map['profileGenerationsToTags'] == null ? null : (map['profileGenerationsToTags'] as List).cast<String>(),
      tagConditions: map['tagConditions'] == null ? null : pulumi.Input.decodeList<PreventionDiscoveryConfigActionTagResourcesTagCondition>(map['tagConditions'], (value) => PreventionDiscoveryConfigActionTagResourcesTagCondition.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
