...
class PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotword {
  ...
  final PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotwordHotwordRegex hotwordRegex;
  ...
  /// Structure is documented below.
  final PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotwordProximity proximity;
  ...
  factory PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotword.fromMap(Map<String, dynamic> map) {
    return PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotword(
      hotwordRegex: PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotwordHotwordRegex.fromMap((map['hotwordRegex'] as Map).cast<String, dynamic>()),
      proximity: PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotwordProximity.fromMap((map['proximity'] as Map).cast<String, dynamic>()),
    );
  }
}
