  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bucketingConfig': ?bucketingConfig == null
          ? null
          : bucketingConfig!.toMap(),
      'characterMaskConfig': ?characterMaskConfig == null
          ? null
          : characterMaskConfig!.toMap(),
      'cryptoDeterministicConfig': ?cryptoDeterministicConfig == null
          ? null
          : cryptoDeterministicConfig!.toMap(),
      'cryptoHashConfig': ?cryptoHashConfig == null
          ? null
          : cryptoHashConfig!.toMap(),
      'cryptoReplaceFfxFpeConfig': ?cryptoReplaceFfxFpeConfig == null
          ? null
          : cryptoReplaceFfxFpeConfig!.toMap(),
      'dateShiftConfig': ?dateShiftConfig == null
          ? null
          : dateShiftConfig!.toMap(),
      'fixedSizeBucketingConfig': ?fixedSizeBucketingConfig == null
          ? null
          : fixedSizeBucketingConfig!.toMap(),
      'redactConfig': ?redactConfig,
      'replaceConfig': ?replaceConfig == null ? null : replaceConfig!.toMap(),
      'replaceDictionaryConfig': ?replaceDictionaryConfig == null
          ? null
          : replaceDictionaryConfig!.toMap(),
      'replaceWithInfoTypeConfig': ?replaceWithInfoTypeConfig,
      'timePartConfig': ?timePartConfig == null
          ? null
          : timePartConfig!.toMap(),
    };
  }
