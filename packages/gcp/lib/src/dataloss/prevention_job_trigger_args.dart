...
class PreventionJobTriggerArgs {
  ...
  PreventionJobTriggerArgs({
    String? description,
    String? displayName,
    PreventionJobTriggerInspectJob? inspectJob,
    required String parent,
    String? status,
    String? triggerId,
    required List<PreventionJobTriggerTrigger> triggers,
  }) :
  ...
  factory PreventionJobTriggerArgs.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerArgs(
      ...
      inspectJob: map['inspectJob'] == null ? null : PreventionJobTriggerInspectJob.fromMap((map['inspectJob'] as Map).cast<String, dynamic>()),
      parent: map['parent'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      triggerId: map['triggerId'] == null ? null : map['triggerId'] as String,
      triggers: pulumi.Input.decodeList<PreventionJobTriggerTrigger>(map['triggers'], (value) => PreventionJobTriggerTrigger.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
