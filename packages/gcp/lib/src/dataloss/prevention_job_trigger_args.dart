...
class PreventionJobTriggerArgs {
  ...
  PreventionJobTriggerArgs({
    ...
    required List<PreventionJobTriggerTrigger> triggers,
        ...
        inspectJob =
            pulumi.Input.asOptionalInput<PreventionJobTriggerInspectJob>(
                inspectJob),
        parent = pulumi.Input.asInput<String>(parent),
        status = pulumi.Input.asOptionalInput<String>(status),
        triggerId = pulumi.Input.asOptionalInput<String>(triggerId),
        triggers =
            pulumi.Input.asInput<List<PreventionJobTriggerTrigger>>(triggers);
  ...
  factory PreventionJobTriggerArgs.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerArgs(
      ...
      triggers: pulumi.Input.decodeList<PreventionJobTriggerTrigger>(
          map['triggers'],
