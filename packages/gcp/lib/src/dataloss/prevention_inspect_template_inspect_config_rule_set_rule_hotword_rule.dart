...
class PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRule {
  ...
  final PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegex hotwordRegex;
  /// Likelihood adjustment to apply to all matching findings.
  /// Structure is documented below.
  final PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleLikelihoodAdjustment likelihoodAdjustment;
  ...
  /// Structure is documented below.
  final PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleProximity proximity;
  ...
  factory PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRule.fromMap(Map<String, dynamic> map) {
    return PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRule(
      hotwordRegex: PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegex.fromMap((map['hotwordRegex'] as Map).cast<String, dynamic>()),
      likelihoodAdjustment: PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleLikelihoodAdjustment.fromMap((map['likelihoodAdjustment'] as Map).cast<String, dynamic>()),
      proximity: PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleProximity.fromMap((map['proximity'] as Map).cast<String, dynamic>()),
    );
  }
}
