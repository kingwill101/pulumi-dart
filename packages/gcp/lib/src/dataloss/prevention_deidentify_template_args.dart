...
class PreventionDeidentifyTemplateArgs {
  ...
  PreventionDeidentifyTemplateArgs({
    required PreventionDeidentifyTemplateDeidentifyConfig deidentifyConfig,
    String? description,
    String? displayName,
  ...
  factory PreventionDeidentifyTemplateArgs.fromMap(Map<String, dynamic> map) {
    return PreventionDeidentifyTemplateArgs(
      deidentifyConfig: PreventionDeidentifyTemplateDeidentifyConfig.fromMap((map['deidentifyConfig'] as Map).cast<String, dynamic>()),
