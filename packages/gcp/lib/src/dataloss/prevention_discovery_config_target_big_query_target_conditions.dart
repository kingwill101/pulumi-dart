...
class PreventionDiscoveryConfigTargetBigQueryTargetConditions {
  ...
  final PreventionDiscoveryConfigTargetBigQueryTargetConditionsOrConditions? orConditions;
  ...
  factory PreventionDiscoveryConfigTargetBigQueryTargetConditions.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTargetBigQueryTargetConditions(
      ...
      orConditions: map['orConditions'] == null ? null : PreventionDiscoveryConfigTargetBigQueryTargetConditionsOrConditions.fromMap((map['orConditions'] as Map).cast<String, dynamic>()),
      typeCollection: map['typeCollection'] == null ? null : map['typeCollection'] as String,
      types: map['types'] == null ? null : PreventionDiscoveryConfigTargetBigQueryTargetConditionsTypes.fromMap((map['types'] as Map).cast<String, dynamic>()),
    );
  }
}
