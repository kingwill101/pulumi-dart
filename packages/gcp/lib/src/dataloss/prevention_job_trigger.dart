...
class PreventionJobTrigger extends pulumi.CustomResource {
  ...
  /// Creates a new [PreventionJobTrigger].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PreventionJobTrigger]. {@macro pulumi_dataloss_prevention_job_trigger_prevention_job_trigger_args_doc}
  ...
  PreventionJobTrigger(
    ...
    this.inspectJob = registerOutput<PreventionJobTriggerInspectJob?>(
      'inspectJob',
    );
    ...
    this.triggers = registerOutput<List<PreventionJobTriggerTrigger>>(
      'triggers',
    );
