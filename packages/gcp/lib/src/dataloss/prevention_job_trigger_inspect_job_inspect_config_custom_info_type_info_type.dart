...
class PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType {
  ...
  final PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoTypeSensitivityScore?
  sensitivityScore;
  ...
  factory PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType.fromMap(
    ...
    return PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType(
      ...
      sensitivityScore: map['sensitivityScore'] == null
          ? null
          : PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoTypeSensitivityScore.fromMap(
