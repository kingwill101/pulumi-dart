...
class PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType {
  ...
  final PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoTypeSensitivityScore? sensitivityScore;
  ...
  factory PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType(
      ...
      sensitivityScore: map['sensitivityScore'] == null ? null : PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoTypeSensitivityScore.fromMap((map['sensitivityScore'] as Map).cast<String, dynamic>()),
