...
class PreventionInspectTemplateInspectConfigCustomInfoType {
  ...
  final PreventionInspectTemplateInspectConfigCustomInfoTypeDictionary? dictionary;
  ...
  /// Structure is documented below.
  final PreventionInspectTemplateInspectConfigCustomInfoTypeSensitivityScore? sensitivityScore;
  /// A reference to a StoredInfoType to use with scanning.
  /// Structure is documented below.
  final PreventionInspectTemplateInspectConfigCustomInfoTypeStoredType? storedType;
  ...
  factory PreventionInspectTemplateInspectConfigCustomInfoType.fromMap(Map<String, dynamic> map) {
    return PreventionInspectTemplateInspectConfigCustomInfoType(
      dictionary: map['dictionary'] == null ? null : PreventionInspectTemplateInspectConfigCustomInfoTypeDictionary.fromMap((map['dictionary'] as Map).cast<String, dynamic>()),
      exclusionType: map['exclusionType'] == null ? null : map['exclusionType'] as String,
      infoType: PreventionInspectTemplateInspectConfigCustomInfoTypeInfoType.fromMap((map['infoType'] as Map).cast<String, dynamic>()),
      likelihood: map['likelihood'] == null ? null : map['likelihood'] as String,
      regex: map['regex'] == null ? null : PreventionInspectTemplateInspectConfigCustomInfoTypeRegex.fromMap((map['regex'] as Map).cast<String, dynamic>()),
      sensitivityScore: map['sensitivityScore'] == null ? null : PreventionInspectTemplateInspectConfigCustomInfoTypeSensitivityScore.fromMap((map['sensitivityScore'] as Map).cast<String, dynamic>()),
      storedType: map['storedType'] == null ? null : PreventionInspectTemplateInspectConfigCustomInfoTypeStoredType.fromMap((map['storedType'] as Map).cast<String, dynamic>()),
