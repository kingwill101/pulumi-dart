...
class PreventionInspectTemplateInspectConfig {
  ...
  final List<PreventionInspectTemplateInspectConfigCustomInfoType>? customInfoTypes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customInfoTypes': ?customInfoTypes == null ? null : pulumi.Input.encodeList<PreventionInspectTemplateInspectConfigCustomInfoType, Map<String, dynamic>>(customInfoTypes!, (value) => value.toMap()),
      'excludeInfoTypes': ?excludeInfoTypes,
      'includeQuote': ?includeQuote,
      'infoTypes': ?infoTypes == null ? null : pulumi.Input.encodeList<PreventionInspectTemplateInspectConfigInfoType, Map<String, dynamic>>(infoTypes!, (value) => value.toMap()),
      'limits': ?limits == null ? null : limits!.toMap(),
      'minLikelihood': ?minLikelihood,
      'ruleSets': ?ruleSets == null ? null : pulumi.Input.encodeList<PreventionInspectTemplateInspectConfigRuleSet, Map<String, dynamic>>(ruleSets!, (value) => value.toMap()),
    };
  }
  ...
  factory PreventionInspectTemplateInspectConfig.fromMap(Map<String, dynamic> map) {
    return PreventionInspectTemplateInspectConfig(
      contentOptions: map['contentOptions'] == null ? null : (map['contentOptions'] as List).cast<String>(),
      customInfoTypes: map['customInfoTypes'] == null ? null : pulumi.Input.decodeList<PreventionInspectTemplateInspectConfigCustomInfoType>(map['customInfoTypes'], (value) => PreventionInspectTemplateInspectConfigCustomInfoType.fromMap((value as Map).cast<String, dynamic>())),
      ...
      infoTypes: map['infoTypes'] == null ? null : pulumi.Input.decodeList<PreventionInspectTemplateInspectConfigInfoType>(map['infoTypes'], (value) => PreventionInspectTemplateInspectConfigInfoType.fromMap((value as Map).cast<String, dynamic>())),
      limits: map['limits'] == null ? null : PreventionInspectTemplateInspectConfigLimits.fromMap((map['limits'] as Map).cast<String, dynamic>()),
      minLikelihood: map['minLikelihood'] == null ? null : map['minLikelihood'] as String,
      ruleSets: map['ruleSets'] == null ? null : pulumi.Input.decodeList<PreventionInspectTemplateInspectConfigRuleSet>(map['ruleSets'], (value) => PreventionInspectTemplateInspectConfigRuleSet.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
