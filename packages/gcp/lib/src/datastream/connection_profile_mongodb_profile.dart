...
class ConnectionProfileMongodbProfile {
  ...
  /// Structure is documented below.
  final ConnectionProfileMongodbProfileStandardConnectionFormat? standardConnectionFormat;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hostAddresses': pulumi.Input.encodeList<ConnectionProfileMongodbProfileHostAddress, Map<String, dynamic>>(hostAddresses, (value) => value.toMap()),
      'password': ?password,
      ...
      'standardConnectionFormat': ?standardConnectionFormat == null ? null : standardConnectionFormat!.toMap(),
      'username': username,
    };
  }
  ...
  factory ConnectionProfileMongodbProfile.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileMongodbProfile(
      hostAddresses: pulumi.Input.decodeList<ConnectionProfileMongodbProfileHostAddress>(map['hostAddresses'], (value) => ConnectionProfileMongodbProfileHostAddress.fromMap((value as Map).cast<String, dynamic>())),
      password: map['password'] == null ? null : map['password'] as String,
      replicaSet: map['replicaSet'] == null ? null : map['replicaSet'] as String,
      secretManagerStoredPassword: map['secretManagerStoredPassword'] == null ? null : map['secretManagerStoredPassword'] as String,
      srvConnectionFormat: map['srvConnectionFormat'] == null ? null : (map['srvConnectionFormat'] as Map).cast<String, dynamic>(),
      sslConfig: map['sslConfig'] == null ? null : ConnectionProfileMongodbProfileSslConfig.fromMap((map['sslConfig'] as Map).cast<String, dynamic>()),
      standardConnectionFormat: map['standardConnectionFormat'] == null ? null : ConnectionProfileMongodbProfileStandardConnectionFormat.fromMap((map['standardConnectionFormat'] as Map).cast<String, dynamic>()),
