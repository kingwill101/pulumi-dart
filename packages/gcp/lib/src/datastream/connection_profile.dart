...
class ConnectionProfile extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ConnectionProfile]. {@macro pulumi_datastream_connection_profile_connection_profile_args_doc}
  ...
  ConnectionProfile(
    ...
    this.gcsProfile = registerOutput<ConnectionProfileGcsProfile?>(
      'gcsProfile',
    );
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.mongodbProfile = registerOutput<ConnectionProfileMongodbProfile?>(
      'mongodbProfile',
    );
    this.mysqlProfile = registerOutput<ConnectionProfileMysqlProfile?>(
      'mysqlProfile',
    );
    this.name = registerOutput<String>('name');
    this.oracleProfile = registerOutput<ConnectionProfileOracleProfile?>(
      'oracleProfile',
    );
    ...
    this.spannerProfile = registerOutput<ConnectionProfileSpannerProfile?>(
      'spannerProfile',
    );
    this.sqlServerProfile = registerOutput<ConnectionProfileSqlServerProfile?>(
      'sqlServerProfile',
    );
  }
}
