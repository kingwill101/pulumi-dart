...
class StreamSourceConfigSalesforceSourceConfigExcludeObjectsObject {
  ...
  final List<StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectField>? fields;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fields': ?fields == null ? null : pulumi.Input.encodeList<StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectField, Map<String, dynamic>>(fields!, (value) => value.toMap()),
  ...
  factory StreamSourceConfigSalesforceSourceConfigExcludeObjectsObject.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigSalesforceSourceConfigExcludeObjectsObject(
      fields: map['fields'] == null ? null : pulumi.Input.decodeList<StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectField>(map['fields'], (value) => StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectField.fromMap((value as Map).cast<String, dynamic>())),
