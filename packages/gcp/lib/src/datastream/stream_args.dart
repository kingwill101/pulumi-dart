...
class StreamArgs {
  ...
  factory StreamArgs.fromMap(Map<String, dynamic> map) {
    return StreamArgs(
      backfillAll: map['backfillAll'] == null ? null : StreamBackfillAll.fromMap((map['backfillAll'] as Map).cast<String, dynamic>()),
      ...
      destinationConfig: StreamDestinationConfig.fromMap((map['destinationConfig'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      ruleSets: map['ruleSets'] == null ? null : pulumi.Input.decodeList<StreamRuleSet>(map['ruleSets'], (value) => StreamRuleSet.fromMap((value as Map).cast<String, dynamic>())),
      sourceConfig: StreamSourceConfig.fromMap((map['sourceConfig'] as Map).cast<String, dynamic>()),
