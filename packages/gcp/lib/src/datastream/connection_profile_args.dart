...
class ConnectionProfileArgs {
  ...
  factory ConnectionProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileArgs(
      bigqueryProfile: map['bigqueryProfile'] == null ? null : (map['bigqueryProfile'] as Map).cast<String, dynamic>(),
      ...
      forwardSshConnectivity: map['forwardSshConnectivity'] == null ? null : ConnectionProfileForwardSshConnectivity.fromMap((map['forwardSshConnectivity'] as Map).cast<String, dynamic>()),
      gcsProfile: map['gcsProfile'] == null ? null : ConnectionProfileGcsProfile.fromMap((map['gcsProfile'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      mongodbProfile: map['mongodbProfile'] == null ? null : ConnectionProfileMongodbProfile.fromMap((map['mongodbProfile'] as Map).cast<String, dynamic>()),
      mysqlProfile: map['mysqlProfile'] == null ? null : ConnectionProfileMysqlProfile.fromMap((map['mysqlProfile'] as Map).cast<String, dynamic>()),
      oracleProfile: map['oracleProfile'] == null ? null : ConnectionProfileOracleProfile.fromMap((map['oracleProfile'] as Map).cast<String, dynamic>()),
      postgresqlProfile: map['postgresqlProfile'] == null ? null : ConnectionProfilePostgresqlProfile.fromMap((map['postgresqlProfile'] as Map).cast<String, dynamic>()),
      privateConnectivity: map['privateConnectivity'] == null ? null : ConnectionProfilePrivateConnectivity.fromMap((map['privateConnectivity'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      salesforceProfile: map['salesforceProfile'] == null ? null : ConnectionProfileSalesforceProfile.fromMap((map['salesforceProfile'] as Map).cast<String, dynamic>()),
      spannerProfile: map['spannerProfile'] == null ? null : ConnectionProfileSpannerProfile.fromMap((map['spannerProfile'] as Map).cast<String, dynamic>()),
      sqlServerProfile: map['sqlServerProfile'] == null ? null : ConnectionProfileSqlServerProfile.fromMap((map['sqlServerProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
