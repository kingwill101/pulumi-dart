...
class StreamDestinationConfigGcsDestinationConfig {
  ...
  final StreamDestinationConfigGcsDestinationConfigJsonFileFormat? jsonFileFormat;
  ...
  factory StreamDestinationConfigGcsDestinationConfig.fromMap(Map<String, dynamic> map) {
    return StreamDestinationConfigGcsDestinationConfig(
      ...
      jsonFileFormat: map['jsonFileFormat'] == null ? null : StreamDestinationConfigGcsDestinationConfigJsonFileFormat.fromMap((map['jsonFileFormat'] as Map).cast<String, dynamic>()),
