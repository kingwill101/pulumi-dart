...
class StreamBackfillAll {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mongodbExcludedObjects': ?mongodbExcludedObjects == null ? null : mongodbExcludedObjects!.toMap(),
      ...
      'salesforceExcludedObjects': ?salesforceExcludedObjects == null ? null : salesforceExcludedObjects!.toMap(),
      'spannerExcludedObjects': ?spannerExcludedObjects == null ? null : spannerExcludedObjects!.toMap(),
      'sqlServerExcludedObjects': ?sqlServerExcludedObjects == null ? null : sqlServerExcludedObjects!.toMap(),
    };
  }

  factory StreamBackfillAll.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAll(
      mongodbExcludedObjects: map['mongodbExcludedObjects'] == null ? null : StreamBackfillAllMongodbExcludedObjects.fromMap((map['mongodbExcludedObjects'] as Map).cast<String, dynamic>()),
      mysqlExcludedObjects: map['mysqlExcludedObjects'] == null ? null : StreamBackfillAllMysqlExcludedObjects.fromMap((map['mysqlExcludedObjects'] as Map).cast<String, dynamic>()),
      oracleExcludedObjects: map['oracleExcludedObjects'] == null ? null : StreamBackfillAllOracleExcludedObjects.fromMap((map['oracleExcludedObjects'] as Map).cast<String, dynamic>()),
      postgresqlExcludedObjects: map['postgresqlExcludedObjects'] == null ? null : StreamBackfillAllPostgresqlExcludedObjects.fromMap((map['postgresqlExcludedObjects'] as Map).cast<String, dynamic>()),
      salesforceExcludedObjects: map['salesforceExcludedObjects'] == null ? null : StreamBackfillAllSalesforceExcludedObjects.fromMap((map['salesforceExcludedObjects'] as Map).cast<String, dynamic>()),
      spannerExcludedObjects: map['spannerExcludedObjects'] == null ? null : StreamBackfillAllSpannerExcludedObjects.fromMap((map['spannerExcludedObjects'] as Map).cast<String, dynamic>()),
      sqlServerExcludedObjects: map['sqlServerExcludedObjects'] == null ? null : StreamBackfillAllSqlServerExcludedObjects.fromMap((map['sqlServerExcludedObjects'] as Map).cast<String, dynamic>()),
    );
  }
}
