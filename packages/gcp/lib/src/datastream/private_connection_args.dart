...
class PrivateConnectionArgs {
  ...
  factory PrivateConnectionArgs.fromMap(Map<String, dynamic> map) {
    return PrivateConnectionArgs(
      createWithoutValidation: map['createWithoutValidation'] == null ? null : map['createWithoutValidation'] as bool,
      displayName: map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      privateConnectionId: map['privateConnectionId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pscInterfaceConfig: map['pscInterfaceConfig'] == null ? null : PrivateConnectionPscInterfaceConfig.fromMap((map['pscInterfaceConfig'] as Map).cast<String, dynamic>()),
      vpcPeeringConfig: map['vpcPeeringConfig'] == null ? null : PrivateConnectionVpcPeeringConfig.fromMap((map['vpcPeeringConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
