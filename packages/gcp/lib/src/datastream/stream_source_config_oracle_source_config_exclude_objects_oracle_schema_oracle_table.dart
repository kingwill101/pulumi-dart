...
class StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTable {
  ...
  final List<StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableOracleColumn>? oracleColumns;
  /// Table name.
  final String table;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'oracleColumns': ?oracleColumns == null ? null : pulumi.Input.encodeList<StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableOracleColumn, Map<String, dynamic>>(oracleColumns!, (value) => value.toMap()),
      'table': table,
    };
  }
