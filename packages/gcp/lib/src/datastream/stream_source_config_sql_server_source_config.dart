...
class StreamSourceConfigSqlServerSourceConfig {
  ...
  factory StreamSourceConfigSqlServerSourceConfig.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigSqlServerSourceConfig(
      changeTables: map['changeTables'] == null ? null : (map['changeTables'] as Map).cast<String, dynamic>(),
      excludeObjects: map['excludeObjects'] == null ? null : StreamSourceConfigSqlServerSourceConfigExcludeObjects.fromMap((map['excludeObjects'] as Map).cast<String, dynamic>()),
      includeObjects: map['includeObjects'] == null ? null : StreamSourceConfigSqlServerSourceConfigIncludeObjects.fromMap((map['includeObjects'] as Map).cast<String, dynamic>()),
      ...
      transactionLogs: map['transactionLogs'] == null ? null : (map['transactionLogs'] as Map).cast<String, dynamic>(),
    );
  }
}
