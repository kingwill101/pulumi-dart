...
class StreamBackfillAllSqlServerExcludedObjectsSchemaTable {
  ...
  final List<StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumn>? columns;
  /// Table name.
  final String table;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns': ?columns == null ? null : pulumi.Input.encodeList<StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumn, Map<String, dynamic>>(columns!, (value) => value.toMap()),
      'table': table,
    };
  }
  ...
  factory StreamBackfillAllSqlServerExcludedObjectsSchemaTable.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllSqlServerExcludedObjectsSchemaTable(
      columns: map['columns'] == null ? null : pulumi.Input.decodeList<StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumn>(map['columns'], (value) => StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumn.fromMap((value as Map).cast<String, dynamic>())),
