...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTable {
  ...
  final List<StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumn>? postgresqlColumns;
  /// Table name.
  final String table;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'postgresqlColumns': ?postgresqlColumns == null ? null : pulumi.Input.encodeList<StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumn, Map<String, dynamic>>(postgresqlColumns!, (value) => value.toMap()),
      'table': table,
    };
  }
