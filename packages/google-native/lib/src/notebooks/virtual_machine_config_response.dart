...
class VirtualMachineConfigResponse {
  ...
  final LocalDiskResponse dataDisk;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bootImage': bootImage,
      'containerImages': pulumi.Input.encodeList<ContainerImageResponse, Map<String, dynamic>>(containerImages, (value) => value.toMap()),
  ...
  factory VirtualMachineConfigResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineConfigResponse(
      acceleratorConfig: RuntimeAcceleratorConfigResponse.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>()),
      bootImage: (map['bootImage'] as Map).cast<String, dynamic>(),
      containerImages: pulumi.Input.decodeList<ContainerImageResponse>(map['containerImages'], (value) => ContainerImageResponse.fromMap((value as Map).cast<String, dynamic>())),
      dataDisk: LocalDiskResponse.fromMap((map['dataDisk'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: RuntimeShieldedInstanceConfigResponse.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
