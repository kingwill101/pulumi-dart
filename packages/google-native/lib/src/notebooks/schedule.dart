...
class Schedule extends pulumi.CustomResource {
  ...
  Schedule(
    ...
    this.executionTemplate = registerOutput<ExecutionTemplateResponse>('executionTemplate');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.recentExecutions = registerOutput<List<ExecutionResponse>>('recentExecutions');
