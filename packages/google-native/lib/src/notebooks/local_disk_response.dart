...
class LocalDiskResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'guestOsFeatures': pulumi.Input.encodeList<RuntimeGuestOsFeatureResponse, Map<String, dynamic>>(guestOsFeatures, (value) => value.toMap()),
      'index': index,
  ...
  factory LocalDiskResponse.fromMap(Map<String, dynamic> map) {
    return LocalDiskResponse(
      ...
      guestOsFeatures: pulumi.Input.decodeList<RuntimeGuestOsFeatureResponse>(map['guestOsFeatures'], (value) => RuntimeGuestOsFeatureResponse.fromMap((value as Map).cast<String, dynamic>())),
      index: map['index'] as int,
      initializeParams: LocalDiskInitializeParamsResponse.fromMap((map['initializeParams'] as Map).cast<String, dynamic>()),
