...
class VirtualMachineConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bootImage': ?bootImage,
      'containerImages': ?containerImages == null ? null : pulumi.Input.encodeList<ContainerImage, Map<String, dynamic>>(containerImages!, (value) => value.toMap()),
  ...
  factory VirtualMachineConfig.fromMap(Map<String, dynamic> map) {
    return VirtualMachineConfig(
      acceleratorConfig: map['acceleratorConfig'] == null ? null : RuntimeAcceleratorConfig.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>()),
      bootImage: map['bootImage'] == null ? null : (map['bootImage'] as Map).cast<String, dynamic>(),
      containerImages: map['containerImages'] == null ? null : pulumi.Input.decodeList<ContainerImage>(map['containerImages'], (value) => ContainerImage.fromMap((value as Map).cast<String, dynamic>())),
      dataDisk: LocalDisk.fromMap((map['dataDisk'] as Map).cast<String, dynamic>()),
      ...
      nicType: map['nicType'] == null ? null : VirtualMachineConfigNicType.fromValue(map['nicType'] as String),
      reservedIpRange: map['reservedIpRange'] == null ? null : map['reservedIpRange'] as String,
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : RuntimeShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
