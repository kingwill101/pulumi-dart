...
/// {@template pulumi_notebooks_v2_instance_iam_binding_notebooks_v2_args_doc}
/// The set of arguments for InstanceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_notebooks_v2_instance_iam_binding_notebooks_v2_args_doc}
class InstanceIamBindingNotebooksV2Args {
  ...
  /// Creates a new [InstanceIamBindingNotebooksV2Args].
  ...
  InstanceIamBindingNotebooksV2Args({
    Condition? condition,
  ...
  factory InstanceIamBindingNotebooksV2Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingNotebooksV2Args(
