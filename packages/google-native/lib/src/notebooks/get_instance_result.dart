...
class GetInstanceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks': pulumi.Input.encodeList<DiskResponse, Map<String, dynamic>>(
        disks,
        (value) => value.toMap(),
      ),
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      acceleratorConfig: AcceleratorConfigResponse.fromMap(
      ...
      disks: pulumi.Input.decodeList<DiskResponse>(
        map['disks'],
      ...
      serviceAccountScopes: (map['serviceAccountScopes'] as List)
          .cast<String>(),
