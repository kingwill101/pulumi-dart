...
class ExecutionTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceleratorConfig': ?acceleratorConfig == null
          ? null
          : acceleratorConfig!.toMap(),
      'containerImageUri': ?containerImageUri,
      'dataprocParameters': ?dataprocParameters == null
          ? null
          : dataprocParameters!.toMap(),
      'inputNotebookFile': ?inputNotebookFile,
      'jobType': ?jobType == null ? null : jobType!.value,
      ...
      'scaleTier': scaleTier.value,
      'serviceAccount': ?serviceAccount,
      'tensorboard': ?tensorboard,
      'vertexAiParameters': ?vertexAiParameters == null
          ? null
          : vertexAiParameters!.toMap(),
    };
  }
  ...
  factory ExecutionTemplate.fromMap(Map<String, dynamic> map) {
    return ExecutionTemplate(
      ...
      kernelSpec: map['kernelSpec'] == null
          ? null
          : map['kernelSpec'] as String,
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      masterType: map['masterType'] == null
          ? null
          : map['masterType'] as String,
      ...
      scaleTier: ExecutionTemplateScaleTier.fromValue(
        map['scaleTier'] as String,
      ),
      serviceAccount: map['serviceAccount'] == null
          ? null
          : map['serviceAccount'] as String,
      tensorboard: map['tensorboard'] == null
          ? null
          : map['tensorboard'] as String,
