...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    VmImage? vmImage,
        ...
        bootDiskType =
            pulumi.Input.asOptionalInput<InstanceBootDiskType>(bootDiskType),
        canIpForward = pulumi.Input.asOptionalInput<bool>(canIpForward),
        containerImage =
            pulumi.Input.asOptionalInput<ContainerImage>(containerImage),
        customGpuDriverPath =
            pulumi.Input.asOptionalInput<String>(customGpuDriverPath),
        dataDiskSizeGb = pulumi.Input.asOptionalInput<String>(dataDiskSizeGb),
        dataDiskType =
            pulumi.Input.asOptionalInput<InstanceDataDiskType>(dataDiskType),
        ...
        upgradeHistory =
            pulumi.Input.asOptionalInput<List<UpgradeHistoryEntry>>(
                upgradeHistory),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (nicTypeValue != null) {
      map['nicType'] =
          pulumi.Input.mapOptionalInputValue<InstanceNicType, String>(
    ...
    if (upgradeHistoryValue != null) {
      map['upgradeHistory'] = pulumi.Input.mapOptionalInputValue<
              List<UpgradeHistoryEntry>, List<Map<String, dynamic>>>(
          upgradeHistoryValue,
          (value) => pulumi.Input.encodeList<UpgradeHistoryEntry,
