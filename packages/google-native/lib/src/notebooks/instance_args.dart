...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      bootDiskType: map['bootDiskType'] == null ? null : InstanceBootDiskType.fromValue(map['bootDiskType'] as String),
      canIpForward: map['canIpForward'] == null ? null : map['canIpForward'] as bool,
      containerImage: map['containerImage'] == null ? null : ContainerImage.fromMap((map['containerImage'] as Map).cast<String, dynamic>()),
      ...
      dataDiskType: map['dataDiskType'] == null ? null : InstanceDataDiskType.fromValue(map['dataDiskType'] as String),
      diskEncryption: map['diskEncryption'] == null ? null : InstanceDiskEncryption.fromValue(map['diskEncryption'] as String),
      installGpuDriver: map['installGpuDriver'] == null ? null : map['installGpuDriver'] as bool,
      instanceId: map['instanceId'] as String,
      instanceOwners: map['instanceOwners'] == null ? null : (map['instanceOwners'] as List).cast<String>(),
      ...
      nicType: map['nicType'] == null ? null : InstanceNicType.fromValue(map['nicType'] as String),
      noProxyAccess: map['noProxyAccess'] == null ? null : map['noProxyAccess'] as bool,
      noPublicIp: map['noPublicIp'] == null ? null : map['noPublicIp'] as bool,
      noRemoveDataDisk: map['noRemoveDataDisk'] == null ? null : map['noRemoveDataDisk'] as bool,
      ...
      upgradeHistory: map['upgradeHistory'] == null ? null : pulumi.Input.decodeList<UpgradeHistoryEntry>(map['upgradeHistory'], (value) => UpgradeHistoryEntry.fromMap((value as Map).cast<String, dynamic>())),
      vmImage: map['vmImage'] == null ? null : VmImage.fromMap((map['vmImage'] as Map).cast<String, dynamic>()),
    );
  }
}
