...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.acceleratorConfig = registerOutput<AcceleratorConfigResponse>(
      'acceleratorConfig',
    );
    ...
    this.containerImage = registerOutput<ContainerImageResponse>(
      'containerImage',
    );
    ...
    this.serviceAccountScopes = registerOutput<List<String>>(
    ...
    this.upgradeHistory = registerOutput<List<UpgradeHistoryEntryResponse>>(
      'upgradeHistory',
    );
