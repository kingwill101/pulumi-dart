...
class ExecutionTemplateResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dataprocParameters'] = dataprocParameters.toMap();
    map['inputNotebookFile'] = inputNotebookFile;
    map['jobType'] = jobType;
    map['kernelSpec'] = kernelSpec;
    map['labels'] = labels;
    map['masterType'] = masterType;
    map['outputNotebookFolder'] = outputNotebookFolder;
    map['parameters'] = parameters;
    map['paramsYamlFile'] = paramsYamlFile;
    map['scaleTier'] = scaleTier;
    map['serviceAccount'] = serviceAccount;
    map['tensorboard'] = tensorboard;
    map['vertexAiParameters'] = vertexAiParameters.toMap();
    return map;
  }
