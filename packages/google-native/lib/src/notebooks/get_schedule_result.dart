...
class GetScheduleResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'recentExecutions':
          pulumi.Input.encodeList<ExecutionResponse, Map<String, dynamic>>(
            recentExecutions,
            (value) => value.toMap(),
          ),
      'state': state,
  ...
  factory GetScheduleResult.fromMap(Map<String, dynamic> map) {
    return GetScheduleResult(
      ...
      recentExecutions: pulumi.Input.decodeList<ExecutionResponse>(
        map['recentExecutions'],
        (value) =>
            ExecutionResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
