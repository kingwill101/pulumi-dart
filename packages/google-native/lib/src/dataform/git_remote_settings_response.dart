...
class GitRemoteSettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['authenticationTokenSecretVersion'] = authenticationTokenSecretVersion;
    map['defaultBranch'] = defaultBranch;
    map['sshAuthenticationConfig'] = sshAuthenticationConfig.toMap();
  ...
  factory GitRemoteSettingsResponse.fromMap(Map<String, dynamic> map) {
    return GitRemoteSettingsResponse(
      ...
      sshAuthenticationConfig: SshAuthenticationConfigResponse.fromMap(
