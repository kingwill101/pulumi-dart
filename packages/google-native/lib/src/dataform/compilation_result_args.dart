...
class CompilationResultArgs {
  ...
  CompilationResultArgs({
    ...
    String? workspace,
  }) : codeCompilationConfig = pulumi
           .Input.asOptionalInput<CodeCompilationConfig>(codeCompilationConfig),
  ...
  factory CompilationResultArgs.fromMap(Map<String, dynamic> map) {
    return CompilationResultArgs(
      codeCompilationConfig: map['codeCompilationConfig'] == null
          ? null
          : CodeCompilationConfig.fromMap(
              (map['codeCompilationConfig'] as Map).cast<String, dynamic>(),
            ),
      gitCommitish: map['gitCommitish'] == null
          ? null
          : map['gitCommitish'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      releaseConfig: map['releaseConfig'] == null
          ? null
          : map['releaseConfig'] as String,
