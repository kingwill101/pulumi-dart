...
class GetRepositoryResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['gitRemoteSettings'] = gitRemoteSettings.toMap();
    map['labels'] = labels;
    map['name'] = name;
    map['npmrcEnvironmentVariablesSecretVersion'] =
        npmrcEnvironmentVariablesSecretVersion;
    map['serviceAccount'] = serviceAccount;
    map['setAuthenticatedUserAdmin'] = setAuthenticatedUserAdmin;
    map['workspaceCompilationOverrides'] =
        workspaceCompilationOverrides.toMap();
    return map;
  }
  ...
  factory GetRepositoryResult.fromMap(Map<String, dynamic> map) {
    return GetRepositoryResult(
      ...
      gitRemoteSettings: GitRemoteSettingsResponse.fromMap(
      ...
      workspaceCompilationOverrides:
          WorkspaceCompilationOverridesResponse.fromMap(
