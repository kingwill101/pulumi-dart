...
class Repository extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Repository]. {@macro pulumi_dataform_v1beta1_repository_args_doc}
  ...
  Repository(
    ...
    this.gitRemoteSettings = registerOutput<GitRemoteSettingsResponse>('gitRemoteSettings');
    ...
    this.setAuthenticatedUserAdmin = registerOutput<bool>('setAuthenticatedUserAdmin');
    this.workspaceCompilationOverrides = registerOutput<WorkspaceCompilationOverridesResponse>('workspaceCompilationOverrides');
  }
}
