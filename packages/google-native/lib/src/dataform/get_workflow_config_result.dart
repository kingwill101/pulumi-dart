...
class GetWorkflowConfigResult {
  ...
  /// Creates a new [GetWorkflowConfigResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'recentScheduledExecutionRecords': pulumi.Input.encodeList<ScheduledExecutionRecordResponse, Map<String, dynamic>>(recentScheduledExecutionRecords, (value) => value.toMap()),
  ...
  factory GetWorkflowConfigResult.fromMap(Map<String, dynamic> map) {
    return GetWorkflowConfigResult(
      ...
      recentScheduledExecutionRecords: pulumi.Input.decodeList<ScheduledExecutionRecordResponse>(map['recentScheduledExecutionRecords'], (value) => ScheduledExecutionRecordResponse.fromMap((value as Map).cast<String, dynamic>())),
