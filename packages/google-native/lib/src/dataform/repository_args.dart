...
class RepositoryArgs {
  ...
  factory RepositoryArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryArgs(
      ...
      gitRemoteSettings: map['gitRemoteSettings'] == null ? null : GitRemoteSettings.fromMap((map['gitRemoteSettings'] as Map).cast<String, dynamic>()),
      ...
      setAuthenticatedUserAdmin: map['setAuthenticatedUserAdmin'] == null ? null : map['setAuthenticatedUserAdmin'] as bool,
      workspaceCompilationOverrides: map['workspaceCompilationOverrides'] == null ? null : WorkspaceCompilationOverrides.fromMap((map['workspaceCompilationOverrides'] as Map).cast<String, dynamic>()),
    );
  }
}
