...
class ReleaseConfigArgs {
  ...
  ReleaseConfigArgs({
    ...
    String? timeZone,
       ...
       releaseCompilationResult = pulumi.Input.asOptionalInput<String>(
  ...
  factory ReleaseConfigArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseConfigArgs(
      ...
      releaseCompilationResult: map['releaseCompilationResult'] == null
          ? null
          : map['releaseCompilationResult'] as String,
