...
class GoogleCloudBillingBudgetsV1Filter {
  ...
  final GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'creditTypesTreatment': ?creditTypesTreatment == null
          ? null
  ...
  factory GoogleCloudBillingBudgetsV1Filter.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1Filter(
      calendarPeriod: map['calendarPeriod'] == null
          ? null
          : GoogleCloudBillingBudgetsV1FilterCalendarPeriod.fromValue(
      ...
      creditTypesTreatment: map['creditTypesTreatment'] == null
          ? null
          : GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment.fromValue(
              map['creditTypesTreatment'] as String,
            ),
      customPeriod: map['customPeriod'] == null
          ? null
          : GoogleCloudBillingBudgetsV1CustomPeriod.fromMap(
