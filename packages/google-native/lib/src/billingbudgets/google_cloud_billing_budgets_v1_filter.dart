...
import 'google_cloud_billing_budgets_v1_custom_period.dart';
import 'google_cloud_billing_budgets_v1_filter_calendar_period.dart';
import 'google_cloud_billing_budgets_v1_filter_credit_types_treatment.dart';
...
class GoogleCloudBillingBudgetsV1Filter {
  ...
  final GoogleCloudBillingBudgetsV1FilterCalendarPeriod? calendarPeriod;
  /// Optional. If Filter.credit_types_treatment is INCLUDE_SPECIFIED_CREDITS, this is a list of credit types to be subtracted from gross cost to determine the spend for threshold calculations. See [a list of acceptable credit type values](https://cloud.google.com/billing/docs/how-to/export-data-bigquery-tables#credits-type). If Filter.credit_types_treatment is **not** INCLUDE_SPECIFIED_CREDITS, this field must be empty.
  final List<String>? creditTypes;
  /// Optional. If not set, default behavior is `INCLUDE_ALL_CREDITS`.
  final GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment? creditTypesTreatment;
  /// Optional. Specifies to track usage from any start date (required) to any end date (optional). This time period is static, it does not recur.
  final GoogleCloudBillingBudgetsV1CustomPeriod? customPeriod;
  ...
  /// Creates a new [GoogleCloudBillingBudgetsV1Filter].
  /// [calendarPeriod] Optional. Specifies to track usage for recurring calendar period. For example, assume that CalendarPeriod.QUARTER is set. The budget tracks usage from April 1 to June 30, when the current calendar month is April, May, June. After that, it tracks usage from July 1 to September 30 when the current calendar month is July, August, September, so on.
  ...
  /// [projects] Optional. A set of projects of the form `projects/{project}`, specifying that usage from only this set of projects should be included in the budget. If omitted, the report includes all usage for the billing account, regardless of which project the usage occurred on.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'calendarPeriod': ?calendarPeriod == null ? null : calendarPeriod!.value,
      'creditTypes': ?creditTypes,
      'creditTypesTreatment': ?creditTypesTreatment == null ? null : creditTypesTreatment!.value,
  ...
  factory GoogleCloudBillingBudgetsV1Filter.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1Filter(
      calendarPeriod: map['calendarPeriod'] == null ? null : GoogleCloudBillingBudgetsV1FilterCalendarPeriod.fromValue(map['calendarPeriod'] as String),
      creditTypes: map['creditTypes'] == null ? null : (map['creditTypes'] as List).cast<String>(),
      creditTypesTreatment: map['creditTypesTreatment'] == null ? null : GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment.fromValue(map['creditTypesTreatment'] as String),
      customPeriod: map['customPeriod'] == null ? null : GoogleCloudBillingBudgetsV1CustomPeriod.fromMap((map['customPeriod'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      projects: map['projects'] == null ? null : (map['projects'] as List).cast<String>(),
      resourceAncestors: map['resourceAncestors'] == null ? null : (map['resourceAncestors'] as List).cast<String>(),
      services: map['services'] == null ? null : (map['services'] as List).cast<String>(),
      subaccounts: map['subaccounts'] == null ? null : (map['subaccounts'] as List).cast<String>(),
    );
  }
}
