...
class GoogleCloudBillingBudgetsV1NotificationsRuleResponse {
  ...
  /// Creates a new [GoogleCloudBillingBudgetsV1NotificationsRuleResponse].
  ...
  factory GoogleCloudBillingBudgetsV1NotificationsRuleResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1NotificationsRuleResponse(
