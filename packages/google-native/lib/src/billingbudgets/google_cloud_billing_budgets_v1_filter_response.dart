...
class GoogleCloudBillingBudgetsV1FilterResponse {
  ...
  final GoogleCloudBillingBudgetsV1CustomPeriodResponse customPeriod;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['calendarPeriod'] = calendarPeriod;
    map['creditTypes'] = creditTypes;
    map['creditTypesTreatment'] = creditTypesTreatment;
    map['customPeriod'] = customPeriod.toMap();
    map['labels'] = labels;
    map['projects'] = projects;
    map['resourceAncestors'] = resourceAncestors;
    map['services'] = services;
    map['subaccounts'] = subaccounts;
    return map;
  }

  factory GoogleCloudBillingBudgetsV1FilterResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1FilterResponse(
      calendarPeriod: map['calendarPeriod'] as String,
      creditTypes: (map['creditTypes'] as List).cast<String>(),
      creditTypesTreatment: map['creditTypesTreatment'] as String,
      customPeriod: GoogleCloudBillingBudgetsV1CustomPeriodResponse.fromMap(
          (map['customPeriod'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      projects: (map['projects'] as List).cast<String>(),
      resourceAncestors: (map['resourceAncestors'] as List).cast<String>(),
      services: (map['services'] as List).cast<String>(),
      subaccounts: (map['subaccounts'] as List).cast<String>(),
    );
  }
}
