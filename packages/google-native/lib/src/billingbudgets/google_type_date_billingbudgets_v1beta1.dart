...
class GoogleTypeDateBillingbudgetsV1beta1 {
  ...
  /// Creates a new [GoogleTypeDateBillingbudgetsV1beta1].
  ...
  GoogleTypeDateBillingbudgetsV1beta1({this.day, this.month, this.year});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'day': ?day, 'month': ?month, 'year': ?year};
  }

  factory GoogleTypeDateBillingbudgetsV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleTypeDateBillingbudgetsV1beta1(
