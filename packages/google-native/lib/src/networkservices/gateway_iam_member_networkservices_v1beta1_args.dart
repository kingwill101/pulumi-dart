...
/// {@template pulumi_networkservices_v1beta1_gateway_iam_member_networkservices_v1beta1_args_doc}
/// The set of arguments for GatewayIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_gateway_iam_member_networkservices_v1beta1_args_doc}
class GatewayIamMemberNetworkservicesV1beta1Args {
  ...
  /// Creates a new [GatewayIamMemberNetworkservicesV1beta1Args].
  ...
  GatewayIamMemberNetworkservicesV1beta1Args({
    Condition? condition,
  ...
  factory GatewayIamMemberNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return GatewayIamMemberNetworkservicesV1beta1Args(
