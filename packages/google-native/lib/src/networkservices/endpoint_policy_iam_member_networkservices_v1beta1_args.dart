...
/// {@template pulumi_networkservices_v1beta1_endpoint_policy_iam_member_networkservices_v1beta1_args_doc}
/// The set of arguments for EndpointPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_endpoint_policy_iam_member_networkservices_v1beta1_args_doc}
class EndpointPolicyIamMemberNetworkservicesV1beta1Args {
  ...
  /// Creates a new [EndpointPolicyIamMemberNetworkservicesV1beta1Args].
  ...
  EndpointPolicyIamMemberNetworkservicesV1beta1Args({
    Condition? condition,
  ...
  factory EndpointPolicyIamMemberNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyIamMemberNetworkservicesV1beta1Args(
