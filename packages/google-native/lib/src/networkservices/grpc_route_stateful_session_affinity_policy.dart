...
class GrpcRouteStatefulSessionAffinityPolicy {
  ...
  /// Creates a new [GrpcRouteStatefulSessionAffinityPolicy].
  ...
  GrpcRouteStatefulSessionAffinityPolicy({required this.cookieTtl});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'cookieTtl': cookieTtl};
  }

  factory GrpcRouteStatefulSessionAffinityPolicy.fromMap(
