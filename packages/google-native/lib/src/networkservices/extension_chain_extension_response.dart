...
class ExtensionChainExtensionResponse {
  ...
  /// Creates a new [ExtensionChainExtensionResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['forwardHeaders'] = forwardHeaders;
    map['name'] = name;
    map['service'] = service;
    map['supportedEvents'] = supportedEvents;
    map['timeout'] = timeout;
    return map;
  }

  factory ExtensionChainExtensionResponse.fromMap(Map<String, dynamic> map) {
    return ExtensionChainExtensionResponse(
      authority: map['authority'] as String,
      failOpen: map['failOpen'] as bool,
      forwardHeaders: (map['forwardHeaders'] as List).cast<String>(),
      name: map['name'] as String,
      service: map['service'] as String,
      supportedEvents: (map['supportedEvents'] as List).cast<String>(),
