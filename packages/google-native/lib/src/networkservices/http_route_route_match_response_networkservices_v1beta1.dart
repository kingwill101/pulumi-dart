...
class HttpRouteRouteMatchResponseNetworkservicesV1beta1 {
  ...
  final List<HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1> queryParameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': pulumi.Input.encodeList<HttpRouteHeaderMatchResponseNetworkservicesV1beta1, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ignoreCase': ignoreCase,
      'prefixMatch': prefixMatch,
      'queryParameters': pulumi.Input.encodeList<HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1, Map<String, dynamic>>(queryParameters, (value) => value.toMap()),
  ...
  factory HttpRouteRouteMatchResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteMatchResponseNetworkservicesV1beta1(
      ...
      headers: pulumi.Input.decodeList<HttpRouteHeaderMatchResponseNetworkservicesV1beta1>(map['headers'], (value) => HttpRouteHeaderMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      ignoreCase: map['ignoreCase'] as bool,
      prefixMatch: map['prefixMatch'] as String,
      queryParameters: pulumi.Input.decodeList<HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1>(map['queryParameters'], (value) => HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
