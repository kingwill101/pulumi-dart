...
class EndpointPolicyNetworkservicesV1beta1Args {
  ...
  EndpointPolicyNetworkservicesV1beta1Args({
    ...
    String? description,
    required EndpointMatcherNetworkservicesV1beta1 endpointMatcher,
    ...
    TrafficPortSelectorNetworkservicesV1beta1? trafficPortSelector,
    required EndpointPolicyTypeNetworkservicesV1beta1 type,
  }) :
  ...
  factory EndpointPolicyNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyNetworkservicesV1beta1Args(
      ...
      endpointMatcher: EndpointMatcherNetworkservicesV1beta1.fromMap((map['endpointMatcher'] as Map).cast<String, dynamic>()),
      ...
      trafficPortSelector: map['trafficPortSelector'] == null ? null : TrafficPortSelectorNetworkservicesV1beta1.fromMap((map['trafficPortSelector'] as Map).cast<String, dynamic>()),
      type: EndpointPolicyTypeNetworkservicesV1beta1.fromValue(map['type'] as String),
    );
  }
}
