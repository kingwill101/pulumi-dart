...
class ServiceLbPolicyArgs {
  ...
  factory ServiceLbPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceLbPolicyArgs(
      autoCapacityDrain: map['autoCapacityDrain'] == null ? null : ServiceLbPolicyAutoCapacityDrain.fromMap((map['autoCapacityDrain'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      failoverConfig: map['failoverConfig'] == null ? null : ServiceLbPolicyFailoverConfig.fromMap((map['failoverConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      loadBalancingAlgorithm: map['loadBalancingAlgorithm'] == null ? null : ServiceLbPolicyLoadBalancingAlgorithm.fromValue(map['loadBalancingAlgorithm'] as String),
