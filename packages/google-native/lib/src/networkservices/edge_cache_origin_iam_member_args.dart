...
/// {@template pulumi_networkservices_v1_edge_cache_origin_iam_member_args_doc}
/// The set of arguments for EdgeCacheOriginIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_edge_cache_origin_iam_member_args_doc}
class EdgeCacheOriginIamMemberArgs {
  ...
  /// Creates a new [EdgeCacheOriginIamMemberArgs].
  ...
  factory EdgeCacheOriginIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheOriginIamMemberArgs(
