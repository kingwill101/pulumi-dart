...
class HttpRouteRouteMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?headers == null ? null : pulumi.Input.encodeList<HttpRouteHeaderMatch, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'ignoreCase': ?ignoreCase,
      'prefixMatch': ?prefixMatch,
      'queryParameters': ?queryParameters == null ? null : pulumi.Input.encodeList<HttpRouteQueryParameterMatch, Map<String, dynamic>>(queryParameters!, (value) => value.toMap()),
  ...
  factory HttpRouteRouteMatch.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteMatch(
      ...
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<HttpRouteHeaderMatch>(map['headers'], (value) => HttpRouteHeaderMatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      queryParameters: map['queryParameters'] == null ? null : pulumi.Input.decodeList<HttpRouteQueryParameterMatch>(map['queryParameters'], (value) => HttpRouteQueryParameterMatch.fromMap((value as Map).cast<String, dynamic>())),
