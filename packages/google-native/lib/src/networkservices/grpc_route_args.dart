...
class GrpcRouteArgs {
  ...
  GrpcRouteArgs({
    ...
    String? name,
    String? project,
    required List<GrpcRouteRouteRule> rules,
  }) :
  ...
  factory GrpcRouteArgs.fromMap(Map<String, dynamic> map) {
    return GrpcRouteArgs(
      ...
      rules: pulumi.Input.decodeList<GrpcRouteRouteRule>(map['rules'], (value) => GrpcRouteRouteRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
