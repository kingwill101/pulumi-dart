...
/// {@template pulumi_networkservices_v1_service_binding_iam_member_args_doc}
/// The set of arguments for ServiceBindingIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_service_binding_iam_member_args_doc}
class ServiceBindingIamMemberArgs {
  ...
  /// Creates a new [ServiceBindingIamMemberArgs].
  ...
  factory ServiceBindingIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBindingIamMemberArgs(
