...
class TcpRouteRouteMatchNetworkservicesV1beta1 {
  ...
  /// Creates a new [TcpRouteRouteMatchNetworkservicesV1beta1].
  ...
  factory TcpRouteRouteMatchNetworkservicesV1beta1.fromMap(
      Map<String, dynamic> map) {
    return TcpRouteRouteMatchNetworkservicesV1beta1(
