...
class GrpcRouteDestinationResponse {
  ...
  /// Creates a new [GrpcRouteDestinationResponse].
  ...
  factory GrpcRouteDestinationResponse.fromMap(Map<String, dynamic> map) {
    return GrpcRouteDestinationResponse(
