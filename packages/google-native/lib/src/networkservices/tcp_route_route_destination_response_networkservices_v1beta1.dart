...
class TcpRouteRouteDestinationResponseNetworkservicesV1beta1 {
  ...
  /// Creates a new [TcpRouteRouteDestinationResponseNetworkservicesV1beta1].
  ...
  factory TcpRouteRouteDestinationResponseNetworkservicesV1beta1.fromMap(
      Map<String, dynamic> map) {
    return TcpRouteRouteDestinationResponseNetworkservicesV1beta1(
