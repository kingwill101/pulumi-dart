...
class GetEndpointPolicyNetworkservicesV1beta1Result {
  ...
  factory GetEndpointPolicyNetworkservicesV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetEndpointPolicyNetworkservicesV1beta1Result(
      ...
      endpointMatcher: EndpointMatcherResponseNetworkservicesV1beta1.fromMap((map['endpointMatcher'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      serverTlsPolicy: map['serverTlsPolicy'] as String,
      trafficPortSelector: TrafficPortSelectorResponseNetworkservicesV1beta1.fromMap((map['trafficPortSelector'] as Map).cast<String, dynamic>()),
