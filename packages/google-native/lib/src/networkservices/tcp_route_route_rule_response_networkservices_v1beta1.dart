...
class TcpRouteRouteRuleResponseNetworkservicesV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action.toMap(),
      'matches': pulumi.Input.encodeList<TcpRouteRouteMatchResponseNetworkservicesV1beta1, Map<String, dynamic>>(matches, (value) => value.toMap()),
    };
  }
  ...
  factory TcpRouteRouteRuleResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteRuleResponseNetworkservicesV1beta1(
      action: TcpRouteRouteActionResponseNetworkservicesV1beta1.fromMap((map['action'] as Map).cast<String, dynamic>()),
      matches: pulumi.Input.decodeList<TcpRouteRouteMatchResponseNetworkservicesV1beta1>(map['matches'], (value) => TcpRouteRouteMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
