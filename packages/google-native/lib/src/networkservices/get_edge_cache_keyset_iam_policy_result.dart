...
/// Result data returned by getEdgeCacheKeysetIamPolicy.
class GetEdgeCacheKeysetIamPolicyResult {
  ...
  /// Creates a new [GetEdgeCacheKeysetIamPolicyResult].
  ...
  factory GetEdgeCacheKeysetIamPolicyResult.fromMap(Map<String, dynamic> map) {
