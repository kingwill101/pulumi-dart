...
class GetEndpointPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['endpointMatcher'] = endpointMatcher.toMap();
    map['labels'] = labels;
    map['name'] = name;
    map['serverTlsPolicy'] = serverTlsPolicy;
    map['trafficPortSelector'] = trafficPortSelector.toMap();
    map['type'] = type;
