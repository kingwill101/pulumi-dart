...
class HttpRouteNetworkservicesV1beta1Args {
  ...
  HttpRouteNetworkservicesV1beta1Args({
    ...
    String? name,
    String? project,
    required List<HttpRouteRouteRuleNetworkservicesV1beta1> rules,
       ...
       rules =
           pulumi.Input.asInput<List<HttpRouteRouteRuleNetworkservicesV1beta1>>(
             rules,
           );
    ...
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<HttpRouteRouteRuleNetworkservicesV1beta1>,
  ...
  factory HttpRouteNetworkservicesV1beta1Args.fromMap(
    ...
    return HttpRouteNetworkservicesV1beta1Args(
      ...
      rules: pulumi.Input.decodeList<HttpRouteRouteRuleNetworkservicesV1beta1>(
        map['rules'],
        (value) => HttpRouteRouteRuleNetworkservicesV1beta1.fromMap(
