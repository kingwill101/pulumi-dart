...
import 'tls_route_networkservices_v1beta1_args.dart';
import 'tls_route_route_rule_response_networkservices_v1beta1.dart';

/// Creates a new TlsRoute in a given project and location.
class TlsRouteNetworkservicesV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<TlsRouteRouteRuleResponseNetworkservicesV1beta1>> rules;
  ...
  /// Creates a new [TlsRouteNetworkservicesV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TlsRouteNetworkservicesV1beta1]. {@macro pulumi_networkservices_v1beta1_tls_route_networkservices_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TlsRouteNetworkservicesV1beta1(
    String name, {
    TlsRouteNetworkservicesV1beta1Args? args,
    ...
    this.rules =
        registerOutput<List<TlsRouteRouteRuleResponseNetworkservicesV1beta1>>(
            'rules');
