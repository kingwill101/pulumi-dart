...
class TcpRouteNetworkservicesV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<TcpRouteRouteRuleResponseNetworkservicesV1beta1>> rules;
  ...
  TcpRouteNetworkservicesV1beta1(
    ...
    this.rules = registerOutput<List<TcpRouteRouteRuleResponseNetworkservicesV1beta1>>('rules');
