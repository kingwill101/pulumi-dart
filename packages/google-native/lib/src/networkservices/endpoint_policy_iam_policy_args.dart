...
/// {@template pulumi_networkservices_v1_endpoint_policy_iam_policy_args_doc}
/// The set of arguments for EndpointPolicyIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_endpoint_policy_iam_policy_args_doc}
class EndpointPolicyIamPolicyArgs {
  ...
  /// Creates a new [EndpointPolicyIamPolicyArgs].
  ...
  factory EndpointPolicyIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyIamPolicyArgs(
