...
class EndpointMatcherMetadataLabelMatcherResponse {
  ...
  final List<EndpointMatcherMetadataLabelMatcherMetadataLabelsResponse>
  metadataLabels;
    ...
    return <String, dynamic>{
      ...
      'metadataLabels':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(metadataLabels, (value) => value.toMap()),
    };
  }

  factory EndpointMatcherMetadataLabelMatcherResponse.fromMap(
    ...
    return EndpointMatcherMetadataLabelMatcherResponse(
      ...
      metadataLabels:
          ...
          >(
            map['metadataLabels'],
            (value) =>
                EndpointMatcherMetadataLabelMatcherMetadataLabelsResponse.fromMap(
