...
class ExtensionChainExtension {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'service': service,
      'supportedEvents': ?supportedEvents == null ? null : pulumi.Input.encodeList<ExtensionChainExtensionSupportedEventsItem, String>(supportedEvents!, (value) => value.value),
      'timeout': timeout,
    };
  }
  ...
  factory ExtensionChainExtension.fromMap(Map<String, dynamic> map) {
    return ExtensionChainExtension(
      ...
      supportedEvents: map['supportedEvents'] == null ? null : pulumi.Input.decodeList<ExtensionChainExtensionSupportedEventsItem>(map['supportedEvents'], (value) => ExtensionChainExtensionSupportedEventsItem.fromValue(value as String)),
