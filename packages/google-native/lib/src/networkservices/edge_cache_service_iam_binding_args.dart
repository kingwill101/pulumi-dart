...
/// {@template pulumi_networkservices_v1_edge_cache_service_iam_binding_args_doc}
/// The set of arguments for EdgeCacheServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_edge_cache_service_iam_binding_args_doc}
class EdgeCacheServiceIamBindingArgs {
  ...
  /// Creates a new [EdgeCacheServiceIamBindingArgs].
  ...
  EdgeCacheServiceIamBindingArgs({
    Condition? condition,
  ...
  factory EdgeCacheServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceIamBindingArgs(
