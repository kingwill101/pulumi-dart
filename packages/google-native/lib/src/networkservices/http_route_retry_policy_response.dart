...
class HttpRouteRetryPolicyResponse {
  ...
  /// Creates a new [HttpRouteRetryPolicyResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['perTryTimeout'] = perTryTimeout;
    map['retryConditions'] = retryConditions;
    return map;
  }

  factory HttpRouteRetryPolicyResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRetryPolicyResponse(
      numRetries: map['numRetries'] as int,
      perTryTimeout: map['perTryTimeout'] as String,
