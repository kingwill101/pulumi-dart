...
class ServiceBindingIamPolicyNetworkservicesV1beta1Args {
  ...
  ServiceBindingIamPolicyNetworkservicesV1beta1Args({
    ...
    int? version,
            ...
            List<AuditConfigNetworkservicesV1beta1>>(auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingNetworkservicesV1beta1>>(
                bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigNetworkservicesV1beta1>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigNetworkservicesV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingNetworkservicesV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingNetworkservicesV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory ServiceBindingIamPolicyNetworkservicesV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return ServiceBindingIamPolicyNetworkservicesV1beta1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigNetworkservicesV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigNetworkservicesV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingNetworkservicesV1beta1>(
              map['bindings'],
              (value) => BindingNetworkservicesV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
