...
/// {@template pulumi_networkservices_v1beta1_service_binding_iam_member_networkservices_v1beta1_args_doc}
/// The set of arguments for ServiceBindingIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_service_binding_iam_member_networkservices_v1beta1_args_doc}
class ServiceBindingIamMemberNetworkservicesV1beta1Args {
  ...
  /// Creates a new [ServiceBindingIamMemberNetworkservicesV1beta1Args].
  ...
  ServiceBindingIamMemberNetworkservicesV1beta1Args({
    Condition? condition,
  ...
  factory ServiceBindingIamMemberNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ServiceBindingIamMemberNetworkservicesV1beta1Args(
