...
class TcpRouteNetworkservicesV1beta1Args {
  ...
  TcpRouteNetworkservicesV1beta1Args({
    ...
    String? name,
    String? project,
    required List<TcpRouteRouteRuleNetworkservicesV1beta1> rules,
    required String tcpRouteId,
       ...
       rules = pulumi
           .Input.asInput<List<TcpRouteRouteRuleNetworkservicesV1beta1>>(rules),
  ...
  factory TcpRouteNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TcpRouteNetworkservicesV1beta1Args(
      ...
      rules: pulumi.Input.decodeList<TcpRouteRouteRuleNetworkservicesV1beta1>(
        map['rules'],
        (value) => TcpRouteRouteRuleNetworkservicesV1beta1.fromMap(
