...
/// {@template pulumi_networkservices_v1beta1_service_lb_policy_iam_binding_args_doc}
/// The set of arguments for ServiceLbPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_service_lb_policy_iam_binding_args_doc}
class ServiceLbPolicyIamBindingArgs {
  ...
  /// Creates a new [ServiceLbPolicyIamBindingArgs].
  ...
  factory ServiceLbPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceLbPolicyIamBindingArgs(
