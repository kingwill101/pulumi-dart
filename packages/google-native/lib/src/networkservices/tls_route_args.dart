...
class TlsRouteArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'rules': pulumi.Input.mapInputValue<List<TlsRouteRouteRule>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<TlsRouteRouteRule, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory TlsRouteArgs.fromMap(Map<String, dynamic> map) {
    return TlsRouteArgs(
      ...
      rules: pulumi.Input.decodeList<TlsRouteRouteRule>(map['rules'], (value) => TlsRouteRouteRule.fromMap((value as Map).cast<String, dynamic>())),
