...
/// {@template pulumi_networkservices_v1beta1_service_binding_iam_binding_networkservices_v1beta1_args_doc}
/// The set of arguments for ServiceBindingIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_service_binding_iam_binding_networkservices_v1beta1_args_doc}
class ServiceBindingIamBindingNetworkservicesV1beta1Args {
  ...
  /// Creates a new [ServiceBindingIamBindingNetworkservicesV1beta1Args].
  ...
  ServiceBindingIamBindingNetworkservicesV1beta1Args({
    Condition? condition,
  ...
  factory ServiceBindingIamBindingNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ServiceBindingIamBindingNetworkservicesV1beta1Args(
