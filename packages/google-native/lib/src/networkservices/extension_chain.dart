...
class ExtensionChain {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'extensions': pulumi.Input.encodeList<ExtensionChainExtension, Map<String, dynamic>>(extensions, (value) => value.toMap()),
  ...
  factory ExtensionChain.fromMap(Map<String, dynamic> map) {
    return ExtensionChain(
      extensions: pulumi.Input.decodeList<ExtensionChainExtension>(map['extensions'], (value) => ExtensionChainExtension.fromMap((value as Map).cast<String, dynamic>())),
      matchCondition: ExtensionChainMatchCondition.fromMap((map['matchCondition'] as Map).cast<String, dynamic>()),
