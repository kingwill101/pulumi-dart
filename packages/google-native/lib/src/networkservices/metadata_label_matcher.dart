...
class MetadataLabelMatcher {
  ...
  final MetadataLabelMatcherMetadataLabelMatchCriteria? metadataLabelMatchCriteria;
  /// The list of label value pairs that must match labels in the provided metadata based on filterMatchCriteria This list can have at most 64 entries. The list can be empty if the match criteria is MATCH_ANY, to specify a wildcard match (i.e this matches any client).
  final List<MetadataLabels>? metadataLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadataLabels': ?metadataLabels == null ? null : pulumi.Input.encodeList<MetadataLabels, Map<String, dynamic>>(metadataLabels!, (value) => value.toMap()),
    };
  }

  factory MetadataLabelMatcher.fromMap(Map<String, dynamic> map) {
    return MetadataLabelMatcher(
      metadataLabelMatchCriteria: map['metadataLabelMatchCriteria'] == null ? null : MetadataLabelMatcherMetadataLabelMatchCriteria.fromValue(map['metadataLabelMatchCriteria'] as String),
      metadataLabels: map['metadataLabels'] == null ? null : pulumi.Input.decodeList<MetadataLabels>(map['metadataLabels'], (value) => MetadataLabels.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
