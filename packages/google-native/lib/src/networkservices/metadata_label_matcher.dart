...
class MetadataLabelMatcher {
  ...
  final MetadataLabelMatcherMetadataLabelMatchCriteria?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metadataLabelMatchCriteria': ?metadataLabelMatchCriteria == null
          ? null
          : metadataLabelMatchCriteria!.value,
      'metadataLabels': ?metadataLabels == null
          ? null
  ...
  factory MetadataLabelMatcher.fromMap(Map<String, dynamic> map) {
    return MetadataLabelMatcher(
      metadataLabelMatchCriteria: map['metadataLabelMatchCriteria'] == null
          ? null
          : MetadataLabelMatcherMetadataLabelMatchCriteria.fromValue(
