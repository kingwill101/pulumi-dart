...
import 'grpc_route_networkservices_v1beta1_args.dart';
import 'grpc_route_route_rule_response_networkservices_v1beta1.dart';

/// Creates a new GrpcRoute in a given project and location.
class GrpcRouteNetworkservicesV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<GrpcRouteRouteRuleResponseNetworkservicesV1beta1>> rules;
  ...
  /// Creates a new [GrpcRouteNetworkservicesV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GrpcRouteNetworkservicesV1beta1]. {@macro pulumi_networkservices_v1beta1_grpc_route_networkservices_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GrpcRouteNetworkservicesV1beta1(
    String name, {
    GrpcRouteNetworkservicesV1beta1Args? args,
    ...
    this.rules =
        registerOutput<List<GrpcRouteRouteRuleResponseNetworkservicesV1beta1>>(
            'rules');
