...
class AndroidKeyRestrictionsResponse {
  ...
  AndroidKeyRestrictionsResponse({required this.allowedApplications});
  ...
  factory AndroidKeyRestrictionsResponse.fromMap(Map<String, dynamic> map) {
    return AndroidKeyRestrictionsResponse(
      allowedApplications: pulumi.Input.decodeList<AndroidApplicationResponse>(
        map['allowedApplications'],
        (value) => AndroidApplicationResponse.fromMap(
