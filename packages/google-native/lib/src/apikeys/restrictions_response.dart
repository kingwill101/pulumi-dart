...
class RestrictionsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'apiTargets':
          pulumi.Input.encodeList<ApiTargetResponse, Map<String, dynamic>>(
            apiTargets,
            (value) => value.toMap(),
          ),
  ...
  factory RestrictionsResponse.fromMap(Map<String, dynamic> map) {
    return RestrictionsResponse(
      androidKeyRestrictions: AndroidKeyRestrictionsResponse.fromMap(
        (map['androidKeyRestrictions'] as Map).cast<String, dynamic>(),
      ),
      apiTargets: pulumi.Input.decodeList<ApiTargetResponse>(
        map['apiTargets'],
        (value) =>
            ApiTargetResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      browserKeyRestrictions: BrowserKeyRestrictionsResponse.fromMap(
        (map['browserKeyRestrictions'] as Map).cast<String, dynamic>(),
      ),
      iosKeyRestrictions: IosKeyRestrictionsResponse.fromMap(
        (map['iosKeyRestrictions'] as Map).cast<String, dynamic>(),
      ),
      serverKeyRestrictions: ServerKeyRestrictionsResponse.fromMap(
