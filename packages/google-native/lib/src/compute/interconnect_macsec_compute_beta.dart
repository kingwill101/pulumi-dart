...
class InterconnectMacsecComputeBeta {
  ...
  InterconnectMacsecComputeBeta({this.failOpen, required this.preSharedKeys});
  ...
  factory InterconnectMacsecComputeBeta.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsecComputeBeta(
      ...
      preSharedKeys:
          pulumi.Input.decodeList<InterconnectMacsecPreSharedKeyComputeBeta>(
            map['preSharedKeys'],
            (value) => InterconnectMacsecPreSharedKeyComputeBeta.fromMap(
