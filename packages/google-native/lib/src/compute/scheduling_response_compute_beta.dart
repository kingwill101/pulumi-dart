...
class SchedulingResponseComputeBeta {
  ...
  factory SchedulingResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SchedulingResponseComputeBeta(
      ...
      localSsdRecoveryTimeout: DurationResponseComputeBeta.fromMap(
      ...
      maxRunDuration: DurationResponseComputeBeta.fromMap(
        (map['maxRunDuration'] as Map).cast<String, dynamic>(),
      ),
      minNodeCpus: map['minNodeCpus'] as int,
      nodeAffinities:
          pulumi.Input.decodeList<SchedulingNodeAffinityResponseComputeBeta>(
            map['nodeAffinities'],
            (value) => SchedulingNodeAffinityResponseComputeBeta.fromMap(
