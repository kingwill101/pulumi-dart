...
class InterconnectAttachmentComputeV1Args {
  ...
  InterconnectAttachmentComputeV1Args({
    ...
    int? vlanTag8021q,
        ...
        type =
            pulumi.Input.asOptionalInput<InterconnectAttachmentTypeComputeV1>(
                type),
  ...
  factory InterconnectAttachmentComputeV1Args.fromMap(
    ...
    return InterconnectAttachmentComputeV1Args(
      ...
      bandwidth: map['bandwidth'] == null
          ? null
          : InterconnectAttachmentBandwidthComputeV1.fromValue(
      ...
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null
          ? null
          : InterconnectAttachmentEdgeAvailabilityDomainComputeV1.fromValue(
              map['edgeAvailabilityDomain'] as String),
      encryption: map['encryption'] == null
          ? null
          : InterconnectAttachmentEncryptionComputeV1.fromValue(
      ...
      partnerMetadata: map['partnerMetadata'] == null
          ? null
          : InterconnectAttachmentPartnerMetadataComputeV1.fromMap(
      ...
      stackType: map['stackType'] == null
          ? null
          : InterconnectAttachmentStackTypeComputeV1.fromValue(
              map['stackType'] as String),
      subnetLength:
          map['subnetLength'] == null ? null : map['subnetLength'] as int,
      type: map['type'] == null
          ? null
          : InterconnectAttachmentTypeComputeV1.fromValue(
              map['type'] as String),
      vlanTag8021q:
