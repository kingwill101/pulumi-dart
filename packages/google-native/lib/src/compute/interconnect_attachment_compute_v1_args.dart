...
class InterconnectAttachmentComputeV1Args {
  ...
  InterconnectAttachmentComputeV1Args({
    bool? adminEnabled,
    InterconnectAttachmentBandwidthComputeV1? bandwidth,
    ...
    String? description,
    InterconnectAttachmentEdgeAvailabilityDomainComputeV1? edgeAvailabilityDomain,
    InterconnectAttachmentEncryptionComputeV1? encryption,
    String? interconnect,
    ...
    String? pairingKey,
    String? partnerAsn,
    InterconnectAttachmentPartnerMetadataComputeV1? partnerMetadata,
    String? project,
    required String region,
    String? requestId,
    String? router,
    InterconnectAttachmentStackTypeComputeV1? stackType,
    int? subnetLength,
    InterconnectAttachmentTypeComputeV1? type,
    int? vlanTag8021q,
  }) :
  ...
  factory InterconnectAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentComputeV1Args(
      ...
      bandwidth: map['bandwidth'] == null ? null : InterconnectAttachmentBandwidthComputeV1.fromValue(map['bandwidth'] as String),
      ...
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : InterconnectAttachmentEdgeAvailabilityDomainComputeV1.fromValue(map['edgeAvailabilityDomain'] as String),
      encryption: map['encryption'] == null ? null : InterconnectAttachmentEncryptionComputeV1.fromValue(map['encryption'] as String),
      ...
      partnerMetadata: map['partnerMetadata'] == null ? null : InterconnectAttachmentPartnerMetadataComputeV1.fromMap((map['partnerMetadata'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      router: map['router'] == null ? null : map['router'] as String,
      stackType: map['stackType'] == null ? null : InterconnectAttachmentStackTypeComputeV1.fromValue(map['stackType'] as String),
      subnetLength: map['subnetLength'] == null ? null : map['subnetLength'] as int,
      type: map['type'] == null ? null : InterconnectAttachmentTypeComputeV1.fromValue(map['type'] as String),
