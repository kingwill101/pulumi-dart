...
class NetworkComputeBetaArgs {
  ...
  NetworkComputeBetaArgs({
    ...
    int? mtu,
    String? name,
    NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta? networkFirewallPolicyEnforcementOrder,
    String? project,
    String? requestId,
    NetworkRoutingConfigComputeBeta? routingConfig,
  }) :
  ...
  factory NetworkComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkComputeBetaArgs(
      ...
      networkFirewallPolicyEnforcementOrder: map['networkFirewallPolicyEnforcementOrder'] == null ? null : NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta.fromValue(map['networkFirewallPolicyEnforcementOrder'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      routingConfig: map['routingConfig'] == null ? null : NetworkRoutingConfigComputeBeta.fromMap((map['routingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
