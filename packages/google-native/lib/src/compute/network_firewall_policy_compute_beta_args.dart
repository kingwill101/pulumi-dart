...
/// {@template pulumi_compute_beta_network_firewall_policy_compute_beta_args_doc}
/// The set of arguments for NetworkFirewallPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_network_firewall_policy_compute_beta_args_doc}
class NetworkFirewallPolicyComputeBetaArgs {
  ...
  /// Creates a new [NetworkFirewallPolicyComputeBetaArgs].
  ...
  NetworkFirewallPolicyComputeBetaArgs({
    ...
    String? shortName,
      ...
      associations = pulumi.Input.asOptionalInput<List<FirewallPolicyAssociationComputeBeta>>(associations),
      description = pulumi.Input.asOptionalInput<String>(description),
      displayName = pulumi.Input.asOptionalInput<String>(displayName),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      rules = pulumi.Input.asOptionalInput<List<FirewallPolicyRuleComputeBeta>>(rules),
      shortName = pulumi.Input.asOptionalInput<String>(shortName);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'associations': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyAssociationComputeBeta>, List<Map<String, dynamic>>>(associations, (value) => pulumi.Input.encodeList<FirewallPolicyAssociationComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'description': ?description,
      'displayName': ?displayName,
      'name': ?name,
      'project': ?project,
      'requestId': ?requestId,
      'rules': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyRuleComputeBeta>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<FirewallPolicyRuleComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'shortName': ?shortName,
    };
  }

  factory NetworkFirewallPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyComputeBetaArgs(
      associations: map['associations'] == null ? null : pulumi.Input.decodeList<FirewallPolicyAssociationComputeBeta>(map['associations'], (value) => FirewallPolicyAssociationComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleComputeBeta>(map['rules'], (value) => FirewallPolicyRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
