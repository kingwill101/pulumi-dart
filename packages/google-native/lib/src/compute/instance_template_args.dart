...
/// {@template pulumi_compute_alpha_instance_template_args_doc}
/// The set of arguments for InstanceTemplate.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_instance_template_args_doc}
class InstanceTemplateArgs {
  ...
  InstanceTemplateArgs({
    ...
    SourceInstanceParams? sourceInstanceParams,
        ...
        properties =
            pulumi.Input.asOptionalInput<InstanceProperties>(properties),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        sourceInstance = pulumi.Input.asOptionalInput<String>(sourceInstance),
        sourceInstanceParams =
            pulumi.Input.asOptionalInput<SourceInstanceParams>(
                sourceInstanceParams);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (propertiesValue != null) {
      map['properties'] = pulumi.Input.mapOptionalInputValue<InstanceProperties,
    ...
    if (sourceInstanceParamsValue != null) {
      map['sourceInstanceParams'] = pulumi.Input.mapOptionalInputValue<
              SourceInstanceParams, Map<String, dynamic>>(
