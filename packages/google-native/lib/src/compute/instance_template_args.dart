...
class InstanceTemplateArgs {
  ...
  InstanceTemplateArgs({
    ...
    SourceInstanceParams? sourceInstanceParams,
      ...
      sourceInstanceParams = pulumi.Input.asOptionalInput<SourceInstanceParams>(sourceInstanceParams);
  ...
  factory InstanceTemplateArgs.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateArgs(
      ...
      sourceInstanceParams: map['sourceInstanceParams'] == null ? null : SourceInstanceParams.fromMap((map['sourceInstanceParams'] as Map).cast<String, dynamic>()),
    );
  }
}
