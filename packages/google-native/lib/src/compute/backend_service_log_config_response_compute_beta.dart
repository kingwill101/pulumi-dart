...
class BackendServiceLogConfigResponseComputeBeta {
  ...
  /// Creates a new [BackendServiceLogConfigResponseComputeBeta].
  ...
  BackendServiceLogConfigResponseComputeBeta({
  ...
  factory BackendServiceLogConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfigResponseComputeBeta(
