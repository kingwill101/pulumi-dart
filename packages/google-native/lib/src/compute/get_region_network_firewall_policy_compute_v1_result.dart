...
class GetRegionNetworkFirewallPolicyComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = pulumi.Input.encodeList<FirewallPolicyRuleResponseComputeV1,
  ...
  factory GetRegionNetworkFirewallPolicyComputeV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetRegionNetworkFirewallPolicyComputeV1Result(
      associations:
          pulumi.Input.decodeList<FirewallPolicyAssociationResponseComputeV1>(
              map['associations'],
              (value) => FirewallPolicyAssociationResponseComputeV1.fromMap(
      ...
      rules: pulumi.Input.decodeList<FirewallPolicyRuleResponseComputeV1>(
          map['rules'],
          (value) => FirewallPolicyRuleResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
