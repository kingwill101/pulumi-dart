...
import 'httphealth_check_port_specification.dart';
import 'httphealth_check_proxy_header.dart';
import 'httphealth_check_weight_report_mode.dart';
...
class HTTPHealthCheck {
  ...
  final HTTPHealthCheckPortSpecification? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTPHealthCheckProxyHeader? proxyHeader;
  ...
  final HTTPHealthCheckWeightReportMode? weightReportMode;
  ...
  Map<String, dynamic> toMap() {
    ...
    final weightReportModeValue = weightReportMode;
    if (weightReportModeValue != null) {
      map['weightReportMode'] = weightReportModeValue.value;
    }
    return map;
  }
  ...
  factory HTTPHealthCheck.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheck(
      ...
      portSpecification: map['portSpecification'] == null
          ? null
          : HTTPHealthCheckPortSpecification.fromValue(
              map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null
          ? null
          : HTTPHealthCheckProxyHeader.fromValue(map['proxyHeader'] as String),
      requestPath:
          map['requestPath'] == null ? null : map['requestPath'] as String,
      response: map['response'] == null ? null : map['response'] as String,
      weightReportMode: map['weightReportMode'] == null
          ? null
          : HTTPHealthCheckWeightReportMode.fromValue(
              map['weightReportMode'] as String),
    );
  }
}
