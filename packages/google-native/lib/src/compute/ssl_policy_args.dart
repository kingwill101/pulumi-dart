...
class SslPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<SslPolicyProfile, String>(
        profile,
        (value) => value.value,
      ),
      'project': ?project,
  ...
  factory SslPolicyArgs.fromMap(Map<String, dynamic> map) {
    return SslPolicyArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null
          ? null
          : SslPolicyMinTlsVersion.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null
          ? null
          : SslPolicyProfile.fromValue(map['profile'] as String),
