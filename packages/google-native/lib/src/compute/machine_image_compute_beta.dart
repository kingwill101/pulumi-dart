...
class MachineImageComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InstancePropertiesResponseComputeBeta> instanceProperties;
  ...
  late final pulumi.Output<CustomerEncryptionKeyResponseComputeBeta> machineImageEncryptionKey;
  ...
  late final pulumi.Output<List<SavedDiskResponseComputeBeta>> savedDisks;
  /// The URL for this machine image. The server defines this URL.
  late final pulumi.Output<String> selfLink;
  /// [Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.
  late final pulumi.Output<List<SourceDiskEncryptionKeyResponseComputeBeta>> sourceDiskEncryptionKeys;
  ...
  late final pulumi.Output<SourceInstancePropertiesResponseComputeBeta> sourceInstanceProperties;
  ...
  MachineImageComputeBeta(
    ...
    this.instanceProperties = registerOutput<InstancePropertiesResponseComputeBeta>('instanceProperties');
    this.kind = registerOutput<String>('kind');
    this.machineImageEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('machineImageEncryptionKey');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.savedDisks = registerOutput<List<SavedDiskResponseComputeBeta>>('savedDisks');
    this.selfLink = registerOutput<String>('selfLink');
    this.sourceDiskEncryptionKeys = registerOutput<List<SourceDiskEncryptionKeyResponseComputeBeta>>('sourceDiskEncryptionKeys');
    this.sourceInstance = registerOutput<String>('sourceInstance');
    this.sourceInstanceProperties = registerOutput<SourceInstancePropertiesResponseComputeBeta>('sourceInstanceProperties');
