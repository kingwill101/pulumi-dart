...
class MachineImageComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SourceDiskEncryptionKeyResponseComputeBeta>>
  ...
  MachineImageComputeBeta(
    ...
    this.instanceProperties =
        registerOutput<InstancePropertiesResponseComputeBeta>(
          'instanceProperties',
        );
    ...
    this.savedDisks = registerOutput<List<SavedDiskResponseComputeBeta>>(
      'savedDisks',
    );
    this.selfLink = registerOutput<String>('selfLink');
    this.sourceDiskEncryptionKeys =
        registerOutput<List<SourceDiskEncryptionKeyResponseComputeBeta>>(
          'sourceDiskEncryptionKeys',
        );
