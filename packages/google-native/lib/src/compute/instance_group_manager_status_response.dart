...
class InstanceGroupManagerStatusResponse {
  ...
  factory InstanceGroupManagerStatusResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerStatusResponse(
      allInstancesConfig: InstanceGroupManagerStatusAllInstancesConfigResponse.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>()),
      autoscaler: map['autoscaler'] as String,
      isStable: map['isStable'] as bool,
      stateful: InstanceGroupManagerStatusStatefulResponse.fromMap((map['stateful'] as Map).cast<String, dynamic>()),
      versionTarget: InstanceGroupManagerStatusVersionTargetResponse.fromMap((map['versionTarget'] as Map).cast<String, dynamic>()),
    );
  }
}
