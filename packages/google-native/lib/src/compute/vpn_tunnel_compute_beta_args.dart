...
/// {@template pulumi_compute_beta_vpn_tunnel_compute_beta_args_doc}
/// The set of arguments for VpnTunnel.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_vpn_tunnel_compute_beta_args_doc}
class VpnTunnelComputeBetaArgs {
  ...
  /// Creates a new [VpnTunnelComputeBetaArgs].
  ...
  VpnTunnelComputeBetaArgs({
    ...
    int? vpnGatewayInterface,
        ...
        localTrafficSelector =
            pulumi.Input.asOptionalInput<List<String>>(localTrafficSelector),
        ...
        remoteTrafficSelector =
            pulumi.Input.asOptionalInput<List<String>>(remoteTrafficSelector),
        ...
        sharedSecretHash =
            pulumi.Input.asOptionalInput<String>(sharedSecretHash),
        targetVpnGateway =
  ...
  factory VpnTunnelComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return VpnTunnelComputeBetaArgs(
      description:
      ...
      localTrafficSelector: map['localTrafficSelector'] == null
          ? null
      ...
      remoteTrafficSelector: map['remoteTrafficSelector'] == null
          ? null
      ...
      sharedSecretHash: map['sharedSecretHash'] == null
          ? null
          : map['sharedSecretHash'] as String,
