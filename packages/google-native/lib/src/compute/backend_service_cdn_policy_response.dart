...
class BackendServiceCdnPolicyResponse {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse>
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final CacheKeyPolicyResponse cacheKeyPolicy;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyResponse>
  ...
  /// Creates a new [BackendServiceCdnPolicyResponse].
  ...
  factory BackendServiceCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponse(
      bypassCacheOnRequestHeaders: pulumi.Input.decodeList<
          ...
          (value) =>
              BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap(
                  (value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: CacheKeyPolicyResponse.fromMap(
      ...
      negativeCachingPolicy: pulumi.Input.decodeList<
          ...
          (value) =>
              BackendServiceCdnPolicyNegativeCachingPolicyResponse.fromMap(
                  (value as Map).cast<String, dynamic>())),
