...
class GetNodeGroupComputeBetaResult {
  ...
  /// Creates a new [GetNodeGroupComputeBetaResult].
  ...
  factory GetNodeGroupComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetNodeGroupComputeBetaResult(
      autoscalingPolicy: NodeGroupAutoscalingPolicyResponseComputeBeta.fromMap((map['autoscalingPolicy'] as Map).cast<String, dynamic>()),
      ...
      maintenanceWindow: NodeGroupMaintenanceWindowResponseComputeBeta.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
