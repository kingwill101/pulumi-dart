...
class RouterInterfaceResponseComputeV1 {
  ...
  /// Creates a new [RouterInterfaceResponseComputeV1].
  ...
  factory RouterInterfaceResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterInterfaceResponseComputeV1(
