...
import 'http_redirect_action_redirect_response_code_compute_v1.dart';
...
class HttpRedirectActionComputeV1 {
  ...
  final HttpRedirectActionRedirectResponseCodeComputeV1? redirectResponseCode;
  /// If set to true, any accompanying query portion of the original URL is removed before redirecting the request. If set to false, the query portion of the original URL is retained. The default is set to false.
  final bool? stripQuery;

  /// Creates a new [HttpRedirectActionComputeV1].
  ...
  factory HttpRedirectActionComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRedirectActionComputeV1(
      ...
      redirectResponseCode: map['redirectResponseCode'] == null ? null : HttpRedirectActionRedirectResponseCodeComputeV1.fromValue(map['redirectResponseCode'] as String),
