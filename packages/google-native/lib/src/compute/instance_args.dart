...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    InstanceKeyRevocationActionType? keyRevocationActionType,
    ...
    InstancePostKeyRevocationActionType? postKeyRevocationActionType,
    String? preservedStateSizeGb,
    InstancePrivateIpv6GoogleAccess? privateIpv6GoogleAccess,
    String? project,
    String? requestId,
    ...
    Map<String, String>? serviceIntegrationSpecs,
    ...
    String? zone,
      ...
      advancedMachineFeatures = pulumi.Input.asOptionalInput<AdvancedMachineFeatures>(advancedMachineFeatures),
      canIpForward = pulumi.Input.asOptionalInput<bool>(canIpForward),
      confidentialInstanceConfig = pulumi.Input.asOptionalInput<ConfidentialInstanceConfig>(confidentialInstanceConfig),
      deletionProtection = pulumi.Input.asOptionalInput<bool>(deletionProtection),
      description = pulumi.Input.asOptionalInput<String>(description),
      disks = pulumi.Input.asOptionalInput<List<AttachedDisk>>(disks),
      displayDevice = pulumi.Input.asOptionalInput<DisplayDevice>(displayDevice),
      eraseWindowsVssSignature = pulumi.Input.asOptionalInput<bool>(eraseWindowsVssSignature),
      guestAccelerators = pulumi.Input.asOptionalInput<List<AcceleratorConfig>>(guestAccelerators),
      hostname = pulumi.Input.asOptionalInput<String>(hostname),
      instanceEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKey>(instanceEncryptionKey),
      keyRevocationActionType = pulumi.Input.asOptionalInput<InstanceKeyRevocationActionType>(keyRevocationActionType),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      machineType = pulumi.Input.asOptionalInput<String>(machineType),
      metadata = pulumi.Input.asOptionalInput<Metadata>(metadata),
      minCpuPlatform = pulumi.Input.asOptionalInput<String>(minCpuPlatform),
      name = pulumi.Input.asOptionalInput<String>(name),
      networkInterfaces = pulumi.Input.asOptionalInput<List<NetworkInterface>>(networkInterfaces),
      networkPerformanceConfig = pulumi.Input.asOptionalInput<NetworkPerformanceConfig>(networkPerformanceConfig),
      ...
      postKeyRevocationActionType = pulumi.Input.asOptionalInput<InstancePostKeyRevocationActionType>(postKeyRevocationActionType),
      preservedStateSizeGb = pulumi.Input.asOptionalInput<String>(preservedStateSizeGb),
      privateIpv6GoogleAccess = pulumi.Input.asOptionalInput<InstancePrivateIpv6GoogleAccess>(privateIpv6GoogleAccess),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      reservationAffinity = pulumi.Input.asOptionalInput<ReservationAffinity>(reservationAffinity),
      resourcePolicies = pulumi.Input.asOptionalInput<List<String>>(resourcePolicies),
      scheduling = pulumi.Input.asOptionalInput<Scheduling>(scheduling),
      secureTags = pulumi.Input.asOptionalInput<List<String>>(secureTags),
      serviceAccounts = pulumi.Input.asOptionalInput<List<ServiceAccount>>(serviceAccounts),
      serviceIntegrationSpecs = pulumi.Input.asOptionalInput<Map<String, String>>(serviceIntegrationSpecs),
      shieldedInstanceConfig = pulumi.Input.asOptionalInput<ShieldedInstanceConfig>(shieldedInstanceConfig),
      shieldedInstanceIntegrityPolicy = pulumi.Input.asOptionalInput<ShieldedInstanceIntegrityPolicy>(shieldedInstanceIntegrityPolicy),
      shieldedVmConfig = pulumi.Input.asOptionalInput<ShieldedVmConfig>(shieldedVmConfig),
      shieldedVmIntegrityPolicy = pulumi.Input.asOptionalInput<ShieldedVmIntegrityPolicy>(shieldedVmIntegrityPolicy),
      ...
      sourceMachineImageEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKey>(sourceMachineImageEncryptionKey),
      tags = pulumi.Input.asOptionalInput<Tags>(tags),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : AdvancedMachineFeatures.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      canIpForward: map['canIpForward'] == null ? null : map['canIpForward'] as bool,
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : ConfidentialInstanceConfig.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>()),
      deletionProtection: map['deletionProtection'] == null ? null : map['deletionProtection'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      disks: map['disks'] == null ? null : pulumi.Input.decodeList<AttachedDisk>(map['disks'], (value) => AttachedDisk.fromMap((value as Map).cast<String, dynamic>())),
      displayDevice: map['displayDevice'] == null ? null : DisplayDevice.fromMap((map['displayDevice'] as Map).cast<String, dynamic>()),
      ...
      instanceEncryptionKey: map['instanceEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['instanceEncryptionKey'] as Map).cast<String, dynamic>()),
      keyRevocationActionType: map['keyRevocationActionType'] == null ? null : InstanceKeyRevocationActionType.fromValue(map['keyRevocationActionType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      machineType: map['machineType'] == null ? null : map['machineType'] as String,
      metadata: map['metadata'] == null ? null : Metadata.fromMap((map['metadata'] as Map).cast<String, dynamic>()),
      ...
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : NetworkPerformanceConfig.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      ...
      postKeyRevocationActionType: map['postKeyRevocationActionType'] == null ? null : InstancePostKeyRevocationActionType.fromValue(map['postKeyRevocationActionType'] as String),
      preservedStateSizeGb: map['preservedStateSizeGb'] == null ? null : map['preservedStateSizeGb'] as String,
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : InstancePrivateIpv6GoogleAccess.fromValue(map['privateIpv6GoogleAccess'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservationAffinity: map['reservationAffinity'] == null ? null : ReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      resourcePolicies: map['resourcePolicies'] == null ? null : (map['resourcePolicies'] as List).cast<String>(),
      scheduling: map['scheduling'] == null ? null : Scheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      secureTags: map['secureTags'] == null ? null : (map['secureTags'] as List).cast<String>(),
      serviceAccounts: map['serviceAccounts'] == null ? null : pulumi.Input.decodeList<ServiceAccount>(map['serviceAccounts'], (value) => ServiceAccount.fromMap((value as Map).cast<String, dynamic>())),
      serviceIntegrationSpecs: map['serviceIntegrationSpecs'] == null ? null : (map['serviceIntegrationSpecs'] as Map).cast<String, String>(),
      ...
      shieldedInstanceIntegrityPolicy: map['shieldedInstanceIntegrityPolicy'] == null ? null : ShieldedInstanceIntegrityPolicy.fromMap((map['shieldedInstanceIntegrityPolicy'] as Map).cast<String, dynamic>()),
      shieldedVmConfig: map['shieldedVmConfig'] == null ? null : ShieldedVmConfig.fromMap((map['shieldedVmConfig'] as Map).cast<String, dynamic>()),
      shieldedVmIntegrityPolicy: map['shieldedVmIntegrityPolicy'] == null ? null : ShieldedVmIntegrityPolicy.fromMap((map['shieldedVmIntegrityPolicy'] as Map).cast<String, dynamic>()),
      ...
      sourceMachineImageEncryptionKey: map['sourceMachineImageEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['sourceMachineImageEncryptionKey'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : Tags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
