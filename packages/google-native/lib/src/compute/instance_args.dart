...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? zone,
       ...
       displayDevice = pulumi.Input.asOptionalInput<DisplayDevice>(
         displayDevice,
       ),
       eraseWindowsVssSignature = pulumi.Input.asOptionalInput<bool>(
         eraseWindowsVssSignature,
       ),
       guestAccelerators = pulumi
           .Input.asOptionalInput<List<AcceleratorConfig>>(guestAccelerators),
       hostname = pulumi.Input.asOptionalInput<String>(hostname),
       instanceEncryptionKey = pulumi
           .Input.asOptionalInput<CustomerEncryptionKey>(instanceEncryptionKey),
       ...
       networkInterfaces = pulumi.Input.asOptionalInput<List<NetworkInterface>>(
         networkInterfaces,
       ),
       ...
       preservedStateSizeGb = pulumi.Input.asOptionalInput<String>(
       ...
       serviceAccounts = pulumi.Input.asOptionalInput<List<ServiceAccount>>(
         serviceAccounts,
       ),
       serviceIntegrationSpecs = pulumi
           .Input.asOptionalInput<Map<String, String>>(serviceIntegrationSpecs),
       ...
       sourceInstanceTemplate = pulumi.Input.asOptionalInput<String>(
         sourceInstanceTemplate,
       ),
       sourceMachineImage = pulumi.Input.asOptionalInput<String>(
         sourceMachineImage,
       ),
    ...
    return <String, dynamic>{
      ...
      'keyRevocationActionType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(keyRevocationActionType, (value) => value.value),
      'labels': ?labels,
      ...
      'postKeyRevocationActionType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(postKeyRevocationActionType, (value) => value.value),
      ...
      'shieldedInstanceIntegrityPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ShieldedInstanceIntegrityPolicy,
            Map<String, dynamic>
          >(shieldedInstanceIntegrityPolicy, (value) => value.toMap()),
      'shieldedVmConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ShieldedVmConfig,
            Map<String, dynamic>
      ...
      'shieldedVmIntegrityPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ShieldedVmIntegrityPolicy,
            Map<String, dynamic>
          >(shieldedVmIntegrityPolicy, (value) => value.toMap()),
      ...
      'tags': ?pulumi.Input.mapOptionalInputValue<Tags, Map<String, dynamic>>(
        tags,
        (value) => value.toMap(),
      ),
      'zone': ?zone,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      keyRevocationActionType: map['keyRevocationActionType'] == null
          ? null
          : InstanceKeyRevocationActionType.fromValue(
      ...
      postKeyRevocationActionType: map['postKeyRevocationActionType'] == null
          ? null
          : InstancePostKeyRevocationActionType.fromValue(
              map['postKeyRevocationActionType'] as String,
            ),
      preservedStateSizeGb: map['preservedStateSizeGb'] == null
          ? null
          : map['preservedStateSizeGb'] as String,
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null
          ? null
          : InstancePrivateIpv6GoogleAccess.fromValue(
      ...
      shieldedInstanceIntegrityPolicy:
          ...
          ? null
          : ShieldedInstanceIntegrityPolicy.fromMap(
      ...
      shieldedVmIntegrityPolicy: map['shieldedVmIntegrityPolicy'] == null
          ? null
          : ShieldedVmIntegrityPolicy.fromMap(
