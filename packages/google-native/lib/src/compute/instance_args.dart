...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? zone,
        ...
        displayDevice =
            pulumi.Input.asOptionalInput<DisplayDevice>(displayDevice),
        eraseWindowsVssSignature =
            pulumi.Input.asOptionalInput<bool>(eraseWindowsVssSignature),
        guestAccelerators =
            pulumi.Input.asOptionalInput<List<AcceleratorConfig>>(
                guestAccelerators),
        ...
        networkInterfaces =
            pulumi.Input.asOptionalInput<List<NetworkInterface>>(
                networkInterfaces),
        ...
        preservedStateSizeGb =
            pulumi.Input.asOptionalInput<String>(preservedStateSizeGb),
        ...
        serviceAccounts =
            pulumi.Input.asOptionalInput<List<ServiceAccount>>(serviceAccounts),
        ...
        shieldedInstanceIntegrityPolicy =
            pulumi.Input.asOptionalInput<ShieldedInstanceIntegrityPolicy>(
                shieldedInstanceIntegrityPolicy),
        shieldedVmConfig =
            pulumi.Input.asOptionalInput<ShieldedVmConfig>(shieldedVmConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (disksValue != null) {
      map['disks'] = pulumi.Input.mapOptionalInputValue<List<AttachedDisk>,
    ...
    if (networkInterfacesValue != null) {
      map['networkInterfaces'] = pulumi.Input.mapOptionalInputValue<
              List<NetworkInterface>, List<Map<String, dynamic>>>(
    ...
    if (serviceAccountsValue != null) {
      map['serviceAccounts'] = pulumi.Input.mapOptionalInputValue<
              List<ServiceAccount>, List<Map<String, dynamic>>>(
    ...
    return InstanceArgs(
      ...
      shieldedVmIntegrityPolicy: map['shieldedVmIntegrityPolicy'] == null
          ...
          : ShieldedVmIntegrityPolicy.fromMap(
              (map['shieldedVmIntegrityPolicy'] as Map)
                  .cast<String, dynamic>()),
