...
class TargetInstanceComputeV1Args {
  ...
  TargetInstanceComputeV1Args({
    ...
    String? zone,
       ...
       natPolicy = pulumi
           .Input.asOptionalInput<TargetInstanceNatPolicyComputeV1>(natPolicy),
    ...
    return <String, dynamic>{
      ...
      'natPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            TargetInstanceNatPolicyComputeV1,
            String
          >(natPolicy, (value) => value.value),
      'network': ?network,
      'project': ?project,
      'requestId': ?requestId,
      'zone': ?zone,
  ...
  factory TargetInstanceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetInstanceComputeV1Args(
      ...
      natPolicy: map['natPolicy'] == null
          ? null
          : TargetInstanceNatPolicyComputeV1.fromValue(
