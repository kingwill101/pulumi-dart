...
class ResourcePolicyResourceStatusResponseComputeV1 {
  ...
  final ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponseComputeV1 instanceSchedulePolicy;
  ...
  factory ResourcePolicyResourceStatusResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyResourceStatusResponseComputeV1(
      instanceSchedulePolicy: ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponseComputeV1.fromMap((map['instanceSchedulePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
