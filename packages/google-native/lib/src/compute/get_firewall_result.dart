...
class GetFirewallResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowed': pulumi.Input.encodeList<FirewallAllowedItemResponse, Map<String, dynamic>>(allowed, (value) => value.toMap()),
      'creationTimestamp': creationTimestamp,
      'denied': pulumi.Input.encodeList<FirewallDeniedItemResponse, Map<String, dynamic>>(denied, (value) => value.toMap()),
  ...
  factory GetFirewallResult.fromMap(Map<String, dynamic> map) {
    return GetFirewallResult(
      allowed: pulumi.Input.decodeList<FirewallAllowedItemResponse>(map['allowed'], (value) => FirewallAllowedItemResponse.fromMap((value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      denied: pulumi.Input.decodeList<FirewallDeniedItemResponse>(map['denied'], (value) => FirewallDeniedItemResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      logConfig: FirewallLogConfigResponse.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
