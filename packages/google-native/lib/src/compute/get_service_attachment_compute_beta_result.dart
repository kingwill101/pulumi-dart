...
class GetServiceAttachmentComputeBetaResult {
  ...
  final List<ServiceAttachmentConnectedEndpointResponseComputeBeta> connectedEndpoints;
  /// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
  final String connectionPreference;
  /// Projects that are allowed to connect to this service attachment.
  final List<ServiceAttachmentConsumerProjectLimitResponseComputeBeta> consumerAcceptLists;
  ...
  /// Creates a new [GetServiceAttachmentComputeBetaResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectedEndpoints': pulumi.Input.encodeList<ServiceAttachmentConnectedEndpointResponseComputeBeta, Map<String, dynamic>>(connectedEndpoints, (value) => value.toMap()),
      'connectionPreference': connectionPreference,
      'consumerAcceptLists': pulumi.Input.encodeList<ServiceAttachmentConsumerProjectLimitResponseComputeBeta, Map<String, dynamic>>(consumerAcceptLists, (value) => value.toMap()),
  ...
  factory GetServiceAttachmentComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetServiceAttachmentComputeBetaResult(
      connectedEndpoints: pulumi.Input.decodeList<ServiceAttachmentConnectedEndpointResponseComputeBeta>(map['connectedEndpoints'], (value) => ServiceAttachmentConnectedEndpointResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      connectionPreference: map['connectionPreference'] as String,
      consumerAcceptLists: pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimitResponseComputeBeta>(map['consumerAcceptLists'], (value) => ServiceAttachmentConsumerProjectLimitResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pscServiceAttachmentId: Uint128ResponseComputeBeta.fromMap((map['pscServiceAttachmentId'] as Map).cast<String, dynamic>()),
      reconcileConnections: map['reconcileConnections'] as bool,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      targetService: map['targetService'] as String,
      tunnelingConfig: ServiceAttachmentTunnelingConfigResponseComputeBeta.fromMap((map['tunnelingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
