...
class SslPolicyComputeBetaArgs {
  ...
  factory SslPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SslPolicyComputeBetaArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : SslPolicyMinTlsVersionComputeBeta.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null ? null : SslPolicyProfileComputeBeta.fromValue(map['profile'] as String),
