...
import 'public_delegated_prefix_public_delegated_sub_prefix_response_compute_beta.dart';

/// Result data returned by getPublicDelegatedPrefix.
class GetPublicDelegatedPrefixComputeBetaResult {
  ...
  final List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeBeta> publicDelegatedSubPrefixs;
  ...
  /// Creates a new [GetPublicDelegatedPrefixComputeBetaResult].
  ...
  GetPublicDelegatedPrefixComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicDelegatedSubPrefixs': pulumi.Input.encodeList<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeBeta, Map<String, dynamic>>(publicDelegatedSubPrefixs, (value) => value.toMap()),
      'region': region,
      'selfLink': selfLink,
      'status': status,
    };
  ...
  factory GetPublicDelegatedPrefixComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetPublicDelegatedPrefixComputeBetaResult(
      ...
      publicDelegatedSubPrefixs: pulumi.Input.decodeList<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeBeta>(map['publicDelegatedSubPrefixs'], (value) => PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
