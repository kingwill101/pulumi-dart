...
class GetPublicDelegatedPrefixComputeBetaResult {
  ...
  final List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeBeta>
    ...
    return <String, dynamic>{
      ...
      'publicDelegatedSubPrefixs':
          pulumi.Input.encodeList<
            PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeBeta,
            Map<String, dynamic>
  ...
  factory GetPublicDelegatedPrefixComputeBetaResult.fromMap(
    ...
    return GetPublicDelegatedPrefixComputeBetaResult(
      ...
      publicDelegatedSubPrefixs:
          ...
          >(
            ...
            (value) =>
                PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeBeta.fromMap(
