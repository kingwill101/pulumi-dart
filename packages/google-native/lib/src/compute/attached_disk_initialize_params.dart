...
class AttachedDiskInitializeParams {
  ...
  final AttachedDiskInitializeParamsArchitecture? architecture;
  ...
  final AttachedDiskInitializeParamsInterface? interface;
  ...
  final AttachedDiskInitializeParamsOnUpdateAction? onUpdateAction;
  ...
  final CustomerEncryptionKey? sourceImageEncryptionKey;
  ...
  final CustomerEncryptionKey? sourceSnapshotEncryptionKey;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'guestOsFeatures': ?guestOsFeatures == null ? null : pulumi.Input.encodeList<GuestOsFeature, Map<String, dynamic>>(guestOsFeatures!, (value) => value.toMap()),
      'interface': ?interface == null ? null : interface!.value,
      'labels': ?labels,
      'licenseCodes': ?licenseCodes,
      'licenses': ?licenses,
      'multiWriter': ?multiWriter,
      'onUpdateAction': ?onUpdateAction == null ? null : onUpdateAction!.value,
  ...
  factory AttachedDiskInitializeParams.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParams(
      architecture: map['architecture'] == null ? null : AttachedDiskInitializeParamsArchitecture.fromValue(map['architecture'] as String),
      ...
      interface: map['interface'] == null ? null : AttachedDiskInitializeParamsInterface.fromValue(map['interface'] as String),
      ...
      onUpdateAction: map['onUpdateAction'] == null ? null : AttachedDiskInitializeParamsOnUpdateAction.fromValue(map['onUpdateAction'] as String),
