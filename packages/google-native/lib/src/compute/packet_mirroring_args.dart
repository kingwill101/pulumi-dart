...
class PacketMirroringArgs {
  ...
  factory PacketMirroringArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringArgs(
      collectorIlb: map['collectorIlb'] == null ? null : PacketMirroringForwardingRuleInfo.fromMap((map['collectorIlb'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enable: map['enable'] == null ? null : PacketMirroringEnable.fromValue(map['enable'] as String),
      filter: map['filter'] == null ? null : PacketMirroringFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      mirroredResources: map['mirroredResources'] == null ? null : PacketMirroringMirroredResourceInfo.fromMap((map['mirroredResources'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : PacketMirroringNetworkInfo.fromMap((map['network'] as Map).cast<String, dynamic>()),
