...
class ResourcePolicyComputeV1Args {
  ...
  final pulumi.Input<ResourcePolicyGroupPlacementPolicyComputeV1>?
  groupPlacementPolicy;

  /// Resource policy for scheduling instance operations.
  final pulumi.Input<ResourcePolicyInstanceSchedulePolicyComputeV1>?
  ...
  final pulumi.Input<ResourcePolicySnapshotSchedulePolicyComputeV1>?
  ...
  factory ResourcePolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyComputeV1Args(
      ...
      snapshotSchedulePolicy: map['snapshotSchedulePolicy'] == null
          ? null
          : ResourcePolicySnapshotSchedulePolicyComputeV1.fromMap(
