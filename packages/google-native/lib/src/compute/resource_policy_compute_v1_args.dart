...
class ResourcePolicyComputeV1Args {
  ...
  ResourcePolicyComputeV1Args({
    ...
    ResourcePolicyGroupPlacementPolicyComputeV1? groupPlacementPolicy,
    ResourcePolicyInstanceSchedulePolicyComputeV1? instanceSchedulePolicy,
    String? name,
    String? project,
    required String region,
    String? requestId,
    ResourcePolicySnapshotSchedulePolicyComputeV1? snapshotSchedulePolicy,
  }) :
  ...
  factory ResourcePolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyComputeV1Args(
      ...
      groupPlacementPolicy: map['groupPlacementPolicy'] == null ? null : ResourcePolicyGroupPlacementPolicyComputeV1.fromMap((map['groupPlacementPolicy'] as Map).cast<String, dynamic>()),
      instanceSchedulePolicy: map['instanceSchedulePolicy'] == null ? null : ResourcePolicyInstanceSchedulePolicyComputeV1.fromMap((map['instanceSchedulePolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      snapshotSchedulePolicy: map['snapshotSchedulePolicy'] == null ? null : ResourcePolicySnapshotSchedulePolicyComputeV1.fromMap((map['snapshotSchedulePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
