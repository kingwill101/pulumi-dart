...
class NodeGroupComputeBetaArgs {
  ...
  NodeGroupComputeBetaArgs({
    NodeGroupAutoscalingPolicyComputeBeta? autoscalingPolicy,
    String? description,
    required int initialNodeCount,
    String? locationHint,
    NodeGroupMaintenanceIntervalComputeBeta? maintenanceInterval,
    NodeGroupMaintenancePolicyComputeBeta? maintenancePolicy,
    NodeGroupMaintenanceWindowComputeBeta? maintenanceWindow,
    String? name,
    String? nodeTemplate,
    String? project,
    String? requestId,
  ...
  factory NodeGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupComputeBetaArgs(
      autoscalingPolicy: map['autoscalingPolicy'] == null ? null : NodeGroupAutoscalingPolicyComputeBeta.fromMap((map['autoscalingPolicy'] as Map).cast<String, dynamic>()),
      ...
      maintenanceInterval: map['maintenanceInterval'] == null ? null : NodeGroupMaintenanceIntervalComputeBeta.fromValue(map['maintenanceInterval'] as String),
      maintenancePolicy: map['maintenancePolicy'] == null ? null : NodeGroupMaintenancePolicyComputeBeta.fromValue(map['maintenancePolicy'] as String),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : NodeGroupMaintenanceWindowComputeBeta.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
