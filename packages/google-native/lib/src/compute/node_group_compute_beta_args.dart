...
class NodeGroupComputeBetaArgs {
  ...
  NodeGroupComputeBetaArgs({
    ...
    String? zone,
            ...
            pulumi.Input.asOptionalInput<NodeGroupAutoscalingPolicyComputeBeta>(
                autoscalingPolicy),
        ...
        maintenanceInterval = pulumi.Input.asOptionalInput<
            NodeGroupMaintenanceIntervalComputeBeta>(maintenanceInterval),
        maintenancePolicy =
            pulumi.Input.asOptionalInput<NodeGroupMaintenancePolicyComputeBeta>(
                maintenancePolicy),
        maintenanceWindow =
            pulumi.Input.asOptionalInput<NodeGroupMaintenanceWindowComputeBeta>(
                maintenanceWindow),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoscalingPolicyValue != null) {
      map['autoscalingPolicy'] = pulumi.Input.mapOptionalInputValue<
              NodeGroupAutoscalingPolicyComputeBeta, Map<String, dynamic>>(
    ...
    if (maintenanceWindowValue != null) {
      map['maintenanceWindow'] = pulumi.Input.mapOptionalInputValue<
              NodeGroupMaintenanceWindowComputeBeta, Map<String, dynamic>>(
