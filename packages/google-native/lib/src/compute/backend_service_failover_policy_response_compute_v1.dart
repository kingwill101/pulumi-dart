...
class BackendServiceFailoverPolicyResponseComputeV1 {
  ...
  /// Creates a new [BackendServiceFailoverPolicyResponseComputeV1].
  ...
  BackendServiceFailoverPolicyResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['disableConnectionDrainOnFailover'] = disableConnectionDrainOnFailover;
    map['dropTrafficIfUnhealthy'] = dropTrafficIfUnhealthy;
    map['failoverRatio'] = failoverRatio;
    return map;
  }

  factory BackendServiceFailoverPolicyResponseComputeV1.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceFailoverPolicyResponseComputeV1(
