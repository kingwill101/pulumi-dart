...
class ImageComputeV1 extends pulumi.CustomResource {
  ...
  ImageComputeV1(
    ...
    this.deprecated = registerOutput<DeprecationStatusResponseComputeV1>('deprecated');
    ...
    this.imageEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeV1>('imageEncryptionKey');
    ...
    this.shieldedInstanceInitialState = registerOutput<InitialStateConfigResponseComputeV1>('shieldedInstanceInitialState');
    this.sourceDisk = registerOutput<String>('sourceDisk');
    this.sourceDiskEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeV1>('sourceDiskEncryptionKey');
