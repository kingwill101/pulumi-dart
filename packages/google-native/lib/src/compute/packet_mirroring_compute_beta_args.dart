...
class PacketMirroringComputeBetaArgs {
  ...
  final pulumi.Input<PacketMirroringForwardingRuleInfoComputeBeta>?
  collectorIlb;
  ...
  final pulumi.Input<PacketMirroringMirroredResourceInfoComputeBeta>?
  mirroredResources;
  ...
  PacketMirroringComputeBetaArgs({
    ...
    String? requestId,
       ...
       enable = pulumi.Input.asOptionalInput<PacketMirroringEnableComputeBeta>(
         enable,
       ),
       filter = pulumi.Input.asOptionalInput<PacketMirroringFilterComputeBeta>(
         filter,
       ),
       mirroredResources =
           pulumi.Input.asOptionalInput<
       ...
       network =
           pulumi.Input.asOptionalInput<PacketMirroringNetworkInfoComputeBeta>(
             network,
           ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enable':
          ?pulumi.Input.mapOptionalInputValue<
            PacketMirroringEnableComputeBeta,
            String
          >(enable, (value) => value.value),
      'filter':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory PacketMirroringComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringComputeBetaArgs(
      collectorIlb: map['collectorIlb'] == null
          ? null
          : PacketMirroringForwardingRuleInfoComputeBeta.fromMap(
      ...
      enable: map['enable'] == null
          ? null
          : PacketMirroringEnableComputeBeta.fromValue(map['enable'] as String),
      filter: map['filter'] == null
          ? null
          : PacketMirroringFilterComputeBeta.fromMap(
              (map['filter'] as Map).cast<String, dynamic>(),
            ),
      mirroredResources: map['mirroredResources'] == null
          ? null
          : PacketMirroringMirroredResourceInfoComputeBeta.fromMap(
              (map['mirroredResources'] as Map).cast<String, dynamic>(),
            ),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null
          ? null
          : PacketMirroringNetworkInfoComputeBeta.fromMap(
