...
class PacketMirroringComputeBetaArgs {
  ...
  PacketMirroringComputeBetaArgs({
    PacketMirroringForwardingRuleInfoComputeBeta? collectorIlb,
    String? description,
    PacketMirroringEnableComputeBeta? enable,
    PacketMirroringFilterComputeBeta? filter,
    PacketMirroringMirroredResourceInfoComputeBeta? mirroredResources,
    String? name,
    PacketMirroringNetworkInfoComputeBeta? network,
    int? priority,
    String? project,
  ...
  factory PacketMirroringComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringComputeBetaArgs(
      collectorIlb: map['collectorIlb'] == null ? null : PacketMirroringForwardingRuleInfoComputeBeta.fromMap((map['collectorIlb'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enable: map['enable'] == null ? null : PacketMirroringEnableComputeBeta.fromValue(map['enable'] as String),
      filter: map['filter'] == null ? null : PacketMirroringFilterComputeBeta.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      mirroredResources: map['mirroredResources'] == null ? null : PacketMirroringMirroredResourceInfoComputeBeta.fromMap((map['mirroredResources'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : PacketMirroringNetworkInfoComputeBeta.fromMap((map['network'] as Map).cast<String, dynamic>()),
