...
class CustomErrorResponsePolicyResponse {
  ...
  final List<CustomErrorResponsePolicyCustomErrorResponseRuleResponse> errorResponseRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': pulumi.Input.encodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponse, Map<String, dynamic>>(errorResponseRules, (value) => value.toMap()),
  ...
  factory CustomErrorResponsePolicyResponse.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyResponse(
      errorResponseRules: pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponse>(map['errorResponseRules'], (value) => CustomErrorResponsePolicyCustomErrorResponseRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
