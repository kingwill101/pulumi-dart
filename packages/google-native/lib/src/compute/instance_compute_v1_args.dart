...
class InstanceComputeV1Args {
  ...
  factory InstanceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceComputeV1Args(
      ...
      displayDevice: map['displayDevice'] == null ? null : DisplayDeviceComputeV1.fromMap((map['displayDevice'] as Map).cast<String, dynamic>()),
      ...
      instanceEncryptionKey: map['instanceEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeV1.fromMap((map['instanceEncryptionKey'] as Map).cast<String, dynamic>()),
      keyRevocationActionType: map['keyRevocationActionType'] == null ? null : InstanceKeyRevocationActionTypeComputeV1.fromValue(map['keyRevocationActionType'] as String),
      ...
      params: map['params'] == null ? null : InstanceParamsComputeV1.fromMap((map['params'] as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : InstancePrivateIpv6GoogleAccessComputeV1.fromValue(map['privateIpv6GoogleAccess'] as String),
      ...
      shieldedInstanceIntegrityPolicy: map['shieldedInstanceIntegrityPolicy'] == null ? null : ShieldedInstanceIntegrityPolicyComputeV1.fromMap((map['shieldedInstanceIntegrityPolicy'] as Map).cast<String, dynamic>()),
      ...
      sourceMachineImageEncryptionKey: map['sourceMachineImageEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeV1.fromMap((map['sourceMachineImageEncryptionKey'] as Map).cast<String, dynamic>()),
