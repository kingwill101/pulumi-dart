...
class RouterComputeBetaArgs {
  ...
  factory RouterComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RouterComputeBetaArgs(
      bgp: map['bgp'] == null ? null : RouterBgpComputeBeta.fromMap((map['bgp'] as Map).cast<String, dynamic>()),
      bgpPeers: map['bgpPeers'] == null ? null : pulumi.Input.decodeList<RouterBgpPeerComputeBeta>(map['bgpPeers'], (value) => RouterBgpPeerComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      encryptedInterconnectRouter: map['encryptedInterconnectRouter'] == null ? null : map['encryptedInterconnectRouter'] as bool,
      interfaces: map['interfaces'] == null ? null : pulumi.Input.decodeList<RouterInterfaceComputeBeta>(map['interfaces'], (value) => RouterInterfaceComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      md5AuthenticationKeys: map['md5AuthenticationKeys'] == null ? null : pulumi.Input.decodeList<RouterMd5AuthenticationKeyComputeBeta>(map['md5AuthenticationKeys'], (value) => RouterMd5AuthenticationKeyComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      nats: map['nats'] == null ? null : pulumi.Input.decodeList<RouterNatComputeBeta>(map['nats'], (value) => RouterNatComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
