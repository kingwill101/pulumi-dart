...
class SourceInstancePropertiesResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks': pulumi.Input.encodeList<SavedAttachedDiskResponseComputeV1, Map<String, dynamic>>(disks, (value) => value.toMap()),
  ...
  factory SourceInstancePropertiesResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SourceInstancePropertiesResponseComputeV1(
      ...
      disks: pulumi.Input.decodeList<SavedAttachedDiskResponseComputeV1>(map['disks'], (value) => SavedAttachedDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
