...
class UrlMapComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<HostRuleResponseComputeV1>> hostRules;
  ...
  late final pulumi.Output<List<PathMatcherResponseComputeV1>> pathMatchers;
  ...
  late final pulumi.Output<List<UrlMapTestResponseComputeV1>> tests;
  ...
  UrlMapComputeV1(
    ...
    this.defaultRouteAction = registerOutput<HttpRouteActionResponseComputeV1>('defaultRouteAction');
    this.defaultService = registerOutput<String>('defaultService');
    this.defaultUrlRedirect = registerOutput<HttpRedirectActionResponseComputeV1>('defaultUrlRedirect');
    this.description = registerOutput<String>('description');
    this.fingerprint = registerOutput<String>('fingerprint');
    this.headerAction = registerOutput<HttpHeaderActionResponseComputeV1>('headerAction');
    this.hostRules = registerOutput<List<HostRuleResponseComputeV1>>('hostRules');
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.pathMatchers = registerOutput<List<PathMatcherResponseComputeV1>>('pathMatchers');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.tests = registerOutput<List<UrlMapTestResponseComputeV1>>('tests');
  }
}
