...
class UrlMapComputeV1 extends pulumi.CustomResource {
  ...
  UrlMapComputeV1(
    ...
    this.defaultRouteAction = registerOutput<HttpRouteActionResponseComputeV1>(
      'defaultRouteAction',
    );
    ...
    this.headerAction = registerOutput<HttpHeaderActionResponseComputeV1>(
      'headerAction',
    );
    this.hostRules = registerOutput<List<HostRuleResponseComputeV1>>(
      'hostRules',
    );
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.pathMatchers = registerOutput<List<PathMatcherResponseComputeV1>>(
      'pathMatchers',
    );
