...
import 'public_advertised_prefix_compute_v1_args.dart';
import 'public_advertised_prefix_public_delegated_prefix_response_compute_v1.dart';

/// Creates a PublicAdvertisedPrefix in the specified project using the parameters that are included in the request.
class PublicAdvertisedPrefixComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<
          List<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeV1>>
  ...
  /// Creates a new [PublicAdvertisedPrefixComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PublicAdvertisedPrefixComputeV1]. {@macro pulumi_compute_v1_public_advertised_prefix_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  PublicAdvertisedPrefixComputeV1(
    String name, {
    PublicAdvertisedPrefixComputeV1Args? args,
