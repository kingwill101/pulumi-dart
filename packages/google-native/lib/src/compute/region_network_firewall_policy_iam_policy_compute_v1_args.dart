...
class RegionNetworkFirewallPolicyIamPolicyComputeV1Args {
  ...
  factory RegionNetworkFirewallPolicyIamPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamPolicyComputeV1Args(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Input.decodeList<AuditConfigComputeV1>(map['auditConfigs'], (value) => AuditConfigComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<BindingComputeV1>(map['bindings'], (value) => BindingComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      etag: map['etag'] == null ? null : map['etag'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      resource: map['resource'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RuleComputeV1>(map['rules'], (value) => RuleComputeV1.fromMap((value as Map).cast<String, dynamic>())),
