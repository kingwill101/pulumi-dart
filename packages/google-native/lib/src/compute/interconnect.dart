...
class Interconnect extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InterconnectOutageNotificationResponse>>
  expectedOutages;
  ...
  Interconnect(
    ...
    this.circuitInfos = registerOutput<List<InterconnectCircuitInfoResponse>>(
      'circuitInfos',
    );
    ...
    this.expectedOutages =
        registerOutput<List<InterconnectOutageNotificationResponse>>(
          'expectedOutages',
        );
