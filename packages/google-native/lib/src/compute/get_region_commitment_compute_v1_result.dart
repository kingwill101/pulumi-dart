...
class GetRegionCommitmentComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['plan'] = plan;
    map['region'] = region;
    map['reservations'] = pulumi.Input.encodeList<ReservationResponseComputeV1,
  ...
  factory GetRegionCommitmentComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionCommitmentComputeV1Result(
      ...
      licenseResource: LicenseResourceCommitmentResponseComputeV1.fromMap(
      ...
      reservations: pulumi.Input.decodeList<ReservationResponseComputeV1>(
          map['reservations'],
          (value) => ReservationResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      resources: pulumi.Input.decodeList<ResourceCommitmentResponseComputeV1>(
          map['resources'],
          (value) => ResourceCommitmentResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
