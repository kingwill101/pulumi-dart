...
import 'security_policy_type_compute_beta.dart';
import 'security_policy_user_defined_field_compute_beta.dart';

/// {@template pulumi_compute_beta_security_policy_compute_beta_args_doc}
/// The set of arguments for SecurityPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_security_policy_compute_beta_args_doc}
class SecurityPolicyComputeBetaArgs {
  ...
  final pulumi.Input<SecurityPolicyTypeComputeBeta>? type;
  ...
  /// Creates a new [SecurityPolicyComputeBetaArgs].
  ...
  SecurityPolicyComputeBetaArgs({
    ...
    SecurityPolicyTypeComputeBeta? type,
    List<SecurityPolicyUserDefinedFieldComputeBeta>? userDefinedFields,
      ...
      type = pulumi.Input.asOptionalInput<SecurityPolicyTypeComputeBeta>(type),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyTypeComputeBeta, String>(type, (value) => value.value),
  ...
  factory SecurityPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyComputeBetaArgs(
      adaptiveProtectionConfig: map['adaptiveProtectionConfig'] == null ? null : SecurityPolicyAdaptiveProtectionConfigComputeBeta.fromMap((map['adaptiveProtectionConfig'] as Map).cast<String, dynamic>()),
      advancedOptionsConfig: map['advancedOptionsConfig'] == null ? null : SecurityPolicyAdvancedOptionsConfigComputeBeta.fromMap((map['advancedOptionsConfig'] as Map).cast<String, dynamic>()),
      associations: map['associations'] == null ? null : pulumi.Input.decodeList<SecurityPolicyAssociationComputeBeta>(map['associations'], (value) => SecurityPolicyAssociationComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ddosProtectionConfig: map['ddosProtectionConfig'] == null ? null : SecurityPolicyDdosProtectionConfigComputeBeta.fromMap((map['ddosProtectionConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      recaptchaOptionsConfig: map['recaptchaOptionsConfig'] == null ? null : SecurityPolicyRecaptchaOptionsConfigComputeBeta.fromMap((map['recaptchaOptionsConfig'] as Map).cast<String, dynamic>()),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<SecurityPolicyRuleComputeBeta>(map['rules'], (value) => SecurityPolicyRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      type: map['type'] == null ? null : SecurityPolicyTypeComputeBeta.fromValue(map['type'] as String),
      userDefinedFields: map['userDefinedFields'] == null ? null : pulumi.Input.decodeList<SecurityPolicyUserDefinedFieldComputeBeta>(map['userDefinedFields'], (value) => SecurityPolicyUserDefinedFieldComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
