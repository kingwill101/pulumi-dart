...
class SecurityPolicyComputeBetaArgs {
  ...
  SecurityPolicyComputeBetaArgs({
    ...
    List<SecurityPolicyUserDefinedFieldComputeBeta>? userDefinedFields,
       ...
       rules = pulumi
           .Input.asOptionalInput<List<SecurityPolicyRuleComputeBeta>>(rules),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecurityPolicyRuleComputeBeta>,
            List<Map<String, dynamic>>
          >(
            rules,
            (value) =>
  ...
  factory SecurityPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyComputeBetaArgs(
      ...
      type: map['type'] == null
          ? null
          : SecurityPolicyTypeComputeBeta.fromValue(map['type'] as String),
