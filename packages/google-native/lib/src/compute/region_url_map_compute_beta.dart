...
class RegionUrlMapComputeBeta extends pulumi.CustomResource {
  ...
  RegionUrlMapComputeBeta(
    ...
    this.headerAction =
        registerOutput<HttpHeaderActionResponseComputeBeta>('headerAction');
    this.hostRules =
        registerOutput<List<HostRuleResponseComputeBeta>>('hostRules');
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.pathMatchers =
        registerOutput<List<PathMatcherResponseComputeBeta>>('pathMatchers');
