...
class RegionUrlMapComputeBeta extends pulumi.CustomResource {
  ...
  RegionUrlMapComputeBeta(
    ...
    this.defaultRouteAction =
        registerOutput<HttpRouteActionResponseComputeBeta>(
          'defaultRouteAction',
        );
    this.defaultService = registerOutput<String>('defaultService');
    this.defaultUrlRedirect =
        registerOutput<HttpRedirectActionResponseComputeBeta>(
          'defaultUrlRedirect',
        );
    this.description = registerOutput<String>('description');
    this.fingerprint = registerOutput<String>('fingerprint');
    this.headerAction = registerOutput<HttpHeaderActionResponseComputeBeta>(
      'headerAction',
    );
    this.hostRules = registerOutput<List<HostRuleResponseComputeBeta>>(
      'hostRules',
    );
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.pathMatchers = registerOutput<List<PathMatcherResponseComputeBeta>>(
      'pathMatchers',
    );
