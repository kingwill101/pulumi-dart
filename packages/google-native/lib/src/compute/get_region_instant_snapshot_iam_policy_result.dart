...
class GetRegionInstantSnapshotIamPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': etag,
      'rules': pulumi.Input.encodeList<RuleResponse, Map<String, dynamic>>(
        rules,
        (value) => value.toMap(),
      ),
      'version': version,
  ...
  factory GetRegionInstantSnapshotIamPolicyResult.fromMap(
    ...
    return GetRegionInstantSnapshotIamPolicyResult(
      auditConfigs: pulumi.Input.decodeList<AuditConfigResponse>(
        map['auditConfigs'],
        (value) =>
            AuditConfigResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      rules: pulumi.Input.decodeList<RuleResponse>(
        map['rules'],
        (value) => RuleResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
