...
import 'region_ssl_certificate_compute_v1_args.dart';
...
class RegionSslCertificateComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SslCertificateManagedSslCertificateResponseComputeV1>
      managed;
  ...
  late final pulumi
      .Output<SslCertificateSelfManagedSslCertificateResponseComputeV1>
      selfManaged;
  ...
  /// Creates a new [RegionSslCertificateComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionSslCertificateComputeV1]. {@macro pulumi_compute_v1_region_ssl_certificate_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionSslCertificateComputeV1(
    String name, {
    RegionSslCertificateComputeV1Args? args,
