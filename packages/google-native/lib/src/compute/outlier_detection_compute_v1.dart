...
class OutlierDetectionComputeV1 {
  ...
  factory OutlierDetectionComputeV1.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionComputeV1(
      baseEjectionTime: map['baseEjectionTime'] == null ? null : DurationComputeV1.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>()),
      ...
      interval: map['interval'] == null ? null : DurationComputeV1.fromMap((map['interval'] as Map).cast<String, dynamic>()),
