    ...
    List<String>? storageLocations,
        ...
        sourceSnapshotEncryptionKey =
            pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeV1>(
                sourceSnapshotEncryptionKey),
        sourceType =
            pulumi.Input.asOptionalInput<ImageSourceTypeComputeV1>(sourceType),
        storageLocations =
  ...
  factory ImageComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ImageComputeV1Args(
      architecture: map['architecture'] == null
          ? null
          : ImageArchitectureComputeV1.fromValue(map['architecture'] as String),
      ...
      sourceType: map['sourceType'] == null
          ? null
          : ImageSourceTypeComputeV1.fromValue(map['sourceType'] as String),
