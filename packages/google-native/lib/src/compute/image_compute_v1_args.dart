...
class ImageComputeV1Args {
  ...
  ImageComputeV1Args({
    ImageArchitectureComputeV1? architecture,
    String? archiveSizeBytes,
    DeprecationStatusComputeV1? deprecated,
    String? description,
    String? diskSizeGb,
    String? family,
    bool? forceCreate,
    List<GuestOsFeatureComputeV1>? guestOsFeatures,
    CustomerEncryptionKeyComputeV1? imageEncryptionKey,
    Map<String, String>? labels,
    List<String>? licenseCodes,
    List<String>? licenses,
    String? name,
    String? project,
    ImageRawDiskComputeV1? rawDisk,
    String? requestId,
    InitialStateConfigComputeV1? shieldedInstanceInitialState,
    String? sourceDisk,
    ...
    ImageSourceTypeComputeV1? sourceType,
  ...
  factory ImageComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ImageComputeV1Args(
      architecture: map['architecture'] == null ? null : ImageArchitectureComputeV1.fromValue(map['architecture'] as String),
      archiveSizeBytes: map['archiveSizeBytes'] == null ? null : map['archiveSizeBytes'] as String,
      deprecated: map['deprecated'] == null ? null : DeprecationStatusComputeV1.fromMap((map['deprecated'] as Map).cast<String, dynamic>()),
      ...
      imageEncryptionKey: map['imageEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeV1.fromMap((map['imageEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      rawDisk: map['rawDisk'] == null ? null : ImageRawDiskComputeV1.fromMap((map['rawDisk'] as Map).cast<String, dynamic>()),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      shieldedInstanceInitialState: map['shieldedInstanceInitialState'] == null ? null : InitialStateConfigComputeV1.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>()),
      ...
      sourceType: map['sourceType'] == null ? null : ImageSourceTypeComputeV1.fromValue(map['sourceType'] as String),
