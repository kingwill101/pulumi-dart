...
class FutureReservation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<FutureReservationSpecificSKUPropertiesResponse> specificSkuProperties;
  ...
  FutureReservation(
    ...
    this.autoCreatedReservationsDuration = registerOutput<DurationResponse>('autoCreatedReservationsDuration');
    ...
    this.specificSkuProperties = registerOutput<FutureReservationSpecificSKUPropertiesResponse>('specificSkuProperties');
    this.status = registerOutput<FutureReservationStatusResponse>('status');
    this.timeWindow = registerOutput<FutureReservationTimeWindowResponse>('timeWindow');
