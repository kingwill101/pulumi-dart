...
class PathMatcherResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'pathRules': pulumi.Input.encodeList<PathRuleResponse, Map<String, dynamic>>(pathRules, (value) => value.toMap()),
      'routeRules': pulumi.Input.encodeList<HttpRouteRuleResponse, Map<String, dynamic>>(routeRules, (value) => value.toMap()),
    };
  }
  ...
  factory PathMatcherResponse.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponse(
      ...
      pathRules: pulumi.Input.decodeList<PathRuleResponse>(map['pathRules'], (value) => PathRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
      routeRules: pulumi.Input.decodeList<HttpRouteRuleResponse>(map['routeRules'], (value) => HttpRouteRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
