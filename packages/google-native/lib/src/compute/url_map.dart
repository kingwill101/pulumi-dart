...
class UrlMap extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CustomErrorResponsePolicyResponse>
  ...
  UrlMap(String name, {UrlMapArgs? args, pulumi.CustomResourceOptions? options})
    : super(
    ...
    this.defaultCustomErrorResponsePolicy =
        registerOutput<CustomErrorResponsePolicyResponse>(
          'defaultCustomErrorResponsePolicy',
        );
    this.defaultRouteAction = registerOutput<HttpRouteActionResponse>(
      'defaultRouteAction',
    );
    this.defaultService = registerOutput<String>('defaultService');
    this.defaultUrlRedirect = registerOutput<HttpRedirectActionResponse>(
      'defaultUrlRedirect',
    );
    this.description = registerOutput<String>('description');
    this.fingerprint = registerOutput<String>('fingerprint');
    this.headerAction = registerOutput<HttpHeaderActionResponse>(
      'headerAction',
    );
    this.hostRules = registerOutput<List<HostRuleResponse>>('hostRules');
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.pathMatchers = registerOutput<List<PathMatcherResponse>>(
      'pathMatchers',
    );
