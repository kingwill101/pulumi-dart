...
enum RegionCommitmentTypeComputeV1 {
  ...
  const RegionCommitmentTypeComputeV1(this.value);
  final String value;

  static RegionCommitmentTypeComputeV1 fromValue(String value) {
    for (final item in RegionCommitmentTypeComputeV1.values) {
      if (item.value == value) {
        return item;
      }
    }
