...
class RouterBgpPeerBfdComputeV1 {
  ...
  final RouterBgpPeerBfdSessionInitializationModeComputeV1? sessionInitializationMode;
  ...
  factory RouterBgpPeerBfdComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfdComputeV1(
      ...
      sessionInitializationMode: map['sessionInitializationMode'] == null ? null : RouterBgpPeerBfdSessionInitializationModeComputeV1.fromValue(map['sessionInitializationMode'] as String),
    );
  }
}
