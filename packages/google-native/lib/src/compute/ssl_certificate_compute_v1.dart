...
import 'ssl_certificate_compute_v1_args.dart';
...
class SslCertificateComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [SslCertificateComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SslCertificateComputeV1]. {@macro pulumi_compute_v1_ssl_certificate_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SslCertificateComputeV1(
    String name, {
    SslCertificateComputeV1Args? args,
