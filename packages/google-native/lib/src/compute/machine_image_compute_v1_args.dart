...
class MachineImageComputeV1Args {
  ...
  MachineImageComputeV1Args({
    String? description,
    bool? guestFlush,
    CustomerEncryptionKeyComputeV1? machineImageEncryptionKey,
    String? name,
    String? project,
    String? requestId,
    List<SavedDiskComputeV1>? savedDisks,
    List<SourceDiskEncryptionKeyComputeV1>? sourceDiskEncryptionKeys,
    required String sourceInstance,
    List<String>? storageLocations,
  }) :
      description = pulumi.Input.asOptionalInput<String>(description),
      guestFlush = pulumi.Input.asOptionalInput<bool>(guestFlush),
      machineImageEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeV1>(machineImageEncryptionKey),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      savedDisks = pulumi.Input.asOptionalInput<List<SavedDiskComputeV1>>(savedDisks),
      sourceDiskEncryptionKeys = pulumi.Input.asOptionalInput<List<SourceDiskEncryptionKeyComputeV1>>(sourceDiskEncryptionKeys),
  ...
  factory MachineImageComputeV1Args.fromMap(Map<String, dynamic> map) {
    return MachineImageComputeV1Args(
      ...
      machineImageEncryptionKey: map['machineImageEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeV1.fromMap((map['machineImageEncryptionKey'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      savedDisks: map['savedDisks'] == null ? null : pulumi.Input.decodeList<SavedDiskComputeV1>(map['savedDisks'], (value) => SavedDiskComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      sourceDiskEncryptionKeys: map['sourceDiskEncryptionKeys'] == null ? null : pulumi.Input.decodeList<SourceDiskEncryptionKeyComputeV1>(map['sourceDiskEncryptionKeys'], (value) => SourceDiskEncryptionKeyComputeV1.fromMap((value as Map).cast<String, dynamic>())),
