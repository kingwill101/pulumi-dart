...
class MachineImageComputeV1Args {
  ...
  MachineImageComputeV1Args({
    ...
    List<String>? storageLocations,
        ...
        savedDisks =
            pulumi.Input.asOptionalInput<List<SavedDiskComputeV1>>(savedDisks),
        sourceDiskEncryptionKeys = pulumi.Input.asOptionalInput<
            List<SourceDiskEncryptionKeyComputeV1>>(sourceDiskEncryptionKeys),
    ...
    return MachineImageComputeV1Args(
      ...
      machineImageEncryptionKey: map['machineImageEncryptionKey'] == null
          ...
          : CustomerEncryptionKeyComputeV1.fromMap(
              (map['machineImageEncryptionKey'] as Map)
                  .cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      savedDisks: map['savedDisks'] == null
          ? null
          : pulumi.Input.decodeList<SavedDiskComputeV1>(
              map['savedDisks'],
              (value) => SavedDiskComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      sourceDiskEncryptionKeys: map['sourceDiskEncryptionKeys'] == null
          ? null
          : pulumi.Input.decodeList<SourceDiskEncryptionKeyComputeV1>(
              map['sourceDiskEncryptionKeys'],
              (value) => SourceDiskEncryptionKeyComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
