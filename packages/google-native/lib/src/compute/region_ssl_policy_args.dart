...
class RegionSslPolicyArgs {
  ...
  RegionSslPolicyArgs({
    ...
    String? requestId,
    ServerTlsSettings? tlsSettings,
  })  : customFeatures =
            pulumi.Input.asOptionalInput<List<String>>(customFeatures),
        description = pulumi.Input.asOptionalInput<String>(description),
        minTlsVersion =
            pulumi.Input.asOptionalInput<RegionSslPolicyMinTlsVersion>(
                minTlsVersion),
        ...
        tlsSettings =
            pulumi.Input.asOptionalInput<ServerTlsSettings>(tlsSettings);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (profileValue != null) {
      map['profile'] =
          pulumi.Input.mapOptionalInputValue<RegionSslPolicyProfile, String>(
    ...
    if (tlsSettingsValue != null) {
      map['tlsSettings'] = pulumi.Input.mapOptionalInputValue<ServerTlsSettings,
  ...
  factory RegionSslPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null
          ? null
          : RegionSslPolicyMinTlsVersion.fromValue(
              map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null
          ? null
          : RegionSslPolicyProfile.fromValue(map['profile'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      tlsSettings: map['tlsSettings'] == null
          ? null
          : ServerTlsSettings.fromMap(
