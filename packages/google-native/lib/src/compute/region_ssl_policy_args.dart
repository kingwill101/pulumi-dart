...
class RegionSslPolicyArgs {
  ...
  factory RegionSslPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : RegionSslPolicyMinTlsVersion.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null ? null : RegionSslPolicyProfile.fromValue(map['profile'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      tlsSettings: map['tlsSettings'] == null ? null : ServerTlsSettings.fromMap((map['tlsSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
