...
class NetworkAttachmentComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<NetworkAttachmentConnectedEndpointResponseComputeBeta>>
      connectionEndpoints;
  ...
  NetworkAttachmentComputeBeta(
    ...
    this.connectionEndpoints = registerOutput<
            List<NetworkAttachmentConnectedEndpointResponseComputeBeta>>(
        'connectionEndpoints');
