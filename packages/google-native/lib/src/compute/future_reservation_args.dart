...
class FutureReservationArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'planningStatus': ?pulumi.Input.mapOptionalInputValue<FutureReservationPlanningStatus, String>(planningStatus, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory FutureReservationArgs.fromMap(Map<String, dynamic> map) {
    return FutureReservationArgs(
      ...
      autoCreatedReservationsDuration: map['autoCreatedReservationsDuration'] == null ? null : Duration.fromMap((map['autoCreatedReservationsDuration'] as Map).cast<String, dynamic>()),
      ...
      planningStatus: map['planningStatus'] == null ? null : FutureReservationPlanningStatus.fromValue(map['planningStatus'] as String),
      ...
      timeWindow: map['timeWindow'] == null ? null : FutureReservationTimeWindow.fromMap((map['timeWindow'] as Map).cast<String, dynamic>()),
