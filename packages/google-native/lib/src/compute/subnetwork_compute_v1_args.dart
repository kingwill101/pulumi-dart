...
class SubnetworkComputeV1Args {
  ...
  final pulumi.Input<SubnetworkPrivateIpv6GoogleAccessComputeV1>?
  ...
  final pulumi.Input<List<SubnetworkSecondaryRangeComputeV1>>?
      secondaryIpRanges;
  ...
  SubnetworkComputeV1Args({
    ...
    SubnetworkStackTypeComputeV1? stackType,
        ...
        ipv6AccessType =
            pulumi.Input.asOptionalInput<SubnetworkIpv6AccessTypeComputeV1>(
                ipv6AccessType),
        logConfig = pulumi.Input.asOptionalInput<SubnetworkLogConfigComputeV1>(
            logConfig),
        ...
        privateIpv6GoogleAccess = pulumi.Input.asOptionalInput<
                SubnetworkPrivateIpv6GoogleAccessComputeV1>(
            privateIpv6GoogleAccess),
        project = pulumi.Input.asOptionalInput<String>(project),
        purpose =
            pulumi.Input.asOptionalInput<SubnetworkPurposeComputeV1>(purpose),
        ...
        secondaryIpRanges = pulumi.Input.asOptionalInput<
            List<SubnetworkSecondaryRangeComputeV1>>(secondaryIpRanges),
        stackType = pulumi.Input.asOptionalInput<SubnetworkStackTypeComputeV1>(
            stackType);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipv6AccessTypeValue != null) {
      map['ipv6AccessType'] = pulumi.Input.mapOptionalInputValue<
          SubnetworkIpv6AccessTypeComputeV1,
    ...
    if (roleValue != null) {
      map['role'] =
          pulumi.Input.mapOptionalInputValue<SubnetworkRoleComputeV1, String>(
  ...
  factory SubnetworkComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SubnetworkComputeV1Args(
      ...
      ipv6AccessType: map['ipv6AccessType'] == null
          ? null
          : SubnetworkIpv6AccessTypeComputeV1.fromValue(
              map['ipv6AccessType'] as String),
      logConfig: map['logConfig'] == null
          ? null
          : SubnetworkLogConfigComputeV1.fromMap(
      ...
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null
          ? null
          : SubnetworkPrivateIpv6GoogleAccessComputeV1.fromValue(
              map['privateIpv6GoogleAccess'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null
          ? null
          : SubnetworkPurposeComputeV1.fromValue(map['purpose'] as String),
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      role: map['role'] == null
          ? null
          : SubnetworkRoleComputeV1.fromValue(map['role'] as String),
      secondaryIpRanges: map['secondaryIpRanges'] == null
          ? null
          : pulumi.Input.decodeList<SubnetworkSecondaryRangeComputeV1>(
              map['secondaryIpRanges'],
              (value) => SubnetworkSecondaryRangeComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      stackType: map['stackType'] == null
          ? null
          : SubnetworkStackTypeComputeV1.fromValue(map['stackType'] as String),
    );
  }
}
