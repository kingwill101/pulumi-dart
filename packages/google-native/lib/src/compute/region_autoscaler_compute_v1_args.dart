...
class RegionAutoscalerComputeV1Args {
  ...
  RegionAutoscalerComputeV1Args({
    AutoscalingPolicyComputeV1? autoscalingPolicy,
    String? description,
    String? name,
    String? project,
  ...
  factory RegionAutoscalerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalerComputeV1Args(
      autoscalingPolicy: map['autoscalingPolicy'] == null ? null : AutoscalingPolicyComputeV1.fromMap((map['autoscalingPolicy'] as Map).cast<String, dynamic>()),
