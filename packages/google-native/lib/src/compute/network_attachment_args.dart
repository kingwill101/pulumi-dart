...
class NetworkAttachmentArgs {
  ...
  NetworkAttachmentArgs({
    NetworkAttachmentConnectionPreference? connectionPreference,
    String? description,
    String? name,
  ...
  factory NetworkAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentArgs(
      connectionPreference: map['connectionPreference'] == null ? null : NetworkAttachmentConnectionPreference.fromValue(map['connectionPreference'] as String),
