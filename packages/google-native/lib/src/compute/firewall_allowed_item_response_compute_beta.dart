...
class FirewallAllowedItemResponseComputeBeta {
  ...
  factory FirewallAllowedItemResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallAllowedItemResponseComputeBeta(
