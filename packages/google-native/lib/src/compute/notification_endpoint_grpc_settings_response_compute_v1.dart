...
class NotificationEndpointGrpcSettingsResponseComputeV1 {
  ...
  final DurationResponseComputeV1 resendInterval;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resendInterval': resendInterval.toMap(),
  ...
  factory NotificationEndpointGrpcSettingsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettingsResponseComputeV1(
      ...
      payloadName: map['payloadName'] as String,
      resendInterval: DurationResponseComputeV1.fromMap((map['resendInterval'] as Map).cast<String, dynamic>()),
      retryDurationSec: map['retryDurationSec'] as int,
    );
  }
}
