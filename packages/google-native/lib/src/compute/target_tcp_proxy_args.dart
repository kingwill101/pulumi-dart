...
class TargetTcpProxyArgs {
  ...
  TargetTcpProxyArgs({
    ...
    String? service,
        ...
        proxyHeader = pulumi.Input.asOptionalInput<TargetTcpProxyProxyHeader>(
            proxyHeader),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          pulumi.Input.mapOptionalInputValue<TargetTcpProxyProxyHeader, String>(
  ...
  factory TargetTcpProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyArgs(
      ...
      proxyHeader: map['proxyHeader'] == null
          ? null
          : TargetTcpProxyProxyHeader.fromValue(map['proxyHeader'] as String),
