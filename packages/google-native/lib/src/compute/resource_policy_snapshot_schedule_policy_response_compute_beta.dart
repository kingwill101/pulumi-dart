...
class ResourcePolicySnapshotSchedulePolicyResponseComputeBeta {
  ...
  factory ResourcePolicySnapshotSchedulePolicyResponseComputeBeta.fromMap(
    ...
    return ResourcePolicySnapshotSchedulePolicyResponseComputeBeta(
      retentionPolicy:
          ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponseComputeBeta.fromMap(
            (map['retentionPolicy'] as Map).cast<String, dynamic>(),
          ),
      schedule:
          ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeBeta.fromMap(
            (map['schedule'] as Map).cast<String, dynamic>(),
          ),
      snapshotProperties:
          ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponseComputeBeta.fromMap(
