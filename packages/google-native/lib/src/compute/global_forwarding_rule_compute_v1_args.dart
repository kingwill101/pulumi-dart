...
class GlobalForwardingRuleComputeV1Args {
  ...
  GlobalForwardingRuleComputeV1Args({
    ...
    String? description,
    String? ipAddress,
    GlobalForwardingRuleIpProtocolComputeV1? ipProtocol,
    GlobalForwardingRuleIpVersionComputeV1? ipVersion,
    bool? isMirroringCollector,
    Map<String, String>? labels,
    GlobalForwardingRuleLoadBalancingSchemeComputeV1? loadBalancingScheme,
    List<MetadataFilterComputeV1>? metadataFilters,
    String? name,
    String? network,
    GlobalForwardingRuleNetworkTierComputeV1? networkTier,
    bool? noAutomateDnsZone,
    String? portRange,
    List<String>? ports,
    String? project,
    GlobalForwardingRulePscConnectionStatusComputeV1? pscConnectionStatus,
    String? requestId,
  ...
  factory GlobalForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleComputeV1Args(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : GlobalForwardingRuleIpProtocolComputeV1.fromValue(map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null ? null : GlobalForwardingRuleIpVersionComputeV1.fromValue(map['ipVersion'] as String),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : map['isMirroringCollector'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : GlobalForwardingRuleLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme'] as String),
      ...
      networkTier: map['networkTier'] == null ? null : GlobalForwardingRuleNetworkTierComputeV1.fromValue(map['networkTier'] as String),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : GlobalForwardingRulePscConnectionStatusComputeV1.fromValue(map['pscConnectionStatus'] as String),
