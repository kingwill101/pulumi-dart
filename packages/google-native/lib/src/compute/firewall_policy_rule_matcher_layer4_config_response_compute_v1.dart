...
class FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1 {
  ...
  /// Creates a new [FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1].
  ...
  factory FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1(
