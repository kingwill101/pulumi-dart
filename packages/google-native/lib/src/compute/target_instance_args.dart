...
class TargetInstanceArgs {
  ...
  TargetInstanceArgs({
    ...
    String? instance,
    String? name,
    TargetInstanceNatPolicy? natPolicy,
    String? network,
    String? project,
    String? requestId,
    String? zone,
        ...
        natPolicy =
            pulumi.Input.asOptionalInput<TargetInstanceNatPolicy>(natPolicy),
  ...
  factory TargetInstanceArgs.fromMap(Map<String, dynamic> map) {
    return TargetInstanceArgs(
      ...
      natPolicy: map['natPolicy'] == null
          ? null
          : TargetInstanceNatPolicy.fromValue(map['natPolicy'] as String),
