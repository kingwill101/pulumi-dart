...
class ImageRawDisk {
  ...
  final ImageRawDiskContainerType? containerType;
  ...
  ImageRawDisk({this.containerType, this.sha1Checksum, this.source});
  ...
  factory ImageRawDisk.fromMap(Map<String, dynamic> map) {
    return ImageRawDisk(
      containerType: map['containerType'] == null
          ? null
          : ImageRawDiskContainerType.fromValue(map['containerType'] as String),
      sha1Checksum: map['sha1Checksum'] == null
          ? null
          : map['sha1Checksum'] as String,
