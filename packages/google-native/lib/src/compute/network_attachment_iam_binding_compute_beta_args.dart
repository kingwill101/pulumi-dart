...
/// {@template pulumi_compute_beta_network_attachment_iam_binding_compute_beta_args_doc}
/// The set of arguments for NetworkAttachmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_network_attachment_iam_binding_compute_beta_args_doc}
class NetworkAttachmentIamBindingComputeBetaArgs {
  ...
  /// Creates a new [NetworkAttachmentIamBindingComputeBetaArgs].
  ...
  NetworkAttachmentIamBindingComputeBetaArgs({
    Condition? condition,
  ...
  factory NetworkAttachmentIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamBindingComputeBetaArgs(
