...
/// Metadata
class MetadataItemsItemResponse {
  ...
  /// Creates a new [MetadataItemsItemResponse].
  ...
  MetadataItemsItemResponse({required this.key, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'key': key, 'value': value};
  }

  factory MetadataItemsItemResponse.fromMap(Map<String, dynamic> map) {
    return MetadataItemsItemResponse(
