...
/// {@template pulumi_compute_beta_firewall_policy_iam_binding_compute_beta_args_doc}
/// The set of arguments for FirewallPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_firewall_policy_iam_binding_compute_beta_args_doc}
class FirewallPolicyIamBindingComputeBetaArgs {
  ...
  /// Creates a new [FirewallPolicyIamBindingComputeBetaArgs].
  ...
  FirewallPolicyIamBindingComputeBetaArgs({
    Condition? condition,
  ...
  factory FirewallPolicyIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamBindingComputeBetaArgs(
