...
class RegionCommitmentComputeBetaArgs {
  ...
  RegionCommitmentComputeBetaArgs({
    bool? autoRenew,
    RegionCommitmentCategoryComputeBeta? category,
    String? description,
    LicenseResourceCommitmentComputeBeta? licenseResource,
    List<String>? mergeSourceCommitments,
    String? name,
    RegionCommitmentPlanComputeBeta? plan,
    String? project,
    required String region,
    String? requestId,
    List<ReservationResource>? reservations,
    List<ResourceCommitmentComputeBeta>? resources,
    String? splitSourceCommitment,
    RegionCommitmentTypeComputeBeta? type,
  }) :
  ...
  factory RegionCommitmentComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentComputeBetaArgs(
      ...
      category: map['category'] == null ? null : RegionCommitmentCategoryComputeBeta.fromValue(map['category'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      licenseResource: map['licenseResource'] == null ? null : LicenseResourceCommitmentComputeBeta.fromMap((map['licenseResource'] as Map).cast<String, dynamic>()),
      mergeSourceCommitments: map['mergeSourceCommitments'] == null ? null : (map['mergeSourceCommitments'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      plan: map['plan'] == null ? null : RegionCommitmentPlanComputeBeta.fromValue(map['plan'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservations: map['reservations'] == null ? null : (map['reservations'] as List).cast<ReservationResource>(),
      resources: map['resources'] == null ? null : pulumi.Input.decodeList<ResourceCommitmentComputeBeta>(map['resources'], (value) => ResourceCommitmentComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      splitSourceCommitment: map['splitSourceCommitment'] == null ? null : map['splitSourceCommitment'] as String,
      type: map['type'] == null ? null : RegionCommitmentTypeComputeBeta.fromValue(map['type'] as String),
    );
  }
}
