...
class RegionCommitmentComputeBetaArgs {
  ...
  RegionCommitmentComputeBetaArgs({
    ...
    String? requestId,
    List<ReservationComputeBeta>? reservations,
    ...
    RegionCommitmentTypeComputeBeta? type,
        ...
        plan =
            pulumi.Input.asOptionalInput<RegionCommitmentPlanComputeBeta>(plan),
        project = pulumi.Input.asOptionalInput<String>(project),
        region = pulumi.Input.asInput<String>(region),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        reservations =
            pulumi.Input.asOptionalInput<List<ReservationComputeBeta>>(
                reservations),
        resources =
        ...
        type =
            pulumi.Input.asOptionalInput<RegionCommitmentTypeComputeBeta>(type);
  ...
  factory RegionCommitmentComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentComputeBetaArgs(
      ...
      category: map['category'] == null
          ? null
          : RegionCommitmentCategoryComputeBeta.fromValue(
              map['category'] as String),
      description:
          map['description'] == null ? null : map['description'] as String,
      licenseResource: map['licenseResource'] == null
          ? null
          : LicenseResourceCommitmentComputeBeta.fromMap(
      ...
      plan: map['plan'] == null
          ? null
          : RegionCommitmentPlanComputeBeta.fromValue(map['plan'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservations: map['reservations'] == null
          ? null
          : pulumi.Input.decodeList<ReservationComputeBeta>(
              map['reservations'],
              (value) => ReservationComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      resources: map['resources'] == null
          ? null
          : pulumi.Input.decodeList<ResourceCommitmentComputeBeta>(
              map['resources'],
              (value) => ResourceCommitmentComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null
          ? null
          : RegionCommitmentTypeComputeBeta.fromValue(map['type'] as String),
    );
  }
}
