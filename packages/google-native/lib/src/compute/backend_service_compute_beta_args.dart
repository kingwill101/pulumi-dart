...
class BackendServiceComputeBetaArgs {
  ...
  BackendServiceComputeBetaArgs({
    ...
    BackendServiceCompressionModeComputeBeta? compressionMode,
    ...
    BackendServiceIpAddressSelectionPolicyComputeBeta? ipAddressSelectionPolicy,
    BackendServiceLoadBalancingSchemeComputeBeta? loadBalancingScheme,
    List<BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta>? localityLbPolicies,
    BackendServiceLocalityLbPolicyComputeBeta? localityLbPolicy,
    ...
    String? portName,
    String? project,
    BackendServiceProtocolComputeBeta? protocol,
    String? requestId,
    SecuritySettingsComputeBeta? securitySettings,
    List<String>? serviceBindings,
    String? serviceLbPolicy,
    BackendServiceSessionAffinityComputeBeta? sessionAffinity,
  ...
  factory BackendServiceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceComputeBetaArgs(
      ...
      compressionMode: map['compressionMode'] == null ? null : BackendServiceCompressionModeComputeBeta.fromValue(map['compressionMode'] as String),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : BackendServiceIpAddressSelectionPolicyComputeBeta.fromValue(map['ipAddressSelectionPolicy'] as String),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : BackendServiceLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : BackendServiceLocalityLbPolicyComputeBeta.fromValue(map['localityLbPolicy'] as String),
      ...
      protocol: map['protocol'] == null ? null : BackendServiceProtocolComputeBeta.fromValue(map['protocol'] as String),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : BackendServiceSessionAffinityComputeBeta.fromValue(map['sessionAffinity'] as String),
