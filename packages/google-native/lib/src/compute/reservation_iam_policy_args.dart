...
/// {@template pulumi_compute_alpha_reservation_iam_policy_args_doc}
/// The set of arguments for ReservationIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_reservation_iam_policy_args_doc}
class ReservationIamPolicyArgs {
  ...
  /// Creates a new [ReservationIamPolicyArgs].
  ...
  factory ReservationIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ReservationIamPolicyArgs(
