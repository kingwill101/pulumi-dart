...
class NetworkEndpointGroupArgs {
  ...
  NetworkEndpointGroupArgs({
    ...
    NetworkEndpointGroupClientPortMappingMode? clientPortMappingMode,
    ...
    String? name,
    String? network,
    NetworkEndpointGroupNetworkEndpointType? networkEndpointType,
    String? project,
  ...
  factory NetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupArgs(
      ...
      clientPortMappingMode: map['clientPortMappingMode'] == null ? null : NetworkEndpointGroupClientPortMappingMode.fromValue(map['clientPortMappingMode'] as String),
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : NetworkEndpointGroupNetworkEndpointType.fromValue(map['networkEndpointType'] as String),
      ...
      type: map['type'] == null ? null : NetworkEndpointGroupType.fromValue(map['type'] as String),
