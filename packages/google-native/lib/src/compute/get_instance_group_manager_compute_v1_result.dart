...
class GetInstanceGroupManagerComputeV1Result {
  /// The autohealing policy for this managed instance group. You can specify only one value.
  final List<InstanceGroupManagerAutoHealingPolicyResponseComputeV1>
      autoHealingPolicies;
  ...
  final InstanceGroupManagerInstanceLifecyclePolicyResponseComputeV1
  ...
  /// Creates a new [GetInstanceGroupManagerComputeV1Result].
  ...
  GetInstanceGroupManagerComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['autoHealingPolicies'] = pulumi.Input.encodeList<
        InstanceGroupManagerAutoHealingPolicyResponseComputeV1,
  ...
  factory GetInstanceGroupManagerComputeV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetInstanceGroupManagerComputeV1Result(
      autoHealingPolicies: pulumi.Input.decodeList<
              InstanceGroupManagerAutoHealingPolicyResponseComputeV1>(
          map['autoHealingPolicies'],
          (value) =>
              InstanceGroupManagerAutoHealingPolicyResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      baseInstanceName: map['baseInstanceName'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      currentActions:
          InstanceGroupManagerActionsSummaryResponseComputeV1.fromMap(
              (map['currentActions'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      distributionPolicy: DistributionPolicyResponseComputeV1.fromMap(
          (map['distributionPolicy'] as Map).cast<String, dynamic>()),
      fingerprint: map['fingerprint'] as String,
      instanceGroup: map['instanceGroup'] as String,
      instanceLifecyclePolicy:
          InstanceGroupManagerInstanceLifecyclePolicyResponseComputeV1.fromMap(
      ...
      statefulPolicy: StatefulPolicyResponseComputeV1.fromMap(
          (map['statefulPolicy'] as Map).cast<String, dynamic>()),
      status: InstanceGroupManagerStatusResponseComputeV1.fromMap(
          (map['status'] as Map).cast<String, dynamic>()),
      targetPools: (map['targetPools'] as List).cast<String>(),
      targetSize: map['targetSize'] as int,
      updatePolicy: InstanceGroupManagerUpdatePolicyResponseComputeV1.fromMap(
          (map['updatePolicy'] as Map).cast<String, dynamic>()),
      versions:
          pulumi.Input.decodeList<InstanceGroupManagerVersionResponseComputeV1>(
              map['versions'],
              (value) => InstanceGroupManagerVersionResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
