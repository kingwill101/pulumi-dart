...
class QueuedResourceStatusResponse {
  ...
  factory QueuedResourceStatusResponse.fromMap(Map<String, dynamic> map) {
    return QueuedResourceStatusResponse(
      failedData: QueuedResourceStatusFailedDataResponse.fromMap((map['failedData'] as Map).cast<String, dynamic>()),
      provisioningOperations: (map['provisioningOperations'] as List).cast<String>(),
