...
class GetMachineImageComputeBetaResult {
  ...
  final List<SourceDiskEncryptionKeyResponseComputeBeta>
  ...
  GetMachineImageComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['savedDisks'] = pulumi.Input.encodeList<SavedDiskResponseComputeBeta,
        Map<String, dynamic>>(savedDisks, (value) => value.toMap());
    map['selfLink'] = selfLink;
    map['sourceDiskEncryptionKeys'] = pulumi.Input.encodeList<
            SourceDiskEncryptionKeyResponseComputeBeta, Map<String, dynamic>>(
  ...
  factory GetMachineImageComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetMachineImageComputeBetaResult(
      ...
      instanceProperties: InstancePropertiesResponseComputeBeta.fromMap(
      ...
      savedDisks: pulumi.Input.decodeList<SavedDiskResponseComputeBeta>(
          map['savedDisks'],
          (value) => SavedDiskResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] as String,
      sourceDiskEncryptionKeys:
          pulumi.Input.decodeList<SourceDiskEncryptionKeyResponseComputeBeta>(
              map['sourceDiskEncryptionKeys'],
              (value) => SourceDiskEncryptionKeyResponseComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceProperties:
          SourceInstancePropertiesResponseComputeBeta.fromMap(
