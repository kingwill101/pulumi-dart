...
class RegionHealthCheckArgs {
  ...
  RegionHealthCheckArgs({
    ...
    int? unhealthyThreshold,
       ...
       grpcHealthCheck = pulumi.Input.asOptionalInput<GRPCHealthCheck>(
         grpcHealthCheck,
       ),
       ...
       httpHealthCheck = pulumi.Input.asOptionalInput<HTTPHealthCheck>(
         httpHealthCheck,
       ),
       ...
       sslHealthCheck = pulumi.Input.asOptionalInput<SSLHealthCheck>(
         sslHealthCheck,
       ),
       tcpHealthCheck = pulumi.Input.asOptionalInput<TCPHealthCheck>(
         tcpHealthCheck,
       ),
       timeoutSec = pulumi.Input.asOptionalInput<int>(timeoutSec),
       type = pulumi.Input.asOptionalInput<RegionHealthCheckType>(type),
       udpHealthCheck = pulumi.Input.asOptionalInput<UDPHealthCheck>(
         udpHealthCheck,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckType, String>(
            type,
            (value) => value.value,
          ),
      'udpHealthCheck':
          ?pulumi.Input.mapOptionalInputValue<
            UDPHealthCheck,
            Map<String, dynamic>
          >(udpHealthCheck, (value) => value.toMap()),
  ...
  factory RegionHealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckArgs(
      ...
      type: map['type'] == null
          ? null
          : RegionHealthCheckType.fromValue(map['type'] as String),
