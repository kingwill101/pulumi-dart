...
class RegionHealthCheckArgs {
  ...
  RegionHealthCheckArgs({
    ...
    int? unhealthyThreshold,
      ...
      type = pulumi.Input.asOptionalInput<RegionHealthCheckType>(type),
  ...
  factory RegionHealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckArgs(
      ...
      grpcHealthCheck: map['grpcHealthCheck'] == null ? null : GRPCHealthCheck.fromMap((map['grpcHealthCheck'] as Map).cast<String, dynamic>()),
      healthyThreshold: map['healthyThreshold'] == null ? null : map['healthyThreshold'] as int,
      http2HealthCheck: map['http2HealthCheck'] == null ? null : HTTP2HealthCheck.fromMap((map['http2HealthCheck'] as Map).cast<String, dynamic>()),
      httpHealthCheck: map['httpHealthCheck'] == null ? null : HTTPHealthCheck.fromMap((map['httpHealthCheck'] as Map).cast<String, dynamic>()),
      httpsHealthCheck: map['httpsHealthCheck'] == null ? null : HTTPSHealthCheck.fromMap((map['httpsHealthCheck'] as Map).cast<String, dynamic>()),
      ...
      sslHealthCheck: map['sslHealthCheck'] == null ? null : SSLHealthCheck.fromMap((map['sslHealthCheck'] as Map).cast<String, dynamic>()),
      tcpHealthCheck: map['tcpHealthCheck'] == null ? null : TCPHealthCheck.fromMap((map['tcpHealthCheck'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] == null ? null : map['timeoutSec'] as int,
      type: map['type'] == null ? null : RegionHealthCheckType.fromValue(map['type'] as String),
      udpHealthCheck: map['udpHealthCheck'] == null ? null : UDPHealthCheck.fromMap((map['udpHealthCheck'] as Map).cast<String, dynamic>()),
