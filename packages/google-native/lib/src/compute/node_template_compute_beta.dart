...
class NodeTemplateComputeBeta extends pulumi.CustomResource {
  late final pulumi.Output<List<AcceleratorConfigResponseComputeBeta>> accelerators;
  /// CPU overcommit.
  ...
  NodeTemplateComputeBeta(
    ...
    this.accelerators = registerOutput<List<AcceleratorConfigResponseComputeBeta>>('accelerators');
    ...
    this.nodeTypeFlexibility = registerOutput<NodeTemplateNodeTypeFlexibilityResponseComputeBeta>('nodeTypeFlexibility');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.serverBinding = registerOutput<ServerBindingResponseComputeBeta>('serverBinding');
