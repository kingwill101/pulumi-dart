...
class RegionHealthCheckServiceComputeBetaArgs {
  ...
  final pulumi
      .Input<RegionHealthCheckServiceHealthStatusAggregationPolicyComputeBeta>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (healthStatusAggregationStrategyValue != null) {
      map['healthStatusAggregationStrategy'] = pulumi.Input.mapOptionalInputValue<
          RegionHealthCheckServiceHealthStatusAggregationStrategyComputeBeta,
  ...
  factory RegionHealthCheckServiceComputeBetaArgs.fromMap(
    ...
    return RegionHealthCheckServiceComputeBetaArgs(
      ...
      healthStatusAggregationStrategy: map['healthStatusAggregationStrategy'] ==
          ...
          ? null
          : RegionHealthCheckServiceHealthStatusAggregationStrategyComputeBeta
              .fromValue(map['healthStatusAggregationStrategy'] as String),
