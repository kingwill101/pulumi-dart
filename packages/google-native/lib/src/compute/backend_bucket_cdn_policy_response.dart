...
class BackendBucketCdnPolicyResponse {
  ...
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse>
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyResponse>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['cacheKeyPolicy'] = cacheKeyPolicy.toMap();
    ...
    map['signedUrlKeyNames'] = signedUrlKeyNames;
    return map;
  }
  ...
  factory BackendBucketCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponse(
      ...
      cacheKeyPolicy: BackendBucketCdnPolicyCacheKeyPolicyResponse.fromMap(
