...
class NetworkEndpointGroupCloudRunComputeBeta {
  ...
  /// Creates a new [NetworkEndpointGroupCloudRunComputeBeta].
  ...
  factory NetworkEndpointGroupCloudRunComputeBeta.fromMap(
