  ...
  Map<String, dynamic> toMap() {
    ...
    if (disksValue != null) {
      map['disks'] = pulumi.Input.mapOptionalInputValue<
              List<LocalDiskComputeBeta>, List<Map<String, dynamic>>>(
          disksValue,
          (value) => pulumi.Input.encodeList<LocalDiskComputeBeta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (nodeTypeFlexibilityValue != null) {
      map['nodeTypeFlexibility'] = pulumi.Input.mapOptionalInputValue<
              NodeTemplateNodeTypeFlexibilityComputeBeta, Map<String, dynamic>>(
