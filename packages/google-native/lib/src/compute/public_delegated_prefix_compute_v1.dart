...
class PublicDelegatedPrefixComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeV1>> publicDelegatedSubPrefixs;
  ...
  /// Creates a new [PublicDelegatedPrefixComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PublicDelegatedPrefixComputeV1]. {@macro pulumi_compute_v1_public_delegated_prefix_compute_v1_args_doc}
  ...
  PublicDelegatedPrefixComputeV1(
    ...
    this.publicDelegatedSubPrefixs = registerOutput<List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeV1>>('publicDelegatedSubPrefixs');
