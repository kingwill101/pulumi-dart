...
class BackendServiceComputeV1Args {
  ...
  BackendServiceComputeV1Args({
    ...
    BackendServiceCompressionModeComputeV1? compressionMode,
    ...
    BackendServiceLoadBalancingSchemeComputeV1? loadBalancingScheme,
    List<BackendServiceLocalityLoadBalancingPolicyConfigComputeV1>? localityLbPolicies,
    BackendServiceLocalityLbPolicyComputeV1? localityLbPolicy,
    ...
    String? portName,
    String? project,
    BackendServiceProtocolComputeV1? protocol,
    String? requestId,
    SecuritySettingsComputeV1? securitySettings,
    List<String>? serviceBindings,
    BackendServiceSessionAffinityComputeV1? sessionAffinity,
  ...
  factory BackendServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return BackendServiceComputeV1Args(
      ...
      backends: map['backends'] == null ? null : pulumi.Input.decodeList<BackendComputeV1>(map['backends'], (value) => BackendComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      cdnPolicy: map['cdnPolicy'] == null ? null : BackendServiceCdnPolicyComputeV1.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: map['circuitBreakers'] == null ? null : CircuitBreakersComputeV1.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] == null ? null : BackendServiceCompressionModeComputeV1.fromValue(map['compressionMode'] as String),
      connectionDraining: map['connectionDraining'] == null ? null : ConnectionDrainingComputeV1.fromMap((map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : BackendServiceConnectionTrackingPolicyComputeV1.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: map['consistentHash'] == null ? null : ConsistentHashLoadBalancerSettingsComputeV1.fromMap((map['consistentHash'] as Map).cast<String, dynamic>()),
      ...
      failoverPolicy: map['failoverPolicy'] == null ? null : BackendServiceFailoverPolicyComputeV1.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>()),
      healthChecks: map['healthChecks'] == null ? null : (map['healthChecks'] as List).cast<String>(),
      iap: map['iap'] == null ? null : BackendServiceIAPComputeV1.fromMap((map['iap'] as Map).cast<String, dynamic>()),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : BackendServiceLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme'] as String),
      localityLbPolicies: map['localityLbPolicies'] == null ? null : pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfigComputeV1>(map['localityLbPolicies'], (value) => BackendServiceLocalityLoadBalancingPolicyConfigComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] == null ? null : BackendServiceLocalityLbPolicyComputeV1.fromValue(map['localityLbPolicy'] as String),
      logConfig: map['logConfig'] == null ? null : BackendServiceLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      maxStreamDuration: map['maxStreamDuration'] == null ? null : DurationComputeV1.fromMap((map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      metadatas: map['metadatas'] == null ? null : (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      outlierDetection: map['outlierDetection'] == null ? null : OutlierDetectionComputeV1.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      portName: map['portName'] == null ? null : map['portName'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      protocol: map['protocol'] == null ? null : BackendServiceProtocolComputeV1.fromValue(map['protocol'] as String),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      securitySettings: map['securitySettings'] == null ? null : SecuritySettingsComputeV1.fromMap((map['securitySettings'] as Map).cast<String, dynamic>()),
      serviceBindings: map['serviceBindings'] == null ? null : (map['serviceBindings'] as List).cast<String>(),
      sessionAffinity: map['sessionAffinity'] == null ? null : BackendServiceSessionAffinityComputeV1.fromValue(map['sessionAffinity'] as String),
      subsetting: map['subsetting'] == null ? null : SubsettingComputeV1.fromMap((map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] == null ? null : map['timeoutSec'] as int,
      usedBy: map['usedBy'] == null ? null : pulumi.Input.decodeList<BackendServiceUsedByComputeV1>(map['usedBy'], (value) => BackendServiceUsedByComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
