...
class BackendServiceComputeV1Args {
  ...
  BackendServiceComputeV1Args({
    ...
    List<BackendServiceUsedByComputeV1>? usedBy,
       ...
       backends = pulumi.Input.asOptionalInput<List<BackendComputeV1>>(
         backends,
       ),
       cdnPolicy = pulumi
           .Input.asOptionalInput<BackendServiceCdnPolicyComputeV1>(cdnPolicy),
       ...
       localityLbPolicy =
           ...
           >(localityLbPolicy),
       logConfig = pulumi
           .Input.asOptionalInput<BackendServiceLogConfigComputeV1>(logConfig),
       ...
       outlierDetection = pulumi
           .Input.asOptionalInput<OutlierDetectionComputeV1>(outlierDetection),
       ...
       securitySettings = pulumi
           .Input.asOptionalInput<SecuritySettingsComputeV1>(securitySettings),
       ...
       subsetting = pulumi.Input.asOptionalInput<SubsettingComputeV1>(
         subsetting,
       ),
       timeoutSec = pulumi.Input.asOptionalInput<int>(timeoutSec),
       usedBy = pulumi
           .Input.asOptionalInput<List<BackendServiceUsedByComputeV1>>(usedBy);
  ...
  factory BackendServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return BackendServiceComputeV1Args(
      ...
      compressionMode: map['compressionMode'] == null
          ? null
          : BackendServiceCompressionModeComputeV1.fromValue(
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null
          ? null
          : BackendServiceLoadBalancingSchemeComputeV1.fromValue(
      ...
      localityLbPolicy: map['localityLbPolicy'] == null
          ? null
          : BackendServiceLocalityLbPolicyComputeV1.fromValue(
      ...
      protocol: map['protocol'] == null
          ? null
          : BackendServiceProtocolComputeV1.fromValue(
      ...
      sessionAffinity: map['sessionAffinity'] == null
          ? null
          : BackendServiceSessionAffinityComputeV1.fromValue(
