...
/// {@template pulumi_compute_alpha_target_grpc_proxy_args_doc}
/// The set of arguments for TargetGrpcProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_target_grpc_proxy_args_doc}
class TargetGrpcProxyArgs {
  ...
  TargetGrpcProxyArgs({
    ...
    bool? validateForProxyless,
       ...
       validateForProxyless = pulumi.Input.asOptionalInput<bool>(
         validateForProxyless,
       );
  ...
  factory TargetGrpcProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetGrpcProxyArgs(
      ...
      validateForProxyless: map['validateForProxyless'] == null
          ? null
          : map['validateForProxyless'] as bool,
    );
  }
}
