...
import 'backend_response_compute_beta.dart';
...
import 'backend_service_locality_load_balancing_policy_config_response_compute_beta.dart';
import 'backend_service_log_config_response_compute_beta.dart';
import 'backend_service_used_by_response_compute_beta.dart';
...
class GetRegionBackendServiceComputeBetaResult {
  ...
  final List<BackendResponseComputeBeta> backends;
  /// Cloud CDN configuration for this BackendService. Only available for specified load balancer types.
  final BackendServiceCdnPolicyResponseComputeBeta cdnPolicy;
  final CircuitBreakersResponseComputeBeta circuitBreakers;
  /// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
  final String compressionMode;
  final ConnectionDrainingResponseComputeBeta connectionDraining;
  /// Connection Tracking configuration for this BackendService. Connection tracking policy settings are only available for Network Load Balancing and Internal TCP/UDP Load Balancing.
  final BackendServiceConnectionTrackingPolicyResponseComputeBeta connectionTrackingPolicy;
  ...
  final ConsistentHashLoadBalancerSettingsResponseComputeBeta consistentHash;
  ...
  final BackendServiceFailoverPolicyResponseComputeBeta failoverPolicy;
  ...
  final BackendServiceIAPResponseComputeBeta iap;
  ...
  final List<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeBeta> localityLbPolicies;
  ...
  final OutlierDetectionResponseComputeBeta outlierDetection;
  ...
  final SecuritySettingsResponseComputeBeta securitySettings;
  ...
  final SubsettingResponseComputeBeta subsetting;
  /// The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration.
  final int timeoutSec;
  final List<BackendServiceUsedByResponseComputeBeta> usedBy;

  /// Creates a new [GetRegionBackendServiceComputeBetaResult].
  ...
  /// [usedBy] Required.
  GetRegionBackendServiceComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'backends': pulumi.Input.encodeList<BackendResponseComputeBeta, Map<String, dynamic>>(backends, (value) => value.toMap()),
      ...
      'localityLbPolicies': pulumi.Input.encodeList<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeBeta, Map<String, dynamic>>(localityLbPolicies, (value) => value.toMap()),
      ...
      'usedBy': pulumi.Input.encodeList<BackendServiceUsedByResponseComputeBeta, Map<String, dynamic>>(usedBy, (value) => value.toMap()),
    };
  }

  factory GetRegionBackendServiceComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceComputeBetaResult(
      affinityCookieTtlSec: map['affinityCookieTtlSec'] as int,
      backends: pulumi.Input.decodeList<BackendResponseComputeBeta>(map['backends'], (value) => BackendResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      cdnPolicy: BackendServiceCdnPolicyResponseComputeBeta.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: CircuitBreakersResponseComputeBeta.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] as String,
      connectionDraining: ConnectionDrainingResponseComputeBeta.fromMap((map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy: BackendServiceConnectionTrackingPolicyResponseComputeBeta.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: ConsistentHashLoadBalancerSettingsResponseComputeBeta.fromMap((map['consistentHash'] as Map).cast<String, dynamic>()),
      ...
      failoverPolicy: BackendServiceFailoverPolicyResponseComputeBeta.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>()),
      fingerprint: map['fingerprint'] as String,
      healthChecks: (map['healthChecks'] as List).cast<String>(),
      iap: BackendServiceIAPResponseComputeBeta.fromMap((map['iap'] as Map).cast<String, dynamic>()),
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] as String,
      kind: map['kind'] as String,
      loadBalancingScheme: map['loadBalancingScheme'] as String,
      localityLbPolicies: pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeBeta>(map['localityLbPolicies'], (value) => BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] as String,
      logConfig: BackendServiceLogConfigResponseComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      maxStreamDuration: DurationResponseComputeBeta.fromMap((map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      metadatas: (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] as String,
      network: map['network'] as String,
      outlierDetection: OutlierDetectionResponseComputeBeta.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>()),
      port: map['port'] as int,
      portName: map['portName'] as String,
      protocol: map['protocol'] as String,
      region: map['region'] as String,
      securityPolicy: map['securityPolicy'] as String,
      securitySettings: SecuritySettingsResponseComputeBeta.fromMap((map['securitySettings'] as Map).cast<String, dynamic>()),
      ...
      subsetting: SubsettingResponseComputeBeta.fromMap((map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] as int,
      usedBy: pulumi.Input.decodeList<BackendServiceUsedByResponseComputeBeta>(map['usedBy'], (value) => BackendServiceUsedByResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
