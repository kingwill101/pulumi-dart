...
class GetRegionBackendServiceComputeBetaResult {
  ...
  final BackendServiceConnectionTrackingPolicyResponseComputeBeta
  ...
  final List<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeBeta>
      localityLbPolicies;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['backends'] = pulumi.Input.encodeList<BackendResponseComputeBeta,
    ...
    map['connectionDraining'] = connectionDraining.toMap();
    map['connectionTrackingPolicy'] = connectionTrackingPolicy.toMap();
    map['consistentHash'] = consistentHash.toMap();
    ...
    map['failoverPolicy'] = failoverPolicy.toMap();
    ...
    map['name'] = name;
    map['network'] = network;
    map['outlierDetection'] = outlierDetection.toMap();
    map['port'] = port;
    map['portName'] = portName;
    map['protocol'] = protocol;
    map['region'] = region;
    map['securityPolicy'] = securityPolicy;
    map['securitySettings'] = securitySettings.toMap();
    map['selfLink'] = selfLink;
    map['serviceBindings'] = serviceBindings;
    ...
    map['usedBy'] = pulumi.Input.encodeList<
        BackendServiceUsedByResponseComputeBeta,
        Map<String, dynamic>>(usedBy, (value) => value.toMap());
    return map;
  }

  factory GetRegionBackendServiceComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetRegionBackendServiceComputeBetaResult(
      affinityCookieTtlSec: map['affinityCookieTtlSec'] as int,
      backends: pulumi.Input.decodeList<BackendResponseComputeBeta>(
          map['backends'],
          (value) => BackendResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
      cdnPolicy: BackendServiceCdnPolicyResponseComputeBeta.fromMap(
          (map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: CircuitBreakersResponseComputeBeta.fromMap(
          (map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] as String,
      connectionDraining: ConnectionDrainingResponseComputeBeta.fromMap(
          (map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy:
          BackendServiceConnectionTrackingPolicyResponseComputeBeta.fromMap(
              (map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash:
          ConsistentHashLoadBalancerSettingsResponseComputeBeta.fromMap(
      ...
      failoverPolicy: BackendServiceFailoverPolicyResponseComputeBeta.fromMap(
          (map['failoverPolicy'] as Map).cast<String, dynamic>()),
      fingerprint: map['fingerprint'] as String,
      healthChecks: (map['healthChecks'] as List).cast<String>(),
      iap: BackendServiceIAPResponseComputeBeta.fromMap(
      ...
      logConfig: BackendServiceLogConfigResponseComputeBeta.fromMap(
          (map['logConfig'] as Map).cast<String, dynamic>()),
      maxStreamDuration: DurationResponseComputeBeta.fromMap(
          (map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      metadatas: (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] as String,
      network: map['network'] as String,
      outlierDetection: OutlierDetectionResponseComputeBeta.fromMap(
      ...
      securitySettings: SecuritySettingsResponseComputeBeta.fromMap(
      ...
      subsetting: SubsettingResponseComputeBeta.fromMap(
          (map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] as int,
      usedBy: pulumi.Input.decodeList<BackendServiceUsedByResponseComputeBeta>(
          map['usedBy'],
          (value) => BackendServiceUsedByResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
