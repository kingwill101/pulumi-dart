...
class GetNetworkFirewallPolicyComputeBetaResult {
  ...
  /// Creates a new [GetNetworkFirewallPolicyComputeBetaResult].
  ...
  GetNetworkFirewallPolicyComputeBetaResult({
  ...
  factory GetNetworkFirewallPolicyComputeBetaResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetNetworkFirewallPolicyComputeBetaResult(
      associations:
