...
/// {@template pulumi_compute_alpha_network_attachment_iam_binding_args_doc}
/// The set of arguments for NetworkAttachmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_network_attachment_iam_binding_args_doc}
class NetworkAttachmentIamBindingArgs {
  ...
  /// Creates a new [NetworkAttachmentIamBindingArgs].
  ...
  NetworkAttachmentIamBindingArgs({
    Condition? condition,
  ...
  factory NetworkAttachmentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamBindingArgs(
