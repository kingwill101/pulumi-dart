...
class SslPolicyComputeV1Args {
  ...
  SslPolicyComputeV1Args({
    ...
    String? requestId,
      ...
      minTlsVersion = pulumi.Input.asOptionalInput<SslPolicyMinTlsVersionComputeV1>(minTlsVersion),
      name = pulumi.Input.asOptionalInput<String>(name),
      profile = pulumi.Input.asOptionalInput<SslPolicyProfileComputeV1>(profile),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<SslPolicyMinTlsVersionComputeV1, String>(minTlsVersion, (value) => value.value),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<SslPolicyProfileComputeV1, String>(profile, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
    };
  }
  ...
  factory SslPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SslPolicyComputeV1Args(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : SslPolicyMinTlsVersionComputeV1.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null ? null : SslPolicyProfileComputeV1.fromValue(map['profile'] as String),
