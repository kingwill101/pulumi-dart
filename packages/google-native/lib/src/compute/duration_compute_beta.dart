...
class DurationComputeBeta {
  ...
  /// Creates a new [DurationComputeBeta].
  ...
  DurationComputeBeta({this.nanos, this.seconds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'nanos': ?nanos, 'seconds': ?seconds};
  }

  factory DurationComputeBeta.fromMap(Map<String, dynamic> map) {
    return DurationComputeBeta(
