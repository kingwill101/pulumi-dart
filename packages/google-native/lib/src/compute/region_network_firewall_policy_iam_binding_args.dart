...
/// {@template pulumi_compute_alpha_region_network_firewall_policy_iam_binding_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_network_firewall_policy_iam_binding_args_doc}
class RegionNetworkFirewallPolicyIamBindingArgs {
  ...
  /// Creates a new [RegionNetworkFirewallPolicyIamBindingArgs].
  ...
  RegionNetworkFirewallPolicyIamBindingArgs({
    Condition? condition,
  ...
  factory RegionNetworkFirewallPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamBindingArgs(
