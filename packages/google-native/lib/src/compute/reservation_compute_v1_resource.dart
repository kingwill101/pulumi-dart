...
import 'reservation_compute_v1_args.dart';
import 'share_settings_response_compute_v1.dart';

/// Creates a new reservation. For more information, read Reserving zonal resources.
class ReservationComputeV1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AllocationResourceStatusResponseComputeV1>
  resourceStatus;
  ...
  late final pulumi.Output<AllocationSpecificSKUReservationResponseComputeV1>
  specificReservation;
  ...
  /// Creates a new [ReservationComputeV1Resource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ReservationComputeV1Resource]. {@macro pulumi_compute_v1_reservation_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ReservationComputeV1Resource(
    String name, {
    ReservationComputeV1Args? args,
    ...
    this.resourcePolicies = registerOutput<Map<String, String>>(
      'resourcePolicies',
    );
    this.resourceStatus =
        registerOutput<AllocationResourceStatusResponseComputeV1>(
          'resourceStatus',
        );
    ...
    this.specificReservationRequired = registerOutput<bool>(
