...
class SSLHealthCheckComputeBeta {
  ...
  factory SSLHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheckComputeBeta(
      ...
      portSpecification: map['portSpecification'] == null ? null : SSLHealthCheckPortSpecificationComputeBeta.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : SSLHealthCheckProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String),
