...
class BackendServiceConnectionTrackingPolicy {
  ...
  final BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends?
  ...
  factory BackendServiceConnectionTrackingPolicy.fromMap(
    ...
    return BackendServiceConnectionTrackingPolicy(
      connectionPersistenceOnUnhealthyBackends:
          ...
          ? null
          : BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends.fromValue(
      ...
      trackingMode: map['trackingMode'] == null
          ? null
          : BackendServiceConnectionTrackingPolicyTrackingMode.fromValue(
