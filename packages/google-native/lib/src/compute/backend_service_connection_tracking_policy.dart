...
class BackendServiceConnectionTrackingPolicy {
  ...
  final BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends? connectionPersistenceOnUnhealthyBackends;
  ...
  final BackendServiceConnectionTrackingPolicyTrackingMode? trackingMode;
  ...
  factory BackendServiceConnectionTrackingPolicy.fromMap(Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicy(
      connectionPersistenceOnUnhealthyBackends: map['connectionPersistenceOnUnhealthyBackends'] == null ? null : BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends.fromValue(map['connectionPersistenceOnUnhealthyBackends'] as String),
      ...
      trackingMode: map['trackingMode'] == null ? null : BackendServiceConnectionTrackingPolicyTrackingMode.fromValue(map['trackingMode'] as String),
    );
  }
}
