...
class MachineImageComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InstancePropertiesResponseComputeV1>
  instanceProperties;
  ...
  late final pulumi.Output<List<SourceDiskEncryptionKeyResponseComputeV1>>
  ...
  late final pulumi.Output<SourceInstancePropertiesResponseComputeV1>
  ...
  MachineImageComputeV1(
    ...
    this.instanceProperties =
        registerOutput<InstancePropertiesResponseComputeV1>(
          'instanceProperties',
        );
    ...
    this.savedDisks = registerOutput<List<SavedDiskResponseComputeV1>>(
      'savedDisks',
    );
    this.selfLink = registerOutput<String>('selfLink');
    this.sourceDiskEncryptionKeys =
        registerOutput<List<SourceDiskEncryptionKeyResponseComputeV1>>(
          'sourceDiskEncryptionKeys',
        );
