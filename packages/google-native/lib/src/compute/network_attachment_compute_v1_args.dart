...
class NetworkAttachmentComputeV1Args {
  final pulumi.Input<NetworkAttachmentConnectionPreferenceComputeV1>?
  ...
  NetworkAttachmentComputeV1Args({
    ...
    List<String>? subnetworks,
           ...
           pulumi.Input.asOptionalInput<
             NetworkAttachmentConnectionPreferenceComputeV1
           >(connectionPreference),
    ...
    return <String, dynamic>{
      'connectionPreference':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkAttachmentConnectionPreferenceComputeV1,
            String
          >(connectionPreference, (value) => value.value),
  ...
  factory NetworkAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentComputeV1Args(
      connectionPreference: map['connectionPreference'] == null
          ? null
          : NetworkAttachmentConnectionPreferenceComputeV1.fromValue(
