...
class GetRegionHealthCheckComputeBetaResult {
  ...
  final GRPCHealthCheckResponseComputeBeta grpcHealthCheck;

  /// A so-far unhealthy instance will be marked healthy after this many consecutive successes. The default value is 2.
  final int healthyThreshold;
  final HTTP2HealthCheckResponseComputeBeta http2HealthCheck;
  final HTTPHealthCheckResponseComputeBeta httpHealthCheck;
  final HTTPSHealthCheckResponseComputeBeta httpsHealthCheck;

  /// Type of the resource.
  final String kind;

  /// Configure logging on this health check.
  final HealthCheckLogConfigResponseComputeBeta logConfig;
  ...
  final SSLHealthCheckResponseComputeBeta sslHealthCheck;
  final TCPHealthCheckResponseComputeBeta tcpHealthCheck;
  ...
  /// Creates a new [GetRegionHealthCheckComputeBetaResult].
  ...
  GetRegionHealthCheckComputeBetaResult({
  ...
  factory GetRegionHealthCheckComputeBetaResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRegionHealthCheckComputeBetaResult(
      checkIntervalSec: map['checkIntervalSec'] as int,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      grpcHealthCheck: GRPCHealthCheckResponseComputeBeta.fromMap(
        (map['grpcHealthCheck'] as Map).cast<String, dynamic>(),
      ),
      healthyThreshold: map['healthyThreshold'] as int,
      http2HealthCheck: HTTP2HealthCheckResponseComputeBeta.fromMap(
        (map['http2HealthCheck'] as Map).cast<String, dynamic>(),
      ),
      httpHealthCheck: HTTPHealthCheckResponseComputeBeta.fromMap(
        (map['httpHealthCheck'] as Map).cast<String, dynamic>(),
      ),
      httpsHealthCheck: HTTPSHealthCheckResponseComputeBeta.fromMap(
        (map['httpsHealthCheck'] as Map).cast<String, dynamic>(),
      ),
      kind: map['kind'] as String,
      logConfig: HealthCheckLogConfigResponseComputeBeta.fromMap(
        (map['logConfig'] as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      sslHealthCheck: SSLHealthCheckResponseComputeBeta.fromMap(
        (map['sslHealthCheck'] as Map).cast<String, dynamic>(),
      ),
      tcpHealthCheck: TCPHealthCheckResponseComputeBeta.fromMap(
