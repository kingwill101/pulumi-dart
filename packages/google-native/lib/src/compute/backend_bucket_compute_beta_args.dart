...
class BackendBucketComputeBetaArgs {
  ...
  factory BackendBucketComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendBucketComputeBetaArgs(
      ...
      cdnPolicy: map['cdnPolicy'] == null ? null : BackendBucketCdnPolicyComputeBeta.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] == null ? null : BackendBucketCompressionModeComputeBeta.fromValue(map['compressionMode'] as String),
