...
import 'global_public_delegated_prefix_compute_beta_args.dart';
import 'public_delegated_prefix_public_delegated_sub_prefix_response_compute_beta.dart';

/// Creates a global PublicDelegatedPrefix in the specified project using the parameters that are included in the request.
class GlobalPublicDelegatedPrefixComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [GlobalPublicDelegatedPrefixComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GlobalPublicDelegatedPrefixComputeBeta]. {@macro pulumi_compute_beta_global_public_delegated_prefix_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GlobalPublicDelegatedPrefixComputeBeta(
    String name, {
    GlobalPublicDelegatedPrefixComputeBetaArgs? args,
