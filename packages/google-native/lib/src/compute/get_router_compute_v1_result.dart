...
class GetRouterComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bgp'] = bgp.toMap();
    map['bgpPeers'] = pulumi.Input.encodeList<RouterBgpPeerResponseComputeV1,
        Map<String, dynamic>>(bgpPeers, (value) => value.toMap());
    map['creationTimestamp'] = creationTimestamp;
    map['description'] = description;
    map['encryptedInterconnectRouter'] = encryptedInterconnectRouter;
    map['interfaces'] = pulumi.Input.encodeList<
        RouterInterfaceResponseComputeV1,
    ...
    map['name'] = name;
    map['nats'] = pulumi.Input.encodeList<RouterNatResponseComputeV1,
        Map<String, dynamic>>(nats, (value) => value.toMap());
    map['network'] = network;
    map['region'] = region;
  ...
  factory GetRouterComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRouterComputeV1Result(
      bgp: RouterBgpResponseComputeV1.fromMap(
          (map['bgp'] as Map).cast<String, dynamic>()),
      bgpPeers: pulumi.Input.decodeList<RouterBgpPeerResponseComputeV1>(
          map['bgpPeers'],
          (value) => RouterBgpPeerResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      encryptedInterconnectRouter: map['encryptedInterconnectRouter'] as bool,
      interfaces: pulumi.Input.decodeList<RouterInterfaceResponseComputeV1>(
          map['interfaces'],
          (value) => RouterInterfaceResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      kind: map['kind'] as String,
      md5AuthenticationKeys:
          pulumi.Input.decodeList<RouterMd5AuthenticationKeyResponseComputeV1>(
              map['md5AuthenticationKeys'],
              (value) => RouterMd5AuthenticationKeyResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      nats: pulumi.Input.decodeList<RouterNatResponseComputeV1>(
          map['nats'],
          (value) => RouterNatResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
