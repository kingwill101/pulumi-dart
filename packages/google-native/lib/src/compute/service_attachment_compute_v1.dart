...
class ServiceAttachmentComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ServiceAttachmentConnectedEndpointResponseComputeV1>> connectedEndpoints;
  /// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
  late final pulumi.Output<String> connectionPreference;
  /// Projects that are allowed to connect to this service attachment.
  late final pulumi.Output<List<ServiceAttachmentConsumerProjectLimitResponseComputeV1>> consumerAcceptLists;
  ...
  ServiceAttachmentComputeV1(
    ...
    this.connectedEndpoints = registerOutput<List<ServiceAttachmentConnectedEndpointResponseComputeV1>>('connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists = registerOutput<List<ServiceAttachmentConsumerProjectLimitResponseComputeV1>>('consumerAcceptLists');
    ...
    this.pscServiceAttachmentId = registerOutput<Uint128ResponseComputeV1>('pscServiceAttachmentId');
