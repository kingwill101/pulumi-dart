...
class VpnGatewayComputeBetaArgs {
  ...
  final pulumi.Input<List<VpnGatewayVpnGatewayInterfaceComputeBeta>>?
      vpnInterfaces;
  ...
  VpnGatewayComputeBetaArgs({
    String? description,
    VpnGatewayGatewayIpVersionComputeBeta? gatewayIpVersion,
    ...
    String? requestId,
    VpnGatewayStackTypeComputeBeta? stackType,
    List<VpnGatewayVpnGatewayInterfaceComputeBeta>? vpnInterfaces,
  })  : description = pulumi.Input.asOptionalInput<String>(description),
        gatewayIpVersion =
            pulumi.Input.asOptionalInput<VpnGatewayGatewayIpVersionComputeBeta>(
                gatewayIpVersion),
        ...
        stackType =
            pulumi.Input.asOptionalInput<VpnGatewayStackTypeComputeBeta>(
                stackType),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (gatewayIpVersionValue != null) {
      map['gatewayIpVersion'] = pulumi.Input.mapOptionalInputValue<
          VpnGatewayGatewayIpVersionComputeBeta,
          String>(gatewayIpVersionValue, (value) => value.value);
    }
    ...
    if (stackTypeValue != null) {
      map['stackType'] = pulumi.Input.mapOptionalInputValue<
          VpnGatewayStackTypeComputeBeta,
    ...
    if (vpnInterfacesValue != null) {
      map['vpnInterfaces'] = pulumi.Input.mapOptionalInputValue<
              List<VpnGatewayVpnGatewayInterfaceComputeBeta>,
  ...
  factory VpnGatewayComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return VpnGatewayComputeBetaArgs(
      ...
      gatewayIpVersion: map['gatewayIpVersion'] == null
          ? null
          : VpnGatewayGatewayIpVersionComputeBeta.fromValue(
      ...
      stackType: map['stackType'] == null
          ? null
          : VpnGatewayStackTypeComputeBeta.fromValue(
              map['stackType'] as String),
      vpnInterfaces: map['vpnInterfaces'] == null
          ? null
          : pulumi.Input.decodeList<VpnGatewayVpnGatewayInterfaceComputeBeta>(
              map['vpnInterfaces'],
              (value) => VpnGatewayVpnGatewayInterfaceComputeBeta.fromMap(
