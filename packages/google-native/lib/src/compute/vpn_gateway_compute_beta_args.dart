...
class VpnGatewayComputeBetaArgs {
  ...
  factory VpnGatewayComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return VpnGatewayComputeBetaArgs(
      ...
      gatewayIpVersion: map['gatewayIpVersion'] == null ? null : VpnGatewayGatewayIpVersionComputeBeta.fromValue(map['gatewayIpVersion'] as String),
      ...
      stackType: map['stackType'] == null ? null : VpnGatewayStackTypeComputeBeta.fromValue(map['stackType'] as String),
      vpnInterfaces: map['vpnInterfaces'] == null ? null : pulumi.Input.decodeList<VpnGatewayVpnGatewayInterfaceComputeBeta>(map['vpnInterfaces'], (value) => VpnGatewayVpnGatewayInterfaceComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
