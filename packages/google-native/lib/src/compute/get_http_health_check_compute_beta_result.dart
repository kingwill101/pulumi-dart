...
class GetHttpHealthCheckComputeBetaResult {
  ...
  /// Creates a new [GetHttpHealthCheckComputeBetaResult].
  ...
  /// [kind] Type of the resource. Always compute#httpHealthCheck for HTTP health checks.
  ...
  GetHttpHealthCheckComputeBetaResult({
  ...
  factory GetHttpHealthCheckComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetHttpHealthCheckComputeBetaResult(
