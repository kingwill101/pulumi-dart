...
import 'network_compute_beta_args.dart';
...
class NetworkComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkPeeringResponseComputeBeta>> peerings;
  ...
  late final pulumi.Output<NetworkRoutingConfigResponseComputeBeta> routingConfig;
  ...
  /// Creates a new [NetworkComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NetworkComputeBeta]. {@macro pulumi_compute_beta_network_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  NetworkComputeBeta(
    String name, {
    NetworkComputeBetaArgs? args,
    ...
    this.networkFirewallPolicyEnforcementOrder = registerOutput<String>('networkFirewallPolicyEnforcementOrder');
    this.peerings = registerOutput<List<NetworkPeeringResponseComputeBeta>>('peerings');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.routingConfig = registerOutput<NetworkRoutingConfigResponseComputeBeta>('routingConfig');
