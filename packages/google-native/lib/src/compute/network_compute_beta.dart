...
class NetworkComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NetworkRoutingConfigResponseComputeBeta>
  routingConfig;
  ...
  NetworkComputeBeta(
    ...
    this.peerings = registerOutput<List<NetworkPeeringResponseComputeBeta>>(
      'peerings',
    );
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.routingConfig =
        registerOutput<NetworkRoutingConfigResponseComputeBeta>(
          'routingConfig',
        );
