...
class AttachedDiskComputeBeta {
  ...
  factory AttachedDiskComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskComputeBeta(
      ...
      initializeParams: map['initializeParams'] == null ? null : AttachedDiskInitializeParamsComputeBeta.fromMap((map['initializeParams'] as Map).cast<String, dynamic>()),
      interface: map['interface'] == null ? null : AttachedDiskInterfaceComputeBeta.fromValue(map['interface'] as String),
      mode: map['mode'] == null ? null : AttachedDiskModeComputeBeta.fromValue(map['mode'] as String),
      savedState: map['savedState'] == null ? null : AttachedDiskSavedStateComputeBeta.fromValue(map['savedState'] as String),
      source: map['source'] == null ? null : map['source'] as String,
      type: map['type'] == null ? null : AttachedDiskTypeComputeBeta.fromValue(map['type'] as String),
    );
  }
}
