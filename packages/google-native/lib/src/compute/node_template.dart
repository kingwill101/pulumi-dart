...
class NodeTemplate extends pulumi.CustomResource {
  ...
  NodeTemplate(
    ...
    this.accelerators = registerOutput<List<AcceleratorConfigResponse>>('accelerators');
    ...
    this.nodeTypeFlexibility = registerOutput<NodeTemplateNodeTypeFlexibilityResponse>('nodeTypeFlexibility');
