...
import 'target_grpc_proxy_compute_beta_args.dart';

/// Creates a TargetGrpcProxy in the specified project in the given scope using the parameters that are included in the request.
class TargetGrpcProxyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetGrpcProxyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetGrpcProxyComputeBeta]. {@macro pulumi_compute_beta_target_grpc_proxy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetGrpcProxyComputeBeta(
    String name, {
    TargetGrpcProxyComputeBetaArgs? args,
