...
class BackendComputeBeta {
  ...
  final BackendBalancingModeComputeBeta? balancingMode;
  ...
  final BackendPreferenceComputeBeta? preference;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'balancingMode': ?balancingMode == null ? null : balancingMode!.value,
      ...
      'preference': ?preference == null ? null : preference!.value,
    };
  }

  factory BackendComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendComputeBeta(
      balancingMode: map['balancingMode'] == null ? null : BackendBalancingModeComputeBeta.fromValue(map['balancingMode'] as String),
      ...
      preference: map['preference'] == null ? null : BackendPreferenceComputeBeta.fromValue(map['preference'] as String),
    );
  }
}
