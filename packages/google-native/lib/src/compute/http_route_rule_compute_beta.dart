...
import 'http_filter_config_compute_beta.dart';
...
import 'http_route_rule_match_compute_beta.dart';

/// The HttpRouteRule setting specifies how to match an HTTP request and the corresponding routing action that load balancing proxies perform.
class HttpRouteRuleComputeBeta {
  ...
  final List<HttpFilterConfigComputeBeta>? httpFilterConfigs;
  ...
  final List<HttpFilterConfigComputeBeta>? httpFilterMetadata;

  /// The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
  final List<HttpRouteRuleMatchComputeBeta>? matchRules;
  ...
  /// Creates a new [HttpRouteRuleComputeBeta].
  ...
  factory HttpRouteRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleComputeBeta(
      ...
      httpFilterConfigs: map['httpFilterConfigs'] == null
          ? null
          : pulumi.Input.decodeList<HttpFilterConfigComputeBeta>(
              map['httpFilterConfigs'],
              (value) => HttpFilterConfigComputeBeta.fromMap(
      ...
      matchRules: map['matchRules'] == null
          ? null
          : pulumi.Input.decodeList<HttpRouteRuleMatchComputeBeta>(
              map['matchRules'],
              (value) => HttpRouteRuleMatchComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
