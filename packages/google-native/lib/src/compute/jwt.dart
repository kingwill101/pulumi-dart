...
class Jwt {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jwtHeaders': ?jwtHeaders == null ? null : pulumi.Input.encodeList<JwtHeader, Map<String, dynamic>>(jwtHeaders!, (value) => value.toMap()),
      'jwtParams': ?jwtParams,
    };
  }
  ...
  factory Jwt.fromMap(Map<String, dynamic> map) {
    return Jwt(
      ...
      jwksPublicKeys: map['jwksPublicKeys'] == null ? null : map['jwksPublicKeys'] as String,
      jwtHeaders: map['jwtHeaders'] == null ? null : pulumi.Input.decodeList<JwtHeader>(map['jwtHeaders'], (value) => JwtHeader.fromMap((value as Map).cast<String, dynamic>())),
      jwtParams: map['jwtParams'] == null ? null : (map['jwtParams'] as List).cast<String>(),
    );
  }
}
