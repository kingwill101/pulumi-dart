...
/// {@template pulumi_compute_v1_region_backend_service_iam_binding_compute_v1_args_doc}
/// The set of arguments for RegionBackendServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_backend_service_iam_binding_compute_v1_args_doc}
class RegionBackendServiceIamBindingComputeV1Args {
  ...
  /// Creates a new [RegionBackendServiceIamBindingComputeV1Args].
  ...
  RegionBackendServiceIamBindingComputeV1Args({
    Condition? condition,
  ...
  factory RegionBackendServiceIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceIamBindingComputeV1Args(
