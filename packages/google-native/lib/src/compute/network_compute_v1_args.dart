...
class NetworkComputeV1Args {
  ...
  final pulumi.Input<NetworkNetworkFirewallPolicyEnforcementOrderComputeV1>? networkFirewallPolicyEnforcementOrder;
  ...
  NetworkComputeV1Args({
    ...
    int? mtu,
    String? name,
    NetworkNetworkFirewallPolicyEnforcementOrderComputeV1? networkFirewallPolicyEnforcementOrder,
    String? project,
    String? requestId,
    NetworkRoutingConfigComputeV1? routingConfig,
      ...
      networkFirewallPolicyEnforcementOrder = pulumi.Input.asOptionalInput<NetworkNetworkFirewallPolicyEnforcementOrderComputeV1>(networkFirewallPolicyEnforcementOrder),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      routingConfig = pulumi.Input.asOptionalInput<NetworkRoutingConfigComputeV1>(routingConfig);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mtu': ?mtu,
      'name': ?name,
      'networkFirewallPolicyEnforcementOrder': ?pulumi.Input.mapOptionalInputValue<NetworkNetworkFirewallPolicyEnforcementOrderComputeV1, String>(networkFirewallPolicyEnforcementOrder, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
      'routingConfig': ?pulumi.Input.mapOptionalInputValue<NetworkRoutingConfigComputeV1, Map<String, dynamic>>(routingConfig, (value) => value.toMap()),
    };
  }
  ...
  factory NetworkComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkComputeV1Args(
      ...
      networkFirewallPolicyEnforcementOrder: map['networkFirewallPolicyEnforcementOrder'] == null ? null : NetworkNetworkFirewallPolicyEnforcementOrderComputeV1.fromValue(map['networkFirewallPolicyEnforcementOrder'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      routingConfig: map['routingConfig'] == null ? null : NetworkRoutingConfigComputeV1.fromMap((map['routingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
