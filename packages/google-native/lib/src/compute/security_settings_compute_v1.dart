...
class SecuritySettingsComputeV1 {
  ...
  final AWSV4SignatureComputeV1? awsV4Authentication;
  ...
  factory SecuritySettingsComputeV1.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsComputeV1(
      awsV4Authentication: map['awsV4Authentication'] == null ? null : AWSV4SignatureComputeV1.fromMap((map['awsV4Authentication'] as Map).cast<String, dynamic>()),
