...
class GetNodeTemplateResult {
  ...
  final List<LocalDiskResponse> disks;
  ...
  final NodeTemplateNodeTypeFlexibilityResponse nodeTypeFlexibility;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks': pulumi.Input.encodeList<LocalDiskResponse, Map<String, dynamic>>(disks, (value) => value.toMap()),
      'kind': kind,
      'name': name,
  ...
  factory GetNodeTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetNodeTemplateResult(
      ...
      disks: pulumi.Input.decodeList<LocalDiskResponse>(map['disks'], (value) => LocalDiskResponse.fromMap((value as Map).cast<String, dynamic>())),
      kind: map['kind'] as String,
      name: map['name'] as String,
      nodeAffinityLabels: (map['nodeAffinityLabels'] as Map).cast<String, String>(),
      nodeType: map['nodeType'] as String,
      nodeTypeFlexibility: NodeTemplateNodeTypeFlexibilityResponse.fromMap((map['nodeTypeFlexibility'] as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      selfLinkWithId: map['selfLinkWithId'] as String,
      serverBinding: ServerBindingResponse.fromMap((map['serverBinding'] as Map).cast<String, dynamic>()),
