...
class BackendServiceConnectionTrackingPolicyComputeBeta {
  ...
  final BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeBeta?
  ...
  final BackendServiceConnectionTrackingPolicyTrackingModeComputeBeta?
  trackingMode;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPersistenceOnUnhealthyBackends':
          ?connectionPersistenceOnUnhealthyBackends == null
          ? null
  ...
  factory BackendServiceConnectionTrackingPolicyComputeBeta.fromMap(
    ...
    return BackendServiceConnectionTrackingPolicyComputeBeta(
      connectionPersistenceOnUnhealthyBackends:
          ...
          ? null
          : BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeBeta.fromValue(
      ...
      trackingMode: map['trackingMode'] == null
          ? null
          : BackendServiceConnectionTrackingPolicyTrackingModeComputeBeta.fromValue(
