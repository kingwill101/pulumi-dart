...
class SubnetworkComputeBetaArgs {
  ...
  SubnetworkComputeBetaArgs({
    ...
    SubnetworkStackTypeComputeBeta? stackType,
       ...
       logConfig = pulumi.Input.asOptionalInput<SubnetworkLogConfigComputeBeta>(
         logConfig,
       ),
       ...
       purpose = pulumi.Input.asOptionalInput<SubnetworkPurposeComputeBeta>(
         purpose,
       ),
       ...
       secondaryIpRanges =
           ...
           >(secondaryIpRanges),
       stackType = pulumi.Input.asOptionalInput<SubnetworkStackTypeComputeBeta>(
         stackType,
       );
    ...
    return <String, dynamic>{
      ...
      'ipv6AccessType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(ipv6AccessType, (value) => value.value),
      'logConfig':
          ?pulumi.Input.mapOptionalInputValue<
