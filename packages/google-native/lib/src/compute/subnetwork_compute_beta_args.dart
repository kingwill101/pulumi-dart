...
class SubnetworkComputeBetaArgs {
  ...
  factory SubnetworkComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkComputeBetaArgs(
      allowSubnetCidrRoutesOverlap: map['allowSubnetCidrRoutesOverlap'] == null ? null : map['allowSubnetCidrRoutesOverlap'] as bool,
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : SubnetworkIpv6AccessTypeComputeBeta.fromValue(map['ipv6AccessType'] as String),
      logConfig: map['logConfig'] == null ? null : SubnetworkLogConfigComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      privateIpGoogleAccess: map['privateIpGoogleAccess'] == null ? null : map['privateIpGoogleAccess'] as bool,
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : SubnetworkPrivateIpv6GoogleAccessComputeBeta.fromValue(map['privateIpv6GoogleAccess'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null ? null : SubnetworkPurposeComputeBeta.fromValue(map['purpose'] as String),
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservedInternalRange: map['reservedInternalRange'] == null ? null : map['reservedInternalRange'] as String,
      role: map['role'] == null ? null : SubnetworkRoleComputeBeta.fromValue(map['role'] as String),
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : pulumi.Input.decodeList<SubnetworkSecondaryRangeComputeBeta>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryRangeComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      stackType: map['stackType'] == null ? null : SubnetworkStackTypeComputeBeta.fromValue(map['stackType'] as String),
    );
  }
}
