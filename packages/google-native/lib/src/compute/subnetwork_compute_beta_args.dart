...
class SubnetworkComputeBetaArgs {
  ...
  final pulumi.Input<SubnetworkPrivateIpv6GoogleAccessComputeBeta>?
  ...
  final pulumi.Input<List<SubnetworkSecondaryRangeComputeBeta>>?
      secondaryIpRanges;
  ...
  SubnetworkComputeBetaArgs({
    ...
    String? ipCidrRange,
    SubnetworkIpv6AccessTypeComputeBeta? ipv6AccessType,
    SubnetworkLogConfigComputeBeta? logConfig,
    String? name,
    String? network,
    bool? privateIpGoogleAccess,
    SubnetworkPrivateIpv6GoogleAccessComputeBeta? privateIpv6GoogleAccess,
    String? project,
    SubnetworkPurposeComputeBeta? purpose,
    required String region,
    String? requestId,
    String? reservedInternalRange,
    SubnetworkRoleComputeBeta? role,
    List<SubnetworkSecondaryRangeComputeBeta>? secondaryIpRanges,
    SubnetworkStackTypeComputeBeta? stackType,
  })  : allowSubnetCidrRoutesOverlap =
            pulumi.Input.asOptionalInput<bool>(allowSubnetCidrRoutesOverlap),
        description = pulumi.Input.asOptionalInput<String>(description),
        enableFlowLogs = pulumi.Input.asOptionalInput<bool>(enableFlowLogs),
        externalIpv6Prefix =
            pulumi.Input.asOptionalInput<String>(externalIpv6Prefix),
        ipCidrRange = pulumi.Input.asOptionalInput<String>(ipCidrRange),
        ipv6AccessType =
            pulumi.Input.asOptionalInput<SubnetworkIpv6AccessTypeComputeBeta>(
                ipv6AccessType),
        logConfig =
            pulumi.Input.asOptionalInput<SubnetworkLogConfigComputeBeta>(
                logConfig),
        name = pulumi.Input.asOptionalInput<String>(name),
        network = pulumi.Input.asOptionalInput<String>(network),
        privateIpGoogleAccess =
            pulumi.Input.asOptionalInput<bool>(privateIpGoogleAccess),
        privateIpv6GoogleAccess = pulumi.Input.asOptionalInput<
                SubnetworkPrivateIpv6GoogleAccessComputeBeta>(
            privateIpv6GoogleAccess),
        project = pulumi.Input.asOptionalInput<String>(project),
        purpose =
            pulumi.Input.asOptionalInput<SubnetworkPurposeComputeBeta>(purpose),
        region = pulumi.Input.asInput<String>(region),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        reservedInternalRange =
            pulumi.Input.asOptionalInput<String>(reservedInternalRange),
        role = pulumi.Input.asOptionalInput<SubnetworkRoleComputeBeta>(role),
        secondaryIpRanges = pulumi.Input.asOptionalInput<
            List<SubnetworkSecondaryRangeComputeBeta>>(secondaryIpRanges),
        stackType =
            pulumi.Input.asOptionalInput<SubnetworkStackTypeComputeBeta>(
                stackType);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipv6AccessTypeValue != null) {
      map['ipv6AccessType'] = pulumi.Input.mapOptionalInputValue<
          SubnetworkIpv6AccessTypeComputeBeta,
          String>(ipv6AccessTypeValue, (value) => value.value);
    }
    ...
    if (purposeValue != null) {
      map['purpose'] = pulumi.Input.mapOptionalInputValue<
          SubnetworkPurposeComputeBeta,
          String>(purposeValue, (value) => value.value);
    }
    map['region'] = region;
    ...
    if (roleValue != null) {
      map['role'] =
          pulumi.Input.mapOptionalInputValue<SubnetworkRoleComputeBeta, String>(
  ...
  factory SubnetworkComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkComputeBetaArgs(
      ...
      enableFlowLogs:
          map['enableFlowLogs'] == null ? null : map['enableFlowLogs'] as bool,
      ...
      ipv6AccessType: map['ipv6AccessType'] == null
          ? null
          : SubnetworkIpv6AccessTypeComputeBeta.fromValue(
              map['ipv6AccessType'] as String),
      logConfig: map['logConfig'] == null
          ? null
          : SubnetworkLogConfigComputeBeta.fromMap(
      ...
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null
          ? null
          : SubnetworkPrivateIpv6GoogleAccessComputeBeta.fromValue(
              map['privateIpv6GoogleAccess'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null
          ? null
          : SubnetworkPurposeComputeBeta.fromValue(map['purpose'] as String),
      ...
      role: map['role'] == null
          ? null
          : SubnetworkRoleComputeBeta.fromValue(map['role'] as String),
      secondaryIpRanges: map['secondaryIpRanges'] == null
          ? null
          : pulumi.Input.decodeList<SubnetworkSecondaryRangeComputeBeta>(
              map['secondaryIpRanges'],
              (value) => SubnetworkSecondaryRangeComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      stackType: map['stackType'] == null
          ? null
          : SubnetworkStackTypeComputeBeta.fromValue(
