...
class InterconnectOutageNotificationResponse {
  ...
  /// Creates a new [InterconnectOutageNotificationResponse].
  ...
  factory InterconnectOutageNotificationResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return InterconnectOutageNotificationResponse(
