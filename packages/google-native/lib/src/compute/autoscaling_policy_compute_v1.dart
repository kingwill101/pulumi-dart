...
class AutoscalingPolicyComputeV1 {
  ...
  final List<AutoscalingPolicyCustomMetricUtilizationComputeV1>?
  customMetricUtilizations;

  /// Configuration parameters of autoscaling based on load balancer.
  final AutoscalingPolicyLoadBalancingUtilizationComputeV1?
  ...
  factory AutoscalingPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyComputeV1(
      ...
      mode: map['mode'] == null
          ? null
          : AutoscalingPolicyModeComputeV1.fromValue(map['mode'] as String),
