...
class CustomErrorResponsePolicy {
  ...
  final List<CustomErrorResponsePolicyCustomErrorResponseRule>? errorResponseRules;
  ...
  /// Creates a new [CustomErrorResponsePolicy].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': ?errorResponseRules == null ? null : pulumi.Input.encodeList<CustomErrorResponsePolicyCustomErrorResponseRule, Map<String, dynamic>>(errorResponseRules!, (value) => value.toMap()),
  ...
  factory CustomErrorResponsePolicy.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicy(
      errorResponseRules: map['errorResponseRules'] == null ? null : pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRule>(map['errorResponseRules'], (value) => CustomErrorResponsePolicyCustomErrorResponseRule.fromMap((value as Map).cast<String, dynamic>())),
