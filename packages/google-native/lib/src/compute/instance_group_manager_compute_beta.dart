...
import 'instance_group_manager_compute_beta_args.dart';
...
class InstanceGroupManagerComputeBeta extends pulumi.CustomResource {
  /// Specifies configuration that overrides the instance template configuration for the group.
  late final pulumi
      .Output<InstanceGroupManagerAllInstancesConfigResponseComputeBeta>
      allInstancesConfig;

  /// The autohealing policy for this managed instance group. You can specify only one value.
  late final pulumi
      .Output<List<InstanceGroupManagerAutoHealingPolicyResponseComputeBeta>>
      autoHealingPolicies;
  ...
  late final pulumi
      .Output<InstanceGroupManagerActionsSummaryResponseComputeBeta>
      currentActions;
  ...
  late final pulumi.Output<DistributionPolicyResponseComputeBeta>
      distributionPolicy;
  ...
  late final pulumi
      .Output<InstanceGroupManagerInstanceFlexibilityPolicyResponseComputeBeta>
  ...
  late final pulumi
      .Output<InstanceGroupManagerInstanceLifecyclePolicyResponseComputeBeta>
  ...
  late final pulumi.Output<List<NamedPortResponseComputeBeta>> namedPorts;
  ...
  late final pulumi.Output<InstanceGroupManagerStandbyPolicyResponseComputeBeta>
      standbyPolicy;
  ...
  late final pulumi.Output<InstanceGroupManagerStatusResponseComputeBeta>
      status;
  ...
  late final pulumi.Output<InstanceGroupManagerUpdatePolicyResponseComputeBeta>
      updatePolicy;

  /// Specifies the instance templates used by this managed instance group to create instances. Each version is defined by an instanceTemplate and a name. Every version can appear at most once per instance group. This field overrides the top-level instanceTemplate field. Read more about the relationships between these fields. Exactly one version must leave the targetSize field unset. That version will be applied to all remaining instances. For more information, read about canary updates.
  late final pulumi.Output<List<InstanceGroupManagerVersionResponseComputeBeta>>
      versions;
  late final pulumi.Output<String> zone;

  /// Creates a new [InstanceGroupManagerComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceGroupManagerComputeBeta]. {@macro pulumi_compute_beta_instance_group_manager_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceGroupManagerComputeBeta(
    String name, {
    InstanceGroupManagerComputeBetaArgs? args,
    ...
    this.allInstancesConfig = registerOutput<
            InstanceGroupManagerAllInstancesConfigResponseComputeBeta>(
        'allInstancesConfig');
    this.autoHealingPolicies = registerOutput<
            List<InstanceGroupManagerAutoHealingPolicyResponseComputeBeta>>(
        'autoHealingPolicies');
    ...
    this.namedPorts =
        registerOutput<List<NamedPortResponseComputeBeta>>('namedPorts');
    ...
    this.standbyPolicy =
        registerOutput<InstanceGroupManagerStandbyPolicyResponseComputeBeta>(
            'standbyPolicy');
    this.statefulPolicy =
        registerOutput<StatefulPolicyResponseComputeBeta>('statefulPolicy');
    this.status =
        registerOutput<InstanceGroupManagerStatusResponseComputeBeta>('status');
    ...
    this.updatePolicy =
        registerOutput<InstanceGroupManagerUpdatePolicyResponseComputeBeta>(
            'updatePolicy');
    this.versions =
        registerOutput<List<InstanceGroupManagerVersionResponseComputeBeta>>(
            'versions');
