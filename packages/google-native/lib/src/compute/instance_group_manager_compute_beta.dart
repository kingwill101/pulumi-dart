...
class InstanceGroupManagerComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<
    InstanceGroupManagerActionsSummaryResponseComputeBeta
  >
  currentActions;
  ...
  InstanceGroupManagerComputeBeta(
    ...
    this.namedPorts = registerOutput<List<NamedPortResponseComputeBeta>>(
      'namedPorts',
    );
    ...
    this.statefulPolicy = registerOutput<StatefulPolicyResponseComputeBeta>(
      'statefulPolicy',
    );
    this.status = registerOutput<InstanceGroupManagerStatusResponseComputeBeta>(
      'status',
    );
