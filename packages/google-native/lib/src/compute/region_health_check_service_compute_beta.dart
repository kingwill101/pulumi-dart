...
class RegionHealthCheckServiceComputeBeta extends pulumi.CustomResource {
  ...
  RegionHealthCheckServiceComputeBeta(
    ...
    this.healthStatusAggregationPolicy = registerOutput<String>(
      'healthStatusAggregationPolicy',
    );
    this.healthStatusAggregationStrategy = registerOutput<String>(
      'healthStatusAggregationStrategy',
    );
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.networkEndpointGroups = registerOutput<List<String>>(
      'networkEndpointGroups',
    );
    this.notificationEndpoints = registerOutput<List<String>>(
