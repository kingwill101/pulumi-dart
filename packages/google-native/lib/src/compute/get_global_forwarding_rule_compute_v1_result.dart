...
class GetGlobalForwardingRuleComputeV1Result {
  ...
  final List<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1>
  ...
  /// Creates a new [GetGlobalForwardingRuleComputeV1Result].
  ...
  GetGlobalForwardingRuleComputeV1Result({
  ...
  factory GetGlobalForwardingRuleComputeV1Result.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetGlobalForwardingRuleComputeV1Result(
      ...
      serviceDirectoryRegistrations:
          ...
          >(
            ...
            (value) =>
                ForwardingRuleServiceDirectoryRegistrationResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
