...
import 'target_http_proxy_compute_beta_args.dart';

/// Creates a TargetHttpProxy resource in the specified project using the data included in the request.
class TargetHttpProxyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetHttpProxyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetHttpProxyComputeBeta]. {@macro pulumi_compute_beta_target_http_proxy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetHttpProxyComputeBeta(
    String name, {
    TargetHttpProxyComputeBetaArgs? args,
