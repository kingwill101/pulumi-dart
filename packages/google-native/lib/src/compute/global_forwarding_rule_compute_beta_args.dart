...
class GlobalForwardingRuleComputeBetaArgs {
  ...
  GlobalForwardingRuleComputeBetaArgs({
    ...
    String? target,
       ...
       allowGlobalAccess = pulumi.Input.asOptionalInput<bool>(
         allowGlobalAccess,
       ),
       allowPscGlobalAccess = pulumi.Input.asOptionalInput<bool>(
         allowPscGlobalAccess,
       ),
       allowPscPacketInjection = pulumi.Input.asOptionalInput<bool>(
       ...
       ipVersion =
           ...
           >(ipVersion),
       isMirroringCollector = pulumi.Input.asOptionalInput<bool>(
       ...
       networkTier =
           ...
           >(networkTier),
       noAutomateDnsZone = pulumi.Input.asOptionalInput<bool>(
         noAutomateDnsZone,
       ),
       ...
       sourceIpRanges = pulumi.Input.asOptionalInput<List<String>>(
         sourceIpRanges,
       ),
    ...
    return <String, dynamic>{
      ...
      'ipProtocol':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalForwardingRuleIpProtocolComputeBeta,
            String
          >(ipProtocol, (value) => value.value),
      'ipVersion':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalForwardingRuleIpVersionComputeBeta,
            String
          >(ipVersion, (value) => value.value),
      ...
      'pscConnectionStatus':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalForwardingRulePscConnectionStatusComputeBeta,
            String
          >(pscConnectionStatus, (value) => value.value),
      'requestId': ?requestId,
      'serviceDirectoryRegistrations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>,
  ...
  factory GlobalForwardingRuleComputeBetaArgs.fromMap(
    ...
    return GlobalForwardingRuleComputeBetaArgs(
      ...
      serviceDirectoryRegistrations:
          map['serviceDirectoryRegistrations'] == null
          ? null
      ...
      serviceLabel: map['serviceLabel'] == null
          ? null
          : map['serviceLabel'] as String,
