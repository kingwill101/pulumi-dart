...
class GlobalForwardingRuleComputeBetaArgs {
  ...
  final pulumi.Input<GlobalForwardingRuleLoadBalancingSchemeComputeBeta>?
      loadBalancingScheme;
  ...
  final pulumi.Input<GlobalForwardingRulePscConnectionStatusComputeBeta>?
      pscConnectionStatus;
  ...
  final pulumi
      .Input<List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>>?
  ...
  GlobalForwardingRuleComputeBetaArgs({
    ...
    String? requestId,
    List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>?
        serviceDirectoryRegistrations,
    String? serviceLabel,
    ...
    String? target,
        ...
        allowGlobalAccess =
            pulumi.Input.asOptionalInput<bool>(allowGlobalAccess),
        allowPscGlobalAccess =
            pulumi.Input.asOptionalInput<bool>(allowPscGlobalAccess),
        allowPscPacketInjection =
            pulumi.Input.asOptionalInput<bool>(allowPscPacketInjection),
        backendService = pulumi.Input.asOptionalInput<String>(backendService),
        description = pulumi.Input.asOptionalInput<String>(description),
        ipAddress = pulumi.Input.asOptionalInput<String>(ipAddress),
        ipProtocol = pulumi.Input.asOptionalInput<
            GlobalForwardingRuleIpProtocolComputeBeta>(ipProtocol),
        ipVersion = pulumi.Input.asOptionalInput<
            GlobalForwardingRuleIpVersionComputeBeta>(ipVersion),
        isMirroringCollector =
            pulumi.Input.asOptionalInput<bool>(isMirroringCollector),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        loadBalancingScheme = pulumi.Input.asOptionalInput<
                GlobalForwardingRuleLoadBalancingSchemeComputeBeta>(
            loadBalancingScheme),
        metadataFilters =
            pulumi.Input.asOptionalInput<List<MetadataFilterComputeBeta>>(
                metadataFilters),
        name = pulumi.Input.asOptionalInput<String>(name),
        network = pulumi.Input.asOptionalInput<String>(network),
        networkTier = pulumi.Input.asOptionalInput<
            GlobalForwardingRuleNetworkTierComputeBeta>(networkTier),
        noAutomateDnsZone =
            pulumi.Input.asOptionalInput<bool>(noAutomateDnsZone),
        portRange = pulumi.Input.asOptionalInput<String>(portRange),
        ports = pulumi.Input.asOptionalInput<List<String>>(ports),
        project = pulumi.Input.asOptionalInput<String>(project),
        pscConnectionStatus = pulumi.Input.asOptionalInput<
                GlobalForwardingRulePscConnectionStatusComputeBeta>(
            pscConnectionStatus),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        serviceDirectoryRegistrations = pulumi.Input.asOptionalInput<
                List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>>(
            serviceDirectoryRegistrations),
        serviceLabel = pulumi.Input.asOptionalInput<String>(serviceLabel),
        sourceIpRanges =
            pulumi.Input.asOptionalInput<List<String>>(sourceIpRanges),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRuleIpProtocolComputeBeta,
          String>(ipProtocolValue, (value) => value.value);
    }
    final ipVersionValue = ipVersion;
    if (ipVersionValue != null) {
      map['ipVersion'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRuleIpVersionComputeBeta,
    ...
    if (metadataFiltersValue != null) {
      map['metadataFilters'] = pulumi.Input.mapOptionalInputValue<
              List<MetadataFilterComputeBeta>, List<Map<String, dynamic>>>(
          metadataFiltersValue,
          (value) => pulumi.Input.encodeList<MetadataFilterComputeBeta,
    ...
    if (networkTierValue != null) {
      map['networkTier'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRuleNetworkTierComputeBeta,
    ...
    if (pscConnectionStatusValue != null) {
      map['pscConnectionStatus'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRulePscConnectionStatusComputeBeta,
    ...
    if (serviceDirectoryRegistrationsValue != null) {
      map['serviceDirectoryRegistrations'] = pulumi.Input.mapOptionalInputValue<
              List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>,
  ...
  factory GlobalForwardingRuleComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return GlobalForwardingRuleComputeBetaArgs(
      allPorts: map['allPorts'] == null ? null : map['allPorts'] as bool,
      allowGlobalAccess: map['allowGlobalAccess'] == null
          ? null
          : map['allowGlobalAccess'] as bool,
      allowPscGlobalAccess: map['allowPscGlobalAccess'] == null
          ? null
          : map['allowPscGlobalAccess'] as bool,
      allowPscPacketInjection: map['allowPscPacketInjection'] == null
          ? null
          : map['allowPscPacketInjection'] as bool,
      ...
      ipProtocol: map['ipProtocol'] == null
          ? null
          : GlobalForwardingRuleIpProtocolComputeBeta.fromValue(
              map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null
          ? null
          : GlobalForwardingRuleIpVersionComputeBeta.fromValue(
              map['ipVersion'] as String),
      isMirroringCollector: map['isMirroringCollector'] == null
          ? null
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null
          ? null
          : GlobalForwardingRuleLoadBalancingSchemeComputeBeta.fromValue(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : GlobalForwardingRuleNetworkTierComputeBeta.fromValue(
              map['networkTier'] as String),
      noAutomateDnsZone: map['noAutomateDnsZone'] == null
          ? null
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null
          ? null
          : GlobalForwardingRulePscConnectionStatusComputeBeta.fromValue(
              map['pscConnectionStatus'] as String),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] ==
              null
          ? null
          : pulumi.Input.decodeList<
              ...
              (value) =>
                  ForwardingRuleServiceDirectoryRegistrationComputeBeta.fromMap(
                      (value as Map).cast<String, dynamic>())),
      serviceLabel:
          map['serviceLabel'] == null ? null : map['serviceLabel'] as String,
      sourceIpRanges: map['sourceIpRanges'] == null
          ? null
