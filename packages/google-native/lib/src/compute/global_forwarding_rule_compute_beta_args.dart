...
import 'forwarding_rule_service_directory_registration_compute_beta.dart';
import 'global_forwarding_rule_ip_protocol_compute_beta.dart';
import 'global_forwarding_rule_ip_version_compute_beta.dart';
import 'global_forwarding_rule_load_balancing_scheme_compute_beta.dart';
import 'global_forwarding_rule_network_tier_compute_beta.dart';
import 'global_forwarding_rule_psc_connection_status_compute_beta.dart';
import 'metadata_filter_compute_beta.dart';

/// {@template pulumi_compute_beta_global_forwarding_rule_compute_beta_args_doc}
/// The set of arguments for GlobalForwardingRule.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_global_forwarding_rule_compute_beta_args_doc}
class GlobalForwardingRuleComputeBetaArgs {
  ...
  final pulumi.Input<bool>? allowPscPacketInjection;
  ...
  final pulumi.Input<GlobalForwardingRuleIpProtocolComputeBeta>? ipProtocol;
  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final pulumi.Input<GlobalForwardingRuleIpVersionComputeBeta>? ipVersion;
  ...
  final pulumi.Input<GlobalForwardingRuleLoadBalancingSchemeComputeBeta>? loadBalancingScheme;
  ...
  final pulumi.Input<GlobalForwardingRuleNetworkTierComputeBeta>? networkTier;
  ...
  final pulumi.Input<GlobalForwardingRulePscConnectionStatusComputeBeta>? pscConnectionStatus;
  ...
  final pulumi.Input<List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>>? serviceDirectoryRegistrations;
  ...
  /// Creates a new [GlobalForwardingRuleComputeBetaArgs].
  ...
  GlobalForwardingRuleComputeBetaArgs({
    bool? allPorts,
    ...
    String? description,
    String? ipAddress,
    GlobalForwardingRuleIpProtocolComputeBeta? ipProtocol,
    GlobalForwardingRuleIpVersionComputeBeta? ipVersion,
    bool? isMirroringCollector,
    Map<String, String>? labels,
    GlobalForwardingRuleLoadBalancingSchemeComputeBeta? loadBalancingScheme,
    List<MetadataFilterComputeBeta>? metadataFilters,
    String? name,
    String? network,
    GlobalForwardingRuleNetworkTierComputeBeta? networkTier,
    bool? noAutomateDnsZone,
    String? portRange,
    List<String>? ports,
    String? project,
    GlobalForwardingRulePscConnectionStatusComputeBeta? pscConnectionStatus,
    String? requestId,
    List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>? serviceDirectoryRegistrations,
    String? serviceLabel,
    ...
    String? target,
      ...
      allowPscPacketInjection = pulumi.Input.asOptionalInput<bool>(allowPscPacketInjection),
      backendService = pulumi.Input.asOptionalInput<String>(backendService),
      description = pulumi.Input.asOptionalInput<String>(description),
      ipAddress = pulumi.Input.asOptionalInput<String>(ipAddress),
      ipProtocol = pulumi.Input.asOptionalInput<GlobalForwardingRuleIpProtocolComputeBeta>(ipProtocol),
      ipVersion = pulumi.Input.asOptionalInput<GlobalForwardingRuleIpVersionComputeBeta>(ipVersion),
      isMirroringCollector = pulumi.Input.asOptionalInput<bool>(isMirroringCollector),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      loadBalancingScheme = pulumi.Input.asOptionalInput<GlobalForwardingRuleLoadBalancingSchemeComputeBeta>(loadBalancingScheme),
      metadataFilters = pulumi.Input.asOptionalInput<List<MetadataFilterComputeBeta>>(metadataFilters),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<GlobalForwardingRuleNetworkTierComputeBeta>(networkTier),
      ...
      pscConnectionStatus = pulumi.Input.asOptionalInput<GlobalForwardingRulePscConnectionStatusComputeBeta>(pscConnectionStatus),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      serviceDirectoryRegistrations = pulumi.Input.asOptionalInput<List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>>(serviceDirectoryRegistrations),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddress': ?ipAddress,
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleIpProtocolComputeBeta, String>(ipProtocol, (value) => value.value),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleIpVersionComputeBeta, String>(ipVersion, (value) => value.value),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleLoadBalancingSchemeComputeBeta, String>(loadBalancingScheme, (value) => value.value),
      'metadataFilters': ?pulumi.Input.mapOptionalInputValue<List<MetadataFilterComputeBeta>, List<Map<String, dynamic>>>(metadataFilters, (value) => pulumi.Input.encodeList<MetadataFilterComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleNetworkTierComputeBeta, String>(networkTier, (value) => value.value),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRulePscConnectionStatusComputeBeta, String>(pscConnectionStatus, (value) => value.value),
      'requestId': ?requestId,
      'serviceDirectoryRegistrations': ?pulumi.Input.mapOptionalInputValue<List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>, List<Map<String, dynamic>>>(serviceDirectoryRegistrations, (value) => pulumi.Input.encodeList<ForwardingRuleServiceDirectoryRegistrationComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GlobalForwardingRuleComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleComputeBetaArgs(
      allPorts: map['allPorts'] == null ? null : map['allPorts'] as bool,
      allowGlobalAccess: map['allowGlobalAccess'] == null ? null : map['allowGlobalAccess'] as bool,
      allowPscGlobalAccess: map['allowPscGlobalAccess'] == null ? null : map['allowPscGlobalAccess'] as bool,
      allowPscPacketInjection: map['allowPscPacketInjection'] == null ? null : map['allowPscPacketInjection'] as bool,
      backendService: map['backendService'] == null ? null : map['backendService'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      ipAddress: map['ipAddress'] == null ? null : map['ipAddress'] as String,
      ipProtocol: map['ipProtocol'] == null ? null : GlobalForwardingRuleIpProtocolComputeBeta.fromValue(map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null ? null : GlobalForwardingRuleIpVersionComputeBeta.fromValue(map['ipVersion'] as String),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : map['isMirroringCollector'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : GlobalForwardingRuleLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String),
      ...
      networkTier: map['networkTier'] == null ? null : GlobalForwardingRuleNetworkTierComputeBeta.fromValue(map['networkTier'] as String),
      noAutomateDnsZone: map['noAutomateDnsZone'] == null ? null : map['noAutomateDnsZone'] as bool,
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : GlobalForwardingRulePscConnectionStatusComputeBeta.fromValue(map['pscConnectionStatus'] as String),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistrationComputeBeta>(map['serviceDirectoryRegistrations'], (value) => ForwardingRuleServiceDirectoryRegistrationComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      serviceLabel: map['serviceLabel'] == null ? null : map['serviceLabel'] as String,
      sourceIpRanges: map['sourceIpRanges'] == null ? null : (map['sourceIpRanges'] as List).cast<String>(),
