...
class ImageArgs {
  ...
  ImageArgs({
    ...
    List<String>? userLicenses,
            ...
            pulumi.Input.asOptionalInput<ImageArchitecture>(architecture),
        archiveSizeBytes =
            pulumi.Input.asOptionalInput<String>(archiveSizeBytes),
        deprecated =
            pulumi.Input.asOptionalInput<DeprecationStatus>(deprecated),
        ...
        rolloutOverride =
            pulumi.Input.asOptionalInput<RolloutPolicy>(rolloutOverride),
        shieldedInstanceInitialState =
            pulumi.Input.asOptionalInput<InitialStateConfig>(
                shieldedInstanceInitialState),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (deprecatedValue != null) {
      map['deprecated'] = pulumi.Input.mapOptionalInputValue<DeprecationStatus,
    ...
    if (rolloutOverrideValue != null) {
      map['rolloutOverride'] = pulumi.Input.mapOptionalInputValue<RolloutPolicy,
    ...
    if (shieldedInstanceInitialStateValue != null) {
      map['shieldedInstanceInitialState'] = pulumi.Input.mapOptionalInputValue<
              InitialStateConfig, Map<String, dynamic>>(
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      architecture: map['architecture'] == null
          ? null
          : ImageArchitecture.fromValue(map['architecture'] as String),
      ...
      sourceType: map['sourceType'] == null
          ? null
          : ImageSourceType.fromValue(map['sourceType'] as String),
