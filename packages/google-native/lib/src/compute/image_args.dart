...
class ImageArgs {
  ...
  ImageArgs({
    ...
    List<String>? userLicenses,
  }) : architecture = pulumi.Input.asOptionalInput<ImageArchitecture>(
         architecture,
       ),
       ...
       imageEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKey>(
         imageEncryptionKey,
       ),
       ...
       rolloutOverride = pulumi.Input.asOptionalInput<RolloutPolicy>(
         rolloutOverride,
       ),
