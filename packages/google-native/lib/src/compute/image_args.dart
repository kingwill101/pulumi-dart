...
class ImageArgs {
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      architecture: map['architecture'] == null ? null : ImageArchitecture.fromValue(map['architecture'] as String),
      archiveSizeBytes: map['archiveSizeBytes'] == null ? null : map['archiveSizeBytes'] as String,
      deprecated: map['deprecated'] == null ? null : DeprecationStatus.fromMap((map['deprecated'] as Map).cast<String, dynamic>()),
      ...
      imageEncryptionKey: map['imageEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['imageEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      rolloutOverride: map['rolloutOverride'] == null ? null : RolloutPolicy.fromMap((map['rolloutOverride'] as Map).cast<String, dynamic>()),
      shieldedInstanceInitialState: map['shieldedInstanceInitialState'] == null ? null : InitialStateConfig.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>()),
      sourceDisk: map['sourceDisk'] == null ? null : map['sourceDisk'] as String,
      sourceDiskEncryptionKey: map['sourceDiskEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['sourceDiskEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      sourceType: map['sourceType'] == null ? null : ImageSourceType.fromValue(map['sourceType'] as String),
