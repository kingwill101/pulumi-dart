...
class ForwardingRuleComputeV1Args {
  ...
  final pulumi.Input<ForwardingRuleLoadBalancingSchemeComputeV1>?
      loadBalancingScheme;
  ...
  final pulumi.Input<ForwardingRulePscConnectionStatusComputeV1>?
      pscConnectionStatus;
  ...
  final pulumi.Input<List<ForwardingRuleServiceDirectoryRegistrationComputeV1>>?
  ...
  ForwardingRuleComputeV1Args({
    ...
    String? requestId,
    List<ForwardingRuleServiceDirectoryRegistrationComputeV1>?
        serviceDirectoryRegistrations,
    String? serviceLabel,
    ...
    String? target,
        ...
        ipProtocol =
            pulumi.Input.asOptionalInput<ForwardingRuleIpProtocolComputeV1>(
                ipProtocol),
        ipVersion =
            pulumi.Input.asOptionalInput<ForwardingRuleIpVersionComputeV1>(
                ipVersion),
        ...
        loadBalancingScheme = pulumi.Input.asOptionalInput<
            ForwardingRuleLoadBalancingSchemeComputeV1>(loadBalancingScheme),
        metadataFilters =
            pulumi.Input.asOptionalInput<List<MetadataFilterComputeV1>>(
                metadataFilters),
        name = pulumi.Input.asOptionalInput<String>(name),
        network = pulumi.Input.asOptionalInput<String>(network),
        networkTier =
            pulumi.Input.asOptionalInput<ForwardingRuleNetworkTierComputeV1>(
                networkTier),
        noAutomateDnsZone =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] = pulumi.Input.mapOptionalInputValue<
          ForwardingRuleIpProtocolComputeV1,
    ...
    if (ipVersionValue != null) {
      map['ipVersion'] = pulumi.Input.mapOptionalInputValue<
          ForwardingRuleIpVersionComputeV1,
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = pulumi.Input.mapOptionalInputValue<
          ForwardingRuleLoadBalancingSchemeComputeV1,
    ...
    if (metadataFiltersValue != null) {
      map['metadataFilters'] = pulumi.Input.mapOptionalInputValue<
              List<MetadataFilterComputeV1>, List<Map<String, dynamic>>>(
          metadataFiltersValue,
          (value) => pulumi.Input.encodeList<MetadataFilterComputeV1,
    ...
    if (networkTierValue != null) {
      map['networkTier'] = pulumi.Input.mapOptionalInputValue<
          ForwardingRuleNetworkTierComputeV1,
    ...
    if (pscConnectionStatusValue != null) {
      map['pscConnectionStatus'] = pulumi.Input.mapOptionalInputValue<
          ForwardingRulePscConnectionStatusComputeV1,
  ...
  factory ForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeV1Args(
      ...
      ipProtocol: map['ipProtocol'] == null
          ? null
          : ForwardingRuleIpProtocolComputeV1.fromValue(
              map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null
          ? null
          : ForwardingRuleIpVersionComputeV1.fromValue(
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null
          ? null
          : ForwardingRuleLoadBalancingSchemeComputeV1.fromValue(
              map['loadBalancingScheme'] as String),
      metadataFilters: map['metadataFilters'] == null
          ? null
          : pulumi.Input.decodeList<MetadataFilterComputeV1>(
              map['metadataFilters'],
              (value) => MetadataFilterComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkTier: map['networkTier'] == null
          ? null
          : ForwardingRuleNetworkTierComputeV1.fromValue(
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null
          ? null
          : ForwardingRulePscConnectionStatusComputeV1.fromValue(
      ...
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] ==
          ...
          : pulumi.Input.decodeList<
              ...
              (value) =>
                  ForwardingRuleServiceDirectoryRegistrationComputeV1.fromMap(
                      (value as Map).cast<String, dynamic>())),
      serviceLabel:
