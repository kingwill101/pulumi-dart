...
import 'forwarding_rule_ip_protocol_compute_v1.dart';
import 'forwarding_rule_ip_version_compute_v1.dart';
import 'forwarding_rule_load_balancing_scheme_compute_v1.dart';
import 'forwarding_rule_network_tier_compute_v1.dart';
import 'forwarding_rule_psc_connection_status_compute_v1.dart';
import 'forwarding_rule_service_directory_registration_compute_v1.dart';
import 'metadata_filter_compute_v1.dart';

/// {@template pulumi_compute_v1_forwarding_rule_compute_v1_args_doc}
/// The set of arguments for ForwardingRule.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_forwarding_rule_compute_v1_args_doc}
class ForwardingRuleComputeV1Args {
  ...
  final pulumi.Input<ForwardingRuleIpProtocolComputeV1>? ipProtocol;
  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final pulumi.Input<ForwardingRuleIpVersionComputeV1>? ipVersion;
  ...
  final pulumi.Input<ForwardingRuleLoadBalancingSchemeComputeV1>? loadBalancingScheme;
  ...
  final pulumi.Input<ForwardingRuleNetworkTierComputeV1>? networkTier;
  ...
  final pulumi.Input<ForwardingRulePscConnectionStatusComputeV1>? pscConnectionStatus;
  ...
  /// Creates a new [ForwardingRuleComputeV1Args].
  ...
  ForwardingRuleComputeV1Args({
    ...
    String? description,
    String? ipAddress,
    ForwardingRuleIpProtocolComputeV1? ipProtocol,
    ForwardingRuleIpVersionComputeV1? ipVersion,
    bool? isMirroringCollector,
    Map<String, String>? labels,
    ForwardingRuleLoadBalancingSchemeComputeV1? loadBalancingScheme,
    List<MetadataFilterComputeV1>? metadataFilters,
    String? name,
    String? network,
    ForwardingRuleNetworkTierComputeV1? networkTier,
    bool? noAutomateDnsZone,
    String? portRange,
    List<String>? ports,
    String? project,
    ForwardingRulePscConnectionStatusComputeV1? pscConnectionStatus,
    required String region,
    String? requestId,
    List<ForwardingRuleServiceDirectoryRegistrationComputeV1>? serviceDirectoryRegistrations,
    String? serviceLabel,
    ...
    String? target,
      ...
      ipProtocol = pulumi.Input.asOptionalInput<ForwardingRuleIpProtocolComputeV1>(ipProtocol),
      ipVersion = pulumi.Input.asOptionalInput<ForwardingRuleIpVersionComputeV1>(ipVersion),
      isMirroringCollector = pulumi.Input.asOptionalInput<bool>(isMirroringCollector),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      loadBalancingScheme = pulumi.Input.asOptionalInput<ForwardingRuleLoadBalancingSchemeComputeV1>(loadBalancingScheme),
      metadataFilters = pulumi.Input.asOptionalInput<List<MetadataFilterComputeV1>>(metadataFilters),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<ForwardingRuleNetworkTierComputeV1>(networkTier),
      ...
      pscConnectionStatus = pulumi.Input.asOptionalInput<ForwardingRulePscConnectionStatusComputeV1>(pscConnectionStatus),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddress': ?ipAddress,
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpProtocolComputeV1, String>(ipProtocol, (value) => value.value),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpVersionComputeV1, String>(ipVersion, (value) => value.value),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleLoadBalancingSchemeComputeV1, String>(loadBalancingScheme, (value) => value.value),
      ...
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleNetworkTierComputeV1, String>(networkTier, (value) => value.value),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<ForwardingRulePscConnectionStatusComputeV1, String>(pscConnectionStatus, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
  ...
  factory ForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeV1Args(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : ForwardingRuleIpProtocolComputeV1.fromValue(map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null ? null : ForwardingRuleIpVersionComputeV1.fromValue(map['ipVersion'] as String),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : map['isMirroringCollector'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : ForwardingRuleLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme'] as String),
      metadataFilters: map['metadataFilters'] == null ? null : pulumi.Input.decodeList<MetadataFilterComputeV1>(map['metadataFilters'], (value) => MetadataFilterComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkTier: map['networkTier'] == null ? null : ForwardingRuleNetworkTierComputeV1.fromValue(map['networkTier'] as String),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : ForwardingRulePscConnectionStatusComputeV1.fromValue(map['pscConnectionStatus'] as String),
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistrationComputeV1>(map['serviceDirectoryRegistrations'], (value) => ForwardingRuleServiceDirectoryRegistrationComputeV1.fromMap((value as Map).cast<String, dynamic>())),
