...
class PublicDelegatedPrefixComputeBetaArgs {
  ...
  PublicDelegatedPrefixComputeBetaArgs({
    String? description,
    String? ipCidrRange,
    ...
    String? parentPrefix,
    String? project,
    List<PublicDelegatedPrefixPublicDelegatedSubPrefixComputeBeta>? publicDelegatedSubPrefixs,
  ...
  factory PublicDelegatedPrefixComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PublicDelegatedPrefixComputeBetaArgs(
      ...
      publicDelegatedSubPrefixs: map['publicDelegatedSubPrefixs'] == null ? null : pulumi.Input.decodeList<PublicDelegatedPrefixPublicDelegatedSubPrefixComputeBeta>(map['publicDelegatedSubPrefixs'], (value) => PublicDelegatedPrefixPublicDelegatedSubPrefixComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
