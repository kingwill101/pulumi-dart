...
class RegionCommitmentComputeV1Args {
  ...
  RegionCommitmentComputeV1Args({
    ...
    RegionCommitmentTypeComputeV1? type,
       ...
       category = pulumi
           .Input.asOptionalInput<RegionCommitmentCategoryComputeV1>(category),
       ...
       reservations =
           pulumi.Input.asOptionalInput<List<ReservationComputeV1Resource>>(
             reservations,
           ),
       resources = pulumi
           .Input.asOptionalInput<List<ResourceCommitmentComputeV1>>(resources),
       splitSourceCommitment = pulumi.Input.asOptionalInput<String>(
  ...
  factory RegionCommitmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentComputeV1Args(
      ...
      reservations: map['reservations'] == null
          ? null
          : (map['reservations'] as List).cast<ReservationComputeV1Resource>(),
