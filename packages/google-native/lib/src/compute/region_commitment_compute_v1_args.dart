...
class RegionCommitmentComputeV1Args {
  ...
  RegionCommitmentComputeV1Args({
    ...
    String? requestId,
    List<ReservationComputeV1Resource>? reservations,
  ...
  factory RegionCommitmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentComputeV1Args(
      ...
      category: map['category'] == null ? null : RegionCommitmentCategoryComputeV1.fromValue(map['category'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      licenseResource: map['licenseResource'] == null ? null : LicenseResourceCommitmentComputeV1.fromMap((map['licenseResource'] as Map).cast<String, dynamic>()),
      mergeSourceCommitments: map['mergeSourceCommitments'] == null ? null : (map['mergeSourceCommitments'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      plan: map['plan'] == null ? null : RegionCommitmentPlanComputeV1.fromValue(map['plan'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservations: map['reservations'] == null ? null : (map['reservations'] as List).cast<ReservationComputeV1Resource>(),
      resources: map['resources'] == null ? null : pulumi.Input.decodeList<ResourceCommitmentComputeV1>(map['resources'], (value) => ResourceCommitmentComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      splitSourceCommitment: map['splitSourceCommitment'] == null ? null : map['splitSourceCommitment'] as String,
      type: map['type'] == null ? null : RegionCommitmentTypeComputeV1.fromValue(map['type'] as String),
    );
  }
}
