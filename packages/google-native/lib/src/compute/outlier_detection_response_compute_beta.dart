...
class OutlierDetectionResponseComputeBeta {
  ...
  final DurationResponseComputeBeta baseEjectionTime;
  ...
  final DurationResponseComputeBeta interval;
  ...
  factory OutlierDetectionResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponseComputeBeta(
      baseEjectionTime: DurationResponseComputeBeta.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>()),
      ...
      interval: DurationResponseComputeBeta.fromMap((map['interval'] as Map).cast<String, dynamic>()),
