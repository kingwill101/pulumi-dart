...
class SourceInstancePropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks': pulumi.Input.encodeList<SavedAttachedDiskResponse, Map<String, dynamic>>(disks, (value) => value.toMap()),
  ...
  factory SourceInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SourceInstancePropertiesResponse(
      ...
      disks: pulumi.Input.decodeList<SavedAttachedDiskResponse>(map['disks'], (value) => SavedAttachedDiskResponse.fromMap((value as Map).cast<String, dynamic>())),
