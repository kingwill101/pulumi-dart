...
class LicenseComputeV1Args {
  ...
  factory LicenseComputeV1Args.fromMap(Map<String, dynamic> map) {
    return LicenseComputeV1Args(
      ...
      resourceRequirements: map['resourceRequirements'] == null ? null : LicenseResourceRequirementsComputeV1.fromMap((map['resourceRequirements'] as Map).cast<String, dynamic>()),
