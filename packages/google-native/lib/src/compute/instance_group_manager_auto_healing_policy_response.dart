...
class InstanceGroupManagerAutoHealingPolicyResponse {
  ...
  final InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse
      autoHealingTriggers;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['autoHealingTriggers'] = autoHealingTriggers.toMap();
  ...
  factory InstanceGroupManagerAutoHealingPolicyResponse.fromMap(
    ...
    return InstanceGroupManagerAutoHealingPolicyResponse(
      ...
      maxUnavailable: FixedOrPercentResponse.fromMap(
