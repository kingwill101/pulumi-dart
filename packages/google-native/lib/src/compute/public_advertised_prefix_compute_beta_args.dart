...
class PublicAdvertisedPrefixComputeBetaArgs {
  ...
  PublicAdvertisedPrefixComputeBetaArgs({
    ...
    PublicAdvertisedPrefixStatusComputeBeta? status,
      ...
      pdpScope = pulumi.Input.asOptionalInput<PublicAdvertisedPrefixPdpScopeComputeBeta>(pdpScope),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      status = pulumi.Input.asOptionalInput<PublicAdvertisedPrefixStatusComputeBeta>(status);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pdpScope': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixPdpScopeComputeBeta, String>(pdpScope, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
      'status': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixStatusComputeBeta, String>(status, (value) => value.value),
    };
  }

  factory PublicAdvertisedPrefixComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixComputeBetaArgs(
      ...
      pdpScope: map['pdpScope'] == null ? null : PublicAdvertisedPrefixPdpScopeComputeBeta.fromValue(map['pdpScope'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      status: map['status'] == null ? null : PublicAdvertisedPrefixStatusComputeBeta.fromValue(map['status'] as String),
    );
  }
}
