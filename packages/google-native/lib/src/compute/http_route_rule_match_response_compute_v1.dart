...
class HttpRouteRuleMatchResponseComputeV1 {
  ...
  final List<HttpHeaderMatchResponseComputeV1> headerMatches;
  ...
  final List<HttpQueryParameterMatchResponseComputeV1> queryParameterMatches;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': pulumi.Input.encodeList<HttpHeaderMatchResponseComputeV1, Map<String, dynamic>>(headerMatches, (value) => value.toMap()),
      ...
      'queryParameterMatches': pulumi.Input.encodeList<HttpQueryParameterMatchResponseComputeV1, Map<String, dynamic>>(queryParameterMatches, (value) => value.toMap()),
  ...
  factory HttpRouteRuleMatchResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponseComputeV1(
      ...
      headerMatches: pulumi.Input.decodeList<HttpHeaderMatchResponseComputeV1>(map['headerMatches'], (value) => HttpHeaderMatchResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      queryParameterMatches: pulumi.Input.decodeList<HttpQueryParameterMatchResponseComputeV1>(map['queryParameterMatches'], (value) => HttpQueryParameterMatchResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
