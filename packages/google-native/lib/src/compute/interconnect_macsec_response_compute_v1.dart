...
import 'interconnect_macsec_pre_shared_key_response_compute_v1.dart';
...
class InterconnectMacsecResponseComputeV1 {
  ...
  final List<InterconnectMacsecPreSharedKeyResponseComputeV1> preSharedKeys;
  ...
  InterconnectMacsecResponseComputeV1({
