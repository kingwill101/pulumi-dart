...
class RegionDiskComputeBetaArgs {
  ...
  factory RegionDiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskComputeBetaArgs(
      architecture: map['architecture'] == null ? null : RegionDiskArchitectureComputeBeta.fromValue(map['architecture'] as String),
      ...
      interface: map['interface'] == null ? null : RegionDiskInterfaceComputeBeta.fromValue(map['interface'] as String),
      ...
      storageType: map['storageType'] == null ? null : RegionDiskStorageTypeComputeBeta.fromValue(map['storageType'] as String),
