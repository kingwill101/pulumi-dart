...
class AuthenticationPolicyResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'origins': pulumi.Input.encodeList<OriginAuthenticationMethodResponse, Map<String, dynamic>>(origins, (value) => value.toMap()),
      'peers': pulumi.Input.encodeList<PeerAuthenticationMethodResponse, Map<String, dynamic>>(peers, (value) => value.toMap()),
      'principalBinding': principalBinding,
      'serverTlsContext': serverTlsContext.toMap(),
    };
  }

  factory AuthenticationPolicyResponse.fromMap(Map<String, dynamic> map) {
    return AuthenticationPolicyResponse(
      origins: pulumi.Input.decodeList<OriginAuthenticationMethodResponse>(map['origins'], (value) => OriginAuthenticationMethodResponse.fromMap((value as Map).cast<String, dynamic>())),
      peers: pulumi.Input.decodeList<PeerAuthenticationMethodResponse>(map['peers'], (value) => PeerAuthenticationMethodResponse.fromMap((value as Map).cast<String, dynamic>())),
      principalBinding: map['principalBinding'] as String,
      serverTlsContext: TlsContextResponse.fromMap((map['serverTlsContext'] as Map).cast<String, dynamic>()),
    );
  }
}
