...
class RouterBgpPeerComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advertisedGroups': ?advertisedGroups == null ? null : pulumi.Input.encodeList<RouterBgpPeerAdvertisedGroupsItemComputeV1, String>(advertisedGroups!, (value) => value.value),
      'advertisedIpRanges': ?advertisedIpRanges == null ? null : pulumi.Input.encodeList<RouterAdvertisedIpRangeComputeV1, Map<String, dynamic>>(advertisedIpRanges!, (value) => value.toMap()),
      'advertisedRoutePriority': ?advertisedRoutePriority,
      'bfd': ?bfd == null ? null : bfd!.toMap(),
      'customLearnedIpRanges': ?customLearnedIpRanges == null ? null : pulumi.Input.encodeList<RouterBgpPeerCustomLearnedIpRangeComputeV1, Map<String, dynamic>>(customLearnedIpRanges!, (value) => value.toMap()),
  ...
  factory RouterBgpPeerComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerComputeV1(
      advertiseMode: map['advertiseMode'] == null ? null : RouterBgpPeerAdvertiseModeComputeV1.fromValue(map['advertiseMode'] as String),
      advertisedGroups: map['advertisedGroups'] == null ? null : pulumi.Input.decodeList<RouterBgpPeerAdvertisedGroupsItemComputeV1>(map['advertisedGroups'], (value) => RouterBgpPeerAdvertisedGroupsItemComputeV1.fromValue(value as String)),
      advertisedIpRanges: map['advertisedIpRanges'] == null ? null : pulumi.Input.decodeList<RouterAdvertisedIpRangeComputeV1>(map['advertisedIpRanges'], (value) => RouterAdvertisedIpRangeComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      advertisedRoutePriority: map['advertisedRoutePriority'] == null ? null : map['advertisedRoutePriority'] as int,
      bfd: map['bfd'] == null ? null : RouterBgpPeerBfdComputeV1.fromMap((map['bfd'] as Map).cast<String, dynamic>()),
      customLearnedIpRanges: map['customLearnedIpRanges'] == null ? null : pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeComputeV1>(map['customLearnedIpRanges'], (value) => RouterBgpPeerCustomLearnedIpRangeComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      customLearnedRoutePriority: map['customLearnedRoutePriority'] == null ? null : map['customLearnedRoutePriority'] as int,
      enable: map['enable'] == null ? null : RouterBgpPeerEnableComputeV1.fromValue(map['enable'] as String),
