...
class SchedulingComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities': ?nodeAffinities == null ? null : pulumi.Input.encodeList<SchedulingNodeAffinityComputeV1, Map<String, dynamic>>(nodeAffinities!, (value) => value.toMap()),
  ...
  factory SchedulingComputeV1.fromMap(Map<String, dynamic> map) {
    return SchedulingComputeV1(
      ...
      instanceTerminationAction: map['instanceTerminationAction'] == null ? null : SchedulingInstanceTerminationActionComputeV1.fromValue(map['instanceTerminationAction'] as String),
      localSsdRecoveryTimeout: map['localSsdRecoveryTimeout'] == null ? null : DurationComputeV1.fromMap((map['localSsdRecoveryTimeout'] as Map).cast<String, dynamic>()),
      ...
      nodeAffinities: map['nodeAffinities'] == null ? null : pulumi.Input.decodeList<SchedulingNodeAffinityComputeV1>(map['nodeAffinities'], (value) => SchedulingNodeAffinityComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      onHostMaintenance: map['onHostMaintenance'] == null ? null : SchedulingOnHostMaintenanceComputeV1.fromValue(map['onHostMaintenance'] as String),
      preemptible: map['preemptible'] == null ? null : map['preemptible'] as bool,
      provisioningModel: map['provisioningModel'] == null ? null : SchedulingProvisioningModelComputeV1.fromValue(map['provisioningModel'] as String),
    );
  }
}
