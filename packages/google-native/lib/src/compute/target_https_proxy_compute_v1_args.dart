...
class TargetHttpsProxyComputeV1Args {
  ...
  TargetHttpsProxyComputeV1Args({
    ...
    String? project,
    bool? proxyBind,
    TargetHttpsProxyQuicOverrideComputeV1? quicOverride,
    String? requestId,
    ...
    String? urlMap,
        ...
        quicOverride =
            pulumi.Input.asOptionalInput<TargetHttpsProxyQuicOverrideComputeV1>(
                quicOverride),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (quicOverrideValue != null) {
      map['quicOverride'] = pulumi.Input.mapOptionalInputValue<
          TargetHttpsProxyQuicOverrideComputeV1,
  ...
  factory TargetHttpsProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyComputeV1Args(
      ...
      quicOverride: map['quicOverride'] == null
          ? null
          : TargetHttpsProxyQuicOverrideComputeV1.fromValue(
