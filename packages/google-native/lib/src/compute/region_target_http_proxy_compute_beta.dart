...
import 'region_target_http_proxy_compute_beta_args.dart';

/// Creates a TargetHttpProxy resource in the specified project and region using the data included in the request.
class RegionTargetHttpProxyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionTargetHttpProxyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionTargetHttpProxyComputeBeta]. {@macro pulumi_compute_beta_region_target_http_proxy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionTargetHttpProxyComputeBeta(
    String name, {
    RegionTargetHttpProxyComputeBetaArgs? args,
    ...
    this.httpKeepAliveTimeoutSec = registerOutput<int>(
