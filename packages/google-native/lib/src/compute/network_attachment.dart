...
class NetworkAttachment extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkAttachmentConnectedEndpointResponse>> connectionEndpoints;
  ...
  NetworkAttachment(
    ...
    this.connectionEndpoints = registerOutput<List<NetworkAttachmentConnectedEndpointResponse>>('connectionEndpoints');
