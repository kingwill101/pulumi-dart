...
class InstanceComputeBeta extends pulumi.CustomResource {
  ...
  InstanceComputeBeta(
    ...
    this.displayDevice =
        registerOutput<DisplayDeviceResponseComputeBeta>('displayDevice');
    ...
    this.resourceStatus =
        registerOutput<ResourceStatusResponseComputeBeta>('resourceStatus');
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.scheduling =
        registerOutput<SchedulingResponseComputeBeta>('scheduling');
    ...
    this.shieldedVmConfig =
        registerOutput<ShieldedVmConfigResponseComputeBeta>('shieldedVmConfig');
