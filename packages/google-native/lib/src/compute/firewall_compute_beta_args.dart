...
class FirewallComputeBetaArgs {
  ...
  FirewallComputeBetaArgs({
    List<FirewallAllowedItemComputeBeta>? allowed,
    List<FirewallDeniedItemComputeBeta>? denied,
    String? description,
    List<String>? destinationRanges,
    FirewallDirectionComputeBeta? direction,
    bool? disabled,
    bool? enableLogging,
    FirewallLogConfigComputeBeta? logConfig,
    String? name,
    String? network,
    int? priority,
    String? project,
    ...
    List<String>? targetTags,
            ...
            pulumi.Input.asOptionalInput<List<FirewallAllowedItemComputeBeta>>(
                allowed),
        denied =
            pulumi.Input.asOptionalInput<List<FirewallDeniedItemComputeBeta>>(
                denied),
        description = pulumi.Input.asOptionalInput<String>(description),
        destinationRanges =
            pulumi.Input.asOptionalInput<List<String>>(destinationRanges),
        direction = pulumi.Input.asOptionalInput<FirewallDirectionComputeBeta>(
            direction),
        disabled = pulumi.Input.asOptionalInput<bool>(disabled),
        enableLogging = pulumi.Input.asOptionalInput<bool>(enableLogging),
        logConfig = pulumi.Input.asOptionalInput<FirewallLogConfigComputeBeta>(
            logConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (allowedValue != null) {
      map['allowed'] = pulumi.Input.mapOptionalInputValue<
              List<FirewallAllowedItemComputeBeta>, List<Map<String, dynamic>>>(
          allowedValue,
          (value) => pulumi.Input.encodeList<FirewallAllowedItemComputeBeta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final deniedValue = denied;
    if (deniedValue != null) {
      map['denied'] = pulumi.Input.mapOptionalInputValue<
              List<FirewallDeniedItemComputeBeta>, List<Map<String, dynamic>>>(
          deniedValue,
          (value) => pulumi.Input.encodeList<FirewallDeniedItemComputeBeta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory FirewallComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FirewallComputeBetaArgs(
      allowed: map['allowed'] == null
          ? null
          : pulumi.Input.decodeList<FirewallAllowedItemComputeBeta>(
              map['allowed'],
              (value) => FirewallAllowedItemComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      denied: map['denied'] == null
          ? null
          : pulumi.Input.decodeList<FirewallDeniedItemComputeBeta>(
              map['denied'],
              (value) => FirewallDeniedItemComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      description:
      ...
      direction: map['direction'] == null
          ? null
          : FirewallDirectionComputeBeta.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      enableLogging:
          map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      logConfig: map['logConfig'] == null
          ? null
          : FirewallLogConfigComputeBeta.fromMap(
