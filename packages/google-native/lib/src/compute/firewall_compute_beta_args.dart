...
class FirewallComputeBetaArgs {
  ...
  factory FirewallComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FirewallComputeBetaArgs(
      allowed: map['allowed'] == null ? null : pulumi.Input.decodeList<FirewallAllowedItemComputeBeta>(map['allowed'], (value) => FirewallAllowedItemComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      denied: map['denied'] == null ? null : pulumi.Input.decodeList<FirewallDeniedItemComputeBeta>(map['denied'], (value) => FirewallDeniedItemComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      destinationRanges: map['destinationRanges'] == null ? null : (map['destinationRanges'] as List).cast<String>(),
      direction: map['direction'] == null ? null : FirewallDirectionComputeBeta.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      enableLogging: map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      logConfig: map['logConfig'] == null ? null : FirewallLogConfigComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
