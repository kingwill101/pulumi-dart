...
class License extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LicenseResourceRequirementsResponse> resourceRequirements;
  ...
  /// [args] Arguments used to configure this [License]. {@macro pulumi_compute_alpha_license_args_doc}
  ...
  License(
    ...
    this.resourceRequirements = registerOutput<LicenseResourceRequirementsResponse>('resourceRequirements');
