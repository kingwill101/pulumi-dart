...
class ImageComputeBetaArgs {
  ...
  ImageComputeBetaArgs({
    ...
    List<String>? userLicenses,
           ...
           .Input.asOptionalInput<ImageArchitectureComputeBeta>(architecture),
       archiveSizeBytes = pulumi.Input.asOptionalInput<String>(
         archiveSizeBytes,
       ),
  ...
  factory ImageComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ImageComputeBetaArgs(
      ...
      forceCreate: map['forceCreate'] == null
          ? null
          : map['forceCreate'] as bool,
