...
class ImageComputeBetaArgs {
  ...
  ImageComputeBetaArgs({
    ImageArchitectureComputeBeta? architecture,
    String? archiveSizeBytes,
    DeprecationStatusComputeBeta? deprecated,
    String? description,
    String? diskSizeGb,
    ...
    CustomerEncryptionKeyComputeBeta? imageEncryptionKey,
    ...
    String? name,
    String? project,
    ImageRawDiskComputeBeta? rawDisk,
    String? requestId,
    RolloutPolicyComputeBeta? rolloutOverride,
    InitialStateConfigComputeBeta? shieldedInstanceInitialState,
    String? sourceDisk,
    CustomerEncryptionKeyComputeBeta? sourceDiskEncryptionKey,
    String? sourceImage,
    ...
    ImageSourceTypeComputeBeta? sourceType,
    List<String>? storageLocations,
    List<String>? userLicenses,
  }) :
      architecture = pulumi.Input.asOptionalInput<ImageArchitectureComputeBeta>(architecture),
      archiveSizeBytes = pulumi.Input.asOptionalInput<String>(archiveSizeBytes),
      deprecated = pulumi.Input.asOptionalInput<DeprecationStatusComputeBeta>(deprecated),
      ...
      guestOsFeatures = pulumi.Input.asOptionalInput<List<GuestOsFeatureComputeBeta>>(guestOsFeatures),
      imageEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeBeta>(imageEncryptionKey),
      ...
      rawDisk = pulumi.Input.asOptionalInput<ImageRawDiskComputeBeta>(rawDisk),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      rolloutOverride = pulumi.Input.asOptionalInput<RolloutPolicyComputeBeta>(rolloutOverride),
      shieldedInstanceInitialState = pulumi.Input.asOptionalInput<InitialStateConfigComputeBeta>(shieldedInstanceInitialState),
      sourceDisk = pulumi.Input.asOptionalInput<String>(sourceDisk),
      sourceDiskEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeBeta>(sourceDiskEncryptionKey),
      sourceImage = pulumi.Input.asOptionalInput<String>(sourceImage),
      sourceImageEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeBeta>(sourceImageEncryptionKey),
      sourceSnapshot = pulumi.Input.asOptionalInput<String>(sourceSnapshot),
      sourceSnapshotEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeBeta>(sourceSnapshotEncryptionKey),
      sourceType = pulumi.Input.asOptionalInput<ImageSourceTypeComputeBeta>(sourceType),
  ...
  factory ImageComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ImageComputeBetaArgs(
      architecture: map['architecture'] == null ? null : ImageArchitectureComputeBeta.fromValue(map['architecture'] as String),
      archiveSizeBytes: map['archiveSizeBytes'] == null ? null : map['archiveSizeBytes'] as String,
      deprecated: map['deprecated'] == null ? null : DeprecationStatusComputeBeta.fromMap((map['deprecated'] as Map).cast<String, dynamic>()),
      ...
      forceCreate: map['forceCreate'] == null ? null : map['forceCreate'] as bool,
      guestOsFeatures: map['guestOsFeatures'] == null ? null : pulumi.Input.decodeList<GuestOsFeatureComputeBeta>(map['guestOsFeatures'], (value) => GuestOsFeatureComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      imageEncryptionKey: map['imageEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeBeta.fromMap((map['imageEncryptionKey'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      licenseCodes: map['licenseCodes'] == null ? null : (map['licenseCodes'] as List).cast<String>(),
      ...
      rawDisk: map['rawDisk'] == null ? null : ImageRawDiskComputeBeta.fromMap((map['rawDisk'] as Map).cast<String, dynamic>()),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      rolloutOverride: map['rolloutOverride'] == null ? null : RolloutPolicyComputeBeta.fromMap((map['rolloutOverride'] as Map).cast<String, dynamic>()),
      shieldedInstanceInitialState: map['shieldedInstanceInitialState'] == null ? null : InitialStateConfigComputeBeta.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>()),
      sourceDisk: map['sourceDisk'] == null ? null : map['sourceDisk'] as String,
      sourceDiskEncryptionKey: map['sourceDiskEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeBeta.fromMap((map['sourceDiskEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceImage: map['sourceImage'] == null ? null : map['sourceImage'] as String,
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeBeta.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceSnapshot: map['sourceSnapshot'] == null ? null : map['sourceSnapshot'] as String,
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeBeta.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceType: map['sourceType'] == null ? null : ImageSourceTypeComputeBeta.fromValue(map['sourceType'] as String),
      storageLocations: map['storageLocations'] == null ? null : (map['storageLocations'] as List).cast<String>(),
      userLicenses: map['userLicenses'] == null ? null : (map['userLicenses'] as List).cast<String>(),
    );
  }
}
