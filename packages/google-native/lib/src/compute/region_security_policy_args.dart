    ...
    return <String, dynamic>{
      ...
      'cloudArmorConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cloudArmorConfig, (value) => value.toMap()),
      'ddosProtectionConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<RegionSecurityPolicyType, String>(
            type,
            (value) => value.value,
          ),
      'userDefinedFields':
  ...
  factory RegionSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyArgs(
      ...
      associations: map['associations'] == null
          ? null
          : pulumi.Input.decodeList<SecurityPolicyAssociation>(
              map['associations'],
              (value) => SecurityPolicyAssociation.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      cloudArmorConfig: map['cloudArmorConfig'] == null
          ? null
          : SecurityPolicyCloudArmorConfig.fromMap(
              (map['cloudArmorConfig'] as Map).cast<String, dynamic>(),
            ),
      ddosProtectionConfig: map['ddosProtectionConfig'] == null
          ? null
          : SecurityPolicyDdosProtectionConfig.fromMap(
      ...
      type: map['type'] == null
          ? null
          : RegionSecurityPolicyType.fromValue(map['type'] as String),
      userDefinedFields: map['userDefinedFields'] == null
          ? null
          : pulumi.Input.decodeList<SecurityPolicyUserDefinedField>(
              map['userDefinedFields'],
              (value) => SecurityPolicyUserDefinedField.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
    );
