...
import 'region_security_policy_type.dart';
...
/// {@template pulumi_compute_alpha_region_security_policy_args_doc}
/// The set of arguments for RegionSecurityPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_security_policy_args_doc}
class RegionSecurityPolicyArgs {
  ...
  final pulumi.Input<RegionSecurityPolicyType>? type;
  ...
  RegionSecurityPolicyArgs({
    ...
    List<SecurityPolicyAssociation>? associations,
    SecurityPolicyCloudArmorConfig? cloudArmorConfig,
    ...
    List<SecurityPolicyUserDefinedField>? userDefinedFields,
  }) :
      ...
      type = pulumi.Input.asOptionalInput<RegionSecurityPolicyType>(type),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionSecurityPolicyType, String>(type, (value) => value.value),
  ...
  factory RegionSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyArgs(
      ...
      associations: map['associations'] == null ? null : pulumi.Input.decodeList<SecurityPolicyAssociation>(map['associations'], (value) => SecurityPolicyAssociation.fromMap((value as Map).cast<String, dynamic>())),
      cloudArmorConfig: map['cloudArmorConfig'] == null ? null : SecurityPolicyCloudArmorConfig.fromMap((map['cloudArmorConfig'] as Map).cast<String, dynamic>()),
      ddosProtectionConfig: map['ddosProtectionConfig'] == null ? null : SecurityPolicyDdosProtectionConfig.fromMap((map['ddosProtectionConfig'] as Map).cast<String, dynamic>()),
      ...
      type: map['type'] == null ? null : RegionSecurityPolicyType.fromValue(map['type'] as String),
      userDefinedFields: map['userDefinedFields'] == null ? null : pulumi.Input.decodeList<SecurityPolicyUserDefinedField>(map['userDefinedFields'], (value) => SecurityPolicyUserDefinedField.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
