...
class GetSubnetworkComputeBetaResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['allowSubnetCidrRoutesOverlap'] = allowSubnetCidrRoutesOverlap;
    map['creationTimestamp'] = creationTimestamp;
    map['description'] = description;
    map['enableFlowLogs'] = enableFlowLogs;
    map['externalIpv6Prefix'] = externalIpv6Prefix;
    map['fingerprint'] = fingerprint;
    map['gatewayAddress'] = gatewayAddress;
    map['internalIpv6Prefix'] = internalIpv6Prefix;
    map['ipCidrRange'] = ipCidrRange;
    map['ipv6AccessType'] = ipv6AccessType;
    map['ipv6CidrRange'] = ipv6CidrRange;
    map['kind'] = kind;
  ...
  factory GetSubnetworkComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetSubnetworkComputeBetaResult(
      ...
      logConfig: SubnetworkLogConfigResponseComputeBeta.fromMap(
      ...
      secondaryIpRanges:
          pulumi.Input.decodeList<SubnetworkSecondaryRangeResponseComputeBeta>(
              map['secondaryIpRanges'],
              (value) => SubnetworkSecondaryRangeResponseComputeBeta.fromMap(
