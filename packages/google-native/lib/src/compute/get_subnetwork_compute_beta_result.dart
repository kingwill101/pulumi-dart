...
import 'subnetwork_secondary_range_response_compute_beta.dart';

/// Result data returned by getSubnetwork.
class GetSubnetworkComputeBetaResult {
  ...
  final bool allowSubnetCidrRoutesOverlap;
  ...
  final SubnetworkLogConfigResponseComputeBeta logConfig;
  ...
  final List<SubnetworkSecondaryRangeResponseComputeBeta> secondaryIpRanges;
  ...
  /// Creates a new [GetSubnetworkComputeBetaResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'role': role,
      'secondaryIpRanges': pulumi.Input.encodeList<SubnetworkSecondaryRangeResponseComputeBeta, Map<String, dynamic>>(secondaryIpRanges, (value) => value.toMap()),
      'selfLink': selfLink,
      'stackType': stackType,
      'state': state,
    };
  ...
  factory GetSubnetworkComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetSubnetworkComputeBetaResult(
      allowSubnetCidrRoutesOverlap: map['allowSubnetCidrRoutesOverlap'] as bool,
      ...
      logConfig: SubnetworkLogConfigResponseComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      ...
      secondaryIpRanges: pulumi.Input.decodeList<SubnetworkSecondaryRangeResponseComputeBeta>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
