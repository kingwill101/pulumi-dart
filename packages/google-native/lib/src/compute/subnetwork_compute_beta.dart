...
class SubnetworkComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SubnetworkSecondaryRangeResponseComputeBeta>>
  secondaryIpRanges;
  ...
  SubnetworkComputeBeta(
    ...
    this.logConfig = registerOutput<SubnetworkLogConfigResponseComputeBeta>(
      'logConfig',
    );
    ...
    this.secondaryIpRanges =
        registerOutput<List<SubnetworkSecondaryRangeResponseComputeBeta>>(
          'secondaryIpRanges',
        );
