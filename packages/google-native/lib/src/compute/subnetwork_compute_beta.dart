...
class SubnetworkComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SubnetworkSecondaryRangeResponseComputeBeta>> secondaryIpRanges;
  ...
  SubnetworkComputeBeta(
    ...
    this.allowSubnetCidrRoutesOverlap = registerOutput<bool>('allowSubnetCidrRoutesOverlap');
    ...
    this.logConfig = registerOutput<SubnetworkLogConfigResponseComputeBeta>('logConfig');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.privateIpGoogleAccess = registerOutput<bool>('privateIpGoogleAccess');
    this.privateIpv6GoogleAccess = registerOutput<String>('privateIpv6GoogleAccess');
    ...
    this.secondaryIpRanges = registerOutput<List<SubnetworkSecondaryRangeResponseComputeBeta>>('secondaryIpRanges');
