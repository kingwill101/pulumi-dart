...
import 'region_ssl_policy_warnings_item_response_compute_v1.dart';

/// Result data returned by getRegionSslPolicy.
class GetRegionSslPolicyComputeV1Result {
  ...
  final List<RegionSslPolicyWarningsItemResponseComputeV1> warnings;

  /// Creates a new [GetRegionSslPolicyComputeV1Result].
  ...
  GetRegionSslPolicyComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'selfLink': selfLink,
      'warnings': pulumi.Input.encodeList<RegionSslPolicyWarningsItemResponseComputeV1, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }

  factory GetRegionSslPolicyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionSslPolicyComputeV1Result(
      ...
      warnings: pulumi.Input.decodeList<RegionSslPolicyWarningsItemResponseComputeV1>(map['warnings'], (value) => RegionSslPolicyWarningsItemResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
