...
class RegionSslPolicyWarningsItemResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'code': code,
      'data': pulumi.Input.encodeList<RegionSslPolicyWarningsItemDataItemResponse, Map<String, dynamic>>(data, (value) => value.toMap()),
      'message': message,
    };
  }
  ...
  factory RegionSslPolicyWarningsItemResponse.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyWarningsItemResponse(
      ...
      data: pulumi.Input.decodeList<RegionSslPolicyWarningsItemDataItemResponse>(map['data'], (value) => RegionSslPolicyWarningsItemDataItemResponse.fromMap((value as Map).cast<String, dynamic>())),
