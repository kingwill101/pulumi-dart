...
class FirewallPolicyRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetSecureTags': ?targetSecureTags == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleSecureTag, Map<String, dynamic>>(targetSecureTags!, (value) => value.toMap()),
  ...
  factory FirewallPolicyRule.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRule(
      ...
      direction: map['direction'] == null ? null : FirewallPolicyRuleDirection.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      enableLogging: map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      match: map['match'] == null ? null : FirewallPolicyRuleMatcher.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleSecureTag>(map['targetSecureTags'], (value) => FirewallPolicyRuleSecureTag.fromMap((value as Map).cast<String, dynamic>())),
