...
class BackendServiceConnectionTrackingPolicyComputeV1 {
  ...
  final BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeV1? connectionPersistenceOnUnhealthyBackends;
  ...
  final BackendServiceConnectionTrackingPolicyTrackingModeComputeV1? trackingMode;
  ...
  factory BackendServiceConnectionTrackingPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicyComputeV1(
      connectionPersistenceOnUnhealthyBackends: map['connectionPersistenceOnUnhealthyBackends'] == null ? null : BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeV1.fromValue(map['connectionPersistenceOnUnhealthyBackends'] as String),
      ...
      trackingMode: map['trackingMode'] == null ? null : BackendServiceConnectionTrackingPolicyTrackingModeComputeV1.fromValue(map['trackingMode'] as String),
    );
  }
}
