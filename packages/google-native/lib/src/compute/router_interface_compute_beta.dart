...
class RouterInterfaceComputeBeta {
  ...
  final RouterInterfaceIpVersionComputeBeta? ipVersion;
  ...
  factory RouterInterfaceComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterInterfaceComputeBeta(
      ...
      ipVersion: map['ipVersion'] == null ? null : RouterInterfaceIpVersionComputeBeta.fromValue(map['ipVersion'] as String),
