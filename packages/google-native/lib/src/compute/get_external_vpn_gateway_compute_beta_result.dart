...
class GetExternalVpnGatewayComputeBetaResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['interfaces'] = pulumi.Input.encodeList<
        ExternalVpnGatewayInterfaceResponseComputeBeta,
  ...
  factory GetExternalVpnGatewayComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetExternalVpnGatewayComputeBetaResult(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      interfaces: pulumi.Input.decodeList<
              ExternalVpnGatewayInterfaceResponseComputeBeta>(
          map['interfaces'],
          (value) => ExternalVpnGatewayInterfaceResponseComputeBeta.fromMap(
