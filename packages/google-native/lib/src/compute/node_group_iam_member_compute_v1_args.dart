...
/// {@template pulumi_compute_v1_node_group_iam_member_compute_v1_args_doc}
/// The set of arguments for NodeGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_node_group_iam_member_compute_v1_args_doc}
class NodeGroupIamMemberComputeV1Args {
  ...
  /// Creates a new [NodeGroupIamMemberComputeV1Args].
  ...
  NodeGroupIamMemberComputeV1Args({
    Condition? condition,
  ...
  factory NodeGroupIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeGroupIamMemberComputeV1Args(
