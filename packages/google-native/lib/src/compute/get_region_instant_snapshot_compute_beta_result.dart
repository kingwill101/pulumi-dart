...
import 'instant_snapshot_resource_status_response_compute_beta.dart';

/// Result data returned by getRegionInstantSnapshot.
class GetRegionInstantSnapshotComputeBetaResult {
  ...
  final InstantSnapshotResourceStatusResponseComputeBeta resourceStatus;
  ...
  /// Creates a new [GetRegionInstantSnapshotComputeBetaResult].
  ...
  GetRegionInstantSnapshotComputeBetaResult({
  ...
  factory GetRegionInstantSnapshotComputeBetaResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRegionInstantSnapshotComputeBetaResult(
      ...
      resourceStatus: InstantSnapshotResourceStatusResponseComputeBeta.fromMap(
