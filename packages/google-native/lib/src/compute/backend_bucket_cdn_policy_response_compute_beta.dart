...
class BackendBucketCdnPolicyResponseComputeBeta {
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta>
  ...
  factory BackendBucketCdnPolicyResponseComputeBeta.fromMap(
    ...
    return BackendBucketCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders:
          ...
          >(
            ...
            (value) =>
                BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      cacheKeyPolicy:
          BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta.fromMap(
      ...
      negativeCachingPolicy:
          ...
          >(
            ...
            (value) =>
                BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
