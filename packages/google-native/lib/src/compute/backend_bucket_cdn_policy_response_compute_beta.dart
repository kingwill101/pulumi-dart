...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header_response_compute_beta.dart';
import 'backend_bucket_cdn_policy_cache_key_policy_response_compute_beta.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy_response_compute_beta.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicyResponseComputeBeta {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta cacheKeyPolicy;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta> negativeCachingPolicy;
  ...
  final List<String> signedUrlKeyNames;

  /// Creates a new [BackendBucketCdnPolicyResponseComputeBeta].
  ...
  BackendBucketCdnPolicyResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.encodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta, Map<String, dynamic>>(bypassCacheOnRequestHeaders, (value) => value.toMap()),
      'cacheKeyPolicy': cacheKeyPolicy.toMap(),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicy': pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta, Map<String, dynamic>>(negativeCachingPolicy, (value) => value.toMap()),
  ...
  factory BackendBucketCdnPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders: pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>(map['bypassCacheOnRequestHeaders'], (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      ...
      negativeCachingPolicy: pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta>(map['negativeCachingPolicy'], (value) => BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      requestCoalescing: map['requestCoalescing'] as bool,
      serveWhileStale: map['serveWhileStale'] as int,
      signedUrlCacheMaxAgeSec: map['signedUrlCacheMaxAgeSec'] as String,
      signedUrlKeyNames: (map['signedUrlKeyNames'] as List).cast<String>(),
    );
  }
}
