...
class RuleComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<ConditionComputeV1, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
      'description': ?description,
      'ins': ?ins,
      'logConfigs': ?logConfigs == null ? null : pulumi.Input.encodeList<LogConfigComputeV1, Map<String, dynamic>>(logConfigs!, (value) => value.toMap()),
      'notIns': ?notIns,
  ...
  factory RuleComputeV1.fromMap(Map<String, dynamic> map) {
    return RuleComputeV1(
      action: map['action'] == null ? null : RuleActionComputeV1.fromValue(map['action'] as String),
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<ConditionComputeV1>(map['conditions'], (value) => ConditionComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      ins: map['ins'] == null ? null : (map['ins'] as List).cast<String>(),
      logConfigs: map['logConfigs'] == null ? null : pulumi.Input.decodeList<LogConfigComputeV1>(map['logConfigs'], (value) => LogConfigComputeV1.fromMap((value as Map).cast<String, dynamic>())),
