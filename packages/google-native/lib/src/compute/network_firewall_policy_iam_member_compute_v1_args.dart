...
/// {@template pulumi_compute_v1_network_firewall_policy_iam_member_compute_v1_args_doc}
/// The set of arguments for NetworkFirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_network_firewall_policy_iam_member_compute_v1_args_doc}
class NetworkFirewallPolicyIamMemberComputeV1Args {
  ...
  /// Creates a new [NetworkFirewallPolicyIamMemberComputeV1Args].
  ...
  NetworkFirewallPolicyIamMemberComputeV1Args({
    Condition? condition,
  ...
  factory NetworkFirewallPolicyIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamMemberComputeV1Args(
