...
class PacketMirroring extends pulumi.CustomResource {
  ...
  PacketMirroring(
    ...
    this.collectorIlb = registerOutput<PacketMirroringForwardingRuleInfoResponse>('collectorIlb');
    ...
    this.mirroredResources = registerOutput<PacketMirroringMirroredResourceInfoResponse>('mirroredResources');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<PacketMirroringNetworkInfoResponse>('network');
