...
class AddressComputeBetaArgs {
  ...
  AddressComputeBetaArgs({
    String? address,
    AddressAddressTypeComputeBeta? addressType,
    String? description,
    AddressIpVersionComputeBeta? ipVersion,
    AddressIpv6EndpointTypeComputeBeta? ipv6EndpointType,
    Map<String, String>? labels,
    String? name,
    String? network,
    AddressNetworkTierComputeBeta? networkTier,
    int? prefixLength,
    String? project,
    AddressPurposeComputeBeta? purpose,
  ...
  factory AddressComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return AddressComputeBetaArgs(
      ...
      addressType: map['addressType'] == null ? null : AddressAddressTypeComputeBeta.fromValue(map['addressType'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      ipVersion: map['ipVersion'] == null ? null : AddressIpVersionComputeBeta.fromValue(map['ipVersion'] as String),
      ipv6EndpointType: map['ipv6EndpointType'] == null ? null : AddressIpv6EndpointTypeComputeBeta.fromValue(map['ipv6EndpointType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkTier: map['networkTier'] == null ? null : AddressNetworkTierComputeBeta.fromValue(map['networkTier'] as String),
      prefixLength: map['prefixLength'] == null ? null : map['prefixLength'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null ? null : AddressPurposeComputeBeta.fromValue(map['purpose'] as String),
