...
class AddressComputeBetaArgs {
  ...
  AddressComputeBetaArgs({
    ...
    String? subnetwork,
       ...
       addressType = pulumi
           .Input.asOptionalInput<AddressAddressTypeComputeBeta>(addressType),
       ...
       networkTier = pulumi
           .Input.asOptionalInput<AddressNetworkTierComputeBeta>(networkTier),
    ...
    return <String, dynamic>{
      ...
      'ipv6EndpointType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(ipv6EndpointType, (value) => value.value),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'networkTier':
  ...
  factory AddressComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return AddressComputeBetaArgs(
      ...
      addressType: map['addressType'] == null
          ? null
          : AddressAddressTypeComputeBeta.fromValue(
      ...
      ipVersion: map['ipVersion'] == null
          ? null
          : AddressIpVersionComputeBeta.fromValue(map['ipVersion'] as String),
      ipv6EndpointType: map['ipv6EndpointType'] == null
          ? null
          : AddressIpv6EndpointTypeComputeBeta.fromValue(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : AddressNetworkTierComputeBeta.fromValue(
      ...
      purpose: map['purpose'] == null
          ? null
          : AddressPurposeComputeBeta.fromValue(map['purpose'] as String),
