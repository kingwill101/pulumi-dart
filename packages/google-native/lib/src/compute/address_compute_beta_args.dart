...
class AddressComputeBetaArgs {
  ...
  AddressComputeBetaArgs({
    ...
    String? subnetwork,
        ...
        addressType =
            pulumi.Input.asOptionalInput<AddressAddressTypeComputeBeta>(
                addressType),
        ...
        networkTier =
            pulumi.Input.asOptionalInput<AddressNetworkTierComputeBeta>(
                networkTier),
        prefixLength = pulumi.Input.asOptionalInput<int>(prefixLength),
        project = pulumi.Input.asOptionalInput<String>(project),
        purpose =
            pulumi.Input.asOptionalInput<AddressPurposeComputeBeta>(purpose),
