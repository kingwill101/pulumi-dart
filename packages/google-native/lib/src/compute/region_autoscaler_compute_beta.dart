...
class RegionAutoscalerComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AutoscalingPolicyResponseComputeBeta>
  autoscalingPolicy;
  ...
  late final pulumi.Output<List<AutoscalerStatusDetailsResponseComputeBeta>>
  statusDetails;
  ...
  RegionAutoscalerComputeBeta(
    ...
    this.autoscalingPolicy =
        registerOutput<AutoscalingPolicyResponseComputeBeta>(
          'autoscalingPolicy',
        );
    ...
    this.scalingScheduleStatus = registerOutput<Map<String, String>>(
      'scalingScheduleStatus',
    );
    this.selfLink = registerOutput<String>('selfLink');
    this.status = registerOutput<String>('status');
    this.statusDetails =
        registerOutput<List<AutoscalerStatusDetailsResponseComputeBeta>>(
          'statusDetails',
        );
