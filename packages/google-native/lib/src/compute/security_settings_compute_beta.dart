...
class SecuritySettingsComputeBeta {
  ...
  final AWSV4SignatureComputeBeta? awsV4Authentication;
  ...
  factory SecuritySettingsComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsComputeBeta(
      ...
      awsV4Authentication: map['awsV4Authentication'] == null ? null : AWSV4SignatureComputeBeta.fromMap((map['awsV4Authentication'] as Map).cast<String, dynamic>()),
