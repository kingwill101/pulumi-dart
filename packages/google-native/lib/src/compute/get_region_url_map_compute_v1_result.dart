...
class GetRegionUrlMapComputeV1Result {
  ...
  /// Creates a new [GetRegionUrlMapComputeV1Result].
  ...
  GetRegionUrlMapComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['hostRules'] = pulumi.Input.encodeList<HostRuleResponseComputeV1,
        Map<String, dynamic>>(hostRules, (value) => value.toMap());
    map['kind'] = kind;
    map['name'] = name;
    map['pathMatchers'] = pulumi.Input.encodeList<PathMatcherResponseComputeV1,
        Map<String, dynamic>>(pathMatchers, (value) => value.toMap());
    map['region'] = region;
    map['selfLink'] = selfLink;
    map['tests'] = pulumi.Input.encodeList<UrlMapTestResponseComputeV1,
        Map<String, dynamic>>(tests, (value) => value.toMap());
    return map;
  }

  factory GetRegionUrlMapComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionUrlMapComputeV1Result(
      ...
      hostRules: pulumi.Input.decodeList<HostRuleResponseComputeV1>(
          map['hostRules'],
          (value) => HostRuleResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      kind: map['kind'] as String,
      name: map['name'] as String,
      pathMatchers: pulumi.Input.decodeList<PathMatcherResponseComputeV1>(
          map['pathMatchers'],
          (value) => PathMatcherResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      tests: pulumi.Input.decodeList<UrlMapTestResponseComputeV1>(
          map['tests'],
          (value) => UrlMapTestResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
