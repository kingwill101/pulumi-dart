...
class RouterComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RouterMd5AuthenticationKeyResponseComputeV1>>
  ...
  RouterComputeV1(
    ...
    this.bgpPeers = registerOutput<List<RouterBgpPeerResponseComputeV1>>(
      'bgpPeers',
    );
    ...
    this.interfaces = registerOutput<List<RouterInterfaceResponseComputeV1>>(
      'interfaces',
    );
    this.kind = registerOutput<String>('kind');
    this.md5AuthenticationKeys =
        registerOutput<List<RouterMd5AuthenticationKeyResponseComputeV1>>(
          'md5AuthenticationKeys',
        );
