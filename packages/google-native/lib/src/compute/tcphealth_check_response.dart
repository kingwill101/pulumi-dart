...
class TCPHealthCheckResponse {
  ...
  /// Creates a new [TCPHealthCheckResponse].
  ...
  factory TCPHealthCheckResponse.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckResponse(
