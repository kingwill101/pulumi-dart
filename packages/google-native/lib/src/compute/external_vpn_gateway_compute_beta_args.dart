...
class ExternalVpnGatewayComputeBetaArgs {
  ...
  final pulumi.Input<ExternalVpnGatewayRedundancyTypeComputeBeta>?
      redundancyType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (interfacesValue != null) {
      map['interfaces'] = pulumi.Input.mapOptionalInputValue<
              List<ExternalVpnGatewayInterfaceComputeBeta>,
    ...
    if (redundancyTypeValue != null) {
      map['redundancyType'] = pulumi.Input.mapOptionalInputValue<
          ExternalVpnGatewayRedundancyTypeComputeBeta,
  ...
  factory ExternalVpnGatewayComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayComputeBetaArgs(
      ...
      interfaces: map['interfaces'] == null
          ? null
          : pulumi.Input.decodeList<ExternalVpnGatewayInterfaceComputeBeta>(
              map['interfaces'],
              (value) => ExternalVpnGatewayInterfaceComputeBeta.fromMap(
      ...
      redundancyType: map['redundancyType'] == null
          ? null
          : ExternalVpnGatewayRedundancyTypeComputeBeta.fromValue(
