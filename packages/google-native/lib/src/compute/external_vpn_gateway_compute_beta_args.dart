...
class ExternalVpnGatewayComputeBetaArgs {
  ...
  ExternalVpnGatewayComputeBetaArgs({
    String? description,
    List<ExternalVpnGatewayInterfaceComputeBeta>? interfaces,
    Map<String, String>? labels,
    String? name,
    String? project,
    ExternalVpnGatewayRedundancyTypeComputeBeta? redundancyType,
    String? requestId,
  }) :
  ...
  factory ExternalVpnGatewayComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayComputeBetaArgs(
      ...
      interfaces: map['interfaces'] == null ? null : pulumi.Input.decodeList<ExternalVpnGatewayInterfaceComputeBeta>(map['interfaces'], (value) => ExternalVpnGatewayInterfaceComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      redundancyType: map['redundancyType'] == null ? null : ExternalVpnGatewayRedundancyTypeComputeBeta.fromValue(map['redundancyType'] as String),
