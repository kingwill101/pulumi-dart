...
class TargetPoolArgs {
  ...
  TargetPoolArgs({
    ...
    TargetPoolSessionAffinity? sessionAffinity,
        ...
        sessionAffinity =
            pulumi.Input.asOptionalInput<TargetPoolSessionAffinity>(
                sessionAffinity);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sessionAffinityValue != null) {
      map['sessionAffinity'] =
          pulumi.Input.mapOptionalInputValue<TargetPoolSessionAffinity, String>(
  ...
  factory TargetPoolArgs.fromMap(Map<String, dynamic> map) {
    return TargetPoolArgs(
      ...
      sessionAffinity: map['sessionAffinity'] == null
          ? null
          : TargetPoolSessionAffinity.fromValue(
