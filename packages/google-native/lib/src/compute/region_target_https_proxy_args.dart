...
class RegionTargetHttpsProxyArgs {
  ...
  RegionTargetHttpsProxyArgs({
    ...
    String? project,
    bool? proxyBind,
    RegionTargetHttpsProxyQuicOverride? quicOverride,
  ...
  factory RegionTargetHttpsProxyArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyArgs(
      ...
      quicOverride: map['quicOverride'] == null ? null : RegionTargetHttpsProxyQuicOverride.fromValue(map['quicOverride'] as String),
