...
class SecurityPolicyRuleResponseComputeV1 {
  ...
  final SecurityPolicyRulePreconfiguredWafConfigResponseComputeV1
  ...
  factory SecurityPolicyRuleResponseComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return SecurityPolicyRuleResponseComputeV1(
      action: map['action'] as String,
      description: map['description'] as String,
      headerAction: SecurityPolicyRuleHttpHeaderActionResponseComputeV1.fromMap(
        (map['headerAction'] as Map).cast<String, dynamic>(),
      ),
      kind: map['kind'] as String,
      match: SecurityPolicyRuleMatcherResponseComputeV1.fromMap(
        (map['match'] as Map).cast<String, dynamic>(),
      ),
      networkMatch: SecurityPolicyRuleNetworkMatcherResponseComputeV1.fromMap(
        (map['networkMatch'] as Map).cast<String, dynamic>(),
      ),
      preconfiguredWafConfig:
          SecurityPolicyRulePreconfiguredWafConfigResponseComputeV1.fromMap(
            (map['preconfiguredWafConfig'] as Map).cast<String, dynamic>(),
          ),
      preview: map['preview'] as bool,
      priority: map['priority'] as int,
      rateLimitOptions:
          SecurityPolicyRuleRateLimitOptionsResponseComputeV1.fromMap(
