...
class SecurityPolicyRuleResponseComputeV1 {
  ...
  final SecurityPolicyRuleHttpHeaderActionResponseComputeV1 headerAction;
  /// [Output only] Type of the resource. Always compute#securityPolicyRule for security policy rules
  final String kind;
  /// A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
  final SecurityPolicyRuleMatcherResponseComputeV1 match;
  ...
  final SecurityPolicyRuleNetworkMatcherResponseComputeV1 networkMatch;
  /// Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  final SecurityPolicyRulePreconfiguredWafConfigResponseComputeV1 preconfiguredWafConfig;
  /// If set to true, the specified action is not enforced.
  final bool preview;
  /// An integer indicating the priority of a rule in the list. The priority must be a positive value between 0 and 2147483647. Rules are evaluated from highest to lowest priority where 0 is the highest priority and 2147483647 is the lowest priority.
  final int priority;
  /// Must be specified if the action is "rate_based_ban" or "throttle". Cannot be specified for any other actions.
  final SecurityPolicyRuleRateLimitOptionsResponseComputeV1 rateLimitOptions;
  /// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final SecurityPolicyRuleRedirectOptionsResponseComputeV1 redirectOptions;
  ...
  factory SecurityPolicyRuleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponseComputeV1(
      ...
      headerAction: SecurityPolicyRuleHttpHeaderActionResponseComputeV1.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      match: SecurityPolicyRuleMatcherResponseComputeV1.fromMap((map['match'] as Map).cast<String, dynamic>()),
      networkMatch: SecurityPolicyRuleNetworkMatcherResponseComputeV1.fromMap((map['networkMatch'] as Map).cast<String, dynamic>()),
      preconfiguredWafConfig: SecurityPolicyRulePreconfiguredWafConfigResponseComputeV1.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>()),
      preview: map['preview'] as bool,
      priority: map['priority'] as int,
      rateLimitOptions: SecurityPolicyRuleRateLimitOptionsResponseComputeV1.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>()),
      redirectOptions: SecurityPolicyRuleRedirectOptionsResponseComputeV1.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
