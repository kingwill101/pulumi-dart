...
class InterconnectAttachmentComputeBetaArgs {
  ...
  InterconnectAttachmentComputeBetaArgs({
    bool? adminEnabled,
    InterconnectAttachmentBandwidthComputeBeta? bandwidth,
    ...
    String? description,
    InterconnectAttachmentEdgeAvailabilityDomainComputeBeta? edgeAvailabilityDomain,
    InterconnectAttachmentEncryptionComputeBeta? encryption,
    String? interconnect,
    ...
    String? pairingKey,
    String? partnerAsn,
    InterconnectAttachmentPartnerMetadataComputeBeta? partnerMetadata,
    String? project,
    required String region,
    String? requestId,
    String? router,
    InterconnectAttachmentStackTypeComputeBeta? stackType,
    int? subnetLength,
    InterconnectAttachmentTypeComputeBeta? type,
    int? vlanTag8021q,
  }) :
  ...
  factory InterconnectAttachmentComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentComputeBetaArgs(
      ...
      bandwidth: map['bandwidth'] == null ? null : InterconnectAttachmentBandwidthComputeBeta.fromValue(map['bandwidth'] as String),
      ...
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : InterconnectAttachmentEdgeAvailabilityDomainComputeBeta.fromValue(map['edgeAvailabilityDomain'] as String),
      encryption: map['encryption'] == null ? null : InterconnectAttachmentEncryptionComputeBeta.fromValue(map['encryption'] as String),
      ...
      partnerMetadata: map['partnerMetadata'] == null ? null : InterconnectAttachmentPartnerMetadataComputeBeta.fromMap((map['partnerMetadata'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      router: map['router'] == null ? null : map['router'] as String,
      stackType: map['stackType'] == null ? null : InterconnectAttachmentStackTypeComputeBeta.fromValue(map['stackType'] as String),
      subnetLength: map['subnetLength'] == null ? null : map['subnetLength'] as int,
      type: map['type'] == null ? null : InterconnectAttachmentTypeComputeBeta.fromValue(map['type'] as String),
