...
class InterconnectAttachmentComputeBetaArgs {
  ...
  InterconnectAttachmentComputeBetaArgs({
    ...
    int? vlanTag8021q,
        ...
        type =
            pulumi.Input.asOptionalInput<InterconnectAttachmentTypeComputeBeta>(
                type),
  ...
  factory InterconnectAttachmentComputeBetaArgs.fromMap(
    ...
    return InterconnectAttachmentComputeBetaArgs(
      ...
      bandwidth: map['bandwidth'] == null
          ? null
          : InterconnectAttachmentBandwidthComputeBeta.fromValue(
      ...
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null
          ? null
          : InterconnectAttachmentEdgeAvailabilityDomainComputeBeta.fromValue(
              map['edgeAvailabilityDomain'] as String),
      encryption: map['encryption'] == null
          ? null
          : InterconnectAttachmentEncryptionComputeBeta.fromValue(
      ...
      partnerMetadata: map['partnerMetadata'] == null
          ? null
          : InterconnectAttachmentPartnerMetadataComputeBeta.fromMap(
      ...
      stackType: map['stackType'] == null
          ? null
          : InterconnectAttachmentStackTypeComputeBeta.fromValue(
              map['stackType'] as String),
      subnetLength:
          map['subnetLength'] == null ? null : map['subnetLength'] as int,
      type: map['type'] == null
          ? null
          : InterconnectAttachmentTypeComputeBeta.fromValue(
              map['type'] as String),
      vlanTag8021q:
