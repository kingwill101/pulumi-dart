...
class RegionSslCertificateComputeV1Args {
  ...
  RegionSslCertificateComputeV1Args({
    String? certificate,
    String? description,
    SslCertificateManagedSslCertificateComputeV1? managed,
    String? name,
    String? privateKey,
    String? project,
    required String region,
    String? requestId,
    SslCertificateSelfManagedSslCertificateComputeV1? selfManaged,
    RegionSslCertificateTypeComputeV1? type,
  }) :
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionSslCertificateTypeComputeV1, String>(type, (value) => value.value),
    };
  }
  ...
  factory RegionSslCertificateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionSslCertificateComputeV1Args(
      ...
      managed: map['managed'] == null ? null : SslCertificateManagedSslCertificateComputeV1.fromMap((map['managed'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      privateKey: map['privateKey'] == null ? null : map['privateKey'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      selfManaged: map['selfManaged'] == null ? null : SslCertificateSelfManagedSslCertificateComputeV1.fromMap((map['selfManaged'] as Map).cast<String, dynamic>()),
      type: map['type'] == null ? null : RegionSslCertificateTypeComputeV1.fromValue(map['type'] as String),
    );
  }
}
