  ...
  factory SslCertificateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SslCertificateComputeV1Args(
      ...
      managed: map['managed'] == null
          ? null
          : SslCertificateManagedSslCertificateComputeV1.fromMap(
      ...
      selfManaged: map['selfManaged'] == null
          ? null
          : SslCertificateSelfManagedSslCertificateComputeV1.fromMap(
              (map['selfManaged'] as Map).cast<String, dynamic>()),
      type: map['type'] == null
          ? null
          : SslCertificateTypeComputeV1.fromValue(map['type'] as String),
    );
  }
}
