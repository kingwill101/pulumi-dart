...
/// {@template pulumi_compute_v1_service_attachment_iam_member_compute_v1_args_doc}
/// The set of arguments for ServiceAttachmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_service_attachment_iam_member_compute_v1_args_doc}
class ServiceAttachmentIamMemberComputeV1Args {
  ...
  /// Creates a new [ServiceAttachmentIamMemberComputeV1Args].
  ...
  ServiceAttachmentIamMemberComputeV1Args({
    Condition? condition,
  ...
  factory ServiceAttachmentIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentIamMemberComputeV1Args(
