...
class SubnetworkArgs {
  ...
  factory SubnetworkArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs(
      aggregationInterval: map['aggregationInterval'] == null ? null : SubnetworkAggregationInterval.fromValue(map['aggregationInterval'] as String),
      ...
      enablePrivateV6Access: map['enablePrivateV6Access'] == null ? null : map['enablePrivateV6Access'] as bool,
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : SubnetworkIpv6AccessType.fromValue(map['ipv6AccessType'] as String),
      logConfig: map['logConfig'] == null ? null : SubnetworkLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      metadata: map['metadata'] == null ? null : SubnetworkMetadata.fromValue(map['metadata'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      privateIpGoogleAccess: map['privateIpGoogleAccess'] == null ? null : map['privateIpGoogleAccess'] as bool,
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : SubnetworkPrivateIpv6GoogleAccess.fromValue(map['privateIpv6GoogleAccess'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null ? null : SubnetworkPurpose.fromValue(map['purpose'] as String),
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservedInternalRange: map['reservedInternalRange'] == null ? null : map['reservedInternalRange'] as String,
      role: map['role'] == null ? null : SubnetworkRole.fromValue(map['role'] as String),
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : pulumi.Input.decodeList<SubnetworkSecondaryRange>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryRange.fromMap((value as Map).cast<String, dynamic>())),
      stackType: map['stackType'] == null ? null : SubnetworkStackType.fromValue(map['stackType'] as String),
