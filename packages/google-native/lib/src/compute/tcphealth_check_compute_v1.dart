...
class TCPHealthCheckComputeV1 {
  ...
  factory TCPHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckComputeV1(
      ...
      portSpecification: map['portSpecification'] == null ? null : TCPHealthCheckPortSpecificationComputeV1.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : TCPHealthCheckProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String),
