...
class ResourcePolicyComputeBetaArgs {
  ...
  ResourcePolicyComputeBetaArgs({
    ...
    ResourcePolicySnapshotSchedulePolicyComputeBeta? snapshotSchedulePolicy,
      ...
      groupPlacementPolicy = pulumi.Input.asOptionalInput<ResourcePolicyGroupPlacementPolicyComputeBeta>(groupPlacementPolicy),
      instanceSchedulePolicy = pulumi.Input.asOptionalInput<ResourcePolicyInstanceSchedulePolicyComputeBeta>(instanceSchedulePolicy),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      region = pulumi.Input.asInput<String>(region),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      snapshotSchedulePolicy = pulumi.Input.asOptionalInput<ResourcePolicySnapshotSchedulePolicyComputeBeta>(snapshotSchedulePolicy);
  ...
  factory ResourcePolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyComputeBetaArgs(
      ...
      diskConsistencyGroupPolicy: map['diskConsistencyGroupPolicy'] == null ? null : (map['diskConsistencyGroupPolicy'] as Map).cast<String, dynamic>(),
      groupPlacementPolicy: map['groupPlacementPolicy'] == null ? null : ResourcePolicyGroupPlacementPolicyComputeBeta.fromMap((map['groupPlacementPolicy'] as Map).cast<String, dynamic>()),
      instanceSchedulePolicy: map['instanceSchedulePolicy'] == null ? null : ResourcePolicyInstanceSchedulePolicyComputeBeta.fromMap((map['instanceSchedulePolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      snapshotSchedulePolicy: map['snapshotSchedulePolicy'] == null ? null : ResourcePolicySnapshotSchedulePolicyComputeBeta.fromMap((map['snapshotSchedulePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
