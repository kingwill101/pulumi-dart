...
class RegionNetworkEndpointGroupArgs {
  ...
  final pulumi.Input<RegionNetworkEndpointGroupClientPortMappingMode>? clientPortMappingMode;
  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  ...
  final pulumi.Input<RegionNetworkEndpointGroupNetworkEndpointType>? networkEndpointType;
  ...
  RegionNetworkEndpointGroupArgs({
    ...
    RegionNetworkEndpointGroupType? type,
      ...
      clientPortMappingMode = pulumi.Input.asOptionalInput<RegionNetworkEndpointGroupClientPortMappingMode>(clientPortMappingMode),
      ...
      networkEndpointType = pulumi.Input.asOptionalInput<RegionNetworkEndpointGroupNetworkEndpointType>(networkEndpointType),
      ...
      type = pulumi.Input.asOptionalInput<RegionNetworkEndpointGroupType>(type);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientPortMappingMode': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupClientPortMappingMode, String>(clientPortMappingMode, (value) => value.value),
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupNetworkEndpointType, String>(networkEndpointType, (value) => value.value),
      'project': ?project,
      'pscData': ?pscData,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupType, String>(type, (value) => value.value),
    };
  }
  ...
  factory RegionNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkEndpointGroupArgs(
      ...
      clientPortMappingMode: map['clientPortMappingMode'] == null ? null : RegionNetworkEndpointGroupClientPortMappingMode.fromValue(map['clientPortMappingMode'] as String),
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : RegionNetworkEndpointGroupNetworkEndpointType.fromValue(map['networkEndpointType'] as String),
      ...
      type: map['type'] == null ? null : RegionNetworkEndpointGroupType.fromValue(map['type'] as String),
    );
  }
}
