...
class RegionDiskComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DiskAsyncReplicationResponseComputeV1>
  asyncPrimaryDisk;
  ...
  RegionDiskComputeV1(
    ...
    this.asyncPrimaryDisk =
        registerOutput<DiskAsyncReplicationResponseComputeV1>(
          'asyncPrimaryDisk',
        );
    this.asyncSecondaryDisks = registerOutput<Map<String, String>>(
      'asyncSecondaryDisks',
    );
    ...
    this.physicalBlockSizeBytes = registerOutput<String>(
      'physicalBlockSizeBytes',
    );
    this.project = registerOutput<String>('project');
    this.provisionedIops = registerOutput<String>('provisionedIops');
    this.provisionedThroughput = registerOutput<String>(
    ...
    this.resourceStatus = registerOutput<DiskResourceStatusResponseComputeV1>(
      'resourceStatus',
    );
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.selfLink = registerOutput<String>('selfLink');
    this.sizeGb = registerOutput<String>('sizeGb');
    this.sourceConsistencyGroupPolicy = registerOutput<String>(
      'sourceConsistencyGroupPolicy',
    );
    this.sourceConsistencyGroupPolicyId = registerOutput<String>(
