...
class NodeGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NodeGroupAutoscalingPolicyResponse> autoscalingPolicy;
  ...
  late final pulumi.Output<NodeGroupMaintenanceWindowResponse> maintenanceWindow;
  ...
  NodeGroup(
    ...
    this.autoscalingPolicy = registerOutput<NodeGroupAutoscalingPolicyResponse>('autoscalingPolicy');
    ...
    this.maintenanceWindow = registerOutput<NodeGroupMaintenanceWindowResponse>('maintenanceWindow');
