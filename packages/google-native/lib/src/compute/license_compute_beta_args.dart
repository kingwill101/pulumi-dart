...
class LicenseComputeBetaArgs {
  ...
  LicenseComputeBetaArgs({
    ...
    String? project,
    String? requestId,
    LicenseResourceRequirementsComputeBeta? resourceRequirements,
    bool? transferable,
  }) :
  ...
  factory LicenseComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return LicenseComputeBetaArgs(
      ...
      resourceRequirements: map['resourceRequirements'] == null ? null : LicenseResourceRequirementsComputeBeta.fromMap((map['resourceRequirements'] as Map).cast<String, dynamic>()),
