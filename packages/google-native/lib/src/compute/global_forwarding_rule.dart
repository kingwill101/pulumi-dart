...
class GlobalForwardingRule extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MetadataFilterResponse>> metadataFilters;
  ...
  late final pulumi.Output<List<ForwardingRuleServiceDirectoryRegistrationResponse>> serviceDirectoryRegistrations;
  ...
  /// [args] Arguments used to configure this [GlobalForwardingRule]. {@macro pulumi_compute_alpha_global_forwarding_rule_args_doc}
  ...
  GlobalForwardingRule(
    ...
    this.metadataFilters = registerOutput<List<MetadataFilterResponse>>('metadataFilters');
    ...
    this.serviceDirectoryRegistrations = registerOutput<List<ForwardingRuleServiceDirectoryRegistrationResponse>>('serviceDirectoryRegistrations');
