...
class RouterNatRuleActionResponseComputeV1 {
  ...
  /// Creates a new [RouterNatRuleActionResponseComputeV1].
  ...
  RouterNatRuleActionResponseComputeV1({
  ...
  factory RouterNatRuleActionResponseComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return RouterNatRuleActionResponseComputeV1(
      sourceNatActiveIps: (map['sourceNatActiveIps'] as List).cast<String>(),
      sourceNatActiveRanges: (map['sourceNatActiveRanges'] as List)
          .cast<String>(),
      sourceNatDrainIps: (map['sourceNatDrainIps'] as List).cast<String>(),
      sourceNatDrainRanges: (map['sourceNatDrainRanges'] as List)
          .cast<String>(),
    );
  }
}
