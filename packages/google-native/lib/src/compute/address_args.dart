...
class AddressArgs {
  ...
  factory AddressArgs.fromMap(Map<String, dynamic> map) {
    return AddressArgs(
      ...
      addressType: map['addressType'] == null ? null : AddressAddressType.fromValue(map['addressType'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      ipVersion: map['ipVersion'] == null ? null : AddressIpVersion.fromValue(map['ipVersion'] as String),
      ipv6EndpointType: map['ipv6EndpointType'] == null ? null : AddressIpv6EndpointType.fromValue(map['ipv6EndpointType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkTier: map['networkTier'] == null ? null : AddressNetworkTier.fromValue(map['networkTier'] as String),
      prefixLength: map['prefixLength'] == null ? null : map['prefixLength'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null ? null : AddressPurpose.fromValue(map['purpose'] as String),
