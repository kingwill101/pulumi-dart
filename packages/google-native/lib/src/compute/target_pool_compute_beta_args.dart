...
class TargetPoolComputeBetaArgs {
  ...
  TargetPoolComputeBetaArgs({
    ...
    String? requestId,
    TargetPoolSessionAffinityComputeBeta? sessionAffinity,
  }) :
  ...
  factory TargetPoolComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetPoolComputeBetaArgs(
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : TargetPoolSessionAffinityComputeBeta.fromValue(map['sessionAffinity'] as String),
    );
  }
}
