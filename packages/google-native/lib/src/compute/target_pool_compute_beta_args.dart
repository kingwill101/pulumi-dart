...
class TargetPoolComputeBetaArgs {
  ...
  TargetPoolComputeBetaArgs({
    ...
    TargetPoolSessionAffinityComputeBeta? sessionAffinity,
        ...
        sessionAffinity =
            pulumi.Input.asOptionalInput<TargetPoolSessionAffinityComputeBeta>(
                sessionAffinity);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sessionAffinityValue != null) {
      map['sessionAffinity'] = pulumi.Input.mapOptionalInputValue<
          TargetPoolSessionAffinityComputeBeta,
  ...
  factory TargetPoolComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetPoolComputeBetaArgs(
      backupPool:
          map['backupPool'] == null ? null : map['backupPool'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      failoverRatio:
          map['failoverRatio'] == null ? null : map['failoverRatio'] as double,
      ...
      sessionAffinity: map['sessionAffinity'] == null
          ? null
          : TargetPoolSessionAffinityComputeBeta.fromValue(
