...
class SecuritySettingsResponseComputeV1 {
  ...
  final AWSV4SignatureResponseComputeV1 awsV4Authentication;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsV4Authentication': awsV4Authentication.toMap(),
  ...
  factory SecuritySettingsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponseComputeV1(
      awsV4Authentication: AWSV4SignatureResponseComputeV1.fromMap((map['awsV4Authentication'] as Map).cast<String, dynamic>()),
