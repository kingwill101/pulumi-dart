...
class NodeTemplateComputeV1 extends pulumi.CustomResource {
  late final pulumi.Output<List<AcceleratorConfigResponseComputeV1>>
  accelerators;
  ...
  NodeTemplateComputeV1(
    ...
    this.accelerators =
        registerOutput<List<AcceleratorConfigResponseComputeV1>>(
          'accelerators',
        );
    ...
    this.serverBinding = registerOutput<ServerBindingResponseComputeV1>(
      'serverBinding',
    );
