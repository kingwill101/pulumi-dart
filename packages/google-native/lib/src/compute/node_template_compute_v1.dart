...
import 'local_disk_response_compute_v1.dart';
...
class NodeTemplateComputeV1 extends pulumi.CustomResource {
  late final pulumi.Output<List<AcceleratorConfigResponseComputeV1>> accelerators;
  /// CPU overcommit.
  ...
  late final pulumi.Output<List<LocalDiskResponseComputeV1>> disks;
  ...
  late final pulumi.Output<NodeTemplateNodeTypeFlexibilityResponseComputeV1> nodeTypeFlexibility;
  ...
  NodeTemplateComputeV1(
    ...
    this.accelerators = registerOutput<List<AcceleratorConfigResponseComputeV1>>('accelerators');
    this.cpuOvercommitType = registerOutput<String>('cpuOvercommitType');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.description = registerOutput<String>('description');
    this.disks = registerOutput<List<LocalDiskResponseComputeV1>>('disks');
    ...
    this.nodeTypeFlexibility = registerOutput<NodeTemplateNodeTypeFlexibilityResponseComputeV1>('nodeTypeFlexibility');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.serverBinding = registerOutput<ServerBindingResponseComputeV1>('serverBinding');
