...
class BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1 {
  ...
  factory BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1.fromMap(
    ...
    return BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1(
      customPolicy:
          BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponseComputeV1.fromMap(
            (map['customPolicy'] as Map).cast<String, dynamic>(),
          ),
      policy:
          BackendServiceLocalityLoadBalancingPolicyConfigPolicyResponseComputeV1.fromMap(
