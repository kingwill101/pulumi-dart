...
class ShareSettings {
  ...
  factory ShareSettings.fromMap(Map<String, dynamic> map) {
    return ShareSettings(
      folderMap: map['folderMap'] == null ? null : (map['folderMap'] as Map).cast<String, String>(),
      ...
      shareType: map['shareType'] == null ? null : ShareSettingsShareType.fromValue(map['shareType'] as String),
    );
  }
}
