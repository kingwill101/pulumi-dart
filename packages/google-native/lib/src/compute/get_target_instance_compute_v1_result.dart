...
class GetTargetInstanceComputeV1Result {
  ...
  /// Creates a new [GetTargetInstanceComputeV1Result].
  ...
  factory GetTargetInstanceComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetTargetInstanceComputeV1Result(
