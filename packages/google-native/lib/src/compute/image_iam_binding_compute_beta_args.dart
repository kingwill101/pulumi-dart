...
/// {@template pulumi_compute_beta_image_iam_binding_compute_beta_args_doc}
/// The set of arguments for ImageIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_image_iam_binding_compute_beta_args_doc}
class ImageIamBindingComputeBetaArgs {
  ...
  /// Creates a new [ImageIamBindingComputeBetaArgs].
  ...
  ImageIamBindingComputeBetaArgs({
    Condition? condition,
  ...
  factory ImageIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ImageIamBindingComputeBetaArgs(
