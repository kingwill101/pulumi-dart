...
/// {@template pulumi_compute_v1_region_disk_iam_member_compute_v1_args_doc}
/// The set of arguments for RegionDiskIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_disk_iam_member_compute_v1_args_doc}
class RegionDiskIamMemberComputeV1Args {
  ...
  /// Creates a new [RegionDiskIamMemberComputeV1Args].
  ...
  RegionDiskIamMemberComputeV1Args({
    Condition? condition,
  ...
  factory RegionDiskIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamMemberComputeV1Args(
