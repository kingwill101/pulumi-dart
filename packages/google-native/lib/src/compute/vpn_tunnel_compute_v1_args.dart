...
/// {@template pulumi_compute_v1_vpn_tunnel_compute_v1_args_doc}
/// The set of arguments for VpnTunnel.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_vpn_tunnel_compute_v1_args_doc}
class VpnTunnelComputeV1Args {
  ...
  /// Creates a new [VpnTunnelComputeV1Args].
  ...
  factory VpnTunnelComputeV1Args.fromMap(Map<String, dynamic> map) {
    return VpnTunnelComputeV1Args(
      description:
