...
class HttpFaultAbortResponseComputeBeta {
  ...
  /// Creates a new [HttpFaultAbortResponseComputeBeta].
  ...
  factory HttpFaultAbortResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpFaultAbortResponseComputeBeta(
