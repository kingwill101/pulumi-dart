...
class GlobalPublicDelegatedPrefixArgs {
  ...
  GlobalPublicDelegatedPrefixArgs({
    ...
    String? requestId,
            ...
            pulumi.Input.asOptionalInput<int>(allocatablePrefixLength),
        ...
        mode =
            pulumi.Input.asOptionalInput<GlobalPublicDelegatedPrefixMode>(mode),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (modeValue != null) {
      map['mode'] = pulumi.Input.mapOptionalInputValue<
          GlobalPublicDelegatedPrefixMode,
          String>(modeValue, (value) => value.value);
    }
  ...
  factory GlobalPublicDelegatedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixArgs(
      ...
      isLiveMigration: map['isLiveMigration'] == null
          ? null
          : map['isLiveMigration'] as bool,
      mode: map['mode'] == null
          ? null
          : GlobalPublicDelegatedPrefixMode.fromValue(map['mode'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      parentPrefix:
          map['parentPrefix'] == null ? null : map['parentPrefix'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      publicDelegatedSubPrefixs: map['publicDelegatedSubPrefixs'] == null
          ? null
