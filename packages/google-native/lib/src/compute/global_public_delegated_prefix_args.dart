...
class GlobalPublicDelegatedPrefixArgs {
  ...
  GlobalPublicDelegatedPrefixArgs({
    ...
    publicDelegatedSubPrefixs,
    String? requestId,
  }) : allocatablePrefixLength = pulumi.Input.asOptionalInput<int>(
       ...
       mode = pulumi.Input.asOptionalInput<GlobalPublicDelegatedPrefixMode>(
         mode,
       ),
  ...
  factory GlobalPublicDelegatedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixArgs(
      ...
      parentPrefix: map['parentPrefix'] == null
          ? null
          : map['parentPrefix'] as String,
