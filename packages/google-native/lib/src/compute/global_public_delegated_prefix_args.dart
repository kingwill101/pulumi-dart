...
import 'global_public_delegated_prefix_mode.dart';
import 'public_delegated_prefix_public_delegated_sub_prefix.dart';

/// {@template pulumi_compute_alpha_global_public_delegated_prefix_args_doc}
/// The set of arguments for GlobalPublicDelegatedPrefix.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_global_public_delegated_prefix_args_doc}
class GlobalPublicDelegatedPrefixArgs {
  ...
  final pulumi.Input<GlobalPublicDelegatedPrefixMode>? mode;
  ...
  /// Creates a new [GlobalPublicDelegatedPrefixArgs].
  ...
  GlobalPublicDelegatedPrefixArgs({
    int? allocatablePrefixLength,
    String? description,
    String? ipCidrRange,
    bool? isLiveMigration,
    GlobalPublicDelegatedPrefixMode? mode,
    String? name,
    String? parentPrefix,
    String? project,
    List<PublicDelegatedPrefixPublicDelegatedSubPrefix>? publicDelegatedSubPrefixs,
    String? requestId,
  }) :
      ...
      mode = pulumi.Input.asOptionalInput<GlobalPublicDelegatedPrefixMode>(mode),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<GlobalPublicDelegatedPrefixMode, String>(mode, (value) => value.value),
      'name': ?name,
  ...
  factory GlobalPublicDelegatedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixArgs(
      ...
      isLiveMigration: map['isLiveMigration'] == null ? null : map['isLiveMigration'] as bool,
      mode: map['mode'] == null ? null : GlobalPublicDelegatedPrefixMode.fromValue(map['mode'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      parentPrefix: map['parentPrefix'] == null ? null : map['parentPrefix'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      publicDelegatedSubPrefixs: map['publicDelegatedSubPrefixs'] == null ? null : pulumi.Input.decodeList<PublicDelegatedPrefixPublicDelegatedSubPrefix>(map['publicDelegatedSubPrefixs'], (value) => PublicDelegatedPrefixPublicDelegatedSubPrefix.fromMap((value as Map).cast<String, dynamic>())),
