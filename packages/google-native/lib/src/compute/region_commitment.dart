...
class RegionCommitment extends pulumi.CustomResource {
  ...
  RegionCommitment(
    ...
    this.existingReservations = registerOutput<List<String>>(
      'existingReservations',
    );
    this.kind = registerOutput<String>('kind');
    this.licenseResource = registerOutput<LicenseResourceCommitmentResponse>(
      'licenseResource',
    );
    this.mergeSourceCommitments = registerOutput<List<String>>(
    ...
    this.reservations = registerOutput<List<ReservationResponse>>(
      'reservations',
    );
    this.resourceStatus = registerOutput<CommitmentResourceStatusResponse>(
      'resourceStatus',
    );
    this.resources = registerOutput<List<ResourceCommitmentResponse>>(
      'resources',
    );
    this.selfLink = registerOutput<String>('selfLink');
    this.selfLinkWithId = registerOutput<String>('selfLinkWithId');
    this.splitSourceCommitment = registerOutput<String>(
