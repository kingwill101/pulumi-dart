...
class RegionCommitment extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ReservationResponse>> reservations;
  ...
  late final pulumi.Output<List<ResourceCommitmentResponse>> resources;
  ...
  RegionCommitment(
    ...
    this.existingReservations = registerOutput<List<String>>('existingReservations');
    this.kind = registerOutput<String>('kind');
    this.licenseResource = registerOutput<LicenseResourceCommitmentResponse>('licenseResource');
    this.mergeSourceCommitments = registerOutput<List<String>>('mergeSourceCommitments');
    this.name = registerOutput<String>('name');
    this.plan = registerOutput<String>('plan');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.reservations = registerOutput<List<ReservationResponse>>('reservations');
    this.resourceStatus = registerOutput<CommitmentResourceStatusResponse>('resourceStatus');
    this.resources = registerOutput<List<ResourceCommitmentResponse>>('resources');
    this.selfLink = registerOutput<String>('selfLink');
    this.selfLinkWithId = registerOutput<String>('selfLinkWithId');
    this.splitSourceCommitment = registerOutput<String>('splitSourceCommitment');
