...
import 'target_https_proxy_quic_override.dart';

/// {@template pulumi_compute_alpha_target_https_proxy_args_doc}
/// The set of arguments for TargetHttpsProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_target_https_proxy_args_doc}
class TargetHttpsProxyArgs {
  ...
  final pulumi.Input<TargetHttpsProxyQuicOverride>? quicOverride;
  ...
  TargetHttpsProxyArgs({
    ...
    String? project,
    bool? proxyBind,
    TargetHttpsProxyQuicOverride? quicOverride,
    String? requestId,
    ...
    String? urlMap,
        ...
        quicOverride =
            pulumi.Input.asOptionalInput<TargetHttpsProxyQuicOverride>(
                quicOverride),
  ...
  factory TargetHttpsProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyArgs(
      ...
      quicOverride: map['quicOverride'] == null
          ? null
          : TargetHttpsProxyQuicOverride.fromValue(
