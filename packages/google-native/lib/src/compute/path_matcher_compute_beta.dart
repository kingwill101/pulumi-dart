...
class PathMatcherComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (pathRulesValue != null) {
      map['pathRules'] =
          pulumi.Input.encodeList<PathRuleComputeBeta, Map<String, dynamic>>(
              pathRulesValue, (value) => value.toMap());
    }
    final routeRulesValue = routeRules;
    if (routeRulesValue != null) {
      map['routeRules'] = pulumi.Input.encodeList<HttpRouteRuleComputeBeta,
  ...
  factory PathMatcherComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherComputeBeta(
      ...
      pathRules: map['pathRules'] == null
          ? null
          : pulumi.Input.decodeList<PathRuleComputeBeta>(
              map['pathRules'],
              (value) => PathRuleComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      routeRules: map['routeRules'] == null
          ? null
          : pulumi.Input.decodeList<HttpRouteRuleComputeBeta>(
              map['routeRules'],
              (value) => HttpRouteRuleComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
    );
  }
}
