...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1 {
  ...
  final SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeV1? enforceOnKeyType;
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1(
      ...
      enforceOnKeyType: map['enforceOnKeyType'] == null ? null : SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeV1.fromValue(map['enforceOnKeyType'] as String),
    );
  }
}
