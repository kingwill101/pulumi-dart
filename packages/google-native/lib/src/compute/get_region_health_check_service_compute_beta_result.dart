...
class GetRegionHealthCheckServiceComputeBetaResult {
  ...
  /// Creates a new [GetRegionHealthCheckServiceComputeBetaResult].
  ...
  factory GetRegionHealthCheckServiceComputeBetaResult.fromMap(
    ...
    return GetRegionHealthCheckServiceComputeBetaResult(
      ...
      networkEndpointGroups: (map['networkEndpointGroups'] as List)
          .cast<String>(),
      notificationEndpoints: (map['notificationEndpoints'] as List)
          .cast<String>(),
