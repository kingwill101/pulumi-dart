...
class RegionSslPolicyComputeBetaArgs {
  ...
  RegionSslPolicyComputeBetaArgs({
    ...
    String? requestId,
        ...
        minTlsVersion = pulumi.Input.asOptionalInput<
            RegionSslPolicyMinTlsVersionComputeBeta>(minTlsVersion),
        name = pulumi.Input.asOptionalInput<String>(name),
        profile =
            pulumi.Input.asOptionalInput<RegionSslPolicyProfileComputeBeta>(
                profile),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (minTlsVersionValue != null) {
      map['minTlsVersion'] = pulumi.Input.mapOptionalInputValue<
          RegionSslPolicyMinTlsVersionComputeBeta,
    ...
    if (profileValue != null) {
      map['profile'] = pulumi.Input.mapOptionalInputValue<
          RegionSslPolicyProfileComputeBeta,
  ...
  factory RegionSslPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyComputeBetaArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null
          ? null
          : RegionSslPolicyMinTlsVersionComputeBeta.fromValue(
              map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null
          ? null
          : RegionSslPolicyProfileComputeBeta.fromValue(
