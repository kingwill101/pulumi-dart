...
class RegionSslPolicyComputeBetaArgs {
  ...
  RegionSslPolicyComputeBetaArgs({
    ...
    String? description,
    RegionSslPolicyMinTlsVersionComputeBeta? minTlsVersion,
    String? name,
    RegionSslPolicyProfileComputeBeta? profile,
    String? project,
  ...
  factory RegionSslPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyComputeBetaArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : RegionSslPolicyMinTlsVersionComputeBeta.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null ? null : RegionSslPolicyProfileComputeBeta.fromValue(map['profile'] as String),
