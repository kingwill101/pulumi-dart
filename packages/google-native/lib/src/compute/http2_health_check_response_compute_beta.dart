...
class HTTP2HealthCheckResponseComputeBeta {
  ...
  /// Creates a new [HTTP2HealthCheckResponseComputeBeta].
  ...
  HTTP2HealthCheckResponseComputeBeta({
    required this.host,
    required this.port,
  ...
  factory HTTP2HealthCheckResponseComputeBeta.fromMap(
    Map<String, dynamic> map,
  ) {
    return HTTP2HealthCheckResponseComputeBeta(
