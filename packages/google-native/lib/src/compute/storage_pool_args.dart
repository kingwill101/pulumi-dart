...
class StoragePoolArgs {
  ...
  factory StoragePoolArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolArgs(
      capacityProvisioningType: map['capacityProvisioningType'] == null ? null : StoragePoolCapacityProvisioningType.fromValue(map['capacityProvisioningType'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      performanceProvisioningType: map['performanceProvisioningType'] == null ? null : StoragePoolPerformanceProvisioningType.fromValue(map['performanceProvisioningType'] as String),
      ...
      storagePoolType: map['storagePoolType'] == null ? null : map['storagePoolType'] as String,
