...
class ReservationComputeBetaArgs {
  ...
  factory ReservationComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ReservationComputeBetaArgs(
      aggregateReservation: map['aggregateReservation'] == null ? null : AllocationAggregateReservationComputeBeta.fromMap((map['aggregateReservation'] as Map).cast<String, dynamic>()),
      deleteAfterDuration: map['deleteAfterDuration'] == null ? null : DurationComputeBeta.fromMap((map['deleteAfterDuration'] as Map).cast<String, dynamic>()),
      ...
      specificReservation: map['specificReservation'] == null ? null : AllocationSpecificSKUReservationComputeBeta.fromMap((map['specificReservation'] as Map).cast<String, dynamic>()),
