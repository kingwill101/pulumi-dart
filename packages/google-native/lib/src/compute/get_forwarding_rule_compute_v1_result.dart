...
import 'forwarding_rule_service_directory_registration_response_compute_v1.dart';
import 'metadata_filter_response_compute_v1.dart';

/// Result data returned by getForwardingRule.
class GetForwardingRuleComputeV1Result {
  ...
  final List<MetadataFilterResponseComputeV1> metadataFilters;
  ...
  final List<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1> serviceDirectoryRegistrations;
  ...
  /// Creates a new [GetForwardingRuleComputeV1Result].
  ...
  GetForwardingRuleComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadataFilters': pulumi.Input.encodeList<MetadataFilterResponseComputeV1, Map<String, dynamic>>(metadataFilters, (value) => value.toMap()),
      'name': name,
      'network': network,
      ...
      'region': region,
      'selfLink': selfLink,
      'serviceDirectoryRegistrations': pulumi.Input.encodeList<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1, Map<String, dynamic>>(serviceDirectoryRegistrations, (value) => value.toMap()),
  ...
  factory GetForwardingRuleComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetForwardingRuleComputeV1Result(
      ...
      metadataFilters: pulumi.Input.decodeList<MetadataFilterResponseComputeV1>(map['metadataFilters'], (value) => MetadataFilterResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      serviceDirectoryRegistrations: pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1>(map['serviceDirectoryRegistrations'], (value) => ForwardingRuleServiceDirectoryRegistrationResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
