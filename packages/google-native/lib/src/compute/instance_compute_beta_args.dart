...
class InstanceComputeBetaArgs {
  ...
  InstanceComputeBetaArgs({
    ...
    String? zone,
        ...
        disks =
            pulumi.Input.asOptionalInput<List<AttachedDiskComputeBeta>>(disks),
        ...
        networkPerformanceConfig =
            pulumi.Input.asOptionalInput<NetworkPerformanceConfigComputeBeta>(
                networkPerformanceConfig),
        params =
            pulumi.Input.asOptionalInput<InstanceParamsComputeBeta>(params),
        ...
        scheduling =
            pulumi.Input.asOptionalInput<SchedulingComputeBeta>(scheduling),
        serviceAccounts =
