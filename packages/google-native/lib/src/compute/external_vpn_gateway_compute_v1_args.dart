    ...
    return <String, dynamic>{
      ...
      'redundancyType':
          ?pulumi.Input.mapOptionalInputValue<
            ExternalVpnGatewayRedundancyTypeComputeV1,
            String
          >(redundancyType, (value) => value.value),
      'requestId': ?requestId,
    };
  }
  ...
  factory ExternalVpnGatewayComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayComputeV1Args(
      ...
      interfaces: map['interfaces'] == null
          ? null
          : pulumi.Input.decodeList<ExternalVpnGatewayInterfaceComputeV1>(
              map['interfaces'],
              (value) => ExternalVpnGatewayInterfaceComputeV1.fromMap(
      ...
      redundancyType: map['redundancyType'] == null
          ? null
          : ExternalVpnGatewayRedundancyTypeComputeV1.fromValue(
              map['redundancyType'] as String,
            ),
