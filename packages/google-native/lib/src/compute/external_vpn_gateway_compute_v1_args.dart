...
class ExternalVpnGatewayComputeV1Args {
  ...
  ExternalVpnGatewayComputeV1Args({
    String? description,
    List<ExternalVpnGatewayInterfaceComputeV1>? interfaces,
    Map<String, String>? labels,
    String? name,
    String? project,
    ExternalVpnGatewayRedundancyTypeComputeV1? redundancyType,
    String? requestId,
  }) :
  ...
  factory ExternalVpnGatewayComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayComputeV1Args(
      ...
      interfaces: map['interfaces'] == null ? null : pulumi.Input.decodeList<ExternalVpnGatewayInterfaceComputeV1>(map['interfaces'], (value) => ExternalVpnGatewayInterfaceComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      redundancyType: map['redundancyType'] == null ? null : ExternalVpnGatewayRedundancyTypeComputeV1.fromValue(map['redundancyType'] as String),
