...
class SecurityPolicyRuleMatcherConfigLayer4Config {
  ...
  /// Creates a new [SecurityPolicyRuleMatcherConfigLayer4Config].
  ...
  SecurityPolicyRuleMatcherConfigLayer4Config({this.ipProtocol, this.ports});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'ipProtocol': ?ipProtocol, 'ports': ?ports};
  }

  factory SecurityPolicyRuleMatcherConfigLayer4Config.fromMap(
