...
class NetworkInterfaceComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessConfigsValue != null) {
      map['accessConfigs'] =
          pulumi.Input.encodeList<AccessConfigComputeV1, Map<String, dynamic>>(
              accessConfigsValue, (value) => value.toMap());
    }
    final aliasIpRangesValue = aliasIpRanges;
    if (aliasIpRangesValue != null) {
      map['aliasIpRanges'] =
          pulumi.Input.encodeList<AliasIpRangeComputeV1, Map<String, dynamic>>(
  ...
  factory NetworkInterfaceComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceComputeV1(
      accessConfigs: map['accessConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AccessConfigComputeV1>(
              map['accessConfigs'],
              (value) => AccessConfigComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null
          ? null
          : pulumi.Input.decodeList<AliasIpRangeComputeV1>(
              map['aliasIpRanges'],
              (value) => AliasIpRangeComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
