...
class OutlierDetectionResponseComputeV1 {
  ...
  final DurationResponseComputeV1 baseEjectionTime;
  ...
  final DurationResponseComputeV1 interval;
  ...
  /// Creates a new [OutlierDetectionResponseComputeV1].
  ...
  OutlierDetectionResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['baseEjectionTime'] = baseEjectionTime.toMap();
    map['consecutiveErrors'] = consecutiveErrors;
    map['consecutiveGatewayFailure'] = consecutiveGatewayFailure;
    map['enforcingConsecutiveErrors'] = enforcingConsecutiveErrors;
    ...
    map['successRateMinimumHosts'] = successRateMinimumHosts;
    map['successRateRequestVolume'] = successRateRequestVolume;
    map['successRateStdevFactor'] = successRateStdevFactor;
    return map;
  }

  factory OutlierDetectionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponseComputeV1(
      baseEjectionTime: DurationResponseComputeV1.fromMap(
      ...
      interval: DurationResponseComputeV1.fromMap(
