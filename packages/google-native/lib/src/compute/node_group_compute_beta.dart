...
class NodeGroupComputeBeta extends pulumi.CustomResource {
  ...
  NodeGroupComputeBeta(
    ...
    this.autoscalingPolicy = registerOutput<NodeGroupAutoscalingPolicyResponseComputeBeta>('autoscalingPolicy');
    ...
    this.maintenanceWindow = registerOutput<NodeGroupMaintenanceWindowResponseComputeBeta>('maintenanceWindow');
