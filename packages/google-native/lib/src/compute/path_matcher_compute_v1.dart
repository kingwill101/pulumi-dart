...
class PathMatcherComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (pathRulesValue != null) {
      map['pathRules'] =
          pulumi.Input.encodeList<PathRuleComputeV1, Map<String, dynamic>>(
              pathRulesValue, (value) => value.toMap());
    }
    final routeRulesValue = routeRules;
    if (routeRulesValue != null) {
      map['routeRules'] =
          pulumi.Input.encodeList<HttpRouteRuleComputeV1, Map<String, dynamic>>(
  ...
  factory PathMatcherComputeV1.fromMap(Map<String, dynamic> map) {
    return PathMatcherComputeV1(
      ...
      pathRules: map['pathRules'] == null
          ? null
          : pulumi.Input.decodeList<PathRuleComputeV1>(
              map['pathRules'],
              (value) => PathRuleComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      routeRules: map['routeRules'] == null
          ? null
          : pulumi.Input.decodeList<HttpRouteRuleComputeV1>(
              map['routeRules'],
              (value) => HttpRouteRuleComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
    );
  }
}
