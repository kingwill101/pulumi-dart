...
/// {@template pulumi_compute_v1_node_group_iam_binding_compute_v1_args_doc}
/// The set of arguments for NodeGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_node_group_iam_binding_compute_v1_args_doc}
class NodeGroupIamBindingComputeV1Args {
  ...
  /// Creates a new [NodeGroupIamBindingComputeV1Args].
  ...
  NodeGroupIamBindingComputeV1Args({
    Condition? condition,
  ...
  factory NodeGroupIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeGroupIamBindingComputeV1Args(
