...
class GlobalAddressComputeBetaArgs {
  ...
  GlobalAddressComputeBetaArgs({
    ...
    String? subnetwork,
        ...
        addressType =
            pulumi.Input.asOptionalInput<GlobalAddressAddressTypeComputeBeta>(
                addressType),
        description = pulumi.Input.asOptionalInput<String>(description),
        ipVersion =
            pulumi.Input.asOptionalInput<GlobalAddressIpVersionComputeBeta>(
                ipVersion),
        ...
        networkTier =
            pulumi.Input.asOptionalInput<GlobalAddressNetworkTierComputeBeta>(
                networkTier),
        prefixLength = pulumi.Input.asOptionalInput<int>(prefixLength),
        project = pulumi.Input.asOptionalInput<String>(project),
        purpose = pulumi.Input.asOptionalInput<GlobalAddressPurposeComputeBeta>(
            purpose),
  ...
  factory GlobalAddressComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return GlobalAddressComputeBetaArgs(
      ...
      addressType: map['addressType'] == null
          ? null
          : GlobalAddressAddressTypeComputeBeta.fromValue(
              map['addressType'] as String),
      description:
          map['description'] == null ? null : map['description'] as String,
      ipVersion: map['ipVersion'] == null
          ? null
          : GlobalAddressIpVersionComputeBeta.fromValue(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : GlobalAddressNetworkTierComputeBeta.fromValue(
      ...
      purpose: map['purpose'] == null
          ? null
          : GlobalAddressPurposeComputeBeta.fromValue(map['purpose'] as String),
