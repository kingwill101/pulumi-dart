    ...
    return <String, dynamic>{
      ...
      'sourceInstanceParams':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sourceInstanceParams, (value) => value.toMap()),
    };
  }

  factory RegionInstanceTemplateComputeV1Args.fromMap(
    ...
    return RegionInstanceTemplateComputeV1Args(
      ...
      properties: map['properties'] == null
          ? null
          : InstancePropertiesComputeV1.fromMap(
      ...
      sourceInstanceParams: map['sourceInstanceParams'] == null
          ? null
          : SourceInstanceParamsComputeV1.fromMap(
