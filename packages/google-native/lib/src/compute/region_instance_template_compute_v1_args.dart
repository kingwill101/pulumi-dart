...
/// {@template pulumi_compute_v1_region_instance_template_compute_v1_args_doc}
/// The set of arguments for RegionInstanceTemplate.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_instance_template_compute_v1_args_doc}
class RegionInstanceTemplateComputeV1Args {
  ...
  /// Creates a new [RegionInstanceTemplateComputeV1Args].
  ...
  RegionInstanceTemplateComputeV1Args({
    String? description,
    String? name,
    String? project,
    InstancePropertiesComputeV1? properties,
    required String region,
    String? requestId,
    String? sourceInstance,
    SourceInstanceParamsComputeV1? sourceInstanceParams,
  }) :
  ...
  factory RegionInstanceTemplateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateComputeV1Args(
      ...
      properties: map['properties'] == null ? null : InstancePropertiesComputeV1.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      sourceInstance: map['sourceInstance'] == null ? null : map['sourceInstance'] as String,
      sourceInstanceParams: map['sourceInstanceParams'] == null ? null : SourceInstanceParamsComputeV1.fromMap((map['sourceInstanceParams'] as Map).cast<String, dynamic>()),
    );
  }
}
