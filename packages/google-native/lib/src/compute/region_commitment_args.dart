...
class RegionCommitmentArgs {
  ...
  RegionCommitmentArgs({
    ...
    RegionCommitmentType? type,
       ...
       licenseResource = pulumi
           .Input.asOptionalInput<LicenseResourceCommitment>(licenseResource),
       ...
       reservations = pulumi
           .Input.asOptionalInput<List<ReservationComputeAlpha>>(reservations),
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      reservations: map['reservations'] == null
          ? null
          : (map['reservations'] as List).cast<ReservationComputeAlpha>(),
