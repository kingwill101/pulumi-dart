...
class RegionCommitmentArgs {
  ...
  RegionCommitmentArgs({
    ...
    RegionCommitmentType? type,
        ...
        category =
            pulumi.Input.asOptionalInput<RegionCommitmentCategory>(category),
        description = pulumi.Input.asOptionalInput<String>(description),
        existingReservations =
            pulumi.Input.asOptionalInput<List<String>>(existingReservations),
        licenseResource =
            pulumi.Input.asOptionalInput<LicenseResourceCommitment>(
                licenseResource),
        ...
        reservations =
            pulumi.Input.asOptionalInput<List<Reservation>>(reservations),
        resources =
            pulumi.Input.asOptionalInput<List<ResourceCommitment>>(resources),
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      category: map['category'] == null
          ? null
          : RegionCommitmentCategory.fromValue(map['category'] as String),
      description:
          map['description'] == null ? null : map['description'] as String,
      existingReservations: map['existingReservations'] == null
          ? null
      ...
      plan: map['plan'] == null
          ? null
          : RegionCommitmentPlan.fromValue(map['plan'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservations: map['reservations'] == null
          ? null
          : pulumi.Input.decodeList<Reservation>(
              map['reservations'],
              (value) =>
                  Reservation.fromMap((value as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null
          ? null
          : RegionCommitmentType.fromValue(map['type'] as String),
    );
  }
}
