...
class SecurityPolicyRuleRateLimitOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exceedActionRpcStatus': ?exceedActionRpcStatus == null ? null : exceedActionRpcStatus!.toMap(),
  ...
  factory SecurityPolicyRuleRateLimitOptions.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptions(
      ...
      banThreshold: map['banThreshold'] == null ? null : SecurityPolicyRuleRateLimitOptionsThreshold.fromMap((map['banThreshold'] as Map).cast<String, dynamic>()),
      conformAction: map['conformAction'] == null ? null : map['conformAction'] as String,
      enforceOnKey: map['enforceOnKey'] == null ? null : SecurityPolicyRuleRateLimitOptionsEnforceOnKey.fromValue(map['enforceOnKey'] as String),
      ...
      exceedActionRpcStatus: map['exceedActionRpcStatus'] == null ? null : SecurityPolicyRuleRateLimitOptionsRpcStatus.fromMap((map['exceedActionRpcStatus'] as Map).cast<String, dynamic>()),
      exceedRedirectOptions: map['exceedRedirectOptions'] == null ? null : SecurityPolicyRuleRedirectOptions.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>()),
      rateLimitThreshold: map['rateLimitThreshold'] == null ? null : SecurityPolicyRuleRateLimitOptionsThreshold.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>()),
    );
  }
}
