...
/// Metadata
class MetadataItemsItemResponseComputeBeta {
  ...
  /// Creates a new [MetadataItemsItemResponseComputeBeta].
  ...
  MetadataItemsItemResponseComputeBeta({
    required this.key,
    required this.value,
  });
  ...
  factory MetadataItemsItemResponseComputeBeta.fromMap(
    Map<String, dynamic> map,
  ) {
    return MetadataItemsItemResponseComputeBeta(
