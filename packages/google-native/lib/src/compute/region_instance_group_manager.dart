...
class RegionInstanceGroupManager extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InstanceGroupManagerAutoHealingPolicyResponse>>
  autoHealingPolicies;
  ...
  late final pulumi.Output<List<InstanceGroupManagerVersionResponse>> versions;
  ...
  RegionInstanceGroupManager(
    ...
    this.distributionPolicy = registerOutput<DistributionPolicyResponse>(
      'distributionPolicy',
    );
    ...
    this.statefulPolicy = registerOutput<StatefulPolicyResponse>(
      'statefulPolicy',
    );
    ...
    this.versions = registerOutput<List<InstanceGroupManagerVersionResponse>>(
      'versions',
    );
