...
class RegionInstantSnapshot extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RegionInstantSnapshot]. {@macro pulumi_compute_alpha_region_instant_snapshot_args_doc}
  ...
  RegionInstantSnapshot(
    ...
    this.resourceStatus = registerOutput<InstantSnapshotResourceStatusResponse>(
      'resourceStatus',
    );
