...
class GetPublicDelegatedPrefixComputeV1Result {
  ...
  /// Creates a new [GetPublicDelegatedPrefixComputeV1Result].
  ...
  GetPublicDelegatedPrefixComputeV1Result({
  ...
  factory GetPublicDelegatedPrefixComputeV1Result.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetPublicDelegatedPrefixComputeV1Result(
      ...
      publicDelegatedSubPrefixs:
          ...
          >(
            ...
            (value) =>
                PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeV1.fromMap(
