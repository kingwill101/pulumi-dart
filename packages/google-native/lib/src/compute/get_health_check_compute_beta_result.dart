...
class GetHealthCheckComputeBetaResult {
  ...
  /// Creates a new [GetHealthCheckComputeBetaResult].
  ...
  GetHealthCheckComputeBetaResult({
  ...
  factory GetHealthCheckComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetHealthCheckComputeBetaResult(
