...
/// {@template pulumi_compute_alpha_license_code_iam_member_args_doc}
/// The set of arguments for LicenseCodeIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_license_code_iam_member_args_doc}
class LicenseCodeIamMemberArgs {
  ...
  /// Creates a new [LicenseCodeIamMemberArgs].
  ...
  factory LicenseCodeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LicenseCodeIamMemberArgs(
