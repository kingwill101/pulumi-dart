...
import 'security_policy_rule_rate_limit_options_enforce_on_key_config_enforce_on_key_type_compute_beta.dart';

class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta {
  ...
  final SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta?
      enforceOnKeyType;

  /// Creates a new [SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    ...
    if (enforceOnKeyTypeValue != null) {
      map['enforceOnKeyType'] = enforceOnKeyTypeValue.value;
    }
    return map;
  }

  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta.fromMap(
    ...
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta(
      ...
      enforceOnKeyType: map['enforceOnKeyType'] == null
          ? null
          : SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta
              .fromValue(map['enforceOnKeyType'] as String),
    );
  }
}
