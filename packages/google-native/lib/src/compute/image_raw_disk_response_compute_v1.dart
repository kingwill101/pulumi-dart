...
class ImageRawDiskResponseComputeV1 {
  ...
  /// Creates a new [ImageRawDiskResponseComputeV1].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['sha1Checksum'] = sha1Checksum;
    map['source'] = source;
    return map;
  }

  factory ImageRawDiskResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ImageRawDiskResponseComputeV1(
      containerType: map['containerType'] as String,
      sha1Checksum: map['sha1Checksum'] as String,
