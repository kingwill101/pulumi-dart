...
class CustomErrorResponsePolicyResponseComputeBeta {
  ...
  final List<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta> errorResponseRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': pulumi.Input.encodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta, Map<String, dynamic>>(errorResponseRules, (value) => value.toMap()),
  ...
  factory CustomErrorResponsePolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyResponseComputeBeta(
      errorResponseRules: pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta>(map['errorResponseRules'], (value) => CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
