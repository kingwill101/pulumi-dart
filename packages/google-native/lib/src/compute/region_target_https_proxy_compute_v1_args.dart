...
class RegionTargetHttpsProxyComputeV1Args {
  ...
  RegionTargetHttpsProxyComputeV1Args({
    ...
    String? project,
    bool? proxyBind,
    RegionTargetHttpsProxyQuicOverrideComputeV1? quicOverride,
  ...
  factory RegionTargetHttpsProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyComputeV1Args(
      ...
      quicOverride: map['quicOverride'] == null ? null : RegionTargetHttpsProxyQuicOverrideComputeV1.fromValue(map['quicOverride'] as String),
