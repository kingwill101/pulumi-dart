...
class RegionAutoscaler extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RegionAutoscaler]. {@macro pulumi_compute_alpha_region_autoscaler_args_doc}
  ...
  RegionAutoscaler(
    ...
    this.autoscalingPolicy = registerOutput<AutoscalingPolicyResponse>('autoscalingPolicy');
    ...
    this.statusDetails = registerOutput<List<AutoscalerStatusDetailsResponse>>('statusDetails');
