  ...
  ServiceAttachmentComputeBeta(
    ...
    this.consumerAcceptLists =
        registerOutput<
          List<ServiceAttachmentConsumerProjectLimitResponseComputeBeta>
        >('consumerAcceptLists');
    this.consumerRejectLists = registerOutput<List<String>>(
      'consumerRejectLists',
    );
    ...
    this.producerForwardingRule = registerOutput<String>(
      'producerForwardingRule',
    );
    this.project = registerOutput<String>('project');
    this.pscServiceAttachmentId = registerOutput<Uint128ResponseComputeBeta>(
