...
import 'service_attachment_compute_beta_args.dart';
...
class ServiceAttachmentComputeBeta extends pulumi.CustomResource {
  /// An array of connections for all the consumers connected to this service attachment.
  late final pulumi.Output<List<ServiceAttachmentConnectedEndpointResponseComputeBeta>> connectedEndpoints;
  /// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
  late final pulumi.Output<String> connectionPreference;
  /// Projects that are allowed to connect to this service attachment.
  late final pulumi.Output<List<ServiceAttachmentConsumerProjectLimitResponseComputeBeta>> consumerAcceptLists;
  ...
  late final pulumi.Output<Uint128ResponseComputeBeta> pscServiceAttachmentId;
  ...
  late final pulumi.Output<ServiceAttachmentTunnelingConfigResponseComputeBeta> tunnelingConfig;

  /// Creates a new [ServiceAttachmentComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServiceAttachmentComputeBeta]. {@macro pulumi_compute_beta_service_attachment_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServiceAttachmentComputeBeta(
    String name, {
    ServiceAttachmentComputeBetaArgs? args,
    ...
    this.connectedEndpoints = registerOutput<List<ServiceAttachmentConnectedEndpointResponseComputeBeta>>('connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists = registerOutput<List<ServiceAttachmentConsumerProjectLimitResponseComputeBeta>>('consumerAcceptLists');
    this.consumerRejectLists = registerOutput<List<String>>('consumerRejectLists');
    ...
    this.producerForwardingRule = registerOutput<String>('producerForwardingRule');
    this.project = registerOutput<String>('project');
    this.pscServiceAttachmentId = registerOutput<Uint128ResponseComputeBeta>('pscServiceAttachmentId');
    ...
    this.tunnelingConfig = registerOutput<ServiceAttachmentTunnelingConfigResponseComputeBeta>('tunnelingConfig');
  }
}
