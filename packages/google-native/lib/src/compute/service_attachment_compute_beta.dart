...
class ServiceAttachmentComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<ServiceAttachmentConnectedEndpointResponseComputeBeta>>
      connectedEndpoints;
  ...
  late final pulumi
      .Output<List<ServiceAttachmentConsumerProjectLimitResponseComputeBeta>>
      consumerAcceptLists;
  ...
  late final pulumi.Output<ServiceAttachmentTunnelingConfigResponseComputeBeta>
      tunnelingConfig;
  ...
  ServiceAttachmentComputeBeta(
    ...
    this.connectedEndpoints = registerOutput<
            List<ServiceAttachmentConnectedEndpointResponseComputeBeta>>(
        'connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists = registerOutput<
            List<ServiceAttachmentConsumerProjectLimitResponseComputeBeta>>(
        'consumerAcceptLists');
    ...
    this.pscServiceAttachmentId =
        registerOutput<Uint128ResponseComputeBeta>('pscServiceAttachmentId');
