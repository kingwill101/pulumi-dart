...
class RegionSslPolicyComputeV1Args {
  ...
  RegionSslPolicyComputeV1Args({
    ...
    String? description,
    RegionSslPolicyMinTlsVersionComputeV1? minTlsVersion,
    String? name,
    RegionSslPolicyProfileComputeV1? profile,
    String? project,
  ...
  factory RegionSslPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyComputeV1Args(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : RegionSslPolicyMinTlsVersionComputeV1.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      profile: map['profile'] == null ? null : RegionSslPolicyProfileComputeV1.fromValue(map['profile'] as String),
