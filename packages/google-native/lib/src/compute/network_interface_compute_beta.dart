...
class NetworkInterfaceComputeBeta {
  ...
  final List<AccessConfigComputeBeta>? accessConfigs;

  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final List<AliasIpRangeComputeBeta>? aliasIpRanges;

  /// The prefix length of the primary internal IPv6 range.
  final int? internalIpv6PrefixLength;

  /// An array of IPv6 access configurations for this interface. Currently, only one IPv6 access config, DIRECT_IPV6, is supported. If there is no ipv6AccessConfig specified, then this instance will have no external IPv6 Internet access.
  final List<AccessConfigComputeBeta>? ipv6AccessConfigs;
  ...
  final NetworkInterfaceNicTypeComputeBeta? nicType;

  /// The networking queue count that's specified by users for the network interface. Both Rx and Tx queues will be set to this number. It'll be empty if not specified by the users.
  final int? queueCount;

  /// The stack type for this network interface. To assign only IPv4 addresses, use IPV4_ONLY. To assign both IPv4 and IPv6 addresses, use IPV4_IPV6. If not specified, IPV4_ONLY is used. This field can be both set at instance creation and update network interface operations.
  final NetworkInterfaceStackTypeComputeBeta? stackType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessConfigsValue != null) {
      map['accessConfigs'] = pulumi.Input.encodeList<AccessConfigComputeBeta,
          Map<String, dynamic>>(accessConfigsValue, (value) => value.toMap());
    }
    final aliasIpRangesValue = aliasIpRanges;
    if (aliasIpRangesValue != null) {
      map['aliasIpRanges'] = pulumi.Input.encodeList<AliasIpRangeComputeBeta,
    ...
    if (ipv6AccessConfigsValue != null) {
      map['ipv6AccessConfigs'] = pulumi.Input.encodeList<
              AccessConfigComputeBeta, Map<String, dynamic>>(
  ...
  factory NetworkInterfaceComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceComputeBeta(
      accessConfigs: map['accessConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AccessConfigComputeBeta>(
              map['accessConfigs'],
              (value) => AccessConfigComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null
          ? null
          : pulumi.Input.decodeList<AliasIpRangeComputeBeta>(
              map['aliasIpRanges'],
              (value) => AliasIpRangeComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
