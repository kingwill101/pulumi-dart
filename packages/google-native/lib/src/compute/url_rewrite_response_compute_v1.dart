...
class UrlRewriteResponseComputeV1 {
  ...
  /// Creates a new [UrlRewriteResponseComputeV1].
  ...
  factory UrlRewriteResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return UrlRewriteResponseComputeV1(
