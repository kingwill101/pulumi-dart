...
class PublicAdvertisedPrefixComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeBeta>> publicDelegatedPrefixs;
  ...
  PublicAdvertisedPrefixComputeBeta(
    ...
    this.publicDelegatedPrefixs = registerOutput<List<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeBeta>>('publicDelegatedPrefixs');
