...
class RegionSnapshotArgs {
  ...
  RegionSnapshotArgs({
    ...
    RegionSnapshotSnapshotType? snapshotType,
    String? sourceDisk,
    ...
    List<String>? storageLocations,
      ...
      snapshotType = pulumi.Input.asOptionalInput<RegionSnapshotSnapshotType>(snapshotType),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'snapshotType': ?pulumi.Input.mapOptionalInputValue<RegionSnapshotSnapshotType, String>(snapshotType, (value) => value.value),
  ...
  factory RegionSnapshotArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotArgs(
      ...
      snapshotEncryptionKey: map['snapshotEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['snapshotEncryptionKey'] as Map).cast<String, dynamic>()),
      snapshotType: map['snapshotType'] == null ? null : RegionSnapshotSnapshotType.fromValue(map['snapshotType'] as String),
      ...
      sourceInstantSnapshotEncryptionKey: map['sourceInstantSnapshotEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['sourceInstantSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
