...
class RegionSnapshotArgs {
  ...
  RegionSnapshotArgs({
    ...
    List<String>? storageLocations,
       ...
       snapshotEncryptionKey = pulumi
           .Input.asOptionalInput<CustomerEncryptionKey>(snapshotEncryptionKey),
       snapshotType = pulumi.Input.asOptionalInput<RegionSnapshotSnapshotType>(
         snapshotType,
       ),
    ...
    return <String, dynamic>{
      ...
      'snapshotType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(snapshotType, (value) => value.value),
      ...
      'sourceInstantSnapshotEncryptionKey':
          ?pulumi.Input.mapOptionalInputValue<
            CustomerEncryptionKey,
            Map<String, dynamic>
          >(sourceInstantSnapshotEncryptionKey, (value) => value.toMap()),
  ...
  factory RegionSnapshotArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotArgs(
      ...
      snapshotType: map['snapshotType'] == null
          ? null
          : RegionSnapshotSnapshotType.fromValue(map['snapshotType'] as String),
