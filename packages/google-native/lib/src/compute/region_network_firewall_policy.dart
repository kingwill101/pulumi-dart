...
class RegionNetworkFirewallPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FirewallPolicyAssociationResponse>> associations;
  ...
  /// [args] Arguments used to configure this [RegionNetworkFirewallPolicy]. {@macro pulumi_compute_alpha_region_network_firewall_policy_args_doc}
  ...
  RegionNetworkFirewallPolicy(
    ...
    this.associations = registerOutput<List<FirewallPolicyAssociationResponse>>('associations');
