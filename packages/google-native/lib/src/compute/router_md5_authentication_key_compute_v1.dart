...
class RouterMd5AuthenticationKeyComputeV1 {
  ...
  /// Creates a new [RouterMd5AuthenticationKeyComputeV1].
  ...
  RouterMd5AuthenticationKeyComputeV1({this.key, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'key': ?key, 'name': ?name};
  }

  factory RouterMd5AuthenticationKeyComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return RouterMd5AuthenticationKeyComputeV1(
