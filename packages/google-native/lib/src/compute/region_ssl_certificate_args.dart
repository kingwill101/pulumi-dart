...
class RegionSslCertificateArgs {
  ...
  factory RegionSslCertificateArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslCertificateArgs(
      ...
      managed: map['managed'] == null ? null : SslCertificateManagedSslCertificate.fromMap((map['managed'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      privateKey: map['privateKey'] == null ? null : map['privateKey'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      selfManaged: map['selfManaged'] == null ? null : SslCertificateSelfManagedSslCertificate.fromMap((map['selfManaged'] as Map).cast<String, dynamic>()),
      type: map['type'] == null ? null : RegionSslCertificateType.fromValue(map['type'] as String),
    );
  }
}
