...
class RegionSslCertificateArgs {
  ...
  RegionSslCertificateArgs({
    ...
    RegionSslCertificateType? type,
       ...
       managed = pulumi
           .Input.asOptionalInput<SslCertificateManagedSslCertificate>(managed),
  ...
  factory RegionSslCertificateArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslCertificateArgs(
      ...
      managed: map['managed'] == null
          ? null
          : SslCertificateManagedSslCertificate.fromMap(
      ...
      selfManaged: map['selfManaged'] == null
          ? null
          : SslCertificateSelfManagedSslCertificate.fromMap(
              (map['selfManaged'] as Map).cast<String, dynamic>(),
            ),
      type: map['type'] == null
          ? null
          : RegionSslCertificateType.fromValue(map['type'] as String),
    );
  }
}
