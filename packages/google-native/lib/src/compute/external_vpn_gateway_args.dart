...
class ExternalVpnGatewayArgs {
  ...
  ExternalVpnGatewayArgs({
    ...
    String? name,
    String? project,
    ExternalVpnGatewayRedundancyType? redundancyType,
    String? requestId,
  ...
  factory ExternalVpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayArgs(
      ...
      interfaces: map['interfaces'] == null
          ? null
          : pulumi.Input.decodeList<ExternalVpnGatewayInterface>(
              map['interfaces'],
              (value) => ExternalVpnGatewayInterface.fromMap(
      ...
      redundancyType: map['redundancyType'] == null
          ? null
          : ExternalVpnGatewayRedundancyType.fromValue(
