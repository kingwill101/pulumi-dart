...
class InterconnectArgs {
  ...
  InterconnectArgs({
    ...
    String? customerName,
    String? description,
    InterconnectInterconnectType? interconnectType,
    Map<String, String>? labels,
    InterconnectLinkType? linkType,
    String? location,
    ...
    String? requestId,
    List<InterconnectRequestedFeaturesItem>? requestedFeatures,
  ...
  factory InterconnectArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs(
      ...
      interconnectType: map['interconnectType'] == null ? null : InterconnectInterconnectType.fromValue(map['interconnectType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linkType: map['linkType'] == null ? null : InterconnectLinkType.fromValue(map['linkType'] as String),
      ...
      requestedFeatures: map['requestedFeatures'] == null ? null : pulumi.Input.decodeList<InterconnectRequestedFeaturesItem>(map['requestedFeatures'], (value) => InterconnectRequestedFeaturesItem.fromValue(value as String)),
