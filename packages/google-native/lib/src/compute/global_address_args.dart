...
class GlobalAddressArgs {
  ...
  GlobalAddressArgs({
    ...
    String? subnetwork,
        ...
        addressType =
            pulumi.Input.asOptionalInput<GlobalAddressAddressType>(addressType),
        description = pulumi.Input.asOptionalInput<String>(description),
        ipVersion =
            pulumi.Input.asOptionalInput<GlobalAddressIpVersion>(ipVersion),
        ipv6EndpointType =
        ...
        networkTier =
            pulumi.Input.asOptionalInput<GlobalAddressNetworkTier>(networkTier),
  ...
  factory GlobalAddressArgs.fromMap(Map<String, dynamic> map) {
    return GlobalAddressArgs(
      ...
      addressType: map['addressType'] == null
          ? null
          : GlobalAddressAddressType.fromValue(map['addressType'] as String),
      description:
          map['description'] == null ? null : map['description'] as String,
      ipVersion: map['ipVersion'] == null
          ? null
          : GlobalAddressIpVersion.fromValue(map['ipVersion'] as String),
      ipv6EndpointType: map['ipv6EndpointType'] == null
          ? null
          : GlobalAddressIpv6EndpointType.fromValue(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : GlobalAddressNetworkTier.fromValue(map['networkTier'] as String),
      prefixLength:
          map['prefixLength'] == null ? null : map['prefixLength'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null
          ? null
          : GlobalAddressPurpose.fromValue(map['purpose'] as String),
