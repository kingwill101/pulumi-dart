...
class RegionInstanceGroupManagerArgs {
  ...
  RegionInstanceGroupManagerArgs({
    ...
    RegionInstanceGroupManagerListManagedInstancesResults? listManagedInstancesResults,
    String? name,
    ...
    List<InstanceGroupManagerVersion>? versions,
      ...
      failoverAction = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerFailoverAction>(failoverAction),
      ...
      listManagedInstancesResults = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerListManagedInstancesResults>(listManagedInstancesResults),
      ...
      targetSizeUnit = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerTargetSizeUnit>(targetSizeUnit),
  ...
  factory RegionInstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerArgs(
      ...
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : pulumi.Input.decodeList<InstanceGroupManagerAutoHealingPolicy>(map['autoHealingPolicies'], (value) => InstanceGroupManagerAutoHealingPolicy.fromMap((value as Map).cast<String, dynamic>())),
      baseInstanceName: map['baseInstanceName'] == null ? null : map['baseInstanceName'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      distributionPolicy: map['distributionPolicy'] == null ? null : DistributionPolicy.fromMap((map['distributionPolicy'] as Map).cast<String, dynamic>()),
      failoverAction: map['failoverAction'] == null ? null : RegionInstanceGroupManagerFailoverAction.fromValue(map['failoverAction'] as String),
      instanceFlexibilityPolicy: map['instanceFlexibilityPolicy'] == null ? null : InstanceGroupManagerInstanceFlexibilityPolicy.fromMap((map['instanceFlexibilityPolicy'] as Map).cast<String, dynamic>()),
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : RegionInstanceGroupManagerListManagedInstancesResults.fromValue(map['listManagedInstancesResults'] as String),
      ...
      statefulPolicy: map['statefulPolicy'] == null ? null : StatefulPolicy.fromMap((map['statefulPolicy'] as Map).cast<String, dynamic>()),
      ...
      targetSizeUnit: map['targetSizeUnit'] == null ? null : RegionInstanceGroupManagerTargetSizeUnit.fromValue(map['targetSizeUnit'] as String),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<InstanceGroupManagerVersion>(map['versions'], (value) => InstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
