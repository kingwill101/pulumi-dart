...
class SecurityPolicyRuleNetworkMatcherResponseComputeBeta {
  ...
  final List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta> userDefinedFields;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'userDefinedFields': pulumi.Input.encodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta, Map<String, dynamic>>(userDefinedFields, (value) => value.toMap()),
    };
  }

  factory SecurityPolicyRuleNetworkMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherResponseComputeBeta(
      ...
      userDefinedFields: pulumi.Input.decodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta>(map['userDefinedFields'], (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
