...
class GetSslCertificateComputeV1Result {
  ...
  /// Creates a new [GetSslCertificateComputeV1Result].
  ...
  GetSslCertificateComputeV1Result({
  ...
  factory GetSslCertificateComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetSslCertificateComputeV1Result(
      certificate: map['certificate'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      kind: map['kind'] as String,
      managed: SslCertificateManagedSslCertificateResponseComputeV1.fromMap(
      ...
      selfManaged:
          SslCertificateSelfManagedSslCertificateResponseComputeV1.fromMap(
