...
class VpnGatewayComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'requestId': ?requestId,
      'stackType': ?pulumi.Input.mapOptionalInputValue<VpnGatewayStackTypeComputeV1, String>(stackType, (value) => value.value),
  ...
  factory VpnGatewayComputeV1Args.fromMap(Map<String, dynamic> map) {
    return VpnGatewayComputeV1Args(
      ...
      stackType: map['stackType'] == null ? null : VpnGatewayStackTypeComputeV1.fromValue(map['stackType'] as String),
      vpnInterfaces: map['vpnInterfaces'] == null ? null : pulumi.Input.decodeList<VpnGatewayVpnGatewayInterfaceComputeV1>(map['vpnInterfaces'], (value) => VpnGatewayVpnGatewayInterfaceComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
