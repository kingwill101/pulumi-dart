...
class InstancePropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'guestAccelerators': pulumi.Input.encodeList<AcceleratorConfigResponse, Map<String, dynamic>>(guestAccelerators, (value) => value.toMap()),
      ...
      'serviceAccounts': pulumi.Input.encodeList<ServiceAccountResponse, Map<String, dynamic>>(serviceAccounts, (value) => value.toMap()),
  ...
  factory InstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesResponse(
      ...
      displayDevice: DisplayDeviceResponse.fromMap((map['displayDevice'] as Map).cast<String, dynamic>()),
      guestAccelerators: pulumi.Input.decodeList<AcceleratorConfigResponse>(map['guestAccelerators'], (value) => AcceleratorConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      networkPerformanceConfig: NetworkPerformanceConfigResponse.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      ...
      scheduling: SchedulingResponse.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      secureTags: (map['secureTags'] as List).cast<String>(),
      serviceAccounts: pulumi.Input.decodeList<ServiceAccountResponse>(map['serviceAccounts'], (value) => ServiceAccountResponse.fromMap((value as Map).cast<String, dynamic>())),
      serviceIntegrationSpecs: (map['serviceIntegrationSpecs'] as Map).cast<String, String>(),
      shieldedInstanceConfig: ShieldedInstanceConfigResponse.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      shieldedVmConfig: ShieldedVmConfigResponse.fromMap((map['shieldedVmConfig'] as Map).cast<String, dynamic>()),
