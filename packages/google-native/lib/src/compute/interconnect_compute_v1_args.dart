...
class InterconnectComputeV1Args {
  ...
  InterconnectComputeV1Args({
    ...
    String? customerName,
    String? description,
    InterconnectInterconnectTypeComputeV1? interconnectType,
    Map<String, String>? labels,
    InterconnectLinkTypeComputeV1? linkType,
    String? location,
    InterconnectMacsecComputeV1? macsec,
    bool? macsecEnabled,
    String? name,
    ...
    String? requestId,
    List<InterconnectRequestedFeaturesItemComputeV1>? requestedFeatures,
  ...
  factory InterconnectComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeV1Args(
      ...
      interconnectType: map['interconnectType'] == null ? null : InterconnectInterconnectTypeComputeV1.fromValue(map['interconnectType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linkType: map['linkType'] == null ? null : InterconnectLinkTypeComputeV1.fromValue(map['linkType'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      macsec: map['macsec'] == null ? null : InterconnectMacsecComputeV1.fromMap((map['macsec'] as Map).cast<String, dynamic>()),
      macsecEnabled: map['macsecEnabled'] == null ? null : map['macsecEnabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      nocContactEmail: map['nocContactEmail'] == null ? null : map['nocContactEmail'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      remoteLocation: map['remoteLocation'] == null ? null : map['remoteLocation'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      requestedFeatures: map['requestedFeatures'] == null ? null : pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeV1>(map['requestedFeatures'], (value) => InterconnectRequestedFeaturesItemComputeV1.fromValue(value as String)),
      requestedLinkCount: map['requestedLinkCount'] == null ? null : map['requestedLinkCount'] as int,
    );
  }
}
