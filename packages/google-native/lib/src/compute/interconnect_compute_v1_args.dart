...
class InterconnectComputeV1Args {
  ...
  InterconnectComputeV1Args({
    ...
    int? requestedLinkCount,
        ...
        macsec =
            pulumi.Input.asOptionalInput<InterconnectMacsecComputeV1>(macsec),
        ...
        requestedFeatures = pulumi.Input.asOptionalInput<
            ...
            requestedFeatures),
        requestedLinkCount =
            pulumi.Input.asOptionalInput<int>(requestedLinkCount);
  ...
  factory InterconnectComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeV1Args(
      ...
      customerName:
          map['customerName'] == null ? null : map['customerName'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      interconnectType: map['interconnectType'] == null
          ? null
          : InterconnectInterconnectTypeComputeV1.fromValue(
      ...
      linkType: map['linkType'] == null
          ? null
          : InterconnectLinkTypeComputeV1.fromValue(map['linkType'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      macsec: map['macsec'] == null
          ? null
          : InterconnectMacsecComputeV1.fromMap(
              (map['macsec'] as Map).cast<String, dynamic>()),
      macsecEnabled:
          map['macsecEnabled'] == null ? null : map['macsecEnabled'] as bool,
      ...
      requestedFeatures: map['requestedFeatures'] == null
          ? null
          : pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeV1>(
              map['requestedFeatures'],
              (value) => InterconnectRequestedFeaturesItemComputeV1.fromValue(
                  value as String)),
