...
class FirewallPolicyRuleComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetSecureTags': ?targetSecureTags == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleSecureTagComputeBeta, Map<String, dynamic>>(targetSecureTags!, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleComputeBeta(
      ...
      direction: map['direction'] == null ? null : FirewallPolicyRuleDirectionComputeBeta.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      enableLogging: map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      match: map['match'] == null ? null : FirewallPolicyRuleMatcherComputeBeta.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleSecureTagComputeBeta>(map['targetSecureTags'], (value) => FirewallPolicyRuleSecureTagComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
