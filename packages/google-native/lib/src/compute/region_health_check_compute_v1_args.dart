...
class RegionHealthCheckComputeV1Args {
  ...
  RegionHealthCheckComputeV1Args({
    ...
    int? unhealthyThreshold,
       ...
       grpcHealthCheck = pulumi.Input.asOptionalInput<GRPCHealthCheckComputeV1>(
         grpcHealthCheck,
       ),
       healthyThreshold = pulumi.Input.asOptionalInput<int>(healthyThreshold),
       http2HealthCheck = pulumi
           .Input.asOptionalInput<HTTP2HealthCheckComputeV1>(http2HealthCheck),
       httpHealthCheck = pulumi.Input.asOptionalInput<HTTPHealthCheckComputeV1>(
         httpHealthCheck,
       ),
       httpsHealthCheck = pulumi
           .Input.asOptionalInput<HTTPSHealthCheckComputeV1>(httpsHealthCheck),
       ...
       type = pulumi.Input.asOptionalInput<RegionHealthCheckTypeComputeV1>(
         type,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<
            RegionHealthCheckTypeComputeV1,
            String
  ...
  factory RegionHealthCheckComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckComputeV1Args(
      ...
      type: map['type'] == null
          ? null
          : RegionHealthCheckTypeComputeV1.fromValue(map['type'] as String),
