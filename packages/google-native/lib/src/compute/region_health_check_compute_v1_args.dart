...
class RegionHealthCheckComputeV1Args {
  ...
  RegionHealthCheckComputeV1Args({
    ...
    int? timeoutSec,
    RegionHealthCheckTypeComputeV1? type,
    int? unhealthyThreshold,
      ...
      type = pulumi.Input.asOptionalInput<RegionHealthCheckTypeComputeV1>(type),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckTypeComputeV1, String>(type, (value) => value.value),
  ...
  factory RegionHealthCheckComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckComputeV1Args(
      ...
      grpcHealthCheck: map['grpcHealthCheck'] == null ? null : GRPCHealthCheckComputeV1.fromMap((map['grpcHealthCheck'] as Map).cast<String, dynamic>()),
      healthyThreshold: map['healthyThreshold'] == null ? null : map['healthyThreshold'] as int,
      http2HealthCheck: map['http2HealthCheck'] == null ? null : HTTP2HealthCheckComputeV1.fromMap((map['http2HealthCheck'] as Map).cast<String, dynamic>()),
      httpHealthCheck: map['httpHealthCheck'] == null ? null : HTTPHealthCheckComputeV1.fromMap((map['httpHealthCheck'] as Map).cast<String, dynamic>()),
      httpsHealthCheck: map['httpsHealthCheck'] == null ? null : HTTPSHealthCheckComputeV1.fromMap((map['httpsHealthCheck'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      logConfig: map['logConfig'] == null ? null : HealthCheckLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      sslHealthCheck: map['sslHealthCheck'] == null ? null : SSLHealthCheckComputeV1.fromMap((map['sslHealthCheck'] as Map).cast<String, dynamic>()),
      tcpHealthCheck: map['tcpHealthCheck'] == null ? null : TCPHealthCheckComputeV1.fromMap((map['tcpHealthCheck'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] == null ? null : map['timeoutSec'] as int,
      type: map['type'] == null ? null : RegionHealthCheckTypeComputeV1.fromValue(map['type'] as String),
