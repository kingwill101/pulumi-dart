...
class RouterBgpPeerResponseComputeV1 {
  ...
  final List<RouterBgpPeerCustomLearnedIpRangeResponseComputeV1>
  ...
  factory RouterBgpPeerResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponseComputeV1(
      ...
      bfd: RouterBgpPeerBfdResponseComputeV1.fromMap(
      ...
      customLearnedIpRanges:
          ...
          >(
            ...
            (value) =>
                RouterBgpPeerCustomLearnedIpRangeResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
