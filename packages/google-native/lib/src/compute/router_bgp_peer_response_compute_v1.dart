...
class RouterBgpPeerResponseComputeV1 {
  ...
  final RouterBgpPeerBfdResponseComputeV1 bfd;
  /// A list of user-defined custom learned route IP address ranges for a BGP session.
  final List<RouterBgpPeerCustomLearnedIpRangeResponseComputeV1> customLearnedIpRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bfd': bfd.toMap(),
      'customLearnedIpRanges': pulumi.Input.encodeList<RouterBgpPeerCustomLearnedIpRangeResponseComputeV1, Map<String, dynamic>>(customLearnedIpRanges, (value) => value.toMap()),
  ...
  factory RouterBgpPeerResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponseComputeV1(
      ...
      bfd: RouterBgpPeerBfdResponseComputeV1.fromMap((map['bfd'] as Map).cast<String, dynamic>()),
      customLearnedIpRanges: pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeResponseComputeV1>(map['customLearnedIpRanges'], (value) => RouterBgpPeerCustomLearnedIpRangeResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
