...
class InstanceGroupManagerArgs {
  ...
  InstanceGroupManagerArgs({
    ...
    InstanceGroupManagerFailoverAction? failoverAction,
    ...
    InstanceGroupManagerListManagedInstancesResults? listManagedInstancesResults,
    String? name,
    ...
    int? targetSize,
    InstanceGroupManagerTargetSizeUnit? targetSizeUnit,
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      ...
      failoverAction: map['failoverAction'] == null ? null : InstanceGroupManagerFailoverAction.fromValue(map['failoverAction'] as String),
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : InstanceGroupManagerListManagedInstancesResults.fromValue(map['listManagedInstancesResults'] as String),
      ...
      targetSizeUnit: map['targetSizeUnit'] == null ? null : InstanceGroupManagerTargetSizeUnit.fromValue(map['targetSizeUnit'] as String),
