    ...
    String? zone,
        ...
        standbyPolicy =
            pulumi.Input.asOptionalInput<InstanceGroupManagerStandbyPolicy>(
                standbyPolicy),
        statefulPolicy =
            pulumi.Input.asOptionalInput<StatefulPolicy>(statefulPolicy),
        ...
        updatePolicy =
            pulumi.Input.asOptionalInput<InstanceGroupManagerUpdatePolicy>(
                updatePolicy),
        versions =
            pulumi.Input.asOptionalInput<List<InstanceGroupManagerVersion>>(
                versions),
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      ...
      failoverAction: map['failoverAction'] == null
          ? null
          : InstanceGroupManagerFailoverAction.fromValue(
      ...
      targetSizeUnit: map['targetSizeUnit'] == null
          ? null
          : InstanceGroupManagerTargetSizeUnit.fromValue(
