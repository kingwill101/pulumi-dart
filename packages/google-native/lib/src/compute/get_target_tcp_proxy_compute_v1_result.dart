...
class GetTargetTcpProxyComputeV1Result {
  ...
  /// Creates a new [GetTargetTcpProxyComputeV1Result].
  ...
  factory GetTargetTcpProxyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetTargetTcpProxyComputeV1Result(
