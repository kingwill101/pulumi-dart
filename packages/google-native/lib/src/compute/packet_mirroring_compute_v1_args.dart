...
class PacketMirroringComputeV1Args {
  ...
  final pulumi.Input<PacketMirroringMirroredResourceInfoComputeV1>? mirroredResources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'collectorIlb': ?pulumi.Input.mapOptionalInputValue<PacketMirroringForwardingRuleInfoComputeV1, Map<String, dynamic>>(collectorIlb, (value) => value.toMap()),
      'description': ?description,
      'enable': ?pulumi.Input.mapOptionalInputValue<PacketMirroringEnableComputeV1, String>(enable, (value) => value.value),
      'filter': ?pulumi.Input.mapOptionalInputValue<PacketMirroringFilterComputeV1, Map<String, dynamic>>(filter, (value) => value.toMap()),
      'mirroredResources': ?pulumi.Input.mapOptionalInputValue<PacketMirroringMirroredResourceInfoComputeV1, Map<String, dynamic>>(mirroredResources, (value) => value.toMap()),
      'name': ?name,
      'network': ?pulumi.Input.mapOptionalInputValue<PacketMirroringNetworkInfoComputeV1, Map<String, dynamic>>(network, (value) => value.toMap()),
      'priority': ?priority,
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
  ...
  factory PacketMirroringComputeV1Args.fromMap(Map<String, dynamic> map) {
    return PacketMirroringComputeV1Args(
      collectorIlb: map['collectorIlb'] == null ? null : PacketMirroringForwardingRuleInfoComputeV1.fromMap((map['collectorIlb'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enable: map['enable'] == null ? null : PacketMirroringEnableComputeV1.fromValue(map['enable'] as String),
      filter: map['filter'] == null ? null : PacketMirroringFilterComputeV1.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      mirroredResources: map['mirroredResources'] == null ? null : PacketMirroringMirroredResourceInfoComputeV1.fromMap((map['mirroredResources'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : PacketMirroringNetworkInfoComputeV1.fromMap((map['network'] as Map).cast<String, dynamic>()),
