...
enum SubnetworkPurposeComputeBeta {
  ...
  const SubnetworkPurposeComputeBeta(this.value);
  final String value;

  static SubnetworkPurposeComputeBeta fromValue(String value) {
    for (final item in SubnetworkPurposeComputeBeta.values) {
      if (item.value == value) {
        return item;
      }
    }
