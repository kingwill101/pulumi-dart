...
class RegionHealthCheck extends pulumi.CustomResource {
  ...
  RegionHealthCheck(
    ...
    this.grpcHealthCheck = registerOutput<GRPCHealthCheckResponse>('grpcHealthCheck');
    this.healthyThreshold = registerOutput<int>('healthyThreshold');
    this.http2HealthCheck = registerOutput<HTTP2HealthCheckResponse>('http2HealthCheck');
    this.httpHealthCheck = registerOutput<HTTPHealthCheckResponse>('httpHealthCheck');
    this.httpsHealthCheck = registerOutput<HTTPSHealthCheckResponse>('httpsHealthCheck');
    ...
    this.sslHealthCheck = registerOutput<SSLHealthCheckResponse>('sslHealthCheck');
    this.tcpHealthCheck = registerOutput<TCPHealthCheckResponse>('tcpHealthCheck');
    this.timeoutSec = registerOutput<int>('timeoutSec');
    this.type = registerOutput<String>('type');
    this.udpHealthCheck = registerOutput<UDPHealthCheckResponse>('udpHealthCheck');
