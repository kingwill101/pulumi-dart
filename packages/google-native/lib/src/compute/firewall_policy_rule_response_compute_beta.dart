...
class FirewallPolicyRuleResponseComputeBeta {
  ...
  final FirewallPolicyRuleMatcherResponseComputeBeta match;
  ...
  final List<FirewallPolicyRuleSecureTagResponseComputeBeta> targetSecureTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetSecureTags': pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponseComputeBeta, Map<String, dynamic>>(targetSecureTags, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponseComputeBeta(
      ...
      match: FirewallPolicyRuleMatcherResponseComputeBeta.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeBeta>(map['targetSecureTags'], (value) => FirewallPolicyRuleSecureTagResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
