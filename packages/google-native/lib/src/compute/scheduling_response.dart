...
class SchedulingResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gracefulShutdown': gracefulShutdown.toMap(),
      ...
      'nodeAffinities': pulumi.Input.encodeList<SchedulingNodeAffinityResponse, Map<String, dynamic>>(nodeAffinities, (value) => value.toMap()),
  ...
  factory SchedulingResponse.fromMap(Map<String, dynamic> map) {
    return SchedulingResponse(
      ...
      gracefulShutdown: SchedulingGracefulShutdownResponse.fromMap((map['gracefulShutdown'] as Map).cast<String, dynamic>()),
      ...
      localSsdRecoveryTimeout: DurationResponse.fromMap((map['localSsdRecoveryTimeout'] as Map).cast<String, dynamic>()),
      ...
      maxRunDuration: DurationResponse.fromMap((map['maxRunDuration'] as Map).cast<String, dynamic>()),
      minNodeCpus: map['minNodeCpus'] as int,
      nodeAffinities: pulumi.Input.decodeList<SchedulingNodeAffinityResponse>(map['nodeAffinities'], (value) => SchedulingNodeAffinityResponse.fromMap((value as Map).cast<String, dynamic>())),
