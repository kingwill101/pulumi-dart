...
class ExternalVpnGateway extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ExternalVpnGatewayInterfaceResponse>> interfaces;
  ...
  /// [args] Arguments used to configure this [ExternalVpnGateway]. {@macro pulumi_compute_alpha_external_vpn_gateway_args_doc}
  ...
  ExternalVpnGateway(
    ...
    this.interfaces = registerOutput<List<ExternalVpnGatewayInterfaceResponse>>('interfaces');
