...
class NodeGroupArgs {
  ...
  NodeGroupArgs({
    ...
    String? zone,
      ...
      maintenanceInterval = pulumi.Input.asOptionalInput<NodeGroupMaintenanceInterval>(maintenanceInterval),
      maintenancePolicy = pulumi.Input.asOptionalInput<NodeGroupMaintenancePolicy>(maintenancePolicy),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maintenanceInterval': ?pulumi.Input.mapOptionalInputValue<NodeGroupMaintenanceInterval, String>(maintenanceInterval, (value) => value.value),
      'maintenancePolicy': ?pulumi.Input.mapOptionalInputValue<NodeGroupMaintenancePolicy, String>(maintenancePolicy, (value) => value.value),
  ...
  factory NodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs(
      autoscalingPolicy: map['autoscalingPolicy'] == null ? null : NodeGroupAutoscalingPolicy.fromMap((map['autoscalingPolicy'] as Map).cast<String, dynamic>()),
      ...
      maintenanceInterval: map['maintenanceInterval'] == null ? null : NodeGroupMaintenanceInterval.fromValue(map['maintenanceInterval'] as String),
      maintenancePolicy: map['maintenancePolicy'] == null ? null : NodeGroupMaintenancePolicy.fromValue(map['maintenancePolicy'] as String),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : NodeGroupMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      nodeTemplate: map['nodeTemplate'] == null ? null : map['nodeTemplate'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      shareSettings: map['shareSettings'] == null ? null : ShareSettings.fromMap((map['shareSettings'] as Map).cast<String, dynamic>()),
