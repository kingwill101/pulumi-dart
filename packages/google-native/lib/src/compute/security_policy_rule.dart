...
class SecurityPolicyRule {
  ...
  factory SecurityPolicyRule.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRule(
      ...
      ruleNumber: map['ruleNumber'] == null
          ? null
          : map['ruleNumber'] as String,
