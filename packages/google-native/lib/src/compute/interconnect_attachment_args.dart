...
class InterconnectAttachmentArgs {
  ...
  final pulumi.Input<InterconnectAttachmentEdgeAvailabilityDomain>?
  ...
  InterconnectAttachmentArgs({
    ...
    int? vlanTag8021q,
        ...
        bandwidth =
            pulumi.Input.asOptionalInput<InterconnectAttachmentBandwidth>(
                bandwidth),
        candidateIpv6Subnets =
            pulumi.Input.asOptionalInput<List<String>>(candidateIpv6Subnets),
        candidateSubnets =
            pulumi.Input.asOptionalInput<List<String>>(candidateSubnets),
        cloudRouterIpv6InterfaceId =
            pulumi.Input.asOptionalInput<String>(cloudRouterIpv6InterfaceId),
        customerRouterIpv6InterfaceId =
            pulumi.Input.asOptionalInput<String>(customerRouterIpv6InterfaceId),
        description = pulumi.Input.asOptionalInput<String>(description),
        edgeAvailabilityDomain = pulumi.Input.asOptionalInput<
                InterconnectAttachmentEdgeAvailabilityDomain>(
            edgeAvailabilityDomain),
        encryption =
            pulumi.Input.asOptionalInput<InterconnectAttachmentEncryption>(
                encryption),
        interconnect = pulumi.Input.asOptionalInput<String>(interconnect),
        ipsecInternalAddresses =
            pulumi.Input.asOptionalInput<List<String>>(ipsecInternalAddresses),
        ...
        partnerMetadata =
            pulumi.Input.asOptionalInput<InterconnectAttachmentPartnerMetadata>(
                partnerMetadata),
        ...
        stackType =
            pulumi.Input.asOptionalInput<InterconnectAttachmentStackType>(
                stackType),
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      bandwidth: map['bandwidth'] == null
          ? null
          : InterconnectAttachmentBandwidth.fromValue(
              map['bandwidth'] as String),
      candidateIpv6Subnets: map['candidateIpv6Subnets'] == null
          ? null
          : (map['candidateIpv6Subnets'] as List).cast<String>(),
      candidateSubnets: map['candidateSubnets'] == null
          ? null
          : (map['candidateSubnets'] as List).cast<String>(),
      cloudRouterIpv6InterfaceId: map['cloudRouterIpv6InterfaceId'] == null
          ? null
          : map['cloudRouterIpv6InterfaceId'] as String,
      customerRouterIpv6InterfaceId:
          map['customerRouterIpv6InterfaceId'] == null
              ? null
              : map['customerRouterIpv6InterfaceId'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null
          ? null
          : InterconnectAttachmentEdgeAvailabilityDomain.fromValue(
              map['edgeAvailabilityDomain'] as String),
      encryption: map['encryption'] == null
          ? null
          : InterconnectAttachmentEncryption.fromValue(
      ...
      partnerAsn:
          map['partnerAsn'] == null ? null : map['partnerAsn'] as String,
      partnerMetadata: map['partnerMetadata'] == null
          ? null
          : InterconnectAttachmentPartnerMetadata.fromMap(
      ...
      stackType: map['stackType'] == null
          ? null
          : InterconnectAttachmentStackType.fromValue(
              map['stackType'] as String),
      subnetLength:
          map['subnetLength'] == null ? null : map['subnetLength'] as int,
      type: map['type'] == null
          ? null
          : InterconnectAttachmentType.fromValue(map['type'] as String),
      vlanTag8021q:
          map['vlanTag8021q'] == null ? null : map['vlanTag8021q'] as int,
    );
  }
}
