...
class InterconnectAttachmentArgs {
  ...
  InterconnectAttachmentArgs({
    ...
    int? vlanTag8021q,
       ...
       bandwidth = pulumi
           .Input.asOptionalInput<InterconnectAttachmentBandwidth>(bandwidth),
       ...
       edgeAvailabilityDomain =
           ...
           >(edgeAvailabilityDomain),
       encryption = pulumi
           .Input.asOptionalInput<InterconnectAttachmentEncryption>(encryption),
       ...
       stackType = pulumi
           .Input.asOptionalInput<InterconnectAttachmentStackType>(stackType),
    ...
    return <String, dynamic>{
      ...
      'edgeAvailabilityDomain':
          ?pulumi.Input.mapOptionalInputValue<
            InterconnectAttachmentEdgeAvailabilityDomain,
            String
          >(edgeAvailabilityDomain, (value) => value.value),
      'encryption':
          ?pulumi.Input.mapOptionalInputValue<
            InterconnectAttachmentEncryption,
            String
          >(encryption, (value) => value.value),
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      partnerAsn: map['partnerAsn'] == null
          ? null
          : map['partnerAsn'] as String,
