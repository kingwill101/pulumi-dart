...
import 'interconnect_attachment_partner_metadata.dart';
import 'interconnect_attachment_stack_type.dart';
import 'interconnect_attachment_type.dart';

/// {@template pulumi_compute_alpha_interconnect_attachment_args_doc}
/// The set of arguments for InterconnectAttachment.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_interconnect_attachment_args_doc}
class InterconnectAttachmentArgs {
  ...
  final pulumi.Input<InterconnectAttachmentBandwidth>? bandwidth;
  ...
  final pulumi.Input<InterconnectAttachmentEdgeAvailabilityDomain>? edgeAvailabilityDomain;
  ...
  final pulumi.Input<InterconnectAttachmentEncryption>? encryption;
  ...
  final pulumi.Input<InterconnectAttachmentPartnerMetadata>? partnerMetadata;
  ...
  final pulumi.Input<InterconnectAttachmentStackType>? stackType;
  ...
  final pulumi.Input<InterconnectAttachmentType>? type;
  ...
  InterconnectAttachmentArgs({
    bool? adminEnabled,
    InterconnectAttachmentBandwidth? bandwidth,
    ...
    String? description,
    InterconnectAttachmentEdgeAvailabilityDomain? edgeAvailabilityDomain,
    InterconnectAttachmentEncryption? encryption,
    String? interconnect,
    ...
    String? requestId,
    String? router,
    InterconnectAttachmentStackType? stackType,
    int? subnetLength,
    InterconnectAttachmentType? type,
    int? vlanTag8021q,
  }) :
      adminEnabled = pulumi.Input.asOptionalInput<bool>(adminEnabled),
      bandwidth = pulumi.Input.asOptionalInput<InterconnectAttachmentBandwidth>(bandwidth),
      ...
      edgeAvailabilityDomain = pulumi.Input.asOptionalInput<InterconnectAttachmentEdgeAvailabilityDomain>(edgeAvailabilityDomain),
      encryption = pulumi.Input.asOptionalInput<InterconnectAttachmentEncryption>(encryption),
      ...
      partnerMetadata = pulumi.Input.asOptionalInput<InterconnectAttachmentPartnerMetadata>(partnerMetadata),
      project = pulumi.Input.asOptionalInput<String>(project),
      region = pulumi.Input.asInput<String>(region),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      router = pulumi.Input.asOptionalInput<String>(router),
      stackType = pulumi.Input.asOptionalInput<InterconnectAttachmentStackType>(stackType),
      subnetLength = pulumi.Input.asOptionalInput<int>(subnetLength),
      type = pulumi.Input.asOptionalInput<InterconnectAttachmentType>(type),
      vlanTag8021q = pulumi.Input.asOptionalInput<int>(vlanTag8021q);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adminEnabled': ?adminEnabled,
      'bandwidth': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentBandwidth, String>(bandwidth, (value) => value.value),
      ...
      'edgeAvailabilityDomain': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEdgeAvailabilityDomain, String>(edgeAvailabilityDomain, (value) => value.value),
      'encryption': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEncryption, String>(encryption, (value) => value.value),
      ...
      'partnerMetadata': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentPartnerMetadata, Map<String, dynamic>>(partnerMetadata, (value) => value.toMap()),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
      'router': ?router,
      'stackType': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentStackType, String>(stackType, (value) => value.value),
      'subnetLength': ?subnetLength,
      'type': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentType, String>(type, (value) => value.value),
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      bandwidth: map['bandwidth'] == null ? null : InterconnectAttachmentBandwidth.fromValue(map['bandwidth'] as String),
      candidateIpv6Subnets: map['candidateIpv6Subnets'] == null ? null : (map['candidateIpv6Subnets'] as List).cast<String>(),
      candidateSubnets: map['candidateSubnets'] == null ? null : (map['candidateSubnets'] as List).cast<String>(),
      cloudRouterIpv6InterfaceId: map['cloudRouterIpv6InterfaceId'] == null ? null : map['cloudRouterIpv6InterfaceId'] as String,
      customerRouterIpv6InterfaceId: map['customerRouterIpv6InterfaceId'] == null ? null : map['customerRouterIpv6InterfaceId'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : InterconnectAttachmentEdgeAvailabilityDomain.fromValue(map['edgeAvailabilityDomain'] as String),
      encryption: map['encryption'] == null ? null : InterconnectAttachmentEncryption.fromValue(map['encryption'] as String),
      interconnect: map['interconnect'] == null ? null : map['interconnect'] as String,
      ipsecInternalAddresses: map['ipsecInternalAddresses'] == null ? null : (map['ipsecInternalAddresses'] as List).cast<String>(),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      mtu: map['mtu'] == null ? null : map['mtu'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      pairingKey: map['pairingKey'] == null ? null : map['pairingKey'] as String,
      partnerAsn: map['partnerAsn'] == null ? null : map['partnerAsn'] as String,
      partnerMetadata: map['partnerMetadata'] == null ? null : InterconnectAttachmentPartnerMetadata.fromMap((map['partnerMetadata'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      router: map['router'] == null ? null : map['router'] as String,
      stackType: map['stackType'] == null ? null : InterconnectAttachmentStackType.fromValue(map['stackType'] as String),
      subnetLength: map['subnetLength'] == null ? null : map['subnetLength'] as int,
      type: map['type'] == null ? null : InterconnectAttachmentType.fromValue(map['type'] as String),
      vlanTag8021q: map['vlanTag8021q'] == null ? null : map['vlanTag8021q'] as int,
    );
  }
}
