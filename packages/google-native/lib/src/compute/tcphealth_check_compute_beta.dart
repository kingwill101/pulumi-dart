...
class TCPHealthCheckComputeBeta {
  ...
  final TCPHealthCheckPortSpecificationComputeBeta? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final TCPHealthCheckProxyHeaderComputeBeta? proxyHeader;
  ...
  factory TCPHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckComputeBeta(
      ...
      portSpecification: map['portSpecification'] == null ? null : TCPHealthCheckPortSpecificationComputeBeta.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : TCPHealthCheckProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String),
