...
class TargetTcpProxyComputeV1Args {
  ...
  TargetTcpProxyComputeV1Args({
    ...
    String? project,
    bool? proxyBind,
    TargetTcpProxyProxyHeaderComputeV1? proxyHeader,
    String? requestId,
    String? service,
  }) :
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetTcpProxyProxyHeaderComputeV1, String>(proxyHeader, (value) => value.value),
      'requestId': ?requestId,
      'service': ?service,
    };
  }
  ...
  factory TargetTcpProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyComputeV1Args(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : TargetTcpProxyProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String),
