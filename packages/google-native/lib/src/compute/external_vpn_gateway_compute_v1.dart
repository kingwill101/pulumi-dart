...
class ExternalVpnGatewayComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ExternalVpnGatewayInterfaceResponseComputeV1>> interfaces;
  ...
  ExternalVpnGatewayComputeV1(
    ...
    this.interfaces = registerOutput<List<ExternalVpnGatewayInterfaceResponseComputeV1>>('interfaces');
