...
class RegionInstanceGroupManagerComputeV1Args {
  ...
  RegionInstanceGroupManagerComputeV1Args({
    ...
    RegionInstanceGroupManagerListManagedInstancesResultsComputeV1? listManagedInstancesResults,
    String? name,
    ...
    List<InstanceGroupManagerVersionComputeV1>? versions,
      ...
      listManagedInstancesResults = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerListManagedInstancesResultsComputeV1>(listManagedInstancesResults),
  ...
  factory RegionInstanceGroupManagerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerComputeV1Args(
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : RegionInstanceGroupManagerListManagedInstancesResultsComputeV1.fromValue(map['listManagedInstancesResults'] as String),
