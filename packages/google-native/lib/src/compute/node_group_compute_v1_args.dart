...
class NodeGroupComputeV1Args {
  ...
  NodeGroupComputeV1Args({
    ...
    String? zone,
      ...
      autoscalingPolicy = pulumi.Input.asOptionalInput<NodeGroupAutoscalingPolicyComputeV1>(autoscalingPolicy),
      ...
      maintenancePolicy = pulumi.Input.asOptionalInput<NodeGroupMaintenancePolicyComputeV1>(maintenancePolicy),
      maintenanceWindow = pulumi.Input.asOptionalInput<NodeGroupMaintenanceWindowComputeV1>(maintenanceWindow),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maintenancePolicy': ?pulumi.Input.mapOptionalInputValue<NodeGroupMaintenancePolicyComputeV1, String>(maintenancePolicy, (value) => value.value),
  ...
  factory NodeGroupComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeGroupComputeV1Args(
      autoscalingPolicy: map['autoscalingPolicy'] == null ? null : NodeGroupAutoscalingPolicyComputeV1.fromMap((map['autoscalingPolicy'] as Map).cast<String, dynamic>()),
      ...
      maintenancePolicy: map['maintenancePolicy'] == null ? null : NodeGroupMaintenancePolicyComputeV1.fromValue(map['maintenancePolicy'] as String),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : NodeGroupMaintenanceWindowComputeV1.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
