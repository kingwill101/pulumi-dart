...
class FirewallAllowedItemComputeV1 {
  ...
  /// Creates a new [FirewallAllowedItemComputeV1].
  ...
  FirewallAllowedItemComputeV1({this.ipProtocol, this.ports});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'ipProtocol': ?ipProtocol, 'ports': ?ports};
  }

  factory FirewallAllowedItemComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallAllowedItemComputeV1(
