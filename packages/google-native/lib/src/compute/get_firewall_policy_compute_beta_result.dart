...
class GetFirewallPolicyComputeBetaResult {
  ...
  /// Creates a new [GetFirewallPolicyComputeBetaResult].
  ...
  GetFirewallPolicyComputeBetaResult({
  ...
  factory GetFirewallPolicyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetFirewallPolicyComputeBetaResult(
      associations:
