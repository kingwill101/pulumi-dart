...
class HTTPHealthCheckResponseComputeBeta {
  ...
  /// Creates a new [HTTPHealthCheckResponseComputeBeta].
  ...
  HTTPHealthCheckResponseComputeBeta({
    required this.host,
    required this.port,
  ...
  factory HTTPHealthCheckResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheckResponseComputeBeta(
