...
class PathMatcherResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'pathRules': pulumi.Input.encodeList<PathRuleResponseComputeV1, Map<String, dynamic>>(pathRules, (value) => value.toMap()),
      'routeRules': pulumi.Input.encodeList<HttpRouteRuleResponseComputeV1, Map<String, dynamic>>(routeRules, (value) => value.toMap()),
    };
  }
  ...
  factory PathMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeV1(
      ...
      pathRules: pulumi.Input.decodeList<PathRuleResponseComputeV1>(map['pathRules'], (value) => PathRuleResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      routeRules: pulumi.Input.decodeList<HttpRouteRuleResponseComputeV1>(map['routeRules'], (value) => HttpRouteRuleResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
