...
class RegionBackendServiceArgs {
  ...
  RegionBackendServiceArgs({
    ...
    RegionBackendServiceCompressionMode? compressionMode,
    ...
    RegionBackendServiceVpcNetworkScope? vpcNetworkScope,
  }) :
  ...
  factory RegionBackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs(
      ...
      compressionMode: map['compressionMode'] == null ? null : RegionBackendServiceCompressionMode.fromValue(map['compressionMode'] as String),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : RegionBackendServiceIpAddressSelectionPolicy.fromValue(map['ipAddressSelectionPolicy'] as String),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : RegionBackendServiceLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : RegionBackendServiceLocalityLbPolicy.fromValue(map['localityLbPolicy'] as String),
      ...
      protocol: map['protocol'] == null ? null : RegionBackendServiceProtocol.fromValue(map['protocol'] as String),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : RegionBackendServiceSessionAffinity.fromValue(map['sessionAffinity'] as String),
      ...
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : RegionBackendServiceVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String),
    );
  }
}
