  ...
  factory RegionBackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs(
      ...
      compressionMode: map['compressionMode'] == null
          ? null
          : RegionBackendServiceCompressionMode.fromValue(
      ...
      protocol: map['protocol'] == null
          ? null
          : RegionBackendServiceProtocol.fromValue(map['protocol'] as String),
      ...
      sessionAffinity: map['sessionAffinity'] == null
          ? null
          : RegionBackendServiceSessionAffinity.fromValue(
      ...
      vpcNetworkScope: map['vpcNetworkScope'] == null
          ? null
          : RegionBackendServiceVpcNetworkScope.fromValue(
