...
class BackendServiceArgs {
  ...
  BackendServiceArgs({
    ...
    BackendServiceVpcNetworkScope? vpcNetworkScope,
       ...
       circuitBreakers = pulumi.Input.asOptionalInput<CircuitBreakers>(
         circuitBreakers,
       ),
       compressionMode =
       ...
       failoverPolicy = pulumi
           .Input.asOptionalInput<BackendServiceFailoverPolicy>(failoverPolicy),
       healthChecks = pulumi.Input.asOptionalInput<List<String>>(healthChecks),
       iap = pulumi.Input.asOptionalInput<BackendServiceIAP>(iap),
       ipAddressSelectionPolicy =
           pulumi.Input.asOptionalInput<BackendServiceIpAddressSelectionPolicy>(
             ipAddressSelectionPolicy,
           ),
       loadBalancingScheme =
       ...
       maxStreamDuration = pulumi.Input.asOptionalInput<Duration>(
         maxStreamDuration,
       ),
       ...
       protocol = pulumi.Input.asOptionalInput<BackendServiceProtocol>(
         protocol,
       ),
