...
class BackendServiceArgs {
  ...
  BackendServiceArgs({
    ...
    BackendServiceVpcNetworkScope? vpcNetworkScope,
      ...
      compressionMode = pulumi.Input.asOptionalInput<BackendServiceCompressionMode>(compressionMode),
      ...
      ipAddressSelectionPolicy = pulumi.Input.asOptionalInput<BackendServiceIpAddressSelectionPolicy>(ipAddressSelectionPolicy),
      loadBalancingScheme = pulumi.Input.asOptionalInput<BackendServiceLoadBalancingScheme>(loadBalancingScheme),
      localityLbPolicies = pulumi.Input.asOptionalInput<List<BackendServiceLocalityLoadBalancingPolicyConfig>>(localityLbPolicies),
      localityLbPolicy = pulumi.Input.asOptionalInput<BackendServiceLocalityLbPolicy>(localityLbPolicy),
      ...
      protocol = pulumi.Input.asOptionalInput<BackendServiceProtocol>(protocol),
      ...
      sessionAffinity = pulumi.Input.asOptionalInput<BackendServiceSessionAffinity>(sessionAffinity),
      ...
      vpcNetworkScope = pulumi.Input.asOptionalInput<BackendServiceVpcNetworkScope>(vpcNetworkScope);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceCompressionMode, String>(compressionMode, (value) => value.value),
      ...
      'ipAddressSelectionPolicy': ?pulumi.Input.mapOptionalInputValue<BackendServiceIpAddressSelectionPolicy, String>(ipAddressSelectionPolicy, (value) => value.value),
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<BackendServiceLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.value),
      ...
      'localityLbPolicy': ?pulumi.Input.mapOptionalInputValue<BackendServiceLocalityLbPolicy, String>(localityLbPolicy, (value) => value.value),
      ...
      'portName': ?portName,
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<BackendServiceProtocol, String>(protocol, (value) => value.value),
      'requestId': ?requestId,
      ...
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<BackendServiceSessionAffinity, String>(sessionAffinity, (value) => value.value),
      ...
      'vpcNetworkScope': ?pulumi.Input.mapOptionalInputValue<BackendServiceVpcNetworkScope, String>(vpcNetworkScope, (value) => value.value),
    };
  }
  ...
  factory BackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceArgs(
      ...
      cdnPolicy: map['cdnPolicy'] == null ? null : BackendServiceCdnPolicy.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: map['circuitBreakers'] == null ? null : CircuitBreakers.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] == null ? null : BackendServiceCompressionMode.fromValue(map['compressionMode'] as String),
      connectionDraining: map['connectionDraining'] == null ? null : ConnectionDraining.fromMap((map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : BackendServiceConnectionTrackingPolicy.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: map['consistentHash'] == null ? null : ConsistentHashLoadBalancerSettings.fromMap((map['consistentHash'] as Map).cast<String, dynamic>()),
      ...
      failoverPolicy: map['failoverPolicy'] == null ? null : BackendServiceFailoverPolicy.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>()),
      healthChecks: map['healthChecks'] == null ? null : (map['healthChecks'] as List).cast<String>(),
      iap: map['iap'] == null ? null : BackendServiceIAP.fromMap((map['iap'] as Map).cast<String, dynamic>()),
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : BackendServiceIpAddressSelectionPolicy.fromValue(map['ipAddressSelectionPolicy'] as String),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : BackendServiceLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String),
      localityLbPolicies: map['localityLbPolicies'] == null ? null : pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfig>(map['localityLbPolicies'], (value) => BackendServiceLocalityLoadBalancingPolicyConfig.fromMap((value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] == null ? null : BackendServiceLocalityLbPolicy.fromValue(map['localityLbPolicy'] as String),
      logConfig: map['logConfig'] == null ? null : BackendServiceLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      maxStreamDuration: map['maxStreamDuration'] == null ? null : Duration.fromMap((map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      metadatas: map['metadatas'] == null ? null : (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      outlierDetection: map['outlierDetection'] == null ? null : OutlierDetection.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      portName: map['portName'] == null ? null : map['portName'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      protocol: map['protocol'] == null ? null : BackendServiceProtocol.fromValue(map['protocol'] as String),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : BackendServiceSessionAffinity.fromValue(map['sessionAffinity'] as String),
      subsetting: map['subsetting'] == null ? null : Subsetting.fromMap((map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] == null ? null : map['timeoutSec'] as int,
      usedBy: map['usedBy'] == null ? null : pulumi.Input.decodeList<BackendServiceUsedBy>(map['usedBy'], (value) => BackendServiceUsedBy.fromMap((value as Map).cast<String, dynamic>())),
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : BackendServiceVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String),
    );
  }
}
