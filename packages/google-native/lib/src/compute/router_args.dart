...
class RouterArgs {
  ...
  RouterArgs({
    ...
    String? requestId,
        ...
        interfaces =
            pulumi.Input.asOptionalInput<List<RouterInterface>>(interfaces),
  ...
  factory RouterArgs.fromMap(Map<String, dynamic> map) {
    return RouterArgs(
      ...
      bgpPeers: map['bgpPeers'] == null
          ? null
          : pulumi.Input.decodeList<RouterBgpPeer>(
              map['bgpPeers'],
              (value) => RouterBgpPeer.fromMap(
      ...
      interfaces: map['interfaces'] == null
          ? null
          : pulumi.Input.decodeList<RouterInterface>(
              map['interfaces'],
              (value) => RouterInterface.fromMap(
                  (value as Map).cast<String, dynamic>())),
      md5AuthenticationKeys: map['md5AuthenticationKeys'] == null
          ? null
          : pulumi.Input.decodeList<RouterMd5AuthenticationKey>(
              map['md5AuthenticationKeys'],
              (value) => RouterMd5AuthenticationKey.fromMap(
                  (value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      nats: map['nats'] == null
          ? null
          : pulumi.Input.decodeList<RouterNat>(
              map['nats'],
              (value) =>
                  RouterNat.fromMap((value as Map).cast<String, dynamic>())),
