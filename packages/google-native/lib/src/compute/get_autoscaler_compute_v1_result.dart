...
class GetAutoscalerComputeV1Result {
  ...
  /// Creates a new [GetAutoscalerComputeV1Result].
    ...
    return <String, dynamic>{
      ...
      'statusDetails':
          pulumi.Input.encodeList<
            AutoscalerStatusDetailsResponseComputeV1,
            Map<String, dynamic>
  ...
  factory GetAutoscalerComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetAutoscalerComputeV1Result(
      autoscalingPolicy: AutoscalingPolicyResponseComputeV1.fromMap(
      ...
      statusDetails:
          pulumi.Input.decodeList<AutoscalerStatusDetailsResponseComputeV1>(
            map['statusDetails'],
            (value) => AutoscalerStatusDetailsResponseComputeV1.fromMap(
