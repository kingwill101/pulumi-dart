...
class GetTargetTcpProxyComputeBetaResult {
  ...
  /// Creates a new [GetTargetTcpProxyComputeBetaResult].
  ...
  GetTargetTcpProxyComputeBetaResult({
  ...
  factory GetTargetTcpProxyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetTargetTcpProxyComputeBetaResult(
