...
class FirewallPolicyRuleMatcherResponseComputeV1 {
  ...
  final List<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1> layer4Configs;
  ...
  /// Creates a new [FirewallPolicyRuleMatcherResponseComputeV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1, Map<String, dynamic>>(layer4Configs, (value) => value.toMap()),
      'srcAddressGroups': srcAddressGroups,
      'srcFqdns': srcFqdns,
      'srcIpRanges': srcIpRanges,
      'srcRegionCodes': srcRegionCodes,
      'srcSecureTags': pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponseComputeV1, Map<String, dynamic>>(srcSecureTags, (value) => value.toMap()),
      'srcThreatIntelligences': srcThreatIntelligences,
    };
  }

  factory FirewallPolicyRuleMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherResponseComputeV1(
      ...
      destThreatIntelligences: (map['destThreatIntelligences'] as List).cast<String>(),
      layer4Configs: pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1>(map['layer4Configs'], (value) => FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeV1>(map['srcSecureTags'], (value) => FirewallPolicyRuleSecureTagResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      srcThreatIntelligences: (map['srcThreatIntelligences'] as List).cast<String>(),
    );
  }
}
