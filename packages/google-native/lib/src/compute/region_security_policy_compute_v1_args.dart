...
class RegionSecurityPolicyComputeV1Args {
  ...
  RegionSecurityPolicyComputeV1Args({
    SecurityPolicyAdaptiveProtectionConfigComputeV1? adaptiveProtectionConfig,
    SecurityPolicyAdvancedOptionsConfigComputeV1? advancedOptionsConfig,
    SecurityPolicyDdosProtectionConfigComputeV1? ddosProtectionConfig,
    String? description,
    Map<String, String>? labels,
    String? name,
    String? project,
    SecurityPolicyRecaptchaOptionsConfigComputeV1? recaptchaOptionsConfig,
    required String region,
    String? requestId,
    List<SecurityPolicyRuleComputeV1>? rules,
    RegionSecurityPolicyTypeComputeV1? type,
    List<SecurityPolicyUserDefinedFieldComputeV1>? userDefinedFields,
  }) :
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionSecurityPolicyTypeComputeV1, String>(type, (value) => value.value),
  ...
  factory RegionSecurityPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyComputeV1Args(
      adaptiveProtectionConfig: map['adaptiveProtectionConfig'] == null ? null : SecurityPolicyAdaptiveProtectionConfigComputeV1.fromMap((map['adaptiveProtectionConfig'] as Map).cast<String, dynamic>()),
      advancedOptionsConfig: map['advancedOptionsConfig'] == null ? null : SecurityPolicyAdvancedOptionsConfigComputeV1.fromMap((map['advancedOptionsConfig'] as Map).cast<String, dynamic>()),
      ddosProtectionConfig: map['ddosProtectionConfig'] == null ? null : SecurityPolicyDdosProtectionConfigComputeV1.fromMap((map['ddosProtectionConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      recaptchaOptionsConfig: map['recaptchaOptionsConfig'] == null ? null : SecurityPolicyRecaptchaOptionsConfigComputeV1.fromMap((map['recaptchaOptionsConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<SecurityPolicyRuleComputeV1>(map['rules'], (value) => SecurityPolicyRuleComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      type: map['type'] == null ? null : RegionSecurityPolicyTypeComputeV1.fromValue(map['type'] as String),
      userDefinedFields: map['userDefinedFields'] == null ? null : pulumi.Input.decodeList<SecurityPolicyUserDefinedFieldComputeV1>(map['userDefinedFields'], (value) => SecurityPolicyUserDefinedFieldComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
