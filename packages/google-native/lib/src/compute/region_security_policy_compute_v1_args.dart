    ...
    return <String, dynamic>{
      ...
      'ddosProtectionConfig':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyDdosProtectionConfigComputeV1,
            Map<String, dynamic>
          >(ddosProtectionConfig, (value) => value.toMap()),
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecurityPolicyRuleComputeV1>,
  ...
  factory RegionSecurityPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyComputeV1Args(
      ...
      recaptchaOptionsConfig: map['recaptchaOptionsConfig'] == null
          ? null
          : SecurityPolicyRecaptchaOptionsConfigComputeV1.fromMap(
      ...
      rules: map['rules'] == null
          ? null
          : pulumi.Input.decodeList<SecurityPolicyRuleComputeV1>(
              map['rules'],
              (value) => SecurityPolicyRuleComputeV1.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      type: map['type'] == null
          ? null
          : RegionSecurityPolicyTypeComputeV1.fromValue(map['type'] as String),
      userDefinedFields: map['userDefinedFields'] == null
          ? null
          : pulumi.Input.decodeList<SecurityPolicyUserDefinedFieldComputeV1>(
              map['userDefinedFields'],
              (value) => SecurityPolicyUserDefinedFieldComputeV1.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
    );
