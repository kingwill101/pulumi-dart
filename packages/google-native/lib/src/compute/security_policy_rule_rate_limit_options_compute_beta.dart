...
class SecurityPolicyRuleRateLimitOptionsComputeBeta {
  ...
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta>? enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRateLimitOptionsThresholdComputeBeta? rateLimitThreshold;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKeyConfigs': ?enforceOnKeyConfigs == null ? null : pulumi.Input.encodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta, Map<String, dynamic>>(enforceOnKeyConfigs!, (value) => value.toMap()),
  ...
  factory SecurityPolicyRuleRateLimitOptionsComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsComputeBeta(
      ...
      banThreshold: map['banThreshold'] == null ? null : SecurityPolicyRuleRateLimitOptionsThresholdComputeBeta.fromMap((map['banThreshold'] as Map).cast<String, dynamic>()),
      conformAction: map['conformAction'] == null ? null : map['conformAction'] as String,
      enforceOnKey: map['enforceOnKey'] == null ? null : SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeBeta.fromValue(map['enforceOnKey'] as String),
      enforceOnKeyConfigs: map['enforceOnKeyConfigs'] == null ? null : pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      exceedRedirectOptions: map['exceedRedirectOptions'] == null ? null : SecurityPolicyRuleRedirectOptionsComputeBeta.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>()),
      rateLimitThreshold: map['rateLimitThreshold'] == null ? null : SecurityPolicyRuleRateLimitOptionsThresholdComputeBeta.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>()),
    );
  }
}
