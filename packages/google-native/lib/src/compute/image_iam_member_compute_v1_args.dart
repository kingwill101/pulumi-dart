...
/// {@template pulumi_compute_v1_image_iam_member_compute_v1_args_doc}
/// The set of arguments for ImageIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_image_iam_member_compute_v1_args_doc}
class ImageIamMemberComputeV1Args {
  ...
  /// Creates a new [ImageIamMemberComputeV1Args].
  ...
  factory ImageIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ImageIamMemberComputeV1Args(
