...
class RegionNetworkFirewallPolicyArgs {
  ...
  RegionNetworkFirewallPolicyArgs({
    ...
    String? shortName,
    RegionNetworkFirewallPolicyVpcNetworkScope? vpcNetworkScope,
  }) :
  ...
  factory RegionNetworkFirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyArgs(
      ...
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : RegionNetworkFirewallPolicyVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String),
    );
  }
}
