...
class GlobalAddressComputeV1Args {
  ...
  GlobalAddressComputeV1Args({
    ...
    String? subnetwork,
       ...
       addressType =
           pulumi.Input.asOptionalInput<GlobalAddressAddressTypeComputeV1>(
             addressType,
           ),
       description = pulumi.Input.asOptionalInput<String>(description),
       ipVersion = pulumi
           .Input.asOptionalInput<GlobalAddressIpVersionComputeV1>(ipVersion),
       ipv6EndpointType =
           pulumi.Input.asOptionalInput<GlobalAddressIpv6EndpointTypeComputeV1>(
             ipv6EndpointType,
           ),
       ...
       networkTier =
           pulumi.Input.asOptionalInput<GlobalAddressNetworkTierComputeV1>(
             networkTier,
           ),
       prefixLength = pulumi.Input.asOptionalInput<int>(prefixLength),
       project = pulumi.Input.asOptionalInput<String>(project),
       purpose = pulumi.Input.asOptionalInput<GlobalAddressPurposeComputeV1>(
         purpose,
       ),
    ...
    return <String, dynamic>{
      ...
      'addressType':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressAddressTypeComputeV1,
            String
          >(addressType, (value) => value.value),
      'description': ?description,
      'ipVersion':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressIpVersionComputeV1,
            String
          >(ipVersion, (value) => value.value),
      'ipv6EndpointType':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressIpv6EndpointTypeComputeV1,
            String
      ...
      'networkTier':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressNetworkTierComputeV1,
            String
  ...
  factory GlobalAddressComputeV1Args.fromMap(Map<String, dynamic> map) {
    return GlobalAddressComputeV1Args(
      ...
      addressType: map['addressType'] == null
          ? null
          : GlobalAddressAddressTypeComputeV1.fromValue(
      ...
      ipVersion: map['ipVersion'] == null
          ? null
          : GlobalAddressIpVersionComputeV1.fromValue(
              map['ipVersion'] as String,
            ),
      ipv6EndpointType: map['ipv6EndpointType'] == null
          ? null
          : GlobalAddressIpv6EndpointTypeComputeV1.fromValue(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : GlobalAddressNetworkTierComputeV1.fromValue(
      ...
      purpose: map['purpose'] == null
          ? null
          : GlobalAddressPurposeComputeV1.fromValue(map['purpose'] as String),
