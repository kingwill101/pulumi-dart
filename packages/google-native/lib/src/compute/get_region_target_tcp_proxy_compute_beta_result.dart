...
/// Result data returned by getRegionTargetTcpProxy.
class GetRegionTargetTcpProxyComputeBetaResult {
  ...
  /// Creates a new [GetRegionTargetTcpProxyComputeBetaResult].
  ...
  GetRegionTargetTcpProxyComputeBetaResult({
  ...
  factory GetRegionTargetTcpProxyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetTcpProxyComputeBetaResult(
