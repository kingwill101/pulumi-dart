...
class InterconnectComputeBetaArgs {
  ...
  factory InterconnectComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeBetaArgs(
      ...
      interconnectType: map['interconnectType'] == null ? null : InterconnectInterconnectTypeComputeBeta.fromValue(map['interconnectType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linkType: map['linkType'] == null ? null : InterconnectLinkTypeComputeBeta.fromValue(map['linkType'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      macsec: map['macsec'] == null ? null : InterconnectMacsecComputeBeta.fromMap((map['macsec'] as Map).cast<String, dynamic>()),
      ...
      requestedFeatures: map['requestedFeatures'] == null ? null : pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeBeta>(map['requestedFeatures'], (value) => InterconnectRequestedFeaturesItemComputeBeta.fromValue(value as String)),
