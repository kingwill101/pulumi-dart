...
class InterconnectComputeBetaArgs {
  ...
  InterconnectComputeBetaArgs({
    ...
    int? requestedLinkCount,
        ...
        interconnectType = pulumi.Input.asOptionalInput<
            InterconnectInterconnectTypeComputeBeta>(interconnectType),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        linkType =
            pulumi.Input.asOptionalInput<InterconnectLinkTypeComputeBeta>(
                linkType),
        location = pulumi.Input.asOptionalInput<String>(location),
        macsec =
            pulumi.Input.asOptionalInput<InterconnectMacsecComputeBeta>(macsec),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (requestedFeaturesValue != null) {
      map['requestedFeatures'] = pulumi.Input.mapOptionalInputValue<
              List<InterconnectRequestedFeaturesItemComputeBeta>, List<String>>(
