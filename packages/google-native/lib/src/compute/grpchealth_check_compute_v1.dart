...
import 'grpchealth_check_port_specification_compute_v1.dart';

class GRPCHealthCheckComputeV1 {
  ...
  final GRPCHealthCheckPortSpecificationComputeV1? portSpecification;

  /// Creates a new [GRPCHealthCheckComputeV1].
  ...
  factory GRPCHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheckComputeV1(
      ...
      portSpecification: map['portSpecification'] == null
          ? null
          : GRPCHealthCheckPortSpecificationComputeV1.fromValue(
