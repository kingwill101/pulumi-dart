...
class RouteArgs {
  ...
  final pulumi.Input<RouteIlbRouteBehaviorOnUnhealthy>?
  ...
  RouteArgs({
    ...
    List<String>? tags,
            ...
            pulumi.Input.asOptionalInput<bool>(allowConflictingSubnetworks),
        description = pulumi.Input.asOptionalInput<String>(description),
        destRange = pulumi.Input.asOptionalInput<String>(destRange),
        ilbRouteBehaviorOnUnhealthy =
            pulumi.Input.asOptionalInput<RouteIlbRouteBehaviorOnUnhealthy>(
                ilbRouteBehaviorOnUnhealthy),
        ...
        nextHopVpnTunnel =
            pulumi.Input.asOptionalInput<String>(nextHopVpnTunnel),
  ...
  Map<String, dynamic> toMap() {
    ...
    final allowConflictingSubnetworksValue = allowConflictingSubnetworks;
    if (allowConflictingSubnetworksValue != null) {
      map['allowConflictingSubnetworks'] = allowConflictingSubnetworksValue;
    }
    ...
    final ilbRouteBehaviorOnUnhealthyValue = ilbRouteBehaviorOnUnhealthy;
    if (ilbRouteBehaviorOnUnhealthyValue != null) {
      map['ilbRouteBehaviorOnUnhealthy'] = pulumi.Input.mapOptionalInputValue<
          RouteIlbRouteBehaviorOnUnhealthy,
          String>(ilbRouteBehaviorOnUnhealthyValue, (value) => value.value);
    }
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      allowConflictingSubnetworks: map['allowConflictingSubnetworks'] == null
          ? null
          : map['allowConflictingSubnetworks'] as bool,
      description:
          map['description'] == null ? null : map['description'] as String,
      destRange: map['destRange'] == null ? null : map['destRange'] as String,
      ilbRouteBehaviorOnUnhealthy: map['ilbRouteBehaviorOnUnhealthy'] == null
          ? null
          : RouteIlbRouteBehaviorOnUnhealthy.fromValue(
              map['ilbRouteBehaviorOnUnhealthy'] as String),
      ...
      nextHopIlb:
          map['nextHopIlb'] == null ? null : map['nextHopIlb'] as String,
      ...
      nextHopNetwork: map['nextHopNetwork'] == null
          ? null
          : map['nextHopNetwork'] as String,
