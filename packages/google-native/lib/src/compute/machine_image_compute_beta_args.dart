...
class MachineImageComputeBetaArgs {
  ...
  MachineImageComputeBetaArgs({
    String? description,
    bool? guestFlush,
    CustomerEncryptionKeyComputeBeta? machineImageEncryptionKey,
    String? name,
    String? project,
    String? requestId,
    List<SavedDiskComputeBeta>? savedDisks,
    List<SourceDiskEncryptionKeyComputeBeta>? sourceDiskEncryptionKeys,
  ...
  factory MachineImageComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageComputeBetaArgs(
      ...
      machineImageEncryptionKey: map['machineImageEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeBeta.fromMap((map['machineImageEncryptionKey'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      savedDisks: map['savedDisks'] == null ? null : pulumi.Input.decodeList<SavedDiskComputeBeta>(map['savedDisks'], (value) => SavedDiskComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      sourceDiskEncryptionKeys: map['sourceDiskEncryptionKeys'] == null ? null : pulumi.Input.decodeList<SourceDiskEncryptionKeyComputeBeta>(map['sourceDiskEncryptionKeys'], (value) => SourceDiskEncryptionKeyComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
