...
class HttpHeaderOptionComputeBeta {
  ...
  /// Creates a new [HttpHeaderOptionComputeBeta].
  ...
  factory HttpHeaderOptionComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpHeaderOptionComputeBeta(
