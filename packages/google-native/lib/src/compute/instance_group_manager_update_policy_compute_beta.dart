...
class InstanceGroupManagerUpdatePolicyComputeBeta {
  ...
  final InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeBeta? instanceRedistributionType;
  ...
  final InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeBeta? mostDisruptiveAllowedAction;
  /// What action should be used to replace instances. See minimal_action.REPLACE
  final InstanceGroupManagerUpdatePolicyReplacementMethodComputeBeta? replacementMethod;
  ...
  factory InstanceGroupManagerUpdatePolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyComputeBeta(
      instanceRedistributionType: map['instanceRedistributionType'] == null ? null : InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeBeta.fromValue(map['instanceRedistributionType'] as String),
      maxSurge: map['maxSurge'] == null ? null : FixedOrPercentComputeBeta.fromMap((map['maxSurge'] as Map).cast<String, dynamic>()),
      maxUnavailable: map['maxUnavailable'] == null ? null : FixedOrPercentComputeBeta.fromMap((map['maxUnavailable'] as Map).cast<String, dynamic>()),
      minReadySec: map['minReadySec'] == null ? null : map['minReadySec'] as int,
      minimalAction: map['minimalAction'] == null ? null : InstanceGroupManagerUpdatePolicyMinimalActionComputeBeta.fromValue(map['minimalAction'] as String),
      mostDisruptiveAllowedAction: map['mostDisruptiveAllowedAction'] == null ? null : InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeBeta.fromValue(map['mostDisruptiveAllowedAction'] as String),
      replacementMethod: map['replacementMethod'] == null ? null : InstanceGroupManagerUpdatePolicyReplacementMethodComputeBeta.fromValue(map['replacementMethod'] as String),
      type: map['type'] == null ? null : InstanceGroupManagerUpdatePolicyTypeComputeBeta.fromValue(map['type'] as String),
    );
  }
}
