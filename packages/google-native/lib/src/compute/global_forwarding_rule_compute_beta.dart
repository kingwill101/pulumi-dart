...
import 'global_forwarding_rule_compute_beta_args.dart';
import 'metadata_filter_response_compute_beta.dart';

/// Creates a GlobalForwardingRule resource in the specified project using the data included in the request.
class GlobalForwardingRuleComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<bool> allowPscPacketInjection;
  ...
  late final pulumi.Output<List<MetadataFilterResponseComputeBeta>> metadataFilters;
  ...
  late final pulumi.Output<List<ForwardingRuleServiceDirectoryRegistrationResponseComputeBeta>> serviceDirectoryRegistrations;
  ...
  /// Creates a new [GlobalForwardingRuleComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GlobalForwardingRuleComputeBeta]. {@macro pulumi_compute_beta_global_forwarding_rule_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GlobalForwardingRuleComputeBeta(
    String name, {
    GlobalForwardingRuleComputeBetaArgs? args,
    ...
    this.allowPscPacketInjection = registerOutput<bool>('allowPscPacketInjection');
    ...
    this.metadataFilters = registerOutput<List<MetadataFilterResponseComputeBeta>>('metadataFilters');
    ...
    this.serviceDirectoryRegistrations = registerOutput<List<ForwardingRuleServiceDirectoryRegistrationResponseComputeBeta>>('serviceDirectoryRegistrations');
