...
class GlobalForwardingRuleComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MetadataFilterResponseComputeBeta>>
  metadataFilters;
  ...
  late final pulumi.Output<
    List<ForwardingRuleServiceDirectoryRegistrationResponseComputeBeta>
  >
  ...
  GlobalForwardingRuleComputeBeta(
    ...
    this.allowPscPacketInjection = registerOutput<bool>(
    ...
    this.metadataFilters =
        registerOutput<List<MetadataFilterResponseComputeBeta>>(
          'metadataFilters',
        );
