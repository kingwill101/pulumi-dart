...
import 'vpn_tunnel_compute_beta_args.dart';

/// Creates a VpnTunnel resource in the specified project and region using the data included in the request.
class VpnTunnelComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [VpnTunnelComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VpnTunnelComputeBeta]. {@macro pulumi_compute_beta_vpn_tunnel_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  VpnTunnelComputeBeta(
    String name, {
    VpnTunnelComputeBetaArgs? args,
    ...
    this.localTrafficSelector = registerOutput<List<String>>('localTrafficSelector');
    ...
    this.remoteTrafficSelector = registerOutput<List<String>>('remoteTrafficSelector');
