...
class AutoscalingPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetricUtilizations': ?customMetricUtilizations == null
          ? null
  ...
  factory AutoscalingPolicy.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicy(
      ...
      maxNumReplicas: map['maxNumReplicas'] == null
          ? null
          : map['maxNumReplicas'] as int,
      minNumReplicas: map['minNumReplicas'] == null
          ? null
          : map['minNumReplicas'] as int,
      mode: map['mode'] == null
          ? null
