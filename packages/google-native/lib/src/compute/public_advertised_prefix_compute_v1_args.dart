...
class PublicAdvertisedPrefixComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pdpScope': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixPdpScopeComputeV1, String>(pdpScope, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
      'status': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixStatusComputeV1, String>(status, (value) => value.value),
    };
  }
  ...
  factory PublicAdvertisedPrefixComputeV1Args.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixComputeV1Args(
      ...
      pdpScope: map['pdpScope'] == null ? null : PublicAdvertisedPrefixPdpScopeComputeV1.fromValue(map['pdpScope'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      status: map['status'] == null ? null : PublicAdvertisedPrefixStatusComputeV1.fromValue(map['status'] as String),
    );
  }
}
