...
class GetRouterComputeBetaResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bgp'] = bgp.toMap();
    map['bgpPeers'] = pulumi.Input.encodeList<RouterBgpPeerResponseComputeBeta,
    ...
    map['name'] = name;
    map['nats'] = pulumi.Input.encodeList<RouterNatResponseComputeBeta,
  ...
  factory GetRouterComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRouterComputeBetaResult(
      ...
      md5AuthenticationKeys: pulumi.Input.decodeList<
              RouterMd5AuthenticationKeyResponseComputeBeta>(
