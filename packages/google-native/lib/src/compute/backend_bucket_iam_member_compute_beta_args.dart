...
/// {@template pulumi_compute_beta_backend_bucket_iam_member_compute_beta_args_doc}
/// The set of arguments for BackendBucketIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_backend_bucket_iam_member_compute_beta_args_doc}
class BackendBucketIamMemberComputeBetaArgs {
  ...
  /// Creates a new [BackendBucketIamMemberComputeBetaArgs].
  ...
  BackendBucketIamMemberComputeBetaArgs({
    Condition? condition,
  ...
  factory BackendBucketIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamMemberComputeBetaArgs(
