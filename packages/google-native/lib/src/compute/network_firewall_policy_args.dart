...
class NetworkFirewallPolicyArgs {
  ...
  NetworkFirewallPolicyArgs({
    ...
    String? shortName,
    NetworkFirewallPolicyVpcNetworkScope? vpcNetworkScope,
  }) :
      ...
      vpcNetworkScope = pulumi.Input.asOptionalInput<NetworkFirewallPolicyVpcNetworkScope>(vpcNetworkScope);
  ...
  factory NetworkFirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyArgs(
      associations: map['associations'] == null ? null : pulumi.Input.decodeList<FirewallPolicyAssociation>(map['associations'], (value) => FirewallPolicyAssociation.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRule>(map['rules'], (value) => FirewallPolicyRule.fromMap((value as Map).cast<String, dynamic>())),
      shortName: map['shortName'] == null ? null : map['shortName'] as String,
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : NetworkFirewallPolicyVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String),
    );
  }
}
