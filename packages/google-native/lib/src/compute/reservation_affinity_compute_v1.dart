...
class ReservationAffinityComputeV1 {
  ...
  final ReservationAffinityConsumeReservationTypeComputeV1? consumeReservationType;
  ...
  factory ReservationAffinityComputeV1.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityComputeV1(
      consumeReservationType: map['consumeReservationType'] == null ? null : ReservationAffinityConsumeReservationTypeComputeV1.fromValue(map['consumeReservationType'] as String),
