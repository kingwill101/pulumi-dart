  ...
  NodeTemplateComputeV1Args({
    ...
    ServerBindingComputeV1? serverBinding,
            ...
            pulumi.Input.asOptionalInput<List<AcceleratorConfigComputeV1>>(
                accelerators),
        cpuOvercommitType = pulumi.Input.asOptionalInput<
            NodeTemplateCpuOvercommitTypeComputeV1>(cpuOvercommitType),
        ...
        serverBinding =
            pulumi.Input.asOptionalInput<ServerBindingComputeV1>(serverBinding);
  ...
  factory NodeTemplateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeTemplateComputeV1Args(
      ...
      cpuOvercommitType: map['cpuOvercommitType'] == null
          ? null
          : NodeTemplateCpuOvercommitTypeComputeV1.fromValue(
              map['cpuOvercommitType'] as String),
      description:
          map['description'] == null ? null : map['description'] as String,
      disks: map['disks'] == null
          ? null
          : pulumi.Input.decodeList<LocalDiskComputeV1>(
              map['disks'],
              (value) => LocalDiskComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      nodeTypeFlexibility: map['nodeTypeFlexibility'] == null
          ? null
          : NodeTemplateNodeTypeFlexibilityComputeV1.fromMap(
      ...
      serverBinding: map['serverBinding'] == null
          ? null
          : ServerBindingComputeV1.fromMap(
