...
class NodeTemplateComputeV1Args {
  ...
  NodeTemplateComputeV1Args({
    List<AcceleratorConfigComputeV1>? accelerators,
    NodeTemplateCpuOvercommitTypeComputeV1? cpuOvercommitType,
    String? description,
    List<LocalDiskComputeV1>? disks,
    String? name,
    Map<String, String>? nodeAffinityLabels,
    String? nodeType,
    NodeTemplateNodeTypeFlexibilityComputeV1? nodeTypeFlexibility,
    String? project,
    required String region,
    String? requestId,
    ServerBindingComputeV1? serverBinding,
  }) :
      accelerators = pulumi.Input.asOptionalInput<List<AcceleratorConfigComputeV1>>(accelerators),
      cpuOvercommitType = pulumi.Input.asOptionalInput<NodeTemplateCpuOvercommitTypeComputeV1>(cpuOvercommitType),
      description = pulumi.Input.asOptionalInput<String>(description),
      disks = pulumi.Input.asOptionalInput<List<LocalDiskComputeV1>>(disks),
      ...
      nodeTypeFlexibility = pulumi.Input.asOptionalInput<NodeTemplateNodeTypeFlexibilityComputeV1>(nodeTypeFlexibility),
      project = pulumi.Input.asOptionalInput<String>(project),
      region = pulumi.Input.asInput<String>(region),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      serverBinding = pulumi.Input.asOptionalInput<ServerBindingComputeV1>(serverBinding);
  ...
  factory NodeTemplateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeTemplateComputeV1Args(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<AcceleratorConfigComputeV1>(map['accelerators'], (value) => AcceleratorConfigComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      cpuOvercommitType: map['cpuOvercommitType'] == null ? null : NodeTemplateCpuOvercommitTypeComputeV1.fromValue(map['cpuOvercommitType'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      disks: map['disks'] == null ? null : pulumi.Input.decodeList<LocalDiskComputeV1>(map['disks'], (value) => LocalDiskComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      nodeAffinityLabels: map['nodeAffinityLabels'] == null ? null : (map['nodeAffinityLabels'] as Map).cast<String, String>(),
      nodeType: map['nodeType'] == null ? null : map['nodeType'] as String,
      nodeTypeFlexibility: map['nodeTypeFlexibility'] == null ? null : NodeTemplateNodeTypeFlexibilityComputeV1.fromMap((map['nodeTypeFlexibility'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      serverBinding: map['serverBinding'] == null ? null : ServerBindingComputeV1.fromMap((map['serverBinding'] as Map).cast<String, dynamic>()),
    );
  }
}
