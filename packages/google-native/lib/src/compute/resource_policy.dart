...
class ResourcePolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ResourcePolicyGroupPlacementPolicyResponse>
  groupPlacementPolicy;

  /// Resource policy for scheduling instance operations.
  late final pulumi.Output<ResourcePolicyInstanceSchedulePolicyResponse>
  ...
  late final pulumi.Output<ResourcePolicySnapshotSchedulePolicyResponse>
  ...
  late final pulumi.Output<ResourcePolicyVmMaintenancePolicyResponse>
  vmMaintenancePolicy;
  ...
  ResourcePolicy(
    ...
    this.diskConsistencyGroupPolicy = registerOutput<Map<String, dynamic>>(
    ...
    this.resourceStatus = registerOutput<ResourcePolicyResourceStatusResponse>(
      'resourceStatus',
    );
