...
class NetworkEndpointGroupComputeV1Args {
  ...
  final pulumi.Input<NetworkEndpointGroupNetworkEndpointTypeComputeV1>?
  networkEndpointType;
  ...
  NetworkEndpointGroupComputeV1Args({
    ...
    String? zone,
       ...
       networkEndpointType =
           pulumi.Input.asOptionalInput<
             NetworkEndpointGroupNetworkEndpointTypeComputeV1
           >(networkEndpointType),
  ...
  factory NetworkEndpointGroupComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupComputeV1Args(
      ...
      networkEndpointType: map['networkEndpointType'] == null
          ? null
          : NetworkEndpointGroupNetworkEndpointTypeComputeV1.fromValue(
