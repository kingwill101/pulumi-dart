...
class DeprecationStatusResponse {
  ...
  final RolloutPolicyResponse stateOverride;

  /// Creates a new [DeprecationStatusResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': state,
      'stateOverride': stateOverride.toMap(),
    };
  }

  factory DeprecationStatusResponse.fromMap(Map<String, dynamic> map) {
    return DeprecationStatusResponse(
      ...
      stateOverride: RolloutPolicyResponse.fromMap((map['stateOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
