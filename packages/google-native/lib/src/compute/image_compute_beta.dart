...
import 'image_compute_beta_args.dart';
...
class ImageComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DeprecationStatusResponseComputeBeta> deprecated;
  ...
  late final pulumi.Output<CustomerEncryptionKeyResponseComputeBeta> imageEncryptionKey;
  ...
  late final pulumi.Output<ImageRawDiskResponseComputeBeta> rawDisk;
  ...
  late final pulumi.Output<RolloutPolicyResponseComputeBeta> rolloutOverride;
  /// Reserved for future use.
  late final pulumi.Output<bool> satisfiesPzs;
  /// Server-defined URL for the resource.
  late final pulumi.Output<String> selfLink;
  /// Set the secure boot keys of shielded instance.
  late final pulumi.Output<InitialStateConfigResponseComputeBeta> shieldedInstanceInitialState;
  ...
  late final pulumi.Output<CustomerEncryptionKeyResponseComputeBeta> sourceImageEncryptionKey;
  ...
  late final pulumi.Output<CustomerEncryptionKeyResponseComputeBeta> sourceSnapshotEncryptionKey;
  ...
  /// Creates a new [ImageComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ImageComputeBeta]. {@macro pulumi_compute_beta_image_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ImageComputeBeta(
    String name, {
    ImageComputeBetaArgs? args,
    ...
    this.deprecated = registerOutput<DeprecationStatusResponseComputeBeta>('deprecated');
    ...
    this.imageEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('imageEncryptionKey');
    ...
    this.rawDisk = registerOutput<ImageRawDiskResponseComputeBeta>('rawDisk');
    this.requestId = registerOutput<String?>('requestId');
    this.rolloutOverride = registerOutput<RolloutPolicyResponseComputeBeta>('rolloutOverride');
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.selfLink = registerOutput<String>('selfLink');
    this.shieldedInstanceInitialState = registerOutput<InitialStateConfigResponseComputeBeta>('shieldedInstanceInitialState');
    ...
    this.sourceImageEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('sourceImageEncryptionKey');
    this.sourceImageId = registerOutput<String>('sourceImageId');
    this.sourceSnapshot = registerOutput<String>('sourceSnapshot');
    this.sourceSnapshotEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('sourceSnapshotEncryptionKey');
