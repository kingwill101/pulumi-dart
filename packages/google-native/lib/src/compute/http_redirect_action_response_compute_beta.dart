...
class HttpRedirectActionResponseComputeBeta {
  ...
  /// Creates a new [HttpRedirectActionResponseComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['prefixRedirect'] = prefixRedirect;
    map['redirectResponseCode'] = redirectResponseCode;
    map['stripQuery'] = stripQuery;
    return map;
  }

  factory HttpRedirectActionResponseComputeBeta.fromMap(
      Map<String, dynamic> map) {
    return HttpRedirectActionResponseComputeBeta(
