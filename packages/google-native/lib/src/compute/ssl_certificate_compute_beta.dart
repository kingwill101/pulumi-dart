...
class SslCertificateComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<SslCertificateManagedSslCertificateResponseComputeBeta> managed;
  ...
  late final pulumi
      .Output<SslCertificateSelfManagedSslCertificateResponseComputeBeta>
      selfManaged;
  ...
  SslCertificateComputeBeta(
    ...
    this.managed =
        registerOutput<SslCertificateManagedSslCertificateResponseComputeBeta>(
            'managed');
    ...
    this.selfManaged = registerOutput<
