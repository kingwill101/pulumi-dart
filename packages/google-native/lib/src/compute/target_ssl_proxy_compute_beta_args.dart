...
/// {@template pulumi_compute_beta_target_ssl_proxy_compute_beta_args_doc}
/// The set of arguments for TargetSslProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_target_ssl_proxy_compute_beta_args_doc}
class TargetSslProxyComputeBetaArgs {
  ...
  /// Creates a new [TargetSslProxyComputeBetaArgs].
  ...
  TargetSslProxyComputeBetaArgs({
    ...
    String? name,
    String? project,
    TargetSslProxyProxyHeaderComputeBeta? proxyHeader,
    String? requestId,
    String? service,
    ...
    String? sslPolicy,
      ...
      proxyHeader = pulumi.Input.asOptionalInput<TargetSslProxyProxyHeaderComputeBeta>(proxyHeader),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetSslProxyProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.value),
      'requestId': ?requestId,
      'service': ?service,
  ...
  factory TargetSslProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyComputeBetaArgs(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : TargetSslProxyProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String),
