...
class MetadataFilterComputeV1 {
  ...
  final List<MetadataFilterLabelMatchComputeV1>? filterLabels;
  /// Specifies how individual filter label matches within the list of filterLabels and contributes toward the overall metadataFilter match. Supported values are: - MATCH_ANY: at least one of the filterLabels must have a matching label in the provided metadata. - MATCH_ALL: all filterLabels must have matching labels in the provided metadata.
  final MetadataFilterFilterMatchCriteriaComputeV1? filterMatchCriteria;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filterLabels': ?filterLabels == null ? null : pulumi.Input.encodeList<MetadataFilterLabelMatchComputeV1, Map<String, dynamic>>(filterLabels!, (value) => value.toMap()),
  ...
  factory MetadataFilterComputeV1.fromMap(Map<String, dynamic> map) {
    return MetadataFilterComputeV1(
      filterLabels: map['filterLabels'] == null ? null : pulumi.Input.decodeList<MetadataFilterLabelMatchComputeV1>(map['filterLabels'], (value) => MetadataFilterLabelMatchComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      filterMatchCriteria: map['filterMatchCriteria'] == null ? null : MetadataFilterFilterMatchCriteriaComputeV1.fromValue(map['filterMatchCriteria'] as String),
    );
  }
}
