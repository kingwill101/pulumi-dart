...
class ForwardingRuleComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MetadataFilterResponseComputeV1>>
      metadataFilters;
  ...
  late final pulumi
      .Output<List<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1>>
  ...
  ForwardingRuleComputeV1(
    ...
    this.metadataFilters =
        registerOutput<List<MetadataFilterResponseComputeV1>>(
            'metadataFilters');
    ...
    this.serviceDirectoryRegistrations = registerOutput<
            List<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1>>(
        'serviceDirectoryRegistrations');
