...
import 'forwarding_rule_compute_v1_args.dart';
...
class ForwardingRuleComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MetadataFilterResponseComputeV1>> metadataFilters;
  ...
  late final pulumi.Output<List<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1>> serviceDirectoryRegistrations;
  ...
  /// Creates a new [ForwardingRuleComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ForwardingRuleComputeV1]. {@macro pulumi_compute_v1_forwarding_rule_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ForwardingRuleComputeV1(
    String name, {
    ForwardingRuleComputeV1Args? args,
    ...
    this.metadataFilters = registerOutput<List<MetadataFilterResponseComputeV1>>('metadataFilters');
    ...
    this.serviceDirectoryRegistrations = registerOutput<List<ForwardingRuleServiceDirectoryRegistrationResponseComputeV1>>('serviceDirectoryRegistrations');
