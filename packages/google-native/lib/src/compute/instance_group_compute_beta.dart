...
import 'instance_group_compute_beta_args.dart';
import 'named_port_response_compute_beta.dart';

/// Creates an instance group in the specified project using the parameters that are included in the request.
class InstanceGroupComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [InstanceGroupComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceGroupComputeBeta]. {@macro pulumi_compute_beta_instance_group_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceGroupComputeBeta(
    String name, {
    InstanceGroupComputeBetaArgs? args,
    ...
    this.namedPorts = registerOutput<List<NamedPortResponseComputeBeta>>('namedPorts');
