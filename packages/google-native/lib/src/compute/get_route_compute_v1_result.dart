...
import 'route_as_path_response_compute_v1.dart';
import 'route_warnings_item_response_compute_v1.dart';

/// Result data returned by getRoute.
class GetRouteComputeV1Result {
  /// AS path.
  final List<RouteAsPathResponseComputeV1> asPaths;
  ...
  final List<RouteWarningsItemResponseComputeV1> warnings;

  /// Creates a new [GetRouteComputeV1Result].
  /// [asPaths] AS path.
  ...
  /// [kind] Type of this resource. Always compute#routes for Route resources.
  ...
  /// [nextHopHub] The full resource name of the Network Connectivity Center hub that will handle matching packets.
  ...
  /// [routeType] The type of this route, which can be one of the following values: - 'TRANSIT' for a transit route that this router learned from another Cloud Router and will readvertise to one of its BGP peers - 'SUBNET' for a route from a subnet of the VPC - 'BGP' for a route learned from a BGP peer of this router - 'STATIC' for a static route
  ...
  Map<String, dynamic> toMap() {
    ...
    map['asPaths'] = pulumi.Input.encodeList<RouteAsPathResponseComputeV1,
  ...
  factory GetRouteComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRouteComputeV1Result(
      asPaths: pulumi.Input.decodeList<RouteAsPathResponseComputeV1>(
          map['asPaths'],
          (value) => RouteAsPathResponseComputeV1.fromMap(
      ...
      warnings: pulumi.Input.decodeList<RouteWarningsItemResponseComputeV1>(
          map['warnings'],
          (value) => RouteWarningsItemResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
