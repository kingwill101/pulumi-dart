...
class UrlMapTestResponseComputeV1 {
  ...
  /// Creates a new [UrlMapTestResponseComputeV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': pulumi.Input.encodeList<UrlMapTestHeaderResponseComputeV1, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'host': host,
      'path': path,
      'service': service,
    };
  ...
  factory UrlMapTestResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return UrlMapTestResponseComputeV1(
      ...
      headers: pulumi.Input.decodeList<UrlMapTestHeaderResponseComputeV1>(map['headers'], (value) => UrlMapTestHeaderResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
