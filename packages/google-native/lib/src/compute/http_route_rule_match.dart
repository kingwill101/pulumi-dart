...
class HttpRouteRuleMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': ?headerMatches == null ? null : pulumi.Input.encodeList<HttpHeaderMatch, Map<String, dynamic>>(headerMatches!, (value) => value.toMap()),
      'ignoreCase': ?ignoreCase,
      'metadataFilters': ?metadataFilters == null ? null : pulumi.Input.encodeList<MetadataFilter, Map<String, dynamic>>(metadataFilters!, (value) => value.toMap()),
      'pathTemplateMatch': ?pathTemplateMatch,
      'prefixMatch': ?prefixMatch,
      'queryParameterMatches': ?queryParameterMatches == null ? null : pulumi.Input.encodeList<HttpQueryParameterMatch, Map<String, dynamic>>(queryParameterMatches!, (value) => value.toMap()),
  ...
  factory HttpRouteRuleMatch.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatch(
      ...
      headerMatches: map['headerMatches'] == null ? null : pulumi.Input.decodeList<HttpHeaderMatch>(map['headerMatches'], (value) => HttpHeaderMatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      queryParameterMatches: map['queryParameterMatches'] == null ? null : pulumi.Input.decodeList<HttpQueryParameterMatch>(map['queryParameterMatches'], (value) => HttpQueryParameterMatch.fromMap((value as Map).cast<String, dynamic>())),
