...
class SubnetworkComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SubnetworkSecondaryRangeResponseComputeV1>>
  secondaryIpRanges;
  ...
  SubnetworkComputeV1(
    ...
    this.logConfig = registerOutput<SubnetworkLogConfigResponseComputeV1>(
      'logConfig',
    );
    ...
    this.secondaryIpRanges =
        registerOutput<List<SubnetworkSecondaryRangeResponseComputeV1>>(
          'secondaryIpRanges',
        );
