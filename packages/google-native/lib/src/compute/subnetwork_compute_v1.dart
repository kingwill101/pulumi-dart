...
import 'subnetwork_compute_v1_args.dart';
...
class SubnetworkComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SubnetworkLogConfigResponseComputeV1> logConfig;
  ...
  late final pulumi.Output<List<SubnetworkSecondaryRangeResponseComputeV1>> secondaryIpRanges;
  ...
  /// Creates a new [SubnetworkComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SubnetworkComputeV1]. {@macro pulumi_compute_v1_subnetwork_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SubnetworkComputeV1(
    String name, {
    SubnetworkComputeV1Args? args,
    ...
    this.logConfig = registerOutput<SubnetworkLogConfigResponseComputeV1>('logConfig');
    ...
    this.secondaryIpRanges = registerOutput<List<SubnetworkSecondaryRangeResponseComputeV1>>('secondaryIpRanges');
