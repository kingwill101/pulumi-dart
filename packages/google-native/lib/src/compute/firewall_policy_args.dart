...
class FirewallPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'shortName': ?shortName,
      'vpcNetworkScope': ?pulumi.Input.mapOptionalInputValue<FirewallPolicyVpcNetworkScope, String>(vpcNetworkScope, (value) => value.value),
    };
  }
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      ...
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : FirewallPolicyVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String),
    );
  }
}
