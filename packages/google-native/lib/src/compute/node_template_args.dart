...
class NodeTemplateArgs {
  ...
  NodeTemplateArgs({
    ...
    NodeTemplateCpuOvercommitType? cpuOvercommitType,
    String? description,
  ...
  factory NodeTemplateArgs.fromMap(Map<String, dynamic> map) {
    return NodeTemplateArgs(
      ...
      cpuOvercommitType: map['cpuOvercommitType'] == null ? null : NodeTemplateCpuOvercommitType.fromValue(map['cpuOvercommitType'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      disks: map['disks'] == null ? null : pulumi.Input.decodeList<LocalDisk>(map['disks'], (value) => LocalDisk.fromMap((value as Map).cast<String, dynamic>())),
      ...
      serverBinding: map['serverBinding'] == null ? null : ServerBinding.fromMap((map['serverBinding'] as Map).cast<String, dynamic>()),
    );
  }
}
