...
class NodeTemplateArgs {
  ...
  NodeTemplateArgs({
    ...
    ServerBinding? serverBinding,
            ...
            pulumi.Input.asOptionalInput<List<AcceleratorConfig>>(accelerators),
        cpuOvercommitType =
        ...
        serverBinding =
            pulumi.Input.asOptionalInput<ServerBinding>(serverBinding);
  ...
  factory NodeTemplateArgs.fromMap(Map<String, dynamic> map) {
    return NodeTemplateArgs(
      ...
      cpuOvercommitType: map['cpuOvercommitType'] == null
          ? null
          : NodeTemplateCpuOvercommitType.fromValue(
