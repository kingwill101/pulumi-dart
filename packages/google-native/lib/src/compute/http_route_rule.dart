...
class HttpRouteRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs': ?httpFilterConfigs == null ? null : pulumi.Input.encodeList<HttpFilterConfig, Map<String, dynamic>>(httpFilterConfigs!, (value) => value.toMap()),
      'httpFilterMetadata': ?httpFilterMetadata == null ? null : pulumi.Input.encodeList<HttpFilterConfig, Map<String, dynamic>>(httpFilterMetadata!, (value) => value.toMap()),
      'matchRules': ?matchRules == null ? null : pulumi.Input.encodeList<HttpRouteRuleMatch, Map<String, dynamic>>(matchRules!, (value) => value.toMap()),
      'priority': ?priority,
  ...
  factory HttpRouteRule.fromMap(Map<String, dynamic> map) {
    return HttpRouteRule(
      customErrorResponsePolicy: map['customErrorResponsePolicy'] == null ? null : CustomErrorResponsePolicy.fromMap((map['customErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      headerAction: map['headerAction'] == null ? null : HttpHeaderAction.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      httpFilterConfigs: map['httpFilterConfigs'] == null ? null : pulumi.Input.decodeList<HttpFilterConfig>(map['httpFilterConfigs'], (value) => HttpFilterConfig.fromMap((value as Map).cast<String, dynamic>())),
      httpFilterMetadata: map['httpFilterMetadata'] == null ? null : pulumi.Input.decodeList<HttpFilterConfig>(map['httpFilterMetadata'], (value) => HttpFilterConfig.fromMap((value as Map).cast<String, dynamic>())),
      matchRules: map['matchRules'] == null ? null : pulumi.Input.decodeList<HttpRouteRuleMatch>(map['matchRules'], (value) => HttpRouteRuleMatch.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] == null ? null : map['priority'] as int,
      routeAction: map['routeAction'] == null ? null : HttpRouteAction.fromMap((map['routeAction'] as Map).cast<String, dynamic>()),
      service: map['service'] == null ? null : map['service'] as String,
      urlRedirect: map['urlRedirect'] == null ? null : HttpRedirectAction.fromMap((map['urlRedirect'] as Map).cast<String, dynamic>()),
    );
  }
}
