...
import 'health_check_compute_beta_args.dart';
...
class HealthCheckComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<HTTP2HealthCheckResponseComputeBeta>
  http2HealthCheck;
  late final pulumi.Output<HTTPHealthCheckResponseComputeBeta> httpHealthCheck;
  late final pulumi.Output<HTTPSHealthCheckResponseComputeBeta>
  httpsHealthCheck;
  ...
  /// Creates a new [HealthCheckComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HealthCheckComputeBeta]. {@macro pulumi_compute_beta_health_check_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HealthCheckComputeBeta(
    String name, {
    HealthCheckComputeBetaArgs? args,
    ...
    this.grpcHealthCheck = registerOutput<GRPCHealthCheckResponseComputeBeta>(
      'grpcHealthCheck',
    );
    this.healthyThreshold = registerOutput<int>('healthyThreshold');
    this.http2HealthCheck = registerOutput<HTTP2HealthCheckResponseComputeBeta>(
      'http2HealthCheck',
    );
    this.httpHealthCheck = registerOutput<HTTPHealthCheckResponseComputeBeta>(
      'httpHealthCheck',
    );
    this.httpsHealthCheck = registerOutput<HTTPSHealthCheckResponseComputeBeta>(
      'httpsHealthCheck',
    );
    this.kind = registerOutput<String>('kind');
    this.logConfig = registerOutput<HealthCheckLogConfigResponseComputeBeta>(
      'logConfig',
    );
    ...
    this.sslHealthCheck = registerOutput<SSLHealthCheckResponseComputeBeta>(
      'sslHealthCheck',
    );
    this.tcpHealthCheck = registerOutput<TCPHealthCheckResponseComputeBeta>(
      'tcpHealthCheck',
    );
