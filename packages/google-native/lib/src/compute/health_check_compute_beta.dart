...
class HealthCheckComputeBeta extends pulumi.CustomResource {
  ...
  HealthCheckComputeBeta(
    ...
    this.grpcHealthCheck =
        registerOutput<GRPCHealthCheckResponseComputeBeta>('grpcHealthCheck');
    this.healthyThreshold = registerOutput<int>('healthyThreshold');
    this.http2HealthCheck =
        registerOutput<HTTP2HealthCheckResponseComputeBeta>('http2HealthCheck');
    this.httpHealthCheck =
        registerOutput<HTTPHealthCheckResponseComputeBeta>('httpHealthCheck');
    this.httpsHealthCheck =
        registerOutput<HTTPSHealthCheckResponseComputeBeta>('httpsHealthCheck');
    this.kind = registerOutput<String>('kind');
    this.logConfig =
        registerOutput<HealthCheckLogConfigResponseComputeBeta>('logConfig');
    ...
    this.sslHealthCheck =
        registerOutput<SSLHealthCheckResponseComputeBeta>('sslHealthCheck');
    this.tcpHealthCheck =
        registerOutput<TCPHealthCheckResponseComputeBeta>('tcpHealthCheck');
