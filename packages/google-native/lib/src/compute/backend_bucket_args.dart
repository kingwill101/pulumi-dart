...
class BackendBucketArgs {
  ...
  factory BackendBucketArgs.fromMap(Map<String, dynamic> map) {
    return BackendBucketArgs(
      ...
      cdnPolicy: map['cdnPolicy'] == null ? null : BackendBucketCdnPolicy.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] == null ? null : BackendBucketCompressionMode.fromValue(map['compressionMode'] as String),
