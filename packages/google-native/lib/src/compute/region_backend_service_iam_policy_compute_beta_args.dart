...
class RegionBackendServiceIamPolicyComputeBetaArgs {
  ...
  factory RegionBackendServiceIamPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceIamPolicyComputeBetaArgs(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Input.decodeList<AuditConfigComputeBeta>(map['auditConfigs'], (value) => AuditConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<BindingComputeBeta>(map['bindings'], (value) => BindingComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      etag: map['etag'] == null ? null : map['etag'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      resource: map['resource'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RuleComputeBeta>(map['rules'], (value) => RuleComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
