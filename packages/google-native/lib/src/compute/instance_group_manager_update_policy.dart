...
class InstanceGroupManagerUpdatePolicy {
  ...
  final InstanceGroupManagerUpdatePolicyInstanceRedistributionType? instanceRedistributionType;
  ...
  final InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedAction? mostDisruptiveAllowedAction;
  ...
  factory InstanceGroupManagerUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicy(
      instanceRedistributionType: map['instanceRedistributionType'] == null ? null : InstanceGroupManagerUpdatePolicyInstanceRedistributionType.fromValue(map['instanceRedistributionType'] as String),
      maxSurge: map['maxSurge'] == null ? null : FixedOrPercent.fromMap((map['maxSurge'] as Map).cast<String, dynamic>()),
      maxUnavailable: map['maxUnavailable'] == null ? null : FixedOrPercent.fromMap((map['maxUnavailable'] as Map).cast<String, dynamic>()),
      minReadySec: map['minReadySec'] == null ? null : map['minReadySec'] as int,
      minimalAction: map['minimalAction'] == null ? null : InstanceGroupManagerUpdatePolicyMinimalAction.fromValue(map['minimalAction'] as String),
      mostDisruptiveAllowedAction: map['mostDisruptiveAllowedAction'] == null ? null : InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedAction.fromValue(map['mostDisruptiveAllowedAction'] as String),
      replacementMethod: map['replacementMethod'] == null ? null : InstanceGroupManagerUpdatePolicyReplacementMethod.fromValue(map['replacementMethod'] as String),
      type: map['type'] == null ? null : InstanceGroupManagerUpdatePolicyType.fromValue(map['type'] as String),
    );
  }
}
