...
class SSLHealthCheckResponse {
  ...
  /// Creates a new [SSLHealthCheckResponse].
  ...
  factory SSLHealthCheckResponse.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheckResponse(
