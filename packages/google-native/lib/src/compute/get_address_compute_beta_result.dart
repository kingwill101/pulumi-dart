...
class GetAddressComputeBetaResult {
  ...
  /// Creates a new [GetAddressComputeBetaResult].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['ipv6EndpointType'] = ipv6EndpointType;
    map['kind'] = kind;
  ...
  factory GetAddressComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetAddressComputeBetaResult(
