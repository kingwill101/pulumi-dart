...
class InstanceGroupManagerUpdatePolicyComputeV1 {
  ...
  final InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeV1?
  ...
  final InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeV1?
  mostDisruptiveAllowedAction;

  /// What action should be used to replace instances. See minimal_action.REPLACE
  final InstanceGroupManagerUpdatePolicyReplacementMethodComputeV1?
  replacementMethod;
  ...
  factory InstanceGroupManagerUpdatePolicyComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return InstanceGroupManagerUpdatePolicyComputeV1(
      instanceRedistributionType: map['instanceRedistributionType'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeV1.fromValue(
      ...
      minimalAction: map['minimalAction'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyMinimalActionComputeV1.fromValue(
              map['minimalAction'] as String,
            ),
      mostDisruptiveAllowedAction: map['mostDisruptiveAllowedAction'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeV1.fromValue(
              map['mostDisruptiveAllowedAction'] as String,
            ),
      replacementMethod: map['replacementMethod'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyReplacementMethodComputeV1.fromValue(
              map['replacementMethod'] as String,
            ),
      type: map['type'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyTypeComputeV1.fromValue(
              map['type'] as String,
            ),
    );
  }
