...
class CustomerEncryptionKeyResponseComputeV1 {
  ...
  /// Creates a new [CustomerEncryptionKeyResponseComputeV1].
  ...
  factory CustomerEncryptionKeyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return CustomerEncryptionKeyResponseComputeV1(
