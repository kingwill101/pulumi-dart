...
import 'forwarding_rule_compute_beta_args.dart';
...
class ForwardingRuleComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [ForwardingRuleComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ForwardingRuleComputeBeta]. {@macro pulumi_compute_beta_forwarding_rule_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ForwardingRuleComputeBeta(
    String name, {
    ForwardingRuleComputeBetaArgs? args,
