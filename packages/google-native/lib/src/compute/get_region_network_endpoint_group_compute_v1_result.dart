...
class GetRegionNetworkEndpointGroupComputeV1Result {
  ...
  /// Creates a new [GetRegionNetworkEndpointGroupComputeV1Result].
  ...
  factory GetRegionNetworkEndpointGroupComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionNetworkEndpointGroupComputeV1Result(
