...
class RegionTargetTcpProxyComputeV1Args {
  ...
  RegionTargetTcpProxyComputeV1Args({
    ...
    String? project,
    bool? proxyBind,
    RegionTargetTcpProxyProxyHeaderComputeV1? proxyHeader,
  ...
  factory RegionTargetTcpProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyComputeV1Args(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : RegionTargetTcpProxyProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String),
