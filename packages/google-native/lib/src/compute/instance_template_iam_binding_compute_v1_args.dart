...
/// {@template pulumi_compute_v1_instance_template_iam_binding_compute_v1_args_doc}
/// The set of arguments for InstanceTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_instance_template_iam_binding_compute_v1_args_doc}
class InstanceTemplateIamBindingComputeV1Args {
  ...
  /// Creates a new [InstanceTemplateIamBindingComputeV1Args].
  ...
  factory InstanceTemplateIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateIamBindingComputeV1Args(
