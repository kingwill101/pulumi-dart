...
class AttachedDiskComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (guestOsFeaturesValue != null) {
      map['guestOsFeatures'] = pulumi.Input.encodeList<GuestOsFeatureComputeV1,
  ...
  factory AttachedDiskComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskComputeV1(
      ...
      initializeParams: map['initializeParams'] == null
          ? null
          : AttachedDiskInitializeParamsComputeV1.fromMap(
              (map['initializeParams'] as Map).cast<String, dynamic>()),
      interface: map['interface'] == null
          ? null
          : AttachedDiskInterfaceComputeV1.fromValue(
              map['interface'] as String),
      mode: map['mode'] == null
          ? null
          : AttachedDiskModeComputeV1.fromValue(map['mode'] as String),
      savedState: map['savedState'] == null
          ? null
          : AttachedDiskSavedStateComputeV1.fromValue(
              map['savedState'] as String),
      source: map['source'] == null ? null : map['source'] as String,
      type: map['type'] == null
          ? null
          : AttachedDiskTypeComputeV1.fromValue(map['type'] as String),
    );
  }
}
