...
import 'disk_architecture_compute_v1.dart';
import 'disk_async_replication_compute_v1.dart';
import 'disk_params_compute_v1.dart';
import 'guest_os_feature_compute_v1.dart';

/// {@template pulumi_compute_v1_disk_compute_v1_args_doc}
/// The set of arguments for Disk.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_disk_compute_v1_args_doc}
class DiskComputeV1Args {
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final pulumi.Input<DiskArchitectureComputeV1>? architecture;
  ...
  /// Creates a new [DiskComputeV1Args].
  ...
  /// [zone] Optional.
  DiskComputeV1Args({
    DiskArchitectureComputeV1? architecture,
    ...
    String? zone,
      ...
      architecture = pulumi.Input.asOptionalInput<DiskArchitectureComputeV1>(architecture),
      asyncPrimaryDisk = pulumi.Input.asOptionalInput<DiskAsyncReplicationComputeV1>(asyncPrimaryDisk),
      description = pulumi.Input.asOptionalInput<String>(description),
      diskEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeV1>(diskEncryptionKey),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<DiskArchitectureComputeV1, String>(architecture, (value) => value.value),
      'asyncPrimaryDisk': ?pulumi.Input.mapOptionalInputValue<DiskAsyncReplicationComputeV1, Map<String, dynamic>>(asyncPrimaryDisk, (value) => value.toMap()),
      ...
      'name': ?name,
      'options': ?options,
      'params': ?pulumi.Input.mapOptionalInputValue<DiskParamsComputeV1, Map<String, dynamic>>(params, (value) => value.toMap()),
  ...
  factory DiskComputeV1Args.fromMap(Map<String, dynamic> map) {
    return DiskComputeV1Args(
      architecture: map['architecture'] == null ? null : DiskArchitectureComputeV1.fromValue(map['architecture'] as String),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : DiskAsyncReplicationComputeV1.fromMap((map['asyncPrimaryDisk'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeV1.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>()),
      guestOsFeatures: map['guestOsFeatures'] == null ? null : pulumi.Input.decodeList<GuestOsFeatureComputeV1>(map['guestOsFeatures'], (value) => GuestOsFeatureComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      params: map['params'] == null ? null : DiskParamsComputeV1.fromMap((map['params'] as Map).cast<String, dynamic>()),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeV1.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceSnapshot: map['sourceSnapshot'] == null ? null : map['sourceSnapshot'] as String,
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeV1.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
