...
class DiskComputeV1Args {
  ...
  DiskComputeV1Args({
    ...
    String? type,
    String? zone,
  })  : architecture = pulumi.Input.asOptionalInput<DiskArchitectureComputeV1>(
            architecture),
        asyncPrimaryDisk =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (architectureValue != null) {
      map['architecture'] =
          pulumi.Input.mapOptionalInputValue<DiskArchitectureComputeV1, String>(
    ...
    if (asyncPrimaryDiskValue != null) {
      map['asyncPrimaryDisk'] = pulumi.Input.mapOptionalInputValue<
              DiskAsyncReplicationComputeV1, Map<String, dynamic>>(
    ...
    if (paramsValue != null) {
      map['params'] = pulumi.Input.mapOptionalInputValue<DiskParamsComputeV1,
  ...
  factory DiskComputeV1Args.fromMap(Map<String, dynamic> map) {
    return DiskComputeV1Args(
      architecture: map['architecture'] == null
          ? null
          : DiskArchitectureComputeV1.fromValue(map['architecture'] as String),
