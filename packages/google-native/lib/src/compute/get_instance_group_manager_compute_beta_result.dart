...
class GetInstanceGroupManagerComputeBetaResult {
  /// Specifies configuration that overrides the instance template configuration for the group.
  final InstanceGroupManagerAllInstancesConfigResponseComputeBeta allInstancesConfig;
  /// The autohealing policy for this managed instance group. You can specify only one value.
  final List<InstanceGroupManagerAutoHealingPolicyResponseComputeBeta> autoHealingPolicies;
  ...
  final InstanceGroupManagerInstanceFlexibilityPolicyResponseComputeBeta instanceFlexibilityPolicy;
  /// The URL of the Instance Group resource.
  final String instanceGroup;
  /// The repair policy for this managed instance group.
  final InstanceGroupManagerInstanceLifecyclePolicyResponseComputeBeta instanceLifecyclePolicy;
  ...
  /// Creates a new [GetInstanceGroupManagerComputeBetaResult].
  ...
  GetInstanceGroupManagerComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'autoHealingPolicies': pulumi.Input.encodeList<InstanceGroupManagerAutoHealingPolicyResponseComputeBeta, Map<String, dynamic>>(autoHealingPolicies, (value) => value.toMap()),
      ...
      'name': name,
      'namedPorts': pulumi.Input.encodeList<NamedPortResponseComputeBeta, Map<String, dynamic>>(namedPorts, (value) => value.toMap()),
      'region': region,
      'selfLink': selfLink,
      ...
      'versions': pulumi.Input.encodeList<InstanceGroupManagerVersionResponseComputeBeta, Map<String, dynamic>>(versions, (value) => value.toMap()),
      'zone': zone,
    };
  }

  factory GetInstanceGroupManagerComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceGroupManagerComputeBetaResult(
      allInstancesConfig: InstanceGroupManagerAllInstancesConfigResponseComputeBeta.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>()),
      autoHealingPolicies: pulumi.Input.decodeList<InstanceGroupManagerAutoHealingPolicyResponseComputeBeta>(map['autoHealingPolicies'], (value) => InstanceGroupManagerAutoHealingPolicyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      baseInstanceName: map['baseInstanceName'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      currentActions: InstanceGroupManagerActionsSummaryResponseComputeBeta.fromMap((map['currentActions'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      distributionPolicy: DistributionPolicyResponseComputeBeta.fromMap((map['distributionPolicy'] as Map).cast<String, dynamic>()),
      failoverAction: map['failoverAction'] as String,
      fingerprint: map['fingerprint'] as String,
      instanceFlexibilityPolicy: InstanceGroupManagerInstanceFlexibilityPolicyResponseComputeBeta.fromMap((map['instanceFlexibilityPolicy'] as Map).cast<String, dynamic>()),
      instanceGroup: map['instanceGroup'] as String,
      instanceLifecyclePolicy: InstanceGroupManagerInstanceLifecyclePolicyResponseComputeBeta.fromMap((map['instanceLifecyclePolicy'] as Map).cast<String, dynamic>()),
      ...
      namedPorts: pulumi.Input.decodeList<NamedPortResponseComputeBeta>(map['namedPorts'], (value) => NamedPortResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      serviceAccount: map['serviceAccount'] as String,
      standbyPolicy: InstanceGroupManagerStandbyPolicyResponseComputeBeta.fromMap((map['standbyPolicy'] as Map).cast<String, dynamic>()),
      statefulPolicy: StatefulPolicyResponseComputeBeta.fromMap((map['statefulPolicy'] as Map).cast<String, dynamic>()),
      status: InstanceGroupManagerStatusResponseComputeBeta.fromMap((map['status'] as Map).cast<String, dynamic>()),
      ...
      updatePolicy: InstanceGroupManagerUpdatePolicyResponseComputeBeta.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>()),
      versions: pulumi.Input.decodeList<InstanceGroupManagerVersionResponseComputeBeta>(map['versions'], (value) => InstanceGroupManagerVersionResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
