...
class GetInstanceGroupManagerComputeBetaResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['namedPorts'] = pulumi.Input.encodeList<NamedPortResponseComputeBeta,
  ...
  factory GetInstanceGroupManagerComputeBetaResult.fromMap(
    ...
    return GetInstanceGroupManagerComputeBetaResult(
      ...
      versions: pulumi.Input.decodeList<
              InstanceGroupManagerVersionResponseComputeBeta>(
          map['versions'],
