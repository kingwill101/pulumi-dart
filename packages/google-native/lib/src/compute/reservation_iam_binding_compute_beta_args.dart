...
/// {@template pulumi_compute_beta_reservation_iam_binding_compute_beta_args_doc}
/// The set of arguments for ReservationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_reservation_iam_binding_compute_beta_args_doc}
class ReservationIamBindingComputeBetaArgs {
  ...
  /// Creates a new [ReservationIamBindingComputeBetaArgs].
  ...
  ReservationIamBindingComputeBetaArgs({
    Condition? condition,
  ...
  factory ReservationIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ReservationIamBindingComputeBetaArgs(
