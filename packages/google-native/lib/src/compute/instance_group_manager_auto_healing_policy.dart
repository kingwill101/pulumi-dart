...
class InstanceGroupManagerAutoHealingPolicy {
  ...
  final InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers?
      autoHealingTriggers;
  ...
  Map<String, dynamic> toMap() {
    ...
    final autoHealingTriggersValue = autoHealingTriggers;
    if (autoHealingTriggersValue != null) {
      map['autoHealingTriggers'] = autoHealingTriggersValue.toMap();
    }
  ...
  factory InstanceGroupManagerAutoHealingPolicy.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicy(
      autoHealingTriggers: map['autoHealingTriggers'] == null
          ? null
          : InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers.fromMap(
