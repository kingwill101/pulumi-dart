...
class InstanceGroupManagerAutoHealingPolicy {
  ...
  final InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers? autoHealingTriggers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoHealingTriggers': ?autoHealingTriggers == null ? null : autoHealingTriggers!.toMap(),
  ...
  factory InstanceGroupManagerAutoHealingPolicy.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicy(
      autoHealingTriggers: map['autoHealingTriggers'] == null ? null : InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers.fromMap((map['autoHealingTriggers'] as Map).cast<String, dynamic>()),
