...
import 'region_network_endpoint_group_compute_beta_args.dart';

/// Creates a network endpoint group in the specified project using the parameters that are included in the request.
class RegionNetworkEndpointGroupComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionNetworkEndpointGroupComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionNetworkEndpointGroupComputeBeta]. {@macro pulumi_compute_beta_region_network_endpoint_group_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionNetworkEndpointGroupComputeBeta(
    String name, {
    RegionNetworkEndpointGroupComputeBetaArgs? args,
