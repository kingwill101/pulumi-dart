...
class PathMatcherResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['pathRules'] = pulumi.Input.encodeList<PathRuleResponseComputeBeta,
  ...
  factory PathMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeBeta(
      ...
      pathRules: pulumi.Input.decodeList<PathRuleResponseComputeBeta>(
          map['pathRules'],
          (value) => PathRuleResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
      routeRules: pulumi.Input.decodeList<HttpRouteRuleResponseComputeBeta>(
          map['routeRules'],
