...
/// {@template pulumi_compute_v1_region_network_firewall_policy_compute_v1_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_network_firewall_policy_compute_v1_args_doc}
class RegionNetworkFirewallPolicyComputeV1Args {
  ...
  /// Creates a new [RegionNetworkFirewallPolicyComputeV1Args].
  ...
  RegionNetworkFirewallPolicyComputeV1Args({
    List<FirewallPolicyAssociationComputeV1>? associations,
    String? description,
    String? displayName,
    String? name,
    String? project,
    ...
    String? requestId,
    List<FirewallPolicyRuleComputeV1>? rules,
    String? shortName,
        ...
        rules = pulumi.Input.asOptionalInput<List<FirewallPolicyRuleComputeV1>>(
            rules),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (associationsValue != null) {
      map['associations'] = pulumi.Input.mapOptionalInputValue<
              List<FirewallPolicyAssociationComputeV1>,
              List<Map<String, dynamic>>>(
          associationsValue,
          (value) => pulumi.Input.encodeList<FirewallPolicyAssociationComputeV1,
    ...
    if (rulesValue != null) {
      map['rules'] = pulumi.Input.mapOptionalInputValue<
              List<FirewallPolicyRuleComputeV1>, List<Map<String, dynamic>>>(
          rulesValue,
          (value) => pulumi.Input.encodeList<FirewallPolicyRuleComputeV1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory RegionNetworkFirewallPolicyComputeV1Args.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyComputeV1Args(
      associations: map['associations'] == null
          ? null
          : pulumi.Input.decodeList<FirewallPolicyAssociationComputeV1>(
              map['associations'],
              (value) => FirewallPolicyAssociationComputeV1.fromMap(
      ...
      rules: map['rules'] == null
          ? null
          : pulumi.Input.decodeList<FirewallPolicyRuleComputeV1>(
              map['rules'],
              (value) => FirewallPolicyRuleComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
