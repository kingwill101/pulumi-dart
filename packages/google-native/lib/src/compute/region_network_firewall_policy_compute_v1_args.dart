...
class RegionNetworkFirewallPolicyComputeV1Args {
  ...
  factory RegionNetworkFirewallPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyComputeV1Args(
      associations: map['associations'] == null ? null : pulumi.Input.decodeList<FirewallPolicyAssociationComputeV1>(map['associations'], (value) => FirewallPolicyAssociationComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleComputeV1>(map['rules'], (value) => FirewallPolicyRuleComputeV1.fromMap((value as Map).cast<String, dynamic>())),
