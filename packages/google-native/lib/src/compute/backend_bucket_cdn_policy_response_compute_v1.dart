...
class BackendBucketCdnPolicyResponseComputeV1 {
  ...
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1>
  ...
  factory BackendBucketCdnPolicyResponseComputeV1.fromMap(
    ...
    return BackendBucketCdnPolicyResponseComputeV1(
      bypassCacheOnRequestHeaders:
          ...
          >(
            ...
            (value) =>
                BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      cacheKeyPolicy:
          BackendBucketCdnPolicyCacheKeyPolicyResponseComputeV1.fromMap(
      ...
      negativeCachingPolicy:
          ...
          >(
            ...
            (value) =>
                BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
