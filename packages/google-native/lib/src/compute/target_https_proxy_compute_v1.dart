...
import 'target_https_proxy_compute_v1_args.dart';

/// Creates a TargetHttpsProxy resource in the specified project using the data included in the request.
class TargetHttpsProxyComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetHttpsProxyComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetHttpsProxyComputeV1]. {@macro pulumi_compute_v1_target_https_proxy_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetHttpsProxyComputeV1(
    String name, {
    TargetHttpsProxyComputeV1Args? args,
