...
class TargetPoolComputeV1Args {
  ...
  TargetPoolComputeV1Args({
    ...
    String? requestId,
    TargetPoolSessionAffinityComputeV1? sessionAffinity,
  }) :
  ...
  factory TargetPoolComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetPoolComputeV1Args(
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : TargetPoolSessionAffinityComputeV1.fromValue(map['sessionAffinity'] as String),
    );
  }
}
