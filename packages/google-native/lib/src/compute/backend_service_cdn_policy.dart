...
class BackendServiceCdnPolicy {
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicy>? negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'negativeCachingPolicy': ?negativeCachingPolicy == null ? null : pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicy, Map<String, dynamic>>(negativeCachingPolicy!, (value) => value.toMap()),
  ...
  factory BackendServiceCdnPolicy.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicy(
      ...
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : CacheKeyPolicy.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null ? null : BackendServiceCdnPolicyCacheMode.fromValue(map['cacheMode'] as String),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicy>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>())),
