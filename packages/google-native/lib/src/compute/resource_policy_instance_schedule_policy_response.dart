...
class ResourcePolicyInstanceSchedulePolicyResponse {
  ...
  factory ResourcePolicyInstanceSchedulePolicyResponse.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyInstanceSchedulePolicyResponse(
      ...
      vmStartSchedule: ResourcePolicyInstanceSchedulePolicyScheduleResponse.fromMap((map['vmStartSchedule'] as Map).cast<String, dynamic>()),
      vmStopSchedule: ResourcePolicyInstanceSchedulePolicyScheduleResponse.fromMap((map['vmStopSchedule'] as Map).cast<String, dynamic>()),
    );
  }
}
