...
class NetworkEndpointGroupComputeBetaArgs {
  ...
  NetworkEndpointGroupComputeBetaArgs({
    ...
    String? name,
    String? network,
    NetworkEndpointGroupNetworkEndpointTypeComputeBeta? networkEndpointType,
    String? project,
    ...
    String? zone,
        ...
        cloudFunction = pulumi.Input.asOptionalInput<
            NetworkEndpointGroupCloudFunctionComputeBeta>(cloudFunction),
        cloudRun = pulumi.Input.asOptionalInput<
            NetworkEndpointGroupCloudRunComputeBeta>(cloudRun),
  ...
  factory NetworkEndpointGroupComputeBetaArgs.fromMap(
    ...
    return NetworkEndpointGroupComputeBetaArgs(
      ...
      networkEndpointType: map['networkEndpointType'] == null
          ? null
          : NetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(
