...
class BackendBucketCdnPolicyComputeBeta {
  ...
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta>? bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final BackendBucketCdnPolicyCacheKeyPolicyComputeBeta? cacheKeyPolicy;
  ...
  final BackendBucketCdnPolicyCacheModeComputeBeta? cacheMode;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta>? negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': ?bypassCacheOnRequestHeaders == null ? null : pulumi.Input.encodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta, Map<String, dynamic>>(bypassCacheOnRequestHeaders!, (value) => value.toMap()),
      'cacheKeyPolicy': ?cacheKeyPolicy == null ? null : cacheKeyPolicy!.toMap(),
      'cacheMode': ?cacheMode == null ? null : cacheMode!.value,
      'clientTtl': ?clientTtl,
      'defaultTtl': ?defaultTtl,
      'maxTtl': ?maxTtl,
      'negativeCaching': ?negativeCaching,
      'negativeCachingPolicy': ?negativeCachingPolicy == null ? null : pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta, Map<String, dynamic>>(negativeCachingPolicy!, (value) => value.toMap()),
  ...
  factory BackendBucketCdnPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyComputeBeta(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null ? null : pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta>(map['bypassCacheOnRequestHeaders'], (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : BackendBucketCdnPolicyCacheKeyPolicyComputeBeta.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null ? null : BackendBucketCdnPolicyCacheModeComputeBeta.fromValue(map['cacheMode'] as String),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta>(map['negativeCachingPolicy'], (value) => BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      signedUrlCacheMaxAgeSec: map['signedUrlCacheMaxAgeSec'] == null ? null : map['signedUrlCacheMaxAgeSec'] as String,
    );
  }
}
