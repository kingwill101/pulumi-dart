...
class SecurityPolicyRuleNetworkMatcherComputeBeta {
  ...
  final List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta>?
  userDefinedFields;
  ...
  factory SecurityPolicyRuleNetworkMatcherComputeBeta.fromMap(
    ...
    return SecurityPolicyRuleNetworkMatcherComputeBeta(
      ...
      srcAsns: map['srcAsns'] == null
          ? null
          : (map['srcAsns'] as List).cast<int>(),
      ...
      userDefinedFields: map['userDefinedFields'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta.fromMap(
