...
import 'security_policy_rule_network_matcher_user_defined_field_match_compute_beta.dart';

/// Represents a match condition that incoming network traffic is evaluated against.
class SecurityPolicyRuleNetworkMatcherComputeBeta {
  ...
  final List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta>? userDefinedFields;

  /// Creates a new [SecurityPolicyRuleNetworkMatcherComputeBeta].
  ...
  SecurityPolicyRuleNetworkMatcherComputeBeta({
    this.destIpRanges,
    this.destPorts,
    this.ipProtocols,
    this.srcAsns,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'userDefinedFields': ?userDefinedFields == null ? null : pulumi.Input.encodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta, Map<String, dynamic>>(userDefinedFields!, (value) => value.toMap()),
    };
  }

  factory SecurityPolicyRuleNetworkMatcherComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherComputeBeta(
      ...
      userDefinedFields: map['userDefinedFields'] == null ? null : pulumi.Input.decodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta>(map['userDefinedFields'], (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
