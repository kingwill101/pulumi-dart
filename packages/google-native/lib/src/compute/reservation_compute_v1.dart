...
class ReservationComputeV1 {
  ...
  final ShareSettingsComputeV1? shareSettings;

  /// Reservation for instances with specific machine shapes.
  final AllocationSpecificSKUReservationComputeV1? specificReservation;
  ...
  factory ReservationComputeV1.fromMap(Map<String, dynamic> map) {
    return ReservationComputeV1(
      ...
      specificReservation: map['specificReservation'] == null
          ? null
          : AllocationSpecificSKUReservationComputeV1.fromMap(
