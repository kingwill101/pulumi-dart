...
class GetTargetSslProxyComputeV1Result {
  ...
  /// Creates a new [GetTargetSslProxyComputeV1Result].
  ...
  GetTargetSslProxyComputeV1Result({
  ...
  factory GetTargetSslProxyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetTargetSslProxyComputeV1Result(
