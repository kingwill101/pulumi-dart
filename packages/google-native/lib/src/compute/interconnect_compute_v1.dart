...
import 'interconnect_compute_v1_args.dart';
...
class InterconnectComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InterconnectCircuitInfoResponseComputeV1>> circuitInfos;
  ...
  late final pulumi.Output<List<InterconnectOutageNotificationResponseComputeV1>> expectedOutages;
  ...
  late final pulumi.Output<InterconnectMacsecResponseComputeV1> macsec;
  ...
  /// Creates a new [InterconnectComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InterconnectComputeV1]. {@macro pulumi_compute_v1_interconnect_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InterconnectComputeV1(
    String name, {
    InterconnectComputeV1Args? args,
    ...
    this.circuitInfos = registerOutput<List<InterconnectCircuitInfoResponseComputeV1>>('circuitInfos');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.customerName = registerOutput<String>('customerName');
    this.description = registerOutput<String>('description');
    this.expectedOutages = registerOutput<List<InterconnectOutageNotificationResponseComputeV1>>('expectedOutages');
    ...
    this.macsec = registerOutput<InterconnectMacsecResponseComputeV1>('macsec');
