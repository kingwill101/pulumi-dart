...
class InterconnectComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InterconnectCircuitInfoResponseComputeV1>>
  circuitInfos;
  ...
  late final pulumi.Output<
    List<InterconnectOutageNotificationResponseComputeV1>
  >
  expectedOutages;
  ...
  InterconnectComputeV1(
    ...
    this.circuitInfos =
        registerOutput<List<InterconnectCircuitInfoResponseComputeV1>>(
          'circuitInfos',
        );
    ...
    this.expectedOutages =
        registerOutput<List<InterconnectOutageNotificationResponseComputeV1>>(
          'expectedOutages',
        );
    this.googleIpAddress = registerOutput<String>('googleIpAddress');
    this.googleReferenceId = registerOutput<String>('googleReferenceId');
    this.interconnectAttachments = registerOutput<List<String>>(
