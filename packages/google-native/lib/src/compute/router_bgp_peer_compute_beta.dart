    ...
    return <String, dynamic>{
      ...
      'advertisedGroups': ?advertisedGroups == null
          ...
          : pulumi.Input.encodeList<
              ...
              String
            >(advertisedGroups!, (value) => value.value),
      ...
      'customLearnedIpRanges': ?customLearnedIpRanges == null
          ? null
          : pulumi.Input.encodeList<
  ...
  factory RouterBgpPeerComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerComputeBeta(
      ...
      advertisedGroups: map['advertisedGroups'] == null
          ? null
          : pulumi
                .Input.decodeList<RouterBgpPeerAdvertisedGroupsItemComputeBeta>(
      ...
      customLearnedIpRanges: map['customLearnedIpRanges'] == null
          ? null
          : pulumi
                .Input.decodeList<RouterBgpPeerCustomLearnedIpRangeComputeBeta>(
