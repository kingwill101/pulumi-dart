...
class RouterBgpPeerComputeBeta {
  ...
  final List<RouterBgpPeerCustomLearnedIpRangeComputeBeta>? customLearnedIpRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advertisedGroups': ?advertisedGroups == null ? null : pulumi.Input.encodeList<RouterBgpPeerAdvertisedGroupsItemComputeBeta, String>(advertisedGroups!, (value) => value.value),
      ...
      'customLearnedIpRanges': ?customLearnedIpRanges == null ? null : pulumi.Input.encodeList<RouterBgpPeerCustomLearnedIpRangeComputeBeta, Map<String, dynamic>>(customLearnedIpRanges!, (value) => value.toMap()),
  ...
  factory RouterBgpPeerComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerComputeBeta(
      advertiseMode: map['advertiseMode'] == null ? null : RouterBgpPeerAdvertiseModeComputeBeta.fromValue(map['advertiseMode'] as String),
      advertisedGroups: map['advertisedGroups'] == null ? null : pulumi.Input.decodeList<RouterBgpPeerAdvertisedGroupsItemComputeBeta>(map['advertisedGroups'], (value) => RouterBgpPeerAdvertisedGroupsItemComputeBeta.fromValue(value as String)),
      ...
      bfd: map['bfd'] == null ? null : RouterBgpPeerBfdComputeBeta.fromMap((map['bfd'] as Map).cast<String, dynamic>()),
      customLearnedIpRanges: map['customLearnedIpRanges'] == null ? null : pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeComputeBeta>(map['customLearnedIpRanges'], (value) => RouterBgpPeerCustomLearnedIpRangeComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      customLearnedRoutePriority: map['customLearnedRoutePriority'] == null ? null : map['customLearnedRoutePriority'] as int,
      enable: map['enable'] == null ? null : RouterBgpPeerEnableComputeBeta.fromValue(map['enable'] as String),
