...
class SecurityPolicyRuleResponseComputeBeta {
  ...
  final SecurityPolicyRulePreconfiguredWafConfigResponseComputeBeta
  ...
  factory SecurityPolicyRuleResponseComputeBeta.fromMap(
    ...
    return SecurityPolicyRuleResponseComputeBeta(
      ...
      headerAction:
          SecurityPolicyRuleHttpHeaderActionResponseComputeBeta.fromMap(
            (map['headerAction'] as Map).cast<String, dynamic>(),
          ),
      kind: map['kind'] as String,
      match: SecurityPolicyRuleMatcherResponseComputeBeta.fromMap(
        (map['match'] as Map).cast<String, dynamic>(),
      ),
      networkMatch: SecurityPolicyRuleNetworkMatcherResponseComputeBeta.fromMap(
        (map['networkMatch'] as Map).cast<String, dynamic>(),
      ),
      preconfiguredWafConfig:
          SecurityPolicyRulePreconfiguredWafConfigResponseComputeBeta.fromMap(
            (map['preconfiguredWafConfig'] as Map).cast<String, dynamic>(),
          ),
      preview: map['preview'] as bool,
      priority: map['priority'] as int,
      rateLimitOptions:
          SecurityPolicyRuleRateLimitOptionsResponseComputeBeta.fromMap(
            (map['rateLimitOptions'] as Map).cast<String, dynamic>(),
          ),
      redirectOptions:
          SecurityPolicyRuleRedirectOptionsResponseComputeBeta.fromMap(
