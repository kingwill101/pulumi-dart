...
class SnapshotComputeBetaArgs {
  ...
  SnapshotComputeBetaArgs({
    ...
    String? project,
    String? requestId,
    CustomerEncryptionKeyComputeBeta? snapshotEncryptionKey,
    SnapshotSnapshotTypeComputeBeta? snapshotType,
    String? sourceDisk,
    ...
    CustomerEncryptionKeyComputeBeta? sourceInstantSnapshotEncryptionKey,
  ...
  factory SnapshotComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotComputeBetaArgs(
      ...
      snapshotEncryptionKey: map['snapshotEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeBeta.fromMap((map['snapshotEncryptionKey'] as Map).cast<String, dynamic>()),
      snapshotType: map['snapshotType'] == null ? null : SnapshotSnapshotTypeComputeBeta.fromValue(map['snapshotType'] as String),
      ...
      sourceInstantSnapshotEncryptionKey: map['sourceInstantSnapshotEncryptionKey'] == null ? null : CustomerEncryptionKeyComputeBeta.fromMap((map['sourceInstantSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
