...
class AttachedDiskInitializeParamsResponseComputeBeta {
  ...
  factory AttachedDiskInitializeParamsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsResponseComputeBeta(
      ...
      sourceImageEncryptionKey: CustomerEncryptionKeyResponseComputeBeta.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceInstantSnapshot: map['sourceInstantSnapshot'] as String,
      sourceSnapshot: map['sourceSnapshot'] as String,
      sourceSnapshotEncryptionKey: CustomerEncryptionKeyResponseComputeBeta.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
    );
  }
}
