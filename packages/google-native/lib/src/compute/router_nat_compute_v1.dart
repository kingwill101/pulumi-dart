...
class RouterNatComputeV1 {
  ...
  final RouterNatSourceSubnetworkIpRangesToNatComputeV1?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoNetworkTier': ?autoNetworkTier == null
          ? null
      ...
      'sourceSubnetworkIpRangesToNat': ?sourceSubnetworkIpRangesToNat == null
          ? null
  ...
  factory RouterNatComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatComputeV1(
      autoNetworkTier: map['autoNetworkTier'] == null
          ? null
          : RouterNatAutoNetworkTierComputeV1.fromValue(
      ...
      endpointTypes: map['endpointTypes'] == null
          ...
          : pulumi.Input.decodeList<RouterNatEndpointTypesItemComputeV1>(
              map['endpointTypes'],
              (value) => RouterNatEndpointTypesItemComputeV1.fromValue(
                value as String,
              ),
            ),
      ...
      maxPortsPerVm: map['maxPortsPerVm'] == null
          ? null
          : map['maxPortsPerVm'] as int,
      minPortsPerVm: map['minPortsPerVm'] == null
          ? null
          : map['minPortsPerVm'] as int,
      ...
      natIps: map['natIps'] == null
          ? null
          : (map['natIps'] as List).cast<String>(),
      ...
      type: map['type'] == null
          ? null
          : RouterNatTypeComputeV1.fromValue(map['type'] as String),
