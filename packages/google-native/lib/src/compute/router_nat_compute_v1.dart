...
class RouterNatComputeV1 {
  ...
  final RouterNatAutoNetworkTierComputeV1? autoNetworkTier;
  ...
  final List<RouterNatEndpointTypesItemComputeV1>? endpointTypes;
  /// Timeout (in seconds) for ICMP connections. Defaults to 30s if not set.
  final int? icmpIdleTimeoutSec;
  /// Configure logging on this NAT.
  final RouterNatLogConfigComputeV1? logConfig;
  ...
  final RouterNatNatIpAllocateOptionComputeV1? natIpAllocateOption;
  /// A list of URLs of the IP resources used for this Nat service. These IP addresses must be valid static external IP addresses assigned to the project.
  final List<String>? natIps;
  /// A list of rules associated with this NAT.
  final List<RouterNatRuleComputeV1>? rules;
  /// Specify the Nat option, which can take one of the following values: - ALL_SUBNETWORKS_ALL_IP_RANGES: All of the IP ranges in every Subnetwork are allowed to Nat. - ALL_SUBNETWORKS_ALL_PRIMARY_IP_RANGES: All of the primary IP ranges in every Subnetwork are allowed to Nat. - LIST_OF_SUBNETWORKS: A list of Subnetworks are allowed to Nat (specified in the field subnetwork below) The default is SUBNETWORK_IP_RANGE_TO_NAT_OPTION_UNSPECIFIED. Note that if this field contains ALL_SUBNETWORKS_ALL_IP_RANGES then there should not be any other Router.Nat section in any Router for this network in this region.
  final RouterNatSourceSubnetworkIpRangesToNatComputeV1? sourceSubnetworkIpRangesToNat;
  /// A list of Subnetwork resources whose traffic should be translated by NAT Gateway. It is used only when LIST_OF_SUBNETWORKS is selected for the SubnetworkIpRangeToNatOption above.
  final List<RouterNatSubnetworkToNatComputeV1>? subnetworks;
  ...
  final RouterNatTypeComputeV1? type;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpointTypes': ?endpointTypes == null ? null : pulumi.Input.encodeList<RouterNatEndpointTypesItemComputeV1, String>(endpointTypes!, (value) => value.value),
      ...
      'natIps': ?natIps,
      'rules': ?rules == null ? null : pulumi.Input.encodeList<RouterNatRuleComputeV1, Map<String, dynamic>>(rules!, (value) => value.toMap()),
      'sourceSubnetworkIpRangesToNat': ?sourceSubnetworkIpRangesToNat == null ? null : sourceSubnetworkIpRangesToNat!.value,
      'subnetworks': ?subnetworks == null ? null : pulumi.Input.encodeList<RouterNatSubnetworkToNatComputeV1, Map<String, dynamic>>(subnetworks!, (value) => value.toMap()),
  ...
  factory RouterNatComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatComputeV1(
      autoNetworkTier: map['autoNetworkTier'] == null ? null : RouterNatAutoNetworkTierComputeV1.fromValue(map['autoNetworkTier'] as String),
      ...
      endpointTypes: map['endpointTypes'] == null ? null : pulumi.Input.decodeList<RouterNatEndpointTypesItemComputeV1>(map['endpointTypes'], (value) => RouterNatEndpointTypesItemComputeV1.fromValue(value as String)),
      icmpIdleTimeoutSec: map['icmpIdleTimeoutSec'] == null ? null : map['icmpIdleTimeoutSec'] as int,
      logConfig: map['logConfig'] == null ? null : RouterNatLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      ...
      natIpAllocateOption: map['natIpAllocateOption'] == null ? null : RouterNatNatIpAllocateOptionComputeV1.fromValue(map['natIpAllocateOption'] as String),
      natIps: map['natIps'] == null ? null : (map['natIps'] as List).cast<String>(),
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RouterNatRuleComputeV1>(map['rules'], (value) => RouterNatRuleComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat: map['sourceSubnetworkIpRangesToNat'] == null ? null : RouterNatSourceSubnetworkIpRangesToNatComputeV1.fromValue(map['sourceSubnetworkIpRangesToNat'] as String),
      subnetworks: map['subnetworks'] == null ? null : pulumi.Input.decodeList<RouterNatSubnetworkToNatComputeV1>(map['subnetworks'], (value) => RouterNatSubnetworkToNatComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null ? null : RouterNatTypeComputeV1.fromValue(map['type'] as String),
