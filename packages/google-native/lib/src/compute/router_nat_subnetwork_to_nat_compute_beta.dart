...
class RouterNatSubnetworkToNatComputeBeta {
  ...
  final List<RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeBeta>?
  sourceIpRangesToNat;
    ...
    return <String, dynamic>{
      ...
      'sourceIpRangesToNat': ?sourceIpRangesToNat == null
          ...
          : pulumi.Input.encodeList<
              RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeBeta,
              String
            >(sourceIpRangesToNat!, (value) => value.value),
    };
  }

  factory RouterNatSubnetworkToNatComputeBeta.fromMap(
      ...
      sourceIpRangesToNat: map['sourceIpRangesToNat'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeBeta.fromValue(
                    value as String,
                  ),
            ),
    );
