...
class GetRouteComputeBetaResult {
  ...
  /// Creates a new [GetRouteComputeBetaResult].
  /// [asPaths] AS path.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asPaths': pulumi.Input.encodeList<RouteAsPathResponseComputeBeta, Map<String, dynamic>>(asPaths, (value) => value.toMap()),
      ...
      'selfLink': selfLink,
      'tags': tags,
      'warnings': pulumi.Input.encodeList<RouteWarningsItemResponseComputeBeta, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }

  factory GetRouteComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRouteComputeBetaResult(
      asPaths: pulumi.Input.decodeList<RouteAsPathResponseComputeBeta>(map['asPaths'], (value) => RouteAsPathResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      warnings: pulumi.Input.decodeList<RouteWarningsItemResponseComputeBeta>(map['warnings'], (value) => RouteWarningsItemResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
