...
class FirewallArgs {
  ...
  FirewallArgs({
    List<FirewallAllowedItem>? allowed,
    List<FirewallDeniedItem>? denied,
    String? description,
    ...
    List<String>? targetTags,
      ...
      allowed = pulumi.Input.asOptionalInput<List<FirewallAllowedItem>>(allowed),
      denied = pulumi.Input.asOptionalInput<List<FirewallDeniedItem>>(denied),
      description = pulumi.Input.asOptionalInput<String>(description),
      destinationRanges = pulumi.Input.asOptionalInput<List<String>>(destinationRanges),
      direction = pulumi.Input.asOptionalInput<FirewallDirection>(direction),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowed': ?pulumi.Input.mapOptionalInputValue<List<FirewallAllowedItem>, List<Map<String, dynamic>>>(allowed, (value) => pulumi.Input.encodeList<FirewallAllowedItem, Map<String, dynamic>>(value, (value) => value.toMap())),
      'denied': ?pulumi.Input.mapOptionalInputValue<List<FirewallDeniedItem>, List<Map<String, dynamic>>>(denied, (value) => pulumi.Input.encodeList<FirewallDeniedItem, Map<String, dynamic>>(value, (value) => value.toMap())),
      'description': ?description,
      'destinationRanges': ?destinationRanges,
      'direction': ?pulumi.Input.mapOptionalInputValue<FirewallDirection, String>(direction, (value) => value.value),
      'disabled': ?disabled,
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allowed: map['allowed'] == null ? null : pulumi.Input.decodeList<FirewallAllowedItem>(map['allowed'], (value) => FirewallAllowedItem.fromMap((value as Map).cast<String, dynamic>())),
      denied: map['denied'] == null ? null : pulumi.Input.decodeList<FirewallDeniedItem>(map['denied'], (value) => FirewallDeniedItem.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      destinationRanges: map['destinationRanges'] == null ? null : (map['destinationRanges'] as List).cast<String>(),
      direction: map['direction'] == null ? null : FirewallDirection.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      enableLogging: map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      logConfig: map['logConfig'] == null ? null : FirewallLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
