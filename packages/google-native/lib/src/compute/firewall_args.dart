...
class FirewallArgs {
  ...
  FirewallArgs({
    ...
    List<String>? targetTags,
            ...
            pulumi.Input.asOptionalInput<List<FirewallAllowedItem>>(allowed),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (allowedValue != null) {
      map['allowed'] = pulumi.Input.mapOptionalInputValue<
              List<FirewallAllowedItem>, List<Map<String, dynamic>>>(
          allowedValue,
          (value) => pulumi.Input.encodeList<FirewallAllowedItem,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final deniedValue = denied;
    if (deniedValue != null) {
      map['denied'] = pulumi.Input.mapOptionalInputValue<
              List<FirewallDeniedItem>, List<Map<String, dynamic>>>(
          deniedValue,
          (value) =>
              pulumi.Input.encodeList<FirewallDeniedItem, Map<String, dynamic>>(
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      ...
      direction: map['direction'] == null
          ? null
          : FirewallDirection.fromValue(map['direction'] as String),
