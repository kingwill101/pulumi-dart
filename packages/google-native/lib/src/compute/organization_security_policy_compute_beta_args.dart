...
class OrganizationSecurityPolicyComputeBetaArgs {
  ...
  OrganizationSecurityPolicyComputeBetaArgs({
    ...
    List<SecurityPolicyUserDefinedFieldComputeBeta>? userDefinedFields,
      ...
      type = pulumi.Input.asOptionalInput<OrganizationSecurityPolicyTypeComputeBeta>(type),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<OrganizationSecurityPolicyTypeComputeBeta, String>(type, (value) => value.value),
  ...
  factory OrganizationSecurityPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSecurityPolicyComputeBetaArgs(
      ...
      type: map['type'] == null ? null : OrganizationSecurityPolicyTypeComputeBeta.fromValue(map['type'] as String),
