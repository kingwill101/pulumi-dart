...
class DurationResponseComputeV1 {
  ...
  /// Creates a new [DurationResponseComputeV1].
  ...
  DurationResponseComputeV1({required this.nanos, required this.seconds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'nanos': nanos, 'seconds': seconds};
  }

  factory DurationResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return DurationResponseComputeV1(
