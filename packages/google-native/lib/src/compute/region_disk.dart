...
class RegionDisk extends pulumi.CustomResource {
  ...
  RegionDisk(
    ...
    this.asyncPrimaryDisk = registerOutput<DiskAsyncReplicationResponse>(
      'asyncPrimaryDisk',
    );
    ...
    this.diskEncryptionKey = registerOutput<CustomerEncryptionKeyResponse>(
      'diskEncryptionKey',
    );
    ...
    this.resourceStatus = registerOutput<DiskResourceStatusResponse>(
      'resourceStatus',
    );
