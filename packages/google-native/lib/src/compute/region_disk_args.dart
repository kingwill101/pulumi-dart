...
class RegionDiskArgs {
  ...
  RegionDiskArgs({
    ...
    List<String>? userLicenses,
  }) : accessMode = pulumi.Input.asOptionalInput<RegionDiskAccessMode>(
         accessMode,
       ),
       architecture = pulumi.Input.asOptionalInput<RegionDiskArchitecture>(
         architecture,
       ),
       ...
       guestOsFeatures = pulumi.Input.asOptionalInput<List<GuestOsFeature>>(
         guestOsFeatures,
       ),
       ...
       storageType = pulumi.Input.asOptionalInput<RegionDiskStorageType>(
         storageType,
       ),
