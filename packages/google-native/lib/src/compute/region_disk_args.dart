...
import 'region_disk_access_mode.dart';
import 'region_disk_architecture.dart';
import 'region_disk_interface.dart';
import 'region_disk_storage_type.dart';

/// {@template pulumi_compute_alpha_region_disk_args_doc}
/// The set of arguments for RegionDisk.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_disk_args_doc}
class RegionDiskArgs {
  /// The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
  final pulumi.Input<RegionDiskAccessMode>? accessMode;
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final pulumi.Input<RegionDiskArchitecture>? architecture;
  ...
  final pulumi.Input<RegionDiskInterface>? interface;
  ...
  final pulumi.Input<RegionDiskStorageType>? storageType;
  ...
  RegionDiskArgs({
    RegionDiskAccessMode? accessMode,
    RegionDiskArchitecture? architecture,
    ...
    String? storagePool,
    RegionDiskStorageType? storageType,
    String? type,
    List<String>? userLicenses,
  }) :
      accessMode = pulumi.Input.asOptionalInput<RegionDiskAccessMode>(accessMode),
      architecture = pulumi.Input.asOptionalInput<RegionDiskArchitecture>(architecture),
      ...
      interface = pulumi.Input.asOptionalInput<RegionDiskInterface>(interface),
      ...
      storageType = pulumi.Input.asOptionalInput<RegionDiskStorageType>(storageType),
      type = pulumi.Input.asOptionalInput<String>(type),
      userLicenses = pulumi.Input.asOptionalInput<List<String>>(userLicenses);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessMode': ?pulumi.Input.mapOptionalInputValue<RegionDiskAccessMode, String>(accessMode, (value) => value.value),
      'architecture': ?pulumi.Input.mapOptionalInputValue<RegionDiskArchitecture, String>(architecture, (value) => value.value),
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<RegionDiskInterface, String>(interface, (value) => value.value),
      'labels': ?labels,
      ...
      'storageType': ?pulumi.Input.mapOptionalInputValue<RegionDiskStorageType, String>(storageType, (value) => value.value),
      'type': ?type,
  ...
  factory RegionDiskArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs(
      accessMode: map['accessMode'] == null ? null : RegionDiskAccessMode.fromValue(map['accessMode'] as String),
      architecture: map['architecture'] == null ? null : RegionDiskArchitecture.fromValue(map['architecture'] as String),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : DiskAsyncReplication.fromMap((map['asyncPrimaryDisk'] as Map).cast<String, dynamic>()),
      ...
      guestOsFeatures: map['guestOsFeatures'] == null ? null : pulumi.Input.decodeList<GuestOsFeature>(map['guestOsFeatures'], (value) => GuestOsFeature.fromMap((value as Map).cast<String, dynamic>())),
      interface: map['interface'] == null ? null : RegionDiskInterface.fromValue(map['interface'] as String),
      ...
      params: map['params'] == null ? null : DiskParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      storageType: map['storageType'] == null ? null : RegionDiskStorageType.fromValue(map['storageType'] as String),
