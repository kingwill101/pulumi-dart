...
class RegionDiskArgs {
  ...
  RegionDiskArgs({
    ...
    List<String>? userLicenses,
            ...
            pulumi.Input.asOptionalInput<RegionDiskAccessMode>(accessMode),
        architecture =
            pulumi.Input.asOptionalInput<RegionDiskArchitecture>(architecture),
        asyncPrimaryDisk = pulumi.Input.asOptionalInput<DiskAsyncReplication>(
            asyncPrimaryDisk),
        description = pulumi.Input.asOptionalInput<String>(description),
        diskEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKey>(
            diskEncryptionKey),
        ...
        guestOsFeatures =
            pulumi.Input.asOptionalInput<List<GuestOsFeature>>(guestOsFeatures),
        interface =
            pulumi.Input.asOptionalInput<RegionDiskInterface>(interface),
        ...
        storageType =
            pulumi.Input.asOptionalInput<RegionDiskStorageType>(storageType),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessModeValue != null) {
      map['accessMode'] =
          pulumi.Input.mapOptionalInputValue<RegionDiskAccessMode, String>(
              accessModeValue, (value) => value.value);
    }
    final architectureValue = architecture;
    if (architectureValue != null) {
      map['architecture'] =
          pulumi.Input.mapOptionalInputValue<RegionDiskArchitecture, String>(
    ...
    if (asyncPrimaryDiskValue != null) {
      map['asyncPrimaryDisk'] = pulumi.Input.mapOptionalInputValue<
              DiskAsyncReplication, Map<String, dynamic>>(
    ...
    if (guestOsFeaturesValue != null) {
      map['guestOsFeatures'] = pulumi.Input.mapOptionalInputValue<
              List<GuestOsFeature>, List<Map<String, dynamic>>>(
    ...
    if (interfaceValue != null) {
      map['interface'] =
          pulumi.Input.mapOptionalInputValue<RegionDiskInterface, String>(
    ...
    if (paramsValue != null) {
      map['params'] =
          pulumi.Input.mapOptionalInputValue<DiskParams, Map<String, dynamic>>(
    ...
    if (storageTypeValue != null) {
      map['storageType'] =
          pulumi.Input.mapOptionalInputValue<RegionDiskStorageType, String>(
  ...
  factory RegionDiskArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs(
      accessMode: map['accessMode'] == null
          ? null
          : RegionDiskAccessMode.fromValue(map['accessMode'] as String),
      architecture: map['architecture'] == null
          ? null
          : RegionDiskArchitecture.fromValue(map['architecture'] as String),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null
          ? null
          : DiskAsyncReplication.fromMap(
      ...
      interface: map['interface'] == null
          ? null
          : RegionDiskInterface.fromValue(map['interface'] as String),
      ...
      params: map['params'] == null
          ? null
          : DiskParams.fromMap((map['params'] as Map).cast<String, dynamic>()),
      ...
      storageType: map['storageType'] == null
          ? null
          : RegionDiskStorageType.fromValue(map['storageType'] as String),
