...
class AddressComputeV1Args {
  ...
  AddressComputeV1Args({
    ...
    String? subnetwork,
        ...
        ipVersion =
            pulumi.Input.asOptionalInput<AddressIpVersionComputeV1>(ipVersion),
        ipv6EndpointType =
        ...
        purpose =
            pulumi.Input.asOptionalInput<AddressPurposeComputeV1>(purpose),
  ...
  factory AddressComputeV1Args.fromMap(Map<String, dynamic> map) {
    return AddressComputeV1Args(
      ...
      addressType: map['addressType'] == null
          ? null
          : AddressAddressTypeComputeV1.fromValue(map['addressType'] as String),
      description:
          map['description'] == null ? null : map['description'] as String,
      ipVersion: map['ipVersion'] == null
          ? null
          : AddressIpVersionComputeV1.fromValue(map['ipVersion'] as String),
      ipv6EndpointType: map['ipv6EndpointType'] == null
          ? null
          : AddressIpv6EndpointTypeComputeV1.fromValue(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : AddressNetworkTierComputeV1.fromValue(map['networkTier'] as String),
      prefixLength:
          map['prefixLength'] == null ? null : map['prefixLength'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null
          ? null
          : AddressPurposeComputeV1.fromValue(map['purpose'] as String),
