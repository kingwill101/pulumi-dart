...
class AddressComputeV1Args {
  ...
  AddressComputeV1Args({
    String? address,
    AddressAddressTypeComputeV1? addressType,
    String? description,
    AddressIpVersionComputeV1? ipVersion,
    AddressIpv6EndpointTypeComputeV1? ipv6EndpointType,
    Map<String, String>? labels,
    String? name,
    String? network,
    AddressNetworkTierComputeV1? networkTier,
    int? prefixLength,
    String? project,
    AddressPurposeComputeV1? purpose,
  ...
  factory AddressComputeV1Args.fromMap(Map<String, dynamic> map) {
    return AddressComputeV1Args(
      ...
      addressType: map['addressType'] == null ? null : AddressAddressTypeComputeV1.fromValue(map['addressType'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      ipVersion: map['ipVersion'] == null ? null : AddressIpVersionComputeV1.fromValue(map['ipVersion'] as String),
      ipv6EndpointType: map['ipv6EndpointType'] == null ? null : AddressIpv6EndpointTypeComputeV1.fromValue(map['ipv6EndpointType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkTier: map['networkTier'] == null ? null : AddressNetworkTierComputeV1.fromValue(map['networkTier'] as String),
      prefixLength: map['prefixLength'] == null ? null : map['prefixLength'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      purpose: map['purpose'] == null ? null : AddressPurposeComputeV1.fromValue(map['purpose'] as String),
