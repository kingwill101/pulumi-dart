...
class PublicAdvertisedPrefix extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PublicAdvertisedPrefixPublicDelegatedPrefixResponse>> publicDelegatedPrefixs;
  ...
  /// [args] Arguments used to configure this [PublicAdvertisedPrefix]. {@macro pulumi_compute_alpha_public_advertised_prefix_args_doc}
  ...
  PublicAdvertisedPrefix(
    ...
    this.publicDelegatedPrefixs = registerOutput<List<PublicAdvertisedPrefixPublicDelegatedPrefixResponse>>('publicDelegatedPrefixs');
