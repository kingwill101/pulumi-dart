...
class ReservationResource extends pulumi.CustomResource {
  ...
  ReservationResource(
    ...
    this.aggregateReservation = registerOutput<AllocationAggregateReservationResponseComputeBeta>('aggregateReservation');
    this.commitment = registerOutput<String>('commitment');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.deleteAfterDuration = registerOutput<DurationResponseComputeBeta>('deleteAfterDuration');
    ...
    this.resourcePolicies = registerOutput<Map<String, String>>('resourcePolicies');
    this.resourceStatus = registerOutput<AllocationResourceStatusResponseComputeBeta>('resourceStatus');
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.selfLink = registerOutput<String>('selfLink');
    this.shareSettings = registerOutput<ShareSettingsResponseComputeBeta>('shareSettings');
    this.specificReservation = registerOutput<AllocationSpecificSKUReservationResponseComputeBeta>('specificReservation');
