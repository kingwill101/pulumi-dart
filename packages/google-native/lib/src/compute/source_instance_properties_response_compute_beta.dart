...
class SourceInstancePropertiesResponseComputeBeta {
  ...
  final List<SavedAttachedDiskResponseComputeBeta> disks;
  ...
  SourceInstancePropertiesResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['disks'] = pulumi.Input.encodeList<SavedAttachedDiskResponseComputeBeta,
  ...
  factory SourceInstancePropertiesResponseComputeBeta.fromMap(
      Map<String, dynamic> map) {
    return SourceInstancePropertiesResponseComputeBeta(
      canIpForward: map['canIpForward'] as bool,
      deletionProtection: map['deletionProtection'] as bool,
      description: map['description'] as String,
      disks: pulumi.Input.decodeList<SavedAttachedDiskResponseComputeBeta>(
          map['disks'],
          (value) => SavedAttachedDiskResponseComputeBeta.fromMap(
