...
class AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta {
  ...
  final String utilizationTargetType;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['filter'] = filter;
    map['metric'] = metric;
    map['singleInstanceAssignment'] = singleInstanceAssignment;
    map['utilizationTarget'] = utilizationTarget;
    map['utilizationTargetType'] = utilizationTargetType;
    return map;
  }

  factory AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta.fromMap(
    ...
    return AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta(
      ...
      utilizationTargetType: map['utilizationTargetType'] as String,
    );
  }
}
