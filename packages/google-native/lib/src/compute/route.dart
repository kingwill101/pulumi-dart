...
class Route extends pulumi.CustomResource {
  ...
  Route(String name, {RouteArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.allowConflictingSubnetworks = registerOutput<bool>(
    ...
    this.ilbRouteBehaviorOnUnhealthy = registerOutput<String>(
    ...
    this.nextHopInterconnectAttachment = registerOutput<String>(
