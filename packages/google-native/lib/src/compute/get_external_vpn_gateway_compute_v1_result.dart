...
class GetExternalVpnGatewayComputeV1Result {
  ...
  factory GetExternalVpnGatewayComputeV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetExternalVpnGatewayComputeV1Result(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      interfaces:
          pulumi.Input.decodeList<ExternalVpnGatewayInterfaceResponseComputeV1>(
              map['interfaces'],
              (value) => ExternalVpnGatewayInterfaceResponseComputeV1.fromMap(
