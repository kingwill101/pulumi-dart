...
class RuleResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action,
      'conditions': pulumi.Input.encodeList<ConditionResponseComputeBeta, Map<String, dynamic>>(conditions, (value) => value.toMap()),
      'description': description,
      'ins': ins,
      'logConfigs': pulumi.Input.encodeList<LogConfigResponseComputeBeta, Map<String, dynamic>>(logConfigs, (value) => value.toMap()),
      'notIns': notIns,
  ...
  factory RuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RuleResponseComputeBeta(
      ...
      conditions: pulumi.Input.decodeList<ConditionResponseComputeBeta>(map['conditions'], (value) => ConditionResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] as String,
      ins: (map['ins'] as List).cast<String>(),
      logConfigs: pulumi.Input.decodeList<LogConfigResponseComputeBeta>(map['logConfigs'], (value) => LogConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
