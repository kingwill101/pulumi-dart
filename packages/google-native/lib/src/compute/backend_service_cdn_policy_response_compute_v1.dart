...
class BackendServiceCdnPolicyResponseComputeV1 {
  ...
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1> bypassCacheOnRequestHeaders;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1> negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1, Map<String, dynamic>>(bypassCacheOnRequestHeaders, (value) => value.toMap()),
      ...
      'negativeCachingPolicy': pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1, Map<String, dynamic>>(negativeCachingPolicy, (value) => value.toMap()),
  ...
  factory BackendServiceCdnPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponseComputeV1(
      bypassCacheOnRequestHeaders: pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: CacheKeyPolicyResponseComputeV1.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      ...
      negativeCachingPolicy: pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
