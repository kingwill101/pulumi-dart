...
class InstanceGroupManagerUpdatePolicyResponseComputeV1 {
  ...
  final FixedOrPercentResponseComputeV1 maxSurge;
  ...
  final FixedOrPercentResponseComputeV1 maxUnavailable;
  ...
  InstanceGroupManagerUpdatePolicyResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['instanceRedistributionType'] = instanceRedistributionType;
    map['maxSurge'] = maxSurge.toMap();
    map['maxUnavailable'] = maxUnavailable.toMap();
  ...
  factory InstanceGroupManagerUpdatePolicyResponseComputeV1.fromMap(
    ...
    return InstanceGroupManagerUpdatePolicyResponseComputeV1(
      ...
      maxSurge: FixedOrPercentResponseComputeV1.fromMap(
          (map['maxSurge'] as Map).cast<String, dynamic>()),
      maxUnavailable: FixedOrPercentResponseComputeV1.fromMap(
