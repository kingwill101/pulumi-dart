...
import 'disk_instantiation_config_instantiate_from_compute_v1.dart';
...
class DiskInstantiationConfigComputeV1 {
  ...
  final DiskInstantiationConfigInstantiateFromComputeV1? instantiateFrom;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instantiateFrom': ?instantiateFrom == null ? null : instantiateFrom!.value,
    };
  }
  ...
  factory DiskInstantiationConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfigComputeV1(
      ...
      customImage: map['customImage'] == null ? null : map['customImage'] as String,
      deviceName: map['deviceName'] == null ? null : map['deviceName'] as String,
      instantiateFrom: map['instantiateFrom'] == null ? null : DiskInstantiationConfigInstantiateFromComputeV1.fromValue(map['instantiateFrom'] as String),
    );
  }
}
