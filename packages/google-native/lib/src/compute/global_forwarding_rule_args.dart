...
import 'global_forwarding_rule_ip_protocol.dart';
import 'global_forwarding_rule_ip_version.dart';
import 'global_forwarding_rule_load_balancing_scheme.dart';
import 'global_forwarding_rule_network_tier.dart';
import 'global_forwarding_rule_psc_connection_status.dart';
import 'metadata_filter.dart';

/// {@template pulumi_compute_alpha_global_forwarding_rule_args_doc}
/// The set of arguments for GlobalForwardingRule.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_global_forwarding_rule_args_doc}
class GlobalForwardingRuleArgs {
  ...
  final pulumi.Input<GlobalForwardingRuleIpProtocol>? ipProtocol;
  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final pulumi.Input<GlobalForwardingRuleIpVersion>? ipVersion;
  ...
  final pulumi.Input<GlobalForwardingRuleLoadBalancingScheme>? loadBalancingScheme;
  ...
  final pulumi.Input<List<MetadataFilter>>? metadataFilters;
  ...
  final pulumi.Input<GlobalForwardingRuleNetworkTier>? networkTier;
  ...
  final pulumi.Input<GlobalForwardingRulePscConnectionStatus>? pscConnectionStatus;
  ...
  final pulumi.Input<List<ForwardingRuleServiceDirectoryRegistration>>? serviceDirectoryRegistrations;
  ...
  GlobalForwardingRuleArgs({
    ...
    String? ipAddress,
    String? ipCollection,
    GlobalForwardingRuleIpProtocol? ipProtocol,
    GlobalForwardingRuleIpVersion? ipVersion,
    bool? isMirroringCollector,
    Map<String, String>? labels,
    GlobalForwardingRuleLoadBalancingScheme? loadBalancingScheme,
    List<MetadataFilter>? metadataFilters,
    String? name,
    String? network,
    GlobalForwardingRuleNetworkTier? networkTier,
    bool? noAutomateDnsZone,
    String? portRange,
    List<String>? ports,
    String? project,
    GlobalForwardingRulePscConnectionStatus? pscConnectionStatus,
    String? requestId,
    ...
    String? target,
      ...
      ipProtocol = pulumi.Input.asOptionalInput<GlobalForwardingRuleIpProtocol>(ipProtocol),
      ipVersion = pulumi.Input.asOptionalInput<GlobalForwardingRuleIpVersion>(ipVersion),
      isMirroringCollector = pulumi.Input.asOptionalInput<bool>(isMirroringCollector),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      loadBalancingScheme = pulumi.Input.asOptionalInput<GlobalForwardingRuleLoadBalancingScheme>(loadBalancingScheme),
      metadataFilters = pulumi.Input.asOptionalInput<List<MetadataFilter>>(metadataFilters),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<GlobalForwardingRuleNetworkTier>(networkTier),
      ...
      pscConnectionStatus = pulumi.Input.asOptionalInput<GlobalForwardingRulePscConnectionStatus>(pscConnectionStatus),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      serviceDirectoryRegistrations = pulumi.Input.asOptionalInput<List<ForwardingRuleServiceDirectoryRegistration>>(serviceDirectoryRegistrations),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleIpProtocol, String>(ipProtocol, (value) => value.value),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleIpVersion, String>(ipVersion, (value) => value.value),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.value),
      'metadataFilters': ?pulumi.Input.mapOptionalInputValue<List<MetadataFilter>, List<Map<String, dynamic>>>(metadataFilters, (value) => pulumi.Input.encodeList<MetadataFilter, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleNetworkTier, String>(networkTier, (value) => value.value),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRulePscConnectionStatus, String>(pscConnectionStatus, (value) => value.value),
      'requestId': ?requestId,
      'serviceDirectoryRegistrations': ?pulumi.Input.mapOptionalInputValue<List<ForwardingRuleServiceDirectoryRegistration>, List<Map<String, dynamic>>>(serviceDirectoryRegistrations, (value) => pulumi.Input.encodeList<ForwardingRuleServiceDirectoryRegistration, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GlobalForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleArgs(
      ...
      ipCollection: map['ipCollection'] == null ? null : map['ipCollection'] as String,
      ipProtocol: map['ipProtocol'] == null ? null : GlobalForwardingRuleIpProtocol.fromValue(map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null ? null : GlobalForwardingRuleIpVersion.fromValue(map['ipVersion'] as String),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : map['isMirroringCollector'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : GlobalForwardingRuleLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String),
      metadataFilters: map['metadataFilters'] == null ? null : pulumi.Input.decodeList<MetadataFilter>(map['metadataFilters'], (value) => MetadataFilter.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkTier: map['networkTier'] == null ? null : GlobalForwardingRuleNetworkTier.fromValue(map['networkTier'] as String),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : GlobalForwardingRulePscConnectionStatus.fromValue(map['pscConnectionStatus'] as String),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistration>(map['serviceDirectoryRegistrations'], (value) => ForwardingRuleServiceDirectoryRegistration.fromMap((value as Map).cast<String, dynamic>())),
