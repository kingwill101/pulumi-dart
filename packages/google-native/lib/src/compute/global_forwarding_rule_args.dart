...
class GlobalForwardingRuleArgs {
  ...
  GlobalForwardingRuleArgs({
    ...
    String? target,
       ...
       ipProtocol = pulumi
           .Input.asOptionalInput<GlobalForwardingRuleIpProtocol>(ipProtocol),
       ...
       loadBalancingScheme =
           ...
           >(loadBalancingScheme),
       metadataFilters = pulumi.Input.asOptionalInput<List<MetadataFilter>>(
         metadataFilters,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       network = pulumi.Input.asOptionalInput<String>(network),
       networkTier = pulumi
           .Input.asOptionalInput<GlobalForwardingRuleNetworkTier>(networkTier),
