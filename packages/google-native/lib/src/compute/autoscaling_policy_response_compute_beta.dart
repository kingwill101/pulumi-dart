...
class AutoscalingPolicyResponseComputeBeta {
  ...
  final List<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta> customMetricUtilizations;
  /// Configuration parameters of autoscaling based on load balancer.
  final AutoscalingPolicyLoadBalancingUtilizationResponseComputeBeta loadBalancingUtilization;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetricUtilizations': pulumi.Input.encodeList<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta, Map<String, dynamic>>(customMetricUtilizations, (value) => value.toMap()),
  ...
  factory AutoscalingPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyResponseComputeBeta(
      ...
      cpuUtilization: AutoscalingPolicyCpuUtilizationResponseComputeBeta.fromMap((map['cpuUtilization'] as Map).cast<String, dynamic>()),
      customMetricUtilizations: pulumi.Input.decodeList<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta>(map['customMetricUtilizations'], (value) => AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      loadBalancingUtilization: AutoscalingPolicyLoadBalancingUtilizationResponseComputeBeta.fromMap((map['loadBalancingUtilization'] as Map).cast<String, dynamic>()),
      maxNumReplicas: map['maxNumReplicas'] as int,
      minNumReplicas: map['minNumReplicas'] as int,
      mode: map['mode'] as String,
      scaleDownControl: AutoscalingPolicyScaleDownControlResponseComputeBeta.fromMap((map['scaleDownControl'] as Map).cast<String, dynamic>()),
      scaleInControl: AutoscalingPolicyScaleInControlResponseComputeBeta.fromMap((map['scaleInControl'] as Map).cast<String, dynamic>()),
