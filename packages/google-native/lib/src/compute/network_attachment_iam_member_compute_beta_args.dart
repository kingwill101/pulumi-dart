...
/// {@template pulumi_compute_beta_network_attachment_iam_member_compute_beta_args_doc}
/// The set of arguments for NetworkAttachmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_network_attachment_iam_member_compute_beta_args_doc}
class NetworkAttachmentIamMemberComputeBetaArgs {
  ...
  /// Creates a new [NetworkAttachmentIamMemberComputeBetaArgs].
  ...
  NetworkAttachmentIamMemberComputeBetaArgs({
    Condition? condition,
  ...
  factory NetworkAttachmentIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamMemberComputeBetaArgs(
