...
import 'interconnect_attachment_compute_beta_args.dart';
...
class InterconnectAttachmentComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<String>> candidateIpv6Subnets;
  ...
  /// This field is not available.
  late final pulumi.Output<String> cloudRouterIpv6InterfaceId;
  ...
  /// This field is not available.
  late final pulumi.Output<String> customerRouterIpv6InterfaceId;
  ...
  late final pulumi.Output<int> dataplaneVersion;
  ...
  late final pulumi.Output<InterconnectAttachmentPrivateInfoResponseComputeBeta>
  ...
  late final pulumi.Output<String> remoteService;
  ...
  /// Creates a new [InterconnectAttachmentComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InterconnectAttachmentComputeBeta]. {@macro pulumi_compute_beta_interconnect_attachment_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InterconnectAttachmentComputeBeta(
    String name, {
    InterconnectAttachmentComputeBetaArgs? args,
    ...
    this.candidateIpv6Subnets = registerOutput<List<String>>(
    ...
    this.cloudRouterIpv6Address = registerOutput<String>(
      'cloudRouterIpv6Address',
    );
    this.cloudRouterIpv6InterfaceId = registerOutput<String>(
    ...
    this.customerRouterIpAddress = registerOutput<String>(
      'customerRouterIpAddress',
    );
    this.customerRouterIpv6Address = registerOutput<String>(
      'customerRouterIpv6Address',
    );
    this.customerRouterIpv6InterfaceId = registerOutput<String>(
      'customerRouterIpv6InterfaceId',
    );
    this.dataplaneVersion = registerOutput<int>('dataplaneVersion');
    this.description = registerOutput<String>('description');
    this.edgeAvailabilityDomain = registerOutput<String>(
    ...
    this.ipsecInternalAddresses = registerOutput<List<String>>(
    ...
    this.privateInterconnectInfo =
        registerOutput<InterconnectAttachmentPrivateInfoResponseComputeBeta>(
          'privateInterconnectInfo',
        );
