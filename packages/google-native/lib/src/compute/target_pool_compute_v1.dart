...
import 'target_pool_compute_v1_args.dart';

/// Creates a target pool in the specified project and region using the data included in the request.
class TargetPoolComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetPoolComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetPoolComputeV1]. {@macro pulumi_compute_v1_target_pool_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetPoolComputeV1(
    String name, {
    TargetPoolComputeV1Args? args,
