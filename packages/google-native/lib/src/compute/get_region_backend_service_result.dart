...
class GetRegionBackendServiceResult {
  ...
  final List<BackendServiceLocalityLoadBalancingPolicyConfigResponse>
      localityLbPolicies;
  ...
  factory GetRegionBackendServiceResult.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceResult(
      ...
      cdnPolicy: BackendServiceCdnPolicyResponse.fromMap(
          (map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: CircuitBreakersResponse.fromMap(
          (map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] as String,
      connectionDraining: ConnectionDrainingResponse.fromMap(
          (map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy:
          BackendServiceConnectionTrackingPolicyResponse.fromMap(
              (map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: ConsistentHashLoadBalancerSettingsResponse.fromMap(
      ...
      localityLbPolicies: pulumi.Input.decodeList<
          ...
          (value) =>
              BackendServiceLocalityLoadBalancingPolicyConfigResponse.fromMap(
                  (value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] as String,
      logConfig: BackendServiceLogConfigResponse.fromMap(
      ...
      outlierDetection: OutlierDetectionResponse.fromMap(
      ...
      securitySettings: SecuritySettingsResponse.fromMap(
