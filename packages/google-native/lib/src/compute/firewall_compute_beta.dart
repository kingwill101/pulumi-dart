...
class FirewallComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FirewallAllowedItemResponseComputeBeta>> allowed;
  /// Creation timestamp in RFC3339 text format.
  late final pulumi.Output<String> creationTimestamp;
  /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
  late final pulumi.Output<List<FirewallDeniedItemResponseComputeBeta>> denied;
  ...
  FirewallComputeBeta(
    ...
    this.allowed = registerOutput<List<FirewallAllowedItemResponseComputeBeta>>('allowed');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.denied = registerOutput<List<FirewallDeniedItemResponseComputeBeta>>('denied');
    ...
    this.logConfig = registerOutput<FirewallLogConfigResponseComputeBeta>('logConfig');
