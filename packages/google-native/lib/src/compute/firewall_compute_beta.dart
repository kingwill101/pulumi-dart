...
class FirewallComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FirewallAllowedItemResponseComputeBeta>>
  allowed;
  ...
  FirewallComputeBeta(
    ...
    this.allowed = registerOutput<List<FirewallAllowedItemResponseComputeBeta>>(
      'allowed',
    );
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.denied = registerOutput<List<FirewallDeniedItemResponseComputeBeta>>(
      'denied',
    );
    ...
    this.logConfig = registerOutput<FirewallLogConfigResponseComputeBeta>(
      'logConfig',
    );
