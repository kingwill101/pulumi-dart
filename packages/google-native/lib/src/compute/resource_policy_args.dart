...
class ResourcePolicyArgs {
  ...
  ResourcePolicyArgs({
    ...
    ResourcePolicyVmMaintenancePolicy? vmMaintenancePolicy,
  }) :
  ...
  factory ResourcePolicyArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyArgs(
      ...
      vmMaintenancePolicy: map['vmMaintenancePolicy'] == null ? null : ResourcePolicyVmMaintenancePolicy.fromMap((map['vmMaintenancePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
