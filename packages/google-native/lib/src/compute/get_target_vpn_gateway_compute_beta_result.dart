...
class GetTargetVpnGatewayComputeBetaResult {
  ...
  /// Creates a new [GetTargetVpnGatewayComputeBetaResult].
  ...
  GetTargetVpnGatewayComputeBetaResult({
  ...
  factory GetTargetVpnGatewayComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetTargetVpnGatewayComputeBetaResult(
