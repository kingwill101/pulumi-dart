...
class GetTargetPoolComputeBetaResult {
  ...
  /// Creates a new [GetTargetPoolComputeBetaResult].
  ...
  factory GetTargetPoolComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetTargetPoolComputeBetaResult(
