...
class GetNetworkComputeBetaResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['peerings'] = pulumi.Input.encodeList<NetworkPeeringResponseComputeBeta,
  ...
  factory GetNetworkComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkComputeBetaResult(
      ...
      peerings: pulumi.Input.decodeList<NetworkPeeringResponseComputeBeta>(
          map['peerings'],
          (value) => NetworkPeeringResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
      routingConfig: NetworkRoutingConfigResponseComputeBeta.fromMap(
