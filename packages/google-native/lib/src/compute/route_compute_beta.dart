...
import 'route_compute_beta_args.dart';
import 'route_warnings_item_response_compute_beta.dart';

/// Creates a Route resource in the specified project using the data included in the request.
class RouteComputeBeta extends pulumi.CustomResource {
  /// AS path.
  late final pulumi.Output<List<RouteAsPathResponseComputeBeta>> asPaths;
  ...
  late final pulumi.Output<List<RouteWarningsItemResponseComputeBeta>> warnings;

  /// Creates a new [RouteComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RouteComputeBeta]. {@macro pulumi_compute_beta_route_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RouteComputeBeta(
    String name, {
    RouteComputeBetaArgs? args,
    ...
    this.asPaths = registerOutput<List<RouteAsPathResponseComputeBeta>>('asPaths');
    ...
    this.warnings = registerOutput<List<RouteWarningsItemResponseComputeBeta>>('warnings');
  }
}
