...
class FirewallPolicyRuleMatcherResponseComputeBeta {
  ...
  final List<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta> layer4Configs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta, Map<String, dynamic>>(layer4Configs, (value) => value.toMap()),
      'srcAddressGroups': srcAddressGroups,
      'srcFqdns': srcFqdns,
      'srcIpRanges': srcIpRanges,
      'srcRegionCodes': srcRegionCodes,
      'srcSecureTags': pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponseComputeBeta, Map<String, dynamic>>(srcSecureTags, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherResponseComputeBeta(
      ...
      layer4Configs: pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta>(map['layer4Configs'], (value) => FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeBeta>(map['srcSecureTags'], (value) => FirewallPolicyRuleSecureTagResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
