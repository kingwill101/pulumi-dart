...
class RouterBgpPeerResponseComputeBeta {
  ...
  final List<RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta> customLearnedIpRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advertisedIpRanges': pulumi.Input.encodeList<RouterAdvertisedIpRangeResponseComputeBeta, Map<String, dynamic>>(advertisedIpRanges, (value) => value.toMap()),
      'advertisedRoutePriority': advertisedRoutePriority,
      'bfd': bfd.toMap(),
      'customLearnedIpRanges': pulumi.Input.encodeList<RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta, Map<String, dynamic>>(customLearnedIpRanges, (value) => value.toMap()),
  ...
  factory RouterBgpPeerResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponseComputeBeta(
      ...
      advertisedIpRanges: pulumi.Input.decodeList<RouterAdvertisedIpRangeResponseComputeBeta>(map['advertisedIpRanges'], (value) => RouterAdvertisedIpRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      advertisedRoutePriority: map['advertisedRoutePriority'] as int,
      bfd: RouterBgpPeerBfdResponseComputeBeta.fromMap((map['bfd'] as Map).cast<String, dynamic>()),
      customLearnedIpRanges: pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta>(map['customLearnedIpRanges'], (value) => RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
