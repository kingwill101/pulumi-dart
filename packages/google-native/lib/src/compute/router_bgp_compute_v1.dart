...
class RouterBgpComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advertisedGroups': ?advertisedGroups == null ? null : pulumi.Input.encodeList<RouterBgpAdvertisedGroupsItemComputeV1, String>(advertisedGroups!, (value) => value.value),
  ...
  factory RouterBgpComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpComputeV1(
      advertiseMode: map['advertiseMode'] == null ? null : RouterBgpAdvertiseModeComputeV1.fromValue(map['advertiseMode'] as String),
      advertisedGroups: map['advertisedGroups'] == null ? null : pulumi.Input.decodeList<RouterBgpAdvertisedGroupsItemComputeV1>(map['advertisedGroups'], (value) => RouterBgpAdvertisedGroupsItemComputeV1.fromValue(value as String)),
