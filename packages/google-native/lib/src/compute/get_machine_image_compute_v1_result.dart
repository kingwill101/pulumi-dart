...
class GetMachineImageComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['savedDisks'] = pulumi.Input.encodeList<SavedDiskResponseComputeV1,
        Map<String, dynamic>>(savedDisks, (value) => value.toMap());
    map['selfLink'] = selfLink;
    map['sourceDiskEncryptionKeys'] = pulumi.Input.encodeList<
            SourceDiskEncryptionKeyResponseComputeV1, Map<String, dynamic>>(
  ...
  factory GetMachineImageComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetMachineImageComputeV1Result(
      ...
      instanceProperties: InstancePropertiesResponseComputeV1.fromMap(
          (map['instanceProperties'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      machineImageEncryptionKey: CustomerEncryptionKeyResponseComputeV1.fromMap(
          (map['machineImageEncryptionKey'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      savedDisks: pulumi.Input.decodeList<SavedDiskResponseComputeV1>(
          map['savedDisks'],
          (value) => SavedDiskResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] as String,
      sourceDiskEncryptionKeys:
          pulumi.Input.decodeList<SourceDiskEncryptionKeyResponseComputeV1>(
              map['sourceDiskEncryptionKeys'],
              (value) => SourceDiskEncryptionKeyResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceProperties:
          SourceInstancePropertiesResponseComputeV1.fromMap(
