...
class SecurityPolicyRuleRateLimitOptionsResponseComputeV1 {
  ...
  final SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1 banThreshold;
  ...
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1> enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRedirectOptionsResponseComputeV1 exceedRedirectOptions;
  /// Threshold at which to begin ratelimiting.
  final SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1 rateLimitThreshold;

  /// Creates a new [SecurityPolicyRuleRateLimitOptionsResponseComputeV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'banThreshold': banThreshold.toMap(),
      'conformAction': conformAction,
      'enforceOnKey': enforceOnKey,
      'enforceOnKeyConfigs': pulumi.Input.encodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1, Map<String, dynamic>>(enforceOnKeyConfigs, (value) => value.toMap()),
      'enforceOnKeyName': enforceOnKeyName,
      'exceedAction': exceedAction,
      'exceedRedirectOptions': exceedRedirectOptions.toMap(),
      'rateLimitThreshold': rateLimitThreshold.toMap(),
    };
  }

  factory SecurityPolicyRuleRateLimitOptionsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponseComputeV1(
      banDurationSec: map['banDurationSec'] as int,
      banThreshold: SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1.fromMap((map['banThreshold'] as Map).cast<String, dynamic>()),
      conformAction: map['conformAction'] as String,
      enforceOnKey: map['enforceOnKey'] as String,
      enforceOnKeyConfigs: pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      enforceOnKeyName: map['enforceOnKeyName'] as String,
      exceedAction: map['exceedAction'] as String,
      exceedRedirectOptions: SecurityPolicyRuleRedirectOptionsResponseComputeV1.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>()),
      rateLimitThreshold: SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>()),
    );
  }
}
