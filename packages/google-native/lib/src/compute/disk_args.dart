...
class DiskArgs {
  ...
  DiskArgs({
    ...
    String? zone,
       ...
       architecture = pulumi.Input.asOptionalInput<DiskArchitecture>(
         architecture,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessMode': ?pulumi.Input.mapOptionalInputValue<DiskAccessMode, String>(
        accessMode,
        (value) => value.value,
      ),
      'architecture':
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<DiskInterface, String>(
        interface,
        (value) => value.value,
      ),
      'labels': ?labels,
