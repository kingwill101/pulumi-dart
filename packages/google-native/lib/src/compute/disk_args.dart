...
class DiskArgs {
  ...
  DiskArgs({
    ...
    String? zone,
        ...
        architecture =
            pulumi.Input.asOptionalInput<DiskArchitecture>(architecture),
        ...
        storageType =
            pulumi.Input.asOptionalInput<DiskStorageType>(storageType),
  ...
  factory DiskArgs.fromMap(Map<String, dynamic> map) {
    return DiskArgs(
      accessMode: map['accessMode'] == null
          ? null
          : DiskAccessMode.fromValue(map['accessMode'] as String),
      architecture: map['architecture'] == null
          ? null
          : DiskArchitecture.fromValue(map['architecture'] as String),
      ...
      interface: map['interface'] == null
          ? null
          : DiskInterface.fromValue(map['interface'] as String),
      ...
      storageType: map['storageType'] == null
          ? null
          : DiskStorageType.fromValue(map['storageType'] as String),
