...
class RouterBgpPeerBfdComputeBeta {
  ...
  final RouterBgpPeerBfdSessionInitializationModeComputeBeta? sessionInitializationMode;
  ...
  factory RouterBgpPeerBfdComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfdComputeBeta(
      ...
      sessionInitializationMode: map['sessionInitializationMode'] == null ? null : RouterBgpPeerBfdSessionInitializationModeComputeBeta.fromValue(map['sessionInitializationMode'] as String),
    );
  }
}
