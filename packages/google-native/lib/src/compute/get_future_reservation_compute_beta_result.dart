...
class GetFutureReservationComputeBetaResult {
  ...
  final DurationResponseComputeBeta autoCreatedReservationsDuration;
  ...
  final FutureReservationStatusResponseComputeBeta status;
  ...
  /// Creates a new [GetFutureReservationComputeBetaResult].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['autoCreatedReservationsDuration'] =
        autoCreatedReservationsDuration.toMap();
    ...
    map['planningStatus'] = planningStatus;
  ...
  factory GetFutureReservationComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetFutureReservationComputeBetaResult(
      autoCreatedReservationsDeleteTime:
          map['autoCreatedReservationsDeleteTime'] as String,
      autoCreatedReservationsDuration: DurationResponseComputeBeta.fromMap(
          (map['autoCreatedReservationsDuration'] as Map)
              .cast<String, dynamic>()),
      autoDeleteAutoCreatedReservations:
      ...
      status: FutureReservationStatusResponseComputeBeta.fromMap(
