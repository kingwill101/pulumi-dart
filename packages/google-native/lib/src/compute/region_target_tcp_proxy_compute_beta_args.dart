...
class RegionTargetTcpProxyComputeBetaArgs {
  ...
  RegionTargetTcpProxyComputeBetaArgs({
    ...
    String? project,
    bool? proxyBind,
    RegionTargetTcpProxyProxyHeaderComputeBeta? proxyHeader,
  ...
  factory RegionTargetTcpProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyComputeBetaArgs(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : RegionTargetTcpProxyProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String),
