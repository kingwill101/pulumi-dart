...
class UrlMapTestResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': pulumi.Input.encodeList<UrlMapTestHeaderResponse, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'host': host,
      'path': path,
      'service': service,
    };
  ...
  factory UrlMapTestResponse.fromMap(Map<String, dynamic> map) {
    return UrlMapTestResponse(
      ...
      headers: pulumi.Input.decodeList<UrlMapTestHeaderResponse>(map['headers'], (value) => UrlMapTestHeaderResponse.fromMap((value as Map).cast<String, dynamic>())),
