...
/// {@template pulumi_compute_alpha_region_url_map_args_doc}
/// The set of arguments for RegionUrlMap.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_url_map_args_doc}
class RegionUrlMapArgs {
  ...
  factory RegionUrlMapArgs.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapArgs(
      ...
      hostRules: map['hostRules'] == null ? null : pulumi.Input.decodeList<HostRule>(map['hostRules'], (value) => HostRule.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      pathMatchers: map['pathMatchers'] == null ? null : pulumi.Input.decodeList<PathMatcher>(map['pathMatchers'], (value) => PathMatcher.fromMap((value as Map).cast<String, dynamic>())),
