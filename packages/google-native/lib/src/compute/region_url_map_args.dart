  ...
  RegionUrlMapArgs({
    ...
    List<UrlMapTest>? tests,
            ...
            pulumi.Input.asOptionalInput<CustomErrorResponsePolicy>(
                defaultCustomErrorResponsePolicy),
        defaultRouteAction =
            pulumi.Input.asOptionalInput<HttpRouteAction>(defaultRouteAction),
        ...
        headerAction =
            pulumi.Input.asOptionalInput<HttpHeaderAction>(headerAction),
        hostRules = pulumi.Input.asOptionalInput<List<HostRule>>(hostRules),
        name = pulumi.Input.asOptionalInput<String>(name),
        pathMatchers =
            pulumi.Input.asOptionalInput<List<PathMatcher>>(pathMatchers),
