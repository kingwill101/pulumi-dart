...
/// {@template pulumi_compute_v1_backend_service_iam_binding_compute_v1_args_doc}
/// The set of arguments for BackendServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_backend_service_iam_binding_compute_v1_args_doc}
class BackendServiceIamBindingComputeV1Args {
  ...
  /// Creates a new [BackendServiceIamBindingComputeV1Args].
  ...
  BackendServiceIamBindingComputeV1Args({
    Condition? condition,
  ...
  factory BackendServiceIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamBindingComputeV1Args(
