...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeV1 {
  ...
  final SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigRuleVisibilityComputeV1? ruleVisibility;
  /// Configuration options for layer7 adaptive protection for various customizable thresholds.
  final List<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigComputeV1>? thresholdConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'thresholdConfigs': ?thresholdConfigs == null ? null : pulumi.Input.encodeList<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigComputeV1, Map<String, dynamic>>(thresholdConfigs!, (value) => value.toMap()),
    };
  }
  ...
  factory SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeV1(
      ...
      ruleVisibility: map['ruleVisibility'] == null ? null : SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigRuleVisibilityComputeV1.fromValue(map['ruleVisibility'] as String),
