...
class NetworkArgs {
  ...
  NetworkArgs({
    ...
    int? mtu,
    String? name,
    NetworkNetworkFirewallPolicyEnforcementOrder? networkFirewallPolicyEnforcementOrder,
    String? project,
    String? requestId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mtu': ?mtu,
      'name': ?name,
      'networkFirewallPolicyEnforcementOrder': ?pulumi.Input.mapOptionalInputValue<NetworkNetworkFirewallPolicyEnforcementOrder, String>(networkFirewallPolicyEnforcementOrder, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      ...
      networkFirewallPolicyEnforcementOrder: map['networkFirewallPolicyEnforcementOrder'] == null ? null : NetworkNetworkFirewallPolicyEnforcementOrder.fromValue(map['networkFirewallPolicyEnforcementOrder'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      routingConfig: map['routingConfig'] == null ? null : NetworkRoutingConfig.fromMap((map['routingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
