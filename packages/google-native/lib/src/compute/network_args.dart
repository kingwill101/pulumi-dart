...
class NetworkArgs {
  ...
  final pulumi.Input<NetworkNetworkFirewallPolicyEnforcementOrder>?
  ...
  NetworkArgs({
    ...
    NetworkRoutingConfig? routingConfig,
        ...
        routingConfig =
            pulumi.Input.asOptionalInput<NetworkRoutingConfig>(routingConfig);
