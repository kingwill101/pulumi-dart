...
class RegionHealthCheckComputeBetaArgs {
  ...
  RegionHealthCheckComputeBetaArgs({
    ...
    int? unhealthyThreshold,
        ...
        grpcHealthCheck =
            pulumi.Input.asOptionalInput<GRPCHealthCheckComputeBeta>(
                grpcHealthCheck),
        ...
        http2HealthCheck =
            pulumi.Input.asOptionalInput<HTTP2HealthCheckComputeBeta>(
                http2HealthCheck),
        httpHealthCheck =
            pulumi.Input.asOptionalInput<HTTPHealthCheckComputeBeta>(
                httpHealthCheck),
        httpsHealthCheck =
        ...
        logConfig =
            pulumi.Input.asOptionalInput<HealthCheckLogConfigComputeBeta>(
                logConfig),
        ...
        sslHealthCheck =
            pulumi.Input.asOptionalInput<SSLHealthCheckComputeBeta>(
                sslHealthCheck),
        tcpHealthCheck =
            pulumi.Input.asOptionalInput<TCPHealthCheckComputeBeta>(
                tcpHealthCheck),
        timeoutSec = pulumi.Input.asOptionalInput<int>(timeoutSec),
        type = pulumi.Input.asOptionalInput<RegionHealthCheckTypeComputeBeta>(
            type),
        unhealthyThreshold =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = pulumi.Input.mapOptionalInputValue<
          RegionHealthCheckTypeComputeBeta,
  ...
  factory RegionHealthCheckComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckComputeBetaArgs(
      ...
      type: map['type'] == null
          ? null
          : RegionHealthCheckTypeComputeBeta.fromValue(map['type'] as String),
