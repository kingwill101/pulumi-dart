...
class AutoscalingPolicyComputeBeta {
  ...
  final List<AutoscalingPolicyCustomMetricUtilizationComputeBeta>? customMetricUtilizations;
  /// Configuration parameters of autoscaling based on load balancer.
  final AutoscalingPolicyLoadBalancingUtilizationComputeBeta? loadBalancingUtilization;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetricUtilizations': ?customMetricUtilizations == null ? null : pulumi.Input.encodeList<AutoscalingPolicyCustomMetricUtilizationComputeBeta, Map<String, dynamic>>(customMetricUtilizations!, (value) => value.toMap()),
  ...
  factory AutoscalingPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyComputeBeta(
      ...
      cpuUtilization: map['cpuUtilization'] == null ? null : AutoscalingPolicyCpuUtilizationComputeBeta.fromMap((map['cpuUtilization'] as Map).cast<String, dynamic>()),
      customMetricUtilizations: map['customMetricUtilizations'] == null ? null : pulumi.Input.decodeList<AutoscalingPolicyCustomMetricUtilizationComputeBeta>(map['customMetricUtilizations'], (value) => AutoscalingPolicyCustomMetricUtilizationComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      loadBalancingUtilization: map['loadBalancingUtilization'] == null ? null : AutoscalingPolicyLoadBalancingUtilizationComputeBeta.fromMap((map['loadBalancingUtilization'] as Map).cast<String, dynamic>()),
      ...
      mode: map['mode'] == null ? null : AutoscalingPolicyModeComputeBeta.fromValue(map['mode'] as String),
      scaleDownControl: map['scaleDownControl'] == null ? null : AutoscalingPolicyScaleDownControlComputeBeta.fromMap((map['scaleDownControl'] as Map).cast<String, dynamic>()),
      scaleInControl: map['scaleInControl'] == null ? null : AutoscalingPolicyScaleInControlComputeBeta.fromMap((map['scaleInControl'] as Map).cast<String, dynamic>()),
