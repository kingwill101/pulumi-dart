...
class GetRegionUrlMapResult {
  ...
  /// Creates a new [GetRegionUrlMapResult].
  ...
  factory GetRegionUrlMapResult.fromMap(Map<String, dynamic> map) {
    return GetRegionUrlMapResult(
      ...
      pathMatchers: pulumi.Input.decodeList<PathMatcherResponse>(
        map['pathMatchers'],
        (value) =>
            PathMatcherResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      tests: pulumi.Input.decodeList<UrlMapTestResponse>(
        map['tests'],
        (value) =>
            UrlMapTestResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
