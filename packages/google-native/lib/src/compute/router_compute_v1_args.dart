...
class RouterComputeV1Args {
  ...
  factory RouterComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RouterComputeV1Args(
      bgp: map['bgp'] == null ? null : RouterBgpComputeV1.fromMap((map['bgp'] as Map).cast<String, dynamic>()),
      bgpPeers: map['bgpPeers'] == null ? null : pulumi.Input.decodeList<RouterBgpPeerComputeV1>(map['bgpPeers'], (value) => RouterBgpPeerComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      interfaces: map['interfaces'] == null ? null : pulumi.Input.decodeList<RouterInterfaceComputeV1>(map['interfaces'], (value) => RouterInterfaceComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      md5AuthenticationKeys: map['md5AuthenticationKeys'] == null ? null : pulumi.Input.decodeList<RouterMd5AuthenticationKeyComputeV1>(map['md5AuthenticationKeys'], (value) => RouterMd5AuthenticationKeyComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      nats: map['nats'] == null ? null : pulumi.Input.decodeList<RouterNatComputeV1>(map['nats'], (value) => RouterNatComputeV1.fromMap((value as Map).cast<String, dynamic>())),
