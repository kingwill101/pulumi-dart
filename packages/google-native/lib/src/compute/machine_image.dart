...
import 'source_disk_encryption_key_response.dart';
...
class MachineImage extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SavedDiskResponse>> savedDisks;
  ...
  late final pulumi.Output<List<SourceDiskEncryptionKeyResponse>> sourceDiskEncryptionKeys;
  ...
  MachineImage(
    ...
    this.instanceProperties = registerOutput<InstancePropertiesResponse>('instanceProperties');
    this.kind = registerOutput<String>('kind');
    this.machineImageEncryptionKey = registerOutput<CustomerEncryptionKeyResponse>('machineImageEncryptionKey');
    ...
    this.sourceDiskEncryptionKeys = registerOutput<List<SourceDiskEncryptionKeyResponse>>('sourceDiskEncryptionKeys');
    this.sourceInstance = registerOutput<String>('sourceInstance');
    this.sourceInstanceProperties = registerOutput<SourceInstancePropertiesResponse>('sourceInstanceProperties');
