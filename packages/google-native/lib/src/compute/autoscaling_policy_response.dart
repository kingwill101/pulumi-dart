...
class AutoscalingPolicyResponse {
  ...
  final List<AutoscalingPolicyCustomMetricUtilizationResponse> customMetricUtilizations;
  /// Configuration parameters of autoscaling based on load balancer.
  final AutoscalingPolicyLoadBalancingUtilizationResponse loadBalancingUtilization;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetricUtilizations': pulumi.Input.encodeList<AutoscalingPolicyCustomMetricUtilizationResponse, Map<String, dynamic>>(customMetricUtilizations, (value) => value.toMap()),
  ...
  factory AutoscalingPolicyResponse.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyResponse(
      ...
      cpuUtilization: AutoscalingPolicyCpuUtilizationResponse.fromMap((map['cpuUtilization'] as Map).cast<String, dynamic>()),
      customMetricUtilizations: pulumi.Input.decodeList<AutoscalingPolicyCustomMetricUtilizationResponse>(map['customMetricUtilizations'], (value) => AutoscalingPolicyCustomMetricUtilizationResponse.fromMap((value as Map).cast<String, dynamic>())),
      loadBalancingUtilization: AutoscalingPolicyLoadBalancingUtilizationResponse.fromMap((map['loadBalancingUtilization'] as Map).cast<String, dynamic>()),
      maxNumReplicas: map['maxNumReplicas'] as int,
      minNumReplicas: map['minNumReplicas'] as int,
      mode: map['mode'] as String,
      scaleDownControl: AutoscalingPolicyScaleDownControlResponse.fromMap((map['scaleDownControl'] as Map).cast<String, dynamic>()),
      scaleInControl: AutoscalingPolicyScaleInControlResponse.fromMap((map['scaleInControl'] as Map).cast<String, dynamic>()),
