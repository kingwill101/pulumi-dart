...
class InstanceGroupManagerInstanceLifecyclePolicy {
  ...
  final InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure?
  defaultActionOnFailure;

  /// A bit indicating whether to forcefully apply the group's latest configuration when repairing a VM. Valid options are: - NO (default): If configuration updates are available, they are not forcefully applied during repair. Instead, configuration updates are applied according to the group's update policy. - YES: If configuration updates are available, they are applied during repair.
  final InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepair?
  forceUpdateOnRepair;
  ...
  final InstanceGroupManagerInstanceLifecyclePolicyMetadataBasedReadinessSignal?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadataBasedReadinessSignal': ?metadataBasedReadinessSignal == null
          ? null
          : metadataBasedReadinessSignal!.toMap(),
    };
  }
  ...
  factory InstanceGroupManagerInstanceLifecyclePolicy.fromMap(
    ...
    return InstanceGroupManagerInstanceLifecyclePolicy(
      defaultActionOnFailure: map['defaultActionOnFailure'] == null
          ? null
          : InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure.fromValue(
              map['defaultActionOnFailure'] as String,
            ),
      forceUpdateOnRepair: map['forceUpdateOnRepair'] == null
          ? null
          : InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepair.fromValue(
              map['forceUpdateOnRepair'] as String,
            ),
      metadataBasedReadinessSignal: map['metadataBasedReadinessSignal'] == null
          ? null
          : InstanceGroupManagerInstanceLifecyclePolicyMetadataBasedReadinessSignal.fromMap(
