...
import 'https_health_check_compute_beta_args.dart';

/// Creates a HttpsHealthCheck resource in the specified project using the data included in the request.
class HttpsHealthCheckComputeBeta extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [HttpsHealthCheckComputeBeta]. {@macro pulumi_compute_beta_https_health_check_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HttpsHealthCheckComputeBeta(
    String name, {
    HttpsHealthCheckComputeBetaArgs? args,
