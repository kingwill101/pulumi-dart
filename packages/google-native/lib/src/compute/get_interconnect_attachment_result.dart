...
class GetInterconnectAttachmentResult {
  ...
  final InterconnectAttachmentConfigurationConstraintsResponse
  ...
  factory GetInterconnectAttachmentResult.fromMap(Map<String, dynamic> map) {
    return GetInterconnectAttachmentResult(
      ...
      configurationConstraints:
          InterconnectAttachmentConfigurationConstraintsResponse.fromMap(
      ...
      partnerMetadata: InterconnectAttachmentPartnerMetadataResponse.fromMap(
          (map['partnerMetadata'] as Map).cast<String, dynamic>()),
      privateInterconnectInfo:
          InterconnectAttachmentPrivateInfoResponse.fromMap(
