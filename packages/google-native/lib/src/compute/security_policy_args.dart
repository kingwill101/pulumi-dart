...
class SecurityPolicyArgs {
  ...
  SecurityPolicyArgs({
    ...
    List<SecurityPolicyUserDefinedField>? userDefinedFields,
      ...
      type = pulumi.Input.asOptionalInput<SecurityPolicyType>(type),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyType, String>(type, (value) => value.value),
  ...
  factory SecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyArgs(
      ...
      type: map['type'] == null ? null : SecurityPolicyType.fromValue(map['type'] as String),
