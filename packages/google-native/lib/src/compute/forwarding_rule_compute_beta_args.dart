...
class ForwardingRuleComputeBetaArgs {
  ...
  ForwardingRuleComputeBetaArgs({
    ...
    String? target,
        ...
        ipProtocol =
            pulumi.Input.asOptionalInput<ForwardingRuleIpProtocolComputeBeta>(
                ipProtocol),
        ipVersion =
            pulumi.Input.asOptionalInput<ForwardingRuleIpVersionComputeBeta>(
                ipVersion),
        ...
        networkTier =
            pulumi.Input.asOptionalInput<ForwardingRuleNetworkTierComputeBeta>(
                networkTier),
        noAutomateDnsZone =
  ...
  factory ForwardingRuleComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeBetaArgs(
      ...
      ipProtocol: map['ipProtocol'] == null
          ? null
          : ForwardingRuleIpProtocolComputeBeta.fromValue(
              map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null
          ? null
          : ForwardingRuleIpVersionComputeBeta.fromValue(
