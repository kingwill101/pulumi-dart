...
class ForwardingRuleComputeBetaArgs {
  ...
  ForwardingRuleComputeBetaArgs({
    ...
    String? description,
    String? ipAddress,
    ForwardingRuleIpProtocolComputeBeta? ipProtocol,
    ForwardingRuleIpVersionComputeBeta? ipVersion,
    bool? isMirroringCollector,
    Map<String, String>? labels,
    ForwardingRuleLoadBalancingSchemeComputeBeta? loadBalancingScheme,
    List<MetadataFilterComputeBeta>? metadataFilters,
    String? name,
    String? network,
    ForwardingRuleNetworkTierComputeBeta? networkTier,
    bool? noAutomateDnsZone,
    String? portRange,
    List<String>? ports,
    String? project,
    ForwardingRulePscConnectionStatusComputeBeta? pscConnectionStatus,
  ...
  factory ForwardingRuleComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeBetaArgs(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : ForwardingRuleIpProtocolComputeBeta.fromValue(map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null ? null : ForwardingRuleIpVersionComputeBeta.fromValue(map['ipVersion'] as String),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : map['isMirroringCollector'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : ForwardingRuleLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String),
      ...
      networkTier: map['networkTier'] == null ? null : ForwardingRuleNetworkTierComputeBeta.fromValue(map['networkTier'] as String),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : ForwardingRulePscConnectionStatusComputeBeta.fromValue(map['pscConnectionStatus'] as String),
