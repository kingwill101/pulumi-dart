...
class SecurityPolicyRuleMatcherConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destPorts': ?destPorts == null ? null : pulumi.Input.encodeList<SecurityPolicyRuleMatcherConfigDestinationPort, Map<String, dynamic>>(destPorts!, (value) => value.toMap()),
      'layer4Configs': ?layer4Configs == null ? null : pulumi.Input.encodeList<SecurityPolicyRuleMatcherConfigLayer4Config, Map<String, dynamic>>(layer4Configs!, (value) => value.toMap()),
  ...
  factory SecurityPolicyRuleMatcherConfig.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherConfig(
      ...
      destPorts: map['destPorts'] == null ? null : pulumi.Input.decodeList<SecurityPolicyRuleMatcherConfigDestinationPort>(map['destPorts'], (value) => SecurityPolicyRuleMatcherConfigDestinationPort.fromMap((value as Map).cast<String, dynamic>())),
      layer4Configs: map['layer4Configs'] == null ? null : pulumi.Input.decodeList<SecurityPolicyRuleMatcherConfigLayer4Config>(map['layer4Configs'], (value) => SecurityPolicyRuleMatcherConfigLayer4Config.fromMap((value as Map).cast<String, dynamic>())),
