...
class GetBackendServiceComputeV1Result {
  ...
  final BackendServiceConnectionTrackingPolicyResponseComputeV1
  ...
  final List<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1>
      localityLbPolicies;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['backends'] =
        pulumi.Input.encodeList<BackendResponseComputeV1, Map<String, dynamic>>(
  ...
  factory GetBackendServiceComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceComputeV1Result(
      ...
      backends: pulumi.Input.decodeList<BackendResponseComputeV1>(
          map['backends'],
          (value) => BackendResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      cdnPolicy: BackendServiceCdnPolicyResponseComputeV1.fromMap(
          (map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: CircuitBreakersResponseComputeV1.fromMap(
          (map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] as String,
      connectionDraining: ConnectionDrainingResponseComputeV1.fromMap(
          (map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy:
          BackendServiceConnectionTrackingPolicyResponseComputeV1.fromMap(
              (map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash:
          ConsistentHashLoadBalancerSettingsResponseComputeV1.fromMap(
      ...
      failoverPolicy: BackendServiceFailoverPolicyResponseComputeV1.fromMap(
          (map['failoverPolicy'] as Map).cast<String, dynamic>()),
      fingerprint: map['fingerprint'] as String,
      healthChecks: (map['healthChecks'] as List).cast<String>(),
      iap: BackendServiceIAPResponseComputeV1.fromMap(
      ...
      logConfig: BackendServiceLogConfigResponseComputeV1.fromMap(
      ...
      outlierDetection: OutlierDetectionResponseComputeV1.fromMap(
      ...
      securitySettings: SecuritySettingsResponseComputeV1.fromMap(
      ...
      subsetting: SubsettingResponseComputeV1.fromMap(
          (map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] as int,
      usedBy: pulumi.Input.decodeList<BackendServiceUsedByResponseComputeV1>(
          map['usedBy'],
          (value) => BackendServiceUsedByResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
