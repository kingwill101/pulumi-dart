...
class HttpRouteRuleMatchResponse {
  ...
  final List<HttpHeaderMatchResponse> headerMatches;
  ...
  final List<MetadataFilterResponse> metadataFilters;
  ...
  final List<HttpQueryParameterMatchResponse> queryParameterMatches;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': pulumi.Input.encodeList<HttpHeaderMatchResponse, Map<String, dynamic>>(headerMatches, (value) => value.toMap()),
      'ignoreCase': ignoreCase,
      'metadataFilters': pulumi.Input.encodeList<MetadataFilterResponse, Map<String, dynamic>>(metadataFilters, (value) => value.toMap()),
      'pathTemplateMatch': pathTemplateMatch,
      'prefixMatch': prefixMatch,
      'queryParameterMatches': pulumi.Input.encodeList<HttpQueryParameterMatchResponse, Map<String, dynamic>>(queryParameterMatches, (value) => value.toMap()),
  ...
  factory HttpRouteRuleMatchResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponse(
      ...
      headerMatches: pulumi.Input.decodeList<HttpHeaderMatchResponse>(map['headerMatches'], (value) => HttpHeaderMatchResponse.fromMap((value as Map).cast<String, dynamic>())),
      ignoreCase: map['ignoreCase'] as bool,
      metadataFilters: pulumi.Input.decodeList<MetadataFilterResponse>(map['metadataFilters'], (value) => MetadataFilterResponse.fromMap((value as Map).cast<String, dynamic>())),
      pathTemplateMatch: map['pathTemplateMatch'] as String,
      prefixMatch: map['prefixMatch'] as String,
      queryParameterMatches: pulumi.Input.decodeList<HttpQueryParameterMatchResponse>(map['queryParameterMatches'], (value) => HttpQueryParameterMatchResponse.fromMap((value as Map).cast<String, dynamic>())),
