...
import 'route_compute_v1_args.dart';
...
class RouteComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [RouteComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RouteComputeV1]. {@macro pulumi_compute_v1_route_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RouteComputeV1(
    String name, {
    RouteComputeV1Args? args,
    ...
    this.asPaths = registerOutput<List<RouteAsPathResponseComputeV1>>(
      'asPaths',
    );
    ...
    this.warnings = registerOutput<List<RouteWarningsItemResponseComputeV1>>(
      'warnings',
    );
  }
}
