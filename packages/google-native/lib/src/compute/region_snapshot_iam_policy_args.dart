...
/// {@template pulumi_compute_alpha_region_snapshot_iam_policy_args_doc}
/// The set of arguments for RegionSnapshotIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_snapshot_iam_policy_args_doc}
class RegionSnapshotIamPolicyArgs {
  ...
  /// Creates a new [RegionSnapshotIamPolicyArgs].
  ...
  factory RegionSnapshotIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotIamPolicyArgs(
