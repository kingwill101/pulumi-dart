...
class FirewallComputeV1Args {
  ...
  FirewallComputeV1Args({
    ...
    List<String>? targetTags,
            ...
            pulumi.Input.asOptionalInput<List<FirewallAllowedItemComputeV1>>(
                allowed),
        denied =
            pulumi.Input.asOptionalInput<List<FirewallDeniedItemComputeV1>>(
                denied),
        description = pulumi.Input.asOptionalInput<String>(description),
        destinationRanges =
            pulumi.Input.asOptionalInput<List<String>>(destinationRanges),
        direction =
            pulumi.Input.asOptionalInput<FirewallDirectionComputeV1>(direction),
        disabled = pulumi.Input.asOptionalInput<bool>(disabled),
        logConfig =
            pulumi.Input.asOptionalInput<FirewallLogConfigComputeV1>(logConfig),
        ...
        sourceServiceAccounts =
            pulumi.Input.asOptionalInput<List<String>>(sourceServiceAccounts),
        sourceTags = pulumi.Input.asOptionalInput<List<String>>(sourceTags),
        targetServiceAccounts =
            pulumi.Input.asOptionalInput<List<String>>(targetServiceAccounts),
  ...
  factory FirewallComputeV1Args.fromMap(Map<String, dynamic> map) {
    return FirewallComputeV1Args(
      allowed: map['allowed'] == null
          ? null
          : pulumi.Input.decodeList<FirewallAllowedItemComputeV1>(
              map['allowed'],
              (value) => FirewallAllowedItemComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      denied: map['denied'] == null
          ? null
          : pulumi.Input.decodeList<FirewallDeniedItemComputeV1>(
              map['denied'],
              (value) => FirewallDeniedItemComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      description:
          map['description'] == null ? null : map['description'] as String,
      destinationRanges: map['destinationRanges'] == null
          ? null
          : (map['destinationRanges'] as List).cast<String>(),
      direction: map['direction'] == null
          ? null
          : FirewallDirectionComputeV1.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      logConfig: map['logConfig'] == null
          ? null
          : FirewallLogConfigComputeV1.fromMap(
      ...
      sourceRanges: map['sourceRanges'] == null
          ? null
          : (map['sourceRanges'] as List).cast<String>(),
      sourceServiceAccounts: map['sourceServiceAccounts'] == null
          ? null
          : (map['sourceServiceAccounts'] as List).cast<String>(),
      sourceTags: map['sourceTags'] == null
          ? null
          : (map['sourceTags'] as List).cast<String>(),
