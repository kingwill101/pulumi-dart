...
class FirewallComputeV1Args {
  ...
  FirewallComputeV1Args({
    ...
    List<String>? targetTags,
           ...
           .Input.asOptionalInput<List<FirewallAllowedItemComputeV1>>(allowed),
       denied = pulumi.Input.asOptionalInput<List<FirewallDeniedItemComputeV1>>(
         denied,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       destinationRanges = pulumi.Input.asOptionalInput<List<String>>(
         destinationRanges,
       ),
    ...
    return <String, dynamic>{
      'allowed':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallAllowedItemComputeV1>,
            List<Map<String, dynamic>>
          >(
            allowed,
            (value) =>
                pulumi.Input.encodeList<
                  FirewallAllowedItemComputeV1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'denied':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallDeniedItemComputeV1>,
            List<Map<String, dynamic>>
          >(
            denied,
            (value) =>
