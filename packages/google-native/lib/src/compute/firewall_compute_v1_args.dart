...
/// {@template pulumi_compute_v1_firewall_compute_v1_args_doc}
/// The set of arguments for Firewall.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_firewall_compute_v1_args_doc}
class FirewallComputeV1Args {
  ...
  /// Creates a new [FirewallComputeV1Args].
  ...
  FirewallComputeV1Args({
    List<FirewallAllowedItemComputeV1>? allowed,
    List<FirewallDeniedItemComputeV1>? denied,
    String? description,
    List<String>? destinationRanges,
    FirewallDirectionComputeV1? direction,
    bool? disabled,
    FirewallLogConfigComputeV1? logConfig,
    String? name,
    String? network,
    int? priority,
    String? project,
    ...
    List<String>? targetTags,
      ...
      allowed = pulumi.Input.asOptionalInput<List<FirewallAllowedItemComputeV1>>(allowed),
      denied = pulumi.Input.asOptionalInput<List<FirewallDeniedItemComputeV1>>(denied),
      description = pulumi.Input.asOptionalInput<String>(description),
      destinationRanges = pulumi.Input.asOptionalInput<List<String>>(destinationRanges),
      direction = pulumi.Input.asOptionalInput<FirewallDirectionComputeV1>(direction),
      disabled = pulumi.Input.asOptionalInput<bool>(disabled),
      logConfig = pulumi.Input.asOptionalInput<FirewallLogConfigComputeV1>(logConfig),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowed': ?pulumi.Input.mapOptionalInputValue<List<FirewallAllowedItemComputeV1>, List<Map<String, dynamic>>>(allowed, (value) => pulumi.Input.encodeList<FirewallAllowedItemComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'denied': ?pulumi.Input.mapOptionalInputValue<List<FirewallDeniedItemComputeV1>, List<Map<String, dynamic>>>(denied, (value) => pulumi.Input.encodeList<FirewallDeniedItemComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'description': ?description,
      'destinationRanges': ?destinationRanges,
      'direction': ?pulumi.Input.mapOptionalInputValue<FirewallDirectionComputeV1, String>(direction, (value) => value.value),
      'disabled': ?disabled,
      'logConfig': ?pulumi.Input.mapOptionalInputValue<FirewallLogConfigComputeV1, Map<String, dynamic>>(logConfig, (value) => value.toMap()),
      'name': ?name,
      'network': ?network,
      'priority': ?priority,
      'project': ?project,
  ...
  factory FirewallComputeV1Args.fromMap(Map<String, dynamic> map) {
    return FirewallComputeV1Args(
      allowed: map['allowed'] == null ? null : pulumi.Input.decodeList<FirewallAllowedItemComputeV1>(map['allowed'], (value) => FirewallAllowedItemComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      denied: map['denied'] == null ? null : pulumi.Input.decodeList<FirewallDeniedItemComputeV1>(map['denied'], (value) => FirewallDeniedItemComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      destinationRanges: map['destinationRanges'] == null ? null : (map['destinationRanges'] as List).cast<String>(),
      direction: map['direction'] == null ? null : FirewallDirectionComputeV1.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      logConfig: map['logConfig'] == null ? null : FirewallLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      sourceRanges: map['sourceRanges'] == null ? null : (map['sourceRanges'] as List).cast<String>(),
      sourceServiceAccounts: map['sourceServiceAccounts'] == null ? null : (map['sourceServiceAccounts'] as List).cast<String>(),
      ...
      targetTags: map['targetTags'] == null ? null : (map['targetTags'] as List).cast<String>(),
    );
  }
}
