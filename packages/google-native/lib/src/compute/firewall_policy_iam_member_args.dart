...
/// {@template pulumi_compute_alpha_firewall_policy_iam_member_args_doc}
/// The set of arguments for FirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_firewall_policy_iam_member_args_doc}
class FirewallPolicyIamMemberArgs {
  ...
  /// Creates a new [FirewallPolicyIamMemberArgs].
  ...
  factory FirewallPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamMemberArgs(
