...
import 'interconnect_attachment_configuration_constraints_response_compute_v1.dart';
import 'interconnect_attachment_partner_metadata_response_compute_v1.dart';
import 'interconnect_attachment_private_info_response_compute_v1.dart';

/// Result data returned by getInterconnectAttachment.
class GetInterconnectAttachmentComputeV1Result {
  ...
  final InterconnectAttachmentConfigurationConstraintsResponseComputeV1
  ...
  final InterconnectAttachmentPartnerMetadataResponseComputeV1 partnerMetadata;
  ...
  final InterconnectAttachmentPrivateInfoResponseComputeV1
  ...
  /// Creates a new [GetInterconnectAttachmentComputeV1Result].
  ...
  GetInterconnectAttachmentComputeV1Result({
  ...
  factory GetInterconnectAttachmentComputeV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetInterconnectAttachmentComputeV1Result(
      ...
      partnerMetadata:
          InterconnectAttachmentPartnerMetadataResponseComputeV1.fromMap(
              (map['partnerMetadata'] as Map).cast<String, dynamic>()),
      privateInterconnectInfo:
          InterconnectAttachmentPrivateInfoResponseComputeV1.fromMap(
