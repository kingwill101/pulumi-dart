...
/// {@template pulumi_compute_alpha_network_attachment_iam_member_args_doc}
/// The set of arguments for NetworkAttachmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_network_attachment_iam_member_args_doc}
class NetworkAttachmentIamMemberArgs {
  ...
  /// Creates a new [NetworkAttachmentIamMemberArgs].
  ...
  NetworkAttachmentIamMemberArgs({
    Condition? condition,
  ...
  factory NetworkAttachmentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamMemberArgs(
