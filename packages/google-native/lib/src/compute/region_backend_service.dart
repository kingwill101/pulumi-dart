...
class RegionBackendService extends pulumi.CustomResource {
  ...
  RegionBackendService(
    ...
    this.cdnPolicy = registerOutput<BackendServiceCdnPolicyResponse>(
      'cdnPolicy',
    );
    this.circuitBreakers = registerOutput<CircuitBreakersResponse>(
      'circuitBreakers',
    );
    this.compressionMode = registerOutput<String>('compressionMode');
    this.connectionDraining = registerOutput<ConnectionDrainingResponse>(
      'connectionDraining',
    );
    ...
    this.failoverPolicy = registerOutput<BackendServiceFailoverPolicyResponse>(
      'failoverPolicy',
    );
    ...
    this.logConfig = registerOutput<BackendServiceLogConfigResponse>(
      'logConfig',
    );
    this.maxStreamDuration = registerOutput<DurationResponse>(
      'maxStreamDuration',
    );
    this.metadatas = registerOutput<Map<String, String>>('metadatas');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.outlierDetection = registerOutput<OutlierDetectionResponse>(
      'outlierDetection',
    );
    ...
    this.securitySettings = registerOutput<SecuritySettingsResponse>(
      'securitySettings',
    );
