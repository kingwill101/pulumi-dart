...
/// {@template pulumi_compute_alpha_interconnect_iam_binding_args_doc}
/// The set of arguments for InterconnectIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_interconnect_iam_binding_args_doc}
class InterconnectIamBindingArgs {
  ...
  /// Creates a new [InterconnectIamBindingArgs].
  ...
  factory InterconnectIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectIamBindingArgs(
