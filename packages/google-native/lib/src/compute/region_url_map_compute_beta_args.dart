...
class RegionUrlMapComputeBetaArgs {
  ...
  RegionUrlMapComputeBetaArgs({
    CustomErrorResponsePolicyComputeBeta? defaultCustomErrorResponsePolicy,
    HttpRouteActionComputeBeta? defaultRouteAction,
    String? defaultService,
    HttpRedirectActionComputeBeta? defaultUrlRedirect,
    String? description,
    HttpHeaderActionComputeBeta? headerAction,
    List<HostRuleComputeBeta>? hostRules,
    String? name,
    List<PathMatcherComputeBeta>? pathMatchers,
    String? project,
    required String region,
    String? requestId,
    List<UrlMapTestComputeBeta>? tests,
  }) :
  ...
  factory RegionUrlMapComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapComputeBetaArgs(
      ...
      hostRules: map['hostRules'] == null ? null : pulumi.Input.decodeList<HostRuleComputeBeta>(map['hostRules'], (value) => HostRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      pathMatchers: map['pathMatchers'] == null ? null : pulumi.Input.decodeList<PathMatcherComputeBeta>(map['pathMatchers'], (value) => PathMatcherComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      tests: map['tests'] == null ? null : pulumi.Input.decodeList<UrlMapTestComputeBeta>(map['tests'], (value) => UrlMapTestComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
