...
class RegionUrlMapComputeBetaArgs {
  ...
  RegionUrlMapComputeBetaArgs({
    ...
    List<UrlMapTestComputeBeta>? tests,
        ...
        headerAction =
            pulumi.Input.asOptionalInput<HttpHeaderActionComputeBeta>(
                headerAction),
        hostRules =
            pulumi.Input.asOptionalInput<List<HostRuleComputeBeta>>(hostRules),
        name = pulumi.Input.asOptionalInput<String>(name),
        pathMatchers =
            pulumi.Input.asOptionalInput<List<PathMatcherComputeBeta>>(
                pathMatchers),
        project = pulumi.Input.asOptionalInput<String>(project),
        region = pulumi.Input.asInput<String>(region),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        tests =
            pulumi.Input.asOptionalInput<List<UrlMapTestComputeBeta>>(tests);
