...
import 'target_tcp_proxy_compute_beta_args.dart';

/// Creates a TargetTcpProxy resource in the specified project using the data included in the request.
class TargetTcpProxyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetTcpProxyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetTcpProxyComputeBeta]. {@macro pulumi_compute_beta_target_tcp_proxy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetTcpProxyComputeBeta(
    String name, {
    TargetTcpProxyComputeBetaArgs? args,
