...
class ReservationArgs {
  ...
  factory ReservationArgs.fromMap(Map<String, dynamic> map) {
    return ReservationArgs(
      aggregateReservation: map['aggregateReservation'] == null ? null : AllocationAggregateReservation.fromMap((map['aggregateReservation'] as Map).cast<String, dynamic>()),
      deleteAfterDuration: map['deleteAfterDuration'] == null ? null : Duration.fromMap((map['deleteAfterDuration'] as Map).cast<String, dynamic>()),
      ...
      specificReservation: map['specificReservation'] == null ? null : AllocationSpecificSKUReservation.fromMap((map['specificReservation'] as Map).cast<String, dynamic>()),
