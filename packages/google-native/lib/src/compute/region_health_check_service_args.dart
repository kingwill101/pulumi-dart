...
class RegionHealthCheckServiceArgs {
  ...
  RegionHealthCheckServiceArgs({
    ...
    RegionHealthCheckServiceHealthStatusAggregationPolicy? healthStatusAggregationPolicy,
    RegionHealthCheckServiceHealthStatusAggregationStrategy? healthStatusAggregationStrategy,
    String? name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'healthStatusAggregationPolicy': ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckServiceHealthStatusAggregationPolicy, String>(healthStatusAggregationPolicy, (value) => value.value),
      'healthStatusAggregationStrategy': ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckServiceHealthStatusAggregationStrategy, String>(healthStatusAggregationStrategy, (value) => value.value),
      'name': ?name,
  ...
  factory RegionHealthCheckServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckServiceArgs(
      ...
      healthStatusAggregationPolicy: map['healthStatusAggregationPolicy'] == null ? null : RegionHealthCheckServiceHealthStatusAggregationPolicy.fromValue(map['healthStatusAggregationPolicy'] as String),
      healthStatusAggregationStrategy: map['healthStatusAggregationStrategy'] == null ? null : RegionHealthCheckServiceHealthStatusAggregationStrategy.fromValue(map['healthStatusAggregationStrategy'] as String),
