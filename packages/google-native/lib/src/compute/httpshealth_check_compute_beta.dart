...
class HTTPSHealthCheckComputeBeta {
  ...
  final HTTPSHealthCheckPortSpecificationComputeBeta? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTPSHealthCheckProxyHeaderComputeBeta? proxyHeader;
  ...
  factory HTTPSHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheckComputeBeta(
      ...
      portSpecification: map['portSpecification'] == null ? null : HTTPSHealthCheckPortSpecificationComputeBeta.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : HTTPSHealthCheckProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String),
