...
class NetworkInterfaceResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['accessConfigs'] =
        pulumi.Input.encodeList<AccessConfigResponse, Map<String, dynamic>>(
            accessConfigs, (value) => value.toMap());
    map['aliasIpRanges'] =
        pulumi.Input.encodeList<AliasIpRangeResponse, Map<String, dynamic>>(
  ...
  factory NetworkInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponse(
      accessConfigs: pulumi.Input.decodeList<AccessConfigResponse>(
          map['accessConfigs'],
          (value) => AccessConfigResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      aliasIpRanges: pulumi.Input.decodeList<AliasIpRangeResponse>(
          map['aliasIpRanges'],
          (value) => AliasIpRangeResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      fingerprint: map['fingerprint'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: pulumi.Input.decodeList<AccessConfigResponse>(
          map['ipv6AccessConfigs'],
          (value) => AccessConfigResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
