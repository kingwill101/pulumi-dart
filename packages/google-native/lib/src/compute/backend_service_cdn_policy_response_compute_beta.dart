...
class BackendServiceCdnPolicyResponseComputeBeta {
  ...
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta> bypassCacheOnRequestHeaders;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta> negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta, Map<String, dynamic>>(bypassCacheOnRequestHeaders, (value) => value.toMap()),
      ...
      'negativeCachingPolicy': pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta, Map<String, dynamic>>(negativeCachingPolicy, (value) => value.toMap()),
  ...
  factory BackendServiceCdnPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders: pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: CacheKeyPolicyResponseComputeBeta.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      ...
      negativeCachingPolicy: pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
