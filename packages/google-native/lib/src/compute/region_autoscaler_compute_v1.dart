...
class RegionAutoscalerComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AutoscalingPolicyResponseComputeV1>
  autoscalingPolicy;
  ...
  late final pulumi.Output<List<AutoscalerStatusDetailsResponseComputeV1>>
  statusDetails;
  ...
  RegionAutoscalerComputeV1(
    ...
    this.autoscalingPolicy = registerOutput<AutoscalingPolicyResponseComputeV1>(
      'autoscalingPolicy',
    );
    ...
    this.statusDetails =
        registerOutput<List<AutoscalerStatusDetailsResponseComputeV1>>(
          'statusDetails',
        );
