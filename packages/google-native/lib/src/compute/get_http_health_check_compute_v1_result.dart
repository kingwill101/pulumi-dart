...
class GetHttpHealthCheckComputeV1Result {
  ...
  /// Creates a new [GetHttpHealthCheckComputeV1Result].
  ...
  factory GetHttpHealthCheckComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetHttpHealthCheckComputeV1Result(
