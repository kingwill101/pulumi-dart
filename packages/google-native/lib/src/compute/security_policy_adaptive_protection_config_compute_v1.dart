...
class SecurityPolicyAdaptiveProtectionConfigComputeV1 {
  ...
  final SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeV1? layer7DdosDefenseConfig;
  ...
  factory SecurityPolicyAdaptiveProtectionConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigComputeV1(
      layer7DdosDefenseConfig: map['layer7DdosDefenseConfig'] == null ? null : SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeV1.fromMap((map['layer7DdosDefenseConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
