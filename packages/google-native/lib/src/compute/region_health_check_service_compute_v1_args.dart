...
class RegionHealthCheckServiceComputeV1Args {
  ...
  RegionHealthCheckServiceComputeV1Args({
    ...
    RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1? healthStatusAggregationPolicy,
    String? name,
    ...
    String? requestId,
      ...
      healthStatusAggregationPolicy = pulumi.Input.asOptionalInput<RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1>(healthStatusAggregationPolicy),
  ...
  factory RegionHealthCheckServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckServiceComputeV1Args(
      ...
      healthStatusAggregationPolicy: map['healthStatusAggregationPolicy'] == null ? null : RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1.fromValue(map['healthStatusAggregationPolicy'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      networkEndpointGroups: map['networkEndpointGroups'] == null ? null : (map['networkEndpointGroups'] as List).cast<String>(),
      notificationEndpoints: map['notificationEndpoints'] == null ? null : (map['notificationEndpoints'] as List).cast<String>(),
