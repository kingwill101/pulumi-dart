...
class RegionHealthCheckServiceComputeV1Args {
  ...
  final pulumi.Input<
    RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1
  >?
  ...
  RegionHealthCheckServiceComputeV1Args({
    ...
    String? requestId,
       ...
       networkEndpointGroups = pulumi.Input.asOptionalInput<List<String>>(
         networkEndpointGroups,
       ),
       notificationEndpoints = pulumi.Input.asOptionalInput<List<String>>(
    ...
    return <String, dynamic>{
      ...
      'healthStatusAggregationPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1,
            String
          >(healthStatusAggregationPolicy, (value) => value.value),
      'name': ?name,
  ...
  factory RegionHealthCheckServiceComputeV1Args.fromMap(
    ...
    return RegionHealthCheckServiceComputeV1Args(
      ...
      healthStatusAggregationPolicy:
          ...
          ? null
          : RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1.fromValue(
