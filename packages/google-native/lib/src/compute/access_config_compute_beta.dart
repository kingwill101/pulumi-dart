...
import 'access_config_network_tier_compute_beta.dart';
import 'access_config_type_compute_beta.dart';

/// An access configuration attached to an instance's network interface. Only one access config per instance is supported.
class AccessConfigComputeBeta {
  ...
  final AccessConfigNetworkTierComputeBeta? networkTier;
  ...
  final AccessConfigTypeComputeBeta? type;

  /// Creates a new [AccessConfigComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkTierValue != null) {
      map['networkTier'] = networkTierValue.value;
    }
    ...
    final setPublicPtrValue = setPublicPtr;
    if (setPublicPtrValue != null) {
      map['setPublicPtr'] = setPublicPtrValue;
    }
  ...
  factory AccessConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return AccessConfigComputeBeta(
      externalIpv6:
      ...
      networkTier: map['networkTier'] == null
          ? null
          : AccessConfigNetworkTierComputeBeta.fromValue(
              map['networkTier'] as String),
      publicPtrDomainName: map['publicPtrDomainName'] == null
          ? null
          : map['publicPtrDomainName'] as String,
      setPublicPtr:
          map['setPublicPtr'] == null ? null : map['setPublicPtr'] as bool,
      type: map['type'] == null
          ? null
          : AccessConfigTypeComputeBeta.fromValue(map['type'] as String),
    );
  }
}
