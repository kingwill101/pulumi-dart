...
class AccessConfigComputeBeta {
  ...
  factory AccessConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return AccessConfigComputeBeta(
      ...
      networkTier: map['networkTier'] == null ? null : AccessConfigNetworkTierComputeBeta.fromValue(map['networkTier'] as String),
      ...
      type: map['type'] == null ? null : AccessConfigTypeComputeBeta.fromValue(map['type'] as String),
    );
  }
}
