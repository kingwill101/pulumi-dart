...
/// {@template pulumi_compute_v1_url_map_compute_v1_args_doc}
/// The set of arguments for UrlMap.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_url_map_compute_v1_args_doc}
class UrlMapComputeV1Args {
  ...
  /// Creates a new [UrlMapComputeV1Args].
  ...
  UrlMapComputeV1Args({
    HttpRouteActionComputeV1? defaultRouteAction,
    String? defaultService,
    HttpRedirectActionComputeV1? defaultUrlRedirect,
    String? description,
    HttpHeaderActionComputeV1? headerAction,
    List<HostRuleComputeV1>? hostRules,
    String? name,
    List<PathMatcherComputeV1>? pathMatchers,
    String? project,
    String? requestId,
    List<UrlMapTestComputeV1>? tests,
  })  : defaultRouteAction =
            pulumi.Input.asOptionalInput<HttpRouteActionComputeV1>(
                defaultRouteAction),
        defaultService = pulumi.Input.asOptionalInput<String>(defaultService),
        defaultUrlRedirect =
            pulumi.Input.asOptionalInput<HttpRedirectActionComputeV1>(
                defaultUrlRedirect),
        description = pulumi.Input.asOptionalInput<String>(description),
        headerAction = pulumi.Input.asOptionalInput<HttpHeaderActionComputeV1>(
            headerAction),
        hostRules =
            pulumi.Input.asOptionalInput<List<HostRuleComputeV1>>(hostRules),
        name = pulumi.Input.asOptionalInput<String>(name),
        pathMatchers = pulumi.Input.asOptionalInput<List<PathMatcherComputeV1>>(
            pathMatchers),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (defaultRouteActionValue != null) {
      map['defaultRouteAction'] = pulumi.Input.mapOptionalInputValue<
              HttpRouteActionComputeV1, Map<String, dynamic>>(
    ...
    if (defaultUrlRedirectValue != null) {
      map['defaultUrlRedirect'] = pulumi.Input.mapOptionalInputValue<
              HttpRedirectActionComputeV1, Map<String, dynamic>>(
    ...
    if (hostRulesValue != null) {
      map['hostRules'] = pulumi.Input.mapOptionalInputValue<
              List<HostRuleComputeV1>, List<Map<String, dynamic>>>(
          hostRulesValue,
          (value) =>
              pulumi.Input.encodeList<HostRuleComputeV1, Map<String, dynamic>>(
    ...
    if (pathMatchersValue != null) {
      map['pathMatchers'] = pulumi.Input.mapOptionalInputValue<
              List<PathMatcherComputeV1>, List<Map<String, dynamic>>>(
          pathMatchersValue,
          (value) => pulumi.Input.encodeList<PathMatcherComputeV1,
    ...
    if (testsValue != null) {
      map['tests'] = pulumi.Input.mapOptionalInputValue<
              List<UrlMapTestComputeV1>, List<Map<String, dynamic>>>(
          testsValue,
          (value) => pulumi.Input.encodeList<UrlMapTestComputeV1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    return map;
  }
  ...
  factory UrlMapComputeV1Args.fromMap(Map<String, dynamic> map) {
    return UrlMapComputeV1Args(
      ...
      hostRules: map['hostRules'] == null
          ? null
          : pulumi.Input.decodeList<HostRuleComputeV1>(
              map['hostRules'],
              (value) => HostRuleComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      pathMatchers: map['pathMatchers'] == null
          ? null
          : pulumi.Input.decodeList<PathMatcherComputeV1>(
              map['pathMatchers'],
              (value) => PathMatcherComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      tests: map['tests'] == null
          ? null
          : pulumi.Input.decodeList<UrlMapTestComputeV1>(
              map['tests'],
              (value) => UrlMapTestComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
    );
  }
}
