...
class UrlMapComputeV1Args {
  ...
  factory UrlMapComputeV1Args.fromMap(Map<String, dynamic> map) {
    return UrlMapComputeV1Args(
      ...
      hostRules: map['hostRules'] == null ? null : pulumi.Input.decodeList<HostRuleComputeV1>(map['hostRules'], (value) => HostRuleComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      pathMatchers: map['pathMatchers'] == null ? null : pulumi.Input.decodeList<PathMatcherComputeV1>(map['pathMatchers'], (value) => PathMatcherComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      tests: map['tests'] == null ? null : pulumi.Input.decodeList<UrlMapTestComputeV1>(map['tests'], (value) => UrlMapTestComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
