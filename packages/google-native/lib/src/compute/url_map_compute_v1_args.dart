...
class UrlMapComputeV1Args {
  ...
  UrlMapComputeV1Args({
    ...
    List<UrlMapTestComputeV1>? tests,
  }) : defaultRouteAction = pulumi
           .Input.asOptionalInput<HttpRouteActionComputeV1>(defaultRouteAction),
       ...
       hostRules = pulumi.Input.asOptionalInput<List<HostRuleComputeV1>>(
         hostRules,
       ),
    ...
    return <String, dynamic>{
      'defaultRouteAction':
          ?pulumi.Input.mapOptionalInputValue<
            HttpRouteActionComputeV1,
            Map<String, dynamic>
          >(defaultRouteAction, (value) => value.toMap()),
      'defaultService': ?defaultService,
      'defaultUrlRedirect':
          ?pulumi.Input.mapOptionalInputValue<
            HttpRedirectActionComputeV1,
            Map<String, dynamic>
