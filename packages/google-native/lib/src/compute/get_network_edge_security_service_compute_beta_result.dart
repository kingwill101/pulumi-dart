...
class GetNetworkEdgeSecurityServiceComputeBetaResult {
  ...
  /// Creates a new [GetNetworkEdgeSecurityServiceComputeBetaResult].
  ...
  GetNetworkEdgeSecurityServiceComputeBetaResult({
  ...
  factory GetNetworkEdgeSecurityServiceComputeBetaResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetNetworkEdgeSecurityServiceComputeBetaResult(
