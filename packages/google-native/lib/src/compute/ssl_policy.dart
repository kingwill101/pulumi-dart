...
class SslPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ServerTlsSettingsResponse> tlsSettings;
  /// If potential misconfigurations are detected for this SSL policy, this field will be populated with warning messages.
  late final pulumi.Output<List<SslPolicyWarningsItemResponse>> warnings;

  /// Creates a new [SslPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SslPolicy]. {@macro pulumi_compute_alpha_ssl_policy_args_doc}
  ...
  SslPolicy(
    ...
    this.tlsSettings = registerOutput<ServerTlsSettingsResponse>('tlsSettings');
    this.warnings = registerOutput<List<SslPolicyWarningsItemResponse>>('warnings');
  }
}
