...
class GetFirewallComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['allowed'] = pulumi.Input.encodeList<
        FirewallAllowedItemResponseComputeV1,
        Map<String, dynamic>>(allowed, (value) => value.toMap());
    map['creationTimestamp'] = creationTimestamp;
    map['denied'] = pulumi.Input.encodeList<FirewallDeniedItemResponseComputeV1,
  ...
  factory GetFirewallComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetFirewallComputeV1Result(
      allowed: pulumi.Input.decodeList<FirewallAllowedItemResponseComputeV1>(
          map['allowed'],
          (value) => FirewallAllowedItemResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      denied: pulumi.Input.decodeList<FirewallDeniedItemResponseComputeV1>(
          map['denied'],
          (value) => FirewallDeniedItemResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      logConfig: FirewallLogConfigResponseComputeV1.fromMap(
