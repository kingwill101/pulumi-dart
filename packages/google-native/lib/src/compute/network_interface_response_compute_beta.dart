...
class NetworkInterfaceResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': pulumi.Input.encodeList<AccessConfigResponseComputeBeta, Map<String, dynamic>>(accessConfigs, (value) => value.toMap()),
      'aliasIpRanges': pulumi.Input.encodeList<AliasIpRangeResponseComputeBeta, Map<String, dynamic>>(aliasIpRanges, (value) => value.toMap()),
      'fingerprint': fingerprint,
      'internalIpv6PrefixLength': internalIpv6PrefixLength,
      'ipv6AccessConfigs': pulumi.Input.encodeList<AccessConfigResponseComputeBeta, Map<String, dynamic>>(ipv6AccessConfigs, (value) => value.toMap()),
  ...
  factory NetworkInterfaceResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponseComputeBeta(
      accessConfigs: pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(map['accessConfigs'], (value) => AccessConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: pulumi.Input.decodeList<AliasIpRangeResponseComputeBeta>(map['aliasIpRanges'], (value) => AliasIpRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      fingerprint: map['fingerprint'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(map['ipv6AccessConfigs'], (value) => AccessConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
