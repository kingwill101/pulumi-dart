...
import 'attached_disk_initialize_params_architecture_compute_v1.dart';
import 'attached_disk_initialize_params_on_update_action_compute_v1.dart';
...
class AttachedDiskInitializeParamsComputeV1 {
  /// The architecture of the attached disk. Valid values are arm64 or x86_64.
  final AttachedDiskInitializeParamsArchitectureComputeV1? architecture;
  ...
  final AttachedDiskInitializeParamsOnUpdateActionComputeV1? onUpdateAction;
  ...
  final CustomerEncryptionKeyComputeV1? sourceImageEncryptionKey;
  /// The source snapshot to create this disk. When creating a new instance, one of initializeParams.sourceSnapshot or initializeParams.sourceImage or disks.source is required except for local SSD. To create a disk with a snapshot that you created, specify the snapshot name in the following format: global/snapshots/my-backup If the source snapshot is deleted later, this field will not be set.
  final String? sourceSnapshot;
  /// The customer-supplied encryption key of the source snapshot.
  final CustomerEncryptionKeyComputeV1? sourceSnapshotEncryptionKey;

  /// Creates a new [AttachedDiskInitializeParamsComputeV1].
  ...
  AttachedDiskInitializeParamsComputeV1({
    this.architecture,
    this.description,
    this.diskName,
    this.diskSizeGb,
  ...
  factory AttachedDiskInitializeParamsComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsComputeV1(
      architecture: map['architecture'] == null ? null : AttachedDiskInitializeParamsArchitectureComputeV1.fromValue(map['architecture'] as String),
      ...
      onUpdateAction: map['onUpdateAction'] == null ? null : AttachedDiskInitializeParamsOnUpdateActionComputeV1.fromValue(map['onUpdateAction'] as String),
