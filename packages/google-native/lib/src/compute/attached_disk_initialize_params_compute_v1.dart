...
class AttachedDiskInitializeParamsComputeV1 {
  ...
  factory AttachedDiskInitializeParamsComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return AttachedDiskInitializeParamsComputeV1(
      architecture: map['architecture'] == null
          ? null
          : AttachedDiskInitializeParamsArchitectureComputeV1.fromValue(
      ...
      onUpdateAction: map['onUpdateAction'] == null
          ? null
          : AttachedDiskInitializeParamsOnUpdateActionComputeV1.fromValue(
