...
class BackendBucketCdnPolicyComputeV1 {
  ...
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeV1>? bypassCacheOnRequestHeaders;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyComputeV1>? negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': ?bypassCacheOnRequestHeaders == null ? null : pulumi.Input.encodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeV1, Map<String, dynamic>>(bypassCacheOnRequestHeaders!, (value) => value.toMap()),
      ...
      'negativeCachingPolicy': ?negativeCachingPolicy == null ? null : pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyComputeV1, Map<String, dynamic>>(negativeCachingPolicy!, (value) => value.toMap()),
  ...
  factory BackendBucketCdnPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyComputeV1(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null ? null : pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeV1>(map['bypassCacheOnRequestHeaders'], (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : BackendBucketCdnPolicyCacheKeyPolicyComputeV1.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null ? null : BackendBucketCdnPolicyCacheModeComputeV1.fromValue(map['cacheMode'] as String),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyComputeV1>(map['negativeCachingPolicy'], (value) => BackendBucketCdnPolicyNegativeCachingPolicyComputeV1.fromMap((value as Map).cast<String, dynamic>())),
