...
class GetNodeTemplateComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['disks'] = pulumi.Input.encodeList<LocalDiskResponseComputeV1,
  ...
  factory GetNodeTemplateComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetNodeTemplateComputeV1Result(
      accelerators: pulumi.Input.decodeList<AcceleratorConfigResponseComputeV1>(
          map['accelerators'],
      ...
      disks: pulumi.Input.decodeList<LocalDiskResponseComputeV1>(
          map['disks'],
          (value) => LocalDiskResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      nodeTypeFlexibility:
          NodeTemplateNodeTypeFlexibilityResponseComputeV1.fromMap(
              (map['nodeTypeFlexibility'] as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      serverBinding: ServerBindingResponseComputeV1.fromMap(
