...
class HttpHeaderActionResponseComputeV1 {
    ...
    return <String, dynamic>{
      'requestHeadersToAdd':
          pulumi.Input.encodeList<
            HttpHeaderOptionResponseComputeV1,
            Map<String, dynamic>
  ...
  factory HttpHeaderActionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpHeaderActionResponseComputeV1(
      requestHeadersToAdd:
          pulumi.Input.decodeList<HttpHeaderOptionResponseComputeV1>(
            map['requestHeadersToAdd'],
            (value) => HttpHeaderOptionResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      requestHeadersToRemove: (map['requestHeadersToRemove'] as List)
          .cast<String>(),
      responseHeadersToAdd:
          pulumi.Input.decodeList<HttpHeaderOptionResponseComputeV1>(
      ...
      responseHeadersToRemove: (map['responseHeadersToRemove'] as List)
          .cast<String>(),
    );
  }
}
