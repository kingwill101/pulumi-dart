...
/// {@template pulumi_compute_alpha_resource_policy_iam_binding_args_doc}
/// The set of arguments for ResourcePolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_resource_policy_iam_binding_args_doc}
class ResourcePolicyIamBindingArgs {
  ...
  /// Creates a new [ResourcePolicyIamBindingArgs].
  ...
  factory ResourcePolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamBindingArgs(
