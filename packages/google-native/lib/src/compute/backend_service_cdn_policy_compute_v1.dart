...
import 'backend_service_cdn_policy_bypass_cache_on_request_header_compute_v1.dart';
import 'backend_service_cdn_policy_cache_mode_compute_v1.dart';
import 'backend_service_cdn_policy_negative_caching_policy_compute_v1.dart';
import 'cache_key_policy_compute_v1.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicyComputeV1 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1>? bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final CacheKeyPolicyComputeV1? cacheKeyPolicy;
  ...
  final BackendServiceCdnPolicyCacheModeComputeV1? cacheMode;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1>? negativeCachingPolicy;
  ...
  /// Creates a new [BackendServiceCdnPolicyComputeV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': ?bypassCacheOnRequestHeaders == null ? null : pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1, Map<String, dynamic>>(bypassCacheOnRequestHeaders!, (value) => value.toMap()),
      ...
      'negativeCachingPolicy': ?negativeCachingPolicy == null ? null : pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1, Map<String, dynamic>>(negativeCachingPolicy!, (value) => value.toMap()),
  ...
  factory BackendServiceCdnPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyComputeV1(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null ? null : pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : CacheKeyPolicyComputeV1.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null ? null : BackendServiceCdnPolicyCacheModeComputeV1.fromValue(map['cacheMode'] as String),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyComputeV1.fromMap((value as Map).cast<String, dynamic>())),
