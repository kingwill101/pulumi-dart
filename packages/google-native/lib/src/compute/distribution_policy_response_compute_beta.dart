...
class DistributionPolicyResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'zones': pulumi.Input.encodeList<DistributionPolicyZoneConfigurationResponseComputeBeta, Map<String, dynamic>>(zones, (value) => value.toMap()),
    };
  }
  ...
  factory DistributionPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return DistributionPolicyResponseComputeBeta(
      ...
      zones: pulumi.Input.decodeList<DistributionPolicyZoneConfigurationResponseComputeBeta>(map['zones'], (value) => DistributionPolicyZoneConfigurationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
