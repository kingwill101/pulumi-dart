...
class GetFirewallPolicyComputeV1Result {
  ...
  /// Creates a new [GetFirewallPolicyComputeV1Result].
  ...
  GetFirewallPolicyComputeV1Result({
  ...
  factory GetFirewallPolicyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetFirewallPolicyComputeV1Result(
      associations:
