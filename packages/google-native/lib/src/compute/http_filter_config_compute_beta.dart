...
class HttpFilterConfigComputeBeta {
  ...
  /// Creates a new [HttpFilterConfigComputeBeta].
  ...
  factory HttpFilterConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpFilterConfigComputeBeta(
      ...
      configTypeUrl: map['configTypeUrl'] == null
          ? null
          : map['configTypeUrl'] as String,
      filterName: map['filterName'] == null
          ? null
          : map['filterName'] as String,
    );
  }
}
