...
class RegionBackendServiceComputeBetaArgs {
  ...
  RegionBackendServiceComputeBetaArgs({
    ...
    List<BackendServiceUsedByComputeBeta>? usedBy,
       ...
       backends = pulumi.Input.asOptionalInput<List<BackendComputeBeta>>(
         backends,
       ),
       cdnPolicy =
       ...
       circuitBreakers = pulumi
           .Input.asOptionalInput<CircuitBreakersComputeBeta>(circuitBreakers),
       compressionMode =
       ...
       serviceBindings = pulumi.Input.asOptionalInput<List<String>>(
         serviceBindings,
       ),
       ...
       sessionAffinity =
           ...
           >(sessionAffinity),
       subsetting = pulumi.Input.asOptionalInput<SubsettingComputeBeta>(
         subsetting,
       ),
    ...
    return <String, dynamic>{
      ...
      'compressionMode':
          ?pulumi.Input.mapOptionalInputValue<
            RegionBackendServiceCompressionModeComputeBeta,
            String
          >(compressionMode, (value) => value.value),
      'connectionDraining':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'ipAddressSelectionPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            RegionBackendServiceIpAddressSelectionPolicyComputeBeta,
            String
          >(ipAddressSelectionPolicy, (value) => value.value),
      'loadBalancingScheme':
          ?pulumi.Input.mapOptionalInputValue<
            RegionBackendServiceLoadBalancingSchemeComputeBeta,
            String
      ...
      'localityLbPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            RegionBackendServiceLocalityLbPolicyComputeBeta,
            String
          >(localityLbPolicy, (value) => value.value),
      'logConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'sessionAffinity':
          ?pulumi.Input.mapOptionalInputValue<
            RegionBackendServiceSessionAffinityComputeBeta,
            String
          >(sessionAffinity, (value) => value.value),
      'subsetting':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      localityLbPolicies: map['localityLbPolicies'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
