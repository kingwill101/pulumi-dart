...
import 'region_backend_service_compression_mode_compute_beta.dart';
import 'region_backend_service_ip_address_selection_policy_compute_beta.dart';
import 'region_backend_service_load_balancing_scheme_compute_beta.dart';
import 'region_backend_service_locality_lb_policy_compute_beta.dart';
import 'region_backend_service_protocol_compute_beta.dart';
import 'region_backend_service_session_affinity_compute_beta.dart';
import 'security_settings_compute_beta.dart';
import 'subsetting_compute_beta.dart';

/// {@template pulumi_compute_beta_region_backend_service_compute_beta_args_doc}
/// The set of arguments for RegionBackendService.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_backend_service_compute_beta_args_doc}
class RegionBackendServiceComputeBetaArgs {
  ...
  final pulumi.Input<RegionBackendServiceCompressionModeComputeBeta>? compressionMode;
  ...
  final pulumi.Input<RegionBackendServiceIpAddressSelectionPolicyComputeBeta>? ipAddressSelectionPolicy;
  /// Specifies the load balancer type. A backend service created for one type of load balancer cannot be used with another. For more information, refer to Choosing a load balancer.
  final pulumi.Input<RegionBackendServiceLoadBalancingSchemeComputeBeta>? loadBalancingScheme;
  ...
  final pulumi.Input<RegionBackendServiceLocalityLbPolicyComputeBeta>? localityLbPolicy;
  ...
  final pulumi.Input<RegionBackendServiceProtocolComputeBeta>? protocol;
  ...
  final pulumi.Input<RegionBackendServiceSessionAffinityComputeBeta>? sessionAffinity;
  ...
  /// Creates a new [RegionBackendServiceComputeBetaArgs].
  ...
  /// [usedBy] Optional.
  RegionBackendServiceComputeBetaArgs({
    int? affinityCookieTtlSec,
    List<BackendComputeBeta>? backends,
    BackendServiceCdnPolicyComputeBeta? cdnPolicy,
    CircuitBreakersComputeBeta? circuitBreakers,
    RegionBackendServiceCompressionModeComputeBeta? compressionMode,
    ConnectionDrainingComputeBeta? connectionDraining,
    BackendServiceConnectionTrackingPolicyComputeBeta? connectionTrackingPolicy,
    ConsistentHashLoadBalancerSettingsComputeBeta? consistentHash,
    List<String>? customRequestHeaders,
    List<String>? customResponseHeaders,
    String? description,
    bool? enableCDN,
    BackendServiceFailoverPolicyComputeBeta? failoverPolicy,
    List<String>? healthChecks,
    BackendServiceIAPComputeBeta? iap,
    RegionBackendServiceIpAddressSelectionPolicyComputeBeta? ipAddressSelectionPolicy,
    RegionBackendServiceLoadBalancingSchemeComputeBeta? loadBalancingScheme,
    List<BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta>? localityLbPolicies,
    RegionBackendServiceLocalityLbPolicyComputeBeta? localityLbPolicy,
    BackendServiceLogConfigComputeBeta? logConfig,
    DurationComputeBeta? maxStreamDuration,
    Map<String, String>? metadatas,
    String? name,
    String? network,
    OutlierDetectionComputeBeta? outlierDetection,
    int? port,
    String? portName,
    String? project,
    RegionBackendServiceProtocolComputeBeta? protocol,
    required String region,
    String? requestId,
    SecuritySettingsComputeBeta? securitySettings,
    List<String>? serviceBindings,
    String? serviceLbPolicy,
    RegionBackendServiceSessionAffinityComputeBeta? sessionAffinity,
    SubsettingComputeBeta? subsetting,
    int? timeoutSec,
    List<BackendServiceUsedByComputeBeta>? usedBy,
  }) :
      ...
      compressionMode = pulumi.Input.asOptionalInput<RegionBackendServiceCompressionModeComputeBeta>(compressionMode),
      ...
      ipAddressSelectionPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceIpAddressSelectionPolicyComputeBeta>(ipAddressSelectionPolicy),
      loadBalancingScheme = pulumi.Input.asOptionalInput<RegionBackendServiceLoadBalancingSchemeComputeBeta>(loadBalancingScheme),
      ...
      localityLbPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceLocalityLbPolicyComputeBeta>(localityLbPolicy),
      ...
      protocol = pulumi.Input.asOptionalInput<RegionBackendServiceProtocolComputeBeta>(protocol),
      ...
      sessionAffinity = pulumi.Input.asOptionalInput<RegionBackendServiceSessionAffinityComputeBeta>(sessionAffinity),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceCompressionModeComputeBeta, String>(compressionMode, (value) => value.value),
      ...
      'ipAddressSelectionPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceIpAddressSelectionPolicyComputeBeta, String>(ipAddressSelectionPolicy, (value) => value.value),
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLoadBalancingSchemeComputeBeta, String>(loadBalancingScheme, (value) => value.value),
      ...
      'localityLbPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLocalityLbPolicyComputeBeta, String>(localityLbPolicy, (value) => value.value),
      ...
      'portName': ?portName,
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceProtocolComputeBeta, String>(protocol, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
      ...
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceSessionAffinityComputeBeta, String>(sessionAffinity, (value) => value.value),
  ...
  factory RegionBackendServiceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceComputeBetaArgs(
      affinityCookieTtlSec: map['affinityCookieTtlSec'] == null ? null : map['affinityCookieTtlSec'] as int,
      backends: map['backends'] == null ? null : pulumi.Input.decodeList<BackendComputeBeta>(map['backends'], (value) => BackendComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      cdnPolicy: map['cdnPolicy'] == null ? null : BackendServiceCdnPolicyComputeBeta.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: map['circuitBreakers'] == null ? null : CircuitBreakersComputeBeta.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] == null ? null : RegionBackendServiceCompressionModeComputeBeta.fromValue(map['compressionMode'] as String),
      connectionDraining: map['connectionDraining'] == null ? null : ConnectionDrainingComputeBeta.fromMap((map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : BackendServiceConnectionTrackingPolicyComputeBeta.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: map['consistentHash'] == null ? null : ConsistentHashLoadBalancerSettingsComputeBeta.fromMap((map['consistentHash'] as Map).cast<String, dynamic>()),
      customRequestHeaders: map['customRequestHeaders'] == null ? null : (map['customRequestHeaders'] as List).cast<String>(),
      customResponseHeaders: map['customResponseHeaders'] == null ? null : (map['customResponseHeaders'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      enableCDN: map['enableCDN'] == null ? null : map['enableCDN'] as bool,
      failoverPolicy: map['failoverPolicy'] == null ? null : BackendServiceFailoverPolicyComputeBeta.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>()),
      healthChecks: map['healthChecks'] == null ? null : (map['healthChecks'] as List).cast<String>(),
      iap: map['iap'] == null ? null : BackendServiceIAPComputeBeta.fromMap((map['iap'] as Map).cast<String, dynamic>()),
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : RegionBackendServiceIpAddressSelectionPolicyComputeBeta.fromValue(map['ipAddressSelectionPolicy'] as String),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : RegionBackendServiceLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String),
      localityLbPolicies: map['localityLbPolicies'] == null ? null : pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta>(map['localityLbPolicies'], (value) => BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] == null ? null : RegionBackendServiceLocalityLbPolicyComputeBeta.fromValue(map['localityLbPolicy'] as String),
      logConfig: map['logConfig'] == null ? null : BackendServiceLogConfigComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      maxStreamDuration: map['maxStreamDuration'] == null ? null : DurationComputeBeta.fromMap((map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      metadatas: map['metadatas'] == null ? null : (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      outlierDetection: map['outlierDetection'] == null ? null : OutlierDetectionComputeBeta.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      portName: map['portName'] == null ? null : map['portName'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      protocol: map['protocol'] == null ? null : RegionBackendServiceProtocolComputeBeta.fromValue(map['protocol'] as String),
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      securitySettings: map['securitySettings'] == null ? null : SecuritySettingsComputeBeta.fromMap((map['securitySettings'] as Map).cast<String, dynamic>()),
      serviceBindings: map['serviceBindings'] == null ? null : (map['serviceBindings'] as List).cast<String>(),
      serviceLbPolicy: map['serviceLbPolicy'] == null ? null : map['serviceLbPolicy'] as String,
      sessionAffinity: map['sessionAffinity'] == null ? null : RegionBackendServiceSessionAffinityComputeBeta.fromValue(map['sessionAffinity'] as String),
      subsetting: map['subsetting'] == null ? null : SubsettingComputeBeta.fromMap((map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] == null ? null : map['timeoutSec'] as int,
      usedBy: map['usedBy'] == null ? null : pulumi.Input.decodeList<BackendServiceUsedByComputeBeta>(map['usedBy'], (value) => BackendServiceUsedByComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
