...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig {
  ...
  final SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyType? enforceOnKeyType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKeyType': ?enforceOnKeyType == null ? null : enforceOnKeyType!.value,
    };
  }
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig(
      ...
      enforceOnKeyType: map['enforceOnKeyType'] == null ? null : SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyType.fromValue(map['enforceOnKeyType'] as String),
    );
  }
}
