...
class InstanceGroupManagerInstanceLifecyclePolicyComputeBeta {
  ...
  final InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailureComputeBeta? defaultActionOnFailure;
  /// A bit indicating whether to forcefully apply the group's latest configuration when repairing a VM. Valid options are: - NO (default): If configuration updates are available, they are not forcefully applied during repair. Instead, configuration updates are applied according to the group's update policy. - YES: If configuration updates are available, they are applied during repair.
  final InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepairComputeBeta? forceUpdateOnRepair;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultActionOnFailure': ?defaultActionOnFailure == null ? null : defaultActionOnFailure!.value,
  ...
  factory InstanceGroupManagerInstanceLifecyclePolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerInstanceLifecyclePolicyComputeBeta(
      defaultActionOnFailure: map['defaultActionOnFailure'] == null ? null : InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailureComputeBeta.fromValue(map['defaultActionOnFailure'] as String),
      forceUpdateOnRepair: map['forceUpdateOnRepair'] == null ? null : InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepairComputeBeta.fromValue(map['forceUpdateOnRepair'] as String),
    );
  }
}
