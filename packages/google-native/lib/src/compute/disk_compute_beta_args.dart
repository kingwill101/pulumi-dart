...
class DiskComputeBetaArgs {
  ...
  DiskComputeBetaArgs({
    ...
    String? zone,
      ...
      architecture = pulumi.Input.asOptionalInput<DiskArchitectureComputeBeta>(architecture),
      asyncPrimaryDisk = pulumi.Input.asOptionalInput<DiskAsyncReplicationComputeBeta>(asyncPrimaryDisk),
      description = pulumi.Input.asOptionalInput<String>(description),
      diskEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeBeta>(diskEncryptionKey),
      ...
      interface = pulumi.Input.asOptionalInput<DiskInterfaceComputeBeta>(interface),
      ...
      storageType = pulumi.Input.asOptionalInput<DiskStorageTypeComputeBeta>(storageType),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<DiskArchitectureComputeBeta, String>(architecture, (value) => value.value),
      'asyncPrimaryDisk': ?pulumi.Input.mapOptionalInputValue<DiskAsyncReplicationComputeBeta, Map<String, dynamic>>(asyncPrimaryDisk, (value) => value.toMap()),
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<DiskInterfaceComputeBeta, String>(interface, (value) => value.value),
      'labels': ?labels,
      ...
      'name': ?name,
      'options': ?options,
      'params': ?pulumi.Input.mapOptionalInputValue<DiskParamsComputeBeta, Map<String, dynamic>>(params, (value) => value.toMap()),
      ...
      'storageType': ?pulumi.Input.mapOptionalInputValue<DiskStorageTypeComputeBeta, String>(storageType, (value) => value.value),
      'type': ?type,
  ...
  factory DiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskComputeBetaArgs(
      architecture: map['architecture'] == null ? null : DiskArchitectureComputeBeta.fromValue(map['architecture'] as String),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : DiskAsyncReplicationComputeBeta.fromMap((map['asyncPrimaryDisk'] as Map).cast<String, dynamic>()),
      ...
      interface: map['interface'] == null ? null : DiskInterfaceComputeBeta.fromValue(map['interface'] as String),
      ...
      multiWriter: map['multiWriter'] == null ? null : map['multiWriter'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      options: map['options'] == null ? null : map['options'] as String,
      params: map['params'] == null ? null : DiskParamsComputeBeta.fromMap((map['params'] as Map).cast<String, dynamic>()),
      physicalBlockSizeBytes: map['physicalBlockSizeBytes'] == null ? null : map['physicalBlockSizeBytes'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      provisionedIops: map['provisionedIops'] == null ? null : map['provisionedIops'] as String,
      provisionedThroughput: map['provisionedThroughput'] == null ? null : map['provisionedThroughput'] as String,
      ...
      sourceInstantSnapshot: map['sourceInstantSnapshot'] == null ? null : map['sourceInstantSnapshot'] as String,
      ...
      sourceStorageObject: map['sourceStorageObject'] == null ? null : map['sourceStorageObject'] as String,
      storageType: map['storageType'] == null ? null : DiskStorageTypeComputeBeta.fromValue(map['storageType'] as String),
