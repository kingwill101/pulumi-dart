...
class ForwardingRuleArgs {
  ...
  ForwardingRuleArgs({
    ...
    String? target,
        ...
        ipProtocol =
            pulumi.Input.asOptionalInput<ForwardingRuleIpProtocol>(ipProtocol),
        ipVersion =
            pulumi.Input.asOptionalInput<ForwardingRuleIpVersion>(ipVersion),
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      ipProtocol: map['ipProtocol'] == null
          ? null
          : ForwardingRuleIpProtocol.fromValue(map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null
          ? null
          : ForwardingRuleIpVersion.fromValue(map['ipVersion'] as String),
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null
          ? null
          : ForwardingRuleLoadBalancingScheme.fromValue(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : ForwardingRuleNetworkTier.fromValue(map['networkTier'] as String),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null
          ? null
          : ForwardingRulePscConnectionStatus.fromValue(
