...
class ForwardingRuleArgs {
  ...
  ForwardingRuleArgs({
    ...
    String? ipAddress,
    String? ipCollection,
    ForwardingRuleIpProtocol? ipProtocol,
    ForwardingRuleIpVersion? ipVersion,
    bool? isMirroringCollector,
    Map<String, String>? labels,
    ForwardingRuleLoadBalancingScheme? loadBalancingScheme,
    List<MetadataFilter>? metadataFilters,
    String? name,
    String? network,
    ForwardingRuleNetworkTier? networkTier,
    bool? noAutomateDnsZone,
    String? portRange,
    List<String>? ports,
    String? project,
    ForwardingRulePscConnectionStatus? pscConnectionStatus,
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : ForwardingRuleIpProtocol.fromValue(map['ipProtocol'] as String),
      ipVersion: map['ipVersion'] == null ? null : ForwardingRuleIpVersion.fromValue(map['ipVersion'] as String),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : map['isMirroringCollector'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : ForwardingRuleLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String),
      ...
      networkTier: map['networkTier'] == null ? null : ForwardingRuleNetworkTier.fromValue(map['networkTier'] as String),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : ForwardingRulePscConnectionStatus.fromValue(map['pscConnectionStatus'] as String),
