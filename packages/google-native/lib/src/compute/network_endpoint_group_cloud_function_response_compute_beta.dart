...
class NetworkEndpointGroupCloudFunctionResponseComputeBeta {
  ...
  /// Creates a new [NetworkEndpointGroupCloudFunctionResponseComputeBeta].
  ...
  factory NetworkEndpointGroupCloudFunctionResponseComputeBeta.fromMap(Map<String, dynamic> map) {
