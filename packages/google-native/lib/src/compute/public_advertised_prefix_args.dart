...
class PublicAdvertisedPrefixArgs {
  ...
  factory PublicAdvertisedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixArgs(
      ...
      pdpScope: map['pdpScope'] == null ? null : PublicAdvertisedPrefixPdpScope.fromValue(map['pdpScope'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      status: map['status'] == null ? null : PublicAdvertisedPrefixStatus.fromValue(map['status'] as String),
    );
  }
}
