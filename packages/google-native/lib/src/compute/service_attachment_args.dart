...
class ServiceAttachmentArgs {
  ...
  ServiceAttachmentArgs({
    ServiceAttachmentConnectionPreference? connectionPreference,
    ...
    ServiceAttachmentTunnelingConfig? tunnelingConfig,
      ...
      connectionPreference = pulumi.Input.asOptionalInput<ServiceAttachmentConnectionPreference>(connectionPreference),
      consumerAcceptLists = pulumi.Input.asOptionalInput<List<ServiceAttachmentConsumerProjectLimit>>(consumerAcceptLists),
  ...
  factory ServiceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentArgs(
      connectionPreference: map['connectionPreference'] == null ? null : ServiceAttachmentConnectionPreference.fromValue(map['connectionPreference'] as String),
      consumerAcceptLists: map['consumerAcceptLists'] == null ? null : pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimit>(map['consumerAcceptLists'], (value) => ServiceAttachmentConsumerProjectLimit.fromMap((value as Map).cast<String, dynamic>())),
      ...
      propagatedConnectionLimit: map['propagatedConnectionLimit'] == null ? null : map['propagatedConnectionLimit'] as int,
      ...
      tunnelingConfig: map['tunnelingConfig'] == null ? null : ServiceAttachmentTunnelingConfig.fromMap((map['tunnelingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
