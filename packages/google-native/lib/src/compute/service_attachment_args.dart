...
class ServiceAttachmentArgs {
  ...
  ServiceAttachmentArgs({
    ...
    ServiceAttachmentTunnelingConfig? tunnelingConfig,
       ...
       enableProxyProtocol = pulumi.Input.asOptionalInput<bool>(
         enableProxyProtocol,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       natSubnets = pulumi.Input.asOptionalInput<List<String>>(natSubnets),
       producerForwardingRule = pulumi.Input.asOptionalInput<String>(
         producerForwardingRule,
       ),
       project = pulumi.Input.asOptionalInput<String>(project),
       propagatedConnectionLimit = pulumi.Input.asOptionalInput<int>(
         propagatedConnectionLimit,
       ),
       reconcileConnections = pulumi.Input.asOptionalInput<bool>(
  ...
  factory ServiceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentArgs(
      connectionPreference: map['connectionPreference'] == null
          ? null
          : ServiceAttachmentConnectionPreference.fromValue(
              map['connectionPreference'] as String,
            ),
      consumerAcceptLists: map['consumerAcceptLists'] == null
          ? null
          : pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimit>(
              map['consumerAcceptLists'],
              (value) => ServiceAttachmentConsumerProjectLimit.fromMap(
      ...
      targetService: map['targetService'] == null
          ? null
          : map['targetService'] as String,
