...
class NetworkInterface {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': ?accessConfigs == null ? null : pulumi.Input.encodeList<AccessConfig, Map<String, dynamic>>(accessConfigs!, (value) => value.toMap()),
      'aliasIpRanges': ?aliasIpRanges == null ? null : pulumi.Input.encodeList<AliasIpRange, Map<String, dynamic>>(aliasIpRanges!, (value) => value.toMap()),
      'internalIpv6PrefixLength': ?internalIpv6PrefixLength,
      'ipv6AccessConfigs': ?ipv6AccessConfigs == null ? null : pulumi.Input.encodeList<AccessConfig, Map<String, dynamic>>(ipv6AccessConfigs!, (value) => value.toMap()),
      ...
      'subinterfaces': ?subinterfaces == null ? null : pulumi.Input.encodeList<NetworkInterfaceSubInterface, Map<String, dynamic>>(subinterfaces!, (value) => value.toMap()),
  ...
  factory NetworkInterface.fromMap(Map<String, dynamic> map) {
    return NetworkInterface(
      accessConfigs: map['accessConfigs'] == null ? null : pulumi.Input.decodeList<AccessConfig>(map['accessConfigs'], (value) => AccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null ? null : pulumi.Input.decodeList<AliasIpRange>(map['aliasIpRanges'], (value) => AliasIpRange.fromMap((value as Map).cast<String, dynamic>())),
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] == null ? null : map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: map['ipv6AccessConfigs'] == null ? null : pulumi.Input.decodeList<AccessConfig>(map['ipv6AccessConfigs'], (value) => AccessConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      parentNicName: map['parentNicName'] == null ? null : map['parentNicName'] as String,
      queueCount: map['queueCount'] == null ? null : map['queueCount'] as int,
      stackType: map['stackType'] == null ? null : NetworkInterfaceStackType.fromValue(map['stackType'] as String),
      subinterfaces: map['subinterfaces'] == null ? null : pulumi.Input.decodeList<NetworkInterfaceSubInterface>(map['subinterfaces'], (value) => NetworkInterfaceSubInterface.fromMap((value as Map).cast<String, dynamic>())),
