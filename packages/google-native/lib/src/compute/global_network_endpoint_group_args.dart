    ...
    return <String, dynamic>{
      ...
      'clientPortMappingMode':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalNetworkEndpointGroupClientPortMappingMode,
            String
          >(clientPortMappingMode, (value) => value.value),
      'cloudFunction':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GlobalNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupArgs(
      ...
      clientPortMappingMode: map['clientPortMappingMode'] == null
          ? null
          : GlobalNetworkEndpointGroupClientPortMappingMode.fromValue(
      ...
      networkEndpointType: map['networkEndpointType'] == null
          ? null
          : GlobalNetworkEndpointGroupNetworkEndpointType.fromValue(
      ...
      type: map['type'] == null
          ? null
          : GlobalNetworkEndpointGroupType.fromValue(map['type'] as String),
    );
  }
}
