...
/// {@template pulumi_compute_alpha_global_network_endpoint_group_args_doc}
/// The set of arguments for GlobalNetworkEndpointGroup.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_global_network_endpoint_group_args_doc}
class GlobalNetworkEndpointGroupArgs {
  ...
  final pulumi.Input<GlobalNetworkEndpointGroupClientPortMappingMode>? clientPortMappingMode;
  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  ...
  final pulumi.Input<GlobalNetworkEndpointGroupNetworkEndpointType>? networkEndpointType;
  ...
  GlobalNetworkEndpointGroupArgs({
    ...
    GlobalNetworkEndpointGroupClientPortMappingMode? clientPortMappingMode,
    ...
    String? name,
    String? network,
    GlobalNetworkEndpointGroupNetworkEndpointType? networkEndpointType,
    String? project,
    ...
    String? subnetwork,
    GlobalNetworkEndpointGroupType? type,
  }) :
      annotations = pulumi.Input.asOptionalInput<Map<String, String>>(annotations),
      appEngine = pulumi.Input.asOptionalInput<NetworkEndpointGroupAppEngine>(appEngine),
      clientPortMappingMode = pulumi.Input.asOptionalInput<GlobalNetworkEndpointGroupClientPortMappingMode>(clientPortMappingMode),
      ...
      networkEndpointType = pulumi.Input.asOptionalInput<GlobalNetworkEndpointGroupNetworkEndpointType>(networkEndpointType),
      ...
      type = pulumi.Input.asOptionalInput<GlobalNetworkEndpointGroupType>(type);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientPortMappingMode': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupClientPortMappingMode, String>(clientPortMappingMode, (value) => value.value),
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupNetworkEndpointType, String>(networkEndpointType, (value) => value.value),
      'project': ?project,
      'pscData': ?pscData,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupType, String>(type, (value) => value.value),
    };
  }
  ...
  factory GlobalNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupArgs(
      ...
      appEngine: map['appEngine'] == null ? null : NetworkEndpointGroupAppEngine.fromMap((map['appEngine'] as Map).cast<String, dynamic>()),
      clientPortMappingMode: map['clientPortMappingMode'] == null ? null : GlobalNetworkEndpointGroupClientPortMappingMode.fromValue(map['clientPortMappingMode'] as String),
      cloudFunction: map['cloudFunction'] == null ? null : NetworkEndpointGroupCloudFunction.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>()),
      cloudRun: map['cloudRun'] == null ? null : NetworkEndpointGroupCloudRun.fromMap((map['cloudRun'] as Map).cast<String, dynamic>()),
      defaultPort: map['defaultPort'] == null ? null : map['defaultPort'] as int,
      description: map['description'] == null ? null : map['description'] as String,
      loadBalancer: map['loadBalancer'] == null ? null : NetworkEndpointGroupLbNetworkEndpointGroup.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkEndpointType: map['networkEndpointType'] == null ? null : GlobalNetworkEndpointGroupNetworkEndpointType.fromValue(map['networkEndpointType'] as String),
      ...
      serverlessDeployment: map['serverlessDeployment'] == null ? null : NetworkEndpointGroupServerlessDeployment.fromMap((map['serverlessDeployment'] as Map).cast<String, dynamic>()),
      subnetwork: map['subnetwork'] == null ? null : map['subnetwork'] as String,
      type: map['type'] == null ? null : GlobalNetworkEndpointGroupType.fromValue(map['type'] as String),
    );
  }
}
