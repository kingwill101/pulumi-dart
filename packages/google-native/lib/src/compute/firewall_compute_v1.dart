...
class FirewallComputeV1 extends pulumi.CustomResource {
  ...
  FirewallComputeV1(
    ...
    this.allowed = registerOutput<List<FirewallAllowedItemResponseComputeV1>>(
      'allowed',
    );
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.denied = registerOutput<List<FirewallDeniedItemResponseComputeV1>>(
      'denied',
    );
    ...
    this.logConfig = registerOutput<FirewallLogConfigResponseComputeV1>(
      'logConfig',
    );
