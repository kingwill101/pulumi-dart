...
class RouterBgpPeerBfd {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'packetMode': ?packetMode == null ? null : packetMode!.value,
      'sessionInitializationMode': ?sessionInitializationMode == null ? null : sessionInitializationMode!.value,
  ...
  factory RouterBgpPeerBfd.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfd(
      ...
      mode: map['mode'] == null ? null : RouterBgpPeerBfdMode.fromValue(map['mode'] as String),
      multiplier: map['multiplier'] == null ? null : map['multiplier'] as int,
      packetMode: map['packetMode'] == null ? null : RouterBgpPeerBfdPacketMode.fromValue(map['packetMode'] as String),
      sessionInitializationMode: map['sessionInitializationMode'] == null ? null : RouterBgpPeerBfdSessionInitializationMode.fromValue(map['sessionInitializationMode'] as String),
      slowTimerInterval: map['slowTimerInterval'] == null ? null : map['slowTimerInterval'] as int,
    );
  }
}
