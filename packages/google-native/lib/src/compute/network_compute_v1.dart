...
class NetworkComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkPeeringResponseComputeV1>> peerings;
  ...
  late final pulumi.Output<NetworkRoutingConfigResponseComputeV1> routingConfig;
  ...
  /// Creates a new [NetworkComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NetworkComputeV1]. {@macro pulumi_compute_v1_network_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  NetworkComputeV1(
    String name, {
    NetworkComputeV1Args? args,
    ...
    this.networkFirewallPolicyEnforcementOrder = registerOutput<String>(
      'networkFirewallPolicyEnforcementOrder',
    );
    this.peerings = registerOutput<List<NetworkPeeringResponseComputeV1>>(
      'peerings',
    );
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.routingConfig = registerOutput<NetworkRoutingConfigResponseComputeV1>(
      'routingConfig',
    );
