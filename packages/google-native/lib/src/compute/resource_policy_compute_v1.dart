...
class ResourcePolicyComputeV1 extends pulumi.CustomResource {
  ...
  ResourcePolicyComputeV1(
    ...
    this.groupPlacementPolicy = registerOutput<ResourcePolicyGroupPlacementPolicyResponseComputeV1>('groupPlacementPolicy');
    this.instanceSchedulePolicy = registerOutput<ResourcePolicyInstanceSchedulePolicyResponseComputeV1>('instanceSchedulePolicy');
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.resourceStatus = registerOutput<ResourcePolicyResourceStatusResponseComputeV1>('resourceStatus');
    this.selfLink = registerOutput<String>('selfLink');
    this.snapshotSchedulePolicy = registerOutput<ResourcePolicySnapshotSchedulePolicyResponseComputeV1>('snapshotSchedulePolicy');
