...
class FirewallPolicyRuleResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetSecureTags': pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponseComputeV1, Map<String, dynamic>>(targetSecureTags, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponseComputeV1(
      ...
      match: FirewallPolicyRuleMatcherResponseComputeV1.fromMap((map['match'] as Map).cast<String, dynamic>()),
      priority: map['priority'] as int,
      ruleName: map['ruleName'] as String,
      ruleTupleCount: map['ruleTupleCount'] as int,
      targetResources: (map['targetResources'] as List).cast<String>(),
      targetSecureTags: pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeV1>(map['targetSecureTags'], (value) => FirewallPolicyRuleSecureTagResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
