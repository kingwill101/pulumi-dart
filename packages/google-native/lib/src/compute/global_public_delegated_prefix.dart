...
import 'global_public_delegated_prefix_args.dart';
import 'public_delegated_prefix_public_delegated_sub_prefix_response.dart';

/// Creates a global PublicDelegatedPrefix in the specified project using the parameters that are included in the request.
class GlobalPublicDelegatedPrefix extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponse>> publicDelegatedSubPrefixs;
  ...
  /// Creates a new [GlobalPublicDelegatedPrefix].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GlobalPublicDelegatedPrefix]. {@macro pulumi_compute_alpha_global_public_delegated_prefix_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GlobalPublicDelegatedPrefix(
    String name, {
    GlobalPublicDelegatedPrefixArgs? args,
    ...
    this.publicDelegatedSubPrefixs = registerOutput<List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponse>>('publicDelegatedSubPrefixs');
