...
/// {@template pulumi_compute_v1_machine_image_iam_binding_compute_v1_args_doc}
/// The set of arguments for MachineImageIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_machine_image_iam_binding_compute_v1_args_doc}
class MachineImageIamBindingComputeV1Args {
  ...
  /// Creates a new [MachineImageIamBindingComputeV1Args].
  ...
  MachineImageIamBindingComputeV1Args({
    Condition? condition,
  ...
  factory MachineImageIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return MachineImageIamBindingComputeV1Args(
