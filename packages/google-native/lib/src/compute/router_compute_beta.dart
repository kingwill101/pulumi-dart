...
class RouterComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RouterMd5AuthenticationKeyResponseComputeBeta>> md5AuthenticationKeys;
  ...
  RouterComputeBeta(
    ...
    this.bgpPeers = registerOutput<List<RouterBgpPeerResponseComputeBeta>>('bgpPeers');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.description = registerOutput<String>('description');
    this.encryptedInterconnectRouter = registerOutput<bool>('encryptedInterconnectRouter');
    this.interfaces = registerOutput<List<RouterInterfaceResponseComputeBeta>>('interfaces');
    this.kind = registerOutput<String>('kind');
    this.md5AuthenticationKeys = registerOutput<List<RouterMd5AuthenticationKeyResponseComputeBeta>>('md5AuthenticationKeys');
