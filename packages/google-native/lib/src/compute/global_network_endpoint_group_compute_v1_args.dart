...
class GlobalNetworkEndpointGroupComputeV1Args {
  ...
  final pulumi.Input<GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1>? networkEndpointType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1, String>(networkEndpointType, (value) => value.value),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory GlobalNetworkEndpointGroupComputeV1Args.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupComputeV1Args(
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1.fromValue(map['networkEndpointType'] as String),
