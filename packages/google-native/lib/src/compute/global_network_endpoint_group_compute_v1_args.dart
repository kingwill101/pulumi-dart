...
import 'global_network_endpoint_group_network_endpoint_type_compute_v1.dart';
...
/// {@template pulumi_compute_v1_global_network_endpoint_group_compute_v1_args_doc}
/// The set of arguments for GlobalNetworkEndpointGroup.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_global_network_endpoint_group_compute_v1_args_doc}
class GlobalNetworkEndpointGroupComputeV1Args {
  ...
  final pulumi.Input<GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1>?
  networkEndpointType;
  ...
  /// Creates a new [GlobalNetworkEndpointGroupComputeV1Args].
  ...
  GlobalNetworkEndpointGroupComputeV1Args({
    ...
    String? name,
    String? network,
    GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1? networkEndpointType,
    String? project,
    ...
    String? subnetwork,
       ...
       networkEndpointType =
           pulumi.Input.asOptionalInput<
             GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1
           >(networkEndpointType),
       project = pulumi.Input.asOptionalInput<String>(project),
       pscData = pulumi.Input.asOptionalInput<Map<String, dynamic>>(pscData),
       pscTargetService = pulumi.Input.asOptionalInput<String>(
         pscTargetService,
       ),
    ...
    return <String, dynamic>{
      ...
      'networkEndpointType':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1,
            String
          >(networkEndpointType, (value) => value.value),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory GlobalNetworkEndpointGroupComputeV1Args.fromMap(
    ...
    return GlobalNetworkEndpointGroupComputeV1Args(
      ...
      networkEndpointType: map['networkEndpointType'] == null
          ? null
          : GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1.fromValue(
