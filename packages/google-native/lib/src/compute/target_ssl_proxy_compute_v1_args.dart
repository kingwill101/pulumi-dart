...
import 'target_ssl_proxy_proxy_header_compute_v1.dart';

/// {@template pulumi_compute_v1_target_ssl_proxy_compute_v1_args_doc}
/// The set of arguments for TargetSslProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_target_ssl_proxy_compute_v1_args_doc}
class TargetSslProxyComputeV1Args {
  ...
  final pulumi.Input<TargetSslProxyProxyHeaderComputeV1>? proxyHeader;
  ...
  /// Creates a new [TargetSslProxyComputeV1Args].
  ...
  TargetSslProxyComputeV1Args({
    String? certificateMap,
    String? description,
    String? name,
    String? project,
    TargetSslProxyProxyHeaderComputeV1? proxyHeader,
    String? requestId,
    String? service,
    ...
    String? sslPolicy,
      ...
      proxyHeader = pulumi.Input.asOptionalInput<TargetSslProxyProxyHeaderComputeV1>(proxyHeader),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetSslProxyProxyHeaderComputeV1, String>(proxyHeader, (value) => value.value),
      'requestId': ?requestId,
      'service': ?service,
  ...
  factory TargetSslProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyComputeV1Args(
      certificateMap: map['certificateMap'] == null ? null : map['certificateMap'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      proxyHeader: map['proxyHeader'] == null ? null : TargetSslProxyProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String),
