...
class InstanceGroupManagerResizeRequestComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'requestedRunDuration': ?pulumi.Input.mapOptionalInputValue<DurationComputeBeta, Map<String, dynamic>>(requestedRunDuration, (value) => value.toMap()),
      'resizeBy': ?resizeBy,
      'zone': ?zone,
    };
  }
  ...
  factory InstanceGroupManagerResizeRequestComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerResizeRequestComputeBetaArgs(
      ...
      requestedRunDuration: map['requestedRunDuration'] == null ? null : DurationComputeBeta.fromMap((map['requestedRunDuration'] as Map).cast<String, dynamic>()),
