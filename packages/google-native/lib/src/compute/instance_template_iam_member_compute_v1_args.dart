...
/// {@template pulumi_compute_v1_instance_template_iam_member_compute_v1_args_doc}
/// The set of arguments for InstanceTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_instance_template_iam_member_compute_v1_args_doc}
class InstanceTemplateIamMemberComputeV1Args {
  ...
  /// Creates a new [InstanceTemplateIamMemberComputeV1Args].
  ...
  InstanceTemplateIamMemberComputeV1Args({
    Condition? condition,
  ...
  factory InstanceTemplateIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateIamMemberComputeV1Args(
