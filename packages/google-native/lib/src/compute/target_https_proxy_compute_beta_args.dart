...
class TargetHttpsProxyComputeBetaArgs {
  ...
  TargetHttpsProxyComputeBetaArgs({
    ...
    String? urlMap,
      ...
      quicOverride = pulumi.Input.asOptionalInput<TargetHttpsProxyQuicOverrideComputeBeta>(quicOverride),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<TargetHttpsProxyQuicOverrideComputeBeta, String>(quicOverride, (value) => value.value),
      'requestId': ?requestId,
  ...
  factory TargetHttpsProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyComputeBetaArgs(
      ...
      quicOverride: map['quicOverride'] == null ? null : TargetHttpsProxyQuicOverrideComputeBeta.fromValue(map['quicOverride'] as String),
