...
import 'target_https_proxy_quic_override_compute_beta.dart';

/// {@template pulumi_compute_beta_target_https_proxy_compute_beta_args_doc}
/// The set of arguments for TargetHttpsProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_target_https_proxy_compute_beta_args_doc}
class TargetHttpsProxyComputeBetaArgs {
  ...
  final pulumi.Input<TargetHttpsProxyQuicOverrideComputeBeta>? quicOverride;
  ...
  /// Creates a new [TargetHttpsProxyComputeBetaArgs].
  ...
  TargetHttpsProxyComputeBetaArgs({
    ...
    String? project,
    bool? proxyBind,
    TargetHttpsProxyQuicOverrideComputeBeta? quicOverride,
    String? requestId,
    ...
    String? urlMap,
        ...
        httpKeepAliveTimeoutSec =
            pulumi.Input.asOptionalInput<int>(httpKeepAliveTimeoutSec),
        name = pulumi.Input.asOptionalInput<String>(name),
        project = pulumi.Input.asOptionalInput<String>(project),
        proxyBind = pulumi.Input.asOptionalInput<bool>(proxyBind),
        quicOverride = pulumi.Input.asOptionalInput<
            TargetHttpsProxyQuicOverrideComputeBeta>(quicOverride),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        serverTlsPolicy = pulumi.Input.asOptionalInput<String>(serverTlsPolicy),
        sslCertificates =
            pulumi.Input.asOptionalInput<List<String>>(sslCertificates),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (quicOverrideValue != null) {
      map['quicOverride'] = pulumi.Input.mapOptionalInputValue<
          TargetHttpsProxyQuicOverrideComputeBeta,
          String>(quicOverrideValue, (value) => value.value);
    }
  ...
  factory TargetHttpsProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyComputeBetaArgs(
      ...
      authorization:
          map['authorization'] == null ? null : map['authorization'] as String,
      ...
      httpFilters: map['httpFilters'] == null
          ? null
          : (map['httpFilters'] as List).cast<String>(),
      ...
      quicOverride: map['quicOverride'] == null
          ? null
          : TargetHttpsProxyQuicOverrideComputeBeta.fromValue(
