...
class FutureReservationComputeBeta extends pulumi.CustomResource {
  ...
  FutureReservationComputeBeta(
    ...
    this.autoCreatedReservationsDuration = registerOutput<DurationResponseComputeBeta>('autoCreatedReservationsDuration');
    ...
    this.specificSkuProperties = registerOutput<FutureReservationSpecificSKUPropertiesResponseComputeBeta>('specificSkuProperties');
    this.status = registerOutput<FutureReservationStatusResponseComputeBeta>('status');
    this.timeWindow = registerOutput<FutureReservationTimeWindowResponseComputeBeta>('timeWindow');
