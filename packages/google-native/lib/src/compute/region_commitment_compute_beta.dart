...
class RegionCommitmentComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LicenseResourceCommitmentResponseComputeBeta> licenseResource;
  ...
  late final pulumi.Output<List<ResourceCommitmentResponseComputeBeta>> resources;
  ...
  /// Creates a new [RegionCommitmentComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionCommitmentComputeBeta]. {@macro pulumi_compute_beta_region_commitment_compute_beta_args_doc}
  ...
  RegionCommitmentComputeBeta(
    ...
    this.licenseResource = registerOutput<LicenseResourceCommitmentResponseComputeBeta>('licenseResource');
    ...
    this.reservations = registerOutput<List<ReservationResponseComputeBeta>>('reservations');
    this.resources = registerOutput<List<ResourceCommitmentResponseComputeBeta>>('resources');
