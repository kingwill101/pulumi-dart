...
/// {@template pulumi_securitycenter_v1_organization_source_iam_binding_args_doc}
/// The set of arguments for OrganizationSourceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_securitycenter_v1_organization_source_iam_binding_args_doc}
class OrganizationSourceIamBindingArgs {
  ...
  /// Creates a new [OrganizationSourceIamBindingArgs].
  ...
  OrganizationSourceIamBindingArgs({
    Condition? condition,
  ...
  factory OrganizationSourceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSourceIamBindingArgs(
