...
/// {@template pulumi_securitycenter_v1beta1_organization_source_iam_binding_securitycenter_v1beta1_args_doc}
/// The set of arguments for OrganizationSourceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_securitycenter_v1beta1_organization_source_iam_binding_securitycenter_v1beta1_args_doc}
class OrganizationSourceIamBindingSecuritycenterV1beta1Args {
  ...
  /// Creates a new [OrganizationSourceIamBindingSecuritycenterV1beta1Args].
  ...
  OrganizationSourceIamBindingSecuritycenterV1beta1Args({
    Condition? condition,
  ...
  factory OrganizationSourceIamBindingSecuritycenterV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OrganizationSourceIamBindingSecuritycenterV1beta1Args(
