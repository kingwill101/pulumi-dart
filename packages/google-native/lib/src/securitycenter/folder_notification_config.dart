...
class FolderNotificationConfig extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [FolderNotificationConfig]. {@macro pulumi_securitycenter_v1_folder_notification_config_args_doc}
  ...
  FolderNotificationConfig(
    ...
    this.streamingConfig = registerOutput<StreamingConfigResponse>('streamingConfig');
  }
}
