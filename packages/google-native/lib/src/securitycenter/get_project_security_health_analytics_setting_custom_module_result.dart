...
/// Result data returned by getProjectSecurityHealthAnalyticsSettingCustomModule.
class GetProjectSecurityHealthAnalyticsSettingCustomModuleResult {
  ...
  /// Creates a new [GetProjectSecurityHealthAnalyticsSettingCustomModuleResult].
  ...
  GetProjectSecurityHealthAnalyticsSettingCustomModuleResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['ancestorModule'] = ancestorModule;
    map['customConfig'] = customConfig.toMap();
    map['displayName'] = displayName;
    map['enablementState'] = enablementState;
    map['lastEditor'] = lastEditor;
    map['name'] = name;
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetProjectSecurityHealthAnalyticsSettingCustomModuleResult.fromMap(
      Map<String, dynamic> map) {
    return GetProjectSecurityHealthAnalyticsSettingCustomModuleResult(
      ancestorModule: map['ancestorModule'] as String,
      customConfig: GoogleCloudSecuritycenterV1CustomConfigResponse.fromMap(
