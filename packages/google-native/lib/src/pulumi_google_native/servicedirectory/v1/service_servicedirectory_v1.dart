...
import 'service_servicedirectory_v1_args.dart';

/// Creates a service, and returns the new service.
class ServiceServicedirectoryV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EndpointResponseServicedirectoryV1>> endpoints;
  ...
  ServiceServicedirectoryV1(
    String name, {
    ServiceServicedirectoryV1Args? args,
    ...
    this.endpoints =
        registerOutput<List<EndpointResponseServicedirectoryV1>>('endpoints');
