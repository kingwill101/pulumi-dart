...
class EndpointServicedirectoryV1Args {
  ...
  EndpointServicedirectoryV1Args({
    this.address,
    this.annotations,
  ...
  factory EndpointServicedirectoryV1Args.fromMap(Map<String, dynamic> map) {
    return EndpointServicedirectoryV1Args(
