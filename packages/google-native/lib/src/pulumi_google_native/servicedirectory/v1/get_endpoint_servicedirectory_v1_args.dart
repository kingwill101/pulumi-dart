...
class GetEndpointServicedirectoryV1Args {
  ...
  GetEndpointServicedirectoryV1Args({
  ...
  factory GetEndpointServicedirectoryV1Args.fromMap(Map<String, dynamic> map) {
    return GetEndpointServicedirectoryV1Args(
