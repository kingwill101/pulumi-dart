...
import 'namespace_service_iam_binding_args2.dart';

/// Sets the IAM Policy for a resource
class NamespaceServiceIamBinding2 extends CustomResource {
  ...
  NamespaceServiceIamBinding2(
    String name, {
    NamespaceServiceIamBindingArgs2? args,
