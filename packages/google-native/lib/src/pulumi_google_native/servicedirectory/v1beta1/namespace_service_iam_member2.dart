...
import 'namespace_service_iam_member_args2.dart';

/// Sets the IAM Policy for a resource
class NamespaceServiceIamMember2 extends CustomResource {
  ...
  NamespaceServiceIamMember2(
    String name, {
    NamespaceServiceIamMemberArgs2? args,
