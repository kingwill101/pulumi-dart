...
class NamespaceServiceIamMemberArgs2 {
  ...
  NamespaceServiceIamMemberArgs2({
    this.condition,
  ...
  factory NamespaceServiceIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return NamespaceServiceIamMemberArgs2(
