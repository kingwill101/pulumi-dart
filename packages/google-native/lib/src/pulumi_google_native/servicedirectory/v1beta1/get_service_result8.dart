...
class GetServiceResult8 {
  ...
  final List<EndpointResponse4> endpoints;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['endpoints'] =
        Input.encodeList<EndpointResponse4, Map<String, dynamic>>(
  ...
  factory GetServiceResult8.fromMap(Map<String, dynamic> map) {
    return GetServiceResult8(
      createTime: map['createTime'] as String,
      endpoints: Input.decodeList<EndpointResponse4>(
          map['endpoints'],
          (value) => EndpointResponse4.fromMap(
