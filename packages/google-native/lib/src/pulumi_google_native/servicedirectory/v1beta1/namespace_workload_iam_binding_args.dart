...
/// The set of arguments for NamespaceWorkloadIamBinding.
class NamespaceWorkloadIamBindingArgs {
  ...
  NamespaceWorkloadIamBindingArgs({
    this.condition,
  ...
  factory NamespaceWorkloadIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceWorkloadIamBindingArgs(
