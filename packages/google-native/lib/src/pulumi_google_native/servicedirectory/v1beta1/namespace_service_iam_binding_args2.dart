...
class NamespaceServiceIamBindingArgs2 {
  ...
  NamespaceServiceIamBindingArgs2({
    this.condition,
  ...
  factory NamespaceServiceIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return NamespaceServiceIamBindingArgs2(
