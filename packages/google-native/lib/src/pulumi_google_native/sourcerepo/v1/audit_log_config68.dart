...
class AuditLogConfig68 {
  ...
  factory AuditLogConfig68.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig68(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType68.fromValue(map['logType'] as String),
    );
  }
}
