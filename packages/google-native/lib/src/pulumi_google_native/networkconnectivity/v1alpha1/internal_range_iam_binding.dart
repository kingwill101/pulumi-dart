...
import 'internal_range_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InternalRangeIamBinding extends pulumi.CustomResource {
  ...
  InternalRangeIamBinding(
    String name, {
    InternalRangeIamBindingArgs? args,
