...
class RouterApplianceInstanceResponse2 {
  ...
  RouterApplianceInstanceResponse2({
  ...
  factory RouterApplianceInstanceResponse2.fromMap(Map<String, dynamic> map) {
    return RouterApplianceInstanceResponse2(
