...
import 'internal_range_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InternalRangeIamMember extends pulumi.CustomResource {
  ...
  InternalRangeIamMember(
    String name, {
    InternalRangeIamMemberArgs? args,
