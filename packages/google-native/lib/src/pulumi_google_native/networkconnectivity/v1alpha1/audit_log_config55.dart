...
class AuditLogConfig55 {
  ...
  factory AuditLogConfig55.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig55(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType55.fromValue(map['logType'] as String),
    );
  }
}
