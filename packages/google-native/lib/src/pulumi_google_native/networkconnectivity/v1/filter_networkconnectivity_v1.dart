...
class FilterNetworkconnectivityV1 {
  ...
  factory FilterNetworkconnectivityV1.fromMap(Map<String, dynamic> map) {
    return FilterNetworkconnectivityV1(
