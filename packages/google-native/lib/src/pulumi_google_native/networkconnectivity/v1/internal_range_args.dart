...
class InternalRangeArgs {
  ...
  final Input<List<InternalRangeOverlapsItem>>? overlaps;

  /// The type of peering set for this internal range.
  final Input<InternalRangePeering>? peering;
  ...
  final Input<InternalRangeUsage>? usage;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (overlapsValue != null) {
      map['overlaps'] = Input.mapOptionalInputValue<
          ...
          overlapsValue,
          (value) => Input.encodeList<InternalRangeOverlapsItem, String>(
              value, (value) => value.value));
    }
    final peeringValue = peering;
    if (peeringValue != null) {
      map['peering'] =
          Input.mapOptionalInputValue<InternalRangePeering, String>(
    ...
    if (usageValue != null) {
      map['usage'] = Input.mapOptionalInputValue<InternalRangeUsage, String>(
  ...
  factory InternalRangeArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeArgs(
      ...
      overlaps: Input.asOptionalInput<List<InternalRangeOverlapsItem>>(
          map['overlaps']),
      peering: Input.asOptionalInput<InternalRangePeering>(map['peering']),
      ...
      usage: Input.asOptionalInput<InternalRangeUsage>(map['usage']),
    );
  }
}
