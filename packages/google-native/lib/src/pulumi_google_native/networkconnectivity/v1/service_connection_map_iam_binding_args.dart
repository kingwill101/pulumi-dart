...
/// The set of arguments for ServiceConnectionMapIamBinding.
class ServiceConnectionMapIamBindingArgs {
  ...
  ServiceConnectionMapIamBindingArgs({
    this.condition,
  ...
  factory ServiceConnectionMapIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionMapIamBindingArgs(
