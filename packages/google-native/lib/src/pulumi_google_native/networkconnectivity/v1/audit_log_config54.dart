...
class AuditLogConfig54 {
  ...
  factory AuditLogConfig54.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig54(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType54.fromValue(map['logType'] as String),
    );
  }
}
