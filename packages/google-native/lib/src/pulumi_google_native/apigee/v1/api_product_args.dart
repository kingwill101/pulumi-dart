...
class ApiProductArgs {
  ...
  final Input<List<String>>? apiResources;
  ...
  final Input<String>? approvalType;
  ...
  final Input<List<String>>? environments;

  /// Configuration used to group Apigee proxies or remote services with graphQL operation name, graphQL operation type and quotas. This grouping allows us to precisely set quota for a particular combination of graphQL name and operation type for a particular proxy request. If graphQL name is not set, this would imply quota will be applied on all graphQL requests matching the operation type.
  final Input<GoogleCloudApigeeV1GraphQLOperationGroup>? graphqlOperationGroup;
  ...
  final Input<GoogleCloudApigeeV1GrpcOperationGroup>? grpcOperationGroup;

  /// Response only. Modified time of this environment as milliseconds since epoch.
  final Input<String>? lastModifiedAt;
  ...
  final Input<GoogleCloudApigeeV1OperationGroup>? operationGroup;
  ...
  final Input<List<String>>? proxies;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (graphqlOperationGroupValue != null) {
      map['graphqlOperationGroup'] = Input.mapOptionalInputValue<
    ...
    if (grpcOperationGroupValue != null) {
      map['grpcOperationGroup'] = Input.mapOptionalInputValue<
    ...
    if (operationGroupValue != null) {
      map['operationGroup'] = Input.mapOptionalInputValue<
    ...
    if (quotaCounterScopeValue != null) {
      map['quotaCounterScope'] =
          Input.mapOptionalInputValue<ApiProductQuotaCounterScope, String>(
              quotaCounterScopeValue, (value) => value.value);
    }
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      apiResources: Input.asOptionalInput<List<String>>(map['apiResources']),
      approvalType: Input.asOptionalInput<String>(map['approvalType']),
      attributes: Input.asOptionalInput<List<GoogleCloudApigeeV1Attribute>>(
          map['attributes']),
      createdAt: Input.asOptionalInput<String>(map['createdAt']),
      description: Input.asOptionalInput<String>(map['description']),
      displayName: Input.asOptionalInput<String>(map['displayName']),
      environments: Input.asOptionalInput<List<String>>(map['environments']),
      graphqlOperationGroup:
          Input.asOptionalInput<GoogleCloudApigeeV1GraphQLOperationGroup>(
              map['graphqlOperationGroup']),
      grpcOperationGroup:
          Input.asOptionalInput<GoogleCloudApigeeV1GrpcOperationGroup>(
              map['grpcOperationGroup']),
      lastModifiedAt: Input.asOptionalInput<String>(map['lastModifiedAt']),
      name: Input.asOptionalInput<String>(map['name']),
      operationGroup: Input.asOptionalInput<GoogleCloudApigeeV1OperationGroup>(
          map['operationGroup']),
      organizationId: Input.asInput<String>(map['organizationId']),
      proxies: Input.asOptionalInput<List<String>>(map['proxies']),
      quota: Input.asOptionalInput<String>(map['quota']),
      quotaCounterScope: Input.asOptionalInput<ApiProductQuotaCounterScope>(
          map['quotaCounterScope']),
      quotaInterval: Input.asOptionalInput<String>(map['quotaInterval']),
      quotaTimeUnit: Input.asOptionalInput<String>(map['quotaTimeUnit']),
