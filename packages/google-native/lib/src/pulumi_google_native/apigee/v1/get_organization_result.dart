...
class GetOrganizationResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['apiConsumerDataEncryptionKeyName'] = apiConsumerDataEncryptionKeyName;
    map['apiConsumerDataLocation'] = apiConsumerDataLocation;
    map['apigeeProjectId'] = apigeeProjectId;
    map['attributes'] = attributes;
    map['authorizedNetwork'] = authorizedNetwork;
    map['billingType'] = billingType;
    map['caCertificate'] = caCertificate;
    map['controlPlaneEncryptionKeyName'] = controlPlaneEncryptionKeyName;
    map['createdAt'] = createdAt;
    map['customerName'] = customerName;
    map['description'] = description;
    map['disableVpcPeering'] = disableVpcPeering;
    map['displayName'] = displayName;
    map['environments'] = environments;
    map['expiresAt'] = expiresAt;
    map['lastModifiedAt'] = lastModifiedAt;
    map['name'] = name;
    map['portalDisabled'] = portalDisabled;
    map['project'] = project;
    map['properties'] = properties.toMap();
    map['runtimeDatabaseEncryptionKeyName'] = runtimeDatabaseEncryptionKeyName;
    map['runtimeType'] = runtimeType_;
    map['state'] = state;
  ...
  factory GetOrganizationResult.fromMap(Map<String, dynamic> map) {
    return GetOrganizationResult(
      addonsConfig: GoogleCloudApigeeV1AddonsConfigResponse.fromMap(
      ...
      properties: GoogleCloudApigeeV1PropertiesResponse.fromMap(
