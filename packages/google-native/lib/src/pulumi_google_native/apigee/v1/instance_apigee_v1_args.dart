...
class InstanceApigeeV1Args {
  ...
  factory InstanceApigeeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceApigeeV1Args(
      consumerAcceptList:
          pulumi.Input.asOptionalInput<List<String>>(map['consumerAcceptList']),
      ...
      peeringCidrRange: pulumi.Input.asOptionalInput<InstancePeeringCidrRange>(
          map['peeringCidrRange']),
    );
  }
}
