...
class OrganizationArgs {
  ...
  final Input<GoogleCloudApigeeV1AddonsConfig>? addonsConfig;
  ...
  final Input<OrganizationBillingType>? billingType;
  ...
  final Input<bool>? portalDisabled;
  ...
  final Input<OrganizationRuntimeType> runtimeType_;

  /// Not used by Apigee.
  final Input<OrganizationType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (billingTypeValue != null) {
      map['billingType'] =
          Input.mapOptionalInputValue<OrganizationBillingType, String>(
    ...
    map['runtimeType'] = Input.mapInputValue<OrganizationRuntimeType, String>(
        runtimeType_, (value) => value.value);
    final typeValue = type;
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<OrganizationType, String>(
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      addonsConfig: Input.asOptionalInput<GoogleCloudApigeeV1AddonsConfig>(
          map['addonsConfig']),
      analyticsRegion: Input.asInput<String>(map['analyticsRegion']),
      ...
      billingType:
          Input.asOptionalInput<OrganizationBillingType>(map['billingType']),
      ...
      portalDisabled: Input.asOptionalInput<bool>(map['portalDisabled']),
      ...
      runtimeDatabaseEncryptionKeyName: Input.asOptionalInput<String>(
          map['runtimeDatabaseEncryptionKeyName']),
      runtimeType_: Input.asInput<OrganizationRuntimeType>(map['runtimeType']),
      type: Input.asOptionalInput<OrganizationType>(map['type']),
    );
  }
}
