...
class RatePlan extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleTypeMoneyResponseApigeeV1> fixedRecurringFee;
  ...
  late final pulumi.Output<GoogleTypeMoneyResponseApigeeV1> setupFee;
  ...
  RatePlan(
    ...
    this.fixedRecurringFee =
        registerOutput<GoogleTypeMoneyResponseApigeeV1>('fixedRecurringFee');
    ...
    this.setupFee = registerOutput<GoogleTypeMoneyResponseApigeeV1>('setupFee');
