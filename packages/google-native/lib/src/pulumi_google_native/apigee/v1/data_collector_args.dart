...
class DataCollectorArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          pulumi.Input.mapOptionalInputValue<DataCollectorType, String>(
  ...
  factory DataCollectorArgs.fromMap(Map<String, dynamic> map) {
    return DataCollectorArgs(
      dataCollectorId:
          pulumi.Input.asOptionalInput<String>(map['dataCollectorId']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      organizationId: pulumi.Input.asInput<String>(map['organizationId']),
      type: pulumi.Input.asOptionalInput<DataCollectorType>(map['type']),
    );
  }
}
