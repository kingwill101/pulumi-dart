...
/// Result data returned by getSecurityReport.
class GetSecurityReportResult {
  ...
  factory GetSecurityReportResult.fromMap(Map<String, dynamic> map) {
    return GetSecurityReportResult(
      ...
      queryParams: GoogleCloudApigeeV1SecurityReportMetadataResponse.fromMap(
          (map['queryParams'] as Map).cast<String, dynamic>()),
      reportDefinitionId: map['reportDefinitionId'] as String,
      result: GoogleCloudApigeeV1SecurityReportResultMetadataResponse.fromMap(
