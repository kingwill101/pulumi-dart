...
class DeviceCloudiotV1Args {
  ...
  factory DeviceCloudiotV1Args.fromMap(Map<String, dynamic> map) {
    return DeviceCloudiotV1Args(
      blocked: pulumi.Input.asOptionalInput<bool>(map['blocked']),
      config: pulumi.Input.asOptionalInput<DeviceConfig>(map['config']),
      credentials: pulumi.Input.asOptionalInput<List<DeviceCredential>>(
          map['credentials']),
      gatewayConfig:
          pulumi.Input.asOptionalInput<GatewayConfig>(map['gatewayConfig']),
      id: pulumi.Input.asOptionalInput<String>(map['id']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      logLevel: pulumi.Input.asOptionalInput<DeviceLogLevel>(map['logLevel']),
      metadata:
