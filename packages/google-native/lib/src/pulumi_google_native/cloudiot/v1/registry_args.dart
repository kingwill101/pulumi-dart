...
class RegistryArgs {
  ...
  factory RegistryArgs.fromMap(Map<String, dynamic> map) {
    return RegistryArgs(
      credentials: pulumi.Input.asOptionalInput<List<RegistryCredential>>(
          map['credentials']),
      eventNotificationConfigs:
          pulumi.Input.asOptionalInput<List<EventNotificationConfig>>(
              map['eventNotificationConfigs']),
      httpConfig: pulumi.Input.asOptionalInput<HttpConfig>(map['httpConfig']),
      id: pulumi.Input.asOptionalInput<String>(map['id']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      logLevel: pulumi.Input.asOptionalInput<RegistryLogLevel>(map['logLevel']),
      mqttConfig: pulumi.Input.asOptionalInput<MqttConfig>(map['mqttConfig']),
