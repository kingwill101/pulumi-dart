...
class GetDeviceResult3 {
  ...
  final StatusResponse4 lastErrorStatus;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['credentials'] =
        Input.encodeList<DeviceCredentialResponse, Map<String, dynamic>>(
  ...
  factory GetDeviceResult3.fromMap(Map<String, dynamic> map) {
    return GetDeviceResult3(
      blocked: map['blocked'] as bool,
      config: DeviceConfigResponse.fromMap(
          (map['config'] as Map).cast<String, dynamic>()),
      credentials: Input.decodeList<DeviceCredentialResponse>(
          map['credentials'],
      ...
      lastErrorStatus: StatusResponse4.fromMap(
