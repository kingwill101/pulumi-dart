...
class GetOrganizationReplayResult4 {
  ...
  factory GetOrganizationReplayResult4.fromMap(Map<String, dynamic> map) {
    return GetOrganizationReplayResult4(
