...
import 'endpoint_iam_binding_ids_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EndpointIamBindingIdsV1 extends pulumi.CustomResource {
  ...
  EndpointIamBindingIdsV1(
    String name, {
    EndpointIamBindingIdsV1Args? args,
