...
class AuditLogConfigIdsV1 {
  ...
  factory AuditLogConfigIdsV1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigIdsV1(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogTypeIdsV1.fromValue(map['logType'] as String),
    );
  }
}
