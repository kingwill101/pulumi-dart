...
import 'endpoint_iam_member_ids_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EndpointIamMemberIdsV1 extends pulumi.CustomResource {
  ...
  EndpointIamMemberIdsV1(
    String name, {
    EndpointIamMemberIdsV1Args? args,
