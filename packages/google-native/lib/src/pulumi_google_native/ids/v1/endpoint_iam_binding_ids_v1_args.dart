...
class EndpointIamBindingIdsV1Args {
  ...
  factory EndpointIamBindingIdsV1Args.fromMap(Map<String, dynamic> map) {
    return EndpointIamBindingIdsV1Args(
