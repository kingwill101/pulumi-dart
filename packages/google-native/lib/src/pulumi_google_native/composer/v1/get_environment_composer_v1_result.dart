...
class GetEnvironmentComposerV1Result {
  ...
  GetEnvironmentComposerV1Result({
  ...
  factory GetEnvironmentComposerV1Result.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentComposerV1Result(
