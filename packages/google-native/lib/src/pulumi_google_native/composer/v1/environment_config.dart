  ...
  factory EnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfig(
      ...
      environmentSize: map['environmentSize'] == null
          ? null
          : EnvironmentConfigEnvironmentSize.fromValue(
