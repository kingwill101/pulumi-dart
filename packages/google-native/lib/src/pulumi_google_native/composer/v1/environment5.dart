...
class Environment5 extends CustomResource {
  ...
  late final Output<EnvironmentConfigResponse> config;
  ...
  late final Output<StorageConfigResponse> storageConfig;
  ...
  Environment5(
    ...
    this.config = Output.createUnknown<EnvironmentConfigResponse>();
    ...
    this.storageConfig = Output.createUnknown<StorageConfigResponse>();
