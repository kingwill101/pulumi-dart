...
class ScheduledSnapshotsConfigResponse2 {
  ...
  ScheduledSnapshotsConfigResponse2({
  ...
  factory ScheduledSnapshotsConfigResponse2.fromMap(Map<String, dynamic> map) {
    return ScheduledSnapshotsConfigResponse2(
