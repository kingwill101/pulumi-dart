...
import 'networking_config2.dart';
import 'private_cluster_config2.dart';

/// The configuration information for configuring a Private IP Cloud Composer environment.
class PrivateEnvironmentConfig2 {
  ...
  final NetworkingConfig2? networkingConfig;

  /// Optional. Configuration for the private GKE cluster for a Private IP Cloud Composer environment.
  final PrivateClusterConfig2? privateClusterConfig;

  /// Optional. The CIDR block from which IP range for web server will be reserved. Needs to be disjoint from private_cluster_config.master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
  final String? webServerIpv4CidrBlock;

  PrivateEnvironmentConfig2({
  ...
  factory PrivateEnvironmentConfig2.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfig2(
      cloudComposerConnectionSubnetwork:
