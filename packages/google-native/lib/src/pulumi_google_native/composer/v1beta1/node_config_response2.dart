...
import 'ipallocation_policy_response2.dart';

/// The configuration information for the Kubernetes Engine nodes running the Apache Airflow software.
class NodeConfigResponse2 {
  ...
  final IPAllocationPolicyResponse2 ipAllocationPolicy;
  ...
  factory NodeConfigResponse2.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponse2(
      diskSizeGb: map['diskSizeGb'] as int,
      enableIpMasqAgent: map['enableIpMasqAgent'] as bool,
      ipAllocationPolicy: IPAllocationPolicyResponse2.fromMap(
