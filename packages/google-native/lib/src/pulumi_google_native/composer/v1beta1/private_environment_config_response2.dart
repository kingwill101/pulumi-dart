...
import 'networking_config_response2.dart';
import 'private_cluster_config_response2.dart';

/// The configuration information for configuring a Private IP Cloud Composer environment.
class PrivateEnvironmentConfigResponse2 {
  ...
  final NetworkingConfigResponse2 networkingConfig;

  /// Optional. Configuration for the private GKE cluster for a Private IP Cloud Composer environment.
  final PrivateClusterConfigResponse2 privateClusterConfig;
  ...
  PrivateEnvironmentConfigResponse2({
  ...
  factory PrivateEnvironmentConfigResponse2.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfigResponse2(
      cloudComposerConnectionSubnetwork:
      ...
      networkingConfig: NetworkingConfigResponse2.fromMap(
          (map['networkingConfig'] as Map).cast<String, dynamic>()),
      privateClusterConfig: PrivateClusterConfigResponse2.fromMap(
