...
class GetEnvironmentResult3 {
  /// Configuration parameters for this environment.
  final EnvironmentConfigResponse2 config;
  ...
  final StorageConfigResponse2 storageConfig;
  ...
  factory GetEnvironmentResult3.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentResult3(
      config: EnvironmentConfigResponse2.fromMap(
      ...
      storageConfig: StorageConfigResponse2.fromMap(
