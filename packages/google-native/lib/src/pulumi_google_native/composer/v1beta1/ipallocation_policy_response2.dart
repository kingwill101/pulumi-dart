...
class IPAllocationPolicyResponse2 {
  ...
  factory IPAllocationPolicyResponse2.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyResponse2(
