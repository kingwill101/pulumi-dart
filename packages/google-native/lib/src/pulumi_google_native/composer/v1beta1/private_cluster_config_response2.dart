...
class PrivateClusterConfigResponse2 {
  ...
  factory PrivateClusterConfigResponse2.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfigResponse2(
