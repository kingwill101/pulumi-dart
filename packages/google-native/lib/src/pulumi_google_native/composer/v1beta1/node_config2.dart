...
import 'ipallocation_policy2.dart';
...
class NodeConfig2 {
  ...
  final IPAllocationPolicy2? ipAllocationPolicy;
  ...
  factory NodeConfig2.fromMap(Map<String, dynamic> map) {
    return NodeConfig2(
