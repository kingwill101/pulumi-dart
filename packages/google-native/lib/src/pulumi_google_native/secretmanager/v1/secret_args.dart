...
class SecretArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (topicsValue != null) {
      map['topics'] = pulumi.Input.mapOptionalInputValue<List<Topic>,
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      replication: pulumi.Input.asInput<Replication>(map['replication']),
      rotation: pulumi.Input.asOptionalInput<Rotation>(map['rotation']),
      secretId: pulumi.Input.asInput<String>(map['secretId']),
      topics: pulumi.Input.asOptionalInput<List<Topic>>(map['topics']),
