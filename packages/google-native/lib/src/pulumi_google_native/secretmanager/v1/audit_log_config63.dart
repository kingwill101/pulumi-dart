...
class AuditLogConfig63 {
  ...
  factory AuditLogConfig63.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig63(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType63.fromValue(map['logType'] as String),
    );
  }
}
