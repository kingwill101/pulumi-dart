...
class SecretIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<List<AuditConfig63>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => Input.encodeList<AuditConfig63, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding92>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding92, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory SecretIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return SecretIamPolicyArgs(
      auditConfigs:
          Input.asOptionalInput<List<AuditConfig63>>(map['auditConfigs']),
      bindings: Input.asOptionalInput<List<Binding92>>(map['bindings']),
