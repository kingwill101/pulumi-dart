...
class AuditLogConfig64 {
  ...
  factory AuditLogConfig64.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig64(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType64.fromValue(map['logType'] as String),
    );
  }
}
