...
class AuditLogConfig16 {
  ...
  factory AuditLogConfig16.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig16(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType16.fromValue(map['logType'] as String),
    );
  }
}
