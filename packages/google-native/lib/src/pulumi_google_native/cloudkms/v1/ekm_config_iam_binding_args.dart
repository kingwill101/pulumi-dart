...
/// The set of arguments for EkmConfigIamBinding.
class EkmConfigIamBindingArgs {
  ...
  factory EkmConfigIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EkmConfigIamBindingArgs(
