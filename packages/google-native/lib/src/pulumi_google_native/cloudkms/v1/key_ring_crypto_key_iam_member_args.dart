...
/// The set of arguments for KeyRingCryptoKeyIamMember.
class KeyRingCryptoKeyIamMemberArgs {
  ...
  factory KeyRingCryptoKeyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return KeyRingCryptoKeyIamMemberArgs(
