...
enum PkixPublicKeySignatureAlgorithm2 {
  ...
  const PkixPublicKeySignatureAlgorithm2(this.value);
  final String value;

  static PkixPublicKeySignatureAlgorithm2 fromValue(String value) {
    for (final item in PkixPublicKeySignatureAlgorithm2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError(
        'Unknown PkixPublicKeySignatureAlgorithm2 value: $value');
  }
}
