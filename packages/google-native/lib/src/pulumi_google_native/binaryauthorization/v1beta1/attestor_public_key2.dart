...
import 'pkix_public_key2.dart';

/// An attestor public key that will be used to verify attestations signed by this attestor.
class AttestorPublicKey2 {
  ...
  final PkixPublicKey2? pkixPublicKey;
  ...
  factory AttestorPublicKey2.fromMap(Map<String, dynamic> map) {
    return AttestorPublicKey2(
