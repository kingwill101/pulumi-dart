...
class EventTriggerResponse3 {
  /// Optional. The name of the channel associated with the trigger in `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from Eventarc SaaS partners.
  final String channel;

  /// Criteria used to filter events.
  final List<EventFilterResponse2> eventFilters;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['channel'] = channel;
    map['eventFilters'] =
        Input.encodeList<EventFilterResponse2, Map<String, dynamic>>(
  ...
  factory EventTriggerResponse3.fromMap(Map<String, dynamic> map) {
    return EventTriggerResponse3(
      channel: map['channel'] as String,
      eventFilters: Input.decodeList<EventFilterResponse2>(
          map['eventFilters'],
          (value) => EventFilterResponse2.fromMap(
