...
class SecretVolumeCloudfunctionsV2alpha {
  ...
  final List<SecretVersionCloudfunctionsV2alpha>? versions;
  ...
  factory SecretVolumeCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return SecretVolumeCloudfunctionsV2alpha(
      ...
      versions: map['versions'] == null
          ? null
          : pulumi.Input.decodeList<SecretVersionCloudfunctionsV2alpha>(
              map['versions'],
              (value) => SecretVersionCloudfunctionsV2alpha.fromMap(
