...
import 'source_provenance_response3.dart';
import 'source_response3.dart';

/// Describes the Build step of the function that builds a container from the given source.
class BuildConfigResponse2 {
  ...
  final SourceResponse3 source;

  /// A permanent fixed identifier for source.
  final SourceProvenanceResponse3 sourceProvenance;
  ...
  factory BuildConfigResponse2.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponse2(
      ...
      source: SourceResponse3.fromMap(
          (map['source'] as Map).cast<String, dynamic>()),
      sourceProvenance: SourceProvenanceResponse3.fromMap(
