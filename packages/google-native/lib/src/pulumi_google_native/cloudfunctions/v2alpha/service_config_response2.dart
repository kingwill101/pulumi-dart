...
import 'secret_env_var_response3.dart';
import 'secret_volume_response3.dart';

/// Describes the Service being deployed. Currently Supported : Cloud Run (fully managed).
class ServiceConfigResponse2 {
  ...
  final List<SecretEnvVarResponse3> secretEnvironmentVariables;

  /// Secret volumes configuration.
  final List<SecretVolumeResponse3> secretVolumes;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['secretEnvironmentVariables'] =
        Input.encodeList<SecretEnvVarResponse3, Map<String, dynamic>>(
            secretEnvironmentVariables, (value) => value.toMap());
    map['secretVolumes'] =
        Input.encodeList<SecretVolumeResponse3, Map<String, dynamic>>(
  ...
  factory ServiceConfigResponse2.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponse2(
      ...
      secretEnvironmentVariables: Input.decodeList<SecretEnvVarResponse3>(
          map['secretEnvironmentVariables'],
          (value) => SecretEnvVarResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      secretVolumes: Input.decodeList<SecretVolumeResponse3>(
          map['secretVolumes'],
          (value) => SecretVolumeResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
