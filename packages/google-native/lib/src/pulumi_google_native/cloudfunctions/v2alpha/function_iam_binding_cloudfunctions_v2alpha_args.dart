...
class FunctionIamBindingCloudfunctionsV2alphaArgs {
  ...
  FunctionIamBindingCloudfunctionsV2alphaArgs({
    this.condition,
  ...
  factory FunctionIamBindingCloudfunctionsV2alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return FunctionIamBindingCloudfunctionsV2alphaArgs(
