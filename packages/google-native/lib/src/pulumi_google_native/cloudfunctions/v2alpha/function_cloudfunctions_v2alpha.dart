...
import 'function_cloudfunctions_v2alpha_args.dart';
...
class FunctionCloudfunctionsV2alpha extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<GoogleCloudFunctionsV2alphaStateMessageResponse>>
      stateMessages;
  ...
  FunctionCloudfunctionsV2alpha(
    ...
    this.buildConfig =
        registerOutput<BuildConfigResponseCloudfunctionsV2alpha>('buildConfig');
