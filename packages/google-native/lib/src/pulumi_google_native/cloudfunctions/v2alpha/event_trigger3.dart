...
import 'event_filter2.dart';
import 'event_trigger_retry_policy2.dart';
...
class EventTrigger3 {
  ...
  final List<EventFilter2>? eventFilters;
  ...
  final EventTriggerRetryPolicy2? retryPolicy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (eventFiltersValue != null) {
      map['eventFilters'] =
          Input.encodeList<EventFilter2, Map<String, dynamic>>(
  ...
  factory EventTrigger3.fromMap(Map<String, dynamic> map) {
    return EventTrigger3(
      channel: map['channel'] == null ? null : map['channel'] as String,
      eventFilters: map['eventFilters'] == null
          ? null
          : Input.decodeList<EventFilter2>(
              map['eventFilters'],
              (value) =>
                  EventFilter2.fromMap((value as Map).cast<String, dynamic>())),
      eventType: map['eventType'] as String,
      pubsubTopic:
          map['pubsubTopic'] == null ? null : map['pubsubTopic'] as String,
      retryPolicy: map['retryPolicy'] == null
          ? null
          : EventTriggerRetryPolicy2.fromValue(map['retryPolicy'] as String),
