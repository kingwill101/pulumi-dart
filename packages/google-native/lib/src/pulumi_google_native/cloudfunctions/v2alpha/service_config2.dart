...
import 'secret_env_var3.dart';
import 'secret_volume3.dart';
import 'service_config_ingress_settings2.dart';
import 'service_config_security_level2.dart';
import 'service_config_vpc_connector_egress_settings2.dart';
...
class ServiceConfig2 {
  ...
  final ServiceConfigIngressSettings2? ingressSettings;
  ...
  final List<SecretEnvVar3>? secretEnvironmentVariables;

  /// Secret volumes configuration.
  final List<SecretVolume3>? secretVolumes;

  /// Security level configure whether the function only accepts https. This configuration is only applicable to 1st Gen functions with Http trigger. By default https is optional for 1st Gen functions; 2nd Gen functions are https ONLY.
  final ServiceConfigSecurityLevel2? securityLevel;
  ...
  final ServiceConfigVpcConnectorEgressSettings2? vpcConnectorEgressSettings;
  ...
  factory ServiceConfig2.fromMap(Map<String, dynamic> map) {
    return ServiceConfig2(
      ...
      ingressSettings: map['ingressSettings'] == null
          ? null
          : ServiceConfigIngressSettings2.fromValue(
      ...
      secretEnvironmentVariables: map['secretEnvironmentVariables'] == null
          ? null
          : Input.decodeList<SecretEnvVar3>(
              map['secretEnvironmentVariables'],
              (value) => SecretEnvVar3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      secretVolumes: map['secretVolumes'] == null
          ? null
          : Input.decodeList<SecretVolume3>(
              map['secretVolumes'],
              (value) => SecretVolume3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      securityLevel: map['securityLevel'] == null
          ? null
          : ServiceConfigSecurityLevel2.fromValue(
      ...
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null
          ? null
          : ServiceConfigVpcConnectorEgressSettings2.fromValue(
