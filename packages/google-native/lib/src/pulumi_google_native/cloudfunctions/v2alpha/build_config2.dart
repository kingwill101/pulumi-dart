...
class BuildConfig2 {
  ...
  factory BuildConfig2.fromMap(Map<String, dynamic> map) {
    return BuildConfig2(
      dockerRegistry: map['dockerRegistry'] == null
          ? null
          : BuildConfigDockerRegistry2.fromValue(
      ...
      source: map['source'] == null
          ? null
          : Source3.fromMap((map['source'] as Map).cast<String, dynamic>()),
      sourceToken:
