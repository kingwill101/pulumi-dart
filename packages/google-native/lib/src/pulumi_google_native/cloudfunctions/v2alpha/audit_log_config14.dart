...
class AuditLogConfig14 {
  ...
  factory AuditLogConfig14.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig14(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType14.fromValue(map['logType'] as String),
    );
  }
}
