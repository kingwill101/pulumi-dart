...
import 'secret_env_var_response4.dart';
import 'secret_volume_response4.dart';

/// Describes the Service being deployed. Currently Supported : Cloud Run (fully managed).
class ServiceConfigResponse3 {
  ...
  final List<SecretEnvVarResponse4> secretEnvironmentVariables;

  /// Secret volumes configuration.
  final List<SecretVolumeResponse4> secretVolumes;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['secretEnvironmentVariables'] =
        Input.encodeList<SecretEnvVarResponse4, Map<String, dynamic>>(
            secretEnvironmentVariables, (value) => value.toMap());
    map['secretVolumes'] =
        Input.encodeList<SecretVolumeResponse4, Map<String, dynamic>>(
  ...
  factory ServiceConfigResponse3.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponse3(
      ...
      secretEnvironmentVariables: Input.decodeList<SecretEnvVarResponse4>(
          map['secretEnvironmentVariables'],
          (value) => SecretEnvVarResponse4.fromMap(
              (value as Map).cast<String, dynamic>())),
      secretVolumes: Input.decodeList<SecretVolumeResponse4>(
          map['secretVolumes'],
          (value) => SecretVolumeResponse4.fromMap(
              (value as Map).cast<String, dynamic>())),
