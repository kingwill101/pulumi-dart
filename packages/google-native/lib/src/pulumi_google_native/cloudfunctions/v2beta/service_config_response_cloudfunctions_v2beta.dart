...
class ServiceConfigResponseCloudfunctionsV2beta {
  ...
  final List<SecretEnvVarResponseCloudfunctionsV2beta>
      secretEnvironmentVariables;

  /// Secret volumes configuration.
  final List<SecretVolumeResponseCloudfunctionsV2beta> secretVolumes;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['secretEnvironmentVariables'] = pulumi.Input.encodeList<
            SecretEnvVarResponseCloudfunctionsV2beta, Map<String, dynamic>>(
  ...
  factory ServiceConfigResponseCloudfunctionsV2beta.fromMap(
    ...
    return ServiceConfigResponseCloudfunctionsV2beta(
      ...
      secretEnvironmentVariables:
          pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2beta>(
              map['secretEnvironmentVariables'],
              (value) => SecretEnvVarResponseCloudfunctionsV2beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      secretVolumes:
          pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2beta>(
              map['secretVolumes'],
              (value) => SecretVolumeResponseCloudfunctionsV2beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
