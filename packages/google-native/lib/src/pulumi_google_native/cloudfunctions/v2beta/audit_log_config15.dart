...
class AuditLogConfig15 {
  ...
  factory AuditLogConfig15.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig15(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType15.fromValue(map['logType'] as String),
    );
  }
}
