...
class FunctionCloudfunctionsV2betaArgs {
  ...
  factory FunctionCloudfunctionsV2betaArgs.fromMap(Map<String, dynamic> map) {
    return FunctionCloudfunctionsV2betaArgs(
      buildConfig:
          pulumi.Input.asOptionalInput<BuildConfigCloudfunctionsV2beta>(
              map['buildConfig']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      environment:
          pulumi.Input.asOptionalInput<FunctionEnvironmentCloudfunctionsV2beta>(
              map['environment']),
      eventTrigger:
          pulumi.Input.asOptionalInput<EventTriggerCloudfunctionsV2beta>(
              map['eventTrigger']),
      ...
      serviceConfig:
          pulumi.Input.asOptionalInput<ServiceConfigCloudfunctionsV2beta>(
              map['serviceConfig']),
    );
  }
}
