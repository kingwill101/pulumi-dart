...
class GetFunctionCloudfunctionsV2betaResult {
  ...
  GetFunctionCloudfunctionsV2betaResult({
  ...
  factory GetFunctionCloudfunctionsV2betaResult.fromMap(
      Map<String, dynamic> map) {
    return GetFunctionCloudfunctionsV2betaResult(
      buildConfig: BuildConfigResponseCloudfunctionsV2beta.fromMap(
          (map['buildConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      environment: map['environment'] as String,
      eventTrigger: EventTriggerResponseCloudfunctionsV2beta.fromMap(
          (map['eventTrigger'] as Map).cast<String, dynamic>()),
      kmsKeyName: map['kmsKeyName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      serviceConfig: ServiceConfigResponseCloudfunctionsV2beta.fromMap(
