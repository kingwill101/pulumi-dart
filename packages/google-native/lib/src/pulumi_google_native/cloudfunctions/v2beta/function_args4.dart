...
import 'build_config3.dart';
import 'event_trigger4.dart';
import 'function_environment3.dart';
import 'service_config3.dart';

/// The set of arguments for Function.
class FunctionArgs4 {
  /// Describes the Build step of the function that builds a container from the given source.
  final Input<BuildConfig3>? buildConfig;

  /// User-provided description of a function.
  final Input<String>? description;

  /// Describe whether the function is 1st Gen or 2nd Gen.
  final Input<FunctionEnvironment3>? environment;

  /// An Eventarc trigger managed by Google Cloud Functions that fires events in response to a condition in another service.
  final Input<EventTrigger4>? eventTrigger;
  ...
  final Input<ServiceConfig3>? serviceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (buildConfigValue != null) {
      map['buildConfig'] =
          Input.mapOptionalInputValue<BuildConfig3, Map<String, dynamic>>(
    ...
    if (environmentValue != null) {
      map['environment'] =
          Input.mapOptionalInputValue<FunctionEnvironment3, String>(
              environmentValue, (value) => value.value);
    }
    final eventTriggerValue = eventTrigger;
    if (eventTriggerValue != null) {
      map['eventTrigger'] =
          Input.mapOptionalInputValue<EventTrigger4, Map<String, dynamic>>(
    ...
    if (serviceConfigValue != null) {
      map['serviceConfig'] =
          Input.mapOptionalInputValue<ServiceConfig3, Map<String, dynamic>>(
              serviceConfigValue, (value) => value.toMap());
    }
    return map;
  }

  factory FunctionArgs4.fromMap(Map<String, dynamic> map) {
    return FunctionArgs4(
      buildConfig: Input.asOptionalInput<BuildConfig3>(map['buildConfig']),
      description: Input.asOptionalInput<String>(map['description']),
      environment:
          Input.asOptionalInput<FunctionEnvironment3>(map['environment']),
      eventTrigger: Input.asOptionalInput<EventTrigger4>(map['eventTrigger']),
      ...
      serviceConfig:
          Input.asOptionalInput<ServiceConfig3>(map['serviceConfig']),
    );
  }
}
