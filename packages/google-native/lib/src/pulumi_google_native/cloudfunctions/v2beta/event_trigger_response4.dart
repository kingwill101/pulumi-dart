...
import 'event_filter_response3.dart';

/// Describes EventTrigger, used to request events to be sent from another service.
class EventTriggerResponse4 {
  /// Optional. The name of the channel associated with the trigger in `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from Eventarc SaaS partners.
  final String channel;

  /// Criteria used to filter events.
  final List<EventFilterResponse3> eventFilters;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['channel'] = channel;
    map['eventFilters'] =
        Input.encodeList<EventFilterResponse3, Map<String, dynamic>>(
  ...
  factory EventTriggerResponse4.fromMap(Map<String, dynamic> map) {
    return EventTriggerResponse4(
      channel: map['channel'] as String,
      eventFilters: Input.decodeList<EventFilterResponse3>(
          map['eventFilters'],
          (value) => EventFilterResponse3.fromMap(
