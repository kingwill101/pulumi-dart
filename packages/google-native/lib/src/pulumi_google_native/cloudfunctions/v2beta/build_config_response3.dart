...
import 'source_provenance_response4.dart';
import 'source_response4.dart';

/// Describes the Build step of the function that builds a container from the given source.
class BuildConfigResponse3 {
  ...
  final SourceResponse4 source;

  /// A permanent fixed identifier for source.
  final SourceProvenanceResponse4 sourceProvenance;
  ...
  factory BuildConfigResponse3.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponse3(
      ...
      source: SourceResponse4.fromMap(
          (map['source'] as Map).cast<String, dynamic>()),
      sourceProvenance: SourceProvenanceResponse4.fromMap(
