...
import 'secret_env_var4.dart';
import 'secret_volume4.dart';
import 'service_config_ingress_settings3.dart';
import 'service_config_security_level3.dart';
import 'service_config_vpc_connector_egress_settings3.dart';

/// Describes the Service being deployed. Currently Supported : Cloud Run (fully managed).
class ServiceConfig3 {
  ...
  final ServiceConfigIngressSettings3? ingressSettings;
  ...
  final List<SecretEnvVar4>? secretEnvironmentVariables;

  /// Secret volumes configuration.
  final List<SecretVolume4>? secretVolumes;

  /// Security level configure whether the function only accepts https. This configuration is only applicable to 1st Gen functions with Http trigger. By default https is optional for 1st Gen functions; 2nd Gen functions are https ONLY.
  final ServiceConfigSecurityLevel3? securityLevel;
  ...
  final ServiceConfigVpcConnectorEgressSettings3? vpcConnectorEgressSettings;
  ...
  factory ServiceConfig3.fromMap(Map<String, dynamic> map) {
    return ServiceConfig3(
      ...
      ingressSettings: map['ingressSettings'] == null
          ? null
          : ServiceConfigIngressSettings3.fromValue(
      ...
      secretEnvironmentVariables: map['secretEnvironmentVariables'] == null
          ? null
          : Input.decodeList<SecretEnvVar4>(
              map['secretEnvironmentVariables'],
              (value) => SecretEnvVar4.fromMap(
                  (value as Map).cast<String, dynamic>())),
      secretVolumes: map['secretVolumes'] == null
          ? null
          : Input.decodeList<SecretVolume4>(
              map['secretVolumes'],
              (value) => SecretVolume4.fromMap(
                  (value as Map).cast<String, dynamic>())),
      securityLevel: map['securityLevel'] == null
          ? null
          : ServiceConfigSecurityLevel3.fromValue(
      ...
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null
          ? null
          : ServiceConfigVpcConnectorEgressSettings3.fromValue(
