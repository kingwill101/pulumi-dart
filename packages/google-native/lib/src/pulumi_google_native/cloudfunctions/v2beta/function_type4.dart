...
class FunctionType4 extends CustomResource {
  ...
  FunctionType4(
    ...
    this.buildConfig = registerOutput<BuildConfigResponse3>('buildConfig');
    this.description = registerOutput<String>('description');
    this.environment = registerOutput<String>('environment');
    this.eventTrigger = registerOutput<EventTriggerResponse4>('eventTrigger');
    ...
    this.serviceConfig =
        registerOutput<ServiceConfigResponse3>('serviceConfig');
