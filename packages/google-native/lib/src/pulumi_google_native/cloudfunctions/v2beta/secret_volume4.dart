...
class SecretVolume4 {
  ...
  final List<SecretVersion4>? versions;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (versionsValue != null) {
      map['versions'] = Input.encodeList<SecretVersion4, Map<String, dynamic>>(
          versionsValue, (value) => value.toMap());
    }
    return map;
  }

  factory SecretVolume4.fromMap(Map<String, dynamic> map) {
    return SecretVolume4(
      ...
      versions: map['versions'] == null
          ? null
          : Input.decodeList<SecretVersion4>(
              map['versions'],
              (value) => SecretVersion4.fromMap(
