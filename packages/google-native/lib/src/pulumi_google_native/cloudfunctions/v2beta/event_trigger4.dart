...
import 'event_filter3.dart';
import 'event_trigger_retry_policy3.dart';
...
class EventTrigger4 {
  ...
  final List<EventFilter3>? eventFilters;
  ...
  final EventTriggerRetryPolicy3? retryPolicy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (eventFiltersValue != null) {
      map['eventFilters'] =
          Input.encodeList<EventFilter3, Map<String, dynamic>>(
  ...
  factory EventTrigger4.fromMap(Map<String, dynamic> map) {
    return EventTrigger4(
      channel: map['channel'] == null ? null : map['channel'] as String,
      eventFilters: map['eventFilters'] == null
          ? null
          : Input.decodeList<EventFilter3>(
              map['eventFilters'],
              (value) =>
                  EventFilter3.fromMap((value as Map).cast<String, dynamic>())),
      eventType: map['eventType'] as String,
      pubsubTopic:
          map['pubsubTopic'] == null ? null : map['pubsubTopic'] as String,
      retryPolicy: map['retryPolicy'] == null
          ? null
          : EventTriggerRetryPolicy3.fromValue(map['retryPolicy'] as String),
