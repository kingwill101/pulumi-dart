...
class BuildConfig3 {
  ...
  factory BuildConfig3.fromMap(Map<String, dynamic> map) {
    return BuildConfig3(
      dockerRegistry: map['dockerRegistry'] == null
          ? null
          : BuildConfigDockerRegistry3.fromValue(
      ...
      source: map['source'] == null
          ? null
          : Source4.fromMap((map['source'] as Map).cast<String, dynamic>()),
      sourceToken:
