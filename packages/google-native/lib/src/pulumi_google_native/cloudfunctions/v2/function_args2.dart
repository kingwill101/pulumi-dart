...
class FunctionArgs2 {
  ...
  final Input<BuildConfig>? buildConfig;
  ...
  final Input<EventTrigger2>? eventTrigger;
  ...
  final Input<ServiceConfig>? serviceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (buildConfigValue != null) {
      map['buildConfig'] =
          Input.mapOptionalInputValue<BuildConfig, Map<String, dynamic>>(
    ...
    if (environmentValue != null) {
      map['environment'] =
          Input.mapOptionalInputValue<FunctionEnvironment, String>(
              environmentValue, (value) => value.value);
    }
    final eventTriggerValue = eventTrigger;
    if (eventTriggerValue != null) {
      map['eventTrigger'] =
          Input.mapOptionalInputValue<EventTrigger2, Map<String, dynamic>>(
    ...
    if (serviceConfigValue != null) {
      map['serviceConfig'] =
          Input.mapOptionalInputValue<ServiceConfig, Map<String, dynamic>>(
  ...
  factory FunctionArgs2.fromMap(Map<String, dynamic> map) {
    return FunctionArgs2(
      buildConfig: Input.asOptionalInput<BuildConfig>(map['buildConfig']),
      description: Input.asOptionalInput<String>(map['description']),
      environment:
          Input.asOptionalInput<FunctionEnvironment>(map['environment']),
      eventTrigger: Input.asOptionalInput<EventTrigger2>(map['eventTrigger']),
      ...
      serviceConfig: Input.asOptionalInput<ServiceConfig>(map['serviceConfig']),
    );
  }
}
