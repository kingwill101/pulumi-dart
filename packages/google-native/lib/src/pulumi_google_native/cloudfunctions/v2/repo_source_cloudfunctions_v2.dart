...
class RepoSourceCloudfunctionsV2 {
  ...
  factory RepoSourceCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return RepoSourceCloudfunctionsV2(
      branchName:
