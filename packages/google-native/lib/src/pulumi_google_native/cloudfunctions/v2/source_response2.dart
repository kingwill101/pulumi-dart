...
class SourceResponse2 {
  ...
  final RepoSourceResponse2 repoSource;

  /// If provided, get the source from this location in Google Cloud Storage.
  final StorageSourceResponse2 storageSource;
  ...
  factory SourceResponse2.fromMap(Map<String, dynamic> map) {
    return SourceResponse2(
      gitUri: map['gitUri'] as String,
      repoSource: RepoSourceResponse2.fromMap(
          (map['repoSource'] as Map).cast<String, dynamic>()),
      storageSource: StorageSourceResponse2.fromMap(
