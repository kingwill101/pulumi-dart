...
class SecretVolume2 {
  ...
  final List<SecretVersion2>? versions;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (versionsValue != null) {
      map['versions'] = Input.encodeList<SecretVersion2, Map<String, dynamic>>(
          versionsValue, (value) => value.toMap());
    }
    return map;
  }

  factory SecretVolume2.fromMap(Map<String, dynamic> map) {
    return SecretVolume2(
      ...
      versions: map['versions'] == null
          ? null
          : Input.decodeList<SecretVersion2>(
              map['versions'],
              (value) => SecretVersion2.fromMap(
