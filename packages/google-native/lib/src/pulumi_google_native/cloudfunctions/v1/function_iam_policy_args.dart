...
class FunctionIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<List<AuditConfig12>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => Input.encodeList<AuditConfig12, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding18>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding18, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory FunctionIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FunctionIamPolicyArgs(
      auditConfigs:
          Input.asOptionalInput<List<AuditConfig12>>(map['auditConfigs']),
      bindings: Input.asOptionalInput<List<Binding18>>(map['bindings']),
