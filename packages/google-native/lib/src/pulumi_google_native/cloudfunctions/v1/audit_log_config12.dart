...
class AuditLogConfig12 {
  ...
  factory AuditLogConfig12.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig12(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType12.fromValue(map['logType'] as String),
    );
  }
}
