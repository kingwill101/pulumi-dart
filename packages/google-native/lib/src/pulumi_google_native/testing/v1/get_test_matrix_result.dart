...
class GetTestMatrixResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['clientInfo'] = clientInfo.toMap();
    map['environmentMatrix'] = environmentMatrix.toMap();
    map['failFast'] = failFast;
    map['flakyTestAttempts'] = flakyTestAttempts;
    map['invalidMatrixDetails'] = invalidMatrixDetails;
