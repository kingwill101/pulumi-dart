...
class SmartShardingResponse {
  ...
  final String targetedShardDuration;

  SmartShardingResponse({
    required this.targetedShardDuration,
  });

  Map<String, dynamic> toMap() {
    final map = <String, dynamic>{};
    map['targetedShardDuration'] = targetedShardDuration;
    return map;
  }

  factory SmartShardingResponse.fromMap(Map<String, dynamic> map) {
    return SmartShardingResponse(
      targetedShardDuration: map['targetedShardDuration'] as String,
    );
  }
}
