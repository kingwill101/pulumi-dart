...
class IosXcTestResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['testSpecialEntitlements'] = testSpecialEntitlements;
    map['testsZip'] = testsZip.toMap();
    map['xcodeVersion'] = xcodeVersion;
    map['xctestrun'] = xctestrun.toMap();
    return map;
  }
