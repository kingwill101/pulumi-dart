...
class GetVersionFirebasehostingV1beta1Result {
  ...
  GetVersionFirebasehostingV1beta1Result({
  ...
  factory GetVersionFirebasehostingV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetVersionFirebasehostingV1beta1Result(
