...
class VersionResponseFirebasehostingV1beta1 {
  ...
  VersionResponseFirebasehostingV1beta1({
  ...
  factory VersionResponseFirebasehostingV1beta1.fromMap(
      Map<String, dynamic> map) {
    return VersionResponseFirebasehostingV1beta1(
