...
class CustomDomainFirebasehostingV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CertificateResponseFirebasehostingV1beta1> cert;
  ...
  late final pulumi.Output<List<StatusResponseFirebasehostingV1beta1>> issues;
  ...
  CustomDomainFirebasehostingV1beta1(
    String name, {
    ...
    this.cert =
        registerOutput<CertificateResponseFirebasehostingV1beta1>('cert');
    ...
    this.issues =
        registerOutput<List<StatusResponseFirebasehostingV1beta1>>('issues');
