...
class GetReleaseFirebasehostingV1beta1Result {
  ...
  GetReleaseFirebasehostingV1beta1Result({
  ...
  factory GetReleaseFirebasehostingV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetReleaseFirebasehostingV1beta1Result(
