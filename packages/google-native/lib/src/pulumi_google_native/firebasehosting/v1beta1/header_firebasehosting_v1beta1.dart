...
class HeaderFirebasehostingV1beta1 {
  ...
  factory HeaderFirebasehostingV1beta1.fromMap(Map<String, dynamic> map) {
    return HeaderFirebasehostingV1beta1(
