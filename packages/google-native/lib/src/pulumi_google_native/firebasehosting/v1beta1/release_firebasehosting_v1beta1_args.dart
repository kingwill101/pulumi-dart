...
class ReleaseFirebasehostingV1beta1Args {
  ...
  ReleaseFirebasehostingV1beta1Args({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = pulumi.Input.mapOptionalInputValue<ReleaseType, String>(
  ...
  factory ReleaseFirebasehostingV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ReleaseFirebasehostingV1beta1Args(
      ...
      type: pulumi.Input.asOptionalInput<ReleaseType>(map['type']),
