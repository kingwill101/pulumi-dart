...
import 'scaling_config_instance_size2.dart';

/// Represents the scaling configuration of a metastore service.
class ScalingConfig2 {
  /// An enum of readable instance sizes, with each instance size mapping to a float value (e.g. InstanceSize.EXTRA_SMALL = scaling_factor(0.1))
  final ScalingConfigInstanceSize2? instanceSize;
  ...
  factory ScalingConfig2.fromMap(Map<String, dynamic> map) {
    return ScalingConfig2(
      instanceSize: map['instanceSize'] == null
          ? null
          : ScalingConfigInstanceSize2.fromValue(map['instanceSize'] as String),
      scalingFactor:
