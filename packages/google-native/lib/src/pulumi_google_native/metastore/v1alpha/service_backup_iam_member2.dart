...
import 'service_backup_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class ServiceBackupIamMember2 extends CustomResource {
  ...
  ServiceBackupIamMember2(
    String name, {
    ServiceBackupIamMemberArgs2? args,
