...
class FederationIamPolicyMetastoreV1alphaArgs {
  ...
  FederationIamPolicyMetastoreV1alphaArgs({
    this.auditConfigs,
    this.bindings,
    this.etag,
  ...
  factory FederationIamPolicyMetastoreV1alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return FederationIamPolicyMetastoreV1alphaArgs(
      auditConfigs:
