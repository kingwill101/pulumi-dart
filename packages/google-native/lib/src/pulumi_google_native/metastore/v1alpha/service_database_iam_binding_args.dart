...
class ServiceDatabaseIamBindingArgs {
  ...
  factory ServiceDatabaseIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseIamBindingArgs(
