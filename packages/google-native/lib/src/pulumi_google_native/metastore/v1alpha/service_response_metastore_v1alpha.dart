...
class ServiceResponseMetastoreV1alpha {
  ...
  final MetadataManagementActivityResponseMetastoreV1alpha
  ...
  factory ServiceResponseMetastoreV1alpha.fromMap(Map<String, dynamic> map) {
    return ServiceResponseMetastoreV1alpha(
      ...
      encryptionConfig: EncryptionConfigResponseMetastoreV1alpha.fromMap(
          (map['encryptionConfig'] as Map).cast<String, dynamic>()),
      endpointUri: map['endpointUri'] as String,
      hiveMetastoreConfig: HiveMetastoreConfigResponseMetastoreV1alpha.fromMap(
          (map['hiveMetastoreConfig'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      maintenanceWindow: MaintenanceWindowResponseMetastoreV1alpha.fromMap(
          (map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      metadataIntegration: MetadataIntegrationResponseMetastoreV1alpha.fromMap(
      ...
      networkConfig: NetworkConfigResponseMetastoreV1alpha.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      port: map['port'] as int,
      releaseChannel: map['releaseChannel'] as String,
      scalingConfig: ScalingConfigResponseMetastoreV1alpha.fromMap(
          (map['scalingConfig'] as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      stateMessage: map['stateMessage'] as String,
      telemetryConfig: TelemetryConfigResponseMetastoreV1alpha.fromMap(
