...
class ServiceBackupIamMemberArgs2 {
  ...
  factory ServiceBackupIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamMemberArgs2(
