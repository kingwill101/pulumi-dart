...
class MetadataImport2 extends CustomResource {
  /// The time when the metadata import was started.
  late final Output<String> createTime;

  /// Immutable. A database dump from a pre-existing metastore's database.
  late final Output<DatabaseDumpResponse2> databaseDump;
  ...
  MetadataImport2(
    ...
    this.databaseDump = registerOutput<DatabaseDumpResponse2>('databaseDump');
