...
class AuditLogConfig52 {
  ...
  factory AuditLogConfig52.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig52(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType52.fromValue(map['logType'] as String),
    );
  }
}
