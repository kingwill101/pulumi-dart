...
class GetServiceBackupIamPolicyArgs2 {
  ...
  GetServiceBackupIamPolicyArgs2({
  ...
  factory GetServiceBackupIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return GetServiceBackupIamPolicyArgs2(
