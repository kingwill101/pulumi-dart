...
class ServiceBackupIamBindingArgs2 {
  ...
  factory ServiceBackupIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamBindingArgs2(
