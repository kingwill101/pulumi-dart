...
import 'database_dump2.dart';

/// The set of arguments for MetadataImport.
class MetadataImportArgs2 {
  /// Immutable. A database dump from a pre-existing metastore's database.
  final Input<DatabaseDump2>? databaseDump;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (databaseDumpValue != null) {
      map['databaseDump'] =
          Input.mapOptionalInputValue<DatabaseDump2, Map<String, dynamic>>(
  ...
  factory MetadataImportArgs2.fromMap(Map<String, dynamic> map) {
    return MetadataImportArgs2(
      databaseDump: Input.asOptionalInput<DatabaseDump2>(map['databaseDump']),
