...
import 'hive_metastore_config_endpoint_protocol2.dart';
import 'kerberos_config4.dart';

/// Specifies configuration information specific to running Hive metastore software as the metastore service.
class HiveMetastoreConfig2 {
  ...
  final HiveMetastoreConfigEndpointProtocol2? endpointProtocol;

  /// Information used to configure the Hive metastore service as a service principal in a Kerberos realm. To disable Kerberos, use the UpdateService method and specify this field's path (hive_metastore_config.kerberos_config) in the request's update_mask while omitting this field from the request's service.
  final KerberosConfig4? kerberosConfig;

  /// Immutable. The Hive metastore schema version.
  final String? version;

  HiveMetastoreConfig2({
  ...
  factory HiveMetastoreConfig2.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfig2(
      ...
      endpointProtocol: map['endpointProtocol'] == null
          ? null
          : HiveMetastoreConfigEndpointProtocol2.fromValue(
              map['endpointProtocol'] as String),
      kerberosConfig: map['kerberosConfig'] == null
          ? null
          : KerberosConfig4.fromMap(
