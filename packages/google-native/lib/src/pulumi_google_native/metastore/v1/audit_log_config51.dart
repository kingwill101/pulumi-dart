...
class AuditLogConfig51 {
  ...
  factory AuditLogConfig51.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig51(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType51.fromValue(map['logType'] as String),
    );
  }
}
