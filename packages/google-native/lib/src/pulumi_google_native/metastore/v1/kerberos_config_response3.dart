...
import 'secret_response3.dart';

/// Configuration information for a Kerberos principal.
class KerberosConfigResponse3 {
  /// A Kerberos keytab file that can be used to authenticate a service principal with a Kerberos Key Distribution Center (KDC).
  final SecretResponse3 keytab;
  ...
  factory KerberosConfigResponse3.fromMap(Map<String, dynamic> map) {
    return KerberosConfigResponse3(
      keytab: SecretResponse3.fromMap(
