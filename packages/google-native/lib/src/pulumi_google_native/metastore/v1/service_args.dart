...
import 'encryption_config_metastore_v1.dart';
import 'hive_metastore_config.dart';
import 'maintenance_window_metastore_v1.dart';
import 'metadata_integration.dart';
import 'network_config_metastore_v1.dart';
...
class ServiceArgs {
  ...
  final pulumi.Input<EncryptionConfigMetastoreV1>? encryptionConfig;
  ...
  final pulumi.Input<MaintenanceWindowMetastoreV1>? maintenanceWindow;
  ...
  final pulumi.Input<NetworkConfigMetastoreV1>? networkConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (encryptionConfigValue != null) {
      map['encryptionConfig'] = pulumi.Input.mapOptionalInputValue<
              EncryptionConfigMetastoreV1, Map<String, dynamic>>(
    ...
    if (maintenanceWindowValue != null) {
      map['maintenanceWindow'] = pulumi.Input.mapOptionalInputValue<
              MaintenanceWindowMetastoreV1, Map<String, dynamic>>(
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      databaseType: pulumi.Input.asOptionalInput<ServiceDatabaseType>(
          map['databaseType']),
      encryptionConfig:
          pulumi.Input.asOptionalInput<EncryptionConfigMetastoreV1>(
      ...
      maintenanceWindow:
          pulumi.Input.asOptionalInput<MaintenanceWindowMetastoreV1>(
      ...
      networkConfig: pulumi.Input.asOptionalInput<NetworkConfigMetastoreV1>(
          map['networkConfig']),
      ...
      scalingConfig:
          pulumi.Input.asOptionalInput<ScalingConfig>(map['scalingConfig']),
      serviceId: pulumi.Input.asInput<String>(map['serviceId']),
      telemetryConfig:
          pulumi.Input.asOptionalInput<TelemetryConfig>(map['telemetryConfig']),
      tier: pulumi.Input.asOptionalInput<ServiceTier>(map['tier']),
    );
  }
}
