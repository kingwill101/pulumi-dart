...
class Service extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EncryptionConfigResponseMetastoreV1>
      encryptionConfig;
  ...
  late final pulumi.Output<MaintenanceWindowResponseMetastoreV1>
      maintenanceWindow;
  ...
  late final pulumi.Output<NetworkConfigResponseMetastoreV1> networkConfig;
  ...
  Service(
    ...
    this.encryptionConfig =
        registerOutput<EncryptionConfigResponseMetastoreV1>('encryptionConfig');
    ...
    this.maintenanceWindow =
        registerOutput<MaintenanceWindowResponseMetastoreV1>(
            'maintenanceWindow');
    ...
    this.networkConfig =
        registerOutput<NetworkConfigResponseMetastoreV1>('networkConfig');
