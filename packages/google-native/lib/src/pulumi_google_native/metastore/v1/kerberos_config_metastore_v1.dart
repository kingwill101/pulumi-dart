...
import 'secret_metastore_v1.dart';

/// Configuration information for a Kerberos principal.
class KerberosConfigMetastoreV1 {
  /// A Kerberos keytab file that can be used to authenticate a service principal with a Kerberos Key Distribution Center (KDC).
  final SecretMetastoreV1? keytab;
  ...
  factory KerberosConfigMetastoreV1.fromMap(Map<String, dynamic> map) {
    return KerberosConfigMetastoreV1(
      keytab: map['keytab'] == null
          ? null
          : SecretMetastoreV1.fromMap(
