...
class ServiceIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<List<AuditConfig51>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => Input.encodeList<AuditConfig51, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding75>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding75, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory ServiceIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamPolicyArgs(
      auditConfigs:
          Input.asOptionalInput<List<AuditConfig51>>(map['auditConfigs']),
      bindings: Input.asOptionalInput<List<Binding75>>(map['bindings']),
