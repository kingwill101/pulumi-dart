...
class ServiceIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigMetastoreV1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigMetastoreV1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingMetastoreV1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) =>
              pulumi.Input.encodeList<BindingMetastoreV1, Map<String, dynamic>>(
  ...
  factory ServiceIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamPolicyArgs(
      auditConfigs: pulumi.Input.asOptionalInput<List<AuditConfigMetastoreV1>>(
          map['auditConfigs']),
      bindings: pulumi.Input.asOptionalInput<List<BindingMetastoreV1>>(
          map['bindings']),
