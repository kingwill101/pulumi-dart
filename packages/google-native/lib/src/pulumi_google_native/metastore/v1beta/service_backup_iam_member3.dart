...
import 'service_backup_iam_member_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class ServiceBackupIamMember3 extends CustomResource {
  ...
  ServiceBackupIamMember3(
    String name, {
    ServiceBackupIamMemberArgs3? args,
