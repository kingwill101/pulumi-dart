...
import 'service_database_table_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class ServiceDatabaseTableIamBinding2 extends CustomResource {
  ...
  ServiceDatabaseTableIamBinding2(
    String name, {
    ServiceDatabaseTableIamBindingArgs2? args,
