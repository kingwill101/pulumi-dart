...
class GetServiceBackupIamPolicyArgs3 {
  ...
  GetServiceBackupIamPolicyArgs3({
  ...
  factory GetServiceBackupIamPolicyArgs3.fromMap(Map<String, dynamic> map) {
    return GetServiceBackupIamPolicyArgs3(
