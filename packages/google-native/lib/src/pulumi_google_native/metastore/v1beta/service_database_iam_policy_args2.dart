...
class ServiceDatabaseIamPolicyArgs2 {
  ...
  factory ServiceDatabaseIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseIamPolicyArgs2(
      auditConfigs:
