...
class GetFederationMetastoreV1betaResult {
  ...
  GetFederationMetastoreV1betaResult({
  ...
  factory GetFederationMetastoreV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetFederationMetastoreV1betaResult(
      backendMetastores:
