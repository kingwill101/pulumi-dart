...
import 'service_response3.dart';

/// Result data returned by getBackup.
class GetBackupResult13 {
  ...
  final ServiceResponse3 serviceRevision;
  ...
  factory GetBackupResult13.fromMap(Map<String, dynamic> map) {
    return GetBackupResult13(
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      endTime: map['endTime'] as String,
      name: map['name'] as String,
      restoringServices: (map['restoringServices'] as List).cast<String>(),
      serviceRevision: ServiceResponse3.fromMap(
