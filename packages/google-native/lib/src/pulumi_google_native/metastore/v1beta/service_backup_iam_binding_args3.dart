...
class ServiceBackupIamBindingArgs3 {
  ...
  factory ServiceBackupIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamBindingArgs3(
