...
import 'kerberos_config_response5.dart';

/// Specifies configuration information specific to running Hive metastore software as the metastore service.
class HiveMetastoreConfigResponse3 {
  ...
  final KerberosConfigResponse5 kerberosConfig;

  /// Immutable. The Hive metastore schema version.
  final String version;

  HiveMetastoreConfigResponse3({
  ...
  factory HiveMetastoreConfigResponse3.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigResponse3(
      auxiliaryVersions:
      ...
      kerberosConfig: KerberosConfigResponse5.fromMap(
