...
class ServiceDatabaseIamMemberArgs2 {
  ...
  factory ServiceDatabaseIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseIamMemberArgs2(
