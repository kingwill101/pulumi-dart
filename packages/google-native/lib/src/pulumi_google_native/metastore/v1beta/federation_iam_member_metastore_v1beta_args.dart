...
class FederationIamMemberMetastoreV1betaArgs {
  ...
  FederationIamMemberMetastoreV1betaArgs({
    this.condition,
  ...
  factory FederationIamMemberMetastoreV1betaArgs.fromMap(
      Map<String, dynamic> map) {
    return FederationIamMemberMetastoreV1betaArgs(
