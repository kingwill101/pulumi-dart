...
import 'service_backup_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class ServiceBackupIamBinding3 extends CustomResource {
  ...
  ServiceBackupIamBinding3(
    String name, {
    ServiceBackupIamBindingArgs3? args,
