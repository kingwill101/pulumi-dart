...
class ServiceDatabaseTableIamBindingArgs2 {
  ...
  ServiceDatabaseTableIamBindingArgs2({
    this.condition,
  ...
  factory ServiceDatabaseTableIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return ServiceDatabaseTableIamBindingArgs2(
