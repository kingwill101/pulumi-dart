...
class ServiceDatabaseTableIamMemberArgs2 {
  ...
  ServiceDatabaseTableIamMemberArgs2({
    this.condition,
  ...
  factory ServiceDatabaseTableIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseTableIamMemberArgs2(
