...
class ServiceBackupIamMemberArgs3 {
  ...
  factory ServiceBackupIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamMemberArgs3(
