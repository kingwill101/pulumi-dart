...
class Service3 extends CustomResource {
  ...
  Service3(
    ...
    this.encryptionConfig =
        registerOutput<EncryptionConfigResponse13>('encryptionConfig');
    this.endpointUri = registerOutput<String>('endpointUri');
    this.hiveMetastoreConfig =
        registerOutput<HiveMetastoreConfigResponse3>('hiveMetastoreConfig');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.maintenanceWindow =
        registerOutput<MaintenanceWindowResponse8>('maintenanceWindow');
    this.metadataIntegration =
        registerOutput<MetadataIntegrationResponse3>('metadataIntegration');
    this.metadataManagementActivity =
        registerOutput<MetadataManagementActivityResponse3>(
            'metadataManagementActivity');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig =
        registerOutput<NetworkConfigResponse18>('networkConfig');
    this.port = registerOutput<int>('port');
    this.project = registerOutput<String>('project');
    this.releaseChannel = registerOutput<String>('releaseChannel');
    this.requestId = registerOutput<String?>('requestId');
    this.scalingConfig =
        registerOutput<ScalingConfigResponse3>('scalingConfig');
    this.serviceId = registerOutput<String>('serviceId');
    this.state = registerOutput<String>('state');
    this.stateMessage = registerOutput<String>('stateMessage');
    this.telemetryConfig =
        registerOutput<TelemetryConfigResponse3>('telemetryConfig');
