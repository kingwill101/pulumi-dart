...
/// The set of arguments for ServiceDatabaseIamBinding.
class ServiceDatabaseIamBindingArgs2 {
  ...
  ServiceDatabaseIamBindingArgs2({
    this.condition,
  ...
  factory ServiceDatabaseIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseIamBindingArgs2(
