...
import 'backup_args13.dart';
import 'service_response3.dart';

/// Creates a new backup in a given project and location.
class Backup13 extends CustomResource {
  ...
  late final Output<ServiceResponse3> serviceRevision;
  ...
  Backup13(
    ...
    this.serviceRevision = registerOutput<ServiceResponse3>('serviceRevision');
