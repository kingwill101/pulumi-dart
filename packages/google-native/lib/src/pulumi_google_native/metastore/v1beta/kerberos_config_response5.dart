...
import 'secret_response5.dart';

/// Configuration information for a Kerberos principal.
class KerberosConfigResponse5 {
  /// A Kerberos keytab file that can be used to authenticate a service principal with a Kerberos Key Distribution Center (KDC).
  final SecretResponse5 keytab;
  ...
  factory KerberosConfigResponse5.fromMap(Map<String, dynamic> map) {
    return KerberosConfigResponse5(
      keytab: SecretResponse5.fromMap(
