...
import 'service_database_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class ServiceDatabaseIamBinding2 extends CustomResource {
  ...
  ServiceDatabaseIamBinding2(
    String name, {
    ServiceDatabaseIamBindingArgs2? args,
