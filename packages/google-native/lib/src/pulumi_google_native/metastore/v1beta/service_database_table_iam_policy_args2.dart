...
class ServiceDatabaseTableIamPolicyArgs2 {
  ...
  ServiceDatabaseTableIamPolicyArgs2({
    this.auditConfigs,
    this.bindings,
  ...
  factory ServiceDatabaseTableIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseTableIamPolicyArgs2(
      auditConfigs:
