...
class Cluster9 extends CustomResource {
  ...
  late final Output<List<DiscoveryEndpointResponse>> discoveryEndpoints;
  ...
  late final Output<List<PscConfigResponse3>> pscConfigs;

  /// PSC connections for discovery of the cluster topology and accessing the cluster.
  late final Output<List<PscConnectionResponse2>> pscConnections;
  ...
  late final Output<StateInfoResponse> stateInfo;
