...
class Instance20 extends CustomResource {
  ...
  Instance20(
    ...
    this.maintenancePolicy =
        registerOutput<MaintenancePolicyResponse3>('maintenancePolicy');
    this.maintenanceSchedule =
        registerOutput<MaintenanceScheduleResponse4>('maintenanceSchedule');
    this.maintenanceVersion = registerOutput<String>('maintenanceVersion');
    this.memorySizeGb = registerOutput<int>('memorySizeGb');
    this.name = registerOutput<String>('name');
    this.nodes = registerOutput<List<NodeInfoResponse>>('nodes');
    this.persistenceConfig =
        registerOutput<PersistenceConfigResponse>('persistenceConfig');
    ...
    this.serverCaCerts =
        registerOutput<List<TlsCertificateResponse>>('serverCaCerts');
