...
class MaintenanceScheduleResponseRedisV1 {
  ...
  MaintenanceScheduleResponseRedisV1({
  ...
  factory MaintenanceScheduleResponseRedisV1.fromMap(Map<String, dynamic> map) {
    return MaintenanceScheduleResponseRedisV1(
