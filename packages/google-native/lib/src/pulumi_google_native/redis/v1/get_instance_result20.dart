...
class GetInstanceResult20 {
  ...
  final MaintenancePolicyResponse3 maintenancePolicy;

  /// Date and time of upcoming maintenance events which have been scheduled.
  final MaintenanceScheduleResponse4 maintenanceSchedule;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['nodes'] = Input.encodeList<NodeInfoResponse, Map<String, dynamic>>(
    ...
    map['serverCaCerts'] =
        Input.encodeList<TlsCertificateResponse, Map<String, dynamic>>(
  ...
  factory GetInstanceResult20.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult20(
      ...
      maintenancePolicy: MaintenancePolicyResponse3.fromMap(
          (map['maintenancePolicy'] as Map).cast<String, dynamic>()),
      maintenanceSchedule: MaintenanceScheduleResponse4.fromMap(
      ...
      nodes: Input.decodeList<NodeInfoResponse>(
          map['nodes'],
          (value) =>
      ...
      serverCaCerts: Input.decodeList<TlsCertificateResponse>(
          map['serverCaCerts'],
