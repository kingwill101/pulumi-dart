...
import 'psc_config_redis_v1.dart';

/// The set of arguments for Cluster.
class ClusterRedisV1Args {
  ...
  final pulumi.Input<List<PscConfigRedisV1>> pscConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['pscConfigs'] = pulumi.Input.mapInputValue<List<PscConfigRedisV1>,
            List<Map<String, dynamic>>>(
        pscConfigs,
        (value) =>
            pulumi.Input.encodeList<PscConfigRedisV1, Map<String, dynamic>>(
  ...
  factory ClusterRedisV1Args.fromMap(Map<String, dynamic> map) {
    return ClusterRedisV1Args(
      authorizationMode: pulumi.Input.asOptionalInput<ClusterAuthorizationMode>(
          map['authorizationMode']),
      ...
      pscConfigs:
          pulumi.Input.asInput<List<PscConfigRedisV1>>(map['pscConfigs']),
