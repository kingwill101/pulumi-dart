...
import 'instance_redis_v1_args.dart';
...
class InstanceRedisV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<MaintenancePolicyResponseRedisV1> maintenancePolicy;

  /// Date and time of upcoming maintenance events which have been scheduled.
  late final pulumi.Output<MaintenanceScheduleResponseRedisV1>
      maintenanceSchedule;
  ...
  InstanceRedisV1(
    ...
    this.maintenancePolicy =
        registerOutput<MaintenancePolicyResponseRedisV1>('maintenancePolicy');
    this.maintenanceSchedule =
        registerOutput<MaintenanceScheduleResponseRedisV1>(
            'maintenanceSchedule');
