...
class MaintenanceScheduleResponse4 {
  ...
  factory MaintenanceScheduleResponse4.fromMap(Map<String, dynamic> map) {
    return MaintenanceScheduleResponse4(
