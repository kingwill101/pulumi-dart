...
import 'cluster_redis_v1_args.dart';
...
class ClusterRedisV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PscConfigResponseRedisV1>> pscConfigs;

  /// PSC connections for discovery of the cluster topology and accessing the cluster.
  late final pulumi.Output<List<PscConnectionResponseRedisV1>> pscConnections;
  ...
  ClusterRedisV1(
    ...
    this.pscConfigs =
        registerOutput<List<PscConfigResponseRedisV1>>('pscConfigs');
    this.pscConnections =
        registerOutput<List<PscConnectionResponseRedisV1>>('pscConnections');
