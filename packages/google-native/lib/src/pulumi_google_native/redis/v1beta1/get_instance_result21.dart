...
import 'maintenance_policy_response4.dart';
import 'maintenance_schedule_response5.dart';
import 'node_info_response2.dart';
import 'persistence_config_response2.dart';
import 'tls_certificate_response2.dart';

/// Result data returned by getInstance.
class GetInstanceResult21 {
  ...
  final MaintenancePolicyResponse4 maintenancePolicy;

  /// Date and time of upcoming maintenance events which have been scheduled.
  final MaintenanceScheduleResponse5 maintenanceSchedule;
  ...
  /// Info per node.
  final List<NodeInfoResponse2> nodes;

  /// Optional. Persistence configuration parameters
  final PersistenceConfigResponse2 persistenceConfig;
  ...
  final List<TlsCertificateResponse2> serverCaCerts;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['nodes'] = Input.encodeList<NodeInfoResponse2, Map<String, dynamic>>(
    ...
    map['serverCaCerts'] =
        Input.encodeList<TlsCertificateResponse2, Map<String, dynamic>>(
  ...
  factory GetInstanceResult21.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult21(
      ...
      maintenancePolicy: MaintenancePolicyResponse4.fromMap(
          (map['maintenancePolicy'] as Map).cast<String, dynamic>()),
      maintenanceSchedule: MaintenanceScheduleResponse5.fromMap(
      ...
      nodes: Input.decodeList<NodeInfoResponse2>(
          map['nodes'],
          (value) => NodeInfoResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      persistenceConfig: PersistenceConfigResponse2.fromMap(
      ...
      serverCaCerts: Input.decodeList<TlsCertificateResponse2>(
          map['serverCaCerts'],
          (value) => TlsCertificateResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
