...
class ClusterRedisV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DiscoveryEndpointResponseRedisV1beta1>>
      discoveryEndpoints;
  ...
  late final pulumi.Output<List<PscConnectionResponseRedisV1beta1>>
      pscConnections;
  ...
  ClusterRedisV1beta1(
    ...
    this.discoveryEndpoints =
        registerOutput<List<DiscoveryEndpointResponseRedisV1beta1>>(
            'discoveryEndpoints');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pscConfigs =
        registerOutput<List<PscConfigResponseRedisV1beta1>>('pscConfigs');
    this.pscConnections =
        registerOutput<List<PscConnectionResponseRedisV1beta1>>(
            'pscConnections');
