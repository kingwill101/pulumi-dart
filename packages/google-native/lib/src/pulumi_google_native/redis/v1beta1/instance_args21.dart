...
import 'instance_tier4.dart';
import 'instance_transit_encryption_mode2.dart';
import 'maintenance_policy4.dart';
import 'persistence_config2.dart';

/// The set of arguments for Instance.
class InstanceArgs21 {
  ...
  final Input<InstanceConnectMode2>? connectMode;
  ...
  final Input<MaintenancePolicy4>? maintenancePolicy;
  ...
  final Input<PersistenceConfig2>? persistenceConfig;
  final Input<String>? project;

  /// Optional. Read replicas mode for the instance. Defaults to READ_REPLICAS_DISABLED.
  final Input<InstanceReadReplicasMode2>? readReplicasMode;
  ...
  final Input<List<InstanceSuspensionReasonsItem2>>? suspensionReasons;

  /// The service tier of the instance.
  final Input<InstanceTier4> tier;

  /// Optional. The TLS mode of the Redis instance. If not provided, TLS is disabled for the instance.
  final Input<InstanceTransitEncryptionMode2>? transitEncryptionMode;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (connectModeValue != null) {
      map['connectMode'] =
          Input.mapOptionalInputValue<InstanceConnectMode2, String>(
    ...
    if (maintenancePolicyValue != null) {
      map['maintenancePolicy'] =
          Input.mapOptionalInputValue<MaintenancePolicy4, Map<String, dynamic>>(
    ...
    if (persistenceConfigValue != null) {
      map['persistenceConfig'] =
          Input.mapOptionalInputValue<PersistenceConfig2, Map<String, dynamic>>(
    ...
    if (readReplicasModeValue != null) {
      map['readReplicasMode'] =
          Input.mapOptionalInputValue<InstanceReadReplicasMode2, String>(
    ...
    if (suspensionReasonsValue != null) {
      map['suspensionReasons'] = Input.mapOptionalInputValue<
              List<InstanceSuspensionReasonsItem2>, List<String>>(
          suspensionReasonsValue,
          (value) => Input.encodeList<InstanceSuspensionReasonsItem2, String>(
              value, (value) => value.value));
    }
    map['tier'] = Input.mapInputValue<InstanceTier4, String>(
    ...
    if (transitEncryptionModeValue != null) {
      map['transitEncryptionMode'] =
          Input.mapOptionalInputValue<InstanceTransitEncryptionMode2, String>(
              transitEncryptionModeValue, (value) => value.value);
    }
    return map;
  }

  factory InstanceArgs21.fromMap(Map<String, dynamic> map) {
    return InstanceArgs21(
      ...
      connectMode:
          Input.asOptionalInput<InstanceConnectMode2>(map['connectMode']),
      customerManagedKey:
      ...
      maintenancePolicy:
          Input.asOptionalInput<MaintenancePolicy4>(map['maintenancePolicy']),
      maintenanceVersion:
          Input.asOptionalInput<String>(map['maintenanceVersion']),
      memorySizeGb: Input.asInput<int>(map['memorySizeGb']),
      name: Input.asOptionalInput<String>(map['name']),
      persistenceConfig:
          Input.asOptionalInput<PersistenceConfig2>(map['persistenceConfig']),
      project: Input.asOptionalInput<String>(map['project']),
      readReplicasMode: Input.asOptionalInput<InstanceReadReplicasMode2>(
          map['readReplicasMode']),
      redisConfigs:
      ...
      suspensionReasons:
          Input.asOptionalInput<List<InstanceSuspensionReasonsItem2>>(
              map['suspensionReasons']),
      tier: Input.asInput<InstanceTier4>(map['tier']),
      transitEncryptionMode:
          Input.asOptionalInput<InstanceTransitEncryptionMode2>(
              map['transitEncryptionMode']),
    );
  }
}
