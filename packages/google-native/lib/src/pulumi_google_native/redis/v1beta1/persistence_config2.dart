...
import 'persistence_config_persistence_mode2.dart';
import 'persistence_config_rdb_snapshot_period2.dart';

/// Configuration of the persistence functionality.
class PersistenceConfig2 {
  /// Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
  final PersistenceConfigPersistenceMode2? persistenceMode;

  /// Optional. Period between RDB snapshots. Snapshots will be attempted every period starting from the provided snapshot start time. For example, a start time of 01/01/2033 06:45 and SIX_HOURS snapshot period will do nothing until 01/01/2033, and then trigger snapshots every day at 06:45, 12:45, 18:45, and 00:45 the next day, and so on. If not provided, TWENTY_FOUR_HOURS will be used as default.
  final PersistenceConfigRdbSnapshotPeriod2? rdbSnapshotPeriod;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (persistenceModeValue != null) {
      map['persistenceMode'] = persistenceModeValue.value;
    }
    final rdbSnapshotPeriodValue = rdbSnapshotPeriod;
    if (rdbSnapshotPeriodValue != null) {
      map['rdbSnapshotPeriod'] = rdbSnapshotPeriodValue.value;
    }
  ...
  factory PersistenceConfig2.fromMap(Map<String, dynamic> map) {
    return PersistenceConfig2(
      persistenceMode: map['persistenceMode'] == null
          ? null
          : PersistenceConfigPersistenceMode2.fromValue(
              map['persistenceMode'] as String),
      rdbSnapshotPeriod: map['rdbSnapshotPeriod'] == null
          ? null
          : PersistenceConfigRdbSnapshotPeriod2.fromValue(
