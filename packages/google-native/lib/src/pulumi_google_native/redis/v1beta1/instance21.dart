...
class Instance21 extends CustomResource {
  ...
  late final Output<MaintenancePolicyResponse4> maintenancePolicy;

  /// Date and time of upcoming maintenance events which have been scheduled.
  late final Output<MaintenanceScheduleResponse5> maintenanceSchedule;
  ...
  /// Info per node.
  late final Output<List<NodeInfoResponse2>> nodes;

  /// Optional. Persistence configuration parameters
  late final Output<PersistenceConfigResponse2> persistenceConfig;
  ...
  late final Output<List<TlsCertificateResponse2>> serverCaCerts;
