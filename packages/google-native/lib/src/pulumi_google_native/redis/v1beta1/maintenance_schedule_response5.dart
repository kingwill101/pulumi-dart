...
class MaintenanceScheduleResponse5 {
  ...
  factory MaintenanceScheduleResponse5.fromMap(Map<String, dynamic> map) {
    return MaintenanceScheduleResponse5(
