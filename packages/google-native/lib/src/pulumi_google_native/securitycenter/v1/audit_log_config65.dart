...
class AuditLogConfig65 {
  ...
  factory AuditLogConfig65.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig65(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType65.fromValue(map['logType'] as String),
    );
  }
}
