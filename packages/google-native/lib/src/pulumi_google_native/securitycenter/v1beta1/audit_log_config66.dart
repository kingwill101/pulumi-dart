...
class AuditLogConfig66 {
  ...
  factory AuditLogConfig66.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig66(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType66.fromValue(map['logType'] as String),
    );
  }
}
