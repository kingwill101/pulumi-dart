...
import 'organization_source_iam_binding_args2.dart';

/// Sets the access control policy on the specified Source.
class OrganizationSourceIamBinding2 extends CustomResource {
  ...
  OrganizationSourceIamBinding2(
    String name, {
    OrganizationSourceIamBindingArgs2? args,
