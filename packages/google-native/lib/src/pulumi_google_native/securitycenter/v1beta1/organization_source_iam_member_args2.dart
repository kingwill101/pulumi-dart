...
class OrganizationSourceIamMemberArgs2 {
  ...
  OrganizationSourceIamMemberArgs2({
    this.condition,
  ...
  factory OrganizationSourceIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return OrganizationSourceIamMemberArgs2(
