...
import 'organization_source_iam_member_args2.dart';

/// Sets the access control policy on the specified Source.
class OrganizationSourceIamMember2 extends CustomResource {
  ...
  OrganizationSourceIamMember2(
    String name, {
    OrganizationSourceIamMemberArgs2? args,
