...
class OrganizationSourceIamBindingArgs2 {
  ...
  OrganizationSourceIamBindingArgs2({
    this.condition,
  ...
  factory OrganizationSourceIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return OrganizationSourceIamBindingArgs2(
