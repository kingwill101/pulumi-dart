...
class ServicePerimeterArgs {
  ...
  final Input<ServicePerimeterPerimeterType>? perimeterType;

  /// Proposed (or dry run) ServicePerimeter configuration. This configuration allows to specify and test ServicePerimeter configuration without enforcing actual access restrictions. Only allowed to be set when the "use_explicit_dry_run_spec" flag is set.
  final Input<ServicePerimeterConfig>? spec;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (perimeterTypeValue != null) {
      map['perimeterType'] =
          Input.mapOptionalInputValue<ServicePerimeterPerimeterType, String>(
              perimeterTypeValue, (value) => value.value);
    }
    final specValue = spec;
    if (specValue != null) {
      map['spec'] = Input.mapOptionalInputValue<ServicePerimeterConfig,
  ...
  factory ServicePerimeterArgs.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterArgs(
      ...
      perimeterType: Input.asOptionalInput<ServicePerimeterPerimeterType>(
          map['perimeterType']),
      spec: Input.asOptionalInput<ServicePerimeterConfig>(map['spec']),
