...
class AccessPolicyIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<List<AuditConfig>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => Input.encodeList<AuditConfig, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory AccessPolicyIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIamPolicyArgs(
      ...
      auditConfigs:
          Input.asOptionalInput<List<AuditConfig>>(map['auditConfigs']),
      bindings: Input.asOptionalInput<List<Binding>>(map['bindings']),
