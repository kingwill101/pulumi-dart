...
import 'vpc_accessible_services2.dart';

/// `ServicePerimeterConfig` specifies a set of Google Cloud resources that describe specific Service Perimeter configuration.
class ServicePerimeterConfig2 {
  ...
  final VpcAccessibleServices2? vpcAccessibleServices;

  ServicePerimeterConfig2({
    this.accessLevels,
    this.resources,
  ...
  factory ServicePerimeterConfig2.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterConfig2(
      ...
      vpcAccessibleServices: map['vpcAccessibleServices'] == null
          ? null
          : VpcAccessibleServices2.fromMap(
