...
import 'os_constraint_os_type2.dart';
...
class OsConstraint2 {
  ...
  /// The allowed OS type.
  final OsConstraintOsType2 osType;
  ...
  factory OsConstraint2.fromMap(Map<String, dynamic> map) {
    return OsConstraint2(
      minimumVersion: map['minimumVersion'] == null
          ? null
          : map['minimumVersion'] as String,
      osType: OsConstraintOsType2.fromValue(map['osType'] as String),
