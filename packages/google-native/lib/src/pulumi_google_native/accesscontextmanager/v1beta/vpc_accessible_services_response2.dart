...
class VpcAccessibleServicesResponse2 {
  ...
  VpcAccessibleServicesResponse2({
  ...
  factory VpcAccessibleServicesResponse2.fromMap(Map<String, dynamic> map) {
    return VpcAccessibleServicesResponse2(
