...
class GameServerDeploymentIamPolicyGameservicesV1betaArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigGameservicesV1beta>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigGameservicesV1beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingGameservicesV1beta>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingGameservicesV1beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (rulesValue != null) {
      map['rules'] = pulumi.Input.mapOptionalInputValue<
              List<RuleGameservicesV1beta>, List<Map<String, dynamic>>>(
          rulesValue,
          (value) => pulumi.Input.encodeList<RuleGameservicesV1beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory GameServerDeploymentIamPolicyGameservicesV1betaArgs.fromMap(
      Map<String, dynamic> map) {
    return GameServerDeploymentIamPolicyGameservicesV1betaArgs(
      auditConfigs:
          pulumi.Input.asOptionalInput<List<AuditConfigGameservicesV1beta>>(
              map['auditConfigs']),
      bindings: pulumi.Input.asOptionalInput<List<BindingGameservicesV1beta>>(
          map['bindings']),
      ...
      rules: pulumi.Input.asOptionalInput<List<RuleGameservicesV1beta>>(
          map['rules']),
