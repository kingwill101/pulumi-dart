...
import 'game_server_deployment_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class GameServerDeploymentIamBinding2 extends CustomResource {
  ...
  GameServerDeploymentIamBinding2(
    String name, {
    GameServerDeploymentIamBindingArgs2? args,
