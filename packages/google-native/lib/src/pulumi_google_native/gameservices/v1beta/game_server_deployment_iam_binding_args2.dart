...
class GameServerDeploymentIamBindingArgs2 {
  ...
  GameServerDeploymentIamBindingArgs2({
    this.condition,
  ...
  factory GameServerDeploymentIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return GameServerDeploymentIamBindingArgs2(
