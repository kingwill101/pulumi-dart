...
import 'game_server_deployment_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class GameServerDeploymentIamMember2 extends CustomResource {
  ...
  GameServerDeploymentIamMember2(
    String name, {
    GameServerDeploymentIamMemberArgs2? args,
