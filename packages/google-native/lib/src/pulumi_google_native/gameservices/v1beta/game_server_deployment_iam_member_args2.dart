...
class GameServerDeploymentIamMemberArgs2 {
  ...
  GameServerDeploymentIamMemberArgs2({
    this.condition,
  ...
  factory GameServerDeploymentIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return GameServerDeploymentIamMemberArgs2(
