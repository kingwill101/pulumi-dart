...
class AuditLogConfig39 {
  ...
  factory AuditLogConfig39.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig39(
      ...
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType39.fromValue(map['logType'] as String),
    );
  }
}
