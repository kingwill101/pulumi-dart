...
class AuditLogConfigGameservicesV1 {
  ...
  factory AuditLogConfigGameservicesV1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigGameservicesV1(
      ...
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogTypeGameservicesV1.fromValue(
