...
class AuditLogConfig38 {
  ...
  factory AuditLogConfig38.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig38(
      ...
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType38.fromValue(map['logType'] as String),
    );
  }
}
