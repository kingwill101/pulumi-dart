...
import 'authorization_logging_options_response4.dart';

/// Write a Cloud Audit log
class CloudAuditOptionsResponse {
  /// Information used by the Cloud Audit Logging pipeline.
  final AuthorizationLoggingOptionsResponse4 authorizationLoggingOptions;
  ...
  factory CloudAuditOptionsResponse.fromMap(Map<String, dynamic> map) {
    return CloudAuditOptionsResponse(
      authorizationLoggingOptions: AuthorizationLoggingOptionsResponse4.fromMap(
