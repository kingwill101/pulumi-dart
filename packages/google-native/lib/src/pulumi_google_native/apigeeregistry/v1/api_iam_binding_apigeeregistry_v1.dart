...
import 'api_iam_binding_apigeeregistry_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ApiIamBindingApigeeregistryV1 extends pulumi.CustomResource {
  ...
  ApiIamBindingApigeeregistryV1(
    String name, {
    ApiIamBindingApigeeregistryV1Args? args,
