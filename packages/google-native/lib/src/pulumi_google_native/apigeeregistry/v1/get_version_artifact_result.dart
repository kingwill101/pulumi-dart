...
/// Result data returned by getVersionArtifact.
class GetVersionArtifactResult {
  ...
  factory GetVersionArtifactResult.fromMap(Map<String, dynamic> map) {
    return GetVersionArtifactResult(
