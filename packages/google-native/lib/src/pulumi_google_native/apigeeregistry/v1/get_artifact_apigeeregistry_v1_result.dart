...
class GetArtifactApigeeregistryV1Result {
  ...
  GetArtifactApigeeregistryV1Result({
  ...
  factory GetArtifactApigeeregistryV1Result.fromMap(Map<String, dynamic> map) {
    return GetArtifactApigeeregistryV1Result(
