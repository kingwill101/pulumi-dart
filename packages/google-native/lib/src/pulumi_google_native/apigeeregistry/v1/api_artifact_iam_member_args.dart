...
/// The set of arguments for ApiArtifactIamMember.
class ApiArtifactIamMemberArgs {
  ...
  factory ApiArtifactIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApiArtifactIamMemberArgs(
