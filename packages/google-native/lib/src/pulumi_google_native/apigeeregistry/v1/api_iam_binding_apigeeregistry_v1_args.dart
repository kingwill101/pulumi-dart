...
class ApiIamBindingApigeeregistryV1Args {
  ...
  ApiIamBindingApigeeregistryV1Args({
    this.condition,
  ...
  factory ApiIamBindingApigeeregistryV1Args.fromMap(Map<String, dynamic> map) {
    return ApiIamBindingApigeeregistryV1Args(
