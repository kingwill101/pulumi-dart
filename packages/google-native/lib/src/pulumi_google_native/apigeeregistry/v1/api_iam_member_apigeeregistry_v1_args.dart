...
class ApiIamMemberApigeeregistryV1Args {
  ...
  ApiIamMemberApigeeregistryV1Args({
    this.condition,
  ...
  factory ApiIamMemberApigeeregistryV1Args.fromMap(Map<String, dynamic> map) {
    return ApiIamMemberApigeeregistryV1Args(
