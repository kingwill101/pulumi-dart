...
import 'api_version_spec_artifact_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ApiVersionSpecArtifactIamBinding extends pulumi.CustomResource {
  ...
  ApiVersionSpecArtifactIamBinding(
    String name, {
    ApiVersionSpecArtifactIamBindingArgs? args,
