...
import 'api_iam_member_apigeeregistry_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ApiIamMemberApigeeregistryV1 extends pulumi.CustomResource {
  ...
  ApiIamMemberApigeeregistryV1(
    String name, {
    ApiIamMemberApigeeregistryV1Args? args,
