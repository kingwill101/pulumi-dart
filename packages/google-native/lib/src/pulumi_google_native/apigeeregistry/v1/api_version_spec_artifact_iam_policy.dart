...
class ApiVersionSpecArtifactIamPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<BindingResponseApigeeregistryV1>> bindings;
  ...
  ApiVersionSpecArtifactIamPolicy(
    ...
    this.bindings =
        registerOutput<List<BindingResponseApigeeregistryV1>>('bindings');
