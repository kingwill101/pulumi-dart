...
class OrganizationIamBindingArgs2 {
  ...
  factory OrganizationIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return OrganizationIamBindingArgs2(
