...
class AuditLogConfig18 {
  ...
  factory AuditLogConfig18.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig18(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType18.fromValue(map['logType'] as String),
    );
  }
}
