...
import 'project_lifecycle_state2.dart';
import 'resource_id2.dart';
...
class ProjectArgs2 {
  ...
  final Input<ProjectLifecycleState2>? lifecycleState;
  ...
  final Input<ResourceId2>? parent;
  ...
  final Input<bool>? useLegacyStack;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (lifecycleStateValue != null) {
      map['lifecycleState'] =
          Input.mapOptionalInputValue<ProjectLifecycleState2, String>(
    ...
    if (parentValue != null) {
      map['parent'] =
          Input.mapOptionalInputValue<ResourceId2, Map<String, dynamic>>(
  ...
  factory ProjectArgs2.fromMap(Map<String, dynamic> map) {
    return ProjectArgs2(
      ...
      lifecycleState:
          Input.asOptionalInput<ProjectLifecycleState2>(map['lifecycleState']),
      name: Input.asOptionalInput<String>(map['name']),
      parent: Input.asOptionalInput<ResourceId2>(map['parent']),
      projectId: Input.asOptionalInput<String>(map['projectId']),
      projectNumber: Input.asOptionalInput<String>(map['projectNumber']),
      useLegacyStack: Input.asOptionalInput<bool>(map['useLegacyStack']),
    );
  }
}
