...
class AuditLogConfig17 {
  ...
  factory AuditLogConfig17.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig17(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType17.fromValue(map['logType'] as String),
    );
  }
}
