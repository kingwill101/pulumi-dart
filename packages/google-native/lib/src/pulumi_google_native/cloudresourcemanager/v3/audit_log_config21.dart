...
class AuditLogConfig21 {
  ...
  factory AuditLogConfig21.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig21(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType21.fromValue(map['logType'] as String),
    );
  }
}
