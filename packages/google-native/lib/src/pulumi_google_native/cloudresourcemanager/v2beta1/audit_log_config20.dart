...
class AuditLogConfig20 {
  ...
  factory AuditLogConfig20.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig20(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType20.fromValue(map['logType'] as String),
    );
  }
}
