...
class AuditLogConfig19 {
  ...
  factory AuditLogConfig19.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig19(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType19.fromValue(map['logType'] as String),
    );
  }
}
