...
class QuantityBasedExpiryResponse3 {
  ...
  factory QuantityBasedExpiryResponse3.fromMap(Map<String, dynamic> map) {
    return QuantityBasedExpiryResponse3(
