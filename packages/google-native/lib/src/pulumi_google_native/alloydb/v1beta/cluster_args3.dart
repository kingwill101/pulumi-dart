...
import 'automated_backup_policy3.dart';
import 'cluster_database_version3.dart';
import 'continuous_backup_config3.dart';
import 'encryption_config3.dart';
import 'network_config3.dart';
import 'secondary_config3.dart';
import 'ssl_config3.dart';
import 'user_password3.dart';
...
class ClusterArgs3 {
  ...
  final Input<AutomatedBackupPolicy3>? automatedBackupPolicy;

  /// Required. ID of the requesting object.
  final Input<String> clusterId;

  /// Optional. Continuous backup configuration for this cluster.
  final Input<ContinuousBackupConfig3>? continuousBackupConfig;

  /// Optional. The database engine major version. This is an optional field and it is populated at the Cluster creation time. If a database version is not supplied at cluster creation time, then a default database version will be used.
  final Input<ClusterDatabaseVersion3>? databaseVersion;
  ...
  final Input<UserPassword3>? initialUser;
  ...
  final Input<NetworkConfig3>? networkConfig;
  ...
  final Input<SecondaryConfig3>? secondaryConfig;

  /// SSL configuration for this AlloyDB cluster.
  final Input<SslConfig3>? sslConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (automatedBackupPolicyValue != null) {
      map['automatedBackupPolicy'] = Input.mapOptionalInputValue<
              AutomatedBackupPolicy3, Map<String, dynamic>>(
    ...
    if (initialUserValue != null) {
      map['initialUser'] =
          Input.mapOptionalInputValue<UserPassword3, Map<String, dynamic>>(
    ...
    if (networkConfigValue != null) {
      map['networkConfig'] =
          Input.mapOptionalInputValue<NetworkConfig3, Map<String, dynamic>>(
    ...
    if (secondaryConfigValue != null) {
      map['secondaryConfig'] =
          Input.mapOptionalInputValue<SecondaryConfig3, Map<String, dynamic>>(
              secondaryConfigValue, (value) => value.toMap());
    }
    final sslConfigValue = sslConfig;
    if (sslConfigValue != null) {
      map['sslConfig'] =
          Input.mapOptionalInputValue<SslConfig3, Map<String, dynamic>>(
  ...
  factory ClusterArgs3.fromMap(Map<String, dynamic> map) {
    return ClusterArgs3(
      ...
      automatedBackupPolicy: Input.asOptionalInput<AutomatedBackupPolicy3>(
          map['automatedBackupPolicy']),
      clusterId: Input.asInput<String>(map['clusterId']),
      continuousBackupConfig: Input.asOptionalInput<ContinuousBackupConfig3>(
          map['continuousBackupConfig']),
      databaseVersion: Input.asOptionalInput<ClusterDatabaseVersion3>(
          map['databaseVersion']),
      displayName: Input.asOptionalInput<String>(map['displayName']),
      encryptionConfig:
          Input.asOptionalInput<EncryptionConfig3>(map['encryptionConfig']),
      etag: Input.asOptionalInput<String>(map['etag']),
      initialUser: Input.asOptionalInput<UserPassword3>(map['initialUser']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      network: Input.asInput<String>(map['network']),
      networkConfig:
          Input.asOptionalInput<NetworkConfig3>(map['networkConfig']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      secondaryConfig:
          Input.asOptionalInput<SecondaryConfig3>(map['secondaryConfig']),
      sslConfig: Input.asOptionalInput<SslConfig3>(map['sslConfig']),
    );
  }
}
