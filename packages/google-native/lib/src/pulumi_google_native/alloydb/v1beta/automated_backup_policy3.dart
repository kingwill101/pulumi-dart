...
import 'quantity_based_retention3.dart';
import 'time_based_retention3.dart';
import 'weekly_schedule3.dart';

/// Message describing the user-specified automated backup policy. All fields in the automated backup policy are optional. Defaults for each field are provided if they are not set.
class AutomatedBackupPolicy3 {
  ...
  final QuantityBasedRetention3? quantityBasedRetention;

  /// Time-based Backup retention policy.
  final TimeBasedRetention3? timeBasedRetention;

  /// Weekly schedule for the Backup.
  final WeeklySchedule3? weeklySchedule;

  AutomatedBackupPolicy3({
    this.backupWindow,
    this.enabled,
  ...
  factory AutomatedBackupPolicy3.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicy3(
      backupWindow:
