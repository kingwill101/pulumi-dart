...
class InstanceAlloydbV1betaArgs {
  ...
  final pulumi.Input<ClientConnectionConfigAlloydbV1beta>?
  ...
  final pulumi.Input<QueryInsightsInstanceConfigAlloydbV1beta>?
      queryInsightsConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (availabilityTypeValue != null) {
      map['availabilityType'] = pulumi.Input.mapOptionalInputValue<
          InstanceAvailabilityTypeAlloydbV1beta,
    ...
    if (clientConnectionConfigValue != null) {
      map['clientConnectionConfig'] = pulumi.Input.mapOptionalInputValue<
              ClientConnectionConfigAlloydbV1beta, Map<String, dynamic>>(
    ...
    map['instanceType'] =
        pulumi.Input.mapInputValue<InstanceInstanceTypeAlloydbV1beta, String>(
    ...
    if (queryInsightsConfigValue != null) {
      map['queryInsightsConfig'] = pulumi.Input.mapOptionalInputValue<
              QueryInsightsInstanceConfigAlloydbV1beta, Map<String, dynamic>>(
  ...
  factory InstanceAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1betaArgs(
      ...
      availabilityType:
          pulumi.Input.asOptionalInput<InstanceAvailabilityTypeAlloydbV1beta>(
              map['availabilityType']),
      clientConnectionConfig:
          pulumi.Input.asOptionalInput<ClientConnectionConfigAlloydbV1beta>(
      ...
      instanceType: pulumi.Input.asInput<InstanceInstanceTypeAlloydbV1beta>(
          map['instanceType']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      machineConfig: pulumi.Input.asOptionalInput<MachineConfigAlloydbV1beta>(
          map['machineConfig']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      queryInsightsConfig: pulumi.Input.asOptionalInput<
          QueryInsightsInstanceConfigAlloydbV1beta>(map['queryInsightsConfig']),
      readPoolConfig: pulumi.Input.asOptionalInput<ReadPoolConfigAlloydbV1beta>(
          map['readPoolConfig']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      updatePolicy: pulumi.Input.asOptionalInput<UpdatePolicyAlloydbV1beta>(
          map['updatePolicy']),
    );
  }
}
