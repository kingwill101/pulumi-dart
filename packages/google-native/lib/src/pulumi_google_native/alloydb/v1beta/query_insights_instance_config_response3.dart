...
class QueryInsightsInstanceConfigResponse3 {
  ...
  QueryInsightsInstanceConfigResponse3({
  ...
  factory QueryInsightsInstanceConfigResponse3.fromMap(
      Map<String, dynamic> map) {
    return QueryInsightsInstanceConfigResponse3(
