...
class NetworkConfigResponseAlloydbV1beta {
  ...
  NetworkConfigResponseAlloydbV1beta({
  ...
  factory NetworkConfigResponseAlloydbV1beta.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseAlloydbV1beta(
