...
import 'instance_alloydb_v1beta_args.dart';
...
class InstanceAlloydbV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ClientConnectionConfigResponseAlloydbV1beta>
  ...
  late final pulumi.Output<MachineConfigResponseAlloydbV1beta> machineConfig;
  ...
  late final pulumi.Output<List<NodeResponseAlloydbV1beta>> nodes;
  late final pulumi.Output<String> project;

  /// Configuration for query insights.
  late final pulumi.Output<QueryInsightsInstanceConfigResponseAlloydbV1beta>
      queryInsightsConfig;

  /// Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
  late final pulumi.Output<ReadPoolConfigResponseAlloydbV1beta> readPoolConfig;
  ...
  late final pulumi.Output<UpdatePolicyResponseAlloydbV1beta> updatePolicy;

  /// Update time stamp
  late final pulumi.Output<String> updateTime;

  /// This is set for the read-write VM of the PRIMARY instance only.
  late final pulumi.Output<NodeResponseAlloydbV1beta> writableNode;

  InstanceAlloydbV1beta(
    String name, {
    InstanceAlloydbV1betaArgs? args,
    ...
    this.machineConfig =
        registerOutput<MachineConfigResponseAlloydbV1beta>('machineConfig');
    this.name = registerOutput<String>('name');
    this.nodes = registerOutput<List<NodeResponseAlloydbV1beta>>('nodes');
    this.project = registerOutput<String>('project');
    this.queryInsightsConfig =
        registerOutput<QueryInsightsInstanceConfigResponseAlloydbV1beta>(
            'queryInsightsConfig');
    this.readPoolConfig =
        registerOutput<ReadPoolConfigResponseAlloydbV1beta>('readPoolConfig');
    this.reconciling = registerOutput<bool>('reconciling');
    this.requestId = registerOutput<String?>('requestId');
    this.state = registerOutput<String>('state');
    this.uid = registerOutput<String>('uid');
    this.updatePolicy =
        registerOutput<UpdatePolicyResponseAlloydbV1beta>('updatePolicy');
    this.updateTime = registerOutput<String>('updateTime');
    this.writableNode =
        registerOutput<NodeResponseAlloydbV1beta>('writableNode');
  }
}
