...
class GetClusterResult3 {
  ...
  final AutomatedBackupPolicyResponse3 automatedBackupPolicy;

  /// Cluster created from backup.
  final BackupSourceResponse3 backupSource;
  ...
  final ContinuousBackupConfigResponse3 continuousBackupConfig;

  /// Continuous backup properties for this cluster.
  final ContinuousBackupInfoResponse3 continuousBackupInfo;
  ...
  final EncryptionInfoResponse3 encryptionInfo;

  /// For Resource freshness validation (https://google.aip.dev/154)
  final String etag;

  /// Input only. Initial user to setup during cluster creation. Required. If used in `RestoreCluster` this is ignored.
  final UserPasswordResponse3 initialUser;

  /// Labels as key value pairs
  final Map<String, String> labels;

  /// Cluster created via DMS migration.
  final MigrationSourceResponse3 migrationSource;
  ...
  final NetworkConfigResponse3 networkConfig;

  /// Cross Region replication config specific to PRIMARY cluster.
  final PrimaryConfigResponse3 primaryConfig;
  ...
  final SecondaryConfigResponse3 secondaryConfig;
  ...
  factory GetClusterResult3.fromMap(Map<String, dynamic> map) {
    return GetClusterResult3(
      ...
      automatedBackupPolicy: AutomatedBackupPolicyResponse3.fromMap(
          (map['automatedBackupPolicy'] as Map).cast<String, dynamic>()),
      backupSource: BackupSourceResponse3.fromMap(
          (map['backupSource'] as Map).cast<String, dynamic>()),
      clusterType: map['clusterType'] as String,
      continuousBackupConfig: ContinuousBackupConfigResponse3.fromMap(
          (map['continuousBackupConfig'] as Map).cast<String, dynamic>()),
      continuousBackupInfo: ContinuousBackupInfoResponse3.fromMap(
      ...
      encryptionInfo: EncryptionInfoResponse3.fromMap(
          (map['encryptionInfo'] as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      initialUser: UserPasswordResponse3.fromMap(
          (map['initialUser'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      migrationSource: MigrationSourceResponse3.fromMap(
          (map['migrationSource'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: map['network'] as String,
      networkConfig: NetworkConfigResponse3.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      primaryConfig: PrimaryConfigResponse3.fromMap(
          (map['primaryConfig'] as Map).cast<String, dynamic>()),
      reconciling: map['reconciling'] as bool,
      secondaryConfig: SecondaryConfigResponse3.fromMap(
