...
class AutomatedBackupPolicyAlloydbV1beta {
  ...
  final QuantityBasedRetentionAlloydbV1beta? quantityBasedRetention;

  /// Time-based Backup retention policy.
  final TimeBasedRetentionAlloydbV1beta? timeBasedRetention;

  /// Weekly schedule for the Backup.
  final WeeklyScheduleAlloydbV1beta? weeklySchedule;
