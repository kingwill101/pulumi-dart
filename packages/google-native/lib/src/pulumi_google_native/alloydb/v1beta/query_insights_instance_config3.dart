...
class QueryInsightsInstanceConfig3 {
  ...
  factory QueryInsightsInstanceConfig3.fromMap(Map<String, dynamic> map) {
    return QueryInsightsInstanceConfig3(
