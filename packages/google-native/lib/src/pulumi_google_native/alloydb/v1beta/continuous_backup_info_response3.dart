...
class ContinuousBackupInfoResponse3 {
  ...
  factory ContinuousBackupInfoResponse3.fromMap(Map<String, dynamic> map) {
    return ContinuousBackupInfoResponse3(
