...
import 'quantity_based_expiry_response3.dart';

/// Result data returned by getBackup.
class GetBackupResult3 {
  ...
  final QuantityBasedExpiryResponse3 expiryQuantity;
  ...
  factory GetBackupResult3.fromMap(Map<String, dynamic> map) {
    return GetBackupResult3(
      ...
      expiryQuantity: QuantityBasedExpiryResponse3.fromMap(
