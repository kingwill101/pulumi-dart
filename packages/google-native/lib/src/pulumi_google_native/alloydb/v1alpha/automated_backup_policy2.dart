...
import 'quantity_based_retention2.dart';
import 'time_based_retention2.dart';
import 'weekly_schedule2.dart';

/// Message describing the user-specified automated backup policy. All fields in the automated backup policy are optional. Defaults for each field are provided if they are not set.
class AutomatedBackupPolicy2 {
  ...
  final EncryptionConfig2? encryptionConfig;
  ...
  final QuantityBasedRetention2? quantityBasedRetention;

  /// Time-based Backup retention policy.
  final TimeBasedRetention2? timeBasedRetention;

  /// Weekly schedule for the Backup.
  final WeeklySchedule2? weeklySchedule;

  AutomatedBackupPolicy2({
    this.backupWindow,
    this.enabled,
  ...
  factory AutomatedBackupPolicy2.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicy2(
      backupWindow:
          map['backupWindow'] == null ? null : map['backupWindow'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      encryptionConfig: map['encryptionConfig'] == null
          ? null
          : EncryptionConfig2.fromMap(
