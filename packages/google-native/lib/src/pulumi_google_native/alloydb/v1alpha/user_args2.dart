...
class UserArgs2 {
  ...
  final Input<UserUserType2>? userType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (userTypeValue != null) {
      map['userType'] = Input.mapOptionalInputValue<UserUserType2, String>(
  ...
  factory UserArgs2.fromMap(Map<String, dynamic> map) {
    return UserArgs2(
      ...
      userType: Input.asOptionalInput<UserUserType2>(map['userType']),
    );
  }
}
