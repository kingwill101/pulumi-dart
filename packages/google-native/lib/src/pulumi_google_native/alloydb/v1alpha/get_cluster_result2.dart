...
class GetClusterResult2 {
  ...
  final AutomatedBackupPolicyResponse2 automatedBackupPolicy;

  /// Cluster created from backup.
  final BackupSourceResponse2 backupSource;
  ...
  final ContinuousBackupConfigResponse2 continuousBackupConfig;

  /// Continuous backup properties for this cluster.
  final ContinuousBackupInfoResponse2 continuousBackupInfo;
  ...
  final UserPasswordResponse2 initialUser;

  /// Labels as key value pairs
  final Map<String, String> labels;

  /// Cluster created via DMS migration.
  final MigrationSourceResponse2 migrationSource;
  ...
  final NetworkConfigResponse2 networkConfig;

  /// Cross Region replication config specific to PRIMARY cluster.
  final PrimaryConfigResponse2 primaryConfig;
  ...
  final SecondaryConfigResponse2 secondaryConfig;
  ...
  factory GetClusterResult2.fromMap(Map<String, dynamic> map) {
    return GetClusterResult2(
      ...
      automatedBackupPolicy: AutomatedBackupPolicyResponse2.fromMap(
          (map['automatedBackupPolicy'] as Map).cast<String, dynamic>()),
      backupSource: BackupSourceResponse2.fromMap(
          (map['backupSource'] as Map).cast<String, dynamic>()),
      clusterType: map['clusterType'] as String,
      continuousBackupConfig: ContinuousBackupConfigResponse2.fromMap(
          (map['continuousBackupConfig'] as Map).cast<String, dynamic>()),
      continuousBackupInfo: ContinuousBackupInfoResponse2.fromMap(
      ...
      initialUser: UserPasswordResponse2.fromMap(
          (map['initialUser'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      migrationSource: MigrationSourceResponse2.fromMap(
          (map['migrationSource'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: map['network'] as String,
      networkConfig: NetworkConfigResponse2.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      primaryConfig: PrimaryConfigResponse2.fromMap(
      ...
      secondaryConfig: SecondaryConfigResponse2.fromMap(
