...
class GetBackupResult2 {
  ...
  final QuantityBasedExpiryResponse2 expiryQuantity;
  ...
  factory GetBackupResult2.fromMap(Map<String, dynamic> map) {
    return GetBackupResult2(
      ...
      expiryQuantity: QuantityBasedExpiryResponse2.fromMap(
