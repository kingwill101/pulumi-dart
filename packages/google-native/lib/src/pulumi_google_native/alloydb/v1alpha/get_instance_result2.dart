...
class GetInstanceResult2 {
  ...
  final ClientConnectionConfigResponse2 clientConnectionConfig;
  ...
  final MachineConfigResponse2 machineConfig;
  ...
  final List<NodeResponse2> nodes;

  /// Configuration for query insights.
  final QueryInsightsInstanceConfigResponse2 queryInsightsConfig;

  /// Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
  final ReadPoolConfigResponse2 readPoolConfig;
  ...
  final NodeResponse2 writableNode;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['nodes'] = Input.encodeList<NodeResponse2, Map<String, dynamic>>(
  ...
  factory GetInstanceResult2.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult2(
      ...
      clientConnectionConfig: ClientConnectionConfigResponse2.fromMap(
      ...
      machineConfig: MachineConfigResponse2.fromMap(
          (map['machineConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      nodes: Input.decodeList<NodeResponse2>(
          map['nodes'],
          (value) =>
              NodeResponse2.fromMap((value as Map).cast<String, dynamic>())),
      queryInsightsConfig: QueryInsightsInstanceConfigResponse2.fromMap(
          (map['queryInsightsConfig'] as Map).cast<String, dynamic>()),
      readPoolConfig: ReadPoolConfigResponse2.fromMap(
      ...
      writableNode: NodeResponse2.fromMap(
