...
class QueryInsightsInstanceConfigResponse2 {
  ...
  QueryInsightsInstanceConfigResponse2({
  ...
  factory QueryInsightsInstanceConfigResponse2.fromMap(
      Map<String, dynamic> map) {
    return QueryInsightsInstanceConfigResponse2(
