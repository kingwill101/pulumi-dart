...
class ContinuousBackupConfigResponse2 {
  ...
  ContinuousBackupConfigResponse2({
  ...
  factory ContinuousBackupConfigResponse2.fromMap(Map<String, dynamic> map) {
    return ContinuousBackupConfigResponse2(
