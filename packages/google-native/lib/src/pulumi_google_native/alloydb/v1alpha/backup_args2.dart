...
class BackupArgs2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<BackupType2, String>(
  ...
  factory BackupArgs2.fromMap(Map<String, dynamic> map) {
    return BackupArgs2(
      ...
      type: Input.asOptionalInput<BackupType2>(map['type']),
    );
  }
}
