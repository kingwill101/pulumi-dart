...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      initialUser:
          pulumi.Input.asOptionalInput<UserPassword>(map['initialUser']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      network: pulumi.Input.asInput<String>(map['network']),
      networkConfig:
          pulumi.Input.asOptionalInput<NetworkConfig>(map['networkConfig']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      secondaryConfig:
          pulumi.Input.asOptionalInput<SecondaryConfig>(map['secondaryConfig']),
      sslConfig: pulumi.Input.asOptionalInput<SslConfig>(map['sslConfig']),
    );
  }
}
