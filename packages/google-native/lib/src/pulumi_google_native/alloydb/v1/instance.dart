...
class Instance extends CustomResource {
  ...
  late final Output<ClientConnectionConfigResponse> clientConnectionConfig;
  ...
  late final Output<MachineConfigResponse> machineConfig;
  ...
  late final Output<List<NodeResponse>> nodes;
  late final Output<String> project;

  /// Configuration for query insights.
  late final Output<QueryInsightsInstanceConfigResponse> queryInsightsConfig;

  /// Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
  late final Output<ReadPoolConfigResponse> readPoolConfig;
  ...
  late final Output<NodeResponse> writableNode;
  ...
  Instance(
    ...
    this.clientConnectionConfig =
        Output.createUnknown<ClientConnectionConfigResponse>();
    ...
    this.machineConfig = Output.createUnknown<MachineConfigResponse>();
    this.name = Output.createUnknown<String>();
    this.nodes = Output.createUnknown<List<NodeResponse>>();
    this.project = Output.createUnknown<String>();
    this.queryInsightsConfig =
        Output.createUnknown<QueryInsightsInstanceConfigResponse>();
    this.readPoolConfig = Output.createUnknown<ReadPoolConfigResponse>();
    this.reconciling = Output.createUnknown<bool>();
    this.requestId = Output.createUnknown<String?>();
    this.state = Output.createUnknown<String>();
    this.uid = Output.createUnknown<String>();
    this.updateTime = Output.createUnknown<String>();
    this.writableNode = Output.createUnknown<NodeResponse>();
  }
}
