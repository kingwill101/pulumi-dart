...
class Cluster extends CustomResource {
  ...
  late final Output<AutomatedBackupPolicyResponse> automatedBackupPolicy;

  /// Cluster created from backup.
  late final Output<BackupSourceResponse> backupSource;
  ...
  late final Output<ContinuousBackupConfigResponse> continuousBackupConfig;

  /// Continuous backup properties for this cluster.
  late final Output<ContinuousBackupInfoResponse> continuousBackupInfo;
  ...
  late final Output<EncryptionConfigResponse> encryptionConfig;

  /// The encryption information for the cluster.
  late final Output<EncryptionInfoResponse> encryptionInfo;

  /// For Resource freshness validation (https://google.aip.dev/154)
  late final Output<String> etag;

  /// Input only. Initial user to setup during cluster creation. Required. If used in `RestoreCluster` this is ignored.
  late final Output<UserPasswordResponse> initialUser;
  ...
  late final Output<MigrationSourceResponse> migrationSource;
  ...
  late final Output<NetworkConfigResponse> networkConfig;

  /// Cross Region replication config specific to PRIMARY cluster.
  late final Output<PrimaryConfigResponse> primaryConfig;
  ...
  late final Output<SecondaryConfigResponse> secondaryConfig;

  /// SSL configuration for this AlloyDB cluster.
  late final Output<SslConfigResponse> sslConfig;
