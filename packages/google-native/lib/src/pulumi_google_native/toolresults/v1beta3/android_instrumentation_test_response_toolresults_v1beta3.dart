...
class AndroidInstrumentationTestResponseToolresultsV1beta3 {
  ...
  AndroidInstrumentationTestResponseToolresultsV1beta3({
  ...
  factory AndroidInstrumentationTestResponseToolresultsV1beta3.fromMap(
      Map<String, dynamic> map) {
    return AndroidInstrumentationTestResponseToolresultsV1beta3(
