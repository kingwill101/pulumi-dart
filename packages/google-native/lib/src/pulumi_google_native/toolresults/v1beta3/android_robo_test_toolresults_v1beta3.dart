...
class AndroidRoboTestToolresultsV1beta3 {
  ...
  AndroidRoboTestToolresultsV1beta3({
  ...
  factory AndroidRoboTestToolresultsV1beta3.fromMap(Map<String, dynamic> map) {
    return AndroidRoboTestToolresultsV1beta3(
