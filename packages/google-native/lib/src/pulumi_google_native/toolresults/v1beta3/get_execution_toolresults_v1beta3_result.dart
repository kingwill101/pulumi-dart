...
class GetExecutionToolresultsV1beta3Result {
  ...
  GetExecutionToolresultsV1beta3Result({
  ...
  factory GetExecutionToolresultsV1beta3Result.fromMap(
      Map<String, dynamic> map) {
    return GetExecutionToolresultsV1beta3Result(
