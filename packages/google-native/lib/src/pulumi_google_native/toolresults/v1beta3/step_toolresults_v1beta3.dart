...
class StepToolresultsV1beta3 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DurationResponseToolresultsV1beta3>
      deviceUsageDuration;
  ...
  late final pulumi.Output<List<StepDimensionValueEntryResponse>>
      dimensionValue;
  ...
  late final pulumi.Output<DurationResponseToolresultsV1beta3> runDuration;
  ...
  StepToolresultsV1beta3(
    ...
    this.deviceUsageDuration =
        registerOutput<DurationResponseToolresultsV1beta3>(
            'deviceUsageDuration');
    this.dimensionValue =
    ...
    this.runDuration =
        registerOutput<DurationResponseToolresultsV1beta3>('runDuration');
