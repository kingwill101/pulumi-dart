...
class Step2 extends CustomResource {
  ...
  late final Output<DurationResponse4> deviceUsageDuration;
  ...
  late final Output<List<StepDimensionValueEntryResponse>> dimensionValue;
  ...
  late final Output<bool> hasImages;
  ...
  late final Output<List<StepLabelsEntryResponse>> labels;
  ...
  late final Output<MultiStepResponse> multiStep;
  ...
  late final Output<DurationResponse4> runDuration;
  ...
  late final Output<TestExecutionStepResponse> testExecutionStep;

  /// An execution of a tool (used for steps we don't explicitly support).
  late final Output<ToolExecutionStepResponse> toolExecutionStep;
