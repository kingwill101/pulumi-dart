...
class GetExecutionResult4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dimensionDefinitions'] = dimensionDefinitions;
    map['executionId'] = executionId;
    map['outcome'] = outcome.toMap();
    map['specification'] = specification.toMap();
    map['state'] = state;
    map['testExecutionMatrixId'] = testExecutionMatrixId;
    return map;
  }

  factory GetExecutionResult4.fromMap(Map<String, dynamic> map) {
    return GetExecutionResult4(
