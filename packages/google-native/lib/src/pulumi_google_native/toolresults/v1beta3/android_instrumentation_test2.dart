...
class AndroidInstrumentationTest2 {
  ...
  factory AndroidInstrumentationTest2.fromMap(Map<String, dynamic> map) {
    return AndroidInstrumentationTest2(
      testPackageId:
