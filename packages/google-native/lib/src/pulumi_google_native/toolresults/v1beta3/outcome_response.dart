...
class OutcomeResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['failureDetail'] = failureDetail.toMap();
    map['inconclusiveDetail'] = inconclusiveDetail.toMap();
    map['skippedDetail'] = skippedDetail.toMap();
    map['successDetail'] = successDetail.toMap();
    map['summary'] = summary;
    return map;
  }
