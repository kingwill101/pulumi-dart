...
class StepArgs {
  ...
  final Input<Duration4>? deviceUsageDuration;
  ...
  final Input<List<StepDimensionValueEntry>>? dimensionValue;
  ...
  final Input<List<StepLabelsEntry>>? labels;
  ...
  final Input<MultiStep>? multiStep;
  ...
  final Input<TestExecutionStep>? testExecutionStep;

  /// An execution of a tool (used for steps we don't explicitly support).
  final Input<ToolExecutionStep>? toolExecutionStep;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (deviceUsageDurationValue != null) {
      map['deviceUsageDuration'] =
          Input.mapOptionalInputValue<Duration4, Map<String, dynamic>>(
              deviceUsageDurationValue, (value) => value.toMap());
    }
    final dimensionValueValue = dimensionValue;
    if (dimensionValueValue != null) {
      map['dimensionValue'] = Input.mapOptionalInputValue<
              List<StepDimensionValueEntry>, List<Map<String, dynamic>>>(
          dimensionValueValue,
          (value) =>
              Input.encodeList<StepDimensionValueEntry, Map<String, dynamic>>(
    ...
    if (labelsValue != null) {
      map['labels'] = Input.mapOptionalInputValue<List<StepLabelsEntry>,
              List<Map<String, dynamic>>>(
          labelsValue,
          (value) => Input.encodeList<StepLabelsEntry, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final multiStepValue = multiStep;
    if (multiStepValue != null) {
      map['multiStep'] =
          Input.mapOptionalInputValue<MultiStep, Map<String, dynamic>>(
    ...
    if (runDurationValue != null) {
      map['runDuration'] =
          Input.mapOptionalInputValue<Duration4, Map<String, dynamic>>(
              runDurationValue, (value) => value.toMap());
    }
    final stateValue = state;
    if (stateValue != null) {
      map['state'] = Input.mapOptionalInputValue<StepState, String>(
    ...
    if (testExecutionStepValue != null) {
      map['testExecutionStep'] =
          Input.mapOptionalInputValue<TestExecutionStep, Map<String, dynamic>>(
    ...
    if (toolExecutionStepValue != null) {
      map['toolExecutionStep'] =
          Input.mapOptionalInputValue<ToolExecutionStep, Map<String, dynamic>>(
  ...
  factory StepArgs.fromMap(Map<String, dynamic> map) {
    return StepArgs(
      ...
      deviceUsageDuration:
          Input.asOptionalInput<Duration4>(map['deviceUsageDuration']),
      dimensionValue: Input.asOptionalInput<List<StepDimensionValueEntry>>(
          map['dimensionValue']),
      executionId: Input.asInput<String>(map['executionId']),
      hasImages: Input.asOptionalInput<bool>(map['hasImages']),
      historyId: Input.asInput<String>(map['historyId']),
      labels: Input.asOptionalInput<List<StepLabelsEntry>>(map['labels']),
      multiStep: Input.asOptionalInput<MultiStep>(map['multiStep']),
      name: Input.asOptionalInput<String>(map['name']),
      outcome: Input.asOptionalInput<Outcome>(map['outcome']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      runDuration: Input.asOptionalInput<Duration4>(map['runDuration']),
      state: Input.asOptionalInput<StepState>(map['state']),
      stepId: Input.asOptionalInput<String>(map['stepId']),
      testExecutionStep:
          Input.asOptionalInput<TestExecutionStep>(map['testExecutionStep']),
      toolExecutionStep:
          Input.asOptionalInput<ToolExecutionStep>(map['toolExecutionStep']),
    );
  }
}
