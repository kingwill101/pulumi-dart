...
class AuditLogConfig9 {
  ...
  factory AuditLogConfig9.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig9(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType9.fromValue(map['logType'] as String),
    );
  }
}
