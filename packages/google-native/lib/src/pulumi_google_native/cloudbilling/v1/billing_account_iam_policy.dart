...
class BillingAccountIamPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<AuditConfigResponseCloudbillingV1>>
      auditConfigs;
  ...
  late final pulumi.Output<List<BindingResponseCloudbillingV1>> bindings;
  ...
  BillingAccountIamPolicy(
    ...
    this.auditConfigs =
        registerOutput<List<AuditConfigResponseCloudbillingV1>>('auditConfigs');
    this.billingAccountId = registerOutput<String>('billingAccountId');
    this.bindings =
        registerOutput<List<BindingResponseCloudbillingV1>>('bindings');
