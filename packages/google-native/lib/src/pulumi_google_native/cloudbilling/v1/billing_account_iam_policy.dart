...
class BillingAccountIamPolicy extends CustomResource {
  /// Specifies cloud audit logging configuration for this policy.
  late final Output<List<AuditConfigResponse9>> auditConfigs;
  ...
  late final Output<List<BindingResponse15>> bindings;
