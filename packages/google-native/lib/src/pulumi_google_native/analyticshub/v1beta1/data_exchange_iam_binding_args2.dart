...
class DataExchangeIamBindingArgs2 {
  ...
  factory DataExchangeIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return DataExchangeIamBindingArgs2(
