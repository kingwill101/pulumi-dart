...
class GetListingResult2 {
  /// Shared dataset i.e. BigQuery dataset source.
  final BigQueryDatasetSourceResponse2 bigqueryDataset;

  /// Optional. Categories of the listing. Up to two categories are allowed.
  final List<String> categories;

  /// Optional. Details of the data provider who owns the source data.
  final DataProviderResponse2 dataProvider;
  ...
  final PublisherResponse2 publisher;

  /// Optional. Email or URL of the request access of the listing. Subscribers can use this reference to request access. Max Length: 1000 bytes.
  final String requestAccess;

  /// Optional. If set, restricted export configuration will be propagated and enforced on the linked dataset.
  final RestrictedExportConfigResponse2 restrictedExportConfig;
  ...
  factory GetListingResult2.fromMap(Map<String, dynamic> map) {
    return GetListingResult2(
      bigqueryDataset: BigQueryDatasetSourceResponse2.fromMap(
          (map['bigqueryDataset'] as Map).cast<String, dynamic>()),
      categories: (map['categories'] as List).cast<String>(),
      dataProvider: DataProviderResponse2.fromMap(
      ...
      publisher: PublisherResponse2.fromMap(
          (map['publisher'] as Map).cast<String, dynamic>()),
      requestAccess: map['requestAccess'] as String,
      restrictedExportConfig: RestrictedExportConfigResponse2.fromMap(
