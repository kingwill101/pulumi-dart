...
import 'big_query_dataset_source2.dart';
import 'data_provider2.dart';
import 'listing_categories_item2.dart';
import 'publisher2.dart';
import 'restricted_export_config2.dart';

/// The set of arguments for Listing.
class ListingArgs2 {
  /// Shared dataset i.e. BigQuery dataset source.
  final Input<BigQueryDatasetSource2> bigqueryDataset;

  /// Optional. Categories of the listing. Up to two categories are allowed.
  final Input<List<ListingCategoriesItem2>>? categories;
  final Input<String> dataExchangeId;

  /// Optional. Details of the data provider who owns the source data.
  final Input<DataProvider2>? dataProvider;
  ...
  final Input<Publisher2>? publisher;

  /// Optional. Email or URL of the request access of the listing. Subscribers can use this reference to request access. Max Length: 1000 bytes.
  final Input<String>? requestAccess;

  /// Optional. If set, restricted export configuration will be propagated and enforced on the linked dataset.
  final Input<RestrictedExportConfig2>? restrictedExportConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bigqueryDataset'] =
        Input.mapInputValue<BigQueryDatasetSource2, Map<String, dynamic>>(
    ...
    if (categoriesValue != null) {
      map['categories'] = Input.mapOptionalInputValue<
              List<ListingCategoriesItem2>, List<String>>(
          categoriesValue,
          (value) => Input.encodeList<ListingCategoriesItem2, String>(
    ...
    if (dataProviderValue != null) {
      map['dataProvider'] =
          Input.mapOptionalInputValue<DataProvider2, Map<String, dynamic>>(
    ...
    if (publisherValue != null) {
      map['publisher'] =
          Input.mapOptionalInputValue<Publisher2, Map<String, dynamic>>(
    ...
    if (restrictedExportConfigValue != null) {
      map['restrictedExportConfig'] = Input.mapOptionalInputValue<
              RestrictedExportConfig2, Map<String, dynamic>>(
          restrictedExportConfigValue, (value) => value.toMap());
    }
    return map;
  }

  factory ListingArgs2.fromMap(Map<String, dynamic> map) {
    return ListingArgs2(
      bigqueryDataset:
          Input.asInput<BigQueryDatasetSource2>(map['bigqueryDataset']),
      categories: Input.asOptionalInput<List<ListingCategoriesItem2>>(
          map['categories']),
      dataExchangeId: Input.asInput<String>(map['dataExchangeId']),
      dataProvider: Input.asOptionalInput<DataProvider2>(map['dataProvider']),
      ...
      publisher: Input.asOptionalInput<Publisher2>(map['publisher']),
      requestAccess: Input.asOptionalInput<String>(map['requestAccess']),
      restrictedExportConfig: Input.asOptionalInput<RestrictedExportConfig2>(
