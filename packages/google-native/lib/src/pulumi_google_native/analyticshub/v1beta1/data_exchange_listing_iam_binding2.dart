...
import 'data_exchange_listing_iam_binding_args2.dart';

/// Sets the IAM policy.
class DataExchangeListingIamBinding2 extends CustomResource {
  ...
  DataExchangeListingIamBinding2(
    String name, {
    DataExchangeListingIamBindingArgs2? args,
