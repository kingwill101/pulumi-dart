...
class DataExchangeListingIamMemberArgs2 {
  ...
  DataExchangeListingIamMemberArgs2({
    this.condition,
  ...
  factory DataExchangeListingIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return DataExchangeListingIamMemberArgs2(
