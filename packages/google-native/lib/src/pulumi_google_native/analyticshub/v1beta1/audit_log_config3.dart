...
class AuditLogConfig3 {
  ...
  factory AuditLogConfig3.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig3(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType3.fromValue(map['logType'] as String),
    );
  }
}
