...
import 'data_exchange_iam_binding_args2.dart';

/// Sets the IAM policy.
class DataExchangeIamBinding2 extends CustomResource {
  ...
  DataExchangeIamBinding2(
    String name, {
    DataExchangeIamBindingArgs2? args,
