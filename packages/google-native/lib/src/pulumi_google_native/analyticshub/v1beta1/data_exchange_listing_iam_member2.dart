...
import 'data_exchange_listing_iam_member_args2.dart';

/// Sets the IAM policy.
class DataExchangeListingIamMember2 extends CustomResource {
  ...
  DataExchangeListingIamMember2(
    String name, {
    DataExchangeListingIamMemberArgs2? args,
