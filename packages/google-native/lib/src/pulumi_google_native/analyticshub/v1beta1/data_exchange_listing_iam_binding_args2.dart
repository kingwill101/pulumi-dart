...
class DataExchangeListingIamBindingArgs2 {
  ...
  DataExchangeListingIamBindingArgs2({
    this.condition,
  ...
  factory DataExchangeListingIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return DataExchangeListingIamBindingArgs2(
