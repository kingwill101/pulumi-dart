enum ListingCategoriesItem2 {
  ...
  const ListingCategoriesItem2(this.value);
  final String value;

  static ListingCategoriesItem2 fromValue(String value) {
    for (final item in ListingCategoriesItem2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown ListingCategoriesItem2 value: $value');
  }
}
