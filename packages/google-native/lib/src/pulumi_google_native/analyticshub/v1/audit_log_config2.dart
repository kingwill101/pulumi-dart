...
class AuditLogConfig2 {
  ...
  factory AuditLogConfig2.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig2(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType2.fromValue(map['logType'] as String),
    );
  }
}
