...
class GetDatasetResult4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['inputConfigs'] = Input.encodeList<
  ...
  factory GetDatasetResult4.fromMap(Map<String, dynamic> map) {
    return GetDatasetResult4(
      ...
      inputConfigs:
          Input.decodeList<GoogleCloudDatalabelingV1beta1InputConfigResponse>(
              map['inputConfigs'],
              (value) =>
