...
class EvaluationJobArgs {
  ...
  factory EvaluationJobArgs.fromMap(Map<String, dynamic> map) {
    return EvaluationJobArgs(
      annotationSpecSet: pulumi.Input.asInput<String>(map['annotationSpecSet']),
      ...
      labelMissingGroundTruth:
          pulumi.Input.asInput<bool>(map['labelMissingGroundTruth']),
      modelVersion: pulumi.Input.asInput<String>(map['modelVersion']),
