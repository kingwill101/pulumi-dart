...
import 'oidc_token_response7.dart';

/// Configuration for a push delivery endpoint.
class PushConfigResponse3 {
  ...
  final OidcTokenResponse7 oidcToken;
  ...
  factory PushConfigResponse3.fromMap(Map<String, dynamic> map) {
    return PushConfigResponse3(
      attributes: (map['attributes'] as Map).cast<String, String>(),
      oidcToken: OidcTokenResponse7.fromMap(
