...
class GetSubscriptionResult5 {
  ...
  final PushConfigResponse3 pushConfig;
  ...
  factory GetSubscriptionResult5.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionResult5(
      ackDeadlineSeconds: map['ackDeadlineSeconds'] as int,
      name: map['name'] as String,
      pushConfig: PushConfigResponse3.fromMap(
