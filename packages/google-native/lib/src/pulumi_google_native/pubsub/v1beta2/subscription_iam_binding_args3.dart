...
class SubscriptionIamBindingArgs3 {
  ...
  factory SubscriptionIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return SubscriptionIamBindingArgs3(
