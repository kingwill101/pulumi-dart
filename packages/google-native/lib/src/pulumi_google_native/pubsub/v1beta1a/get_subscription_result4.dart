...
class GetSubscriptionResult4 {
  ...
  final PushConfigResponse2 pushConfig;

  /// The name of the topic from which this subscription is receiving messages.
  final String topic;

  GetSubscriptionResult4({
  ...
  factory GetSubscriptionResult4.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionResult4(
      ackDeadlineSeconds: map['ackDeadlineSeconds'] as int,
      name: map['name'] as String,
      pushConfig: PushConfigResponse2.fromMap(
