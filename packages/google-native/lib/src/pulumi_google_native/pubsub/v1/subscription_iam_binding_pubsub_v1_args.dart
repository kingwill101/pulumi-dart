...
class SubscriptionIamBindingPubsubV1Args {
  ...
  SubscriptionIamBindingPubsubV1Args({
    this.condition,
  ...
  factory SubscriptionIamBindingPubsubV1Args.fromMap(Map<String, dynamic> map) {
    return SubscriptionIamBindingPubsubV1Args(
