...
class SchemaSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (encodingValue != null) {
      map['encoding'] = encodingValue.value;
    }
    final firstRevisionIdValue = firstRevisionId;
    if (firstRevisionIdValue != null) {
      map['firstRevisionId'] = firstRevisionIdValue;
    }
    final lastRevisionIdValue = lastRevisionId;
    if (lastRevisionIdValue != null) {
      map['lastRevisionId'] = lastRevisionIdValue;
    }
    map['schema'] = schema;
    return map;
  }
