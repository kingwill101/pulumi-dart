...
import 'snapshot_iam_member_pubsub_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class SnapshotIamMemberPubsubV1 extends pulumi.CustomResource {
  ...
  SnapshotIamMemberPubsubV1(
    String name, {
    SnapshotIamMemberPubsubV1Args? args,
