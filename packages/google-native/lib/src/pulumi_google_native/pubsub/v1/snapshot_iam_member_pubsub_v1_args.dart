...
class SnapshotIamMemberPubsubV1Args {
  ...
  factory SnapshotIamMemberPubsubV1Args.fromMap(Map<String, dynamic> map) {
    return SnapshotIamMemberPubsubV1Args(
