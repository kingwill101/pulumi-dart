...
class SubscriptionIamBindingArgs2 {
  ...
  factory SubscriptionIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return SubscriptionIamBindingArgs2(
