...
class SubscriptionIamMemberPubsubV1Args {
  ...
  SubscriptionIamMemberPubsubV1Args({
    this.condition,
  ...
  factory SubscriptionIamMemberPubsubV1Args.fromMap(Map<String, dynamic> map) {
    return SubscriptionIamMemberPubsubV1Args(
