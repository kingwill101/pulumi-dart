...
class TopicArgs {
  ...
  final Input<MessageStoragePolicy>? messageStoragePolicy;
  ...
  final Input<SchemaSettings>? schemaSettings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (schemaSettingsValue != null) {
      map['schemaSettings'] =
          Input.mapOptionalInputValue<SchemaSettings, Map<String, dynamic>>(
              schemaSettingsValue, (value) => value.toMap());
    }
    map['topicId'] = topicId;
    return map;
  }
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ...
      messageStoragePolicy: Input.asOptionalInput<MessageStoragePolicy>(
          map['messageStoragePolicy']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      satisfiesPzs: Input.asOptionalInput<bool>(map['satisfiesPzs']),
      schemaSettings:
          Input.asOptionalInput<SchemaSettings>(map['schemaSettings']),
