...
class SnapshotIamBindingPubsubV1Args {
  ...
  SnapshotIamBindingPubsubV1Args({
    this.condition,
  ...
  factory SnapshotIamBindingPubsubV1Args.fromMap(Map<String, dynamic> map) {
    return SnapshotIamBindingPubsubV1Args(
