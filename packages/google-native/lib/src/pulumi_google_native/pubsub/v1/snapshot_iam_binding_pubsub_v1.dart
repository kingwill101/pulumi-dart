...
import 'snapshot_iam_binding_pubsub_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class SnapshotIamBindingPubsubV1 extends pulumi.CustomResource {
  ...
  SnapshotIamBindingPubsubV1(
    String name, {
    SnapshotIamBindingPubsubV1Args? args,
