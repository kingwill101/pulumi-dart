...
class GetSubscriptionPubsubV1Result {
  ...
  factory GetSubscriptionPubsubV1Result.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionPubsubV1Result(
