...
import 'dynamic_group_metadata_response2.dart';
...
class GetGroupResult2 {
  ...
  final List<EntityKeyResponse2> additionalGroupKeys;
  ...
  final DynamicGroupMetadataResponse2 dynamicGroupMetadata;

  /// The `EntityKey` of the `Group`.
  final EntityKeyResponse2 groupKey;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['additionalGroupKeys'] =
        Input.encodeList<EntityKeyResponse2, Map<String, dynamic>>(
    ...
    map['parent'] = parent;
    map['posixGroups'] =
        Input.encodeList<PosixGroupResponse, Map<String, dynamic>>(
  ...
  factory GetGroupResult2.fromMap(Map<String, dynamic> map) {
    return GetGroupResult2(
      additionalGroupKeys: Input.decodeList<EntityKeyResponse2>(
          map['additionalGroupKeys'],
          (value) => EntityKeyResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      dynamicGroupMetadata: DynamicGroupMetadataResponse2.fromMap(
          (map['dynamicGroupMetadata'] as Map).cast<String, dynamic>()),
      groupKey: EntityKeyResponse2.fromMap(
          (map['groupKey'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      parent: map['parent'] as String,
      posixGroups: Input.decodeList<PosixGroupResponse>(
          map['posixGroups'],
