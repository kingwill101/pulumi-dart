...
class GetDeviceResult {
  ...
  final GoogleAppsCloudidentityDevicesV1AndroidAttributesResponse
  ...
  factory GetDeviceResult.fromMap(Map<String, dynamic> map) {
    return GetDeviceResult(
      androidSpecificAttributes:
          GoogleAppsCloudidentityDevicesV1AndroidAttributesResponse.fromMap(
              (map['androidSpecificAttributes'] as Map)
                  .cast<String, dynamic>()),
