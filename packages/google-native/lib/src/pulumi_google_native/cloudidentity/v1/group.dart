...
class Group extends CustomResource {
  ...
  late final Output<List<EntityKeyResponse>> additionalGroupKeys;
  ...
  late final Output<DynamicGroupMetadataResponse> dynamicGroupMetadata;

  /// The `EntityKey` of the `Group`.
  late final Output<EntityKeyResponse> groupKey;

  /// Optional. The initial configuration option for the `Group`.
  late final Output<String?> initialGroupConfig;
