...
import 'status_response_transcoder_v1.dart';

/// Result data returned by getJob.
class GetJobTranscoderV1Result {
  ...
  final StatusResponseTranscoderV1 error;
  ...
  factory GetJobTranscoderV1Result.fromMap(Map<String, dynamic> map) {
    return GetJobTranscoderV1Result(
      batchModePriority: map['batchModePriority'] as int,
      config: JobConfigResponse.fromMap(
          (map['config'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      endTime: map['endTime'] as String,
      error: StatusResponseTranscoderV1.fromMap(
