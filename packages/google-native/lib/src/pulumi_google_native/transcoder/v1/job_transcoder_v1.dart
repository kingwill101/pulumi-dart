...
import 'job_transcoder_v1_args.dart';
import 'status_response_transcoder_v1.dart';

/// Creates a job in the specified region.
class JobTranscoderV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<StatusResponseTranscoderV1> error;
  ...
  JobTranscoderV1(
    ...
    this.error = registerOutput<StatusResponseTranscoderV1>('error');
