...
class H265CodecSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final allowOpenGopValue = allowOpenGop;
    if (allowOpenGopValue != null) {
      map['allowOpenGop'] = allowOpenGopValue;
    }
    final aqStrengthValue = aqStrength;
    if (aqStrengthValue != null) {
      map['aqStrength'] = aqStrengthValue;
    }
    final bFrameCountValue = bFrameCount;
    if (bFrameCountValue != null) {
      map['bFrameCount'] = bFrameCountValue;
    }
    final bPyramidValue = bPyramid;
    if (bPyramidValue != null) {
      map['bPyramid'] = bPyramidValue;
    }
    ...
    final enableTwoPassValue = enableTwoPass;
    if (enableTwoPassValue != null) {
      map['enableTwoPass'] = enableTwoPassValue;
    }
    ...
    final gopFrameCountValue = gopFrameCount;
    if (gopFrameCountValue != null) {
      map['gopFrameCount'] = gopFrameCountValue;
    }
  ...
  factory H265CodecSettings.fromMap(Map<String, dynamic> map) {
    return H265CodecSettings(
      allowOpenGop:
          map['allowOpenGop'] == null ? null : map['allowOpenGop'] as bool,
      aqStrength:
          map['aqStrength'] == null ? null : map['aqStrength'] as double,
      bFrameCount:
          map['bFrameCount'] == null ? null : map['bFrameCount'] as int,
      ...
      enableTwoPass:
          map['enableTwoPass'] == null ? null : map['enableTwoPass'] as bool,
      frameRate: map['frameRate'] as double,
      gopDuration:
          map['gopDuration'] == null ? null : map['gopDuration'] as String,
      gopFrameCount:
          map['gopFrameCount'] == null ? null : map['gopFrameCount'] as int,
      heightPixels:
