...
/// Overlaid image.
class ImageResponseTranscoderV1 {
  ...
  factory ImageResponseTranscoderV1.fromMap(Map<String, dynamic> map) {
    return ImageResponseTranscoderV1(
