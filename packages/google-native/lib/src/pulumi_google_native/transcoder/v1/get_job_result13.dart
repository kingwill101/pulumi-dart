...
class GetJobResult13 {
  ...
  factory GetJobResult13.fromMap(Map<String, dynamic> map) {
    return GetJobResult13(
      batchModePriority: map['batchModePriority'] as int,
      config: JobConfigResponse.fromMap(
          (map['config'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      endTime: map['endTime'] as String,
      error: StatusResponse28.fromMap(
