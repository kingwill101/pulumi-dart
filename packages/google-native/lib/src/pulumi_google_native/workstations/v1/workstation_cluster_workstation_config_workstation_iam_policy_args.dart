...
import 'audit_config70.dart';
import 'binding102.dart';
...
class WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<List<AuditConfig70>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => Input.encodeList<AuditConfig70, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding102>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding102, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs.fromMap(
    ...
    return WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs(
      auditConfigs:
          Input.asOptionalInput<List<AuditConfig70>>(map['auditConfigs']),
      bindings: Input.asOptionalInput<List<Binding102>>(map['bindings']),
