...
import 'container_workstations_v1.dart';
import 'customer_encryption_key_workstations_v1.dart';
import 'host.dart';
import 'persistent_directory.dart';
import 'readiness_check_workstations_v1.dart';
...
class WorkstationConfigArgs {
  ...
  final pulumi.Input<ContainerWorkstationsV1>? container;
  ...
  final pulumi.Input<CustomerEncryptionKeyWorkstationsV1>? encryptionKey;
  ...
  final pulumi.Input<List<ReadinessCheckWorkstationsV1>>? readinessChecks;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (encryptionKeyValue != null) {
      map['encryptionKey'] = pulumi.Input.mapOptionalInputValue<
          CustomerEncryptionKeyWorkstationsV1,
    ...
    if (readinessChecksValue != null) {
      map['readinessChecks'] = pulumi.Input.mapOptionalInputValue<
              List<ReadinessCheckWorkstationsV1>, List<Map<String, dynamic>>>(
          readinessChecksValue,
          (value) => pulumi.Input.encodeList<ReadinessCheckWorkstationsV1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory WorkstationConfigArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigArgs(
      ...
      container: pulumi.Input.asOptionalInput<ContainerWorkstationsV1>(
          map['container']),
      displayName: pulumi.Input.asOptionalInput<String>(map['displayName']),
      encryptionKey:
          pulumi.Input.asOptionalInput<CustomerEncryptionKeyWorkstationsV1>(
              map['encryptionKey']),
      etag: pulumi.Input.asOptionalInput<String>(map['etag']),
      host: pulumi.Input.asOptionalInput<Host>(map['host']),
      ...
      readinessChecks:
          pulumi.Input.asOptionalInput<List<ReadinessCheckWorkstationsV1>>(
              map['readinessChecks']),
      replicaZones:
