...
class CustomerEncryptionKeyResponse5 {
  ...
  CustomerEncryptionKeyResponse5({
  ...
  factory CustomerEncryptionKeyResponse5.fromMap(Map<String, dynamic> map) {
    return CustomerEncryptionKeyResponse5(
