...
class WorkstationConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ContainerResponseWorkstationsV1> container;
  ...
  late final pulumi.Output<CustomerEncryptionKeyResponseWorkstationsV1>
      encryptionKey;
  ...
  late final pulumi.Output<List<PersistentDirectoryResponse>>
      persistentDirectories;
  late final pulumi.Output<String> project;

  /// Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes.
  late final pulumi.Output<List<ReadinessCheckResponseWorkstationsV1>>
      readinessChecks;
  ...
  WorkstationConfig(
    ...
    this.container =
        registerOutput<ContainerResponseWorkstationsV1>('container');
    this.createTime = registerOutput<String>('createTime');
    this.degraded = registerOutput<bool>('degraded');
    this.deleteTime = registerOutput<String>('deleteTime');
    this.displayName = registerOutput<String>('displayName');
    this.encryptionKey =
        registerOutput<CustomerEncryptionKeyResponseWorkstationsV1>(
            'encryptionKey');
    ...
    this.readinessChecks =
        registerOutput<List<ReadinessCheckResponseWorkstationsV1>>(
            'readinessChecks');
