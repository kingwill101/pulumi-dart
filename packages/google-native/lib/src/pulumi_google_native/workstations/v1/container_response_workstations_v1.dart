...
/// A Docker container.
class ContainerResponseWorkstationsV1 {
  ...
  ContainerResponseWorkstationsV1({
    required this.args,
  ...
  factory ContainerResponseWorkstationsV1.fromMap(Map<String, dynamic> map) {
    return ContainerResponseWorkstationsV1(
