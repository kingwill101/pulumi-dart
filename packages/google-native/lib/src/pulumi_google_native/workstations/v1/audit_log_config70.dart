...
class AuditLogConfig70 {
  ...
  factory AuditLogConfig70.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig70(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType70.fromValue(map['logType'] as String),
    );
  }
}
