...
class PrivateClusterConfigResponseWorkstationsV1 {
  ...
  PrivateClusterConfigResponseWorkstationsV1({
  ...
  factory PrivateClusterConfigResponseWorkstationsV1.fromMap(
      Map<String, dynamic> map) {
    return PrivateClusterConfigResponseWorkstationsV1(
