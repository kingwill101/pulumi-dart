...
class WorkstationClusterWorkstationConfigWorkstationIamBindingArgs2 {
  ...
  WorkstationClusterWorkstationConfigWorkstationIamBindingArgs2({
    this.condition,
  ...
  factory WorkstationClusterWorkstationConfigWorkstationIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return WorkstationClusterWorkstationConfigWorkstationIamBindingArgs2(
