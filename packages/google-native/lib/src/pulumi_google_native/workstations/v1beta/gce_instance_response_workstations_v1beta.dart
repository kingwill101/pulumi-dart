...
import 'accelerator_response_workstations_v1beta.dart';
...
class GceInstanceResponseWorkstationsV1beta {
  ...
  final List<AcceleratorResponseWorkstationsV1beta> accelerators;
  ...
  final GceConfidentialInstanceConfigResponseWorkstationsV1beta
  ...
  final GceShieldedInstanceConfigResponseWorkstationsV1beta
  ...
  factory GceInstanceResponseWorkstationsV1beta.fromMap(
      Map<String, dynamic> map) {
    return GceInstanceResponseWorkstationsV1beta(
      accelerators:
          pulumi.Input.decodeList<AcceleratorResponseWorkstationsV1beta>(
              map['accelerators'],
              (value) => AcceleratorResponseWorkstationsV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bootDiskSizeGb: map['bootDiskSizeGb'] as int,
      confidentialInstanceConfig:
          GceConfidentialInstanceConfigResponseWorkstationsV1beta.fromMap(
      ...
      shieldedInstanceConfig:
          GceShieldedInstanceConfigResponseWorkstationsV1beta.fromMap(
