...
class PrivateClusterConfigResponse6 {
  ...
  factory PrivateClusterConfigResponse6.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfigResponse6(
