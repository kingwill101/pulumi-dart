...
class GceRegionalPersistentDiskResponse2 {
  ...
  GceRegionalPersistentDiskResponse2({
  ...
  factory GceRegionalPersistentDiskResponse2.fromMap(Map<String, dynamic> map) {
    return GceRegionalPersistentDiskResponse2(
