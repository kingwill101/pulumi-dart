...
class GceInstance2 {
  ...
  final List<Accelerator2>? accelerators;
  ...
  final GceConfidentialInstanceConfig2? confidentialInstanceConfig;
  ...
  final GceShieldedInstanceConfig2? shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (acceleratorsValue != null) {
      map['accelerators'] =
          Input.encodeList<Accelerator2, Map<String, dynamic>>(
  ...
  factory GceInstance2.fromMap(Map<String, dynamic> map) {
    return GceInstance2(
      accelerators: map['accelerators'] == null
          ? null
          : Input.decodeList<Accelerator2>(
              map['accelerators'],
              (value) =>
                  Accelerator2.fromMap((value as Map).cast<String, dynamic>())),
      bootDiskSizeGb:
          map['bootDiskSizeGb'] == null ? null : map['bootDiskSizeGb'] as int,
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null
          ? null
          : GceConfidentialInstanceConfig2.fromMap(
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null
          ? null
          : GceShieldedInstanceConfig2.fromMap(
