...
class CustomerEncryptionKeyResponse6 {
  ...
  CustomerEncryptionKeyResponse6({
  ...
  factory CustomerEncryptionKeyResponse6.fromMap(Map<String, dynamic> map) {
    return CustomerEncryptionKeyResponse6(
