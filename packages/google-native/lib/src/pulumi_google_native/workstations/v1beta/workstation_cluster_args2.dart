...
import 'private_cluster_config6.dart';

/// The set of arguments for WorkstationCluster.
class WorkstationClusterArgs2 {
  ...
  final Input<DomainConfig>? domainConfig;
  ...
  final Input<PrivateClusterConfig6>? privateClusterConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (domainConfigValue != null) {
      map['domainConfig'] =
          Input.mapOptionalInputValue<DomainConfig, Map<String, dynamic>>(
              domainConfigValue, (value) => value.toMap());
    }
    ...
    if (privateClusterConfigValue != null) {
      map['privateClusterConfig'] = Input.mapOptionalInputValue<
              PrivateClusterConfig6, Map<String, dynamic>>(
  ...
  factory WorkstationClusterArgs2.fromMap(Map<String, dynamic> map) {
    return WorkstationClusterArgs2(
      annotations:
          Input.asOptionalInput<Map<String, String>>(map['annotations']),
      displayName: Input.asOptionalInput<String>(map['displayName']),
      domainConfig: Input.asOptionalInput<DomainConfig>(map['domainConfig']),
      etag: Input.asOptionalInput<String>(map['etag']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      name: Input.asOptionalInput<String>(map['name']),
      network: Input.asOptionalInput<String>(map['network']),
      privateClusterConfig: Input.asOptionalInput<PrivateClusterConfig6>(
