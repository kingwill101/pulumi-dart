...
class WorkstationClusterWorkstationConfigIamMemberArgs2 {
  ...
  WorkstationClusterWorkstationConfigIamMemberArgs2({
    this.condition,
  ...
  factory WorkstationClusterWorkstationConfigIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return WorkstationClusterWorkstationConfigIamMemberArgs2(
