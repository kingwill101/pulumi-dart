...
import 'customer_encryption_key6.dart';
import 'ephemeral_directory.dart';
import 'host2.dart';
import 'persistent_directory2.dart';
import 'readiness_check4.dart';

/// The set of arguments for WorkstationConfig.
class WorkstationConfigArgs2 {
  /// Optional. Client-specified annotations.
  final Input<Map<String, String>>? annotations;

  /// Optional. Container that runs upon startup for each workstation using this workstation configuration.
  final Input<Container4>? container;
  ...
  final Input<CustomerEncryptionKey6>? encryptionKey;

  /// Optional. Ephemeral directories which won't persist across workstation sessions.
  final Input<List<EphemeralDirectory>>? ephemeralDirectories;

  /// Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding.
  final Input<String>? etag;

  /// Optional. Runtime host for the workstation.
  final Input<Host2>? host;
  ...
  final Input<List<PersistentDirectory2>>? persistentDirectories;
  final Input<String>? project;

  /// Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes.
  final Input<List<ReadinessCheck4>>? readinessChecks;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (containerValue != null) {
      map['container'] =
          Input.mapOptionalInputValue<Container4, Map<String, dynamic>>(
    ...
    if (encryptionKeyValue != null) {
      map['encryptionKey'] = Input.mapOptionalInputValue<CustomerEncryptionKey6,
    ...
    if (ephemeralDirectoriesValue != null) {
      map['ephemeralDirectories'] = Input.mapOptionalInputValue<
          ...
          (value) => Input.encodeList<EphemeralDirectory, Map<String, dynamic>>(
    ...
    if (hostValue != null) {
      map['host'] = Input.mapOptionalInputValue<Host2, Map<String, dynamic>>(
    ...
    if (persistentDirectoriesValue != null) {
      map['persistentDirectories'] = Input.mapOptionalInputValue<
              List<PersistentDirectory2>, List<Map<String, dynamic>>>(
          persistentDirectoriesValue,
          (value) =>
              Input.encodeList<PersistentDirectory2, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    ...
    if (readinessChecksValue != null) {
      map['readinessChecks'] = Input.mapOptionalInputValue<
              List<ReadinessCheck4>, List<Map<String, dynamic>>>(
          readinessChecksValue,
          (value) => Input.encodeList<ReadinessCheck4, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory WorkstationConfigArgs2.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigArgs2(
      annotations:
          Input.asOptionalInput<Map<String, String>>(map['annotations']),
      container: Input.asOptionalInput<Container4>(map['container']),
      ...
      encryptionKey:
          Input.asOptionalInput<CustomerEncryptionKey6>(map['encryptionKey']),
      ephemeralDirectories: Input.asOptionalInput<List<EphemeralDirectory>>(
          map['ephemeralDirectories']),
      etag: Input.asOptionalInput<String>(map['etag']),
      host: Input.asOptionalInput<Host2>(map['host']),
      idleTimeout: Input.asOptionalInput<String>(map['idleTimeout']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      name: Input.asOptionalInput<String>(map['name']),
      persistentDirectories: Input.asOptionalInput<List<PersistentDirectory2>>(
          map['persistentDirectories']),
      project: Input.asOptionalInput<String>(map['project']),
      readinessChecks:
          Input.asOptionalInput<List<ReadinessCheck4>>(map['readinessChecks']),
