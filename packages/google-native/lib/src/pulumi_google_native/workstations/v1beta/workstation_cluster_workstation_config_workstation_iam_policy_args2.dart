...
class WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs2 {
  ...
  WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs2({
    this.auditConfigs,
    this.bindings,
    this.etag,
    this.location,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<List<AuditConfig71>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => Input.encodeList<AuditConfig71, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding103>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding103, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs2.fromMap(
      Map<String, dynamic> map) {
    return WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs2(
      auditConfigs:
          Input.asOptionalInput<List<AuditConfig71>>(map['auditConfigs']),
      bindings: Input.asOptionalInput<List<Binding103>>(map['bindings']),
