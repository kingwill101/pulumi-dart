...
class AuditLogConfig71 {
  ...
  factory AuditLogConfig71.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig71(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType71.fromValue(map['logType'] as String),
    );
  }
}
