...
import 'accelerator_response4.dart';
import 'gce_confidential_instance_config_response2.dart';
import 'gce_shielded_instance_config_response2.dart';

/// A runtime using a Compute Engine instance.
class GceInstanceResponse2 {
  /// Optional. A list of the type and count of accelerator cards attached to the instance.
  final List<AcceleratorResponse4> accelerators;
  ...
  final GceConfidentialInstanceConfigResponse2 confidentialInstanceConfig;
  ...
  final GceShieldedInstanceConfigResponse2 shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['accelerators'] =
        Input.encodeList<AcceleratorResponse4, Map<String, dynamic>>(
    ...
    map['disablePublicIpAddresses'] = disablePublicIpAddresses;
    map['enableNestedVirtualization'] = enableNestedVirtualization;
    map['machineType'] = machineType;
    map['poolSize'] = poolSize;
    map['pooledInstances'] = pooledInstances;
  ...
  factory GceInstanceResponse2.fromMap(Map<String, dynamic> map) {
    return GceInstanceResponse2(
      accelerators: Input.decodeList<AcceleratorResponse4>(
          map['accelerators'],
          (value) => AcceleratorResponse4.fromMap(
              (value as Map).cast<String, dynamic>())),
      bootDiskSizeGb: map['bootDiskSizeGb'] as int,
      confidentialInstanceConfig:
          GceConfidentialInstanceConfigResponse2.fromMap(
      ...
      shieldedInstanceConfig: GceShieldedInstanceConfigResponse2.fromMap(
