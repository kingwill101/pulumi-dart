...
class GetWorkstationConfigWorkstationsV1betaResult {
  ...
  final List<PersistentDirectoryResponseWorkstationsV1beta>
  ...
  GetWorkstationConfigWorkstationsV1betaResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['ephemeralDirectories'] = pulumi.Input.encodeList<
        EphemeralDirectoryResponse,
        Map<String, dynamic>>(ephemeralDirectories, (value) => value.toMap());
    map['etag'] = etag;
    map['host'] = host.toMap();
  ...
  factory GetWorkstationConfigWorkstationsV1betaResult.fromMap(
    ...
    return GetWorkstationConfigWorkstationsV1betaResult(
      ...
      container: ContainerResponseWorkstationsV1beta.fromMap(
      ...
      encryptionKey: CustomerEncryptionKeyResponseWorkstationsV1beta.fromMap(
          (map['encryptionKey'] as Map).cast<String, dynamic>()),
      ephemeralDirectories: pulumi.Input.decodeList<EphemeralDirectoryResponse>(
          map['ephemeralDirectories'],
          (value) => EphemeralDirectoryResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      etag: map['etag'] as String,
      host: HostResponseWorkstationsV1beta.fromMap(
          (map['host'] as Map).cast<String, dynamic>()),
      idleTimeout: map['idleTimeout'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      persistentDirectories: pulumi.Input.decodeList<
              PersistentDirectoryResponseWorkstationsV1beta>(
          map['persistentDirectories'],
          (value) => PersistentDirectoryResponseWorkstationsV1beta.fromMap(
              (value as Map).cast<String, dynamic>())),
      readinessChecks:
          pulumi.Input.decodeList<ReadinessCheckResponseWorkstationsV1beta>(
              map['readinessChecks'],
              (value) => ReadinessCheckResponseWorkstationsV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
