...
class AuditLogConfig44 {
  ...
  factory AuditLogConfig44.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig44(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType44.fromValue(map['logType'] as String),
    );
  }
}
