...
import 'authority5.dart';
import 'membership_endpoint4.dart';
import 'membership_infrastructure_type2.dart';
import 'monitoring_config6.dart';

/// The set of arguments for Membership.
class MembershipArgs6 {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final Input<Authority5>? authority;

  /// Optional. Description of this membership, limited to 63 characters. Must match the regex: `a-zA-Z0-9*`
  final Input<String>? description;

  /// Optional. Endpoint information to reach this member.
  final Input<MembershipEndpoint4>? endpoint;
  ...
  final Input<MembershipInfrastructureType2>? infrastructureType;
  ...
  final Input<MonitoringConfig6>? monitoringConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (authorityValue != null) {
      map['authority'] =
          Input.mapOptionalInputValue<Authority5, Map<String, dynamic>>(
    ...
    if (endpointValue != null) {
      map['endpoint'] = Input.mapOptionalInputValue<MembershipEndpoint4,
    ...
    if (infrastructureTypeValue != null) {
      map['infrastructureType'] =
          Input.mapOptionalInputValue<MembershipInfrastructureType2, String>(
    ...
    if (monitoringConfigValue != null) {
      map['monitoringConfig'] =
          Input.mapOptionalInputValue<MonitoringConfig6, Map<String, dynamic>>(
  ...
  factory MembershipArgs6.fromMap(Map<String, dynamic> map) {
    return MembershipArgs6(
      authority: Input.asOptionalInput<Authority5>(map['authority']),
      description: Input.asOptionalInput<String>(map['description']),
      endpoint: Input.asOptionalInput<MembershipEndpoint4>(map['endpoint']),
      externalId: Input.asOptionalInput<String>(map['externalId']),
      infrastructureType: Input.asOptionalInput<MembershipInfrastructureType2>(
          map['infrastructureType']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      membershipId: Input.asInput<String>(map['membershipId']),
      monitoringConfig:
          Input.asOptionalInput<MonitoringConfig6>(map['monitoringConfig']),
