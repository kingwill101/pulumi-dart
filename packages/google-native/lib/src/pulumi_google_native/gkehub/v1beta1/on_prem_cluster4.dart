...
import 'on_prem_cluster_cluster_type4.dart';

/// OnPremCluster contains information specific to GKE On-Prem clusters.
class OnPremCluster4 {
  /// Immutable. Whether the cluster is an admin cluster.
  final bool? adminCluster;

  /// Immutable. The on prem cluster's type.
  final OnPremClusterClusterType4? clusterType;
  ...
  factory OnPremCluster4.fromMap(Map<String, dynamic> map) {
    return OnPremCluster4(
      adminCluster:
          map['adminCluster'] == null ? null : map['adminCluster'] as bool,
      clusterType: map['clusterType'] == null
          ? null
          : OnPremClusterClusterType4.fromValue(map['clusterType'] as String),
      resourceLink:
