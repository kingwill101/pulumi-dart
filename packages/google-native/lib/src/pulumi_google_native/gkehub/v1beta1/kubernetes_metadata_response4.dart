...
class KubernetesMetadataResponse4 {
  ...
  factory KubernetesMetadataResponse4.fromMap(Map<String, dynamic> map) {
    return KubernetesMetadataResponse4(
