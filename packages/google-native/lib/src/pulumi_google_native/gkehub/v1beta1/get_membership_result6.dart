...
class GetMembershipResult6 {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final AuthorityResponse5 authority;
  ...
  final MembershipEndpointResponse4 endpoint;
  ...
  final MonitoringConfigResponse6 monitoringConfig;
  ...
  final MembershipStateResponse4 state;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['infrastructureType'] = infrastructureType;
    map['labels'] = labels;
  ...
  factory GetMembershipResult6.fromMap(Map<String, dynamic> map) {
    return GetMembershipResult6(
      authority: AuthorityResponse5.fromMap(
          (map['authority'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponse4.fromMap(
          (map['endpoint'] as Map).cast<String, dynamic>()),
      externalId: map['externalId'] as String,
      infrastructureType: map['infrastructureType'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      lastConnectionTime: map['lastConnectionTime'] as String,
      monitoringConfig: MonitoringConfigResponse6.fromMap(
          (map['monitoringConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      state: MembershipStateResponse4.fromMap(
