...
class GetBindingResult2 {
  ...
  final MembershipBindingLifecycleStateResponse2 state;
  ...
  factory GetBindingResult2.fromMap(Map<String, dynamic> map) {
    return GetBindingResult2(
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      scope: map['scope'] as String,
      state: MembershipBindingLifecycleStateResponse2.fromMap(
