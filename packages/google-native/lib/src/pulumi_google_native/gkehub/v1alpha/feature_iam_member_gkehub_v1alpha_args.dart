...
class FeatureIamMemberGkehubV1alphaArgs {
  ...
  FeatureIamMemberGkehubV1alphaArgs({
    this.condition,
  ...
  factory FeatureIamMemberGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureIamMemberGkehubV1alphaArgs(
