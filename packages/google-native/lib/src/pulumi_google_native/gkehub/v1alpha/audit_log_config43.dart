...
class AuditLogConfig43 {
  ...
  factory AuditLogConfig43.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig43(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType43.fromValue(map['logType'] as String),
    );
  }
}
