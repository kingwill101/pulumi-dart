...
import 'config_management_policy_controller_monitoring_response2.dart';

/// Configuration for Policy Controller
class ConfigManagementPolicyControllerResponse2 {
  ...
  final ConfigManagementPolicyControllerMonitoringResponse2 monitoring;
  ...
  ConfigManagementPolicyControllerResponse2({
  ...
  factory ConfigManagementPolicyControllerResponse2.fromMap(
      Map<String, dynamic> map) {
    return ConfigManagementPolicyControllerResponse2(
      ...
      monitoring: ConfigManagementPolicyControllerMonitoringResponse2.fromMap(
