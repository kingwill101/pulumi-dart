...
import 'cluster_upgrade_gkeupgrade_override_response2.dart';
import 'cluster_upgrade_post_conditions_response2.dart';

/// **ClusterUpgrade**: The configuration for the fleet-level ClusterUpgrade feature.
class ClusterUpgradeFleetSpecResponse2 {
  /// Allow users to override some properties of each GKE upgrade.
  final List<ClusterUpgradeGKEUpgradeOverrideResponse2> gkeUpgradeOverrides;
  ...
  ClusterUpgradeFleetSpecResponse2({
  ...
  factory ClusterUpgradeFleetSpecResponse2.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpecResponse2(
      gkeUpgradeOverrides:
          Input.decodeList<ClusterUpgradeGKEUpgradeOverrideResponse2>(
              map['gkeUpgradeOverrides'],
              (value) => ClusterUpgradeGKEUpgradeOverrideResponse2.fromMap(
