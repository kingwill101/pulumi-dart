...
class MembershipIamMemberGkehubV1alphaArgs {
  ...
  MembershipIamMemberGkehubV1alphaArgs({
    this.condition,
  ...
  factory MembershipIamMemberGkehubV1alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return MembershipIamMemberGkehubV1alphaArgs(
