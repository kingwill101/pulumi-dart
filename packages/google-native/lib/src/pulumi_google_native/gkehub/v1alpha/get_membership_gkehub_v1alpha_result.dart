...
class GetMembershipGkehubV1alphaResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['labels'] = labels;
    map['lastConnectionTime'] = lastConnectionTime;
