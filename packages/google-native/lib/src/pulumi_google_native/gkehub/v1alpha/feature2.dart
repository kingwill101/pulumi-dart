...
class Feature2 extends CustomResource {
  ...
  Feature2(
    ...
    this.fleetDefaultMemberConfig =
        Output.createUnknown<CommonFleetDefaultMemberConfigSpecResponse2>();
    ...
    this.resourceState = Output.createUnknown<FeatureResourceStateResponse2>();
    this.scopeSpecs = Output.createUnknown<Map<String, String>>();
    this.scopeStates = Output.createUnknown<Map<String, String>>();
    this.spec = Output.createUnknown<CommonFeatureSpecResponse2>();
    this.state = Output.createUnknown<CommonFeatureStateResponse2>();
