...
import 'common_feature_spec2.dart';
import 'common_fleet_default_member_config_spec2.dart';
...
class FeatureArgs2 {
  ...
  final Input<CommonFleetDefaultMemberConfigSpec2>? fleetDefaultMemberConfig;
  ...
  final Input<CommonFeatureSpec2>? spec;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (fleetDefaultMemberConfigValue != null) {
      map['fleetDefaultMemberConfig'] = Input.mapOptionalInputValue<
              CommonFleetDefaultMemberConfigSpec2, Map<String, dynamic>>(
    ...
    if (specValue != null) {
      map['spec'] =
          Input.mapOptionalInputValue<CommonFeatureSpec2, Map<String, dynamic>>(
              specValue, (value) => value.toMap());
    }
    return map;
  }

  factory FeatureArgs2.fromMap(Map<String, dynamic> map) {
    return FeatureArgs2(
      featureId: Input.asOptionalInput<String>(map['featureId']),
      fleetDefaultMemberConfig:
          Input.asOptionalInput<CommonFleetDefaultMemberConfigSpec2>(
      ...
      spec: Input.asOptionalInput<CommonFeatureSpec2>(map['spec']),
    );
  }
}
