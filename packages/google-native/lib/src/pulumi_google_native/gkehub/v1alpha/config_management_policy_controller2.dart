...
import 'config_management_policy_controller_monitoring2.dart';

/// Configuration for Policy Controller
class ConfigManagementPolicyController2 {
  ...
  final ConfigManagementPolicyControllerMonitoring2? monitoring;
  ...
  ConfigManagementPolicyController2({
  ...
  factory ConfigManagementPolicyController2.fromMap(Map<String, dynamic> map) {
    return ConfigManagementPolicyController2(
      ...
      monitoring: map['monitoring'] == null
          ? null
          : ConfigManagementPolicyControllerMonitoring2.fromMap(
