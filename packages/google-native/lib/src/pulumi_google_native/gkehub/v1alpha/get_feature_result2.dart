...
class GetFeatureResult2 {
  ...
  final CommonFleetDefaultMemberConfigSpecResponse2 fleetDefaultMemberConfig;
  ...
  final FeatureResourceStateResponse2 resourceState;
  ...
  final CommonFeatureSpecResponse2 spec;

  /// The Hub-wide Feature state.
  final CommonFeatureStateResponse2 state;
  ...
  factory GetFeatureResult2.fromMap(Map<String, dynamic> map) {
    return GetFeatureResult2(
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      fleetDefaultMemberConfig:
          CommonFleetDefaultMemberConfigSpecResponse2.fromMap(
      ...
      resourceState: FeatureResourceStateResponse2.fromMap(
      ...
      spec: CommonFeatureSpecResponse2.fromMap(
          (map['spec'] as Map).cast<String, dynamic>()),
      state: CommonFeatureStateResponse2.fromMap(
