...
import 'config_management_git_config_response2.dart';
import 'config_management_oci_config_response2.dart';

/// Configuration for Config Sync
class ConfigManagementConfigSyncResponse2 {
  ...
  final ConfigManagementGitConfigResponse2 git;
  ...
  final ConfigManagementOciConfigResponse2 oci;
  ...
  ConfigManagementConfigSyncResponse2({
  ...
  factory ConfigManagementConfigSyncResponse2.fromMap(
      Map<String, dynamic> map) {
    return ConfigManagementConfigSyncResponse2(
      allowVerticalScale: map['allowVerticalScale'] as bool,
      enabled: map['enabled'] as bool,
      git: ConfigManagementGitConfigResponse2.fromMap(
          (map['git'] as Map).cast<String, dynamic>()),
      metricsGcpServiceAccountEmail:
          map['metricsGcpServiceAccountEmail'] as String,
      oci: ConfigManagementOciConfigResponse2.fromMap(
