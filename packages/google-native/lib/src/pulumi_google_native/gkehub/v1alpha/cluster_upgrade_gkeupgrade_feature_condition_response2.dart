...
class ClusterUpgradeGKEUpgradeFeatureConditionResponse2 {
  ...
  factory ClusterUpgradeGKEUpgradeFeatureConditionResponse2.fromMap(
      Map<String, dynamic> map) {
    return ClusterUpgradeGKEUpgradeFeatureConditionResponse2(
