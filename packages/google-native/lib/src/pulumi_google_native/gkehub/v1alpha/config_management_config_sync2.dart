...
import 'config_management_git_config2.dart';
import 'config_management_oci_config2.dart';

/// Configuration for Config Sync
class ConfigManagementConfigSync2 {
  ...
  final ConfigManagementGitConfig2? git;
  ...
  final ConfigManagementOciConfig2? oci;
  ...
  factory ConfigManagementConfigSync2.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSync2(
      ...
      git: map['git'] == null
          ? null
          : ConfigManagementGitConfig2.fromMap(
      ...
      oci: map['oci'] == null
          ? null
          : ConfigManagementOciConfig2.fromMap(
