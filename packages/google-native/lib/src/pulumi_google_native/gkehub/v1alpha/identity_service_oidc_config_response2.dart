...
class IdentityServiceOidcConfigResponse2 {
  ...
  IdentityServiceOidcConfigResponse2({
  ...
  factory IdentityServiceOidcConfigResponse2.fromMap(Map<String, dynamic> map) {
    return IdentityServiceOidcConfigResponse2(
