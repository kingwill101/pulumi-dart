...
import 'appliance_cluster3.dart';
import 'edge_cluster3.dart';
import 'gke_cluster4.dart';
import 'kubernetes_resource3.dart';
import 'multi_cloud_cluster3.dart';
import 'on_prem_cluster3.dart';

/// MembershipEndpoint contains information needed to contact a Kubernetes API, endpoint and any additional Kubernetes metadata.
class MembershipEndpoint3 {
  /// Optional. Specific information for a GDC Edge Appliance cluster.
  final ApplianceCluster3? applianceCluster;

  /// Optional. Specific information for a Google Edge cluster.
  final EdgeCluster3? edgeCluster;

  /// Optional. Specific information for a GKE-on-GCP cluster.
  final GkeCluster4? gkeCluster;

  /// Optional. The in-cluster Kubernetes Resources that should be applied for a correctly registered cluster, in the steady state. These resources: * Ensure that the cluster is exclusively registered to one and only one Hub Membership. * Propagate Workload Pool Information available in the Membership Authority field. * Ensure proper initial configuration of default Hub Features.
  final KubernetesResource3? kubernetesResource;

  /// Optional. Specific information for a GKE Multi-Cloud cluster.
  final MultiCloudCluster3? multiCloudCluster;

  /// Optional. Specific information for a GKE On-Prem cluster. An onprem user-cluster who has no resourceLink is not allowed to use this field, it should have a nil "type" instead.
  final OnPremCluster3? onPremCluster;
  ...
  factory MembershipEndpoint3.fromMap(Map<String, dynamic> map) {
    return MembershipEndpoint3(
      applianceCluster: map['applianceCluster'] == null
          ? null
          : ApplianceCluster3.fromMap(
              (map['applianceCluster'] as Map).cast<String, dynamic>()),
      edgeCluster: map['edgeCluster'] == null
          ? null
          : EdgeCluster3.fromMap(
