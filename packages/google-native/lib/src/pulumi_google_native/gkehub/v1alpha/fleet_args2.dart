...
import 'default_cluster_config2.dart';

/// The set of arguments for Fleet.
class FleetArgs2 {
  /// Optional. The default cluster configurations to apply across the fleet.
  final Input<DefaultClusterConfig2>? defaultClusterConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (defaultClusterConfigValue != null) {
      map['defaultClusterConfig'] = Input.mapOptionalInputValue<
              DefaultClusterConfig2, Map<String, dynamic>>(
  ...
  factory FleetArgs2.fromMap(Map<String, dynamic> map) {
    return FleetArgs2(
      defaultClusterConfig: Input.asOptionalInput<DefaultClusterConfig2>(
