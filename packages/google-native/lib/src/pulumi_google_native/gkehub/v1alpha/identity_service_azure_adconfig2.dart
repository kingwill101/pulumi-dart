...
class IdentityServiceAzureADConfig2 {
  ...
  factory IdentityServiceAzureADConfig2.fromMap(Map<String, dynamic> map) {
    return IdentityServiceAzureADConfig2(
