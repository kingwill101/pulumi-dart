...
class ConfigManagementOciConfigResponse2 {
  ...
  ConfigManagementOciConfigResponse2({
  ...
  factory ConfigManagementOciConfigResponse2.fromMap(Map<String, dynamic> map) {
    return ConfigManagementOciConfigResponse2(
