...
class KubernetesMetadataResponse3 {
  ...
  factory KubernetesMetadataResponse3.fromMap(Map<String, dynamic> map) {
    return KubernetesMetadataResponse3(
