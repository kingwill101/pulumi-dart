...
import 'scope_iam_member_gkehub_v1alpha_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ScopeIamMemberGkehubV1alpha extends pulumi.CustomResource {
  ...
  ScopeIamMemberGkehubV1alpha(
    String name, {
    ScopeIamMemberGkehubV1alphaArgs? args,
