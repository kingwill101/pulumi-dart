...
class ConfigManagementHierarchyControllerConfig2 {
  ...
  ConfigManagementHierarchyControllerConfig2({
  ...
  factory ConfigManagementHierarchyControllerConfig2.fromMap(
      Map<String, dynamic> map) {
    return ConfigManagementHierarchyControllerConfig2(
      enableHierarchicalResourceQuota:
