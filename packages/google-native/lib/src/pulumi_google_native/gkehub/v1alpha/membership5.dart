...
import 'membership_state_response3.dart';
import 'monitoring_config_response5.dart';

/// Creates a new Membership. **This is currently only supported for GKE clusters on Google Cloud**. To register other clusters, follow the instructions at https://cloud.google.com/anthos/multicluster-management/connect/registering-a-cluster.
/// Auto-naming is currently not supported for this resource.
class Membership5 extends CustomResource {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  late final Output<AuthorityResponse4> authority;
  ...
  late final Output<MembershipEndpointResponse3> endpoint;
  ...
  late final Output<MonitoringConfigResponse5> monitoringConfig;
  ...
  late final Output<MembershipStateResponse3> state;
  ...
  Membership5(
    ...
    this.authority = Output.createUnknown<AuthorityResponse4>();
    this.createTime = Output.createUnknown<String>();
    this.deleteTime = Output.createUnknown<String>();
    this.description = Output.createUnknown<String>();
    this.endpoint = Output.createUnknown<MembershipEndpointResponse3>();
    ...
    this.monitoringConfig = Output.createUnknown<MonitoringConfigResponse5>();
    this.name = Output.createUnknown<String>();
    this.project = Output.createUnknown<String>();
    this.requestId = Output.createUnknown<String?>();
    this.state = Output.createUnknown<MembershipStateResponse3>();
