...
class ConfigManagementHierarchyControllerConfigResponse2 {
  ...
  ConfigManagementHierarchyControllerConfigResponse2({
  ...
  factory ConfigManagementHierarchyControllerConfigResponse2.fromMap(
      Map<String, dynamic> map) {
    return ConfigManagementHierarchyControllerConfigResponse2(
