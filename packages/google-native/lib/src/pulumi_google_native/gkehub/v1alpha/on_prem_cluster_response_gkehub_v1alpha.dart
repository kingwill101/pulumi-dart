...
class OnPremClusterResponseGkehubV1alpha {
  ...
  factory OnPremClusterResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return OnPremClusterResponseGkehubV1alpha(
