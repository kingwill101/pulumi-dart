...
import 'on_prem_cluster_cluster_type3.dart';

/// OnPremCluster contains information specific to GKE On-Prem clusters.
class OnPremCluster3 {
  /// Immutable. Whether the cluster is an admin cluster.
  final bool? adminCluster;

  /// Immutable. The on prem cluster's type.
  final OnPremClusterClusterType3? clusterType;
  ...
  factory OnPremCluster3.fromMap(Map<String, dynamic> map) {
    return OnPremCluster3(
      adminCluster:
          map['adminCluster'] == null ? null : map['adminCluster'] as bool,
      clusterType: map['clusterType'] == null
          ? null
          : OnPremClusterClusterType3.fromValue(map['clusterType'] as String),
      resourceLink:
