...
class GetFleetResult2 {
  /// When the Fleet was created.
  final String createTime;

  /// Optional. The default cluster configurations to apply across the fleet.
  final DefaultClusterConfigResponse2 defaultClusterConfig;
  ...
  final FleetLifecycleStateResponse2 state;
  ...
  factory GetFleetResult2.fromMap(Map<String, dynamic> map) {
    return GetFleetResult2(
      createTime: map['createTime'] as String,
      defaultClusterConfig: DefaultClusterConfigResponse2.fromMap(
          (map['defaultClusterConfig'] as Map).cast<String, dynamic>()),
      deleteTime: map['deleteTime'] as String,
      displayName: map['displayName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      state: FleetLifecycleStateResponse2.fromMap(
