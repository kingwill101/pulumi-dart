...
import 'policy_controller_monitoring_config_response2.dart';
import 'policy_controller_policy_content_spec_response2.dart';

/// Configuration for Policy Controller
class PolicyControllerHubConfigResponse2 {
  ...
  final PolicyControllerMonitoringConfigResponse2 monitoring;

  /// Enables the ability to mutate resources using Policy Controller.
  final bool mutationEnabled;

  /// Specifies the desired policy content on the cluster
  final PolicyControllerPolicyContentSpecResponse2 policyContent;

  /// Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
  final bool referentialRulesEnabled;

  PolicyControllerHubConfigResponse2({
  ...
  factory PolicyControllerHubConfigResponse2.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponse2(
      ...
      monitoring: PolicyControllerMonitoringConfigResponse2.fromMap(
          (map['monitoring'] as Map).cast<String, dynamic>()),
      mutationEnabled: map['mutationEnabled'] as bool,
      policyContent: PolicyControllerPolicyContentSpecResponse2.fromMap(
