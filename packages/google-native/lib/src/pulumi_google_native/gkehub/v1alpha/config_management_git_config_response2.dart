...
class ConfigManagementGitConfigResponse2 {
  ...
  ConfigManagementGitConfigResponse2({
  ...
  factory ConfigManagementGitConfigResponse2.fromMap(Map<String, dynamic> map) {
    return ConfigManagementGitConfigResponse2(
