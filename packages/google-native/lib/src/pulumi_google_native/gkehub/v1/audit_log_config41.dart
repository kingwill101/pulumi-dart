...
class AuditLogConfig41 {
  ...
  factory AuditLogConfig41.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig41(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType41.fromValue(map['logType'] as String),
    );
  }
}
