...
import 'security_posture_config_response_gkehub_v1.dart';
...
class DefaultClusterConfigResponse {
  ...
  final SecurityPostureConfigResponseGkehubV1 securityPostureConfig;
  ...
  factory DefaultClusterConfigResponse.fromMap(Map<String, dynamic> map) {
    return DefaultClusterConfigResponse(
      ...
      securityPostureConfig: SecurityPostureConfigResponseGkehubV1.fromMap(
