...
class MembershipIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigGkehubV1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigGkehubV1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingGkehubV1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) =>
              pulumi.Input.encodeList<BindingGkehubV1, Map<String, dynamic>>(
  ...
  factory MembershipIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return MembershipIamPolicyArgs(
      auditConfigs: pulumi.Input.asOptionalInput<List<AuditConfigGkehubV1>>(
          map['auditConfigs']),
      bindings:
          pulumi.Input.asOptionalInput<List<BindingGkehubV1>>(map['bindings']),
