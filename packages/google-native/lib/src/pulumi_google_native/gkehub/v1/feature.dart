...
class Feature extends CustomResource {
  ...
  late final Output<CommonFleetDefaultMemberConfigSpecResponse>
  ...
  late final Output<FeatureResourceStateResponse> resourceState;
  ...
  late final Output<CommonFeatureSpecResponse> spec;

  /// The Hub-wide Feature state.
  late final Output<CommonFeatureStateResponse> state;
