...
class Binding104 extends CustomResource {
  ...
  late final Output<MembershipBindingLifecycleStateResponse> state;
  ...
  Binding104(
    ...
    this.state =
        registerOutput<MembershipBindingLifecycleStateResponse>('state');
