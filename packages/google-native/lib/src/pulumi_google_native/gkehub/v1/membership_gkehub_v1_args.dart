...
import 'authority_gkehub_v1.dart';
import 'membership_endpoint.dart';
import 'monitoring_config_gkehub_v1.dart';

/// The set of arguments for Membership.
class MembershipGkehubV1Args {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final pulumi.Input<AuthorityGkehubV1>? authority;
  ...
  final pulumi.Input<MonitoringConfigGkehubV1>? monitoringConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (authorityValue != null) {
      map['authority'] = pulumi.Input.mapOptionalInputValue<AuthorityGkehubV1,
    ...
    if (monitoringConfigValue != null) {
      map['monitoringConfig'] = pulumi.Input.mapOptionalInputValue<
              MonitoringConfigGkehubV1, Map<String, dynamic>>(
  ...
  factory MembershipGkehubV1Args.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1Args(
      authority:
          pulumi.Input.asOptionalInput<AuthorityGkehubV1>(map['authority']),
      endpoint:
      ...
      monitoringConfig: pulumi.Input.asOptionalInput<MonitoringConfigGkehubV1>(
