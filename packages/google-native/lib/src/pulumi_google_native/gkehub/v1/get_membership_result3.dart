...
class GetMembershipResult3 {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final AuthorityResponse2 authority;
  ...
  final MonitoringConfigResponse3 monitoringConfig;
  ...
  factory GetMembershipResult3.fromMap(Map<String, dynamic> map) {
    return GetMembershipResult3(
      authority: AuthorityResponse2.fromMap(
      ...
      monitoringConfig: MonitoringConfigResponse3.fromMap(
