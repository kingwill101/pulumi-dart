...
import 'membership_gkehub_v1_args.dart';
...
class MembershipGkehubV1 extends pulumi.CustomResource {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  late final pulumi.Output<AuthorityResponseGkehubV1> authority;
  ...
  late final pulumi.Output<MonitoringConfigResponseGkehubV1> monitoringConfig;
  ...
  MembershipGkehubV1(
    ...
    this.authority = registerOutput<AuthorityResponseGkehubV1>('authority');
    ...
    this.monitoringConfig =
        registerOutput<MonitoringConfigResponseGkehubV1>('monitoringConfig');
