...
import 'authority_response_gkehub_v1.dart';
import 'membership_endpoint_response.dart';
import 'membership_state_response.dart';
import 'monitoring_config_response_gkehub_v1.dart';

/// Result data returned by getMembership.
class GetMembershipGkehubV1Result {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final AuthorityResponseGkehubV1 authority;
  ...
  final MonitoringConfigResponseGkehubV1 monitoringConfig;
  ...
  factory GetMembershipGkehubV1Result.fromMap(Map<String, dynamic> map) {
    return GetMembershipGkehubV1Result(
      authority: AuthorityResponseGkehubV1.fromMap(
      ...
      monitoringConfig: MonitoringConfigResponseGkehubV1.fromMap(
