...
class MonitoringConfigResponseGkehubV1 {
  ...
  MonitoringConfigResponseGkehubV1({
  ...
  factory MonitoringConfigResponseGkehubV1.fromMap(Map<String, dynamic> map) {
    return MonitoringConfigResponseGkehubV1(
