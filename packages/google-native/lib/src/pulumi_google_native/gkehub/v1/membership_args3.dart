...
import 'authority2.dart';
import 'membership_endpoint.dart';
import 'monitoring_config3.dart';

/// The set of arguments for Membership.
class MembershipArgs3 {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final Input<Authority2>? authority;
  ...
  final Input<MonitoringConfig3>? monitoringConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (authorityValue != null) {
      map['authority'] =
          Input.mapOptionalInputValue<Authority2, Map<String, dynamic>>(
    ...
    if (monitoringConfigValue != null) {
      map['monitoringConfig'] =
          Input.mapOptionalInputValue<MonitoringConfig3, Map<String, dynamic>>(
  ...
  factory MembershipArgs3.fromMap(Map<String, dynamic> map) {
    return MembershipArgs3(
      authority: Input.asOptionalInput<Authority2>(map['authority']),
      ...
      monitoringConfig:
          Input.asOptionalInput<MonitoringConfig3>(map['monitoringConfig']),
