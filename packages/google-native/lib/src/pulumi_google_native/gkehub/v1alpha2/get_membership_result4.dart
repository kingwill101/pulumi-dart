...
class GetMembershipResult4 {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final AuthorityResponse3 authority;
  ...
  final MembershipEndpointResponse2 endpoint;
  ...
  final MonitoringConfigResponse4 monitoringConfig;
  ...
  final MembershipStateResponse2 state;
  ...
  factory GetMembershipResult4.fromMap(Map<String, dynamic> map) {
    return GetMembershipResult4(
      authority: AuthorityResponse3.fromMap(
          (map['authority'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponse2.fromMap(
      ...
      monitoringConfig: MonitoringConfigResponse4.fromMap(
          (map['monitoringConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      state: MembershipStateResponse2.fromMap(
