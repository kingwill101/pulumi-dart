...
class AuditLogConfig42 {
  ...
  factory AuditLogConfig42.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig42(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType42.fromValue(map['logType'] as String),
    );
  }
}
