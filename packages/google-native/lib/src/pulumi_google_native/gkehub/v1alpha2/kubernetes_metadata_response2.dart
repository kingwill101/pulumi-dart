...
class KubernetesMetadataResponse2 {
  ...
  factory KubernetesMetadataResponse2.fromMap(Map<String, dynamic> map) {
    return KubernetesMetadataResponse2(
