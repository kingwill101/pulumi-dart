...
class GetMembershipResult7 {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final AuthorityResponse6 authority;
  ...
  final MembershipEndpointResponse5 endpoint;
  ...
  final MonitoringConfigResponse7 monitoringConfig;
  ...
  final MembershipStateResponse5 state;
  ...
  factory GetMembershipResult7.fromMap(Map<String, dynamic> map) {
    return GetMembershipResult7(
      authority: AuthorityResponse6.fromMap(
          (map['authority'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponse5.fromMap(
          (map['endpoint'] as Map).cast<String, dynamic>()),
      externalId: map['externalId'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      lastConnectionTime: map['lastConnectionTime'] as String,
      monitoringConfig: MonitoringConfigResponse7.fromMap(
          (map['monitoringConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      state: MembershipStateResponse5.fromMap(
