...
class IdentityServiceOidcConfigResponse3 {
  ...
  IdentityServiceOidcConfigResponse3({
  ...
  factory IdentityServiceOidcConfigResponse3.fromMap(Map<String, dynamic> map) {
    return IdentityServiceOidcConfigResponse3(
