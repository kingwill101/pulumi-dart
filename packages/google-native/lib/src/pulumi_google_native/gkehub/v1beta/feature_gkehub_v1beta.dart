...
import 'feature_gkehub_v1beta_args.dart';
import 'feature_resource_state_response_gkehub_v1beta.dart';

/// Adds a new Feature.
/// Auto-naming is currently not supported for this resource.
class FeatureGkehubV1beta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<CommonFleetDefaultMemberConfigSpecResponseGkehubV1beta>
  ...
  late final pulumi.Output<FeatureResourceStateResponseGkehubV1beta>
      resourceState;
  ...
  late final pulumi.Output<CommonFeatureSpecResponseGkehubV1beta> spec;

  /// The Hub-wide Feature state.
  late final pulumi.Output<CommonFeatureStateResponseGkehubV1beta> state;
  ...
  FeatureGkehubV1beta(
    ...
    this.resourceState =
        registerOutput<FeatureResourceStateResponseGkehubV1beta>(
            'resourceState');
    this.scopeSpecs = registerOutput<Map<String, String>>('scopeSpecs');
    this.scopeStates = registerOutput<Map<String, String>>('scopeStates');
    this.spec = registerOutput<CommonFeatureSpecResponseGkehubV1beta>('spec');
    this.state =
        registerOutput<CommonFeatureStateResponseGkehubV1beta>('state');
