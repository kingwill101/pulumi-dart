...
class IdentityServiceAzureADConfig3 {
  ...
  factory IdentityServiceAzureADConfig3.fromMap(Map<String, dynamic> map) {
    return IdentityServiceAzureADConfig3(
