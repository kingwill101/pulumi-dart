...
import 'common_feature_spec3.dart';
import 'common_fleet_default_member_config_spec3.dart';
...
class FeatureArgs3 {
  ...
  final Input<CommonFleetDefaultMemberConfigSpec3>? fleetDefaultMemberConfig;
  ...
  final Input<CommonFeatureSpec3>? spec;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (fleetDefaultMemberConfigValue != null) {
      map['fleetDefaultMemberConfig'] = Input.mapOptionalInputValue<
              CommonFleetDefaultMemberConfigSpec3, Map<String, dynamic>>(
    ...
    if (specValue != null) {
      map['spec'] =
          Input.mapOptionalInputValue<CommonFeatureSpec3, Map<String, dynamic>>(
              specValue, (value) => value.toMap());
    }
    return map;
  }

  factory FeatureArgs3.fromMap(Map<String, dynamic> map) {
    return FeatureArgs3(
      featureId: Input.asOptionalInput<String>(map['featureId']),
      fleetDefaultMemberConfig:
          Input.asOptionalInput<CommonFleetDefaultMemberConfigSpec3>(
      ...
      spec: Input.asOptionalInput<CommonFeatureSpec3>(map['spec']),
    );
  }
}
