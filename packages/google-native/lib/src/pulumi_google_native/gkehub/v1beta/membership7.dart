...
class Membership7 extends CustomResource {
  ...
  Membership7(
    ...
    this.authority = registerOutput<AuthorityResponse6>('authority');
    this.createTime = registerOutput<String>('createTime');
    this.deleteTime = registerOutput<String>('deleteTime');
    this.description = registerOutput<String>('description');
    this.endpoint = registerOutput<MembershipEndpointResponse5>('endpoint');
    ...
    this.monitoringConfig =
        registerOutput<MonitoringConfigResponse7>('monitoringConfig');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.state = registerOutput<MembershipStateResponse5>('state');
