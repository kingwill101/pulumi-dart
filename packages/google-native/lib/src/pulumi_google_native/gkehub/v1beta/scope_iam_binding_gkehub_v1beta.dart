...
import 'scope_iam_binding_gkehub_v1beta_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ScopeIamBindingGkehubV1beta extends pulumi.CustomResource {
  ...
  ScopeIamBindingGkehubV1beta(
    String name, {
    ScopeIamBindingGkehubV1betaArgs? args,
