...
class KubernetesMetadataResponse5 {
  ...
  factory KubernetesMetadataResponse5.fromMap(Map<String, dynamic> map) {
    return KubernetesMetadataResponse5(
