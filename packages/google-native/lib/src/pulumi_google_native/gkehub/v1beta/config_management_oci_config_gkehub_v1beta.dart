...
class ConfigManagementOciConfigGkehubV1beta {
  ...
  ConfigManagementOciConfigGkehubV1beta({
  ...
  factory ConfigManagementOciConfigGkehubV1beta.fromMap(
      Map<String, dynamic> map) {
    return ConfigManagementOciConfigGkehubV1beta(
