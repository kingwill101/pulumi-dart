...
import 'config_management_git_config3.dart';
import 'config_management_oci_config3.dart';

/// Configuration for Config Sync
class ConfigManagementConfigSync3 {
  ...
  final ConfigManagementGitConfig3? git;
  ...
  final ConfigManagementOciConfig3? oci;
  ...
  factory ConfigManagementConfigSync3.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSync3(
      ...
      git: map['git'] == null
          ? null
          : ConfigManagementGitConfig3.fromMap(
      ...
      oci: map['oci'] == null
          ? null
          : ConfigManagementOciConfig3.fromMap(
