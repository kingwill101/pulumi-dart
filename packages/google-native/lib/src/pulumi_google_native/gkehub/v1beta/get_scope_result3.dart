...
import 'scope_lifecycle_state_response3.dart';

/// Result data returned by getScope.
class GetScopeResult3 {
  ...
  final ScopeLifecycleStateResponse3 state;
  ...
  factory GetScopeResult3.fromMap(Map<String, dynamic> map) {
    return GetScopeResult3(
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      namespaceLabels: (map['namespaceLabels'] as Map).cast<String, String>(),
      state: ScopeLifecycleStateResponse3.fromMap(
