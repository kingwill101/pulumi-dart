...
import 'common_feature_spec_response3.dart';
import 'common_feature_state_response3.dart';
import 'common_fleet_default_member_config_spec_response3.dart';
import 'feature_resource_state_response3.dart';

/// Result data returned by getFeature.
class GetFeatureResult3 {
  ...
  final CommonFleetDefaultMemberConfigSpecResponse3 fleetDefaultMemberConfig;
  ...
  final FeatureResourceStateResponse3 resourceState;
  ...
  final CommonFeatureSpecResponse3 spec;

  /// The Hub-wide Feature state.
  final CommonFeatureStateResponse3 state;
  ...
  factory GetFeatureResult3.fromMap(Map<String, dynamic> map) {
    return GetFeatureResult3(
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      fleetDefaultMemberConfig:
          CommonFleetDefaultMemberConfigSpecResponse3.fromMap(
      ...
      resourceState: FeatureResourceStateResponse3.fromMap(
      ...
      spec: CommonFeatureSpecResponse3.fromMap(
          (map['spec'] as Map).cast<String, dynamic>()),
      state: CommonFeatureStateResponse3.fromMap(
