...
class KubernetesResourceResponseGkehubV1beta {
  ...
  factory KubernetesResourceResponseGkehubV1beta.fromMap(
      Map<String, dynamic> map) {
    return KubernetesResourceResponseGkehubV1beta(
      connectResources:
          pulumi.Input.decodeList<ResourceManifestResponseGkehubV1beta>(
              map['connectResources'],
              (value) => ResourceManifestResponseGkehubV1beta.fromMap(
      ...
      membershipResources:
          pulumi.Input.decodeList<ResourceManifestResponseGkehubV1beta>(
              ...
              (value) => ResourceManifestResponseGkehubV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      resourceOptions: ResourceOptionsResponseGkehubV1beta.fromMap(
