...
class AuditLogConfig45 {
  ...
  factory AuditLogConfig45.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig45(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType45.fromValue(map['logType'] as String),
    );
  }
}
