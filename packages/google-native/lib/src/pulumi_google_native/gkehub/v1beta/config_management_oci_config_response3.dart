...
class ConfigManagementOciConfigResponse3 {
  ...
  ConfigManagementOciConfigResponse3({
  ...
  factory ConfigManagementOciConfigResponse3.fromMap(Map<String, dynamic> map) {
    return ConfigManagementOciConfigResponse3(
