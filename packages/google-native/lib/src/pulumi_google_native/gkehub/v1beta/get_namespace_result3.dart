...
class GetNamespaceResult3 {
  ...
  final NamespaceLifecycleStateResponse3 state;
  ...
  factory GetNamespaceResult3.fromMap(Map<String, dynamic> map) {
    return GetNamespaceResult3(
      ...
      state: NamespaceLifecycleStateResponse3.fromMap(
