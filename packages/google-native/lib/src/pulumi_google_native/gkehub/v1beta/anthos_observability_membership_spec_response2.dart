...
class AnthosObservabilityMembershipSpecResponse2 {
  ...
  AnthosObservabilityMembershipSpecResponse2({
  ...
  factory AnthosObservabilityMembershipSpecResponse2.fromMap(
      Map<String, dynamic> map) {
    return AnthosObservabilityMembershipSpecResponse2(
