...
class GetScopeRbacRoleBindingResult2 {
  ...
  final RoleResponse3 role;

  /// State of the rbacrolebinding resource.
  final RBACRoleBindingLifecycleStateResponse3 state;
  ...
  GetScopeRbacRoleBindingResult2({
  ...
  factory GetScopeRbacRoleBindingResult2.fromMap(Map<String, dynamic> map) {
    return GetScopeRbacRoleBindingResult2(
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      group: map['group'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      role: RoleResponse3.fromMap((map['role'] as Map).cast<String, dynamic>()),
      state: RBACRoleBindingLifecycleStateResponse3.fromMap(
