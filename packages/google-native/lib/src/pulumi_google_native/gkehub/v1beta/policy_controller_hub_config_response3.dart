...
import 'policy_controller_monitoring_config_response3.dart';
import 'policy_controller_policy_content_spec_response3.dart';

/// Configuration for Policy Controller
class PolicyControllerHubConfigResponse3 {
  ...
  final PolicyControllerMonitoringConfigResponse3 monitoring;

  /// Enables the ability to mutate resources using Policy Controller.
  final bool mutationEnabled;

  /// Specifies the desired policy content on the cluster
  final PolicyControllerPolicyContentSpecResponse3 policyContent;

  /// Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
  final bool referentialRulesEnabled;

  PolicyControllerHubConfigResponse3({
  ...
  factory PolicyControllerHubConfigResponse3.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponse3(
      ...
      monitoring: PolicyControllerMonitoringConfigResponse3.fromMap(
          (map['monitoring'] as Map).cast<String, dynamic>()),
      mutationEnabled: map['mutationEnabled'] as bool,
      policyContent: PolicyControllerPolicyContentSpecResponse3.fromMap(
