...
import 'cluster_upgrade_gkeupgrade_feature_state_response3.dart';

/// **ClusterUpgrade**: The state for the fleet-level ClusterUpgrade feature.
class ClusterUpgradeFleetStateResponse3 {
  ...
  final ClusterUpgradeGKEUpgradeFeatureStateResponse3 gkeState;
  ...
  ClusterUpgradeFleetStateResponse3({
  ...
  factory ClusterUpgradeFleetStateResponse3.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetStateResponse3(
      downstreamFleets: (map['downstreamFleets'] as List).cast<String>(),
      gkeState: ClusterUpgradeGKEUpgradeFeatureStateResponse3.fromMap(
