...
class AnthosObservabilityMembershipSpec2 {
  ...
  AnthosObservabilityMembershipSpec2({
  ...
  factory AnthosObservabilityMembershipSpec2.fromMap(Map<String, dynamic> map) {
    return AnthosObservabilityMembershipSpec2(
