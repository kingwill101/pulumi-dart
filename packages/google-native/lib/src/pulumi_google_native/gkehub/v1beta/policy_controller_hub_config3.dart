...
import 'policy_controller_hub_config_install_spec3.dart';
import 'policy_controller_monitoring_config3.dart';
import 'policy_controller_policy_content_spec3.dart';

/// Configuration for Policy Controller
class PolicyControllerHubConfig3 {
  ...
  final PolicyControllerHubConfigInstallSpec3? installSpec;

  /// Logs all denies and dry run failures.
  final bool? logDeniesEnabled;

  /// Monitoring specifies the configuration of monitoring.
  final PolicyControllerMonitoringConfig3? monitoring;

  /// Enables the ability to mutate resources using Policy Controller.
  final bool? mutationEnabled;

  /// Specifies the desired policy content on the cluster
  final PolicyControllerPolicyContentSpec3? policyContent;

  /// Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
  final bool? referentialRulesEnabled;

  PolicyControllerHubConfig3({
  ...
  factory PolicyControllerHubConfig3.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfig3(
      ...
      installSpec: map['installSpec'] == null
          ? null
          : PolicyControllerHubConfigInstallSpec3.fromValue(
      ...
      monitoring: map['monitoring'] == null
          ? null
          : PolicyControllerMonitoringConfig3.fromMap(
      ...
      policyContent: map['policyContent'] == null
          ? null
          : PolicyControllerPolicyContentSpec3.fromMap(
