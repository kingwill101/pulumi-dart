...
import 'scope_args3.dart';
import 'scope_lifecycle_state_response3.dart';

/// Creates a Scope.
/// Auto-naming is currently not supported for this resource.
class Scope4 extends CustomResource {
  ...
  late final Output<ScopeLifecycleStateResponse3> state;
  ...
  Scope4(
    ...
    this.state = registerOutput<ScopeLifecycleStateResponse3>('state');
