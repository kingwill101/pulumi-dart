...
class MembershipRbacRoleBindingArgs2 {
  ...
  final Input<Role3> role;

  /// user is the name of the user as seen by the kubernetes cluster, example "alice" or "alice@domain.tld"
  final Input<String>? user;

  MembershipRbacRoleBindingArgs2({
    this.group,
    this.labels,
    this.location,
  ...
  Map<String, dynamic> toMap() {
    ...
    map['role'] = Input.mapInputValue<Role3, Map<String, dynamic>>(
  ...
  factory MembershipRbacRoleBindingArgs2.fromMap(Map<String, dynamic> map) {
    return MembershipRbacRoleBindingArgs2(
      ...
      role: Input.asInput<Role3>(map['role']),
