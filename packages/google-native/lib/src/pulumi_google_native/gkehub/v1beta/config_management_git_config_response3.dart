...
class ConfigManagementGitConfigResponse3 {
  ...
  ConfigManagementGitConfigResponse3({
  ...
  factory ConfigManagementGitConfigResponse3.fromMap(Map<String, dynamic> map) {
    return ConfigManagementGitConfigResponse3(
