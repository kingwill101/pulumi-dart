...
import 'on_prem_cluster_cluster_type5.dart';

/// OnPremCluster contains information specific to GKE On-Prem clusters.
class OnPremCluster5 {
  /// Immutable. Whether the cluster is an admin cluster.
  final bool? adminCluster;

  /// Immutable. The on prem cluster's type.
  final OnPremClusterClusterType5? clusterType;
  ...
  factory OnPremCluster5.fromMap(Map<String, dynamic> map) {
    return OnPremCluster5(
      adminCluster:
          map['adminCluster'] == null ? null : map['adminCluster'] as bool,
      clusterType: map['clusterType'] == null
          ? null
          : OnPremClusterClusterType5.fromValue(map['clusterType'] as String),
      resourceLink:
