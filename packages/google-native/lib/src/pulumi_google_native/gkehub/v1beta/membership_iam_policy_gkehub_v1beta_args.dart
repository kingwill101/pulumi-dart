...
class MembershipIamPolicyGkehubV1betaArgs {
  ...
  factory MembershipIamPolicyGkehubV1betaArgs.fromMap(
      Map<String, dynamic> map) {
    return MembershipIamPolicyGkehubV1betaArgs(
      auditConfigs: pulumi.Input.asOptionalInput<List<AuditConfigGkehubV1beta>>(
          map['auditConfigs']),
      bindings: pulumi.Input.asOptionalInput<List<BindingGkehubV1beta>>(
          map['bindings']),
