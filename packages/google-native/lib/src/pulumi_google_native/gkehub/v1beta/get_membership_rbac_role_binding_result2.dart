...
class GetMembershipRbacRoleBindingResult2 {
  ...
  GetMembershipRbacRoleBindingResult2({
  ...
  factory GetMembershipRbacRoleBindingResult2.fromMap(
      Map<String, dynamic> map) {
    return GetMembershipRbacRoleBindingResult2(
