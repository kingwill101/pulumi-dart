...
class IdentityServiceAzureADConfigResponse3 {
  ...
  IdentityServiceAzureADConfigResponse3({
  ...
  factory IdentityServiceAzureADConfigResponse3.fromMap(
      Map<String, dynamic> map) {
    return IdentityServiceAzureADConfigResponse3(
