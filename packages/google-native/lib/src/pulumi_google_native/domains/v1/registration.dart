...
class Registration extends CustomResource {
  ...
  Registration(
    ...
    this.contactSettings = Output.createUnknown<ContactSettingsResponse>();
    this.createTime = Output.createUnknown<String>();
    this.dnsSettings = Output.createUnknown<DnsSettingsResponse>();
    ...
    this.managementSettings =
        Output.createUnknown<ManagementSettingsResponse>();
    this.name = Output.createUnknown<String>();
    this.pendingContactSettings =
        Output.createUnknown<ContactSettingsResponse>();
