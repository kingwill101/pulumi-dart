...
class AuditLogConfig33 {
  ...
  factory AuditLogConfig33.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig33(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType33.fromValue(map['logType'] as String),
    );
  }
}
