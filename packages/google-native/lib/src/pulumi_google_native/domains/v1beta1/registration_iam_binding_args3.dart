...
class RegistrationIamBindingArgs3 {
  ...
  factory RegistrationIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return RegistrationIamBindingArgs3(
