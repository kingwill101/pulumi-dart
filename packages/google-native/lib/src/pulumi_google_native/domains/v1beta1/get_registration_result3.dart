...
class GetRegistrationResult3 {
  ...
  final ManagementSettingsResponse3 managementSettings;
  ...
  final ContactSettingsResponse3 pendingContactSettings;
  ...
  factory GetRegistrationResult3.fromMap(Map<String, dynamic> map) {
    return GetRegistrationResult3(
      contactSettings: ContactSettingsResponse3.fromMap(
          (map['contactSettings'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dnsSettings: DnsSettingsResponse3.fromMap(
          (map['dnsSettings'] as Map).cast<String, dynamic>()),
      domainName: map['domainName'] as String,
      expireTime: map['expireTime'] as String,
      issues: (map['issues'] as List).cast<String>(),
      labels: (map['labels'] as Map).cast<String, String>(),
      managementSettings: ManagementSettingsResponse3.fromMap(
          (map['managementSettings'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      pendingContactSettings: ContactSettingsResponse3.fromMap(
