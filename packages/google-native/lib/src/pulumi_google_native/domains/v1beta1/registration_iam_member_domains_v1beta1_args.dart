...
class RegistrationIamMemberDomainsV1beta1Args {
  ...
  RegistrationIamMemberDomainsV1beta1Args({
    this.condition,
  ...
  factory RegistrationIamMemberDomainsV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return RegistrationIamMemberDomainsV1beta1Args(
