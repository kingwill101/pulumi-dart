...
import 'google_domains_dns_ds_state3.dart';
...
class GoogleDomainsDns3 {
  ...
  factory GoogleDomainsDns3.fromMap(Map<String, dynamic> map) {
    return GoogleDomainsDns3(
      dsState: GoogleDomainsDnsDsState3.fromValue(map['dsState'] as String),
    );
  }
}
