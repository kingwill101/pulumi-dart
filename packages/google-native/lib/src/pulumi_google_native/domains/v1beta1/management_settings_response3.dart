...
class ManagementSettingsResponse3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['preferredRenewalMethod'] = preferredRenewalMethod;
    map['renewalMethod'] = renewalMethod;
    map['transferLockState'] = transferLockState;
    return map;
  }

  factory ManagementSettingsResponse3.fromMap(Map<String, dynamic> map) {
    return ManagementSettingsResponse3(
      preferredRenewalMethod: map['preferredRenewalMethod'] as String,
      renewalMethod: map['renewalMethod'] as String,
      transferLockState: map['transferLockState'] as String,
    );
  }
}
