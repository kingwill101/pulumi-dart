...
class AuditLogConfig35 {
  ...
  factory AuditLogConfig35.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig35(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType35.fromValue(map['logType'] as String),
    );
  }
}
