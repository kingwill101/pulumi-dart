...
enum ManagementSettingsPreferredRenewalMethod3 {
  ...
  const ManagementSettingsPreferredRenewalMethod3(this.value);
  final String value;

  static ManagementSettingsPreferredRenewalMethod3 fromValue(String value) {
    for (final item in ManagementSettingsPreferredRenewalMethod3.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError(
        'Unknown ManagementSettingsPreferredRenewalMethod3 value: $value');
  }
}
