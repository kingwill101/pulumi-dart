...
import 'ds_record_algorithm2.dart';
import 'ds_record_digest_type2.dart';

/// Defines a Delegation Signer (DS) record, which is needed to enable DNSSEC for a domain. It contains a digest (hash) of a DNSKEY record that must be present in the domain's DNS zone.
class DsRecord2 {
  /// The algorithm used to generate the referenced DNSKEY.
  final DsRecordAlgorithm2? algorithm;

  /// The digest generated from the referenced DNSKEY.
  final String? digest;

  /// The hash function used to generate the digest of the referenced DNSKEY.
  final DsRecordDigestType2? digestType;
  ...
  factory DsRecord2.fromMap(Map<String, dynamic> map) {
    return DsRecord2(
      algorithm: map['algorithm'] == null
          ? null
          : DsRecordAlgorithm2.fromValue(map['algorithm'] as String),
      digest: map['digest'] == null ? null : map['digest'] as String,
      digestType: map['digestType'] == null
          ? null
          : DsRecordDigestType2.fromValue(map['digestType'] as String),
