...
class Registration2 extends CustomResource {
  ...
  Registration2(
    ...
    this.contactSettings =
        registerOutput<ContactSettingsResponse2>('contactSettings');
    this.createTime = registerOutput<String>('createTime');
    this.dnsSettings = registerOutput<DnsSettingsResponse2>('dnsSettings');
    ...
    this.managementSettings =
        registerOutput<ManagementSettingsResponse2>('managementSettings');
    this.name = registerOutput<String>('name');
    this.pendingContactSettings =
        registerOutput<ContactSettingsResponse2>('pendingContactSettings');
