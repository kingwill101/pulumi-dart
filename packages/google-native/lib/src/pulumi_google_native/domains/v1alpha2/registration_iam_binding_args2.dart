...
class RegistrationIamBindingArgs2 {
  ...
  factory RegistrationIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return RegistrationIamBindingArgs2(
