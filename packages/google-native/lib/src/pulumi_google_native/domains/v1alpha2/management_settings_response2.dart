...
class ManagementSettingsResponse2 {
  ...
  factory ManagementSettingsResponse2.fromMap(Map<String, dynamic> map) {
    return ManagementSettingsResponse2(
