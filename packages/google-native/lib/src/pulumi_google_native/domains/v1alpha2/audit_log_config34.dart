...
class AuditLogConfig34 {
  ...
  factory AuditLogConfig34.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig34(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType34.fromValue(map['logType'] as String),
    );
  }
}
