...
import 'management_settings_preferred_renewal_method2.dart';
import 'management_settings_transfer_lock_state2.dart';

/// Defines renewal, billing, and transfer settings for a `Registration`.
class ManagementSettings2 {
  ...
  final ManagementSettingsPreferredRenewalMethod2? preferredRenewalMethod;

  /// Controls whether the domain can be transferred to another registrar.
  final ManagementSettingsTransferLockState2? transferLockState;
  ...
  factory ManagementSettings2.fromMap(Map<String, dynamic> map) {
    return ManagementSettings2(
      preferredRenewalMethod: map['preferredRenewalMethod'] == null
          ? null
          : ManagementSettingsPreferredRenewalMethod2.fromValue(
              map['preferredRenewalMethod'] as String),
      transferLockState: map['transferLockState'] == null
          ? null
          : ManagementSettingsTransferLockState2.fromValue(
