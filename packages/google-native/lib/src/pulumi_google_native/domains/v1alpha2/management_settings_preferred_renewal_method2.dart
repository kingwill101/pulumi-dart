...
enum ManagementSettingsPreferredRenewalMethod2 {
  ...
  const ManagementSettingsPreferredRenewalMethod2(this.value);
  final String value;

  static ManagementSettingsPreferredRenewalMethod2 fromValue(String value) {
    for (final item in ManagementSettingsPreferredRenewalMethod2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError(
        'Unknown ManagementSettingsPreferredRenewalMethod2 value: $value');
  }
}
