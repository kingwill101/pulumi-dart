...
class NodePoolContainerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NodeConfigResponseContainerV1> config;
  ...
  late final pulumi.Output<PlacementPolicyResponseContainerV1> placementPolicy;
  ...
  NodePoolContainerV1(
    ...
    this.config = registerOutput<NodeConfigResponseContainerV1>('config');
    ...
    this.placementPolicy =
        registerOutput<PlacementPolicyResponseContainerV1>('placementPolicy');
