...
import 'accelerator_config_container_v1.dart';
import 'advanced_machine_features_container_v1.dart';
...
import 'reservation_affinity_container_v1.dart';
...
class NodeConfigContainerV1 {
  /// A list of hardware accelerators to be attached to each node. See https://cloud.google.com/compute/docs/gpus for more information about support for GPUs.
  final List<AcceleratorConfigContainerV1>? accelerators;

  /// Advanced features for the Compute Engine VM.
  final AdvancedMachineFeaturesContainerV1? advancedMachineFeatures;
  ...
  final ReservationAffinityContainerV1? reservationAffinity;
  ...
  factory NodeConfigContainerV1.fromMap(Map<String, dynamic> map) {
    return NodeConfigContainerV1(
      accelerators: map['accelerators'] == null
          ? null
          : pulumi.Input.decodeList<AcceleratorConfigContainerV1>(
              map['accelerators'],
              (value) => AcceleratorConfigContainerV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      advancedMachineFeatures: map['advancedMachineFeatures'] == null
          ? null
          : AdvancedMachineFeaturesContainerV1.fromMap(
      ...
      reservationAffinity: map['reservationAffinity'] == null
          ? null
          : ReservationAffinityContainerV1.fromMap(
