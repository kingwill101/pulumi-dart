...
import 'ipallocation_policy_response_container_v1.dart';
...
import 'master_authorized_networks_config_response_container_v1.dart';
import 'max_pods_constraint_response.dart';
import 'mesh_certificates_response.dart';
import 'monitoring_config_response.dart';
import 'network_config_response_container_v1.dart';
import 'network_policy_response_container_v1.dart';
...
import 'private_cluster_config_response_container_v1.dart';
...
class GetClusterContainerV1Result {
  ...
  final IPAllocationPolicyResponseContainerV1 ipAllocationPolicy;
  ...
  final MasterAuthorizedNetworksConfigResponseContainerV1
  ...
  final NetworkConfigResponseContainerV1 networkConfig;

  /// Configuration options for the NetworkPolicy feature.
  final NetworkPolicyResponseContainerV1 networkPolicy;

  /// Parameters used in creating the cluster's nodes. For requests, this field should only be used in lieu of a "node_pool" object, since this configuration (along with the "initial_node_count") will be used to create a "NodePool" object with an auto-generated name. Do not use this and a node_pool at the same time. For responses, this field will be populated with the node configuration of the first node pool. (For configuration of each node pool, see `node_pool.config`) If unspecified, the defaults are used. This field is deprecated, use node_pool.config instead.
  final NodeConfigResponseContainerV1 nodeConfig;
  ...
  final PrivateClusterConfigResponseContainerV1 privateClusterConfig;
  ...
  factory GetClusterContainerV1Result.fromMap(Map<String, dynamic> map) {
    return GetClusterContainerV1Result(
      ...
      ipAllocationPolicy: IPAllocationPolicyResponseContainerV1.fromMap(
      ...
      masterAuthorizedNetworksConfig:
          MasterAuthorizedNetworksConfigResponseContainerV1.fromMap(
      ...
      networkConfig: NetworkConfigResponseContainerV1.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      networkPolicy: NetworkPolicyResponseContainerV1.fromMap(
          (map['networkPolicy'] as Map).cast<String, dynamic>()),
      nodeConfig: NodeConfigResponseContainerV1.fromMap(
      ...
      privateClusterConfig: PrivateClusterConfigResponseContainerV1.fromMap(
