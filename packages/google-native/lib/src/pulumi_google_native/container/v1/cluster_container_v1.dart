...
import 'cluster_container_v1_args.dart';
...
class ClusterContainerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<IPAllocationPolicyResponseContainerV1>
      ipAllocationPolicy;
  ...
  late final pulumi.Output<MasterAuthorizedNetworksConfigResponseContainerV1>
  ...
  late final pulumi.Output<NetworkConfigResponseContainerV1> networkConfig;

  /// Configuration options for the NetworkPolicy feature.
  late final pulumi.Output<NetworkPolicyResponseContainerV1> networkPolicy;

  /// Parameters used in creating the cluster's nodes. For requests, this field should only be used in lieu of a "node_pool" object, since this configuration (along with the "initial_node_count") will be used to create a "NodePool" object with an auto-generated name. Do not use this and a node_pool at the same time. For responses, this field will be populated with the node configuration of the first node pool. (For configuration of each node pool, see `node_pool.config`) If unspecified, the defaults are used. This field is deprecated, use node_pool.config instead.
  late final pulumi.Output<NodeConfigResponseContainerV1> nodeConfig;
  ...
  late final pulumi.Output<PrivateClusterConfigResponseContainerV1>
  ...
  ClusterContainerV1(
    ...
    this.ipAllocationPolicy =
        registerOutput<IPAllocationPolicyResponseContainerV1>(
            'ipAllocationPolicy');
    ...
    this.masterAuthorizedNetworksConfig =
        registerOutput<MasterAuthorizedNetworksConfigResponseContainerV1>(
            'masterAuthorizedNetworksConfig');
    ...
    this.networkConfig =
        registerOutput<NetworkConfigResponseContainerV1>('networkConfig');
    this.networkPolicy =
        registerOutput<NetworkPolicyResponseContainerV1>('networkPolicy');
    this.nodeConfig =
        registerOutput<NodeConfigResponseContainerV1>('nodeConfig');
    ...
    this.privateClusterConfig =
        registerOutput<PrivateClusterConfigResponseContainerV1>(
            'privateClusterConfig');
