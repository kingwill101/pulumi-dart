...
class MaintenanceWindowContainerV1 {
  ...
  factory MaintenanceWindowContainerV1.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowContainerV1(
