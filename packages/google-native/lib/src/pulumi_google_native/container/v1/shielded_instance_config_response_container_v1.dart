...
class ShieldedInstanceConfigResponseContainerV1 {
  ...
  ShieldedInstanceConfigResponseContainerV1({
  ...
  factory ShieldedInstanceConfigResponseContainerV1.fromMap(
      Map<String, dynamic> map) {
    return ShieldedInstanceConfigResponseContainerV1(
