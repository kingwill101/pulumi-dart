...
class NetworkConfigResponseContainerV1 {
  ...
  NetworkConfigResponseContainerV1({
  ...
  factory NetworkConfigResponseContainerV1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseContainerV1(
