...
class IPAllocationPolicyContainerV1 {
  ...
  factory IPAllocationPolicyContainerV1.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyContainerV1(
