...
import 'accelerator_config_response_container_v1.dart';
import 'advanced_machine_features_response_container_v1.dart';
...
import 'reservation_affinity_response_container_v1.dart';
...
class NodeConfigResponseContainerV1 {
  /// A list of hardware accelerators to be attached to each node. See https://cloud.google.com/compute/docs/gpus for more information about support for GPUs.
  final List<AcceleratorConfigResponseContainerV1> accelerators;

  /// Advanced features for the Compute Engine VM.
  final AdvancedMachineFeaturesResponseContainerV1 advancedMachineFeatures;
  ...
  final ReservationAffinityResponseContainerV1 reservationAffinity;
  ...
  factory NodeConfigResponseContainerV1.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponseContainerV1(
      accelerators:
          pulumi.Input.decodeList<AcceleratorConfigResponseContainerV1>(
              map['accelerators'],
              (value) => AcceleratorConfigResponseContainerV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      advancedMachineFeatures:
          AdvancedMachineFeaturesResponseContainerV1.fromMap(
      ...
      reservationAffinity: ReservationAffinityResponseContainerV1.fromMap(
