...
class IPAllocationPolicyResponse3 {
  ...
  final AdditionalPodRangesConfigResponse additionalPodRangesConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['additionalPodRangesConfig'] = additionalPodRangesConfig.toMap();
    ...
    map['createSubnetwork'] = createSubnetwork;
    map['defaultPodIpv4RangeUtilization'] = defaultPodIpv4RangeUtilization;
    map['ipv6AccessType'] = ipv6AccessType;
    map['nodeIpv4Cidr'] = nodeIpv4Cidr;
    map['nodeIpv4CidrBlock'] = nodeIpv4CidrBlock;
    ...
    map['servicesIpv6CidrBlock'] = servicesIpv6CidrBlock;
    map['servicesSecondaryRangeName'] = servicesSecondaryRangeName;
    map['stackType'] = stackType;
    map['subnetIpv6CidrBlock'] = subnetIpv6CidrBlock;
    map['subnetworkName'] = subnetworkName;
    map['tpuIpv4CidrBlock'] = tpuIpv4CidrBlock;
    map['useIpAliases'] = useIpAliases;
    map['useRoutes'] = useRoutes;
    return map;
  }

  factory IPAllocationPolicyResponse3.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyResponse3(
      additionalPodRangesConfig: AdditionalPodRangesConfigResponse.fromMap(
