...
class AcceleratorConfigResponseContainerV1 {
  ...
  AcceleratorConfigResponseContainerV1({
  ...
  factory AcceleratorConfigResponseContainerV1.fromMap(
      Map<String, dynamic> map) {
    return AcceleratorConfigResponseContainerV1(
