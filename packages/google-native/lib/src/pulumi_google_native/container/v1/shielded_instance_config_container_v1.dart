...
class ShieldedInstanceConfigContainerV1 {
  ...
  ShieldedInstanceConfigContainerV1({
  ...
  factory ShieldedInstanceConfigContainerV1.fromMap(Map<String, dynamic> map) {
    return ShieldedInstanceConfigContainerV1(
