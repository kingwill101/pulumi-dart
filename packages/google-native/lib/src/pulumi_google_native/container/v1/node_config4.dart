...
import 'accelerator_config4.dart';
import 'advanced_machine_features4.dart';
...
import 'reservation_affinity4.dart';
...
class NodeConfig4 {
  ...
  final List<AcceleratorConfig4>? accelerators;

  /// Advanced features for the Compute Engine VM.
  final AdvancedMachineFeatures4? advancedMachineFeatures;
  ...
  final ReservationAffinity4? reservationAffinity;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (acceleratorsValue != null) {
      map['accelerators'] =
          Input.encodeList<AcceleratorConfig4, Map<String, dynamic>>(
  ...
  factory NodeConfig4.fromMap(Map<String, dynamic> map) {
    return NodeConfig4(
      accelerators: map['accelerators'] == null
          ? null
          : Input.decodeList<AcceleratorConfig4>(
              map['accelerators'],
              (value) => AcceleratorConfig4.fromMap(
                  (value as Map).cast<String, dynamic>())),
      advancedMachineFeatures: map['advancedMachineFeatures'] == null
          ? null
          : AdvancedMachineFeatures4.fromMap(
