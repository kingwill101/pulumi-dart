...
class GetClusterResult5 {
  ...
  final IPAllocationPolicyResponse3 ipAllocationPolicy;
  ...
  final MasterAuthorizedNetworksConfigResponse3 masterAuthorizedNetworksConfig;
  ...
  final NetworkConfigResponse9 networkConfig;

  /// Configuration options for the NetworkPolicy feature.
  final NetworkPolicyResponse2 networkPolicy;

  /// Parameters used in creating the cluster's nodes. For requests, this field should only be used in lieu of a "node_pool" object, since this configuration (along with the "initial_node_count") will be used to create a "NodePool" object with an auto-generated name. Do not use this and a node_pool at the same time. For responses, this field will be populated with the node configuration of the first node pool. (For configuration of each node pool, see `node_pool.config`) If unspecified, the defaults are used. This field is deprecated, use node_pool.config instead.
  final NodeConfigResponse4 nodeConfig;
  ...
  final PrivateClusterConfigResponse3 privateClusterConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['nodePools'] = Input.encodeList<NodePoolResponse, Map<String, dynamic>>(
  ...
  factory GetClusterResult5.fromMap(Map<String, dynamic> map) {
    return GetClusterResult5(
      ...
      ipAllocationPolicy: IPAllocationPolicyResponse3.fromMap(
      ...
      masterAuthorizedNetworksConfig:
          MasterAuthorizedNetworksConfigResponse3.fromMap(
      ...
      networkConfig: NetworkConfigResponse9.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      networkPolicy: NetworkPolicyResponse2.fromMap(
          (map['networkPolicy'] as Map).cast<String, dynamic>()),
      nodeConfig: NodeConfigResponse4.fromMap(
      ...
      nodePools: Input.decodeList<NodePoolResponse>(
          map['nodePools'],
          (value) =>
      ...
      privateClusterConfig: PrivateClusterConfigResponse3.fromMap(
