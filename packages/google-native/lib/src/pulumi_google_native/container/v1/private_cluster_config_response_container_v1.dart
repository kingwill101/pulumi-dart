...
class PrivateClusterConfigResponseContainerV1 {
  ...
  PrivateClusterConfigResponseContainerV1({
  ...
  factory PrivateClusterConfigResponseContainerV1.fromMap(
      Map<String, dynamic> map) {
    return PrivateClusterConfigResponseContainerV1(
