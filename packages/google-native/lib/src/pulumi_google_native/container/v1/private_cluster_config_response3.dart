...
class PrivateClusterConfigResponse3 {
  ...
  factory PrivateClusterConfigResponse3.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfigResponse3(
