...
class MaintenanceWindowResponseContainerV1 {
  ...
  MaintenanceWindowResponseContainerV1({
  ...
  factory MaintenanceWindowResponseContainerV1.fromMap(
      Map<String, dynamic> map) {
    return MaintenanceWindowResponseContainerV1(
