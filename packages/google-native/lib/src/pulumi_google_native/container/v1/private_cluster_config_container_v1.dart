...
class PrivateClusterConfigContainerV1 {
  ...
  PrivateClusterConfigContainerV1({
  ...
  factory PrivateClusterConfigContainerV1.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfigContainerV1(
      ...
      masterGlobalAccessConfig: map['masterGlobalAccessConfig'] == null
          ? null
          : PrivateClusterMasterGlobalAccessConfig.fromMap(
