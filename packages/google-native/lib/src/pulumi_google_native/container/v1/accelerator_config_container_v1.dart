...
class AcceleratorConfigContainerV1 {
  ...
  factory AcceleratorConfigContainerV1.fromMap(Map<String, dynamic> map) {
    return AcceleratorConfigContainerV1(
      ...
      gpuDriverInstallationConfig: map['gpuDriverInstallationConfig'] == null
          ? null
          : GPUDriverInstallationConfig.fromMap(
