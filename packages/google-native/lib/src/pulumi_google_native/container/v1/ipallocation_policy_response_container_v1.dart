...
class IPAllocationPolicyResponseContainerV1 {
  ...
  IPAllocationPolicyResponseContainerV1({
  ...
  factory IPAllocationPolicyResponseContainerV1.fromMap(
      Map<String, dynamic> map) {
    return IPAllocationPolicyResponseContainerV1(
