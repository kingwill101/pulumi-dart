...
class AutoprovisioningNodePoolDefaultsResponse2 {
  ...
  AutoprovisioningNodePoolDefaultsResponse2({
  ...
  factory AutoprovisioningNodePoolDefaultsResponse2.fromMap(
      Map<String, dynamic> map) {
    return AutoprovisioningNodePoolDefaultsResponse2(
