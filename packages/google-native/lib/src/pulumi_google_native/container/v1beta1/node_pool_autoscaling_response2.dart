...
class NodePoolAutoscalingResponse2 {
  ...
  factory NodePoolAutoscalingResponse2.fromMap(Map<String, dynamic> map) {
    return NodePoolAutoscalingResponse2(
