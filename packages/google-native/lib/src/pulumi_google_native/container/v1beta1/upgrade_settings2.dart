...
import 'blue_green_settings2.dart';
import 'upgrade_settings_strategy2.dart';
...
class UpgradeSettings2 {
  /// Settings for blue-green upgrade strategy.
  final BlueGreenSettings2? blueGreenSettings;
  ...
  final UpgradeSettingsStrategy2? strategy;
  ...
  factory UpgradeSettings2.fromMap(Map<String, dynamic> map) {
    return UpgradeSettings2(
      blueGreenSettings: map['blueGreenSettings'] == null
          ? null
          : BlueGreenSettings2.fromMap(
      ...
      strategy: map['strategy'] == null
          ? null
          : UpgradeSettingsStrategy2.fromValue(map['strategy'] as String),
    );
  }
}
