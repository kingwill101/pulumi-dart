...
import 'accelerator_config5.dart';
import 'advanced_machine_features5.dart';
import 'confidential_nodes2.dart';
import 'ephemeral_storage_config.dart';
import 'ephemeral_storage_local_ssd_config2.dart';
import 'fast_socket2.dart';
import 'gcfs_config2.dart';
import 'host_maintenance_policy.dart';
import 'linux_node_config2.dart';
import 'local_nvme_ssd_block_config2.dart';
import 'node_kubelet_config2.dart';
import 'node_pool_logging_config2.dart';
import 'node_taint2.dart';
import 'reservation_affinity5.dart';
import 'resource_manager_tags2.dart';
import 'sandbox_config2.dart';
import 'shielded_instance_config5.dart';
import 'sole_tenant_config2.dart';
import 'virtual_nic2.dart';
import 'windows_node_config2.dart';
import 'workload_metadata_config2.dart';

/// Parameters that describe the nodes in a cluster. GKE Autopilot clusters do not recognize parameters in `NodeConfig`. Use AutoprovisioningNodePoolDefaults instead.
class NodeConfig5 {
  /// A list of hardware accelerators to be attached to each node. See https://cloud.google.com/compute/docs/gpus for more information about support for GPUs.
  final List<AcceleratorConfig5>? accelerators;

  /// Advanced features for the Compute Engine VM.
  final AdvancedMachineFeatures5? advancedMachineFeatures;

  /// The Customer Managed Encryption Key used to encrypt the boot disk attached to each node in the node pool. This should be of the form projects/[KEY_PROJECT_ID]/locations/[LOCATION]/keyRings/[RING_NAME]/cryptoKeys/[KEY_NAME]. For more information about protecting resources with Cloud KMS Keys please see: https://cloud.google.com/compute/docs/disks/customer-managed-encryption
  final String? bootDiskKmsKey;

  /// Confidential nodes config. All the nodes in the node pool will be Confidential VM once enabled.
  final ConfidentialNodes2? confidentialNodes;
  ...
  final EphemeralStorageLocalSsdConfig2? ephemeralStorageLocalSsdConfig;

  /// Enable or disable NCCL fast socket for the node pool.
  final FastSocket2? fastSocket;

  /// GCFS (Google Container File System) configs.
  final GcfsConfig2? gcfsConfig;

  /// Enable or disable gvnic on the node pool.
  final VirtualNIC2? gvnic;
  ...
  final NodeKubeletConfig2? kubeletConfig;

  /// The map of Kubernetes labels (key/value pairs) to be applied to each node. These will added in addition to any default label(s) that Kubernetes may apply to the node. In case of conflict in label keys, the applied set may differ depending on the Kubernetes version -- it's best to assume the behavior is undefined and conflicts should be avoided. For more information, including usage and the valid values, see: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/
  final Map<String, String>? labels;

  /// Parameters that can be configured on Linux nodes.
  final LinuxNodeConfig2? linuxNodeConfig;

  /// Parameters for using raw-block Local NVMe SSDs.
  final LocalNvmeSsdBlockConfig2? localNvmeSsdBlockConfig;
  ...
  final ReservationAffinity5? reservationAffinity;
  ...
  final SandboxConfig2? sandboxConfig;
  ...
  final SoleTenantConfig2? soleTenantConfig;
  ...
  final WindowsNodeConfig2? windowsNodeConfig;

  /// The workload metadata configuration for this node.
  final WorkloadMetadataConfig2? workloadMetadataConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (acceleratorsValue != null) {
      map['accelerators'] =
          Input.encodeList<AcceleratorConfig5, Map<String, dynamic>>(
  ...
  factory NodeConfig5.fromMap(Map<String, dynamic> map) {
    return NodeConfig5(
      accelerators: map['accelerators'] == null
          ? null
          : Input.decodeList<AcceleratorConfig5>(
              map['accelerators'],
              (value) => AcceleratorConfig5.fromMap(
                  (value as Map).cast<String, dynamic>())),
      advancedMachineFeatures: map['advancedMachineFeatures'] == null
          ? null
          : AdvancedMachineFeatures5.fromMap(
      ...
      ephemeralStorageLocalSsdConfig:
          map['ephemeralStorageLocalSsdConfig'] == null
              ? null
              : EphemeralStorageLocalSsdConfig2.fromMap(
      ...
      gvnic: map['gvnic'] == null
          ? null
          : VirtualNIC2.fromMap((map['gvnic'] as Map).cast<String, dynamic>()),
