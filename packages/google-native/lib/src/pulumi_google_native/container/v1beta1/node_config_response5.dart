...
import 'accelerator_config_response5.dart';
import 'advanced_machine_features_response5.dart';
import 'confidential_nodes_response2.dart';
import 'ephemeral_storage_config_response.dart';
import 'ephemeral_storage_local_ssd_config_response2.dart';
import 'fast_socket_response2.dart';
import 'gcfs_config_response2.dart';
import 'host_maintenance_policy_response.dart';
import 'linux_node_config_response2.dart';
import 'local_nvme_ssd_block_config_response2.dart';
import 'node_kubelet_config_response2.dart';
import 'node_pool_logging_config_response2.dart';
import 'node_taint_response2.dart';
import 'reservation_affinity_response5.dart';
import 'resource_manager_tags_response2.dart';
import 'sandbox_config_response2.dart';
import 'shielded_instance_config_response5.dart';
import 'sole_tenant_config_response2.dart';
import 'virtual_nicresponse2.dart';
import 'windows_node_config_response2.dart';
import 'workload_metadata_config_response2.dart';

/// Parameters that describe the nodes in a cluster. GKE Autopilot clusters do not recognize parameters in `NodeConfig`. Use AutoprovisioningNodePoolDefaults instead.
class NodeConfigResponse5 {
  /// A list of hardware accelerators to be attached to each node. See https://cloud.google.com/compute/docs/gpus for more information about support for GPUs.
  final List<AcceleratorConfigResponse5> accelerators;

  /// Advanced features for the Compute Engine VM.
  final AdvancedMachineFeaturesResponse5 advancedMachineFeatures;
  ...
  final EphemeralStorageLocalSsdConfigResponse2 ephemeralStorageLocalSsdConfig;

  /// Enable or disable NCCL fast socket for the node pool.
  final FastSocketResponse2 fastSocket;

  /// GCFS (Google Container File System) configs.
  final GcfsConfigResponse2 gcfsConfig;

  /// Enable or disable gvnic on the node pool.
  final VirtualNICResponse2 gvnic;
  ...
  final NodeKubeletConfigResponse2 kubeletConfig;

  /// The map of Kubernetes labels (key/value pairs) to be applied to each node. These will added in addition to any default label(s) that Kubernetes may apply to the node. In case of conflict in label keys, the applied set may differ depending on the Kubernetes version -- it's best to assume the behavior is undefined and conflicts should be avoided. For more information, including usage and the valid values, see: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/
  final Map<String, String> labels;

  /// Parameters that can be configured on Linux nodes.
  final LinuxNodeConfigResponse2 linuxNodeConfig;

  /// Parameters for using raw-block Local NVMe SSDs.
  final LocalNvmeSsdBlockConfigResponse2 localNvmeSsdBlockConfig;
  ...
  final ReservationAffinityResponse5 reservationAffinity;
  ...
  final SandboxConfigResponse2 sandboxConfig;

  /// The Google Cloud Platform Service Account to be used by the node VMs. Specify the email address of the Service Account; otherwise, if no Service Account is specified, the "default" service account is used.
  final String serviceAccount;

  /// Shielded Instance options.
  final ShieldedInstanceConfigResponse5 shieldedInstanceConfig;

  /// Parameters for node pools to be backed by shared sole tenant node groups.
  final SoleTenantConfigResponse2 soleTenantConfig;
  ...
  final List<NodeTaintResponse2> taints;

  /// Parameters that can be configured on Windows nodes.
  final WindowsNodeConfigResponse2 windowsNodeConfig;

  /// The workload metadata configuration for this node.
  final WorkloadMetadataConfigResponse2 workloadMetadataConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['accelerators'] =
        Input.encodeList<AcceleratorConfigResponse5, Map<String, dynamic>>(
    ...
    map['spot'] = spot;
    map['tags'] = tags;
    map['taints'] = Input.encodeList<NodeTaintResponse2, Map<String, dynamic>>(
  ...
  factory NodeConfigResponse5.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponse5(
      accelerators: Input.decodeList<AcceleratorConfigResponse5>(
          map['accelerators'],
          (value) => AcceleratorConfigResponse5.fromMap(
              (value as Map).cast<String, dynamic>())),
      advancedMachineFeatures: AdvancedMachineFeaturesResponse5.fromMap(
      ...
      kubeletConfig: NodeKubeletConfigResponse2.fromMap(
          (map['kubeletConfig'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      linuxNodeConfig: LinuxNodeConfigResponse2.fromMap(
          (map['linuxNodeConfig'] as Map).cast<String, dynamic>()),
      localNvmeSsdBlockConfig: LocalNvmeSsdBlockConfigResponse2.fromMap(
      ...
      reservationAffinity: ReservationAffinityResponse5.fromMap(
      ...
      sandboxConfig: SandboxConfigResponse2.fromMap(
          (map['sandboxConfig'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      shieldedInstanceConfig: ShieldedInstanceConfigResponse5.fromMap(
          (map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      soleTenantConfig: SoleTenantConfigResponse2.fromMap(
          (map['soleTenantConfig'] as Map).cast<String, dynamic>()),
      spot: map['spot'] as bool,
      tags: (map['tags'] as List).cast<String>(),
      taints: Input.decodeList<NodeTaintResponse2>(
          map['taints'],
          (value) => NodeTaintResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      windowsNodeConfig: WindowsNodeConfigResponse2.fromMap(
          (map['windowsNodeConfig'] as Map).cast<String, dynamic>()),
      workloadMetadataConfig: WorkloadMetadataConfigResponse2.fromMap(
