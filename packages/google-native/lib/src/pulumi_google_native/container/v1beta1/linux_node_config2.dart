...
import 'linux_node_config_cgroup_mode2.dart';

/// Parameters that can be configured on Linux nodes.
class LinuxNodeConfig2 {
  /// cgroup_mode specifies the cgroup mode to be used on the node.
  final LinuxNodeConfigCgroupMode2? cgroupMode;
  ...
  factory LinuxNodeConfig2.fromMap(Map<String, dynamic> map) {
    return LinuxNodeConfig2(
      cgroupMode: map['cgroupMode'] == null
          ? null
          : LinuxNodeConfigCgroupMode2.fromValue(map['cgroupMode'] as String),
