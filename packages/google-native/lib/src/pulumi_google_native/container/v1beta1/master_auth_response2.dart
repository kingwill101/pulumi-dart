...
import 'client_certificate_config_response2.dart';

/// The authentication information for accessing the master endpoint. Authentication can be done using HTTP basic auth or using client certificates.
class MasterAuthResponse2 {
  /// [Output only] Base64-encoded public certificate used by clients to authenticate to the cluster endpoint.
  final String clientCertificate;

  /// Configuration for client certificate authentication on the cluster. For clusters before v1.12, if no configuration is specified, a client certificate is issued.
  final ClientCertificateConfigResponse2 clientCertificateConfig;
  ...
  factory MasterAuthResponse2.fromMap(Map<String, dynamic> map) {
    return MasterAuthResponse2(
      clientCertificate: map['clientCertificate'] as String,
      clientCertificateConfig: ClientCertificateConfigResponse2.fromMap(
