...
class ClusterContainerV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<MasterAuthorizedNetworksConfigResponseContainerV1beta1>
  ...
  ClusterContainerV1beta1(
    ...
    this.addonsConfig =
        registerOutput<AddonsConfigResponseContainerV1beta1>('addonsConfig');
    this.authenticatorGroupsConfig =
        registerOutput<AuthenticatorGroupsConfigResponseContainerV1beta1>(
            'authenticatorGroupsConfig');
    this.autopilot =
        registerOutput<AutopilotResponseContainerV1beta1>('autopilot');
    this.autoscaling =
        registerOutput<ClusterAutoscalingResponseContainerV1beta1>(
            'autoscaling');
    ...
    this.enterpriseConfig =
        registerOutput<EnterpriseConfigResponseContainerV1beta1>(
            'enterpriseConfig');
    ...
    this.legacyAbac =
        registerOutput<LegacyAbacResponseContainerV1beta1>('legacyAbac');
    this.location = registerOutput<String>('location');
    this.locations = registerOutput<List<String>>('locations');
    this.loggingConfig =
        registerOutput<LoggingConfigResponseContainerV1beta1>('loggingConfig');
    ...
    this.masterAuth =
        registerOutput<MasterAuthResponseContainerV1beta1>('masterAuth');
    ...
    this.meshCertificates =
        registerOutput<MeshCertificatesResponseContainerV1beta1>(
            'meshCertificates');
    this.monitoringConfig =
        registerOutput<MonitoringConfigResponseContainerV1beta1>(
            'monitoringConfig');
    this.monitoringService = registerOutput<String>('monitoringService');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig =
        registerOutput<NetworkConfigResponseContainerV1beta1>('networkConfig');
    this.networkPolicy =
        registerOutput<NetworkPolicyResponseContainerV1beta1>('networkPolicy');
    this.nodeConfig =
        registerOutput<NodeConfigResponseContainerV1beta1>('nodeConfig');
    ...
    this.nodePoolDefaults =
        registerOutput<NodePoolDefaultsResponseContainerV1beta1>(
            'nodePoolDefaults');
    this.nodePools =
        registerOutput<List<NodePoolResponseContainerV1beta1>>('nodePools');
    ...
    this.releaseChannel =
        registerOutput<ReleaseChannelResponseContainerV1beta1>(
            'releaseChannel');
    ...
    this.shieldedNodes =
        registerOutput<ShieldedNodesResponseContainerV1beta1>('shieldedNodes');
