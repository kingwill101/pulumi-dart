...
class MaintenancePolicy2 {
  ...
  factory MaintenancePolicy2.fromMap(Map<String, dynamic> map) {
    return MaintenancePolicy2(
      resourceVersion: map['resourceVersion'] == null
          ? null
          : map['resourceVersion'] as String,
      window: map['window'] == null
          ? null
          : MaintenanceWindow4.fromMap(
