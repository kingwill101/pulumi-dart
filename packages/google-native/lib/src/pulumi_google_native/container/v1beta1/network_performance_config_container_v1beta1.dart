...
import 'network_performance_config_external_ip_egress_bandwidth_tier_container_v1beta1.dart';
...
class NetworkPerformanceConfigContainerV1beta1 {
  ...
  final NetworkPerformanceConfigExternalIpEgressBandwidthTierContainerV1beta1?
  ...
  factory NetworkPerformanceConfigContainerV1beta1.fromMap(
    ...
    return NetworkPerformanceConfigContainerV1beta1(
      externalIpEgressBandwidthTier: map['externalIpEgressBandwidthTier'] ==
              null
          ? null
          : NetworkPerformanceConfigExternalIpEgressBandwidthTierContainerV1beta1
              .fromValue(map['externalIpEgressBandwidthTier'] as String),
