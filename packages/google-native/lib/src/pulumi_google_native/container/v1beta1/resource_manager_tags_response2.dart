...
class ResourceManagerTagsResponse2 {
  ...
  factory ResourceManagerTagsResponse2.fromMap(Map<String, dynamic> map) {
    return ResourceManagerTagsResponse2(
