...
class ClusterAutoscaling2 {
  /// The list of Google Compute Engine [zones](https://cloud.google.com/compute/docs/zones#available) in which the NodePool's nodes can be created by NAP.
  final List<String>? autoprovisioningLocations;

  /// AutoprovisioningNodePoolDefaults contains defaults for a node pool created by NAP.
  final AutoprovisioningNodePoolDefaults2? autoprovisioningNodePoolDefaults;

  /// Defines autoscaling behaviour.
  final ClusterAutoscalingAutoscalingProfile2? autoscalingProfile;

  /// Enables automatic node pool creation and deletion.
  final bool? enableNodeAutoprovisioning;

  /// Contains global constraints regarding minimum and maximum amount of resources in the cluster.
  final List<ResourceLimit2>? resourceLimits;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (resourceLimitsValue != null) {
      map['resourceLimits'] =
          Input.encodeList<ResourceLimit2, Map<String, dynamic>>(
              resourceLimitsValue, (value) => value.toMap());
    }
    return map;
  }

  factory ClusterAutoscaling2.fromMap(Map<String, dynamic> map) {
    return ClusterAutoscaling2(
      ...
      resourceLimits: map['resourceLimits'] == null
          ? null
          : Input.decodeList<ResourceLimit2>(
              map['resourceLimits'],
              (value) => ResourceLimit2.fromMap(
