...
class NodeNetworkConfigContainerV1beta1 {
  ...
  final List<AdditionalNodeNetworkConfigContainerV1beta1>?
      additionalNodeNetworkConfigs;

  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final List<AdditionalPodNetworkConfigContainerV1beta1>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (additionalPodNetworkConfigsValue != null) {
      map['additionalPodNetworkConfigs'] = pulumi.Input.encodeList<
              AdditionalPodNetworkConfigContainerV1beta1, Map<String, dynamic>>(
