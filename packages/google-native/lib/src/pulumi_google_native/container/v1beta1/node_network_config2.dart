...
class NodeNetworkConfig2 {
  /// We specify the additional node networks for this node pool using this list. Each node network corresponds to an additional interface
  final List<AdditionalNodeNetworkConfig2>? additionalNodeNetworkConfigs;

  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final List<AdditionalPodNetworkConfig2>? additionalPodNetworkConfigs;
  ...
  final NetworkPerformanceConfig5? networkPerformanceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (additionalNodeNetworkConfigsValue != null) {
      map['additionalNodeNetworkConfigs'] =
          Input.encodeList<AdditionalNodeNetworkConfig2, Map<String, dynamic>>(
    ...
    if (additionalPodNetworkConfigsValue != null) {
      map['additionalPodNetworkConfigs'] =
          Input.encodeList<AdditionalPodNetworkConfig2, Map<String, dynamic>>(
  ...
  factory NodeNetworkConfig2.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfig2(
      additionalNodeNetworkConfigs: map['additionalNodeNetworkConfigs'] == null
          ? null
          : Input.decodeList<AdditionalNodeNetworkConfig2>(
              map['additionalNodeNetworkConfigs'],
              (value) => AdditionalNodeNetworkConfig2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      additionalPodNetworkConfigs: map['additionalPodNetworkConfigs'] == null
          ? null
          : Input.decodeList<AdditionalPodNetworkConfig2>(
              map['additionalPodNetworkConfigs'],
              (value) => AdditionalPodNetworkConfig2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      createPodRange:
      ...
      networkPerformanceConfig: map['networkPerformanceConfig'] == null
          ? null
          : NetworkPerformanceConfig5.fromMap(
