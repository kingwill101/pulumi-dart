...
import 'ipallocation_policy_ipv6_access_type2.dart';
import 'ipallocation_policy_stack_type2.dart';
import 'pod_cidroverprovision_config2.dart';

/// Configuration for controlling how IPs are allocated in the cluster.
class IPAllocationPolicy4 {
  ...
  final IPAllocationPolicyIpv6AccessType2? ipv6AccessType;
  ...
  final PodCIDROverprovisionConfig2? podCidrOverprovisionConfig;
  ...
  /// IP stack type
  final IPAllocationPolicyStackType2? stackType;
  ...
  Map<String, dynamic> toMap() {
    ...
    final allowRouteOverlapValue = allowRouteOverlap;
    if (allowRouteOverlapValue != null) {
      map['allowRouteOverlap'] = allowRouteOverlapValue;
    }
  ...
  factory IPAllocationPolicy4.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicy4(
      ...
      ipv6AccessType: map['ipv6AccessType'] == null
          ? null
          : IPAllocationPolicyIpv6AccessType2.fromValue(
      ...
      podCidrOverprovisionConfig: map['podCidrOverprovisionConfig'] == null
          ? null
          : PodCIDROverprovisionConfig2.fromMap(
      ...
      stackType: map['stackType'] == null
          ? null
          : IPAllocationPolicyStackType2.fromValue(map['stackType'] as String),
