...
import 'blue_green_settings_response2.dart';
...
class UpgradeSettingsResponse2 {
  /// Settings for blue-green upgrade strategy.
  final BlueGreenSettingsResponse2 blueGreenSettings;
  ...
  factory UpgradeSettingsResponse2.fromMap(Map<String, dynamic> map) {
    return UpgradeSettingsResponse2(
      blueGreenSettings: BlueGreenSettingsResponse2.fromMap(
