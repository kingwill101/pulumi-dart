...
import 'private_cluster_master_global_access_config2.dart';

/// Configuration options for private clusters.
class PrivateClusterConfig4 {
  ...
  final PrivateClusterMasterGlobalAccessConfig2? masterGlobalAccessConfig;
  ...
  factory PrivateClusterConfig4.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfig4(
      ...
      masterGlobalAccessConfig: map['masterGlobalAccessConfig'] == null
          ? null
          : PrivateClusterMasterGlobalAccessConfig2.fromMap(
