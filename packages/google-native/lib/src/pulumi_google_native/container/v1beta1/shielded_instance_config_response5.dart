...
class ShieldedInstanceConfigResponse5 {
  ...
  ShieldedInstanceConfigResponse5({
  ...
  factory ShieldedInstanceConfigResponse5.fromMap(Map<String, dynamic> map) {
    return ShieldedInstanceConfigResponse5(
