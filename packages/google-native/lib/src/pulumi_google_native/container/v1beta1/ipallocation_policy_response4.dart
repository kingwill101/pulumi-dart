...
import 'additional_pod_ranges_config_response2.dart';
import 'pod_cidroverprovision_config_response2.dart';

/// Configuration for controlling how IPs are allocated in the cluster.
class IPAllocationPolicyResponse4 {
  ...
  final AdditionalPodRangesConfigResponse2 additionalPodRangesConfig;
  ...
  factory IPAllocationPolicyResponse4.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyResponse4(
      additionalPodRangesConfig: AdditionalPodRangesConfigResponse2.fromMap(
