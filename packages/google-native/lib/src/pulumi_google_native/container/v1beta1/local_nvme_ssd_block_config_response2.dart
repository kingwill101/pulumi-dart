...
class LocalNvmeSsdBlockConfigResponse2 {
  ...
  LocalNvmeSsdBlockConfigResponse2({
  ...
  factory LocalNvmeSsdBlockConfigResponse2.fromMap(Map<String, dynamic> map) {
    return LocalNvmeSsdBlockConfigResponse2(
