...
import 'cluster_network_performance_config_response2.dart';
import 'default_snat_status_response2.dart';
import 'dnsconfig_response2.dart';
import 'gateway_apiconfig_response2.dart';
import 'service_external_ips_config_response2.dart';

/// NetworkConfig reports the relative names of network & subnetwork.
class NetworkConfigResponse10 {
  /// The desired datapath provider for this cluster. By default, uses the IPTables-based kube-proxy implementation.
  final String datapathProvider;

  /// Whether the cluster disables default in-node sNAT rules. In-node sNAT rules will be disabled when default_snat_status is disabled. When disabled is set to false, default IP masquerade rules will be applied to the nodes to prevent sNAT on cluster internal traffic.
  final DefaultSnatStatusResponse2 defaultSnatStatus;

  /// DNSConfig contains clusterDNS config for this cluster.
  final DNSConfigResponse2 dnsConfig;
  ...
  final GatewayAPIConfigResponse2 gatewayApiConfig;
  ...
  final ClusterNetworkPerformanceConfigResponse2 networkPerformanceConfig;

  /// The desired state of IPv6 connectivity to Google Services. By default, no private IPv6 access to or from Google Services (all access will be via IPv4)
  final String privateIpv6GoogleAccess;

  /// ServiceExternalIPsConfig specifies if services with externalIPs field are blocked or not.
  final ServiceExternalIPsConfigResponse2 serviceExternalIpsConfig;
  ...
  factory NetworkConfigResponse10.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponse10(
      datapathProvider: map['datapathProvider'] as String,
      defaultSnatStatus: DefaultSnatStatusResponse2.fromMap(
          (map['defaultSnatStatus'] as Map).cast<String, dynamic>()),
      dnsConfig: DNSConfigResponse2.fromMap(
      ...
      gatewayApiConfig: GatewayAPIConfigResponse2.fromMap(
