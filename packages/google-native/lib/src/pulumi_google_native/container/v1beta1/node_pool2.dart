...
class NodePool2 {
  ...
  final NodePoolAutoscaling2? autoscaling;

  /// Enable best effort provisioning for nodes
  final BestEffortProvisioning2? bestEffortProvisioning;

  /// Which conditions caused the current node pool state.
  final List<StatusCondition2>? conditions;

  /// The node configuration of the pool.
  final NodeConfig5? config;
  ...
  final MaxPodsConstraint2? maxPodsConstraint;

  /// The name of the node pool.
  final String? name;

  /// Networking configuration for this NodePool. If specified, it overrides the cluster-level defaults.
  final NodeNetworkConfig2? networkConfig;

  /// Specifies the node placement policy.
  final PlacementPolicy3? placementPolicy;

  /// Specifies the configuration of queued provisioning.
  final QueuedProvisioning2? queuedProvisioning;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionsValue != null) {
      map['conditions'] =
          Input.encodeList<StatusCondition2, Map<String, dynamic>>(
  ...
  factory NodePool2.fromMap(Map<String, dynamic> map) {
    return NodePool2(
      ...
      bestEffortProvisioning: map['bestEffortProvisioning'] == null
          ? null
          : BestEffortProvisioning2.fromMap(
              (map['bestEffortProvisioning'] as Map).cast<String, dynamic>()),
      conditions: map['conditions'] == null
          ? null
          : Input.decodeList<StatusCondition2>(
              map['conditions'],
              (value) => StatusCondition2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      config: map['config'] == null
          ? null
          : NodeConfig5.fromMap((map['config'] as Map).cast<String, dynamic>()),
