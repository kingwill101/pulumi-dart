...
class GetPolicyOrgpolicyV2Result {
  /// Deprecated.
  ...
  factory GetPolicyOrgpolicyV2Result.fromMap(Map<String, dynamic> map) {
    return GetPolicyOrgpolicyV2Result(
