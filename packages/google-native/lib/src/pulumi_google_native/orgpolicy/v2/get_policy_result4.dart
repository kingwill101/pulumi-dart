...
class GetPolicyResult4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['alternate'] = alternate.toMap();
    map['dryRunSpec'] = dryRunSpec.toMap();
    map['name'] = name;
    map['spec'] = spec.toMap();
    return map;
  }

  factory GetPolicyResult4.fromMap(Map<String, dynamic> map) {
    return GetPolicyResult4(
