...
class SqlScheduledMaintenanceResponse2 {
  final bool canDefer;
  ...
  SqlScheduledMaintenanceResponse2({
  ...
  factory SqlScheduledMaintenanceResponse2.fromMap(Map<String, dynamic> map) {
    return SqlScheduledMaintenanceResponse2(
