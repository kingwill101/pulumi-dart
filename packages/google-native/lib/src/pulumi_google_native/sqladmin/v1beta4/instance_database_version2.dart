...
enum InstanceDatabaseVersion2 {
  ...
  const InstanceDatabaseVersion2(this.value);
  final String value;

  static InstanceDatabaseVersion2 fromValue(String value) {
    for (final item in InstanceDatabaseVersion2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown InstanceDatabaseVersion2 value: $value');
  }
}
