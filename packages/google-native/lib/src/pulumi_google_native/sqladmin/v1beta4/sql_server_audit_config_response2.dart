...
class SqlServerAuditConfigResponse2 {
  ...
  factory SqlServerAuditConfigResponse2.fromMap(Map<String, dynamic> map) {
    return SqlServerAuditConfigResponse2(
