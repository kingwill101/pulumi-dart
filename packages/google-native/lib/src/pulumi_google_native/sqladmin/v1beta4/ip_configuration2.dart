...
import 'acl_entry2.dart';
import 'ip_configuration_ssl_mode2.dart';
import 'psc_config6.dart';

/// IP Management configuration.
class IpConfiguration2 {
  ...
  final List<AclEntry2>? authorizedNetworks;
  ...
  final IpConfigurationSslMode2? sslMode;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (authorizedNetworksValue != null) {
      map['authorizedNetworks'] =
          Input.encodeList<AclEntry2, Map<String, dynamic>>(
  ...
  factory IpConfiguration2.fromMap(Map<String, dynamic> map) {
    return IpConfiguration2(
      ...
      authorizedNetworks: map['authorizedNetworks'] == null
          ? null
          : Input.decodeList<AclEntry2>(
              map['authorizedNetworks'],
              (value) =>
                  AclEntry2.fromMap((value as Map).cast<String, dynamic>())),
      enablePrivatePathForGoogleCloudServices:
      ...
      sslMode: map['sslMode'] == null
          ? null
          : IpConfigurationSslMode2.fromValue(map['sslMode'] as String),
    );
  }
}
