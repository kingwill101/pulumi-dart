...
import 'acl_entry_response2.dart';
import 'psc_config_response6.dart';

/// IP Management configuration.
class IpConfigurationResponse2 {
  ...
  final List<AclEntryResponse2> authorizedNetworks;
  ...
  final PscConfigResponse6 pscConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['authorizedNetworks'] =
        Input.encodeList<AclEntryResponse2, Map<String, dynamic>>(
  ...
  factory IpConfigurationResponse2.fromMap(Map<String, dynamic> map) {
    return IpConfigurationResponse2(
      allocatedIpRange: map['allocatedIpRange'] as String,
      authorizedNetworks: Input.decodeList<AclEntryResponse2>(
          map['authorizedNetworks'],
          (value) => AclEntryResponse2.fromMap(
      ...
      pscConfig: PscConfigResponse6.fromMap(
