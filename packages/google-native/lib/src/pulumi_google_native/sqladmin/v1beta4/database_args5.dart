...
import 'sql_server_database_details2.dart';
...
class DatabaseArgs5 {
  ...
  final Input<SqlServerDatabaseDetails2>? sqlserverDatabaseDetails;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sqlserverDatabaseDetailsValue != null) {
      map['sqlserverDatabaseDetails'] = Input.mapOptionalInputValue<
              SqlServerDatabaseDetails2, Map<String, dynamic>>(
          sqlserverDatabaseDetailsValue, (value) => value.toMap());
    }
    return map;
  }

  factory DatabaseArgs5.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs5(
      ...
      sqlserverDatabaseDetails:
          Input.asOptionalInput<SqlServerDatabaseDetails2>(
