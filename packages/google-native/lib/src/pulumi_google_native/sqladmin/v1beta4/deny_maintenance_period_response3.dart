...
class DenyMaintenancePeriodResponse3 {
  ...
  DenyMaintenancePeriodResponse3({
  ...
  factory DenyMaintenancePeriodResponse3.fromMap(Map<String, dynamic> map) {
    return DenyMaintenancePeriodResponse3(
