...
class BackupRun2 extends CustomResource {
  ...
  late final Output<OperationErrorResponse5> error;
  ...
  BackupRun2(
    ...
    this.error = registerOutput<OperationErrorResponse5>('error');
