...
import 'maintenance_window_update_track2.dart';

/// Maintenance window. This specifies when a Cloud SQL instance is restarted for system maintenance purposes.
class MaintenanceWindow10 {
  ...
  final MaintenanceWindowUpdateTrack2? updateTrack;
  ...
  factory MaintenanceWindow10.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindow10(
      day: map['day'] == null ? null : map['day'] as int,
      hour: map['hour'] == null ? null : map['hour'] as int,
      kind: map['kind'] == null ? null : map['kind'] as String,
      updateTrack: map['updateTrack'] == null
          ? null
          : MaintenanceWindowUpdateTrack2.fromValue(
