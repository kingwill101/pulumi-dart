...
import 'user_type2.dart';

/// The set of arguments for User.
class UserArgs5 {
  /// Dual password status for the user.
  final Input<UserDualPasswordType2>? dualPasswordType;
  ...
  final Input<UserPasswordValidationPolicy2>? passwordPolicy;

  /// The project ID of the project containing the Cloud SQL database. The Google apps domain is prefixed if applicable. Can be omitted for *update* because it is already specified on the URL.
  final Input<String>? project;
  final Input<SqlServerUserDetails2>? sqlserverUserDetails;

  /// The user type. It determines the method to authenticate the user during login. The default is the database's built-in user type.
  final Input<UserType2>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (dualPasswordTypeValue != null) {
      map['dualPasswordType'] =
          Input.mapOptionalInputValue<UserDualPasswordType2, String>(
    ...
    if (sqlserverUserDetailsValue != null) {
      map['sqlserverUserDetails'] = Input.mapOptionalInputValue<
              SqlServerUserDetails2, Map<String, dynamic>>(
          sqlserverUserDetailsValue, (value) => value.toMap());
    }
    final typeValue = type;
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<UserType2, String>(
  ...
  factory UserArgs5.fromMap(Map<String, dynamic> map) {
    return UserArgs5(
      dualPasswordType:
          Input.asOptionalInput<UserDualPasswordType2>(map['dualPasswordType']),
      ...
      passwordPolicy: Input.asOptionalInput<UserPasswordValidationPolicy2>(
          map['passwordPolicy']),
      project: Input.asOptionalInput<String>(map['project']),
      sqlserverUserDetails: Input.asOptionalInput<SqlServerUserDetails2>(
          map['sqlserverUserDetails']),
      type: Input.asOptionalInput<UserType2>(map['type']),
    );
  }
}
