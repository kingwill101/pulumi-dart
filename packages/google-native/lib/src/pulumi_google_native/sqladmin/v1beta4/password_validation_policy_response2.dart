...
class PasswordValidationPolicyResponse2 {
  ...
  PasswordValidationPolicyResponse2({
  ...
  factory PasswordValidationPolicyResponse2.fromMap(Map<String, dynamic> map) {
    return PasswordValidationPolicyResponse2(
