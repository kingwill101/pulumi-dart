...
import 'advanced_machine_features_response7.dart';
import 'backup_configuration_response2.dart';
import 'data_cache_config_response3.dart';
import 'database_flags_response2.dart';
import 'deny_maintenance_period_response3.dart';
import 'insights_config_response2.dart';
import 'ip_configuration_response2.dart';
import 'location_preference_response2.dart';
import 'maintenance_window_response10.dart';
import 'password_validation_policy_response2.dart';
import 'sql_active_directory_config_response2.dart';
import 'sql_server_audit_config_response2.dart';
...
class SettingsResponse2 {
  ...
  final SqlActiveDirectoryConfigResponse2 activeDirectoryConfig;

  /// Specifies advance machine configuration for the instance relevant only for SQL Server.
  final AdvancedMachineFeaturesResponse7 advancedMachineFeatures;
  ...
  final BackupConfigurationResponse2 backupConfiguration;
  ...
  final DataCacheConfigResponse3 dataCacheConfig;
  ...
  final List<DatabaseFlagsResponse2> databaseFlags;
  ...
  final List<DenyMaintenancePeriodResponse3> denyMaintenancePeriods;

  /// Optional. The edition of the instance.
  final String edition;

  /// Insights configuration, for now relevant only for Postgres.
  final InsightsConfigResponse2 insightsConfig;

  /// The settings for IP Management. This allows to enable or disable the instance IP and manage which external networks can connect to the instance. The IPv4 address cannot be disabled for Second Generation instances.
  final IpConfigurationResponse2 ipConfiguration;

  /// This is always `sql#settings`.
  final String kind;

  /// The location preference settings. This allows the instance to be located as near as possible to either an App Engine app or Compute Engine zone for better performance. App Engine co-location was only applicable to First Generation instances.
  final LocationPreferenceResponse2 locationPreference;

  /// The maintenance window for this instance. This specifies when the instance can be restarted for maintenance purposes.
  final MaintenanceWindowResponse10 maintenanceWindow;

  /// The local user password validation policy of the instance.
  final PasswordValidationPolicyResponse2 passwordValidationPolicy;
  ...
  final SqlServerAuditConfigResponse2 sqlServerAuditConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['databaseFlags'] =
        Input.encodeList<DatabaseFlagsResponse2, Map<String, dynamic>>(
    ...
    map['denyMaintenancePeriods'] =
        Input.encodeList<DenyMaintenancePeriodResponse3, Map<String, dynamic>>(
  ...
  factory SettingsResponse2.fromMap(Map<String, dynamic> map) {
    return SettingsResponse2(
      activationPolicy: map['activationPolicy'] as String,
      activeDirectoryConfig: SqlActiveDirectoryConfigResponse2.fromMap(
          (map['activeDirectoryConfig'] as Map).cast<String, dynamic>()),
      advancedMachineFeatures: AdvancedMachineFeaturesResponse7.fromMap(
      ...
      backupConfiguration: BackupConfigurationResponse2.fromMap(
      ...
      dataCacheConfig: DataCacheConfigResponse3.fromMap(
      ...
      databaseFlags: Input.decodeList<DatabaseFlagsResponse2>(
          map['databaseFlags'],
          (value) => DatabaseFlagsResponse2.fromMap(
      ...
      denyMaintenancePeriods: Input.decodeList<DenyMaintenancePeriodResponse3>(
          map['denyMaintenancePeriods'],
          (value) => DenyMaintenancePeriodResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      edition: map['edition'] as String,
      insightsConfig: InsightsConfigResponse2.fromMap(
          (map['insightsConfig'] as Map).cast<String, dynamic>()),
      ipConfiguration: IpConfigurationResponse2.fromMap(
          (map['ipConfiguration'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      locationPreference: LocationPreferenceResponse2.fromMap(
          (map['locationPreference'] as Map).cast<String, dynamic>()),
      maintenanceWindow: MaintenanceWindowResponse10.fromMap(
          (map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      passwordValidationPolicy: PasswordValidationPolicyResponse2.fromMap(
      ...
      sqlServerAuditConfig: SqlServerAuditConfigResponse2.fromMap(
