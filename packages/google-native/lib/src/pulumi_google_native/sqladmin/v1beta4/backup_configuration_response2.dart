...
import 'backup_retention_settings_response2.dart';

/// Database instance backup configuration.
class BackupConfigurationResponse2 {
  /// Backup retention settings.
  final BackupRetentionSettingsResponse2 backupRetentionSettings;
  ...
  factory BackupConfigurationResponse2.fromMap(Map<String, dynamic> map) {
    return BackupConfigurationResponse2(
      backupRetentionSettings: BackupRetentionSettingsResponse2.fromMap(
