...
class LocationPreferenceResponse2 {
  ...
  factory LocationPreferenceResponse2.fromMap(Map<String, dynamic> map) {
    return LocationPreferenceResponse2(
