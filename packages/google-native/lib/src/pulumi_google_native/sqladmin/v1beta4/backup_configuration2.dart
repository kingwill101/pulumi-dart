...
import 'backup_retention_settings2.dart';

/// Database instance backup configuration.
class BackupConfiguration2 {
  /// Backup retention settings.
  final BackupRetentionSettings2? backupRetentionSettings;
  ...
  factory BackupConfiguration2.fromMap(Map<String, dynamic> map) {
    return BackupConfiguration2(
      backupRetentionSettings: map['backupRetentionSettings'] == null
          ? null
          : BackupRetentionSettings2.fromMap(
