...
import 'instance_reference2.dart';

/// On-premises instance configuration.
class OnPremisesConfiguration2 {
  ...
  final InstanceReference2? sourceInstance;

  /// The username for connecting to on-premises instance.
  final String? username;

  OnPremisesConfiguration2({
    this.caCertificate,
  ...
  factory OnPremisesConfiguration2.fromMap(Map<String, dynamic> map) {
    return OnPremisesConfiguration2(
      caCertificate:
