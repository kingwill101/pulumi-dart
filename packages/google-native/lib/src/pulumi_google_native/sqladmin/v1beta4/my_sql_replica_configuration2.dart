...
class MySqlReplicaConfiguration2 {
  ...
  factory MySqlReplicaConfiguration2.fromMap(Map<String, dynamic> map) {
    return MySqlReplicaConfiguration2(
      caCertificate:
