...
class GetUserResult5 {
  ...
  final UserPasswordValidationPolicyResponse2 passwordPolicy;

  /// The project ID of the project containing the Cloud SQL database. The Google apps domain is prefixed if applicable. Can be omitted for *update* because it is already specified on the URL.
  final String project;
  final SqlServerUserDetailsResponse2 sqlserverUserDetails;
  ...
  factory GetUserResult5.fromMap(Map<String, dynamic> map) {
    return GetUserResult5(
      ...
      passwordPolicy: UserPasswordValidationPolicyResponse2.fromMap(
          (map['passwordPolicy'] as Map).cast<String, dynamic>()),
      project: map['project'] as String,
      sqlserverUserDetails: SqlServerUserDetailsResponse2.fromMap(
