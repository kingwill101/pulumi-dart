...
enum IpConfigurationSslMode2 {
  ...
  const IpConfigurationSslMode2(this.value);
  final String value;

  static IpConfigurationSslMode2 fromValue(String value) {
    for (final item in IpConfigurationSslMode2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown IpConfigurationSslMode2 value: $value');
  }
}
