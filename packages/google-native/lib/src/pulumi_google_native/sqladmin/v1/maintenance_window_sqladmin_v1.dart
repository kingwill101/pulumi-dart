...
class MaintenanceWindowSqladminV1 {
  ...
  factory MaintenanceWindowSqladminV1.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowSqladminV1(
