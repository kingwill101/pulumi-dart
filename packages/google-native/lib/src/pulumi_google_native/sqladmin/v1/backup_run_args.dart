...
class BackupRunArgs {
  ...
  final Input<BackupRunBackupKind>? backupKind;
  ...
  final Input<OperationError>? error;
  ...
  final Input<BackupRunType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (backupKindValue != null) {
      map['backupKind'] =
          Input.mapOptionalInputValue<BackupRunBackupKind, String>(
    ...
    if (errorValue != null) {
      map['error'] =
          Input.mapOptionalInputValue<OperationError, Map<String, dynamic>>(
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<BackupRunType, String>(
  ...
  factory BackupRunArgs.fromMap(Map<String, dynamic> map) {
    return BackupRunArgs(
      backupKind: Input.asOptionalInput<BackupRunBackupKind>(map['backupKind']),
      ...
      error: Input.asOptionalInput<OperationError>(map['error']),
      ...
      type: Input.asOptionalInput<BackupRunType>(map['type']),
