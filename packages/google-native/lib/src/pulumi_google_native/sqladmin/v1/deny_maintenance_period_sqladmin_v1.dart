...
class DenyMaintenancePeriodSqladminV1 {
  ...
  DenyMaintenancePeriodSqladminV1({
    this.endDate,
    this.startDate,
    this.time,
  });
  ...
  factory DenyMaintenancePeriodSqladminV1.fromMap(Map<String, dynamic> map) {
    return DenyMaintenancePeriodSqladminV1(
