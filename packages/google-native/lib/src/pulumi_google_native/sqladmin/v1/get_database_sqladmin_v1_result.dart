...
class GetDatabaseSqladminV1Result {
  ...
  factory GetDatabaseSqladminV1Result.fromMap(Map<String, dynamic> map) {
    return GetDatabaseSqladminV1Result(
