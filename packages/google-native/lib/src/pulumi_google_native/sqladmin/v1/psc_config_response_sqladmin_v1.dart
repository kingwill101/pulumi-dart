...
class PscConfigResponseSqladminV1 {
  ...
  factory PscConfigResponseSqladminV1.fromMap(Map<String, dynamic> map) {
    return PscConfigResponseSqladminV1(
