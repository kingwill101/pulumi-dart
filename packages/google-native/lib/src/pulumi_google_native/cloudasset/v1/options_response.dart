...
class OptionsResponse {
  ...
  OptionsResponse({
    required this.analyzeServiceAccountImpersonation,
    required this.expandGroups,
    required this.expandResources,
    required this.expandRoles,
    required this.outputGroupEdges,
    required this.outputResourceEdges,
  });
  ...
  Map<String, dynamic> toMap() {
    ...
    map['expandGroups'] = expandGroups;
    map['expandResources'] = expandResources;
    map['expandRoles'] = expandRoles;
    map['outputGroupEdges'] = outputGroupEdges;
    map['outputResourceEdges'] = outputResourceEdges;
    return map;
  }
  ...
  factory OptionsResponse.fromMap(Map<String, dynamic> map) {
    return OptionsResponse(
      ...
      expandGroups: map['expandGroups'] as bool,
      expandResources: map['expandResources'] as bool,
      expandRoles: map['expandRoles'] as bool,
      outputGroupEdges: map['outputGroupEdges'] as bool,
      outputResourceEdges: map['outputResourceEdges'] as bool,
    );
  }
}
