...
class GoogleCloudIdentitytoolkitAdminV2EmailPrivacyConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final enableImprovedEmailPrivacyValue = enableImprovedEmailPrivacy;
    if (enableImprovedEmailPrivacyValue != null) {
      map['enableImprovedEmailPrivacy'] = enableImprovedEmailPrivacyValue;
    }
    return map;
  }
