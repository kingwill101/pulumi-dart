...
class TenantArgs {
  ...
  factory TenantArgs.fromMap(Map<String, dynamic> map) {
    return TenantArgs(
      ...
      enableAnonymousUser:
          pulumi.Input.asOptionalInput<bool>(map['enableAnonymousUser']),
      enableEmailLinkSignin:
          pulumi.Input.asOptionalInput<bool>(map['enableEmailLinkSignin']),
      inheritance: pulumi.Input.asOptionalInput<
          GoogleCloudIdentitytoolkitAdminV2Inheritance>(map['inheritance']),
      ...
      smsRegionConfig: pulumi.Input.asOptionalInput<
              GoogleCloudIdentitytoolkitAdminV2SmsRegionConfig>(
          map['smsRegionConfig']),
      testPhoneNumbers: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['testPhoneNumbers']),
    );
  }
}
