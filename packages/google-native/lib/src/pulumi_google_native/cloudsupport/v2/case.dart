...
class Case extends CustomResource {
  /// The issue classification applicable to this case.
  late final Output<CaseClassificationResponse> classification;
  ...
  late final Output<ActorResponse> creator;
  ...
  late final Output<String> v2Id;
  late final Output<String> v2Id1;
