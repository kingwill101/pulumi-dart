...
class CaseArgs2 {
  ...
  final Input<CasePriority2>? priority;

  /// REMOVED. The severity of this case. Use priority instead.
  final Input<CaseSeverity>? severity;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (classificationValue != null) {
      map['classification'] = Input.mapOptionalInputValue<CaseClassification2,
    ...
    if (creatorValue != null) {
      map['creator'] =
          Input.mapOptionalInputValue<Actor2, Map<String, dynamic>>(
    ...
    if (priorityValue != null) {
      map['priority'] = Input.mapOptionalInputValue<CasePriority2, String>(
          priorityValue, (value) => value.value);
    }
    final severityValue = severity;
    if (severityValue != null) {
      map['severity'] = Input.mapOptionalInputValue<CaseSeverity, String>(
  ...
  factory CaseArgs2.fromMap(Map<String, dynamic> map) {
    return CaseArgs2(
      classification:
          Input.asOptionalInput<CaseClassification2>(map['classification']),
      contactEmail: Input.asOptionalInput<String>(map['contactEmail']),
      creator: Input.asOptionalInput<Actor2>(map['creator']),
      ...
      priority: Input.asOptionalInput<CasePriority2>(map['priority']),
      severity: Input.asOptionalInput<CaseSeverity>(map['severity']),
