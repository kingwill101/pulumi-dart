...
class GetCaseResult2 {
  /// The issue classification applicable to this case.
  final CaseClassificationResponse2 classification;
  ...
  factory GetCaseResult2.fromMap(Map<String, dynamic> map) {
    return GetCaseResult2(
      classification: CaseClassificationResponse2.fromMap(
          (map['classification'] as Map).cast<String, dynamic>()),
      contactEmail: map['contactEmail'] as String,
      createTime: map['createTime'] as String,
      creator: ActorResponse2.fromMap(
