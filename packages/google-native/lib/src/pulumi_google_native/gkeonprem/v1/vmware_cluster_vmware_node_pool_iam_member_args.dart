...
/// The set of arguments for VmwareClusterVmwareNodePoolIamMember.
class VmwareClusterVmwareNodePoolIamMemberArgs {
  ...
  VmwareClusterVmwareNodePoolIamMemberArgs({
    this.condition,
  ...
  factory VmwareClusterVmwareNodePoolIamMemberArgs.fromMap(
      Map<String, dynamic> map) {
    return VmwareClusterVmwareNodePoolIamMemberArgs(
