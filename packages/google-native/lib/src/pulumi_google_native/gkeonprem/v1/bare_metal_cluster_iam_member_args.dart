...
/// The set of arguments for BareMetalClusterIamMember.
class BareMetalClusterIamMemberArgs {
  ...
  factory BareMetalClusterIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterIamMemberArgs(
