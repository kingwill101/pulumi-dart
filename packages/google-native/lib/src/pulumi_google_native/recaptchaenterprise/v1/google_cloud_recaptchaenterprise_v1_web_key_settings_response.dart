...
class GoogleCloudRecaptchaenterpriseV1WebKeySettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['allowAllDomains'] = allowAllDomains;
    map['allowAmpTraffic'] = allowAmpTraffic;
    map['allowedDomains'] = allowedDomains;
    map['challengeSecurityPreference'] = challengeSecurityPreference;
