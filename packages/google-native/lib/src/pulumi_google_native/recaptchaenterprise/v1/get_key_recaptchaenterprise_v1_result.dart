...
class GetKeyRecaptchaenterpriseV1Result {
  ...
  GetKeyRecaptchaenterpriseV1Result({
  ...
  factory GetKeyRecaptchaenterpriseV1Result.fromMap(Map<String, dynamic> map) {
    return GetKeyRecaptchaenterpriseV1Result(
      androidSettings:
