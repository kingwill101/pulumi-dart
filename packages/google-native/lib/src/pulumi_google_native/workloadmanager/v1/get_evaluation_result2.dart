...
class GetEvaluationResult2 {
  ...
  final ResourceFilterResponse2 resourceFilter;

  /// [Output only] The updated rule ids if exist.
  final ResourceStatusResponse5 resourceStatus;
  ...
  factory GetEvaluationResult2.fromMap(Map<String, dynamic> map) {
    return GetEvaluationResult2(
      createTime: map['createTime'] as String,
      customRulesBucket: map['customRulesBucket'] as String,
      description: map['description'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      resourceFilter: ResourceFilterResponse2.fromMap(
          (map['resourceFilter'] as Map).cast<String, dynamic>()),
      resourceStatus: ResourceStatusResponse5.fromMap(
