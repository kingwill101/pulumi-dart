...
class WorkflowArgs {
  ...
  final Input<WorkflowCallLogLevel>? callLogLevel;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (callLogLevelValue != null) {
      map['callLogLevel'] =
          Input.mapOptionalInputValue<WorkflowCallLogLevel, String>(
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      callLogLevel:
          Input.asOptionalInput<WorkflowCallLogLevel>(map['callLogLevel']),
