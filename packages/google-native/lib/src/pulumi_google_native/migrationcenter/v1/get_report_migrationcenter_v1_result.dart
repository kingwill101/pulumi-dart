...
class GetReportMigrationcenterV1Result {
  /// Creation timestamp.
  ...
  GetReportMigrationcenterV1Result({
  ...
  factory GetReportMigrationcenterV1Result.fromMap(Map<String, dynamic> map) {
    return GetReportMigrationcenterV1Result(
