...
class ReportConfigArgs {
  ...
  final Input<List<ReportConfigGroupPreferenceSetAssignment>>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['groupPreferencesetAssignments'] = Input.mapInputValue<
        ...
        groupPreferencesetAssignments,
        (value) => Input.encodeList<ReportConfigGroupPreferenceSetAssignment,
  ...
  factory ReportConfigArgs.fromMap(Map<String, dynamic> map) {
    return ReportConfigArgs(
      ...
      groupPreferencesetAssignments:
          Input.asInput<List<ReportConfigGroupPreferenceSetAssignment>>(
