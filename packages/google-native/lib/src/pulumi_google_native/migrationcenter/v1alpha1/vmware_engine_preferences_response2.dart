...
class VmwareEnginePreferencesResponse2 {
  ...
  VmwareEnginePreferencesResponse2({
  ...
  factory VmwareEnginePreferencesResponse2.fromMap(Map<String, dynamic> map) {
    return VmwareEnginePreferencesResponse2(
