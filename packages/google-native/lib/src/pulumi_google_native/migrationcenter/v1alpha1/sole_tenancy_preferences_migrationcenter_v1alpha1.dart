...
class SoleTenancyPreferencesMigrationcenterV1alpha1 {
  ...
  final SoleTenancyPreferencesCommitmentPlanMigrationcenterV1alpha1?
      commitmentPlan;
  ...
  final SoleTenancyPreferencesHostMaintenancePolicyMigrationcenterV1alpha1?
    ...
    return SoleTenancyPreferencesMigrationcenterV1alpha1(
      ...
      hostMaintenancePolicy: map['hostMaintenancePolicy'] == null
          ...
          : SoleTenancyPreferencesHostMaintenancePolicyMigrationcenterV1alpha1
              .fromValue(map['hostMaintenancePolicy'] as String),
