...
import 'vmware_engine_preferences_commitment_plan2.dart';

/// The user preferences relating to Google Cloud VMware Engine target platform.
class VmwareEnginePreferences2 {
  /// Commitment plan to consider when calculating costs for virtual machine insights and recommendations. If you are unsure which value to set, a 3 year commitment plan is often a good value to start with.
  final VmwareEnginePreferencesCommitmentPlan2? commitmentPlan;
  ...
  factory VmwareEnginePreferences2.fromMap(Map<String, dynamic> map) {
    return VmwareEnginePreferences2(
      commitmentPlan: map['commitmentPlan'] == null
          ? null
          : VmwareEnginePreferencesCommitmentPlan2.fromValue(
