...
class ImportJob3 extends CustomResource {
  ...
  ImportJob3(
    ...
    this.executionReport = Output.createUnknown<ExecutionReportResponse2>();
    this.gcsPayload = Output.createUnknown<GCSPayloadInfoResponse>();
    this.importJobId = Output.createUnknown<String>();
    this.inlinePayload = Output.createUnknown<InlinePayloadInfoResponse>();
    ...
    this.validationReport = Output.createUnknown<ValidationReportResponse2>();
  }
}
