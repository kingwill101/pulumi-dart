...
class GetImportJobResult3 {
  ...
  final ExecutionReportResponse2 executionReport;
  ...
  final ValidationReportResponse2 validationReport;
  ...
  factory GetImportJobResult3.fromMap(Map<String, dynamic> map) {
    return GetImportJobResult3(
      assetSource: map['assetSource'] as String,
      completeTime: map['completeTime'] as String,
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      executionReport: ExecutionReportResponse2.fromMap(
      ...
      validationReport: ValidationReportResponse2.fromMap(
