...
import 'compute_engine_preferences_response2.dart';
import 'region_preferences_response2.dart';
import 'sole_tenancy_preferences_response2.dart';
...
import 'vmware_engine_preferences_response2.dart';
...
class VirtualMachinePreferencesResponse2 {
  /// Commitment plan to consider when calculating costs for virtual machine insights and recommendations. If you are unsure which value to set, a 3 year commitment plan is often a good value to start with.
  final String commitmentPlan;

  /// Compute Engine preferences concern insights and recommendations for Compute Engine target.
  final ComputeEnginePreferencesResponse2 computeEnginePreferences;
  ...
  final RegionPreferencesResponse2 regionPreferences;
  ...
  final SoleTenancyPreferencesResponse2 soleTenancyPreferences;

  /// Target product for assets using this preference set. Specify either target product or business goal, but not both.
  final String targetProduct;

  /// Preferences concerning insights and recommendations for Google Cloud VMware Engine.
  final VmwareEnginePreferencesResponse2 vmwareEnginePreferences;

  VirtualMachinePreferencesResponse2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['networkCostParameters'] = networkCostParameters.toMap();
  ...
  factory VirtualMachinePreferencesResponse2.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePreferencesResponse2(
      commitmentPlan: map['commitmentPlan'] as String,
      computeEnginePreferences: ComputeEnginePreferencesResponse2.fromMap(
      ...
      regionPreferences: RegionPreferencesResponse2.fromMap(
      ...
      soleTenancyPreferences: SoleTenancyPreferencesResponse2.fromMap(
          (map['soleTenancyPreferences'] as Map).cast<String, dynamic>()),
      targetProduct: map['targetProduct'] as String,
      vmwareEnginePreferences: VmwareEnginePreferencesResponse2.fromMap(
