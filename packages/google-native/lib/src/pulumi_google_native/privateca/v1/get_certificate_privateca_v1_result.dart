...
class GetCertificatePrivatecaV1Result {
  ...
  GetCertificatePrivatecaV1Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['certificateDescription'] = certificateDescription.toMap();
    map['certificateTemplate'] = certificateTemplate;
    map['config'] = config.toMap();
    map['createTime'] = createTime;
    map['issuerCertificateAuthority'] = issuerCertificateAuthority;
    map['labels'] = labels;
    map['lifetime'] = lifetime;
    map['name'] = name;
    map['pemCertificate'] = pemCertificate;
    map['pemCertificateChain'] = pemCertificateChain;
    map['pemCsr'] = pemCsr;
    map['revocationDetails'] = revocationDetails.toMap();
    map['subjectMode'] = subjectMode;
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetCertificatePrivatecaV1Result.fromMap(Map<String, dynamic> map) {
    return GetCertificatePrivatecaV1Result(
