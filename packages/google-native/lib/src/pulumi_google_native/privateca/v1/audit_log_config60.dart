...
class AuditLogConfig60 {
  ...
  factory AuditLogConfig60.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig60(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType60.fromValue(map['logType'] as String),
    );
  }
}
