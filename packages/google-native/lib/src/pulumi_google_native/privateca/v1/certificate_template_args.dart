...
class CertificateTemplateArgs {
  ...
  final Input<CertificateIdentityConstraints>? identityConstraints;
  ...
  final Input<CertificateExtensionConstraints>? passthroughExtensions;

  /// Optional. A set of X.509 values that will be applied to all issued certificates that use this template. If the certificate request includes conflicting values for the same properties, they will be overwritten by the values defined here. If the issuing CaPool's IssuancePolicy defines conflicting baseline_values for the same properties, the certificate issuance request will fail.
  final Input<X509Parameters>? predefinedValues;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (predefinedValuesValue != null) {
      map['predefinedValues'] =
          Input.mapOptionalInputValue<X509Parameters, Map<String, dynamic>>(
  ...
  factory CertificateTemplateArgs.fromMap(Map<String, dynamic> map) {
    return CertificateTemplateArgs(
      ...
      identityConstraints:
          Input.asOptionalInput<CertificateIdentityConstraints>(
              map['identityConstraints']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      maximumLifetime: Input.asOptionalInput<String>(map['maximumLifetime']),
      passthroughExtensions:
          Input.asOptionalInput<CertificateExtensionConstraints>(
              map['passthroughExtensions']),
      predefinedValues:
          Input.asOptionalInput<X509Parameters>(map['predefinedValues']),
