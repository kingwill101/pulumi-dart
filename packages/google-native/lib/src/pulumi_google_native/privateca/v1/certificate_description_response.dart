...
class CertificateDescriptionResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['authorityKeyId'] = authorityKeyId.toMap();
    map['certFingerprint'] = certFingerprint.toMap();
    map['crlDistributionPoints'] = crlDistributionPoints;
    map['publicKey'] = publicKey.toMap();
    map['subjectDescription'] = subjectDescription.toMap();
    map['subjectKeyId'] = subjectKeyId.toMap();
    map['x509Description'] = x509Description.toMap();
    return map;
  }
