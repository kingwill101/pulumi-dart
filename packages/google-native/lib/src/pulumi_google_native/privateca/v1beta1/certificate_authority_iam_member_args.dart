...
/// The set of arguments for CertificateAuthorityIamMember.
class CertificateAuthorityIamMemberArgs {
  ...
  CertificateAuthorityIamMemberArgs({
    this.condition,
  ...
  factory CertificateAuthorityIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityIamMemberArgs(
