...
class AuditLogConfig61 {
  ...
  factory AuditLogConfig61.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig61(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType61.fromValue(map['logType'] as String),
    );
  }
}
