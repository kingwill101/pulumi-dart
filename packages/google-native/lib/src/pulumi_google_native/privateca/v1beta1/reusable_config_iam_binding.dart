...
import 'reusable_config_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ReusableConfigIamBinding extends pulumi.CustomResource {
  ...
  ReusableConfigIamBinding(
    String name, {
    ReusableConfigIamBindingArgs? args,
