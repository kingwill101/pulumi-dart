...
class InstanceClusterBackupIamPolicy extends CustomResource {
  /// Specifies cloud audit logging configuration for this policy.
  late final Output<List<AuditConfigResponse8>> auditConfigs;
  ...
  late final Output<List<BindingResponse12>> bindings;
