...
class InstanceIamMemberBigtableadminV2Args {
  ...
  InstanceIamMemberBigtableadminV2Args({
    this.condition,
  ...
  factory InstanceIamMemberBigtableadminV2Args.fromMap(
      Map<String, dynamic> map) {
    return InstanceIamMemberBigtableadminV2Args(
