...
class BackupBigtableadminV2 extends pulumi.CustomResource {
  ...
  BackupBigtableadminV2(
    String name, {
    BackupBigtableadminV2Args? args,
    ...
    this.encryptionInfo =
        registerOutput<EncryptionInfoResponseBigtableadminV2>('encryptionInfo');
