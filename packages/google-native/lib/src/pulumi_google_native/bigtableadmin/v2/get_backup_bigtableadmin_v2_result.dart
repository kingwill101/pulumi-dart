...
import 'encryption_info_response_bigtableadmin_v2.dart';

/// Result data returned by getBackup.
class GetBackupBigtableadminV2Result {
  /// The encryption information for the backup.
  final EncryptionInfoResponseBigtableadminV2 encryptionInfo;
  ...
  GetBackupBigtableadminV2Result({
  ...
  factory GetBackupBigtableadminV2Result.fromMap(Map<String, dynamic> map) {
    return GetBackupBigtableadminV2Result(
      encryptionInfo: EncryptionInfoResponseBigtableadminV2.fromMap(
