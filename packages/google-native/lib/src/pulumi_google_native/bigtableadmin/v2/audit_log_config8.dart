...
class AuditLogConfig8 {
  ...
  factory AuditLogConfig8.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig8(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType8.fromValue(map['logType'] as String),
    );
  }
}
