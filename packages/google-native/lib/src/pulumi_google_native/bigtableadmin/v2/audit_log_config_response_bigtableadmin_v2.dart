...
class AuditLogConfigResponseBigtableadminV2 {
  ...
  AuditLogConfigResponseBigtableadminV2({
  ...
  factory AuditLogConfigResponseBigtableadminV2.fromMap(
      Map<String, dynamic> map) {
    return AuditLogConfigResponseBigtableadminV2(
