...
class GetTableBigtableadminV2Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['changeStreamConfig'] = changeStreamConfig.toMap();
    map['clusterStates'] = clusterStates;
    map['columnFamilies'] = columnFamilies;
  ...
  factory GetTableBigtableadminV2Result.fromMap(Map<String, dynamic> map) {
    return GetTableBigtableadminV2Result(
      changeStreamConfig: ChangeStreamConfigResponse.fromMap(
      ...
      restoreInfo: RestoreInfoResponse.fromMap(
          (map['restoreInfo'] as Map).cast<String, dynamic>()),
      stats: TableStatsResponse.fromMap(
