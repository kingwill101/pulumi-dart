...
class GetBackupResult4 {
  /// The encryption information for the backup.
  final EncryptionInfoResponse4 encryptionInfo;
  ...
  factory GetBackupResult4.fromMap(Map<String, dynamic> map) {
    return GetBackupResult4(
      encryptionInfo: EncryptionInfoResponse4.fromMap(
