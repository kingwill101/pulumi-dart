...
class InstanceIamBindingBigtableadminV2Args {
  ...
  InstanceIamBindingBigtableadminV2Args({
    this.condition,
  ...
  factory InstanceIamBindingBigtableadminV2Args.fromMap(
      Map<String, dynamic> map) {
    return InstanceIamBindingBigtableadminV2Args(
