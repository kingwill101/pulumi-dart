...
import 'vpc_peering_config2.dart';
...
class PrivateConnectionArgs2 {
  ...
  /// VPC Peering Config.
  final Input<VpcPeeringConfig2>? vpcPeeringConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (vpcPeeringConfigValue != null) {
      map['vpcPeeringConfig'] =
          Input.mapOptionalInputValue<VpcPeeringConfig2, Map<String, dynamic>>(
  ...
  factory PrivateConnectionArgs2.fromMap(Map<String, dynamic> map) {
    return PrivateConnectionArgs2(
      ...
      vpcPeeringConfig:
          Input.asOptionalInput<VpcPeeringConfig2>(map['vpcPeeringConfig']),
    );
  }
}
