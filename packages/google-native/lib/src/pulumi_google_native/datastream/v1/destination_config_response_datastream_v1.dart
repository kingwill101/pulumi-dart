...
class DestinationConfigResponseDatastreamV1 {
  ...
  DestinationConfigResponseDatastreamV1({
  ...
  factory DestinationConfigResponseDatastreamV1.fromMap(
      Map<String, dynamic> map) {
    return DestinationConfigResponseDatastreamV1(
