...
class SourceConfigResponseDatastreamV1 {
  ...
  SourceConfigResponseDatastreamV1({
  ...
  factory SourceConfigResponseDatastreamV1.fromMap(Map<String, dynamic> map) {
    return SourceConfigResponseDatastreamV1(
