...
class Stream extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DestinationConfigResponseDatastreamV1>
      destinationConfig;
  ...
  late final pulumi.Output<SourceConfigResponseDatastreamV1> sourceConfig;
  ...
  Stream(
    ...
    this.destinationConfig =
        registerOutput<DestinationConfigResponseDatastreamV1>(
            'destinationConfig');
    ...
    this.sourceConfig =
        registerOutput<SourceConfigResponseDatastreamV1>('sourceConfig');
