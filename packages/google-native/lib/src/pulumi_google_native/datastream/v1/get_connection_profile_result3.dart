...
class GetConnectionProfileResult3 {
  ...
  final ForwardSshTunnelConnectivityResponse2 forwardSshConnectivity;
  ...
  final PrivateConnectivityResponse2 privateConnectivity;
  ...
  factory GetConnectionProfileResult3.fromMap(Map<String, dynamic> map) {
    return GetConnectionProfileResult3(
      bigqueryProfile: (map['bigqueryProfile'] as Map).cast<String, dynamic>(),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      forwardSshConnectivity: ForwardSshTunnelConnectivityResponse2.fromMap(
      ...
      privateConnectivity: PrivateConnectivityResponse2.fromMap(
