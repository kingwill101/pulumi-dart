...
class PrivateConnection2 extends CustomResource {
  ...
  late final Output<ErrorResponse> error;
  ...
  /// VPC Peering Config.
  late final Output<VpcPeeringConfigResponse2> vpcPeeringConfig;
  ...
  PrivateConnection2(
    ...
    this.error = Output.createUnknown<ErrorResponse>();
    ...
    this.vpcPeeringConfig = Output.createUnknown<VpcPeeringConfigResponse2>();
  }
}
