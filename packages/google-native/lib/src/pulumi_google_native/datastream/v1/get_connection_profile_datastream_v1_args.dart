...
class GetConnectionProfileDatastreamV1Args {
  final pulumi.Input<String> connectionProfileId;
  final pulumi.Input<String> location;
  final pulumi.Input<String>? project;

  GetConnectionProfileDatastreamV1Args({
  ...
  factory GetConnectionProfileDatastreamV1Args.fromMap(
      Map<String, dynamic> map) {
    return GetConnectionProfileDatastreamV1Args(
      connectionProfileId:
