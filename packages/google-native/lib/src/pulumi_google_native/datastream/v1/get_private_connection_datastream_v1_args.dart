...
class GetPrivateConnectionDatastreamV1Args {
  final pulumi.Input<String> location;
  final pulumi.Input<String> privateConnectionId;
  final pulumi.Input<String>? project;

  GetPrivateConnectionDatastreamV1Args({
  ...
  factory GetPrivateConnectionDatastreamV1Args.fromMap(
      Map<String, dynamic> map) {
    return GetPrivateConnectionDatastreamV1Args(
