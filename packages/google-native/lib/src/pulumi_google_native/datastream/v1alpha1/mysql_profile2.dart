...
class MysqlProfile2 {
  ...
  final MysqlSslConfig2? sslConfig;
  ...
  factory MysqlProfile2.fromMap(Map<String, dynamic> map) {
    return MysqlProfile2(
      hostname: map['hostname'] as String,
      password: map['password'] as String,
      port: map['port'] == null ? null : map['port'] as int,
      sslConfig: map['sslConfig'] == null
          ? null
          : MysqlSslConfig2.fromMap(
