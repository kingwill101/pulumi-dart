...
class BackupPlanArgs {
  ...
  factory BackupPlanArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanArgs(
      backupConfig:
          pulumi.Input.asOptionalInput<BackupConfig>(map['backupConfig']),
      backupPlanId: pulumi.Input.asInput<String>(map['backupPlanId']),
      backupSchedule:
          pulumi.Input.asOptionalInput<Schedule>(map['backupSchedule']),
      ...
      retentionPolicy:
          pulumi.Input.asOptionalInput<RetentionPolicy>(map['retentionPolicy']),
    );
  }
}
