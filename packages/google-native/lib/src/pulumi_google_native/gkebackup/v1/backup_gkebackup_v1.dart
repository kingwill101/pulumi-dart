...
import 'backup_gkebackup_v1_args.dart';
...
class BackupGkebackupV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EncryptionKeyResponseGkebackupV1> encryptionKey;
  ...
  BackupGkebackupV1(
    ...
    this.encryptionKey =
        registerOutput<EncryptionKeyResponseGkebackupV1>('encryptionKey');
