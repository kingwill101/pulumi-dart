...
class GetBackupGkebackupV1Result {
  ...
  final EncryptionKeyResponseGkebackupV1 encryptionKey;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['clusterMetadata'] = clusterMetadata.toMap();
    map['completeTime'] = completeTime;
    map['configBackupSizeBytes'] = configBackupSizeBytes;
    map['containsSecrets'] = containsSecrets;
    map['containsVolumeData'] = containsVolumeData;
    map['createTime'] = createTime;
    map['deleteLockDays'] = deleteLockDays;
    map['deleteLockExpireTime'] = deleteLockExpireTime;
    ...
    map['retainDays'] = retainDays;
    map['retainExpireTime'] = retainExpireTime;
    ...
    map['volumeCount'] = volumeCount;
    return map;
  }

  factory GetBackupGkebackupV1Result.fromMap(Map<String, dynamic> map) {
    return GetBackupGkebackupV1Result(
      ...
      encryptionKey: EncryptionKeyResponseGkebackupV1.fromMap(
