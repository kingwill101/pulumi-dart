...
class Backup7 extends CustomResource {
  /// If True, all namespaces were included in the Backup.
  late final Output<bool> allNamespaces;
  ...
  late final Output<EncryptionKeyResponse2> encryptionKey;
