...
import 'audit_config_gkebackup_v1.dart';
import 'binding_gkebackup_v1.dart';

/// The set of arguments for BackupPlanBackupVolumeBackupIamPolicy.
class BackupPlanBackupVolumeBackupIamPolicyArgs {
  /// Specifies cloud audit logging configuration for this policy.
  final pulumi.Input<List<AuditConfigGkebackupV1>>? auditConfigs;
  ...
  final pulumi.Input<List<BindingGkebackupV1>>? bindings;
  ...
  BackupPlanBackupVolumeBackupIamPolicyArgs({
    this.auditConfigs,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigGkebackupV1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigGkebackupV1,
    ...
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingGkebackupV1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) =>
              pulumi.Input.encodeList<BindingGkebackupV1, Map<String, dynamic>>(
  ...
  factory BackupPlanBackupVolumeBackupIamPolicyArgs.fromMap(
      Map<String, dynamic> map) {
    return BackupPlanBackupVolumeBackupIamPolicyArgs(
      auditConfigs: pulumi.Input.asOptionalInput<List<AuditConfigGkebackupV1>>(
          map['auditConfigs']),
      backupId: pulumi.Input.asInput<String>(map['backupId']),
      backupPlanId: pulumi.Input.asInput<String>(map['backupPlanId']),
      bindings: pulumi.Input.asOptionalInput<List<BindingGkebackupV1>>(
          map['bindings']),
