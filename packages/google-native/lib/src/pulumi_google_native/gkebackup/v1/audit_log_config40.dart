...
class AuditLogConfig40 {
  ...
  factory AuditLogConfig40.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig40(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType40.fromValue(map['logType'] as String),
    );
  }
}
