...
class Dimension {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['column'] = column;
    final columnTypeValue = columnType;
    if (columnTypeValue != null) {
      map['columnType'] = columnTypeValue;
    }
    final floatBinSizeValue = floatBinSize;
    if (floatBinSizeValue != null) {
      map['floatBinSize'] = floatBinSizeValue;
    }
    final maxBinCountValue = maxBinCount;
    if (maxBinCountValue != null) {
      map['maxBinCount'] = maxBinCountValue;
    }
    final numericBinSizeValue = numericBinSize;
    if (numericBinSizeValue != null) {
      map['numericBinSize'] = numericBinSizeValue;
    }
    final sortColumnValue = sortColumn;
    if (sortColumnValue != null) {
      map['sortColumn'] = sortColumnValue;
    }
    final sortOrderValue = sortOrder;
    if (sortOrderValue != null) {
      map['sortOrder'] = sortOrderValue.value;
    }
    final timeBinSizeValue = timeBinSize;
    if (timeBinSizeValue != null) {
      map['timeBinSize'] = timeBinSizeValue;
    }
    return map;
  }
  ...
  factory Dimension.fromMap(Map<String, dynamic> map) {
    return Dimension(
      ...
      columnType:
          map['columnType'] == null ? null : map['columnType'] as String,
      floatBinSize:
          map['floatBinSize'] == null ? null : map['floatBinSize'] as double,
      maxBinCount:
          map['maxBinCount'] == null ? null : map['maxBinCount'] as int,
      numericBinSize:
          map['numericBinSize'] == null ? null : map['numericBinSize'] as int,
      sortColumn:
          map['sortColumn'] == null ? null : map['sortColumn'] as String,
      sortOrder: map['sortOrder'] == null
          ? null
          : DimensionSortOrder.fromValue(map['sortOrder'] as String),
      timeBinSize:
          map['timeBinSize'] == null ? null : map['timeBinSize'] as String,
    );
  }
}
