...
class ErrorReportingPanel {
  ...
  Map<String, dynamic> toMap() {
    ...
    final projectNamesValue = projectNames;
    if (projectNamesValue != null) {
      map['projectNames'] = projectNamesValue;
    }
  ...
  factory ErrorReportingPanel.fromMap(Map<String, dynamic> map) {
    return ErrorReportingPanel(
      projectNames: map['projectNames'] == null
          ? null
          : (map['projectNames'] as List).cast<String>(),
