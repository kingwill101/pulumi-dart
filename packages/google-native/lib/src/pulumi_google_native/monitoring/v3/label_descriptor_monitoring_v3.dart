...
import 'label_descriptor_value_type_monitoring_v3.dart';

/// A description of a label.
class LabelDescriptorMonitoringV3 {
  ...
  final LabelDescriptorValueTypeMonitoringV3? valueType;

  LabelDescriptorMonitoringV3({
    this.description,
    this.key,
    this.valueType,
  });
  ...
  factory LabelDescriptorMonitoringV3.fromMap(Map<String, dynamic> map) {
    return LabelDescriptorMonitoringV3(
      description:
          map['description'] == null ? null : map['description'] as String,
      key: map['key'] == null ? null : map['key'] as String,
      valueType: map['valueType'] == null
          ? null
          : LabelDescriptorValueTypeMonitoringV3.fromValue(
