...
import 'aggregation_cross_series_reducer2.dart';
import 'aggregation_per_series_aligner2.dart';
...
class Aggregation2 {
  ...
  final AggregationCrossSeriesReducer2? crossSeriesReducer;
  ...
  final AggregationPerSeriesAligner2? perSeriesAligner;
  ...
  factory Aggregation2.fromMap(Map<String, dynamic> map) {
    return Aggregation2(
      ...
      crossSeriesReducer: map['crossSeriesReducer'] == null
          ? null
          : AggregationCrossSeriesReducer2.fromValue(
      ...
      perSeriesAligner: map['perSeriesAligner'] == null
          ? null
          : AggregationPerSeriesAligner2.fromValue(
