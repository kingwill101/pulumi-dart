...
class GetServiceMonitoringV3Result {
  ...
  final CloudRunResponseMonitoringV3 cloudRun;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['basicService'] = basicService.toMap();
    map['cloudEndpoints'] = cloudEndpoints.toMap();
    map['cloudRun'] = cloudRun.toMap();
    map['clusterIstio'] = clusterIstio.toMap();
    map['custom'] = custom;
    map['displayName'] = displayName;
    map['gkeNamespace'] = gkeNamespace.toMap();
    map['gkeService'] = gkeService.toMap();
    map['gkeWorkload'] = gkeWorkload.toMap();
    map['istioCanonicalService'] = istioCanonicalService.toMap();
    map['meshIstio'] = meshIstio.toMap();
    map['name'] = name;
    map['telemetry'] = telemetry.toMap();
    map['userLabels'] = userLabels;
    return map;
  }

  factory GetServiceMonitoringV3Result.fromMap(Map<String, dynamic> map) {
    return GetServiceMonitoringV3Result(
      ...
      cloudRun: CloudRunResponseMonitoringV3.fromMap(
