...
enum AggregationPerSeriesAligner2 {
  ...
  const AggregationPerSeriesAligner2(this.value);
  final String value;

  static AggregationPerSeriesAligner2 fromValue(String value) {
    for (final item in AggregationPerSeriesAligner2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown AggregationPerSeriesAligner2 value: $value');
  }
}
