...
class UptimeCheckConfigArgs {
  ...
  factory UptimeCheckConfigArgs.fromMap(Map<String, dynamic> map) {
    return UptimeCheckConfigArgs(
      ...
      httpCheck: pulumi.Input.asOptionalInput<HttpCheck>(map['httpCheck']),
      internalCheckers: pulumi.Input.asOptionalInput<List<InternalChecker>>(
          map['internalCheckers']),
      isInternal: pulumi.Input.asOptionalInput<bool>(map['isInternal']),
      monitoredResource:
      ...
      resourceGroup:
          pulumi.Input.asOptionalInput<ResourceGroup>(map['resourceGroup']),
      selectedRegions: pulumi.Input.asOptionalInput<
          List<UptimeCheckConfigSelectedRegionsItem>>(map['selectedRegions']),
      syntheticMonitor: pulumi.Input.asOptionalInput<SyntheticMonitorTarget>(
          map['syntheticMonitor']),
      tcpCheck: pulumi.Input.asOptionalInput<TcpCheck>(map['tcpCheck']),
