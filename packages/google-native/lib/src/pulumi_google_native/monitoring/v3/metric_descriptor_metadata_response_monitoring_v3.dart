...
class MetricDescriptorMetadataResponseMonitoringV3 {
  ...
  MetricDescriptorMetadataResponseMonitoringV3({
  ...
  factory MetricDescriptorMetadataResponseMonitoringV3.fromMap(
      Map<String, dynamic> map) {
    return MetricDescriptorMetadataResponseMonitoringV3(
