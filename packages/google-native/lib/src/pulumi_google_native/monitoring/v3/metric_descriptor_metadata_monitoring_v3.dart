...
import 'metric_descriptor_metadata_launch_stage_monitoring_v3.dart';

/// Additional annotations that can be used to guide the usage of a metric.
class MetricDescriptorMetadataMonitoringV3 {
  /// The delay of data points caused by ingestion. Data points older than this age are guaranteed to be ingested and available to be read, excluding data loss due to errors.
  final String? ingestDelay;

  /// Deprecated. Must use the MetricDescriptor.launch_stage instead.
  final MetricDescriptorMetadataLaunchStageMonitoringV3? launchStage;
  ...
  factory MetricDescriptorMetadataMonitoringV3.fromMap(
      Map<String, dynamic> map) {
    return MetricDescriptorMetadataMonitoringV3(
      ingestDelay:
          map['ingestDelay'] == null ? null : map['ingestDelay'] as String,
      launchStage: map['launchStage'] == null
          ? null
          : MetricDescriptorMetadataLaunchStageMonitoringV3.fromValue(
