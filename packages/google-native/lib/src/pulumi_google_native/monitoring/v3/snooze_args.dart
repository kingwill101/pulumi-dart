...
class SnoozeArgs {
  ...
  final Input<TimeInterval> interval;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['criteria'] = Input.mapInputValue<Criteria, Map<String, dynamic>>(
        criteria, (value) => value.toMap());
    map['displayName'] = displayName;
    map['interval'] = Input.mapInputValue<TimeInterval, Map<String, dynamic>>(
  ...
  factory SnoozeArgs.fromMap(Map<String, dynamic> map) {
    return SnoozeArgs(
      criteria: Input.asInput<Criteria>(map['criteria']),
      displayName: Input.asInput<String>(map['displayName']),
      interval: Input.asInput<TimeInterval>(map['interval']),
