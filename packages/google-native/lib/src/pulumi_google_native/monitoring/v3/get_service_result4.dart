...
class GetServiceResult4 {
  ...
  final CloudRunResponse2 cloudRun;
  ...
  factory GetServiceResult4.fromMap(Map<String, dynamic> map) {
    return GetServiceResult4(
      ...
      cloudRun: CloudRunResponse2.fromMap(
