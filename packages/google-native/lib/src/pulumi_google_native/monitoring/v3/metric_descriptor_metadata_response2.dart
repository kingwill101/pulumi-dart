...
class MetricDescriptorMetadataResponse2 {
  ...
  MetricDescriptorMetadataResponse2({
  ...
  factory MetricDescriptorMetadataResponse2.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorMetadataResponse2(
