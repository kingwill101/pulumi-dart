...
class AlertPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ConditionResponseMonitoringV3>> conditions;
  ...
  late final pulumi.Output<StatusResponseMonitoringV3> validity;
  ...
  AlertPolicy(
    ...
    this.conditions =
        registerOutput<List<ConditionResponseMonitoringV3>>('conditions');
    this.creationRecord =
    ...
    this.validity = registerOutput<StatusResponseMonitoringV3>('validity');
  }
}
