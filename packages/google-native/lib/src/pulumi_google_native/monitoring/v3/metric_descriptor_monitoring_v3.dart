...
class MetricDescriptorMonitoringV3 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<LabelDescriptorResponseMonitoringV3>> labels;

  /// Optional. The launch stage of the metric definition.
  late final pulumi.Output<String> launchStage;

  /// Optional. Metadata which can be used to guide usage of the metric.
  late final pulumi.Output<MetricDescriptorMetadataResponseMonitoringV3>
      metadata;
  ...
  MetricDescriptorMonitoringV3(
    ...
    this.labels =
        registerOutput<List<LabelDescriptorResponseMonitoringV3>>('labels');
    this.launchStage = registerOutput<String>('launchStage');
    this.metadata =
        registerOutput<MetricDescriptorMetadataResponseMonitoringV3>(
            'metadata');
