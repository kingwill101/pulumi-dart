...
class HttpCheck {
  ...
  final List<ResponseStatusCode>? acceptedResponseStatusCodes;

  /// The authentication information. Optional when creating an HTTP check; defaults to empty.
  final BasicAuthentication? authInfo;
  ...
  final HttpCheckContentType? contentType;
  ...
  final HttpCheckRequestMethod? requestMethod;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (requestMethodValue != null) {
      map['requestMethod'] = requestMethodValue.value;
    }
  ...
  factory HttpCheck.fromMap(Map<String, dynamic> map) {
    return HttpCheck(
      ...
      contentType: map['contentType'] == null
          ? null
          : HttpCheckContentType.fromValue(map['contentType'] as String),
      ...
      requestMethod: map['requestMethod'] == null
          ? null
          : HttpCheckRequestMethod.fromValue(map['requestMethod'] as String),
