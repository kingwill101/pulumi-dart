...
enum AggregationCrossSeriesReducer2 {
  ...
  const AggregationCrossSeriesReducer2(this.value);
  final String value;

  static AggregationCrossSeriesReducer2 fromValue(String value) {
    for (final item in AggregationCrossSeriesReducer2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown AggregationCrossSeriesReducer2 value: $value');
  }
}
