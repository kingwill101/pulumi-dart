...
class MetricDescriptor3 extends CustomResource {
  ...
  late final Output<List<LabelDescriptorResponse2>> labels;

  /// Optional. The launch stage of the metric definition.
  late final Output<String> launchStage;

  /// Optional. Metadata which can be used to guide usage of the metric.
  late final Output<MetricDescriptorMetadataResponse2> metadata;
