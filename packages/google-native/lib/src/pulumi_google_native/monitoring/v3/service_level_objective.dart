...
class ServiceLevelObjective extends CustomResource {
  ...
  late final Output<String> rollingPeriod;
  late final Output<String> serviceId;

  /// The definition of good service, used to measure and calculate the quality of the Service's performance with respect to a single aspect of service quality.
  late final Output<ServiceLevelIndicatorResponse> serviceLevelIndicator;
  ...
  late final Output<String?> serviceLevelObjectiveId;
