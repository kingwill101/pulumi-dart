...
class GetIndexResult6 {
  ...
  factory GetIndexResult6.fromMap(Map<String, dynamic> map) {
    return GetIndexResult6(
      fields: Input.decodeList<GoogleFirestoreAdminV1beta2IndexFieldResponse>(
          map['fields'],
          (value) => GoogleFirestoreAdminV1beta2IndexFieldResponse.fromMap(
