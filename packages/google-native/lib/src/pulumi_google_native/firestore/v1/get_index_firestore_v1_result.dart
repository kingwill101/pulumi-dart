...
class GetIndexFirestoreV1Result {
  ...
  factory GetIndexFirestoreV1Result.fromMap(Map<String, dynamic> map) {
    return GetIndexFirestoreV1Result(
      apiScope: map['apiScope'] as String,
      fields: pulumi.Input.decodeList<GoogleFirestoreAdminV1IndexFieldResponse>(
          map['fields'],
