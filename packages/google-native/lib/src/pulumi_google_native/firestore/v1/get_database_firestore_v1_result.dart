...
class GetDatabaseFirestoreV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['appEngineIntegrationMode'] = appEngineIntegrationMode;
    map['concurrencyMode'] = concurrencyMode;
    map['createTime'] = createTime;
    map['deleteProtectionState'] = deleteProtectionState;
    map['earliestVersionTime'] = earliestVersionTime;
    map['etag'] = etag;
    map['keyPrefix'] = keyPrefix;
    map['location'] = location;
    map['name'] = name;
    map['pointInTimeRecoveryEnablement'] = pointInTimeRecoveryEnablement;
    map['type'] = type;
    map['uid'] = uid;
  ...
  factory GetDatabaseFirestoreV1Result.fromMap(Map<String, dynamic> map) {
    return GetDatabaseFirestoreV1Result(
