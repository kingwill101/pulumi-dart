...
class AuditLogConfigResponseDeploymentmanagerV2beta {
  ...
  factory AuditLogConfigResponseDeploymentmanagerV2beta.fromMap(
      Map<String, dynamic> map) {
    return AuditLogConfigResponseDeploymentmanagerV2beta(
