...
class GetTypeProviderResult2 {
  /// Allows resource handling overrides for specific collections
  final List<CollectionOverrideResponse2> collectionOverrides;

  /// Credential used when interacting with this type.
  final CredentialResponse2 credential;
  ...
  final List<TypeProviderLabelEntryResponse2> labels;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['collectionOverrides'] =
        Input.encodeList<CollectionOverrideResponse2, Map<String, dynamic>>(
    ...
    map['labels'] =
        Input.encodeList<TypeProviderLabelEntryResponse2, Map<String, dynamic>>(
  ...
  factory GetTypeProviderResult2.fromMap(Map<String, dynamic> map) {
    return GetTypeProviderResult2(
      collectionOverrides: Input.decodeList<CollectionOverrideResponse2>(
          map['collectionOverrides'],
          (value) => CollectionOverrideResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      credential: CredentialResponse2.fromMap(
      ...
      labels: Input.decodeList<TypeProviderLabelEntryResponse2>(
          map['labels'],
          (value) => TypeProviderLabelEntryResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
