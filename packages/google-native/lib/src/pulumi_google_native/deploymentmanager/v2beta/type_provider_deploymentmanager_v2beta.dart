...
class TypeProviderDeploymentmanagerV2beta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<CollectionOverrideResponseDeploymentmanagerV2beta>>
      collectionOverrides;
  ...
  late final pulumi
      .Output<List<TypeProviderLabelEntryResponseDeploymentmanagerV2beta>>
      labels;
  ...
  TypeProviderDeploymentmanagerV2beta(
    ...
    this.collectionOverrides =
        registerOutput<List<CollectionOverrideResponseDeploymentmanagerV2beta>>(
            'collectionOverrides');
    this.credential =
        registerOutput<CredentialResponseDeploymentmanagerV2beta>('credential');
    ...
    this.labels = registerOutput<
        List<TypeProviderLabelEntryResponseDeploymentmanagerV2beta>>('labels');
    this.name = registerOutput<String>('name');
    this.operation =
        registerOutput<OperationResponseDeploymentmanagerV2beta>('operation');
    this.options =
        registerOutput<OptionsResponseDeploymentmanagerV2beta>('options');
