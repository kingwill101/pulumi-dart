...
class AuditLogConfig32 {
  ...
  factory AuditLogConfig32.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig32(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType32.fromValue(map['logType'] as String),
    );
  }
}
