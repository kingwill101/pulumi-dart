...
class OperationResponseDeploymentmanagerV2beta {
  ...
  final OperationErrorResponseDeploymentmanagerV2beta error;
  ...
  final InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2beta
  ...
  final SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2beta
  ...
  final List<OperationWarningsItemResponseDeploymentmanagerV2beta> warnings;
  ...
  factory OperationResponseDeploymentmanagerV2beta.fromMap(
    ...
    return OperationResponseDeploymentmanagerV2beta(
      ...
      error: OperationErrorResponseDeploymentmanagerV2beta.fromMap(
      ...
      warnings: pulumi.Input.decodeList<
          ...
          map['warnings'],
          (value) =>
              OperationWarningsItemResponseDeploymentmanagerV2beta.fromMap(
