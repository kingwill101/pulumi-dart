...
import 'instances_bulk_insert_operation_metadata_response3.dart';
import 'operation_error_response3.dart';
import 'operation_warnings_item_response3.dart';
import 'set_common_instance_metadata_operation_metadata_response3.dart';
...
class OperationResponse4 {
  ...
  final OperationErrorResponse3 error;
  ...
  final InstancesBulkInsertOperationMetadataResponse3
  ...
  final SetCommonInstanceMetadataOperationMetadataResponse3
  ...
  final List<OperationWarningsItemResponse3> warnings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['user'] = user;
    map['warnings'] =
        Input.encodeList<OperationWarningsItemResponse3, Map<String, dynamic>>(
            warnings, (value) => value.toMap());
    map['zone'] = zone;
    return map;
  }

  factory OperationResponse4.fromMap(Map<String, dynamic> map) {
    return OperationResponse4(
      clientOperationId: map['clientOperationId'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      endTime: map['endTime'] as String,
      error: OperationErrorResponse3.fromMap(
      ...
      instancesBulkInsertOperationMetadata:
          InstancesBulkInsertOperationMetadataResponse3.fromMap(
      ...
      setCommonInstanceMetadataOperationMetadata:
          SetCommonInstanceMetadataOperationMetadataResponse3.fromMap(
      ...
      warnings: Input.decodeList<OperationWarningsItemResponse3>(
          map['warnings'],
          (value) => OperationWarningsItemResponse3.fromMap(
