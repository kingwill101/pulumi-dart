...
class DeploymentType8 extends CustomResource {
  ...
  late final Output<List<DeploymentLabelEntryResponse3>> labels;
  ...
  late final Output<TargetConfigurationResponse3> target;
  ...
  late final Output<DeploymentUpdateResponse3> update;
  ...
  DeploymentType8(
    ...
    this.labels = registerOutput<List<DeploymentLabelEntryResponse3>>('labels');
    ...
    this.target = registerOutput<TargetConfigurationResponse3>('target');
    this.update = registerOutput<DeploymentUpdateResponse3>('update');
