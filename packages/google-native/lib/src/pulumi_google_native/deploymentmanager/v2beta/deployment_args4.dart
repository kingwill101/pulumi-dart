...
import 'deployment_label_entry3.dart';
import 'target_configuration3.dart';
...
class DeploymentArgs4 {
  ...
  final Input<List<DeploymentLabelEntry3>>? labels;
  ...
  final Input<TargetConfiguration3>? target;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (labelsValue != null) {
      map['labels'] = Input.mapOptionalInputValue<List<DeploymentLabelEntry3>,
              List<Map<String, dynamic>>>(
          labelsValue,
          (value) =>
              Input.encodeList<DeploymentLabelEntry3, Map<String, dynamic>>(
    ...
    if (targetValue != null) {
      map['target'] = Input.mapOptionalInputValue<TargetConfiguration3,
  ...
  factory DeploymentArgs4.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs4(
      ...
      labels: Input.asOptionalInput<List<DeploymentLabelEntry3>>(map['labels']),
      name: Input.asOptionalInput<String>(map['name']),
      preview: Input.asOptionalInput<bool>(map['preview']),
      project: Input.asOptionalInput<String>(map['project']),
      target: Input.asOptionalInput<TargetConfiguration3>(map['target']),
    );
  }
}
