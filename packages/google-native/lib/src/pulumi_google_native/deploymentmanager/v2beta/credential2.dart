...
import 'basic_auth2.dart';
import 'service_account7.dart';

/// The credential used by Deployment Manager and TypeProvider. Only one of the options is permitted.
class Credential2 {
  /// Basic Auth Credential, only used by TypeProvider.
  final BasicAuth2? basicAuth;

  /// Service Account Credential, only used by Deployment.
  final ServiceAccount7? serviceAccount;
  ...
  factory Credential2.fromMap(Map<String, dynamic> map) {
    return Credential2(
