...
class AuditLogConfig30 {
  ...
  factory AuditLogConfig30.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig30(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType30.fromValue(map['logType'] as String),
    );
  }
}
