...
class GetDeploymentResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['labels'] =
        Input.encodeList<DeploymentLabelEntryResponse, Map<String, dynamic>>(
            labels, (value) => value.toMap());
    map['manifest'] = manifest;
    map['name'] = name;
    map['operation'] = operation.toMap();
    map['outputs'] =
        Input.encodeList<DeploymentOutputEntryResponse, Map<String, dynamic>>(
  ...
  factory GetDeploymentResult2.fromMap(Map<String, dynamic> map) {
    return GetDeploymentResult2(
      ...
      labels: Input.decodeList<DeploymentLabelEntryResponse>(
          map['labels'],
      ...
      outputs: Input.decodeList<DeploymentOutputEntryResponse>(
          map['outputs'],
