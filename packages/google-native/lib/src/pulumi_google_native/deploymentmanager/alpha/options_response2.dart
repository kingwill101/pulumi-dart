...
class OptionsResponse2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['asyncOptions'] =
        Input.encodeList<AsyncOptionsResponse, Map<String, dynamic>>(
            asyncOptions, (value) => value.toMap());
    map['inputMappings'] =
        Input.encodeList<InputMappingResponse, Map<String, dynamic>>(
  ...
  factory OptionsResponse2.fromMap(Map<String, dynamic> map) {
    return OptionsResponse2(
      asyncOptions: Input.decodeList<AsyncOptionsResponse>(
          map['asyncOptions'],
          (value) => AsyncOptionsResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      inputMappings: Input.decodeList<InputMappingResponse>(
          map['inputMappings'],
