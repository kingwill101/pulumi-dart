...
import 'deployment_deploymentmanager_alpha_args.dart';
...
class DeploymentDeploymentmanagerAlpha extends pulumi.CustomResource {
  ...
  DeploymentDeploymentmanagerAlpha(
    String name, {
    DeploymentDeploymentmanagerAlphaArgs? args,
