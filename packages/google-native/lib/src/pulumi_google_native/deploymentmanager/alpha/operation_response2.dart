...
class OperationResponse2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['user'] = user;
    map['warnings'] =
        Input.encodeList<OperationWarningsItemResponse, Map<String, dynamic>>(
            warnings, (value) => value.toMap());
    map['zone'] = zone;
    return map;
  }

  factory OperationResponse2.fromMap(Map<String, dynamic> map) {
    return OperationResponse2(
      ...
      warnings: Input.decodeList<OperationWarningsItemResponse>(
          map['warnings'],
