...
class OperationResponseDeploymentmanagerAlpha {
  ...
  final InstancesBulkInsertOperationMetadataResponse
  ...
  final SetCommonInstanceMetadataOperationMetadataResponse
  ...
  OperationResponseDeploymentmanagerAlpha({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['user'] = user;
    map['warnings'] = pulumi.Input.encodeList<OperationWarningsItemResponse,
        Map<String, dynamic>>(warnings, (value) => value.toMap());
    map['zone'] = zone;
    return map;
  }

  factory OperationResponseDeploymentmanagerAlpha.fromMap(
      Map<String, dynamic> map) {
    return OperationResponseDeploymentmanagerAlpha(
      ...
      warnings: pulumi.Input.decodeList<OperationWarningsItemResponse>(
          map['warnings'],
