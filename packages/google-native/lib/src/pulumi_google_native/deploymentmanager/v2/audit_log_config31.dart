...
class AuditLogConfig31 {
  ...
  factory AuditLogConfig31.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig31(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType31.fromValue(map['logType'] as String),
    );
  }
}
