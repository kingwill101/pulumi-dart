...
import 'instances_bulk_insert_operation_metadata_response2.dart';
import 'operation_error_response2.dart';
import 'operation_warnings_item_response2.dart';
import 'set_common_instance_metadata_operation_metadata_response2.dart';
...
class OperationResponse3 {
  ...
  final OperationErrorResponse2 error;
  ...
  final InstancesBulkInsertOperationMetadataResponse2
  ...
  final SetCommonInstanceMetadataOperationMetadataResponse2
  ...
  final List<OperationWarningsItemResponse2> warnings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['user'] = user;
    map['warnings'] =
        Input.encodeList<OperationWarningsItemResponse2, Map<String, dynamic>>(
            warnings, (value) => value.toMap());
    map['zone'] = zone;
    return map;
  }

  factory OperationResponse3.fromMap(Map<String, dynamic> map) {
    return OperationResponse3(
      clientOperationId: map['clientOperationId'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      endTime: map['endTime'] as String,
      error: OperationErrorResponse2.fromMap(
      ...
      instancesBulkInsertOperationMetadata:
          InstancesBulkInsertOperationMetadataResponse2.fromMap(
      ...
      setCommonInstanceMetadataOperationMetadata:
          SetCommonInstanceMetadataOperationMetadataResponse2.fromMap(
      ...
      warnings: Input.decodeList<OperationWarningsItemResponse2>(
          map['warnings'],
          (value) => OperationWarningsItemResponse2.fromMap(
