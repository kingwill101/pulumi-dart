...
class DeploymentType7 extends CustomResource {
  ...
  late final Output<List<DeploymentLabelEntryResponse2>> labels;
  ...
  late final Output<OperationResponse3> operation;
  ...
  late final Output<TargetConfigurationResponse2> target;
  ...
  late final Output<DeploymentUpdateResponse2> update;
