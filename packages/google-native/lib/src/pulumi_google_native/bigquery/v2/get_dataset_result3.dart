...
class GetDatasetResult3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['access'] =
        Input.encodeList<DatasetAccessItemResponse, Map<String, dynamic>>(
    ...
    map['defaultEncryptionConfiguration'] =
        defaultEncryptionConfiguration.toMap();
    ...
    map['etag'] = etag;
    map['externalDatasetReference'] = externalDatasetReference.toMap();
    ...
    map['tags'] =
        Input.encodeList<DatasetTagsItemResponse, Map<String, dynamic>>(
            tags, (value) => value.toMap());
    return map;
  }

  factory GetDatasetResult3.fromMap(Map<String, dynamic> map) {
    return GetDatasetResult3(
      access: Input.decodeList<DatasetAccessItemResponse>(
          map['access'],
      ...
      tags: Input.decodeList<DatasetTagsItemResponse>(
          map['tags'],
