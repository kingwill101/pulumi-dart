...
class JobConfigurationLoadResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['destinationTableProperties'] = destinationTableProperties.toMap();
    ...
    map['nullMarker'] = nullMarker;
    map['parquetOptions'] = parquetOptions.toMap();
    map['preserveAsciiControlCharacters'] = preserveAsciiControlCharacters;
    map['projectionFields'] = projectionFields;
    map['quote'] = quote;
    map['rangePartitioning'] = rangePartitioning.toMap();
    map['referenceFileSchemaUri'] = referenceFileSchemaUri;
    map['schema'] = schema.toMap();
    map['schemaInline'] = schemaInline;
    map['schemaInlineFormat'] = schemaInlineFormat;
  ...
  factory JobConfigurationLoadResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationLoadResponse(
      ...
      destinationTableProperties: DestinationTablePropertiesResponse.fromMap(
          (map['destinationTableProperties'] as Map).cast<String, dynamic>()),
