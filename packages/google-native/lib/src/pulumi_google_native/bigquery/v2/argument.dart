...
class Argument {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (argumentKindValue != null) {
      map['argumentKind'] = argumentKindValue.value;
    }
    final dataTypeValue = dataType;
    if (dataTypeValue != null) {
      map['dataType'] = dataTypeValue.toMap();
    }
    final isAggregateValue = isAggregate;
    if (isAggregateValue != null) {
      map['isAggregate'] = isAggregateValue;
    }
  ...
  factory Argument.fromMap(Map<String, dynamic> map) {
    return Argument(
      ...
      isAggregate:
          map['isAggregate'] == null ? null : map['isAggregate'] as bool,
      mode: map['mode'] == null
          ? null
