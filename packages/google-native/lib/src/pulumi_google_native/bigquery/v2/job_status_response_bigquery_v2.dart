...
class JobStatusResponseBigqueryV2 {
  ...
  factory JobStatusResponseBigqueryV2.fromMap(Map<String, dynamic> map) {
    return JobStatusResponseBigqueryV2(
