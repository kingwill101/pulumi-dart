...
class AuditLogConfig5 {
  ...
  factory AuditLogConfig5.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig5(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType5.fromValue(map['logType'] as String),
    );
  }
}
