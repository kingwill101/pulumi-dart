...
class JobConfigurationQuery {
  ...
  Map<String, dynamic> toMap() {
    ...
    final preserveNullsValue = preserveNulls;
    if (preserveNullsValue != null) {
      map['preserveNulls'] = preserveNullsValue;
    }
    ...
    final tableDefinitionsValue = tableDefinitions;
    if (tableDefinitionsValue != null) {
      map['tableDefinitions'] = tableDefinitionsValue;
    }
  ...
  factory JobConfigurationQuery.fromMap(Map<String, dynamic> map) {
    return JobConfigurationQuery(
      ...
      preserveNulls:
          map['preserveNulls'] == null ? null : map['preserveNulls'] as bool,
