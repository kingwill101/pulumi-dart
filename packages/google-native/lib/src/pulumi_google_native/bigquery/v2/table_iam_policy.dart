...
class TableIamPolicy extends CustomResource {
  ...
  TableIamPolicy(
    ...
    this.auditConfigs = Output.createUnknown<List<AuditConfigResponse5>>();
    this.bindings = Output.createUnknown<List<BindingResponse9>>();
