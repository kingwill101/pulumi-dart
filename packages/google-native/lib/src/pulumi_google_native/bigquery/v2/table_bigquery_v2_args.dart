...
class TableBigqueryV2Args {
  ...
  factory TableBigqueryV2Args.fromMap(Map<String, dynamic> map) {
    return TableBigqueryV2Args(
      biglakeConfiguration: pulumi.Input.asOptionalInput<BigLakeConfiguration>(
          map['biglakeConfiguration']),
      clustering: pulumi.Input.asOptionalInput<Clustering>(map['clustering']),
      ...
      model: pulumi.Input.asOptionalInput<ModelDefinition>(map['model']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      rangePartitioning: pulumi.Input.asOptionalInput<RangePartitioning>(
      ...
      tableConstraints: pulumi.Input.asOptionalInput<TableConstraints>(
          map['tableConstraints']),
      tableReference:
          pulumi.Input.asOptionalInput<TableReference>(map['tableReference']),
      timePartitioning: pulumi.Input.asOptionalInput<TimePartitioning>(
          map['timePartitioning']),
      view: pulumi.Input.asOptionalInput<ViewDefinition>(map['view']),
    );
  }
}
