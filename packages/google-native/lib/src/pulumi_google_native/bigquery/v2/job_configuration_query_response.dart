...
class JobConfigurationQueryResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['defaultDataset'] = defaultDataset.toMap();
    ...
    map['flattenResults'] = flattenResults;
    map['maximumBillingTier'] = maximumBillingTier;
    map['maximumBytesBilled'] = maximumBytesBilled;
    map['parameterMode'] = parameterMode;
    ...
    map['tableDefinitions'] = tableDefinitions;
