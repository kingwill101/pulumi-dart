...
class SearchStatisticsResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['indexUnusedReasons'] =
        Input.encodeList<IndexUnusedReasonResponse, Map<String, dynamic>>(
            indexUnusedReasons, (value) => value.toMap());
  ...
  factory SearchStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return SearchStatisticsResponse(
      indexUnusedReasons: Input.decodeList<IndexUnusedReasonResponse>(
          map['indexUnusedReasons'],
