...
class GooglePrivacyDlpV2ExclusionRuleResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['excludeByHotword'] = excludeByHotword.toMap();
    map['excludeInfoTypes'] = excludeInfoTypes.toMap();
    map['matchingType'] = matchingType;
    map['regex'] = regex.toMap();
    return map;
  }

  factory GooglePrivacyDlpV2ExclusionRuleResponse.fromMap(
    ...
    return GooglePrivacyDlpV2ExclusionRuleResponse(
      ...
      excludeByHotword: GooglePrivacyDlpV2ExcludeByHotwordResponse.fromMap(
          (map['excludeByHotword'] as Map).cast<String, dynamic>()),
      excludeInfoTypes: GooglePrivacyDlpV2ExcludeInfoTypesResponse.fromMap(
