...
class GooglePrivacyDlpV2CloudStorageOptionsResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bytesLimitPerFile'] = bytesLimitPerFile;
    map['bytesLimitPerFilePercent'] = bytesLimitPerFilePercent;
    map['fileSet'] = fileSet.toMap();
    map['fileTypes'] = fileTypes;
    map['filesLimitPercent'] = filesLimitPercent;
    map['sampleMethod'] = sampleMethod;
    return map;
  }
  ...
  factory GooglePrivacyDlpV2CloudStorageOptionsResponse.fromMap(
    ...
    return GooglePrivacyDlpV2CloudStorageOptionsResponse(
      ...
      fileSet: GooglePrivacyDlpV2FileSetResponse.fromMap(
