...
class GooglePrivacyDlpV2DeidentifyConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final transformationErrorHandlingValue = transformationErrorHandling;
    if (transformationErrorHandlingValue != null) {
      map['transformationErrorHandling'] =
          transformationErrorHandlingValue.toMap();
    }
    return map;
  }
