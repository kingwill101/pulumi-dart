...
class DiscoveryConfigArgs {
  ...
  final Input<DiscoveryConfigStatus> status;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['status'] = Input.mapInputValue<DiscoveryConfigStatus, String>(
  ...
  factory DiscoveryConfigArgs.fromMap(Map<String, dynamic> map) {
    return DiscoveryConfigArgs(
      ...
      status: Input.asInput<DiscoveryConfigStatus>(map['status']),
