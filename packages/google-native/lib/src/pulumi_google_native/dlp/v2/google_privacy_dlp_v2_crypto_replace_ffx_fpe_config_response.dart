...
class GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['commonAlphabet'] = commonAlphabet;
    map['context'] = context.toMap();
    map['cryptoKey'] = cryptoKey.toMap();
    map['customAlphabet'] = customAlphabet;
    map['radix'] = radix;
  ...
  factory GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse.fromMap(
    ...
    return GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse(
      commonAlphabet: map['commonAlphabet'] as String,
      ...
      customAlphabet: map['customAlphabet'] as String,
      radix: map['radix'] as int,
