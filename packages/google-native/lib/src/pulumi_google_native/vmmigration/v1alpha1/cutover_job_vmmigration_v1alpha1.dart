...
class CutoverJobVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<ComputeEngineDisksTargetDetailsResponseVmmigrationV1alpha1>
      computeEngineDisksTargetDetails;

  /// Details of the target VM in Compute Engine.
  late final pulumi
      .Output<ComputeEngineTargetDetailsResponseVmmigrationV1alpha1>
  ...
  late final pulumi.Output<List<CutoverStepResponseVmmigrationV1alpha1>> steps;
  ...
  CutoverJobVmmigrationV1alpha1(
    ...
    this.computeEngineDisksTargetDetails = registerOutput<
    ...
    this.steps =
        registerOutput<List<CutoverStepResponseVmmigrationV1alpha1>>('steps');
    this.targetDetails =
