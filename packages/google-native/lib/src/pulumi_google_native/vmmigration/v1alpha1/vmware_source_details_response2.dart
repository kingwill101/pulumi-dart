...
class VmwareSourceDetailsResponse2 {
  ...
  factory VmwareSourceDetailsResponse2.fromMap(Map<String, dynamic> map) {
    return VmwareSourceDetailsResponse2(
