...
class ComputeEngineTargetDefaultsResponse2 {
  ...
  ComputeEngineTargetDefaultsResponse2({
  ...
  factory ComputeEngineTargetDefaultsResponse2.fromMap(
      Map<String, dynamic> map) {
    return ComputeEngineTargetDefaultsResponse2(
