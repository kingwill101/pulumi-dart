...
class GetDatacenterConnectorResult2 {
  ...
  final AvailableUpdatesResponse2 availableVersions;
  ...
  final UpgradeStatusResponse2 upgradeStatus;

  /// The version running in the DatacenterConnector. This is supplied by the OVA connector during the registration process and can not be modified.
  final String version;

  GetDatacenterConnectorResult2({
  ...
  factory GetDatacenterConnectorResult2.fromMap(Map<String, dynamic> map) {
    return GetDatacenterConnectorResult2(
      applianceInfrastructureVersion:
          map['applianceInfrastructureVersion'] as String,
      applianceSoftwareVersion: map['applianceSoftwareVersion'] as String,
      availableVersions: AvailableUpdatesResponse2.fromMap(
      ...
      upgradeStatus: UpgradeStatusResponse2.fromMap(
