...
import 'group_migration_target_type2.dart';
...
class GroupArgs8 {
  ...
  final Input<GroupMigrationTargetType2>? migrationTargetType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (migrationTargetTypeValue != null) {
      map['migrationTargetType'] =
          Input.mapOptionalInputValue<GroupMigrationTargetType2, String>(
  ...
  factory GroupArgs8.fromMap(Map<String, dynamic> map) {
    return GroupArgs8(
      ...
      migrationTargetType: Input.asOptionalInput<GroupMigrationTargetType2>(
          map['migrationTargetType']),
