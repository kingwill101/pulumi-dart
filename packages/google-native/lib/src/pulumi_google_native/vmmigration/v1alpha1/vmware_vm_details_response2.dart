...
class VmwareVmDetailsResponse2 {
  /// The VM Boot Option.
  ...
  Map<String, dynamic> toMap() {
    ...
    map['committedStorage'] = committedStorage;
    map['committedStorageMb'] = committedStorageMb;
    map['cpuCount'] = cpuCount;
    map['datacenterDescription'] = datacenterDescription;
    map['datacenterId'] = datacenterId;
    map['diskCount'] = diskCount;
    map['displayName'] = displayName;
    map['guestDescription'] = guestDescription;
    map['memoryMb'] = memoryMb;
    map['powerState'] = powerState;
    map['uuid'] = uuid;
    map['vmId'] = vmId;
    return map;
  }

  factory VmwareVmDetailsResponse2.fromMap(Map<String, dynamic> map) {
    return VmwareVmDetailsResponse2(
      bootOption: map['bootOption'] as String,
      committedStorage: map['committedStorage'] as String,
