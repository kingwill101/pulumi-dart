...
import 'compute_engine_target_defaults_disk_type2.dart';
import 'compute_engine_target_defaults_license_type2.dart';
import 'compute_scheduling2.dart';
import 'encryption3.dart';
import 'network_interface7.dart';

/// ComputeEngineTargetDefaults is a collection of details for creating a VM in a target Compute Engine project.
class ComputeEngineTargetDefaults2 {
  ...
  final ComputeEngineTargetDefaultsDiskType2? diskType;
  ...
  final ComputeEngineTargetDefaultsLicenseType2? licenseType;
  ...
  factory ComputeEngineTargetDefaults2.fromMap(Map<String, dynamic> map) {
    return ComputeEngineTargetDefaults2(
      ...
      diskType: map['diskType'] == null
          ? null
          : ComputeEngineTargetDefaultsDiskType2.fromValue(
      ...
      licenseType: map['licenseType'] == null
          ? null
          : ComputeEngineTargetDefaultsLicenseType2.fromValue(
