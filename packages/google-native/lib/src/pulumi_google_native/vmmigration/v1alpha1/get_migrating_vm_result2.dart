...
class GetMigratingVmResult2 {
  /// Details of the VM from an AWS source.
  final AwsSourceVmDetailsResponse2 awsSourceVmDetails;

  /// Details of the VM from an Azure source.
  final AzureSourceVmDetailsResponse2 azureSourceVmDetails;

  /// Details of the target Persistent Disks in Compute Engine.
  final ComputeEngineDisksTargetDefaultsResponse2
      computeEngineDisksTargetDefaults;

  /// Details of the target VM in Compute Engine.
  final ComputeEngineTargetDefaultsResponse2 computeEngineTargetDefaults;
  ...
  final ReplicationCycleResponse2 lastReplicationCycle;

  /// The most updated snapshot created time in the source that finished replication.
  final ReplicationSyncResponse2 lastSync;

  /// The identifier of the MigratingVm.
  final String name;

  /// The replication schedule policy.
  final SchedulePolicyResponse2 policy;
  ...
  final List<CloneJobResponse2> recentCloneJobs;
  ...
  final List<CutoverJobResponse2> recentCutoverJobs;
  ...
  final VmwareSourceVmDetailsResponse2 vmwareSourceVmDetails;

  GetMigratingVmResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['recentCloneJobs'] =
        Input.encodeList<CloneJobResponse2, Map<String, dynamic>>(
            recentCloneJobs, (value) => value.toMap());
    map['recentCutoverJobs'] =
        Input.encodeList<CutoverJobResponse2, Map<String, dynamic>>(
  ...
  factory GetMigratingVmResult2.fromMap(Map<String, dynamic> map) {
    return GetMigratingVmResult2(
      awsSourceVmDetails: AwsSourceVmDetailsResponse2.fromMap(
          (map['awsSourceVmDetails'] as Map).cast<String, dynamic>()),
      azureSourceVmDetails: AzureSourceVmDetailsResponse2.fromMap(
          (map['azureSourceVmDetails'] as Map).cast<String, dynamic>()),
      computeEngineDisksTargetDefaults:
          ComputeEngineDisksTargetDefaultsResponse2.fromMap(
              (map['computeEngineDisksTargetDefaults'] as Map)
                  .cast<String, dynamic>()),
      computeEngineTargetDefaults: ComputeEngineTargetDefaultsResponse2.fromMap(
      ...
      currentSyncInfo: ReplicationCycleResponse2.fromMap(
          (map['currentSyncInfo'] as Map).cast<String, dynamic>()),
      cutoverForecast: CutoverForecastResponse2.fromMap(
      ...
      lastReplicationCycle: ReplicationCycleResponse2.fromMap(
          (map['lastReplicationCycle'] as Map).cast<String, dynamic>()),
      lastSync: ReplicationSyncResponse2.fromMap(
          (map['lastSync'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      policy: SchedulePolicyResponse2.fromMap(
          (map['policy'] as Map).cast<String, dynamic>()),
      recentCloneJobs: Input.decodeList<CloneJobResponse2>(
          map['recentCloneJobs'],
          (value) => CloneJobResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      recentCutoverJobs: Input.decodeList<CutoverJobResponse2>(
          map['recentCutoverJobs'],
          (value) => CutoverJobResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      vmwareSourceVmDetails: VmwareSourceVmDetailsResponse2.fromMap(
