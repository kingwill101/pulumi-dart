...
class VmUtilizationMetricsResponse2 {
  ...
  factory VmUtilizationMetricsResponse2.fromMap(Map<String, dynamic> map) {
    return VmUtilizationMetricsResponse2(
