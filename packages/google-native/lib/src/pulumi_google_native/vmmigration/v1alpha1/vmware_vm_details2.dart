...
import 'vmware_vm_details_power_state2.dart';

/// VmwareVmDetails describes a VM in vCenter.
class VmwareVmDetails2 {
  ...
  final VmwareVmDetailsPowerState2? powerState;
  ...
  Map<String, dynamic> toMap() {
    ...
    final committedStorageValue = committedStorage;
    if (committedStorageValue != null) {
      map['committedStorage'] = committedStorageValue;
    }
  ...
  factory VmwareVmDetails2.fromMap(Map<String, dynamic> map) {
    return VmwareVmDetails2(
      ...
      powerState: map['powerState'] == null
          ? null
          : VmwareVmDetailsPowerState2.fromValue(map['powerState'] as String),
