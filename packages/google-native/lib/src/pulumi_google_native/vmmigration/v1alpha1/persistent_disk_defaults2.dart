...
import 'persistent_disk_defaults_disk_type2.dart';
import 'vm_attachment_details2.dart';

/// Details for creation of a Persistent Disk.
class PersistentDiskDefaults2 {
  ...
  final PersistentDiskDefaultsDiskType2? diskType;
  ...
  final VmAttachmentDetails2? vmAttachmentDetails;

  PersistentDiskDefaults2({
  ...
  factory PersistentDiskDefaults2.fromMap(Map<String, dynamic> map) {
    return PersistentDiskDefaults2(
      ...
      diskType: map['diskType'] == null
          ? null
          : PersistentDiskDefaultsDiskType2.fromValue(
