...
import 'available_updates_response2.dart';
import 'datacenter_connector_args2.dart';
import 'status_response31.dart';
import 'upgrade_status_response2.dart';

/// Creates a new DatacenterConnector in a given Source.
/// Auto-naming is currently not supported for this resource.
class DatacenterConnector2 extends CustomResource {
  ...
  late final Output<AvailableUpdatesResponse2> availableVersions;
  ...
  late final Output<UpgradeStatusResponse2> upgradeStatus;

  /// The version running in the DatacenterConnector. This is supplied by the OVA connector during the registration process and can not be modified.
  late final Output<String> version;

  DatacenterConnector2(
    String name, {
    DatacenterConnectorArgs2? args,
    ...
    this.availableVersions = Output.createUnknown<AvailableUpdatesResponse2>();
    ...
    this.upgradeStatus = Output.createUnknown<UpgradeStatusResponse2>();
