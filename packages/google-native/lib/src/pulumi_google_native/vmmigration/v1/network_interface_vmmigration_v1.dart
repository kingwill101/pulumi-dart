...
class NetworkInterfaceVmmigrationV1 {
  ...
  factory NetworkInterfaceVmmigrationV1.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceVmmigrationV1(
      externalIp:
