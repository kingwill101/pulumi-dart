...
class GetGroupVmmigrationV1Result {
  ...
  factory GetGroupVmmigrationV1Result.fromMap(Map<String, dynamic> map) {
    return GetGroupVmmigrationV1Result(
