...
import 'migration_job_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class MigrationJobIamBinding2 extends CustomResource {
  ...
  MigrationJobIamBinding2(
    String name, {
    MigrationJobIamBindingArgs2? args,
