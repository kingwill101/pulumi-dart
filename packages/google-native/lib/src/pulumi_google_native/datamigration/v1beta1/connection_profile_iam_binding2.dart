...
import 'connection_profile_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ConnectionProfileIamBinding2 extends CustomResource {
  ...
  ConnectionProfileIamBinding2(
    String name, {
    ConnectionProfileIamBindingArgs2? args,
