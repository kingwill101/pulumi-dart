...
import 'connection_profile_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ConnectionProfileIamMember2 extends CustomResource {
  ...
  ConnectionProfileIamMember2(
    String name, {
    ConnectionProfileIamMemberArgs2? args,
