...
import 'cloud_sql_settings_activation_policy2.dart';
import 'cloud_sql_settings_data_disk_type2.dart';
import 'cloud_sql_settings_database_version2.dart';
import 'sql_ip_config2.dart';

/// Settings for creating a Cloud SQL database instance.
class CloudSqlSettings2 {
  /// The activation policy specifies when the instance is activated; it is applicable only when the instance state is 'RUNNABLE'. Valid values: 'ALWAYS': The instance is on, and remains so even in the absence of connection requests. `NEVER`: The instance is off; it is not activated, even if a connection request arrives.
  final CloudSqlSettingsActivationPolicy2? activationPolicy;
  ...
  final CloudSqlSettingsDataDiskType2? dataDiskType;

  /// The database flags passed to the Cloud SQL instance at startup. An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
  final Map<String, String>? databaseFlags;

  /// The database engine type and version.
  final CloudSqlSettingsDatabaseVersion2? databaseVersion;

  /// The settings for IP Management. This allows to enable or disable the instance IP and manage which external networks can connect to the instance. The IPv4 address cannot be disabled.
  final SqlIpConfig2? ipConfig;
  ...
  factory CloudSqlSettings2.fromMap(Map<String, dynamic> map) {
    return CloudSqlSettings2(
      activationPolicy: map['activationPolicy'] == null
          ? null
          : CloudSqlSettingsActivationPolicy2.fromValue(
      ...
      dataDiskType: map['dataDiskType'] == null
          ? null
          : CloudSqlSettingsDataDiskType2.fromValue(
      ...
      databaseVersion: map['databaseVersion'] == null
          ? null
          : CloudSqlSettingsDatabaseVersion2.fromValue(
              map['databaseVersion'] as String),
      ipConfig: map['ipConfig'] == null
          ? null
          : SqlIpConfig2.fromMap(
