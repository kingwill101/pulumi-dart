...
class AuditLogConfig29 {
  ...
  factory AuditLogConfig29.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig29(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType29.fromValue(map['logType'] as String),
    );
  }
}
