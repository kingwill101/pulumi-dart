...
class MigrationJobIamBindingArgs2 {
  ...
  factory MigrationJobIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return MigrationJobIamBindingArgs2(
