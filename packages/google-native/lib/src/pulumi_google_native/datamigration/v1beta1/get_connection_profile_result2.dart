...
class GetConnectionProfileResult2 {
  /// A CloudSQL database connection profile.
  final CloudSqlConnectionProfileResponse2 cloudsql;
  ...
  final MySqlConnectionProfileResponse2 mysql;
  ...
  factory GetConnectionProfileResult2.fromMap(Map<String, dynamic> map) {
    return GetConnectionProfileResult2(
      cloudsql: CloudSqlConnectionProfileResponse2.fromMap(
      ...
      mysql: MySqlConnectionProfileResponse2.fromMap(
