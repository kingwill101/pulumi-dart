...
class ConnectionProfileIamBindingArgs2 {
  ...
  ConnectionProfileIamBindingArgs2({
    this.condition,
  ...
  factory ConnectionProfileIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileIamBindingArgs2(
