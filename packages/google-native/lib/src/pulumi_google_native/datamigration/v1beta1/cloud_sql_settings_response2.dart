...
import 'sql_ip_config_response2.dart';

/// Settings for creating a Cloud SQL database instance.
class CloudSqlSettingsResponse2 {
  ...
  final SqlIpConfigResponse2 ipConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['autoStorageIncrease'] = autoStorageIncrease;
    ...
    map['ipConfig'] = ipConfig.toMap();
    map['rootPassword'] = rootPassword;
    map['rootPasswordSet'] = rootPasswordSet;
  ...
  factory CloudSqlSettingsResponse2.fromMap(Map<String, dynamic> map) {
    return CloudSqlSettingsResponse2(
      ...
      ipConfig: SqlIpConfigResponse2.fromMap(
