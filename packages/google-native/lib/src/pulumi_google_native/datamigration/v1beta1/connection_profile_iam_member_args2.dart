...
class ConnectionProfileIamMemberArgs2 {
  ...
  ConnectionProfileIamMemberArgs2({
    this.condition,
  ...
  factory ConnectionProfileIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileIamMemberArgs2(
