...
class ReverseSshConnectivityResponse2 {
  ...
  ReverseSshConnectivityResponse2({
    required this.vm,
    required this.vmIp,
  ...
  factory ReverseSshConnectivityResponse2.fromMap(Map<String, dynamic> map) {
    return ReverseSshConnectivityResponse2(
      vm: map['vm'] as String,
