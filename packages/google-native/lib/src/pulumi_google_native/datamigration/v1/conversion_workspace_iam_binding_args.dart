...
/// The set of arguments for ConversionWorkspaceIamBinding.
class ConversionWorkspaceIamBindingArgs {
  ...
  ConversionWorkspaceIamBindingArgs({
    this.condition,
  ...
  factory ConversionWorkspaceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConversionWorkspaceIamBindingArgs(
