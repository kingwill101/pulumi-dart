...
class ConversionWorkspaceArgs {
  ...
  factory ConversionWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return ConversionWorkspaceArgs(
      ...
      destination: pulumi.Input.asInput<DatabaseEngineInfo>(map['destination']),
      displayName: pulumi.Input.asOptionalInput<String>(map['displayName']),
      globalSettings: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['globalSettings']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      source: pulumi.Input.asInput<DatabaseEngineInfo>(map['source']),
    );
  }
}
