...
/// The set of arguments for PrivateConnectionIamBinding.
class PrivateConnectionIamBindingArgs {
  ...
  PrivateConnectionIamBindingArgs({
    this.condition,
  ...
  factory PrivateConnectionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return PrivateConnectionIamBindingArgs(
