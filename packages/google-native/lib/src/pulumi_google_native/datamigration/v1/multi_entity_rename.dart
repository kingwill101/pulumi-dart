...
class MultiEntityRename {
  ...
  Map<String, dynamic> toMap() {
    ...
    final newNamePatternValue = newNamePattern;
    if (newNamePatternValue != null) {
      map['newNamePattern'] = newNamePatternValue;
    }
    final sourceNameTransformationValue = sourceNameTransformation;
    if (sourceNameTransformationValue != null) {
      map['sourceNameTransformation'] = sourceNameTransformationValue.value;
    }
    return map;
  }
