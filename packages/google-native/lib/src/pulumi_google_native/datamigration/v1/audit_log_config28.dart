...
class AuditLogConfig28 {
  ...
  factory AuditLogConfig28.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig28(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType28.fromValue(map['logType'] as String),
    );
  }
}
