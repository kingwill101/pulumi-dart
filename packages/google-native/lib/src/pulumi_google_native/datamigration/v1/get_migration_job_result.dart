...
class GetMigrationJobResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['conversionWorkspace'] = conversionWorkspace.toMap();
    map['createTime'] = createTime;
    map['destination'] = destination;
    map['destinationDatabase'] = destinationDatabase.toMap();
    map['displayName'] = displayName;
    map['dumpFlags'] = dumpFlags.toMap();
    ...
    map['labels'] = labels;
    map['name'] = name;
    map['performanceConfig'] = performanceConfig.toMap();
    map['phase'] = phase;
  ...
  factory GetMigrationJobResult.fromMap(Map<String, dynamic> map) {
    return GetMigrationJobResult(
      ...
      conversionWorkspace: ConversionWorkspaceInfoResponse.fromMap(
          (map['conversionWorkspace'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      destination: map['destination'] as String,
      destinationDatabase: DatabaseTypeResponse.fromMap(
          (map['destinationDatabase'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      dumpFlags: DumpFlagsResponse.fromMap(
      ...
      performanceConfig: PerformanceConfigResponse.fromMap(
          (map['performanceConfig'] as Map).cast<String, dynamic>()),
      phase: map['phase'] as String,
      reverseSshConnectivity: ReverseSshConnectivityResponse.fromMap(
          (map['reverseSshConnectivity'] as Map).cast<String, dynamic>()),
      source: map['source'] as String,
      sourceDatabase: DatabaseTypeResponse.fromMap(
      ...
      vpcPeeringConnectivity: VpcPeeringConnectivityResponse.fromMap(
