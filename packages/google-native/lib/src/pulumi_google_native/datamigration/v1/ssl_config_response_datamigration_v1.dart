...
class SslConfigResponseDatamigrationV1 {
  ...
  SslConfigResponseDatamigrationV1({
  ...
  factory SslConfigResponseDatamigrationV1.fromMap(Map<String, dynamic> map) {
    return SslConfigResponseDatamigrationV1(
