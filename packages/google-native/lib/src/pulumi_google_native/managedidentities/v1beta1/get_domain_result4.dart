...
class GetDomainResult4 {
  ...
  final List<TrustResponse3> trusts;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['trusts'] = Input.encodeList<TrustResponse3, Map<String, dynamic>>(
        trusts, (value) => value.toMap());
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetDomainResult4.fromMap(Map<String, dynamic> map) {
    return GetDomainResult4(
      ...
      trusts: Input.decodeList<TrustResponse3>(
          map['trusts'],
          (value) =>
              TrustResponse3.fromMap((value as Map).cast<String, dynamic>())),
