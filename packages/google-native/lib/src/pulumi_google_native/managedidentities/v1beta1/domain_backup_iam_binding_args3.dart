...
class DomainBackupIamBindingArgs3 {
  ...
  factory DomainBackupIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return DomainBackupIamBindingArgs3(
