...
import 'domain_backup_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DomainBackupIamBinding3 extends CustomResource {
  ...
  DomainBackupIamBinding3(
    String name, {
    DomainBackupIamBindingArgs3? args,
