...
class DomainManagedidentitiesV1Args {
  ...
  factory DomainManagedidentitiesV1Args.fromMap(Map<String, dynamic> map) {
    return DomainManagedidentitiesV1Args(
