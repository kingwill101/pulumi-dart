...
class GetDomainResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['trusts'] = Input.encodeList<TrustResponse, Map<String, dynamic>>(
        trusts, (value) => value.toMap());
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetDomainResult2.fromMap(Map<String, dynamic> map) {
    return GetDomainResult2(
      ...
      trusts: Input.decodeList<TrustResponse>(
          map['trusts'],
          (value) =>
