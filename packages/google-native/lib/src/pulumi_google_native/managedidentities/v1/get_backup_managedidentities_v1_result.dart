...
class GetBackupManagedidentitiesV1Result {
  ...
  GetBackupManagedidentitiesV1Result({
  ...
  factory GetBackupManagedidentitiesV1Result.fromMap(Map<String, dynamic> map) {
    return GetBackupManagedidentitiesV1Result(
