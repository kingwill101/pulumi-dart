...
class BackupManagedidentitiesV1Args {
  ...
  factory BackupManagedidentitiesV1Args.fromMap(Map<String, dynamic> map) {
    return BackupManagedidentitiesV1Args(
