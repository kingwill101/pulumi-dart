...
class GetDomainManagedidentitiesV1Result {
  ...
  GetDomainManagedidentitiesV1Result({
    required this.admin,
  ...
  factory GetDomainManagedidentitiesV1Result.fromMap(Map<String, dynamic> map) {
    return GetDomainManagedidentitiesV1Result(
