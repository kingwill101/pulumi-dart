...
class DomainIamMemberManagedidentitiesV1alpha1Args {
  ...
  DomainIamMemberManagedidentitiesV1alpha1Args({
    this.condition,
  ...
  factory DomainIamMemberManagedidentitiesV1alpha1Args.fromMap(
      Map<String, dynamic> map) {
    return DomainIamMemberManagedidentitiesV1alpha1Args(
