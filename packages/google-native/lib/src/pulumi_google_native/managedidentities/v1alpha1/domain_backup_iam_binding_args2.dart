...
class DomainBackupIamBindingArgs2 {
  ...
  factory DomainBackupIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return DomainBackupIamBindingArgs2(
