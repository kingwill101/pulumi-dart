...
import 'domain_backup_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DomainBackupIamBinding2 extends CustomResource {
  ...
  DomainBackupIamBinding2(
    String name, {
    DomainBackupIamBindingArgs2? args,
