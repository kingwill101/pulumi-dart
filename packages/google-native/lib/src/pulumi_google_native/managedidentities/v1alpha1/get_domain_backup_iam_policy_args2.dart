...
class GetDomainBackupIamPolicyArgs2 {
  ...
  factory GetDomainBackupIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return GetDomainBackupIamPolicyArgs2(
