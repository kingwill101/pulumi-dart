...
class ManagementServer extends CustomResource {
  ...
  late final Output<ManagementURIResponse> managementUri;
  ...
  late final Output<List<NetworkConfigResponse4>> networks;
  ...
  late final Output<WorkforceIdentityBasedManagementURIResponse>
      workforceIdentityBasedManagementUri;

  /// The OAuth client IDs for both types of user i.e. 1p and 3p.
  late final Output<WorkforceIdentityBasedOAuth2ClientIDResponse>
