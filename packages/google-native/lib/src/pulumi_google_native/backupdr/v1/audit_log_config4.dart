...
class AuditLogConfig4 {
  ...
  factory AuditLogConfig4.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig4(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType4.fromValue(map['logType'] as String),
    );
  }
}
