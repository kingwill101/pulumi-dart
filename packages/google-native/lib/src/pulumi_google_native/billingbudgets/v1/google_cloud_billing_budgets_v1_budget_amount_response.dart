...
import 'google_type_money_response_billingbudgets_v1.dart';
...
class GoogleCloudBillingBudgetsV1BudgetAmountResponse {
  ...
  final GoogleTypeMoneyResponseBillingbudgetsV1 specifiedAmount;
  ...
  factory GoogleCloudBillingBudgetsV1BudgetAmountResponse.fromMap(
    ...
    return GoogleCloudBillingBudgetsV1BudgetAmountResponse(
      ...
      specifiedAmount: GoogleTypeMoneyResponseBillingbudgetsV1.fromMap(
