...
class GoogleTypeMoneyBillingbudgetsV1 {
  ...
  GoogleTypeMoneyBillingbudgetsV1({
    this.currencyCode,
    this.nanos,
    this.units,
  });
  ...
  factory GoogleTypeMoneyBillingbudgetsV1.fromMap(Map<String, dynamic> map) {
    return GoogleTypeMoneyBillingbudgetsV1(
      currencyCode:
