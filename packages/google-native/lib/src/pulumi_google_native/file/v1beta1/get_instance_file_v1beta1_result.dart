...
class GetInstanceFileV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['etag'] = etag;
    map['fileShares'] = pulumi.Input.encodeList<
        FileShareConfigResponseFileV1beta1,
        Map<String, dynamic>>(fileShares, (value) => value.toMap());
    ...
    map['name'] = name;
    map['networks'] = pulumi.Input.encodeList<NetworkConfigResponseFileV1beta1,
