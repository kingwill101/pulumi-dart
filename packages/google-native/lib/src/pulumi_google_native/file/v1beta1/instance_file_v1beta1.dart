...
class InstanceFileV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FileShareConfigResponseFileV1beta1>> fileShares;
  ...
  late final pulumi.Output<List<NetworkConfigResponseFileV1beta1>> networks;
  ...
  InstanceFileV1beta1(
    ...
    this.fileShares =
        registerOutput<List<FileShareConfigResponseFileV1beta1>>('fileShares');
    ...
    this.networks =
        registerOutput<List<NetworkConfigResponseFileV1beta1>>('networks');
