...
class NetworkConfigFileV1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (modesValue != null) {
      map['modes'] = pulumi.Input.encodeList<NetworkConfigModesItem, String>(
  ...
  factory NetworkConfigFileV1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigFileV1(
      connectMode: map['connectMode'] == null
          ? null
          : NetworkConfigConnectMode.fromValue(map['connectMode'] as String),
      modes: map['modes'] == null
          ? null
          : pulumi.Input.decodeList<NetworkConfigModesItem>(map['modes'],
