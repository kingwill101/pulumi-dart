...
class InstanceFileV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkConfigResponseFileV1>> networks;
  ...
  InstanceFileV1(
    ...
    this.networks =
        registerOutput<List<NetworkConfigResponseFileV1>>('networks');
