...
class NetworkConfigResponseFileV1 {
  ...
  factory NetworkConfigResponseFileV1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseFileV1(
