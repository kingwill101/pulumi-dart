...
class OccurrenceContaineranalysisV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<SBOMReferenceOccurrenceResponseContaineranalysisV1beta1>
      sbomReference;
  ...
  late final pulumi
      .Output<PackageInfoOccurrenceResponseContaineranalysisV1beta1>
      spdxPackage;

  /// Describes a specific SPDX Relationship.
  late final pulumi
      .Output<RelationshipOccurrenceResponseContaineranalysisV1beta1>
      spdxRelationship;
  ...
  OccurrenceContaineranalysisV1beta1(
    ...
    this.envelope =
        registerOutput<EnvelopeResponseContaineranalysisV1beta1>('envelope');
    this.installation =
    ...
    this.resource =
        registerOutput<ResourceResponseContaineranalysisV1beta1>('resource');
    this.sbom =
