...
class Package2 {
  ...
  final List<Digest3>? digest;

  /// The various channels by which a package is distributed.
  final List<Distribution3>? distribution;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (digestValue != null) {
      map['digest'] = Input.encodeList<Digest3, Map<String, dynamic>>(
          digestValue, (value) => value.toMap());
    }
    final distributionValue = distribution;
    if (distributionValue != null) {
      map['distribution'] =
          Input.encodeList<Distribution3, Map<String, dynamic>>(
  ...
  factory Package2.fromMap(Map<String, dynamic> map) {
    return Package2(
      architecture: map['architecture'] == null
          ? null
          : PackageArchitecture2.fromValue(map['architecture'] as String),
      cpeUri: map['cpeUri'] == null ? null : map['cpeUri'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      digest: map['digest'] == null
          ? null
          : Input.decodeList<Digest3>(
              map['digest'],
              (value) =>
                  Digest3.fromMap((value as Map).cast<String, dynamic>())),
      distribution: map['distribution'] == null
          ? null
          : Input.decodeList<Distribution3>(
              map['distribution'],
              (value) => Distribution3.fromMap(
