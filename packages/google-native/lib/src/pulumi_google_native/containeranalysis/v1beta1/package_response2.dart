...
class PackageResponse2 {
  ...
  final List<DigestResponse3> digest;

  /// The various channels by which a package is distributed.
  final List<DistributionResponse3> distribution;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['digest'] = Input.encodeList<DigestResponse3, Map<String, dynamic>>(
        digest, (value) => value.toMap());
    map['distribution'] =
        Input.encodeList<DistributionResponse3, Map<String, dynamic>>(
  ...
  factory PackageResponse2.fromMap(Map<String, dynamic> map) {
    return PackageResponse2(
      architecture: map['architecture'] as String,
      cpeUri: map['cpeUri'] as String,
      description: map['description'] as String,
      digest: Input.decodeList<DigestResponse3>(
          map['digest'],
          (value) =>
              DigestResponse3.fromMap((value as Map).cast<String, dynamic>())),
      distribution: Input.decodeList<DistributionResponse3>(
          map['distribution'],
          (value) => DistributionResponse3.fromMap(
