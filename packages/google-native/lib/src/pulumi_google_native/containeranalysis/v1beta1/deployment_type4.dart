...
import 'deployment_platform2.dart';

/// The period during which some deployable was active in a runtime.
class DeploymentType4 {
  ...
  final DeploymentPlatform2? platform;
  ...
  factory DeploymentType4.fromMap(Map<String, dynamic> map) {
    return DeploymentType4(
      address: map['address'] == null ? null : map['address'] as String,
      config: map['config'] == null ? null : map['config'] as String,
      deployTime: map['deployTime'] as String,
      platform: map['platform'] == null
          ? null
          : DeploymentPlatform2.fromValue(map['platform'] as String),
      undeployTime:
