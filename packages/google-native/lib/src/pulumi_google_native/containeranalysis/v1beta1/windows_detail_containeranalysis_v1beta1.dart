...
class WindowsDetailContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['fixingKbs'] = pulumi.Input.encodeList<
        KnowledgeBaseContaineranalysisV1beta1,
        Map<String, dynamic>>(fixingKbs, (value) => value.toMap());
    map['name'] = name;
    return map;
  }

  factory WindowsDetailContaineranalysisV1beta1.fromMap(
      Map<String, dynamic> map) {
    return WindowsDetailContaineranalysisV1beta1(
      cpeUri: map['cpeUri'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      fixingKbs: pulumi.Input.decodeList<KnowledgeBaseContaineranalysisV1beta1>(
          map['fixingKbs'],
          (value) => KnowledgeBaseContaineranalysisV1beta1.fromMap(
