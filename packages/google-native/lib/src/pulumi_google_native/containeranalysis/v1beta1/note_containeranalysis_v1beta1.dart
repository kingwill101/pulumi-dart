...
class NoteContaineranalysisV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BuildResponseContaineranalysisV1beta1> build;

  /// The time this note was created. This field can be used as a filter in list requests.
  late final pulumi.Output<String> createTime;

  /// A note describing something that can be deployed.
  late final pulumi.Output<DeployableResponseContaineranalysisV1beta1>
      deployable;
  ...
  late final pulumi.Output<List<RelatedUrlResponseContaineranalysisV1beta1>>
      relatedUrl;
  ...
  late final pulumi.Output<SBOMReferenceNoteResponseContaineranalysisV1beta1>
      sbomReference;
  ...
  late final pulumi.Output<PackageInfoNoteResponseContaineranalysisV1beta1>
      spdxPackage;

  /// A note describing an SPDX File.
  late final pulumi.Output<RelationshipNoteResponseContaineranalysisV1beta1>
      spdxRelationship;
  ...
  late final pulumi
      .Output<VulnerabilityAssessmentNoteResponseContaineranalysisV1beta1>
  ...
  NoteContaineranalysisV1beta1(
    ...
    this.baseImage =
        registerOutput<BasisResponseContaineranalysisV1beta1>('baseImage');
    this.build = registerOutput<BuildResponseContaineranalysisV1beta1>('build');
    this.createTime = registerOutput<String>('createTime');
    this.deployable =
        registerOutput<DeployableResponseContaineranalysisV1beta1>(
            'deployable');
    this.discovery =
        registerOutput<DiscoveryResponseContaineranalysisV1beta1>('discovery');
    ...
    this.package =
        registerOutput<PackageResponseContaineranalysisV1beta1>('package');
    this.project = registerOutput<String>('project');
    this.relatedNoteNames = registerOutput<List<String>>('relatedNoteNames');
    this.relatedUrl =
        registerOutput<List<RelatedUrlResponseContaineranalysisV1beta1>>(
            'relatedUrl');
    this.sbom =
        registerOutput<DocumentNoteResponseContaineranalysisV1beta1>('sbom');
    this.sbomReference =
    ...
    this.spdxFile =
        registerOutput<FileNoteResponseContaineranalysisV1beta1>('spdxFile');
    this.spdxPackage =
