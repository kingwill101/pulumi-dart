...
import 'artifact3.dart';
import 'command3.dart';
import 'source8.dart';

/// Provenance of a build. Contains all information needed to verify the full details about the build from source to completion.
class BuildProvenance3 {
  ...
  /// Output of the build.
  final List<Artifact3>? builtArtifacts;

  /// Commands requested by the build.
  final List<Command3>? commands;
  ...
  final Source8? sourceProvenance;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (builtArtifactsValue != null) {
      map['builtArtifacts'] = Input.encodeList<Artifact3, Map<String, dynamic>>(
          builtArtifactsValue, (value) => value.toMap());
    }
    final commandsValue = commands;
    if (commandsValue != null) {
      map['commands'] = Input.encodeList<Command3, Map<String, dynamic>>(
  ...
  factory BuildProvenance3.fromMap(Map<String, dynamic> map) {
    return BuildProvenance3(
      ...
      builtArtifacts: map['builtArtifacts'] == null
          ? null
          : Input.decodeList<Artifact3>(
              map['builtArtifacts'],
              (value) =>
                  Artifact3.fromMap((value as Map).cast<String, dynamic>())),
      commands: map['commands'] == null
          ? null
          : Input.decodeList<Command3>(
              map['commands'],
              (value) =>
                  Command3.fromMap((value as Map).cast<String, dynamic>())),
      createTime:
