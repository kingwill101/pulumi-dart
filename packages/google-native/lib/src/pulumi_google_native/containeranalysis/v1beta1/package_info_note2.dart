...
import 'external_ref2.dart';
import 'license3.dart';

/// PackageInfoNote represents an SPDX Package Information section: https://spdx.github.io/spdx-spec/3-package-information/
class PackageInfoNote2 {
  ...
  /// ExternalRef
  final List<ExternalRef2>? externalRefs;
  ...
  final License3? licenseDeclared;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (externalRefsValue != null) {
      map['externalRefs'] =
          Input.encodeList<ExternalRef2, Map<String, dynamic>>(
  ...
  factory PackageInfoNote2.fromMap(Map<String, dynamic> map) {
    return PackageInfoNote2(
      ...
      externalRefs: map['externalRefs'] == null
          ? null
          : Input.decodeList<ExternalRef2>(
              map['externalRefs'],
              (value) =>
                  ExternalRef2.fromMap((value as Map).cast<String, dynamic>())),
