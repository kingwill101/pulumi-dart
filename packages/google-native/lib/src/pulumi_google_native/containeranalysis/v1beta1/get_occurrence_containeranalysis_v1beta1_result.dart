...
class GetOccurrenceContaineranalysisV1beta1Result {
  ...
  factory GetOccurrenceContaineranalysisV1beta1Result.fromMap(
    ...
    return GetOccurrenceContaineranalysisV1beta1Result(
      ...
      envelope: EnvelopeResponseContaineranalysisV1beta1.fromMap(
      ...
      resource: ResourceResponseContaineranalysisV1beta1.fromMap(
          (map['resource'] as Map).cast<String, dynamic>()),
      sbom: DocumentOccurrenceResponseContaineranalysisV1beta1.fromMap(
          (map['sbom'] as Map).cast<String, dynamic>()),
      sbomReference:
          SBOMReferenceOccurrenceResponseContaineranalysisV1beta1.fromMap(
              (map['sbomReference'] as Map).cast<String, dynamic>()),
      spdxFile: FileOccurrenceResponseContaineranalysisV1beta1.fromMap(
          (map['spdxFile'] as Map).cast<String, dynamic>()),
      spdxPackage:
          PackageInfoOccurrenceResponseContaineranalysisV1beta1.fromMap(
              (map['spdxPackage'] as Map).cast<String, dynamic>()),
      spdxRelationship:
          RelationshipOccurrenceResponseContaineranalysisV1beta1.fromMap(
