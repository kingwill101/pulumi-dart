...
import 'build_provenance_response3.dart';
import 'in_toto_slsa_provenance_v1_response3.dart';

/// Details of a build occurrence.
class GrafeasV1beta1BuildDetailsResponse {
  final InTotoSlsaProvenanceV1Response3 inTotoSlsaProvenanceV1;

  /// The actual provenance for the build.
  final BuildProvenanceResponse3 provenance;
  ...
  factory GrafeasV1beta1BuildDetailsResponse.fromMap(Map<String, dynamic> map) {
    return GrafeasV1beta1BuildDetailsResponse(
      inTotoSlsaProvenanceV1: InTotoSlsaProvenanceV1Response3.fromMap(
          (map['inTotoSlsaProvenanceV1'] as Map).cast<String, dynamic>()),
      provenance: BuildProvenanceResponse3.fromMap(
