...
class GetOccurrenceResult3 {
  ...
  final EnvelopeResponse3 envelope;
  ...
  final ResourceResponse2 resource;

  /// Describes a specific software bill of materials document.
  final DocumentOccurrenceResponse2 sbom;

  /// Describes a specific SBOM reference occurrences.
  final SBOMReferenceOccurrenceResponse3 sbomReference;

  /// Describes a specific SPDX File.
  final FileOccurrenceResponse2 spdxFile;

  /// Describes a specific SPDX Package.
  final PackageInfoOccurrenceResponse2 spdxPackage;

  /// Describes a specific SPDX Relationship.
  final RelationshipOccurrenceResponse2 spdxRelationship;
  ...
  factory GetOccurrenceResult3.fromMap(Map<String, dynamic> map) {
    return GetOccurrenceResult3(
      attestation: DetailsResponse.fromMap(
          (map['attestation'] as Map).cast<String, dynamic>()),
      build: GrafeasV1beta1BuildDetailsResponse.fromMap(
          (map['build'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deployment: GrafeasV1beta1DeploymentDetailsResponse.fromMap(
          (map['deployment'] as Map).cast<String, dynamic>()),
      derivedImage: GrafeasV1beta1ImageDetailsResponse.fromMap(
          (map['derivedImage'] as Map).cast<String, dynamic>()),
      discovered: GrafeasV1beta1DiscoveryDetailsResponse.fromMap(
          (map['discovered'] as Map).cast<String, dynamic>()),
      envelope: EnvelopeResponse3.fromMap(
          (map['envelope'] as Map).cast<String, dynamic>()),
      installation: GrafeasV1beta1PackageDetailsResponse.fromMap(
          (map['installation'] as Map).cast<String, dynamic>()),
      intoto: GrafeasV1beta1IntotoDetailsResponse.fromMap(
          (map['intoto'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      name: map['name'] as String,
      noteName: map['noteName'] as String,
      remediation: map['remediation'] as String,
      resource: ResourceResponse2.fromMap(
          (map['resource'] as Map).cast<String, dynamic>()),
      sbom: DocumentOccurrenceResponse2.fromMap(
          (map['sbom'] as Map).cast<String, dynamic>()),
      sbomReference: SBOMReferenceOccurrenceResponse3.fromMap(
          (map['sbomReference'] as Map).cast<String, dynamic>()),
      spdxFile: FileOccurrenceResponse2.fromMap(
          (map['spdxFile'] as Map).cast<String, dynamic>()),
      spdxPackage: PackageInfoOccurrenceResponse2.fromMap(
          (map['spdxPackage'] as Map).cast<String, dynamic>()),
      spdxRelationship: RelationshipOccurrenceResponse2.fromMap(
          (map['spdxRelationship'] as Map).cast<String, dynamic>()),
      updateTime: map['updateTime'] as String,
      vulnerability: GrafeasV1beta1VulnerabilityDetailsResponse.fromMap(
