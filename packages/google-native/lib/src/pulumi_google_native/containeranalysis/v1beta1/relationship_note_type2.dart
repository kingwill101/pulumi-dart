...
enum RelationshipNoteType2 {
  ...
  const RelationshipNoteType2(this.value);
  final String value;

  static RelationshipNoteType2 fromValue(String value) {
    for (final item in RelationshipNoteType2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown RelationshipNoteType2 value: $value');
  }
}
