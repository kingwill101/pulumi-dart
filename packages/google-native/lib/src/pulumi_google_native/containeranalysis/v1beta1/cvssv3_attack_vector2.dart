...
enum CVSSv3AttackVector2 {
  ...
  const CVSSv3AttackVector2(this.value);
  final String value;

  static CVSSv3AttackVector2 fromValue(String value) {
    for (final item in CVSSv3AttackVector2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown CVSSv3AttackVector2 value: $value');
  }
}
