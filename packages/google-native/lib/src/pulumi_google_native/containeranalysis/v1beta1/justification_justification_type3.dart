...
enum JustificationJustificationType3 {
  ...
  const JustificationJustificationType3(this.value);
  final String value;

  static JustificationJustificationType3 fromValue(String value) {
    for (final item in JustificationJustificationType3.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError(
        'Unknown JustificationJustificationType3 value: $value');
  }
}
