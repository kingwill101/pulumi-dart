...
import 'external_ref_response2.dart';
import 'license_response3.dart';

/// PackageInfoNote represents an SPDX Package Information section: https://spdx.github.io/spdx-spec/3-package-information/
class PackageInfoNoteResponse2 {
  ...
  /// ExternalRef
  final List<ExternalRefResponse2> externalRefs;
  ...
  final LicenseResponse3 licenseDeclared;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['externalRefs'] =
        Input.encodeList<ExternalRefResponse2, Map<String, dynamic>>(
  ...
  factory PackageInfoNoteResponse2.fromMap(Map<String, dynamic> map) {
    return PackageInfoNoteResponse2(
      ...
      externalRefs: Input.decodeList<ExternalRefResponse2>(
          map['externalRefs'],
          (value) => ExternalRefResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      filesLicenseInfo: (map['filesLicenseInfo'] as List).cast<String>(),
      homePage: map['homePage'] as String,
      licenseDeclared: LicenseResponse3.fromMap(
