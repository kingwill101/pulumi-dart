...
class DocumentOccurrenceResponse2 {
  ...
  factory DocumentOccurrenceResponse2.fromMap(Map<String, dynamic> map) {
    return DocumentOccurrenceResponse2(
