...
class SbomReferenceIntotoPredicate3 {
  ...
  factory SbomReferenceIntotoPredicate3.fromMap(Map<String, dynamic> map) {
    return SbomReferenceIntotoPredicate3(
