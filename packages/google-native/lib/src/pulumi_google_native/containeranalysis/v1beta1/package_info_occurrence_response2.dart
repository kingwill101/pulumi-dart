...
class PackageInfoOccurrenceResponse2 {
  ...
  PackageInfoOccurrenceResponse2({
  ...
  factory PackageInfoOccurrenceResponse2.fromMap(Map<String, dynamic> map) {
    return PackageInfoOccurrenceResponse2(
