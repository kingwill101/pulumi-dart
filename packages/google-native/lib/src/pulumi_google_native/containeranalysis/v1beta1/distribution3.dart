...
import 'distribution_architecture3.dart';
import 'version3.dart';

/// This represents a particular channel of distribution for a given package. E.g., Debian's jessie-backports dpkg mirror.
class Distribution3 {
  /// The CPU architecture for which packages in this distribution channel were built.
  final DistributionArchitecture3? architecture;
  ...
  factory Distribution3.fromMap(Map<String, dynamic> map) {
    return Distribution3(
      architecture: map['architecture'] == null
          ? null
          : DistributionArchitecture3.fromValue(map['architecture'] as String),
