...
import 'build_response_containeranalysis_v1beta1.dart';
...
class GetNoteContaineranalysisV1beta1Result {
  ...
  final BuildResponseContaineranalysisV1beta1 build;
  ...
  final VulnerabilityAssessmentNoteResponseContaineranalysisV1beta1
  ...
  factory GetNoteContaineranalysisV1beta1Result.fromMap(
    ...
    return GetNoteContaineranalysisV1beta1Result(
      ...
      baseImage: BasisResponseContaineranalysisV1beta1.fromMap(
          (map['baseImage'] as Map).cast<String, dynamic>()),
      build: BuildResponseContaineranalysisV1beta1.fromMap(
          (map['build'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deployable: DeployableResponseContaineranalysisV1beta1.fromMap(
          (map['deployable'] as Map).cast<String, dynamic>()),
      discovery: DiscoveryResponseContaineranalysisV1beta1.fromMap(
      ...
      package: PackageResponseContaineranalysisV1beta1.fromMap(
      ...
      sbom: DocumentNoteResponseContaineranalysisV1beta1.fromMap(
          (map['sbom'] as Map).cast<String, dynamic>()),
      sbomReference: SBOMReferenceNoteResponseContaineranalysisV1beta1.fromMap(
          (map['sbomReference'] as Map).cast<String, dynamic>()),
      shortDescription: map['shortDescription'] as String,
      spdxFile: FileNoteResponseContaineranalysisV1beta1.fromMap(
          (map['spdxFile'] as Map).cast<String, dynamic>()),
      spdxPackage: PackageInfoNoteResponseContaineranalysisV1beta1.fromMap(
          (map['spdxPackage'] as Map).cast<String, dynamic>()),
      spdxRelationship:
          RelationshipNoteResponseContaineranalysisV1beta1.fromMap(
      ...
      vulnerabilityAssessment:
          VulnerabilityAssessmentNoteResponseContaineranalysisV1beta1.fromMap(
