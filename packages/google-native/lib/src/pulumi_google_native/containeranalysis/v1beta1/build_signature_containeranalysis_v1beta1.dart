...
class BuildSignatureContaineranalysisV1beta1 {
  ...
  final BuildSignatureKeyTypeContaineranalysisV1beta1? keyType;
  ...
  BuildSignatureContaineranalysisV1beta1({
    this.keyId,
    this.keyType,
    this.publicKey,
