...
import 'source_context_response_containeranalysis_v1beta1.dart';

/// Source describes the location of the source used for the build.
class SourceResponseContaineranalysisV1beta1 {
  /// If provided, some of the source code used for the build may be found in these locations, in the case where the source repository had multiple remotes or submodules. This list will not include the context specified in the context field.
  final List<SourceContextResponseContaineranalysisV1beta1> additionalContexts;

  /// If provided, the input binary artifacts for the build came from this location.
  final String artifactStorageSourceUri;

  /// If provided, the source code used for the build came from this location.
  final SourceContextResponseContaineranalysisV1beta1 context;

  /// Hash(es) of the build source, which can be used to verify that the original source integrity was maintained in the build. The keys to this map are file paths used as build source and the values contain the hash values for those files. If the build source came in a single package such as a gzipped tarfile (.tar.gz), the FileHash will be for the single path to that file.
  final Map<String, String> fileHashes;

  SourceResponseContaineranalysisV1beta1({
  ...
  factory SourceResponseContaineranalysisV1beta1.fromMap(
      Map<String, dynamic> map) {
    return SourceResponseContaineranalysisV1beta1(
      additionalContexts: pulumi.Input.decodeList<
              SourceContextResponseContaineranalysisV1beta1>(
          map['additionalContexts'],
          (value) => SourceContextResponseContaineranalysisV1beta1.fromMap(
              (value as Map).cast<String, dynamic>())),
      artifactStorageSourceUri: map['artifactStorageSourceUri'] as String,
      context: SourceContextResponseContaineranalysisV1beta1.fromMap(
