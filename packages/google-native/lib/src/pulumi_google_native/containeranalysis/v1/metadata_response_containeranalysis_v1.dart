...
class MetadataResponseContaineranalysisV1 {
  ...
  MetadataResponseContaineranalysisV1({
  ...
  factory MetadataResponseContaineranalysisV1.fromMap(
      Map<String, dynamic> map) {
    return MetadataResponseContaineranalysisV1(
