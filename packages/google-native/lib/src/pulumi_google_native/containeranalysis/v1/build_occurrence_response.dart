...
class BuildOccurrenceResponse {
  ...
  factory BuildOccurrenceResponse.fromMap(Map<String, dynamic> map) {
    return BuildOccurrenceResponse(
      inTotoSlsaProvenanceV1: InTotoSlsaProvenanceV1Response.fromMap(
          (map['inTotoSlsaProvenanceV1'] as Map).cast<String, dynamic>()),
      intotoProvenance: InTotoProvenanceResponse.fromMap(
          (map['intotoProvenance'] as Map).cast<String, dynamic>()),
      intotoStatement: InTotoStatementResponse.fromMap(
          (map['intotoStatement'] as Map).cast<String, dynamic>()),
      provenance: BuildProvenanceResponse.fromMap(
