...
class SourceResponseContaineranalysisV1 {
  ...
  SourceResponseContaineranalysisV1({
  ...
  factory SourceResponseContaineranalysisV1.fromMap(Map<String, dynamic> map) {
    return SourceResponseContaineranalysisV1(
