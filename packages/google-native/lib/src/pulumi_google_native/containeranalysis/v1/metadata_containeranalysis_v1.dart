...
class MetadataContaineranalysisV1 {
  ...
  factory MetadataContaineranalysisV1.fromMap(Map<String, dynamic> map) {
    return MetadataContaineranalysisV1(
