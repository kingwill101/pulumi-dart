...
import 'jwt_response_containeranalysis_v1.dart';
...
class AttestationOccurrenceResponse {
  ...
  final List<JwtResponseContaineranalysisV1> jwts;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['jwts'] = pulumi.Input.encodeList<JwtResponseContaineranalysisV1,
        Map<String, dynamic>>(jwts, (value) => value.toMap());
    map['serializedPayload'] = serializedPayload;
    map['signatures'] =
        pulumi.Input.encodeList<SignatureResponse, Map<String, dynamic>>(
  ...
  factory AttestationOccurrenceResponse.fromMap(Map<String, dynamic> map) {
    return AttestationOccurrenceResponse(
      jwts: pulumi.Input.decodeList<JwtResponseContaineranalysisV1>(
          map['jwts'],
          (value) => JwtResponseContaineranalysisV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      serializedPayload: map['serializedPayload'] as String,
      signatures: pulumi.Input.decodeList<SignatureResponse>(
          map['signatures'],
