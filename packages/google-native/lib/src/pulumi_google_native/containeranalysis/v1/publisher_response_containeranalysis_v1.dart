...
class PublisherResponseContaineranalysisV1 {
  ...
  PublisherResponseContaineranalysisV1({
  ...
  factory PublisherResponseContaineranalysisV1.fromMap(
      Map<String, dynamic> map) {
    return PublisherResponseContaineranalysisV1(
