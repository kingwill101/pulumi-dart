...
class AttestationOccurrence {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (jwtsValue != null) {
      map['jwts'] = Input.encodeList<Jwt2, Map<String, dynamic>>(
    ...
    if (signaturesValue != null) {
      map['signatures'] = Input.encodeList<Signature, Map<String, dynamic>>(
  ...
  factory AttestationOccurrence.fromMap(Map<String, dynamic> map) {
    return AttestationOccurrence(
      jwts: map['jwts'] == null
          ? null
          : Input.decodeList<Jwt2>(map['jwts'],
              (value) => Jwt2.fromMap((value as Map).cast<String, dynamic>())),
      serializedPayload: map['serializedPayload'] as String,
      signatures: map['signatures'] == null
          ? null
          : Input.decodeList<Signature>(
              map['signatures'],
              (value) =>
