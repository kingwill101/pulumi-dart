...
class SourceContaineranalysisV1 {
  ...
  factory SourceContaineranalysisV1.fromMap(Map<String, dynamic> map) {
    return SourceContaineranalysisV1(
      additionalContexts: map['additionalContexts'] == null
          ? null
          : pulumi.Input.decodeList<SourceContext>(
              map['additionalContexts'],
              (value) => SourceContext.fromMap(
