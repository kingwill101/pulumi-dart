...
class PublisherContaineranalysisV1 {
  ...
  factory PublisherContaineranalysisV1.fromMap(Map<String, dynamic> map) {
    return PublisherContaineranalysisV1(
