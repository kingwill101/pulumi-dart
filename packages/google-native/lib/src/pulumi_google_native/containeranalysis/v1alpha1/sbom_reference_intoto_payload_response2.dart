...
import 'sbom_reference_intoto_predicate_response2.dart';
import 'subject_response2.dart';

/// The actual payload that contains the SBOM Reference data. The payload follows the intoto statement specification. See https://github.com/in-toto/attestation/blob/main/spec/v1.0/statement.md for more details.
class SbomReferenceIntotoPayloadResponse2 {
  /// Additional parameters of the Predicate. Includes the actual data about the SBOM.
  final SbomReferenceIntotoPredicateResponse2 predicate;
  ...
  SbomReferenceIntotoPayloadResponse2({
  ...
  factory SbomReferenceIntotoPayloadResponse2.fromMap(
      Map<String, dynamic> map) {
    return SbomReferenceIntotoPayloadResponse2(
      predicate: SbomReferenceIntotoPredicateResponse2.fromMap(
