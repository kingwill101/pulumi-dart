...
class Assessment2 {
  ...
  factory Assessment2.fromMap(Map<String, dynamic> map) {
    return Assessment2(
      ...
      state: map['state'] == null
          ? null
          : AssessmentState2.fromValue(map['state'] as String),
