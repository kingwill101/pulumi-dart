...
import 'slsa_completeness_response2.dart';

/// Other properties of the build.
class SlsaMetadataResponse2 {
  ...
  final SlsaCompletenessResponse2 completeness;

  /// If true, the builder claims that running the recipe on materials will produce bit-for-bit identical output.
  final bool reproducible;

  SlsaMetadataResponse2({
  ...
  factory SlsaMetadataResponse2.fromMap(Map<String, dynamic> map) {
    return SlsaMetadataResponse2(
      ...
      completeness: SlsaCompletenessResponse2.fromMap(
