...
class DeploymentResponseContaineranalysisV1alpha1 {
  ...
  DeploymentResponseContaineranalysisV1alpha1({
  ...
  factory DeploymentResponseContaineranalysisV1alpha1.fromMap(
      Map<String, dynamic> map) {
    return DeploymentResponseContaineranalysisV1alpha1(
