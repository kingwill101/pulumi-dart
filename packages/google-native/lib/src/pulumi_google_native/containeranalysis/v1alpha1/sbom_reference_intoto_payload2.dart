...
import 'sbom_reference_intoto_predicate2.dart';
import 'subject2.dart';

/// The actual payload that contains the SBOM Reference data. The payload follows the intoto statement specification. See https://github.com/in-toto/attestation/blob/main/spec/v1.0/statement.md for more details.
class SbomReferenceIntotoPayload2 {
  /// Additional parameters of the Predicate. Includes the actual data about the SBOM.
  final SbomReferenceIntotoPredicate2? predicate;
  ...
  factory SbomReferenceIntotoPayload2.fromMap(Map<String, dynamic> map) {
    return SbomReferenceIntotoPayload2(
      predicate: map['predicate'] == null
          ? null
          : SbomReferenceIntotoPredicate2.fromMap(
