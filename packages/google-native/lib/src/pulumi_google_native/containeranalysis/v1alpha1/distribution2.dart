...
import 'distribution_architecture2.dart';
import 'version2.dart';

/// This represents a particular channel of distribution for a given package. e.g. Debian's jessie-backports dpkg mirror
class Distribution2 {
  /// The CPU architecture for which packages in this distribution channel were built
  final DistributionArchitecture2? architecture;
  ...
  factory Distribution2.fromMap(Map<String, dynamic> map) {
    return Distribution2(
      architecture: map['architecture'] == null
          ? null
          : DistributionArchitecture2.fromValue(map['architecture'] as String),
