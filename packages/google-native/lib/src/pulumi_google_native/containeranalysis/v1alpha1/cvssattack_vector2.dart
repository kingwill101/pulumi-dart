...
enum CVSSAttackVector2 {
  ...
  const CVSSAttackVector2(this.value);
  final String value;

  static CVSSAttackVector2 fromValue(String value) {
    for (final item in CVSSAttackVector2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown CVSSAttackVector2 value: $value');
  }
}
