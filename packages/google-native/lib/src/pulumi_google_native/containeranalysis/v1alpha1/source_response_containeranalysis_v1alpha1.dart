...
import 'repo_source_response_containeranalysis_v1alpha1.dart';
import 'storage_source_response_containeranalysis_v1alpha1.dart';
...
class SourceResponseContaineranalysisV1alpha1 {
  ...
  final StorageSourceResponseContaineranalysisV1alpha1 artifactStorageSource;
  ...
  final RepoSourceResponseContaineranalysisV1alpha1 repoSource;

  /// If provided, get the source from this location in Google Cloud Storage.
  final StorageSourceResponseContaineranalysisV1alpha1 storageSource;
  ...
  factory SourceResponseContaineranalysisV1alpha1.fromMap(
    ...
    return SourceResponseContaineranalysisV1alpha1(
      additionalContexts: pulumi.Input.decodeList<
              GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse>(
      ...
      artifactStorageSource:
          StorageSourceResponseContaineranalysisV1alpha1.fromMap(
      ...
      repoSource: RepoSourceResponseContaineranalysisV1alpha1.fromMap(
          (map['repoSource'] as Map).cast<String, dynamic>()),
      storageSource: StorageSourceResponseContaineranalysisV1alpha1.fromMap(
