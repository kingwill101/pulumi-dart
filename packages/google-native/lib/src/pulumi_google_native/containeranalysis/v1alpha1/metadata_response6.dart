...
import 'completeness_response2.dart';

/// Other properties of the build.
class MetadataResponse6 {
  ...
  final CompletenessResponse2 completeness;
  ...
  factory MetadataResponse6.fromMap(Map<String, dynamic> map) {
    return MetadataResponse6(
      ...
      completeness: CompletenessResponse2.fromMap(
