...
import 'deployment_response_containeranalysis_v1alpha1.dart';
...
class GetOccurrenceContaineranalysisV1alpha1Result {
  ...
  final DeploymentResponseContaineranalysisV1alpha1 deployment;
  ...
  final DSSEAttestationOccurrenceResponseContaineranalysisV1alpha1
      dsseAttestation;
  ...
  factory GetOccurrenceContaineranalysisV1alpha1Result.fromMap(
    ...
    return GetOccurrenceContaineranalysisV1alpha1Result(
      ...
      compliance: ComplianceOccurrenceResponseContaineranalysisV1alpha1.fromMap(
          (map['compliance'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deployment: DeploymentResponseContaineranalysisV1alpha1.fromMap(
      ...
      dsseAttestation:
          DSSEAttestationOccurrenceResponseContaineranalysisV1alpha1.fromMap(
      ...
      sbomReference:
          SBOMReferenceOccurrenceResponseContaineranalysisV1alpha1.fromMap(
      ...
      upgrade: UpgradeOccurrenceResponseContaineranalysisV1alpha1.fromMap(
