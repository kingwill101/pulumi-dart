...
class DetailResponse2 {
  ...
  final VersionResponse2 maxAffectedVersion;

  /// The min version of the package in which the vulnerability exists.
  final VersionResponse2 minAffectedVersion;
  ...
  factory DetailResponse2.fromMap(Map<String, dynamic> map) {
    return DetailResponse2(
      ...
      maxAffectedVersion: VersionResponse2.fromMap(
          (map['maxAffectedVersion'] as Map).cast<String, dynamic>()),
      minAffectedVersion: VersionResponse2.fromMap(
