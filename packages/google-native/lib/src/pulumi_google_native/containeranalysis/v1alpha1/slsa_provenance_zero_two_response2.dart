...
class SlsaProvenanceZeroTwoResponse2 {
  ...
  SlsaProvenanceZeroTwoResponse2({
  ...
  factory SlsaProvenanceZeroTwoResponse2.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceZeroTwoResponse2(
