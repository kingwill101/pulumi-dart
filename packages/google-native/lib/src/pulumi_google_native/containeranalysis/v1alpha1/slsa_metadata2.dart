...
import 'slsa_completeness2.dart';
...
class SlsaMetadata2 {
  ...
  final SlsaCompleteness2? completeness;
  ...
  factory SlsaMetadata2.fromMap(Map<String, dynamic> map) {
    return SlsaMetadata2(
