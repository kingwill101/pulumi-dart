...
import 'sbom_reference_intoto_payload_response2.dart';

/// The occurrence representing an SBOM reference as applied to a specific resource. The occurrence follows the DSSE specification. See https://github.com/secure-systems-lab/dsse/blob/master/envelope.md for more details.
class SBOMReferenceOccurrenceResponse2 {
  /// The actual payload that contains the SBOM reference data.
  final SbomReferenceIntotoPayloadResponse2 payload;
  ...
  SBOMReferenceOccurrenceResponse2({
  ...
  factory SBOMReferenceOccurrenceResponse2.fromMap(Map<String, dynamic> map) {
    return SBOMReferenceOccurrenceResponse2(
      payload: SbomReferenceIntotoPayloadResponse2.fromMap(
