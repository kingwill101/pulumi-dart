...
enum JustificationJustificationType2 {
  ...
  const JustificationJustificationType2(this.value);
  final String value;

  static JustificationJustificationType2 fromValue(String value) {
    for (final item in JustificationJustificationType2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError(
        'Unknown JustificationJustificationType2 value: $value');
  }
}
