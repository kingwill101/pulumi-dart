...
class AuditLogConfig7 {
  ...
  factory AuditLogConfig7.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig7(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType7.fromValue(map['logType'] as String),
    );
  }
}
