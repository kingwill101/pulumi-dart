...
class DocumentArgs5 {
  ...
  final Input<GoogleCloudDiscoveryengineV1betaDocumentContent>? content;
  ...
  factory DocumentArgs5.fromMap(Map<String, dynamic> map) {
    return DocumentArgs5(
      ...
      content: Input.asOptionalInput<
          GoogleCloudDiscoveryengineV1betaDocumentContent>(map['content']),
