...
import 'document_discoveryengine_v1alpha_args.dart';
import 'google_cloud_discoveryengine_v1alpha_document_content_response.dart';

/// Creates a Document.
class DocumentDiscoveryengineV1alpha extends pulumi.CustomResource {
  ...
  DocumentDiscoveryengineV1alpha(
    String name, {
    DocumentDiscoveryengineV1alphaArgs? args,
