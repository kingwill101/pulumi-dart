...
/// Creates a Document.
class Document4 extends CustomResource {
  late final Output<String> branchId;
  late final Output<String> collectionId;

  /// The unstructured data linked to this document. Content must be set if this document is under a `CONTENT_REQUIRED` data store.
  late final Output<GoogleCloudDiscoveryengineV1alphaDocumentContentResponse>
      content;
  ...
  Document4(
    ...
    this.content = registerOutput<
        GoogleCloudDiscoveryengineV1alphaDocumentContentResponse>('content');
