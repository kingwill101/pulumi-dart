...
class GetDocumentDiscoveryengineV1alphaResult {
  ...
  GetDocumentDiscoveryengineV1alphaResult({
  ...
  factory GetDocumentDiscoveryengineV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetDocumentDiscoveryengineV1alphaResult(
