...
class GoogleCloudDiscoveryengineV1alphaDocumentContentResponse {
  ...
  factory GoogleCloudDiscoveryengineV1alphaDocumentContentResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaDocumentContentResponse(
