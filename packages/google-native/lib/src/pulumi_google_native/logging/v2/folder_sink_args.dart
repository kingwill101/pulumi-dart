...
class FolderSinkArgs {
  ...
  final Input<FolderSinkOutputVersionFormat>? outputVersionFormat;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (outputVersionFormatValue != null) {
      map['outputVersionFormat'] =
          Input.mapOptionalInputValue<FolderSinkOutputVersionFormat, String>(
  ...
  factory FolderSinkArgs.fromMap(Map<String, dynamic> map) {
    return FolderSinkArgs(
      ...
      outputVersionFormat: Input.asOptionalInput<FolderSinkOutputVersionFormat>(
          map['outputVersionFormat']),
