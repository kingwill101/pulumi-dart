...
class SinkArgs {
  ...
  final Input<SinkOutputVersionFormat>? outputVersionFormat;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (outputVersionFormatValue != null) {
      map['outputVersionFormat'] =
          Input.mapOptionalInputValue<SinkOutputVersionFormat, String>(
  ...
  factory SinkArgs.fromMap(Map<String, dynamic> map) {
    return SinkArgs(
      ...
      outputVersionFormat: Input.asOptionalInput<SinkOutputVersionFormat>(
          map['outputVersionFormat']),
