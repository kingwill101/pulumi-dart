...
class FolderSink extends CustomResource {
  ...
  late final Output<BigQueryOptionsResponse> bigqueryOptions;
  ...
  late final Output<List<LogExclusionResponse>> exclusions;
  ...
  late final Output<String> outputVersionFormat;
