...
class Metric2 extends CustomResource {
  ...
  late final Output<BucketOptionsResponse> bucketOptions;
  ...
  late final Output<Map<String, String>> labelExtractors;
  ...
  late final Output<MetricDescriptorResponse> metricDescriptor;
  ...
  late final Output<String> valueExtractor;
