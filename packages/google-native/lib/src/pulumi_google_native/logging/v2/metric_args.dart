...
class MetricArgs {
  ...
  final Input<BucketOptions>? bucketOptions;
  ...
  final Input<MetricDescriptor>? metricDescriptor;
  ...
  final Input<MetricVersion>? version;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bucketOptionsValue != null) {
      map['bucketOptions'] =
          Input.mapOptionalInputValue<BucketOptions, Map<String, dynamic>>(
              bucketOptionsValue, (value) => value.toMap());
    }
    ...
    if (metricDescriptorValue != null) {
      map['metricDescriptor'] =
          Input.mapOptionalInputValue<MetricDescriptor, Map<String, dynamic>>(
    ...
    if (versionValue != null) {
      map['version'] = Input.mapOptionalInputValue<MetricVersion, String>(
  ...
  factory MetricArgs.fromMap(Map<String, dynamic> map) {
    return MetricArgs(
      ...
      bucketOptions: Input.asOptionalInput<BucketOptions>(map['bucketOptions']),
      ...
      metricDescriptor:
          Input.asOptionalInput<MetricDescriptor>(map['metricDescriptor']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      valueExtractor: Input.asOptionalInput<String>(map['valueExtractor']),
      version: Input.asOptionalInput<MetricVersion>(map['version']),
    );
  }
}
