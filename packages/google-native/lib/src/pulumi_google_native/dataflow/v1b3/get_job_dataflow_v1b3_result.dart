...
class GetJobDataflowV1b3Result {
  ...
  final EnvironmentResponseDataflowV1b3 environment;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['createdFromSnapshotId'] = createdFromSnapshotId;
    map['currentState'] = currentState;
    map['currentStateTime'] = currentStateTime;
    map['environment'] = environment.toMap();
    map['executionInfo'] = executionInfo.toMap();
    map['jobMetadata'] = jobMetadata.toMap();
    map['labels'] = labels;
    map['location'] = location;
    map['name'] = name;
    map['pipelineDescription'] = pipelineDescription.toMap();
    map['project'] = project;
    map['replaceJobId'] = replaceJobId;
    map['replacedByJobId'] = replacedByJobId;
    map['requestedState'] = requestedState;
    map['runtimeUpdatableParams'] = runtimeUpdatableParams.toMap();
    map['satisfiesPzi'] = satisfiesPzi;
    map['satisfiesPzs'] = satisfiesPzs;
    map['stageStates'] = pulumi.Input.encodeList<ExecutionStageStateResponse,
        Map<String, dynamic>>(stageStates, (value) => value.toMap());
    map['startTime'] = startTime;
    map['steps'] = pulumi.Input.encodeList<StepResponse, Map<String, dynamic>>(
        steps, (value) => value.toMap());
    map['stepsLocation'] = stepsLocation;
    map['tempFiles'] = tempFiles;
    map['transformNameMapping'] = transformNameMapping;
    map['type'] = type;
    return map;
  }

  factory GetJobDataflowV1b3Result.fromMap(Map<String, dynamic> map) {
    return GetJobDataflowV1b3Result(
      ...
      environment: EnvironmentResponseDataflowV1b3.fromMap(
          (map['environment'] as Map).cast<String, dynamic>()),
      executionInfo: JobExecutionInfoResponse.fromMap(
          (map['executionInfo'] as Map).cast<String, dynamic>()),
      jobMetadata: JobMetadataResponse.fromMap(
          (map['jobMetadata'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      name: map['name'] as String,
      pipelineDescription: PipelineDescriptionResponse.fromMap(
          (map['pipelineDescription'] as Map).cast<String, dynamic>()),
      ...
      runtimeUpdatableParams: RuntimeUpdatableParamsResponse.fromMap(
          (map['runtimeUpdatableParams'] as Map).cast<String, dynamic>()),
      satisfiesPzi: map['satisfiesPzi'] as bool,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      stageStates: pulumi.Input.decodeList<ExecutionStageStateResponse>(
          map['stageStates'],
          (value) => ExecutionStageStateResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      startTime: map['startTime'] as String,
      steps: pulumi.Input.decodeList<StepResponse>(
          map['steps'],
          (value) =>
