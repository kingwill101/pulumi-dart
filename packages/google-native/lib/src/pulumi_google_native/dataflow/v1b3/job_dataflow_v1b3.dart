...
import 'environment_response_dataflow_v1b3.dart';
import 'execution_stage_state_response.dart';
import 'job_dataflow_v1b3_args.dart';
...
class JobDataflowV1b3 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EnvironmentResponseDataflowV1b3> environment;
  ...
  JobDataflowV1b3(
    ...
    this.environment =
        registerOutput<EnvironmentResponseDataflowV1b3>('environment');
    this.executionInfo =
