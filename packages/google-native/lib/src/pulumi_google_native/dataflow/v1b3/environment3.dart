...
class Environment3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    final clusterManagerApiServiceValue = clusterManagerApiService;
    if (clusterManagerApiServiceValue != null) {
      map['clusterManagerApiService'] = clusterManagerApiServiceValue;
    }
    final datasetValue = dataset;
    if (datasetValue != null) {
      map['dataset'] = datasetValue;
    }
    final debugOptionsValue = debugOptions;
    if (debugOptionsValue != null) {
      map['debugOptions'] = debugOptionsValue.toMap();
    }
    final experimentsValue = experiments;
    if (experimentsValue != null) {
      map['experiments'] = experimentsValue;
    }
    final flexResourceSchedulingGoalValue = flexResourceSchedulingGoal;
    if (flexResourceSchedulingGoalValue != null) {
      map['flexResourceSchedulingGoal'] = flexResourceSchedulingGoalValue.value;
    }
    final internalExperimentsValue = internalExperiments;
    if (internalExperimentsValue != null) {
      map['internalExperiments'] = internalExperimentsValue;
    }
    final sdkPipelineOptionsValue = sdkPipelineOptions;
    if (sdkPipelineOptionsValue != null) {
      map['sdkPipelineOptions'] = sdkPipelineOptionsValue;
    }
    ...
    final serviceKmsKeyNameValue = serviceKmsKeyName;
    if (serviceKmsKeyNameValue != null) {
      map['serviceKmsKeyName'] = serviceKmsKeyNameValue;
    }
    final serviceOptionsValue = serviceOptions;
    if (serviceOptionsValue != null) {
      map['serviceOptions'] = serviceOptionsValue;
    }
    ...
    final workerPoolsValue = workerPools;
    if (workerPoolsValue != null) {
      map['workerPools'] = Input.encodeList<WorkerPool, Map<String, dynamic>>(
          workerPoolsValue, (value) => value.toMap());
    }
  ...
  factory Environment3.fromMap(Map<String, dynamic> map) {
    return Environment3(
      clusterManagerApiService: map['clusterManagerApiService'] == null
          ? null
          : map['clusterManagerApiService'] as String,
      dataset: map['dataset'] == null ? null : map['dataset'] as String,
      debugOptions: map['debugOptions'] == null
          ? null
          : DebugOptions.fromMap(
              (map['debugOptions'] as Map).cast<String, dynamic>()),
      experiments: map['experiments'] == null
          ? null
          : (map['experiments'] as List).cast<String>(),
      flexResourceSchedulingGoal: map['flexResourceSchedulingGoal'] == null
          ? null
          : EnvironmentFlexResourceSchedulingGoal.fromValue(
              map['flexResourceSchedulingGoal'] as String),
      internalExperiments: map['internalExperiments'] == null
          ? null
          : (map['internalExperiments'] as Map).cast<String, String>(),
      sdkPipelineOptions: map['sdkPipelineOptions'] == null
          ? null
      ...
      serviceKmsKeyName: map['serviceKmsKeyName'] == null
          ? null
          : map['serviceKmsKeyName'] as String,
      serviceOptions: map['serviceOptions'] == null
          ? null
          : (map['serviceOptions'] as List).cast<String>(),
      tempStoragePrefix: map['tempStoragePrefix'] == null
          ? null
          : map['tempStoragePrefix'] as String,
      userAgent: map['userAgent'] == null
          ? null
          : (map['userAgent'] as Map).cast<String, String>(),
      version: map['version'] == null
          ? null
          : (map['version'] as Map).cast<String, String>(),
      workerPools: map['workerPools'] == null
          ? null
          : Input.decodeList<WorkerPool>(
              map['workerPools'],
              (value) =>
