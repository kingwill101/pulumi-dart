...
class Job5 extends CustomResource {
  ...
  late final Output<String> clientRequestId;

  /// The timestamp when the job was initially created. Immutable and set by the Cloud Dataflow service.
  late final Output<String> createTime;

  /// If this is specified, the job's initial state is populated from the given snapshot.
  late final Output<String> createdFromSnapshotId;

  /// The current state of the job. Jobs are created in the `JOB_STATE_STOPPED` state unless otherwise specified. A job in the `JOB_STATE_RUNNING` state may asynchronously enter a terminal state. After a job has reached a terminal state, no further state updates may be made. This field may be mutated by the Cloud Dataflow service; callers cannot mutate it.
  late final Output<String> currentState;

  /// The timestamp associated with the current state.
  late final Output<String> currentStateTime;

  /// The environment for the job.
  late final Output<EnvironmentResponse3> environment;

  /// Deprecated.
  late final Output<JobExecutionInfoResponse> executionInfo;

  /// This field is populated by the Dataflow service to support filtering jobs by the metadata values provided here. Populated for ListJobs and all GetJob views SUMMARY and higher.
  late final Output<JobMetadataResponse> jobMetadata;
  ...
  late final Output<PipelineDescriptionResponse> pipelineDescription;
  late final Output<String> project;

  /// Deprecated. This field is now in the Job message.
  late final Output<String> replaceJobId;

  /// If another job is an update of this job (and thus, this job is in `JOB_STATE_UPDATED`), this field contains the ID of that job.
  late final Output<String> replacedByJobId;
  ...
  late final Output<RuntimeUpdatableParamsResponse> runtimeUpdatableParams;
  ...
  late final Output<List<ExecutionStageStateResponse>> stageStates;
  ...
  late final Output<List<StepResponse>> steps;

  /// The Cloud Storage location where the steps are stored.
  late final Output<String> stepsLocation;

  /// A set of files the system should be aware of that are used for temporary storage. These temporary files will be removed on job completion. No duplicates are allowed. No file patterns are supported. The supported files are: Google Cloud Storage: storage.googleapis.com/{bucket}/{object} bucket.storage.googleapis.com/{object}
  late final Output<List<String>> tempFiles;
