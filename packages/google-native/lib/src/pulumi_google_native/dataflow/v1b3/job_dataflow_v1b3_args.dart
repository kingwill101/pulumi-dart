...
import 'environment_dataflow_v1b3.dart';
...
class JobDataflowV1b3Args {
  ...
  final pulumi.Input<EnvironmentDataflowV1b3>? environment;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (environmentValue != null) {
      map['environment'] = pulumi.Input.mapOptionalInputValue<
          EnvironmentDataflowV1b3,
          Map<String, dynamic>>(environmentValue, (value) => value.toMap());
    }
    final executionInfoValue = executionInfo;
    if (executionInfoValue != null) {
      map['executionInfo'] = pulumi.Input.mapOptionalInputValue<
          JobExecutionInfo,
          Map<String, dynamic>>(executionInfoValue, (value) => value.toMap());
    }
    final idValue = id;
    if (idValue != null) {
      map['id'] = idValue;
    ...
    if (jobMetadataValue != null) {
      map['jobMetadata'] =
          pulumi.Input.mapOptionalInputValue<JobMetadata, Map<String, dynamic>>(
    ...
    if (pipelineDescriptionValue != null) {
      map['pipelineDescription'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (runtimeUpdatableParamsValue != null) {
      map['runtimeUpdatableParams'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (stageStatesValue != null) {
      map['stageStates'] = pulumi.Input.mapOptionalInputValue<
              List<ExecutionStageState>, List<Map<String, dynamic>>>(
          stageStatesValue,
          (value) => pulumi.Input.encodeList<ExecutionStageState,
    ...
    if (stepsValue != null) {
      map['steps'] = pulumi.Input.mapOptionalInputValue<List<Step>,
    ...
    if (typeValue != null) {
      map['type'] = pulumi.Input.mapOptionalInputValue<JobType, String>(
  ...
  factory JobDataflowV1b3Args.fromMap(Map<String, dynamic> map) {
    return JobDataflowV1b3Args(
      clientRequestId:
          pulumi.Input.asOptionalInput<String>(map['clientRequestId']),
      createTime: pulumi.Input.asOptionalInput<String>(map['createTime']),
      createdFromSnapshotId:
          pulumi.Input.asOptionalInput<String>(map['createdFromSnapshotId']),
      currentState:
          pulumi.Input.asOptionalInput<JobCurrentState>(map['currentState']),
      currentStateTime:
          pulumi.Input.asOptionalInput<String>(map['currentStateTime']),
      environment: pulumi.Input.asOptionalInput<EnvironmentDataflowV1b3>(
          map['environment']),
      executionInfo:
          pulumi.Input.asOptionalInput<JobExecutionInfo>(map['executionInfo']),
      id: pulumi.Input.asOptionalInput<String>(map['id']),
      jobMetadata:
          pulumi.Input.asOptionalInput<JobMetadata>(map['jobMetadata']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      pipelineDescription: pulumi.Input.asOptionalInput<PipelineDescription>(
          map['pipelineDescription']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      replaceJobId: pulumi.Input.asOptionalInput<String>(map['replaceJobId']),
      replacedByJobId:
          pulumi.Input.asOptionalInput<String>(map['replacedByJobId']),
      requestedState: pulumi.Input.asOptionalInput<JobRequestedState>(
          map['requestedState']),
      runtimeUpdatableParams:
          pulumi.Input.asOptionalInput<RuntimeUpdatableParams>(
              map['runtimeUpdatableParams']),
      satisfiesPzs: pulumi.Input.asOptionalInput<bool>(map['satisfiesPzs']),
      stageStates: pulumi.Input.asOptionalInput<List<ExecutionStageState>>(
          map['stageStates']),
      startTime: pulumi.Input.asOptionalInput<String>(map['startTime']),
      steps: pulumi.Input.asOptionalInput<List<Step>>(map['steps']),
      stepsLocation: pulumi.Input.asOptionalInput<String>(map['stepsLocation']),
      tempFiles: pulumi.Input.asOptionalInput<List<String>>(map['tempFiles']),
      transformNameMapping: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['transformNameMapping']),
      type: pulumi.Input.asOptionalInput<JobType>(map['type']),
