...
class EnvironmentResponseDataflowV1b3 {
  ...
  EnvironmentResponseDataflowV1b3({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['version'] = version;
    map['workerPools'] =
        pulumi.Input.encodeList<WorkerPoolResponse, Map<String, dynamic>>(
  ...
  factory EnvironmentResponseDataflowV1b3.fromMap(Map<String, dynamic> map) {
    return EnvironmentResponseDataflowV1b3(
      ...
      workerPools: pulumi.Input.decodeList<WorkerPoolResponse>(
          map['workerPools'],
