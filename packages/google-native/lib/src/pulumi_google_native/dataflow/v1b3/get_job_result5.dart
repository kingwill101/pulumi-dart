...
class GetJobResult5 {
  ...
  final EnvironmentResponse3 environment;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['stageStates'] =
        Input.encodeList<ExecutionStageStateResponse, Map<String, dynamic>>(
            stageStates, (value) => value.toMap());
    map['startTime'] = startTime;
    map['steps'] = Input.encodeList<StepResponse, Map<String, dynamic>>(
  ...
  factory GetJobResult5.fromMap(Map<String, dynamic> map) {
    return GetJobResult5(
      ...
      environment: EnvironmentResponse3.fromMap(
      ...
      stageStates: Input.decodeList<ExecutionStageStateResponse>(
          map['stageStates'],
          (value) => ExecutionStageStateResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      startTime: map['startTime'] as String,
      steps: Input.decodeList<StepResponse>(
          map['steps'],
          (value) =>
