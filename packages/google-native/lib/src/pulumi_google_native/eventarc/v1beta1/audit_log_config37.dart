...
class AuditLogConfig37 {
  ...
  factory AuditLogConfig37.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig37(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType37.fromValue(map['logType'] as String),
    );
  }
}
