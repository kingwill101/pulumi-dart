...
class GetTriggerEventarcV1beta1Result {
  ...
  GetTriggerEventarcV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['matchingCriteria'] =
        pulumi.Input.encodeList<MatchingCriteriaResponse, Map<String, dynamic>>(
  ...
  factory GetTriggerEventarcV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetTriggerEventarcV1beta1Result(
      ...
      destination: DestinationResponseEventarcV1beta1.fromMap(
          (map['destination'] as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      matchingCriteria: pulumi.Input.decodeList<MatchingCriteriaResponse>(
          map['matchingCriteria'],
          (value) => MatchingCriteriaResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      serviceAccount: map['serviceAccount'] as String,
      transport: TransportResponseEventarcV1beta1.fromMap(
