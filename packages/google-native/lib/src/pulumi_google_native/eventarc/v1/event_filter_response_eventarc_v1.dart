...
class EventFilterResponseEventarcV1 {
  ...
  factory EventFilterResponseEventarcV1.fromMap(Map<String, dynamic> map) {
    return EventFilterResponseEventarcV1(
