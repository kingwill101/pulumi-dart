...
import 'network_config_eventarc_v1.dart';

/// Represents a target of an invocation over HTTP.
class DestinationEventarcV1 {
  ...
  final NetworkConfigEventarcV1? networkConfig;

  /// The resource name of the Workflow whose Executions are triggered by the events. The Workflow resource should be deployed in the same project as the trigger. Format: `projects/{project}/locations/{location}/workflows/{workflow}`
  final String? workflow;

  DestinationEventarcV1({
    this.cloudFunction,
    this.cloudRun,
    this.gke,
    this.httpEndpoint,
  ...
  factory DestinationEventarcV1.fromMap(Map<String, dynamic> map) {
    return DestinationEventarcV1(
      cloudFunction:
      ...
      networkConfig: map['networkConfig'] == null
          ? null
          : NetworkConfigEventarcV1.fromMap(
