...
class AuditLogConfig36 {
  ...
  factory AuditLogConfig36.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig36(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType36.fromValue(map['logType'] as String),
    );
  }
}
