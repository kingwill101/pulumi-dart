...
import 'trigger_eventarc_v1_args.dart';

/// Create a new trigger in a particular project and location.
class TriggerEventarcV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DestinationResponseEventarcV1> destination;
  ...
  late final pulumi.Output<List<EventFilterResponseEventarcV1>> eventFilters;
  ...
  TriggerEventarcV1(
    ...
    this.destination =
        registerOutput<DestinationResponseEventarcV1>('destination');
    this.etag = registerOutput<String>('etag');
    this.eventDataContentType = registerOutput<String>('eventDataContentType');
    this.eventFilters =
        registerOutput<List<EventFilterResponseEventarcV1>>('eventFilters');
