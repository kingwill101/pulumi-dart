...
import 'network_config_response13.dart';

/// Represents a target of an invocation over HTTP.
class DestinationResponse2 {
  ...
  final NetworkConfigResponse13 networkConfig;

  /// The resource name of the Workflow whose Executions are triggered by the events. The Workflow resource should be deployed in the same project as the trigger. Format: `projects/{project}/locations/{location}/workflows/{workflow}`
  final String workflow;

  DestinationResponse2({
  ...
  factory DestinationResponse2.fromMap(Map<String, dynamic> map) {
    return DestinationResponse2(
      ...
      networkConfig: NetworkConfigResponse13.fromMap(
