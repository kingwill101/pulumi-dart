...
class GetTriggerResult2 {
  ...
  final DestinationResponse2 destination;
  ...
  final List<EventFilterResponse4> eventFilters;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['eventFilters'] =
        Input.encodeList<EventFilterResponse4, Map<String, dynamic>>(
  ...
  factory GetTriggerResult2.fromMap(Map<String, dynamic> map) {
    return GetTriggerResult2(
      channel: map['channel'] as String,
      conditions: (map['conditions'] as Map).cast<String, String>(),
      createTime: map['createTime'] as String,
      destination: DestinationResponse2.fromMap(
          (map['destination'] as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      eventDataContentType: map['eventDataContentType'] as String,
      eventFilters: Input.decodeList<EventFilterResponse4>(
          map['eventFilters'],
          (value) => EventFilterResponse4.fromMap(
