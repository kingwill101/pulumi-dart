...
class NetworkConfig5 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (vlanAttachmentsValue != null) {
      map['vlanAttachments'] =
          Input.encodeList<IntakeVlanAttachment, Map<String, dynamic>>(
  ...
  factory NetworkConfig5.fromMap(Map<String, dynamic> map) {
    return NetworkConfig5(
      ...
      vlanAttachments: map['vlanAttachments'] == null
          ? null
          : Input.decodeList<IntakeVlanAttachment>(
              map['vlanAttachments'],
