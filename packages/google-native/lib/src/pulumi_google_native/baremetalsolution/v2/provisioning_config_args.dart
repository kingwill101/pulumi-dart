...
class ProvisioningConfigArgs {
  ...
  final Input<String>? ticketId;

  /// Volumes to be created.
  final Input<List<VolumeConfig>>? volumes;

  /// If true, VPC SC is enabled for the cluster.
  final Input<bool>? vpcScEnabled;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (instancesValue != null) {
      map['instances'] = Input.mapOptionalInputValue<List<InstanceConfig>,
              List<Map<String, dynamic>>>(
          instancesValue,
          (value) => Input.encodeList<InstanceConfig, Map<String, dynamic>>(
    ...
    if (networksValue != null) {
      map['networks'] = Input.mapOptionalInputValue<List<NetworkConfig5>,
              List<Map<String, dynamic>>>(
          networksValue,
          (value) => Input.encodeList<NetworkConfig5, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final podValue = pod;
    if (podValue != null) {
    ...
    if (volumesValue != null) {
      map['volumes'] = Input.mapOptionalInputValue<List<VolumeConfig>,
              List<Map<String, dynamic>>>(
          volumesValue,
          (value) => Input.encodeList<VolumeConfig, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory ProvisioningConfigArgs.fromMap(Map<String, dynamic> map) {
    return ProvisioningConfigArgs(
      customId: Input.asOptionalInput<String>(map['customId']),
      email: Input.asOptionalInput<String>(map['email']),
      handoverServiceAccount:
          Input.asOptionalInput<String>(map['handoverServiceAccount']),
      instances: Input.asOptionalInput<List<InstanceConfig>>(map['instances']),
      location: Input.asOptionalInput<String>(map['location']),
      networks: Input.asOptionalInput<List<NetworkConfig5>>(map['networks']),
      pod: Input.asOptionalInput<String>(map['pod']),
      project: Input.asOptionalInput<String>(map['project']),
      statusMessage: Input.asOptionalInput<String>(map['statusMessage']),
      ticketId: Input.asOptionalInput<String>(map['ticketId']),
      volumes: Input.asOptionalInput<List<VolumeConfig>>(map['volumes']),
      vpcScEnabled: Input.asOptionalInput<bool>(map['vpcScEnabled']),
    );
  }
}
