...
class NetworkConfigResponse5 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['vlanAttachments'] =
        Input.encodeList<IntakeVlanAttachmentResponse, Map<String, dynamic>>(
            vlanAttachments, (value) => value.toMap());
    map['vlanSameProject'] = vlanSameProject;
    return map;
  }

  factory NetworkConfigResponse5.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponse5(
      ...
      vlanAttachments: Input.decodeList<IntakeVlanAttachmentResponse>(
          map['vlanAttachments'],
