...
class RuntimeIamMemberNotebooksV1Args {
  ...
  RuntimeIamMemberNotebooksV1Args({
    this.condition,
  ...
  factory RuntimeIamMemberNotebooksV1Args.fromMap(Map<String, dynamic> map) {
    return RuntimeIamMemberNotebooksV1Args(
