...
class RuntimeIamBindingNotebooksV1Args {
  ...
  RuntimeIamBindingNotebooksV1Args({
    this.condition,
  ...
  factory RuntimeIamBindingNotebooksV1Args.fromMap(Map<String, dynamic> map) {
    return RuntimeIamBindingNotebooksV1Args(
