...
class GetScheduleNotebooksV1Result {
  ...
  factory GetScheduleNotebooksV1Result.fromMap(Map<String, dynamic> map) {
    return GetScheduleNotebooksV1Result(
