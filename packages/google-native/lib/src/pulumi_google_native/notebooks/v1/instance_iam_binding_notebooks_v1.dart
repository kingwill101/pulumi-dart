...
import 'instance_iam_binding_notebooks_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InstanceIamBindingNotebooksV1 extends pulumi.CustomResource {
  ...
  InstanceIamBindingNotebooksV1(
    String name, {
    InstanceIamBindingNotebooksV1Args? args,
