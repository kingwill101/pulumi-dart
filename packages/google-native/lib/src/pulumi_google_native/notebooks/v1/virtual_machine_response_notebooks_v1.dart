...
class VirtualMachineResponseNotebooksV1 {
  ...
  VirtualMachineResponseNotebooksV1({
  ...
  factory VirtualMachineResponseNotebooksV1.fromMap(Map<String, dynamic> map) {
    return VirtualMachineResponseNotebooksV1(
