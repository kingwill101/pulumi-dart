...
class LocalDiskResponseNotebooksV1 {
  ...
  factory LocalDiskResponseNotebooksV1.fromMap(Map<String, dynamic> map) {
    return LocalDiskResponseNotebooksV1(
      autoDelete: map['autoDelete'] as bool,
      boot: map['boot'] as bool,
      deviceName: map['deviceName'] as String,
      guestOsFeatures: pulumi.Input.decodeList<RuntimeGuestOsFeatureResponse>(
          map['guestOsFeatures'],
