...
class InstanceIamMemberNotebooksV1Args {
  ...
  InstanceIamMemberNotebooksV1Args({
    this.condition,
  ...
  factory InstanceIamMemberNotebooksV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberNotebooksV1Args(
