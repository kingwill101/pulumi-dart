...
import 'accelerator_config_notebooks_v1.dart';
...
import 'reservation_affinity_notebooks_v1.dart';
import 'shielded_instance_config_notebooks_v1.dart';
import 'upgrade_history_entry.dart';
import 'vm_image.dart';

/// The set of arguments for Instance.
class InstanceNotebooksV1Args {
  ...
  final pulumi.Input<AcceleratorConfigNotebooksV1>? acceleratorConfig;
  ...
  final pulumi.Input<ReservationAffinityNotebooksV1>? reservationAffinity;
  ...
  final pulumi.Input<ShieldedInstanceConfigNotebooksV1>? shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (acceleratorConfigValue != null) {
      map['acceleratorConfig'] = pulumi.Input.mapOptionalInputValue<
              AcceleratorConfigNotebooksV1, Map<String, dynamic>>(
    ...
    if (reservationAffinityValue != null) {
      map['reservationAffinity'] = pulumi.Input.mapOptionalInputValue<
              ReservationAffinityNotebooksV1, Map<String, dynamic>>(
    ...
    if (shieldedInstanceConfigValue != null) {
      map['shieldedInstanceConfig'] = pulumi.Input.mapOptionalInputValue<
              ShieldedInstanceConfigNotebooksV1, Map<String, dynamic>>(
  ...
  factory InstanceNotebooksV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceNotebooksV1Args(
      acceleratorConfig:
          pulumi.Input.asOptionalInput<AcceleratorConfigNotebooksV1>(
              map['acceleratorConfig']),
      bootDiskSizeGb:
          pulumi.Input.asOptionalInput<String>(map['bootDiskSizeGb']),
      ...
      dataDiskSizeGb:
          pulumi.Input.asOptionalInput<String>(map['dataDiskSizeGb']),
      ...
      nicType: pulumi.Input.asOptionalInput<InstanceNicType>(map['nicType']),
      ...
      reservationAffinity:
          pulumi.Input.asOptionalInput<ReservationAffinityNotebooksV1>(
      ...
      shieldedInstanceConfig:
          pulumi.Input.asOptionalInput<ShieldedInstanceConfigNotebooksV1>(
