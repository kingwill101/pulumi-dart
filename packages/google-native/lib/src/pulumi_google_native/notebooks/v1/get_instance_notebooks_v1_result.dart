...
import 'accelerator_config_response_notebooks_v1.dart';
import 'container_image_response.dart';
import 'disk_response_notebooks_v1.dart';
import 'instance_migration_eligibility_response.dart';
import 'reservation_affinity_response_notebooks_v1.dart';
import 'shielded_instance_config_response_notebooks_v1.dart';
import 'upgrade_history_entry_response.dart';
import 'vm_image_response.dart';

/// Result data returned by getInstance.
class GetInstanceNotebooksV1Result {
  ...
  final AcceleratorConfigResponseNotebooksV1 acceleratorConfig;
  ...
  final List<DiskResponseNotebooksV1> disks;
  ...
  final ReservationAffinityResponseNotebooksV1 reservationAffinity;
  ...
  final ShieldedInstanceConfigResponseNotebooksV1 shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['disks'] =
        pulumi.Input.encodeList<DiskResponseNotebooksV1, Map<String, dynamic>>(
    ...
    map['upgradeHistory'] = pulumi.Input.encodeList<UpgradeHistoryEntryResponse,
        Map<String, dynamic>>(upgradeHistory, (value) => value.toMap());
    map['vmImage'] = vmImage.toMap();
    return map;
  }

  factory GetInstanceNotebooksV1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceNotebooksV1Result(
      acceleratorConfig: AcceleratorConfigResponseNotebooksV1.fromMap(
      ...
      disks: pulumi.Input.decodeList<DiskResponseNotebooksV1>(
          map['disks'],
          (value) => DiskResponseNotebooksV1.fromMap(
      ...
      reservationAffinity: ReservationAffinityResponseNotebooksV1.fromMap(
          (map['reservationAffinity'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      serviceAccountScopes:
          (map['serviceAccountScopes'] as List).cast<String>(),
      shieldedInstanceConfig: ShieldedInstanceConfigResponseNotebooksV1.fromMap(
          (map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      subnet: map['subnet'] as String,
      tags: (map['tags'] as List).cast<String>(),
      updateTime: map['updateTime'] as String,
      upgradeHistory: pulumi.Input.decodeList<UpgradeHistoryEntryResponse>(
          map['upgradeHistory'],
