...
class ShieldedInstanceConfigNotebooksV1 {
  ...
  ShieldedInstanceConfigNotebooksV1({
  ...
  factory ShieldedInstanceConfigNotebooksV1.fromMap(Map<String, dynamic> map) {
    return ShieldedInstanceConfigNotebooksV1(
