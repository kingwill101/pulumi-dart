...
class AcceleratorConfigResponseNotebooksV1 {
  ...
  AcceleratorConfigResponseNotebooksV1({
  ...
  factory AcceleratorConfigResponseNotebooksV1.fromMap(
      Map<String, dynamic> map) {
    return AcceleratorConfigResponseNotebooksV1(
