...
class ReservationAffinityResponse8 {
  ...
  factory ReservationAffinityResponse8.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityResponse8(
