...
class InstanceIamBindingNotebooksV1Args {
  ...
  InstanceIamBindingNotebooksV1Args({
    this.condition,
  ...
  factory InstanceIamBindingNotebooksV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingNotebooksV1Args(
