...
import 'instance_iam_member_notebooks_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InstanceIamMemberNotebooksV1 extends pulumi.CustomResource {
  ...
  InstanceIamMemberNotebooksV1(
    String name, {
    InstanceIamMemberNotebooksV1Args? args,
