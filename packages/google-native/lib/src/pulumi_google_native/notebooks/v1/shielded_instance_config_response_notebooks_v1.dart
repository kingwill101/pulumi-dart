...
class ShieldedInstanceConfigResponseNotebooksV1 {
  ...
  ShieldedInstanceConfigResponseNotebooksV1({
  ...
  factory ShieldedInstanceConfigResponseNotebooksV1.fromMap(
      Map<String, dynamic> map) {
    return ShieldedInstanceConfigResponseNotebooksV1(
