...
class GetEnvironmentNotebooksV1Result {
  ...
  GetEnvironmentNotebooksV1Result({
  ...
  factory GetEnvironmentNotebooksV1Result.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentNotebooksV1Result(
