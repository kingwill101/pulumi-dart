...
import 'instance_notebooks_v1_args.dart';
...
class InstanceNotebooksV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AcceleratorConfigResponseNotebooksV1>
      acceleratorConfig;
  ...
  late final pulumi.Output<List<DiskResponseNotebooksV1>> disks;
  ...
  late final pulumi.Output<ReservationAffinityResponseNotebooksV1>
      reservationAffinity;
  ...
  late final pulumi.Output<ShieldedInstanceConfigResponseNotebooksV1>
  ...
  InstanceNotebooksV1(
    ...
    this.acceleratorConfig =
        registerOutput<AcceleratorConfigResponseNotebooksV1>(
            'acceleratorConfig');
    ...
    this.disks = registerOutput<List<DiskResponseNotebooksV1>>('disks');
    ...
    this.reservationAffinity =
        registerOutput<ReservationAffinityResponseNotebooksV1>(
            'reservationAffinity');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.serviceAccountScopes =
        registerOutput<List<String>>('serviceAccountScopes');
    this.shieldedInstanceConfig =
        registerOutput<ShieldedInstanceConfigResponseNotebooksV1>(
            'shieldedInstanceConfig');
