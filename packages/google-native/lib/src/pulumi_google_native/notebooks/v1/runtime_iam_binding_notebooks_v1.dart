...
import 'runtime_iam_binding_notebooks_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class RuntimeIamBindingNotebooksV1 extends pulumi.CustomResource {
  ...
  RuntimeIamBindingNotebooksV1(
    String name, {
    RuntimeIamBindingNotebooksV1Args? args,
