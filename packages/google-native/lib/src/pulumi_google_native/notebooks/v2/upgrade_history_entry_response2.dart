...
class UpgradeHistoryEntryResponse2 {
  ...
  factory UpgradeHistoryEntryResponse2.fromMap(Map<String, dynamic> map) {
    return UpgradeHistoryEntryResponse2(
