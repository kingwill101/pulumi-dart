...
class GetInstanceResult19 {
  ...
  final List<UpgradeHistoryEntryResponse2> upgradeHistory;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['upgradeHistory'] =
        Input.encodeList<UpgradeHistoryEntryResponse2, Map<String, dynamic>>(
            upgradeHistory, (value) => value.toMap());
    return map;
  }

  factory GetInstanceResult19.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult19(
      ...
      upgradeHistory: Input.decodeList<UpgradeHistoryEntryResponse2>(
          map['upgradeHistory'],
          (value) => UpgradeHistoryEntryResponse2.fromMap(
