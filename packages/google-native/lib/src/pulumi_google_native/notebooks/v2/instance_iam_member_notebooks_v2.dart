...
import 'instance_iam_member_notebooks_v2_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InstanceIamMemberNotebooksV2 extends pulumi.CustomResource {
  ...
  InstanceIamMemberNotebooksV2(
    String name, {
    InstanceIamMemberNotebooksV2Args? args,
