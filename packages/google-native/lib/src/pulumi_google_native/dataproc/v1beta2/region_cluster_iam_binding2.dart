...
import 'region_cluster_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class RegionClusterIamBinding2 extends CustomResource {
  ...
  RegionClusterIamBinding2(
    String name, {
    RegionClusterIamBindingArgs2? args,
