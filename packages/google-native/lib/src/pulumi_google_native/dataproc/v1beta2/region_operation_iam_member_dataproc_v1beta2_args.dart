...
/// The set of arguments for RegionOperationIamMember.
class RegionOperationIamMemberDataprocV1beta2Args {
  ...
  RegionOperationIamMemberDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionOperationIamMemberDataprocV1beta2Args.fromMap(
      Map<String, dynamic> map) {
    return RegionOperationIamMemberDataprocV1beta2Args(
