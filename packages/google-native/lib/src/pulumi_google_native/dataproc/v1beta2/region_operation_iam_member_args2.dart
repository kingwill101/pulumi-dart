...
class RegionOperationIamMemberArgs2 {
  ...
  factory RegionOperationIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return RegionOperationIamMemberArgs2(
