...
import 'autoscaling_policy_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class AutoscalingPolicyIamBinding2 extends CustomResource {
  ...
  AutoscalingPolicyIamBinding2(
    String name, {
    AutoscalingPolicyIamBindingArgs2? args,
