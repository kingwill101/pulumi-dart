...
class WorkflowTemplateIamMemberArgs2 {
  ...
  WorkflowTemplateIamMemberArgs2({
    this.condition,
  ...
  factory WorkflowTemplateIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateIamMemberArgs2(
