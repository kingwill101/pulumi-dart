...
class GetWorkflowTemplateDataprocV1beta2Result {
  ...
  GetWorkflowTemplateDataprocV1beta2Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['jobs'] = pulumi.Input.encodeList<OrderedJobResponseDataprocV1beta2,
        Map<String, dynamic>>(jobs, (value) => value.toMap());
    map['labels'] = labels;
    map['name'] = name;
    map['parameters'] = pulumi.Input.encodeList<
        TemplateParameterResponseDataprocV1beta2,
  ...
  factory GetWorkflowTemplateDataprocV1beta2Result.fromMap(
      Map<String, dynamic> map) {
    return GetWorkflowTemplateDataprocV1beta2Result(
      createTime: map['createTime'] as String,
      dagTimeout: map['dagTimeout'] as String,
      jobs: pulumi.Input.decodeList<OrderedJobResponseDataprocV1beta2>(
          map['jobs'],
          (value) => OrderedJobResponseDataprocV1beta2.fromMap(
              (value as Map).cast<String, dynamic>())),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      parameters:
          pulumi.Input.decodeList<TemplateParameterResponseDataprocV1beta2>(
              map['parameters'],
              (value) => TemplateParameterResponseDataprocV1beta2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      placement: WorkflowTemplatePlacementResponseDataprocV1beta2.fromMap(
