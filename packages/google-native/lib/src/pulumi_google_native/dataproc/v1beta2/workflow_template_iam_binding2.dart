...
import 'workflow_template_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class WorkflowTemplateIamBinding2 extends CustomResource {
  ...
  WorkflowTemplateIamBinding2(
    String name, {
    WorkflowTemplateIamBindingArgs2? args,
