...
class SoftwareConfig4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (optionalComponentsValue != null) {
      map['optionalComponents'] =
          Input.encodeList<SoftwareConfigOptionalComponentsItem2, String>(
  ...
  factory SoftwareConfig4.fromMap(Map<String, dynamic> map) {
    return SoftwareConfig4(
      imageVersion:
          map['imageVersion'] == null ? null : map['imageVersion'] as String,
      optionalComponents: map['optionalComponents'] == null
          ? null
          : Input.decodeList<SoftwareConfigOptionalComponentsItem2>(
              map['optionalComponents'],
              (value) => SoftwareConfigOptionalComponentsItem2.fromValue(
                  value as String)),
