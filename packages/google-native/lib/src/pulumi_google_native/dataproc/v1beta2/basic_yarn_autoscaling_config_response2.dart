...
class BasicYarnAutoscalingConfigResponse2 {
  ...
  BasicYarnAutoscalingConfigResponse2({
  ...
  factory BasicYarnAutoscalingConfigResponse2.fromMap(
      Map<String, dynamic> map) {
    return BasicYarnAutoscalingConfigResponse2(
