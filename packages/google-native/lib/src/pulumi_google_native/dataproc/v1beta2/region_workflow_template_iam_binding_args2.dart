...
class RegionWorkflowTemplateIamBindingArgs2 {
  ...
  RegionWorkflowTemplateIamBindingArgs2({
    this.condition,
  ...
  factory RegionWorkflowTemplateIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionWorkflowTemplateIamBindingArgs2(
