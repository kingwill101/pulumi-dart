...
class BasicYarnAutoscalingConfigResponseDataprocV1beta2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['scaleDownMinWorkerFraction'] = scaleDownMinWorkerFraction;
    map['scaleUpFactor'] = scaleUpFactor;
    map['scaleUpMinWorkerFraction'] = scaleUpMinWorkerFraction;
    return map;
  }

  factory BasicYarnAutoscalingConfigResponseDataprocV1beta2.fromMap(
      Map<String, dynamic> map) {
    return BasicYarnAutoscalingConfigResponseDataprocV1beta2(
      gracefulDecommissionTimeout: map['gracefulDecommissionTimeout'] as String,
      scaleDownFactor: map['scaleDownFactor'] as double,
      scaleDownMinWorkerFraction: map['scaleDownMinWorkerFraction'] as double,
      scaleUpFactor: map['scaleUpFactor'] as double,
      scaleUpMinWorkerFraction: map['scaleUpMinWorkerFraction'] as double,
    );
  }
}
