...
class InstanceGroupAutoscalingPolicyConfigResponse2 {
  ...
  InstanceGroupAutoscalingPolicyConfigResponse2({
  ...
  factory InstanceGroupAutoscalingPolicyConfigResponse2.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupAutoscalingPolicyConfigResponse2(
