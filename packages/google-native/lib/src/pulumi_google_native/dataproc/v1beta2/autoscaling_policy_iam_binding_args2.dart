...
class AutoscalingPolicyIamBindingArgs2 {
  ...
  AutoscalingPolicyIamBindingArgs2({
    this.condition,
  ...
  factory AutoscalingPolicyIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyIamBindingArgs2(
