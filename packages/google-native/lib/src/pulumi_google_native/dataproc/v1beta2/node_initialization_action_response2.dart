...
class NodeInitializationActionResponse2 {
  ...
  factory NodeInitializationActionResponse2.fromMap(Map<String, dynamic> map) {
    return NodeInitializationActionResponse2(
