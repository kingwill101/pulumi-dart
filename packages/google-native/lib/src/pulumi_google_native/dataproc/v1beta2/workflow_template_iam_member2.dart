...
import 'workflow_template_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class WorkflowTemplateIamMember2 extends CustomResource {
  ...
  WorkflowTemplateIamMember2(
    String name, {
    WorkflowTemplateIamMemberArgs2? args,
