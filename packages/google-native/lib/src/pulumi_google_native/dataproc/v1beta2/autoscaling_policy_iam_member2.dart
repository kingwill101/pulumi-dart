...
import 'autoscaling_policy_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class AutoscalingPolicyIamMember2 extends CustomResource {
  ...
  AutoscalingPolicyIamMember2(
    String name, {
    AutoscalingPolicyIamMemberArgs2? args,
