...
class RegionAutoscalingPolicyIamMemberArgs2 {
  ...
  RegionAutoscalingPolicyIamMemberArgs2({
    this.condition,
  ...
  factory RegionAutoscalingPolicyIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionAutoscalingPolicyIamMemberArgs2(
