...
class RegionClusterIamMemberArgs2 {
  ...
  factory RegionClusterIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return RegionClusterIamMemberArgs2(
