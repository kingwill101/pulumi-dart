...
class WorkflowTemplateIamPolicyDataprocV1beta2Args {
  ...
  WorkflowTemplateIamPolicyDataprocV1beta2Args({
    this.bindings,
    this.etag,
    this.location,
    this.project,
  ...
  factory WorkflowTemplateIamPolicyDataprocV1beta2Args.fromMap(
      Map<String, dynamic> map) {
    return WorkflowTemplateIamPolicyDataprocV1beta2Args(
