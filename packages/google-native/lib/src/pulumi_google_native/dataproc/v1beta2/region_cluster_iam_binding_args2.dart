...
class RegionClusterIamBindingArgs2 {
  ...
  factory RegionClusterIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return RegionClusterIamBindingArgs2(
