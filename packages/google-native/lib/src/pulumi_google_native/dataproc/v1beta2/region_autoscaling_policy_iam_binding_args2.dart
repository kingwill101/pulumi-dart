...
class RegionAutoscalingPolicyIamBindingArgs2 {
  ...
  RegionAutoscalingPolicyIamBindingArgs2({
    this.condition,
  ...
  factory RegionAutoscalingPolicyIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionAutoscalingPolicyIamBindingArgs2(
