...
/// The set of arguments for RegionClusterIamBinding.
class RegionClusterIamBindingDataprocV1beta2Args {
  ...
  RegionClusterIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionClusterIamBindingDataprocV1beta2Args.fromMap(
      Map<String, dynamic> map) {
    return RegionClusterIamBindingDataprocV1beta2Args(
