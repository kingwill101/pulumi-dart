...
class ManagedCluster2 {
  ...
  factory ManagedCluster2.fromMap(Map<String, dynamic> map) {
    return ManagedCluster2(
      clusterName: map['clusterName'] as String,
      config: ClusterConfig3.fromMap(
