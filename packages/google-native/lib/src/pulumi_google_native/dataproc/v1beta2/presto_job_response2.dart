...
import 'logging_config_response4.dart';
import 'query_list_response2.dart';

/// A Dataproc job for running Presto (https://prestosql.io/) queries. IMPORTANT: The Dataproc Presto Optional Component (https://cloud.google.com/dataproc/docs/concepts/components/presto) must be enabled when the cluster is created to submit a Presto job to the cluster.
class PrestoJobResponse2 {
  ...
  final LoggingConfigResponse4 loggingConfig;
  ...
  /// A list of queries.
  final QueryListResponse2 queryList;
  ...
  factory PrestoJobResponse2.fromMap(Map<String, dynamic> map) {
    return PrestoJobResponse2(
      clientTags: (map['clientTags'] as List).cast<String>(),
      continueOnFailure: map['continueOnFailure'] as bool,
      loggingConfig: LoggingConfigResponse4.fromMap(
      ...
      queryList: QueryListResponse2.fromMap(
