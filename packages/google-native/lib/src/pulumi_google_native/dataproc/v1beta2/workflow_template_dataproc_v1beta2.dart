...
class WorkflowTemplateDataprocV1beta2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<TemplateParameterResponseDataprocV1beta2>>
      parameters;

  /// WorkflowTemplate scheduling information.
  late final pulumi.Output<WorkflowTemplatePlacementResponseDataprocV1beta2>
      placement;
  ...
  WorkflowTemplateDataprocV1beta2(
    ...
    this.parameters =
        registerOutput<List<TemplateParameterResponseDataprocV1beta2>>(
            'parameters');
    this.placement =
