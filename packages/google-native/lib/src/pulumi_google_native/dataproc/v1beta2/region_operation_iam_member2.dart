...
import 'region_operation_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class RegionOperationIamMember2 extends CustomResource {
  ...
  RegionOperationIamMember2(
    String name, {
    RegionOperationIamMemberArgs2? args,
