...
class WorkflowTemplate2 extends CustomResource {
  ...
  late final Output<List<OrderedJobResponse2>> jobs;
  ...
  late final Output<List<TemplateParameterResponse2>> parameters;

  /// WorkflowTemplate scheduling information.
  late final Output<WorkflowTemplatePlacementResponse2> placement;
