...
class RegionWorkflowTemplateIamMemberArgs2 {
  ...
  RegionWorkflowTemplateIamMemberArgs2({
    this.condition,
  ...
  factory RegionWorkflowTemplateIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionWorkflowTemplateIamMemberArgs2(
