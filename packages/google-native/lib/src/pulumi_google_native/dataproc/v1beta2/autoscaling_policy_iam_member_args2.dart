...
class AutoscalingPolicyIamMemberArgs2 {
  ...
  AutoscalingPolicyIamMemberArgs2({
    this.condition,
  ...
  factory AutoscalingPolicyIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyIamMemberArgs2(
