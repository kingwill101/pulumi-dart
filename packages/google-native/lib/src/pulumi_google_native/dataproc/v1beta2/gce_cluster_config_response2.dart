...
import 'node_group_affinity_response2.dart';
import 'reservation_affinity_response7.dart';
import 'shielded_instance_config_response7.dart';

/// Common config settings for resources of Compute Engine cluster instances, applicable to all instances in the cluster.
class GceClusterConfigResponse2 {
  ...
  final NodeGroupAffinityResponse2 nodeGroupAffinity;

  /// Optional. The type of IPv6 access for a cluster.
  final String privateIpv6GoogleAccess;

  /// Optional. Reservation Affinity for consuming Zonal reservation.
  final ReservationAffinityResponse7 reservationAffinity;
  ...
  final ShieldedInstanceConfigResponse7 shieldedInstanceConfig;
