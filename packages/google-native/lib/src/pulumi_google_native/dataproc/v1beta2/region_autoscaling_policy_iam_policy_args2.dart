...
class RegionAutoscalingPolicyIamPolicyArgs2 {
  ...
  RegionAutoscalingPolicyIamPolicyArgs2({
  ...
  factory RegionAutoscalingPolicyIamPolicyArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionAutoscalingPolicyIamPolicyArgs2(
