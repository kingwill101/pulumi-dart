...
class BasicYarnAutoscalingConfig2 {
  ...
  factory BasicYarnAutoscalingConfig2.fromMap(Map<String, dynamic> map) {
    return BasicYarnAutoscalingConfig2(
