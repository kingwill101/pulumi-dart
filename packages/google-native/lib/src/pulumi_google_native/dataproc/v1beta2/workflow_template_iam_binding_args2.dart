...
class WorkflowTemplateIamBindingArgs2 {
  ...
  WorkflowTemplateIamBindingArgs2({
    this.condition,
  ...
  factory WorkflowTemplateIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateIamBindingArgs2(
