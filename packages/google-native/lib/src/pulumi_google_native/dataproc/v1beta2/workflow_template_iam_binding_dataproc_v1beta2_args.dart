...
/// The set of arguments for WorkflowTemplateIamBinding.
class WorkflowTemplateIamBindingDataprocV1beta2Args {
  ...
  WorkflowTemplateIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory WorkflowTemplateIamBindingDataprocV1beta2Args.fromMap(
      Map<String, dynamic> map) {
    return WorkflowTemplateIamBindingDataprocV1beta2Args(
