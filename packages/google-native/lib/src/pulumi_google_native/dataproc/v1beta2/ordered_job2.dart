...
class OrderedJob2 {
  ...
  final HadoopJob2? hadoopJob;

  /// Optional. Job is a Hive job.
  final HiveJob2? hiveJob;

  /// Optional. The labels to associate with this job.Label keys must be between 1 and 63 characters long, and must conform to the following regular expression: \p{Ll}\p{Lo}{0,62}Label values must be between 1 and 63 characters long, and must conform to the following regular expression: \p{Ll}\p{Lo}\p{N}_-{0,63}No more than 32 labels can be associated with a given job.
  final Map<String, String>? labels;

  /// Optional. Job is a Pig job.
  final PigJob2? pigJob;

  /// Optional. The optional list of prerequisite job step_ids. If not specified, the job will start at the beginning of workflow.
  final List<String>? prerequisiteStepIds;

  /// Optional. Job is a Presto job.
  final PrestoJob2? prestoJob;

  /// Optional. Job is a PySpark job.
  final PySparkJob2? pysparkJob;

  /// Optional. Job scheduling configuration.
  final JobScheduling2? scheduling;

  /// Optional. Job is a Spark job.
  final SparkJob2? sparkJob;

  /// Optional. Job is a SparkR job.
  final SparkRJob2? sparkRJob;

  /// Optional. Job is a SparkSql job.
  final SparkSqlJob2? sparkSqlJob;
  ...
  factory OrderedJob2.fromMap(Map<String, dynamic> map) {
    return OrderedJob2(
      ...
      hiveJob: map['hiveJob'] == null
          ? null
          : HiveJob2.fromMap((map['hiveJob'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      pigJob: map['pigJob'] == null
          ? null
          : PigJob2.fromMap((map['pigJob'] as Map).cast<String, dynamic>()),
      ...
      scheduling: map['scheduling'] == null
          ? null
          : JobScheduling2.fromMap(
              (map['scheduling'] as Map).cast<String, dynamic>()),
      sparkJob: map['sparkJob'] == null
          ? null
          : SparkJob2.fromMap((map['sparkJob'] as Map).cast<String, dynamic>()),
