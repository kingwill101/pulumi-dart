...
class RegionOperationIamBindingArgs2 {
  ...
  RegionOperationIamBindingArgs2({
    this.condition,
  ...
  factory RegionOperationIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return RegionOperationIamBindingArgs2(
