...
import 'region_operation_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class RegionOperationIamBinding2 extends CustomResource {
  ...
  RegionOperationIamBinding2(
    String name, {
    RegionOperationIamBindingArgs2? args,
