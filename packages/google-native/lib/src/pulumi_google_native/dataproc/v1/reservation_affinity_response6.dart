...
class ReservationAffinityResponse6 {
  ...
  factory ReservationAffinityResponse6.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityResponse6(
