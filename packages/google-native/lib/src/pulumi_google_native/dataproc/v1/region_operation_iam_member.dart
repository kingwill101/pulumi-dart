...
import 'region_operation_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class RegionOperationIamMember extends pulumi.CustomResource {
  ...
  RegionOperationIamMember(
    String name, {
    RegionOperationIamMemberArgs? args,
