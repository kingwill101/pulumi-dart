...
class SoftwareConfigResponseDataprocV1 {
  ...
  SoftwareConfigResponseDataprocV1({
  ...
  factory SoftwareConfigResponseDataprocV1.fromMap(Map<String, dynamic> map) {
    return SoftwareConfigResponseDataprocV1(
