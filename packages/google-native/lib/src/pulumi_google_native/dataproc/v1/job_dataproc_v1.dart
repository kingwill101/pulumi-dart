...
import 'job_dataproc_v1_args.dart';
...
class JobDataprocV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<JobReferenceResponseDataprocV1> reference;
  ...
  late final pulumi.Output<JobStatusResponseDataprocV1> status;

  /// The previous job status.
  late final pulumi.Output<List<JobStatusResponseDataprocV1>> statusHistory;
  ...
  JobDataprocV1(
    ...
    this.reference =
        registerOutput<JobReferenceResponseDataprocV1>('reference');
    ...
    this.status = registerOutput<JobStatusResponseDataprocV1>('status');
    this.statusHistory =
        registerOutput<List<JobStatusResponseDataprocV1>>('statusHistory');
