...
import 'encryption_config_dataproc_v1.dart';
...
import 'software_config_dataproc_v1.dart';

/// The cluster config.
class ClusterConfigDataprocV1 {
  ...
  final EncryptionConfigDataprocV1? encryptionConfig;
  ...
  final SoftwareConfigDataprocV1? softwareConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auxiliaryNodeGroupsValue != null) {
      map['auxiliaryNodeGroups'] =
          pulumi.Input.encodeList<AuxiliaryNodeGroup, Map<String, dynamic>>(
    ...
    if (initializationActionsValue != null) {
      map['initializationActions'] = pulumi.Input.encodeList<
              NodeInitializationAction, Map<String, dynamic>>(
  ...
  factory ClusterConfigDataprocV1.fromMap(Map<String, dynamic> map) {
    return ClusterConfigDataprocV1(
      ...
      encryptionConfig: map['encryptionConfig'] == null
          ? null
          : EncryptionConfigDataprocV1.fromMap(
      ...
      softwareConfig: map['softwareConfig'] == null
          ? null
          : SoftwareConfigDataprocV1.fromMap(
