...
class NodeGroupDataprocV1Args {
  ...
  factory NodeGroupDataprocV1Args.fromMap(Map<String, dynamic> map) {
    return NodeGroupDataprocV1Args(
      ...
      nodeGroupConfig: pulumi.Input.asOptionalInput<InstanceGroupConfig>(
          map['nodeGroupConfig']),
      nodeGroupId: pulumi.Input.asOptionalInput<String>(map['nodeGroupId']),
      parentOperationId:
          pulumi.Input.asOptionalInput<String>(map['parentOperationId']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      regionId: pulumi.Input.asInput<String>(map['regionId']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      roles: pulumi.Input.asInput<List<NodeGroupRolesItem>>(map['roles']),
    );
  }
}
