...
import 'cluster_dataproc_v1_args.dart';
...
class ClusterDataprocV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ClusterConfigResponseDataprocV1> config;
  ...
  ClusterDataprocV1(
    ...
    this.config = registerOutput<ClusterConfigResponseDataprocV1>('config');
