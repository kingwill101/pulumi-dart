...
import 'encryption_config_response_dataproc_v1.dart';
...
import 'software_config_response_dataproc_v1.dart';

/// The cluster config.
class ClusterConfigResponseDataprocV1 {
  ...
  final EncryptionConfigResponseDataprocV1 encryptionConfig;
  ...
  final SoftwareConfigResponseDataprocV1 softwareConfig;
  ...
  ClusterConfigResponseDataprocV1({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['auxiliaryNodeGroups'] = pulumi.Input.encodeList<
        ...
        Map<String, dynamic>>(auxiliaryNodeGroups, (value) => value.toMap());
  ...
  factory ClusterConfigResponseDataprocV1.fromMap(Map<String, dynamic> map) {
    return ClusterConfigResponseDataprocV1(
      autoscalingConfig: AutoscalingConfigResponse.fromMap(
          (map['autoscalingConfig'] as Map).cast<String, dynamic>()),
      auxiliaryNodeGroups: pulumi.Input.decodeList<AuxiliaryNodeGroupResponse>(
      ...
      encryptionConfig: EncryptionConfigResponseDataprocV1.fromMap(
      ...
      initializationActions:
          pulumi.Input.decodeList<NodeInitializationActionResponse>(
      ...
      softwareConfig: SoftwareConfigResponseDataprocV1.fromMap(
