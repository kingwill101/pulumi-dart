...
/// Dataproc job status.
class JobStatusResponseDataprocV1 {
  ...
  factory JobStatusResponseDataprocV1.fromMap(Map<String, dynamic> map) {
    return JobStatusResponseDataprocV1(
