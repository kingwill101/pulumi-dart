...
class GetJobResult6 {
  ...
  final JobReferenceResponse2 reference;
  ...
  final JobStatusResponse3 status;

  /// The previous job status.
  final List<JobStatusResponse3> statusHistory;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['statusHistory'] =
        Input.encodeList<JobStatusResponse3, Map<String, dynamic>>(
            statusHistory, (value) => value.toMap());
    map['trinoJob'] = trinoJob.toMap();
    map['yarnApplications'] =
        Input.encodeList<YarnApplicationResponse, Map<String, dynamic>>(
            yarnApplications, (value) => value.toMap());
    return map;
  }

  factory GetJobResult6.fromMap(Map<String, dynamic> map) {
    return GetJobResult6(
      ...
      reference: JobReferenceResponse2.fromMap(
      ...
      status: JobStatusResponse3.fromMap(
          (map['status'] as Map).cast<String, dynamic>()),
      statusHistory: Input.decodeList<JobStatusResponse3>(
          map['statusHistory'],
          (value) => JobStatusResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      trinoJob: TrinoJobResponse.fromMap(
          (map['trinoJob'] as Map).cast<String, dynamic>()),
      yarnApplications: Input.decodeList<YarnApplicationResponse>(
          map['yarnApplications'],
