...
class RuntimeConfigResponseDataprocV1 {
  ...
  RuntimeConfigResponseDataprocV1({
  ...
  factory RuntimeConfigResponseDataprocV1.fromMap(Map<String, dynamic> map) {
    return RuntimeConfigResponseDataprocV1(
