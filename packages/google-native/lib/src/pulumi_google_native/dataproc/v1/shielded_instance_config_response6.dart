...
class ShieldedInstanceConfigResponse6 {
  ...
  ShieldedInstanceConfigResponse6({
  ...
  factory ShieldedInstanceConfigResponse6.fromMap(Map<String, dynamic> map) {
    return ShieldedInstanceConfigResponse6(
