...
class GetClusterDataprocV1Result {
  ...
  final ClusterConfigResponseDataprocV1 config;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['statusHistory'] =
        pulumi.Input.encodeList<ClusterStatusResponse, Map<String, dynamic>>(
            statusHistory, (value) => value.toMap());
    map['virtualClusterConfig'] = virtualClusterConfig.toMap();
    return map;
  }

  factory GetClusterDataprocV1Result.fromMap(Map<String, dynamic> map) {
    return GetClusterDataprocV1Result(
      clusterName: map['clusterName'] as String,
      clusterUuid: map['clusterUuid'] as String,
      config: ClusterConfigResponseDataprocV1.fromMap(
      ...
      statusHistory: pulumi.Input.decodeList<ClusterStatusResponse>(
          map['statusHistory'],
