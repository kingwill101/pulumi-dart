...
class ShieldedInstanceConfigResponseDataprocV1 {
  ...
  ShieldedInstanceConfigResponseDataprocV1({
  ...
  factory ShieldedInstanceConfigResponseDataprocV1.fromMap(
      Map<String, dynamic> map) {
    return ShieldedInstanceConfigResponseDataprocV1(
