...
class ExecutionConfigResponseDataprocV1 {
  ...
  ExecutionConfigResponseDataprocV1({
  ...
  factory ExecutionConfigResponseDataprocV1.fromMap(Map<String, dynamic> map) {
    return ExecutionConfigResponseDataprocV1(
