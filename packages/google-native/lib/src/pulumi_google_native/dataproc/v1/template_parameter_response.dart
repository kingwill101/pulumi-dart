...
import 'parameter_validation_response.dart';
...
class TemplateParameterResponse {
  ...
  final ParameterValidationResponse validation;
  ...
  factory TemplateParameterResponse.fromMap(Map<String, dynamic> map) {
    return TemplateParameterResponse(
      description: map['description'] as String,
      fields: (map['fields'] as List).cast<String>(),
      name: map['name'] as String,
      validation: ParameterValidationResponse.fromMap(
