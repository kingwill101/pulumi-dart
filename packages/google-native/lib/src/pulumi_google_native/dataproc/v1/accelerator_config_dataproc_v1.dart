...
class AcceleratorConfigDataprocV1 {
  ...
  factory AcceleratorConfigDataprocV1.fromMap(Map<String, dynamic> map) {
    return AcceleratorConfigDataprocV1(
