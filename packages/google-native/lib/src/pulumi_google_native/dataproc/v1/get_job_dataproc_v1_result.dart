...
import 'job_reference_response_dataproc_v1.dart';
import 'job_scheduling_response.dart';
import 'job_status_response_dataproc_v1.dart';
...
class GetJobDataprocV1Result {
  ...
  final JobReferenceResponseDataprocV1 reference;
  ...
  final JobStatusResponseDataprocV1 status;

  /// The previous job status.
  final List<JobStatusResponseDataprocV1> statusHistory;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['statusHistory'] = pulumi.Input.encodeList<JobStatusResponseDataprocV1,
        Map<String, dynamic>>(statusHistory, (value) => value.toMap());
  ...
  factory GetJobDataprocV1Result.fromMap(Map<String, dynamic> map) {
    return GetJobDataprocV1Result(
      ...
      reference: JobReferenceResponseDataprocV1.fromMap(
      ...
      status: JobStatusResponseDataprocV1.fromMap(
          (map['status'] as Map).cast<String, dynamic>()),
      statusHistory: pulumi.Input.decodeList<JobStatusResponseDataprocV1>(
          map['statusHistory'],
          (value) => JobStatusResponseDataprocV1.fromMap(
