...
class GetPrivateConnectionVmwareengineV1Result {
  ...
  GetPrivateConnectionVmwareengineV1Result({
  ...
  factory GetPrivateConnectionVmwareengineV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetPrivateConnectionVmwareengineV1Result(
