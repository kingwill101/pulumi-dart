...
/// The set of arguments for PrivateCloudIamPolicy.
class PrivateCloudIamPolicyArgs {
  ...
  factory PrivateCloudIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudIamPolicyArgs(
      auditConfigs:
