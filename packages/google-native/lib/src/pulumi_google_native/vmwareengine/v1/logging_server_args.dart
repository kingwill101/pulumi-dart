...
class LoggingServerArgs {
  ...
  factory LoggingServerArgs.fromMap(Map<String, dynamic> map) {
    return LoggingServerArgs(
      hostname: pulumi.Input.asInput<String>(map['hostname']),
      ...
      protocol: pulumi.Input.asInput<LoggingServerProtocol>(map['protocol']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      sourceType:
          pulumi.Input.asInput<LoggingServerSourceType>(map['sourceType']),
    );
  }
}
