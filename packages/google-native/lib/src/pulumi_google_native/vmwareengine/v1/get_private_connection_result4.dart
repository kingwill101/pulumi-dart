...
class GetPrivateConnectionResult4 {
  ...
  factory GetPrivateConnectionResult4.fromMap(Map<String, dynamic> map) {
    return GetPrivateConnectionResult4(
