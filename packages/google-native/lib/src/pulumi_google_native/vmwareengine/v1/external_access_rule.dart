...
class ExternalAccessRule extends CustomResource {
  ...
  late final Output<List<IpRangeResponse>> destinationIpRanges;
  ...
  late final Output<List<String>> destinationPorts;
  ...
  late final Output<String> externalAccessRuleId;
  ...
  late final Output<List<IpRangeResponse>> sourceIpRanges;
  ...
  late final Output<List<String>> sourcePorts;
