...
class AuditLogConfig69 {
  ...
  factory AuditLogConfig69.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig69(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType69.fromValue(map['logType'] as String),
    );
  }
}
