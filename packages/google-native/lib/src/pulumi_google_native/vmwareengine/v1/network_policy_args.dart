...
class NetworkPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (externalIpValue != null) {
      map['externalIp'] = pulumi.Input.mapOptionalInputValue<NetworkService,
          Map<String, dynamic>>(externalIpValue, (value) => value.toMap());
    }
    final internetAccessValue = internetAccess;
    if (internetAccessValue != null) {
      map['internetAccess'] = pulumi.Input.mapOptionalInputValue<NetworkService,
  ...
  factory NetworkPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NetworkPolicyArgs(
      ...
      externalIp:
          pulumi.Input.asOptionalInput<NetworkService>(map['externalIp']),
      internetAccess:
          pulumi.Input.asOptionalInput<NetworkService>(map['internetAccess']),
