...
class ExternalAccessRuleArgs {
  ...
  final Input<List<IpRange>>? sourceIpRanges;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (actionValue != null) {
      map['action'] =
          Input.mapOptionalInputValue<ExternalAccessRuleAction, String>(
    ...
    if (destinationIpRangesValue != null) {
      map['destinationIpRanges'] = Input.mapOptionalInputValue<List<IpRange>,
              List<Map<String, dynamic>>>(
          destinationIpRangesValue,
          (value) => Input.encodeList<IpRange, Map<String, dynamic>>(
    ...
    if (sourceIpRangesValue != null) {
      map['sourceIpRanges'] = Input.mapOptionalInputValue<List<IpRange>,
              List<Map<String, dynamic>>>(
          sourceIpRangesValue,
          (value) => Input.encodeList<IpRange, Map<String, dynamic>>(
              value, (value) => value.toMap()));
  ...
  factory ExternalAccessRuleArgs.fromMap(Map<String, dynamic> map) {
    return ExternalAccessRuleArgs(
      action: Input.asOptionalInput<ExternalAccessRuleAction>(map['action']),
      description: Input.asOptionalInput<String>(map['description']),
      destinationIpRanges:
          Input.asOptionalInput<List<IpRange>>(map['destinationIpRanges']),
      destinationPorts:
          Input.asOptionalInput<List<String>>(map['destinationPorts']),
      ...
      sourceIpRanges:
          Input.asOptionalInput<List<IpRange>>(map['sourceIpRanges']),
      sourcePorts: Input.asOptionalInput<List<String>>(map['sourcePorts']),
    );
  }
}
