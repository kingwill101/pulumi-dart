...
import 'tls_route_args2.dart';
import 'tls_route_route_rule_response2.dart';

/// Creates a new TlsRoute in a given project and location.
class TlsRoute2 extends CustomResource {
  ...
  late final Output<List<TlsRouteRouteRuleResponse2>> rules;
  ...
  TlsRoute2(
    ...
    this.rules = registerOutput<List<TlsRouteRouteRuleResponse2>>('rules');
