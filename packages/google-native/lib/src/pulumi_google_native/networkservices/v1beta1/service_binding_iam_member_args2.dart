...
class ServiceBindingIamMemberArgs2 {
  ...
  factory ServiceBindingIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceBindingIamMemberArgs2(
