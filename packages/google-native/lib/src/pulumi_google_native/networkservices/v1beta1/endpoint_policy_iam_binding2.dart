...
import 'endpoint_policy_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EndpointPolicyIamBinding2 extends CustomResource {
  ...
  EndpointPolicyIamBinding2(
    String name, {
    EndpointPolicyIamBindingArgs2? args,
