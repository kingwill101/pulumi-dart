...
class GrpcRouteMethodMatchResponse2 {
  ...
  factory GrpcRouteMethodMatchResponse2.fromMap(Map<String, dynamic> map) {
    return GrpcRouteMethodMatchResponse2(
