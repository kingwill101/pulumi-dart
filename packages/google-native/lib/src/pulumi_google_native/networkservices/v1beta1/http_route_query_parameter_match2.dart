...
class HttpRouteQueryParameterMatch2 {
  ...
  factory HttpRouteQueryParameterMatch2.fromMap(Map<String, dynamic> map) {
    return HttpRouteQueryParameterMatch2(
      exactMatch:
