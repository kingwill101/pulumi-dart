...
import 'http_route_header_match_integer_range_response2.dart';

/// Specifies how to select a route rule based on HTTP request headers.
class HttpRouteHeaderMatchResponse2 {
  ...
  final HttpRouteHeaderMatchIntegerRangeResponse2 rangeMatch;
  ...
  factory HttpRouteHeaderMatchResponse2.fromMap(Map<String, dynamic> map) {
    return HttpRouteHeaderMatchResponse2(
      ...
      rangeMatch: HttpRouteHeaderMatchIntegerRangeResponse2.fromMap(
