...
class GrpcRouteStatefulSessionAffinityPolicyResponse2 {
  ...
  GrpcRouteStatefulSessionAffinityPolicyResponse2({
  ...
  factory GrpcRouteStatefulSessionAffinityPolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return GrpcRouteStatefulSessionAffinityPolicyResponse2(
