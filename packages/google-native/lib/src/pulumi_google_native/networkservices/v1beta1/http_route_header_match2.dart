...
import 'http_route_header_match_integer_range2.dart';

/// Specifies how to select a route rule based on HTTP request headers.
class HttpRouteHeaderMatch2 {
  ...
  final HttpRouteHeaderMatchIntegerRange2? rangeMatch;
  ...
  factory HttpRouteHeaderMatch2.fromMap(Map<String, dynamic> map) {
    return HttpRouteHeaderMatch2(
      exactMatch:
      ...
      rangeMatch: map['rangeMatch'] == null
          ? null
          : HttpRouteHeaderMatchIntegerRange2.fromMap(
