...
import 'tcp_route_route_rule2.dart';
...
class TcpRouteArgs2 {
  ...
  final Input<List<TcpRouteRouteRule2>> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = Input.mapInputValue<List<TcpRouteRouteRule2>,
            List<Map<String, dynamic>>>(
        rules,
        (value) => Input.encodeList<TcpRouteRouteRule2, Map<String, dynamic>>(
            value, (value) => value.toMap()));
    map['tcpRouteId'] = tcpRouteId;
    return map;
  }

  factory TcpRouteArgs2.fromMap(Map<String, dynamic> map) {
    return TcpRouteArgs2(
      ...
      rules: Input.asInput<List<TcpRouteRouteRule2>>(map['rules']),
