...
import 'grpc_route_method_match_type2.dart';

/// Specifies a match against a method.
class GrpcRouteMethodMatch2 {
  ...
  final GrpcRouteMethodMatchType2? type;

  GrpcRouteMethodMatch2({
    this.caseSensitive,
  ...
  factory GrpcRouteMethodMatch2.fromMap(Map<String, dynamic> map) {
    return GrpcRouteMethodMatch2(
      caseSensitive:
      ...
      type: map['type'] == null
          ? null
          : GrpcRouteMethodMatchType2.fromValue(map['type'] as String),
    );
  }
}
