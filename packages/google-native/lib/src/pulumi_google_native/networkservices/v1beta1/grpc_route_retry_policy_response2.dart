...
class GrpcRouteRetryPolicyResponse2 {
  ...
  factory GrpcRouteRetryPolicyResponse2.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRetryPolicyResponse2(
