...
import 'grpc_route_stateful_session_affinity_policy2.dart';

/// Specifies how to route matched traffic.
class GrpcRouteRouteAction2 {
  /// Optional. The destination services to which traffic should be forwarded. If multiple destinations are specified, traffic will be split between Backend Service(s) according to the weight field of these destinations.
  final List<GrpcRouteDestination2>? destinations;

  /// Optional. The specification for fault injection introduced into traffic to test the resiliency of clients to destination service failure. As part of fault injection, when clients send requests to a destination, delays can be introduced on a percentage of requests before sending those requests to the destination service. Similarly requests from clients can be aborted by for a percentage of requests. timeout and retry_policy will be ignored by clients that are configured with a fault_injection_policy
  final GrpcRouteFaultInjectionPolicy2? faultInjectionPolicy;

  /// Optional. Specifies the retry policy associated with this route.
  final GrpcRouteRetryPolicy2? retryPolicy;

  /// Optional. Specifies cookie-based stateful session affinity.
  final GrpcRouteStatefulSessionAffinityPolicy2? statefulSessionAffinity;

  /// Optional. Specifies the timeout for selected route. Timeout is computed from the time the request has been fully processed (i.e. end of stream) up until the response has been completely processed. Timeout includes all retries.
  final String? timeout;

  GrpcRouteRouteAction2({
    this.destinations,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (destinationsValue != null) {
      map['destinations'] =
          Input.encodeList<GrpcRouteDestination2, Map<String, dynamic>>(
  ...
  factory GrpcRouteRouteAction2.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteAction2(
      destinations: map['destinations'] == null
          ? null
          : Input.decodeList<GrpcRouteDestination2>(
              map['destinations'],
              (value) => GrpcRouteDestination2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      faultInjectionPolicy: map['faultInjectionPolicy'] == null
          ? null
          : GrpcRouteFaultInjectionPolicy2.fromMap(
              (map['faultInjectionPolicy'] as Map).cast<String, dynamic>()),
      retryPolicy: map['retryPolicy'] == null
          ? null
          : GrpcRouteRetryPolicy2.fromMap(
              (map['retryPolicy'] as Map).cast<String, dynamic>()),
      statefulSessionAffinity: map['statefulSessionAffinity'] == null
          ? null
          : GrpcRouteStatefulSessionAffinityPolicy2.fromMap(
