...
import 'endpoint_matcher2.dart';
import 'endpoint_policy_type2.dart';
import 'traffic_port_selector2.dart';

/// The set of arguments for EndpointPolicy.
class EndpointPolicyArgs2 {
  ...
  final Input<EndpointMatcher2> endpointMatcher;
  ...
  final Input<TrafficPortSelector2>? trafficPortSelector;

  /// The type of endpoint policy. This is primarily used to validate the configuration.
  final Input<EndpointPolicyType2> type;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['endpointMatcher'] =
        Input.mapInputValue<EndpointMatcher2, Map<String, dynamic>>(
    ...
    if (trafficPortSelectorValue != null) {
      map['trafficPortSelector'] = Input.mapOptionalInputValue<
              TrafficPortSelector2, Map<String, dynamic>>(
          trafficPortSelectorValue, (value) => value.toMap());
    }
    map['type'] = Input.mapInputValue<EndpointPolicyType2, String>(
        type, (value) => value.value);
    return map;
  }

  factory EndpointPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyArgs2(
      authorizationPolicy:
      ...
      endpointMatcher: Input.asInput<EndpointMatcher2>(map['endpointMatcher']),
      ...
      trafficPortSelector: Input.asOptionalInput<TrafficPortSelector2>(
          map['trafficPortSelector']),
      type: Input.asInput<EndpointPolicyType2>(map['type']),
    );
  }
}
