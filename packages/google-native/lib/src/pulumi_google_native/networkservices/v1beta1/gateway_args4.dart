...
class GatewayArgs4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<GatewayType3, String>(
          typeValue, (value) => value.value);
    }
    return map;
  }

  factory GatewayArgs4.fromMap(Map<String, dynamic> map) {
    return GatewayArgs4(
      ...
      type: Input.asOptionalInput<GatewayType3>(map['type']),
    );
  }
}
