...
class HttpRouteStatefulSessionAffinityPolicyResponse2 {
  ...
  HttpRouteStatefulSessionAffinityPolicyResponse2({
  ...
  factory HttpRouteStatefulSessionAffinityPolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return HttpRouteStatefulSessionAffinityPolicyResponse2(
