...
import 'tcp_route_route_rule_response2.dart';

/// Result data returned by getTcpRoute.
class GetTcpRouteResult2 {
  ...
  final List<TcpRouteRouteRuleResponse2> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['rules'] =
        Input.encodeList<TcpRouteRouteRuleResponse2, Map<String, dynamic>>(
  ...
  factory GetTcpRouteResult2.fromMap(Map<String, dynamic> map) {
    return GetTcpRouteResult2(
      ...
      rules: Input.decodeList<TcpRouteRouteRuleResponse2>(
          map['rules'],
          (value) => TcpRouteRouteRuleResponse2.fromMap(
