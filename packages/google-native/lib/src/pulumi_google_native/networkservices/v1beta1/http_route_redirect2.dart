...
import 'http_route_redirect_response_code2.dart';

/// The specification for redirecting traffic.
class HttpRouteRedirect2 {
  ...
  final HttpRouteRedirectResponseCode2? responseCode;
  ...
  factory HttpRouteRedirect2.fromMap(Map<String, dynamic> map) {
    return HttpRouteRedirect2(
      hostRedirect:
      ...
      responseCode: map['responseCode'] == null
          ? null
          : HttpRouteRedirectResponseCode2.fromValue(
