...
class HttpRouteCorsPolicyResponse2 {
  ...
  factory HttpRouteCorsPolicyResponse2.fromMap(Map<String, dynamic> map) {
    return HttpRouteCorsPolicyResponse2(
