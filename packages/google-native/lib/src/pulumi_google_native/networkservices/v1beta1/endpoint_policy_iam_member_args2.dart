...
class EndpointPolicyIamMemberArgs2 {
  ...
  factory EndpointPolicyIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyIamMemberArgs2(
