...
class AuditLogConfig59 {
  ...
  factory AuditLogConfig59.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig59(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType59.fromValue(map['logType'] as String),
    );
  }
}
