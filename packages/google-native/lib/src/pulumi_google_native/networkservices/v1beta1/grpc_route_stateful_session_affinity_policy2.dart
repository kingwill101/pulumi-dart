...
class GrpcRouteStatefulSessionAffinityPolicy2 {
  ...
  GrpcRouteStatefulSessionAffinityPolicy2({
  ...
  factory GrpcRouteStatefulSessionAffinityPolicy2.fromMap(
      Map<String, dynamic> map) {
    return GrpcRouteStatefulSessionAffinityPolicy2(
