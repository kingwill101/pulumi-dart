...
import 'http_route_route_rule2.dart';

/// The set of arguments for HttpRoute.
class HttpRouteArgs2 {
  ...
  final Input<List<HttpRouteRouteRule2>> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = Input.mapInputValue<List<HttpRouteRouteRule2>,
            List<Map<String, dynamic>>>(
        rules,
        (value) => Input.encodeList<HttpRouteRouteRule2, Map<String, dynamic>>(
            value, (value) => value.toMap()));
    return map;
  }

  factory HttpRouteArgs2.fromMap(Map<String, dynamic> map) {
    return HttpRouteArgs2(
      ...
      rules: Input.asInput<List<HttpRouteRouteRule2>>(map['rules']),
    );
  }
}
