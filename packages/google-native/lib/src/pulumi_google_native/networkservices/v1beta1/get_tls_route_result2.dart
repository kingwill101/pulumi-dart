...
import 'tls_route_route_rule_response2.dart';

/// Result data returned by getTlsRoute.
class GetTlsRouteResult2 {
  ...
  final List<TlsRouteRouteRuleResponse2> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['rules'] =
        Input.encodeList<TlsRouteRouteRuleResponse2, Map<String, dynamic>>(
  ...
  factory GetTlsRouteResult2.fromMap(Map<String, dynamic> map) {
    return GetTlsRouteResult2(
      ...
      rules: Input.decodeList<TlsRouteRouteRuleResponse2>(
          map['rules'],
          (value) => TlsRouteRouteRuleResponse2.fromMap(
