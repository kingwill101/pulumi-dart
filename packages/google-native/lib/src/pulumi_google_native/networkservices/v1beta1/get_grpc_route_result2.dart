...
class GetGrpcRouteResult2 {
  ...
  final List<GrpcRouteRouteRuleResponse2> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['rules'] =
        Input.encodeList<GrpcRouteRouteRuleResponse2, Map<String, dynamic>>(
  ...
  factory GetGrpcRouteResult2.fromMap(Map<String, dynamic> map) {
    return GetGrpcRouteResult2(
      ...
      rules: Input.decodeList<GrpcRouteRouteRuleResponse2>(
          map['rules'],
          (value) => GrpcRouteRouteRuleResponse2.fromMap(
