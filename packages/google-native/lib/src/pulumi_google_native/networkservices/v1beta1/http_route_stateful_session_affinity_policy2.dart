...
class HttpRouteStatefulSessionAffinityPolicy2 {
  ...
  HttpRouteStatefulSessionAffinityPolicy2({
  ...
  factory HttpRouteStatefulSessionAffinityPolicy2.fromMap(
      Map<String, dynamic> map) {
    return HttpRouteStatefulSessionAffinityPolicy2(
