...
class TcpRouteRouteMatchResponse2 {
  ...
  factory TcpRouteRouteMatchResponse2.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteMatchResponse2(
