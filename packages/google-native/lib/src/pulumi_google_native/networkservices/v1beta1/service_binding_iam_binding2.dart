...
import 'service_binding_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ServiceBindingIamBinding2 extends CustomResource {
  ...
  ServiceBindingIamBinding2(
    String name, {
    ServiceBindingIamBindingArgs2? args,
