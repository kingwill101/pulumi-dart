...
import 'tcp_route_args2.dart';
import 'tcp_route_route_rule_response2.dart';

/// Creates a new TcpRoute in a given project and location.
class TcpRoute2 extends CustomResource {
  ...
  late final Output<List<TcpRouteRouteRuleResponse2>> rules;
  ...
  TcpRoute2(
    ...
    this.rules = Output.createUnknown<List<TcpRouteRouteRuleResponse2>>();
