...
class GrpcRouteFaultInjectionPolicyAbort2 {
  ...
  GrpcRouteFaultInjectionPolicyAbort2({
    this.httpStatus,
    this.percentage,
  });
  ...
  factory GrpcRouteFaultInjectionPolicyAbort2.fromMap(
      Map<String, dynamic> map) {
    return GrpcRouteFaultInjectionPolicyAbort2(
