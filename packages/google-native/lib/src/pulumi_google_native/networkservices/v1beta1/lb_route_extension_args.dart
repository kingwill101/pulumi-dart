...
class LbRouteExtensionArgs {
  ...
  final Input<LbRouteExtensionLoadBalancingScheme> loadBalancingScheme;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['loadBalancingScheme'] =
        Input.mapInputValue<LbRouteExtensionLoadBalancingScheme, String>(
  ...
  factory LbRouteExtensionArgs.fromMap(Map<String, dynamic> map) {
    return LbRouteExtensionArgs(
      ...
      loadBalancingScheme: Input.asInput<LbRouteExtensionLoadBalancingScheme>(
          map['loadBalancingScheme']),
