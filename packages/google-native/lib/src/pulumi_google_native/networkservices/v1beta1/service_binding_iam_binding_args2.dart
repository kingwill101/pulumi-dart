...
class ServiceBindingIamBindingArgs2 {
  ...
  factory ServiceBindingIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceBindingIamBindingArgs2(
