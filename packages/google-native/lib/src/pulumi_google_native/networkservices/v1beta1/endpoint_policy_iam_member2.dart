...
import 'endpoint_policy_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EndpointPolicyIamMember2 extends CustomResource {
  ...
  EndpointPolicyIamMember2(
    String name, {
    EndpointPolicyIamMemberArgs2? args,
