...
class EndpointPolicyIamBindingArgs2 {
  ...
  factory EndpointPolicyIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyIamBindingArgs2(
