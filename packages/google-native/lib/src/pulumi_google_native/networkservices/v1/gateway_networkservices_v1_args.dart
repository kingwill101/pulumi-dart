...
import 'gateway_type_networkservices_v1.dart';

/// The set of arguments for Gateway.
class GatewayNetworkservicesV1Args {
  ...
  final pulumi.Input<GatewayTypeNetworkservicesV1>? type;

  GatewayNetworkservicesV1Args({
    this.addresses,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = pulumi.Input.mapOptionalInputValue<
          GatewayTypeNetworkservicesV1,
          String>(typeValue, (value) => value.value);
    }
    return map;
  }

  factory GatewayNetworkservicesV1Args.fromMap(Map<String, dynamic> map) {
    return GatewayNetworkservicesV1Args(
      ...
      type: pulumi.Input.asOptionalInput<GatewayTypeNetworkservicesV1>(
          map['type']),
    );
  }
}
