...
import 'edge_cache_origin_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EdgeCacheOriginIamBinding extends pulumi.CustomResource {
  ...
  EdgeCacheOriginIamBinding(
    String name, {
    EdgeCacheOriginIamBindingArgs? args,
