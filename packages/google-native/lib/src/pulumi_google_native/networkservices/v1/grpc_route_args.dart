...
class GrpcRouteArgs {
  ...
  final Input<List<GrpcRouteRouteRule>> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = Input.mapInputValue<List<GrpcRouteRouteRule>,
            List<Map<String, dynamic>>>(
        rules,
        (value) => Input.encodeList<GrpcRouteRouteRule, Map<String, dynamic>>(
  ...
  factory GrpcRouteArgs.fromMap(Map<String, dynamic> map) {
    return GrpcRouteArgs(
      ...
      rules: Input.asInput<List<GrpcRouteRouteRule>>(map['rules']),
    );
  }
}
