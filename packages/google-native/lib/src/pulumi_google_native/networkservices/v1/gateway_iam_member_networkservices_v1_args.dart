...
class GatewayIamMemberNetworkservicesV1Args {
  ...
  GatewayIamMemberNetworkservicesV1Args({
    this.condition,
  ...
  factory GatewayIamMemberNetworkservicesV1Args.fromMap(
      Map<String, dynamic> map) {
    return GatewayIamMemberNetworkservicesV1Args(
