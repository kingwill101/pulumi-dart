...
class AuditLogConfig58 {
  ...
  factory AuditLogConfig58.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig58(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType58.fromValue(map['logType'] as String),
    );
  }
}
