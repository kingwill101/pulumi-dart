...
class TlsRouteArgs {
  ...
  final Input<List<TlsRouteRouteRule>> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = Input.mapInputValue<List<TlsRouteRouteRule>,
            List<Map<String, dynamic>>>(
        rules,
        (value) => Input.encodeList<TlsRouteRouteRule, Map<String, dynamic>>(
  ...
  factory TlsRouteArgs.fromMap(Map<String, dynamic> map) {
    return TlsRouteArgs(
      ...
      rules: Input.asInput<List<TlsRouteRouteRule>>(map['rules']),
