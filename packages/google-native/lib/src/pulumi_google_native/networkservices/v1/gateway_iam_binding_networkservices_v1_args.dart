...
class GatewayIamBindingNetworkservicesV1Args {
  ...
  GatewayIamBindingNetworkservicesV1Args({
    this.condition,
  ...
  factory GatewayIamBindingNetworkservicesV1Args.fromMap(
      Map<String, dynamic> map) {
    return GatewayIamBindingNetworkservicesV1Args(
