...
import 'edge_cache_service_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EdgeCacheServiceIamBinding extends pulumi.CustomResource {
  ...
  EdgeCacheServiceIamBinding(
    String name, {
    EdgeCacheServiceIamBindingArgs? args,
