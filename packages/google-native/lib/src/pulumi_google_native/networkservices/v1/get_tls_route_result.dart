...
class GetTlsRouteResult {
  ...
  final List<TlsRouteRouteRuleResponse> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['meshes'] = meshes;
    map['name'] = name;
    map['rules'] = pulumi.Input.encodeList<TlsRouteRouteRuleResponse,
  ...
  factory GetTlsRouteResult.fromMap(Map<String, dynamic> map) {
    return GetTlsRouteResult(
      ...
      rules: pulumi.Input.decodeList<TlsRouteRouteRuleResponse>(
          map['rules'],
          (value) => TlsRouteRouteRuleResponse.fromMap(
