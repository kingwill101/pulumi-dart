...
class HttpRouteArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = pulumi.Input.mapInputValue<List<HttpRouteRouteRule>,
            List<Map<String, dynamic>>>(
        rules,
        (value) =>
            pulumi.Input.encodeList<HttpRouteRouteRule, Map<String, dynamic>>(
  ...
  factory HttpRouteArgs.fromMap(Map<String, dynamic> map) {
    return HttpRouteArgs(
      ...
      rules: pulumi.Input.asInput<List<HttpRouteRouteRule>>(map['rules']),
    );
  }
}
