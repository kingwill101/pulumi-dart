...
class HttpRouteArgs {
  ...
  final Input<List<HttpRouteRouteRule>> rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['rules'] = Input.mapInputValue<List<HttpRouteRouteRule>,
            List<Map<String, dynamic>>>(
        rules,
        (value) => Input.encodeList<HttpRouteRouteRule, Map<String, dynamic>>(
  ...
  factory HttpRouteArgs.fromMap(Map<String, dynamic> map) {
    return HttpRouteArgs(
      ...
      rules: Input.asInput<List<HttpRouteRouteRule>>(map['rules']),
    );
  }
}
