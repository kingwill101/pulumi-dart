...
class GetGatewayNetworkservicesV1Result {
  ...
  GetGatewayNetworkservicesV1Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['certificateUrls'] = certificateUrls;
  ...
  factory GetGatewayNetworkservicesV1Result.fromMap(Map<String, dynamic> map) {
    return GetGatewayNetworkservicesV1Result(
