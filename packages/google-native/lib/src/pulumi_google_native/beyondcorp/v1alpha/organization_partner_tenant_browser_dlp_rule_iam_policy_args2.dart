...
import 'google_iam_v1_audit_config3.dart';
import 'google_iam_v1_binding5.dart';

/// The set of arguments for OrganizationPartnerTenantBrowserDlpRuleIamPolicy.
class OrganizationPartnerTenantBrowserDlpRuleIamPolicyArgs2 {
  /// Specifies cloud audit logging configuration for this policy.
  final Input<List<GoogleIamV1AuditConfig3>>? auditConfigs;

  /// Associates a list of `members`, or principals, with a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one principal. The `bindings` in a `Policy` can refer to up to 1,500 principals; up to 250 of these principals can be Google groups. Each occurrence of a principal counts towards these limits. For example, if the `bindings` grant 50 different roles to `user:alice@example.com`, and not to any other principal, then you can add another 1,450 principals to the `bindings` in the `Policy`.
  final Input<List<GoogleIamV1Binding5>>? bindings;
  ...
  OrganizationPartnerTenantBrowserDlpRuleIamPolicyArgs2({
    this.auditConfigs,
    this.bindings,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<
              List<GoogleIamV1AuditConfig3>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) =>
              Input.encodeList<GoogleIamV1AuditConfig3, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<GoogleIamV1Binding5>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) =>
              Input.encodeList<GoogleIamV1Binding5, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
  ...
  factory OrganizationPartnerTenantBrowserDlpRuleIamPolicyArgs2.fromMap(
      Map<String, dynamic> map) {
    return OrganizationPartnerTenantBrowserDlpRuleIamPolicyArgs2(
      auditConfigs: Input.asOptionalInput<List<GoogleIamV1AuditConfig3>>(
          map['auditConfigs']),
      bindings:
          Input.asOptionalInput<List<GoogleIamV1Binding5>>(map['bindings']),
