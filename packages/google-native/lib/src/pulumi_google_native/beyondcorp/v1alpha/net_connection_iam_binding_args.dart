...
/// The set of arguments for NetConnectionIamBinding.
class NetConnectionIamBindingArgs {
  ...
  factory NetConnectionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NetConnectionIamBindingArgs(
