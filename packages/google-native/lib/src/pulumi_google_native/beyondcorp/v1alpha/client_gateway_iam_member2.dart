...
import 'client_gateway_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ClientGatewayIamMember2 extends CustomResource {
  ...
  ClientGatewayIamMember2(
    String name, {
    ClientGatewayIamMemberArgs2? args,
