...
class AppConnectionArgs2 {
  ...
  final Input<GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGateway>?
      gateway;
  ...
  final Input<AppConnectionType2> type;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['type'] = Input.mapInputValue<AppConnectionType2, String>(
        type, (value) => value.value);
    return map;
  }

  factory AppConnectionArgs2.fromMap(Map<String, dynamic> map) {
    return AppConnectionArgs2(
      ...
      type: Input.asInput<AppConnectionType2>(map['type']),
    );
  }
}
