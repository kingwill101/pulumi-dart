...
class OrganizationPartnerTenantProxyConfigIamPolicyBeyondcorpV1alphaArgs {
  ...
  OrganizationPartnerTenantProxyConfigIamPolicyBeyondcorpV1alphaArgs({
    this.auditConfigs,
    this.bindings,
    this.etag,
  ...
  factory OrganizationPartnerTenantProxyConfigIamPolicyBeyondcorpV1alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return OrganizationPartnerTenantProxyConfigIamPolicyBeyondcorpV1alphaArgs(
