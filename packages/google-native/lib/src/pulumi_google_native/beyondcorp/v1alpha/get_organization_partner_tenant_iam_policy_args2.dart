...
class GetOrganizationPartnerTenantIamPolicyArgs2 {
  final Input<int>? optionsRequestedPolicyVersion;
  final Input<String> organizationId;
  final Input<String> partnerTenantId;

  GetOrganizationPartnerTenantIamPolicyArgs2({
  ...
  factory GetOrganizationPartnerTenantIamPolicyArgs2.fromMap(
      Map<String, dynamic> map) {
    return GetOrganizationPartnerTenantIamPolicyArgs2(
