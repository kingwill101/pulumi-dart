...
class ClientGatewayIamMemberArgs2 {
  ...
  factory ClientGatewayIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ClientGatewayIamMemberArgs2(
