...
class OrganizationPartnerTenantIamMemberArgs2 {
  ...
  OrganizationPartnerTenantIamMemberArgs2({
    this.condition,
  ...
  factory OrganizationPartnerTenantIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return OrganizationPartnerTenantIamMemberArgs2(
