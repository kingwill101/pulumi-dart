...
class AppConnectionIamMemberArgs2 {
  ...
  factory AppConnectionIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return AppConnectionIamMemberArgs2(
