...
class ClientGatewayIamBindingArgs2 {
  ...
  factory ClientGatewayIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ClientGatewayIamBindingArgs2(
