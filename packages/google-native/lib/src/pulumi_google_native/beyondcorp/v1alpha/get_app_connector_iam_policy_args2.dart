...
class GetAppConnectorIamPolicyArgs2 {
  final Input<String> appConnectorId;
  final Input<String> location;
  final Input<int>? optionsRequestedPolicyVersion;
  final Input<String>? project;

  GetAppConnectorIamPolicyArgs2({
  ...
  factory GetAppConnectorIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return GetAppConnectorIamPolicyArgs2(
