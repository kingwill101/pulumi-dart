...
class OrganizationPartnerTenantProxyConfigIamPolicyArgs2 {
  ...
  OrganizationPartnerTenantProxyConfigIamPolicyArgs2({
    this.auditConfigs,
    this.bindings,
    this.etag,
  ...
  factory OrganizationPartnerTenantProxyConfigIamPolicyArgs2.fromMap(
      Map<String, dynamic> map) {
    return OrganizationPartnerTenantProxyConfigIamPolicyArgs2(
