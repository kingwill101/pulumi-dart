...
class ConnectorArgs {
  ...
  final Input<PrincipalInfo> principalInfo;
  ...
  final Input<ResourceInfo>? resourceInfo;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['principalInfo'] =
        Input.mapInputValue<PrincipalInfo, Map<String, dynamic>>(
    ...
    if (resourceInfoValue != null) {
      map['resourceInfo'] =
          Input.mapOptionalInputValue<ResourceInfo, Map<String, dynamic>>(
              resourceInfoValue, (value) => value.toMap());
    }
    return map;
  }
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      connectorId: Input.asOptionalInput<String>(map['connectorId']),
      displayName: Input.asOptionalInput<String>(map['displayName']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      name: Input.asOptionalInput<String>(map['name']),
      principalInfo: Input.asInput<PrincipalInfo>(map['principalInfo']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      resourceInfo: Input.asOptionalInput<ResourceInfo>(map['resourceInfo']),
    );
  }
}
