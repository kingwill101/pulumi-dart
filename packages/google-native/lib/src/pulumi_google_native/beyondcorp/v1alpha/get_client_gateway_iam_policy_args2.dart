...
class GetClientGatewayIamPolicyArgs2 {
  final Input<String> clientGatewayId;
  final Input<String> location;
  final Input<int>? optionsRequestedPolicyVersion;
  final Input<String>? project;

  GetClientGatewayIamPolicyArgs2({
  ...
  factory GetClientGatewayIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return GetClientGatewayIamPolicyArgs2(
