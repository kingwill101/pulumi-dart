...
import 'client_gateway_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ClientGatewayIamBinding2 extends CustomResource {
  ...
  ClientGatewayIamBinding2(
    String name, {
    ClientGatewayIamBindingArgs2? args,
