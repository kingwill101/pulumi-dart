...
class AppConnectorIamBindingArgs2 {
  ...
  factory AppConnectorIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return AppConnectorIamBindingArgs2(
