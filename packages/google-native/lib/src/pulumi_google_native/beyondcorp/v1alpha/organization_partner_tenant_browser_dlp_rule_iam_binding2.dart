...
import 'organization_partner_tenant_browser_dlp_rule_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class OrganizationPartnerTenantBrowserDlpRuleIamBinding2
  ...
  OrganizationPartnerTenantBrowserDlpRuleIamBinding2(
    String name, {
    OrganizationPartnerTenantBrowserDlpRuleIamBindingArgs2? args,
