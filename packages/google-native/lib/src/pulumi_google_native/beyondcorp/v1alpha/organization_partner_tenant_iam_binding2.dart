...
import 'organization_partner_tenant_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class OrganizationPartnerTenantIamBinding2 extends CustomResource {
  ...
  OrganizationPartnerTenantIamBinding2(
    String name, {
    OrganizationPartnerTenantIamBindingArgs2? args,
