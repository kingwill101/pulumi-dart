...
class OrganizationPartnerTenantIamBindingArgs2 {
  ...
  OrganizationPartnerTenantIamBindingArgs2({
    this.condition,
  ...
  factory OrganizationPartnerTenantIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return OrganizationPartnerTenantIamBindingArgs2(
