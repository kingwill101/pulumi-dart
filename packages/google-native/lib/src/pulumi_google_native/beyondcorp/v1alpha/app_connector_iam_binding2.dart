...
import 'app_connector_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class AppConnectorIamBinding2 extends CustomResource {
  ...
  AppConnectorIamBinding2(
    String name, {
    AppConnectorIamBindingArgs2? args,
