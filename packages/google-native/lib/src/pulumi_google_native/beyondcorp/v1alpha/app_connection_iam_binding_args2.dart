...
class AppConnectionIamBindingArgs2 {
  ...
  factory AppConnectionIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return AppConnectionIamBindingArgs2(
