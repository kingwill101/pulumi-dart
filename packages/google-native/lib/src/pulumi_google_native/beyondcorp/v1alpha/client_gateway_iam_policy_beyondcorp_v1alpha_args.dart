...
class ClientGatewayIamPolicyBeyondcorpV1alphaArgs {
  ...
  ClientGatewayIamPolicyBeyondcorpV1alphaArgs({
    this.auditConfigs,
    this.bindings,
  ...
  factory ClientGatewayIamPolicyBeyondcorpV1alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return ClientGatewayIamPolicyBeyondcorpV1alphaArgs(
