...
import 'net_connection_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class NetConnectionIamMember extends pulumi.CustomResource {
  ...
  NetConnectionIamMember(
    String name, {
    NetConnectionIamMemberArgs? args,
