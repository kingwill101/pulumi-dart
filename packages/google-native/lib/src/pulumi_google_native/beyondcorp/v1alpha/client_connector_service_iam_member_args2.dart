...
class ClientConnectorServiceIamMemberArgs2 {
  ...
  ClientConnectorServiceIamMemberArgs2({
    this.condition,
  ...
  factory ClientConnectorServiceIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return ClientConnectorServiceIamMemberArgs2(
