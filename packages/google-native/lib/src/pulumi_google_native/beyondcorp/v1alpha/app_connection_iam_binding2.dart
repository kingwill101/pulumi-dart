...
import 'app_connection_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class AppConnectionIamBinding2 extends CustomResource {
  ...
  AppConnectionIamBinding2(
    String name, {
    AppConnectionIamBindingArgs2? args,
