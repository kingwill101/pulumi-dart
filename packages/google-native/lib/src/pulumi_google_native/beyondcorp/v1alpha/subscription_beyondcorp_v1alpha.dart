...
import 'subscription_beyondcorp_v1alpha_args.dart';
...
class SubscriptionBeyondcorpV1alpha extends pulumi.CustomResource {
  ...
  SubscriptionBeyondcorpV1alpha(
    String name, {
    SubscriptionBeyondcorpV1alphaArgs? args,
