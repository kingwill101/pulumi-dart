...
import 'app_gateway_host_type2.dart';
import 'app_gateway_type2.dart';

/// The set of arguments for AppGateway.
class AppGatewayArgs2 {
  ...
  final Input<AppGatewayHostType2> hostType;
  ...
  final Input<AppGatewayType2> type;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['hostType'] = Input.mapInputValue<AppGatewayHostType2, String>(
    ...
    map['type'] = Input.mapInputValue<AppGatewayType2, String>(
        type, (value) => value.value);
    return map;
  }

  factory AppGatewayArgs2.fromMap(Map<String, dynamic> map) {
    return AppGatewayArgs2(
      appGatewayId: Input.asOptionalInput<String>(map['appGatewayId']),
      displayName: Input.asOptionalInput<String>(map['displayName']),
      hostType: Input.asInput<AppGatewayHostType2>(map['hostType']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      type: Input.asInput<AppGatewayType2>(map['type']),
    );
  }
}
