...
class ClientConnectorServiceIamBindingArgs2 {
  ...
  ClientConnectorServiceIamBindingArgs2({
    this.condition,
  ...
  factory ClientConnectorServiceIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return ClientConnectorServiceIamBindingArgs2(
