...
class OrganizationPartnerTenantIamBindingArgs {
  ...
  OrganizationPartnerTenantIamBindingArgs({
    this.condition,
  ...
  factory OrganizationPartnerTenantIamBindingArgs.fromMap(
      Map<String, dynamic> map) {
    return OrganizationPartnerTenantIamBindingArgs(
