...
class ClientConnectorServiceIamMemberArgs {
  ...
  ClientConnectorServiceIamMemberArgs({
    this.condition,
  ...
  factory ClientConnectorServiceIamMemberArgs.fromMap(
      Map<String, dynamic> map) {
    return ClientConnectorServiceIamMemberArgs(
