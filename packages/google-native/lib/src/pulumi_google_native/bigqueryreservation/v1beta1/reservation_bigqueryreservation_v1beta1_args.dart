...
class ReservationBigqueryreservationV1beta1Args {
  ...
  factory ReservationBigqueryreservationV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return ReservationBigqueryreservationV1beta1Args(
      concurrency: pulumi.Input.asOptionalInput<String>(map['concurrency']),
      ignoreIdleSlots:
          pulumi.Input.asOptionalInput<bool>(map['ignoreIdleSlots']),
      ...
      slotCapacity: pulumi.Input.asOptionalInput<String>(map['slotCapacity']),
    );
  }
}
