...
class GetReservationBigqueryreservationV1beta1Result {
  ...
  GetReservationBigqueryreservationV1beta1Result({
  ...
  factory GetReservationBigqueryreservationV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetReservationBigqueryreservationV1beta1Result(
