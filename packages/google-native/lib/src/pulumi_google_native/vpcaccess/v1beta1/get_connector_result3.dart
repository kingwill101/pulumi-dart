...
class GetConnectorResult3 {
  ...
  factory GetConnectorResult3.fromMap(Map<String, dynamic> map) {
    return GetConnectorResult3(
      ...
      subnet: SubnetResponse2.fromMap(
