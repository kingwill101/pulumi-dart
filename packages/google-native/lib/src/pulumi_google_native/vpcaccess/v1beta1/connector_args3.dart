...
class ConnectorArgs3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (subnetValue != null) {
      map['subnet'] =
          Input.mapOptionalInputValue<Subnet2, Map<String, dynamic>>(
              subnetValue, (value) => value.toMap());
    }
    return map;
  }

  factory ConnectorArgs3.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs3(
      ...
      subnet: Input.asOptionalInput<Subnet2>(map['subnet']),
    );
  }
}
