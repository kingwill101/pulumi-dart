...
class ConnectorVpcaccessV1Args {
  ...
  factory ConnectorVpcaccessV1Args.fromMap(Map<String, dynamic> map) {
    return ConnectorVpcaccessV1Args(
      ...
      subnet: pulumi.Input.asOptionalInput<Subnet>(map['subnet']),
    );
  }
}
