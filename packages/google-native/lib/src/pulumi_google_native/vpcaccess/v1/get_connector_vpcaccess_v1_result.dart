...
class GetConnectorVpcaccessV1Result {
  ...
  factory GetConnectorVpcaccessV1Result.fromMap(Map<String, dynamic> map) {
    return GetConnectorVpcaccessV1Result(
