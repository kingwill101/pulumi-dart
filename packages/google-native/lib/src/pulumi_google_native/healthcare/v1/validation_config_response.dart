...
class ValidationConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['disableFhirpathValidation'] = disableFhirpathValidation;
    map['disableProfileValidation'] = disableProfileValidation;
    map['disableReferenceTypeValidation'] = disableReferenceTypeValidation;
    map['disableRequiredFieldValidation'] = disableRequiredFieldValidation;
    map['enabledImplementationGuides'] = enabledImplementationGuides;
    return map;
  }

  factory ValidationConfigResponse.fromMap(Map<String, dynamic> map) {
    return ValidationConfigResponse(
      disableFhirpathValidation: map['disableFhirpathValidation'] as bool,
      disableProfileValidation: map['disableProfileValidation'] as bool,
