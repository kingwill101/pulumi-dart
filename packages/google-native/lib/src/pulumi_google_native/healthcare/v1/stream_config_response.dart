...
import 'deidentified_store_destination_response.dart';
import 'google_cloud_healthcare_v1_fhir_big_query_destination_response.dart';
...
class StreamConfigResponse {
  ...
  final GoogleCloudHealthcareV1FhirBigQueryDestinationResponse
      bigqueryDestination;
  ...
  final DeidentifiedStoreDestinationResponse deidentifiedStoreDestination;
  ...
  factory StreamConfigResponse.fromMap(Map<String, dynamic> map) {
    return StreamConfigResponse(
      bigqueryDestination:
          GoogleCloudHealthcareV1FhirBigQueryDestinationResponse.fromMap(
              (map['bigqueryDestination'] as Map).cast<String, dynamic>()),
      deidentifiedStoreDestination:
          DeidentifiedStoreDestinationResponse.fromMap(
