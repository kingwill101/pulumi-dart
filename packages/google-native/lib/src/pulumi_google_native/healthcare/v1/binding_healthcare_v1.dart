...
class BindingHealthcareV1 {
  ...
  factory BindingHealthcareV1.fromMap(Map<String, dynamic> map) {
    return BindingHealthcareV1(
      condition: map['condition'] == null
          ? null
          : ExprHealthcareV1.fromMap(
