...
class DatasetFhirStoreIamBindingArgs {
  ...
  DatasetFhirStoreIamBindingArgs({
    this.condition,
  ...
  factory DatasetFhirStoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DatasetFhirStoreIamBindingArgs(
