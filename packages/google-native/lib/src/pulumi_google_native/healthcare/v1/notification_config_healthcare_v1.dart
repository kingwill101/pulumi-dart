...
class NotificationConfigHealthcareV1 {
  ...
  NotificationConfigHealthcareV1({
    this.pubsubTopic,
  ...
  factory NotificationConfigHealthcareV1.fromMap(Map<String, dynamic> map) {
    return NotificationConfigHealthcareV1(
      pubsubTopic:
