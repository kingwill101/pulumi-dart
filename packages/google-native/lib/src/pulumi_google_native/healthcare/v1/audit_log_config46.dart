...
class AuditLogConfig46 {
  ...
  factory AuditLogConfig46.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig46(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType46.fromValue(map['logType'] as String),
    );
  }
}
