...
import 'time_partitioning_response2.dart';

/// Configuration for the FHIR BigQuery schema. Determines how the server generates the schema.
class SchemaConfigResponse {
  /// The configuration for exported BigQuery tables to be partitioned by FHIR resource's last updated time column.
  final TimePartitioningResponse2 lastUpdatedPartitionConfig;
  ...
  factory SchemaConfigResponse.fromMap(Map<String, dynamic> map) {
    return SchemaConfigResponse(
      lastUpdatedPartitionConfig: TimePartitioningResponse2.fromMap(
