...
class Consent extends CustomResource {
  ...
  late final Output<List<GoogleCloudHealthcareV1ConsentPolicyResponse>>
      policies;
  ...
  Consent(
    ...
    this.policies = Output.createUnknown<
        List<GoogleCloudHealthcareV1ConsentPolicyResponse>>();
