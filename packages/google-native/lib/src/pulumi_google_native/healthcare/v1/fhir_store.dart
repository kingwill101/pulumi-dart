...
class FhirStore extends CustomResource {
  ...
  late final Output<List<FhirNotificationConfigResponse>> notificationConfigs;
  ...
  late final Output<List<StreamConfigResponse>> streamConfigs;

  /// Configuration for how to validate incoming FHIR resources against configured profiles.
  late final Output<ValidationConfigResponse> validationConfig;
