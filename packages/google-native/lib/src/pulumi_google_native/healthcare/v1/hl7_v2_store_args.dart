...
class Hl7V2StoreArgs {
  ...
  final Input<List<Hl7V2NotificationConfig>>? notificationConfigs;

  /// The configuration for the parser. It determines how the server parses the messages.
  final Input<ParserConfig>? parserConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (notificationConfigsValue != null) {
      map['notificationConfigs'] = Input.mapOptionalInputValue<
          ...
          (value) =>
              Input.encodeList<Hl7V2NotificationConfig, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    final parserConfigValue = parserConfig;
    if (parserConfigValue != null) {
      map['parserConfig'] =
          Input.mapOptionalInputValue<ParserConfig, Map<String, dynamic>>(
  ...
  factory Hl7V2StoreArgs.fromMap(Map<String, dynamic> map) {
    return Hl7V2StoreArgs(
      ...
      notificationConfigs: Input.asOptionalInput<List<Hl7V2NotificationConfig>>(
          map['notificationConfigs']),
      parserConfig: Input.asOptionalInput<ParserConfig>(map['parserConfig']),
