...
class KmsWrappedCryptoKeyResponse2 {
  ...
  factory KmsWrappedCryptoKeyResponse2.fromMap(Map<String, dynamic> map) {
    return KmsWrappedCryptoKeyResponse2(
