...
class GetMessageResult2 {
  ...
  final ParsedDataResponse2 parsedData;

  /// All patient IDs listed in the PID-2, PID-3, and PID-4 segments of this message.
  final List<PatientIdResponse2> patientIds;

  /// The parsed version of the raw message data schematized according to this store's schemas and type definitions.
  final SchematizedDataResponse2 schematizedData;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['patientIds'] =
        Input.encodeList<PatientIdResponse2, Map<String, dynamic>>(
  ...
  factory GetMessageResult2.fromMap(Map<String, dynamic> map) {
    return GetMessageResult2(
      ...
      parsedData: ParsedDataResponse2.fromMap(
          (map['parsedData'] as Map).cast<String, dynamic>()),
      patientIds: Input.decodeList<PatientIdResponse2>(
          map['patientIds'],
          (value) => PatientIdResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      schematizedData: SchematizedDataResponse2.fromMap(
