...
import 'dataset_dicom_store_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetDicomStoreIamMember2 extends CustomResource {
  ...
  DatasetDicomStoreIamMember2(
    String name, {
    DatasetDicomStoreIamMemberArgs2? args,
