...
class ValidationConfig2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    final disableFhirpathValidationValue = disableFhirpathValidation;
    if (disableFhirpathValidationValue != null) {
      map['disableFhirpathValidation'] = disableFhirpathValidationValue;
    }
    final disableProfileValidationValue = disableProfileValidation;
    if (disableProfileValidationValue != null) {
      map['disableProfileValidation'] = disableProfileValidationValue;
    }
    final disableReferenceTypeValidationValue = disableReferenceTypeValidation;
    if (disableReferenceTypeValidationValue != null) {
      map['disableReferenceTypeValidation'] =
          disableReferenceTypeValidationValue;
    }
    final disableRequiredFieldValidationValue = disableRequiredFieldValidation;
    if (disableRequiredFieldValidationValue != null) {
      map['disableRequiredFieldValidation'] =
          disableRequiredFieldValidationValue;
    }
    final enabledImplementationGuidesValue = enabledImplementationGuides;
    if (enabledImplementationGuidesValue != null) {
      map['enabledImplementationGuides'] = enabledImplementationGuidesValue;
    }
    return map;
  }

  factory ValidationConfig2.fromMap(Map<String, dynamic> map) {
    return ValidationConfig2(
