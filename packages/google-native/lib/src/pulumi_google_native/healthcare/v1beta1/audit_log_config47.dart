...
class AuditLogConfig47 {
  ...
  factory AuditLogConfig47.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig47(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType47.fromValue(map['logType'] as String),
    );
  }
}
