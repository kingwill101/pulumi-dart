...
class GetMessageHealthcareV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['patientIds'] = pulumi.Input.encodeList<
        PatientIdResponseHealthcareV1beta1,
        Map<String, dynamic>>(patientIds, (value) => value.toMap());
  ...
  factory GetMessageHealthcareV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetMessageHealthcareV1beta1Result(
      ...
      parsedData: ParsedDataResponseHealthcareV1beta1.fromMap(
          (map['parsedData'] as Map).cast<String, dynamic>()),
      patientIds: pulumi.Input.decodeList<PatientIdResponseHealthcareV1beta1>(
          map['patientIds'],
          (value) => PatientIdResponseHealthcareV1beta1.fromMap(
              (value as Map).cast<String, dynamic>())),
      schematizedData: SchematizedDataResponseHealthcareV1beta1.fromMap(
