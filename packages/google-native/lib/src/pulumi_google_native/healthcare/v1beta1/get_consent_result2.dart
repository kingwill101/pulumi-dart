...
class GetConsentResult2 {
  ...
  factory GetConsentResult2.fromMap(Map<String, dynamic> map) {
    return GetConsentResult2(
      consentArtifact: map['consentArtifact'] as String,
      expireTime: map['expireTime'] as String,
      metadata: (map['metadata'] as Map).cast<String, String>(),
      name: map['name'] as String,
      policies:
          Input.decodeList<GoogleCloudHealthcareV1beta1ConsentPolicyResponse>(
              map['policies'],
              (value) =>
