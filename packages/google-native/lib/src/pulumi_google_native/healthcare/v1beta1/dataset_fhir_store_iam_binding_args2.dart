...
class DatasetFhirStoreIamBindingArgs2 {
  ...
  DatasetFhirStoreIamBindingArgs2({
    this.condition,
  ...
  factory DatasetFhirStoreIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetFhirStoreIamBindingArgs2(
