...
import 'dataset_fhir_store_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetFhirStoreIamMember2 extends CustomResource {
  ...
  DatasetFhirStoreIamMember2(
    String name, {
    DatasetFhirStoreIamMemberArgs2? args,
