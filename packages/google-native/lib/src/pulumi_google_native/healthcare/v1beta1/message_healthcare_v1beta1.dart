...
class MessageHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SchematizedDataResponseHealthcareV1beta1>
      schematizedData;
  ...
  MessageHealthcareV1beta1(
    ...
    this.parsedData =
        registerOutput<ParsedDataResponseHealthcareV1beta1>('parsedData');
    this.patientIds =
        registerOutput<List<PatientIdResponseHealthcareV1beta1>>('patientIds');
    this.project = registerOutput<String>('project');
    this.schematizedData =
        registerOutput<SchematizedDataResponseHealthcareV1beta1>(
            'schematizedData');
