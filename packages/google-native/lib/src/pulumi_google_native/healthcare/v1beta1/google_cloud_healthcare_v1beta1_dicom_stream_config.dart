...
import 'google_cloud_healthcare_v1beta1_dicom_big_query_destination.dart';
...
class GoogleCloudHealthcareV1beta1DicomStreamConfig {
  ...
  final GoogleCloudHealthcareV1beta1DicomBigQueryDestination?
      bigqueryDestination;
  ...
  factory GoogleCloudHealthcareV1beta1DicomStreamConfig.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1DicomStreamConfig(
      bigqueryDestination: map['bigqueryDestination'] == null
          ? null
          : GoogleCloudHealthcareV1beta1DicomBigQueryDestination.fromMap(
