...
import 'dataset_dicom_store_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetDicomStoreIamBinding2 extends CustomResource {
  ...
  DatasetDicomStoreIamBinding2(
    String name, {
    DatasetDicomStoreIamBindingArgs2? args,
