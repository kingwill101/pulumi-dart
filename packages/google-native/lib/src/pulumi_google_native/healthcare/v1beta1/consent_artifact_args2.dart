...
import 'image2.dart';
import 'signature4.dart';

/// The set of arguments for ConsentArtifact.
class ConsentArtifactArgs2 {
  /// Optional. Screenshots, PDFs, or other binary information documenting the user's consent.
  final Input<List<Image2>>? consentContentScreenshots;
  ...
  final Input<Signature4>? guardianSignature;
  ...
  final Input<Signature4>? userSignature;

  /// Optional. A signature from a witness.
  final Input<Signature4>? witnessSignature;

  ConsentArtifactArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (consentContentScreenshotsValue != null) {
      map['consentContentScreenshots'] =
          Input.mapOptionalInputValue<List<Image2>, List<Map<String, dynamic>>>(
              consentContentScreenshotsValue,
              (value) => Input.encodeList<Image2, Map<String, dynamic>>(
    ...
    if (guardianSignatureValue != null) {
      map['guardianSignature'] =
          Input.mapOptionalInputValue<Signature4, Map<String, dynamic>>(
  ...
  factory ConsentArtifactArgs2.fromMap(Map<String, dynamic> map) {
    return ConsentArtifactArgs2(
      consentContentScreenshots:
          Input.asOptionalInput<List<Image2>>(map['consentContentScreenshots']),
      ...
      guardianSignature:
          Input.asOptionalInput<Signature4>(map['guardianSignature']),
      ...
      userSignature: Input.asOptionalInput<Signature4>(map['userSignature']),
      witnessSignature:
          Input.asOptionalInput<Signature4>(map['witnessSignature']),
    );
  }
}
