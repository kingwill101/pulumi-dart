...
import 'dataset_fhir_store_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetFhirStoreIamBinding2 extends CustomResource {
  ...
  DatasetFhirStoreIamBinding2(
    String name, {
    DatasetFhirStoreIamBindingArgs2? args,
