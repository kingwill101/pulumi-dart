...
class DatasetFhirStoreIamMemberHealthcareV1beta1Args {
  ...
  DatasetFhirStoreIamMemberHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetFhirStoreIamMemberHealthcareV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return DatasetFhirStoreIamMemberHealthcareV1beta1Args(
