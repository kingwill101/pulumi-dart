...
class DatasetHl7V2StoreIamBindingArgs2 {
  ...
  DatasetHl7V2StoreIamBindingArgs2({
    this.condition,
  ...
  factory DatasetHl7V2StoreIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetHl7V2StoreIamBindingArgs2(
