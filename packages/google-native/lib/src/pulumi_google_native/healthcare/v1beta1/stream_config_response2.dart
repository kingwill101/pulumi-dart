...
class StreamConfigResponse2 {
  ...
  final DeidentifiedStoreDestinationResponse2 deidentifiedStoreDestination;

  /// Supply a FHIR resource type (such as "Patient" or "Observation"). See https://www.hl7.org/fhir/valueset-resource-types.html for a list of all FHIR resource types. The server treats an empty list as an intent to stream all the supported resource types in this FHIR store.
  final List<String> resourceTypes;

  StreamConfigResponse2({
  ...
  factory StreamConfigResponse2.fromMap(Map<String, dynamic> map) {
    return StreamConfigResponse2(
      bigqueryDestination:
      ...
      deidentifiedStoreDestination:
          DeidentifiedStoreDestinationResponse2.fromMap(
