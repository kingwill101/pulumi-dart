...
class GetAttributeDefinitionResult2 {
  ...
  factory GetAttributeDefinitionResult2.fromMap(Map<String, dynamic> map) {
    return GetAttributeDefinitionResult2(
