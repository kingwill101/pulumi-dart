...
class DatasetConsentStoreIamBindingArgs2 {
  ...
  DatasetConsentStoreIamBindingArgs2({
    this.condition,
  ...
  factory DatasetConsentStoreIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetConsentStoreIamBindingArgs2(
