...
import 'dataset_hl7_v2_store_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetHl7V2StoreIamBinding2 extends CustomResource {
  ...
  DatasetHl7V2StoreIamBinding2(
    String name, {
    DatasetHl7V2StoreIamBindingArgs2? args,
