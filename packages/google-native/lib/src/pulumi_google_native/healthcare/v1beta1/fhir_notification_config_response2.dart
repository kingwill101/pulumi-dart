...
class FhirNotificationConfigResponse2 {
  ...
  FhirNotificationConfigResponse2({
  ...
  factory FhirNotificationConfigResponse2.fromMap(Map<String, dynamic> map) {
    return FhirNotificationConfigResponse2(
