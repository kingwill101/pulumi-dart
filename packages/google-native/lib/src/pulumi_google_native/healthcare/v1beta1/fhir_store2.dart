...
class FhirStore2 extends CustomResource {
  ...
  late final Output<ConsentConfigResponse> consentConfig;
  ...
  late final Output<List<FhirNotificationConfigResponse2>> notificationConfigs;
  late final Output<String> project;

  /// Configuration for how FHIR resources can be searched.
  late final Output<SearchConfigResponse> searchConfig;
  ...
  late final Output<List<StreamConfigResponse2>> streamConfigs;

  /// Configuration for how to validate incoming FHIR resources against configured profiles.
  late final Output<ValidationConfigResponse2> validationConfig;
