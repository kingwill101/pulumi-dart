...
import 'deidentified_store_destination2.dart';
...
class StreamConfig2 {
  ...
  final DeidentifiedStoreDestination2? deidentifiedStoreDestination;
  ...
  factory StreamConfig2.fromMap(Map<String, dynamic> map) {
    return StreamConfig2(
      ...
      deidentifiedStoreDestination: map['deidentifiedStoreDestination'] == null
          ? null
          : DeidentifiedStoreDestination2.fromMap(
