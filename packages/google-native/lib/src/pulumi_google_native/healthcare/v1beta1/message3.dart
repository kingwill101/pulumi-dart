...
class Message3 extends CustomResource {
  ...
  Message3(
    ...
    this.parsedData = Output.createUnknown<ParsedDataResponse2>();
    this.patientIds = Output.createUnknown<List<PatientIdResponse2>>();
    this.project = Output.createUnknown<String>();
    this.schematizedData = Output.createUnknown<SchematizedDataResponse2>();
