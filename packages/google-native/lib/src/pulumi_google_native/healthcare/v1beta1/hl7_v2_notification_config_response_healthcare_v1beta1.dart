...
class Hl7V2NotificationConfigResponseHealthcareV1beta1 {
  ...
  factory Hl7V2NotificationConfigResponseHealthcareV1beta1.fromMap(
      Map<String, dynamic> map) {
    return Hl7V2NotificationConfigResponseHealthcareV1beta1(
