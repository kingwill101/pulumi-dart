...
class DatasetDicomStoreIamBindingArgs2 {
  ...
  DatasetDicomStoreIamBindingArgs2({
    this.condition,
  ...
  factory DatasetDicomStoreIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetDicomStoreIamBindingArgs2(
