...
import 'dataset_consent_store_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetConsentStoreIamBinding2 extends CustomResource {
  ...
  DatasetConsentStoreIamBinding2(
    String name, {
    DatasetConsentStoreIamBindingArgs2? args,
