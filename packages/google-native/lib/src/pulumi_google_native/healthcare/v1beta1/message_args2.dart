...
import 'patient_id2.dart';
import 'schematized_data2.dart';
...
class MessageArgs2 {
  ...
  final Input<List<PatientId2>>? patientIds;
  final Input<String>? project;

  /// The parsed version of the raw message data schematized according to this store's schemas and type definitions.
  final Input<SchematizedData2>? schematizedData;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (patientIdsValue != null) {
      map['patientIds'] = Input.mapOptionalInputValue<List<PatientId2>,
              List<Map<String, dynamic>>>(
          patientIdsValue,
          (value) => Input.encodeList<PatientId2, Map<String, dynamic>>(
    ...
    if (schematizedDataValue != null) {
      map['schematizedData'] =
          Input.mapOptionalInputValue<SchematizedData2, Map<String, dynamic>>(
  ...
  factory MessageArgs2.fromMap(Map<String, dynamic> map) {
    return MessageArgs2(
      ...
      patientIds: Input.asOptionalInput<List<PatientId2>>(map['patientIds']),
      project: Input.asOptionalInput<String>(map['project']),
      schematizedData:
          Input.asOptionalInput<SchematizedData2>(map['schematizedData']),
