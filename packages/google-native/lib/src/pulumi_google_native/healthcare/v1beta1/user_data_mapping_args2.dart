...
class UserDataMappingArgs2 {
  ...
  final Input<List<Attribute2>>? resourceAttributes;

  /// User's UUID provided by the client.
  final Input<String> userId;

  UserDataMappingArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (resourceAttributesValue != null) {
      map['resourceAttributes'] = Input.mapOptionalInputValue<List<Attribute2>,
              List<Map<String, dynamic>>>(
          resourceAttributesValue,
          (value) => Input.encodeList<Attribute2, Map<String, dynamic>>(
  ...
  factory UserDataMappingArgs2.fromMap(Map<String, dynamic> map) {
    return UserDataMappingArgs2(
      ...
      resourceAttributes:
          Input.asOptionalInput<List<Attribute2>>(map['resourceAttributes']),
