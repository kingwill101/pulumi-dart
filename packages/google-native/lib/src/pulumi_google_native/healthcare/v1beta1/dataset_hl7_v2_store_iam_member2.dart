...
import 'dataset_hl7_v2_store_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetHl7V2StoreIamMember2 extends CustomResource {
  ...
  DatasetHl7V2StoreIamMember2(
    String name, {
    DatasetHl7V2StoreIamMemberArgs2? args,
