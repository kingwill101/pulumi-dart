...
class DatasetConsentStoreIamMemberArgs2 {
  ...
  DatasetConsentStoreIamMemberArgs2({
    this.condition,
  ...
  factory DatasetConsentStoreIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetConsentStoreIamMemberArgs2(
