...
class DatasetHl7V2StoreIamMemberArgs2 {
  ...
  DatasetHl7V2StoreIamMemberArgs2({
    this.condition,
  ...
  factory DatasetHl7V2StoreIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetHl7V2StoreIamMemberArgs2(
