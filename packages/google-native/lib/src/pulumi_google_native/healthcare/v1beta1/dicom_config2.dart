...
import 'dicom_config_filter_profile2.dart';
import 'tag_filter_list2.dart';

/// Specifies the parameters needed for de-identification of DICOM stores.
class DicomConfig2 {
  /// Tag filtering profile that determines which tags to keep/remove.
  final DicomConfigFilterProfile2? filterProfile;

  /// List of tags to keep. Remove all other tags.
  final TagFilterList2? keepList;

  /// List of tags to remove. Keep all other tags.
  final TagFilterList2? removeList;
  ...
  factory DicomConfig2.fromMap(Map<String, dynamic> map) {
    return DicomConfig2(
      filterProfile: map['filterProfile'] == null
          ? null
          : DicomConfigFilterProfile2.fromValue(map['filterProfile'] as String),
      keepList: map['keepList'] == null
          ? null
          : TagFilterList2.fromMap(
