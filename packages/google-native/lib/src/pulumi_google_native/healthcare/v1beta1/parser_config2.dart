...
import 'parser_config_version2.dart';
import 'schema_package2.dart';
...
class ParserConfig2 {
  ...
  factory ParserConfig2.fromMap(Map<String, dynamic> map) {
    return ParserConfig2(
      ...
      version: map['version'] == null
          ? null
          : ParserConfigVersion2.fromValue(map['version'] as String),
    );
  }
}
