...
class DatasetDicomStoreIamMemberArgs2 {
  ...
  DatasetDicomStoreIamMemberArgs2({
    this.condition,
  ...
  factory DatasetDicomStoreIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetDicomStoreIamMemberArgs2(
