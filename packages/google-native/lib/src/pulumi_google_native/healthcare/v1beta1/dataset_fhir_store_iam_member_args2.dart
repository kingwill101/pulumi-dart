...
class DatasetFhirStoreIamMemberArgs2 {
  ...
  DatasetFhirStoreIamMemberArgs2({
    this.condition,
  ...
  factory DatasetFhirStoreIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetFhirStoreIamMemberArgs2(
