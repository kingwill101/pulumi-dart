...
class ConsentArtifactHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  ConsentArtifactHealthcareV1beta1(
    ...
    this.guardianSignature =
        registerOutput<SignatureResponseHealthcareV1beta1>('guardianSignature');
    ...
    this.userSignature =
        registerOutput<SignatureResponseHealthcareV1beta1>('userSignature');
    this.witnessSignature =
        registerOutput<SignatureResponseHealthcareV1beta1>('witnessSignature');
  }
}
