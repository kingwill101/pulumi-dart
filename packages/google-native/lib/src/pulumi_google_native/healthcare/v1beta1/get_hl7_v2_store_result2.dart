...
class GetHl7V2StoreResult2 {
  ...
  final List<Hl7V2NotificationConfigResponse2> notificationConfigs;

  /// The configuration for the parser. It determines how the server parses the messages.
  final ParserConfigResponse2 parserConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['notificationConfigs'] = Input.encodeList<
        Hl7V2NotificationConfigResponse2,
  ...
  factory GetHl7V2StoreResult2.fromMap(Map<String, dynamic> map) {
    return GetHl7V2StoreResult2(
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      notificationConfig: NotificationConfigResponse4.fromMap(
          (map['notificationConfig'] as Map).cast<String, dynamic>()),
      notificationConfigs: Input.decodeList<Hl7V2NotificationConfigResponse2>(
          map['notificationConfigs'],
          (value) => Hl7V2NotificationConfigResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      parserConfig: ParserConfigResponse2.fromMap(
