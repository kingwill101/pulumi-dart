...
class InstanceIamMemberSpannerV1Args {
  ...
  InstanceIamMemberSpannerV1Args({
    this.condition,
  ...
  factory InstanceIamMemberSpannerV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberSpannerV1Args(
