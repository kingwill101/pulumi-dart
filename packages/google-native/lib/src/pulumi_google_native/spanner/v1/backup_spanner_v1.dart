...
import 'backup_spanner_v1_args.dart';
...
class BackupSpannerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EncryptionInfoResponseSpannerV1> encryptionInfo;
  ...
  BackupSpannerV1(
    ...
    this.encryptionInfo =
        registerOutput<EncryptionInfoResponseSpannerV1>('encryptionInfo');
