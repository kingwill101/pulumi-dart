...
import 'status_response_spanner_v1.dart';

/// Encryption information for a Cloud Spanner database or backup.
class EncryptionInfoResponseSpannerV1 {
  ...
  final StatusResponseSpannerV1 encryptionStatus;
  ...
  factory EncryptionInfoResponseSpannerV1.fromMap(Map<String, dynamic> map) {
    return EncryptionInfoResponseSpannerV1(
      encryptionStatus: StatusResponseSpannerV1.fromMap(
