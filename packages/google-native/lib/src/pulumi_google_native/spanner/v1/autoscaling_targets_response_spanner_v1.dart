...
class AutoscalingTargetsResponseSpannerV1 {
  ...
  AutoscalingTargetsResponseSpannerV1({
  ...
  factory AutoscalingTargetsResponseSpannerV1.fromMap(
      Map<String, dynamic> map) {
    return AutoscalingTargetsResponseSpannerV1(
      highPriorityCpuUtilizationPercent:
