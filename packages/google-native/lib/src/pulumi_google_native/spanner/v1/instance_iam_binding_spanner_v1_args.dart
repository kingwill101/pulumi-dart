...
class InstanceIamBindingSpannerV1Args {
  ...
  InstanceIamBindingSpannerV1Args({
    this.condition,
  ...
  factory InstanceIamBindingSpannerV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingSpannerV1Args(
