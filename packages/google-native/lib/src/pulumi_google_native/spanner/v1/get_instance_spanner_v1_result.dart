...
import 'autoscaling_config_response_spanner_v1.dart';
import 'free_instance_metadata_response.dart';

/// Result data returned by getInstance.
class GetInstanceSpannerV1Result {
  ...
  final AutoscalingConfigResponseSpannerV1 autoscalingConfig;
  ...
  factory GetInstanceSpannerV1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceSpannerV1Result(
      autoscalingConfig: AutoscalingConfigResponseSpannerV1.fromMap(
