...
class BackupSpannerV1Args {
  ...
  factory BackupSpannerV1Args.fromMap(Map<String, dynamic> map) {
    return BackupSpannerV1Args(
      ...
      encryptionConfigEncryptionType:
          pulumi.Input.asInput<String>(map['encryptionConfigEncryptionType']),
      encryptionConfigKmsKeyName: pulumi.Input.asOptionalInput<String>(
          map['encryptionConfigKmsKeyName']),
      expireTime: pulumi.Input.asOptionalInput<String>(map['expireTime']),
      instanceId: pulumi.Input.asInput<String>(map['instanceId']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      versionTime: pulumi.Input.asOptionalInput<String>(map['versionTime']),
    );
  }
}
