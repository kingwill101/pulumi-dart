...
class GetDatabaseSpannerV1Result {
  ...
  final EncryptionConfigResponseSpannerV1 encryptionConfig;
  ...
  final List<EncryptionInfoResponseSpannerV1> encryptionInfo;
  ...
  final RestoreInfoResponseSpannerV1 restoreInfo;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['defaultLeader'] = defaultLeader;
    map['earliestVersionTime'] = earliestVersionTime;
    map['enableDropProtection'] = enableDropProtection;
    map['encryptionConfig'] = encryptionConfig.toMap();
    map['encryptionInfo'] = pulumi.Input.encodeList<
        EncryptionInfoResponseSpannerV1,
        Map<String, dynamic>>(encryptionInfo, (value) => value.toMap());
    map['name'] = name;
    map['reconciling'] = reconciling;
    map['restoreInfo'] = restoreInfo.toMap();
    map['state'] = state;
    map['versionRetentionPeriod'] = versionRetentionPeriod;
    return map;
  }

  factory GetDatabaseSpannerV1Result.fromMap(Map<String, dynamic> map) {
    return GetDatabaseSpannerV1Result(
      ...
      encryptionConfig: EncryptionConfigResponseSpannerV1.fromMap(
          (map['encryptionConfig'] as Map).cast<String, dynamic>()),
      encryptionInfo: pulumi.Input.decodeList<EncryptionInfoResponseSpannerV1>(
          map['encryptionInfo'],
          (value) => EncryptionInfoResponseSpannerV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      reconciling: map['reconciling'] as bool,
      restoreInfo: RestoreInfoResponseSpannerV1.fromMap(
          (map['restoreInfo'] as Map).cast<String, dynamic>()),
