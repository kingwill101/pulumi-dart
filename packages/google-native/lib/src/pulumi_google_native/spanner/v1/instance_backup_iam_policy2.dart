...
import 'instance_backup_iam_policy_args2.dart';
...
class InstanceBackupIamPolicy2 extends CustomResource {
  ...
  InstanceBackupIamPolicy2(
    String name, {
    InstanceBackupIamPolicyArgs2? args,
