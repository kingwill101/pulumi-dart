...
import 'binding_response_spanner_v1.dart';
import 'instance_backup_iam_policy_spanner_v1_args.dart';
...
class InstanceBackupIamPolicySpannerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<BindingResponseSpannerV1>> bindings;
  ...
  InstanceBackupIamPolicySpannerV1(
    String name, {
    InstanceBackupIamPolicySpannerV1Args? args,
    ...
    this.bindings = registerOutput<List<BindingResponseSpannerV1>>('bindings');
