...
class InstanceBackupIamBindingSpannerV1Args {
  ...
  InstanceBackupIamBindingSpannerV1Args({
    this.condition,
  ...
  factory InstanceBackupIamBindingSpannerV1Args.fromMap(
      Map<String, dynamic> map) {
    return InstanceBackupIamBindingSpannerV1Args(
