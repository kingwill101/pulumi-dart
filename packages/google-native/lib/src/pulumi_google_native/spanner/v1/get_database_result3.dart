...
class GetDatabaseResult3 {
  ...
  final EncryptionConfigResponse15 encryptionConfig;
  ...
  final List<EncryptionInfoResponse5> encryptionInfo;
  ...
  final RestoreInfoResponse2 restoreInfo;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['encryptionInfo'] =
        Input.encodeList<EncryptionInfoResponse5, Map<String, dynamic>>(
  ...
  factory GetDatabaseResult3.fromMap(Map<String, dynamic> map) {
    return GetDatabaseResult3(
      ...
      encryptionConfig: EncryptionConfigResponse15.fromMap(
          (map['encryptionConfig'] as Map).cast<String, dynamic>()),
      encryptionInfo: Input.decodeList<EncryptionInfoResponse5>(
          map['encryptionInfo'],
          (value) => EncryptionInfoResponse5.fromMap(
              (value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      reconciling: map['reconciling'] as bool,
      restoreInfo: RestoreInfoResponse2.fromMap(
