...
class InstanceBackupIamBindingArgs2 {
  ...
  factory InstanceBackupIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return InstanceBackupIamBindingArgs2(
