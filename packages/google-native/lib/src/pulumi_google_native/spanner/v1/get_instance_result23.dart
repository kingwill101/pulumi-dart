...
class GetInstanceResult23 {
  ...
  final AutoscalingConfigResponse3 autoscalingConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['endpointUris'] = endpointUris;
    map['freeInstanceMetadata'] = freeInstanceMetadata.toMap();
  ...
  factory GetInstanceResult23.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult23(
      autoscalingConfig: AutoscalingConfigResponse3.fromMap(
      ...
      freeInstanceMetadata: FreeInstanceMetadataResponse.fromMap(
