...
class InstanceConfig3 extends CustomResource {
  ...
  late final Output<String> freeInstanceAvailability;
  ...
  late final Output<List<String>> leaderOptions;
  ...
  late final Output<List<ReplicaInfoResponse>> optionalReplicas;
  ...
  late final Output<List<ReplicaInfoResponse>> replicas;
