...
class GetBackupResult14 {
  ...
  final EncryptionInfoResponse5 encryptionInfo;
  ...
  factory GetBackupResult14.fromMap(Map<String, dynamic> map) {
    return GetBackupResult14(
      createTime: map['createTime'] as String,
      database: map['database'] as String,
      databaseDialect: map['databaseDialect'] as String,
      encryptionInfo: EncryptionInfoResponse5.fromMap(
