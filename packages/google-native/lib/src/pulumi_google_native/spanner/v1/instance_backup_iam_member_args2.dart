...
class InstanceBackupIamMemberArgs2 {
  ...
  factory InstanceBackupIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return InstanceBackupIamMemberArgs2(
