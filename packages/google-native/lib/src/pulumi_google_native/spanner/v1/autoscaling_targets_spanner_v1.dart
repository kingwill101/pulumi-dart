...
class AutoscalingTargetsSpannerV1 {
  ...
  factory AutoscalingTargetsSpannerV1.fromMap(Map<String, dynamic> map) {
    return AutoscalingTargetsSpannerV1(
      highPriorityCpuUtilizationPercent:
