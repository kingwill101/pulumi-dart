...
import 'attached_disk_mode5.dart';

/// A node-attached disk resource. Next ID: 8;
class AttachedDisk6 {
  /// The mode in which to attach this disk. If not specified, the default is READ_WRITE mode. Only applicable to data_disks.
  final AttachedDiskMode5? mode;
  ...
  factory AttachedDisk6.fromMap(Map<String, dynamic> map) {
    return AttachedDisk6(
      mode: map['mode'] == null
          ? null
          : AttachedDiskMode5.fromValue(map['mode'] as String),
      sourceDisk:
