...
class NodeTpuV2alpha1 extends pulumi.CustomResource {
  ...
  NodeTpuV2alpha1(
    ...
    this.dataDisks =
        registerOutput<List<AttachedDiskResponseTpuV2alpha1>>('dataDisks');
    ...
    this.networkConfig =
        registerOutput<NetworkConfigResponseTpuV2alpha1>('networkConfig');
    ...
    this.schedulingConfig =
        registerOutput<SchedulingConfigResponseTpuV2alpha1>('schedulingConfig');
    this.serviceAccount =
        registerOutput<ServiceAccountResponseTpuV2alpha1>('serviceAccount');
    this.shieldedInstanceConfig =
        registerOutput<ShieldedInstanceConfigResponseTpuV2alpha1>(
            'shieldedInstanceConfig');
    this.state = registerOutput<String>('state');
    this.symptoms =
        registerOutput<List<SymptomResponseTpuV2alpha1>>('symptoms');
