...
class NodeTpuV2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AcceleratorConfigResponseTpuV2> acceleratorConfig;
  ...
  late final pulumi.Output<List<AttachedDiskResponseTpuV2>> dataDisks;
  ...
  late final pulumi.Output<NetworkConfigResponseTpuV2> networkConfig;
  ...
  late final pulumi.Output<ServiceAccountResponseTpuV2> serviceAccount;

  /// Shielded Instance options.
  late final pulumi.Output<ShieldedInstanceConfigResponseTpuV2>
  ...
  NodeTpuV2(
    ...
    this.acceleratorConfig =
        registerOutput<AcceleratorConfigResponseTpuV2>('acceleratorConfig');
    ...
    this.dataDisks =
        registerOutput<List<AttachedDiskResponseTpuV2>>('dataDisks');
    ...
    this.networkConfig =
        registerOutput<NetworkConfigResponseTpuV2>('networkConfig');
    this.networkEndpoints =
        registerOutput<List<NetworkEndpointResponseTpuV2>>('networkEndpoints');
    ...
    this.schedulingConfig =
        registerOutput<SchedulingConfigResponseTpuV2>('schedulingConfig');
    this.serviceAccount =
        registerOutput<ServiceAccountResponseTpuV2>('serviceAccount');
    this.shieldedInstanceConfig =
        registerOutput<ShieldedInstanceConfigResponseTpuV2>(
            'shieldedInstanceConfig');
