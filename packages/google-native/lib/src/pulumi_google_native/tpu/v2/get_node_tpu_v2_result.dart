...
import 'accelerator_config_response_tpu_v2.dart';
import 'attached_disk_response_tpu_v2.dart';
import 'network_config_response_tpu_v2.dart';
import 'network_endpoint_response_tpu_v2.dart';
import 'scheduling_config_response_tpu_v2.dart';
import 'service_account_response_tpu_v2.dart';
import 'shielded_instance_config_response_tpu_v2.dart';
import 'symptom_response_tpu_v2.dart';

/// Result data returned by getNode.
class GetNodeTpuV2Result {
  /// The AccleratorConfig for the TPU Node.
  final AcceleratorConfigResponseTpuV2 acceleratorConfig;
  ...
  final List<AttachedDiskResponseTpuV2> dataDisks;
  ...
  final NetworkConfigResponseTpuV2 networkConfig;
  ...
  final ServiceAccountResponseTpuV2 serviceAccount;

  /// Shielded Instance options.
  final ShieldedInstanceConfigResponseTpuV2 shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dataDisks'] = pulumi.Input.encodeList<AttachedDiskResponseTpuV2,
    ...
    map['state'] = state;
    map['symptoms'] =
        pulumi.Input.encodeList<SymptomResponseTpuV2, Map<String, dynamic>>(
  ...
  factory GetNodeTpuV2Result.fromMap(Map<String, dynamic> map) {
    return GetNodeTpuV2Result(
      acceleratorConfig: AcceleratorConfigResponseTpuV2.fromMap(
      ...
      dataDisks: pulumi.Input.decodeList<AttachedDiskResponseTpuV2>(
          map['dataDisks'],
          (value) => AttachedDiskResponseTpuV2.fromMap(
      ...
      networkConfig: NetworkConfigResponseTpuV2.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      networkEndpoints: pulumi.Input.decodeList<NetworkEndpointResponseTpuV2>(
          map['networkEndpoints'],
          (value) => NetworkEndpointResponseTpuV2.fromMap(
              (value as Map).cast<String, dynamic>())),
      queuedResource: map['queuedResource'] as String,
      runtimeVersion: map['runtimeVersion'] as String,
      schedulingConfig: SchedulingConfigResponseTpuV2.fromMap(
          (map['schedulingConfig'] as Map).cast<String, dynamic>()),
      serviceAccount: ServiceAccountResponseTpuV2.fromMap(
          (map['serviceAccount'] as Map).cast<String, dynamic>()),
      shieldedInstanceConfig: ShieldedInstanceConfigResponseTpuV2.fromMap(
          (map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      symptoms: pulumi.Input.decodeList<SymptomResponseTpuV2>(
          map['symptoms'],
          (value) => SymptomResponseTpuV2.fromMap(
              (value as Map).cast<String, dynamic>())),
