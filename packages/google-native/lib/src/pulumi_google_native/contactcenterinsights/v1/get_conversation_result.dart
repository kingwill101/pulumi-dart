...
class GetConversationResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['agentId'] = agentId;
    map['callMetadata'] = callMetadata.toMap();
    map['createTime'] = createTime;
    map['dataSource'] = dataSource.toMap();
    map['dialogflowIntents'] = dialogflowIntents;
    map['duration'] = duration;
    map['expireTime'] = expireTime;
    map['labels'] = labels;
    map['languageCode'] = languageCode;
    map['latestAnalysis'] = latestAnalysis.toMap();
    map['latestSummary'] = latestSummary.toMap();
    map['medium'] = medium;
    map['name'] = name;
    ...
    map['transcript'] = transcript.toMap();
    map['ttl'] = ttl;
    ...
    return GetConversationResult(
      ...
      callMetadata:
          GoogleCloudContactcenterinsightsV1ConversationCallMetadataResponse
              .fromMap((map['callMetadata'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dataSource:
          GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse
              .fromMap((map['dataSource'] as Map).cast<String, dynamic>()),
      dialogflowIntents:
          (map['dialogflowIntents'] as Map).cast<String, String>(),
      ...
      latestSummary:
          GoogleCloudContactcenterinsightsV1ConversationSummarizationSuggestionDataResponse
              .fromMap((map['latestSummary'] as Map).cast<String, dynamic>()),
      ...
      transcript:
          GoogleCloudContactcenterinsightsV1ConversationTranscriptResponse
              .fromMap((map['transcript'] as Map).cast<String, dynamic>()),
