...
import 'pipeline_genomics_v1alpha2_args.dart';
...
class PipelineGenomicsV1alpha2 extends pulumi.CustomResource {
  ...
  PipelineGenomicsV1alpha2(
    String name, {
    PipelineGenomicsV1alpha2Args? args,
