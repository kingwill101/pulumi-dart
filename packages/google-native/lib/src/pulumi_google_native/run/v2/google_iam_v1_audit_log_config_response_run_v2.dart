...
class GoogleIamV1AuditLogConfigResponseRunV2 {
  ...
  GoogleIamV1AuditLogConfigResponseRunV2({
  ...
  factory GoogleIamV1AuditLogConfigResponseRunV2.fromMap(
      Map<String, dynamic> map) {
    return GoogleIamV1AuditLogConfigResponseRunV2(
