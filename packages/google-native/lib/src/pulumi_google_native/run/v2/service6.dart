...
class Service6 extends CustomResource {
  ...
  late final Output<GoogleCloudRunV2ServiceScalingResponse> scaling;
  ...
  late final Output<GoogleCloudRunV2RevisionTemplateResponse> template;
  ...
  late final Output<List<GoogleCloudRunV2TrafficTargetResponse>> traffic;

  /// Detailed status information for corresponding traffic targets. See comments in `reconciling` for additional information on reconciliation process in Cloud Run.
  late final Output<List<GoogleCloudRunV2TrafficTargetStatusResponse>>
      trafficStatuses;
