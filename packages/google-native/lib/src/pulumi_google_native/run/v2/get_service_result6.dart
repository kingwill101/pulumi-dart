...
class GetServiceResult6 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['conditions'] = Input.encodeList<GoogleCloudRunV2ConditionResponse,
    ...
    map['terminalCondition'] = terminalCondition.toMap();
    map['traffic'] = Input.encodeList<GoogleCloudRunV2TrafficTargetResponse,
        Map<String, dynamic>>(traffic, (value) => value.toMap());
    map['trafficStatuses'] = Input.encodeList<
        GoogleCloudRunV2TrafficTargetStatusResponse,
        Map<String, dynamic>>(trafficStatuses, (value) => value.toMap());
    map['uid'] = uid;
  ...
  factory GetServiceResult6.fromMap(Map<String, dynamic> map) {
    return GetServiceResult6(
      ...
      conditions: Input.decodeList<GoogleCloudRunV2ConditionResponse>(
          map['conditions'],
      ...
      traffic: Input.decodeList<GoogleCloudRunV2TrafficTargetResponse>(
          map['traffic'],
          (value) => GoogleCloudRunV2TrafficTargetResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      trafficStatuses:
          Input.decodeList<GoogleCloudRunV2TrafficTargetStatusResponse>(
              map['trafficStatuses'],
