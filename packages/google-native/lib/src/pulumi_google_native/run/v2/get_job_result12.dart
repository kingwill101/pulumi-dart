...
class GetJobResult12 {
  ...
  factory GetJobResult12.fromMap(Map<String, dynamic> map) {
    return GetJobResult12(
      ...
      latestCreatedExecution:
          GoogleCloudRunV2ExecutionReferenceResponse.fromMap(
      ...
      template: GoogleCloudRunV2ExecutionTemplateResponse.fromMap(
