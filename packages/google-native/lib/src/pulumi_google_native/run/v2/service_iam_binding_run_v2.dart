...
import 'service_iam_binding_run_v2_args.dart';

/// Sets the IAM Access control policy for the specified Service. Overwrites any existing policy.
class ServiceIamBindingRunV2 extends pulumi.CustomResource {
  ...
  ServiceIamBindingRunV2(
    String name, {
    ServiceIamBindingRunV2Args? args,
