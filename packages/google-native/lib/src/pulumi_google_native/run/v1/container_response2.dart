...
class ContainerResponse2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['args'] = args;
    map['command'] = command;
    map['env'] = Input.encodeList<EnvVarResponse, Map<String, dynamic>>(
        env, (value) => value.toMap());
    map['envFrom'] =
        Input.encodeList<EnvFromSourceResponse, Map<String, dynamic>>(
    ...
    map['name'] = name;
    map['ports'] =
        Input.encodeList<ContainerPortResponse, Map<String, dynamic>>(
    ...
    map['volumeMounts'] =
        Input.encodeList<VolumeMountResponse, Map<String, dynamic>>(
            volumeMounts, (value) => value.toMap());
    map['workingDir'] = workingDir;
    return map;
  }

  factory ContainerResponse2.fromMap(Map<String, dynamic> map) {
    return ContainerResponse2(
      args: (map['args'] as List).cast<String>(),
      command: (map['command'] as List).cast<String>(),
      env: Input.decodeList<EnvVarResponse>(
          map['env'],
          (value) =>
              EnvVarResponse.fromMap((value as Map).cast<String, dynamic>())),
      envFrom: Input.decodeList<EnvFromSourceResponse>(
          map['envFrom'],
      ...
      ports: Input.decodeList<ContainerPortResponse>(
          map['ports'],
      ...
      volumeMounts: Input.decodeList<VolumeMountResponse>(
          map['volumeMounts'],
