...
class AuditLogConfigResponseRunV1 {
  ...
  factory AuditLogConfigResponseRunV1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseRunV1(
