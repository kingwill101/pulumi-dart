...
class AuditLogConfig62 {
  ...
  factory AuditLogConfig62.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig62(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType62.fromValue(map['logType'] as String),
    );
  }
}
