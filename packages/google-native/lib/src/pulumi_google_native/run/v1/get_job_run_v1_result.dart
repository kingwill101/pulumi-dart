...
class GetJobRunV1Result {
  ...
  final JobStatusResponseRunV1 status;
  ...
  factory GetJobRunV1Result.fromMap(Map<String, dynamic> map) {
    return GetJobRunV1Result(
      ...
      status: JobStatusResponseRunV1.fromMap(
