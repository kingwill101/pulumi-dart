...
class ServiceRunV1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (specValue != null) {
      map['spec'] =
          pulumi.Input.mapOptionalInputValue<ServiceSpec, Map<String, dynamic>>(
              specValue, (value) => value.toMap());
    }
    return map;
  }

  factory ServiceRunV1Args.fromMap(Map<String, dynamic> map) {
    return ServiceRunV1Args(
      ...
      spec: pulumi.Input.asOptionalInput<ServiceSpec>(map['spec']),
    );
  }
}
