...
class AuditLogConfigRunV1 {
  ...
  factory AuditLogConfigRunV1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigRunV1(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogTypeRunV1.fromValue(map['logType'] as String),
    );
  }
}
