...
class RepositoryIamMemberArtifactregistryV1beta1Args {
  ...
  RepositoryIamMemberArtifactregistryV1beta1Args({
    this.condition,
  ...
  factory RepositoryIamMemberArtifactregistryV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return RepositoryIamMemberArtifactregistryV1beta1Args(
