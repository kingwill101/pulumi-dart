...
class RepositoryIamPolicyArgs2 {
  ...
  final Input<List<Binding6>>? bindings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding6>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding6, Map<String, dynamic>>(
  ...
  factory RepositoryIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return RepositoryIamPolicyArgs2(
      bindings: Input.asOptionalInput<List<Binding6>>(map['bindings']),
