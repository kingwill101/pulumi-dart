...
class RepositoryIamBindingArtifactregistryV1beta2Args {
  ...
  RepositoryIamBindingArtifactregistryV1beta2Args({
    this.condition,
  ...
  factory RepositoryIamBindingArtifactregistryV1beta2Args.fromMap(
      Map<String, dynamic> map) {
    return RepositoryIamBindingArtifactregistryV1beta2Args(
