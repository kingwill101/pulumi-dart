...
import 'maven_repository_config_version_policy2.dart';

/// MavenRepositoryConfig is maven related repository details. Provides additional configuration details for repositories of the maven format type.
class MavenRepositoryConfig2 {
  /// The repository with this flag will allow publishing the same snapshot versions.
  final bool? allowSnapshotOverwrites;

  /// Version policy defines the versions that the registry will accept.
  final MavenRepositoryConfigVersionPolicy2? versionPolicy;

  MavenRepositoryConfig2({
  ...
  factory MavenRepositoryConfig2.fromMap(Map<String, dynamic> map) {
    return MavenRepositoryConfig2(
      ...
      versionPolicy: map['versionPolicy'] == null
          ? null
          : MavenRepositoryConfigVersionPolicy2.fromValue(
