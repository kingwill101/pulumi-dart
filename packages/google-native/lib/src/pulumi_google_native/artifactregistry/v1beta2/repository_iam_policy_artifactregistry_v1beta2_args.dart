...
class RepositoryIamPolicyArtifactregistryV1beta2Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingArtifactregistryV1beta2>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingArtifactregistryV1beta2,
  ...
  factory RepositoryIamPolicyArtifactregistryV1beta2Args.fromMap(
    ...
    return RepositoryIamPolicyArtifactregistryV1beta2Args(
      bindings:
          pulumi.Input.asOptionalInput<List<BindingArtifactregistryV1beta2>>(
              map['bindings']),
