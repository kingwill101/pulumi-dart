...
import 'binding_response_artifactregistry_v1.dart';
...
class RepositoryIamPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<BindingResponseArtifactregistryV1>> bindings;
  ...
  RepositoryIamPolicy(
    ...
    this.bindings =
        registerOutput<List<BindingResponseArtifactregistryV1>>('bindings');
