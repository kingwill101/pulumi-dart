...
class RepositoryIamPolicyArgs {
  ...
  final Input<List<Binding5>>? bindings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding5>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding5, Map<String, dynamic>>(
  ...
  factory RepositoryIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryIamPolicyArgs(
      bindings: Input.asOptionalInput<List<Binding5>>(map['bindings']),
