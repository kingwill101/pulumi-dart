...
import 'binding_artifactregistry_v1.dart';
...
class RepositoryIamPolicyArgs {
  ...
  final pulumi.Input<List<BindingArtifactregistryV1>>? bindings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingArtifactregistryV1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingArtifactregistryV1,
  ...
  factory RepositoryIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryIamPolicyArgs(
      bindings: pulumi.Input.asOptionalInput<List<BindingArtifactregistryV1>>(
          map['bindings']),
