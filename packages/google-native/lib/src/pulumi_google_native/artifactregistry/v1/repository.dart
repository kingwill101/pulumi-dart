...
class Repository extends CustomResource {
  ...
  late final Output<Map<String, String>> cleanupPolicies;
  ...
  late final Output<DockerRepositoryConfigResponse> dockerConfig;
  ...
  late final Output<MavenRepositoryConfigResponse> mavenConfig;
  ...
  late final Output<RemoteRepositoryConfigResponse> remoteRepositoryConfig;
  ...
  late final Output<VirtualRepositoryConfigResponse> virtualRepositoryConfig;
