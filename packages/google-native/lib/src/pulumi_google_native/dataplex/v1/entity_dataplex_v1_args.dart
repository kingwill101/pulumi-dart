...
class EntityDataplexV1Args {
  ...
  factory EntityDataplexV1Args.fromMap(Map<String, dynamic> map) {
    return EntityDataplexV1Args(
      asset: pulumi.Input.asInput<String>(map['asset']),
      dataPath: pulumi.Input.asInput<String>(map['dataPath']),
      dataPathPattern:
          pulumi.Input.asOptionalInput<String>(map['dataPathPattern']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      displayName: pulumi.Input.asOptionalInput<String>(map['displayName']),
      etag: pulumi.Input.asOptionalInput<String>(map['etag']),
      format: pulumi.Input.asInput<GoogleCloudDataplexV1StorageFormat>(
          map['format']),
      id: pulumi.Input.asInput<String>(map['id']),
      lakeId: pulumi.Input.asInput<String>(map['lakeId']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      schema: pulumi.Input.asInput<GoogleCloudDataplexV1Schema>(map['schema']),
      system: pulumi.Input.asInput<EntitySystem>(map['system']),
      type: pulumi.Input.asInput<EntityType>(map['type']),
