...
import 'lake_environment_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class LakeEnvironmentIamBinding extends pulumi.CustomResource {
  ...
  LakeEnvironmentIamBinding(
    String name, {
    LakeEnvironmentIamBindingArgs? args,
