...
import 'environment_dataplex_v1_args.dart';
...
class EnvironmentDataplexV1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<GoogleCloudDataplexV1EnvironmentInfrastructureSpecResponse>
      infrastructureSpec;
  ...
  late final pulumi
      .Output<GoogleCloudDataplexV1EnvironmentSessionStatusResponse>
      sessionStatus;
  ...
  EnvironmentDataplexV1(
    String name, {
    EnvironmentDataplexV1Args? args,
