...
class EntryGroupIamMemberDataplexV1Args {
  ...
  EntryGroupIamMemberDataplexV1Args({
    this.condition,
  ...
  factory EntryGroupIamMemberDataplexV1Args.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamMemberDataplexV1Args(
