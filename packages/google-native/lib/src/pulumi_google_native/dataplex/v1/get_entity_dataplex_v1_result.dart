...
class GetEntityDataplexV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['access'] = access.toMap();
    map['asset'] = asset;
    map['catalogEntry'] = catalogEntry;
    map['compatibility'] = compatibility.toMap();
    map['createTime'] = createTime;
    map['dataPath'] = dataPath;
    map['dataPathPattern'] = dataPathPattern;
    map['description'] = description;
    map['displayName'] = displayName;
    map['etag'] = etag;
    map['format'] = format.toMap();
    map['name'] = name;
  ...
  factory GetEntityDataplexV1Result.fromMap(Map<String, dynamic> map) {
    return GetEntityDataplexV1Result(
      access: GoogleCloudDataplexV1StorageAccessResponse.fromMap(
          (map['access'] as Map).cast<String, dynamic>()),
      asset: map['asset'] as String,
      catalogEntry: map['catalogEntry'] as String,
      compatibility:
          GoogleCloudDataplexV1EntityCompatibilityStatusResponse.fromMap(
              (map['compatibility'] as Map).cast<String, dynamic>()),
      ...
      format: GoogleCloudDataplexV1StorageFormatResponse.fromMap(
          (map['format'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      schema: GoogleCloudDataplexV1SchemaResponse.fromMap(
