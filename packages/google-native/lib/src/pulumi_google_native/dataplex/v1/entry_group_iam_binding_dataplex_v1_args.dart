...
class EntryGroupIamBindingDataplexV1Args {
  ...
  EntryGroupIamBindingDataplexV1Args({
    this.condition,
  ...
  factory EntryGroupIamBindingDataplexV1Args.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamBindingDataplexV1Args(
