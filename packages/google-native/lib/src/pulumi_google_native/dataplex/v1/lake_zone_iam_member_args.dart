...
/// The set of arguments for LakeZoneIamMember.
class LakeZoneIamMemberArgs {
  ...
  factory LakeZoneIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LakeZoneIamMemberArgs(
