...
/// The set of arguments for LakeContentitemIamMember.
class LakeContentitemIamMemberArgs {
  ...
  factory LakeContentitemIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LakeContentitemIamMemberArgs(
