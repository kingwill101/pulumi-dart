...
class GetEnvironmentDataplexV1Result {
  ...
  GetEnvironmentDataplexV1Result({
  ...
  factory GetEnvironmentDataplexV1Result.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentDataplexV1Result(
