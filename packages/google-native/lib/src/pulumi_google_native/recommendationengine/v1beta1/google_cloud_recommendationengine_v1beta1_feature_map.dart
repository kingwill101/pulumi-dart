...
class GoogleCloudRecommendationengineV1beta1FeatureMap {
  ...
  Map<String, dynamic> toMap() {
    ...
    final categoricalFeaturesValue = categoricalFeatures;
    if (categoricalFeaturesValue != null) {
      map['categoricalFeatures'] = categoricalFeaturesValue;
    }
    final numericalFeaturesValue = numericalFeatures;
    if (numericalFeaturesValue != null) {
      map['numericalFeatures'] = numericalFeaturesValue;
    }
    return map;
  }

  factory GoogleCloudRecommendationengineV1beta1FeatureMap.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudRecommendationengineV1beta1FeatureMap(
      categoricalFeatures: map['categoricalFeatures'] == null
          ? null
          : (map['categoricalFeatures'] as Map).cast<String, String>(),
      numericalFeatures: map['numericalFeatures'] == null
          ? null
