...
class GetVersionIntegrationsV1alphaResult {
  ...
  GetVersionIntegrationsV1alphaResult({
  ...
  factory GetVersionIntegrationsV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetVersionIntegrationsV1alphaResult(
      cloudLoggingDetails:
