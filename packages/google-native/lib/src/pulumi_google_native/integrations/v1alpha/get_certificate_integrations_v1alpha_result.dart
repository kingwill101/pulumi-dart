...
class GetCertificateIntegrationsV1alphaResult {
  ...
  GetCertificateIntegrationsV1alphaResult({
  ...
  factory GetCertificateIntegrationsV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetCertificateIntegrationsV1alphaResult(
