...
class GoogleCloudIntegrationsV1alphaIntegrationAlertConfigResponse {
  ...
  final GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValueResponse
      thresholdValue;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['alertThreshold'] = alertThreshold;
    map['disableAlert'] = disableAlert;
    map['displayName'] = displayName;
    map['durationThreshold'] = durationThreshold;
