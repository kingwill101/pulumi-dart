...
class EnterpriseCrmEventbusProtoTaskAlertConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['aggregationPeriod'] = aggregationPeriod;
    map['alertDisabled'] = alertDisabled;
    map['alertName'] = alertName;
    map['clientId'] = clientId;
    map['durationThresholdMs'] = durationThresholdMs;
    map['errorEnumList'] = errorEnumList.toMap();
    map['metricType'] = metricType;
    map['numAggregationPeriods'] = numAggregationPeriods;
    map['onlyFinalAttempt'] = onlyFinalAttempt;
    map['playbookUrl'] = playbookUrl;
    map['thresholdType'] = thresholdType;
    map['thresholdValue'] = thresholdValue.toMap();
    map['warningEnumList'] = warningEnumList.toMap();
    return map;
  }

  factory EnterpriseCrmEventbusProtoTaskAlertConfigResponse.fromMap(
    ...
    return EnterpriseCrmEventbusProtoTaskAlertConfigResponse(
      ...
      errorEnumList:
          EnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumListResponse
              .fromMap((map['errorEnumList'] as Map).cast<String, dynamic>()),
      ...
      warningEnumList:
          EnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumListResponse
              .fromMap((map['warningEnumList'] as Map).cast<String, dynamic>()),
    );
  }
}
