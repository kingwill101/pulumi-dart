...
class GetTestCaseIntegrationsV1alphaResult {
  /// Auto-generated.
  ...
  GetTestCaseIntegrationsV1alphaResult({
  ...
  factory GetTestCaseIntegrationsV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetTestCaseIntegrationsV1alphaResult(
