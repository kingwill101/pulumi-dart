...
class GoogleCloudIntegrationsV1alphaAssertion {
  ...
  Map<String, dynamic> toMap() {
    ...
    final assertionStrategyValue = assertionStrategy;
    if (assertionStrategyValue != null) {
      map['assertionStrategy'] = assertionStrategyValue.value;
    }
    ...
    if (parameterValue != null) {
      map['parameter'] = parameterValue.toMap();
    }
