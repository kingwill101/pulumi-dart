...
class CertificateIntegrationsV1alpha extends pulumi.CustomResource {
  ...
  CertificateIntegrationsV1alpha(
    String name, {
    CertificateIntegrationsV1alphaArgs? args,
