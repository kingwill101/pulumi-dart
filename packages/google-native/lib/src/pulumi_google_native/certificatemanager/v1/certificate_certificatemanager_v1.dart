...
class CertificateCertificatemanagerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ManagedCertificateResponseCertificatemanagerV1>
      managed;
  ...
  CertificateCertificatemanagerV1(
    String name, {
    ...
    this.managed =
        registerOutput<ManagedCertificateResponseCertificatemanagerV1>(
            'managed');
