...
class ManagedCertificateResponseCertificatemanagerV1 {
  ...
  ManagedCertificateResponseCertificatemanagerV1({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['authorizationAttemptInfo'] = pulumi.Input.encodeList<
  ...
  factory ManagedCertificateResponseCertificatemanagerV1.fromMap(
      Map<String, dynamic> map) {
    return ManagedCertificateResponseCertificatemanagerV1(
