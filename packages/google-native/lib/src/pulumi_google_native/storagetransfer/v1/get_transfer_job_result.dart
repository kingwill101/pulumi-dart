...
class GetTransferJobResult {
  ...
  final LoggingConfigResponseStoragetransferV1 loggingConfig;
  ...
  final NotificationConfigResponseStoragetransferV1 notificationConfig;

  /// The ID of the Google Cloud project that owns the job.
  final String project;

  /// Specifies schedule for the transfer job. This is an optional field. When the field is not set, the job never executes a transfer, unless you invoke RunTransferJob or update the job to have a non-empty schedule.
  final ScheduleResponseStoragetransferV1 schedule;
  ...
  factory GetTransferJobResult.fromMap(Map<String, dynamic> map) {
    return GetTransferJobResult(
      ...
      loggingConfig: LoggingConfigResponseStoragetransferV1.fromMap(
          (map['loggingConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      notificationConfig: NotificationConfigResponseStoragetransferV1.fromMap(
          (map['notificationConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] as String,
      schedule: ScheduleResponseStoragetransferV1.fromMap(
