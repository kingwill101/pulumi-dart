...
class ObjectConditionsResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['excludePrefixes'] = excludePrefixes;
    map['includePrefixes'] = includePrefixes;
    map['lastModifiedBefore'] = lastModifiedBefore;
    map['lastModifiedSince'] = lastModifiedSince;
