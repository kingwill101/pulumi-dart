...
class NotificationConfigStoragetransferV1 {
  ...
  NotificationConfigStoragetransferV1({
    this.eventTypes,
  ...
  factory NotificationConfigStoragetransferV1.fromMap(
      Map<String, dynamic> map) {
    return NotificationConfigStoragetransferV1(
