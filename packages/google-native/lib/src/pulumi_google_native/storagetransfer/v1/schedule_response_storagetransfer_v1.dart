...
import 'date_response_storagetransfer_v1.dart';
import 'time_of_day_response_storagetransfer_v1.dart';

/// Transfers can be scheduled to recur or to run just once.
class ScheduleResponseStoragetransferV1 {
  /// The time in UTC that no further transfer operations are scheduled. Combined with schedule_end_date, `end_time_of_day` specifies the end date and time for starting new transfer operations. This field must be greater than or equal to the timestamp corresponding to the combintation of schedule_start_date and start_time_of_day, and is subject to the following: * If `end_time_of_day` is not set and `schedule_end_date` is set, then a default value of `23:59:59` is used for `end_time_of_day`. * If `end_time_of_day` is set and `schedule_end_date` is not set, then INVALID_ARGUMENT is returned.
  final TimeOfDayResponseStoragetransferV1 endTimeOfDay;
  ...
  final DateResponseStoragetransferV1 scheduleEndDate;
  ...
  final DateResponseStoragetransferV1 scheduleStartDate;
  ...
  final TimeOfDayResponseStoragetransferV1 startTimeOfDay;

  ScheduleResponseStoragetransferV1({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['endTimeOfDay'] = endTimeOfDay.toMap();
    map['repeatInterval'] = repeatInterval;
    map['scheduleEndDate'] = scheduleEndDate.toMap();
    map['scheduleStartDate'] = scheduleStartDate.toMap();
    map['startTimeOfDay'] = startTimeOfDay.toMap();
    return map;
  }

  factory ScheduleResponseStoragetransferV1.fromMap(Map<String, dynamic> map) {
    return ScheduleResponseStoragetransferV1(
      endTimeOfDay: TimeOfDayResponseStoragetransferV1.fromMap(
          (map['endTimeOfDay'] as Map).cast<String, dynamic>()),
      repeatInterval: map['repeatInterval'] as String,
      scheduleEndDate: DateResponseStoragetransferV1.fromMap(
          (map['scheduleEndDate'] as Map).cast<String, dynamic>()),
      scheduleStartDate: DateResponseStoragetransferV1.fromMap(
          (map['scheduleStartDate'] as Map).cast<String, dynamic>()),
      startTimeOfDay: TimeOfDayResponseStoragetransferV1.fromMap(
