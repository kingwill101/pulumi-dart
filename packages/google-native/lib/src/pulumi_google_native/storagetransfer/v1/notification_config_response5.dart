...
class NotificationConfigResponse5 {
  ...
  factory NotificationConfigResponse5.fromMap(Map<String, dynamic> map) {
    return NotificationConfigResponse5(
