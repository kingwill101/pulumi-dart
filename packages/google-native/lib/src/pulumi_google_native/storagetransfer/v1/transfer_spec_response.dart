...
class TransferSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['awsS3CompatibleDataSource'] = awsS3CompatibleDataSource.toMap();
    map['awsS3DataSource'] = awsS3DataSource.toMap();
    map['azureBlobStorageDataSource'] = azureBlobStorageDataSource.toMap();
    map['gcsDataSink'] = gcsDataSink.toMap();
    map['gcsDataSource'] = gcsDataSource.toMap();
    map['gcsIntermediateDataLocation'] = gcsIntermediateDataLocation.toMap();
    map['httpDataSource'] = httpDataSource.toMap();
    map['objectConditions'] = objectConditions.toMap();
    map['posixDataSink'] = posixDataSink.toMap();
    map['posixDataSource'] = posixDataSource.toMap();
    map['sinkAgentPoolName'] = sinkAgentPoolName;
    map['sourceAgentPoolName'] = sourceAgentPoolName;
    map['transferManifest'] = transferManifest.toMap();
    map['transferOptions'] = transferOptions.toMap();
    return map;
  }
