...
class LoggingConfig5 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (logActionStatesValue != null) {
      map['logActionStates'] =
          Input.encodeList<LoggingConfigLogActionStatesItem, String>(
              logActionStatesValue, (value) => value.value);
    }
    final logActionsValue = logActions;
    if (logActionsValue != null) {
      map['logActions'] = Input.encodeList<LoggingConfigLogActionsItem, String>(
          logActionsValue, (value) => value.value);
    }
    return map;
  }

  factory LoggingConfig5.fromMap(Map<String, dynamic> map) {
    return LoggingConfig5(
      ...
      logActionStates: map['logActionStates'] == null
          ? null
          : Input.decodeList<LoggingConfigLogActionStatesItem>(
              map['logActionStates'],
              (value) =>
                  LoggingConfigLogActionStatesItem.fromValue(value as String)),
      logActions: map['logActions'] == null
          ? null
          : Input.decodeList<LoggingConfigLogActionsItem>(
              map['logActions'],
              (value) =>
