...
class GetInstanceResult17 {
  ...
  final List<InstanceMessageResponse2> instanceMessages;
  ...
  final MaintenanceScheduleResponse3 maintenanceSchedule;
  ...
  final List<NodeResponse5> memcacheNodes;
  ...
  final NodeConfigResponse7 nodeConfig;

  /// Number of nodes in the Memcached instance.
  final int nodeCount;

  /// User defined parameters to apply to the memcached process on each node.
  final MemcacheParametersResponse2 parameters;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['instanceMessages'] =
        Input.encodeList<InstanceMessageResponse2, Map<String, dynamic>>(
    ...
    map['memcacheNodes'] =
        Input.encodeList<NodeResponse5, Map<String, dynamic>>(
  ...
  factory GetInstanceResult17.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult17(
      authorizedNetwork: map['authorizedNetwork'] as String,
      createTime: map['createTime'] as String,
      discoveryEndpoint: map['discoveryEndpoint'] as String,
      displayName: map['displayName'] as String,
      instanceMessages: Input.decodeList<InstanceMessageResponse2>(
          map['instanceMessages'],
          (value) => InstanceMessageResponse2.fromMap(
      ...
      maintenanceSchedule: MaintenanceScheduleResponse3.fromMap(
          (map['maintenanceSchedule'] as Map).cast<String, dynamic>()),
      memcacheFullVersion: map['memcacheFullVersion'] as String,
      memcacheNodes: Input.decodeList<NodeResponse5>(
          map['memcacheNodes'],
          (value) =>
              NodeResponse5.fromMap((value as Map).cast<String, dynamic>())),
      memcacheVersion: map['memcacheVersion'] as String,
      name: map['name'] as String,
      nodeConfig: NodeConfigResponse7.fromMap(
          (map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      parameters: MemcacheParametersResponse2.fromMap(
