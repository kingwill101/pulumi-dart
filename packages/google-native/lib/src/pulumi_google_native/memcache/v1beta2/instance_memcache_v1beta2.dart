...
class InstanceMemcacheV1beta2 extends pulumi.CustomResource {
  ...
  InstanceMemcacheV1beta2(
    ...
    this.memcacheNodes =
        registerOutput<List<NodeResponseMemcacheV1beta2>>('memcacheNodes');
    this.memcacheVersion = registerOutput<String>('memcacheVersion');
    this.name = registerOutput<String>('name');
    this.nodeConfig =
        registerOutput<NodeConfigResponseMemcacheV1beta2>('nodeConfig');
    this.nodeCount = registerOutput<int>('nodeCount');
    this.parameters =
        registerOutput<MemcacheParametersResponseMemcacheV1beta2>('parameters');
