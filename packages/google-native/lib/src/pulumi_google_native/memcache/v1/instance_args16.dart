...
class InstanceArgs16 {
  ...
  final Input<List<InstanceMessage>>? instanceMessages;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (instanceMessagesValue != null) {
      map['instanceMessages'] = Input.mapOptionalInputValue<
              List<InstanceMessage>, List<Map<String, dynamic>>>(
          instanceMessagesValue,
          (value) => Input.encodeList<InstanceMessage, Map<String, dynamic>>(
    ...
    if (maintenancePolicyValue != null) {
      map['maintenancePolicy'] = Input.mapOptionalInputValue<
              GoogleCloudMemcacheV1MaintenancePolicy, Map<String, dynamic>>(
          maintenancePolicyValue, (value) => value.toMap());
    }
    final memcacheVersionValue = memcacheVersion;
    if (memcacheVersionValue != null) {
      map['memcacheVersion'] =
          Input.mapOptionalInputValue<InstanceMemcacheVersion, String>(
    ...
    map['nodeConfig'] = Input.mapInputValue<NodeConfig6, Map<String, dynamic>>(
        nodeConfig, (value) => value.toMap());
    map['nodeCount'] = nodeCount;
    final parametersValue = parameters;
    if (parametersValue != null) {
      map['parameters'] =
          Input.mapOptionalInputValue<MemcacheParameters, Map<String, dynamic>>(
  ...
  factory InstanceArgs16.fromMap(Map<String, dynamic> map) {
    return InstanceArgs16(
      ...
      instanceMessages:
          Input.asOptionalInput<List<InstanceMessage>>(map['instanceMessages']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      maintenancePolicy:
          Input.asOptionalInput<GoogleCloudMemcacheV1MaintenancePolicy>(
              map['maintenancePolicy']),
      memcacheVersion: Input.asOptionalInput<InstanceMemcacheVersion>(
          map['memcacheVersion']),
      name: Input.asOptionalInput<String>(map['name']),
      nodeConfig: Input.asInput<NodeConfig6>(map['nodeConfig']),
      nodeCount: Input.asInput<int>(map['nodeCount']),
      parameters: Input.asOptionalInput<MemcacheParameters>(map['parameters']),
