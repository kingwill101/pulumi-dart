...
import 'instance_memcache_v1_args.dart';
import 'instance_message_response.dart';
import 'maintenance_schedule_response_memcache_v1.dart';
import 'memcache_parameters_response.dart';
import 'node_config_response_memcache_v1.dart';
import 'node_response_memcache_v1.dart';

/// Creates a new Instance in a given location.
class InstanceMemcacheV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InstanceMessageResponse>> instanceMessages;
  ...
  late final pulumi.Output<MaintenanceScheduleResponseMemcacheV1>
      maintenanceSchedule;
  ...
  late final pulumi.Output<List<NodeResponseMemcacheV1>> memcacheNodes;
  ...
  late final pulumi.Output<NodeConfigResponseMemcacheV1> nodeConfig;
  ...
  InstanceMemcacheV1(
    ...
    this.instanceMessages =
        registerOutput<List<InstanceMessageResponse>>('instanceMessages');
    ...
    this.maintenanceSchedule =
        registerOutput<MaintenanceScheduleResponseMemcacheV1>(
            'maintenanceSchedule');
    this.memcacheFullVersion = registerOutput<String>('memcacheFullVersion');
    this.memcacheNodes =
        registerOutput<List<NodeResponseMemcacheV1>>('memcacheNodes');
    this.memcacheVersion = registerOutput<String>('memcacheVersion');
    this.name = registerOutput<String>('name');
    this.nodeConfig =
        registerOutput<NodeConfigResponseMemcacheV1>('nodeConfig');
    this.nodeCount = registerOutput<int>('nodeCount');
    this.parameters = registerOutput<MemcacheParametersResponse>('parameters');
