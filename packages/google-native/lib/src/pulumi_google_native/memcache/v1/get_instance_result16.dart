...
class GetInstanceResult16 {
  ...
  final MaintenanceScheduleResponse2 maintenanceSchedule;
  ...
  final List<NodeResponse4> memcacheNodes;
  ...
  final NodeConfigResponse6 nodeConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['instanceMessages'] =
        Input.encodeList<InstanceMessageResponse, Map<String, dynamic>>(
    ...
    map['memcacheNodes'] =
        Input.encodeList<NodeResponse4, Map<String, dynamic>>(
  ...
  factory GetInstanceResult16.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult16(
      authorizedNetwork: map['authorizedNetwork'] as String,
      createTime: map['createTime'] as String,
      discoveryEndpoint: map['discoveryEndpoint'] as String,
      displayName: map['displayName'] as String,
      instanceMessages: Input.decodeList<InstanceMessageResponse>(
          map['instanceMessages'],
      ...
      maintenanceSchedule: MaintenanceScheduleResponse2.fromMap(
          (map['maintenanceSchedule'] as Map).cast<String, dynamic>()),
      memcacheFullVersion: map['memcacheFullVersion'] as String,
      memcacheNodes: Input.decodeList<NodeResponse4>(
          map['memcacheNodes'],
          (value) =>
              NodeResponse4.fromMap((value as Map).cast<String, dynamic>())),
      memcacheVersion: map['memcacheVersion'] as String,
      name: map['name'] as String,
      nodeConfig: NodeConfigResponse6.fromMap(
