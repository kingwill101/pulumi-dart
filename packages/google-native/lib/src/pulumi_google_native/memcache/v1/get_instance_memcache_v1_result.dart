...
class GetInstanceMemcacheV1Result {
  ...
  final MaintenanceScheduleResponseMemcacheV1 maintenanceSchedule;
  ...
  final List<NodeResponseMemcacheV1> memcacheNodes;
  ...
  final NodeConfigResponseMemcacheV1 nodeConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['memcacheNodes'] =
        pulumi.Input.encodeList<NodeResponseMemcacheV1, Map<String, dynamic>>(
  ...
  factory GetInstanceMemcacheV1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceMemcacheV1Result(
      ...
      maintenanceSchedule: MaintenanceScheduleResponseMemcacheV1.fromMap(
          (map['maintenanceSchedule'] as Map).cast<String, dynamic>()),
      memcacheFullVersion: map['memcacheFullVersion'] as String,
      memcacheNodes: pulumi.Input.decodeList<NodeResponseMemcacheV1>(
          map['memcacheNodes'],
          (value) => NodeResponseMemcacheV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      memcacheVersion: map['memcacheVersion'] as String,
      name: map['name'] as String,
      nodeConfig: NodeConfigResponseMemcacheV1.fromMap(
