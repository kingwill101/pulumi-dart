...
class AuditLogConfig25 {
  ...
  factory AuditLogConfig25.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig25(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType25.fromValue(map['logType'] as String),
    );
  }
}
