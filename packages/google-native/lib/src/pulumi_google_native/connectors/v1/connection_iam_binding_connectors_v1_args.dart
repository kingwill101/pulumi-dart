...
class ConnectionIamBindingConnectorsV1Args {
  ...
  ConnectionIamBindingConnectorsV1Args({
    this.condition,
  ...
  factory ConnectionIamBindingConnectorsV1Args.fromMap(
      Map<String, dynamic> map) {
    return ConnectionIamBindingConnectorsV1Args(
