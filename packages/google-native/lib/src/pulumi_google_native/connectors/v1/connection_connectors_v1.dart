...
import 'connection_connectors_v1_args.dart';
...
import 'node_config_response_connectors_v1.dart';
import 'ssl_config_response_connectors_v1.dart';

/// Creates a new Connection in a given project and location.
/// Auto-naming is currently not supported for this resource.
class ConnectionConnectorsV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NodeConfigResponseConnectorsV1> nodeConfig;
  ...
  late final pulumi.Output<SslConfigResponseConnectorsV1> sslConfig;
  ...
  ConnectionConnectorsV1(
    String name, {
    ConnectionConnectorsV1Args? args,
    ...
    this.nodeConfig =
        registerOutput<NodeConfigResponseConnectorsV1>('nodeConfig');
    this.project = registerOutput<String>('project');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.serviceDirectory = registerOutput<String>('serviceDirectory');
    this.sslConfig = registerOutput<SslConfigResponseConnectorsV1>('sslConfig');
