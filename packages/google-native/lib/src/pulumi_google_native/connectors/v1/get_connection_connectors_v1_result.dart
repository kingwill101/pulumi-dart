...
class GetConnectionConnectorsV1Result {
  ...
  final NodeConfigResponseConnectorsV1 nodeConfig;
  ...
  final SslConfigResponseConnectorsV1 sslConfig;
  ...
  GetConnectionConnectorsV1Result({
  ...
  factory GetConnectionConnectorsV1Result.fromMap(Map<String, dynamic> map) {
    return GetConnectionConnectorsV1Result(
      ...
      nodeConfig: NodeConfigResponseConnectorsV1.fromMap(
          (map['nodeConfig'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      serviceDirectory: map['serviceDirectory'] as String,
      sslConfig: SslConfigResponseConnectorsV1.fromMap(
