...
class GetEndpointAttachmentConnectorsV1Result {
  /// Created time.
  ...
  GetEndpointAttachmentConnectorsV1Result({
  ...
  factory GetEndpointAttachmentConnectorsV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetEndpointAttachmentConnectorsV1Result(
