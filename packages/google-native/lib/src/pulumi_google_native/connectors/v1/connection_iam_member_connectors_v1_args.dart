...
class ConnectionIamMemberConnectorsV1Args {
  ...
  ConnectionIamMemberConnectorsV1Args({
    this.condition,
  ...
  factory ConnectionIamMemberConnectorsV1Args.fromMap(
      Map<String, dynamic> map) {
    return ConnectionIamMemberConnectorsV1Args(
