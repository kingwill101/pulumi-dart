...
class GetWorkerPoolRemotebuildexecutionV1alphaResult {
  ...
  GetWorkerPoolRemotebuildexecutionV1alphaResult({
  ...
  factory GetWorkerPoolRemotebuildexecutionV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetWorkerPoolRemotebuildexecutionV1alphaResult(
