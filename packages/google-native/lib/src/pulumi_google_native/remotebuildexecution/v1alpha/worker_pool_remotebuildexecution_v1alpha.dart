...
import 'worker_pool_remotebuildexecution_v1alpha_args.dart';
...
class WorkerPoolRemotebuildexecutionV1alpha extends pulumi.CustomResource {
  ...
  WorkerPoolRemotebuildexecutionV1alpha(
    String name, {
    WorkerPoolRemotebuildexecutionV1alphaArgs? args,
