...
class GetInstanceRemotebuildexecutionV1alphaResult {
  ...
  GetInstanceRemotebuildexecutionV1alphaResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['featurePolicy'] = featurePolicy.toMap();
  ...
  factory GetInstanceRemotebuildexecutionV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetInstanceRemotebuildexecutionV1alphaResult(
      featurePolicy:
          GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyResponse
              .fromMap((map['featurePolicy'] as Map).cast<String, dynamic>()),
