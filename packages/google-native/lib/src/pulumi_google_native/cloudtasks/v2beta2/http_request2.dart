...
import 'http_request_http_method2.dart';
...
class HttpRequest2 {
  ...
  final HttpRequestHttpMethod2? httpMethod;
  ...
  factory HttpRequest2.fromMap(Map<String, dynamic> map) {
    return HttpRequest2(
      ...
      httpMethod: map['httpMethod'] == null
          ? null
          : HttpRequestHttpMethod2.fromValue(map['httpMethod'] as String),
