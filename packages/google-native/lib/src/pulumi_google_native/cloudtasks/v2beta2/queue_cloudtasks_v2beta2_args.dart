...
import 'app_engine_http_target_cloudtasks_v2beta2.dart';
...
class QueueCloudtasksV2beta2Args {
  ...
  final pulumi.Input<AppEngineHttpTargetCloudtasksV2beta2>? appEngineHttpTarget;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (appEngineHttpTargetValue != null) {
      map['appEngineHttpTarget'] = pulumi.Input.mapOptionalInputValue<
              AppEngineHttpTargetCloudtasksV2beta2, Map<String, dynamic>>(
  ...
  factory QueueCloudtasksV2beta2Args.fromMap(Map<String, dynamic> map) {
    return QueueCloudtasksV2beta2Args(
      appEngineHttpTarget:
          pulumi.Input.asOptionalInput<AppEngineHttpTargetCloudtasksV2beta2>(
      ...
      pullTarget:
          pulumi.Input.asOptionalInput<Map<String, dynamic>>(map['pullTarget']),
