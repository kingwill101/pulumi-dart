...
import 'app_engine_http_request_http_method_cloudtasks_v2beta2.dart';
...
class AppEngineHttpRequestCloudtasksV2beta2 {
  ...
  final AppEngineRoutingCloudtasksV2beta2? appEngineRouting;
  ...
  final AppEngineHttpRequestHttpMethodCloudtasksV2beta2? httpMethod;
  ...
  Map<String, dynamic> toMap() {
    ...
    final relativeUrlValue = relativeUrl;
    if (relativeUrlValue != null) {
      map['relativeUrl'] = relativeUrlValue;
    }
    return map;
  }
  ...
  factory AppEngineHttpRequestCloudtasksV2beta2.fromMap(
    ...
    return AppEngineHttpRequestCloudtasksV2beta2(
      ...
      relativeUrl:
          map['relativeUrl'] == null ? null : map['relativeUrl'] as String,
    );
  }
}
