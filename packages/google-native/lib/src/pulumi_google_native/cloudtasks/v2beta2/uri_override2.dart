...
import 'path_override2.dart';
import 'query_override2.dart';
import 'uri_override_scheme2.dart';
import 'uri_override_uri_override_enforce_mode2.dart';
...
class UriOverride2 {
  ...
  final PathOverride2? pathOverride;
  ...
  final QueryOverride2? queryOverride;

  /// Scheme override. When specified, the task URI scheme is replaced by the provided value (HTTP or HTTPS).
  final UriOverrideScheme2? scheme;

  /// URI Override Enforce Mode When specified, determines the Target UriOverride mode. If not specified, it defaults to ALWAYS.
  final UriOverrideUriOverrideEnforceMode2? uriOverrideEnforceMode;
