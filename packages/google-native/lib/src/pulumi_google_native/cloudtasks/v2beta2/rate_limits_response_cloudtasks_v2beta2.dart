...
class RateLimitsResponseCloudtasksV2beta2 {
  ...
  RateLimitsResponseCloudtasksV2beta2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['maxTasksDispatchedPerSecond'] = maxTasksDispatchedPerSecond;
    return map;
  }

  factory RateLimitsResponseCloudtasksV2beta2.fromMap(
      Map<String, dynamic> map) {
    return RateLimitsResponseCloudtasksV2beta2(
      maxBurstSize: map['maxBurstSize'] as int,
      maxConcurrentTasks: map['maxConcurrentTasks'] as int,
      maxTasksDispatchedPerSecond: map['maxTasksDispatchedPerSecond'] as double,
    );
  }
}
