...
class RetryConfigResponse4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['unlimitedAttempts'] = unlimitedAttempts;
    return map;
  }

  factory RetryConfigResponse4.fromMap(Map<String, dynamic> map) {
    return RetryConfigResponse4(
