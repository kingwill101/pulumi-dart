...
import 'app_engine_http_request_http_method2.dart';
...
class AppEngineHttpRequest2 {
  ...
  final AppEngineRouting4? appEngineRouting;
  ...
  final AppEngineHttpRequestHttpMethod2? httpMethod;
  ...
  factory AppEngineHttpRequest2.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequest2(
      ...
      httpMethod: map['httpMethod'] == null
          ? null
          : AppEngineHttpRequestHttpMethod2.fromValue(
