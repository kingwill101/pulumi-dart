...
class RateLimitsCloudtasksV2beta2 {
  ...
  final double? maxTasksDispatchedPerSecond;

  RateLimitsCloudtasksV2beta2({
    this.maxBurstSize,
    this.maxConcurrentTasks,
    this.maxTasksDispatchedPerSecond,
  });
  ...
  Map<String, dynamic> toMap() {
    ...
    final maxConcurrentTasksValue = maxConcurrentTasks;
    if (maxConcurrentTasksValue != null) {
      map['maxConcurrentTasks'] = maxConcurrentTasksValue;
    }
    final maxTasksDispatchedPerSecondValue = maxTasksDispatchedPerSecond;
    if (maxTasksDispatchedPerSecondValue != null) {
      map['maxTasksDispatchedPerSecond'] = maxTasksDispatchedPerSecondValue;
    }
    return map;
  }
  ...
  factory RateLimitsCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return RateLimitsCloudtasksV2beta2(
      ...
      maxConcurrentTasks: map['maxConcurrentTasks'] == null
          ? null
          : map['maxConcurrentTasks'] as int,
      maxTasksDispatchedPerSecond: map['maxTasksDispatchedPerSecond'] == null
          ? null
          : map['maxTasksDispatchedPerSecond'] as double,
    );
  }
}
