...
class AppEngineHttpRequestResponse2 {
  ...
  final AppEngineRoutingResponse4 appEngineRouting;
  ...
  factory AppEngineHttpRequestResponse2.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequestResponse2(
      appEngineRouting: AppEngineRoutingResponse4.fromMap(
