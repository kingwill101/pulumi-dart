...
import 'app_engine_http_target_response3.dart';
import 'http_target_response4.dart';
import 'queue_args2.dart';
import 'queue_stats_response.dart';
import 'rate_limits_response2.dart';
import 'retry_config_response4.dart';
...
class Queue2 extends CustomResource {
  ...
  late final Output<AppEngineHttpTargetResponse3> appEngineHttpTarget;

  /// An http_target is used to override the target values for HTTP tasks.
  late final Output<HttpTargetResponse4> httpTarget;
  ...
  late final Output<Map<String, dynamic>> pullTarget;
  ...
  late final Output<String> tombstoneTtl;
