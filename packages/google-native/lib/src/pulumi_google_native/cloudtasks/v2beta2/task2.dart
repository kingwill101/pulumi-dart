...
class Task2 extends CustomResource {
  ...
  late final Output<AppEngineHttpRequestResponse2> appEngineHttpRequest;

  /// The time that the task was created. `create_time` will be truncated to the nearest second.
  late final Output<String> createTime;

  /// HTTP request that is sent to the task's target. An HTTP task is a task that has HttpRequest set.
  late final Output<HttpRequestResponse2> httpRequest;
  ...
  late final Output<PullMessageResponse> pullMessage;
  ...
  /// The task status.
  late final Output<TaskStatusResponse> status;
