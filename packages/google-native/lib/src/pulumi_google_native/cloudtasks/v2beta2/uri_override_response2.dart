...
import 'path_override_response2.dart';
import 'query_override_response2.dart';

/// Uri Override. When specified, all the HTTP tasks inside the queue will be partially or fully overridden depending on the configured values.
class UriOverrideResponse2 {
  ...
  final PathOverrideResponse2 pathOverride;
  ...
  final QueryOverrideResponse2 queryOverride;
  ...
  factory UriOverrideResponse2.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponse2(
      host: map['host'] as String,
      pathOverride: PathOverrideResponse2.fromMap(
          (map['pathOverride'] as Map).cast<String, dynamic>()),
      port: map['port'] as String,
      queryOverride: QueryOverrideResponse2.fromMap(
