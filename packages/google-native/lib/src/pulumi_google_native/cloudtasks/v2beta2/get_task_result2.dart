...
import 'app_engine_http_request_response2.dart';
import 'http_request_response2.dart';
import 'pull_message_response.dart';
import 'task_status_response.dart';

/// Result data returned by getTask.
class GetTaskResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['appEngineHttpRequest'] = appEngineHttpRequest.toMap();
    map['createTime'] = createTime;
    map['httpRequest'] = httpRequest.toMap();
    map['name'] = name;
    map['pullMessage'] = pullMessage.toMap();
  ...
  factory GetTaskResult2.fromMap(Map<String, dynamic> map) {
    return GetTaskResult2(
      appEngineHttpRequest: AppEngineHttpRequestResponse2.fromMap(
          (map['appEngineHttpRequest'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      httpRequest: HttpRequestResponse2.fromMap(
          (map['httpRequest'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      pullMessage: PullMessageResponse.fromMap(
          (map['pullMessage'] as Map).cast<String, dynamic>()),
      scheduleTime: map['scheduleTime'] as String,
      status: TaskStatusResponse.fromMap(
