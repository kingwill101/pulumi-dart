...
class RetryConfigCloudtasksV2beta2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    final unlimitedAttemptsValue = unlimitedAttempts;
    if (unlimitedAttemptsValue != null) {
      map['unlimitedAttempts'] = unlimitedAttemptsValue;
    }
    return map;
  }

  factory RetryConfigCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return RetryConfigCloudtasksV2beta2(
      maxAttempts:
      ...
      unlimitedAttempts: map['unlimitedAttempts'] == null
          ? null
          : map['unlimitedAttempts'] as bool,
    );
  }
}
