...
class GetQueueResult2 {
  ...
  final AppEngineHttpTargetResponse3 appEngineHttpTarget;

  /// An http_target is used to override the target values for HTTP tasks.
  final HttpTargetResponse4 httpTarget;
  ...
  factory GetQueueResult2.fromMap(Map<String, dynamic> map) {
    return GetQueueResult2(
      appEngineHttpTarget: AppEngineHttpTargetResponse3.fromMap(
          (map['appEngineHttpTarget'] as Map).cast<String, dynamic>()),
      httpTarget: HttpTargetResponse4.fromMap(
      ...
      rateLimits: RateLimitsResponse2.fromMap(
          (map['rateLimits'] as Map).cast<String, dynamic>()),
      retryConfig: RetryConfigResponse4.fromMap(
