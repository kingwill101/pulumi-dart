...
class AppEngineRoutingResponseCloudtasksV2 {
  ...
  AppEngineRoutingResponseCloudtasksV2({
    required this.host,
  ...
  factory AppEngineRoutingResponseCloudtasksV2.fromMap(
      Map<String, dynamic> map) {
    return AppEngineRoutingResponseCloudtasksV2(
