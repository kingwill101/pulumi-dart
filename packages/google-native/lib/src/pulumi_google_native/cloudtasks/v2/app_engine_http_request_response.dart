...
class AppEngineHttpRequestResponse {
  ...
  final AppEngineRoutingResponseCloudtasksV2 appEngineRouting;
  ...
  factory AppEngineHttpRequestResponse.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequestResponse(
      appEngineRouting: AppEngineRoutingResponseCloudtasksV2.fromMap(
