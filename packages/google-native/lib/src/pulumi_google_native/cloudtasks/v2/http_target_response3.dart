...
import 'oauth_token_response3.dart';
import 'oidc_token_response3.dart';
import 'uri_override_response.dart';

/// HTTP target. When specified as a Queue, all the tasks with [HttpRequest] will be overridden according to the target.
class HttpTargetResponse3 {
  ...
  final OAuthTokenResponse3 oauthToken;

  /// If specified, an [OIDC](https://developers.google.com/identity/protocols/OpenIDConnect) token will be generated and attached as an `Authorization` header in the HTTP request. This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself.
  final OidcTokenResponse3 oidcToken;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['headerOverrides'] =
        Input.encodeList<HeaderOverrideResponse, Map<String, dynamic>>(
  ...
  factory HttpTargetResponse3.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponse3(
      headerOverrides: Input.decodeList<HeaderOverrideResponse>(
          map['headerOverrides'],
          (value) => HeaderOverrideResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      httpMethod: map['httpMethod'] as String,
      oauthToken: OAuthTokenResponse3.fromMap(
          (map['oauthToken'] as Map).cast<String, dynamic>()),
      oidcToken: OidcTokenResponse3.fromMap(
