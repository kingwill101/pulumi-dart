...
class RetryConfigResponseCloudtasksV2 {
  ...
  RetryConfigResponseCloudtasksV2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['maxBackoff'] = maxBackoff;
    map['maxDoublings'] = maxDoublings;
    map['maxRetryDuration'] = maxRetryDuration;
    map['minBackoff'] = minBackoff;
    return map;
  }

  factory RetryConfigResponseCloudtasksV2.fromMap(Map<String, dynamic> map) {
    return RetryConfigResponseCloudtasksV2(
