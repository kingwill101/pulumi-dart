...
class UriOverrideResponse {
  ...
  final PathOverrideResponse pathOverride;
  ...
  final QueryOverrideResponse queryOverride;
  ...
  factory UriOverrideResponse.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponse(
      ...
      pathOverride: PathOverrideResponse.fromMap(
          (map['pathOverride'] as Map).cast<String, dynamic>()),
      port: map['port'] as String,
      queryOverride: QueryOverrideResponse.fromMap(
