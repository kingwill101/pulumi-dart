...
class OidcTokenResponseCloudtasksV2 {
  ...
  factory OidcTokenResponseCloudtasksV2.fromMap(Map<String, dynamic> map) {
    return OidcTokenResponseCloudtasksV2(
