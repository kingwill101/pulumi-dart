...
import 'http_target_http_method3.dart';
import 'oauth_token3.dart';
import 'oidc_token3.dart';
...
class HttpTarget3 {
  ...
  final HttpTargetHttpMethod3? httpMethod;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headerOverridesValue != null) {
      map['headerOverrides'] =
          Input.encodeList<HeaderOverride, Map<String, dynamic>>(
  ...
  factory HttpTarget3.fromMap(Map<String, dynamic> map) {
    return HttpTarget3(
      headerOverrides: map['headerOverrides'] == null
          ? null
          : Input.decodeList<HeaderOverride>(
              map['headerOverrides'],
              (value) => HeaderOverride.fromMap(
                  (value as Map).cast<String, dynamic>())),
      httpMethod: map['httpMethod'] == null
          ? null
          : HttpTargetHttpMethod3.fromValue(map['httpMethod'] as String),
