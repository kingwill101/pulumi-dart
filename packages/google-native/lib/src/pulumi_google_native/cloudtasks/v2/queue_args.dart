...
import 'app_engine_routing_cloudtasks_v2.dart';
import 'http_target_cloudtasks_v2.dart';
import 'rate_limits.dart';
import 'retry_config_cloudtasks_v2.dart';
...
class QueueArgs {
  ...
  final pulumi.Input<AppEngineRoutingCloudtasksV2>? appEngineRoutingOverride;

  /// Modifies HTTP target for HTTP tasks.
  final pulumi.Input<HttpTargetCloudtasksV2>? httpTarget;
  ...
  final pulumi.Input<RetryConfigCloudtasksV2>? retryConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (appEngineRoutingOverrideValue != null) {
      map['appEngineRoutingOverride'] = pulumi.Input.mapOptionalInputValue<
              AppEngineRoutingCloudtasksV2, Map<String, dynamic>>(
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      appEngineRoutingOverride:
          pulumi.Input.asOptionalInput<AppEngineRoutingCloudtasksV2>(
              map['appEngineRoutingOverride']),
      httpTarget: pulumi.Input.asOptionalInput<HttpTargetCloudtasksV2>(
          map['httpTarget']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      rateLimits: pulumi.Input.asOptionalInput<RateLimits>(map['rateLimits']),
      retryConfig: pulumi.Input.asOptionalInput<RetryConfigCloudtasksV2>(
          map['retryConfig']),
