...
class OAuthTokenResponseCloudtasksV2 {
  ...
  OAuthTokenResponseCloudtasksV2({
    required this.scope,
  ...
  factory OAuthTokenResponseCloudtasksV2.fromMap(Map<String, dynamic> map) {
    return OAuthTokenResponseCloudtasksV2(
