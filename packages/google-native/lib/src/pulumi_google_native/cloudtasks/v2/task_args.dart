...
class TaskArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (httpRequestValue != null) {
      map['httpRequest'] =
          pulumi.Input.mapOptionalInputValue<HttpRequest, Map<String, dynamic>>(
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      appEngineHttpRequest: pulumi.Input.asOptionalInput<AppEngineHttpRequest>(
          map['appEngineHttpRequest']),
      dispatchDeadline:
          pulumi.Input.asOptionalInput<String>(map['dispatchDeadline']),
      httpRequest:
          pulumi.Input.asOptionalInput<HttpRequest>(map['httpRequest']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      queueId: pulumi.Input.asInput<String>(map['queueId']),
      responseView:
          pulumi.Input.asOptionalInput<TaskResponseView>(map['responseView']),
