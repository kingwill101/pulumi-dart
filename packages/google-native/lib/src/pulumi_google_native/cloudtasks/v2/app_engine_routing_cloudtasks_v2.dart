...
class AppEngineRoutingCloudtasksV2 {
  ...
  factory AppEngineRoutingCloudtasksV2.fromMap(Map<String, dynamic> map) {
    return AppEngineRoutingCloudtasksV2(
