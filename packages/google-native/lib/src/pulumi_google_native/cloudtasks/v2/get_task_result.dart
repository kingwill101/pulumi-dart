...
class GetTaskResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dispatchCount'] = dispatchCount;
    map['dispatchDeadline'] = dispatchDeadline;
    map['firstAttempt'] = firstAttempt.toMap();
    map['httpRequest'] = httpRequest.toMap();
    map['lastAttempt'] = lastAttempt.toMap();
    map['name'] = name;
    map['responseCount'] = responseCount;
