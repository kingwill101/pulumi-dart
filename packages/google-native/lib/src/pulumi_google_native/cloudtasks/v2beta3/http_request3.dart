...
import 'http_request_http_method3.dart';
...
class HttpRequest3 {
  ...
  final HttpRequestHttpMethod3? httpMethod;
  ...
  factory HttpRequest3.fromMap(Map<String, dynamic> map) {
    return HttpRequest3(
      ...
      httpMethod: map['httpMethod'] == null
          ? null
          : HttpRequestHttpMethod3.fromValue(map['httpMethod'] as String),
