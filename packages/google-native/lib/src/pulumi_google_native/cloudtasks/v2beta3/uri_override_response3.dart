...
import 'path_override_response3.dart';
import 'query_override_response3.dart';

/// URI Override. When specified, all the HTTP tasks inside the queue will be partially or fully overridden depending on the configured values.
class UriOverrideResponse3 {
  ...
  final PathOverrideResponse3 pathOverride;
  ...
  final QueryOverrideResponse3 queryOverride;
  ...
  factory UriOverrideResponse3.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponse3(
      host: map['host'] as String,
      pathOverride: PathOverrideResponse3.fromMap(
          (map['pathOverride'] as Map).cast<String, dynamic>()),
      port: map['port'] as String,
      queryOverride: QueryOverrideResponse3.fromMap(
