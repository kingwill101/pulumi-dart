...
import 'app_engine_http_request_http_method3.dart';
import 'app_engine_routing5.dart';
...
class AppEngineHttpRequest3 {
  ...
  final AppEngineRouting5? appEngineRouting;
  ...
  final AppEngineHttpRequestHttpMethod3? httpMethod;

  /// The relative URI. The relative URI must begin with "/" and must be a valid HTTP relative URI. It can contain a path and query string arguments. If the relative URI is empty, then the root path "/" will be used. No spaces are allowed, and the maximum length allowed is 2083 characters.
  final String? relativeUri;

  AppEngineHttpRequest3({
  ...
  factory AppEngineHttpRequest3.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequest3(
      appEngineRouting: map['appEngineRouting'] == null
          ? null
          : AppEngineRouting5.fromMap(
      ...
      httpMethod: map['httpMethod'] == null
          ? null
          : AppEngineHttpRequestHttpMethod3.fromValue(
