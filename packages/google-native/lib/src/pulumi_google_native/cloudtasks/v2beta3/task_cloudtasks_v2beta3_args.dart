...
class TaskCloudtasksV2beta3Args {
  ...
  factory TaskCloudtasksV2beta3Args.fromMap(Map<String, dynamic> map) {
    return TaskCloudtasksV2beta3Args(
      ...
      dispatchDeadline:
          pulumi.Input.asOptionalInput<String>(map['dispatchDeadline']),
      httpRequest: pulumi.Input.asOptionalInput<HttpRequestCloudtasksV2beta3>(
          map['httpRequest']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      pullMessage: pulumi.Input.asOptionalInput<PullMessageCloudtasksV2beta3>(
          map['pullMessage']),
