...
import 'status_response9.dart';

/// The status of a task attempt.
class AttemptResponse2 {
  ...
  final StatusResponse9 responseStatus;
  ...
  factory AttemptResponse2.fromMap(Map<String, dynamic> map) {
    return AttemptResponse2(
      dispatchTime: map['dispatchTime'] as String,
      responseStatus: StatusResponse9.fromMap(
