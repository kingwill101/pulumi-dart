...
class StackdriverLoggingConfig2 {
  ...
  factory StackdriverLoggingConfig2.fromMap(Map<String, dynamic> map) {
    return StackdriverLoggingConfig2(
      samplingRatio:
