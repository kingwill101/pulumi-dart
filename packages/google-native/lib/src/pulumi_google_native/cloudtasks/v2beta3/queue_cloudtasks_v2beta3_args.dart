...
class QueueCloudtasksV2beta3Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (appEngineHttpQueueValue != null) {
      map['appEngineHttpQueue'] = pulumi.Input.mapOptionalInputValue<
              AppEngineHttpQueue, Map<String, dynamic>>(
    ...
    if (rateLimitsValue != null) {
      map['rateLimits'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (stackdriverLoggingConfigValue != null) {
      map['stackdriverLoggingConfig'] = pulumi.Input.mapOptionalInputValue<
              StackdriverLoggingConfigCloudtasksV2beta3, Map<String, dynamic>>(
    ...
    if (typeValue != null) {
      map['type'] = pulumi.Input.mapOptionalInputValue<QueueType, String>(
  ...
  factory QueueCloudtasksV2beta3Args.fromMap(Map<String, dynamic> map) {
    return QueueCloudtasksV2beta3Args(
      ...
      retryConfig: pulumi.Input.asOptionalInput<RetryConfigCloudtasksV2beta3>(
          map['retryConfig']),
      stackdriverLoggingConfig: pulumi.Input.asOptionalInput<
              StackdriverLoggingConfigCloudtasksV2beta3>(
          map['stackdriverLoggingConfig']),
      taskTtl: pulumi.Input.asOptionalInput<String>(map['taskTtl']),
      tombstoneTtl: pulumi.Input.asOptionalInput<String>(map['tombstoneTtl']),
      type: pulumi.Input.asOptionalInput<QueueType>(map['type']),
    );
  }
}
