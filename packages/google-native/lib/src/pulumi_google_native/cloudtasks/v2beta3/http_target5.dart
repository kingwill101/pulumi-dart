...
import 'header_override3.dart';
import 'http_target_http_method5.dart';
import 'oauth_token5.dart';
import 'oidc_token5.dart';
import 'uri_override3.dart';
...
class HttpTarget5 {
  ...
  final List<HeaderOverride3>? headerOverrides;

  /// The HTTP method to use for the request. When specified, it overrides HttpRequest for the task. Note that if the value is set to HttpMethod the HttpRequest of the task will be ignored at execution time.
  final HttpTargetHttpMethod5? httpMethod;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headerOverridesValue != null) {
      map['headerOverrides'] =
          Input.encodeList<HeaderOverride3, Map<String, dynamic>>(
  ...
  factory HttpTarget5.fromMap(Map<String, dynamic> map) {
    return HttpTarget5(
      headerOverrides: map['headerOverrides'] == null
          ? null
          : Input.decodeList<HeaderOverride3>(
              map['headerOverrides'],
              (value) => HeaderOverride3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      httpMethod: map['httpMethod'] == null
          ? null
          : HttpTargetHttpMethod5.fromValue(map['httpMethod'] as String),
