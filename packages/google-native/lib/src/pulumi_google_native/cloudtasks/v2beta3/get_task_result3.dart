...
class GetTaskResult3 {
  /// HTTP request that is sent to the App Engine app handler. An App Engine task is a task that has AppEngineHttpRequest set.
  final AppEngineHttpRequestResponse3 appEngineHttpRequest;
  ...
  final AttemptResponse2 firstAttempt;

  /// HTTP request that is sent to the task's target. An HTTP task is a task that has HttpRequest set.
  final HttpRequestResponse3 httpRequest;

  /// The status of the task's last attempt.
  final AttemptResponse2 lastAttempt;
  ...
  final PullMessageResponse2 pullMessage;
  ...
  factory GetTaskResult3.fromMap(Map<String, dynamic> map) {
    return GetTaskResult3(
      appEngineHttpRequest: AppEngineHttpRequestResponse3.fromMap(
      ...
      firstAttempt: AttemptResponse2.fromMap(
          (map['firstAttempt'] as Map).cast<String, dynamic>()),
      httpRequest: HttpRequestResponse3.fromMap(
          (map['httpRequest'] as Map).cast<String, dynamic>()),
      lastAttempt: AttemptResponse2.fromMap(
          (map['lastAttempt'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      pullMessage: PullMessageResponse2.fromMap(
