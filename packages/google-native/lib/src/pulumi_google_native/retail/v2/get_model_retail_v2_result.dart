...
class GetModelRetailV2Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['servingConfigLists'] = pulumi.Input.encodeList<
  ...
  factory GetModelRetailV2Result.fromMap(Map<String, dynamic> map) {
    return GetModelRetailV2Result(
      ...
      servingConfigLists: pulumi.Input.decodeList<
              GoogleCloudRetailV2ModelServingConfigListResponse>(
          map['servingConfigLists'],
          (value) => GoogleCloudRetailV2ModelServingConfigListResponse.fromMap(
