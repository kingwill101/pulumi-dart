...
class ProductArgs {
  ...
  final Input<GoogleCloudRetailV2Audience>? audience;

  /// The online availability of the Product. Default to Availability.IN_STOCK. Corresponding properties: Google Merchant Center property [availability](https://support.google.com/merchants/answer/6324448). Schema.org property [Offer.availability](https://schema.org/availability).
  final Input<ProductAvailability>? availability;
  ...
  final Input<GoogleCloudRetailV2ColorInfo>? colorInfo;
  ...
  final Input<List<GoogleCloudRetailV2FulfillmentInfo>>? fulfillmentInfo;
  ...
  final Input<List<GoogleCloudRetailV2Image>>? images;
  ...
  final Input<GoogleCloudRetailV2PriceInfo>? priceInfo;
  ...
  final Input<List<GoogleCloudRetailV2Promotion>>? promotions;

  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final Input<String>? publishTime;

  /// The rating of this product.
  final Input<GoogleCloudRetailV2Rating>? rating;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (audienceValue != null) {
      map['audience'] = Input.mapOptionalInputValue<GoogleCloudRetailV2Audience,
          Map<String, dynamic>>(audienceValue, (value) => value.toMap());
    }
    final availabilityValue = availability;
    if (availabilityValue != null) {
      map['availability'] =
          Input.mapOptionalInputValue<ProductAvailability, String>(
    ...
    if (fulfillmentInfoValue != null) {
      map['fulfillmentInfo'] = Input.mapOptionalInputValue<
              List<GoogleCloudRetailV2FulfillmentInfo>,
              List<Map<String, dynamic>>>(
          fulfillmentInfoValue,
          (value) => Input.encodeList<GoogleCloudRetailV2FulfillmentInfo,
    ...
    if (imagesValue != null) {
      map['images'] = Input.mapOptionalInputValue<
              List<GoogleCloudRetailV2Image>, List<Map<String, dynamic>>>(
          imagesValue,
          (value) =>
              Input.encodeList<GoogleCloudRetailV2Image, Map<String, dynamic>>(
    ...
    if (promotionsValue != null) {
      map['promotions'] = Input.mapOptionalInputValue<
              List<GoogleCloudRetailV2Promotion>, List<Map<String, dynamic>>>(
          promotionsValue,
          (value) => Input.encodeList<GoogleCloudRetailV2Promotion,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (ratingValue != null) {
      map['rating'] = Input.mapOptionalInputValue<GoogleCloudRetailV2Rating,
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<ProductType, String>(
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      audience:
          Input.asOptionalInput<GoogleCloudRetailV2Audience>(map['audience']),
      availability:
          Input.asOptionalInput<ProductAvailability>(map['availability']),
      ...
      colorInfo:
          Input.asOptionalInput<GoogleCloudRetailV2ColorInfo>(map['colorInfo']),
      ...
      fulfillmentInfo:
          Input.asOptionalInput<List<GoogleCloudRetailV2FulfillmentInfo>>(
              map['fulfillmentInfo']),
      gtin: Input.asOptionalInput<String>(map['gtin']),
      id: Input.asOptionalInput<String>(map['id']),
      images:
          Input.asOptionalInput<List<GoogleCloudRetailV2Image>>(map['images']),
      ...
      priceInfo:
          Input.asOptionalInput<GoogleCloudRetailV2PriceInfo>(map['priceInfo']),
      primaryProductId: Input.asOptionalInput<String>(map['primaryProductId']),
      productId: Input.asInput<String>(map['productId']),
      project: Input.asOptionalInput<String>(map['project']),
      promotions: Input.asOptionalInput<List<GoogleCloudRetailV2Promotion>>(
          map['promotions']),
      publishTime: Input.asOptionalInput<String>(map['publishTime']),
      rating: Input.asOptionalInput<GoogleCloudRetailV2Rating>(map['rating']),
      retrievableFields:
      ...
      type: Input.asOptionalInput<ProductType>(map['type']),
