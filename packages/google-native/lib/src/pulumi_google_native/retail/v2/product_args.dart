...
class ProductArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (availabilityValue != null) {
      map['availability'] =
          pulumi.Input.mapOptionalInputValue<ProductAvailability, String>(
    ...
    if (fulfillmentInfoValue != null) {
      map['fulfillmentInfo'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<GoogleCloudRetailV2FulfillmentInfo,
    ...
    if (imagesValue != null) {
      map['images'] = pulumi.Input.mapOptionalInputValue<
          ...
          imagesValue,
          (value) => pulumi.Input.encodeList<GoogleCloudRetailV2Image,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (promotionsValue != null) {
      map['promotions'] = pulumi.Input.mapOptionalInputValue<
          ...
          promotionsValue,
          (value) => pulumi.Input.encodeList<GoogleCloudRetailV2Promotion,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (typeValue != null) {
      map['type'] = pulumi.Input.mapOptionalInputValue<ProductType, String>(
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      audience: pulumi.Input.asOptionalInput<GoogleCloudRetailV2Audience>(
          map['audience']),
      availability: pulumi.Input.asOptionalInput<ProductAvailability>(
          map['availability']),
      availableQuantity:
      ...
      colorInfo: pulumi.Input.asOptionalInput<GoogleCloudRetailV2ColorInfo>(
          map['colorInfo']),
      ...
      fulfillmentInfo: pulumi.Input.asOptionalInput<
          List<GoogleCloudRetailV2FulfillmentInfo>>(map['fulfillmentInfo']),
      gtin: pulumi.Input.asOptionalInput<String>(map['gtin']),
      id: pulumi.Input.asOptionalInput<String>(map['id']),
      images: pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2Image>>(
          map['images']),
      ...
      priceInfo: pulumi.Input.asOptionalInput<GoogleCloudRetailV2PriceInfo>(
          map['priceInfo']),
      primaryProductId:
      ...
      promotions:
          pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2Promotion>>(
              map['promotions']),
      publishTime: pulumi.Input.asOptionalInput<String>(map['publishTime']),
      rating: pulumi.Input.asOptionalInput<GoogleCloudRetailV2Rating>(
          map['rating']),
      retrievableFields:
      ...
      type: pulumi.Input.asOptionalInput<ProductType>(map['type']),
