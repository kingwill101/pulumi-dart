...
/// Creates a Product.
class ProductRetailV2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2FulfillmentInfoResponse>>
      fulfillmentInfo;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2ImageResponse>> images;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2LocalInventoryResponse>>
      localInventories;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2PromotionResponse>>
      promotions;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2ProductResponse>> variants;
