...
class ServingConfigArgs {
  ...
  final Input<ServingConfigDiversityType>? diversityType;
  ...
  final Input<GoogleCloudRetailV2SearchRequestDynamicFacetSpec>?
      dynamicFacetSpec;
  ...
  final Input<GoogleCloudRetailV2SearchRequestPersonalizationSpec>?
      personalizationSpec;
  ...
  final Input<List<ServingConfigSolutionTypesItem>> solutionTypes;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (diversityTypeValue != null) {
      map['diversityType'] =
          Input.mapOptionalInputValue<ServingConfigDiversityType, String>(
    ...
    map['solutionTypes'] =
        Input.mapInputValue<List<ServingConfigSolutionTypesItem>, List<String>>(
            solutionTypes,
            (value) => Input.encodeList<ServingConfigSolutionTypesItem, String>(
  ...
  factory ServingConfigArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigArgs(
      ...
      diversityType: Input.asOptionalInput<ServingConfigDiversityType>(
          map['diversityType']),
      ...
      solutionTypes: Input.asInput<List<ServingConfigSolutionTypesItem>>(
          map['solutionTypes']),
