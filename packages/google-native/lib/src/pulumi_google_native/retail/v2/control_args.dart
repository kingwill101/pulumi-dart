...
class ControlArgs {
  ...
  final Input<GoogleCloudRetailV2Rule>? rule;

  /// Specifies the use case for the control. Affects what condition fields can be set. Only settable by search controls. Will default to SEARCH_SOLUTION_USE_CASE_SEARCH if not specified. Currently only allow one search_solution_use_case per control.
  final Input<List<ControlSearchSolutionUseCaseItem>>? searchSolutionUseCase;
  ...
  final Input<List<ControlSolutionTypesItem>> solutionTypes;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ruleValue != null) {
      map['rule'] = Input.mapOptionalInputValue<GoogleCloudRetailV2Rule,
    ...
    if (searchSolutionUseCaseValue != null) {
      map['searchSolutionUseCase'] = Input.mapOptionalInputValue<
          ...
          (value) => Input.encodeList<ControlSearchSolutionUseCaseItem, String>(
              value, (value) => value.value));
    }
    map['solutionTypes'] =
        Input.mapInputValue<List<ControlSolutionTypesItem>, List<String>>(
            solutionTypes,
            (value) => Input.encodeList<ControlSolutionTypesItem, String>(
                value, (value) => value.value));
    return map;
  }
  ...
  factory ControlArgs.fromMap(Map<String, dynamic> map) {
    return ControlArgs(
      ...
      rule: Input.asOptionalInput<GoogleCloudRetailV2Rule>(map['rule']),
      searchSolutionUseCase:
          Input.asOptionalInput<List<ControlSearchSolutionUseCaseItem>>(
              map['searchSolutionUseCase']),
      solutionTypes:
          Input.asInput<List<ControlSolutionTypesItem>>(map['solutionTypes']),
    );
  }
}
