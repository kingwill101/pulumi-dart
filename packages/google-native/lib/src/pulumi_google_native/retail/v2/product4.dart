...
/// Creates a Product.
class Product4 extends CustomResource {
  ...
  late final Output<GoogleCloudRetailV2AudienceResponse> audience;
  ...
  late final Output<GoogleCloudRetailV2ColorInfoResponse> colorInfo;
  ...
  late final Output<List<GoogleCloudRetailV2FulfillmentInfoResponse>>
      fulfillmentInfo;
  ...
  late final Output<List<GoogleCloudRetailV2ImageResponse>> images;
  ...
  late final Output<List<GoogleCloudRetailV2LocalInventoryResponse>>
      localInventories;
  ...
  late final Output<GoogleCloudRetailV2PriceInfoResponse> priceInfo;
  ...
  late final Output<List<GoogleCloudRetailV2PromotionResponse>> promotions;

  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  late final Output<String> publishTime;

  /// The rating of this product.
  late final Output<GoogleCloudRetailV2RatingResponse> rating;
  ...
  late final Output<List<GoogleCloudRetailV2ProductResponse>> variants;
