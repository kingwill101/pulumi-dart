...
import 'google_cloud_retail_v2alpha_audience_response.dart';
import 'google_cloud_retail_v2alpha_color_info_response.dart';
import 'google_cloud_retail_v2alpha_fulfillment_info_response.dart';
import 'google_cloud_retail_v2alpha_image_response.dart';
import 'google_cloud_retail_v2alpha_local_inventory_response.dart';
import 'google_cloud_retail_v2alpha_price_info_response.dart';
import 'google_cloud_retail_v2alpha_promotion_response.dart';
import 'google_cloud_retail_v2alpha_rating_response.dart';

/// Product captures all metadata information of items to be recommended or searched.
class GoogleCloudRetailV2alphaProductResponse {
  ...
  final GoogleCloudRetailV2alphaAudienceResponse audience;
  ...
  final GoogleCloudRetailV2alphaColorInfoResponse colorInfo;
  ...
  final List<GoogleCloudRetailV2alphaFulfillmentInfoResponse> fulfillmentInfo;
  ...
  final List<GoogleCloudRetailV2alphaImageResponse> images;
  ...
  final List<GoogleCloudRetailV2alphaLocalInventoryResponse> localInventories;
  ...
  final GoogleCloudRetailV2alphaPriceInfoResponse priceInfo;
  ...
  final List<GoogleCloudRetailV2alphaPromotionResponse> promotions;

  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final String publishTime;

  /// The rating of this product.
  final GoogleCloudRetailV2alphaRatingResponse rating;
  ...
  final List<GoogleCloudRetailV2alphaProductResponse> variants;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['audience'] = audience.toMap();
    map['availability'] = availability;
    map['availableQuantity'] = availableQuantity;
    map['availableTime'] = availableTime;
    map['brands'] = brands;
    map['categories'] = categories;
    map['collectionMemberIds'] = collectionMemberIds;
    map['colorInfo'] = colorInfo.toMap();
    ...
    map['gtin'] = gtin;
    map['images'] = Input.encodeList<GoogleCloudRetailV2alphaImageResponse,
    ...
    map['retrievableFields'] = retrievableFields;
    map['sizes'] = sizes;
    map['tags'] = tags;
    map['title'] = title;
    map['ttl'] = ttl;
    map['type'] = type;
    map['uri'] = uri;
    map['variants'] = Input.encodeList<GoogleCloudRetailV2alphaProductResponse,
        Map<String, dynamic>>(variants, (value) => value.toMap());
    return map;
  }

  factory GoogleCloudRetailV2alphaProductResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaProductResponse(
      attributes: (map['attributes'] as Map).cast<String, String>(),
      audience: GoogleCloudRetailV2alphaAudienceResponse.fromMap(
      ...
      colorInfo: GoogleCloudRetailV2alphaColorInfoResponse.fromMap(
          (map['colorInfo'] as Map).cast<String, dynamic>()),
      conditions: (map['conditions'] as List).cast<String>(),
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      fulfillmentInfo:
          Input.decodeList<GoogleCloudRetailV2alphaFulfillmentInfoResponse>(
              map['fulfillmentInfo'],
              (value) =>
                  GoogleCloudRetailV2alphaFulfillmentInfoResponse.fromMap(
                      (value as Map).cast<String, dynamic>())),
      gtin: map['gtin'] as String,
      images: Input.decodeList<GoogleCloudRetailV2alphaImageResponse>(
          map['images'],
          (value) => GoogleCloudRetailV2alphaImageResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      languageCode: map['languageCode'] as String,
      localInventories:
          Input.decodeList<GoogleCloudRetailV2alphaLocalInventoryResponse>(
              map['localInventories'],
              (value) => GoogleCloudRetailV2alphaLocalInventoryResponse.fromMap(
                  (value as Map).cast<String, dynamic>())),
      materials: (map['materials'] as List).cast<String>(),
      name: map['name'] as String,
      patterns: (map['patterns'] as List).cast<String>(),
      priceInfo: GoogleCloudRetailV2alphaPriceInfoResponse.fromMap(
          (map['priceInfo'] as Map).cast<String, dynamic>()),
      primaryProductId: map['primaryProductId'] as String,
      promotions: Input.decodeList<GoogleCloudRetailV2alphaPromotionResponse>(
          map['promotions'],
          (value) => GoogleCloudRetailV2alphaPromotionResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      publishTime: map['publishTime'] as String,
      rating: GoogleCloudRetailV2alphaRatingResponse.fromMap(
      ...
      variants: Input.decodeList<GoogleCloudRetailV2alphaProductResponse>(
          map['variants'],
          (value) => GoogleCloudRetailV2alphaProductResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
