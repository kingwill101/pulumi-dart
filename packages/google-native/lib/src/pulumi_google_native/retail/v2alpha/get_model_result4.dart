...
class GetModelResult4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['pageOptimizationConfig'] = pageOptimizationConfig.toMap();
  ...
  factory GetModelResult4.fromMap(Map<String, dynamic> map) {
    return GetModelResult4(
