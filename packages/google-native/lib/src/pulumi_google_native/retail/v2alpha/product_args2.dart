...
import 'product_availability2.dart';
import 'product_type2.dart';
...
class ProductArgs2 {
  ...
  final Input<GoogleCloudRetailV2alphaAudience>? audience;

  /// The online availability of the Product. Default to Availability.IN_STOCK. Corresponding properties: Google Merchant Center property [availability](https://support.google.com/merchants/answer/6324448). Schema.org property [Offer.availability](https://schema.org/availability).
  final Input<ProductAvailability2>? availability;

  /// The available quantity of the item.
  final Input<int>? availableQuantity;
  ...
  final Input<String>? availableTime;
  ...
  final Input<List<String>>? brands;
  ...
  final Input<List<String>>? collectionMemberIds;
  ...
  final Input<GoogleCloudRetailV2alphaColorInfo>? colorInfo;

  /// The condition of the product. Strongly encouraged to use the standard values: "new", "refurbished", "used". A maximum of 1 value is allowed per Product. Each value must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned. Corresponding properties: Google Merchant Center property [condition](https://support.google.com/merchants/answer/6324469). Schema.org property [Offer.itemCondition](https://schema.org/itemCondition).
  final Input<List<String>>? conditions;
  ...
  final Input<List<GoogleCloudRetailV2alphaImage>>? images;
  ...
  final Input<List<GoogleCloudRetailV2alphaPromotion>>? promotions;

  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final Input<String>? publishTime;

  /// The rating of this product.
  final Input<GoogleCloudRetailV2alphaRating>? rating;
  ...
  final Input<String>? retrievableFields;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (audienceValue != null) {
      map['audience'] = Input.mapOptionalInputValue<
    ...
    if (availabilityValue != null) {
      map['availability'] =
          Input.mapOptionalInputValue<ProductAvailability2, String>(
              availabilityValue, (value) => value.value);
    }
    ...
    if (colorInfoValue != null) {
      map['colorInfo'] = Input.mapOptionalInputValue<
    ...
    if (fulfillmentInfoValue != null) {
      map['fulfillmentInfo'] = Input.mapOptionalInputValue<
              List<GoogleCloudRetailV2alphaFulfillmentInfo>,
              List<Map<String, dynamic>>>(
          fulfillmentInfoValue,
          (value) => Input.encodeList<GoogleCloudRetailV2alphaFulfillmentInfo,
    ...
    if (imagesValue != null) {
      map['images'] = Input.mapOptionalInputValue<
              List<GoogleCloudRetailV2alphaImage>, List<Map<String, dynamic>>>(
          imagesValue,
          (value) => Input.encodeList<GoogleCloudRetailV2alphaImage,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (priceInfoValue != null) {
      map['priceInfo'] = Input.mapOptionalInputValue<
    ...
    if (promotionsValue != null) {
      map['promotions'] = Input.mapOptionalInputValue<
              List<GoogleCloudRetailV2alphaPromotion>,
              List<Map<String, dynamic>>>(
          promotionsValue,
          (value) => Input.encodeList<GoogleCloudRetailV2alphaPromotion,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (ratingValue != null) {
      map['rating'] = Input.mapOptionalInputValue<
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<ProductType2, String>(
  ...
  factory ProductArgs2.fromMap(Map<String, dynamic> map) {
    return ProductArgs2(
      attributes: Input.asOptionalInput<Map<String, String>>(map['attributes']),
      audience: Input.asOptionalInput<GoogleCloudRetailV2alphaAudience>(
          map['audience']),
      availability:
          Input.asOptionalInput<ProductAvailability2>(map['availability']),
      availableQuantity: Input.asOptionalInput<int>(map['availableQuantity']),
      availableTime: Input.asOptionalInput<String>(map['availableTime']),
      branchId: Input.asInput<String>(map['branchId']),
      brands: Input.asOptionalInput<List<String>>(map['brands']),
      catalogId: Input.asInput<String>(map['catalogId']),
      categories: Input.asOptionalInput<List<String>>(map['categories']),
      collectionMemberIds:
          Input.asOptionalInput<List<String>>(map['collectionMemberIds']),
      colorInfo: Input.asOptionalInput<GoogleCloudRetailV2alphaColorInfo>(
          map['colorInfo']),
      conditions: Input.asOptionalInput<List<String>>(map['conditions']),
      description: Input.asOptionalInput<String>(map['description']),
      expireTime: Input.asOptionalInput<String>(map['expireTime']),
      fulfillmentInfo:
          Input.asOptionalInput<List<GoogleCloudRetailV2alphaFulfillmentInfo>>(
              map['fulfillmentInfo']),
      gtin: Input.asOptionalInput<String>(map['gtin']),
      id: Input.asOptionalInput<String>(map['id']),
      images: Input.asOptionalInput<List<GoogleCloudRetailV2alphaImage>>(
          map['images']),
      languageCode: Input.asOptionalInput<String>(map['languageCode']),
      location: Input.asOptionalInput<String>(map['location']),
      materials: Input.asOptionalInput<List<String>>(map['materials']),
      name: Input.asOptionalInput<String>(map['name']),
      patterns: Input.asOptionalInput<List<String>>(map['patterns']),
      priceInfo: Input.asOptionalInput<GoogleCloudRetailV2alphaPriceInfo>(
          map['priceInfo']),
      primaryProductId: Input.asOptionalInput<String>(map['primaryProductId']),
      productId: Input.asInput<String>(map['productId']),
      project: Input.asOptionalInput<String>(map['project']),
      promotions:
          Input.asOptionalInput<List<GoogleCloudRetailV2alphaPromotion>>(
              map['promotions']),
      publishTime: Input.asOptionalInput<String>(map['publishTime']),
      rating:
          Input.asOptionalInput<GoogleCloudRetailV2alphaRating>(map['rating']),
      retrievableFields:
          Input.asOptionalInput<String>(map['retrievableFields']),
      sizes: Input.asOptionalInput<List<String>>(map['sizes']),
      ...
      type: Input.asOptionalInput<ProductType2>(map['type']),
