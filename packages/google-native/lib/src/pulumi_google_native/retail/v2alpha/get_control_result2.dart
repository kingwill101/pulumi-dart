...
class GetControlResult2 {
  ...
  factory GetControlResult2.fromMap(Map<String, dynamic> map) {
    return GetControlResult2(
      associatedServingConfigIds:
          (map['associatedServingConfigIds'] as List).cast<String>(),
      displayName: map['displayName'] as String,
      facetSpec: GoogleCloudRetailV2alphaSearchRequestFacetSpecResponse.fromMap(
          (map['facetSpec'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      rule: GoogleCloudRetailV2alphaRuleResponse.fromMap(
