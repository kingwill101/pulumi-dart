...
class Control3 extends CustomResource {
  ...
  late final Output<GoogleCloudRetailV2alphaSearchRequestFacetSpecResponse>
      facetSpec;
  ...
  late final Output<GoogleCloudRetailV2alphaRuleResponse> rule;
  ...
  Control3(
    ...
    this.rule = Output.createUnknown<GoogleCloudRetailV2alphaRuleResponse>();
