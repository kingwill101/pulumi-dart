...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
  ...
  final List<GoogleCloudRetailV2alphaInterval>? intervals;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (intervalsValue != null) {
      map['intervals'] = Input.encodeList<GoogleCloudRetailV2alphaInterval,
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey.fromMap(
    ...
    return GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey(
      ...
      intervals: map['intervals'] == null
          ? null
          : Input.decodeList<GoogleCloudRetailV2alphaInterval>(
              map['intervals'],
