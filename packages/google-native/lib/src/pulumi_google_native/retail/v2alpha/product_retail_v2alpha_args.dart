...
class ProductRetailV2alphaArgs {
  ...
  factory ProductRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2alphaArgs(
      ...
      audience: pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaAudience>(
          map['audience']),
      availability:
      ...
      images: pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2alphaImage>>(
          map['images']),
      ...
      promotions:
          pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2alphaPromotion>>(
              map['promotions']),
      ...
      type: pulumi.Input.asOptionalInput<ProductTypeRetailV2alpha>(map['type']),
