...
import 'serving_config_diversity_type_retail_v2alpha.dart';
import 'serving_config_solution_types_item_retail_v2alpha.dart';

/// The set of arguments for ServingConfig.
class ServingConfigRetailV2alphaArgs {
  ...
  final pulumi.Input<ServingConfigDiversityTypeRetailV2alpha>? diversityType;
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec>?
      dynamicFacetSpec;
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec>?
      personalizationSpec;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (diversityTypeValue != null) {
      map['diversityType'] = pulumi.Input.mapOptionalInputValue<
          ServingConfigDiversityTypeRetailV2alpha,
    ...
    map['solutionTypes'] = pulumi.Input.mapInputValue<
            List<ServingConfigSolutionTypesItemRetailV2alpha>, List<String>>(
        solutionTypes,
        (value) => pulumi.Input.encodeList<
            ServingConfigSolutionTypesItemRetailV2alpha,
  ...
  factory ServingConfigRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2alphaArgs(
      boostControlIds:
      ...
      diversityLevel:
          pulumi.Input.asOptionalInput<String>(map['diversityLevel']),
      diversityType:
          pulumi.Input.asOptionalInput<ServingConfigDiversityTypeRetailV2alpha>(
              map['diversityType']),
      doNotAssociateControlIds: pulumi.Input.asOptionalInput<List<String>>(
          map['doNotAssociateControlIds']),
      ...
      enableCategoryFilterLevel: pulumi.Input.asOptionalInput<String>(
          map['enableCategoryFilterLevel']),
      facetControlIds:
          pulumi.Input.asOptionalInput<List<String>>(map['facetControlIds']),
      filterControlIds:
          pulumi.Input.asOptionalInput<List<String>>(map['filterControlIds']),
      ignoreControlIds:
          pulumi.Input.asOptionalInput<List<String>>(map['ignoreControlIds']),
      ...
      onewaySynonymsControlIds: pulumi.Input.asOptionalInput<List<String>>(
          map['onewaySynonymsControlIds']),
      personalizationSpec: pulumi.Input.asOptionalInput<
              GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec>(
          map['personalizationSpec']),
      priceRerankingLevel:
          pulumi.Input.asOptionalInput<String>(map['priceRerankingLevel']),
