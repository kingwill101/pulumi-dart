...
import 'serving_config_solution_types_item3.dart';

/// The set of arguments for ServingConfig.
class ServingConfigArgs3 {
  ...
  final Input<ServingConfigDiversityType3>? diversityType;
  ...
  final Input<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec>?
      dynamicFacetSpec;
  ...
  final Input<GoogleCloudRetailV2betaSearchRequestPersonalizationSpec>?
      personalizationSpec;
  ...
  final Input<List<ServingConfigSolutionTypesItem3>> solutionTypes;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (diversityTypeValue != null) {
      map['diversityType'] =
          Input.mapOptionalInputValue<ServingConfigDiversityType3, String>(
    ...
    map['solutionTypes'] = Input.mapInputValue<
            List<ServingConfigSolutionTypesItem3>, List<String>>(
        solutionTypes,
        (value) => Input.encodeList<ServingConfigSolutionTypesItem3, String>(
  ...
  factory ServingConfigArgs3.fromMap(Map<String, dynamic> map) {
    return ServingConfigArgs3(
      boostControlIds:
      ...
      diversityType: Input.asOptionalInput<ServingConfigDiversityType3>(
          map['diversityType']),
      ...
      solutionTypes: Input.asInput<List<ServingConfigSolutionTypesItem3>>(
          map['solutionTypes']),
