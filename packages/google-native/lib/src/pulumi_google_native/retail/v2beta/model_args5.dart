...
import 'model_training_state3.dart';
...
class ModelArgs5 {
  ...
  final Input<ModelFilteringOption3>? filteringOption;
  final Input<String>? location;

  /// Optional. Additional model features config.
  final Input<GoogleCloudRetailV2betaModelModelFeaturesConfig>?
      modelFeaturesConfig;
  ...
  final Input<ModelPeriodicTuningState3>? periodicTuningState;
  final Input<String>? project;

  /// Optional. The training state that the model is in (e.g. `TRAINING` or `PAUSED`). Since part of the cost of running the service is frequency of training - this can be used to determine when to train model in order to control cost. If not specified: the default value for `CreateModel` method is `TRAINING`. The default value for `UpdateModel` method is to keep the state the same as before.
  final Input<ModelTrainingState3>? trainingState;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (filteringOptionValue != null) {
      map['filteringOption'] =
          Input.mapOptionalInputValue<ModelFilteringOption3, String>(
    ...
    if (periodicTuningStateValue != null) {
      map['periodicTuningState'] =
          Input.mapOptionalInputValue<ModelPeriodicTuningState3, String>(
    ...
    if (trainingStateValue != null) {
      map['trainingState'] =
          Input.mapOptionalInputValue<ModelTrainingState3, String>(
  ...
  factory ModelArgs5.fromMap(Map<String, dynamic> map) {
    return ModelArgs5(
      catalogId: Input.asInput<String>(map['catalogId']),
      displayName: Input.asInput<String>(map['displayName']),
      dryRun: Input.asOptionalInput<bool>(map['dryRun']),
      filteringOption:
          Input.asOptionalInput<ModelFilteringOption3>(map['filteringOption']),
      ...
      periodicTuningState: Input.asOptionalInput<ModelPeriodicTuningState3>(
          map['periodicTuningState']),
      project: Input.asOptionalInput<String>(map['project']),
      trainingState:
          Input.asOptionalInput<ModelTrainingState3>(map['trainingState']),
