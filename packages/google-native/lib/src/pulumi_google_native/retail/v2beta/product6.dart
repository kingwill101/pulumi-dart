...
import 'product_args3.dart';

/// Creates a Product.
class Product6 extends CustomResource {
  ...
  late final Output<GoogleCloudRetailV2betaAudienceResponse> audience;
  ...
  late final Output<GoogleCloudRetailV2betaColorInfoResponse> colorInfo;
  ...
  late final Output<List<GoogleCloudRetailV2betaFulfillmentInfoResponse>>
      fulfillmentInfo;
  ...
  late final Output<List<GoogleCloudRetailV2betaImageResponse>> images;
  ...
  late final Output<List<GoogleCloudRetailV2betaLocalInventoryResponse>>
      localInventories;
  ...
  late final Output<GoogleCloudRetailV2betaPriceInfoResponse> priceInfo;
  ...
  late final Output<List<GoogleCloudRetailV2betaPromotionResponse>> promotions;

  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  late final Output<String> publishTime;

  /// The rating of this product.
  late final Output<GoogleCloudRetailV2betaRatingResponse> rating;
  ...
  late final Output<List<GoogleCloudRetailV2betaProductResponse>> variants;
  ...
  Product6(
    ...
    this.audience =
        registerOutput<GoogleCloudRetailV2betaAudienceResponse>('audience');
    ...
    this.colorInfo =
        registerOutput<GoogleCloudRetailV2betaColorInfoResponse>('colorInfo');
    this.conditions = registerOutput<List<String>>('conditions');
    this.description = registerOutput<String>('description');
    this.expireTime = registerOutput<String>('expireTime');
    this.fulfillmentInfo =
        registerOutput<List<GoogleCloudRetailV2betaFulfillmentInfoResponse>>(
            'fulfillmentInfo');
    this.gtin = registerOutput<String>('gtin');
    this.images =
        registerOutput<List<GoogleCloudRetailV2betaImageResponse>>('images');
    this.languageCode = registerOutput<String>('languageCode');
    this.localInventories =
        registerOutput<List<GoogleCloudRetailV2betaLocalInventoryResponse>>(
            'localInventories');
    ...
    this.priceInfo =
        registerOutput<GoogleCloudRetailV2betaPriceInfoResponse>('priceInfo');
    this.primaryProductId = registerOutput<String>('primaryProductId');
    this.productId = registerOutput<String>('productId');
    this.project = registerOutput<String>('project');
    this.promotions =
        registerOutput<List<GoogleCloudRetailV2betaPromotionResponse>>(
            'promotions');
    this.publishTime = registerOutput<String>('publishTime');
    this.rating =
        registerOutput<GoogleCloudRetailV2betaRatingResponse>('rating');
    ...
    this.variants =
        registerOutput<List<GoogleCloudRetailV2betaProductResponse>>(
            'variants');
  }
}
