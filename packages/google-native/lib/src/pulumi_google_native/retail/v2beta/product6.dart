...
class Product6 extends CustomResource {
  ...
  Product6(
    ...
    this.audience =
        Output.createUnknown<GoogleCloudRetailV2betaAudienceResponse>();
    ...
    this.variants =
        Output.createUnknown<List<GoogleCloudRetailV2betaProductResponse>>();
  }
}
