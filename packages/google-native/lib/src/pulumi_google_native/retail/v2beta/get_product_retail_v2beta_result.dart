...
import 'google_cloud_retail_v2beta_product_response.dart';
...
class GetProductRetailV2betaResult {
  ...
  final GoogleCloudRetailV2betaAudienceResponse audience;
  ...
  final GoogleCloudRetailV2betaColorInfoResponse colorInfo;
  ...
  final List<GoogleCloudRetailV2betaFulfillmentInfoResponse> fulfillmentInfo;
  ...
  final List<GoogleCloudRetailV2betaImageResponse> images;
  ...
  final List<GoogleCloudRetailV2betaLocalInventoryResponse> localInventories;
  ...
  final GoogleCloudRetailV2betaPriceInfoResponse priceInfo;
  ...
  final List<GoogleCloudRetailV2betaPromotionResponse> promotions;

  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final String publishTime;

  /// The rating of this product.
  final GoogleCloudRetailV2betaRatingResponse rating;
  ...
  final List<GoogleCloudRetailV2betaProductResponse> variants;

  GetProductRetailV2betaResult({
  ...
  factory GetProductRetailV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetProductRetailV2betaResult(
      attributes: (map['attributes'] as Map).cast<String, String>(),
      audience: GoogleCloudRetailV2betaAudienceResponse.fromMap(
      ...
      colorInfo: GoogleCloudRetailV2betaColorInfoResponse.fromMap(
