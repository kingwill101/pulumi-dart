...
import 'product_availability3.dart';
import 'product_type3.dart';
...
class ProductArgs3 {
  ...
  final Input<GoogleCloudRetailV2betaAudience>? audience;

  /// The online availability of the Product. Default to Availability.IN_STOCK. Corresponding properties: Google Merchant Center property [availability](https://support.google.com/merchants/answer/6324448). Schema.org property [Offer.availability](https://schema.org/availability).
  final Input<ProductAvailability3>? availability;
  ...
  final Input<GoogleCloudRetailV2betaColorInfo>? colorInfo;
  ...
  final Input<List<GoogleCloudRetailV2betaFulfillmentInfo>>? fulfillmentInfo;
  ...
  final Input<List<GoogleCloudRetailV2betaImage>>? images;
  ...
  final Input<GoogleCloudRetailV2betaPriceInfo>? priceInfo;
  ...
  final Input<List<GoogleCloudRetailV2betaPromotion>>? promotions;

  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final Input<String>? publishTime;

  /// The rating of this product.
  final Input<GoogleCloudRetailV2betaRating>? rating;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (availabilityValue != null) {
      map['availability'] =
          Input.mapOptionalInputValue<ProductAvailability3, String>(
    ...
    if (fulfillmentInfoValue != null) {
      map['fulfillmentInfo'] = Input.mapOptionalInputValue<
          ...
          (value) => Input.encodeList<GoogleCloudRetailV2betaFulfillmentInfo,
    ...
    if (imagesValue != null) {
      map['images'] = Input.mapOptionalInputValue<
          ...
          imagesValue,
          (value) => Input.encodeList<GoogleCloudRetailV2betaImage,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (promotionsValue != null) {
      map['promotions'] = Input.mapOptionalInputValue<
              ...
              List<Map<String, dynamic>>>(
          promotionsValue,
          (value) => Input.encodeList<GoogleCloudRetailV2betaPromotion,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (ratingValue != null) {
      map['rating'] = Input.mapOptionalInputValue<GoogleCloudRetailV2betaRating,
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<ProductType3, String>(
  ...
  factory ProductArgs3.fromMap(Map<String, dynamic> map) {
    return ProductArgs3(
      attributes: Input.asOptionalInput<Map<String, String>>(map['attributes']),
      audience: Input.asOptionalInput<GoogleCloudRetailV2betaAudience>(
          map['audience']),
      availability:
          Input.asOptionalInput<ProductAvailability3>(map['availability']),
      ...
      colorInfo: Input.asOptionalInput<GoogleCloudRetailV2betaColorInfo>(
          map['colorInfo']),
      ...
      fulfillmentInfo:
          Input.asOptionalInput<List<GoogleCloudRetailV2betaFulfillmentInfo>>(
              map['fulfillmentInfo']),
      gtin: Input.asOptionalInput<String>(map['gtin']),
      id: Input.asOptionalInput<String>(map['id']),
      images: Input.asOptionalInput<List<GoogleCloudRetailV2betaImage>>(
          map['images']),
      ...
      priceInfo: Input.asOptionalInput<GoogleCloudRetailV2betaPriceInfo>(
          map['priceInfo']),
      primaryProductId: Input.asOptionalInput<String>(map['primaryProductId']),
      productId: Input.asInput<String>(map['productId']),
      project: Input.asOptionalInput<String>(map['project']),
      promotions: Input.asOptionalInput<List<GoogleCloudRetailV2betaPromotion>>(
          map['promotions']),
      publishTime: Input.asOptionalInput<String>(map['publishTime']),
      rating:
          Input.asOptionalInput<GoogleCloudRetailV2betaRating>(map['rating']),
      retrievableFields:
      ...
      type: Input.asOptionalInput<ProductType3>(map['type']),
