...
class JobArgs {
  ...
  final Input<AllocationPolicy>? allocationPolicy;
  ...
  final Input<LogsPolicy>? logsPolicy;

  /// Notification configurations.
  final Input<List<JobNotification>>? notifications;

  /// Priority of the Job. The valid value range is [0, 100). Default value is 0. Higher value indicates higher priority. A job with higher priority value is more likely to run earlier if all other requirements are satisfied.
  final Input<String>? priority;
  ...
  final Input<List<TaskGroup>> taskGroups;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (allocationPolicyValue != null) {
      map['allocationPolicy'] =
          Input.mapOptionalInputValue<AllocationPolicy, Map<String, dynamic>>(
    ...
    if (logsPolicyValue != null) {
      map['logsPolicy'] =
          Input.mapOptionalInputValue<LogsPolicy, Map<String, dynamic>>(
              logsPolicyValue, (value) => value.toMap());
    }
    final notificationsValue = notifications;
    if (notificationsValue != null) {
      map['notifications'] = Input.mapOptionalInputValue<List<JobNotification>,
              List<Map<String, dynamic>>>(
          notificationsValue,
          (value) => Input.encodeList<JobNotification, Map<String, dynamic>>(
    ...
    map['taskGroups'] =
        Input.mapInputValue<List<TaskGroup>, List<Map<String, dynamic>>>(
            taskGroups,
            (value) => Input.encodeList<TaskGroup, Map<String, dynamic>>(
                value, (value) => value.toMap()));
    return map;
  }
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      allocationPolicy:
          Input.asOptionalInput<AllocationPolicy>(map['allocationPolicy']),
      jobId: Input.asOptionalInput<String>(map['jobId']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      logsPolicy: Input.asOptionalInput<LogsPolicy>(map['logsPolicy']),
      notifications:
          Input.asOptionalInput<List<JobNotification>>(map['notifications']),
      priority: Input.asOptionalInput<String>(map['priority']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      taskGroups: Input.asInput<List<TaskGroup>>(map['taskGroups']),
    );
  }
}
