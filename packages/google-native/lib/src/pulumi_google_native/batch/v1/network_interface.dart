...
class NetworkInterface {
  ...
  Map<String, dynamic> toMap() {
    ...
    final noExternalIpAddressValue = noExternalIpAddress;
    if (noExternalIpAddressValue != null) {
      map['noExternalIpAddress'] = noExternalIpAddressValue;
    }
  ...
  factory NetworkInterface.fromMap(Map<String, dynamic> map) {
    return NetworkInterface(
      ...
      noExternalIpAddress: map['noExternalIpAddress'] == null
          ? null
          : map['noExternalIpAddress'] as bool,
      subnetwork:
