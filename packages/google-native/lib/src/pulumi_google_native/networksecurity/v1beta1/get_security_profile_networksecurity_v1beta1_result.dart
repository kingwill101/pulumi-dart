...
class GetSecurityProfileNetworksecurityV1beta1Result {
  ...
  GetSecurityProfileNetworksecurityV1beta1Result({
  ...
  factory GetSecurityProfileNetworksecurityV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetSecurityProfileNetworksecurityV1beta1Result(
