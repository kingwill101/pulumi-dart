...
import 'address_group_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class AddressGroupIamBinding2 extends CustomResource {
  ...
  AddressGroupIamBinding2(
    String name, {
    AddressGroupIamBindingArgs2? args,
