...
import 'rule_networksecurity_v1beta1.dart';
...
class AuthorizationPolicyNetworksecurityV1beta1Args {
  ...
  final pulumi.Input<List<RuleNetworksecurityV1beta1>>? rules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['action'] = pulumi.Input.mapInputValue<
        AuthorizationPolicyActionNetworksecurityV1beta1,
        String>(action, (value) => value.value);
    ...
    if (rulesValue != null) {
      map['rules'] = pulumi.Input.mapOptionalInputValue<
              List<RuleNetworksecurityV1beta1>, List<Map<String, dynamic>>>(
          rulesValue,
          (value) => pulumi.Input.encodeList<RuleNetworksecurityV1beta1,
  ...
  factory AuthorizationPolicyNetworksecurityV1beta1Args.fromMap(
    ...
    return AuthorizationPolicyNetworksecurityV1beta1Args(
      action:
          pulumi.Input.asInput<AuthorizationPolicyActionNetworksecurityV1beta1>(
              map['action']),
      ...
      rules: pulumi.Input.asOptionalInput<List<RuleNetworksecurityV1beta1>>(
          map['rules']),
    );
  }
}
