...
class GetTlsInspectionPolicyNetworksecurityV1beta1Result {
  ...
  GetTlsInspectionPolicyNetworksecurityV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['customTlsFeatures'] = customTlsFeatures;
    map['description'] = description;
    map['excludePublicCaSet'] = excludePublicCaSet;
    map['minTlsVersion'] = minTlsVersion;
    map['name'] = name;
    map['tlsFeatureProfile'] = tlsFeatureProfile;
    map['trustConfig'] = trustConfig;
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetTlsInspectionPolicyNetworksecurityV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetTlsInspectionPolicyNetworksecurityV1beta1Result(
