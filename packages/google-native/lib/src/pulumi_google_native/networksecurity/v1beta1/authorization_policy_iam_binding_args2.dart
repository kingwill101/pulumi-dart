...
class AuthorizationPolicyIamBindingArgs2 {
  ...
  AuthorizationPolicyIamBindingArgs2({
    this.condition,
  ...
  factory AuthorizationPolicyIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return AuthorizationPolicyIamBindingArgs2(
