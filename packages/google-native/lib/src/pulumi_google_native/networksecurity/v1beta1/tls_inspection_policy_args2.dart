...
import 'tls_inspection_policy_min_tls_version2.dart';
import 'tls_inspection_policy_tls_feature_profile2.dart';

/// The set of arguments for TlsInspectionPolicy.
class TlsInspectionPolicyArgs2 {
  ...
  final Input<TlsInspectionPolicyMinTlsVersion2>? minTlsVersion;
  ...
  final Input<TlsInspectionPolicyTlsFeatureProfile2>? tlsFeatureProfile;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (minTlsVersionValue != null) {
      map['minTlsVersion'] = Input.mapOptionalInputValue<
          TlsInspectionPolicyMinTlsVersion2,
    ...
    if (tlsFeatureProfileValue != null) {
      map['tlsFeatureProfile'] = Input.mapOptionalInputValue<
          TlsInspectionPolicyTlsFeatureProfile2,
  ...
  factory TlsInspectionPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return TlsInspectionPolicyArgs2(
      ...
      minTlsVersion: Input.asOptionalInput<TlsInspectionPolicyMinTlsVersion2>(
          map['minTlsVersion']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      tlsFeatureProfile:
          Input.asOptionalInput<TlsInspectionPolicyTlsFeatureProfile2>(
