...
import 'server_tls_policy_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ServerTlsPolicyIamBinding2 extends CustomResource {
  ...
  ServerTlsPolicyIamBinding2(
    String name, {
    ServerTlsPolicyIamBindingArgs2? args,
