...
import 'mtlspolicy2.dart';

/// The set of arguments for ServerTlsPolicy.
class ServerTlsPolicyArgs2 {
  ...
  final Input<MTLSPolicy2>? mtlsPolicy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (mtlsPolicyValue != null) {
      map['mtlsPolicy'] =
          Input.mapOptionalInputValue<MTLSPolicy2, Map<String, dynamic>>(
  ...
  factory ServerTlsPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyArgs2(
      allowOpen: Input.asOptionalInput<bool>(map['allowOpen']),
      description: Input.asOptionalInput<String>(map['description']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      mtlsPolicy: Input.asOptionalInput<MTLSPolicy2>(map['mtlsPolicy']),
