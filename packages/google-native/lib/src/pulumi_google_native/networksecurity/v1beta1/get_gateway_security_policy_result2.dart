...
class GetGatewaySecurityPolicyResult2 {
  ...
  GetGatewaySecurityPolicyResult2({
  ...
  factory GetGatewaySecurityPolicyResult2.fromMap(Map<String, dynamic> map) {
    return GetGatewaySecurityPolicyResult2(
