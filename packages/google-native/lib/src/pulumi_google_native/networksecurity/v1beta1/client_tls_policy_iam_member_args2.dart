...
class ClientTlsPolicyIamMemberArgs2 {
  ...
  factory ClientTlsPolicyIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyIamMemberArgs2(
