...
class MTLSPolicyResponse2 {
  ...
  final List<ValidationCAResponse2> clientValidationCa;
  ...
  factory MTLSPolicyResponse2.fromMap(Map<String, dynamic> map) {
    return MTLSPolicyResponse2(
      clientValidationCa: Input.decodeList<ValidationCAResponse2>(
          map['clientValidationCa'],
