...
class AddressGroupNetworksecurityV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['type'] = pulumi.Input.mapInputValue<
        AddressGroupTypeNetworksecurityV1beta1,
        String>(type, (value) => value.value);
    return map;
  }

  factory AddressGroupNetworksecurityV1beta1Args.fromMap(
    ...
    return AddressGroupNetworksecurityV1beta1Args(
      ...
      type: pulumi.Input.asInput<AddressGroupTypeNetworksecurityV1beta1>(
          map['type']),
    );
  }
}
