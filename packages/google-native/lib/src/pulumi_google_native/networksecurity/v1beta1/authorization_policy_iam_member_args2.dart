...
class AuthorizationPolicyIamMemberArgs2 {
  ...
  AuthorizationPolicyIamMemberArgs2({
    this.condition,
  ...
  factory AuthorizationPolicyIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return AuthorizationPolicyIamMemberArgs2(
