...
class AddressGroupIamBindingArgs2 {
  ...
  factory AddressGroupIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return AddressGroupIamBindingArgs2(
