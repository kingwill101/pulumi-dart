...
import 'authorization_policy_args2.dart';
import 'rule_response7.dart';

/// Creates a new AuthorizationPolicy in a given project and location.
class AuthorizationPolicy2 extends CustomResource {
  ...
  late final Output<List<RuleResponse7>> rules;
  ...
  AuthorizationPolicy2(
    ...
    this.rules = registerOutput<List<RuleResponse7>>('rules');
