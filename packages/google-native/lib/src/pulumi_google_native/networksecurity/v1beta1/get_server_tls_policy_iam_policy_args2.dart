...
class GetServerTlsPolicyIamPolicyArgs2 {
  final Input<String> location;
  final Input<int>? optionsRequestedPolicyVersion;
  final Input<String>? project;
  final Input<String> serverTlsPolicyId;

  GetServerTlsPolicyIamPolicyArgs2({
  ...
  factory GetServerTlsPolicyIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return GetServerTlsPolicyIamPolicyArgs2(
