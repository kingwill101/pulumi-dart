...
import 'organization_address_group_type2.dart';

/// The set of arguments for OrganizationAddressGroup.
class OrganizationAddressGroupArgs2 {
  ...
  final Input<OrganizationAddressGroupType2> type;

  OrganizationAddressGroupArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['type'] = Input.mapInputValue<OrganizationAddressGroupType2, String>(
        type, (value) => value.value);
    return map;
  }

  factory OrganizationAddressGroupArgs2.fromMap(Map<String, dynamic> map) {
    return OrganizationAddressGroupArgs2(
      ...
      type: Input.asInput<OrganizationAddressGroupType2>(map['type']),
    );
  }
}
