...
class ServerTlsPolicyIamBindingArgs2 {
  ...
  ServerTlsPolicyIamBindingArgs2({
    this.condition,
  ...
  factory ServerTlsPolicyIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyIamBindingArgs2(
