...
import 'server_tls_policy_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ServerTlsPolicyIamMember2 extends CustomResource {
  ...
  ServerTlsPolicyIamMember2(
    String name, {
    ServerTlsPolicyIamMemberArgs2? args,
