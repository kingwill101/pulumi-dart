...
import 'authorization_policy_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class AuthorizationPolicyIamMember2 extends CustomResource {
  ...
  AuthorizationPolicyIamMember2(
    String name, {
    AuthorizationPolicyIamMemberArgs2? args,
