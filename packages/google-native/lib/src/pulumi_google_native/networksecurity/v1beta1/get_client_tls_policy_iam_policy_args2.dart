...
class GetClientTlsPolicyIamPolicyArgs2 {
  final Input<String> clientTlsPolicyId;
  final Input<String> location;
  final Input<int>? optionsRequestedPolicyVersion;
  final Input<String>? project;

  GetClientTlsPolicyIamPolicyArgs2({
  ...
  factory GetClientTlsPolicyIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return GetClientTlsPolicyIamPolicyArgs2(
