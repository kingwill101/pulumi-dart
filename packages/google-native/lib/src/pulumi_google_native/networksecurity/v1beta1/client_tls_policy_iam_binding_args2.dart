...
class ClientTlsPolicyIamBindingArgs2 {
  ...
  ClientTlsPolicyIamBindingArgs2({
    this.condition,
  ...
  factory ClientTlsPolicyIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyIamBindingArgs2(
