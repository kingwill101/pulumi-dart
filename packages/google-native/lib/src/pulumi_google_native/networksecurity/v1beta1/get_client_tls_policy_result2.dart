...
class GetClientTlsPolicyResult2 {
  ...
  final List<ValidationCAResponse2> serverValidationCa;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['serverValidationCa'] =
        Input.encodeList<ValidationCAResponse2, Map<String, dynamic>>(
  ...
  factory GetClientTlsPolicyResult2.fromMap(Map<String, dynamic> map) {
    return GetClientTlsPolicyResult2(
      clientCertificate:
      ...
      serverValidationCa: Input.decodeList<ValidationCAResponse2>(
          map['serverValidationCa'],
          (value) => ValidationCAResponse2.fromMap(
