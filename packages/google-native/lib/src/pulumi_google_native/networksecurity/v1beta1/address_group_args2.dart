...
import 'address_group_type2.dart';

/// The set of arguments for AddressGroup.
class AddressGroupArgs2 {
  ...
  final Input<AddressGroupType2> type;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['type'] = Input.mapInputValue<AddressGroupType2, String>(
        type, (value) => value.value);
    return map;
  }

  factory AddressGroupArgs2.fromMap(Map<String, dynamic> map) {
    return AddressGroupArgs2(
      ...
      type: Input.asInput<AddressGroupType2>(map['type']),
    );
  }
}
