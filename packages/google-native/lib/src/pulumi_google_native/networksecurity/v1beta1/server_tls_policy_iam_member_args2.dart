...
class ServerTlsPolicyIamMemberArgs2 {
  ...
  factory ServerTlsPolicyIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyIamMemberArgs2(
