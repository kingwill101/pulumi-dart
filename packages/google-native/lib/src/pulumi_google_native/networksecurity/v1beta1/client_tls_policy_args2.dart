...
class ClientTlsPolicyArgs2 {
  /// Optional. Defines a mechanism to provision client identity (public and private keys) for peer to peer authentication. The presence of this dictates mTLS.
  final Input<GoogleCloudNetworksecurityV1beta1CertificateProvider>?
      clientCertificate;
  ...
  final Input<List<ValidationCA2>>? serverValidationCa;

  /// Optional. Server Name Indication string to present to the server during TLS handshake. E.g: "secure.example.com".
  final Input<String>? sni;

  ClientTlsPolicyArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (serverValidationCaValue != null) {
      map['serverValidationCa'] = Input.mapOptionalInputValue<
              List<ValidationCA2>, List<Map<String, dynamic>>>(
          serverValidationCaValue,
          (value) => Input.encodeList<ValidationCA2, Map<String, dynamic>>(
  ...
  factory ClientTlsPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyArgs2(
      ...
      serverValidationCa:
          Input.asOptionalInput<List<ValidationCA2>>(map['serverValidationCa']),
