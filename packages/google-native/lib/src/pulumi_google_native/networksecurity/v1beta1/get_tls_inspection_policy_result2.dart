...
class GetTlsInspectionPolicyResult2 {
  ...
  factory GetTlsInspectionPolicyResult2.fromMap(Map<String, dynamic> map) {
    return GetTlsInspectionPolicyResult2(
