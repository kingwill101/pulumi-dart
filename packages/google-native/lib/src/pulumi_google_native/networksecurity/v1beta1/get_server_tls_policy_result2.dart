...
class GetServerTlsPolicyResult2 {
  ...
  final MTLSPolicyResponse2 mtlsPolicy;
  ...
  factory GetServerTlsPolicyResult2.fromMap(Map<String, dynamic> map) {
    return GetServerTlsPolicyResult2(
      allowOpen: map['allowOpen'] as bool,
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      mtlsPolicy: MTLSPolicyResponse2.fromMap(
