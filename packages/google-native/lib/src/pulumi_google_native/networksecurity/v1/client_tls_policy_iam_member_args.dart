...
class ClientTlsPolicyIamMemberArgs {
  ...
  factory ClientTlsPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyIamMemberArgs(
