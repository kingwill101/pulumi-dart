...
import 'job_derived_info_response2.dart';
import 'processing_options_response2.dart';
...
class GetJobResult9 {
  ...
  final ApplicationInfoResponse2 applicationInfo;
  ...
  final CompensationInfoResponse2 compensationInfo;
  ...
  final JobDerivedInfoResponse2 derivedInfo;
  ...
  final ProcessingOptionsResponse2 processingOptions;
  ...
  factory GetJobResult9.fromMap(Map<String, dynamic> map) {
    return GetJobResult9(
      addresses: (map['addresses'] as List).cast<String>(),
      applicationInfo: ApplicationInfoResponse2.fromMap(
          (map['applicationInfo'] as Map).cast<String, dynamic>()),
      company: map['company'] as String,
      companyDisplayName: map['companyDisplayName'] as String,
      compensationInfo: CompensationInfoResponse2.fromMap(
      ...
      derivedInfo: JobDerivedInfoResponse2.fromMap(
      ...
      processingOptions: ProcessingOptionsResponse2.fromMap(
