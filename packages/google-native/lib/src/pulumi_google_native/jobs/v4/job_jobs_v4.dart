...
class JobJobsV4 extends pulumi.CustomResource {
  ...
  JobJobsV4(
    ...
    this.applicationInfo =
        registerOutput<ApplicationInfoResponseJobsV4>('applicationInfo');
    ...
    this.compensationInfo =
        registerOutput<CompensationInfoResponseJobsV4>('compensationInfo');
    ...
    this.derivedInfo =
        registerOutput<JobDerivedInfoResponseJobsV4>('derivedInfo');
    ...
    this.processingOptions =
        registerOutput<ProcessingOptionsResponseJobsV4>('processingOptions');
