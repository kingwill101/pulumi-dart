  ...
  factory JobJobsV4Args.fromMap(Map<String, dynamic> map) {
    return JobJobsV4Args(
      ...
      applicationInfo: pulumi.Input.asOptionalInput<ApplicationInfoJobsV4>(
          map['applicationInfo']),
      company: pulumi.Input.asInput<String>(map['company']),
      ...
      degreeTypes: pulumi.Input.asOptionalInput<List<JobDegreeTypesItemJobsV4>>(
          map['degreeTypes']),
      ...
      jobBenefits: pulumi.Input.asOptionalInput<List<JobJobBenefitsItemJobsV4>>(
          map['jobBenefits']),
      jobEndTime: pulumi.Input.asOptionalInput<String>(map['jobEndTime']),
      jobLevel:
          pulumi.Input.asOptionalInput<JobJobLevelJobsV4>(map['jobLevel']),
      ...
      postingRegion: pulumi.Input.asOptionalInput<JobPostingRegionJobsV4>(
          map['postingRegion']),
      processingOptions: pulumi.Input.asOptionalInput<ProcessingOptionsJobsV4>(
      ...
      visibility:
          pulumi.Input.asOptionalInput<JobVisibilityJobsV4>(map['visibility']),
    );
  }
}
