...
class Job9 extends CustomResource {
  ...
  late final Output<ApplicationInfoResponse2> applicationInfo;
  ...
  late final Output<JobDerivedInfoResponse2> derivedInfo;
  ...
  late final Output<ProcessingOptionsResponse2> processingOptions;
