...
import 'lat_lng_response2.dart';
import 'postal_address_response5.dart';

/// A resource that represents a location with full geographic information.
class LocationResponse5 {
  /// An object representing a latitude/longitude pair.
  final LatLngResponse2 latLng;

  /// The type of a location, which corresponds to the address lines field of google.type.PostalAddress. For example, "Downtown, Atlanta, GA, USA" has a type of LocationType.NEIGHBORHOOD, and "Kansas City, KS, USA" has a type of LocationType.LOCALITY.
  final String locationType;

  /// Postal address of the location that includes human readable information, such as postal delivery and payments addresses. Given a postal address, a postal service can deliver items to a premises, P.O. Box, or other delivery location.
  final PostalAddressResponse5 postalAddress;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['radiusMiles'] = radiusMiles;
    return map;
  }

  factory LocationResponse5.fromMap(Map<String, dynamic> map) {
    return LocationResponse5(
      latLng: LatLngResponse2.fromMap(
          (map['latLng'] as Map).cast<String, dynamic>()),
      locationType: map['locationType'] as String,
      postalAddress: PostalAddressResponse5.fromMap(
