...
import 'postal_address_response_jobs_v3.dart';

/// Output only. A resource that represents a location with full geographic information.
class LocationResponseJobsV3 {
  ...
  final PostalAddressResponseJobsV3 postalAddress;
  ...
  factory LocationResponseJobsV3.fromMap(Map<String, dynamic> map) {
    return LocationResponseJobsV3(
      latLng: LatLngResponse.fromMap(
          (map['latLng'] as Map).cast<String, dynamic>()),
      locationType: map['locationType'] as String,
      postalAddress: PostalAddressResponseJobsV3.fromMap(
