  ...
  Map<String, dynamic> toMap() {
    ...
    if (compensationInfoValue != null) {
      map['compensationInfo'] = pulumi.Input.mapOptionalInputValue<
              CompensationInfo, Map<String, dynamic>>(
    ...
    if (degreeTypesValue != null) {
      map['degreeTypes'] = pulumi.Input.mapOptionalInputValue<
              List<JobDegreeTypesItem>, List<String>>(
          degreeTypesValue,
    ...
    if (jobBenefitsValue != null) {
      map['jobBenefits'] = pulumi.Input.mapOptionalInputValue<
              List<JobJobBenefitsItem>, List<String>>(
          jobBenefitsValue,
    ...
    if (jobLevelValue != null) {
      map['jobLevel'] = pulumi.Input.mapOptionalInputValue<JobJobLevel, String>(
    ...
    if (processingOptionsValue != null) {
      map['processingOptions'] = pulumi.Input.mapOptionalInputValue<
              ProcessingOptions, Map<String, dynamic>>(
    ...
    if (visibilityValue != null) {
      map['visibility'] =
          pulumi.Input.mapOptionalInputValue<JobVisibility, String>(
              visibilityValue, (value) => value.value);
    }
    return map;
  }

  factory JobJobsV3Args.fromMap(Map<String, dynamic> map) {
    return JobJobsV3Args(
      addresses: pulumi.Input.asOptionalInput<List<String>>(map['addresses']),
      applicationInfo:
          pulumi.Input.asInput<ApplicationInfo>(map['applicationInfo']),
      companyName: pulumi.Input.asInput<String>(map['companyName']),
      ...
      degreeTypes: pulumi.Input.asOptionalInput<List<JobDegreeTypesItem>>(
          map['degreeTypes']),
      department: pulumi.Input.asOptionalInput<String>(map['department']),
      description: pulumi.Input.asInput<String>(map['description']),
      employmentTypes:
          pulumi.Input.asOptionalInput<List<JobEmploymentTypesItem>>(
              map['employmentTypes']),
      incentives: pulumi.Input.asOptionalInput<String>(map['incentives']),
      jobBenefits: pulumi.Input.asOptionalInput<List<JobJobBenefitsItem>>(
          map['jobBenefits']),
      jobEndTime: pulumi.Input.asOptionalInput<String>(map['jobEndTime']),
      jobLevel: pulumi.Input.asOptionalInput<JobJobLevel>(map['jobLevel']),
      jobStartTime: pulumi.Input.asOptionalInput<String>(map['jobStartTime']),
      languageCode: pulumi.Input.asOptionalInput<String>(map['languageCode']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      postingExpireTime:
          pulumi.Input.asOptionalInput<String>(map['postingExpireTime']),
      postingPublishTime:
          pulumi.Input.asOptionalInput<String>(map['postingPublishTime']),
      postingRegion:
          pulumi.Input.asOptionalInput<JobPostingRegion>(map['postingRegion']),
      processingOptions: pulumi.Input.asOptionalInput<ProcessingOptions>(
          map['processingOptions']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      promotionValue: pulumi.Input.asOptionalInput<int>(map['promotionValue']),
      qualifications:
          pulumi.Input.asOptionalInput<String>(map['qualifications']),
      requisitionId: pulumi.Input.asInput<String>(map['requisitionId']),
      responsibilities:
          pulumi.Input.asOptionalInput<String>(map['responsibilities']),
      title: pulumi.Input.asInput<String>(map['title']),
      visibility:
          pulumi.Input.asOptionalInput<JobVisibility>(map['visibility']),
    );
  }
}
