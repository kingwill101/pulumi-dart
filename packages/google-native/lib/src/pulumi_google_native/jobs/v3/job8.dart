...
class Job8 extends CustomResource {
  ...
  Job8(
    ...
    this.applicationInfo = Output.createUnknown<ApplicationInfoResponse>();
    this.companyDisplayName = Output.createUnknown<String>();
    this.companyName = Output.createUnknown<String>();
    this.compensationInfo = Output.createUnknown<CompensationInfoResponse>();
    ...
    this.derivedInfo = Output.createUnknown<JobDerivedInfoResponse>();
    ...
    this.processingOptions = Output.createUnknown<ProcessingOptionsResponse>();
