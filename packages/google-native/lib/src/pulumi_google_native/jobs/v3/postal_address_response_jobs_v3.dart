...
class PostalAddressResponseJobsV3 {
  ...
  factory PostalAddressResponseJobsV3.fromMap(Map<String, dynamic> map) {
    return PostalAddressResponseJobsV3(
