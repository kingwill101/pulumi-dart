...
class AuditLogConfig26 {
  ...
  factory AuditLogConfig26.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig26(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType26.fromValue(map['logType'] as String),
    );
  }
}
