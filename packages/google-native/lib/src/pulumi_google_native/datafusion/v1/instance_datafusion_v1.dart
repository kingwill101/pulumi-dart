...
import 'accelerator_response_datafusion_v1.dart';
import 'crypto_key_config_response.dart';
import 'event_publish_config_response.dart';
import 'instance_datafusion_v1_args.dart';
import 'network_config_response_datafusion_v1.dart';
import 'version_response_datafusion_v1.dart';

/// Creates a new Data Fusion instance in the specified project and location.
/// Auto-naming is currently not supported for this resource.
class InstanceDatafusionV1 extends pulumi.CustomResource {
  /// List of accelerators enabled for this CDF instance.
  late final pulumi.Output<List<AcceleratorResponseDatafusionV1>> accelerators;

  /// Endpoint on which the REST APIs is accessible.
  late final pulumi.Output<String> apiEndpoint;

  /// Available versions that the instance can be upgraded to using UpdateInstanceRequest.
  late final pulumi.Output<List<VersionResponseDatafusionV1>> availableVersion;
  ...
  late final pulumi.Output<NetworkConfigResponseDatafusionV1> networkConfig;
  ...
  InstanceDatafusionV1(
    String name, {
    InstanceDatafusionV1Args? args,
    ...
    this.accelerators =
        registerOutput<List<AcceleratorResponseDatafusionV1>>('accelerators');
    this.apiEndpoint = registerOutput<String>('apiEndpoint');
    this.availableVersion =
        registerOutput<List<VersionResponseDatafusionV1>>('availableVersion');
    ...
    this.networkConfig =
        registerOutput<NetworkConfigResponseDatafusionV1>('networkConfig');
