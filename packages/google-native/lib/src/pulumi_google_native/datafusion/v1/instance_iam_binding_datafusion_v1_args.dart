...
class InstanceIamBindingDatafusionV1Args {
  ...
  InstanceIamBindingDatafusionV1Args({
    this.condition,
  ...
  factory InstanceIamBindingDatafusionV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingDatafusionV1Args(
