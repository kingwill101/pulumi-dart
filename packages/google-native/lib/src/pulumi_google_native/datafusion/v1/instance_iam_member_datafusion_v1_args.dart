...
class InstanceIamMemberDatafusionV1Args {
  ...
  InstanceIamMemberDatafusionV1Args({
    this.condition,
  ...
  factory InstanceIamMemberDatafusionV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberDatafusionV1Args(
