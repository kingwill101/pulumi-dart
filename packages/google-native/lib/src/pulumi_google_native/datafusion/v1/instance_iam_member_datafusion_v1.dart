...
import 'instance_iam_member_datafusion_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InstanceIamMemberDatafusionV1 extends pulumi.CustomResource {
  ...
  InstanceIamMemberDatafusionV1(
    String name, {
    InstanceIamMemberDatafusionV1Args? args,
