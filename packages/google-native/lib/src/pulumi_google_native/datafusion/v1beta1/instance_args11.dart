...
import 'crypto_key_config2.dart';
import 'event_publish_config2.dart';
import 'instance_type3.dart';
import 'network_config12.dart';

/// The set of arguments for Instance.
class InstanceArgs11 {
  /// The crypto key configuration. This field is used by the Customer-Managed Encryption Keys (CMEK) feature.
  final Input<CryptoKeyConfig2>? cryptoKeyConfig;
  ...
  final Input<EventPublishConfig2>? eventPublishConfig;
  ...
  final Input<NetworkConfig12>? networkConfig;
  ...
  /// Instance type.
  final Input<InstanceType3> type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (cryptoKeyConfigValue != null) {
      map['cryptoKeyConfig'] =
          Input.mapOptionalInputValue<CryptoKeyConfig2, Map<String, dynamic>>(
    ...
    if (eventPublishConfigValue != null) {
      map['eventPublishConfig'] = Input.mapOptionalInputValue<
              EventPublishConfig2, Map<String, dynamic>>(
    ...
    if (networkConfigValue != null) {
      map['networkConfig'] =
          Input.mapOptionalInputValue<NetworkConfig12, Map<String, dynamic>>(
    ...
    map['type'] = Input.mapInputValue<InstanceType3, String>(
  ...
  factory InstanceArgs11.fromMap(Map<String, dynamic> map) {
    return InstanceArgs11(
      cryptoKeyConfig:
          Input.asOptionalInput<CryptoKeyConfig2>(map['cryptoKeyConfig']),
      ...
      eventPublishConfig:
          Input.asOptionalInput<EventPublishConfig2>(map['eventPublishConfig']),
      instanceId: Input.asInput<String>(map['instanceId']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: Input.asOptionalInput<String>(map['location']),
      networkConfig:
          Input.asOptionalInput<NetworkConfig12>(map['networkConfig']),
      ...
      type: Input.asInput<InstanceType3>(map['type']),
