...
class AuditLogConfig27 {
  ...
  factory AuditLogConfig27.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig27(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType27.fromValue(map['logType'] as String),
    );
  }
}
