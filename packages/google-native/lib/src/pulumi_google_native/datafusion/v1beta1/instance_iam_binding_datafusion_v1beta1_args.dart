...
class InstanceIamBindingDatafusionV1beta1Args {
  ...
  InstanceIamBindingDatafusionV1beta1Args({
    this.condition,
  ...
  factory InstanceIamBindingDatafusionV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return InstanceIamBindingDatafusionV1beta1Args(
