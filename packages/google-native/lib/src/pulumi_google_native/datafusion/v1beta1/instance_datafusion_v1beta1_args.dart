...
class InstanceDatafusionV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (eventPublishConfigValue != null) {
      map['eventPublishConfig'] = pulumi.Input.mapOptionalInputValue<
              EventPublishConfigDatafusionV1beta1, Map<String, dynamic>>(
    ...
    map['type'] =
        pulumi.Input.mapInputValue<InstanceTypeDatafusionV1beta1, String>(
  ...
  factory InstanceDatafusionV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceDatafusionV1beta1Args(
      cryptoKeyConfig:
          pulumi.Input.asOptionalInput<CryptoKeyConfigDatafusionV1beta1>(
              map['cryptoKeyConfig']),
      ...
      eventPublishConfig:
          pulumi.Input.asOptionalInput<EventPublishConfigDatafusionV1beta1>(
              map['eventPublishConfig']),
      instanceId: pulumi.Input.asInput<String>(map['instanceId']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      networkConfig:
          pulumi.Input.asOptionalInput<NetworkConfigDatafusionV1beta1>(
              map['networkConfig']),
      options:
      ...
      type: pulumi.Input.asInput<InstanceTypeDatafusionV1beta1>(map['type']),
