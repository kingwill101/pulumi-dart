...
class Instance11 extends CustomResource {
  ...
  Instance11(
    ...
    this.accelerators =
        registerOutput<List<AcceleratorResponse3>>('accelerators');
    this.apiEndpoint = registerOutput<String>('apiEndpoint');
    this.availableVersion =
        registerOutput<List<VersionResponse5>>('availableVersion');
    this.createTime = registerOutput<String>('createTime');
    this.cryptoKeyConfig =
        registerOutput<CryptoKeyConfigResponse2>('cryptoKeyConfig');
    ...
    this.eventPublishConfig =
        registerOutput<EventPublishConfigResponse2>('eventPublishConfig');
    ...
    this.networkConfig =
        registerOutput<NetworkConfigResponse12>('networkConfig');
