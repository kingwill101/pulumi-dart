...
class Instance11 extends CustomResource {
  ...
  late final Output<List<AcceleratorResponse3>> accelerators;

  /// Endpoint on which the REST APIs is accessible.
  late final Output<String> apiEndpoint;

  /// Available versions that the instance can be upgraded to using UpdateInstanceRequest.
  late final Output<List<VersionResponse5>> availableVersion;

  /// The time the instance was created.
  late final Output<String> createTime;

  /// The crypto key configuration. This field is used by the Customer-Managed Encryption Keys (CMEK) feature.
  late final Output<CryptoKeyConfigResponse2> cryptoKeyConfig;
  ...
  late final Output<EventPublishConfigResponse2> eventPublishConfig;
  ...
  late final Output<NetworkConfigResponse12> networkConfig;
  ...
  Instance11(
    ...
    this.accelerators = Output.createUnknown<List<AcceleratorResponse3>>();
    this.apiEndpoint = Output.createUnknown<String>();
    this.availableVersion = Output.createUnknown<List<VersionResponse5>>();
    this.createTime = Output.createUnknown<String>();
    this.cryptoKeyConfig = Output.createUnknown<CryptoKeyConfigResponse2>();
    ...
    this.eventPublishConfig =
        Output.createUnknown<EventPublishConfigResponse2>();
    this.gcsBucket = Output.createUnknown<String>();
    this.instanceId = Output.createUnknown<String>();
    this.labels = Output.createUnknown<Map<String, String>>();
    this.location = Output.createUnknown<String>();
    this.name = Output.createUnknown<String>();
    this.networkConfig = Output.createUnknown<NetworkConfigResponse12>();
