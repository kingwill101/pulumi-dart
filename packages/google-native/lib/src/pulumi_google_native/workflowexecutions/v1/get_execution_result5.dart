...
class GetExecutionResult5 {
  ...
  factory GetExecutionResult5.fromMap(Map<String, dynamic> map) {
    return GetExecutionResult5(
      argument: map['argument'] as String,
      callLogLevel: map['callLogLevel'] as String,
      duration: map['duration'] as String,
      endTime: map['endTime'] as String,
      error:
          ErrorResponse3.fromMap((map['error'] as Map).cast<String, dynamic>()),
      ...
      status: StatusResponse32.fromMap(
