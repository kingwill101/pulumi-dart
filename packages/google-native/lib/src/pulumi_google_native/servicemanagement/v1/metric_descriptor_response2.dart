...
import 'metric_descriptor_metadata_response3.dart';

/// Defines a metric type and its schema. Once a metric descriptor is created, deleting or altering it stops data collection and makes the metric type's existing data unusable.
class MetricDescriptorResponse2 {
  ...
  final MetricDescriptorMetadataResponse3 metadata;
  ...
  factory MetricDescriptorResponse2.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorResponse2(
      ...
      metadata: MetricDescriptorMetadataResponse3.fromMap(
