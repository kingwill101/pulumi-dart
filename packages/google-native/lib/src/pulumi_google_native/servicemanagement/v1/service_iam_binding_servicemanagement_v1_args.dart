...
class ServiceIamBindingServicemanagementV1Args {
  ...
  ServiceIamBindingServicemanagementV1Args({
    this.condition,
  ...
  factory ServiceIamBindingServicemanagementV1Args.fromMap(
      Map<String, dynamic> map) {
    return ServiceIamBindingServicemanagementV1Args(
