...
class MonitoringResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['consumerDestinations'] =
        Input.encodeList<MonitoringDestinationResponse, Map<String, dynamic>>(
  ...
  factory MonitoringResponse.fromMap(Map<String, dynamic> map) {
    return MonitoringResponse(
      consumerDestinations: Input.decodeList<MonitoringDestinationResponse>(
          map['consumerDestinations'],
          (value) => MonitoringDestinationResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      producerDestinations: Input.decodeList<MonitoringDestinationResponse>(
          map['producerDestinations'],
          (value) => MonitoringDestinationResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
