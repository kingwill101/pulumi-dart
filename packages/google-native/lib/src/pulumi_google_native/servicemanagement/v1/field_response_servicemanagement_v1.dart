...
class FieldResponseServicemanagementV1 {
  ...
  FieldResponseServicemanagementV1({
  ...
  factory FieldResponseServicemanagementV1.fromMap(Map<String, dynamic> map) {
    return FieldResponseServicemanagementV1(
