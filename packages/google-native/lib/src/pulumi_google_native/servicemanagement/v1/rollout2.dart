...
class Rollout2 extends CustomResource {
  ...
  late final Output<Map<String, dynamic>> deleteServiceStrategy;
  ...
  late final Output<TrafficPercentStrategyResponse> trafficPercentStrategy;
