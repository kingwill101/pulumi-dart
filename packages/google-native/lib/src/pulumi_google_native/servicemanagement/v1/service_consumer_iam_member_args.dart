...
/// The set of arguments for ServiceConsumerIamMember.
class ServiceConsumerIamMemberArgs {
  ...
  factory ServiceConsumerIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConsumerIamMemberArgs(
