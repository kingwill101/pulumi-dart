...
import 'config_servicemanagement_v1_args.dart';
...
class ConfigServicemanagementV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BackendResponseServicemanagementV1> backend;
  ...
  late final pulumi.Output<DocumentationResponseServicemanagementV1>
      documentation;

  /// Configuration for network endpoints. If this is empty, then an endpoint with the same name as the service is automatically generated to service all defined APIs.
  late final pulumi.Output<List<EndpointResponseServicemanagementV1>> endpoints;
  ...
  late final pulumi.Output<List<MetricDescriptorResponseServicemanagementV1>>
      metrics;
  ...
  late final pulumi.Output<List<TypeResponseServicemanagementV1>> systemTypes;

  /// The product title for this service, it is the name displayed in Google Cloud Console.
  late final pulumi.Output<String> title;

  /// A list of all proto message types included in this API service. Types referenced directly or indirectly by the `apis` are automatically included. Messages which are not referenced but shall be included, such as types used by the `google.protobuf.Any` type, should be listed here by name by the configuration author. Example: types: - name: google.protobuf.Int32
  late final pulumi.Output<List<TypeResponseServicemanagementV1>> types;

  /// Configuration controlling usage of this service.
  late final pulumi.Output<UsageResponse> usage;

  ConfigServicemanagementV1(
    String name, {
    ConfigServicemanagementV1Args? args,
    ...
    this.backend =
        registerOutput<BackendResponseServicemanagementV1>('backend');
    ...
    this.documentation =
        registerOutput<DocumentationResponseServicemanagementV1>(
            'documentation');
    this.endpoints =
        registerOutput<List<EndpointResponseServicemanagementV1>>('endpoints');
    ...
    this.metrics =
        registerOutput<List<MetricDescriptorResponseServicemanagementV1>>(
            'metrics');
    ...
    this.systemTypes =
        registerOutput<List<TypeResponseServicemanagementV1>>('systemTypes');
    this.title = registerOutput<String>('title');
    this.types = registerOutput<List<TypeResponseServicemanagementV1>>('types');
