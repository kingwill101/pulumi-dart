...
class DotnetSettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['forcedNamespaceAliases'] = forcedNamespaceAliases;
    map['handwrittenSignatures'] = handwrittenSignatures;
    map['ignoredResources'] = ignoredResources;
    map['renamedResources'] = renamedResources;
    map['renamedServices'] = renamedServices;
    return map;
  }
