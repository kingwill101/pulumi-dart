...
import 'metric_descriptor_metadata_launch_stage_servicemanagement_v1.dart';

/// Additional annotations that can be used to guide the usage of a metric.
class MetricDescriptorMetadataServicemanagementV1 {
  /// The delay of data points caused by ingestion. Data points older than this age are guaranteed to be ingested and available to be read, excluding data loss due to errors.
  final String? ingestDelay;

  /// Deprecated. Must use the MetricDescriptor.launch_stage instead.
  final MetricDescriptorMetadataLaunchStageServicemanagementV1? launchStage;

  /// The sampling period of metric data points. For metrics which are written periodically, consecutive data points are stored at this time interval, excluding data loss due to errors. Metrics with a higher granularity have a smaller sampling period.
  final String? samplePeriod;

  MetricDescriptorMetadataServicemanagementV1({
    this.ingestDelay,
    this.launchStage,
    this.samplePeriod,
  });
  ...
  factory MetricDescriptorMetadataServicemanagementV1.fromMap(
      Map<String, dynamic> map) {
    return MetricDescriptorMetadataServicemanagementV1(
      ingestDelay:
          map['ingestDelay'] == null ? null : map['ingestDelay'] as String,
      launchStage: map['launchStage'] == null
          ? null
          : MetricDescriptorMetadataLaunchStageServicemanagementV1.fromValue(
