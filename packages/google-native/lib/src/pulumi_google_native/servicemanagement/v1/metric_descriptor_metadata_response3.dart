...
class MetricDescriptorMetadataResponse3 {
  ...
  MetricDescriptorMetadataResponse3({
  ...
  factory MetricDescriptorMetadataResponse3.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorMetadataResponse3(
