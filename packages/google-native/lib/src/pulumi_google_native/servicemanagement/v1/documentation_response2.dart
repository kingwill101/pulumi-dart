...
class DocumentationResponse2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['pages'] = Input.encodeList<PageResponse, Map<String, dynamic>>(
        pages, (value) => value.toMap());
    map['rules'] =
        Input.encodeList<DocumentationRuleResponse, Map<String, dynamic>>(
            rules, (value) => value.toMap());
    map['sectionOverrides'] =
        Input.encodeList<PageResponse, Map<String, dynamic>>(
  ...
  factory DocumentationResponse2.fromMap(Map<String, dynamic> map) {
    return DocumentationResponse2(
      documentationRootUrl: map['documentationRootUrl'] as String,
      overview: map['overview'] as String,
      pages: Input.decodeList<PageResponse>(
          map['pages'],
          (value) =>
              PageResponse.fromMap((value as Map).cast<String, dynamic>())),
      rules: Input.decodeList<DocumentationRuleResponse>(
          map['rules'],
          (value) => DocumentationRuleResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      sectionOverrides: Input.decodeList<PageResponse>(
          map['sectionOverrides'],
          (value) =>
              PageResponse.fromMap((value as Map).cast<String, dynamic>())),
