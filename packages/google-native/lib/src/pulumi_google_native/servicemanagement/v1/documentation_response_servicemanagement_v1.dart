...
class DocumentationResponseServicemanagementV1 {
  ...
  DocumentationResponseServicemanagementV1({
  ...
  factory DocumentationResponseServicemanagementV1.fromMap(
      Map<String, dynamic> map) {
    return DocumentationResponseServicemanagementV1(
