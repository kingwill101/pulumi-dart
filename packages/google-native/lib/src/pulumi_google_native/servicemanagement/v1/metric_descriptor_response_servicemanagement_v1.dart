...
import 'metric_descriptor_metadata_response_servicemanagement_v1.dart';

/// Defines a metric type and its schema. Once a metric descriptor is created, deleting or altering it stops data collection and makes the metric type's existing data unusable.
class MetricDescriptorResponseServicemanagementV1 {
  ...
  final MetricDescriptorMetadataResponseServicemanagementV1 metadata;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['monitoredResourceTypes'] = monitoredResourceTypes;
    map['name'] = name;
    map['type'] = type;
    map['unit'] = unit;
  ...
  factory MetricDescriptorResponseServicemanagementV1.fromMap(
      Map<String, dynamic> map) {
    return MetricDescriptorResponseServicemanagementV1(
      ...
      metadata: MetricDescriptorMetadataResponseServicemanagementV1.fromMap(
