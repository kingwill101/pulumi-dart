...
class GetRolloutServicemanagementV1Result {
  ...
  GetRolloutServicemanagementV1Result({
  ...
  factory GetRolloutServicemanagementV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetRolloutServicemanagementV1Result(
