...
class AuditLogConfig67 {
  ...
  factory AuditLogConfig67.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig67(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType67.fromValue(map['logType'] as String),
    );
  }
}
