...
class GetBucketResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['acl'] =
        Input.encodeList<BucketAccessControlResponse, Map<String, dynamic>>(
            acl, (value) => value.toMap());
    map['autoclass'] = autoclass.toMap();
    map['billing'] = billing.toMap();
    map['cors'] =
        Input.encodeList<BucketCorsItemResponse, Map<String, dynamic>>(
            cors, (value) => value.toMap());
    map['customPlacementConfig'] = customPlacementConfig.toMap();
    ...
    map['defaultObjectAcl'] =
        Input.encodeList<ObjectAccessControlResponse, Map<String, dynamic>>(
            defaultObjectAcl, (value) => value.toMap());
    map['encryption'] = encryption.toMap();
    map['etag'] = etag;
    map['iamConfiguration'] = iamConfiguration.toMap();
    map['kind'] = kind;
    map['labels'] = labels;
    map['lifecycle'] = lifecycle.toMap();
    map['location'] = location;
    map['locationType'] = locationType;
    map['logging'] = logging.toMap();
    map['metageneration'] = metageneration;
    map['name'] = name;
    map['objectRetention'] = objectRetention.toMap();
    ...
    map['softDeletePolicy'] = softDeletePolicy.toMap();
    map['storageClass'] = storageClass;
    map['timeCreated'] = timeCreated;
    map['updated'] = updated;
    map['versioning'] = versioning.toMap();
    map['website'] = website.toMap();
    return map;
  }

  factory GetBucketResult2.fromMap(Map<String, dynamic> map) {
    return GetBucketResult2(
      acl: Input.decodeList<BucketAccessControlResponse>(
          map['acl'],
          (value) => BucketAccessControlResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      autoclass: BucketAutoclassResponse.fromMap(
          (map['autoclass'] as Map).cast<String, dynamic>()),
      billing: BucketBillingResponse.fromMap(
          (map['billing'] as Map).cast<String, dynamic>()),
      cors: Input.decodeList<BucketCorsItemResponse>(
          map['cors'],
          (value) => BucketCorsItemResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      customPlacementConfig: BucketCustomPlacementConfigResponse.fromMap(
          (map['customPlacementConfig'] as Map).cast<String, dynamic>()),
      defaultEventBasedHold: map['defaultEventBasedHold'] as bool,
      defaultObjectAcl: Input.decodeList<ObjectAccessControlResponse>(
          map['defaultObjectAcl'],
          (value) => ObjectAccessControlResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      encryption: BucketEncryptionResponse.fromMap(
          (map['encryption'] as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      iamConfiguration: BucketIamConfigurationResponse.fromMap(
          (map['iamConfiguration'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      lifecycle: BucketLifecycleResponse.fromMap(
          (map['lifecycle'] as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      locationType: map['locationType'] as String,
      logging: BucketLoggingResponse.fromMap(
          (map['logging'] as Map).cast<String, dynamic>()),
      metageneration: map['metageneration'] as String,
      name: map['name'] as String,
      objectRetention: BucketObjectRetentionResponse.fromMap(
          (map['objectRetention'] as Map).cast<String, dynamic>()),
      owner: BucketOwnerResponse.fromMap(
          (map['owner'] as Map).cast<String, dynamic>()),
      projectNumber: map['projectNumber'] as String,
      retentionPolicy: BucketRetentionPolicyResponse.fromMap(
          (map['retentionPolicy'] as Map).cast<String, dynamic>()),
      rpo: map['rpo'] as String,
      satisfiesPZS: map['satisfiesPZS'] as bool,
      selfLink: map['selfLink'] as String,
      softDeletePolicy: BucketSoftDeletePolicyResponse.fromMap(
      ...
      versioning: BucketVersioningResponse.fromMap(
          (map['versioning'] as Map).cast<String, dynamic>()),
      website: BucketWebsiteResponse.fromMap(
