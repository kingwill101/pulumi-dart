...
class BucketArgs2 {
  ...
  final Input<List<BucketAccessControl>>? acl;

  /// The bucket's Autoclass configuration.
  final Input<BucketAutoclass>? autoclass;

  /// The bucket's billing configuration.
  final Input<BucketBilling>? billing;

  /// The bucket's Cross-Origin Resource Sharing (CORS) configuration.
  final Input<List<BucketCorsItem>>? cors;
  ...
  final Input<List<ObjectAccessControl>>? defaultObjectAcl;
  ...
  final Input<BucketIamConfiguration>? iamConfiguration;
  ...
  final Input<BucketLifecycle>? lifecycle;
  ...
  final Input<BucketObjectRetention>? objectRetention;

  /// The owner of the bucket. This is always the project team's owner group.
  final Input<BucketOwner>? owner;

  /// Apply a predefined set of access controls to this bucket.
  final Input<String>? predefinedAcl;

  /// Apply a predefined set of default object access controls to this bucket.
  final Input<String>? predefinedDefaultObjectAcl;
  ...
  Map<String, dynamic> toMap() {
    ...
    final aclValue = acl;
    if (aclValue != null) {
      map['acl'] = Input.mapOptionalInputValue<List<BucketAccessControl>,
              List<Map<String, dynamic>>>(
          aclValue,
          (value) =>
              Input.encodeList<BucketAccessControl, Map<String, dynamic>>(
    ...
    if (billingValue != null) {
      map['billing'] =
          Input.mapOptionalInputValue<BucketBilling, Map<String, dynamic>>(
              billingValue, (value) => value.toMap());
    }
    final corsValue = cors;
    if (corsValue != null) {
      map['cors'] = Input.mapOptionalInputValue<List<BucketCorsItem>,
              List<Map<String, dynamic>>>(
          corsValue,
          (value) => Input.encodeList<BucketCorsItem, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (defaultObjectAclValue != null) {
      map['defaultObjectAcl'] = Input.mapOptionalInputValue<
    ...
    if (iamConfigurationValue != null) {
      map['iamConfiguration'] = Input.mapOptionalInputValue<
    ...
    if (lifecycleValue != null) {
      map['lifecycle'] =
          Input.mapOptionalInputValue<BucketLifecycle, Map<String, dynamic>>(
              lifecycleValue, (value) => value.toMap());
    }
    ...
    if (objectRetentionValue != null) {
      map['objectRetention'] = Input.mapOptionalInputValue<
    ...
    if (ownerValue != null) {
      map['owner'] =
          Input.mapOptionalInputValue<BucketOwner, Map<String, dynamic>>(
  ...
  factory BucketArgs2.fromMap(Map<String, dynamic> map) {
    return BucketArgs2(
      acl: Input.asOptionalInput<List<BucketAccessControl>>(map['acl']),
      autoclass: Input.asOptionalInput<BucketAutoclass>(map['autoclass']),
      billing: Input.asOptionalInput<BucketBilling>(map['billing']),
      cors: Input.asOptionalInput<List<BucketCorsItem>>(map['cors']),
      ...
      defaultObjectAcl: Input.asOptionalInput<List<ObjectAccessControl>>(
      ...
      iamConfiguration: Input.asOptionalInput<BucketIamConfiguration>(
          map['iamConfiguration']),
      id: Input.asOptionalInput<String>(map['id']),
      kind: Input.asOptionalInput<String>(map['kind']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      lifecycle: Input.asOptionalInput<BucketLifecycle>(map['lifecycle']),
      ...
      objectRetention:
          Input.asOptionalInput<BucketObjectRetention>(map['objectRetention']),
      owner: Input.asOptionalInput<BucketOwner>(map['owner']),
      predefinedAcl: Input.asOptionalInput<String>(map['predefinedAcl']),
      predefinedDefaultObjectAcl:
          Input.asOptionalInput<String>(map['predefinedDefaultObjectAcl']),
