...
class GetBucketObjectResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['crc32c'] = crc32c;
    map['customTime'] = customTime;
    map['customerEncryption'] = customerEncryption.toMap();
    map['etag'] = etag;
    ...
    map['retention'] = retention.toMap();
    map['retentionExpirationTime'] = retentionExpirationTime;
    map['selfLink'] = selfLink;
    map['size'] = size;
    map['softDeleteTime'] = softDeleteTime;
    map['storageClass'] = storageClass;
    map['temporaryHold'] = temporaryHold;
    map['timeCreated'] = timeCreated;
    map['timeDeleted'] = timeDeleted;
    map['timeStorageClassUpdated'] = timeStorageClassUpdated;
    map['updated'] = updated;
    return map;
  }
  ...
  factory GetBucketObjectResult.fromMap(Map<String, dynamic> map) {
    return GetBucketObjectResult(
      ...
      customerEncryption: BucketObjectCustomerEncryptionResponse.fromMap(
      ...
      owner: BucketObjectOwnerResponse.fromMap(
          (map['owner'] as Map).cast<String, dynamic>()),
      retention: BucketObjectRetentionResponse.fromMap(
