...
class AuditLogConfig10 {
  ...
  factory AuditLogConfig10.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig10(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType10.fromValue(map['logType'] as String),
    );
  }
}
