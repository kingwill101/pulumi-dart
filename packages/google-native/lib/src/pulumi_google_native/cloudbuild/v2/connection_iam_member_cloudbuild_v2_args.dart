...
class ConnectionIamMemberCloudbuildV2Args {
  ...
  ConnectionIamMemberCloudbuildV2Args({
    this.condition,
  ...
  factory ConnectionIamMemberCloudbuildV2Args.fromMap(
      Map<String, dynamic> map) {
    return ConnectionIamMemberCloudbuildV2Args(
