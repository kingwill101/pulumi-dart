...
class ConnectionIamBindingCloudbuildV2Args {
  ...
  ConnectionIamBindingCloudbuildV2Args({
    this.condition,
  ...
  factory ConnectionIamBindingCloudbuildV2Args.fromMap(
      Map<String, dynamic> map) {
    return ConnectionIamBindingCloudbuildV2Args(
