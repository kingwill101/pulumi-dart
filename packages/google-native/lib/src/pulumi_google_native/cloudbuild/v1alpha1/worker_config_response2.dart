...
import 'network_response3.dart';

/// WorkerConfig defines the configuration to be used for a creating workers in the pool.
class WorkerConfigResponse2 {
  ...
  final NetworkResponse3 network;
  ...
  factory WorkerConfigResponse2.fromMap(Map<String, dynamic> map) {
    return WorkerConfigResponse2(
      diskSizeGb: map['diskSizeGb'] as String,
      machineType: map['machineType'] as String,
      network: NetworkResponse3.fromMap(
