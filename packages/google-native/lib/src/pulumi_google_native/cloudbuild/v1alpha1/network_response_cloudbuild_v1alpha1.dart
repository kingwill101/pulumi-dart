...
class NetworkResponseCloudbuildV1alpha1 {
  ...
  NetworkResponseCloudbuildV1alpha1({
  ...
  factory NetworkResponseCloudbuildV1alpha1.fromMap(Map<String, dynamic> map) {
    return NetworkResponseCloudbuildV1alpha1(
