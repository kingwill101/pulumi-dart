...
import 'network_response_cloudbuild_v1alpha1.dart';
...
class WorkerConfigResponseCloudbuildV1alpha1 {
  ...
  final NetworkResponseCloudbuildV1alpha1 network;
  ...
  factory WorkerConfigResponseCloudbuildV1alpha1.fromMap(
      Map<String, dynamic> map) {
    return WorkerConfigResponseCloudbuildV1alpha1(
      diskSizeGb: map['diskSizeGb'] as String,
      machineType: map['machineType'] as String,
      network: NetworkResponseCloudbuildV1alpha1.fromMap(
