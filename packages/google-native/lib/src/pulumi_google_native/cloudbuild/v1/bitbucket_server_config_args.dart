  ...
  factory BitbucketServerConfigArgs.fromMap(Map<String, dynamic> map) {
    return BitbucketServerConfigArgs(
      ...
      bitbucketServerConfigId:
          pulumi.Input.asOptionalInput<String>(map['bitbucketServerConfigId']),
      ...
      peeredNetworkIpRange:
          pulumi.Input.asOptionalInput<String>(map['peeredNetworkIpRange']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      secrets: pulumi.Input.asInput<BitbucketServerSecrets>(map['secrets']),
