...
class TriggerCloudbuildV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BuildResponseCloudbuildV1> build;
  ...
  TriggerCloudbuildV1(
    ...
    this.bitbucketServerTriggerConfig =
        registerOutput<BitbucketServerTriggerConfigResponse>(
            'bitbucketServerTriggerConfig');
    this.build = registerOutput<BuildResponseCloudbuildV1>('build');
