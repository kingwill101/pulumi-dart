...
class GithubEnterpriseConfigArgs {
  ...
  factory GithubEnterpriseConfigArgs.fromMap(Map<String, dynamic> map) {
    return GithubEnterpriseConfigArgs(
      ...
      gheConfigId: pulumi.Input.asOptionalInput<String>(map['gheConfigId']),
      hostUrl: pulumi.Input.asOptionalInput<String>(map['hostUrl']),
      ...
      secrets:
          pulumi.Input.asOptionalInput<GitHubEnterpriseSecrets>(map['secrets']),
      sslCa: pulumi.Input.asOptionalInput<String>(map['sslCa']),
      webhookKey: pulumi.Input.asOptionalInput<String>(map['webhookKey']),
    );
  }
}
