...
class EntitlementArgs {
  ...
  final pulumi.Input<GoogleCloudChannelV1CommitmentSettings>?
      commitmentSettings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (associationInfoValue != null) {
      map['associationInfo'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (commitmentSettingsValue != null) {
      map['commitmentSettings'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (parametersValue != null) {
      map['parameters'] = pulumi.Input.mapOptionalInputValue<
          ...
          parametersValue,
          (value) => pulumi.Input.encodeList<GoogleCloudChannelV1Parameter,
  ...
  factory EntitlementArgs.fromMap(Map<String, dynamic> map) {
    return EntitlementArgs(
      ...
      associationInfo:
          pulumi.Input.asOptionalInput<GoogleCloudChannelV1AssociationInfo>(
              map['associationInfo']),
      billingAccount:
          pulumi.Input.asOptionalInput<String>(map['billingAccount']),
      commitmentSettings:
          pulumi.Input.asOptionalInput<GoogleCloudChannelV1CommitmentSettings>(
              map['commitmentSettings']),
      customerId: pulumi.Input.asInput<String>(map['customerId']),
      offer: pulumi.Input.asInput<String>(map['offer']),
      parameters:
          pulumi.Input.asOptionalInput<List<GoogleCloudChannelV1Parameter>>(
              map['parameters']),
      purchaseOrderId:
          pulumi.Input.asOptionalInput<String>(map['purchaseOrderId']),
