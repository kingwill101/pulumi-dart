...
class OrganizationRoleArgs {
  ...
  final Input<OrganizationRoleStage>? stage;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (stageValue != null) {
      map['stage'] = Input.mapOptionalInputValue<OrganizationRoleStage, String>(
  ...
  factory OrganizationRoleArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationRoleArgs(
      ...
      stage: Input.asOptionalInput<OrganizationRoleStage>(map['stage']),
