...
class AuditLogConfig48 {
  ...
  factory AuditLogConfig48.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig48(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType48.fromValue(map['logType'] as String),
    );
  }
}
