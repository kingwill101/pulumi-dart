...
class WorkforcePoolProvider extends CustomResource {
  ...
  late final Output<GoogleIamAdminV1WorkforcePoolProviderOidcResponse> oidc;

  /// A SAML identity provider configuration.
  late final Output<GoogleIamAdminV1WorkforcePoolProviderSamlResponse> saml;
  ...
  late final Output<String> workforcePoolProviderId;
