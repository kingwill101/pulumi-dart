...
class AuditLogConfigIamV1 {
  ...
  factory AuditLogConfigIamV1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigIamV1(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogTypeIamV1.fromValue(map['logType'] as String),
    );
  }
}
