...
class WorkforcePoolArgs {
  ...
  final Input<AccessRestrictions>? accessRestrictions;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessRestrictionsValue != null) {
      map['accessRestrictions'] =
          Input.mapOptionalInputValue<AccessRestrictions, Map<String, dynamic>>(
  ...
  factory WorkforcePoolArgs.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolArgs(
      accessRestrictions:
          Input.asOptionalInput<AccessRestrictions>(map['accessRestrictions']),
      ...
      workforcePoolId: Input.asOptionalInput<String>(map['workforcePoolId']),
    );
  }
}
