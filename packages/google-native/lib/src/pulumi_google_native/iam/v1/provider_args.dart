...
class ProviderArgs {
  ...
  final Input<Oidc>? oidc;
  final Input<String>? project;

  /// An SAML 2.0 identity provider.
  final Input<Saml>? saml;
  ...
  Map<String, dynamic> toMap() {
    ...
    final awsValue = aws;
    if (awsValue != null) {
      map['aws'] = Input.mapOptionalInputValue<Aws, Map<String, dynamic>>(
    ...
    if (oidcValue != null) {
      map['oidc'] = Input.mapOptionalInputValue<Oidc, Map<String, dynamic>>(
    ...
    if (samlValue != null) {
      map['saml'] = Input.mapOptionalInputValue<Saml, Map<String, dynamic>>(
  ...
  factory ProviderArgs.fromMap(Map<String, dynamic> map) {
    return ProviderArgs(
      ...
      aws: Input.asOptionalInput<Aws>(map['aws']),
      description: Input.asOptionalInput<String>(map['description']),
      disabled: Input.asOptionalInput<bool>(map['disabled']),
      displayName: Input.asOptionalInput<String>(map['displayName']),
      location: Input.asOptionalInput<String>(map['location']),
      oidc: Input.asOptionalInput<Oidc>(map['oidc']),
      project: Input.asOptionalInput<String>(map['project']),
      saml: Input.asOptionalInput<Saml>(map['saml']),
