...
class WorkforcePoolProviderArgs {
  ...
  factory WorkforcePoolProviderArgs.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolProviderArgs(
      ...
      attributeMapping:
          pulumi.Input.asInput<Map<String, String>>(map['attributeMapping']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      disabled: pulumi.Input.asOptionalInput<bool>(map['disabled']),
      displayName: pulumi.Input.asOptionalInput<String>(map['displayName']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      oidc: pulumi.Input.asOptionalInput<
          GoogleIamAdminV1WorkforcePoolProviderOidc>(map['oidc']),
      saml: pulumi.Input.asOptionalInput<
          GoogleIamAdminV1WorkforcePoolProviderSaml>(map['saml']),
      workforcePoolId: pulumi.Input.asInput<String>(map['workforcePoolId']),
      workforcePoolProviderId:
          pulumi.Input.asInput<String>(map['workforcePoolProviderId']),
    );
  }
}
