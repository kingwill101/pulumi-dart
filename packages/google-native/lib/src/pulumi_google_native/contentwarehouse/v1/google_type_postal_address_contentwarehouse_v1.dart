...
class GoogleTypePostalAddressContentwarehouseV1 {
  ...
  GoogleTypePostalAddressContentwarehouseV1({
    this.addressLines,
  ...
  Map<String, dynamic> toMap() {
    ...
    final addressLinesValue = addressLines;
    if (addressLinesValue != null) {
      map['addressLines'] = addressLinesValue;
    }
    final administrativeAreaValue = administrativeArea;
    if (administrativeAreaValue != null) {
      map['administrativeArea'] = administrativeAreaValue;
    }
    ...
    final sortingCodeValue = sortingCode;
    if (sortingCodeValue != null) {
      map['sortingCode'] = sortingCodeValue;
    }
    final sublocalityValue = sublocality;
    if (sublocalityValue != null) {
      map['sublocality'] = sublocalityValue;
    }
    return map;
  }

  factory GoogleTypePostalAddressContentwarehouseV1.fromMap(
      Map<String, dynamic> map) {
    return GoogleTypePostalAddressContentwarehouseV1(
      ...
      sortingCode:
          map['sortingCode'] == null ? null : map['sortingCode'] as String,
      sublocality:
          map['sublocality'] == null ? null : map['sublocality'] as String,
    );
  }
}
