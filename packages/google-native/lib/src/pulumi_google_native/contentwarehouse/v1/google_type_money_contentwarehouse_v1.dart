...
class GoogleTypeMoneyContentwarehouseV1 {
  ...
  GoogleTypeMoneyContentwarehouseV1({
    this.currencyCode,
    this.nanos,
    this.units,
  });
  ...
  factory GoogleTypeMoneyContentwarehouseV1.fromMap(Map<String, dynamic> map) {
    return GoogleTypeMoneyContentwarehouseV1(
      currencyCode:
