...
class GoogleTypePostalAddressResponseContentwarehouseV1 {
  ...
  GoogleTypePostalAddressResponseContentwarehouseV1({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['sortingCode'] = sortingCode;
    map['sublocality'] = sublocality;
    return map;
  }

  factory GoogleTypePostalAddressResponseContentwarehouseV1.fromMap(
      Map<String, dynamic> map) {
    return GoogleTypePostalAddressResponseContentwarehouseV1(
      addressLines: (map['addressLines'] as List).cast<String>(),
      administrativeArea: map['administrativeArea'] as String,
      languageCode: map['languageCode'] as String,
      locality: map['locality'] as String,
      organization: map['organization'] as String,
      postalCode: map['postalCode'] as String,
      recipients: (map['recipients'] as List).cast<String>(),
      regionCode: map['regionCode'] as String,
      revision: map['revision'] as int,
      sortingCode: map['sortingCode'] as String,
