  ...
  factory DocumentArgs.fromMap(Map<String, dynamic> map) {
    return DocumentArgs(
      ...
      contentCategory: pulumi.Input.asOptionalInput<DocumentContentCategory>(
          map['contentCategory']),
      createMask: pulumi.Input.asOptionalInput<String>(map['createMask']),
      creator: pulumi.Input.asOptionalInput<String>(map['creator']),
      displayName: pulumi.Input.asInput<String>(map['displayName']),
      displayUri: pulumi.Input.asOptionalInput<String>(map['displayUri']),
      documentSchemaName:
          pulumi.Input.asOptionalInput<String>(map['documentSchemaName']),
      inlineRawDocument:
          pulumi.Input.asOptionalInput<String>(map['inlineRawDocument']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      plainText: pulumi.Input.asOptionalInput<String>(map['plainText']),
      policy: pulumi.Input.asOptionalInput<GoogleIamV1Policy>(map['policy']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      properties: pulumi.Input.asOptionalInput<
          List<GoogleCloudContentwarehouseV1Property>>(map['properties']),
      rawDocumentFileType:
          pulumi.Input.asOptionalInput<DocumentRawDocumentFileType>(
              map['rawDocumentFileType']),
      rawDocumentPath:
          pulumi.Input.asOptionalInput<String>(map['rawDocumentPath']),
      referenceId: pulumi.Input.asOptionalInput<String>(map['referenceId']),
      requestMetadata: pulumi.Input.asOptionalInput<
          GoogleCloudContentwarehouseV1RequestMetadata>(map['requestMetadata']),
      textExtractionDisabled:
          pulumi.Input.asOptionalInput<bool>(map['textExtractionDisabled']),
      textExtractionEnabled:
          pulumi.Input.asOptionalInput<bool>(map['textExtractionEnabled']),
      title: pulumi.Input.asOptionalInput<String>(map['title']),
      updater: pulumi.Input.asOptionalInput<String>(map['updater']),
    );
  }
}
