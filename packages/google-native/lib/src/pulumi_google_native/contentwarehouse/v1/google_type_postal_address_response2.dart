...
class GoogleTypePostalAddressResponse2 {
  ...
  GoogleTypePostalAddressResponse2({
  ...
  factory GoogleTypePostalAddressResponse2.fromMap(Map<String, dynamic> map) {
    return GoogleTypePostalAddressResponse2(
