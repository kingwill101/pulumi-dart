...
class GoogleCloudContentwarehouseV1CloudAIDocumentOption {
  ...
  Map<String, dynamic> toMap() {
    ...
    final customizedEntitiesPropertiesConversionsValue =
        customizedEntitiesPropertiesConversions;
    if (customizedEntitiesPropertiesConversionsValue != null) {
      map['customizedEntitiesPropertiesConversions'] =
          customizedEntitiesPropertiesConversionsValue;
    }
    final enableEntitiesConversionsValue = enableEntitiesConversions;
    if (enableEntitiesConversionsValue != null) {
      map['enableEntitiesConversions'] = enableEntitiesConversionsValue;
    }
    return map;
  }
