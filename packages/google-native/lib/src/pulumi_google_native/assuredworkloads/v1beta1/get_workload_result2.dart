...
class GetWorkloadResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['cjisSettings'] = cjisSettings.toMap();
    ...
    map['etag'] = etag;
    map['fedrampHighSettings'] = fedrampHighSettings.toMap();
    map['fedrampModerateSettings'] = fedrampModerateSettings.toMap();
    map['il4Settings'] = il4Settings.toMap();
  ...
  factory GetWorkloadResult2.fromMap(Map<String, dynamic> map) {
    return GetWorkloadResult2(
      billingAccount: map['billingAccount'] as String,
      cjisSettings:
          GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsResponse
              .fromMap((map['cjisSettings'] as Map).cast<String, dynamic>()),
