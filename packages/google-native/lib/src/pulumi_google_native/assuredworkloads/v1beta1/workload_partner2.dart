...
enum WorkloadPartner2 {
  ...
  const WorkloadPartner2(this.value);
  final String value;

  static WorkloadPartner2 fromValue(String value) {
    for (final item in WorkloadPartner2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown WorkloadPartner2 value: $value');
  }
}
