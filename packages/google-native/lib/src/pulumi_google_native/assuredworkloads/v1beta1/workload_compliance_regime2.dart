...
enum WorkloadComplianceRegime2 {
  ...
  const WorkloadComplianceRegime2(this.value);
  final String value;

  static WorkloadComplianceRegime2 fromValue(String value) {
    for (final item in WorkloadComplianceRegime2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown WorkloadComplianceRegime2 value: $value');
  }
}
