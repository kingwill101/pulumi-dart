...
class WorkloadArgs {
  ...
  final Input<WorkloadComplianceRegime> complianceRegime;
  ...
  final Input<GoogleCloudAssuredworkloadsV1WorkloadKMSSettings>? kmsSettings;
  ...
  final Input<WorkloadPartner>? partner;

  /// Optional. Permissions granted to the AW Partner SA account for the customer workload
  final Input<GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissions>?
      partnerPermissions;
  ...
  final Input<List<GoogleCloudAssuredworkloadsV1WorkloadResourceSettings>>?
      resourceSettings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['complianceRegime'] =
        Input.mapInputValue<WorkloadComplianceRegime, String>(
    ...
    if (partnerValue != null) {
      map['partner'] = Input.mapOptionalInputValue<WorkloadPartner, String>(
  ...
  factory WorkloadArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadArgs(
      ...
      complianceRegime:
          Input.asInput<WorkloadComplianceRegime>(map['complianceRegime']),
      ...
      partner: Input.asOptionalInput<WorkloadPartner>(map['partner']),
