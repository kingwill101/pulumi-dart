...
import 'featurestore_entity_type_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class FeaturestoreEntityTypeIamBinding2 extends CustomResource {
  ...
  FeaturestoreEntityTypeIamBinding2(
    String name, {
    FeaturestoreEntityTypeIamBindingArgs2? args,
