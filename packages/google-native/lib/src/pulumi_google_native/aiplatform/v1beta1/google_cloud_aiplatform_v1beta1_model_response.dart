...
class GoogleCloudAiplatformV1beta1ModelResponse {
  ...
  final List<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>
      deployedModels;
  ...
  final GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse
      originalModelInfo;
  ...
  final List<GoogleCloudAiplatformV1beta1ModelExportFormatResponse>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['modelSourceInfo'] = modelSourceInfo.toMap();
    map['name'] = name;
    map['originalModelInfo'] = originalModelInfo.toMap();
    ...
    map['supportedOutputStorageFormats'] = supportedOutputStorageFormats;
    map['trainingPipeline'] = trainingPipeline;
    map['updateTime'] = updateTime;
    map['versionAliases'] = versionAliases;
    map['versionCreateTime'] = versionCreateTime;
    map['versionDescription'] = versionDescription;
    map['versionId'] = versionId;
    map['versionUpdateTime'] = versionUpdateTime;
    return map;
  }
