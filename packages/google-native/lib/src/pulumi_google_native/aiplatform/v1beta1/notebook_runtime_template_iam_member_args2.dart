...
class NotebookRuntimeTemplateIamMemberArgs2 {
  ...
  NotebookRuntimeTemplateIamMemberArgs2({
    this.condition,
  ...
  factory NotebookRuntimeTemplateIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return NotebookRuntimeTemplateIamMemberArgs2(
