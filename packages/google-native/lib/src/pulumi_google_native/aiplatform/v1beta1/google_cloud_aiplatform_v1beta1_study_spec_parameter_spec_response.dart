...
import 'google_cloud_aiplatform_v1beta1_study_spec_parameter_spec_double_value_spec_response.dart';
import 'google_cloud_aiplatform_v1beta1_study_spec_parameter_spec_integer_value_spec_response.dart';

/// Represents a single parameter to optimize.
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse {
  /// The value spec for a 'CATEGORICAL' parameter.
  final GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpecResponse
  ...
  final GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecResponse
      discreteValueSpec;

  /// The value spec for a 'DOUBLE' parameter.
  final GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpecResponse
      doubleValueSpec;

  /// The value spec for an 'INTEGER' parameter.
  final GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpecResponse
      integerValueSpec;
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse(
      categoricalValueSpec:
