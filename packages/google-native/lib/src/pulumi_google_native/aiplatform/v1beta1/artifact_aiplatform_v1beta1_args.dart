...
class ArtifactAiplatformV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (stateValue != null) {
      map['state'] = pulumi.Input.mapOptionalInputValue<
          ArtifactStateAiplatformV1beta1,
  ...
  factory ArtifactAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ArtifactAiplatformV1beta1Args(
      artifactId: pulumi.Input.asOptionalInput<String>(map['artifactId']),
      ...
      state: pulumi.Input.asOptionalInput<ArtifactStateAiplatformV1beta1>(
          map['state']),
