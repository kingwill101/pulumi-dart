...
class FeaturestoreIamBindingArgs2 {
  ...
  factory FeaturestoreIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamBindingArgs2(
