...
class EndpointAiplatformV1beta1Args {
  ...
  final pulumi
      .Input<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (predictRequestResponseLoggingConfigValue != null) {
      map['predictRequestResponseLoggingConfig'] = pulumi
  ...
  factory EndpointAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointAiplatformV1beta1Args(
      ...
      endpointId: pulumi.Input.asOptionalInput<String>(map['endpointId']),
      etag: pulumi.Input.asOptionalInput<String>(map['etag']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      network: pulumi.Input.asOptionalInput<String>(map['network']),
      predictRequestResponseLoggingConfig: pulumi.Input.asOptionalInput<
              GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig>(
          map['predictRequestResponseLoggingConfig']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      trafficSplit: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['trafficSplit']),
    );
  }
}
