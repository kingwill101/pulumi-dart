...
class GoogleCloudAiplatformV1beta1FeatureStatsAnomaly {
  ...
  Map<String, dynamic> toMap() {
    ...
    final anomalyDetectionThresholdValue = anomalyDetectionThreshold;
    if (anomalyDetectionThresholdValue != null) {
      map['anomalyDetectionThreshold'] = anomalyDetectionThresholdValue;
    }
    final anomalyUriValue = anomalyUri;
    if (anomalyUriValue != null) {
      map['anomalyUri'] = anomalyUriValue;
    }
    final distributionDeviationValue = distributionDeviation;
    if (distributionDeviationValue != null) {
      map['distributionDeviation'] = distributionDeviationValue;
    }
    ...
    final statsUriValue = statsUri;
    if (statsUriValue != null) {
      map['statsUri'] = statsUriValue;
    }
    return map;
  }
  ...
  factory GoogleCloudAiplatformV1beta1FeatureStatsAnomaly.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1FeatureStatsAnomaly(
      anomalyDetectionThreshold: map['anomalyDetectionThreshold'] == null
          ? null
          : map['anomalyDetectionThreshold'] as double,
      anomalyUri:
          map['anomalyUri'] == null ? null : map['anomalyUri'] as String,
      distributionDeviation: map['distributionDeviation'] == null
          ? null
          : map['distributionDeviation'] as double,
      endTime: map['endTime'] == null ? null : map['endTime'] as String,
      score: map['score'] == null ? null : map['score'] as double,
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      statsUri: map['statsUri'] == null ? null : map['statsUri'] as String,
    );
  }
}
