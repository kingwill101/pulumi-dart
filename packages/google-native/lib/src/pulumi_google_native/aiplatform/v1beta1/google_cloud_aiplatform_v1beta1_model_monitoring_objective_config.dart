...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (explanationConfigValue != null) {
      map['explanationConfig'] = explanationConfigValue.toMap();
    }
    final predictionDriftDetectionConfigValue = predictionDriftDetectionConfig;
    if (predictionDriftDetectionConfigValue != null) {
      map['predictionDriftDetectionConfig'] =
          predictionDriftDetectionConfigValue.toMap();
    }
    final trainingDatasetValue = trainingDataset;
    if (trainingDatasetValue != null) {
      map['trainingDataset'] = trainingDatasetValue.toMap();
    }
    final trainingPredictionSkewDetectionConfigValue =
        trainingPredictionSkewDetectionConfig;
    if (trainingPredictionSkewDetectionConfigValue != null) {
      map['trainingPredictionSkewDetectionConfig'] =
          trainingPredictionSkewDetectionConfigValue.toMap();
    }
    return map;
  }
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig(
      ...
      predictionDriftDetectionConfig: map['predictionDriftDetectionConfig'] ==
              null
          ? null
      ...
      trainingPredictionSkewDetectionConfig: map[
                  'trainingPredictionSkewDetectionConfig'] ==
              null
          ? null
