...
class GetIndexEndpointResult2 {
  ...
  factory GetIndexEndpointResult2.fromMap(Map<String, dynamic> map) {
    return GetIndexEndpointResult2(
      createTime: map['createTime'] as String,
      deployedIndexes:
          Input.decodeList<GoogleCloudAiplatformV1beta1DeployedIndexResponse>(
              map['deployedIndexes'],
              (value) =>
                  GoogleCloudAiplatformV1beta1DeployedIndexResponse.fromMap(
