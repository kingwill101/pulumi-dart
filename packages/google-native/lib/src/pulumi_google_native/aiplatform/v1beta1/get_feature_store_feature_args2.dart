...
class GetFeatureStoreFeatureArgs2 {
  ...
  factory GetFeatureStoreFeatureArgs2.fromMap(Map<String, dynamic> map) {
    return GetFeatureStoreFeatureArgs2(
