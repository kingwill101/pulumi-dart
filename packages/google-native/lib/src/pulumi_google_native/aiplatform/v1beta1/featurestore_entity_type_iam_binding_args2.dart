...
class FeaturestoreEntityTypeIamBindingArgs2 {
  ...
  FeaturestoreEntityTypeIamBindingArgs2({
    this.condition,
  ...
  factory FeaturestoreEntityTypeIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return FeaturestoreEntityTypeIamBindingArgs2(
