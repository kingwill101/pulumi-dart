...
class PipelineJobAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1PipelineJobDetailResponse> jobDetail;
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigResponse>
      runtimeConfig;
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1PipelineTemplateMetadataResponse>
      templateMetadata;
  ...
  PipelineJobAiplatformV1beta1(
    ...
    this.jobDetail =
        registerOutput<GoogleCloudAiplatformV1beta1PipelineJobDetailResponse>(
            'jobDetail');
    ...
    this.runtimeConfig = registerOutput<
    ...
    this.templateMetadata = registerOutput<
