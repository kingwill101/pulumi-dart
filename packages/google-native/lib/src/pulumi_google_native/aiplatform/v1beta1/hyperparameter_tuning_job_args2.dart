...
class HyperparameterTuningJobArgs2 {
  ...
  final Input<GoogleCloudAiplatformV1beta1CustomJobSpec> trialJobSpec;

  HyperparameterTuningJobArgs2({
  ...
  factory HyperparameterTuningJobArgs2.fromMap(Map<String, dynamic> map) {
    return HyperparameterTuningJobArgs2(
      ...
      studySpec: Input.asInput<GoogleCloudAiplatformV1beta1StudySpec>(
          map['studySpec']),
      trialJobSpec: Input.asInput<GoogleCloudAiplatformV1beta1CustomJobSpec>(
          map['trialJobSpec']),
    );
  }
}
