...
import 'training_pipeline_args2.dart';

/// Creates a TrainingPipeline. A created TrainingPipeline right away will be attempted to be run.
/// Auto-naming is currently not supported for this resource.
class TrainingPipeline2 extends CustomResource {
  ...
  late final Output<GoogleCloudAiplatformV1beta1InputDataConfigResponse>
      inputDataConfig;
  ...
  late final Output<GoogleCloudAiplatformV1beta1ModelResponse> modelToUpload;
  ...
  late final Output<String> parentModel;
  ...
  late final Output<String> trainingTaskDefinition;

  /// The training task's parameter(s), as specified in the training_task_definition's `inputs`.
  late final Output<dynamic> trainingTaskInputs;
  ...
  late final Output<dynamic> trainingTaskMetadata;
  ...
  TrainingPipeline2(
    ...
    this.modelToUpload =
        Output.createUnknown<GoogleCloudAiplatformV1beta1ModelResponse>();
