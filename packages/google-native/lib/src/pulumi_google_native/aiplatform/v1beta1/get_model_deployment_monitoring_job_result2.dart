...
class GetModelDeploymentMonitoringJobResult2 {
  ...
  GetModelDeploymentMonitoringJobResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['enableMonitoringPipelineLogs'] = enableMonitoringPipelineLogs;
    map['encryptionSpec'] = encryptionSpec.toMap();
    map['endpoint'] = endpoint;
    map['error'] = error.toMap();
    map['labels'] = labels;
    map['latestMonitoringPipelineMetadata'] =
    ...
    map['modelMonitoringAlertConfig'] = modelMonitoringAlertConfig.toMap();
    map['name'] = name;
    map['nextScheduleTime'] = nextScheduleTime;
    map['predictInstanceSchemaUri'] = predictInstanceSchemaUri;
    map['samplePredictInstance'] = samplePredictInstance;
    map['scheduleState'] = scheduleState;
    map['state'] = state;
  ...
  factory GetModelDeploymentMonitoringJobResult2.fromMap(
      Map<String, dynamic> map) {
    return GetModelDeploymentMonitoringJobResult2(
      ...
      latestMonitoringPipelineMetadata:
          GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse
              .fromMap((map['latestMonitoringPipelineMetadata'] as Map)
                  .cast<String, dynamic>()),
      ...
      modelMonitoringAlertConfig:
          GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse
              .fromMap((map['modelMonitoringAlertConfig'] as Map)
                  .cast<String, dynamic>()),
