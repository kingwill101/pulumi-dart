...
class ArtifactArgs2 {
  ...
  final Input<ArtifactState2>? state;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (stateValue != null) {
      map['state'] = Input.mapOptionalInputValue<ArtifactState2, String>(
  ...
  factory ArtifactArgs2.fromMap(Map<String, dynamic> map) {
    return ArtifactArgs2(
      ...
      state: Input.asOptionalInput<ArtifactState2>(map['state']),
