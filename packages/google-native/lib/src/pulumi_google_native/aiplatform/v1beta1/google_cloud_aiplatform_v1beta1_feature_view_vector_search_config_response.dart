...
class GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bruteForceConfig'] = bruteForceConfig;
    map['crowdingColumn'] = crowdingColumn;
    map['distanceMeasureType'] = distanceMeasureType;
    map['embeddingColumn'] = embeddingColumn;
    map['embeddingDimension'] = embeddingDimension;
    map['filterColumns'] = filterColumns;
    map['treeAhConfig'] = treeAhConfig.toMap();
    return map;
  }
