...
class GetFeatureOnlineStoreResult2 {
  ...
  factory GetFeatureOnlineStoreResult2.fromMap(Map<String, dynamic> map) {
    return GetFeatureOnlineStoreResult2(
