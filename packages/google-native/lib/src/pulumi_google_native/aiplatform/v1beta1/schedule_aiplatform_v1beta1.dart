...
import 'schedule_aiplatform_v1beta1_args.dart';

/// Creates a Schedule.
class ScheduleAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1CreatePipelineJobRequestResponse>
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1ScheduleRunResponseResponse>
  ...
  ScheduleAiplatformV1beta1(
    String name, {
    ScheduleAiplatformV1beta1Args? args,
    ...
    this.createPipelineJobRequest = registerOutput<
