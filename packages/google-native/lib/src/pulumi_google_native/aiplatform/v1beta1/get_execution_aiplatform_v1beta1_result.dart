...
class GetExecutionAiplatformV1beta1Result {
  ...
  GetExecutionAiplatformV1beta1Result({
  ...
  factory GetExecutionAiplatformV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetExecutionAiplatformV1beta1Result(
