...
class GoogleCloudAiplatformV1beta1RaySpec {
  ...
  Map<String, dynamic> toMap() {
    ...
    final headNodeResourcePoolIdValue = headNodeResourcePoolId;
    if (headNodeResourcePoolIdValue != null) {
      map['headNodeResourcePoolId'] = headNodeResourcePoolIdValue;
    }
    final imageUriValue = imageUri;
    if (imageUriValue != null) {
      map['imageUri'] = imageUriValue;
    }
    final resourcePoolImagesValue = resourcePoolImages;
    if (resourcePoolImagesValue != null) {
      map['resourcePoolImages'] = resourcePoolImagesValue;
    }
    return map;
  }

  factory GoogleCloudAiplatformV1beta1RaySpec.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1RaySpec(
      headNodeResourcePoolId: map['headNodeResourcePoolId'] == null
          ? null
          : map['headNodeResourcePoolId'] as String,
      imageUri: map['imageUri'] == null ? null : map['imageUri'] as String,
      resourcePoolImages: map['resourcePoolImages'] == null
          ? null
