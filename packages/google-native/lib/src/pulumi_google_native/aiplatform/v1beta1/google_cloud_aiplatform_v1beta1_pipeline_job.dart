...
class GoogleCloudAiplatformV1beta1PipelineJob {
  ...
  final GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig? runtimeConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (encryptionSpecValue != null) {
      map['encryptionSpec'] = encryptionSpecValue.toMap();
    }
  ...
  factory GoogleCloudAiplatformV1beta1PipelineJob.fromMap(
