...
class NotebookRuntimeTemplateIamPolicyArgs2 {
  ...
  NotebookRuntimeTemplateIamPolicyArgs2({
    this.bindings,
    this.etag,
    this.location,
  ...
  factory NotebookRuntimeTemplateIamPolicyArgs2.fromMap(
      Map<String, dynamic> map) {
    return NotebookRuntimeTemplateIamPolicyArgs2(
      bindings:
