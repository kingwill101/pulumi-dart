...
class NasJobArgs2 {
  ...
  final Input<GoogleCloudAiplatformV1beta1NasJobSpec> nasJobSpec;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['nasJobSpec'] = Input.mapInputValue<
  ...
  factory NasJobArgs2.fromMap(Map<String, dynamic> map) {
    return NasJobArgs2(
      ...
      nasJobSpec: Input.asInput<GoogleCloudAiplatformV1beta1NasJobSpec>(
          map['nasJobSpec']),
