...
class GetHyperparameterTuningJobResult2 {
  ...
  GetHyperparameterTuningJobResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['trials'] = Input.encodeList<GoogleCloudAiplatformV1beta1TrialResponse,
        Map<String, dynamic>>(trials, (value) => value.toMap());
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetHyperparameterTuningJobResult2.fromMap(Map<String, dynamic> map) {
    return GetHyperparameterTuningJobResult2(
      ...
      trials: Input.decodeList<GoogleCloudAiplatformV1beta1TrialResponse>(
          map['trials'],
