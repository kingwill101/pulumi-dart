...
import 'index_index_update_method2.dart';
...
class IndexArgs2 {
  ...
  final Input<IndexIndexUpdateMethod2>? indexUpdateMethod;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (indexUpdateMethodValue != null) {
      map['indexUpdateMethod'] =
          Input.mapOptionalInputValue<IndexIndexUpdateMethod2, String>(
  ...
  factory IndexArgs2.fromMap(Map<String, dynamic> map) {
    return IndexArgs2(
      ...
      indexUpdateMethod: Input.asOptionalInput<IndexIndexUpdateMethod2>(
          map['indexUpdateMethod']),
