...
class NotebookRuntimeTemplateIamBindingArgs2 {
  ...
  NotebookRuntimeTemplateIamBindingArgs2({
    this.condition,
  ...
  factory NotebookRuntimeTemplateIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return NotebookRuntimeTemplateIamBindingArgs2(
