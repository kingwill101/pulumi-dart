...
class GoogleCloudAiplatformV1beta1DeployedModelResponse {
  ...
  final GoogleCloudAiplatformV1beta1PrivateEndpointsResponse privateEndpoints;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['disableExplanations'] = disableExplanations;
    map['displayName'] = displayName;
    map['enableAccessLogging'] = enableAccessLogging;
    map['enableContainerLogging'] = enableContainerLogging;
    ...
    map['sharedResources'] = sharedResources;
    return map;
  }

  factory GoogleCloudAiplatformV1beta1DeployedModelResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1DeployedModelResponse(
      ...
      disableExplanations: map['disableExplanations'] as bool,
      displayName: map['displayName'] as String,
      enableAccessLogging: map['enableAccessLogging'] as bool,
      enableContainerLogging: map['enableContainerLogging'] as bool,
      explanationSpec:
      ...
      privateEndpoints:
          GoogleCloudAiplatformV1beta1PrivateEndpointsResponse.fromMap(
              (map['privateEndpoints'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      sharedResources: map['sharedResources'] as String,
    );
  }
}
