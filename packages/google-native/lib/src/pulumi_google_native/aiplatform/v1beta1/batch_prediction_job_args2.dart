...
class BatchPredictionJobArgs2 {
  /// The config of resources used by the Model during the batch prediction. If the Model supports DEDICATED_RESOURCES this config may be provided (and the job will use these resources), if the Model doesn't support AUTOMATIC_RESOURCES, this config must be provided.
  final Input<GoogleCloudAiplatformV1beta1BatchDedicatedResources>?
      dedicatedResources;
  ...
  final Input<GoogleCloudAiplatformV1beta1ExplanationSpec>? explanationSpec;
  ...
  final Input<GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig>
      inputConfig;

  /// Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
  final Input<GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig>?
      instanceConfig;
  ...
  final Input<GoogleCloudAiplatformV1beta1ManualBatchTuningParameters>?
  ...
  final Input<GoogleCloudAiplatformV1beta1ModelMonitoringConfig>?
      modelMonitoringConfig;

  /// Get batch prediction job monitoring statistics.
  final Input<List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>>?
  ...
  final Input<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig>
      outputConfig;
  ...
  final Input<GoogleCloudAiplatformV1beta1UnmanagedContainerModel>?
      unmanagedContainerModel;

  BatchPredictionJobArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (modelMonitoringConfigValue != null) {
      map['modelMonitoringConfig'] = Input.mapOptionalInputValue<
    ...
    if (modelMonitoringStatsAnomaliesValue != null) {
      map['modelMonitoringStatsAnomalies'] = Input.mapOptionalInputValue<
  ...
  factory BatchPredictionJobArgs2.fromMap(Map<String, dynamic> map) {
    return BatchPredictionJobArgs2(
      dedicatedResources: Input.asOptionalInput<
              GoogleCloudAiplatformV1beta1BatchDedicatedResources>(
      ...
      encryptionSpec:
          Input.asOptionalInput<GoogleCloudAiplatformV1beta1EncryptionSpec>(
              map['encryptionSpec']),
      explanationSpec:
          Input.asOptionalInput<GoogleCloudAiplatformV1beta1ExplanationSpec>(
              map['explanationSpec']),
      generateExplanation:
          Input.asOptionalInput<bool>(map['generateExplanation']),
      inputConfig: Input.asInput<
              GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig>(
          map['inputConfig']),
