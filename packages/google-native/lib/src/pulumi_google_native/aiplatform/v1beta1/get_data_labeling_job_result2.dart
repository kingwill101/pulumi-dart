...
class GetDataLabelingJobResult2 {
  ...
  final GoogleTypeMoneyResponse2 currentSpend;
  ...
  factory GetDataLabelingJobResult2.fromMap(Map<String, dynamic> map) {
    return GetDataLabelingJobResult2(
      activeLearningConfig:
      ...
      currentSpend: GoogleTypeMoneyResponse2.fromMap(
