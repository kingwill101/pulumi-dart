...
class FeaturestoreEntityTypeIamMemberArgs2 {
  ...
  FeaturestoreEntityTypeIamMemberArgs2({
    this.condition,
  ...
  factory FeaturestoreEntityTypeIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return FeaturestoreEntityTypeIamMemberArgs2(
