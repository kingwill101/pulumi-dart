...
class DatasetArgs2 {
  ...
  final Input<List<GoogleCloudAiplatformV1beta1SavedQuery>>? savedQueries;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (savedQueriesValue != null) {
      map['savedQueries'] = Input.mapOptionalInputValue<
          ...
          savedQueriesValue,
          (value) => Input.encodeList<GoogleCloudAiplatformV1beta1SavedQuery,
  ...
  factory DatasetArgs2.fromMap(Map<String, dynamic> map) {
    return DatasetArgs2(
      ...
      savedQueries:
          Input.asOptionalInput<List<GoogleCloudAiplatformV1beta1SavedQuery>>(
              map['savedQueries']),
    );
  }
}
