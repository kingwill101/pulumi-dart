...
class GetFeaturestoreResult2 {
  ...
  final GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigResponse
      onlineServingConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['labels'] = labels;
    map['name'] = name;
    map['onlineServingConfig'] = onlineServingConfig.toMap();
    map['onlineStorageTtlDays'] = onlineStorageTtlDays;
    map['state'] = state;
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetFeaturestoreResult2.fromMap(Map<String, dynamic> map) {
    return GetFeaturestoreResult2(
