...
class GetIndexEndpointAiplatformV1beta1Result {
  /// Timestamp when this IndexEndpoint was created.
  final String createTime;

  /// The indexes deployed in this endpoint.
  final List<GoogleCloudAiplatformV1beta1DeployedIndexResponse> deployedIndexes;
  ...
  GetIndexEndpointAiplatformV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['publicEndpointDomainName'] = publicEndpointDomainName;
    map['publicEndpointEnabled'] = publicEndpointEnabled;
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetIndexEndpointAiplatformV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetIndexEndpointAiplatformV1beta1Result(
      createTime: map['createTime'] as String,
      deployedIndexes: pulumi.Input.decodeList<
              GoogleCloudAiplatformV1beta1DeployedIndexResponse>(
          map['deployedIndexes'],
          (value) => GoogleCloudAiplatformV1beta1DeployedIndexResponse.fromMap(
