...
class GetFeatureStoreFeatureResult2 {
  ...
  factory GetFeatureStoreFeatureResult2.fromMap(Map<String, dynamic> map) {
    return GetFeatureStoreFeatureResult2(
