...
import 'metadata_schema_schema_type2.dart';

/// The set of arguments for MetadataSchema.
class MetadataSchemaArgs2 {
  ...
  final Input<MetadataSchemaSchemaType2>? schemaType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (schemaTypeValue != null) {
      map['schemaType'] =
          Input.mapOptionalInputValue<MetadataSchemaSchemaType2, String>(
  ...
  factory MetadataSchemaArgs2.fromMap(Map<String, dynamic> map) {
    return MetadataSchemaArgs2(
      ...
      schemaType:
          Input.asOptionalInput<MetadataSchemaSchemaType2>(map['schemaType']),
