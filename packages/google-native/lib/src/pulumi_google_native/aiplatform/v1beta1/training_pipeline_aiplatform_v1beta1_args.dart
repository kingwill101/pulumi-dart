...
class TrainingPipelineAiplatformV1beta1Args {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1InputDataConfig>?
      inputDataConfig;
  ...
  TrainingPipelineAiplatformV1beta1Args({
  ...
  factory TrainingPipelineAiplatformV1beta1Args.fromMap(
    ...
    return TrainingPipelineAiplatformV1beta1Args(
      ...
      inputDataConfig: pulumi.Input.asOptionalInput<
          GoogleCloudAiplatformV1beta1InputDataConfig>(map['inputDataConfig']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      modelId: pulumi.Input.asOptionalInput<String>(map['modelId']),
      modelToUpload:
          pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1Model>(
              map['modelToUpload']),
