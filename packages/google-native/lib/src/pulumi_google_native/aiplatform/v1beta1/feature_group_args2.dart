...
class FeatureGroupArgs2 {
  ...
  final Input<GoogleCloudAiplatformV1beta1FeatureGroupBigQuery>? bigQuery;
  ...
  factory FeatureGroupArgs2.fromMap(Map<String, dynamic> map) {
    return FeatureGroupArgs2(
      bigQuery: Input.asOptionalInput<
