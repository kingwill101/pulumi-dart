...
class FeatureGroupFeatureArgs2 {
  ...
  final Input<FeatureGroupFeatureValueType2>? valueType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (valueTypeValue != null) {
      map['valueType'] =
          Input.mapOptionalInputValue<FeatureGroupFeatureValueType2, String>(
  ...
  factory FeatureGroupFeatureArgs2.fromMap(Map<String, dynamic> map) {
    return FeatureGroupFeatureArgs2(
      ...
      valueType: Input.asOptionalInput<FeatureGroupFeatureValueType2>(
          map['valueType']),
      versionColumnName:
