...
class GoogleCloudAiplatformV1beta1CustomJobSpec {
  ...
  final GoogleCloudAiplatformV1beta1GcsDestination? baseOutputDirectory;
  ...
  final GoogleCloudAiplatformV1beta1Scheduling? scheduling;
  ...
  final List<GoogleCloudAiplatformV1beta1WorkerPoolSpec> workerPoolSpecs;
  ...
  Map<String, dynamic> toMap() {
    ...
    final persistentResourceIdValue = persistentResourceId;
    if (persistentResourceIdValue != null) {
      map['persistentResourceId'] = persistentResourceIdValue;
    }
  ...
  factory GoogleCloudAiplatformV1beta1CustomJobSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1CustomJobSpec(
      ...
      persistentResourceId: map['persistentResourceId'] == null
          ? null
      ...
      scheduling: map['scheduling'] == null
          ? null
          : GoogleCloudAiplatformV1beta1Scheduling.fromMap(
      ...
      workerPoolSpecs:
          pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpec>(
              map['workerPoolSpecs'],
              (value) => GoogleCloudAiplatformV1beta1WorkerPoolSpec.fromMap(
