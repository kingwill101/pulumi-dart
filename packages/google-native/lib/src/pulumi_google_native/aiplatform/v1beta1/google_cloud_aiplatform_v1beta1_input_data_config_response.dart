...
import 'google_cloud_aiplatform_v1beta1_filter_split_response.dart';
import 'google_cloud_aiplatform_v1beta1_fraction_split_response.dart';
import 'google_cloud_aiplatform_v1beta1_gcs_destination_response.dart';
import 'google_cloud_aiplatform_v1beta1_predefined_split_response.dart';
import 'google_cloud_aiplatform_v1beta1_stratified_split_response.dart';
import 'google_cloud_aiplatform_v1beta1_timestamp_split_response.dart';

/// Specifies Vertex AI owned input data to be used for training, and possibly evaluating, the Model.
class GoogleCloudAiplatformV1beta1InputDataConfigResponse {
  ...
  final GoogleCloudAiplatformV1beta1BigQueryDestinationResponse
      bigqueryDestination;
  ...
  final GoogleCloudAiplatformV1beta1FilterSplitResponse filterSplit;

  /// Split based on fractions defining the size of each set.
  final GoogleCloudAiplatformV1beta1FractionSplitResponse fractionSplit;
  ...
  final GoogleCloudAiplatformV1beta1GcsDestinationResponse gcsDestination;

  /// Whether to persist the ML use assignment to data item system labels.
  final bool persistMlUseAssignment;

  /// Supported only for tabular Datasets. Split based on a predefined key.
  final GoogleCloudAiplatformV1beta1PredefinedSplitResponse predefinedSplit;
  ...
  final GoogleCloudAiplatformV1beta1StratifiedSplitResponse stratifiedSplit;

  /// Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
  final GoogleCloudAiplatformV1beta1TimestampSplitResponse timestampSplit;
  ...
  factory GoogleCloudAiplatformV1beta1InputDataConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1InputDataConfigResponse(
      annotationSchemaUri: map['annotationSchemaUri'] as String,
      annotationsFilter: map['annotationsFilter'] as String,
      bigqueryDestination:
          GoogleCloudAiplatformV1beta1BigQueryDestinationResponse.fromMap(
              (map['bigqueryDestination'] as Map).cast<String, dynamic>()),
      datasetId: map['datasetId'] as String,
      filterSplit: GoogleCloudAiplatformV1beta1FilterSplitResponse.fromMap(
          (map['filterSplit'] as Map).cast<String, dynamic>()),
      fractionSplit: GoogleCloudAiplatformV1beta1FractionSplitResponse.fromMap(
      ...
      predefinedSplit:
          GoogleCloudAiplatformV1beta1PredefinedSplitResponse.fromMap(
              (map['predefinedSplit'] as Map).cast<String, dynamic>()),
      savedQueryId: map['savedQueryId'] as String,
      stratifiedSplit:
          GoogleCloudAiplatformV1beta1StratifiedSplitResponse.fromMap(
              (map['stratifiedSplit'] as Map).cast<String, dynamic>()),
      timestampSplit:
          GoogleCloudAiplatformV1beta1TimestampSplitResponse.fromMap(
