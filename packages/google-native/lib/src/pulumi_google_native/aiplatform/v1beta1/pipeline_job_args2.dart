...
class PipelineJobArgs2 {
  ...
  final Input<GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig>?
      runtimeConfig;
  ...
  factory PipelineJobArgs2.fromMap(Map<String, dynamic> map) {
    return PipelineJobArgs2(
