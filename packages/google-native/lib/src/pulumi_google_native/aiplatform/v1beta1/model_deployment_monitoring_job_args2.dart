...
class ModelDeploymentMonitoringJobArgs2 {
  ...
  final Input<GoogleCloudAiplatformV1beta1SamplingStrategy>
  ...
  final Input<GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfig>?
  ...
  final Input<GoogleCloudAiplatformV1beta1GcsDestination>?
      statsAnomaliesBaseDirectory;

  ModelDeploymentMonitoringJobArgs2({
  ...
  factory ModelDeploymentMonitoringJobArgs2.fromMap(Map<String, dynamic> map) {
    return ModelDeploymentMonitoringJobArgs2(
      ...
      loggingSamplingStrategy:
          Input.asInput<GoogleCloudAiplatformV1beta1SamplingStrategy>(
      ...
      statsAnomaliesBaseDirectory:
          Input.asOptionalInput<GoogleCloudAiplatformV1beta1GcsDestination>(
