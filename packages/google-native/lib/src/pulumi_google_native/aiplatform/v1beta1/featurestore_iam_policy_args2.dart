...
class FeaturestoreIamPolicyArgs2 {
  ...
  factory FeaturestoreIamPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamPolicyArgs2(
      bindings:
