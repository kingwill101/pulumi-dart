...
class GetFeatureGroupAiplatformV1beta1Result {
  ...
  GetFeatureGroupAiplatformV1beta1Result({
  ...
  factory GetFeatureGroupAiplatformV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetFeatureGroupAiplatformV1beta1Result(
      bigQuery:
          GoogleCloudAiplatformV1beta1FeatureGroupBigQueryResponse.fromMap(
