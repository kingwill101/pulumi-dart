...
class GetNotebookRuntimeTemplateResult2 {
  ...
  GetNotebookRuntimeTemplateResult2({
  ...
  factory GetNotebookRuntimeTemplateResult2.fromMap(Map<String, dynamic> map) {
    return GetNotebookRuntimeTemplateResult2(
