...
class GetNotebookRuntimeTemplateResult {
  ...
  final GoogleCloudAiplatformV1PersistentDiskSpecResponse
  ...
  final GoogleCloudAiplatformV1NotebookEucConfigResponse eucConfig;

  /// The idle shutdown configuration of NotebookRuntimeTemplate. This config will only be set when idle shutdown is enabled.
  final GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse
      idleShutdownConfig;
  ...
  final GoogleCloudAiplatformV1NetworkSpecResponse networkSpec;
  ...
  factory GetNotebookRuntimeTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetNotebookRuntimeTemplateResult(
      createTime: map['createTime'] as String,
      dataPersistentDiskSpec:
          GoogleCloudAiplatformV1PersistentDiskSpecResponse.fromMap(
              (map['dataPersistentDiskSpec'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      etag: map['etag'] as String,
      eucConfig: GoogleCloudAiplatformV1NotebookEucConfigResponse.fromMap(
          (map['eucConfig'] as Map).cast<String, dynamic>()),
      idleShutdownConfig:
          GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse.fromMap(
      ...
      networkSpec: GoogleCloudAiplatformV1NetworkSpecResponse.fromMap(
