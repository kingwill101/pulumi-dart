...
class GoogleCloudAiplatformV1ModelContainerSpec {
  ...
  final GoogleCloudAiplatformV1Probe? healthProbe;
  ...
  final List<GoogleCloudAiplatformV1Port>? ports;
  ...
  final GoogleCloudAiplatformV1Probe? startupProbe;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (portsValue != null) {
      map['ports'] =
          Input.encodeList<GoogleCloudAiplatformV1Port, Map<String, dynamic>>(
  ...
  factory GoogleCloudAiplatformV1ModelContainerSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1ModelContainerSpec(
      ...
      ports: map['ports'] == null
          ? null
          : Input.decodeList<GoogleCloudAiplatformV1Port>(
              map['ports'],
