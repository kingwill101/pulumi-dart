...
class GoogleCloudAiplatformV1ModelResponse {
  ...
  final List<GoogleCloudAiplatformV1ModelExportFormatResponse>
    ...
    return GoogleCloudAiplatformV1ModelResponse(
      ...
      deployedModels:
          Input.decodeList<GoogleCloudAiplatformV1DeployedModelRefResponse>(
              map['deployedModels'],
              (value) =>
                  GoogleCloudAiplatformV1DeployedModelRefResponse.fromMap(
      ...
      explanationSpec: GoogleCloudAiplatformV1ExplanationSpecResponse.fromMap(
      ...
      modelSourceInfo: GoogleCloudAiplatformV1ModelSourceInfoResponse.fromMap(
      ...
      supportedExportFormats:
          Input.decodeList<GoogleCloudAiplatformV1ModelExportFormatResponse>(
              ...
              (value) =>
                  GoogleCloudAiplatformV1ModelExportFormatResponse.fromMap(
                      (value as Map).cast<String, dynamic>())),
