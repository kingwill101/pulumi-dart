...
class FeatureView extends CustomResource {
  /// Optional. Configures how data is supposed to be extracted from a BigQuery source to be loaded onto the FeatureOnlineStore.
  late final Output<GoogleCloudAiplatformV1FeatureViewBigQuerySourceResponse>
      bigQuerySource;
  ...
  late final Output<GoogleCloudAiplatformV1FeatureViewSyncConfigResponse>
      syncConfig;
