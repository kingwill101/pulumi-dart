...
class FeatureViewArgs {
  ...
  final Input<GoogleCloudAiplatformV1FeatureViewBigQuerySource>? bigQuerySource;
  ...
  final Input<GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource>?
  ...
  final Input<GoogleCloudAiplatformV1FeatureViewSyncConfig>? syncConfig;
  ...
  factory FeatureViewArgs.fromMap(Map<String, dynamic> map) {
    return FeatureViewArgs(
      ...
      syncConfig:
          Input.asOptionalInput<GoogleCloudAiplatformV1FeatureViewSyncConfig>(
              map['syncConfig']),
    );
  }
}
