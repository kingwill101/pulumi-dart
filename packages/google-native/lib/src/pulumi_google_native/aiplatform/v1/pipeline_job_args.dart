...
class PipelineJobArgs {
  ...
  factory PipelineJobArgs.fromMap(Map<String, dynamic> map) {
    return PipelineJobArgs(
      ...
      pipelineJobId: pulumi.Input.asOptionalInput<String>(map['pipelineJobId']),
      pipelineSpec: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['pipelineSpec']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      reservedIpRanges:
          pulumi.Input.asOptionalInput<List<String>>(map['reservedIpRanges']),
      runtimeConfig: pulumi.Input.asOptionalInput<
              GoogleCloudAiplatformV1PipelineJobRuntimeConfig>(
          map['runtimeConfig']),
      serviceAccount:
          pulumi.Input.asOptionalInput<String>(map['serviceAccount']),
      templateUri: pulumi.Input.asOptionalInput<String>(map['templateUri']),
    );
  }
}
