...
class GoogleCloudAiplatformV1ExplanationParameters {
  ...
  final GoogleCloudAiplatformV1IntegratedGradientsAttribution?
  ...
  final GoogleCloudAiplatformV1SampledShapleyAttribution?
  ...
  factory GoogleCloudAiplatformV1ExplanationParameters.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExplanationParameters(
      examples: map['examples'] == null
          ? null
          : GoogleCloudAiplatformV1Examples.fromMap(
              (map['examples'] as Map).cast<String, dynamic>()),
      integratedGradientsAttribution:
          map['integratedGradientsAttribution'] == null
              ? null
              : GoogleCloudAiplatformV1IntegratedGradientsAttribution.fromMap(
