...
class ArtifactArgs {
  ...
  final Input<ArtifactState>? state;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (stateValue != null) {
      map['state'] = Input.mapOptionalInputValue<ArtifactState, String>(
  ...
  factory ArtifactArgs.fromMap(Map<String, dynamic> map) {
    return ArtifactArgs(
      artifactId: Input.asOptionalInput<String>(map['artifactId']),
      ...
      state: Input.asOptionalInput<ArtifactState>(map['state']),
