...
class Index extends CustomResource {
  ...
  late final Output<List<GoogleCloudAiplatformV1DeployedIndexRefResponse>>
      deployedIndexes;
  ...
  late final Output<GoogleCloudAiplatformV1IndexStatsResponse> indexStats;
  ...
  Index(
    ...
    this.deployedIndexes =
        registerOutput<List<GoogleCloudAiplatformV1DeployedIndexRefResponse>>(
            'deployedIndexes');
    ...
    this.indexStats =
        registerOutput<GoogleCloudAiplatformV1IndexStatsResponse>('indexStats');
