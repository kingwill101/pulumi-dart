...
import 'featurestore_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class FeaturestoreIamBinding extends pulumi.CustomResource {
  ...
  FeaturestoreIamBinding(
    String name, {
    FeaturestoreIamBindingArgs? args,
