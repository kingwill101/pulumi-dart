...
class ModelDeploymentMonitoringJob extends CustomResource {
  ...
  late final Output<GoogleCloudAiplatformV1SamplingStrategyResponse>
  ...
  late final Output<GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse>
  ...
  late final Output<GoogleCloudAiplatformV1GcsDestinationResponse>
  ...
  ModelDeploymentMonitoringJob(
    ...
    this.loggingSamplingStrategy =
        Output.createUnknown<GoogleCloudAiplatformV1SamplingStrategyResponse>();
    ...
    this.statsAnomaliesBaseDirectory =
        Output.createUnknown<GoogleCloudAiplatformV1GcsDestinationResponse>();
