...
class GoogleCloudAiplatformV1Model {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (explanationSpecValue != null) {
      map['explanationSpec'] = explanationSpecValue.toMap();
    }
    ...
    final pipelineJobValue = pipelineJob;
    if (pipelineJobValue != null) {
      map['pipelineJob'] = pipelineJobValue;
    }
  ...
  factory GoogleCloudAiplatformV1Model.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1Model(
      ...
      pipelineJob:
          map['pipelineJob'] == null ? null : map['pipelineJob'] as String,
