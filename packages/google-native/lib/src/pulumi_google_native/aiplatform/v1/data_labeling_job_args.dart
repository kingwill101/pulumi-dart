  ...
  factory DataLabelingJobArgs.fromMap(Map<String, dynamic> map) {
    return DataLabelingJobArgs(
      ...
      annotationLabels: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['annotationLabels']),
      datasets: pulumi.Input.asInput<List<String>>(map['datasets']),
      displayName: pulumi.Input.asInput<String>(map['displayName']),
      encryptionSpec:
          pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1EncryptionSpec>(
              map['encryptionSpec']),
      inputs: pulumi.Input.asInput<dynamic>(map['inputs']),
      inputsSchemaUri: pulumi.Input.asInput<String>(map['inputsSchemaUri']),
      instructionUri: pulumi.Input.asInput<String>(map['instructionUri']),
      labelerCount: pulumi.Input.asInput<int>(map['labelerCount']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      specialistPools:
          pulumi.Input.asOptionalInput<List<String>>(map['specialistPools']),
    );
  }
}
