...
class GoogleCloudAiplatformV1ModelContainerSpecResponse {
  ...
  final GoogleCloudAiplatformV1ProbeResponse healthProbe;
  ...
  final List<GoogleCloudAiplatformV1PortResponse> ports;
  ...
  final GoogleCloudAiplatformV1ProbeResponse startupProbe;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['env'] = Input.encodeList<GoogleCloudAiplatformV1EnvVarResponse,
    ...
    map['ports'] = Input.encodeList<GoogleCloudAiplatformV1PortResponse,
  ...
  factory GoogleCloudAiplatformV1ModelContainerSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1ModelContainerSpecResponse(
      ...
      env: Input.decodeList<GoogleCloudAiplatformV1EnvVarResponse>(
          map['env'],
          (value) => GoogleCloudAiplatformV1EnvVarResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      healthProbe: GoogleCloudAiplatformV1ProbeResponse.fromMap(
          (map['healthProbe'] as Map).cast<String, dynamic>()),
      healthRoute: map['healthRoute'] as String,
      imageUri: map['imageUri'] as String,
      ports: Input.decodeList<GoogleCloudAiplatformV1PortResponse>(
          map['ports'],
      ...
      startupProbe: GoogleCloudAiplatformV1ProbeResponse.fromMap(
