...
class BatchPredictionJobArgs {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1BatchDedicatedResources>?
      dedicatedResources;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1BatchPredictionJobInputConfig>
      inputConfig;

  /// Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
  final pulumi.Input<GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig>?
      instanceConfig;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ManualBatchTuningParameters>?
  ...
  final pulumi.Input<GoogleCloudAiplatformV1BatchPredictionJobOutputConfig>
      outputConfig;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1UnmanagedContainerModel>?
    ...
    return BatchPredictionJobArgs(
      ...
      encryptionSpec:
          pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1EncryptionSpec>(
              map['encryptionSpec']),
      explanationSpec:
          pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1ExplanationSpec>(
              map['explanationSpec']),
      generateExplanation:
