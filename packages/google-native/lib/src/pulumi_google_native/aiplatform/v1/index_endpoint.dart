...
class IndexEndpoint extends CustomResource {
  /// Timestamp when this IndexEndpoint was created.
  late final Output<String> createTime;

  /// The indexes deployed in this endpoint.
  late final Output<List<GoogleCloudAiplatformV1DeployedIndexResponse>>
      deployedIndexes;
  ...
  late final Output<GoogleCloudAiplatformV1PrivateServiceConnectConfigResponse>
