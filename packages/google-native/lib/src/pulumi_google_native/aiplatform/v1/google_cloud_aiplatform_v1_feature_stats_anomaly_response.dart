...
class GoogleCloudAiplatformV1FeatureStatsAnomalyResponse {
  ...
  factory GoogleCloudAiplatformV1FeatureStatsAnomalyResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeatureStatsAnomalyResponse(
