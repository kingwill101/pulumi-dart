...
import 'binding_response_runtimeconfig_v1beta1.dart';
...
class ConfigIamPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<BindingResponseRuntimeconfigV1beta1>> bindings;
  ...
  ConfigIamPolicy(
    ...
    this.bindings =
        registerOutput<List<BindingResponseRuntimeconfigV1beta1>>('bindings');
