...
class GetConfigRuntimeconfigV1beta1Result {
  ...
  GetConfigRuntimeconfigV1beta1Result({
  ...
  factory GetConfigRuntimeconfigV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetConfigRuntimeconfigV1beta1Result(
