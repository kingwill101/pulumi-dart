...
class BlockchainNodeArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (blockchainTypeValue != null) {
      map['blockchainType'] = pulumi.Input.mapOptionalInputValue<
          BlockchainNodeBlockchainType,
          String>(blockchainTypeValue, (value) => value.value);
    }
  ...
  factory BlockchainNodeArgs.fromMap(Map<String, dynamic> map) {
    return BlockchainNodeArgs(
      ...
      blockchainType:
          pulumi.Input.asOptionalInput<BlockchainNodeBlockchainType>(
              map['blockchainType']),
      ethereumDetails:
          pulumi.Input.asOptionalInput<EthereumDetails>(map['ethereumDetails']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      privateServiceConnectEnabled: pulumi.Input.asOptionalInput<bool>(
          map['privateServiceConnectEnabled']),
