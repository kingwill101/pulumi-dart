...
class PackageResponseOsconfigV1beta {
  ...
  factory PackageResponseOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return PackageResponseOsconfigV1beta(
