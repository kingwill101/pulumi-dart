...
class AptRepositoryResponseOsconfigV1beta {
  ...
  AptRepositoryResponseOsconfigV1beta({
  ...
  factory AptRepositoryResponseOsconfigV1beta.fromMap(
      Map<String, dynamic> map) {
    return AptRepositoryResponseOsconfigV1beta(
