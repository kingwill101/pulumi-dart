...
import 'apt_settings_type2.dart';
...
class AptSettings2 {
  ...
  factory AptSettings2.fromMap(Map<String, dynamic> map) {
    return AptSettings2(
      ...
      type: map['type'] == null
          ? null
          : AptSettingsType2.fromValue(map['type'] as String),
    );
  }
}
