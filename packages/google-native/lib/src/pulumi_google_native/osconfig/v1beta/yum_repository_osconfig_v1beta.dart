...
class YumRepositoryOsconfigV1beta {
  ...
  factory YumRepositoryOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return YumRepositoryOsconfigV1beta(
