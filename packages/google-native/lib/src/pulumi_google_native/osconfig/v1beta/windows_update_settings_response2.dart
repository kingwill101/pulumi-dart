...
class WindowsUpdateSettingsResponse2 {
  ...
  WindowsUpdateSettingsResponse2({
  ...
  factory WindowsUpdateSettingsResponse2.fromMap(Map<String, dynamic> map) {
    return WindowsUpdateSettingsResponse2(
