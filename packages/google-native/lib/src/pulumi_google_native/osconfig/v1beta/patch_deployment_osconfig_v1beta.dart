...
class PatchDeploymentOsconfigV1beta extends pulumi.CustomResource {
  ...
  PatchDeploymentOsconfigV1beta(
    ...
    this.instanceFilter =
        registerOutput<PatchInstanceFilterResponseOsconfigV1beta>(
            'instanceFilter');
    this.lastExecuteTime = registerOutput<String>('lastExecuteTime');
    this.name = registerOutput<String>('name');
    this.oneTimeSchedule =
        registerOutput<OneTimeScheduleResponseOsconfigV1beta>(
            'oneTimeSchedule');
    this.patchConfig =
        registerOutput<PatchConfigResponseOsconfigV1beta>('patchConfig');
    this.patchDeploymentId = registerOutput<String>('patchDeploymentId');
    this.project = registerOutput<String>('project');
    this.recurringSchedule =
        registerOutput<RecurringScheduleResponseOsconfigV1beta>(
            'recurringSchedule');
    this.rollout =
        registerOutput<PatchRolloutResponseOsconfigV1beta>('rollout');
