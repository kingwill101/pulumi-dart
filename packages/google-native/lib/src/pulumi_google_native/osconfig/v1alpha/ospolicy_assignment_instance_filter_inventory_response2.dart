...
class OSPolicyAssignmentInstanceFilterInventoryResponse2 {
  /// The OS short name
  ...
  factory OSPolicyAssignmentInstanceFilterInventoryResponse2.fromMap(
      Map<String, dynamic> map) {
    return OSPolicyAssignmentInstanceFilterInventoryResponse2(
