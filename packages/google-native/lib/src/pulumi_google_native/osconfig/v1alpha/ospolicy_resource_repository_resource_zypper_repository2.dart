...
class OSPolicyResourceRepositoryResourceZypperRepository2 {
  ...
  OSPolicyResourceRepositoryResourceZypperRepository2({
  ...
  factory OSPolicyResourceRepositoryResourceZypperRepository2.fromMap(
      Map<String, dynamic> map) {
    return OSPolicyResourceRepositoryResourceZypperRepository2(
