...
class OsPolicyAssignment2 extends CustomResource {
  ...
  OsPolicyAssignment2(
    ...
    this.instanceFilter =
        registerOutput<OSPolicyAssignmentInstanceFilterResponse2>(
            'instanceFilter');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.osPolicies = registerOutput<List<OSPolicyResponse2>>('osPolicies');
    ...
    this.rollout =
        registerOutput<OSPolicyAssignmentRolloutResponse2>('rollout');
