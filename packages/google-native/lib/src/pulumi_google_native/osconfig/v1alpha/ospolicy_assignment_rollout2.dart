...
class OSPolicyAssignmentRollout2 {
  ...
  factory OSPolicyAssignmentRollout2.fromMap(Map<String, dynamic> map) {
    return OSPolicyAssignmentRollout2(
      disruptionBudget: FixedOrPercent5.fromMap(
