...
import 'ospolicy_resource_exec_resource_exec2.dart';
...
class OSPolicyResourceExecResource2 {
  /// What to run to bring this resource into the desired state. An exit code of 100 indicates "success", any other exit code indicates a failure running enforce.
  final OSPolicyResourceExecResourceExec2? enforce;
  ...
  final OSPolicyResourceExecResourceExec2 validate;

  OSPolicyResourceExecResource2({
    this.enforce,
  ...
  factory OSPolicyResourceExecResource2.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceExecResource2(
      enforce: map['enforce'] == null
          ? null
          : OSPolicyResourceExecResourceExec2.fromMap(
              (map['enforce'] as Map).cast<String, dynamic>()),
      validate: OSPolicyResourceExecResourceExec2.fromMap(
