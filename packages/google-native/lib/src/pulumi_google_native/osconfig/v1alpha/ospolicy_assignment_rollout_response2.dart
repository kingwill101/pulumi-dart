...
class OSPolicyAssignmentRolloutResponse2 {
  ...
  factory OSPolicyAssignmentRolloutResponse2.fromMap(Map<String, dynamic> map) {
    return OSPolicyAssignmentRolloutResponse2(
      disruptionBudget: FixedOrPercentResponse5.fromMap(
