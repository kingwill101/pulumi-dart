...
class GetOsPolicyAssignmentResult2 {
  ...
  final OSPolicyAssignmentInstanceFilterResponse2 instanceFilter;

  /// Resource name. Format: `projects/{project_number}/locations/{location}/osPolicyAssignments/{os_policy_assignment_id}` This field is ignored when you create an OS policy assignment.
  final String name;

  /// List of OS policies to be applied to the VMs.
  final List<OSPolicyResponse2> osPolicies;
  ...
  final OSPolicyAssignmentRolloutResponse2 rollout;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['osPolicies'] =
        Input.encodeList<OSPolicyResponse2, Map<String, dynamic>>(
  ...
  factory GetOsPolicyAssignmentResult2.fromMap(Map<String, dynamic> map) {
    return GetOsPolicyAssignmentResult2(
      baseline: map['baseline'] as bool,
      deleted: map['deleted'] as bool,
      description: map['description'] as String,
      etag: map['etag'] as String,
      instanceFilter: OSPolicyAssignmentInstanceFilterResponse2.fromMap(
          (map['instanceFilter'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      osPolicies: Input.decodeList<OSPolicyResponse2>(
          map['osPolicies'],
          (value) => OSPolicyResponse2.fromMap(
      ...
      rollout: OSPolicyAssignmentRolloutResponse2.fromMap(
