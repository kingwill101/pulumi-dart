...
class OSPolicyResourceExecResourceResponseOsconfigV1alpha {
  ...
  factory OSPolicyResourceExecResourceResponseOsconfigV1alpha.fromMap(
      Map<String, dynamic> map) {
    return OSPolicyResourceExecResourceResponseOsconfigV1alpha(
      enforce: OSPolicyResourceExecResourceExecResponseOsconfigV1alpha.fromMap(
          (map['enforce'] as Map).cast<String, dynamic>()),
      validate: OSPolicyResourceExecResourceExecResponseOsconfigV1alpha.fromMap(
