...
class AuditLogConfigResponseLookerV1 {
  ...
  AuditLogConfigResponseLookerV1({
  ...
  factory AuditLogConfigResponseLookerV1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseLookerV1(
