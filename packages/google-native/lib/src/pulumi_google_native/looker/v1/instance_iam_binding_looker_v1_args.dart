...
class InstanceIamBindingLookerV1Args {
  ...
  InstanceIamBindingLookerV1Args({
    this.condition,
  ...
  factory InstanceIamBindingLookerV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingLookerV1Args(
