...
import 'instance_backup_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InstanceBackupIamBinding extends pulumi.CustomResource {
  ...
  InstanceBackupIamBinding(
    String name, {
    InstanceBackupIamBindingArgs? args,
