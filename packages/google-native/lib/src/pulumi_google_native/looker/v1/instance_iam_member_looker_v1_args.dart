...
class InstanceIamMemberLookerV1Args {
  ...
  factory InstanceIamMemberLookerV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberLookerV1Args(
