...
class GetInstanceLookerV1Result {
  ...
  final EncryptionConfigResponseLookerV1 encryptionConfig;
  ...
  final MaintenanceWindowResponseLookerV1 maintenanceWindow;
  ...
  factory GetInstanceLookerV1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceLookerV1Result(
      ...
      encryptionConfig: EncryptionConfigResponseLookerV1.fromMap(
      ...
      maintenanceWindow: MaintenanceWindowResponseLookerV1.fromMap(
