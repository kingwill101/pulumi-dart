...
import 'encryption_config_response_looker_v1.dart';
import 'instance_looker_v1_args.dart';
import 'maintenance_schedule_response.dart';
import 'maintenance_window_response_looker_v1.dart';
import 'oauth_config_response.dart';
import 'user_metadata_response.dart';

/// Creates a new Instance in a given project and location.
/// Auto-naming is currently not supported for this resource.
class InstanceLookerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EncryptionConfigResponseLookerV1> encryptionConfig;
  ...
  late final pulumi.Output<MaintenanceWindowResponseLookerV1> maintenanceWindow;
  ...
  InstanceLookerV1(
    ...
    this.encryptionConfig =
        registerOutput<EncryptionConfigResponseLookerV1>('encryptionConfig');
    ...
    this.maintenanceWindow =
        registerOutput<MaintenanceWindowResponseLookerV1>('maintenanceWindow');
