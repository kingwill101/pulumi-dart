...
class AuditLogConfig50 {
  ...
  factory AuditLogConfig50.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig50(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType50.fromValue(map['logType'] as String),
    );
  }
}
