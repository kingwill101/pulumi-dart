...
import 'instance_iam_binding_looker_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InstanceIamBindingLookerV1 extends pulumi.CustomResource {
  ...
  InstanceIamBindingLookerV1(
    String name, {
    InstanceIamBindingLookerV1Args? args,
