...
import 'instance_iam_member_looker_v1_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class InstanceIamMemberLookerV1 extends pulumi.CustomResource {
  ...
  InstanceIamMemberLookerV1(
    String name, {
    InstanceIamMemberLookerV1Args? args,
