...
class IngressRuleArgs {
  ...
  final Input<IngressRuleAction>? action;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (actionValue != null) {
      map['action'] = Input.mapOptionalInputValue<IngressRuleAction, String>(
  ...
  factory IngressRuleArgs.fromMap(Map<String, dynamic> map) {
    return IngressRuleArgs(
      action: Input.asOptionalInput<IngressRuleAction>(map['action']),
      appId: Input.asInput<String>(map['appId']),
      description: Input.asOptionalInput<String>(map['description']),
      priority: Input.asOptionalInput<int>(map['priority']),
      sourceRange: Input.asOptionalInput<String>(map['sourceRange']),
    );
  }
}
