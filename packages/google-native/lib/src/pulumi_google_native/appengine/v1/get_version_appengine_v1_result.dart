...
class GetVersionAppengineV1Result {
  ...
  factory GetVersionAppengineV1Result.fromMap(Map<String, dynamic> map) {
    return GetVersionAppengineV1Result(
