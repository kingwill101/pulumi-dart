...
class App2 extends CustomResource {
  ...
  late final Output<List<UrlDispatchRuleResponse2>> dispatchRules;

  /// The feature specific settings to be used in the application.
  late final Output<FeatureSettingsResponse2> featureSettings;
  ...
  late final Output<IdentityAwareProxyResponse2> iap;
