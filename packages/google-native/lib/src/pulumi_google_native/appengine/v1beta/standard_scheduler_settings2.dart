...
class StandardSchedulerSettings2 {
  ...
  factory StandardSchedulerSettings2.fromMap(Map<String, dynamic> map) {
    return StandardSchedulerSettings2(
      maxInstances:
