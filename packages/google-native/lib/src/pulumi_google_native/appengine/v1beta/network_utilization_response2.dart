...
class NetworkUtilizationResponse2 {
  ...
  factory NetworkUtilizationResponse2.fromMap(Map<String, dynamic> map) {
    return NetworkUtilizationResponse2(
