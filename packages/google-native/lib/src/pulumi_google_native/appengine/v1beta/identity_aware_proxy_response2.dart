...
class IdentityAwareProxyResponse2 {
  ...
  factory IdentityAwareProxyResponse2.fromMap(Map<String, dynamic> map) {
    return IdentityAwareProxyResponse2(
