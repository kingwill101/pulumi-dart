...
import 'endpoints_api_service_rollout_strategy2.dart';
...
class EndpointsApiService2 {
  ...
  final EndpointsApiServiceRolloutStrategy2? rolloutStrategy;

  EndpointsApiService2({
    this.configId,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (rolloutStrategyValue != null) {
      map['rolloutStrategy'] = rolloutStrategyValue.value;
    }
    return map;
  }

  factory EndpointsApiService2.fromMap(Map<String, dynamic> map) {
    return EndpointsApiService2(
      ...
      rolloutStrategy: map['rolloutStrategy'] == null
          ? null
          : EndpointsApiServiceRolloutStrategy2.fromValue(
