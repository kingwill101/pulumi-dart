...
class EndpointsApiServiceResponse2 {
  ...
  factory EndpointsApiServiceResponse2.fromMap(Map<String, dynamic> map) {
    return EndpointsApiServiceResponse2(
