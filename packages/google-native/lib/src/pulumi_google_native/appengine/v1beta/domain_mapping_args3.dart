...
import 'ssl_settings3.dart';

/// The set of arguments for DomainMapping.
class DomainMappingArgs3 {
  ...
  final Input<SslSettings3>? sslSettings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sslSettingsValue != null) {
      map['sslSettings'] =
          Input.mapOptionalInputValue<SslSettings3, Map<String, dynamic>>(
              sslSettingsValue, (value) => value.toMap());
    }
    return map;
  }

  factory DomainMappingArgs3.fromMap(Map<String, dynamic> map) {
    return DomainMappingArgs3(
      appId: Input.asInput<String>(map['appId']),
      id: Input.asOptionalInput<String>(map['id']),
      overrideStrategy: Input.asOptionalInput<String>(map['overrideStrategy']),
      sslSettings: Input.asOptionalInput<SslSettings3>(map['sslSettings']),
    );
  }
}
