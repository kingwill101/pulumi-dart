...
import 'api_endpoint_handler_response2.dart';
import 'script_handler_response2.dart';
import 'static_files_handler_response2.dart';

/// URL pattern and description of how the URL should be handled. App Engine can handle URLs by executing application code or by serving static files uploaded with the version, such as images, CSS, or JavaScript.
class UrlMapResponse2 {
  /// Uses API Endpoints to handle requests.
  final ApiEndpointHandlerResponse2 apiEndpoint;
  ...
  final ScriptHandlerResponse2 script;

  /// Security (HTTPS) enforcement for this URL.
  final String securityLevel;

  /// Returns the contents of a file, such as an image, as the response.
  final StaticFilesHandlerResponse2 staticFiles;
  ...
  factory UrlMapResponse2.fromMap(Map<String, dynamic> map) {
    return UrlMapResponse2(
      apiEndpoint: ApiEndpointHandlerResponse2.fromMap(
      ...
      script: ScriptHandlerResponse2.fromMap(
          (map['script'] as Map).cast<String, dynamic>()),
      securityLevel: map['securityLevel'] as String,
      staticFiles: StaticFilesHandlerResponse2.fromMap(
