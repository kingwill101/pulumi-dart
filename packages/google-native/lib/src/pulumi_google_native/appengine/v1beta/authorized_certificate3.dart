...
class AuthorizedCertificate3 extends CustomResource {
  ...
  late final Output<ManagedCertificateResponse3> managedCertificate;
  ...
  AuthorizedCertificate3(
    String name, {
    AuthorizedCertificateArgs3? args,
    ...
    this.certificateRawData =
        registerOutput<CertificateRawDataResponse3>('certificateRawData');
    ...
    this.managedCertificate =
        registerOutput<ManagedCertificateResponse3>('managedCertificate');
