...
import 'api_config_handler_auth_fail_action2.dart';
import 'api_config_handler_login2.dart';
import 'api_config_handler_security_level2.dart';

/// Google Cloud Endpoints (https://cloud.google.com/endpoints) configuration for API handlers.
class ApiConfigHandler2 {
  /// Action to take when users access resources that require authentication. Defaults to redirect.
  final ApiConfigHandlerAuthFailAction2? authFailAction;

  /// Level of login required to access this resource. Defaults to optional.
  final ApiConfigHandlerLogin2? login;

  /// Path to the script from the application root directory.
  final String? script;

  /// Security (HTTPS) enforcement for this URL.
  final ApiConfigHandlerSecurityLevel2? securityLevel;
  ...
  factory ApiConfigHandler2.fromMap(Map<String, dynamic> map) {
    return ApiConfigHandler2(
      authFailAction: map['authFailAction'] == null
          ? null
          : ApiConfigHandlerAuthFailAction2.fromValue(
              map['authFailAction'] as String),
      login: map['login'] == null
          ? null
          : ApiConfigHandlerLogin2.fromValue(map['login'] as String),
      script: map['script'] == null ? null : map['script'] as String,
      securityLevel: map['securityLevel'] == null
          ? null
          : ApiConfigHandlerSecurityLevel2.fromValue(
