...
class GetAppResult2 {
  ...
  final List<UrlDispatchRuleResponse2> dispatchRules;

  /// The feature specific settings to be used in the application.
  final FeatureSettingsResponse2 featureSettings;
  ...
  final IdentityAwareProxyResponse2 iap;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dispatchRules'] =
        Input.encodeList<UrlDispatchRuleResponse2, Map<String, dynamic>>(
  ...
  factory GetAppResult2.fromMap(Map<String, dynamic> map) {
    return GetAppResult2(
      ...
      dispatchRules: Input.decodeList<UrlDispatchRuleResponse2>(
          map['dispatchRules'],
          (value) => UrlDispatchRuleResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      featureSettings: FeatureSettingsResponse2.fromMap(
      ...
      iap: IdentityAwareProxyResponse2.fromMap(
