...
import 'certificate_raw_data_response3.dart';
import 'managed_certificate_response3.dart';

/// Result data returned by getAuthorizedCertificate.
class GetAuthorizedCertificateResult3 {
  /// The SSL certificate serving the AuthorizedCertificate resource. This must be obtained independently from a certificate authority.
  final CertificateRawDataResponse3 certificateRawData;
  ...
  final ManagedCertificateResponse3 managedCertificate;
  ...
  GetAuthorizedCertificateResult3({
  ...
  factory GetAuthorizedCertificateResult3.fromMap(Map<String, dynamic> map) {
    return GetAuthorizedCertificateResult3(
      certificateRawData: CertificateRawDataResponse3.fromMap(
      ...
      managedCertificate: ManagedCertificateResponse3.fromMap(
