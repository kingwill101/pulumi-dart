...
class StandardSchedulerSettingsResponse2 {
  ...
  StandardSchedulerSettingsResponse2({
  ...
  factory StandardSchedulerSettingsResponse2.fromMap(Map<String, dynamic> map) {
    return StandardSchedulerSettingsResponse2(
