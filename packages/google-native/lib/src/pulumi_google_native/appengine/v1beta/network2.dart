...
import 'network_instance_ip_mode2.dart';
...
class Network2 {
  ...
  final NetworkInstanceIpMode2? instanceIpMode;
  ...
  factory Network2.fromMap(Map<String, dynamic> map) {
    return Network2(
      ...
      instanceIpMode: map['instanceIpMode'] == null
          ? null
          : NetworkInstanceIpMode2.fromValue(map['instanceIpMode'] as String),
      instanceTag:
