...
class GetAuthorizedCertificateResult2 {
  /// The SSL certificate serving the AuthorizedCertificate resource. This must be obtained independently from a certificate authority.
  final CertificateRawDataResponse2 certificateRawData;
  ...
  final ManagedCertificateResponse2 managedCertificate;
  ...
  GetAuthorizedCertificateResult2({
  ...
  factory GetAuthorizedCertificateResult2.fromMap(Map<String, dynamic> map) {
    return GetAuthorizedCertificateResult2(
      certificateRawData: CertificateRawDataResponse2.fromMap(
      ...
      managedCertificate: ManagedCertificateResponse2.fromMap(
