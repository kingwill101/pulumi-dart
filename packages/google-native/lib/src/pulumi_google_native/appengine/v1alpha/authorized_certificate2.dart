...
class AuthorizedCertificate2 extends CustomResource {
  late final Output<String> appId;

  /// The SSL certificate serving the AuthorizedCertificate resource. This must be obtained independently from a certificate authority.
  late final Output<CertificateRawDataResponse2> certificateRawData;
  ...
  late final Output<ManagedCertificateResponse2> managedCertificate;
  ...
  AuthorizedCertificate2(
    String name, {
    AuthorizedCertificateArgs2? args,
    ...
    this.certificateRawData =
        registerOutput<CertificateRawDataResponse2>('certificateRawData');
    ...
    this.managedCertificate =
        registerOutput<ManagedCertificateResponse2>('managedCertificate');
