...
class GetAuthorizedCertificateAppengineV1alphaResult {
  /// The SSL certificate serving the AuthorizedCertificate resource. This must be obtained independently from a certificate authority.
  final CertificateRawDataResponseAppengineV1alpha certificateRawData;
  ...
  final ManagedCertificateResponseAppengineV1alpha managedCertificate;
  ...
  GetAuthorizedCertificateAppengineV1alphaResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['certificateRawData'] = certificateRawData.toMap();
    map['displayName'] = displayName;
    map['domainMappingsCount'] = domainMappingsCount;
    map['domainNames'] = domainNames;
    map['expireTime'] = expireTime;
    map['managedCertificate'] = managedCertificate.toMap();
    map['name'] = name;
    map['visibleDomainMappings'] = visibleDomainMappings;
    return map;
  }

  factory GetAuthorizedCertificateAppengineV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetAuthorizedCertificateAppengineV1alphaResult(
      certificateRawData: CertificateRawDataResponseAppengineV1alpha.fromMap(
      ...
      managedCertificate: ManagedCertificateResponseAppengineV1alpha.fromMap(
          (map['managedCertificate'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      visibleDomainMappings:
          (map['visibleDomainMappings'] as List).cast<String>(),
    );
  }
}
