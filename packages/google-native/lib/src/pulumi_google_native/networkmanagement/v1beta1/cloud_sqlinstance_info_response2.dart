...
class CloudSQLInstanceInfoResponse2 {
  ...
  factory CloudSQLInstanceInfoResponse2.fromMap(Map<String, dynamic> map) {
    return CloudSQLInstanceInfoResponse2(
