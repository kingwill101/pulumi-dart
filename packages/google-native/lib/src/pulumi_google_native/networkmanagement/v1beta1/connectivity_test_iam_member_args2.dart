...
class ConnectivityTestIamMemberArgs2 {
  ...
  ConnectivityTestIamMemberArgs2({
    this.condition,
  ...
  factory ConnectivityTestIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestIamMemberArgs2(
