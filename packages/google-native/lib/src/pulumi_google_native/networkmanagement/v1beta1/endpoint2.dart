...
import 'app_engine_version_endpoint2.dart';
import 'cloud_function_endpoint2.dart';
import 'cloud_run_revision_endpoint2.dart';
import 'endpoint_network_type2.dart';
...
class Endpoint2 {
  ...
  final AppEngineVersionEndpoint2? appEngineVersion;

  /// A [Cloud Function](https://cloud.google.com/functions).
  final CloudFunctionEndpoint2? cloudFunction;
  ...
  final CloudRunRevisionEndpoint2? cloudRunRevision;
  ...
  final EndpointNetworkType2? networkType;
  ...
  factory Endpoint2.fromMap(Map<String, dynamic> map) {
    return Endpoint2(
      ...
      networkType: map['networkType'] == null
          ? null
          : EndpointNetworkType2.fromValue(map['networkType'] as String),
