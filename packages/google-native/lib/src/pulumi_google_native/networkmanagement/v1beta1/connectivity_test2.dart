...
class ConnectivityTest2 extends CustomResource {
  ...
  late final Output<EndpointResponse2> destination;
  ...
  late final Output<ProbingDetailsResponse2> probingDetails;
  ...
  late final Output<ReachabilityDetailsResponse2> reachabilityDetails;
  ...
  late final Output<EndpointResponse2> source;
