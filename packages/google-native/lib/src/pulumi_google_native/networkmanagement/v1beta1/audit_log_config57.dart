...
class AuditLogConfig57 {
  ...
  factory AuditLogConfig57.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig57(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType57.fromValue(map['logType'] as String),
    );
  }
}
