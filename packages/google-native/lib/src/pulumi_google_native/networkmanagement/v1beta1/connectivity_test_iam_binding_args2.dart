...
class ConnectivityTestIamBindingArgs2 {
  ...
  ConnectivityTestIamBindingArgs2({
    this.condition,
  ...
  factory ConnectivityTestIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestIamBindingArgs2(
