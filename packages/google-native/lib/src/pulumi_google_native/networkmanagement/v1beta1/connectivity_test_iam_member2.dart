...
import 'connectivity_test_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ConnectivityTestIamMember2 extends CustomResource {
  ...
  ConnectivityTestIamMember2(
    String name, {
    ConnectivityTestIamMemberArgs2? args,
