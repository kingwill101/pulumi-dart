...
import 'reachability_details_response2.dart';

/// Result data returned by getConnectivityTest.
class GetConnectivityTestResult2 {
  ...
  final EndpointResponse2 destination;
  ...
  final ProbingDetailsResponse2 probingDetails;
  ...
  final ReachabilityDetailsResponse2 reachabilityDetails;
  ...
  final EndpointResponse2 source;

  /// The time the test's configuration was updated.
  final String updateTime;

  GetConnectivityTestResult2({
  ...
  factory GetConnectivityTestResult2.fromMap(Map<String, dynamic> map) {
    return GetConnectivityTestResult2(
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      destination: EndpointResponse2.fromMap(
          (map['destination'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      probingDetails: ProbingDetailsResponse2.fromMap(
          (map['probingDetails'] as Map).cast<String, dynamic>()),
      protocol: map['protocol'] as String,
      reachabilityDetails: ReachabilityDetailsResponse2.fromMap(
          (map['reachabilityDetails'] as Map).cast<String, dynamic>()),
      relatedProjects: (map['relatedProjects'] as List).cast<String>(),
      source: EndpointResponse2.fromMap(
