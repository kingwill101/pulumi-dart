...
class ForwardingRuleInfoResponse2 {
  ...
  factory ForwardingRuleInfoResponse2.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleInfoResponse2(
