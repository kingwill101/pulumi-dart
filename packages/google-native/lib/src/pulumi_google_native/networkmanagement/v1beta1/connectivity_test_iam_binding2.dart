...
import 'connectivity_test_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ConnectivityTestIamBinding2 extends CustomResource {
  ...
  ConnectivityTestIamBinding2(
    String name, {
    ConnectivityTestIamBindingArgs2? args,
