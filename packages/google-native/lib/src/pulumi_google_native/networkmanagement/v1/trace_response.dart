...
import 'step_response_networkmanagement_v1.dart';
...
class TraceResponse {
  ...
  final List<StepResponseNetworkmanagementV1> steps;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['steps'] = pulumi.Input.encodeList<StepResponseNetworkmanagementV1,
  ...
  factory TraceResponse.fromMap(Map<String, dynamic> map) {
    return TraceResponse(
      ...
      steps: pulumi.Input.decodeList<StepResponseNetworkmanagementV1>(
          map['steps'],
          (value) => StepResponseNetworkmanagementV1.fromMap(
