...
class ConnectivityTestArgs {
  ...
  final Input<Endpoint> destination;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['destination'] = Input.mapInputValue<Endpoint, Map<String, dynamic>>(
    ...
    map['source'] = Input.mapInputValue<Endpoint, Map<String, dynamic>>(
  ...
  factory ConnectivityTestArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestArgs(
      ...
      destination: Input.asInput<Endpoint>(map['destination']),
      ...
      source: Input.asInput<Endpoint>(map['source']),
