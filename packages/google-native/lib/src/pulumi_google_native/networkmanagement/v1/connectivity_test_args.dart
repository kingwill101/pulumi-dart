...
class ConnectivityTestArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['destination'] =
        pulumi.Input.mapInputValue<Endpoint, Map<String, dynamic>>(
    ...
    map['source'] = pulumi.Input.mapInputValue<Endpoint, Map<String, dynamic>>(
  ...
  factory ConnectivityTestArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestArgs(
      ...
      destination: pulumi.Input.asInput<Endpoint>(map['destination']),
      ...
      source: pulumi.Input.asInput<Endpoint>(map['source']),
