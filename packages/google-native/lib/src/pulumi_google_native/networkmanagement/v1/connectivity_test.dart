...
class ConnectivityTest extends CustomResource {
  ...
  late final Output<EndpointResponse> destination;
  ...
  late final Output<ProbingDetailsResponse> probingDetails;
  ...
  late final Output<ReachabilityDetailsResponse> reachabilityDetails;
  ...
  late final Output<EndpointResponse> source;
  ...
  late final Output<String> testId;
  ...
  ConnectivityTest(
    ...
    this.destination = registerOutput<EndpointResponse>('destination');
    this.displayName = registerOutput<String>('displayName');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.name = registerOutput<String>('name');
    this.probingDetails =
        registerOutput<ProbingDetailsResponse>('probingDetails');
    this.project = registerOutput<String>('project');
    this.protocol = registerOutput<String>('protocol');
    this.reachabilityDetails =
        registerOutput<ReachabilityDetailsResponse>('reachabilityDetails');
    this.relatedProjects = registerOutput<List<String>>('relatedProjects');
    this.source = registerOutput<EndpointResponse>('source');
