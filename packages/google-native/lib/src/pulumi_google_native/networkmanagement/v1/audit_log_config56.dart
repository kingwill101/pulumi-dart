...
class AuditLogConfig56 {
  ...
  factory AuditLogConfig56.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig56(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType56.fromValue(map['logType'] as String),
    );
  }
}
