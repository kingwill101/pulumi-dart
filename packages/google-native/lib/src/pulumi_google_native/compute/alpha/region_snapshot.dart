...
class RegionSnapshot extends CustomResource {
  ...
  late final Output<CustomerEncryptionKeyResponse> snapshotEncryptionKey;
  ...
  late final Output<CustomerEncryptionKeyResponse> sourceDiskEncryptionKey;
  ...
  RegionSnapshot(
    ...
    this.snapshotEncryptionKey =
        registerOutput<CustomerEncryptionKeyResponse>('snapshotEncryptionKey');
