...
class ForwardingRuleArgs {
  ...
  final pulumi.Input<ForwardingRuleIpProtocol>? ipProtocol;

  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final pulumi.Input<ForwardingRuleIpVersion>? ipVersion;
  ...
  final pulumi.Input<ForwardingRuleLoadBalancingScheme>? loadBalancingScheme;
  ...
  final pulumi.Input<ForwardingRuleNetworkTier>? networkTier;
  ...
  final pulumi.Input<ForwardingRulePscConnectionStatus>? pscConnectionStatus;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] =
          pulumi.Input.mapOptionalInputValue<ForwardingRuleIpProtocol, String>(
              ipProtocolValue, (value) => value.value);
    }
    final ipVersionValue = ipVersion;
    if (ipVersionValue != null) {
      map['ipVersion'] =
          pulumi.Input.mapOptionalInputValue<ForwardingRuleIpVersion, String>(
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          pulumi.Input.mapOptionalInputValue<ForwardingRuleNetworkTier, String>(
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      ipProtocol: pulumi.Input.asOptionalInput<ForwardingRuleIpProtocol>(
          map['ipProtocol']),
      ipVersion: pulumi.Input.asOptionalInput<ForwardingRuleIpVersion>(
          map['ipVersion']),
      isMirroringCollector:
          pulumi.Input.asOptionalInput<bool>(map['isMirroringCollector']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      loadBalancingScheme:
          pulumi.Input.asOptionalInput<ForwardingRuleLoadBalancingScheme>(
      ...
      networkTier: pulumi.Input.asOptionalInput<ForwardingRuleNetworkTier>(
          map['networkTier']),
      noAutomateDnsZone:
      ...
      pscConnectionStatus:
          pulumi.Input.asOptionalInput<ForwardingRulePscConnectionStatus>(
