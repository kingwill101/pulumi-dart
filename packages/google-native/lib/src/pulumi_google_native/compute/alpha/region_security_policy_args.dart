...
class RegionSecurityPolicyArgs {
  ...
  final Input<RegionSecurityPolicyType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<RegionSecurityPolicyType, String>(
  ...
  factory RegionSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyArgs(
      ...
      type: Input.asOptionalInput<RegionSecurityPolicyType>(map['type']),
      userDefinedFields:
