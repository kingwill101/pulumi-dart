...
import 'service_attachment_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class ServiceAttachmentIamMember extends pulumi.CustomResource {
  ...
  ServiceAttachmentIamMember(
    String name, {
    ServiceAttachmentIamMemberArgs? args,
