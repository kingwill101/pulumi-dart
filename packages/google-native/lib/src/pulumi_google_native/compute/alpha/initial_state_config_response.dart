...
class InitialStateConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dbs'] =
        Input.encodeList<FileContentBufferResponse, Map<String, dynamic>>(
  ...
  factory InitialStateConfigResponse.fromMap(Map<String, dynamic> map) {
    return InitialStateConfigResponse(
      dbs: Input.decodeList<FileContentBufferResponse>(
          map['dbs'],
          (value) => FileContentBufferResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      dbxs: Input.decodeList<FileContentBufferResponse>(
          map['dbxs'],
          (value) => FileContentBufferResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      keks: Input.decodeList<FileContentBufferResponse>(
          map['keks'],
          (value) => FileContentBufferResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
