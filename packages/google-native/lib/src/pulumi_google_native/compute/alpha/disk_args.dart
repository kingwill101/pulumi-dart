...
class DiskArgs {
  ...
  final Input<DiskAccessMode>? accessMode;

  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final Input<DiskArchitecture>? architecture;

  /// Disk asynchronously replicated into this disk.
  final Input<DiskAsyncReplication>? asyncPrimaryDisk;
  ...
  final Input<CustomerEncryptionKey>? diskEncryptionKey;
  ...
  final Input<List<GuestOsFeature>>? guestOsFeatures;

  /// [Deprecated] Specifies the disk interface to use for attaching this disk, which is either SCSI or NVME. The default is SCSI.
  final Input<DiskInterface>? interface;
  ...
  final Input<CustomerEncryptionKey>? sourceImageEncryptionKey;
  ...
  final Input<CustomerEncryptionKey>? sourceSnapshotEncryptionKey;
  ...
  final Input<DiskStorageType>? storageType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessModeValue != null) {
      map['accessMode'] = Input.mapOptionalInputValue<DiskAccessMode, String>(
          accessModeValue, (value) => value.value);
    }
    final architectureValue = architecture;
    if (architectureValue != null) {
      map['architecture'] =
          Input.mapOptionalInputValue<DiskArchitecture, String>(
    ...
    if (guestOsFeaturesValue != null) {
      map['guestOsFeatures'] = Input.mapOptionalInputValue<List<GuestOsFeature>,
              List<Map<String, dynamic>>>(
          guestOsFeaturesValue,
          (value) => Input.encodeList<GuestOsFeature, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final interfaceValue = interface;
    if (interfaceValue != null) {
      map['interface'] = Input.mapOptionalInputValue<DiskInterface, String>(
    ...
    if (storageTypeValue != null) {
      map['storageType'] = Input.mapOptionalInputValue<DiskStorageType, String>(
  ...
  factory DiskArgs.fromMap(Map<String, dynamic> map) {
    return DiskArgs(
      accessMode: Input.asOptionalInput<DiskAccessMode>(map['accessMode']),
      architecture:
          Input.asOptionalInput<DiskArchitecture>(map['architecture']),
      asyncPrimaryDisk:
          Input.asOptionalInput<DiskAsyncReplication>(map['asyncPrimaryDisk']),
      description: Input.asOptionalInput<String>(map['description']),
      diskEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey>(
      ...
      guestOsFeatures:
          Input.asOptionalInput<List<GuestOsFeature>>(map['guestOsFeatures']),
      interface: Input.asOptionalInput<DiskInterface>(map['interface']),
      ...
      sourceImageEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey>(
      ...
      sourceSnapshotEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey>(
      ...
      storageType: Input.asOptionalInput<DiskStorageType>(map['storageType']),
