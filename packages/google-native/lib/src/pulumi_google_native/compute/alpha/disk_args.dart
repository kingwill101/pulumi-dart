...
class DiskArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessModeValue != null) {
      map['accessMode'] =
          pulumi.Input.mapOptionalInputValue<DiskAccessMode, String>(
              accessModeValue, (value) => value.value);
    }
    final architectureValue = architecture;
    if (architectureValue != null) {
      map['architecture'] =
          pulumi.Input.mapOptionalInputValue<DiskArchitecture, String>(
    ...
    if (interfaceValue != null) {
      map['interface'] =
          pulumi.Input.mapOptionalInputValue<DiskInterface, String>(
    ...
    if (storageTypeValue != null) {
      map['storageType'] =
          pulumi.Input.mapOptionalInputValue<DiskStorageType, String>(
  ...
  factory DiskArgs.fromMap(Map<String, dynamic> map) {
    return DiskArgs(
      accessMode:
          pulumi.Input.asOptionalInput<DiskAccessMode>(map['accessMode']),
      architecture:
          pulumi.Input.asOptionalInput<DiskArchitecture>(map['architecture']),
      ...
      guestOsFeatures: pulumi.Input.asOptionalInput<List<GuestOsFeature>>(
          map['guestOsFeatures']),
      interface: pulumi.Input.asOptionalInput<DiskInterface>(map['interface']),
      ...
      multiWriter: pulumi.Input.asOptionalInput<bool>(map['multiWriter']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      options: pulumi.Input.asOptionalInput<String>(map['options']),
      params: pulumi.Input.asOptionalInput<DiskParams>(map['params']),
      physicalBlockSizeBytes:
          pulumi.Input.asOptionalInput<String>(map['physicalBlockSizeBytes']),
      ...
      sourceStorageObject:
          pulumi.Input.asOptionalInput<String>(map['sourceStorageObject']),
      storagePool: pulumi.Input.asOptionalInput<String>(map['storagePool']),
      storageType:
          pulumi.Input.asOptionalInput<DiskStorageType>(map['storageType']),
