...
class SslCertificateArgs {
  ...
  final Input<SslCertificateType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<SslCertificateType, String>(
    ...
    return SslCertificateArgs(
      ...
      selfManaged:
          Input.asOptionalInput<SslCertificateSelfManagedSslCertificate>(
              map['selfManaged']),
      type: Input.asOptionalInput<SslCertificateType>(map['type']),
    );
  }
}
