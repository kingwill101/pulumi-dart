...
class RegionSnapshotArgs {
  ...
  final Input<CustomerEncryptionKey>? snapshotEncryptionKey;

  /// Indicates the type of the snapshot.
  final Input<RegionSnapshotSnapshotType>? snapshotType;

  /// The source disk used to create this snapshot.
  final Input<String>? sourceDisk;

  /// The customer-supplied encryption key of the source disk. Required if the source disk is protected by a customer-supplied encryption key.
  final Input<CustomerEncryptionKey>? sourceDiskEncryptionKey;
  ...
  final Input<CustomerEncryptionKey>? sourceInstantSnapshotEncryptionKey;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (snapshotTypeValue != null) {
      map['snapshotType'] =
          Input.mapOptionalInputValue<RegionSnapshotSnapshotType, String>(
  ...
  factory RegionSnapshotArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotArgs(
      ...
      snapshotEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey>(
          map['snapshotEncryptionKey']),
      snapshotType: Input.asOptionalInput<RegionSnapshotSnapshotType>(
          map['snapshotType']),
      sourceDisk: Input.asOptionalInput<String>(map['sourceDisk']),
      sourceDiskEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey>(
