...
import 'path_rule_response.dart';

/// A matcher for the path portion of the URL. The BackendService from the longest-matched rule will serve the URL. If no rule was matched, the default service is used.
class PathMatcherResponse {
  ...
  final List<PathRuleResponse> pathRules;

  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final List<HttpRouteRuleResponse> routeRules;
  ...
  factory PathMatcherResponse.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponse(
      defaultCustomErrorResponsePolicy:
          CustomErrorResponsePolicyResponse.fromMap(
              (map['defaultCustomErrorResponsePolicy'] as Map)
                  .cast<String, dynamic>()),
      defaultRouteAction: HttpRouteActionResponse.fromMap(
          (map['defaultRouteAction'] as Map).cast<String, dynamic>()),
      defaultService: map['defaultService'] as String,
      defaultUrlRedirect: HttpRedirectActionResponse.fromMap(
