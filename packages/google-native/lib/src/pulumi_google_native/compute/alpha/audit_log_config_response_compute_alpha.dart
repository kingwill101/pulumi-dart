...
class AuditLogConfigResponseComputeAlpha {
  ...
  factory AuditLogConfigResponseComputeAlpha.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseComputeAlpha(
