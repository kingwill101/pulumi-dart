...
class MachineImage extends CustomResource {
  ...
  late final Output<InstancePropertiesResponse> instanceProperties;
  ...
  late final Output<CustomerEncryptionKeyResponse> machineImageEncryptionKey;
  ...
  late final Output<List<SavedDiskResponse>> savedDisks;
  ...
  late final Output<List<SourceDiskEncryptionKeyResponse>>
  ...
  late final Output<SourceInstancePropertiesResponse> sourceInstanceProperties;
