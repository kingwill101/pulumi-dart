...
class RegionAutoscaler extends CustomResource {
  ...
  late final Output<AutoscalingPolicyResponse> autoscalingPolicy;
  ...
  late final Output<List<AutoscalerStatusDetailsResponse>> statusDetails;
  ...
  RegionAutoscaler(
    ...
    this.autoscalingPolicy = Output.createUnknown<AutoscalingPolicyResponse>();
    ...
    this.statusDetails =
        Output.createUnknown<List<AutoscalerStatusDetailsResponse>>();
