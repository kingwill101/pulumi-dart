...
class RegionSslPolicyArgs {
  ...
  final Input<RegionSslPolicyMinTlsVersion>? minTlsVersion;
  ...
  final Input<RegionSslPolicyProfile>? profile;
  ...
  final Input<ServerTlsSettings>? tlsSettings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (minTlsVersionValue != null) {
      map['minTlsVersion'] =
          Input.mapOptionalInputValue<RegionSslPolicyMinTlsVersion, String>(
    ...
    if (profileValue != null) {
      map['profile'] =
          Input.mapOptionalInputValue<RegionSslPolicyProfile, String>(
    ...
    if (tlsSettingsValue != null) {
      map['tlsSettings'] =
          Input.mapOptionalInputValue<ServerTlsSettings, Map<String, dynamic>>(
              tlsSettingsValue, (value) => value.toMap());
    }
    return map;
  }
  ...
  factory RegionSslPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyArgs(
      ...
      minTlsVersion: Input.asOptionalInput<RegionSslPolicyMinTlsVersion>(
          map['minTlsVersion']),
      name: Input.asOptionalInput<String>(map['name']),
      profile: Input.asOptionalInput<RegionSslPolicyProfile>(map['profile']),
      project: Input.asOptionalInput<String>(map['project']),
      region: Input.asInput<String>(map['region']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      tlsSettings: Input.asOptionalInput<ServerTlsSettings>(map['tlsSettings']),
    );
  }
}
