...
class GlobalPublicDelegatedPrefixArgs {
  ...
  final Input<GlobalPublicDelegatedPrefixMode>? mode;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (modeValue != null) {
      map['mode'] =
          Input.mapOptionalInputValue<GlobalPublicDelegatedPrefixMode, String>(
  ...
  factory GlobalPublicDelegatedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixArgs(
      ...
      mode: Input.asOptionalInput<GlobalPublicDelegatedPrefixMode>(map['mode']),
