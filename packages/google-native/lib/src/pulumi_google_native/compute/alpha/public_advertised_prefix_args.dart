...
class PublicAdvertisedPrefixArgs {
  ...
  final Input<PublicAdvertisedPrefixPdpScope>? pdpScope;
  ...
  final Input<PublicAdvertisedPrefixStatus>? status;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (pdpScopeValue != null) {
      map['pdpScope'] =
          Input.mapOptionalInputValue<PublicAdvertisedPrefixPdpScope, String>(
    ...
    if (statusValue != null) {
      map['status'] =
          Input.mapOptionalInputValue<PublicAdvertisedPrefixStatus, String>(
  ...
  factory PublicAdvertisedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixArgs(
      ...
      pdpScope: Input.asOptionalInput<PublicAdvertisedPrefixPdpScope>(
          map['pdpScope']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      status:
          Input.asOptionalInput<PublicAdvertisedPrefixStatus>(map['status']),
    );
  }
}
