...
class InstanceIamMemberComputeAlphaArgs {
  ...
  InstanceIamMemberComputeAlphaArgs({
    this.condition,
  ...
  factory InstanceIamMemberComputeAlphaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberComputeAlphaArgs(
