...
class SubnetworkArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (aggregationIntervalValue != null) {
      map['aggregationInterval'] = pulumi.Input.mapOptionalInputValue<
          SubnetworkAggregationInterval,
          String>(aggregationIntervalValue, (value) => value.value);
    }
    ...
    if (purposeValue != null) {
      map['purpose'] =
          pulumi.Input.mapOptionalInputValue<SubnetworkPurpose, String>(
    ...
    if (roleValue != null) {
      map['role'] = pulumi.Input.mapOptionalInputValue<SubnetworkRole, String>(
    ...
    if (secondaryIpRangesValue != null) {
      map['secondaryIpRanges'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<SubnetworkSecondaryRange,
  ...
  factory SubnetworkArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs(
      ...
      enableL2: pulumi.Input.asOptionalInput<bool>(map['enableL2']),
      enablePrivateV6Access:
          pulumi.Input.asOptionalInput<bool>(map['enablePrivateV6Access']),
      externalIpv6Prefix:
      ...
      metadata:
          pulumi.Input.asOptionalInput<SubnetworkMetadata>(map['metadata']),
      ...
      purpose: pulumi.Input.asOptionalInput<SubnetworkPurpose>(map['purpose']),
      region: pulumi.Input.asInput<String>(map['region']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      reservedInternalRange:
          pulumi.Input.asOptionalInput<String>(map['reservedInternalRange']),
      role: pulumi.Input.asOptionalInput<SubnetworkRole>(map['role']),
      secondaryIpRanges:
          pulumi.Input.asOptionalInput<List<SubnetworkSecondaryRange>>(
              map['secondaryIpRanges']),
      stackType:
          pulumi.Input.asOptionalInput<SubnetworkStackType>(map['stackType']),
      vlans: pulumi.Input.asOptionalInput<List<int>>(map['vlans']),
    );
  }
}
