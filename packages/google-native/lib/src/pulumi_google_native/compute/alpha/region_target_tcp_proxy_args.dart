...
class RegionTargetTcpProxyArgs {
  ...
  final Input<RegionTargetTcpProxyProxyHeader>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          Input.mapOptionalInputValue<RegionTargetTcpProxyProxyHeader, String>(
  ...
  factory RegionTargetTcpProxyArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyArgs(
      ...
      proxyHeader: Input.asOptionalInput<RegionTargetTcpProxyProxyHeader>(
          map['proxyHeader']),
