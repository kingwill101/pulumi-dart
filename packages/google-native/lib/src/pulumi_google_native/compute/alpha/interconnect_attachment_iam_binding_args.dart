...
/// The set of arguments for InterconnectAttachmentIamBinding.
class InterconnectAttachmentIamBindingArgs {
  ...
  InterconnectAttachmentIamBindingArgs({
    this.condition,
  ...
  factory InterconnectAttachmentIamBindingArgs.fromMap(
      Map<String, dynamic> map) {
    return InterconnectAttachmentIamBindingArgs(
