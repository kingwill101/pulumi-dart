...
class RegionDiskArgs {
  ...
  final Input<RegionDiskAccessMode>? accessMode;

  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final Input<RegionDiskArchitecture>? architecture;
  ...
  final Input<RegionDiskInterface>? interface;
  ...
  final Input<RegionDiskStorageType>? storageType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessModeValue != null) {
      map['accessMode'] =
          Input.mapOptionalInputValue<RegionDiskAccessMode, String>(
              accessModeValue, (value) => value.value);
    }
    final architectureValue = architecture;
    if (architectureValue != null) {
      map['architecture'] =
          Input.mapOptionalInputValue<RegionDiskArchitecture, String>(
    ...
    if (interfaceValue != null) {
      map['interface'] =
          Input.mapOptionalInputValue<RegionDiskInterface, String>(
    ...
    if (storageTypeValue != null) {
      map['storageType'] =
          Input.mapOptionalInputValue<RegionDiskStorageType, String>(
  ...
  factory RegionDiskArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs(
      accessMode:
          Input.asOptionalInput<RegionDiskAccessMode>(map['accessMode']),
      architecture:
          Input.asOptionalInput<RegionDiskArchitecture>(map['architecture']),
      asyncPrimaryDisk:
      ...
      interface: Input.asOptionalInput<RegionDiskInterface>(map['interface']),
      ...
      storageType:
          Input.asOptionalInput<RegionDiskStorageType>(map['storageType']),
