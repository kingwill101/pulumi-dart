...
import 'reservation_args3.dart';
import 'share_settings_response.dart';

/// Creates a new reservation. For more information, read Reserving zonal resources.
class Reservation6 extends CustomResource {
  /// Reservation for aggregated resources, providing shape flexibility.
  late final Output<AllocationAggregateReservationResponse>
  ...
  late final Output<DurationResponse> deleteAfterDuration;
  ...
  late final Output<AllocationResourceStatusResponse> resourceStatus;
  ...
  late final Output<AllocationSpecificSKUReservationResponse>
      specificReservation;
  ...
  Reservation6(
    ...
    this.aggregateReservation =
        Output.createUnknown<AllocationAggregateReservationResponse>();
    this.commitment = Output.createUnknown<String>();
    this.creationTimestamp = Output.createUnknown<String>();
    this.deleteAfterDuration = Output.createUnknown<DurationResponse>();
    ...
    this.resourceStatus =
        Output.createUnknown<AllocationResourceStatusResponse>();
    ...
    this.specificReservation =
        Output.createUnknown<AllocationSpecificSKUReservationResponse>();
