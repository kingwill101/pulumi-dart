...
class Route extends CustomResource {
  ...
  late final Output<bool> allowConflictingSubnetworks;

  /// AS path.
  late final Output<List<RouteAsPathResponse>> asPaths;
  ...
  late final Output<String> ilbRouteBehaviorOnUnhealthy;
  ...
  late final Output<int> nextHopInterRegionCost;
  ...
  late final Output<String> nextHopInterconnectAttachment;
  ...
  late final Output<int> nextHopMed;
  ...
  late final Output<List<RouteWarningsItemResponse>> warnings;
