...
class MachineImageArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (savedDisksValue != null) {
      map['savedDisks'] = pulumi.Input.mapOptionalInputValue<List<SavedDisk>,
    ...
    if (sourceDiskEncryptionKeysValue != null) {
      map['sourceDiskEncryptionKeys'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<SourceDiskEncryptionKey,
  ...
  factory MachineImageArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageArgs(
      ...
      savedDisks:
          pulumi.Input.asOptionalInput<List<SavedDisk>>(map['savedDisks']),
      sourceDiskEncryptionKeys:
          pulumi.Input.asOptionalInput<List<SourceDiskEncryptionKey>>(
