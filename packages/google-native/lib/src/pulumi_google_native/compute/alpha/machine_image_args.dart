...
class MachineImageArgs {
  ...
  final Input<CustomerEncryptionKey>? machineImageEncryptionKey;
  ...
  final Input<List<SavedDisk>>? savedDisks;

  /// [Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.
  final Input<List<SourceDiskEncryptionKey>>? sourceDiskEncryptionKeys;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (savedDisksValue != null) {
      map['savedDisks'] = Input.mapOptionalInputValue<List<SavedDisk>,
              List<Map<String, dynamic>>>(
          savedDisksValue,
          (value) => Input.encodeList<SavedDisk, Map<String, dynamic>>(
    ...
    if (sourceDiskEncryptionKeysValue != null) {
      map['sourceDiskEncryptionKeys'] = Input.mapOptionalInputValue<
              List<SourceDiskEncryptionKey>, List<Map<String, dynamic>>>(
          sourceDiskEncryptionKeysValue,
          (value) =>
              Input.encodeList<SourceDiskEncryptionKey, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
  ...
  factory MachineImageArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageArgs(
      ...
      machineImageEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey>(
          map['machineImageEncryptionKey']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      savedDisks: Input.asOptionalInput<List<SavedDisk>>(map['savedDisks']),
      sourceDiskEncryptionKeys:
          Input.asOptionalInput<List<SourceDiskEncryptionKey>>(
