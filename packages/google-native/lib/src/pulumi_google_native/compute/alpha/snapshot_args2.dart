...
class SnapshotArgs2 {
  ...
  final Input<SnapshotSnapshotType>? snapshotType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (snapshotTypeValue != null) {
      map['snapshotType'] =
          Input.mapOptionalInputValue<SnapshotSnapshotType, String>(
  ...
  factory SnapshotArgs2.fromMap(Map<String, dynamic> map) {
    return SnapshotArgs2(
      ...
      snapshotType:
          Input.asOptionalInput<SnapshotSnapshotType>(map['snapshotType']),
