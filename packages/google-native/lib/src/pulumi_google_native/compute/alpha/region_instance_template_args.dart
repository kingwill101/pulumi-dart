...
class RegionInstanceTemplateArgs {
  ...
  final Input<InstanceProperties>? properties;
  ...
  final Input<SourceInstanceParams>? sourceInstanceParams;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (propertiesValue != null) {
      map['properties'] =
          Input.mapOptionalInputValue<InstanceProperties, Map<String, dynamic>>(
  ...
  factory RegionInstanceTemplateArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateArgs(
      ...
      properties: Input.asOptionalInput<InstanceProperties>(map['properties']),
      region: Input.asInput<String>(map['region']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      sourceInstance: Input.asOptionalInput<String>(map['sourceInstance']),
      sourceInstanceParams: Input.asOptionalInput<SourceInstanceParams>(
