...
class OrganizationSecurityPolicyArgs {
  ...
  final Input<OrganizationSecurityPolicyType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<OrganizationSecurityPolicyType, String>(
  ...
  factory OrganizationSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSecurityPolicyArgs(
      ...
      type: Input.asOptionalInput<OrganizationSecurityPolicyType>(map['type']),
      userDefinedFields:
