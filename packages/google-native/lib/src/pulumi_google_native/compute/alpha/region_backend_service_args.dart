...
class RegionBackendServiceArgs {
  ...
  final pulumi.Input<RegionBackendServiceIpAddressSelectionPolicy>?
      ipAddressSelectionPolicy;

  /// Specifies the load balancer type. A backend service created for one type of load balancer cannot be used with another. For more information, refer to Choosing a load balancer.
  final pulumi.Input<RegionBackendServiceLoadBalancingScheme>?
      loadBalancingScheme;
  ...
  factory RegionBackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs(
      ...
      backends: pulumi.Input.asOptionalInput<List<Backend>>(map['backends']),
      cdnPolicy: pulumi.Input.asOptionalInput<BackendServiceCdnPolicy>(
          map['cdnPolicy']),
      circuitBreakers:
          pulumi.Input.asOptionalInput<CircuitBreakers>(map['circuitBreakers']),
      compressionMode:
          pulumi.Input.asOptionalInput<RegionBackendServiceCompressionMode>(
              map['compressionMode']),
      connectionDraining: pulumi.Input.asOptionalInput<ConnectionDraining>(
          map['connectionDraining']),
      connectionTrackingPolicy:
          pulumi.Input.asOptionalInput<BackendServiceConnectionTrackingPolicy>(
      ...
      loadBalancingScheme:
          pulumi.Input.asOptionalInput<RegionBackendServiceLoadBalancingScheme>(
              map['loadBalancingScheme']),
      localityLbPolicies: pulumi.Input.asOptionalInput<
              List<BackendServiceLocalityLoadBalancingPolicyConfig>>(
          map['localityLbPolicies']),
      localityLbPolicy:
          pulumi.Input.asOptionalInput<RegionBackendServiceLocalityLbPolicy>(
              map['localityLbPolicy']),
      logConfig: pulumi.Input.asOptionalInput<BackendServiceLogConfig>(
          map['logConfig']),
      maxStreamDuration:
          pulumi.Input.asOptionalInput<Duration>(map['maxStreamDuration']),
      metadatas:
      ...
      outlierDetection: pulumi.Input.asOptionalInput<OutlierDetection>(
      ...
      protocol: pulumi.Input.asOptionalInput<RegionBackendServiceProtocol>(
          map['protocol']),
      region: pulumi.Input.asInput<String>(map['region']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      securitySettings: pulumi.Input.asOptionalInput<SecuritySettings>(
      ...
      sessionAffinity:
          pulumi.Input.asOptionalInput<RegionBackendServiceSessionAffinity>(
              map['sessionAffinity']),
      subsetting: pulumi.Input.asOptionalInput<Subsetting>(map['subsetting']),
      timeoutSec: pulumi.Input.asOptionalInput<int>(map['timeoutSec']),
      usedBy: pulumi.Input.asOptionalInput<List<BackendServiceUsedBy>>(
          map['usedBy']),
      vpcNetworkScope:
          pulumi.Input.asOptionalInput<RegionBackendServiceVpcNetworkScope>(
              map['vpcNetworkScope']),
    );
  }
}
