...
class GlobalForwardingRuleArgs {
  ...
  factory GlobalForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleArgs(
      ...
      ipProtocol: pulumi.Input.asOptionalInput<GlobalForwardingRuleIpProtocol>(
          map['ipProtocol']),
      ...
      loadBalancingScheme:
          pulumi.Input.asOptionalInput<GlobalForwardingRuleLoadBalancingScheme>(
      ...
      pscConnectionStatus:
          pulumi.Input.asOptionalInput<GlobalForwardingRulePscConnectionStatus>(
