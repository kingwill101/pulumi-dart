...
class GlobalForwardingRuleArgs {
  ...
  final Input<GlobalForwardingRuleIpProtocol>? ipProtocol;

  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final Input<GlobalForwardingRuleIpVersion>? ipVersion;
  ...
  final Input<GlobalForwardingRuleLoadBalancingScheme>? loadBalancingScheme;
  ...
  final Input<GlobalForwardingRuleNetworkTier>? networkTier;
  ...
  final Input<GlobalForwardingRulePscConnectionStatus>? pscConnectionStatus;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleIpProtocol, String>(
              ipProtocolValue, (value) => value.value);
    }
    final ipVersionValue = ipVersion;
    if (ipVersionValue != null) {
      map['ipVersion'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleIpVersion, String>(
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleNetworkTier, String>(
  ...
  factory GlobalForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleArgs(
      ...
      ipProtocol: Input.asOptionalInput<GlobalForwardingRuleIpProtocol>(
          map['ipProtocol']),
      ipVersion: Input.asOptionalInput<GlobalForwardingRuleIpVersion>(
          map['ipVersion']),
      isMirroringCollector:
          Input.asOptionalInput<bool>(map['isMirroringCollector']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      loadBalancingScheme:
          Input.asOptionalInput<GlobalForwardingRuleLoadBalancingScheme>(
      ...
      networkTier: Input.asOptionalInput<GlobalForwardingRuleNetworkTier>(
          map['networkTier']),
      ...
      pscConnectionStatus:
          Input.asOptionalInput<GlobalForwardingRulePscConnectionStatus>(
