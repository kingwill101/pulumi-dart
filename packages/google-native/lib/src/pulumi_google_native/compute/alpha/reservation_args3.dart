...
class ReservationArgs3 {
  /// Reservation for aggregated resources, providing shape flexibility.
  final Input<AllocationAggregateReservation>? aggregateReservation;

  /// Duration time relative to reservation creation when GCE will automatically delete this resource.
  final Input<Duration>? deleteAfterDuration;
  ...
  final Input<AllocationSpecificSKUReservation>? specificReservation;
  ...
  factory ReservationArgs3.fromMap(Map<String, dynamic> map) {
    return ReservationArgs3(
      aggregateReservation:
          Input.asOptionalInput<AllocationAggregateReservation>(
              map['aggregateReservation']),
      deleteAfterDuration:
          Input.asOptionalInput<Duration>(map['deleteAfterDuration']),
      ...
      specificReservation:
          Input.asOptionalInput<AllocationSpecificSKUReservation>(
