...
class ExternalVpnGatewayArgs {
  ...
  final Input<ExternalVpnGatewayRedundancyType>? redundancyType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (redundancyTypeValue != null) {
      map['redundancyType'] =
          Input.mapOptionalInputValue<ExternalVpnGatewayRedundancyType, String>(
              redundancyTypeValue, (value) => value.value);
    }
  ...
  factory ExternalVpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayArgs(
      ...
      redundancyType: Input.asOptionalInput<ExternalVpnGatewayRedundancyType>(
          map['redundancyType']),
