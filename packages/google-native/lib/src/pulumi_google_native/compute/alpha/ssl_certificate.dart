...
class SslCertificate extends CustomResource {
  ...
  late final Output<SslCertificateManagedSslCertificateResponse> managed;
  ...
  late final Output<SslCertificateSelfManagedSslCertificateResponse>
      selfManaged;
  ...
  SslCertificate(
    ...
    this.managed =
        Output.createUnknown<SslCertificateManagedSslCertificateResponse>();
    ...
    this.selfManaged =
        Output.createUnknown<SslCertificateSelfManagedSslCertificateResponse>();
