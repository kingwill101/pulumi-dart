...
class AddressArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (purposeValue != null) {
      map['purpose'] =
          pulumi.Input.mapOptionalInputValue<AddressPurpose, String>(
  ...
  factory AddressArgs.fromMap(Map<String, dynamic> map) {
    return AddressArgs(
      ...
      addressType:
          pulumi.Input.asOptionalInput<AddressAddressType>(map['addressType']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      ipVersion:
          pulumi.Input.asOptionalInput<AddressIpVersion>(map['ipVersion']),
      ...
      networkTier:
          pulumi.Input.asOptionalInput<AddressNetworkTier>(map['networkTier']),
      prefixLength: pulumi.Input.asOptionalInput<int>(map['prefixLength']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      purpose: pulumi.Input.asOptionalInput<AddressPurpose>(map['purpose']),
