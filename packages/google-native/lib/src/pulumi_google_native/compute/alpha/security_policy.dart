...
class SecurityPolicy extends pulumi.CustomResource {
  late final pulumi.Output<SecurityPolicyAdaptiveProtectionConfigResponse>
      adaptiveProtectionConfig;
  late final pulumi.Output<SecurityPolicyAdvancedOptionsConfigResponse>
      advancedOptionsConfig;

  /// A list of associations that belong to this policy.
  late final pulumi.Output<List<SecurityPolicyAssociationResponse>>
      associations;
  late final pulumi.Output<SecurityPolicyCloudArmorConfigResponse>
      cloudArmorConfig;

  /// Creation timestamp in RFC3339 text format.
  late final pulumi.Output<String> creationTimestamp;
  late final pulumi.Output<SecurityPolicyDdosProtectionConfigResponse>
  ...
  late final pulumi.Output<SecurityPolicyRecaptchaOptionsConfigResponse>
  ...
  late final pulumi.Output<List<SecurityPolicyUserDefinedFieldResponse>>
      userDefinedFields;
  ...
  SecurityPolicy(
    ...
    this.advancedOptionsConfig =
        registerOutput<SecurityPolicyAdvancedOptionsConfigResponse>(
            'advancedOptionsConfig');
    this.associations =
        registerOutput<List<SecurityPolicyAssociationResponse>>('associations');
    this.cloudArmorConfig =
        registerOutput<SecurityPolicyCloudArmorConfigResponse>(
            'cloudArmorConfig');
    ...
    this.userDefinedFields =
        registerOutput<List<SecurityPolicyUserDefinedFieldResponse>>(
            'userDefinedFields');
  }
}
