...
class InterconnectAttachmentArgs {
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      bandwidth: pulumi.Input.asOptionalInput<InterconnectAttachmentBandwidth>(
          map['bandwidth']),
      ...
      stackType: pulumi.Input.asOptionalInput<InterconnectAttachmentStackType>(
          map['stackType']),
      subnetLength: pulumi.Input.asOptionalInput<int>(map['subnetLength']),
      type:
          pulumi.Input.asOptionalInput<InterconnectAttachmentType>(map['type']),
