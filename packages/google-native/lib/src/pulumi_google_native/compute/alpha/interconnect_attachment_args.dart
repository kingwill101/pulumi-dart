...
class InterconnectAttachmentArgs {
  ...
  final Input<InterconnectAttachmentBandwidth>? bandwidth;
  ...
  final Input<InterconnectAttachmentEdgeAvailabilityDomain>?
  ...
  final Input<InterconnectAttachmentEncryption>? encryption;
  ...
  final Input<InterconnectAttachmentPartnerMetadata>? partnerMetadata;
  ...
  final Input<InterconnectAttachmentStackType>? stackType;
  ...
  final Input<InterconnectAttachmentType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bandwidthValue != null) {
      map['bandwidth'] =
          Input.mapOptionalInputValue<InterconnectAttachmentBandwidth, String>(
    ...
    if (encryptionValue != null) {
      map['encryption'] =
          Input.mapOptionalInputValue<InterconnectAttachmentEncryption, String>(
              encryptionValue, (value) => value.value);
    }
    ...
    if (stackTypeValue != null) {
      map['stackType'] =
          Input.mapOptionalInputValue<InterconnectAttachmentStackType, String>(
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<InterconnectAttachmentType, String>(
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      bandwidth: Input.asOptionalInput<InterconnectAttachmentBandwidth>(
          map['bandwidth']),
      ...
      edgeAvailabilityDomain:
          Input.asOptionalInput<InterconnectAttachmentEdgeAvailabilityDomain>(
              map['edgeAvailabilityDomain']),
      encryption: Input.asOptionalInput<InterconnectAttachmentEncryption>(
          map['encryption']),
      ...
      partnerMetadata:
          Input.asOptionalInput<InterconnectAttachmentPartnerMetadata>(
              map['partnerMetadata']),
      project: Input.asOptionalInput<String>(map['project']),
      region: Input.asInput<String>(map['region']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      router: Input.asOptionalInput<String>(map['router']),
      stackType: Input.asOptionalInput<InterconnectAttachmentStackType>(
          map['stackType']),
      subnetLength: Input.asOptionalInput<int>(map['subnetLength']),
      type: Input.asOptionalInput<InterconnectAttachmentType>(map['type']),
