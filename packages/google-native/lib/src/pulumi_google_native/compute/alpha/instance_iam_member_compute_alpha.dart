...
import 'instance_iam_member_compute_alpha_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class InstanceIamMemberComputeAlpha extends pulumi.CustomResource {
  ...
  InstanceIamMemberComputeAlpha(
    String name, {
    InstanceIamMemberComputeAlphaArgs? args,
