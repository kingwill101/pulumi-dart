...
class GlobalNetworkEndpointGroupArgs {
  ...
  final Input<GlobalNetworkEndpointGroupClientPortMappingMode>?
  ...
  final Input<GlobalNetworkEndpointGroupNetworkEndpointType>?
      networkEndpointType;
  ...
  final Input<GlobalNetworkEndpointGroupType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<GlobalNetworkEndpointGroupType, String>(
  ...
  factory GlobalNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupArgs(
      ...
      appEngine: Input.asOptionalInput<NetworkEndpointGroupAppEngine>(
          map['appEngine']),
      clientPortMappingMode: Input.asOptionalInput<
              GlobalNetworkEndpointGroupClientPortMappingMode>(
      ...
      networkEndpointType:
          Input.asOptionalInput<GlobalNetworkEndpointGroupNetworkEndpointType>(
      ...
      type: Input.asOptionalInput<GlobalNetworkEndpointGroupType>(map['type']),
    );
  }
}
