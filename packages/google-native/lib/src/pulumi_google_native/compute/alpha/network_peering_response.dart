...
class NetworkPeeringResponse {
  ...
  NetworkPeeringResponse({
    required this.advertisePeerSubnetsViaRouters,
  ...
  Map<String, dynamic> toMap() {
    ...
    map['advertisePeerSubnetsViaRouters'] = advertisePeerSubnetsViaRouters;
  ...
  factory NetworkPeeringResponse.fromMap(Map<String, dynamic> map) {
    return NetworkPeeringResponse(
      advertisePeerSubnetsViaRouters:
          map['advertisePeerSubnetsViaRouters'] as bool,
