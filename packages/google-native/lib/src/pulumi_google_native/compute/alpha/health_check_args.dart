...
class HealthCheckArgs {
  ...
  factory HealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckArgs(
      ...
      grpcHealthCheck:
          pulumi.Input.asOptionalInput<GRPCHealthCheck>(map['grpcHealthCheck']),
      healthyThreshold:
          pulumi.Input.asOptionalInput<int>(map['healthyThreshold']),
      http2HealthCheck: pulumi.Input.asOptionalInput<HTTP2HealthCheck>(
          map['http2HealthCheck']),
      httpHealthCheck:
          pulumi.Input.asOptionalInput<HTTPHealthCheck>(map['httpHealthCheck']),
      httpsHealthCheck: pulumi.Input.asOptionalInput<HTTPSHealthCheck>(
      ...
      sslHealthCheck:
          pulumi.Input.asOptionalInput<SSLHealthCheck>(map['sslHealthCheck']),
      tcpHealthCheck:
          pulumi.Input.asOptionalInput<TCPHealthCheck>(map['tcpHealthCheck']),
      timeoutSec: pulumi.Input.asOptionalInput<int>(map['timeoutSec']),
      type: pulumi.Input.asOptionalInput<HealthCheckType>(map['type']),
      udpHealthCheck:
          pulumi.Input.asOptionalInput<UDPHealthCheck>(map['udpHealthCheck']),
      unhealthyThreshold:
