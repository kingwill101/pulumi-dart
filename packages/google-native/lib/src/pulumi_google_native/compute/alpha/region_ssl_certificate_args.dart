...
import 'region_ssl_certificate_type.dart';
...
class RegionSslCertificateArgs {
  ...
  final Input<SslCertificateManagedSslCertificate>? managed;
  ...
  final Input<SslCertificateSelfManagedSslCertificate>? selfManaged;

  /// (Optional) Specifies the type of SSL certificate, either "SELF_MANAGED" or "MANAGED". If not specified, the certificate is self-managed and the fields certificate and private_key are used.
  final Input<RegionSslCertificateType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<RegionSslCertificateType, String>(
  ...
  factory RegionSslCertificateArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslCertificateArgs(
      ...
      managed: Input.asOptionalInput<SslCertificateManagedSslCertificate>(
          map['managed']),
      ...
      selfManaged:
          Input.asOptionalInput<SslCertificateSelfManagedSslCertificate>(
              map['selfManaged']),
      type: Input.asOptionalInput<RegionSslCertificateType>(map['type']),
    );
  }
}
