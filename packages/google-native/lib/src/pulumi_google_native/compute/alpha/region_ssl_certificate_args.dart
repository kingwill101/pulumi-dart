...
class RegionSslCertificateArgs {
  ...
  final pulumi.Input<RegionSslCertificateType>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          pulumi.Input.mapOptionalInputValue<RegionSslCertificateType, String>(
  ...
  factory RegionSslCertificateArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslCertificateArgs(
      ...
      managed:
          pulumi.Input.asOptionalInput<SslCertificateManagedSslCertificate>(
              map['managed']),
      ...
      selfManaged:
          pulumi.Input.asOptionalInput<SslCertificateSelfManagedSslCertificate>(
              map['selfManaged']),
      type: pulumi.Input.asOptionalInput<RegionSslCertificateType>(map['type']),
    );
  }
}
