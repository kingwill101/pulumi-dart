...
class FirewallPolicyArgs {
  ...
  final Input<FirewallPolicyVpcNetworkScope>? vpcNetworkScope;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (vpcNetworkScopeValue != null) {
      map['vpcNetworkScope'] =
          Input.mapOptionalInputValue<FirewallPolicyVpcNetworkScope, String>(
              vpcNetworkScopeValue, (value) => value.value);
    }
    return map;
  }
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      ...
      vpcNetworkScope: Input.asOptionalInput<FirewallPolicyVpcNetworkScope>(
          map['vpcNetworkScope']),
    );
  }
}
