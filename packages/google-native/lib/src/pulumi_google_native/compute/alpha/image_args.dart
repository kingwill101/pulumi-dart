...
class ImageArgs {
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      architecture:
          pulumi.Input.asOptionalInput<ImageArchitecture>(map['architecture']),
      archiveSizeBytes:
          pulumi.Input.asOptionalInput<String>(map['archiveSizeBytes']),
      deprecated:
          pulumi.Input.asOptionalInput<DeprecationStatus>(map['deprecated']),
      ...
      rolloutOverride:
          pulumi.Input.asOptionalInput<RolloutPolicy>(map['rolloutOverride']),
      ...
      sourceType:
          pulumi.Input.asOptionalInput<ImageSourceType>(map['sourceType']),
      storageLocations:
