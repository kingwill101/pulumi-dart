...
class ImageArgs {
  ...
  final Input<ImageArchitecture>? architecture;

  /// Size of the image tar.gz archive stored in Google Cloud Storage (in bytes).
  final Input<String>? archiveSizeBytes;

  /// The deprecation status associated with this image.
  final Input<DeprecationStatus>? deprecated;
  ...
  final Input<CustomerEncryptionKey>? imageEncryptionKey;
  ...
  final Input<RolloutPolicy>? rolloutOverride;

  /// Set the secure boot keys of shielded instance.
  final Input<InitialStateConfig>? shieldedInstanceInitialState;
  ...
  final Input<ImageSourceType>? sourceType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (architectureValue != null) {
      map['architecture'] =
          Input.mapOptionalInputValue<ImageArchitecture, String>(
    ...
    if (deprecatedValue != null) {
      map['deprecated'] =
          Input.mapOptionalInputValue<DeprecationStatus, Map<String, dynamic>>(
    ...
    if (rolloutOverrideValue != null) {
      map['rolloutOverride'] =
          Input.mapOptionalInputValue<RolloutPolicy, Map<String, dynamic>>(
    ...
    if (shieldedInstanceInitialStateValue != null) {
      map['shieldedInstanceInitialState'] =
          Input.mapOptionalInputValue<InitialStateConfig, Map<String, dynamic>>(
    ...
    if (sourceTypeValue != null) {
      map['sourceType'] = Input.mapOptionalInputValue<ImageSourceType, String>(
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      architecture:
          Input.asOptionalInput<ImageArchitecture>(map['architecture']),
      archiveSizeBytes: Input.asOptionalInput<String>(map['archiveSizeBytes']),
      deprecated: Input.asOptionalInput<DeprecationStatus>(map['deprecated']),
      ...
      imageEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey>(
      ...
      rolloutOverride:
          Input.asOptionalInput<RolloutPolicy>(map['rolloutOverride']),
      shieldedInstanceInitialState: Input.asOptionalInput<InitialStateConfig>(
          map['shieldedInstanceInitialState']),
      ...
      sourceType: Input.asOptionalInput<ImageSourceType>(map['sourceType']),
      storageLocations:
