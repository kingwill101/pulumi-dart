...
class TargetPoolArgs {
  ...
  final Input<TargetPoolSessionAffinity>? sessionAffinity;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sessionAffinityValue != null) {
      map['sessionAffinity'] =
          Input.mapOptionalInputValue<TargetPoolSessionAffinity, String>(
  ...
  factory TargetPoolArgs.fromMap(Map<String, dynamic> map) {
    return TargetPoolArgs(
      ...
      sessionAffinity: Input.asOptionalInput<TargetPoolSessionAffinity>(
          map['sessionAffinity']),
    );
  }
}
