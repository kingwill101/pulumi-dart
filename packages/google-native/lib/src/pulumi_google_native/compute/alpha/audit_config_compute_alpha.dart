...
import 'audit_log_config_compute_alpha.dart';
...
class AuditConfigComputeAlpha {
  /// The configuration for logging of each type of permission.
  final List<AuditLogConfigComputeAlpha>? auditLogConfigs;
  ...
  factory AuditConfigComputeAlpha.fromMap(Map<String, dynamic> map) {
    return AuditConfigComputeAlpha(
      auditLogConfigs: map['auditLogConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditLogConfigComputeAlpha>(
              map['auditLogConfigs'],
              (value) => AuditLogConfigComputeAlpha.fromMap(
