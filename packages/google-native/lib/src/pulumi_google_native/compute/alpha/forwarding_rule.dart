...
class ForwardingRule extends CustomResource {
  ...
  late final Output<List<MetadataFilterResponse>> metadataFilters;
  ...
  late final Output<List<ForwardingRuleServiceDirectoryRegistrationResponse>>
  ...
  ForwardingRule(
    ...
    this.metadataFilters = Output.createUnknown<List<MetadataFilterResponse>>();
