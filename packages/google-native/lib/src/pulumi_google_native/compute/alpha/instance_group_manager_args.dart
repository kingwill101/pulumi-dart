...
class InstanceGroupManagerArgs {
  ...
  final Input<InstanceGroupManagerFailoverAction>? failoverAction;
  ...
  final Input<InstanceGroupManagerListManagedInstancesResults>?
  ...
  final Input<InstanceGroupManagerTargetSizeUnit>? targetSizeUnit;
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      ...
      failoverAction: Input.asOptionalInput<InstanceGroupManagerFailoverAction>(
          map['failoverAction']),
      instanceFlexibilityPolicy:
      ...
      targetSizeUnit: Input.asOptionalInput<InstanceGroupManagerTargetSizeUnit>(
          map['targetSizeUnit']),
