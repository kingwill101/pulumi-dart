...
class GetResourcePolicyResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['status'] = status;
    map['vmMaintenancePolicy'] = vmMaintenancePolicy.toMap();
    return map;
  }
  ...
  factory GetResourcePolicyResult.fromMap(Map<String, dynamic> map) {
    return GetResourcePolicyResult(
      ...
      groupPlacementPolicy: ResourcePolicyGroupPlacementPolicyResponse.fromMap(
          (map['groupPlacementPolicy'] as Map).cast<String, dynamic>()),
      instanceSchedulePolicy:
          ResourcePolicyInstanceSchedulePolicyResponse.fromMap(
              (map['instanceSchedulePolicy'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      name: map['name'] as String,
      region: map['region'] as String,
      resourceStatus: ResourcePolicyResourceStatusResponse.fromMap(
          (map['resourceStatus'] as Map).cast<String, dynamic>()),
      selfLink: map['selfLink'] as String,
      selfLinkWithId: map['selfLinkWithId'] as String,
      snapshotSchedulePolicy:
          ResourcePolicySnapshotSchedulePolicyResponse.fromMap(
              (map['snapshotSchedulePolicy'] as Map).cast<String, dynamic>()),
      status: map['status'] as String,
      vmMaintenancePolicy: ResourcePolicyVmMaintenancePolicyResponse.fromMap(
          (map['vmMaintenancePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
