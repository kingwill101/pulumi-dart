...
class PacketMirroring extends CustomResource {
  ...
  late final Output<PacketMirroringForwardingRuleInfoResponse> collectorIlb;
  ...
  late final Output<PacketMirroringFilterResponse> filter;

  /// Type of the resource. Always compute#packetMirroring for packet mirrorings.
  late final Output<String> kind;

  /// PacketMirroring mirroredResourceInfos. MirroredResourceInfo specifies a set of mirrored VM instances, subnetworks and/or tags for which traffic from/to all VM instances will be mirrored.
  late final Output<PacketMirroringMirroredResourceInfoResponse>
      mirroredResources;
  ...
  late final Output<PacketMirroringNetworkInfoResponse> network;
