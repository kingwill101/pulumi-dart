...
class FutureReservationArgs {
  ...
  final Input<Duration>? autoCreatedReservationsDuration;
  ...
  final Input<FutureReservationPlanningStatus>? planningStatus;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (planningStatusValue != null) {
      map['planningStatus'] =
          Input.mapOptionalInputValue<FutureReservationPlanningStatus, String>(
  ...
  factory FutureReservationArgs.fromMap(Map<String, dynamic> map) {
    return FutureReservationArgs(
      autoCreatedReservationsDeleteTime: Input.asOptionalInput<String>(
          map['autoCreatedReservationsDeleteTime']),
      autoCreatedReservationsDuration: Input.asOptionalInput<Duration>(
          map['autoCreatedReservationsDuration']),
      autoDeleteAutoCreatedReservations:
      ...
      planningStatus: Input.asOptionalInput<FutureReservationPlanningStatus>(
          map['planningStatus']),
      ...
      timeWindow:
          Input.asOptionalInput<FutureReservationTimeWindow>(map['timeWindow']),
