...
class Network4 extends CustomResource {
  ...
  late final Output<List<NetworkPeeringResponse>> peerings;
  ...
  late final Output<NetworkRoutingConfigResponse> routingConfig;
