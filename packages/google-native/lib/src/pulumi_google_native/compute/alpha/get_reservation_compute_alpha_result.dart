...
class GetReservationComputeAlphaResult {
  ...
  GetReservationComputeAlphaResult({
  ...
  factory GetReservationComputeAlphaResult.fromMap(Map<String, dynamic> map) {
    return GetReservationComputeAlphaResult(
