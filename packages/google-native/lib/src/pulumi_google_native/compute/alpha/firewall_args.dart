...
class FirewallArgs {
  ...
  final Input<List<FirewallAllowedItem>>? allowed;

  /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
  final Input<List<FirewallDeniedItem>>? denied;
  ...
  final Input<FirewallDirection>? direction;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (allowedValue != null) {
      map['allowed'] = Input.mapOptionalInputValue<List<FirewallAllowedItem>,
              List<Map<String, dynamic>>>(
          allowedValue,
          (value) =>
              Input.encodeList<FirewallAllowedItem, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    final deniedValue = denied;
    if (deniedValue != null) {
      map['denied'] = Input.mapOptionalInputValue<List<FirewallDeniedItem>,
              List<Map<String, dynamic>>>(
          deniedValue,
          (value) => Input.encodeList<FirewallDeniedItem, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (directionValue != null) {
      map['direction'] = Input.mapOptionalInputValue<FirewallDirection, String>(
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allowed: Input.asOptionalInput<List<FirewallAllowedItem>>(map['allowed']),
      denied: Input.asOptionalInput<List<FirewallDeniedItem>>(map['denied']),
      description: Input.asOptionalInput<String>(map['description']),
      destinationRanges:
          Input.asOptionalInput<List<String>>(map['destinationRanges']),
      direction: Input.asOptionalInput<FirewallDirection>(map['direction']),
