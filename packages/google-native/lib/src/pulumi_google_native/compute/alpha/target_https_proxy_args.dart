...
class TargetHttpsProxyArgs {
  ...
  final Input<TargetHttpsProxyQuicOverride>? quicOverride;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (quicOverrideValue != null) {
      map['quicOverride'] =
          Input.mapOptionalInputValue<TargetHttpsProxyQuicOverride, String>(
  ...
  factory TargetHttpsProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyArgs(
      ...
      quicOverride: Input.asOptionalInput<TargetHttpsProxyQuicOverride>(
          map['quicOverride']),
