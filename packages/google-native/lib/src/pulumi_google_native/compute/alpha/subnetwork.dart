...
class Subnetwork extends CustomResource {
  ...
  late final Output<bool> enableL2;
  ...
  late final Output<bool> enablePrivateV6Access;
  ...
  late final Output<SubnetworkLogConfigResponse> logConfig;
  ...
  late final Output<List<SubnetworkSecondaryRangeResponse>> secondaryIpRanges;
  ...
  late final Output<List<int>> vlans;
  ...
  Subnetwork(
    ...
    this.enableL2 = Output.createUnknown<bool>();
    this.enablePrivateV6Access = Output.createUnknown<bool>();
    ...
    this.logConfig = Output.createUnknown<SubnetworkLogConfigResponse>();
