...
class Firewall extends CustomResource {
  ...
  Firewall(
    ...
    this.allowed = Output.createUnknown<List<FirewallAllowedItemResponse>>();
    this.creationTimestamp = Output.createUnknown<String>();
    this.denied = Output.createUnknown<List<FirewallDeniedItemResponse>>();
    ...
    this.logConfig = Output.createUnknown<FirewallLogConfigResponse>();
