...
class InstanceTemplate extends CustomResource {
  ...
  late final Output<InstancePropertiesResponse> properties;
  ...
  late final Output<SourceInstanceParamsResponse> sourceInstanceParams;
  ...
  InstanceTemplate(
    ...
    this.sourceInstanceParams =
        registerOutput<SourceInstanceParamsResponse>('sourceInstanceParams');
  }
}
