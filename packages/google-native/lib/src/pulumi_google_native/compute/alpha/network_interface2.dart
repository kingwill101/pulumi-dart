...
class NetworkInterface2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (subinterfacesValue != null) {
      map['subinterfaces'] =
          Input.encodeList<NetworkInterfaceSubInterface, Map<String, dynamic>>(
              subinterfacesValue, (value) => value.toMap());
    }
  ...
  factory NetworkInterface2.fromMap(Map<String, dynamic> map) {
    return NetworkInterface2(
      ...
      subinterfaces: map['subinterfaces'] == null
          ? null
          : Input.decodeList<NetworkInterfaceSubInterface>(
              map['subinterfaces'],
