...
class GetInstanceIamPolicyComputeAlphaResult {
  ...
  GetInstanceIamPolicyComputeAlphaResult({
  ...
  factory GetInstanceIamPolicyComputeAlphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetInstanceIamPolicyComputeAlphaResult(
