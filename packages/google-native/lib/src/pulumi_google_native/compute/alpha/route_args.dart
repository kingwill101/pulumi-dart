...
class RouteArgs {
  ...
  final Input<bool>? allowConflictingSubnetworks;
  ...
  final Input<RouteIlbRouteBehaviorOnUnhealthy>? ilbRouteBehaviorOnUnhealthy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ilbRouteBehaviorOnUnhealthyValue != null) {
      map['ilbRouteBehaviorOnUnhealthy'] =
          Input.mapOptionalInputValue<RouteIlbRouteBehaviorOnUnhealthy, String>(
              ilbRouteBehaviorOnUnhealthyValue, (value) => value.value);
    }
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      allowConflictingSubnetworks:
          Input.asOptionalInput<bool>(map['allowConflictingSubnetworks']),
      description: Input.asOptionalInput<String>(map['description']),
      destRange: Input.asOptionalInput<String>(map['destRange']),
      ilbRouteBehaviorOnUnhealthy:
          Input.asOptionalInput<RouteIlbRouteBehaviorOnUnhealthy>(
              map['ilbRouteBehaviorOnUnhealthy']),
