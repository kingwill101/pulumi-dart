...
class RouteArgs {
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      allowConflictingSubnetworks: pulumi.Input.asOptionalInput<bool>(
          map['allowConflictingSubnetworks']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      destRange: pulumi.Input.asOptionalInput<String>(map['destRange']),
      ilbRouteBehaviorOnUnhealthy:
          pulumi.Input.asOptionalInput<RouteIlbRouteBehaviorOnUnhealthy>(
              map['ilbRouteBehaviorOnUnhealthy']),
      ...
      nextHopNetwork:
          pulumi.Input.asOptionalInput<String>(map['nextHopNetwork']),
      nextHopVpnTunnel:
