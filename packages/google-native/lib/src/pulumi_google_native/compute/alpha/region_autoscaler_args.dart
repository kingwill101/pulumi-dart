...
class RegionAutoscalerArgs {
  ...
  final Input<AutoscalingPolicy>? autoscalingPolicy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoscalingPolicyValue != null) {
      map['autoscalingPolicy'] =
          Input.mapOptionalInputValue<AutoscalingPolicy, Map<String, dynamic>>(
  ...
  factory RegionAutoscalerArgs.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalerArgs(
      autoscalingPolicy:
          Input.asOptionalInput<AutoscalingPolicy>(map['autoscalingPolicy']),
