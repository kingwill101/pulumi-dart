...
/// The set of arguments for RegionSnapshotIamMember.
class RegionSnapshotIamMemberArgs {
  ...
  factory RegionSnapshotIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotIamMemberArgs(
