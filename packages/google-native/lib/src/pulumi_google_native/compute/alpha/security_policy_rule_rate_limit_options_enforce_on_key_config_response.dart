...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse {
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse(
