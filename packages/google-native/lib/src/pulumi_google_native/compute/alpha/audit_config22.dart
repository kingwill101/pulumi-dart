...
import 'audit_log_config22.dart';
...
class AuditConfig22 {
  ...
  final List<AuditLogConfig22>? auditLogConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditLogConfigsValue != null) {
      map['auditLogConfigs'] =
          Input.encodeList<AuditLogConfig22, Map<String, dynamic>>(
  ...
  factory AuditConfig22.fromMap(Map<String, dynamic> map) {
    return AuditConfig22(
      auditLogConfigs: map['auditLogConfigs'] == null
          ? null
          : Input.decodeList<AuditLogConfig22>(
              map['auditLogConfigs'],
              (value) => AuditLogConfig22.fromMap(
