...
class ReservationComputeAlphaArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (aggregateReservationValue != null) {
      map['aggregateReservation'] = pulumi.Input.mapOptionalInputValue<
              AllocationAggregateReservation, Map<String, dynamic>>(
    ...
    if (specificReservationValue != null) {
      map['specificReservation'] = pulumi.Input.mapOptionalInputValue<
              AllocationSpecificSKUReservation, Map<String, dynamic>>(
  ...
  factory ReservationComputeAlphaArgs.fromMap(Map<String, dynamic> map) {
    return ReservationComputeAlphaArgs(
      aggregateReservation:
          pulumi.Input.asOptionalInput<AllocationAggregateReservation>(
              map['aggregateReservation']),
      deleteAfterDuration:
          pulumi.Input.asOptionalInput<Duration>(map['deleteAfterDuration']),
