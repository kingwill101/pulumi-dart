...
class PacketMirroringArgs {
  ...
  factory PacketMirroringArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringArgs(
      collectorIlb:
          pulumi.Input.asOptionalInput<PacketMirroringForwardingRuleInfo>(
              map['collectorIlb']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      enable:
          pulumi.Input.asOptionalInput<PacketMirroringEnable>(map['enable']),
      filter:
          pulumi.Input.asOptionalInput<PacketMirroringFilter>(map['filter']),
      mirroredResources:
          pulumi.Input.asOptionalInput<PacketMirroringMirroredResourceInfo>(
              map['mirroredResources']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      network: pulumi.Input.asOptionalInput<PacketMirroringNetworkInfo>(
          map['network']),
