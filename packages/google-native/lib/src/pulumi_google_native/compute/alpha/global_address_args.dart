...
class GlobalAddressArgs {
  ...
  final Input<GlobalAddressAddressType>? addressType;

  /// An optional description of this resource. Provide this field when you create the resource.
  final Input<String>? description;

  /// The IP version that will be used by this address. Valid options are IPV4 or IPV6.
  final Input<GlobalAddressIpVersion>? ipVersion;

  /// The endpoint type of this address, which should be VM or NETLB. This is used for deciding which type of endpoint this address can be used after the external IPv6 address reservation.
  final Input<GlobalAddressIpv6EndpointType>? ipv6EndpointType;
  ...
  final Input<GlobalAddressNetworkTier>? networkTier;
  ...
  final Input<GlobalAddressPurpose>? purpose;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (addressTypeValue != null) {
      map['addressType'] =
          Input.mapOptionalInputValue<GlobalAddressAddressType, String>(
    ...
    if (ipVersionValue != null) {
      map['ipVersion'] =
          Input.mapOptionalInputValue<GlobalAddressIpVersion, String>(
    ...
    if (ipv6EndpointTypeValue != null) {
      map['ipv6EndpointType'] =
          Input.mapOptionalInputValue<GlobalAddressIpv6EndpointType, String>(
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          Input.mapOptionalInputValue<GlobalAddressNetworkTier, String>(
    ...
    if (purposeValue != null) {
      map['purpose'] =
          Input.mapOptionalInputValue<GlobalAddressPurpose, String>(
  ...
  factory GlobalAddressArgs.fromMap(Map<String, dynamic> map) {
    return GlobalAddressArgs(
      ...
      addressType:
          Input.asOptionalInput<GlobalAddressAddressType>(map['addressType']),
      description: Input.asOptionalInput<String>(map['description']),
      ipVersion:
          Input.asOptionalInput<GlobalAddressIpVersion>(map['ipVersion']),
      ipv6EndpointType: Input.asOptionalInput<GlobalAddressIpv6EndpointType>(
          map['ipv6EndpointType']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      name: Input.asOptionalInput<String>(map['name']),
      network: Input.asOptionalInput<String>(map['network']),
      networkTier:
          Input.asOptionalInput<GlobalAddressNetworkTier>(map['networkTier']),
      prefixLength: Input.asOptionalInput<int>(map['prefixLength']),
      project: Input.asOptionalInput<String>(map['project']),
      purpose: Input.asOptionalInput<GlobalAddressPurpose>(map['purpose']),
