...
class SslPolicy extends CustomResource {
  ...
  late final Output<ServerTlsSettingsResponse> tlsSettings;

  /// If potential misconfigurations are detected for this SSL policy, this field will be populated with warning messages.
  late final Output<List<SslPolicyWarningsItemResponse>> warnings;
  ...
  SslPolicy(
    ...
    this.tlsSettings = Output.createUnknown<ServerTlsSettingsResponse>();
    this.warnings = Output.createUnknown<List<SslPolicyWarningsItemResponse>>();
  }
}
