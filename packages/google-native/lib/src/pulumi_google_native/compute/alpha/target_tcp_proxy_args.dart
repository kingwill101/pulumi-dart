...
class TargetTcpProxyArgs {
  ...
  final Input<TargetTcpProxyProxyHeader>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          Input.mapOptionalInputValue<TargetTcpProxyProxyHeader, String>(
  ...
  factory TargetTcpProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyArgs(
      ...
      proxyHeader:
          Input.asOptionalInput<TargetTcpProxyProxyHeader>(map['proxyHeader']),
