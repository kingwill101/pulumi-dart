...
class ServiceAttachmentArgs {
  ...
  final Input<ServiceAttachmentConnectionPreference>? connectionPreference;

  /// Projects that are allowed to connect to this service attachment.
  final Input<List<ServiceAttachmentConsumerProjectLimit>>? consumerAcceptLists;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (consumerAcceptListsValue != null) {
      map['consumerAcceptLists'] = Input.mapOptionalInputValue<
          ...
          (value) => Input.encodeList<ServiceAttachmentConsumerProjectLimit,
  ...
  factory ServiceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentArgs(
      connectionPreference:
          Input.asOptionalInput<ServiceAttachmentConnectionPreference>(
              map['connectionPreference']),
      consumerAcceptLists:
          Input.asOptionalInput<List<ServiceAttachmentConsumerProjectLimit>>(
