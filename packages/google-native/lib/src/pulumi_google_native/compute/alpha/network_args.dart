...
class NetworkArgs {
  ...
  final Input<NetworkNetworkFirewallPolicyEnforcementOrder>?
  ...
  final Input<NetworkRoutingConfig>? routingConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkFirewallPolicyEnforcementOrderValue != null) {
      map['networkFirewallPolicyEnforcementOrder'] =
          Input.mapOptionalInputValue<
                  NetworkNetworkFirewallPolicyEnforcementOrder, String>(
    ...
    if (routingConfigValue != null) {
      map['routingConfig'] = Input.mapOptionalInputValue<NetworkRoutingConfig,
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      ...
      networkFirewallPolicyEnforcementOrder:
          Input.asOptionalInput<NetworkNetworkFirewallPolicyEnforcementOrder>(
              map['networkFirewallPolicyEnforcementOrder']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      routingConfig:
          Input.asOptionalInput<NetworkRoutingConfig>(map['routingConfig']),
    );
  }
}
