...
import 'reservation_compute_alpha_args.dart';
...
class ReservationComputeAlpha extends pulumi.CustomResource {
  ...
  ReservationComputeAlpha(
    String name, {
    ReservationComputeAlphaArgs? args,
    ...
    this.deleteAfterDuration =
        registerOutput<DurationResponse>('deleteAfterDuration');
    ...
    this.resourceStatus =
        registerOutput<AllocationResourceStatusResponse>('resourceStatus');
