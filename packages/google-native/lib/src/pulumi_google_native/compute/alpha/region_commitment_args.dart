...
class RegionCommitmentArgs {
  ...
  final pulumi.Input<List<Reservation>>? reservations;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (categoryValue != null) {
      map['category'] =
          pulumi.Input.mapOptionalInputValue<RegionCommitmentCategory, String>(
    ...
    if (planValue != null) {
      map['plan'] =
          pulumi.Input.mapOptionalInputValue<RegionCommitmentPlan, String>(
    ...
    if (reservationsValue != null) {
      map['reservations'] = pulumi.Input.mapOptionalInputValue<
              List<Reservation>, List<Map<String, dynamic>>>(
          reservationsValue,
          (value) => pulumi.Input.encodeList<Reservation, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final resourcesValue = resources;
    if (resourcesValue != null) {
      map['resources'] = pulumi.Input.mapOptionalInputValue<
              List<ResourceCommitment>, List<Map<String, dynamic>>>(
          resourcesValue,
          (value) =>
              pulumi.Input.encodeList<ResourceCommitment, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    ...
    if (typeValue != null) {
      map['type'] =
          pulumi.Input.mapOptionalInputValue<RegionCommitmentType, String>(
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      category: pulumi.Input.asOptionalInput<RegionCommitmentCategory>(
          map['category']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      existingReservations: pulumi.Input.asOptionalInput<List<String>>(
          map['existingReservations']),
      licenseResource: pulumi.Input.asOptionalInput<LicenseResourceCommitment>(
          map['licenseResource']),
      mergeSourceCommitments: pulumi.Input.asOptionalInput<List<String>>(
          map['mergeSourceCommitments']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      plan: pulumi.Input.asOptionalInput<RegionCommitmentPlan>(map['plan']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      region: pulumi.Input.asInput<String>(map['region']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      reservations:
          pulumi.Input.asOptionalInput<List<Reservation>>(map['reservations']),
      resources: pulumi.Input.asOptionalInput<List<ResourceCommitment>>(
          map['resources']),
      splitSourceCommitment:
          pulumi.Input.asOptionalInput<String>(map['splitSourceCommitment']),
      type: pulumi.Input.asOptionalInput<RegionCommitmentType>(map['type']),
    );
  }
}
