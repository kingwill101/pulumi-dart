...
class RegionCommitmentArgs {
  ...
  final Input<RegionCommitmentCategory>? category;
  ...
  final Input<List<String>>? existingReservations;

  /// The license specification required as part of a license commitment.
  final Input<LicenseResourceCommitment>? licenseResource;
  ...
  final Input<RegionCommitmentPlan>? plan;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (categoryValue != null) {
      map['category'] =
          Input.mapOptionalInputValue<RegionCommitmentCategory, String>(
    ...
    if (planValue != null) {
      map['plan'] = Input.mapOptionalInputValue<RegionCommitmentPlan, String>(
    ...
    if (reservationsValue != null) {
      map['reservations'] = Input.mapOptionalInputValue<List<Reservation>,
              List<Map<String, dynamic>>>(
          reservationsValue,
          (value) => Input.encodeList<Reservation, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final resourcesValue = resources;
    if (resourcesValue != null) {
      map['resources'] = Input.mapOptionalInputValue<List<ResourceCommitment>,
              List<Map<String, dynamic>>>(
          resourcesValue,
          (value) => Input.encodeList<ResourceCommitment, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<RegionCommitmentType, String>(
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      category:
          Input.asOptionalInput<RegionCommitmentCategory>(map['category']),
      description: Input.asOptionalInput<String>(map['description']),
      existingReservations:
          Input.asOptionalInput<List<String>>(map['existingReservations']),
      licenseResource: Input.asOptionalInput<LicenseResourceCommitment>(
          map['licenseResource']),
      mergeSourceCommitments:
          Input.asOptionalInput<List<String>>(map['mergeSourceCommitments']),
      name: Input.asOptionalInput<String>(map['name']),
      plan: Input.asOptionalInput<RegionCommitmentPlan>(map['plan']),
      project: Input.asOptionalInput<String>(map['project']),
      region: Input.asInput<String>(map['region']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      reservations:
          Input.asOptionalInput<List<Reservation>>(map['reservations']),
      resources:
          Input.asOptionalInput<List<ResourceCommitment>>(map['resources']),
      splitSourceCommitment:
          Input.asOptionalInput<String>(map['splitSourceCommitment']),
      type: Input.asOptionalInput<RegionCommitmentType>(map['type']),
    );
  }
}
