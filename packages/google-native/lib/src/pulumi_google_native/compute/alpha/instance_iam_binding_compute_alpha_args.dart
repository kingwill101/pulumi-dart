...
class InstanceIamBindingComputeAlphaArgs {
  ...
  InstanceIamBindingComputeAlphaArgs({
    this.condition,
  ...
  factory InstanceIamBindingComputeAlphaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingComputeAlphaArgs(
