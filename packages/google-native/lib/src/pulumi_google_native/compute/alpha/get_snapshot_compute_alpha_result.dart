...
class GetSnapshotComputeAlphaResult {
  ...
  factory GetSnapshotComputeAlphaResult.fromMap(Map<String, dynamic> map) {
    return GetSnapshotComputeAlphaResult(
