...
class TargetSslProxyArgs {
  ...
  final Input<TargetSslProxyProxyHeader>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          Input.mapOptionalInputValue<TargetSslProxyProxyHeader, String>(
  ...
  factory TargetSslProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyArgs(
      ...
      proxyHeader:
          Input.asOptionalInput<TargetSslProxyProxyHeader>(map['proxyHeader']),
