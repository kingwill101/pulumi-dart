...
class BackendServiceArgs {
  ...
  final Input<BackendServiceCompressionMode>? compressionMode;
  ...
  final Input<BackendServiceIpAddressSelectionPolicy>? ipAddressSelectionPolicy;

  /// Specifies the load balancer type. A backend service created for one type of load balancer cannot be used with another. For more information, refer to Choosing a load balancer.
  final Input<BackendServiceLoadBalancingScheme>? loadBalancingScheme;
  ...
  final Input<BackendServiceLocalityLbPolicy>? localityLbPolicy;
  ...
  final Input<BackendServiceProtocol>? protocol;
  ...
  final Input<BackendServiceSessionAffinity>? sessionAffinity;
  ...
  final Input<BackendServiceVpcNetworkScope>? vpcNetworkScope;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (compressionModeValue != null) {
      map['compressionMode'] =
          Input.mapOptionalInputValue<BackendServiceCompressionMode, String>(
    ...
    if (localityLbPolicyValue != null) {
      map['localityLbPolicy'] =
          Input.mapOptionalInputValue<BackendServiceLocalityLbPolicy, String>(
    ...
    if (protocolValue != null) {
      map['protocol'] =
          Input.mapOptionalInputValue<BackendServiceProtocol, String>(
    ...
    if (sessionAffinityValue != null) {
      map['sessionAffinity'] =
          Input.mapOptionalInputValue<BackendServiceSessionAffinity, String>(
    ...
    if (vpcNetworkScopeValue != null) {
      map['vpcNetworkScope'] =
          Input.mapOptionalInputValue<BackendServiceVpcNetworkScope, String>(
  ...
  factory BackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceArgs(
      ...
      compressionMode: Input.asOptionalInput<BackendServiceCompressionMode>(
          map['compressionMode']),
      connectionDraining:
      ...
      ipAddressSelectionPolicy:
          Input.asOptionalInput<BackendServiceIpAddressSelectionPolicy>(
              map['ipAddressSelectionPolicy']),
      loadBalancingScheme:
          Input.asOptionalInput<BackendServiceLoadBalancingScheme>(
              map['loadBalancingScheme']),
      localityLbPolicies: Input.asOptionalInput<
              List<BackendServiceLocalityLoadBalancingPolicyConfig>>(
          map['localityLbPolicies']),
      localityLbPolicy: Input.asOptionalInput<BackendServiceLocalityLbPolicy>(
          map['localityLbPolicy']),
      logConfig:
      ...
      protocol: Input.asOptionalInput<BackendServiceProtocol>(map['protocol']),
      ...
      sessionAffinity: Input.asOptionalInput<BackendServiceSessionAffinity>(
          map['sessionAffinity']),
      ...
      vpcNetworkScope: Input.asOptionalInput<BackendServiceVpcNetworkScope>(
          map['vpcNetworkScope']),
    );
  }
}
