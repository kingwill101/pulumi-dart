...
import 'condition_response_compute_alpha.dart';
...
class RuleResponse {
  ...
  /// This is deprecated and has no effect. Do not use.
  final List<ConditionResponseComputeAlpha> conditions;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['action'] = action;
    map['conditions'] = pulumi.Input.encodeList<ConditionResponseComputeAlpha,
  ...
  factory RuleResponse.fromMap(Map<String, dynamic> map) {
    return RuleResponse(
      ...
      conditions: pulumi.Input.decodeList<ConditionResponseComputeAlpha>(
          map['conditions'],
          (value) => ConditionResponseComputeAlpha.fromMap(
