...
class InstanceGroupManagerInstanceLifecyclePolicy {
  ...
  Map<String, dynamic> toMap() {
    ...
    final metadataBasedReadinessSignalValue = metadataBasedReadinessSignal;
    if (metadataBasedReadinessSignalValue != null) {
      map['metadataBasedReadinessSignal'] =
          metadataBasedReadinessSignalValue.toMap();
    }
    return map;
  }
