...
class NetworkFirewallPolicyIamBindingArgs2 {
  ...
  NetworkFirewallPolicyIamBindingArgs2({
    this.condition,
  ...
  factory NetworkFirewallPolicyIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamBindingArgs2(
