...
import 'service_attachment_args2.dart';
...
class ServiceAttachment2 extends CustomResource {
  /// An array of connections for all the consumers connected to this service attachment.
  late final Output<List<ServiceAttachmentConnectedEndpointResponse2>>
      connectedEndpoints;
  ...
  late final Output<List<ServiceAttachmentConsumerProjectLimitResponse2>>
      consumerAcceptLists;
  ...
  late final Output<Uint128Response2> pscServiceAttachmentId;
  ...
  late final Output<ServiceAttachmentTunnelingConfigResponse2> tunnelingConfig;

  ServiceAttachment2(
    String name, {
    ServiceAttachmentArgs2? args,
    ...
    this.connectedEndpoints =
        registerOutput<List<ServiceAttachmentConnectedEndpointResponse2>>(
            'connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists =
        registerOutput<List<ServiceAttachmentConsumerProjectLimitResponse2>>(
            'consumerAcceptLists');
    ...
    this.pscServiceAttachmentId =
        registerOutput<Uint128Response2>('pscServiceAttachmentId');
    ...
    this.tunnelingConfig =
        registerOutput<ServiceAttachmentTunnelingConfigResponse2>(
            'tunnelingConfig');
  }
}
