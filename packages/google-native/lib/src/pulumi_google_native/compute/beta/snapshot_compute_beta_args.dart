...
import 'snapshot_snapshot_type_compute_beta.dart';

/// The set of arguments for Snapshot.
class SnapshotComputeBetaArgs {
  ...
  final pulumi.Input<CustomerEncryptionKeyComputeBeta>? snapshotEncryptionKey;

  /// Indicates the type of the snapshot.
  final pulumi.Input<SnapshotSnapshotTypeComputeBeta>? snapshotType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (snapshotTypeValue != null) {
      map['snapshotType'] = pulumi.Input.mapOptionalInputValue<
          SnapshotSnapshotTypeComputeBeta,
    ...
    if (sourceInstantSnapshotEncryptionKeyValue != null) {
      map['sourceInstantSnapshotEncryptionKey'] =
          pulumi.Input.mapOptionalInputValue<CustomerEncryptionKeyComputeBeta,
                  Map<String, dynamic>>(sourceInstantSnapshotEncryptionKeyValue,
              (value) => value.toMap());
    }
  ...
  factory SnapshotComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotComputeBetaArgs(
      ...
      snapshotType:
          pulumi.Input.asOptionalInput<SnapshotSnapshotTypeComputeBeta>(
              map['snapshotType']),
