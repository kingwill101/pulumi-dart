...
class PublicDelegatedPrefixPublicDelegatedSubPrefix2 {
  ...
  factory PublicDelegatedPrefixPublicDelegatedSubPrefix2.fromMap(
      Map<String, dynamic> map) {
    return PublicDelegatedPrefixPublicDelegatedSubPrefix2(
