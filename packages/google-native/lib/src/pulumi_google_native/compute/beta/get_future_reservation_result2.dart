...
class GetFutureReservationResult2 {
  ...
  final DurationResponse2 autoCreatedReservationsDuration;
  ...
  final FutureReservationStatusResponse2 status;
  ...
  factory GetFutureReservationResult2.fromMap(Map<String, dynamic> map) {
    return GetFutureReservationResult2(
      autoCreatedReservationsDeleteTime:
          map['autoCreatedReservationsDeleteTime'] as String,
      autoCreatedReservationsDuration: DurationResponse2.fromMap(
      ...
      status: FutureReservationStatusResponse2.fromMap(
