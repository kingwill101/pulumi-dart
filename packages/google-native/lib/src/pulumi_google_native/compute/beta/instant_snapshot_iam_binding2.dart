...
import 'instant_snapshot_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class InstantSnapshotIamBinding2 extends CustomResource {
  ...
  InstantSnapshotIamBinding2(
    String name, {
    InstantSnapshotIamBindingArgs2? args,
