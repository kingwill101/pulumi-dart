...
import 'firewall_policy_rule_matcher_response2.dart';
import 'firewall_policy_rule_secure_tag_response2.dart';

/// Represents a rule that describes one or more match conditions along with the action to be taken when traffic matches this condition (allow or deny).
class FirewallPolicyRuleResponse2 {
  ...
  final FirewallPolicyRuleMatcherResponse2 match;
  ...
  final List<FirewallPolicyRuleSecureTagResponse2> targetSecureTags;
  ...
  factory FirewallPolicyRuleResponse2.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponse2(
      ...
      match: FirewallPolicyRuleMatcherResponse2.fromMap(
      ...
      targetSecureTags: Input.decodeList<FirewallPolicyRuleSecureTagResponse2>(
