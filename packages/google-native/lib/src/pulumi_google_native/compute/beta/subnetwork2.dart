...
import 'subnetwork_args2.dart';
import 'subnetwork_log_config_response2.dart';
import 'subnetwork_secondary_range_response2.dart';

/// Creates a subnetwork in the specified project using the data included in the request.
class Subnetwork2 extends CustomResource {
  ...
  late final Output<SubnetworkLogConfigResponse2> logConfig;
  ...
  late final Output<List<SubnetworkSecondaryRangeResponse2>> secondaryIpRanges;
