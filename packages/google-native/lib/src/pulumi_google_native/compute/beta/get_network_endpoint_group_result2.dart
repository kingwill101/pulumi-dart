...
class GetNetworkEndpointGroupResult2 {
  ...
  GetNetworkEndpointGroupResult2({
  ...
  factory GetNetworkEndpointGroupResult2.fromMap(Map<String, dynamic> map) {
    return GetNetworkEndpointGroupResult2(
