...
class StatefulPolicyPreservedState2 {
  ...
  factory StatefulPolicyPreservedState2.fromMap(Map<String, dynamic> map) {
    return StatefulPolicyPreservedState2(
