...
class GetRegionNotificationEndpointComputeBetaResult {
  ...
  GetRegionNotificationEndpointComputeBetaResult({
  ...
  factory GetRegionNotificationEndpointComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetRegionNotificationEndpointComputeBetaResult(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      grpcSettings: NotificationEndpointGrpcSettingsResponseComputeBeta.fromMap(
