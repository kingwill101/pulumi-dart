...
import 'firewall_log_config_response2.dart';

/// Result data returned by getFirewall.
class GetFirewallResult2 {
  /// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
  final List<FirewallAllowedItemResponse2> allowed;

  /// Creation timestamp in RFC3339 text format.
  final String creationTimestamp;

  /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
  final List<FirewallDeniedItemResponse2> denied;
  ...
  final FirewallLogConfigResponse2 logConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['allowed'] =
        Input.encodeList<FirewallAllowedItemResponse2, Map<String, dynamic>>(
            allowed, (value) => value.toMap());
    map['creationTimestamp'] = creationTimestamp;
    map['denied'] =
        Input.encodeList<FirewallDeniedItemResponse2, Map<String, dynamic>>(
  ...
  factory GetFirewallResult2.fromMap(Map<String, dynamic> map) {
    return GetFirewallResult2(
      allowed: Input.decodeList<FirewallAllowedItemResponse2>(
          map['allowed'],
          (value) => FirewallAllowedItemResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      denied: Input.decodeList<FirewallDeniedItemResponse2>(
          map['denied'],
          (value) => FirewallDeniedItemResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      logConfig: FirewallLogConfigResponse2.fromMap(
