...
import 'network_attachment_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class NetworkAttachmentIamMember2 extends CustomResource {
  ...
  NetworkAttachmentIamMember2(
    String name, {
    NetworkAttachmentIamMemberArgs2? args,
