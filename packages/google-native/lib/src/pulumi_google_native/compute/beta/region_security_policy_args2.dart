...
import 'region_security_policy_type2.dart';
...
class RegionSecurityPolicyArgs2 {
  ...
  final Input<RegionSecurityPolicyType2>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<RegionSecurityPolicyType2, String>(
  ...
  factory RegionSecurityPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyArgs2(
      adaptiveProtectionConfig:
      ...
      type: Input.asOptionalInput<RegionSecurityPolicyType2>(map['type']),
      userDefinedFields:
