...
import 'grpchealth_check_port_specification2.dart';

class GRPCHealthCheck2 {
  ...
  final GRPCHealthCheckPortSpecification2? portSpecification;
  ...
  factory GRPCHealthCheck2.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheck2(
      ...
      portSpecification: map['portSpecification'] == null
          ? null
          : GRPCHealthCheckPortSpecification2.fromValue(
