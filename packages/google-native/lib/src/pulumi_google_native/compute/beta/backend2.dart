...
import 'backend_balancing_mode2.dart';
import 'backend_preference2.dart';
...
class Backend2 {
  ...
  final BackendBalancingMode2? balancingMode;
  ...
  final BackendPreference2? preference;
  ...
  factory Backend2.fromMap(Map<String, dynamic> map) {
    return Backend2(
      balancingMode: map['balancingMode'] == null
          ? null
          : BackendBalancingMode2.fromValue(map['balancingMode'] as String),
      ...
      preference: map['preference'] == null
          ? null
          : BackendPreference2.fromValue(map['preference'] as String),
    );
  }
}
