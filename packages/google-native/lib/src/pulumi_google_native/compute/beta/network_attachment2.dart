...
import 'network_attachment_args2.dart';
import 'network_attachment_connected_endpoint_response2.dart';

/// Creates a NetworkAttachment in the specified project in the given scope using the parameters that are included in the request.
class NetworkAttachment2 extends CustomResource {
  /// An array of connections for all the producers connected to this network attachment.
  late final Output<List<NetworkAttachmentConnectedEndpointResponse2>>
      connectionEndpoints;
  ...
  NetworkAttachment2(
    ...
    this.connectionEndpoints =
        registerOutput<List<NetworkAttachmentConnectedEndpointResponse2>>(
            'connectionEndpoints');
