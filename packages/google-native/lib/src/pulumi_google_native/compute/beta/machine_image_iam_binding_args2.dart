...
class MachineImageIamBindingArgs2 {
  ...
  factory MachineImageIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return MachineImageIamBindingArgs2(
