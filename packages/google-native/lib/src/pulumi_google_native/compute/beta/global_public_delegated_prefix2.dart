...
import 'global_public_delegated_prefix_args2.dart';
import 'public_delegated_prefix_public_delegated_sub_prefix_response2.dart';

/// Creates a global PublicDelegatedPrefix in the specified project using the parameters that are included in the request.
class GlobalPublicDelegatedPrefix2 extends CustomResource {
  ...
  late final Output<
          List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponse2>>
  ...
  GlobalPublicDelegatedPrefix2(
    String name, {
    GlobalPublicDelegatedPrefixArgs2? args,
