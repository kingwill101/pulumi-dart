...
class PathRuleResponse2 {
  ...
  final CustomErrorResponsePolicyResponse2 customErrorResponsePolicy;
  ...
  final HttpRouteActionResponse2 routeAction;
  ...
  final HttpRedirectActionResponse2 urlRedirect;
  ...
  factory PathRuleResponse2.fromMap(Map<String, dynamic> map) {
    return PathRuleResponse2(
      customErrorResponsePolicy: CustomErrorResponsePolicyResponse2.fromMap(
          (map['customErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      paths: (map['paths'] as List).cast<String>(),
      routeAction: HttpRouteActionResponse2.fromMap(
          (map['routeAction'] as Map).cast<String, dynamic>()),
      service: map['service'] as String,
      urlRedirect: HttpRedirectActionResponse2.fromMap(
