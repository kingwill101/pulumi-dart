...
import 'network_interface_stack_type2.dart';

/// A network interface resource attached to an instance.
class NetworkInterface3 {
  /// An array of configurations for this interface. Currently, only one access config, ONE_TO_ONE_NAT, is supported. If there are no accessConfigs specified, then this instance will have no external internet access.
  final List<AccessConfig2>? accessConfigs;

  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final List<AliasIpRange2>? aliasIpRanges;

  /// The prefix length of the primary internal IPv6 range.
  final int? internalIpv6PrefixLength;

  /// An array of IPv6 access configurations for this interface. Currently, only one IPv6 access config, DIRECT_IPV6, is supported. If there is no ipv6AccessConfig specified, then this instance will have no external IPv6 Internet access.
  final List<AccessConfig2>? ipv6AccessConfigs;
  ...
  factory NetworkInterface3.fromMap(Map<String, dynamic> map) {
    return NetworkInterface3(
      accessConfigs: map['accessConfigs'] == null
          ? null
          : Input.decodeList<AccessConfig2>(
              map['accessConfigs'],
              (value) => AccessConfig2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null
          ? null
          : Input.decodeList<AliasIpRange2>(
              map['aliasIpRanges'],
              (value) => AliasIpRange2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      nicType: map['nicType'] == null
          ? null
          : NetworkInterfaceNicType2.fromValue(map['nicType'] as String),
      queueCount: map['queueCount'] == null ? null : map['queueCount'] as int,
      stackType: map['stackType'] == null
          ? null
          : NetworkInterfaceStackType2.fromValue(map['stackType'] as String),
      subnetwork:
