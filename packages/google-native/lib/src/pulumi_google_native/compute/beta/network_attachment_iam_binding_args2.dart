...
class NetworkAttachmentIamBindingArgs2 {
  ...
  NetworkAttachmentIamBindingArgs2({
    this.condition,
  ...
  factory NetworkAttachmentIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamBindingArgs2(
