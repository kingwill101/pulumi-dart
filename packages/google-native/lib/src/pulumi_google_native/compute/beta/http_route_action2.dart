...
import 'cors_policy2.dart';
import 'duration2.dart';
import 'http_fault_injection2.dart';
import 'http_retry_policy2.dart';
import 'request_mirror_policy2.dart';
import 'url_rewrite2.dart';
import 'weighted_backend_service2.dart';

class HttpRouteAction2 {
  /// The specification for allowing client-side cross-origin requests. For more information about the W3C recommendation for cross-origin resource sharing (CORS), see Fetch API Living Standard. Not supported when the URL map is bound to a target gRPC proxy.
  final CorsPolicy2? corsPolicy;
  ...
  final HttpFaultInjection2? faultInjectionPolicy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (weightedBackendServicesValue != null) {
      map['weightedBackendServices'] =
          Input.encodeList<WeightedBackendService2, Map<String, dynamic>>(
              weightedBackendServicesValue, (value) => value.toMap());
    }
    return map;
  }

  factory HttpRouteAction2.fromMap(Map<String, dynamic> map) {
    return HttpRouteAction2(
      ...
      weightedBackendServices: map['weightedBackendServices'] == null
          ? null
          : Input.decodeList<WeightedBackendService2>(
              map['weightedBackendServices'],
              (value) => WeightedBackendService2.fromMap(
