...
import 'backend_bucket_args2.dart';
import 'backend_bucket_cdn_policy_response2.dart';

/// Creates a BackendBucket resource in the specified project using the data included in the request.
class BackendBucket2 extends CustomResource {
  /// Cloud Storage bucket name.
  late final Output<String> bucketName;

  /// Cloud CDN configuration for this BackendBucket.
  late final Output<BackendBucketCdnPolicyResponse2> cdnPolicy;
  ...
  BackendBucket2(
    ...
    this.cdnPolicy = Output.createUnknown<BackendBucketCdnPolicyResponse2>();
