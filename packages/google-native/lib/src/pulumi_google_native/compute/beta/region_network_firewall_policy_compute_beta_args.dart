...
class RegionNetworkFirewallPolicyComputeBetaArgs {
  ...
  RegionNetworkFirewallPolicyComputeBetaArgs({
    this.associations,
    this.description,
    this.displayName,
    this.name,
  ...
  factory RegionNetworkFirewallPolicyComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyComputeBetaArgs(
