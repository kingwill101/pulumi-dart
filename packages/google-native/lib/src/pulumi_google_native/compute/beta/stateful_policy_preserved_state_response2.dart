...
class StatefulPolicyPreservedStateResponse2 {
  ...
  StatefulPolicyPreservedStateResponse2({
    required this.disks,
  ...
  factory StatefulPolicyPreservedStateResponse2.fromMap(
      Map<String, dynamic> map) {
    return StatefulPolicyPreservedStateResponse2(
