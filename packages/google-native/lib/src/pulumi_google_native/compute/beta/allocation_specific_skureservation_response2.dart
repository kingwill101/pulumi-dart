...
class AllocationSpecificSKUReservationResponse2 {
  ...
  AllocationSpecificSKUReservationResponse2({
  ...
  factory AllocationSpecificSKUReservationResponse2.fromMap(
      Map<String, dynamic> map) {
    return AllocationSpecificSKUReservationResponse2(
