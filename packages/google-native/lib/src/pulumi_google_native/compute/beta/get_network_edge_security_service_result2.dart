...
class GetNetworkEdgeSecurityServiceResult2 {
  ...
  GetNetworkEdgeSecurityServiceResult2({
  ...
  factory GetNetworkEdgeSecurityServiceResult2.fromMap(
      Map<String, dynamic> map) {
    return GetNetworkEdgeSecurityServiceResult2(
