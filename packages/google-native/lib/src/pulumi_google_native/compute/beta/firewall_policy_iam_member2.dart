...
import 'firewall_policy_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class FirewallPolicyIamMember2 extends CustomResource {
  ...
  FirewallPolicyIamMember2(
    String name, {
    FirewallPolicyIamMemberArgs2? args,
