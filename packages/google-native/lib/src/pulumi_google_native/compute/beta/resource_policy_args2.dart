...
class ResourcePolicyArgs2 {
  ...
  final Input<ResourcePolicyGroupPlacementPolicy2>? groupPlacementPolicy;

  /// Resource policy for scheduling instance operations.
  final Input<ResourcePolicyInstanceSchedulePolicy2>? instanceSchedulePolicy;
  ...
  final Input<ResourcePolicySnapshotSchedulePolicy2>? snapshotSchedulePolicy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (groupPlacementPolicyValue != null) {
      map['groupPlacementPolicy'] = Input.mapOptionalInputValue<
              ResourcePolicyGroupPlacementPolicy2, Map<String, dynamic>>(
    ...
    if (instanceSchedulePolicyValue != null) {
      map['instanceSchedulePolicy'] = Input.mapOptionalInputValue<
              ResourcePolicyInstanceSchedulePolicy2, Map<String, dynamic>>(
    ...
    if (snapshotSchedulePolicyValue != null) {
      map['snapshotSchedulePolicy'] = Input.mapOptionalInputValue<
              ResourcePolicySnapshotSchedulePolicy2, Map<String, dynamic>>(
  ...
  factory ResourcePolicyArgs2.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyArgs2(
      ...
      groupPlacementPolicy:
          Input.asOptionalInput<ResourcePolicyGroupPlacementPolicy2>(
              map['groupPlacementPolicy']),
      instanceSchedulePolicy:
          Input.asOptionalInput<ResourcePolicyInstanceSchedulePolicy2>(
      ...
      snapshotSchedulePolicy:
          Input.asOptionalInput<ResourcePolicySnapshotSchedulePolicy2>(
