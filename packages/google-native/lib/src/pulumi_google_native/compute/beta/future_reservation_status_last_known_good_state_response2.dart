...
import 'future_reservation_status_last_known_good_state_future_reservation_specs_response2.dart';

/// The state that the future reservation will be reverted to should the amendment be declined.
class FutureReservationStatusLastKnownGoodStateResponse2 {
  /// The description of the FutureReservation before an amendment was requested.
  final String description;
  final FutureReservationStatusLastKnownGoodStateFutureReservationSpecsResponse2
  ...
  FutureReservationStatusLastKnownGoodStateResponse2({
  ...
  factory FutureReservationStatusLastKnownGoodStateResponse2.fromMap(
      Map<String, dynamic> map) {
    return FutureReservationStatusLastKnownGoodStateResponse2(
