...
class RegionNetworkFirewallPolicyIamMemberArgs2 {
  ...
  RegionNetworkFirewallPolicyIamMemberArgs2({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamMemberArgs2(
