...
enum GuestOsFeatureType2 {
  ...
  const GuestOsFeatureType2(this.value);
  final String value;

  static GuestOsFeatureType2 fromValue(String value) {
    for (final item in GuestOsFeatureType2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown GuestOsFeatureType2 value: $value');
  }
}
