...
import 'organization_security_policy_type2.dart';
...
class OrganizationSecurityPolicyArgs2 {
  ...
  final Input<OrganizationSecurityPolicyType2>? type;
  ...
  OrganizationSecurityPolicyArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<OrganizationSecurityPolicyType2, String>(
  ...
  factory OrganizationSecurityPolicyArgs2.fromMap(Map<String, dynamic> map) {
    return OrganizationSecurityPolicyArgs2(
      adaptiveProtectionConfig:
      ...
      type: Input.asOptionalInput<OrganizationSecurityPolicyType2>(map['type']),
      userDefinedFields:
