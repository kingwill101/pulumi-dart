...
import 'public_delegated_prefix_public_delegated_sub_prefix_response2.dart';

/// Result data returned by getPublicDelegatedPrefix.
class GetPublicDelegatedPrefixResult2 {
  ...
  final List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponse2>
  ...
  GetPublicDelegatedPrefixResult2({
  ...
  factory GetPublicDelegatedPrefixResult2.fromMap(Map<String, dynamic> map) {
    return GetPublicDelegatedPrefixResult2(
      ...
      publicDelegatedSubPrefixs: Input.decodeList<
          ...
          (value) =>
              PublicDelegatedPrefixPublicDelegatedSubPrefixResponse2.fromMap(
