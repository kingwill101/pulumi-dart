...
import 'interconnect_attachment_configuration_constraints_response_compute_beta.dart';
import 'interconnect_attachment_partner_metadata_response_compute_beta.dart';
import 'interconnect_attachment_private_info_response_compute_beta.dart';

/// Result data returned by getInterconnectAttachment.
class GetInterconnectAttachmentComputeBetaResult {
  ...
  final InterconnectAttachmentConfigurationConstraintsResponseComputeBeta
  ...
  final InterconnectAttachmentPartnerMetadataResponseComputeBeta
      partnerMetadata;
  ...
  final InterconnectAttachmentPrivateInfoResponseComputeBeta
  ...
  GetInterconnectAttachmentComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['candidateIpv6Subnets'] = candidateIpv6Subnets;
    map['candidateSubnets'] = candidateSubnets;
    map['cloudRouterIpAddress'] = cloudRouterIpAddress;
    map['cloudRouterIpv6Address'] = cloudRouterIpv6Address;
    map['cloudRouterIpv6InterfaceId'] = cloudRouterIpv6InterfaceId;
    map['configurationConstraints'] = configurationConstraints.toMap();
    map['creationTimestamp'] = creationTimestamp;
    map['customerRouterIpAddress'] = customerRouterIpAddress;
    map['customerRouterIpv6Address'] = customerRouterIpv6Address;
    map['customerRouterIpv6InterfaceId'] = customerRouterIpv6InterfaceId;
    map['dataplaneVersion'] = dataplaneVersion;
    map['description'] = description;
    map['edgeAvailabilityDomain'] = edgeAvailabilityDomain;
    map['encryption'] = encryption;
    map['googleReferenceId'] = googleReferenceId;
    map['interconnect'] = interconnect;
    map['ipsecInternalAddresses'] = ipsecInternalAddresses;
    map['kind'] = kind;
    map['labelFingerprint'] = labelFingerprint;
    map['labels'] = labels;
    map['mtu'] = mtu;
    map['name'] = name;
    map['operationalStatus'] = operationalStatus;
    map['pairingKey'] = pairingKey;
    map['partnerAsn'] = partnerAsn;
    map['partnerMetadata'] = partnerMetadata.toMap();
    map['privateInterconnectInfo'] = privateInterconnectInfo.toMap();
    map['region'] = region;
    map['remoteService'] = remoteService;
    map['router'] = router;
    map['satisfiesPzs'] = satisfiesPzs;
    map['selfLink'] = selfLink;
    map['stackType'] = stackType;
    map['state'] = state;
    map['subnetLength'] = subnetLength;
    map['type'] = type;
    map['vlanTag8021q'] = vlanTag8021q;
    return map;
  }

  factory GetInterconnectAttachmentComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetInterconnectAttachmentComputeBetaResult(
      ...
      configurationConstraints:
          InterconnectAttachmentConfigurationConstraintsResponseComputeBeta
              .fromMap((map['configurationConstraints'] as Map)
                  .cast<String, dynamic>()),
      ...
      partnerMetadata:
          InterconnectAttachmentPartnerMetadataResponseComputeBeta.fromMap(
              (map['partnerMetadata'] as Map).cast<String, dynamic>()),
      privateInterconnectInfo:
          InterconnectAttachmentPrivateInfoResponseComputeBeta.fromMap(
              (map['privateInterconnectInfo'] as Map).cast<String, dynamic>()),
