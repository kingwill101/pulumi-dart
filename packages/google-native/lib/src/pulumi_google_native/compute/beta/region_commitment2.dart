...
class RegionCommitment2 extends CustomResource {
  ...
  RegionCommitment2(
    ...
    this.licenseResource =
        registerOutput<LicenseResourceCommitmentResponse2>('licenseResource');
    ...
    this.reservations =
        registerOutput<List<ReservationResponse2>>('reservations');
    this.resources =
        registerOutput<List<ResourceCommitmentResponse2>>('resources');
