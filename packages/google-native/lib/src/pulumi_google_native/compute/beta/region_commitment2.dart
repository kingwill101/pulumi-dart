...
import 'resource_commitment_response2.dart';

/// Creates a commitment in the specified project using the data included in the request.
/// Note - this resource's API doesn't support deletion. When deleted, the resource will persist
/// on Google Cloud even though it will be deleted from Pulumi state.
class RegionCommitment2 extends CustomResource {
  ...
  late final Output<LicenseResourceCommitmentResponse2> licenseResource;
  ...
  late final Output<List<ReservationResponse2>> reservations;

  /// A list of commitment amounts for particular resources. Note that VCPU and MEMORY resource commitments must occur together.
  late final Output<List<ResourceCommitmentResponse2>> resources;
  ...
  RegionCommitment2(
    ...
    this.licenseResource =
        Output.createUnknown<LicenseResourceCommitmentResponse2>();
    ...
    this.reservations = Output.createUnknown<List<ReservationResponse2>>();
    this.resources = Output.createUnknown<List<ResourceCommitmentResponse2>>();
