...
class GetSslPolicyComputeBetaResult {
  ...
  final List<SslPolicyWarningsItemResponseComputeBeta> warnings;

  GetSslPolicyComputeBetaResult({
  ...
  factory GetSslPolicyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetSslPolicyComputeBetaResult(
      ...
      warnings:
          pulumi.Input.decodeList<SslPolicyWarningsItemResponseComputeBeta>(
              map['warnings'],
              (value) => SslPolicyWarningsItemResponseComputeBeta.fromMap(
