...
class ForwardingRuleServiceDirectoryRegistration2 {
  ...
  factory ForwardingRuleServiceDirectoryRegistration2.fromMap(
      Map<String, dynamic> map) {
    return ForwardingRuleServiceDirectoryRegistration2(
