...
import 'node_group_autoscaling_policy_response2.dart';
import 'node_group_maintenance_window_response2.dart';
import 'share_settings_response2.dart';

/// Result data returned by getNodeGroup.
class GetNodeGroupResult2 {
  /// Specifies how autoscaling should behave.
  final NodeGroupAutoscalingPolicyResponse2 autoscalingPolicy;
  ...
  final NodeGroupMaintenanceWindowResponse2 maintenanceWindow;
  ...
  factory GetNodeGroupResult2.fromMap(Map<String, dynamic> map) {
    return GetNodeGroupResult2(
      autoscalingPolicy: NodeGroupAutoscalingPolicyResponse2.fromMap(
      ...
      maintenanceWindow: NodeGroupMaintenanceWindowResponse2.fromMap(
