...
class RegionInstanceGroupManagerComputeBetaArgs {
  ...
  final pulumi.Input<RegionInstanceGroupManagerFailoverActionComputeBeta>?
      failoverAction;
  ...
  final pulumi
      .Input<RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (failoverActionValue != null) {
      map['failoverAction'] = pulumi.Input.mapOptionalInputValue<
          RegionInstanceGroupManagerFailoverActionComputeBeta,
    ...
    if (listManagedInstancesResultsValue != null) {
      map['listManagedInstancesResults'] = pulumi.Input.mapOptionalInputValue<
          RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta,
  ...
  factory RegionInstanceGroupManagerComputeBetaArgs.fromMap(
    ...
    return RegionInstanceGroupManagerComputeBetaArgs(
      ...
      standbyPolicy: pulumi.Input.asOptionalInput<
          InstanceGroupManagerStandbyPolicyComputeBeta>(map['standbyPolicy']),
      statefulPolicy: pulumi.Input.asOptionalInput<StatefulPolicyComputeBeta>(
          map['statefulPolicy']),
      targetPools:
      ...
      updatePolicy: pulumi.Input.asOptionalInput<
          InstanceGroupManagerUpdatePolicyComputeBeta>(map['updatePolicy']),
      versions: pulumi.Input.asOptionalInput<
          List<InstanceGroupManagerVersionComputeBeta>>(map['versions']),
    );
  }
}
