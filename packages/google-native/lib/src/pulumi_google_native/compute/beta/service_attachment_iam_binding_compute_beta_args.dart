...
/// The set of arguments for ServiceAttachmentIamBinding.
class ServiceAttachmentIamBindingComputeBetaArgs {
  ...
  ServiceAttachmentIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory ServiceAttachmentIamBindingComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return ServiceAttachmentIamBindingComputeBetaArgs(
