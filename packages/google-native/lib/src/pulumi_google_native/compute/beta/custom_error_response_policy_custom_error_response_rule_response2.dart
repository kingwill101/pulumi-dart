...
class CustomErrorResponsePolicyCustomErrorResponseRuleResponse2 {
  ...
  CustomErrorResponsePolicyCustomErrorResponseRuleResponse2({
  ...
  factory CustomErrorResponsePolicyCustomErrorResponseRuleResponse2.fromMap(
      Map<String, dynamic> map) {
    return CustomErrorResponsePolicyCustomErrorResponseRuleResponse2(
