...
class Reservation2 {
  ...
  final ShareSettings2? shareSettings;

  /// Reservation for instances with specific machine shapes.
  final AllocationSpecificSKUReservation2? specificReservation;
  ...
  factory Reservation2.fromMap(Map<String, dynamic> map) {
    return Reservation2(
      aggregateReservation: map['aggregateReservation'] == null
          ? null
          : AllocationAggregateReservation2.fromMap(
