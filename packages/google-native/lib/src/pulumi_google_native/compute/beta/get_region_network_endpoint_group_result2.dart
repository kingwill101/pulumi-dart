...
class GetRegionNetworkEndpointGroupResult2 {
  ...
  GetRegionNetworkEndpointGroupResult2({
  ...
  factory GetRegionNetworkEndpointGroupResult2.fromMap(
      Map<String, dynamic> map) {
    return GetRegionNetworkEndpointGroupResult2(
