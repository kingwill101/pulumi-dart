...
import 'autoscaling_policy_cpu_utilization_predictive_method2.dart';

/// CPU utilization policy.
class AutoscalingPolicyCpuUtilization2 {
  /// Indicates whether predictive autoscaling based on CPU metric is enabled. Valid values are: * NONE (default). No predictive method is used. The autoscaler scales the group to meet current demand based on real-time metrics. * OPTIMIZE_AVAILABILITY. Predictive autoscaling improves availability by monitoring daily and weekly load patterns and scaling out ahead of anticipated demand.
  final AutoscalingPolicyCpuUtilizationPredictiveMethod2? predictiveMethod;
  ...
  AutoscalingPolicyCpuUtilization2({
  ...
  factory AutoscalingPolicyCpuUtilization2.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCpuUtilization2(
      predictiveMethod: map['predictiveMethod'] == null
          ? null
          : AutoscalingPolicyCpuUtilizationPredictiveMethod2.fromValue(
