...
import 'ssl_policy_args2.dart';
import 'ssl_policy_warnings_item_response2.dart';

/// Returns the specified SSL policy resource.
class SslPolicy2 extends CustomResource {
  ...
  late final Output<List<SslPolicyWarningsItemResponse2>> warnings;
  ...
  SslPolicy2(
    ...
    this.warnings =
        registerOutput<List<SslPolicyWarningsItemResponse2>>('warnings');
  }
}
