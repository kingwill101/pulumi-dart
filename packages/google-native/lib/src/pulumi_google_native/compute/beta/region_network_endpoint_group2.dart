...
import 'region_network_endpoint_group_args2.dart';

/// Creates a network endpoint group in the specified project using the parameters that are included in the request.
class RegionNetworkEndpointGroup2 extends CustomResource {
  ...
  RegionNetworkEndpointGroup2(
    String name, {
    RegionNetworkEndpointGroupArgs2? args,
