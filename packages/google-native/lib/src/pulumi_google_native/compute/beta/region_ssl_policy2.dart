...
import 'region_ssl_policy_args2.dart';
import 'region_ssl_policy_warnings_item_response2.dart';

/// Creates a new policy in the specified project and region using the data included in the request.
class RegionSslPolicy2 extends CustomResource {
  ...
  late final Output<List<RegionSslPolicyWarningsItemResponse2>> warnings;

  RegionSslPolicy2(
    String name, {
    RegionSslPolicyArgs2? args,
    ...
    this.warnings =
        registerOutput<List<RegionSslPolicyWarningsItemResponse2>>('warnings');
  }
}
