...
class NetworkEndpointGroupComputeBetaArgs {
  ...
  final pulumi.Input<NetworkEndpointGroupNetworkEndpointTypeComputeBeta>?
      networkEndpointType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkEndpointTypeValue != null) {
      map['networkEndpointType'] = pulumi.Input.mapOptionalInputValue<
          NetworkEndpointGroupNetworkEndpointTypeComputeBeta,
  ...
  factory NetworkEndpointGroupComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return NetworkEndpointGroupComputeBetaArgs(
      annotations:
          pulumi.Input.asOptionalInput<Map<String, String>>(map['annotations']),
      appEngine: pulumi.Input.asOptionalInput<
          NetworkEndpointGroupAppEngineComputeBeta>(map['appEngine']),
      cloudFunction: pulumi.Input.asOptionalInput<
          NetworkEndpointGroupCloudFunctionComputeBeta>(map['cloudFunction']),
      cloudRun:
          pulumi.Input.asOptionalInput<NetworkEndpointGroupCloudRunComputeBeta>(
              map['cloudRun']),
