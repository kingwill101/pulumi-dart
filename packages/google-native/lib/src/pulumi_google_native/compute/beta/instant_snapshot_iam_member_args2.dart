...
class InstantSnapshotIamMemberArgs2 {
  ...
  factory InstantSnapshotIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotIamMemberArgs2(
