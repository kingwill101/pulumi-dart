...
class GetRegionNotificationEndpointResult2 {
  ...
  final NotificationEndpointGrpcSettingsResponse2 grpcSettings;
  ...
  GetRegionNotificationEndpointResult2({
  ...
  factory GetRegionNotificationEndpointResult2.fromMap(
      Map<String, dynamic> map) {
    return GetRegionNotificationEndpointResult2(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      grpcSettings: NotificationEndpointGrpcSettingsResponse2.fromMap(
