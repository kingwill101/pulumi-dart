...
import 'attached_disk_initialize_params_architecture2.dart';
import 'attached_disk_initialize_params_on_update_action2.dart';
...
class AttachedDiskInitializeParams2 {
  /// The architecture of the attached disk. Valid values are arm64 or x86_64.
  final AttachedDiskInitializeParamsArchitecture2? architecture;
  ...
  final AttachedDiskInitializeParamsOnUpdateAction2? onUpdateAction;
  ...
  final CustomerEncryptionKey2? sourceImageEncryptionKey;
  ...
  final CustomerEncryptionKey2? sourceSnapshotEncryptionKey;

  AttachedDiskInitializeParams2({
    this.architecture,
    this.description,
    this.diskName,
    this.diskSizeGb,
  ...
  factory AttachedDiskInitializeParams2.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParams2(
      architecture: map['architecture'] == null
          ? null
          : AttachedDiskInitializeParamsArchitecture2.fromValue(
      ...
      onUpdateAction: map['onUpdateAction'] == null
          ? null
          : AttachedDiskInitializeParamsOnUpdateAction2.fromValue(
