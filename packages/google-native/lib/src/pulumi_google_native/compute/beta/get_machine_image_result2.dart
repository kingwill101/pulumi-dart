...
import 'saved_disk_response2.dart';
import 'source_disk_encryption_key_response2.dart';
import 'source_instance_properties_response2.dart';

/// Result data returned by getMachineImage.
class GetMachineImageResult2 {
  ...
  final InstancePropertiesResponse2 instanceProperties;
  ...
  final CustomerEncryptionKeyResponse2 machineImageEncryptionKey;
  ...
  final List<SavedDiskResponse2> savedDisks;

  /// The URL for this machine image. The server defines this URL.
  final String selfLink;

  /// [Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.
  final List<SourceDiskEncryptionKeyResponse2> sourceDiskEncryptionKeys;
  ...
  final SourceInstancePropertiesResponse2 sourceInstanceProperties;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['savedDisks'] =
        Input.encodeList<SavedDiskResponse2, Map<String, dynamic>>(
            savedDisks, (value) => value.toMap());
    map['selfLink'] = selfLink;
    map['sourceDiskEncryptionKeys'] = Input.encodeList<
            SourceDiskEncryptionKeyResponse2, Map<String, dynamic>>(
  ...
  factory GetMachineImageResult2.fromMap(Map<String, dynamic> map) {
    return GetMachineImageResult2(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      guestFlush: map['guestFlush'] as bool,
      instanceProperties: InstancePropertiesResponse2.fromMap(
          (map['instanceProperties'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      machineImageEncryptionKey: CustomerEncryptionKeyResponse2.fromMap(
          (map['machineImageEncryptionKey'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      savedDisks: Input.decodeList<SavedDiskResponse2>(
          map['savedDisks'],
          (value) => SavedDiskResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] as String,
      sourceDiskEncryptionKeys:
          Input.decodeList<SourceDiskEncryptionKeyResponse2>(
              map['sourceDiskEncryptionKeys'],
              (value) => SourceDiskEncryptionKeyResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceProperties: SourceInstancePropertiesResponse2.fromMap(
