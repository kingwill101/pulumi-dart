...
import 'region_target_tcp_proxy_proxy_header2.dart';

/// The set of arguments for RegionTargetTcpProxy.
class RegionTargetTcpProxyArgs2 {
  ...
  final Input<RegionTargetTcpProxyProxyHeader2>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          Input.mapOptionalInputValue<RegionTargetTcpProxyProxyHeader2, String>(
  ...
  factory RegionTargetTcpProxyArgs2.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyArgs2(
      description: Input.asOptionalInput<String>(map['description']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      proxyBind: Input.asOptionalInput<bool>(map['proxyBind']),
      proxyHeader: Input.asOptionalInput<RegionTargetTcpProxyProxyHeader2>(
          map['proxyHeader']),
