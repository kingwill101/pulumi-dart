...
import 'machine_image_args2.dart';
...
class MachineImage2 extends CustomResource {
  ...
  late final Output<InstancePropertiesResponse2> instanceProperties;
  ...
  late final Output<CustomerEncryptionKeyResponse2> machineImageEncryptionKey;
  ...
  late final Output<List<SavedDiskResponse2>> savedDisks;

  /// The URL for this machine image. The server defines this URL.
  late final Output<String> selfLink;

  /// [Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.
  late final Output<List<SourceDiskEncryptionKeyResponse2>>
  ...
  late final Output<SourceInstancePropertiesResponse2> sourceInstanceProperties;
  ...
  late final Output<String> totalStorageBytes;

  MachineImage2(
    String name, {
    MachineImageArgs2? args,
