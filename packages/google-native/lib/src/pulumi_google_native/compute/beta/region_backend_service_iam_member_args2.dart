...
class RegionBackendServiceIamMemberArgs2 {
  ...
  RegionBackendServiceIamMemberArgs2({
    this.condition,
  ...
  factory RegionBackendServiceIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceIamMemberArgs2(
