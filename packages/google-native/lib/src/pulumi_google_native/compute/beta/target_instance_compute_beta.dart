...
import 'target_instance_compute_beta_args.dart';

/// Creates a TargetInstance resource in the specified project and zone using the data included in the request.
class TargetInstanceComputeBeta extends pulumi.CustomResource {
  ...
  TargetInstanceComputeBeta(
    String name, {
    TargetInstanceComputeBetaArgs? args,
