...
class SecurityPolicyAdaptiveProtectionConfigAutoDeployConfig2 {
  final double? confidenceThreshold;
  final int? expirationSec;
  final double? impactedBaselineThreshold;
  final double? loadThreshold;

  SecurityPolicyAdaptiveProtectionConfigAutoDeployConfig2({
  ...
  factory SecurityPolicyAdaptiveProtectionConfigAutoDeployConfig2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigAutoDeployConfig2(
