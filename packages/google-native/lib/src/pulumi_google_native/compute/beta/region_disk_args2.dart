...
import 'disk_async_replication2.dart';
import 'disk_params2.dart';
import 'guest_os_feature2.dart';
import 'region_disk_architecture2.dart';
import 'region_disk_interface2.dart';
import 'region_disk_storage_type2.dart';

/// The set of arguments for RegionDisk.
class RegionDiskArgs2 {
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final Input<RegionDiskArchitecture2>? architecture;

  /// Disk asynchronously replicated into this disk.
  final Input<DiskAsyncReplication2>? asyncPrimaryDisk;
  ...
  final Input<CustomerEncryptionKey2>? diskEncryptionKey;
  ...
  final Input<RegionDiskInterface2>? interface;
  ...
  final Input<DiskParams2>? params;
  ...
  final Input<RegionDiskStorageType2>? storageType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (architectureValue != null) {
      map['architecture'] =
          Input.mapOptionalInputValue<RegionDiskArchitecture2, String>(
    ...
    if (asyncPrimaryDiskValue != null) {
      map['asyncPrimaryDisk'] = Input.mapOptionalInputValue<
              DiskAsyncReplication2, Map<String, dynamic>>(
    ...
    if (interfaceValue != null) {
      map['interface'] =
          Input.mapOptionalInputValue<RegionDiskInterface2, String>(
    ...
    if (paramsValue != null) {
      map['params'] =
          Input.mapOptionalInputValue<DiskParams2, Map<String, dynamic>>(
    ...
    if (storageTypeValue != null) {
      map['storageType'] =
          Input.mapOptionalInputValue<RegionDiskStorageType2, String>(
  ...
  factory RegionDiskArgs2.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs2(
      architecture:
          Input.asOptionalInput<RegionDiskArchitecture2>(map['architecture']),
      asyncPrimaryDisk:
          Input.asOptionalInput<DiskAsyncReplication2>(map['asyncPrimaryDisk']),
      description: Input.asOptionalInput<String>(map['description']),
      diskEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey2>(
      ...
      interface: Input.asOptionalInput<RegionDiskInterface2>(map['interface']),
      ...
      params: Input.asOptionalInput<DiskParams2>(map['params']),
      ...
      storageType:
          Input.asOptionalInput<RegionDiskStorageType2>(map['storageType']),
