...
class GetImageResult2 {
  ...
  final DeprecationStatusResponse2 deprecated;
  ...
  final CustomerEncryptionKeyResponse2 imageEncryptionKey;
  ...
  final ImageRawDiskResponse2 rawDisk;
  ...
  final RolloutPolicyResponse2 rolloutOverride;
  ...
  final CustomerEncryptionKeyResponse2 sourceDiskEncryptionKey;
  ...
  factory GetImageResult2.fromMap(Map<String, dynamic> map) {
    return GetImageResult2(
      ...
      deprecated: DeprecationStatusResponse2.fromMap(
      ...
      imageEncryptionKey: CustomerEncryptionKeyResponse2.fromMap(
      ...
      rawDisk: ImageRawDiskResponse2.fromMap(
          (map['rawDisk'] as Map).cast<String, dynamic>()),
      rolloutOverride: RolloutPolicyResponse2.fromMap(
      ...
      sourceDiskEncryptionKey: CustomerEncryptionKeyResponse2.fromMap(
