...
class ResourcePolicyHourlyCycle2 {
  ...
  factory ResourcePolicyHourlyCycle2.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyHourlyCycle2(
      hoursInCycle:
