...
class InstanceTemplateComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sourceInstanceParamsValue != null) {
      map['sourceInstanceParams'] = pulumi.Input.mapOptionalInputValue<
              SourceInstanceParamsComputeBeta, Map<String, dynamic>>(
  ...
  factory InstanceTemplateComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateComputeBetaArgs(
      ...
      properties: pulumi.Input.asOptionalInput<InstancePropertiesComputeBeta>(
          map['properties']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      sourceInstance:
          pulumi.Input.asOptionalInput<String>(map['sourceInstance']),
      sourceInstanceParams:
          pulumi.Input.asOptionalInput<SourceInstanceParamsComputeBeta>(
