...
import 'audit_log_config23.dart';
...
class AuditConfig23 {
  ...
  final List<AuditLogConfig23>? auditLogConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditLogConfigsValue != null) {
      map['auditLogConfigs'] =
          Input.encodeList<AuditLogConfig23, Map<String, dynamic>>(
  ...
  factory AuditConfig23.fromMap(Map<String, dynamic> map) {
    return AuditConfig23(
      auditLogConfigs: map['auditLogConfigs'] == null
          ? null
          : Input.decodeList<AuditLogConfig23>(
              map['auditLogConfigs'],
              (value) => AuditLogConfig23.fromMap(
