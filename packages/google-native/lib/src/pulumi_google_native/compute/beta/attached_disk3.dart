...
import 'attached_disk_initialize_params2.dart';
import 'attached_disk_interface2.dart';
import 'attached_disk_mode2.dart';
import 'attached_disk_saved_state2.dart';
import 'attached_disk_type2.dart';
...
class AttachedDisk3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (guestOsFeaturesValue != null) {
      map['guestOsFeatures'] =
          Input.encodeList<GuestOsFeature2, Map<String, dynamic>>(
  ...
  factory AttachedDisk3.fromMap(Map<String, dynamic> map) {
    return AttachedDisk3(
      ...
      guestOsFeatures: map['guestOsFeatures'] == null
          ? null
          : Input.decodeList<GuestOsFeature2>(
              map['guestOsFeatures'],
              (value) => GuestOsFeature2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      initializeParams: map['initializeParams'] == null
          ? null
          : AttachedDiskInitializeParams2.fromMap(
              (map['initializeParams'] as Map).cast<String, dynamic>()),
      interface: map['interface'] == null
          ? null
          : AttachedDiskInterface2.fromValue(map['interface'] as String),
      mode: map['mode'] == null
          ? null
          : AttachedDiskMode2.fromValue(map['mode'] as String),
      savedState: map['savedState'] == null
          ? null
          : AttachedDiskSavedState2.fromValue(map['savedState'] as String),
      source: map['source'] == null ? null : map['source'] as String,
      type: map['type'] == null
          ? null
          : AttachedDiskType2.fromValue(map['type'] as String),
    );
  }
}
