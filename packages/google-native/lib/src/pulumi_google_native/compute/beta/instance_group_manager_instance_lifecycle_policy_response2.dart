...
class InstanceGroupManagerInstanceLifecyclePolicyResponse2 {
  ...
  factory InstanceGroupManagerInstanceLifecyclePolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerInstanceLifecyclePolicyResponse2(
