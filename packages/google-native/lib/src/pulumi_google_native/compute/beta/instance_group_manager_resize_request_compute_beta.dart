...
class InstanceGroupManagerResizeRequestComputeBeta
  ...
  late final pulumi
      .Output<InstanceGroupManagerResizeRequestStatusResponseComputeBeta>
      status;
  ...
  InstanceGroupManagerResizeRequestComputeBeta(
    ...
    this.requestedRunDuration =
        registerOutput<DurationResponseComputeBeta>('requestedRunDuration');
    this.resizeBy = registerOutput<int>('resizeBy');
    this.selfLink = registerOutput<String>('selfLink');
    this.selfLinkWithId = registerOutput<String>('selfLinkWithId');
    this.state = registerOutput<String>('state');
    this.status = registerOutput<
        InstanceGroupManagerResizeRequestStatusResponseComputeBeta>('status');
