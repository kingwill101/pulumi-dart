...
class BackendServiceLogConfigResponse2 {
  ...
  BackendServiceLogConfigResponse2({
  ...
  factory BackendServiceLogConfigResponse2.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfigResponse2(
