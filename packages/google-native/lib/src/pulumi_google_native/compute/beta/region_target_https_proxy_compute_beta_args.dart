...
class RegionTargetHttpsProxyComputeBetaArgs {
  ...
  final pulumi.Input<RegionTargetHttpsProxyQuicOverrideComputeBeta>?
      quicOverride;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (quicOverrideValue != null) {
      map['quicOverride'] = pulumi.Input.mapOptionalInputValue<
          RegionTargetHttpsProxyQuicOverrideComputeBeta,
  ...
  factory RegionTargetHttpsProxyComputeBetaArgs.fromMap(
    ...
    return RegionTargetHttpsProxyComputeBetaArgs(
      ...
      quicOverride: pulumi.Input.asOptionalInput<
          RegionTargetHttpsProxyQuicOverrideComputeBeta>(map['quicOverride']),
