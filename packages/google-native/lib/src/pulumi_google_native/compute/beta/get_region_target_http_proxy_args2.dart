...
class GetRegionTargetHttpProxyArgs2 {
  final Input<String>? project;
  final Input<String> region;
  final Input<String> targetHttpProxy;

  GetRegionTargetHttpProxyArgs2({
    this.project,
  ...
  factory GetRegionTargetHttpProxyArgs2.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpProxyArgs2(
