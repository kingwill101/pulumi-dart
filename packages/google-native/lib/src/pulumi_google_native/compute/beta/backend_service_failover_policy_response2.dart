...
class BackendServiceFailoverPolicyResponse2 {
  ...
  BackendServiceFailoverPolicyResponse2({
  ...
  factory BackendServiceFailoverPolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceFailoverPolicyResponse2(
