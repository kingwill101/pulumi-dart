...
class MachineImageComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (savedDisksValue != null) {
      map['savedDisks'] = pulumi.Input.mapOptionalInputValue<
              List<SavedDiskComputeBeta>, List<Map<String, dynamic>>>(
          savedDisksValue,
          (value) => pulumi.Input.encodeList<SavedDiskComputeBeta,
    ...
    if (sourceDiskEncryptionKeysValue != null) {
      map['sourceDiskEncryptionKeys'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<SourceDiskEncryptionKeyComputeBeta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory MachineImageComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageComputeBetaArgs(
      ...
      savedDisks: pulumi.Input.asOptionalInput<List<SavedDiskComputeBeta>>(
          map['savedDisks']),
