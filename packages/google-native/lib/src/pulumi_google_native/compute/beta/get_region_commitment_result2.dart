...
class GetRegionCommitmentResult2 {
  ...
  final LicenseResourceCommitmentResponse2 licenseResource;
  ...
  final List<ReservationResponse2> reservations;

  /// A list of commitment amounts for particular resources. Note that VCPU and MEMORY resource commitments must occur together.
  final List<ResourceCommitmentResponse2> resources;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['region'] = region;
    map['reservations'] =
        Input.encodeList<ReservationResponse2, Map<String, dynamic>>(
            reservations, (value) => value.toMap());
    map['resources'] =
        Input.encodeList<ResourceCommitmentResponse2, Map<String, dynamic>>(
  ...
  factory GetRegionCommitmentResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionCommitmentResult2(
      ...
      licenseResource: LicenseResourceCommitmentResponse2.fromMap(
      ...
      reservations: Input.decodeList<ReservationResponse2>(
          map['reservations'],
          (value) => ReservationResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      resources: Input.decodeList<ResourceCommitmentResponse2>(
          map['resources'],
          (value) => ResourceCommitmentResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
