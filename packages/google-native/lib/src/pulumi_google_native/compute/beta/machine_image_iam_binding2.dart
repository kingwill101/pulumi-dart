...
import 'machine_image_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class MachineImageIamBinding2 extends CustomResource {
  ...
  MachineImageIamBinding2(
    String name, {
    MachineImageIamBindingArgs2? args,
