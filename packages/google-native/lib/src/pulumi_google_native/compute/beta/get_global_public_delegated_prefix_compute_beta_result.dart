...
class GetGlobalPublicDelegatedPrefixComputeBetaResult {
  ...
  GetGlobalPublicDelegatedPrefixComputeBetaResult({
  ...
  factory GetGlobalPublicDelegatedPrefixComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetGlobalPublicDelegatedPrefixComputeBetaResult(
