...
import 'backend_service_cdn_policy_bypass_cache_on_request_header_response2.dart';
import 'backend_service_cdn_policy_negative_caching_policy_response2.dart';
import 'cache_key_policy_response2.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicyResponse2 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse2>
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final CacheKeyPolicyResponse2 cacheKeyPolicy;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyResponse2>
  ...
  BackendServiceCdnPolicyResponse2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bypassCacheOnRequestHeaders'] = Input.encodeList<
            BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse2,
            Map<String, dynamic>>(
    ...
    map['negativeCachingPolicy'] = Input.encodeList<
        BackendServiceCdnPolicyNegativeCachingPolicyResponse2,
  ...
  factory BackendServiceCdnPolicyResponse2.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponse2(
      bypassCacheOnRequestHeaders: Input.decodeList<
              BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse2>(
          map['bypassCacheOnRequestHeaders'],
          (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse2
              .fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: CacheKeyPolicyResponse2.fromMap(
      ...
      negativeCachingPolicy: Input.decodeList<
          ...
          (value) =>
              BackendServiceCdnPolicyNegativeCachingPolicyResponse2.fromMap(
