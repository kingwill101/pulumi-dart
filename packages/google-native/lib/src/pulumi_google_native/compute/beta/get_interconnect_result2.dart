...
import 'interconnect_circuit_info_response2.dart';
import 'interconnect_macsec_response2.dart';
import 'interconnect_outage_notification_response2.dart';

/// Result data returned by getInterconnect.
class GetInterconnectResult2 {
  ...
  final List<InterconnectCircuitInfoResponse2> circuitInfos;
  ...
  final List<InterconnectOutageNotificationResponse2> expectedOutages;
  ...
  final InterconnectMacsecResponse2 macsec;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['circuitInfos'] = Input.encodeList<InterconnectCircuitInfoResponse2,
        Map<String, dynamic>>(circuitInfos, (value) => value.toMap());
    map['creationTimestamp'] = creationTimestamp;
    map['customerName'] = customerName;
    map['description'] = description;
    map['expectedOutages'] = Input.encodeList<
        InterconnectOutageNotificationResponse2,
  ...
  factory GetInterconnectResult2.fromMap(Map<String, dynamic> map) {
    return GetInterconnectResult2(
      adminEnabled: map['adminEnabled'] as bool,
      availableFeatures: (map['availableFeatures'] as List).cast<String>(),
      circuitInfos: Input.decodeList<InterconnectCircuitInfoResponse2>(
          map['circuitInfos'],
          (value) => InterconnectCircuitInfoResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      customerName: map['customerName'] as String,
      description: map['description'] as String,
      expectedOutages:
          Input.decodeList<InterconnectOutageNotificationResponse2>(
              map['expectedOutages'],
              (value) => InterconnectOutageNotificationResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      macsec: InterconnectMacsecResponse2.fromMap(
