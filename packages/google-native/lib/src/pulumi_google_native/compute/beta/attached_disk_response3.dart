...
import 'attached_disk_initialize_params_response2.dart';
...
class AttachedDiskResponse3 {
  ...
  final CustomerEncryptionKeyResponse2 diskEncryptionKey;
  ...
  final AttachedDiskInitializeParamsResponse2 initializeParams;
  ...
  final InitialStateConfigResponse2 shieldedInstanceInitialState;
  ...
  factory AttachedDiskResponse3.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponse3(
      architecture: map['architecture'] as String,
      autoDelete: map['autoDelete'] as bool,
      boot: map['boot'] as bool,
      deviceName: map['deviceName'] as String,
      diskEncryptionKey: CustomerEncryptionKeyResponse2.fromMap(
      ...
      initializeParams: AttachedDiskInitializeParamsResponse2.fromMap(
      ...
      shieldedInstanceInitialState: InitialStateConfigResponse2.fromMap(
