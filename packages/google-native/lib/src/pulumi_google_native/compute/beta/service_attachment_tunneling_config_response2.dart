...
class ServiceAttachmentTunnelingConfigResponse2 {
  ...
  ServiceAttachmentTunnelingConfigResponse2({
  ...
  factory ServiceAttachmentTunnelingConfigResponse2.fromMap(
      Map<String, dynamic> map) {
    return ServiceAttachmentTunnelingConfigResponse2(
