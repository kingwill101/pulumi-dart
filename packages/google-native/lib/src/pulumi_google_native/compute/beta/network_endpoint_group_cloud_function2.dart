...
class NetworkEndpointGroupCloudFunction2 {
  ...
  factory NetworkEndpointGroupCloudFunction2.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupCloudFunction2(
