...
class FirewallPolicyIamBindingArgs2 {
  ...
  factory FirewallPolicyIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamBindingArgs2(
