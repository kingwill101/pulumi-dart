...
class HttpRouteRule2 {
  ...
  final CustomErrorResponsePolicy2? customErrorResponsePolicy;
  ...
  final List<HttpFilterConfig2>? httpFilterConfigs;
  ...
  final List<HttpFilterConfig2>? httpFilterMetadata;

  /// The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
  final List<HttpRouteRuleMatch2>? matchRules;
  ...
  final HttpRouteAction2? routeAction;
  ...
  final HttpRedirectAction2? urlRedirect;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (httpFilterConfigsValue != null) {
      map['httpFilterConfigs'] =
          Input.encodeList<HttpFilterConfig2, Map<String, dynamic>>(
    ...
    if (matchRulesValue != null) {
      map['matchRules'] =
          Input.encodeList<HttpRouteRuleMatch2, Map<String, dynamic>>(
  ...
  factory HttpRouteRule2.fromMap(Map<String, dynamic> map) {
    return HttpRouteRule2(
      ...
      httpFilterConfigs: map['httpFilterConfigs'] == null
          ? null
          : Input.decodeList<HttpFilterConfig2>(
              map['httpFilterConfigs'],
              (value) => HttpFilterConfig2.fromMap(
      ...
      matchRules: map['matchRules'] == null
          ? null
          : Input.decodeList<HttpRouteRuleMatch2>(
              map['matchRules'],
              (value) => HttpRouteRuleMatch2.fromMap(
                  (value as Map).cast<String, dynamic>())),
