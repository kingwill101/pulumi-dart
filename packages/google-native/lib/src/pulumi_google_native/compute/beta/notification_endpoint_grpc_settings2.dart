...
class NotificationEndpointGrpcSettings2 {
  ...
  final Duration2? resendInterval;

  /// How much time (in seconds) is spent attempting notification retries until a successful response is received. Default is 30s. Limit is 20m (1200s). Must be a positive number.
  final int? retryDurationSec;

  NotificationEndpointGrpcSettings2({
    this.authority,
    this.endpoint,
    this.payloadName,
    this.resendInterval,
  ...
  factory NotificationEndpointGrpcSettings2.fromMap(Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettings2(
