...
class ExternalVpnGatewayInterface2 {
  ...
  factory ExternalVpnGatewayInterface2.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayInterface2(
