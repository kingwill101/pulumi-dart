...
class GetRegionHealthCheckServiceResult2 {
  ...
  GetRegionHealthCheckServiceResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['healthStatusAggregationStrategy'] = healthStatusAggregationStrategy;
    map['kind'] = kind;
    map['name'] = name;
  ...
  factory GetRegionHealthCheckServiceResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionHealthCheckServiceResult2(
