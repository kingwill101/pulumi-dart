...
enum RegionCommitmentType2 {
  ...
  const RegionCommitmentType2(this.value);
  final String value;

  static RegionCommitmentType2 fromValue(String value) {
    for (final item in RegionCommitmentType2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown RegionCommitmentType2 value: $value');
  }
}
