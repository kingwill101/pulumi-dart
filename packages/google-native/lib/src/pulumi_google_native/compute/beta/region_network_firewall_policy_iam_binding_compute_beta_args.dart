...
class RegionNetworkFirewallPolicyIamBindingComputeBetaArgs {
  ...
  RegionNetworkFirewallPolicyIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamBindingComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamBindingComputeBetaArgs(
