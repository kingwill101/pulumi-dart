...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse2 {
  ...
  SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse2({
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse2(
