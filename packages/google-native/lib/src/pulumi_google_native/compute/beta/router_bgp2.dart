...
import 'router_bgp_advertise_mode2.dart';
import 'router_bgp_advertised_groups_item2.dart';

class RouterBgp2 {
  /// User-specified flag to indicate which mode to use for advertisement. The options are DEFAULT or CUSTOM.
  final RouterBgpAdvertiseMode2? advertiseMode;

  /// User-specified list of prefix groups to advertise in custom mode. This field can only be populated if advertise_mode is CUSTOM and is advertised to all peers of the router. These groups will be advertised in addition to any specified prefixes. Leave this field blank to advertise no custom groups.
  final List<RouterBgpAdvertisedGroupsItem2>? advertisedGroups;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (advertisedGroupsValue != null) {
      map['advertisedGroups'] =
          Input.encodeList<RouterBgpAdvertisedGroupsItem2, String>(
  ...
  factory RouterBgp2.fromMap(Map<String, dynamic> map) {
    return RouterBgp2(
      advertiseMode: map['advertiseMode'] == null
          ? null
          : RouterBgpAdvertiseMode2.fromValue(map['advertiseMode'] as String),
      advertisedGroups: map['advertisedGroups'] == null
          ? null
          : Input.decodeList<RouterBgpAdvertisedGroupsItem2>(
              map['advertisedGroups'],
              (value) =>
                  RouterBgpAdvertisedGroupsItem2.fromValue(value as String)),
