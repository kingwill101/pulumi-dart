...
class GetRegionSslCertificateResult2 {
  ...
  final SslCertificateManagedSslCertificateResponse2 managed;
  ...
  final SslCertificateSelfManagedSslCertificateResponse2 selfManaged;
  ...
  GetRegionSslCertificateResult2({
  ...
  factory GetRegionSslCertificateResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionSslCertificateResult2(
      certificate: map['certificate'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      kind: map['kind'] as String,
      managed: SslCertificateManagedSslCertificateResponse2.fromMap(
          (map['managed'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      privateKey: map['privateKey'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      selfManaged: SslCertificateSelfManagedSslCertificateResponse2.fromMap(
