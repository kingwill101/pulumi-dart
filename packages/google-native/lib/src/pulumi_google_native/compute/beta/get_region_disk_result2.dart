...
class GetRegionDiskResult2 {
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final String architecture;

  /// Disk asynchronously replicated into this disk.
  final DiskAsyncReplicationResponse2 asyncPrimaryDisk;
  ...
  final DiskParamsResponse2 params;
  ...
  final DiskResourceStatusResponse2 resourceStatus;
  ...
  factory GetRegionDiskResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionDiskResult2(
      architecture: map['architecture'] as String,
      asyncPrimaryDisk: DiskAsyncReplicationResponse2.fromMap(
      ...
      params: DiskParamsResponse2.fromMap(
      ...
      resourceStatus: DiskResourceStatusResponse2.fromMap(
