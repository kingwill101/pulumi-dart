...
class ResourcePolicyGroupPlacementPolicyResponse2 {
  ...
  ResourcePolicyGroupPlacementPolicyResponse2({
  ...
  factory ResourcePolicyGroupPlacementPolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicyGroupPlacementPolicyResponse2(
