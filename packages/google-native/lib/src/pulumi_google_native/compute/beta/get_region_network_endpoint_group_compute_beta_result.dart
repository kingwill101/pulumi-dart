...
class GetRegionNetworkEndpointGroupComputeBetaResult {
  ...
  GetRegionNetworkEndpointGroupComputeBetaResult({
  ...
  factory GetRegionNetworkEndpointGroupComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetRegionNetworkEndpointGroupComputeBetaResult(
