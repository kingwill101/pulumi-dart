...
import 'access_config_network_tier2.dart';
import 'access_config_type2.dart';
...
class AccessConfig2 {
  ...
  final AccessConfigNetworkTier2? networkTier;
  ...
  factory AccessConfig2.fromMap(Map<String, dynamic> map) {
    return AccessConfig2(
      ...
      networkTier: map['networkTier'] == null
          ? null
          : AccessConfigNetworkTier2.fromValue(map['networkTier'] as String),
      ...
      type: map['type'] == null
          ? null
          : AccessConfigType2.fromValue(map['type'] as String),
    );
  }
}
