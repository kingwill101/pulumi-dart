...
class RegionInstantSnapshotIamBindingArgs2 {
  ...
  RegionInstantSnapshotIamBindingArgs2({
    this.condition,
  ...
  factory RegionInstantSnapshotIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionInstantSnapshotIamBindingArgs2(
