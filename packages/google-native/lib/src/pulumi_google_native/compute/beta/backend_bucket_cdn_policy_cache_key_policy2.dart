...
class BackendBucketCdnPolicyCacheKeyPolicy2 {
  ...
  BackendBucketCdnPolicyCacheKeyPolicy2({
  ...
  factory BackendBucketCdnPolicyCacheKeyPolicy2.fromMap(
      Map<String, dynamic> map) {
    return BackendBucketCdnPolicyCacheKeyPolicy2(
