...
class RouterBgpPeerComputeBeta {
  ...
  final RouterBgpPeerAdvertiseModeComputeBeta? advertiseMode;

  /// User-specified list of prefix groups to advertise in custom mode, which currently supports the following option: - ALL_SUBNETS: Advertises all of the router's own VPC subnets. This excludes any routes learned for subnets that use VPC Network Peering. Note that this field can only be populated if advertise_mode is CUSTOM and overrides the list defined for the router (in the "bgp" message). These groups are advertised in addition to any specified prefixes. Leave this field blank to advertise no custom groups.
  final List<RouterBgpPeerAdvertisedGroupsItemComputeBeta>? advertisedGroups;
  ...
  final RouterBgpPeerBfdComputeBeta? bfd;

  /// A list of user-defined custom learned route IP address ranges for a BGP session.
  final List<RouterBgpPeerCustomLearnedIpRangeComputeBeta>?
  ...
  final RouterBgpPeerEnableComputeBeta? enable;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (advertisedGroupsValue != null) {
      map['advertisedGroups'] = pulumi.Input.encodeList<
          RouterBgpPeerAdvertisedGroupsItemComputeBeta,
  ...
  factory RouterBgpPeerComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerComputeBeta(
      advertiseMode: map['advertiseMode'] == null
          ? null
          : RouterBgpPeerAdvertiseModeComputeBeta.fromValue(
      ...
      advertisedGroups: map['advertisedGroups'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => RouterBgpPeerAdvertisedGroupsItemComputeBeta.fromValue(
                  value as String)),
      ...
      bfd: map['bfd'] == null
          ? null
          : RouterBgpPeerBfdComputeBeta.fromMap(
      ...
      customLearnedIpRanges: map['customLearnedIpRanges'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => RouterBgpPeerCustomLearnedIpRangeComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      enable: map['enable'] == null
          ? null
          : RouterBgpPeerEnableComputeBeta.fromValue(map['enable'] as String),
