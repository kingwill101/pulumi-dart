...
class PacketMirroringFilterResponse2 {
  ...
  PacketMirroringFilterResponse2({
  ...
  factory PacketMirroringFilterResponse2.fromMap(Map<String, dynamic> map) {
    return PacketMirroringFilterResponse2(
