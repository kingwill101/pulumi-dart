...
class InterconnectAttachmentPartnerMetadataResponse2 {
  ...
  InterconnectAttachmentPartnerMetadataResponse2({
  ...
  factory InterconnectAttachmentPartnerMetadataResponse2.fromMap(
      Map<String, dynamic> map) {
    return InterconnectAttachmentPartnerMetadataResponse2(
