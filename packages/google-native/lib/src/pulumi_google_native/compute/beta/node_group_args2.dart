...
import 'node_group_autoscaling_policy2.dart';
import 'node_group_maintenance_interval2.dart';
import 'node_group_maintenance_policy2.dart';
import 'node_group_maintenance_window2.dart';
import 'share_settings2.dart';

/// The set of arguments for NodeGroup.
class NodeGroupArgs2 {
  /// Specifies how autoscaling should behave.
  final Input<NodeGroupAutoscalingPolicy2>? autoscalingPolicy;
  ...
  final Input<NodeGroupMaintenanceInterval2>? maintenanceInterval;

  /// Specifies how to handle instances when a node in the group undergoes maintenance. Set to one of: DEFAULT, RESTART_IN_PLACE, or MIGRATE_WITHIN_NODE_GROUP. The default value is DEFAULT. For more information, see Maintenance policies.
  final Input<NodeGroupMaintenancePolicy2>? maintenancePolicy;
  final Input<NodeGroupMaintenanceWindow2>? maintenanceWindow;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoscalingPolicyValue != null) {
      map['autoscalingPolicy'] = Input.mapOptionalInputValue<
              NodeGroupAutoscalingPolicy2, Map<String, dynamic>>(
    ...
    if (maintenanceIntervalValue != null) {
      map['maintenanceInterval'] =
          Input.mapOptionalInputValue<NodeGroupMaintenanceInterval2, String>(
    ...
    if (maintenancePolicyValue != null) {
      map['maintenancePolicy'] =
          Input.mapOptionalInputValue<NodeGroupMaintenancePolicy2, String>(
    ...
    if (maintenanceWindowValue != null) {
      map['maintenanceWindow'] = Input.mapOptionalInputValue<
              NodeGroupMaintenanceWindow2, Map<String, dynamic>>(
  ...
  factory NodeGroupArgs2.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs2(
      autoscalingPolicy: Input.asOptionalInput<NodeGroupAutoscalingPolicy2>(
      ...
      maintenanceInterval: Input.asOptionalInput<NodeGroupMaintenanceInterval2>(
          map['maintenanceInterval']),
      maintenancePolicy: Input.asOptionalInput<NodeGroupMaintenancePolicy2>(
          map['maintenancePolicy']),
      maintenanceWindow: Input.asOptionalInput<NodeGroupMaintenanceWindow2>(
