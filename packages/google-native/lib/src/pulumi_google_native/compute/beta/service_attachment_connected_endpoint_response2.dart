...
class ServiceAttachmentConnectedEndpointResponse2 {
  ...
  factory ServiceAttachmentConnectedEndpointResponse2.fromMap(
      Map<String, dynamic> map) {
    return ServiceAttachmentConnectedEndpointResponse2(
