...
import 'allocation_specific_skuallocation_reserved_instance_properties2.dart';

/// This reservation type allows to pre allocate specific instance configuration. Next ID: 6
class AllocationSpecificSKUReservation2 {
  /// Specifies the number of resources that are allocated.
  final String? count;

  /// The instance properties for the reservation.
  final AllocationSpecificSKUAllocationReservedInstanceProperties2?
      instanceProperties;
  ...
  AllocationSpecificSKUReservation2({
    this.count,
  ...
  factory AllocationSpecificSKUReservation2.fromMap(Map<String, dynamic> map) {
    return AllocationSpecificSKUReservation2(
      count: map['count'] == null ? null : map['count'] as String,
      instanceProperties: map['instanceProperties'] == null
          ? null
          : AllocationSpecificSKUAllocationReservedInstanceProperties2.fromMap(
