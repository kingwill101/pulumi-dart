...
import 'instance_key_revocation_action_type2.dart';
import 'instance_params2.dart';
import 'instance_post_key_revocation_action_type2.dart';
import 'instance_private_ipv6_google_access2.dart';
...
import 'shielded_instance_integrity_policy2.dart';
import 'shielded_vm_config2.dart';
import 'shielded_vm_integrity_policy2.dart';
import 'tags2.dart';

/// The set of arguments for Instance.
class InstanceArgs8 {
  /// Controls for advanced machine-related behavior features.
  final Input<AdvancedMachineFeatures2>? advancedMachineFeatures;

  /// Allows this instance to send and receive packets with non-matching destination or source IPs. This is required if you plan to use this instance to forward routes. For more information, see Enabling IP Forwarding .
  final Input<bool>? canIpForward;
  final Input<ConfidentialInstanceConfig2>? confidentialInstanceConfig;
  ...
  final Input<List<AttachedDisk3>>? disks;

  /// Enables display device for the instance.
  final Input<DisplayDevice2>? displayDevice;

  /// Specifies whether the disks restored from source snapshots or source machine image should erase Windows specific VSS signature.
  final Input<bool>? eraseWindowsVssSignature;

  /// A list of the type and count of accelerator cards attached to the instance.
  final Input<List<AcceleratorConfig2>>? guestAccelerators;
  ...
  final Input<CustomerEncryptionKey2>? instanceEncryptionKey;

  /// KeyRevocationActionType of the instance. Supported options are "STOP" and "NONE". The default value is "NONE" if it is not specified.
  final Input<InstanceKeyRevocationActionType2>? keyRevocationActionType;
  ...
  final Input<Metadata2>? metadata;
  ...
  final Input<List<NetworkInterface3>>? networkInterfaces;
  final Input<NetworkPerformanceConfig2>? networkPerformanceConfig;

  /// Input only. [Input Only] Additional params passed with the request, but not persisted as part of resource payload.
  final Input<InstanceParams2>? params;

  /// PostKeyRevocationActionType of the instance.
  final Input<InstancePostKeyRevocationActionType2>?
      postKeyRevocationActionType;

  /// The private IPv6 google access type for the VM. If not specified, use INHERIT_FROM_SUBNETWORK as default.
  final Input<InstancePrivateIpv6GoogleAccess2>? privateIpv6GoogleAccess;
  ...
  final Input<ReservationAffinity2>? reservationAffinity;

  /// Resource policies applied to this instance.
  final Input<List<String>>? resourcePolicies;

  /// Sets the scheduling options for this instance.
  final Input<Scheduling2>? scheduling;

  /// A list of service accounts, with their specified scopes, authorized for this instance. Only one service account per VM instance is supported. Service accounts generate access tokens that can be accessed through the metadata server and used to authenticate applications on the instance. See Service Accounts for more information.
  final Input<List<ServiceAccount4>>? serviceAccounts;
  final Input<ShieldedInstanceConfig2>? shieldedInstanceConfig;
  final Input<ShieldedInstanceIntegrityPolicy2>?
      shieldedInstanceIntegrityPolicy;

  /// Deprecating, please use shielded_instance_config.
  final Input<ShieldedVmConfig2>? shieldedVmConfig;

  /// Deprecating, please use shielded_instance_integrity_policy.
  final Input<ShieldedVmIntegrityPolicy2>? shieldedVmIntegrityPolicy;
  ...
  final Input<CustomerEncryptionKey2>? sourceMachineImageEncryptionKey;

  /// Tags to apply to this instance. Tags are used to identify valid sources or targets for network firewalls and are specified by the client during instance creation. The tags can be later modified by the setTags method. Each tag within the list must comply with RFC1035. Multiple tags can be specified via the 'tags.items' field.
  final Input<Tags2>? tags;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (advancedMachineFeaturesValue != null) {
      map['advancedMachineFeatures'] = Input.mapOptionalInputValue<
              AdvancedMachineFeatures2, Map<String, dynamic>>(
    ...
    if (confidentialInstanceConfigValue != null) {
      map['confidentialInstanceConfig'] = Input.mapOptionalInputValue<
              ConfidentialInstanceConfig2, Map<String, dynamic>>(
    ...
    if (disksValue != null) {
      map['disks'] = Input.mapOptionalInputValue<List<AttachedDisk3>,
              List<Map<String, dynamic>>>(
          disksValue,
          (value) => Input.encodeList<AttachedDisk3, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final displayDeviceValue = displayDevice;
    if (displayDeviceValue != null) {
      map['displayDevice'] =
          Input.mapOptionalInputValue<DisplayDevice2, Map<String, dynamic>>(
    ...
    if (guestAcceleratorsValue != null) {
      map['guestAccelerators'] = Input.mapOptionalInputValue<
              List<AcceleratorConfig2>, List<Map<String, dynamic>>>(
          guestAcceleratorsValue,
          (value) => Input.encodeList<AcceleratorConfig2, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (keyRevocationActionTypeValue != null) {
      map['keyRevocationActionType'] =
          Input.mapOptionalInputValue<InstanceKeyRevocationActionType2, String>(
    ...
    if (metadataValue != null) {
      map['metadata'] =
          Input.mapOptionalInputValue<Metadata2, Map<String, dynamic>>(
    ...
    if (networkInterfacesValue != null) {
      map['networkInterfaces'] = Input.mapOptionalInputValue<
              List<NetworkInterface3>, List<Map<String, dynamic>>>(
          networkInterfacesValue,
          (value) => Input.encodeList<NetworkInterface3, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (networkPerformanceConfigValue != null) {
      map['networkPerformanceConfig'] = Input.mapOptionalInputValue<
              NetworkPerformanceConfig2, Map<String, dynamic>>(
          networkPerformanceConfigValue, (value) => value.toMap());
    }
    final paramsValue = params;
    if (paramsValue != null) {
      map['params'] =
          Input.mapOptionalInputValue<InstanceParams2, Map<String, dynamic>>(
    ...
    if (postKeyRevocationActionTypeValue != null) {
      map['postKeyRevocationActionType'] = Input.mapOptionalInputValue<
          InstancePostKeyRevocationActionType2,
    ...
    if (privateIpv6GoogleAccessValue != null) {
      map['privateIpv6GoogleAccess'] =
          Input.mapOptionalInputValue<InstancePrivateIpv6GoogleAccess2, String>(
    ...
    if (reservationAffinityValue != null) {
      map['reservationAffinity'] = Input.mapOptionalInputValue<
              ReservationAffinity2, Map<String, dynamic>>(
    ...
    if (schedulingValue != null) {
      map['scheduling'] =
          Input.mapOptionalInputValue<Scheduling2, Map<String, dynamic>>(
    ...
    if (serviceAccountsValue != null) {
      map['serviceAccounts'] = Input.mapOptionalInputValue<
              List<ServiceAccount4>, List<Map<String, dynamic>>>(
          serviceAccountsValue,
          (value) => Input.encodeList<ServiceAccount4, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (shieldedInstanceConfigValue != null) {
      map['shieldedInstanceConfig'] = Input.mapOptionalInputValue<
              ShieldedInstanceConfig2, Map<String, dynamic>>(
    ...
    if (shieldedInstanceIntegrityPolicyValue != null) {
      map['shieldedInstanceIntegrityPolicy'] = Input.mapOptionalInputValue<
              ShieldedInstanceIntegrityPolicy2, Map<String, dynamic>>(
    ...
    if (shieldedVmConfigValue != null) {
      map['shieldedVmConfig'] =
          Input.mapOptionalInputValue<ShieldedVmConfig2, Map<String, dynamic>>(
    ...
    if (shieldedVmIntegrityPolicyValue != null) {
      map['shieldedVmIntegrityPolicy'] = Input.mapOptionalInputValue<
              ShieldedVmIntegrityPolicy2, Map<String, dynamic>>(
    ...
    if (tagsValue != null) {
      map['tags'] = Input.mapOptionalInputValue<Tags2, Map<String, dynamic>>(
  ...
  factory InstanceArgs8.fromMap(Map<String, dynamic> map) {
    return InstanceArgs8(
      advancedMachineFeatures: Input.asOptionalInput<AdvancedMachineFeatures2>(
          map['advancedMachineFeatures']),
      canIpForward: Input.asOptionalInput<bool>(map['canIpForward']),
      confidentialInstanceConfig:
          Input.asOptionalInput<ConfidentialInstanceConfig2>(
              map['confidentialInstanceConfig']),
      deletionProtection:
          Input.asOptionalInput<bool>(map['deletionProtection']),
      description: Input.asOptionalInput<String>(map['description']),
      disks: Input.asOptionalInput<List<AttachedDisk3>>(map['disks']),
      displayDevice:
          Input.asOptionalInput<DisplayDevice2>(map['displayDevice']),
      eraseWindowsVssSignature:
          Input.asOptionalInput<bool>(map['eraseWindowsVssSignature']),
      guestAccelerators: Input.asOptionalInput<List<AcceleratorConfig2>>(
          map['guestAccelerators']),
      hostname: Input.asOptionalInput<String>(map['hostname']),
      instanceEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey2>(
          map['instanceEncryptionKey']),
      keyRevocationActionType:
          Input.asOptionalInput<InstanceKeyRevocationActionType2>(
              map['keyRevocationActionType']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      machineType: Input.asOptionalInput<String>(map['machineType']),
      metadata: Input.asOptionalInput<Metadata2>(map['metadata']),
      minCpuPlatform: Input.asOptionalInput<String>(map['minCpuPlatform']),
      name: Input.asOptionalInput<String>(map['name']),
      networkInterfaces: Input.asOptionalInput<List<NetworkInterface3>>(
          map['networkInterfaces']),
      networkPerformanceConfig:
          Input.asOptionalInput<NetworkPerformanceConfig2>(
              map['networkPerformanceConfig']),
      params: Input.asOptionalInput<InstanceParams2>(map['params']),
      postKeyRevocationActionType:
          Input.asOptionalInput<InstancePostKeyRevocationActionType2>(
              map['postKeyRevocationActionType']),
      privateIpv6GoogleAccess:
          Input.asOptionalInput<InstancePrivateIpv6GoogleAccess2>(
              map['privateIpv6GoogleAccess']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      reservationAffinity: Input.asOptionalInput<ReservationAffinity2>(
          map['reservationAffinity']),
      resourcePolicies:
          Input.asOptionalInput<List<String>>(map['resourcePolicies']),
      scheduling: Input.asOptionalInput<Scheduling2>(map['scheduling']),
      serviceAccounts:
          Input.asOptionalInput<List<ServiceAccount4>>(map['serviceAccounts']),
      shieldedInstanceConfig: Input.asOptionalInput<ShieldedInstanceConfig2>(
          map['shieldedInstanceConfig']),
      shieldedInstanceIntegrityPolicy:
          Input.asOptionalInput<ShieldedInstanceIntegrityPolicy2>(
              map['shieldedInstanceIntegrityPolicy']),
      shieldedVmConfig:
          Input.asOptionalInput<ShieldedVmConfig2>(map['shieldedVmConfig']),
      shieldedVmIntegrityPolicy:
          Input.asOptionalInput<ShieldedVmIntegrityPolicy2>(
      ...
      tags: Input.asOptionalInput<Tags2>(map['tags']),
