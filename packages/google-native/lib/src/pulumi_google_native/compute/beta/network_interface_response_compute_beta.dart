...
import 'access_config_response_compute_beta.dart';
import 'alias_ip_range_response_compute_beta.dart';

/// A network interface resource attached to an instance.
class NetworkInterfaceResponseComputeBeta {
  /// An array of configurations for this interface. Currently, only one access config, ONE_TO_ONE_NAT, is supported. If there are no accessConfigs specified, then this instance will have no external internet access.
  final List<AccessConfigResponseComputeBeta> accessConfigs;

  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final List<AliasIpRangeResponseComputeBeta> aliasIpRanges;
  ...
  final List<AccessConfigResponseComputeBeta> ipv6AccessConfigs;
  ...
  factory NetworkInterfaceResponseComputeBeta.fromMap(
      Map<String, dynamic> map) {
    return NetworkInterfaceResponseComputeBeta(
      accessConfigs: pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(
          map['accessConfigs'],
          (value) => AccessConfigResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
      aliasIpRanges: pulumi.Input.decodeList<AliasIpRangeResponseComputeBeta>(
          map['aliasIpRanges'],
          (value) => AliasIpRangeResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
      fingerprint: map['fingerprint'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs:
          pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(
