...
class ResourcePolicyIamBindingComputeBetaArgs {
  ...
  ResourcePolicyIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory ResourcePolicyIamBindingComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicyIamBindingComputeBetaArgs(
