...
class GetGlobalForwardingRuleResult2 {
  ...
  final List<ForwardingRuleServiceDirectoryRegistrationResponse2>
  ...
  GetGlobalForwardingRuleResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['serviceDirectoryRegistrations'] = Input.encodeList<
            ForwardingRuleServiceDirectoryRegistrationResponse2,
            Map<String, dynamic>>(
  ...
  factory GetGlobalForwardingRuleResult2.fromMap(Map<String, dynamic> map) {
    return GetGlobalForwardingRuleResult2(
      ...
      serviceDirectoryRegistrations:
          Input.decodeList<ForwardingRuleServiceDirectoryRegistrationResponse2>(
              map['serviceDirectoryRegistrations'],
              (value) =>
                  ForwardingRuleServiceDirectoryRegistrationResponse2.fromMap(
                      (value as Map).cast<String, dynamic>())),
