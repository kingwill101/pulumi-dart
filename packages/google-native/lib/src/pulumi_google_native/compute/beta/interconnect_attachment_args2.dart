...
import 'interconnect_attachment_bandwidth2.dart';
import 'interconnect_attachment_edge_availability_domain2.dart';
import 'interconnect_attachment_encryption2.dart';
import 'interconnect_attachment_partner_metadata2.dart';
import 'interconnect_attachment_stack_type2.dart';
import 'interconnect_attachment_type2.dart';
...
class InterconnectAttachmentArgs2 {
  ...
  final Input<InterconnectAttachmentBandwidth2>? bandwidth;
  ...
  final Input<InterconnectAttachmentEdgeAvailabilityDomain2>?
  ...
  final Input<InterconnectAttachmentEncryption2>? encryption;
  ...
  final Input<InterconnectAttachmentPartnerMetadata2>? partnerMetadata;
  ...
  final Input<InterconnectAttachmentStackType2>? stackType;
  ...
  final Input<InterconnectAttachmentType2>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bandwidthValue != null) {
      map['bandwidth'] =
          Input.mapOptionalInputValue<InterconnectAttachmentBandwidth2, String>(
    ...
    if (edgeAvailabilityDomainValue != null) {
      map['edgeAvailabilityDomain'] = Input.mapOptionalInputValue<
          InterconnectAttachmentEdgeAvailabilityDomain2,
    ...
    if (encryptionValue != null) {
      map['encryption'] = Input.mapOptionalInputValue<
          InterconnectAttachmentEncryption2,
    ...
    if (partnerMetadataValue != null) {
      map['partnerMetadata'] = Input.mapOptionalInputValue<
          InterconnectAttachmentPartnerMetadata2,
    ...
    if (stackTypeValue != null) {
      map['stackType'] =
          Input.mapOptionalInputValue<InterconnectAttachmentStackType2, String>(
    ...
    if (typeValue != null) {
      map['type'] =
          Input.mapOptionalInputValue<InterconnectAttachmentType2, String>(
  ...
  factory InterconnectAttachmentArgs2.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs2(
      ...
      bandwidth: Input.asOptionalInput<InterconnectAttachmentBandwidth2>(
          map['bandwidth']),
      ...
      edgeAvailabilityDomain:
          Input.asOptionalInput<InterconnectAttachmentEdgeAvailabilityDomain2>(
              map['edgeAvailabilityDomain']),
      encryption: Input.asOptionalInput<InterconnectAttachmentEncryption2>(
          map['encryption']),
      ...
      partnerMetadata:
          Input.asOptionalInput<InterconnectAttachmentPartnerMetadata2>(
              map['partnerMetadata']),
      project: Input.asOptionalInput<String>(map['project']),
      region: Input.asInput<String>(map['region']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      router: Input.asOptionalInput<String>(map['router']),
      stackType: Input.asOptionalInput<InterconnectAttachmentStackType2>(
          map['stackType']),
      subnetLength: Input.asOptionalInput<int>(map['subnetLength']),
      type: Input.asOptionalInput<InterconnectAttachmentType2>(map['type']),
