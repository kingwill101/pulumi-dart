...
import 'network_endpoint_group_cloud_run_response2.dart';
import 'network_endpoint_group_lb_network_endpoint_group_response2.dart';
import 'network_endpoint_group_psc_data_response2.dart';
import 'network_endpoint_group_serverless_deployment_response2.dart';

/// Result data returned by getGlobalNetworkEndpointGroup.
class GetGlobalNetworkEndpointGroupResult2 {
  /// Metadata defined as annotations on the network endpoint group.
  final Map<String, String> annotations;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  final NetworkEndpointGroupAppEngineResponse2 appEngine;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  final NetworkEndpointGroupCloudFunctionResponse2 cloudFunction;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  final NetworkEndpointGroupCloudRunResponse2 cloudRun;
  ...
  final NetworkEndpointGroupLbNetworkEndpointGroupResponse2 loadBalancer;
  ...
  final NetworkEndpointGroupPscDataResponse2 pscData;
  ...
  final NetworkEndpointGroupServerlessDeploymentResponse2 serverlessDeployment;
  ...
  GetGlobalNetworkEndpointGroupResult2({
  ...
  factory GetGlobalNetworkEndpointGroupResult2.fromMap(
      Map<String, dynamic> map) {
    return GetGlobalNetworkEndpointGroupResult2(
      annotations: (map['annotations'] as Map).cast<String, String>(),
      appEngine: NetworkEndpointGroupAppEngineResponse2.fromMap(
          (map['appEngine'] as Map).cast<String, dynamic>()),
      cloudFunction: NetworkEndpointGroupCloudFunctionResponse2.fromMap(
          (map['cloudFunction'] as Map).cast<String, dynamic>()),
      cloudRun: NetworkEndpointGroupCloudRunResponse2.fromMap(
          (map['cloudRun'] as Map).cast<String, dynamic>()),
      creationTimestamp: map['creationTimestamp'] as String,
      defaultPort: map['defaultPort'] as int,
      description: map['description'] as String,
      kind: map['kind'] as String,
      loadBalancer: NetworkEndpointGroupLbNetworkEndpointGroupResponse2.fromMap(
          (map['loadBalancer'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: map['network'] as String,
      networkEndpointType: map['networkEndpointType'] as String,
      pscData: NetworkEndpointGroupPscDataResponse2.fromMap(
          (map['pscData'] as Map).cast<String, dynamic>()),
      pscTargetService: map['pscTargetService'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      serverlessDeployment:
          NetworkEndpointGroupServerlessDeploymentResponse2.fromMap(
