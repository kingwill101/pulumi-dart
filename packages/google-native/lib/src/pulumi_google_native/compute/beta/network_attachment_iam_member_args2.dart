...
class NetworkAttachmentIamMemberArgs2 {
  ...
  NetworkAttachmentIamMemberArgs2({
    this.condition,
  ...
  factory NetworkAttachmentIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamMemberArgs2(
