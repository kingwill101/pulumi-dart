...
class GetDiskComputeBetaResult {
  ...
  factory GetDiskComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetDiskComputeBetaResult(
      ...
      asyncPrimaryDisk: DiskAsyncReplicationResponseComputeBeta.fromMap(
      ...
      params: DiskParamsResponseComputeBeta.fromMap(
      ...
      resourceStatus: DiskResourceStatusResponseComputeBeta.fromMap(
