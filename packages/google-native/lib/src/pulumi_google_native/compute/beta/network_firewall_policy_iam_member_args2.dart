...
class NetworkFirewallPolicyIamMemberArgs2 {
  ...
  NetworkFirewallPolicyIamMemberArgs2({
    this.condition,
  ...
  factory NetworkFirewallPolicyIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamMemberArgs2(
