...
class GetPublicAdvertisedPrefixResult2 {
  ...
  final List<PublicAdvertisedPrefixPublicDelegatedPrefixResponse2>
  ...
  GetPublicAdvertisedPrefixResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['publicDelegatedPrefixs'] = Input.encodeList<
        PublicAdvertisedPrefixPublicDelegatedPrefixResponse2,
  ...
  factory GetPublicAdvertisedPrefixResult2.fromMap(Map<String, dynamic> map) {
    return GetPublicAdvertisedPrefixResult2(
      ...
      publicDelegatedPrefixs: Input.decodeList<
          ...
          (value) =>
              PublicAdvertisedPrefixPublicDelegatedPrefixResponse2.fromMap(
