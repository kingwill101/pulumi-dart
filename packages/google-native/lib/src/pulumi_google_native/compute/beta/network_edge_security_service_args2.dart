...
class NetworkEdgeSecurityServiceArgs2 {
  ...
  NetworkEdgeSecurityServiceArgs2({
    this.description,
    this.name,
    this.project,
  ...
  factory NetworkEdgeSecurityServiceArgs2.fromMap(Map<String, dynamic> map) {
    return NetworkEdgeSecurityServiceArgs2(
