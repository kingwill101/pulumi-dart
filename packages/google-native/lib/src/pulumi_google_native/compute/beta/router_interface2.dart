...
import 'router_interface_ip_version2.dart';

class RouterInterface2 {
  /// IP address and range of the interface. The IP range must be in the RFC3927 link-local IP address space. The value must be a CIDR-formatted string, for example: 169.254.0.1/30. NOTE: Do not truncate the address as it represents the IP address of the interface.
  final String? ipRange;

  /// IP version of this interface.
  final RouterInterfaceIpVersion2? ipVersion;
  ...
  factory RouterInterface2.fromMap(Map<String, dynamic> map) {
    return RouterInterface2(
      ipRange: map['ipRange'] == null ? null : map['ipRange'] as String,
      ipVersion: map['ipVersion'] == null
          ? null
          : RouterInterfaceIpVersion2.fromValue(map['ipVersion'] as String),
