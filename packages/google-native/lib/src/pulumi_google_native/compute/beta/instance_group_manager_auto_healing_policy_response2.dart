...
class InstanceGroupManagerAutoHealingPolicyResponse2 {
  ...
  factory InstanceGroupManagerAutoHealingPolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicyResponse2(
