...
import 'interconnect_attachment_configuration_constraints_bgp_peer_asnrange_response2.dart';

class InterconnectAttachmentConfigurationConstraintsResponse2 {
  ...
  InterconnectAttachmentConfigurationConstraintsResponse2({
  ...
  factory InterconnectAttachmentConfigurationConstraintsResponse2.fromMap(
      Map<String, dynamic> map) {
    return InterconnectAttachmentConfigurationConstraintsResponse2(
