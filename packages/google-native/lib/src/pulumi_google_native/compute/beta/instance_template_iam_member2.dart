...
import 'instance_template_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class InstanceTemplateIamMember2 extends CustomResource {
  ...
  InstanceTemplateIamMember2(
    String name, {
    InstanceTemplateIamMemberArgs2? args,
