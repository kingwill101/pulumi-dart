...
import 'backend_bucket_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class BackendBucketIamBinding2 extends CustomResource {
  ...
  BackendBucketIamBinding2(
    String name, {
    BackendBucketIamBindingArgs2? args,
