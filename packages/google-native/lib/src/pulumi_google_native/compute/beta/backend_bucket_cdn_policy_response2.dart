...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header_response2.dart';
import 'backend_bucket_cdn_policy_cache_key_policy_response2.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy_response2.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicyResponse2 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse2>
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final BackendBucketCdnPolicyCacheKeyPolicyResponse2 cacheKeyPolicy;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyResponse2>
  ...
  BackendBucketCdnPolicyResponse2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bypassCacheOnRequestHeaders'] = Input.encodeList<
            BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse2,
            Map<String, dynamic>>(
  ...
  factory BackendBucketCdnPolicyResponse2.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponse2(
      bypassCacheOnRequestHeaders: Input.decodeList<
              BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse2>(
          map['bypassCacheOnRequestHeaders'],
          (value) =>
              BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: BackendBucketCdnPolicyCacheKeyPolicyResponse2.fromMap(
      ...
      negativeCachingPolicy: Input.decodeList<
          ...
          (value) =>
              BackendBucketCdnPolicyNegativeCachingPolicyResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
