...
import 'firewall_policy_rule_direction2.dart';
import 'firewall_policy_rule_matcher2.dart';
import 'firewall_policy_rule_secure_tag2.dart';

/// Represents a rule that describes one or more match conditions along with the action to be taken when traffic matches this condition (allow or deny).
class FirewallPolicyRule2 {
  ...
  final FirewallPolicyRuleDirection2? direction;
  ...
  final FirewallPolicyRuleMatcher2? match;
  ...
  final List<FirewallPolicyRuleSecureTag2>? targetSecureTags;
  ...
  factory FirewallPolicyRule2.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRule2(
      action: map['action'] == null ? null : map['action'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      direction: map['direction'] == null
          ? null
          : FirewallPolicyRuleDirection2.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      enableLogging:
          map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      match: map['match'] == null
          ? null
          : FirewallPolicyRuleMatcher2.fromMap(
