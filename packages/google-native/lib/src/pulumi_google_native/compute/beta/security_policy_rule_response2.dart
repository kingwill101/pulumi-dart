...
import 'security_policy_rule_http_header_action_response2.dart';
import 'security_policy_rule_matcher_response2.dart';
import 'security_policy_rule_network_matcher_response2.dart';
import 'security_policy_rule_preconfigured_waf_config_response2.dart';
import 'security_policy_rule_rate_limit_options_response2.dart';
import 'security_policy_rule_redirect_options_response2.dart';

/// Represents a rule that describes one or more match conditions along with the action to be taken when traffic matches this condition (allow or deny).
class SecurityPolicyRuleResponse2 {
  ...
  final SecurityPolicyRuleHttpHeaderActionResponse2 headerAction;

  /// [Output only] Type of the resource. Always compute#securityPolicyRule for security policy rules
  final String kind;

  /// A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
  final SecurityPolicyRuleMatcherResponse2 match;
  ...
  final SecurityPolicyRuleNetworkMatcherResponse2 networkMatch;

  /// Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  final SecurityPolicyRulePreconfiguredWafConfigResponse2
  ...
  final SecurityPolicyRuleRateLimitOptionsResponse2 rateLimitOptions;

  /// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final SecurityPolicyRuleRedirectOptionsResponse2 redirectOptions;
  ...
  factory SecurityPolicyRuleResponse2.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponse2(
      action: map['action'] as String,
      description: map['description'] as String,
      direction: map['direction'] as String,
      enableLogging: map['enableLogging'] as bool,
      headerAction: SecurityPolicyRuleHttpHeaderActionResponse2.fromMap(
          (map['headerAction'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      match: SecurityPolicyRuleMatcherResponse2.fromMap(
          (map['match'] as Map).cast<String, dynamic>()),
      networkMatch: SecurityPolicyRuleNetworkMatcherResponse2.fromMap(
          (map['networkMatch'] as Map).cast<String, dynamic>()),
      preconfiguredWafConfig:
          SecurityPolicyRulePreconfiguredWafConfigResponse2.fromMap(
              (map['preconfiguredWafConfig'] as Map).cast<String, dynamic>()),
      preview: map['preview'] as bool,
      priority: map['priority'] as int,
      rateLimitOptions: SecurityPolicyRuleRateLimitOptionsResponse2.fromMap(
          (map['rateLimitOptions'] as Map).cast<String, dynamic>()),
      redirectOptions: SecurityPolicyRuleRedirectOptionsResponse2.fromMap(
