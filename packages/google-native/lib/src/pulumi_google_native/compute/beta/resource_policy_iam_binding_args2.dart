...
class ResourcePolicyIamBindingArgs2 {
  ...
  factory ResourcePolicyIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamBindingArgs2(
