...
class RouterNatComputeBeta {
  ...
  final RouterNatSourceSubnetworkIpRangesToNatComputeBeta?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (endpointTypesValue != null) {
      map['endpointTypes'] = pulumi.Input.encodeList<
          RouterNatEndpointTypesItemComputeBeta,
          String>(endpointTypesValue, (value) => value.value);
    }
    ...
    if (rulesValue != null) {
      map['rules'] = pulumi.Input.encodeList<RouterNatRuleComputeBeta,
  ...
  factory RouterNatComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatComputeBeta(
      autoNetworkTier: map['autoNetworkTier'] == null
          ? null
          : RouterNatAutoNetworkTierComputeBeta.fromValue(
      ...
      type: map['type'] == null
          ? null
          : RouterNatTypeComputeBeta.fromValue(map['type'] as String),
