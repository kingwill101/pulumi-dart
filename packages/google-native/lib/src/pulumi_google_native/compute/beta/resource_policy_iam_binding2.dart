...
import 'resource_policy_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class ResourcePolicyIamBinding2 extends CustomResource {
  ...
  ResourcePolicyIamBinding2(
    String name, {
    ResourcePolicyIamBindingArgs2? args,
