...
import 'service_attachment_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class ServiceAttachmentIamBinding2 extends CustomResource {
  ...
  ServiceAttachmentIamBinding2(
    String name, {
    ServiceAttachmentIamBindingArgs2? args,
