...
class InstanceTemplateIamBindingArgs2 {
  ...
  InstanceTemplateIamBindingArgs2({
    this.condition,
  ...
  factory InstanceTemplateIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateIamBindingArgs2(
