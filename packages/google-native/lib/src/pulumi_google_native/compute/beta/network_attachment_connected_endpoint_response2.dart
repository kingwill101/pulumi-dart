...
class NetworkAttachmentConnectedEndpointResponse2 {
  ...
  factory NetworkAttachmentConnectedEndpointResponse2.fromMap(
      Map<String, dynamic> map) {
    return NetworkAttachmentConnectedEndpointResponse2(
