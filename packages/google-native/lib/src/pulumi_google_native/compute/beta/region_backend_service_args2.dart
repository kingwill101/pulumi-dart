...
import 'backend2.dart';
import 'backend_service_cdn_policy2.dart';
import 'backend_service_connection_tracking_policy2.dart';
import 'backend_service_failover_policy2.dart';
import 'backend_service_iap2.dart';
import 'backend_service_locality_load_balancing_policy_config2.dart';
import 'backend_service_log_config2.dart';
import 'backend_service_used_by2.dart';
import 'circuit_breakers2.dart';
import 'connection_draining2.dart';
import 'consistent_hash_load_balancer_settings2.dart';
import 'duration2.dart';
import 'outlier_detection2.dart';
import 'region_backend_service_compression_mode2.dart';
import 'region_backend_service_ip_address_selection_policy2.dart';
import 'region_backend_service_load_balancing_scheme2.dart';
import 'region_backend_service_locality_lb_policy2.dart';
import 'region_backend_service_protocol2.dart';
import 'region_backend_service_session_affinity2.dart';
import 'security_settings2.dart';
import 'subsetting2.dart';

/// The set of arguments for RegionBackendService.
class RegionBackendServiceArgs2 {
  ...
  final Input<List<Backend2>>? backends;

  /// Cloud CDN configuration for this BackendService. Only available for specified load balancer types.
  final Input<BackendServiceCdnPolicy2>? cdnPolicy;
  final Input<CircuitBreakers2>? circuitBreakers;

  /// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
  final Input<RegionBackendServiceCompressionMode2>? compressionMode;
  final Input<ConnectionDraining2>? connectionDraining;

  /// Connection Tracking configuration for this BackendService. Connection tracking policy settings are only available for Network Load Balancing and Internal TCP/UDP Load Balancing.
  final Input<BackendServiceConnectionTrackingPolicy2>?
  ...
  final Input<ConsistentHashLoadBalancerSettings2>? consistentHash;
  ...
  final Input<BackendServiceFailoverPolicy2>? failoverPolicy;
  ...
  final Input<BackendServiceIAP2>? iap;
  ...
  final Input<RegionBackendServiceIpAddressSelectionPolicy2>?
      ipAddressSelectionPolicy;

  /// Specifies the load balancer type. A backend service created for one type of load balancer cannot be used with another. For more information, refer to Choosing a load balancer.
  final Input<RegionBackendServiceLoadBalancingScheme2>? loadBalancingScheme;

  /// A list of locality load-balancing policies to be used in order of preference. When you use localityLbPolicies, you must set at least one value for either the localityLbPolicies[].policy or the localityLbPolicies[].customPolicy field. localityLbPolicies overrides any value set in the localityLbPolicy field. For an example of how to use this field, see Define a list of preferred policies. Caution: This field and its children are intended for use in a service mesh that includes gRPC clients only. Envoy proxies can't use backend services that have this configuration.
  final Input<List<BackendServiceLocalityLoadBalancingPolicyConfig2>>?
      localityLbPolicies;
  ...
  final Input<RegionBackendServiceLocalityLbPolicy2>? localityLbPolicy;

  /// This field denotes the logging options for the load balancer traffic served by this backend service. If logging is enabled, logs will be exported to Stackdriver.
  final Input<BackendServiceLogConfig2>? logConfig;

  /// Specifies the default maximum duration (timeout) for streams to this service. Duration is computed from the beginning of the stream until the response has been completely processed, including all retries. A stream that does not complete in this duration is closed. If not specified, there will be no timeout limit, i.e. the maximum duration is infinite. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. This field is only allowed when the loadBalancingScheme of the backend service is INTERNAL_SELF_MANAGED.
  final Input<Duration2>? maxStreamDuration;
  ...
  final Input<OutlierDetection2>? outlierDetection;
  ...
  final Input<RegionBackendServiceProtocol2>? protocol;
  ...
  final Input<SecuritySettings2>? securitySettings;
  ...
  final Input<RegionBackendServiceSessionAffinity2>? sessionAffinity;
  final Input<Subsetting2>? subsetting;
  ...
  final Input<List<BackendServiceUsedBy2>>? usedBy;

  RegionBackendServiceArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (backendsValue != null) {
      map['backends'] = Input.mapOptionalInputValue<List<Backend2>,
              List<Map<String, dynamic>>>(
          backendsValue,
          (value) => Input.encodeList<Backend2, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final cdnPolicyValue = cdnPolicy;
    if (cdnPolicyValue != null) {
      map['cdnPolicy'] = Input.mapOptionalInputValue<BackendServiceCdnPolicy2,
    ...
    if (circuitBreakersValue != null) {
      map['circuitBreakers'] =
          Input.mapOptionalInputValue<CircuitBreakers2, Map<String, dynamic>>(
    ...
    if (compressionModeValue != null) {
      map['compressionMode'] = Input.mapOptionalInputValue<
          RegionBackendServiceCompressionMode2,
    ...
    if (connectionDrainingValue != null) {
      map['connectionDraining'] = Input.mapOptionalInputValue<
              ConnectionDraining2, Map<String, dynamic>>(
    ...
    if (connectionTrackingPolicyValue != null) {
      map['connectionTrackingPolicy'] = Input.mapOptionalInputValue<
              BackendServiceConnectionTrackingPolicy2, Map<String, dynamic>>(
    ...
    if (consistentHashValue != null) {
      map['consistentHash'] = Input.mapOptionalInputValue<
          ConsistentHashLoadBalancerSettings2,
    ...
    if (iapValue != null) {
      map['iap'] =
          Input.mapOptionalInputValue<BackendServiceIAP2, Map<String, dynamic>>(
    ...
    if (ipAddressSelectionPolicyValue != null) {
      map['ipAddressSelectionPolicy'] = Input.mapOptionalInputValue<
          RegionBackendServiceIpAddressSelectionPolicy2,
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = Input.mapOptionalInputValue<
          RegionBackendServiceLoadBalancingScheme2,
    ...
    if (localityLbPoliciesValue != null) {
      map['localityLbPolicies'] = Input.mapOptionalInputValue<
              List<BackendServiceLocalityLoadBalancingPolicyConfig2>,
              List<Map<String, dynamic>>>(
    ...
    if (localityLbPolicyValue != null) {
      map['localityLbPolicy'] = Input.mapOptionalInputValue<
          RegionBackendServiceLocalityLbPolicy2,
          String>(localityLbPolicyValue, (value) => value.value);
    }
    final logConfigValue = logConfig;
    if (logConfigValue != null) {
      map['logConfig'] = Input.mapOptionalInputValue<BackendServiceLogConfig2,
    ...
    if (outlierDetectionValue != null) {
      map['outlierDetection'] =
          Input.mapOptionalInputValue<OutlierDetection2, Map<String, dynamic>>(
    ...
    if (protocolValue != null) {
      map['protocol'] =
          Input.mapOptionalInputValue<RegionBackendServiceProtocol2, String>(
    ...
    if (securitySettingsValue != null) {
      map['securitySettings'] =
          Input.mapOptionalInputValue<SecuritySettings2, Map<String, dynamic>>(
    ...
    if (usedByValue != null) {
      map['usedBy'] = Input.mapOptionalInputValue<List<BackendServiceUsedBy2>,
              List<Map<String, dynamic>>>(
          usedByValue,
          (value) =>
              Input.encodeList<BackendServiceUsedBy2, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    return map;
  }

  factory RegionBackendServiceArgs2.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs2(
      affinityCookieTtlSec:
          Input.asOptionalInput<int>(map['affinityCookieTtlSec']),
      backends: Input.asOptionalInput<List<Backend2>>(map['backends']),
      cdnPolicy:
          Input.asOptionalInput<BackendServiceCdnPolicy2>(map['cdnPolicy']),
      circuitBreakers:
          Input.asOptionalInput<CircuitBreakers2>(map['circuitBreakers']),
      compressionMode:
          Input.asOptionalInput<RegionBackendServiceCompressionMode2>(
              map['compressionMode']),
      connectionDraining:
          Input.asOptionalInput<ConnectionDraining2>(map['connectionDraining']),
      connectionTrackingPolicy:
          Input.asOptionalInput<BackendServiceConnectionTrackingPolicy2>(
              map['connectionTrackingPolicy']),
      consistentHash:
          Input.asOptionalInput<ConsistentHashLoadBalancerSettings2>(
              map['consistentHash']),
      ...
      failoverPolicy: Input.asOptionalInput<BackendServiceFailoverPolicy2>(
          map['failoverPolicy']),
      healthChecks: Input.asOptionalInput<List<String>>(map['healthChecks']),
      iap: Input.asOptionalInput<BackendServiceIAP2>(map['iap']),
      ipAddressSelectionPolicy:
          Input.asOptionalInput<RegionBackendServiceIpAddressSelectionPolicy2>(
              map['ipAddressSelectionPolicy']),
      loadBalancingScheme:
          Input.asOptionalInput<RegionBackendServiceLoadBalancingScheme2>(
              map['loadBalancingScheme']),
      localityLbPolicies: Input.asOptionalInput<
              List<BackendServiceLocalityLoadBalancingPolicyConfig2>>(
          map['localityLbPolicies']),
      localityLbPolicy:
          Input.asOptionalInput<RegionBackendServiceLocalityLbPolicy2>(
              map['localityLbPolicy']),
      logConfig:
          Input.asOptionalInput<BackendServiceLogConfig2>(map['logConfig']),
      maxStreamDuration:
          Input.asOptionalInput<Duration2>(map['maxStreamDuration']),
      metadatas: Input.asOptionalInput<Map<String, String>>(map['metadatas']),
      name: Input.asOptionalInput<String>(map['name']),
      network: Input.asOptionalInput<String>(map['network']),
      outlierDetection:
          Input.asOptionalInput<OutlierDetection2>(map['outlierDetection']),
      port: Input.asOptionalInput<int>(map['port']),
      portName: Input.asOptionalInput<String>(map['portName']),
      project: Input.asOptionalInput<String>(map['project']),
      protocol:
          Input.asOptionalInput<RegionBackendServiceProtocol2>(map['protocol']),
      region: Input.asInput<String>(map['region']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      securitySettings:
          Input.asOptionalInput<SecuritySettings2>(map['securitySettings']),
      serviceBindings:
          Input.asOptionalInput<List<String>>(map['serviceBindings']),
      serviceLbPolicy: Input.asOptionalInput<String>(map['serviceLbPolicy']),
      sessionAffinity:
          Input.asOptionalInput<RegionBackendServiceSessionAffinity2>(
              map['sessionAffinity']),
      subsetting: Input.asOptionalInput<Subsetting2>(map['subsetting']),
      timeoutSec: Input.asOptionalInput<int>(map['timeoutSec']),
      usedBy: Input.asOptionalInput<List<BackendServiceUsedBy2>>(map['usedBy']),
    );
  }
}
