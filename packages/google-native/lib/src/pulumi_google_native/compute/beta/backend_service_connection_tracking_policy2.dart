...
import 'backend_service_connection_tracking_policy_connection_persistence_on_unhealthy_backends2.dart';
import 'backend_service_connection_tracking_policy_tracking_mode2.dart';

/// Connection Tracking configuration for this BackendService.
class BackendServiceConnectionTrackingPolicy2 {
  ...
  final BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends2?
  ...
  final BackendServiceConnectionTrackingPolicyTrackingMode2? trackingMode;

  BackendServiceConnectionTrackingPolicy2({
  ...
  factory BackendServiceConnectionTrackingPolicy2.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicy2(
      connectionPersistenceOnUnhealthyBackends: map[
                  'connectionPersistenceOnUnhealthyBackends'] ==
              null
          ? null
          : BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends2
              .fromValue(
      ...
      trackingMode: map['trackingMode'] == null
          ? null
          : BackendServiceConnectionTrackingPolicyTrackingMode2.fromValue(
