...
import 'region_target_https_proxy_args2.dart';

/// Creates a TargetHttpsProxy resource in the specified project and region using the data included in the request.
class RegionTargetHttpsProxy2 extends CustomResource {
  ...
  RegionTargetHttpsProxy2(
    String name, {
    RegionTargetHttpsProxyArgs2? args,
    ...
    this.httpFilters = Output.createUnknown<List<String>>();
