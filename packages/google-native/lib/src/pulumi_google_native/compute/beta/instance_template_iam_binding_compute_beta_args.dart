...
class InstanceTemplateIamBindingComputeBetaArgs {
  ...
  InstanceTemplateIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory InstanceTemplateIamBindingComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return InstanceTemplateIamBindingComputeBetaArgs(
