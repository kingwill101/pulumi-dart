...
class ServiceAttachmentConsumerProjectLimitResponse2 {
  ...
  factory ServiceAttachmentConsumerProjectLimitResponse2.fromMap(
      Map<String, dynamic> map) {
    return ServiceAttachmentConsumerProjectLimitResponse2(
