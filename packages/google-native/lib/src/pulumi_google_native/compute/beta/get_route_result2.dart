...
import 'route_as_path_response2.dart';
import 'route_warnings_item_response2.dart';

/// Result data returned by getRoute.
class GetRouteResult2 {
  /// AS path.
  final List<RouteAsPathResponse2> asPaths;
  ...
  final List<RouteWarningsItemResponse2> warnings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['asPaths'] =
        Input.encodeList<RouteAsPathResponse2, Map<String, dynamic>>(
    ...
    map['tags'] = tags;
    map['warnings'] =
        Input.encodeList<RouteWarningsItemResponse2, Map<String, dynamic>>(
  ...
  factory GetRouteResult2.fromMap(Map<String, dynamic> map) {
    return GetRouteResult2(
      asPaths: Input.decodeList<RouteAsPathResponse2>(
          map['asPaths'],
          (value) => RouteAsPathResponse2.fromMap(
      ...
      warnings: Input.decodeList<RouteWarningsItemResponse2>(
          map['warnings'],
          (value) => RouteWarningsItemResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
