...
import 'backend_service_cdn_policy_bypass_cache_on_request_header2.dart';
import 'backend_service_cdn_policy_cache_mode2.dart';
import 'backend_service_cdn_policy_negative_caching_policy2.dart';
import 'cache_key_policy2.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicy2 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeader2>?
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final CacheKeyPolicy2? cacheKeyPolicy;
  ...
  final BackendServiceCdnPolicyCacheMode2? cacheMode;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicy2>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bypassCacheOnRequestHeadersValue != null) {
      map['bypassCacheOnRequestHeaders'] = Input.encodeList<
              BackendServiceCdnPolicyBypassCacheOnRequestHeader2,
              Map<String, dynamic>>(
    ...
    if (negativeCachingPolicyValue != null) {
      map['negativeCachingPolicy'] = Input.encodeList<
              BackendServiceCdnPolicyNegativeCachingPolicy2,
              Map<String, dynamic>>(
  ...
  factory BackendServiceCdnPolicy2.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicy2(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null
          ...
          : Input.decodeList<
              ...
              (value) =>
                  BackendServiceCdnPolicyBypassCacheOnRequestHeader2.fromMap(
                      (value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null
          ? null
          : CacheKeyPolicy2.fromMap(
              (map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null
          ? null
          : BackendServiceCdnPolicyCacheMode2.fromValue(
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null
          ? null
          : Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicy2>(
              map['negativeCachingPolicy'],
              (value) => BackendServiceCdnPolicyNegativeCachingPolicy2.fromMap(
                  (value as Map).cast<String, dynamic>())),
