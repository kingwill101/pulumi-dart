...
class OutlierDetectionResponse2 {
  ...
  final DurationResponse2 baseEjectionTime;
  ...
  final DurationResponse2 interval;
  ...
  factory OutlierDetectionResponse2.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponse2(
      baseEjectionTime: DurationResponse2.fromMap(
      ...
      interval: DurationResponse2.fromMap(
