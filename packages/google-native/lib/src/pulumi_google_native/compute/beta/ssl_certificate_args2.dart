...
import 'ssl_certificate_type2.dart';

/// The set of arguments for SslCertificate.
class SslCertificateArgs2 {
  ...
  final Input<SslCertificateType2>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<SslCertificateType2, String>(
          typeValue, (value) => value.value);
    }
    return map;
  }

  factory SslCertificateArgs2.fromMap(Map<String, dynamic> map) {
    return SslCertificateArgs2(
      ...
      selfManaged:
          Input.asOptionalInput<SslCertificateSelfManagedSslCertificate2>(
              map['selfManaged']),
      type: Input.asOptionalInput<SslCertificateType2>(map['type']),
    );
  }
}
