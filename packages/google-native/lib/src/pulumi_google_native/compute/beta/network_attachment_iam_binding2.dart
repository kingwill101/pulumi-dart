...
import 'network_attachment_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class NetworkAttachmentIamBinding2 extends CustomResource {
  ...
  NetworkAttachmentIamBinding2(
    String name, {
    NetworkAttachmentIamBindingArgs2? args,
