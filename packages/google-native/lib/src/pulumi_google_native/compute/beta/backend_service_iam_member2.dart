...
import 'backend_service_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class BackendServiceIamMember2 extends CustomResource {
  ...
  BackendServiceIamMember2(
    String name, {
    BackendServiceIamMemberArgs2? args,
