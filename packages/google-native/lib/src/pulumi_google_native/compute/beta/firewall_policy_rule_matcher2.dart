...
import 'firewall_policy_rule_matcher_layer4_config2.dart';
import 'firewall_policy_rule_secure_tag2.dart';

/// Represents a match condition that incoming traffic is evaluated against. Exactly one field must be specified.
class FirewallPolicyRuleMatcher2 {
  ...
  final List<FirewallPolicyRuleMatcherLayer4Config2>? layer4Configs;
  ...
  final List<FirewallPolicyRuleSecureTag2>? srcSecureTags;

  /// Names of Network Threat Intelligence lists. The IPs in these lists will be matched against traffic source.
  final List<String>? srcThreatIntelligences;

  FirewallPolicyRuleMatcher2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (layer4ConfigsValue != null) {
      map['layer4Configs'] = Input.encodeList<
          FirewallPolicyRuleMatcherLayer4Config2,
    ...
    if (srcSecureTagsValue != null) {
      map['srcSecureTags'] =
          Input.encodeList<FirewallPolicyRuleSecureTag2, Map<String, dynamic>>(
  ...
  factory FirewallPolicyRuleMatcher2.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcher2(
      ...
      layer4Configs: map['layer4Configs'] == null
          ? null
          : Input.decodeList<FirewallPolicyRuleMatcherLayer4Config2>(
              map['layer4Configs'],
              (value) => FirewallPolicyRuleMatcherLayer4Config2.fromMap(
      ...
      srcSecureTags: map['srcSecureTags'] == null
          ? null
          : Input.decodeList<FirewallPolicyRuleSecureTag2>(
              map['srcSecureTags'],
              (value) => FirewallPolicyRuleSecureTag2.fromMap(
                  (value as Map).cast<String, dynamic>())),
