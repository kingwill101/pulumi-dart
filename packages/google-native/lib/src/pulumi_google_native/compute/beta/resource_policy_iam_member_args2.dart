...
class ResourcePolicyIamMemberArgs2 {
  ...
  factory ResourcePolicyIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamMemberArgs2(
