...
import 'node_template_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class NodeTemplateIamBinding2 extends CustomResource {
  ...
  NodeTemplateIamBinding2(
    String name, {
    NodeTemplateIamBindingArgs2? args,
