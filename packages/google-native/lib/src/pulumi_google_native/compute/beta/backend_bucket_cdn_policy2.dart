...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header2.dart';
import 'backend_bucket_cdn_policy_cache_key_policy2.dart';
import 'backend_bucket_cdn_policy_cache_mode2.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy2.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicy2 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeader2>?
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final BackendBucketCdnPolicyCacheKeyPolicy2? cacheKeyPolicy;
  ...
  final BackendBucketCdnPolicyCacheMode2? cacheMode;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicy2>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (negativeCachingPolicyValue != null) {
      map['negativeCachingPolicy'] = Input.encodeList<
              BackendBucketCdnPolicyNegativeCachingPolicy2,
              Map<String, dynamic>>(
  ...
  factory BackendBucketCdnPolicy2.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicy2(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null
          ? null
          : Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeader2>(
              map['bypassCacheOnRequestHeaders'],
              (value) =>
                  BackendBucketCdnPolicyBypassCacheOnRequestHeader2.fromMap(
                      (value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null
          ? null
          : BackendBucketCdnPolicyCacheKeyPolicy2.fromMap(
              (map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null
          ? null
          : BackendBucketCdnPolicyCacheMode2.fromValue(
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null
          ? null
          : Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicy2>(
              map['negativeCachingPolicy'],
              (value) => BackendBucketCdnPolicyNegativeCachingPolicy2.fromMap(
                  (value as Map).cast<String, dynamic>())),
