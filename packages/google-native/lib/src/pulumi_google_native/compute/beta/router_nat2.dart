...
import 'router_nat_auto_network_tier2.dart';
import 'router_nat_endpoint_types_item2.dart';
import 'router_nat_log_config2.dart';
import 'router_nat_nat_ip_allocate_option2.dart';
import 'router_nat_rule2.dart';
import 'router_nat_source_subnetwork_ip_ranges_to_nat2.dart';
import 'router_nat_subnetwork_to_nat2.dart';
import 'router_nat_type2.dart';

/// Represents a Nat resource. It enables the VMs within the specified subnetworks to access Internet without external IP addresses. It specifies a list of subnetworks (and the ranges within) that want to use NAT. Customers can also provide the external IPs that would be used for NAT. GCP would auto-allocate ephemeral IPs if no external IPs are provided.
class RouterNat2 {
  /// The network tier to use when automatically reserving NAT IP addresses. Must be one of: PREMIUM, STANDARD. If not specified, then the current project-level default tier is used.
  final RouterNatAutoNetworkTier2? autoNetworkTier;
  ...
  final List<RouterNatEndpointTypesItem2>? endpointTypes;

  /// Timeout (in seconds) for ICMP connections. Defaults to 30s if not set.
  final int? icmpIdleTimeoutSec;

  /// Configure logging on this NAT.
  final RouterNatLogConfig2? logConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (endpointTypesValue != null) {
      map['endpointTypes'] =
          Input.encodeList<RouterNatEndpointTypesItem2, String>(
    ...
    if (rulesValue != null) {
      map['rules'] = Input.encodeList<RouterNatRule2, Map<String, dynamic>>(
    ...
    if (subnetworksValue != null) {
      map['subnetworks'] =
          Input.encodeList<RouterNatSubnetworkToNat2, Map<String, dynamic>>(
  ...
  factory RouterNat2.fromMap(Map<String, dynamic> map) {
    return RouterNat2(
      autoNetworkTier: map['autoNetworkTier'] == null
          ? null
          : RouterNatAutoNetworkTier2.fromValue(
      ...
      endpointTypes: map['endpointTypes'] == null
          ? null
          : Input.decodeList<RouterNatEndpointTypesItem2>(
              map['endpointTypes'],
              (value) =>
                  RouterNatEndpointTypesItem2.fromValue(value as String)),
      icmpIdleTimeoutSec: map['icmpIdleTimeoutSec'] == null
          ? null
          : map['icmpIdleTimeoutSec'] as int,
      logConfig: map['logConfig'] == null
          ? null
          : RouterNatLogConfig2.fromMap(
      ...
      natIpAllocateOption: map['natIpAllocateOption'] == null
          ? null
          : RouterNatNatIpAllocateOption2.fromValue(
              map['natIpAllocateOption'] as String),
      natIps:
          map['natIps'] == null ? null : (map['natIps'] as List).cast<String>(),
      rules: map['rules'] == null
          ? null
          : Input.decodeList<RouterNatRule2>(
              map['rules'],
              (value) => RouterNatRule2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat:
          map['sourceSubnetworkIpRangesToNat'] == null
              ? null
              : RouterNatSourceSubnetworkIpRangesToNat2.fromValue(
                  map['sourceSubnetworkIpRangesToNat'] as String),
      subnetworks: map['subnetworks'] == null
          ? null
          : Input.decodeList<RouterNatSubnetworkToNat2>(
              map['subnetworks'],
              (value) => RouterNatSubnetworkToNat2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null
          ? null
          : RouterNatType2.fromValue(map['type'] as String),
