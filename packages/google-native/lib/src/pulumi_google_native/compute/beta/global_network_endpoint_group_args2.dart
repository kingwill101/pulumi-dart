...
import 'global_network_endpoint_group_network_endpoint_type2.dart';
...
class GlobalNetworkEndpointGroupArgs2 {
  ...
  final Input<GlobalNetworkEndpointGroupNetworkEndpointType2>?
      networkEndpointType;
  ...
  GlobalNetworkEndpointGroupArgs2({
    this.annotations,
    this.appEngine,
    this.cloudFunction,
    this.cloudRun,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkEndpointTypeValue != null) {
      map['networkEndpointType'] = Input.mapOptionalInputValue<
          GlobalNetworkEndpointGroupNetworkEndpointType2,
  ...
  factory GlobalNetworkEndpointGroupArgs2.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupArgs2(
      annotations:
      ...
      networkEndpointType:
          Input.asOptionalInput<GlobalNetworkEndpointGroupNetworkEndpointType2>(
