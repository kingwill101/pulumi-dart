...
import 'network_firewall_policy_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class NetworkFirewallPolicyIamBinding2 extends CustomResource {
  ...
  NetworkFirewallPolicyIamBinding2(
    String name, {
    NetworkFirewallPolicyIamBindingArgs2? args,
