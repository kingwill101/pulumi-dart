...
class RegionHealthCheckArgs2 {
  ...
  final Input<RegionHealthCheckType2>? type;

  /// A so-far healthy instance will be marked unhealthy after this many consecutive failures. The default value is 2.
  final Input<int>? unhealthyThreshold;

  RegionHealthCheckArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<RegionHealthCheckType2, String>(
  ...
  factory RegionHealthCheckArgs2.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckArgs2(
      ...
      type: Input.asOptionalInput<RegionHealthCheckType2>(map['type']),
