...
class BackendBucketIamBindingArgs2 {
  ...
  factory BackendBucketIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamBindingArgs2(
