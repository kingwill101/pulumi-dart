...
import 'security_policy_args2.dart';
...
class SecurityPolicy2 extends CustomResource {
  late final Output<SecurityPolicyAdaptiveProtectionConfigResponse2>
      adaptiveProtectionConfig;
  late final Output<SecurityPolicyAdvancedOptionsConfigResponse2>
      advancedOptionsConfig;

  /// A list of associations that belong to this policy.
  late final Output<List<SecurityPolicyAssociationResponse2>> associations;

  /// Creation timestamp in RFC3339 text format.
  late final Output<String> creationTimestamp;
  late final Output<SecurityPolicyDdosProtectionConfigResponse2>
  ...
  late final Output<SecurityPolicyRecaptchaOptionsConfigResponse2>
  ...
  late final Output<List<SecurityPolicyRuleResponse2>> rules;
  ...
  late final Output<List<SecurityPolicyUserDefinedFieldResponse2>>
      userDefinedFields;

  SecurityPolicy2(
    String name, {
    SecurityPolicyArgs2? args,
