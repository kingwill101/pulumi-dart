...
import 'forwarding_rule_ip_protocol2.dart';
import 'forwarding_rule_ip_version2.dart';
import 'forwarding_rule_load_balancing_scheme2.dart';
import 'forwarding_rule_network_tier2.dart';
import 'forwarding_rule_psc_connection_status2.dart';
...
class ForwardingRuleArgs2 {
  ...
  final Input<ForwardingRuleIpProtocol2>? ipProtocol;

  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final Input<ForwardingRuleIpVersion2>? ipVersion;
  ...
  final Input<ForwardingRuleLoadBalancingScheme2>? loadBalancingScheme;
  ...
  final Input<ForwardingRuleNetworkTier2>? networkTier;
  ...
  final Input<ForwardingRulePscConnectionStatus2>? pscConnectionStatus;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] =
          Input.mapOptionalInputValue<ForwardingRuleIpProtocol2, String>(
              ipProtocolValue, (value) => value.value);
    }
    final ipVersionValue = ipVersion;
    if (ipVersionValue != null) {
      map['ipVersion'] =
          Input.mapOptionalInputValue<ForwardingRuleIpVersion2, String>(
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = Input.mapOptionalInputValue<
          ForwardingRuleLoadBalancingScheme2,
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          Input.mapOptionalInputValue<ForwardingRuleNetworkTier2, String>(
    ...
    if (pscConnectionStatusValue != null) {
      map['pscConnectionStatus'] = Input.mapOptionalInputValue<
          ForwardingRulePscConnectionStatus2,
  ...
  factory ForwardingRuleArgs2.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs2(
      ...
      ipProtocol:
          Input.asOptionalInput<ForwardingRuleIpProtocol2>(map['ipProtocol']),
      ipVersion:
          Input.asOptionalInput<ForwardingRuleIpVersion2>(map['ipVersion']),
      isMirroringCollector:
          Input.asOptionalInput<bool>(map['isMirroringCollector']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      loadBalancingScheme:
          Input.asOptionalInput<ForwardingRuleLoadBalancingScheme2>(
      ...
      networkTier:
          Input.asOptionalInput<ForwardingRuleNetworkTier2>(map['networkTier']),
      ...
      pscConnectionStatus:
          Input.asOptionalInput<ForwardingRulePscConnectionStatus2>(
