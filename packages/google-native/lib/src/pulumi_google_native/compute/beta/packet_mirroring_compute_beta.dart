...
class PacketMirroringComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<PacketMirroringForwardingRuleInfoResponseComputeBeta>
      collectorIlb;
  ...
  late final pulumi
      .Output<PacketMirroringMirroredResourceInfoResponseComputeBeta>
      mirroredResources;
  ...
  late final pulumi.Output<PacketMirroringNetworkInfoResponseComputeBeta>
      network;
  ...
  PacketMirroringComputeBeta(
    ...
    this.collectorIlb =
        registerOutput<PacketMirroringForwardingRuleInfoResponseComputeBeta>(
            'collectorIlb');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.description = registerOutput<String>('description');
    this.enable = registerOutput<String>('enable');
    this.filter =
        registerOutput<PacketMirroringFilterResponseComputeBeta>('filter');
    this.kind = registerOutput<String>('kind');
    this.mirroredResources =
        registerOutput<PacketMirroringMirroredResourceInfoResponseComputeBeta>(
            'mirroredResources');
    this.name = registerOutput<String>('name');
    this.network =
        registerOutput<PacketMirroringNetworkInfoResponseComputeBeta>(
            'network');
