...
class GetInstanceTemplateResult2 {
  ...
  final InstancePropertiesResponse2 properties;
  ...
  final SourceInstanceParamsResponse2 sourceInstanceParams;

  GetInstanceTemplateResult2({
  ...
  factory GetInstanceTemplateResult2.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateResult2(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      kind: map['kind'] as String,
      name: map['name'] as String,
      properties: InstancePropertiesResponse2.fromMap(
          (map['properties'] as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceParams: SourceInstanceParamsResponse2.fromMap(
