...
class SecurityPolicyRuleRateLimitOptionsResponse2 {
  /// Can only be specified if the action for the rule is "rate_based_ban". If specified, determines the time (in seconds) the traffic will continue to be banned by the rate limit after the rate falls below the threshold.
  final int banDurationSec;

  /// Can only be specified if the action for the rule is "rate_based_ban". If specified, the key will be banned for the configured 'ban_duration_sec' when the number of requests that exceed the 'rate_limit_threshold' also exceed this 'ban_threshold'.
  final SecurityPolicyRuleRateLimitOptionsThresholdResponse2 banThreshold;
  ...
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse2>
      enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRedirectOptionsResponse2 exceedRedirectOptions;

  /// Threshold at which to begin ratelimiting.
  final SecurityPolicyRuleRateLimitOptionsThresholdResponse2 rateLimitThreshold;

  SecurityPolicyRuleRateLimitOptionsResponse2({
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponse2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponse2(
      banDurationSec: map['banDurationSec'] as int,
      banThreshold:
          SecurityPolicyRuleRateLimitOptionsThresholdResponse2.fromMap(
      ...
      exceedRedirectOptions: SecurityPolicyRuleRedirectOptionsResponse2.fromMap(
