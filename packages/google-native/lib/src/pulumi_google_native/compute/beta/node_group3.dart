...
class NodeGroup3 extends CustomResource {
  /// Specifies how autoscaling should behave.
  late final Output<NodeGroupAutoscalingPolicyResponse2> autoscalingPolicy;
  ...
  late final Output<NodeGroupMaintenanceWindowResponse2> maintenanceWindow;
  ...
  NodeGroup3(
    ...
    this.autoscalingPolicy =
        Output.createUnknown<NodeGroupAutoscalingPolicyResponse2>();
    ...
    this.maintenanceWindow =
        Output.createUnknown<NodeGroupMaintenanceWindowResponse2>();
