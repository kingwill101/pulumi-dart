...
class InterconnectCircuitInfoResponse2 {
  ...
  InterconnectCircuitInfoResponse2({
  ...
  factory InterconnectCircuitInfoResponse2.fromMap(Map<String, dynamic> map) {
    return InterconnectCircuitInfoResponse2(
