...
class InstanceGroupManagerActionsSummaryResponse2 {
  ...
  InstanceGroupManagerActionsSummaryResponse2({
  ...
  factory InstanceGroupManagerActionsSummaryResponse2.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerActionsSummaryResponse2(
