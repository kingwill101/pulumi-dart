...
import 'resource_policy_instance_schedule_policy_schedule2.dart';

/// An InstanceSchedulePolicy specifies when and how frequent certain operations are performed on the instance.
class ResourcePolicyInstanceSchedulePolicy2 {
  ...
  final ResourcePolicyInstanceSchedulePolicySchedule2? vmStartSchedule;

  /// Specifies the schedule for stopping instances.
  final ResourcePolicyInstanceSchedulePolicySchedule2? vmStopSchedule;

  ResourcePolicyInstanceSchedulePolicy2({
    this.expirationTime,
    this.startTime,
    this.timeZone,
  ...
  factory ResourcePolicyInstanceSchedulePolicy2.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicyInstanceSchedulePolicy2(
      ...
      vmStartSchedule: map['vmStartSchedule'] == null
          ? null
          : ResourcePolicyInstanceSchedulePolicySchedule2.fromMap(
