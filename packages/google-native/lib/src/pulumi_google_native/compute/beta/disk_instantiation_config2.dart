...
import 'disk_instantiation_config_instantiate_from2.dart';

/// A specification of the desired way to instantiate a disk in the instance template when its created from a source instance.
class DiskInstantiationConfig2 {
  ...
  final DiskInstantiationConfigInstantiateFrom2? instantiateFrom;

  DiskInstantiationConfig2({
    this.autoDelete,
    this.customImage,
    this.deviceName,
  ...
  factory DiskInstantiationConfig2.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfig2(
      ...
      instantiateFrom: map['instantiateFrom'] == null
          ? null
          : DiskInstantiationConfigInstantiateFrom2.fromValue(
