...
import 'router_nat_log_config_response_compute_beta.dart';
import 'router_nat_rule_response_compute_beta.dart';
import 'router_nat_subnetwork_to_nat_response_compute_beta.dart';

/// Represents a Nat resource. It enables the VMs within the specified subnetworks to access Internet without external IP addresses. It specifies a list of subnetworks (and the ranges within) that want to use NAT. Customers can also provide the external IPs that would be used for NAT. GCP would auto-allocate ephemeral IPs if no external IPs are provided.
class RouterNatResponseComputeBeta {
  ...
  final RouterNatLogConfigResponseComputeBeta logConfig;
  ...
  final List<RouterNatRuleResponseComputeBeta> rules;
  ...
  final List<RouterNatSubnetworkToNatResponseComputeBeta> subnetworks;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['natIps'] = natIps;
    map['rules'] = pulumi.Input.encodeList<RouterNatRuleResponseComputeBeta,
  ...
  factory RouterNatResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeBeta(
      ...
      logConfig: RouterNatLogConfigResponseComputeBeta.fromMap(
      ...
      rules: pulumi.Input.decodeList<RouterNatRuleResponseComputeBeta>(
          map['rules'],
          (value) => RouterNatRuleResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat:
          map['sourceSubnetworkIpRangesToNat'] as String,
      subnetworks:
          pulumi.Input.decodeList<RouterNatSubnetworkToNatResponseComputeBeta>(
              map['subnetworks'],
              (value) => RouterNatSubnetworkToNatResponseComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>())),
