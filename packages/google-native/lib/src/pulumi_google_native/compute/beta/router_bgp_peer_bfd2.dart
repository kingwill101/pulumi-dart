...
import 'router_bgp_peer_bfd_session_initialization_mode2.dart';

class RouterBgpPeerBfd2 {
  ...
  final RouterBgpPeerBfdSessionInitializationMode2? sessionInitializationMode;
  ...
  factory RouterBgpPeerBfd2.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfd2(
      ...
      sessionInitializationMode: map['sessionInitializationMode'] == null
          ? null
          : RouterBgpPeerBfdSessionInitializationMode2.fromValue(
