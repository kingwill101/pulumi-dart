...
import 'backend_bucket_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class BackendBucketIamMember2 extends CustomResource {
  ...
  BackendBucketIamMember2(
    String name, {
    BackendBucketIamMemberArgs2? args,
