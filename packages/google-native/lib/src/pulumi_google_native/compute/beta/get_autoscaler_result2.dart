...
class GetAutoscalerResult2 {
  /// The configuration parameters for the autoscaling algorithm. You can define one or more signals for an autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the default will be to autoscale based on cpuUtilization to 0.6 or 60%.
  final AutoscalingPolicyResponse2 autoscalingPolicy;
  ...
  final List<AutoscalerStatusDetailsResponse2> statusDetails;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['status'] = status;
    map['statusDetails'] = Input.encodeList<AutoscalerStatusDetailsResponse2,
  ...
  factory GetAutoscalerResult2.fromMap(Map<String, dynamic> map) {
    return GetAutoscalerResult2(
      autoscalingPolicy: AutoscalingPolicyResponse2.fromMap(
      ...
      statusDetails: Input.decodeList<AutoscalerStatusDetailsResponse2>(
          map['statusDetails'],
          (value) => AutoscalerStatusDetailsResponse2.fromMap(
