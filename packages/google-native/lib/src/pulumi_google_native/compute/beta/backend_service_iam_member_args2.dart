...
class BackendServiceIamMemberArgs2 {
  ...
  factory BackendServiceIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamMemberArgs2(
