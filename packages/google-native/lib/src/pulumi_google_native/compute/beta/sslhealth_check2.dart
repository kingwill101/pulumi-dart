...
import 'sslhealth_check_port_specification2.dart';
import 'sslhealth_check_proxy_header2.dart';

class SSLHealthCheck2 {
  ...
  final SSLHealthCheckPortSpecification2? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final SSLHealthCheckProxyHeader2? proxyHeader;
  ...
  factory SSLHealthCheck2.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheck2(
      port: map['port'] == null ? null : map['port'] as int,
      portName: map['portName'] == null ? null : map['portName'] as String,
      portSpecification: map['portSpecification'] == null
          ? null
          : SSLHealthCheckPortSpecification2.fromValue(
              map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null
          ? null
          : SSLHealthCheckProxyHeader2.fromValue(map['proxyHeader'] as String),
