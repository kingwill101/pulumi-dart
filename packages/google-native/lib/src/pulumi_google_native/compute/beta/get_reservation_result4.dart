...
class GetReservationResult4 {
  /// Reservation for aggregated resources, providing shape flexibility.
  final AllocationAggregateReservationResponse2 aggregateReservation;
  ...
  final DurationResponse2 deleteAfterDuration;
  ...
  final AllocationResourceStatusResponse2 resourceStatus;
  ...
  final AllocationSpecificSKUReservationResponse2 specificReservation;
  ...
  factory GetReservationResult4.fromMap(Map<String, dynamic> map) {
    return GetReservationResult4(
      aggregateReservation: AllocationAggregateReservationResponse2.fromMap(
          (map['aggregateReservation'] as Map).cast<String, dynamic>()),
      commitment: map['commitment'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      deleteAfterDuration: DurationResponse2.fromMap(
      ...
      resourceStatus: AllocationResourceStatusResponse2.fromMap(
      ...
      specificReservation: AllocationSpecificSKUReservationResponse2.fromMap(
