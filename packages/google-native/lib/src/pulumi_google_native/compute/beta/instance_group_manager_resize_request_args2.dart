...
class InstanceGroupManagerResizeRequestArgs2 {
  ...
  final Input<Duration2>? requestedRunDuration;

  /// The number of instances to be created by this resize request. The group's target size will be increased by this number.
  final Input<int>? resizeBy;
  final Input<String>? zone;

  InstanceGroupManagerResizeRequestArgs2({
    this.count,
    this.description,
  ...
  factory InstanceGroupManagerResizeRequestArgs2.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerResizeRequestArgs2(
      ...
      requestedRunDuration:
          Input.asOptionalInput<Duration2>(map['requestedRunDuration']),
