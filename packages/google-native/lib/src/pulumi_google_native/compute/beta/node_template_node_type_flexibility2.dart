...
class NodeTemplateNodeTypeFlexibility2 {
  final String? cpus;
  final String? localSsd;
  final String? memory;

  NodeTemplateNodeTypeFlexibility2({
    this.cpus,
    this.localSsd,
    this.memory,
  });
  ...
  factory NodeTemplateNodeTypeFlexibility2.fromMap(Map<String, dynamic> map) {
    return NodeTemplateNodeTypeFlexibility2(
