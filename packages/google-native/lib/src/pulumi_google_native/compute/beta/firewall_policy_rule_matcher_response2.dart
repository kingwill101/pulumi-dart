...
import 'firewall_policy_rule_matcher_layer4_config_response2.dart';
import 'firewall_policy_rule_secure_tag_response2.dart';

/// Represents a match condition that incoming traffic is evaluated against. Exactly one field must be specified.
class FirewallPolicyRuleMatcherResponse2 {
  ...
  final List<FirewallPolicyRuleMatcherLayer4ConfigResponse2> layer4Configs;
  ...
  final List<FirewallPolicyRuleSecureTagResponse2> srcSecureTags;

  /// Names of Network Threat Intelligence lists. The IPs in these lists will be matched against traffic source.
  final List<String> srcThreatIntelligences;

  FirewallPolicyRuleMatcherResponse2({
  ...
  factory FirewallPolicyRuleMatcherResponse2.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherResponse2(
      ...
      layer4Configs:
          Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigResponse2>(
              map['layer4Configs'],
              (value) => FirewallPolicyRuleMatcherLayer4ConfigResponse2.fromMap(
      ...
      srcSecureTags: Input.decodeList<FirewallPolicyRuleSecureTagResponse2>(
          map['srcSecureTags'],
          (value) => FirewallPolicyRuleSecureTagResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
