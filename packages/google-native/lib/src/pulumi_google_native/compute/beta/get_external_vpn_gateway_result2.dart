...
import 'external_vpn_gateway_interface_response2.dart';

/// Result data returned by getExternalVpnGateway.
class GetExternalVpnGatewayResult2 {
  ...
  final List<ExternalVpnGatewayInterfaceResponse2> interfaces;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['interfaces'] = Input.encodeList<ExternalVpnGatewayInterfaceResponse2,
  ...
  factory GetExternalVpnGatewayResult2.fromMap(Map<String, dynamic> map) {
    return GetExternalVpnGatewayResult2(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      interfaces: Input.decodeList<ExternalVpnGatewayInterfaceResponse2>(
          map['interfaces'],
          (value) => ExternalVpnGatewayInterfaceResponse2.fromMap(
