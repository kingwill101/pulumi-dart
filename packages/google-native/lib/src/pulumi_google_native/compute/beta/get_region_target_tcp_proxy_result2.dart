...
class GetRegionTargetTcpProxyResult2 {
  ...
  GetRegionTargetTcpProxyResult2({
  ...
  factory GetRegionTargetTcpProxyResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetTcpProxyResult2(
