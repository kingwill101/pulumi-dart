...
import 'http_route_rule_response2.dart';
import 'path_rule_response2.dart';

/// A matcher for the path portion of the URL. The BackendService from the longest-matched rule will serve the URL. If no rule was matched, the default service is used.
class PathMatcherResponse2 {
  ...
  final List<PathRuleResponse2> pathRules;

  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final List<HttpRouteRuleResponse2> routeRules;

  PathMatcherResponse2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['pathRules'] =
        Input.encodeList<PathRuleResponse2, Map<String, dynamic>>(
            pathRules, (value) => value.toMap());
    map['routeRules'] =
        Input.encodeList<HttpRouteRuleResponse2, Map<String, dynamic>>(
            routeRules, (value) => value.toMap());
    return map;
  }

  factory PathMatcherResponse2.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponse2(
      ...
      pathRules: Input.decodeList<PathRuleResponse2>(
          map['pathRules'],
          (value) => PathRuleResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      routeRules: Input.decodeList<HttpRouteRuleResponse2>(
          map['routeRules'],
          (value) => HttpRouteRuleResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
