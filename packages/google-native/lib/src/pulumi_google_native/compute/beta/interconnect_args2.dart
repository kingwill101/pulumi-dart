...
import 'interconnect_interconnect_type2.dart';
import 'interconnect_link_type2.dart';
import 'interconnect_macsec2.dart';
import 'interconnect_requested_features_item2.dart';

/// The set of arguments for Interconnect.
class InterconnectArgs2 {
  ...
  final Input<InterconnectInterconnectType2>? interconnectType;

  /// Labels for this resource. These can only be added or modified by the setLabels method. Each label key/value pair must comply with RFC1035. Label values may be empty.
  final Input<Map<String, String>>? labels;

  /// Type of link requested, which can take one of the following values: - LINK_TYPE_ETHERNET_10G_LR: A 10G Ethernet with LR optics - LINK_TYPE_ETHERNET_100G_LR: A 100G Ethernet with LR optics. Note that this field indicates the speed of each of the links in the bundle, not the speed of the entire bundle.
  final Input<InterconnectLinkType2>? linkType;
  ...
  final Input<InterconnectMacsec2>? macsec;
  ...
  final Input<List<InterconnectRequestedFeaturesItem2>>? requestedFeatures;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (interconnectTypeValue != null) {
      map['interconnectType'] =
          Input.mapOptionalInputValue<InterconnectInterconnectType2, String>(
    ...
    if (linkTypeValue != null) {
      map['linkType'] =
          Input.mapOptionalInputValue<InterconnectLinkType2, String>(
    ...
    if (macsecValue != null) {
      map['macsec'] = Input.mapOptionalInputValue<InterconnectMacsec2,
    ...
    if (requestedFeaturesValue != null) {
      map['requestedFeatures'] = Input.mapOptionalInputValue<
              List<InterconnectRequestedFeaturesItem2>, List<String>>(
          requestedFeaturesValue,
          (value) =>
              Input.encodeList<InterconnectRequestedFeaturesItem2, String>(
  ...
  factory InterconnectArgs2.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs2(
      ...
      interconnectType: Input.asOptionalInput<InterconnectInterconnectType2>(
          map['interconnectType']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      linkType: Input.asOptionalInput<InterconnectLinkType2>(map['linkType']),
      location: Input.asOptionalInput<String>(map['location']),
      macsec: Input.asOptionalInput<InterconnectMacsec2>(map['macsec']),
      ...
      requestedFeatures:
          Input.asOptionalInput<List<InterconnectRequestedFeaturesItem2>>(
