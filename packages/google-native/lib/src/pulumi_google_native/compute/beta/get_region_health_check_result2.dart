...
class GetRegionHealthCheckResult2 {
  ...
  final GRPCHealthCheckResponse2 grpcHealthCheck;

  /// A so-far unhealthy instance will be marked healthy after this many consecutive successes. The default value is 2.
  final int healthyThreshold;
  final HTTP2HealthCheckResponse2 http2HealthCheck;
  final HTTPHealthCheckResponse2 httpHealthCheck;
  final HTTPSHealthCheckResponse2 httpsHealthCheck;

  /// Type of the resource.
  final String kind;

  /// Configure logging on this health check.
  final HealthCheckLogConfigResponse2 logConfig;
  ...
  final SSLHealthCheckResponse2 sslHealthCheck;
  final TCPHealthCheckResponse2 tcpHealthCheck;
  ...
  factory GetRegionHealthCheckResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionHealthCheckResult2(
      checkIntervalSec: map['checkIntervalSec'] as int,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      grpcHealthCheck: GRPCHealthCheckResponse2.fromMap(
          (map['grpcHealthCheck'] as Map).cast<String, dynamic>()),
      healthyThreshold: map['healthyThreshold'] as int,
      http2HealthCheck: HTTP2HealthCheckResponse2.fromMap(
          (map['http2HealthCheck'] as Map).cast<String, dynamic>()),
      httpHealthCheck: HTTPHealthCheckResponse2.fromMap(
          (map['httpHealthCheck'] as Map).cast<String, dynamic>()),
      httpsHealthCheck: HTTPSHealthCheckResponse2.fromMap(
          (map['httpsHealthCheck'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      logConfig: HealthCheckLogConfigResponse2.fromMap(
          (map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      sslHealthCheck: SSLHealthCheckResponse2.fromMap(
          (map['sslHealthCheck'] as Map).cast<String, dynamic>()),
      tcpHealthCheck: TCPHealthCheckResponse2.fromMap(
