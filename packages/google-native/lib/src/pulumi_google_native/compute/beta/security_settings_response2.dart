...
import 'awsv4_signature_response2.dart';

/// The authentication and authorization settings for a BackendService.
class SecuritySettingsResponse2 {
  ...
  final AWSV4SignatureResponse2 awsV4Authentication;
  ...
  factory SecuritySettingsResponse2.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponse2(
      authentication: map['authentication'] as String,
      awsV4Authentication: AWSV4SignatureResponse2.fromMap(
