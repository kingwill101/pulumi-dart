...
import 'region_ssl_certificate_compute_beta_args.dart';
...
class RegionSslCertificateComputeBeta extends pulumi.CustomResource {
  ...
  RegionSslCertificateComputeBeta(
    String name, {
    RegionSslCertificateComputeBetaArgs? args,
