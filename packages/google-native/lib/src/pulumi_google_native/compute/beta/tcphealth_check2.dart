...
import 'tcphealth_check_port_specification2.dart';
import 'tcphealth_check_proxy_header2.dart';

class TCPHealthCheck2 {
  ...
  final TCPHealthCheckPortSpecification2? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final TCPHealthCheckProxyHeader2? proxyHeader;
  ...
  factory TCPHealthCheck2.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheck2(
      port: map['port'] == null ? null : map['port'] as int,
      portName: map['portName'] == null ? null : map['portName'] as String,
      portSpecification: map['portSpecification'] == null
          ? null
          : TCPHealthCheckPortSpecification2.fromValue(
              map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null
          ? null
          : TCPHealthCheckProxyHeader2.fromValue(map['proxyHeader'] as String),
