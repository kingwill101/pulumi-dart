...
class HttpRedirectActionResponse2 {
  ...
  factory HttpRedirectActionResponse2.fromMap(Map<String, dynamic> map) {
    return HttpRedirectActionResponse2(
