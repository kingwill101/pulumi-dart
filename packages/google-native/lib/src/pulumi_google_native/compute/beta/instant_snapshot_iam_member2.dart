...
import 'instant_snapshot_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class InstantSnapshotIamMember2 extends CustomResource {
  ...
  InstantSnapshotIamMember2(
    String name, {
    InstantSnapshotIamMemberArgs2? args,
