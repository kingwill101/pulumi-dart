...
import 'subnetwork_purpose2.dart';
import 'subnetwork_role2.dart';
import 'subnetwork_secondary_range2.dart';
import 'subnetwork_stack_type2.dart';

/// The set of arguments for Subnetwork.
class SubnetworkArgs2 {
  ...
  final Input<SubnetworkIpv6AccessType2>? ipv6AccessType;

  /// This field denotes the VPC flow logging options for this subnetwork. If logging is enabled, logs are exported to Cloud Logging.
  final Input<SubnetworkLogConfig2>? logConfig;
  ...
  final Input<SubnetworkPrivateIpv6GoogleAccess2>? privateIpv6GoogleAccess;
  ...
  final Input<SubnetworkPurpose2>? purpose;
  ...
  final Input<SubnetworkRole2>? role;

  /// An array of configurations for secondary IP ranges for VM instances contained in this subnetwork. The primary IP of such VM must belong to the primary ipCidrRange of the subnetwork. The alias IPs may belong to either primary or secondary ranges. This field can be updated with a patch request.
  final Input<List<SubnetworkSecondaryRange2>>? secondaryIpRanges;

  /// The stack type for the subnet. If set to IPV4_ONLY, new VMs in the subnet are assigned IPv4 addresses only. If set to IPV4_IPV6, new VMs in the subnet can be assigned both IPv4 and IPv6 addresses. If not specified, IPV4_ONLY is used. This field can be both set at resource creation time and updated using patch.
  final Input<SubnetworkStackType2>? stackType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipv6AccessTypeValue != null) {
      map['ipv6AccessType'] =
          Input.mapOptionalInputValue<SubnetworkIpv6AccessType2, String>(
              ipv6AccessTypeValue, (value) => value.value);
    }
    final logConfigValue = logConfig;
    if (logConfigValue != null) {
      map['logConfig'] = Input.mapOptionalInputValue<SubnetworkLogConfig2,
    ...
    if (privateIpv6GoogleAccessValue != null) {
      map['privateIpv6GoogleAccess'] = Input.mapOptionalInputValue<
          SubnetworkPrivateIpv6GoogleAccess2,
    ...
    if (purposeValue != null) {
      map['purpose'] = Input.mapOptionalInputValue<SubnetworkPurpose2, String>(
    ...
    if (roleValue != null) {
      map['role'] = Input.mapOptionalInputValue<SubnetworkRole2, String>(
    ...
    if (secondaryIpRangesValue != null) {
      map['secondaryIpRanges'] = Input.mapOptionalInputValue<
              List<SubnetworkSecondaryRange2>, List<Map<String, dynamic>>>(
          secondaryIpRangesValue,
          (value) =>
              Input.encodeList<SubnetworkSecondaryRange2, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    final stackTypeValue = stackType;
    if (stackTypeValue != null) {
      map['stackType'] =
          Input.mapOptionalInputValue<SubnetworkStackType2, String>(
              stackTypeValue, (value) => value.value);
    }
    return map;
  }

  factory SubnetworkArgs2.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs2(
      ...
      ipv6AccessType: Input.asOptionalInput<SubnetworkIpv6AccessType2>(
          map['ipv6AccessType']),
      logConfig: Input.asOptionalInput<SubnetworkLogConfig2>(map['logConfig']),
      name: Input.asOptionalInput<String>(map['name']),
      network: Input.asOptionalInput<String>(map['network']),
      privateIpGoogleAccess:
          Input.asOptionalInput<bool>(map['privateIpGoogleAccess']),
      privateIpv6GoogleAccess:
          Input.asOptionalInput<SubnetworkPrivateIpv6GoogleAccess2>(
              map['privateIpv6GoogleAccess']),
      project: Input.asOptionalInput<String>(map['project']),
      purpose: Input.asOptionalInput<SubnetworkPurpose2>(map['purpose']),
      region: Input.asInput<String>(map['region']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      reservedInternalRange:
          Input.asOptionalInput<String>(map['reservedInternalRange']),
      role: Input.asOptionalInput<SubnetworkRole2>(map['role']),
      secondaryIpRanges: Input.asOptionalInput<List<SubnetworkSecondaryRange2>>(
          map['secondaryIpRanges']),
      stackType: Input.asOptionalInput<SubnetworkStackType2>(map['stackType']),
    );
  }
}
