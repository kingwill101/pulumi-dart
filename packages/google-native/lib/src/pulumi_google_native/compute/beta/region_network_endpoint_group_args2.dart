...
import 'region_network_endpoint_group_network_endpoint_type2.dart';

/// The set of arguments for RegionNetworkEndpointGroup.
class RegionNetworkEndpointGroupArgs2 {
  ...
  final Input<RegionNetworkEndpointGroupNetworkEndpointType2>?
      networkEndpointType;
  ...
  RegionNetworkEndpointGroupArgs2({
    this.annotations,
    this.appEngine,
    this.cloudFunction,
    this.cloudRun,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkEndpointTypeValue != null) {
      map['networkEndpointType'] = Input.mapOptionalInputValue<
          RegionNetworkEndpointGroupNetworkEndpointType2,
  ...
  factory RegionNetworkEndpointGroupArgs2.fromMap(Map<String, dynamic> map) {
    return RegionNetworkEndpointGroupArgs2(
      annotations:
      ...
      networkEndpointType:
          Input.asOptionalInput<RegionNetworkEndpointGroupNetworkEndpointType2>(
