...
import 'disk_architecture2.dart';
import 'disk_async_replication2.dart';
import 'disk_interface2.dart';
import 'disk_params2.dart';
import 'disk_storage_type2.dart';
import 'guest_os_feature2.dart';

/// The set of arguments for Disk.
class DiskArgs2 {
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final Input<DiskArchitecture2>? architecture;
  ...
  final Input<DiskInterface2>? interface;
  ...
  final Input<DiskStorageType2>? storageType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (architectureValue != null) {
      map['architecture'] =
          Input.mapOptionalInputValue<DiskArchitecture2, String>(
    ...
    if (interfaceValue != null) {
      map['interface'] = Input.mapOptionalInputValue<DiskInterface2, String>(
    ...
    if (storageTypeValue != null) {
      map['storageType'] =
          Input.mapOptionalInputValue<DiskStorageType2, String>(
  ...
  factory DiskArgs2.fromMap(Map<String, dynamic> map) {
    return DiskArgs2(
      architecture:
          Input.asOptionalInput<DiskArchitecture2>(map['architecture']),
      asyncPrimaryDisk:
      ...
      interface: Input.asOptionalInput<DiskInterface2>(map['interface']),
      ...
      storageType: Input.asOptionalInput<DiskStorageType2>(map['storageType']),
