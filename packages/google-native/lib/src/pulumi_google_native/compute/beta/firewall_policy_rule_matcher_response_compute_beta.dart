...
import 'firewall_policy_rule_matcher_layer4_config_response_compute_beta.dart';
import 'firewall_policy_rule_secure_tag_response_compute_beta.dart';

/// Represents a match condition that incoming traffic is evaluated against. Exactly one field must be specified.
class FirewallPolicyRuleMatcherResponseComputeBeta {
  ...
  final List<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta>
      layer4Configs;
  ...
  final List<FirewallPolicyRuleSecureTagResponseComputeBeta> srcSecureTags;

  /// Names of Network Threat Intelligence lists. The IPs in these lists will be matched against traffic source.
  final List<String> srcThreatIntelligences;

  FirewallPolicyRuleMatcherResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['layer4Configs'] = pulumi.Input.encodeList<
        FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta,
  ...
  factory FirewallPolicyRuleMatcherResponseComputeBeta.fromMap(
      Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherResponseComputeBeta(
      ...
      layer4Configs: pulumi.Input.decodeList<
          ...
          map['layer4Configs'],
          (value) =>
              FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta.fromMap(
      ...
      srcSecureTags: pulumi.Input.decodeList<
              FirewallPolicyRuleSecureTagResponseComputeBeta>(
          map['srcSecureTags'],
          (value) => FirewallPolicyRuleSecureTagResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>())),
