...
import 'backend_bucket_cdn_policy2.dart';
import 'backend_bucket_compression_mode2.dart';

/// The set of arguments for BackendBucket.
class BackendBucketArgs2 {
  /// Cloud Storage bucket name.
  final Input<String>? bucketName;

  /// Cloud CDN configuration for this BackendBucket.
  final Input<BackendBucketCdnPolicy2>? cdnPolicy;

  /// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
  final Input<BackendBucketCompressionMode2>? compressionMode;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (cdnPolicyValue != null) {
      map['cdnPolicy'] = Input.mapOptionalInputValue<BackendBucketCdnPolicy2,
    ...
    if (compressionModeValue != null) {
      map['compressionMode'] =
          Input.mapOptionalInputValue<BackendBucketCompressionMode2, String>(
  ...
  factory BackendBucketArgs2.fromMap(Map<String, dynamic> map) {
    return BackendBucketArgs2(
      bucketName: Input.asOptionalInput<String>(map['bucketName']),
      cdnPolicy:
          Input.asOptionalInput<BackendBucketCdnPolicy2>(map['cdnPolicy']),
      compressionMode: Input.asOptionalInput<BackendBucketCompressionMode2>(
          map['compressionMode']),
