...
class GetGlobalPublicDelegatedPrefixResult2 {
  ...
  GetGlobalPublicDelegatedPrefixResult2({
  ...
  factory GetGlobalPublicDelegatedPrefixResult2.fromMap(
      Map<String, dynamic> map) {
    return GetGlobalPublicDelegatedPrefixResult2(
