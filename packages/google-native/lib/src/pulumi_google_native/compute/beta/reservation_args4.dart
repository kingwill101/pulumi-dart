...
class ReservationArgs4 {
  /// Reservation for aggregated resources, providing shape flexibility.
  final Input<AllocationAggregateReservation2>? aggregateReservation;

  /// Duration time relative to reservation creation when GCE will automatically delete this resource.
  final Input<Duration2>? deleteAfterDuration;
  ...
  final Input<AllocationSpecificSKUReservation2>? specificReservation;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (aggregateReservationValue != null) {
      map['aggregateReservation'] = Input.mapOptionalInputValue<
              AllocationAggregateReservation2, Map<String, dynamic>>(
    ...
    if (specificReservationValue != null) {
      map['specificReservation'] = Input.mapOptionalInputValue<
              AllocationSpecificSKUReservation2, Map<String, dynamic>>(
  ...
  factory ReservationArgs4.fromMap(Map<String, dynamic> map) {
    return ReservationArgs4(
      aggregateReservation:
          Input.asOptionalInput<AllocationAggregateReservation2>(
              map['aggregateReservation']),
      deleteAfterDuration:
          Input.asOptionalInput<Duration2>(map['deleteAfterDuration']),
      ...
      specificReservation:
          Input.asOptionalInput<AllocationSpecificSKUReservation2>(
