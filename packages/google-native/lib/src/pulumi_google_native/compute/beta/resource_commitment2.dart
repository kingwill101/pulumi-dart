...
import 'resource_commitment_type2.dart';

/// Commitment for a particular resource (a Commitment is composed of one or more of these).
class ResourceCommitment2 {
  ...
  final ResourceCommitmentType2? type;
  ...
  factory ResourceCommitment2.fromMap(Map<String, dynamic> map) {
    return ResourceCommitment2(
      ...
      type: map['type'] == null
          ? null
          : ResourceCommitmentType2.fromValue(map['type'] as String),
    );
  }
}
