...
class ResourcePolicy2 extends CustomResource {
  ...
  ResourcePolicy2(
    ...
    this.groupPlacementPolicy =
        registerOutput<ResourcePolicyGroupPlacementPolicyResponse2>(
            'groupPlacementPolicy');
    this.instanceSchedulePolicy =
        registerOutput<ResourcePolicyInstanceSchedulePolicyResponse2>(
            'instanceSchedulePolicy');
    ...
    this.resourceStatus =
        registerOutput<ResourcePolicyResourceStatusResponse2>('resourceStatus');
    this.selfLink = registerOutput<String>('selfLink');
    this.snapshotSchedulePolicy =
        registerOutput<ResourcePolicySnapshotSchedulePolicyResponse2>(
            'snapshotSchedulePolicy');
