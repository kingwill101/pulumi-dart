...
class ResourcePolicy2 extends CustomResource {
  ...
  late final Output<ResourcePolicyGroupPlacementPolicyResponse2>
      groupPlacementPolicy;

  /// Resource policy for scheduling instance operations.
  late final Output<ResourcePolicyInstanceSchedulePolicyResponse2>
  ...
  late final Output<ResourcePolicyResourceStatusResponse2> resourceStatus;

  /// Server-defined fully-qualified URL for this resource.
  late final Output<String> selfLink;

  /// Resource policy for persistent disks for creating snapshots.
  late final Output<ResourcePolicySnapshotSchedulePolicyResponse2>
  ...
  ResourcePolicy2(
    ...
    this.groupPlacementPolicy =
        Output.createUnknown<ResourcePolicyGroupPlacementPolicyResponse2>();
    this.instanceSchedulePolicy =
        Output.createUnknown<ResourcePolicyInstanceSchedulePolicyResponse2>();
    ...
    this.resourceStatus =
        Output.createUnknown<ResourcePolicyResourceStatusResponse2>();
    this.selfLink = Output.createUnknown<String>();
    this.snapshotSchedulePolicy =
        Output.createUnknown<ResourcePolicySnapshotSchedulePolicyResponse2>();
