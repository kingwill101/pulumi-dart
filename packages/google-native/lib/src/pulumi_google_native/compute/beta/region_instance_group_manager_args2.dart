...
import 'region_instance_group_manager_failover_action2.dart';
import 'region_instance_group_manager_list_managed_instances_results2.dart';
import 'stateful_policy2.dart';

/// The set of arguments for RegionInstanceGroupManager.
class RegionInstanceGroupManagerArgs2 {
  ...
  final Input<RegionInstanceGroupManagerFailoverAction2>? failoverAction;
  ...
  final Input<RegionInstanceGroupManagerListManagedInstancesResults2>?
  ...
  RegionInstanceGroupManagerArgs2({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (failoverActionValue != null) {
      map['failoverAction'] = Input.mapOptionalInputValue<
          RegionInstanceGroupManagerFailoverAction2,
    ...
    if (listManagedInstancesResultsValue != null) {
      map['listManagedInstancesResults'] = Input.mapOptionalInputValue<
          RegionInstanceGroupManagerListManagedInstancesResults2,
  ...
  factory RegionInstanceGroupManagerArgs2.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerArgs2(
      allInstancesConfig:
      ...
      failoverAction:
          Input.asOptionalInput<RegionInstanceGroupManagerFailoverAction2>(
              map['failoverAction']),
      instanceFlexibilityPolicy:
