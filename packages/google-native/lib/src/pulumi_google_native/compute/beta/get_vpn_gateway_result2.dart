...
import 'vpn_gateway_vpn_gateway_interface_response2.dart';

/// Result data returned by getVpnGateway.
class GetVpnGatewayResult2 {
  ...
  final List<VpnGatewayVpnGatewayInterfaceResponse2> vpnInterfaces;

  GetVpnGatewayResult2({
  ...
  factory GetVpnGatewayResult2.fromMap(Map<String, dynamic> map) {
    return GetVpnGatewayResult2(
      ...
      vpnInterfaces: Input.decodeList<VpnGatewayVpnGatewayInterfaceResponse2>(
          map['vpnInterfaces'],
          (value) => VpnGatewayVpnGatewayInterfaceResponse2.fromMap(
