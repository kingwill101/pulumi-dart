...
/// The set of arguments for ResourcePolicyIamMember.
class ResourcePolicyIamMemberComputeBetaArgs {
  ...
  ResourcePolicyIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory ResourcePolicyIamMemberComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicyIamMemberComputeBetaArgs(
