...
import 'interconnect_macsec_pre_shared_key2.dart';
...
class InterconnectMacsec2 {
  ...
  final List<InterconnectMacsecPreSharedKey2> preSharedKeys;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['preSharedKeys'] =
        Input.encodeList<InterconnectMacsecPreSharedKey2, Map<String, dynamic>>(
            preSharedKeys, (value) => value.toMap());
    return map;
  }

  factory InterconnectMacsec2.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsec2(
      failOpen: map['failOpen'] == null ? null : map['failOpen'] as bool,
      preSharedKeys: Input.decodeList<InterconnectMacsecPreSharedKey2>(
          map['preSharedKeys'],
          (value) => InterconnectMacsecPreSharedKey2.fromMap(
