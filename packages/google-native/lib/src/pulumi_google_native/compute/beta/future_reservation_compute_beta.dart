...
class FutureReservationComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<FutureReservationSpecificSKUPropertiesResponseComputeBeta>
  ...
  FutureReservationComputeBeta(
    ...
    this.shareSettings =
        registerOutput<ShareSettingsResponseComputeBeta>('shareSettings');
    this.specificSkuProperties = registerOutput<
            FutureReservationSpecificSKUPropertiesResponseComputeBeta>(
        'specificSkuProperties');
    this.status =
        registerOutput<FutureReservationStatusResponseComputeBeta>('status');
    this.timeWindow =
