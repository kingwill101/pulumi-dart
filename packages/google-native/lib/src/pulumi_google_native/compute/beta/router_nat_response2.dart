...
import 'router_nat_log_config_response2.dart';
import 'router_nat_rule_response2.dart';
import 'router_nat_subnetwork_to_nat_response2.dart';

/// Represents a Nat resource. It enables the VMs within the specified subnetworks to access Internet without external IP addresses. It specifies a list of subnetworks (and the ranges within) that want to use NAT. Customers can also provide the external IPs that would be used for NAT. GCP would auto-allocate ephemeral IPs if no external IPs are provided.
class RouterNatResponse2 {
  ...
  final RouterNatLogConfigResponse2 logConfig;
  ...
  final List<RouterNatRuleResponse2> rules;
  ...
  final List<RouterNatSubnetworkToNatResponse2> subnetworks;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['natIps'] = natIps;
    map['rules'] =
        Input.encodeList<RouterNatRuleResponse2, Map<String, dynamic>>(
            rules, (value) => value.toMap());
    map['sourceSubnetworkIpRangesToNat'] = sourceSubnetworkIpRangesToNat;
    map['subnetworks'] = Input.encodeList<RouterNatSubnetworkToNatResponse2,
  ...
  factory RouterNatResponse2.fromMap(Map<String, dynamic> map) {
    return RouterNatResponse2(
      ...
      logConfig: RouterNatLogConfigResponse2.fromMap(
      ...
      rules: Input.decodeList<RouterNatRuleResponse2>(
          map['rules'],
          (value) => RouterNatRuleResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat:
          map['sourceSubnetworkIpRangesToNat'] as String,
      subnetworks: Input.decodeList<RouterNatSubnetworkToNatResponse2>(
          map['subnetworks'],
          (value) => RouterNatSubnetworkToNatResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
