...
import 'access_config_response2.dart';
import 'alias_ip_range_response2.dart';

/// A network interface resource attached to an instance.
class NetworkInterfaceResponse3 {
  /// An array of configurations for this interface. Currently, only one access config, ONE_TO_ONE_NAT, is supported. If there are no accessConfigs specified, then this instance will have no external internet access.
  final List<AccessConfigResponse2> accessConfigs;

  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final List<AliasIpRangeResponse2> aliasIpRanges;
  ...
  final List<AccessConfigResponse2> ipv6AccessConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['accessConfigs'] =
        Input.encodeList<AccessConfigResponse2, Map<String, dynamic>>(
            accessConfigs, (value) => value.toMap());
    map['aliasIpRanges'] =
        Input.encodeList<AliasIpRangeResponse2, Map<String, dynamic>>(
  ...
  factory NetworkInterfaceResponse3.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponse3(
      accessConfigs: Input.decodeList<AccessConfigResponse2>(
          map['accessConfigs'],
          (value) => AccessConfigResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      aliasIpRanges: Input.decodeList<AliasIpRangeResponse2>(
          map['aliasIpRanges'],
          (value) => AliasIpRangeResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      fingerprint: map['fingerprint'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: Input.decodeList<AccessConfigResponse2>(
          map['ipv6AccessConfigs'],
          (value) => AccessConfigResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
