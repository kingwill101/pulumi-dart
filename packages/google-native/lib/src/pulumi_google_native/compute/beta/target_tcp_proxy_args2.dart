...
import 'target_tcp_proxy_proxy_header2.dart';

/// The set of arguments for TargetTcpProxy.
class TargetTcpProxyArgs2 {
  ...
  final Input<TargetTcpProxyProxyHeader2>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          Input.mapOptionalInputValue<TargetTcpProxyProxyHeader2, String>(
  ...
  factory TargetTcpProxyArgs2.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyArgs2(
      description: Input.asOptionalInput<String>(map['description']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      proxyBind: Input.asOptionalInput<bool>(map['proxyBind']),
      proxyHeader:
          Input.asOptionalInput<TargetTcpProxyProxyHeader2>(map['proxyHeader']),
