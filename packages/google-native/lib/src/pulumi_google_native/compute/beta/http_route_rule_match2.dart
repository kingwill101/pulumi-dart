...
class HttpRouteRuleMatch2 {
  ...
  final List<MetadataFilter2>? metadataFilters;
  ...
  final List<HttpQueryParameterMatch2>? queryParameterMatches;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headerMatchesValue != null) {
      map['headerMatches'] =
          Input.encodeList<HttpHeaderMatch2, Map<String, dynamic>>(
    ...
    if (metadataFiltersValue != null) {
      map['metadataFilters'] =
          Input.encodeList<MetadataFilter2, Map<String, dynamic>>(
    ...
    if (queryParameterMatchesValue != null) {
      map['queryParameterMatches'] =
          Input.encodeList<HttpQueryParameterMatch2, Map<String, dynamic>>(
  ...
  factory HttpRouteRuleMatch2.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatch2(
      fullPathMatch:
          map['fullPathMatch'] == null ? null : map['fullPathMatch'] as String,
      headerMatches: map['headerMatches'] == null
          ? null
          : Input.decodeList<HttpHeaderMatch2>(
              map['headerMatches'],
              (value) => HttpHeaderMatch2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ignoreCase: map['ignoreCase'] == null ? null : map['ignoreCase'] as bool,
      metadataFilters: map['metadataFilters'] == null
          ? null
          : Input.decodeList<MetadataFilter2>(
              map['metadataFilters'],
              (value) => MetadataFilter2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      queryParameterMatches: map['queryParameterMatches'] == null
          ? null
          : Input.decodeList<HttpQueryParameterMatch2>(
              map['queryParameterMatches'],
              (value) => HttpQueryParameterMatch2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      regexMatch:
