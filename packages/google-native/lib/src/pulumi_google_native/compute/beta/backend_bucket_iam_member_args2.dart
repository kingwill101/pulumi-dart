...
class BackendBucketIamMemberArgs2 {
  ...
  factory BackendBucketIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamMemberArgs2(
