...
import 'image_raw_disk_container_type2.dart';

/// The parameters of the raw disk image.
class ImageRawDisk2 {
  /// The format used to encode and transmit the block device, which should be TAR. This is just a container and transmission format and not a runtime format. Provided by the client when the disk image is created.
  final ImageRawDiskContainerType2? containerType;
  ...
  factory ImageRawDisk2.fromMap(Map<String, dynamic> map) {
    return ImageRawDisk2(
      containerType: map['containerType'] == null
          ? null
          : ImageRawDiskContainerType2.fromValue(
