...
class DiskInstantiationConfigResponse2 {
  ...
  DiskInstantiationConfigResponse2({
  ...
  factory DiskInstantiationConfigResponse2.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfigResponse2(
