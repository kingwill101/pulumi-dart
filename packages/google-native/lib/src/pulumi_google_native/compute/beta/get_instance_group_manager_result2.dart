...
class GetInstanceGroupManagerResult2 {
  ...
  GetInstanceGroupManagerResult2({
  ...
  factory GetInstanceGroupManagerResult2.fromMap(Map<String, dynamic> map) {
    return GetInstanceGroupManagerResult2(
      allInstancesConfig:
