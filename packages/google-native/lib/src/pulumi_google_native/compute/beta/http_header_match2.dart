...
import 'int64_range_match2.dart';

/// matchRule criteria for request header matches.
class HttpHeaderMatch2 {
  ...
  final Int64RangeMatch2? rangeMatch;
  ...
  factory HttpHeaderMatch2.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatch2(
      exactMatch:
