...
class TCPHealthCheckResponseComputeBeta {
  ...
  TCPHealthCheckResponseComputeBeta({
    required this.port,
  ...
  factory TCPHealthCheckResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckResponseComputeBeta(
