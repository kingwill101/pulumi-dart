...
class OutlierDetection2 {
  ...
  final Duration2? baseEjectionTime;
  ...
  factory OutlierDetection2.fromMap(Map<String, dynamic> map) {
    return OutlierDetection2(
      ...
      interval: map['interval'] == null
          ? null
          : Duration2.fromMap((map['interval'] as Map).cast<String, dynamic>()),
