...
class InstancePropertiesComputeBeta {
  ...
  final InstancePropertiesKeyRevocationActionTypeComputeBeta?
  ...
  final InstancePropertiesPostKeyRevocationActionTypeComputeBeta?
      postKeyRevocationActionType;

  /// The private IPv6 google access type for VMs. If not specified, use INHERIT_FROM_SUBNETWORK as default. Note that for MachineImage, this is not supported yet.
  final InstancePropertiesPrivateIpv6GoogleAccessComputeBeta?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (disksValue != null) {
      map['disks'] = pulumi.Input.encodeList<AttachedDiskComputeBeta,
    ...
    if (networkInterfacesValue != null) {
      map['networkInterfaces'] = pulumi.Input.encodeList<
              NetworkInterfaceComputeBeta, Map<String, dynamic>>(
  ...
  factory InstancePropertiesComputeBeta.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesComputeBeta(
      ...
      keyRevocationActionType: map['keyRevocationActionType'] == null
          ? null
          : InstancePropertiesKeyRevocationActionTypeComputeBeta.fromValue(
      ...
      postKeyRevocationActionType: map['postKeyRevocationActionType'] == null
          ? null
          : InstancePropertiesPostKeyRevocationActionTypeComputeBeta.fromValue(
              map['postKeyRevocationActionType'] as String),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null
          ? null
          : InstancePropertiesPrivateIpv6GoogleAccessComputeBeta.fromValue(
