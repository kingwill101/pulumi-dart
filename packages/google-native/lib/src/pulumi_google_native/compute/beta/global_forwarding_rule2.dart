...
class GlobalForwardingRule2 extends CustomResource {
  ...
  late final Output<bool> allowPscPacketInjection;
  ...
  late final Output<List<MetadataFilterResponse2>> metadataFilters;
  ...
  late final Output<List<ForwardingRuleServiceDirectoryRegistrationResponse2>>
  ...
  GlobalForwardingRule2(
    String name, {
    GlobalForwardingRuleArgs2? args,
    ...
    this.allowPscPacketInjection = Output.createUnknown<bool>();
    ...
    this.metadataFilters =
        Output.createUnknown<List<MetadataFilterResponse2>>();
    ...
    this.serviceDirectoryRegistrations = Output.createUnknown<
        List<ForwardingRuleServiceDirectoryRegistrationResponse2>>();
