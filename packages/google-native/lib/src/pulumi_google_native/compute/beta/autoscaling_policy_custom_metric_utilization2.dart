...
import 'autoscaling_policy_custom_metric_utilization_utilization_target_type2.dart';

/// Custom utilization metric policy.
class AutoscalingPolicyCustomMetricUtilization2 {
  ...
  final AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType2?
      utilizationTargetType;

  AutoscalingPolicyCustomMetricUtilization2({
    this.filter,
    this.metric,
  ...
  factory AutoscalingPolicyCustomMetricUtilization2.fromMap(
      Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilization2(
      ...
      utilizationTargetType: map['utilizationTargetType'] == null
          ? null
          : AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType2
