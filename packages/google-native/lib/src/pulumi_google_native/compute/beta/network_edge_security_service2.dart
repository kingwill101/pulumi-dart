...
import 'network_edge_security_service_args2.dart';

/// Creates a new service in the specified project using the data included in the request.
class NetworkEdgeSecurityService2 extends CustomResource {
  ...
  NetworkEdgeSecurityService2(
    String name, {
    NetworkEdgeSecurityServiceArgs2? args,
