...
import 'backend_service_cdn_policy_bypass_cache_on_request_header_compute_beta.dart';
import 'backend_service_cdn_policy_cache_mode_compute_beta.dart';
import 'backend_service_cdn_policy_negative_caching_policy_compute_beta.dart';
import 'cache_key_policy_compute_beta.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicyComputeBeta {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeBeta>?
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final CacheKeyPolicyComputeBeta? cacheKeyPolicy;
  ...
  final BackendServiceCdnPolicyCacheModeComputeBeta? cacheMode;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyComputeBeta>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bypassCacheOnRequestHeadersValue != null) {
      map['bypassCacheOnRequestHeaders'] = pulumi.Input.encodeList<
              BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeBeta,
              Map<String, dynamic>>(
  ...
  factory BackendServiceCdnPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyComputeBeta(
      ...
      cacheKeyPolicy: map['cacheKeyPolicy'] == null
          ? null
          : CacheKeyPolicyComputeBeta.fromMap(
              (map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null
          ? null
          : BackendServiceCdnPolicyCacheModeComputeBeta.fromValue(
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => BackendServiceCdnPolicyNegativeCachingPolicyComputeBeta
                  .fromMap((value as Map).cast<String, dynamic>())),
