...
import 'target_vpn_gateway_args2.dart';

/// Creates a target VPN gateway in the specified project and region using the data included in the request.
class TargetVpnGateway2 extends CustomResource {
  ...
  late final Output<List<String>> tunnels;

  TargetVpnGateway2(
    String name, {
    TargetVpnGatewayArgs2? args,
    ...
    this.tunnels = Output.createUnknown<List<String>>();
  }
}
