...
import 'public_delegated_prefix_public_delegated_sub_prefix2.dart';

/// The set of arguments for GlobalPublicDelegatedPrefix.
class GlobalPublicDelegatedPrefixArgs2 {
  ...
  final Input<List<PublicDelegatedPrefixPublicDelegatedSubPrefix2>>?
  ...
  GlobalPublicDelegatedPrefixArgs2({
    this.description,
    this.ipCidrRange,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (publicDelegatedSubPrefixsValue != null) {
      map['publicDelegatedSubPrefixs'] = Input.mapOptionalInputValue<
              List<PublicDelegatedPrefixPublicDelegatedSubPrefix2>,
              List<Map<String, dynamic>>>(
          publicDelegatedSubPrefixsValue,
          (value) => Input.encodeList<
              PublicDelegatedPrefixPublicDelegatedSubPrefix2,
  ...
  factory GlobalPublicDelegatedPrefixArgs2.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixArgs2(
