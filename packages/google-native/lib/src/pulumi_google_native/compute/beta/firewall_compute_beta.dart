...
class FirewallComputeBeta extends pulumi.CustomResource {
  ...
  FirewallComputeBeta(
    ...
    this.allowed =
        registerOutput<List<FirewallAllowedItemResponseComputeBeta>>('allowed');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.denied =
        registerOutput<List<FirewallDeniedItemResponseComputeBeta>>('denied');
    ...
    this.logConfig =
        registerOutput<FirewallLogConfigResponseComputeBeta>('logConfig');
