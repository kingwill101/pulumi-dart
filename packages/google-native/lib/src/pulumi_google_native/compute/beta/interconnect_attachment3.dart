...
class InterconnectAttachment3 extends CustomResource {
  ...
  late final Output<InterconnectAttachmentConfigurationConstraintsResponse2>
  ...
  late final Output<InterconnectAttachmentPartnerMetadataResponse2>
      partnerMetadata;
  ...
  late final Output<InterconnectAttachmentPrivateInfoResponse2>
  ...
  InterconnectAttachment3(
    ...
    this.configurationConstraints =
        registerOutput<InterconnectAttachmentConfigurationConstraintsResponse2>(
            'configurationConstraints');
    ...
    this.partnerMetadata =
        registerOutput<InterconnectAttachmentPartnerMetadataResponse2>(
            'partnerMetadata');
    this.privateInterconnectInfo =
        registerOutput<InterconnectAttachmentPrivateInfoResponse2>(
            'privateInterconnectInfo');
