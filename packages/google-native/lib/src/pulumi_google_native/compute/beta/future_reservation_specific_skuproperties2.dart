...
class FutureReservationSpecificSKUProperties2 {
  ...
  FutureReservationSpecificSKUProperties2({
  ...
  factory FutureReservationSpecificSKUProperties2.fromMap(
      Map<String, dynamic> map) {
    return FutureReservationSpecificSKUProperties2(
