...
class ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponse2 {
  ...
  factory ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponse2.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponse2(
