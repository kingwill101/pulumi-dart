...
class CustomerEncryptionKeyResponse2 {
  ...
  CustomerEncryptionKeyResponse2({
  ...
  factory CustomerEncryptionKeyResponse2.fromMap(Map<String, dynamic> map) {
    return CustomerEncryptionKeyResponse2(
