...
import 'forwarding_rule_service_directory_registration2.dart';
import 'global_forwarding_rule_ip_protocol2.dart';
import 'global_forwarding_rule_ip_version2.dart';
import 'global_forwarding_rule_load_balancing_scheme2.dart';
import 'global_forwarding_rule_network_tier2.dart';
import 'global_forwarding_rule_psc_connection_status2.dart';
import 'metadata_filter2.dart';

/// The set of arguments for GlobalForwardingRule.
class GlobalForwardingRuleArgs2 {
  ...
  final Input<GlobalForwardingRuleIpProtocol2>? ipProtocol;

  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final Input<GlobalForwardingRuleIpVersion2>? ipVersion;
  ...
  final Input<GlobalForwardingRuleLoadBalancingScheme2>? loadBalancingScheme;
  ...
  final Input<List<MetadataFilter2>>? metadataFilters;
  ...
  final Input<GlobalForwardingRuleNetworkTier2>? networkTier;
  ...
  final Input<GlobalForwardingRulePscConnectionStatus2>? pscConnectionStatus;
  ...
  final Input<List<ForwardingRuleServiceDirectoryRegistration2>>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleIpProtocol2, String>(
              ipProtocolValue, (value) => value.value);
    }
    final ipVersionValue = ipVersion;
    if (ipVersionValue != null) {
      map['ipVersion'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleIpVersion2, String>(
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = Input.mapOptionalInputValue<
          GlobalForwardingRuleLoadBalancingScheme2,
    ...
    if (metadataFiltersValue != null) {
      map['metadataFilters'] = Input.mapOptionalInputValue<
              List<MetadataFilter2>, List<Map<String, dynamic>>>(
          metadataFiltersValue,
          (value) => Input.encodeList<MetadataFilter2, Map<String, dynamic>>(
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleNetworkTier2, String>(
    ...
    if (pscConnectionStatusValue != null) {
      map['pscConnectionStatus'] = Input.mapOptionalInputValue<
          GlobalForwardingRulePscConnectionStatus2,
    ...
    if (serviceDirectoryRegistrationsValue != null) {
      map['serviceDirectoryRegistrations'] = Input.mapOptionalInputValue<
              List<ForwardingRuleServiceDirectoryRegistration2>,
              List<Map<String, dynamic>>>(
          serviceDirectoryRegistrationsValue,
          (value) => Input.encodeList<
              ForwardingRuleServiceDirectoryRegistration2,
  ...
  factory GlobalForwardingRuleArgs2.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleArgs2(
      ...
      ipProtocol: Input.asOptionalInput<GlobalForwardingRuleIpProtocol2>(
          map['ipProtocol']),
      ipVersion: Input.asOptionalInput<GlobalForwardingRuleIpVersion2>(
          map['ipVersion']),
      isMirroringCollector:
          Input.asOptionalInput<bool>(map['isMirroringCollector']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      loadBalancingScheme:
          Input.asOptionalInput<GlobalForwardingRuleLoadBalancingScheme2>(
              map['loadBalancingScheme']),
      metadataFilters:
          Input.asOptionalInput<List<MetadataFilter2>>(map['metadataFilters']),
      name: Input.asOptionalInput<String>(map['name']),
      network: Input.asOptionalInput<String>(map['network']),
      networkTier: Input.asOptionalInput<GlobalForwardingRuleNetworkTier2>(
          map['networkTier']),
      ...
      pscConnectionStatus:
          Input.asOptionalInput<GlobalForwardingRulePscConnectionStatus2>(
