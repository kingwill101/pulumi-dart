...
import 'region_url_map_args2.dart';
import 'url_map_test_response2.dart';

/// Creates a UrlMap resource in the specified project using the data included in the request.
class RegionUrlMap2 extends CustomResource {
  ...
  late final Output<CustomErrorResponsePolicyResponse2>
  ...
  late final Output<HttpRouteActionResponse2> defaultRouteAction;
  ...
  late final Output<HttpRedirectActionResponse2> defaultUrlRedirect;
  ...
  late final Output<HttpHeaderActionResponse2> headerAction;

  /// The list of host rules to use against the URL.
  late final Output<List<HostRuleResponse2>> hostRules;
  ...
  late final Output<List<PathMatcherResponse2>> pathMatchers;
  ...
  late final Output<List<UrlMapTestResponse2>> tests;

  RegionUrlMap2(
    String name, {
    RegionUrlMapArgs2? args,
