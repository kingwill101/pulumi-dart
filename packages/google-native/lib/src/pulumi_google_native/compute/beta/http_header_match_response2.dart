...
import 'int64_range_match_response2.dart';

/// matchRule criteria for request header matches.
class HttpHeaderMatchResponse2 {
  ...
  final Int64RangeMatchResponse2 rangeMatch;
  ...
  factory HttpHeaderMatchResponse2.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatchResponse2(
      ...
      rangeMatch: Int64RangeMatchResponse2.fromMap(
