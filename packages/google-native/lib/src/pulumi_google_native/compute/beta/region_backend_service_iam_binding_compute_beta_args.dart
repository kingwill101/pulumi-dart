...
class RegionBackendServiceIamBindingComputeBetaArgs {
  ...
  RegionBackendServiceIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory RegionBackendServiceIamBindingComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return RegionBackendServiceIamBindingComputeBetaArgs(
