...
import 'security_policy_rule_preconfigured_waf_config_exclusion_field_params2.dart';

class SecurityPolicyRulePreconfiguredWafConfigExclusion2 {
  /// A list of request cookie names whose value will be excluded from inspection during preconfigured WAF evaluation.
  final List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams2>?
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusion2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRulePreconfiguredWafConfigExclusion2(
