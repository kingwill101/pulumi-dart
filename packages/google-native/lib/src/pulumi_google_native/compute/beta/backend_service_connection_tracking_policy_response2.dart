...
class BackendServiceConnectionTrackingPolicyResponse2 {
  ...
  BackendServiceConnectionTrackingPolicyResponse2({
  ...
  factory BackendServiceConnectionTrackingPolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicyResponse2(
      connectionPersistenceOnUnhealthyBackends:
