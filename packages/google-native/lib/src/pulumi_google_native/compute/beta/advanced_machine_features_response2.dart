...
class AdvancedMachineFeaturesResponse2 {
  ...
  AdvancedMachineFeaturesResponse2({
  ...
  factory AdvancedMachineFeaturesResponse2.fromMap(Map<String, dynamic> map) {
    return AdvancedMachineFeaturesResponse2(
