...
class FirewallPolicyIamMemberComputeBetaArgs {
  ...
  FirewallPolicyIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory FirewallPolicyIamMemberComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return FirewallPolicyIamMemberComputeBetaArgs(
