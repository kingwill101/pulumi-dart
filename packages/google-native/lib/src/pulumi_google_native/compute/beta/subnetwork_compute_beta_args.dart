...
class SubnetworkComputeBetaArgs {
  ...
  factory SubnetworkComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkComputeBetaArgs(
      ...
      enableFlowLogs: pulumi.Input.asOptionalInput<bool>(map['enableFlowLogs']),
      externalIpv6Prefix:
      ...
      role:
          pulumi.Input.asOptionalInput<SubnetworkRoleComputeBeta>(map['role']),
      secondaryIpRanges: pulumi.Input.asOptionalInput<
          List<SubnetworkSecondaryRangeComputeBeta>>(map['secondaryIpRanges']),
