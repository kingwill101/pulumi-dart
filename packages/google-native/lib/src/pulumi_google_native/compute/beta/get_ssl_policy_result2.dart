...
class GetSslPolicyResult2 {
  ...
  final List<SslPolicyWarningsItemResponse2> warnings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['warnings'] =
        Input.encodeList<SslPolicyWarningsItemResponse2, Map<String, dynamic>>(
            warnings, (value) => value.toMap());
    return map;
  }

  factory GetSslPolicyResult2.fromMap(Map<String, dynamic> map) {
    return GetSslPolicyResult2(
      ...
      warnings: Input.decodeList<SslPolicyWarningsItemResponse2>(
          map['warnings'],
          (value) => SslPolicyWarningsItemResponse2.fromMap(
