...
class RegionNetworkFirewallPolicyIamBindingArgs2 {
  ...
  RegionNetworkFirewallPolicyIamBindingArgs2({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamBindingArgs2(
