...
class BackendServiceIamBindingArgs2 {
  ...
  factory BackendServiceIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamBindingArgs2(
