...
class ServiceAttachmentIamBindingArgs2 {
  ...
  ServiceAttachmentIamBindingArgs2({
    this.condition,
  ...
  factory ServiceAttachmentIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentIamBindingArgs2(
