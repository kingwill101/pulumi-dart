...
class SecurityPolicyRuleMatcherConfigLayer4Config2 {
  ...
  factory SecurityPolicyRuleMatcherConfigLayer4Config2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherConfigLayer4Config2(
      ipProtocol:
