...
import 'service_attachment_iam_member_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class ServiceAttachmentIamMember2 extends CustomResource {
  ...
  ServiceAttachmentIamMember2(
    String name, {
    ServiceAttachmentIamMemberArgs2? args,
