...
class CustomErrorResponsePolicyCustomErrorResponseRule2 {
  ...
  factory CustomErrorResponsePolicyCustomErrorResponseRule2.fromMap(
      Map<String, dynamic> map) {
    return CustomErrorResponsePolicyCustomErrorResponseRule2(
