...
class ReservationAffinityResponse2 {
  ...
  factory ReservationAffinityResponse2.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityResponse2(
