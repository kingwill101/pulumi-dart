...
class GetSubnetworkResult2 {
  ...
  final SubnetworkLogConfigResponse2 logConfig;
  ...
  final List<SubnetworkSecondaryRangeResponse2> secondaryIpRanges;
  ...
  factory GetSubnetworkResult2.fromMap(Map<String, dynamic> map) {
    return GetSubnetworkResult2(
      ...
      logConfig: SubnetworkLogConfigResponse2.fromMap(
      ...
      secondaryIpRanges: Input.decodeList<SubnetworkSecondaryRangeResponse2>(
          map['secondaryIpRanges'],
          (value) => SubnetworkSecondaryRangeResponse2.fromMap(
