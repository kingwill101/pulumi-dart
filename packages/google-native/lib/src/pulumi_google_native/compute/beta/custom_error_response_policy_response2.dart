...
import 'custom_error_response_policy_custom_error_response_rule_response2.dart';

/// Specifies the custom error response policy that must be applied when the backend service or backend bucket responds with an error.
class CustomErrorResponsePolicyResponse2 {
  ...
  final List<CustomErrorResponsePolicyCustomErrorResponseRuleResponse2>
      errorResponseRules;
  ...
  CustomErrorResponsePolicyResponse2({
  ...
  factory CustomErrorResponsePolicyResponse2.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyResponse2(
      errorResponseRules: Input.decodeList<
              CustomErrorResponsePolicyCustomErrorResponseRuleResponse2>(
          map['errorResponseRules'],
          (value) =>
              CustomErrorResponsePolicyCustomErrorResponseRuleResponse2.fromMap(
