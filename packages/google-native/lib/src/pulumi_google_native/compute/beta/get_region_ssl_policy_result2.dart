...
import 'region_ssl_policy_warnings_item_response2.dart';

/// Result data returned by getRegionSslPolicy.
class GetRegionSslPolicyResult2 {
  ...
  final List<RegionSslPolicyWarningsItemResponse2> warnings;

  GetRegionSslPolicyResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['warnings'] = Input.encodeList<RegionSslPolicyWarningsItemResponse2,
        Map<String, dynamic>>(warnings, (value) => value.toMap());
    return map;
  }

  factory GetRegionSslPolicyResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionSslPolicyResult2(
      ...
      warnings: Input.decodeList<RegionSslPolicyWarningsItemResponse2>(
          map['warnings'],
          (value) => RegionSslPolicyWarningsItemResponse2.fromMap(
