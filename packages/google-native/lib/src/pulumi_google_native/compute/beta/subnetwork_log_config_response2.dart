...
class SubnetworkLogConfigResponse2 {
  ...
  factory SubnetworkLogConfigResponse2.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfigResponse2(
