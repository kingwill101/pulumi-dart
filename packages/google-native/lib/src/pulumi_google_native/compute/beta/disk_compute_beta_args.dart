...
class DiskComputeBetaArgs {
  ...
  factory DiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskComputeBetaArgs(
      architecture: pulumi.Input.asOptionalInput<DiskArchitectureComputeBeta>(
          map['architecture']),
      asyncPrimaryDisk:
      ...
      guestOsFeatures:
          pulumi.Input.asOptionalInput<List<GuestOsFeatureComputeBeta>>(
              map['guestOsFeatures']),
      interface: pulumi.Input.asOptionalInput<DiskInterfaceComputeBeta>(
          map['interface']),
      ...
      params:
          pulumi.Input.asOptionalInput<DiskParamsComputeBeta>(map['params']),
