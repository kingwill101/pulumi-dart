...
class GetRegionTargetHttpsProxyResult2 {
  ...
  GetRegionTargetHttpsProxyResult2({
  ...
  factory GetRegionTargetHttpsProxyResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpsProxyResult2(
