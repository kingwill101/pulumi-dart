...
class NodeTemplateIamBindingArgs2 {
  ...
  factory NodeTemplateIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return NodeTemplateIamBindingArgs2(
