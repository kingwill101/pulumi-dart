...
import 'custom_error_response_policy_custom_error_response_rule2.dart';

/// Specifies the custom error response policy that must be applied when the backend service or backend bucket responds with an error.
class CustomErrorResponsePolicy2 {
  ...
  final List<CustomErrorResponsePolicyCustomErrorResponseRule2>?
      errorResponseRules;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (errorResponseRulesValue != null) {
      map['errorResponseRules'] = Input.encodeList<
              CustomErrorResponsePolicyCustomErrorResponseRule2,
              Map<String, dynamic>>(
          errorResponseRulesValue, (value) => value.toMap());
    }
    final errorServiceValue = errorService;
    if (errorServiceValue != null) {
      map['errorService'] = errorServiceValue;
    }
    return map;
  }

  factory CustomErrorResponsePolicy2.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicy2(
      errorResponseRules: map['errorResponseRules'] == null
          ? null
          : Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRule2>(
              map['errorResponseRules'],
              (value) =>
                  CustomErrorResponsePolicyCustomErrorResponseRule2.fromMap(
                      (value as Map).cast<String, dynamic>())),
      errorService:
          map['errorService'] == null ? null : map['errorService'] as String,
    );
  }
}
