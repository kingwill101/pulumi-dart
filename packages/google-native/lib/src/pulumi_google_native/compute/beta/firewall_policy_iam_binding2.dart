...
import 'firewall_policy_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class FirewallPolicyIamBinding2 extends CustomResource {
  ...
  FirewallPolicyIamBinding2(
    String name, {
    FirewallPolicyIamBindingArgs2? args,
