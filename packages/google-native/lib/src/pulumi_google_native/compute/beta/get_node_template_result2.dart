...
import 'local_disk_response2.dart';
import 'node_template_node_type_flexibility_response2.dart';
import 'server_binding_response2.dart';

/// Result data returned by getNodeTemplate.
class GetNodeTemplateResult2 {
  final List<AcceleratorConfigResponse2> accelerators;
  ...
  final List<LocalDiskResponse2> disks;
  ...
  final NodeTemplateNodeTypeFlexibilityResponse2 nodeTypeFlexibility;
  ...
  final ServerBindingResponse2 serverBinding;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['disks'] = Input.encodeList<LocalDiskResponse2, Map<String, dynamic>>(
  ...
  factory GetNodeTemplateResult2.fromMap(Map<String, dynamic> map) {
    return GetNodeTemplateResult2(
      accelerators: Input.decodeList<AcceleratorConfigResponse2>(
          map['accelerators'],
      ...
      disks: Input.decodeList<LocalDiskResponse2>(
          map['disks'],
          (value) => LocalDiskResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      nodeTypeFlexibility: NodeTemplateNodeTypeFlexibilityResponse2.fromMap(
          (map['nodeTypeFlexibility'] as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      serverBinding: ServerBindingResponse2.fromMap(
