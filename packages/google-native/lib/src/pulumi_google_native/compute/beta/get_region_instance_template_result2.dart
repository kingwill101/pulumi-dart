...
class GetRegionInstanceTemplateResult2 {
  ...
  GetRegionInstanceTemplateResult2({
  ...
  factory GetRegionInstanceTemplateResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateResult2(
