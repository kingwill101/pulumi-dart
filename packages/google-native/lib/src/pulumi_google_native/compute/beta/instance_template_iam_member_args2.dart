...
class InstanceTemplateIamMemberArgs2 {
  ...
  InstanceTemplateIamMemberArgs2({
    this.condition,
  ...
  factory InstanceTemplateIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateIamMemberArgs2(
