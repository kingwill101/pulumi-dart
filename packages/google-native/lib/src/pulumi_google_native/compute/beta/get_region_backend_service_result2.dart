...
class GetRegionBackendServiceResult2 {
  ...
  final List<BackendResponse2> backends;

  /// Cloud CDN configuration for this BackendService. Only available for specified load balancer types.
  final BackendServiceCdnPolicyResponse2 cdnPolicy;
  final CircuitBreakersResponse2 circuitBreakers;

  /// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
  final String compressionMode;
  final ConnectionDrainingResponse2 connectionDraining;

  /// Connection Tracking configuration for this BackendService. Connection tracking policy settings are only available for Network Load Balancing and Internal TCP/UDP Load Balancing.
  final BackendServiceConnectionTrackingPolicyResponse2
  ...
  final ConsistentHashLoadBalancerSettingsResponse2 consistentHash;
  ...
  final BackendServiceFailoverPolicyResponse2 failoverPolicy;
  ...
  final BackendServiceIAPResponse2 iap;
  ...
  final List<BackendServiceLocalityLoadBalancingPolicyConfigResponse2>
      localityLbPolicies;
  ...
  final OutlierDetectionResponse2 outlierDetection;
  ...
  final SecuritySettingsResponse2 securitySettings;
  ...
  final SubsettingResponse2 subsetting;

  /// The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration.
  final int timeoutSec;
  final List<BackendServiceUsedByResponse2> usedBy;

  GetRegionBackendServiceResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['backends'] = Input.encodeList<BackendResponse2, Map<String, dynamic>>(
    ...
    map['usedBy'] =
        Input.encodeList<BackendServiceUsedByResponse2, Map<String, dynamic>>(
            usedBy, (value) => value.toMap());
    return map;
  }

  factory GetRegionBackendServiceResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceResult2(
      affinityCookieTtlSec: map['affinityCookieTtlSec'] as int,
      backends: Input.decodeList<BackendResponse2>(
          map['backends'],
          (value) =>
              BackendResponse2.fromMap((value as Map).cast<String, dynamic>())),
      cdnPolicy: BackendServiceCdnPolicyResponse2.fromMap(
          (map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: CircuitBreakersResponse2.fromMap(
          (map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] as String,
      connectionDraining: ConnectionDrainingResponse2.fromMap(
          (map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy:
          BackendServiceConnectionTrackingPolicyResponse2.fromMap(
              (map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: ConsistentHashLoadBalancerSettingsResponse2.fromMap(
      ...
      localityLbPolicies: Input.decodeList<
          ...
          (value) =>
              BackendServiceLocalityLoadBalancingPolicyConfigResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] as String,
      logConfig: BackendServiceLogConfigResponse2.fromMap(
          (map['logConfig'] as Map).cast<String, dynamic>()),
      maxStreamDuration: DurationResponse2.fromMap(
          (map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      metadatas: (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] as String,
      network: map['network'] as String,
      outlierDetection: OutlierDetectionResponse2.fromMap(
      ...
      securitySettings: SecuritySettingsResponse2.fromMap(
      ...
      subsetting: SubsettingResponse2.fromMap(
          (map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] as int,
      usedBy: Input.decodeList<BackendServiceUsedByResponse2>(
          map['usedBy'],
          (value) => BackendServiceUsedByResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
