...
class PacketMirroringFilter2 {
  ...
  factory PacketMirroringFilter2.fromMap(Map<String, dynamic> map) {
    return PacketMirroringFilter2(
      cidrRanges: map['cidrRanges'] == null
          ? null
          : (map['cidrRanges'] as List).cast<String>(),
      direction: map['direction'] == null
          ? null
          : PacketMirroringFilterDirection2.fromValue(
