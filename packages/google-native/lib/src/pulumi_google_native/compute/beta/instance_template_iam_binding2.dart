...
import 'instance_template_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class InstanceTemplateIamBinding2 extends CustomResource {
  ...
  InstanceTemplateIamBinding2(
    String name, {
    InstanceTemplateIamBindingArgs2? args,
