...
import 'region_target_https_proxy_quic_override2.dart';

/// The set of arguments for RegionTargetHttpsProxy.
class RegionTargetHttpsProxyArgs2 {
  ...
  final Input<RegionTargetHttpsProxyQuicOverride2>? quicOverride;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (quicOverrideValue != null) {
      map['quicOverride'] = Input.mapOptionalInputValue<
          RegionTargetHttpsProxyQuicOverride2,
  ...
  factory RegionTargetHttpsProxyArgs2.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyArgs2(
      ...
      quicOverride: Input.asOptionalInput<RegionTargetHttpsProxyQuicOverride2>(
          map['quicOverride']),
