...
import 'security_policy_rule_network_matcher_user_defined_field_match2.dart';

/// Represents a match condition that incoming network traffic is evaluated against.
class SecurityPolicyRuleNetworkMatcher2 {
  ...
  final List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatch2>?
      userDefinedFields;

  SecurityPolicyRuleNetworkMatcher2({
    this.destIpRanges,
    this.destPorts,
    this.ipProtocols,
    this.srcAsns,
  ...
  factory SecurityPolicyRuleNetworkMatcher2.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcher2(
      ...
      userDefinedFields: map['userDefinedFields'] == null
          ...
          : Input.decodeList<
              ...
              (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatch2
