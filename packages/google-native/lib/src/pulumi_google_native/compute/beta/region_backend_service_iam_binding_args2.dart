...
class RegionBackendServiceIamBindingArgs2 {
  ...
  RegionBackendServiceIamBindingArgs2({
    this.condition,
  ...
  factory RegionBackendServiceIamBindingArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionBackendServiceIamBindingArgs2(
