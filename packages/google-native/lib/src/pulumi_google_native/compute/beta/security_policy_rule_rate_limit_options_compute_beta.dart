...
class SecurityPolicyRuleRateLimitOptionsComputeBeta {
  ...
  final SecurityPolicyRuleRateLimitOptionsThresholdComputeBeta? banThreshold;
  ...
  final SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeBeta? enforceOnKey;

  /// If specified, any combination of values of enforce_on_key_type/enforce_on_key_name is treated as the key on which ratelimit threshold/action is enforced. You can specify up to 3 enforce_on_key_configs. If enforce_on_key_configs is specified, enforce_on_key must not be specified.
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta>?
      enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRedirectOptionsComputeBeta? exceedRedirectOptions;

  /// Threshold at which to begin ratelimiting.
  final SecurityPolicyRuleRateLimitOptionsThresholdComputeBeta?
      rateLimitThreshold;
  ...
  factory SecurityPolicyRuleRateLimitOptionsComputeBeta.fromMap(
    ...
    return SecurityPolicyRuleRateLimitOptionsComputeBeta(
      ...
      banThreshold: map['banThreshold'] == null
          ? null
          : SecurityPolicyRuleRateLimitOptionsThresholdComputeBeta.fromMap(
      ...
      enforceOnKey: map['enforceOnKey'] == null
          ? null
          : SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeBeta.fromValue(
