...
import 'router_advertised_ip_range_response2.dart';
import 'router_bgp_peer_bfd_response2.dart';
import 'router_bgp_peer_custom_learned_ip_range_response2.dart';

class RouterBgpPeerResponse2 {
  ...
  final List<RouterAdvertisedIpRangeResponse2> advertisedIpRanges;

  /// The priority of routes advertised to this BGP peer. Where there is more than one matching route of maximum length, the routes with the lowest priority value win.
  final int advertisedRoutePriority;

  /// BFD configuration for the BGP peering.
  final RouterBgpPeerBfdResponse2 bfd;

  /// A list of user-defined custom learned route IP address ranges for a BGP session.
  final List<RouterBgpPeerCustomLearnedIpRangeResponse2> customLearnedIpRanges;
  ...
  factory RouterBgpPeerResponse2.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponse2(
      advertiseMode: map['advertiseMode'] as String,
      advertisedGroups: (map['advertisedGroups'] as List).cast<String>(),
      advertisedIpRanges: Input.decodeList<RouterAdvertisedIpRangeResponse2>(
          map['advertisedIpRanges'],
          (value) => RouterAdvertisedIpRangeResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      advertisedRoutePriority: map['advertisedRoutePriority'] as int,
      bfd: RouterBgpPeerBfdResponse2.fromMap(
          (map['bfd'] as Map).cast<String, dynamic>()),
      customLearnedIpRanges:
          Input.decodeList<RouterBgpPeerCustomLearnedIpRangeResponse2>(
              map['customLearnedIpRanges'],
              (value) => RouterBgpPeerCustomLearnedIpRangeResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
