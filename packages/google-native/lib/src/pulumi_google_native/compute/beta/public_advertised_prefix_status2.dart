...
enum PublicAdvertisedPrefixStatus2 {
  ...
  const PublicAdvertisedPrefixStatus2(this.value);
  final String value;

  static PublicAdvertisedPrefixStatus2 fromValue(String value) {
    for (final item in PublicAdvertisedPrefixStatus2.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown PublicAdvertisedPrefixStatus2 value: $value');
  }
}
