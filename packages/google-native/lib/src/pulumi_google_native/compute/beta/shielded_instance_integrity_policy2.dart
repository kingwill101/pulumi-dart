...
class ShieldedInstanceIntegrityPolicy2 {
  /// Updates the integrity policy baseline using the measurements from the VM instance's most recent boot.
  final bool? updateAutoLearnPolicy;

  ShieldedInstanceIntegrityPolicy2({
  ...
  factory ShieldedInstanceIntegrityPolicy2.fromMap(Map<String, dynamic> map) {
    return ShieldedInstanceIntegrityPolicy2(
