...
class Interconnect2 extends CustomResource {
  ...
  Interconnect2(
    ...
    this.circuitInfos =
        Output.createUnknown<List<InterconnectCircuitInfoResponse2>>();
    this.creationTimestamp = Output.createUnknown<String>();
    this.customerName = Output.createUnknown<String>();
    this.description = Output.createUnknown<String>();
    this.expectedOutages =
        Output.createUnknown<List<InterconnectOutageNotificationResponse2>>();
    ...
    this.macsec = Output.createUnknown<InterconnectMacsecResponse2>();
