...
import 'region_health_check_service_health_status_aggregation_policy2.dart';
import 'region_health_check_service_health_status_aggregation_strategy2.dart';

/// The set of arguments for RegionHealthCheckService.
class RegionHealthCheckServiceArgs2 {
  ...
  final Input<RegionHealthCheckServiceHealthStatusAggregationPolicy2>?
  ...
  final Input<RegionHealthCheckServiceHealthStatusAggregationStrategy2>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (healthStatusAggregationPolicyValue != null) {
      map['healthStatusAggregationPolicy'] = Input.mapOptionalInputValue<
          RegionHealthCheckServiceHealthStatusAggregationPolicy2,
    ...
    if (healthStatusAggregationStrategyValue != null) {
      map['healthStatusAggregationStrategy'] = Input.mapOptionalInputValue<
          RegionHealthCheckServiceHealthStatusAggregationStrategy2,
          String>(healthStatusAggregationStrategyValue, (value) => value.value);
    }
  ...
  factory RegionHealthCheckServiceArgs2.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckServiceArgs2(
      ...
      healthStatusAggregationStrategy: Input.asOptionalInput<
              RegionHealthCheckServiceHealthStatusAggregationStrategy2>(
