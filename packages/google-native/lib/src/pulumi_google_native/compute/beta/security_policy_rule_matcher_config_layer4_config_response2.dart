...
class SecurityPolicyRuleMatcherConfigLayer4ConfigResponse2 {
  ...
  factory SecurityPolicyRuleMatcherConfigLayer4ConfigResponse2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherConfigLayer4ConfigResponse2(
