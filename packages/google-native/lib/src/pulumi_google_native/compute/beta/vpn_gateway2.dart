...
class VpnGateway2 extends CustomResource {
  ...
  late final Output<List<VpnGatewayVpnGatewayInterfaceResponse2>> vpnInterfaces;

  VpnGateway2(
    String name, {
    VpnGatewayArgs2? args,
    ...
    this.vpnInterfaces =
        Output.createUnknown<List<VpnGatewayVpnGatewayInterfaceResponse2>>();
  }
}
