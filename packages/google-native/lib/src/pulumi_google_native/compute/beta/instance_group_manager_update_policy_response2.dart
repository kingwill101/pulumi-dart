...
class InstanceGroupManagerUpdatePolicyResponse2 {
  ...
  final FixedOrPercentResponse2 maxSurge;
  ...
  final FixedOrPercentResponse2 maxUnavailable;
  ...
  InstanceGroupManagerUpdatePolicyResponse2({
  ...
  factory InstanceGroupManagerUpdatePolicyResponse2.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyResponse2(
      instanceRedistributionType: map['instanceRedistributionType'] as String,
      maxSurge: FixedOrPercentResponse2.fromMap(
          (map['maxSurge'] as Map).cast<String, dynamic>()),
      maxUnavailable: FixedOrPercentResponse2.fromMap(
