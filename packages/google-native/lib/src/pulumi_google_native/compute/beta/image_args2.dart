...
import 'deprecation_status2.dart';
import 'guest_os_feature2.dart';
import 'image_architecture2.dart';
import 'image_raw_disk2.dart';
import 'image_source_type2.dart';
import 'initial_state_config2.dart';
import 'rollout_policy2.dart';

/// The set of arguments for Image.
class ImageArgs2 {
  /// The architecture of the image. Valid values are ARM64 or X86_64.
  final Input<ImageArchitecture2>? architecture;

  /// Size of the image tar.gz archive stored in Google Cloud Storage (in bytes).
  final Input<String>? archiveSizeBytes;

  /// The deprecation status associated with this image.
  final Input<DeprecationStatus2>? deprecated;
  ...
  final Input<List<GuestOsFeature2>>? guestOsFeatures;

  /// Encrypts the image using a customer-supplied encryption key. After you encrypt an image with a customer-supplied key, you must provide the same key if you use the image later (e.g. to create a disk from the image). Customer-supplied encryption keys do not protect access to metadata of the disk. If you do not provide an encryption key when creating the image, then the disk will be encrypted using an automatically generated key and you do not need to provide a key to use the image later.
  final Input<CustomerEncryptionKey2>? imageEncryptionKey;
  ...
  final Input<ImageRawDisk2>? rawDisk;
  ...
  final Input<RolloutPolicy2>? rolloutOverride;

  /// Set the secure boot keys of shielded instance.
  final Input<InitialStateConfig2>? shieldedInstanceInitialState;
  ...
  final Input<CustomerEncryptionKey2>? sourceImageEncryptionKey;
  ...
  final Input<CustomerEncryptionKey2>? sourceSnapshotEncryptionKey;

  /// The type of the image used to create this disk. The default and only valid value is RAW.
  final Input<ImageSourceType2>? sourceType;

  /// Cloud Storage bucket storage location of the image (regional or multi-regional).
  final Input<List<String>>? storageLocations;

  /// A list of publicly visible user-licenses. Unlike regular licenses, user provided licenses can be modified after the disk is created. This includes a list of URLs to the license resource. For example, to provide a debian license: https://www.googleapis.com/compute/v1/projects/debian-cloud/global/licenses/debian-9-stretch
  final Input<List<String>>? userLicenses;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (architectureValue != null) {
      map['architecture'] =
          Input.mapOptionalInputValue<ImageArchitecture2, String>(
    ...
    if (deprecatedValue != null) {
      map['deprecated'] =
          Input.mapOptionalInputValue<DeprecationStatus2, Map<String, dynamic>>(
    ...
    if (guestOsFeaturesValue != null) {
      map['guestOsFeatures'] = Input.mapOptionalInputValue<
              List<GuestOsFeature2>, List<Map<String, dynamic>>>(
          guestOsFeaturesValue,
          (value) => Input.encodeList<GuestOsFeature2, Map<String, dynamic>>(
    ...
    if (rawDiskValue != null) {
      map['rawDisk'] =
          Input.mapOptionalInputValue<ImageRawDisk2, Map<String, dynamic>>(
    ...
    if (rolloutOverrideValue != null) {
      map['rolloutOverride'] =
          Input.mapOptionalInputValue<RolloutPolicy2, Map<String, dynamic>>(
              rolloutOverrideValue, (value) => value.toMap());
    }
    ...
    if (shieldedInstanceInitialStateValue != null) {
      map['shieldedInstanceInitialState'] = Input.mapOptionalInputValue<
              InitialStateConfig2, Map<String, dynamic>>(
    ...
    if (sourceTypeValue != null) {
      map['sourceType'] = Input.mapOptionalInputValue<ImageSourceType2, String>(
  ...
  factory ImageArgs2.fromMap(Map<String, dynamic> map) {
    return ImageArgs2(
      architecture:
          Input.asOptionalInput<ImageArchitecture2>(map['architecture']),
      archiveSizeBytes: Input.asOptionalInput<String>(map['archiveSizeBytes']),
      deprecated: Input.asOptionalInput<DeprecationStatus2>(map['deprecated']),
      ...
      guestOsFeatures:
          Input.asOptionalInput<List<GuestOsFeature2>>(map['guestOsFeatures']),
      imageEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey2>(
      ...
      rawDisk: Input.asOptionalInput<ImageRawDisk2>(map['rawDisk']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      rolloutOverride:
          Input.asOptionalInput<RolloutPolicy2>(map['rolloutOverride']),
      shieldedInstanceInitialState: Input.asOptionalInput<InitialStateConfig2>(
      ...
      sourceImageEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey2>(
      ...
      sourceType: Input.asOptionalInput<ImageSourceType2>(map['sourceType']),
      storageLocations:
          Input.asOptionalInput<List<String>>(map['storageLocations']),
      userLicenses: Input.asOptionalInput<List<String>>(map['userLicenses']),
    );
  }
}
