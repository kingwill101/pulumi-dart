...
import 'http_filter_config_response2.dart';
...
import 'http_route_rule_match_response2.dart';

/// The HttpRouteRule setting specifies how to match an HTTP request and the corresponding routing action that load balancing proxies perform.
class HttpRouteRuleResponse2 {
  ...
  final List<HttpFilterConfigResponse2> httpFilterConfigs;
  ...
  final List<HttpFilterConfigResponse2> httpFilterMetadata;

  /// The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
  final List<HttpRouteRuleMatchResponse2> matchRules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['httpFilterConfigs'] =
        Input.encodeList<HttpFilterConfigResponse2, Map<String, dynamic>>(
            httpFilterConfigs, (value) => value.toMap());
    map['httpFilterMetadata'] =
        Input.encodeList<HttpFilterConfigResponse2, Map<String, dynamic>>(
            httpFilterMetadata, (value) => value.toMap());
    map['matchRules'] =
        Input.encodeList<HttpRouteRuleMatchResponse2, Map<String, dynamic>>(
  ...
  factory HttpRouteRuleResponse2.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponse2(
      ...
      httpFilterConfigs: Input.decodeList<HttpFilterConfigResponse2>(
          map['httpFilterConfigs'],
          (value) => HttpFilterConfigResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      httpFilterMetadata: Input.decodeList<HttpFilterConfigResponse2>(
          map['httpFilterMetadata'],
          (value) => HttpFilterConfigResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      matchRules: Input.decodeList<HttpRouteRuleMatchResponse2>(
          map['matchRules'],
          (value) => HttpRouteRuleMatchResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
