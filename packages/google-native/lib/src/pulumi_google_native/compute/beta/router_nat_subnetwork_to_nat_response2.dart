...
class RouterNatSubnetworkToNatResponse2 {
  ...
  RouterNatSubnetworkToNatResponse2({
    required this.name,
  ...
  factory RouterNatSubnetworkToNatResponse2.fromMap(Map<String, dynamic> map) {
    return RouterNatSubnetworkToNatResponse2(
