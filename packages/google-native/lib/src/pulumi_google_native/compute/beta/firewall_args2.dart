...
import 'firewall_allowed_item2.dart';
import 'firewall_denied_item2.dart';
import 'firewall_direction2.dart';
import 'firewall_log_config2.dart';

/// The set of arguments for Firewall.
class FirewallArgs2 {
  /// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
  final Input<List<FirewallAllowedItem2>>? allowed;

  /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
  final Input<List<FirewallDeniedItem2>>? denied;
  ...
  final Input<FirewallDirection2>? direction;
  ...
  final Input<FirewallLogConfig2>? logConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (allowedValue != null) {
      map['allowed'] = Input.mapOptionalInputValue<List<FirewallAllowedItem2>,
              List<Map<String, dynamic>>>(
          allowedValue,
          (value) =>
              Input.encodeList<FirewallAllowedItem2, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    final deniedValue = denied;
    if (deniedValue != null) {
      map['denied'] = Input.mapOptionalInputValue<List<FirewallDeniedItem2>,
              List<Map<String, dynamic>>>(
          deniedValue,
          (value) =>
              Input.encodeList<FirewallDeniedItem2, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
    ...
    if (directionValue != null) {
      map['direction'] =
          Input.mapOptionalInputValue<FirewallDirection2, String>(
    ...
    if (logConfigValue != null) {
      map['logConfig'] =
          Input.mapOptionalInputValue<FirewallLogConfig2, Map<String, dynamic>>(
  ...
  factory FirewallArgs2.fromMap(Map<String, dynamic> map) {
    return FirewallArgs2(
      allowed:
          Input.asOptionalInput<List<FirewallAllowedItem2>>(map['allowed']),
      denied: Input.asOptionalInput<List<FirewallDeniedItem2>>(map['denied']),
      description: Input.asOptionalInput<String>(map['description']),
      destinationRanges:
          Input.asOptionalInput<List<String>>(map['destinationRanges']),
      direction: Input.asOptionalInput<FirewallDirection2>(map['direction']),
      disabled: Input.asOptionalInput<bool>(map['disabled']),
      enableLogging: Input.asOptionalInput<bool>(map['enableLogging']),
      logConfig: Input.asOptionalInput<FirewallLogConfig2>(map['logConfig']),
