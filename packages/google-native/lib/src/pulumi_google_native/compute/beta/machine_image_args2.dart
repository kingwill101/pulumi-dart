...
import 'saved_disk2.dart';
import 'source_disk_encryption_key2.dart';

/// The set of arguments for MachineImage.
class MachineImageArgs2 {
  ...
  final Input<CustomerEncryptionKey2>? machineImageEncryptionKey;
  ...
  final Input<List<SavedDisk2>>? savedDisks;

  /// [Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.
  final Input<List<SourceDiskEncryptionKey2>>? sourceDiskEncryptionKeys;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (savedDisksValue != null) {
      map['savedDisks'] = Input.mapOptionalInputValue<List<SavedDisk2>,
              List<Map<String, dynamic>>>(
          savedDisksValue,
          (value) => Input.encodeList<SavedDisk2, Map<String, dynamic>>(
    ...
    if (sourceDiskEncryptionKeysValue != null) {
      map['sourceDiskEncryptionKeys'] = Input.mapOptionalInputValue<
              List<SourceDiskEncryptionKey2>, List<Map<String, dynamic>>>(
          sourceDiskEncryptionKeysValue,
          (value) =>
              Input.encodeList<SourceDiskEncryptionKey2, Map<String, dynamic>>(
                  value, (value) => value.toMap()));
    }
  ...
  factory MachineImageArgs2.fromMap(Map<String, dynamic> map) {
    return MachineImageArgs2(
      description: Input.asOptionalInput<String>(map['description']),
      guestFlush: Input.asOptionalInput<bool>(map['guestFlush']),
      machineImageEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey2>(
          map['machineImageEncryptionKey']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      savedDisks: Input.asOptionalInput<List<SavedDisk2>>(map['savedDisks']),
      sourceDiskEncryptionKeys:
          Input.asOptionalInput<List<SourceDiskEncryptionKey2>>(
