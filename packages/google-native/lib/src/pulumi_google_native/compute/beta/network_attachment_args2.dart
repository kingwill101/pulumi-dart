...
import 'network_attachment_connection_preference2.dart';

/// The set of arguments for NetworkAttachment.
class NetworkAttachmentArgs2 {
  final Input<NetworkAttachmentConnectionPreference2>? connectionPreference;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (connectionPreferenceValue != null) {
      map['connectionPreference'] = Input.mapOptionalInputValue<
          NetworkAttachmentConnectionPreference2,
  ...
  factory NetworkAttachmentArgs2.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentArgs2(
      connectionPreference:
          Input.asOptionalInput<NetworkAttachmentConnectionPreference2>(
