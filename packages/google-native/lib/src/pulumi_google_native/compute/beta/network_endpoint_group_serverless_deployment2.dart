...
class NetworkEndpointGroupServerlessDeployment2 {
  ...
  NetworkEndpointGroupServerlessDeployment2({
    this.platform,
    this.resource,
    this.urlMask,
    this.version,
  ...
  factory NetworkEndpointGroupServerlessDeployment2.fromMap(
      Map<String, dynamic> map) {
    return NetworkEndpointGroupServerlessDeployment2(
