...
import 'region_health_check_service_args2.dart';

/// Creates a regional HealthCheckService resource in the specified project and region using the data included in the request.
class RegionHealthCheckService2 extends CustomResource {
  ...
  RegionHealthCheckService2(
    String name, {
    RegionHealthCheckServiceArgs2? args,
