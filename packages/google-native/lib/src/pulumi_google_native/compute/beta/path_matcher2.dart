...
import 'http_route_rule2.dart';
import 'path_rule2.dart';
...
class PathMatcher2 {
  ...
  final CustomErrorResponsePolicy2? defaultCustomErrorResponsePolicy;
  ...
  final HttpRouteAction2? defaultRouteAction;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (defaultCustomErrorResponsePolicyValue != null) {
      map['defaultCustomErrorResponsePolicy'] =
          defaultCustomErrorResponsePolicyValue.toMap();
    }
