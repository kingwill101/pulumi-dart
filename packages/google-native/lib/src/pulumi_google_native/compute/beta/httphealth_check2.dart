...
import 'httphealth_check_port_specification2.dart';
import 'httphealth_check_proxy_header2.dart';

class HTTPHealthCheck2 {
  ...
  final HTTPHealthCheckPortSpecification2? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTPHealthCheckProxyHeader2? proxyHeader;
  ...
  factory HTTPHealthCheck2.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheck2(
      ...
      portSpecification: map['portSpecification'] == null
          ? null
          : HTTPHealthCheckPortSpecification2.fromValue(
              map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null
          ? null
          : HTTPHealthCheckProxyHeader2.fromValue(map['proxyHeader'] as String),
      requestPath:
