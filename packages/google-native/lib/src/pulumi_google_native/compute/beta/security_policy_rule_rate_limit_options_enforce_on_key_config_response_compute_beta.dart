...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta {
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta(
