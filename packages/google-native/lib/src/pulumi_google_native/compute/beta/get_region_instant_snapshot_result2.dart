...
class GetRegionInstantSnapshotResult2 {
  ...
  GetRegionInstantSnapshotResult2({
  ...
  factory GetRegionInstantSnapshotResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionInstantSnapshotResult2(
