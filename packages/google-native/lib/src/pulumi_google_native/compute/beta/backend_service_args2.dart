...
import 'backend_service_compression_mode2.dart';
...
import 'backend_service_ip_address_selection_policy2.dart';
import 'backend_service_load_balancing_scheme2.dart';
import 'backend_service_locality_lb_policy2.dart';
import 'backend_service_locality_load_balancing_policy_config2.dart';
import 'backend_service_log_config2.dart';
import 'backend_service_protocol2.dart';
import 'backend_service_session_affinity2.dart';
...
class BackendServiceArgs2 {
  ...
  final Input<BackendServiceCompressionMode2>? compressionMode;
  ...
  final Input<BackendServiceIpAddressSelectionPolicy2>?
      ipAddressSelectionPolicy;

  /// Specifies the load balancer type. A backend service created for one type of load balancer cannot be used with another. For more information, refer to Choosing a load balancer.
  final Input<BackendServiceLoadBalancingScheme2>? loadBalancingScheme;
  ...
  final Input<BackendServiceLocalityLbPolicy2>? localityLbPolicy;
  ...
  final Input<BackendServiceProtocol2>? protocol;
  ...
  final Input<BackendServiceSessionAffinity2>? sessionAffinity;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (compressionModeValue != null) {
      map['compressionMode'] =
          Input.mapOptionalInputValue<BackendServiceCompressionMode2, String>(
    ...
    if (ipAddressSelectionPolicyValue != null) {
      map['ipAddressSelectionPolicy'] = Input.mapOptionalInputValue<
          BackendServiceIpAddressSelectionPolicy2,
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = Input.mapOptionalInputValue<
          BackendServiceLoadBalancingScheme2,
    ...
    if (localityLbPolicyValue != null) {
      map['localityLbPolicy'] =
          Input.mapOptionalInputValue<BackendServiceLocalityLbPolicy2, String>(
    ...
    if (protocolValue != null) {
      map['protocol'] =
          Input.mapOptionalInputValue<BackendServiceProtocol2, String>(
    ...
    if (sessionAffinityValue != null) {
      map['sessionAffinity'] =
          Input.mapOptionalInputValue<BackendServiceSessionAffinity2, String>(
  ...
  factory BackendServiceArgs2.fromMap(Map<String, dynamic> map) {
    return BackendServiceArgs2(
      ...
      compressionMode: Input.asOptionalInput<BackendServiceCompressionMode2>(
          map['compressionMode']),
      connectionDraining:
      ...
      ipAddressSelectionPolicy:
          Input.asOptionalInput<BackendServiceIpAddressSelectionPolicy2>(
              map['ipAddressSelectionPolicy']),
      loadBalancingScheme:
          Input.asOptionalInput<BackendServiceLoadBalancingScheme2>(
              map['loadBalancingScheme']),
      localityLbPolicies: Input.asOptionalInput<
              List<BackendServiceLocalityLoadBalancingPolicyConfig2>>(
          map['localityLbPolicies']),
      localityLbPolicy: Input.asOptionalInput<BackendServiceLocalityLbPolicy2>(
          map['localityLbPolicy']),
      logConfig:
      ...
      protocol: Input.asOptionalInput<BackendServiceProtocol2>(map['protocol']),
      ...
      sessionAffinity: Input.asOptionalInput<BackendServiceSessionAffinity2>(
          map['sessionAffinity']),
