...
class AutoscalingPolicyResponseComputeBeta {
  ...
  final AutoscalingPolicyCpuUtilizationResponseComputeBeta cpuUtilization;

  /// Configuration parameters of autoscaling based on a custom metric.
  final List<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta>
      customMetricUtilizations;

  /// Configuration parameters of autoscaling based on load balancer.
  final AutoscalingPolicyLoadBalancingUtilizationResponseComputeBeta
  ...
  final String mode;
  final AutoscalingPolicyScaleDownControlResponseComputeBeta scaleDownControl;
  final AutoscalingPolicyScaleInControlResponseComputeBeta scaleInControl;
  ...
  factory AutoscalingPolicyResponseComputeBeta.fromMap(
    ...
    return AutoscalingPolicyResponseComputeBeta(
      ...
      customMetricUtilizations: pulumi.Input.decodeList<
          ...
          (value) => AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta
