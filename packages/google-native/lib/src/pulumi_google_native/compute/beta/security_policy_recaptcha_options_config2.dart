...
class SecurityPolicyRecaptchaOptionsConfig2 {
  ...
  factory SecurityPolicyRecaptchaOptionsConfig2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRecaptchaOptionsConfig2(
