...
class SnapshotIamBindingComputeBetaArgs {
  ...
  SnapshotIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory SnapshotIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotIamBindingComputeBetaArgs(
