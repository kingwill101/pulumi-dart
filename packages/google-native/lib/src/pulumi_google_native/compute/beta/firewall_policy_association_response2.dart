...
class FirewallPolicyAssociationResponse2 {
  ...
  FirewallPolicyAssociationResponse2({
  ...
  factory FirewallPolicyAssociationResponse2.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyAssociationResponse2(
