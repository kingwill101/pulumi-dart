...
class GetRegionTargetHttpProxyResult2 {
  ...
  GetRegionTargetHttpProxyResult2({
  ...
  factory GetRegionTargetHttpProxyResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpProxyResult2(
