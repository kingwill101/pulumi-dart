...
class ResourcePolicySnapshotSchedulePolicySnapshotProperties2 {
  ...
  ResourcePolicySnapshotSchedulePolicySnapshotProperties2({
    this.chainName,
    this.guestFlush,
    this.labels,
  ...
  factory ResourcePolicySnapshotSchedulePolicySnapshotProperties2.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicySnapshotProperties2(
