...
class SecurityPolicyRuleNetworkMatcherResponse2 {
  ...
  final List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponse2>
      userDefinedFields;

  SecurityPolicyRuleNetworkMatcherResponse2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['userDefinedFields'] = Input.encodeList<
        SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponse2,
        Map<String, dynamic>>(userDefinedFields, (value) => value.toMap());
    return map;
  }

  factory SecurityPolicyRuleNetworkMatcherResponse2.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherResponse2(
