...
class NetworkAttachmentConnectedEndpointResponseComputeBeta {
  ...
  factory NetworkAttachmentConnectedEndpointResponseComputeBeta.fromMap(
      Map<String, dynamic> map) {
    return NetworkAttachmentConnectedEndpointResponseComputeBeta(
