...
class GetServiceAttachmentResult2 {
  ...
  final Uint128Response2 pscServiceAttachmentId;
  ...
  final ServiceAttachmentTunnelingConfigResponse2 tunnelingConfig;

  GetServiceAttachmentResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['connectedEndpoints'] = Input.encodeList<
        ServiceAttachmentConnectedEndpointResponse2,
    ...
    map['consumerAcceptLists'] = Input.encodeList<
        ServiceAttachmentConsumerProjectLimitResponse2,
  ...
  factory GetServiceAttachmentResult2.fromMap(Map<String, dynamic> map) {
    return GetServiceAttachmentResult2(
      connectedEndpoints:
          Input.decodeList<ServiceAttachmentConnectedEndpointResponse2>(
              map['connectedEndpoints'],
              (value) => ServiceAttachmentConnectedEndpointResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      connectionPreference: map['connectionPreference'] as String,
      consumerAcceptLists:
          Input.decodeList<ServiceAttachmentConsumerProjectLimitResponse2>(
              map['consumerAcceptLists'],
              (value) => ServiceAttachmentConsumerProjectLimitResponse2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      pscServiceAttachmentId: Uint128Response2.fromMap(
      ...
      tunnelingConfig: ServiceAttachmentTunnelingConfigResponse2.fromMap(
