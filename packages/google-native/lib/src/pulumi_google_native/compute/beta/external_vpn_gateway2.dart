...
import 'external_vpn_gateway_args2.dart';
import 'external_vpn_gateway_interface_response2.dart';

/// Creates a ExternalVpnGateway in the specified project using the data included in the request.
class ExternalVpnGateway2 extends CustomResource {
  ...
  late final Output<List<ExternalVpnGatewayInterfaceResponse2>> interfaces;
  ...
  ExternalVpnGateway2(
    ...
    this.interfaces =
        Output.createUnknown<List<ExternalVpnGatewayInterfaceResponse2>>();
