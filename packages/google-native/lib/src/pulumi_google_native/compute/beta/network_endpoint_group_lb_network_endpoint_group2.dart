...
class NetworkEndpointGroupLbNetworkEndpointGroup2 {
  ...
  factory NetworkEndpointGroupLbNetworkEndpointGroup2.fromMap(
      Map<String, dynamic> map) {
    return NetworkEndpointGroupLbNetworkEndpointGroup2(
      defaultPort:
