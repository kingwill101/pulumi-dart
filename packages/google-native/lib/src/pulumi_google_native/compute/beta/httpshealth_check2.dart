...
import 'httpshealth_check_port_specification2.dart';
import 'httpshealth_check_proxy_header2.dart';

class HTTPSHealthCheck2 {
  ...
  final HTTPSHealthCheckPortSpecification2? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTPSHealthCheckProxyHeader2? proxyHeader;
  ...
  factory HTTPSHealthCheck2.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheck2(
      ...
      portSpecification: map['portSpecification'] == null
          ? null
          : HTTPSHealthCheckPortSpecification2.fromValue(
              map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null
          ? null
          : HTTPSHealthCheckProxyHeader2.fromValue(
