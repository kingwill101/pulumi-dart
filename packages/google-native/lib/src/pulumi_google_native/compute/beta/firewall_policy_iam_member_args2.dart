...
class FirewallPolicyIamMemberArgs2 {
  ...
  factory FirewallPolicyIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamMemberArgs2(
