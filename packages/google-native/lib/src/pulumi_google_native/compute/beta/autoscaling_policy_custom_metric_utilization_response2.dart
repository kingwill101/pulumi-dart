...
class AutoscalingPolicyCustomMetricUtilizationResponse2 {
  ...
  factory AutoscalingPolicyCustomMetricUtilizationResponse2.fromMap(
      Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationResponse2(
