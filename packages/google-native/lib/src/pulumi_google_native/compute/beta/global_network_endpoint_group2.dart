...
class GlobalNetworkEndpointGroup2 extends CustomResource {
  /// Metadata defined as annotations on the network endpoint group.
  late final Output<Map<String, String>> annotations;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final Output<NetworkEndpointGroupAppEngineResponse2> appEngine;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final Output<NetworkEndpointGroupCloudFunctionResponse2> cloudFunction;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final Output<NetworkEndpointGroupCloudRunResponse2> cloudRun;
  ...
  late final Output<NetworkEndpointGroupLbNetworkEndpointGroupResponse2>
      loadBalancer;
  ...
  late final Output<NetworkEndpointGroupPscDataResponse2> pscData;
  ...
  late final Output<NetworkEndpointGroupServerlessDeploymentResponse2>
  ...
  GlobalNetworkEndpointGroup2(
    String name, {
    GlobalNetworkEndpointGroupArgs2? args,
