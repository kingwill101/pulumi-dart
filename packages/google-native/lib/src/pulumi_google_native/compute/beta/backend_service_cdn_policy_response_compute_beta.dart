...
class BackendServiceCdnPolicyResponseComputeBeta {
  ...
  final CacheKeyPolicyResponseComputeBeta cacheKeyPolicy;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bypassCacheOnRequestHeaders'] = pulumi.Input.encodeList<
        BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta,
        Map<String,
            dynamic>>(bypassCacheOnRequestHeaders, (value) => value.toMap());
  ...
  factory BackendServiceCdnPolicyResponseComputeBeta.fromMap(
    ...
    return BackendServiceCdnPolicyResponseComputeBeta(
      ...
      cacheKeyPolicy: CacheKeyPolicyResponseComputeBeta.fromMap(
