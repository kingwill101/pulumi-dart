...
class RouterNatRuleActionResponse2 {
  ...
  factory RouterNatRuleActionResponse2.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleActionResponse2(
