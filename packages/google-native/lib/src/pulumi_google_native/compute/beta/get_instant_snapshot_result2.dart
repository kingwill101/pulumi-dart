...
class GetInstantSnapshotResult2 {
  ...
  final InstantSnapshotResourceStatusResponse2 resourceStatus;
  ...
  factory GetInstantSnapshotResult2.fromMap(Map<String, dynamic> map) {
    return GetInstantSnapshotResult2(
      ...
      resourceStatus: InstantSnapshotResourceStatusResponse2.fromMap(
