...
import 'backend_bucket_cdn_policy_response2.dart';

/// Result data returned by getBackendBucket.
class GetBackendBucketResult2 {
  /// Cloud Storage bucket name.
  final String bucketName;

  /// Cloud CDN configuration for this BackendBucket.
  final BackendBucketCdnPolicyResponse2 cdnPolicy;
  ...
  factory GetBackendBucketResult2.fromMap(Map<String, dynamic> map) {
    return GetBackendBucketResult2(
      bucketName: map['bucketName'] as String,
      cdnPolicy: BackendBucketCdnPolicyResponse2.fromMap(
