...
import 'custom_error_response_policy_response2.dart';
import 'host_rule_response2.dart';
import 'http_header_action_response2.dart';
import 'http_redirect_action_response2.dart';
import 'http_route_action_response2.dart';
import 'path_matcher_response2.dart';
import 'url_map_test_response2.dart';

/// Result data returned by getRegionUrlMap.
class GetRegionUrlMapResult2 {
  ...
  final CustomErrorResponsePolicyResponse2 defaultCustomErrorResponsePolicy;
  ...
  final HttpRouteActionResponse2 defaultRouteAction;
  ...
  final HttpRedirectActionResponse2 defaultUrlRedirect;
  ...
  final HttpHeaderActionResponse2 headerAction;

  /// The list of host rules to use against the URL.
  final List<HostRuleResponse2> hostRules;
  ...
  final List<PathMatcherResponse2> pathMatchers;
  ...
  final List<UrlMapTestResponse2> tests;

  GetRegionUrlMapResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['hostRules'] =
        Input.encodeList<HostRuleResponse2, Map<String, dynamic>>(
            hostRules, (value) => value.toMap());
    map['kind'] = kind;
    map['name'] = name;
    map['pathMatchers'] =
        Input.encodeList<PathMatcherResponse2, Map<String, dynamic>>(
            pathMatchers, (value) => value.toMap());
    map['region'] = region;
    map['selfLink'] = selfLink;
    map['tests'] = Input.encodeList<UrlMapTestResponse2, Map<String, dynamic>>(
        tests, (value) => value.toMap());
    return map;
  }

  factory GetRegionUrlMapResult2.fromMap(Map<String, dynamic> map) {
    return GetRegionUrlMapResult2(
      creationTimestamp: map['creationTimestamp'] as String,
      defaultCustomErrorResponsePolicy:
          CustomErrorResponsePolicyResponse2.fromMap(
              (map['defaultCustomErrorResponsePolicy'] as Map)
                  .cast<String, dynamic>()),
      defaultRouteAction: HttpRouteActionResponse2.fromMap(
          (map['defaultRouteAction'] as Map).cast<String, dynamic>()),
      defaultService: map['defaultService'] as String,
      defaultUrlRedirect: HttpRedirectActionResponse2.fromMap(
          (map['defaultUrlRedirect'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      fingerprint: map['fingerprint'] as String,
      headerAction: HttpHeaderActionResponse2.fromMap(
          (map['headerAction'] as Map).cast<String, dynamic>()),
      hostRules: Input.decodeList<HostRuleResponse2>(
          map['hostRules'],
          (value) => HostRuleResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      kind: map['kind'] as String,
      name: map['name'] as String,
      pathMatchers: Input.decodeList<PathMatcherResponse2>(
          map['pathMatchers'],
          (value) => PathMatcherResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      tests: Input.decodeList<UrlMapTestResponse2>(
          map['tests'],
          (value) => UrlMapTestResponse2.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
