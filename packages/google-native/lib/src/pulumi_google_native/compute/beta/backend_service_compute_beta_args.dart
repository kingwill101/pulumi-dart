    ...
    return BackendServiceComputeBetaArgs(
      ...
      cdnPolicy:
          pulumi.Input.asOptionalInput<BackendServiceCdnPolicyComputeBeta>(
              map['cdnPolicy']),
      circuitBreakers: pulumi.Input.asOptionalInput<CircuitBreakersComputeBeta>(
          map['circuitBreakers']),
      compressionMode: pulumi.Input.asOptionalInput<
          BackendServiceCompressionModeComputeBeta>(map['compressionMode']),
      connectionDraining:
      ...
      consistentHash: pulumi.Input.asOptionalInput<
          ConsistentHashLoadBalancerSettingsComputeBeta>(map['consistentHash']),
      ...
      failoverPolicy:
          pulumi.Input.asOptionalInput<BackendServiceFailoverPolicyComputeBeta>(
              map['failoverPolicy']),
      healthChecks:
          pulumi.Input.asOptionalInput<List<String>>(map['healthChecks']),
      iap: pulumi.Input.asOptionalInput<BackendServiceIAPComputeBeta>(
          map['iap']),
      ...
      localityLbPolicy: pulumi.Input.asOptionalInput<
          BackendServiceLocalityLbPolicyComputeBeta>(map['localityLbPolicy']),
      logConfig:
      ...
      protocol: pulumi.Input.asOptionalInput<BackendServiceProtocolComputeBeta>(
          map['protocol']),
      ...
      sessionAffinity: pulumi.Input.asOptionalInput<
          BackendServiceSessionAffinityComputeBeta>(map['sessionAffinity']),
