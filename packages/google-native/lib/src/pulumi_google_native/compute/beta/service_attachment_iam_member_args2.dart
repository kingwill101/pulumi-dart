...
class ServiceAttachmentIamMemberArgs2 {
  ...
  ServiceAttachmentIamMemberArgs2({
    this.condition,
  ...
  factory ServiceAttachmentIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentIamMemberArgs2(
