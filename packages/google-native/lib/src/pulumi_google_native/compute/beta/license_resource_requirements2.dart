...
class LicenseResourceRequirements2 {
  ...
  factory LicenseResourceRequirements2.fromMap(Map<String, dynamic> map) {
    return LicenseResourceRequirements2(
