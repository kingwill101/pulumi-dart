...
class ResourcePolicyDailyCycle2 {
  ...
  factory ResourcePolicyDailyCycle2.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyDailyCycle2(
      daysInCycle:
