...
class AutoscalingPolicyCustomMetricUtilizationComputeBeta {
  ...
  final AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeBeta?
  ...
  Map<String, dynamic> toMap() {
    ...
    final utilizationTargetTypeValue = utilizationTargetType;
    if (utilizationTargetTypeValue != null) {
      map['utilizationTargetType'] = utilizationTargetTypeValue.value;
    }
    return map;
  }
  ...
  factory AutoscalingPolicyCustomMetricUtilizationComputeBeta.fromMap(
    ...
    return AutoscalingPolicyCustomMetricUtilizationComputeBeta(
      ...
      utilizationTargetType: map['utilizationTargetType'] == null
          ? null
          : AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeBeta
              .fromValue(map['utilizationTargetType'] as String),
    );
  }
}
