...
class GetInstantSnapshotComputeBetaResult {
  ...
  GetInstantSnapshotComputeBetaResult({
  ...
  factory GetInstantSnapshotComputeBetaResult.fromMap(
      Map<String, dynamic> map) {
    return GetInstantSnapshotComputeBetaResult(
