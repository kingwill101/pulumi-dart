...
import 'region_disk_compute_beta_args.dart';

/// Creates a persistent regional disk in the specified project using the data included in the request.
class RegionDiskComputeBeta extends pulumi.CustomResource {
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  late final pulumi.Output<String> architecture;

  /// Disk asynchronously replicated into this disk.
  late final pulumi.Output<DiskAsyncReplicationResponseComputeBeta>
      asyncPrimaryDisk;
  ...
  late final pulumi.Output<DiskParamsResponseComputeBeta> params;
  ...
  late final pulumi.Output<DiskResourceStatusResponseComputeBeta>
      resourceStatus;
  ...
  RegionDiskComputeBeta(
    String name, {
    RegionDiskComputeBetaArgs? args,
    ...
    this.asyncPrimaryDisk =
        registerOutput<DiskAsyncReplicationResponseComputeBeta>(
            'asyncPrimaryDisk');
    ...
    this.params = registerOutput<DiskParamsResponseComputeBeta>('params');
    ...
    this.resourceStatus =
        registerOutput<DiskResourceStatusResponseComputeBeta>('resourceStatus');
