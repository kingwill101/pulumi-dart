...
import 'http_redirect_action_redirect_response_code2.dart';

/// Specifies settings for an HTTP redirect.
class HttpRedirectAction2 {
  ...
  final HttpRedirectActionRedirectResponseCode2? redirectResponseCode;
  ...
  factory HttpRedirectAction2.fromMap(Map<String, dynamic> map) {
    return HttpRedirectAction2(
      hostRedirect:
      ...
      redirectResponseCode: map['redirectResponseCode'] == null
          ? null
          : HttpRedirectActionRedirectResponseCode2.fromValue(
