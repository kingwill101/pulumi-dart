...
class RegionInstantSnapshotIamMemberArgs2 {
  ...
  RegionInstantSnapshotIamMemberArgs2({
    this.condition,
  ...
  factory RegionInstantSnapshotIamMemberArgs2.fromMap(
      Map<String, dynamic> map) {
    return RegionInstantSnapshotIamMemberArgs2(
