...
import 'http2_health_check_port_specification2.dart';
import 'http2_health_check_proxy_header2.dart';

class HTTP2HealthCheck2 {
  ...
  final HTTP2HealthCheckPortSpecification2? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTP2HealthCheckProxyHeader2? proxyHeader;
