...
class GetRegionInstanceTemplateArgs2 {
  final Input<String> instanceTemplate;
  final Input<String>? project;
  final Input<String> region;

  GetRegionInstanceTemplateArgs2({
  ...
  factory GetRegionInstanceTemplateArgs2.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateArgs2(
