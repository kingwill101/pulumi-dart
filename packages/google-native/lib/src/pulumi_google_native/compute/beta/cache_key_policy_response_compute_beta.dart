...
class CacheKeyPolicyResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['queryStringBlacklist'] = queryStringBlacklist;
    map['queryStringWhitelist'] = queryStringWhitelist;
    return map;
  }

  factory CacheKeyPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return CacheKeyPolicyResponseComputeBeta(
