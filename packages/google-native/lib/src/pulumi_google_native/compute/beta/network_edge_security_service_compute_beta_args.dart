...
class NetworkEdgeSecurityServiceComputeBetaArgs {
  ...
  NetworkEdgeSecurityServiceComputeBetaArgs({
    this.description,
    this.name,
    this.project,
  ...
  factory NetworkEdgeSecurityServiceComputeBetaArgs.fromMap(
      Map<String, dynamic> map) {
    return NetworkEdgeSecurityServiceComputeBetaArgs(
