...
class InstanceGroupManagerAutoHealingPolicy2 {
  ...
  InstanceGroupManagerAutoHealingPolicy2({
    this.healthCheck,
  ...
  factory InstanceGroupManagerAutoHealingPolicy2.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicy2(
      healthCheck:
