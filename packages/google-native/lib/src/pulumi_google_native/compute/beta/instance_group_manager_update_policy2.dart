...
import 'instance_group_manager_update_policy_instance_redistribution_type2.dart';
import 'instance_group_manager_update_policy_minimal_action2.dart';
import 'instance_group_manager_update_policy_most_disruptive_allowed_action2.dart';
import 'instance_group_manager_update_policy_replacement_method2.dart';
import 'instance_group_manager_update_policy_type2.dart';

class InstanceGroupManagerUpdatePolicy2 {
  /// The instance redistribution policy for regional managed instance groups. Valid values are: - PROACTIVE (default): The group attempts to maintain an even distribution of VM instances across zones in the region. - NONE: For non-autoscaled groups, proactive redistribution is disabled.
  final InstanceGroupManagerUpdatePolicyInstanceRedistributionType2?
      instanceRedistributionType;

  /// The maximum number of instances that can be created above the specified targetSize during the update process. This value can be either a fixed number or, if the group has 10 or more instances, a percentage. If you set a percentage, the number of instances is rounded if necessary. The default value for maxSurge is a fixed value equal to the number of zones in which the managed instance group operates. At least one of either maxSurge or maxUnavailable must be greater than 0. Learn more about maxSurge.
  final FixedOrPercent2? maxSurge;
  ...
  final FixedOrPercent2? maxUnavailable;
  ...
  final InstanceGroupManagerUpdatePolicyMinimalAction2? minimalAction;

  /// Most disruptive action that is allowed to be taken on an instance. You can specify either NONE to forbid any actions, REFRESH to avoid restarting the VM and to limit disruption as much as possible. RESTART to allow actions that can be applied without instance replacing or REPLACE to allow all possible actions. If the Updater determines that the minimal update action needed is more disruptive than most disruptive allowed action you specify it will not perform the update at all.
  final InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedAction2?
      mostDisruptiveAllowedAction;

  /// What action should be used to replace instances. See minimal_action.REPLACE
  final InstanceGroupManagerUpdatePolicyReplacementMethod2? replacementMethod;

  /// The type of update process. You can specify either PROACTIVE so that the MIG automatically updates VMs to the latest configurations or OPPORTUNISTIC so that you can select the VMs that you want to update.
  final InstanceGroupManagerUpdatePolicyType2? type;
  ...
  factory InstanceGroupManagerUpdatePolicy2.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicy2(
      instanceRedistributionType: map['instanceRedistributionType'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyInstanceRedistributionType2
      ...
      minimalAction: map['minimalAction'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyMinimalAction2.fromValue(
              map['minimalAction'] as String),
      mostDisruptiveAllowedAction: map['mostDisruptiveAllowedAction'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedAction2
              .fromValue(map['mostDisruptiveAllowedAction'] as String),
      replacementMethod: map['replacementMethod'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyReplacementMethod2.fromValue(
              map['replacementMethod'] as String),
      type: map['type'] == null
          ? null
          : InstanceGroupManagerUpdatePolicyType2.fromValue(
              map['type'] as String),
    );
  }
}
