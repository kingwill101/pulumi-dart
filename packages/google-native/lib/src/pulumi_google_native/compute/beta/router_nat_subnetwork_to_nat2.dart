...
class RouterNatSubnetworkToNat2 {
  ...
  final List<RouterNatSubnetworkToNatSourceIpRangesToNatItem2>?
      sourceIpRangesToNat;

  RouterNatSubnetworkToNat2({
    this.name,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sourceIpRangesToNatValue != null) {
      map['sourceIpRangesToNat'] = Input.encodeList<
          RouterNatSubnetworkToNatSourceIpRangesToNatItem2,
          String>(sourceIpRangesToNatValue, (value) => value.value);
    }
    return map;
  }

  factory RouterNatSubnetworkToNat2.fromMap(Map<String, dynamic> map) {
    return RouterNatSubnetworkToNat2(
      ...
      sourceIpRangesToNat: map['sourceIpRangesToNat'] == null
          ? null
          : Input.decodeList<RouterNatSubnetworkToNatSourceIpRangesToNatItem2>(
              map['sourceIpRangesToNat'],
              (value) =>
                  RouterNatSubnetworkToNatSourceIpRangesToNatItem2.fromValue(
                      value as String)),
    );
  }
}
