...
import 'ssl_certificate_args2.dart';
import 'ssl_certificate_managed_ssl_certificate_response2.dart';
import 'ssl_certificate_self_managed_ssl_certificate_response2.dart';

/// Creates a SslCertificate resource in the specified project using the data included in the request.
class SslCertificate2 extends CustomResource {
  ...
  late final Output<SslCertificateManagedSslCertificateResponse2> managed;
  ...
  late final Output<SslCertificateSelfManagedSslCertificateResponse2>
      selfManaged;
  ...
  SslCertificate2(
    ...
    this.managed =
        registerOutput<SslCertificateManagedSslCertificateResponse2>('managed');
    ...
    this.selfManaged =
        registerOutput<SslCertificateSelfManagedSslCertificateResponse2>(
            'selfManaged');
