...
import 'backend_service_iam_binding_args2.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class BackendServiceIamBinding2 extends CustomResource {
  ...
  BackendServiceIamBinding2(
    String name, {
    BackendServiceIamBindingArgs2? args,
