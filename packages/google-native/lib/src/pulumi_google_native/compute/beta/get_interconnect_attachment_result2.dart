...
import 'interconnect_attachment_configuration_constraints_response2.dart';
import 'interconnect_attachment_partner_metadata_response2.dart';
import 'interconnect_attachment_private_info_response2.dart';

/// Result data returned by getInterconnectAttachment.
class GetInterconnectAttachmentResult2 {
  ...
  final InterconnectAttachmentConfigurationConstraintsResponse2
  ...
  final InterconnectAttachmentPartnerMetadataResponse2 partnerMetadata;
  ...
  final InterconnectAttachmentPrivateInfoResponse2 privateInterconnectInfo;
  ...
  GetInterconnectAttachmentResult2({
  ...
  factory GetInterconnectAttachmentResult2.fromMap(Map<String, dynamic> map) {
    return GetInterconnectAttachmentResult2(
      ...
      configurationConstraints:
          InterconnectAttachmentConfigurationConstraintsResponse2.fromMap(
              (map['configurationConstraints'] as Map).cast<String, dynamic>()),
      ...
      partnerMetadata: InterconnectAttachmentPartnerMetadataResponse2.fromMap(
          (map['partnerMetadata'] as Map).cast<String, dynamic>()),
      privateInterconnectInfo:
          InterconnectAttachmentPrivateInfoResponse2.fromMap(
