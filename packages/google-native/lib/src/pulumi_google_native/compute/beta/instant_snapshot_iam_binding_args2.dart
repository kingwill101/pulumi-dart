...
class InstantSnapshotIamBindingArgs2 {
  ...
  InstantSnapshotIamBindingArgs2({
    this.condition,
  ...
  factory InstantSnapshotIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotIamBindingArgs2(
