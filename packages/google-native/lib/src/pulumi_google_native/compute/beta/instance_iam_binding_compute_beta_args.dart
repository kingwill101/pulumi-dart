...
class InstanceIamBindingComputeBetaArgs {
  ...
  InstanceIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory InstanceIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingComputeBetaArgs(
