...
class BackendBucketCdnPolicyCacheKeyPolicy3 {
  ...
  BackendBucketCdnPolicyCacheKeyPolicy3({
  ...
  factory BackendBucketCdnPolicyCacheKeyPolicy3.fromMap(
      Map<String, dynamic> map) {
    return BackendBucketCdnPolicyCacheKeyPolicy3(
