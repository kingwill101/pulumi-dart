...
import 'tcphealth_check_port_specification3.dart';
import 'tcphealth_check_proxy_header3.dart';

class TCPHealthCheck3 {
  ...
  final TCPHealthCheckPortSpecification3? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final TCPHealthCheckProxyHeader3? proxyHeader;
  ...
  factory TCPHealthCheck3.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheck3(
      port: map['port'] == null ? null : map['port'] as int,
      portName: map['portName'] == null ? null : map['portName'] as String,
      portSpecification: map['portSpecification'] == null
          ? null
          : TCPHealthCheckPortSpecification3.fromValue(
              map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null
          ? null
          : TCPHealthCheckProxyHeader3.fromValue(map['proxyHeader'] as String),
