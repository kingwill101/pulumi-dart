...
class RouterNatRuleActionResponse3 {
  ...
  factory RouterNatRuleActionResponse3.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleActionResponse3(
