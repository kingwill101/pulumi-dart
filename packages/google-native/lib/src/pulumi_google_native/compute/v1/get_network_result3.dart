...
class GetNetworkResult3 {
  ...
  final List<NetworkPeeringResponse3> peerings;

  /// The network-level routing configuration for this network. Used by Cloud Router to determine what type of network-wide routing behavior to enforce.
  final NetworkRoutingConfigResponse3 routingConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['peerings'] =
        Input.encodeList<NetworkPeeringResponse3, Map<String, dynamic>>(
  ...
  factory GetNetworkResult3.fromMap(Map<String, dynamic> map) {
    return GetNetworkResult3(
      ...
      peerings: Input.decodeList<NetworkPeeringResponse3>(
          map['peerings'],
          (value) => NetworkPeeringResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      routingConfig: NetworkRoutingConfigResponse3.fromMap(
