...
import 'target_tcp_proxy_proxy_header3.dart';

/// The set of arguments for TargetTcpProxy.
class TargetTcpProxyArgs3 {
  ...
  final Input<TargetTcpProxyProxyHeader3>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          Input.mapOptionalInputValue<TargetTcpProxyProxyHeader3, String>(
  ...
  factory TargetTcpProxyArgs3.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyArgs3(
      description: Input.asOptionalInput<String>(map['description']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      proxyBind: Input.asOptionalInput<bool>(map['proxyBind']),
      proxyHeader:
          Input.asOptionalInput<TargetTcpProxyProxyHeader3>(map['proxyHeader']),
