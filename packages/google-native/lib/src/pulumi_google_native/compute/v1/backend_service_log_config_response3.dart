...
class BackendServiceLogConfigResponse3 {
  ...
  BackendServiceLogConfigResponse3({
  ...
  factory BackendServiceLogConfigResponse3.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfigResponse3(
