...
class GetRegionHealthCheckServiceResult3 {
  ...
  GetRegionHealthCheckServiceResult3({
  ...
  factory GetRegionHealthCheckServiceResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionHealthCheckServiceResult3(
