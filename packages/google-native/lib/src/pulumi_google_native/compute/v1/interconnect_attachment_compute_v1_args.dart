...
import 'interconnect_attachment_bandwidth_compute_v1.dart';
import 'interconnect_attachment_edge_availability_domain_compute_v1.dart';
import 'interconnect_attachment_encryption_compute_v1.dart';
import 'interconnect_attachment_partner_metadata_compute_v1.dart';
import 'interconnect_attachment_stack_type_compute_v1.dart';
import 'interconnect_attachment_type_compute_v1.dart';

/// The set of arguments for InterconnectAttachment.
class InterconnectAttachmentComputeV1Args {
  ...
  final pulumi.Input<InterconnectAttachmentBandwidthComputeV1>? bandwidth;
  ...
  final pulumi.Input<InterconnectAttachmentEdgeAvailabilityDomainComputeV1>?
  ...
  final pulumi.Input<InterconnectAttachmentEncryptionComputeV1>? encryption;
  ...
  final pulumi.Input<InterconnectAttachmentPartnerMetadataComputeV1>?
      partnerMetadata;
  ...
  final pulumi.Input<InterconnectAttachmentStackTypeComputeV1>? stackType;
  ...
  final pulumi.Input<InterconnectAttachmentTypeComputeV1>? type;

  /// The IEEE 802.1Q VLAN tag for this attachment, in the range 2-4093. Only specified at creation time.
  final pulumi.Input<int>? vlanTag8021q;

  InterconnectAttachmentComputeV1Args({
    this.adminEnabled,
    this.bandwidth,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bandwidthValue != null) {
      map['bandwidth'] = pulumi.Input.mapOptionalInputValue<
          InterconnectAttachmentBandwidthComputeV1,
    ...
    if (edgeAvailabilityDomainValue != null) {
      map['edgeAvailabilityDomain'] = pulumi.Input.mapOptionalInputValue<
          InterconnectAttachmentEdgeAvailabilityDomainComputeV1,
    ...
    if (encryptionValue != null) {
      map['encryption'] = pulumi.Input.mapOptionalInputValue<
          InterconnectAttachmentEncryptionComputeV1,
    ...
    if (stackTypeValue != null) {
      map['stackType'] = pulumi.Input.mapOptionalInputValue<
          InterconnectAttachmentStackTypeComputeV1,
    ...
    if (typeValue != null) {
      map['type'] = pulumi.Input.mapOptionalInputValue<
          InterconnectAttachmentTypeComputeV1,
  ...
  factory InterconnectAttachmentComputeV1Args.fromMap(
      Map<String, dynamic> map) {
    return InterconnectAttachmentComputeV1Args(
      adminEnabled: pulumi.Input.asOptionalInput<bool>(map['adminEnabled']),
      bandwidth: pulumi.Input.asOptionalInput<
          InterconnectAttachmentBandwidthComputeV1>(map['bandwidth']),
      ...
      encryption: pulumi.Input.asOptionalInput<
          InterconnectAttachmentEncryptionComputeV1>(map['encryption']),
      ...
      stackType: pulumi.Input.asOptionalInput<
          InterconnectAttachmentStackTypeComputeV1>(map['stackType']),
      subnetLength: pulumi.Input.asOptionalInput<int>(map['subnetLength']),
      type: pulumi.Input.asOptionalInput<InterconnectAttachmentTypeComputeV1>(
          map['type']),
