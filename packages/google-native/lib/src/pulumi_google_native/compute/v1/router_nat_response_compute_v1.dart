...
import 'router_nat_log_config_response_compute_v1.dart';
import 'router_nat_rule_response_compute_v1.dart';
import 'router_nat_subnetwork_to_nat_response_compute_v1.dart';

/// Represents a Nat resource. It enables the VMs within the specified subnetworks to access Internet without external IP addresses. It specifies a list of subnetworks (and the ranges within) that want to use NAT. Customers can also provide the external IPs that would be used for NAT. GCP would auto-allocate ephemeral IPs if no external IPs are provided.
class RouterNatResponseComputeV1 {
  ...
  final RouterNatLogConfigResponseComputeV1 logConfig;
  ...
  final List<RouterNatRuleResponseComputeV1> rules;
  ...
  final List<RouterNatSubnetworkToNatResponseComputeV1> subnetworks;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['natIps'] = natIps;
    map['rules'] = pulumi.Input.encodeList<RouterNatRuleResponseComputeV1,
  ...
  factory RouterNatResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeV1(
      ...
      logConfig: RouterNatLogConfigResponseComputeV1.fromMap(
      ...
      rules: pulumi.Input.decodeList<RouterNatRuleResponseComputeV1>(
          map['rules'],
          (value) => RouterNatRuleResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat:
          map['sourceSubnetworkIpRangesToNat'] as String,
      subnetworks:
          pulumi.Input.decodeList<RouterNatSubnetworkToNatResponseComputeV1>(
              map['subnetworks'],
              (value) => RouterNatSubnetworkToNatResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
