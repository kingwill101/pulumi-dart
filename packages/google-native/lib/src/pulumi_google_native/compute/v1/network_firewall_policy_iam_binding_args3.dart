...
class NetworkFirewallPolicyIamBindingArgs3 {
  ...
  NetworkFirewallPolicyIamBindingArgs3({
    this.condition,
  ...
  factory NetworkFirewallPolicyIamBindingArgs3.fromMap(
      Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamBindingArgs3(
