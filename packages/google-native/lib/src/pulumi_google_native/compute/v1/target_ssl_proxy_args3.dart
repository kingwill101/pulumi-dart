...
import 'target_ssl_proxy_proxy_header3.dart';

/// The set of arguments for TargetSslProxy.
class TargetSslProxyArgs3 {
  ...
  final Input<TargetSslProxyProxyHeader3>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (proxyHeaderValue != null) {
      map['proxyHeader'] =
          Input.mapOptionalInputValue<TargetSslProxyProxyHeader3, String>(
  ...
  factory TargetSslProxyArgs3.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyArgs3(
      certificateMap: Input.asOptionalInput<String>(map['certificateMap']),
      description: Input.asOptionalInput<String>(map['description']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      proxyHeader:
          Input.asOptionalInput<TargetSslProxyProxyHeader3>(map['proxyHeader']),
