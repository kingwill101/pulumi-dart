...
class GetInstanceComputeV1Result {
  ...
  final ShieldedInstanceIntegrityPolicyResponseComputeV1
  ...
  factory GetInstanceComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceComputeV1Result(
      ...
      displayDevice: DisplayDeviceResponseComputeV1.fromMap(
      ...
      instanceEncryptionKey: CustomerEncryptionKeyResponseComputeV1.fromMap(
      ...
      params: InstanceParamsResponseComputeV1.fromMap(
      ...
      resourceStatus: ResourceStatusResponseComputeV1.fromMap(
      ...
      shieldedInstanceIntegrityPolicy:
          ShieldedInstanceIntegrityPolicyResponseComputeV1.fromMap(
