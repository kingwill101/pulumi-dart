...
class InterconnectAttachment4 extends CustomResource {
  ...
  late final Output<List<String>> candidateIpv6Subnets;
  ...
  /// This field is not available.
  late final Output<String> cloudRouterIpv6InterfaceId;

  /// Constraints for this attachment, if any. The attachment does not work if these constraints are not met.
  late final Output<InterconnectAttachmentConfigurationConstraintsResponse3>
  ...
  /// This field is not available.
  late final Output<String> customerRouterIpv6InterfaceId;
  ...
  late final Output<int> dataplaneVersion;
  ...
  late final Output<InterconnectAttachmentPartnerMetadataResponse3>
      partnerMetadata;
  ...
  late final Output<InterconnectAttachmentPrivateInfoResponse3>
  ...
  late final Output<String> remoteService;
  ...
  InterconnectAttachment4(
    String name, {
    InterconnectAttachmentArgs3? args,
    ...
    this.configurationConstraints =
        registerOutput<InterconnectAttachmentConfigurationConstraintsResponse3>(
            'configurationConstraints');
    ...
    this.partnerMetadata =
        registerOutput<InterconnectAttachmentPartnerMetadataResponse3>(
            'partnerMetadata');
    this.privateInterconnectInfo =
        registerOutput<InterconnectAttachmentPrivateInfoResponse3>(
            'privateInterconnectInfo');
