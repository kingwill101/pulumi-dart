...
class ServiceAttachment3 extends CustomResource {
  ...
  ServiceAttachment3(
    ...
    this.connectedEndpoints = Output.createUnknown<
        List<ServiceAttachmentConnectedEndpointResponse3>>();
    this.connectionPreference = Output.createUnknown<String>();
    this.consumerAcceptLists = Output.createUnknown<
        List<ServiceAttachmentConsumerProjectLimitResponse3>>();
    ...
    this.pscServiceAttachmentId = Output.createUnknown<Uint128Response3>();
