...
import 'service_attachment_args3.dart';
...
class ServiceAttachment3 extends CustomResource {
  /// An array of connections for all the consumers connected to this service attachment.
  late final Output<List<ServiceAttachmentConnectedEndpointResponse3>>
      connectedEndpoints;
  ...
  late final Output<List<ServiceAttachmentConsumerProjectLimitResponse3>>
      consumerAcceptLists;
  ...
  late final Output<Uint128Response3> pscServiceAttachmentId;
  ...
  ServiceAttachment3(
    ...
    this.connectedEndpoints =
        registerOutput<List<ServiceAttachmentConnectedEndpointResponse3>>(
            'connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists =
        registerOutput<List<ServiceAttachmentConsumerProjectLimitResponse3>>(
            'consumerAcceptLists');
    ...
    this.pscServiceAttachmentId =
        registerOutput<Uint128Response3>('pscServiceAttachmentId');
