...
class GetVpnGatewayResult3 {
  ...
  final List<VpnGatewayVpnGatewayInterfaceResponse3> vpnInterfaces;

  GetVpnGatewayResult3({
  ...
  factory GetVpnGatewayResult3.fromMap(Map<String, dynamic> map) {
    return GetVpnGatewayResult3(
      ...
      vpnInterfaces: Input.decodeList<VpnGatewayVpnGatewayInterfaceResponse3>(
          map['vpnInterfaces'],
          (value) => VpnGatewayVpnGatewayInterfaceResponse3.fromMap(
