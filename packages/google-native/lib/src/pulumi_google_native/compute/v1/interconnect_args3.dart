...
import 'interconnect_interconnect_type3.dart';
import 'interconnect_link_type3.dart';
import 'interconnect_macsec3.dart';
import 'interconnect_requested_features_item3.dart';

/// The set of arguments for Interconnect.
class InterconnectArgs3 {
  ...
  final Input<InterconnectInterconnectType3>? interconnectType;

  /// Labels for this resource. These can only be added or modified by the setLabels method. Each label key/value pair must comply with RFC1035. Label values may be empty.
  final Input<Map<String, String>>? labels;

  /// Type of link requested, which can take one of the following values: - LINK_TYPE_ETHERNET_10G_LR: A 10G Ethernet with LR optics - LINK_TYPE_ETHERNET_100G_LR: A 100G Ethernet with LR optics. Note that this field indicates the speed of each of the links in the bundle, not the speed of the entire bundle.
  final Input<InterconnectLinkType3>? linkType;
  ...
  final Input<InterconnectMacsec3>? macsec;
  ...
  final Input<List<InterconnectRequestedFeaturesItem3>>? requestedFeatures;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (interconnectTypeValue != null) {
      map['interconnectType'] =
          Input.mapOptionalInputValue<InterconnectInterconnectType3, String>(
    ...
    if (linkTypeValue != null) {
      map['linkType'] =
          Input.mapOptionalInputValue<InterconnectLinkType3, String>(
    ...
    if (macsecValue != null) {
      map['macsec'] = Input.mapOptionalInputValue<InterconnectMacsec3,
    ...
    if (requestedFeaturesValue != null) {
      map['requestedFeatures'] = Input.mapOptionalInputValue<
              List<InterconnectRequestedFeaturesItem3>, List<String>>(
          requestedFeaturesValue,
          (value) =>
              Input.encodeList<InterconnectRequestedFeaturesItem3, String>(
  ...
  factory InterconnectArgs3.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs3(
      ...
      interconnectType: Input.asOptionalInput<InterconnectInterconnectType3>(
          map['interconnectType']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      linkType: Input.asOptionalInput<InterconnectLinkType3>(map['linkType']),
      location: Input.asOptionalInput<String>(map['location']),
      macsec: Input.asOptionalInput<InterconnectMacsec3>(map['macsec']),
      ...
      requestedFeatures:
          Input.asOptionalInput<List<InterconnectRequestedFeaturesItem3>>(
