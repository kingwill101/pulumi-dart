...
import 'ssl_policy_args3.dart';
import 'ssl_policy_warnings_item_response3.dart';

/// Returns the specified SSL policy resource.
class SslPolicy3 extends CustomResource {
  ...
  late final Output<List<SslPolicyWarningsItemResponse3>> warnings;
  ...
  SslPolicy3(
    ...
    this.warnings =
        registerOutput<List<SslPolicyWarningsItemResponse3>>('warnings');
  }
}
