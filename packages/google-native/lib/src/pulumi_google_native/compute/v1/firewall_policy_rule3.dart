...
class FirewallPolicyRule3 {
  ...
  final FirewallPolicyRuleDirection3? direction;
  ...
  final FirewallPolicyRuleMatcher3? match;
  ...
  final List<FirewallPolicyRuleSecureTag3>? targetSecureTags;
  ...
  factory FirewallPolicyRule3.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRule3(
      action: map['action'] == null ? null : map['action'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      direction: map['direction'] == null
          ? null
          : FirewallPolicyRuleDirection3.fromValue(map['direction'] as String),
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      enableLogging:
          map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      match: map['match'] == null
          ? null
          : FirewallPolicyRuleMatcher3.fromMap(
