...
import 'forwarding_rule_ip_protocol3.dart';
import 'forwarding_rule_ip_version3.dart';
import 'forwarding_rule_load_balancing_scheme3.dart';
import 'forwarding_rule_network_tier3.dart';
import 'forwarding_rule_psc_connection_status3.dart';
...
class ForwardingRuleArgs3 {
  ...
  final Input<ForwardingRuleIpProtocol3>? ipProtocol;

  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final Input<ForwardingRuleIpVersion3>? ipVersion;
  ...
  final Input<ForwardingRuleLoadBalancingScheme3>? loadBalancingScheme;
  ...
  final Input<ForwardingRuleNetworkTier3>? networkTier;
  ...
  final Input<ForwardingRulePscConnectionStatus3>? pscConnectionStatus;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] =
          Input.mapOptionalInputValue<ForwardingRuleIpProtocol3, String>(
              ipProtocolValue, (value) => value.value);
    }
    final ipVersionValue = ipVersion;
    if (ipVersionValue != null) {
      map['ipVersion'] =
          Input.mapOptionalInputValue<ForwardingRuleIpVersion3, String>(
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = Input.mapOptionalInputValue<
          ForwardingRuleLoadBalancingScheme3,
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          Input.mapOptionalInputValue<ForwardingRuleNetworkTier3, String>(
    ...
    if (pscConnectionStatusValue != null) {
      map['pscConnectionStatus'] = Input.mapOptionalInputValue<
          ForwardingRulePscConnectionStatus3,
  ...
  factory ForwardingRuleArgs3.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs3(
      ...
      ipProtocol:
          Input.asOptionalInput<ForwardingRuleIpProtocol3>(map['ipProtocol']),
      ipVersion:
          Input.asOptionalInput<ForwardingRuleIpVersion3>(map['ipVersion']),
      isMirroringCollector:
          Input.asOptionalInput<bool>(map['isMirroringCollector']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      loadBalancingScheme:
          Input.asOptionalInput<ForwardingRuleLoadBalancingScheme3>(
      ...
      networkTier:
          Input.asOptionalInput<ForwardingRuleNetworkTier3>(map['networkTier']),
      ...
      pscConnectionStatus:
          Input.asOptionalInput<ForwardingRulePscConnectionStatus3>(
