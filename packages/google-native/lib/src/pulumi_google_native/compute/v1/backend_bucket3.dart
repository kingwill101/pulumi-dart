...
class BackendBucket3 extends CustomResource {
  /// Cloud Storage bucket name.
  late final Output<String> bucketName;

  /// Cloud CDN configuration for this BackendBucket.
  late final Output<BackendBucketCdnPolicyResponse3> cdnPolicy;
  ...
  BackendBucket3(
    ...
    this.cdnPolicy = Output.createUnknown<BackendBucketCdnPolicyResponse3>();
