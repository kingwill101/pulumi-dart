...
import 'router_nat_log_config_response3.dart';
import 'router_nat_rule_response3.dart';
import 'router_nat_subnetwork_to_nat_response3.dart';

/// Represents a Nat resource. It enables the VMs within the specified subnetworks to access Internet without external IP addresses. It specifies a list of subnetworks (and the ranges within) that want to use NAT. Customers can also provide the external IPs that would be used for NAT. GCP would auto-allocate ephemeral IPs if no external IPs are provided.
class RouterNatResponse3 {
  ...
  final RouterNatLogConfigResponse3 logConfig;
  ...
  final List<RouterNatRuleResponse3> rules;
  ...
  final List<RouterNatSubnetworkToNatResponse3> subnetworks;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['natIps'] = natIps;
    map['rules'] =
        Input.encodeList<RouterNatRuleResponse3, Map<String, dynamic>>(
            rules, (value) => value.toMap());
    map['sourceSubnetworkIpRangesToNat'] = sourceSubnetworkIpRangesToNat;
    map['subnetworks'] = Input.encodeList<RouterNatSubnetworkToNatResponse3,
  ...
  factory RouterNatResponse3.fromMap(Map<String, dynamic> map) {
    return RouterNatResponse3(
      ...
      logConfig: RouterNatLogConfigResponse3.fromMap(
      ...
      rules: Input.decodeList<RouterNatRuleResponse3>(
          map['rules'],
          (value) => RouterNatRuleResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat:
          map['sourceSubnetworkIpRangesToNat'] as String,
      subnetworks: Input.decodeList<RouterNatSubnetworkToNatResponse3>(
          map['subnetworks'],
          (value) => RouterNatSubnetworkToNatResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
