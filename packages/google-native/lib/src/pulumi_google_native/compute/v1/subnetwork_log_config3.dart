...
import 'subnetwork_log_config_aggregation_interval3.dart';
import 'subnetwork_log_config_metadata3.dart';

/// The available logging options for this subnetwork.
class SubnetworkLogConfig3 {
  /// Can only be specified if VPC flow logging for this subnetwork is enabled. Toggles the aggregation interval for collecting flow logs. Increasing the interval time will reduce the amount of generated flow logs for long lasting connections. Default is an interval of 5 seconds per connection.
  final SubnetworkLogConfigAggregationInterval3? aggregationInterval;
  ...
  final SubnetworkLogConfigMetadata3? metadata;

  /// Can only be specified if VPC flow logs for this subnetwork is enabled and "metadata" was set to CUSTOM_METADATA.
  final List<String>? metadataFields;

  SubnetworkLogConfig3({
  ...
  factory SubnetworkLogConfig3.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfig3(
      aggregationInterval: map['aggregationInterval'] == null
          ? null
          : SubnetworkLogConfigAggregationInterval3.fromValue(
      ...
      metadata: map['metadata'] == null
          ? null
          : SubnetworkLogConfigMetadata3.fromValue(map['metadata'] as String),
