...
class GetRegionBackendServiceResult3 {
  ...
  final List<BackendResponse3> backends;

  /// Cloud CDN configuration for this BackendService. Only available for specified load balancer types.
  final BackendServiceCdnPolicyResponse3 cdnPolicy;
  final CircuitBreakersResponse3 circuitBreakers;

  /// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
  final String compressionMode;
  final ConnectionDrainingResponse3 connectionDraining;

  /// Connection Tracking configuration for this BackendService. Connection tracking policy settings are only available for Network Load Balancing and Internal TCP/UDP Load Balancing.
  final BackendServiceConnectionTrackingPolicyResponse3
  ...
  final ConsistentHashLoadBalancerSettingsResponse3 consistentHash;
  ...
  final BackendServiceFailoverPolicyResponse3 failoverPolicy;
  ...
  final BackendServiceIAPResponse3 iap;
  ...
  final List<BackendServiceLocalityLoadBalancingPolicyConfigResponse3>
      localityLbPolicies;
  ...
  final OutlierDetectionResponse3 outlierDetection;
  ...
  final SecuritySettingsResponse3 securitySettings;
  ...
  final SubsettingResponse3 subsetting;

  /// The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration.
  final int timeoutSec;
  final List<BackendServiceUsedByResponse3> usedBy;

  GetRegionBackendServiceResult3({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['backends'] = Input.encodeList<BackendResponse3, Map<String, dynamic>>(
    ...
    map['usedBy'] =
        Input.encodeList<BackendServiceUsedByResponse3, Map<String, dynamic>>(
            usedBy, (value) => value.toMap());
    return map;
  }

  factory GetRegionBackendServiceResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceResult3(
      affinityCookieTtlSec: map['affinityCookieTtlSec'] as int,
      backends: Input.decodeList<BackendResponse3>(
          map['backends'],
          (value) =>
              BackendResponse3.fromMap((value as Map).cast<String, dynamic>())),
      cdnPolicy: BackendServiceCdnPolicyResponse3.fromMap(
          (map['cdnPolicy'] as Map).cast<String, dynamic>()),
      circuitBreakers: CircuitBreakersResponse3.fromMap(
          (map['circuitBreakers'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] as String,
      connectionDraining: ConnectionDrainingResponse3.fromMap(
          (map['connectionDraining'] as Map).cast<String, dynamic>()),
      connectionTrackingPolicy:
          BackendServiceConnectionTrackingPolicyResponse3.fromMap(
              (map['connectionTrackingPolicy'] as Map).cast<String, dynamic>()),
      consistentHash: ConsistentHashLoadBalancerSettingsResponse3.fromMap(
      ...
      localityLbPolicies: Input.decodeList<
          ...
          (value) =>
              BackendServiceLocalityLoadBalancingPolicyConfigResponse3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] as String,
      logConfig: BackendServiceLogConfigResponse3.fromMap(
          (map['logConfig'] as Map).cast<String, dynamic>()),
      maxStreamDuration: DurationResponse3.fromMap(
          (map['maxStreamDuration'] as Map).cast<String, dynamic>()),
      metadatas: (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] as String,
      network: map['network'] as String,
      outlierDetection: OutlierDetectionResponse3.fromMap(
      ...
      securitySettings: SecuritySettingsResponse3.fromMap(
      ...
      subsetting: SubsettingResponse3.fromMap(
          (map['subsetting'] as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] as int,
      usedBy: Input.decodeList<BackendServiceUsedByResponse3>(
          map['usedBy'],
          (value) => BackendServiceUsedByResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
