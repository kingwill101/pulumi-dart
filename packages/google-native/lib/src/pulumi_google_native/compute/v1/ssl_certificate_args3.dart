...
import 'ssl_certificate_type3.dart';

/// The set of arguments for SslCertificate.
class SslCertificateArgs3 {
  ...
  final Input<SslCertificateType3>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<SslCertificateType3, String>(
          typeValue, (value) => value.value);
    }
    return map;
  }

  factory SslCertificateArgs3.fromMap(Map<String, dynamic> map) {
    return SslCertificateArgs3(
      ...
      selfManaged:
          Input.asOptionalInput<SslCertificateSelfManagedSslCertificate3>(
              map['selfManaged']),
      type: Input.asOptionalInput<SslCertificateType3>(map['type']),
    );
  }
}
