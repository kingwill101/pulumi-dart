...
import 'network_args3.dart';
import 'network_peering_response3.dart';
import 'network_routing_config_response3.dart';

/// Creates a network in the specified project using the data included in the request.
class Network6 extends CustomResource {
  ...
  late final Output<List<NetworkPeeringResponse3>> peerings;
  ...
  late final Output<NetworkRoutingConfigResponse3> routingConfig;
  ...
  Network6(
    ...
    this.peerings = Output.createUnknown<List<NetworkPeeringResponse3>>();
    this.project = Output.createUnknown<String>();
    this.requestId = Output.createUnknown<String?>();
    this.routingConfig = Output.createUnknown<NetworkRoutingConfigResponse3>();
