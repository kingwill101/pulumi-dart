...
class PacketMirroringFilterResponse3 {
  ...
  PacketMirroringFilterResponse3({
  ...
  factory PacketMirroringFilterResponse3.fromMap(Map<String, dynamic> map) {
    return PacketMirroringFilterResponse3(
