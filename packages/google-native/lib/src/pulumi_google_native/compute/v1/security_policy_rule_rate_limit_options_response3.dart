...
import 'security_policy_rule_rate_limit_options_enforce_on_key_config_response3.dart';
import 'security_policy_rule_rate_limit_options_threshold_response3.dart';
import 'security_policy_rule_redirect_options_response3.dart';

class SecurityPolicyRuleRateLimitOptionsResponse3 {
  /// Can only be specified if the action for the rule is "rate_based_ban". If specified, determines the time (in seconds) the traffic will continue to be banned by the rate limit after the rate falls below the threshold.
  final int banDurationSec;

  /// Can only be specified if the action for the rule is "rate_based_ban". If specified, the key will be banned for the configured 'ban_duration_sec' when the number of requests that exceed the 'rate_limit_threshold' also exceed this 'ban_threshold'.
  final SecurityPolicyRuleRateLimitOptionsThresholdResponse3 banThreshold;
  ...
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse3>
      enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRedirectOptionsResponse3 exceedRedirectOptions;

  /// Threshold at which to begin ratelimiting.
  final SecurityPolicyRuleRateLimitOptionsThresholdResponse3 rateLimitThreshold;

  SecurityPolicyRuleRateLimitOptionsResponse3({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['enforceOnKeyConfigs'] = Input.encodeList<
        SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse3,
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponse3.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponse3(
      banDurationSec: map['banDurationSec'] as int,
      banThreshold:
          SecurityPolicyRuleRateLimitOptionsThresholdResponse3.fromMap(
      ...
      exceedRedirectOptions: SecurityPolicyRuleRedirectOptionsResponse3.fromMap(
