...
import 'security_policy_rule_rate_limit_options_enforce_on_key3.dart';
import 'security_policy_rule_rate_limit_options_enforce_on_key_config3.dart';
import 'security_policy_rule_rate_limit_options_threshold3.dart';
import 'security_policy_rule_redirect_options3.dart';

class SecurityPolicyRuleRateLimitOptions3 {
  /// Can only be specified if the action for the rule is "rate_based_ban". If specified, determines the time (in seconds) the traffic will continue to be banned by the rate limit after the rate falls below the threshold.
  final int? banDurationSec;

  /// Can only be specified if the action for the rule is "rate_based_ban". If specified, the key will be banned for the configured 'ban_duration_sec' when the number of requests that exceed the 'rate_limit_threshold' also exceed this 'ban_threshold'.
  final SecurityPolicyRuleRateLimitOptionsThreshold3? banThreshold;
  ...
  final SecurityPolicyRuleRateLimitOptionsEnforceOnKey3? enforceOnKey;

  /// If specified, any combination of values of enforce_on_key_type/enforce_on_key_name is treated as the key on which ratelimit threshold/action is enforced. You can specify up to 3 enforce_on_key_configs. If enforce_on_key_configs is specified, enforce_on_key must not be specified.
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig3>?
      enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRedirectOptions3? exceedRedirectOptions;

  /// Threshold at which to begin ratelimiting.
  final SecurityPolicyRuleRateLimitOptionsThreshold3? rateLimitThreshold;

  SecurityPolicyRuleRateLimitOptions3({
    this.banDurationSec,
    this.banThreshold,
    this.conformAction,
    this.enforceOnKey,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (enforceOnKeyConfigsValue != null) {
      map['enforceOnKeyConfigs'] = Input.encodeList<
              SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig3,
              Map<String, dynamic>>(
  ...
  factory SecurityPolicyRuleRateLimitOptions3.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptions3(
      banDurationSec:
          map['banDurationSec'] == null ? null : map['banDurationSec'] as int,
      banThreshold: map['banThreshold'] == null
          ? null
          : SecurityPolicyRuleRateLimitOptionsThreshold3.fromMap(
      ...
      enforceOnKey: map['enforceOnKey'] == null
          ? null
          : SecurityPolicyRuleRateLimitOptionsEnforceOnKey3.fromValue(
      ...
      enforceOnKeyConfigs: map['enforceOnKeyConfigs'] == null
          ...
          : Input.decodeList<
              ...
              (value) =>
                  SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig3.fromMap(
      ...
      exceedRedirectOptions: map['exceedRedirectOptions'] == null
          ? null
          : SecurityPolicyRuleRedirectOptions3.fromMap(
