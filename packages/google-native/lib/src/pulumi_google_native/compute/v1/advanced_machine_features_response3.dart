...
class AdvancedMachineFeaturesResponse3 {
  ...
  AdvancedMachineFeaturesResponse3({
  ...
  factory AdvancedMachineFeaturesResponse3.fromMap(Map<String, dynamic> map) {
    return AdvancedMachineFeaturesResponse3(
