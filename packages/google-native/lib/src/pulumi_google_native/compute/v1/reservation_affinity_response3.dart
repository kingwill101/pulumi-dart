...
class ReservationAffinityResponse3 {
  ...
  factory ReservationAffinityResponse3.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityResponse3(
