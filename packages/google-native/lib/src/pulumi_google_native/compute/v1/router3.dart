...
class Router3 extends CustomResource {
  ...
  Router3(
    ...
    this.bgp = registerOutput<RouterBgpResponse3>('bgp');
    this.bgpPeers = registerOutput<List<RouterBgpPeerResponse3>>('bgpPeers');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.description = registerOutput<String>('description');
    this.encryptedInterconnectRouter =
        registerOutput<bool>('encryptedInterconnectRouter');
    this.interfaces =
        registerOutput<List<RouterInterfaceResponse3>>('interfaces');
    this.kind = registerOutput<String>('kind');
    this.md5AuthenticationKeys =
        registerOutput<List<RouterMd5AuthenticationKeyResponse3>>(
            'md5AuthenticationKeys');
    this.name = registerOutput<String>('name');
    this.nats = registerOutput<List<RouterNatResponse3>>('nats');
