...
class DiskAsyncReplicationResponse3 {
  ...
  factory DiskAsyncReplicationResponse3.fromMap(Map<String, dynamic> map) {
    return DiskAsyncReplicationResponse3(
