...
import 'security_policy_rule_network_matcher_user_defined_field_match_response3.dart';

/// Represents a match condition that incoming network traffic is evaluated against.
class SecurityPolicyRuleNetworkMatcherResponse3 {
  ...
  final List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponse3>
      userDefinedFields;

  SecurityPolicyRuleNetworkMatcherResponse3({
  ...
  factory SecurityPolicyRuleNetworkMatcherResponse3.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherResponse3(
