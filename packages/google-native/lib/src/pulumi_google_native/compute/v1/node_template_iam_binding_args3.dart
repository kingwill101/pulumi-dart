...
class NodeTemplateIamBindingArgs3 {
  ...
  factory NodeTemplateIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return NodeTemplateIamBindingArgs3(
