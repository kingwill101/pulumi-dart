...
import 'awsv4_signature_response3.dart';

/// The authentication and authorization settings for a BackendService.
class SecuritySettingsResponse3 {
  ...
  final AWSV4SignatureResponse3 awsV4Authentication;
  ...
  factory SecuritySettingsResponse3.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponse3(
      awsV4Authentication: AWSV4SignatureResponse3.fromMap(
