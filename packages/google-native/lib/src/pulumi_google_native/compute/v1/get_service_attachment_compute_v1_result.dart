...
import 'service_attachment_connected_endpoint_response_compute_v1.dart';
import 'service_attachment_consumer_project_limit_response_compute_v1.dart';
import 'uint128_response_compute_v1.dart';

/// Result data returned by getServiceAttachment.
class GetServiceAttachmentComputeV1Result {
  /// An array of connections for all the consumers connected to this service attachment.
  final List<ServiceAttachmentConnectedEndpointResponseComputeV1>
      connectedEndpoints;
  ...
  final List<ServiceAttachmentConsumerProjectLimitResponseComputeV1>
      consumerAcceptLists;
  ...
  final Uint128ResponseComputeV1 pscServiceAttachmentId;
  ...
  factory GetServiceAttachmentComputeV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetServiceAttachmentComputeV1Result(
      connectedEndpoints: pulumi.Input.decodeList<
              ServiceAttachmentConnectedEndpointResponseComputeV1>(
          map['connectedEndpoints'],
          (value) =>
              ServiceAttachmentConnectedEndpointResponseComputeV1.fromMap(
      ...
      consumerAcceptLists: pulumi.Input.decodeList<
          ...
          (value) =>
              ServiceAttachmentConsumerProjectLimitResponseComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      pscServiceAttachmentId: Uint128ResponseComputeV1.fromMap(
