...
class GetGlobalPublicDelegatedPrefixResult3 {
  ...
  GetGlobalPublicDelegatedPrefixResult3({
  ...
  factory GetGlobalPublicDelegatedPrefixResult3.fromMap(
      Map<String, dynamic> map) {
    return GetGlobalPublicDelegatedPrefixResult3(
