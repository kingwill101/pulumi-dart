...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header_response3.dart';
import 'backend_bucket_cdn_policy_cache_key_policy_response3.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy_response3.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicyResponse3 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse3>
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final BackendBucketCdnPolicyCacheKeyPolicyResponse3 cacheKeyPolicy;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyResponse3>
  ...
  BackendBucketCdnPolicyResponse3({
  ...
  factory BackendBucketCdnPolicyResponse3.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponse3(
      bypassCacheOnRequestHeaders: Input.decodeList<
              BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse3>(
          map['bypassCacheOnRequestHeaders'],
          (value) =>
              BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: BackendBucketCdnPolicyCacheKeyPolicyResponse3.fromMap(
      ...
      negativeCachingPolicy: Input.decodeList<
          ...
          (value) =>
              BackendBucketCdnPolicyNegativeCachingPolicyResponse3.fromMap(
                  (value as Map).cast<String, dynamic>())),
