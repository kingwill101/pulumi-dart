...
class InstanceGroupManagerVersion3 {
  ...
  final FixedOrPercent3? targetSize;

  InstanceGroupManagerVersion3({
  ...
  factory InstanceGroupManagerVersion3.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerVersion3(
