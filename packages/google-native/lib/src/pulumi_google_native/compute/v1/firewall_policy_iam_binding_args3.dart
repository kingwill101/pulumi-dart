...
class FirewallPolicyIamBindingArgs3 {
  ...
  factory FirewallPolicyIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamBindingArgs3(
