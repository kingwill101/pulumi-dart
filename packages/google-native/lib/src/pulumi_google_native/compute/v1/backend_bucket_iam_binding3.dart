...
import 'backend_bucket_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class BackendBucketIamBinding3 extends CustomResource {
  ...
  BackendBucketIamBinding3(
    String name, {
    BackendBucketIamBindingArgs3? args,
