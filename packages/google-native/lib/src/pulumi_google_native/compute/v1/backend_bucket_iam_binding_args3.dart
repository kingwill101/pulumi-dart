...
class BackendBucketIamBindingArgs3 {
  ...
  factory BackendBucketIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamBindingArgs3(
