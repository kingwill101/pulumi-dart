...
class NodeTemplateNodeTypeFlexibility3 {
  final String? cpus;
  final String? localSsd;
  final String? memory;

  NodeTemplateNodeTypeFlexibility3({
    this.cpus,
    this.localSsd,
    this.memory,
  });
  ...
  factory NodeTemplateNodeTypeFlexibility3.fromMap(Map<String, dynamic> map) {
    return NodeTemplateNodeTypeFlexibility3(
