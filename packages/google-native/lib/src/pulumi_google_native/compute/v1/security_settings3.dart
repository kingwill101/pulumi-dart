...
import 'awsv4_signature3.dart';

/// The authentication and authorization settings for a BackendService.
class SecuritySettings3 {
  ...
  final AWSV4Signature3? awsV4Authentication;
  ...
  factory SecuritySettings3.fromMap(Map<String, dynamic> map) {
    return SecuritySettings3(
      awsV4Authentication: map['awsV4Authentication'] == null
          ? null
          : AWSV4Signature3.fromMap(
