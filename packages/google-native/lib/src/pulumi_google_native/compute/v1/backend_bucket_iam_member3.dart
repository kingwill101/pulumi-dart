...
import 'backend_bucket_iam_member_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class BackendBucketIamMember3 extends CustomResource {
  ...
  BackendBucketIamMember3(
    String name, {
    BackendBucketIamMemberArgs3? args,
