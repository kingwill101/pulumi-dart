...
import 'int64_range_match3.dart';

/// matchRule criteria for request header matches.
class HttpHeaderMatch3 {
  ...
  final Int64RangeMatch3? rangeMatch;
  ...
  factory HttpHeaderMatch3.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatch3(
      exactMatch:
