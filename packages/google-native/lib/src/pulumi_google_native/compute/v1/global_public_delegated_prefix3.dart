...
import 'global_public_delegated_prefix_args3.dart';
import 'public_delegated_prefix_public_delegated_sub_prefix_response3.dart';

/// Creates a global PublicDelegatedPrefix in the specified project using the parameters that are included in the request.
class GlobalPublicDelegatedPrefix3 extends CustomResource {
  ...
  GlobalPublicDelegatedPrefix3(
    String name, {
    GlobalPublicDelegatedPrefixArgs3? args,
