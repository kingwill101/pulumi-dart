...
class NetworkAttachmentConnectedEndpointResponse3 {
  ...
  factory NetworkAttachmentConnectedEndpointResponse3.fromMap(
      Map<String, dynamic> map) {
    return NetworkAttachmentConnectedEndpointResponse3(
