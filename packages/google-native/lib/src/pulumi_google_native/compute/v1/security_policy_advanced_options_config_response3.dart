...
import 'security_policy_advanced_options_config_json_custom_config_response3.dart';

class SecurityPolicyAdvancedOptionsConfigResponse3 {
  /// Custom configuration to apply the JSON parsing. Only applicable when json_parsing is set to STANDARD.
  final SecurityPolicyAdvancedOptionsConfigJsonCustomConfigResponse3
      jsonCustomConfig;
  ...
  SecurityPolicyAdvancedOptionsConfigResponse3({
  ...
  factory SecurityPolicyAdvancedOptionsConfigResponse3.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyAdvancedOptionsConfigResponse3(
      jsonCustomConfig:
          SecurityPolicyAdvancedOptionsConfigJsonCustomConfigResponse3.fromMap(
