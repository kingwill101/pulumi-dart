...
class ResourcePolicyIamBindingArgs3 {
  ...
  factory ResourcePolicyIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamBindingArgs3(
