...
import 'backend_bucket_cdn_policy3.dart';
import 'backend_bucket_compression_mode3.dart';

/// The set of arguments for BackendBucket.
class BackendBucketArgs3 {
  /// Cloud Storage bucket name.
  final Input<String>? bucketName;

  /// Cloud CDN configuration for this BackendBucket.
  final Input<BackendBucketCdnPolicy3>? cdnPolicy;

  /// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
  final Input<BackendBucketCompressionMode3>? compressionMode;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (cdnPolicyValue != null) {
      map['cdnPolicy'] = Input.mapOptionalInputValue<BackendBucketCdnPolicy3,
    ...
    if (compressionModeValue != null) {
      map['compressionMode'] =
          Input.mapOptionalInputValue<BackendBucketCompressionMode3, String>(
  ...
  factory BackendBucketArgs3.fromMap(Map<String, dynamic> map) {
    return BackendBucketArgs3(
      bucketName: Input.asOptionalInput<String>(map['bucketName']),
      cdnPolicy:
          Input.asOptionalInput<BackendBucketCdnPolicy3>(map['cdnPolicy']),
      compressionMode: Input.asOptionalInput<BackendBucketCompressionMode3>(
          map['compressionMode']),
