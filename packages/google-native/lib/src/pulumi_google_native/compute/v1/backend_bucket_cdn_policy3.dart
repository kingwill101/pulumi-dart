...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header3.dart';
import 'backend_bucket_cdn_policy_cache_key_policy3.dart';
import 'backend_bucket_cdn_policy_cache_mode3.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy3.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicy3 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeader3>?
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final BackendBucketCdnPolicyCacheKeyPolicy3? cacheKeyPolicy;
  ...
  final BackendBucketCdnPolicyCacheMode3? cacheMode;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicy3>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bypassCacheOnRequestHeadersValue != null) {
      map['bypassCacheOnRequestHeaders'] = Input.encodeList<
              BackendBucketCdnPolicyBypassCacheOnRequestHeader3,
              Map<String, dynamic>>(
    ...
    if (negativeCachingPolicyValue != null) {
      map['negativeCachingPolicy'] = Input.encodeList<
              BackendBucketCdnPolicyNegativeCachingPolicy3,
              Map<String, dynamic>>(
  ...
  factory BackendBucketCdnPolicy3.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicy3(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null
          ? null
          : Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeader3>(
              map['bypassCacheOnRequestHeaders'],
              (value) =>
                  BackendBucketCdnPolicyBypassCacheOnRequestHeader3.fromMap(
                      (value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null
          ? null
          : BackendBucketCdnPolicyCacheKeyPolicy3.fromMap(
              (map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null
          ? null
          : BackendBucketCdnPolicyCacheMode3.fromValue(
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null
          ? null
          : Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicy3>(
              map['negativeCachingPolicy'],
              (value) => BackendBucketCdnPolicyNegativeCachingPolicy3.fromMap(
                  (value as Map).cast<String, dynamic>())),
