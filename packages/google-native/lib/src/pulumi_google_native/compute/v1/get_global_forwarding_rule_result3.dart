...
class GetGlobalForwardingRuleResult3 {
  ...
  GetGlobalForwardingRuleResult3({
  ...
  factory GetGlobalForwardingRuleResult3.fromMap(Map<String, dynamic> map) {
    return GetGlobalForwardingRuleResult3(
