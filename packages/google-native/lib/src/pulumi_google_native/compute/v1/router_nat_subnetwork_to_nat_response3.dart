...
class RouterNatSubnetworkToNatResponse3 {
  ...
  RouterNatSubnetworkToNatResponse3({
    required this.name,
  ...
  factory RouterNatSubnetworkToNatResponse3.fromMap(Map<String, dynamic> map) {
    return RouterNatSubnetworkToNatResponse3(
