...
import 'network_endpoint_group_network_endpoint_type3.dart';

/// The set of arguments for NetworkEndpointGroup.
class NetworkEndpointGroupArgs3 {
  ...
  final Input<NetworkEndpointGroupNetworkEndpointType3>? networkEndpointType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkEndpointTypeValue != null) {
      map['networkEndpointType'] = Input.mapOptionalInputValue<
          NetworkEndpointGroupNetworkEndpointType3,
  ...
  factory NetworkEndpointGroupArgs3.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupArgs3(
      annotations:
      ...
      networkEndpointType:
          Input.asOptionalInput<NetworkEndpointGroupNetworkEndpointType3>(
