...
class GetNodeGroupResult3 {
  /// Specifies how autoscaling should behave.
  final NodeGroupAutoscalingPolicyResponse3 autoscalingPolicy;
  ...
  final NodeGroupMaintenanceWindowResponse3 maintenanceWindow;
  ...
  factory GetNodeGroupResult3.fromMap(Map<String, dynamic> map) {
    return GetNodeGroupResult3(
      autoscalingPolicy: NodeGroupAutoscalingPolicyResponse3.fromMap(
      ...
      maintenanceWindow: NodeGroupMaintenanceWindowResponse3.fromMap(
