...
import 'disk_instantiation_config_instantiate_from3.dart';

/// A specification of the desired way to instantiate a disk in the instance template when its created from a source instance.
class DiskInstantiationConfig3 {
  ...
  final DiskInstantiationConfigInstantiateFrom3? instantiateFrom;

  DiskInstantiationConfig3({
    this.autoDelete,
    this.customImage,
    this.deviceName,
  ...
  factory DiskInstantiationConfig3.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfig3(
      ...
      instantiateFrom: map['instantiateFrom'] == null
          ? null
          : DiskInstantiationConfigInstantiateFrom3.fromValue(
