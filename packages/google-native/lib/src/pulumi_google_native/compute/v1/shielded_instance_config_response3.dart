...
class ShieldedInstanceConfigResponse3 {
  ...
  ShieldedInstanceConfigResponse3({
  ...
  factory ShieldedInstanceConfigResponse3.fromMap(Map<String, dynamic> map) {
    return ShieldedInstanceConfigResponse3(
