...
import 'router_nat_rule_action3.dart';

class RouterNatRule3 {
  /// The action to be enforced for traffic that matches this rule.
  final RouterNatRuleAction3? action;
  ...
  factory RouterNatRule3.fromMap(Map<String, dynamic> map) {
    return RouterNatRule3(
      action: map['action'] == null
          ? null
          : RouterNatRuleAction3.fromMap(
