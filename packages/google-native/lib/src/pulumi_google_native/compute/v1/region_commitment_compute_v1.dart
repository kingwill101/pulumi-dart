...
import 'region_commitment_compute_v1_args.dart';
...
class RegionCommitmentComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LicenseResourceCommitmentResponseComputeV1>
      licenseResource;
  ...
  late final pulumi.Output<List<ReservationResponseComputeV1>> reservations;

  /// A list of commitment amounts for particular resources. Note that VCPU and MEMORY resource commitments must occur together.
  late final pulumi.Output<List<ResourceCommitmentResponseComputeV1>> resources;
  ...
  RegionCommitmentComputeV1(
    String name, {
    RegionCommitmentComputeV1Args? args,
    ...
    this.reservations =
        registerOutput<List<ReservationResponseComputeV1>>('reservations');
    this.resources =
        registerOutput<List<ResourceCommitmentResponseComputeV1>>('resources');
