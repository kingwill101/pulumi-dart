...
import 'scheduling_node_affinity_response3.dart';

/// Sets the scheduling options for an Instance.
class SchedulingResponse3 {
  ...
  final DurationResponse3 localSsdRecoveryTimeout;
  ...
  final List<SchedulingNodeAffinityResponse3> nodeAffinities;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['nodeAffinities'] =
        Input.encodeList<SchedulingNodeAffinityResponse3, Map<String, dynamic>>(
  ...
  factory SchedulingResponse3.fromMap(Map<String, dynamic> map) {
    return SchedulingResponse3(
      automaticRestart: map['automaticRestart'] as bool,
      instanceTerminationAction: map['instanceTerminationAction'] as String,
      localSsdRecoveryTimeout: DurationResponse3.fromMap(
      ...
      nodeAffinities: Input.decodeList<SchedulingNodeAffinityResponse3>(
          map['nodeAffinities'],
          (value) => SchedulingNodeAffinityResponse3.fromMap(
