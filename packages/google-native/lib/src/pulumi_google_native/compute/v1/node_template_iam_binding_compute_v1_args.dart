...
class NodeTemplateIamBindingComputeV1Args {
  ...
  NodeTemplateIamBindingComputeV1Args({
    this.condition,
  ...
  factory NodeTemplateIamBindingComputeV1Args.fromMap(
      Map<String, dynamic> map) {
    return NodeTemplateIamBindingComputeV1Args(
