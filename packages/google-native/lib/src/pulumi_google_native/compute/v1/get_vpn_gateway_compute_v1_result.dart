...
class GetVpnGatewayComputeV1Result {
  ...
  final List<VpnGatewayVpnGatewayInterfaceResponseComputeV1> vpnInterfaces;
  ...
  factory GetVpnGatewayComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetVpnGatewayComputeV1Result(
      ...
      vpnInterfaces: pulumi.Input.decodeList<
              VpnGatewayVpnGatewayInterfaceResponseComputeV1>(
          map['vpnInterfaces'],
          (value) => VpnGatewayVpnGatewayInterfaceResponseComputeV1.fromMap(
