...
import 'router_nat_auto_network_tier3.dart';
import 'router_nat_endpoint_types_item3.dart';
import 'router_nat_log_config3.dart';
import 'router_nat_nat_ip_allocate_option3.dart';
import 'router_nat_rule3.dart';
import 'router_nat_source_subnetwork_ip_ranges_to_nat3.dart';
import 'router_nat_subnetwork_to_nat3.dart';
import 'router_nat_type3.dart';

/// Represents a Nat resource. It enables the VMs within the specified subnetworks to access Internet without external IP addresses. It specifies a list of subnetworks (and the ranges within) that want to use NAT. Customers can also provide the external IPs that would be used for NAT. GCP would auto-allocate ephemeral IPs if no external IPs are provided.
class RouterNat3 {
  /// The network tier to use when automatically reserving NAT IP addresses. Must be one of: PREMIUM, STANDARD. If not specified, then the current project-level default tier is used.
  final RouterNatAutoNetworkTier3? autoNetworkTier;
  ...
  final List<RouterNatEndpointTypesItem3>? endpointTypes;

  /// Timeout (in seconds) for ICMP connections. Defaults to 30s if not set.
  final int? icmpIdleTimeoutSec;

  /// Configure logging on this NAT.
  final RouterNatLogConfig3? logConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (endpointTypesValue != null) {
      map['endpointTypes'] =
          Input.encodeList<RouterNatEndpointTypesItem3, String>(
    ...
    if (rulesValue != null) {
      map['rules'] = Input.encodeList<RouterNatRule3, Map<String, dynamic>>(
    ...
    if (subnetworksValue != null) {
      map['subnetworks'] =
          Input.encodeList<RouterNatSubnetworkToNat3, Map<String, dynamic>>(
  ...
  factory RouterNat3.fromMap(Map<String, dynamic> map) {
    return RouterNat3(
      autoNetworkTier: map['autoNetworkTier'] == null
          ? null
          : RouterNatAutoNetworkTier3.fromValue(
      ...
      endpointTypes: map['endpointTypes'] == null
          ? null
          : Input.decodeList<RouterNatEndpointTypesItem3>(
              map['endpointTypes'],
              (value) =>
                  RouterNatEndpointTypesItem3.fromValue(value as String)),
      icmpIdleTimeoutSec: map['icmpIdleTimeoutSec'] == null
          ? null
          : map['icmpIdleTimeoutSec'] as int,
      logConfig: map['logConfig'] == null
          ? null
          : RouterNatLogConfig3.fromMap(
      ...
      natIpAllocateOption: map['natIpAllocateOption'] == null
          ? null
          : RouterNatNatIpAllocateOption3.fromValue(
              map['natIpAllocateOption'] as String),
      natIps:
          map['natIps'] == null ? null : (map['natIps'] as List).cast<String>(),
      rules: map['rules'] == null
          ? null
          : Input.decodeList<RouterNatRule3>(
              map['rules'],
              (value) => RouterNatRule3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat:
          map['sourceSubnetworkIpRangesToNat'] == null
              ? null
              : RouterNatSourceSubnetworkIpRangesToNat3.fromValue(
                  map['sourceSubnetworkIpRangesToNat'] as String),
      subnetworks: map['subnetworks'] == null
          ? null
          : Input.decodeList<RouterNatSubnetworkToNat3>(
              map['subnetworks'],
              (value) => RouterNatSubnetworkToNat3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null
          ? null
          : RouterNatType3.fromValue(map['type'] as String),
