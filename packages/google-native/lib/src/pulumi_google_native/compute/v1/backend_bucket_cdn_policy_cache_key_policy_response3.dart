...
class BackendBucketCdnPolicyCacheKeyPolicyResponse3 {
  ...
  BackendBucketCdnPolicyCacheKeyPolicyResponse3({
  ...
  factory BackendBucketCdnPolicyCacheKeyPolicyResponse3.fromMap(
      Map<String, dynamic> map) {
    return BackendBucketCdnPolicyCacheKeyPolicyResponse3(
