...
class InstanceGroupManagerUpdatePolicyResponse3 {
  ...
  final FixedOrPercentResponse3 maxSurge;
  ...
  final FixedOrPercentResponse3 maxUnavailable;
  ...
  InstanceGroupManagerUpdatePolicyResponse3({
  ...
  factory InstanceGroupManagerUpdatePolicyResponse3.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyResponse3(
      instanceRedistributionType: map['instanceRedistributionType'] as String,
      maxSurge: FixedOrPercentResponse3.fromMap(
          (map['maxSurge'] as Map).cast<String, dynamic>()),
      maxUnavailable: FixedOrPercentResponse3.fromMap(
