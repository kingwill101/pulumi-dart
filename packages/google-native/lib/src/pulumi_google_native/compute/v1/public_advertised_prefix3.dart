...
import 'public_advertised_prefix_args3.dart';
import 'public_advertised_prefix_public_delegated_prefix_response3.dart';

/// Creates a PublicAdvertisedPrefix in the specified project using the parameters that are included in the request.
class PublicAdvertisedPrefix3 extends CustomResource {
  ...
  late final Output<List<PublicAdvertisedPrefixPublicDelegatedPrefixResponse3>>
  ...
  PublicAdvertisedPrefix3(
    String name, {
    PublicAdvertisedPrefixArgs3? args,
    ...
    this.publicDelegatedPrefixs = Output.createUnknown<
        List<PublicAdvertisedPrefixPublicDelegatedPrefixResponse3>>();
