...
import 'region_instance_group_manager_list_managed_instances_results3.dart';
import 'stateful_policy3.dart';

/// The set of arguments for RegionInstanceGroupManager.
class RegionInstanceGroupManagerArgs3 {
  ...
  final Input<RegionInstanceGroupManagerListManagedInstancesResults3>?
  ...
  RegionInstanceGroupManagerArgs3({
  ...
  Map<String, dynamic> toMap() {
    ...
    if (listManagedInstancesResultsValue != null) {
      map['listManagedInstancesResults'] = Input.mapOptionalInputValue<
          RegionInstanceGroupManagerListManagedInstancesResults3,
  ...
  factory RegionInstanceGroupManagerArgs3.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerArgs3(
      autoHealingPolicies:
