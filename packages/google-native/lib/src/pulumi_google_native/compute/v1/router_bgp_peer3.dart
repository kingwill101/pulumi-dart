...
import 'router_bgp_peer_bfd3.dart';
import 'router_bgp_peer_custom_learned_ip_range3.dart';
import 'router_bgp_peer_enable3.dart';

class RouterBgpPeer3 {
  /// User-specified flag to indicate which mode to use for advertisement.
  final RouterBgpPeerAdvertiseMode3? advertiseMode;

  /// User-specified list of prefix groups to advertise in custom mode, which currently supports the following option: - ALL_SUBNETS: Advertises all of the router's own VPC subnets. This excludes any routes learned for subnets that use VPC Network Peering. Note that this field can only be populated if advertise_mode is CUSTOM and overrides the list defined for the router (in the "bgp" message). These groups are advertised in addition to any specified prefixes. Leave this field blank to advertise no custom groups.
  final List<RouterBgpPeerAdvertisedGroupsItem3>? advertisedGroups;
  ...
  final RouterBgpPeerBfd3? bfd;

  /// A list of user-defined custom learned route IP address ranges for a BGP session.
  final List<RouterBgpPeerCustomLearnedIpRange3>? customLearnedIpRanges;
  ...
  final RouterBgpPeerEnable3? enable;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (advertisedGroupsValue != null) {
      map['advertisedGroups'] =
          Input.encodeList<RouterBgpPeerAdvertisedGroupsItem3, String>(
    ...
    if (customLearnedIpRangesValue != null) {
      map['customLearnedIpRanges'] = Input.encodeList<
              RouterBgpPeerCustomLearnedIpRange3, Map<String, dynamic>>(
  ...
  factory RouterBgpPeer3.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeer3(
      advertiseMode: map['advertiseMode'] == null
          ? null
          : RouterBgpPeerAdvertiseMode3.fromValue(
              map['advertiseMode'] as String),
      advertisedGroups: map['advertisedGroups'] == null
          ? null
          : Input.decodeList<RouterBgpPeerAdvertisedGroupsItem3>(
              map['advertisedGroups'],
              (value) => RouterBgpPeerAdvertisedGroupsItem3.fromValue(
                  value as String)),
      ...
      bfd: map['bfd'] == null
          ? null
          : RouterBgpPeerBfd3.fromMap(
              (map['bfd'] as Map).cast<String, dynamic>()),
      customLearnedIpRanges: map['customLearnedIpRanges'] == null
          ? null
          : Input.decodeList<RouterBgpPeerCustomLearnedIpRange3>(
              map['customLearnedIpRanges'],
              (value) => RouterBgpPeerCustomLearnedIpRange3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      enable: map['enable'] == null
          ? null
          : RouterBgpPeerEnable3.fromValue(map['enable'] as String),
