...
class OutlierDetectionResponse3 {
  ...
  final DurationResponse3 baseEjectionTime;
  ...
  final DurationResponse3 interval;
  ...
  factory OutlierDetectionResponse3.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponse3(
      baseEjectionTime: DurationResponse3.fromMap(
      ...
      interval: DurationResponse3.fromMap(
