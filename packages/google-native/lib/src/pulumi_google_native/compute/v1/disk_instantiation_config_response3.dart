...
class DiskInstantiationConfigResponse3 {
  ...
  DiskInstantiationConfigResponse3({
  ...
  factory DiskInstantiationConfigResponse3.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfigResponse3(
