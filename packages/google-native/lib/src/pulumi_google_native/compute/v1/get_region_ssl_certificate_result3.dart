...
class GetRegionSslCertificateResult3 {
  ...
  final SslCertificateManagedSslCertificateResponse3 managed;
  ...
  final SslCertificateSelfManagedSslCertificateResponse3 selfManaged;
  ...
  GetRegionSslCertificateResult3({
  ...
  factory GetRegionSslCertificateResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionSslCertificateResult3(
      certificate: map['certificate'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      kind: map['kind'] as String,
      managed: SslCertificateManagedSslCertificateResponse3.fromMap(
          (map['managed'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      privateKey: map['privateKey'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      selfManaged: SslCertificateSelfManagedSslCertificateResponse3.fromMap(
