...
class InstanceTemplateIamMemberArgs3 {
  ...
  InstanceTemplateIamMemberArgs3({
    this.condition,
  ...
  factory InstanceTemplateIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateIamMemberArgs3(
