...
class ResourcePolicyDailyCycle3 {
  ...
  factory ResourcePolicyDailyCycle3.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyDailyCycle3(
      daysInCycle:
