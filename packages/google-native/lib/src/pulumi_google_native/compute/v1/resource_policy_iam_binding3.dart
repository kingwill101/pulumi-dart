...
import 'resource_policy_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class ResourcePolicyIamBinding3 extends CustomResource {
  ...
  ResourcePolicyIamBinding3(
    String name, {
    ResourcePolicyIamBindingArgs3? args,
