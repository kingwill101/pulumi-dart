...
import 'firewall_policy_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class FirewallPolicyIamBinding3 extends CustomResource {
  ...
  FirewallPolicyIamBinding3(
    String name, {
    FirewallPolicyIamBindingArgs3? args,
