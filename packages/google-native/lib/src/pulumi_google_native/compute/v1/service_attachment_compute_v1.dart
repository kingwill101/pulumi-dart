...
class ServiceAttachmentComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<ServiceAttachmentConnectedEndpointResponseComputeV1>>
      connectedEndpoints;
  ...
  late final pulumi
      .Output<List<ServiceAttachmentConsumerProjectLimitResponseComputeV1>>
      consumerAcceptLists;
  ...
  ServiceAttachmentComputeV1(
    ...
    this.connectedEndpoints = registerOutput<
            List<ServiceAttachmentConnectedEndpointResponseComputeV1>>(
        'connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists = registerOutput<
            List<ServiceAttachmentConsumerProjectLimitResponseComputeV1>>(
        'consumerAcceptLists');
    ...
    this.pscServiceAttachmentId =
        registerOutput<Uint128ResponseComputeV1>('pscServiceAttachmentId');
