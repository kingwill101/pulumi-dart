...
import 'ssl_policy_warnings_item_response3.dart';

/// Result data returned by getSslPolicy.
class GetSslPolicyResult3 {
  ...
  final List<SslPolicyWarningsItemResponse3> warnings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['warnings'] =
        Input.encodeList<SslPolicyWarningsItemResponse3, Map<String, dynamic>>(
            warnings, (value) => value.toMap());
    return map;
  }

  factory GetSslPolicyResult3.fromMap(Map<String, dynamic> map) {
    return GetSslPolicyResult3(
      ...
      warnings: Input.decodeList<SslPolicyWarningsItemResponse3>(
          map['warnings'],
          (value) => SslPolicyWarningsItemResponse3.fromMap(
