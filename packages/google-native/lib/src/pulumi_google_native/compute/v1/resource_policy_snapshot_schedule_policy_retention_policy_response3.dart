...
class ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse3 {
  ...
  ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse3({
  ...
  factory ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse3.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse3(
