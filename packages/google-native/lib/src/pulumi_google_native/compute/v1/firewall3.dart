...
import 'firewall_allowed_item_response3.dart';
import 'firewall_args3.dart';
import 'firewall_denied_item_response3.dart';
import 'firewall_log_config_response3.dart';

/// Creates a firewall rule in the specified project using the data included in the request.
class Firewall3 extends CustomResource {
  /// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
  late final Output<List<FirewallAllowedItemResponse3>> allowed;

  /// Creation timestamp in RFC3339 text format.
  late final Output<String> creationTimestamp;

  /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
  late final Output<List<FirewallDeniedItemResponse3>> denied;
  ...
  late final Output<FirewallLogConfigResponse3> logConfig;
  ...
  Firewall3(
    ...
    this.allowed = Output.createUnknown<List<FirewallAllowedItemResponse3>>();
    this.creationTimestamp = Output.createUnknown<String>();
    this.denied = Output.createUnknown<List<FirewallDeniedItemResponse3>>();
    ...
    this.logConfig = Output.createUnknown<FirewallLogConfigResponse3>();
