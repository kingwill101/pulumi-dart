...
class Firewall3 extends CustomResource {
  ...
  Firewall3(
    ...
    this.allowed =
        registerOutput<List<FirewallAllowedItemResponse3>>('allowed');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.denied = registerOutput<List<FirewallDeniedItemResponse3>>('denied');
    ...
    this.logConfig = registerOutput<FirewallLogConfigResponse3>('logConfig');
