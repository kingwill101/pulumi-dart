...
class Reservation8 extends CustomResource {
  ...
  late final Output<AllocationResourceStatusResponse3> resourceStatus;
  ...
  late final Output<AllocationSpecificSKUReservationResponse3>
      specificReservation;
