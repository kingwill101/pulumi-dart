...
import 'license_args3.dart';
import 'license_resource_requirements_response3.dart';

/// Create a License resource in the specified project. *Caution* This resource is intended for use only by third-party partners who are creating Cloud Marketplace images.
class License6 extends CustomResource {
  ...
  late final Output<LicenseResourceRequirementsResponse3> resourceRequirements;
  ...
  License6(
    ...
    this.resourceRequirements =
        Output.createUnknown<LicenseResourceRequirementsResponse3>();
