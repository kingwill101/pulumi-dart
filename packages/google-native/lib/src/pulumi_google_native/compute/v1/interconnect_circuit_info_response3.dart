...
class InterconnectCircuitInfoResponse3 {
  ...
  InterconnectCircuitInfoResponse3({
  ...
  factory InterconnectCircuitInfoResponse3.fromMap(Map<String, dynamic> map) {
    return InterconnectCircuitInfoResponse3(
