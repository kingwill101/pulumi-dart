...
class NotificationEndpointGrpcSettingsResponse3 {
  ...
  final DurationResponse3 resendInterval;

  /// How much time (in seconds) is spent attempting notification retries until a successful response is received. Default is 30s. Limit is 20m (1200s). Must be a positive number.
  final int retryDurationSec;

  NotificationEndpointGrpcSettingsResponse3({
  ...
  factory NotificationEndpointGrpcSettingsResponse3.fromMap(
      Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettingsResponse3(
      authority: map['authority'] as String,
      endpoint: map['endpoint'] as String,
      payloadName: map['payloadName'] as String,
      resendInterval: DurationResponse3.fromMap(
