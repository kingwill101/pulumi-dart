...
class GetRegionTargetHttpProxyResult3 {
  ...
  GetRegionTargetHttpProxyResult3({
  ...
  factory GetRegionTargetHttpProxyResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpProxyResult3(
