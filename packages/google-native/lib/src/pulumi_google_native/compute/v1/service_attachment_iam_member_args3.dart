...
class ServiceAttachmentIamMemberArgs3 {
  ...
  ServiceAttachmentIamMemberArgs3({
    this.condition,
  ...
  factory ServiceAttachmentIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentIamMemberArgs3(
