...
class BackendServiceIamBindingArgs3 {
  ...
  factory BackendServiceIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamBindingArgs3(
