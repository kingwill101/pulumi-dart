...
class HTTPHealthCheckResponseComputeV1 {
  ...
  HTTPHealthCheckResponseComputeV1({
    required this.host,
    required this.port,
  ...
  factory HTTPHealthCheckResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheckResponseComputeV1(
