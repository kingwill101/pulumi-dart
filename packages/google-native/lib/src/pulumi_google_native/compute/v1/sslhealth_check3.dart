...
import 'sslhealth_check_port_specification3.dart';
import 'sslhealth_check_proxy_header3.dart';

class SSLHealthCheck3 {
  ...
  final SSLHealthCheckPortSpecification3? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final SSLHealthCheckProxyHeader3? proxyHeader;
  ...
  factory SSLHealthCheck3.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheck3(
      port: map['port'] == null ? null : map['port'] as int,
      portName: map['portName'] == null ? null : map['portName'] as String,
      portSpecification: map['portSpecification'] == null
          ? null
          : SSLHealthCheckPortSpecification3.fromValue(
              map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null
          ? null
          : SSLHealthCheckProxyHeader3.fromValue(map['proxyHeader'] as String),
