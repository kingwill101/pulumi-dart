...
import 'network_edge_security_service_args3.dart';

/// Creates a new service in the specified project using the data included in the request.
class NetworkEdgeSecurityService3 extends CustomResource {
  ...
  NetworkEdgeSecurityService3(
    String name, {
    NetworkEdgeSecurityServiceArgs3? args,
