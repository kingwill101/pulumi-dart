...
import 'network_attachment_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class NetworkAttachmentIamBinding3 extends CustomResource {
  ...
  NetworkAttachmentIamBinding3(
    String name, {
    NetworkAttachmentIamBindingArgs3? args,
