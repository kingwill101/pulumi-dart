...
class NotificationEndpointGrpcSettings3 {
  ...
  final Duration3? resendInterval;
  ...
  factory NotificationEndpointGrpcSettings3.fromMap(Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettings3(
