...
class NetworkEndpointGroupPscDataResponse3 {
  ...
  NetworkEndpointGroupPscDataResponse3({
  ...
  factory NetworkEndpointGroupPscDataResponse3.fromMap(
      Map<String, dynamic> map) {
    return NetworkEndpointGroupPscDataResponse3(
