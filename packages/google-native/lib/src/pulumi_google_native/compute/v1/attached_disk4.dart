...
import 'attached_disk_saved_state3.dart';
import 'attached_disk_type3.dart';
...
class AttachedDisk4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (guestOsFeaturesValue != null) {
      map['guestOsFeatures'] =
          Input.encodeList<GuestOsFeature3, Map<String, dynamic>>(
  ...
  factory AttachedDisk4.fromMap(Map<String, dynamic> map) {
    return AttachedDisk4(
      ...
      guestOsFeatures: map['guestOsFeatures'] == null
          ? null
          : Input.decodeList<GuestOsFeature3>(
              map['guestOsFeatures'],
              (value) => GuestOsFeature3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      initializeParams: map['initializeParams'] == null
          ? null
          : AttachedDiskInitializeParams3.fromMap(
              (map['initializeParams'] as Map).cast<String, dynamic>()),
      interface: map['interface'] == null
          ? null
          : AttachedDiskInterface3.fromValue(map['interface'] as String),
      mode: map['mode'] == null
          ? null
          : AttachedDiskMode3.fromValue(map['mode'] as String),
      savedState: map['savedState'] == null
          ? null
          : AttachedDiskSavedState3.fromValue(map['savedState'] as String),
      source: map['source'] == null ? null : map['source'] as String,
      type: map['type'] == null
          ? null
          : AttachedDiskType3.fromValue(map['type'] as String),
    );
  }
}
