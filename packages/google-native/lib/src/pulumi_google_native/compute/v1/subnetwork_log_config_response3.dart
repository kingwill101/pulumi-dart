...
class SubnetworkLogConfigResponse3 {
  ...
  factory SubnetworkLogConfigResponse3.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfigResponse3(
