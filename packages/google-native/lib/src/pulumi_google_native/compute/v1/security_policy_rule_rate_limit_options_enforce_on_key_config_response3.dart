...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse3 {
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse3.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse3(
