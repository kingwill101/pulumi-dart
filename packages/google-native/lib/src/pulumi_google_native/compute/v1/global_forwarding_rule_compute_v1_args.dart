...
class GlobalForwardingRuleComputeV1Args {
  ...
  final pulumi.Input<GlobalForwardingRuleLoadBalancingSchemeComputeV1>?
      loadBalancingScheme;
  ...
  final pulumi.Input<GlobalForwardingRulePscConnectionStatusComputeV1>?
      pscConnectionStatus;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRuleIpProtocolComputeV1,
    ...
    if (ipVersionValue != null) {
      map['ipVersion'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRuleIpVersionComputeV1,
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRuleLoadBalancingSchemeComputeV1,
    ...
    if (networkTierValue != null) {
      map['networkTier'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRuleNetworkTierComputeV1,
    ...
    if (pscConnectionStatusValue != null) {
      map['pscConnectionStatus'] = pulumi.Input.mapOptionalInputValue<
          GlobalForwardingRulePscConnectionStatusComputeV1,
  ...
  factory GlobalForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleComputeV1Args(
      ...
      ipProtocol:
          pulumi.Input.asOptionalInput<GlobalForwardingRuleIpProtocolComputeV1>(
              map['ipProtocol']),
      ipVersion:
          pulumi.Input.asOptionalInput<GlobalForwardingRuleIpVersionComputeV1>(
              map['ipVersion']),
      ...
      networkTier: pulumi.Input.asOptionalInput<
          GlobalForwardingRuleNetworkTierComputeV1>(map['networkTier']),
      noAutomateDnsZone:
