...
class RegionNetworkFirewallPolicyIamMemberArgs3 {
  ...
  RegionNetworkFirewallPolicyIamMemberArgs3({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamMemberArgs3.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamMemberArgs3(
