...
import 'region_disk_architecture3.dart';

/// The set of arguments for RegionDisk.
class RegionDiskArgs3 {
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final Input<RegionDiskArchitecture3>? architecture;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (architectureValue != null) {
      map['architecture'] =
          Input.mapOptionalInputValue<RegionDiskArchitecture3, String>(
  ...
  factory RegionDiskArgs3.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs3(
      architecture:
          Input.asOptionalInput<RegionDiskArchitecture3>(map['architecture']),
      asyncPrimaryDisk:
