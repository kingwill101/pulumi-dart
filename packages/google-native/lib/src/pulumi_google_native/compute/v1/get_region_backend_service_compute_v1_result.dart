...
class GetRegionBackendServiceComputeV1Result {
  ...
  GetRegionBackendServiceComputeV1Result({
  ...
  factory GetRegionBackendServiceComputeV1Result.fromMap(
      Map<String, dynamic> map) {
    return GetRegionBackendServiceComputeV1Result(
