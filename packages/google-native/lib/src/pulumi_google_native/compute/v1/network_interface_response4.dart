...
import 'access_config_response3.dart';
import 'alias_ip_range_response3.dart';

/// A network interface resource attached to an instance.
class NetworkInterfaceResponse4 {
  /// An array of configurations for this interface. Currently, only one access config, ONE_TO_ONE_NAT, is supported. If there are no accessConfigs specified, then this instance will have no external internet access.
  final List<AccessConfigResponse3> accessConfigs;

  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final List<AliasIpRangeResponse3> aliasIpRanges;
  ...
  final List<AccessConfigResponse3> ipv6AccessConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['accessConfigs'] =
        Input.encodeList<AccessConfigResponse3, Map<String, dynamic>>(
            accessConfigs, (value) => value.toMap());
    map['aliasIpRanges'] =
        Input.encodeList<AliasIpRangeResponse3, Map<String, dynamic>>(
  ...
  factory NetworkInterfaceResponse4.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponse4(
      accessConfigs: Input.decodeList<AccessConfigResponse3>(
          map['accessConfigs'],
          (value) => AccessConfigResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      aliasIpRanges: Input.decodeList<AliasIpRangeResponse3>(
          map['aliasIpRanges'],
          (value) => AliasIpRangeResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      fingerprint: map['fingerprint'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: Input.decodeList<AccessConfigResponse3>(
          map['ipv6AccessConfigs'],
          (value) => AccessConfigResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
