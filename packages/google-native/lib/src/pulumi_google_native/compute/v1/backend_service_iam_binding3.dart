...
import 'backend_service_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class BackendServiceIamBinding3 extends CustomResource {
  ...
  BackendServiceIamBinding3(
    String name, {
    BackendServiceIamBindingArgs3? args,
