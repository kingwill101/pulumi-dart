...
class SubnetworkSecondaryRange3 {
  ...
  factory SubnetworkSecondaryRange3.fromMap(Map<String, dynamic> map) {
    return SubnetworkSecondaryRange3(
      ipCidrRange:
