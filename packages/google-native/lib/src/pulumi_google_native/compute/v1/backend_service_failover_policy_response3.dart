...
class BackendServiceFailoverPolicyResponse3 {
  ...
  BackendServiceFailoverPolicyResponse3({
  ...
  factory BackendServiceFailoverPolicyResponse3.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceFailoverPolicyResponse3(
