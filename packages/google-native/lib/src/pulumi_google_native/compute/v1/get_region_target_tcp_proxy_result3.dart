...
class GetRegionTargetTcpProxyResult3 {
  ...
  GetRegionTargetTcpProxyResult3({
  ...
  factory GetRegionTargetTcpProxyResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetTcpProxyResult3(
