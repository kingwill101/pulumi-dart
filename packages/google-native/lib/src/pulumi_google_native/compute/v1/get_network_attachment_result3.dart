...
class GetNetworkAttachmentResult3 {
  /// An array of connections for all the producers connected to this network attachment.
  final List<NetworkAttachmentConnectedEndpointResponse3> connectionEndpoints;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['connectionEndpoints'] = Input.encodeList<
        NetworkAttachmentConnectedEndpointResponse3,
  ...
  factory GetNetworkAttachmentResult3.fromMap(Map<String, dynamic> map) {
    return GetNetworkAttachmentResult3(
      connectionEndpoints:
          Input.decodeList<NetworkAttachmentConnectedEndpointResponse3>(
              map['connectionEndpoints'],
              (value) => NetworkAttachmentConnectedEndpointResponse3.fromMap(
