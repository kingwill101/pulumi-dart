...
import 'region_ssl_policy_warnings_item_response3.dart';

/// Result data returned by getRegionSslPolicy.
class GetRegionSslPolicyResult3 {
  ...
  final List<RegionSslPolicyWarningsItemResponse3> warnings;

  GetRegionSslPolicyResult3({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['warnings'] = Input.encodeList<RegionSslPolicyWarningsItemResponse3,
        Map<String, dynamic>>(warnings, (value) => value.toMap());
    return map;
  }

  factory GetRegionSslPolicyResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionSslPolicyResult3(
      ...
      warnings: Input.decodeList<RegionSslPolicyWarningsItemResponse3>(
          map['warnings'],
          (value) => RegionSslPolicyWarningsItemResponse3.fromMap(
