...
import 'region_network_endpoint_group_compute_v1_args.dart';

/// Creates a network endpoint group in the specified project using the parameters that are included in the request.
class RegionNetworkEndpointGroupComputeV1 extends pulumi.CustomResource {
  /// Metadata defined as annotations on the network endpoint group.
  late final pulumi.Output<Map<String, String>> annotations;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final pulumi.Output<NetworkEndpointGroupAppEngineResponseComputeV1>
      appEngine;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final pulumi.Output<NetworkEndpointGroupCloudFunctionResponseComputeV1>
      cloudFunction;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final pulumi.Output<NetworkEndpointGroupCloudRunResponseComputeV1>
      cloudRun;
  ...
  late final pulumi.Output<NetworkEndpointGroupPscDataResponseComputeV1>
      pscData;
  ...
  RegionNetworkEndpointGroupComputeV1(
    String name, {
    RegionNetworkEndpointGroupComputeV1Args? args,
    ...
    this.appEngine =
        registerOutput<NetworkEndpointGroupAppEngineResponseComputeV1>(
            'appEngine');
    this.cloudFunction =
        registerOutput<NetworkEndpointGroupCloudFunctionResponseComputeV1>(
            'cloudFunction');
    this.cloudRun =
        registerOutput<NetworkEndpointGroupCloudRunResponseComputeV1>(
            'cloudRun');
    ...
    this.pscData =
        registerOutput<NetworkEndpointGroupPscDataResponseComputeV1>('pscData');
