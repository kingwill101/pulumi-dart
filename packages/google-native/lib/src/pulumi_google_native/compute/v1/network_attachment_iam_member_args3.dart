...
class NetworkAttachmentIamMemberArgs3 {
  ...
  NetworkAttachmentIamMemberArgs3({
    this.condition,
  ...
  factory NetworkAttachmentIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamMemberArgs3(
