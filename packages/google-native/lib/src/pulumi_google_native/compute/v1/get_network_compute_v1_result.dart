...
class GetNetworkComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['peerings'] = pulumi.Input.encodeList<NetworkPeeringResponseComputeV1,
        Map<String, dynamic>>(peerings, (value) => value.toMap());
  ...
  factory GetNetworkComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetNetworkComputeV1Result(
      ...
      peerings: pulumi.Input.decodeList<NetworkPeeringResponseComputeV1>(
          map['peerings'],
          (value) => NetworkPeeringResponseComputeV1.fromMap(
              (value as Map).cast<String, dynamic>())),
      routingConfig: NetworkRoutingConfigResponseComputeV1.fromMap(
