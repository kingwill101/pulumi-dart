...
class AutoscalingPolicyCpuUtilizationResponse3 {
  ...
  AutoscalingPolicyCpuUtilizationResponse3({
  ...
  factory AutoscalingPolicyCpuUtilizationResponse3.fromMap(
      Map<String, dynamic> map) {
    return AutoscalingPolicyCpuUtilizationResponse3(
