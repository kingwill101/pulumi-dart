...
import 'public_delegated_prefix_compute_v1_args.dart';
import 'public_delegated_prefix_public_delegated_sub_prefix_response_compute_v1.dart';

/// Creates a PublicDelegatedPrefix in the specified project in the given region using the parameters that are included in the request.
class PublicDelegatedPrefixComputeV1 extends pulumi.CustomResource {
  ...
  PublicDelegatedPrefixComputeV1(
    String name, {
    PublicDelegatedPrefixComputeV1Args? args,
