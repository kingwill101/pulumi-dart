...
import 'forwarding_rule_service_directory_registration3.dart';
import 'global_forwarding_rule_ip_protocol3.dart';
import 'global_forwarding_rule_ip_version3.dart';
import 'global_forwarding_rule_load_balancing_scheme3.dart';
import 'global_forwarding_rule_network_tier3.dart';
import 'global_forwarding_rule_psc_connection_status3.dart';
import 'metadata_filter3.dart';

/// The set of arguments for GlobalForwardingRule.
class GlobalForwardingRuleArgs3 {
  ...
  final Input<GlobalForwardingRuleIpProtocol3>? ipProtocol;

  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final Input<GlobalForwardingRuleIpVersion3>? ipVersion;
  ...
  final Input<GlobalForwardingRuleLoadBalancingScheme3>? loadBalancingScheme;
  ...
  final Input<List<MetadataFilter3>>? metadataFilters;
  ...
  final Input<GlobalForwardingRuleNetworkTier3>? networkTier;
  ...
  final Input<GlobalForwardingRulePscConnectionStatus3>? pscConnectionStatus;
  ...
  final Input<List<ForwardingRuleServiceDirectoryRegistration3>>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipProtocolValue != null) {
      map['ipProtocol'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleIpProtocol3, String>(
              ipProtocolValue, (value) => value.value);
    }
    final ipVersionValue = ipVersion;
    if (ipVersionValue != null) {
      map['ipVersion'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleIpVersion3, String>(
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = Input.mapOptionalInputValue<
          GlobalForwardingRuleLoadBalancingScheme3,
    ...
    if (metadataFiltersValue != null) {
      map['metadataFilters'] = Input.mapOptionalInputValue<
              List<MetadataFilter3>, List<Map<String, dynamic>>>(
          metadataFiltersValue,
          (value) => Input.encodeList<MetadataFilter3, Map<String, dynamic>>(
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          Input.mapOptionalInputValue<GlobalForwardingRuleNetworkTier3, String>(
    ...
    if (pscConnectionStatusValue != null) {
      map['pscConnectionStatus'] = Input.mapOptionalInputValue<
          GlobalForwardingRulePscConnectionStatus3,
    ...
    if (serviceDirectoryRegistrationsValue != null) {
      map['serviceDirectoryRegistrations'] = Input.mapOptionalInputValue<
              List<ForwardingRuleServiceDirectoryRegistration3>,
              List<Map<String, dynamic>>>(
          serviceDirectoryRegistrationsValue,
          (value) => Input.encodeList<
              ForwardingRuleServiceDirectoryRegistration3,
  ...
  factory GlobalForwardingRuleArgs3.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleArgs3(
      ...
      ipProtocol: Input.asOptionalInput<GlobalForwardingRuleIpProtocol3>(
          map['ipProtocol']),
      ipVersion: Input.asOptionalInput<GlobalForwardingRuleIpVersion3>(
          map['ipVersion']),
      isMirroringCollector:
          Input.asOptionalInput<bool>(map['isMirroringCollector']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      loadBalancingScheme:
          Input.asOptionalInput<GlobalForwardingRuleLoadBalancingScheme3>(
              map['loadBalancingScheme']),
      metadataFilters:
          Input.asOptionalInput<List<MetadataFilter3>>(map['metadataFilters']),
      name: Input.asOptionalInput<String>(map['name']),
      network: Input.asOptionalInput<String>(map['network']),
      networkTier: Input.asOptionalInput<GlobalForwardingRuleNetworkTier3>(
          map['networkTier']),
      ...
      pscConnectionStatus:
          Input.asOptionalInput<GlobalForwardingRulePscConnectionStatus3>(
