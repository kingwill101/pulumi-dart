...
class GetInstanceGroupManagerResult3 {
  ...
  GetInstanceGroupManagerResult3({
  ...
  factory GetInstanceGroupManagerResult3.fromMap(Map<String, dynamic> map) {
    return GetInstanceGroupManagerResult3(
      autoHealingPolicies:
