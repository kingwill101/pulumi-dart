...
class GetSnapshotResult4 {
  ...
  final CustomerEncryptionKeyResponse3 snapshotEncryptionKey;
  ...
  factory GetSnapshotResult4.fromMap(Map<String, dynamic> map) {
    return GetSnapshotResult4(
      ...
      snapshotEncryptionKey: CustomerEncryptionKeyResponse3.fromMap(
