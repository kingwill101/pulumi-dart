...
class NetworkArgs3 {
  ...
  final Input<NetworkNetworkFirewallPolicyEnforcementOrder3>?
  ...
  final Input<NetworkRoutingConfig3>? routingConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkFirewallPolicyEnforcementOrderValue != null) {
      map['networkFirewallPolicyEnforcementOrder'] =
          Input.mapOptionalInputValue<
                  NetworkNetworkFirewallPolicyEnforcementOrder3, String>(
    ...
    if (routingConfigValue != null) {
      map['routingConfig'] = Input.mapOptionalInputValue<NetworkRoutingConfig3,
  ...
  factory NetworkArgs3.fromMap(Map<String, dynamic> map) {
    return NetworkArgs3(
      ...
      networkFirewallPolicyEnforcementOrder:
          Input.asOptionalInput<NetworkNetworkFirewallPolicyEnforcementOrder3>(
              map['networkFirewallPolicyEnforcementOrder']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      routingConfig:
          Input.asOptionalInput<NetworkRoutingConfig3>(map['routingConfig']),
    );
  }
}
