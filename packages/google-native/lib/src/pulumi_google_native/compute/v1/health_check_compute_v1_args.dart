...
class HealthCheckComputeV1Args {
  ...
  factory HealthCheckComputeV1Args.fromMap(Map<String, dynamic> map) {
    return HealthCheckComputeV1Args(
      ...
      http2HealthCheck: pulumi.Input.asOptionalInput<HTTP2HealthCheckComputeV1>(
          map['http2HealthCheck']),
      httpHealthCheck: pulumi.Input.asOptionalInput<HTTPHealthCheckComputeV1>(
          map['httpHealthCheck']),
      httpsHealthCheck: pulumi.Input.asOptionalInput<HTTPSHealthCheckComputeV1>(
      ...
      type: pulumi.Input.asOptionalInput<HealthCheckTypeComputeV1>(map['type']),
      unhealthyThreshold:
