...
import 'region_target_https_proxy_quic_override3.dart';

/// The set of arguments for RegionTargetHttpsProxy.
class RegionTargetHttpsProxyArgs3 {
  ...
  final Input<RegionTargetHttpsProxyQuicOverride3>? quicOverride;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (quicOverrideValue != null) {
      map['quicOverride'] = Input.mapOptionalInputValue<
          RegionTargetHttpsProxyQuicOverride3,
  ...
  factory RegionTargetHttpsProxyArgs3.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyArgs3(
      authorizationPolicy:
      ...
      quicOverride: Input.asOptionalInput<RegionTargetHttpsProxyQuicOverride3>(
          map['quicOverride']),
