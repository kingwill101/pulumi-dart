...
import 'region_backend_service_compression_mode3.dart';
import 'region_backend_service_load_balancing_scheme3.dart';
import 'region_backend_service_locality_lb_policy3.dart';
import 'region_backend_service_protocol3.dart';
import 'region_backend_service_session_affinity3.dart';
import 'security_settings3.dart';
import 'subsetting3.dart';

/// The set of arguments for RegionBackendService.
class RegionBackendServiceArgs3 {
  ...
  final Input<RegionBackendServiceCompressionMode3>? compressionMode;
  ...
  final Input<RegionBackendServiceLoadBalancingScheme3>? loadBalancingScheme;
  ...
  final Input<RegionBackendServiceLocalityLbPolicy3>? localityLbPolicy;
  ...
  final Input<RegionBackendServiceProtocol3>? protocol;
  ...
  final Input<RegionBackendServiceSessionAffinity3>? sessionAffinity;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (compressionModeValue != null) {
      map['compressionMode'] = Input.mapOptionalInputValue<
          RegionBackendServiceCompressionMode3,
    ...
    if (loadBalancingSchemeValue != null) {
      map['loadBalancingScheme'] = Input.mapOptionalInputValue<
          RegionBackendServiceLoadBalancingScheme3,
    ...
    if (localityLbPolicyValue != null) {
      map['localityLbPolicy'] = Input.mapOptionalInputValue<
          RegionBackendServiceLocalityLbPolicy3,
    ...
    if (protocolValue != null) {
      map['protocol'] =
          Input.mapOptionalInputValue<RegionBackendServiceProtocol3, String>(
    ...
    if (sessionAffinityValue != null) {
      map['sessionAffinity'] = Input.mapOptionalInputValue<
          RegionBackendServiceSessionAffinity3,
  ...
  factory RegionBackendServiceArgs3.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs3(
      ...
      compressionMode:
          Input.asOptionalInput<RegionBackendServiceCompressionMode3>(
              map['compressionMode']),
      connectionDraining:
      ...
      loadBalancingScheme:
          Input.asOptionalInput<RegionBackendServiceLoadBalancingScheme3>(
              map['loadBalancingScheme']),
      localityLbPolicies: Input.asOptionalInput<
              List<BackendServiceLocalityLoadBalancingPolicyConfig3>>(
          map['localityLbPolicies']),
      localityLbPolicy:
          Input.asOptionalInput<RegionBackendServiceLocalityLbPolicy3>(
      ...
      protocol:
          Input.asOptionalInput<RegionBackendServiceProtocol3>(map['protocol']),
      ...
      sessionAffinity:
          Input.asOptionalInput<RegionBackendServiceSessionAffinity3>(
              map['sessionAffinity']),
