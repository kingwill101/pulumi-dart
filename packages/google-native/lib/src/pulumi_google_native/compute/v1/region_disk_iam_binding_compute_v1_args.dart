...
class RegionDiskIamBindingComputeV1Args {
  ...
  RegionDiskIamBindingComputeV1Args({
    this.condition,
  ...
  factory RegionDiskIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamBindingComputeV1Args(
