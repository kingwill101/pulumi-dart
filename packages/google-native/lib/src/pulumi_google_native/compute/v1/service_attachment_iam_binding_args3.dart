...
class ServiceAttachmentIamBindingArgs3 {
  ...
  ServiceAttachmentIamBindingArgs3({
    this.condition,
  ...
  factory ServiceAttachmentIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentIamBindingArgs3(
