...
import 'resource_policy_instance_schedule_policy_schedule3.dart';

/// An InstanceSchedulePolicy specifies when and how frequent certain operations are performed on the instance.
class ResourcePolicyInstanceSchedulePolicy3 {
  ...
  final ResourcePolicyInstanceSchedulePolicySchedule3? vmStartSchedule;

  /// Specifies the schedule for stopping instances.
  final ResourcePolicyInstanceSchedulePolicySchedule3? vmStopSchedule;

  ResourcePolicyInstanceSchedulePolicy3({
    this.expirationTime,
    this.startTime,
    this.timeZone,
  ...
  factory ResourcePolicyInstanceSchedulePolicy3.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicyInstanceSchedulePolicy3(
      ...
      vmStartSchedule: map['vmStartSchedule'] == null
          ? null
          : ResourcePolicyInstanceSchedulePolicySchedule3.fromMap(
