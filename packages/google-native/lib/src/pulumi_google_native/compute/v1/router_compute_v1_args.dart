...
class RouterComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    final bgpValue = bgp;
    if (bgpValue != null) {
      map['bgp'] = pulumi.Input.mapOptionalInputValue<RouterBgpComputeV1,
    ...
    if (bgpPeersValue != null) {
      map['bgpPeers'] = pulumi.Input.mapOptionalInputValue<
              List<RouterBgpPeerComputeV1>, List<Map<String, dynamic>>>(
          bgpPeersValue,
          (value) => pulumi.Input.encodeList<RouterBgpPeerComputeV1,
    ...
    if (interfacesValue != null) {
      map['interfaces'] = pulumi.Input.mapOptionalInputValue<
              List<RouterInterfaceComputeV1>, List<Map<String, dynamic>>>(
          interfacesValue,
          (value) => pulumi.Input.encodeList<RouterInterfaceComputeV1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (natsValue != null) {
      map['nats'] = pulumi.Input.mapOptionalInputValue<List<RouterNatComputeV1>,
              List<Map<String, dynamic>>>(
          natsValue,
          (value) =>
              pulumi.Input.encodeList<RouterNatComputeV1, Map<String, dynamic>>(
  ...
  factory RouterComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RouterComputeV1Args(
      bgp: pulumi.Input.asOptionalInput<RouterBgpComputeV1>(map['bgp']),
      ...
      interfaces: pulumi.Input.asOptionalInput<List<RouterInterfaceComputeV1>>(
          map['interfaces']),
      md5AuthenticationKeys: pulumi.Input.asOptionalInput<
              List<RouterMd5AuthenticationKeyComputeV1>>(
          map['md5AuthenticationKeys']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      nats: pulumi.Input.asOptionalInput<List<RouterNatComputeV1>>(map['nats']),
