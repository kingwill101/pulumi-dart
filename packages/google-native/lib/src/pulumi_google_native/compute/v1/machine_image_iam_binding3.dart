...
import 'machine_image_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class MachineImageIamBinding3 extends CustomResource {
  ...
  MachineImageIamBinding3(
    String name, {
    MachineImageIamBindingArgs3? args,
