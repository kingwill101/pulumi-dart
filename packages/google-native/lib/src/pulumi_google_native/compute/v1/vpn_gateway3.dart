...
import 'vpn_gateway_args3.dart';
import 'vpn_gateway_vpn_gateway_interface_response3.dart';

/// Creates a VPN gateway in the specified project and region using the data included in the request.
class VpnGateway3 extends CustomResource {
  ...
  late final Output<List<VpnGatewayVpnGatewayInterfaceResponse3>> vpnInterfaces;

  VpnGateway3(
    String name, {
    VpnGatewayArgs3? args,
    ...
    this.vpnInterfaces =
        Output.createUnknown<List<VpnGatewayVpnGatewayInterfaceResponse3>>();
  }
}
