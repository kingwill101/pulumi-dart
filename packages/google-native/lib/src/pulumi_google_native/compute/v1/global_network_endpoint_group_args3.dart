...
import 'global_network_endpoint_group_network_endpoint_type3.dart';
...
class GlobalNetworkEndpointGroupArgs3 {
  ...
  final Input<GlobalNetworkEndpointGroupNetworkEndpointType3>?
      networkEndpointType;
  ...
  GlobalNetworkEndpointGroupArgs3({
    this.annotations,
    this.appEngine,
    this.cloudFunction,
    this.cloudRun,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networkEndpointTypeValue != null) {
      map['networkEndpointType'] = Input.mapOptionalInputValue<
          GlobalNetworkEndpointGroupNetworkEndpointType3,
  ...
  factory GlobalNetworkEndpointGroupArgs3.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupArgs3(
      annotations:
      ...
      networkEndpointType:
          Input.asOptionalInput<GlobalNetworkEndpointGroupNetworkEndpointType3>(
