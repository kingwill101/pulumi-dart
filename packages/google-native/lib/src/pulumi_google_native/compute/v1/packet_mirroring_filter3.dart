...
class PacketMirroringFilter3 {
  ...
  factory PacketMirroringFilter3.fromMap(Map<String, dynamic> map) {
    return PacketMirroringFilter3(
      cidrRanges: map['cidrRanges'] == null
          ? null
          : (map['cidrRanges'] as List).cast<String>(),
      direction: map['direction'] == null
          ? null
          : PacketMirroringFilterDirection3.fromValue(
