...
import 'network_firewall_policy_args3.dart';

/// Creates a new policy in the specified project using the data included in the request.
class NetworkFirewallPolicy3 extends CustomResource {
  /// A list of associations that belong to this firewall policy.
  late final Output<List<FirewallPolicyAssociationResponse3>> associations;
  ...
  late final Output<List<FirewallPolicyRuleResponse3>> rules;
  ...
  NetworkFirewallPolicy3(
    String name, {
    NetworkFirewallPolicyArgs3? args,
