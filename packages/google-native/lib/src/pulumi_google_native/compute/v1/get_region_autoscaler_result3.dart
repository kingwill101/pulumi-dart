...
class GetRegionAutoscalerResult3 {
  /// The configuration parameters for the autoscaling algorithm. You can define one or more signals for an autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the default will be to autoscale based on cpuUtilization to 0.6 or 60%.
  final AutoscalingPolicyResponse3 autoscalingPolicy;
  ...
  final List<AutoscalerStatusDetailsResponse3> statusDetails;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['status'] = status;
    map['statusDetails'] = Input.encodeList<AutoscalerStatusDetailsResponse3,
  ...
  factory GetRegionAutoscalerResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionAutoscalerResult3(
      autoscalingPolicy: AutoscalingPolicyResponse3.fromMap(
      ...
      statusDetails: Input.decodeList<AutoscalerStatusDetailsResponse3>(
          map['statusDetails'],
          (value) => AutoscalerStatusDetailsResponse3.fromMap(
