...
class RegionCommitmentComputeV1Args {
  ...
  factory RegionCommitmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentComputeV1Args(
      ...
      category: pulumi.Input.asOptionalInput<RegionCommitmentCategoryComputeV1>(
          map['category']),
      ...
      plan: pulumi.Input.asOptionalInput<RegionCommitmentPlanComputeV1>(
          map['plan']),
      ...
      type: pulumi.Input.asOptionalInput<RegionCommitmentTypeComputeV1>(
          map['type']),
    );
  }
}
