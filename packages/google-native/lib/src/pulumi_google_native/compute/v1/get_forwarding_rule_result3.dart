...
import 'forwarding_rule_service_directory_registration_response3.dart';
import 'metadata_filter_response3.dart';

/// Result data returned by getForwardingRule.
class GetForwardingRuleResult3 {
  ...
  final List<ForwardingRuleServiceDirectoryRegistrationResponse3>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['serviceDirectoryRegistrations'] = Input.encodeList<
            ForwardingRuleServiceDirectoryRegistrationResponse3,
            Map<String, dynamic>>(
  ...
  factory GetForwardingRuleResult3.fromMap(Map<String, dynamic> map) {
    return GetForwardingRuleResult3(
      ...
      serviceDirectoryRegistrations:
          Input.decodeList<ForwardingRuleServiceDirectoryRegistrationResponse3>(
              map['serviceDirectoryRegistrations'],
              (value) =>
                  ForwardingRuleServiceDirectoryRegistrationResponse3.fromMap(
                      (value as Map).cast<String, dynamic>())),
