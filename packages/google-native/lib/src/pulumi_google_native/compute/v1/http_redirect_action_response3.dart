...
class HttpRedirectActionResponse3 {
  ...
  factory HttpRedirectActionResponse3.fromMap(Map<String, dynamic> map) {
    return HttpRedirectActionResponse3(
