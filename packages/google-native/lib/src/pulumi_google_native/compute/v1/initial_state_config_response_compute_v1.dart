...
class InitialStateConfigResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dbs'] = pulumi.Input.encodeList<FileContentBufferResponseComputeV1,
        Map<String, dynamic>>(dbs, (value) => value.toMap());
    map['dbxs'] = pulumi.Input.encodeList<FileContentBufferResponseComputeV1,
        Map<String, dynamic>>(dbxs, (value) => value.toMap());
    map['keks'] = pulumi.Input.encodeList<FileContentBufferResponseComputeV1,
