...
import 'region_network_endpoint_group_args3.dart';

/// Creates a network endpoint group in the specified project using the parameters that are included in the request.
class RegionNetworkEndpointGroup3 extends CustomResource {
  /// Metadata defined as annotations on the network endpoint group.
  late final Output<Map<String, String>> annotations;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final Output<NetworkEndpointGroupAppEngineResponse3> appEngine;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final Output<NetworkEndpointGroupCloudFunctionResponse3> cloudFunction;

  /// Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.
  late final Output<NetworkEndpointGroupCloudRunResponse3> cloudRun;
  ...
  late final Output<NetworkEndpointGroupPscDataResponse3> pscData;
  ...
  RegionNetworkEndpointGroup3(
    String name, {
    RegionNetworkEndpointGroupArgs3? args,
