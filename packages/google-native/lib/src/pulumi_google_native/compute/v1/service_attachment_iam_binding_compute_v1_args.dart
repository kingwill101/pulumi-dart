...
class ServiceAttachmentIamBindingComputeV1Args {
  ...
  ServiceAttachmentIamBindingComputeV1Args({
    this.condition,
  ...
  factory ServiceAttachmentIamBindingComputeV1Args.fromMap(
      Map<String, dynamic> map) {
    return ServiceAttachmentIamBindingComputeV1Args(
