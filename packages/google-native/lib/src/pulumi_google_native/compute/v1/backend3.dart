...
import 'backend_balancing_mode3.dart';
...
class Backend3 {
  ...
  final BackendBalancingMode3? balancingMode;
  ...
  factory Backend3.fromMap(Map<String, dynamic> map) {
    return Backend3(
      balancingMode: map['balancingMode'] == null
          ? null
          : BackendBalancingMode3.fromValue(map['balancingMode'] as String),
