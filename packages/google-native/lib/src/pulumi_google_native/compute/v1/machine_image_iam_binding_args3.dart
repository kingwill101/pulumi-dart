...
class MachineImageIamBindingArgs3 {
  ...
  factory MachineImageIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return MachineImageIamBindingArgs3(
