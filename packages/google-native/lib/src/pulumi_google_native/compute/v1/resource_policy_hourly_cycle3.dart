...
class ResourcePolicyHourlyCycle3 {
  ...
  factory ResourcePolicyHourlyCycle3.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyHourlyCycle3(
      hoursInCycle:
