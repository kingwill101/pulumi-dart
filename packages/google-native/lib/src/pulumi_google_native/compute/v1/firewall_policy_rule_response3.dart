...
import 'firewall_policy_rule_matcher_response3.dart';
import 'firewall_policy_rule_secure_tag_response3.dart';

/// Represents a rule that describes one or more match conditions along with the action to be taken when traffic matches this condition (allow or deny).
class FirewallPolicyRuleResponse3 {
  ...
  final FirewallPolicyRuleMatcherResponse3 match;
  ...
  final List<FirewallPolicyRuleSecureTagResponse3> targetSecureTags;

  /// A list of service accounts indicating the sets of instances that are applied with this rule.
  final List<String> targetServiceAccounts;

  FirewallPolicyRuleResponse3({
  ...
  factory FirewallPolicyRuleResponse3.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponse3(
      ...
      match: FirewallPolicyRuleMatcherResponse3.fromMap(
      ...
      targetSecureTags: Input.decodeList<FirewallPolicyRuleSecureTagResponse3>(
