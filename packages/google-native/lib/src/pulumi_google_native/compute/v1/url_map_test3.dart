...
import 'url_map_test_header3.dart';
...
class UrlMapTest3 {
  ...
  final List<UrlMapTestHeader3>? headers;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headersValue != null) {
      map['headers'] =
          Input.encodeList<UrlMapTestHeader3, Map<String, dynamic>>(
  ...
  factory UrlMapTest3.fromMap(Map<String, dynamic> map) {
    return UrlMapTest3(
      description:
      ...
      headers: map['headers'] == null
          ? null
          : Input.decodeList<UrlMapTestHeader3>(
              map['headers'],
              (value) => UrlMapTestHeader3.fromMap(
