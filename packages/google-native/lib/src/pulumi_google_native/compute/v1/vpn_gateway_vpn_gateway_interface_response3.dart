...
class VpnGatewayVpnGatewayInterfaceResponse3 {
  ...
  VpnGatewayVpnGatewayInterfaceResponse3({
  ...
  factory VpnGatewayVpnGatewayInterfaceResponse3.fromMap(
      Map<String, dynamic> map) {
    return VpnGatewayVpnGatewayInterfaceResponse3(
