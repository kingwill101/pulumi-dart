...
import 'http2_health_check_port_specification3.dart';
import 'http2_health_check_proxy_header3.dart';

class HTTP2HealthCheck3 {
  ...
  final HTTP2HealthCheckPortSpecification3? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTP2HealthCheckProxyHeader3? proxyHeader;
