...
import 'interconnect_attachment_private_info_response3.dart';

/// Result data returned by getInterconnectAttachment.
class GetInterconnectAttachmentResult3 {
  ...
  final InterconnectAttachmentConfigurationConstraintsResponse3
  ...
  final InterconnectAttachmentPartnerMetadataResponse3 partnerMetadata;
  ...
  final InterconnectAttachmentPrivateInfoResponse3 privateInterconnectInfo;
  ...
  GetInterconnectAttachmentResult3({
  ...
  factory GetInterconnectAttachmentResult3.fromMap(Map<String, dynamic> map) {
    return GetInterconnectAttachmentResult3(
      ...
      configurationConstraints:
          InterconnectAttachmentConfigurationConstraintsResponse3.fromMap(
      ...
      partnerMetadata: InterconnectAttachmentPartnerMetadataResponse3.fromMap(
          (map['partnerMetadata'] as Map).cast<String, dynamic>()),
      privateInterconnectInfo:
          InterconnectAttachmentPrivateInfoResponse3.fromMap(
