...
import 'http_route_rule_match3.dart';

/// The HttpRouteRule setting specifies how to match an HTTP request and the corresponding routing action that load balancing proxies perform.
class HttpRouteRule3 {
  ...
  final List<HttpRouteRuleMatch3>? matchRules;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (matchRulesValue != null) {
      map['matchRules'] =
          Input.encodeList<HttpRouteRuleMatch3, Map<String, dynamic>>(
  ...
  factory HttpRouteRule3.fromMap(Map<String, dynamic> map) {
    return HttpRouteRule3(
      description:
      ...
      matchRules: map['matchRules'] == null
          ? null
          : Input.decodeList<HttpRouteRuleMatch3>(
              map['matchRules'],
              (value) => HttpRouteRuleMatch3.fromMap(
