...
class GetTargetVpnGatewayComputeV1Result {
  ...
  factory GetTargetVpnGatewayComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetTargetVpnGatewayComputeV1Result(
