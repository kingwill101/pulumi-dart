...
class GetRouteResult3 {
  /// AS path.
  final List<RouteAsPathResponse3> asPaths;
  ...
  final List<RouteWarningsItemResponse3> warnings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['asPaths'] =
        Input.encodeList<RouteAsPathResponse3, Map<String, dynamic>>(
    ...
    map['tags'] = tags;
    map['warnings'] =
        Input.encodeList<RouteWarningsItemResponse3, Map<String, dynamic>>(
            warnings, (value) => value.toMap());
    return map;
  }

  factory GetRouteResult3.fromMap(Map<String, dynamic> map) {
    return GetRouteResult3(
      asPaths: Input.decodeList<RouteAsPathResponse3>(
          map['asPaths'],
          (value) => RouteAsPathResponse3.fromMap(
      ...
      warnings: Input.decodeList<RouteWarningsItemResponse3>(
          map['warnings'],
          (value) => RouteWarningsItemResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
