...
import 'node_template_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class NodeTemplateIamBinding3 extends CustomResource {
  ...
  NodeTemplateIamBinding3(
    String name, {
    NodeTemplateIamBindingArgs3? args,
