...
class GetFirewallResult3 {
  /// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
  final List<FirewallAllowedItemResponse3> allowed;

  /// Creation timestamp in RFC3339 text format.
  final String creationTimestamp;

  /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
  final List<FirewallDeniedItemResponse3> denied;
  ...
  final FirewallLogConfigResponse3 logConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['allowed'] =
        Input.encodeList<FirewallAllowedItemResponse3, Map<String, dynamic>>(
            allowed, (value) => value.toMap());
    map['creationTimestamp'] = creationTimestamp;
    map['denied'] =
        Input.encodeList<FirewallDeniedItemResponse3, Map<String, dynamic>>(
  ...
  factory GetFirewallResult3.fromMap(Map<String, dynamic> map) {
    return GetFirewallResult3(
      allowed: Input.decodeList<FirewallAllowedItemResponse3>(
          map['allowed'],
          (value) => FirewallAllowedItemResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      denied: Input.decodeList<FirewallDeniedItemResponse3>(
          map['denied'],
          (value) => FirewallDeniedItemResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      logConfig: FirewallLogConfigResponse3.fromMap(
