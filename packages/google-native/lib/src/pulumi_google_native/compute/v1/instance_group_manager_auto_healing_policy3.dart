...
class InstanceGroupManagerAutoHealingPolicy3 {
  ...
  InstanceGroupManagerAutoHealingPolicy3({
    this.healthCheck,
  ...
  factory InstanceGroupManagerAutoHealingPolicy3.fromMap(
      Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicy3(
      healthCheck:
