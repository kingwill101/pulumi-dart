...
import 'deprecation_status_state3.dart';

/// Deprecation status for a public resource.
class DeprecationStatus3 {
  ...
  final DeprecationStatusState3? state;
  ...
  factory DeprecationStatus3.fromMap(Map<String, dynamic> map) {
    return DeprecationStatus3(
      ...
      state: map['state'] == null
          ? null
          : DeprecationStatusState3.fromValue(map['state'] as String),
    );
  }
}
