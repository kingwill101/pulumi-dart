...
import 'resource_policy_resource_status_instance_schedule_policy_status_response3.dart';

/// Contains output only fields. Use this sub-message for all output fields set on ResourcePolicy. The internal structure of this "status" field should mimic the structure of ResourcePolicy proto specification.
class ResourcePolicyResourceStatusResponse3 {
  ...
  final ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponse3
      instanceSchedulePolicy;

  ResourcePolicyResourceStatusResponse3({
  ...
  factory ResourcePolicyResourceStatusResponse3.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicyResourceStatusResponse3(
      instanceSchedulePolicy:
