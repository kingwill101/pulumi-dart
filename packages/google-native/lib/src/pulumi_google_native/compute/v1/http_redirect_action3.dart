...
import 'http_redirect_action_redirect_response_code3.dart';

/// Specifies settings for an HTTP redirect.
class HttpRedirectAction3 {
  ...
  final HttpRedirectActionRedirectResponseCode3? redirectResponseCode;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (redirectResponseCodeValue != null) {
      map['redirectResponseCode'] = redirectResponseCodeValue.value;
    }
  ...
  factory HttpRedirectAction3.fromMap(Map<String, dynamic> map) {
    return HttpRedirectAction3(
      hostRedirect:
      ...
      redirectResponseCode: map['redirectResponseCode'] == null
          ? null
          : HttpRedirectActionRedirectResponseCode3.fromValue(
