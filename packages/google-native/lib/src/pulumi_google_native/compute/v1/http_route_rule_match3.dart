...
class HttpRouteRuleMatch3 {
  ...
  final List<MetadataFilter3>? metadataFilters;
  ...
  final List<HttpQueryParameterMatch3>? queryParameterMatches;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headerMatchesValue != null) {
      map['headerMatches'] =
          Input.encodeList<HttpHeaderMatch3, Map<String, dynamic>>(
    ...
    if (metadataFiltersValue != null) {
      map['metadataFilters'] =
          Input.encodeList<MetadataFilter3, Map<String, dynamic>>(
    ...
    if (queryParameterMatchesValue != null) {
      map['queryParameterMatches'] =
          Input.encodeList<HttpQueryParameterMatch3, Map<String, dynamic>>(
  ...
  factory HttpRouteRuleMatch3.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatch3(
      fullPathMatch:
          map['fullPathMatch'] == null ? null : map['fullPathMatch'] as String,
      headerMatches: map['headerMatches'] == null
          ? null
          : Input.decodeList<HttpHeaderMatch3>(
              map['headerMatches'],
              (value) => HttpHeaderMatch3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ignoreCase: map['ignoreCase'] == null ? null : map['ignoreCase'] as bool,
      metadataFilters: map['metadataFilters'] == null
          ? null
          : Input.decodeList<MetadataFilter3>(
              map['metadataFilters'],
              (value) => MetadataFilter3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      queryParameterMatches: map['queryParameterMatches'] == null
          ? null
          : Input.decodeList<HttpQueryParameterMatch3>(
              map['queryParameterMatches'],
              (value) => HttpQueryParameterMatch3.fromMap(
                  (value as Map).cast<String, dynamic>())),
      regexMatch:
