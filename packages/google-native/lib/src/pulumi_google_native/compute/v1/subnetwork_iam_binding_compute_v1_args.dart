...
class SubnetworkIamBindingComputeV1Args {
  ...
  SubnetworkIamBindingComputeV1Args({
    this.condition,
  ...
  factory SubnetworkIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SubnetworkIamBindingComputeV1Args(
