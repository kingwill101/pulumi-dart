...
import 'instance_template_iam_member_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class InstanceTemplateIamMember3 extends CustomResource {
  ...
  InstanceTemplateIamMember3(
    String name, {
    InstanceTemplateIamMemberArgs3? args,
