...
class FirewallPolicyIamMemberArgs3 {
  ...
  factory FirewallPolicyIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamMemberArgs3(
