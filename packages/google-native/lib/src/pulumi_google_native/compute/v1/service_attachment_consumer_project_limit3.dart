...
class ServiceAttachmentConsumerProjectLimit3 {
  ...
  ServiceAttachmentConsumerProjectLimit3({
  ...
  factory ServiceAttachmentConsumerProjectLimit3.fromMap(
      Map<String, dynamic> map) {
    return ServiceAttachmentConsumerProjectLimit3(
      connectionLimit:
