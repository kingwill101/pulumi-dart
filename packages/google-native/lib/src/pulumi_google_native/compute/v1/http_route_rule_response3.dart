...
import 'http_route_rule_match_response3.dart';

/// The HttpRouteRule setting specifies how to match an HTTP request and the corresponding routing action that load balancing proxies perform.
class HttpRouteRuleResponse3 {
  ...
  final List<HttpRouteRuleMatchResponse3> matchRules;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['matchRules'] =
        Input.encodeList<HttpRouteRuleMatchResponse3, Map<String, dynamic>>(
  ...
  factory HttpRouteRuleResponse3.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponse3(
      description: map['description'] as String,
      headerAction: HttpHeaderActionResponse3.fromMap(
          (map['headerAction'] as Map).cast<String, dynamic>()),
      matchRules: Input.decodeList<HttpRouteRuleMatchResponse3>(
          map['matchRules'],
          (value) => HttpRouteRuleMatchResponse3.fromMap(
