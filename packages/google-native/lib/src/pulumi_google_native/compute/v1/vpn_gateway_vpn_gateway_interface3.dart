...
class VpnGatewayVpnGatewayInterface3 {
  ...
  factory VpnGatewayVpnGatewayInterface3.fromMap(Map<String, dynamic> map) {
    return VpnGatewayVpnGatewayInterface3(
