...
import 'resource_commitment_type3.dart';

/// Commitment for a particular resource (a Commitment is composed of one or more of these).
class ResourceCommitment3 {
  ...
  final ResourceCommitmentType3? type;
  ...
  factory ResourceCommitment3.fromMap(Map<String, dynamic> map) {
    return ResourceCommitment3(
      ...
      type: map['type'] == null
          ? null
          : ResourceCommitmentType3.fromValue(map['type'] as String),
    );
  }
}
