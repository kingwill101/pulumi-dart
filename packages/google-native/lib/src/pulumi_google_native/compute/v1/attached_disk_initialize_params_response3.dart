...
class AttachedDiskInitializeParamsResponse3 {
  ...
  AttachedDiskInitializeParamsResponse3({
  ...
  factory AttachedDiskInitializeParamsResponse3.fromMap(
      Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsResponse3(
