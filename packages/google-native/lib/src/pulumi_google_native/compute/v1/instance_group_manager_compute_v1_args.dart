...
class InstanceGroupManagerComputeV1Args {
  ...
  final pulumi.Input<InstanceGroupManagerListManagedInstancesResultsComputeV1>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (listManagedInstancesResultsValue != null) {
      map['listManagedInstancesResults'] = pulumi.Input.mapOptionalInputValue<
          InstanceGroupManagerListManagedInstancesResultsComputeV1,
  ...
  factory InstanceGroupManagerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerComputeV1Args(
      ...
      namedPorts: pulumi.Input.asOptionalInput<List<NamedPortComputeV1>>(
          map['namedPorts']),
      ...
      updatePolicy: pulumi.Input.asOptionalInput<
          InstanceGroupManagerUpdatePolicyComputeV1>(map['updatePolicy']),
      versions: pulumi.Input.asOptionalInput<
          List<InstanceGroupManagerVersionComputeV1>>(map['versions']),
