...
class GetNetworkEdgeSecurityServiceResult3 {
  ...
  GetNetworkEdgeSecurityServiceResult3({
  ...
  factory GetNetworkEdgeSecurityServiceResult3.fromMap(
      Map<String, dynamic> map) {
    return GetNetworkEdgeSecurityServiceResult3(
