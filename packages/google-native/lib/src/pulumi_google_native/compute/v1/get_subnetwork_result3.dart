...
class GetSubnetworkResult3 {
  ...
  final SubnetworkLogConfigResponse3 logConfig;
  ...
  final List<SubnetworkSecondaryRangeResponse3> secondaryIpRanges;
  ...
  factory GetSubnetworkResult3.fromMap(Map<String, dynamic> map) {
    return GetSubnetworkResult3(
      ...
      logConfig: SubnetworkLogConfigResponse3.fromMap(
      ...
      secondaryIpRanges: Input.decodeList<SubnetworkSecondaryRangeResponse3>(
          map['secondaryIpRanges'],
          (value) => SubnetworkSecondaryRangeResponse3.fromMap(
