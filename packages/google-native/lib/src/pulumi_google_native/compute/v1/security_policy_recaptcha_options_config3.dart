...
class SecurityPolicyRecaptchaOptionsConfig3 {
  ...
  factory SecurityPolicyRecaptchaOptionsConfig3.fromMap(
      Map<String, dynamic> map) {
    return SecurityPolicyRecaptchaOptionsConfig3(
