...
class InterconnectAttachmentPartnerMetadataResponse3 {
  ...
  InterconnectAttachmentPartnerMetadataResponse3({
  ...
  factory InterconnectAttachmentPartnerMetadataResponse3.fromMap(
      Map<String, dynamic> map) {
    return InterconnectAttachmentPartnerMetadataResponse3(
