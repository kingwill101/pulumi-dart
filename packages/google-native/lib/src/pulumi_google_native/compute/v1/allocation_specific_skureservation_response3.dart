...
import 'allocation_specific_skuallocation_reserved_instance_properties_response3.dart';

/// This reservation type allows to pre allocate specific instance configuration. Next ID: 6
class AllocationSpecificSKUReservationResponse3 {
  ...
  final AllocationSpecificSKUAllocationReservedInstancePropertiesResponse3
      instanceProperties;
  ...
  AllocationSpecificSKUReservationResponse3({
  ...
  factory AllocationSpecificSKUReservationResponse3.fromMap(
      Map<String, dynamic> map) {
    return AllocationSpecificSKUReservationResponse3(
