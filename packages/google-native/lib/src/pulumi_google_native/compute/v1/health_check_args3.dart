...
class HealthCheckArgs3 {
  ...
  final Input<HealthCheckType3>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<HealthCheckType3, String>(
  ...
  factory HealthCheckArgs3.fromMap(Map<String, dynamic> map) {
    return HealthCheckArgs3(
      ...
      type: Input.asOptionalInput<HealthCheckType3>(map['type']),
