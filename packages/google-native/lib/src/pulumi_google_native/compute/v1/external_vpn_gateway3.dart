...
class ExternalVpnGateway3 extends CustomResource {
  ...
  late final Output<List<ExternalVpnGatewayInterfaceResponse3>> interfaces;
  ...
  ExternalVpnGateway3(
    ...
    this.interfaces =
        Output.createUnknown<List<ExternalVpnGatewayInterfaceResponse3>>();
