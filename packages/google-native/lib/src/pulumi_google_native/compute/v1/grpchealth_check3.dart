...
import 'grpchealth_check_port_specification3.dart';

class GRPCHealthCheck3 {
  ...
  final GRPCHealthCheckPortSpecification3? portSpecification;
  ...
  factory GRPCHealthCheck3.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheck3(
      ...
      portSpecification: map['portSpecification'] == null
          ? null
          : GRPCHealthCheckPortSpecification3.fromValue(
