...
import 'security_policy_rule_network_matcher_user_defined_field_match3.dart';

/// Represents a match condition that incoming network traffic is evaluated against.
class SecurityPolicyRuleNetworkMatcher3 {
  ...
  final List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatch3>?
      userDefinedFields;

  SecurityPolicyRuleNetworkMatcher3({
    this.destIpRanges,
    this.destPorts,
    this.ipProtocols,
    this.srcAsns,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (userDefinedFieldsValue != null) {
      map['userDefinedFields'] = Input.encodeList<
              SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatch3,
              Map<String, dynamic>>(
  ...
  factory SecurityPolicyRuleNetworkMatcher3.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcher3(
      ...
      userDefinedFields: map['userDefinedFields'] == null
          ...
          : Input.decodeList<
              ...
              (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatch3
