...
class ResourcePolicyIamMemberArgs3 {
  ...
  factory ResourcePolicyIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamMemberArgs3(
