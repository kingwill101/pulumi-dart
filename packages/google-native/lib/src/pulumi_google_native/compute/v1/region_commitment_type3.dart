...
enum RegionCommitmentType3 {
  ...
  const RegionCommitmentType3(this.value);
  final String value;

  static RegionCommitmentType3 fromValue(String value) {
    for (final item in RegionCommitmentType3.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError('Unknown RegionCommitmentType3 value: $value');
  }
}
