...
import 'attached_disk_initialize_params_architecture3.dart';
import 'attached_disk_initialize_params_on_update_action3.dart';
import 'customer_encryption_key3.dart';

/// [Input Only] Specifies the parameters for a new disk that will be created alongside the new instance. Use initialization parameters to create boot disks or local SSDs attached to the new instance. This field is persisted and returned for instanceTemplate and not returned in the context of instance. This property is mutually exclusive with the source property; you can only define one or the other, but not both.
class AttachedDiskInitializeParams3 {
  /// The architecture of the attached disk. Valid values are arm64 or x86_64.
  final AttachedDiskInitializeParamsArchitecture3? architecture;
  ...
  final AttachedDiskInitializeParamsOnUpdateAction3? onUpdateAction;
  ...
  final CustomerEncryptionKey3? sourceImageEncryptionKey;

  /// The source snapshot to create this disk. When creating a new instance, one of initializeParams.sourceSnapshot or initializeParams.sourceImage or disks.source is required except for local SSD. To create a disk with a snapshot that you created, specify the snapshot name in the following format: global/snapshots/my-backup If the source snapshot is deleted later, this field will not be set.
  final String? sourceSnapshot;

  /// The customer-supplied encryption key of the source snapshot.
  final CustomerEncryptionKey3? sourceSnapshotEncryptionKey;

  AttachedDiskInitializeParams3({
    this.architecture,
    this.description,
    this.diskName,
    this.diskSizeGb,
  ...
  factory AttachedDiskInitializeParams3.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParams3(
      architecture: map['architecture'] == null
          ? null
          : AttachedDiskInitializeParamsArchitecture3.fromValue(
      ...
      onUpdateAction: map['onUpdateAction'] == null
          ? null
          : AttachedDiskInitializeParamsOnUpdateAction3.fromValue(
