...
class SSLHealthCheckResponseComputeV1 {
  ...
  SSLHealthCheckResponseComputeV1({
    required this.port,
  ...
  factory SSLHealthCheckResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheckResponseComputeV1(
