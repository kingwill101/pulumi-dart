...
class AddressComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ipVersionValue != null) {
      map['ipVersion'] =
          pulumi.Input.mapOptionalInputValue<AddressIpVersionComputeV1, String>(
    ...
    if (ipv6EndpointTypeValue != null) {
      map['ipv6EndpointType'] = pulumi.Input.mapOptionalInputValue<
          AddressIpv6EndpointTypeComputeV1,
    ...
    if (purposeValue != null) {
      map['purpose'] =
          pulumi.Input.mapOptionalInputValue<AddressPurposeComputeV1, String>(
  ...
  factory AddressComputeV1Args.fromMap(Map<String, dynamic> map) {
    return AddressComputeV1Args(
      ...
      addressType: pulumi.Input.asOptionalInput<AddressAddressTypeComputeV1>(
          map['addressType']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      ipVersion: pulumi.Input.asOptionalInput<AddressIpVersionComputeV1>(
          map['ipVersion']),
      ipv6EndpointType:
          pulumi.Input.asOptionalInput<AddressIpv6EndpointTypeComputeV1>(
              map['ipv6EndpointType']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      network: pulumi.Input.asOptionalInput<String>(map['network']),
      networkTier: pulumi.Input.asOptionalInput<AddressNetworkTierComputeV1>(
          map['networkTier']),
      prefixLength: pulumi.Input.asOptionalInput<int>(map['prefixLength']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      purpose:
          pulumi.Input.asOptionalInput<AddressPurposeComputeV1>(map['purpose']),
