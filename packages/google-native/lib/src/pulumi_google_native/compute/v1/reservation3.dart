...
class Reservation3 {
  ...
  final ShareSettings3? shareSettings;

  /// Reservation for instances with specific machine shapes.
  final AllocationSpecificSKUReservation3? specificReservation;
  ...
  factory Reservation3.fromMap(Map<String, dynamic> map) {
    return Reservation3(
      description:
