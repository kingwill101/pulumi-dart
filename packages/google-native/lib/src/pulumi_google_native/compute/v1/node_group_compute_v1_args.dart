...
class NodeGroupComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoscalingPolicyValue != null) {
      map['autoscalingPolicy'] = pulumi.Input.mapOptionalInputValue<
              NodeGroupAutoscalingPolicyComputeV1, Map<String, dynamic>>(
    ...
    if (maintenanceWindowValue != null) {
      map['maintenanceWindow'] = pulumi.Input.mapOptionalInputValue<
              NodeGroupMaintenanceWindowComputeV1, Map<String, dynamic>>(
  ...
  factory NodeGroupComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeGroupComputeV1Args(
      ...
      initialNodeCount: pulumi.Input.asInput<int>(map['initialNodeCount']),
      ...
      nodeTemplate: pulumi.Input.asOptionalInput<String>(map['nodeTemplate']),
