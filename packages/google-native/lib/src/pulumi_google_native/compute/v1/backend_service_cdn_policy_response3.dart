...
import 'backend_service_cdn_policy_bypass_cache_on_request_header_response3.dart';
import 'backend_service_cdn_policy_negative_caching_policy_response3.dart';
import 'cache_key_policy_response3.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicyResponse3 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse3>
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final CacheKeyPolicyResponse3 cacheKeyPolicy;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyResponse3>
  ...
  BackendServiceCdnPolicyResponse3({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['negativeCachingPolicy'] = Input.encodeList<
        BackendServiceCdnPolicyNegativeCachingPolicyResponse3,
  ...
  factory BackendServiceCdnPolicyResponse3.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponse3(
      bypassCacheOnRequestHeaders: Input.decodeList<
              BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse3>(
          map['bypassCacheOnRequestHeaders'],
          (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse3
              .fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: CacheKeyPolicyResponse3.fromMap(
      ...
      negativeCachingPolicy: Input.decodeList<
          ...
          (value) =>
              BackendServiceCdnPolicyNegativeCachingPolicyResponse3.fromMap(
