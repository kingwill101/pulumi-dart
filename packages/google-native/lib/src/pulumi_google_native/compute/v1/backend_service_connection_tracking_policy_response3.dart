...
class BackendServiceConnectionTrackingPolicyResponse3 {
  ...
  BackendServiceConnectionTrackingPolicyResponse3({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['enableStrongAffinity'] = enableStrongAffinity;
    map['idleTimeoutSec'] = idleTimeoutSec;
    map['trackingMode'] = trackingMode;
    return map;
  }

  factory BackendServiceConnectionTrackingPolicyResponse3.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicyResponse3(
      connectionPersistenceOnUnhealthyBackends:
