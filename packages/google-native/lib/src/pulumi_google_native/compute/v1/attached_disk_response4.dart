...
import 'attached_disk_initialize_params_response3.dart';
...
class AttachedDiskResponse4 {
  ...
  final AttachedDiskInitializeParamsResponse3 initializeParams;
  ...
  factory AttachedDiskResponse4.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponse4(
      ...
      initializeParams: AttachedDiskInitializeParamsResponse3.fromMap(
