...
import 'region_ssl_policy_args3.dart';
import 'region_ssl_policy_warnings_item_response3.dart';

/// Creates a new policy in the specified project and region using the data included in the request.
class RegionSslPolicy3 extends CustomResource {
  ...
  late final Output<List<RegionSslPolicyWarningsItemResponse3>> warnings;

  RegionSslPolicy3(
    String name, {
    RegionSslPolicyArgs3? args,
    ...
    this.warnings =
        registerOutput<List<RegionSslPolicyWarningsItemResponse3>>('warnings');
  }
}
