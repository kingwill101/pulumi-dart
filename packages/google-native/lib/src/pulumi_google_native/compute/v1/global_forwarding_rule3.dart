...
import 'global_forwarding_rule_args3.dart';
import 'metadata_filter_response3.dart';

/// Creates a GlobalForwardingRule resource in the specified project using the data included in the request.
class GlobalForwardingRule3 extends CustomResource {
  ...
  late final Output<List<MetadataFilterResponse3>> metadataFilters;
  ...
  late final Output<List<ForwardingRuleServiceDirectoryRegistrationResponse3>>
  ...
  GlobalForwardingRule3(
    String name, {
    GlobalForwardingRuleArgs3? args,
