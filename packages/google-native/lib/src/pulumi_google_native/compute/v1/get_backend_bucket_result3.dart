...
class GetBackendBucketResult3 {
  /// Cloud Storage bucket name.
  final String bucketName;

  /// Cloud CDN configuration for this BackendBucket.
  final BackendBucketCdnPolicyResponse3 cdnPolicy;
  ...
  factory GetBackendBucketResult3.fromMap(Map<String, dynamic> map) {
    return GetBackendBucketResult3(
      bucketName: map['bucketName'] as String,
      cdnPolicy: BackendBucketCdnPolicyResponse3.fromMap(
