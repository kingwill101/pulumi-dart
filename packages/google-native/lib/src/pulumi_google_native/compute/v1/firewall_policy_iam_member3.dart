...
import 'firewall_policy_iam_member_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class FirewallPolicyIamMember3 extends CustomResource {
  ...
  FirewallPolicyIamMember3(
    String name, {
    FirewallPolicyIamMemberArgs3? args,
