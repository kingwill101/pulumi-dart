...
class ResourcePolicySnapshotSchedulePolicySnapshotProperties3 {
  ...
  ResourcePolicySnapshotSchedulePolicySnapshotProperties3({
    this.chainName,
    this.guestFlush,
    this.labels,
  ...
  factory ResourcePolicySnapshotSchedulePolicySnapshotProperties3.fromMap(
      Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicySnapshotProperties3(
