...
import 'target_https_proxy_quic_override3.dart';

/// The set of arguments for TargetHttpsProxy.
class TargetHttpsProxyArgs3 {
  ...
  final Input<TargetHttpsProxyQuicOverride3>? quicOverride;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (quicOverrideValue != null) {
      map['quicOverride'] =
          Input.mapOptionalInputValue<TargetHttpsProxyQuicOverride3, String>(
  ...
  factory TargetHttpsProxyArgs3.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyArgs3(
      authorizationPolicy:
      ...
      quicOverride: Input.asOptionalInput<TargetHttpsProxyQuicOverride3>(
          map['quicOverride']),
