...
import 'backend_service_connection_tracking_policy_connection_persistence_on_unhealthy_backends3.dart';
import 'backend_service_connection_tracking_policy_tracking_mode3.dart';

/// Connection Tracking configuration for this BackendService.
class BackendServiceConnectionTrackingPolicy3 {
  ...
  final BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends3?
  ...
  final BackendServiceConnectionTrackingPolicyTrackingMode3? trackingMode;

  BackendServiceConnectionTrackingPolicy3({
  ...
  factory BackendServiceConnectionTrackingPolicy3.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicy3(
      connectionPersistenceOnUnhealthyBackends: map[
                  'connectionPersistenceOnUnhealthyBackends'] ==
              null
          ? null
          : BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends3
              .fromValue(
      ...
      trackingMode: map['trackingMode'] == null
          ? null
          : BackendServiceConnectionTrackingPolicyTrackingMode3.fromValue(
