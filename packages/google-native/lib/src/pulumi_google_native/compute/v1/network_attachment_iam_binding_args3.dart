...
class NetworkAttachmentIamBindingArgs3 {
  ...
  NetworkAttachmentIamBindingArgs3({
    this.condition,
  ...
  factory NetworkAttachmentIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamBindingArgs3(
