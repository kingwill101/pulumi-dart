...
class RegionNetworkFirewallPolicyIamBindingArgs3 {
  ...
  RegionNetworkFirewallPolicyIamBindingArgs3({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamBindingArgs3.fromMap(
      Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamBindingArgs3(
