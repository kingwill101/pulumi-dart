...
class NetworkFirewallPolicyIamMemberArgs3 {
  ...
  NetworkFirewallPolicyIamMemberArgs3({
    this.condition,
  ...
  factory NetworkFirewallPolicyIamMemberArgs3.fromMap(
      Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamMemberArgs3(
