...
import 'security_policy_rule_http_header_action3.dart';
import 'security_policy_rule_matcher3.dart';
import 'security_policy_rule_network_matcher3.dart';
import 'security_policy_rule_preconfigured_waf_config3.dart';
import 'security_policy_rule_rate_limit_options3.dart';
import 'security_policy_rule_redirect_options3.dart';

/// Represents a rule that describes one or more match conditions along with the action to be taken when traffic matches this condition (allow or deny).
class SecurityPolicyRule3 {
  ...
  final SecurityPolicyRuleHttpHeaderAction3? headerAction;

  /// A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
  final SecurityPolicyRuleMatcher3? match;
  ...
  final SecurityPolicyRuleNetworkMatcher3? networkMatch;

  /// Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  final SecurityPolicyRulePreconfiguredWafConfig3? preconfiguredWafConfig;
  ...
  final SecurityPolicyRuleRateLimitOptions3? rateLimitOptions;

  /// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final SecurityPolicyRuleRedirectOptions3? redirectOptions;
  ...
  factory SecurityPolicyRule3.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRule3(
      ...
      rateLimitOptions: map['rateLimitOptions'] == null
          ? null
          : SecurityPolicyRuleRateLimitOptions3.fromMap(
