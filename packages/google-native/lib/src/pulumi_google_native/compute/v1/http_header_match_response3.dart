...
import 'int64_range_match_response3.dart';

/// matchRule criteria for request header matches.
class HttpHeaderMatchResponse3 {
  ...
  final Int64RangeMatchResponse3 rangeMatch;
  ...
  factory HttpHeaderMatchResponse3.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatchResponse3(
      ...
      rangeMatch: Int64RangeMatchResponse3.fromMap(
