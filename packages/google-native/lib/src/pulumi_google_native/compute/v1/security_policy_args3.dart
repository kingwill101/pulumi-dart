...
class SecurityPolicyArgs3 {
  ...
  final Input<SecurityPolicyType3>? type;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (typeValue != null) {
      map['type'] = Input.mapOptionalInputValue<SecurityPolicyType3, String>(
  ...
  factory SecurityPolicyArgs3.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyArgs3(
      adaptiveProtectionConfig:
      ...
      type: Input.asOptionalInput<SecurityPolicyType3>(map['type']),
      userDefinedFields:
