...
class InstanceTemplateIamBindingArgs3 {
  ...
  InstanceTemplateIamBindingArgs3({
    this.condition,
  ...
  factory InstanceTemplateIamBindingArgs3.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateIamBindingArgs3(
