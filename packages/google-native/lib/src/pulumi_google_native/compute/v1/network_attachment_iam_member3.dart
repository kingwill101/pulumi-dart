...
import 'network_attachment_iam_member_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class NetworkAttachmentIamMember3 extends CustomResource {
  ...
  NetworkAttachmentIamMember3(
    String name, {
    NetworkAttachmentIamMemberArgs3? args,
