...
import 'global_forwarding_rule_compute_v1_args.dart';
import 'metadata_filter_response_compute_v1.dart';

/// Creates a GlobalForwardingRule resource in the specified project using the data included in the request.
class GlobalForwardingRuleComputeV1 extends pulumi.CustomResource {
  ...
  GlobalForwardingRuleComputeV1(
    String name, {
    GlobalForwardingRuleComputeV1Args? args,
