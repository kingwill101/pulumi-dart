...
class ForwardingRuleServiceDirectoryRegistration3 {
  ...
  factory ForwardingRuleServiceDirectoryRegistration3.fromMap(
      Map<String, dynamic> map) {
    return ForwardingRuleServiceDirectoryRegistration3(
