...
class BackendServiceIamMemberArgs3 {
  ...
  factory BackendServiceIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamMemberArgs3(
