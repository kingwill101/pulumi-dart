...
import 'region_url_map_compute_v1_args.dart';
import 'url_map_test_response_compute_v1.dart';

/// Creates a UrlMap resource in the specified project using the data included in the request.
class RegionUrlMapComputeV1 extends pulumi.CustomResource {
  ...
  RegionUrlMapComputeV1(
    String name, {
    RegionUrlMapComputeV1Args? args,
    ...
    this.defaultRouteAction =
        registerOutput<HttpRouteActionResponseComputeV1>('defaultRouteAction');
    this.defaultService = registerOutput<String>('defaultService');
    this.defaultUrlRedirect =
        registerOutput<HttpRedirectActionResponseComputeV1>(
            'defaultUrlRedirect');
    this.description = registerOutput<String>('description');
    this.fingerprint = registerOutput<String>('fingerprint');
    this.headerAction =
        registerOutput<HttpHeaderActionResponseComputeV1>('headerAction');
    this.hostRules =
        registerOutput<List<HostRuleResponseComputeV1>>('hostRules');
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.pathMatchers =
        registerOutput<List<PathMatcherResponseComputeV1>>('pathMatchers');
