...
class GetRegionNotificationEndpointArgs3 {
  final Input<String> notificationEndpoint;
  final Input<String>? project;
  final Input<String> region;

  GetRegionNotificationEndpointArgs3({
  ...
  factory GetRegionNotificationEndpointArgs3.fromMap(Map<String, dynamic> map) {
    return GetRegionNotificationEndpointArgs3(
