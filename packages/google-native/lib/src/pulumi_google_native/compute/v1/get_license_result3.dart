...
class GetLicenseResult3 {
  ...
  final String name;
  final LicenseResourceRequirementsResponse3 resourceRequirements;
  ...
  factory GetLicenseResult3.fromMap(Map<String, dynamic> map) {
    return GetLicenseResult3(
      ...
      resourceRequirements: LicenseResourceRequirementsResponse3.fromMap(
