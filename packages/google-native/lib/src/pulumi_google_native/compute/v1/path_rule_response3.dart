...
class PathRuleResponse3 {
  ...
  final HttpRouteActionResponse3 routeAction;
  ...
  final HttpRedirectActionResponse3 urlRedirect;
  ...
  factory PathRuleResponse3.fromMap(Map<String, dynamic> map) {
    return PathRuleResponse3(
      paths: (map['paths'] as List).cast<String>(),
      routeAction: HttpRouteActionResponse3.fromMap(
          (map['routeAction'] as Map).cast<String, dynamic>()),
      service: map['service'] as String,
      urlRedirect: HttpRedirectActionResponse3.fromMap(
