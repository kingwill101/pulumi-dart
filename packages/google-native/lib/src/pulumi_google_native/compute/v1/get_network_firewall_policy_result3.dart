...
class GetNetworkFirewallPolicyResult3 {
  ...
  GetNetworkFirewallPolicyResult3({
  ...
  factory GetNetworkFirewallPolicyResult3.fromMap(Map<String, dynamic> map) {
    return GetNetworkFirewallPolicyResult3(
