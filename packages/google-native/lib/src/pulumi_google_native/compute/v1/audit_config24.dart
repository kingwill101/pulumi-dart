...
import 'audit_log_config24.dart';
...
class AuditConfig24 {
  ...
  final List<AuditLogConfig24>? auditLogConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditLogConfigsValue != null) {
      map['auditLogConfigs'] =
          Input.encodeList<AuditLogConfig24, Map<String, dynamic>>(
  ...
  factory AuditConfig24.fromMap(Map<String, dynamic> map) {
    return AuditConfig24(
      auditLogConfigs: map['auditLogConfigs'] == null
          ? null
          : Input.decodeList<AuditLogConfig24>(
              map['auditLogConfigs'],
              (value) => AuditLogConfig24.fromMap(
