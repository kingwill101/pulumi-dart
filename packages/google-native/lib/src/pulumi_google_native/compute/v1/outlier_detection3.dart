...
class OutlierDetection3 {
  ...
  final Duration3? baseEjectionTime;
  ...
  factory OutlierDetection3.fromMap(Map<String, dynamic> map) {
    return OutlierDetection3(
      ...
      interval: map['interval'] == null
          ? null
          : Duration3.fromMap((map['interval'] as Map).cast<String, dynamic>()),
