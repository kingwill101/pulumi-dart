...
class BackendServiceFailoverPolicyComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    final disableConnectionDrainOnFailoverValue =
        disableConnectionDrainOnFailover;
    if (disableConnectionDrainOnFailoverValue != null) {
      map['disableConnectionDrainOnFailover'] =
          disableConnectionDrainOnFailoverValue;
    }
    final dropTrafficIfUnhealthyValue = dropTrafficIfUnhealthy;
    if (dropTrafficIfUnhealthyValue != null) {
      map['dropTrafficIfUnhealthy'] = dropTrafficIfUnhealthyValue;
    }
  ...
  factory BackendServiceFailoverPolicyComputeV1.fromMap(
      Map<String, dynamic> map) {
    return BackendServiceFailoverPolicyComputeV1(
      disableConnectionDrainOnFailover:
          map['disableConnectionDrainOnFailover'] == null
              ? null
              : map['disableConnectionDrainOnFailover'] as bool,
      dropTrafficIfUnhealthy: map['dropTrafficIfUnhealthy'] == null
          ? null
