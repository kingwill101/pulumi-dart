...
import 'public_advertised_prefix_public_delegated_prefix_response3.dart';

/// Result data returned by getPublicAdvertisedPrefix.
class GetPublicAdvertisedPrefixResult3 {
  ...
  final List<PublicAdvertisedPrefixPublicDelegatedPrefixResponse3>
  ...
  GetPublicAdvertisedPrefixResult3({
  ...
  factory GetPublicAdvertisedPrefixResult3.fromMap(Map<String, dynamic> map) {
    return GetPublicAdvertisedPrefixResult3(
      ...
      publicDelegatedPrefixs: Input.decodeList<
              PublicAdvertisedPrefixPublicDelegatedPrefixResponse3>(
          map['publicDelegatedPrefixs'],
          (value) =>
              PublicAdvertisedPrefixPublicDelegatedPrefixResponse3.fromMap(
