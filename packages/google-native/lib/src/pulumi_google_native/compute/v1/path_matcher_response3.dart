...
import 'http_route_rule_response3.dart';
import 'path_rule_response3.dart';

/// A matcher for the path portion of the URL. The BackendService from the longest-matched rule will serve the URL. If no rule was matched, the default service is used.
class PathMatcherResponse3 {
  ...
  final List<PathRuleResponse3> pathRules;

  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final List<HttpRouteRuleResponse3> routeRules;

  PathMatcherResponse3({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['pathRules'] =
        Input.encodeList<PathRuleResponse3, Map<String, dynamic>>(
            pathRules, (value) => value.toMap());
    map['routeRules'] =
        Input.encodeList<HttpRouteRuleResponse3, Map<String, dynamic>>(
            routeRules, (value) => value.toMap());
    return map;
  }

  factory PathMatcherResponse3.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponse3(
      ...
      pathRules: Input.decodeList<PathRuleResponse3>(
          map['pathRules'],
          (value) => PathRuleResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
      routeRules: Input.decodeList<HttpRouteRuleResponse3>(
          map['routeRules'],
          (value) => HttpRouteRuleResponse3.fromMap(
              (value as Map).cast<String, dynamic>())),
    );
  }
}
