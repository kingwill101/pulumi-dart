...
class HttpRetryPolicyResponse3 {
  ...
  factory HttpRetryPolicyResponse3.fromMap(Map<String, dynamic> map) {
    return HttpRetryPolicyResponse3(
      numRetries: map['numRetries'] as int,
      perTryTimeout: DurationResponse3.fromMap(
