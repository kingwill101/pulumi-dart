...
class ImageIamBindingComputeV1Args {
  ...
  factory ImageIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ImageIamBindingComputeV1Args(
