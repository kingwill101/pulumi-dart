...
class GetRegionTargetHttpsProxyResult3 {
  ...
  GetRegionTargetHttpsProxyResult3({
  ...
  factory GetRegionTargetHttpsProxyResult3.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpsProxyResult3(
