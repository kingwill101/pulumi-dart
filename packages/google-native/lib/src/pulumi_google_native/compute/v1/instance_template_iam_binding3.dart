...
import 'instance_template_iam_binding_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class InstanceTemplateIamBinding3 extends CustomResource {
  ...
  InstanceTemplateIamBinding3(
    String name, {
    InstanceTemplateIamBindingArgs3? args,
