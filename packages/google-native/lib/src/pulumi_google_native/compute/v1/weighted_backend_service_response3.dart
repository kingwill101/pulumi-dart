...
class WeightedBackendServiceResponse3 {
  ...
  WeightedBackendServiceResponse3({
  ...
  factory WeightedBackendServiceResponse3.fromMap(Map<String, dynamic> map) {
    return WeightedBackendServiceResponse3(
