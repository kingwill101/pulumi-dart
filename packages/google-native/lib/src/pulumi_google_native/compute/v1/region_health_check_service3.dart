...
import 'region_health_check_service_args3.dart';

/// Creates a regional HealthCheckService resource in the specified project and region using the data included in the request.
class RegionHealthCheckService3 extends CustomResource {
  ...
  RegionHealthCheckService3(
    String name, {
    RegionHealthCheckServiceArgs3? args,
