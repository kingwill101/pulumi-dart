...
class ResourcePolicyComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ResourcePolicyGroupPlacementPolicyResponseComputeV1>
      groupPlacementPolicy;

  /// Resource policy for scheduling instance operations.
  late final pulumi
      .Output<ResourcePolicyInstanceSchedulePolicyResponseComputeV1>
  ...
  late final pulumi.Output<ResourcePolicyResourceStatusResponseComputeV1>
      resourceStatus;
  ...
  late final pulumi
      .Output<ResourcePolicySnapshotSchedulePolicyResponseComputeV1>
