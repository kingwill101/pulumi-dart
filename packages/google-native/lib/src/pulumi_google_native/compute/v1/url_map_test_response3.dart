...
import 'url_map_test_header_response3.dart';

/// Message for the expected URL mappings.
class UrlMapTestResponse3 {
  ...
  final List<UrlMapTestHeaderResponse3> headers;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['headers'] =
        Input.encodeList<UrlMapTestHeaderResponse3, Map<String, dynamic>>(
  ...
  factory UrlMapTestResponse3.fromMap(Map<String, dynamic> map) {
    return UrlMapTestResponse3(
      ...
      headers: Input.decodeList<UrlMapTestHeaderResponse3>(
          map['headers'],
          (value) => UrlMapTestHeaderResponse3.fromMap(
