...
import 'backend_service_cdn_policy_bypass_cache_on_request_header3.dart';
import 'backend_service_cdn_policy_cache_mode3.dart';
import 'backend_service_cdn_policy_negative_caching_policy3.dart';
import 'cache_key_policy3.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicy3 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeader3>?
      bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final CacheKeyPolicy3? cacheKeyPolicy;
  ...
  final BackendServiceCdnPolicyCacheMode3? cacheMode;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicy3>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (bypassCacheOnRequestHeadersValue != null) {
      map['bypassCacheOnRequestHeaders'] = Input.encodeList<
              BackendServiceCdnPolicyBypassCacheOnRequestHeader3,
              Map<String, dynamic>>(
  ...
  factory BackendServiceCdnPolicy3.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicy3(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null
          ...
          : Input.decodeList<
              ...
              (value) =>
                  BackendServiceCdnPolicyBypassCacheOnRequestHeader3.fromMap(
                      (value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null
          ? null
          : CacheKeyPolicy3.fromMap(
              (map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null
          ? null
          : BackendServiceCdnPolicyCacheMode3.fromValue(
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null
          ? null
          : Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicy3>(
              map['negativeCachingPolicy'],
              (value) => BackendServiceCdnPolicyNegativeCachingPolicy3.fromMap(
                  (value as Map).cast<String, dynamic>())),
