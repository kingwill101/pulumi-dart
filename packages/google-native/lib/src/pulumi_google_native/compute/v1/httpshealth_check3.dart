...
import 'httpshealth_check_port_specification3.dart';
import 'httpshealth_check_proxy_header3.dart';

class HTTPSHealthCheck3 {
  ...
  final HTTPSHealthCheckPortSpecification3? portSpecification;

  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTPSHealthCheckProxyHeader3? proxyHeader;
