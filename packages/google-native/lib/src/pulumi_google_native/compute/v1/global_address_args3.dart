...
import 'global_address_network_tier3.dart';
import 'global_address_purpose3.dart';

/// The set of arguments for GlobalAddress.
class GlobalAddressArgs3 {
  /// The static IP address represented by this resource.
  final Input<String>? address;

  /// The type of address to reserve, either INTERNAL or EXTERNAL. If unspecified, defaults to EXTERNAL.
  final Input<GlobalAddressAddressType3>? addressType;

  /// An optional description of this resource. Provide this field when you create the resource.
  final Input<String>? description;

  /// The IP version that will be used by this address. Valid options are IPV4 or IPV6.
  final Input<GlobalAddressIpVersion3>? ipVersion;

  /// The endpoint type of this address, which should be VM or NETLB. This is used for deciding which type of endpoint this address can be used after the external IPv6 address reservation.
  final Input<GlobalAddressIpv6EndpointType3>? ipv6EndpointType;
  ...
  final Input<GlobalAddressNetworkTier3>? networkTier;
  ...
  final Input<GlobalAddressPurpose3>? purpose;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (addressTypeValue != null) {
      map['addressType'] =
          Input.mapOptionalInputValue<GlobalAddressAddressType3, String>(
    ...
    if (ipVersionValue != null) {
      map['ipVersion'] =
          Input.mapOptionalInputValue<GlobalAddressIpVersion3, String>(
    ...
    if (ipv6EndpointTypeValue != null) {
      map['ipv6EndpointType'] =
          Input.mapOptionalInputValue<GlobalAddressIpv6EndpointType3, String>(
    ...
    if (networkTierValue != null) {
      map['networkTier'] =
          Input.mapOptionalInputValue<GlobalAddressNetworkTier3, String>(
    ...
    if (purposeValue != null) {
      map['purpose'] =
          Input.mapOptionalInputValue<GlobalAddressPurpose3, String>(
  ...
  factory GlobalAddressArgs3.fromMap(Map<String, dynamic> map) {
    return GlobalAddressArgs3(
      address: Input.asOptionalInput<String>(map['address']),
      addressType:
          Input.asOptionalInput<GlobalAddressAddressType3>(map['addressType']),
      description: Input.asOptionalInput<String>(map['description']),
      ipVersion:
          Input.asOptionalInput<GlobalAddressIpVersion3>(map['ipVersion']),
      ipv6EndpointType: Input.asOptionalInput<GlobalAddressIpv6EndpointType3>(
          map['ipv6EndpointType']),
      labels: Input.asOptionalInput<Map<String, String>>(map['labels']),
      name: Input.asOptionalInput<String>(map['name']),
      network: Input.asOptionalInput<String>(map['network']),
      networkTier:
          Input.asOptionalInput<GlobalAddressNetworkTier3>(map['networkTier']),
      prefixLength: Input.asOptionalInput<int>(map['prefixLength']),
      project: Input.asOptionalInput<String>(map['project']),
      purpose: Input.asOptionalInput<GlobalAddressPurpose3>(map['purpose']),
