...
class RegionBackendServiceIamBindingArgs3 {
  ...
  RegionBackendServiceIamBindingArgs3({
    this.condition,
  ...
  factory RegionBackendServiceIamBindingArgs3.fromMap(
      Map<String, dynamic> map) {
    return RegionBackendServiceIamBindingArgs3(
