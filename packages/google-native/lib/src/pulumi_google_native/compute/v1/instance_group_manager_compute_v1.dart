...
class InstanceGroupManagerComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<InstanceGroupManagerAutoHealingPolicyResponseComputeV1>>
      autoHealingPolicies;
  ...
  late final pulumi
      .Output<InstanceGroupManagerInstanceLifecyclePolicyResponseComputeV1>
  ...
  InstanceGroupManagerComputeV1(
    ...
    this.statefulPolicy =
        registerOutput<StatefulPolicyResponseComputeV1>('statefulPolicy');
    this.status =
        registerOutput<InstanceGroupManagerStatusResponseComputeV1>('status');
