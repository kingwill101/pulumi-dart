...
import 'license_resource_requirements3.dart';
...
class LicenseArgs3 {
  ...
  final Input<LicenseResourceRequirements3>? resourceRequirements;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (resourceRequirementsValue != null) {
      map['resourceRequirements'] = Input.mapOptionalInputValue<
              LicenseResourceRequirements3, Map<String, dynamic>>(
  ...
  factory LicenseArgs3.fromMap(Map<String, dynamic> map) {
    return LicenseArgs3(
      description: Input.asOptionalInput<String>(map['description']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      requestId: Input.asOptionalInput<String>(map['requestId']),
      resourceRequirements: Input.asOptionalInput<LicenseResourceRequirements3>(
