...
import 'autoscaling_policy_custom_metric_utilization_utilization_target_type3.dart';

/// Custom utilization metric policy.
class AutoscalingPolicyCustomMetricUtilization3 {
  ...
  final AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType3?
      utilizationTargetType;

  AutoscalingPolicyCustomMetricUtilization3({
    this.filter,
    this.metric,
  ...
  factory AutoscalingPolicyCustomMetricUtilization3.fromMap(
      Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilization3(
      ...
      utilizationTargetType: map['utilizationTargetType'] == null
          ? null
          : AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType3
