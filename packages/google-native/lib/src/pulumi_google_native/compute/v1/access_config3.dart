...
import 'access_config_network_tier3.dart';
import 'access_config_type3.dart';
...
class AccessConfig3 {
  ...
  final AccessConfigNetworkTier3? networkTier;
  ...
  factory AccessConfig3.fromMap(Map<String, dynamic> map) {
    return AccessConfig3(
      externalIpv6:
      ...
      networkTier: map['networkTier'] == null
          ? null
          : AccessConfigNetworkTier3.fromValue(map['networkTier'] as String),
      ...
      type: map['type'] == null
          ? null
          : AccessConfigType3.fromValue(map['type'] as String),
    );
  }
}
