...
import 'snapshot_snapshot_type3.dart';
...
class SnapshotArgs4 {
  ...
  final Input<CustomerEncryptionKey3>? snapshotEncryptionKey;

  /// Indicates the type of the snapshot.
  final Input<SnapshotSnapshotType3>? snapshotType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (snapshotTypeValue != null) {
      map['snapshotType'] =
          Input.mapOptionalInputValue<SnapshotSnapshotType3, String>(
  ...
  factory SnapshotArgs4.fromMap(Map<String, dynamic> map) {
    return SnapshotArgs4(
      ...
      snapshotEncryptionKey: Input.asOptionalInput<CustomerEncryptionKey3>(
          map['snapshotEncryptionKey']),
      snapshotType:
          Input.asOptionalInput<SnapshotSnapshotType3>(map['snapshotType']),
