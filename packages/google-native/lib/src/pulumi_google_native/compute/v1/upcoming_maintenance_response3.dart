...
class UpcomingMaintenanceResponse3 {
  ...
  factory UpcomingMaintenanceResponse3.fromMap(Map<String, dynamic> map) {
    return UpcomingMaintenanceResponse3(
