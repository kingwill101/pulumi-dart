...
import 'resource_policy_iam_member_args3.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class ResourcePolicyIamMember3 extends CustomResource {
  ...
  ResourcePolicyIamMember3(
    String name, {
    ResourcePolicyIamMemberArgs3? args,
