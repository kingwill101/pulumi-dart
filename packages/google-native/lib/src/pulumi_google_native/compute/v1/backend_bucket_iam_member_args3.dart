...
class BackendBucketIamMemberArgs3 {
  ...
  factory BackendBucketIamMemberArgs3.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamMemberArgs3(
