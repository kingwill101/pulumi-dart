...
import 'backend_service_log_config_optional_mode3.dart';

/// The available logging options for the load balancer traffic served by this backend service.
class BackendServiceLogConfig3 {
  ...
  final BackendServiceLogConfigOptionalMode3? optionalMode;

  /// This field can only be specified if logging is enabled for this backend service. The value of the field must be in [0, 1]. This configures the sampling rate of requests to the load balancer where 1.0 means all logged requests are reported and 0.0 means no logged requests are reported. The default value is 1.0.
  final double? sampleRate;

  BackendServiceLogConfig3({
    this.enable,
    this.optionalFields,
    this.optionalMode,
    this.sampleRate,
  ...
  factory BackendServiceLogConfig3.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfig3(
      ...
      optionalMode: map['optionalMode'] == null
          ? null
          : BackendServiceLogConfigOptionalMode3.fromValue(
