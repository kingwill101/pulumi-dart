...
import 'target_pool_session_affinity3.dart';

/// The set of arguments for TargetPool.
class TargetPoolArgs3 {
  ...
  final Input<TargetPoolSessionAffinity3>? sessionAffinity;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sessionAffinityValue != null) {
      map['sessionAffinity'] =
          Input.mapOptionalInputValue<TargetPoolSessionAffinity3, String>(
              sessionAffinityValue, (value) => value.value);
    }
    return map;
  }

  factory TargetPoolArgs3.fromMap(Map<String, dynamic> map) {
    return TargetPoolArgs3(
      ...
      sessionAffinity: Input.asOptionalInput<TargetPoolSessionAffinity3>(
          map['sessionAffinity']),
    );
  }
}
