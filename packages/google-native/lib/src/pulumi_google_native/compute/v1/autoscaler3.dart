...
class Autoscaler3 extends CustomResource {
  ...
  Autoscaler3(
    ...
    this.autoscalingPolicy = Output.createUnknown<AutoscalingPolicyResponse3>();
    ...
    this.statusDetails =
        Output.createUnknown<List<AutoscalerStatusDetailsResponse3>>();
