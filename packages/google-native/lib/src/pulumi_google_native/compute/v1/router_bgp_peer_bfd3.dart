...
import 'router_bgp_peer_bfd_session_initialization_mode3.dart';

class RouterBgpPeerBfd3 {
  ...
  final RouterBgpPeerBfdSessionInitializationMode3? sessionInitializationMode;
  ...
  factory RouterBgpPeerBfd3.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfd3(
      ...
      sessionInitializationMode: map['sessionInitializationMode'] == null
          ? null
          : RouterBgpPeerBfdSessionInitializationMode3.fromValue(
