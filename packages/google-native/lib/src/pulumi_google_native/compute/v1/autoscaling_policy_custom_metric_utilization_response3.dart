...
class AutoscalingPolicyCustomMetricUtilizationResponse3 {
  ...
  factory AutoscalingPolicyCustomMetricUtilizationResponse3.fromMap(
      Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationResponse3(
