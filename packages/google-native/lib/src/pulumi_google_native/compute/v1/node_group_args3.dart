...
import 'node_group_autoscaling_policy3.dart';
import 'node_group_maintenance_policy3.dart';
import 'node_group_maintenance_window3.dart';
import 'share_settings3.dart';

/// The set of arguments for NodeGroup.
class NodeGroupArgs3 {
  /// Specifies how autoscaling should behave.
  final Input<NodeGroupAutoscalingPolicy3>? autoscalingPolicy;
  ...
  final Input<NodeGroupMaintenancePolicy3>? maintenancePolicy;
  final Input<NodeGroupMaintenanceWindow3>? maintenanceWindow;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoscalingPolicyValue != null) {
      map['autoscalingPolicy'] = Input.mapOptionalInputValue<
              NodeGroupAutoscalingPolicy3, Map<String, dynamic>>(
    ...
    if (maintenancePolicyValue != null) {
      map['maintenancePolicy'] =
          Input.mapOptionalInputValue<NodeGroupMaintenancePolicy3, String>(
    ...
    if (maintenanceWindowValue != null) {
      map['maintenanceWindow'] = Input.mapOptionalInputValue<
              NodeGroupMaintenanceWindow3, Map<String, dynamic>>(
  ...
  factory NodeGroupArgs3.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs3(
      autoscalingPolicy: Input.asOptionalInput<NodeGroupAutoscalingPolicy3>(
      ...
      maintenancePolicy: Input.asOptionalInput<NodeGroupMaintenancePolicy3>(
          map['maintenancePolicy']),
      maintenanceWindow: Input.asOptionalInput<NodeGroupMaintenanceWindow3>(
