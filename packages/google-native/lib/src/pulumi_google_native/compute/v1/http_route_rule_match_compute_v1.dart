...
class HttpRouteRuleMatchComputeV1 {
  ...
  final List<HttpHeaderMatchComputeV1>? headerMatches;
  ...
  final List<MetadataFilterComputeV1>? metadataFilters;
  ...
  final List<HttpQueryParameterMatchComputeV1>? queryParameterMatches;

  /// For satisfying the matchRule condition, the path of the request must satisfy the regular expression specified in regexMatch after removing any query parameters and anchor supplied with the original URL. For more information about regular expression syntax, see Syntax. Only one of prefixMatch, fullPathMatch or regexMatch must be specified. Regular expressions can only be used when the loadBalancingScheme is set to INTERNAL_SELF_MANAGED.
  final String? regexMatch;

  HttpRouteRuleMatchComputeV1({
    this.fullPathMatch,
    this.headerMatches,
    this.ignoreCase,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headerMatchesValue != null) {
      map['headerMatches'] = pulumi.Input.encodeList<HttpHeaderMatchComputeV1,
    ...
    if (metadataFiltersValue != null) {
      map['metadataFilters'] = pulumi.Input.encodeList<MetadataFilterComputeV1,
    ...
    if (queryParameterMatchesValue != null) {
      map['queryParameterMatches'] = pulumi.Input.encodeList<
              HttpQueryParameterMatchComputeV1, Map<String, dynamic>>(
  ...
  factory HttpRouteRuleMatchComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchComputeV1(
      ...
      headerMatches: map['headerMatches'] == null
          ? null
          : pulumi.Input.decodeList<HttpHeaderMatchComputeV1>(
              map['headerMatches'],
              (value) => HttpHeaderMatchComputeV1.fromMap(
      ...
      queryParameterMatches: map['queryParameterMatches'] == null
          ? null
          : pulumi.Input.decodeList<HttpQueryParameterMatchComputeV1>(
              map['queryParameterMatches'],
              (value) => HttpQueryParameterMatchComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      regexMatch:
