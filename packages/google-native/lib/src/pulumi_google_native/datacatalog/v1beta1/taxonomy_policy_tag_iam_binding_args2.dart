...
class TaxonomyPolicyTagIamBindingArgs2 {
  ...
  TaxonomyPolicyTagIamBindingArgs2({
    this.condition,
  ...
  factory TaxonomyPolicyTagIamBindingArgs2.fromMap(Map<String, dynamic> map) {
    return TaxonomyPolicyTagIamBindingArgs2(
