...
class GetEntryDatacatalogV1beta1Result {
  ...
  final GoogleCloudDatacatalogV1beta1BigQueryDateShardedSpecResponse
      bigqueryDateShardedSpec;

  /// Specification that applies to a BigQuery table. This is only valid on entries of type `TABLE`.
  final GoogleCloudDatacatalogV1beta1BigQueryTableSpecResponse
      bigqueryTableSpec;
  ...
  final GoogleCloudDatacatalogV1beta1SystemTimestampsResponse
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bigqueryDateShardedSpec'] = bigqueryDateShardedSpec.toMap();
    map['bigqueryTableSpec'] = bigqueryTableSpec.toMap();
    map['description'] = description;
    map['displayName'] = displayName;
    map['gcsFilesetSpec'] = gcsFilesetSpec.toMap();
    map['integratedSystem'] = integratedSystem;
    map['linkedResource'] = linkedResource;
    map['name'] = name;
    map['schema'] = schema.toMap();
    map['sourceSystemTimestamps'] = sourceSystemTimestamps.toMap();
    map['type'] = type;
    map['usageSignal'] = usageSignal.toMap();
    map['userSpecifiedSystem'] = userSpecifiedSystem;
    map['userSpecifiedType'] = userSpecifiedType;
    return map;
  }
  ...
  factory GetEntryDatacatalogV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetEntryDatacatalogV1beta1Result(
      bigqueryDateShardedSpec:
          GoogleCloudDatacatalogV1beta1BigQueryDateShardedSpecResponse.fromMap(
              (map['bigqueryDateShardedSpec'] as Map).cast<String, dynamic>()),
      bigqueryTableSpec:
          GoogleCloudDatacatalogV1beta1BigQueryTableSpecResponse.fromMap(
              (map['bigqueryTableSpec'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      gcsFilesetSpec:
          GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse.fromMap(
      ...
      schema: GoogleCloudDatacatalogV1beta1SchemaResponse.fromMap(
      ...
      usageSignal: GoogleCloudDatacatalogV1beta1UsageSignalResponse.fromMap(
