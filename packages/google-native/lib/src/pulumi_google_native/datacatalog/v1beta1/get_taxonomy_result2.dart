...
class GetTaxonomyResult2 {
  ...
  factory GetTaxonomyResult2.fromMap(Map<String, dynamic> map) {
    return GetTaxonomyResult2(
      ...
      service: GoogleCloudDatacatalogV1beta1TaxonomyServiceResponse.fromMap(
