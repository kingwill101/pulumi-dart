...
class TaxonomyPolicyTagIamMemberArgs2 {
  ...
  TaxonomyPolicyTagIamMemberArgs2({
    this.condition,
  ...
  factory TaxonomyPolicyTagIamMemberArgs2.fromMap(Map<String, dynamic> map) {
    return TaxonomyPolicyTagIamMemberArgs2(
