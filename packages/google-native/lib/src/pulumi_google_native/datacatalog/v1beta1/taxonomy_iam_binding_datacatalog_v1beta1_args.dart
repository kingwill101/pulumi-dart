...
class TaxonomyIamBindingDatacatalogV1beta1Args {
  ...
  TaxonomyIamBindingDatacatalogV1beta1Args({
    this.condition,
  ...
  factory TaxonomyIamBindingDatacatalogV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return TaxonomyIamBindingDatacatalogV1beta1Args(
