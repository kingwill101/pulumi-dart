  ...
  factory EntryDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EntryDatacatalogV1beta1Args(
      ...
      gcsFilesetSpec: pulumi.Input.asOptionalInput<
          GoogleCloudDatacatalogV1beta1GcsFilesetSpec>(map['gcsFilesetSpec']),
      linkedResource:
          pulumi.Input.asOptionalInput<String>(map['linkedResource']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      schema: pulumi.Input.asOptionalInput<GoogleCloudDatacatalogV1beta1Schema>(
          map['schema']),
      type: pulumi.Input.asOptionalInput<EntryTypeDatacatalogV1beta1>(
          map['type']),
      userSpecifiedSystem:
