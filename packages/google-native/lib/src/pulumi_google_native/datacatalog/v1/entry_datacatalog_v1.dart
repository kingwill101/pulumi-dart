...
import 'entry_datacatalog_v1_args.dart';
...
class EntryDatacatalogV1 extends pulumi.CustomResource {
  /// Specification for a group of BigQuery tables with the `[prefix]YYYYMMDD` name pattern. For more information, see [Introduction to partitioned tables] (https://cloud.google.com/bigquery/docs/partitioned-tables#partitioning_versus_sharding).
  late final pulumi
      .Output<GoogleCloudDatacatalogV1BigQueryDateShardedSpecResponse>
      bigqueryDateShardedSpec;

  /// Specification that applies to a BigQuery table. Valid only for entries with the `TABLE` type.
  late final pulumi.Output<GoogleCloudDatacatalogV1BigQueryTableSpecResponse>
      bigqueryTableSpec;

  /// Business Context of the entry. Not supported for BigQuery datasets
  late final pulumi.Output<GoogleCloudDatacatalogV1BusinessContextResponse>
      businessContext;

  /// Specification that applies to Cloud Bigtable system. Only settable when `integrated_system` is equal to `CLOUD_BIGTABLE`
  late final pulumi
      .Output<GoogleCloudDatacatalogV1CloudBigtableSystemSpecResponse>
      cloudBigtableSystemSpec;

  /// Physical location of the entry.
  late final pulumi.Output<GoogleCloudDatacatalogV1DataSourceResponse>
      dataSource;

  /// Specification that applies to a data source connection. Valid only for entries with the `DATA_SOURCE_CONNECTION` type.
  late final pulumi
      .Output<GoogleCloudDatacatalogV1DataSourceConnectionSpecResponse>
      dataSourceConnectionSpec;

  /// Specification that applies to a table resource. Valid only for entries with the `TABLE` or `EXPLORE` type.
  late final pulumi.Output<GoogleCloudDatacatalogV1DatabaseTableSpecResponse>
      databaseTableSpec;

  /// Specification that applies to a dataset.
  late final pulumi.Output<GoogleCloudDatacatalogV1DatasetSpecResponse>
      datasetSpec;
  ...
  late final pulumi.Output<GoogleCloudDatacatalogV1FilesetSpecResponse>
      filesetSpec;
  ...
  late final pulumi.Output<GoogleCloudDatacatalogV1GcsFilesetSpecResponse>
      gcsFilesetSpec;
  ...
  late final pulumi.Output<GoogleCloudDatacatalogV1LookerSystemSpecResponse>
      lookerSystemSpec;
  ...
  late final pulumi.Output<GoogleCloudDatacatalogV1PersonalDetailsResponse>
      personalDetails;
  late final pulumi.Output<String> project;

  /// Specification that applies to a user-defined function or procedure. Valid only for entries with the `ROUTINE` type.
  late final pulumi.Output<GoogleCloudDatacatalogV1RoutineSpecResponse>
      routineSpec;
  ...
  late final pulumi.Output<GoogleCloudDatacatalogV1ServiceSpecResponse>
      serviceSpec;
  ...
  late final pulumi
      .Output<GoogleCloudDatacatalogV1SqlDatabaseSystemSpecResponse>
  ...
  late final pulumi.Output<GoogleCloudDatacatalogV1UsageSignalResponse>
      usageSignal;
