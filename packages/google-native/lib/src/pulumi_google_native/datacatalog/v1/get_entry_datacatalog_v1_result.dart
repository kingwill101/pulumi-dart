...
class GetEntryDatacatalogV1Result {
  /// Specification for a group of BigQuery tables with the `[prefix]YYYYMMDD` name pattern. For more information, see [Introduction to partitioned tables] (https://cloud.google.com/bigquery/docs/partitioned-tables#partitioning_versus_sharding).
  final GoogleCloudDatacatalogV1BigQueryDateShardedSpecResponse
  ...
  final GoogleCloudDatacatalogV1CloudBigtableSystemSpecResponse
  ...
  final GoogleCloudDatacatalogV1DataSourceConnectionSpecResponse
  ...
  final GoogleCloudDatacatalogV1SqlDatabaseSystemSpecResponse
  ...
  Map<String, dynamic> toMap() {
    ...
    map['businessContext'] = businessContext.toMap();
    map['cloudBigtableSystemSpec'] = cloudBigtableSystemSpec.toMap();
    map['dataSource'] = dataSource.toMap();
    map['dataSourceConnectionSpec'] = dataSourceConnectionSpec.toMap();
    map['databaseTableSpec'] = databaseTableSpec.toMap();
    map['datasetSpec'] = datasetSpec.toMap();
    map['description'] = description;
    map['displayName'] = displayName;
    map['filesetSpec'] = filesetSpec.toMap();
    ...
    map['lookerSystemSpec'] = lookerSystemSpec.toMap();
    map['modelSpec'] = modelSpec.toMap();
    map['name'] = name;
    map['personalDetails'] = personalDetails.toMap();
    map['routineSpec'] = routineSpec.toMap();
    map['schema'] = schema.toMap();
    map['serviceSpec'] = serviceSpec.toMap();
    map['sourceSystemTimestamps'] = sourceSystemTimestamps.toMap();
    map['sqlDatabaseSystemSpec'] = sqlDatabaseSystemSpec.toMap();
    map['type'] = type;
  ...
  factory GetEntryDatacatalogV1Result.fromMap(Map<String, dynamic> map) {
    return GetEntryDatacatalogV1Result(
      bigqueryDateShardedSpec:
          GoogleCloudDatacatalogV1BigQueryDateShardedSpecResponse.fromMap(
              (map['bigqueryDateShardedSpec'] as Map).cast<String, dynamic>()),
      bigqueryTableSpec:
          GoogleCloudDatacatalogV1BigQueryTableSpecResponse.fromMap(
              (map['bigqueryTableSpec'] as Map).cast<String, dynamic>()),
      businessContext: GoogleCloudDatacatalogV1BusinessContextResponse.fromMap(
          (map['businessContext'] as Map).cast<String, dynamic>()),
      cloudBigtableSystemSpec:
          GoogleCloudDatacatalogV1CloudBigtableSystemSpecResponse.fromMap(
              (map['cloudBigtableSystemSpec'] as Map).cast<String, dynamic>()),
      dataSource: GoogleCloudDatacatalogV1DataSourceResponse.fromMap(
          (map['dataSource'] as Map).cast<String, dynamic>()),
      dataSourceConnectionSpec:
          GoogleCloudDatacatalogV1DataSourceConnectionSpecResponse.fromMap(
              (map['dataSourceConnectionSpec'] as Map).cast<String, dynamic>()),
      databaseTableSpec:
          GoogleCloudDatacatalogV1DatabaseTableSpecResponse.fromMap(
              (map['databaseTableSpec'] as Map).cast<String, dynamic>()),
      datasetSpec: GoogleCloudDatacatalogV1DatasetSpecResponse.fromMap(
          (map['datasetSpec'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      filesetSpec: GoogleCloudDatacatalogV1FilesetSpecResponse.fromMap(
          (map['filesetSpec'] as Map).cast<String, dynamic>()),
      fullyQualifiedName: map['fullyQualifiedName'] as String,
      gcsFilesetSpec: GoogleCloudDatacatalogV1GcsFilesetSpecResponse.fromMap(
      ...
      lookerSystemSpec:
          GoogleCloudDatacatalogV1LookerSystemSpecResponse.fromMap(
              (map['lookerSystemSpec'] as Map).cast<String, dynamic>()),
      modelSpec: GoogleCloudDatacatalogV1ModelSpecResponse.fromMap(
          (map['modelSpec'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      personalDetails: GoogleCloudDatacatalogV1PersonalDetailsResponse.fromMap(
          (map['personalDetails'] as Map).cast<String, dynamic>()),
      routineSpec: GoogleCloudDatacatalogV1RoutineSpecResponse.fromMap(
          (map['routineSpec'] as Map).cast<String, dynamic>()),
      schema: GoogleCloudDatacatalogV1SchemaResponse.fromMap(
          (map['schema'] as Map).cast<String, dynamic>()),
      serviceSpec: GoogleCloudDatacatalogV1ServiceSpecResponse.fromMap(
      ...
      sqlDatabaseSystemSpec:
          GoogleCloudDatacatalogV1SqlDatabaseSystemSpecResponse.fromMap(
              (map['sqlDatabaseSystemSpec'] as Map).cast<String, dynamic>()),
      type: map['type'] as String,
      usageSignal: GoogleCloudDatacatalogV1UsageSignalResponse.fromMap(
