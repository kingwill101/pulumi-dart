...
class ScheduleResponseWebsecurityscannerV1 {
  ...
  ScheduleResponseWebsecurityscannerV1({
  ...
  factory ScheduleResponseWebsecurityscannerV1.fromMap(
      Map<String, dynamic> map) {
    return ScheduleResponseWebsecurityscannerV1(
