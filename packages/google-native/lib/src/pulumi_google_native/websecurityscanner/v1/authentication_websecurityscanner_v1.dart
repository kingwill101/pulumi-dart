...
class AuthenticationWebsecurityscannerV1 {
  ...
  factory AuthenticationWebsecurityscannerV1.fromMap(Map<String, dynamic> map) {
    return AuthenticationWebsecurityscannerV1(
