...
class ScheduleWebsecurityscannerV1 {
  ...
  factory ScheduleWebsecurityscannerV1.fromMap(Map<String, dynamic> map) {
    return ScheduleWebsecurityscannerV1(
