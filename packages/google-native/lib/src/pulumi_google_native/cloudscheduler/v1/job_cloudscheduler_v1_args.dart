...
class JobCloudschedulerV1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (pubsubTargetValue != null) {
      map['pubsubTarget'] = pulumi.Input.mapOptionalInputValue<PubsubTarget,
  ...
  factory JobCloudschedulerV1Args.fromMap(Map<String, dynamic> map) {
    return JobCloudschedulerV1Args(
      ...
      httpTarget: pulumi.Input.asOptionalInput<HttpTarget>(map['httpTarget']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      pubsubTarget:
          pulumi.Input.asOptionalInput<PubsubTarget>(map['pubsubTarget']),
      retryConfig:
          pulumi.Input.asOptionalInput<RetryConfig>(map['retryConfig']),
