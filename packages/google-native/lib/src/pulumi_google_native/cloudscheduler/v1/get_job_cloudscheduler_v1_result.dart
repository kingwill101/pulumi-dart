...
import 'status_response_cloudscheduler_v1.dart';

/// Result data returned by getJob.
class GetJobCloudschedulerV1Result {
  /// App Engine HTTP target.
  final AppEngineHttpTargetResponse appEngineHttpTarget;
  ...
  /// Pub/Sub target.
  final PubsubTargetResponse pubsubTarget;
  ...
  final StatusResponseCloudschedulerV1 status;
  ...
  factory GetJobCloudschedulerV1Result.fromMap(Map<String, dynamic> map) {
    return GetJobCloudschedulerV1Result(
      appEngineHttpTarget: AppEngineHttpTargetResponse.fromMap(
      ...
      pubsubTarget: PubsubTargetResponse.fromMap(
      ...
      status: StatusResponseCloudschedulerV1.fromMap(
