...
class JobCloudschedulerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<StatusResponseCloudschedulerV1> status;
  ...
  JobCloudschedulerV1(
    ...
    this.status = registerOutput<StatusResponseCloudschedulerV1>('status');
