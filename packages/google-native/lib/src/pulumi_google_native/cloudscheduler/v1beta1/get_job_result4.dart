...
import 'app_engine_http_target_response2.dart';
import 'http_target_response2.dart';
import 'pubsub_target_response2.dart';
import 'retry_config_response2.dart';
import 'status_response6.dart';

/// Result data returned by getJob.
class GetJobResult4 {
  /// App Engine HTTP target.
  final AppEngineHttpTargetResponse2 appEngineHttpTarget;
  ...
  /// HTTP target.
  final HttpTargetResponse2 httpTarget;
  ...
  /// Pub/Sub target.
  final PubsubTargetResponse2 pubsubTarget;

  /// Settings that determine the retry behavior.
  final RetryConfigResponse2 retryConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['attemptDeadline'] = attemptDeadline;
    map['description'] = description;
    map['httpTarget'] = httpTarget.toMap();
    map['lastAttemptTime'] = lastAttemptTime;
    map['legacyAppEngineCron'] = legacyAppEngineCron;
    map['name'] = name;
    map['pubsubTarget'] = pubsubTarget.toMap();
    ...
    map['userUpdateTime'] = userUpdateTime;
    return map;
  }

  factory GetJobResult4.fromMap(Map<String, dynamic> map) {
    return GetJobResult4(
      appEngineHttpTarget: AppEngineHttpTargetResponse2.fromMap(
          (map['appEngineHttpTarget'] as Map).cast<String, dynamic>()),
      attemptDeadline: map['attemptDeadline'] as String,
      description: map['description'] as String,
      httpTarget: HttpTargetResponse2.fromMap(
