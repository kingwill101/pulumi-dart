...
class JobCloudschedulerV1beta1Args {
  ...
  final pulumi.Input<AppEngineHttpTargetCloudschedulerV1beta1>?
      appEngineHttpTarget;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (appEngineHttpTargetValue != null) {
      map['appEngineHttpTarget'] = pulumi.Input.mapOptionalInputValue<
              AppEngineHttpTargetCloudschedulerV1beta1, Map<String, dynamic>>(
    ...
    if (pubsubTargetValue != null) {
      map['pubsubTarget'] = pulumi.Input.mapOptionalInputValue<
          PubsubTargetCloudschedulerV1beta1,
          Map<String, dynamic>>(pubsubTargetValue, (value) => value.toMap());
    }
    final retryConfigValue = retryConfig;
    if (retryConfigValue != null) {
      map['retryConfig'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory JobCloudschedulerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return JobCloudschedulerV1beta1Args(
      appEngineHttpTarget: pulumi.Input.asOptionalInput<
          AppEngineHttpTargetCloudschedulerV1beta1>(map['appEngineHttpTarget']),
      attemptDeadline:
          pulumi.Input.asOptionalInput<String>(map['attemptDeadline']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      httpTarget: pulumi.Input.asOptionalInput<HttpTargetCloudschedulerV1beta1>(
          map['httpTarget']),
      legacyAppEngineCron:
          pulumi.Input.asOptionalInput<bool>(map['legacyAppEngineCron']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      pubsubTarget:
          pulumi.Input.asOptionalInput<PubsubTargetCloudschedulerV1beta1>(
              map['pubsubTarget']),
      retryConfig:
          pulumi.Input.asOptionalInput<RetryConfigCloudschedulerV1beta1>(
              map['retryConfig']),
