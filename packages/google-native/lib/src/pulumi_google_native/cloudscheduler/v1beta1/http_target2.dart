...
import 'http_target_http_method2.dart';
import 'oauth_token2.dart';
import 'oidc_token2.dart';
...
class HttpTarget2 {
  ...
  factory HttpTarget2.fromMap(Map<String, dynamic> map) {
    return HttpTarget2(
      ...
      httpMethod: map['httpMethod'] == null
          ? null
          : HttpTargetHttpMethod2.fromValue(map['httpMethod'] as String),
