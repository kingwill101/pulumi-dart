...
class RetryConfigResponseCloudschedulerV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['maxBackoffDuration'] = maxBackoffDuration;
    map['maxDoublings'] = maxDoublings;
    map['maxRetryDuration'] = maxRetryDuration;
    map['minBackoffDuration'] = minBackoffDuration;
    map['retryCount'] = retryCount;
    return map;
  }

  factory RetryConfigResponseCloudschedulerV1beta1.fromMap(
      Map<String, dynamic> map) {
    return RetryConfigResponseCloudschedulerV1beta1(
      maxBackoffDuration: map['maxBackoffDuration'] as String,
      maxDoublings: map['maxDoublings'] as int,
      maxRetryDuration: map['maxRetryDuration'] as String,
      minBackoffDuration: map['minBackoffDuration'] as String,
