...
import 'app_engine_http_target2.dart';
import 'http_target2.dart';
import 'pubsub_target2.dart';
import 'retry_config2.dart';

/// The set of arguments for Job.
class JobArgs4 {
  /// App Engine HTTP target.
  final Input<AppEngineHttpTarget2>? appEngineHttpTarget;
  ...
  /// HTTP target.
  final Input<HttpTarget2>? httpTarget;
  ...
  final Input<bool>? legacyAppEngineCron;
  ...
  /// Pub/Sub target.
  final Input<PubsubTarget2>? pubsubTarget;

  /// Settings that determine the retry behavior.
  final Input<RetryConfig2>? retryConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (appEngineHttpTargetValue != null) {
      map['appEngineHttpTarget'] = Input.mapOptionalInputValue<
              AppEngineHttpTarget2, Map<String, dynamic>>(
    ...
    if (httpTargetValue != null) {
      map['httpTarget'] =
          Input.mapOptionalInputValue<HttpTarget2, Map<String, dynamic>>(
              httpTargetValue, (value) => value.toMap());
    }
    final legacyAppEngineCronValue = legacyAppEngineCron;
    if (legacyAppEngineCronValue != null) {
      map['legacyAppEngineCron'] = legacyAppEngineCronValue;
    }
    ...
    if (pubsubTargetValue != null) {
      map['pubsubTarget'] =
          Input.mapOptionalInputValue<PubsubTarget2, Map<String, dynamic>>(
              pubsubTargetValue, (value) => value.toMap());
    }
    final retryConfigValue = retryConfig;
    if (retryConfigValue != null) {
      map['retryConfig'] =
          Input.mapOptionalInputValue<RetryConfig2, Map<String, dynamic>>(
  ...
  factory JobArgs4.fromMap(Map<String, dynamic> map) {
    return JobArgs4(
      appEngineHttpTarget: Input.asOptionalInput<AppEngineHttpTarget2>(
          map['appEngineHttpTarget']),
      attemptDeadline: Input.asOptionalInput<String>(map['attemptDeadline']),
      description: Input.asOptionalInput<String>(map['description']),
      httpTarget: Input.asOptionalInput<HttpTarget2>(map['httpTarget']),
      legacyAppEngineCron:
          Input.asOptionalInput<bool>(map['legacyAppEngineCron']),
      location: Input.asOptionalInput<String>(map['location']),
      name: Input.asOptionalInput<String>(map['name']),
      project: Input.asOptionalInput<String>(map['project']),
      pubsubTarget: Input.asOptionalInput<PubsubTarget2>(map['pubsubTarget']),
      retryConfig: Input.asOptionalInput<RetryConfig2>(map['retryConfig']),
