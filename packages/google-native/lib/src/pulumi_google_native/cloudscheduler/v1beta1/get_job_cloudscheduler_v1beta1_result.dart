...
class GetJobCloudschedulerV1beta1Result {
  ...
  GetJobCloudschedulerV1beta1Result({
  ...
  factory GetJobCloudschedulerV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetJobCloudschedulerV1beta1Result(
      appEngineHttpTarget:
          AppEngineHttpTargetResponseCloudschedulerV1beta1.fromMap(
              (map['appEngineHttpTarget'] as Map).cast<String, dynamic>()),
      attemptDeadline: map['attemptDeadline'] as String,
      description: map['description'] as String,
      httpTarget: HttpTargetResponseCloudschedulerV1beta1.fromMap(
      ...
      pubsubTarget: PubsubTargetResponseCloudschedulerV1beta1.fromMap(
          (map['pubsubTarget'] as Map).cast<String, dynamic>()),
      retryConfig: RetryConfigResponseCloudschedulerV1beta1.fromMap(
          (map['retryConfig'] as Map).cast<String, dynamic>()),
      schedule: map['schedule'] as String,
      scheduleTime: map['scheduleTime'] as String,
      state: map['state'] as String,
      status: StatusResponseCloudschedulerV1beta1.fromMap(
