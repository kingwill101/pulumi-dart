...
class Job4 extends CustomResource {
  ...
  late final Output<AppEngineHttpTargetResponse2> appEngineHttpTarget;
  ...
  /// HTTP target.
  late final Output<HttpTargetResponse2> httpTarget;
  ...
  late final Output<bool> legacyAppEngineCron;
  ...
  /// Pub/Sub target.
  late final Output<PubsubTargetResponse2> pubsubTarget;

  /// Settings that determine the retry behavior.
  late final Output<RetryConfigResponse2> retryConfig;
  ...
  late final Output<StatusResponse6> status;
