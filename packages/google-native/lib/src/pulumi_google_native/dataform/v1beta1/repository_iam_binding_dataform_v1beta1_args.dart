...
class RepositoryIamBindingDataformV1beta1Args {
  ...
  RepositoryIamBindingDataformV1beta1Args({
    this.condition,
  ...
  factory RepositoryIamBindingDataformV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return RepositoryIamBindingDataformV1beta1Args(
