...
class GetRepositoryDataformV1beta1Result {
  ...
  GetRepositoryDataformV1beta1Result({
  ...
  factory GetRepositoryDataformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetRepositoryDataformV1beta1Result(
