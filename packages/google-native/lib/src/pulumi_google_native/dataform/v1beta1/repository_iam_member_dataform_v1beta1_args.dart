...
class RepositoryIamMemberDataformV1beta1Args {
  ...
  RepositoryIamMemberDataformV1beta1Args({
    this.condition,
  ...
  factory RepositoryIamMemberDataformV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return RepositoryIamMemberDataformV1beta1Args(
