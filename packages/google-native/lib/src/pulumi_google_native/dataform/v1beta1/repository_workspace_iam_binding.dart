...
import 'repository_workspace_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class RepositoryWorkspaceIamBinding extends pulumi.CustomResource {
  ...
  RepositoryWorkspaceIamBinding(
    String name, {
    RepositoryWorkspaceIamBindingArgs? args,
