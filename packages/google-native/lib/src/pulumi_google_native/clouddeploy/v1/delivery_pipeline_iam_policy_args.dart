...
class DeliveryPipelineIamPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = Input.mapOptionalInputValue<List<AuditConfig11>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => Input.encodeList<AuditConfig11, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = Input.mapOptionalInputValue<List<Binding17>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => Input.encodeList<Binding17, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
  ...
  factory DeliveryPipelineIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DeliveryPipelineIamPolicyArgs(
      auditConfigs:
          Input.asOptionalInput<List<AuditConfig11>>(map['auditConfigs']),
      bindings: Input.asOptionalInput<List<Binding17>>(map['bindings']),
