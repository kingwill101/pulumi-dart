...
class TargetArgs {
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      anthosCluster:
          pulumi.Input.asOptionalInput<AnthosCluster>(map['anthosCluster']),
      ...
      gke: pulumi.Input.asOptionalInput<GkeCluster>(map['gke']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      multiTarget:
          pulumi.Input.asOptionalInput<MultiTarget>(map['multiTarget']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      requestId: pulumi.Input.asOptionalInput<String>(map['requestId']),
      requireApproval:
          pulumi.Input.asOptionalInput<bool>(map['requireApproval']),
      run: pulumi.Input.asOptionalInput<CloudRunLocation>(map['run']),
