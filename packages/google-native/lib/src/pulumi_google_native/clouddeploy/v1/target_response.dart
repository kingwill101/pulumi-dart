...
class TargetResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['anthosCluster'] = anthosCluster.toMap();
    ...
    map['gke'] = gke.toMap();
    map['labels'] = labels;
    map['multiTarget'] = multiTarget.toMap();
    map['name'] = name;
    map['requireApproval'] = requireApproval;
    map['run'] = run.toMap();
  ...
  factory TargetResponse.fromMap(Map<String, dynamic> map) {
    return TargetResponse(
      ...
      anthosCluster: AnthosClusterResponse.fromMap(
