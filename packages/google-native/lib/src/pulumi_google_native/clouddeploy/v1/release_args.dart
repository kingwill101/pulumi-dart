...
class ReleaseArgs {
  ...
  factory ReleaseArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseArgs(
      ...
      skaffoldConfigPath:
          pulumi.Input.asOptionalInput<String>(map['skaffoldConfigPath']),
      skaffoldConfigUri:
          pulumi.Input.asOptionalInput<String>(map['skaffoldConfigUri']),
      skaffoldVersion:
          pulumi.Input.asOptionalInput<String>(map['skaffoldVersion']),
    );
  }
}
