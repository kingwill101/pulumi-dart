...
class AuditLogConfig11 {
  ...
  factory AuditLogConfig11.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig11(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType11.fromValue(map['logType'] as String),
    );
  }
}
