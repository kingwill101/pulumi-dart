...
class Version13 extends CustomResource {
  ...
  late final Output<GoogleCloudMlV1AcceleratorConfigResponse> acceleratorConfig;

  /// Automatically scale the number of nodes used to serve the model in response to increases and decreases in traffic. Care should be taken to ramp up traffic according to the model's ability to scale or you will start seeing increases in latency and 429 response codes.
  late final Output<GoogleCloudMlV1AutoScalingResponse> autoScaling;

  /// Optional. Specifies a custom container to use for serving predictions. If you specify this field, then `machineType` is required. If you specify this field, then `deploymentUri` is optional. If you specify this field, then you must not specify `runtimeVersion`, `packageUris`, `framework`, `pythonVersion`, or `predictionClass`.
  late final Output<GoogleCloudMlV1ContainerSpecResponse> container;
  ...
  late final Output<String> deploymentUri;
  ...
  late final Output<GoogleCloudMlV1ExplanationConfigResponse> explanationConfig;
  ...
  late final Output<String> lastMigrationModelId;
  ...
  late final Output<String> lastMigrationTime;

  /// The time the version was last used for prediction.
  late final Output<String> lastUseTime;
  ...
  late final Output<GoogleCloudMlV1ManualScalingResponse> manualScaling;
  ...
  late final Output<List<String>> packageUris;
  ...
  late final Output<GoogleCloudMlV1RequestLoggingConfigResponse>
  ...
  late final Output<GoogleCloudMlV1RouteMapResponse> routes;
