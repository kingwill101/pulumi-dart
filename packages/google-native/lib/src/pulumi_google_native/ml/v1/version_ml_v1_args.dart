...
class VersionMlV1Args {
  ...
  factory VersionMlV1Args.fromMap(Map<String, dynamic> map) {
    return VersionMlV1Args(
      acceleratorConfig:
      ...
      container: pulumi.Input.asOptionalInput<GoogleCloudMlV1ContainerSpec>(
          map['container']),
      deploymentUri: pulumi.Input.asOptionalInput<String>(map['deploymentUri']),
      ...
      framework:
          pulumi.Input.asOptionalInput<VersionFramework>(map['framework']),
      labels: pulumi.Input.asOptionalInput<Map<String, String>>(map['labels']),
      machineType: pulumi.Input.asOptionalInput<String>(map['machineType']),
      manualScaling: pulumi.Input.asOptionalInput<GoogleCloudMlV1ManualScaling>(
          map['manualScaling']),
      modelId: pulumi.Input.asInput<String>(map['modelId']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      packageUris:
          pulumi.Input.asOptionalInput<List<String>>(map['packageUris']),
      predictionClass:
          pulumi.Input.asOptionalInput<String>(map['predictionClass']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      pythonVersion: pulumi.Input.asInput<String>(map['pythonVersion']),
      requestLoggingConfig:
          pulumi.Input.asOptionalInput<GoogleCloudMlV1RequestLoggingConfig>(
              map['requestLoggingConfig']),
      routes:
          pulumi.Input.asOptionalInput<GoogleCloudMlV1RouteMap>(map['routes']),
