...
class GetModelResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['defaultVersion'] = defaultVersion.toMap();
    map['description'] = description;
    map['etag'] = etag;
    map['labels'] = labels;
    map['name'] = name;
    map['onlinePredictionConsoleLogging'] = onlinePredictionConsoleLogging;
    map['onlinePredictionLogging'] = onlinePredictionLogging;
    map['regions'] = regions;
    return map;
  }

  factory GetModelResult2.fromMap(Map<String, dynamic> map) {
    return GetModelResult2(
