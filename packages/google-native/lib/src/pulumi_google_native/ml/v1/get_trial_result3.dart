...
class GetTrialResult3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['measurements'] = Input.encodeList<GoogleCloudMlV1MeasurementResponse,
        Map<String, dynamic>>(measurements, (value) => value.toMap());
    map['name'] = name;
    map['parameters'] = Input.encodeList<GoogleCloudMlV1TrialParameterResponse,
  ...
  factory GetTrialResult3.fromMap(Map<String, dynamic> map) {
    return GetTrialResult3(
      ...
      measurements: Input.decodeList<GoogleCloudMlV1MeasurementResponse>(
          map['measurements'],
          (value) => GoogleCloudMlV1MeasurementResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      parameters: Input.decodeList<GoogleCloudMlV1TrialParameterResponse>(
          map['parameters'],
