...
class GoogleCloudMlV1TrainingInput {
  ...
  final GoogleCloudMlV1EncryptionConfig? encryptionConfig;
  ...
  final GoogleCloudMlV1ReplicaConfig? evaluatorConfig;
  ...
  final GoogleCloudMlV1HyperparameterSpec? hyperparameters;
  ...
  final GoogleCloudMlV1ReplicaConfig? masterConfig;
  ...
  final GoogleCloudMlV1ReplicaConfig? parameterServerConfig;
  ...
  final GoogleCloudMlV1TrainingInputScaleTier scaleTier;

  /// Optional. Scheduling options for a training job.
  final GoogleCloudMlV1Scheduling? scheduling;
  ...
  final GoogleCloudMlV1ReplicaConfig? workerConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    final evaluatorConfigValue = evaluatorConfig;
    if (evaluatorConfigValue != null) {
      map['evaluatorConfig'] = evaluatorConfigValue.toMap();
    }
    final evaluatorCountValue = evaluatorCount;
    if (evaluatorCountValue != null) {
      map['evaluatorCount'] = evaluatorCountValue;
    }
    final evaluatorTypeValue = evaluatorType;
    if (evaluatorTypeValue != null) {
      map['evaluatorType'] = evaluatorTypeValue;
    }
    final hyperparametersValue = hyperparameters;
    if (hyperparametersValue != null) {
      map['hyperparameters'] = hyperparametersValue.toMap();
    }
    final jobDirValue = jobDir;
    if (jobDirValue != null) {
      map['jobDir'] = jobDirValue;
    }
    ...
    final parameterServerConfigValue = parameterServerConfig;
    if (parameterServerConfigValue != null) {
      map['parameterServerConfig'] = parameterServerConfigValue.toMap();
    }
    final parameterServerCountValue = parameterServerCount;
    if (parameterServerCountValue != null) {
      map['parameterServerCount'] = parameterServerCountValue;
    }
    final parameterServerTypeValue = parameterServerType;
    if (parameterServerTypeValue != null) {
      map['parameterServerType'] = parameterServerTypeValue;
    }
    ...
    final useChiefInTfConfigValue = useChiefInTfConfig;
    if (useChiefInTfConfigValue != null) {
      map['useChiefInTfConfig'] = useChiefInTfConfigValue;
    }
  ...
  factory GoogleCloudMlV1TrainingInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingInput(
      ...
      encryptionConfig: map['encryptionConfig'] == null
          ? null
          : GoogleCloudMlV1EncryptionConfig.fromMap(
              (map['encryptionConfig'] as Map).cast<String, dynamic>()),
      evaluatorConfig: map['evaluatorConfig'] == null
          ? null
          : GoogleCloudMlV1ReplicaConfig.fromMap(
              (map['evaluatorConfig'] as Map).cast<String, dynamic>()),
      evaluatorCount: map['evaluatorCount'] == null
          ? null
          : map['evaluatorCount'] as String,
      evaluatorType:
          map['evaluatorType'] == null ? null : map['evaluatorType'] as String,
      hyperparameters: map['hyperparameters'] == null
          ? null
          : GoogleCloudMlV1HyperparameterSpec.fromMap(
              (map['hyperparameters'] as Map).cast<String, dynamic>()),
      jobDir: map['jobDir'] == null ? null : map['jobDir'] as String,
      ...
      parameterServerConfig: map['parameterServerConfig'] == null
          ? null
          : GoogleCloudMlV1ReplicaConfig.fromMap(
              (map['parameterServerConfig'] as Map).cast<String, dynamic>()),
      parameterServerCount: map['parameterServerCount'] == null
          ? null
          : map['parameterServerCount'] as String,
      parameterServerType: map['parameterServerType'] == null
          ? null
          : map['parameterServerType'] as String,
      ...
      scaleTier: GoogleCloudMlV1TrainingInputScaleTier.fromValue(
          map['scaleTier'] as String),
      scheduling: map['scheduling'] == null
          ? null
          : GoogleCloudMlV1Scheduling.fromMap(
              (map['scheduling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null
          ? null
          : map['serviceAccount'] as String,
      useChiefInTfConfig: map['useChiefInTfConfig'] == null
          ? null
          : map['useChiefInTfConfig'] as bool,
      workerConfig: map['workerConfig'] == null
          ? null
          : GoogleCloudMlV1ReplicaConfig.fromMap(
              (map['workerConfig'] as Map).cast<String, dynamic>()),
      workerCount:
          map['workerCount'] == null ? null : map['workerCount'] as String,
      workerType:
