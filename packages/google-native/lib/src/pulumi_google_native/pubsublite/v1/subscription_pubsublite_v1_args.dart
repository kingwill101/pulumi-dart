...
class SubscriptionPubsubliteV1Args {
  ...
  factory SubscriptionPubsubliteV1Args.fromMap(Map<String, dynamic> map) {
    return SubscriptionPubsubliteV1Args(
      deliveryConfig:
          pulumi.Input.asOptionalInput<DeliveryConfig>(map['deliveryConfig']),
      exportConfig:
          pulumi.Input.asOptionalInput<ExportConfig>(map['exportConfig']),
      location: pulumi.Input.asOptionalInput<String>(map['location']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asOptionalInput<String>(map['project']),
      skipBacklog: pulumi.Input.asOptionalInput<bool>(map['skipBacklog']),
