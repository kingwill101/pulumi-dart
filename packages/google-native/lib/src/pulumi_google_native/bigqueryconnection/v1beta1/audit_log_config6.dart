...
class AuditLogConfig6 {
  ...
  factory AuditLogConfig6.fromMap(Map<String, dynamic> map) {
    return AuditLogConfig6(
      exemptedMembers: map['exemptedMembers'] == null
          ? null
          : (map['exemptedMembers'] as List).cast<String>(),
      logType: map['logType'] == null
          ? null
          : AuditLogConfigLogType6.fromValue(map['logType'] as String),
    );
  }
}
