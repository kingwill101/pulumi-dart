...
class ConnectionIamMemberBigqueryconnectionV1beta1Args {
  ...
  ConnectionIamMemberBigqueryconnectionV1beta1Args({
    this.condition,
  ...
  factory ConnectionIamMemberBigqueryconnectionV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return ConnectionIamMemberBigqueryconnectionV1beta1Args(
