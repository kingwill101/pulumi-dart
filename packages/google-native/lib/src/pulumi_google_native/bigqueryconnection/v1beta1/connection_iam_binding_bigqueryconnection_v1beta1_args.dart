...
class ConnectionIamBindingBigqueryconnectionV1beta1Args {
  ...
  ConnectionIamBindingBigqueryconnectionV1beta1Args({
    this.condition,
  ...
  factory ConnectionIamBindingBigqueryconnectionV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return ConnectionIamBindingBigqueryconnectionV1beta1Args(
