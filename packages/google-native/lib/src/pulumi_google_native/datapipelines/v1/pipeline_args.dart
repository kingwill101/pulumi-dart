...
class PipelineArgs {
  ...
  final Input<Map<String, String>>? pipelineSources;
  final Input<String>? project;

  /// Internal scheduling information for a pipeline. If this information is provided, periodic jobs will be created per the schedule. If not, users are responsible for creating jobs externally.
  final Input<GoogleCloudDatapipelinesV1ScheduleSpec>? scheduleInfo;

  /// Optional. A service account email to be used with the Cloud Scheduler job. If not specified, the default compute engine service account will be used.
  final Input<String>? schedulerServiceAccountEmail;
  ...
  final Input<PipelineState> state;

  /// The type of the pipeline. This field affects the scheduling of the pipeline and the type of metrics to show for the pipeline.
  final Input<PipelineType> type;

  /// Workload information for creating new jobs.
  final Input<GoogleCloudDatapipelinesV1Workload>? workload;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (scheduleInfoValue != null) {
      map['scheduleInfo'] = Input.mapOptionalInputValue<
    ...
    map['state'] = Input.mapInputValue<PipelineState, String>(
        state, (value) => value.value);
    map['type'] =
        Input.mapInputValue<PipelineType, String>(type, (value) => value.value);
    final workloadValue = workload;
    if (workloadValue != null) {
      map['workload'] = Input.mapOptionalInputValue<
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      ...
      pipelineSources:
          Input.asOptionalInput<Map<String, String>>(map['pipelineSources']),
      project: Input.asOptionalInput<String>(map['project']),
      scheduleInfo:
          Input.asOptionalInput<GoogleCloudDatapipelinesV1ScheduleSpec>(
              map['scheduleInfo']),
      schedulerServiceAccountEmail:
          Input.asOptionalInput<String>(map['schedulerServiceAccountEmail']),
      state: Input.asInput<PipelineState>(map['state']),
      type: Input.asInput<PipelineType>(map['type']),
      workload: Input.asOptionalInput<GoogleCloudDatapipelinesV1Workload>(
          map['workload']),
    );
  }
}
