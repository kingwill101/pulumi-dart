...
class GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['additionalExperiments'] = additionalExperiments;
    map['additionalUserLabels'] = additionalUserLabels;
    map['bypassTempDirValidation'] = bypassTempDirValidation;
    map['enableStreamingEngine'] = enableStreamingEngine;
    map['ipConfiguration'] = ipConfiguration;
    map['kmsKeyName'] = kmsKeyName;
    map['machineType'] = machineType;
    map['maxWorkers'] = maxWorkers;
    map['network'] = network;
    map['numWorkers'] = numWorkers;
    map['serviceAccountEmail'] = serviceAccountEmail;
    map['subnetwork'] = subnetwork;
    map['tempLocation'] = tempLocation;
  ...
  factory GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse.fromMap(
