...
class RRSetRoutingPolicyLoadBalancerTarget {
  ...
  factory RRSetRoutingPolicyLoadBalancerTarget.fromMap(
      Map<String, dynamic> map) {
    return RRSetRoutingPolicyLoadBalancerTarget(
      ipAddress: map['ipAddress'] == null ? null : map['ipAddress'] as String,
      ipProtocol: map['ipProtocol'] == null
          ? null
          : RRSetRoutingPolicyLoadBalancerTargetIpProtocol.fromValue(
              map['ipProtocol'] as String),
      kind: map['kind'] == null ? null : map['kind'] as String,
      loadBalancerType: map['loadBalancerType'] == null
          ? null
          : RRSetRoutingPolicyLoadBalancerTargetLoadBalancerType.fromValue(
