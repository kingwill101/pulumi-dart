...
class Change extends CustomResource {
  /// Which ResourceRecordSets to add?
  late final Output<List<ResourceRecordSetResponse>> additions;

  /// For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
  late final Output<String?> clientOperationId;

  /// Which ResourceRecordSets to remove? Must match existing data exactly.
  late final Output<List<ResourceRecordSetResponse>> deletions;
  ...
  Change(
    ...
    this.additions = Output.createUnknown<List<ResourceRecordSetResponse>>();
    this.clientOperationId = Output.createUnknown<String?>();
    this.deletions = Output.createUnknown<List<ResourceRecordSetResponse>>();
