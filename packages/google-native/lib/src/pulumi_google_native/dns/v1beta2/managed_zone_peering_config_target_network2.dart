...
class ManagedZonePeeringConfigTargetNetwork2 {
  ...
  ManagedZonePeeringConfigTargetNetwork2({
    this.deactivateTime,
    this.kind,
    this.networkUrl,
  });
  ...
  factory ManagedZonePeeringConfigTargetNetwork2.fromMap(
      Map<String, dynamic> map) {
    return ManagedZonePeeringConfigTargetNetwork2(
