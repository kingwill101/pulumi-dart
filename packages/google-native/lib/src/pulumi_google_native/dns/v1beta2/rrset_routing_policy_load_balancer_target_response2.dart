...
class RRSetRoutingPolicyLoadBalancerTargetResponse2 {
  ...
  factory RRSetRoutingPolicyLoadBalancerTargetResponse2.fromMap(
      Map<String, dynamic> map) {
    return RRSetRoutingPolicyLoadBalancerTargetResponse2(
