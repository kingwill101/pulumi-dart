...
import 'managed_zone_peering_config2.dart';
import 'managed_zone_private_visibility_config2.dart';
import 'managed_zone_reverse_lookup_config2.dart';
import 'managed_zone_service_directory_config2.dart';
import 'managed_zone_visibility2.dart';

/// The set of arguments for ManagedZone.
class ManagedZoneArgs3 {
  /// For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
  final Input<String>? clientOperationId;
  final Input<ManagedZoneCloudLoggingConfig2>? cloudLoggingConfig;
  ...
  final Input<ManagedZoneDnsSecConfig2>? dnssecConfig;

  /// The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field contains the set of destinations to forward to.
  final Input<ManagedZoneForwardingConfig2>? forwardingConfig;
  ...
  final Input<ManagedZonePeeringConfig2>? peeringConfig;

  /// For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
  final Input<ManagedZonePrivateVisibilityConfig2>? privateVisibilityConfig;
  final Input<String>? project;

  /// The presence of this field indicates that this is a managed reverse lookup zone and Cloud DNS resolves reverse lookup queries using automatically configured records for VPC resources. This only applies to networks listed under private_visibility_config.
  final Input<ManagedZoneReverseLookupConfig2>? reverseLookupConfig;

  /// This field links to the associated service directory namespace. Do not set this field for public zones or forwarding zones.
  final Input<ManagedZoneServiceDirectoryConfig2>? serviceDirectoryConfig;

  /// The zone's visibility: public zones are exposed to the Internet, while private zones are visible only to Virtual Private Cloud resources.
  final Input<ManagedZoneVisibility2>? visibility;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (cloudLoggingConfigValue != null) {
      map['cloudLoggingConfig'] = Input.mapOptionalInputValue<
              ManagedZoneCloudLoggingConfig2, Map<String, dynamic>>(
    ...
    if (dnssecConfigValue != null) {
      map['dnssecConfig'] = Input.mapOptionalInputValue<
    ...
    if (forwardingConfigValue != null) {
      map['forwardingConfig'] = Input.mapOptionalInputValue<
              ManagedZoneForwardingConfig2, Map<String, dynamic>>(
    ...
    if (privateVisibilityConfigValue != null) {
      map['privateVisibilityConfig'] = Input.mapOptionalInputValue<
              ManagedZonePrivateVisibilityConfig2, Map<String, dynamic>>(
    ...
    if (reverseLookupConfigValue != null) {
      map['reverseLookupConfig'] = Input.mapOptionalInputValue<
              ManagedZoneReverseLookupConfig2, Map<String, dynamic>>(
    ...
    if (serviceDirectoryConfigValue != null) {
      map['serviceDirectoryConfig'] = Input.mapOptionalInputValue<
              ManagedZoneServiceDirectoryConfig2, Map<String, dynamic>>(
          serviceDirectoryConfigValue, (value) => value.toMap());
    }
    final visibilityValue = visibility;
    if (visibilityValue != null) {
      map['visibility'] =
          Input.mapOptionalInputValue<ManagedZoneVisibility2, String>(
              visibilityValue, (value) => value.value);
    }
    return map;
  }

  factory ManagedZoneArgs3.fromMap(Map<String, dynamic> map) {
    return ManagedZoneArgs3(
      clientOperationId:
          Input.asOptionalInput<String>(map['clientOperationId']),
      cloudLoggingConfig: Input.asOptionalInput<ManagedZoneCloudLoggingConfig2>(
      ...
      dnssecConfig:
          Input.asOptionalInput<ManagedZoneDnsSecConfig2>(map['dnssecConfig']),
      forwardingConfig: Input.asOptionalInput<ManagedZoneForwardingConfig2>(
      ...
      peeringConfig: Input.asOptionalInput<ManagedZonePeeringConfig2>(
          map['peeringConfig']),
      privateVisibilityConfig:
          Input.asOptionalInput<ManagedZonePrivateVisibilityConfig2>(
              map['privateVisibilityConfig']),
      project: Input.asOptionalInput<String>(map['project']),
      reverseLookupConfig:
          Input.asOptionalInput<ManagedZoneReverseLookupConfig2>(
              map['reverseLookupConfig']),
      serviceDirectoryConfig:
          Input.asOptionalInput<ManagedZoneServiceDirectoryConfig2>(
              map['serviceDirectoryConfig']),
      visibility:
          Input.asOptionalInput<ManagedZoneVisibility2>(map['visibility']),
    );
  }
}
