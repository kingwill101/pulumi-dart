...
class RRSetRoutingPolicyWrrPolicyWrrPolicyItem2 {
  ...
  RRSetRoutingPolicyWrrPolicyWrrPolicyItem2({
  ...
  factory RRSetRoutingPolicyWrrPolicyWrrPolicyItem2.fromMap(
      Map<String, dynamic> map) {
    return RRSetRoutingPolicyWrrPolicyWrrPolicyItem2(
