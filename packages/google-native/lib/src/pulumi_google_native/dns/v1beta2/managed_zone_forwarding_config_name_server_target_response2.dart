...
class ManagedZoneForwardingConfigNameServerTargetResponse2 {
  ...
  factory ManagedZoneForwardingConfigNameServerTargetResponse2.fromMap(
      Map<String, dynamic> map) {
    return ManagedZoneForwardingConfigNameServerTargetResponse2(
