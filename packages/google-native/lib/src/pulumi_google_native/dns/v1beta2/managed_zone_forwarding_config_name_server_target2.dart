...
import 'managed_zone_forwarding_config_name_server_target_forwarding_path2.dart';

class ManagedZoneForwardingConfigNameServerTarget2 {
  /// Forwarding path for this NameServerTarget. If unset or set to DEFAULT, Cloud DNS makes forwarding decisions based on IP address ranges; that is, RFC1918 addresses go to the VPC network, non-RFC1918 addresses go to the internet. When set to PRIVATE, Cloud DNS always sends queries through the VPC network for this target.
  final ManagedZoneForwardingConfigNameServerTargetForwardingPath2?
      forwardingPath;
  ...
  factory ManagedZoneForwardingConfigNameServerTarget2.fromMap(
      Map<String, dynamic> map) {
    return ManagedZoneForwardingConfigNameServerTarget2(
      forwardingPath: map['forwardingPath'] == null
          ? null
          : ManagedZoneForwardingConfigNameServerTargetForwardingPath2
