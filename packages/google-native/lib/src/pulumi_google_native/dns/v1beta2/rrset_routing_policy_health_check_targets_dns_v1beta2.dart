...
class RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2 {
  final List<RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2>?
  ...
  factory RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2.fromMap(
    ...
    return RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2(
      internalLoadBalancers: map['internalLoadBalancers'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2.fromMap(
