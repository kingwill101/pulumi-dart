...
class GetResourceRecordSetResult2 {
  final String kind;
  ...
  final RRSetRoutingPolicyResponse2 routingPolicy;
  ...
  factory GetResourceRecordSetResult2.fromMap(Map<String, dynamic> map) {
    return GetResourceRecordSetResult2(
      kind: map['kind'] as String,
      name: map['name'] as String,
      routingPolicy: RRSetRoutingPolicyResponse2.fromMap(
