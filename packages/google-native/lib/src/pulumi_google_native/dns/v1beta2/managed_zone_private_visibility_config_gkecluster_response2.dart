...
class ManagedZonePrivateVisibilityConfigGKEClusterResponse2 {
  ...
  factory ManagedZonePrivateVisibilityConfigGKEClusterResponse2.fromMap(
      Map<String, dynamic> map) {
    return ManagedZonePrivateVisibilityConfigGKEClusterResponse2(
