...
class ResourceRecordSetResponse2 {
  final String kind;
  ...
  factory ResourceRecordSetResponse2.fromMap(Map<String, dynamic> map) {
    return ResourceRecordSetResponse2(
