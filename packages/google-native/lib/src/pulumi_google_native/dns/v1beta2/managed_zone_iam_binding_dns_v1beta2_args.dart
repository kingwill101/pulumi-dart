...
class ManagedZoneIamBindingDnsV1beta2Args {
  ...
  ManagedZoneIamBindingDnsV1beta2Args({
    this.condition,
  ...
  factory ManagedZoneIamBindingDnsV1beta2Args.fromMap(
      Map<String, dynamic> map) {
    return ManagedZoneIamBindingDnsV1beta2Args(
