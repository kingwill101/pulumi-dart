...
class ManagedZoneServiceDirectoryConfigNamespace2 {
  ...
  ManagedZoneServiceDirectoryConfigNamespace2({
    this.deletionTime,
    this.kind,
    this.namespaceUrl,
  });
  ...
  factory ManagedZoneServiceDirectoryConfigNamespace2.fromMap(
      Map<String, dynamic> map) {
    return ManagedZoneServiceDirectoryConfigNamespace2(
      deletionTime:
