...
class PolicyAlternativeNameServerConfigTargetNameServerResponse2 {
  ...
  factory PolicyAlternativeNameServerConfigTargetNameServerResponse2.fromMap(
      Map<String, dynamic> map) {
    return PolicyAlternativeNameServerConfigTargetNameServerResponse2(
