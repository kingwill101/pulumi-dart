...
class ManagedZonePrivateVisibilityConfigGKECluster2 {
  ...
  factory ManagedZonePrivateVisibilityConfigGKECluster2.fromMap(
      Map<String, dynamic> map) {
    return ManagedZonePrivateVisibilityConfigGKECluster2(
