...
class ManagedZonePrivateVisibilityConfigNetwork2 {
  final String? kind;
  ...
  factory ManagedZonePrivateVisibilityConfigNetwork2.fromMap(
      Map<String, dynamic> map) {
    return ManagedZonePrivateVisibilityConfigNetwork2(
