...
import 'managed_zone_args3.dart';
import 'managed_zone_cloud_logging_config_response2.dart';
import 'managed_zone_dns_sec_config_response2.dart';
import 'managed_zone_forwarding_config_response2.dart';
import 'managed_zone_peering_config_response2.dart';
import 'managed_zone_private_visibility_config_response2.dart';
import 'managed_zone_reverse_lookup_config_response2.dart';
import 'managed_zone_service_directory_config_response2.dart';

/// Creates a new ManagedZone.
class ManagedZone3 extends CustomResource {
  /// For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
  late final Output<String?> clientOperationId;
  late final Output<ManagedZoneCloudLoggingConfigResponse2> cloudLoggingConfig;
  ...
  late final Output<ManagedZoneDnsSecConfigResponse2> dnssecConfig;

  /// The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field contains the set of destinations to forward to.
  late final Output<ManagedZoneForwardingConfigResponse2> forwardingConfig;
  ...
  late final Output<ManagedZonePeeringConfigResponse2> peeringConfig;

  /// For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
  late final Output<ManagedZonePrivateVisibilityConfigResponse2>
      privateVisibilityConfig;
  late final Output<String> project;

  /// The presence of this field indicates that this is a managed reverse lookup zone and Cloud DNS resolves reverse lookup queries using automatically configured records for VPC resources. This only applies to networks listed under private_visibility_config.
  late final Output<ManagedZoneReverseLookupConfigResponse2>
      reverseLookupConfig;

  /// This field links to the associated service directory namespace. Do not set this field for public zones or forwarding zones.
  late final Output<ManagedZoneServiceDirectoryConfigResponse2>
