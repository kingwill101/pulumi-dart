...
class GetReferenceImageResult {
  ...
  final List<BoundingPolyResponse2> boundingPolys;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['boundingPolys'] =
        Input.encodeList<BoundingPolyResponse2, Map<String, dynamic>>(
  ...
  factory GetReferenceImageResult.fromMap(Map<String, dynamic> map) {
    return GetReferenceImageResult(
      boundingPolys: Input.decodeList<BoundingPolyResponse2>(
          map['boundingPolys'],
          (value) => BoundingPolyResponse2.fromMap(
