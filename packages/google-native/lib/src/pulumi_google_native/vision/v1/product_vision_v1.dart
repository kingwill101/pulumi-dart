...
import 'product_vision_v1_args.dart';

/// Creates and returns a new product resource. Possible errors: * Returns INVALID_ARGUMENT if display_name is missing or longer than 4096 characters. * Returns INVALID_ARGUMENT if description is longer than 4096 characters. * Returns INVALID_ARGUMENT if product_category is missing or invalid.
class ProductVisionV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String> productCategory;
  ...
  late final pulumi.Output<List<KeyValueResponse>> productLabels;
  late final pulumi.Output<String> project;

  ProductVisionV1(
    String name, {
    ProductVisionV1Args? args,
