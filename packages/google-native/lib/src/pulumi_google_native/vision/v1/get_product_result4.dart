...
class GetProductResult4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['productLabels'] =
        Input.encodeList<KeyValueResponse, Map<String, dynamic>>(
            productLabels, (value) => value.toMap());
    return map;
  }

  factory GetProductResult4.fromMap(Map<String, dynamic> map) {
    return GetProductResult4(
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      name: map['name'] as String,
      productCategory: map['productCategory'] as String,
      productLabels: Input.decodeList<KeyValueResponse>(
          map['productLabels'],
          (value) =>
