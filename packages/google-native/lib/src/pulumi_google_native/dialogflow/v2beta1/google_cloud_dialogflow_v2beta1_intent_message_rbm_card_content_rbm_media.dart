...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (heightValue != null) {
      map['height'] = heightValue.value;
    }
    final thumbnailUriValue = thumbnailUri;
    if (thumbnailUriValue != null) {
      map['thumbnailUri'] = thumbnailUriValue;
    }
    return map;
  }
    ...
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia(
      ...
      height: map['height'] == null
          ...
          : GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaHeight
              .fromValue(map['height'] as String),
      thumbnailUri:
          map['thumbnailUri'] == null ? null : map['thumbnailUri'] as String,
    );
  }
}
