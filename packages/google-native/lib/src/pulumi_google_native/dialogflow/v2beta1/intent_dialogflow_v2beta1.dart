...
class IntentDialogflowV2beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<GoogleCloudDialogflowV2beta1IntentMessageResponse>> messages;
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowV2beta1ContextResponse>>
      outputContexts;

  /// Optional. The collection of parameters associated with the intent.
  late final pulumi
      .Output<List<GoogleCloudDialogflowV2beta1IntentParameterResponse>>
      parameters;
  ...
  late final pulumi
      .Output<List<GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse>>
      trainingPhrases;
  ...
  IntentDialogflowV2beta1(
    ...
    this.messages =
        registerOutput<List<GoogleCloudDialogflowV2beta1IntentMessageResponse>>(
            'messages');
    this.mlDisabled = registerOutput<bool>('mlDisabled');
    this.mlEnabled = registerOutput<bool>('mlEnabled');
    this.name = registerOutput<String>('name');
    this.outputContexts =
        registerOutput<List<GoogleCloudDialogflowV2beta1ContextResponse>>(
            'outputContexts');
