...
class ParticipantDialogflowV2beta1Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (roleValue != null) {
      map['role'] = pulumi.Input.mapOptionalInputValue<
          ParticipantRoleDialogflowV2beta1,
          String>(roleValue, (value) => value.value);
    }
    return map;
  }
  ...
  factory ParticipantDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return ParticipantDialogflowV2beta1Args(
      ...
      role: pulumi.Input.asOptionalInput<ParticipantRoleDialogflowV2beta1>(
          map['role']),
    );
  }
}
