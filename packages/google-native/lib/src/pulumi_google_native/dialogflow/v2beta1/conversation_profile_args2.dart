...
class ConversationProfileArgs2 {
  /// Configuration for an automated agent to use with this profile.
  final Input<GoogleCloudDialogflowV2beta1AutomatedAgentConfig>?
  ...
  final Input<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig>?
      humanAgentAssistantConfig;

  /// Configuration for connecting to a live agent. Currently, this feature is not general available, please contact Google to get access.
  final Input<GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig>?
  ...
  final Input<GoogleCloudDialogflowV2beta1LoggingConfig>? loggingConfig;

  /// The unique identifier of this conversation profile. Format: `projects//locations//conversationProfiles/`.
  final Input<String>? name;

  /// Configuration for publishing new message events. Event will be sent in format of ConversationEvent
  final Input<GoogleCloudDialogflowV2beta1NotificationConfig>?
  ...
  final Input<GoogleCloudDialogflowV2beta1SpeechToTextConfig>? sttConfig;
  ...
  final Input<GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig>? ttsConfig;

  ConversationProfileArgs2({
  ...
  factory ConversationProfileArgs2.fromMap(Map<String, dynamic> map) {
    return ConversationProfileArgs2(
      automatedAgentConfig: Input.asOptionalInput<
              GoogleCloudDialogflowV2beta1AutomatedAgentConfig>(
      ...
      humanAgentHandoffConfig: Input.asOptionalInput<
              GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig>(
          map['humanAgentHandoffConfig']),
      languageCode: Input.asOptionalInput<String>(map['languageCode']),
      location: Input.asOptionalInput<String>(map['location']),
      loggingConfig:
          Input.asOptionalInput<GoogleCloudDialogflowV2beta1LoggingConfig>(
              map['loggingConfig']),
      name: Input.asOptionalInput<String>(map['name']),
      newMessageEventNotificationConfig:
          Input.asOptionalInput<GoogleCloudDialogflowV2beta1NotificationConfig>(
      ...
      sttConfig:
          Input.asOptionalInput<GoogleCloudDialogflowV2beta1SpeechToTextConfig>(
              map['sttConfig']),
      timeZone: Input.asOptionalInput<String>(map['timeZone']),
      ttsConfig: Input.asOptionalInput<
