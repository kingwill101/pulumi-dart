...
class GoogleCloudDialogflowV2beta1IntentTrainingPhrase {
  ...
  final List<GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart> parts;

  /// Optional. Indicates how many times this example was added to the intent. Each time a developer adds an existing sample by editing an intent or training, this counter is increased.
  final int? timesAddedCount;

  /// The type of the training phrase.
  final GoogleCloudDialogflowV2beta1IntentTrainingPhraseType type;
  ...
  factory GoogleCloudDialogflowV2beta1IntentTrainingPhrase.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1IntentTrainingPhrase(
      ...
      type: GoogleCloudDialogflowV2beta1IntentTrainingPhraseType.fromValue(
          map['type'] as String),
    );
  }
}
