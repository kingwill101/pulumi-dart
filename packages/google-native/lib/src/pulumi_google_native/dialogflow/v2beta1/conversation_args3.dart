...
import 'conversation_conversation_stage2.dart';

/// The set of arguments for Conversation.
class ConversationArgs3 {
  ...
  final Input<ConversationConversationStage2>? conversationStage;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conversationStageValue != null) {
      map['conversationStage'] =
          Input.mapOptionalInputValue<ConversationConversationStage2, String>(
  ...
  factory ConversationArgs3.fromMap(Map<String, dynamic> map) {
    return ConversationArgs3(
      ...
      conversationStage: Input.asOptionalInput<ConversationConversationStage2>(
          map['conversationStage']),
