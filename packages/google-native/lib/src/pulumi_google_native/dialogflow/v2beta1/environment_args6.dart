...
class EnvironmentArgs6 {
  ...
  final Input<GoogleCloudDialogflowV2beta1Fulfillment>? fulfillment;
  final Input<String>? location;
  final Input<String>? project;

  /// Optional. Text to speech settings for this environment.
  final Input<GoogleCloudDialogflowV2beta1TextToSpeechSettings>?
  ...
  factory EnvironmentArgs6.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs6(
      agentVersion: Input.asOptionalInput<String>(map['agentVersion']),
      description: Input.asOptionalInput<String>(map['description']),
      environmentId: Input.asInput<String>(map['environmentId']),
      fulfillment:
          Input.asOptionalInput<GoogleCloudDialogflowV2beta1Fulfillment>(
              map['fulfillment']),
      location: Input.asOptionalInput<String>(map['location']),
      project: Input.asOptionalInput<String>(map['project']),
      textToSpeechSettings: Input.asOptionalInput<
              GoogleCloudDialogflowV2beta1TextToSpeechSettings>(
