...
class GetConversationProfileResult2 {
  ...
  factory GetConversationProfileResult2.fromMap(Map<String, dynamic> map) {
    return GetConversationProfileResult2(
      automatedAgentConfig:
