...
class GetIntentResult2 {
  ...
  factory GetIntentResult2.fromMap(Map<String, dynamic> map) {
    return GetIntentResult2(
      ...
      messages:
          Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageResponse>(
              map['messages'],
              (value) =>
      ...
      outputContexts:
          Input.decodeList<GoogleCloudDialogflowV2beta1ContextResponse>(
              map['outputContexts'],
              (value) => GoogleCloudDialogflowV2beta1ContextResponse.fromMap(
                  (value as Map).cast<String, dynamic>())),
      parameters:
          Input.decodeList<GoogleCloudDialogflowV2beta1IntentParameterResponse>(
              map['parameters'],
              (value) =>
