...
class PageDialogflowV3beta1Args {
  ...
  factory PageDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return PageDialogflowV3beta1Args(
      ...
      entryFulfillment: pulumi.Input.asOptionalInput<
          GoogleCloudDialogflowCxV3beta1Fulfillment>(map['entryFulfillment']),
      eventHandlers: pulumi.Input.asOptionalInput<
              List<GoogleCloudDialogflowCxV3beta1EventHandler>>(
          map['eventHandlers']),
      flowId: pulumi.Input.asInput<String>(map['flowId']),
      form: pulumi.Input.asOptionalInput<GoogleCloudDialogflowCxV3beta1Form>(
          map['form']),
