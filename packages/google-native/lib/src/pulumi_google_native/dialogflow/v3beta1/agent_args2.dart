...
class AgentArgs2 {
  ...
  final Input<GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettings>?
  ...
  final Input<GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettings>?
      genAppBuilderSettings;

  /// Git integration settings for this agent.
  final Input<GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettings>?
  ...
  final Input<GoogleCloudDialogflowCxV3beta1SpeechToTextSettings>?
  ...
  final Input<GoogleCloudDialogflowCxV3beta1TextToSpeechSettings>?
  ...
  factory AgentArgs2.fromMap(Map<String, dynamic> map) {
    return AgentArgs2(
      ...
      speechToTextSettings: Input.asOptionalInput<
              GoogleCloudDialogflowCxV3beta1SpeechToTextSettings>(
