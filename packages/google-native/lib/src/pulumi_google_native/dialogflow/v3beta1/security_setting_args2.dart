...
import 'security_setting_purge_data_types_item2.dart';
import 'security_setting_redaction_scope2.dart';
import 'security_setting_redaction_strategy2.dart';
import 'security_setting_retention_strategy2.dart';

/// The set of arguments for SecuritySetting.
class SecuritySettingArgs2 {
  ...
  final Input<List<SecuritySettingPurgeDataTypesItem2>>? purgeDataTypes;

  /// Defines the data for which Dialogflow applies redaction. Dialogflow does not redact data that it does not have access to – for example, Cloud logging.
  final Input<SecuritySettingRedactionScope2>? redactionScope;

  /// Strategy that defines how we do redaction.
  final Input<SecuritySettingRedactionStrategy2>? redactionStrategy;

  /// Specifies the retention behavior defined by SecuritySettings.RetentionStrategy.
  final Input<SecuritySettingRetentionStrategy2>? retentionStrategy;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (purgeDataTypesValue != null) {
      map['purgeDataTypes'] = Input.mapOptionalInputValue<
              List<SecuritySettingPurgeDataTypesItem2>, List<String>>(
          purgeDataTypesValue,
          (value) =>
              Input.encodeList<SecuritySettingPurgeDataTypesItem2, String>(
                  value, (value) => value.value));
    }
    final redactionScopeValue = redactionScope;
    if (redactionScopeValue != null) {
      map['redactionScope'] =
          Input.mapOptionalInputValue<SecuritySettingRedactionScope2, String>(
              redactionScopeValue, (value) => value.value);
    }
    final redactionStrategyValue = redactionStrategy;
    if (redactionStrategyValue != null) {
      map['redactionStrategy'] = Input.mapOptionalInputValue<
          SecuritySettingRedactionStrategy2,
    ...
    if (retentionStrategyValue != null) {
      map['retentionStrategy'] = Input.mapOptionalInputValue<
          SecuritySettingRetentionStrategy2,
  ...
  factory SecuritySettingArgs2.fromMap(Map<String, dynamic> map) {
    return SecuritySettingArgs2(
      ...
      purgeDataTypes:
          Input.asOptionalInput<List<SecuritySettingPurgeDataTypesItem2>>(
              map['purgeDataTypes']),
      redactionScope: Input.asOptionalInput<SecuritySettingRedactionScope2>(
          map['redactionScope']),
      redactionStrategy:
          Input.asOptionalInput<SecuritySettingRedactionStrategy2>(
              map['redactionStrategy']),
      retentionStrategy:
          Input.asOptionalInput<SecuritySettingRetentionStrategy2>(
