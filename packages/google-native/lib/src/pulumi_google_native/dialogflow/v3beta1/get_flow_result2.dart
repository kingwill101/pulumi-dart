...
class GetFlowResult2 {
  ...
  factory GetFlowResult2.fromMap(Map<String, dynamic> map) {
    return GetFlowResult2(
      advancedSettings:
      ...
      eventHandlers:
          Input.decodeList<GoogleCloudDialogflowCxV3beta1EventHandlerResponse>(
              map['eventHandlers'],
              (value) =>
