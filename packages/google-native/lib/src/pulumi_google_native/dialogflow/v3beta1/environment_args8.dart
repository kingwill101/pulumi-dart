...
class EnvironmentArgs8 {
  ...
  final Input<GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfig>?
      testCasesConfig;

  /// A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned.
  final Input<List<GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfig>>?
      versionConfigs;

  /// The webhook configuration for this environment.
  final Input<GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfig>?
      webhookConfig;
  ...
  factory EnvironmentArgs8.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs8(
