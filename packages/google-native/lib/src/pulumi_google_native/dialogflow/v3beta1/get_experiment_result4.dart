...
class GetExperimentResult4 {
  ...
  factory GetExperimentResult4.fromMap(Map<String, dynamic> map) {
    return GetExperimentResult4(
      ...
      variantsHistory: Input.decodeList<
              GoogleCloudDialogflowCxV3beta1VariantsHistoryResponse>(
          map['variantsHistory'],
          (value) =>
