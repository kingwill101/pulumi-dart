...
class GetSecuritySettingResult2 {
  ...
  factory GetSecuritySettingResult2.fromMap(Map<String, dynamic> map) {
    return GetSecuritySettingResult2(
      audioExportSettings:
