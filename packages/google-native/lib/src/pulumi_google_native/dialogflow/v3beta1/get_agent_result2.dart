...
class GetAgentResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['answerFeedbackSettings'] = answerFeedbackSettings.toMap();
    map['avatarUri'] = avatarUri;
    map['defaultLanguageCode'] = defaultLanguageCode;
    map['description'] = description;
    map['displayName'] = displayName;
    map['enableSpellCorrection'] = enableSpellCorrection;
    map['enableStackdriverLogging'] = enableStackdriverLogging;
    map['genAppBuilderSettings'] = genAppBuilderSettings.toMap();
    map['gitIntegrationSettings'] = gitIntegrationSettings.toMap();
    map['locked'] = locked;
    map['name'] = name;
    map['securitySettings'] = securitySettings;
    map['speechToTextSettings'] = speechToTextSettings.toMap();
    map['startFlow'] = startFlow;
    map['supportedLanguageCodes'] = supportedLanguageCodes;
    map['textToSpeechSettings'] = textToSpeechSettings.toMap();
    map['timeZone'] = timeZone;
    return map;
  }

  factory GetAgentResult2.fromMap(Map<String, dynamic> map) {
    return GetAgentResult2(
      advancedSettings:
      ...
      answerFeedbackSettings:
          GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettingsResponse
              .fromMap((map['answerFeedbackSettings'] as Map)
                  .cast<String, dynamic>()),
      ...
      genAppBuilderSettings:
          GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettingsResponse
              .fromMap((map['genAppBuilderSettings'] as Map)
                  .cast<String, dynamic>()),
      gitIntegrationSettings:
          GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettingsResponse
              .fromMap((map['gitIntegrationSettings'] as Map)
                  .cast<String, dynamic>()),
