...
class GetConversationDialogflowV2Result {
  ...
  GetConversationDialogflowV2Result({
  ...
  factory GetConversationDialogflowV2Result.fromMap(Map<String, dynamic> map) {
    return GetConversationDialogflowV2Result(
      ...
      phoneNumber:
          GoogleCloudDialogflowV2ConversationPhoneNumberResponse.fromMap(
