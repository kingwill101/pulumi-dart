...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigResponse {
  ...
  final GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse
  ...
  final GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfigResponse
  ...
  Map<String, dynamic> toMap() {
    ...
    map['endUserSuggestionConfig'] = endUserSuggestionConfig.toMap();
    map['humanAgentSuggestionConfig'] = humanAgentSuggestionConfig.toMap();
    map['messageAnalysisConfig'] = messageAnalysisConfig.toMap();
