...
class DocumentArgs2 {
  ...
  final Input<List<DocumentKnowledgeTypesItem>> knowledgeTypes;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['knowledgeTypes'] =
        Input.mapInputValue<List<DocumentKnowledgeTypesItem>, List<String>>(
            knowledgeTypes,
            (value) => Input.encodeList<DocumentKnowledgeTypesItem, String>(
  ...
  factory DocumentArgs2.fromMap(Map<String, dynamic> map) {
    return DocumentArgs2(
      ...
      knowledgeTypes: Input.asInput<List<DocumentKnowledgeTypesItem>>(
          map['knowledgeTypes']),
