...
class ParticipantArgs {
  ...
  final Input<ParticipantRole>? role;

  /// Optional. Label applied to streams representing this participant in SIPREC XML metadata and SDP. This is used to assign transcriptions from that media stream to this participant. This field can be updated.
  final Input<String>? sipRecordingMediaLabel;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (roleValue != null) {
      map['role'] = Input.mapOptionalInputValue<ParticipantRole, String>(
  ...
  factory ParticipantArgs.fromMap(Map<String, dynamic> map) {
    return ParticipantArgs(
      ...
      role: Input.asOptionalInput<ParticipantRole>(map['role']),
      sipRecordingMediaLabel:
          Input.asOptionalInput<String>(map['sipRecordingMediaLabel']),
    );
  }
}
