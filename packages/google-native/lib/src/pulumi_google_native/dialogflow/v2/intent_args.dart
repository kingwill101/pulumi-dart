...
class IntentArgs {
  ...
  final Input<List<IntentDefaultResponsePlatformsItem>>?
  ...
  final Input<List<GoogleCloudDialogflowV2IntentMessage>>? messages;
  ...
  final Input<List<GoogleCloudDialogflowV2Context>>? outputContexts;

  /// Optional. The collection of parameters associated with the intent.
  final Input<List<GoogleCloudDialogflowV2IntentParameter>>? parameters;
  ...
  final Input<List<GoogleCloudDialogflowV2IntentTrainingPhrase>>?
      trainingPhrases;

  /// Optional. Indicates whether webhooks are enabled for the intent.
  final Input<IntentWebhookState>? webhookState;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (defaultResponsePlatformsValue != null) {
      map['defaultResponsePlatforms'] = Input.mapOptionalInputValue<
          ...
          (value) =>
              Input.encodeList<IntentDefaultResponsePlatformsItem, String>(
    ...
    if (messagesValue != null) {
      map['messages'] = Input.mapOptionalInputValue<
          ...
          messagesValue,
          (value) => Input.encodeList<GoogleCloudDialogflowV2IntentMessage,
    ...
    if (outputContextsValue != null) {
      map['outputContexts'] = Input.mapOptionalInputValue<
          ...
          outputContextsValue,
          (value) => Input.encodeList<GoogleCloudDialogflowV2Context,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (parametersValue != null) {
      map['parameters'] = Input.mapOptionalInputValue<
              ...
              List<Map<String, dynamic>>>(
          parametersValue,
          (value) => Input.encodeList<GoogleCloudDialogflowV2IntentParameter,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (webhookStateValue != null) {
      map['webhookState'] =
          Input.mapOptionalInputValue<IntentWebhookState, String>(
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      ...
      defaultResponsePlatforms:
          Input.asOptionalInput<List<IntentDefaultResponsePlatformsItem>>(
      ...
      messages:
          Input.asOptionalInput<List<GoogleCloudDialogflowV2IntentMessage>>(
              map['messages']),
      mlDisabled: Input.asOptionalInput<bool>(map['mlDisabled']),
      name: Input.asOptionalInput<String>(map['name']),
      outputContexts:
          Input.asOptionalInput<List<GoogleCloudDialogflowV2Context>>(
              map['outputContexts']),
      parameters:
          Input.asOptionalInput<List<GoogleCloudDialogflowV2IntentParameter>>(
              map['parameters']),
      ...
      trainingPhrases: Input.asOptionalInput<
          ...
          map['trainingPhrases']),
      webhookState:
          Input.asOptionalInput<IntentWebhookState>(map['webhookState']),
    );
  }
}
