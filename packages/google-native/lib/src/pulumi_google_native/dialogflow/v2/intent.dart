...
class Intent extends CustomResource {
  ...
  late final Output<List<GoogleCloudDialogflowV2IntentMessageResponse>>
      messages;
  ...
  late final Output<List<GoogleCloudDialogflowV2ContextResponse>>
      outputContexts;

  /// Optional. The collection of parameters associated with the intent.
  late final Output<List<GoogleCloudDialogflowV2IntentParameterResponse>>
      parameters;
  ...
  late final Output<List<GoogleCloudDialogflowV2IntentTrainingPhraseResponse>>
      trainingPhrases;
