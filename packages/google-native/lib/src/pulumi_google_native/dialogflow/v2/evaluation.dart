...
class Evaluation extends CustomResource {
  late final Output<String> conversationModelId;
  ...
  late final Output<GoogleCloudDialogflowV2EvaluationConfigResponse>
      evaluationConfig;
  ...
  late final Output<String> rawHumanEvalTemplateCsv;

  /// Only available when model is for smart reply.
  late final Output<GoogleCloudDialogflowV2SmartReplyMetricsResponse>
      smartReplyMetrics;
