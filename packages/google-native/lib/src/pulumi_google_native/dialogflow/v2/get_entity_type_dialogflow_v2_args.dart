...
class GetEntityTypeDialogflowV2Args {
  final pulumi.Input<String> entityTypeId;
  final pulumi.Input<String>? languageCode;
  final pulumi.Input<String> location;
  final pulumi.Input<String>? project;

  GetEntityTypeDialogflowV2Args({
  ...
  factory GetEntityTypeDialogflowV2Args.fromMap(Map<String, dynamic> map) {
    return GetEntityTypeDialogflowV2Args(
