...
class GetDocumentDialogflowV2Result {
  ...
  factory GetDocumentDialogflowV2Result.fromMap(Map<String, dynamic> map) {
    return GetDocumentDialogflowV2Result(
