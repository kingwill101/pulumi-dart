...
class ContextDialogflowV2Args {
  ...
  factory ContextDialogflowV2Args.fromMap(Map<String, dynamic> map) {
    return ContextDialogflowV2Args(
      environmentId: pulumi.Input.asInput<String>(map['environmentId']),
      lifespanCount: pulumi.Input.asOptionalInput<int>(map['lifespanCount']),
