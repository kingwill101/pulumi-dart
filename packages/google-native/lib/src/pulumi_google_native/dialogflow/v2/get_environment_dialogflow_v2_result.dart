...
class GetEnvironmentDialogflowV2Result {
  ...
  GetEnvironmentDialogflowV2Result({
  ...
  factory GetEnvironmentDialogflowV2Result.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentDialogflowV2Result(
