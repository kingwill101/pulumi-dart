...
import 'entity_type_dialogflow_v2_args.dart';
...
class EntityTypeDialogflowV2 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<GoogleCloudDialogflowV2EntityTypeEntityResponse>> entities;
  ...
  EntityTypeDialogflowV2(
    String name, {
    EntityTypeDialogflowV2Args? args,
