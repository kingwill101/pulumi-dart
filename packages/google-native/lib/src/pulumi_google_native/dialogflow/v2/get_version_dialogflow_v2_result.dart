...
class GetVersionDialogflowV2Result {
  ...
  factory GetVersionDialogflowV2Result.fromMap(Map<String, dynamic> map) {
    return GetVersionDialogflowV2Result(
