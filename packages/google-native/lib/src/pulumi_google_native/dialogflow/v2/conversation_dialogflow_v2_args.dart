...
class ConversationDialogflowV2Args {
  ...
  factory ConversationDialogflowV2Args.fromMap(Map<String, dynamic> map) {
    return ConversationDialogflowV2Args(
      conversationId:
          pulumi.Input.asOptionalInput<String>(map['conversationId']),
      conversationProfile:
          pulumi.Input.asInput<String>(map['conversationProfile']),
      conversationStage:
