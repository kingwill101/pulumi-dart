...
class GetEntityTypeDialogflowV2Result {
  ...
  GetEntityTypeDialogflowV2Result({
  ...
  factory GetEntityTypeDialogflowV2Result.fromMap(Map<String, dynamic> map) {
    return GetEntityTypeDialogflowV2Result(
