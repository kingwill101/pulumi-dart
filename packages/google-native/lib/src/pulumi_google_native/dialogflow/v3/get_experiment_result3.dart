...
class GetExperimentResult3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['state'] = state;
    map['variantsHistory'] = Input.encodeList<
        GoogleCloudDialogflowCxV3VariantsHistoryResponse,
        Map<String, dynamic>>(variantsHistory, (value) => value.toMap());
    return map;
  }

  factory GetExperimentResult3.fromMap(Map<String, dynamic> map) {
    return GetExperimentResult3(
      ...
      variantsHistory:
          Input.decodeList<GoogleCloudDialogflowCxV3VariantsHistoryResponse>(
              map['variantsHistory'],
              (value) =>
                  GoogleCloudDialogflowCxV3VariantsHistoryResponse.fromMap(
