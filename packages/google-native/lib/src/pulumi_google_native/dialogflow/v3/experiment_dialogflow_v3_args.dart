...
class ExperimentDialogflowV3Args {
  ...
  factory ExperimentDialogflowV3Args.fromMap(Map<String, dynamic> map) {
    return ExperimentDialogflowV3Args(
      ...
      definition: pulumi.Input.asOptionalInput<
          GoogleCloudDialogflowCxV3ExperimentDefinition>(map['definition']),
      ...
      result: pulumi.Input.asOptionalInput<
          GoogleCloudDialogflowCxV3ExperimentResult>(map['result']),
      rolloutConfig:
      ...
      state: pulumi.Input.asOptionalInput<ExperimentState>(map['state']),
