...
class GetExperimentDialogflowV3Args {
  ...
  factory GetExperimentDialogflowV3Args.fromMap(Map<String, dynamic> map) {
    return GetExperimentDialogflowV3Args(
