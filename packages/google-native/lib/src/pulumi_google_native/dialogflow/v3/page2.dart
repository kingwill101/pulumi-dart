...
class Page2 extends CustomResource {
  ...
  late final Output<GoogleCloudDialogflowCxV3FulfillmentResponse>
      entryFulfillment;
  ...
  late final Output<GoogleCloudDialogflowCxV3FormResponse> form;
