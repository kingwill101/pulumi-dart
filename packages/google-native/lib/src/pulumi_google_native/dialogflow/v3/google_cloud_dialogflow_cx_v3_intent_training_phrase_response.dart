...
class GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse {
  ...
  final List<GoogleCloudDialogflowCxV3IntentTrainingPhrasePartResponse> parts;
  ...
  factory GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse(
      parts: pulumi.Input.decodeList<
          ...
          map['parts'],
          (value) =>
              GoogleCloudDialogflowCxV3IntentTrainingPhrasePartResponse.fromMap(
