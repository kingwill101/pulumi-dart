...
class GoogleCloudDialogflowCxV3BargeInConfig {
  ...
  final String? noBargeInDuration;
  ...
  Map<String, dynamic> toMap() {
    ...
    final noBargeInDurationValue = noBargeInDuration;
    if (noBargeInDurationValue != null) {
      map['noBargeInDuration'] = noBargeInDurationValue;
    }
    final totalDurationValue = totalDuration;
    if (totalDurationValue != null) {
      map['totalDuration'] = totalDurationValue;
    }
    return map;
  }

  factory GoogleCloudDialogflowCxV3BargeInConfig.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3BargeInConfig(
      noBargeInDuration: map['noBargeInDuration'] == null
          ? null
          : map['noBargeInDuration'] as String,
      totalDuration:
          map['totalDuration'] == null ? null : map['totalDuration'] as String,
    );
  }
}
