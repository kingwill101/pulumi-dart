...
import 'entity_type_auto_expansion_mode3.dart';
import 'entity_type_kind3.dart';
...
class EntityTypeArgs5 {
  final Input<String> agentId;

  /// Indicates whether the entity type can be automatically expanded.
  final Input<EntityTypeAutoExpansionMode3>? autoExpansionMode;
  ...
  final Input<List<GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase>>?
      excludedPhrases;

  /// Indicates the kind of entity type.
  final Input<EntityTypeKind3> kind;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoExpansionModeValue != null) {
      map['autoExpansionMode'] =
          Input.mapOptionalInputValue<EntityTypeAutoExpansionMode3, String>(
    ...
    map['kind'] = Input.mapInputValue<EntityTypeKind3, String>(
  ...
  factory EntityTypeArgs5.fromMap(Map<String, dynamic> map) {
    return EntityTypeArgs5(
      agentId: Input.asInput<String>(map['agentId']),
      autoExpansionMode: Input.asOptionalInput<EntityTypeAutoExpansionMode3>(
          map['autoExpansionMode']),
      ...
      excludedPhrases: Input.asOptionalInput<
              List<GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase>>(
          map['excludedPhrases']),
      kind: Input.asInput<EntityTypeKind3>(map['kind']),
