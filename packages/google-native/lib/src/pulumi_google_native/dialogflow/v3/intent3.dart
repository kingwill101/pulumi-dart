...
import 'intent_args3.dart';

/// Creates an intent in the specified agent. Note: You should always train a flow prior to sending it queries. See the [training documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).
class Intent3 extends CustomResource {
  ...
  late final Output<List<GoogleCloudDialogflowCxV3IntentParameterResponse>>
      parameters;
  ...
  late final Output<List<GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse>>
      trainingPhrases;
