...
class ExecutionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'argument': ?argument,
      'callLogLevel': ?pulumi.Input.mapOptionalInputValue<ExecutionCallLogLevel, String>(callLogLevel, (value) => value.value),
      'labels': ?labels,
      'location': ?location,
      'project': ?project,
  ...
  factory ExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ExecutionArgs(
      ...
      callLogLevel: map['callLogLevel'] == null ? null : ExecutionCallLogLevel.fromValue(map['callLogLevel'] as String),
