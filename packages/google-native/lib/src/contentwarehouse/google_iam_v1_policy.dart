...
class GoogleIamV1Policy {
  ...
  /// Creates a new [GoogleIamV1Policy].
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] =
          pulumi.Input.encodeList<GoogleIamV1AuditConfig, Map<String, dynamic>>(
  ...
  factory GoogleIamV1Policy.fromMap(Map<String, dynamic> map) {
