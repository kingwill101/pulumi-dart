...
class GoogleCloudDocumentaiV1DocumentRevision {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'humanReview': ?humanReview == null ? null : humanReview!.toMap(),
      'id': ?id,
      'parent': ?parent,
      'parentIds': ?parentIds,
      'processor': ?processor,
  ...
  factory GoogleCloudDocumentaiV1DocumentRevision.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentRevision(
      ...
      humanReview: map['humanReview'] == null ? null : GoogleCloudDocumentaiV1DocumentRevisionHumanReview.fromMap((map['humanReview'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      parent: map['parent'] == null ? null : (map['parent'] as List).cast<int>(),
