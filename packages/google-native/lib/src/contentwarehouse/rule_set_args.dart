...
class RuleSetArgs {
  ...
  RuleSetArgs({
    ...
    String? name,
    String? project,
    List<GoogleCloudContentwarehouseV1Rule>? rules,
    String? source,
  }) :
  ...
  factory RuleSetArgs.fromMap(Map<String, dynamic> map) {
    return RuleSetArgs(
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<GoogleCloudContentwarehouseV1Rule>(map['rules'], (value) => GoogleCloudContentwarehouseV1Rule.fromMap((value as Map).cast<String, dynamic>())),
