...
class GoogleCloudDocumentaiV1DocumentPageFormField {
  ...
  final List<GoogleCloudDocumentaiV1DocumentPageDetectedLanguage>? nameDetectedLanguages;
  /// The history of this annotation.
  final GoogleCloudDocumentaiV1DocumentProvenance? provenance;
  /// A list of detected languages for value together with confidence.
  final List<GoogleCloudDocumentaiV1DocumentPageDetectedLanguage>? valueDetectedLanguages;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nameDetectedLanguages': ?nameDetectedLanguages == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageDetectedLanguage, Map<String, dynamic>>(nameDetectedLanguages!, (value) => value.toMap()),
      'provenance': ?provenance == null ? null : provenance!.toMap(),
      'valueDetectedLanguages': ?valueDetectedLanguages == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageDetectedLanguage, Map<String, dynamic>>(valueDetectedLanguages!, (value) => value.toMap()),
      'valueType': ?valueType,
    };
  }
  ...
  factory GoogleCloudDocumentaiV1DocumentPageFormField.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageFormField(
      correctedKeyText: map['correctedKeyText'] == null ? null : map['correctedKeyText'] as String,
      correctedValueText: map['correctedValueText'] == null ? null : map['correctedValueText'] as String,
      fieldName: map['fieldName'] == null ? null : GoogleCloudDocumentaiV1DocumentPageLayout.fromMap((map['fieldName'] as Map).cast<String, dynamic>()),
      fieldValue: map['fieldValue'] == null ? null : GoogleCloudDocumentaiV1DocumentPageLayout.fromMap((map['fieldValue'] as Map).cast<String, dynamic>()),
      nameDetectedLanguages: map['nameDetectedLanguages'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageDetectedLanguage>(map['nameDetectedLanguages'], (value) => GoogleCloudDocumentaiV1DocumentPageDetectedLanguage.fromMap((value as Map).cast<String, dynamic>())),
      ...
      valueDetectedLanguages: map['valueDetectedLanguages'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageDetectedLanguage>(map['valueDetectedLanguages'], (value) => GoogleCloudDocumentaiV1DocumentPageDetectedLanguage.fromMap((value as Map).cast<String, dynamic>())),
