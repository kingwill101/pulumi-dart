...
class GoogleCloudContentwarehouseV1PropertyDefinition {
  ...
  final GoogleCloudContentwarehouseV1PropertyDefinitionRetrievalImportance? retrievalImportance;
  /// The mapping information between this property to another schema source.
  final List<GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSource>? schemaSources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'retrievalImportance': ?retrievalImportance == null ? null : retrievalImportance!.value,
      'schemaSources': ?schemaSources == null ? null : pulumi.Input.encodeList<GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSource, Map<String, dynamic>>(schemaSources!, (value) => value.toMap()),
  ...
  factory GoogleCloudContentwarehouseV1PropertyDefinition.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContentwarehouseV1PropertyDefinition(
      ...
      enumTypeOptions: map['enumTypeOptions'] == null ? null : GoogleCloudContentwarehouseV1EnumTypeOptions.fromMap((map['enumTypeOptions'] as Map).cast<String, dynamic>()),
      ...
      propertyTypeOptions: map['propertyTypeOptions'] == null ? null : GoogleCloudContentwarehouseV1PropertyTypeOptions.fromMap((map['propertyTypeOptions'] as Map).cast<String, dynamic>()),
      retrievalImportance: map['retrievalImportance'] == null ? null : GoogleCloudContentwarehouseV1PropertyDefinitionRetrievalImportance.fromValue(map['retrievalImportance'] as String),
      schemaSources: map['schemaSources'] == null ? null : pulumi.Input.decodeList<GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSource>(map['schemaSources'], (value) => GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSource.fromMap((value as Map).cast<String, dynamic>())),
