...
class GoogleCloudContentwarehouseV1PropertyDefinitionResponse {
  ...
  factory GoogleCloudContentwarehouseV1PropertyDefinitionResponse.fromMap(
    ...
    return GoogleCloudContentwarehouseV1PropertyDefinitionResponse(
      dateTimeTypeOptions: (map['dateTimeTypeOptions'] as Map)
          .cast<String, dynamic>(),
      ...
      floatTypeOptions: (map['floatTypeOptions'] as Map)
          .cast<String, dynamic>(),
      integerTypeOptions: (map['integerTypeOptions'] as Map)
          .cast<String, dynamic>(),
      ...
      timestampTypeOptions: (map['timestampTypeOptions'] as Map)
          .cast<String, dynamic>(),
    );
  }
}
