...
class GoogleCloudContentwarehouseV1RuleResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': pulumi.Input.encodeList<GoogleCloudContentwarehouseV1ActionResponse, Map<String, dynamic>>(actions, (value) => value.toMap()),
      'condition': condition,
  ...
  factory GoogleCloudContentwarehouseV1RuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContentwarehouseV1RuleResponse(
      actions: pulumi.Input.decodeList<GoogleCloudContentwarehouseV1ActionResponse>(map['actions'], (value) => GoogleCloudContentwarehouseV1ActionResponse.fromMap((value as Map).cast<String, dynamic>())),
