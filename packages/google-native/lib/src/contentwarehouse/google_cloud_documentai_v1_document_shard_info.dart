...
class GoogleCloudDocumentaiV1DocumentShardInfo {
  ...
  factory GoogleCloudDocumentaiV1DocumentShardInfo.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentShardInfo(
      shardCount: map['shardCount'] == null
          ? null
          : map['shardCount'] as String,
      shardIndex: map['shardIndex'] == null
          ? null
          : map['shardIndex'] as String,
      textOffset: map['textOffset'] == null
          ? null
          : map['textOffset'] as String,
    );
  }
}
