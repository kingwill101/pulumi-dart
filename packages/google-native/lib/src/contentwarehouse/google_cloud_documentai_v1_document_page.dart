...
class GoogleCloudDocumentaiV1DocumentPage {
  ...
  final List<GoogleCloudDocumentaiV1DocumentPageDetectedBarcode>? detectedBarcodes;
  ...
  final GoogleCloudDocumentaiV1DocumentPageImageQualityScores? imageQualityScores;
  /// Layout for the page.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blocks': ?blocks == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageBlock, Map<String, dynamic>>(blocks!, (value) => value.toMap()),
      'detectedBarcodes': ?detectedBarcodes == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageDetectedBarcode, Map<String, dynamic>>(detectedBarcodes!, (value) => value.toMap()),
      ...
      'formFields': ?formFields == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageFormField, Map<String, dynamic>>(formFields!, (value) => value.toMap()),
      'image': ?image == null ? null : image!.toMap(),
      'imageQualityScores': ?imageQualityScores == null ? null : imageQualityScores!.toMap(),
      'layout': ?layout == null ? null : layout!.toMap(),
      'lines': ?lines == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageLine, Map<String, dynamic>>(lines!, (value) => value.toMap()),
      'pageNumber': ?pageNumber,
      'paragraphs': ?paragraphs == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageParagraph, Map<String, dynamic>>(paragraphs!, (value) => value.toMap()),
      'provenance': ?provenance == null ? null : provenance!.toMap(),
      'symbols': ?symbols == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageSymbol, Map<String, dynamic>>(symbols!, (value) => value.toMap()),
      'tables': ?tables == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageTable, Map<String, dynamic>>(tables!, (value) => value.toMap()),
      'tokens': ?tokens == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageToken, Map<String, dynamic>>(tokens!, (value) => value.toMap()),
      'transforms': ?transforms == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageMatrix, Map<String, dynamic>>(transforms!, (value) => value.toMap()),
      'visualElements': ?visualElements == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageVisualElement, Map<String, dynamic>>(visualElements!, (value) => value.toMap()),
    };
  }

  factory GoogleCloudDocumentaiV1DocumentPage.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPage(
      blocks: map['blocks'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageBlock>(map['blocks'], (value) => GoogleCloudDocumentaiV1DocumentPageBlock.fromMap((value as Map).cast<String, dynamic>())),
      detectedBarcodes: map['detectedBarcodes'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageDetectedBarcode>(map['detectedBarcodes'], (value) => GoogleCloudDocumentaiV1DocumentPageDetectedBarcode.fromMap((value as Map).cast<String, dynamic>())),
      ...
      dimension: map['dimension'] == null ? null : GoogleCloudDocumentaiV1DocumentPageDimension.fromMap((map['dimension'] as Map).cast<String, dynamic>()),
      formFields: map['formFields'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageFormField>(map['formFields'], (value) => GoogleCloudDocumentaiV1DocumentPageFormField.fromMap((value as Map).cast<String, dynamic>())),
      image: map['image'] == null ? null : GoogleCloudDocumentaiV1DocumentPageImage.fromMap((map['image'] as Map).cast<String, dynamic>()),
      imageQualityScores: map['imageQualityScores'] == null ? null : GoogleCloudDocumentaiV1DocumentPageImageQualityScores.fromMap((map['imageQualityScores'] as Map).cast<String, dynamic>()),
      layout: map['layout'] == null ? null : GoogleCloudDocumentaiV1DocumentPageLayout.fromMap((map['layout'] as Map).cast<String, dynamic>()),
      lines: map['lines'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageLine>(map['lines'], (value) => GoogleCloudDocumentaiV1DocumentPageLine.fromMap((value as Map).cast<String, dynamic>())),
      pageNumber: map['pageNumber'] == null ? null : map['pageNumber'] as int,
      paragraphs: map['paragraphs'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageParagraph>(map['paragraphs'], (value) => GoogleCloudDocumentaiV1DocumentPageParagraph.fromMap((value as Map).cast<String, dynamic>())),
      ...
      symbols: map['symbols'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageSymbol>(map['symbols'], (value) => GoogleCloudDocumentaiV1DocumentPageSymbol.fromMap((value as Map).cast<String, dynamic>())),
      tables: map['tables'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTable>(map['tables'], (value) => GoogleCloudDocumentaiV1DocumentPageTable.fromMap((value as Map).cast<String, dynamic>())),
      tokens: map['tokens'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageToken>(map['tokens'], (value) => GoogleCloudDocumentaiV1DocumentPageToken.fromMap((value as Map).cast<String, dynamic>())),
      transforms: map['transforms'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageMatrix>(map['transforms'], (value) => GoogleCloudDocumentaiV1DocumentPageMatrix.fromMap((value as Map).cast<String, dynamic>())),
      visualElements: map['visualElements'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageVisualElement>(map['visualElements'], (value) => GoogleCloudDocumentaiV1DocumentPageVisualElement.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
