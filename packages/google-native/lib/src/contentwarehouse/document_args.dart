...
class DocumentArgs {
  ...
  DocumentArgs({
    ...
    String? updater,
       ...
       documentSchemaName = pulumi.Input.asOptionalInput<String>(
         documentSchemaName,
       ),
       inlineRawDocument = pulumi.Input.asOptionalInput<String>(
         inlineRawDocument,
       ),
       ...
       requestMetadata =
           ...
           >(requestMetadata),
       textExtractionDisabled = pulumi.Input.asOptionalInput<bool>(
         textExtractionDisabled,
       ),
       textExtractionEnabled = pulumi.Input.asOptionalInput<bool>(
    ...
    return <String, dynamic>{
      ...
      'rawDocumentFileType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(rawDocumentFileType, (value) => value.value),
  ...
  factory DocumentArgs.fromMap(Map<String, dynamic> map) {
    return DocumentArgs(
      ...
      createMask: map['createMask'] == null
          ? null
          : map['createMask'] as String,
      creator: map['creator'] == null ? null : map['creator'] as String,
      displayName: map['displayName'] as String,
      displayUri: map['displayUri'] == null
          ? null
          : map['displayUri'] as String,
