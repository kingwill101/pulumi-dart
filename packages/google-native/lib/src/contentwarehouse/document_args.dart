...
class DocumentArgs {
  ...
  factory DocumentArgs.fromMap(Map<String, dynamic> map) {
    return DocumentArgs(
      cloudAiDocument: map['cloudAiDocument'] == null ? null : GoogleCloudDocumentaiV1Document.fromMap((map['cloudAiDocument'] as Map).cast<String, dynamic>()),
      cloudAiDocumentOption: map['cloudAiDocumentOption'] == null ? null : GoogleCloudContentwarehouseV1CloudAIDocumentOption.fromMap((map['cloudAiDocumentOption'] as Map).cast<String, dynamic>()),
      contentCategory: map['contentCategory'] == null ? null : DocumentContentCategory.fromValue(map['contentCategory'] as String),
      createMask: map['createMask'] == null ? null : map['createMask'] as String,
      creator: map['creator'] == null ? null : map['creator'] as String,
      displayName: map['displayName'] as String,
      displayUri: map['displayUri'] == null ? null : map['displayUri'] as String,
      documentSchemaName: map['documentSchemaName'] == null ? null : map['documentSchemaName'] as String,
      inlineRawDocument: map['inlineRawDocument'] == null ? null : map['inlineRawDocument'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      plainText: map['plainText'] == null ? null : map['plainText'] as String,
      policy: map['policy'] == null ? null : GoogleIamV1Policy.fromMap((map['policy'] as Map).cast<String, dynamic>()),
      ...
      rawDocumentFileType: map['rawDocumentFileType'] == null ? null : DocumentRawDocumentFileType.fromValue(map['rawDocumentFileType'] as String),
      rawDocumentPath: map['rawDocumentPath'] == null ? null : map['rawDocumentPath'] as String,
      referenceId: map['referenceId'] == null ? null : map['referenceId'] as String,
      requestMetadata: map['requestMetadata'] == null ? null : GoogleCloudContentwarehouseV1RequestMetadata.fromMap((map['requestMetadata'] as Map).cast<String, dynamic>()),
      textExtractionDisabled: map['textExtractionDisabled'] == null ? null : map['textExtractionDisabled'] as bool,
      textExtractionEnabled: map['textExtractionEnabled'] == null ? null : map['textExtractionEnabled'] as bool,
