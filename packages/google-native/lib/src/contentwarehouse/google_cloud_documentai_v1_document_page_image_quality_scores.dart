    ...
    return <String, dynamic>{
      'detectedDefects': ?detectedDefects == null
          ...
          : pulumi.Input.encodeList<
              GoogleCloudDocumentaiV1DocumentPageImageQualityScoresDetectedDefect,
              Map<String, dynamic>
            >(detectedDefects!, (value) => value.toMap()),
      ...
      detectedDefects: map['detectedDefects'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['detectedDefects'],
              (value) =>
                  GoogleCloudDocumentaiV1DocumentPageImageQualityScoresDetectedDefect.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      qualityScore: map['qualityScore'] == null
          ? null
          : map['qualityScore'] as double,
    );
  }
}
