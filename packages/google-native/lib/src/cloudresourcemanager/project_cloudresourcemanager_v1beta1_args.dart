    ...
    return <String, dynamic>{
      ...
      'lifecycleState':
          ?pulumi.Input.mapOptionalInputValue<
            ProjectLifecycleStateCloudresourcemanagerV1beta1,
            String
          >(lifecycleState, (value) => value.value),
      'name': ?name,
      'parent':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ProjectCloudresourcemanagerV1beta1Args.fromMap(
    ...
    return ProjectCloudresourcemanagerV1beta1Args(
      ...
      lifecycleState: map['lifecycleState'] == null
          ? null
          : ProjectLifecycleStateCloudresourcemanagerV1beta1.fromValue(
              map['lifecycleState'] as String,
            ),
      name: map['name'] == null ? null : map['name'] as String,
      parent: map['parent'] == null
          ? null
          : ResourceIdCloudresourcemanagerV1beta1.fromMap(
      ...
      useLegacyStack: map['useLegacyStack'] == null
          ? null
          : map['useLegacyStack'] as bool,
    );
  }
}
