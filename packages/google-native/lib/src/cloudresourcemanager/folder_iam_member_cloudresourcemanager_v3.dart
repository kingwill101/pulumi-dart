...
import 'folder_iam_member_cloudresourcemanager_v3_args.dart';
...
class FolderIamMemberCloudresourcemanagerV3 extends pulumi.CustomResource {
  ...
  /// Creates a new [FolderIamMemberCloudresourcemanagerV3].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FolderIamMemberCloudresourcemanagerV3]. {@macro pulumi_cloudresourcemanager_v3_folder_iam_member_cloudresourcemanager_v3_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FolderIamMemberCloudresourcemanagerV3(
    String name, {
    FolderIamMemberCloudresourcemanagerV3Args? args,
