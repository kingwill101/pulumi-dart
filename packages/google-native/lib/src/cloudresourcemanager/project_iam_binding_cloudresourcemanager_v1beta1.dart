...
import 'project_iam_binding_cloudresourcemanager_v1beta1_args.dart';
...
class ProjectIamBindingCloudresourcemanagerV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [ProjectIamBindingCloudresourcemanagerV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProjectIamBindingCloudresourcemanagerV1beta1]. {@macro pulumi_cloudresourcemanager_v1beta1_project_iam_binding_cloudresourcemanager_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ProjectIamBindingCloudresourcemanagerV1beta1(
    String name, {
    ProjectIamBindingCloudresourcemanagerV1beta1Args? args,
