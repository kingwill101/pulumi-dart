...
/// {@template pulumi_cloudresourcemanager_v1_project_iam_binding_args_doc}
/// The set of arguments for ProjectIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1_project_iam_binding_args_doc}
class ProjectIamBindingArgs {
  ...
  /// Creates a new [ProjectIamBindingArgs].
  ...
  factory ProjectIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ProjectIamBindingArgs(
