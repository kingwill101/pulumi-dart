...
class ProjectArgs {
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      ...
      lifecycleState: map['lifecycleState'] == null ? null : ProjectLifecycleState.fromValue(map['lifecycleState'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      parent: map['parent'] == null ? null : ResourceId.fromMap((map['parent'] as Map).cast<String, dynamic>()),
