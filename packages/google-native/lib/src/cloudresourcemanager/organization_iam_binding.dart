...
import 'organization_iam_binding_args.dart';
...
class OrganizationIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationIamBinding]. {@macro pulumi_cloudresourcemanager_v1_organization_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  OrganizationIamBinding(
    String name, {
    OrganizationIamBindingArgs? args,
