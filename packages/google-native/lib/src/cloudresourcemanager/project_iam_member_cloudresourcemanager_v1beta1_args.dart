...
/// {@template pulumi_cloudresourcemanager_v1beta1_project_iam_member_cloudresourcemanager_v1beta1_args_doc}
/// The set of arguments for ProjectIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1beta1_project_iam_member_cloudresourcemanager_v1beta1_args_doc}
class ProjectIamMemberCloudresourcemanagerV1beta1Args {
  ...
  /// Creates a new [ProjectIamMemberCloudresourcemanagerV1beta1Args].
  ...
  ProjectIamMemberCloudresourcemanagerV1beta1Args({
    Condition? condition,
  ...
  factory ProjectIamMemberCloudresourcemanagerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ProjectIamMemberCloudresourcemanagerV1beta1Args(
