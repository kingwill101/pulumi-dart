...
class FolderIamPolicyCloudresourcemanagerV3Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
          ...
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigCloudresourcemanagerV3,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingCloudresourcemanagerV3>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingCloudresourcemanagerV3,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory FolderIamPolicyCloudresourcemanagerV3Args.fromMap(
