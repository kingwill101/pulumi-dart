...
/// {@template pulumi_cloudresourcemanager_v1_organization_iam_member_args_doc}
/// The set of arguments for OrganizationIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1_organization_iam_member_args_doc}
class OrganizationIamMemberArgs {
  ...
  /// Creates a new [OrganizationIamMemberArgs].
  ...
  factory OrganizationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationIamMemberArgs(
