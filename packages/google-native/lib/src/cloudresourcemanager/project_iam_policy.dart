...
import 'project_iam_policy_args.dart';
...
class ProjectIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ProjectIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProjectIamPolicy]. {@macro pulumi_cloudresourcemanager_v1_project_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ProjectIamPolicy(
    String name, {
    ProjectIamPolicyArgs? args,
