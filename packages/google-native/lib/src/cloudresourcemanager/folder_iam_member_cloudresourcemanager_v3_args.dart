...
/// {@template pulumi_cloudresourcemanager_v3_folder_iam_member_cloudresourcemanager_v3_args_doc}
/// The set of arguments for FolderIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v3_folder_iam_member_cloudresourcemanager_v3_args_doc}
class FolderIamMemberCloudresourcemanagerV3Args {
  ...
  /// Creates a new [FolderIamMemberCloudresourcemanagerV3Args].
  ...
  FolderIamMemberCloudresourcemanagerV3Args({
    Condition? condition,
  ...
  factory FolderIamMemberCloudresourcemanagerV3Args.fromMap(Map<String, dynamic> map) {
    return FolderIamMemberCloudresourcemanagerV3Args(
