...
/// {@template pulumi_cloudresourcemanager_v1beta1_organization_iam_binding_cloudresourcemanager_v1beta1_args_doc}
/// The set of arguments for OrganizationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1beta1_organization_iam_binding_cloudresourcemanager_v1beta1_args_doc}
class OrganizationIamBindingCloudresourcemanagerV1beta1Args {
  ...
  /// Creates a new [OrganizationIamBindingCloudresourcemanagerV1beta1Args].
  ...
  OrganizationIamBindingCloudresourcemanagerV1beta1Args({
    Condition? condition,
  ...
  factory OrganizationIamBindingCloudresourcemanagerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OrganizationIamBindingCloudresourcemanagerV1beta1Args(
