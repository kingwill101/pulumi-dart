...
/// {@template pulumi_cloudresourcemanager_v2beta1_folder_iam_member_cloudresourcemanager_v2beta1_args_doc}
/// The set of arguments for FolderIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v2beta1_folder_iam_member_cloudresourcemanager_v2beta1_args_doc}
class FolderIamMemberCloudresourcemanagerV2beta1Args {
  ...
  /// Creates a new [FolderIamMemberCloudresourcemanagerV2beta1Args].
  ...
  FolderIamMemberCloudresourcemanagerV2beta1Args({
    Condition? condition,
  ...
  factory FolderIamMemberCloudresourcemanagerV2beta1Args.fromMap(Map<String, dynamic> map) {
    return FolderIamMemberCloudresourcemanagerV2beta1Args(
