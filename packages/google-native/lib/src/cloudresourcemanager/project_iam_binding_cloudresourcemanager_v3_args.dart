...
/// {@template pulumi_cloudresourcemanager_v3_project_iam_binding_cloudresourcemanager_v3_args_doc}
/// The set of arguments for ProjectIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v3_project_iam_binding_cloudresourcemanager_v3_args_doc}
class ProjectIamBindingCloudresourcemanagerV3Args {
  ...
  /// Creates a new [ProjectIamBindingCloudresourcemanagerV3Args].
  ...
  ProjectIamBindingCloudresourcemanagerV3Args({
    Condition? condition,
  ...
  factory ProjectIamBindingCloudresourcemanagerV3Args.fromMap(Map<String, dynamic> map) {
    return ProjectIamBindingCloudresourcemanagerV3Args(
