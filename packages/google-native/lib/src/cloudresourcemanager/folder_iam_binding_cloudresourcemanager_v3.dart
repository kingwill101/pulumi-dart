...
import 'folder_iam_binding_cloudresourcemanager_v3_args.dart';
...
class FolderIamBindingCloudresourcemanagerV3 extends pulumi.CustomResource {
  ...
  /// Creates a new [FolderIamBindingCloudresourcemanagerV3].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FolderIamBindingCloudresourcemanagerV3]. {@macro pulumi_cloudresourcemanager_v3_folder_iam_binding_cloudresourcemanager_v3_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FolderIamBindingCloudresourcemanagerV3(
    String name, {
    FolderIamBindingCloudresourcemanagerV3Args? args,
