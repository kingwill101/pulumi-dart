...
class ExprResponseCloudresourcemanagerV1beta1 {
  ...
  /// Creates a new [ExprResponseCloudresourcemanagerV1beta1].
  ...
  ExprResponseCloudresourcemanagerV1beta1({
  ...
  factory ExprResponseCloudresourcemanagerV1beta1.fromMap(
      Map<String, dynamic> map) {
    return ExprResponseCloudresourcemanagerV1beta1(
