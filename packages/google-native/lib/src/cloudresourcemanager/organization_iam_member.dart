...
import 'organization_iam_member_args.dart';
...
class OrganizationIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationIamMember]. {@macro pulumi_cloudresourcemanager_v1_organization_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  OrganizationIamMember(
    String name, {
    OrganizationIamMemberArgs? args,
