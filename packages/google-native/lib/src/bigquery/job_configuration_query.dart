...
class JobConfigurationQuery {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'priority': ?priority,
      'query': ?query,
      'queryParameters': ?queryParameters == null ? null : pulumi.Input.encodeList<QueryParameter, Map<String, dynamic>>(queryParameters!, (value) => value.toMap()),
  ...
  factory JobConfigurationQuery.fromMap(Map<String, dynamic> map) {
    return JobConfigurationQuery(
      ...
      defaultDataset: map['defaultDataset'] == null ? null : DatasetReference.fromMap((map['defaultDataset'] as Map).cast<String, dynamic>()),
      ...
      preserveNulls: map['preserveNulls'] == null ? null : map['preserveNulls'] as bool,
      priority: map['priority'] == null ? null : map['priority'] as String,
      query: map['query'] == null ? null : map['query'] as String,
      queryParameters: map['queryParameters'] == null ? null : pulumi.Input.decodeList<QueryParameter>(map['queryParameters'], (value) => QueryParameter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tableDefinitions: map['tableDefinitions'] == null ? null : (map['tableDefinitions'] as Map).cast<String, String>(),
