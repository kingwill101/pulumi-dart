...
class JobStatistics2Response {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'biEngineStatistics': biEngineStatistics.toMap(),
      'billingTier': billingTier,
      'cacheHit': cacheHit,
      'ddlAffectedRowAccessPolicyCount': ddlAffectedRowAccessPolicyCount,
      'ddlDestinationTable': ddlDestinationTable.toMap(),
      'ddlOperationPerformed': ddlOperationPerformed,
      'ddlTargetDataset': ddlTargetDataset.toMap(),
      'ddlTargetRoutine': ddlTargetRoutine.toMap(),
      'ddlTargetRowAccessPolicy': ddlTargetRowAccessPolicy.toMap(),
      'ddlTargetTable': ddlTargetTable.toMap(),
      'dmlStats': dmlStats.toMap(),
      'estimatedBytesProcessed': estimatedBytesProcessed,
      'mlStatistics': mlStatistics.toMap(),
      'modelTraining': modelTraining.toMap(),
      ...
      'queryPlan': pulumi.Input.encodeList<ExplainQueryStageResponse, Map<String, dynamic>>(queryPlan, (value) => value.toMap()),
      'referencedRoutines': pulumi.Input.encodeList<RoutineReferenceResponse, Map<String, dynamic>>(referencedRoutines, (value) => value.toMap()),
      'referencedTables': pulumi.Input.encodeList<TableReferenceResponse, Map<String, dynamic>>(referencedTables, (value) => value.toMap()),
      'reservationUsage': pulumi.Input.encodeList<JobStatistics2ReservationUsageItemResponse, Map<String, dynamic>>(reservationUsage, (value) => value.toMap()),
      'schema': schema.toMap(),
      'searchStatistics': searchStatistics.toMap(),
      'sparkStatistics': sparkStatistics.toMap(),
      'statementType': statementType,
      'timeline': pulumi.Input.encodeList<QueryTimelineSampleResponse, Map<String, dynamic>>(timeline, (value) => value.toMap()),
      ...
      'undeclaredQueryParameters': pulumi.Input.encodeList<QueryParameterResponse, Map<String, dynamic>>(undeclaredQueryParameters, (value) => value.toMap()),
    };
  }

  factory JobStatistics2Response.fromMap(Map<String, dynamic> map) {
    return JobStatistics2Response(
      biEngineStatistics: BiEngineStatisticsResponse.fromMap((map['biEngineStatistics'] as Map).cast<String, dynamic>()),
      billingTier: map['billingTier'] as int,
      cacheHit: map['cacheHit'] as bool,
      ddlAffectedRowAccessPolicyCount: map['ddlAffectedRowAccessPolicyCount'] as String,
      ddlDestinationTable: TableReferenceResponse.fromMap((map['ddlDestinationTable'] as Map).cast<String, dynamic>()),
      ddlOperationPerformed: map['ddlOperationPerformed'] as String,
      ddlTargetDataset: DatasetReferenceResponse.fromMap((map['ddlTargetDataset'] as Map).cast<String, dynamic>()),
      ddlTargetRoutine: RoutineReferenceResponse.fromMap((map['ddlTargetRoutine'] as Map).cast<String, dynamic>()),
      ddlTargetRowAccessPolicy: RowAccessPolicyReferenceResponse.fromMap((map['ddlTargetRowAccessPolicy'] as Map).cast<String, dynamic>()),
      ddlTargetTable: TableReferenceResponse.fromMap((map['ddlTargetTable'] as Map).cast<String, dynamic>()),
      dmlStats: DmlStatisticsResponse.fromMap((map['dmlStats'] as Map).cast<String, dynamic>()),
      estimatedBytesProcessed: map['estimatedBytesProcessed'] as String,
      mlStatistics: MlStatisticsResponse.fromMap((map['mlStatistics'] as Map).cast<String, dynamic>()),
      modelTraining: BigQueryModelTrainingResponse.fromMap((map['modelTraining'] as Map).cast<String, dynamic>()),
      modelTrainingCurrentIteration: map['modelTrainingCurrentIteration'] as int,
      modelTrainingExpectedTotalIteration: map['modelTrainingExpectedTotalIteration'] as String,
      numDmlAffectedRows: map['numDmlAffectedRows'] as String,
      queryPlan: pulumi.Input.decodeList<ExplainQueryStageResponse>(map['queryPlan'], (value) => ExplainQueryStageResponse.fromMap((value as Map).cast<String, dynamic>())),
      referencedRoutines: pulumi.Input.decodeList<RoutineReferenceResponse>(map['referencedRoutines'], (value) => RoutineReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
      referencedTables: pulumi.Input.decodeList<TableReferenceResponse>(map['referencedTables'], (value) => TableReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
      reservationUsage: pulumi.Input.decodeList<JobStatistics2ReservationUsageItemResponse>(map['reservationUsage'], (value) => JobStatistics2ReservationUsageItemResponse.fromMap((value as Map).cast<String, dynamic>())),
      schema: TableSchemaResponse.fromMap((map['schema'] as Map).cast<String, dynamic>()),
      searchStatistics: SearchStatisticsResponse.fromMap((map['searchStatistics'] as Map).cast<String, dynamic>()),
      sparkStatistics: SparkStatisticsResponse.fromMap((map['sparkStatistics'] as Map).cast<String, dynamic>()),
      statementType: map['statementType'] as String,
      timeline: pulumi.Input.decodeList<QueryTimelineSampleResponse>(map['timeline'], (value) => QueryTimelineSampleResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      undeclaredQueryParameters: pulumi.Input.decodeList<QueryParameterResponse>(map['undeclaredQueryParameters'], (value) => QueryParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
