...
class DatasetArgs {
  ...
  DatasetArgs({
    ...
    List<DatasetTagsItem>? tags,
      ...
      datasetReference = pulumi.Input.asOptionalInput<DatasetReference>(datasetReference),
      defaultEncryptionConfiguration = pulumi.Input.asOptionalInput<EncryptionConfiguration>(defaultEncryptionConfiguration),
      defaultPartitionExpirationMs = pulumi.Input.asOptionalInput<String>(defaultPartitionExpirationMs),
      defaultTableExpirationMs = pulumi.Input.asOptionalInput<String>(defaultTableExpirationMs),
      description = pulumi.Input.asOptionalInput<String>(description),
      externalDatasetReference = pulumi.Input.asOptionalInput<ExternalDatasetReference>(externalDatasetReference),
  ...
  factory DatasetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetArgs(
      access: map['access'] == null ? null : pulumi.Input.decodeList<DatasetAccessItem>(map['access'], (value) => DatasetAccessItem.fromMap((value as Map).cast<String, dynamic>())),
      datasetReference: map['datasetReference'] == null ? null : DatasetReference.fromMap((map['datasetReference'] as Map).cast<String, dynamic>()),
      defaultEncryptionConfiguration: map['defaultEncryptionConfiguration'] == null ? null : EncryptionConfiguration.fromMap((map['defaultEncryptionConfiguration'] as Map).cast<String, dynamic>()),
      defaultPartitionExpirationMs: map['defaultPartitionExpirationMs'] == null ? null : map['defaultPartitionExpirationMs'] as String,
      defaultTableExpirationMs: map['defaultTableExpirationMs'] == null ? null : map['defaultTableExpirationMs'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      externalDatasetReference: map['externalDatasetReference'] == null ? null : ExternalDatasetReference.fromMap((map['externalDatasetReference'] as Map).cast<String, dynamic>()),
      ...
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<DatasetTagsItem>(map['tags'], (value) => DatasetTagsItem.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
