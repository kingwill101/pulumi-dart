...
class GetRoutineResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['determinismLevel'] = determinismLevel;
    map['etag'] = etag;
    map['importedLibraries'] = importedLibraries;
    map['language'] = language;
    map['lastModifiedTime'] = lastModifiedTime;
    map['remoteFunctionOptions'] = remoteFunctionOptions.toMap();
    map['returnTableType'] = returnTableType.toMap();
    map['returnType'] = returnType.toMap();
    map['routineReference'] = routineReference.toMap();
    map['routineType'] = routineType;
    map['securityMode'] = securityMode;
    map['sparkOptions'] = sparkOptions.toMap();
    map['strictMode'] = strictMode;
    return map;
  }
