...
class JobConfigurationTableCopyResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceTables': pulumi.Input.encodeList<TableReferenceResponse, Map<String, dynamic>>(sourceTables, (value) => value.toMap()),
  ...
  factory JobConfigurationTableCopyResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationTableCopyResponse(
      ...
      sourceTable: TableReferenceResponse.fromMap((map['sourceTable'] as Map).cast<String, dynamic>()),
      sourceTables: pulumi.Input.decodeList<TableReferenceResponse>(map['sourceTables'], (value) => TableReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
