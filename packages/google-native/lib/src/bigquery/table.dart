...
class Table extends pulumi.CustomResource {
  ...
  Table(String name, {TableArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.biglakeConfiguration = registerOutput<BigLakeConfigurationResponse>(
      'biglakeConfiguration',
    );
    this.cloneDefinition = registerOutput<CloneDefinitionResponse>(
      'cloneDefinition',
    );
    ...
    this.materializedView = registerOutput<MaterializedViewDefinitionResponse>(
      'materializedView',
    );
    this.maxStaleness = registerOutput<String>('maxStaleness');
    this.model = registerOutput<ModelDefinitionResponse>('model');
    this.numActiveLogicalBytes = registerOutput<String>(
      'numActiveLogicalBytes',
    );
    this.numActivePhysicalBytes = registerOutput<String>(
      'numActivePhysicalBytes',
    );
    this.numBytes = registerOutput<String>('numBytes');
    this.numLongTermBytes = registerOutput<String>('numLongTermBytes');
    this.numLongTermLogicalBytes = registerOutput<String>(
      'numLongTermLogicalBytes',
    );
    this.numLongTermPhysicalBytes = registerOutput<String>(
    ...
    this.numTimeTravelPhysicalBytes = registerOutput<String>(
      'numTimeTravelPhysicalBytes',
    );
    this.numTotalLogicalBytes = registerOutput<String>('numTotalLogicalBytes');
    this.numTotalPhysicalBytes = registerOutput<String>(
      'numTotalPhysicalBytes',
    );
    this.project = registerOutput<String>('project');
    this.rangePartitioning = registerOutput<RangePartitioningResponse>(
      'rangePartitioning',
    );
    this.requirePartitionFilter = registerOutput<bool>(
    ...
    this.snapshotDefinition = registerOutput<SnapshotDefinitionResponse>(
      'snapshotDefinition',
    );
    this.streamingBuffer = registerOutput<StreamingbufferResponse>(
      'streamingBuffer',
    );
    this.tableConstraints = registerOutput<TableConstraintsResponse>(
      'tableConstraints',
    );
    this.tableReference = registerOutput<TableReferenceResponse>(
      'tableReference',
    );
    this.timePartitioning = registerOutput<TimePartitioningResponse>(
      'timePartitioning',
    );
