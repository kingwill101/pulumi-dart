...
class ExternalDataConfigurationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'avroOptions': avroOptions.toMap(),
      'bigtableOptions': bigtableOptions.toMap(),
      'compression': compression,
      'connectionId': connectionId,
      'csvOptions': csvOptions.toMap(),
      'decimalTargetTypes': decimalTargetTypes,
      'fileSetSpecType': fileSetSpecType,
      'googleSheetsOptions': googleSheetsOptions.toMap(),
  ...
  factory ExternalDataConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ExternalDataConfigurationResponse(
      ...
      avroOptions: AvroOptionsResponse.fromMap((map['avroOptions'] as Map).cast<String, dynamic>()),
      bigtableOptions: BigtableOptionsResponse.fromMap((map['bigtableOptions'] as Map).cast<String, dynamic>()),
      compression: map['compression'] as String,
      connectionId: map['connectionId'] as String,
      csvOptions: CsvOptionsResponse.fromMap((map['csvOptions'] as Map).cast<String, dynamic>()),
      decimalTargetTypes: (map['decimalTargetTypes'] as List).cast<String>(),
      fileSetSpecType: map['fileSetSpecType'] as String,
      googleSheetsOptions: GoogleSheetsOptionsResponse.fromMap((map['googleSheetsOptions'] as Map).cast<String, dynamic>()),
      ...
      jsonOptions: JsonOptionsResponse.fromMap((map['jsonOptions'] as Map).cast<String, dynamic>()),
