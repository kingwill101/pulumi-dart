...
class ModelDefinition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'modelOptions': ?modelOptions == null ? null : modelOptions!.toMap(),
      'trainingRuns': ?trainingRuns == null ? null : pulumi.Input.encodeList<BqmlTrainingRun, Map<String, dynamic>>(trainingRuns!, (value) => value.toMap()),
    };
  }

  factory ModelDefinition.fromMap(Map<String, dynamic> map) {
    return ModelDefinition(
      modelOptions: map['modelOptions'] == null ? null : ModelDefinitionModelOptions.fromMap((map['modelOptions'] as Map).cast<String, dynamic>()),
      trainingRuns: map['trainingRuns'] == null ? null : pulumi.Input.decodeList<BqmlTrainingRun>(map['trainingRuns'], (value) => BqmlTrainingRun.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
