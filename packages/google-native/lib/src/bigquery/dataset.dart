...
class Dataset extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DatasetAccessItemResponse>> access;
  ...
  late final pulumi.Output<EncryptionConfigurationResponse> defaultEncryptionConfiguration;
  ...
  late final pulumi.Output<ExternalDatasetReferenceResponse> externalDatasetReference;
  ...
  late final pulumi.Output<List<DatasetTagsItemResponse>> tags;
  ...
  Dataset(
    ...
    this.datasetReference = registerOutput<DatasetReferenceResponse>('datasetReference');
    this.defaultCollation = registerOutput<String>('defaultCollation');
    this.defaultEncryptionConfiguration = registerOutput<EncryptionConfigurationResponse>('defaultEncryptionConfiguration');
    this.defaultPartitionExpirationMs = registerOutput<String>('defaultPartitionExpirationMs');
    this.defaultRoundingMode = registerOutput<String>('defaultRoundingMode');
    this.defaultTableExpirationMs = registerOutput<String>('defaultTableExpirationMs');
    this.description = registerOutput<String>('description');
    this.etag = registerOutput<String>('etag');
    this.externalDatasetReference = registerOutput<ExternalDatasetReferenceResponse>('externalDatasetReference');
