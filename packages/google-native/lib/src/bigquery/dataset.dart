...
class Dataset extends pulumi.CustomResource {
  ...
  Dataset(
    ...
    this.datasetReference = registerOutput<DatasetReferenceResponse>(
      'datasetReference',
    );
    ...
    this.defaultPartitionExpirationMs = registerOutput<String>(
      'defaultPartitionExpirationMs',
    );
    this.defaultRoundingMode = registerOutput<String>('defaultRoundingMode');
    this.defaultTableExpirationMs = registerOutput<String>(
