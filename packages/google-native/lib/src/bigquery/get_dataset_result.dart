...
class GetDatasetResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['access'] = pulumi.Input.encodeList<DatasetAccessItemResponse,
        Map<String, dynamic>>(access, (value) => value.toMap());
    ...
    map['tags'] =
        pulumi.Input.encodeList<DatasetTagsItemResponse, Map<String, dynamic>>(
