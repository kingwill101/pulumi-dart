...
class TableFieldSchemaResponse {
  ...
  factory TableFieldSchemaResponse.fromMap(Map<String, dynamic> map) {
    return TableFieldSchemaResponse(
      categories: TableFieldSchemaCategoriesResponse.fromMap((map['categories'] as Map).cast<String, dynamic>()),
      ...
      policyTags: TableFieldSchemaPolicyTagsResponse.fromMap((map['policyTags'] as Map).cast<String, dynamic>()),
      precision: map['precision'] as String,
      rangeElementType: TableFieldSchemaRangeElementTypeResponse.fromMap((map['rangeElementType'] as Map).cast<String, dynamic>()),
