...
class JobConfigurationExtract {
  ...
  Map<String, dynamic> toMap() {
    ...
    final destinationUrisValue = destinationUris;
    if (destinationUrisValue != null) {
      map['destinationUris'] = destinationUrisValue;
    }
  ...
  factory JobConfigurationExtract.fromMap(Map<String, dynamic> map) {
    return JobConfigurationExtract(
      ...
      destinationUris: map['destinationUris'] == null
          ? null
