...
class Routine extends pulumi.CustomResource {
  ...
  Routine(
    ...
    this.remoteFunctionOptions = registerOutput<RemoteFunctionOptionsResponse>(
      'remoteFunctionOptions',
    );
    this.returnTableType = registerOutput<StandardSqlTableTypeResponse>(
      'returnTableType',
    );
    this.returnType = registerOutput<StandardSqlDataTypeResponse>('returnType');
    this.routineReference = registerOutput<RoutineReferenceResponse>(
      'routineReference',
    );
