...
class TableArgs {
  ...
  TableArgs({
    ...
    ViewDefinition? view,
            ...
            pulumi.Input.asOptionalInput<BigLakeConfiguration>(
                biglakeConfiguration),
        ...
        externalDataConfiguration =
            pulumi.Input.asOptionalInput<ExternalDataConfiguration>(
                externalDataConfiguration),
        friendlyName = pulumi.Input.asOptionalInput<String>(friendlyName),
        labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
        materializedView =
            pulumi.Input.asOptionalInput<MaterializedViewDefinition>(
                materializedView),
        ...
        rangePartitioning =
            pulumi.Input.asOptionalInput<RangePartitioning>(rangePartitioning),
        requirePartitionFilter =
            pulumi.Input.asOptionalInput<bool>(requirePartitionFilter),
        resourceTags =
            pulumi.Input.asOptionalInput<Map<String, String>>(resourceTags),
        schema = pulumi.Input.asOptionalInput<TableSchema>(schema),
        tableConstraints =
            pulumi.Input.asOptionalInput<TableConstraints>(tableConstraints),
        tableReference =
            pulumi.Input.asOptionalInput<TableReference>(tableReference),
        timePartitioning =
            pulumi.Input.asOptionalInput<TimePartitioning>(timePartitioning),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (modelValue != null) {
      map['model'] = pulumi.Input.mapOptionalInputValue<ModelDefinition,
          Map<String, dynamic>>(modelValue, (value) => value.toMap());
    }
    ...
    if (rangePartitioningValue != null) {
      map['rangePartitioning'] = pulumi.Input.mapOptionalInputValue<
              RangePartitioning, Map<String, dynamic>>(
    ...
    if (tableConstraintsValue != null) {
      map['tableConstraints'] = pulumi.Input.mapOptionalInputValue<
              TableConstraints, Map<String, dynamic>>(
          tableConstraintsValue, (value) => value.toMap());
    }
    final tableReferenceValue = tableReference;
    if (tableReferenceValue != null) {
      map['tableReference'] = pulumi.Input.mapOptionalInputValue<TableReference,
          Map<String, dynamic>>(tableReferenceValue, (value) => value.toMap());
    }
    ...
    if (timePartitioningValue != null) {
      map['timePartitioning'] = pulumi.Input.mapOptionalInputValue<
              TimePartitioning, Map<String, dynamic>>(
          timePartitioningValue, (value) => value.toMap());
    }
    final viewValue = view;
    if (viewValue != null) {
      map['view'] = pulumi.Input.mapOptionalInputValue<ViewDefinition,
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      biglakeConfiguration: map['biglakeConfiguration'] == null
          ? null
          : BigLakeConfiguration.fromMap(
      ...
      externalDataConfiguration: map['externalDataConfiguration'] == null
          ? null
          : ExternalDataConfiguration.fromMap(
              (map['externalDataConfiguration'] as Map)
                  .cast<String, dynamic>()),
      friendlyName:
      ...
      tableConstraints: map['tableConstraints'] == null
          ? null
          : TableConstraints.fromMap(
