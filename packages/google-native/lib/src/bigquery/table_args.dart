...
class TableArgs {
  ...
  TableArgs({
    ...
    ViewDefinition? view,
  }) : biglakeConfiguration = pulumi
           .Input.asOptionalInput<BigLakeConfiguration>(biglakeConfiguration),
       ...
       materializedView = pulumi
           .Input.asOptionalInput<MaterializedViewDefinition>(materializedView),
       ...
       requirePartitionFilter = pulumi.Input.asOptionalInput<bool>(
       ...
       tableReference = pulumi.Input.asOptionalInput<TableReference>(
         tableReference,
       ),
