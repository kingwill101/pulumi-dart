...
class TableFieldSchema {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?mode,
      'name': ?name,
      'policyTags': ?policyTags == null ? null : policyTags!.toMap(),
      'precision': ?precision,
  ...
  factory TableFieldSchema.fromMap(Map<String, dynamic> map) {
    return TableFieldSchema(
      categories: map['categories'] == null ? null : TableFieldSchemaCategories.fromMap((map['categories'] as Map).cast<String, dynamic>()),
      collation: map['collation'] == null ? null : map['collation'] as String,
      defaultValueExpression: map['defaultValueExpression'] == null ? null : map['defaultValueExpression'] as String,
      ...
      policyTags: map['policyTags'] == null ? null : TableFieldSchemaPolicyTags.fromMap((map['policyTags'] as Map).cast<String, dynamic>()),
      precision: map['precision'] == null ? null : map['precision'] as String,
      rangeElementType: map['rangeElementType'] == null ? null : TableFieldSchemaRangeElementType.fromMap((map['rangeElementType'] as Map).cast<String, dynamic>()),
      roundingMode: map['roundingMode'] == null ? null : map['roundingMode'] as String,
