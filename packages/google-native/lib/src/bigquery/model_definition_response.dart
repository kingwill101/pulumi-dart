...
class ModelDefinitionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'modelOptions': modelOptions.toMap(),
      'trainingRuns': pulumi.Input.encodeList<BqmlTrainingRunResponse, Map<String, dynamic>>(trainingRuns, (value) => value.toMap()),
    };
  }

  factory ModelDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return ModelDefinitionResponse(
      modelOptions: ModelDefinitionModelOptionsResponse.fromMap((map['modelOptions'] as Map).cast<String, dynamic>()),
      trainingRuns: pulumi.Input.decodeList<BqmlTrainingRunResponse>(map['trainingRuns'], (value) => BqmlTrainingRunResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
