...
class RoutineArgs {
  ...
  RoutineArgs({
    ...
    bool? strictMode,
      ...
      dataGovernanceType = pulumi.Input.asOptionalInput<RoutineDataGovernanceType>(dataGovernanceType),
      datasetId = pulumi.Input.asInput<String>(datasetId),
      definitionBody = pulumi.Input.asInput<String>(definitionBody),
      description = pulumi.Input.asOptionalInput<String>(description),
      determinismLevel = pulumi.Input.asOptionalInput<RoutineDeterminismLevel>(determinismLevel),
      ...
      remoteFunctionOptions = pulumi.Input.asOptionalInput<RemoteFunctionOptions>(remoteFunctionOptions),
      returnTableType = pulumi.Input.asOptionalInput<StandardSqlTableType>(returnTableType),
      returnType = pulumi.Input.asOptionalInput<StandardSqlDataType>(returnType),
      routineReference = pulumi.Input.asInput<RoutineReference>(routineReference),
      routineType = pulumi.Input.asInput<RoutineRoutineType>(routineType),
      securityMode = pulumi.Input.asOptionalInput<RoutineSecurityMode>(securityMode),
  ...
  factory RoutineArgs.fromMap(Map<String, dynamic> map) {
    return RoutineArgs(
      ...
      dataGovernanceType: map['dataGovernanceType'] == null ? null : RoutineDataGovernanceType.fromValue(map['dataGovernanceType'] as String),
      datasetId: map['datasetId'] as String,
      definitionBody: map['definitionBody'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      determinismLevel: map['determinismLevel'] == null ? null : RoutineDeterminismLevel.fromValue(map['determinismLevel'] as String),
      importedLibraries: map['importedLibraries'] == null ? null : (map['importedLibraries'] as List).cast<String>(),
      language: map['language'] == null ? null : RoutineLanguage.fromValue(map['language'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      remoteFunctionOptions: map['remoteFunctionOptions'] == null ? null : RemoteFunctionOptions.fromMap((map['remoteFunctionOptions'] as Map).cast<String, dynamic>()),
      returnTableType: map['returnTableType'] == null ? null : StandardSqlTableType.fromMap((map['returnTableType'] as Map).cast<String, dynamic>()),
      returnType: map['returnType'] == null ? null : StandardSqlDataType.fromMap((map['returnType'] as Map).cast<String, dynamic>()),
      routineReference: RoutineReference.fromMap((map['routineReference'] as Map).cast<String, dynamic>()),
      routineType: RoutineRoutineType.fromValue(map['routineType'] as String),
      securityMode: map['securityMode'] == null ? null : RoutineSecurityMode.fromValue(map['securityMode'] as String),
      sparkOptions: map['sparkOptions'] == null ? null : SparkOptions.fromMap((map['sparkOptions'] as Map).cast<String, dynamic>()),
