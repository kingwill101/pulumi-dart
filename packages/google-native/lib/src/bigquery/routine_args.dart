...
class RoutineArgs {
  ...
  RoutineArgs({
    ...
    bool? strictMode,
       ...
       remoteFunctionOptions = pulumi
           .Input.asOptionalInput<RemoteFunctionOptions>(remoteFunctionOptions),
       returnTableType = pulumi.Input.asOptionalInput<StandardSqlTableType>(
         returnTableType,
       ),
       returnType = pulumi.Input.asOptionalInput<StandardSqlDataType>(
         returnType,
       ),
       routineReference = pulumi.Input.asInput<RoutineReference>(
         routineReference,
       ),
    ...
    return <String, dynamic>{
      ...
      'dataGovernanceType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(dataGovernanceType, (value) => value.value),
      'datasetId': datasetId,
      ...
      'language': ?pulumi.Input.mapOptionalInputValue<RoutineLanguage, String>(
        language,
        (value) => value.value,
      ),
      'project': ?project,
      ...
      'returnTableType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(returnTableType, (value) => value.toMap()),
      'returnType':
          ?pulumi.Input.mapOptionalInputValue<
            StandardSqlDataType,
            Map<String, dynamic>
          >(returnType, (value) => value.toMap()),
      'routineReference':
          pulumi.Input.mapInputValue<RoutineReference, Map<String, dynamic>>(
            routineReference,
            (value) => value.toMap(),
          ),
      'routineType': pulumi.Input.mapInputValue<RoutineRoutineType, String>(
        routineType,
        (value) => value.value,
      ),
      'securityMode':
