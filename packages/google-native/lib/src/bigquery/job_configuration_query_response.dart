...
class JobConfigurationQueryResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'priority': priority,
      'query': query,
      'queryParameters': pulumi.Input.encodeList<QueryParameterResponse, Map<String, dynamic>>(queryParameters, (value) => value.toMap()),
  ...
  factory JobConfigurationQueryResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationQueryResponse(
      ...
      defaultDataset: DatasetReferenceResponse.fromMap((map['defaultDataset'] as Map).cast<String, dynamic>()),
      ...
      queryParameters: pulumi.Input.decodeList<QueryParameterResponse>(map['queryParameters'], (value) => QueryParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
