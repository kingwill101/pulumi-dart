...
/// {@template pulumi_managedidentities_v1_domain_iam_binding_args_doc}
/// The set of arguments for DomainIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_domain_iam_binding_args_doc}
class DomainIamBindingArgs {
  ...
  /// Creates a new [DomainIamBindingArgs].
  ...
  factory DomainIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DomainIamBindingArgs(
