...
/// {@template pulumi_managedidentities_v1alpha1_domain_backup_iam_binding_managedidentities_v1alpha1_args_doc}
/// The set of arguments for DomainBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1alpha1_domain_backup_iam_binding_managedidentities_v1alpha1_args_doc}
class DomainBackupIamBindingManagedidentitiesV1alpha1Args {
  ...
  /// Creates a new [DomainBackupIamBindingManagedidentitiesV1alpha1Args].
  ...
  DomainBackupIamBindingManagedidentitiesV1alpha1Args({
    Condition? condition,
  ...
  factory DomainBackupIamBindingManagedidentitiesV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return DomainBackupIamBindingManagedidentitiesV1alpha1Args(
