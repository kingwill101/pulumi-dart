...
class Domain extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<TrustResponse>> trusts;
  ...
  /// [args] Arguments used to configure this [Domain]. {@macro pulumi_managedidentities_v1_domain_args_doc}
  ...
  Domain(String name, {DomainArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.authorizedNetworks = registerOutput<List<String>>(
      'authorizedNetworks',
    );
    ...
    this.trusts = registerOutput<List<TrustResponse>>('trusts');
