...
import 'backup_managedidentities_v1alpha1_args.dart';

/// Creates a Backup for a domain.
/// Auto-naming is currently not supported for this resource.
class BackupManagedidentitiesV1alpha1 extends pulumi.CustomResource {
  ...
  /// Creates a new [BackupManagedidentitiesV1alpha1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackupManagedidentitiesV1alpha1]. {@macro pulumi_managedidentities_v1alpha1_backup_managedidentities_v1alpha1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BackupManagedidentitiesV1alpha1(
    String name, {
    BackupManagedidentitiesV1alpha1Args? args,
