...
class GetPeeringIamPolicyResult {
  ...
  /// Creates a new [GetPeeringIamPolicyResult].
  ...
  factory GetPeeringIamPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetPeeringIamPolicyResult(
