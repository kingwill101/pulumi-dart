...
class DomainManagedidentitiesV1alpha1Args {
  ...
  DomainManagedidentitiesV1alpha1Args({
    ...
    required String reservedIpRange,
        ...
        managedIdentitiesAdminName =
            pulumi.Input.asOptionalInput<String>(managedIdentitiesAdminName),
  ...
  factory DomainManagedidentitiesV1alpha1Args.fromMap(
    ...
    return DomainManagedidentitiesV1alpha1Args(
      ...
      managedIdentitiesAdminName: map['managedIdentitiesAdminName'] == null
          ? null
          : map['managedIdentitiesAdminName'] as String,
