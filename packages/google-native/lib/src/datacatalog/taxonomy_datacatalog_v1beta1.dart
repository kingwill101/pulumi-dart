...
class TaxonomyDatacatalogV1beta1 extends pulumi.CustomResource {
  ...
  TaxonomyDatacatalogV1beta1(
    ...
    this.service = registerOutput<GoogleCloudDatacatalogV1beta1TaxonomyServiceResponse>('service');
    this.taxonomyTimestamps = registerOutput<GoogleCloudDatacatalogV1beta1SystemTimestampsResponse>('taxonomyTimestamps');
  }
}
