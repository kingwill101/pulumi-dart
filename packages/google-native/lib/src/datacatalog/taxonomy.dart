...
class Taxonomy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Taxonomy]. {@macro pulumi_datacatalog_v1_taxonomy_args_doc}
  ...
  Taxonomy(
    ...
    this.service = registerOutput<GoogleCloudDatacatalogV1TaxonomyServiceResponse>('service');
    this.taxonomyTimestamps = registerOutput<GoogleCloudDatacatalogV1SystemTimestampsResponse>('taxonomyTimestamps');
  }
}
