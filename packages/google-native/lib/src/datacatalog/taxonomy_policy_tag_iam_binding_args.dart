...
/// {@template pulumi_datacatalog_v1_taxonomy_policy_tag_iam_binding_args_doc}
/// The set of arguments for TaxonomyPolicyTagIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1_taxonomy_policy_tag_iam_binding_args_doc}
class TaxonomyPolicyTagIamBindingArgs {
  ...
  /// Creates a new [TaxonomyPolicyTagIamBindingArgs].
  ...
  TaxonomyPolicyTagIamBindingArgs({
    Condition? condition,
  ...
  factory TaxonomyPolicyTagIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TaxonomyPolicyTagIamBindingArgs(
