...
class GoogleCloudDatacatalogV1GcsFilesetSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sampleGcsFileSpecs': pulumi.Input.encodeList<GoogleCloudDatacatalogV1GcsFileSpecResponse, Map<String, dynamic>>(sampleGcsFileSpecs, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDatacatalogV1GcsFilesetSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1GcsFilesetSpecResponse(
      ...
      sampleGcsFileSpecs: pulumi.Input.decodeList<GoogleCloudDatacatalogV1GcsFileSpecResponse>(map['sampleGcsFileSpecs'], (value) => GoogleCloudDatacatalogV1GcsFileSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
