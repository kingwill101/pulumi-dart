...
class GetTaxonomyResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['activatedPolicyTypes'] = activatedPolicyTypes;
    map['description'] = description;
    map['displayName'] = displayName;
    map['name'] = name;
    map['policyTagCount'] = policyTagCount;
    map['service'] = service.toMap();
    map['taxonomyTimestamps'] = taxonomyTimestamps.toMap();
    return map;
  }
  ...
  factory GetTaxonomyResult.fromMap(Map<String, dynamic> map) {
    return GetTaxonomyResult(
      ...
      service: GoogleCloudDatacatalogV1TaxonomyServiceResponse.fromMap(
          (map['service'] as Map).cast<String, dynamic>()),
      taxonomyTimestamps:
          GoogleCloudDatacatalogV1SystemTimestampsResponse.fromMap(
              (map['taxonomyTimestamps'] as Map).cast<String, dynamic>()),
    );
  }
}
