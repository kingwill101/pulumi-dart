...
class EntryDatacatalogV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<EntryTypeDatacatalogV1beta1, String>(type, (value) => value.value),
  ...
  factory EntryDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EntryDatacatalogV1beta1Args(
      bigqueryDateShardedSpec: map['bigqueryDateShardedSpec'] == null ? null : (map['bigqueryDateShardedSpec'] as Map).cast<String, dynamic>(),
      bigqueryTableSpec: map['bigqueryTableSpec'] == null ? null : GoogleCloudDatacatalogV1beta1BigQueryTableSpec.fromMap((map['bigqueryTableSpec'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      entryGroupId: map['entryGroupId'] as String,
      entryId: map['entryId'] as String,
      gcsFilesetSpec: map['gcsFilesetSpec'] == null ? null : GoogleCloudDatacatalogV1beta1GcsFilesetSpec.fromMap((map['gcsFilesetSpec'] as Map).cast<String, dynamic>()),
      linkedResource: map['linkedResource'] == null ? null : map['linkedResource'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      schema: map['schema'] == null ? null : GoogleCloudDatacatalogV1beta1Schema.fromMap((map['schema'] as Map).cast<String, dynamic>()),
      type: map['type'] == null ? null : EntryTypeDatacatalogV1beta1.fromValue(map['type'] as String),
