...
class GoogleCloudDatacatalogV1CloudBigtableInstanceSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudBigtableClusterSpecs': ?cloudBigtableClusterSpecs == null
          ? null
          : pulumi.Input.encodeList<
              GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec,
              Map<String, dynamic>
            >(cloudBigtableClusterSpecs!, (value) => value.toMap()),
    };
  }
      ...
      cloudBigtableClusterSpecs: map['cloudBigtableClusterSpecs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec.fromMap(
