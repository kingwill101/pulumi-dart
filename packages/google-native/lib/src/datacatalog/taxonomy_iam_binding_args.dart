...
/// {@template pulumi_datacatalog_v1_taxonomy_iam_binding_args_doc}
/// The set of arguments for TaxonomyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1_taxonomy_iam_binding_args_doc}
class TaxonomyIamBindingArgs {
  ...
  /// Creates a new [TaxonomyIamBindingArgs].
  ...
  factory TaxonomyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TaxonomyIamBindingArgs(
