...
class EntryArgs {
  ...
  factory EntryArgs.fromMap(Map<String, dynamic> map) {
    return EntryArgs(
      businessContext: map['businessContext'] == null ? null : GoogleCloudDatacatalogV1BusinessContext.fromMap((map['businessContext'] as Map).cast<String, dynamic>()),
      cloudBigtableSystemSpec: map['cloudBigtableSystemSpec'] == null ? null : GoogleCloudDatacatalogV1CloudBigtableSystemSpec.fromMap((map['cloudBigtableSystemSpec'] as Map).cast<String, dynamic>()),
      dataSourceConnectionSpec: map['dataSourceConnectionSpec'] == null ? null : (map['dataSourceConnectionSpec'] as Map).cast<String, dynamic>(),
      databaseTableSpec: map['databaseTableSpec'] == null ? null : GoogleCloudDatacatalogV1DatabaseTableSpec.fromMap((map['databaseTableSpec'] as Map).cast<String, dynamic>()),
      datasetSpec: map['datasetSpec'] == null ? null : GoogleCloudDatacatalogV1DatasetSpec.fromMap((map['datasetSpec'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      entryGroupId: map['entryGroupId'] as String,
      entryId: map['entryId'] as String,
      filesetSpec: map['filesetSpec'] == null ? null : GoogleCloudDatacatalogV1FilesetSpec.fromMap((map['filesetSpec'] as Map).cast<String, dynamic>()),
      fullyQualifiedName: map['fullyQualifiedName'] == null ? null : map['fullyQualifiedName'] as String,
      gcsFilesetSpec: map['gcsFilesetSpec'] == null ? null : GoogleCloudDatacatalogV1GcsFilesetSpec.fromMap((map['gcsFilesetSpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linkedResource: map['linkedResource'] == null ? null : map['linkedResource'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      lookerSystemSpec: map['lookerSystemSpec'] == null ? null : GoogleCloudDatacatalogV1LookerSystemSpec.fromMap((map['lookerSystemSpec'] as Map).cast<String, dynamic>()),
      modelSpec: map['modelSpec'] == null ? null : GoogleCloudDatacatalogV1ModelSpec.fromMap((map['modelSpec'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      routineSpec: map['routineSpec'] == null ? null : GoogleCloudDatacatalogV1RoutineSpec.fromMap((map['routineSpec'] as Map).cast<String, dynamic>()),
      schema: map['schema'] == null ? null : GoogleCloudDatacatalogV1Schema.fromMap((map['schema'] as Map).cast<String, dynamic>()),
      serviceSpec: map['serviceSpec'] == null ? null : GoogleCloudDatacatalogV1ServiceSpec.fromMap((map['serviceSpec'] as Map).cast<String, dynamic>()),
      sourceSystemTimestamps: map['sourceSystemTimestamps'] == null ? null : GoogleCloudDatacatalogV1SystemTimestamps.fromMap((map['sourceSystemTimestamps'] as Map).cast<String, dynamic>()),
      sqlDatabaseSystemSpec: map['sqlDatabaseSystemSpec'] == null ? null : GoogleCloudDatacatalogV1SqlDatabaseSystemSpec.fromMap((map['sqlDatabaseSystemSpec'] as Map).cast<String, dynamic>()),
      type: map['type'] == null ? null : EntryType.fromValue(map['type'] as String),
      usageSignal: map['usageSignal'] == null ? null : GoogleCloudDatacatalogV1UsageSignal.fromMap((map['usageSignal'] as Map).cast<String, dynamic>()),
      userSpecifiedSystem: map['userSpecifiedSystem'] == null ? null : map['userSpecifiedSystem'] as String,
      userSpecifiedType: map['userSpecifiedType'] == null ? null : map['userSpecifiedType'] as String,
    );
  }
}
