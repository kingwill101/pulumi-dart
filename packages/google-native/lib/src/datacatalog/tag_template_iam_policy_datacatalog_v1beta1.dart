...
class TagTemplateIamPolicyDatacatalogV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [TagTemplateIamPolicyDatacatalogV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TagTemplateIamPolicyDatacatalogV1beta1]. {@macro pulumi_datacatalog_v1beta1_tag_template_iam_policy_datacatalog_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TagTemplateIamPolicyDatacatalogV1beta1(
    String name, {
    ...
    this.bindings = registerOutput<List<BindingResponseDatacatalogV1beta1>>(
      'bindings',
    );
