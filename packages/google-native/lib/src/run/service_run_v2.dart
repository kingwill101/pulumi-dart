...
class ServiceRunV2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRunV2TrafficTargetStatusResponse>>
  trafficStatuses;
  ...
  ServiceRunV2(
    ...
    this.conditions = registerOutput<List<GoogleCloudRunV2ConditionResponse>>(
      'conditions',
    );
    ...
    this.latestCreatedRevision = registerOutput<String>(
    ...
    this.scaling = registerOutput<GoogleCloudRunV2ServiceScalingResponse>(
      'scaling',
    );
    this.serviceId = registerOutput<String>('serviceId');
    this.template = registerOutput<GoogleCloudRunV2RevisionTemplateResponse>(
      'template',
    );
    this.terminalCondition = registerOutput<GoogleCloudRunV2ConditionResponse>(
      'terminalCondition',
    );
    this.traffic = registerOutput<List<GoogleCloudRunV2TrafficTargetResponse>>(
      'traffic',
    );
