...
/// {@template pulumi_run_v2_service_iam_binding_run_v2_args_doc}
/// The set of arguments for ServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_run_v2_service_iam_binding_run_v2_args_doc}
class ServiceIamBindingRunV2Args {
  ...
  /// Creates a new [ServiceIamBindingRunV2Args].
  ...
  factory ServiceIamBindingRunV2Args.fromMap(Map<String, dynamic> map) {
    return ServiceIamBindingRunV2Args(
