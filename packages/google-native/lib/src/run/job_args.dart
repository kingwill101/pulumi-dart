...
class JobArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobId': jobId,
      'labels': ?labels,
      'launchStage': ?pulumi.Input.mapOptionalInputValue<JobLaunchStage, String>(launchStage, (value) => value.value),
      'location': ?location,
      'name': ?name,
      'project': ?project,
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      launchStage: map['launchStage'] == null ? null : JobLaunchStage.fromValue(map['launchStage'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      template: GoogleCloudRunV2ExecutionTemplate.fromMap((map['template'] as Map).cast<String, dynamic>()),
    );
  }
}
