...
class GoogleCloudRunV2RevisionTemplate {
  ...
  final GoogleCloudRunV2RevisionTemplateExecutionEnvironment? executionEnvironment;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': ?containers == null ? null : pulumi.Input.encodeList<GoogleCloudRunV2Container, Map<String, dynamic>>(containers!, (value) => value.toMap()),
      'encryptionKey': ?encryptionKey,
      'executionEnvironment': ?executionEnvironment == null ? null : executionEnvironment!.value,
      'labels': ?labels,
      ...
      'timeout': ?timeout,
      'volumes': ?volumes == null ? null : pulumi.Input.encodeList<GoogleCloudRunV2Volume, Map<String, dynamic>>(volumes!, (value) => value.toMap()),
  ...
  factory GoogleCloudRunV2RevisionTemplate.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2RevisionTemplate(
      ...
      containers: map['containers'] == null ? null : pulumi.Input.decodeList<GoogleCloudRunV2Container>(map['containers'], (value) => GoogleCloudRunV2Container.fromMap((value as Map).cast<String, dynamic>())),
      encryptionKey: map['encryptionKey'] == null ? null : map['encryptionKey'] as String,
      executionEnvironment: map['executionEnvironment'] == null ? null : GoogleCloudRunV2RevisionTemplateExecutionEnvironment.fromValue(map['executionEnvironment'] as String),
      ...
      scaling: map['scaling'] == null ? null : GoogleCloudRunV2RevisionScaling.fromMap((map['scaling'] as Map).cast<String, dynamic>()),
      ...
      volumes: map['volumes'] == null ? null : pulumi.Input.decodeList<GoogleCloudRunV2Volume>(map['volumes'], (value) => GoogleCloudRunV2Volume.fromMap((value as Map).cast<String, dynamic>())),
      vpcAccess: map['vpcAccess'] == null ? null : GoogleCloudRunV2VpcAccess.fromMap((map['vpcAccess'] as Map).cast<String, dynamic>()),
    );
  }
}
