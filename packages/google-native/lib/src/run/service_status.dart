...
class ServiceStatus {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (addressValue != null) {
      map['address'] = addressValue.toMap();
    }
    ...
    if (latestCreatedRevisionNameValue != null) {
      map['latestCreatedRevisionName'] = latestCreatedRevisionNameValue;
    }
    final latestReadyRevisionNameValue = latestReadyRevisionName;
    if (latestReadyRevisionNameValue != null) {
      map['latestReadyRevisionName'] = latestReadyRevisionNameValue;
    }
  ...
  factory ServiceStatus.fromMap(Map<String, dynamic> map) {
    return ServiceStatus(
      ...
      latestCreatedRevisionName: map['latestCreatedRevisionName'] == null
          ? null
          : map['latestCreatedRevisionName'] as String,
      latestReadyRevisionName: map['latestReadyRevisionName'] == null
          ? null
          : map['latestReadyRevisionName'] as String,
