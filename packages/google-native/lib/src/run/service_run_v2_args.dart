...
class ServiceRunV2Args {
  ...
  ServiceRunV2Args({
    ...
    List<GoogleCloudRunV2TrafficTarget>? traffic,
       ...
       customAudiences = pulumi.Input.asOptionalInput<List<String>>(
         customAudiences,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       ingress = pulumi.Input.asOptionalInput<ServiceIngress>(ingress),
       labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
       launchStage = pulumi.Input.asOptionalInput<ServiceLaunchStage>(
         launchStage,
       ),
       ...
       template = pulumi.Input.asInput<GoogleCloudRunV2RevisionTemplate>(
         template,
       ),
       traffic = pulumi
           .Input.asOptionalInput<List<GoogleCloudRunV2TrafficTarget>>(traffic);
