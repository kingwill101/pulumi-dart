...
class ServiceRunV2Args {
  ...
  ServiceRunV2Args({
    ...
    List<GoogleCloudRunV2TrafficTarget>? traffic,
      ...
      launchStage = pulumi.Input.asOptionalInput<ServiceLaunchStage>(launchStage),
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      scaling = pulumi.Input.asOptionalInput<GoogleCloudRunV2ServiceScaling>(scaling),
      serviceId = pulumi.Input.asInput<String>(serviceId),
      template = pulumi.Input.asInput<GoogleCloudRunV2RevisionTemplate>(template),
      traffic = pulumi.Input.asOptionalInput<List<GoogleCloudRunV2TrafficTarget>>(traffic);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'annotations': ?annotations,
      'binaryAuthorization': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRunV2BinaryAuthorization, Map<String, dynamic>>(binaryAuthorization, (value) => value.toMap()),
      'client': ?client,
      'clientVersion': ?clientVersion,
      'customAudiences': ?customAudiences,
      'description': ?description,
      'ingress': ?pulumi.Input.mapOptionalInputValue<ServiceIngress, String>(ingress, (value) => value.value),
      'labels': ?labels,
      'launchStage': ?pulumi.Input.mapOptionalInputValue<ServiceLaunchStage, String>(launchStage, (value) => value.value),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      'scaling': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRunV2ServiceScaling, Map<String, dynamic>>(scaling, (value) => value.toMap()),
      'serviceId': serviceId,
      'template': pulumi.Input.mapInputValue<GoogleCloudRunV2RevisionTemplate, Map<String, dynamic>>(template, (value) => value.toMap()),
      'traffic': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRunV2TrafficTarget>, List<Map<String, dynamic>>>(traffic, (value) => pulumi.Input.encodeList<GoogleCloudRunV2TrafficTarget, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory ServiceRunV2Args.fromMap(Map<String, dynamic> map) {
    return ServiceRunV2Args(
      ...
      binaryAuthorization: map['binaryAuthorization'] == null ? null : GoogleCloudRunV2BinaryAuthorization.fromMap((map['binaryAuthorization'] as Map).cast<String, dynamic>()),
      client: map['client'] == null ? null : map['client'] as String,
      clientVersion: map['clientVersion'] == null ? null : map['clientVersion'] as String,
      customAudiences: map['customAudiences'] == null ? null : (map['customAudiences'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      ingress: map['ingress'] == null ? null : ServiceIngress.fromValue(map['ingress'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      launchStage: map['launchStage'] == null ? null : ServiceLaunchStage.fromValue(map['launchStage'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      scaling: map['scaling'] == null ? null : GoogleCloudRunV2ServiceScaling.fromMap((map['scaling'] as Map).cast<String, dynamic>()),
      serviceId: map['serviceId'] as String,
      template: GoogleCloudRunV2RevisionTemplate.fromMap((map['template'] as Map).cast<String, dynamic>()),
      traffic: map['traffic'] == null ? null : pulumi.Input.decodeList<GoogleCloudRunV2TrafficTarget>(map['traffic'], (value) => GoogleCloudRunV2TrafficTarget.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
