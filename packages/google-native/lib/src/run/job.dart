...
class Job extends pulumi.CustomResource {
  ...
  Job(
    ...
    this.latestCreatedExecution = registerOutput<GoogleCloudRunV2ExecutionReferenceResponse>('latestCreatedExecution');
    ...
    this.template = registerOutput<GoogleCloudRunV2ExecutionTemplateResponse>('template');
