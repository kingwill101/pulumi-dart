...
class GoogleCloudRunV2Probe {
  ...
  factory GoogleCloudRunV2Probe.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2Probe(
      ...
      grpc: map['grpc'] == null ? null : GoogleCloudRunV2GRPCAction.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: map['httpGet'] == null ? null : GoogleCloudRunV2HTTPGetAction.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : GoogleCloudRunV2TCPSocketAction.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
