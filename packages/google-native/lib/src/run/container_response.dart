...
class ContainerResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'args': args,
      'command': command,
      'env': pulumi.Input.encodeList<EnvVarResponse, Map<String, dynamic>>(env, (value) => value.toMap()),
      'envFrom': pulumi.Input.encodeList<EnvFromSourceResponse, Map<String, dynamic>>(envFrom, (value) => value.toMap()),
      'image': image,
      'imagePullPolicy': imagePullPolicy,
      'livenessProbe': livenessProbe.toMap(),
      'name': name,
      'ports': pulumi.Input.encodeList<ContainerPortResponse, Map<String, dynamic>>(ports, (value) => value.toMap()),
      'readinessProbe': readinessProbe.toMap(),
      'resources': resources.toMap(),
      'securityContext': securityContext.toMap(),
      'startupProbe': startupProbe.toMap(),
      'terminationMessagePath': terminationMessagePath,
      'terminationMessagePolicy': terminationMessagePolicy,
      'volumeMounts': pulumi.Input.encodeList<VolumeMountResponse, Map<String, dynamic>>(volumeMounts, (value) => value.toMap()),
  ...
  factory ContainerResponse.fromMap(Map<String, dynamic> map) {
    return ContainerResponse(
      ...
      env: pulumi.Input.decodeList<EnvVarResponse>(map['env'], (value) => EnvVarResponse.fromMap((value as Map).cast<String, dynamic>())),
      envFrom: pulumi.Input.decodeList<EnvFromSourceResponse>(map['envFrom'], (value) => EnvFromSourceResponse.fromMap((value as Map).cast<String, dynamic>())),
      image: map['image'] as String,
      imagePullPolicy: map['imagePullPolicy'] as String,
      livenessProbe: ProbeResponse.fromMap((map['livenessProbe'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      ports: pulumi.Input.decodeList<ContainerPortResponse>(map['ports'], (value) => ContainerPortResponse.fromMap((value as Map).cast<String, dynamic>())),
      readinessProbe: ProbeResponse.fromMap((map['readinessProbe'] as Map).cast<String, dynamic>()),
      resources: ResourceRequirementsResponse.fromMap((map['resources'] as Map).cast<String, dynamic>()),
      securityContext: SecurityContextResponse.fromMap((map['securityContext'] as Map).cast<String, dynamic>()),
      startupProbe: ProbeResponse.fromMap((map['startupProbe'] as Map).cast<String, dynamic>()),
      ...
      volumeMounts: pulumi.Input.decodeList<VolumeMountResponse>(map['volumeMounts'], (value) => VolumeMountResponse.fromMap((value as Map).cast<String, dynamic>())),
