...
class SecretVolumeSourceResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<KeyToPathResponse, Map<String, dynamic>>(items, (value) => value.toMap()),
      'optional': optional,
  ...
  factory SecretVolumeSourceResponse.fromMap(Map<String, dynamic> map) {
    return SecretVolumeSourceResponse(
      ...
      items: pulumi.Input.decodeList<KeyToPathResponse>(map['items'], (value) => KeyToPathResponse.fromMap((value as Map).cast<String, dynamic>())),
