...
class GoogleCloudRunV2RevisionTemplateResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': pulumi.Input.encodeList<GoogleCloudRunV2ContainerResponse, Map<String, dynamic>>(containers, (value) => value.toMap()),
      ...
      'timeout': timeout,
      'volumes': pulumi.Input.encodeList<GoogleCloudRunV2VolumeResponse, Map<String, dynamic>>(volumes, (value) => value.toMap()),
      'vpcAccess': vpcAccess.toMap(),
    };
  }
  ...
  factory GoogleCloudRunV2RevisionTemplateResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2RevisionTemplateResponse(
      ...
      containers: pulumi.Input.decodeList<GoogleCloudRunV2ContainerResponse>(map['containers'], (value) => GoogleCloudRunV2ContainerResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      scaling: GoogleCloudRunV2RevisionScalingResponse.fromMap((map['scaling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      sessionAffinity: map['sessionAffinity'] as bool,
      timeout: map['timeout'] as String,
      volumes: pulumi.Input.decodeList<GoogleCloudRunV2VolumeResponse>(map['volumes'], (value) => GoogleCloudRunV2VolumeResponse.fromMap((value as Map).cast<String, dynamic>())),
      vpcAccess: GoogleCloudRunV2VpcAccessResponse.fromMap((map['vpcAccess'] as Map).cast<String, dynamic>()),
    );
  }
}
