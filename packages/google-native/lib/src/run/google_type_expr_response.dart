...
class GoogleTypeExprResponse {
  ...
  /// Creates a new [GoogleTypeExprResponse].
  ...
  factory GoogleTypeExprResponse.fromMap(Map<String, dynamic> map) {
    return GoogleTypeExprResponse(
