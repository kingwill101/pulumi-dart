...
class ObjectMeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'namespace': namespace,
      'ownerReferences': ?ownerReferences == null ? null : pulumi.Input.encodeList<OwnerReference, Map<String, dynamic>>(ownerReferences!, (value) => value.toMap()),
  ...
  factory ObjectMeta.fromMap(Map<String, dynamic> map) {
    return ObjectMeta(
      ...
      deletionGracePeriodSeconds: map['deletionGracePeriodSeconds'] == null ? null : map['deletionGracePeriodSeconds'] as int,
      deletionTimestamp: map['deletionTimestamp'] == null ? null : map['deletionTimestamp'] as String,
      finalizers: map['finalizers'] == null ? null : (map['finalizers'] as List).cast<String>(),
      generateName: map['generateName'] == null ? null : map['generateName'] as String,
      generation: map['generation'] == null ? null : map['generation'] as int,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      namespace: map['namespace'] as String,
      ownerReferences: map['ownerReferences'] == null ? null : pulumi.Input.decodeList<OwnerReference>(map['ownerReferences'], (value) => OwnerReference.fromMap((value as Map).cast<String, dynamic>())),
