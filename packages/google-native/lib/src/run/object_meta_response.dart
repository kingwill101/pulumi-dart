...
class ObjectMetaResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['deletionGracePeriodSeconds'] = deletionGracePeriodSeconds;
    map['deletionTimestamp'] = deletionTimestamp;
    map['finalizers'] = finalizers;
    map['generateName'] = generateName;
    map['generation'] = generation;
    map['labels'] = labels;
    map['name'] = name;
    map['namespace'] = namespace;
    map['ownerReferences'] =
        pulumi.Input.encodeList<OwnerReferenceResponse, Map<String, dynamic>>(
            ownerReferences, (value) => value.toMap());
  ...
  factory ObjectMetaResponse.fromMap(Map<String, dynamic> map) {
    return ObjectMetaResponse(
      ...
      ownerReferences: pulumi.Input.decodeList<OwnerReferenceResponse>(
          map['ownerReferences'],
          (value) => OwnerReferenceResponse.fromMap(
