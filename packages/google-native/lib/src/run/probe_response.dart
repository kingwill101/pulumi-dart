...
class ProbeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'grpc': grpc.toMap(),
      'httpGet': httpGet.toMap(),
      'initialDelaySeconds': initialDelaySeconds,
      'periodSeconds': periodSeconds,
      'successThreshold': successThreshold,
      'tcpSocket': tcpSocket.toMap(),
  ...
  factory ProbeResponse.fromMap(Map<String, dynamic> map) {
    return ProbeResponse(
      exec: ExecActionResponse.fromMap((map['exec'] as Map).cast<String, dynamic>()),
      failureThreshold: map['failureThreshold'] as int,
      grpc: GRPCActionResponse.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: HTTPGetActionResponse.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: TCPSocketActionResponse.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
