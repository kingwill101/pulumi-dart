...
class GoogleCloudRunV2VolumeResponse {
  ...
  factory GoogleCloudRunV2VolumeResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2VolumeResponse(
      cloudSqlInstance: GoogleCloudRunV2CloudSqlInstanceResponse.fromMap((map['cloudSqlInstance'] as Map).cast<String, dynamic>()),
      emptyDir: GoogleCloudRunV2EmptyDirVolumeSourceResponse.fromMap((map['emptyDir'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      secret: GoogleCloudRunV2SecretVolumeSourceResponse.fromMap((map['secret'] as Map).cast<String, dynamic>()),
    );
  }
}
