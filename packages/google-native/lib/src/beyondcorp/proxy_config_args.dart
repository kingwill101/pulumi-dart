...
class ProxyConfigArgs {
  ...
  ProxyConfigArgs({
    ...
    required GoogleCloudBeyondcorpPartnerservicesV1alphaTransportInfo transportInfo,
  }) :
  ...
  factory ProxyConfigArgs.fromMap(Map<String, dynamic> map) {
    return ProxyConfigArgs(
      ...
      encryptionInfo: map['encryptionInfo'] == null ? null : GoogleCloudBeyondcorpPartnerservicesV1alphaEncryptionInfo.fromMap((map['encryptionInfo'] as Map).cast<String, dynamic>()),
      organizationId: map['organizationId'] as String,
      partnerTenantId: map['partnerTenantId'] as String,
      proxyUri: map['proxyUri'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      routingInfo: GoogleCloudBeyondcorpPartnerservicesV1alphaRoutingInfo.fromMap((map['routingInfo'] as Map).cast<String, dynamic>()),
      transportInfo: GoogleCloudBeyondcorpPartnerservicesV1alphaTransportInfo.fromMap((map['transportInfo'] as Map).cast<String, dynamic>()),
    );
  }
}
