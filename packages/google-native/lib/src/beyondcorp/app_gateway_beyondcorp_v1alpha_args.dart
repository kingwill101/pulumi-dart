...
class AppGatewayBeyondcorpV1alphaArgs {
  ...
  AppGatewayBeyondcorpV1alphaArgs({
    String? appGatewayId,
    String? displayName,
    required AppGatewayHostTypeBeyondcorpV1alpha hostType,
    Map<String, String>? labels,
    String? location,
    String? name,
    String? project,
    String? requestId,
    required AppGatewayTypeBeyondcorpV1alpha type,
  })  : appGatewayId = pulumi.Input.asOptionalInput<String>(appGatewayId),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        hostType =
            pulumi.Input.asInput<AppGatewayHostTypeBeyondcorpV1alpha>(hostType),
  ...
  factory AppGatewayBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppGatewayBeyondcorpV1alphaArgs(
      appGatewayId:
          map['appGatewayId'] == null ? null : map['appGatewayId'] as String,
      displayName:
          map['displayName'] == null ? null : map['displayName'] as String,
      hostType: AppGatewayHostTypeBeyondcorpV1alpha.fromValue(
          map['hostType'] as String),
      ...
      type: AppGatewayTypeBeyondcorpV1alpha.fromValue(map['type'] as String),
    );
  }
}
