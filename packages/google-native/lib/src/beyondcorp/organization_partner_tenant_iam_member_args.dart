...
/// {@template pulumi_beyondcorp_v1_organization_partner_tenant_iam_member_args_doc}
/// The set of arguments for OrganizationPartnerTenantIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_organization_partner_tenant_iam_member_args_doc}
class OrganizationPartnerTenantIamMemberArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantIamMemberArgs].
  ...
  OrganizationPartnerTenantIamMemberArgs({
    Condition? condition,
  ...
  factory OrganizationPartnerTenantIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationPartnerTenantIamMemberArgs(
