...
/// {@template pulumi_beyondcorp_v1_organization_partner_tenant_browser_dlp_rule_iam_policy_args_doc}
/// The set of arguments for OrganizationPartnerTenantBrowserDlpRuleIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_organization_partner_tenant_browser_dlp_rule_iam_policy_args_doc}
class OrganizationPartnerTenantBrowserDlpRuleIamPolicyArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantBrowserDlpRuleIamPolicyArgs].
  ...
  factory OrganizationPartnerTenantBrowserDlpRuleIamPolicyArgs.fromMap(Map<String, dynamic> map) {
