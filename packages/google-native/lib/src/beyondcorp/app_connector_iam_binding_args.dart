...
/// {@template pulumi_beyondcorp_v1_app_connector_iam_binding_args_doc}
/// The set of arguments for AppConnectorIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_app_connector_iam_binding_args_doc}
class AppConnectorIamBindingArgs {
  ...
  /// Creates a new [AppConnectorIamBindingArgs].
  ...
  factory AppConnectorIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectorIamBindingArgs(
