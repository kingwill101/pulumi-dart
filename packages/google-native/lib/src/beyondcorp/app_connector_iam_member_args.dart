...
/// {@template pulumi_beyondcorp_v1_app_connector_iam_member_args_doc}
/// The set of arguments for AppConnectorIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_app_connector_iam_member_args_doc}
class AppConnectorIamMemberArgs {
  ...
  /// Creates a new [AppConnectorIamMemberArgs].
  ...
  factory AppConnectorIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectorIamMemberArgs(
