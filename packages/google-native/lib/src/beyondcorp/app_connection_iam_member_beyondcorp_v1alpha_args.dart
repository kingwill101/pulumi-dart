...
/// {@template pulumi_beyondcorp_v1alpha_app_connection_iam_member_beyondcorp_v1alpha_args_doc}
/// The set of arguments for AppConnectionIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_app_connection_iam_member_beyondcorp_v1alpha_args_doc}
class AppConnectionIamMemberBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [AppConnectionIamMemberBeyondcorpV1alphaArgs].
  ...
  AppConnectionIamMemberBeyondcorpV1alphaArgs({
    Condition? condition,
  ...
  factory AppConnectionIamMemberBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectionIamMemberBeyondcorpV1alphaArgs(
