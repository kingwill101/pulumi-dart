...
/// {@template pulumi_beyondcorp_v1_client_gateway_iam_binding_args_doc}
/// The set of arguments for ClientGatewayIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_client_gateway_iam_binding_args_doc}
class ClientGatewayIamBindingArgs {
  ...
  /// Creates a new [ClientGatewayIamBindingArgs].
  ...
  factory ClientGatewayIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ClientGatewayIamBindingArgs(
