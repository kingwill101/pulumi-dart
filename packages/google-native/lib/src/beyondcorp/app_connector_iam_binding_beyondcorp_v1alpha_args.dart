...
/// {@template pulumi_beyondcorp_v1alpha_app_connector_iam_binding_beyondcorp_v1alpha_args_doc}
/// The set of arguments for AppConnectorIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_app_connector_iam_binding_beyondcorp_v1alpha_args_doc}
class AppConnectorIamBindingBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [AppConnectorIamBindingBeyondcorpV1alphaArgs].
  ...
  AppConnectorIamBindingBeyondcorpV1alphaArgs({
    Condition? condition,
  ...
  factory AppConnectorIamBindingBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectorIamBindingBeyondcorpV1alphaArgs(
