...
class AppConnectionBeyondcorpV1alphaArgs {
  ...
  AppConnectionBeyondcorpV1alphaArgs({
    ...
    required GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpoint applicationEndpoint,
    ...
    String? project,
    String? requestId,
    required AppConnectionTypeBeyondcorpV1alpha type,
  }) :
  ...
  factory AppConnectionBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectionBeyondcorpV1alphaArgs(
      ...
      applicationEndpoint: GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpoint.fromMap((map['applicationEndpoint'] as Map).cast<String, dynamic>()),
      connectors: map['connectors'] == null ? null : (map['connectors'] as List).cast<String>(),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      gateway: map['gateway'] == null ? null : GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      type: AppConnectionTypeBeyondcorpV1alpha.fromValue(map['type'] as String),
    );
  }
}
