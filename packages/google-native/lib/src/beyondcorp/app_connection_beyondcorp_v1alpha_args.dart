...
class AppConnectionBeyondcorpV1alphaArgs {
  ...
  AppConnectionBeyondcorpV1alphaArgs({
    ...
    required GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpoint
        applicationEndpoint,
  ...
  factory AppConnectionBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectionBeyondcorpV1alphaArgs(
      appConnectionId: map['appConnectionId'] == null
          ? null
          : map['appConnectionId'] as String,
      applicationEndpoint:
          GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpoint
              .fromMap(
      ...
      connectors: map['connectors'] == null
          ? null
          : (map['connectors'] as List).cast<String>(),
      displayName:
          map['displayName'] == null ? null : map['displayName'] as String,
      gateway: map['gateway'] == null
          ? null
          : GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGateway
              .fromMap((map['gateway'] as Map).cast<String, dynamic>()),
