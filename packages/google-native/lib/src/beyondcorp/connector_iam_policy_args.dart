...
/// {@template pulumi_beyondcorp_v1alpha_connector_iam_policy_args_doc}
/// The set of arguments for ConnectorIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_connector_iam_policy_args_doc}
class ConnectorIamPolicyArgs {
  ...
  /// Creates a new [ConnectorIamPolicyArgs].
  ...
  factory ConnectorIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorIamPolicyArgs(
