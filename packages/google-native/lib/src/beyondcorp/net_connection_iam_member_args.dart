...
/// {@template pulumi_beyondcorp_v1alpha_net_connection_iam_member_args_doc}
/// The set of arguments for NetConnectionIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_net_connection_iam_member_args_doc}
class NetConnectionIamMemberArgs {
  ...
  /// Creates a new [NetConnectionIamMemberArgs].
  ...
  factory NetConnectionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NetConnectionIamMemberArgs(
