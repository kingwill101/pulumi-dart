...
class GetAppConnectorResult {
  ...
  final GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse
  principalInfo;

  /// Optional. Resource info of the connector.
  final GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse resourceInfo;
  ...
  factory GetAppConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetAppConnectorResult(
      ...
      principalInfo:
          GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse.fromMap(
