...
/// {@template pulumi_beyondcorp_v1alpha_app_connector_iam_member_beyondcorp_v1alpha_args_doc}
/// The set of arguments for AppConnectorIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_app_connector_iam_member_beyondcorp_v1alpha_args_doc}
class AppConnectorIamMemberBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [AppConnectorIamMemberBeyondcorpV1alphaArgs].
  ...
  factory AppConnectorIamMemberBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectorIamMemberBeyondcorpV1alphaArgs(
