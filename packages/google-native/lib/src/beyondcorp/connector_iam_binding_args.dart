...
/// {@template pulumi_beyondcorp_v1alpha_connector_iam_binding_args_doc}
/// The set of arguments for ConnectorIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_connector_iam_binding_args_doc}
class ConnectorIamBindingArgs {
  ...
  /// Creates a new [ConnectorIamBindingArgs].
  ...
  factory ConnectorIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorIamBindingArgs(
