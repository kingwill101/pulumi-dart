...
class AppConnectorArgs {
  ...
  AppConnectorArgs({
    ...
    String? location,
    String? name,
    required GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfo principalInfo,
    String? project,
    String? requestId,
  ...
  factory AppConnectorArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectorArgs(
      ...
      principalInfo: GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfo.fromMap((map['principalInfo'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      resourceInfo: map['resourceInfo'] == null ? null : GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo.fromMap((map['resourceInfo'] as Map).cast<String, dynamic>()),
    );
  }
}
