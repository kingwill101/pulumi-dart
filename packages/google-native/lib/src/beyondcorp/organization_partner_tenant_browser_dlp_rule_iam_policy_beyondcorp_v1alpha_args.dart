...
class OrganizationPartnerTenantBrowserDlpRuleIamPolicyBeyondcorpV1alphaArgs {
  ...
  final pulumi.Input<List<GoogleIamV1AuditConfigBeyondcorpV1alpha>>?
      auditConfigs;
  ...
  OrganizationPartnerTenantBrowserDlpRuleIamPolicyBeyondcorpV1alphaArgs({
    List<GoogleIamV1AuditConfigBeyondcorpV1alpha>? auditConfigs,
    List<GoogleIamV1BindingBeyondcorpV1alpha>? bindings,
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<GoogleIamV1AuditConfigBeyondcorpV1alpha>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<
              GoogleIamV1AuditConfigBeyondcorpV1alpha,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<GoogleIamV1BindingBeyondcorpV1alpha>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<
              GoogleIamV1BindingBeyondcorpV1alpha,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory OrganizationPartnerTenantBrowserDlpRuleIamPolicyBeyondcorpV1alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return OrganizationPartnerTenantBrowserDlpRuleIamPolicyBeyondcorpV1alphaArgs(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<GoogleIamV1AuditConfigBeyondcorpV1alpha>(
              map['auditConfigs'],
              (value) => GoogleIamV1AuditConfigBeyondcorpV1alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<GoogleIamV1BindingBeyondcorpV1alpha>(
              map['bindings'],
              (value) => GoogleIamV1BindingBeyondcorpV1alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
