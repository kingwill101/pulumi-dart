...
class OrganizationPartnerTenantBrowserDlpRuleIamPolicyBeyondcorpV1alphaArgs {
  ...
  factory OrganizationPartnerTenantBrowserDlpRuleIamPolicyBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationPartnerTenantBrowserDlpRuleIamPolicyBeyondcorpV1alphaArgs(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Input.decodeList<GoogleIamV1AuditConfigBeyondcorpV1alpha>(map['auditConfigs'], (value) => GoogleIamV1AuditConfigBeyondcorpV1alpha.fromMap((value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<GoogleIamV1BindingBeyondcorpV1alpha>(map['bindings'], (value) => GoogleIamV1BindingBeyondcorpV1alpha.fromMap((value as Map).cast<String, dynamic>())),
