...
/// {@template pulumi_beyondcorp_v1_app_gateway_iam_policy_args_doc}
/// The set of arguments for AppGatewayIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_app_gateway_iam_policy_args_doc}
class AppGatewayIamPolicyArgs {
  ...
  /// Creates a new [AppGatewayIamPolicyArgs].
  ...
  factory AppGatewayIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AppGatewayIamPolicyArgs(
