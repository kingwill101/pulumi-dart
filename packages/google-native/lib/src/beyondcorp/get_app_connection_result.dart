...
class GetAppConnectionResult {
  ...
  final GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponse applicationEndpoint;
  ...
  final GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponse gateway;
  ...
  factory GetAppConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetAppConnectionResult(
      applicationEndpoint: GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponse.fromMap((map['applicationEndpoint'] as Map).cast<String, dynamic>()),
      connectors: (map['connectors'] as List).cast<String>(),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      gateway: GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponse.fromMap((map['gateway'] as Map).cast<String, dynamic>()),
