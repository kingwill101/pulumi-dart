...
class ConnectionArgs {
  ...
  }) : applicationEndpoint = pulumi.Input.asInput<ApplicationEndpoint>(
         applicationEndpoint,
       ),
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      applicationEndpoint: ApplicationEndpoint.fromMap(
      ...
      gateway: map['gateway'] == null
          ? null
          : Gateway.fromMap((map['gateway'] as Map).cast<String, dynamic>()),
