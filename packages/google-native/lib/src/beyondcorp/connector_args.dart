...
class ConnectorArgs {
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      principalInfo: PrincipalInfo.fromMap((map['principalInfo'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      resourceInfo: map['resourceInfo'] == null ? null : ResourceInfo.fromMap((map['resourceInfo'] as Map).cast<String, dynamic>()),
    );
  }
}
