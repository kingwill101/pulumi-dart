...
/// {@template pulumi_beyondcorp_v1alpha_application_iam_policy_args_doc}
/// The set of arguments for ApplicationIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_application_iam_policy_args_doc}
class ApplicationIamPolicyArgs {
  ...
  /// Creates a new [ApplicationIamPolicyArgs].
  ...
  factory ApplicationIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationIamPolicyArgs(
