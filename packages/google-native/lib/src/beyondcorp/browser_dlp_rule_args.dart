...
class BrowserDlpRuleArgs {
  ...
  factory BrowserDlpRuleArgs.fromMap(Map<String, dynamic> map) {
    return BrowserDlpRuleArgs(
      group: GoogleCloudBeyondcorpPartnerservicesV1alphaGroup.fromMap((map['group'] as Map).cast<String, dynamic>()),
      organizationId: map['organizationId'] as String,
      partnerTenantId: map['partnerTenantId'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      ruleSetting: GoogleCloudBeyondcorpPartnerservicesV1alphaRuleSetting.fromMap((map['ruleSetting'] as Map).cast<String, dynamic>()),
    );
  }
}
