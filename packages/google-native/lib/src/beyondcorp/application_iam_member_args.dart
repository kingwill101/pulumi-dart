...
/// {@template pulumi_beyondcorp_v1alpha_application_iam_member_args_doc}
/// The set of arguments for ApplicationIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_application_iam_member_args_doc}
class ApplicationIamMemberArgs {
  ...
  /// Creates a new [ApplicationIamMemberArgs].
  ...
  factory ApplicationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationIamMemberArgs(
