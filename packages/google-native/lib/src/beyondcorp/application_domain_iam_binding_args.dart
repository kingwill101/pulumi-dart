...
/// {@template pulumi_beyondcorp_v1alpha_application_domain_iam_binding_args_doc}
/// The set of arguments for ApplicationDomainIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_application_domain_iam_binding_args_doc}
class ApplicationDomainIamBindingArgs {
  ...
  /// Creates a new [ApplicationDomainIamBindingArgs].
  ...
  ApplicationDomainIamBindingArgs({
    Condition? condition,
  ...
  factory ApplicationDomainIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationDomainIamBindingArgs(
