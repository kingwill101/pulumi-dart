...
class AppConnectorBeyondcorpV1alphaArgs {
  ...
  AppConnectorBeyondcorpV1alphaArgs({
    ...
    String? location,
    String? name,
    required GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfo principalInfo,
    String? project,
    String? requestId,
  ...
  factory AppConnectorBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectorBeyondcorpV1alphaArgs(
      appConnectorId: map['appConnectorId'] == null ? null : map['appConnectorId'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      principalInfo: GoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorPrincipalInfo.fromMap((map['principalInfo'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      resourceInfo: map['resourceInfo'] == null ? null : GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfo.fromMap((map['resourceInfo'] as Map).cast<String, dynamic>()),
    );
  }
}
