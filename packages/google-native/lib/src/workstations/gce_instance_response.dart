...
class GceInstanceResponse {
  ...
  final GceConfidentialInstanceConfigResponse confidentialInstanceConfig;
  ...
  final GceShieldedInstanceConfigResponse shieldedInstanceConfig;
  ...
  factory GceInstanceResponse.fromMap(Map<String, dynamic> map) {
    return GceInstanceResponse(
      ...
      confidentialInstanceConfig: GceConfidentialInstanceConfigResponse.fromMap(
      ...
      shieldedInstanceConfig: GceShieldedInstanceConfigResponse.fromMap(
