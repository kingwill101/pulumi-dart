...
class GceInstance {
  ...
  final GceConfidentialInstanceConfig? confidentialInstanceConfig;
  ...
  final GceShieldedInstanceConfig? shieldedInstanceConfig;
  ...
  factory GceInstance.fromMap(Map<String, dynamic> map) {
    return GceInstance(
      ...
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : GceConfidentialInstanceConfig.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : GceShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
