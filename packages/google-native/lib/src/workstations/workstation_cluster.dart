...
class WorkstationCluster extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<StatusResponse>> conditions;
  ...
  WorkstationCluster(
    ...
    this.conditions = registerOutput<List<StatusResponse>>('conditions');
    ...
    this.privateClusterConfig = registerOutput<PrivateClusterConfigResponse>('privateClusterConfig');
