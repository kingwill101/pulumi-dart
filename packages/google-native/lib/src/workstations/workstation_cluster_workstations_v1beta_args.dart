...
class WorkstationClusterWorkstationsV1betaArgs {
  ...
  WorkstationClusterWorkstationsV1betaArgs({
    ...
    String? name,
    String? network,
    PrivateClusterConfigWorkstationsV1beta? privateClusterConfig,
    String? project,
    String? subnetwork,
  ...
  factory WorkstationClusterWorkstationsV1betaArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationClusterWorkstationsV1betaArgs(
      ...
      domainConfig: map['domainConfig'] == null ? null : DomainConfig.fromMap((map['domainConfig'] as Map).cast<String, dynamic>()),
      etag: map['etag'] == null ? null : map['etag'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      privateClusterConfig: map['privateClusterConfig'] == null ? null : PrivateClusterConfigWorkstationsV1beta.fromMap((map['privateClusterConfig'] as Map).cast<String, dynamic>()),
