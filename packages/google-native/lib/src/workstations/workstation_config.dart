...
class WorkstationConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PersistentDirectoryResponse>> persistentDirectories;
  late final pulumi.Output<String> project;
  /// Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes.
  late final pulumi.Output<List<ReadinessCheckResponse>> readinessChecks;
  ...
  WorkstationConfig(
    ...
    this.container = registerOutput<ContainerResponse>('container');
    this.createTime = registerOutput<String>('createTime');
    this.degraded = registerOutput<bool>('degraded');
    this.deleteTime = registerOutput<String>('deleteTime');
    this.displayName = registerOutput<String>('displayName');
    this.encryptionKey = registerOutput<CustomerEncryptionKeyResponse>('encryptionKey');
    ...
    this.persistentDirectories = registerOutput<List<PersistentDirectoryResponse>>('persistentDirectories');
    this.project = registerOutput<String>('project');
    this.readinessChecks = registerOutput<List<ReadinessCheckResponse>>('readinessChecks');
