...
class WorkstationConfigWorkstationsV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EphemeralDirectoryResponse>>
  ...
  late final pulumi.Output<List<PersistentDirectoryResponseWorkstationsV1beta>>
      persistentDirectories;
  late final pulumi.Output<String> project;

  /// Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes.
  late final pulumi.Output<List<ReadinessCheckResponseWorkstationsV1beta>>
      readinessChecks;
  ...
  WorkstationConfigWorkstationsV1beta(
    ...
    this.conditions =
        registerOutput<List<StatusResponseWorkstationsV1beta>>('conditions');
    this.container =
        registerOutput<ContainerResponseWorkstationsV1beta>('container');
    ...
    this.persistentDirectories =
        registerOutput<List<PersistentDirectoryResponseWorkstationsV1beta>>(
            'persistentDirectories');
    this.project = registerOutput<String>('project');
    this.readinessChecks =
        registerOutput<List<ReadinessCheckResponseWorkstationsV1beta>>(
            'readinessChecks');
