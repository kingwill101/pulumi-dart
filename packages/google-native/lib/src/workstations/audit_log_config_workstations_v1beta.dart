...
import 'audit_log_config_log_type_workstations_v1beta.dart';
...
class AuditLogConfigWorkstationsV1beta {
  ...
  final AuditLogConfigLogTypeWorkstationsV1beta? logType;
  ...
  factory AuditLogConfigWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigWorkstationsV1beta(
      ...
      logType: map['logType'] == null ? null : AuditLogConfigLogTypeWorkstationsV1beta.fromValue(map['logType'] as String),
    );
  }
}
