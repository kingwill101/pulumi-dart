...
import 'workstation_workstations_v1beta_args.dart';

/// Creates a new workstation.
class WorkstationWorkstationsV1beta extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkstationWorkstationsV1beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkstationWorkstationsV1beta]. {@macro pulumi_workstations_v1beta_workstation_workstations_v1beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkstationWorkstationsV1beta(
    String name, {
    WorkstationWorkstationsV1betaArgs? args,
