...
class GetWorkstationConfigResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'readinessChecks':
          pulumi.Input.encodeList<ReadinessCheckResponse, Map<String, dynamic>>(
            readinessChecks,
            (value) => value.toMap(),
          ),
  ...
  factory GetWorkstationConfigResult.fromMap(Map<String, dynamic> map) {
    return GetWorkstationConfigResult(
      ...
      conditions: pulumi.Input.decodeList<StatusResponse>(
        map['conditions'],
        (value) =>
      ...
      encryptionKey: CustomerEncryptionKeyResponse.fromMap(
      ...
      readinessChecks: pulumi.Input.decodeList<ReadinessCheckResponse>(
        map['readinessChecks'],
        (value) => ReadinessCheckResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
