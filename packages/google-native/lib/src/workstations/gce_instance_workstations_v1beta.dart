...
class GceInstanceWorkstationsV1beta {
  ...
  final GceConfidentialInstanceConfigWorkstationsV1beta? confidentialInstanceConfig;
  ...
  /// Creates a new [GceInstanceWorkstationsV1beta].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<Accelerator, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
  ...
  factory GceInstanceWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return GceInstanceWorkstationsV1beta(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<Accelerator>(map['accelerators'], (value) => Accelerator.fromMap((value as Map).cast<String, dynamic>())),
      bootDiskSizeGb: map['bootDiskSizeGb'] == null ? null : map['bootDiskSizeGb'] as int,
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : GceConfidentialInstanceConfigWorkstationsV1beta.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : GceShieldedInstanceConfigWorkstationsV1beta.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
