...
class WorkstationClusterWorkstationConfigWorkstationIamPolicy
  ...
  /// Creates a new [WorkstationClusterWorkstationConfigWorkstationIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkstationClusterWorkstationConfigWorkstationIamPolicy]. {@macro pulumi_workstations_v1_workstation_cluster_workstation_config_workstation_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkstationClusterWorkstationConfigWorkstationIamPolicy(
    String name, {
    WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs? args,
    ...
    this.auditConfigs = registerOutput<List<AuditConfigResponse>>(
      'auditConfigs',
    );
