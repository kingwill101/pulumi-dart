...
/// {@template pulumi_workstations_v1_workstation_cluster_workstation_config_iam_binding_args_doc}
/// The set of arguments for WorkstationClusterWorkstationConfigIamBinding.
/// {@endtemplate}
/// {@macro pulumi_workstations_v1_workstation_cluster_workstation_config_iam_binding_args_doc}
class WorkstationClusterWorkstationConfigIamBindingArgs {
  ...
  /// Creates a new [WorkstationClusterWorkstationConfigIamBindingArgs].
  ...
  WorkstationClusterWorkstationConfigIamBindingArgs({
    Condition? condition,
  ...
  factory WorkstationClusterWorkstationConfigIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationClusterWorkstationConfigIamBindingArgs(
