...
class WorkstationConfigArgs {
  ...
  WorkstationConfigArgs({
    ...
    required String workstationConfigId,
        ...
        encryptionKey =
            pulumi.Input.asOptionalInput<CustomerEncryptionKey>(encryptionKey),
        ...
        readinessChecks =
            pulumi.Input.asOptionalInput<List<ReadinessCheck>>(readinessChecks),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (hostValue != null) {
      map['host'] =
          pulumi.Input.mapOptionalInputValue<Host, Map<String, dynamic>>(
    ...
    if (persistentDirectoriesValue != null) {
      map['persistentDirectories'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<PersistentDirectory,
    ...
    if (readinessChecksValue != null) {
      map['readinessChecks'] = pulumi.Input.mapOptionalInputValue<
              List<ReadinessCheck>, List<Map<String, dynamic>>>(
