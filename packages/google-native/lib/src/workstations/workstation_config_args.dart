...
class WorkstationConfigArgs {
  ...
  factory WorkstationConfigArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigArgs(
      ...
      container: map['container'] == null ? null : Container.fromMap((map['container'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      encryptionKey: map['encryptionKey'] == null ? null : CustomerEncryptionKey.fromMap((map['encryptionKey'] as Map).cast<String, dynamic>()),
      etag: map['etag'] == null ? null : map['etag'] as String,
      host: map['host'] == null ? null : Host.fromMap((map['host'] as Map).cast<String, dynamic>()),
      idleTimeout: map['idleTimeout'] == null ? null : map['idleTimeout'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      persistentDirectories: map['persistentDirectories'] == null ? null : pulumi.Input.decodeList<PersistentDirectory>(map['persistentDirectories'], (value) => PersistentDirectory.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      readinessChecks: map['readinessChecks'] == null ? null : pulumi.Input.decodeList<ReadinessCheck>(map['readinessChecks'], (value) => ReadinessCheck.fromMap((value as Map).cast<String, dynamic>())),
      replicaZones: map['replicaZones'] == null ? null : (map['replicaZones'] as List).cast<String>(),
      runningTimeout: map['runningTimeout'] == null ? null : map['runningTimeout'] as String,
