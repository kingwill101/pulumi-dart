...
class WorkstationClusterWorkstationConfigWorkstationIamPolicyWorkstationsV1betaArgs {
  ...
  WorkstationClusterWorkstationConfigWorkstationIamPolicyWorkstationsV1betaArgs({
    ...
    required String workstationId,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigWorkstationsV1beta>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingWorkstationsV1beta>>(
                bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigWorkstationsV1beta>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigWorkstationsV1beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingWorkstationsV1beta>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingWorkstationsV1beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory WorkstationClusterWorkstationConfigWorkstationIamPolicyWorkstationsV1betaArgs.fromMap(
    ...
    return WorkstationClusterWorkstationConfigWorkstationIamPolicyWorkstationsV1betaArgs(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigWorkstationsV1beta>(
              map['auditConfigs'],
              (value) => AuditConfigWorkstationsV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingWorkstationsV1beta>(
              map['bindings'],
              (value) => BindingWorkstationsV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
