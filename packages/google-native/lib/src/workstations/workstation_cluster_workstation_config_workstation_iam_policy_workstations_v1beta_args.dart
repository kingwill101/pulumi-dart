...
class WorkstationClusterWorkstationConfigWorkstationIamPolicyWorkstationsV1betaArgs {
  ...
  WorkstationClusterWorkstationConfigWorkstationIamPolicyWorkstationsV1betaArgs({
    ...
    required String workstationId,
       ...
       bindings = pulumi.Input.asOptionalInput<List<BindingWorkstationsV1beta>>(
         bindings,
       ),
    ...
    return <String, dynamic>{
      'auditConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuditConfigWorkstationsV1beta>,
      ...
      'bindings':
          ?pulumi.Input.mapOptionalInputValue<
            List<BindingWorkstationsV1beta>,
            List<Map<String, dynamic>>
          >(
            bindings,
            (value) =>
                pulumi.Input.encodeList<
                  BindingWorkstationsV1beta,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'etag': ?etag,
