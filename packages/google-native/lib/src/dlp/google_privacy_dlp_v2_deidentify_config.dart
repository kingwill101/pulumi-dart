...
class GooglePrivacyDlpV2DeidentifyConfig {
  ...
  final GooglePrivacyDlpV2TransformationErrorHandling?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'imageTransformations': ?imageTransformations == null
          ? null
          : imageTransformations!.toMap(),
      'infoTypeTransformations': ?infoTypeTransformations == null
          ? null
          : infoTypeTransformations!.toMap(),
      'recordTransformations': ?recordTransformations == null
          ? null
          : recordTransformations!.toMap(),
      'transformationErrorHandling': ?transformationErrorHandling == null
          ? null
          : transformationErrorHandling!.toMap(),
    };
  }
  ...
  factory GooglePrivacyDlpV2DeidentifyConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DeidentifyConfig(
      imageTransformations: map['imageTransformations'] == null
          ? null
          : GooglePrivacyDlpV2ImageTransformations.fromMap(
      ...
      recordTransformations: map['recordTransformations'] == null
          ? null
          : GooglePrivacyDlpV2RecordTransformations.fromMap(
              (map['recordTransformations'] as Map).cast<String, dynamic>(),
            ),
      transformationErrorHandling: map['transformationErrorHandling'] == null
          ? null
          : GooglePrivacyDlpV2TransformationErrorHandling.fromMap(
