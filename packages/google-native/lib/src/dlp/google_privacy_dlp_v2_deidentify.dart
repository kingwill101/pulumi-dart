...
class GooglePrivacyDlpV2Deidentify {
  ...
  final List<GooglePrivacyDlpV2DeidentifyFileTypesToTransformItem>? fileTypesToTransform;
  ...
  final GooglePrivacyDlpV2TransformationDetailsStorageConfig? transformationDetailsStorageConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileTypesToTransform': ?fileTypesToTransform == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2DeidentifyFileTypesToTransformItem, String>(fileTypesToTransform!, (value) => value.value),
  ...
  factory GooglePrivacyDlpV2Deidentify.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2Deidentify(
      ...
      fileTypesToTransform: map['fileTypesToTransform'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2DeidentifyFileTypesToTransformItem>(map['fileTypesToTransform'], (value) => GooglePrivacyDlpV2DeidentifyFileTypesToTransformItem.fromValue(value as String)),
      transformationConfig: map['transformationConfig'] == null ? null : GooglePrivacyDlpV2TransformationConfig.fromMap((map['transformationConfig'] as Map).cast<String, dynamic>()),
      transformationDetailsStorageConfig: map['transformationDetailsStorageConfig'] == null ? null : GooglePrivacyDlpV2TransformationDetailsStorageConfig.fromMap((map['transformationDetailsStorageConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
