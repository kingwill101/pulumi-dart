...
class GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig {
  /// Common alphabets.
  final GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigCommonAlphabet? commonAlphabet;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'commonAlphabet': ?commonAlphabet == null ? null : commonAlphabet!.value,
  ...
  factory GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig(
      commonAlphabet: map['commonAlphabet'] == null ? null : GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigCommonAlphabet.fromValue(map['commonAlphabet'] as String),
      context: map['context'] == null ? null : GooglePrivacyDlpV2FieldId.fromMap((map['context'] as Map).cast<String, dynamic>()),
      cryptoKey: GooglePrivacyDlpV2CryptoKey.fromMap((map['cryptoKey'] as Map).cast<String, dynamic>()),
      customAlphabet: map['customAlphabet'] == null ? null : map['customAlphabet'] as String,
      radix: map['radix'] == null ? null : map['radix'] as int,
      surrogateInfoType: map['surrogateInfoType'] == null ? null : GooglePrivacyDlpV2InfoType.fromMap((map['surrogateInfoType'] as Map).cast<String, dynamic>()),
    );
  }
}
