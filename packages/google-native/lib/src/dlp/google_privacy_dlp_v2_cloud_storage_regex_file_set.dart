...
class GooglePrivacyDlpV2CloudStorageRegexFileSet {
  ...
  /// Creates a new [GooglePrivacyDlpV2CloudStorageRegexFileSet].
  ...
  Map<String, dynamic> toMap() {
    ...
    final excludeRegexValue = excludeRegex;
    if (excludeRegexValue != null) {
      map['excludeRegex'] = excludeRegexValue;
    }
    final includeRegexValue = includeRegex;
    if (includeRegexValue != null) {
      map['includeRegex'] = includeRegexValue;
    }
    return map;
  }
  ...
  factory GooglePrivacyDlpV2CloudStorageRegexFileSet.fromMap(
    ...
    return GooglePrivacyDlpV2CloudStorageRegexFileSet(
      ...
      excludeRegex: map['excludeRegex'] == null
          ? null
          : (map['excludeRegex'] as List).cast<String>(),
      includeRegex: map['includeRegex'] == null
          ? null
          : (map['includeRegex'] as List).cast<String>(),
    );
  }
}
