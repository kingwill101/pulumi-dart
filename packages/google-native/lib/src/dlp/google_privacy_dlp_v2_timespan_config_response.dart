...
class GooglePrivacyDlpV2TimespanConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endTime': endTime,
      'startTime': startTime,
      'timestampField': timestampField.toMap(),
    };
  }
  ...
  factory GooglePrivacyDlpV2TimespanConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2TimespanConfigResponse(
      enableAutoPopulationOfTimespanConfig: map['enableAutoPopulationOfTimespanConfig'] as bool,
      endTime: map['endTime'] as String,
      startTime: map['startTime'] as String,
      timestampField: GooglePrivacyDlpV2FieldIdResponse.fromMap((map['timestampField'] as Map).cast<String, dynamic>()),
    );
  }
}
