...
class OrganizationJobTriggerArgs {
  ...
  OrganizationJobTriggerArgs({
    ...
    required OrganizationJobTriggerStatus status,
    String? triggerId,
    List<GooglePrivacyDlpV2Trigger>? triggers,
        ...
        triggers =
            pulumi.Input.asOptionalInput<List<GooglePrivacyDlpV2Trigger>>(
                triggers);
  ...
  factory OrganizationJobTriggerArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationJobTriggerArgs(
      ...
      status: OrganizationJobTriggerStatus.fromValue(map['status'] as String),
      triggerId: map['triggerId'] == null ? null : map['triggerId'] as String,
      triggers: map['triggers'] == null
          ? null
          : pulumi.Input.decodeList<GooglePrivacyDlpV2Trigger>(
              map['triggers'],
              (value) => GooglePrivacyDlpV2Trigger.fromMap(
