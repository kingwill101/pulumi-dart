...
class GooglePrivacyDlpV2InspectConfigResponse {
  ...
  final List<GooglePrivacyDlpV2InfoTypeLikelihoodResponse> minLikelihoodPerInfoType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customInfoTypes': pulumi.Input.encodeList<GooglePrivacyDlpV2CustomInfoTypeResponse, Map<String, dynamic>>(customInfoTypes, (value) => value.toMap()),
      ...
      'minLikelihoodPerInfoType': pulumi.Input.encodeList<GooglePrivacyDlpV2InfoTypeLikelihoodResponse, Map<String, dynamic>>(minLikelihoodPerInfoType, (value) => value.toMap()),
      'ruleSet': pulumi.Input.encodeList<GooglePrivacyDlpV2InspectionRuleSetResponse, Map<String, dynamic>>(ruleSet, (value) => value.toMap()),
    };
  }
  ...
  factory GooglePrivacyDlpV2InspectConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectConfigResponse(
      ...
      customInfoTypes: pulumi.Input.decodeList<GooglePrivacyDlpV2CustomInfoTypeResponse>(map['customInfoTypes'], (value) => GooglePrivacyDlpV2CustomInfoTypeResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      limits: GooglePrivacyDlpV2FindingLimitsResponse.fromMap((map['limits'] as Map).cast<String, dynamic>()),
      minLikelihood: map['minLikelihood'] as String,
      minLikelihoodPerInfoType: pulumi.Input.decodeList<GooglePrivacyDlpV2InfoTypeLikelihoodResponse>(map['minLikelihoodPerInfoType'], (value) => GooglePrivacyDlpV2InfoTypeLikelihoodResponse.fromMap((value as Map).cast<String, dynamic>())),
      ruleSet: pulumi.Input.decodeList<GooglePrivacyDlpV2InspectionRuleSetResponse>(map['ruleSet'], (value) => GooglePrivacyDlpV2InspectionRuleSetResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
