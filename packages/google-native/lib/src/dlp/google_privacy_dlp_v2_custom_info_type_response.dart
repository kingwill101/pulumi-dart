...
class GooglePrivacyDlpV2CustomInfoTypeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'detectionRules': pulumi.Input.encodeList<GooglePrivacyDlpV2DetectionRuleResponse, Map<String, dynamic>>(detectionRules, (value) => value.toMap()),
      'dictionary': dictionary.toMap(),
      'exclusionType': exclusionType,
      'infoType': infoType.toMap(),
      'likelihood': likelihood,
      'regex': regex.toMap(),
      'sensitivityScore': sensitivityScore.toMap(),
      'storedType': storedType.toMap(),
  ...
  factory GooglePrivacyDlpV2CustomInfoTypeResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CustomInfoTypeResponse(
      detectionRules: pulumi.Input.decodeList<GooglePrivacyDlpV2DetectionRuleResponse>(map['detectionRules'], (value) => GooglePrivacyDlpV2DetectionRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sensitivityScore: GooglePrivacyDlpV2SensitivityScoreResponse.fromMap((map['sensitivityScore'] as Map).cast<String, dynamic>()),
      storedType: GooglePrivacyDlpV2StoredTypeResponse.fromMap((map['storedType'] as Map).cast<String, dynamic>()),
