...
class GooglePrivacyDlpV2DeidentifyConfigResponse {
  ...
  final GooglePrivacyDlpV2InfoTypeTransformationsResponse infoTypeTransformations;
  ...
  final GooglePrivacyDlpV2TransformationErrorHandlingResponse transformationErrorHandling;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'infoTypeTransformations': infoTypeTransformations.toMap(),
      'recordTransformations': recordTransformations.toMap(),
      'transformationErrorHandling': transformationErrorHandling.toMap(),
    };
  }
  ...
  factory GooglePrivacyDlpV2DeidentifyConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DeidentifyConfigResponse(
      imageTransformations: GooglePrivacyDlpV2ImageTransformationsResponse.fromMap((map['imageTransformations'] as Map).cast<String, dynamic>()),
      infoTypeTransformations: GooglePrivacyDlpV2InfoTypeTransformationsResponse.fromMap((map['infoTypeTransformations'] as Map).cast<String, dynamic>()),
      recordTransformations: GooglePrivacyDlpV2RecordTransformationsResponse.fromMap((map['recordTransformations'] as Map).cast<String, dynamic>()),
      transformationErrorHandling: GooglePrivacyDlpV2TransformationErrorHandlingResponse.fromMap((map['transformationErrorHandling'] as Map).cast<String, dynamic>()),
    );
  }
}
