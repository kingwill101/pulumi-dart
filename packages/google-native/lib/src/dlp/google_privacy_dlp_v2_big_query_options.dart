...
class GooglePrivacyDlpV2BigQueryOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludedFields': ?excludedFields == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2FieldId, Map<String, dynamic>>(excludedFields!, (value) => value.toMap()),
      ...
      'includedFields': ?includedFields == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2FieldId, Map<String, dynamic>>(includedFields!, (value) => value.toMap()),
      'rowsLimit': ?rowsLimit,
      'rowsLimitPercent': ?rowsLimitPercent,
      'sampleMethod': ?sampleMethod == null ? null : sampleMethod!.value,
  ...
  factory GooglePrivacyDlpV2BigQueryOptions.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2BigQueryOptions(
      excludedFields: map['excludedFields'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2FieldId>(map['excludedFields'], (value) => GooglePrivacyDlpV2FieldId.fromMap((value as Map).cast<String, dynamic>())),
      ...
      includedFields: map['includedFields'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2FieldId>(map['includedFields'], (value) => GooglePrivacyDlpV2FieldId.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sampleMethod: map['sampleMethod'] == null ? null : GooglePrivacyDlpV2BigQueryOptionsSampleMethod.fromValue(map['sampleMethod'] as String),
      tableReference: map['tableReference'] == null ? null : GooglePrivacyDlpV2BigQueryTable.fromMap((map['tableReference'] as Map).cast<String, dynamic>()),
    );
  }
}
