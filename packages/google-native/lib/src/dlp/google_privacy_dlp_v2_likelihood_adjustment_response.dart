...
class GooglePrivacyDlpV2LikelihoodAdjustmentResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['fixedLikelihood'] = fixedLikelihood;
    map['relativeLikelihood'] = relativeLikelihood;
    return map;
  }

  factory GooglePrivacyDlpV2LikelihoodAdjustmentResponse.fromMap(
      Map<String, dynamic> map) {
    return GooglePrivacyDlpV2LikelihoodAdjustmentResponse(
      fixedLikelihood: map['fixedLikelihood'] as String,
      relativeLikelihood: map['relativeLikelihood'] as int,
    );
  }
}
