...
class GooglePrivacyDlpV2FileSetResponse {
  ...
  final GooglePrivacyDlpV2CloudStorageRegexFileSetResponse regexFileSet;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'regexFileSet': regexFileSet.toMap(),
      'url': url,
    };
  }
  ...
  factory GooglePrivacyDlpV2FileSetResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2FileSetResponse(
      regexFileSet: GooglePrivacyDlpV2CloudStorageRegexFileSetResponse.fromMap((map['regexFileSet'] as Map).cast<String, dynamic>()),
