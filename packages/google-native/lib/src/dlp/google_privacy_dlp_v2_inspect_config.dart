...
class GooglePrivacyDlpV2InspectConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentOptions': ?contentOptions == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2InspectConfigContentOptionsItem, String>(contentOptions!, (value) => value.value),
      'customInfoTypes': ?customInfoTypes == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2CustomInfoType, Map<String, dynamic>>(customInfoTypes!, (value) => value.toMap()),
      ...
      'minLikelihoodPerInfoType': ?minLikelihoodPerInfoType == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2InfoTypeLikelihood, Map<String, dynamic>>(minLikelihoodPerInfoType!, (value) => value.toMap()),
      'ruleSet': ?ruleSet == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2InspectionRuleSet, Map<String, dynamic>>(ruleSet!, (value) => value.toMap()),
    };
  }

  factory GooglePrivacyDlpV2InspectConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectConfig(
      contentOptions: map['contentOptions'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2InspectConfigContentOptionsItem>(map['contentOptions'], (value) => GooglePrivacyDlpV2InspectConfigContentOptionsItem.fromValue(value as String)),
      customInfoTypes: map['customInfoTypes'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2CustomInfoType>(map['customInfoTypes'], (value) => GooglePrivacyDlpV2CustomInfoType.fromMap((value as Map).cast<String, dynamic>())),
      excludeInfoTypes: map['excludeInfoTypes'] == null ? null : map['excludeInfoTypes'] as bool,
      includeQuote: map['includeQuote'] == null ? null : map['includeQuote'] as bool,
      ...
      limits: map['limits'] == null ? null : GooglePrivacyDlpV2FindingLimits.fromMap((map['limits'] as Map).cast<String, dynamic>()),
      minLikelihood: map['minLikelihood'] == null ? null : GooglePrivacyDlpV2InspectConfigMinLikelihood.fromValue(map['minLikelihood'] as String),
      minLikelihoodPerInfoType: map['minLikelihoodPerInfoType'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2InfoTypeLikelihood>(map['minLikelihoodPerInfoType'], (value) => GooglePrivacyDlpV2InfoTypeLikelihood.fromMap((value as Map).cast<String, dynamic>())),
      ruleSet: map['ruleSet'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2InspectionRuleSet>(map['ruleSet'], (value) => GooglePrivacyDlpV2InspectionRuleSet.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
