...
/// {@template pulumi_dlp_v2_organization_discovery_config_args_doc}
/// The set of arguments for OrganizationDiscoveryConfig.
/// {@endtemplate}
/// {@macro pulumi_dlp_v2_organization_discovery_config_args_doc}
class OrganizationDiscoveryConfigArgs {
  ...
  final pulumi.Input<OrganizationDiscoveryConfigStatus> status;
  /// Target to match against for determining what to scan and how frequently.
  final pulumi.Input<List<GooglePrivacyDlpV2DiscoveryTarget>>? targets;

  /// Creates a new [OrganizationDiscoveryConfigArgs].
  ...
  OrganizationDiscoveryConfigArgs({
    ...
    required OrganizationDiscoveryConfigStatus status,
    List<GooglePrivacyDlpV2DiscoveryTarget>? targets,
  }) :
      actions = pulumi.Input.asOptionalInput<List<GooglePrivacyDlpV2DataProfileAction>>(actions),
      ...
      orgConfig = pulumi.Input.asOptionalInput<GooglePrivacyDlpV2OrgConfig>(orgConfig),
      organizationId = pulumi.Input.asInput<String>(organizationId),
      status = pulumi.Input.asInput<OrganizationDiscoveryConfigStatus>(status),
      targets = pulumi.Input.asOptionalInput<List<GooglePrivacyDlpV2DiscoveryTarget>>(targets);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': ?pulumi.Input.mapOptionalInputValue<List<GooglePrivacyDlpV2DataProfileAction>, List<Map<String, dynamic>>>(actions, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2DataProfileAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'configId': ?configId,
      'displayName': ?displayName,
      'inspectTemplates': ?inspectTemplates,
      'location': ?location,
      'name': ?name,
      'orgConfig': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2OrgConfig, Map<String, dynamic>>(orgConfig, (value) => value.toMap()),
      'organizationId': organizationId,
      'status': pulumi.Input.mapInputValue<OrganizationDiscoveryConfigStatus, String>(status, (value) => value.value),
      'targets': ?pulumi.Input.mapOptionalInputValue<List<GooglePrivacyDlpV2DiscoveryTarget>, List<Map<String, dynamic>>>(targets, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2DiscoveryTarget, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory OrganizationDiscoveryConfigArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationDiscoveryConfigArgs(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2DataProfileAction>(map['actions'], (value) => GooglePrivacyDlpV2DataProfileAction.fromMap((value as Map).cast<String, dynamic>())),
      configId: map['configId'] == null ? null : map['configId'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      inspectTemplates: map['inspectTemplates'] == null ? null : (map['inspectTemplates'] as List).cast<String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      orgConfig: map['orgConfig'] == null ? null : GooglePrivacyDlpV2OrgConfig.fromMap((map['orgConfig'] as Map).cast<String, dynamic>()),
      organizationId: map['organizationId'] as String,
      status: OrganizationDiscoveryConfigStatus.fromValue(map['status'] as String),
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2DiscoveryTarget>(map['targets'], (value) => GooglePrivacyDlpV2DiscoveryTarget.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
