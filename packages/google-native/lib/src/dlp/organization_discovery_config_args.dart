...
class OrganizationDiscoveryConfigArgs {
  ...
  OrganizationDiscoveryConfigArgs({
    ...
    List<GooglePrivacyDlpV2DiscoveryTarget>? targets,
        ...
        status =
            pulumi.Input.asInput<OrganizationDiscoveryConfigStatus>(status),
        targets = pulumi.Input.asOptionalInput<
            List<GooglePrivacyDlpV2DiscoveryTarget>>(targets);
  ...
  Map<String, dynamic> toMap() {
    ...
    map['status'] =
        pulumi.Input.mapInputValue<OrganizationDiscoveryConfigStatus, String>(
  ...
  factory OrganizationDiscoveryConfigArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationDiscoveryConfigArgs(
      ...
      status:
          OrganizationDiscoveryConfigStatus.fromValue(map['status'] as String),
