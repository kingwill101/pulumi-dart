...
class GooglePrivacyDlpV2CloudStorageRegexFileSetResponse {
  ...
  final List<String> includeRegex;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['excludeRegex'] = excludeRegex;
    map['includeRegex'] = includeRegex;
    return map;
  }

  factory GooglePrivacyDlpV2CloudStorageRegexFileSetResponse.fromMap(
      Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CloudStorageRegexFileSetResponse(
      bucketName: map['bucketName'] as String,
      excludeRegex: (map['excludeRegex'] as List).cast<String>(),
      includeRegex: (map['includeRegex'] as List).cast<String>(),
    );
  }
}
