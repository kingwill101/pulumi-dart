...
class GooglePrivacyDlpV2LDiversityConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'quasiIds': ?quasiIds == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2FieldId, Map<String, dynamic>>(quasiIds!, (value) => value.toMap()),
      'sensitiveAttribute': ?sensitiveAttribute == null ? null : sensitiveAttribute!.toMap(),
    };
  }

  factory GooglePrivacyDlpV2LDiversityConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2LDiversityConfig(
      quasiIds: map['quasiIds'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2FieldId>(map['quasiIds'], (value) => GooglePrivacyDlpV2FieldId.fromMap((value as Map).cast<String, dynamic>())),
      sensitiveAttribute: map['sensitiveAttribute'] == null ? null : GooglePrivacyDlpV2FieldId.fromMap((map['sensitiveAttribute'] as Map).cast<String, dynamic>()),
    );
  }
}
