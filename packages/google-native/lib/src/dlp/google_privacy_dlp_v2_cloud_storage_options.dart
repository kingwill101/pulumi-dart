...
class GooglePrivacyDlpV2CloudStorageOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileSet': ?fileSet == null ? null : fileSet!.toMap(),
      'fileTypes': ?fileTypes == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2CloudStorageOptionsFileTypesItem, String>(fileTypes!, (value) => value.value),
  ...
  factory GooglePrivacyDlpV2CloudStorageOptions.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CloudStorageOptions(
      bytesLimitPerFile: map['bytesLimitPerFile'] == null ? null : map['bytesLimitPerFile'] as String,
      bytesLimitPerFilePercent: map['bytesLimitPerFilePercent'] == null ? null : map['bytesLimitPerFilePercent'] as int,
      fileSet: map['fileSet'] == null ? null : GooglePrivacyDlpV2FileSet.fromMap((map['fileSet'] as Map).cast<String, dynamic>()),
      fileTypes: map['fileTypes'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2CloudStorageOptionsFileTypesItem>(map['fileTypes'], (value) => GooglePrivacyDlpV2CloudStorageOptionsFileTypesItem.fromValue(value as String)),
      filesLimitPercent: map['filesLimitPercent'] == null ? null : map['filesLimitPercent'] as int,
      sampleMethod: map['sampleMethod'] == null ? null : GooglePrivacyDlpV2CloudStorageOptionsSampleMethod.fromValue(map['sampleMethod'] as String),
    );
  }
}
