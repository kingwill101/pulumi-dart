...
class BackupAlloydbV1betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': ?pulumi.Input.mapOptionalInputValue<BackupTypeAlloydbV1beta, String>(type, (value) => value.value),
    };
  }
  ...
  factory BackupAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return BackupAlloydbV1betaArgs(
      ...
      type: map['type'] == null ? null : BackupTypeAlloydbV1beta.fromValue(map['type'] as String),
    );
  }
}
