...
class GoogleTypeTimeOfDayAlloydbV1alpha {
  ...
  /// Creates a new [GoogleTypeTimeOfDayAlloydbV1alpha].
  ...
  factory GoogleTypeTimeOfDayAlloydbV1alpha.fromMap(Map<String, dynamic> map) {
    return GoogleTypeTimeOfDayAlloydbV1alpha(
