...
class ClusterAlloydbV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AutomatedBackupPolicyResponseAlloydbV1alpha>
  ...
  late final pulumi.Output<ContinuousBackupConfigResponseAlloydbV1alpha>
  continuousBackupConfig;

  /// Continuous backup properties for this cluster.
  late final pulumi.Output<ContinuousBackupInfoResponseAlloydbV1alpha>
  ...
  late final pulumi.Output<MigrationSourceResponseAlloydbV1alpha>
  migrationSource;
  ...
  late final pulumi.Output<SecondaryConfigResponseAlloydbV1alpha>
  secondaryConfig;
  ...
  ClusterAlloydbV1alpha(
    ...
    this.backupSource = registerOutput<BackupSourceResponseAlloydbV1alpha>(
      'backupSource',
    );
    ...
    this.initialUser = registerOutput<UserPasswordResponseAlloydbV1alpha>(
      'initialUser',
    );
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.migrationSource =
        registerOutput<MigrationSourceResponseAlloydbV1alpha>(
          'migrationSource',
        );
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig = registerOutput<NetworkConfigResponseAlloydbV1alpha>(
      'networkConfig',
    );
    this.primaryConfig = registerOutput<PrimaryConfigResponseAlloydbV1alpha>(
      'primaryConfig',
    );
    ...
    this.secondaryConfig =
        registerOutput<SecondaryConfigResponseAlloydbV1alpha>(
          'secondaryConfig',
        );
    this.sslConfig = registerOutput<SslConfigResponseAlloydbV1alpha>(
      'sslConfig',
    );
