  ...
  ClusterAlloydbV1alpha(
    ...
    this.automatedBackupPolicy =
        registerOutput<AutomatedBackupPolicyResponseAlloydbV1alpha>(
            'automatedBackupPolicy');
    this.backupSource =
        registerOutput<BackupSourceResponseAlloydbV1alpha>('backupSource');
    ...
    this.initialUser =
        registerOutput<UserPasswordResponseAlloydbV1alpha>('initialUser');
    ...
    this.networkConfig =
        registerOutput<NetworkConfigResponseAlloydbV1alpha>('networkConfig');
    this.primaryConfig =
        registerOutput<PrimaryConfigResponseAlloydbV1alpha>('primaryConfig');
    ...
    this.secondaryConfig =
        registerOutput<SecondaryConfigResponseAlloydbV1alpha>(
            'secondaryConfig');
    this.sslConfig =
        registerOutput<SslConfigResponseAlloydbV1alpha>('sslConfig');
