  ...
  factory GetClusterAlloydbV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetClusterAlloydbV1alphaResult(
      ...
      automatedBackupPolicy:
          AutomatedBackupPolicyResponseAlloydbV1alpha.fromMap(
              (map['automatedBackupPolicy'] as Map).cast<String, dynamic>()),
      backupSource: BackupSourceResponseAlloydbV1alpha.fromMap(
          (map['backupSource'] as Map).cast<String, dynamic>()),
      clusterType: map['clusterType'] as String,
      continuousBackupConfig:
          ContinuousBackupConfigResponseAlloydbV1alpha.fromMap(
              (map['continuousBackupConfig'] as Map).cast<String, dynamic>()),
      continuousBackupInfo: ContinuousBackupInfoResponseAlloydbV1alpha.fromMap(
      ...
      initialUser: UserPasswordResponseAlloydbV1alpha.fromMap(
          (map['initialUser'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      migrationSource: MigrationSourceResponseAlloydbV1alpha.fromMap(
          (map['migrationSource'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: map['network'] as String,
      networkConfig: NetworkConfigResponseAlloydbV1alpha.fromMap(
          (map['networkConfig'] as Map).cast<String, dynamic>()),
      primaryConfig: PrimaryConfigResponseAlloydbV1alpha.fromMap(
      ...
      secondaryConfig: SecondaryConfigResponseAlloydbV1alpha.fromMap(
