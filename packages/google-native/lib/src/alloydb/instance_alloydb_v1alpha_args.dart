...
class InstanceAlloydbV1alphaArgs {
  ...
  InstanceAlloydbV1alphaArgs({
    ...
    UpdatePolicy? updatePolicy,
       ...
       machineConfig = pulumi
           .Input.asOptionalInput<MachineConfigAlloydbV1alpha>(machineConfig),
       ...
       readPoolConfig = pulumi
           .Input.asOptionalInput<ReadPoolConfigAlloydbV1alpha>(readPoolConfig),
  ...
  factory InstanceAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1alphaArgs(
      ...
      instanceType: InstanceInstanceTypeAlloydbV1alpha.fromValue(
