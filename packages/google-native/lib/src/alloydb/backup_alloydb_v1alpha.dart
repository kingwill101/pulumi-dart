...
class BackupAlloydbV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EncryptionConfigResponseAlloydbV1alpha>
  encryptionConfig;
  ...
  late final pulumi.Output<QuantityBasedExpiryResponseAlloydbV1alpha>
  expiryQuantity;
  ...
  BackupAlloydbV1alpha(
    ...
    this.encryptionConfig =
        registerOutput<EncryptionConfigResponseAlloydbV1alpha>(
          'encryptionConfig',
        );
    this.encryptionInfo = registerOutput<EncryptionInfoResponseAlloydbV1alpha>(
      'encryptionInfo',
    );
    this.etag = registerOutput<String>('etag');
    this.expiryQuantity =
        registerOutput<QuantityBasedExpiryResponseAlloydbV1alpha>(
          'expiryQuantity',
        );
