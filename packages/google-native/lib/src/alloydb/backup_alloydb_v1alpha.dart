...
import 'backup_alloydb_v1alpha_args.dart';
...
class BackupAlloydbV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EncryptionConfigResponseAlloydbV1alpha> encryptionConfig;
  /// The encryption information for the backup.
  late final pulumi.Output<EncryptionInfoResponseAlloydbV1alpha> encryptionInfo;
  ...
  late final pulumi.Output<QuantityBasedExpiryResponseAlloydbV1alpha> expiryQuantity;
  ...
  /// Creates a new [BackupAlloydbV1alpha].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackupAlloydbV1alpha]. {@macro pulumi_alloydb_v1alpha_backup_alloydb_v1alpha_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BackupAlloydbV1alpha(
    String name, {
    BackupAlloydbV1alphaArgs? args,
    ...
    this.encryptionConfig = registerOutput<EncryptionConfigResponseAlloydbV1alpha>('encryptionConfig');
    this.encryptionInfo = registerOutput<EncryptionInfoResponseAlloydbV1alpha>('encryptionInfo');
    this.etag = registerOutput<String>('etag');
    this.expiryQuantity = registerOutput<QuantityBasedExpiryResponseAlloydbV1alpha>('expiryQuantity');
