...
class InstanceAlloydbV1alpha extends pulumi.CustomResource {
  ...
  InstanceAlloydbV1alpha(
    ...
    this.clientConnectionConfig = registerOutput<ClientConnectionConfigResponseAlloydbV1alpha>('clientConnectionConfig');
    ...
    this.machineConfig = registerOutput<MachineConfigResponseAlloydbV1alpha>('machineConfig');
    this.name = registerOutput<String>('name');
    this.nodes = registerOutput<List<NodeResponseAlloydbV1alpha>>('nodes');
    this.project = registerOutput<String>('project');
    this.queryInsightsConfig = registerOutput<QueryInsightsInstanceConfigResponseAlloydbV1alpha>('queryInsightsConfig');
    this.readPoolConfig = registerOutput<ReadPoolConfigResponseAlloydbV1alpha>('readPoolConfig');
    ...
    this.writableNode = registerOutput<NodeResponseAlloydbV1alpha>('writableNode');
  }
}
