...
class InstanceAlloydbV1alpha extends pulumi.CustomResource {
  ...
  InstanceAlloydbV1alpha(
    ...
    this.machineConfig = registerOutput<MachineConfigResponseAlloydbV1alpha>(
      'machineConfig',
    );
    ...
    this.readPoolConfig = registerOutput<ReadPoolConfigResponseAlloydbV1alpha>(
      'readPoolConfig',
    );
    ...
    this.writableNode = registerOutput<NodeResponseAlloydbV1alpha>(
      'writableNode',
    );
  }
}
