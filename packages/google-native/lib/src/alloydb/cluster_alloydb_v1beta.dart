  ...
  ClusterAlloydbV1beta(
    ...
    this.automatedBackupPolicy =
        registerOutput<AutomatedBackupPolicyResponseAlloydbV1beta>(
            'automatedBackupPolicy');
    this.backupSource =
        registerOutput<BackupSourceResponseAlloydbV1beta>('backupSource');
    ...
    this.encryptionConfig =
        registerOutput<EncryptionConfigResponseAlloydbV1beta>(
            'encryptionConfig');
    this.encryptionInfo =
        registerOutput<EncryptionInfoResponseAlloydbV1beta>('encryptionInfo');
    this.etag = registerOutput<String>('etag');
    this.initialUser =
        registerOutput<UserPasswordResponseAlloydbV1beta>('initialUser');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.migrationSource =
        registerOutput<MigrationSourceResponseAlloydbV1beta>('migrationSource');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig =
        registerOutput<NetworkConfigResponseAlloydbV1beta>('networkConfig');
    this.primaryConfig =
        registerOutput<PrimaryConfigResponseAlloydbV1beta>('primaryConfig');
    this.project = registerOutput<String>('project');
    this.reconciling = registerOutput<bool>('reconciling');
    this.requestId = registerOutput<String?>('requestId');
    this.secondaryConfig =
        registerOutput<SecondaryConfigResponseAlloydbV1beta>('secondaryConfig');
    this.sslConfig =
        registerOutput<SslConfigResponseAlloydbV1beta>('sslConfig');
