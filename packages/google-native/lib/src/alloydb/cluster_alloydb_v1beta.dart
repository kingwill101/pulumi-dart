...
class ClusterAlloydbV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AutomatedBackupPolicyResponseAlloydbV1beta>
  ...
  late final pulumi.Output<ContinuousBackupConfigResponseAlloydbV1beta>
  continuousBackupConfig;

  /// Continuous backup properties for this cluster.
  late final pulumi.Output<ContinuousBackupInfoResponseAlloydbV1beta>
  ...
  late final pulumi.Output<EncryptionConfigResponseAlloydbV1beta>
  encryptionConfig;
  ...
  late final pulumi.Output<MigrationSourceResponseAlloydbV1beta>
  migrationSource;
  ...
  late final pulumi.Output<SecondaryConfigResponseAlloydbV1beta>
  secondaryConfig;
  ...
  ClusterAlloydbV1beta(
    ...
    this.automatedBackupPolicy =
        registerOutput<AutomatedBackupPolicyResponseAlloydbV1beta>(
          'automatedBackupPolicy',
        );
    this.backupSource = registerOutput<BackupSourceResponseAlloydbV1beta>(
      'backupSource',
    );
    this.clusterId = registerOutput<String>('clusterId');
    this.clusterType = registerOutput<String>('clusterType');
    this.continuousBackupConfig =
        registerOutput<ContinuousBackupConfigResponseAlloydbV1beta>(
          'continuousBackupConfig',
        );
    this.continuousBackupInfo =
        registerOutput<ContinuousBackupInfoResponseAlloydbV1beta>(
          'continuousBackupInfo',
        );
    ...
    this.encryptionConfig =
        registerOutput<EncryptionConfigResponseAlloydbV1beta>(
          'encryptionConfig',
        );
    this.encryptionInfo = registerOutput<EncryptionInfoResponseAlloydbV1beta>(
      'encryptionInfo',
    );
    this.etag = registerOutput<String>('etag');
    this.initialUser = registerOutput<UserPasswordResponseAlloydbV1beta>(
      'initialUser',
    );
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.migrationSource = registerOutput<MigrationSourceResponseAlloydbV1beta>(
      'migrationSource',
    );
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig = registerOutput<NetworkConfigResponseAlloydbV1beta>(
      'networkConfig',
    );
    this.primaryConfig = registerOutput<PrimaryConfigResponseAlloydbV1beta>(
      'primaryConfig',
    );
    this.project = registerOutput<String>('project');
    this.reconciling = registerOutput<bool>('reconciling');
    this.requestId = registerOutput<String?>('requestId');
    this.secondaryConfig = registerOutput<SecondaryConfigResponseAlloydbV1beta>(
      'secondaryConfig',
    );
    this.sslConfig = registerOutput<SslConfigResponseAlloydbV1beta>(
      'sslConfig',
    );
