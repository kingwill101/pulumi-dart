...
class AutomatedBackupPolicyAlloydbV1beta {
  ...
  factory AutomatedBackupPolicyAlloydbV1beta.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicyAlloydbV1beta(
      ...
      quantityBasedRetention: map['quantityBasedRetention'] == null ? null : QuantityBasedRetentionAlloydbV1beta.fromMap((map['quantityBasedRetention'] as Map).cast<String, dynamic>()),
      timeBasedRetention: map['timeBasedRetention'] == null ? null : TimeBasedRetentionAlloydbV1beta.fromMap((map['timeBasedRetention'] as Map).cast<String, dynamic>()),
      weeklySchedule: map['weeklySchedule'] == null ? null : WeeklyScheduleAlloydbV1beta.fromMap((map['weeklySchedule'] as Map).cast<String, dynamic>()),
    );
  }
}
