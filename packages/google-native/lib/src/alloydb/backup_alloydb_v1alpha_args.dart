...
class BackupAlloydbV1alphaArgs {
  ...
  BackupAlloydbV1alphaArgs({
    ...
    BackupTypeAlloydbV1alpha? type,
       ...
       type = pulumi.Input.asOptionalInput<BackupTypeAlloydbV1alpha>(type);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'type':
          ?pulumi.Input.mapOptionalInputValue<BackupTypeAlloydbV1alpha, String>(
            type,
            (value) => value.value,
          ),
    };
  ...
  factory BackupAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return BackupAlloydbV1alphaArgs(
      ...
      type: map['type'] == null
          ? null
          : BackupTypeAlloydbV1alpha.fromValue(map['type'] as String),
    );
  }
}
