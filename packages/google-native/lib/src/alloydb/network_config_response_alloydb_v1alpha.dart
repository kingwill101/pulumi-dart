...
class NetworkConfigResponseAlloydbV1alpha {
  ...
  /// Creates a new [NetworkConfigResponseAlloydbV1alpha].
  ...
  NetworkConfigResponseAlloydbV1alpha({
  ...
  factory NetworkConfigResponseAlloydbV1alpha.fromMap(
      Map<String, dynamic> map) {
    return NetworkConfigResponseAlloydbV1alpha(
