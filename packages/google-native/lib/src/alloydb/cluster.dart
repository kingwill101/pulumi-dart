...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.automatedBackupPolicy = registerOutput<AutomatedBackupPolicyResponse>(
    ...
    this.continuousBackupInfo = registerOutput<ContinuousBackupInfoResponse>(
    ...
    this.migrationSource = registerOutput<MigrationSourceResponse>(
      'migrationSource',
    );
    ...
    this.secondaryConfig = registerOutput<SecondaryConfigResponse>(
      'secondaryConfig',
    );
