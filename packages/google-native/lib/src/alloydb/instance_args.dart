...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? requestId,
        ...
        availabilityType =
            pulumi.Input.asOptionalInput<InstanceAvailabilityType>(
                availabilityType),
        ...
        machineConfig =
            pulumi.Input.asOptionalInput<MachineConfig>(machineConfig),
        project = pulumi.Input.asOptionalInput<String>(project),
        queryInsightsConfig =
            pulumi.Input.asOptionalInput<QueryInsightsInstanceConfig>(
                queryInsightsConfig),
        readPoolConfig =
            pulumi.Input.asOptionalInput<ReadPoolConfig>(readPoolConfig),
