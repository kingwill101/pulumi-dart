...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? requestId,
       ...
       availabilityType = pulumi
           .Input.asOptionalInput<InstanceAvailabilityType>(availabilityType),
       ...
       machineConfig = pulumi.Input.asOptionalInput<MachineConfig>(
         machineConfig,
       ),
       ...
       readPoolConfig = pulumi.Input.asOptionalInput<ReadPoolConfig>(
         readPoolConfig,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instanceType': pulumi.Input.mapInputValue<InstanceInstanceType, String>(
        instanceType,
        (value) => value.value,
      ),
      'labels': ?labels,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      instanceType: InstanceInstanceType.fromValue(
