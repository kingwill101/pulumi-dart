...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    InstanceAvailabilityType? availabilityType,
    ...
    required InstanceInstanceType instanceType,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      availabilityType: map['availabilityType'] == null ? null : InstanceAvailabilityType.fromValue(map['availabilityType'] as String),
      clientConnectionConfig: map['clientConnectionConfig'] == null ? null : ClientConnectionConfig.fromMap((map['clientConnectionConfig'] as Map).cast<String, dynamic>()),
      ...
      instanceType: InstanceInstanceType.fromValue(map['instanceType'] as String),
      ...
      queryInsightsConfig: map['queryInsightsConfig'] == null ? null : QueryInsightsInstanceConfig.fromMap((map['queryInsightsConfig'] as Map).cast<String, dynamic>()),
      readPoolConfig: map['readPoolConfig'] == null ? null : ReadPoolConfig.fromMap((map['readPoolConfig'] as Map).cast<String, dynamic>()),
