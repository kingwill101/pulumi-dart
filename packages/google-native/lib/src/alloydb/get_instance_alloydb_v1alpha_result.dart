...
class GetInstanceAlloydbV1alphaResult {
  ...
  final ClientConnectionConfigResponseAlloydbV1alpha clientConnectionConfig;
  ...
  final MachineConfigResponseAlloydbV1alpha machineConfig;
  ...
  final List<NodeResponseAlloydbV1alpha> nodes;

  /// Configuration for query insights.
  final QueryInsightsInstanceConfigResponseAlloydbV1alpha queryInsightsConfig;

  /// Read pool instance configuration. This is required if the value of instanceType is READ_POOL.
  final ReadPoolConfigResponseAlloydbV1alpha readPoolConfig;
  ...
  final UpdatePolicyResponse updatePolicy;

  /// Update time stamp
  final String updateTime;

  /// This is set for the read-write VM of the PRIMARY instance only.
  final NodeResponseAlloydbV1alpha writableNode;

  /// Creates a new [GetInstanceAlloydbV1alphaResult].
  ...
  GetInstanceAlloydbV1alphaResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['nodes'] = pulumi.Input.encodeList<NodeResponseAlloydbV1alpha,
  ...
  factory GetInstanceAlloydbV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceAlloydbV1alphaResult(
      annotations: (map['annotations'] as Map).cast<String, String>(),
      availabilityType: map['availabilityType'] as String,
      clientConnectionConfig:
          ClientConnectionConfigResponseAlloydbV1alpha.fromMap(
      ...
      machineConfig: MachineConfigResponseAlloydbV1alpha.fromMap(
          (map['machineConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      nodes: pulumi.Input.decodeList<NodeResponseAlloydbV1alpha>(
          map['nodes'],
          (value) => NodeResponseAlloydbV1alpha.fromMap(
              (value as Map).cast<String, dynamic>())),
      queryInsightsConfig:
          QueryInsightsInstanceConfigResponseAlloydbV1alpha.fromMap(
              (map['queryInsightsConfig'] as Map).cast<String, dynamic>()),
      readPoolConfig: ReadPoolConfigResponseAlloydbV1alpha.fromMap(
      ...
      updatePolicy: UpdatePolicyResponse.fromMap(
          (map['updatePolicy'] as Map).cast<String, dynamic>()),
      updateTime: map['updateTime'] as String,
      writableNode: NodeResponseAlloydbV1alpha.fromMap(
