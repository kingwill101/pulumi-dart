...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    SslConfig? sslConfig,
       ...
       automatedBackupPolicy = pulumi
           .Input.asOptionalInput<AutomatedBackupPolicy>(automatedBackupPolicy),
       ...
       secondaryConfig = pulumi.Input.asOptionalInput<SecondaryConfig>(
         secondaryConfig,
       ),
