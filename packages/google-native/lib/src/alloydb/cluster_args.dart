...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    SslConfig? sslConfig,
        ...
        automatedBackupPolicy =
            pulumi.Input.asOptionalInput<AutomatedBackupPolicy>(
                automatedBackupPolicy),
        clusterId = pulumi.Input.asInput<String>(clusterId),
        continuousBackupConfig =
            pulumi.Input.asOptionalInput<ContinuousBackupConfig>(
                continuousBackupConfig),
        databaseVersion = pulumi.Input.asOptionalInput<ClusterDatabaseVersion>(
            databaseVersion),
        ...
        secondaryConfig =
            pulumi.Input.asOptionalInput<SecondaryConfig>(secondaryConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (databaseVersionValue != null) {
      map['databaseVersion'] =
          pulumi.Input.mapOptionalInputValue<ClusterDatabaseVersion, String>(
    ...
    if (initialUserValue != null) {
      map['initialUser'] = pulumi.Input.mapOptionalInputValue<UserPassword,
