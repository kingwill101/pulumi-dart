...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterDatabaseVersion? databaseVersion,
    String? displayName,
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      automatedBackupPolicy: map['automatedBackupPolicy'] == null ? null : AutomatedBackupPolicy.fromMap((map['automatedBackupPolicy'] as Map).cast<String, dynamic>()),
      clusterId: map['clusterId'] as String,
      continuousBackupConfig: map['continuousBackupConfig'] == null ? null : ContinuousBackupConfig.fromMap((map['continuousBackupConfig'] as Map).cast<String, dynamic>()),
      databaseVersion: map['databaseVersion'] == null ? null : ClusterDatabaseVersion.fromValue(map['databaseVersion'] as String),
      ...
      initialUser: map['initialUser'] == null ? null : UserPassword.fromMap((map['initialUser'] as Map).cast<String, dynamic>()),
      ...
      secondaryConfig: map['secondaryConfig'] == null ? null : SecondaryConfig.fromMap((map['secondaryConfig'] as Map).cast<String, dynamic>()),
      sslConfig: map['sslConfig'] == null ? null : SslConfig.fromMap((map['sslConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
