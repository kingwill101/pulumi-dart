...
class GetInstanceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'nodes': pulumi.Input.encodeList<NodeResponse, Map<String, dynamic>>(
        nodes,
        (value) => value.toMap(),
      ),
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      ...
      clientConnectionConfig: ClientConnectionConfigResponse.fromMap(
      ...
      nodes: pulumi.Input.decodeList<NodeResponse>(
        map['nodes'],
        (value) => NodeResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      queryInsightsConfig: QueryInsightsInstanceConfigResponse.fromMap(
        (map['queryInsightsConfig'] as Map).cast<String, dynamic>(),
      ),
      readPoolConfig: ReadPoolConfigResponse.fromMap(
      ...
      writableNode: NodeResponse.fromMap(
