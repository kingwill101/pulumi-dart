...
class InstanceAlloydbV1beta extends pulumi.CustomResource {
  ...
  InstanceAlloydbV1beta(
    ...
    this.machineConfig = registerOutput<MachineConfigResponseAlloydbV1beta>(
      'machineConfig',
    );
    ...
    this.readPoolConfig = registerOutput<ReadPoolConfigResponseAlloydbV1beta>(
      'readPoolConfig',
    );
    ...
    this.updatePolicy = registerOutput<UpdatePolicyResponseAlloydbV1beta>(
      'updatePolicy',
    );
    this.updateTime = registerOutput<String>('updateTime');
    this.writableNode = registerOutput<NodeResponseAlloydbV1beta>(
      'writableNode',
    );
  }
}
