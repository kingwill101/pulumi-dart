...
class GetInstanceAlloydbV1betaResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'nodes': pulumi.Input.encodeList<NodeResponseAlloydbV1beta, Map<String, dynamic>>(nodes, (value) => value.toMap()),
  ...
  factory GetInstanceAlloydbV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceAlloydbV1betaResult(
      ...
      clientConnectionConfig: ClientConnectionConfigResponseAlloydbV1beta.fromMap((map['clientConnectionConfig'] as Map).cast<String, dynamic>()),
      ...
      machineConfig: MachineConfigResponseAlloydbV1beta.fromMap((map['machineConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      nodes: pulumi.Input.decodeList<NodeResponseAlloydbV1beta>(map['nodes'], (value) => NodeResponseAlloydbV1beta.fromMap((value as Map).cast<String, dynamic>())),
      queryInsightsConfig: QueryInsightsInstanceConfigResponseAlloydbV1beta.fromMap((map['queryInsightsConfig'] as Map).cast<String, dynamic>()),
      readPoolConfig: ReadPoolConfigResponseAlloydbV1beta.fromMap((map['readPoolConfig'] as Map).cast<String, dynamic>()),
      reconciling: map['reconciling'] as bool,
      state: map['state'] as String,
      uid: map['uid'] as String,
      updatePolicy: UpdatePolicyResponseAlloydbV1beta.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>()),
      updateTime: map['updateTime'] as String,
      writableNode: NodeResponseAlloydbV1beta.fromMap((map['writableNode'] as Map).cast<String, dynamic>()),
    );
  }
}
