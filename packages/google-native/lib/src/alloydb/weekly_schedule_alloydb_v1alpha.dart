...
class WeeklyScheduleAlloydbV1alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'daysOfWeek': ?daysOfWeek == null ? null : pulumi.Input.encodeList<WeeklyScheduleDaysOfWeekItemAlloydbV1alpha, String>(daysOfWeek!, (value) => value.value),
      'startTimes': ?startTimes == null ? null : pulumi.Input.encodeList<GoogleTypeTimeOfDayAlloydbV1alpha, Map<String, dynamic>>(startTimes!, (value) => value.toMap()),
    };
  }

  factory WeeklyScheduleAlloydbV1alpha.fromMap(Map<String, dynamic> map) {
    return WeeklyScheduleAlloydbV1alpha(
      daysOfWeek: map['daysOfWeek'] == null ? null : pulumi.Input.decodeList<WeeklyScheduleDaysOfWeekItemAlloydbV1alpha>(map['daysOfWeek'], (value) => WeeklyScheduleDaysOfWeekItemAlloydbV1alpha.fromValue(value as String)),
      startTimes: map['startTimes'] == null ? null : pulumi.Input.decodeList<GoogleTypeTimeOfDayAlloydbV1alpha>(map['startTimes'], (value) => GoogleTypeTimeOfDayAlloydbV1alpha.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
