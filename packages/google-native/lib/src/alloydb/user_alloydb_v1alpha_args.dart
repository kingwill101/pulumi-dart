...
class UserAlloydbV1alphaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'userId': userId,
      'userType': ?pulumi.Input.mapOptionalInputValue<UserUserTypeAlloydbV1alpha, String>(userType, (value) => value.value),
    };
  }
  ...
  factory UserAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return UserAlloydbV1alphaArgs(
      ...
      userType: map['userType'] == null ? null : UserUserTypeAlloydbV1alpha.fromValue(map['userType'] as String),
    );
  }
}
