...
class UserAlloydbV1alphaArgs {
  ...
  UserAlloydbV1alphaArgs({
    ...
    UserUserTypeAlloydbV1alpha? userType,
        ...
        userType =
            pulumi.Input.asOptionalInput<UserUserTypeAlloydbV1alpha>(userType);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (userTypeValue != null) {
      map['userType'] = pulumi.Input.mapOptionalInputValue<
          UserUserTypeAlloydbV1alpha,
          String>(userTypeValue, (value) => value.value);
    }
    return map;
  }
  ...
  factory UserAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return UserAlloydbV1alphaArgs(
      ...
      userType: map['userType'] == null
          ? null
          : UserUserTypeAlloydbV1alpha.fromValue(map['userType'] as String),
    );
  }
}
