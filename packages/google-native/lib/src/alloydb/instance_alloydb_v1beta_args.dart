...
class InstanceAlloydbV1betaArgs {
  ...
  InstanceAlloydbV1betaArgs({
    ...
    UpdatePolicyAlloydbV1beta? updatePolicy,
       ...
       queryInsightsConfig =
           ...
           >(queryInsightsConfig),
       readPoolConfig = pulumi
           .Input.asOptionalInput<ReadPoolConfigAlloydbV1beta>(readPoolConfig),
    ...
    return <String, dynamic>{
      ...
      'availabilityType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(availabilityType, (value) => value.value),
      'clientConnectionConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory InstanceAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1betaArgs(
      ...
      instanceType: InstanceInstanceTypeAlloydbV1beta.fromValue(
