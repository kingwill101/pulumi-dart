...
class InstanceAlloydbV1betaArgs {
  ...
  InstanceAlloydbV1betaArgs({
    ...
    InstanceAvailabilityTypeAlloydbV1beta? availabilityType,
    ClientConnectionConfigAlloydbV1beta? clientConnectionConfig,
    ...
    required InstanceInstanceTypeAlloydbV1beta instanceType,
    Map<String, String>? labels,
    String? location,
    MachineConfigAlloydbV1beta? machineConfig,
    String? project,
    QueryInsightsInstanceConfigAlloydbV1beta? queryInsightsConfig,
    ReadPoolConfigAlloydbV1beta? readPoolConfig,
    String? requestId,
    UpdatePolicyAlloydbV1beta? updatePolicy,
  }) :
  ...
  factory InstanceAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1betaArgs(
      ...
      availabilityType: map['availabilityType'] == null ? null : InstanceAvailabilityTypeAlloydbV1beta.fromValue(map['availabilityType'] as String),
      clientConnectionConfig: map['clientConnectionConfig'] == null ? null : ClientConnectionConfigAlloydbV1beta.fromMap((map['clientConnectionConfig'] as Map).cast<String, dynamic>()),
      ...
      instanceType: InstanceInstanceTypeAlloydbV1beta.fromValue(map['instanceType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      machineConfig: map['machineConfig'] == null ? null : MachineConfigAlloydbV1beta.fromMap((map['machineConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      queryInsightsConfig: map['queryInsightsConfig'] == null ? null : QueryInsightsInstanceConfigAlloydbV1beta.fromMap((map['queryInsightsConfig'] as Map).cast<String, dynamic>()),
      readPoolConfig: map['readPoolConfig'] == null ? null : ReadPoolConfigAlloydbV1beta.fromMap((map['readPoolConfig'] as Map).cast<String, dynamic>()),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      updatePolicy: map['updatePolicy'] == null ? null : UpdatePolicyAlloydbV1beta.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
