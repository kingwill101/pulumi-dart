...
class GetBackupAlloydbV1betaResult {
  ...
  final QuantityBasedExpiryResponseAlloydbV1beta expiryQuantity;
  ...
  /// Creates a new [GetBackupAlloydbV1betaResult].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['etag'] = etag;
    map['expiryQuantity'] = expiryQuantity.toMap();
  ...
  factory GetBackupAlloydbV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetBackupAlloydbV1betaResult(
      ...
      expiryQuantity: QuantityBasedExpiryResponseAlloydbV1beta.fromMap(
