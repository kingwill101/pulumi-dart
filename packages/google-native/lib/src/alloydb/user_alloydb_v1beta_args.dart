...
class UserAlloydbV1betaArgs {
  ...
  UserAlloydbV1betaArgs({
    ...
    UserUserTypeAlloydbV1beta? userType,
        ...
        userType =
            pulumi.Input.asOptionalInput<UserUserTypeAlloydbV1beta>(userType);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (userTypeValue != null) {
      map['userType'] =
          pulumi.Input.mapOptionalInputValue<UserUserTypeAlloydbV1beta, String>(
  ...
  factory UserAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return UserAlloydbV1betaArgs(
      ...
      userType: map['userType'] == null
          ? null
          : UserUserTypeAlloydbV1beta.fromValue(map['userType'] as String),
    );
  }
}
