...
class ClusterAlloydbV1betaArgs {
  ...
  factory ClusterAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ClusterAlloydbV1betaArgs(
      ...
      automatedBackupPolicy: map['automatedBackupPolicy'] == null ? null : AutomatedBackupPolicyAlloydbV1beta.fromMap((map['automatedBackupPolicy'] as Map).cast<String, dynamic>()),
      clusterId: map['clusterId'] as String,
      continuousBackupConfig: map['continuousBackupConfig'] == null ? null : ContinuousBackupConfigAlloydbV1beta.fromMap((map['continuousBackupConfig'] as Map).cast<String, dynamic>()),
      databaseVersion: map['databaseVersion'] == null ? null : ClusterDatabaseVersionAlloydbV1beta.fromValue(map['databaseVersion'] as String),
      ...
      initialUser: map['initialUser'] == null ? null : UserPasswordAlloydbV1beta.fromMap((map['initialUser'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      network: map['network'] as String,
      networkConfig: map['networkConfig'] == null ? null : NetworkConfigAlloydbV1beta.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      secondaryConfig: map['secondaryConfig'] == null ? null : SecondaryConfigAlloydbV1beta.fromMap((map['secondaryConfig'] as Map).cast<String, dynamic>()),
