...
class ClusterAlloydbV1alphaArgs {
  ...
  ClusterAlloydbV1alphaArgs({
    ...
    AutomatedBackupPolicyAlloydbV1alpha? automatedBackupPolicy,
    required String clusterId,
    ContinuousBackupConfigAlloydbV1alpha? continuousBackupConfig,
    ClusterDatabaseVersionAlloydbV1alpha? databaseVersion,
    String? displayName,
    EncryptionConfigAlloydbV1alpha? encryptionConfig,
    String? etag,
    UserPasswordAlloydbV1alpha? initialUser,
    Map<String, String>? labels,
    String? location,
    required String network,
    NetworkConfigAlloydbV1alpha? networkConfig,
    String? project,
    PscConfig? pscConfig,
    String? requestId,
    SecondaryConfigAlloydbV1alpha? secondaryConfig,
    SslConfigAlloydbV1alpha? sslConfig,
  }) :
  ...
  factory ClusterAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ClusterAlloydbV1alphaArgs(
      ...
      automatedBackupPolicy: map['automatedBackupPolicy'] == null ? null : AutomatedBackupPolicyAlloydbV1alpha.fromMap((map['automatedBackupPolicy'] as Map).cast<String, dynamic>()),
      clusterId: map['clusterId'] as String,
      continuousBackupConfig: map['continuousBackupConfig'] == null ? null : ContinuousBackupConfigAlloydbV1alpha.fromMap((map['continuousBackupConfig'] as Map).cast<String, dynamic>()),
      databaseVersion: map['databaseVersion'] == null ? null : ClusterDatabaseVersionAlloydbV1alpha.fromValue(map['databaseVersion'] as String),
      ...
      initialUser: map['initialUser'] == null ? null : UserPasswordAlloydbV1alpha.fromMap((map['initialUser'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      network: map['network'] as String,
      networkConfig: map['networkConfig'] == null ? null : NetworkConfigAlloydbV1alpha.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      pscConfig: map['pscConfig'] == null ? null : PscConfig.fromMap((map['pscConfig'] as Map).cast<String, dynamic>()),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      secondaryConfig: map['secondaryConfig'] == null ? null : SecondaryConfigAlloydbV1alpha.fromMap((map['secondaryConfig'] as Map).cast<String, dynamic>()),
