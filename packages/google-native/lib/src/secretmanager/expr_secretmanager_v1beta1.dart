...
class ExprSecretmanagerV1beta1 {
  ...
  /// Creates a new [ExprSecretmanagerV1beta1].
  ...
  factory ExprSecretmanagerV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprSecretmanagerV1beta1(
      description:
