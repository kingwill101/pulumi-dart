...
class SecretArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'project': ?project,
      'replication': pulumi.Input.mapInputValue<Replication, Map<String, dynamic>>(replication, (value) => value.toMap()),
      'rotation': ?pulumi.Input.mapOptionalInputValue<Rotation, Map<String, dynamic>>(rotation, (value) => value.toMap()),
      'secretId': secretId,
      'topics': ?pulumi.Input.mapOptionalInputValue<List<Topic>, List<Map<String, dynamic>>>(topics, (value) => pulumi.Input.encodeList<Topic, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ttl': ?ttl,
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      replication: Replication.fromMap((map['replication'] as Map).cast<String, dynamic>()),
      rotation: map['rotation'] == null ? null : Rotation.fromMap((map['rotation'] as Map).cast<String, dynamic>()),
      secretId: map['secretId'] as String,
      topics: map['topics'] == null ? null : pulumi.Input.decodeList<Topic>(map['topics'], (value) => Topic.fromMap((value as Map).cast<String, dynamic>())),
      ttl: map['ttl'] == null ? null : map['ttl'] as String,
      versionAliases: map['versionAliases'] == null ? null : (map['versionAliases'] as Map).cast<String, String>(),
    );
  }
}
