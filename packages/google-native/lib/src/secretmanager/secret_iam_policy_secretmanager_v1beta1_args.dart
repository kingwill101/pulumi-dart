...
class SecretIamPolicySecretmanagerV1beta1Args {
  ...
  SecretIamPolicySecretmanagerV1beta1Args({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigSecretmanagerV1beta1>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingSecretmanagerV1beta1>>(
                bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigSecretmanagerV1beta1>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigSecretmanagerV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingSecretmanagerV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingSecretmanagerV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory SecretIamPolicySecretmanagerV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return SecretIamPolicySecretmanagerV1beta1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigSecretmanagerV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigSecretmanagerV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingSecretmanagerV1beta1>(
              map['bindings'],
              (value) => BindingSecretmanagerV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
