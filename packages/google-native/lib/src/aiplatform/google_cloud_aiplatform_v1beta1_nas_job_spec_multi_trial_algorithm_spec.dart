...
class GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec {
  ...
  final GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpec? metric;
  /// The multi-trial Neural Architecture Search (NAS) algorithm type. Defaults to `REINFORCEMENT_LEARNING`.
  final GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm? multiTrialAlgorithm;
  /// Spec for search trials.
  final GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec searchTrialSpec;
  ...
  final GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec? trainTrialSpec;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'multiTrialAlgorithm': ?multiTrialAlgorithm == null ? null : multiTrialAlgorithm!.value,
      'searchTrialSpec': searchTrialSpec.toMap(),
      'trainTrialSpec': ?trainTrialSpec == null ? null : trainTrialSpec!.toMap(),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec(
      metric: map['metric'] == null ? null : GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpec.fromMap((map['metric'] as Map).cast<String, dynamic>()),
      multiTrialAlgorithm: map['multiTrialAlgorithm'] == null ? null : GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm.fromValue(map['multiTrialAlgorithm'] as String),
      searchTrialSpec: GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec.fromMap((map['searchTrialSpec'] as Map).cast<String, dynamic>()),
      trainTrialSpec: map['trainTrialSpec'] == null ? null : GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec.fromMap((map['trainTrialSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
