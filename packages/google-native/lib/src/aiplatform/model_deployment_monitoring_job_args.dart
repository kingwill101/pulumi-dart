...
class ModelDeploymentMonitoringJobArgs {
  ...
  ModelDeploymentMonitoringJobArgs({
    ...
    >
    modelDeploymentMonitoringObjectiveConfigs,
    required GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig
    modelDeploymentMonitoringScheduleConfig,
    ...
    GoogleCloudAiplatformV1GcsDestination? statsAnomaliesBaseDirectory,
       ...
       modelMonitoringAlertConfig =
           pulumi.Input.asOptionalInput<
             GoogleCloudAiplatformV1ModelMonitoringAlertConfig
           >(modelMonitoringAlertConfig),
       predictInstanceSchemaUri = pulumi.Input.asOptionalInput<String>(
         predictInstanceSchemaUri,
       ),
       project = pulumi.Input.asOptionalInput<String>(project),
       samplePredictInstance = pulumi.Input.asOptionalInput<dynamic>(
  ...
  factory ModelDeploymentMonitoringJobArgs.fromMap(Map<String, dynamic> map) {
    return ModelDeploymentMonitoringJobArgs(
      ...
      loggingSamplingStrategy: GoogleCloudAiplatformV1SamplingStrategy.fromMap(
