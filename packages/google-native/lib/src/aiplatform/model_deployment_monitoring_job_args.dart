...
class ModelDeploymentMonitoringJobArgs {
  ...
  ModelDeploymentMonitoringJobArgs({
    ...
    String? location,
    String? logTtl,
    required GoogleCloudAiplatformV1SamplingStrategy loggingSamplingStrategy,
    required List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig> modelDeploymentMonitoringObjectiveConfigs,
    required GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig modelDeploymentMonitoringScheduleConfig,
  ...
  factory ModelDeploymentMonitoringJobArgs.fromMap(Map<String, dynamic> map) {
    return ModelDeploymentMonitoringJobArgs(
      analysisInstanceSchemaUri: map['analysisInstanceSchemaUri'] == null ? null : map['analysisInstanceSchemaUri'] as String,
      displayName: map['displayName'] as String,
      enableMonitoringPipelineLogs: map['enableMonitoringPipelineLogs'] == null ? null : map['enableMonitoringPipelineLogs'] as bool,
      ...
      loggingSamplingStrategy: GoogleCloudAiplatformV1SamplingStrategy.fromMap((map['loggingSamplingStrategy'] as Map).cast<String, dynamic>()),
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Input.decodeList<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig>(map['modelDeploymentMonitoringObjectiveConfigs'], (value) => GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig.fromMap((value as Map).cast<String, dynamic>())),
      modelDeploymentMonitoringScheduleConfig: GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig.fromMap((map['modelDeploymentMonitoringScheduleConfig'] as Map).cast<String, dynamic>()),
      modelMonitoringAlertConfig: map['modelMonitoringAlertConfig'] == null ? null : GoogleCloudAiplatformV1ModelMonitoringAlertConfig.fromMap((map['modelMonitoringAlertConfig'] as Map).cast<String, dynamic>()),
      predictInstanceSchemaUri: map['predictInstanceSchemaUri'] == null ? null : map['predictInstanceSchemaUri'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      samplePredictInstance: map['samplePredictInstance'] == null ? null : map['samplePredictInstance'],
      statsAnomaliesBaseDirectory: map['statsAnomaliesBaseDirectory'] == null ? null : GoogleCloudAiplatformV1GcsDestination.fromMap((map['statsAnomaliesBaseDirectory'] as Map).cast<String, dynamic>()),
    );
  }
}
