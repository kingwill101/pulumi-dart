...
class IndexEndpointArgs {
  ...
  factory IndexEndpointArgs.fromMap(Map<String, dynamic> map) {
    return IndexEndpointArgs(
      ...
      privateServiceConnectConfig: map['privateServiceConnectConfig'] == null ? null : GoogleCloudAiplatformV1PrivateServiceConnectConfig.fromMap((map['privateServiceConnectConfig'] as Map).cast<String, dynamic>()),
