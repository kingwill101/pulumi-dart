...
class GoogleCloudAiplatformV1beta1DedicatedResources {
  ...
  final List<GoogleCloudAiplatformV1beta1AutoscalingMetricSpec>? autoscalingMetricSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricSpecs': ?autoscalingMetricSpecs == null ? null : pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1AutoscalingMetricSpec, Map<String, dynamic>>(autoscalingMetricSpecs!, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1DedicatedResources.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1DedicatedResources(
      autoscalingMetricSpecs: map['autoscalingMetricSpecs'] == null ? null : pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1AutoscalingMetricSpec>(map['autoscalingMetricSpecs'], (value) => GoogleCloudAiplatformV1beta1AutoscalingMetricSpec.fromMap((value as Map).cast<String, dynamic>())),
