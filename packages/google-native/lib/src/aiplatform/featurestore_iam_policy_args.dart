...
/// {@template pulumi_aiplatform_v1_featurestore_iam_policy_args_doc}
/// The set of arguments for FeaturestoreIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_featurestore_iam_policy_args_doc}
class FeaturestoreIamPolicyArgs {
  ...
  /// Creates a new [FeaturestoreIamPolicyArgs].
  ...
  factory FeaturestoreIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamPolicyArgs(
