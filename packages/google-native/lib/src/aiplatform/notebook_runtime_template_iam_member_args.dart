...
/// {@template pulumi_aiplatform_v1_notebook_runtime_template_iam_member_args_doc}
/// The set of arguments for NotebookRuntimeTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_notebook_runtime_template_iam_member_args_doc}
class NotebookRuntimeTemplateIamMemberArgs {
  ...
  /// Creates a new [NotebookRuntimeTemplateIamMemberArgs].
  ...
  NotebookRuntimeTemplateIamMemberArgs({
    Condition? condition,
  ...
  factory NotebookRuntimeTemplateIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateIamMemberArgs(
