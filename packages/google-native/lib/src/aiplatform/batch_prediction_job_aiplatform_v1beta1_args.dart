...
class BatchPredictionJobAiplatformV1beta1Args {
  ...
  BatchPredictionJobAiplatformV1beta1Args({
    ...
    required GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig inputConfig,
    GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig? instanceConfig,
    Map<String, String>? labels,
    String? location,
    GoogleCloudAiplatformV1beta1ManualBatchTuningParameters? manualBatchTuningParameters,
    String? model,
    GoogleCloudAiplatformV1beta1ModelMonitoringConfig? modelMonitoringConfig,
    List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>? modelMonitoringStatsAnomalies,
    dynamic modelParameters,
    required GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig outputConfig,
    String? project,
  ...
  factory BatchPredictionJobAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return BatchPredictionJobAiplatformV1beta1Args(
      dedicatedResources: map['dedicatedResources'] == null ? null : GoogleCloudAiplatformV1beta1BatchDedicatedResources.fromMap((map['dedicatedResources'] as Map).cast<String, dynamic>()),
      disableContainerLogging: map['disableContainerLogging'] == null ? null : map['disableContainerLogging'] as bool,
      ...
      explanationSpec: map['explanationSpec'] == null ? null : GoogleCloudAiplatformV1beta1ExplanationSpec.fromMap((map['explanationSpec'] as Map).cast<String, dynamic>()),
      generateExplanation: map['generateExplanation'] == null ? null : map['generateExplanation'] as bool,
      inputConfig: GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig.fromMap((map['inputConfig'] as Map).cast<String, dynamic>()),
      instanceConfig: map['instanceConfig'] == null ? null : GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig.fromMap((map['instanceConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      manualBatchTuningParameters: map['manualBatchTuningParameters'] == null ? null : GoogleCloudAiplatformV1beta1ManualBatchTuningParameters.fromMap((map['manualBatchTuningParameters'] as Map).cast<String, dynamic>()),
      model: map['model'] == null ? null : map['model'] as String,
      modelMonitoringConfig: map['modelMonitoringConfig'] == null ? null : GoogleCloudAiplatformV1beta1ModelMonitoringConfig.fromMap((map['modelMonitoringConfig'] as Map).cast<String, dynamic>()),
      modelMonitoringStatsAnomalies: map['modelMonitoringStatsAnomalies'] == null ? null : pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>(map['modelMonitoringStatsAnomalies'], (value) => GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies.fromMap((value as Map).cast<String, dynamic>())),
      modelParameters: map['modelParameters'] == null ? null : map['modelParameters'],
      outputConfig: GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig.fromMap((map['outputConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      unmanagedContainerModel: map['unmanagedContainerModel'] == null ? null : GoogleCloudAiplatformV1beta1UnmanagedContainerModel.fromMap((map['unmanagedContainerModel'] as Map).cast<String, dynamic>()),
    );
  }
}
