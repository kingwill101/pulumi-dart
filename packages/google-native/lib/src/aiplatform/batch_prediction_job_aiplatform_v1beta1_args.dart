...
class BatchPredictionJobAiplatformV1beta1Args {
  ...
  final pulumi
      .Input<GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig>?
      instanceConfig;
  ...
  final pulumi
      .Input<List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>>?
  ...
  BatchPredictionJobAiplatformV1beta1Args({
    ...
    GoogleCloudAiplatformV1beta1UnmanagedContainerModel?
        unmanagedContainerModel,
            ...
            dedicatedResources),
        disableContainerLogging =
            pulumi.Input.asOptionalInput<bool>(disableContainerLogging),
        displayName = pulumi.Input.asInput<String>(displayName),
        encryptionSpec = pulumi.Input.asOptionalInput<
            GoogleCloudAiplatformV1beta1EncryptionSpec>(encryptionSpec),
        explanationSpec = pulumi.Input.asOptionalInput<
            GoogleCloudAiplatformV1beta1ExplanationSpec>(explanationSpec),
        generateExplanation =
            pulumi.Input.asOptionalInput<bool>(generateExplanation),
        inputConfig = pulumi.Input.asInput<
        ...
        manualBatchTuningParameters = pulumi.Input.asOptionalInput<
                GoogleCloudAiplatformV1beta1ManualBatchTuningParameters>(
            manualBatchTuningParameters),
        model = pulumi.Input.asOptionalInput<String>(model),
        modelMonitoringConfig = pulumi.Input.asOptionalInput<
                GoogleCloudAiplatformV1beta1ModelMonitoringConfig>(
            modelMonitoringConfig),
        modelMonitoringStatsAnomalies = pulumi.Input.asOptionalInput<
                List<
                    GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>>(
            modelMonitoringStatsAnomalies),
        modelParameters =
            pulumi.Input.asOptionalInput<dynamic>(modelParameters),
        outputConfig = pulumi.Input.asInput<
                GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig>(
            outputConfig),
        project = pulumi.Input.asOptionalInput<String>(project),
        serviceAccount = pulumi.Input.asOptionalInput<String>(serviceAccount),
        unmanagedContainerModel = pulumi.Input.asOptionalInput<
                GoogleCloudAiplatformV1beta1UnmanagedContainerModel>(
            unmanagedContainerModel);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (explanationSpecValue != null) {
      map['explanationSpec'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (manualBatchTuningParametersValue != null) {
      map['manualBatchTuningParameters'] = pulumi.Input.mapOptionalInputValue<
              GoogleCloudAiplatformV1beta1ManualBatchTuningParameters,
              Map<String, dynamic>>(
    ...
    final modelMonitoringConfigValue = modelMonitoringConfig;
    if (modelMonitoringConfigValue != null) {
      map['modelMonitoringConfig'] = pulumi.Input.mapOptionalInputValue<
              GoogleCloudAiplatformV1beta1ModelMonitoringConfig,
              Map<String, dynamic>>(
          modelMonitoringConfigValue, (value) => value.toMap());
    }
    final modelMonitoringStatsAnomaliesValue = modelMonitoringStatsAnomalies;
    if (modelMonitoringStatsAnomaliesValue != null) {
      map['modelMonitoringStatsAnomalies'] = pulumi.Input.mapOptionalInputValue<
              List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>,
              List<Map<String, dynamic>>>(
          modelMonitoringStatsAnomaliesValue,
    ...
    if (unmanagedContainerModelValue != null) {
      map['unmanagedContainerModel'] = pulumi.Input.mapOptionalInputValue<
              GoogleCloudAiplatformV1beta1UnmanagedContainerModel,
              Map<String, dynamic>>(
  ...
  factory BatchPredictionJobAiplatformV1beta1Args.fromMap(
    ...
    return BatchPredictionJobAiplatformV1beta1Args(
      ...
      modelMonitoringStatsAnomalies: map['modelMonitoringStatsAnomalies'] ==
              null
          ? null
      ...
      modelParameters:
          map['modelParameters'] == null ? null : map['modelParameters'],
      outputConfig:
