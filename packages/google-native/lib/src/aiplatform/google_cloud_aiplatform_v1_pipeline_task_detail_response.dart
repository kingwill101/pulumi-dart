...
class GoogleCloudAiplatformV1PipelineTaskDetailResponse {
  ...
  final GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse executorDetail;
  ...
  final List<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse> pipelineTaskStatus;
  /// Task start time.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'executorDetail': executorDetail.toMap(),
      'inputs': inputs,
      'outputs': outputs,
      'parentTaskId': parentTaskId,
      'pipelineTaskStatus': pulumi.Input.encodeList<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse, Map<String, dynamic>>(pipelineTaskStatus, (value) => value.toMap()),
      'startTime': startTime,
      'state': state,
      'taskId': taskId,
      'taskName': taskName,
  ...
  factory GoogleCloudAiplatformV1PipelineTaskDetailResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PipelineTaskDetailResponse(
      ...
      execution: GoogleCloudAiplatformV1ExecutionResponse.fromMap((map['execution'] as Map).cast<String, dynamic>()),
      executorDetail: GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse.fromMap((map['executorDetail'] as Map).cast<String, dynamic>()),
      ...
      pipelineTaskStatus: pulumi.Input.decodeList<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse>(map['pipelineTaskStatus'], (value) => GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse.fromMap((value as Map).cast<String, dynamic>())),
