...
class GoogleCloudAiplatformV1beta1StudySpecMetricSpec {
  ...
  final GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfig?
  safetyConfig;
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecMetricSpec.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1StudySpecMetricSpec(
      goal: GoogleCloudAiplatformV1beta1StudySpecMetricSpecGoal.fromValue(
        map['goal'] as String,
      ),
      metricId: map['metricId'] as String,
      safetyConfig: map['safetyConfig'] == null
          ? null
          : GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfig.fromMap(
