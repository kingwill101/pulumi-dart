...
class GoogleCloudAiplatformV1FeatureOnlineStoreBigtable {
  ...
  final GoogleCloudAiplatformV1FeatureOnlineStoreBigtableAutoScaling autoScaling;
  ...
  factory GoogleCloudAiplatformV1FeatureOnlineStoreBigtable.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeatureOnlineStoreBigtable(
      autoScaling: GoogleCloudAiplatformV1FeatureOnlineStoreBigtableAutoScaling.fromMap((map['autoScaling'] as Map).cast<String, dynamic>()),
    );
  }
}
