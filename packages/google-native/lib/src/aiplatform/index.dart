...
class Index extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1DeployedIndexRefResponse>> deployedIndexes;
  ...
  Index(
    ...
    this.deployedIndexes = registerOutput<List<GoogleCloudAiplatformV1DeployedIndexRefResponse>>('deployedIndexes');
    ...
    this.indexStats = registerOutput<GoogleCloudAiplatformV1IndexStatsResponse>('indexStats');
