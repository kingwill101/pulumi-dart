...
class GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blurBaselineConfig': ?blurBaselineConfig == null
          ? null
          : blurBaselineConfig!.toMap(),
      'smoothGradConfig': ?smoothGradConfig == null
          ? null
          : smoothGradConfig!.toMap(),
      'stepCount': stepCount,
    };
  }

  factory GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution(
      blurBaselineConfig: map['blurBaselineConfig'] == null
          ? null
          : GoogleCloudAiplatformV1beta1BlurBaselineConfig.fromMap(
              (map['blurBaselineConfig'] as Map).cast<String, dynamic>(),
            ),
      smoothGradConfig: map['smoothGradConfig'] == null
          ? null
          : GoogleCloudAiplatformV1beta1SmoothGradConfig.fromMap(
