...
class GoogleCloudAiplatformV1beta1StudySpecConvexStopConfig {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecConvexStopConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecConvexStopConfig(
      autoregressiveOrder: map['autoregressiveOrder'] == null ? null : map['autoregressiveOrder'] as String,
      learningRateParameterName: map['learningRateParameterName'] == null ? null : map['learningRateParameterName'] as String,
      maxNumSteps: map['maxNumSteps'] == null ? null : map['maxNumSteps'] as String,
      minNumSteps: map['minNumSteps'] == null ? null : map['minNumSteps'] as String,
