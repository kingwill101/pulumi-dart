    ...
    return <String, dynamic>{
      ...
      'workerPoolSpecs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(workerPoolSpecs, (value) => value.toMap()),
    };
  }

  factory GoogleCloudAiplatformV1CustomJobSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1CustomJobSpecResponse(
      ...
      scheduling: GoogleCloudAiplatformV1SchedulingResponse.fromMap(
      ...
      workerPoolSpecs:
          pulumi
              .Input.decodeList<GoogleCloudAiplatformV1WorkerPoolSpecResponse>(
            map['workerPoolSpecs'],
            (value) => GoogleCloudAiplatformV1WorkerPoolSpecResponse.fromMap(
