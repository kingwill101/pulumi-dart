...
class GoogleCloudAiplatformV1PredictSchemataResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['instanceSchemaUri'] = instanceSchemaUri;
    map['parametersSchemaUri'] = parametersSchemaUri;
    map['predictionSchemaUri'] = predictionSchemaUri;
    return map;
  }

  factory GoogleCloudAiplatformV1PredictSchemataResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PredictSchemataResponse(
      instanceSchemaUri: map['instanceSchemaUri'] as String,
      parametersSchemaUri: map['parametersSchemaUri'] as String,
      predictionSchemaUri: map['predictionSchemaUri'] as String,
    );
  }
}
