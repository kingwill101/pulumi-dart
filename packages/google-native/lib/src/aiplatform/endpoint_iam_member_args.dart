...
/// {@template pulumi_aiplatform_v1beta1_endpoint_iam_member_args_doc}
/// The set of arguments for EndpointIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_endpoint_iam_member_args_doc}
class EndpointIamMemberArgs {
  ...
  /// Creates a new [EndpointIamMemberArgs].
  ...
  factory EndpointIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EndpointIamMemberArgs(
