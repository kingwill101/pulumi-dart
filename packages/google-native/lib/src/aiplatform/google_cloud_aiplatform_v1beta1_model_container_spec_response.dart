...
class GoogleCloudAiplatformV1beta1ModelContainerSpecResponse {
  ...
  final GoogleCloudAiplatformV1beta1ProbeResponse healthProbe;
  ...
  final List<GoogleCloudAiplatformV1beta1PortResponse> ports;
  ...
  final GoogleCloudAiplatformV1beta1ProbeResponse startupProbe;
  ...
  factory GoogleCloudAiplatformV1beta1ModelContainerSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ModelContainerSpecResponse(
      ...
      healthProbe: GoogleCloudAiplatformV1beta1ProbeResponse.fromMap(
      ...
      predictRoute: map['predictRoute'] as String,
      sharedMemorySizeMb: map['sharedMemorySizeMb'] as String,
      startupProbe: GoogleCloudAiplatformV1beta1ProbeResponse.fromMap(
