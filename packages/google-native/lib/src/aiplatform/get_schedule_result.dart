...
class GetScheduleResult {
  ...
  final GoogleCloudAiplatformV1CreatePipelineJobRequestResponse
  ...
  final GoogleCloudAiplatformV1ScheduleRunResponseResponse
  ...
  factory GetScheduleResult.fromMap(Map<String, dynamic> map) {
    return GetScheduleResult(
      ...
      createPipelineJobRequest:
          GoogleCloudAiplatformV1CreatePipelineJobRequestResponse.fromMap(
      ...
      lastScheduledRunResponse:
          GoogleCloudAiplatformV1ScheduleRunResponseResponse.fromMap(
