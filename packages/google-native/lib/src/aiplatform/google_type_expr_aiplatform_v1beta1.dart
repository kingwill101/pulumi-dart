...
class GoogleTypeExprAiplatformV1beta1 {
  ...
  /// Creates a new [GoogleTypeExprAiplatformV1beta1].
  ...
  factory GoogleTypeExprAiplatformV1beta1.fromMap(Map<String, dynamic> map) {
    return GoogleTypeExprAiplatformV1beta1(
      description:
