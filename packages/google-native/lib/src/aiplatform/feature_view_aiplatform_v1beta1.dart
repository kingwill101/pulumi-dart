...
class FeatureViewAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse> bigQuerySource;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceResponse> featureRegistrySource;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1FeatureViewSyncConfigResponse> syncConfig;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigResponse> vectorSearchConfig;
  ...
  FeatureViewAiplatformV1beta1(
    ...
    this.bigQuerySource = registerOutput<GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse>('bigQuerySource');
    this.createTime = registerOutput<String>('createTime');
    this.etag = registerOutput<String>('etag');
    this.featureOnlineStoreId = registerOutput<String>('featureOnlineStoreId');
    this.featureRegistrySource = registerOutput<GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceResponse>('featureRegistrySource');
    ...
    this.syncConfig = registerOutput<GoogleCloudAiplatformV1beta1FeatureViewSyncConfigResponse>('syncConfig');
    this.updateTime = registerOutput<String>('updateTime');
    this.vectorSearchConfig = registerOutput<GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigResponse>('vectorSearchConfig');
  }
}
