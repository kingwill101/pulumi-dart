...
class GoogleCloudAiplatformV1FeatureNoiseSigmaResponse {
  ...
  GoogleCloudAiplatformV1FeatureNoiseSigmaResponse({required this.noiseSigma});
    ...
    return GoogleCloudAiplatformV1FeatureNoiseSigmaResponse(
      noiseSigma:
          ...
          >(
            map['noiseSigma'],
            (value) =>
                GoogleCloudAiplatformV1FeatureNoiseSigmaNoiseSigmaForFeatureResponse.fromMap(
