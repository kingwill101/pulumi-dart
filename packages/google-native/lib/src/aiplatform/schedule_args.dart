...
class ScheduleArgs {
  ...
  factory ScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduleArgs(
      ...
      createPipelineJobRequest: map['createPipelineJobRequest'] == null ? null : GoogleCloudAiplatformV1CreatePipelineJobRequest.fromMap((map['createPipelineJobRequest'] as Map).cast<String, dynamic>()),
