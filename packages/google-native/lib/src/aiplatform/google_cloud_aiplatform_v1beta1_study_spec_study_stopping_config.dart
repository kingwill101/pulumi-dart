...
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig {
  ...
  final GoogleCloudAiplatformV1beta1StudyTimeConstraint?
  ...
  Map<String, dynamic> toMap() {
    ...
    final maxDurationNoProgressValue = maxDurationNoProgress;
    if (maxDurationNoProgressValue != null) {
      map['maxDurationNoProgress'] = maxDurationNoProgressValue;
    }
    final maxNumTrialsValue = maxNumTrials;
    if (maxNumTrialsValue != null) {
      map['maxNumTrials'] = maxNumTrialsValue;
    }
    final maxNumTrialsNoProgressValue = maxNumTrialsNoProgress;
    if (maxNumTrialsNoProgressValue != null) {
      map['maxNumTrialsNoProgress'] = maxNumTrialsNoProgressValue;
    }
    final maximumRuntimeConstraintValue = maximumRuntimeConstraint;
    if (maximumRuntimeConstraintValue != null) {
      map['maximumRuntimeConstraint'] = maximumRuntimeConstraintValue.toMap();
    }
    final minNumTrialsValue = minNumTrials;
    if (minNumTrialsValue != null) {
      map['minNumTrials'] = minNumTrialsValue;
    }
    final minimumRuntimeConstraintValue = minimumRuntimeConstraint;
    if (minimumRuntimeConstraintValue != null) {
      map['minimumRuntimeConstraint'] = minimumRuntimeConstraintValue.toMap();
    }
    final shouldStopAsapValue = shouldStopAsap;
    if (shouldStopAsapValue != null) {
      map['shouldStopAsap'] = shouldStopAsapValue;
    }
    return map;
  }

  factory GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig(
      maxDurationNoProgress: map['maxDurationNoProgress'] == null
          ? null
          : map['maxDurationNoProgress'] as String,
      maxNumTrials:
          map['maxNumTrials'] == null ? null : map['maxNumTrials'] as int,
      maxNumTrialsNoProgress: map['maxNumTrialsNoProgress'] == null
          ? null
          : map['maxNumTrialsNoProgress'] as int,
      maximumRuntimeConstraint: map['maximumRuntimeConstraint'] == null
          ? null
          : GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap(
              (map['maximumRuntimeConstraint'] as Map).cast<String, dynamic>()),
      minNumTrials:
          map['minNumTrials'] == null ? null : map['minNumTrials'] as int,
      minimumRuntimeConstraint: map['minimumRuntimeConstraint'] == null
          ? null
          : GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap(
              (map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>()),
      shouldStopAsap:
          map['shouldStopAsap'] == null ? null : map['shouldStopAsap'] as bool,
    );
  }
}
