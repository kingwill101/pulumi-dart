...
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maximumRuntimeConstraint': ?maximumRuntimeConstraint == null
          ? null
          : maximumRuntimeConstraint!.toMap(),
      'minNumTrials': ?minNumTrials,
      'minimumRuntimeConstraint': ?minimumRuntimeConstraint == null
          ? null
          : minimumRuntimeConstraint!.toMap(),
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig(
      ...
      maxNumTrials: map['maxNumTrials'] == null
          ? null
          : map['maxNumTrials'] as int,
      ...
      minNumTrials: map['minNumTrials'] == null
          ? null
          : map['minNumTrials'] as int,
      minimumRuntimeConstraint: map['minimumRuntimeConstraint'] == null
          ? null
          : GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap(
              (map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>(),
            ),
      shouldStopAsap: map['shouldStopAsap'] == null
          ? null
          : map['shouldStopAsap'] as bool,
    );
  }
}
