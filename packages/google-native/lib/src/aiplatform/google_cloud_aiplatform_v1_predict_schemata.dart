...
class GoogleCloudAiplatformV1PredictSchemata {
  ...
  Map<String, dynamic> toMap() {
    ...
    final instanceSchemaUriValue = instanceSchemaUri;
    if (instanceSchemaUriValue != null) {
      map['instanceSchemaUri'] = instanceSchemaUriValue;
    }
    final parametersSchemaUriValue = parametersSchemaUri;
    if (parametersSchemaUriValue != null) {
      map['parametersSchemaUri'] = parametersSchemaUriValue;
    }
    final predictionSchemaUriValue = predictionSchemaUri;
    if (predictionSchemaUriValue != null) {
      map['predictionSchemaUri'] = predictionSchemaUriValue;
    }
    return map;
  }
