...
class GoogleCloudAiplatformV1SamplingStrategy {
  ...
  final GoogleCloudAiplatformV1SamplingStrategyRandomSampleConfig? randomSampleConfig;
  ...
  factory GoogleCloudAiplatformV1SamplingStrategy.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1SamplingStrategy(
      randomSampleConfig: map['randomSampleConfig'] == null ? null : GoogleCloudAiplatformV1SamplingStrategyRandomSampleConfig.fromMap((map['randomSampleConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
