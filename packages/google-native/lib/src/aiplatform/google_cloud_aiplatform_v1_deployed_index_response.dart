...
import 'google_cloud_aiplatform_v1_deployed_index_auth_config_response.dart';
import 'google_cloud_aiplatform_v1_index_private_endpoints_response.dart';

/// A deployment of an Index. IndexEndpoints contain one or more DeployedIndexes.
class GoogleCloudAiplatformV1DeployedIndexResponse {
  ...
  final GoogleCloudAiplatformV1DeployedIndexAuthConfigResponse
  ...
  final GoogleCloudAiplatformV1IndexPrivateEndpointsResponse privateEndpoints;
  ...
  /// Creates a new [GoogleCloudAiplatformV1DeployedIndexResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['automaticResources'] = automaticResources.toMap();
    map['createTime'] = createTime;
    map['dedicatedResources'] = dedicatedResources.toMap();
    map['deployedIndexAuthConfig'] = deployedIndexAuthConfig.toMap();
    map['deploymentGroup'] = deploymentGroup;
    map['displayName'] = displayName;
    map['enableAccessLogging'] = enableAccessLogging;
    map['index'] = index;
    map['indexSyncTime'] = indexSyncTime;
    map['privateEndpoints'] = privateEndpoints.toMap();
    map['reservedIpRanges'] = reservedIpRanges;
    return map;
  }

  factory GoogleCloudAiplatformV1DeployedIndexResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1DeployedIndexResponse(
      automaticResources:
          GoogleCloudAiplatformV1AutomaticResourcesResponse.fromMap(
              (map['automaticResources'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dedicatedResources:
          GoogleCloudAiplatformV1DedicatedResourcesResponse.fromMap(
              (map['dedicatedResources'] as Map).cast<String, dynamic>()),
      deployedIndexAuthConfig:
          GoogleCloudAiplatformV1DeployedIndexAuthConfigResponse.fromMap(
              (map['deployedIndexAuthConfig'] as Map).cast<String, dynamic>()),
      deploymentGroup: map['deploymentGroup'] as String,
      displayName: map['displayName'] as String,
      enableAccessLogging: map['enableAccessLogging'] as bool,
      index: map['index'] as String,
      indexSyncTime: map['indexSyncTime'] as String,
      privateEndpoints:
          GoogleCloudAiplatformV1IndexPrivateEndpointsResponse.fromMap(
              (map['privateEndpoints'] as Map).cast<String, dynamic>()),
