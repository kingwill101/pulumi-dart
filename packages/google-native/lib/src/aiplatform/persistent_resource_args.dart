...
class PersistentResourceArgs {
  ...
  factory PersistentResourceArgs.fromMap(Map<String, dynamic> map) {
    return PersistentResourceArgs(
      ...
      resourcePools: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ResourcePool>(map['resourcePools'], (value) => GoogleCloudAiplatformV1beta1ResourcePool.fromMap((value as Map).cast<String, dynamic>())),
      resourceRuntimeSpec: map['resourceRuntimeSpec'] == null ? null : GoogleCloudAiplatformV1beta1ResourceRuntimeSpec.fromMap((map['resourceRuntimeSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
