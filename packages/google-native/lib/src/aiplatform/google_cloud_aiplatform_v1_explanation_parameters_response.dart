...
class GoogleCloudAiplatformV1ExplanationParametersResponse {
  ...
  final GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse
  ...
  final GoogleCloudAiplatformV1SampledShapleyAttributionResponse
  ...
  factory GoogleCloudAiplatformV1ExplanationParametersResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1ExplanationParametersResponse(
      examples: GoogleCloudAiplatformV1ExamplesResponse.fromMap(
        (map['examples'] as Map).cast<String, dynamic>(),
      ),
      integratedGradientsAttribution:
          GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse.fromMap(
            (map['integratedGradientsAttribution'] as Map)
                .cast<String, dynamic>(),
          ),
      outputIndices: (map['outputIndices'] as List).cast<dynamic>(),
      sampledShapleyAttribution:
          GoogleCloudAiplatformV1SampledShapleyAttributionResponse.fromMap(
            (map['sampledShapleyAttribution'] as Map).cast<String, dynamic>(),
          ),
      topK: map['topK'] as int,
      xraiAttribution: GoogleCloudAiplatformV1XraiAttributionResponse.fromMap(
