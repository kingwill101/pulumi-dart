...
class GoogleCloudAiplatformV1ExplanationParametersResponse {
  ...
  final GoogleCloudAiplatformV1ExamplesResponse examples;
  /// An attribution method that computes Aumann-Shapley values taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365
  final GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse integratedGradientsAttribution;
  ...
  final GoogleCloudAiplatformV1SampledShapleyAttributionResponse sampledShapleyAttribution;
  ...
  final GoogleCloudAiplatformV1XraiAttributionResponse xraiAttribution;
  ...
  factory GoogleCloudAiplatformV1ExplanationParametersResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExplanationParametersResponse(
      examples: GoogleCloudAiplatformV1ExamplesResponse.fromMap((map['examples'] as Map).cast<String, dynamic>()),
      integratedGradientsAttribution: GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>()),
      outputIndices: (map['outputIndices'] as List).cast<dynamic>(),
      sampledShapleyAttribution: GoogleCloudAiplatformV1SampledShapleyAttributionResponse.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>()),
      topK: map['topK'] as int,
      xraiAttribution: GoogleCloudAiplatformV1XraiAttributionResponse.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>()),
    );
  }
}
