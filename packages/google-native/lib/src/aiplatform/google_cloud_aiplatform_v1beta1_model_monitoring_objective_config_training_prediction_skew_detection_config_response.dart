...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['attributionScoreSkewThresholds'] = attributionScoreSkewThresholds;
    map['defaultSkewThreshold'] = defaultSkewThreshold.toMap();
    map['skewThresholds'] = skewThresholds;
    return map;
  }

  factory GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse(
      ...
      skewThresholds: (map['skewThresholds'] as Map).cast<String, String>(),
    );
  }
}
