...
class GetFeatureGroupFeatureAiplatformV1beta1Result {
  ...
  final GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigResponse monitoringConfig;
  ...
  final List<GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse> monitoringStats;
  /// Only applicable for Vertex AI Feature Store (Legacy). The list of historical stats and anomalies with specified objectives.
  final List<GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse> monitoringStatsAnomalies;
  ...
  /// Creates a new [GetFeatureGroupFeatureAiplatformV1beta1Result].
  ...
  GetFeatureGroupFeatureAiplatformV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'monitoringStats': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse, Map<String, dynamic>>(monitoringStats, (value) => value.toMap()),
      'monitoringStatsAnomalies': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse, Map<String, dynamic>>(monitoringStatsAnomalies, (value) => value.toMap()),
      'name': name,
  ...
  factory GetFeatureGroupFeatureAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetFeatureGroupFeatureAiplatformV1beta1Result(
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      disableMonitoring: map['disableMonitoring'] as bool,
      etag: map['etag'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      monitoringConfig: GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigResponse.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
      monitoringStats: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse>(map['monitoringStats'], (value) => GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse.fromMap((value as Map).cast<String, dynamic>())),
      monitoringStatsAnomalies: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse>(map['monitoringStatsAnomalies'], (value) => GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse.fromMap((value as Map).cast<String, dynamic>())),
