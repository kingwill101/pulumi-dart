...
class FeatureViewArgs {
  ...
  factory FeatureViewArgs.fromMap(Map<String, dynamic> map) {
    return FeatureViewArgs(
      bigQuerySource: map['bigQuerySource'] == null ? null : GoogleCloudAiplatformV1FeatureViewBigQuerySource.fromMap((map['bigQuerySource'] as Map).cast<String, dynamic>()),
      etag: map['etag'] == null ? null : map['etag'] as String,
      featureOnlineStoreId: map['featureOnlineStoreId'] as String,
      featureRegistrySource: map['featureRegistrySource'] == null ? null : GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource.fromMap((map['featureRegistrySource'] as Map).cast<String, dynamic>()),
      ...
      syncConfig: map['syncConfig'] == null ? null : GoogleCloudAiplatformV1FeatureViewSyncConfig.fromMap((map['syncConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
