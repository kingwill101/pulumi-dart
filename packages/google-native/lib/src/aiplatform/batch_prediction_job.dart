...
class BatchPredictionJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1CompletionStatsResponse>
      completionStats;
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1BatchDedicatedResourcesResponse>
      dedicatedResources;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1ExplanationSpecResponse>
      explanationSpec;
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse>
      inputConfig;

  /// Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
  late final pulumi
      .Output<GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse>
      instanceConfig;
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1ManualBatchTuningParametersResponse>
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse>
      outputConfig;

  /// Information further describing the output of this job.
  late final pulumi
      .Output<GoogleCloudAiplatformV1BatchPredictionJobOutputInfoResponse>
      outputInfo;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1ResourcesConsumedResponse>
      resourcesConsumed;
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1UnmanagedContainerModelResponse>
