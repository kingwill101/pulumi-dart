...
class GoogleCloudAiplatformV1beta1CustomJobSpecResponse {
  ...
  final List<GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse> workerPoolSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workerPoolSpecs': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse, Map<String, dynamic>>(workerPoolSpecs, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1CustomJobSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1CustomJobSpecResponse(
      baseOutputDirectory: GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap((map['baseOutputDirectory'] as Map).cast<String, dynamic>()),
      ...
      scheduling: GoogleCloudAiplatformV1beta1SchedulingResponse.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      tensorboard: map['tensorboard'] as String,
      workerPoolSpecs: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse>(map['workerPoolSpecs'], (value) => GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
