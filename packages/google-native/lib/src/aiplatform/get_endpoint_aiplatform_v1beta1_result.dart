...
class GetEndpointAiplatformV1beta1Result {
  ...
  final GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse
  ...
  Map<String, dynamic> toMap() {
    ...
    map['etag'] = etag;
    map['labels'] = labels;
    map['modelDeploymentMonitoringJob'] = modelDeploymentMonitoringJob;
    map['name'] = name;
    map['network'] = network;
    map['predictRequestResponseLoggingConfig'] =
        predictRequestResponseLoggingConfig.toMap();
    map['trafficSplit'] = trafficSplit;
  ...
  factory GetEndpointAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetEndpointAiplatformV1beta1Result(
      ...
      deployedModels: pulumi.Input.decodeList<
              GoogleCloudAiplatformV1beta1DeployedModelResponse>(
          map['deployedModels'],
          (value) => GoogleCloudAiplatformV1beta1DeployedModelResponse.fromMap(
      ...
      predictRequestResponseLoggingConfig:
          GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse
              .fromMap((map['predictRequestResponseLoggingConfig'] as Map)
                  .cast<String, dynamic>()),
