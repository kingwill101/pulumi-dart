...
class GoogleCloudAiplatformV1beta1NasJobOutputMultiTrialJobOutputResponse {
  ...
  final List<GoogleCloudAiplatformV1beta1NasTrialResponse> searchTrials;
  /// List of NasTrials that were started as part of train stage.
  final List<GoogleCloudAiplatformV1beta1NasTrialResponse> trainTrials;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'searchTrials': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1NasTrialResponse, Map<String, dynamic>>(searchTrials, (value) => value.toMap()),
      'trainTrials': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1NasTrialResponse, Map<String, dynamic>>(trainTrials, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1NasJobOutputMultiTrialJobOutputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NasJobOutputMultiTrialJobOutputResponse(
      searchTrials: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1NasTrialResponse>(map['searchTrials'], (value) => GoogleCloudAiplatformV1beta1NasTrialResponse.fromMap((value as Map).cast<String, dynamic>())),
      trainTrials: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1NasTrialResponse>(map['trainTrials'], (value) => GoogleCloudAiplatformV1beta1NasTrialResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
