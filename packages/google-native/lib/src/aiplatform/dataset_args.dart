...
class DatasetArgs {
  ...
  factory DatasetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetArgs(
      ...
      savedQueries: map['savedQueries'] == null ? null : pulumi.Input.decodeList<GoogleCloudAiplatformV1SavedQuery>(map['savedQueries'], (value) => GoogleCloudAiplatformV1SavedQuery.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
