...
class GoogleCloudAiplatformV1beta1Model {
  ...
  final GoogleCloudAiplatformV1beta1EncryptionSpec? encryptionSpec;
  ...
  final GoogleCloudAiplatformV1beta1ExplanationSpec? explanationSpec;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'encryptionSpec': ?encryptionSpec == null ? null : encryptionSpec!.toMap(),
      'etag': ?etag,
      'explanationSpec': ?explanationSpec == null ? null : explanationSpec!.toMap(),
      'labels': ?labels,
      'metadata': ?metadata,
      'metadataSchemaUri': ?metadataSchemaUri,
      'name': ?name,
      'predictSchemata': ?predictSchemata == null ? null : predictSchemata!.toMap(),
  ...
  factory GoogleCloudAiplatformV1beta1Model.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1Model(
      artifactUri: map['artifactUri'] == null ? null : map['artifactUri'] as String,
      containerSpec: map['containerSpec'] == null ? null : GoogleCloudAiplatformV1beta1ModelContainerSpec.fromMap((map['containerSpec'] as Map).cast<String, dynamic>()),
      ...
      metadataSchemaUri: map['metadataSchemaUri'] == null ? null : map['metadataSchemaUri'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      predictSchemata: map['predictSchemata'] == null ? null : GoogleCloudAiplatformV1beta1PredictSchemata.fromMap((map['predictSchemata'] as Map).cast<String, dynamic>()),
      versionAliases: map['versionAliases'] == null ? null : (map['versionAliases'] as List).cast<String>(),
