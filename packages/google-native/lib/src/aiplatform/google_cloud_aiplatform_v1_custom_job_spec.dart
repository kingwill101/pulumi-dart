...
class GoogleCloudAiplatformV1CustomJobSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseOutputDirectory': ?baseOutputDirectory == null
          ? null
          : baseOutputDirectory!.toMap(),
  ...
  factory GoogleCloudAiplatformV1CustomJobSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1CustomJobSpec(
      ...
      experiment: map['experiment'] == null
          ? null
          : map['experiment'] as String,
      experimentRun: map['experimentRun'] == null
          ? null
          : map['experimentRun'] as String,
