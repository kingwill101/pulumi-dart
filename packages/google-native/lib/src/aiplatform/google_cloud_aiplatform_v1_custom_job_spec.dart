...
class GoogleCloudAiplatformV1CustomJobSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseOutputDirectory': ?baseOutputDirectory == null ? null : baseOutputDirectory!.toMap(),
      ...
      'workerPoolSpecs': pulumi.Input.encodeList<GoogleCloudAiplatformV1WorkerPoolSpec, Map<String, dynamic>>(workerPoolSpecs, (value) => value.toMap()),
    };
  }

  factory GoogleCloudAiplatformV1CustomJobSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1CustomJobSpec(
      baseOutputDirectory: map['baseOutputDirectory'] == null ? null : GoogleCloudAiplatformV1GcsDestination.fromMap((map['baseOutputDirectory'] as Map).cast<String, dynamic>()),
      enableDashboardAccess: map['enableDashboardAccess'] == null ? null : map['enableDashboardAccess'] as bool,
      enableWebAccess: map['enableWebAccess'] == null ? null : map['enableWebAccess'] as bool,
      experiment: map['experiment'] == null ? null : map['experiment'] as String,
      experimentRun: map['experimentRun'] == null ? null : map['experimentRun'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      protectedArtifactLocationId: map['protectedArtifactLocationId'] == null ? null : map['protectedArtifactLocationId'] as String,
      reservedIpRanges: map['reservedIpRanges'] == null ? null : (map['reservedIpRanges'] as List).cast<String>(),
      scheduling: map['scheduling'] == null ? null : GoogleCloudAiplatformV1Scheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      tensorboard: map['tensorboard'] == null ? null : map['tensorboard'] as String,
      workerPoolSpecs: pulumi.Input.decodeList<GoogleCloudAiplatformV1WorkerPoolSpec>(map['workerPoolSpecs'], (value) => GoogleCloudAiplatformV1WorkerPoolSpec.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
