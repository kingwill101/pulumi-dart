...
class GoogleCloudAiplatformV1beta1SmoothGradConfigResponse {
  ...
  final GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse featureNoiseSigma;
  ...
  factory GoogleCloudAiplatformV1beta1SmoothGradConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1SmoothGradConfigResponse(
      featureNoiseSigma:
          GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse.fromMap(
