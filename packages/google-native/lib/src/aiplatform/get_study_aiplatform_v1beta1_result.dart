...
class GetStudyAiplatformV1beta1Result {
  ...
  /// Creates a new [GetStudyAiplatformV1beta1Result].
  ...
  factory GetStudyAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetStudyAiplatformV1beta1Result(
