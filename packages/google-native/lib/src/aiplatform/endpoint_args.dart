...
class EndpointArgs {
  ...
  final pulumi
      .Input<GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig>?
  ...
  EndpointArgs({
    ...
    Map<String, String>? trafficSplit,
        ...
        trafficSplit =
            pulumi.Input.asOptionalInput<Map<String, String>>(trafficSplit);
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      trafficSplit: map['trafficSplit'] == null
          ? null
          : (map['trafficSplit'] as Map).cast<String, String>(),
    );
  }
}
