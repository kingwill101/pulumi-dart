...
class GetDatasetAiplatformV1beta1Result {
  ...
  GetDatasetAiplatformV1beta1Result({
    ...
    return <String, dynamic>{
      ...
      'savedQueries':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(savedQueries, (value) => value.toMap()),
  ...
  factory GetDatasetAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetDatasetAiplatformV1beta1Result(
      ...
      savedQueries:
          pulumi
              .Input.decodeList<GoogleCloudAiplatformV1beta1SavedQueryResponse>(
            map['savedQueries'],
            (value) => GoogleCloudAiplatformV1beta1SavedQueryResponse.fromMap(
