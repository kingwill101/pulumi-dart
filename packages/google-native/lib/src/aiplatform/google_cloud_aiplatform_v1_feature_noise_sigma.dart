...
class GoogleCloudAiplatformV1FeatureNoiseSigma {
  ...
  final List<GoogleCloudAiplatformV1FeatureNoiseSigmaNoiseSigmaForFeature>?
  noiseSigma;
  ...
  GoogleCloudAiplatformV1FeatureNoiseSigma({this.noiseSigma});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'noiseSigma': ?noiseSigma == null
          ? null
  ...
  factory GoogleCloudAiplatformV1FeatureNoiseSigma.fromMap(
      ...
      noiseSigma: map['noiseSigma'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['noiseSigma'],
              (value) =>
                  GoogleCloudAiplatformV1FeatureNoiseSigmaNoiseSigmaForFeature.fromMap(
