...
class GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse {
  /// Columns to construct entity_id / row keys. Start by supporting 1 only.
  final List<String> entityIdColumns;
  /// The BigQuery view URI that will be materialized on each sync trigger based on FeatureView.SyncConfig.
  final String uri;

  /// Creates a new [GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse].
  ...
  factory GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1FeatureViewBigQuerySourceResponse(
