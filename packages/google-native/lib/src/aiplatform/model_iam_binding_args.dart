...
/// {@template pulumi_aiplatform_v1beta1_model_iam_binding_args_doc}
/// The set of arguments for ModelIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_model_iam_binding_args_doc}
class ModelIamBindingArgs {
  ...
  /// Creates a new [ModelIamBindingArgs].
  ...
  factory ModelIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ModelIamBindingArgs(
