...
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse(
      categoricalValueSpec:
          GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpecResponse.fromMap(
      ...
      conditionalParameterSpecs:
          ...
          >(
            ...
            (value) =>
                GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      discreteValueSpec:
          GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecResponse.fromMap(
            (map['discreteValueSpec'] as Map).cast<String, dynamic>(),
          ),
      doubleValueSpec:
          GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpecResponse.fromMap(
            (map['doubleValueSpec'] as Map).cast<String, dynamic>(),
          ),
      integerValueSpec:
          GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpecResponse.fromMap(
