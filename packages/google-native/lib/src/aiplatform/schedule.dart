...
class Schedule extends pulumi.CustomResource {
  ...
  Schedule(
    ...
    this.createPipelineJobRequest = registerOutput<GoogleCloudAiplatformV1CreatePipelineJobRequestResponse>('createPipelineJobRequest');
    ...
    this.lastScheduledRunResponse = registerOutput<GoogleCloudAiplatformV1ScheduleRunResponseResponse>('lastScheduledRunResponse');
