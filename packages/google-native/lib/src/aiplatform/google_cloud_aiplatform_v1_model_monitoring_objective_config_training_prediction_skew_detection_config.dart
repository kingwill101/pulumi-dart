...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultSkewThreshold': ?defaultSkewThreshold == null ? null : defaultSkewThreshold!.toMap(),
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig(
      attributionScoreSkewThresholds: map['attributionScoreSkewThresholds'] == null ? null : (map['attributionScoreSkewThresholds'] as Map).cast<String, String>(),
      defaultSkewThreshold: map['defaultSkewThreshold'] == null ? null : GoogleCloudAiplatformV1ThresholdConfig.fromMap((map['defaultSkewThreshold'] as Map).cast<String, dynamic>()),
      skewThresholds: map['skewThresholds'] == null ? null : (map['skewThresholds'] as Map).cast<String, String>(),
    );
  }
}
