...
class GoogleCloudAiplatformV1beta1XraiAttributionResponse {
  ...
  final GoogleCloudAiplatformV1beta1BlurBaselineConfigResponse blurBaselineConfig;
  ...
  factory GoogleCloudAiplatformV1beta1XraiAttributionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1XraiAttributionResponse(
      blurBaselineConfig: GoogleCloudAiplatformV1beta1BlurBaselineConfigResponse.fromMap((map['blurBaselineConfig'] as Map).cast<String, dynamic>()),
      smoothGradConfig: GoogleCloudAiplatformV1beta1SmoothGradConfigResponse.fromMap((map['smoothGradConfig'] as Map).cast<String, dynamic>()),
