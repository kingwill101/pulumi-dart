...
class GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec {
  ...
  /// Creates a new [GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec].
  ...
  Map<String, dynamic> toMap() {
    ...
    final maxStepCountValue = maxStepCount;
    if (maxStepCountValue != null) {
      map['maxStepCount'] = maxStepCountValue;
    }
    final minMeasurementCountValue = minMeasurementCount;
    if (minMeasurementCountValue != null) {
      map['minMeasurementCount'] = minMeasurementCountValue;
    }
    final minStepCountValue = minStepCount;
    if (minStepCountValue != null) {
      map['minStepCount'] = minStepCountValue;
    }
    final updateAllStoppedTrialsValue = updateAllStoppedTrials;
    if (updateAllStoppedTrialsValue != null) {
      map['updateAllStoppedTrials'] = updateAllStoppedTrialsValue;
    }
  ...
  factory GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec(
      ...
      maxStepCount:
          map['maxStepCount'] == null ? null : map['maxStepCount'] as String,
      minMeasurementCount: map['minMeasurementCount'] == null
          ? null
          : map['minMeasurementCount'] as String,
      minStepCount:
          map['minStepCount'] == null ? null : map['minStepCount'] as String,
      updateAllStoppedTrials: map['updateAllStoppedTrials'] == null
          ? null
