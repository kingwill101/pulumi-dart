...
/// {@template pulumi_aiplatform_v1beta1_featurestore_iam_binding_aiplatform_v1beta1_args_doc}
/// The set of arguments for FeaturestoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_featurestore_iam_binding_aiplatform_v1beta1_args_doc}
class FeaturestoreIamBindingAiplatformV1beta1Args {
  ...
  /// Creates a new [FeaturestoreIamBindingAiplatformV1beta1Args].
  ...
  FeaturestoreIamBindingAiplatformV1beta1Args({
    Condition? condition,
  ...
  factory FeaturestoreIamBindingAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamBindingAiplatformV1beta1Args(
