...
class GoogleCloudAiplatformV1beta1Examples {
  ...
  factory GoogleCloudAiplatformV1beta1Examples.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1Examples(
      exampleGcsSource: map['exampleGcsSource'] == null ? null : GoogleCloudAiplatformV1beta1ExamplesExampleGcsSource.fromMap((map['exampleGcsSource'] as Map).cast<String, dynamic>()),
      ...
      presets: map['presets'] == null ? null : GoogleCloudAiplatformV1beta1Presets.fromMap((map['presets'] as Map).cast<String, dynamic>()),
    );
  }
}
