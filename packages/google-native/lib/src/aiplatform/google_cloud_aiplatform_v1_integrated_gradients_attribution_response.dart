...
class GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse {
  ...
  final GoogleCloudAiplatformV1BlurBaselineConfigResponse blurBaselineConfig;

  /// Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
  final GoogleCloudAiplatformV1SmoothGradConfigResponse smoothGradConfig;
  ...
  /// Creates a new [GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blurBaselineConfig': blurBaselineConfig.toMap(),
      'smoothGradConfig': smoothGradConfig.toMap(),
      'stepCount': stepCount,
    };
  }
  ...
  factory GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse(
      ...
      smoothGradConfig: GoogleCloudAiplatformV1SmoothGradConfigResponse.fromMap(
