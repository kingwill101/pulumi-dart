...
class NotebookRuntimeTemplateAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1PersistentDiskSpecResponse>
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1NotebookEucConfigResponse> eucConfig;

  /// The idle shutdown configuration of NotebookRuntimeTemplate. This config will only be set when idle shutdown is enabled.
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfigResponse>
      idleShutdownConfig;
