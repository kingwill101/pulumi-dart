...
class GoogleCloudAiplatformV1InputDataConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'datasetId': datasetId,
      'filterSplit': filterSplit.toMap(),
      'fractionSplit': fractionSplit.toMap(),
      'gcsDestination': gcsDestination.toMap(),
      'persistMlUseAssignment': persistMlUseAssignment,
      'predefinedSplit': predefinedSplit.toMap(),
      'savedQueryId': savedQueryId,
      'stratifiedSplit': stratifiedSplit.toMap(),
      'timestampSplit': timestampSplit.toMap(),
    };
  }
