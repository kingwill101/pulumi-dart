...
class GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse {
  ...
  final GoogleCloudAiplatformV1PipelineTaskExecutorDetailContainerDetailResponse
      containerDetail;

  /// The detailed info for a custom job executor.
  final GoogleCloudAiplatformV1PipelineTaskExecutorDetailCustomJobDetailResponse
      customJobDetail;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['containerDetail'] = containerDetail.toMap();
    map['customJobDetail'] = customJobDetail.toMap();
    return map;
  }

  factory GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse(
      containerDetail:
          GoogleCloudAiplatformV1PipelineTaskExecutorDetailContainerDetailResponse
              .fromMap((map['containerDetail'] as Map).cast<String, dynamic>()),
      customJobDetail:
          GoogleCloudAiplatformV1PipelineTaskExecutorDetailCustomJobDetailResponse
              .fromMap((map['customJobDetail'] as Map).cast<String, dynamic>()),
    );
  }
}
