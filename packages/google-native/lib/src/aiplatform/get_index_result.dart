...
class GetIndexResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedIndexes': pulumi.Input.encodeList<GoogleCloudAiplatformV1DeployedIndexRefResponse, Map<String, dynamic>>(deployedIndexes, (value) => value.toMap()),
  ...
  factory GetIndexResult.fromMap(Map<String, dynamic> map) {
    return GetIndexResult(
      ...
      deployedIndexes: pulumi.Input.decodeList<GoogleCloudAiplatformV1DeployedIndexRefResponse>(map['deployedIndexes'], (value) => GoogleCloudAiplatformV1DeployedIndexRefResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      indexStats: GoogleCloudAiplatformV1IndexStatsResponse.fromMap((map['indexStats'] as Map).cast<String, dynamic>()),
