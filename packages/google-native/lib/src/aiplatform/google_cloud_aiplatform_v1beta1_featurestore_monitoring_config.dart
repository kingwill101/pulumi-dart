...
class GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfig {
  ...
  final GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigThresholdConfig?
  categoricalThresholdConfig;

  /// The config for ImportFeatures Analysis Based Feature Monitoring.
  final GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigImportFeaturesAnalysis?
  ...
  final GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigSnapshotAnalysis?
  snapshotAnalysis;
