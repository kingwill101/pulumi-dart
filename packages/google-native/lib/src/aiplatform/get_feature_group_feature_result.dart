...
class GetFeatureGroupFeatureResult {
  ...
  /// Creates a new [GetFeatureGroupFeatureResult].
  ...
  factory GetFeatureGroupFeatureResult.fromMap(Map<String, dynamic> map) {
    return GetFeatureGroupFeatureResult(
      ...
      monitoringStatsAnomalies:
          ...
          >(
            ...
            (value) =>
                GoogleCloudAiplatformV1FeatureMonitoringStatsAnomalyResponse.fromMap(
