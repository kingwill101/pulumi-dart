...
class MetadataSchemaAiplatformV1beta1Args {
  ...
  MetadataSchemaAiplatformV1beta1Args({
    ...
    String? schemaVersion,
      ...
      schemaType = pulumi.Input.asOptionalInput<MetadataSchemaSchemaTypeAiplatformV1beta1>(schemaType),
  ...
  factory MetadataSchemaAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MetadataSchemaAiplatformV1beta1Args(
      ...
      metadataSchemaId: map['metadataSchemaId'] == null ? null : map['metadataSchemaId'] as String,
      metadataStoreId: map['metadataStoreId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      schema: map['schema'] as String,
      schemaType: map['schemaType'] == null ? null : MetadataSchemaSchemaTypeAiplatformV1beta1.fromValue(map['schemaType'] as String),
