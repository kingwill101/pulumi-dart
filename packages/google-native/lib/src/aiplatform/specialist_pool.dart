...
class SpecialistPool extends pulumi.CustomResource {
  ...
  /// Creates a new [SpecialistPool].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SpecialistPool]. {@macro pulumi_aiplatform_v1_specialist_pool_args_doc}
  ...
  SpecialistPool(
    ...
    this.pendingDataLabelingJobs = registerOutput<List<String>>(
      'pendingDataLabelingJobs',
    );
    this.project = registerOutput<String>('project');
    this.specialistManagerEmails = registerOutput<List<String>>(
      'specialistManagerEmails',
    );
    this.specialistManagersCount = registerOutput<int>(
      'specialistManagersCount',
    );
    this.specialistWorkerEmails = registerOutput<List<String>>(
