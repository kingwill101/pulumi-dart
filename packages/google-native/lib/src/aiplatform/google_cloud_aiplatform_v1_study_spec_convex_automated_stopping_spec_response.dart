...
class GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['learningRateParameterName'] = learningRateParameterName;
    map['maxStepCount'] = maxStepCount;
    map['minMeasurementCount'] = minMeasurementCount;
    map['minStepCount'] = minStepCount;
    map['updateAllStoppedTrials'] = updateAllStoppedTrials;
  ...
  factory GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse(
      ...
      maxStepCount: map['maxStepCount'] as String,
      minMeasurementCount: map['minMeasurementCount'] as String,
      minStepCount: map['minStepCount'] as String,
      updateAllStoppedTrials: map['updateAllStoppedTrials'] as bool,
