...
class GoogleCloudAiplatformV1beta1RaySpec {
  ...
  factory GoogleCloudAiplatformV1beta1RaySpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1RaySpec(
      headNodeResourcePoolId: map['headNodeResourcePoolId'] == null ? null : map['headNodeResourcePoolId'] as String,
      imageUri: map['imageUri'] == null ? null : map['imageUri'] as String,
      resourcePoolImages: map['resourcePoolImages'] == null ? null : (map['resourcePoolImages'] as Map).cast<String, String>(),
    );
  }
}
