...
class GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['predictionsFormat'] = predictionsFormat;
    return map;
  }

  factory GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse(
      bigqueryDestination:
