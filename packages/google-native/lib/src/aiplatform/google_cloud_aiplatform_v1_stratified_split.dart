...
class GoogleCloudAiplatformV1StratifiedSplit {
  ...
  /// Creates a new [GoogleCloudAiplatformV1StratifiedSplit].
  ...
  factory GoogleCloudAiplatformV1StratifiedSplit.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StratifiedSplit(
      ...
      testFraction: map['testFraction'] == null ? null : map['testFraction'] as double,
      trainingFraction: map['trainingFraction'] == null ? null : map['trainingFraction'] as double,
      validationFraction: map['validationFraction'] == null ? null : map['validationFraction'] as double,
    );
  }
}
