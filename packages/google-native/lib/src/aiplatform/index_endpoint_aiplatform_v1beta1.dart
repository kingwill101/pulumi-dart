...
import 'index_endpoint_aiplatform_v1beta1_args.dart';

/// Creates an IndexEndpoint.
/// Auto-naming is currently not supported for this resource.
class IndexEndpointAiplatformV1beta1 extends pulumi.CustomResource {
  /// Timestamp when this IndexEndpoint was created.
  late final pulumi.Output<String> createTime;

  /// The indexes deployed in this endpoint.
  late final pulumi
      .Output<List<GoogleCloudAiplatformV1beta1DeployedIndexResponse>>
      deployedIndexes;
  ...
  late final pulumi
      .Output<GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigResponse>
  ...
  /// Creates a new [IndexEndpointAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IndexEndpointAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_index_endpoint_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IndexEndpointAiplatformV1beta1(
    String name, {
    IndexEndpointAiplatformV1beta1Args? args,
    ...
    this.deployedIndexes =
        registerOutput<List<GoogleCloudAiplatformV1beta1DeployedIndexResponse>>(
            'deployedIndexes');
