...
class GetPersistentResourceResult {
  ...
  /// Creates a new [GetPersistentResourceResult].
  ...
  /// [error] Only populated when persistent resource's state is `STOPPING` or `ERROR`.
  ...
  /// [resourceRuntime] Runtime information of the Persistent Resource.
    ...
    return <String, dynamic>{
      ...
      'resourcePools':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(resourcePools, (value) => value.toMap()),
      'resourceRuntime': resourceRuntime.toMap(),
      'resourceRuntimeSpec': resourceRuntimeSpec.toMap(),
      'startTime': startTime,
      'state': state,
