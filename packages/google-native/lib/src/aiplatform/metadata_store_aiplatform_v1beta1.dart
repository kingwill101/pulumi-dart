...
class MetadataStoreAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1MetadataStoreMetadataStoreStateResponse> state;
  ...
  MetadataStoreAiplatformV1beta1(
    ...
    this.state = registerOutput<GoogleCloudAiplatformV1beta1MetadataStoreMetadataStoreStateResponse>('state');
