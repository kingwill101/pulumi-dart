...
import 'endpoint_aiplatform_v1beta1_args.dart';
...
class EndpointAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1DeployedModelResponse>> deployedModels;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse> predictRequestResponseLoggingConfig;
  late final pulumi.Output<String> project;
  /// A map from a DeployedModel's ID to the percentage of this Endpoint's traffic that should be forwarded to that DeployedModel. If a DeployedModel's ID is not listed in this map, then it receives no traffic. The traffic percentage values must add up to 100, or map must be empty if the Endpoint is to not accept any traffic at a moment.
  late final pulumi.Output<Map<String, String>> trafficSplit;
  /// Timestamp when this Endpoint was last updated.
  late final pulumi.Output<String> updateTime;

  /// Creates a new [EndpointAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EndpointAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_endpoint_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  EndpointAiplatformV1beta1(
    String name, {
    EndpointAiplatformV1beta1Args? args,
    ...
    this.deployedModels = registerOutput<List<GoogleCloudAiplatformV1beta1DeployedModelResponse>>('deployedModels');
    ...
    this.modelDeploymentMonitoringJob = registerOutput<String>('modelDeploymentMonitoringJob');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.predictRequestResponseLoggingConfig = registerOutput<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse>('predictRequestResponseLoggingConfig');
