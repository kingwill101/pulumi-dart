...
class EndpointAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  EndpointAiplatformV1beta1(
    ...
    this.deployedModels =
        registerOutput<List<GoogleCloudAiplatformV1beta1DeployedModelResponse>>(
          'deployedModels',
        );
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.enablePrivateServiceConnect = registerOutput<bool>(
    ...
    this.modelDeploymentMonitoringJob = registerOutput<String>(
