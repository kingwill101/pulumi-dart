...
class EndpointAiplatformV1beta1Args {
  ...
  EndpointAiplatformV1beta1Args({
    ...
    String? location,
    String? network,
    GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig? predictRequestResponseLoggingConfig,
    String? project,
  ...
  factory EndpointAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointAiplatformV1beta1Args(
      ...
      predictRequestResponseLoggingConfig: map['predictRequestResponseLoggingConfig'] == null ? null : GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig.fromMap((map['predictRequestResponseLoggingConfig'] as Map).cast<String, dynamic>()),
