...
class GoogleCloudAiplatformV1beta1ContainerSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'args': ?args,
      'command': ?command,
      'env': ?env == null ? null : pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1EnvVar, Map<String, dynamic>>(env!, (value) => value.toMap()),
      'imageUri': imageUri,
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1ContainerSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ContainerSpec(
      ...
      env: map['env'] == null ? null : pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1EnvVar>(map['env'], (value) => GoogleCloudAiplatformV1beta1EnvVar.fromMap((value as Map).cast<String, dynamic>())),
