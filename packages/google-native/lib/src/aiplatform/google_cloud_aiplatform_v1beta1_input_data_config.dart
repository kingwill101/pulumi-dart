...
class GoogleCloudAiplatformV1beta1InputDataConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'predefinedSplit': ?predefinedSplit == null
          ? null
          : predefinedSplit!.toMap(),
      'savedQueryId': ?savedQueryId,
      'stratifiedSplit': ?stratifiedSplit == null
          ? null
          : stratifiedSplit!.toMap(),
      'timestampSplit': ?timestampSplit == null
          ? null
          : timestampSplit!.toMap(),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1InputDataConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1InputDataConfig(
      ...
      savedQueryId: map['savedQueryId'] == null
          ? null
          : map['savedQueryId'] as String,
