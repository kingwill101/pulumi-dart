...
class GoogleCloudAiplatformV1beta1InputDataConfig {
  ...
  final GoogleCloudAiplatformV1beta1FilterSplit? filterSplit;
  /// Split based on fractions defining the size of each set.
  final GoogleCloudAiplatformV1beta1FractionSplit? fractionSplit;
  ...
  final GoogleCloudAiplatformV1beta1PredefinedSplit? predefinedSplit;
  ...
  final GoogleCloudAiplatformV1beta1StratifiedSplit? stratifiedSplit;
  /// Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
  final GoogleCloudAiplatformV1beta1TimestampSplit? timestampSplit;
  ...
  factory GoogleCloudAiplatformV1beta1InputDataConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1InputDataConfig(
      ...
      filterSplit: map['filterSplit'] == null ? null : GoogleCloudAiplatformV1beta1FilterSplit.fromMap((map['filterSplit'] as Map).cast<String, dynamic>()),
      fractionSplit: map['fractionSplit'] == null ? null : GoogleCloudAiplatformV1beta1FractionSplit.fromMap((map['fractionSplit'] as Map).cast<String, dynamic>()),
      ...
      predefinedSplit: map['predefinedSplit'] == null ? null : GoogleCloudAiplatformV1beta1PredefinedSplit.fromMap((map['predefinedSplit'] as Map).cast<String, dynamic>()),
      savedQueryId: map['savedQueryId'] == null ? null : map['savedQueryId'] as String,
      stratifiedSplit: map['stratifiedSplit'] == null ? null : GoogleCloudAiplatformV1beta1StratifiedSplit.fromMap((map['stratifiedSplit'] as Map).cast<String, dynamic>()),
      timestampSplit: map['timestampSplit'] == null ? null : GoogleCloudAiplatformV1beta1TimestampSplit.fromMap((map['timestampSplit'] as Map).cast<String, dynamic>()),
    );
  }
}
