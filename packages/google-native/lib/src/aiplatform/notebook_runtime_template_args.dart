...
class NotebookRuntimeTemplateArgs {
  ...
  NotebookRuntimeTemplateArgs({
    ...
    NotebookRuntimeTemplateNotebookRuntimeType? notebookRuntimeType,
    String? project,
  ...
  factory NotebookRuntimeTemplateArgs.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateArgs(
      dataPersistentDiskSpec: map['dataPersistentDiskSpec'] == null ? null : GoogleCloudAiplatformV1PersistentDiskSpec.fromMap((map['dataPersistentDiskSpec'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      eucConfig: map['eucConfig'] == null ? null : GoogleCloudAiplatformV1NotebookEucConfig.fromMap((map['eucConfig'] as Map).cast<String, dynamic>()),
      idleShutdownConfig: map['idleShutdownConfig'] == null ? null : GoogleCloudAiplatformV1NotebookIdleShutdownConfig.fromMap((map['idleShutdownConfig'] as Map).cast<String, dynamic>()),
      ...
      networkSpec: map['networkSpec'] == null ? null : GoogleCloudAiplatformV1NetworkSpec.fromMap((map['networkSpec'] as Map).cast<String, dynamic>()),
      notebookRuntimeTemplateId: map['notebookRuntimeTemplateId'] == null ? null : map['notebookRuntimeTemplateId'] as String,
      notebookRuntimeType: map['notebookRuntimeType'] == null ? null : NotebookRuntimeTemplateNotebookRuntimeType.fromValue(map['notebookRuntimeType'] as String),
