  ...
  factory NotebookRuntimeTemplateArgs.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateArgs(
      dataPersistentDiskSpec: map['dataPersistentDiskSpec'] == null
          ? null
          : GoogleCloudAiplatformV1PersistentDiskSpec.fromMap(
      ...
      eucConfig: map['eucConfig'] == null
          ? null
          : GoogleCloudAiplatformV1NotebookEucConfig.fromMap(
              (map['eucConfig'] as Map).cast<String, dynamic>(),
            ),
      idleShutdownConfig: map['idleShutdownConfig'] == null
          ? null
          : GoogleCloudAiplatformV1NotebookIdleShutdownConfig.fromMap(
      ...
      networkSpec: map['networkSpec'] == null
          ? null
          : GoogleCloudAiplatformV1NetworkSpec.fromMap(
      ...
      notebookRuntimeType: map['notebookRuntimeType'] == null
          ? null
          : NotebookRuntimeTemplateNotebookRuntimeType.fromValue(
