...
class GetTrainingPipelineAiplatformV1beta1Result {
  ...
  final GoogleCloudAiplatformV1beta1InputDataConfigResponse inputDataConfig;
  ...
  final GoogleCloudAiplatformV1beta1ModelResponse modelToUpload;
  ...
  /// Creates a new [GetTrainingPipelineAiplatformV1beta1Result].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['inputDataConfig'] = inputDataConfig.toMap();
    map['labels'] = labels;
    map['modelId'] = modelId;
    map['modelToUpload'] = modelToUpload.toMap();
    map['name'] = name;
    map['parentModel'] = parentModel;
    map['startTime'] = startTime;
    map['state'] = state;
    map['trainingTaskDefinition'] = trainingTaskDefinition;
    map['trainingTaskInputs'] = trainingTaskInputs;
    map['trainingTaskMetadata'] = trainingTaskMetadata;
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetTrainingPipelineAiplatformV1beta1Result.fromMap(
      Map<String, dynamic> map) {
    return GetTrainingPipelineAiplatformV1beta1Result(
      ...
      inputDataConfig:
          GoogleCloudAiplatformV1beta1InputDataConfigResponse.fromMap(
              (map['inputDataConfig'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      modelId: map['modelId'] as String,
      modelToUpload: GoogleCloudAiplatformV1beta1ModelResponse.fromMap(
