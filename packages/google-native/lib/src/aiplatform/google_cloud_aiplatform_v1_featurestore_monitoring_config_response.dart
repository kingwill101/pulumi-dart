...
class GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse {
  ...
  factory GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse(
      categoricalThresholdConfig:
          GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfigResponse.fromMap(
            (map['categoricalThresholdConfig'] as Map).cast<String, dynamic>(),
          ),
      importFeaturesAnalysis:
          GoogleCloudAiplatformV1FeaturestoreMonitoringConfigImportFeaturesAnalysisResponse.fromMap(
      ...
      snapshotAnalysis:
          GoogleCloudAiplatformV1FeaturestoreMonitoringConfigSnapshotAnalysisResponse.fromMap(
