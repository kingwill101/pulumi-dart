...
class GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse {
  ...
  final List<GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureResponse> noiseSigma;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'noiseSigma': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureResponse, Map<String, dynamic>>(noiseSigma, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse(
      noiseSigma: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureResponse>(map['noiseSigma'], (value) => GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
