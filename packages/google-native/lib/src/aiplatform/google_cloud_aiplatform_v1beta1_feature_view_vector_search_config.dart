...
class GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig {
  ...
  final GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType?
      distanceMeasureType;
  ...
  final GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigTreeAHConfig?
      treeAhConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    final bruteForceConfigValue = bruteForceConfig;
    if (bruteForceConfigValue != null) {
      map['bruteForceConfig'] = bruteForceConfigValue;
    }
    final crowdingColumnValue = crowdingColumn;
    if (crowdingColumnValue != null) {
      map['crowdingColumn'] = crowdingColumnValue;
    }
    final distanceMeasureTypeValue = distanceMeasureType;
    if (distanceMeasureTypeValue != null) {
      map['distanceMeasureType'] = distanceMeasureTypeValue.value;
    }
    final embeddingColumnValue = embeddingColumn;
    if (embeddingColumnValue != null) {
      map['embeddingColumn'] = embeddingColumnValue;
    }
    final embeddingDimensionValue = embeddingDimension;
    if (embeddingDimensionValue != null) {
      map['embeddingDimension'] = embeddingDimensionValue;
    }
    final filterColumnsValue = filterColumns;
    if (filterColumnsValue != null) {
      map['filterColumns'] = filterColumnsValue;
    }
    final treeAhConfigValue = treeAhConfig;
    if (treeAhConfigValue != null) {
      map['treeAhConfig'] = treeAhConfigValue.toMap();
    }
    return map;
  }

  factory GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig(
      ...
      crowdingColumn: map['crowdingColumn'] == null
          ? null
          : map['crowdingColumn'] as String,
      distanceMeasureType: map['distanceMeasureType'] == null
          ...
          : GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType
              .fromValue(map['distanceMeasureType'] as String),
      embeddingColumn: map['embeddingColumn'] == null
          ? null
          : map['embeddingColumn'] as String,
      embeddingDimension: map['embeddingDimension'] == null
          ? null
          : map['embeddingDimension'] as int,
      filterColumns: map['filterColumns'] == null
          ? null
          : (map['filterColumns'] as List).cast<String>(),
      treeAhConfig: map['treeAhConfig'] == null
          ? null
          : GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigTreeAHConfig
              .fromMap((map['treeAhConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
