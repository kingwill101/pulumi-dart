...
import 'entity_type_aiplatform_v1beta1_args.dart';
import 'google_cloud_aiplatform_v1beta1_featurestore_monitoring_config_response.dart';

/// Creates a new EntityType in a given Featurestore.
class EntityTypeAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [EntityTypeAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EntityTypeAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_entity_type_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  EntityTypeAiplatformV1beta1(
    String name, {
    EntityTypeAiplatformV1beta1Args? args,
