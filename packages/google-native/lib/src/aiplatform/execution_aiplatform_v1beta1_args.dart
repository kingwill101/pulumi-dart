...
class ExecutionAiplatformV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<ExecutionStateAiplatformV1beta1, String>(state, (value) => value.value),
    };
  }
  ...
  factory ExecutionAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ExecutionAiplatformV1beta1Args(
      ...
      state: map['state'] == null ? null : ExecutionStateAiplatformV1beta1.fromValue(map['state'] as String),
    );
  }
}
