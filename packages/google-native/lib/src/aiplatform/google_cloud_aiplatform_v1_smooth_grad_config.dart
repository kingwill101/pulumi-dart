...
class GoogleCloudAiplatformV1SmoothGradConfig {
  ...
  final GoogleCloudAiplatformV1FeatureNoiseSigma? featureNoiseSigma;
  ...
  factory GoogleCloudAiplatformV1SmoothGradConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1SmoothGradConfig(
      featureNoiseSigma: map['featureNoiseSigma'] == null ? null : GoogleCloudAiplatformV1FeatureNoiseSigma.fromMap((map['featureNoiseSigma'] as Map).cast<String, dynamic>()),
