  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureNoiseSigma': ?featureNoiseSigma == null
          ? null
          : featureNoiseSigma!.toMap(),
      'noiseSigma': ?noiseSigma,
      'noisySampleCount': ?noisySampleCount,
    };
  }

  factory GoogleCloudAiplatformV1SmoothGradConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1SmoothGradConfig(
      featureNoiseSigma: map['featureNoiseSigma'] == null
          ? null
          : GoogleCloudAiplatformV1FeatureNoiseSigma.fromMap(
              (map['featureNoiseSigma'] as Map).cast<String, dynamic>(),
            ),
      noiseSigma: map['noiseSigma'] == null
          ? null
          : map['noiseSigma'] as double,
