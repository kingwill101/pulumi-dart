  ...
  factory BatchPredictionJobArgs.fromMap(Map<String, dynamic> map) {
    return BatchPredictionJobArgs(
      dedicatedResources: map['dedicatedResources'] == null
          ? null
          : GoogleCloudAiplatformV1BatchDedicatedResources.fromMap(
      ...
      inputConfig: GoogleCloudAiplatformV1BatchPredictionJobInputConfig.fromMap(
        (map['inputConfig'] as Map).cast<String, dynamic>(),
      ),
      instanceConfig: map['instanceConfig'] == null
          ? null
          : GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.fromMap(
      ...
      manualBatchTuningParameters: map['manualBatchTuningParameters'] == null
          ? null
          : GoogleCloudAiplatformV1ManualBatchTuningParameters.fromMap(
      ...
      modelParameters: map['modelParameters'] == null
          ...
          : map['modelParameters'],
      outputConfig:
          GoogleCloudAiplatformV1BatchPredictionJobOutputConfig.fromMap(
      ...
      unmanagedContainerModel: map['unmanagedContainerModel'] == null
          ? null
          : GoogleCloudAiplatformV1UnmanagedContainerModel.fromMap(
