...
class BatchPredictionJobArgs {
  ...
  BatchPredictionJobArgs({
    ...
    required GoogleCloudAiplatformV1BatchPredictionJobInputConfig inputConfig,
    GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig? instanceConfig,
    Map<String, String>? labels,
    String? location,
    GoogleCloudAiplatformV1ManualBatchTuningParameters? manualBatchTuningParameters,
    String? model,
    dynamic modelParameters,
    required GoogleCloudAiplatformV1BatchPredictionJobOutputConfig outputConfig,
    String? project,
  ...
  factory BatchPredictionJobArgs.fromMap(Map<String, dynamic> map) {
    return BatchPredictionJobArgs(
      dedicatedResources: map['dedicatedResources'] == null ? null : GoogleCloudAiplatformV1BatchDedicatedResources.fromMap((map['dedicatedResources'] as Map).cast<String, dynamic>()),
      ...
      explanationSpec: map['explanationSpec'] == null ? null : GoogleCloudAiplatformV1ExplanationSpec.fromMap((map['explanationSpec'] as Map).cast<String, dynamic>()),
      generateExplanation: map['generateExplanation'] == null ? null : map['generateExplanation'] as bool,
      inputConfig: GoogleCloudAiplatformV1BatchPredictionJobInputConfig.fromMap((map['inputConfig'] as Map).cast<String, dynamic>()),
      instanceConfig: map['instanceConfig'] == null ? null : GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.fromMap((map['instanceConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      manualBatchTuningParameters: map['manualBatchTuningParameters'] == null ? null : GoogleCloudAiplatformV1ManualBatchTuningParameters.fromMap((map['manualBatchTuningParameters'] as Map).cast<String, dynamic>()),
      model: map['model'] == null ? null : map['model'] as String,
      modelParameters: map['modelParameters'] == null ? null : map['modelParameters'],
      outputConfig: GoogleCloudAiplatformV1BatchPredictionJobOutputConfig.fromMap((map['outputConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      unmanagedContainerModel: map['unmanagedContainerModel'] == null ? null : GoogleCloudAiplatformV1UnmanagedContainerModel.fromMap((map['unmanagedContainerModel'] as Map).cast<String, dynamic>()),
    );
  }
}
