...
class Tensorboard extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Tensorboard]. {@macro pulumi_aiplatform_v1_tensorboard_args_doc}
  ...
  Tensorboard(
    ...
    this.blobStoragePathPrefix = registerOutput<String>(
