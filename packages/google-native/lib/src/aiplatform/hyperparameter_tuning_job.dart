...
class HyperparameterTuningJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1CustomJobSpecResponse> trialJobSpec;
  ...
  HyperparameterTuningJob(
    ...
    this.studySpec = registerOutput<GoogleCloudAiplatformV1StudySpecResponse>('studySpec');
    this.trialJobSpec = registerOutput<GoogleCloudAiplatformV1CustomJobSpecResponse>('trialJobSpec');
    this.trials = registerOutput<List<GoogleCloudAiplatformV1TrialResponse>>('trials');
