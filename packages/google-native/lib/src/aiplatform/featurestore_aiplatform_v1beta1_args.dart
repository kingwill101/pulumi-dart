...
class FeaturestoreAiplatformV1beta1Args {
  ...
  FeaturestoreAiplatformV1beta1Args({
    ...
    String? location,
    GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig? onlineServingConfig,
  ...
  factory FeaturestoreAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeaturestoreAiplatformV1beta1Args(
      ...
      onlineServingConfig: map['onlineServingConfig'] == null ? null : GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig.fromMap((map['onlineServingConfig'] as Map).cast<String, dynamic>()),
