...
class DataLabelingJobArgs {
  ...
  factory DataLabelingJobArgs.fromMap(Map<String, dynamic> map) {
    return DataLabelingJobArgs(
      activeLearningConfig: map['activeLearningConfig'] == null ? null : GoogleCloudAiplatformV1ActiveLearningConfig.fromMap((map['activeLearningConfig'] as Map).cast<String, dynamic>()),
      annotationLabels: map['annotationLabels'] == null ? null : (map['annotationLabels'] as Map).cast<String, String>(),
      ...
      specialistPools: map['specialistPools'] == null ? null : (map['specialistPools'] as List).cast<String>(),
    );
  }
}
