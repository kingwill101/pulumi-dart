...
class GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse {
  /// Email alert config.
  final GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigResponse
  emailAlertConfig;
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse(
      emailAlertConfig:
          GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigResponse.fromMap(
