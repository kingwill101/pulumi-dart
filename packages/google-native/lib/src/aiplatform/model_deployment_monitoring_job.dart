...
class ModelDeploymentMonitoringJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<
    List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse>
  >
  bigqueryTables;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1SamplingStrategyResponse>
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1GcsDestinationResponse>
  ...
  ModelDeploymentMonitoringJob(
    ...
    this.analysisInstanceSchemaUri = registerOutput<String>(
    ...
    this.enableMonitoringPipelineLogs = registerOutput<bool>(
    ...
    this.predictInstanceSchemaUri = registerOutput<String>(
      'predictInstanceSchemaUri',
    );
    this.project = registerOutput<String>('project');
    this.samplePredictInstance = registerOutput<dynamic>(
