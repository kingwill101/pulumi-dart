...
class PipelineJobArgs {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineJobRuntimeConfig>?
  runtimeConfig;
  ...
  PipelineJobArgs({
    ...
    String? templateUri,
       ...
       pipelineSpec = pulumi.Input.asOptionalInput<Map<String, String>>(
         pipelineSpec,
       ),
  ...
  factory PipelineJobArgs.fromMap(Map<String, dynamic> map) {
    return PipelineJobArgs(
      ...
      pipelineJobId: map['pipelineJobId'] == null
          ? null
          : map['pipelineJobId'] as String,
      ...
      runtimeConfig: map['runtimeConfig'] == null
          ? null
          : GoogleCloudAiplatformV1PipelineJobRuntimeConfig.fromMap(
              (map['runtimeConfig'] as Map).cast<String, dynamic>(),
            ),
      serviceAccount: map['serviceAccount'] == null
          ? null
          : map['serviceAccount'] as String,
      templateUri: map['templateUri'] == null
          ? null
          : map['templateUri'] as String,
    );
  }
}
