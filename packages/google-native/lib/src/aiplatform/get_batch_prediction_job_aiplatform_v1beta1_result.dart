...
class GetBatchPredictionJobAiplatformV1beta1Result {
  ...
  GetBatchPredictionJobAiplatformV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partialFailures':
          pulumi.Input.encodeList<
            GoogleRpcStatusResponseAiplatformV1beta1,
            Map<String, dynamic>
  ...
  factory GetBatchPredictionJobAiplatformV1beta1Result.fromMap(
    ...
    return GetBatchPredictionJobAiplatformV1beta1Result(
      ...
      inputConfig:
          GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfigResponse.fromMap(
            (map['inputConfig'] as Map).cast<String, dynamic>(),
          ),
      instanceConfig:
          GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse.fromMap(
            (map['instanceConfig'] as Map).cast<String, dynamic>(),
          ),
      labels: (map['labels'] as Map).cast<String, String>(),
      manualBatchTuningParameters:
          GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse.fromMap(
            (map['manualBatchTuningParameters'] as Map).cast<String, dynamic>(),
          ),
      ...
      modelMonitoringStatsAnomalies:
          ...
          >(
            ...
            (value) =>
                GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      modelMonitoringStatus: GoogleRpcStatusResponseAiplatformV1beta1.fromMap(
      ...
      outputConfig:
          GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse.fromMap(
            (map['outputConfig'] as Map).cast<String, dynamic>(),
          ),
      outputInfo:
          GoogleCloudAiplatformV1beta1BatchPredictionJobOutputInfoResponse.fromMap(
            (map['outputInfo'] as Map).cast<String, dynamic>(),
          ),
      partialFailures:
          pulumi.Input.decodeList<GoogleRpcStatusResponseAiplatformV1beta1>(
            map['partialFailures'],
            (value) => GoogleRpcStatusResponseAiplatformV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      resourcesConsumed:
