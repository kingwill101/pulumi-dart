...
class GoogleCloudAiplatformV1beta1StudySpecResponse {
  ...
  final GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecResponse convexAutomatedStoppingSpec;
  /// Deprecated. The automated early stopping using convex stopping rule.
  final GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse convexStopConfig;
  /// The automated early stopping spec using decay curve rule.
  final GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecResponse decayCurveStoppingSpec;
  /// Describe which measurement selection type will be used
  final String measurementSelectionType;
  /// The automated early stopping spec using median rule.
  final GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse medianAutomatedStoppingSpec;
  ...
  final List<GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse> parameters;
  /// Conditions for automated stopping of a Study. Enable automated stopping by configuring at least one condition.
  final GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse studyStoppingConfig;
  ...
  final GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigResponse transferLearningConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'algorithm': algorithm,
      'convexAutomatedStoppingSpec': convexAutomatedStoppingSpec.toMap(),
      'convexStopConfig': convexStopConfig.toMap(),
      'decayCurveStoppingSpec': decayCurveStoppingSpec.toMap(),
      'measurementSelectionType': measurementSelectionType,
      'medianAutomatedStoppingSpec': medianAutomatedStoppingSpec.toMap(),
      'metrics': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse, Map<String, dynamic>>(metrics, (value) => value.toMap()),
      'observationNoise': observationNoise,
      'parameters': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'studyStoppingConfig': studyStoppingConfig.toMap(),
      'transferLearningConfig': transferLearningConfig.toMap(),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecResponse(
      ...
      convexAutomatedStoppingSpec: GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecResponse.fromMap((map['convexAutomatedStoppingSpec'] as Map).cast<String, dynamic>()),
      convexStopConfig: GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse.fromMap((map['convexStopConfig'] as Map).cast<String, dynamic>()),
      decayCurveStoppingSpec: GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecResponse.fromMap((map['decayCurveStoppingSpec'] as Map).cast<String, dynamic>()),
      measurementSelectionType: map['measurementSelectionType'] as String,
      medianAutomatedStoppingSpec: GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse.fromMap((map['medianAutomatedStoppingSpec'] as Map).cast<String, dynamic>()),
      metrics: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse>(map['metrics'], (value) => GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
      observationNoise: map['observationNoise'] as String,
      parameters: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse>(map['parameters'], (value) => GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
      studyStoppingConfig: GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse.fromMap((map['studyStoppingConfig'] as Map).cast<String, dynamic>()),
      transferLearningConfig: GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigResponse.fromMap((map['transferLearningConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
