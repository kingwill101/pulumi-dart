...
class FeatureGroupFeatureAiplatformV1beta1Args {
  ...
  FeatureGroupFeatureAiplatformV1beta1Args({
    ...
    String? name,
    String? project,
    FeatureGroupFeatureValueTypeAiplatformV1beta1? valueType,
  ...
  factory FeatureGroupFeatureAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeatureGroupFeatureAiplatformV1beta1Args(
      ...
      valueType: map['valueType'] == null ? null : FeatureGroupFeatureValueTypeAiplatformV1beta1.fromValue(map['valueType'] as String),
