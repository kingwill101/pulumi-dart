...
class DataLabelingJob extends pulumi.CustomResource {
  ...
  DataLabelingJob(
    ...
    this.activeLearningConfig = registerOutput<GoogleCloudAiplatformV1ActiveLearningConfigResponse>('activeLearningConfig');
    this.annotationLabels = registerOutput<Map<String, String>>('annotationLabels');
    this.createTime = registerOutput<String>('createTime');
    this.currentSpend = registerOutput<GoogleTypeMoneyResponse>('currentSpend');
