...
class GoogleCloudAiplatformV1beta1DeployedIndexResponse {
  ...
  final GoogleCloudAiplatformV1beta1AutomaticResourcesResponse automaticResources;
  ...
  final GoogleCloudAiplatformV1beta1DeployedIndexAuthConfigResponse deployedIndexAuthConfig;
  ...
  final GoogleCloudAiplatformV1beta1IndexPrivateEndpointsResponse privateEndpoints;
  ...
  factory GoogleCloudAiplatformV1beta1DeployedIndexResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1DeployedIndexResponse(
      automaticResources: GoogleCloudAiplatformV1beta1AutomaticResourcesResponse.fromMap((map['automaticResources'] as Map).cast<String, dynamic>()),
      ...
      deployedIndexAuthConfig: GoogleCloudAiplatformV1beta1DeployedIndexAuthConfigResponse.fromMap((map['deployedIndexAuthConfig'] as Map).cast<String, dynamic>()),
      ...
      privateEndpoints: GoogleCloudAiplatformV1beta1IndexPrivateEndpointsResponse.fromMap((map['privateEndpoints'] as Map).cast<String, dynamic>()),
