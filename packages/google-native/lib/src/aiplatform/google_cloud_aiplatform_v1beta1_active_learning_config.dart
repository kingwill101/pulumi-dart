  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trainingConfig': ?trainingConfig == null
          ? null
          : trainingConfig!.toMap(),
    };
  }

  factory GoogleCloudAiplatformV1beta1ActiveLearningConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ActiveLearningConfig(
      ...
      sampleConfig: map['sampleConfig'] == null
          ? null
          : GoogleCloudAiplatformV1beta1SampleConfig.fromMap(
              (map['sampleConfig'] as Map).cast<String, dynamic>(),
            ),
      trainingConfig: map['trainingConfig'] == null
          ? null
          : GoogleCloudAiplatformV1beta1TrainingConfig.fromMap(
