...
import 'google_cloud_aiplatform_v1beta1_sample_config.dart';
import 'google_cloud_aiplatform_v1beta1_training_config.dart';
...
class GoogleCloudAiplatformV1beta1ActiveLearningConfig {
  ...
  final GoogleCloudAiplatformV1beta1SampleConfig? sampleConfig;
  /// CMLE training config. For every active learning labeling iteration, system will train a machine learning model on CMLE. The trained model will be used by data sampling algorithm to select DataItems.
  final GoogleCloudAiplatformV1beta1TrainingConfig? trainingConfig;

  /// Creates a new [GoogleCloudAiplatformV1beta1ActiveLearningConfig].
  ...
  factory GoogleCloudAiplatformV1beta1ActiveLearningConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ActiveLearningConfig(
      ...
      sampleConfig: map['sampleConfig'] == null ? null : GoogleCloudAiplatformV1beta1SampleConfig.fromMap((map['sampleConfig'] as Map).cast<String, dynamic>()),
      trainingConfig: map['trainingConfig'] == null ? null : GoogleCloudAiplatformV1beta1TrainingConfig.fromMap((map['trainingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
