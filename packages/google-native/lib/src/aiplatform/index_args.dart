...
class IndexArgs {
  ...
  IndexArgs({
    ...
    String? etag,
    IndexIndexUpdateMethod? indexUpdateMethod,
    ...
    String? project,
      ...
      indexUpdateMethod = pulumi.Input.asOptionalInput<IndexIndexUpdateMethod>(indexUpdateMethod),
  ...
  factory IndexArgs.fromMap(Map<String, dynamic> map) {
    return IndexArgs(
      ...
      indexUpdateMethod: map['indexUpdateMethod'] == null ? null : IndexIndexUpdateMethod.fromValue(map['indexUpdateMethod'] as String),
