...
class IndexArgs {
  ...
  IndexArgs({
    ...
    String? project,
       ...
       indexUpdateMethod = pulumi.Input.asOptionalInput<IndexIndexUpdateMethod>(
         indexUpdateMethod,
       ),
       labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
       location = pulumi.Input.asOptionalInput<String>(location),
       metadata = pulumi.Input.asOptionalInput<dynamic>(metadata),
       metadataSchemaUri = pulumi.Input.asOptionalInput<String>(
         metadataSchemaUri,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': ?etag,
      'indexUpdateMethod':
          ?pulumi.Input.mapOptionalInputValue<IndexIndexUpdateMethod, String>(
            indexUpdateMethod,
            (value) => value.value,
          ),
      'labels': ?labels,
  ...
  factory IndexArgs.fromMap(Map<String, dynamic> map) {
    return IndexArgs(
      ...
      indexUpdateMethod: map['indexUpdateMethod'] == null
          ? null
          : IndexIndexUpdateMethod.fromValue(
