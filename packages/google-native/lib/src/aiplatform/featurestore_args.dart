...
class FeaturestoreArgs {
  ...
  factory FeaturestoreArgs.fromMap(Map<String, dynamic> map) {
    return FeaturestoreArgs(
      ...
      onlineServingConfig: map['onlineServingConfig'] == null ? null : GoogleCloudAiplatformV1FeaturestoreOnlineServingConfig.fromMap((map['onlineServingConfig'] as Map).cast<String, dynamic>()),
      onlineStorageTtlDays: map['onlineStorageTtlDays'] == null ? null : map['onlineStorageTtlDays'] as int,
