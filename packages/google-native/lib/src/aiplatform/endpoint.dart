...
class Endpoint extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1DeployedModelResponse>> deployedModels;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse> predictRequestResponseLoggingConfig;
  ...
  /// [args] Arguments used to configure this [Endpoint]. {@macro pulumi_aiplatform_v1_endpoint_args_doc}
  ...
  Endpoint(
    ...
    this.deployedModels = registerOutput<List<GoogleCloudAiplatformV1DeployedModelResponse>>('deployedModels');
    ...
    this.predictRequestResponseLoggingConfig = registerOutput<GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse>('predictRequestResponseLoggingConfig');
