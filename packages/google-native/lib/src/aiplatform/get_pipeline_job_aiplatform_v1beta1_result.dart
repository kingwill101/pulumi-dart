...
class GetPipelineJobAiplatformV1beta1Result {
  ...
  final GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigResponse runtimeConfig;
  ...
  final GoogleCloudAiplatformV1beta1PipelineTemplateMetadataResponse templateMetadata;
  /// A template uri from where the PipelineJob.pipeline_spec, if empty, will be downloaded. Currently, only uri from Vertex Template Registry & Gallery is supported. Reference to https://cloud.google.com/vertex-ai/docs/pipelines/create-pipeline-template.
  final String templateUri;
  /// Timestamp when this PipelineJob was most recently updated.
  final String updateTime;

  /// Creates a new [GetPipelineJobAiplatformV1beta1Result].
  ...
  factory GetPipelineJobAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetPipelineJobAiplatformV1beta1Result(
      ...
      jobDetail: GoogleCloudAiplatformV1beta1PipelineJobDetailResponse.fromMap((map['jobDetail'] as Map).cast<String, dynamic>()),
      ...
      runtimeConfig: GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigResponse.fromMap((map['runtimeConfig'] as Map).cast<String, dynamic>()),
      scheduleName: map['scheduleName'] as String,
      serviceAccount: map['serviceAccount'] as String,
      startTime: map['startTime'] as String,
      state: map['state'] as String,
      templateMetadata: GoogleCloudAiplatformV1beta1PipelineTemplateMetadataResponse.fromMap((map['templateMetadata'] as Map).cast<String, dynamic>()),
