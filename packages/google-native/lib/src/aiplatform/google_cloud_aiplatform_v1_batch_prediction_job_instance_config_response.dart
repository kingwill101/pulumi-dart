...
class GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['excludedFields'] = excludedFields;
    map['includedFields'] = includedFields;
    map['instanceType'] = instanceType;
    map['keyField'] = keyField;
    return map;
  }

  factory GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse(
      excludedFields: (map['excludedFields'] as List).cast<String>(),
      includedFields: (map['includedFields'] as List).cast<String>(),
      instanceType: map['instanceType'] as String,
      keyField: map['keyField'] as String,
    );
  }
}
