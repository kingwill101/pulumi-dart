...
class IndexEndpointAiplatformV1beta1Args {
  ...
  IndexEndpointAiplatformV1beta1Args({
    ...
    String? location,
    String? network,
    GoogleCloudAiplatformV1beta1PrivateServiceConnectConfig? privateServiceConnectConfig,
    String? project,
  ...
  factory IndexEndpointAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IndexEndpointAiplatformV1beta1Args(
      ...
      privateServiceConnectConfig: map['privateServiceConnectConfig'] == null ? null : GoogleCloudAiplatformV1beta1PrivateServiceConnectConfig.fromMap((map['privateServiceConnectConfig'] as Map).cast<String, dynamic>()),
