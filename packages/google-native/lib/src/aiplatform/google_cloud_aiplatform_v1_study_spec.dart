...
class GoogleCloudAiplatformV1StudySpec {
  ...
  final GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec?
  convexAutomatedStoppingSpec;

  /// The automated early stopping spec using decay curve rule.
  final GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpec?
  decayCurveStoppingSpec;

  /// Describe which measurement selection type will be used
  final GoogleCloudAiplatformV1StudySpecMeasurementSelectionType?
  measurementSelectionType;

  /// The automated early stopping spec using median rule.
  final GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpec?
  ...
  final GoogleCloudAiplatformV1StudySpecStudyStoppingConfig?
  studyStoppingConfig;
  ...
  factory GoogleCloudAiplatformV1StudySpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpec(
      algorithm: map['algorithm'] == null
          ? null
          : GoogleCloudAiplatformV1StudySpecAlgorithm.fromValue(
              map['algorithm'] as String,
            ),
      convexAutomatedStoppingSpec: map['convexAutomatedStoppingSpec'] == null
          ? null
          : GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpec.fromMap(
              (map['convexAutomatedStoppingSpec'] as Map)
                  .cast<String, dynamic>(),
            ),
      decayCurveStoppingSpec: map['decayCurveStoppingSpec'] == null
          ? null
          : GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpec.fromMap(
              (map['decayCurveStoppingSpec'] as Map).cast<String, dynamic>(),
            ),
      measurementSelectionType: map['measurementSelectionType'] == null
          ? null
          : GoogleCloudAiplatformV1StudySpecMeasurementSelectionType.fromValue(
              map['measurementSelectionType'] as String,
            ),
      medianAutomatedStoppingSpec: map['medianAutomatedStoppingSpec'] == null
          ? null
          : GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpec.fromMap(
              (map['medianAutomatedStoppingSpec'] as Map)
                  .cast<String, dynamic>(),
            ),
      metrics:
          pulumi.Input.decodeList<GoogleCloudAiplatformV1StudySpecMetricSpec>(
            map['metrics'],
            (value) => GoogleCloudAiplatformV1StudySpecMetricSpec.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      observationNoise: map['observationNoise'] == null
          ? null
          : GoogleCloudAiplatformV1StudySpecObservationNoise.fromValue(
              map['observationNoise'] as String,
            ),
      parameters:
          pulumi
              .Input.decodeList<GoogleCloudAiplatformV1StudySpecParameterSpec>(
            map['parameters'],
            (value) => GoogleCloudAiplatformV1StudySpecParameterSpec.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      studyStoppingConfig: map['studyStoppingConfig'] == null
          ? null
          : GoogleCloudAiplatformV1StudySpecStudyStoppingConfig.fromMap(
