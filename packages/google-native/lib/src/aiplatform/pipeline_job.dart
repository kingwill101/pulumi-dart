...
class PipelineJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1PipelineJobDetailResponse> jobDetail;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse> runtimeConfig;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1PipelineTemplateMetadataResponse> templateMetadata;
  ...
  PipelineJob(
    ...
    this.jobDetail = registerOutput<GoogleCloudAiplatformV1PipelineJobDetailResponse>('jobDetail');
    ...
    this.runtimeConfig = registerOutput<GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse>('runtimeConfig');
    this.scheduleName = registerOutput<String>('scheduleName');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.startTime = registerOutput<String>('startTime');
    this.state = registerOutput<String>('state');
    this.templateMetadata = registerOutput<GoogleCloudAiplatformV1PipelineTemplateMetadataResponse>('templateMetadata');
