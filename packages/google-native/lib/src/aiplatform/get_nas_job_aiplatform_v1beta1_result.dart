...
class GetNasJobAiplatformV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['enableRestrictedImageTraining'] = enableRestrictedImageTraining;
    map['encryptionSpec'] = encryptionSpec.toMap();
    map['endTime'] = endTime;
    map['error'] = error.toMap();
    map['labels'] = labels;
    map['name'] = name;
    map['nasJobOutput'] = nasJobOutput.toMap();
    map['nasJobSpec'] = nasJobSpec.toMap();
  ...
  factory GetNasJobAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetNasJobAiplatformV1beta1Result(
      ...
      nasJobOutput: GoogleCloudAiplatformV1beta1NasJobOutputResponse.fromMap(
          (map['nasJobOutput'] as Map).cast<String, dynamic>()),
      nasJobSpec: GoogleCloudAiplatformV1beta1NasJobSpecResponse.fromMap(
