...
class GoogleCloudAiplatformV1ExplanationMetadataResponse {
  ...
  factory GoogleCloudAiplatformV1ExplanationMetadataResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExplanationMetadataResponse(
      featureAttributionsSchemaUri: map['featureAttributionsSchemaUri'] as String,
