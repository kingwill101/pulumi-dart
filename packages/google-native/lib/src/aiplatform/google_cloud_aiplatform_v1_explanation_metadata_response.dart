...
class GoogleCloudAiplatformV1ExplanationMetadataResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1ExplanationMetadataResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['featureAttributionsSchemaUri'] = featureAttributionsSchemaUri;
    map['inputs'] = inputs;
    map['latentSpaceSource'] = latentSpaceSource;
    map['outputs'] = outputs;
    return map;
  }

  factory GoogleCloudAiplatformV1ExplanationMetadataResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExplanationMetadataResponse(
      featureAttributionsSchemaUri:
          map['featureAttributionsSchemaUri'] as String,
      inputs: (map['inputs'] as Map).cast<String, String>(),
      latentSpaceSource: map['latentSpaceSource'] as String,
