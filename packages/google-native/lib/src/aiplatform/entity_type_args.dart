...
class EntityTypeArgs {
  ...
  factory EntityTypeArgs.fromMap(Map<String, dynamic> map) {
    return EntityTypeArgs(
      ...
      monitoringConfig: map['monitoringConfig'] == null ? null : GoogleCloudAiplatformV1FeaturestoreMonitoringConfig.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
