...
/// {@template pulumi_aiplatform_v1beta1_featurestore_iam_member_aiplatform_v1beta1_args_doc}
/// The set of arguments for FeaturestoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_featurestore_iam_member_aiplatform_v1beta1_args_doc}
class FeaturestoreIamMemberAiplatformV1beta1Args {
  ...
  /// Creates a new [FeaturestoreIamMemberAiplatformV1beta1Args].
  ...
  FeaturestoreIamMemberAiplatformV1beta1Args({
    Condition? condition,
  ...
  factory FeaturestoreIamMemberAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamMemberAiplatformV1beta1Args(
