...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigResponse {
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigResponse(
      explanationConfig:
          GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigExplanationConfigResponse.fromMap(
            (map['explanationConfig'] as Map).cast<String, dynamic>(),
          ),
      predictionDriftDetectionConfig:
          GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigResponse.fromMap(
            (map['predictionDriftDetectionConfig'] as Map)
                .cast<String, dynamic>(),
          ),
      trainingDataset:
          GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingDatasetResponse.fromMap(
            (map['trainingDataset'] as Map).cast<String, dynamic>(),
          ),
      trainingPredictionSkewDetectionConfig:
          GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse.fromMap(
