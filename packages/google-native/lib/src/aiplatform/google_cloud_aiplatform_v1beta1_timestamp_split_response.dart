...
class GoogleCloudAiplatformV1beta1TimestampSplitResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1TimestampSplitResponse].
  ...
  factory GoogleCloudAiplatformV1beta1TimestampSplitResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1TimestampSplitResponse(
