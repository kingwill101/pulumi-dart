...
class Trial extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1MeasurementResponse>> measurements;
  /// Resource name of the Trial assigned by the service.
  late final pulumi.Output<String> name;
  /// The parameters of the Trial.
  late final pulumi.Output<List<GoogleCloudAiplatformV1TrialParameterResponse>> parameters;
  ...
  Trial(
    ...
    this.finalMeasurement = registerOutput<GoogleCloudAiplatformV1MeasurementResponse>('finalMeasurement');
    this.infeasibleReason = registerOutput<String>('infeasibleReason');
    this.location = registerOutput<String>('location');
    this.measurements = registerOutput<List<GoogleCloudAiplatformV1MeasurementResponse>>('measurements');
    this.name = registerOutput<String>('name');
    this.parameters = registerOutput<List<GoogleCloudAiplatformV1TrialParameterResponse>>('parameters');
