...
class ModelDeploymentMonitoringJobAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponse>> bigqueryTables;
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponse>> modelDeploymentMonitoringObjectiveConfigs;
  ...
  ModelDeploymentMonitoringJobAiplatformV1beta1(
    ...
    this.bigqueryTables = registerOutput<List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponse>>('bigqueryTables');
    ...
    this.latestMonitoringPipelineMetadata = registerOutput<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse>('latestMonitoringPipelineMetadata');
    this.location = registerOutput<String>('location');
    this.logTtl = registerOutput<String>('logTtl');
    this.loggingSamplingStrategy = registerOutput<GoogleCloudAiplatformV1beta1SamplingStrategyResponse>('loggingSamplingStrategy');
    this.modelDeploymentMonitoringObjectiveConfigs = registerOutput<List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponse>>('modelDeploymentMonitoringObjectiveConfigs');
    this.modelDeploymentMonitoringScheduleConfig = registerOutput<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigResponse>('modelDeploymentMonitoringScheduleConfig');
    this.modelMonitoringAlertConfig = registerOutput<GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse>('modelMonitoringAlertConfig');
    ...
    this.statsAnomaliesBaseDirectory = registerOutput<GoogleCloudAiplatformV1beta1GcsDestinationResponse>('statsAnomaliesBaseDirectory');
