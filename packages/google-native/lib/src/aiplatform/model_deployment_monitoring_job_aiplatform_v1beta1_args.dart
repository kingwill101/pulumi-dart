...
class ModelDeploymentMonitoringJobAiplatformV1beta1Args {
  ...
  ModelDeploymentMonitoringJobAiplatformV1beta1Args({
    ...
    String? location,
    String? logTtl,
    required GoogleCloudAiplatformV1beta1SamplingStrategy loggingSamplingStrategy,
    required List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig> modelDeploymentMonitoringObjectiveConfigs,
    required GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfig modelDeploymentMonitoringScheduleConfig,
    GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfig? modelMonitoringAlertConfig,
  ...
  factory ModelDeploymentMonitoringJobAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ModelDeploymentMonitoringJobAiplatformV1beta1Args(
      ...
      loggingSamplingStrategy: GoogleCloudAiplatformV1beta1SamplingStrategy.fromMap((map['loggingSamplingStrategy'] as Map).cast<String, dynamic>()),
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig>(map['modelDeploymentMonitoringObjectiveConfigs'], (value) => GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig.fromMap((value as Map).cast<String, dynamic>())),
      modelDeploymentMonitoringScheduleConfig: GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfig.fromMap((map['modelDeploymentMonitoringScheduleConfig'] as Map).cast<String, dynamic>()),
      modelMonitoringAlertConfig: map['modelMonitoringAlertConfig'] == null ? null : GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfig.fromMap((map['modelMonitoringAlertConfig'] as Map).cast<String, dynamic>()),
      ...
      statsAnomaliesBaseDirectory: map['statsAnomaliesBaseDirectory'] == null ? null : GoogleCloudAiplatformV1beta1GcsDestination.fromMap((map['statsAnomaliesBaseDirectory'] as Map).cast<String, dynamic>()),
    );
  }
}
