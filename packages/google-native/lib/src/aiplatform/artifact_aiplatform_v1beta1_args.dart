...
class ArtifactAiplatformV1beta1Args {
  ...
  ArtifactAiplatformV1beta1Args({
    ...
    ArtifactStateAiplatformV1beta1? state,
    String? uri,
        ...
        state =
            pulumi.Input.asOptionalInput<ArtifactStateAiplatformV1beta1>(state),
  ...
  factory ArtifactAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ArtifactAiplatformV1beta1Args(
      ...
      state: map['state'] == null
          ? null
          : ArtifactStateAiplatformV1beta1.fromValue(map['state'] as String),
