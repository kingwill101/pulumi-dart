...
class TrainingPipelineAiplatformV1beta1Args {
  ...
  factory TrainingPipelineAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TrainingPipelineAiplatformV1beta1Args(
      ...
      inputDataConfig: map['inputDataConfig'] == null ? null : GoogleCloudAiplatformV1beta1InputDataConfig.fromMap((map['inputDataConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      modelId: map['modelId'] == null ? null : map['modelId'] as String,
      modelToUpload: map['modelToUpload'] == null ? null : GoogleCloudAiplatformV1beta1Model.fromMap((map['modelToUpload'] as Map).cast<String, dynamic>()),
