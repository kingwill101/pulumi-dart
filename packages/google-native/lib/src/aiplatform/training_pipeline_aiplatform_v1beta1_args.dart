...
class TrainingPipelineAiplatformV1beta1Args {
  ...
  TrainingPipelineAiplatformV1beta1Args({
    ...
    required dynamic trainingTaskInputs,
       ...
       trainingTaskDefinition = pulumi.Input.asInput<String>(
  ...
  factory TrainingPipelineAiplatformV1beta1Args.fromMap(
    ...
    return TrainingPipelineAiplatformV1beta1Args(
      ...
      inputDataConfig: map['inputDataConfig'] == null
          ? null
          : GoogleCloudAiplatformV1beta1InputDataConfig.fromMap(
      ...
      modelToUpload: map['modelToUpload'] == null
          ? null
          : GoogleCloudAiplatformV1beta1Model.fromMap(
              (map['modelToUpload'] as Map).cast<String, dynamic>(),
            ),
      parentModel: map['parentModel'] == null
          ? null
          : map['parentModel'] as String,
