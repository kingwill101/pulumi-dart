...
class TrialAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1MeasurementResponse>> measurements;
  /// Resource name of the Trial assigned by the service.
  late final pulumi.Output<String> name;
  /// The parameters of the Trial.
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1TrialParameterResponse>> parameters;
  ...
  TrialAiplatformV1beta1(
    ...
    this.finalMeasurement = registerOutput<GoogleCloudAiplatformV1beta1MeasurementResponse>('finalMeasurement');
    this.infeasibleReason = registerOutput<String>('infeasibleReason');
    this.location = registerOutput<String>('location');
    this.measurements = registerOutput<List<GoogleCloudAiplatformV1beta1MeasurementResponse>>('measurements');
    this.name = registerOutput<String>('name');
    this.parameters = registerOutput<List<GoogleCloudAiplatformV1beta1TrialParameterResponse>>('parameters');
