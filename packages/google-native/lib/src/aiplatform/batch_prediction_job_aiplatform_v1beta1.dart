...
class BatchPredictionJobAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1CompletionStatsResponse> completionStats;
  /// Time when the BatchPredictionJob was created.
  late final pulumi.Output<String> createTime;
  /// The config of resources used by the Model during the batch prediction. If the Model supports DEDICATED_RESOURCES this config may be provided (and the job will use these resources), if the Model doesn't support AUTOMATIC_RESOURCES, this config must be provided.
  late final pulumi.Output<GoogleCloudAiplatformV1beta1BatchDedicatedResourcesResponse> dedicatedResources;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1ExplanationSpecResponse> explanationSpec;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfigResponse> inputConfig;
  /// Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
  late final pulumi.Output<GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse> instanceConfig;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse> manualBatchTuningParameters;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse> modelMonitoringConfig;
  /// Get batch prediction job monitoring statistics.
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesResponse>> modelMonitoringStatsAnomalies;
  /// The running status of the model monitoring pipeline.
  late final pulumi.Output<GoogleRpcStatusResponseAiplatformV1beta1> modelMonitoringStatus;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse> outputConfig;
  /// Information further describing the output of this job.
  late final pulumi.Output<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputInfoResponse> outputInfo;
  ...
  late final pulumi.Output<List<GoogleRpcStatusResponseAiplatformV1beta1>> partialFailures;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1ResourcesConsumedResponse> resourcesConsumed;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1UnmanagedContainerModelResponse> unmanagedContainerModel;
  ...
  BatchPredictionJobAiplatformV1beta1(
    ...
    this.completionStats = registerOutput<GoogleCloudAiplatformV1beta1CompletionStatsResponse>('completionStats');
    this.createTime = registerOutput<String>('createTime');
    this.dedicatedResources = registerOutput<GoogleCloudAiplatformV1beta1BatchDedicatedResourcesResponse>('dedicatedResources');
    this.disableContainerLogging = registerOutput<bool>('disableContainerLogging');
    ...
    this.explanationSpec = registerOutput<GoogleCloudAiplatformV1beta1ExplanationSpecResponse>('explanationSpec');
    this.generateExplanation = registerOutput<bool>('generateExplanation');
    this.inputConfig = registerOutput<GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfigResponse>('inputConfig');
    this.instanceConfig = registerOutput<GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse>('instanceConfig');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.manualBatchTuningParameters = registerOutput<GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse>('manualBatchTuningParameters');
    this.model = registerOutput<String>('model');
    this.modelMonitoringConfig = registerOutput<GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse>('modelMonitoringConfig');
    this.modelMonitoringStatsAnomalies = registerOutput<List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesResponse>>('modelMonitoringStatsAnomalies');
    this.modelMonitoringStatus = registerOutput<GoogleRpcStatusResponseAiplatformV1beta1>('modelMonitoringStatus');
    ...
    this.outputConfig = registerOutput<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse>('outputConfig');
    this.outputInfo = registerOutput<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputInfoResponse>('outputInfo');
    this.partialFailures = registerOutput<List<GoogleRpcStatusResponseAiplatformV1beta1>>('partialFailures');
    this.project = registerOutput<String>('project');
    this.resourcesConsumed = registerOutput<GoogleCloudAiplatformV1beta1ResourcesConsumedResponse>('resourcesConsumed');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.startTime = registerOutput<String>('startTime');
    this.state = registerOutput<String>('state');
    this.unmanagedContainerModel = registerOutput<GoogleCloudAiplatformV1beta1UnmanagedContainerModelResponse>('unmanagedContainerModel');
