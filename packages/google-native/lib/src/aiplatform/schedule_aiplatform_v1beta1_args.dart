...
class ScheduleAiplatformV1beta1Args {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1CreatePipelineJobRequest>? createPipelineJobRequest;
  ...
  ScheduleAiplatformV1beta1Args({
    bool? allowQueueing,
    GoogleCloudAiplatformV1beta1CreatePipelineJobRequest? createPipelineJobRequest,
    String? cron,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'createPipelineJobRequest': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1CreatePipelineJobRequest, Map<String, dynamic>>(createPipelineJobRequest, (value) => value.toMap()),
      'cron': ?cron,
  ...
  factory ScheduleAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ScheduleAiplatformV1beta1Args(
      ...
      createPipelineJobRequest: map['createPipelineJobRequest'] == null ? null : GoogleCloudAiplatformV1beta1CreatePipelineJobRequest.fromMap((map['createPipelineJobRequest'] as Map).cast<String, dynamic>()),
