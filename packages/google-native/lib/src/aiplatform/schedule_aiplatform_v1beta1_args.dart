...
class ScheduleAiplatformV1beta1Args {
  ...
  ScheduleAiplatformV1beta1Args({
    ...
    String? startTime,
       ...
       maxConcurrentRunCount = pulumi.Input.asInput<String>(
  ...
  factory ScheduleAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ScheduleAiplatformV1beta1Args(
      allowQueueing: map['allowQueueing'] == null
          ? null
          : map['allowQueueing'] as bool,
      ...
      maxRunCount: map['maxRunCount'] == null
          ? null
          : map['maxRunCount'] as String,
