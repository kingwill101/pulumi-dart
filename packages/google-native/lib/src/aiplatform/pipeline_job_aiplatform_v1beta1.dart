...
class PipelineJobAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  PipelineJobAiplatformV1beta1(
    ...
    this.jobDetail = registerOutput<GoogleCloudAiplatformV1beta1PipelineJobDetailResponse>('jobDetail');
    ...
    this.runtimeConfig = registerOutput<GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigResponse>('runtimeConfig');
    this.scheduleName = registerOutput<String>('scheduleName');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.startTime = registerOutput<String>('startTime');
    this.state = registerOutput<String>('state');
    this.templateMetadata = registerOutput<GoogleCloudAiplatformV1beta1PipelineTemplateMetadataResponse>('templateMetadata');
