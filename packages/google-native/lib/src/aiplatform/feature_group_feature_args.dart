...
class FeatureGroupFeatureArgs {
  ...
  FeatureGroupFeatureArgs({
    ...
    String? name,
    String? project,
    FeatureGroupFeatureValueType? valueType,
    String? versionColumnName,
  })  : description = pulumi.Input.asOptionalInput<String>(description),
        disableMonitoring =
            pulumi.Input.asOptionalInput<bool>(disableMonitoring),
        ...
        valueType = pulumi.Input.asOptionalInput<FeatureGroupFeatureValueType>(
            valueType),
        versionColumnName =
            pulumi.Input.asOptionalInput<String>(versionColumnName);
  ...
  factory FeatureGroupFeatureArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGroupFeatureArgs(
      ...
      valueType: map['valueType'] == null
          ? null
          : FeatureGroupFeatureValueType.fromValue(map['valueType'] as String),
