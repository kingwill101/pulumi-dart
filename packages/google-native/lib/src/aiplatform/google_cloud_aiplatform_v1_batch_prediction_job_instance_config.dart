...
class GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig {
  ...
  /// Creates a new [GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig].
  ...
  Map<String, dynamic> toMap() {
    ...
    if (excludedFieldsValue != null) {
      map['excludedFields'] = excludedFieldsValue;
    }
    final includedFieldsValue = includedFields;
    if (includedFieldsValue != null) {
      map['includedFields'] = includedFieldsValue;
    }
    final instanceTypeValue = instanceType;
    if (instanceTypeValue != null) {
      map['instanceType'] = instanceTypeValue;
    }
    final keyFieldValue = keyField;
    if (keyFieldValue != null) {
      map['keyField'] = keyFieldValue;
    }
    return map;
  }

  factory GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig(
      ...
      keyField: map['keyField'] == null ? null : map['keyField'] as String,
    );
  }
}
