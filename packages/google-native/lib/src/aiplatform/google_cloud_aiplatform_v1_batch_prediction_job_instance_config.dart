...
class GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig {
  ...
  factory GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig(
      excludedFields: map['excludedFields'] == null ? null : (map['excludedFields'] as List).cast<String>(),
      includedFields: map['includedFields'] == null ? null : (map['includedFields'] as List).cast<String>(),
