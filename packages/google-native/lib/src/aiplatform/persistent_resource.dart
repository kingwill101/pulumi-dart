...
class PersistentResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1ResourcePoolResponse>> resourcePools;
  ...
  PersistentResource(
    ...
    this.resourcePools = registerOutput<List<GoogleCloudAiplatformV1beta1ResourcePoolResponse>>('resourcePools');
    this.resourceRuntime = registerOutput<GoogleCloudAiplatformV1beta1ResourceRuntimeResponse>('resourceRuntime');
    this.resourceRuntimeSpec = registerOutput<GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse>('resourceRuntimeSpec');
