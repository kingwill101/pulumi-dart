...
class GetIndexEndpointResult {
  ...
  final GoogleCloudAiplatformV1PrivateServiceConnectConfigResponse
  ...
  factory GetIndexEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetIndexEndpointResult(
      ...
      deployedIndexes:
          pulumi.Input.decodeList<GoogleCloudAiplatformV1DeployedIndexResponse>(
              map['deployedIndexes'],
              (value) => GoogleCloudAiplatformV1DeployedIndexResponse.fromMap(
      ...
      privateServiceConnectConfig:
          GoogleCloudAiplatformV1PrivateServiceConnectConfigResponse.fromMap(
