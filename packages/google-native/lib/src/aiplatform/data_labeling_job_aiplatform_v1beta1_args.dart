...
class DataLabelingJobAiplatformV1beta1Args {
  ...
  factory DataLabelingJobAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DataLabelingJobAiplatformV1beta1Args(
      activeLearningConfig: map['activeLearningConfig'] == null ? null : GoogleCloudAiplatformV1beta1ActiveLearningConfig.fromMap((map['activeLearningConfig'] as Map).cast<String, dynamic>()),
