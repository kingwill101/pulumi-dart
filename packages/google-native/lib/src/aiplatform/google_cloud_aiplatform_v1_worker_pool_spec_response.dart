...
class GoogleCloudAiplatformV1WorkerPoolSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nfsMounts': pulumi.Input.encodeList<GoogleCloudAiplatformV1NfsMountResponse, Map<String, dynamic>>(nfsMounts, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1WorkerPoolSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1WorkerPoolSpecResponse(
      containerSpec: GoogleCloudAiplatformV1ContainerSpecResponse.fromMap((map['containerSpec'] as Map).cast<String, dynamic>()),
      diskSpec: GoogleCloudAiplatformV1DiskSpecResponse.fromMap((map['diskSpec'] as Map).cast<String, dynamic>()),
      machineSpec: GoogleCloudAiplatformV1MachineSpecResponse.fromMap((map['machineSpec'] as Map).cast<String, dynamic>()),
      nfsMounts: pulumi.Input.decodeList<GoogleCloudAiplatformV1NfsMountResponse>(map['nfsMounts'], (value) => GoogleCloudAiplatformV1NfsMountResponse.fromMap((value as Map).cast<String, dynamic>())),
      pythonPackageSpec: GoogleCloudAiplatformV1PythonPackageSpecResponse.fromMap((map['pythonPackageSpec'] as Map).cast<String, dynamic>()),
