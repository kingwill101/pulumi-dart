...
class GoogleCloudAiplatformV1NasJobSpec {
  ...
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpec? multiTrialAlgorithmSpec;
  ...
  factory GoogleCloudAiplatformV1NasJobSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1NasJobSpec(
      multiTrialAlgorithmSpec: map['multiTrialAlgorithmSpec'] == null ? null : GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpec.fromMap((map['multiTrialAlgorithmSpec'] as Map).cast<String, dynamic>()),
