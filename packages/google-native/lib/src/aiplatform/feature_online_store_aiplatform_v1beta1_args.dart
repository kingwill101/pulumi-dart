...
class FeatureOnlineStoreAiplatformV1beta1Args {
  ...
  FeatureOnlineStoreAiplatformV1beta1Args({
    ...
    GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpoint? dedicatedServingEndpoint,
    GoogleCloudAiplatformV1beta1FeatureOnlineStoreEmbeddingManagement? embeddingManagement,
    String? etag,
  ...
  factory FeatureOnlineStoreAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeatureOnlineStoreAiplatformV1beta1Args(
      bigtable: map['bigtable'] == null ? null : GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtable.fromMap((map['bigtable'] as Map).cast<String, dynamic>()),
      dedicatedServingEndpoint: map['dedicatedServingEndpoint'] == null ? null : GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpoint.fromMap((map['dedicatedServingEndpoint'] as Map).cast<String, dynamic>()),
      embeddingManagement: map['embeddingManagement'] == null ? null : GoogleCloudAiplatformV1beta1FeatureOnlineStoreEmbeddingManagement.fromMap((map['embeddingManagement'] as Map).cast<String, dynamic>()),
      etag: map['etag'] == null ? null : map['etag'] as String,
      featureOnlineStoreId: map['featureOnlineStoreId'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      optimized: map['optimized'] == null ? null : (map['optimized'] as Map).cast<String, dynamic>(),
