...
class FeatureOnlineStoreAiplatformV1beta1Args {
  ...
  FeatureOnlineStoreAiplatformV1beta1Args({
    ...
    String? project,
       ...
       optimized = pulumi.Input.asOptionalInput<Map<String, dynamic>>(
         optimized,
       ),
  ...
  factory FeatureOnlineStoreAiplatformV1beta1Args.fromMap(
    ...
    return FeatureOnlineStoreAiplatformV1beta1Args(
      bigtable: map['bigtable'] == null
          ? null
          : GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtable.fromMap(
              (map['bigtable'] as Map).cast<String, dynamic>(),
            ),
      dedicatedServingEndpoint: map['dedicatedServingEndpoint'] == null
          ? null
          : GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpoint.fromMap(
              (map['dedicatedServingEndpoint'] as Map).cast<String, dynamic>(),
            ),
      embeddingManagement: map['embeddingManagement'] == null
          ? null
          : GoogleCloudAiplatformV1beta1FeatureOnlineStoreEmbeddingManagement.fromMap(
