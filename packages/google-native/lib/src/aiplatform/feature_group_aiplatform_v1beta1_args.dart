...
class FeatureGroupAiplatformV1beta1Args {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1FeatureGroupBigQuery>? bigQuery;
  ...
  FeatureGroupAiplatformV1beta1Args({
    ...
    String? project,
      ...
      bigQuery = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1FeatureGroupBigQuery>(bigQuery),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bigQuery': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1FeatureGroupBigQuery, Map<String, dynamic>>(bigQuery, (value) => value.toMap()),
  ...
  factory FeatureGroupAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeatureGroupAiplatformV1beta1Args(
      bigQuery: map['bigQuery'] == null ? null : GoogleCloudAiplatformV1beta1FeatureGroupBigQuery.fromMap((map['bigQuery'] as Map).cast<String, dynamic>()),
