...
class FeaturestoreIamPolicyAiplatformV1beta1Args {
  ...
  FeaturestoreIamPolicyAiplatformV1beta1Args({
    List<GoogleIamV1BindingAiplatformV1beta1>? bindings,
    String? etag,
  ...
  factory FeaturestoreIamPolicyAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamPolicyAiplatformV1beta1Args(
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<GoogleIamV1BindingAiplatformV1beta1>(map['bindings'], (value) => GoogleIamV1BindingAiplatformV1beta1.fromMap((value as Map).cast<String, dynamic>())),
