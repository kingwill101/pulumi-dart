...
class FeaturestoreIamPolicyAiplatformV1beta1Args {
  ...
  FeaturestoreIamPolicyAiplatformV1beta1Args({
    ...
    int? version,
           ...
           pulumi.Input.asOptionalInput<
             List<GoogleIamV1BindingAiplatformV1beta1>
           >(bindings),
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  GoogleIamV1BindingAiplatformV1beta1,
                  Map<String, dynamic>
  ...
  factory FeaturestoreIamPolicyAiplatformV1beta1Args.fromMap(
    Map<String, dynamic> map,
  ) {
    return FeaturestoreIamPolicyAiplatformV1beta1Args(
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<GoogleIamV1BindingAiplatformV1beta1>(
              map['bindings'],
              (value) => GoogleIamV1BindingAiplatformV1beta1.fromMap(
