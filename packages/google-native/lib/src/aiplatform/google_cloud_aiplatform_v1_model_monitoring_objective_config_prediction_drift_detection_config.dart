...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultDriftThreshold': ?defaultDriftThreshold == null ? null : defaultDriftThreshold!.toMap(),
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig(
      attributionScoreDriftThresholds: map['attributionScoreDriftThresholds'] == null ? null : (map['attributionScoreDriftThresholds'] as Map).cast<String, String>(),
      defaultDriftThreshold: map['defaultDriftThreshold'] == null ? null : GoogleCloudAiplatformV1ThresholdConfig.fromMap((map['defaultDriftThreshold'] as Map).cast<String, dynamic>()),
      driftThresholds: map['driftThresholds'] == null ? null : (map['driftThresholds'] as Map).cast<String, String>(),
    );
  }
}
