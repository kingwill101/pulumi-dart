...
class InstanceMemcacheV1beta2Args {
  ...
  factory InstanceMemcacheV1beta2Args.fromMap(Map<String, dynamic> map) {
    return InstanceMemcacheV1beta2Args(
      ...
      instanceMessages: map['instanceMessages'] == null ? null : pulumi.Input.decodeList<InstanceMessageMemcacheV1beta2>(map['instanceMessages'], (value) => InstanceMessageMemcacheV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      maintenancePolicy: map['maintenancePolicy'] == null ? null : GoogleCloudMemcacheV1beta2MaintenancePolicy.fromMap((map['maintenancePolicy'] as Map).cast<String, dynamic>()),
      memcacheVersion: map['memcacheVersion'] == null ? null : InstanceMemcacheVersionMemcacheV1beta2.fromValue(map['memcacheVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      nodeConfig: NodeConfigMemcacheV1beta2.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      parameters: map['parameters'] == null ? null : MemcacheParametersMemcacheV1beta2.fromMap((map['parameters'] as Map).cast<String, dynamic>()),
