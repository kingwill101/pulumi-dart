...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    List<String>? zones,
        ...
        parameters =
            pulumi.Input.asOptionalInput<MemcacheParameters>(parameters),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['nodeConfig'] =
        pulumi.Input.mapInputValue<NodeConfig, Map<String, dynamic>>(
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      instanceMessages: map['instanceMessages'] == null
          ? null
          : pulumi.Input.decodeList<InstanceMessage>(
              map['instanceMessages'],
              (value) => InstanceMessage.fromMap(
      ...
      maintenancePolicy: map['maintenancePolicy'] == null
          ? null
          : GoogleCloudMemcacheV1MaintenancePolicy.fromMap(
              (map['maintenancePolicy'] as Map).cast<String, dynamic>()),
      memcacheVersion: map['memcacheVersion'] == null
          ? null
          : InstanceMemcacheVersion.fromValue(map['memcacheVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      nodeConfig: NodeConfig.fromMap(
          (map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      parameters: map['parameters'] == null
          ? null
          : MemcacheParameters.fromMap(
