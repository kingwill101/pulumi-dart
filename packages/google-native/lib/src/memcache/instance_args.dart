...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    InstanceMemcacheVersion? memcacheVersion,
    String? name,
    ...
    List<String>? zones,
      ...
      instanceMessages = pulumi.Input.asOptionalInput<List<InstanceMessage>>(instanceMessages),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      maintenancePolicy = pulumi.Input.asOptionalInput<GoogleCloudMemcacheV1MaintenancePolicy>(maintenancePolicy),
      memcacheVersion = pulumi.Input.asOptionalInput<InstanceMemcacheVersion>(memcacheVersion),
      name = pulumi.Input.asOptionalInput<String>(name),
      nodeConfig = pulumi.Input.asInput<NodeConfig>(nodeConfig),
      nodeCount = pulumi.Input.asInput<int>(nodeCount),
      parameters = pulumi.Input.asOptionalInput<MemcacheParameters>(parameters),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      instanceMessages: map['instanceMessages'] == null ? null : pulumi.Input.decodeList<InstanceMessage>(map['instanceMessages'], (value) => InstanceMessage.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      maintenancePolicy: map['maintenancePolicy'] == null ? null : GoogleCloudMemcacheV1MaintenancePolicy.fromMap((map['maintenancePolicy'] as Map).cast<String, dynamic>()),
      memcacheVersion: map['memcacheVersion'] == null ? null : InstanceMemcacheVersion.fromValue(map['memcacheVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      nodeConfig: NodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      parameters: map['parameters'] == null ? null : MemcacheParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      reservedIpRangeId: map['reservedIpRangeId'] == null ? null : (map['reservedIpRangeId'] as List).cast<String>(),
