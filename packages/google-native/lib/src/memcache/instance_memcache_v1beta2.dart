...
class InstanceMemcacheV1beta2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InstanceMessageResponseMemcacheV1beta2>> instanceMessages;
  ...
  InstanceMemcacheV1beta2(
    ...
    this.instanceMessages = registerOutput<List<InstanceMessageResponseMemcacheV1beta2>>('instanceMessages');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.maintenancePolicy = registerOutput<GoogleCloudMemcacheV1beta2MaintenancePolicyResponse>('maintenancePolicy');
    this.maintenanceSchedule = registerOutput<MaintenanceScheduleResponseMemcacheV1beta2>('maintenanceSchedule');
    this.memcacheFullVersion = registerOutput<String>('memcacheFullVersion');
    this.memcacheNodes = registerOutput<List<NodeResponseMemcacheV1beta2>>('memcacheNodes');
    this.memcacheVersion = registerOutput<String>('memcacheVersion');
    this.name = registerOutput<String>('name');
    this.nodeConfig = registerOutput<NodeConfigResponseMemcacheV1beta2>('nodeConfig');
    this.nodeCount = registerOutput<int>('nodeCount');
    this.parameters = registerOutput<MemcacheParametersResponseMemcacheV1beta2>('parameters');
