...
class GetInstanceMemcacheV1beta2Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['instanceMessages'] = pulumi.Input.encodeList<
        InstanceMessageResponseMemcacheV1beta2,
        Map<String, dynamic>>(instanceMessages, (value) => value.toMap());
    map['labels'] = labels;
    ...
    map['memcacheNodes'] = pulumi.Input.encodeList<NodeResponseMemcacheV1beta2,
        Map<String, dynamic>>(memcacheNodes, (value) => value.toMap());
    ...
    map['state'] = state;
    map['updateAvailable'] = updateAvailable;
  ...
  factory GetInstanceMemcacheV1beta2Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceMemcacheV1beta2Result(
      ...
      instanceMessages:
          pulumi.Input.decodeList<InstanceMessageResponseMemcacheV1beta2>(
              map['instanceMessages'],
              (value) => InstanceMessageResponseMemcacheV1beta2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      labels: (map['labels'] as Map).cast<String, String>(),
      maintenancePolicy:
          GoogleCloudMemcacheV1beta2MaintenancePolicyResponse.fromMap(
              (map['maintenancePolicy'] as Map).cast<String, dynamic>()),
      maintenanceSchedule: MaintenanceScheduleResponseMemcacheV1beta2.fromMap(
          (map['maintenanceSchedule'] as Map).cast<String, dynamic>()),
      memcacheFullVersion: map['memcacheFullVersion'] as String,
      memcacheNodes: pulumi.Input.decodeList<NodeResponseMemcacheV1beta2>(
          map['memcacheNodes'],
          (value) => NodeResponseMemcacheV1beta2.fromMap(
              (value as Map).cast<String, dynamic>())),
      memcacheVersion: map['memcacheVersion'] as String,
      name: map['name'] as String,
      nodeConfig: NodeConfigResponseMemcacheV1beta2.fromMap(
          (map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      parameters: MemcacheParametersResponseMemcacheV1beta2.fromMap(
