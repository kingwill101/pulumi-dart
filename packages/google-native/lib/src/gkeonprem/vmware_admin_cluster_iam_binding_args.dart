...
/// {@template pulumi_gkeonprem_v1_vmware_admin_cluster_iam_binding_args_doc}
/// The set of arguments for VmwareAdminClusterIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_admin_cluster_iam_binding_args_doc}
class VmwareAdminClusterIamBindingArgs {
  ...
  /// Creates a new [VmwareAdminClusterIamBindingArgs].
  ...
  VmwareAdminClusterIamBindingArgs({
    Condition? condition,
  ...
  factory VmwareAdminClusterIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterIamBindingArgs(
