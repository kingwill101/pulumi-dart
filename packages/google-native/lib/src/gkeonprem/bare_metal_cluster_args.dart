...
class BareMetalClusterArgs {
  ...
  factory BareMetalClusterArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterArgs(
      ...
      clusterOperations: map['clusterOperations'] == null ? null : BareMetalClusterOperationsConfig.fromMap((map['clusterOperations'] as Map).cast<String, dynamic>()),
      controlPlane: BareMetalControlPlaneConfig.fromMap((map['controlPlane'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      loadBalancer: BareMetalLoadBalancerConfig.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      maintenanceConfig: map['maintenanceConfig'] == null ? null : BareMetalMaintenanceConfig.fromMap((map['maintenanceConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: BareMetalNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      nodeAccessConfig: map['nodeAccessConfig'] == null ? null : BareMetalNodeAccessConfig.fromMap((map['nodeAccessConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: map['nodeConfig'] == null ? null : BareMetalWorkloadNodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      osEnvironmentConfig: map['osEnvironmentConfig'] == null ? null : BareMetalOsEnvironmentConfig.fromMap((map['osEnvironmentConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      proxy: map['proxy'] == null ? null : BareMetalProxyConfig.fromMap((map['proxy'] as Map).cast<String, dynamic>()),
      securityConfig: map['securityConfig'] == null ? null : BareMetalSecurityConfig.fromMap((map['securityConfig'] as Map).cast<String, dynamic>()),
      storage: BareMetalStorageConfig.fromMap((map['storage'] as Map).cast<String, dynamic>()),
