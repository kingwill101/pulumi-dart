    ...
    BareMetalClusterUpgradePolicy? upgradePolicy,
        ...
        clusterOperations =
            pulumi.Input.asOptionalInput<BareMetalClusterOperationsConfig>(
                clusterOperations),
        controlPlane =
            pulumi.Input.asInput<BareMetalControlPlaneConfig>(controlPlane),
        description = pulumi.Input.asOptionalInput<String>(description),
        loadBalancer =
            pulumi.Input.asInput<BareMetalLoadBalancerConfig>(loadBalancer),
        ...
        networkConfig =
            pulumi.Input.asInput<BareMetalNetworkConfig>(networkConfig),
        nodeAccessConfig =
            pulumi.Input.asOptionalInput<BareMetalNodeAccessConfig>(
                nodeAccessConfig),
