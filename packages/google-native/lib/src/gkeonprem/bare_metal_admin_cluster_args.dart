...
class BareMetalAdminClusterArgs {
  ...
  factory BareMetalAdminClusterArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterArgs(
      ...
      bareMetalVersion: map['bareMetalVersion'] == null ? null : map['bareMetalVersion'] as String,
      ...
      clusterOperations: map['clusterOperations'] == null ? null : BareMetalAdminClusterOperationsConfig.fromMap((map['clusterOperations'] as Map).cast<String, dynamic>()),
      controlPlane: map['controlPlane'] == null ? null : BareMetalAdminControlPlaneConfig.fromMap((map['controlPlane'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      loadBalancer: map['loadBalancer'] == null ? null : BareMetalAdminLoadBalancerConfig.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      maintenanceConfig: map['maintenanceConfig'] == null ? null : BareMetalAdminMaintenanceConfig.fromMap((map['maintenanceConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: map['networkConfig'] == null ? null : BareMetalAdminNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      nodeAccessConfig: map['nodeAccessConfig'] == null ? null : BareMetalAdminNodeAccessConfig.fromMap((map['nodeAccessConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: map['nodeConfig'] == null ? null : BareMetalAdminWorkloadNodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      osEnvironmentConfig: map['osEnvironmentConfig'] == null ? null : BareMetalAdminOsEnvironmentConfig.fromMap((map['osEnvironmentConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      proxy: map['proxy'] == null ? null : BareMetalAdminProxyConfig.fromMap((map['proxy'] as Map).cast<String, dynamic>()),
      securityConfig: map['securityConfig'] == null ? null : BareMetalAdminSecurityConfig.fromMap((map['securityConfig'] as Map).cast<String, dynamic>()),
      storage: map['storage'] == null ? null : BareMetalAdminStorageConfig.fromMap((map['storage'] as Map).cast<String, dynamic>()),
    );
  }
}
