...
class VmwareClusterVmwareNodePoolIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [VmwareClusterVmwareNodePoolIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VmwareClusterVmwareNodePoolIamPolicy]. {@macro pulumi_gkeonprem_v1_vmware_cluster_vmware_node_pool_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  VmwareClusterVmwareNodePoolIamPolicy(
    String name, {
    VmwareClusterVmwareNodePoolIamPolicyArgs? args,
