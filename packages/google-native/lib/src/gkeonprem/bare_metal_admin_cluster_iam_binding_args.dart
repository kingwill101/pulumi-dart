...
/// {@template pulumi_gkeonprem_v1_bare_metal_admin_cluster_iam_binding_args_doc}
/// The set of arguments for BareMetalAdminClusterIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_bare_metal_admin_cluster_iam_binding_args_doc}
class BareMetalAdminClusterIamBindingArgs {
  ...
  /// Creates a new [BareMetalAdminClusterIamBindingArgs].
  ...
  BareMetalAdminClusterIamBindingArgs({
    Condition? condition,
  ...
  factory BareMetalAdminClusterIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterIamBindingArgs(
