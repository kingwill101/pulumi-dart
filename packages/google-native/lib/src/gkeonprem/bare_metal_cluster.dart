...
class BareMetalCluster extends pulumi.CustomResource {
  ...
  BareMetalCluster(
    ...
    this.binaryAuthorization = registerOutput<BinaryAuthorizationResponse>('binaryAuthorization');
    this.clusterOperations = registerOutput<BareMetalClusterOperationsConfigResponse>('clusterOperations');
    this.controlPlane = registerOutput<BareMetalControlPlaneConfigResponse>('controlPlane');
    ...
    this.loadBalancer = registerOutput<BareMetalLoadBalancerConfigResponse>('loadBalancer');
    this.localName = registerOutput<String>('localName');
    this.location = registerOutput<String>('location');
    this.maintenanceConfig = registerOutput<BareMetalMaintenanceConfigResponse>('maintenanceConfig');
    this.maintenanceStatus = registerOutput<BareMetalMaintenanceStatusResponse>('maintenanceStatus');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<BareMetalNetworkConfigResponse>('networkConfig');
    this.nodeAccessConfig = registerOutput<BareMetalNodeAccessConfigResponse>('nodeAccessConfig');
    this.nodeConfig = registerOutput<BareMetalWorkloadNodeConfigResponse>('nodeConfig');
    this.osEnvironmentConfig = registerOutput<BareMetalOsEnvironmentConfigResponse>('osEnvironmentConfig');
    this.project = registerOutput<String>('project');
    this.proxy = registerOutput<BareMetalProxyConfigResponse>('proxy');
    this.reconciling = registerOutput<bool>('reconciling');
    this.securityConfig = registerOutput<BareMetalSecurityConfigResponse>('securityConfig');
    ...
    this.upgradePolicy = registerOutput<BareMetalClusterUpgradePolicyResponse>('upgradePolicy');
    this.validationCheck = registerOutput<ValidationCheckResponse>('validationCheck');
  }
}
