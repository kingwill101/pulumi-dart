...
class BareMetalCluster extends pulumi.CustomResource {
  ...
  BareMetalCluster(
    ...
    this.adminClusterMembership = registerOutput<String>(
    ...
    this.binaryAuthorization = registerOutput<BinaryAuthorizationResponse>(
      'binaryAuthorization',
    );
    ...
    this.controlPlane = registerOutput<BareMetalControlPlaneConfigResponse>(
      'controlPlane',
    );
    ...
    this.loadBalancer = registerOutput<BareMetalLoadBalancerConfigResponse>(
      'loadBalancer',
    );
    this.localName = registerOutput<String>('localName');
    this.location = registerOutput<String>('location');
    this.maintenanceConfig = registerOutput<BareMetalMaintenanceConfigResponse>(
      'maintenanceConfig',
    );
    this.maintenanceStatus = registerOutput<BareMetalMaintenanceStatusResponse>(
      'maintenanceStatus',
    );
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<BareMetalNetworkConfigResponse>(
      'networkConfig',
    );
    this.nodeAccessConfig = registerOutput<BareMetalNodeAccessConfigResponse>(
      'nodeAccessConfig',
    );
    this.nodeConfig = registerOutput<BareMetalWorkloadNodeConfigResponse>(
      'nodeConfig',
    );
    ...
    this.securityConfig = registerOutput<BareMetalSecurityConfigResponse>(
      'securityConfig',
    );
    ...
    this.upgradePolicy = registerOutput<BareMetalClusterUpgradePolicyResponse>(
      'upgradePolicy',
    );
    this.validationCheck = registerOutput<ValidationCheckResponse>(
      'validationCheck',
    );
  }
}
