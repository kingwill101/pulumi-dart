...
class BareMetalNodePoolArgs {
  ...
  BareMetalNodePoolArgs({
    ...
    String? bareMetalNodePoolId,
    String? displayName,
    String? etag,
    String? location,
    String? name,
    required BareMetalNodePoolConfig nodePoolConfig,
    String? project,
  ...
  factory BareMetalNodePoolArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalNodePoolArgs(
      ...
      bareMetalNodePoolId: map['bareMetalNodePoolId'] == null ? null : map['bareMetalNodePoolId'] as String,
      ...
      upgradePolicy: map['upgradePolicy'] == null ? null : BareMetalNodePoolUpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
