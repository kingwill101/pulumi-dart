...
class BareMetalNodePoolArgs {
  ...
  BareMetalNodePoolArgs({
    ...
    BareMetalNodePoolUpgradePolicy? upgradePolicy,
        ...
        bareMetalNodePoolId =
            pulumi.Input.asOptionalInput<String>(bareMetalNodePoolId),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        etag = pulumi.Input.asOptionalInput<String>(etag),
        location = pulumi.Input.asOptionalInput<String>(location),
        name = pulumi.Input.asOptionalInput<String>(name),
        nodePoolConfig =
            pulumi.Input.asInput<BareMetalNodePoolConfig>(nodePoolConfig),
  ...
  factory BareMetalNodePoolArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalNodePoolArgs(
      ...
      bareMetalNodePoolId: map['bareMetalNodePoolId'] == null
          ? null
