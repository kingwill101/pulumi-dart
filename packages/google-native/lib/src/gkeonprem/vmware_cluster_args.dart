...
class VmwareClusterArgs {
  ...
  factory VmwareClusterArgs.fromMap(Map<String, dynamic> map) {
    return VmwareClusterArgs(
      ...
      antiAffinityGroups: map['antiAffinityGroups'] == null ? null : VmwareAAGConfig.fromMap((map['antiAffinityGroups'] as Map).cast<String, dynamic>()),
      authorization: map['authorization'] == null ? null : Authorization.fromMap((map['authorization'] as Map).cast<String, dynamic>()),
      autoRepairConfig: map['autoRepairConfig'] == null ? null : VmwareAutoRepairConfig.fromMap((map['autoRepairConfig'] as Map).cast<String, dynamic>()),
      controlPlaneNode: map['controlPlaneNode'] == null ? null : VmwareControlPlaneNodeConfig.fromMap((map['controlPlaneNode'] as Map).cast<String, dynamic>()),
      dataplaneV2: map['dataplaneV2'] == null ? null : VmwareDataplaneV2Config.fromMap((map['dataplaneV2'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      disableBundledIngress: map['disableBundledIngress'] == null ? null : map['disableBundledIngress'] as bool,
      enableControlPlaneV2: map['enableControlPlaneV2'] == null ? null : map['enableControlPlaneV2'] as bool,
      etag: map['etag'] == null ? null : map['etag'] as String,
      loadBalancer: map['loadBalancer'] == null ? null : VmwareLoadBalancerConfig.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkConfig: map['networkConfig'] == null ? null : VmwareNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      onPremVersion: map['onPremVersion'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      storage: map['storage'] == null ? null : VmwareStorageConfig.fromMap((map['storage'] as Map).cast<String, dynamic>()),
      upgradePolicy: map['upgradePolicy'] == null ? null : VmwareClusterUpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>()),
      vcenter: map['vcenter'] == null ? null : VmwareVCenterConfig.fromMap((map['vcenter'] as Map).cast<String, dynamic>()),
      vmTrackingEnabled: map['vmTrackingEnabled'] == null ? null : map['vmTrackingEnabled'] as bool,
      vmwareClusterId: map['vmwareClusterId'] == null ? null : map['vmwareClusterId'] as String,
    );
  }
}
