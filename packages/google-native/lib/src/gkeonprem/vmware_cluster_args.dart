...
class VmwareClusterArgs {
  ...
  VmwareClusterArgs({
    ...
    String? vmwareClusterId,
        ...
        antiAffinityGroups =
            pulumi.Input.asOptionalInput<VmwareAAGConfig>(antiAffinityGroups),
        authorization =
            pulumi.Input.asOptionalInput<Authorization>(authorization),
        ...
        controlPlaneNode =
            pulumi.Input.asOptionalInput<VmwareControlPlaneNodeConfig>(
                controlPlaneNode),
        dataplaneV2 =
            pulumi.Input.asOptionalInput<VmwareDataplaneV2Config>(dataplaneV2),
        description = pulumi.Input.asOptionalInput<String>(description),
        disableBundledIngress =
            pulumi.Input.asOptionalInput<bool>(disableBundledIngress),
        enableControlPlaneV2 =
            pulumi.Input.asOptionalInput<bool>(enableControlPlaneV2),
        ...
        networkConfig =
            pulumi.Input.asOptionalInput<VmwareNetworkConfig>(networkConfig),
        ...
        upgradePolicy =
            pulumi.Input.asOptionalInput<VmwareClusterUpgradePolicy>(
                upgradePolicy),
        vcenter = pulumi.Input.asOptionalInput<VmwareVCenterConfig>(vcenter),
        vmTrackingEnabled =
            pulumi.Input.asOptionalInput<bool>(vmTrackingEnabled),
