...
class VmwareNodePoolArgs {
  ...
  VmwareNodePoolArgs({
    ...
    required VmwareNodeConfig config,
    String? displayName,
    String? etag,
    String? location,
    String? name,
  ...
  factory VmwareNodePoolArgs.fromMap(Map<String, dynamic> map) {
    return VmwareNodePoolArgs(
      ...
      config: VmwareNodeConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nodePoolAutoscaling: map['nodePoolAutoscaling'] == null ? null : VmwareNodePoolAutoscalingConfig.fromMap((map['nodePoolAutoscaling'] as Map).cast<String, dynamic>()),
      ...
      vmwareNodePoolId: map['vmwareNodePoolId'] == null ? null : map['vmwareNodePoolId'] as String,
    );
  }
}
