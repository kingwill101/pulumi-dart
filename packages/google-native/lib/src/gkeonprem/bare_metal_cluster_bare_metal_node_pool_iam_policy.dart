...
class BareMetalClusterBareMetalNodePoolIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [BareMetalClusterBareMetalNodePoolIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BareMetalClusterBareMetalNodePoolIamPolicy]. {@macro pulumi_gkeonprem_v1_bare_metal_cluster_bare_metal_node_pool_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BareMetalClusterBareMetalNodePoolIamPolicy(
    String name, {
    BareMetalClusterBareMetalNodePoolIamPolicyArgs? args,
