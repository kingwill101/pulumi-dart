...
class VmwareNodePool extends pulumi.CustomResource {
  ...
  late final pulumi.Output<VmwareNodePoolAutoscalingConfigResponse> nodePoolAutoscaling;
  ...
  /// [args] Arguments used to configure this [VmwareNodePool]. {@macro pulumi_gkeonprem_v1_vmware_node_pool_args_doc}
  ...
  VmwareNodePool(
    ...
    this.nodePoolAutoscaling = registerOutput<VmwareNodePoolAutoscalingConfigResponse>('nodePoolAutoscaling');
