...
class GetVmwareClusterResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['antiAffinityGroups'] = antiAffinityGroups.toMap();
    map['authorization'] = authorization.toMap();
    map['autoRepairConfig'] = autoRepairConfig.toMap();
    map['controlPlaneNode'] = controlPlaneNode.toMap();
    map['createTime'] = createTime;
    map['dataplaneV2'] = dataplaneV2.toMap();
    map['deleteTime'] = deleteTime;
    map['description'] = description;
    map['disableBundledIngress'] = disableBundledIngress;
    map['enableControlPlaneV2'] = enableControlPlaneV2;
    ...
    map['vmTrackingEnabled'] = vmTrackingEnabled;
    return map;
  }
