...
/// {@template pulumi_gkeonprem_v1_vmware_admin_cluster_iam_member_args_doc}
/// The set of arguments for VmwareAdminClusterIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_admin_cluster_iam_member_args_doc}
class VmwareAdminClusterIamMemberArgs {
  ...
  /// Creates a new [VmwareAdminClusterIamMemberArgs].
  ...
  VmwareAdminClusterIamMemberArgs({
    Condition? condition,
  ...
  factory VmwareAdminClusterIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterIamMemberArgs(
