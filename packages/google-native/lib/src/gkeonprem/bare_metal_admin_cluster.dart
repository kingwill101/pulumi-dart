...
class BareMetalAdminCluster extends pulumi.CustomResource {
  ...
  BareMetalAdminCluster(
    ...
    this.networkConfig = registerOutput<BareMetalAdminNetworkConfigResponse>(
      'networkConfig',
    );
    ...
    this.nodeConfig = registerOutput<BareMetalAdminWorkloadNodeConfigResponse>(
      'nodeConfig',
    );
    ...
    this.securityConfig = registerOutput<BareMetalAdminSecurityConfigResponse>(
      'securityConfig',
    );
    this.state = registerOutput<String>('state');
    this.status = registerOutput<ResourceStatusResponse>('status');
    this.storage = registerOutput<BareMetalAdminStorageConfigResponse>(
      'storage',
    );
