...
/// {@template pulumi_gkeonprem_v1_bare_metal_cluster_bare_metal_node_pool_iam_binding_args_doc}
/// The set of arguments for BareMetalClusterBareMetalNodePoolIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_bare_metal_cluster_bare_metal_node_pool_iam_binding_args_doc}
class BareMetalClusterBareMetalNodePoolIamBindingArgs {
  ...
  /// Creates a new [BareMetalClusterBareMetalNodePoolIamBindingArgs].
  ...
  BareMetalClusterBareMetalNodePoolIamBindingArgs({
    Condition? condition,
  ...
  factory BareMetalClusterBareMetalNodePoolIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterBareMetalNodePoolIamBindingArgs(
