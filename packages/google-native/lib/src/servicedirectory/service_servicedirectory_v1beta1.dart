...
class ServiceServicedirectoryV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EndpointResponseServicedirectoryV1beta1>> endpoints;
  ...
  ServiceServicedirectoryV1beta1(
    ...
    this.endpoints = registerOutput<List<EndpointResponseServicedirectoryV1beta1>>('endpoints');
