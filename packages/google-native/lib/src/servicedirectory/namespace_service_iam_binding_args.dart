...
/// {@template pulumi_servicedirectory_v1_namespace_service_iam_binding_args_doc}
/// The set of arguments for NamespaceServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1_namespace_service_iam_binding_args_doc}
class NamespaceServiceIamBindingArgs {
  ...
  /// Creates a new [NamespaceServiceIamBindingArgs].
  ...
  NamespaceServiceIamBindingArgs({
    Condition? condition,
  ...
  factory NamespaceServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceServiceIamBindingArgs(
