...
/// {@template pulumi_servicedirectory_v1beta1_namespace_iam_member_servicedirectory_v1beta1_args_doc}
/// The set of arguments for NamespaceIamMember.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1beta1_namespace_iam_member_servicedirectory_v1beta1_args_doc}
class NamespaceIamMemberServicedirectoryV1beta1Args {
  ...
  /// Creates a new [NamespaceIamMemberServicedirectoryV1beta1Args].
  ...
  NamespaceIamMemberServicedirectoryV1beta1Args({
    Condition? condition,
  ...
  factory NamespaceIamMemberServicedirectoryV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NamespaceIamMemberServicedirectoryV1beta1Args(
