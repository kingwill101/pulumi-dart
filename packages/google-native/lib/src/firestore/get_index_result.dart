...
class GetIndexResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiScope': apiScope,
      'fields': pulumi.Input.encodeList<GoogleFirestoreAdminV1IndexFieldResponse, Map<String, dynamic>>(fields, (value) => value.toMap()),
      'name': name,
  ...
  factory GetIndexResult.fromMap(Map<String, dynamic> map) {
    return GetIndexResult(
      ...
      fields: pulumi.Input.decodeList<GoogleFirestoreAdminV1IndexFieldResponse>(map['fields'], (value) => GoogleFirestoreAdminV1IndexFieldResponse.fromMap((value as Map).cast<String, dynamic>())),
