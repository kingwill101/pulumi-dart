...
class IndexFirestoreV1beta1Args {
  ...
  factory IndexFirestoreV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IndexFirestoreV1beta1Args(
      ...
      fields: map['fields'] == null ? null : pulumi.Input.decodeList<GoogleFirestoreAdminV1beta1IndexField>(map['fields'], (value) => GoogleFirestoreAdminV1beta1IndexField.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      state: map['state'] == null ? null : IndexState.fromValue(map['state'] as String),
    );
  }
}
