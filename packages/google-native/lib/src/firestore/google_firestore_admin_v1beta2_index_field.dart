...
class GoogleFirestoreAdminV1beta2IndexField {
  ...
  factory GoogleFirestoreAdminV1beta2IndexField.fromMap(Map<String, dynamic> map) {
    return GoogleFirestoreAdminV1beta2IndexField(
      arrayConfig: map['arrayConfig'] == null ? null : GoogleFirestoreAdminV1beta2IndexFieldArrayConfig.fromValue(map['arrayConfig'] as String),
      fieldPath: map['fieldPath'] == null ? null : map['fieldPath'] as String,
      order: map['order'] == null ? null : GoogleFirestoreAdminV1beta2IndexFieldOrder.fromValue(map['order'] as String),
    );
  }
}
