...
class IndexArgs {
  ...
  factory IndexArgs.fromMap(Map<String, dynamic> map) {
    return IndexArgs(
      apiScope: map['apiScope'] == null ? null : IndexApiScope.fromValue(map['apiScope'] as String),
      collectionGroupId: map['collectionGroupId'] as String,
      databaseId: map['databaseId'] as String,
      fields: map['fields'] == null ? null : pulumi.Input.decodeList<GoogleFirestoreAdminV1IndexField>(map['fields'], (value) => GoogleFirestoreAdminV1IndexField.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      queryScope: map['queryScope'] == null ? null : IndexQueryScope.fromValue(map['queryScope'] as String),
    );
  }
}
