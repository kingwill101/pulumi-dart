...
class DatabaseArgs {
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      appEngineIntegrationMode: map['appEngineIntegrationMode'] == null ? null : DatabaseAppEngineIntegrationMode.fromValue(map['appEngineIntegrationMode'] as String),
      concurrencyMode: map['concurrencyMode'] == null ? null : DatabaseConcurrencyMode.fromValue(map['concurrencyMode'] as String),
      databaseId: map['databaseId'] as String,
      deleteProtectionState: map['deleteProtectionState'] == null ? null : DatabaseDeleteProtectionState.fromValue(map['deleteProtectionState'] as String),
      etag: map['etag'] == null ? null : map['etag'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      pointInTimeRecoveryEnablement: map['pointInTimeRecoveryEnablement'] == null ? null : DatabasePointInTimeRecoveryEnablement.fromValue(map['pointInTimeRecoveryEnablement'] as String),
