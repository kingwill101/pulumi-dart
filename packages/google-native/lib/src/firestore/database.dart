...
class Database extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Database]. {@macro pulumi_firestore_v1_database_args_doc}
  ...
  Database(
    ...
    this.appEngineIntegrationMode = registerOutput<String>('appEngineIntegrationMode');
    this.concurrencyMode = registerOutput<String>('concurrencyMode');
    this.createTime = registerOutput<String>('createTime');
    this.databaseId = registerOutput<String>('databaseId');
    this.deleteProtectionState = registerOutput<String>('deleteProtectionState');
    ...
    this.pointInTimeRecoveryEnablement = registerOutput<String>('pointInTimeRecoveryEnablement');
