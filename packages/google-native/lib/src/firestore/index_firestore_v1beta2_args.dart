...
class IndexFirestoreV1beta2Args {
  ...
  factory IndexFirestoreV1beta2Args.fromMap(Map<String, dynamic> map) {
    return IndexFirestoreV1beta2Args(
      ...
      fields: map['fields'] == null ? null : pulumi.Input.decodeList<GoogleFirestoreAdminV1beta2IndexField>(map['fields'], (value) => GoogleFirestoreAdminV1beta2IndexField.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      queryScope: map['queryScope'] == null ? null : IndexQueryScopeFirestoreV1beta2.fromValue(map['queryScope'] as String),
    );
  }
}
