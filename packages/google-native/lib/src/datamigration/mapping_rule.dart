...
class MappingRule extends pulumi.CustomResource {
  ...
  MappingRule(
    ...
    this.conditionalColumnSetValue = registerOutput<ConditionalColumnSetValueResponse>('conditionalColumnSetValue');
    this.conversionWorkspaceId = registerOutput<String>('conversionWorkspaceId');
    this.convertRowidColumn = registerOutput<ConvertRowIdToColumnResponse>('convertRowidColumn');
    ...
    this.filterTableColumns = registerOutput<FilterTableColumnsResponse>('filterTableColumns');
    this.location = registerOutput<String>('location');
    this.mappingRuleId = registerOutput<String>('mappingRuleId');
    this.multiColumnDataTypeChange = registerOutput<MultiColumnDatatypeChangeResponse>('multiColumnDataTypeChange');
    this.multiEntityRename = registerOutput<MultiEntityRenameResponse>('multiEntityRename');
    ...
    this.setTablePrimaryKey = registerOutput<SetTablePrimaryKeyResponse>('setTablePrimaryKey');
    this.singleColumnChange = registerOutput<SingleColumnChangeResponse>('singleColumnChange');
    this.singleEntityRename = registerOutput<SingleEntityRenameResponse>('singleEntityRename');
    this.singlePackageChange = registerOutput<SinglePackageChangeResponse>('singlePackageChange');
    this.sourceSqlChange = registerOutput<SourceSqlChangeResponse>('sourceSqlChange');
