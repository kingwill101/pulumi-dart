...
class SqlIpConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': ?authorizedNetworks == null ? null : pulumi.Input.encodeList<SqlAclEntry, Map<String, dynamic>>(authorizedNetworks!, (value) => value.toMap()),
  ...
  factory SqlIpConfig.fromMap(Map<String, dynamic> map) {
    return SqlIpConfig(
      ...
      authorizedNetworks: map['authorizedNetworks'] == null ? null : pulumi.Input.decodeList<SqlAclEntry>(map['authorizedNetworks'], (value) => SqlAclEntry.fromMap((value as Map).cast<String, dynamic>())),
