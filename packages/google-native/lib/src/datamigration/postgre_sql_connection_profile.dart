...
class PostgreSqlConnectionProfile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'password': password,
      'port': port,
      'privateServiceConnectConnectivity': ?privateServiceConnectConnectivity == null ? null : privateServiceConnectConnectivity!.toMap(),
  ...
  factory PostgreSqlConnectionProfile.fromMap(Map<String, dynamic> map) {
    return PostgreSqlConnectionProfile(
      ...
      privateServiceConnectConnectivity: map['privateServiceConnectConnectivity'] == null ? null : PrivateServiceConnectConnectivity.fromMap((map['privateServiceConnectConnectivity'] as Map).cast<String, dynamic>()),
