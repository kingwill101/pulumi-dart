...
class GetMigrationJobDatamigrationV1beta1Result {
  ...
  final ReverseSshConnectivityResponseDatamigrationV1beta1 reverseSshConnectivity;
  ...
  final VpcPeeringConnectivityResponseDatamigrationV1beta1 vpcPeeringConnectivity;
  ...
  factory GetMigrationJobDatamigrationV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetMigrationJobDatamigrationV1beta1Result(
      createTime: map['createTime'] as String,
      destination: map['destination'] as String,
      destinationDatabase: DatabaseTypeResponseDatamigrationV1beta1.fromMap((map['destinationDatabase'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      dumpPath: map['dumpPath'] as String,
      duration: map['duration'] as String,
      endTime: map['endTime'] as String,
      error: StatusResponseDatamigrationV1beta1.fromMap((map['error'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      phase: map['phase'] as String,
      reverseSshConnectivity: ReverseSshConnectivityResponseDatamigrationV1beta1.fromMap((map['reverseSshConnectivity'] as Map).cast<String, dynamic>()),
      source: map['source'] as String,
      sourceDatabase: DatabaseTypeResponseDatamigrationV1beta1.fromMap((map['sourceDatabase'] as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      staticIpConnectivity: (map['staticIpConnectivity'] as Map).cast<String, dynamic>(),
      type: map['type'] as String,
      updateTime: map['updateTime'] as String,
      vpcPeeringConnectivity: VpcPeeringConnectivityResponseDatamigrationV1beta1.fromMap((map['vpcPeeringConnectivity'] as Map).cast<String, dynamic>()),
    );
  }
}
