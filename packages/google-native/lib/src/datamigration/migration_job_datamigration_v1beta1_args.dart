...
class MigrationJobDatamigrationV1beta1Args {
  ...
  factory MigrationJobDatamigrationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MigrationJobDatamigrationV1beta1Args(
      ...
      destinationDatabase: map['destinationDatabase'] == null ? null : DatabaseTypeDatamigrationV1beta1.fromMap((map['destinationDatabase'] as Map).cast<String, dynamic>()),
      ...
      reverseSshConnectivity: map['reverseSshConnectivity'] == null ? null : ReverseSshConnectivityDatamigrationV1beta1.fromMap((map['reverseSshConnectivity'] as Map).cast<String, dynamic>()),
      source: map['source'] as String,
      sourceDatabase: map['sourceDatabase'] == null ? null : DatabaseTypeDatamigrationV1beta1.fromMap((map['sourceDatabase'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : MigrationJobStateDatamigrationV1beta1.fromValue(map['state'] as String),
      staticIpConnectivity: map['staticIpConnectivity'] == null ? null : (map['staticIpConnectivity'] as Map).cast<String, dynamic>(),
      type: MigrationJobTypeDatamigrationV1beta1.fromValue(map['type'] as String),
      vpcPeeringConnectivity: map['vpcPeeringConnectivity'] == null ? null : VpcPeeringConnectivityDatamigrationV1beta1.fromMap((map['vpcPeeringConnectivity'] as Map).cast<String, dynamic>()),
    );
  }
}
