...
class ConversionWorkspaceArgs {
  ...
  factory ConversionWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return ConversionWorkspaceArgs(
      ...
      destination: DatabaseEngineInfo.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      globalSettings: map['globalSettings'] == null ? null : (map['globalSettings'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      source: DatabaseEngineInfo.fromMap((map['source'] as Map).cast<String, dynamic>()),
    );
  }
}
