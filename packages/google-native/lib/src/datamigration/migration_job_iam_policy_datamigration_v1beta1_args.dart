...
class MigrationJobIamPolicyDatamigrationV1beta1Args {
  ...
  MigrationJobIamPolicyDatamigrationV1beta1Args({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigDatamigrationV1beta1>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingDatamigrationV1beta1>>(
                bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigDatamigrationV1beta1>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigDatamigrationV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingDatamigrationV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingDatamigrationV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory MigrationJobIamPolicyDatamigrationV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return MigrationJobIamPolicyDatamigrationV1beta1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigDatamigrationV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigDatamigrationV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingDatamigrationV1beta1>(
              map['bindings'],
              (value) => BindingDatamigrationV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
