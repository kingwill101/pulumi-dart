...
/// {@template pulumi_datamigration_v1_migration_job_iam_policy_args_doc}
/// The set of arguments for MigrationJobIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_migration_job_iam_policy_args_doc}
class MigrationJobIamPolicyArgs {
  ...
  /// Creates a new [MigrationJobIamPolicyArgs].
  ...
  factory MigrationJobIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobIamPolicyArgs(
