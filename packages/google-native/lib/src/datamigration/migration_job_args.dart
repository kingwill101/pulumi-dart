...
class MigrationJobArgs {
  ...
  MigrationJobArgs({
    ...
    VpcPeeringConnectivity? vpcPeeringConnectivity,
        ...
        destinationDatabase =
            pulumi.Input.asOptionalInput<DatabaseType>(destinationDatabase),
        ...
        performanceConfig =
            pulumi.Input.asOptionalInput<PerformanceConfig>(performanceConfig),
        ...
        sourceDatabase =
            pulumi.Input.asOptionalInput<DatabaseType>(sourceDatabase),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (destinationDatabaseValue != null) {
      map['destinationDatabase'] = pulumi.Input.mapOptionalInputValue<
              DatabaseType, Map<String, dynamic>>(
    ...
    if (sourceDatabaseValue != null) {
      map['sourceDatabase'] = pulumi.Input.mapOptionalInputValue<DatabaseType,
