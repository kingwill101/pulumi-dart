...
class MigrationJobArgs {
  ...
  MigrationJobArgs({
    ...
    required MigrationJobType type,
    VpcPeeringConnectivity? vpcPeeringConnectivity,
  }) :
      cmekKeyName = pulumi.Input.asOptionalInput<String>(cmekKeyName),
      conversionWorkspace = pulumi.Input.asOptionalInput<ConversionWorkspaceInfo>(conversionWorkspace),
      destination = pulumi.Input.asInput<String>(destination),
      destinationDatabase = pulumi.Input.asOptionalInput<DatabaseType>(destinationDatabase),
      displayName = pulumi.Input.asOptionalInput<String>(displayName),
      dumpFlags = pulumi.Input.asOptionalInput<DumpFlags>(dumpFlags),
      ...
      performanceConfig = pulumi.Input.asOptionalInput<PerformanceConfig>(performanceConfig),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      reverseSshConnectivity = pulumi.Input.asOptionalInput<ReverseSshConnectivity>(reverseSshConnectivity),
      source = pulumi.Input.asInput<String>(source),
      sourceDatabase = pulumi.Input.asOptionalInput<DatabaseType>(sourceDatabase),
      state = pulumi.Input.asOptionalInput<MigrationJobState>(state),
      staticIpConnectivity = pulumi.Input.asOptionalInput<Map<String, dynamic>>(staticIpConnectivity),
      type = pulumi.Input.asInput<MigrationJobType>(type),
      vpcPeeringConnectivity = pulumi.Input.asOptionalInput<VpcPeeringConnectivity>(vpcPeeringConnectivity);
  ...
  factory MigrationJobArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobArgs(
      cmekKeyName: map['cmekKeyName'] == null ? null : map['cmekKeyName'] as String,
      conversionWorkspace: map['conversionWorkspace'] == null ? null : ConversionWorkspaceInfo.fromMap((map['conversionWorkspace'] as Map).cast<String, dynamic>()),
      destination: map['destination'] as String,
      destinationDatabase: map['destinationDatabase'] == null ? null : DatabaseType.fromMap((map['destinationDatabase'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      dumpFlags: map['dumpFlags'] == null ? null : DumpFlags.fromMap((map['dumpFlags'] as Map).cast<String, dynamic>()),
      ...
      performanceConfig: map['performanceConfig'] == null ? null : PerformanceConfig.fromMap((map['performanceConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reverseSshConnectivity: map['reverseSshConnectivity'] == null ? null : ReverseSshConnectivity.fromMap((map['reverseSshConnectivity'] as Map).cast<String, dynamic>()),
      source: map['source'] as String,
      sourceDatabase: map['sourceDatabase'] == null ? null : DatabaseType.fromMap((map['sourceDatabase'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : MigrationJobState.fromValue(map['state'] as String),
      staticIpConnectivity: map['staticIpConnectivity'] == null ? null : (map['staticIpConnectivity'] as Map).cast<String, dynamic>(),
      type: MigrationJobType.fromValue(map['type'] as String),
      vpcPeeringConnectivity: map['vpcPeeringConnectivity'] == null ? null : VpcPeeringConnectivity.fromMap((map['vpcPeeringConnectivity'] as Map).cast<String, dynamic>()),
    );
  }
}
