...
class MigrationJobArgs {
  ...
  MigrationJobArgs({
    ...
    VpcPeeringConnectivity? vpcPeeringConnectivity,
       ...
       conversionWorkspace = pulumi
           .Input.asOptionalInput<ConversionWorkspaceInfo>(conversionWorkspace),
       destination = pulumi.Input.asInput<String>(destination),
       destinationDatabase = pulumi.Input.asOptionalInput<DatabaseType>(
         destinationDatabase,
       ),
       ...
       sourceDatabase = pulumi.Input.asOptionalInput<DatabaseType>(
         sourceDatabase,
       ),
       state = pulumi.Input.asOptionalInput<MigrationJobState>(state),
       staticIpConnectivity = pulumi
           .Input.asOptionalInput<Map<String, dynamic>>(staticIpConnectivity),
    ...
    return <String, dynamic>{
      ...
      'conversionWorkspace':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(conversionWorkspace, (value) => value.toMap()),
      'destination': destination,
      'destinationDatabase':
          ?pulumi.Input.mapOptionalInputValue<
            DatabaseType,
            Map<String, dynamic>
          >(destinationDatabase, (value) => value.toMap()),
      ...
      'reverseSshConnectivity':
          ?pulumi.Input.mapOptionalInputValue<
            ReverseSshConnectivity,
            Map<String, dynamic>
          >(reverseSshConnectivity, (value) => value.toMap()),
      'source': source,
      'sourceDatabase':
          ?pulumi.Input.mapOptionalInputValue<
            DatabaseType,
            Map<String, dynamic>
          >(sourceDatabase, (value) => value.toMap()),
      'state': ?pulumi.Input.mapOptionalInputValue<MigrationJobState, String>(
        state,
        (value) => value.value,
      ),
      'staticIpConnectivity': ?staticIpConnectivity,
      'type': pulumi.Input.mapInputValue<MigrationJobType, String>(
        type,
        (value) => value.value,
      ),
      'vpcPeeringConnectivity':
          ?pulumi.Input.mapOptionalInputValue<
            VpcPeeringConnectivity,
            Map<String, dynamic>
          >(vpcPeeringConnectivity, (value) => value.toMap()),
    };
  }
  ...
  factory MigrationJobArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobArgs(
      ...
      conversionWorkspace: map['conversionWorkspace'] == null
          ? null
          : ConversionWorkspaceInfo.fromMap(
              (map['conversionWorkspace'] as Map).cast<String, dynamic>(),
            ),
      destination: map['destination'] as String,
      destinationDatabase: map['destinationDatabase'] == null
          ? null
          : DatabaseType.fromMap(
      ...
      dumpFlags: map['dumpFlags'] == null
          ? null
          : DumpFlags.fromMap(
              (map['dumpFlags'] as Map).cast<String, dynamic>(),
            ),
      ...
      reverseSshConnectivity: map['reverseSshConnectivity'] == null
          ? null
          : ReverseSshConnectivity.fromMap(
      ...
      state: map['state'] == null
          ? null
          : MigrationJobState.fromValue(map['state'] as String),
      ...
      vpcPeeringConnectivity: map['vpcPeeringConnectivity'] == null
          ? null
          : VpcPeeringConnectivity.fromMap(
