...
class MultiEntityRename {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceNameTransformation': ?sourceNameTransformation == null ? null : sourceNameTransformation!.value,
    };
  }

  factory MultiEntityRename.fromMap(Map<String, dynamic> map) {
    return MultiEntityRename(
      newNamePattern: map['newNamePattern'] == null ? null : map['newNamePattern'] as String,
      sourceNameTransformation: map['sourceNameTransformation'] == null ? null : MultiEntityRenameSourceNameTransformation.fromValue(map['sourceNameTransformation'] as String),
    );
  }
}
