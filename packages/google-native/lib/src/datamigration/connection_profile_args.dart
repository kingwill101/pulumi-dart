...
class ConnectionProfileArgs {
  ...
  ConnectionProfileArgs({
    ...
    ConnectionProfileState? state,
            ...
            pulumi.Input.asOptionalInput<AlloyDbConnectionProfile>(alloydb),
        cloudsql =
            pulumi.Input.asOptionalInput<CloudSqlConnectionProfile>(cloudsql),
        ...
        provider =
            pulumi.Input.asOptionalInput<ConnectionProfileProvider>(provider),
