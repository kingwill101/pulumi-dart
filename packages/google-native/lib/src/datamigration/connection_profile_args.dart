...
class ConnectionProfileArgs {
  ...
  factory ConnectionProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileArgs(
      alloydb: map['alloydb'] == null ? null : AlloyDbConnectionProfile.fromMap((map['alloydb'] as Map).cast<String, dynamic>()),
      cloudsql: map['cloudsql'] == null ? null : CloudSqlConnectionProfile.fromMap((map['cloudsql'] as Map).cast<String, dynamic>()),
      connectionProfileId: map['connectionProfileId'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      mysql: map['mysql'] == null ? null : MySqlConnectionProfile.fromMap((map['mysql'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      oracle: map['oracle'] == null ? null : OracleConnectionProfile.fromMap((map['oracle'] as Map).cast<String, dynamic>()),
      postgresql: map['postgresql'] == null ? null : PostgreSqlConnectionProfile.fromMap((map['postgresql'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      provider: map['provider'] == null ? null : ConnectionProfileProvider.fromValue(map['provider'] as String),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      skipValidation: map['skipValidation'] == null ? null : map['skipValidation'] as bool,
      state: map['state'] == null ? null : ConnectionProfileState.fromValue(map['state'] as String),
    );
  }
}
