...
class SingleColumnChange {
  ...
  factory SingleColumnChange.fromMap(Map<String, dynamic> map) {
    return SingleColumnChange(
      ...
      arrayLength: map['arrayLength'] == null ? null : map['arrayLength'] as int,
      autoGenerated: map['autoGenerated'] == null ? null : map['autoGenerated'] as bool,
      ...
      fractionalSecondsPrecision: map['fractionalSecondsPrecision'] == null ? null : map['fractionalSecondsPrecision'] as int,
      ...
      setValues: map['setValues'] == null ? null : (map['setValues'] as List).cast<String>(),
