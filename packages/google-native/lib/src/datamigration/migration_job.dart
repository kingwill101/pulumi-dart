...
class MigrationJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ReverseSshConnectivityResponse>
  ...
  late final pulumi.Output<VpcPeeringConnectivityResponse>
  ...
  MigrationJob(
    ...
    this.conversionWorkspace = registerOutput<ConversionWorkspaceInfoResponse>(
      'conversionWorkspace',
    );
    this.createTime = registerOutput<String>('createTime');
    this.destination = registerOutput<String>('destination');
    this.destinationDatabase = registerOutput<DatabaseTypeResponse>(
      'destinationDatabase',
    );
    ...
    this.performanceConfig = registerOutput<PerformanceConfigResponse>(
      'performanceConfig',
    );
    ...
    this.sourceDatabase = registerOutput<DatabaseTypeResponse>(
      'sourceDatabase',
    );
