...
class SqlIpConfigDatamigrationV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authorizedNetworks': ?authorizedNetworks == null ? null : pulumi.Input.encodeList<SqlAclEntryDatamigrationV1beta1, Map<String, dynamic>>(authorizedNetworks!, (value) => value.toMap()),
  ...
  factory SqlIpConfigDatamigrationV1beta1.fromMap(Map<String, dynamic> map) {
    return SqlIpConfigDatamigrationV1beta1(
      authorizedNetworks: map['authorizedNetworks'] == null ? null : pulumi.Input.decodeList<SqlAclEntryDatamigrationV1beta1>(map['authorizedNetworks'], (value) => SqlAclEntryDatamigrationV1beta1.fromMap((value as Map).cast<String, dynamic>())),
