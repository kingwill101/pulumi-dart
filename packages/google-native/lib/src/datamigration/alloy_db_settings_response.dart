...
class AlloyDbSettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'primaryInstanceSettings': primaryInstanceSettings.toMap(),
  ...
  factory AlloyDbSettingsResponse.fromMap(Map<String, dynamic> map) {
    return AlloyDbSettingsResponse(
      ...
      primaryInstanceSettings: PrimaryInstanceSettingsResponse.fromMap((map['primaryInstanceSettings'] as Map).cast<String, dynamic>()),
