...
class GetConversionWorkspaceResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['hasUncommittedChanges'] = hasUncommittedChanges;
    map['latestCommitId'] = latestCommitId;
    map['latestCommitTime'] = latestCommitTime;
    map['name'] = name;
  ...
  factory GetConversionWorkspaceResult.fromMap(Map<String, dynamic> map) {
    return GetConversionWorkspaceResult(
      ...
      destination: DatabaseEngineInfoResponse.fromMap(
      ...
      source: DatabaseEngineInfoResponse.fromMap(
