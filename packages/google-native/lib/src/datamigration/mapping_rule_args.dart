...
class MappingRuleArgs {
  ...
  factory MappingRuleArgs.fromMap(Map<String, dynamic> map) {
    return MappingRuleArgs(
      conditionalColumnSetValue: map['conditionalColumnSetValue'] == null ? null : ConditionalColumnSetValue.fromMap((map['conditionalColumnSetValue'] as Map).cast<String, dynamic>()),
      conversionWorkspaceId: map['conversionWorkspaceId'] as String,
      convertRowidColumn: map['convertRowidColumn'] == null ? null : ConvertRowIdToColumn.fromMap((map['convertRowidColumn'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      entityMove: map['entityMove'] == null ? null : EntityMove.fromMap((map['entityMove'] as Map).cast<String, dynamic>()),
      filter: MappingRuleFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      filterTableColumns: map['filterTableColumns'] == null ? null : FilterTableColumns.fromMap((map['filterTableColumns'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      mappingRuleId: map['mappingRuleId'] as String,
      multiColumnDataTypeChange: map['multiColumnDataTypeChange'] == null ? null : MultiColumnDatatypeChange.fromMap((map['multiColumnDataTypeChange'] as Map).cast<String, dynamic>()),
      multiEntityRename: map['multiEntityRename'] == null ? null : MultiEntityRename.fromMap((map['multiEntityRename'] as Map).cast<String, dynamic>()),
      ...
      setTablePrimaryKey: map['setTablePrimaryKey'] == null ? null : SetTablePrimaryKey.fromMap((map['setTablePrimaryKey'] as Map).cast<String, dynamic>()),
      singleColumnChange: map['singleColumnChange'] == null ? null : SingleColumnChange.fromMap((map['singleColumnChange'] as Map).cast<String, dynamic>()),
      singleEntityRename: map['singleEntityRename'] == null ? null : SingleEntityRename.fromMap((map['singleEntityRename'] as Map).cast<String, dynamic>()),
      singlePackageChange: map['singlePackageChange'] == null ? null : SinglePackageChange.fromMap((map['singlePackageChange'] as Map).cast<String, dynamic>()),
      sourceSqlChange: map['sourceSqlChange'] == null ? null : SourceSqlChange.fromMap((map['sourceSqlChange'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : MappingRuleState.fromValue(map['state'] as String),
    );
  }
}
