...
class CloudSqlSettings {
  ...
  factory CloudSqlSettings.fromMap(Map<String, dynamic> map) {
    return CloudSqlSettings(
      activationPolicy: map['activationPolicy'] == null ? null : CloudSqlSettingsActivationPolicy.fromValue(map['activationPolicy'] as String),
      autoStorageIncrease: map['autoStorageIncrease'] == null ? null : map['autoStorageIncrease'] as bool,
      availabilityType: map['availabilityType'] == null ? null : CloudSqlSettingsAvailabilityType.fromValue(map['availabilityType'] as String),
      cmekKeyName: map['cmekKeyName'] == null ? null : map['cmekKeyName'] as String,
      collation: map['collation'] == null ? null : map['collation'] as String,
      dataCacheConfig: map['dataCacheConfig'] == null ? null : DataCacheConfig.fromMap((map['dataCacheConfig'] as Map).cast<String, dynamic>()),
      dataDiskSizeGb: map['dataDiskSizeGb'] == null ? null : map['dataDiskSizeGb'] as String,
      dataDiskType: map['dataDiskType'] == null ? null : CloudSqlSettingsDataDiskType.fromValue(map['dataDiskType'] as String),
      databaseFlags: map['databaseFlags'] == null ? null : (map['databaseFlags'] as Map).cast<String, String>(),
      databaseVersion: map['databaseVersion'] == null ? null : CloudSqlSettingsDatabaseVersion.fromValue(map['databaseVersion'] as String),
      edition: map['edition'] == null ? null : CloudSqlSettingsEdition.fromValue(map['edition'] as String),
      ipConfig: map['ipConfig'] == null ? null : SqlIpConfig.fromMap((map['ipConfig'] as Map).cast<String, dynamic>()),
