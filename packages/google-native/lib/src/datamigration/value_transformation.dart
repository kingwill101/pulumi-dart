...
class ValueTransformation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'assignSpecificValue': ?assignSpecificValue == null ? null : assignSpecificValue!.toMap(),
      'doubleComparison': ?doubleComparison == null ? null : doubleComparison!.toMap(),
  ...
  factory ValueTransformation.fromMap(Map<String, dynamic> map) {
    return ValueTransformation(
      applyHash: map['applyHash'] == null ? null : ApplyHash.fromMap((map['applyHash'] as Map).cast<String, dynamic>()),
      assignMaxValue: map['assignMaxValue'] == null ? null : (map['assignMaxValue'] as Map).cast<String, dynamic>(),
      assignMinValue: map['assignMinValue'] == null ? null : (map['assignMinValue'] as Map).cast<String, dynamic>(),
      assignNull: map['assignNull'] == null ? null : (map['assignNull'] as Map).cast<String, dynamic>(),
      assignSpecificValue: map['assignSpecificValue'] == null ? null : AssignSpecificValue.fromMap((map['assignSpecificValue'] as Map).cast<String, dynamic>()),
      doubleComparison: map['doubleComparison'] == null ? null : DoubleComparisonFilter.fromMap((map['doubleComparison'] as Map).cast<String, dynamic>()),
      intComparison: map['intComparison'] == null ? null : IntComparisonFilter.fromMap((map['intComparison'] as Map).cast<String, dynamic>()),
      isNull: map['isNull'] == null ? null : (map['isNull'] as Map).cast<String, dynamic>(),
      roundScale: map['roundScale'] == null ? null : RoundToScale.fromMap((map['roundScale'] as Map).cast<String, dynamic>()),
      valueList: map['valueList'] == null ? null : ValueListFilter.fromMap((map['valueList'] as Map).cast<String, dynamic>()),
    );
  }
}
