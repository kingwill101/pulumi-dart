...
class MultiColumnDatatypeChange {
  ...
  Map<String, dynamic> toMap() {
    ...
    final overrideFractionalSecondsPrecisionValue =
        overrideFractionalSecondsPrecision;
    if (overrideFractionalSecondsPrecisionValue != null) {
      map['overrideFractionalSecondsPrecision'] =
          overrideFractionalSecondsPrecisionValue;
    }
    final overrideLengthValue = overrideLength;
    if (overrideLengthValue != null) {
      map['overrideLength'] = overrideLengthValue;
    }
    final overridePrecisionValue = overridePrecision;
    if (overridePrecisionValue != null) {
      map['overridePrecision'] = overridePrecisionValue;
    }
    final overrideScaleValue = overrideScale;
    if (overrideScaleValue != null) {
      map['overrideScale'] = overrideScaleValue;
    }
  ...
  factory MultiColumnDatatypeChange.fromMap(Map<String, dynamic> map) {
    return MultiColumnDatatypeChange(
      ...
      overrideScale:
          map['overrideScale'] == null ? null : map['overrideScale'] as int,
