...
class ConnectionProfileDatamigrationV1beta1 extends pulumi.CustomResource {
  ...
  ConnectionProfileDatamigrationV1beta1(
    ...
    this.cloudsql = registerOutput<CloudSqlConnectionProfileResponseDatamigrationV1beta1>('cloudsql');
    ...
    this.mysql = registerOutput<MySqlConnectionProfileResponseDatamigrationV1beta1>('mysql');
