...
class JobJobsV4Args {
  ...
  JobJobsV4Args({
    ...
    ApplicationInfoJobsV4? applicationInfo,
    required String company,
    CompensationInfoJobsV4? compensationInfo,
    Map<String, String>? customAttributes,
    List<JobDegreeTypesItemJobsV4>? degreeTypes,
    String? department,
    required String description,
    List<JobEmploymentTypesItemJobsV4>? employmentTypes,
    String? incentives,
    List<JobJobBenefitsItemJobsV4>? jobBenefits,
    String? jobEndTime,
    JobJobLevelJobsV4? jobLevel,
    String? jobStartTime,
    String? languageCode,
    String? name,
    String? postingExpireTime,
    String? postingPublishTime,
    JobPostingRegionJobsV4? postingRegion,
    ProcessingOptionsJobsV4? processingOptions,
    String? project,
    int? promotionValue,
    ...
    JobVisibilityJobsV4? visibility,
  })  : addresses = pulumi.Input.asOptionalInput<List<String>>(addresses),
        applicationInfo = pulumi.Input.asOptionalInput<ApplicationInfoJobsV4>(
            applicationInfo),
        company = pulumi.Input.asInput<String>(company),
        compensationInfo = pulumi.Input.asOptionalInput<CompensationInfoJobsV4>(
            compensationInfo),
        customAttributes =
            pulumi.Input.asOptionalInput<Map<String, String>>(customAttributes),
        degreeTypes =
            pulumi.Input.asOptionalInput<List<JobDegreeTypesItemJobsV4>>(
                degreeTypes),
        department = pulumi.Input.asOptionalInput<String>(department),
        description = pulumi.Input.asInput<String>(description),
        employmentTypes =
            pulumi.Input.asOptionalInput<List<JobEmploymentTypesItemJobsV4>>(
                employmentTypes),
        incentives = pulumi.Input.asOptionalInput<String>(incentives),
        jobBenefits =
            pulumi.Input.asOptionalInput<List<JobJobBenefitsItemJobsV4>>(
                jobBenefits),
        ...
        postingExpireTime =
            pulumi.Input.asOptionalInput<String>(postingExpireTime),
        postingPublishTime =
            pulumi.Input.asOptionalInput<String>(postingPublishTime),
        postingRegion =
            pulumi.Input.asOptionalInput<JobPostingRegionJobsV4>(postingRegion),
        processingOptions =
            pulumi.Input.asOptionalInput<ProcessingOptionsJobsV4>(
                processingOptions),
        ...
        responsibilities =
            pulumi.Input.asOptionalInput<String>(responsibilities),
        tenantId = pulumi.Input.asInput<String>(tenantId),
        title = pulumi.Input.asInput<String>(title),
        visibility =
            pulumi.Input.asOptionalInput<JobVisibilityJobsV4>(visibility);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (applicationInfoValue != null) {
      map['applicationInfo'] = pulumi.Input.mapOptionalInputValue<
          ApplicationInfoJobsV4,
          Map<String, dynamic>>(applicationInfoValue, (value) => value.toMap());
    }
    map['company'] = company;
    final compensationInfoValue = compensationInfo;
    if (compensationInfoValue != null) {
      map['compensationInfo'] = pulumi.Input.mapOptionalInputValue<
              CompensationInfoJobsV4, Map<String, dynamic>>(
    ...
    if (degreeTypesValue != null) {
      map['degreeTypes'] = pulumi.Input.mapOptionalInputValue<
              List<JobDegreeTypesItemJobsV4>, List<String>>(
          degreeTypesValue,
          (value) => pulumi.Input.encodeList<JobDegreeTypesItemJobsV4, String>(
    ...
    if (employmentTypesValue != null) {
      map['employmentTypes'] = pulumi.Input.mapOptionalInputValue<
              List<JobEmploymentTypesItemJobsV4>, List<String>>(
          employmentTypesValue,
          (value) =>
              pulumi.Input.encodeList<JobEmploymentTypesItemJobsV4, String>(
                  value, (value) => value.value));
    }
    ...
    if (jobBenefitsValue != null) {
      map['jobBenefits'] = pulumi.Input.mapOptionalInputValue<
              List<JobJobBenefitsItemJobsV4>, List<String>>(
          jobBenefitsValue,
          (value) => pulumi.Input.encodeList<JobJobBenefitsItemJobsV4, String>(
              value, (value) => value.value));
    }
    ...
    if (jobLevelValue != null) {
      map['jobLevel'] =
          pulumi.Input.mapOptionalInputValue<JobJobLevelJobsV4, String>(
    ...
    if (postingRegionValue != null) {
      map['postingRegion'] =
          pulumi.Input.mapOptionalInputValue<JobPostingRegionJobsV4, String>(
              postingRegionValue, (value) => value.value);
    }
    final processingOptionsValue = processingOptions;
    if (processingOptionsValue != null) {
      map['processingOptions'] = pulumi.Input.mapOptionalInputValue<
              ProcessingOptionsJobsV4, Map<String, dynamic>>(
    ...
    if (visibilityValue != null) {
      map['visibility'] =
          pulumi.Input.mapOptionalInputValue<JobVisibilityJobsV4, String>(
  ...
  factory JobJobsV4Args.fromMap(Map<String, dynamic> map) {
    return JobJobsV4Args(
      ...
      applicationInfo: map['applicationInfo'] == null
          ? null
          : ApplicationInfoJobsV4.fromMap(
              (map['applicationInfo'] as Map).cast<String, dynamic>()),
      company: map['company'] as String,
      compensationInfo: map['compensationInfo'] == null
          ? null
          : CompensationInfoJobsV4.fromMap(
      ...
      degreeTypes: map['degreeTypes'] == null
          ? null
          : pulumi.Input.decodeList<JobDegreeTypesItemJobsV4>(
              map['degreeTypes'],
              (value) => JobDegreeTypesItemJobsV4.fromValue(value as String)),
      department:
          map['department'] == null ? null : map['department'] as String,
      description: map['description'] as String,
      employmentTypes: map['employmentTypes'] == null
          ? null
          : pulumi.Input.decodeList<JobEmploymentTypesItemJobsV4>(
              map['employmentTypes'],
              (value) =>
                  JobEmploymentTypesItemJobsV4.fromValue(value as String)),
      incentives:
          map['incentives'] == null ? null : map['incentives'] as String,
      jobBenefits: map['jobBenefits'] == null
          ? null
          : pulumi.Input.decodeList<JobJobBenefitsItemJobsV4>(
              map['jobBenefits'],
              (value) => JobJobBenefitsItemJobsV4.fromValue(value as String)),
      jobEndTime:
          map['jobEndTime'] == null ? null : map['jobEndTime'] as String,
      jobLevel: map['jobLevel'] == null
          ? null
          : JobJobLevelJobsV4.fromValue(map['jobLevel'] as String),
      jobStartTime:
          map['jobStartTime'] == null ? null : map['jobStartTime'] as String,
      languageCode:
      ...
      postingRegion: map['postingRegion'] == null
          ? null
          : JobPostingRegionJobsV4.fromValue(map['postingRegion'] as String),
      processingOptions: map['processingOptions'] == null
          ? null
          : ProcessingOptionsJobsV4.fromMap(
              (map['processingOptions'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      promotionValue:
          map['promotionValue'] == null ? null : map['promotionValue'] as int,
      ...
      visibility: map['visibility'] == null
          ? null
          : JobVisibilityJobsV4.fromValue(map['visibility'] as String),
    );
  }
}
