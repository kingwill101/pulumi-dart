...
class JobJobsV4Args {
  ...
  JobJobsV4Args({
    ...
    JobVisibilityJobsV4? visibility,
       ...
       degreeTypes = pulumi
           .Input.asOptionalInput<List<JobDegreeTypesItemJobsV4>>(degreeTypes),
       ...
       jobBenefits = pulumi
           .Input.asOptionalInput<List<JobJobBenefitsItemJobsV4>>(jobBenefits),
       ...
       postingRegion = pulumi.Input.asOptionalInput<JobPostingRegionJobsV4>(
         postingRegion,
       ),
       processingOptions = pulumi
           .Input.asOptionalInput<ProcessingOptionsJobsV4>(processingOptions),
       ...
       visibility = pulumi.Input.asOptionalInput<JobVisibilityJobsV4>(
         visibility,
       );
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'degreeTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobDegreeTypesItemJobsV4>,
            List<String>
          >(
            degreeTypes,
            (value) =>
                pulumi.Input.encodeList<JobDegreeTypesItemJobsV4, String>(
                  value,
                  (value) => value.value,
                ),
          ),
      ...
      'employmentTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobEmploymentTypesItemJobsV4>,
            List<String>
          >(
            employmentTypes,
            (value) =>
      ...
      'jobBenefits':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobJobBenefitsItemJobsV4>,
            List<String>
          >(
            jobBenefits,
            (value) =>
                pulumi.Input.encodeList<JobJobBenefitsItemJobsV4, String>(
                  value,
                  (value) => value.value,
                ),
          ),
