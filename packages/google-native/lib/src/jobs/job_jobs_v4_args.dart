...
class JobJobsV4Args {
  ...
  factory JobJobsV4Args.fromMap(Map<String, dynamic> map) {
    return JobJobsV4Args(
      ...
      applicationInfo: map['applicationInfo'] == null ? null : ApplicationInfoJobsV4.fromMap((map['applicationInfo'] as Map).cast<String, dynamic>()),
      company: map['company'] as String,
      compensationInfo: map['compensationInfo'] == null ? null : CompensationInfoJobsV4.fromMap((map['compensationInfo'] as Map).cast<String, dynamic>()),
      customAttributes: map['customAttributes'] == null ? null : (map['customAttributes'] as Map).cast<String, String>(),
      degreeTypes: map['degreeTypes'] == null ? null : pulumi.Input.decodeList<JobDegreeTypesItemJobsV4>(map['degreeTypes'], (value) => JobDegreeTypesItemJobsV4.fromValue(value as String)),
      department: map['department'] == null ? null : map['department'] as String,
      description: map['description'] as String,
      employmentTypes: map['employmentTypes'] == null ? null : pulumi.Input.decodeList<JobEmploymentTypesItemJobsV4>(map['employmentTypes'], (value) => JobEmploymentTypesItemJobsV4.fromValue(value as String)),
      incentives: map['incentives'] == null ? null : map['incentives'] as String,
      jobBenefits: map['jobBenefits'] == null ? null : pulumi.Input.decodeList<JobJobBenefitsItemJobsV4>(map['jobBenefits'], (value) => JobJobBenefitsItemJobsV4.fromValue(value as String)),
      jobEndTime: map['jobEndTime'] == null ? null : map['jobEndTime'] as String,
      jobLevel: map['jobLevel'] == null ? null : JobJobLevelJobsV4.fromValue(map['jobLevel'] as String),
      jobStartTime: map['jobStartTime'] == null ? null : map['jobStartTime'] as String,
      languageCode: map['languageCode'] == null ? null : map['languageCode'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      postingExpireTime: map['postingExpireTime'] == null ? null : map['postingExpireTime'] as String,
      postingPublishTime: map['postingPublishTime'] == null ? null : map['postingPublishTime'] as String,
      postingRegion: map['postingRegion'] == null ? null : JobPostingRegionJobsV4.fromValue(map['postingRegion'] as String),
      processingOptions: map['processingOptions'] == null ? null : ProcessingOptionsJobsV4.fromMap((map['processingOptions'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      promotionValue: map['promotionValue'] == null ? null : map['promotionValue'] as int,
      qualifications: map['qualifications'] == null ? null : map['qualifications'] as String,
      requisitionId: map['requisitionId'] as String,
      responsibilities: map['responsibilities'] == null ? null : map['responsibilities'] as String,
      tenantId: map['tenantId'] as String,
      title: map['title'] as String,
      visibility: map['visibility'] == null ? null : JobVisibilityJobsV4.fromValue(map['visibility'] as String),
    );
  }
}
