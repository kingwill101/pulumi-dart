...
class CompanyJobsV4Args {
  ...
  factory CompanyJobsV4Args.fromMap(Map<String, dynamic> map) {
    return CompanyJobsV4Args(
      careerSiteUri: map['careerSiteUri'] == null ? null : map['careerSiteUri'] as String,
      displayName: map['displayName'] as String,
      eeoText: map['eeoText'] == null ? null : map['eeoText'] as String,
      externalId: map['externalId'] as String,
      headquartersAddress: map['headquartersAddress'] == null ? null : map['headquartersAddress'] as String,
      hiringAgency: map['hiringAgency'] == null ? null : map['hiringAgency'] as bool,
      imageUri: map['imageUri'] == null ? null : map['imageUri'] as String,
      keywordSearchableJobCustomAttributes: map['keywordSearchableJobCustomAttributes'] == null ? null : (map['keywordSearchableJobCustomAttributes'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      size: map['size'] == null ? null : CompanySizeJobsV4.fromValue(map['size'] as String),
      tenantId: map['tenantId'] as String,
      websiteUri: map['websiteUri'] == null ? null : map['websiteUri'] as String,
    );
  }
}
