...
class CompanyJobsV4Args {
  ...
  CompanyJobsV4Args({
    ...
    String? websiteUri,
       ...
       headquartersAddress = pulumi.Input.asOptionalInput<String>(
         headquartersAddress,
       ),
  ...
  factory CompanyJobsV4Args.fromMap(Map<String, dynamic> map) {
    return CompanyJobsV4Args(
      careerSiteUri: map['careerSiteUri'] == null
          ? null
          : map['careerSiteUri'] as String,
      ...
      hiringAgency: map['hiringAgency'] == null
          ? null
          : map['hiringAgency'] as bool,
