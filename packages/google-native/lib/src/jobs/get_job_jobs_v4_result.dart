...
class GetJobJobsV4Result {
  ...
  final ApplicationInfoResponseJobsV4 applicationInfo;
  ...
  final CompensationInfoResponseJobsV4 compensationInfo;
  ...
  final JobDerivedInfoResponseJobsV4 derivedInfo;
  ...
  final ProcessingOptionsResponseJobsV4 processingOptions;
  ...
  /// Creates a new [GetJobJobsV4Result].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['company'] = company;
    map['companyDisplayName'] = companyDisplayName;
    map['compensationInfo'] = compensationInfo.toMap();
    map['customAttributes'] = customAttributes;
    map['degreeTypes'] = degreeTypes;
    map['department'] = department;
    map['derivedInfo'] = derivedInfo.toMap();
    map['description'] = description;
    map['employmentTypes'] = employmentTypes;
    map['incentives'] = incentives;
    map['jobBenefits'] = jobBenefits;
    map['jobEndTime'] = jobEndTime;
    map['jobLevel'] = jobLevel;
    map['jobStartTime'] = jobStartTime;
    map['languageCode'] = languageCode;
    map['name'] = name;
    map['postingCreateTime'] = postingCreateTime;
    map['postingExpireTime'] = postingExpireTime;
    map['postingPublishTime'] = postingPublishTime;
    map['postingRegion'] = postingRegion;
    map['postingUpdateTime'] = postingUpdateTime;
    map['processingOptions'] = processingOptions.toMap();
    map['promotionValue'] = promotionValue;
  ...
  factory GetJobJobsV4Result.fromMap(Map<String, dynamic> map) {
    return GetJobJobsV4Result(
      addresses: (map['addresses'] as List).cast<String>(),
      applicationInfo: ApplicationInfoResponseJobsV4.fromMap(
          (map['applicationInfo'] as Map).cast<String, dynamic>()),
      company: map['company'] as String,
      companyDisplayName: map['companyDisplayName'] as String,
      compensationInfo: CompensationInfoResponseJobsV4.fromMap(
      ...
      derivedInfo: JobDerivedInfoResponseJobsV4.fromMap(
      ...
      processingOptions: ProcessingOptionsResponseJobsV4.fromMap(
