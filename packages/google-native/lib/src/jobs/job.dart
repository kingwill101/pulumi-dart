...
class Job extends pulumi.CustomResource {
  ...
  Job(String name, {JobArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.applicationInfo = registerOutput<ApplicationInfoResponse>(
      'applicationInfo',
    );
    this.companyDisplayName = registerOutput<String>('companyDisplayName');
    this.companyName = registerOutput<String>('companyName');
    this.compensationInfo = registerOutput<CompensationInfoResponse>(
      'compensationInfo',
    );
    ...
    this.processingOptions = registerOutput<ProcessingOptionsResponse>(
      'processingOptions',
    );
