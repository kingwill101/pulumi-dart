...
class JobArgs {
  ...
  JobArgs({
    ...
    JobVisibility? visibility,
        ...
        applicationInfo =
            pulumi.Input.asInput<ApplicationInfo>(applicationInfo),
        companyName = pulumi.Input.asInput<String>(companyName),
        compensationInfo =
            pulumi.Input.asOptionalInput<CompensationInfo>(compensationInfo),
        customAttributes =
            pulumi.Input.asOptionalInput<Map<String, String>>(customAttributes),
        degreeTypes =
            pulumi.Input.asOptionalInput<List<JobDegreeTypesItem>>(degreeTypes),
        ...
        jobBenefits =
            pulumi.Input.asOptionalInput<List<JobJobBenefitsItem>>(jobBenefits),
        ...
        postingRegion =
            pulumi.Input.asOptionalInput<JobPostingRegion>(postingRegion),
        processingOptions =
            pulumi.Input.asOptionalInput<ProcessingOptions>(processingOptions),
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      degreeTypes: map['degreeTypes'] == null
          ? null
          : pulumi.Input.decodeList<JobDegreeTypesItem>(map['degreeTypes'],
      ...
      jobBenefits: map['jobBenefits'] == null
          ? null
          : pulumi.Input.decodeList<JobJobBenefitsItem>(map['jobBenefits'],
