...
class GameServerDeploymentIamPolicyGameservicesV1betaArgs {
  ...
  GameServerDeploymentIamPolicyGameservicesV1betaArgs({
    List<AuditConfigGameservicesV1beta>? auditConfigs,
    List<BindingGameservicesV1beta>? bindings,
    String? etag,
    required String gameServerDeploymentId,
    String? location,
    String? project,
    List<RuleGameservicesV1beta>? rules,
    String? updateMask,
    int? version,
  }) :
  ...
  factory GameServerDeploymentIamPolicyGameservicesV1betaArgs.fromMap(Map<String, dynamic> map) {
    return GameServerDeploymentIamPolicyGameservicesV1betaArgs(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Input.decodeList<AuditConfigGameservicesV1beta>(map['auditConfigs'], (value) => AuditConfigGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<BindingGameservicesV1beta>(map['bindings'], (value) => BindingGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>())),
      etag: map['etag'] == null ? null : map['etag'] as String,
      gameServerDeploymentId: map['gameServerDeploymentId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RuleGameservicesV1beta>(map['rules'], (value) => RuleGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>())),
