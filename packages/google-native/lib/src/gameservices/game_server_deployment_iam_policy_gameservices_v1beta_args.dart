  ...
  GameServerDeploymentIamPolicyGameservicesV1betaArgs({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigGameservicesV1beta>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingGameservicesV1beta>>(
                bindings),
        ...
        rules =
            pulumi.Input.asOptionalInput<List<RuleGameservicesV1beta>>(rules),
  ...
  factory GameServerDeploymentIamPolicyGameservicesV1betaArgs.fromMap(
    ...
    return GameServerDeploymentIamPolicyGameservicesV1betaArgs(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigGameservicesV1beta>(
              map['auditConfigs'],
              (value) => AuditConfigGameservicesV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingGameservicesV1beta>(
              map['bindings'],
              (value) => BindingGameservicesV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      rules: map['rules'] == null
          ? null
          : pulumi.Input.decodeList<RuleGameservicesV1beta>(
              map['rules'],
              (value) => RuleGameservicesV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      updateMask:
