...
class RuleGameservicesV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<ConditionGameservicesV1beta, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
      'description': ?description,
      'in': ?in_,
      'logConfig': ?logConfig == null ? null : pulumi.Input.encodeList<LogConfigGameservicesV1beta, Map<String, dynamic>>(logConfig!, (value) => value.toMap()),
      'notIn': ?notIn,
  ...
  factory RuleGameservicesV1beta.fromMap(Map<String, dynamic> map) {
    return RuleGameservicesV1beta(
      action: map['action'] == null ? null : RuleActionGameservicesV1beta.fromValue(map['action'] as String),
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<ConditionGameservicesV1beta>(map['conditions'], (value) => ConditionGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      in_: map['in'] == null ? null : (map['in'] as List).cast<String>(),
      logConfig: map['logConfig'] == null ? null : pulumi.Input.decodeList<LogConfigGameservicesV1beta>(map['logConfig'], (value) => LogConfigGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>())),
