...
/// {@template pulumi_gameservices_v1_game_server_deployment_iam_member_args_doc}
/// The set of arguments for GameServerDeploymentIamMember.
/// {@endtemplate}
/// {@macro pulumi_gameservices_v1_game_server_deployment_iam_member_args_doc}
class GameServerDeploymentIamMemberArgs {
  ...
  /// Creates a new [GameServerDeploymentIamMemberArgs].
  ...
  GameServerDeploymentIamMemberArgs({
    Condition? condition,
  ...
  factory GameServerDeploymentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return GameServerDeploymentIamMemberArgs(
