...
class StepArgs {
  ...
  StepArgs({
    ...
    List<StepDimensionValueEntry>? dimensionValue,
  ...
  factory StepArgs.fromMap(Map<String, dynamic> map) {
    return StepArgs(
      ...
      deviceUsageDuration: map['deviceUsageDuration'] == null ? null : Duration.fromMap((map['deviceUsageDuration'] as Map).cast<String, dynamic>()),
      dimensionValue: map['dimensionValue'] == null ? null : pulumi.Input.decodeList<StepDimensionValueEntry>(map['dimensionValue'], (value) => StepDimensionValueEntry.fromMap((value as Map).cast<String, dynamic>())),
      executionId: map['executionId'] as String,
      hasImages: map['hasImages'] == null ? null : map['hasImages'] as bool,
      historyId: map['historyId'] as String,
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<StepLabelsEntry>(map['labels'], (value) => StepLabelsEntry.fromMap((value as Map).cast<String, dynamic>())),
      multiStep: map['multiStep'] == null ? null : MultiStep.fromMap((map['multiStep'] as Map).cast<String, dynamic>()),
      ...
      state: map['state'] == null ? null : StepState.fromValue(map['state'] as String),
      stepId: map['stepId'] == null ? null : map['stepId'] as String,
      testExecutionStep: map['testExecutionStep'] == null ? null : TestExecutionStep.fromMap((map['testExecutionStep'] as Map).cast<String, dynamic>()),
      toolExecutionStep: map['toolExecutionStep'] == null ? null : ToolExecutionStep.fromMap((map['toolExecutionStep'] as Map).cast<String, dynamic>()),
    );
  }
}
