...
class StepArgs {
  ...
  StepArgs({
    ...
    ToolExecutionStep? toolExecutionStep,
       ...
       deviceUsageDuration = pulumi.Input.asOptionalInput<Duration>(
         deviceUsageDuration,
       ),
       dimensionValue =
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<StepState, String>(
        state,
        (value) => value.value,
      ),
      'stepId': ?stepId,
      'testExecutionStep':
          ?pulumi.Input.mapOptionalInputValue<
            TestExecutionStep,
            Map<String, dynamic>
          >(testExecutionStep, (value) => value.toMap()),
      'toolExecutionStep':
          ?pulumi.Input.mapOptionalInputValue<
            ToolExecutionStep,
            Map<String, dynamic>
          >(toolExecutionStep, (value) => value.toMap()),
    };
  }
