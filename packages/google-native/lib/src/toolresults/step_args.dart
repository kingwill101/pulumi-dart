...
class StepArgs {
  ...
  StepArgs({
    ...
    ToolExecutionStep? toolExecutionStep,
            ...
            pulumi.Input.asOptionalInput<Timestamp>(completionTime),
        creationTime = pulumi.Input.asOptionalInput<Timestamp>(creationTime),
        description = pulumi.Input.asOptionalInput<String>(description),
        deviceUsageDuration =
            pulumi.Input.asOptionalInput<Duration>(deviceUsageDuration),
        dimensionValue =
        ...
        testExecutionStep =
            pulumi.Input.asOptionalInput<TestExecutionStep>(testExecutionStep),
        toolExecutionStep =
            pulumi.Input.asOptionalInput<ToolExecutionStep>(toolExecutionStep);
  ...
  factory StepArgs.fromMap(Map<String, dynamic> map) {
    return StepArgs(
      completionTime: map['completionTime'] == null
          ? null
          : Timestamp.fromMap(
              (map['completionTime'] as Map).cast<String, dynamic>()),
      ...
      deviceUsageDuration: map['deviceUsageDuration'] == null
          ? null
          : Duration.fromMap(
              (map['deviceUsageDuration'] as Map).cast<String, dynamic>()),
      dimensionValue: map['dimensionValue'] == null
          ? null
          : pulumi.Input.decodeList<StepDimensionValueEntry>(
              map['dimensionValue'],
              (value) => StepDimensionValueEntry.fromMap(
      ...
      labels: map['labels'] == null
          ? null
          : pulumi.Input.decodeList<StepLabelsEntry>(
              map['labels'],
              (value) => StepLabelsEntry.fromMap(
                  (value as Map).cast<String, dynamic>())),
      multiStep: map['multiStep'] == null
          ? null
          : MultiStep.fromMap(
              (map['multiStep'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      outcome: map['outcome'] == null
          ? null
          : Outcome.fromMap((map['outcome'] as Map).cast<String, dynamic>()),
      ...
      state: map['state'] == null
          ? null
          : StepState.fromValue(map['state'] as String),
      stepId: map['stepId'] == null ? null : map['stepId'] as String,
      testExecutionStep: map['testExecutionStep'] == null
          ? null
          : TestExecutionStep.fromMap(
              (map['testExecutionStep'] as Map).cast<String, dynamic>()),
      toolExecutionStep: map['toolExecutionStep'] == null
          ? null
          : ToolExecutionStep.fromMap(
              (map['toolExecutionStep'] as Map).cast<String, dynamic>()),
    );
  }
}
