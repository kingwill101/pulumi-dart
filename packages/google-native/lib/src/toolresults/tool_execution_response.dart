...
class ToolExecutionResponse {
  ...
  final List<FileReferenceResponse> toolLogs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exitCode': exitCode.toMap(),
      'toolLogs': pulumi.Input.encodeList<FileReferenceResponse, Map<String, dynamic>>(toolLogs, (value) => value.toMap()),
      'toolOutputs': pulumi.Input.encodeList<ToolOutputReferenceResponse, Map<String, dynamic>>(toolOutputs, (value) => value.toMap()),
    };
  }

  factory ToolExecutionResponse.fromMap(Map<String, dynamic> map) {
    return ToolExecutionResponse(
      commandLineArguments: (map['commandLineArguments'] as List).cast<String>(),
      exitCode: ToolExitCodeResponse.fromMap((map['exitCode'] as Map).cast<String, dynamic>()),
      toolLogs: pulumi.Input.decodeList<FileReferenceResponse>(map['toolLogs'], (value) => FileReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
      toolOutputs: pulumi.Input.decodeList<ToolOutputReferenceResponse>(map['toolOutputs'], (value) => ToolOutputReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
