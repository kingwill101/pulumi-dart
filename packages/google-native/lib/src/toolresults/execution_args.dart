...
class ExecutionArgs {
  ...
  ExecutionArgs({
    ...
    String? testExecutionMatrixId,
       ...
       specification = pulumi.Input.asOptionalInput<Specification>(
         specification,
       ),
       state = pulumi.Input.asOptionalInput<ExecutionState>(state),
       testExecutionMatrixId = pulumi.Input.asOptionalInput<String>(
  ...
  factory ExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ExecutionArgs(
      ...
      dimensionDefinitions: map['dimensionDefinitions'] == null
          ? null
      ...
      testExecutionMatrixId: map['testExecutionMatrixId'] == null
          ? null
          : map['testExecutionMatrixId'] as String,
    );
  }
}
