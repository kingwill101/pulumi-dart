...
class ExecutionArgs {
  ...
  ExecutionArgs({
    ...
    String? testExecutionMatrixId,
        ...
        specification =
            pulumi.Input.asOptionalInput<Specification>(specification),
        state = pulumi.Input.asOptionalInput<ExecutionState>(state),
        testExecutionMatrixId =
            pulumi.Input.asOptionalInput<String>(testExecutionMatrixId);
  ...
  factory ExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ExecutionArgs(
      ...
      executionId:
          map['executionId'] == null ? null : map['executionId'] as String,
