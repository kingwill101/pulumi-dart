...
class IosTest {
  ...
  factory IosTest.fromMap(Map<String, dynamic> map) {
    return IosTest(
      iosAppInfo: map['iosAppInfo'] == null ? null : IosAppInfo.fromMap((map['iosAppInfo'] as Map).cast<String, dynamic>()),
      iosRoboTest: map['iosRoboTest'] == null ? null : (map['iosRoboTest'] as Map).cast<String, dynamic>(),
