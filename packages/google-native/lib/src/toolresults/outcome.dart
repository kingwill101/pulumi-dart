...
class Outcome {
  ...
  Map<String, dynamic> toMap() {
    ...
    final failureDetailValue = failureDetail;
    if (failureDetailValue != null) {
      map['failureDetail'] = failureDetailValue.toMap();
    }
    final inconclusiveDetailValue = inconclusiveDetail;
    if (inconclusiveDetailValue != null) {
      map['inconclusiveDetail'] = inconclusiveDetailValue.toMap();
    }
    final skippedDetailValue = skippedDetail;
    if (skippedDetailValue != null) {
      map['skippedDetail'] = skippedDetailValue.toMap();
    }
    final successDetailValue = successDetail;
    if (successDetailValue != null) {
      map['successDetail'] = successDetailValue.toMap();
    }
    final summaryValue = summary;
    if (summaryValue != null) {
      map['summary'] = summaryValue.value;
    }
    return map;
  }
  ...
  factory Outcome.fromMap(Map<String, dynamic> map) {
    return Outcome(
      failureDetail: map['failureDetail'] == null
          ? null
          : FailureDetail.fromMap(
              (map['failureDetail'] as Map).cast<String, dynamic>()),
      inconclusiveDetail: map['inconclusiveDetail'] == null
          ? null
          : InconclusiveDetail.fromMap(
              (map['inconclusiveDetail'] as Map).cast<String, dynamic>()),
      skippedDetail: map['skippedDetail'] == null
          ? null
          : SkippedDetail.fromMap(
              (map['skippedDetail'] as Map).cast<String, dynamic>()),
      successDetail: map['successDetail'] == null
          ? null
          : SuccessDetail.fromMap(
              (map['successDetail'] as Map).cast<String, dynamic>()),
      summary: map['summary'] == null
          ? null
          : OutcomeSummary.fromValue(map['summary'] as String),
    );
  }
}
