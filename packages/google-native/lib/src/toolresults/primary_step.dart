...
class PrimaryStep {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'individualOutcome': ?individualOutcome == null ? null : pulumi.Input.encodeList<IndividualOutcome, Map<String, dynamic>>(individualOutcome!, (value) => value.toMap()),
  ...
  factory PrimaryStep.fromMap(Map<String, dynamic> map) {
    return PrimaryStep(
      individualOutcome: map['individualOutcome'] == null ? null : pulumi.Input.decodeList<IndividualOutcome>(map['individualOutcome'], (value) => IndividualOutcome.fromMap((value as Map).cast<String, dynamic>())),
      rollUp: map['rollUp'] == null ? null : PrimaryStepRollUp.fromValue(map['rollUp'] as String),
    );
  }
}
