...
class Step extends pulumi.CustomResource {
  ...
  Step(String name, {StepArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.deviceUsageDuration = registerOutput<DurationResponse>(
      'deviceUsageDuration',
    );
    this.dimensionValue = registerOutput<List<StepDimensionValueEntryResponse>>(
      'dimensionValue',
    );
    ...
    this.testExecutionStep = registerOutput<TestExecutionStepResponse>(
      'testExecutionStep',
    );
    this.toolExecutionStep = registerOutput<ToolExecutionStepResponse>(
      'toolExecutionStep',
    );
  }
}
