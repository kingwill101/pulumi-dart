...
class ToolExecution {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'toolLogs': ?toolLogs == null ? null : pulumi.Input.encodeList<FileReference, Map<String, dynamic>>(toolLogs!, (value) => value.toMap()),
      'toolOutputs': ?toolOutputs == null ? null : pulumi.Input.encodeList<ToolOutputReference, Map<String, dynamic>>(toolOutputs!, (value) => value.toMap()),
    };
  }

  factory ToolExecution.fromMap(Map<String, dynamic> map) {
    return ToolExecution(
      commandLineArguments: map['commandLineArguments'] == null ? null : (map['commandLineArguments'] as List).cast<String>(),
      exitCode: map['exitCode'] == null ? null : ToolExitCode.fromMap((map['exitCode'] as Map).cast<String, dynamic>()),
      toolLogs: map['toolLogs'] == null ? null : pulumi.Input.decodeList<FileReference>(map['toolLogs'], (value) => FileReference.fromMap((value as Map).cast<String, dynamic>())),
      toolOutputs: map['toolOutputs'] == null ? null : pulumi.Input.decodeList<ToolOutputReference>(map['toolOutputs'], (value) => ToolOutputReference.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
