...
class GetStepResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['completionTime'] = completionTime.toMap();
    ...
    map['name'] = name;
    map['outcome'] = outcome.toMap();
    map['runDuration'] = runDuration.toMap();
    map['state'] = state;
    map['stepId'] = stepId;
    map['testExecutionStep'] = testExecutionStep.toMap();
    map['toolExecutionStep'] = toolExecutionStep.toMap();
    return map;
  }

  factory GetStepResult.fromMap(Map<String, dynamic> map) {
    return GetStepResult(
      completionTime: TimestampResponse.fromMap(
      ...
      deviceUsageDuration: DurationResponse.fromMap(
      ...
      labels: pulumi.Input.decodeList<StepLabelsEntryResponse>(
          ...
          (value) => StepLabelsEntryResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      multiStep: MultiStepResponse.fromMap(
      ...
      testExecutionStep: TestExecutionStepResponse.fromMap(
          (map['testExecutionStep'] as Map).cast<String, dynamic>()),
      toolExecutionStep: ToolExecutionStepResponse.fromMap(
