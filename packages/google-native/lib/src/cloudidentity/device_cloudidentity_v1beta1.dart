...
class DeviceCloudidentityV1beta1 extends pulumi.CustomResource {
  ...
  DeviceCloudidentityV1beta1(
    ...
    this.androidSpecificAttributes = registerOutput<AndroidAttributesResponse>('androidSpecificAttributes');
    ...
    this.enabledDeveloperOptions = registerOutput<bool>('enabledDeveloperOptions');
    ...
    this.endpointVerificationSpecificAttributes = registerOutput<EndpointVerificationSpecificAttributesResponse>('endpointVerificationSpecificAttributes');
