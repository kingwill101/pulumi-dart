...
class InboundSsoAssignmentArgs {
  ...
  InboundSsoAssignmentArgs({
    ...
    String? targetOrgUnit,
        ...
        signInBehavior =
            pulumi.Input.asOptionalInput<SignInBehavior>(signInBehavior),
        ssoMode =
            pulumi.Input.asOptionalInput<InboundSsoAssignmentSsoMode>(ssoMode),
  ...
  factory InboundSsoAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return InboundSsoAssignmentArgs(
      ...
      targetGroup:
          map['targetGroup'] == null ? null : map['targetGroup'] as String,
      targetOrgUnit:
          map['targetOrgUnit'] == null ? null : map['targetOrgUnit'] as String,
    );
  }
}
