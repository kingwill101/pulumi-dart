...
class InboundSsoAssignmentArgs {
  ...
  factory InboundSsoAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return InboundSsoAssignmentArgs(
      ...
      samlSsoInfo: map['samlSsoInfo'] == null ? null : SamlSsoInfo.fromMap((map['samlSsoInfo'] as Map).cast<String, dynamic>()),
      signInBehavior: map['signInBehavior'] == null ? null : SignInBehavior.fromMap((map['signInBehavior'] as Map).cast<String, dynamic>()),
      ssoMode: map['ssoMode'] == null ? null : InboundSsoAssignmentSsoMode.fromValue(map['ssoMode'] as String),
