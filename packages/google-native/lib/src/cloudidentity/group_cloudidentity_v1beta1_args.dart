...
class GroupCloudidentityV1beta1Args {
  ...
  GroupCloudidentityV1beta1Args({
    String? description,
    String? displayName,
    DynamicGroupMetadataCloudidentityV1beta1? dynamicGroupMetadata,
    required EntityKeyCloudidentityV1beta1 groupKey,
    required String initialGroupConfig,
    required Map<String, String> labels,
    required String parent,
    List<PosixGroup>? posixGroups,
  }) :
  ...
  factory GroupCloudidentityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return GroupCloudidentityV1beta1Args(
      ...
      dynamicGroupMetadata: map['dynamicGroupMetadata'] == null ? null : DynamicGroupMetadataCloudidentityV1beta1.fromMap((map['dynamicGroupMetadata'] as Map).cast<String, dynamic>()),
      groupKey: EntityKeyCloudidentityV1beta1.fromMap((map['groupKey'] as Map).cast<String, dynamic>()),
      initialGroupConfig: map['initialGroupConfig'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      parent: map['parent'] as String,
      posixGroups: map['posixGroups'] == null ? null : pulumi.Input.decodeList<PosixGroup>(map['posixGroups'], (value) => PosixGroup.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
