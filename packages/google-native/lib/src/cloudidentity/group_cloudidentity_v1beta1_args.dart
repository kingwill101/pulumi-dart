  ...
  GroupCloudidentityV1beta1Args({
    ...
    List<PosixGroup>? posixGroups,
        ...
        dynamicGroupMetadata = pulumi.Input.asOptionalInput<
            DynamicGroupMetadataCloudidentityV1beta1>(dynamicGroupMetadata),
        groupKey =
            pulumi.Input.asInput<EntityKeyCloudidentityV1beta1>(groupKey),
        ...
        posixGroups =
            pulumi.Input.asOptionalInput<List<PosixGroup>>(posixGroups);
