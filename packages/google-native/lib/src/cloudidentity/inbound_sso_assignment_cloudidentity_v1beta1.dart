...
class InboundSsoAssignmentCloudidentityV1beta1 extends pulumi.CustomResource {
  ...
  InboundSsoAssignmentCloudidentityV1beta1(
    ...
    this.samlSsoInfo = registerOutput<SamlSsoInfoResponseCloudidentityV1beta1>('samlSsoInfo');
    this.signInBehavior = registerOutput<SignInBehaviorResponseCloudidentityV1beta1>('signInBehavior');
