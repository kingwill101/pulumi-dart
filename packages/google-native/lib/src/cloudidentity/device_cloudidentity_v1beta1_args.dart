...
class DeviceCloudidentityV1beta1Args {
  ...
  factory DeviceCloudidentityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DeviceCloudidentityV1beta1Args(
      ...
      clientTypes: map['clientTypes'] == null ? null : pulumi.Input.decodeList<DeviceClientTypesItem>(map['clientTypes'], (value) => DeviceClientTypesItem.fromValue(value as String)),
