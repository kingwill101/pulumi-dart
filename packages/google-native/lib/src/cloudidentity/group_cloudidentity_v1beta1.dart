...
class GroupCloudidentityV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EntityKeyResponseCloudidentityV1beta1>> additionalGroupKeys;
  ...
  GroupCloudidentityV1beta1(
    ...
    this.additionalGroupKeys = registerOutput<List<EntityKeyResponseCloudidentityV1beta1>>('additionalGroupKeys');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.dynamicGroupMetadata = registerOutput<DynamicGroupMetadataResponseCloudidentityV1beta1>('dynamicGroupMetadata');
    this.groupKey = registerOutput<EntityKeyResponseCloudidentityV1beta1>('groupKey');
