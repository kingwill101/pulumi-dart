...
class GetMembershipCloudidentityV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'memberKey': memberKey.toMap(),
      'name': name,
      'preferredMemberKey': preferredMemberKey.toMap(),
      'roles': pulumi.Input.encodeList<MembershipRoleResponseCloudidentityV1beta1, Map<String, dynamic>>(roles, (value) => value.toMap()),
      'type': type,
      'updateTime': updateTime,
    };
  }

  factory GetMembershipCloudidentityV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetMembershipCloudidentityV1beta1Result(
      createTime: map['createTime'] as String,
      deliverySetting: map['deliverySetting'] as String,
      memberKey: EntityKeyResponseCloudidentityV1beta1.fromMap((map['memberKey'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      preferredMemberKey: EntityKeyResponseCloudidentityV1beta1.fromMap((map['preferredMemberKey'] as Map).cast<String, dynamic>()),
      roles: pulumi.Input.decodeList<MembershipRoleResponseCloudidentityV1beta1>(map['roles'], (value) => MembershipRoleResponseCloudidentityV1beta1.fromMap((value as Map).cast<String, dynamic>())),
