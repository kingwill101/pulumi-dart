...
class GroupArgs {
  ...
  GroupArgs({
    ...
    required String parent,
       ...
       dynamicGroupMetadata = pulumi
           .Input.asOptionalInput<DynamicGroupMetadata>(dynamicGroupMetadata),
       groupKey = pulumi.Input.asInput<EntityKey>(groupKey),
       initialGroupConfig = pulumi.Input.asOptionalInput<String>(
         initialGroupConfig,
       ),
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      groupKey: EntityKey.fromMap(
        (map['groupKey'] as Map).cast<String, dynamic>(),
      ),
      initialGroupConfig: map['initialGroupConfig'] == null
          ? null
