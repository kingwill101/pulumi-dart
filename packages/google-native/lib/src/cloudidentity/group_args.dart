...
class GroupArgs {
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      dynamicGroupMetadata: map['dynamicGroupMetadata'] == null ? null : DynamicGroupMetadata.fromMap((map['dynamicGroupMetadata'] as Map).cast<String, dynamic>()),
      groupKey: EntityKey.fromMap((map['groupKey'] as Map).cast<String, dynamic>()),
      initialGroupConfig: map['initialGroupConfig'] == null ? null : map['initialGroupConfig'] as String,
