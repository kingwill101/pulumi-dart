...
class GoogleCloudRecommendationengineV1beta1ProductCatalogItem {
  ...
  final GoogleCloudRecommendationengineV1beta1ProductCatalogItemExactPrice? exactPrice;
  /// Optional. Product images for the catalog item.
  final List<GoogleCloudRecommendationengineV1beta1Image>? images;
  /// Optional. The product price range.
  final GoogleCloudRecommendationengineV1beta1ProductCatalogItemPriceRange? priceRange;
  /// Optional. Online stock state of the catalog item. Default is `IN_STOCK`.
  final GoogleCloudRecommendationengineV1beta1ProductCatalogItemStockState? stockState;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exactPrice': ?exactPrice == null ? null : exactPrice!.toMap(),
      'images': ?images == null ? null : pulumi.Input.encodeList<GoogleCloudRecommendationengineV1beta1Image, Map<String, dynamic>>(images!, (value) => value.toMap()),
      'priceRange': ?priceRange == null ? null : priceRange!.toMap(),
      'stockState': ?stockState == null ? null : stockState!.value,
    };
  }
  ...
  factory GoogleCloudRecommendationengineV1beta1ProductCatalogItem.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecommendationengineV1beta1ProductCatalogItem(
      availableQuantity: map['availableQuantity'] == null ? null : map['availableQuantity'] as String,
      canonicalProductUri: map['canonicalProductUri'] == null ? null : map['canonicalProductUri'] as String,
      costs: map['costs'] == null ? null : (map['costs'] as Map).cast<String, String>(),
      currencyCode: map['currencyCode'] == null ? null : map['currencyCode'] as String,
      exactPrice: map['exactPrice'] == null ? null : GoogleCloudRecommendationengineV1beta1ProductCatalogItemExactPrice.fromMap((map['exactPrice'] as Map).cast<String, dynamic>()),
      images: map['images'] == null ? null : pulumi.Input.decodeList<GoogleCloudRecommendationengineV1beta1Image>(map['images'], (value) => GoogleCloudRecommendationengineV1beta1Image.fromMap((value as Map).cast<String, dynamic>())),
      priceRange: map['priceRange'] == null ? null : GoogleCloudRecommendationengineV1beta1ProductCatalogItemPriceRange.fromMap((map['priceRange'] as Map).cast<String, dynamic>()),
      stockState: map['stockState'] == null ? null : GoogleCloudRecommendationengineV1beta1ProductCatalogItemStockState.fromValue(map['stockState'] as String),
    );
  }
}
