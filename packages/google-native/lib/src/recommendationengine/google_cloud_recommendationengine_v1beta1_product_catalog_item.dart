...
class GoogleCloudRecommendationengineV1beta1ProductCatalogItem {
  ...
  factory GoogleCloudRecommendationengineV1beta1ProductCatalogItem.fromMap(
    ...
    return GoogleCloudRecommendationengineV1beta1ProductCatalogItem(
      ...
      currencyCode: map['currencyCode'] == null
          ? null
          : map['currencyCode'] as String,
      exactPrice: map['exactPrice'] == null
          ? null
          : GoogleCloudRecommendationengineV1beta1ProductCatalogItemExactPrice.fromMap(
      ...
      priceRange: map['priceRange'] == null
          ? null
          : GoogleCloudRecommendationengineV1beta1ProductCatalogItemPriceRange.fromMap(
              (map['priceRange'] as Map).cast<String, dynamic>(),
            ),
      stockState: map['stockState'] == null
          ? null
          : GoogleCloudRecommendationengineV1beta1ProductCatalogItemStockState.fromValue(
              map['stockState'] as String,
            ),
    );
  }
}
