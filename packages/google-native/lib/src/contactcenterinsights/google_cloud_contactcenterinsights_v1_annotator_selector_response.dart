...
class GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse {
  ...
  final GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfigResponse summarizationConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'summarizationConfig': summarizationConfig.toMap(),
    };
  }
  ...
  factory GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse(
      ...
      summarizationConfig: GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfigResponse.fromMap((map['summarizationConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
