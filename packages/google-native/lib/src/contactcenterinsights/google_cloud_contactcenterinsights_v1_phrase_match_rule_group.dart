...
class GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup {
  ...
  final List<GoogleCloudContactcenterinsightsV1PhraseMatchRule>? phraseMatchRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'phraseMatchRules': ?phraseMatchRules == null ? null : pulumi.Input.encodeList<GoogleCloudContactcenterinsightsV1PhraseMatchRule, Map<String, dynamic>>(phraseMatchRules!, (value) => value.toMap()),
      'type': type.value,
    };
  }
  ...
  factory GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup(
      phraseMatchRules: map['phraseMatchRules'] == null ? null : pulumi.Input.decodeList<GoogleCloudContactcenterinsightsV1PhraseMatchRule>(map['phraseMatchRules'], (value) => GoogleCloudContactcenterinsightsV1PhraseMatchRule.fromMap((value as Map).cast<String, dynamic>())),
      type: GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroupType.fromValue(map['type'] as String),
    );
  }
}
