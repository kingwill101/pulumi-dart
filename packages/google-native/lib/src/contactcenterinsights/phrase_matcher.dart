...
class PhraseMatcher extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroupResponse>> phraseMatchRuleGroups;
  ...
  PhraseMatcher(
    ...
    this.phraseMatchRuleGroups = registerOutput<List<GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroupResponse>>('phraseMatchRuleGroups');
