...
class ConversationArgs {
  ...
  factory ConversationArgs.fromMap(Map<String, dynamic> map) {
    return ConversationArgs(
      ...
      callMetadata: map['callMetadata'] == null ? null : GoogleCloudContactcenterinsightsV1ConversationCallMetadata.fromMap((map['callMetadata'] as Map).cast<String, dynamic>()),
      conversationId: map['conversationId'] == null ? null : map['conversationId'] as String,
      dataSource: map['dataSource'] == null ? null : GoogleCloudContactcenterinsightsV1ConversationDataSource.fromMap((map['dataSource'] as Map).cast<String, dynamic>()),
      ...
      medium: map['medium'] == null ? null : ConversationMedium.fromValue(map['medium'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      obfuscatedUserId: map['obfuscatedUserId'] == null ? null : map['obfuscatedUserId'] as String,
