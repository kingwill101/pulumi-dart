...
class GoogleCloudContactcenterinsightsV1IssueMatchDataResponse {
  ...
  final GoogleCloudContactcenterinsightsV1IssueAssignmentResponse issueAssignment;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'issueAssignment': issueAssignment.toMap(),
    };
  }
  ...
  factory GoogleCloudContactcenterinsightsV1IssueMatchDataResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1IssueMatchDataResponse(
      issueAssignment: GoogleCloudContactcenterinsightsV1IssueAssignmentResponse.fromMap((map['issueAssignment'] as Map).cast<String, dynamic>()),
    );
  }
}
