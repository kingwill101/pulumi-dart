...
class PhraseMatcherArgs {
  ...
  PhraseMatcherArgs({
    ...
    String? versionTag,
        ...
        roleMatch =
            pulumi.Input.asOptionalInput<PhraseMatcherRoleMatch>(roleMatch),
    ...
    return PhraseMatcherArgs(
      ...
      phraseMatchRuleGroups: map['phraseMatchRuleGroups'] == null
          ...
          : pulumi.Input.decodeList<
              ...
              (value) => GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup
      ...
      versionTag:
          map['versionTag'] == null ? null : map['versionTag'] as String,
    );
  }
}
