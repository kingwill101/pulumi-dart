...
class PhraseMatcherArgs {
  ...
  PhraseMatcherArgs({
    ...
    String? location,
    String? name,
    List<GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup>? phraseMatchRuleGroups,
    String? project,
  ...
  factory PhraseMatcherArgs.fromMap(Map<String, dynamic> map) {
    return PhraseMatcherArgs(
      ...
      phraseMatchRuleGroups: map['phraseMatchRuleGroups'] == null ? null : pulumi.Input.decodeList<GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup>(map['phraseMatchRuleGroups'], (value) => GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      roleMatch: map['roleMatch'] == null ? null : PhraseMatcherRoleMatch.fromValue(map['roleMatch'] as String),
