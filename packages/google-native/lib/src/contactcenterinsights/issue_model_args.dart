...
class IssueModelArgs {
  ...
  factory IssueModelArgs.fromMap(Map<String, dynamic> map) {
    return IssueModelArgs(
      ...
      inputDataConfig: map['inputDataConfig'] == null ? null : GoogleCloudContactcenterinsightsV1IssueModelInputDataConfig.fromMap((map['inputDataConfig'] as Map).cast<String, dynamic>()),
      languageCode: map['languageCode'] == null ? null : map['languageCode'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      modelType: map['modelType'] == null ? null : IssueModelModelType.fromValue(map['modelType'] as String),
