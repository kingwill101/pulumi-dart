...
class Detail {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'affectedVersionEnd': ?affectedVersionEnd == null ? null : affectedVersionEnd!.toMap(),
      'affectedVersionStart': ?affectedVersionStart == null ? null : affectedVersionStart!.toMap(),
      'description': ?description,
      'fixedCpeUri': ?fixedCpeUri,
      'fixedPackage': ?fixedPackage,
      'fixedVersion': ?fixedVersion == null ? null : fixedVersion!.toMap(),
  ...
  factory Detail.fromMap(Map<String, dynamic> map) {
    return Detail(
      ...
      affectedVersionEnd: map['affectedVersionEnd'] == null ? null : Version.fromMap((map['affectedVersionEnd'] as Map).cast<String, dynamic>()),
      affectedVersionStart: map['affectedVersionStart'] == null ? null : Version.fromMap((map['affectedVersionStart'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      fixedCpeUri: map['fixedCpeUri'] == null ? null : map['fixedCpeUri'] as String,
      fixedPackage: map['fixedPackage'] == null ? null : map['fixedPackage'] as String,
      fixedVersion: map['fixedVersion'] == null ? null : Version.fromMap((map['fixedVersion'] as Map).cast<String, dynamic>()),
