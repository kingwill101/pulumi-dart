...
class Detail {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'affectedVersionEnd': ?affectedVersionEnd == null
          ? null
          : affectedVersionEnd!.toMap(),
      'affectedVersionStart': ?affectedVersionStart == null
          ? null
          : affectedVersionStart!.toMap(),
  ...
  factory Detail.fromMap(Map<String, dynamic> map) {
    return Detail(
      ...
      fixedCpeUri: map['fixedCpeUri'] == null
          ? null
          : map['fixedCpeUri'] as String,
      fixedPackage: map['fixedPackage'] == null
          ? null
          : map['fixedPackage'] as String,
