...
class DocumentOccurrenceResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['creatorComment'] = creatorComment;
    map['creators'] = creators;
    map['documentComment'] = documentComment;
    map['externalDocumentRefs'] = externalDocumentRefs;
    map['licenseListVersion'] = licenseListVersion;
