...
class SlsaRecipeResponse {
  ...
  /// Creates a new [SlsaRecipeResponse].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['definedInMaterial'] = definedInMaterial;
  ...
  factory SlsaRecipeResponse.fromMap(Map<String, dynamic> map) {
    return SlsaRecipeResponse(
      arguments: (map['arguments'] as Map).cast<String, String>(),
