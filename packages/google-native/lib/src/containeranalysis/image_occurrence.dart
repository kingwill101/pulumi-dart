...
class ImageOccurrence {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layerInfo': ?layerInfo == null ? null : pulumi.Input.encodeList<Layer, Map<String, dynamic>>(layerInfo!, (value) => value.toMap()),
    };
  }

  factory ImageOccurrence.fromMap(Map<String, dynamic> map) {
    return ImageOccurrence(
      fingerprint: Fingerprint.fromMap((map['fingerprint'] as Map).cast<String, dynamic>()),
      layerInfo: map['layerInfo'] == null ? null : pulumi.Input.decodeList<Layer>(map['layerInfo'], (value) => Layer.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
