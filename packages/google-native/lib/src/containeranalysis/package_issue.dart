...
class PackageIssue {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileLocation': ?fileLocation == null ? null : pulumi.Input.encodeList<GrafeasV1FileLocation, Map<String, dynamic>>(fileLocation!, (value) => value.toMap()),
  ...
  factory PackageIssue.fromMap(Map<String, dynamic> map) {
    return PackageIssue(
      ...
      affectedVersion: Version.fromMap((map['affectedVersion'] as Map).cast<String, dynamic>()),
      fileLocation: map['fileLocation'] == null ? null : pulumi.Input.decodeList<GrafeasV1FileLocation>(map['fileLocation'], (value) => GrafeasV1FileLocation.fromMap((value as Map).cast<String, dynamic>())),
      ...
      fixedVersion: Version.fromMap((map['fixedVersion'] as Map).cast<String, dynamic>()),
