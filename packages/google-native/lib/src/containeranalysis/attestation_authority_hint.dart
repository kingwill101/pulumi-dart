...
class AttestationAuthorityHint {
  ...
  Map<String, dynamic> toMap() {
    ...
    final humanReadableNameValue = humanReadableName;
    if (humanReadableNameValue != null) {
      map['humanReadableName'] = humanReadableNameValue;
    }
    return map;
  }
  ...
  factory AttestationAuthorityHint.fromMap(Map<String, dynamic> map) {
    return AttestationAuthorityHint(
      humanReadableName: map['humanReadableName'] == null
          ? null
