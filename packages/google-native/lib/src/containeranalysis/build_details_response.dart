...
class BuildDetailsResponse {
  ...
  final InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1
  ...
  factory BuildDetailsResponse.fromMap(Map<String, dynamic> map) {
    return BuildDetailsResponse(
      inTotoSlsaProvenanceV1:
          InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1.fromMap(
              (map['inTotoSlsaProvenanceV1'] as Map).cast<String, dynamic>()),
      intotoProvenance:
          InTotoProvenanceResponseContaineranalysisV1alpha1.fromMap(
              (map['intotoProvenance'] as Map).cast<String, dynamic>()),
      intotoStatement: InTotoStatementResponseContaineranalysisV1alpha1.fromMap(
          (map['intotoStatement'] as Map).cast<String, dynamic>()),
      provenance: BuildProvenanceResponseContaineranalysisV1alpha1.fromMap(
