...
class GoogleDevtoolsContaineranalysisV1alpha1SourceContext {
  ...
  final GoogleDevtoolsContaineranalysisV1alpha1CloudRepoSourceContext? cloudRepo;
  ...
  factory GoogleDevtoolsContaineranalysisV1alpha1SourceContext.fromMap(Map<String, dynamic> map) {
    return GoogleDevtoolsContaineranalysisV1alpha1SourceContext(
      cloudRepo: map['cloudRepo'] == null ? null : GoogleDevtoolsContaineranalysisV1alpha1CloudRepoSourceContext.fromMap((map['cloudRepo'] as Map).cast<String, dynamic>()),
      gerrit: map['gerrit'] == null ? null : GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext.fromMap((map['gerrit'] as Map).cast<String, dynamic>()),
      git: map['git'] == null ? null : GoogleDevtoolsContaineranalysisV1alpha1GitSourceContext.fromMap((map['git'] as Map).cast<String, dynamic>()),
