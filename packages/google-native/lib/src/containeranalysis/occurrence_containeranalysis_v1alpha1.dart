...
class OccurrenceContaineranalysisV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<ComplianceOccurrenceResponseContaineranalysisV1alpha1> compliance;
  ...
  late final pulumi
      .Output<DSSEAttestationOccurrenceResponseContaineranalysisV1alpha1>
      dsseAttestation;
  ...
  late final pulumi
      .Output<SBOMReferenceOccurrenceResponseContaineranalysisV1alpha1>
      sbomReference;
  ...
  OccurrenceContaineranalysisV1alpha1(
    ...
    this.dsseAttestation = registerOutput<
            DSSEAttestationOccurrenceResponseContaineranalysisV1alpha1>(
        'dsseAttestation');
    this.envelope =
        registerOutput<EnvelopeResponseContaineranalysisV1alpha1>('envelope');
    ...
    this.sbomReference = registerOutput<
