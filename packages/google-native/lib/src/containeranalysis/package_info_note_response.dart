...
class PackageInfoNoteResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'externalRefs': pulumi.Input.encodeList<ExternalRefResponse, Map<String, dynamic>>(externalRefs, (value) => value.toMap()),
  ...
  factory PackageInfoNoteResponse.fromMap(Map<String, dynamic> map) {
    return PackageInfoNoteResponse(
      ...
      externalRefs: pulumi.Input.decodeList<ExternalRefResponse>(map['externalRefs'], (value) => ExternalRefResponse.fromMap((value as Map).cast<String, dynamic>())),
      filesLicenseInfo: (map['filesLicenseInfo'] as List).cast<String>(),
      homePage: map['homePage'] as String,
      licenseDeclared: LicenseResponseContaineranalysisV1alpha1.fromMap((map['licenseDeclared'] as Map).cast<String, dynamic>()),
