...
/// {@template pulumi_containeranalysis_v1beta1_note_iam_binding_containeranalysis_v1beta1_args_doc}
/// The set of arguments for NoteIamBinding.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1beta1_note_iam_binding_containeranalysis_v1beta1_args_doc}
class NoteIamBindingContaineranalysisV1beta1Args {
  ...
  /// Creates a new [NoteIamBindingContaineranalysisV1beta1Args].
  ...
  NoteIamBindingContaineranalysisV1beta1Args({
    Condition? condition,
  ...
  factory NoteIamBindingContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NoteIamBindingContaineranalysisV1beta1Args(
