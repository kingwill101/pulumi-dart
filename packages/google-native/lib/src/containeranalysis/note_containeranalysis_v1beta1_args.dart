...
class NoteContaineranalysisV1beta1Args {
  ...
  NoteContaineranalysisV1beta1Args({
    ...
    VulnerabilityAssessmentNoteContaineranalysisV1beta1? vulnerabilityAssessment,
  }) :
  ...
  factory NoteContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NoteContaineranalysisV1beta1Args(
      attestationAuthority: map['attestationAuthority'] == null ? null : Authority.fromMap((map['attestationAuthority'] as Map).cast<String, dynamic>()),
      baseImage: map['baseImage'] == null ? null : BasisContaineranalysisV1beta1.fromMap((map['baseImage'] as Map).cast<String, dynamic>()),
      build: map['build'] == null ? null : Build.fromMap((map['build'] as Map).cast<String, dynamic>()),
      deployable: map['deployable'] == null ? null : DeployableContaineranalysisV1beta1.fromMap((map['deployable'] as Map).cast<String, dynamic>()),
      discovery: map['discovery'] == null ? null : DiscoveryContaineranalysisV1beta1.fromMap((map['discovery'] as Map).cast<String, dynamic>()),
      expirationTime: map['expirationTime'] == null ? null : map['expirationTime'] as String,
      intoto: map['intoto'] == null ? null : InToto.fromMap((map['intoto'] as Map).cast<String, dynamic>()),
      longDescription: map['longDescription'] == null ? null : map['longDescription'] as String,
      noteId: map['noteId'] as String,
      package: map['package'] == null ? null : PackageContaineranalysisV1beta1.fromMap((map['package'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      relatedNoteNames: map['relatedNoteNames'] == null ? null : (map['relatedNoteNames'] as List).cast<String>(),
      relatedUrl: map['relatedUrl'] == null ? null : pulumi.Input.decodeList<RelatedUrlContaineranalysisV1beta1>(map['relatedUrl'], (value) => RelatedUrlContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      sbom: map['sbom'] == null ? null : DocumentNoteContaineranalysisV1beta1.fromMap((map['sbom'] as Map).cast<String, dynamic>()),
      sbomReference: map['sbomReference'] == null ? null : SBOMReferenceNoteContaineranalysisV1beta1.fromMap((map['sbomReference'] as Map).cast<String, dynamic>()),
      shortDescription: map['shortDescription'] == null ? null : map['shortDescription'] as String,
      spdxFile: map['spdxFile'] == null ? null : FileNoteContaineranalysisV1beta1.fromMap((map['spdxFile'] as Map).cast<String, dynamic>()),
      spdxPackage: map['spdxPackage'] == null ? null : PackageInfoNoteContaineranalysisV1beta1.fromMap((map['spdxPackage'] as Map).cast<String, dynamic>()),
      spdxRelationship: map['spdxRelationship'] == null ? null : RelationshipNoteContaineranalysisV1beta1.fromMap((map['spdxRelationship'] as Map).cast<String, dynamic>()),
      vulnerability: map['vulnerability'] == null ? null : Vulnerability.fromMap((map['vulnerability'] as Map).cast<String, dynamic>()),
      vulnerabilityAssessment: map['vulnerabilityAssessment'] == null ? null : VulnerabilityAssessmentNoteContaineranalysisV1beta1.fromMap((map['vulnerabilityAssessment'] as Map).cast<String, dynamic>()),
    );
  }
}
