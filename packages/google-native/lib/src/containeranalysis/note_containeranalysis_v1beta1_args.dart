  ...
  NoteContaineranalysisV1beta1Args({
    ...
    VulnerabilityAssessmentNoteContaineranalysisV1beta1?
        vulnerabilityAssessment,
            ...
            pulumi.Input.asOptionalInput<Authority>(attestationAuthority),
        ...
        relatedUrl = pulumi.Input.asOptionalInput<
            List<RelatedUrlContaineranalysisV1beta1>>(relatedUrl),
        sbom =
            pulumi.Input.asOptionalInput<DocumentNoteContaineranalysisV1beta1>(
                sbom),
        ...
        spdxFile =
            pulumi.Input.asOptionalInput<FileNoteContaineranalysisV1beta1>(
                spdxFile),
        ...
        spdxRelationship = pulumi.Input.asOptionalInput<
            RelationshipNoteContaineranalysisV1beta1>(spdxRelationship),
        vulnerability =
            pulumi.Input.asOptionalInput<Vulnerability>(vulnerability),
