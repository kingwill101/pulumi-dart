...
class NoteContaineranalysisV1beta1 extends pulumi.CustomResource {
  ...
  NoteContaineranalysisV1beta1(
    ...
    this.attestationAuthority = registerOutput<AuthorityResponse>(
      'attestationAuthority',
    );
    this.baseImage = registerOutput<BasisResponseContaineranalysisV1beta1>(
      'baseImage',
    );
    ...
    this.discovery = registerOutput<DiscoveryResponseContaineranalysisV1beta1>(
      'discovery',
    );
    ...
    this.package = registerOutput<PackageResponseContaineranalysisV1beta1>(
      'package',
    );
    ...
    this.sbom = registerOutput<DocumentNoteResponseContaineranalysisV1beta1>(
      'sbom',
    );
    this.sbomReference =
    ...
    this.spdxFile = registerOutput<FileNoteResponseContaineranalysisV1beta1>(
      'spdxFile',
    );
    this.spdxPackage =
