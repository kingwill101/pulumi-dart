...
class NoteContaineranalysisV1alpha1Args {
  ...
  NoteContaineranalysisV1alpha1Args({
    ...
    VulnerabilityAssessmentNoteContaineranalysisV1alpha1? vulnerabilityAssessment,
    VulnerabilityType? vulnerabilityType,
  }) :
      attestationAuthority = pulumi.Input.asOptionalInput<AttestationAuthority>(attestationAuthority),
      baseImage = pulumi.Input.asOptionalInput<Basis>(baseImage),
      buildType = pulumi.Input.asOptionalInput<BuildType>(buildType),
      compliance = pulumi.Input.asOptionalInput<ComplianceNoteContaineranalysisV1alpha1>(compliance),
      deployable = pulumi.Input.asOptionalInput<Deployable>(deployable),
      discovery = pulumi.Input.asOptionalInput<Discovery>(discovery),
      dsseAttestation = pulumi.Input.asOptionalInput<DSSEAttestationNoteContaineranalysisV1alpha1>(dsseAttestation),
      ...
      relatedUrl = pulumi.Input.asOptionalInput<List<RelatedUrlContaineranalysisV1alpha1>>(relatedUrl),
      sbom = pulumi.Input.asOptionalInput<DocumentNote>(sbom),
      sbomReference = pulumi.Input.asOptionalInput<SBOMReferenceNoteContaineranalysisV1alpha1>(sbomReference),
      ...
      spdxRelationship = pulumi.Input.asOptionalInput<RelationshipNote>(spdxRelationship),
      upgrade = pulumi.Input.asOptionalInput<UpgradeNoteContaineranalysisV1alpha1>(upgrade),
      vulnerabilityAssessment = pulumi.Input.asOptionalInput<VulnerabilityAssessmentNoteContaineranalysisV1alpha1>(vulnerabilityAssessment),
      vulnerabilityType = pulumi.Input.asOptionalInput<VulnerabilityType>(vulnerabilityType);
  ...
  factory NoteContaineranalysisV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return NoteContaineranalysisV1alpha1Args(
      attestationAuthority: map['attestationAuthority'] == null ? null : AttestationAuthority.fromMap((map['attestationAuthority'] as Map).cast<String, dynamic>()),
      baseImage: map['baseImage'] == null ? null : Basis.fromMap((map['baseImage'] as Map).cast<String, dynamic>()),
      buildType: map['buildType'] == null ? null : BuildType.fromMap((map['buildType'] as Map).cast<String, dynamic>()),
      compliance: map['compliance'] == null ? null : ComplianceNoteContaineranalysisV1alpha1.fromMap((map['compliance'] as Map).cast<String, dynamic>()),
      deployable: map['deployable'] == null ? null : Deployable.fromMap((map['deployable'] as Map).cast<String, dynamic>()),
      discovery: map['discovery'] == null ? null : Discovery.fromMap((map['discovery'] as Map).cast<String, dynamic>()),
      dsseAttestation: map['dsseAttestation'] == null ? null : DSSEAttestationNoteContaineranalysisV1alpha1.fromMap((map['dsseAttestation'] as Map).cast<String, dynamic>()),
      ...
      package: map['package'] == null ? null : Package.fromMap((map['package'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      relatedUrl: map['relatedUrl'] == null ? null : pulumi.Input.decodeList<RelatedUrlContaineranalysisV1alpha1>(map['relatedUrl'], (value) => RelatedUrlContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      sbom: map['sbom'] == null ? null : DocumentNote.fromMap((map['sbom'] as Map).cast<String, dynamic>()),
      sbomReference: map['sbomReference'] == null ? null : SBOMReferenceNoteContaineranalysisV1alpha1.fromMap((map['sbomReference'] as Map).cast<String, dynamic>()),
      shortDescription: map['shortDescription'] == null ? null : map['shortDescription'] as String,
      spdxFile: map['spdxFile'] == null ? null : FileNote.fromMap((map['spdxFile'] as Map).cast<String, dynamic>()),
      spdxPackage: map['spdxPackage'] == null ? null : PackageInfoNote.fromMap((map['spdxPackage'] as Map).cast<String, dynamic>()),
      spdxRelationship: map['spdxRelationship'] == null ? null : RelationshipNote.fromMap((map['spdxRelationship'] as Map).cast<String, dynamic>()),
      upgrade: map['upgrade'] == null ? null : UpgradeNoteContaineranalysisV1alpha1.fromMap((map['upgrade'] as Map).cast<String, dynamic>()),
      vulnerabilityAssessment: map['vulnerabilityAssessment'] == null ? null : VulnerabilityAssessmentNoteContaineranalysisV1alpha1.fromMap((map['vulnerabilityAssessment'] as Map).cast<String, dynamic>()),
      vulnerabilityType: map['vulnerabilityType'] == null ? null : VulnerabilityType.fromMap((map['vulnerabilityType'] as Map).cast<String, dynamic>()),
    );
  }
}
