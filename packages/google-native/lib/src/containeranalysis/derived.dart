...
class Derived {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layerInfo': ?layerInfo == null ? null : pulumi.Input.encodeList<LayerContaineranalysisV1alpha1, Map<String, dynamic>>(layerInfo!, (value) => value.toMap()),
    };
  }
  ...
  factory Derived.fromMap(Map<String, dynamic> map) {
    return Derived(
      ...
      layerInfo: map['layerInfo'] == null ? null : pulumi.Input.decodeList<LayerContaineranalysisV1alpha1>(map['layerInfo'], (value) => LayerContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
