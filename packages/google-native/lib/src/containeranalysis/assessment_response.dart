...
class AssessmentResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'relatedUris': pulumi.Input.encodeList<RelatedUrlResponse, Map<String, dynamic>>(relatedUris, (value) => value.toMap()),
      'remediations': pulumi.Input.encodeList<RemediationResponse, Map<String, dynamic>>(remediations, (value) => value.toMap()),
  ...
  factory AssessmentResponse.fromMap(Map<String, dynamic> map) {
    return AssessmentResponse(
      ...
      justification: JustificationResponse.fromMap((map['justification'] as Map).cast<String, dynamic>()),
      longDescription: map['longDescription'] as String,
      relatedUris: pulumi.Input.decodeList<RelatedUrlResponse>(map['relatedUris'], (value) => RelatedUrlResponse.fromMap((value as Map).cast<String, dynamic>())),
      remediations: pulumi.Input.decodeList<RemediationResponse>(map['remediations'], (value) => RemediationResponse.fromMap((value as Map).cast<String, dynamic>())),
