...
class SourceContextResponseContaineranalysisV1beta1 {
  ...
  factory SourceContextResponseContaineranalysisV1beta1.fromMap(
    ...
    return SourceContextResponseContaineranalysisV1beta1(
      cloudRepo: CloudRepoSourceContextResponseContaineranalysisV1beta1.fromMap(
          (map['cloudRepo'] as Map).cast<String, dynamic>()),
      gerrit: GerritSourceContextResponseContaineranalysisV1beta1.fromMap(
          (map['gerrit'] as Map).cast<String, dynamic>()),
      git: GitSourceContextResponseContaineranalysisV1beta1.fromMap(
