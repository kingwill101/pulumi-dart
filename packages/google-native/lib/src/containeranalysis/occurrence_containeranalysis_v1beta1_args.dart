...
class OccurrenceContaineranalysisV1beta1Args {
  ...
  factory OccurrenceContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OccurrenceContaineranalysisV1beta1Args(
      attestation: map['attestation'] == null ? null : Details.fromMap((map['attestation'] as Map).cast<String, dynamic>()),
      build: map['build'] == null ? null : GrafeasV1beta1BuildDetails.fromMap((map['build'] as Map).cast<String, dynamic>()),
      deployment: map['deployment'] == null ? null : GrafeasV1beta1DeploymentDetails.fromMap((map['deployment'] as Map).cast<String, dynamic>()),
      derivedImage: map['derivedImage'] == null ? null : GrafeasV1beta1ImageDetails.fromMap((map['derivedImage'] as Map).cast<String, dynamic>()),
      discovered: map['discovered'] == null ? null : GrafeasV1beta1DiscoveryDetails.fromMap((map['discovered'] as Map).cast<String, dynamic>()),
      envelope: map['envelope'] == null ? null : EnvelopeContaineranalysisV1beta1.fromMap((map['envelope'] as Map).cast<String, dynamic>()),
      installation: map['installation'] == null ? null : GrafeasV1beta1PackageDetails.fromMap((map['installation'] as Map).cast<String, dynamic>()),
      intoto: map['intoto'] == null ? null : GrafeasV1beta1IntotoDetails.fromMap((map['intoto'] as Map).cast<String, dynamic>()),
      noteName: map['noteName'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      remediation: map['remediation'] == null ? null : map['remediation'] as String,
      resource: ResourceContaineranalysisV1beta1.fromMap((map['resource'] as Map).cast<String, dynamic>()),
      sbom: map['sbom'] == null ? null : DocumentOccurrenceContaineranalysisV1beta1.fromMap((map['sbom'] as Map).cast<String, dynamic>()),
      sbomReference: map['sbomReference'] == null ? null : SBOMReferenceOccurrenceContaineranalysisV1beta1.fromMap((map['sbomReference'] as Map).cast<String, dynamic>()),
      spdxFile: map['spdxFile'] == null ? null : FileOccurrenceContaineranalysisV1beta1.fromMap((map['spdxFile'] as Map).cast<String, dynamic>()),
      spdxPackage: map['spdxPackage'] == null ? null : PackageInfoOccurrenceContaineranalysisV1beta1.fromMap((map['spdxPackage'] as Map).cast<String, dynamic>()),
      spdxRelationship: map['spdxRelationship'] == null ? null : RelationshipOccurrenceContaineranalysisV1beta1.fromMap((map['spdxRelationship'] as Map).cast<String, dynamic>()),
      vulnerability: map['vulnerability'] == null ? null : GrafeasV1beta1VulnerabilityDetails.fromMap((map['vulnerability'] as Map).cast<String, dynamic>()),
    );
  }
}
