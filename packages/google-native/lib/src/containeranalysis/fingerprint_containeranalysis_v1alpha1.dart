...
class FingerprintContaineranalysisV1alpha1 {
  ...
  FingerprintContaineranalysisV1alpha1({this.v1Name, this.v2Blob});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'v1Name': ?v1Name, 'v2Blob': ?v2Blob};
  }

  factory FingerprintContaineranalysisV1alpha1.fromMap(
    Map<String, dynamic> map,
  ) {
    return FingerprintContaineranalysisV1alpha1(
      v1Name: map['v1Name'] == null ? null : map['v1Name'] as String,
      v2Blob: map['v2Blob'] == null
          ? null
          : (map['v2Blob'] as List).cast<String>(),
    );
  }
}
