...
class JustificationContaineranalysisV1beta1 {
  ...
  final JustificationJustificationTypeContaineranalysisV1beta1? justificationType;
  ...
  factory JustificationContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return JustificationContaineranalysisV1beta1(
      ...
      justificationType: map['justificationType'] == null ? null : JustificationJustificationTypeContaineranalysisV1beta1.fromValue(map['justificationType'] as String),
    );
  }
}
