...
class DocumentOccurrenceContaineranalysisV1beta1 {
  ...
  factory DocumentOccurrenceContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DocumentOccurrenceContaineranalysisV1beta1(
      ...
      creatorComment: map['creatorComment'] == null ? null : map['creatorComment'] as String,
      creators: map['creators'] == null ? null : (map['creators'] as List).cast<String>(),
      documentComment: map['documentComment'] == null ? null : map['documentComment'] as String,
      externalDocumentRefs: map['externalDocumentRefs'] == null ? null : (map['externalDocumentRefs'] as List).cast<String>(),
      id: map['id'] == null ? null : map['id'] as String,
      licenseListVersion: map['licenseListVersion'] == null ? null : map['licenseListVersion'] as String,
