...
class VexAssessmentContaineranalysisV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'noteName': ?noteName,
      'relatedUris': ?relatedUris == null ? null : pulumi.Input.encodeList<URI, Map<String, dynamic>>(relatedUris!, (value) => value.toMap()),
      'remediations': ?remediations == null ? null : pulumi.Input.encodeList<RemediationContaineranalysisV1alpha1, Map<String, dynamic>>(remediations!, (value) => value.toMap()),
  ...
  factory VexAssessmentContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return VexAssessmentContaineranalysisV1alpha1(
      ...
      justification: map['justification'] == null ? null : JustificationContaineranalysisV1alpha1.fromMap((map['justification'] as Map).cast<String, dynamic>()),
      noteName: map['noteName'] == null ? null : map['noteName'] as String,
      relatedUris: map['relatedUris'] == null ? null : pulumi.Input.decodeList<URI>(map['relatedUris'], (value) => URI.fromMap((value as Map).cast<String, dynamic>())),
      remediations: map['remediations'] == null ? null : pulumi.Input.decodeList<RemediationContaineranalysisV1alpha1>(map['remediations'], (value) => RemediationContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      state: map['state'] == null ? null : VexAssessmentStateContaineranalysisV1alpha1.fromValue(map['state'] as String),
