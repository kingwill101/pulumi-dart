...
class Occurrence extends pulumi.CustomResource {
  ...
  Occurrence(
    ...
    this.attestation = registerOutput<AttestationOccurrenceResponse>(
      'attestation',
    );
    this.build = registerOutput<BuildOccurrenceResponse>('build');
    this.compliance = registerOutput<ComplianceOccurrenceResponse>(
      'compliance',
    );
    this.createTime = registerOutput<String>('createTime');
    this.deployment = registerOutput<DeploymentOccurrenceResponse>(
      'deployment',
    );
    this.discovery = registerOutput<DiscoveryOccurrenceResponse>('discovery');
    this.dsseAttestation = registerOutput<DSSEAttestationOccurrenceResponse>(
      'dsseAttestation',
    );
    ...
    this.sbomReference = registerOutput<SBOMReferenceOccurrenceResponse>(
      'sbomReference',
    );
    this.updateTime = registerOutput<String>('updateTime');
    this.upgrade = registerOutput<UpgradeOccurrenceResponse>('upgrade');
    this.vulnerability = registerOutput<VulnerabilityOccurrenceResponse>(
      'vulnerability',
    );
  }
}
