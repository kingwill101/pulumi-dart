...
class DerivedResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layerInfo': pulumi.Input.encodeList<LayerResponseContaineranalysisV1alpha1, Map<String, dynamic>>(layerInfo, (value) => value.toMap()),
    };
  }
  ...
  factory DerivedResponse.fromMap(Map<String, dynamic> map) {
    return DerivedResponse(
      ...
      layerInfo: pulumi.Input.decodeList<LayerResponseContaineranalysisV1alpha1>(map['layerInfo'], (value) => LayerResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
