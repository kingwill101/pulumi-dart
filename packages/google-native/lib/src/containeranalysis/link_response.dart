...
class LinkResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'byproducts': byproducts.toMap(),
      'command': command,
      'environment': environment.toMap(),
      'materials': pulumi.Input.encodeList<GrafeasV1beta1IntotoArtifactResponse, Map<String, dynamic>>(materials, (value) => value.toMap()),
      'products': pulumi.Input.encodeList<GrafeasV1beta1IntotoArtifactResponse, Map<String, dynamic>>(products, (value) => value.toMap()),
    };
  }

  factory LinkResponse.fromMap(Map<String, dynamic> map) {
    return LinkResponse(
      byproducts: ByProductsResponse.fromMap((map['byproducts'] as Map).cast<String, dynamic>()),
      ...
      materials: pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifactResponse>(map['materials'], (value) => GrafeasV1beta1IntotoArtifactResponse.fromMap((value as Map).cast<String, dynamic>())),
      products: pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifactResponse>(map['products'], (value) => GrafeasV1beta1IntotoArtifactResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
