...
class OccurrenceContaineranalysisV1alpha1Args {
  ...
  OccurrenceContaineranalysisV1alpha1Args({
    ...
    ComplianceOccurrenceContaineranalysisV1alpha1? compliance,
    DeploymentType? deployment,
    Derived? derivedImage,
    Discovered? discovered,
    DSSEAttestationOccurrenceContaineranalysisV1alpha1? dsseAttestation,
    EnvelopeContaineranalysisV1alpha1? envelope,
    ...
    SBOMReferenceOccurrenceContaineranalysisV1alpha1? sbomReference,
    ...
    VulnerabilityDetails? vulnerabilityDetails,
        ...
        dsseAttestation = pulumi.Input.asOptionalInput<
            ...
            dsseAttestation),
        envelope =
            pulumi.Input.asOptionalInput<EnvelopeContaineranalysisV1alpha1>(
                envelope),
        ...
        spdxPackage =
            pulumi.Input.asOptionalInput<PackageInfoOccurrence>(spdxPackage),
        spdxRelationship = pulumi.Input.asOptionalInput<RelationshipOccurrence>(
            spdxRelationship),
        upgrade = pulumi.Input.asOptionalInput<
            UpgradeOccurrenceContaineranalysisV1alpha1>(upgrade),
        vulnerabilityDetails =
            pulumi.Input.asOptionalInput<VulnerabilityDetails>(
                vulnerabilityDetails);
