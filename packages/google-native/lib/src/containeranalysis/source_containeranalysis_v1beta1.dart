...
class SourceContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalContexts': ?additionalContexts == null ? null : pulumi.Input.encodeList<SourceContextContaineranalysisV1beta1, Map<String, dynamic>>(additionalContexts!, (value) => value.toMap()),
  ...
  factory SourceContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SourceContaineranalysisV1beta1(
      additionalContexts: map['additionalContexts'] == null ? null : pulumi.Input.decodeList<SourceContextContaineranalysisV1beta1>(map['additionalContexts'], (value) => SourceContextContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      artifactStorageSourceUri: map['artifactStorageSourceUri'] == null ? null : map['artifactStorageSourceUri'] as String,
      context: map['context'] == null ? null : SourceContextContaineranalysisV1beta1.fromMap((map['context'] as Map).cast<String, dynamic>()),
