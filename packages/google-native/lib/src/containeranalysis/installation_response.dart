...
class InstallationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': pulumi.Input.encodeList<LocationResponseContaineranalysisV1alpha1, Map<String, dynamic>>(location, (value) => value.toMap()),
      'name': name,
  ...
  factory InstallationResponse.fromMap(Map<String, dynamic> map) {
    return InstallationResponse(
      ...
      location: pulumi.Input.decodeList<LocationResponseContaineranalysisV1alpha1>(map['location'], (value) => LocationResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
