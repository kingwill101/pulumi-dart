...
class ProvenanceBuilderContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'builderDependencies': ?builderDependencies == null ? null : pulumi.Input.encodeList<ResourceDescriptorContaineranalysisV1beta1, Map<String, dynamic>>(builderDependencies!, (value) => value.toMap()),
      'id': ?id,
      'version': ?version,
    };
  }
  ...
  factory ProvenanceBuilderContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return ProvenanceBuilderContaineranalysisV1beta1(
      builderDependencies: map['builderDependencies'] == null ? null : pulumi.Input.decodeList<ResourceDescriptorContaineranalysisV1beta1>(map['builderDependencies'], (value) => ResourceDescriptorContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
