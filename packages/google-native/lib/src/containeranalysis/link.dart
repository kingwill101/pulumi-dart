...
class Link {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'byproducts': ?byproducts == null ? null : byproducts!.toMap(),
      'command': ?command,
      'environment': ?environment == null ? null : environment!.toMap(),
      'materials': ?materials == null ? null : pulumi.Input.encodeList<GrafeasV1beta1IntotoArtifact, Map<String, dynamic>>(materials!, (value) => value.toMap()),
      'products': ?products == null ? null : pulumi.Input.encodeList<GrafeasV1beta1IntotoArtifact, Map<String, dynamic>>(products!, (value) => value.toMap()),
    };
  }

  factory Link.fromMap(Map<String, dynamic> map) {
    return Link(
      byproducts: map['byproducts'] == null ? null : ByProducts.fromMap((map['byproducts'] as Map).cast<String, dynamic>()),
      ...
      materials: map['materials'] == null ? null : pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifact>(map['materials'], (value) => GrafeasV1beta1IntotoArtifact.fromMap((value as Map).cast<String, dynamic>())),
      products: map['products'] == null ? null : pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifact>(map['products'], (value) => GrafeasV1beta1IntotoArtifact.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
