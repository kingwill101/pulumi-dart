...
class ProductContaineranalysisV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': ?id,
      'identifierHelper': ?identifierHelper == null ? null : identifierHelper!.toMap(),
      'name': ?name,
    };
  }
  ...
  factory ProductContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return ProductContaineranalysisV1alpha1(
      ...
      identifierHelper: map['identifierHelper'] == null ? null : IdentifierHelper.fromMap((map['identifierHelper'] as Map).cast<String, dynamic>()),
