...
class ProvenanceBuilderResponseContaineranalysisV1beta1 {
  final List<ResourceDescriptorResponseContaineranalysisV1beta1> builderDependencies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'builderDependencies': pulumi.Input.encodeList<ResourceDescriptorResponseContaineranalysisV1beta1, Map<String, dynamic>>(builderDependencies, (value) => value.toMap()),
      'version': version,
    };
  }
  ...
  factory ProvenanceBuilderResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return ProvenanceBuilderResponseContaineranalysisV1beta1(
      builderDependencies: pulumi.Input.decodeList<ResourceDescriptorResponseContaineranalysisV1beta1>(map['builderDependencies'], (value) => ResourceDescriptorResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
