...
class NoteContaineranalysisV1alpha1 extends pulumi.CustomResource {
  ...
  NoteContaineranalysisV1alpha1(
    ...
    this.attestationAuthority = registerOutput<AttestationAuthorityResponse>(
    ...
    this.spdxRelationship = registerOutput<RelationshipNoteResponse>(
      'spdxRelationship',
    );
    this.updateTime = registerOutput<String>('updateTime');
    this.upgrade = registerOutput<UpgradeNoteResponseContaineranalysisV1alpha1>(
      'upgrade',
    );
    this.vulnerabilityAssessment =
        registerOutput<
          VulnerabilityAssessmentNoteResponseContaineranalysisV1alpha1
        >('vulnerabilityAssessment');
    this.vulnerabilityType = registerOutput<VulnerabilityTypeResponse>(
      'vulnerabilityType',
    );
  }
}
