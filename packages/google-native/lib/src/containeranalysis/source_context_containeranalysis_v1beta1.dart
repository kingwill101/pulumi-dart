...
class SourceContextContaineranalysisV1beta1 {
  ...
  factory SourceContextContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SourceContextContaineranalysisV1beta1(
      cloudRepo: map['cloudRepo'] == null ? null : CloudRepoSourceContextContaineranalysisV1beta1.fromMap((map['cloudRepo'] as Map).cast<String, dynamic>()),
      gerrit: map['gerrit'] == null ? null : GerritSourceContextContaineranalysisV1beta1.fromMap((map['gerrit'] as Map).cast<String, dynamic>()),
      git: map['git'] == null ? null : GitSourceContextContaineranalysisV1beta1.fromMap((map['git'] as Map).cast<String, dynamic>()),
