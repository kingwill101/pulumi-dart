...
class PgpSignedAttestationContaineranalysisV1beta1 {
  ...
  final PgpSignedAttestationContentTypeContaineranalysisV1beta1? contentType;
  ...
  factory PgpSignedAttestationContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return PgpSignedAttestationContaineranalysisV1beta1(
      contentType: map['contentType'] == null ? null : PgpSignedAttestationContentTypeContaineranalysisV1beta1.fromValue(map['contentType'] as String),
