...
class OccurrenceContaineranalysisV1beta1 extends pulumi.CustomResource {
  ...
  OccurrenceContaineranalysisV1beta1(
    ...
    this.deployment = registerOutput<GrafeasV1beta1DeploymentDetailsResponse>('deployment');
    this.derivedImage = registerOutput<GrafeasV1beta1ImageDetailsResponse>('derivedImage');
    this.discovered = registerOutput<GrafeasV1beta1DiscoveryDetailsResponse>('discovered');
    this.envelope = registerOutput<EnvelopeResponseContaineranalysisV1beta1>('envelope');
    this.installation = registerOutput<GrafeasV1beta1PackageDetailsResponse>('installation');
    ...
    this.resource = registerOutput<ResourceResponseContaineranalysisV1beta1>('resource');
    this.sbom = registerOutput<DocumentOccurrenceResponseContaineranalysisV1beta1>('sbom');
    this.sbomReference = registerOutput<SBOMReferenceOccurrenceResponseContaineranalysisV1beta1>('sbomReference');
    this.spdxFile = registerOutput<FileOccurrenceResponseContaineranalysisV1beta1>('spdxFile');
    this.spdxPackage = registerOutput<PackageInfoOccurrenceResponseContaineranalysisV1beta1>('spdxPackage');
    this.spdxRelationship = registerOutput<RelationshipOccurrenceResponseContaineranalysisV1beta1>('spdxRelationship');
    this.updateTime = registerOutput<String>('updateTime');
    this.vulnerability = registerOutput<GrafeasV1beta1VulnerabilityDetailsResponse>('vulnerability');
  }
}
