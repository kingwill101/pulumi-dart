...
class Note extends pulumi.CustomResource {
  ...
  Note(String name, {NoteArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.dsseAttestation = registerOutput<DSSEAttestationNoteResponse>(
      'dsseAttestation',
    );
    ...
    this.sbomReference = registerOutput<SBOMReferenceNoteResponse>(
      'sbomReference',
    );
    ...
    this.vulnerability = registerOutput<VulnerabilityNoteResponse>(
      'vulnerability',
    );
