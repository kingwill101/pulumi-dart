...
/// {@template pulumi_containeranalysis_v1beta1_occurrence_iam_member_containeranalysis_v1beta1_args_doc}
/// The set of arguments for OccurrenceIamMember.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1beta1_occurrence_iam_member_containeranalysis_v1beta1_args_doc}
class OccurrenceIamMemberContaineranalysisV1beta1Args {
  ...
  /// Creates a new [OccurrenceIamMemberContaineranalysisV1beta1Args].
  ...
  factory OccurrenceIamMemberContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OccurrenceIamMemberContaineranalysisV1beta1Args(
