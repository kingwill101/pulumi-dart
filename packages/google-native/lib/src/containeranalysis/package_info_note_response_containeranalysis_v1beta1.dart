...
class PackageInfoNoteResponseContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'externalRefs': pulumi.Input.encodeList<ExternalRefResponseContaineranalysisV1beta1, Map<String, dynamic>>(externalRefs, (value) => value.toMap()),
  ...
  factory PackageInfoNoteResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return PackageInfoNoteResponseContaineranalysisV1beta1(
      ...
      externalRefs: pulumi.Input.decodeList<ExternalRefResponseContaineranalysisV1beta1>(map['externalRefs'], (value) => ExternalRefResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      filesLicenseInfo: (map['filesLicenseInfo'] as List).cast<String>(),
      homePage: map['homePage'] as String,
      licenseDeclared: LicenseResponseContaineranalysisV1beta1.fromMap((map['licenseDeclared'] as Map).cast<String, dynamic>()),
