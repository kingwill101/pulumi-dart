...
class OccurrenceArgs {
  ...
  factory OccurrenceArgs.fromMap(Map<String, dynamic> map) {
    return OccurrenceArgs(
      attestation: map['attestation'] == null ? null : AttestationOccurrence.fromMap((map['attestation'] as Map).cast<String, dynamic>()),
      build: map['build'] == null ? null : BuildOccurrence.fromMap((map['build'] as Map).cast<String, dynamic>()),
      compliance: map['compliance'] == null ? null : ComplianceOccurrence.fromMap((map['compliance'] as Map).cast<String, dynamic>()),
      deployment: map['deployment'] == null ? null : DeploymentOccurrence.fromMap((map['deployment'] as Map).cast<String, dynamic>()),
      discovery: map['discovery'] == null ? null : DiscoveryOccurrence.fromMap((map['discovery'] as Map).cast<String, dynamic>()),
      dsseAttestation: map['dsseAttestation'] == null ? null : DSSEAttestationOccurrence.fromMap((map['dsseAttestation'] as Map).cast<String, dynamic>()),
      envelope: map['envelope'] == null ? null : Envelope.fromMap((map['envelope'] as Map).cast<String, dynamic>()),
      image: map['image'] == null ? null : ImageOccurrence.fromMap((map['image'] as Map).cast<String, dynamic>()),
      noteName: map['noteName'] as String,
      package: map['package'] == null ? null : PackageOccurrence.fromMap((map['package'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      remediation: map['remediation'] == null ? null : map['remediation'] as String,
      resourceUri: map['resourceUri'] as String,
      sbomReference: map['sbomReference'] == null ? null : SBOMReferenceOccurrence.fromMap((map['sbomReference'] as Map).cast<String, dynamic>()),
      upgrade: map['upgrade'] == null ? null : UpgradeOccurrence.fromMap((map['upgrade'] as Map).cast<String, dynamic>()),
      vulnerability: map['vulnerability'] == null ? null : VulnerabilityOccurrence.fromMap((map['vulnerability'] as Map).cast<String, dynamic>()),
    );
  }
}
