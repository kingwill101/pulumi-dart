...
class OccurrenceArgs {
  ...
  OccurrenceArgs({
    ...
    VulnerabilityOccurrence? vulnerability,
       ...
       compliance = pulumi.Input.asOptionalInput<ComplianceOccurrence>(
         compliance,
       ),
       deployment = pulumi.Input.asOptionalInput<DeploymentOccurrence>(
         deployment,
       ),
       discovery = pulumi.Input.asOptionalInput<DiscoveryOccurrence>(discovery),
       dsseAttestation = pulumi
           .Input.asOptionalInput<DSSEAttestationOccurrence>(dsseAttestation),
