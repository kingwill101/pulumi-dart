...
/// {@template pulumi_containeranalysis_v1alpha1_provider_note_iam_policy_args_doc}
/// The set of arguments for ProviderNoteIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1alpha1_provider_note_iam_policy_args_doc}
class ProviderNoteIamPolicyArgs {
  ...
  /// Creates a new [ProviderNoteIamPolicyArgs].
  ...
  ProviderNoteIamPolicyArgs({
    List<BindingContaineranalysisV1alpha1>? bindings,
    String? etag,
  ...
  factory ProviderNoteIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ProviderNoteIamPolicyArgs(
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<BindingContaineranalysisV1alpha1>(map['bindings'], (value) => BindingContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
