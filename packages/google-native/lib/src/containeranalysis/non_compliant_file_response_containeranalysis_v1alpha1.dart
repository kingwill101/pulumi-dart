...
class NonCompliantFileResponseContaineranalysisV1alpha1 {
  ...
  /// Creates a new [NonCompliantFileResponseContaineranalysisV1alpha1].
  ...
  factory NonCompliantFileResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
