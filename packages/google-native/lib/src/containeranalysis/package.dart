...
class Package {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'digest': ?digest == null ? null : pulumi.Input.encodeList<DigestContaineranalysisV1alpha1, Map<String, dynamic>>(digest!, (value) => value.toMap()),
      'distribution': ?distribution == null ? null : pulumi.Input.encodeList<DistributionContaineranalysisV1alpha1, Map<String, dynamic>>(distribution!, (value) => value.toMap()),
  ...
  factory Package.fromMap(Map<String, dynamic> map) {
    return Package(
      architecture: map['architecture'] == null ? null : PackageArchitecture.fromValue(map['architecture'] as String),
      cpeUri: map['cpeUri'] == null ? null : map['cpeUri'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      digest: map['digest'] == null ? null : pulumi.Input.decodeList<DigestContaineranalysisV1alpha1>(map['digest'], (value) => DigestContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      distribution: map['distribution'] == null ? null : pulumi.Input.decodeList<DistributionContaineranalysisV1alpha1>(map['distribution'], (value) => DistributionContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
