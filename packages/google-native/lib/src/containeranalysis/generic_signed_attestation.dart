...
class GenericSignedAttestation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'signatures': ?signatures == null ? null : pulumi.Input.encodeList<SignatureContaineranalysisV1beta1, Map<String, dynamic>>(signatures!, (value) => value.toMap()),
    };
  }

  factory GenericSignedAttestation.fromMap(Map<String, dynamic> map) {
    return GenericSignedAttestation(
      contentType: map['contentType'] == null ? null : GenericSignedAttestationContentType.fromValue(map['contentType'] as String),
      serializedPayload: map['serializedPayload'] == null ? null : map['serializedPayload'] as String,
      signatures: map['signatures'] == null ? null : pulumi.Input.decodeList<SignatureContaineranalysisV1beta1>(map['signatures'], (value) => SignatureContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
