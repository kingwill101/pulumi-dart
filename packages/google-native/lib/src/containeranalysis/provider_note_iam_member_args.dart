...
/// {@template pulumi_containeranalysis_v1alpha1_provider_note_iam_member_args_doc}
/// The set of arguments for ProviderNoteIamMember.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1alpha1_provider_note_iam_member_args_doc}
class ProviderNoteIamMemberArgs {
  ...
  /// Creates a new [ProviderNoteIamMemberArgs].
  ...
  factory ProviderNoteIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ProviderNoteIamMemberArgs(
