...
class CVSSv3ContaineranalysisV1beta1 {
  ...
  final CVSSv3ConfidentialityImpactContaineranalysisV1beta1? confidentialityImpact;
  ...
  factory CVSSv3ContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return CVSSv3ContaineranalysisV1beta1(
      attackComplexity: map['attackComplexity'] == null ? null : CVSSv3AttackComplexityContaineranalysisV1beta1.fromValue(map['attackComplexity'] as String),
      attackVector: map['attackVector'] == null ? null : CVSSv3AttackVectorContaineranalysisV1beta1.fromValue(map['attackVector'] as String),
      availabilityImpact: map['availabilityImpact'] == null ? null : CVSSv3AvailabilityImpactContaineranalysisV1beta1.fromValue(map['availabilityImpact'] as String),
      baseScore: map['baseScore'] == null ? null : map['baseScore'] as double,
      confidentialityImpact: map['confidentialityImpact'] == null ? null : CVSSv3ConfidentialityImpactContaineranalysisV1beta1.fromValue(map['confidentialityImpact'] as String),
      ...
      integrityImpact: map['integrityImpact'] == null ? null : CVSSv3IntegrityImpactContaineranalysisV1beta1.fromValue(map['integrityImpact'] as String),
      privilegesRequired: map['privilegesRequired'] == null ? null : CVSSv3PrivilegesRequiredContaineranalysisV1beta1.fromValue(map['privilegesRequired'] as String),
      scope: map['scope'] == null ? null : CVSSv3ScopeContaineranalysisV1beta1.fromValue(map['scope'] as String),
      userInteraction: map['userInteraction'] == null ? null : CVSSv3UserInteractionContaineranalysisV1beta1.fromValue(map['userInteraction'] as String),
    );
  }
}
