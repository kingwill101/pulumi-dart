...
class CompositeTypeDeploymentmanagerV2betaArgs {
  ...
  factory CompositeTypeDeploymentmanagerV2betaArgs.fromMap(Map<String, dynamic> map) {
    return CompositeTypeDeploymentmanagerV2betaArgs(
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<CompositeTypeLabelEntryDeploymentmanagerV2beta>(map['labels'], (value) => CompositeTypeLabelEntryDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      templateContents: map['templateContents'] == null ? null : TemplateContentsDeploymentmanagerV2beta.fromMap((map['templateContents'] as Map).cast<String, dynamic>()),
    );
  }
}
