...
class DeploymentDeploymentmanagerV2betaArgs {
  ...
  DeploymentDeploymentmanagerV2betaArgs({
    ...
    String? description,
    String? id,
    List<DeploymentLabelEntryDeploymentmanagerV2beta>? labels,
    String? name,
    bool? preview,
    String? project,
    TargetConfigurationDeploymentmanagerV2beta? target,
  }) :
  ...
  factory DeploymentDeploymentmanagerV2betaArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentDeploymentmanagerV2betaArgs(
      createPolicy: map['createPolicy'] == null ? null : map['createPolicy'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      id: map['id'] == null ? null : map['id'] as String,
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<DeploymentLabelEntryDeploymentmanagerV2beta>(map['labels'], (value) => DeploymentLabelEntryDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      preview: map['preview'] == null ? null : map['preview'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      target: map['target'] == null ? null : TargetConfigurationDeploymentmanagerV2beta.fromMap((map['target'] as Map).cast<String, dynamic>()),
    );
  }
}
