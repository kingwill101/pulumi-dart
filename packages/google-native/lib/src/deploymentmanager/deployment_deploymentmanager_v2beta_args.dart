  ...
  factory DeploymentDeploymentmanagerV2betaArgs.fromMap(
    ...
    return DeploymentDeploymentmanagerV2betaArgs(
      ...
      labels: map['labels'] == null
          ? null
          : pulumi
                .Input.decodeList<DeploymentLabelEntryDeploymentmanagerV2beta>(
              map['labels'],
              (value) => DeploymentLabelEntryDeploymentmanagerV2beta.fromMap(
      ...
      target: map['target'] == null
          ? null
          : TargetConfigurationDeploymentmanagerV2beta.fromMap(
