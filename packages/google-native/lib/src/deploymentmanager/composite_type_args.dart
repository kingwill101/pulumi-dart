...
class CompositeTypeArgs {
  ...
  factory CompositeTypeArgs.fromMap(Map<String, dynamic> map) {
    return CompositeTypeArgs(
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<CompositeTypeLabelEntry>(map['labels'], (value) => CompositeTypeLabelEntry.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      templateContents: map['templateContents'] == null ? null : TemplateContents.fromMap((map['templateContents'] as Map).cast<String, dynamic>()),
    );
  }
}
