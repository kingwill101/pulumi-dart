...
class DeploymentDeploymentmanagerV2beta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<DeploymentLabelEntryResponseDeploymentmanagerV2beta>> labels;
  ...
  late final pulumi.Output<TargetConfigurationResponseDeploymentmanagerV2beta>
      target;
  ...
  late final pulumi.Output<DeploymentUpdateResponseDeploymentmanagerV2beta>
      update;
  ...
  DeploymentDeploymentmanagerV2beta(
    ...
    this.labels = registerOutput<
        List<DeploymentLabelEntryResponseDeploymentmanagerV2beta>>('labels');
    ...
    this.target =
        registerOutput<TargetConfigurationResponseDeploymentmanagerV2beta>(
            'target');
    this.update =
        registerOutput<DeploymentUpdateResponseDeploymentmanagerV2beta>(
            'update');
