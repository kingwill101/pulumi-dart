...
/// {@template pulumi_deploymentmanager_v2_deployment_iam_binding_deploymentmanager_v2_args_doc}
/// The set of arguments for DeploymentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_deploymentmanager_v2_deployment_iam_binding_deploymentmanager_v2_args_doc}
class DeploymentIamBindingDeploymentmanagerV2Args {
  ...
  /// Creates a new [DeploymentIamBindingDeploymentmanagerV2Args].
  ...
  DeploymentIamBindingDeploymentmanagerV2Args({
    Condition? condition,
  ...
  factory DeploymentIamBindingDeploymentmanagerV2Args.fromMap(Map<String, dynamic> map) {
    return DeploymentIamBindingDeploymentmanagerV2Args(
