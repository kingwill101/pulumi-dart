...
class OperationResponseDeploymentmanagerV2beta {
  ...
  final InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2beta instancesBulkInsertOperationMetadata;
  ...
  final SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2beta setCommonInstanceMetadataOperationMetadata;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'user': user,
      'warnings': pulumi.Input.encodeList<OperationWarningsItemResponseDeploymentmanagerV2beta, Map<String, dynamic>>(warnings, (value) => value.toMap()),
      'zone': zone,
    };
  }
  ...
  factory OperationResponseDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return OperationResponseDeploymentmanagerV2beta(
      ...
      error: OperationErrorResponseDeploymentmanagerV2beta.fromMap((map['error'] as Map).cast<String, dynamic>()),
      ...
      instancesBulkInsertOperationMetadata: InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2beta.fromMap((map['instancesBulkInsertOperationMetadata'] as Map).cast<String, dynamic>()),
      ...
      setCommonInstanceMetadataOperationMetadata: SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2beta.fromMap((map['setCommonInstanceMetadataOperationMetadata'] as Map).cast<String, dynamic>()),
      ...
      warnings: pulumi.Input.decodeList<OperationWarningsItemResponseDeploymentmanagerV2beta>(map['warnings'], (value) => OperationWarningsItemResponseDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
