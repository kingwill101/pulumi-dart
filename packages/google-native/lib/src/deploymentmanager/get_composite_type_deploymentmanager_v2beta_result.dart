...
class GetCompositeTypeDeploymentmanagerV2betaResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': pulumi.Input.encodeList<CompositeTypeLabelEntryResponseDeploymentmanagerV2beta, Map<String, dynamic>>(labels, (value) => value.toMap()),
      'name': name,
  ...
  factory GetCompositeTypeDeploymentmanagerV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetCompositeTypeDeploymentmanagerV2betaResult(
      description: map['description'] as String,
      insertTime: map['insertTime'] as String,
      labels: pulumi.Input.decodeList<CompositeTypeLabelEntryResponseDeploymentmanagerV2beta>(map['labels'], (value) => CompositeTypeLabelEntryResponseDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      operation: OperationResponseDeploymentmanagerV2beta.fromMap((map['operation'] as Map).cast<String, dynamic>()),
      selfLink: map['selfLink'] as String,
      status: map['status'] as String,
      templateContents: TemplateContentsResponseDeploymentmanagerV2beta.fromMap((map['templateContents'] as Map).cast<String, dynamic>()),
    );
  }
}
