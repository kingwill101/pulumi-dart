...
class PollingOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diagnostics': ?diagnostics == null ? null : pulumi.Input.encodeList<Diagnostic, Map<String, dynamic>>(diagnostics!, (value) => value.toMap()),
  ...
  factory PollingOptions.fromMap(Map<String, dynamic> map) {
    return PollingOptions(
      diagnostics: map['diagnostics'] == null ? null : pulumi.Input.decodeList<Diagnostic>(map['diagnostics'], (value) => Diagnostic.fromMap((value as Map).cast<String, dynamic>())),
