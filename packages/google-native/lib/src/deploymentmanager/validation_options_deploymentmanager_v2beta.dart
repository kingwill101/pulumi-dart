...
class ValidationOptionsDeploymentmanagerV2beta {
  ...
  final ValidationOptionsSchemaValidationDeploymentmanagerV2beta? schemaValidation;
  /// Specify what to do with extra properties when executing a request.
  final ValidationOptionsUndeclaredPropertiesDeploymentmanagerV2beta? undeclaredProperties;
  ...
  factory ValidationOptionsDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return ValidationOptionsDeploymentmanagerV2beta(
      schemaValidation: map['schemaValidation'] == null ? null : ValidationOptionsSchemaValidationDeploymentmanagerV2beta.fromValue(map['schemaValidation'] as String),
      undeclaredProperties: map['undeclaredProperties'] == null ? null : ValidationOptionsUndeclaredPropertiesDeploymentmanagerV2beta.fromValue(map['undeclaredProperties'] as String),
    );
  }
}
