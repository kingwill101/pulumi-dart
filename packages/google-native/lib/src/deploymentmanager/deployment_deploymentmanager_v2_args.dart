...
class DeploymentDeploymentmanagerV2Args {
  ...
  factory DeploymentDeploymentmanagerV2Args.fromMap(Map<String, dynamic> map) {
    return DeploymentDeploymentmanagerV2Args(
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<DeploymentLabelEntryDeploymentmanagerV2>(map['labels'], (value) => DeploymentLabelEntryDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      preview: map['preview'] == null ? null : map['preview'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      target: map['target'] == null ? null : TargetConfigurationDeploymentmanagerV2.fromMap((map['target'] as Map).cast<String, dynamic>()),
    );
  }
}
