...
/// {@template pulumi_deploymentmanager_alpha_deployment_iam_policy_args_doc}
/// The set of arguments for DeploymentIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_deploymentmanager_alpha_deployment_iam_policy_args_doc}
class DeploymentIamPolicyArgs {
  ...
  /// Creates a new [DeploymentIamPolicyArgs].
  ...
  factory DeploymentIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentIamPolicyArgs(
