...
class DeploymentType extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DeploymentLabelEntryResponse>> labels;
  ...
  late final pulumi.Output<List<DeploymentOutputEntryResponse>> outputs;
  ...
  DeploymentType(
    ...
    this.outputs = registerOutput<List<DeploymentOutputEntryResponse>>(
      'outputs',
    );
