...
class GetDeploymentResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['labels'] = pulumi.Input.encodeList<DeploymentLabelEntryResponse,
        Map<String, dynamic>>(labels, (value) => value.toMap());
    map['manifest'] = manifest;
    map['name'] = name;
    map['operation'] = operation.toMap();
    map['outputs'] = pulumi.Input.encodeList<DeploymentOutputEntryResponse,
  ...
  factory GetDeploymentResult.fromMap(Map<String, dynamic> map) {
    return GetDeploymentResult(
      ...
      labels: pulumi.Input.decodeList<DeploymentLabelEntryResponse>(
          map['labels'],
          (value) => DeploymentLabelEntryResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      manifest: map['manifest'] as String,
      name: map['name'] as String,
      operation: OperationResponse.fromMap(
          (map['operation'] as Map).cast<String, dynamic>()),
      outputs: pulumi.Input.decodeList<DeploymentOutputEntryResponse>(
          map['outputs'],
          (value) => DeploymentOutputEntryResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] as String,
      target: TargetConfigurationResponse.fromMap(
          (map['target'] as Map).cast<String, dynamic>()),
      update: DeploymentUpdateResponse.fromMap(
