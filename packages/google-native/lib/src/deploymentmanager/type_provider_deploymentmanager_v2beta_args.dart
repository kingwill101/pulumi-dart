...
class TypeProviderDeploymentmanagerV2betaArgs {
  ...
  final pulumi.Input<List<CollectionOverrideDeploymentmanagerV2beta>>?
      collectionOverrides;
  ...
  final pulumi.Input<List<TypeProviderLabelEntryDeploymentmanagerV2beta>>?
      labels;
  ...
  TypeProviderDeploymentmanagerV2betaArgs({
    List<CollectionOverrideDeploymentmanagerV2beta>? collectionOverrides,
    CredentialDeploymentmanagerV2beta? credential,
    List<String>? customCertificateAuthorityRoots,
    String? description,
    String? descriptorUrl,
    List<TypeProviderLabelEntryDeploymentmanagerV2beta>? labels,
    String? name,
    OptionsDeploymentmanagerV2beta? options,
    String? project,
  })  : collectionOverrides = pulumi.Input.asOptionalInput<
                List<CollectionOverrideDeploymentmanagerV2beta>>(
            collectionOverrides),
        credential =
            pulumi.Input.asOptionalInput<CredentialDeploymentmanagerV2beta>(
                credential),
        customCertificateAuthorityRoots =
        ...
        options = pulumi.Input.asOptionalInput<OptionsDeploymentmanagerV2beta>(
            options),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (credentialValue != null) {
      map['credential'] = pulumi.Input.mapOptionalInputValue<
          CredentialDeploymentmanagerV2beta,
          Map<String, dynamic>>(credentialValue, (value) => value.toMap());
    }
    ...
    if (labelsValue != null) {
      map['labels'] = pulumi.Input.mapOptionalInputValue<
              List<TypeProviderLabelEntryDeploymentmanagerV2beta>,
              List<Map<String, dynamic>>>(
          labelsValue,
          (value) => pulumi.Input.encodeList<
  ...
  factory TypeProviderDeploymentmanagerV2betaArgs.fromMap(
      Map<String, dynamic> map) {
    return TypeProviderDeploymentmanagerV2betaArgs(
      collectionOverrides: map['collectionOverrides'] == null
          ? null
          : pulumi.Input.decodeList<CollectionOverrideDeploymentmanagerV2beta>(
              map['collectionOverrides'],
              (value) => CollectionOverrideDeploymentmanagerV2beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      credential: map['credential'] == null
          ? null
          : CredentialDeploymentmanagerV2beta.fromMap(
              (map['credential'] as Map).cast<String, dynamic>()),
      customCertificateAuthorityRoots:
          map['customCertificateAuthorityRoots'] == null
              ? null
              : (map['customCertificateAuthorityRoots'] as List).cast<String>(),
      description:
          map['description'] == null ? null : map['description'] as String,
      descriptorUrl:
          map['descriptorUrl'] == null ? null : map['descriptorUrl'] as String,
      labels: map['labels'] == null
          ? null
          : pulumi.Input.decodeList<
                  TypeProviderLabelEntryDeploymentmanagerV2beta>(
              map['labels'],
              (value) => TypeProviderLabelEntryDeploymentmanagerV2beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
