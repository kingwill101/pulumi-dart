...
class TypeProviderDeploymentmanagerV2betaArgs {
  ...
  factory TypeProviderDeploymentmanagerV2betaArgs.fromMap(Map<String, dynamic> map) {
    return TypeProviderDeploymentmanagerV2betaArgs(
      collectionOverrides: map['collectionOverrides'] == null ? null : pulumi.Input.decodeList<CollectionOverrideDeploymentmanagerV2beta>(map['collectionOverrides'], (value) => CollectionOverrideDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
      credential: map['credential'] == null ? null : CredentialDeploymentmanagerV2beta.fromMap((map['credential'] as Map).cast<String, dynamic>()),
      customCertificateAuthorityRoots: map['customCertificateAuthorityRoots'] == null ? null : (map['customCertificateAuthorityRoots'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      descriptorUrl: map['descriptorUrl'] == null ? null : map['descriptorUrl'] as String,
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<TypeProviderLabelEntryDeploymentmanagerV2beta>(map['labels'], (value) => TypeProviderLabelEntryDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
