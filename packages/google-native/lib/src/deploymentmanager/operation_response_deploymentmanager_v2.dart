...
class OperationResponseDeploymentmanagerV2 {
  ...
  final InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2 instancesBulkInsertOperationMetadata;
  ...
  final SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2 setCommonInstanceMetadataOperationMetadata;
  ...
  /// Creates a new [OperationResponseDeploymentmanagerV2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'user': user,
      'warnings': pulumi.Input.encodeList<OperationWarningsItemResponseDeploymentmanagerV2, Map<String, dynamic>>(warnings, (value) => value.toMap()),
      'zone': zone,
    };
  }

  factory OperationResponseDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return OperationResponseDeploymentmanagerV2(
      clientOperationId: map['clientOperationId'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      endTime: map['endTime'] as String,
      error: OperationErrorResponseDeploymentmanagerV2.fromMap((map['error'] as Map).cast<String, dynamic>()),
      ...
      instancesBulkInsertOperationMetadata: InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2.fromMap((map['instancesBulkInsertOperationMetadata'] as Map).cast<String, dynamic>()),
      ...
      setCommonInstanceMetadataOperationMetadata: SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2.fromMap((map['setCommonInstanceMetadataOperationMetadata'] as Map).cast<String, dynamic>()),
      ...
      warnings: pulumi.Input.decodeList<OperationWarningsItemResponseDeploymentmanagerV2>(map['warnings'], (value) => OperationWarningsItemResponseDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>())),
