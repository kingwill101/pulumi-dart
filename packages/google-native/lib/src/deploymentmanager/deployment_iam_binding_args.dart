...
/// {@template pulumi_deploymentmanager_alpha_deployment_iam_binding_args_doc}
/// The set of arguments for DeploymentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_deploymentmanager_alpha_deployment_iam_binding_args_doc}
class DeploymentIamBindingArgs {
  ...
  /// Creates a new [DeploymentIamBindingArgs].
  ...
  factory DeploymentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentIamBindingArgs(
