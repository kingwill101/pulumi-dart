...
class TypeProviderDeploymentmanagerV2beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<
    List<CollectionOverrideResponseDeploymentmanagerV2beta>
  >
  collectionOverrides;
  ...
  late final pulumi.Output<
    List<TypeProviderLabelEntryResponseDeploymentmanagerV2beta>
  >
  labels;
  ...
  TypeProviderDeploymentmanagerV2beta(
    ...
    this.credential = registerOutput<CredentialResponseDeploymentmanagerV2beta>(
      'credential',
    );
    this.customCertificateAuthorityRoots = registerOutput<List<String>>(
