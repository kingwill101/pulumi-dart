...
class TypeProviderArgs {
  ...
  /// [project] Optional.
  TypeProviderArgs({
    List<CollectionOverride>? collectionOverrides,
    Credential? credential,
    List<String>? customCertificateAuthorityRoots,
    String? description,
    String? descriptorUrl,
    List<TypeProviderLabelEntry>? labels,
    String? name,
    Options? options,
    String? project,
  }) :
  ...
  factory TypeProviderArgs.fromMap(Map<String, dynamic> map) {
    return TypeProviderArgs(
      collectionOverrides: map['collectionOverrides'] == null ? null : pulumi.Input.decodeList<CollectionOverride>(map['collectionOverrides'], (value) => CollectionOverride.fromMap((value as Map).cast<String, dynamic>())),
      credential: map['credential'] == null ? null : Credential.fromMap((map['credential'] as Map).cast<String, dynamic>()),
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<TypeProviderLabelEntry>(map['labels'], (value) => TypeProviderLabelEntry.fromMap((value as Map).cast<String, dynamic>())),
