...
class PollingOptionsDeploymentmanagerV2beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diagnostics': ?diagnostics == null ? null : pulumi.Input.encodeList<DiagnosticDeploymentmanagerV2beta, Map<String, dynamic>>(diagnostics!, (value) => value.toMap()),
  ...
  factory PollingOptionsDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return PollingOptionsDeploymentmanagerV2beta(
      diagnostics: map['diagnostics'] == null ? null : pulumi.Input.decodeList<DiagnosticDeploymentmanagerV2beta>(map['diagnostics'], (value) => DiagnosticDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
      failCondition: map['failCondition'] == null ? null : map['failCondition'] as String,
      finishCondition: map['finishCondition'] == null ? null : map['finishCondition'] as String,
      pollingLink: map['pollingLink'] == null ? null : map['pollingLink'] as String,
      targetLink: map['targetLink'] == null ? null : map['targetLink'] as String,
    );
  }
}
