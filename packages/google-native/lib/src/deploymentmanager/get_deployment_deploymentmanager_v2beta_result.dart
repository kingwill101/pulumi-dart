...
class GetDeploymentDeploymentmanagerV2betaResult {
  ...
  factory GetDeploymentDeploymentmanagerV2betaResult.fromMap(
    ...
    return GetDeploymentDeploymentmanagerV2betaResult(
      ...
      labels:
          ...
          >(
            map['labels'],
            (value) =>
                DeploymentLabelEntryResponseDeploymentmanagerV2beta.fromMap(
      ...
      target: TargetConfigurationResponseDeploymentmanagerV2beta.fromMap(
        (map['target'] as Map).cast<String, dynamic>(),
      ),
      update: DeploymentUpdateResponseDeploymentmanagerV2beta.fromMap(
