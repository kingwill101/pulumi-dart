...
class OptionsResponseDeploymentmanagerV2beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asyncOptions': pulumi.Input.encodeList<AsyncOptionsResponseDeploymentmanagerV2beta, Map<String, dynamic>>(asyncOptions, (value) => value.toMap()),
      'inputMappings': pulumi.Input.encodeList<InputMappingResponseDeploymentmanagerV2beta, Map<String, dynamic>>(inputMappings, (value) => value.toMap()),
  ...
  factory OptionsResponseDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return OptionsResponseDeploymentmanagerV2beta(
      asyncOptions: pulumi.Input.decodeList<AsyncOptionsResponseDeploymentmanagerV2beta>(map['asyncOptions'], (value) => AsyncOptionsResponseDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
      inputMappings: pulumi.Input.decodeList<InputMappingResponseDeploymentmanagerV2beta>(map['inputMappings'], (value) => InputMappingResponseDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>())),
      validationOptions: ValidationOptionsResponseDeploymentmanagerV2beta.fromMap((map['validationOptions'] as Map).cast<String, dynamic>()),
