...
class GetTypeProviderDeploymentmanagerV2betaResult {
  ...
  final List<CollectionOverrideResponseDeploymentmanagerV2beta>
      collectionOverrides;
  ...
  factory GetTypeProviderDeploymentmanagerV2betaResult.fromMap(
      Map<String, dynamic> map) {
    return GetTypeProviderDeploymentmanagerV2betaResult(
      collectionOverrides: pulumi.Input.decodeList<
              CollectionOverrideResponseDeploymentmanagerV2beta>(
          map['collectionOverrides'],
          (value) => CollectionOverrideResponseDeploymentmanagerV2beta.fromMap(
              (value as Map).cast<String, dynamic>())),
      credential: CredentialResponseDeploymentmanagerV2beta.fromMap(
      ...
      labels: pulumi.Input.decodeList<
          ...
          map['labels'],
          (value) =>
              TypeProviderLabelEntryResponseDeploymentmanagerV2beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
