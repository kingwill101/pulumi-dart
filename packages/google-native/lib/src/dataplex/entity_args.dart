...
class EntityArgs {
  ...
  factory EntityArgs.fromMap(Map<String, dynamic> map) {
    return EntityArgs(
      ...
      dataPathPattern: map['dataPathPattern'] == null ? null : map['dataPathPattern'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      format: GoogleCloudDataplexV1StorageFormat.fromMap((map['format'] as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      lakeId: map['lakeId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      schema: GoogleCloudDataplexV1Schema.fromMap((map['schema'] as Map).cast<String, dynamic>()),
