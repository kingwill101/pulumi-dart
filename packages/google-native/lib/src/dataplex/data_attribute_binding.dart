...
class DataAttributeBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDataplexV1DataAttributeBindingPathResponse>> paths;
  ...
  /// Creates a new [DataAttributeBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataAttributeBinding]. {@macro pulumi_dataplex_v1_data_attribute_binding_args_doc}
  ...
  DataAttributeBinding(
    ...
    this.paths = registerOutput<List<GoogleCloudDataplexV1DataAttributeBindingPathResponse>>('paths');
