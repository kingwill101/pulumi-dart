...
/// {@template pulumi_dataplex_v1_lake_contentitem_iam_binding_args_doc}
/// The set of arguments for LakeContentitemIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_contentitem_iam_binding_args_doc}
class LakeContentitemIamBindingArgs {
  ...
  /// Creates a new [LakeContentitemIamBindingArgs].
  ...
  factory LakeContentitemIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LakeContentitemIamBindingArgs(
