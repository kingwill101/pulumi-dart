...
class Zone extends pulumi.CustomResource {
  ...
  Zone(
    ...
    this.discoverySpec = registerOutput<GoogleCloudDataplexV1ZoneDiscoverySpecResponse>('discoverySpec');
    ...
    this.resourceSpec = registerOutput<GoogleCloudDataplexV1ZoneResourceSpecResponse>('resourceSpec');
