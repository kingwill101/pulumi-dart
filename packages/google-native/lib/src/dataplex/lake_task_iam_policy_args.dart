...
/// {@template pulumi_dataplex_v1_lake_task_iam_policy_args_doc}
/// The set of arguments for LakeTaskIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_task_iam_policy_args_doc}
class LakeTaskIamPolicyArgs {
  ...
  /// Creates a new [LakeTaskIamPolicyArgs].
  ...
  factory LakeTaskIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return LakeTaskIamPolicyArgs(
