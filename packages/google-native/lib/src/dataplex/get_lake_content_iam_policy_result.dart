...
/// Result data returned by getLakeContentIamPolicy.
class GetLakeContentIamPolicyResult {
  ...
  /// Creates a new [GetLakeContentIamPolicyResult].
  ...
  factory GetLakeContentIamPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetLakeContentIamPolicyResult(
