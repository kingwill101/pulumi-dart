...
class DataAttributeBindingArgs {
  ...
  DataAttributeBindingArgs({
    ...
    String? location,
    List<GoogleCloudDataplexV1DataAttributeBindingPath>? paths,
    String? project,
    String? resource,
  }) :
  ...
  factory DataAttributeBindingArgs.fromMap(Map<String, dynamic> map) {
    return DataAttributeBindingArgs(
      ...
      paths: map['paths'] == null ? null : pulumi.Input.decodeList<GoogleCloudDataplexV1DataAttributeBindingPath>(map['paths'], (value) => GoogleCloudDataplexV1DataAttributeBindingPath.fromMap((value as Map).cast<String, dynamic>())),
