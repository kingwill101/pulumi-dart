...
class GetDataScanResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['data'] = data.toMap();
    map['dataProfileResult'] = dataProfileResult.toMap();
    map['dataProfileSpec'] = dataProfileSpec.toMap();
    map['dataQualityResult'] = dataQualityResult.toMap();
    map['dataQualitySpec'] = dataQualitySpec.toMap();
