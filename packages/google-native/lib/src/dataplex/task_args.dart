...
class TaskArgs {
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      ...
      executionSpec: GoogleCloudDataplexV1TaskExecutionSpec.fromMap((map['executionSpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      lakeId: map['lakeId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      notebook: map['notebook'] == null ? null : GoogleCloudDataplexV1TaskNotebookTaskConfig.fromMap((map['notebook'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      spark: map['spark'] == null ? null : GoogleCloudDataplexV1TaskSparkTaskConfig.fromMap((map['spark'] as Map).cast<String, dynamic>()),
      taskId: map['taskId'] as String,
      triggerSpec: GoogleCloudDataplexV1TaskTriggerSpec.fromMap((map['triggerSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
