...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    required GoogleCloudDataplexV1EnvironmentInfrastructureSpec infrastructureSpec,
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      infrastructureSpec: GoogleCloudDataplexV1EnvironmentInfrastructureSpec.fromMap((map['infrastructureSpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      lakeId: map['lakeId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      sessionSpec: map['sessionSpec'] == null ? null : GoogleCloudDataplexV1EnvironmentSessionSpec.fromMap((map['sessionSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
