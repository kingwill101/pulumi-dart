...
class GoogleCloudDataplexV1ScannedDataResponse {
  ...
  final GoogleCloudDataplexV1ScannedDataIncrementalFieldResponse incrementalField;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'incrementalField': incrementalField.toMap(),
    };
  }
  ...
  factory GoogleCloudDataplexV1ScannedDataResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1ScannedDataResponse(
      incrementalField: GoogleCloudDataplexV1ScannedDataIncrementalFieldResponse.fromMap((map['incrementalField'] as Map).cast<String, dynamic>()),
    );
  }
}
