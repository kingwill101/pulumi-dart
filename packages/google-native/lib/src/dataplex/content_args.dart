...
class ContentArgs {
  ...
  factory ContentArgs.fromMap(Map<String, dynamic> map) {
    return ContentArgs(
      ...
      notebook: map['notebook'] == null ? null : GoogleCloudDataplexV1ContentNotebook.fromMap((map['notebook'] as Map).cast<String, dynamic>()),
      path: map['path'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      sqlScript: map['sqlScript'] == null ? null : GoogleCloudDataplexV1ContentSqlScript.fromMap((map['sqlScript'] as Map).cast<String, dynamic>()),
    );
  }
}
