...
/// {@template pulumi_dataplex_v1_lake_task_iam_member_args_doc}
/// The set of arguments for LakeTaskIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_task_iam_member_args_doc}
class LakeTaskIamMemberArgs {
  ...
  /// Creates a new [LakeTaskIamMemberArgs].
  ...
  factory LakeTaskIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LakeTaskIamMemberArgs(
