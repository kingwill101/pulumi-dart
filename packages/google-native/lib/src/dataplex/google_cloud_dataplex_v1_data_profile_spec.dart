...
class GoogleCloudDataplexV1DataProfileSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'postScanActions': ?postScanActions == null
          ? null
          : postScanActions!.toMap(),
      'rowFilter': ?rowFilter,
      'samplingPercent': ?samplingPercent,
    };
  }

  factory GoogleCloudDataplexV1DataProfileSpec.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudDataplexV1DataProfileSpec(
      excludeFields: map['excludeFields'] == null
          ? null
          : GoogleCloudDataplexV1DataProfileSpecSelectedFields.fromMap(
      ...
      postScanActions: map['postScanActions'] == null
          ? null
          : GoogleCloudDataplexV1DataProfileSpecPostScanActions.fromMap(
