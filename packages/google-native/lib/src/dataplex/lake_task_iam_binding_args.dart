...
/// {@template pulumi_dataplex_v1_lake_task_iam_binding_args_doc}
/// The set of arguments for LakeTaskIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_task_iam_binding_args_doc}
class LakeTaskIamBindingArgs {
  ...
  /// Creates a new [LakeTaskIamBindingArgs].
  ...
  factory LakeTaskIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LakeTaskIamBindingArgs(
