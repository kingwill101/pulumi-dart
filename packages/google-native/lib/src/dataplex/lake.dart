...
class Lake extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudDataplexV1LakeMetastoreResponse> metastore;
  /// Metastore status of the lake.
  late final pulumi.Output<GoogleCloudDataplexV1LakeMetastoreStatusResponse> metastoreStatus;
  ...
  Lake(
    ...
    this.assetStatus = registerOutput<GoogleCloudDataplexV1AssetStatusResponse>('assetStatus');
    ...
    this.metastore = registerOutput<GoogleCloudDataplexV1LakeMetastoreResponse>('metastore');
    this.metastoreStatus = registerOutput<GoogleCloudDataplexV1LakeMetastoreStatusResponse>('metastoreStatus');
