...
class AttributeArgs {
  ...
  factory AttributeArgs.fromMap(Map<String, dynamic> map) {
    return AttributeArgs(
      dataAccessSpec: map['dataAccessSpec'] == null ? null : GoogleCloudDataplexV1DataAccessSpec.fromMap((map['dataAccessSpec'] as Map).cast<String, dynamic>()),
      ...
      resourceAccessSpec: map['resourceAccessSpec'] == null ? null : GoogleCloudDataplexV1ResourceAccessSpec.fromMap((map['resourceAccessSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
