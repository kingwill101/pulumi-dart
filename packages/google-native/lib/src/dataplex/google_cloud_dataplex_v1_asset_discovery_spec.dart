...
class GoogleCloudDataplexV1AssetDiscoverySpec {
  ...
  factory GoogleCloudDataplexV1AssetDiscoverySpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1AssetDiscoverySpec(
      csvOptions: map['csvOptions'] == null ? null : GoogleCloudDataplexV1AssetDiscoverySpecCsvOptions.fromMap((map['csvOptions'] as Map).cast<String, dynamic>()),
      ...
      jsonOptions: map['jsonOptions'] == null ? null : GoogleCloudDataplexV1AssetDiscoverySpecJsonOptions.fromMap((map['jsonOptions'] as Map).cast<String, dynamic>()),
