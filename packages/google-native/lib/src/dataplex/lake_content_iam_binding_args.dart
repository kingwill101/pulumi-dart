...
/// {@template pulumi_dataplex_v1_lake_content_iam_binding_args_doc}
/// The set of arguments for LakeContentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_content_iam_binding_args_doc}
class LakeContentIamBindingArgs {
  ...
  /// Creates a new [LakeContentIamBindingArgs].
  ...
  factory LakeContentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LakeContentIamBindingArgs(
