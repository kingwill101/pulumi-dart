...
class GoogleCloudDataplexV1DataProfileSpecResponse {
  ...
  final GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse
      excludeFields;
  ...
  final GoogleCloudDataplexV1DataProfileSpecPostScanActionsResponse
      postScanActions;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['excludeFields'] = excludeFields.toMap();
    map['includeFields'] = includeFields.toMap();
