...
class ZoneArgs {
  ...
  factory ZoneArgs.fromMap(Map<String, dynamic> map) {
    return ZoneArgs(
      ...
      discoverySpec: map['discoverySpec'] == null ? null : GoogleCloudDataplexV1ZoneDiscoverySpec.fromMap((map['discoverySpec'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      lakeId: map['lakeId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      resourceSpec: GoogleCloudDataplexV1ZoneResourceSpec.fromMap((map['resourceSpec'] as Map).cast<String, dynamic>()),
