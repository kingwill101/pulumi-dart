...
class JobConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inputs': pulumi.Input.encodeList<InputResponse, Map<String, dynamic>>(
        inputs,
        (value) => value.toMap(),
      ),
      'manifests':
  ...
  factory JobConfigResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigResponse(
      ...
      encryptions: pulumi.Input.decodeList<EncryptionResponse>(
        map['encryptions'],
        (value) =>
            EncryptionResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      spriteSheets: pulumi.Input.decodeList<SpriteSheetResponse>(
        map['spriteSheets'],
        (value) =>
            SpriteSheetResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
