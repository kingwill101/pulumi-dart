...
class H265CodecSettings {
  ...
  /// Creates a new [H265CodecSettings].
  ...
  factory H265CodecSettings.fromMap(Map<String, dynamic> map) {
    return H265CodecSettings(
      allowOpenGop: map['allowOpenGop'] == null
          ? null
          : map['allowOpenGop'] as bool,
      aqStrength: map['aqStrength'] == null
          ? null
          : map['aqStrength'] as double,
      bFrameCount: map['bFrameCount'] == null
          ? null
          : map['bFrameCount'] as int,
      ...
      enableTwoPass: map['enableTwoPass'] == null
          ? null
          : map['enableTwoPass'] as bool,
