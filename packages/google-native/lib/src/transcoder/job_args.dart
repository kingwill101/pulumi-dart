...
class JobArgs {
  ...
  JobArgs({
    ...
    int? ttlAfterCompletionDays,
            ...
            pulumi.Input.asOptionalInput<int>(batchModePriority),
        ...
        optimization =
            pulumi.Input.asOptionalInput<JobOptimization>(optimization),
        ...
        ttlAfterCompletionDays =
            pulumi.Input.asOptionalInput<int>(ttlAfterCompletionDays);
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      batchModePriority: map['batchModePriority'] == null
          ? null
          : map['batchModePriority'] as int,
      ...
      mode:
          map['mode'] == null ? null : JobMode.fromValue(map['mode'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      optimization: map['optimization'] == null
          ? null
          : JobOptimization.fromValue(map['optimization'] as String),
      outputUri: map['outputUri'] == null ? null : map['outputUri'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      templateId:
          map['templateId'] == null ? null : map['templateId'] as String,
      ttlAfterCompletionDays: map['ttlAfterCompletionDays'] == null
          ? null
          : map['ttlAfterCompletionDays'] as int,
    );
  }
}
