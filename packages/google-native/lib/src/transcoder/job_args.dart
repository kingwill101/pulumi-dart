...
class JobArgs {
  ...
  JobArgs({
    ...
    int? ttlAfterCompletionDays,
       ...
       optimization = pulumi.Input.asOptionalInput<JobOptimization>(
         optimization,
       ),
       ...
       ttlAfterCompletionDays = pulumi.Input.asOptionalInput<int>(
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'location': ?location,
      'mode': ?pulumi.Input.mapOptionalInputValue<JobMode, String>(
        mode,
        (value) => value.value,
      ),
      'name': ?name,
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      mode: map['mode'] == null
          ? null
          : JobMode.fromValue(map['mode'] as String),
