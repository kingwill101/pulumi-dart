...
class EncryptionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mpegCenc': mpegCenc.toMap(),
      'sampleAes': sampleAes,
      'secretManagerKeySource': secretManagerKeySource.toMap(),
    };
  }
  ...
  factory EncryptionResponse.fromMap(Map<String, dynamic> map) {
    return EncryptionResponse(
      ...
      drmSystems: DrmSystemsResponse.fromMap((map['drmSystems'] as Map).cast<String, dynamic>()),
      mpegCenc: MpegCommonEncryptionResponse.fromMap((map['mpegCenc'] as Map).cast<String, dynamic>()),
      sampleAes: (map['sampleAes'] as Map).cast<String, dynamic>(),
      secretManagerKeySource: SecretManagerSourceResponse.fromMap((map['secretManagerKeySource'] as Map).cast<String, dynamic>()),
    );
  }
}
