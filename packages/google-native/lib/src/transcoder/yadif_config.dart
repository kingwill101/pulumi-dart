...
class YadifConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final disableSpatialInterlacingValue = disableSpatialInterlacing;
    if (disableSpatialInterlacingValue != null) {
      map['disableSpatialInterlacing'] = disableSpatialInterlacingValue;
    }
