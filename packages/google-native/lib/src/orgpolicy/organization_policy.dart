...
class OrganizationPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [OrganizationPolicy]. {@macro pulumi_orgpolicy_v2_organization_policy_args_doc}
  ...
  OrganizationPolicy(
    ...
    this.dryRunSpec = registerOutput<GoogleCloudOrgpolicyV2PolicySpecResponse>(
      'dryRunSpec',
    );
    this.name = registerOutput<String>('name');
    this.organizationId = registerOutput<String>('organizationId');
    this.spec = registerOutput<GoogleCloudOrgpolicyV2PolicySpecResponse>(
      'spec',
    );
  }
}
