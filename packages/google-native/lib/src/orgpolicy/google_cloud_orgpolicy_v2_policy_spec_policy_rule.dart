...
class GoogleCloudOrgpolicyV2PolicySpecPolicyRule {
  ...
  factory GoogleCloudOrgpolicyV2PolicySpecPolicyRule.fromMap(Map<String, dynamic> map) {
    return GoogleCloudOrgpolicyV2PolicySpecPolicyRule(
      ...
      condition: map['condition'] == null ? null : GoogleTypeExpr.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      denyAll: map['denyAll'] == null ? null : map['denyAll'] as bool,
      enforce: map['enforce'] == null ? null : map['enforce'] as bool,
      values: map['values'] == null ? null : GoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues.fromMap((map['values'] as Map).cast<String, dynamic>()),
    );
  }
}
