...
class CustomConstraintArgs {
  ...
  factory CustomConstraintArgs.fromMap(Map<String, dynamic> map) {
    return CustomConstraintArgs(
      actionType: map['actionType'] == null ? null : CustomConstraintActionType.fromValue(map['actionType'] as String),
      condition: map['condition'] == null ? null : map['condition'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      methodTypes: map['methodTypes'] == null ? null : pulumi.Input.decodeList<CustomConstraintMethodTypesItem>(map['methodTypes'], (value) => CustomConstraintMethodTypesItem.fromValue(value as String)),
