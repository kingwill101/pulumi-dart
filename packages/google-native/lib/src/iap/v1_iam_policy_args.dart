...
/// {@template pulumi_iap_v1_v1_iam_policy_args_doc}
/// The set of arguments for V1IamPolicy.
/// {@endtemplate}
/// {@macro pulumi_iap_v1_v1_iam_policy_args_doc}
class V1IamPolicyArgs {
  ...
  factory V1IamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return V1IamPolicyArgs(
