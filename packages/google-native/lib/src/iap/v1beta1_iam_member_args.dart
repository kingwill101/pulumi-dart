...
/// {@template pulumi_iap_v1beta1_v1beta1_iam_member_args_doc}
/// The set of arguments for V1beta1IamMember.
/// {@endtemplate}
/// {@macro pulumi_iap_v1beta1_v1beta1_iam_member_args_doc}
class V1beta1IamMemberArgs {
  ...
  /// Creates a new [V1beta1IamMemberArgs].
  ...
  factory V1beta1IamMemberArgs.fromMap(Map<String, dynamic> map) {
    return V1beta1IamMemberArgs(
