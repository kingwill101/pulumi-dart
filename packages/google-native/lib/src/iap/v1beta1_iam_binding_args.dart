...
/// {@template pulumi_iap_v1beta1_v1beta1_iam_binding_args_doc}
/// The set of arguments for V1beta1IamBinding.
/// {@endtemplate}
/// {@macro pulumi_iap_v1beta1_v1beta1_iam_binding_args_doc}
class V1beta1IamBindingArgs {
  ...
  /// Creates a new [V1beta1IamBindingArgs].
  ...
  factory V1beta1IamBindingArgs.fromMap(Map<String, dynamic> map) {
    return V1beta1IamBindingArgs(
