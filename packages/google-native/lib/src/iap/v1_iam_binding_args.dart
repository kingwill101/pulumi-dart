...
/// {@template pulumi_iap_v1_v1_iam_binding_args_doc}
/// The set of arguments for V1IamBinding.
/// {@endtemplate}
/// {@macro pulumi_iap_v1_v1_iam_binding_args_doc}
class V1IamBindingArgs {
  ...
  /// Creates a new [V1IamBindingArgs].
  ...
  factory V1IamBindingArgs.fromMap(Map<String, dynamic> map) {
    return V1IamBindingArgs(
