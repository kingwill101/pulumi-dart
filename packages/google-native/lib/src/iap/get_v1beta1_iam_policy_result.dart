...
class GetV1beta1IamPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bindings'] = pulumi.Input.encodeList<BindingResponseIapV1beta1,
  ...
  factory GetV1beta1IamPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetV1beta1IamPolicyResult(
      bindings: pulumi.Input.decodeList<BindingResponseIapV1beta1>(
          map['bindings'],
          (value) => BindingResponseIapV1beta1.fromMap(
