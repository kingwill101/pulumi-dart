...
class WorkerPoolCloudbuildV1alpha1Args {
  ...
  WorkerPoolCloudbuildV1alpha1Args({
    ...
    String? workerCount,
       ...
       workerConfig = pulumi
           .Input.asOptionalInput<WorkerConfigCloudbuildV1alpha1>(workerConfig),
  ...
  factory WorkerPoolCloudbuildV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return WorkerPoolCloudbuildV1alpha1Args(
      ...
      regions: map['regions'] == null
          ? null
          : pulumi.Input.decodeList<WorkerPoolRegionsItem>(
              map['regions'],
              (value) => WorkerPoolRegionsItem.fromValue(value as String),
            ),
      workerConfig: map['workerConfig'] == null
          ? null
          : WorkerConfigCloudbuildV1alpha1.fromMap(
              (map['workerConfig'] as Map).cast<String, dynamic>(),
            ),
      workerCount: map['workerCount'] == null
          ? null
          : map['workerCount'] as String,
    );
  }
}
