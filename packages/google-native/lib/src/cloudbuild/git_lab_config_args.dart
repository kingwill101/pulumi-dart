...
class GitLabConfigArgs {
  ...
  GitLabConfigArgs({
    ...
    String? username,
      ...
      connectedRepositories = pulumi.Input.asOptionalInput<List<GitLabRepositoryId>>(connectedRepositories),
      enterpriseConfig = pulumi.Input.asOptionalInput<GitLabEnterpriseConfig>(enterpriseConfig),
  ...
  factory GitLabConfigArgs.fromMap(Map<String, dynamic> map) {
    return GitLabConfigArgs(
      connectedRepositories: map['connectedRepositories'] == null ? null : pulumi.Input.decodeList<GitLabRepositoryId>(map['connectedRepositories'], (value) => GitLabRepositoryId.fromMap((value as Map).cast<String, dynamic>())),
      enterpriseConfig: map['enterpriseConfig'] == null ? null : GitLabEnterpriseConfig.fromMap((map['enterpriseConfig'] as Map).cast<String, dynamic>()),
      gitlabConfigId: map['gitlabConfigId'] == null ? null : map['gitlabConfigId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      secrets: GitLabSecrets.fromMap((map['secrets'] as Map).cast<String, dynamic>()),
