...
class BitbucketServerTriggerConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bitbucketServerConfig': bitbucketServerConfig.toMap(),
  ...
  factory BitbucketServerTriggerConfigResponse.fromMap(Map<String, dynamic> map) {
    return BitbucketServerTriggerConfigResponse(
      bitbucketServerConfig: BitbucketServerConfigResponse.fromMap((map['bitbucketServerConfig'] as Map).cast<String, dynamic>()),
