...
class Trigger extends pulumi.CustomResource {
  ...
  Trigger(
    ...
    this.approvalConfig = registerOutput<ApprovalConfigResponse>('approvalConfig');
    this.autodetect = registerOutput<bool>('autodetect');
    this.bitbucketServerTriggerConfig = registerOutput<BitbucketServerTriggerConfigResponse>('bitbucketServerTriggerConfig');
    ...
    this.gitlabEnterpriseEventsConfig = registerOutput<GitLabEventsConfigResponse>('gitlabEnterpriseEventsConfig');
    ...
    this.repositoryEventConfig = registerOutput<RepositoryEventConfigResponse>('repositoryEventConfig');
    ...
    this.triggerTemplate = registerOutput<RepoSourceResponse>('triggerTemplate');
