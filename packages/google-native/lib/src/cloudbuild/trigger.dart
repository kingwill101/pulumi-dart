...
class Trigger extends pulumi.CustomResource {
  ...
  Trigger(
    ...
    this.approvalConfig = registerOutput<ApprovalConfigResponse>(
      'approvalConfig',
    );
    ...
    this.repositoryEventConfig = registerOutput<RepositoryEventConfigResponse>(
    ...
    this.triggerTemplate = registerOutput<RepoSourceResponse>(
      'triggerTemplate',
    );
