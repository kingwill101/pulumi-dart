...
class GithubEnterpriseConfigArgs {
  ...
  GithubEnterpriseConfigArgs({
    ...
    String? webhookKey,
        ...
        secrets =
            pulumi.Input.asOptionalInput<GitHubEnterpriseSecrets>(secrets),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (secretsValue != null) {
      map['secrets'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory GithubEnterpriseConfigArgs.fromMap(Map<String, dynamic> map) {
    return GithubEnterpriseConfigArgs(
      ...
      gheConfigId:
          map['gheConfigId'] == null ? null : map['gheConfigId'] as String,
