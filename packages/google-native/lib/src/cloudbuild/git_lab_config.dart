...
class GitLabConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GitLabRepositoryIdResponse>> connectedRepositories;
  ...
  GitLabConfig(
    ...
    this.connectedRepositories = registerOutput<List<GitLabRepositoryIdResponse>>('connectedRepositories');
    this.createTime = registerOutput<String>('createTime');
    this.enterpriseConfig = registerOutput<GitLabEnterpriseConfigResponse>('enterpriseConfig');
