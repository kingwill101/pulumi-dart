...
class BitbucketServerConfigArgs {
  ...
  factory BitbucketServerConfigArgs.fromMap(Map<String, dynamic> map) {
    return BitbucketServerConfigArgs(
      ...
      bitbucketServerConfigId: map['bitbucketServerConfigId'] == null ? null : map['bitbucketServerConfigId'] as String,
      ...
      peeredNetworkIpRange: map['peeredNetworkIpRange'] == null ? null : map['peeredNetworkIpRange'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      secrets: BitbucketServerSecrets.fromMap((map['secrets'] as Map).cast<String, dynamic>()),
