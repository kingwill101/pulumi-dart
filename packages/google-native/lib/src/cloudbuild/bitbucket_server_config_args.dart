...
class BitbucketServerConfigArgs {
  ...
  BitbucketServerConfigArgs({
    ...
    String? project,
    required BitbucketServerSecrets secrets,
    String? sslCa,
    String? username,
  })  : apiKey = pulumi.Input.asInput<String>(apiKey),
        bitbucketServerConfigId =
            pulumi.Input.asOptionalInput<String>(bitbucketServerConfigId),
        ...
        peeredNetworkIpRange =
            pulumi.Input.asOptionalInput<String>(peeredNetworkIpRange),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['secrets'] = pulumi.Input.mapInputValue<BitbucketServerSecrets,
  ...
  factory BitbucketServerConfigArgs.fromMap(Map<String, dynamic> map) {
    return BitbucketServerConfigArgs(
      ...
      bitbucketServerConfigId: map['bitbucketServerConfigId'] == null
          ? null
          : map['bitbucketServerConfigId'] as String,
      createTime:
