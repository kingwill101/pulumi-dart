...
class WorkerPoolCloudbuildV1alpha2Args {
  ...
  factory WorkerPoolCloudbuildV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return WorkerPoolCloudbuildV1alpha2Args(
      networkConfig: map['networkConfig'] == null ? null : NetworkConfigCloudbuildV1alpha2.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      workerConfig: map['workerConfig'] == null ? null : WorkerConfigCloudbuildV1alpha2.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
