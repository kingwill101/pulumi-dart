...
class SourceProvenanceResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resolvedConnectedRepository': resolvedConnectedRepository.toMap(),
      'resolvedGitSource': resolvedGitSource.toMap(),
      'resolvedRepoSource': resolvedRepoSource.toMap(),
      'resolvedStorageSource': resolvedStorageSource.toMap(),
      'resolvedStorageSourceManifest': resolvedStorageSourceManifest.toMap(),
    };
  }
  ...
  factory SourceProvenanceResponse.fromMap(Map<String, dynamic> map) {
    return SourceProvenanceResponse(
      ...
      resolvedConnectedRepository: ConnectedRepositoryResponse.fromMap((map['resolvedConnectedRepository'] as Map).cast<String, dynamic>()),
      resolvedGitSource: GitSourceResponse.fromMap((map['resolvedGitSource'] as Map).cast<String, dynamic>()),
      ...
      resolvedStorageSourceManifest: StorageSourceManifestResponse.fromMap((map['resolvedStorageSourceManifest'] as Map).cast<String, dynamic>()),
    );
  }
}
