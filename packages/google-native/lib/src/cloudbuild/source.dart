...
class Source {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectedRepository': ?connectedRepository == null ? null : connectedRepository!.toMap(),
      ...
      'storageSourceManifest': ?storageSourceManifest == null ? null : storageSourceManifest!.toMap(),
    };
  }

  factory Source.fromMap(Map<String, dynamic> map) {
    return Source(
      connectedRepository: map['connectedRepository'] == null ? null : ConnectedRepository.fromMap((map['connectedRepository'] as Map).cast<String, dynamic>()),
      gitSource: map['gitSource'] == null ? null : GitSource.fromMap((map['gitSource'] as Map).cast<String, dynamic>()),
      ...
      storageSourceManifest: map['storageSourceManifest'] == null ? null : StorageSourceManifest.fromMap((map['storageSourceManifest'] as Map).cast<String, dynamic>()),
    );
  }
}
