...
class BuildOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultLogsBucketBehavior': ?defaultLogsBucketBehavior == null ? null : defaultLogsBucketBehavior!.value,
      'diskSizeGb': ?diskSizeGb,
      'dynamicSubstitutions': ?dynamicSubstitutions,
      'env': ?env,
      'logStreamingOption': ?logStreamingOption == null ? null : logStreamingOption!.value,
      'logging': ?logging == null ? null : logging!.value,
      'machineType': ?machineType == null ? null : machineType!.value,
      'pool': ?pool == null ? null : pool!.toMap(),
      'requestedVerifyOption': ?requestedVerifyOption == null ? null : requestedVerifyOption!.value,
      'secretEnv': ?secretEnv,
      'sourceProvenanceHash': ?sourceProvenanceHash == null ? null : pulumi.Input.encodeList<BuildOptionsSourceProvenanceHashItem, String>(sourceProvenanceHash!, (value) => value.value),
      'substitutionOption': ?substitutionOption == null ? null : substitutionOption!.value,
  ...
  factory BuildOptions.fromMap(Map<String, dynamic> map) {
    return BuildOptions(
      ...
      defaultLogsBucketBehavior: map['defaultLogsBucketBehavior'] == null ? null : BuildOptionsDefaultLogsBucketBehavior.fromValue(map['defaultLogsBucketBehavior'] as String),
      ...
      logStreamingOption: map['logStreamingOption'] == null ? null : BuildOptionsLogStreamingOption.fromValue(map['logStreamingOption'] as String),
      logging: map['logging'] == null ? null : BuildOptionsLogging.fromValue(map['logging'] as String),
      machineType: map['machineType'] == null ? null : BuildOptionsMachineType.fromValue(map['machineType'] as String),
      pool: map['pool'] == null ? null : PoolOption.fromMap((map['pool'] as Map).cast<String, dynamic>()),
      requestedVerifyOption: map['requestedVerifyOption'] == null ? null : BuildOptionsRequestedVerifyOption.fromValue(map['requestedVerifyOption'] as String),
      secretEnv: map['secretEnv'] == null ? null : (map['secretEnv'] as List).cast<String>(),
      sourceProvenanceHash: map['sourceProvenanceHash'] == null ? null : pulumi.Input.decodeList<BuildOptionsSourceProvenanceHashItem>(map['sourceProvenanceHash'], (value) => BuildOptionsSourceProvenanceHashItem.fromValue(value as String)),
      substitutionOption: map['substitutionOption'] == null ? null : BuildOptionsSubstitutionOption.fromValue(map['substitutionOption'] as String),
