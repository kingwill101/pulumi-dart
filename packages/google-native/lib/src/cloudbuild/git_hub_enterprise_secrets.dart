...
class GitHubEnterpriseSecrets {
  ...
  factory GitHubEnterpriseSecrets.fromMap(Map<String, dynamic> map) {
    return GitHubEnterpriseSecrets(
      oauthClientIdName: map['oauthClientIdName'] == null ? null : map['oauthClientIdName'] as String,
      oauthClientIdVersionName: map['oauthClientIdVersionName'] == null ? null : map['oauthClientIdVersionName'] as String,
      oauthSecretName: map['oauthSecretName'] == null ? null : map['oauthSecretName'] as String,
      oauthSecretVersionName: map['oauthSecretVersionName'] == null ? null : map['oauthSecretVersionName'] as String,
      privateKeyName: map['privateKeyName'] == null ? null : map['privateKeyName'] as String,
      privateKeyVersionName: map['privateKeyVersionName'] == null ? null : map['privateKeyVersionName'] as String,
      webhookSecretName: map['webhookSecretName'] == null ? null : map['webhookSecretName'] as String,
      webhookSecretVersionName: map['webhookSecretVersionName'] == null ? null : map['webhookSecretVersionName'] as String,
    );
  }
}
