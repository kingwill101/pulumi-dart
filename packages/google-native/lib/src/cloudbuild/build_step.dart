...
class BuildStep {
  ...
  factory BuildStep.fromMap(Map<String, dynamic> map) {
    return BuildStep(
      allowExitCodes: map['allowExitCodes'] == null ? null : (map['allowExitCodes'] as List).cast<int>(),
      allowFailure: map['allowFailure'] == null ? null : map['allowFailure'] as bool,
      args: map['args'] == null ? null : (map['args'] as List).cast<String>(),
      automapSubstitutions: map['automapSubstitutions'] == null ? null : map['automapSubstitutions'] as bool,
      ...
      secretEnv: map['secretEnv'] == null ? null : (map['secretEnv'] as List).cast<String>(),
