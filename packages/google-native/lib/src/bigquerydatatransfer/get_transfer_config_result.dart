...
class GetTransferConfigResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dataRefreshWindowDays'] = dataRefreshWindowDays;
    map['dataSourceId'] = dataSourceId;
    map['datasetRegion'] = datasetRegion;
    map['destinationDatasetId'] = destinationDatasetId;
    map['disabled'] = disabled;
    map['displayName'] = displayName;
    map['emailPreferences'] = emailPreferences.toMap();
    map['encryptionConfiguration'] = encryptionConfiguration.toMap();
    map['name'] = name;
    map['nextRunTime'] = nextRunTime;
    map['notificationPubsubTopic'] = notificationPubsubTopic;
    map['ownerInfo'] = ownerInfo.toMap();
    map['params'] = params;
    map['schedule'] = schedule;
    map['scheduleOptions'] = scheduleOptions.toMap();
    map['state'] = state;
  ...
  factory GetTransferConfigResult.fromMap(Map<String, dynamic> map) {
    return GetTransferConfigResult(
      ...
      ownerInfo: UserInfoResponse.fromMap(
          (map['ownerInfo'] as Map).cast<String, dynamic>()),
      params: (map['params'] as Map).cast<String, String>(),
      schedule: map['schedule'] as String,
      scheduleOptions: ScheduleOptionsResponse.fromMap(
