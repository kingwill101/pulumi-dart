...
class TransferConfigArgs {
  ...
  TransferConfigArgs({
    ...
    String? versionInfo,
            ...
            pulumi.Input.asOptionalInput<String>(authorizationCode),
        ...
        emailPreferences =
            pulumi.Input.asOptionalInput<EmailPreferences>(emailPreferences),
        ...
        scheduleOptions =
            pulumi.Input.asOptionalInput<ScheduleOptions>(scheduleOptions),
        serviceAccountName =
  ...
  factory TransferConfigArgs.fromMap(Map<String, dynamic> map) {
    return TransferConfigArgs(
      ...
      versionInfo:
          map['versionInfo'] == null ? null : map['versionInfo'] as String,
    );
  }
}
