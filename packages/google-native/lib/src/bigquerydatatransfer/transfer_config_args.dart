...
class TransferConfigArgs {
  ...
  TransferConfigArgs({
    ...
    String? userId,
    String? versionInfo,
  }) : authorizationCode = pulumi.Input.asOptionalInput<String>(
         authorizationCode,
       ),
       ...
       scheduleOptions = pulumi.Input.asOptionalInput<ScheduleOptions>(
         scheduleOptions,
       ),
  ...
  factory TransferConfigArgs.fromMap(Map<String, dynamic> map) {
    return TransferConfigArgs(
      ...
      versionInfo: map['versionInfo'] == null
          ? null
          : map['versionInfo'] as String,
    );
  }
}
