...
class MethodPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'requestPolicies': ?requestPolicies == null ? null : pulumi.Input.encodeList<FieldPolicy, Map<String, dynamic>>(requestPolicies!, (value) => value.toMap()),
      'selector': ?selector,
    };
  }
  ...
  factory MethodPolicy.fromMap(Map<String, dynamic> map) {
    return MethodPolicy(
      requestPolicies: map['requestPolicies'] == null ? null : pulumi.Input.decodeList<FieldPolicy>(map['requestPolicies'], (value) => FieldPolicy.fromMap((value as Map).cast<String, dynamic>())),
