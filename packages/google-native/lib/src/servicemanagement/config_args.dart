...
class ConfigArgs {
  ...
  ConfigArgs({
    ...
    Usage? usage,
       ...
       documentation = pulumi.Input.asOptionalInput<Documentation>(
         documentation,
       ),
       ...
       producerProjectId = pulumi.Input.asOptionalInput<String>(
         producerProjectId,
       ),
  ...
  factory ConfigArgs.fromMap(Map<String, dynamic> map) {
    return ConfigArgs(
      ...
      configVersion: map['configVersion'] == null
          ? null
          : map['configVersion'] as int,
