...
class ConfigArgs {
  ...
  ConfigArgs({
    ...
    Usage? usage,
        ...
        documentation =
            pulumi.Input.asOptionalInput<Documentation>(documentation),
        ...
        systemParameters =
            pulumi.Input.asOptionalInput<SystemParameters>(systemParameters),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (endpointsValue != null) {
      map['endpoints'] = pulumi.Input.mapOptionalInputValue<List<Endpoint>,
              List<Map<String, dynamic>>>(
          endpointsValue,
    ...
    if (metricsValue != null) {
      map['metrics'] = pulumi.Input.mapOptionalInputValue<
              List<MetricDescriptor>, List<Map<String, dynamic>>>(
          metricsValue,
          (value) =>
    ...
    if (systemTypesValue != null) {
      map['systemTypes'] = pulumi.Input.mapOptionalInputValue<List<Type>,
              List<Map<String, dynamic>>>(
          systemTypesValue,
    ...
    if (typesValue != null) {
      map['types'] = pulumi.Input.mapOptionalInputValue<List<Type>,
              List<Map<String, dynamic>>>(
          typesValue,
          (value) => pulumi.Input.encodeList<Type, Map<String, dynamic>>(
              value, (value) => value.toMap()));
  ...
  factory ConfigArgs.fromMap(Map<String, dynamic> map) {
    return ConfigArgs(
      apis: map['apis'] == null
          ? null
          : pulumi.Input.decodeList<Api>(map['apis'],
      ...
      backend: map['backend'] == null
          ? null
          : Backend.fromMap((map['backend'] as Map).cast<String, dynamic>()),
      billing: map['billing'] == null
          ? null
          : Billing.fromMap((map['billing'] as Map).cast<String, dynamic>()),
      configVersion:
          map['configVersion'] == null ? null : map['configVersion'] as int,
      context: map['context'] == null
          ? null
          : Context.fromMap((map['context'] as Map).cast<String, dynamic>()),
      control: map['control'] == null
          ? null
          : Control.fromMap((map['control'] as Map).cast<String, dynamic>()),
      customError: map['customError'] == null
          ? null
          : CustomError.fromMap(
              (map['customError'] as Map).cast<String, dynamic>()),
      documentation: map['documentation'] == null
          ? null
          : Documentation.fromMap(
      ...
      endpoints: map['endpoints'] == null
          ...
          : pulumi.Input.decodeList<Endpoint>(
              map['endpoints'],
              (value) =>
                  Endpoint.fromMap((value as Map).cast<String, dynamic>())),
      enums: map['enums'] == null
          ? null
          : pulumi.Input.decodeList<Enum>(map['enums'],
              (value) => Enum.fromMap((value as Map).cast<String, dynamic>())),
      http: map['http'] == null
          ? null
          : Http.fromMap((map['http'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      logging: map['logging'] == null
          ? null
          : Logging.fromMap((map['logging'] as Map).cast<String, dynamic>()),
      logs: map['logs'] == null
          ? null
          : pulumi.Input.decodeList<LogDescriptor>(
              map['logs'],
              (value) => LogDescriptor.fromMap(
      ...
      publishing: map['publishing'] == null
          ? null
          : Publishing.fromMap(
              (map['publishing'] as Map).cast<String, dynamic>()),
      quota: map['quota'] == null
          ? null
          : Quota.fromMap((map['quota'] as Map).cast<String, dynamic>()),
      serviceName: map['serviceName'] as String,
      systemParameters: map['systemParameters'] == null
          ? null
          : SystemParameters.fromMap(
              (map['systemParameters'] as Map).cast<String, dynamic>()),
      systemTypes: map['systemTypes'] == null
          ? null
          : pulumi.Input.decodeList<Type>(map['systemTypes'],
              (value) => Type.fromMap((value as Map).cast<String, dynamic>())),
      title: map['title'] == null ? null : map['title'] as String,
      types: map['types'] == null
          ? null
          : pulumi.Input.decodeList<Type>(map['types'],
              (value) => Type.fromMap((value as Map).cast<String, dynamic>())),
      usage: map['usage'] == null
          ? null
          : Usage.fromMap((map['usage'] as Map).cast<String, dynamic>()),
    );
  }
}
