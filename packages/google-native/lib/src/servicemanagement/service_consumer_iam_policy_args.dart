...
/// {@template pulumi_servicemanagement_v1_service_consumer_iam_policy_args_doc}
/// The set of arguments for ServiceConsumerIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_servicemanagement_v1_service_consumer_iam_policy_args_doc}
class ServiceConsumerIamPolicyArgs {
  ...
  /// Creates a new [ServiceConsumerIamPolicyArgs].
  ...
  factory ServiceConsumerIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConsumerIamPolicyArgs(
