...
class Publishing {
  ...
  factory Publishing.fromMap(Map<String, dynamic> map) {
    return Publishing(
      apiShortName: map['apiShortName'] == null
          ? null
          : map['apiShortName'] as String,
      codeownerGithubTeams: map['codeownerGithubTeams'] == null
          ? null
          : (map['codeownerGithubTeams'] as List).cast<String>(),
      docTagPrefix: map['docTagPrefix'] == null
          ? null
          : map['docTagPrefix'] as String,
      documentationUri: map['documentationUri'] == null
          ? null
          : map['documentationUri'] as String,
      githubLabel: map['githubLabel'] == null
          ? null
          : map['githubLabel'] as String,
      ...
      newIssueUri: map['newIssueUri'] == null
          ? null
          : map['newIssueUri'] as String,
