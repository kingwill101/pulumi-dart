...
class UsageRule {
  ...
  factory UsageRule.fromMap(Map<String, dynamic> map) {
    return UsageRule(
      allowUnregisteredCalls: map['allowUnregisteredCalls'] == null ? null : map['allowUnregisteredCalls'] as bool,
      selector: map['selector'] == null ? null : map['selector'] as String,
      skipServiceControl: map['skipServiceControl'] == null ? null : map['skipServiceControl'] as bool,
    );
  }
}
