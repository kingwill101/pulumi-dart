...
class Config extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MonitoredResourceDescriptorResponse>> monitoredResources;
  ...
  Config(
    ...
    this.monitoredResources = registerOutput<List<MonitoredResourceDescriptorResponse>>('monitoredResources');
    ...
    this.systemParameters = registerOutput<SystemParametersResponse>('systemParameters');
