...
class HttpRule {
  ...
  Map<String, dynamic> toMap() {
    ...
    final additionalBindingsValue = additionalBindings;
    if (additionalBindingsValue != null) {
      map['additionalBindings'] =
          pulumi.Input.encodeList<HttpRule, Map<String, dynamic>>(
              additionalBindingsValue, (value) => value.toMap());
    }
    ...
    final patchValue = patch;
    if (patchValue != null) {
      map['patch'] = patchValue;
    }
    final postValue = post;
    if (postValue != null) {
      map['post'] = postValue;
    }
    final putValue = put;
    ...
    final responseBodyValue = responseBody;
    if (responseBodyValue != null) {
      map['responseBody'] = responseBodyValue;
    }
  ...
  factory HttpRule.fromMap(Map<String, dynamic> map) {
    return HttpRule(
      additionalBindings: map['additionalBindings'] == null
          ? null
