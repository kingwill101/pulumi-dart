...
class PageResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'content': content,
      'name': name,
      'subpages': pulumi.Input.encodeList<PageResponse, Map<String, dynamic>>(subpages, (value) => value.toMap()),
    };
  }
  ...
  factory PageResponse.fromMap(Map<String, dynamic> map) {
    return PageResponse(
      ...
      subpages: pulumi.Input.decodeList<PageResponse>(map['subpages'], (value) => PageResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
