...
class AuthProviderResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'issuer': issuer,
      'jwksUri': jwksUri,
      'jwtLocations': pulumi.Input.encodeList<JwtLocationResponse, Map<String, dynamic>>(jwtLocations, (value) => value.toMap()),
    };
  }
  ...
  factory AuthProviderResponse.fromMap(Map<String, dynamic> map) {
    return AuthProviderResponse(
      ...
      jwtLocations: pulumi.Input.decodeList<JwtLocationResponse>(map['jwtLocations'], (value) => JwtLocationResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
