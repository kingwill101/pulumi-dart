...
class BackendRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pathTranslation': ?pathTranslation == null ? null : pathTranslation!.value,
      'protocol': ?protocol,
      'selector': ?selector,
    };
  }
  ...
  factory BackendRule.fromMap(Map<String, dynamic> map) {
    return BackendRule(
      ...
      jwtAudience: map['jwtAudience'] == null ? null : map['jwtAudience'] as String,
      minDeadline: map['minDeadline'] == null ? null : map['minDeadline'] as double,
      operationDeadline: map['operationDeadline'] == null ? null : map['operationDeadline'] as double,
      overridesByRequestProtocol: map['overridesByRequestProtocol'] == null ? null : (map['overridesByRequestProtocol'] as Map).cast<String, String>(),
      pathTranslation: map['pathTranslation'] == null ? null : BackendRulePathTranslation.fromValue(map['pathTranslation'] as String),
