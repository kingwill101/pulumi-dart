...
import 'backend_rule_path_translation.dart';
...
class BackendRule {
  ...
  final BackendRulePathTranslation? pathTranslation;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (deadlineValue != null) {
      map['deadline'] = deadlineValue;
    }
    final disableAuthValue = disableAuth;
    if (disableAuthValue != null) {
      map['disableAuth'] = disableAuthValue;
    }
    final jwtAudienceValue = jwtAudience;
    if (jwtAudienceValue != null) {
      map['jwtAudience'] = jwtAudienceValue;
    }
    final minDeadlineValue = minDeadline;
    if (minDeadlineValue != null) {
      map['minDeadline'] = minDeadlineValue;
    }
    final operationDeadlineValue = operationDeadline;
    if (operationDeadlineValue != null) {
      map['operationDeadline'] = operationDeadlineValue;
    }
    final overridesByRequestProtocolValue = overridesByRequestProtocol;
    if (overridesByRequestProtocolValue != null) {
      map['overridesByRequestProtocol'] = overridesByRequestProtocolValue;
    }
    final pathTranslationValue = pathTranslation;
    if (pathTranslationValue != null) {
      map['pathTranslation'] = pathTranslationValue.value;
    }
  ...
  factory BackendRule.fromMap(Map<String, dynamic> map) {
    return BackendRule(
      ...
      deadline: map['deadline'] == null ? null : map['deadline'] as double,
      disableAuth:
          map['disableAuth'] == null ? null : map['disableAuth'] as bool,
      jwtAudience:
          map['jwtAudience'] == null ? null : map['jwtAudience'] as String,
      minDeadline:
          map['minDeadline'] == null ? null : map['minDeadline'] as double,
      operationDeadline: map['operationDeadline'] == null
          ? null
          : map['operationDeadline'] as double,
      overridesByRequestProtocol: map['overridesByRequestProtocol'] == null
          ? null
          : (map['overridesByRequestProtocol'] as Map).cast<String, String>(),
      pathTranslation: map['pathTranslation'] == null
          ? null
          : BackendRulePathTranslation.fromValue(
              map['pathTranslation'] as String),
