...
class JavaSettings {
  ...
  factory JavaSettings.fromMap(Map<String, dynamic> map) {
    return JavaSettings(
      ...
      libraryPackage: map['libraryPackage'] == null ? null : map['libraryPackage'] as String,
      serviceClassNames: map['serviceClassNames'] == null ? null : (map['serviceClassNames'] as Map).cast<String, String>(),
    );
  }
}
