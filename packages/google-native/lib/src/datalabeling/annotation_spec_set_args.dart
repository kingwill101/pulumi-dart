...
class AnnotationSpecSetArgs {
  ...
  factory AnnotationSpecSetArgs.fromMap(Map<String, dynamic> map) {
    return AnnotationSpecSetArgs(
      annotationSpecs: pulumi.Input.decodeList<GoogleCloudDatalabelingV1beta1AnnotationSpec>(map['annotationSpecs'], (value) => GoogleCloudDatalabelingV1beta1AnnotationSpec.fromMap((value as Map).cast<String, dynamic>())),
