...
class InstructionArgs {
  ...
  factory InstructionArgs.fromMap(Map<String, dynamic> map) {
    return InstructionArgs(
      csvInstruction: map['csvInstruction'] == null ? null : GoogleCloudDatalabelingV1beta1CsvInstruction.fromMap((map['csvInstruction'] as Map).cast<String, dynamic>()),
      dataType: InstructionDataType.fromValue(map['dataType'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      pdfInstruction: map['pdfInstruction'] == null ? null : GoogleCloudDatalabelingV1beta1PdfInstruction.fromMap((map['pdfInstruction'] as Map).cast<String, dynamic>()),
