...
class EvaluationJobArgs {
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1EvaluationJobConfig>
      evaluationJobConfig;
  ...
  EvaluationJobArgs({
    required String annotationSpecSet,
    required String description,
    required GoogleCloudDatalabelingV1beta1EvaluationJobConfig
        evaluationJobConfig,
    required bool labelMissingGroundTruth,
    required String modelVersion,
    String? project,
    required String schedule,
  })  : annotationSpecSet = pulumi.Input.asInput<String>(annotationSpecSet),
        description = pulumi.Input.asInput<String>(description),
        evaluationJobConfig = pulumi.Input.asInput<
                GoogleCloudDatalabelingV1beta1EvaluationJobConfig>(
            evaluationJobConfig),
        labelMissingGroundTruth =
            pulumi.Input.asInput<bool>(labelMissingGroundTruth),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['evaluationJobConfig'] = pulumi.Input.mapInputValue<
        GoogleCloudDatalabelingV1beta1EvaluationJobConfig,
  ...
  factory EvaluationJobArgs.fromMap(Map<String, dynamic> map) {
    return EvaluationJobArgs(
      ...
      evaluationJobConfig:
          GoogleCloudDatalabelingV1beta1EvaluationJobConfig.fromMap(
