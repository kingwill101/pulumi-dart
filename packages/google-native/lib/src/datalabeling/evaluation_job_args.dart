...
class EvaluationJobArgs {
  ...
  EvaluationJobArgs({
    ...
    required GoogleCloudDatalabelingV1beta1EvaluationJobConfig evaluationJobConfig,
  ...
  factory EvaluationJobArgs.fromMap(Map<String, dynamic> map) {
    return EvaluationJobArgs(
      ...
      evaluationJobConfig: GoogleCloudDatalabelingV1beta1EvaluationJobConfig.fromMap((map['evaluationJobConfig'] as Map).cast<String, dynamic>()),
