...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse {
  ...
  final GoogleCloudDatalabelingV1beta1BoundingPolyConfigResponse boundingPolyConfig;
  ...
  final GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfigResponse evaluationJobAlertConfig;
  ...
  final GoogleCloudDatalabelingV1beta1HumanAnnotationConfigResponse humanAnnotationConfig;
  ...
  final GoogleCloudDatalabelingV1beta1ImageClassificationConfigResponse imageClassificationConfig;
  ...
  final GoogleCloudDatalabelingV1beta1TextClassificationConfigResponse textClassificationConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'boundingPolyConfig': boundingPolyConfig.toMap(),
      'evaluationConfig': evaluationConfig.toMap(),
      'evaluationJobAlertConfig': evaluationJobAlertConfig.toMap(),
      'exampleCount': exampleCount,
      'exampleSamplePercentage': exampleSamplePercentage,
      'humanAnnotationConfig': humanAnnotationConfig.toMap(),
      'imageClassificationConfig': imageClassificationConfig.toMap(),
      'inputConfig': inputConfig.toMap(),
      'textClassificationConfig': textClassificationConfig.toMap(),
    };
  }
  ...
  factory GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse(
      ...
      boundingPolyConfig: GoogleCloudDatalabelingV1beta1BoundingPolyConfigResponse.fromMap((map['boundingPolyConfig'] as Map).cast<String, dynamic>()),
      evaluationConfig: GoogleCloudDatalabelingV1beta1EvaluationConfigResponse.fromMap((map['evaluationConfig'] as Map).cast<String, dynamic>()),
      evaluationJobAlertConfig: GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfigResponse.fromMap((map['evaluationJobAlertConfig'] as Map).cast<String, dynamic>()),
      exampleCount: map['exampleCount'] as int,
      exampleSamplePercentage: map['exampleSamplePercentage'] as double,
      humanAnnotationConfig: GoogleCloudDatalabelingV1beta1HumanAnnotationConfigResponse.fromMap((map['humanAnnotationConfig'] as Map).cast<String, dynamic>()),
      imageClassificationConfig: GoogleCloudDatalabelingV1beta1ImageClassificationConfigResponse.fromMap((map['imageClassificationConfig'] as Map).cast<String, dynamic>()),
      inputConfig: GoogleCloudDatalabelingV1beta1InputConfigResponse.fromMap((map['inputConfig'] as Map).cast<String, dynamic>()),
      textClassificationConfig: GoogleCloudDatalabelingV1beta1TextClassificationConfigResponse.fromMap((map['textClassificationConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
