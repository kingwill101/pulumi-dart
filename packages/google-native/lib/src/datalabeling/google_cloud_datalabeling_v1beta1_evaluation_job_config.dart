...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'boundingPolyConfig': ?boundingPolyConfig == null
          ? null
          : boundingPolyConfig!.toMap(),
      'evaluationConfig': evaluationConfig.toMap(),
      'evaluationJobAlertConfig': ?evaluationJobAlertConfig == null
          ? null
          : evaluationJobAlertConfig!.toMap(),
      'exampleCount': exampleCount,
      'exampleSamplePercentage': exampleSamplePercentage,
      'humanAnnotationConfig': ?humanAnnotationConfig == null
          ? null
          : humanAnnotationConfig!.toMap(),
      'imageClassificationConfig': ?imageClassificationConfig == null
          ? null
          : imageClassificationConfig!.toMap(),
      'inputConfig': ?inputConfig == null ? null : inputConfig!.toMap(),
      'textClassificationConfig': ?textClassificationConfig == null
          ? null
          : textClassificationConfig!.toMap(),
    };
  }
  ...
  factory GoogleCloudDatalabelingV1beta1EvaluationJobConfig.fromMap(
    ...
    return GoogleCloudDatalabelingV1beta1EvaluationJobConfig(
      bigqueryImportKeys: (map['bigqueryImportKeys'] as Map)
          .cast<String, String>(),
      ...
      imageClassificationConfig: map['imageClassificationConfig'] == null
          ...
          : GoogleCloudDatalabelingV1beta1ImageClassificationConfig.fromMap(
              (map['imageClassificationConfig'] as Map).cast<String, dynamic>(),
            ),
