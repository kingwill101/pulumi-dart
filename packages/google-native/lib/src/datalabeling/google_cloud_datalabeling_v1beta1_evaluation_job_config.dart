...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfig {
  ...
  final GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfig?
  ...
  final GoogleCloudDatalabelingV1beta1HumanAnnotationConfig?
  ...
  final GoogleCloudDatalabelingV1beta1ImageClassificationConfig?
  ...
  final GoogleCloudDatalabelingV1beta1TextClassificationConfig?
  ...
  Map<String, dynamic> toMap() {
    ...
    final boundingPolyConfigValue = boundingPolyConfig;
    if (boundingPolyConfigValue != null) {
      map['boundingPolyConfig'] = boundingPolyConfigValue.toMap();
    }
    map['evaluationConfig'] = evaluationConfig.toMap();
    final evaluationJobAlertConfigValue = evaluationJobAlertConfig;
    if (evaluationJobAlertConfigValue != null) {
      map['evaluationJobAlertConfig'] = evaluationJobAlertConfigValue.toMap();
    }
    map['exampleCount'] = exampleCount;
    map['exampleSamplePercentage'] = exampleSamplePercentage;
    final humanAnnotationConfigValue = humanAnnotationConfig;
    if (humanAnnotationConfigValue != null) {
      map['humanAnnotationConfig'] = humanAnnotationConfigValue.toMap();
    }
    final imageClassificationConfigValue = imageClassificationConfig;
    if (imageClassificationConfigValue != null) {
      map['imageClassificationConfig'] = imageClassificationConfigValue.toMap();
    }
    final inputConfigValue = inputConfig;
    if (inputConfigValue != null) {
      map['inputConfig'] = inputConfigValue.toMap();
    }
    final textClassificationConfigValue = textClassificationConfig;
    if (textClassificationConfigValue != null) {
      map['textClassificationConfig'] = textClassificationConfigValue.toMap();
    }
    return map;
  }
