...
class NetworkConfigResponseTpuV2alpha1 {
  ...
  /// Creates a new [NetworkConfigResponseTpuV2alpha1].
  ...
  factory NetworkConfigResponseTpuV2alpha1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseTpuV2alpha1(
