...
class QueuedResourceArgs {
  ...
  factory QueuedResourceArgs.fromMap(Map<String, dynamic> map) {
    return QueuedResourceArgs(
      bestEffort: map['bestEffort'] == null ? null : (map['bestEffort'] as Map).cast<String, dynamic>(),
      guaranteed: map['guaranteed'] == null ? null : Guaranteed.fromMap((map['guaranteed'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      queuedResourceId: map['queuedResourceId'] == null ? null : map['queuedResourceId'] as String,
      queueingPolicy: map['queueingPolicy'] == null ? null : QueueingPolicy.fromMap((map['queueingPolicy'] as Map).cast<String, dynamic>()),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      reservationName: map['reservationName'] == null ? null : map['reservationName'] as String,
      spot: map['spot'] == null ? null : (map['spot'] as Map).cast<String, dynamic>(),
      tpu: map['tpu'] == null ? null : Tpu.fromMap((map['tpu'] as Map).cast<String, dynamic>()),
    );
  }
}
