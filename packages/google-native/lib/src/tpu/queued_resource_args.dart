...
class QueuedResourceArgs {
  ...
  QueuedResourceArgs({
    ...
    Tpu? tpu,
            ...
            pulumi.Input.asOptionalInput<Map<String, dynamic>>(bestEffort),
        guaranteed = pulumi.Input.asOptionalInput<Guaranteed>(guaranteed),
        location = pulumi.Input.asOptionalInput<String>(location),
        project = pulumi.Input.asOptionalInput<String>(project),
        queuedResourceId =
            pulumi.Input.asOptionalInput<String>(queuedResourceId),
        queueingPolicy =
            pulumi.Input.asOptionalInput<QueueingPolicy>(queueingPolicy),
