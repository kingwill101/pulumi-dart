...
class NodeTpuV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkEndpointResponseTpuV1alpha1>> networkEndpoints;
  ...
  late final pulumi.Output<SchedulingConfigResponseTpuV1alpha1> schedulingConfig;
  ...
  late final pulumi.Output<List<SymptomResponseTpuV1alpha1>> symptoms;
  ...
  /// Creates a new [NodeTpuV1alpha1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NodeTpuV1alpha1]. {@macro pulumi_tpu_v1alpha1_node_tpu_v1alpha1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  NodeTpuV1alpha1(
    String name, {
    NodeTpuV1alpha1Args? args,
    ...
    this.networkEndpoints = registerOutput<List<NetworkEndpointResponseTpuV1alpha1>>('networkEndpoints');
    this.nodeId = registerOutput<String?>('nodeId');
    this.port = registerOutput<String>('port');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.schedulingConfig = registerOutput<SchedulingConfigResponseTpuV1alpha1>('schedulingConfig');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.state = registerOutput<String>('state');
    this.symptoms = registerOutput<List<SymptomResponseTpuV1alpha1>>('symptoms');
