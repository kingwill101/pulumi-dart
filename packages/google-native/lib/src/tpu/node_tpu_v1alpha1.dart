...
class NodeTpuV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkEndpointResponseTpuV1alpha1>>
  networkEndpoints;
  ...
  late final pulumi.Output<SchedulingConfigResponseTpuV1alpha1>
  schedulingConfig;
  ...
  NodeTpuV1alpha1(
    ...
    this.networkEndpoints =
        registerOutput<List<NetworkEndpointResponseTpuV1alpha1>>(
          'networkEndpoints',
        );
    ...
    this.schedulingConfig = registerOutput<SchedulingConfigResponseTpuV1alpha1>(
      'schedulingConfig',
    );
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.state = registerOutput<String>('state');
    this.symptoms = registerOutput<List<SymptomResponseTpuV1alpha1>>(
      'symptoms',
    );
