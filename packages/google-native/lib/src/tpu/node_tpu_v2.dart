...
class NodeTpuV2 extends pulumi.CustomResource {
  ...
  NodeTpuV2(
    ...
    this.networkEndpoints = registerOutput<List<NetworkEndpointResponseTpuV2>>(
      'networkEndpoints',
    );
    ...
    this.schedulingConfig = registerOutput<SchedulingConfigResponseTpuV2>(
      'schedulingConfig',
    );
    this.serviceAccount = registerOutput<ServiceAccountResponse>(
      'serviceAccount',
    );
