...
class NodeArgs {
  ...
  factory NodeArgs.fromMap(Map<String, dynamic> map) {
    return NodeArgs(
      ...
      health: map['health'] == null ? null : NodeHealth.fromValue(map['health'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      nodeId: map['nodeId'] == null ? null : map['nodeId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      schedulingConfig: map['schedulingConfig'] == null ? null : SchedulingConfig.fromMap((map['schedulingConfig'] as Map).cast<String, dynamic>()),
