...
class GetNodeResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'network': network,
      'networkEndpoints': pulumi.Input.encodeList<NetworkEndpointResponse, Map<String, dynamic>>(networkEndpoints, (value) => value.toMap()),
      'port': port,
      'schedulingConfig': schedulingConfig.toMap(),
      'serviceAccount': serviceAccount,
      'state': state,
      'symptoms': pulumi.Input.encodeList<SymptomResponse, Map<String, dynamic>>(symptoms, (value) => value.toMap()),
  ...
  factory GetNodeResult.fromMap(Map<String, dynamic> map) {
    return GetNodeResult(
      ...
      networkEndpoints: pulumi.Input.decodeList<NetworkEndpointResponse>(map['networkEndpoints'], (value) => NetworkEndpointResponse.fromMap((value as Map).cast<String, dynamic>())),
      port: map['port'] as String,
      schedulingConfig: SchedulingConfigResponse.fromMap((map['schedulingConfig'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      state: map['state'] as String,
      symptoms: pulumi.Input.decodeList<SymptomResponse>(map['symptoms'], (value) => SymptomResponse.fromMap((value as Map).cast<String, dynamic>())),
