...
class NodeTpuV1alpha1Args {
  ...
  factory NodeTpuV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return NodeTpuV1alpha1Args(
      ...
      health: map['health'] == null ? null : NodeHealthTpuV1alpha1.fromValue(map['health'] as String),
      ...
      schedulingConfig: map['schedulingConfig'] == null ? null : SchedulingConfigTpuV1alpha1.fromMap((map['schedulingConfig'] as Map).cast<String, dynamic>()),
