...
class SmartSharding {
  ...
  Map<String, dynamic> toMap() {
    ...
    final targetedShardDurationValue = targetedShardDuration;
    if (targetedShardDurationValue != null) {
      map['targetedShardDuration'] = targetedShardDurationValue;
    }
    return map;
  }
  ...
  factory SmartSharding.fromMap(Map<String, dynamic> map) {
    return SmartSharding(
      targetedShardDuration: map['targetedShardDuration'] == null
          ? null
          : map['targetedShardDuration'] as String,
    );
  }
}
