...
class AndroidInstrumentationTest {
  ...
  Map<String, dynamic> toMap() {
    ...
    final orchestratorOptionValue = orchestratorOption;
    if (orchestratorOptionValue != null) {
      map['orchestratorOption'] = orchestratorOptionValue.value;
    }
    final shardingOptionValue = shardingOption;
    if (shardingOptionValue != null) {
      map['shardingOption'] = shardingOptionValue.toMap();
    }
