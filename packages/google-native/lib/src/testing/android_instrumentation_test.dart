...
class AndroidInstrumentationTest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'orchestratorOption': ?orchestratorOption == null ? null : orchestratorOption!.value,
      'shardingOption': ?shardingOption == null ? null : shardingOption!.toMap(),
  ...
  factory AndroidInstrumentationTest.fromMap(Map<String, dynamic> map) {
    return AndroidInstrumentationTest(
      ...
      orchestratorOption: map['orchestratorOption'] == null ? null : AndroidInstrumentationTestOrchestratorOption.fromValue(map['orchestratorOption'] as String),
      shardingOption: map['shardingOption'] == null ? null : ShardingOption.fromMap((map['shardingOption'] as Map).cast<String, dynamic>()),
      testApk: FileReference.fromMap((map['testApk'] as Map).cast<String, dynamic>()),
      testPackageId: map['testPackageId'] == null ? null : map['testPackageId'] as String,
      testRunnerClass: map['testRunnerClass'] == null ? null : map['testRunnerClass'] as String,
