  ...
  factory TestSetupResponse.fromMap(Map<String, dynamic> map) {
    return TestSetupResponse(
      ...
      additionalApks: pulumi.Input.decodeList<ApkResponse>(
        map['additionalApks'],
        (value) => ApkResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      filesToPush: pulumi.Input.decodeList<DeviceFileResponse>(
        map['filesToPush'],
        (value) =>
            DeviceFileResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      systrace: SystraceSetupResponse.fromMap(
