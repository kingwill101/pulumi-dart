...
class IosTestSetupResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalIpas': pulumi.Input.encodeList<FileReferenceResponse, Map<String, dynamic>>(additionalIpas, (value) => value.toMap()),
      'networkProfile': networkProfile,
      'pullDirectories': pulumi.Input.encodeList<IosDeviceFileResponse, Map<String, dynamic>>(pullDirectories, (value) => value.toMap()),
      'pushFiles': pulumi.Input.encodeList<IosDeviceFileResponse, Map<String, dynamic>>(pushFiles, (value) => value.toMap()),
    };
  }

  factory IosTestSetupResponse.fromMap(Map<String, dynamic> map) {
    return IosTestSetupResponse(
      additionalIpas: pulumi.Input.decodeList<FileReferenceResponse>(map['additionalIpas'], (value) => FileReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
      networkProfile: map['networkProfile'] as String,
      pullDirectories: pulumi.Input.decodeList<IosDeviceFileResponse>(map['pullDirectories'], (value) => IosDeviceFileResponse.fromMap((value as Map).cast<String, dynamic>())),
      pushFiles: pulumi.Input.decodeList<IosDeviceFileResponse>(map['pushFiles'], (value) => IosDeviceFileResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
