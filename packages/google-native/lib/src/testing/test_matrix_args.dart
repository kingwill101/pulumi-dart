...
class TestMatrixArgs {
  ...
  TestMatrixArgs({
    ...
    required TestSpecification testSpecification,
        ...
        environmentMatrix =
            pulumi.Input.asInput<EnvironmentMatrix>(environmentMatrix),
        failFast = pulumi.Input.asOptionalInput<bool>(failFast),
        flakyTestAttempts =
            pulumi.Input.asOptionalInput<int>(flakyTestAttempts),
        project = pulumi.Input.asOptionalInput<String>(project),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        resultStorage = pulumi.Input.asInput<ResultStorage>(resultStorage),
        testSpecification =
            pulumi.Input.asInput<TestSpecification>(testSpecification);
  ...
  factory TestMatrixArgs.fromMap(Map<String, dynamic> map) {
    return TestMatrixArgs(
      clientInfo: map['clientInfo'] == null
          ? null
          : ClientInfo.fromMap(
              (map['clientInfo'] as Map).cast<String, dynamic>()),
      environmentMatrix: EnvironmentMatrix.fromMap(
          (map['environmentMatrix'] as Map).cast<String, dynamic>()),
      failFast: map['failFast'] == null ? null : map['failFast'] as bool,
      flakyTestAttempts: map['flakyTestAttempts'] == null
          ? null
          : map['flakyTestAttempts'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      resultStorage: ResultStorage.fromMap(
          (map['resultStorage'] as Map).cast<String, dynamic>()),
      testSpecification: TestSpecification.fromMap(
