...
class TestMatrixArgs {
  ...
  TestMatrixArgs({
    ...
    required EnvironmentMatrix environmentMatrix,
    bool? failFast,
    int? flakyTestAttempts,
    String? project,
    String? requestId,
    required ResultStorage resultStorage,
    required TestSpecification testSpecification,
  }) :
  ...
  factory TestMatrixArgs.fromMap(Map<String, dynamic> map) {
    return TestMatrixArgs(
      clientInfo: map['clientInfo'] == null ? null : ClientInfo.fromMap((map['clientInfo'] as Map).cast<String, dynamic>()),
      environmentMatrix: EnvironmentMatrix.fromMap((map['environmentMatrix'] as Map).cast<String, dynamic>()),
      failFast: map['failFast'] == null ? null : map['failFast'] as bool,
      flakyTestAttempts: map['flakyTestAttempts'] == null ? null : map['flakyTestAttempts'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      resultStorage: ResultStorage.fromMap((map['resultStorage'] as Map).cast<String, dynamic>()),
      testSpecification: TestSpecification.fromMap((map['testSpecification'] as Map).cast<String, dynamic>()),
    );
  }
}
