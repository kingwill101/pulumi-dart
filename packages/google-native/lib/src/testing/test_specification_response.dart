...
class TestSpecificationResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['androidTestLoop'] = androidTestLoop.toMap();
    map['disablePerformanceMetrics'] = disablePerformanceMetrics;
    map['disableVideoRecording'] = disableVideoRecording;
    map['iosRoboTest'] = iosRoboTest.toMap();
    map['iosTestLoop'] = iosTestLoop.toMap();
    map['iosTestSetup'] = iosTestSetup.toMap();
    map['iosXcTest'] = iosXcTest.toMap();
    map['testSetup'] = testSetup.toMap();
    map['testTimeout'] = testTimeout;
    return map;
  }
