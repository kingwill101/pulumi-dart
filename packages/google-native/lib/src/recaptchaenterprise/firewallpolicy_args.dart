...
class FirewallpolicyArgs {
  ...
  /// [project] Optional.
  FirewallpolicyArgs({
    List<GoogleCloudRecaptchaenterpriseV1FirewallAction>? actions,
    String? condition,
    String? description,
    String? name,
    String? path,
  ...
  factory FirewallpolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallpolicyArgs(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<GoogleCloudRecaptchaenterpriseV1FirewallAction>(map['actions'], (value) => GoogleCloudRecaptchaenterpriseV1FirewallAction.fromMap((value as Map).cast<String, dynamic>())),
