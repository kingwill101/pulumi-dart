...
class Key extends pulumi.CustomResource {
  ...
  Key(
    ...
    this.androidSettings = registerOutput<GoogleCloudRecaptchaenterpriseV1AndroidKeySettingsResponse>('androidSettings');
    this.createTime = registerOutput<String>('createTime');
    this.displayName = registerOutput<String>('displayName');
    this.iosSettings = registerOutput<GoogleCloudRecaptchaenterpriseV1IOSKeySettingsResponse>('iosSettings');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.testingOptions = registerOutput<GoogleCloudRecaptchaenterpriseV1TestingOptionsResponse>('testingOptions');
    this.wafSettings = registerOutput<GoogleCloudRecaptchaenterpriseV1WafSettingsResponse>('wafSettings');
    this.webSettings = registerOutput<GoogleCloudRecaptchaenterpriseV1WebKeySettingsResponse>('webSettings');
  }
}
