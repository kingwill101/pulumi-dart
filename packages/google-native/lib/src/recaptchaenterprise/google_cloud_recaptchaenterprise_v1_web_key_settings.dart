...
class GoogleCloudRecaptchaenterpriseV1WebKeySettings {
  ...
  final GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference?
      challengeSecurityPreference;

  /// Describes how this key is integrated with the website.
  final GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType
      integrationType;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (challengeSecurityPreferenceValue != null) {
      map['challengeSecurityPreference'] =
          challengeSecurityPreferenceValue.value;
    }
    ...
    return GoogleCloudRecaptchaenterpriseV1WebKeySettings(
      ...
      challengeSecurityPreference: map['challengeSecurityPreference'] == null
          ...
          : GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference
              .fromValue(map['challengeSecurityPreference'] as String),
      integrationType:
          GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType
              .fromValue(map['integrationType'] as String),
    );
  }
}
