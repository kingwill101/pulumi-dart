...
class GoogleCloudRecaptchaenterpriseV1FirewallAction {
  ...
  final GoogleCloudRecaptchaenterpriseV1FirewallActionSetHeaderAction? setHeader;
  /// This action will transparently serve a different page to an offending user.
  final GoogleCloudRecaptchaenterpriseV1FirewallActionSubstituteAction? substitute;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'block': ?block,
      'redirect': ?redirect,
      'setHeader': ?setHeader == null ? null : setHeader!.toMap(),
      'substitute': ?substitute == null ? null : substitute!.toMap(),
    };
  }
  ...
  factory GoogleCloudRecaptchaenterpriseV1FirewallAction.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecaptchaenterpriseV1FirewallAction(
      ...
      block: map['block'] == null ? null : (map['block'] as Map).cast<String, dynamic>(),
      redirect: map['redirect'] == null ? null : (map['redirect'] as Map).cast<String, dynamic>(),
      setHeader: map['setHeader'] == null ? null : GoogleCloudRecaptchaenterpriseV1FirewallActionSetHeaderAction.fromMap((map['setHeader'] as Map).cast<String, dynamic>()),
      substitute: map['substitute'] == null ? null : GoogleCloudRecaptchaenterpriseV1FirewallActionSubstituteAction.fromMap((map['substitute'] as Map).cast<String, dynamic>()),
    );
  }
}
