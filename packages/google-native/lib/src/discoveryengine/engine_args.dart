...
class EngineArgs {
  ...
  EngineArgs({
    ...
    String? location,
    GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfig? mediaRecommendationEngineConfig,
    String? name,
    String? project,
  ...
  factory EngineArgs.fromMap(Map<String, dynamic> map) {
    return EngineArgs(
      chatEngineConfig: map['chatEngineConfig'] == null ? null : GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfig.fromMap((map['chatEngineConfig'] as Map).cast<String, dynamic>()),
      collectionId: map['collectionId'] as String,
      commonConfig: map['commonConfig'] == null ? null : GoogleCloudDiscoveryengineV1alphaEngineCommonConfig.fromMap((map['commonConfig'] as Map).cast<String, dynamic>()),
      dataStoreIds: map['dataStoreIds'] == null ? null : (map['dataStoreIds'] as List).cast<String>(),
      displayName: map['displayName'] as String,
      engineId: map['engineId'] as String,
      industryVertical: map['industryVertical'] == null ? null : EngineIndustryVertical.fromValue(map['industryVertical'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      mediaRecommendationEngineConfig: map['mediaRecommendationEngineConfig'] == null ? null : GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfig.fromMap((map['mediaRecommendationEngineConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      searchEngineConfig: map['searchEngineConfig'] == null ? null : GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfig.fromMap((map['searchEngineConfig'] as Map).cast<String, dynamic>()),
      similarDocumentsConfig: map['similarDocumentsConfig'] == null ? null : (map['similarDocumentsConfig'] as Map).cast<String, dynamic>(),
