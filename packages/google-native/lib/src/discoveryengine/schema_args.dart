...
/// {@template pulumi_discoveryengine_v1alpha_schema_args_doc}
/// The set of arguments for Schema.
/// {@endtemplate}
/// {@macro pulumi_discoveryengine_v1alpha_schema_args_doc}
class SchemaArgs {
  ...
  factory SchemaArgs.fromMap(Map<String, dynamic> map) {
    return SchemaArgs(
      ...
      structSchema: map['structSchema'] == null ? null : (map['structSchema'] as Map).cast<String, String>(),
    );
  }
}
