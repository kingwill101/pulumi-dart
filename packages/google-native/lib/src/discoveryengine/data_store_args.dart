...
class DataStoreArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contentConfig': ?pulumi.Input.mapOptionalInputValue<DataStoreContentConfig, String>(contentConfig, (value) => value.value),
      'createAdvancedSiteSearch': ?createAdvancedSiteSearch,
      'dataStoreId': dataStoreId,
      'displayName': displayName,
      'industryVertical': ?pulumi.Input.mapOptionalInputValue<DataStoreIndustryVertical, String>(industryVertical, (value) => value.value),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      'solutionTypes': ?pulumi.Input.mapOptionalInputValue<List<DataStoreSolutionTypesItem>, List<String>>(solutionTypes, (value) => pulumi.Input.encodeList<DataStoreSolutionTypesItem, String>(value, (value) => value.value)),
    };
  }
  ...
  factory DataStoreArgs.fromMap(Map<String, dynamic> map) {
    return DataStoreArgs(
      ...
      contentConfig: map['contentConfig'] == null ? null : DataStoreContentConfig.fromValue(map['contentConfig'] as String),
      createAdvancedSiteSearch: map['createAdvancedSiteSearch'] == null ? null : map['createAdvancedSiteSearch'] as bool,
      dataStoreId: map['dataStoreId'] as String,
      displayName: map['displayName'] as String,
      industryVertical: map['industryVertical'] == null ? null : DataStoreIndustryVertical.fromValue(map['industryVertical'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      solutionTypes: map['solutionTypes'] == null ? null : pulumi.Input.decodeList<DataStoreSolutionTypesItem>(map['solutionTypes'], (value) => DataStoreSolutionTypesItem.fromValue(value as String)),
    );
  }
}
