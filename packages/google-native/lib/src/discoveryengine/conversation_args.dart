...
class ConversationArgs {
  ...
  factory ConversationArgs.fromMap(Map<String, dynamic> map) {
    return ConversationArgs(
      ...
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<GoogleCloudDiscoveryengineV1alphaConversationMessage>(map['messages'], (value) => GoogleCloudDiscoveryengineV1alphaConversationMessage.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      state: map['state'] == null ? null : ConversationState.fromValue(map['state'] as String),
