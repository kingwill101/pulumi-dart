...
class Engine extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigResponse>
      chatEngineConfig;

  /// Additional information of the Chat Engine. Only applicable if solution_type is SOLUTION_TYPE_CHAT.
  late final pulumi
      .Output<GoogleCloudDiscoveryengineV1alphaEngineChatEngineMetadataResponse>
      chatEngineMetadata;
  late final pulumi.Output<String> collectionId;

  /// Common config spec that specifies the metadata of the engine.
  late final pulumi
      .Output<GoogleCloudDiscoveryengineV1alphaEngineCommonConfigResponse>
      commonConfig;
  ...
  late final pulumi
      .Output<GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfigResponse>
      searchEngineConfig;
