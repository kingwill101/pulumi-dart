...
class GetDocumentDiscoveryengineV1betaResult {
  /// The unstructured data linked to this document. Content must be set if this document is under a `CONTENT_REQUIRED` data store.
  final GoogleCloudDiscoveryengineV1betaDocumentContentResponse content;
  ...
  /// Creates a new [GetDocumentDiscoveryengineV1betaResult].
  ...
  GetDocumentDiscoveryengineV1betaResult({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['derivedStructData'] = derivedStructData;
    map['jsonData'] = jsonData;
    map['name'] = name;
    map['parentDocumentId'] = parentDocumentId;
    map['schemaId'] = schemaId;
    map['structData'] = structData;
    return map;
  }

  factory GetDocumentDiscoveryengineV1betaResult.fromMap(
      Map<String, dynamic> map) {
    return GetDocumentDiscoveryengineV1betaResult(
      content: GoogleCloudDiscoveryengineV1betaDocumentContentResponse.fromMap(
          (map['content'] as Map).cast<String, dynamic>()),
      derivedStructData:
          (map['derivedStructData'] as Map).cast<String, String>(),
