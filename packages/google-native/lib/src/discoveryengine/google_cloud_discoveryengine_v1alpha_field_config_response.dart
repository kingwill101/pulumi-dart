...
class GoogleCloudDiscoveryengineV1alphaFieldConfigResponse {
  ...
  final String completableOption;
  ...
  final String dynamicFacetableOption;
  ...
  final String recsFilterableOption;
  ...
  final String retrievableOption;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['completableOption'] = completableOption;
    map['dynamicFacetableOption'] = dynamicFacetableOption;
    map['fieldPath'] = fieldPath;
    map['fieldType'] = fieldType;
    map['indexableOption'] = indexableOption;
    map['keyPropertyType'] = keyPropertyType;
    map['recsFilterableOption'] = recsFilterableOption;
    map['retrievableOption'] = retrievableOption;
    map['searchableOption'] = searchableOption;
    return map;
  }

  factory GoogleCloudDiscoveryengineV1alphaFieldConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaFieldConfigResponse(
      completableOption: map['completableOption'] as String,
      dynamicFacetableOption: map['dynamicFacetableOption'] as String,
      fieldPath: map['fieldPath'] as String,
      fieldType: map['fieldType'] as String,
      indexableOption: map['indexableOption'] as String,
      keyPropertyType: map['keyPropertyType'] as String,
      recsFilterableOption: map['recsFilterableOption'] as String,
      retrievableOption: map['retrievableOption'] as String,
      searchableOption: map['searchableOption'] as String,
    );
  }
}
