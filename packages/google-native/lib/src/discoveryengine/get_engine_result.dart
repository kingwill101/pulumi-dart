...
class GetEngineResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['chatEngineConfig'] = chatEngineConfig.toMap();
    map['chatEngineMetadata'] = chatEngineMetadata.toMap();
    map['commonConfig'] = commonConfig.toMap();
    map['createTime'] = createTime;
    map['dataStoreIds'] = dataStoreIds;
    map['displayName'] = displayName;
    map['industryVertical'] = industryVertical;
    map['mediaRecommendationEngineConfig'] =
        mediaRecommendationEngineConfig.toMap();
    map['name'] = name;
    map['recommendationMetadata'] = recommendationMetadata.toMap();
    map['searchEngineConfig'] = searchEngineConfig.toMap();
    map['similarDocumentsConfig'] = similarDocumentsConfig;
    ...
    return GetEngineResult(
      ...
      recommendationMetadata:
          GoogleCloudDiscoveryengineV1alphaEngineRecommendationMetadataResponse
              .fromMap((map['recommendationMetadata'] as Map)
                  .cast<String, dynamic>()),
      searchEngineConfig:
