...
class TriggerIamPolicyEventarcV1beta1Args {
  ...
  TriggerIamPolicyEventarcV1beta1Args({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigEventarcV1beta1>>(
                auditConfigs),
        bindings = pulumi.Input.asOptionalInput<List<BindingEventarcV1beta1>>(
            bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigEventarcV1beta1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigEventarcV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingEventarcV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingEventarcV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory TriggerIamPolicyEventarcV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return TriggerIamPolicyEventarcV1beta1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigEventarcV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigEventarcV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingEventarcV1beta1>(
              map['bindings'],
              (value) => BindingEventarcV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
