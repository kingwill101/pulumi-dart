...
/// {@template pulumi_eventarc_v1beta1_trigger_iam_member_eventarc_v1beta1_args_doc}
/// The set of arguments for TriggerIamMember.
/// {@endtemplate}
/// {@macro pulumi_eventarc_v1beta1_trigger_iam_member_eventarc_v1beta1_args_doc}
class TriggerIamMemberEventarcV1beta1Args {
  ...
  /// Creates a new [TriggerIamMemberEventarcV1beta1Args].
  ...
  TriggerIamMemberEventarcV1beta1Args({
    Condition? condition,
  ...
  factory TriggerIamMemberEventarcV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TriggerIamMemberEventarcV1beta1Args(
