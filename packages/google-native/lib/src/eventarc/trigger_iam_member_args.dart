...
/// {@template pulumi_eventarc_v1_trigger_iam_member_args_doc}
/// The set of arguments for TriggerIamMember.
/// {@endtemplate}
/// {@macro pulumi_eventarc_v1_trigger_iam_member_args_doc}
class TriggerIamMemberArgs {
  ...
  /// Creates a new [TriggerIamMemberArgs].
  ...
  factory TriggerIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return TriggerIamMemberArgs(
