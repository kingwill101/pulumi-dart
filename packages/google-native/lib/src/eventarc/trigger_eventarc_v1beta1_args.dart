...
class TriggerEventarcV1beta1Args {
  ...
  factory TriggerEventarcV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TriggerEventarcV1beta1Args(
      destination: DestinationEventarcV1beta1.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      matchingCriteria: pulumi.Input.decodeList<MatchingCriteria>(map['matchingCriteria'], (value) => MatchingCriteria.fromMap((value as Map).cast<String, dynamic>())),
