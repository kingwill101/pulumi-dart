...
class TriggerEventarcV1beta1Args {
  ...
  TriggerEventarcV1beta1Args({
    required DestinationEventarcV1beta1 destination,
    Map<String, String>? labels,
    String? location,
    required List<MatchingCriteria> matchingCriteria,
    String? name,
    String? project,
    String? serviceAccount,
    required String triggerId,
  }) : destination = pulumi.Input.asInput<DestinationEventarcV1beta1>(
         destination,
       ),
       labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
       location = pulumi.Input.asOptionalInput<String>(location),
       matchingCriteria = pulumi.Input.asInput<List<MatchingCriteria>>(
         matchingCriteria,
       ),
  ...
  factory TriggerEventarcV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TriggerEventarcV1beta1Args(
      destination: DestinationEventarcV1beta1.fromMap(
      ...
      matchingCriteria: pulumi.Input.decodeList<MatchingCriteria>(
        map['matchingCriteria'],
        (value) =>
            MatchingCriteria.fromMap((value as Map).cast<String, dynamic>()),
      ),
