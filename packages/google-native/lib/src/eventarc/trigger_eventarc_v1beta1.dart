...
class TriggerEventarcV1beta1 extends pulumi.CustomResource {
  ...
  TriggerEventarcV1beta1(
    ...
    this.destination = registerOutput<DestinationResponseEventarcV1beta1>(
      'destination',
    );
    this.etag = registerOutput<String>('etag');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.matchingCriteria = registerOutput<List<MatchingCriteriaResponse>>(
      'matchingCriteria',
    );
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.transport = registerOutput<TransportResponseEventarcV1beta1>(
      'transport',
    );
