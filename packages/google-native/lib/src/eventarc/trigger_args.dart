...
class TriggerArgs {
  ...
  factory TriggerArgs.fromMap(Map<String, dynamic> map) {
    return TriggerArgs(
      ...
      destination: Destination.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      eventDataContentType: map['eventDataContentType'] == null ? null : map['eventDataContentType'] as String,
      eventFilters: pulumi.Input.decodeList<EventFilter>(map['eventFilters'], (value) => EventFilter.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      transport: map['transport'] == null ? null : Transport.fromMap((map['transport'] as Map).cast<String, dynamic>()),
