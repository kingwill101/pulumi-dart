...
class EvaluationArgs {
  ...
  EvaluationArgs({
    ...
    String? schedule,
            ...
            pulumi.Input.asOptionalInput<String>(customRulesBucket),
        ...
        resourceFilter =
            pulumi.Input.asOptionalInput<ResourceFilter>(resourceFilter),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (resourceFilterValue != null) {
      map['resourceFilter'] = pulumi.Input.mapOptionalInputValue<ResourceFilter,
