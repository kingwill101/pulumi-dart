...
class GetTableResult {
  ...
  /// [deleteTime] The deletion time of the table. Only set after the table is deleted.
  ...
  /// [expireTime] The time when this table is considered expired. Only set after the table is deleted.
