...
class ListingArgs {
  ...
  ListingArgs({
    required BigQueryDatasetSource bigqueryDataset,
    List<ListingCategoriesItem>? categories,
  ...
  factory ListingArgs.fromMap(Map<String, dynamic> map) {
    return ListingArgs(
      bigqueryDataset: BigQueryDatasetSource.fromMap((map['bigqueryDataset'] as Map).cast<String, dynamic>()),
      categories: map['categories'] == null ? null : pulumi.Input.decodeList<ListingCategoriesItem>(map['categories'], (value) => ListingCategoriesItem.fromValue(value as String)),
      dataExchangeId: map['dataExchangeId'] as String,
      dataProvider: map['dataProvider'] == null ? null : DataProvider.fromMap((map['dataProvider'] as Map).cast<String, dynamic>()),
      ...
      publisher: map['publisher'] == null ? null : Publisher.fromMap((map['publisher'] as Map).cast<String, dynamic>()),
      requestAccess: map['requestAccess'] == null ? null : map['requestAccess'] as String,
      restrictedExportConfig: map['restrictedExportConfig'] == null ? null : RestrictedExportConfig.fromMap((map['restrictedExportConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
