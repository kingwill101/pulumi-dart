...
class ListingArgs {
  ...
  }) : bigqueryDataset = pulumi.Input.asInput<BigQueryDatasetSource>(
         bigqueryDataset,
       ),
  ...
  factory ListingArgs.fromMap(Map<String, dynamic> map) {
    return ListingArgs(
      bigqueryDataset: BigQueryDatasetSource.fromMap(
        (map['bigqueryDataset'] as Map).cast<String, dynamic>(),
      ),
      categories: map['categories'] == null
          ? null
          : pulumi.Input.decodeList<ListingCategoriesItem>(
              map['categories'],
              (value) => ListingCategoriesItem.fromValue(value as String),
            ),
      dataExchangeId: map['dataExchangeId'] as String,
      dataProvider: map['dataProvider'] == null
          ? null
          : DataProvider.fromMap(
      ...
      restrictedExportConfig: map['restrictedExportConfig'] == null
          ? null
          : RestrictedExportConfig.fromMap(
