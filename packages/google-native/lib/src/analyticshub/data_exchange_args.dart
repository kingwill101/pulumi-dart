...
class DataExchangeArgs {
  ...
  factory DataExchangeArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeArgs(
      ...
      sharingEnvironmentConfig: map['sharingEnvironmentConfig'] == null ? null : SharingEnvironmentConfig.fromMap((map['sharingEnvironmentConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
