...
class ExprResponseAnalyticshubV1beta1 {
  ...
  /// Creates a new [ExprResponseAnalyticshubV1beta1].
  ...
  ExprResponseAnalyticshubV1beta1({
  ...
  factory ExprResponseAnalyticshubV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseAnalyticshubV1beta1(
