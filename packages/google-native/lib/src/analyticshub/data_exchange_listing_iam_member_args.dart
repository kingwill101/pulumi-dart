...
/// {@template pulumi_analyticshub_v1_data_exchange_listing_iam_member_args_doc}
/// The set of arguments for DataExchangeListingIamMember.
/// {@endtemplate}
/// {@macro pulumi_analyticshub_v1_data_exchange_listing_iam_member_args_doc}
class DataExchangeListingIamMemberArgs {
  ...
  /// Creates a new [DataExchangeListingIamMemberArgs].
  ...
  DataExchangeListingIamMemberArgs({
    Condition? condition,
  ...
  factory DataExchangeListingIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeListingIamMemberArgs(
