...
class DataExchange extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SharingEnvironmentConfigResponse> sharingEnvironmentConfig;
  ...
  DataExchange(
    ...
    this.sharingEnvironmentConfig = registerOutput<SharingEnvironmentConfigResponse>('sharingEnvironmentConfig');
  }
}
