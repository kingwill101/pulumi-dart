...
class CaseArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'priority': ?pulumi.Input.mapOptionalInputValue<CasePriority, String>(priority, (value) => value.value),
  ...
  factory CaseArgs.fromMap(Map<String, dynamic> map) {
    return CaseArgs(
      classification: map['classification'] == null ? null : CaseClassification.fromMap((map['classification'] as Map).cast<String, dynamic>()),
      contactEmail: map['contactEmail'] == null ? null : map['contactEmail'] as String,
      creator: map['creator'] == null ? null : Actor.fromMap((map['creator'] as Map).cast<String, dynamic>()),
      ...
      priority: map['priority'] == null ? null : CasePriority.fromValue(map['priority'] as String),
