...
class CaseCloudsupportV2betaArgs {
  ...
  factory CaseCloudsupportV2betaArgs.fromMap(Map<String, dynamic> map) {
    return CaseCloudsupportV2betaArgs(
      classification: map['classification'] == null ? null : CaseClassificationCloudsupportV2beta.fromMap((map['classification'] as Map).cast<String, dynamic>()),
      contactEmail: map['contactEmail'] == null ? null : map['contactEmail'] as String,
      creator: map['creator'] == null ? null : ActorCloudsupportV2beta.fromMap((map['creator'] as Map).cast<String, dynamic>()),
      ...
      priority: map['priority'] == null ? null : CasePriorityCloudsupportV2beta.fromValue(map['priority'] as String),
      severity: map['severity'] == null ? null : CaseSeverity.fromValue(map['severity'] as String),
