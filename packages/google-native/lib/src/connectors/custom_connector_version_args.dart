...
class CustomConnectorVersionArgs {
  ...
  factory CustomConnectorVersionArgs.fromMap(Map<String, dynamic> map) {
    return CustomConnectorVersionArgs(
      authConfig: AuthConfig.fromMap((map['authConfig'] as Map).cast<String, dynamic>()),
      customConnectorId: map['customConnectorId'] as String,
      customConnectorVersionId: map['customConnectorVersionId'] as String,
      destinationConfig: DestinationConfig.fromMap((map['destinationConfig'] as Map).cast<String, dynamic>()),
      enableBackendDestinationConfig: map['enableBackendDestinationConfig'] == null ? null : map['enableBackendDestinationConfig'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      project: map['project'] == null ? null : map['project'] as String,
      specLocation: map['specLocation'] == null ? null : map['specLocation'] as String,
