...
class Connection extends pulumi.CustomResource {
  ...
  Connection(
    ...
    this.configVariables = registerOutput<List<ConfigVariableResponse>>('configVariables');
    ...
    this.connectorVersionInfraConfig = registerOutput<ConnectorVersionInfraConfigResponse>('connectorVersionInfraConfig');
    this.connectorVersionLaunchStage = registerOutput<String>('connectorVersionLaunchStage');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String>('description');
    this.destinationConfigs = registerOutput<List<DestinationConfigResponse>>('destinationConfigs');
    this.envoyImageLocation = registerOutput<String>('envoyImageLocation');
    this.eventingConfig = registerOutput<EventingConfigResponse>('eventingConfig');
    this.eventingEnablementType = registerOutput<String>('eventingEnablementType');
    this.eventingRuntimeData = registerOutput<EventingRuntimeDataResponse>('eventingRuntimeData');
