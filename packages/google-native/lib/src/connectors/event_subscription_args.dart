...
class EventSubscriptionArgs {
  ...
  factory EventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionArgs(
      ...
      destinations: map['destinations'] == null ? null : EventSubscriptionDestination.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
      eventSubscriptionId: map['eventSubscriptionId'] as String,
      eventTypeId: map['eventTypeId'] == null ? null : map['eventTypeId'] as String,
      jms: map['jms'] == null ? null : JMS.fromMap((map['jms'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      subscriber: map['subscriber'] == null ? null : map['subscriber'] as String,
      subscriberLink: map['subscriberLink'] == null ? null : map['subscriberLink'] as String,
    );
  }
}
