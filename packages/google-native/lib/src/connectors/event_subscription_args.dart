...
class EventSubscriptionArgs {
  ...
  EventSubscriptionArgs({
    ...
    String? subscriberLink,
        ...
        destinations =
            pulumi.Input.asOptionalInput<EventSubscriptionDestination>(
                destinations),
  ...
  factory EventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionArgs(
      ...
      eventTypeId:
          map['eventTypeId'] == null ? null : map['eventTypeId'] as String,
      jms: map['jms'] == null
          ? null
      ...
      subscriber:
          map['subscriber'] == null ? null : map['subscriber'] as String,
