...
class ConnectionArgs {
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      ...
      configVariables: map['configVariables'] == null ? null : pulumi.Input.decodeList<ConfigVariable>(map['configVariables'], (value) => ConfigVariable.fromMap((value as Map).cast<String, dynamic>())),
      connectionId: map['connectionId'] as String,
      connectorVersion: map['connectorVersion'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      destinationConfigs: map['destinationConfigs'] == null ? null : pulumi.Input.decodeList<DestinationConfig>(map['destinationConfigs'], (value) => DestinationConfig.fromMap((value as Map).cast<String, dynamic>())),
      eventingConfig: map['eventingConfig'] == null ? null : EventingConfig.fromMap((map['eventingConfig'] as Map).cast<String, dynamic>()),
      eventingEnablementType: map['eventingEnablementType'] == null ? null : ConnectionEventingEnablementType.fromValue(map['eventingEnablementType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      lockConfig: map['lockConfig'] == null ? null : LockConfig.fromMap((map['lockConfig'] as Map).cast<String, dynamic>()),
      logConfig: map['logConfig'] == null ? null : ConnectorsLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
