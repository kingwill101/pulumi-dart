...
class ConnectionArgs {
  ...
  ConnectionArgs({
    ...
    bool? suspended,
       ...
       destinationConfigs = pulumi
           .Input.asOptionalInput<List<DestinationConfig>>(destinationConfigs),
       eventingConfig = pulumi.Input.asOptionalInput<EventingConfig>(
         eventingConfig,
       ),
    ...
    return <String, dynamic>{
      ...
      'eventingEnablementType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(eventingEnablementType, (value) => value.value),
      'labels': ?labels,
      'location': ?location,
      'lockConfig':
