...
class StreamDatastreamV1alpha1Args {
  ...
  factory StreamDatastreamV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return StreamDatastreamV1alpha1Args(
      backfillAll: map['backfillAll'] == null ? null : BackfillAllStrategyDatastreamV1alpha1.fromMap((map['backfillAll'] as Map).cast<String, dynamic>()),
      ...
      destinationConfig: DestinationConfigDatastreamV1alpha1.fromMap((map['destinationConfig'] as Map).cast<String, dynamic>()),
      ...
      sourceConfig: SourceConfigDatastreamV1alpha1.fromMap((map['sourceConfig'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : StreamStateDatastreamV1alpha1.fromValue(map['state'] as String),
