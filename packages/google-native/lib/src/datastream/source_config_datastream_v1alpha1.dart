...
class SourceConfigDatastreamV1alpha1 {
  ...
  factory SourceConfigDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return SourceConfigDatastreamV1alpha1(
      mysqlSourceConfig: map['mysqlSourceConfig'] == null ? null : MysqlSourceConfigDatastreamV1alpha1.fromMap((map['mysqlSourceConfig'] as Map).cast<String, dynamic>()),
      oracleSourceConfig: map['oracleSourceConfig'] == null ? null : OracleSourceConfigDatastreamV1alpha1.fromMap((map['oracleSourceConfig'] as Map).cast<String, dynamic>()),
