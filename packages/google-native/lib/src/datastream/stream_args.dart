...
class StreamArgs {
  ...
  StreamArgs({
    ...
    required String streamId,
            ...
            pulumi.Input.asOptionalInput<BackfillAllStrategy>(backfillAll),
        backfillNone =
            pulumi.Input.asOptionalInput<Map<String, dynamic>>(backfillNone),
        customerManagedEncryptionKey =
            pulumi.Input.asOptionalInput<String>(customerManagedEncryptionKey),
        destinationConfig =
  ...
  Map<String, dynamic> toMap() {
    ...
    map['sourceConfig'] =
        pulumi.Input.mapInputValue<SourceConfig, Map<String, dynamic>>(
  ...
  factory StreamArgs.fromMap(Map<String, dynamic> map) {
    return StreamArgs(
      ...
      state: map['state'] == null
          ? null
          : StreamState.fromValue(map['state'] as String),
