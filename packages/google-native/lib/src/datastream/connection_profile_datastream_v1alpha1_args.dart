...
class ConnectionProfileDatastreamV1alpha1Args {
  ...
  factory ConnectionProfileDatastreamV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileDatastreamV1alpha1Args(
      ...
      forwardSshConnectivity: map['forwardSshConnectivity'] == null ? null : ForwardSshTunnelConnectivityDatastreamV1alpha1.fromMap((map['forwardSshConnectivity'] as Map).cast<String, dynamic>()),
      gcsProfile: map['gcsProfile'] == null ? null : GcsProfileDatastreamV1alpha1.fromMap((map['gcsProfile'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      mysqlProfile: map['mysqlProfile'] == null ? null : MysqlProfileDatastreamV1alpha1.fromMap((map['mysqlProfile'] as Map).cast<String, dynamic>()),
      noConnectivity: map['noConnectivity'] == null ? null : (map['noConnectivity'] as Map).cast<String, dynamic>(),
      oracleProfile: map['oracleProfile'] == null ? null : OracleProfileDatastreamV1alpha1.fromMap((map['oracleProfile'] as Map).cast<String, dynamic>()),
      privateConnectivity: map['privateConnectivity'] == null ? null : PrivateConnectivityDatastreamV1alpha1.fromMap((map['privateConnectivity'] as Map).cast<String, dynamic>()),
