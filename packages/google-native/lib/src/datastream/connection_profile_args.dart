...
class ConnectionProfileArgs {
  ...
  factory ConnectionProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileArgs(
      ...
      gcsProfile: map['gcsProfile'] == null ? null : GcsProfile.fromMap((map['gcsProfile'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      mysqlProfile: map['mysqlProfile'] == null ? null : MysqlProfile.fromMap((map['mysqlProfile'] as Map).cast<String, dynamic>()),
      oracleProfile: map['oracleProfile'] == null ? null : OracleProfile.fromMap((map['oracleProfile'] as Map).cast<String, dynamic>()),
      postgresqlProfile: map['postgresqlProfile'] == null ? null : PostgresqlProfile.fromMap((map['postgresqlProfile'] as Map).cast<String, dynamic>()),
