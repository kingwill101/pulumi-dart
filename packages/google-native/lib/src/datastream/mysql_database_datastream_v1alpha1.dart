...
class MysqlDatabaseDatastreamV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mysqlTables': ?mysqlTables == null ? null : pulumi.Input.encodeList<MysqlTableDatastreamV1alpha1, Map<String, dynamic>>(mysqlTables!, (value) => value.toMap()),
    };
  }
  ...
  factory MysqlDatabaseDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return MysqlDatabaseDatastreamV1alpha1(
      ...
      mysqlTables: map['mysqlTables'] == null ? null : pulumi.Input.decodeList<MysqlTableDatastreamV1alpha1>(map['mysqlTables'], (value) => MysqlTableDatastreamV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
