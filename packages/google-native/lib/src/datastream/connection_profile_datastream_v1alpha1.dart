...
class ConnectionProfileDatastreamV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<ForwardSshTunnelConnectivityResponseDatastreamV1alpha1>
  ...
  ConnectionProfileDatastreamV1alpha1(
    ...
    this.forwardSshConnectivity =
        registerOutput<ForwardSshTunnelConnectivityResponseDatastreamV1alpha1>(
            'forwardSshConnectivity');
    this.gcsProfile =
        registerOutput<GcsProfileResponseDatastreamV1alpha1>('gcsProfile');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.mysqlProfile =
        registerOutput<MysqlProfileResponseDatastreamV1alpha1>('mysqlProfile');
    this.name = registerOutput<String>('name');
    this.noConnectivity =
        registerOutput<Map<String, dynamic>>('noConnectivity');
    this.oracleProfile =
        registerOutput<OracleProfileResponseDatastreamV1alpha1>(
            'oracleProfile');
