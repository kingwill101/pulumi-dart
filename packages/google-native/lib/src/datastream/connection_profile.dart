...
class ConnectionProfile extends pulumi.CustomResource {
  ...
  ConnectionProfile(
    ...
    this.forwardSshConnectivity = registerOutput<ForwardSshTunnelConnectivityResponse>('forwardSshConnectivity');
    ...
    this.postgresqlProfile = registerOutput<PostgresqlProfileResponse>('postgresqlProfile');
    this.privateConnectivity = registerOutput<PrivateConnectivityResponse>('privateConnectivity');
