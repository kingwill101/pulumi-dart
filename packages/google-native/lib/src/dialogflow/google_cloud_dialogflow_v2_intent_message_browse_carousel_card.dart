  ...
  factory GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard.fromMap(
    ...
    return GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard(
      imageDisplayOptions: map['imageDisplayOptions'] == null
          ? null
          : GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardImageDisplayOptions.fromValue(
      ...
      items:
          ...
          >(
            map['items'],
            (value) =>
                GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItem.fromMap(
