  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig.fromMap(
    ...
    return GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig(
      conversationModelConfig: map['conversationModelConfig'] == null
          ? null
          : GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfig.fromMap(
              (map['conversationModelConfig'] as Map).cast<String, dynamic>(),
            ),
      conversationProcessConfig: map['conversationProcessConfig'] == null
          ? null
          : GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationProcessConfig.fromMap(
      ...
      queryConfig: map['queryConfig'] == null
          ? null
          : GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig.fromMap(
      ...
      suggestionTriggerSettings: map['suggestionTriggerSettings'] == null
          ? null
          : GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings.fromMap(
