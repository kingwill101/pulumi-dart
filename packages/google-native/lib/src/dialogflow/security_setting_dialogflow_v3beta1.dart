...
class SecuritySettingDialogflowV3beta1 extends pulumi.CustomResource {
  ...
  SecuritySettingDialogflowV3beta1(
    ...
    this.audioExportSettings = registerOutput<GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsResponse>('audioExportSettings');
    this.deidentifyTemplate = registerOutput<String>('deidentifyTemplate');
    this.displayName = registerOutput<String>('displayName');
    this.insightsExportSettings = registerOutput<GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettingsResponse>('insightsExportSettings');
