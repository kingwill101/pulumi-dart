...
class GoogleCloudDialogflowCxV3Fulfillment {
  ...
  final List<GoogleCloudDialogflowCxV3FulfillmentConditionalCases>? conditionalCases;
  ...
  final List<GoogleCloudDialogflowCxV3FulfillmentSetParameterAction>? setParameterActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionalCases': ?conditionalCases == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3FulfillmentConditionalCases, Map<String, dynamic>>(conditionalCases!, (value) => value.toMap()),
      'enableGenerativeFallback': ?enableGenerativeFallback,
      'messages': ?messages == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3ResponseMessage, Map<String, dynamic>>(messages!, (value) => value.toMap()),
      'returnPartialResponses': ?returnPartialResponses,
      'setParameterActions': ?setParameterActions == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3FulfillmentSetParameterAction, Map<String, dynamic>>(setParameterActions!, (value) => value.toMap()),
      'tag': ?tag,
      'webhook': ?webhook,
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3Fulfillment.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3Fulfillment(
      ...
      conditionalCases: map['conditionalCases'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3FulfillmentConditionalCases>(map['conditionalCases'], (value) => GoogleCloudDialogflowCxV3FulfillmentConditionalCases.fromMap((value as Map).cast<String, dynamic>())),
      enableGenerativeFallback: map['enableGenerativeFallback'] == null ? null : map['enableGenerativeFallback'] as bool,
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3ResponseMessage>(map['messages'], (value) => GoogleCloudDialogflowCxV3ResponseMessage.fromMap((value as Map).cast<String, dynamic>())),
      returnPartialResponses: map['returnPartialResponses'] == null ? null : map['returnPartialResponses'] as bool,
      setParameterActions: map['setParameterActions'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3FulfillmentSetParameterAction>(map['setParameterActions'], (value) => GoogleCloudDialogflowCxV3FulfillmentSetParameterAction.fromMap((value as Map).cast<String, dynamic>())),
