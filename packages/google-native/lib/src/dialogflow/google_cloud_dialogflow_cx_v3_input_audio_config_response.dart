...
class GoogleCloudDialogflowCxV3InputAudioConfigResponse {
  ...
  final GoogleCloudDialogflowCxV3BargeInConfigResponse bargeInConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['audioEncoding'] = audioEncoding;
    map['bargeInConfig'] = bargeInConfig.toMap();
    map['enableWordInfo'] = enableWordInfo;
    map['model'] = model;
    map['modelVariant'] = modelVariant;
    map['phraseHints'] = phraseHints;
    map['sampleRateHertz'] = sampleRateHertz;
    map['singleUtterance'] = singleUtterance;
    return map;
  }

  factory GoogleCloudDialogflowCxV3InputAudioConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3InputAudioConfigResponse(
      audioEncoding: map['audioEncoding'] as String,
      bargeInConfig: GoogleCloudDialogflowCxV3BargeInConfigResponse.fromMap(
