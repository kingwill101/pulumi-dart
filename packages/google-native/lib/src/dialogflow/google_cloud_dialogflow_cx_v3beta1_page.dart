...
class GoogleCloudDialogflowCxV3beta1Page {
  ...
  final GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettings? knowledgeConnectorSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'eventHandlers': ?eventHandlers == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1EventHandler, Map<String, dynamic>>(eventHandlers!, (value) => value.toMap()),
      ...
      'transitionRoutes': ?transitionRoutes == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1TransitionRoute, Map<String, dynamic>>(transitionRoutes!, (value) => value.toMap()),
    };
  }
