...
class GoogleCloudDialogflowCxV3Intent {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'name': ?name,
      'parameters': ?parameters == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3IntentParameter, Map<String, dynamic>>(parameters!, (value) => value.toMap()),
      'priority': ?priority,
      'trainingPhrases': ?trainingPhrases == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3IntentTrainingPhrase, Map<String, dynamic>>(trainingPhrases!, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3Intent.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3Intent(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3IntentParameter>(map['parameters'], (value) => GoogleCloudDialogflowCxV3IntentParameter.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] == null ? null : map['priority'] as int,
      trainingPhrases: map['trainingPhrases'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3IntentTrainingPhrase>(map['trainingPhrases'], (value) => GoogleCloudDialogflowCxV3IntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
