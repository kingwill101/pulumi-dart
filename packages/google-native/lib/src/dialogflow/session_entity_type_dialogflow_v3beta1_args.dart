...
class SessionEntityTypeDialogflowV3beta1Args {
  ...
  SessionEntityTypeDialogflowV3beta1Args({
    ...
    required SessionEntityTypeEntityOverrideModeDialogflowV3beta1 entityOverrideMode,
    ...
    required String sessionId,
      ...
      entities = pulumi.Input.asInput<List<GoogleCloudDialogflowCxV3beta1EntityTypeEntity>>(entities),
      entityOverrideMode = pulumi.Input.asInput<SessionEntityTypeEntityOverrideModeDialogflowV3beta1>(entityOverrideMode),
  ...
  factory SessionEntityTypeDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return SessionEntityTypeDialogflowV3beta1Args(
      ...
      entities: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EntityTypeEntity>(map['entities'], (value) => GoogleCloudDialogflowCxV3beta1EntityTypeEntity.fromMap((value as Map).cast<String, dynamic>())),
      entityOverrideMode: SessionEntityTypeEntityOverrideModeDialogflowV3beta1.fromValue(map['entityOverrideMode'] as String),
