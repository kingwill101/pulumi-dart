...
class GoogleCloudDialogflowCxV3RolloutConfigRolloutStep {
  ...
  Map<String, dynamic> toMap() {
    ...
    final trafficPercentValue = trafficPercent;
    if (trafficPercentValue != null) {
      map['trafficPercent'] = trafficPercentValue;
    }
    return map;
  }
  ...
  factory GoogleCloudDialogflowCxV3RolloutConfigRolloutStep.fromMap(
    ...
    return GoogleCloudDialogflowCxV3RolloutConfigRolloutStep(
      ...
      trafficPercent:
          map['trafficPercent'] == null ? null : map['trafficPercent'] as int,
    );
  }
}
