...
class SecuritySetting extends pulumi.CustomResource {
  ...
  SecuritySetting(
    ...
    this.audioExportSettings = registerOutput<GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsResponse>('audioExportSettings');
    this.deidentifyTemplate = registerOutput<String>('deidentifyTemplate');
    this.displayName = registerOutput<String>('displayName');
    this.insightsExportSettings = registerOutput<GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettingsResponse>('insightsExportSettings');
