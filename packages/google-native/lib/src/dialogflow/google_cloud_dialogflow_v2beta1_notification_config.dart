...
class GoogleCloudDialogflowV2beta1NotificationConfig {
  /// Format of message.
  final GoogleCloudDialogflowV2beta1NotificationConfigMessageFormat? messageFormat;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'messageFormat': ?messageFormat == null ? null : messageFormat!.value,
      'topic': ?topic,
    };
  }
  ...
  factory GoogleCloudDialogflowV2beta1NotificationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1NotificationConfig(
      messageFormat: map['messageFormat'] == null ? null : GoogleCloudDialogflowV2beta1NotificationConfigMessageFormat.fromValue(map['messageFormat'] as String),
