...
class GoogleCloudDialogflowCxV3FormParameterFillBehaviorResponse {
  ...
  final List<GoogleCloudDialogflowCxV3EventHandlerResponse>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['repromptEventHandlers'] = pulumi.Input.encodeList<
        ...
        Map<String, dynamic>>(repromptEventHandlers, (value) => value.toMap());
    return map;
  }

  factory GoogleCloudDialogflowCxV3FormParameterFillBehaviorResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3FormParameterFillBehaviorResponse(
      ...
      repromptEventHandlers: pulumi.Input.decodeList<
              GoogleCloudDialogflowCxV3EventHandlerResponse>(
