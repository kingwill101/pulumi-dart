...
class GoogleCloudDialogflowV2SynthesizeSpeechConfig {
  ...
  factory GoogleCloudDialogflowV2SynthesizeSpeechConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2SynthesizeSpeechConfig(
      effectsProfileId: map['effectsProfileId'] == null ? null : (map['effectsProfileId'] as List).cast<String>(),
      pitch: map['pitch'] == null ? null : map['pitch'] as double,
      speakingRate: map['speakingRate'] == null ? null : map['speakingRate'] as double,
      voice: map['voice'] == null ? null : GoogleCloudDialogflowV2VoiceSelectionParams.fromMap((map['voice'] as Map).cast<String, dynamic>()),
