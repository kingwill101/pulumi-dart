...
class GoogleCloudDialogflowCxV3beta1TextInput {
  ...
  GoogleCloudDialogflowCxV3beta1TextInput({required this.text});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'text': text};
  }

  factory GoogleCloudDialogflowCxV3beta1TextInput.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudDialogflowCxV3beta1TextInput(text: map['text'] as String);
  }
}
