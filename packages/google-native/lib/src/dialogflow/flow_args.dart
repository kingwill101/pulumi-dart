...
class FlowArgs {
  ...
  FlowArgs({
    ...
    GoogleCloudDialogflowCxV3KnowledgeConnectorSettings? knowledgeConnectorSettings,
    String? languageCode,
    String? location,
    String? name,
    ...
    List<GoogleCloudDialogflowCxV3TransitionRoute>? transitionRoutes,
      ...
      nluSettings = pulumi.Input.asOptionalInput<GoogleCloudDialogflowCxV3NluSettings>(nluSettings),
  ...
  factory FlowArgs.fromMap(Map<String, dynamic> map) {
    return FlowArgs(
      ...
      nluSettings: map['nluSettings'] == null ? null : GoogleCloudDialogflowCxV3NluSettings.fromMap((map['nluSettings'] as Map).cast<String, dynamic>()),
