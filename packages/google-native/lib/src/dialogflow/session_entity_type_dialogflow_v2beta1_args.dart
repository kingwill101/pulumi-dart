...
class SessionEntityTypeDialogflowV2beta1Args {
  ...
  SessionEntityTypeDialogflowV2beta1Args({
    ...
    required SessionEntityTypeEntityOverrideModeDialogflowV2beta1 entityOverrideMode,
  ...
  factory SessionEntityTypeDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return SessionEntityTypeDialogflowV2beta1Args(
      entities: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1EntityTypeEntity>(map['entities'], (value) => GoogleCloudDialogflowV2beta1EntityTypeEntity.fromMap((value as Map).cast<String, dynamic>())),
      entityOverrideMode: SessionEntityTypeEntityOverrideModeDialogflowV2beta1.fromValue(map['entityOverrideMode'] as String),
