...
class ExperimentArgs {
  ...
  ExperimentArgs({
    ...
    List<GoogleCloudDialogflowCxV3VariantsHistory>? variantsHistory,
  }) :
  ...
  factory ExperimentArgs.fromMap(Map<String, dynamic> map) {
    return ExperimentArgs(
      ...
      definition: map['definition'] == null ? null : GoogleCloudDialogflowCxV3ExperimentDefinition.fromMap((map['definition'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      endTime: map['endTime'] == null ? null : map['endTime'] as String,
      environmentId: map['environmentId'] as String,
      experimentLength: map['experimentLength'] == null ? null : map['experimentLength'] as String,
      lastUpdateTime: map['lastUpdateTime'] == null ? null : map['lastUpdateTime'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      result: map['result'] == null ? null : GoogleCloudDialogflowCxV3ExperimentResult.fromMap((map['result'] as Map).cast<String, dynamic>()),
      rolloutConfig: map['rolloutConfig'] == null ? null : GoogleCloudDialogflowCxV3RolloutConfig.fromMap((map['rolloutConfig'] as Map).cast<String, dynamic>()),
      rolloutFailureReason: map['rolloutFailureReason'] == null ? null : map['rolloutFailureReason'] as String,
      rolloutState: map['rolloutState'] == null ? null : GoogleCloudDialogflowCxV3RolloutState.fromMap((map['rolloutState'] as Map).cast<String, dynamic>()),
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      state: map['state'] == null ? null : ExperimentState.fromValue(map['state'] as String),
      variantsHistory: map['variantsHistory'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3VariantsHistory>(map['variantsHistory'], (value) => GoogleCloudDialogflowCxV3VariantsHistory.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
