...
class ExperimentArgs {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3VariantsHistory>>?
  variantsHistory;
  ...
  ExperimentArgs({
    ...
    List<GoogleCloudDialogflowCxV3VariantsHistory>? variantsHistory,
       ...
       experimentLength = pulumi.Input.asOptionalInput<String>(
         experimentLength,
       ),
       ...
       result =
           ...
           >(result),
       rolloutConfig =
           pulumi.Input.asOptionalInput<GoogleCloudDialogflowCxV3RolloutConfig>(
             rolloutConfig,
           ),
       rolloutFailureReason = pulumi.Input.asOptionalInput<String>(
         rolloutFailureReason,
       ),
       rolloutState =
           pulumi.Input.asOptionalInput<GoogleCloudDialogflowCxV3RolloutState>(
             rolloutState,
           ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTime': ?startTime,
      'state': ?pulumi.Input.mapOptionalInputValue<ExperimentState, String>(
        state,
        (value) => value.value,
      ),
      'variantsHistory':
  ...
  factory ExperimentArgs.fromMap(Map<String, dynamic> map) {
    return ExperimentArgs(
      ...
      definition: map['definition'] == null
          ? null
          : GoogleCloudDialogflowCxV3ExperimentDefinition.fromMap(
      ...
      experimentLength: map['experimentLength'] == null
          ? null
          : map['experimentLength'] as String,
      ...
      result: map['result'] == null
          ? null
          : GoogleCloudDialogflowCxV3ExperimentResult.fromMap(
              (map['result'] as Map).cast<String, dynamic>(),
            ),
      rolloutConfig: map['rolloutConfig'] == null
          ? null
          : GoogleCloudDialogflowCxV3RolloutConfig.fromMap(
              (map['rolloutConfig'] as Map).cast<String, dynamic>(),
            ),
      rolloutFailureReason: map['rolloutFailureReason'] == null
          ? null
          : map['rolloutFailureReason'] as String,
      rolloutState: map['rolloutState'] == null
          ? null
          : GoogleCloudDialogflowCxV3RolloutState.fromMap(
              (map['rolloutState'] as Map).cast<String, dynamic>(),
            ),
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      state: map['state'] == null
          ? null
          : ExperimentState.fromValue(map['state'] as String),
      variantsHistory: map['variantsHistory'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3VariantsHistory>(
              map['variantsHistory'],
              (value) => GoogleCloudDialogflowCxV3VariantsHistory.fromMap(
