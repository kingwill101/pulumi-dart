...
class ExperimentArgs {
  ...
  ExperimentArgs({
    ...
    List<GoogleCloudDialogflowCxV3VariantsHistory>? variantsHistory,
        ...
        experimentLength =
            pulumi.Input.asOptionalInput<String>(experimentLength),
        ...
        rolloutFailureReason =
            pulumi.Input.asOptionalInput<String>(rolloutFailureReason),
        rolloutState =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (stateValue != null) {
      map['state'] =
          pulumi.Input.mapOptionalInputValue<ExperimentState, String>(
