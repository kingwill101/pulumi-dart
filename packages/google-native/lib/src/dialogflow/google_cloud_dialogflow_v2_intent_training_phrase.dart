...
class GoogleCloudDialogflowV2IntentTrainingPhrase {
  ...
  /// Creates a new [GoogleCloudDialogflowV2IntentTrainingPhrase].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parts': pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentTrainingPhrasePart, Map<String, dynamic>>(parts, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowV2IntentTrainingPhrase.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentTrainingPhrase(
      parts: pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentTrainingPhrasePart>(map['parts'], (value) => GoogleCloudDialogflowV2IntentTrainingPhrasePart.fromMap((value as Map).cast<String, dynamic>())),
      timesAddedCount: map['timesAddedCount'] == null ? null : map['timesAddedCount'] as int,
      type: GoogleCloudDialogflowV2IntentTrainingPhraseType.fromValue(map['type'] as String),
    );
  }
}
