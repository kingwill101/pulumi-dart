...
class GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parts': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3IntentTrainingPhrasePartResponse, Map<String, dynamic>>(parts, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse(
      parts: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3IntentTrainingPhrasePartResponse>(map['parts'], (value) => GoogleCloudDialogflowCxV3IntentTrainingPhrasePartResponse.fromMap((value as Map).cast<String, dynamic>())),
