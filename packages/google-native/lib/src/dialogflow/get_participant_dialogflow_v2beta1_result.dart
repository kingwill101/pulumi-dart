...
class GetParticipantDialogflowV2beta1Result {
  ...
  /// Creates a new [GetParticipantDialogflowV2beta1Result].
  ...
  GetParticipantDialogflowV2beta1Result({
  ...
  factory GetParticipantDialogflowV2beta1Result.fromMap(Map<String, dynamic> map) {
    return GetParticipantDialogflowV2beta1Result(
      documentsMetadataFilters: (map['documentsMetadataFilters'] as Map).cast<String, String>(),
