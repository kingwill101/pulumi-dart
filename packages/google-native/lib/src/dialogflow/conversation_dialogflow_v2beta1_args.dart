...
class ConversationDialogflowV2beta1Args {
  ...
  factory ConversationDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return ConversationDialogflowV2beta1Args(
      conversationId: map['conversationId'] == null ? null : map['conversationId'] as String,
      conversationProfile: map['conversationProfile'] as String,
      conversationStage: map['conversationStage'] == null ? null : ConversationConversationStageDialogflowV2beta1.fromValue(map['conversationStage'] as String),
