...
class GoogleCloudDialogflowV2SpeechToTextConfig {
  ...
  final GoogleCloudDialogflowV2SpeechToTextConfigSpeechModelVariant? speechModelVariant;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'model': ?model,
      'speechModelVariant': ?speechModelVariant == null ? null : speechModelVariant!.value,
  ...
  factory GoogleCloudDialogflowV2SpeechToTextConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2SpeechToTextConfig(
      ...
      speechModelVariant: map['speechModelVariant'] == null ? null : GoogleCloudDialogflowV2SpeechToTextConfigSpeechModelVariant.fromValue(map['speechModelVariant'] as String),
