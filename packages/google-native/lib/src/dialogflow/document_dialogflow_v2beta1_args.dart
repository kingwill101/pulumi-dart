...
class DocumentDialogflowV2beta1Args {
  ...
  DocumentDialogflowV2beta1Args({
    ...
    String? rawContent,
        ...
        importGcsCustomMetadata =
            pulumi.Input.asOptionalInput<bool>(importGcsCustomMetadata),
        knowledgeBaseId = pulumi.Input.asInput<String>(knowledgeBaseId),
        knowledgeTypes = pulumi.Input.asInput<
            List<DocumentKnowledgeTypesItemDialogflowV2beta1>>(knowledgeTypes),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['knowledgeTypes'] = pulumi.Input.mapInputValue<
            List<DocumentKnowledgeTypesItemDialogflowV2beta1>, List<String>>(
        knowledgeTypes,
