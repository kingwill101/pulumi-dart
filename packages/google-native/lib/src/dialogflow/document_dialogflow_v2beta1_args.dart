...
class DocumentDialogflowV2beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'knowledgeTypes': pulumi.Input.mapInputValue<List<DocumentKnowledgeTypesItemDialogflowV2beta1>, List<String>>(knowledgeTypes, (value) => pulumi.Input.encodeList<DocumentKnowledgeTypesItemDialogflowV2beta1, String>(value, (value) => value.value)),
      'location': ?location,
      'metadata': ?metadata,
      'mimeType': mimeType,
      'name': ?name,
  ...
  factory DocumentDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return DocumentDialogflowV2beta1Args(
      ...
      enableAutoReload: map['enableAutoReload'] == null ? null : map['enableAutoReload'] as bool,
      importGcsCustomMetadata: map['importGcsCustomMetadata'] == null ? null : map['importGcsCustomMetadata'] as bool,
      knowledgeBaseId: map['knowledgeBaseId'] as String,
      knowledgeTypes: pulumi.Input.decodeList<DocumentKnowledgeTypesItemDialogflowV2beta1>(map['knowledgeTypes'], (value) => DocumentKnowledgeTypesItemDialogflowV2beta1.fromValue(value as String)),
