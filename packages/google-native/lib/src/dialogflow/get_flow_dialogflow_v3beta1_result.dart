...
class GetFlowDialogflowV3beta1Result {
  ...
  /// Creates a new [GetFlowDialogflowV3beta1Result].
  ...
  GetFlowDialogflowV3beta1Result({
  ...
  factory GetFlowDialogflowV3beta1Result.fromMap(Map<String, dynamic> map) {
    return GetFlowDialogflowV3beta1Result(
      advancedSettings:
      ...
      knowledgeConnectorSettings:
          GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponse
              .fromMap((map['knowledgeConnectorSettings'] as Map)
                  .cast<String, dynamic>()),
      name: map['name'] as String,
      nluSettings: GoogleCloudDialogflowCxV3beta1NluSettingsResponse.fromMap(
