...
class EntityTypeDialogflowV3beta1Args {
  ...
  EntityTypeDialogflowV3beta1Args({
    ...
    EntityTypeAutoExpansionModeDialogflowV3beta1? autoExpansionMode,
    required String displayName,
    bool? enableFuzzyExtraction,
    List<GoogleCloudDialogflowCxV3beta1EntityTypeEntity>? entities,
    List<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase>? excludedPhrases,
    required EntityTypeKindDialogflowV3beta1 kind,
    String? languageCode,
    String? location,
    String? name,
    String? project,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agentId': agentId,
      'autoExpansionMode': ?pulumi.Input.mapOptionalInputValue<EntityTypeAutoExpansionModeDialogflowV3beta1, String>(autoExpansionMode, (value) => value.value),
      ...
      'kind': pulumi.Input.mapInputValue<EntityTypeKindDialogflowV3beta1, String>(kind, (value) => value.value),
  ...
  factory EntityTypeDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return EntityTypeDialogflowV3beta1Args(
      ...
      autoExpansionMode: map['autoExpansionMode'] == null ? null : EntityTypeAutoExpansionModeDialogflowV3beta1.fromValue(map['autoExpansionMode'] as String),
      displayName: map['displayName'] as String,
      enableFuzzyExtraction: map['enableFuzzyExtraction'] == null ? null : map['enableFuzzyExtraction'] as bool,
      entities: map['entities'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EntityTypeEntity>(map['entities'], (value) => GoogleCloudDialogflowCxV3beta1EntityTypeEntity.fromMap((value as Map).cast<String, dynamic>())),
      excludedPhrases: map['excludedPhrases'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase>(map['excludedPhrases'], (value) => GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase.fromMap((value as Map).cast<String, dynamic>())),
      kind: EntityTypeKindDialogflowV3beta1.fromValue(map['kind'] as String),
