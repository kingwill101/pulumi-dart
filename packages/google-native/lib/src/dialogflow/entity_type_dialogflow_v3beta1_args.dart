...
class EntityTypeDialogflowV3beta1Args {
  ...
  final pulumi.Input<EntityTypeAutoExpansionModeDialogflowV3beta1>?
      autoExpansionMode;
  ...
  final pulumi
      .Input<List<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase>>?
      excludedPhrases;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoExpansionModeValue != null) {
      map['autoExpansionMode'] = pulumi.Input.mapOptionalInputValue<
          EntityTypeAutoExpansionModeDialogflowV3beta1,
    ...
    map['kind'] =
        pulumi.Input.mapInputValue<EntityTypeKindDialogflowV3beta1, String>(
  ...
  factory EntityTypeDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return EntityTypeDialogflowV3beta1Args(
      ...
      autoExpansionMode: map['autoExpansionMode'] == null
          ? null
          : EntityTypeAutoExpansionModeDialogflowV3beta1.fromValue(
      ...
      excludedPhrases: map['excludedPhrases'] == null
          ...
          : pulumi.Input.decodeList<
                  GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase>(
              map['excludedPhrases'],
              (value) => GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhrase
