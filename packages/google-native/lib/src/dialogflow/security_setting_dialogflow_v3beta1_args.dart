...
class SecuritySettingDialogflowV3beta1Args {
  ...
  SecuritySettingDialogflowV3beta1Args({
    GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings? audioExportSettings,
    String? deidentifyTemplate,
    required String displayName,
    GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings? insightsExportSettings,
  ...
  factory SecuritySettingDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return SecuritySettingDialogflowV3beta1Args(
      audioExportSettings: map['audioExportSettings'] == null ? null : GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings.fromMap((map['audioExportSettings'] as Map).cast<String, dynamic>()),
      deidentifyTemplate: map['deidentifyTemplate'] == null ? null : map['deidentifyTemplate'] as String,
      displayName: map['displayName'] as String,
      insightsExportSettings: map['insightsExportSettings'] == null ? null : GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings.fromMap((map['insightsExportSettings'] as Map).cast<String, dynamic>()),
      inspectTemplate: map['inspectTemplate'] == null ? null : map['inspectTemplate'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      purgeDataTypes: map['purgeDataTypes'] == null ? null : pulumi.Input.decodeList<SecuritySettingPurgeDataTypesItemDialogflowV3beta1>(map['purgeDataTypes'], (value) => SecuritySettingPurgeDataTypesItemDialogflowV3beta1.fromValue(value as String)),
      redactionScope: map['redactionScope'] == null ? null : SecuritySettingRedactionScopeDialogflowV3beta1.fromValue(map['redactionScope'] as String),
      redactionStrategy: map['redactionStrategy'] == null ? null : SecuritySettingRedactionStrategyDialogflowV3beta1.fromValue(map['redactionStrategy'] as String),
      retentionStrategy: map['retentionStrategy'] == null ? null : SecuritySettingRetentionStrategyDialogflowV3beta1.fromValue(map['retentionStrategy'] as String),
