...
import 'google_cloud_dialogflow_v2beta1_human_agent_assistant_config_suggestion_feature_config.dart';

/// Detail human agent assistant config.
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig {
  /// Configuration of different suggestion features. One feature can have only one config.
  final List<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig>? featureConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureConfigs': ?featureConfigs == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig, Map<String, dynamic>>(featureConfigs!, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfig(
      featureConfigs: map['featureConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig>(map['featureConfigs'], (value) => GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig.fromMap((value as Map).cast<String, dynamic>())),
