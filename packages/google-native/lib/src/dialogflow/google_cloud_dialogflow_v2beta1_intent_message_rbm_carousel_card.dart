...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard {
  ...
  final List<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent> cardContents;
  /// The width of the cards in the carousel.
  final GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardCardWidth cardWidth;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cardContents': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent, Map<String, dynamic>>(cardContents, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard(
      cardContents: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent>(map['cardContents'], (value) => GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent.fromMap((value as Map).cast<String, dynamic>())),
      cardWidth: GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardCardWidth.fromValue(map['cardWidth'] as String),
    );
  }
}
