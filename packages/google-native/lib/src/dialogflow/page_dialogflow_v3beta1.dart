...
class PageDialogflowV3beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudDialogflowCxV3beta1FulfillmentResponse>
      entryFulfillment;

  /// Handlers associated with the page to handle events such as webhook errors, no match or no input.
  late final pulumi
      .Output<List<GoogleCloudDialogflowCxV3beta1EventHandlerResponse>>
      eventHandlers;
  ...
  late final pulumi
      .Output<GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponse>
  ...
  late final pulumi
      .Output<List<GoogleCloudDialogflowCxV3beta1TransitionRouteResponse>>
      transitionRoutes;
  ...
  PageDialogflowV3beta1(
    ...
    this.entryFulfillment =
        registerOutput<GoogleCloudDialogflowCxV3beta1FulfillmentResponse>(
            'entryFulfillment');
    this.eventHandlers = registerOutput<
            List<GoogleCloudDialogflowCxV3beta1EventHandlerResponse>>(
        'eventHandlers');
    this.flowId = registerOutput<String>('flowId');
    this.form =
        registerOutput<GoogleCloudDialogflowCxV3beta1FormResponse>('form');
