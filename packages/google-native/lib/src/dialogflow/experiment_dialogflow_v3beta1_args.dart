...
class ExperimentDialogflowV3beta1Args {
  ...
  ExperimentDialogflowV3beta1Args({
    ...
    String? startTime,
    ExperimentStateDialogflowV3beta1? state,
    List<GoogleCloudDialogflowCxV3beta1VariantsHistory>? variantsHistory,
  }) :
  ...
  factory ExperimentDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return ExperimentDialogflowV3beta1Args(
      ...
      definition: map['definition'] == null ? null : GoogleCloudDialogflowCxV3beta1ExperimentDefinition.fromMap((map['definition'] as Map).cast<String, dynamic>()),
      ...
      result: map['result'] == null ? null : GoogleCloudDialogflowCxV3beta1ExperimentResult.fromMap((map['result'] as Map).cast<String, dynamic>()),
      rolloutConfig: map['rolloutConfig'] == null ? null : GoogleCloudDialogflowCxV3beta1RolloutConfig.fromMap((map['rolloutConfig'] as Map).cast<String, dynamic>()),
      rolloutFailureReason: map['rolloutFailureReason'] == null ? null : map['rolloutFailureReason'] as String,
      rolloutState: map['rolloutState'] == null ? null : GoogleCloudDialogflowCxV3beta1RolloutState.fromMap((map['rolloutState'] as Map).cast<String, dynamic>()),
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      state: map['state'] == null ? null : ExperimentStateDialogflowV3beta1.fromValue(map['state'] as String),
      variantsHistory: map['variantsHistory'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1VariantsHistory>(map['variantsHistory'], (value) => GoogleCloudDialogflowCxV3beta1VariantsHistory.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
