...
class TestCaseDialogflowV3beta1Args {
  ...
  TestCaseDialogflowV3beta1Args({
    ...
    String? project,
    List<String>? tags,
    List<GoogleCloudDialogflowCxV3beta1ConversationTurn>? testCaseConversationTurns,
  ...
  factory TestCaseDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return TestCaseDialogflowV3beta1Args(
      ...
      lastTestResult: map['lastTestResult'] == null ? null : GoogleCloudDialogflowCxV3beta1TestCaseResult.fromMap((map['lastTestResult'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      notes: map['notes'] == null ? null : map['notes'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      testCaseConversationTurns: map['testCaseConversationTurns'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1ConversationTurn>(map['testCaseConversationTurns'], (value) => GoogleCloudDialogflowCxV3beta1ConversationTurn.fromMap((value as Map).cast<String, dynamic>())),
      testConfig: map['testConfig'] == null ? null : GoogleCloudDialogflowCxV3beta1TestConfig.fromMap((map['testConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
