...
class GoogleCloudDialogflowCxV3NluSettings {
  ...
  final GoogleCloudDialogflowCxV3NluSettingsModelTrainingMode? modelTrainingMode;
  ...
  factory GoogleCloudDialogflowCxV3NluSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3NluSettings(
      ...
      modelTrainingMode: map['modelTrainingMode'] == null ? null : GoogleCloudDialogflowCxV3NluSettingsModelTrainingMode.fromValue(map['modelTrainingMode'] as String),
      modelType: map['modelType'] == null ? null : GoogleCloudDialogflowCxV3NluSettingsModelType.fromValue(map['modelType'] as String),
    );
  }
}
