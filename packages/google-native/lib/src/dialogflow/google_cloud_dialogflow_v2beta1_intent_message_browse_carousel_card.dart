...
class GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'imageDisplayOptions': ?imageDisplayOptions == null
          ? null
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard(
      imageDisplayOptions: map['imageDisplayOptions'] == null
          ? null
          : GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardImageDisplayOptions.fromValue(
      ...
      items:
          ...
          >(
            map['items'],
            (value) =>
                GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItem.fromMap(
