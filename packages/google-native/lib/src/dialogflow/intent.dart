...
class Intent extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowV2IntentFollowupIntentInfoResponse>> followupIntentInfo;
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowV2IntentMessageResponse>> messages;
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowV2ContextResponse>> outputContexts;
  /// Optional. The collection of parameters associated with the intent.
  late final pulumi.Output<List<GoogleCloudDialogflowV2IntentParameterResponse>> parameters;
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowV2IntentTrainingPhraseResponse>> trainingPhrases;
  ...
  Intent(
    ...
    this.followupIntentInfo = registerOutput<List<GoogleCloudDialogflowV2IntentFollowupIntentInfoResponse>>('followupIntentInfo');
    ...
    this.messages = registerOutput<List<GoogleCloudDialogflowV2IntentMessageResponse>>('messages');
    this.mlDisabled = registerOutput<bool>('mlDisabled');
    this.name = registerOutput<String>('name');
    this.outputContexts = registerOutput<List<GoogleCloudDialogflowV2ContextResponse>>('outputContexts');
    this.parameters = registerOutput<List<GoogleCloudDialogflowV2IntentParameterResponse>>('parameters');
    ...
    this.trainingPhrases = registerOutput<List<GoogleCloudDialogflowV2IntentTrainingPhraseResponse>>('trainingPhrases');
