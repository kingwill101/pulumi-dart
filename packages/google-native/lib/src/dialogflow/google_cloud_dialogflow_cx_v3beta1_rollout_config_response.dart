...
class GoogleCloudDialogflowCxV3beta1RolloutConfigResponse {
  ...
  final List<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse> rolloutSteps;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rolloutSteps': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse, Map<String, dynamic>>(rolloutSteps, (value) => value.toMap()),
    };
  }

  factory GoogleCloudDialogflowCxV3beta1RolloutConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1RolloutConfigResponse(
      ...
      rolloutSteps: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse>(map['rolloutSteps'], (value) => GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
