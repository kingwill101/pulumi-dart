...
class GoogleCloudDialogflowCxV3AdvancedSettingsResponse {
  ...
  final GoogleCloudDialogflowCxV3GcsDestinationResponse audioExportGcsDestination;
  /// Settings for DTMF. Exposed at the following levels: - Agent level - Flow level - Page level - Parameter level.
  final GoogleCloudDialogflowCxV3AdvancedSettingsDtmfSettingsResponse dtmfSettings;
  /// Settings for logging. Settings for Dialogflow History, Contact Center messages, StackDriver logs, and speech logging. Exposed at the following levels: - Agent level.
  final GoogleCloudDialogflowCxV3AdvancedSettingsLoggingSettingsResponse loggingSettings;
  ...
  factory GoogleCloudDialogflowCxV3AdvancedSettingsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3AdvancedSettingsResponse(
      audioExportGcsDestination: GoogleCloudDialogflowCxV3GcsDestinationResponse.fromMap((map['audioExportGcsDestination'] as Map).cast<String, dynamic>()),
      dtmfSettings: GoogleCloudDialogflowCxV3AdvancedSettingsDtmfSettingsResponse.fromMap((map['dtmfSettings'] as Map).cast<String, dynamic>()),
      loggingSettings: GoogleCloudDialogflowCxV3AdvancedSettingsLoggingSettingsResponse.fromMap((map['loggingSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
