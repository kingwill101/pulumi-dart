...
class GoogleCloudDialogflowV2beta1IntentMessage {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'browseCarouselCard': ?browseCarouselCard == null
          ? null
          : browseCarouselCard!.toMap(),
      'card': ?card == null ? null : card!.toMap(),
      'carouselSelect': ?carouselSelect == null
          ? null
          : carouselSelect!.toMap(),
      'image': ?image == null ? null : image!.toMap(),
      'linkOutSuggestion': ?linkOutSuggestion == null
          ? null
          : linkOutSuggestion!.toMap(),
      ...
      'rbmCarouselRichCard': ?rbmCarouselRichCard == null
          ? null
          : rbmCarouselRichCard!.toMap(),
      'rbmStandaloneRichCard': ?rbmStandaloneRichCard == null
          ? null
          : rbmStandaloneRichCard!.toMap(),
      'rbmText': ?rbmText == null ? null : rbmText!.toMap(),
      'simpleResponses': ?simpleResponses == null
          ? null
          : simpleResponses!.toMap(),
      'suggestions': ?suggestions == null ? null : suggestions!.toMap(),
      'tableCard': ?tableCard == null ? null : tableCard!.toMap(),
      'telephonyPlayAudio': ?telephonyPlayAudio == null
          ? null
          : telephonyPlayAudio!.toMap(),
      'telephonySynthesizeSpeech': ?telephonySynthesizeSpeech == null
          ? null
          : telephonySynthesizeSpeech!.toMap(),
