...
enum GoogleCloudDialogflowCxV3beta1ExperimentResultMetricType {
  ...
  const GoogleCloudDialogflowCxV3beta1ExperimentResultMetricType(this.value);
  final String value;

  static GoogleCloudDialogflowCxV3beta1ExperimentResultMetricType fromValue(
      String value) {
    for (final item
        in GoogleCloudDialogflowCxV3beta1ExperimentResultMetricType.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError(
        'Unknown GoogleCloudDialogflowCxV3beta1ExperimentResultMetricType value: $value');
  }
}
