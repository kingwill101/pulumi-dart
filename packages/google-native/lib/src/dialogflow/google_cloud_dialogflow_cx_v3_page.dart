...
class GoogleCloudDialogflowCxV3Page {
  ...
  final GoogleCloudDialogflowCxV3KnowledgeConnectorSettings?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'entryFulfillment': ?entryFulfillment == null
          ? null
          : entryFulfillment!.toMap(),
      ...
      'knowledgeConnectorSettings': ?knowledgeConnectorSettings == null
          ? null
          : knowledgeConnectorSettings!.toMap(),
      'name': ?name,
      'transitionRouteGroups': ?transitionRouteGroups,
      'transitionRoutes': ?transitionRoutes == null
          ? null
          : pulumi.Input.encodeList<
