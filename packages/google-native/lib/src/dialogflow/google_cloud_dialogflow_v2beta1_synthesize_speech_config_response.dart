...
class GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['effectsProfileId'] = effectsProfileId;
    map['pitch'] = pitch;
    map['speakingRate'] = speakingRate;
    map['voice'] = voice.toMap();
    map['volumeGainDb'] = volumeGainDb;
    return map;
  }
  ...
  factory GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse(
      ...
      voice: GoogleCloudDialogflowV2beta1VoiceSelectionParamsResponse.fromMap(
