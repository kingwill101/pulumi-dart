...
class GoogleCloudDialogflowCxV3beta1TestCaseResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conversationTurns': ?conversationTurns == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1ConversationTurn, Map<String, dynamic>>(conversationTurns!, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowCxV3beta1TestCaseResult.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1TestCaseResult(
      conversationTurns: map['conversationTurns'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1ConversationTurn>(map['conversationTurns'], (value) => GoogleCloudDialogflowCxV3beta1ConversationTurn.fromMap((value as Map).cast<String, dynamic>())),
      environment: map['environment'] == null ? null : map['environment'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      testResult: map['testResult'] == null ? null : GoogleCloudDialogflowCxV3beta1TestCaseResultTestResult.fromValue(map['testResult'] as String),
