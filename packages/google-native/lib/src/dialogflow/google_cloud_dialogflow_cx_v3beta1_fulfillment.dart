...
class GoogleCloudDialogflowCxV3beta1Fulfillment {
  ...
  final List<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases>?
  conditionalCases;
  ...
  final List<GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterAction>?
  setParameterActions;
  ...
  factory GoogleCloudDialogflowCxV3beta1Fulfillment.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1Fulfillment(
      ...
      messages: map['messages'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['messages'],
              (value) => GoogleCloudDialogflowCxV3beta1ResponseMessage.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      ...
      setParameterActions: map['setParameterActions'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterAction.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
