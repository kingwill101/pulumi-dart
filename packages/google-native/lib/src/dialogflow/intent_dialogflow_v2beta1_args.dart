...
class IntentDialogflowV2beta1Args {
  ...
  IntentDialogflowV2beta1Args({
    String? action,
    List<IntentDefaultResponsePlatformsItemDialogflowV2beta1>? defaultResponsePlatforms,
    ...
    String? location,
    List<GoogleCloudDialogflowV2beta1IntentMessage>? messages,
    bool? mlDisabled,
    bool? mlEnabled,
    String? name,
    List<GoogleCloudDialogflowV2beta1Context>? outputContexts,
    List<GoogleCloudDialogflowV2beta1IntentParameter>? parameters,
    String? parentFollowupIntentName,
    int? priority,
    String? project,
    bool? resetContexts,
    List<GoogleCloudDialogflowV2beta1IntentTrainingPhrase>? trainingPhrases,
    IntentWebhookStateDialogflowV2beta1? webhookState,
  }) :
  ...
  factory IntentDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return IntentDialogflowV2beta1Args(
      ...
      defaultResponsePlatforms: map['defaultResponsePlatforms'] == null ? null : pulumi.Input.decodeList<IntentDefaultResponsePlatformsItemDialogflowV2beta1>(map['defaultResponsePlatforms'], (value) => IntentDefaultResponsePlatformsItemDialogflowV2beta1.fromValue(value as String)),
      displayName: map['displayName'] as String,
      endInteraction: map['endInteraction'] == null ? null : map['endInteraction'] as bool,
      events: map['events'] == null ? null : (map['events'] as List).cast<String>(),
      inputContextNames: map['inputContextNames'] == null ? null : (map['inputContextNames'] as List).cast<String>(),
      ...
      liveAgentHandoff: map['liveAgentHandoff'] == null ? null : map['liveAgentHandoff'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessage>(map['messages'], (value) => GoogleCloudDialogflowV2beta1IntentMessage.fromMap((value as Map).cast<String, dynamic>())),
      mlDisabled: map['mlDisabled'] == null ? null : map['mlDisabled'] as bool,
      mlEnabled: map['mlEnabled'] == null ? null : map['mlEnabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      outputContexts: map['outputContexts'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1Context>(map['outputContexts'], (value) => GoogleCloudDialogflowV2beta1Context.fromMap((value as Map).cast<String, dynamic>())),
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentParameter>(map['parameters'], (value) => GoogleCloudDialogflowV2beta1IntentParameter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      resetContexts: map['resetContexts'] == null ? null : map['resetContexts'] as bool,
      trainingPhrases: map['trainingPhrases'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentTrainingPhrase>(map['trainingPhrases'], (value) => GoogleCloudDialogflowV2beta1IntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>())),
      webhookState: map['webhookState'] == null ? null : IntentWebhookStateDialogflowV2beta1.fromValue(map['webhookState'] as String),
    );
  }
}
