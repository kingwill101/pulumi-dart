...
class IntentDialogflowV2beta1Args {
  ...
  IntentDialogflowV2beta1Args({
    ...
    IntentWebhookStateDialogflowV2beta1? webhookState,
       ...
       inputContextNames = pulumi.Input.asOptionalInput<List<String>>(
         inputContextNames,
       ),
       ...
       parameters =
           ...
           >(parameters),
       parentFollowupIntentName = pulumi.Input.asOptionalInput<String>(
    ...
    return <String, dynamic>{
      ...
      'webhookState':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(webhookState, (value) => value.value),
    };
  }
  ...
  factory IntentDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return IntentDialogflowV2beta1Args(
      ...
      endInteraction: map['endInteraction'] == null
          ? null
          : map['endInteraction'] as bool,
      events: map['events'] == null
          ? null
          : (map['events'] as List).cast<String>(),
      ...
      parameters: map['parameters'] == null
          ? null
          : pulumi
                .Input.decodeList<GoogleCloudDialogflowV2beta1IntentParameter>(
              map['parameters'],
      ...
      resetContexts: map['resetContexts'] == null
          ? null
          : map['resetContexts'] as bool,
      trainingPhrases: map['trainingPhrases'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['trainingPhrases'],
              (value) =>
                  GoogleCloudDialogflowV2beta1IntentTrainingPhrase.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      webhookState: map['webhookState'] == null
          ? null
          : IntentWebhookStateDialogflowV2beta1.fromValue(
              map['webhookState'] as String,
            ),
    );
  }
}
