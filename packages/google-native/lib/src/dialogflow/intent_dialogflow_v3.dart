...
class IntentDialogflowV3 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3IntentParameterResponse>> parameters;
  /// The priority of this intent. Higher numbers represent higher priorities. - If the supplied value is unspecified or 0, the service translates the value to 500,000, which corresponds to the `Normal` priority in the console. - If the supplied value is negative, the intent is ignored in runtime detect intent requests.
  late final pulumi.Output<int> priority;
  late final pulumi.Output<String> project;
  /// The collection of training phrases the agent is trained on to identify the intent.
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse>> trainingPhrases;
  ...
  IntentDialogflowV3(
    ...
    this.parameters = registerOutput<List<GoogleCloudDialogflowCxV3IntentParameterResponse>>('parameters');
    this.priority = registerOutput<int>('priority');
    this.project = registerOutput<String>('project');
    this.trainingPhrases = registerOutput<List<GoogleCloudDialogflowCxV3IntentTrainingPhraseResponse>>('trainingPhrases');
  }
}
