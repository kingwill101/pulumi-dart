...
class GoogleCloudDialogflowCxV3ExperimentResultMetricResponse {
  ...
  final GoogleCloudDialogflowCxV3ExperimentResultConfidenceIntervalResponse confidenceInterval;
  ...
  factory GoogleCloudDialogflowCxV3ExperimentResultMetricResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3ExperimentResultMetricResponse(
      confidenceInterval: GoogleCloudDialogflowCxV3ExperimentResultConfidenceIntervalResponse.fromMap((map['confidenceInterval'] as Map).cast<String, dynamic>()),
