...
import 'session_entity_type_dialogflow_v3_args.dart';
...
class SessionEntityTypeDialogflowV3 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<GoogleCloudDialogflowCxV3EntityTypeEntityResponse>> entities;
  ...
  /// Creates a new [SessionEntityTypeDialogflowV3].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SessionEntityTypeDialogflowV3]. {@macro pulumi_dialogflow_v3_session_entity_type_dialogflow_v3_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SessionEntityTypeDialogflowV3(
    String name, {
