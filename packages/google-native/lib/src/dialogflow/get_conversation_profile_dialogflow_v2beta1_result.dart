...
class GetConversationProfileDialogflowV2beta1Result {
  ...
  final GoogleCloudDialogflowV2beta1AutomatedAgentConfigResponse
  ...
  final GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigResponse
  humanAgentAssistantConfig;

  /// Configuration for connecting to a live agent. Currently, this feature is not general available, please contact Google to get access.
  final GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigResponse
  ...
  GetConversationProfileDialogflowV2beta1Result({
  ...
  factory GetConversationProfileDialogflowV2beta1Result.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetConversationProfileDialogflowV2beta1Result(
      automatedAgentConfig:
          GoogleCloudDialogflowV2beta1AutomatedAgentConfigResponse.fromMap(
            (map['automatedAgentConfig'] as Map).cast<String, dynamic>(),
          ),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      humanAgentAssistantConfig:
          GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigResponse.fromMap(
            (map['humanAgentAssistantConfig'] as Map).cast<String, dynamic>(),
          ),
      humanAgentHandoffConfig:
          GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigResponse.fromMap(
            (map['humanAgentHandoffConfig'] as Map).cast<String, dynamic>(),
          ),
      languageCode: map['languageCode'] as String,
      loggingConfig: GoogleCloudDialogflowV2beta1LoggingConfigResponse.fromMap(
      ...
      sttConfig: GoogleCloudDialogflowV2beta1SpeechToTextConfigResponse.fromMap(
        (map['sttConfig'] as Map).cast<String, dynamic>(),
      ),
      timeZone: map['timeZone'] as String,
      ttsConfig:
          GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse.fromMap(
