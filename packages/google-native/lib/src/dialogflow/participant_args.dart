...
class ParticipantArgs {
  ...
  factory ParticipantArgs.fromMap(Map<String, dynamic> map) {
    return ParticipantArgs(
      ...
      documentsMetadataFilters: map['documentsMetadataFilters'] == null ? null : (map['documentsMetadataFilters'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      obfuscatedExternalUserId: map['obfuscatedExternalUserId'] == null ? null : map['obfuscatedExternalUserId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      role: map['role'] == null ? null : ParticipantRole.fromValue(map['role'] as String),
      sipRecordingMediaLabel: map['sipRecordingMediaLabel'] == null ? null : map['sipRecordingMediaLabel'] as String,
    );
  }
}
