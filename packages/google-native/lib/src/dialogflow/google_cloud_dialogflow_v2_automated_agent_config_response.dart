...
class GoogleCloudDialogflowV2AutomatedAgentConfigResponse {
  ...
  /// Creates a new [GoogleCloudDialogflowV2AutomatedAgentConfigResponse].
  ...
  factory GoogleCloudDialogflowV2AutomatedAgentConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2AutomatedAgentConfigResponse(
