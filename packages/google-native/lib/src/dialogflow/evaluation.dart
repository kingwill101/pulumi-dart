...
class Evaluation extends pulumi.CustomResource {
  ...
  Evaluation(
    ...
    this.evaluationConfig = registerOutput<GoogleCloudDialogflowV2EvaluationConfigResponse>('evaluationConfig');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.rawHumanEvalTemplateCsv = registerOutput<String>('rawHumanEvalTemplateCsv');
    this.smartReplyMetrics = registerOutput<GoogleCloudDialogflowV2SmartReplyMetricsResponse>('smartReplyMetrics');
  }
}
