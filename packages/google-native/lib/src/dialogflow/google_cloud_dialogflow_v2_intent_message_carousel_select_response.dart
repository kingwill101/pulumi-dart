...
class GoogleCloudDialogflowV2IntentMessageCarouselSelectResponse {
  /// Carousel items.
  final List<GoogleCloudDialogflowV2IntentMessageCarouselSelectItemResponse> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'items': pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentMessageCarouselSelectItemResponse, Map<String, dynamic>>(items, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowV2IntentMessageCarouselSelectResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageCarouselSelectResponse(
      items: pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageCarouselSelectItemResponse>(map['items'], (value) => GoogleCloudDialogflowV2IntentMessageCarouselSelectItemResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
