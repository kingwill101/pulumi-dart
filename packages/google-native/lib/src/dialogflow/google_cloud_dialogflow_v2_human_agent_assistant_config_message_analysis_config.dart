...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig {
  ...
  /// Creates a new [GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig].
  ...
  Map<String, dynamic> toMap() {
    ...
    final enableEntityExtractionValue = enableEntityExtraction;
    if (enableEntityExtractionValue != null) {
      map['enableEntityExtraction'] = enableEntityExtractionValue;
    }
  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig.fromMap(
