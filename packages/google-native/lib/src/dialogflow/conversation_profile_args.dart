...
class ConversationProfileArgs {
  ...
  factory ConversationProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConversationProfileArgs(
      automatedAgentConfig: map['automatedAgentConfig'] == null ? null : GoogleCloudDialogflowV2AutomatedAgentConfig.fromMap((map['automatedAgentConfig'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      humanAgentAssistantConfig: map['humanAgentAssistantConfig'] == null ? null : GoogleCloudDialogflowV2HumanAgentAssistantConfig.fromMap((map['humanAgentAssistantConfig'] as Map).cast<String, dynamic>()),
      humanAgentHandoffConfig: map['humanAgentHandoffConfig'] == null ? null : GoogleCloudDialogflowV2HumanAgentHandoffConfig.fromMap((map['humanAgentHandoffConfig'] as Map).cast<String, dynamic>()),
      languageCode: map['languageCode'] == null ? null : map['languageCode'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      loggingConfig: map['loggingConfig'] == null ? null : GoogleCloudDialogflowV2LoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      newMessageEventNotificationConfig: map['newMessageEventNotificationConfig'] == null ? null : GoogleCloudDialogflowV2NotificationConfig.fromMap((map['newMessageEventNotificationConfig'] as Map).cast<String, dynamic>()),
      ...
      sttConfig: map['sttConfig'] == null ? null : GoogleCloudDialogflowV2SpeechToTextConfig.fromMap((map['sttConfig'] as Map).cast<String, dynamic>()),
      timeZone: map['timeZone'] == null ? null : map['timeZone'] as String,
      ttsConfig: map['ttsConfig'] == null ? null : GoogleCloudDialogflowV2SynthesizeSpeechConfig.fromMap((map['ttsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
