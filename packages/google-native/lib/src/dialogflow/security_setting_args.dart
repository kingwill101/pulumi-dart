...
class SecuritySettingArgs {
  ...
  factory SecuritySettingArgs.fromMap(Map<String, dynamic> map) {
    return SecuritySettingArgs(
      audioExportSettings: map['audioExportSettings'] == null ? null : GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettings.fromMap((map['audioExportSettings'] as Map).cast<String, dynamic>()),
      deidentifyTemplate: map['deidentifyTemplate'] == null ? null : map['deidentifyTemplate'] as String,
      displayName: map['displayName'] as String,
      insightsExportSettings: map['insightsExportSettings'] == null ? null : GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettings.fromMap((map['insightsExportSettings'] as Map).cast<String, dynamic>()),
      inspectTemplate: map['inspectTemplate'] == null ? null : map['inspectTemplate'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      purgeDataTypes: map['purgeDataTypes'] == null ? null : pulumi.Input.decodeList<SecuritySettingPurgeDataTypesItem>(map['purgeDataTypes'], (value) => SecuritySettingPurgeDataTypesItem.fromValue(value as String)),
      redactionScope: map['redactionScope'] == null ? null : SecuritySettingRedactionScope.fromValue(map['redactionScope'] as String),
      redactionStrategy: map['redactionStrategy'] == null ? null : SecuritySettingRedactionStrategy.fromValue(map['redactionStrategy'] as String),
      retentionStrategy: map['retentionStrategy'] == null ? null : SecuritySettingRetentionStrategy.fromValue(map['retentionStrategy'] as String),
