...
class GetAgentResult {
  ...
  final GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsResponse
  ...
  final GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponse
  genAppBuilderSettings;

  /// Git integration settings for this agent.
  final GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsResponse
  ...
  final GoogleCloudDialogflowCxV3SpeechToTextSettingsResponse
  ...
  final GoogleCloudDialogflowCxV3TextToSpeechSettingsResponse
  ...
  factory GetAgentResult.fromMap(Map<String, dynamic> map) {
    return GetAgentResult(
      ...
      answerFeedbackSettings:
          GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsResponse.fromMap(
      ...
      genAppBuilderSettings:
          GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponse.fromMap(
            (map['genAppBuilderSettings'] as Map).cast<String, dynamic>(),
          ),
      gitIntegrationSettings:
          GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsResponse.fromMap(
      ...
      speechToTextSettings:
          GoogleCloudDialogflowCxV3SpeechToTextSettingsResponse.fromMap(
      ...
      supportedLanguageCodes: (map['supportedLanguageCodes'] as List)
          .cast<String>(),
      textToSpeechSettings:
          GoogleCloudDialogflowCxV3TextToSpeechSettingsResponse.fromMap(
