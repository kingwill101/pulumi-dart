...
class IntentArgs {
  ...
  IntentArgs({
    ...
    IntentWebhookState? webhookState,
       ...
       trainingPhrases =
           ...
           >(trainingPhrases),
       webhookState = pulumi.Input.asOptionalInput<IntentWebhookState>(
         webhookState,
       );
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'outputContexts':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowV2Context>,
            List<Map<String, dynamic>>
          >(
            outputContexts,
            (value) =>
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      ...
      defaultResponsePlatforms: map['defaultResponsePlatforms'] == null
          ? null
          : pulumi.Input.decodeList<IntentDefaultResponsePlatformsItem>(
              map['defaultResponsePlatforms'],
              (value) =>
                  IntentDefaultResponsePlatformsItem.fromValue(value as String),
            ),
      ...
      messages: map['messages'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessage>(
              map['messages'],
              (value) => GoogleCloudDialogflowV2IntentMessage.fromMap(
      ...
      outputContexts: map['outputContexts'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudDialogflowV2Context>(
              map['outputContexts'],
              (value) => GoogleCloudDialogflowV2Context.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      parameters: map['parameters'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentParameter>(
              map['parameters'],
              (value) => GoogleCloudDialogflowV2IntentParameter.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      ...
      trainingPhrases: map['trainingPhrases'] == null
          ? null
          : pulumi
                .Input.decodeList<GoogleCloudDialogflowV2IntentTrainingPhrase>(
              map['trainingPhrases'],
              (value) => GoogleCloudDialogflowV2IntentTrainingPhrase.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      webhookState: map['webhookState'] == null
          ? null
          : IntentWebhookState.fromValue(map['webhookState'] as String),
    );
  }
}
