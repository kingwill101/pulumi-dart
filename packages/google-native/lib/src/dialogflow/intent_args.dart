...
class IntentArgs {
  ...
  IntentArgs({
    String? action,
    List<IntentDefaultResponsePlatformsItem>? defaultResponsePlatforms,
    ...
    IntentWebhookState? webhookState,
  }) :
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      ...
      defaultResponsePlatforms: map['defaultResponsePlatforms'] == null ? null : pulumi.Input.decodeList<IntentDefaultResponsePlatformsItem>(map['defaultResponsePlatforms'], (value) => IntentDefaultResponsePlatformsItem.fromValue(value as String)),
      ...
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessage>(map['messages'], (value) => GoogleCloudDialogflowV2IntentMessage.fromMap((value as Map).cast<String, dynamic>())),
      mlDisabled: map['mlDisabled'] == null ? null : map['mlDisabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      outputContexts: map['outputContexts'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2Context>(map['outputContexts'], (value) => GoogleCloudDialogflowV2Context.fromMap((value as Map).cast<String, dynamic>())),
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentParameter>(map['parameters'], (value) => GoogleCloudDialogflowV2IntentParameter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      trainingPhrases: map['trainingPhrases'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentTrainingPhrase>(map['trainingPhrases'], (value) => GoogleCloudDialogflowV2IntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>())),
      webhookState: map['webhookState'] == null ? null : IntentWebhookState.fromValue(map['webhookState'] as String),
    );
  }
}
