...
class GoogleCloudDialogflowCxV3ExperimentResultConfidenceInterval {
  ...
  Map<String, dynamic> toMap() {
    ...
    final lowerBoundValue = lowerBound;
    if (lowerBoundValue != null) {
      map['lowerBound'] = lowerBoundValue;
    }
    final ratioValue = ratio;
    if (ratioValue != null) {
      map['ratio'] = ratioValue;
    }
    final upperBoundValue = upperBound;
    if (upperBoundValue != null) {
      map['upperBound'] = upperBoundValue;
    }
    return map;
  }
  ...
  factory GoogleCloudDialogflowCxV3ExperimentResultConfidenceInterval.fromMap(
    ...
    return GoogleCloudDialogflowCxV3ExperimentResultConfidenceInterval(
      confidenceLevel: map['confidenceLevel'] == null
          ? null
          : map['confidenceLevel'] as double,
      lowerBound:
          map['lowerBound'] == null ? null : map['lowerBound'] as double,
      ratio: map['ratio'] == null ? null : map['ratio'] as double,
      upperBound:
          map['upperBound'] == null ? null : map['upperBound'] as double,
    );
  }
}
