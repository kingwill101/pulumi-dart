...
class GoogleCloudDialogflowV2IntentMessageSimpleResponsesResponse {
  ...
  final List<GoogleCloudDialogflowV2IntentMessageSimpleResponseResponse> simpleResponses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'simpleResponses': pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentMessageSimpleResponseResponse, Map<String, dynamic>>(simpleResponses, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowV2IntentMessageSimpleResponsesResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageSimpleResponsesResponse(
      simpleResponses: pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageSimpleResponseResponse>(map['simpleResponses'], (value) => GoogleCloudDialogflowV2IntentMessageSimpleResponseResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
