...
class Environment extends pulumi.CustomResource {
  ...
  Environment(
    ...
    this.fulfillment = registerOutput<GoogleCloudDialogflowV2FulfillmentResponse>('fulfillment');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.state = registerOutput<String>('state');
    this.textToSpeechSettings = registerOutput<GoogleCloudDialogflowV2TextToSpeechSettingsResponse>('textToSpeechSettings');
