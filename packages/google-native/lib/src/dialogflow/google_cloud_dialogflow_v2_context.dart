...
class GoogleCloudDialogflowV2Context {
  ...
  /// Creates a new [GoogleCloudDialogflowV2Context].
  ...
  factory GoogleCloudDialogflowV2Context.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2Context(
      lifespanCount:
          map['lifespanCount'] == null ? null : map['lifespanCount'] as int,
