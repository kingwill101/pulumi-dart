...
class GoogleCloudDialogflowV2beta1IntentParameter {
  ...
  factory GoogleCloudDialogflowV2beta1IntentParameter.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentParameter(
      ...
      entityTypeDisplayName: map['entityTypeDisplayName'] == null ? null : map['entityTypeDisplayName'] as String,
      isList: map['isList'] == null ? null : map['isList'] as bool,
      mandatory: map['mandatory'] == null ? null : map['mandatory'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      prompts: map['prompts'] == null ? null : (map['prompts'] as List).cast<String>(),
