...
class GoogleCloudDialogflowCxV3beta1RolloutConfig {
  ...
  final List<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep>?
      rolloutSteps;
  ...
  Map<String, dynamic> toMap() {
    ...
    final failureConditionValue = failureCondition;
    if (failureConditionValue != null) {
      map['failureCondition'] = failureConditionValue;
    }
    final rolloutConditionValue = rolloutCondition;
    if (rolloutConditionValue != null) {
      map['rolloutCondition'] = rolloutConditionValue;
    }
  ...
  factory GoogleCloudDialogflowCxV3beta1RolloutConfig.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1RolloutConfig(
      failureCondition: map['failureCondition'] == null
          ? null
          : map['failureCondition'] as String,
      rolloutCondition: map['rolloutCondition'] == null
          ? null
