...
class TestCaseDialogflowV3beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3beta1ConversationTurnResponse>> testCaseConversationTurns;
  ...
  TestCaseDialogflowV3beta1(
    ...
    this.lastTestResult = registerOutput<GoogleCloudDialogflowCxV3beta1TestCaseResultResponse>('lastTestResult');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.notes = registerOutput<String>('notes');
    this.project = registerOutput<String>('project');
    this.tags = registerOutput<List<String>>('tags');
    this.testCaseConversationTurns = registerOutput<List<GoogleCloudDialogflowCxV3beta1ConversationTurnResponse>>('testCaseConversationTurns');
    this.testConfig = registerOutput<GoogleCloudDialogflowCxV3beta1TestConfigResponse>('testConfig');
  }
}
