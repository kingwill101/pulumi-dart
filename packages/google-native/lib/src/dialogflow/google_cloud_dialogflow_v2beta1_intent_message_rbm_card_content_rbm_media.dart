...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia {
  ...
  final GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaHeight? height;
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia(
      ...
      height: map['height'] == null ? null : GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaHeight.fromValue(map['height'] as String),
      thumbnailUri: map['thumbnailUri'] == null ? null : map['thumbnailUri'] as String,
    );
  }
}
