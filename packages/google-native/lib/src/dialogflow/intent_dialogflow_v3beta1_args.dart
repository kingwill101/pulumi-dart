...
class IntentDialogflowV3beta1Args {
  ...
  factory IntentDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return IntentDialogflowV3beta1Args(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentParameter>(map['parameters'], (value) => GoogleCloudDialogflowCxV3beta1IntentParameter.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] == null ? null : map['priority'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      trainingPhrases: map['trainingPhrases'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase>(map['trainingPhrases'], (value) => GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
