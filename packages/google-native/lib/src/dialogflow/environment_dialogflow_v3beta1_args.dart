...
class EnvironmentDialogflowV3beta1Args {
  ...
  factory EnvironmentDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return EnvironmentDialogflowV3beta1Args(
      ...
      testCasesConfig: map['testCasesConfig'] == null
          ? null
          : GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfig.fromMap(
              (map['testCasesConfig'] as Map).cast<String, dynamic>(),
            ),
      versionConfigs: map['versionConfigs'] == null
          ? null
          : pulumi.Input.decodeList<
            ...
            >(
              map['versionConfigs'],
              (value) =>
                  GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfig.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      webhookConfig: map['webhookConfig'] == null
          ? null
          : GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfig.fromMap(
