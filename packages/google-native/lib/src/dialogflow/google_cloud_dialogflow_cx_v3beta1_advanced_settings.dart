...
class GoogleCloudDialogflowCxV3beta1AdvancedSettings {
  ...
  final GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettings? dtmfSettings;
  /// Settings for logging. Settings for Dialogflow History, Contact Center messages, StackDriver logs, and speech logging. Exposed at the following levels: - Agent level.
  final GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettings? loggingSettings;
  ...
  factory GoogleCloudDialogflowCxV3beta1AdvancedSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1AdvancedSettings(
      audioExportGcsDestination: map['audioExportGcsDestination'] == null ? null : GoogleCloudDialogflowCxV3beta1GcsDestination.fromMap((map['audioExportGcsDestination'] as Map).cast<String, dynamic>()),
      dtmfSettings: map['dtmfSettings'] == null ? null : GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettings.fromMap((map['dtmfSettings'] as Map).cast<String, dynamic>()),
      loggingSettings: map['loggingSettings'] == null ? null : GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettings.fromMap((map['loggingSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
