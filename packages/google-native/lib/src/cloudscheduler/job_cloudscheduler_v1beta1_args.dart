...
class JobCloudschedulerV1beta1Args {
  ...
  JobCloudschedulerV1beta1Args({
    ...
    String? timeZone,
       ...
       httpTarget = pulumi
           .Input.asOptionalInput<HttpTargetCloudschedulerV1beta1>(httpTarget),
       legacyAppEngineCron = pulumi.Input.asOptionalInput<bool>(
         legacyAppEngineCron,
       ),
  ...
  factory JobCloudschedulerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return JobCloudschedulerV1beta1Args(
      appEngineHttpTarget: map['appEngineHttpTarget'] == null
          ? null
          : AppEngineHttpTargetCloudschedulerV1beta1.fromMap(
      ...
      httpTarget: map['httpTarget'] == null
          ? null
          : HttpTargetCloudschedulerV1beta1.fromMap(
              (map['httpTarget'] as Map).cast<String, dynamic>(),
            ),
      legacyAppEngineCron: map['legacyAppEngineCron'] == null
          ? null
          : map['legacyAppEngineCron'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pubsubTarget: map['pubsubTarget'] == null
          ? null
          : PubsubTargetCloudschedulerV1beta1.fromMap(
              (map['pubsubTarget'] as Map).cast<String, dynamic>(),
            ),
      retryConfig: map['retryConfig'] == null
          ? null
          : RetryConfigCloudschedulerV1beta1.fromMap(
