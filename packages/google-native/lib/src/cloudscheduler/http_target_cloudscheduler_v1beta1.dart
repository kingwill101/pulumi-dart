...
class HttpTargetCloudschedulerV1beta1 {
  ...
  final HttpTargetHttpMethodCloudschedulerV1beta1? httpMethod;
  /// If specified, an [OAuth token](https://developers.google.com/identity/protocols/OAuth2) will be generated and attached as an `Authorization` header in the HTTP request. This type of authorization should generally only be used when calling Google APIs hosted on *.googleapis.com.
  final OAuthTokenCloudschedulerV1beta1? oauthToken;
  /// If specified, an [OIDC](https://developers.google.com/identity/protocols/OpenIDConnect) token will be generated and attached as an `Authorization` header in the HTTP request. This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself.
  final OidcTokenCloudschedulerV1beta1? oidcToken;
  ...
  factory HttpTargetCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpTargetCloudschedulerV1beta1(
      ...
      httpMethod: map['httpMethod'] == null ? null : HttpTargetHttpMethodCloudschedulerV1beta1.fromValue(map['httpMethod'] as String),
      oauthToken: map['oauthToken'] == null ? null : OAuthTokenCloudschedulerV1beta1.fromMap((map['oauthToken'] as Map).cast<String, dynamic>()),
      oidcToken: map['oidcToken'] == null ? null : OidcTokenCloudschedulerV1beta1.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
