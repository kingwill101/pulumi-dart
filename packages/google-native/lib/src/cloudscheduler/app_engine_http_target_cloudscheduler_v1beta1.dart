...
class AppEngineHttpTargetCloudschedulerV1beta1 {
  ...
  final AppEngineRoutingCloudschedulerV1beta1? appEngineRouting;
  ...
  final AppEngineHttpTargetHttpMethodCloudschedulerV1beta1? httpMethod;
  ...
  factory AppEngineHttpTargetCloudschedulerV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return AppEngineHttpTargetCloudschedulerV1beta1(
      appEngineRouting: map['appEngineRouting'] == null
          ? null
          : AppEngineRoutingCloudschedulerV1beta1.fromMap(
      ...
      httpMethod: map['httpMethod'] == null
          ? null
          : AppEngineHttpTargetHttpMethodCloudschedulerV1beta1.fromValue(
