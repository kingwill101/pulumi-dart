...
import 'oauth_token_response_cloudscheduler_v1beta1.dart';
import 'oidc_token_response_cloudscheduler_v1beta1.dart';

/// Http target. The job will be pushed to the job handler by means of an HTTP request via an http_method such as HTTP POST, HTTP GET, etc. The job is acknowledged by means of an HTTP response code in the range [200 - 299]. A failure to receive a response constitutes a failed execution. For a redirected request, the response returned by the redirected request is considered.
class HttpTargetResponseCloudschedulerV1beta1 {
  ...
  final OAuthTokenResponseCloudschedulerV1beta1 oauthToken;

  /// If specified, an [OIDC](https://developers.google.com/identity/protocols/OpenIDConnect) token will be generated and attached as an `Authorization` header in the HTTP request. This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself.
  final OidcTokenResponseCloudschedulerV1beta1 oidcToken;

  /// The full URI path that the request will be sent to. This string must begin with either "http://" or "https://". Some examples of valid values for uri are: `http://acme.com` and `https://acme.com/sales:8080`. Cloud Scheduler will encode some characters for safety and compatibility. The maximum allowed URL length is 2083 characters after encoding.
  final String uri;

  /// Creates a new [HttpTargetResponseCloudschedulerV1beta1].
  ...
  HttpTargetResponseCloudschedulerV1beta1({
    required this.body,
  ...
  factory HttpTargetResponseCloudschedulerV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return HttpTargetResponseCloudschedulerV1beta1(
      body: map['body'] as String,
      headers: (map['headers'] as Map).cast<String, String>(),
      httpMethod: map['httpMethod'] as String,
      oauthToken: OAuthTokenResponseCloudschedulerV1beta1.fromMap(
        (map['oauthToken'] as Map).cast<String, dynamic>(),
      ),
      oidcToken: OidcTokenResponseCloudschedulerV1beta1.fromMap(
