...
class OrganizationContactArgs {
  ...
  OrganizationContactArgs({
    ...
    required List<OrganizationContactNotificationCategorySubscriptionsItem> notificationCategorySubscriptions,
  ...
  factory OrganizationContactArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationContactArgs(
      ...
      notificationCategorySubscriptions: pulumi.Input.decodeList<OrganizationContactNotificationCategorySubscriptionsItem>(map['notificationCategorySubscriptions'], (value) => OrganizationContactNotificationCategorySubscriptionsItem.fromValue(value as String)),
      organizationId: map['organizationId'] as String,
      validateTime: map['validateTime'] == null ? null : map['validateTime'] as String,
      validationState: map['validationState'] == null ? null : OrganizationContactValidationState.fromValue(map['validationState'] as String),
    );
  }
}
