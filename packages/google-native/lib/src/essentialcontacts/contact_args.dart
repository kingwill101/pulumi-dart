...
class ContactArgs {
  ...
  ContactArgs({
    ...
    required List<ContactNotificationCategorySubscriptionsItem> notificationCategorySubscriptions,
    String? project,
    String? validateTime,
  ...
  factory ContactArgs.fromMap(Map<String, dynamic> map) {
    return ContactArgs(
      ...
      notificationCategorySubscriptions: pulumi.Input.decodeList<ContactNotificationCategorySubscriptionsItem>(map['notificationCategorySubscriptions'], (value) => ContactNotificationCategorySubscriptionsItem.fromValue(value as String)),
      project: map['project'] == null ? null : map['project'] as String,
      validateTime: map['validateTime'] == null ? null : map['validateTime'] as String,
      validationState: map['validationState'] == null ? null : ContactValidationState.fromValue(map['validationState'] as String),
    );
  }
}
