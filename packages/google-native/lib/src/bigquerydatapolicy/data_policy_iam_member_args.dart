...
/// {@template pulumi_bigquerydatapolicy_v1_data_policy_iam_member_args_doc}
/// The set of arguments for DataPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_bigquerydatapolicy_v1_data_policy_iam_member_args_doc}
class DataPolicyIamMemberArgs {
  ...
  /// Creates a new [DataPolicyIamMemberArgs].
  ...
  factory DataPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DataPolicyIamMemberArgs(
