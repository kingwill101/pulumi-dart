...
class GoogleCloudMlV1ReplicaConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['containerArgs'] = containerArgs;
    map['containerCommand'] = containerCommand;
    map['diskConfig'] = diskConfig.toMap();
    map['imageUri'] = imageUri;
    map['tpuTfVersion'] = tpuTfVersion;
    return map;
  }

  factory GoogleCloudMlV1ReplicaConfigResponse.fromMap(
    ...
    return GoogleCloudMlV1ReplicaConfigResponse(
      ...
      diskConfig: GoogleCloudMlV1DiskConfigResponse.fromMap(
