...
class GoogleCloudMlV1ExplanationConfigResponse {
  ...
  final GoogleCloudMlV1IntegratedGradientsAttributionResponse integratedGradientsAttribution;
  /// An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features.
  final GoogleCloudMlV1SampledShapleyAttributionResponse sampledShapleyAttribution;
  ...
  factory GoogleCloudMlV1ExplanationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ExplanationConfigResponse(
      integratedGradientsAttribution: GoogleCloudMlV1IntegratedGradientsAttributionResponse.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>()),
      sampledShapleyAttribution: GoogleCloudMlV1SampledShapleyAttributionResponse.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>()),
      xraiAttribution: GoogleCloudMlV1XraiAttributionResponse.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>()),
    );
  }
}
