...
class GoogleCloudMlV1ParameterSpec {
  ...
  Map<String, dynamic> toMap() {
    ...
    final categoricalValuesValue = categoricalValues;
    if (categoricalValuesValue != null) {
      map['categoricalValues'] = categoricalValuesValue;
    }
    final discreteValuesValue = discreteValues;
    if (discreteValuesValue != null) {
      map['discreteValues'] = discreteValuesValue;
    }
  ...
  factory GoogleCloudMlV1ParameterSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ParameterSpec(
      categoricalValues: map['categoricalValues'] == null
          ? null
          : (map['categoricalValues'] as List).cast<String>(),
      discreteValues: map['discreteValues'] == null
          ? null
