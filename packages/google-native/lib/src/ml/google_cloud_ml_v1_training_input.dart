...
class GoogleCloudMlV1TrainingInput {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parameterServerConfig': ?parameterServerConfig == null
          ? null
          : parameterServerConfig!.toMap(),
  ...
  factory GoogleCloudMlV1TrainingInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingInput(
      ...
      evaluatorType: map['evaluatorType'] == null
          ? null
          : map['evaluatorType'] as String,
