...
class VersionArgs {
  ...
  VersionArgs({
    ...
    String? serviceAccount,
            ...
            pulumi.Input.asOptionalInput<GoogleCloudMlV1AcceleratorConfig>(
                acceleratorConfig),
        autoScaling = pulumi.Input.asOptionalInput<GoogleCloudMlV1AutoScaling>(
            autoScaling),
        container = pulumi.Input.asOptionalInput<GoogleCloudMlV1ContainerSpec>(
            container),
        deploymentUri = pulumi.Input.asOptionalInput<String>(deploymentUri),
        description = pulumi.Input.asOptionalInput<String>(description),
        etag = pulumi.Input.asOptionalInput<String>(etag),
        explanationConfig =
            pulumi.Input.asOptionalInput<GoogleCloudMlV1ExplanationConfig>(
                explanationConfig),
        ...
        manualScaling =
            pulumi.Input.asOptionalInput<GoogleCloudMlV1ManualScaling>(
                manualScaling),
        ...
        requestLoggingConfig =
            pulumi.Input.asOptionalInput<GoogleCloudMlV1RequestLoggingConfig>(
                requestLoggingConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (explanationConfigValue != null) {
      map['explanationConfig'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (frameworkValue != null) {
      map['framework'] =
          pulumi.Input.mapOptionalInputValue<VersionFramework, String>(
    ...
    if (requestLoggingConfigValue != null) {
      map['requestLoggingConfig'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      ...
      autoScaling: map['autoScaling'] == null
          ? null
          : GoogleCloudMlV1AutoScaling.fromMap(
              (map['autoScaling'] as Map).cast<String, dynamic>()),
      container: map['container'] == null
          ? null
          : GoogleCloudMlV1ContainerSpec.fromMap(
              (map['container'] as Map).cast<String, dynamic>()),
      deploymentUri:
          map['deploymentUri'] == null ? null : map['deploymentUri'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      explanationConfig: map['explanationConfig'] == null
          ? null
          : GoogleCloudMlV1ExplanationConfig.fromMap(
              (map['explanationConfig'] as Map).cast<String, dynamic>()),
      framework: map['framework'] == null
          ? null
          : VersionFramework.fromValue(map['framework'] as String),
      ...
      manualScaling: map['manualScaling'] == null
          ? null
          : GoogleCloudMlV1ManualScaling.fromMap(
              (map['manualScaling'] as Map).cast<String, dynamic>()),
      modelId: map['modelId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      packageUris: map['packageUris'] == null
          ? null
          : (map['packageUris'] as List).cast<String>(),
      predictionClass: map['predictionClass'] == null
          ? null
          : map['predictionClass'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pythonVersion: map['pythonVersion'] as String,
      requestLoggingConfig: map['requestLoggingConfig'] == null
          ? null
          : GoogleCloudMlV1RequestLoggingConfig.fromMap(
              (map['requestLoggingConfig'] as Map).cast<String, dynamic>()),
      routes: map['routes'] == null
          ? null
          : GoogleCloudMlV1RouteMap.fromMap(
