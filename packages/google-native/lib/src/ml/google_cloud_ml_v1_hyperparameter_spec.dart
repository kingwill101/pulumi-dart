...
class GoogleCloudMlV1HyperparameterSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maxTrials': ?maxTrials,
      'params': pulumi.Input.encodeList<GoogleCloudMlV1ParameterSpec, Map<String, dynamic>>(params, (value) => value.toMap()),
  ...
  factory GoogleCloudMlV1HyperparameterSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1HyperparameterSpec(
      algorithm: map['algorithm'] == null ? null : GoogleCloudMlV1HyperparameterSpecAlgorithm.fromValue(map['algorithm'] as String),
      enableTrialEarlyStopping: map['enableTrialEarlyStopping'] == null ? null : map['enableTrialEarlyStopping'] as bool,
      goal: GoogleCloudMlV1HyperparameterSpecGoal.fromValue(map['goal'] as String),
      hyperparameterMetricTag: map['hyperparameterMetricTag'] == null ? null : map['hyperparameterMetricTag'] as String,
      maxFailedTrials: map['maxFailedTrials'] == null ? null : map['maxFailedTrials'] as int,
      maxParallelTrials: map['maxParallelTrials'] == null ? null : map['maxParallelTrials'] as int,
      maxTrials: map['maxTrials'] == null ? null : map['maxTrials'] as int,
      params: pulumi.Input.decodeList<GoogleCloudMlV1ParameterSpec>(map['params'], (value) => GoogleCloudMlV1ParameterSpec.fromMap((value as Map).cast<String, dynamic>())),
      resumePreviousJobId: map['resumePreviousJobId'] == null ? null : map['resumePreviousJobId'] as String,
    );
  }
}
