...
class GoogleCloudMlV1Scheduling {
  ...
  Map<String, dynamic> toMap() {
    ...
    final maxRunningTimeValue = maxRunningTime;
    if (maxRunningTimeValue != null) {
      map['maxRunningTime'] = maxRunningTimeValue;
    }
    final maxWaitTimeValue = maxWaitTime;
    if (maxWaitTimeValue != null) {
      map['maxWaitTime'] = maxWaitTimeValue;
    }
  ...
  factory GoogleCloudMlV1Scheduling.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1Scheduling(
      maxRunningTime: map['maxRunningTime'] == null
          ? null
          : map['maxRunningTime'] as String,
      maxWaitTime:
          map['maxWaitTime'] == null ? null : map['maxWaitTime'] as String,
