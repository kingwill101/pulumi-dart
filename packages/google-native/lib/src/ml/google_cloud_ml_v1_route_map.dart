...
class GoogleCloudMlV1RouteMap {
  ...
  /// Creates a new [GoogleCloudMlV1RouteMap].
  ...
  Map<String, dynamic> toMap() {
    ...
    if (healthValue != null) {
      map['health'] = healthValue;
    }
    final predictValue = predict;
    if (predictValue != null) {
      map['predict'] = predictValue;
    }
    return map;
  }
  ...
  factory GoogleCloudMlV1RouteMap.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1RouteMap(
      ...
      predict: map['predict'] == null ? null : map['predict'] as String,
    );
  }
}
