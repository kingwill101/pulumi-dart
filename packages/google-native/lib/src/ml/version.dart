...
class Version extends pulumi.CustomResource {
  ...
  Version(
    ...
    this.acceleratorConfig = registerOutput<GoogleCloudMlV1AcceleratorConfigResponse>('acceleratorConfig');
    this.autoScaling = registerOutput<GoogleCloudMlV1AutoScalingResponse>('autoScaling');
    this.container = registerOutput<GoogleCloudMlV1ContainerSpecResponse>('container');
    ...
    this.explanationConfig = registerOutput<GoogleCloudMlV1ExplanationConfigResponse>('explanationConfig');
    ...
    this.manualScaling = registerOutput<GoogleCloudMlV1ManualScalingResponse>('manualScaling');
    ...
    this.requestLoggingConfig = registerOutput<GoogleCloudMlV1RequestLoggingConfigResponse>('requestLoggingConfig');
