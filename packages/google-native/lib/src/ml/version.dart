...
class Version extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudMlV1AcceleratorConfigResponse>
  acceleratorConfig;
  ...
  late final pulumi.Output<GoogleCloudMlV1ExplanationConfigResponse>
  explanationConfig;
  ...
  late final pulumi.Output<GoogleCloudMlV1RequestLoggingConfigResponse>
  ...
  Version(
    ...
    this.autoScaling = registerOutput<GoogleCloudMlV1AutoScalingResponse>(
      'autoScaling',
    );
    this.container = registerOutput<GoogleCloudMlV1ContainerSpecResponse>(
      'container',
    );
    ...
    this.manualScaling = registerOutput<GoogleCloudMlV1ManualScalingResponse>(
      'manualScaling',
    );
