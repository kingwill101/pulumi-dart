...
class Trial extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudMlV1MeasurementResponse>> measurements;
  /// Name of the trial assigned by the service.
  late final pulumi.Output<String> name;
  /// The parameters of the trial.
  late final pulumi.Output<List<GoogleCloudMlV1TrialParameterResponse>> parameters;
  ...
  Trial(
    ...
    this.finalMeasurement = registerOutput<GoogleCloudMlV1MeasurementResponse>('finalMeasurement');
    this.infeasibleReason = registerOutput<String>('infeasibleReason');
    this.location = registerOutput<String>('location');
    this.measurements = registerOutput<List<GoogleCloudMlV1MeasurementResponse>>('measurements');
    this.name = registerOutput<String>('name');
    this.parameters = registerOutput<List<GoogleCloudMlV1TrialParameterResponse>>('parameters');
