...
class Model extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudMlV1VersionResponse> defaultVersion;
  ...
  /// [args] Arguments used to configure this [Model]. {@macro pulumi_ml_v1_model_args_doc}
  ...
  Model(String name, {ModelArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.defaultVersion = registerOutput<GoogleCloudMlV1VersionResponse>(
      'defaultVersion',
    );
    ...
    this.onlinePredictionConsoleLogging = registerOutput<bool>(
      'onlinePredictionConsoleLogging',
    );
    this.onlinePredictionLogging = registerOutput<bool>(
