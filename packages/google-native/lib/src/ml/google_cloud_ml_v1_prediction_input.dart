...
class GoogleCloudMlV1PredictionInput {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'modelName': ?modelName,
      'outputDataFormat': ?outputDataFormat == null ? null : outputDataFormat!.value,
  ...
  factory GoogleCloudMlV1PredictionInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1PredictionInput(
      ...
      dataFormat: GoogleCloudMlV1PredictionInputDataFormat.fromValue(map['dataFormat'] as String),
      inputPaths: (map['inputPaths'] as List).cast<String>(),
      maxWorkerCount: map['maxWorkerCount'] == null ? null : map['maxWorkerCount'] as String,
      modelName: map['modelName'] == null ? null : map['modelName'] as String,
      outputDataFormat: map['outputDataFormat'] == null ? null : GoogleCloudMlV1PredictionInputOutputDataFormat.fromValue(map['outputDataFormat'] as String),
      outputPath: map['outputPath'] as String,
      region: map['region'] as String,
      runtimeVersion: map['runtimeVersion'] == null ? null : map['runtimeVersion'] as String,
      signatureName: map['signatureName'] == null ? null : map['signatureName'] as String,
