...
class GetModelResult {
  ...
  factory GetModelResult.fromMap(Map<String, dynamic> map) {
    return GetModelResult(
      defaultVersion: GoogleCloudMlV1VersionResponse.fromMap((map['defaultVersion'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      etag: map['etag'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      onlinePredictionConsoleLogging: map['onlinePredictionConsoleLogging'] as bool,
