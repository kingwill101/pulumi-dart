...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      predictionInput: map['predictionInput'] == null ? null : GoogleCloudMlV1PredictionInput.fromMap((map['predictionInput'] as Map).cast<String, dynamic>()),
      predictionOutput: map['predictionOutput'] == null ? null : GoogleCloudMlV1PredictionOutput.fromMap((map['predictionOutput'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      trainingInput: map['trainingInput'] == null ? null : GoogleCloudMlV1TrainingInput.fromMap((map['trainingInput'] as Map).cast<String, dynamic>()),
      trainingOutput: map['trainingOutput'] == null ? null : GoogleCloudMlV1TrainingOutput.fromMap((map['trainingOutput'] as Map).cast<String, dynamic>()),
    );
  }
}
