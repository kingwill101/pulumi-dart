...
class ApigatewayBackendConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final googleServiceAccountValue = googleServiceAccount;
    if (googleServiceAccountValue != null) {
      map['googleServiceAccount'] = googleServiceAccountValue;
    }
    return map;
  }
  ...
  factory ApigatewayBackendConfig.fromMap(Map<String, dynamic> map) {
    return ApigatewayBackendConfig(
      googleServiceAccount: map['googleServiceAccount'] == null
          ? null
