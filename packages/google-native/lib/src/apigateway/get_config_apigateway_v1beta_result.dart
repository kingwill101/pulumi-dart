...
class GetConfigApigatewayV1betaResult {
  ...
  final List<ApigatewayApiConfigGrpcServiceDefinitionResponseApigatewayV1beta>
  grpcServices;
  ...
  final List<ApigatewayApiConfigFileResponseApigatewayV1beta>
  ...
  final List<ApigatewayApiConfigOpenApiDocumentResponseApigatewayV1beta>
  openapiDocuments;
    ...
    return <String, dynamic>{
      ...
      'grpcServices':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(grpcServices, (value) => value.toMap()),
      'labels': labels,
      'managedServiceConfigs':
          pulumi.Input.encodeList<
      ...
      'openapiDocuments':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(openapiDocuments, (value) => value.toMap()),
    ...
    return GetConfigApigatewayV1betaResult(
      ...
      grpcServices:
          ...
          >(
            map['grpcServices'],
            (value) =>
                ApigatewayApiConfigGrpcServiceDefinitionResponseApigatewayV1beta.fromMap(
      ...
      managedServiceConfigs:
          ...
          >(
            ...
            (value) => ApigatewayApiConfigFileResponseApigatewayV1beta.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      openapiDocuments:
          ...
          >(
            ...
            (value) =>
                ApigatewayApiConfigOpenApiDocumentResponseApigatewayV1beta.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
