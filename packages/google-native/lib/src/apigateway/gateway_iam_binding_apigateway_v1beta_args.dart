...
/// {@template pulumi_apigateway_v1beta_gateway_iam_binding_apigateway_v1beta_args_doc}
/// The set of arguments for GatewayIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigateway_v1beta_gateway_iam_binding_apigateway_v1beta_args_doc}
class GatewayIamBindingApigatewayV1betaArgs {
  ...
  /// Creates a new [GatewayIamBindingApigatewayV1betaArgs].
  ...
  GatewayIamBindingApigatewayV1betaArgs({
    Condition? condition,
  ...
  factory GatewayIamBindingApigatewayV1betaArgs.fromMap(Map<String, dynamic> map) {
    return GatewayIamBindingApigatewayV1betaArgs(
