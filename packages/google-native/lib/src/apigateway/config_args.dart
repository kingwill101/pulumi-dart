...
class ConfigArgs {
  ...
  factory ConfigArgs.fromMap(Map<String, dynamic> map) {
    return ConfigArgs(
      ...
      gatewayServiceAccount: map['gatewayServiceAccount'] == null ? null : map['gatewayServiceAccount'] as String,
      grpcServices: map['grpcServices'] == null ? null : pulumi.Input.decodeList<ApigatewayApiConfigGrpcServiceDefinition>(map['grpcServices'], (value) => ApigatewayApiConfigGrpcServiceDefinition.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      managedServiceConfigs: map['managedServiceConfigs'] == null ? null : pulumi.Input.decodeList<ApigatewayApiConfigFile>(map['managedServiceConfigs'], (value) => ApigatewayApiConfigFile.fromMap((value as Map).cast<String, dynamic>())),
      openapiDocuments: map['openapiDocuments'] == null ? null : pulumi.Input.decodeList<ApigatewayApiConfigOpenApiDocument>(map['openapiDocuments'], (value) => ApigatewayApiConfigOpenApiDocument.fromMap((value as Map).cast<String, dynamic>())),
