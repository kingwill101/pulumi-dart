...
class ApigatewayBinding {
  ...
  final ApigatewayExpr? condition;
  ...
  /// Creates a new [ApigatewayBinding].
  ...
  factory ApigatewayBinding.fromMap(Map<String, dynamic> map) {
    return ApigatewayBinding(
      condition: map['condition'] == null
          ? null
          : ApigatewayExpr.fromMap(
