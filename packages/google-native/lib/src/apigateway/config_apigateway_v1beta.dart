...
class ConfigApigatewayV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ApigatewayApiConfigGrpcServiceDefinitionResponseApigatewayV1beta>> grpcServices;
  ...
  late final pulumi.Output<List<ApigatewayApiConfigFileResponseApigatewayV1beta>> managedServiceConfigs;
  ...
  late final pulumi.Output<List<ApigatewayApiConfigOpenApiDocumentResponseApigatewayV1beta>> openapiDocuments;
  ...
  ConfigApigatewayV1beta(
    ...
    this.gatewayConfig = registerOutput<ApigatewayGatewayConfigResponse>('gatewayConfig');
    this.gatewayServiceAccount = registerOutput<String>('gatewayServiceAccount');
    this.grpcServices = registerOutput<List<ApigatewayApiConfigGrpcServiceDefinitionResponseApigatewayV1beta>>('grpcServices');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.managedServiceConfigs = registerOutput<List<ApigatewayApiConfigFileResponseApigatewayV1beta>>('managedServiceConfigs');
    this.name = registerOutput<String>('name');
    this.openapiDocuments = registerOutput<List<ApigatewayApiConfigOpenApiDocumentResponseApigatewayV1beta>>('openapiDocuments');
