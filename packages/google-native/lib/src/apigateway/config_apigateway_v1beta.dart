...
class ConfigApigatewayV1beta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<List<ApigatewayApiConfigFileResponseApigatewayV1beta>>
  ...
  late final pulumi
      .Output<List<ApigatewayApiConfigOpenApiDocumentResponseApigatewayV1beta>>
      openapiDocuments;
  ...
  ConfigApigatewayV1beta(
    ...
    this.grpcServices = registerOutput<
            List<
                ApigatewayApiConfigGrpcServiceDefinitionResponseApigatewayV1beta>>(
        'grpcServices');
    ...
    this.openapiDocuments = registerOutput<
