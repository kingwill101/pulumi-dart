...
class ConfigApigatewayV1betaArgs {
  ...
  ConfigApigatewayV1betaArgs({
    ...
    List<ApigatewayApiConfigGrpcServiceDefinitionApigatewayV1beta>? grpcServices,
  ...
  factory ConfigApigatewayV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ConfigApigatewayV1betaArgs(
      ...
      gatewayConfig: map['gatewayConfig'] == null ? null : ApigatewayGatewayConfig.fromMap((map['gatewayConfig'] as Map).cast<String, dynamic>()),
      gatewayServiceAccount: map['gatewayServiceAccount'] == null ? null : map['gatewayServiceAccount'] as String,
      grpcServices: map['grpcServices'] == null ? null : pulumi.Input.decodeList<ApigatewayApiConfigGrpcServiceDefinitionApigatewayV1beta>(map['grpcServices'], (value) => ApigatewayApiConfigGrpcServiceDefinitionApigatewayV1beta.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      managedServiceConfigs: map['managedServiceConfigs'] == null ? null : pulumi.Input.decodeList<ApigatewayApiConfigFileApigatewayV1beta>(map['managedServiceConfigs'], (value) => ApigatewayApiConfigFileApigatewayV1beta.fromMap((value as Map).cast<String, dynamic>())),
      openapiDocuments: map['openapiDocuments'] == null ? null : pulumi.Input.decodeList<ApigatewayApiConfigOpenApiDocumentApigatewayV1beta>(map['openapiDocuments'], (value) => ApigatewayApiConfigOpenApiDocumentApigatewayV1beta.fromMap((value as Map).cast<String, dynamic>())),
