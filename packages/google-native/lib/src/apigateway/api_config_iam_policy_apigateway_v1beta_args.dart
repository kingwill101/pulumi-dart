...
class ApiConfigIamPolicyApigatewayV1betaArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<ApigatewayAuditConfigApigatewayV1beta>,
    ...
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<ApigatewayBindingApigatewayV1beta>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<ApigatewayBindingApigatewayV1beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory ApiConfigIamPolicyApigatewayV1betaArgs.fromMap(
      Map<String, dynamic> map) {
    return ApiConfigIamPolicyApigatewayV1betaArgs(
      apiId: map['apiId'] as String,
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<ApigatewayAuditConfigApigatewayV1beta>(
              map['auditConfigs'],
              (value) => ApigatewayAuditConfigApigatewayV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<ApigatewayBindingApigatewayV1beta>(
              map['bindings'],
              (value) => ApigatewayBindingApigatewayV1beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
