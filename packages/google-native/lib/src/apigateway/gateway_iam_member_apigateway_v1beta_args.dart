...
/// {@template pulumi_apigateway_v1beta_gateway_iam_member_apigateway_v1beta_args_doc}
/// The set of arguments for GatewayIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigateway_v1beta_gateway_iam_member_apigateway_v1beta_args_doc}
class GatewayIamMemberApigatewayV1betaArgs {
  ...
  /// Creates a new [GatewayIamMemberApigatewayV1betaArgs].
  ...
  GatewayIamMemberApigatewayV1betaArgs({
    Condition? condition,
  ...
  factory GatewayIamMemberApigatewayV1betaArgs.fromMap(Map<String, dynamic> map) {
    return GatewayIamMemberApigatewayV1betaArgs(
