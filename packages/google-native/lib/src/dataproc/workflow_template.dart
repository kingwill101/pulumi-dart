...
class WorkflowTemplate extends pulumi.CustomResource {
  ...
  WorkflowTemplate(
    ...
    this.encryptionConfig = registerOutput<GoogleCloudDataprocV1WorkflowTemplateEncryptionConfigResponse>('encryptionConfig');
    this.jobs = registerOutput<List<OrderedJobResponse>>('jobs');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.parameters = registerOutput<List<TemplateParameterResponse>>('parameters');
    this.placement = registerOutput<WorkflowTemplatePlacementResponse>('placement');
