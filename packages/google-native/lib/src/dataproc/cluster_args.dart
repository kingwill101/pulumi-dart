...
class ClusterArgs {
  ...
  ClusterArgs({
    String? actionOnFailedPrimaryWorkers,
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      actionOnFailedPrimaryWorkers: map['actionOnFailedPrimaryWorkers'] == null ? null : map['actionOnFailedPrimaryWorkers'] as String,
      clusterName: map['clusterName'] as String,
      config: map['config'] == null ? null : ClusterConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      project: map['project'] == null ? null : map['project'] as String,
      region: map['region'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      virtualClusterConfig: map['virtualClusterConfig'] == null ? null : VirtualClusterConfig.fromMap((map['virtualClusterConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
