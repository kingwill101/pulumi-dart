...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    VirtualClusterConfig? virtualClusterConfig,
            ...
            pulumi.Input.asOptionalInput<String>(actionOnFailedPrimaryWorkers),
        ...
        virtualClusterConfig =
            pulumi.Input.asOptionalInput<VirtualClusterConfig>(
                virtualClusterConfig);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (configValue != null) {
      map['config'] = pulumi.Input.mapOptionalInputValue<ClusterConfig,
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      actionOnFailedPrimaryWorkers: map['actionOnFailedPrimaryWorkers'] == null
          ? null
          : map['actionOnFailedPrimaryWorkers'] as String,
