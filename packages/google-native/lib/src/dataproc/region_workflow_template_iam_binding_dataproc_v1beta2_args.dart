...
/// {@template pulumi_dataproc_v1beta2_region_workflow_template_iam_binding_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionWorkflowTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_workflow_template_iam_binding_dataproc_v1beta2_args_doc}
class RegionWorkflowTemplateIamBindingDataprocV1beta2Args {
  ...
  /// Creates a new [RegionWorkflowTemplateIamBindingDataprocV1beta2Args].
  ...
  RegionWorkflowTemplateIamBindingDataprocV1beta2Args({
    Condition? condition,
  ...
  factory RegionWorkflowTemplateIamBindingDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RegionWorkflowTemplateIamBindingDataprocV1beta2Args(
