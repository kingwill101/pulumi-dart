...
class AutoscalingPolicyDataprocV1beta2Args {
  ...
  factory AutoscalingPolicyDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyDataprocV1beta2Args(
      basicAlgorithm: map['basicAlgorithm'] == null ? null : BasicAutoscalingAlgorithmDataprocV1beta2.fromMap((map['basicAlgorithm'] as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      secondaryWorkerConfig: map['secondaryWorkerConfig'] == null ? null : InstanceGroupAutoscalingPolicyConfigDataprocV1beta2.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      workerConfig: InstanceGroupAutoscalingPolicyConfigDataprocV1beta2.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
