...
class GetClusterDataprocV1beta2Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['statusHistory'] = pulumi.Input.encodeList<
  ...
  factory GetClusterDataprocV1beta2Result.fromMap(Map<String, dynamic> map) {
    return GetClusterDataprocV1beta2Result(
      ...
      metrics: ClusterMetricsResponseDataprocV1beta2.fromMap(
          (map['metrics'] as Map).cast<String, dynamic>()),
      project: map['project'] as String,
      status: ClusterStatusResponseDataprocV1beta2.fromMap(
          (map['status'] as Map).cast<String, dynamic>()),
      statusHistory:
          pulumi.Input.decodeList<ClusterStatusResponseDataprocV1beta2>(
              map['statusHistory'],
              (value) => ClusterStatusResponseDataprocV1beta2.fromMap(
