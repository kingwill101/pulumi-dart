...
class OrderedJobDataprocV1beta2 {
  ...
  factory OrderedJobDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return OrderedJobDataprocV1beta2(
      hadoopJob: map['hadoopJob'] == null ? null : HadoopJobDataprocV1beta2.fromMap((map['hadoopJob'] as Map).cast<String, dynamic>()),
      hiveJob: map['hiveJob'] == null ? null : HiveJobDataprocV1beta2.fromMap((map['hiveJob'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      pigJob: map['pigJob'] == null ? null : PigJobDataprocV1beta2.fromMap((map['pigJob'] as Map).cast<String, dynamic>()),
      prerequisiteStepIds: map['prerequisiteStepIds'] == null ? null : (map['prerequisiteStepIds'] as List).cast<String>(),
      prestoJob: map['prestoJob'] == null ? null : PrestoJobDataprocV1beta2.fromMap((map['prestoJob'] as Map).cast<String, dynamic>()),
      pysparkJob: map['pysparkJob'] == null ? null : PySparkJobDataprocV1beta2.fromMap((map['pysparkJob'] as Map).cast<String, dynamic>()),
      scheduling: map['scheduling'] == null ? null : JobSchedulingDataprocV1beta2.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      sparkJob: map['sparkJob'] == null ? null : SparkJobDataprocV1beta2.fromMap((map['sparkJob'] as Map).cast<String, dynamic>()),
      sparkRJob: map['sparkRJob'] == null ? null : SparkRJobDataprocV1beta2.fromMap((map['sparkRJob'] as Map).cast<String, dynamic>()),
      sparkSqlJob: map['sparkSqlJob'] == null ? null : SparkSqlJobDataprocV1beta2.fromMap((map['sparkSqlJob'] as Map).cast<String, dynamic>()),
