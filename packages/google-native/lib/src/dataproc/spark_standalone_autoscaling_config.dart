...
class SparkStandaloneAutoscalingConfig {
  ...
  /// Creates a new [SparkStandaloneAutoscalingConfig].
  ...
  factory SparkStandaloneAutoscalingConfig.fromMap(Map<String, dynamic> map) {
    return SparkStandaloneAutoscalingConfig(
      ...
      removeOnlyIdleWorkers: map['removeOnlyIdleWorkers'] == null ? null : map['removeOnlyIdleWorkers'] as bool,
      scaleDownFactor: map['scaleDownFactor'] as double,
      scaleDownMinWorkerFraction: map['scaleDownMinWorkerFraction'] == null ? null : map['scaleDownMinWorkerFraction'] as double,
      scaleUpFactor: map['scaleUpFactor'] as double,
      scaleUpMinWorkerFraction: map['scaleUpMinWorkerFraction'] == null ? null : map['scaleUpMinWorkerFraction'] as double,
    );
  }
}
