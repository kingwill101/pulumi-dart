...
/// {@template pulumi_dataproc_v1beta2_region_workflow_template_iam_policy_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionWorkflowTemplateIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_workflow_template_iam_policy_dataproc_v1beta2_args_doc}
class RegionWorkflowTemplateIamPolicyDataprocV1beta2Args {
  ...
  /// Creates a new [RegionWorkflowTemplateIamPolicyDataprocV1beta2Args].
  ...
  RegionWorkflowTemplateIamPolicyDataprocV1beta2Args({
  ...
  factory RegionWorkflowTemplateIamPolicyDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RegionWorkflowTemplateIamPolicyDataprocV1beta2Args(
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<BindingDataprocV1beta2>(map['bindings'], (value) => BindingDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>())),
