...
class StartupConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final requiredRegistrationFractionValue = requiredRegistrationFraction;
    if (requiredRegistrationFractionValue != null) {
      map['requiredRegistrationFraction'] = requiredRegistrationFractionValue;
    }
    return map;
  }
  ...
  factory StartupConfig.fromMap(Map<String, dynamic> map) {
    return StartupConfig(
      requiredRegistrationFraction: map['requiredRegistrationFraction'] == null
          ? null
