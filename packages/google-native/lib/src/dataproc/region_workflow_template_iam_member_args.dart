...
/// {@template pulumi_dataproc_v1_region_workflow_template_iam_member_args_doc}
/// The set of arguments for RegionWorkflowTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_workflow_template_iam_member_args_doc}
class RegionWorkflowTemplateIamMemberArgs {
  ...
  /// Creates a new [RegionWorkflowTemplateIamMemberArgs].
  ...
  RegionWorkflowTemplateIamMemberArgs({
    Condition? condition,
  ...
  factory RegionWorkflowTemplateIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionWorkflowTemplateIamMemberArgs(
