...
class AutoscalingPolicyDataprocV1beta2 extends pulumi.CustomResource {
  ...
  AutoscalingPolicyDataprocV1beta2(
    ...
    this.basicAlgorithm = registerOutput<BasicAutoscalingAlgorithmResponseDataprocV1beta2>('basicAlgorithm');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.secondaryWorkerConfig = registerOutput<InstanceGroupAutoscalingPolicyConfigResponseDataprocV1beta2>('secondaryWorkerConfig');
    this.workerConfig = registerOutput<InstanceGroupAutoscalingPolicyConfigResponseDataprocV1beta2>('workerConfig');
  }
}
