...
class GetAutoscalingPolicyResult {
  ...
  factory GetAutoscalingPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetAutoscalingPolicyResult(
      basicAlgorithm: BasicAutoscalingAlgorithmResponse.fromMap(
          (map['basicAlgorithm'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      secondaryWorkerConfig:
          InstanceGroupAutoscalingPolicyConfigResponse.fromMap(
              (map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      workerConfig: InstanceGroupAutoscalingPolicyConfigResponse.fromMap(
