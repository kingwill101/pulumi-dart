...
class GceClusterConfig {
  ...
  factory GceClusterConfig.fromMap(Map<String, dynamic> map) {
    return GceClusterConfig(
      ...
      nodeGroupAffinity: map['nodeGroupAffinity'] == null ? null : NodeGroupAffinity.fromMap((map['nodeGroupAffinity'] as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : GceClusterConfigPrivateIpv6GoogleAccess.fromValue(map['privateIpv6GoogleAccess'] as String),
