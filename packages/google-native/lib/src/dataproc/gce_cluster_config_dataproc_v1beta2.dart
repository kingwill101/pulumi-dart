...
class GceClusterConfigDataprocV1beta2 {
  ...
  final NodeGroupAffinityDataprocV1beta2? nodeGroupAffinity;
  /// Optional. The type of IPv6 access for a cluster.
  final GceClusterConfigPrivateIpv6GoogleAccessDataprocV1beta2? privateIpv6GoogleAccess;
  /// Optional. Reservation Affinity for consuming Zonal reservation.
  final ReservationAffinityDataprocV1beta2? reservationAffinity;
  ...
  final ShieldedInstanceConfigDataprocV1beta2? shieldedInstanceConfig;
  ...
  factory GceClusterConfigDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return GceClusterConfigDataprocV1beta2(
      ...
      nodeGroupAffinity: map['nodeGroupAffinity'] == null ? null : NodeGroupAffinityDataprocV1beta2.fromMap((map['nodeGroupAffinity'] as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : GceClusterConfigPrivateIpv6GoogleAccessDataprocV1beta2.fromValue(map['privateIpv6GoogleAccess'] as String),
      reservationAffinity: map['reservationAffinity'] == null ? null : ReservationAffinityDataprocV1beta2.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : ShieldedInstanceConfigDataprocV1beta2.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
