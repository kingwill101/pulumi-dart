...
class GceClusterConfigDataprocV1beta2 {
  ...
  final GceClusterConfigPrivateIpv6GoogleAccessDataprocV1beta2?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeGroupAffinity': ?nodeGroupAffinity == null
          ? null
          : nodeGroupAffinity!.toMap(),
  ...
  factory GceClusterConfigDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return GceClusterConfigDataprocV1beta2(
      internalIpOnly: map['internalIpOnly'] == null
          ? null
          : map['internalIpOnly'] as bool,
      metadata: map['metadata'] == null
          ? null
          : (map['metadata'] as Map).cast<String, String>(),
      networkUri: map['networkUri'] == null
          ? null
          : map['networkUri'] as String,
      nodeGroupAffinity: map['nodeGroupAffinity'] == null
          ? null
          : NodeGroupAffinityDataprocV1beta2.fromMap(
              (map['nodeGroupAffinity'] as Map).cast<String, dynamic>(),
            ),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null
          ? null
          : GceClusterConfigPrivateIpv6GoogleAccessDataprocV1beta2.fromValue(
              map['privateIpv6GoogleAccess'] as String,
            ),
      reservationAffinity: map['reservationAffinity'] == null
          ? null
          : ReservationAffinityDataprocV1beta2.fromMap(
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null
          ? null
          : ShieldedInstanceConfigDataprocV1beta2.fromMap(
              (map['shieldedInstanceConfig'] as Map).cast<String, dynamic>(),
            ),
      subnetworkUri: map['subnetworkUri'] == null
          ? null
          : map['subnetworkUri'] as String,
