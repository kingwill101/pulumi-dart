...
class BatchArgs {
  ...
  factory BatchArgs.fromMap(Map<String, dynamic> map) {
    return BatchArgs(
      ...
      pysparkBatch: map['pysparkBatch'] == null ? null : PySparkBatch.fromMap((map['pysparkBatch'] as Map).cast<String, dynamic>()),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      runtimeConfig: map['runtimeConfig'] == null ? null : RuntimeConfig.fromMap((map['runtimeConfig'] as Map).cast<String, dynamic>()),
      sparkBatch: map['sparkBatch'] == null ? null : SparkBatch.fromMap((map['sparkBatch'] as Map).cast<String, dynamic>()),
      sparkRBatch: map['sparkRBatch'] == null ? null : SparkRBatch.fromMap((map['sparkRBatch'] as Map).cast<String, dynamic>()),
      sparkSqlBatch: map['sparkSqlBatch'] == null ? null : SparkSqlBatch.fromMap((map['sparkSqlBatch'] as Map).cast<String, dynamic>()),
    );
  }
}
