...
class SoftwareConfigDataprocV1beta2 {
  ...
  final List<SoftwareConfigOptionalComponentsItemDataprocV1beta2>? optionalComponents;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optionalComponents': ?optionalComponents == null ? null : pulumi.Input.encodeList<SoftwareConfigOptionalComponentsItemDataprocV1beta2, String>(optionalComponents!, (value) => value.value),
  ...
  factory SoftwareConfigDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return SoftwareConfigDataprocV1beta2(
      ...
      optionalComponents: map['optionalComponents'] == null ? null : pulumi.Input.decodeList<SoftwareConfigOptionalComponentsItemDataprocV1beta2>(map['optionalComponents'], (value) => SoftwareConfigOptionalComponentsItemDataprocV1beta2.fromValue(value as String)),
