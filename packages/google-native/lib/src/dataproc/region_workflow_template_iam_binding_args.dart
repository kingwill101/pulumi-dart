...
/// {@template pulumi_dataproc_v1_region_workflow_template_iam_binding_args_doc}
/// The set of arguments for RegionWorkflowTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_workflow_template_iam_binding_args_doc}
class RegionWorkflowTemplateIamBindingArgs {
  ...
  /// Creates a new [RegionWorkflowTemplateIamBindingArgs].
  ...
  factory RegionWorkflowTemplateIamBindingArgs.fromMap(Map<String, dynamic> map) {
