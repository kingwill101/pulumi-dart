...
class GkeNodePoolTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'roles': pulumi.Input.encodeList<GkeNodePoolTargetRolesItem, String>(roles, (value) => value.value),
    };
  }
  ...
  factory GkeNodePoolTarget.fromMap(Map<String, dynamic> map) {
    return GkeNodePoolTarget(
      ...
      nodePoolConfig: map['nodePoolConfig'] == null ? null : GkeNodePoolConfig.fromMap((map['nodePoolConfig'] as Map).cast<String, dynamic>()),
      roles: pulumi.Input.decodeList<GkeNodePoolTargetRolesItem>(map['roles'], (value) => GkeNodePoolTargetRolesItem.fromValue(value as String)),
    );
  }
}
