...
/// {@template pulumi_dataproc_v1_region_autoscaling_policy_iam_member_args_doc}
/// The set of arguments for RegionAutoscalingPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_autoscaling_policy_iam_member_args_doc}
class RegionAutoscalingPolicyIamMemberArgs {
  ...
  /// Creates a new [RegionAutoscalingPolicyIamMemberArgs].
  ...
  RegionAutoscalingPolicyIamMemberArgs({
    Condition? condition,
  ...
  factory RegionAutoscalingPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalingPolicyIamMemberArgs(
