...
class WorkflowTemplateDataprocV1beta2Args {
  ...
  WorkflowTemplateDataprocV1beta2Args({
    ...
    int? version,
       ...
       placement = pulumi
           .Input.asInput<WorkflowTemplatePlacementDataprocV1beta2>(placement),
  ...
  factory WorkflowTemplateDataprocV1beta2Args.fromMap(
    ...
    return WorkflowTemplateDataprocV1beta2Args(
      ...
      id: map['id'] as String,
      jobs: pulumi.Input.decodeList<OrderedJobDataprocV1beta2>(
        map['jobs'],
      ...
      placement: WorkflowTemplatePlacementDataprocV1beta2.fromMap(
