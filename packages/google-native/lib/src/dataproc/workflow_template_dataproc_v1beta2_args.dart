...
class WorkflowTemplateDataprocV1beta2Args {
  ...
  WorkflowTemplateDataprocV1beta2Args({
    String? dagTimeout,
    required String id,
    required List<OrderedJobDataprocV1beta2> jobs,
    Map<String, String>? labels,
    String? location,
    List<TemplateParameterDataprocV1beta2>? parameters,
    required WorkflowTemplatePlacementDataprocV1beta2 placement,
    String? project,
    int? version,
  }) :
  ...
  factory WorkflowTemplateDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateDataprocV1beta2Args(
      ...
      id: map['id'] as String,
      jobs: pulumi.Input.decodeList<OrderedJobDataprocV1beta2>(map['jobs'], (value) => OrderedJobDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<TemplateParameterDataprocV1beta2>(map['parameters'], (value) => TemplateParameterDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      placement: WorkflowTemplatePlacementDataprocV1beta2.fromMap((map['placement'] as Map).cast<String, dynamic>()),
