...
class GceClusterConfigResponseDataprocV1beta2 {
  ...
  factory GceClusterConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return GceClusterConfigResponseDataprocV1beta2(
      ...
      nodeGroupAffinity: NodeGroupAffinityResponseDataprocV1beta2.fromMap((map['nodeGroupAffinity'] as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] as String,
      reservationAffinity: ReservationAffinityResponseDataprocV1beta2.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      serviceAccountScopes: (map['serviceAccountScopes'] as List).cast<String>(),
      shieldedInstanceConfig: ShieldedInstanceConfigResponseDataprocV1beta2.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
