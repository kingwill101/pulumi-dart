...
class NodeGroupArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'regionId': regionId,
      'requestId': ?requestId,
      'roles': pulumi.Input.mapInputValue<List<NodeGroupRolesItem>, List<String>>(roles, (value) => pulumi.Input.encodeList<NodeGroupRolesItem, String>(value, (value) => value.value)),
    };
  }
  ...
  factory NodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs(
      ...
      nodeGroupConfig: map['nodeGroupConfig'] == null ? null : InstanceGroupConfig.fromMap((map['nodeGroupConfig'] as Map).cast<String, dynamic>()),
      nodeGroupId: map['nodeGroupId'] == null ? null : map['nodeGroupId'] as String,
      parentOperationId: map['parentOperationId'] == null ? null : map['parentOperationId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      regionId: map['regionId'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      roles: pulumi.Input.decodeList<NodeGroupRolesItem>(map['roles'], (value) => NodeGroupRolesItem.fromValue(value as String)),
    );
  }
}
