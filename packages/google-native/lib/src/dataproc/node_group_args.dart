...
class NodeGroupArgs {
  ...
  NodeGroupArgs({
    ...
    required List<NodeGroupRolesItem> roles,
        ...
        nodeGroupConfig =
            pulumi.Input.asOptionalInput<InstanceGroupConfig>(nodeGroupConfig),
        nodeGroupId = pulumi.Input.asOptionalInput<String>(nodeGroupId),
        parentOperationId =
            pulumi.Input.asOptionalInput<String>(parentOperationId),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (nodeGroupConfigValue != null) {
      map['nodeGroupConfig'] = pulumi.Input.mapOptionalInputValue<
          InstanceGroupConfig,
