...
class SessionArgs {
  ...
  SessionArgs({
    ...
    String? user,
  }) : environmentConfig = pulumi.Input.asOptionalInput<EnvironmentConfig>(
         environmentConfig,
       ),
       jupyterSession = pulumi.Input.asOptionalInput<JupyterConfig>(
         jupyterSession,
       ),
       ...
       runtimeConfig = pulumi.Input.asOptionalInput<RuntimeConfig>(
         runtimeConfig,
       ),
  ...
  factory SessionArgs.fromMap(Map<String, dynamic> map) {
    return SessionArgs(
      ...
      sessionTemplate: map['sessionTemplate'] == null
          ? null
          : map['sessionTemplate'] as String,
