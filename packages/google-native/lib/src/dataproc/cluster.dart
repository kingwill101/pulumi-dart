...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.actionOnFailedPrimaryWorkers = registerOutput<String?>(
    ...
    this.statusHistory = registerOutput<List<ClusterStatusResponse>>(
      'statusHistory',
    );
    this.virtualClusterConfig = registerOutput<VirtualClusterConfigResponse>(
