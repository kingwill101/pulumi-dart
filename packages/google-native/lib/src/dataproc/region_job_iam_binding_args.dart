...
/// {@template pulumi_dataproc_v1_region_job_iam_binding_args_doc}
/// The set of arguments for RegionJobIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_job_iam_binding_args_doc}
class RegionJobIamBindingArgs {
  ...
  /// Creates a new [RegionJobIamBindingArgs].
  ...
  factory RegionJobIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegionJobIamBindingArgs(
