...
class Job extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DriverSchedulingConfigResponse>
  ...
  Job(String name, {JobArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.statusHistory = registerOutput<List<JobStatusResponse>>(
      'statusHistory',
    );
    this.trinoJob = registerOutput<TrinoJobResponse>('trinoJob');
    this.yarnApplications = registerOutput<List<YarnApplicationResponse>>(
      'yarnApplications',
    );
  }
}
