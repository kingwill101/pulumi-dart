...
/// {@template pulumi_dataproc_v1beta2_region_job_iam_member_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionJobIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_job_iam_member_dataproc_v1beta2_args_doc}
class RegionJobIamMemberDataprocV1beta2Args {
  ...
  /// Creates a new [RegionJobIamMemberDataprocV1beta2Args].
  ...
  RegionJobIamMemberDataprocV1beta2Args({
    Condition? condition,
  ...
  factory RegionJobIamMemberDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RegionJobIamMemberDataprocV1beta2Args(
