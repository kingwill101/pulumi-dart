...
/// {@template pulumi_dataproc_v1_region_autoscaling_policy_iam_binding_args_doc}
/// The set of arguments for RegionAutoscalingPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_autoscaling_policy_iam_binding_args_doc}
class RegionAutoscalingPolicyIamBindingArgs {
  ...
  /// Creates a new [RegionAutoscalingPolicyIamBindingArgs].
  ...
  RegionAutoscalingPolicyIamBindingArgs({
    Condition? condition,
  ...
  factory RegionAutoscalingPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalingPolicyIamBindingArgs(
