...
class AutoscalingPolicyArgs {
  ...
  factory AutoscalingPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyArgs(
      basicAlgorithm: map['basicAlgorithm'] == null ? null : BasicAutoscalingAlgorithm.fromMap((map['basicAlgorithm'] as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      secondaryWorkerConfig: map['secondaryWorkerConfig'] == null ? null : InstanceGroupAutoscalingPolicyConfig.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      workerConfig: InstanceGroupAutoscalingPolicyConfig.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
