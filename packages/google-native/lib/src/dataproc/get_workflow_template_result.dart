...
class GetWorkflowTemplateResult {
  ...
  final GoogleCloudDataprocV1WorkflowTemplateEncryptionConfigResponse
  encryptionConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobs': pulumi.Input.encodeList<OrderedJobResponse, Map<String, dynamic>>(
        jobs,
        (value) => value.toMap(),
      ),
      'labels': labels,
  ...
  factory GetWorkflowTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetWorkflowTemplateResult(
      ...
      jobs: pulumi.Input.decodeList<OrderedJobResponse>(
        map['jobs'],
        (value) =>
            OrderedJobResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      placement: WorkflowTemplatePlacementResponse.fromMap(
