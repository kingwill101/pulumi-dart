...
/// {@template pulumi_dataproc_v1_region_job_iam_member_args_doc}
/// The set of arguments for RegionJobIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_job_iam_member_args_doc}
class RegionJobIamMemberArgs {
  ...
  /// Creates a new [RegionJobIamMemberArgs].
  ...
  factory RegionJobIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionJobIamMemberArgs(
