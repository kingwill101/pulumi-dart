...
class JobDataprocV1beta2Args {
  ...
  factory JobDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return JobDataprocV1beta2Args(
      ...
      placement: JobPlacementDataprocV1beta2.fromMap((map['placement'] as Map).cast<String, dynamic>()),
      ...
      reference: map['reference'] == null ? null : JobReferenceDataprocV1beta2.fromMap((map['reference'] as Map).cast<String, dynamic>()),
