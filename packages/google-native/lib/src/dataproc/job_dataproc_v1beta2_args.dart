...
class JobDataprocV1beta2Args {
  ...
  JobDataprocV1beta2Args({
    ...
    SparkSqlJobDataprocV1beta2? sparkSqlJob,
            ...
            pulumi.Input.asOptionalInput<HadoopJobDataprocV1beta2>(hadoopJob),
        ...
        placement =
            pulumi.Input.asInput<JobPlacementDataprocV1beta2>(placement),
        prestoJob =
            pulumi.Input.asOptionalInput<PrestoJobDataprocV1beta2>(prestoJob),
        project = pulumi.Input.asOptionalInput<String>(project),
        pysparkJob =
            pulumi.Input.asOptionalInput<PySparkJobDataprocV1beta2>(pysparkJob),
        ...
        scheduling = pulumi.Input.asOptionalInput<JobSchedulingDataprocV1beta2>(
            scheduling),
        sparkJob =
            pulumi.Input.asOptionalInput<SparkJobDataprocV1beta2>(sparkJob),
        sparkRJob =
            pulumi.Input.asOptionalInput<SparkRJobDataprocV1beta2>(sparkRJob),
