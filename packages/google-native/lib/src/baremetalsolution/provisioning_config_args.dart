...
class ProvisioningConfigArgs {
  ...
  ProvisioningConfigArgs({
    ...
    bool? vpcScEnabled,
        ...
        handoverServiceAccount =
            pulumi.Input.asOptionalInput<String>(handoverServiceAccount),
        instances =
            pulumi.Input.asOptionalInput<List<InstanceConfig>>(instances),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (networksValue != null) {
      map['networks'] = pulumi.Input.mapOptionalInputValue<List<NetworkConfig>,
  ...
  factory ProvisioningConfigArgs.fromMap(Map<String, dynamic> map) {
    return ProvisioningConfigArgs(
      ...
      handoverServiceAccount: map['handoverServiceAccount'] == null
          ? null
          : map['handoverServiceAccount'] as String,
      instances: map['instances'] == null
          ? null
          : pulumi.Input.decodeList<InstanceConfig>(
              map['instances'],
              (value) => InstanceConfig.fromMap(
      ...
      volumes: map['volumes'] == null
          ? null
          : pulumi.Input.decodeList<VolumeConfig>(
              map['volumes'],
              (value) =>
                  VolumeConfig.fromMap((value as Map).cast<String, dynamic>())),
      vpcScEnabled:
          map['vpcScEnabled'] == null ? null : map['vpcScEnabled'] as bool,
    );
  }
}
