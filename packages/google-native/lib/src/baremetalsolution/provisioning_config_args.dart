...
class ProvisioningConfigArgs {
  ...
  ProvisioningConfigArgs({
    ...
    bool? vpcScEnabled,
       ...
       handoverServiceAccount = pulumi.Input.asOptionalInput<String>(
         handoverServiceAccount,
       ),
       instances = pulumi.Input.asOptionalInput<List<InstanceConfig>>(
         instances,
       ),
  ...
  factory ProvisioningConfigArgs.fromMap(Map<String, dynamic> map) {
    return ProvisioningConfigArgs(
      ...
      vpcScEnabled: map['vpcScEnabled'] == null
          ? null
          : map['vpcScEnabled'] as bool,
    );
  }
}
