...
class NfsShareArgs {
  ...
  NfsShareArgs({
    ...
    NfsShareStorageType? storageType,
       ...
       requestedSizeGib = pulumi.Input.asOptionalInput<String>(
         requestedSizeGib,
       ),
       storageType = pulumi.Input.asOptionalInput<NfsShareStorageType>(
         storageType,
       );
    ...
    return NfsShareArgs(
      allowedClients: map['allowedClients'] == null
          ...
          : pulumi.Input.decodeList<AllowedClient>(
              map['allowedClients'],
              (value) =>
                  AllowedClient.fromMap((value as Map).cast<String, dynamic>()),
            ),
