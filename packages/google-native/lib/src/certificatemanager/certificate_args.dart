...
class CertificateArgs {
  ...
  factory CertificateArgs.fromMap(Map<String, dynamic> map) {
    return CertificateArgs(
      ...
      managed: map['managed'] == null ? null : ManagedCertificate.fromMap((map['managed'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      scope: map['scope'] == null ? null : CertificateScope.fromValue(map['scope'] as String),
      selfManaged: map['selfManaged'] == null ? null : SelfManagedCertificate.fromMap((map['selfManaged'] as Map).cast<String, dynamic>()),
    );
  }
}
