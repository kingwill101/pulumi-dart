...
class TrustConfigArgs {
  ...
  TrustConfigArgs({
    ...
    List<TrustStore>? trustStores,
      ...
      trustStores = pulumi.Input.asOptionalInput<List<TrustStore>>(trustStores);
  ...
  factory TrustConfigArgs.fromMap(Map<String, dynamic> map) {
    return TrustConfigArgs(
      ...
      trustStores: map['trustStores'] == null ? null : pulumi.Input.decodeList<TrustStore>(map['trustStores'], (value) => TrustStore.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
