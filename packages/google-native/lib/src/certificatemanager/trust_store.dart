...
class TrustStore {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'intermediateCas': ?intermediateCas == null
          ? null
          : pulumi.Input.encodeList<IntermediateCA, Map<String, dynamic>>(
              intermediateCas!,
              (value) => value.toMap(),
            ),
      'trustAnchors': ?trustAnchors == null
          ? null
          : pulumi.Input.encodeList<TrustAnchor, Map<String, dynamic>>(
              trustAnchors!,
              (value) => value.toMap(),
            ),
    };
  ...
  factory TrustStore.fromMap(Map<String, dynamic> map) {
    return TrustStore(
      intermediateCas: map['intermediateCas'] == null
          ? null
          : pulumi.Input.decodeList<IntermediateCA>(
              map['intermediateCas'],
      ...
      trustAnchors: map['trustAnchors'] == null
          ? null
          : pulumi.Input.decodeList<TrustAnchor>(
              map['trustAnchors'],
              (value) =>
