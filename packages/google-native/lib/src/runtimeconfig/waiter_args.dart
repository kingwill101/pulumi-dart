...
class WaiterArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (failureValue != null) {
      map['failure'] = pulumi.Input.mapOptionalInputValue<EndCondition,
          Map<String, dynamic>>(failureValue, (value) => value.toMap());
    }
    ...
    if (successValue != null) {
      map['success'] = pulumi.Input.mapOptionalInputValue<EndCondition,
          Map<String, dynamic>>(successValue, (value) => value.toMap());
    }
  ...
  factory WaiterArgs.fromMap(Map<String, dynamic> map) {
    return WaiterArgs(
      ...
      failure: map['failure'] == null
          ? null
          : EndCondition.fromMap(
              (map['failure'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      success: map['success'] == null
          ? null
          : EndCondition.fromMap(
              (map['success'] as Map).cast<String, dynamic>()),
