...
class PushConfig {
  ...
  factory PushConfig.fromMap(Map<String, dynamic> map) {
    return PushConfig(
      ...
      noWrapper: map['noWrapper'] == null ? null : NoWrapper.fromMap((map['noWrapper'] as Map).cast<String, dynamic>()),
      oidcToken: map['oidcToken'] == null ? null : OidcToken.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
      pubsubWrapper: map['pubsubWrapper'] == null ? null : (map['pubsubWrapper'] as Map).cast<String, dynamic>(),
