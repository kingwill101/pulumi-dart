...
class GetTopicResult {
  ...
  factory GetTopicResult.fromMap(Map<String, dynamic> map) {
    return GetTopicResult(
      ...
      messageStoragePolicy: MessageStoragePolicyResponse.fromMap((map['messageStoragePolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      schemaSettings: SchemaSettingsResponse.fromMap((map['schemaSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
