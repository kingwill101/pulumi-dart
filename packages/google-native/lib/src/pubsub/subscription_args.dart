...
class SubscriptionArgs {
  ...
  SubscriptionArgs({
    ...
    required String topic,
        ...
        bigqueryConfig =
            pulumi.Input.asOptionalInput<BigQueryConfig>(bigqueryConfig),
        cloudStorageConfig = pulumi.Input.asOptionalInput<CloudStorageConfig>(
            cloudStorageConfig),
        deadLetterPolicy =
            pulumi.Input.asOptionalInput<DeadLetterPolicy>(deadLetterPolicy),
        ...
        expirationPolicy =
            pulumi.Input.asOptionalInput<ExpirationPolicy>(expirationPolicy),
