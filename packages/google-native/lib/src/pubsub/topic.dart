...
class Topic extends pulumi.CustomResource {
  ...
  Topic(
    ...
    this.messageStoragePolicy = registerOutput<MessageStoragePolicyResponse>('messageStoragePolicy');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.schemaSettings = registerOutput<SchemaSettingsResponse>('schemaSettings');
