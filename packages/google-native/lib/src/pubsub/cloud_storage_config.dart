...
class CloudStorageConfig {
  ...
  factory CloudStorageConfig.fromMap(Map<String, dynamic> map) {
    return CloudStorageConfig(
      avroConfig: map['avroConfig'] == null ? null : AvroConfig.fromMap((map['avroConfig'] as Map).cast<String, dynamic>()),
      ...
      textConfig: map['textConfig'] == null ? null : (map['textConfig'] as Map).cast<String, dynamic>(),
    );
  }
}
