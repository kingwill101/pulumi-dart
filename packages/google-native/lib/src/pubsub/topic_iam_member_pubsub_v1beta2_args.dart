...
/// {@template pulumi_pubsub_v1beta2_topic_iam_member_pubsub_v1beta2_args_doc}
/// The set of arguments for TopicIamMember.
/// {@endtemplate}
/// {@macro pulumi_pubsub_v1beta2_topic_iam_member_pubsub_v1beta2_args_doc}
class TopicIamMemberPubsubV1beta2Args {
  ...
  /// Creates a new [TopicIamMemberPubsubV1beta2Args].
  ...
  TopicIamMemberPubsubV1beta2Args({
    Condition? condition,
  ...
  factory TopicIamMemberPubsubV1beta2Args.fromMap(Map<String, dynamic> map) {
    return TopicIamMemberPubsubV1beta2Args(
