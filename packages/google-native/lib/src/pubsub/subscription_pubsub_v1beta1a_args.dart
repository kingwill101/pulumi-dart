...
class SubscriptionPubsubV1beta1aArgs {
  ...
  factory SubscriptionPubsubV1beta1aArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionPubsubV1beta1aArgs(
      ackDeadlineSeconds: map['ackDeadlineSeconds'] == null ? null : map['ackDeadlineSeconds'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      pushConfig: map['pushConfig'] == null ? null : PushConfigPubsubV1beta1a.fromMap((map['pushConfig'] as Map).cast<String, dynamic>()),
