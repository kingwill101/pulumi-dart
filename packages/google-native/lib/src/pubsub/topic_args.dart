...
class TopicArgs {
  ...
  TopicArgs({
    ...
    required String topicId,
       ...
       messageRetentionDuration = pulumi.Input.asOptionalInput<String>(
         messageRetentionDuration,
       ),
       messageStoragePolicy = pulumi
           .Input.asOptionalInput<MessageStoragePolicy>(messageStoragePolicy),
       name = pulumi.Input.asOptionalInput<String>(name),
       project = pulumi.Input.asOptionalInput<String>(project),
       satisfiesPzs = pulumi.Input.asOptionalInput<bool>(satisfiesPzs),
       schemaSettings = pulumi.Input.asOptionalInput<SchemaSettings>(
         schemaSettings,
       ),
