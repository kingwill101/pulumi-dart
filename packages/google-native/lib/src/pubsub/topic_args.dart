...
class TopicArgs {
  ...
  TopicArgs({
    ...
    required String topicId,
        ...
        messageRetentionDuration =
            pulumi.Input.asOptionalInput<String>(messageRetentionDuration),
        messageStoragePolicy =
            pulumi.Input.asOptionalInput<MessageStoragePolicy>(
                messageStoragePolicy),
        name = pulumi.Input.asOptionalInput<String>(name),
        project = pulumi.Input.asOptionalInput<String>(project),
        satisfiesPzs = pulumi.Input.asOptionalInput<bool>(satisfiesPzs),
        schemaSettings =
            pulumi.Input.asOptionalInput<SchemaSettings>(schemaSettings),
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ...
      messageRetentionDuration: map['messageRetentionDuration'] == null
          ? null
          : map['messageRetentionDuration'] as String,
      messageStoragePolicy: map['messageStoragePolicy'] == null
          ? null
          : MessageStoragePolicy.fromMap(
              (map['messageStoragePolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      satisfiesPzs:
          map['satisfiesPzs'] == null ? null : map['satisfiesPzs'] as bool,
      schemaSettings: map['schemaSettings'] == null
          ? null
          : SchemaSettings.fromMap(
