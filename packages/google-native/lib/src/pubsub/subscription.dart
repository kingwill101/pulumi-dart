...
class Subscription extends pulumi.CustomResource {
  ...
  Subscription(
    ...
    this.bigqueryConfig = registerOutput<BigQueryConfigResponse>(
      'bigqueryConfig',
    );
    this.cloudStorageConfig = registerOutput<CloudStorageConfigResponse>(
      'cloudStorageConfig',
    );
    this.deadLetterPolicy = registerOutput<DeadLetterPolicyResponse>(
      'deadLetterPolicy',
    );
    this.detached = registerOutput<bool>('detached');
    this.enableExactlyOnceDelivery = registerOutput<bool>(
      'enableExactlyOnceDelivery',
    );
    this.enableMessageOrdering = registerOutput<bool>('enableMessageOrdering');
    this.expirationPolicy = registerOutput<ExpirationPolicyResponse>(
      'expirationPolicy',
    );
    ...
    this.topicMessageRetentionDuration = registerOutput<String>(
