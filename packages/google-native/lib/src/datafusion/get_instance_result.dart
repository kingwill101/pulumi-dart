...
class GetInstanceResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['availableVersion'] =
        pulumi.Input.encodeList<VersionResponse, Map<String, dynamic>>(
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      ...
      availableVersion: pulumi.Input.decodeList<VersionResponse>(
          map['availableVersion'],
          (value) =>
              VersionResponse.fromMap((value as Map).cast<String, dynamic>())),
