...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? zone,
            ...
            pulumi.Input.asOptionalInput<CryptoKeyConfig>(cryptoKeyConfig),
        dataprocServiceAccount =
            pulumi.Input.asOptionalInput<String>(dataprocServiceAccount),
        ...
        enableStackdriverMonitoring =
            pulumi.Input.asOptionalInput<bool>(enableStackdriverMonitoring),
        enableZoneSeparation =
            pulumi.Input.asOptionalInput<bool>(enableZoneSeparation),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['type'] = pulumi.Input.mapInputValue<InstanceType, String>(
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      enableZoneSeparation: map['enableZoneSeparation'] == null
          ? null
          : map['enableZoneSeparation'] as bool,
      eventPublishConfig: map['eventPublishConfig'] == null
          ? null
          : EventPublishConfig.fromMap(
      ...
      patchRevision:
          map['patchRevision'] == null ? null : map['patchRevision'] as String,
      privateInstance: map['privateInstance'] == null
          ? null
          : map['privateInstance'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      type: InstanceType.fromValue(map['type'] as String),
