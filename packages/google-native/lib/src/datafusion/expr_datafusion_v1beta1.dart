...
class ExprDatafusionV1beta1 {
  ...
  /// Creates a new [ExprDatafusionV1beta1].
  ...
  factory ExprDatafusionV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprDatafusionV1beta1(
      description:
