...
class PrivateServiceConnectConfigResponse {
  ...
  factory PrivateServiceConnectConfigResponse.fromMap(Map<String, dynamic> map) {
    return PrivateServiceConnectConfigResponse(
      effectiveUnreachableCidrBlock: map['effectiveUnreachableCidrBlock'] as String,
      networkAttachment: map['networkAttachment'] as String,
      unreachableCidrBlock: map['unreachableCidrBlock'] as String,
    );
  }
}
