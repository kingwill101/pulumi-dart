...
class InstanceDatafusionV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<AcceleratorResponseDatafusionV1beta1>> accelerators;
  /// Endpoint on which the REST APIs is accessible.
  late final pulumi.Output<String> apiEndpoint;
  /// Available versions that the instance can be upgraded to using UpdateInstanceRequest.
  late final pulumi.Output<List<VersionResponseDatafusionV1beta1>> availableVersion;
  ...
  InstanceDatafusionV1beta1(
    ...
    this.accelerators = registerOutput<List<AcceleratorResponseDatafusionV1beta1>>('accelerators');
    this.apiEndpoint = registerOutput<String>('apiEndpoint');
    this.availableVersion = registerOutput<List<VersionResponseDatafusionV1beta1>>('availableVersion');
    this.createTime = registerOutput<String>('createTime');
    this.cryptoKeyConfig = registerOutput<CryptoKeyConfigResponseDatafusionV1beta1>('cryptoKeyConfig');
    ...
    this.eventPublishConfig = registerOutput<EventPublishConfigResponseDatafusionV1beta1>('eventPublishConfig');
    this.gcsBucket = registerOutput<String>('gcsBucket');
    this.instanceId = registerOutput<String>('instanceId');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<NetworkConfigResponseDatafusionV1beta1>('networkConfig');
    ...
    this.workforceIdentityServiceEndpoint = registerOutput<String>('workforceIdentityServiceEndpoint');
