...
class InstanceDatafusionV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<AcceleratorResponseDatafusionV1beta1>>
  accelerators;
  ...
  late final pulumi.Output<List<VersionResponseDatafusionV1beta1>>
  availableVersion;
  ...
  late final pulumi.Output<CryptoKeyConfigResponseDatafusionV1beta1>
  cryptoKeyConfig;
  ...
  late final pulumi.Output<EventPublishConfigResponseDatafusionV1beta1>
  eventPublishConfig;
  ...
  late final pulumi.Output<NetworkConfigResponseDatafusionV1beta1>
  networkConfig;
  ...
  InstanceDatafusionV1beta1(
    ...
    this.accelerators =
        registerOutput<List<AcceleratorResponseDatafusionV1beta1>>(
          'accelerators',
        );
    this.apiEndpoint = registerOutput<String>('apiEndpoint');
    this.availableVersion =
        registerOutput<List<VersionResponseDatafusionV1beta1>>(
          'availableVersion',
        );
    this.createTime = registerOutput<String>('createTime');
    this.cryptoKeyConfig =
        registerOutput<CryptoKeyConfigResponseDatafusionV1beta1>(
          'cryptoKeyConfig',
        );
    ...
    this.networkConfig = registerOutput<NetworkConfigResponseDatafusionV1beta1>(
      'networkConfig',
    );
