...
class TaskCloudtasksV2beta2Args {
  ...
  factory TaskCloudtasksV2beta2Args.fromMap(Map<String, dynamic> map) {
    return TaskCloudtasksV2beta2Args(
      appEngineHttpRequest: map['appEngineHttpRequest'] == null ? null : AppEngineHttpRequestCloudtasksV2beta2.fromMap((map['appEngineHttpRequest'] as Map).cast<String, dynamic>()),
      httpRequest: map['httpRequest'] == null ? null : HttpRequestCloudtasksV2beta2.fromMap((map['httpRequest'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pullMessage: map['pullMessage'] == null ? null : PullMessage.fromMap((map['pullMessage'] as Map).cast<String, dynamic>()),
      queueId: map['queueId'] as String,
      responseView: map['responseView'] == null ? null : TaskResponseViewCloudtasksV2beta2.fromValue(map['responseView'] as String),
