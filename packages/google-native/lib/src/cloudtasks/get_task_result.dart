...
class GetTaskResult {
  ...
  factory GetTaskResult.fromMap(Map<String, dynamic> map) {
    return GetTaskResult(
      appEngineHttpRequest: AppEngineHttpRequestResponse.fromMap((map['appEngineHttpRequest'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dispatchCount: map['dispatchCount'] as int,
      dispatchDeadline: map['dispatchDeadline'] as String,
      firstAttempt: AttemptResponse.fromMap((map['firstAttempt'] as Map).cast<String, dynamic>()),
      httpRequest: HttpRequestResponse.fromMap((map['httpRequest'] as Map).cast<String, dynamic>()),
      lastAttempt: AttemptResponse.fromMap((map['lastAttempt'] as Map).cast<String, dynamic>()),
