...
class GetQueueCloudtasksV2beta3Result {
  ...
  final StackdriverLoggingConfigResponseCloudtasksV2beta3 stackdriverLoggingConfig;
  ...
  /// Creates a new [GetQueueCloudtasksV2beta3Result].
  ...
  /// [state] The state of the queue. `state` can only be changed by called PauseQueue, ResumeQueue, or uploading [queue.yaml/xml](https://cloud.google.com/appengine/docs/python/config/queueref). UpdateQueue cannot be used to change `state`.
  /// [stats] The realtime, informational statistics for a queue. In order to receive the statistics the caller should include this field in the FieldMask.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineHttpQueue': appEngineHttpQueue.toMap(),
  ...
  factory GetQueueCloudtasksV2beta3Result.fromMap(Map<String, dynamic> map) {
    return GetQueueCloudtasksV2beta3Result(
      appEngineHttpQueue: AppEngineHttpQueueResponse.fromMap((map['appEngineHttpQueue'] as Map).cast<String, dynamic>()),
      httpTarget: HttpTargetResponseCloudtasksV2beta3.fromMap((map['httpTarget'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      purgeTime: map['purgeTime'] as String,
      rateLimits: RateLimitsResponseCloudtasksV2beta3.fromMap((map['rateLimits'] as Map).cast<String, dynamic>()),
      retryConfig: RetryConfigResponseCloudtasksV2beta3.fromMap((map['retryConfig'] as Map).cast<String, dynamic>()),
      stackdriverLoggingConfig: StackdriverLoggingConfigResponseCloudtasksV2beta3.fromMap((map['stackdriverLoggingConfig'] as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      stats: QueueStatsResponseCloudtasksV2beta3.fromMap((map['stats'] as Map).cast<String, dynamic>()),
