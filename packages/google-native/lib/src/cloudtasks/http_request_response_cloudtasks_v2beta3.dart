...
class HttpRequestResponseCloudtasksV2beta3 {
  ...
  /// Creates a new [HttpRequestResponseCloudtasksV2beta3].
  ...
  HttpRequestResponseCloudtasksV2beta3({
    required this.body,
  ...
  factory HttpRequestResponseCloudtasksV2beta3.fromMap(
    Map<String, dynamic> map,
  ) {
    return HttpRequestResponseCloudtasksV2beta3(
