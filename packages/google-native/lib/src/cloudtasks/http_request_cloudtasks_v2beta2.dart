...
class HttpRequestCloudtasksV2beta2 {
  ...
  final HttpRequestHttpMethodCloudtasksV2beta2? httpMethod;
  ...
  factory HttpRequestCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return HttpRequestCloudtasksV2beta2(
      ...
      httpMethod: map['httpMethod'] == null ? null : HttpRequestHttpMethodCloudtasksV2beta2.fromValue(map['httpMethod'] as String),
