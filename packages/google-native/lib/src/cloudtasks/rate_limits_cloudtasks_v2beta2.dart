...
class RateLimitsCloudtasksV2beta2 {
  ...
  factory RateLimitsCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return RateLimitsCloudtasksV2beta2(
      ...
      maxConcurrentTasks: map['maxConcurrentTasks'] == null ? null : map['maxConcurrentTasks'] as int,
      maxTasksDispatchedPerSecond: map['maxTasksDispatchedPerSecond'] == null ? null : map['maxTasksDispatchedPerSecond'] as double,
    );
  }
}
