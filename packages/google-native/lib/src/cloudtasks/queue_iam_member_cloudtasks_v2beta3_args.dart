...
/// {@template pulumi_cloudtasks_v2beta3_queue_iam_member_cloudtasks_v2beta3_args_doc}
/// The set of arguments for QueueIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudtasks_v2beta3_queue_iam_member_cloudtasks_v2beta3_args_doc}
class QueueIamMemberCloudtasksV2beta3Args {
  ...
  /// Creates a new [QueueIamMemberCloudtasksV2beta3Args].
  ...
  factory QueueIamMemberCloudtasksV2beta3Args.fromMap(Map<String, dynamic> map) {
    return QueueIamMemberCloudtasksV2beta3Args(
