...
class GetQueueResult {
  ...
  factory GetQueueResult.fromMap(Map<String, dynamic> map) {
    return GetQueueResult(
      appEngineRoutingOverride: AppEngineRoutingResponse.fromMap((map['appEngineRoutingOverride'] as Map).cast<String, dynamic>()),
      httpTarget: HttpTargetResponse.fromMap((map['httpTarget'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      purgeTime: map['purgeTime'] as String,
      rateLimits: RateLimitsResponse.fromMap((map['rateLimits'] as Map).cast<String, dynamic>()),
      retryConfig: RetryConfigResponse.fromMap((map['retryConfig'] as Map).cast<String, dynamic>()),
      stackdriverLoggingConfig: StackdriverLoggingConfigResponse.fromMap((map['stackdriverLoggingConfig'] as Map).cast<String, dynamic>()),
