...
class QueueCloudtasksV2beta2Args {
  ...
  factory QueueCloudtasksV2beta2Args.fromMap(Map<String, dynamic> map) {
    return QueueCloudtasksV2beta2Args(
      ...
      httpTarget: map['httpTarget'] == null ? null : HttpTargetCloudtasksV2beta2.fromMap((map['httpTarget'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pullTarget: map['pullTarget'] == null ? null : (map['pullTarget'] as Map).cast<String, dynamic>(),
      rateLimits: map['rateLimits'] == null ? null : RateLimitsCloudtasksV2beta2.fromMap((map['rateLimits'] as Map).cast<String, dynamic>()),
      retryConfig: map['retryConfig'] == null ? null : RetryConfigCloudtasksV2beta2.fromMap((map['retryConfig'] as Map).cast<String, dynamic>()),
