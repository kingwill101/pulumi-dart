...
class RateLimitsCloudtasksV2beta3 {
  ...
  /// Creates a new [RateLimitsCloudtasksV2beta3].
  ...
  factory RateLimitsCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return RateLimitsCloudtasksV2beta3(
      maxBurstSize: map['maxBurstSize'] == null
          ? null
          : map['maxBurstSize'] as int,
