...
class TaskArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'queueId': queueId,
      'responseView': ?pulumi.Input.mapOptionalInputValue<TaskResponseView, String>(responseView, (value) => value.value),
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      appEngineHttpRequest: map['appEngineHttpRequest'] == null ? null : AppEngineHttpRequest.fromMap((map['appEngineHttpRequest'] as Map).cast<String, dynamic>()),
      dispatchDeadline: map['dispatchDeadline'] == null ? null : map['dispatchDeadline'] as String,
      httpRequest: map['httpRequest'] == null ? null : HttpRequest.fromMap((map['httpRequest'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      queueId: map['queueId'] as String,
      responseView: map['responseView'] == null ? null : TaskResponseView.fromValue(map['responseView'] as String),
