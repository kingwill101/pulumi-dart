...
/// {@template pulumi_cloudtasks_v2beta2_queue_iam_binding_cloudtasks_v2beta2_args_doc}
/// The set of arguments for QueueIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudtasks_v2beta2_queue_iam_binding_cloudtasks_v2beta2_args_doc}
class QueueIamBindingCloudtasksV2beta2Args {
  ...
  /// Creates a new [QueueIamBindingCloudtasksV2beta2Args].
  ...
  QueueIamBindingCloudtasksV2beta2Args({
    Condition? condition,
  ...
  factory QueueIamBindingCloudtasksV2beta2Args.fromMap(Map<String, dynamic> map) {
    return QueueIamBindingCloudtasksV2beta2Args(
