...
class OidcTokenResponseCloudtasksV2beta2 {
  ...
  /// Creates a new [OidcTokenResponseCloudtasksV2beta2].
  ...
  factory OidcTokenResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return OidcTokenResponseCloudtasksV2beta2(
