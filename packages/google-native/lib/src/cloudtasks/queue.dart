...
class Queue extends pulumi.CustomResource {
  ...
  Queue(
    ...
    this.appEngineRoutingOverride = registerOutput<AppEngineRoutingResponse>('appEngineRoutingOverride');
    ...
    this.stackdriverLoggingConfig = registerOutput<StackdriverLoggingConfigResponse>('stackdriverLoggingConfig');
