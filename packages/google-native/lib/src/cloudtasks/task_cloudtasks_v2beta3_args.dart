...
class TaskCloudtasksV2beta3Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'queueId': queueId,
      'responseView': ?pulumi.Input.mapOptionalInputValue<TaskResponseViewCloudtasksV2beta3, String>(responseView, (value) => value.value),
  ...
  factory TaskCloudtasksV2beta3Args.fromMap(Map<String, dynamic> map) {
    return TaskCloudtasksV2beta3Args(
      appEngineHttpRequest: map['appEngineHttpRequest'] == null ? null : AppEngineHttpRequestCloudtasksV2beta3.fromMap((map['appEngineHttpRequest'] as Map).cast<String, dynamic>()),
      dispatchDeadline: map['dispatchDeadline'] == null ? null : map['dispatchDeadline'] as String,
      httpRequest: map['httpRequest'] == null ? null : HttpRequestCloudtasksV2beta3.fromMap((map['httpRequest'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pullMessage: map['pullMessage'] == null ? null : PullMessageCloudtasksV2beta3.fromMap((map['pullMessage'] as Map).cast<String, dynamic>()),
      queueId: map['queueId'] as String,
      responseView: map['responseView'] == null ? null : TaskResponseViewCloudtasksV2beta3.fromValue(map['responseView'] as String),
