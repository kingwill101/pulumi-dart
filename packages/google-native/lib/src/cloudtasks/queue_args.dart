...
class QueueArgs {
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      appEngineRoutingOverride: map['appEngineRoutingOverride'] == null ? null : AppEngineRouting.fromMap((map['appEngineRoutingOverride'] as Map).cast<String, dynamic>()),
      ...
      rateLimits: map['rateLimits'] == null ? null : RateLimits.fromMap((map['rateLimits'] as Map).cast<String, dynamic>()),
      retryConfig: map['retryConfig'] == null ? null : RetryConfig.fromMap((map['retryConfig'] as Map).cast<String, dynamic>()),
      stackdriverLoggingConfig: map['stackdriverLoggingConfig'] == null ? null : StackdriverLoggingConfig.fromMap((map['stackdriverLoggingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
