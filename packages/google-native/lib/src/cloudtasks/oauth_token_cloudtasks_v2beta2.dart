...
class OAuthTokenCloudtasksV2beta2 {
  ...
  OAuthTokenCloudtasksV2beta2({this.scope, this.serviceAccountEmail});
  ...
  factory OAuthTokenCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return OAuthTokenCloudtasksV2beta2(
