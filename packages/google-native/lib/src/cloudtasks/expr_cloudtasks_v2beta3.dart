...
class ExprCloudtasksV2beta3 {
  ...
  /// Creates a new [ExprCloudtasksV2beta3].
  ...
  factory ExprCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return ExprCloudtasksV2beta3(
