...
class HttpTargetResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headerOverrides': pulumi.Input.encodeList<HeaderOverrideResponse, Map<String, dynamic>>(headerOverrides, (value) => value.toMap()),
  ...
  factory HttpTargetResponse.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponse(
      headerOverrides: pulumi.Input.decodeList<HeaderOverrideResponse>(map['headerOverrides'], (value) => HeaderOverrideResponse.fromMap((value as Map).cast<String, dynamic>())),
      httpMethod: map['httpMethod'] as String,
      oauthToken: OAuthTokenResponse.fromMap((map['oauthToken'] as Map).cast<String, dynamic>()),
      oidcToken: OidcTokenResponse.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
      uriOverride: UriOverrideResponse.fromMap((map['uriOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
