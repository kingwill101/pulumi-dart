...
/// {@template pulumi_cloudtasks_v2beta3_queue_iam_binding_cloudtasks_v2beta3_args_doc}
/// The set of arguments for QueueIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudtasks_v2beta3_queue_iam_binding_cloudtasks_v2beta3_args_doc}
class QueueIamBindingCloudtasksV2beta3Args {
  ...
  /// Creates a new [QueueIamBindingCloudtasksV2beta3Args].
  ...
  QueueIamBindingCloudtasksV2beta3Args({
    Condition? condition,
  ...
  factory QueueIamBindingCloudtasksV2beta3Args.fromMap(Map<String, dynamic> map) {
    return QueueIamBindingCloudtasksV2beta3Args(
