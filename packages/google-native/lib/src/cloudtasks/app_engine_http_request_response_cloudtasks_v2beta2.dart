...
class AppEngineHttpRequestResponseCloudtasksV2beta2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['appEngineRouting'] = appEngineRouting.toMap();
    map['headers'] = headers;
  ...
  factory AppEngineHttpRequestResponseCloudtasksV2beta2.fromMap(
      Map<String, dynamic> map) {
    return AppEngineHttpRequestResponseCloudtasksV2beta2(
      appEngineRouting: AppEngineRoutingResponseCloudtasksV2beta2.fromMap(
