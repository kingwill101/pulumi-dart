...
class HttpTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headerOverrides': ?headerOverrides == null ? null : pulumi.Input.encodeList<HeaderOverride, Map<String, dynamic>>(headerOverrides!, (value) => value.toMap()),
  ...
  factory HttpTarget.fromMap(Map<String, dynamic> map) {
    return HttpTarget(
      headerOverrides: map['headerOverrides'] == null ? null : pulumi.Input.decodeList<HeaderOverride>(map['headerOverrides'], (value) => HeaderOverride.fromMap((value as Map).cast<String, dynamic>())),
      ...
      uriOverride: map['uriOverride'] == null ? null : UriOverride.fromMap((map['uriOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
