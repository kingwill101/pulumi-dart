...
class AppEngineHttpRequestResponseCloudtasksV2beta3 {
  ...
  final AppEngineRoutingResponseCloudtasksV2beta3 appEngineRouting;
  ...
  /// Creates a new [AppEngineHttpRequestResponseCloudtasksV2beta3].
  ...
  AppEngineHttpRequestResponseCloudtasksV2beta3({
  ...
  factory AppEngineHttpRequestResponseCloudtasksV2beta3.fromMap(
      Map<String, dynamic> map) {
    return AppEngineHttpRequestResponseCloudtasksV2beta3(
      appEngineRouting: AppEngineRoutingResponseCloudtasksV2beta3.fromMap(
