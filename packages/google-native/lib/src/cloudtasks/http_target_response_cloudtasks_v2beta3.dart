...
class HttpTargetResponseCloudtasksV2beta3 {
  ...
  factory HttpTargetResponseCloudtasksV2beta3.fromMap(
    Map<String, dynamic> map,
  ) {
    return HttpTargetResponseCloudtasksV2beta3(
      headerOverrides:
          pulumi.Input.decodeList<HeaderOverrideResponseCloudtasksV2beta3>(
            map['headerOverrides'],
            (value) => HeaderOverrideResponseCloudtasksV2beta3.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      httpMethod: map['httpMethod'] as String,
      oauthToken: OAuthTokenResponseCloudtasksV2beta3.fromMap(
        (map['oauthToken'] as Map).cast<String, dynamic>(),
      ),
      oidcToken: OidcTokenResponseCloudtasksV2beta3.fromMap(
        (map['oidcToken'] as Map).cast<String, dynamic>(),
      ),
      uriOverride: UriOverrideResponseCloudtasksV2beta3.fromMap(
