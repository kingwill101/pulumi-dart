...
import 'header_override_response_cloudtasks_v2beta3.dart';
import 'oauth_token_response_cloudtasks_v2beta3.dart';
import 'oidc_token_response_cloudtasks_v2beta3.dart';
import 'uri_override_response_cloudtasks_v2beta3.dart';

/// HTTP target. When specified as a Queue, all the tasks with [HttpRequest] will be overridden according to the target.
class HttpTargetResponseCloudtasksV2beta3 {
  ...
  final List<HeaderOverrideResponseCloudtasksV2beta3> headerOverrides;
  ...
  final OAuthTokenResponseCloudtasksV2beta3 oauthToken;
  /// If specified, an [OIDC](https://developers.google.com/identity/protocols/OpenIDConnect) token will be generated and attached as an `Authorization` header in the HTTP request. This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself.
  final OidcTokenResponseCloudtasksV2beta3 oidcToken;
  /// URI override. When specified, overrides the execution URI for all the tasks in the queue.
  final UriOverrideResponseCloudtasksV2beta3 uriOverride;

  /// Creates a new [HttpTargetResponseCloudtasksV2beta3].
  ...
  HttpTargetResponseCloudtasksV2beta3({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headerOverrides': pulumi.Input.encodeList<HeaderOverrideResponseCloudtasksV2beta3, Map<String, dynamic>>(headerOverrides, (value) => value.toMap()),
      'httpMethod': httpMethod,
      'oauthToken': oauthToken.toMap(),
      'oidcToken': oidcToken.toMap(),
      'uriOverride': uriOverride.toMap(),
    };
  }

  factory HttpTargetResponseCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponseCloudtasksV2beta3(
      headerOverrides: pulumi.Input.decodeList<HeaderOverrideResponseCloudtasksV2beta3>(map['headerOverrides'], (value) => HeaderOverrideResponseCloudtasksV2beta3.fromMap((value as Map).cast<String, dynamic>())),
      httpMethod: map['httpMethod'] as String,
      oauthToken: OAuthTokenResponseCloudtasksV2beta3.fromMap((map['oauthToken'] as Map).cast<String, dynamic>()),
      oidcToken: OidcTokenResponseCloudtasksV2beta3.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
      uriOverride: UriOverrideResponseCloudtasksV2beta3.fromMap((map['uriOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
