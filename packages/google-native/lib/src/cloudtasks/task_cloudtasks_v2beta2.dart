...
class TaskCloudtasksV2beta2 extends pulumi.CustomResource {
  ...
  TaskCloudtasksV2beta2(
    ...
    this.appEngineHttpRequest = registerOutput<AppEngineHttpRequestResponseCloudtasksV2beta2>('appEngineHttpRequest');
    this.createTime = registerOutput<String>('createTime');
    this.httpRequest = registerOutput<HttpRequestResponseCloudtasksV2beta2>('httpRequest');
