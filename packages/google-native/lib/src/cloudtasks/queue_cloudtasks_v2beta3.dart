...
class QueueCloudtasksV2beta3 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<StackdriverLoggingConfigResponseCloudtasksV2beta3> stackdriverLoggingConfig;
  ...
  QueueCloudtasksV2beta3(
    ...
    this.appEngineHttpQueue = registerOutput<AppEngineHttpQueueResponse>('appEngineHttpQueue');
    this.httpTarget = registerOutput<HttpTargetResponseCloudtasksV2beta3>('httpTarget');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.purgeTime = registerOutput<String>('purgeTime');
    this.rateLimits = registerOutput<RateLimitsResponseCloudtasksV2beta3>('rateLimits');
    this.retryConfig = registerOutput<RetryConfigResponseCloudtasksV2beta3>('retryConfig');
    this.stackdriverLoggingConfig = registerOutput<StackdriverLoggingConfigResponseCloudtasksV2beta3>('stackdriverLoggingConfig');
