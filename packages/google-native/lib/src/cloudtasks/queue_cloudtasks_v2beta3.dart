...
class QueueCloudtasksV2beta3 extends pulumi.CustomResource {
  ...
  QueueCloudtasksV2beta3(
    ...
    this.appEngineHttpQueue = registerOutput<AppEngineHttpQueueResponse>(
      'appEngineHttpQueue',
    );
    this.httpTarget = registerOutput<HttpTargetResponseCloudtasksV2beta3>(
      'httpTarget',
    );
    ...
    this.rateLimits = registerOutput<RateLimitsResponseCloudtasksV2beta3>(
      'rateLimits',
    );
    this.retryConfig = registerOutput<RetryConfigResponseCloudtasksV2beta3>(
      'retryConfig',
    );
