...
class QueueCloudtasksV2beta2 extends pulumi.CustomResource {
  ...
  QueueCloudtasksV2beta2(
    ...
    this.httpTarget = registerOutput<HttpTargetResponseCloudtasksV2beta2>(
      'httpTarget',
    );
    ...
    this.rateLimits = registerOutput<RateLimitsResponseCloudtasksV2beta2>(
      'rateLimits',
    );
    this.retryConfig = registerOutput<RetryConfigResponseCloudtasksV2beta2>(
      'retryConfig',
    );
