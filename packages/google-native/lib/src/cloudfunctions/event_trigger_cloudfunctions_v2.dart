...
class EventTriggerCloudfunctionsV2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'channel': ?channel,
      'eventFilters': ?eventFilters == null ? null : pulumi.Input.encodeList<EventFilter, Map<String, dynamic>>(eventFilters!, (value) => value.toMap()),
      'eventType': eventType,
  ...
  factory EventTriggerCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return EventTriggerCloudfunctionsV2(
      ...
      eventFilters: map['eventFilters'] == null ? null : pulumi.Input.decodeList<EventFilter>(map['eventFilters'], (value) => EventFilter.fromMap((value as Map).cast<String, dynamic>())),
      eventType: map['eventType'] as String,
      pubsubTopic: map['pubsubTopic'] == null ? null : map['pubsubTopic'] as String,
      retryPolicy: map['retryPolicy'] == null ? null : EventTriggerRetryPolicy.fromValue(map['retryPolicy'] as String),
