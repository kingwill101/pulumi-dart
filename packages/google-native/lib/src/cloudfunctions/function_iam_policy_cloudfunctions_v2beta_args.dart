...
class FunctionIamPolicyCloudfunctionsV2betaArgs {
  ...
  FunctionIamPolicyCloudfunctionsV2betaArgs({
    List<AuditConfigCloudfunctionsV2beta>? auditConfigs,
    List<BindingCloudfunctionsV2beta>? bindings,
    String? etag,
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigCloudfunctionsV2beta>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingCloudfunctionsV2beta>>(
                bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigCloudfunctionsV2beta>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigCloudfunctionsV2beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingCloudfunctionsV2beta>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingCloudfunctionsV2beta,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory FunctionIamPolicyCloudfunctionsV2betaArgs.fromMap(
      Map<String, dynamic> map) {
    return FunctionIamPolicyCloudfunctionsV2betaArgs(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigCloudfunctionsV2beta>(
              map['auditConfigs'],
              (value) => AuditConfigCloudfunctionsV2beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingCloudfunctionsV2beta>(
              map['bindings'],
              (value) => BindingCloudfunctionsV2beta.fromMap(
                  (value as Map).cast<String, dynamic>())),
