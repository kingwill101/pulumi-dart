...
class AuditLogConfigCloudfunctionsV2beta {
  ...
  final AuditLogConfigLogTypeCloudfunctionsV2beta? logType;
  ...
  factory AuditLogConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigCloudfunctionsV2beta(
      ...
      logType: map['logType'] == null ? null : AuditLogConfigLogTypeCloudfunctionsV2beta.fromValue(map['logType'] as String),
    );
  }
}
