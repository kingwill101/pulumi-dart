...
import 'secret_version_response_cloudfunctions_v2.dart';
...
class SecretVolumeResponseCloudfunctionsV2 {
  ...
  final List<SecretVersionResponseCloudfunctionsV2> versions;

  /// Creates a new [SecretVolumeResponseCloudfunctionsV2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': project,
      'secret': secret,
      'versions': pulumi.Input.encodeList<SecretVersionResponseCloudfunctionsV2, Map<String, dynamic>>(versions, (value) => value.toMap()),
    };
  }
  ...
  factory SecretVolumeResponseCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return SecretVolumeResponseCloudfunctionsV2(
      ...
      versions: pulumi.Input.decodeList<SecretVersionResponseCloudfunctionsV2>(map['versions'], (value) => SecretVersionResponseCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
