...
class ServiceConfigResponseCloudfunctionsV2beta {
  ...
  final List<SecretEnvVarResponseCloudfunctionsV2beta> secretEnvironmentVariables;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'revision': revision,
      'secretEnvironmentVariables': pulumi.Input.encodeList<SecretEnvVarResponseCloudfunctionsV2beta, Map<String, dynamic>>(secretEnvironmentVariables, (value) => value.toMap()),
      'secretVolumes': pulumi.Input.encodeList<SecretVolumeResponseCloudfunctionsV2beta, Map<String, dynamic>>(secretVolumes, (value) => value.toMap()),
  ...
  factory ServiceConfigResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponseCloudfunctionsV2beta(
      ...
      secretEnvironmentVariables: pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2beta>(map['secretEnvironmentVariables'], (value) => SecretEnvVarResponseCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>())),
      secretVolumes: pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2beta>(map['secretVolumes'], (value) => SecretVolumeResponseCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>())),
