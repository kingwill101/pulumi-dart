...
import 'secret_env_var_response_cloudfunctions_v2alpha.dart';
import 'secret_volume_response_cloudfunctions_v2alpha.dart';

/// Describes the Service being deployed. Currently Supported : Cloud Run (fully managed).
class ServiceConfigResponseCloudfunctionsV2alpha {
  ...
  final List<SecretEnvVarResponseCloudfunctionsV2alpha>
      secretEnvironmentVariables;

  /// Secret volumes configuration.
  final List<SecretVolumeResponseCloudfunctionsV2alpha> secretVolumes;
  ...
  /// Creates a new [ServiceConfigResponseCloudfunctionsV2alpha].
  ...
  ServiceConfigResponseCloudfunctionsV2alpha({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['secretEnvironmentVariables'] = pulumi.Input.encodeList<
            SecretEnvVarResponseCloudfunctionsV2alpha, Map<String, dynamic>>(
  ...
  factory ServiceConfigResponseCloudfunctionsV2alpha.fromMap(
      Map<String, dynamic> map) {
    return ServiceConfigResponseCloudfunctionsV2alpha(
      ...
      secretEnvironmentVariables:
          pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2alpha>(
              map['secretEnvironmentVariables'],
              (value) => SecretEnvVarResponseCloudfunctionsV2alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
      secretVolumes:
          pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2alpha>(
              map['secretVolumes'],
              (value) => SecretVolumeResponseCloudfunctionsV2alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
