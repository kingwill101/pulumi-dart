...
class BuildConfigCloudfunctionsV2alpha {
  ...
  factory BuildConfigCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return BuildConfigCloudfunctionsV2alpha(
      dockerRegistry: map['dockerRegistry'] == null ? null : BuildConfigDockerRegistryCloudfunctionsV2alpha.fromValue(map['dockerRegistry'] as String),
      ...
      source: map['source'] == null ? null : SourceCloudfunctionsV2alpha.fromMap((map['source'] as Map).cast<String, dynamic>()),
