...
import 'build_config_docker_registry_cloudfunctions_v2beta.dart';
import 'source_cloudfunctions_v2beta.dart';

/// Describes the Build step of the function that builds a container from the given source.
class BuildConfigCloudfunctionsV2beta {
  /// Docker Registry to use for this deployment. This configuration is only applicable to 1st Gen functions, 2nd Gen functions can only use Artifact Registry. If `docker_repository` field is specified, this field will be automatically set as `ARTIFACT_REGISTRY`. If unspecified, it currently defaults to `CONTAINER_REGISTRY`. This field may be overridden by the backend for eligible deployments.
  final BuildConfigDockerRegistryCloudfunctionsV2beta? dockerRegistry;
  ...
  final SourceCloudfunctionsV2beta? source;
  ...
  /// Creates a new [BuildConfigCloudfunctionsV2beta].
  ...
  factory BuildConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return BuildConfigCloudfunctionsV2beta(
      dockerRegistry: map['dockerRegistry'] == null ? null : BuildConfigDockerRegistryCloudfunctionsV2beta.fromValue(map['dockerRegistry'] as String),
      ...
      source: map['source'] == null ? null : SourceCloudfunctionsV2beta.fromMap((map['source'] as Map).cast<String, dynamic>()),
