...
class FunctionCloudfunctionsV2Args {
  ...
  FunctionCloudfunctionsV2Args({
    ...
    ServiceConfig? serviceConfig,
       ...
       environment = pulumi.Input.asOptionalInput<FunctionEnvironment>(
         environment,
       ),
       eventTrigger = pulumi
           .Input.asOptionalInput<EventTriggerCloudfunctionsV2>(eventTrigger),
       ...
       serviceConfig = pulumi.Input.asOptionalInput<ServiceConfig>(
         serviceConfig,
       );
  ...
  factory FunctionCloudfunctionsV2Args.fromMap(Map<String, dynamic> map) {
    return FunctionCloudfunctionsV2Args(
      ...
      environment: map['environment'] == null
          ? null
          : FunctionEnvironment.fromValue(map['environment'] as String),
      eventTrigger: map['eventTrigger'] == null
          ? null
          : EventTriggerCloudfunctionsV2.fromMap(
              (map['eventTrigger'] as Map).cast<String, dynamic>(),
            ),
      functionId: map['functionId'] == null
          ? null
          : map['functionId'] as String,
