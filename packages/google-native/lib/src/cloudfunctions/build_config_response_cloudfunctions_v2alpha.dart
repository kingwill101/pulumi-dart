...
class BuildConfigResponseCloudfunctionsV2alpha {
  ...
  final SourceResponseCloudfunctionsV2alpha source;
  /// A permanent fixed identifier for source.
  final SourceProvenanceResponseCloudfunctionsV2alpha sourceProvenance;
  ...
  factory BuildConfigResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponseCloudfunctionsV2alpha(
      ...
      source: SourceResponseCloudfunctionsV2alpha.fromMap((map['source'] as Map).cast<String, dynamic>()),
      sourceProvenance: SourceProvenanceResponseCloudfunctionsV2alpha.fromMap((map['sourceProvenance'] as Map).cast<String, dynamic>()),
