    ...
    FunctionVpcConnectorEgressSettings? vpcConnectorEgressSettings,
        ...
        secretEnvironmentVariables =
            pulumi.Input.asOptionalInput<List<SecretEnvVar>>(
                secretEnvironmentVariables),
        secretVolumes =
            pulumi.Input.asOptionalInput<List<SecretVolume>>(secretVolumes),
        serviceAccountEmail =
            pulumi.Input.asOptionalInput<String>(serviceAccountEmail),
        sourceArchiveUrl =
            pulumi.Input.asOptionalInput<String>(sourceArchiveUrl),
        sourceRepository =
            pulumi.Input.asOptionalInput<SourceRepository>(sourceRepository),
  ...
  factory FunctionArgs.fromMap(Map<String, dynamic> map) {
    return FunctionArgs(
      ...
      dockerRegistry: map['dockerRegistry'] == null
          ? null
          : FunctionDockerRegistry.fromValue(map['dockerRegistry'] as String),
      ...
      eventTrigger: map['eventTrigger'] == null
          ? null
          : EventTrigger.fromMap(
              (map['eventTrigger'] as Map).cast<String, dynamic>()),
      httpsTrigger: map['httpsTrigger'] == null
          ? null
          : HttpsTrigger.fromMap(
              (map['httpsTrigger'] as Map).cast<String, dynamic>()),
      ingressSettings: map['ingressSettings'] == null
          ? null
          : FunctionIngressSettings.fromValue(map['ingressSettings'] as String),
      kmsKeyName:
      ...
      sourceArchiveUrl: map['sourceArchiveUrl'] == null
          ? null
          : map['sourceArchiveUrl'] as String,
      ...
      sourceUploadUrl: map['sourceUploadUrl'] == null
          ? null
          : map['sourceUploadUrl'] as String,
      ...
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null
          ? null
          : FunctionVpcConnectorEgressSettings.fromValue(
