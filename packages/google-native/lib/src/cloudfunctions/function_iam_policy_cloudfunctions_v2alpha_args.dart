...
class FunctionIamPolicyCloudfunctionsV2alphaArgs {
  ...
  FunctionIamPolicyCloudfunctionsV2alphaArgs({
    ...
    int? version,
            ...
            List<AuditConfigCloudfunctionsV2alpha>>(auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingCloudfunctionsV2alpha>>(
                bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigCloudfunctionsV2alpha>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigCloudfunctionsV2alpha,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingCloudfunctionsV2alpha>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingCloudfunctionsV2alpha,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory FunctionIamPolicyCloudfunctionsV2alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return FunctionIamPolicyCloudfunctionsV2alphaArgs(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigCloudfunctionsV2alpha>(
              map['auditConfigs'],
              (value) => AuditConfigCloudfunctionsV2alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingCloudfunctionsV2alpha>(
              map['bindings'],
              (value) => BindingCloudfunctionsV2alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
