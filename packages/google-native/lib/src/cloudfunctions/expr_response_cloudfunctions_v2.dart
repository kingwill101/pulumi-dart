...
class ExprResponseCloudfunctionsV2 {
  ...
  /// Creates a new [ExprResponseCloudfunctionsV2].
  ...
  factory ExprResponseCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudfunctionsV2(
