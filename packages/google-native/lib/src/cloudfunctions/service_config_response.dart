...
class ServiceConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'revision': revision,
      'secretEnvironmentVariables': pulumi.Input.encodeList<SecretEnvVarResponseCloudfunctionsV2, Map<String, dynamic>>(secretEnvironmentVariables, (value) => value.toMap()),
      'secretVolumes': pulumi.Input.encodeList<SecretVolumeResponseCloudfunctionsV2, Map<String, dynamic>>(secretVolumes, (value) => value.toMap()),
  ...
  factory ServiceConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponse(
      ...
      secretEnvironmentVariables: pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2>(map['secretEnvironmentVariables'], (value) => SecretEnvVarResponseCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>())),
      secretVolumes: pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2>(map['secretVolumes'], (value) => SecretVolumeResponseCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>())),
