...
/// {@template pulumi_cloudfunctions_v2beta_function_iam_binding_cloudfunctions_v2beta_args_doc}
/// The set of arguments for FunctionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudfunctions_v2beta_function_iam_binding_cloudfunctions_v2beta_args_doc}
class FunctionIamBindingCloudfunctionsV2betaArgs {
  ...
  /// Creates a new [FunctionIamBindingCloudfunctionsV2betaArgs].
  ...
  FunctionIamBindingCloudfunctionsV2betaArgs({
    Condition? condition,
  ...
  factory FunctionIamBindingCloudfunctionsV2betaArgs.fromMap(Map<String, dynamic> map) {
    return FunctionIamBindingCloudfunctionsV2betaArgs(
