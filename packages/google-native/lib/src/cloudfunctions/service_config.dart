...
class ServiceConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secretEnvironmentVariables': ?secretEnvironmentVariables == null ? null : pulumi.Input.encodeList<SecretEnvVarCloudfunctionsV2, Map<String, dynamic>>(secretEnvironmentVariables!, (value) => value.toMap()),
      'secretVolumes': ?secretVolumes == null ? null : pulumi.Input.encodeList<SecretVolumeCloudfunctionsV2, Map<String, dynamic>>(secretVolumes!, (value) => value.toMap()),
  ...
  factory ServiceConfig.fromMap(Map<String, dynamic> map) {
    return ServiceConfig(
      ...
      ingressSettings: map['ingressSettings'] == null ? null : ServiceConfigIngressSettings.fromValue(map['ingressSettings'] as String),
      ...
      secretEnvironmentVariables: map['secretEnvironmentVariables'] == null ? null : pulumi.Input.decodeList<SecretEnvVarCloudfunctionsV2>(map['secretEnvironmentVariables'], (value) => SecretEnvVarCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>())),
      secretVolumes: map['secretVolumes'] == null ? null : pulumi.Input.decodeList<SecretVolumeCloudfunctionsV2>(map['secretVolumes'], (value) => SecretVolumeCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>())),
      securityLevel: map['securityLevel'] == null ? null : ServiceConfigSecurityLevel.fromValue(map['securityLevel'] as String),
      ...
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null ? null : ServiceConfigVpcConnectorEgressSettings.fromValue(map['vpcConnectorEgressSettings'] as String),
    );
  }
}
