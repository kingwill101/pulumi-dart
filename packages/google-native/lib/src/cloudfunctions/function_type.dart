...
class FunctionType extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SecretEnvVarResponse>> secretEnvironmentVariables;
  ...
  FunctionType(
    ...
    this.secretEnvironmentVariables = registerOutput<List<SecretEnvVarResponse>>('secretEnvironmentVariables');
    this.secretVolumes = registerOutput<List<SecretVolumeResponse>>('secretVolumes');
    ...
    this.sourceRepository = registerOutput<SourceRepositoryResponse>('sourceRepository');
