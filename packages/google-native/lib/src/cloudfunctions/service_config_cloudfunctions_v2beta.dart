...
class ServiceConfigCloudfunctionsV2beta {
  ...
  final ServiceConfigVpcConnectorEgressSettingsCloudfunctionsV2beta? vpcConnectorEgressSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ingressSettings': ?ingressSettings == null ? null : ingressSettings!.value,
      'maxInstanceCount': ?maxInstanceCount,
      'maxInstanceRequestConcurrency': ?maxInstanceRequestConcurrency,
      'minInstanceCount': ?minInstanceCount,
      'secretEnvironmentVariables': ?secretEnvironmentVariables == null ? null : pulumi.Input.encodeList<SecretEnvVarCloudfunctionsV2beta, Map<String, dynamic>>(secretEnvironmentVariables!, (value) => value.toMap()),
      'secretVolumes': ?secretVolumes == null ? null : pulumi.Input.encodeList<SecretVolumeCloudfunctionsV2beta, Map<String, dynamic>>(secretVolumes!, (value) => value.toMap()),
      'securityLevel': ?securityLevel == null ? null : securityLevel!.value,
      'serviceAccountEmail': ?serviceAccountEmail,
      'timeoutSeconds': ?timeoutSeconds,
      'vpcConnector': ?vpcConnector,
      'vpcConnectorEgressSettings': ?vpcConnectorEgressSettings == null ? null : vpcConnectorEgressSettings!.value,
    };
  }
  ...
  factory ServiceConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return ServiceConfigCloudfunctionsV2beta(
      ...
      ingressSettings: map['ingressSettings'] == null ? null : ServiceConfigIngressSettingsCloudfunctionsV2beta.fromValue(map['ingressSettings'] as String),
      ...
      secretEnvironmentVariables: map['secretEnvironmentVariables'] == null ? null : pulumi.Input.decodeList<SecretEnvVarCloudfunctionsV2beta>(map['secretEnvironmentVariables'], (value) => SecretEnvVarCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>())),
      secretVolumes: map['secretVolumes'] == null ? null : pulumi.Input.decodeList<SecretVolumeCloudfunctionsV2beta>(map['secretVolumes'], (value) => SecretVolumeCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>())),
      securityLevel: map['securityLevel'] == null ? null : ServiceConfigSecurityLevelCloudfunctionsV2beta.fromValue(map['securityLevel'] as String),
      ...
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null ? null : ServiceConfigVpcConnectorEgressSettingsCloudfunctionsV2beta.fromValue(map['vpcConnectorEgressSettings'] as String),
    );
  }
}
