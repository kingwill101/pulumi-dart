  ...
  Map<String, dynamic> toMap() {
    ...
    if (secretEnvironmentVariablesValue != null) {
      map['secretEnvironmentVariables'] = pulumi.Input.encodeList<
              SecretEnvVarCloudfunctionsV2beta, Map<String, dynamic>>(
  ...
  factory ServiceConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return ServiceConfigCloudfunctionsV2beta(
      ...
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null
          ? null
          : ServiceConfigVpcConnectorEgressSettingsCloudfunctionsV2beta
              .fromValue(map['vpcConnectorEgressSettings'] as String),
    );
  }
}
