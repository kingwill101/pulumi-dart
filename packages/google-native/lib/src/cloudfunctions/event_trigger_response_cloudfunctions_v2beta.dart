...
class EventTriggerResponseCloudfunctionsV2beta {
  ...
  final List<EventFilterResponseCloudfunctionsV2beta> eventFilters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'channel': channel,
      'eventFilters': pulumi.Input.encodeList<EventFilterResponseCloudfunctionsV2beta, Map<String, dynamic>>(eventFilters, (value) => value.toMap()),
      'eventType': eventType,
  ...
  factory EventTriggerResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return EventTriggerResponseCloudfunctionsV2beta(
      ...
      eventFilters: pulumi.Input.decodeList<EventFilterResponseCloudfunctionsV2beta>(map['eventFilters'], (value) => EventFilterResponseCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>())),
