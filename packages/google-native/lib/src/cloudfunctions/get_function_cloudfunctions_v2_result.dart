...
import 'event_trigger_response_cloudfunctions_v2.dart';
...
class GetFunctionCloudfunctionsV2Result {
  /// Describes the Build step of the function that builds a container from the given source.
  final BuildConfigResponse buildConfig;
  /// User-provided description of a function.
  final String description;
  /// Describe whether the function is 1st Gen or 2nd Gen.
  final String environment;
  /// An Eventarc trigger managed by Google Cloud Functions that fires events in response to a condition in another service.
  final EventTriggerResponseCloudfunctionsV2 eventTrigger;
  ...
  final ServiceConfigResponse serviceConfig;
  /// State of the function.
  final String state;
  /// State Messages for this Cloud Function.
  final List<GoogleCloudFunctionsV2StateMessageResponse> stateMessages;
  /// The last update timestamp of a Cloud Function.
  final String updateTime;
  /// The deployed url for the function.
  final String url;

  /// Creates a new [GetFunctionCloudfunctionsV2Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': state,
      'stateMessages': pulumi.Input.encodeList<GoogleCloudFunctionsV2StateMessageResponse, Map<String, dynamic>>(stateMessages, (value) => value.toMap()),
      'updateTime': updateTime,
      'url': url,
    };
  }

  factory GetFunctionCloudfunctionsV2Result.fromMap(Map<String, dynamic> map) {
    return GetFunctionCloudfunctionsV2Result(
      buildConfig: BuildConfigResponse.fromMap((map['buildConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      environment: map['environment'] as String,
      eventTrigger: EventTriggerResponseCloudfunctionsV2.fromMap((map['eventTrigger'] as Map).cast<String, dynamic>()),
      kmsKeyName: map['kmsKeyName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      serviceConfig: ServiceConfigResponse.fromMap((map['serviceConfig'] as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      stateMessages: pulumi.Input.decodeList<GoogleCloudFunctionsV2StateMessageResponse>(map['stateMessages'], (value) => GoogleCloudFunctionsV2StateMessageResponse.fromMap((value as Map).cast<String, dynamic>())),
