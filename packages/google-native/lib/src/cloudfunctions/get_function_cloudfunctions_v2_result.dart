...
class GetFunctionCloudfunctionsV2Result {
  ...
  factory GetFunctionCloudfunctionsV2Result.fromMap(Map<String, dynamic> map) {
    return GetFunctionCloudfunctionsV2Result(
      buildConfig: BuildConfigResponse.fromMap(
          (map['buildConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      environment: map['environment'] as String,
      eventTrigger: EventTriggerResponseCloudfunctionsV2.fromMap(
          (map['eventTrigger'] as Map).cast<String, dynamic>()),
      kmsKeyName: map['kmsKeyName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      serviceConfig: ServiceConfigResponse.fromMap(
          (map['serviceConfig'] as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      stateMessages:
          pulumi.Input.decodeList<GoogleCloudFunctionsV2StateMessageResponse>(
              map['stateMessages'],
              (value) => GoogleCloudFunctionsV2StateMessageResponse.fromMap(
