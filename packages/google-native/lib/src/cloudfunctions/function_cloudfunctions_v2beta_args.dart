...
class FunctionCloudfunctionsV2betaArgs {
  ...
  FunctionCloudfunctionsV2betaArgs({
    BuildConfigCloudfunctionsV2beta? buildConfig,
    String? description,
    FunctionEnvironmentCloudfunctionsV2beta? environment,
    EventTriggerCloudfunctionsV2beta? eventTrigger,
    String? functionId,
    String? kmsKeyName,
    ...
    String? name,
    String? project,
    ServiceConfigCloudfunctionsV2beta? serviceConfig,
  }) :
  ...
  factory FunctionCloudfunctionsV2betaArgs.fromMap(Map<String, dynamic> map) {
    return FunctionCloudfunctionsV2betaArgs(
      buildConfig: map['buildConfig'] == null ? null : BuildConfigCloudfunctionsV2beta.fromMap((map['buildConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      environment: map['environment'] == null ? null : FunctionEnvironmentCloudfunctionsV2beta.fromValue(map['environment'] as String),
      eventTrigger: map['eventTrigger'] == null ? null : EventTriggerCloudfunctionsV2beta.fromMap((map['eventTrigger'] as Map).cast<String, dynamic>()),
      ...
      serviceConfig: map['serviceConfig'] == null ? null : ServiceConfigCloudfunctionsV2beta.fromMap((map['serviceConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
