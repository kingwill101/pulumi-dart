...
class ExprResponseCloudfunctionsV2alpha {
  ...
  /// Creates a new [ExprResponseCloudfunctionsV2alpha].
  ...
  factory ExprResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudfunctionsV2alpha(
