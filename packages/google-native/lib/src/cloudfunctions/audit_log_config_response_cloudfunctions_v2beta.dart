...
class AuditLogConfigResponseCloudfunctionsV2beta {
  ...
  /// Creates a new [AuditLogConfigResponseCloudfunctionsV2beta].
  ...
  factory AuditLogConfigResponseCloudfunctionsV2beta.fromMap(
      Map<String, dynamic> map) {
    return AuditLogConfigResponseCloudfunctionsV2beta(
