...
class EventTriggerCloudfunctionsV2alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'channel': ?channel,
      'eventFilters': ?eventFilters == null ? null : pulumi.Input.encodeList<EventFilterCloudfunctionsV2alpha, Map<String, dynamic>>(eventFilters!, (value) => value.toMap()),
      'eventType': eventType,
  ...
  factory EventTriggerCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return EventTriggerCloudfunctionsV2alpha(
      ...
      eventFilters: map['eventFilters'] == null ? null : pulumi.Input.decodeList<EventFilterCloudfunctionsV2alpha>(map['eventFilters'], (value) => EventFilterCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>())),
      eventType: map['eventType'] as String,
      pubsubTopic: map['pubsubTopic'] == null ? null : map['pubsubTopic'] as String,
      retryPolicy: map['retryPolicy'] == null ? null : EventTriggerRetryPolicyCloudfunctionsV2alpha.fromValue(map['retryPolicy'] as String),
