...
class FunctionCloudfunctionsV2alphaArgs {
  ...
  factory FunctionCloudfunctionsV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return FunctionCloudfunctionsV2alphaArgs(
      buildConfig: map['buildConfig'] == null ? null : BuildConfigCloudfunctionsV2alpha.fromMap((map['buildConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      environment: map['environment'] == null ? null : FunctionEnvironmentCloudfunctionsV2alpha.fromValue(map['environment'] as String),
      eventTrigger: map['eventTrigger'] == null ? null : EventTriggerCloudfunctionsV2alpha.fromMap((map['eventTrigger'] as Map).cast<String, dynamic>()),
      ...
      serviceConfig: map['serviceConfig'] == null ? null : ServiceConfigCloudfunctionsV2alpha.fromMap((map['serviceConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
