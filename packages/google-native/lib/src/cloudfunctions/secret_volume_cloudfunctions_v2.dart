...
class SecretVolumeCloudfunctionsV2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'secret': ?secret,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<SecretVersionCloudfunctionsV2, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory SecretVolumeCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return SecretVolumeCloudfunctionsV2(
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<SecretVersionCloudfunctionsV2>(map['versions'], (value) => SecretVersionCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
