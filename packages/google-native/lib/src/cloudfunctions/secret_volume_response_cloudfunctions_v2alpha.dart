...
class SecretVolumeResponseCloudfunctionsV2alpha {
  ...
  final List<SecretVersionResponseCloudfunctionsV2alpha> versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': project,
      'secret': secret,
      'versions': pulumi.Input.encodeList<SecretVersionResponseCloudfunctionsV2alpha, Map<String, dynamic>>(versions, (value) => value.toMap()),
    };
  }
  ...
  factory SecretVolumeResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return SecretVolumeResponseCloudfunctionsV2alpha(
      ...
      versions: pulumi.Input.decodeList<SecretVersionResponseCloudfunctionsV2alpha>(map['versions'], (value) => SecretVersionResponseCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
