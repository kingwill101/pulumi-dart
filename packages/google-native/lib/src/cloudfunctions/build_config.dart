...
class BuildConfig {
  ...
  final BuildConfigDockerRegistry? dockerRegistry;
  ...
  factory BuildConfig.fromMap(Map<String, dynamic> map) {
    return BuildConfig(
      dockerRegistry: map['dockerRegistry'] == null ? null : BuildConfigDockerRegistry.fromValue(map['dockerRegistry'] as String),
