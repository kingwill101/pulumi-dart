...
class MetricArgs {
  ...
  MetricArgs({
    ...
    MetricVersion? version,
       ...
       bucketOptions = pulumi.Input.asOptionalInput<BucketOptions>(
         bucketOptions,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       disabled = pulumi.Input.asOptionalInput<bool>(disabled),
       filter = pulumi.Input.asInput<String>(filter),
       labelExtractors = pulumi.Input.asOptionalInput<Map<String, String>>(
         labelExtractors,
       ),
       metricDescriptor = pulumi.Input.asOptionalInput<MetricDescriptor>(
         metricDescriptor,
       ),
    ...
    return <String, dynamic>{
      ...
      'bucketOptions':
          ?pulumi.Input.mapOptionalInputValue<
            BucketOptions,
            Map<String, dynamic>
          >(bucketOptions, (value) => value.toMap()),
      ...
      'metricDescriptor':
          ?pulumi.Input.mapOptionalInputValue<
            MetricDescriptor,
            Map<String, dynamic>
          >(metricDescriptor, (value) => value.toMap()),
      'name': ?name,
      'project': ?project,
      'valueExtractor': ?valueExtractor,
      'version': ?pulumi.Input.mapOptionalInputValue<MetricVersion, String>(
        version,
        (value) => value.value,
      ),
    };
