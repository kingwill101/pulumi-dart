...
class MetricArgs {
  ...
  factory MetricArgs.fromMap(Map<String, dynamic> map) {
    return MetricArgs(
      ...
      bucketOptions: map['bucketOptions'] == null ? null : BucketOptions.fromMap((map['bucketOptions'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      filter: map['filter'] as String,
      labelExtractors: map['labelExtractors'] == null ? null : (map['labelExtractors'] as Map).cast<String, String>(),
      metricDescriptor: map['metricDescriptor'] == null ? null : MetricDescriptor.fromMap((map['metricDescriptor'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      valueExtractor: map['valueExtractor'] == null ? null : map['valueExtractor'] as String,
      version: map['version'] == null ? null : MetricVersion.fromValue(map['version'] as String),
    );
  }
}
