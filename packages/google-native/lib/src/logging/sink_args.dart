...
class SinkArgs {
  ...
  SinkArgs({
    ...
    bool? uniqueWriterIdentity,
            ...
            pulumi.Input.asOptionalInput<BigQueryOptions>(bigqueryOptions),
        customWriterIdentity =
            pulumi.Input.asOptionalInput<String>(customWriterIdentity),
        description = pulumi.Input.asOptionalInput<String>(description),
        destination = pulumi.Input.asInput<String>(destination),
        disabled = pulumi.Input.asOptionalInput<bool>(disabled),
        exclusions =
            pulumi.Input.asOptionalInput<List<LogExclusion>>(exclusions),
        filter = pulumi.Input.asOptionalInput<String>(filter),
        includeChildren = pulumi.Input.asOptionalInput<bool>(includeChildren),
        name = pulumi.Input.asOptionalInput<String>(name),
        outputVersionFormat =
            pulumi.Input.asOptionalInput<SinkOutputVersionFormat>(
                outputVersionFormat),
        project = pulumi.Input.asOptionalInput<String>(project),
        uniqueWriterIdentity =
            pulumi.Input.asOptionalInput<bool>(uniqueWriterIdentity);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (exclusionsValue != null) {
      map['exclusions'] = pulumi.Input.mapOptionalInputValue<List<LogExclusion>,
    ...
    if (outputVersionFormatValue != null) {
      map['outputVersionFormat'] =
          pulumi.Input.mapOptionalInputValue<SinkOutputVersionFormat, String>(
              outputVersionFormatValue, (value) => value.value);
    }
  ...
  factory SinkArgs.fromMap(Map<String, dynamic> map) {
    return SinkArgs(
      ...
      customWriterIdentity: map['customWriterIdentity'] == null
          ? null
          : map['customWriterIdentity'] as String,
      description:
      ...
      outputVersionFormat: map['outputVersionFormat'] == null
          ? null
          : SinkOutputVersionFormat.fromValue(
              map['outputVersionFormat'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      uniqueWriterIdentity: map['uniqueWriterIdentity'] == null
          ? null
          : map['uniqueWriterIdentity'] as bool,
    );
  }
}
