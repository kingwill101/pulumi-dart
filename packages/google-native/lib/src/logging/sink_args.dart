...
import 'sink_output_version_format.dart';

/// {@template pulumi_logging_v2_sink_args_doc}
/// The set of arguments for Sink.
/// {@endtemplate}
/// {@macro pulumi_logging_v2_sink_args_doc}
class SinkArgs {
  ...
  final pulumi.Input<SinkOutputVersionFormat>? outputVersionFormat;
  ...
  SinkArgs({
    ...
    String? name,
    SinkOutputVersionFormat? outputVersionFormat,
    String? project,
    bool? uniqueWriterIdentity,
      ...
      outputVersionFormat = pulumi.Input.asOptionalInput<SinkOutputVersionFormat>(outputVersionFormat),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'outputVersionFormat': ?pulumi.Input.mapOptionalInputValue<SinkOutputVersionFormat, String>(outputVersionFormat, (value) => value.value),
      'project': ?project,
  ...
  factory SinkArgs.fromMap(Map<String, dynamic> map) {
    return SinkArgs(
      bigqueryOptions: map['bigqueryOptions'] == null ? null : BigQueryOptions.fromMap((map['bigqueryOptions'] as Map).cast<String, dynamic>()),
      customWriterIdentity: map['customWriterIdentity'] == null ? null : map['customWriterIdentity'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      destination: map['destination'] as String,
      disabled: map['disabled'] == null ? null : map['disabled'] as bool,
      exclusions: map['exclusions'] == null ? null : pulumi.Input.decodeList<LogExclusion>(map['exclusions'], (value) => LogExclusion.fromMap((value as Map).cast<String, dynamic>())),
      filter: map['filter'] == null ? null : map['filter'] as String,
      includeChildren: map['includeChildren'] == null ? null : map['includeChildren'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      outputVersionFormat: map['outputVersionFormat'] == null ? null : SinkOutputVersionFormat.fromValue(map['outputVersionFormat'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      uniqueWriterIdentity: map['uniqueWriterIdentity'] == null ? null : map['uniqueWriterIdentity'] as bool,
    );
  }
}
