...
/// Result data returned by getFolderSink.
class GetFolderSinkResult {
  ...
  /// Creates a new [GetFolderSinkResult].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['outputVersionFormat'] = outputVersionFormat;
    map['updateTime'] = updateTime;
    map['writerIdentity'] = writerIdentity;
    return map;
  }

  factory GetFolderSinkResult.fromMap(Map<String, dynamic> map) {
