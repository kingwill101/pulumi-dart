...
class BillingAccountSinkArgs {
  ...
  BillingAccountSinkArgs({
    ...
    String? name,
    BillingAccountSinkOutputVersionFormat? outputVersionFormat,
  ...
  factory BillingAccountSinkArgs.fromMap(Map<String, dynamic> map) {
    return BillingAccountSinkArgs(
      ...
      outputVersionFormat: map['outputVersionFormat'] == null ? null : BillingAccountSinkOutputVersionFormat.fromValue(map['outputVersionFormat'] as String),
