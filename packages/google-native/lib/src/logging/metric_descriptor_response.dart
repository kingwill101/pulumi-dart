...
class MetricDescriptorResponse {
  ...
  final MetricDescriptorMetadataResponse metadata;
  ...
  factory MetricDescriptorResponse.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorResponse(
      ...
      metadata: MetricDescriptorMetadataResponse.fromMap((map['metadata'] as Map).cast<String, dynamic>()),
      metricKind: map['metricKind'] as String,
      monitoredResourceTypes: (map['monitoredResourceTypes'] as List).cast<String>(),
