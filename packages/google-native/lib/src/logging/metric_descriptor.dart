  ...
  factory MetricDescriptor.fromMap(Map<String, dynamic> map) {
    return MetricDescriptor(
      ...
      launchStage: map['launchStage'] == null
          ? null
          : MetricDescriptorLaunchStage.fromValue(map['launchStage'] as String),
      ...
      metricKind: map['metricKind'] == null
          ? null
          : MetricDescriptorMetricKind.fromValue(map['metricKind'] as String),
      ...
      valueType: map['valueType'] == null
          ? null
          : MetricDescriptorValueType.fromValue(map['valueType'] as String),
    );
  }
}
