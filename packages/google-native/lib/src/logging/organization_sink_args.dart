...
class OrganizationSinkArgs {
  ...
  OrganizationSinkArgs({
    ...
    OrganizationSinkOutputVersionFormat? outputVersionFormat,
  ...
  factory OrganizationSinkArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSinkArgs(
      ...
      outputVersionFormat: map['outputVersionFormat'] == null ? null : OrganizationSinkOutputVersionFormat.fromValue(map['outputVersionFormat'] as String),
