...
class Sink extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Sink]. {@macro pulumi_logging_v2_sink_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  Sink(String name, {SinkArgs? args, pulumi.CustomResourceOptions? options})
    : super(
    ...
    this.bigqueryOptions = registerOutput<BigQueryOptionsResponse>(
      'bigqueryOptions',
    );
