...
/// Result data returned by getOrganizationBucketView.
class GetOrganizationBucketViewResult {
  ...
  /// Creates a new [GetOrganizationBucketViewResult].
  ...
  factory GetOrganizationBucketViewResult.fromMap(Map<String, dynamic> map) {
