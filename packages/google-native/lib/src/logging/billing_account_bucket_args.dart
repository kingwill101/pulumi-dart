...
class BillingAccountBucketArgs {
  ...
  factory BillingAccountBucketArgs.fromMap(Map<String, dynamic> map) {
    return BillingAccountBucketArgs(
      analyticsEnabled: map['analyticsEnabled'] == null ? null : map['analyticsEnabled'] as bool,
      billingAccountId: map['billingAccountId'] as String,
      bucketId: map['bucketId'] as String,
      cmekSettings: map['cmekSettings'] == null ? null : CmekSettings.fromMap((map['cmekSettings'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      indexConfigs: map['indexConfigs'] == null ? null : pulumi.Input.decodeList<IndexConfig>(map['indexConfigs'], (value) => IndexConfig.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      locked: map['locked'] == null ? null : map['locked'] as bool,
      restrictedFields: map['restrictedFields'] == null ? null : (map['restrictedFields'] as List).cast<String>(),
