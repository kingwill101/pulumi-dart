...
import 'folder_sink_output_version_format.dart';
import 'log_exclusion.dart';

/// {@template pulumi_logging_v2_folder_sink_args_doc}
/// The set of arguments for FolderSink.
/// {@endtemplate}
/// {@macro pulumi_logging_v2_folder_sink_args_doc}
class FolderSinkArgs {
  ...
  final pulumi.Input<FolderSinkOutputVersionFormat>? outputVersionFormat;
  ...
  FolderSinkArgs({
    ...
    String? name,
    FolderSinkOutputVersionFormat? outputVersionFormat,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'outputVersionFormat': ?pulumi.Input.mapOptionalInputValue<FolderSinkOutputVersionFormat, String>(outputVersionFormat, (value) => value.value),
  ...
  factory FolderSinkArgs.fromMap(Map<String, dynamic> map) {
    return FolderSinkArgs(
      ...
      outputVersionFormat: map['outputVersionFormat'] == null ? null : FolderSinkOutputVersionFormat.fromValue(map['outputVersionFormat'] as String),
