...
class FolderSinkArgs {
  ...
  FolderSinkArgs({
    ...
    bool? uniqueWriterIdentity,
        ...
        outputVersionFormat =
            pulumi.Input.asOptionalInput<FolderSinkOutputVersionFormat>(
                outputVersionFormat),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (outputVersionFormatValue != null) {
      map['outputVersionFormat'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory FolderSinkArgs.fromMap(Map<String, dynamic> map) {
    return FolderSinkArgs(
      ...
      outputVersionFormat: map['outputVersionFormat'] == null
          ? null
          : FolderSinkOutputVersionFormat.fromValue(
