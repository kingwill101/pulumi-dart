...
class EndpointResponse {
  ...
  factory EndpointResponse.fromMap(Map<String, dynamic> map) {
    return EndpointResponse(
      appEngineVersion: AppEngineVersionEndpointResponse.fromMap(
          (map['appEngineVersion'] as Map).cast<String, dynamic>()),
      cloudFunction: CloudFunctionEndpointResponse.fromMap(
          (map['cloudFunction'] as Map).cast<String, dynamic>()),
      cloudRunRevision: CloudRunRevisionEndpointResponse.fromMap(
