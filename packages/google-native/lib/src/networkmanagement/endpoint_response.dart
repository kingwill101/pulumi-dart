...
import 'app_engine_version_endpoint_response.dart';
import 'cloud_function_endpoint_response.dart';
import 'cloud_run_revision_endpoint_response.dart';
...
class EndpointResponse {
  ...
  final AppEngineVersionEndpointResponse appEngineVersion;
  /// A [Cloud Function](https://cloud.google.com/functions).
  final CloudFunctionEndpointResponse cloudFunction;
  ...
  final CloudRunRevisionEndpointResponse cloudRunRevision;
  ...
  factory EndpointResponse.fromMap(Map<String, dynamic> map) {
    return EndpointResponse(
      appEngineVersion: AppEngineVersionEndpointResponse.fromMap((map['appEngineVersion'] as Map).cast<String, dynamic>()),
      cloudFunction: CloudFunctionEndpointResponse.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>()),
      cloudRunRevision: CloudRunRevisionEndpointResponse.fromMap((map['cloudRunRevision'] as Map).cast<String, dynamic>()),
