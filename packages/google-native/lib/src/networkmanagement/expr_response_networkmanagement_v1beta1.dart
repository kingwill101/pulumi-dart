...
class ExprResponseNetworkmanagementV1beta1 {
  ...
  /// Creates a new [ExprResponseNetworkmanagementV1beta1].
  ...
  factory ExprResponseNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseNetworkmanagementV1beta1(
