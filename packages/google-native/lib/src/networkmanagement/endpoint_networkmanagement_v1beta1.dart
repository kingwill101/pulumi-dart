...
class EndpointNetworkmanagementV1beta1 {
  ...
  final AppEngineVersionEndpointNetworkmanagementV1beta1? appEngineVersion;

  /// A [Cloud Function](https://cloud.google.com/functions).
  final CloudFunctionEndpointNetworkmanagementV1beta1? cloudFunction;
  ...
  final CloudRunRevisionEndpointNetworkmanagementV1beta1? cloudRunRevision;
  ...
  final EndpointNetworkTypeNetworkmanagementV1beta1? networkType;
  ...
  factory EndpointNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return EndpointNetworkmanagementV1beta1(
      ...
      networkType: map['networkType'] == null
          ? null
          : EndpointNetworkTypeNetworkmanagementV1beta1.fromValue(
