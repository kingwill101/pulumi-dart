...
class ConnectivityTestNetworkmanagementV1beta1 extends pulumi.CustomResource {
  ...
  ConnectivityTestNetworkmanagementV1beta1(
    ...
    this.destination = registerOutput<EndpointResponseNetworkmanagementV1beta1>('destination');
    this.displayName = registerOutput<String>('displayName');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.name = registerOutput<String>('name');
    this.probingDetails = registerOutput<ProbingDetailsResponseNetworkmanagementV1beta1>('probingDetails');
    this.project = registerOutput<String>('project');
    this.protocol = registerOutput<String>('protocol');
    this.reachabilityDetails = registerOutput<ReachabilityDetailsResponseNetworkmanagementV1beta1>('reachabilityDetails');
    this.relatedProjects = registerOutput<List<String>>('relatedProjects');
    this.source = registerOutput<EndpointResponseNetworkmanagementV1beta1>('source');
