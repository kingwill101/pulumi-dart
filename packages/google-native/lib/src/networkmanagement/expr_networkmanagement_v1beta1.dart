...
class ExprNetworkmanagementV1beta1 {
  ...
  /// Creates a new [ExprNetworkmanagementV1beta1].
  ...
  factory ExprNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprNetworkmanagementV1beta1(
