...
/// {@template pulumi_networkmanagement_v1_connectivity_test_iam_binding_args_doc}
/// The set of arguments for ConnectivityTestIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkmanagement_v1_connectivity_test_iam_binding_args_doc}
class ConnectivityTestIamBindingArgs {
  ...
  /// Creates a new [ConnectivityTestIamBindingArgs].
  ...
  ConnectivityTestIamBindingArgs({
    Condition? condition,
  ...
  factory ConnectivityTestIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestIamBindingArgs(
