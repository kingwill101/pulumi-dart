...
class EndpointResponseNetworkmanagementV1beta1 {
  ...
  final AppEngineVersionEndpointResponseNetworkmanagementV1beta1 appEngineVersion;
  /// A [Cloud Function](https://cloud.google.com/functions).
  final CloudFunctionEndpointResponseNetworkmanagementV1beta1 cloudFunction;
  ...
  final CloudRunRevisionEndpointResponseNetworkmanagementV1beta1 cloudRunRevision;
  ...
  factory EndpointResponseNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return EndpointResponseNetworkmanagementV1beta1(
      appEngineVersion: AppEngineVersionEndpointResponseNetworkmanagementV1beta1.fromMap((map['appEngineVersion'] as Map).cast<String, dynamic>()),
      cloudFunction: CloudFunctionEndpointResponseNetworkmanagementV1beta1.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>()),
      cloudRunRevision: CloudRunRevisionEndpointResponseNetworkmanagementV1beta1.fromMap((map['cloudRunRevision'] as Map).cast<String, dynamic>()),
