...
/// {@template pulumi_networkmanagement_v1_connectivity_test_iam_policy_args_doc}
/// The set of arguments for ConnectivityTestIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_networkmanagement_v1_connectivity_test_iam_policy_args_doc}
class ConnectivityTestIamPolicyArgs {
  ...
  /// Creates a new [ConnectivityTestIamPolicyArgs].
  ...
  factory ConnectivityTestIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestIamPolicyArgs(
