...
class PrivateEnvironmentConfig {
  ...
  final PrivateClusterConfig? privateClusterConfig;
  ...
  factory PrivateEnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfig(
      ...
      networkingConfig: map['networkingConfig'] == null ? null : NetworkingConfig.fromMap((map['networkingConfig'] as Map).cast<String, dynamic>()),
