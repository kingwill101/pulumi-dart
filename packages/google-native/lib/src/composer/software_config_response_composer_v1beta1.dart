...
class SoftwareConfigResponseComposerV1beta1 {
  ...
  final CloudDataLineageIntegrationResponse cloudDataLineageIntegration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudDataLineageIntegration': cloudDataLineageIntegration.toMap(),
  ...
  factory SoftwareConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return SoftwareConfigResponseComposerV1beta1(
      ...
      cloudDataLineageIntegration: CloudDataLineageIntegrationResponse.fromMap((map['cloudDataLineageIntegration'] as Map).cast<String, dynamic>()),
