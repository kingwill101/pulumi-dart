...
class SoftwareConfigResponseComposerV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['cloudDataLineageIntegration'] = cloudDataLineageIntegration.toMap();
  ...
  factory SoftwareConfigResponseComposerV1beta1.fromMap(
      Map<String, dynamic> map) {
    return SoftwareConfigResponseComposerV1beta1(
      airflowConfigOverrides:
          (map['airflowConfigOverrides'] as Map).cast<String, String>(),
      cloudDataLineageIntegration: CloudDataLineageIntegrationResponse.fromMap(
          (map['cloudDataLineageIntegration'] as Map).cast<String, dynamic>()),
