...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    StorageConfig? storageConfig,
       ...
       storageConfig = pulumi.Input.asOptionalInput<StorageConfig>(
         storageConfig,
       );
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'state': ?pulumi.Input.mapOptionalInputValue<EnvironmentState, String>(
        state,
        (value) => value.value,
      ),
      'storageConfig':
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      state: map['state'] == null
          ? null
          : EnvironmentState.fromValue(map['state'] as String),
      storageConfig: map['storageConfig'] == null
          ? null
          : StorageConfig.fromMap(
