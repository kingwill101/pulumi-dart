...
class EnvironmentArgs {
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      config: map['config'] == null ? null : EnvironmentConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      state: map['state'] == null ? null : EnvironmentState.fromValue(map['state'] as String),
      storageConfig: map['storageConfig'] == null ? null : StorageConfig.fromMap((map['storageConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
