...
import 'networking_config_response.dart';
import 'private_cluster_config_response.dart';

/// The configuration information for configuring a Private IP Cloud Composer environment.
class PrivateEnvironmentConfigResponse {
  ...
  final NetworkingConfigResponse networkingConfig;
  ...
  /// Creates a new [PrivateEnvironmentConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkingConfig': networkingConfig.toMap(),
  ...
  factory PrivateEnvironmentConfigResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfigResponse(
      ...
      networkingConfig: NetworkingConfigResponse.fromMap(
