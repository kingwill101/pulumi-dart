...
class EnvironmentComposerV1beta1 extends pulumi.CustomResource {
  ...
  EnvironmentComposerV1beta1(
    ...
    this.config = registerOutput<EnvironmentConfigResponseComposerV1beta1>('config');
    ...
    this.storageConfig = registerOutput<StorageConfigResponseComposerV1beta1>('storageConfig');
