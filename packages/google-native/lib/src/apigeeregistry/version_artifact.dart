...
class VersionArtifact extends pulumi.CustomResource {
  ...
  /// Creates a new [VersionArtifact].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VersionArtifact]. {@macro pulumi_apigeeregistry_v1_version_artifact_args_doc}
