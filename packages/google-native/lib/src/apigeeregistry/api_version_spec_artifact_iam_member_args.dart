...
/// {@template pulumi_apigeeregistry_v1_api_version_spec_artifact_iam_member_args_doc}
/// The set of arguments for ApiVersionSpecArtifactIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_spec_artifact_iam_member_args_doc}
class ApiVersionSpecArtifactIamMemberArgs {
  ...
  /// Creates a new [ApiVersionSpecArtifactIamMemberArgs].
  ...
  ApiVersionSpecArtifactIamMemberArgs({
    Condition? condition,
  ...
  factory ApiVersionSpecArtifactIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionSpecArtifactIamMemberArgs(
