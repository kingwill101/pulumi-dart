...
/// {@template pulumi_apigeeregistry_v1_api_artifact_iam_policy_args_doc}
/// The set of arguments for ApiArtifactIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_artifact_iam_policy_args_doc}
class ApiArtifactIamPolicyArgs {
  ...
  /// Creates a new [ApiArtifactIamPolicyArgs].
  /// [apiId] Required.
  /// [artifactId] Required.
  ...
  factory ApiArtifactIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ApiArtifactIamPolicyArgs(
