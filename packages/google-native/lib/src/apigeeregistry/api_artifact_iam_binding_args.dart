...
/// {@template pulumi_apigeeregistry_v1_api_artifact_iam_binding_args_doc}
/// The set of arguments for ApiArtifactIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_artifact_iam_binding_args_doc}
class ApiArtifactIamBindingArgs {
  ...
  /// Creates a new [ApiArtifactIamBindingArgs].
  ...
  factory ApiArtifactIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiArtifactIamBindingArgs(
