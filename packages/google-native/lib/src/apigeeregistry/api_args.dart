...
class ApiArgs {
  ...
  ApiArgs({
    ...
    String? recommendedVersion,
        ...
        recommendedDeployment =
            pulumi.Input.asOptionalInput<String>(recommendedDeployment),
        recommendedVersion =
            pulumi.Input.asOptionalInput<String>(recommendedVersion);
  ...
  factory ApiArgs.fromMap(Map<String, dynamic> map) {
    return ApiArgs(
      ...
      availability:
          map['availability'] == null ? null : map['availability'] as String,
      description:
      ...
      recommendedDeployment: map['recommendedDeployment'] == null
          ? null
          : map['recommendedDeployment'] as String,
      recommendedVersion: map['recommendedVersion'] == null
          ? null
          : map['recommendedVersion'] as String,
    );
  }
}
