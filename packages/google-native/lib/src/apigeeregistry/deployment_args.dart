...
class DeploymentArgs {
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      accessGuidance: map['accessGuidance'] == null ? null : map['accessGuidance'] as String,
      ...
      apiSpecRevision: map['apiSpecRevision'] == null ? null : map['apiSpecRevision'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      endpointUri: map['endpointUri'] == null ? null : map['endpointUri'] as String,
      externalChannelUri: map['externalChannelUri'] == null ? null : map['externalChannelUri'] as String,
      intendedAudience: map['intendedAudience'] == null ? null : map['intendedAudience'] as String,
