...
/// {@template pulumi_apigeeregistry_v1_api_version_spec_iam_member_args_doc}
/// The set of arguments for ApiVersionSpecIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_spec_iam_member_args_doc}
class ApiVersionSpecIamMemberArgs {
  ...
  /// Creates a new [ApiVersionSpecIamMemberArgs].
  ...
  factory ApiVersionSpecIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionSpecIamMemberArgs(
