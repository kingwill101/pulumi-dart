...
/// Result data returned by getApiVersionSpecIamPolicy.
class GetApiVersionSpecIamPolicyResult {
  ...
  /// Creates a new [GetApiVersionSpecIamPolicyResult].
  ...
  factory GetApiVersionSpecIamPolicyResult.fromMap(Map<String, dynamic> map) {
