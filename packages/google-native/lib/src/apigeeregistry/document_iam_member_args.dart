...
/// {@template pulumi_apigeeregistry_v1_document_iam_member_args_doc}
/// The set of arguments for DocumentIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_document_iam_member_args_doc}
class DocumentIamMemberArgs {
  ...
  /// Creates a new [DocumentIamMemberArgs].
  ...
  factory DocumentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DocumentIamMemberArgs(
