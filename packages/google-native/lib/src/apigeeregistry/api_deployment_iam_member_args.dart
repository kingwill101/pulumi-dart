...
/// {@template pulumi_apigeeregistry_v1_api_deployment_iam_member_args_doc}
/// The set of arguments for ApiDeploymentIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_deployment_iam_member_args_doc}
class ApiDeploymentIamMemberArgs {
  ...
  /// Creates a new [ApiDeploymentIamMemberArgs].
  ...
  factory ApiDeploymentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApiDeploymentIamMemberArgs(
