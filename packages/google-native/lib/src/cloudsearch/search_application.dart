...
class SearchApplication extends pulumi.CustomResource {
  ...
  SearchApplication(
    ...
    this.defaultFacetOptions = registerOutput<List<FacetOptionsResponse>>(
      'defaultFacetOptions',
    );
    this.defaultSortOptions = registerOutput<SortOptionsResponse>(
      'defaultSortOptions',
    );
    ...
    this.returnResultThumbnailUrls = registerOutput<bool>(
      'returnResultThumbnailUrls',
    );
    this.scoringConfig = registerOutput<ScoringConfigResponse>('scoringConfig');
    this.sourceConfig = registerOutput<List<SourceConfigResponse>>(
      'sourceConfig',
    );
  }
}
