...
class DataSource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GSuitePrincipalResponse>> itemsVisibility;
  ...
  DataSource(
    ...
    this.indexingServiceAccounts = registerOutput<List<String>>('indexingServiceAccounts');
    this.itemsVisibility = registerOutput<List<GSuitePrincipalResponse>>('itemsVisibility');
