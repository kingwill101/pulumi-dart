...
class DataSourceArgs {
  ...
  DataSourceArgs({
    ...
    String? shortName,
            ...
            pulumi.Input.asOptionalInput<bool>(disableModifications),
        disableServing = pulumi.Input.asOptionalInput<bool>(disableServing),
        displayName = pulumi.Input.asInput<String>(displayName),
        indexingServiceAccounts =
            pulumi.Input.asOptionalInput<List<String>>(indexingServiceAccounts),
        ...
        returnThumbnailUrls =
            pulumi.Input.asOptionalInput<bool>(returnThumbnailUrls),
  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      disableModifications: map['disableModifications'] == null
          ? null
          : map['disableModifications'] as bool,
      disableServing:
          map['disableServing'] == null ? null : map['disableServing'] as bool,
      displayName: map['displayName'] as String,
      indexingServiceAccounts: map['indexingServiceAccounts'] == null
          ? null
          : (map['indexingServiceAccounts'] as List).cast<String>(),
      itemsVisibility: map['itemsVisibility'] == null
          ? null
          : pulumi.Input.decodeList<GSuitePrincipal>(
              map['itemsVisibility'],
              (value) => GSuitePrincipal.fromMap(
                  (value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      operationIds: map['operationIds'] == null
          ? null
          : (map['operationIds'] as List).cast<String>(),
      returnThumbnailUrls: map['returnThumbnailUrls'] == null
          ? null
          : map['returnThumbnailUrls'] as bool,
