...
class DataSourceArgs {
  ...
  DataSourceArgs({
    ...
    String? shortName,
  }) : disableModifications = pulumi.Input.asOptionalInput<bool>(
       ...
       returnThumbnailUrls = pulumi.Input.asOptionalInput<bool>(
         returnThumbnailUrls,
       ),
  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      ...
      disableServing: map['disableServing'] == null
          ? null
          : map['disableServing'] as bool,
