...
class FacetOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'integerFacetingOptions': ?integerFacetingOptions == null ? null : integerFacetingOptions!.toMap(),
  ...
  factory FacetOptions.fromMap(Map<String, dynamic> map) {
    return FacetOptions(
      integerFacetingOptions: map['integerFacetingOptions'] == null ? null : IntegerFacetingOptions.fromMap((map['integerFacetingOptions'] as Map).cast<String, dynamic>()),
      numFacetBuckets: map['numFacetBuckets'] == null ? null : map['numFacetBuckets'] as int,
