...
class DataSourceRestriction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filterOptions': ?filterOptions == null ? null : pulumi.Input.encodeList<FilterOptions, Map<String, dynamic>>(filterOptions!, (value) => value.toMap()),
  ...
  factory DataSourceRestriction.fromMap(Map<String, dynamic> map) {
    return DataSourceRestriction(
      filterOptions: map['filterOptions'] == null ? null : pulumi.Input.decodeList<FilterOptions>(map['filterOptions'], (value) => FilterOptions.fromMap((value as Map).cast<String, dynamic>())),
