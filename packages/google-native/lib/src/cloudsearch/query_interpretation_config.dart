...
class QueryInterpretationConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final forceDisableSupplementalResultsValue =
        forceDisableSupplementalResults;
    if (forceDisableSupplementalResultsValue != null) {
      map['forceDisableSupplementalResults'] =
          forceDisableSupplementalResultsValue;
    }
    final forceVerbatimModeValue = forceVerbatimMode;
    if (forceVerbatimModeValue != null) {
      map['forceVerbatimMode'] = forceVerbatimModeValue;
    }
    return map;
  }
