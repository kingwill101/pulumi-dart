  ...
  SearchApplicationArgs({
    ...
    List<SourceConfig>? sourceConfig,
        ...
        defaultFacetOptions = pulumi.Input.asOptionalInput<List<FacetOptions>>(
            defaultFacetOptions),
        defaultSortOptions =
            pulumi.Input.asOptionalInput<SortOptions>(defaultSortOptions),
        ...
        returnResultThumbnailUrls =
            pulumi.Input.asOptionalInput<bool>(returnResultThumbnailUrls),
        scoringConfig =
            pulumi.Input.asOptionalInput<ScoringConfig>(scoringConfig),
        sourceConfig =
            pulumi.Input.asOptionalInput<List<SourceConfig>>(sourceConfig);
