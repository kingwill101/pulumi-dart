...
import 'google_cloud_datapipelines_v1_runtime_environment_ip_configuration.dart';
...
class GoogleCloudDatapipelinesV1RuntimeEnvironment {
  ...
  final GoogleCloudDatapipelinesV1RuntimeEnvironmentIpConfiguration?
  ipConfiguration;
  ...
  /// Creates a new [GoogleCloudDatapipelinesV1RuntimeEnvironment].
  ...
  factory GoogleCloudDatapipelinesV1RuntimeEnvironment.fromMap(
    ...
    return GoogleCloudDatapipelinesV1RuntimeEnvironment(
      ...
      ipConfiguration: map['ipConfiguration'] == null
          ? null
          : GoogleCloudDatapipelinesV1RuntimeEnvironmentIpConfiguration.fromValue(
      ...
      tempLocation: map['tempLocation'] == null
          ? null
          : map['tempLocation'] as String,
      workerRegion: map['workerRegion'] == null
          ? null
          : map['workerRegion'] as String,
      workerZone: map['workerZone'] == null
          ? null
          : map['workerZone'] as String,
