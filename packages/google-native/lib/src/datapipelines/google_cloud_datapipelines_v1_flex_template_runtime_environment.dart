...
class GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment {
  ...
  final GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentFlexrsGoal?
  flexrsGoal;

  /// Configuration for VM IPs.
  final GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentIpConfiguration?
  ipConfiguration;
  ...
  factory GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.fromMap(
    ...
    return GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment(
      ...
      flexrsGoal: map['flexrsGoal'] == null
          ? null
          : GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentFlexrsGoal.fromValue(
              map['flexrsGoal'] as String,
            ),
      ipConfiguration: map['ipConfiguration'] == null
          ? null
          : GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentIpConfiguration.fromValue(
