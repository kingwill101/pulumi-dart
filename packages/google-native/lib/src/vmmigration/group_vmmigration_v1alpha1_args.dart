...
class GroupVmmigrationV1alpha1Args {
  ...
  GroupVmmigrationV1alpha1Args({
    ...
    String? location,
    GroupMigrationTargetTypeVmmigrationV1alpha1? migrationTargetType,
    String? project,
    String? requestId,
        ...
        migrationTargetType = pulumi.Input.asOptionalInput<
            GroupMigrationTargetTypeVmmigrationV1alpha1>(migrationTargetType),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (migrationTargetTypeValue != null) {
      map['migrationTargetType'] = pulumi.Input.mapOptionalInputValue<
          GroupMigrationTargetTypeVmmigrationV1alpha1,
          String>(migrationTargetTypeValue, (value) => value.value);
    }
