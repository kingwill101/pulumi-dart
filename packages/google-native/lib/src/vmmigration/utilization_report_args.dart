...
class UtilizationReportArgs {
  ...
  factory UtilizationReportArgs.fromMap(Map<String, dynamic> map) {
    return UtilizationReportArgs(
      ...
      timeFrame: map['timeFrame'] == null ? null : UtilizationReportTimeFrame.fromValue(map['timeFrame'] as String),
      utilizationReportId: map['utilizationReportId'] as String,
      vms: map['vms'] == null ? null : pulumi.Input.decodeList<VmUtilizationInfo>(map['vms'], (value) => VmUtilizationInfo.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
