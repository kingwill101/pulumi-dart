...
class ComputeEngineDisksTargetDetailsResponseVmmigrationV1alpha1 {
  ...
  final DisksMigrationVmTargetDetailsResponseVmmigrationV1alpha1 vmTargetDetails;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'disks': pulumi.Input.encodeList<PersistentDiskResponseVmmigrationV1alpha1, Map<String, dynamic>>(disks, (value) => value.toMap()),
  ...
  factory ComputeEngineDisksTargetDetailsResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return ComputeEngineDisksTargetDetailsResponseVmmigrationV1alpha1(
      disks: pulumi.Input.decodeList<PersistentDiskResponseVmmigrationV1alpha1>(map['disks'], (value) => PersistentDiskResponseVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      disksTargetDetails: (map['disksTargetDetails'] as Map).cast<String, dynamic>(),
      vmTargetDetails: DisksMigrationVmTargetDetailsResponseVmmigrationV1alpha1.fromMap((map['vmTargetDetails'] as Map).cast<String, dynamic>()),
    );
  }
}
