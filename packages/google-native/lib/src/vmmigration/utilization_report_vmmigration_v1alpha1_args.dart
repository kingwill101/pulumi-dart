...
class UtilizationReportVmmigrationV1alpha1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'sourceId': sourceId,
      'timeFrame': ?pulumi.Input.mapOptionalInputValue<UtilizationReportTimeFrameVmmigrationV1alpha1, String>(timeFrame, (value) => value.value),
  ...
  factory UtilizationReportVmmigrationV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return UtilizationReportVmmigrationV1alpha1Args(
      ...
      timeFrame: map['timeFrame'] == null ? null : UtilizationReportTimeFrameVmmigrationV1alpha1.fromValue(map['timeFrame'] as String),
      utilizationReportId: map['utilizationReportId'] as String,
      vms: map['vms'] == null ? null : pulumi.Input.decodeList<VmUtilizationInfoVmmigrationV1alpha1>(map['vms'], (value) => VmUtilizationInfoVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
