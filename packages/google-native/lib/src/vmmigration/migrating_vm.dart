...
class MigratingVm extends pulumi.CustomResource {
  ...
  MigratingVm(
    ...
    this.awsSourceVmDetails = registerOutput<AwsSourceVmDetailsResponse>(
      'awsSourceVmDetails',
    );
    this.azureSourceVmDetails = registerOutput<AzureSourceVmDetailsResponse>(
    ...
    this.currentSyncInfo = registerOutput<ReplicationCycleResponse>(
      'currentSyncInfo',
    );
    this.cutoverForecast = registerOutput<CutoverForecastResponse>(
      'cutoverForecast',
    );
    ...
    this.lastReplicationCycle = registerOutput<ReplicationCycleResponse>(
    ...
    this.recentCloneJobs = registerOutput<List<CloneJobResponse>>(
      'recentCloneJobs',
    );
    this.recentCutoverJobs = registerOutput<List<CutoverJobResponse>>(
      'recentCutoverJobs',
    );
    ...
    this.vmwareSourceVmDetails = registerOutput<VmwareSourceVmDetailsResponse>(
