...
class AwsSourceDetails {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inventoryTagList': ?inventoryTagList == null ? null : pulumi.Input.encodeList<Tag, Map<String, dynamic>>(inventoryTagList!, (value) => value.toMap()),
  ...
  factory AwsSourceDetails.fromMap(Map<String, dynamic> map) {
    return AwsSourceDetails(
      accessKeyCreds: map['accessKeyCreds'] == null ? null : AccessKeyCredentials.fromMap((map['accessKeyCreds'] as Map).cast<String, dynamic>()),
      ...
      inventoryTagList: map['inventoryTagList'] == null ? null : pulumi.Input.decodeList<Tag>(map['inventoryTagList'], (value) => Tag.fromMap((value as Map).cast<String, dynamic>())),
