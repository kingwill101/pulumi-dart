...
class GetCloneJobVmmigrationV1alpha1Result {
  ...
  /// Creates a new [GetCloneJobVmmigrationV1alpha1Result].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['steps'] = pulumi.Input.encodeList<CloneStepResponseVmmigrationV1alpha1,
    ...
    return GetCloneJobVmmigrationV1alpha1Result(
      ...
      computeEngineTargetDetails:
          ComputeEngineTargetDetailsResponseVmmigrationV1alpha1.fromMap(
              (map['computeEngineTargetDetails'] as Map)
                  .cast<String, dynamic>()),
