...
class DatacenterConnectorVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  DatacenterConnectorVmmigrationV1alpha1(
    ...
    this.availableVersions = registerOutput<AvailableUpdatesResponseVmmigrationV1alpha1>('availableVersions');
    ...
    this.upgradeStatus = registerOutput<UpgradeStatusResponseVmmigrationV1alpha1>('upgradeStatus');
