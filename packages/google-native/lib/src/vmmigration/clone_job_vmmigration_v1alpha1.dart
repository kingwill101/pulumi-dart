...
class CloneJobVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  CloneJobVmmigrationV1alpha1(
    ...
    this.computeEngineVmDetails = registerOutput<TargetVMDetailsResponse>(
    ...
    this.steps = registerOutput<List<CloneStepResponseVmmigrationV1alpha1>>(
      'steps',
    );
    this.targetDetails = registerOutput<TargetVMDetailsResponse>(
      'targetDetails',
    );
  }
}
