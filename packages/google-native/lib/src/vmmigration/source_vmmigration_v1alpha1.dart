...
class SourceVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  SourceVmmigrationV1alpha1(
    ...
    this.aws = registerOutput<AwsSourceDetailsResponseVmmigrationV1alpha1>(
      'aws',
    );
    this.azure = registerOutput<AzureSourceDetailsResponseVmmigrationV1alpha1>(
      'azure',
    );
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String>('description');
    this.encryption = registerOutput<EncryptionResponseVmmigrationV1alpha1>(
      'encryption',
    );
