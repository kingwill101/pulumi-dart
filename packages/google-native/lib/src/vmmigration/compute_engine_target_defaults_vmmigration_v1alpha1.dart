...
class ComputeEngineTargetDefaultsVmmigrationV1alpha1 {
  ...
  factory ComputeEngineTargetDefaultsVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return ComputeEngineTargetDefaultsVmmigrationV1alpha1(
      ...
      diskType: map['diskType'] == null ? null : ComputeEngineTargetDefaultsDiskTypeVmmigrationV1alpha1.fromValue(map['diskType'] as String),
      ...
      licenseType: map['licenseType'] == null ? null : ComputeEngineTargetDefaultsLicenseTypeVmmigrationV1alpha1.fromValue(map['licenseType'] as String),
