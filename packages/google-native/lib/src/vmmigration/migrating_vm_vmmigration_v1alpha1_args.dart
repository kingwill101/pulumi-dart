...
class MigratingVmVmmigrationV1alpha1Args {
  ...
  MigratingVmVmmigrationV1alpha1Args({
    ...
    TargetVMDetails? targetDefaults,
        ...
        policy =
            pulumi.Input.asOptionalInput<SchedulePolicyVmmigrationV1alpha1>(
                policy),
        ...
        targetDefaults =
            pulumi.Input.asOptionalInput<TargetVMDetails>(targetDefaults);
  ...
  factory MigratingVmVmmigrationV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return MigratingVmVmmigrationV1alpha1Args(
      ...
      sourceVmId:
          map['sourceVmId'] == null ? null : map['sourceVmId'] as String,
      targetDefaults: map['targetDefaults'] == null
          ? null
          : TargetVMDetails.fromMap(
