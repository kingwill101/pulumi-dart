...
class SourceVmmigrationV1alpha1Args {
  ...
  SourceVmmigrationV1alpha1Args({
    AwsSourceDetailsVmmigrationV1alpha1? aws,
    AzureSourceDetailsVmmigrationV1alpha1? azure,
    String? description,
    EncryptionVmmigrationV1alpha1? encryption,
    Map<String, String>? labels,
    String? location,
    String? project,
    String? requestId,
    required String sourceId,
    VmwareSourceDetailsVmmigrationV1alpha1? vmware,
  }) :
  ...
  factory SourceVmmigrationV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return SourceVmmigrationV1alpha1Args(
      aws: map['aws'] == null ? null : AwsSourceDetailsVmmigrationV1alpha1.fromMap((map['aws'] as Map).cast<String, dynamic>()),
      azure: map['azure'] == null ? null : AzureSourceDetailsVmmigrationV1alpha1.fromMap((map['azure'] as Map).cast<String, dynamic>()),
      ...
      vmware: map['vmware'] == null ? null : VmwareSourceDetailsVmmigrationV1alpha1.fromMap((map['vmware'] as Map).cast<String, dynamic>()),
    );
  }
}
