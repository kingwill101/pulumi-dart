...
class MigratingVmArgs {
  ...
  factory MigratingVmArgs.fromMap(Map<String, dynamic> map) {
    return MigratingVmArgs(
      computeEngineDisksTargetDefaults: map['computeEngineDisksTargetDefaults'] == null ? null : ComputeEngineDisksTargetDefaults.fromMap((map['computeEngineDisksTargetDefaults'] as Map).cast<String, dynamic>()),
      computeEngineTargetDefaults: map['computeEngineTargetDefaults'] == null ? null : ComputeEngineTargetDefaults.fromMap((map['computeEngineTargetDefaults'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      migratingVmId: map['migratingVmId'] as String,
      policy: map['policy'] == null ? null : SchedulePolicy.fromMap((map['policy'] as Map).cast<String, dynamic>()),
