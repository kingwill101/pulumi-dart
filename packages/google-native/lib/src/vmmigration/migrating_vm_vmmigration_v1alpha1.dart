...
class MigratingVmVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<ComputeEngineDisksTargetDefaultsResponseVmmigrationV1alpha1>
      computeEngineDisksTargetDefaults;

  /// Details of the target VM in Compute Engine.
  late final pulumi
      .Output<ComputeEngineTargetDefaultsResponseVmmigrationV1alpha1>
  ...
  late final pulumi.Output<List<CloneJobResponseVmmigrationV1alpha1>>
      recentCloneJobs;
  ...
  late final pulumi.Output<List<CutoverJobResponseVmmigrationV1alpha1>>
      recentCutoverJobs;
  ...
  MigratingVmVmmigrationV1alpha1(
    ...
    this.azureSourceVmDetails =
        registerOutput<AzureSourceVmDetailsResponseVmmigrationV1alpha1>(
            'azureSourceVmDetails');
    this.computeEngineDisksTargetDefaults = registerOutput<
    ...
    this.lastReplicationCycle =
        registerOutput<ReplicationCycleResponseVmmigrationV1alpha1>(
            'lastReplicationCycle');
    this.lastSync =
        registerOutput<ReplicationSyncResponseVmmigrationV1alpha1>('lastSync');
    this.location = registerOutput<String>('location');
    this.migratingVmId = registerOutput<String>('migratingVmId');
    this.name = registerOutput<String>('name');
    this.policy =
        registerOutput<SchedulePolicyResponseVmmigrationV1alpha1>('policy');
    this.project = registerOutput<String>('project');
    this.recentCloneJobs =
        registerOutput<List<CloneJobResponseVmmigrationV1alpha1>>(
            'recentCloneJobs');
    this.recentCutoverJobs =
        registerOutput<List<CutoverJobResponseVmmigrationV1alpha1>>(
            'recentCutoverJobs');
