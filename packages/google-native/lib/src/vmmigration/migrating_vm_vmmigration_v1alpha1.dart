...
class MigratingVmVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  MigratingVmVmmigrationV1alpha1(
    ...
    this.computeEngineVmDefaults = registerOutput<TargetVMDetailsResponse>(
    ...
    this.lastSync = registerOutput<ReplicationSyncResponseVmmigrationV1alpha1>(
      'lastSync',
    );
    this.location = registerOutput<String>('location');
    this.migratingVmId = registerOutput<String>('migratingVmId');
    this.name = registerOutput<String>('name');
    this.policy = registerOutput<SchedulePolicyResponseVmmigrationV1alpha1>(
      'policy',
    );
    ...
    this.targetDefaults = registerOutput<TargetVMDetailsResponse>(
      'targetDefaults',
    );
