...
class DatacenterConnector extends pulumi.CustomResource {
  ...
  DatacenterConnector(
    ...
    this.applianceInfrastructureVersion = registerOutput<String>('applianceInfrastructureVersion');
    this.applianceSoftwareVersion = registerOutput<String>('applianceSoftwareVersion');
    this.availableVersions = registerOutput<AvailableUpdatesResponse>('availableVersions');
    this.bucket = registerOutput<String>('bucket');
    this.createTime = registerOutput<String>('createTime');
    this.datacenterConnectorId = registerOutput<String>('datacenterConnectorId');
