...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    int? processingUnits,
    String? project,
  }) : autoscalingConfig = pulumi.Input.asOptionalInput<AutoscalingConfig>(
         autoscalingConfig,
       ),
       config = pulumi.Input.asInput<String>(config),
       displayName = pulumi.Input.asInput<String>(displayName),
       endpointUris = pulumi.Input.asOptionalInput<List<String>>(endpointUris),
       freeInstanceMetadata = pulumi
           .Input.asOptionalInput<FreeInstanceMetadata>(freeInstanceMetadata),
    ...
    return <String, dynamic>{
      ...
      'freeInstanceMetadata':
          ?pulumi.Input.mapOptionalInputValue<
            FreeInstanceMetadata,
            Map<String, dynamic>
          >(freeInstanceMetadata, (value) => value.toMap()),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      processingUnits: map['processingUnits'] == null
          ? null
          : map['processingUnits'] as int,
