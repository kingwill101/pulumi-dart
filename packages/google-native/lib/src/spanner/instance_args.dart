...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      autoscalingConfig: map['autoscalingConfig'] == null ? null : AutoscalingConfig.fromMap((map['autoscalingConfig'] as Map).cast<String, dynamic>()),
      config: map['config'] as String,
      displayName: map['displayName'] as String,
      endpointUris: map['endpointUris'] == null ? null : (map['endpointUris'] as List).cast<String>(),
      freeInstanceMetadata: map['freeInstanceMetadata'] == null ? null : FreeInstanceMetadata.fromMap((map['freeInstanceMetadata'] as Map).cast<String, dynamic>()),
      instanceId: map['instanceId'] as String,
      instanceType: map['instanceType'] == null ? null : InstanceInstanceType.fromValue(map['instanceType'] as String),
