...
class Backup extends pulumi.CustomResource {
  ...
  Backup(
    ...
    this.encryptionConfigEncryptionType = registerOutput<String>('encryptionConfigEncryptionType');
    this.encryptionConfigKmsKeyName = registerOutput<String?>('encryptionConfigKmsKeyName');
    ...
    this.referencingBackups = registerOutput<List<String>>('referencingBackups');
    this.referencingDatabases = registerOutput<List<String>>('referencingDatabases');
