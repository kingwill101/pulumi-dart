...
class BackupArgs {
  ...
  BackupArgs({
    ...
    String? versionTime,
        ...
        encryptionConfigEncryptionType =
            pulumi.Input.asInput<String>(encryptionConfigEncryptionType),
        encryptionConfigKmsKeyName =
            pulumi.Input.asOptionalInput<String>(encryptionConfigKmsKeyName),
  ...
  factory BackupArgs.fromMap(Map<String, dynamic> map) {
    return BackupArgs(
      ...
      versionTime:
          map['versionTime'] == null ? null : map['versionTime'] as String,
    );
  }
}
