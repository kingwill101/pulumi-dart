...
class BackupArgs {
  ...
  BackupArgs({
    ...
    String? versionTime,
       ...
       encryptionConfigEncryptionType = pulumi.Input.asInput<String>(
         encryptionConfigEncryptionType,
       ),
       encryptionConfigKmsKeyName = pulumi.Input.asOptionalInput<String>(
  ...
  factory BackupArgs.fromMap(Map<String, dynamic> map) {
    return BackupArgs(
      ...
      encryptionConfigKmsKeyName: map['encryptionConfigKmsKeyName'] == null
          ? null
          : map['encryptionConfigKmsKeyName'] as String,
      ...
      versionTime: map['versionTime'] == null
          ? null
          : map['versionTime'] as String,
    );
  }
}
