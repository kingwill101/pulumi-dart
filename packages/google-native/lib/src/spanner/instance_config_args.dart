...
class InstanceConfigArgs {
  ...
  factory InstanceConfigArgs.fromMap(Map<String, dynamic> map) {
    return InstanceConfigArgs(
      baseConfig: map['baseConfig'] == null ? null : map['baseConfig'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      instanceConfigId: map['instanceConfigId'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      leaderOptions: map['leaderOptions'] == null ? null : (map['leaderOptions'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      replicas: map['replicas'] == null ? null : pulumi.Input.decodeList<ReplicaInfo>(map['replicas'], (value) => ReplicaInfo.fromMap((value as Map).cast<String, dynamic>())),
