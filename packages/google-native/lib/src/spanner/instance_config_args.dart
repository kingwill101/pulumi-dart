...
class InstanceConfigArgs {
  ...
  InstanceConfigArgs({
    ...
    bool? validateOnly,
       ...
       leaderOptions = pulumi.Input.asOptionalInput<List<String>>(
         leaderOptions,
       ),
    ...
    return <String, dynamic>{
      ...
      'replicas':
          ...
          >(
            replicas,
            (value) =>
                pulumi.Input.encodeList<ReplicaInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory InstanceConfigArgs.fromMap(Map<String, dynamic> map) {
    return InstanceConfigArgs(
      baseConfig: map['baseConfig'] == null
          ? null
          : map['baseConfig'] as String,
