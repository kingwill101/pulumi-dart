...
class InstanceConfigArgs {
  ...
  InstanceConfigArgs({
    ...
    bool? validateOnly,
        ...
        leaderOptions =
            pulumi.Input.asOptionalInput<List<String>>(leaderOptions),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (replicasValue != null) {
      map['replicas'] = pulumi.Input.mapOptionalInputValue<List<ReplicaInfo>,
              List<Map<String, dynamic>>>(
          replicasValue,
          (value) => pulumi.Input.encodeList<ReplicaInfo, Map<String, dynamic>>(
  ...
  factory InstanceConfigArgs.fromMap(Map<String, dynamic> map) {
    return InstanceConfigArgs(
      baseConfig:
          map['baseConfig'] == null ? null : map['baseConfig'] as String,
      displayName:
      ...
      leaderOptions: map['leaderOptions'] == null
          ? null
          : (map['leaderOptions'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      replicas: map['replicas'] == null
          ? null
          : pulumi.Input.decodeList<ReplicaInfo>(
              map['replicas'],
              (value) =>
                  ReplicaInfo.fromMap((value as Map).cast<String, dynamic>())),
      validateOnly:
