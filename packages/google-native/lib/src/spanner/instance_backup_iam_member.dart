...
import 'instance_backup_iam_member_args.dart';
...
class InstanceBackupIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [InstanceBackupIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceBackupIamMember]. {@macro pulumi_spanner_v1_instance_backup_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceBackupIamMember(
    String name, {
    InstanceBackupIamMemberArgs? args,
