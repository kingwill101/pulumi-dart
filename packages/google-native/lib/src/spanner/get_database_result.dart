...
class GetDatabaseResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['encryptionInfo'] =
        pulumi.Input.encodeList<EncryptionInfoResponse, Map<String, dynamic>>(
  ...
  factory GetDatabaseResult.fromMap(Map<String, dynamic> map) {
    return GetDatabaseResult(
      ...
      encryptionInfo: pulumi.Input.decodeList<EncryptionInfoResponse>(
          map['encryptionInfo'],
          (value) => EncryptionInfoResponse.fromMap(
