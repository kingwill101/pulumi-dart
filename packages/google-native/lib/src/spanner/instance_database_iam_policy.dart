...
import 'instance_database_iam_policy_args.dart';
...
class InstanceDatabaseIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [InstanceDatabaseIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceDatabaseIamPolicy]. {@macro pulumi_spanner_v1_instance_database_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceDatabaseIamPolicy(
    String name, {
    InstanceDatabaseIamPolicyArgs? args,
