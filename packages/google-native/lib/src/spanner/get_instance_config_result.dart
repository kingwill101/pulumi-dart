...
class GetInstanceConfigResult {
  ...
  /// Creates a new [GetInstanceConfigResult].
  ...
  /// [configType] Whether this instance config is a Google or User Managed Configuration.
  ...
  /// [freeInstanceAvailability] Describes whether free instances are available to be created in this instance config.
  ...
  /// [optionalReplicas] The available optional replicas to choose from for user managed configurations. Populated for Google managed configurations.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'optionalReplicas': pulumi.Input.encodeList<ReplicaInfoResponse, Map<String, dynamic>>(optionalReplicas, (value) => value.toMap()),
      'reconciling': reconciling,
      'replicas': pulumi.Input.encodeList<ReplicaInfoResponse, Map<String, dynamic>>(replicas, (value) => value.toMap()),
      'state': state,
    };
  }
  ...
  factory GetInstanceConfigResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceConfigResult(
      ...
      optionalReplicas: pulumi.Input.decodeList<ReplicaInfoResponse>(map['optionalReplicas'], (value) => ReplicaInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
      reconciling: map['reconciling'] as bool,
      replicas: pulumi.Input.decodeList<ReplicaInfoResponse>(map['replicas'], (value) => ReplicaInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
