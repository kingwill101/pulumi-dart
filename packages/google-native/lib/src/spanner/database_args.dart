...
class DatabaseArgs {
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      ...
      databaseDialect: map['databaseDialect'] == null ? null : DatabaseDatabaseDialect.fromValue(map['databaseDialect'] as String),
      encryptionConfig: map['encryptionConfig'] == null ? null : EncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      extraStatements: map['extraStatements'] == null ? null : (map['extraStatements'] as List).cast<String>(),
      instanceId: map['instanceId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      protoDescriptors: map['protoDescriptors'] == null ? null : map['protoDescriptors'] as String,
    );
  }
}
