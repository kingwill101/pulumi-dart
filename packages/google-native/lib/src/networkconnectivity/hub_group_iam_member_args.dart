...
/// {@template pulumi_networkconnectivity_v1_hub_group_iam_member_args_doc}
/// The set of arguments for HubGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_hub_group_iam_member_args_doc}
class HubGroupIamMemberArgs {
  ...
  /// Creates a new [HubGroupIamMemberArgs].
  ...
  factory HubGroupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return HubGroupIamMemberArgs(
