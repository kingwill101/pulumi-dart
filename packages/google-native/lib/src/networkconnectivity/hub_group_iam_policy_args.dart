...
/// {@template pulumi_networkconnectivity_v1_hub_group_iam_policy_args_doc}
/// The set of arguments for HubGroupIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_hub_group_iam_policy_args_doc}
class HubGroupIamPolicyArgs {
  ...
  /// Creates a new [HubGroupIamPolicyArgs].
  ...
  factory HubGroupIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return HubGroupIamPolicyArgs(
