...
class ServiceConnectionPolicyArgs {
  ...
  factory ServiceConnectionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionPolicyArgs(
      ...
      serviceClass: map['serviceClass'] == null ? null : map['serviceClass'] as String,
      serviceConnectionPolicyId: map['serviceConnectionPolicyId'] == null ? null : map['serviceConnectionPolicyId'] as String,
    );
  }
}
