...
import 'internal_range_networkconnectivity_v1alpha1_args.dart';

/// Creates a new internal range in a given project and location.
class InternalRangeNetworkconnectivityV1alpha1 extends pulumi.CustomResource {
  ...
  /// Creates a new [InternalRangeNetworkconnectivityV1alpha1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InternalRangeNetworkconnectivityV1alpha1]. {@macro pulumi_networkconnectivity_v1alpha1_internal_range_networkconnectivity_v1alpha1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InternalRangeNetworkconnectivityV1alpha1(
    String name, {
    InternalRangeNetworkconnectivityV1alpha1Args? args,
