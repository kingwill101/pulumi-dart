...
class ServiceConnectionMapArgs {
  ...
  factory ServiceConnectionMapArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionMapArgs(
      consumerPscConfigs: map['consumerPscConfigs'] == null ? null : pulumi.Input.decodeList<ConsumerPscConfig>(map['consumerPscConfigs'], (value) => ConsumerPscConfig.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      producerPscConfigs: map['producerPscConfigs'] == null ? null : pulumi.Input.decodeList<ProducerPscConfig>(map['producerPscConfigs'], (value) => ProducerPscConfig.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      serviceClass: map['serviceClass'] == null ? null : map['serviceClass'] as String,
      serviceConnectionMapId: map['serviceConnectionMapId'] == null ? null : map['serviceConnectionMapId'] as String,
