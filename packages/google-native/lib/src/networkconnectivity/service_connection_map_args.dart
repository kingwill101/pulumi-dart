...
class ServiceConnectionMapArgs {
  ...
  ServiceConnectionMapArgs({
    ...
    String? token,
  }) : consumerPscConfigs = pulumi
           .Input.asOptionalInput<List<ConsumerPscConfig>>(consumerPscConfigs),
       description = pulumi.Input.asOptionalInput<String>(description),
       etag = pulumi.Input.asOptionalInput<String>(etag),
       labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
       location = pulumi.Input.asOptionalInput<String>(location),
       name = pulumi.Input.asOptionalInput<String>(name),
       producerPscConfigs = pulumi
           .Input.asOptionalInput<List<ProducerPscConfig>>(producerPscConfigs),
       project = pulumi.Input.asOptionalInput<String>(project),
       requestId = pulumi.Input.asOptionalInput<String>(requestId),
       serviceClass = pulumi.Input.asOptionalInput<String>(serviceClass),
       serviceConnectionMapId = pulumi.Input.asOptionalInput<String>(
