...
class SpokeIamPolicyNetworkconnectivityV1alpha1Args {
  ...
  final pulumi.Input<List<AuditConfigNetworkconnectivityV1alpha1>>?
      auditConfigs;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigNetworkconnectivityV1alpha1>,
    ...
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingNetworkconnectivityV1alpha1>,
              List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingNetworkconnectivityV1alpha1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory SpokeIamPolicyNetworkconnectivityV1alpha1Args.fromMap(
      Map<String, dynamic> map) {
    return SpokeIamPolicyNetworkconnectivityV1alpha1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigNetworkconnectivityV1alpha1>(
              map['auditConfigs'],
              (value) => AuditConfigNetworkconnectivityV1alpha1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingNetworkconnectivityV1alpha1>(
              map['bindings'],
              (value) => BindingNetworkconnectivityV1alpha1.fromMap(
                  (value as Map).cast<String, dynamic>())),
