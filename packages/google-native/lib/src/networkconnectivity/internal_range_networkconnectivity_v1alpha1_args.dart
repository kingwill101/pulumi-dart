...
class InternalRangeNetworkconnectivityV1alpha1Args {
  ...
  final pulumi.Input<List<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>>? overlaps;
  ...
  InternalRangeNetworkconnectivityV1alpha1Args({
    ...
    String? name,
    String? network,
    List<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>? overlaps,
    InternalRangePeeringNetworkconnectivityV1alpha1? peering,
    int? prefixLength,
    String? project,
    String? requestId,
    List<String>? targetCidrRange,
    String? updateTime,
    InternalRangeUsageNetworkconnectivityV1alpha1? usage,
  }) :
      ...
      overlaps = pulumi.Input.asOptionalInput<List<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>>(overlaps),
      peering = pulumi.Input.asOptionalInput<InternalRangePeeringNetworkconnectivityV1alpha1>(peering),
      ...
      usage = pulumi.Input.asOptionalInput<InternalRangeUsageNetworkconnectivityV1alpha1>(usage);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'overlaps': ?pulumi.Input.mapOptionalInputValue<List<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>, List<String>>(overlaps, (value) => pulumi.Input.encodeList<InternalRangeOverlapsItemNetworkconnectivityV1alpha1, String>(value, (value) => value.value)),
      'peering': ?pulumi.Input.mapOptionalInputValue<InternalRangePeeringNetworkconnectivityV1alpha1, String>(peering, (value) => value.value),
      'prefixLength': ?prefixLength,
      'project': ?project,
      'requestId': ?requestId,
      'targetCidrRange': ?targetCidrRange,
      'updateTime': ?updateTime,
      'usage': ?pulumi.Input.mapOptionalInputValue<InternalRangeUsageNetworkconnectivityV1alpha1, String>(usage, (value) => value.value),
    };
  }
  ...
  factory InternalRangeNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return InternalRangeNetworkconnectivityV1alpha1Args(
      ...
      internalRangeId: map['internalRangeId'] == null ? null : map['internalRangeId'] as String,
      ipCidrRange: map['ipCidrRange'] == null ? null : map['ipCidrRange'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      overlaps: map['overlaps'] == null ? null : pulumi.Input.decodeList<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>(map['overlaps'], (value) => InternalRangeOverlapsItemNetworkconnectivityV1alpha1.fromValue(value as String)),
      peering: map['peering'] == null ? null : InternalRangePeeringNetworkconnectivityV1alpha1.fromValue(map['peering'] as String),
      prefixLength: map['prefixLength'] == null ? null : map['prefixLength'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      targetCidrRange: map['targetCidrRange'] == null ? null : (map['targetCidrRange'] as List).cast<String>(),
      updateTime: map['updateTime'] == null ? null : map['updateTime'] as String,
      usage: map['usage'] == null ? null : InternalRangeUsageNetworkconnectivityV1alpha1.fromValue(map['usage'] as String),
    );
  }
}
