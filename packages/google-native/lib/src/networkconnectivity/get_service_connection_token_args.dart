...
class GetServiceConnectionTokenArgs {
  ...
  GetServiceConnectionTokenArgs({
    ...
    String? project,
    required String serviceConnectionTokenId,
  }) : location = pulumi.Input.asInput<String>(location),
       project = pulumi.Input.asOptionalInput<String>(project),
       serviceConnectionTokenId = pulumi.Input.asInput<String>(
  ...
  factory GetServiceConnectionTokenArgs.fromMap(Map<String, dynamic> map) {
    return GetServiceConnectionTokenArgs(
      ...
      serviceConnectionTokenId: map['serviceConnectionTokenId'] as String,
    );
  }
}
