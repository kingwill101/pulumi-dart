...
class InternalRangeArgs {
  ...
  InternalRangeArgs({
    ...
    InternalRangeUsage? usage,
       ...
       overlaps = pulumi.Input.asOptionalInput<List<InternalRangeOverlapsItem>>(
         overlaps,
       ),
       ...
       targetCidrRange = pulumi.Input.asOptionalInput<List<String>>(
         targetCidrRange,
       ),
    ...
    return <String, dynamic>{
      ...
      'overlaps':
          ?pulumi.Input.mapOptionalInputValue<
            List<InternalRangeOverlapsItem>,
            List<String>
          >(
            overlaps,
            (value) =>
                pulumi.Input.encodeList<InternalRangeOverlapsItem, String>(
                  value,
                  (value) => value.value,
                ),
          ),
      ...
      'usage': ?pulumi.Input.mapOptionalInputValue<InternalRangeUsage, String>(
        usage,
        (value) => value.value,
      ),
    };
  ...
  factory InternalRangeArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeArgs(
      ...
      overlaps: map['overlaps'] == null
          ? null
          : pulumi.Input.decodeList<InternalRangeOverlapsItem>(
              map['overlaps'],
