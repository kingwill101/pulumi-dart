...
class InternalRangeArgs {
  ...
  factory InternalRangeArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeArgs(
      ...
      overlaps: map['overlaps'] == null ? null : pulumi.Input.decodeList<InternalRangeOverlapsItem>(map['overlaps'], (value) => InternalRangeOverlapsItem.fromValue(value as String)),
      peering: map['peering'] == null ? null : InternalRangePeering.fromValue(map['peering'] as String),
      ...
      usage: map['usage'] == null ? null : InternalRangeUsage.fromValue(map['usage'] as String),
    );
  }
}
