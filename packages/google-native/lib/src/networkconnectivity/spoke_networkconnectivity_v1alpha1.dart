...
class SpokeNetworkconnectivityV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RouterApplianceInstanceResponseNetworkconnectivityV1alpha1>> linkedRouterApplianceInstances;
  ...
  SpokeNetworkconnectivityV1alpha1(
    ...
    this.linkedInterconnectAttachments = registerOutput<List<String>>('linkedInterconnectAttachments');
    this.linkedRouterApplianceInstances = registerOutput<List<RouterApplianceInstanceResponseNetworkconnectivityV1alpha1>>('linkedRouterApplianceInstances');
