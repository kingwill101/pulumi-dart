...
class ServiceConnectionMap extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ConsumerPscConnectionResponse>> consumerPscConnections;
  ...
  ServiceConnectionMap(
    ...
    this.consumerPscConfigs = registerOutput<List<ConsumerPscConfigResponse>>('consumerPscConfigs');
    this.consumerPscConnections = registerOutput<List<ConsumerPscConnectionResponse>>('consumerPscConnections');
    ...
    this.producerPscConfigs = registerOutput<List<ProducerPscConfigResponse>>('producerPscConfigs');
