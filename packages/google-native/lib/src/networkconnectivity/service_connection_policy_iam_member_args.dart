...
/// {@template pulumi_networkconnectivity_v1_service_connection_policy_iam_member_args_doc}
/// The set of arguments for ServiceConnectionPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_service_connection_policy_iam_member_args_doc}
class ServiceConnectionPolicyIamMemberArgs {
  ...
  /// Creates a new [ServiceConnectionPolicyIamMemberArgs].
  ...
  ServiceConnectionPolicyIamMemberArgs({
    Condition? condition,
  ...
  factory ServiceConnectionPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionPolicyIamMemberArgs(
