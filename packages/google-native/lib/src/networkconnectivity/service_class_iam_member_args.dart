...
/// {@template pulumi_networkconnectivity_v1_service_class_iam_member_args_doc}
/// The set of arguments for ServiceClassIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_service_class_iam_member_args_doc}
class ServiceClassIamMemberArgs {
  ...
  /// Creates a new [ServiceClassIamMemberArgs].
  ...
  factory ServiceClassIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceClassIamMemberArgs(
