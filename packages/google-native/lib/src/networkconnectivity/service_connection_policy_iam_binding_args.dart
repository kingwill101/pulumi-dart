...
/// {@template pulumi_networkconnectivity_v1_service_connection_policy_iam_binding_args_doc}
/// The set of arguments for ServiceConnectionPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_service_connection_policy_iam_binding_args_doc}
class ServiceConnectionPolicyIamBindingArgs {
  ...
  /// Creates a new [ServiceConnectionPolicyIamBindingArgs].
  ...
  ServiceConnectionPolicyIamBindingArgs({
    Condition? condition,
  ...
  factory ServiceConnectionPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionPolicyIamBindingArgs(
