...
class SpokeArgs {
    ...
    required String spokeId,
        ...
        linkedRouterApplianceInstances =
            pulumi.Input.asOptionalInput<LinkedRouterApplianceInstances>(
                linkedRouterApplianceInstances),
        linkedVpcNetwork =
            pulumi.Input.asOptionalInput<LinkedVpcNetwork>(linkedVpcNetwork),
        linkedVpnTunnels =
            pulumi.Input.asOptionalInput<LinkedVpnTunnels>(linkedVpnTunnels),
  ...
  factory SpokeArgs.fromMap(Map<String, dynamic> map) {
    return SpokeArgs(
      ...
      linkedInterconnectAttachments:
          map['linkedInterconnectAttachments'] == null
              ? null
              : LinkedInterconnectAttachments.fromMap(
                  (map['linkedInterconnectAttachments'] as Map)
                      .cast<String, dynamic>()),
      linkedRouterApplianceInstances:
          map['linkedRouterApplianceInstances'] == null
              ? null
              : LinkedRouterApplianceInstances.fromMap(
                  (map['linkedRouterApplianceInstances'] as Map)
                      .cast<String, dynamic>()),
      linkedVpcNetwork: map['linkedVpcNetwork'] == null
          ? null
          : LinkedVpcNetwork.fromMap(
              (map['linkedVpcNetwork'] as Map).cast<String, dynamic>()),
      linkedVpnTunnels: map['linkedVpnTunnels'] == null
          ? null
          : LinkedVpnTunnels.fromMap(
