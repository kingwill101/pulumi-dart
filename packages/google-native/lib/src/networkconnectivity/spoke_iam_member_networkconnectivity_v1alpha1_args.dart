...
/// {@template pulumi_networkconnectivity_v1alpha1_spoke_iam_member_networkconnectivity_v1alpha1_args_doc}
/// The set of arguments for SpokeIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1alpha1_spoke_iam_member_networkconnectivity_v1alpha1_args_doc}
class SpokeIamMemberNetworkconnectivityV1alpha1Args {
  ...
  /// Creates a new [SpokeIamMemberNetworkconnectivityV1alpha1Args].
  ...
  SpokeIamMemberNetworkconnectivityV1alpha1Args({
    Condition? condition,
  ...
  factory SpokeIamMemberNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return SpokeIamMemberNetworkconnectivityV1alpha1Args(
