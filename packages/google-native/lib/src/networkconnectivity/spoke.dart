...
class Spoke extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LinkedInterconnectAttachmentsResponse>
  linkedInterconnectAttachments;

  /// Router appliance instances that are associated with the spoke.
  late final pulumi.Output<LinkedRouterApplianceInstancesResponse>
  ...
  Spoke(String name, {SpokeArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.linkedVpcNetwork = registerOutput<LinkedVpcNetworkResponse>(
      'linkedVpcNetwork',
    );
    this.linkedVpnTunnels = registerOutput<LinkedVpnTunnelsResponse>(
      'linkedVpnTunnels',
    );
