...
class ScanConfig extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ScanConfig]. {@macro pulumi_websecurityscanner_v1_scan_config_args_doc}
  ...
  ScanConfig(
    ...
    this.authentication = registerOutput<AuthenticationResponse>(
      'authentication',
    );
    ...
    this.ignoreHttpStatusErrors = registerOutput<bool>(
    ...
    this.schedule = registerOutput<ScheduleResponse>('schedule');
