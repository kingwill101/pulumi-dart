...
class ScanRun {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endTime': ?endTime,
      'executionState': ?executionState == null ? null : executionState!.value,
      'hasVulnerabilities': ?hasVulnerabilities,
      'name': ?name,
      'progressPercent': ?progressPercent,
      'resultState': ?resultState == null ? null : resultState!.value,
      'startTime': ?startTime,
  ...
  factory ScanRun.fromMap(Map<String, dynamic> map) {
    return ScanRun(
      ...
      executionState: map['executionState'] == null ? null : ScanRunExecutionState.fromValue(map['executionState'] as String),
      hasVulnerabilities: map['hasVulnerabilities'] == null ? null : map['hasVulnerabilities'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      progressPercent: map['progressPercent'] == null ? null : map['progressPercent'] as int,
      resultState: map['resultState'] == null ? null : ScanRunResultState.fromValue(map['resultState'] as String),
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      urlsCrawledCount: map['urlsCrawledCount'] == null ? null : map['urlsCrawledCount'] as String,
      urlsTestedCount: map['urlsTestedCount'] == null ? null : map['urlsTestedCount'] as String,
    );
  }
}
