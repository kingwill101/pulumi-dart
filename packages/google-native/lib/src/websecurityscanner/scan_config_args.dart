...
class ScanConfigArgs {
  ...
  factory ScanConfigArgs.fromMap(Map<String, dynamic> map) {
    return ScanConfigArgs(
      ...
      exportToSecurityCommandCenter: map['exportToSecurityCommandCenter'] == null ? null : ScanConfigExportToSecurityCommandCenter.fromValue(map['exportToSecurityCommandCenter'] as String),
      ...
      riskLevel: map['riskLevel'] == null ? null : ScanConfigRiskLevel.fromValue(map['riskLevel'] as String),
      ...
      userAgent: map['userAgent'] == null ? null : ScanConfigUserAgent.fromValue(map['userAgent'] as String),
    );
  }
}
