...
class CertificateArgs {
  ...
  CertificateArgs({
    ...
    CertificateSubjectMode? subjectMode,
        ...
        certificateTemplate =
            pulumi.Input.asOptionalInput<String>(certificateTemplate),
        config = pulumi.Input.asOptionalInput<CertificateConfig>(config),
        issuingCertificateAuthorityId =
            pulumi.Input.asOptionalInput<String>(issuingCertificateAuthorityId),
        ...
        subjectMode =
            pulumi.Input.asOptionalInput<CertificateSubjectMode>(subjectMode);
  ...
  factory CertificateArgs.fromMap(Map<String, dynamic> map) {
    return CertificateArgs(
      ...
      certificateTemplate: map['certificateTemplate'] == null
          ? null
      ...
      issuingCertificateAuthorityId:
          map['issuingCertificateAuthorityId'] == null
              ? null
              : map['issuingCertificateAuthorityId'] as String,
      ...
      subjectMode: map['subjectMode'] == null
          ? null
          : CertificateSubjectMode.fromValue(map['subjectMode'] as String),
    );
  }
}
