...
class CertificateTemplate extends pulumi.CustomResource {
  ...
  CertificateTemplate(
    ...
    this.certificateTemplateId = registerOutput<String>('certificateTemplateId');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String>('description');
    this.identityConstraints = registerOutput<CertificateIdentityConstraintsResponse>('identityConstraints');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.maximumLifetime = registerOutput<String>('maximumLifetime');
    this.name = registerOutput<String>('name');
    this.passthroughExtensions = registerOutput<CertificateExtensionConstraintsResponse>('passthroughExtensions');
    this.predefinedValues = registerOutput<X509ParametersResponse>('predefinedValues');
