...
class IssuancePolicyResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowedKeyTypes': pulumi.Input.encodeList<AllowedKeyTypeResponse, Map<String, dynamic>>(allowedKeyTypes, (value) => value.toMap()),
  ...
  factory IssuancePolicyResponse.fromMap(Map<String, dynamic> map) {
    return IssuancePolicyResponse(
      allowedIssuanceModes: IssuanceModesResponse.fromMap((map['allowedIssuanceModes'] as Map).cast<String, dynamic>()),
      allowedKeyTypes: pulumi.Input.decodeList<AllowedKeyTypeResponse>(map['allowedKeyTypes'], (value) => AllowedKeyTypeResponse.fromMap((value as Map).cast<String, dynamic>())),
      baselineValues: X509ParametersResponse.fromMap((map['baselineValues'] as Map).cast<String, dynamic>()),
      identityConstraints: CertificateIdentityConstraintsResponse.fromMap((map['identityConstraints'] as Map).cast<String, dynamic>()),
      maximumLifetime: map['maximumLifetime'] as String,
      passthroughExtensions: CertificateExtensionConstraintsResponse.fromMap((map['passthroughExtensions'] as Map).cast<String, dynamic>()),
    );
  }
}
