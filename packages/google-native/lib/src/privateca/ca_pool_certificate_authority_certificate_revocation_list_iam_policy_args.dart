...
class CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs {
  ...
  CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs({
    ...
    String? updateMask,
    int? version,
  }) : auditConfigs = pulumi.Input.asOptionalInput<List<AuditConfig>>(
         auditConfigs,
       ),
    ...
    return <String, dynamic>{
      'auditConfigs':
          ...
          >(
            auditConfigs,
            (value) =>
                pulumi.Input.encodeList<AuditConfig, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs.fromMap(
