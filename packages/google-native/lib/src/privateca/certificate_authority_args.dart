...
class CertificateAuthorityArgs {
  ...
  factory CertificateAuthorityArgs.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityArgs(
      ...
      config: CertificateConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      gcsBucket: map['gcsBucket'] == null ? null : map['gcsBucket'] as String,
      keySpec: KeyVersionSpec.fromMap((map['keySpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      lifetime: map['lifetime'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      subordinateConfig: map['subordinateConfig'] == null ? null : SubordinateConfig.fromMap((map['subordinateConfig'] as Map).cast<String, dynamic>()),
