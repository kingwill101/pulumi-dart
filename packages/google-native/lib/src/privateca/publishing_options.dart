...
class PublishingOptions {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (encodingFormatValue != null) {
      map['encodingFormat'] = encodingFormatValue.value;
    }
    final publishCaCertValue = publishCaCert;
    if (publishCaCertValue != null) {
      map['publishCaCert'] = publishCaCertValue;
    }
    final publishCrlValue = publishCrl;
    if (publishCrlValue != null) {
      map['publishCrl'] = publishCrlValue;
    }
    return map;
  }
  ...
  factory PublishingOptions.fromMap(Map<String, dynamic> map) {
    return PublishingOptions(
      encodingFormat: map['encodingFormat'] == null
          ? null
          : PublishingOptionsEncodingFormat.fromValue(
              map['encodingFormat'] as String),
      publishCaCert:
          map['publishCaCert'] == null ? null : map['publishCaCert'] as bool,
