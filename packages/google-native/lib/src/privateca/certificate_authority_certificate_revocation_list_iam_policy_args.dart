...
class CertificateAuthorityCertificateRevocationListIamPolicyArgs {
  ...
  CertificateAuthorityCertificateRevocationListIamPolicyArgs({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigPrivatecaV1beta1>>(
                auditConfigs),
        bindings = pulumi.Input.asOptionalInput<List<BindingPrivatecaV1beta1>>(
            bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigPrivatecaV1beta1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigPrivatecaV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingPrivatecaV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingPrivatecaV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory CertificateAuthorityCertificateRevocationListIamPolicyArgs.fromMap(
      Map<String, dynamic> map) {
    return CertificateAuthorityCertificateRevocationListIamPolicyArgs(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigPrivatecaV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigPrivatecaV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingPrivatecaV1beta1>(
              map['bindings'],
              (value) => BindingPrivatecaV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
