...
class AuditLogConfigResponsePrivatecaV1beta1 {
  ...
  factory AuditLogConfigResponsePrivatecaV1beta1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponsePrivatecaV1beta1(
