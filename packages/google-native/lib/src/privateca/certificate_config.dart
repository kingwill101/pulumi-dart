...
class CertificateConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'publicKey': ?publicKey == null ? null : publicKey!.toMap(),
  ...
  factory CertificateConfig.fromMap(Map<String, dynamic> map) {
    return CertificateConfig(
      publicKey: map['publicKey'] == null ? null : PublicKey.fromMap((map['publicKey'] as Map).cast<String, dynamic>()),
      subjectConfig: SubjectConfig.fromMap((map['subjectConfig'] as Map).cast<String, dynamic>()),
      x509Config: X509Parameters.fromMap((map['x509Config'] as Map).cast<String, dynamic>()),
    );
  }
}
