...
class Certificate extends pulumi.CustomResource {
  ...
  Certificate(
    ...
    this.issuingCertificateAuthorityId = registerOutput<String?>(
    ...
    this.pemCertificateChain = registerOutput<List<String>>(
      'pemCertificateChain',
    );
    this.pemCsr = registerOutput<String>('pemCsr');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.revocationDetails = registerOutput<RevocationDetailsResponse>(
      'revocationDetails',
    );
