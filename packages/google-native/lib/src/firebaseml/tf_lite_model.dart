...
class TfLiteModel {
  ...
  TfLiteModel({this.automlModel, this.gcsTfliteUri});
  ...
  factory TfLiteModel.fromMap(Map<String, dynamic> map) {
    return TfLiteModel(
      automlModel: map['automlModel'] == null
          ? null
          : map['automlModel'] as String,
      gcsTfliteUri: map['gcsTfliteUri'] == null
          ? null
          : map['gcsTfliteUri'] as String,
    );
  }
}
