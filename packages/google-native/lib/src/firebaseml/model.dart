...
class Model extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<OperationResponse>> activeOperations;
  ...
  /// [args] Arguments used to configure this [Model]. {@macro pulumi_firebaseml_v1beta2_model_args_doc}
  ...
  Model(String name, {ModelArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.activeOperations = registerOutput<List<OperationResponse>>(
      'activeOperations',
    );
