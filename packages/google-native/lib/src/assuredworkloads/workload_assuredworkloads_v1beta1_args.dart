...
class WorkloadAssuredworkloadsV1beta1Args {
  ...
  WorkloadAssuredworkloadsV1beta1Args({
    ...
    required WorkloadComplianceRegimeAssuredworkloadsV1beta1 complianceRegime,
    required String displayName,
    bool? enableSovereignControls,
    String? etag,
    String? externalId,
    GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings? fedrampHighSettings,
    GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings? fedrampModerateSettings,
    ...
    WorkloadPartnerAssuredworkloadsV1beta1? partner,
    GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions? partnerPermissions,
    String? provisionedResourcesParent,
    List<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>? resourceSettings,
    bool? violationNotificationsEnabled,
  }) :
      billingAccount = pulumi.Input.asOptionalInput<String>(billingAccount),
      cjisSettings = pulumi.Input.asOptionalInput<GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings>(cjisSettings),
      complianceRegime = pulumi.Input.asInput<WorkloadComplianceRegimeAssuredworkloadsV1beta1>(complianceRegime),
      ...
      fedrampHighSettings = pulumi.Input.asOptionalInput<GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings>(fedrampHighSettings),
      fedrampModerateSettings = pulumi.Input.asOptionalInput<GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings>(fedrampModerateSettings),
      il4Settings = pulumi.Input.asOptionalInput<GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings>(il4Settings),
      kmsSettings = pulumi.Input.asOptionalInput<GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings>(kmsSettings),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      organizationId = pulumi.Input.asInput<String>(organizationId),
      partner = pulumi.Input.asOptionalInput<WorkloadPartnerAssuredworkloadsV1beta1>(partner),
      partnerPermissions = pulumi.Input.asOptionalInput<GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions>(partnerPermissions),
      provisionedResourcesParent = pulumi.Input.asOptionalInput<String>(provisionedResourcesParent),
      resourceSettings = pulumi.Input.asOptionalInput<List<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>>(resourceSettings),
  ...
  factory WorkloadAssuredworkloadsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return WorkloadAssuredworkloadsV1beta1Args(
      ...
      cjisSettings: map['cjisSettings'] == null ? null : GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings.fromMap((map['cjisSettings'] as Map).cast<String, dynamic>()),
      complianceRegime: WorkloadComplianceRegimeAssuredworkloadsV1beta1.fromValue(map['complianceRegime'] as String),
      ...
      fedrampHighSettings: map['fedrampHighSettings'] == null ? null : GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings.fromMap((map['fedrampHighSettings'] as Map).cast<String, dynamic>()),
      fedrampModerateSettings: map['fedrampModerateSettings'] == null ? null : GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings.fromMap((map['fedrampModerateSettings'] as Map).cast<String, dynamic>()),
      il4Settings: map['il4Settings'] == null ? null : GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings.fromMap((map['il4Settings'] as Map).cast<String, dynamic>()),
      ...
      partner: map['partner'] == null ? null : WorkloadPartnerAssuredworkloadsV1beta1.fromValue(map['partner'] as String),
      partnerPermissions: map['partnerPermissions'] == null ? null : GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions.fromMap((map['partnerPermissions'] as Map).cast<String, dynamic>()),
      provisionedResourcesParent: map['provisionedResourcesParent'] == null ? null : map['provisionedResourcesParent'] as String,
      resourceSettings: map['resourceSettings'] == null ? null : pulumi.Input.decodeList<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>(map['resourceSettings'], (value) => GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings.fromMap((value as Map).cast<String, dynamic>())),
