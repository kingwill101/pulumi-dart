  ...
  WorkloadAssuredworkloadsV1beta1Args({
    ...
    bool? violationNotificationsEnabled,
        ...
        cjisSettings = pulumi.Input.asOptionalInput<
            ...
            cjisSettings),
        complianceRegime = pulumi.Input.asInput<
            WorkloadComplianceRegimeAssuredworkloadsV1beta1>(complianceRegime),
        displayName = pulumi.Input.asInput<String>(displayName),
        enableSovereignControls =
            pulumi.Input.asOptionalInput<bool>(enableSovereignControls),
        ...
        partner = pulumi.Input.asOptionalInput<
            WorkloadPartnerAssuredworkloadsV1beta1>(partner),
        partnerPermissions = pulumi.Input.asOptionalInput<
                GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions>(
            partnerPermissions),
        provisionedResourcesParent =
            pulumi.Input.asOptionalInput<String>(provisionedResourcesParent),
        resourceSettings = pulumi.Input.asOptionalInput<
                List<
                    GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>>(
            resourceSettings),
        violationNotificationsEnabled =
            pulumi.Input.asOptionalInput<bool>(violationNotificationsEnabled);
  ...
  factory WorkloadAssuredworkloadsV1beta1Args.fromMap(
    ...
    return WorkloadAssuredworkloadsV1beta1Args(
      ...
      fedrampModerateSettings: map['fedrampModerateSettings'] == null
          ? null
          : GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings
              .fromMap((map['fedrampModerateSettings'] as Map)
                  .cast<String, dynamic>()),
