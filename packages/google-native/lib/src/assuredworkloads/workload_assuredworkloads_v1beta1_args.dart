...
class WorkloadAssuredworkloadsV1beta1Args {
  ...
  WorkloadAssuredworkloadsV1beta1Args({
    ...
    bool? violationNotificationsEnabled,
       ...
       enableSovereignControls = pulumi.Input.asOptionalInput<bool>(
    ...
    return <String, dynamic>{
      ...
      'cjisSettings':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings,
            Map<String, dynamic>
          >(cjisSettings, (value) => value.toMap()),
      'complianceRegime':
      ...
      'fedrampHighSettings':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings,
            Map<String, dynamic>
          >(fedrampHighSettings, (value) => value.toMap()),
      'fedrampModerateSettings':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings,
            Map<String, dynamic>
          >(fedrampModerateSettings, (value) => value.toMap()),
      'il4Settings':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings,
            Map<String, dynamic>
          >(il4Settings, (value) => value.toMap()),
      'kmsSettings':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings,
            Map<String, dynamic>
      ...
      'partner':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(partner, (value) => value.value),
      'partnerPermissions':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions,
            Map<String, dynamic>
          >(partnerPermissions, (value) => value.toMap()),
  ...
  factory WorkloadAssuredworkloadsV1beta1Args.fromMap(
    ...
    return WorkloadAssuredworkloadsV1beta1Args(
      ...
      cjisSettings: map['cjisSettings'] == null
          ? null
          : GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings.fromMap(
              (map['cjisSettings'] as Map).cast<String, dynamic>(),
            ),
      complianceRegime:
          WorkloadComplianceRegimeAssuredworkloadsV1beta1.fromValue(
            map['complianceRegime'] as String,
          ),
      displayName: map['displayName'] as String,
      enableSovereignControls: map['enableSovereignControls'] == null
          ? null
          : map['enableSovereignControls'] as bool,
      etag: map['etag'] == null ? null : map['etag'] as String,
      externalId: map['externalId'] == null
          ? null
          : map['externalId'] as String,
      fedrampHighSettings: map['fedrampHighSettings'] == null
          ? null
          : GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings.fromMap(
              (map['fedrampHighSettings'] as Map).cast<String, dynamic>(),
            ),
      fedrampModerateSettings: map['fedrampModerateSettings'] == null
          ? null
          : GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings.fromMap(
              (map['fedrampModerateSettings'] as Map).cast<String, dynamic>(),
            ),
      il4Settings: map['il4Settings'] == null
          ? null
          : GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings.fromMap(
              (map['il4Settings'] as Map).cast<String, dynamic>(),
            ),
      ...
      partner: map['partner'] == null
          ? null
          : WorkloadPartnerAssuredworkloadsV1beta1.fromValue(
              map['partner'] as String,
            ),
      partnerPermissions: map['partnerPermissions'] == null
          ? null
          : GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions.fromMap(
              (map['partnerPermissions'] as Map).cast<String, dynamic>(),
            ),
      provisionedResourcesParent: map['provisionedResourcesParent'] == null
          ? null
          : map['provisionedResourcesParent'] as String,
      resourceSettings: map['resourceSettings'] == null
          ? null
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      violationNotificationsEnabled:
          map['violationNotificationsEnabled'] == null
          ? null
