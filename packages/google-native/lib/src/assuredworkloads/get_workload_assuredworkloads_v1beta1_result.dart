...
class GetWorkloadAssuredworkloadsV1beta1Result {
  ...
  final GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsResponse
  cjisSettings;
  ...
  final GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatusResponse
  complianceStatus;
  ...
  final GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponseResponse
  ...
  final GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsResponse
  fedrampHighSettings;

  /// Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate.
  final GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsResponse
  fedrampModerateSettings;

  /// Input only. Immutable. Settings specific to resources needed for IL4.
  final GoogleCloudAssuredworkloadsV1beta1WorkloadIL4SettingsResponse
  il4Settings;
  ...
  final GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissionsResponse
  partnerPermissions;
  ...
  final List<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponse>
  resourceSettings;
  ...
  final List<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfoResponse>
  resources;
  ...
  final GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseResponse
  ...
  factory GetWorkloadAssuredworkloadsV1beta1Result.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetWorkloadAssuredworkloadsV1beta1Result(
      billingAccount: map['billingAccount'] as String,
      cjisSettings:
          GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettingsResponse.fromMap(
            (map['cjisSettings'] as Map).cast<String, dynamic>(),
          ),
      complianceRegime: map['complianceRegime'] as String,
      complianceStatus:
          GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatusResponse.fromMap(
      ...
      ekmProvisioningResponse:
          GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponseResponse.fromMap(
            (map['ekmProvisioningResponse'] as Map).cast<String, dynamic>(),
          ),
      enableSovereignControls: map['enableSovereignControls'] as bool,
      etag: map['etag'] as String,
      fedrampHighSettings:
          GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettingsResponse.fromMap(
            (map['fedrampHighSettings'] as Map).cast<String, dynamic>(),
          ),
      fedrampModerateSettings:
          GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettingsResponse.fromMap(
            (map['fedrampModerateSettings'] as Map).cast<String, dynamic>(),
          ),
      il4Settings:
          GoogleCloudAssuredworkloadsV1beta1WorkloadIL4SettingsResponse.fromMap(
      ...
      partnerPermissions:
          GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissionsResponse.fromMap(
      ...
      resourceSettings:
          ...
          >(
            ...
            (value) =>
                GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponse.fromMap(
      ...
      resources:
          ...
          >(
            map['resources'],
            (value) =>
                GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfoResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      saaEnrollmentResponse:
          GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseResponse.fromMap(
