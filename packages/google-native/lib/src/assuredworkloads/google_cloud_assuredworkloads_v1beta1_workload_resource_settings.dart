...
class GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings {
  ...
  final GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResourceType? resourceType;
  ...
  factory GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings(
      ...
      resourceType: map['resourceType'] == null ? null : GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResourceType.fromValue(map['resourceType'] as String),
    );
  }
}
