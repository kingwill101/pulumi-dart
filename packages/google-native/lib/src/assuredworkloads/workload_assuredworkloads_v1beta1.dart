...
class WorkloadAssuredworkloadsV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<
    List<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResponse>
  >
  resourceSettings;
  ...
  WorkloadAssuredworkloadsV1beta1(
    ...
    this.complianceStatus =
        registerOutput<
          GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatusResponse
        >('complianceStatus');
    this.compliantButDisallowedServices = registerOutput<List<String>>(
    ...
    this.ekmProvisioningResponse =
        registerOutput<
          GoogleCloudAssuredworkloadsV1beta1WorkloadEkmProvisioningResponseResponse
        >('ekmProvisioningResponse');
    this.enableSovereignControls = registerOutput<bool>(
    ...
    this.partnerPermissions =
        registerOutput<
          GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissionsResponse
        >('partnerPermissions');
    this.provisionedResourcesParent = registerOutput<String>(
      'provisionedResourcesParent',
    );
    this.resourceMonitoringEnabled = registerOutput<bool>(
    ...
    this.saaEnrollmentResponse =
        registerOutput<
          GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseResponse
        >('saaEnrollmentResponse');
    this.violationNotificationsEnabled = registerOutput<bool>(
