...
class ProviderArgs {
  ...
  ProviderArgs({
    ...
    required String workloadIdentityPoolProviderId,
  }) : attributeCondition = pulumi.Input.asOptionalInput<String>(
         attributeCondition,
       ),
       ...
       workloadIdentityPoolProviderId = pulumi.Input.asInput<String>(
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'aws': ?pulumi.Input.mapOptionalInputValue<Aws, Map<String, dynamic>>(
        aws,
        (value) => value.toMap(),
      ),
      ...
      'project': ?project,
      'saml': ?pulumi.Input.mapOptionalInputValue<Saml, Map<String, dynamic>>(
        saml,
        (value) => value.toMap(),
      ),
