...
class OrganizationRoleArgs {
  ...
  factory OrganizationRoleArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationRoleArgs(
      ...
      includedPermissions: map['includedPermissions'] == null ? null : (map['includedPermissions'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      organizationId: map['organizationId'] as String,
      roleId: map['roleId'] == null ? null : map['roleId'] as String,
      stage: map['stage'] == null ? null : OrganizationRoleStage.fromValue(map['stage'] as String),
