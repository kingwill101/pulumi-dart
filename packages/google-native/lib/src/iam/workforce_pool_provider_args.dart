...
class WorkforcePoolProviderArgs {
  ...
  WorkforcePoolProviderArgs({
    ...
    required String workforcePoolProviderId,
  }) :
  ...
  factory WorkforcePoolProviderArgs.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolProviderArgs(
      ...
      oidc: map['oidc'] == null ? null : GoogleIamAdminV1WorkforcePoolProviderOidc.fromMap((map['oidc'] as Map).cast<String, dynamic>()),
      saml: map['saml'] == null ? null : GoogleIamAdminV1WorkforcePoolProviderSaml.fromMap((map['saml'] as Map).cast<String, dynamic>()),
      workforcePoolId: map['workforcePoolId'] as String,
      workforcePoolProviderId: map['workforcePoolProviderId'] as String,
    );
  }
}
