...
class KeyArgs {
  ...
  factory KeyArgs.fromMap(Map<String, dynamic> map) {
    return KeyArgs(
      keyAlgorithm: map['keyAlgorithm'] == null ? null : KeyKeyAlgorithm.fromValue(map['keyAlgorithm'] as String),
      privateKeyType: map['privateKeyType'] == null ? null : KeyPrivateKeyType.fromValue(map['privateKeyType'] as String),
