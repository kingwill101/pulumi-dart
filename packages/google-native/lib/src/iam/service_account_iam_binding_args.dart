...
/// {@template pulumi_iam_v1_service_account_iam_binding_args_doc}
/// The set of arguments for ServiceAccountIamBinding.
/// {@endtemplate}
/// {@macro pulumi_iam_v1_service_account_iam_binding_args_doc}
class ServiceAccountIamBindingArgs {
  ...
  /// Creates a new [ServiceAccountIamBindingArgs].
  ...
  factory ServiceAccountIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAccountIamBindingArgs(
