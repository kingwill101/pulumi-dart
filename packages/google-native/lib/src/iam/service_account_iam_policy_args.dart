...
/// {@template pulumi_iam_v1_service_account_iam_policy_args_doc}
/// The set of arguments for ServiceAccountIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_iam_v1_service_account_iam_policy_args_doc}
class ServiceAccountIamPolicyArgs {
  ...
  /// Creates a new [ServiceAccountIamPolicyArgs].
  ...
  factory ServiceAccountIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAccountIamPolicyArgs(
