...
class WorkforcePoolArgs {
  ...
  factory WorkforcePoolArgs.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolArgs(
      accessRestrictions: map['accessRestrictions'] == null ? null : AccessRestrictions.fromMap((map['accessRestrictions'] as Map).cast<String, dynamic>()),
      ...
      workforcePoolId: map['workforcePoolId'] == null ? null : map['workforcePoolId'] as String,
    );
  }
}
