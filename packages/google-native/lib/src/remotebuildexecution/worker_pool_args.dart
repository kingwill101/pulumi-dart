...
class WorkerPoolArgs {
  ...
  factory WorkerPoolArgs.fromMap(Map<String, dynamic> map) {
    return WorkerPoolArgs(
      autoscale: map['autoscale'] == null ? null : GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale.fromMap((map['autoscale'] as Map).cast<String, dynamic>()),
      ...
      workerConfig: map['workerConfig'] == null ? null : GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
