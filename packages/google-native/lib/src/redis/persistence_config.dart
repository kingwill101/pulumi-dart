...
class PersistenceConfig {
  ...
  factory PersistenceConfig.fromMap(Map<String, dynamic> map) {
    return PersistenceConfig(
      persistenceMode: map['persistenceMode'] == null ? null : PersistenceConfigPersistenceMode.fromValue(map['persistenceMode'] as String),
      rdbSnapshotPeriod: map['rdbSnapshotPeriod'] == null ? null : PersistenceConfigRdbSnapshotPeriod.fromValue(map['rdbSnapshotPeriod'] as String),
