...
class Instance extends pulumi.CustomResource {
  ...
  /// Info per node.
  late final pulumi.Output<List<NodeInfoResponse>> nodes;
  /// Optional. Persistence configuration parameters
  late final pulumi.Output<PersistenceConfigResponse> persistenceConfig;
  ...
  late final pulumi.Output<List<TlsCertificateResponse>> serverCaCerts;
  ...
  /// [args] Arguments used to configure this [Instance]. {@macro pulumi_redis_v1_instance_args_doc}
  ...
  Instance(
    ...
    this.maintenancePolicy = registerOutput<MaintenancePolicyResponse>('maintenancePolicy');
    this.maintenanceSchedule = registerOutput<MaintenanceScheduleResponse>('maintenanceSchedule');
    ...
    this.persistenceConfig = registerOutput<PersistenceConfigResponse>('persistenceConfig');
    ...
    this.serverCaCerts = registerOutput<List<TlsCertificateResponse>>('serverCaCerts');
