...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.maintenancePolicy = registerOutput<MaintenancePolicyResponse>(
      'maintenancePolicy',
    );
    ...
    this.persistenceConfig = registerOutput<PersistenceConfigResponse>(
      'persistenceConfig',
    );
    ...
    this.serverCaCerts = registerOutput<List<TlsCertificateResponse>>(
      'serverCaCerts',
    );
