...
class GetClusterResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'discoveryEndpoints': pulumi.Input.encodeList<DiscoveryEndpointResponse, Map<String, dynamic>>(discoveryEndpoints, (value) => value.toMap()),
      'name': name,
      'pscConfigs': pulumi.Input.encodeList<PscConfigResponse, Map<String, dynamic>>(pscConfigs, (value) => value.toMap()),
  ...
  factory GetClusterResult.fromMap(Map<String, dynamic> map) {
    return GetClusterResult(
      ...
      discoveryEndpoints: pulumi.Input.decodeList<DiscoveryEndpointResponse>(map['discoveryEndpoints'], (value) => DiscoveryEndpointResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      pscConfigs: pulumi.Input.decodeList<PscConfigResponse>(map['pscConfigs'], (value) => PscConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      stateInfo: StateInfoResponse.fromMap((map['stateInfo'] as Map).cast<String, dynamic>()),
