...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      authorizationMode: map['authorizationMode'] == null ? null : ClusterAuthorizationMode.fromValue(map['authorizationMode'] as String),
      clusterId: map['clusterId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      pscConfigs: pulumi.Input.decodeList<PscConfig>(map['pscConfigs'], (value) => PscConfig.fromMap((value as Map).cast<String, dynamic>())),
      replicaCount: map['replicaCount'] == null ? null : map['replicaCount'] as int,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      shardCount: map['shardCount'] as int,
      transitEncryptionMode: map['transitEncryptionMode'] == null ? null : ClusterTransitEncryptionMode.fromValue(map['transitEncryptionMode'] as String),
    );
  }
}
