...
class InstanceArgs {
    ...
    InstanceTransitEncryptionMode? transitEncryptionMode,
        ...
        availableMaintenanceVersions =
            pulumi.Input.asOptionalInput<List<String>>(
                availableMaintenanceVersions),
        connectMode =
            pulumi.Input.asOptionalInput<InstanceConnectMode>(connectMode),
        customerManagedKey =
        ...
        persistenceConfig =
            pulumi.Input.asOptionalInput<PersistenceConfig>(persistenceConfig),
        project = pulumi.Input.asOptionalInput<String>(project),
        readReplicasMode =
            pulumi.Input.asOptionalInput<InstanceReadReplicasMode>(
                readReplicasMode),
        redisConfigs =
  ...
  Map<String, dynamic> toMap() {
    ...
    map['tier'] = pulumi.Input.mapInputValue<InstanceTier, String>(
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      connectMode: map['connectMode'] == null
          ? null
          : InstanceConnectMode.fromValue(map['connectMode'] as String),
      ...
      readReplicasMode: map['readReplicasMode'] == null
          ? null
          : InstanceReadReplicasMode.fromValue(
      ...
      suspensionReasons: map['suspensionReasons'] == null
          ? null
          : pulumi.Input.decodeList<InstanceSuspensionReasonsItem>(
              map['suspensionReasons'],
              (value) =>
                  InstanceSuspensionReasonsItem.fromValue(value as String)),
      tier: InstanceTier.fromValue(map['tier'] as String),
      transitEncryptionMode: map['transitEncryptionMode'] == null
          ? null
          : InstanceTransitEncryptionMode.fromValue(
