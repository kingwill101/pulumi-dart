...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    InstanceConnectMode? connectMode,
    ...
    String? project,
    InstanceReadReplicasMode? readReplicasMode,
    Map<String, String>? redisConfigs,
    String? redisVersion,
    int? replicaCount,
    String? reservedIpRange,
    String? secondaryIpRange,
    List<InstanceSuspensionReasonsItem>? suspensionReasons,
    required InstanceTier tier,
    InstanceTransitEncryptionMode? transitEncryptionMode,
  }) :
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      connectMode: map['connectMode'] == null ? null : InstanceConnectMode.fromValue(map['connectMode'] as String),
      ...
      persistenceConfig: map['persistenceConfig'] == null ? null : PersistenceConfig.fromMap((map['persistenceConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      readReplicasMode: map['readReplicasMode'] == null ? null : InstanceReadReplicasMode.fromValue(map['readReplicasMode'] as String),
      ...
      suspensionReasons: map['suspensionReasons'] == null ? null : pulumi.Input.decodeList<InstanceSuspensionReasonsItem>(map['suspensionReasons'], (value) => InstanceSuspensionReasonsItem.fromValue(value as String)),
      tier: InstanceTier.fromValue(map['tier'] as String),
      transitEncryptionMode: map['transitEncryptionMode'] == null ? null : InstanceTransitEncryptionMode.fromValue(map['transitEncryptionMode'] as String),
    );
  }
}
