...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    InstanceTransitEncryptionMode? transitEncryptionMode,
       ...
       connectMode = pulumi.Input.asOptionalInput<InstanceConnectMode>(
         connectMode,
       ),
       ...
       readReplicasMode = pulumi
           .Input.asOptionalInput<InstanceReadReplicasMode>(readReplicasMode),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'suspensionReasons':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceSuspensionReasonsItem>,
            List<String>
          >(
            suspensionReasons,
            (value) =>
      ...
      'tier': pulumi.Input.mapInputValue<InstanceTier, String>(
        tier,
        (value) => value.value,
      ),
      'transitEncryptionMode':
