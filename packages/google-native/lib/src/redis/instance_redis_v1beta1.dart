...
class InstanceRedisV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<TlsCertificateResponseRedisV1beta1>> serverCaCerts;
  ...
  InstanceRedisV1beta1(
    ...
    this.alternativeLocationId = registerOutput<String>('alternativeLocationId');
    ...
    this.maintenancePolicy = registerOutput<MaintenancePolicyResponseRedisV1beta1>('maintenancePolicy');
    this.maintenanceSchedule = registerOutput<MaintenanceScheduleResponseRedisV1beta1>('maintenanceSchedule');
    ...
    this.persistenceConfig = registerOutput<PersistenceConfigResponseRedisV1beta1>('persistenceConfig');
    this.persistenceIamIdentity = registerOutput<String>('persistenceIamIdentity');
    ...
    this.serverCaCerts = registerOutput<List<TlsCertificateResponseRedisV1beta1>>('serverCaCerts');
