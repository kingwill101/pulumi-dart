...
class InstanceRedisV1beta1Args {
  ...
  final pulumi.Input<List<InstanceSuspensionReasonsItemRedisV1beta1>>?
  suspensionReasons;
  ...
  final pulumi.Input<InstanceTransitEncryptionModeRedisV1beta1>?
  ...
  InstanceRedisV1beta1Args({
    ...
    InstanceTransitEncryptionModeRedisV1beta1? transitEncryptionMode,
  }) : alternativeLocationId = pulumi.Input.asOptionalInput<String>(
       ...
       availableMaintenanceVersions = pulumi
           .Input.asOptionalInput<List<String>>(availableMaintenanceVersions),
       connectMode = pulumi
           .Input.asOptionalInput<InstanceConnectModeRedisV1beta1>(connectMode),
       customerManagedKey = pulumi.Input.asOptionalInput<String>(
         customerManagedKey,
       ),
       ...
       maintenancePolicy =
           pulumi.Input.asOptionalInput<MaintenancePolicyRedisV1beta1>(
             maintenancePolicy,
           ),
       ...
       persistenceConfig =
           pulumi.Input.asOptionalInput<PersistenceConfigRedisV1beta1>(
             persistenceConfig,
           ),
       project = pulumi.Input.asOptionalInput<String>(project),
       readReplicasMode =
           pulumi.Input.asOptionalInput<InstanceReadReplicasModeRedisV1beta1>(
             readReplicasMode,
           ),
       ...
       secondaryIpRange = pulumi.Input.asOptionalInput<String>(
         secondaryIpRange,
       ),
       suspensionReasons =
           pulumi.Input.asOptionalInput<
             List<InstanceSuspensionReasonsItemRedisV1beta1>
           >(suspensionReasons),
       tier = pulumi.Input.asInput<InstanceTierRedisV1beta1>(tier),
       transitEncryptionMode =
           pulumi.Input.asOptionalInput<
             InstanceTransitEncryptionModeRedisV1beta1
           >(transitEncryptionMode);
    ...
    return <String, dynamic>{
      ...
      'connectMode':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceConnectModeRedisV1beta1,
            String
          >(connectMode, (value) => value.value),
      ...
      'readReplicasMode':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceReadReplicasModeRedisV1beta1,
            String
          >(readReplicasMode, (value) => value.value),
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  InstanceSuspensionReasonsItemRedisV1beta1,
                  String
                >(value, (value) => value.value),
          ),
      'tier': pulumi.Input.mapInputValue<InstanceTierRedisV1beta1, String>(
        tier,
        (value) => value.value,
      ),
      'transitEncryptionMode':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceTransitEncryptionModeRedisV1beta1,
            String
          >(transitEncryptionMode, (value) => value.value),
    };
  }
  ...
  factory InstanceRedisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceRedisV1beta1Args(
      ...
      authEnabled: map['authEnabled'] == null
          ? null
          : map['authEnabled'] as bool,
      authorizedNetwork: map['authorizedNetwork'] == null
          ? null
          : map['authorizedNetwork'] as String,
      availableMaintenanceVersions: map['availableMaintenanceVersions'] == null
          ? null
          : (map['availableMaintenanceVersions'] as List).cast<String>(),
      connectMode: map['connectMode'] == null
          ? null
          : InstanceConnectModeRedisV1beta1.fromValue(
      ...
      maintenancePolicy: map['maintenancePolicy'] == null
          ? null
          : MaintenancePolicyRedisV1beta1.fromMap(
      ...
      suspensionReasons: map['suspensionReasons'] == null
          ? null
          : pulumi.Input.decodeList<InstanceSuspensionReasonsItemRedisV1beta1>(
              map['suspensionReasons'],
              (value) => InstanceSuspensionReasonsItemRedisV1beta1.fromValue(
                value as String,
              ),
            ),
      ...
      transitEncryptionMode: map['transitEncryptionMode'] == null
          ? null
          : InstanceTransitEncryptionModeRedisV1beta1.fromValue(
