...
class InstanceRedisV1beta1Args {
    ...
    InstanceTransitEncryptionModeRedisV1beta1? transitEncryptionMode,
        ...
        availableMaintenanceVersions =
            pulumi.Input.asOptionalInput<List<String>>(
                availableMaintenanceVersions),
        connectMode =
            pulumi.Input.asOptionalInput<InstanceConnectModeRedisV1beta1>(
                connectMode),
        customerManagedKey =
        ...
        suspensionReasons = pulumi.Input.asOptionalInput<
            List<InstanceSuspensionReasonsItemRedisV1beta1>>(suspensionReasons),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (connectModeValue != null) {
      map['connectMode'] = pulumi.Input.mapOptionalInputValue<
          InstanceConnectModeRedisV1beta1,
          String>(connectModeValue, (value) => value.value);
    }
    ...
    if (maintenancePolicyValue != null) {
      map['maintenancePolicy'] = pulumi.Input.mapOptionalInputValue<
              MaintenancePolicyRedisV1beta1, Map<String, dynamic>>(
    ...
    if (persistenceConfigValue != null) {
      map['persistenceConfig'] = pulumi.Input.mapOptionalInputValue<
              PersistenceConfigRedisV1beta1, Map<String, dynamic>>(
    ...
    if (readReplicasModeValue != null) {
      map['readReplicasMode'] = pulumi.Input.mapOptionalInputValue<
          InstanceReadReplicasModeRedisV1beta1,
          String>(readReplicasModeValue, (value) => value.value);
    }
    ...
    if (suspensionReasonsValue != null) {
      map['suspensionReasons'] = pulumi.Input.mapOptionalInputValue<
              List<InstanceSuspensionReasonsItemRedisV1beta1>, List<String>>(
          suspensionReasonsValue,
          (value) => pulumi.Input.encodeList<
              InstanceSuspensionReasonsItemRedisV1beta1,
              String>(value, (value) => value.value));
    }
    map['tier'] = pulumi.Input.mapInputValue<InstanceTierRedisV1beta1, String>(
