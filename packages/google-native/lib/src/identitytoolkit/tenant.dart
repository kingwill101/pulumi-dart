...
class Tenant extends pulumi.CustomResource {
  ...
  Tenant(
    ...
    this.client = registerOutput<GoogleCloudIdentitytoolkitAdminV2ClientPermissionConfigResponse>('client');
    this.disableAuth = registerOutput<bool>('disableAuth');
    this.displayName = registerOutput<String>('displayName');
    this.emailPrivacyConfig = registerOutput<GoogleCloudIdentitytoolkitAdminV2EmailPrivacyConfigResponse>('emailPrivacyConfig');
    ...
    this.hashConfig = registerOutput<GoogleCloudIdentitytoolkitAdminV2HashConfigResponse>('hashConfig');
    this.inheritance = registerOutput<GoogleCloudIdentitytoolkitAdminV2InheritanceResponse>('inheritance');
    this.mfaConfig = registerOutput<GoogleCloudIdentitytoolkitAdminV2MultiFactorAuthConfigResponse>('mfaConfig');
    this.monitoring = registerOutput<GoogleCloudIdentitytoolkitAdminV2MonitoringConfigResponse>('monitoring');
    this.name = registerOutput<String>('name');
    this.passwordPolicyConfig = registerOutput<GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfigResponse>('passwordPolicyConfig');
    this.project = registerOutput<String>('project');
    this.recaptchaConfig = registerOutput<GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigResponse>('recaptchaConfig');
    this.smsRegionConfig = registerOutput<GoogleCloudIdentitytoolkitAdminV2SmsRegionConfigResponse>('smsRegionConfig');
    this.testPhoneNumbers = registerOutput<Map<String, String>>('testPhoneNumbers');
  }
}
