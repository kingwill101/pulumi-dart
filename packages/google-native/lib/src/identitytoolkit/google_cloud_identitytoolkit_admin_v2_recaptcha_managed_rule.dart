...
class GoogleCloudIdentitytoolkitAdminV2RecaptchaManagedRule {
  ...
  Map<String, dynamic> toMap() {
    ...
    final endScoreValue = endScore;
    if (endScoreValue != null) {
      map['endScore'] = endScoreValue;
    }
    return map;
  }

  factory GoogleCloudIdentitytoolkitAdminV2RecaptchaManagedRule.fromMap(
    ...
    return GoogleCloudIdentitytoolkitAdminV2RecaptchaManagedRule(
      action: map['action'] == null
          ...
          : GoogleCloudIdentitytoolkitAdminV2RecaptchaManagedRuleAction
              .fromValue(map['action'] as String),
