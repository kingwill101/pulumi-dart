...
class TenantArgs {
  ...
  TenantArgs({
    ...
    Map<String, String>? testPhoneNumbers,
  }) : allowPasswordSignup = pulumi.Input.asOptionalInput<bool>(
         allowPasswordSignup,
       ),
       autodeleteAnonymousUsers = pulumi.Input.asOptionalInput<bool>(
       ...
       emailPrivacyConfig =
           ...
           >(emailPrivacyConfig),
       enableAnonymousUser = pulumi.Input.asOptionalInput<bool>(
         enableAnonymousUser,
       ),
       enableEmailLinkSignin = pulumi.Input.asOptionalInput<bool>(
  ...
  factory TenantArgs.fromMap(Map<String, dynamic> map) {
    return TenantArgs(
      ...
      disableAuth: map['disableAuth'] == null
          ? null
          : map['disableAuth'] as bool,
