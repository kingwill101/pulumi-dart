...
class GoogleTypeDateResponsePolicysimulatorV1alpha {
  ...
  /// Creates a new [GoogleTypeDateResponsePolicysimulatorV1alpha].
  ...
  factory GoogleTypeDateResponsePolicysimulatorV1alpha.fromMap(Map<String, dynamic> map) {
    return GoogleTypeDateResponsePolicysimulatorV1alpha(
      day: map['day'] as int,
