...
class GetReplayPolicysimulatorV1alphaResult {
  ...
  /// Creates a new [GetReplayPolicysimulatorV1alphaResult].
  ...
  GetReplayPolicysimulatorV1alphaResult({
  ...
  factory GetReplayPolicysimulatorV1alphaResult.fromMap(
      Map<String, dynamic> map) {
    return GetReplayPolicysimulatorV1alphaResult(
