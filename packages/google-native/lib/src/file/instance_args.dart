...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      fileShares: map['fileShares'] == null ? null : pulumi.Input.decodeList<FileShareConfig>(map['fileShares'], (value) => FileShareConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tier: map['tier'] == null ? null : InstanceTier.fromValue(map['tier'] as String),
    );
  }
}
