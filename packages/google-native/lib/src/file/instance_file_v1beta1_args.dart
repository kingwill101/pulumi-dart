...
class InstanceFileV1beta1Args {
  ...
  InstanceFileV1beta1Args({
    ...
    InstanceTierFileV1beta1? tier,
       ...
       directoryServices = pulumi
           .Input.asOptionalInput<DirectoryServicesConfig>(directoryServices),
       etag = pulumi.Input.asOptionalInput<String>(etag),
       fileShares = pulumi
           .Input.asOptionalInput<List<FileShareConfigFileV1beta1>>(fileShares),
       instanceId = pulumi.Input.asInput<String>(instanceId),
       kmsKeyName = pulumi.Input.asOptionalInput<String>(kmsKeyName),
       labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
       location = pulumi.Input.asOptionalInput<String>(location),
       maxShareCount = pulumi.Input.asOptionalInput<String>(maxShareCount),
       multiShareEnabled = pulumi.Input.asOptionalInput<bool>(
         multiShareEnabled,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileShares':
          ?pulumi.Input.mapOptionalInputValue<
            List<FileShareConfigFileV1beta1>,
      ...
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<InstanceProtocol, String>(
        protocol,
        (value) => value.value,
      ),
      'tier':
  ...
  factory InstanceFileV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceFileV1beta1Args(
      ...
      maxShareCount: map['maxShareCount'] == null
          ? null
          : map['maxShareCount'] as String,
