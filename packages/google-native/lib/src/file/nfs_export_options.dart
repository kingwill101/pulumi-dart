...
class NfsExportOptions {
  ...
  factory NfsExportOptions.fromMap(Map<String, dynamic> map) {
    return NfsExportOptions(
      accessMode: map['accessMode'] == null ? null : NfsExportOptionsAccessMode.fromValue(map['accessMode'] as String),
      ...
      squashMode: map['squashMode'] == null ? null : NfsExportOptionsSquashMode.fromValue(map['squashMode'] as String),
    );
  }
}
