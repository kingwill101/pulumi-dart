...
class ShareArgs {
  ...
  factory ShareArgs.fromMap(Map<String, dynamic> map) {
    return ShareArgs(
      ...
      nfsExportOptions: map['nfsExportOptions'] == null ? null : pulumi.Input.decodeList<NfsExportOptionsFileV1beta1>(map['nfsExportOptions'], (value) => NfsExportOptionsFileV1beta1.fromMap((value as Map).cast<String, dynamic>())),
