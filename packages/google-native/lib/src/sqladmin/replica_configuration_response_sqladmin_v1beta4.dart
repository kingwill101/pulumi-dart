...
class ReplicaConfigurationResponseSqladminV1beta4 {
  ...
  final MySqlReplicaConfigurationResponseSqladminV1beta4 mysqlReplicaConfiguration;
  ...
  ReplicaConfigurationResponseSqladminV1beta4({
  ...
  factory ReplicaConfigurationResponseSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return ReplicaConfigurationResponseSqladminV1beta4(
      ...
      mysqlReplicaConfiguration: MySqlReplicaConfigurationResponseSqladminV1beta4.fromMap((map['mysqlReplicaConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
