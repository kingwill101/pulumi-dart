...
class ReplicaConfigurationResponse {
  ...
  final MySqlReplicaConfigurationResponse mysqlReplicaConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': kind,
      'mysqlReplicaConfiguration': mysqlReplicaConfiguration.toMap(),
    };
  }
  ...
  factory ReplicaConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ReplicaConfigurationResponse(
      ...
      mysqlReplicaConfiguration: MySqlReplicaConfigurationResponse.fromMap((map['mysqlReplicaConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
