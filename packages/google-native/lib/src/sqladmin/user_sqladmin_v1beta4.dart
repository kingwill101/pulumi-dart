...
class UserSqladminV1beta4 extends pulumi.CustomResource {
  ...
  UserSqladminV1beta4(
    ...
    this.passwordPolicy = registerOutput<UserPasswordValidationPolicyResponseSqladminV1beta4>('passwordPolicy');
    this.project = registerOutput<String>('project');
    this.sqlserverUserDetails = registerOutput<SqlServerUserDetailsResponseSqladminV1beta4>('sqlserverUserDetails');
