...
class Settings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'databaseFlags': ?databaseFlags == null ? null : pulumi.Input.encodeList<DatabaseFlags, Map<String, dynamic>>(databaseFlags!, (value) => value.toMap()),
      'databaseReplicationEnabled': ?databaseReplicationEnabled,
      'deletionProtectionEnabled': ?deletionProtectionEnabled,
      'denyMaintenancePeriods': ?denyMaintenancePeriods == null ? null : pulumi.Input.encodeList<DenyMaintenancePeriod, Map<String, dynamic>>(denyMaintenancePeriods!, (value) => value.toMap()),
  ...
  factory Settings.fromMap(Map<String, dynamic> map) {
    return Settings(
      activationPolicy: map['activationPolicy'] == null ? null : SettingsActivationPolicy.fromValue(map['activationPolicy'] as String),
      activeDirectoryConfig: map['activeDirectoryConfig'] == null ? null : SqlActiveDirectoryConfig.fromMap((map['activeDirectoryConfig'] as Map).cast<String, dynamic>()),
      ...
      availabilityType: map['availabilityType'] == null ? null : SettingsAvailabilityType.fromValue(map['availabilityType'] as String),
      ...
      connectorEnforcement: map['connectorEnforcement'] == null ? null : SettingsConnectorEnforcement.fromValue(map['connectorEnforcement'] as String),
      ...
      dataDiskType: map['dataDiskType'] == null ? null : SettingsDataDiskType.fromValue(map['dataDiskType'] as String),
      databaseFlags: map['databaseFlags'] == null ? null : pulumi.Input.decodeList<DatabaseFlags>(map['databaseFlags'], (value) => DatabaseFlags.fromMap((value as Map).cast<String, dynamic>())),
      ...
      denyMaintenancePeriods: map['denyMaintenancePeriods'] == null ? null : pulumi.Input.decodeList<DenyMaintenancePeriod>(map['denyMaintenancePeriods'], (value) => DenyMaintenancePeriod.fromMap((value as Map).cast<String, dynamic>())),
      edition: map['edition'] == null ? null : SettingsEdition.fromValue(map['edition'] as String),
      insightsConfig: map['insightsConfig'] == null ? null : InsightsConfig.fromMap((map['insightsConfig'] as Map).cast<String, dynamic>()),
      ipConfiguration: map['ipConfiguration'] == null ? null : IpConfiguration.fromMap((map['ipConfiguration'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      locationPreference: map['locationPreference'] == null ? null : LocationPreference.fromMap((map['locationPreference'] as Map).cast<String, dynamic>()),
      ...
      passwordValidationPolicy: map['passwordValidationPolicy'] == null ? null : PasswordValidationPolicy.fromMap((map['passwordValidationPolicy'] as Map).cast<String, dynamic>()),
      pricingPlan: map['pricingPlan'] == null ? null : SettingsPricingPlan.fromValue(map['pricingPlan'] as String),
      replicationType: map['replicationType'] == null ? null : SettingsReplicationType.fromValue(map['replicationType'] as String),
      settingsVersion: map['settingsVersion'] == null ? null : map['settingsVersion'] as String,
      sqlServerAuditConfig: map['sqlServerAuditConfig'] == null ? null : SqlServerAuditConfig.fromMap((map['sqlServerAuditConfig'] as Map).cast<String, dynamic>()),
