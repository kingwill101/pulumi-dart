...
class InstanceSqladminV1beta4 extends pulumi.CustomResource {
  ...
  InstanceSqladminV1beta4(
    ...
    this.databaseInstalledVersion = registerOutput<String>(
    ...
    this.ipAddresses = registerOutput<List<IpMappingResponseSqladminV1beta4>>(
      'ipAddresses',
    );
    ...
    this.serverCaCert = registerOutput<SslCertResponseSqladminV1beta4>(
      'serverCaCert',
    );
    ...
    this.sqlNetworkArchitecture = registerOutput<String>(
