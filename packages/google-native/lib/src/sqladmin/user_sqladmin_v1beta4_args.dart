...
class UserSqladminV1beta4Args {
  ...
  factory UserSqladminV1beta4Args.fromMap(Map<String, dynamic> map) {
    return UserSqladminV1beta4Args(
      dualPasswordType: map['dualPasswordType'] == null ? null : UserDualPasswordTypeSqladminV1beta4.fromValue(map['dualPasswordType'] as String),
      ...
      passwordPolicy: map['passwordPolicy'] == null ? null : UserPasswordValidationPolicySqladminV1beta4.fromMap((map['passwordPolicy'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      sqlserverUserDetails: map['sqlserverUserDetails'] == null ? null : SqlServerUserDetailsSqladminV1beta4.fromMap((map['sqlserverUserDetails'] as Map).cast<String, dynamic>()),
      type: map['type'] == null ? null : UserTypeSqladminV1beta4.fromValue(map['type'] as String),
    );
  }
}
