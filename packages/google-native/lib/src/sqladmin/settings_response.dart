...
class SettingsResponse {
  ...
  factory SettingsResponse.fromMap(Map<String, dynamic> map) {
    return SettingsResponse(
      ...
      authorizedGaeApplications: (map['authorizedGaeApplications'] as List)
          .cast<String>(),
      availabilityType: map['availabilityType'] as String,
      backupConfiguration: BackupConfigurationResponse.fromMap(
      ...
      ipConfiguration: IpConfigurationResponse.fromMap(
      ...
      sqlServerAuditConfig: SqlServerAuditConfigResponse.fromMap(
