...
class IpMappingSqladminV1beta4 {
  ...
  final IpMappingTypeSqladminV1beta4? type;
  ...
  IpMappingSqladminV1beta4({this.ipAddress, this.timeToRetire, this.type});
  ...
  factory IpMappingSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return IpMappingSqladminV1beta4(
      ...
      type: map['type'] == null
          ? null
          : IpMappingTypeSqladminV1beta4.fromValue(map['type'] as String),
    );
  }
}
