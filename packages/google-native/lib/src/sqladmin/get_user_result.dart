...
class GetUserResult {
  ...
  factory GetUserResult.fromMap(Map<String, dynamic> map) {
    return GetUserResult(
      ...
      passwordPolicy: UserPasswordValidationPolicyResponse.fromMap((map['passwordPolicy'] as Map).cast<String, dynamic>()),
      project: map['project'] as String,
      sqlserverUserDetails: SqlServerUserDetailsResponse.fromMap((map['sqlserverUserDetails'] as Map).cast<String, dynamic>()),
