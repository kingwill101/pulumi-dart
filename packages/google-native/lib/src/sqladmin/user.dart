...
class User extends pulumi.CustomResource {
  ...
  User(
    ...
    this.passwordPolicy = registerOutput<UserPasswordValidationPolicyResponse>('passwordPolicy');
    this.project = registerOutput<String>('project');
    this.sqlserverUserDetails = registerOutput<SqlServerUserDetailsResponse>('sqlserverUserDetails');
