...
class IpConfigurationResponseSqladminV1beta4 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': pulumi.Input.encodeList<AclEntryResponseSqladminV1beta4, Map<String, dynamic>>(authorizedNetworks, (value) => value.toMap()),
  ...
  factory IpConfigurationResponseSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return IpConfigurationResponseSqladminV1beta4(
      ...
      authorizedNetworks: pulumi.Input.decodeList<AclEntryResponseSqladminV1beta4>(map['authorizedNetworks'], (value) => AclEntryResponseSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pscConfig: PscConfigResponseSqladminV1beta4.fromMap((map['pscConfig'] as Map).cast<String, dynamic>()),
