...
class IpConfigurationResponse {
  ...
  final List<AclEntryResponse> authorizedNetworks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': pulumi.Input.encodeList<AclEntryResponse, Map<String, dynamic>>(authorizedNetworks, (value) => value.toMap()),
  ...
  factory IpConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return IpConfigurationResponse(
      ...
      authorizedNetworks: pulumi.Input.decodeList<AclEntryResponse>(map['authorizedNetworks'], (value) => AclEntryResponse.fromMap((value as Map).cast<String, dynamic>())),
