...
class IpConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': ?authorizedNetworks == null ? null : pulumi.Input.encodeList<AclEntry, Map<String, dynamic>>(authorizedNetworks!, (value) => value.toMap()),
  ...
  factory IpConfiguration.fromMap(Map<String, dynamic> map) {
    return IpConfiguration(
      ...
      authorizedNetworks: map['authorizedNetworks'] == null ? null : pulumi.Input.decodeList<AclEntry>(map['authorizedNetworks'], (value) => AclEntry.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pscConfig: map['pscConfig'] == null ? null : PscConfig.fromMap((map['pscConfig'] as Map).cast<String, dynamic>()),
      requireSsl: map['requireSsl'] == null ? null : map['requireSsl'] as bool,
      sslMode: map['sslMode'] == null ? null : IpConfigurationSslMode.fromValue(map['sslMode'] as String),
    );
  }
}
