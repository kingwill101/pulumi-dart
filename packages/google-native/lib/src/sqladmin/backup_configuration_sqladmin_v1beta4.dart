...
class BackupConfigurationSqladminV1beta4 {
  ...
  factory BackupConfigurationSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return BackupConfigurationSqladminV1beta4(
      backupRetentionSettings: map['backupRetentionSettings'] == null ? null : BackupRetentionSettingsSqladminV1beta4.fromMap((map['backupRetentionSettings'] as Map).cast<String, dynamic>()),
