...
class UserArgs {
  ...
  UserArgs({
    ...
    UserType? type,
       ...
       passwordPolicy = pulumi
           .Input.asOptionalInput<UserPasswordValidationPolicy>(passwordPolicy),
       project = pulumi.Input.asOptionalInput<String>(project),
       sqlserverUserDetails = pulumi
           .Input.asOptionalInput<SqlServerUserDetails>(sqlserverUserDetails),
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      dualPasswordType: map['dualPasswordType'] == null
          ? null
          : UserDualPasswordType.fromValue(map['dualPasswordType'] as String),
      ...
      type: map['type'] == null
          ? null
          : UserType.fromValue(map['type'] as String),
    );
  }
}
