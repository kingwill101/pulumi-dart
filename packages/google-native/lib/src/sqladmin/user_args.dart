...
class UserArgs {
  ...
  UserArgs({
    UserDualPasswordType? dualPasswordType,
    String? etag,
    String? host,
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      dualPasswordType: map['dualPasswordType'] == null ? null : UserDualPasswordType.fromValue(map['dualPasswordType'] as String),
      ...
      passwordPolicy: map['passwordPolicy'] == null ? null : UserPasswordValidationPolicy.fromMap((map['passwordPolicy'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      sqlserverUserDetails: map['sqlserverUserDetails'] == null ? null : SqlServerUserDetails.fromMap((map['sqlserverUserDetails'] as Map).cast<String, dynamic>()),
      type: map['type'] == null ? null : UserType.fromValue(map['type'] as String),
    );
  }
}
