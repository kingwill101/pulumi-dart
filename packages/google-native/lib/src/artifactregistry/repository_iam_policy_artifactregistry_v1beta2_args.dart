...
class RepositoryIamPolicyArtifactregistryV1beta2Args {
  ...
  RepositoryIamPolicyArtifactregistryV1beta2Args({
    List<BindingArtifactregistryV1beta2>? bindings,
    String? etag,
    String? location,
    String? project,
  ...
  factory RepositoryIamPolicyArtifactregistryV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RepositoryIamPolicyArtifactregistryV1beta2Args(
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<BindingArtifactregistryV1beta2>(map['bindings'], (value) => BindingArtifactregistryV1beta2.fromMap((value as Map).cast<String, dynamic>())),
