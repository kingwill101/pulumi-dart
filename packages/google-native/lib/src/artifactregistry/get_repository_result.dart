...
class GetRepositoryResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['cleanupPolicies'] = cleanupPolicies;
    map['cleanupPolicyDryRun'] = cleanupPolicyDryRun;
    map['createTime'] = createTime;
    map['description'] = description;
    map['dockerConfig'] = dockerConfig.toMap();
    map['format'] = format;
    ...
    map['mode'] = mode;
    map['name'] = name;
    map['remoteRepositoryConfig'] = remoteRepositoryConfig.toMap();
    map['satisfiesPzs'] = satisfiesPzs;
    map['sizeBytes'] = sizeBytes;
    map['updateTime'] = updateTime;
    map['virtualRepositoryConfig'] = virtualRepositoryConfig.toMap();
    return map;
  }
  ...
  factory GetRepositoryResult.fromMap(Map<String, dynamic> map) {
    return GetRepositoryResult(
      ...
      dockerConfig: DockerRepositoryConfigResponse.fromMap(
          (map['dockerConfig'] as Map).cast<String, dynamic>()),
      format: map['format'] as String,
      kmsKeyName: map['kmsKeyName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      mavenConfig: MavenRepositoryConfigResponse.fromMap(
          (map['mavenConfig'] as Map).cast<String, dynamic>()),
      mode: map['mode'] as String,
      name: map['name'] as String,
      remoteRepositoryConfig: RemoteRepositoryConfigResponse.fromMap(
      ...
      virtualRepositoryConfig: VirtualRepositoryConfigResponse.fromMap(
