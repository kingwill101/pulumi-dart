...
/// {@template pulumi_artifactregistry_v1beta2_repository_iam_member_artifactregistry_v1beta2_args_doc}
/// The set of arguments for RepositoryIamMember.
/// {@endtemplate}
/// {@macro pulumi_artifactregistry_v1beta2_repository_iam_member_artifactregistry_v1beta2_args_doc}
class RepositoryIamMemberArtifactregistryV1beta2Args {
  ...
  /// Creates a new [RepositoryIamMemberArtifactregistryV1beta2Args].
  ...
  RepositoryIamMemberArtifactregistryV1beta2Args({
    Condition? condition,
  ...
  factory RepositoryIamMemberArtifactregistryV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RepositoryIamMemberArtifactregistryV1beta2Args(
