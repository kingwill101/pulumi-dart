...
class Repository extends pulumi.CustomResource {
  ...
  Repository(
    ...
    this.cleanupPolicies = registerOutput<Map<String, String>>('cleanupPolicies');
    this.cleanupPolicyDryRun = registerOutput<bool>('cleanupPolicyDryRun');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String>('description');
    this.dockerConfig = registerOutput<DockerRepositoryConfigResponse>('dockerConfig');
    this.format = registerOutput<String>('format');
    this.kmsKeyName = registerOutput<String>('kmsKeyName');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.mavenConfig = registerOutput<MavenRepositoryConfigResponse>('mavenConfig');
    this.mode = registerOutput<String>('mode');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.remoteRepositoryConfig = registerOutput<RemoteRepositoryConfigResponse>('remoteRepositoryConfig');
    ...
    this.virtualRepositoryConfig = registerOutput<VirtualRepositoryConfigResponse>('virtualRepositoryConfig');
  }
}
