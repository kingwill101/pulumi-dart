...
class Repository extends pulumi.CustomResource {
  ...
  Repository(
    ...
    this.cleanupPolicies = registerOutput<Map<String, String>>(
      'cleanupPolicies',
    );
    this.cleanupPolicyDryRun = registerOutput<bool>('cleanupPolicyDryRun');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String>('description');
    this.dockerConfig = registerOutput<DockerRepositoryConfigResponse>(
      'dockerConfig',
    );
    ...
    this.mavenConfig = registerOutput<MavenRepositoryConfigResponse>(
      'mavenConfig',
    );
