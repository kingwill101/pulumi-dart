...
class ContactCenterArgs {
  ...
  ContactCenterArgs({
    ...
    String? userEmail,
       ...
       ccaipManagedUsers = pulumi.Input.asOptionalInput<bool>(
         ccaipManagedUsers,
       ),
       contactCenterId = pulumi.Input.asInput<String>(contactCenterId),
       customerDomainPrefix = pulumi.Input.asInput<String>(
         customerDomainPrefix,
       ),
       displayName = pulumi.Input.asInput<String>(displayName),
       instanceConfig = pulumi.Input.asOptionalInput<InstanceConfig>(
         instanceConfig,
       ),
