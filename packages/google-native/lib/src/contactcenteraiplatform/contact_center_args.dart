...
class ContactCenterArgs {
  ...
  ContactCenterArgs({
    ...
    String? userEmail,
        ...
        ccaipManagedUsers =
            pulumi.Input.asOptionalInput<bool>(ccaipManagedUsers),
        contactCenterId = pulumi.Input.asInput<String>(contactCenterId),
        customerDomainPrefix =
            pulumi.Input.asInput<String>(customerDomainPrefix),
        displayName = pulumi.Input.asInput<String>(displayName),
        instanceConfig =
            pulumi.Input.asOptionalInput<InstanceConfig>(instanceConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (instanceConfigValue != null) {
      map['instanceConfig'] = pulumi.Input.mapOptionalInputValue<InstanceConfig,
  ...
  factory ContactCenterArgs.fromMap(Map<String, dynamic> map) {
    return ContactCenterArgs(
      adminUser: map['adminUser'] == null
          ? null
          : AdminUser.fromMap(
              (map['adminUser'] as Map).cast<String, dynamic>()),
      ccaipManagedUsers: map['ccaipManagedUsers'] == null
          ? null
          : map['ccaipManagedUsers'] as bool,
      ...
      samlParams: map['samlParams'] == null
          ? null
          : SAMLParams.fromMap(
