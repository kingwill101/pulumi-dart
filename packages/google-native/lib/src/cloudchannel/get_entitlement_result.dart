...
class GetEntitlementResult {
  ...
  /// [createTime] The time at which the entitlement is created.
  /// [name] Resource name of an entitlement in the form: accounts/{account_id}/customers/{customer_id}/entitlements/{entitlement_id}.
  ...
  /// [provisionedService] Service provisioning details for the entitlement.
  /// [provisioningState] Current provisioning state of the entitlement.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'associationInfo': associationInfo.toMap(),
      'billingAccount': billingAccount,
      'commitmentSettings': commitmentSettings.toMap(),
      'createTime': createTime,
      'name': name,
      'offer': offer,
      'parameters': pulumi.Input.encodeList<GoogleCloudChannelV1ParameterResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'provisionedService': provisionedService.toMap(),
      'provisioningState': provisioningState,
      'purchaseOrderId': purchaseOrderId,
      'suspensionReasons': suspensionReasons,
      'trialSettings': trialSettings.toMap(),
  ...
  factory GetEntitlementResult.fromMap(Map<String, dynamic> map) {
    return GetEntitlementResult(
      associationInfo: GoogleCloudChannelV1AssociationInfoResponse.fromMap((map['associationInfo'] as Map).cast<String, dynamic>()),
      billingAccount: map['billingAccount'] as String,
      commitmentSettings: GoogleCloudChannelV1CommitmentSettingsResponse.fromMap((map['commitmentSettings'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      name: map['name'] as String,
      offer: map['offer'] as String,
      parameters: pulumi.Input.decodeList<GoogleCloudChannelV1ParameterResponse>(map['parameters'], (value) => GoogleCloudChannelV1ParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
      provisionedService: GoogleCloudChannelV1ProvisionedServiceResponse.fromMap((map['provisionedService'] as Map).cast<String, dynamic>()),
      provisioningState: map['provisioningState'] as String,
      purchaseOrderId: map['purchaseOrderId'] as String,
      suspensionReasons: (map['suspensionReasons'] as List).cast<String>(),
      trialSettings: GoogleCloudChannelV1TrialSettingsResponse.fromMap((map['trialSettings'] as Map).cast<String, dynamic>()),
