...
class EntitlementArgs {
  ...
  EntitlementArgs({
    ...
    String? requestId,
        ...
        commitmentSettings = pulumi.Input.asOptionalInput<
            GoogleCloudChannelV1CommitmentSettings>(commitmentSettings),
  ...
  factory EntitlementArgs.fromMap(Map<String, dynamic> map) {
    return EntitlementArgs(
      ...
      associationInfo: map['associationInfo'] == null
          ? null
      ...
      commitmentSettings: map['commitmentSettings'] == null
          ? null
      ...
      purchaseOrderId: map['purchaseOrderId'] == null
          ? null
          : map['purchaseOrderId'] as String,
