...
class CustomerArgs {
  ...
  factory CustomerArgs.fromMap(Map<String, dynamic> map) {
    return CustomerArgs(
      ...
      alternateEmail: map['alternateEmail'] == null ? null : map['alternateEmail'] as String,
      channelPartnerId: map['channelPartnerId'] == null ? null : map['channelPartnerId'] as String,
      ...
      orgPostalAddress: GoogleTypePostalAddress.fromMap((map['orgPostalAddress'] as Map).cast<String, dynamic>()),
      primaryContactInfo: map['primaryContactInfo'] == null ? null : GoogleCloudChannelV1ContactInfo.fromMap((map['primaryContactInfo'] as Map).cast<String, dynamic>()),
    );
  }
}
