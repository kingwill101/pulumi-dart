...
class CustomerArgs {
  ...
  CustomerArgs({
    ...
    GoogleCloudChannelV1ContactInfo? primaryContactInfo,
        ...
        channelPartnerId =
            pulumi.Input.asOptionalInput<String>(channelPartnerId),
        ...
        orgPostalAddress =
            pulumi.Input.asInput<GoogleTypePostalAddress>(orgPostalAddress),
        primaryContactInfo =
  ...
  factory CustomerArgs.fromMap(Map<String, dynamic> map) {
    return CustomerArgs(
      ...
      correlationId:
          map['correlationId'] == null ? null : map['correlationId'] as String,
