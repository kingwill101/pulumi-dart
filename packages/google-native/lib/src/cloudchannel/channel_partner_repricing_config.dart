...
class ChannelPartnerRepricingConfig extends pulumi.CustomResource {
  ...
  /// Creates a new [ChannelPartnerRepricingConfig].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ChannelPartnerRepricingConfig]. {@macro pulumi_cloudchannel_v1_channel_partner_repricing_config_args_doc}
