...
class GetCustomerResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['alternateEmail'] = alternateEmail;
    map['channelPartnerId'] = channelPartnerId;
    map['cloudIdentityId'] = cloudIdentityId;
    map['cloudIdentityInfo'] = cloudIdentityInfo.toMap();
    ...
    map['orgPostalAddress'] = orgPostalAddress.toMap();
    map['primaryContactInfo'] = primaryContactInfo.toMap();
