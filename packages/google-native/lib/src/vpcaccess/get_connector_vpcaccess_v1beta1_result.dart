...
class GetConnectorVpcaccessV1beta1Result {
  ...
  final SubnetResponseVpcaccessV1beta1 subnet;

  /// Creates a new [GetConnectorVpcaccessV1beta1Result].
  ...
  GetConnectorVpcaccessV1beta1Result({
  ...
  factory GetConnectorVpcaccessV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetConnectorVpcaccessV1beta1Result(
      ...
      subnet: SubnetResponseVpcaccessV1beta1.fromMap((map['subnet'] as Map).cast<String, dynamic>()),
    );
  }
}
