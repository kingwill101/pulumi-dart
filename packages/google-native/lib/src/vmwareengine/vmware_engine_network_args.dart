...
class VmwareEngineNetworkArgs {
  ...
  VmwareEngineNetworkArgs({
    ...
    required String vmwareEngineNetworkId,
       ...
       vmwareEngineNetworkId = pulumi.Input.asInput<String>(
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<VmwareEngineNetworkType, String>(
        type,
        (value) => value.value,
      ),
  ...
  factory VmwareEngineNetworkArgs.fromMap(Map<String, dynamic> map) {
    return VmwareEngineNetworkArgs(
      ...
      type: VmwareEngineNetworkType.fromValue(map['type'] as String),
