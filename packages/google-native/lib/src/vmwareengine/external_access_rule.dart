...
class ExternalAccessRule extends pulumi.CustomResource {
  ...
  ExternalAccessRule(
    ...
    this.destinationIpRanges = registerOutput<List<IpRangeResponse>>('destinationIpRanges');
    ...
    this.sourceIpRanges = registerOutput<List<IpRangeResponse>>('sourceIpRanges');
