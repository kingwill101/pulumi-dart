...
/// {@template pulumi_vmwareengine_v1_private_cloud_cluster_iam_member_args_doc}
/// The set of arguments for PrivateCloudClusterIamMember.
/// {@endtemplate}
/// {@macro pulumi_vmwareengine_v1_private_cloud_cluster_iam_member_args_doc}
class PrivateCloudClusterIamMemberArgs {
  ...
  /// Creates a new [PrivateCloudClusterIamMemberArgs].
  ...
  PrivateCloudClusterIamMemberArgs({
    Condition? condition,
  ...
  factory PrivateCloudClusterIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudClusterIamMemberArgs(
