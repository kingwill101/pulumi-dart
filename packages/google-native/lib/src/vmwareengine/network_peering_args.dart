...
class NetworkPeeringArgs {
  ...
  NetworkPeeringArgs({
    ...
    required String vmwareEngineNetwork,
        ...
        exchangeSubnetRoutes =
            pulumi.Input.asOptionalInput<bool>(exchangeSubnetRoutes),
        exportCustomRoutes =
            pulumi.Input.asOptionalInput<bool>(exportCustomRoutes),
        exportCustomRoutesWithPublicIp =
            pulumi.Input.asOptionalInput<bool>(exportCustomRoutesWithPublicIp),
        importCustomRoutes =
            pulumi.Input.asOptionalInput<bool>(importCustomRoutes),
        importCustomRoutesWithPublicIp =
            pulumi.Input.asOptionalInput<bool>(importCustomRoutesWithPublicIp),
  ...
  factory NetworkPeeringArgs.fromMap(Map<String, dynamic> map) {
    return NetworkPeeringArgs(
      ...
      exchangeSubnetRoutes: map['exchangeSubnetRoutes'] == null
          ? null
          : map['exchangeSubnetRoutes'] as bool,
      exportCustomRoutes: map['exportCustomRoutes'] == null
          ? null
          : map['exportCustomRoutes'] as bool,
      exportCustomRoutesWithPublicIp:
          map['exportCustomRoutesWithPublicIp'] == null
              ? null
      ...
      importCustomRoutesWithPublicIp:
          map['importCustomRoutesWithPublicIp'] == null
              ? null
      ...
      peerNetworkType: NetworkPeeringPeerNetworkType.fromValue(
          map['peerNetworkType'] as String),
