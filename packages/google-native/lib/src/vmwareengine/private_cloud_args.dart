...
class PrivateCloudArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': ?pulumi.Input.mapOptionalInputValue<PrivateCloudType, String>(type, (value) => value.value),
    };
  }
  ...
  factory PrivateCloudArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudArgs(
      ...
      networkConfig: NetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      privateCloudId: map['privateCloudId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      type: map['type'] == null ? null : PrivateCloudType.fromValue(map['type'] as String),
    );
  }
}
