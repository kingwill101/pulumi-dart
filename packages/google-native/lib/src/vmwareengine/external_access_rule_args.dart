...
class ExternalAccessRuleArgs {
  ...
  ExternalAccessRuleArgs({
    ...
    List<String>? sourcePorts,
        ...
        destinationIpRanges =
            pulumi.Input.asOptionalInput<List<IpRange>>(destinationIpRanges),
        destinationPorts =
            pulumi.Input.asOptionalInput<List<String>>(destinationPorts),
        ...
        sourceIpRanges =
            pulumi.Input.asOptionalInput<List<IpRange>>(sourceIpRanges),
  ...
  factory ExternalAccessRuleArgs.fromMap(Map<String, dynamic> map) {
    return ExternalAccessRuleArgs(
      action: map['action'] == null
          ? null
          : ExternalAccessRuleAction.fromValue(map['action'] as String),
      description:
          map['description'] == null ? null : map['description'] as String,
      destinationIpRanges: map['destinationIpRanges'] == null
          ? null
          : pulumi.Input.decodeList<IpRange>(
              map['destinationIpRanges'],
              (value) =>
                  IpRange.fromMap((value as Map).cast<String, dynamic>())),
