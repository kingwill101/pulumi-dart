...
class LoggingServerArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'protocol': pulumi.Input.mapInputValue<LoggingServerProtocol, String>(
        protocol,
        (value) => value.value,
      ),
      'requestId': ?requestId,
      'sourceType': pulumi.Input.mapInputValue<LoggingServerSourceType, String>(
        sourceType,
        (value) => value.value,
      ),
    };
  ...
  factory LoggingServerArgs.fromMap(Map<String, dynamic> map) {
    return LoggingServerArgs(
      ...
      sourceType: LoggingServerSourceType.fromValue(
