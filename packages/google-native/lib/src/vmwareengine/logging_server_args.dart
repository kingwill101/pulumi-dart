...
class LoggingServerArgs {
  ...
  LoggingServerArgs({
    ...
    String? project,
    required LoggingServerProtocol protocol,
    String? requestId,
    required LoggingServerSourceType sourceType,
  ...
  Map<String, dynamic> toMap() {
    ...
    map['protocol'] = pulumi.Input.mapInputValue<LoggingServerProtocol, String>(
    ...
    map['sourceType'] =
        pulumi.Input.mapInputValue<LoggingServerSourceType, String>(
  ...
  factory LoggingServerArgs.fromMap(Map<String, dynamic> map) {
    return LoggingServerArgs(
      ...
      protocol: LoggingServerProtocol.fromValue(map['protocol'] as String),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      sourceType:
          LoggingServerSourceType.fromValue(map['sourceType'] as String),
    );
  }
}
