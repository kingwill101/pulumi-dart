...
/// {@template pulumi_domains_v1alpha2_registration_iam_binding_domains_v1alpha2_args_doc}
/// The set of arguments for RegistrationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_domains_v1alpha2_registration_iam_binding_domains_v1alpha2_args_doc}
class RegistrationIamBindingDomainsV1alpha2Args {
  ...
  /// Creates a new [RegistrationIamBindingDomainsV1alpha2Args].
  ...
  RegistrationIamBindingDomainsV1alpha2Args({
    Condition? condition,
  ...
  factory RegistrationIamBindingDomainsV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return RegistrationIamBindingDomainsV1alpha2Args(
