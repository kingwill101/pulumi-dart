...
class MoneyDomainsV1alpha2 {
  ...
  /// Creates a new [MoneyDomainsV1alpha2].
  ...
  MoneyDomainsV1alpha2({this.currencyCode, this.nanos, this.units});
  ...
  factory MoneyDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return MoneyDomainsV1alpha2(
