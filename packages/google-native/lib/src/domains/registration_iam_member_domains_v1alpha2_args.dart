...
/// {@template pulumi_domains_v1alpha2_registration_iam_member_domains_v1alpha2_args_doc}
/// The set of arguments for RegistrationIamMember.
/// {@endtemplate}
/// {@macro pulumi_domains_v1alpha2_registration_iam_member_domains_v1alpha2_args_doc}
class RegistrationIamMemberDomainsV1alpha2Args {
  ...
  /// Creates a new [RegistrationIamMemberDomainsV1alpha2Args].
  ...
  RegistrationIamMemberDomainsV1alpha2Args({
    Condition? condition,
  ...
  factory RegistrationIamMemberDomainsV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return RegistrationIamMemberDomainsV1alpha2Args(
