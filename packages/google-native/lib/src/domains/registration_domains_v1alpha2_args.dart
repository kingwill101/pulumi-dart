...
class RegistrationDomainsV1alpha2Args {
  ...
  factory RegistrationDomainsV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return RegistrationDomainsV1alpha2Args(
      contactNotices: map['contactNotices'] == null ? null : pulumi.Input.decodeList<RegistrationContactNoticesItemDomainsV1alpha2>(map['contactNotices'], (value) => RegistrationContactNoticesItemDomainsV1alpha2.fromValue(value as String)),
      contactSettings: ContactSettingsDomainsV1alpha2.fromMap((map['contactSettings'] as Map).cast<String, dynamic>()),
      dnsSettings: map['dnsSettings'] == null ? null : DnsSettingsDomainsV1alpha2.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      domainName: map['domainName'] as String,
      domainNotices: map['domainNotices'] == null ? null : pulumi.Input.decodeList<RegistrationDomainNoticesItemDomainsV1alpha2>(map['domainNotices'], (value) => RegistrationDomainNoticesItemDomainsV1alpha2.fromValue(value as String)),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      managementSettings: map['managementSettings'] == null ? null : ManagementSettingsDomainsV1alpha2.fromMap((map['managementSettings'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      validateOnly: map['validateOnly'] == null ? null : map['validateOnly'] as bool,
      yearlyPrice: MoneyDomainsV1alpha2.fromMap((map['yearlyPrice'] as Map).cast<String, dynamic>()),
    );
  }
}
