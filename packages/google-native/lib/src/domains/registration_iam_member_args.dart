...
/// {@template pulumi_domains_v1_registration_iam_member_args_doc}
/// The set of arguments for RegistrationIamMember.
/// {@endtemplate}
/// {@macro pulumi_domains_v1_registration_iam_member_args_doc}
class RegistrationIamMemberArgs {
  ...
  /// Creates a new [RegistrationIamMemberArgs].
  ...
  factory RegistrationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegistrationIamMemberArgs(
