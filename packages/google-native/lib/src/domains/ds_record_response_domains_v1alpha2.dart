...
class DsRecordResponseDomainsV1alpha2 {
  ...
  /// Creates a new [DsRecordResponseDomainsV1alpha2].
  ...
  factory DsRecordResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return DsRecordResponseDomainsV1alpha2(
