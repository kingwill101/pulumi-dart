  ...
  factory RegistrationDomainsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RegistrationDomainsV1beta1Args(
      contactNotices: map['contactNotices'] == null
          ? null
          : pulumi
                .Input.decodeList<RegistrationContactNoticesItemDomainsV1beta1>(
              map['contactNotices'],
              (value) => RegistrationContactNoticesItemDomainsV1beta1.fromValue(
                value as String,
              ),
            ),
      contactSettings: ContactSettingsDomainsV1beta1.fromMap(
        (map['contactSettings'] as Map).cast<String, dynamic>(),
      ),
      dnsSettings: map['dnsSettings'] == null
          ? null
          : DnsSettingsDomainsV1beta1.fromMap(
      ...
      domainNotices: map['domainNotices'] == null
          ? null
          : pulumi
                .Input.decodeList<RegistrationDomainNoticesItemDomainsV1beta1>(
              map['domainNotices'],
              (value) => RegistrationDomainNoticesItemDomainsV1beta1.fromValue(
                value as String,
              ),
            ),
      ...
      managementSettings: map['managementSettings'] == null
          ? null
          : ManagementSettingsDomainsV1beta1.fromMap(
      ...
      yearlyPrice: MoneyDomainsV1beta1.fromMap(
