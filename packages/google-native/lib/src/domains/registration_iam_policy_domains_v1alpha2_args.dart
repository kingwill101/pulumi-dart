...
class RegistrationIamPolicyDomainsV1alpha2Args {
  ...
  RegistrationIamPolicyDomainsV1alpha2Args({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigDomainsV1alpha2>>(
                auditConfigs),
        bindings = pulumi.Input.asOptionalInput<List<BindingDomainsV1alpha2>>(
            bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigDomainsV1alpha2>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigDomainsV1alpha2,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingDomainsV1alpha2>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingDomainsV1alpha2,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory RegistrationIamPolicyDomainsV1alpha2Args.fromMap(
      Map<String, dynamic> map) {
    return RegistrationIamPolicyDomainsV1alpha2Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigDomainsV1alpha2>(
              map['auditConfigs'],
              (value) => AuditConfigDomainsV1alpha2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingDomainsV1alpha2>(
              map['bindings'],
              (value) => BindingDomainsV1alpha2.fromMap(
                  (value as Map).cast<String, dynamic>())),
