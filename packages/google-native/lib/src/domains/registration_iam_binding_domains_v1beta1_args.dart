...
/// {@template pulumi_domains_v1beta1_registration_iam_binding_domains_v1beta1_args_doc}
/// The set of arguments for RegistrationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_domains_v1beta1_registration_iam_binding_domains_v1beta1_args_doc}
class RegistrationIamBindingDomainsV1beta1Args {
  ...
  /// Creates a new [RegistrationIamBindingDomainsV1beta1Args].
  ...
  RegistrationIamBindingDomainsV1beta1Args({
    Condition? condition,
  ...
  factory RegistrationIamBindingDomainsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RegistrationIamBindingDomainsV1beta1Args(
