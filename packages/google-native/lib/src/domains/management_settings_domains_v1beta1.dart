...
class ManagementSettingsDomainsV1beta1 {
  ...
  final ManagementSettingsPreferredRenewalMethodDomainsV1beta1? preferredRenewalMethod;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'preferredRenewalMethod': ?preferredRenewalMethod == null ? null : preferredRenewalMethod!.value,
      'transferLockState': ?transferLockState == null ? null : transferLockState!.value,
    };
  }

  factory ManagementSettingsDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return ManagementSettingsDomainsV1beta1(
      preferredRenewalMethod: map['preferredRenewalMethod'] == null ? null : ManagementSettingsPreferredRenewalMethodDomainsV1beta1.fromValue(map['preferredRenewalMethod'] as String),
      transferLockState: map['transferLockState'] == null ? null : ManagementSettingsTransferLockStateDomainsV1beta1.fromValue(map['transferLockState'] as String),
    );
  }
}
