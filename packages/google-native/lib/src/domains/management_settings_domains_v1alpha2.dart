...
class ManagementSettingsDomainsV1alpha2 {
  ...
  final ManagementSettingsPreferredRenewalMethodDomainsV1alpha2? preferredRenewalMethod;
  ...
  factory ManagementSettingsDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return ManagementSettingsDomainsV1alpha2(
      preferredRenewalMethod: map['preferredRenewalMethod'] == null ? null : ManagementSettingsPreferredRenewalMethodDomainsV1alpha2.fromValue(map['preferredRenewalMethod'] as String),
      transferLockState: map['transferLockState'] == null ? null : ManagementSettingsTransferLockStateDomainsV1alpha2.fromValue(map['transferLockState'] as String),
    );
  }
}
