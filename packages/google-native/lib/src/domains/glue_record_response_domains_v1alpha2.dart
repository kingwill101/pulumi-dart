...
class GlueRecordResponseDomainsV1alpha2 {
  ...
  /// Creates a new [GlueRecordResponseDomainsV1alpha2].
  ...
  factory GlueRecordResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return GlueRecordResponseDomainsV1alpha2(
