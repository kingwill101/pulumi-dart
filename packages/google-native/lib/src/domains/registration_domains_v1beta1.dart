...
class RegistrationDomainsV1beta1 extends pulumi.CustomResource {
  ...
  RegistrationDomainsV1beta1(
    ...
    this.dnsSettings = registerOutput<DnsSettingsResponseDomainsV1beta1>(
      'dnsSettings',
    );
    ...
    this.registerFailureReason = registerOutput<String>(
      'registerFailureReason',
    );
    this.state = registerOutput<String>('state');
    this.supportedPrivacy = registerOutput<List<String>>('supportedPrivacy');
    this.transferFailureReason = registerOutput<String>(
