...
class RegistrationIamPolicyDomainsV1beta1Args {
  ...
  RegistrationIamPolicyDomainsV1beta1Args({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigDomainsV1beta1>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingDomainsV1beta1>>(bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigDomainsV1beta1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigDomainsV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingDomainsV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingDomainsV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory RegistrationIamPolicyDomainsV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return RegistrationIamPolicyDomainsV1beta1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigDomainsV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigDomainsV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingDomainsV1beta1>(
              map['bindings'],
              (value) => BindingDomainsV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
