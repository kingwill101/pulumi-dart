...
class Registration extends pulumi.CustomResource {
  ...
  Registration(
    ...
    this.contactSettings = registerOutput<ContactSettingsResponse>(
      'contactSettings',
    );
    ...
    this.managementSettings = registerOutput<ManagementSettingsResponse>(
      'managementSettings',
    );
    this.name = registerOutput<String>('name');
    this.pendingContactSettings = registerOutput<ContactSettingsResponse>(
