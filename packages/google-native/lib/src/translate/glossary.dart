...
class Glossary extends pulumi.CustomResource {
  ...
  Glossary(
    ...
    this.inputConfig = registerOutput<GlossaryInputConfigResponse>(
      'inputConfig',
    );
    this.languageCodesSet = registerOutput<LanguageCodesSetResponse>(
      'languageCodesSet',
    );
    this.languagePair = registerOutput<LanguageCodePairResponse>(
      'languagePair',
    );
