...
class GlossaryArgs {
  ...
  factory GlossaryArgs.fromMap(Map<String, dynamic> map) {
    return GlossaryArgs(
      ...
      inputConfig: GlossaryInputConfig.fromMap((map['inputConfig'] as Map).cast<String, dynamic>()),
      languageCodesSet: map['languageCodesSet'] == null ? null : LanguageCodesSet.fromMap((map['languageCodesSet'] as Map).cast<String, dynamic>()),
      languagePair: map['languagePair'] == null ? null : LanguageCodePair.fromMap((map['languagePair'] as Map).cast<String, dynamic>()),
