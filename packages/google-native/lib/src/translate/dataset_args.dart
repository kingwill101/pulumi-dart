...
class DatasetArgs {
  ...
  factory DatasetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetArgs(
      ...
      sourceLanguageCode: map['sourceLanguageCode'] == null ? null : map['sourceLanguageCode'] as String,
      targetLanguageCode: map['targetLanguageCode'] == null ? null : map['targetLanguageCode'] as String,
    );
  }
}
