...
class GlossaryTranslateV3beta1Args {
  ...
  factory GlossaryTranslateV3beta1Args.fromMap(Map<String, dynamic> map) {
    return GlossaryTranslateV3beta1Args(
      inputConfig: GlossaryInputConfigTranslateV3beta1.fromMap((map['inputConfig'] as Map).cast<String, dynamic>()),
      languageCodesSet: map['languageCodesSet'] == null ? null : LanguageCodesSetTranslateV3beta1.fromMap((map['languageCodesSet'] as Map).cast<String, dynamic>()),
      languagePair: map['languagePair'] == null ? null : LanguageCodePairTranslateV3beta1.fromMap((map['languagePair'] as Map).cast<String, dynamic>()),
