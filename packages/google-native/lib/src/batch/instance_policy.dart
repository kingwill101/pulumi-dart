...
class InstancePolicy {
  ...
  factory InstancePolicy.fromMap(Map<String, dynamic> map) {
    return InstancePolicy(
      ...
      bootDisk: map['bootDisk'] == null ? null : Disk.fromMap((map['bootDisk'] as Map).cast<String, dynamic>()),
      ...
      provisioningModel: map['provisioningModel'] == null ? null : InstancePolicyProvisioningModel.fromValue(map['provisioningModel'] as String),
