...
class Runnable {
  ...
  Map<String, dynamic> toMap() {
    ...
    final alwaysRunValue = alwaysRun;
    if (alwaysRunValue != null) {
      map['alwaysRun'] = alwaysRunValue;
    }
    final backgroundValue = background;
    if (backgroundValue != null) {
      map['background'] = backgroundValue;
    }
    final barrierValue = barrier;
    if (barrierValue != null) {
      map['barrier'] = barrierValue.toMap();
    }
    ...
    final ignoreExitStatusValue = ignoreExitStatus;
    if (ignoreExitStatusValue != null) {
      map['ignoreExitStatus'] = ignoreExitStatusValue;
    }
