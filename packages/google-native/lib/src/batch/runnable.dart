...
class Runnable {
  ...
  factory Runnable.fromMap(Map<String, dynamic> map) {
    return Runnable(
      ...
      barrier: map['barrier'] == null ? null : Barrier.fromMap((map['barrier'] as Map).cast<String, dynamic>()),
      ...
      ignoreExitStatus: map['ignoreExitStatus'] == null ? null : map['ignoreExitStatus'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      script: map['script'] == null ? null : Script.fromMap((map['script'] as Map).cast<String, dynamic>()),
