...
class ComputeResourceResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bootDiskMib'] = bootDiskMib;
    map['cpuMilli'] = cpuMilli;
    map['memoryMib'] = memoryMib;
    return map;
  }

  factory ComputeResourceResponse.fromMap(Map<String, dynamic> map) {
    return ComputeResourceResponse(
      bootDiskMib: map['bootDiskMib'] as String,
      cpuMilli: map['cpuMilli'] as String,
      memoryMib: map['memoryMib'] as String,
    );
  }
}
