...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      allocationPolicy: map['allocationPolicy'] == null ? null : AllocationPolicy.fromMap((map['allocationPolicy'] as Map).cast<String, dynamic>()),
      jobId: map['jobId'] == null ? null : map['jobId'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      logsPolicy: map['logsPolicy'] == null ? null : LogsPolicy.fromMap((map['logsPolicy'] as Map).cast<String, dynamic>()),
      notifications: map['notifications'] == null ? null : pulumi.Input.decodeList<JobNotification>(map['notifications'], (value) => JobNotification.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] == null ? null : map['priority'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      taskGroups: pulumi.Input.decodeList<TaskGroup>(map['taskGroups'], (value) => TaskGroup.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
