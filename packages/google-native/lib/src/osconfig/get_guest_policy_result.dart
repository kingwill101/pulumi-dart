...
class GetGuestPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': etag,
      'name': name,
      'packageRepositories': pulumi.Input.encodeList<PackageRepositoryResponse, Map<String, dynamic>>(packageRepositories, (value) => value.toMap()),
      'packages': pulumi.Input.encodeList<PackageResponse, Map<String, dynamic>>(packages, (value) => value.toMap()),
      'recipes': pulumi.Input.encodeList<SoftwareRecipeResponse, Map<String, dynamic>>(recipes, (value) => value.toMap()),
  ...
  factory GetGuestPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetGuestPolicyResult(
      assignment: AssignmentResponse.fromMap((map['assignment'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      etag: map['etag'] as String,
      name: map['name'] as String,
      packageRepositories: pulumi.Input.decodeList<PackageRepositoryResponse>(map['packageRepositories'], (value) => PackageRepositoryResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      recipes: pulumi.Input.decodeList<SoftwareRecipeResponse>(map['recipes'], (value) => SoftwareRecipeResponse.fromMap((value as Map).cast<String, dynamic>())),
