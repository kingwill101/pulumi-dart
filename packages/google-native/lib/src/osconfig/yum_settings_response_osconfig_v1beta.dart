...
class YumSettingsResponseOsconfigV1beta {
  ...
  /// Creates a new [YumSettingsResponseOsconfigV1beta].
  ...
  factory YumSettingsResponseOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return YumSettingsResponseOsconfigV1beta(
