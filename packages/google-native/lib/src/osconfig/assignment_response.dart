...
class AssignmentResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groupLabels': pulumi.Input.encodeList<AssignmentGroupLabelResponse, Map<String, dynamic>>(groupLabels, (value) => value.toMap()),
      'instanceNamePrefixes': instanceNamePrefixes,
      'instances': instances,
      'osTypes': pulumi.Input.encodeList<AssignmentOsTypeResponse, Map<String, dynamic>>(osTypes, (value) => value.toMap()),
      'zones': zones,
    };
  }
  ...
  factory AssignmentResponse.fromMap(Map<String, dynamic> map) {
    return AssignmentResponse(
      groupLabels: pulumi.Input.decodeList<AssignmentGroupLabelResponse>(map['groupLabels'], (value) => AssignmentGroupLabelResponse.fromMap((value as Map).cast<String, dynamic>())),
      instanceNamePrefixes: (map['instanceNamePrefixes'] as List).cast<String>(),
      instances: (map['instances'] as List).cast<String>(),
      osTypes: pulumi.Input.decodeList<AssignmentOsTypeResponse>(map['osTypes'], (value) => AssignmentOsTypeResponse.fromMap((value as Map).cast<String, dynamic>())),
