...
class OSPolicyInventoryFilterResponse {
  /// The OS short name
  ...
  /// Creates a new [OSPolicyInventoryFilterResponse].
  ...
  factory OSPolicyInventoryFilterResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyInventoryFilterResponse(
