...
class OsPolicyAssignmentArgs {
  ...
  factory OsPolicyAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentArgs(
      ...
      instanceFilter: OSPolicyAssignmentInstanceFilter.fromMap((map['instanceFilter'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      osPolicies: pulumi.Input.decodeList<OSPolicy>(map['osPolicies'], (value) => OSPolicy.fromMap((value as Map).cast<String, dynamic>())),
      osPolicyAssignmentId: map['osPolicyAssignmentId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rollout: OSPolicyAssignmentRollout.fromMap((map['rollout'] as Map).cast<String, dynamic>()),
    );
  }
}
