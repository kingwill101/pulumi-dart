...
class PatchRolloutOsconfigV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'disruptionBudget': ?disruptionBudget == null ? null : disruptionBudget!.toMap(),
  ...
  factory PatchRolloutOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return PatchRolloutOsconfigV1beta(
      disruptionBudget: map['disruptionBudget'] == null ? null : FixedOrPercentOsconfigV1beta.fromMap((map['disruptionBudget'] as Map).cast<String, dynamic>()),
      mode: map['mode'] == null ? null : PatchRolloutModeOsconfigV1beta.fromValue(map['mode'] as String),
    );
  }
}
