...
class PatchDeploymentOsconfigV1betaArgs {
  ...
  factory PatchDeploymentOsconfigV1betaArgs.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentOsconfigV1betaArgs(
      ...
      instanceFilter: PatchInstanceFilterOsconfigV1beta.fromMap((map['instanceFilter'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      oneTimeSchedule: OneTimeScheduleOsconfigV1beta.fromMap((map['oneTimeSchedule'] as Map).cast<String, dynamic>()),
      patchConfig: map['patchConfig'] == null ? null : PatchConfigOsconfigV1beta.fromMap((map['patchConfig'] as Map).cast<String, dynamic>()),
      patchDeploymentId: map['patchDeploymentId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      recurringSchedule: RecurringScheduleOsconfigV1beta.fromMap((map['recurringSchedule'] as Map).cast<String, dynamic>()),
      rollout: map['rollout'] == null ? null : PatchRolloutOsconfigV1beta.fromMap((map['rollout'] as Map).cast<String, dynamic>()),
    );
  }
}
