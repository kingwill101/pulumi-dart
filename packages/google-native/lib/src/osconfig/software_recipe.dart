...
class SoftwareRecipe {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'artifacts': ?artifacts == null ? null : pulumi.Input.encodeList<SoftwareRecipeArtifact, Map<String, dynamic>>(artifacts!, (value) => value.toMap()),
      'desiredState': ?desiredState == null ? null : desiredState!.value,
      'installSteps': ?installSteps == null ? null : pulumi.Input.encodeList<SoftwareRecipeStep, Map<String, dynamic>>(installSteps!, (value) => value.toMap()),
      'name': name,
      'updateSteps': ?updateSteps == null ? null : pulumi.Input.encodeList<SoftwareRecipeStep, Map<String, dynamic>>(updateSteps!, (value) => value.toMap()),
      'version': ?version,
    };
  }
  ...
  factory SoftwareRecipe.fromMap(Map<String, dynamic> map) {
    return SoftwareRecipe(
      artifacts: map['artifacts'] == null ? null : pulumi.Input.decodeList<SoftwareRecipeArtifact>(map['artifacts'], (value) => SoftwareRecipeArtifact.fromMap((value as Map).cast<String, dynamic>())),
      desiredState: map['desiredState'] == null ? null : SoftwareRecipeDesiredState.fromValue(map['desiredState'] as String),
      installSteps: map['installSteps'] == null ? null : pulumi.Input.decodeList<SoftwareRecipeStep>(map['installSteps'], (value) => SoftwareRecipeStep.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      updateSteps: map['updateSteps'] == null ? null : pulumi.Input.decodeList<SoftwareRecipeStep>(map['updateSteps'], (value) => SoftwareRecipeStep.fromMap((value as Map).cast<String, dynamic>())),
