...
class GuestPolicyArgs {
  ...
  factory GuestPolicyArgs.fromMap(Map<String, dynamic> map) {
    return GuestPolicyArgs(
      assignment: Assignment.fromMap((map['assignment'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      guestPolicyId: map['guestPolicyId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      packageRepositories: map['packageRepositories'] == null ? null : pulumi.Input.decodeList<PackageRepository>(map['packageRepositories'], (value) => PackageRepository.fromMap((value as Map).cast<String, dynamic>())),
      ...
      recipes: map['recipes'] == null ? null : pulumi.Input.decodeList<SoftwareRecipe>(map['recipes'], (value) => SoftwareRecipe.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
