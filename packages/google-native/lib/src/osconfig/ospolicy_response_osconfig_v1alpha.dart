...
class OSPolicyResponseOsconfigV1alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': mode,
      'resourceGroups': pulumi.Input.encodeList<OSPolicyResourceGroupResponseOsconfigV1alpha, Map<String, dynamic>>(resourceGroups, (value) => value.toMap()),
    };
  }
  ...
  factory OSPolicyResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResponseOsconfigV1alpha(
      ...
      resourceGroups: pulumi.Input.decodeList<OSPolicyResourceGroupResponseOsconfigV1alpha>(map['resourceGroups'], (value) => OSPolicyResourceGroupResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
