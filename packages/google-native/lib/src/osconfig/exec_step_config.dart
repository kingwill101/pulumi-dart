...
class ExecStepConfig {
  ...
  factory ExecStepConfig.fromMap(Map<String, dynamic> map) {
    return ExecStepConfig(
      ...
      gcsObject: map['gcsObject'] == null ? null : GcsObject.fromMap((map['gcsObject'] as Map).cast<String, dynamic>()),
      interpreter: map['interpreter'] == null ? null : ExecStepConfigInterpreter.fromValue(map['interpreter'] as String),
