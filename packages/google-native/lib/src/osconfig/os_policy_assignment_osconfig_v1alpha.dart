...
class OsPolicyAssignmentOsconfigV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha>
      instanceFilter;
  ...
  OsPolicyAssignmentOsconfigV1alpha(
    ...
    this.osPolicies =
        registerOutput<List<OSPolicyResponseOsconfigV1alpha>>('osPolicies');
    ...
    this.rollout =
        registerOutput<OSPolicyAssignmentRolloutResponseOsconfigV1alpha>(
            'rollout');
