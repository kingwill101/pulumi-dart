...
class ExecStepConfigOsconfigV1beta {
  ...
  factory ExecStepConfigOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return ExecStepConfigOsconfigV1beta(
      ...
      gcsObject: map['gcsObject'] == null ? null : GcsObjectOsconfigV1beta.fromMap((map['gcsObject'] as Map).cast<String, dynamic>()),
      interpreter: map['interpreter'] == null ? null : ExecStepConfigInterpreterOsconfigV1beta.fromValue(map['interpreter'] as String),
