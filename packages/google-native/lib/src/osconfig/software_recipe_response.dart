...
class SoftwareRecipeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'artifacts': pulumi.Input.encodeList<SoftwareRecipeArtifactResponse, Map<String, dynamic>>(artifacts, (value) => value.toMap()),
      'desiredState': desiredState,
      'installSteps': pulumi.Input.encodeList<SoftwareRecipeStepResponse, Map<String, dynamic>>(installSteps, (value) => value.toMap()),
      'name': name,
      'updateSteps': pulumi.Input.encodeList<SoftwareRecipeStepResponse, Map<String, dynamic>>(updateSteps, (value) => value.toMap()),
      'version': version,
    };
  }
  ...
  factory SoftwareRecipeResponse.fromMap(Map<String, dynamic> map) {
    return SoftwareRecipeResponse(
      artifacts: pulumi.Input.decodeList<SoftwareRecipeArtifactResponse>(map['artifacts'], (value) => SoftwareRecipeArtifactResponse.fromMap((value as Map).cast<String, dynamic>())),
      desiredState: map['desiredState'] as String,
      installSteps: pulumi.Input.decodeList<SoftwareRecipeStepResponse>(map['installSteps'], (value) => SoftwareRecipeStepResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      updateSteps: pulumi.Input.decodeList<SoftwareRecipeStepResponse>(map['updateSteps'], (value) => SoftwareRecipeStepResponse.fromMap((value as Map).cast<String, dynamic>())),
