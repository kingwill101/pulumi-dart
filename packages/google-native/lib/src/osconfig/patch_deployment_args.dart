...
class PatchDeploymentArgs {
  ...
  factory PatchDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentArgs(
      ...
      instanceFilter: PatchInstanceFilter.fromMap((map['instanceFilter'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      oneTimeSchedule: OneTimeSchedule.fromMap((map['oneTimeSchedule'] as Map).cast<String, dynamic>()),
      patchConfig: map['patchConfig'] == null ? null : PatchConfig.fromMap((map['patchConfig'] as Map).cast<String, dynamic>()),
      patchDeploymentId: map['patchDeploymentId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      recurringSchedule: RecurringSchedule.fromMap((map['recurringSchedule'] as Map).cast<String, dynamic>()),
      rollout: map['rollout'] == null ? null : PatchRollout.fromMap((map['rollout'] as Map).cast<String, dynamic>()),
    );
  }
}
