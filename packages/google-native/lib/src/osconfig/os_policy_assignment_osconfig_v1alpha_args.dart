...
class OsPolicyAssignmentOsconfigV1alphaArgs {
  ...
  final pulumi.Input<OSPolicyAssignmentInstanceFilterOsconfigV1alpha>
      instanceFilter;
  ...
  OsPolicyAssignmentOsconfigV1alphaArgs({
    String? description,
    String? etag,
    required OSPolicyAssignmentInstanceFilterOsconfigV1alpha instanceFilter,
    String? location,
    String? name,
    required List<OSPolicyOsconfigV1alpha> osPolicies,
    required String osPolicyAssignmentId,
    String? project,
    required OSPolicyAssignmentRolloutOsconfigV1alpha rollout,
  })  : description = pulumi.Input.asOptionalInput<String>(description),
        etag = pulumi.Input.asOptionalInput<String>(etag),
        instanceFilter = pulumi.Input.asInput<
            OSPolicyAssignmentInstanceFilterOsconfigV1alpha>(instanceFilter),
        location = pulumi.Input.asOptionalInput<String>(location),
        name = pulumi.Input.asOptionalInput<String>(name),
        osPolicies =
            pulumi.Input.asInput<List<OSPolicyOsconfigV1alpha>>(osPolicies),
        osPolicyAssignmentId =
            pulumi.Input.asInput<String>(osPolicyAssignmentId),
        project = pulumi.Input.asOptionalInput<String>(project),
        rollout =
            pulumi.Input.asInput<OSPolicyAssignmentRolloutOsconfigV1alpha>(
                rollout);
  ...
  Map<String, dynamic> toMap() {
    ...
    map['osPolicies'] = pulumi.Input.mapInputValue<
            List<OSPolicyOsconfigV1alpha>, List<Map<String, dynamic>>>(
        osPolicies,
        (value) => pulumi.Input.encodeList<OSPolicyOsconfigV1alpha,
    ...
    map['rollout'] = pulumi.Input.mapInputValue<
        OSPolicyAssignmentRolloutOsconfigV1alpha,
        Map<String, dynamic>>(rollout, (value) => value.toMap());
    return map;
  }

  factory OsPolicyAssignmentOsconfigV1alphaArgs.fromMap(
      Map<String, dynamic> map) {
    return OsPolicyAssignmentOsconfigV1alphaArgs(
      description:
          map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      instanceFilter: OSPolicyAssignmentInstanceFilterOsconfigV1alpha.fromMap(
          (map['instanceFilter'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      osPolicies: pulumi.Input.decodeList<OSPolicyOsconfigV1alpha>(
          map['osPolicies'],
          (value) => OSPolicyOsconfigV1alpha.fromMap(
              (value as Map).cast<String, dynamic>())),
      osPolicyAssignmentId: map['osPolicyAssignmentId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rollout: OSPolicyAssignmentRolloutOsconfigV1alpha.fromMap(
