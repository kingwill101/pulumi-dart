...
class OsPolicyAssignmentOsconfigV1alphaArgs {
  ...
  factory OsPolicyAssignmentOsconfigV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentOsconfigV1alphaArgs(
      ...
      instanceFilter: OSPolicyAssignmentInstanceFilterOsconfigV1alpha.fromMap((map['instanceFilter'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      osPolicies: pulumi.Input.decodeList<OSPolicyOsconfigV1alpha>(map['osPolicies'], (value) => OSPolicyOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>())),
      osPolicyAssignmentId: map['osPolicyAssignmentId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rollout: OSPolicyAssignmentRolloutOsconfigV1alpha.fromMap((map['rollout'] as Map).cast<String, dynamic>()),
    );
  }
}
