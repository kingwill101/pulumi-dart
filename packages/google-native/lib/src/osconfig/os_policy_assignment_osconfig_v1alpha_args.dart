...
class OsPolicyAssignmentOsconfigV1alphaArgs {
  ...
  OsPolicyAssignmentOsconfigV1alphaArgs({
    ...
    required OSPolicyAssignmentRolloutOsconfigV1alpha rollout,
       ...
       osPolicies = pulumi.Input.asInput<List<OSPolicyOsconfigV1alpha>>(
         osPolicies,
       ),
       ...
       rollout = pulumi.Input.asInput<OSPolicyAssignmentRolloutOsconfigV1alpha>(
         rollout,
       );
