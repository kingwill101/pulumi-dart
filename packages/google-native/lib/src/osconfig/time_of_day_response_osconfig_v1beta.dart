...
class TimeOfDayResponseOsconfigV1beta {
  ...
  /// Creates a new [TimeOfDayResponseOsconfigV1beta].
  ...
  factory TimeOfDayResponseOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return TimeOfDayResponseOsconfigV1beta(
