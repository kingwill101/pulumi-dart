...
class OSPolicyResourcePackageResource {
  ...
  factory OSPolicyResourcePackageResource.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourcePackageResource(
      apt: map['apt'] == null ? null : OSPolicyResourcePackageResourceAPT.fromMap((map['apt'] as Map).cast<String, dynamic>()),
      deb: map['deb'] == null ? null : OSPolicyResourcePackageResourceDeb.fromMap((map['deb'] as Map).cast<String, dynamic>()),
      desiredState: OSPolicyResourcePackageResourceDesiredState.fromValue(map['desiredState'] as String),
      googet: map['googet'] == null ? null : OSPolicyResourcePackageResourceGooGet.fromMap((map['googet'] as Map).cast<String, dynamic>()),
      msi: map['msi'] == null ? null : OSPolicyResourcePackageResourceMSI.fromMap((map['msi'] as Map).cast<String, dynamic>()),
      rpm: map['rpm'] == null ? null : OSPolicyResourcePackageResourceRPM.fromMap((map['rpm'] as Map).cast<String, dynamic>()),
      yum: map['yum'] == null ? null : OSPolicyResourcePackageResourceYUM.fromMap((map['yum'] as Map).cast<String, dynamic>()),
      zypper: map['zypper'] == null ? null : OSPolicyResourcePackageResourceZypper.fromMap((map['zypper'] as Map).cast<String, dynamic>()),
    );
  }
}
