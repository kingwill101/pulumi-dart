...
class SoftwareRecipeStepResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'archiveExtraction': archiveExtraction.toMap(),
      'dpkgInstallation': dpkgInstallation.toMap(),
      'fileCopy': fileCopy.toMap(),
      'fileExec': fileExec.toMap(),
      'msiInstallation': msiInstallation.toMap(),
      'rpmInstallation': rpmInstallation.toMap(),
      'scriptRun': scriptRun.toMap(),
    };
  }
