...
class ReportConfigMigrationcenterV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ReportConfigGroupPreferenceSetAssignmentResponseMigrationcenterV1alpha1>> groupPreferencesetAssignments;
  ...
  ReportConfigMigrationcenterV1alpha1(
    ...
    this.groupPreferencesetAssignments = registerOutput<List<ReportConfigGroupPreferenceSetAssignmentResponseMigrationcenterV1alpha1>>('groupPreferencesetAssignments');
