...
class SourceMigrationcenterV1alpha1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'sourceId': sourceId,
      'type': ?pulumi.Input.mapOptionalInputValue<SourceTypeMigrationcenterV1alpha1, String>(type, (value) => value.value),
    };
  }
  ...
  factory SourceMigrationcenterV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return SourceMigrationcenterV1alpha1Args(
      ...
      type: map['type'] == null ? null : SourceTypeMigrationcenterV1alpha1.fromValue(map['type'] as String),
    );
  }
}
