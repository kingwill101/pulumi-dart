...
class ReportConfigArgs {
  ...
  final pulumi.Input<List<ReportConfigGroupPreferenceSetAssignment>>
  ...
  ReportConfigArgs({
    String? description,
    String? displayName,
    required List<ReportConfigGroupPreferenceSetAssignment>
    groupPreferencesetAssignments,
    String? location,
    String? project,
    ...
    String? requestId,
       ...
       groupPreferencesetAssignments =
           pulumi.Input.asInput<List<ReportConfigGroupPreferenceSetAssignment>>(
             groupPreferencesetAssignments,
           ),
    ...
    return <String, dynamic>{
      ...
      'groupPreferencesetAssignments':
          pulumi.Input.mapInputValue<
            List<ReportConfigGroupPreferenceSetAssignment>,
  ...
  factory ReportConfigArgs.fromMap(Map<String, dynamic> map) {
    return ReportConfigArgs(
      ...
      groupPreferencesetAssignments:
          pulumi.Input.decodeList<ReportConfigGroupPreferenceSetAssignment>(
            map['groupPreferencesetAssignments'],
            (value) => ReportConfigGroupPreferenceSetAssignment.fromMap(
