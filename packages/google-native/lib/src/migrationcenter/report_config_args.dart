...
class ReportConfigArgs {
  ...
  ReportConfigArgs({
    String? description,
    String? displayName,
    required List<ReportConfigGroupPreferenceSetAssignment> groupPreferencesetAssignments,
    String? location,
    String? project,
  ...
  factory ReportConfigArgs.fromMap(Map<String, dynamic> map) {
    return ReportConfigArgs(
      ...
      groupPreferencesetAssignments: pulumi.Input.decodeList<ReportConfigGroupPreferenceSetAssignment>(map['groupPreferencesetAssignments'], (value) => ReportConfigGroupPreferenceSetAssignment.fromMap((value as Map).cast<String, dynamic>())),
