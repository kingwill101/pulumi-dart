...
class VirtualMachinePreferencesMigrationcenterV1alpha1 {
  ...
  final VirtualMachinePreferencesCommitmentPlanMigrationcenterV1alpha1? commitmentPlan;
  /// Compute Engine preferences concern insights and recommendations for Compute Engine target.
  final ComputeEnginePreferencesMigrationcenterV1alpha1? computeEnginePreferences;
  ...
  final VirtualMachinePreferencesSizingOptimizationCustomParameters? sizingOptimizationCustomParameters;
  /// Sizing optimization strategy specifies the preferred strategy used when extrapolating usage data to calculate insights and recommendations for a virtual machine. If you are unsure which value to set, a moderate sizing optimization strategy is often a good value to start with.
  final VirtualMachinePreferencesSizingOptimizationStrategyMigrationcenterV1alpha1? sizingOptimizationStrategy;
  /// Preferences concerning Sole Tenant nodes and virtual machines.
  final SoleTenancyPreferencesMigrationcenterV1alpha1? soleTenancyPreferences;
  /// Target product for assets using this preference set. Specify either target product or business goal, but not both.
  final VirtualMachinePreferencesTargetProductMigrationcenterV1alpha1? targetProduct;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkCostParameters': ?networkCostParameters == null ? null : networkCostParameters!.toMap(),
      'regionPreferences': ?regionPreferences == null ? null : regionPreferences!.toMap(),
      'sizingOptimizationCustomParameters': ?sizingOptimizationCustomParameters == null ? null : sizingOptimizationCustomParameters!.toMap(),
  ...
  factory VirtualMachinePreferencesMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePreferencesMigrationcenterV1alpha1(
      commitmentPlan: map['commitmentPlan'] == null ? null : VirtualMachinePreferencesCommitmentPlanMigrationcenterV1alpha1.fromValue(map['commitmentPlan'] as String),
      computeEnginePreferences: map['computeEnginePreferences'] == null ? null : ComputeEnginePreferencesMigrationcenterV1alpha1.fromMap((map['computeEnginePreferences'] as Map).cast<String, dynamic>()),
      networkCostParameters: map['networkCostParameters'] == null ? null : VirtualMachinePreferencesNetworkCostParameters.fromMap((map['networkCostParameters'] as Map).cast<String, dynamic>()),
      regionPreferences: map['regionPreferences'] == null ? null : RegionPreferencesMigrationcenterV1alpha1.fromMap((map['regionPreferences'] as Map).cast<String, dynamic>()),
      sizingOptimizationCustomParameters: map['sizingOptimizationCustomParameters'] == null ? null : VirtualMachinePreferencesSizingOptimizationCustomParameters.fromMap((map['sizingOptimizationCustomParameters'] as Map).cast<String, dynamic>()),
      sizingOptimizationStrategy: map['sizingOptimizationStrategy'] == null ? null : VirtualMachinePreferencesSizingOptimizationStrategyMigrationcenterV1alpha1.fromValue(map['sizingOptimizationStrategy'] as String),
      soleTenancyPreferences: map['soleTenancyPreferences'] == null ? null : SoleTenancyPreferencesMigrationcenterV1alpha1.fromMap((map['soleTenancyPreferences'] as Map).cast<String, dynamic>()),
      targetProduct: map['targetProduct'] == null ? null : VirtualMachinePreferencesTargetProductMigrationcenterV1alpha1.fromValue(map['targetProduct'] as String),
      vmwareEnginePreferences: map['vmwareEnginePreferences'] == null ? null : VmwareEnginePreferencesMigrationcenterV1alpha1.fromMap((map['vmwareEnginePreferences'] as Map).cast<String, dynamic>()),
    );
  }
}
