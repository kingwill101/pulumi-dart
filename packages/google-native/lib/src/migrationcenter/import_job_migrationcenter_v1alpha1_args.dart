...
class ImportJobMigrationcenterV1alpha1Args {
  ...
  factory ImportJobMigrationcenterV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ImportJobMigrationcenterV1alpha1Args(
      ...
      gcsPayload: map['gcsPayload'] == null ? null : GCSPayloadInfo.fromMap((map['gcsPayload'] as Map).cast<String, dynamic>()),
      importJobId: map['importJobId'] as String,
      inlinePayload: map['inlinePayload'] == null ? null : InlinePayloadInfo.fromMap((map['inlinePayload'] as Map).cast<String, dynamic>()),
