...
class ReportSummaryChartDataResponseMigrationcenterV1alpha1 {
  ...
  final List<ReportSummaryChartDataDataPointResponseMigrationcenterV1alpha1> dataPoints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataPoints': pulumi.Input.encodeList<ReportSummaryChartDataDataPointResponseMigrationcenterV1alpha1, Map<String, dynamic>>(dataPoints, (value) => value.toMap()),
    };
  }
  ...
  factory ReportSummaryChartDataResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return ReportSummaryChartDataResponseMigrationcenterV1alpha1(
      dataPoints: pulumi.Input.decodeList<ReportSummaryChartDataDataPointResponseMigrationcenterV1alpha1>(map['dataPoints'], (value) => ReportSummaryChartDataDataPointResponseMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
