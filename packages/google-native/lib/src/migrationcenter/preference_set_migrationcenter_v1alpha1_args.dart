...
class PreferenceSetMigrationcenterV1alpha1Args {
  ...
  factory PreferenceSetMigrationcenterV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return PreferenceSetMigrationcenterV1alpha1Args(
      ...
      preferenceSetId: map['preferenceSetId'] == null ? null : map['preferenceSetId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      virtualMachinePreferences: map['virtualMachinePreferences'] == null ? null : VirtualMachinePreferencesMigrationcenterV1alpha1.fromMap((map['virtualMachinePreferences'] as Map).cast<String, dynamic>()),
    );
  }
}
