...
class ImportDataFileMigrationcenterV1alpha1Args {
  ...
  ImportDataFileMigrationcenterV1alpha1Args({
    String? displayName,
    required ImportDataFileFormatMigrationcenterV1alpha1 format,
  ...
  factory ImportDataFileMigrationcenterV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ImportDataFileMigrationcenterV1alpha1Args(
      ...
      format: ImportDataFileFormatMigrationcenterV1alpha1.fromValue(map['format'] as String),
      importDataFileId: map['importDataFileId'] as String,
      importJobId: map['importJobId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      uploadFileInfo: map['uploadFileInfo'] == null ? null : (map['uploadFileInfo'] as Map).cast<String, dynamic>(),
    );
  }
}
