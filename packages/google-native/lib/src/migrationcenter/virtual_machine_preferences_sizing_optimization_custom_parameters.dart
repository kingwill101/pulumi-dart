...
class VirtualMachinePreferencesSizingOptimizationCustomParameters {
  ...
  final VirtualMachinePreferencesSizingOptimizationCustomParametersAggregationMethod? aggregationMethod;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregationMethod': ?aggregationMethod == null ? null : aggregationMethod!.value,
  ...
  factory VirtualMachinePreferencesSizingOptimizationCustomParameters.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePreferencesSizingOptimizationCustomParameters(
      aggregationMethod: map['aggregationMethod'] == null ? null : VirtualMachinePreferencesSizingOptimizationCustomParametersAggregationMethod.fromValue(map['aggregationMethod'] as String),
      cpuUsagePercentage: map['cpuUsagePercentage'] == null ? null : map['cpuUsagePercentage'] as int,
      memoryUsagePercentage: map['memoryUsagePercentage'] == null ? null : map['memoryUsagePercentage'] as int,
      storageMultiplier: map['storageMultiplier'] == null ? null : map['storageMultiplier'] as double,
    );
  }
}
