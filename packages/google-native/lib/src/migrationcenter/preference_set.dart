...
class PreferenceSet extends pulumi.CustomResource {
  ...
  late final pulumi.Output<VirtualMachinePreferencesResponse> virtualMachinePreferences;
  ...
  PreferenceSet(
    ...
    this.virtualMachinePreferences = registerOutput<VirtualMachinePreferencesResponse>('virtualMachinePreferences');
  }
}
