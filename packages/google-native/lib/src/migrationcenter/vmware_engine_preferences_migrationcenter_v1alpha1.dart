...
class VmwareEnginePreferencesMigrationcenterV1alpha1 {
  ...
  final VmwareEnginePreferencesCommitmentPlanMigrationcenterV1alpha1? commitmentPlan;
  ...
  factory VmwareEnginePreferencesMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return VmwareEnginePreferencesMigrationcenterV1alpha1(
      commitmentPlan: map['commitmentPlan'] == null ? null : VmwareEnginePreferencesCommitmentPlanMigrationcenterV1alpha1.fromValue(map['commitmentPlan'] as String),
