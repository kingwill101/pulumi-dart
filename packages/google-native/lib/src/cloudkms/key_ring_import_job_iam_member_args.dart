...
/// {@template pulumi_cloudkms_v1_key_ring_import_job_iam_member_args_doc}
/// The set of arguments for KeyRingImportJobIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_key_ring_import_job_iam_member_args_doc}
class KeyRingImportJobIamMemberArgs {
  ...
  /// Creates a new [KeyRingImportJobIamMemberArgs].
  ...
  factory KeyRingImportJobIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return KeyRingImportJobIamMemberArgs(
