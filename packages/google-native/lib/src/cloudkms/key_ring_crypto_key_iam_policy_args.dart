...
/// {@template pulumi_cloudkms_v1_key_ring_crypto_key_iam_policy_args_doc}
/// The set of arguments for KeyRingCryptoKeyIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_key_ring_crypto_key_iam_policy_args_doc}
class KeyRingCryptoKeyIamPolicyArgs {
  ...
  /// Creates a new [KeyRingCryptoKeyIamPolicyArgs].
  ...
  factory KeyRingCryptoKeyIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return KeyRingCryptoKeyIamPolicyArgs(
