...
class CryptoKeyVersionArgs {
  ...
  factory CryptoKeyVersionArgs.fromMap(Map<String, dynamic> map) {
    return CryptoKeyVersionArgs(
      ...
      externalProtectionLevelOptions: map['externalProtectionLevelOptions'] == null ? null : ExternalProtectionLevelOptions.fromMap((map['externalProtectionLevelOptions'] as Map).cast<String, dynamic>()),
      keyRingId: map['keyRingId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      state: map['state'] == null ? null : CryptoKeyVersionState.fromValue(map['state'] as String),
    );
  }
}
