...
class ServiceResolverResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostname': hostname,
      'serverCertificates': pulumi.Input.encodeList<CertificateResponse, Map<String, dynamic>>(serverCertificates, (value) => value.toMap()),
  ...
  factory ServiceResolverResponse.fromMap(Map<String, dynamic> map) {
    return ServiceResolverResponse(
      ...
      serverCertificates: pulumi.Input.decodeList<CertificateResponse>(map['serverCertificates'], (value) => CertificateResponse.fromMap((value as Map).cast<String, dynamic>())),
