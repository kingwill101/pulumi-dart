...
class CryptoKey extends pulumi.CustomResource {
  ...
  CryptoKey(
    ...
    this.destroyScheduledDuration = registerOutput<String>(
    ...
    this.skipInitialVersionCreation = registerOutput<bool?>(
      'skipInitialVersionCreation',
    );
    this.versionTemplate = registerOutput<CryptoKeyVersionTemplateResponse>(
      'versionTemplate',
    );
  }
}
