...
class EkmConnection extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [EkmConnection]. {@macro pulumi_cloudkms_v1_ekm_connection_args_doc}
  ...
  EkmConnection(
    ...
    this.serviceResolvers = registerOutput<List<ServiceResolverResponse>>(
      'serviceResolvers',
    );
  }
}
