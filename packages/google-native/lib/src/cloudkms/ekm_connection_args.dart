...
class EkmConnectionArgs {
    ...
    return <String, dynamic>{
      ...
      'keyManagementMode':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(keyManagementMode, (value) => value.value),
      'location': ?location,
      'project': ?project,
      'serviceResolvers':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory EkmConnectionArgs.fromMap(Map<String, dynamic> map) {
    return EkmConnectionArgs(
      ...
      ekmConnectionId: map['ekmConnectionId'] == null
          ? null
          : map['ekmConnectionId'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      keyManagementMode: map['keyManagementMode'] == null
          ? null
          : EkmConnectionKeyManagementMode.fromValue(
              map['keyManagementMode'] as String,
            ),
      location: map['location'] == null ? null : map['location'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      serviceResolvers: map['serviceResolvers'] == null
          ? null
          : pulumi.Input.decodeList<ServiceResolver>(
              map['serviceResolvers'],
              (value) => ServiceResolver.fromMap(
