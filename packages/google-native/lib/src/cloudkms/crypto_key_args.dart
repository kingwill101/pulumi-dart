...
class CryptoKeyArgs {
  ...
  CryptoKeyArgs({
    ...
    CryptoKeyVersionTemplate? versionTemplate,
            ...
            pulumi.Input.asOptionalInput<String>(cryptoKeyBackend),
        cryptoKeyId = pulumi.Input.asOptionalInput<String>(cryptoKeyId),
        destroyScheduledDuration =
            pulumi.Input.asOptionalInput<String>(destroyScheduledDuration),
        ...
        nextRotationTime =
            pulumi.Input.asOptionalInput<String>(nextRotationTime),
        ...
        skipInitialVersionCreation =
            pulumi.Input.asOptionalInput<bool>(skipInitialVersionCreation),
        versionTemplate =
            pulumi.Input.asOptionalInput<CryptoKeyVersionTemplate>(
                versionTemplate);
