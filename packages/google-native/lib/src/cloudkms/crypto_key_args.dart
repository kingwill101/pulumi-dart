...
class CryptoKeyArgs {
  ...
  CryptoKeyArgs({
    ...
    CryptoKeyVersionTemplate? versionTemplate,
      ...
      nextRotationTime = pulumi.Input.asOptionalInput<String>(nextRotationTime),
  ...
  factory CryptoKeyArgs.fromMap(Map<String, dynamic> map) {
    return CryptoKeyArgs(
      cryptoKeyBackend: map['cryptoKeyBackend'] == null ? null : map['cryptoKeyBackend'] as String,
      cryptoKeyId: map['cryptoKeyId'] == null ? null : map['cryptoKeyId'] as String,
      destroyScheduledDuration: map['destroyScheduledDuration'] == null ? null : map['destroyScheduledDuration'] as String,
      ...
      purpose: map['purpose'] == null ? null : CryptoKeyPurpose.fromValue(map['purpose'] as String),
      rotationPeriod: map['rotationPeriod'] == null ? null : map['rotationPeriod'] as String,
      skipInitialVersionCreation: map['skipInitialVersionCreation'] == null ? null : map['skipInitialVersionCreation'] as bool,
      versionTemplate: map['versionTemplate'] == null ? null : CryptoKeyVersionTemplate.fromMap((map['versionTemplate'] as Map).cast<String, dynamic>()),
    );
  }
}
