...
class CryptoKeyVersion extends pulumi.CustomResource {
  ...
  CryptoKeyVersion(
    ...
    this.attestation = registerOutput<KeyOperationAttestationResponse>('attestation');
    ...
    this.externalDestructionFailureReason = registerOutput<String>('externalDestructionFailureReason');
    this.externalProtectionLevelOptions = registerOutput<ExternalProtectionLevelOptionsResponse>('externalProtectionLevelOptions');
    this.generateTime = registerOutput<String>('generateTime');
    this.generationFailureReason = registerOutput<String>('generationFailureReason');
