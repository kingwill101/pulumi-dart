...
/// {@template pulumi_gkebackup_v1_backup_plan_backup_iam_member_args_doc}
/// The set of arguments for BackupPlanBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_backup_plan_backup_iam_member_args_doc}
class BackupPlanBackupIamMemberArgs {
  ...
  /// Creates a new [BackupPlanBackupIamMemberArgs].
  ...
  factory BackupPlanBackupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupIamMemberArgs(
