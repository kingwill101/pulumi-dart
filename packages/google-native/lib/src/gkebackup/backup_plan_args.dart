...
class BackupPlanArgs {
  ...
  factory BackupPlanArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanArgs(
      backupConfig: map['backupConfig'] == null ? null : BackupConfig.fromMap((map['backupConfig'] as Map).cast<String, dynamic>()),
      backupPlanId: map['backupPlanId'] as String,
      backupSchedule: map['backupSchedule'] == null ? null : Schedule.fromMap((map['backupSchedule'] as Map).cast<String, dynamic>()),
      cluster: map['cluster'] as String,
      deactivated: map['deactivated'] == null ? null : map['deactivated'] as bool,
