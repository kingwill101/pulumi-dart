...
class RestoreConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterResourceRestoreScope': clusterResourceRestoreScope.toMap(),
      'excludedNamespaces': excludedNamespaces.toMap(),
      ...
      'substitutionRules': pulumi.Input.encodeList<SubstitutionRuleResponse, Map<String, dynamic>>(substitutionRules, (value) => value.toMap()),
      'transformationRules': pulumi.Input.encodeList<TransformationRuleResponse, Map<String, dynamic>>(transformationRules, (value) => value.toMap()),
  ...
  factory RestoreConfigResponse.fromMap(Map<String, dynamic> map) {
    return RestoreConfigResponse(
      ...
      clusterResourceConflictPolicy: map['clusterResourceConflictPolicy'] as String,
      clusterResourceRestoreScope: ClusterResourceRestoreScopeResponse.fromMap((map['clusterResourceRestoreScope'] as Map).cast<String, dynamic>()),
      excludedNamespaces: NamespacesResponse.fromMap((map['excludedNamespaces'] as Map).cast<String, dynamic>()),
      namespacedResourceRestoreMode: map['namespacedResourceRestoreMode'] as String,
      ...
      substitutionRules: pulumi.Input.decodeList<SubstitutionRuleResponse>(map['substitutionRules'], (value) => SubstitutionRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
      transformationRules: pulumi.Input.decodeList<TransformationRuleResponse>(map['transformationRules'], (value) => TransformationRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
