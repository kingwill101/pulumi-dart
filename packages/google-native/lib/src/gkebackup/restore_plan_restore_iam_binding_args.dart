...
/// {@template pulumi_gkebackup_v1_restore_plan_restore_iam_binding_args_doc}
/// The set of arguments for RestorePlanRestoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_restore_plan_restore_iam_binding_args_doc}
class RestorePlanRestoreIamBindingArgs {
  ...
  /// Creates a new [RestorePlanRestoreIamBindingArgs].
  ...
  RestorePlanRestoreIamBindingArgs({
    Condition? condition,
  ...
  factory RestorePlanRestoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RestorePlanRestoreIamBindingArgs(
