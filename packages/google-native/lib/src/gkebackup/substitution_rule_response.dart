...
class SubstitutionRuleResponse {
  ...
  final List<GroupKindResponse> targetGroupKinds;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetGroupKinds': pulumi.Input.encodeList<GroupKindResponse, Map<String, dynamic>>(targetGroupKinds, (value) => value.toMap()),
  ...
  factory SubstitutionRuleResponse.fromMap(Map<String, dynamic> map) {
    return SubstitutionRuleResponse(
      ...
      originalValuePattern: map['originalValuePattern'] as String,
      targetGroupKinds: pulumi.Input.decodeList<GroupKindResponse>(map['targetGroupKinds'], (value) => GroupKindResponse.fromMap((value as Map).cast<String, dynamic>())),
      targetJsonPath: map['targetJsonPath'] as String,
      targetNamespaces: (map['targetNamespaces'] as List).cast<String>(),
    );
  }
}
