...
/// {@template pulumi_gkebackup_v1_backup_plan_backup_volume_backup_iam_policy_args_doc}
/// The set of arguments for BackupPlanBackupVolumeBackupIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_backup_plan_backup_volume_backup_iam_policy_args_doc}
class BackupPlanBackupVolumeBackupIamPolicyArgs {
  ...
  /// Creates a new [BackupPlanBackupVolumeBackupIamPolicyArgs].
  ...
  factory BackupPlanBackupVolumeBackupIamPolicyArgs.fromMap(Map<String, dynamic> map) {
