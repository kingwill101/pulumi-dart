...
/// {@template pulumi_gkebackup_v1_restore_plan_restore_volume_restore_iam_binding_args_doc}
/// The set of arguments for RestorePlanRestoreVolumeRestoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_restore_plan_restore_volume_restore_iam_binding_args_doc}
class RestorePlanRestoreVolumeRestoreIamBindingArgs {
  ...
  /// Creates a new [RestorePlanRestoreVolumeRestoreIamBindingArgs].
  ...
  RestorePlanRestoreVolumeRestoreIamBindingArgs({
    Condition? condition,
  ...
  factory RestorePlanRestoreVolumeRestoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RestorePlanRestoreVolumeRestoreIamBindingArgs(
