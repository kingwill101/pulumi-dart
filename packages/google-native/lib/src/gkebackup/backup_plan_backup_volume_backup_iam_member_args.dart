...
/// {@template pulumi_gkebackup_v1_backup_plan_backup_volume_backup_iam_member_args_doc}
/// The set of arguments for BackupPlanBackupVolumeBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_backup_plan_backup_volume_backup_iam_member_args_doc}
class BackupPlanBackupVolumeBackupIamMemberArgs {
  ...
  /// Creates a new [BackupPlanBackupVolumeBackupIamMemberArgs].
  ...
  BackupPlanBackupVolumeBackupIamMemberArgs({
    Condition? condition,
  ...
  factory BackupPlanBackupVolumeBackupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupVolumeBackupIamMemberArgs(
