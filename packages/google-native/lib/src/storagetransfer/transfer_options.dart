...
class TransferOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'overwriteWhen': ?overwriteWhen == null ? null : overwriteWhen!.value,
    };
  }
  ...
  factory TransferOptions.fromMap(Map<String, dynamic> map) {
    return TransferOptions(
      ...
      metadataOptions: map['metadataOptions'] == null ? null : MetadataOptions.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>()),
      ...
      overwriteWhen: map['overwriteWhen'] == null ? null : TransferOptionsOverwriteWhen.fromValue(map['overwriteWhen'] as String),
    );
  }
}
