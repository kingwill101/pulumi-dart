...
class AwsS3DataResponse {
  ...
  final AwsAccessKeyResponse awsAccessKey;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsAccessKey': awsAccessKey.toMap(),
  ...
  factory AwsS3DataResponse.fromMap(Map<String, dynamic> map) {
    return AwsS3DataResponse(
      awsAccessKey: AwsAccessKeyResponse.fromMap((map['awsAccessKey'] as Map).cast<String, dynamic>()),
      bucketName: map['bucketName'] as String,
      cloudfrontDomain: map['cloudfrontDomain'] as String,
