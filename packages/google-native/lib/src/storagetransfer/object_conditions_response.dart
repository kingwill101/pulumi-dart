...
class ObjectConditionsResponse {
  ...
  factory ObjectConditionsResponse.fromMap(Map<String, dynamic> map) {
    return ObjectConditionsResponse(
      excludePrefixes: (map['excludePrefixes'] as List).cast<String>(),
      includePrefixes: (map['includePrefixes'] as List).cast<String>(),
      lastModifiedBefore: map['lastModifiedBefore'] as String,
      lastModifiedSince: map['lastModifiedSince'] as String,
      maxTimeElapsedSinceLastModification: map['maxTimeElapsedSinceLastModification'] as String,
      minTimeElapsedSinceLastModification: map['minTimeElapsedSinceLastModification'] as String,
    );
  }
}
