...
class TransferJobArgs {
  ...
  factory TransferJobArgs.fromMap(Map<String, dynamic> map) {
    return TransferJobArgs(
      ...
      eventStream: map['eventStream'] == null ? null : EventStream.fromMap((map['eventStream'] as Map).cast<String, dynamic>()),
      latestOperationName: map['latestOperationName'] == null ? null : map['latestOperationName'] as String,
      ...
      status: map['status'] == null ? null : TransferJobStatus.fromValue(map['status'] as String),
      transferSpec: map['transferSpec'] == null ? null : TransferSpec.fromMap((map['transferSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
