...
class S3CompatibleMetadata {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authMethod': ?authMethod == null ? null : authMethod!.value,
      'listApi': ?listApi == null ? null : listApi!.value,
      'protocol': ?protocol == null ? null : protocol!.value,
      'requestModel': ?requestModel == null ? null : requestModel!.value,
    };
  }

  factory S3CompatibleMetadata.fromMap(Map<String, dynamic> map) {
    return S3CompatibleMetadata(
      authMethod: map['authMethod'] == null ? null : S3CompatibleMetadataAuthMethod.fromValue(map['authMethod'] as String),
      listApi: map['listApi'] == null ? null : S3CompatibleMetadataListApi.fromValue(map['listApi'] as String),
      protocol: map['protocol'] == null ? null : S3CompatibleMetadataProtocol.fromValue(map['protocol'] as String),
      requestModel: map['requestModel'] == null ? null : S3CompatibleMetadataRequestModel.fromValue(map['requestModel'] as String),
    );
  }
}
