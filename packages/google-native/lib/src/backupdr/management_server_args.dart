...
class ManagementServerArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['networks'] = pulumi.Input.mapInputValue<List<NetworkConfig>,
            List<Map<String, dynamic>>>(
        networks,
        (value) => pulumi.Input.encodeList<NetworkConfig, Map<String, dynamic>>(
  ...
  factory ManagementServerArgs.fromMap(Map<String, dynamic> map) {
    return ManagementServerArgs(
      ...
      networks: pulumi.Input.decodeList<NetworkConfig>(
          map['networks'],
          (value) =>
