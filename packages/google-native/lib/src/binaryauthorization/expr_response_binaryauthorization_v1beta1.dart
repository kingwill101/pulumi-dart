...
class ExprResponseBinaryauthorizationV1beta1 {
  ...
  /// Creates a new [ExprResponseBinaryauthorizationV1beta1].
  ...
  ExprResponseBinaryauthorizationV1beta1({
  ...
  factory ExprResponseBinaryauthorizationV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseBinaryauthorizationV1beta1(
