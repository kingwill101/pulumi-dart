...
class Check {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'imageAllowlist': ?imageAllowlist == null
          ? null
          : imageAllowlist!.toMap(),
      'imageFreshnessCheck': ?imageFreshnessCheck == null
          ? null
          : imageFreshnessCheck!.toMap(),
      'simpleSigningAttestationCheck': ?simpleSigningAttestationCheck == null
          ? null
          : simpleSigningAttestationCheck!.toMap(),
      'slsaCheck': ?slsaCheck == null ? null : slsaCheck!.toMap(),
      'trustedDirectoryCheck': ?trustedDirectoryCheck == null
          ? null
          : trustedDirectoryCheck!.toMap(),
      'vulnerabilityCheck': ?vulnerabilityCheck == null
          ? null
          : vulnerabilityCheck!.toMap(),
    };
  }
