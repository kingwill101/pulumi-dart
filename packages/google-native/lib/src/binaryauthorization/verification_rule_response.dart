...
class VerificationRuleResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['attestationSource'] = attestationSource.toMap();
    map['configBasedBuildRequired'] = configBasedBuildRequired;
    map['trustedBuilder'] = trustedBuilder;
    map['trustedSourceRepoPatterns'] = trustedSourceRepoPatterns;
    return map;
  }

  factory VerificationRuleResponse.fromMap(Map<String, dynamic> map) {
    return VerificationRuleResponse(
      attestationSource: AttestationSourceResponse.fromMap(
