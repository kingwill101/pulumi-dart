...
class CheckResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['alwaysDeny'] = alwaysDeny;
    map['displayName'] = displayName;
    map['imageAllowlist'] = imageAllowlist.toMap();
    map['imageFreshnessCheck'] = imageFreshnessCheck.toMap();
    map['simpleSigningAttestationCheck'] =
        simpleSigningAttestationCheck.toMap();
    map['slsaCheck'] = slsaCheck.toMap();
    map['trustedDirectoryCheck'] = trustedDirectoryCheck.toMap();
    map['vulnerabilityCheck'] = vulnerabilityCheck.toMap();
    return map;
  }
  ...
  factory CheckResponse.fromMap(Map<String, dynamic> map) {
    return CheckResponse(
      ...
      imageFreshnessCheck: ImageFreshnessCheckResponse.fromMap(
      ...
      simpleSigningAttestationCheck:
          SimpleSigningAttestationCheckResponse.fromMap(
              (map['simpleSigningAttestationCheck'] as Map)
                  .cast<String, dynamic>()),
      slsaCheck: SlsaCheckResponse.fromMap(
          (map['slsaCheck'] as Map).cast<String, dynamic>()),
      trustedDirectoryCheck: TrustedDirectoryCheckResponse.fromMap(
          (map['trustedDirectoryCheck'] as Map).cast<String, dynamic>()),
      vulnerabilityCheck: VulnerabilityCheckResponse.fromMap(
