...
class SimpleSigningAttestationCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attestationAuthenticators': pulumi.Input.encodeList<AttestationAuthenticator, Map<String, dynamic>>(attestationAuthenticators, (value) => value.toMap()),
  ...
  factory SimpleSigningAttestationCheck.fromMap(Map<String, dynamic> map) {
    return SimpleSigningAttestationCheck(
      attestationAuthenticators: pulumi.Input.decodeList<AttestationAuthenticator>(map['attestationAuthenticators'], (value) => AttestationAuthenticator.fromMap((value as Map).cast<String, dynamic>())),
