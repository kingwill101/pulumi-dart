...
class VerificationRule {
  ...
  Map<String, dynamic> toMap() {
    ...
    final attestationSourceValue = attestationSource;
    if (attestationSourceValue != null) {
      map['attestationSource'] = attestationSourceValue.toMap();
    }
    final configBasedBuildRequiredValue = configBasedBuildRequired;
    if (configBasedBuildRequiredValue != null) {
      map['configBasedBuildRequired'] = configBasedBuildRequiredValue;
    }
    final trustedBuilderValue = trustedBuilder;
    if (trustedBuilderValue != null) {
      map['trustedBuilder'] = trustedBuilderValue.value;
    }
    final trustedSourceRepoPatternsValue = trustedSourceRepoPatterns;
    if (trustedSourceRepoPatternsValue != null) {
      map['trustedSourceRepoPatterns'] = trustedSourceRepoPatternsValue;
    }
    return map;
  }
