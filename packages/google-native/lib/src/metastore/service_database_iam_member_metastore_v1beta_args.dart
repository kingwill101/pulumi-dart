...
/// {@template pulumi_metastore_v1beta_service_database_iam_member_metastore_v1beta_args_doc}
/// The set of arguments for ServiceDatabaseIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_database_iam_member_metastore_v1beta_args_doc}
class ServiceDatabaseIamMemberMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceDatabaseIamMemberMetastoreV1betaArgs].
  ...
  ServiceDatabaseIamMemberMetastoreV1betaArgs({
    Condition? condition,
  ...
  factory ServiceDatabaseIamMemberMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseIamMemberMetastoreV1betaArgs(
