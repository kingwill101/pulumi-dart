...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      databaseType: map['databaseType'] == null ? null : ServiceDatabaseType.fromValue(map['databaseType'] as String),
      encryptionConfig: map['encryptionConfig'] == null ? null : EncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      hiveMetastoreConfig: map['hiveMetastoreConfig'] == null ? null : HiveMetastoreConfig.fromMap((map['hiveMetastoreConfig'] as Map).cast<String, dynamic>()),
      ...
      metadataIntegration: map['metadataIntegration'] == null ? null : MetadataIntegration.fromMap((map['metadataIntegration'] as Map).cast<String, dynamic>()),
      ...
      releaseChannel: map['releaseChannel'] == null ? null : ServiceReleaseChannel.fromValue(map['releaseChannel'] as String),
      ...
      telemetryConfig: map['telemetryConfig'] == null ? null : TelemetryConfig.fromMap((map['telemetryConfig'] as Map).cast<String, dynamic>()),
      tier: map['tier'] == null ? null : ServiceTier.fromValue(map['tier'] as String),
    );
  }
}
