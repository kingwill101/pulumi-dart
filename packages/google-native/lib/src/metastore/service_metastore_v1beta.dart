...
class ServiceMetastoreV1beta extends pulumi.CustomResource {
  ...
  ServiceMetastoreV1beta(
    ...
    this.encryptionConfig =
        registerOutput<EncryptionConfigResponseMetastoreV1beta>(
          'encryptionConfig',
        );
    ...
    this.networkConfig = registerOutput<NetworkConfigResponseMetastoreV1beta>(
      'networkConfig',
    );
    ...
    this.scalingConfig = registerOutput<ScalingConfigResponseMetastoreV1beta>(
      'scalingConfig',
    );
    ...
    this.telemetryConfig =
        registerOutput<TelemetryConfigResponseMetastoreV1beta>(
          'telemetryConfig',
        );
