...
/// {@template pulumi_metastore_v1beta_service_database_table_iam_binding_metastore_v1beta_args_doc}
/// The set of arguments for ServiceDatabaseTableIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_database_table_iam_binding_metastore_v1beta_args_doc}
class ServiceDatabaseTableIamBindingMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceDatabaseTableIamBindingMetastoreV1betaArgs].
  ...
  ServiceDatabaseTableIamBindingMetastoreV1betaArgs({
    Condition? condition,
  ...
  factory ServiceDatabaseTableIamBindingMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseTableIamBindingMetastoreV1betaArgs(
