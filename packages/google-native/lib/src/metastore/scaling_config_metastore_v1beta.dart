...
class ScalingConfigMetastoreV1beta {
  ...
  final ScalingConfigInstanceSizeMetastoreV1beta? instanceSize;
  ...
  factory ScalingConfigMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return ScalingConfigMetastoreV1beta(
      instanceSize: map['instanceSize'] == null ? null : ScalingConfigInstanceSizeMetastoreV1beta.fromValue(map['instanceSize'] as String),
