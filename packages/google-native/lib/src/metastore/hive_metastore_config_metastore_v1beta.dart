...
class HiveMetastoreConfigMetastoreV1beta {
  ...
  factory HiveMetastoreConfigMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigMetastoreV1beta(
      ...
      endpointProtocol: map['endpointProtocol'] == null ? null : HiveMetastoreConfigEndpointProtocolMetastoreV1beta.fromValue(map['endpointProtocol'] as String),
      kerberosConfig: map['kerberosConfig'] == null ? null : KerberosConfigMetastoreV1beta.fromMap((map['kerberosConfig'] as Map).cast<String, dynamic>()),
