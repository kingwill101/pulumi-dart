...
class GetServiceResult {
  ...
  factory GetServiceResult.fromMap(Map<String, dynamic> map) {
    return GetServiceResult(
      ...
      metadataManagementActivity: MetadataManagementActivityResponse.fromMap(
      ...
      scalingConfig: ScalingConfigResponse.fromMap(
        (map['scalingConfig'] as Map).cast<String, dynamic>(),
      ),
      state: map['state'] as String,
      stateMessage: map['stateMessage'] as String,
      telemetryConfig: TelemetryConfigResponse.fromMap(
