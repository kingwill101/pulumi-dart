...
/// {@template pulumi_metastore_v1alpha_service_database_table_iam_policy_args_doc}
/// The set of arguments for ServiceDatabaseTableIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_database_table_iam_policy_args_doc}
class ServiceDatabaseTableIamPolicyArgs {
  ...
  /// Creates a new [ServiceDatabaseTableIamPolicyArgs].
  ...
  ServiceDatabaseTableIamPolicyArgs({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigMetastoreV1alpha>>(
                auditConfigs),
        bindings = pulumi.Input.asOptionalInput<List<BindingMetastoreV1alpha>>(
            bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigMetastoreV1alpha>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigMetastoreV1alpha,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingMetastoreV1alpha>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingMetastoreV1alpha,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory ServiceDatabaseTableIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseTableIamPolicyArgs(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigMetastoreV1alpha>(
              map['auditConfigs'],
              (value) => AuditConfigMetastoreV1alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingMetastoreV1alpha>(
              map['bindings'],
              (value) => BindingMetastoreV1alpha.fromMap(
                  (value as Map).cast<String, dynamic>())),
