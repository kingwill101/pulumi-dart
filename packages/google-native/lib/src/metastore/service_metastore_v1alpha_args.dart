...
class ServiceMetastoreV1alphaArgs {
  ...
  factory ServiceMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceMetastoreV1alphaArgs(
      databaseType: map['databaseType'] == null ? null : ServiceDatabaseTypeMetastoreV1alpha.fromValue(map['databaseType'] as String),
      encryptionConfig: map['encryptionConfig'] == null ? null : EncryptionConfigMetastoreV1alpha.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      hiveMetastoreConfig: map['hiveMetastoreConfig'] == null ? null : HiveMetastoreConfigMetastoreV1alpha.fromMap((map['hiveMetastoreConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : MaintenanceWindowMetastoreV1alpha.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      metadataIntegration: map['metadataIntegration'] == null ? null : MetadataIntegrationMetastoreV1alpha.fromMap((map['metadataIntegration'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkConfig: map['networkConfig'] == null ? null : NetworkConfigMetastoreV1alpha.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      releaseChannel: map['releaseChannel'] == null ? null : ServiceReleaseChannelMetastoreV1alpha.fromValue(map['releaseChannel'] as String),
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      scalingConfig: map['scalingConfig'] == null ? null : ScalingConfigMetastoreV1alpha.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>()),
      serviceId: map['serviceId'] as String,
      telemetryConfig: map['telemetryConfig'] == null ? null : TelemetryConfigMetastoreV1alpha.fromMap((map['telemetryConfig'] as Map).cast<String, dynamic>()),
      tier: map['tier'] == null ? null : ServiceTierMetastoreV1alpha.fromValue(map['tier'] as String),
    );
  }
}
