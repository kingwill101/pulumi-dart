...
/// {@template pulumi_metastore_v1alpha_federation_iam_binding_metastore_v1alpha_args_doc}
/// The set of arguments for FederationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_federation_iam_binding_metastore_v1alpha_args_doc}
class FederationIamBindingMetastoreV1alphaArgs {
  ...
  /// Creates a new [FederationIamBindingMetastoreV1alphaArgs].
  ...
  FederationIamBindingMetastoreV1alphaArgs({
    Condition? condition,
  ...
  factory FederationIamBindingMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FederationIamBindingMetastoreV1alphaArgs(
