...
class HiveMetastoreConfigResponse {
  ...
  /// Creates a new [HiveMetastoreConfigResponse].
  ...
  factory HiveMetastoreConfigResponse.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigResponse(
