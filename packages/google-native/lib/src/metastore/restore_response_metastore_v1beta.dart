...
class RestoreResponseMetastoreV1beta {
  ...
  /// Creates a new [RestoreResponseMetastoreV1beta].
  ...
  factory RestoreResponseMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return RestoreResponseMetastoreV1beta(
