...
/// {@template pulumi_metastore_v1_service_backup_iam_policy_args_doc}
/// The set of arguments for ServiceBackupIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1_service_backup_iam_policy_args_doc}
class ServiceBackupIamPolicyArgs {
  ...
  /// Creates a new [ServiceBackupIamPolicyArgs].
  ...
  factory ServiceBackupIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamPolicyArgs(
