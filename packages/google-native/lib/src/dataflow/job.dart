...
class Job extends pulumi.CustomResource {
  ...
  Job(String name, {JobArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.createdFromSnapshotId = registerOutput<String>(
    ...
    this.executionInfo = registerOutput<JobExecutionInfoResponse>(
      'executionInfo',
    );
    ...
    this.pipelineDescription = registerOutput<PipelineDescriptionResponse>(
      'pipelineDescription',
    );
    ...
    this.stageStates = registerOutput<List<ExecutionStageStateResponse>>(
      'stageStates',
    );
