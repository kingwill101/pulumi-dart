...
class Job extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ExecutionStageStateResponse>> stageStates;
  ...
  Job(
    ...
    this.createdFromSnapshotId = registerOutput<String>('createdFromSnapshotId');
    this.currentState = registerOutput<String>('currentState');
    this.currentStateTime = registerOutput<String>('currentStateTime');
    this.environment = registerOutput<EnvironmentResponse>('environment');
    this.executionInfo = registerOutput<JobExecutionInfoResponse>('executionInfo');
    this.jobMetadata = registerOutput<JobMetadataResponse>('jobMetadata');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.pipelineDescription = registerOutput<PipelineDescriptionResponse>('pipelineDescription');
    ...
    this.runtimeUpdatableParams = registerOutput<RuntimeUpdatableParamsResponse>('runtimeUpdatableParams');
    this.satisfiesPzi = registerOutput<bool>('satisfiesPzi');
    this.satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    this.stageStates = registerOutput<List<ExecutionStageStateResponse>>('stageStates');
