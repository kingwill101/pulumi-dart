...
class WorkerPool {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (dataDisksValue != null) {
      map['dataDisks'] = pulumi.Input.encodeList<Disk, Map<String, dynamic>>(
    ...
    if (packagesValue != null) {
      map['packages'] = pulumi.Input.encodeList<Package, Map<String, dynamic>>(
  ...
  factory WorkerPool.fromMap(Map<String, dynamic> map) {
    return WorkerPool(
      ...
      dataDisks: map['dataDisks'] == null
          ? null
          : pulumi.Input.decodeList<Disk>(map['dataDisks'],
