  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataDisks': ?dataDisks == null
          ? null
          : pulumi.Input.encodeList<Disk, Map<String, dynamic>>(
              dataDisks!,
              (value) => value.toMap(),
            ),
      'defaultPackageSet': ?defaultPackageSet == null
          ? null
      ...
      'packages': ?packages == null
          ? null
          : pulumi.Input.encodeList<Package, Map<String, dynamic>>(
              packages!,
              (value) => value.toMap(),
            ),
      'poolArgs': ?poolArgs,
      'sdkHarnessContainerImages': ?sdkHarnessContainerImages == null
          ? null
