...
class EnvironmentResponse {
  ...
  factory EnvironmentResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentResponse(
      ...
      internalExperiments: (map['internalExperiments'] as Map)
          .cast<String, String>(),
      sdkPipelineOptions: (map['sdkPipelineOptions'] as Map)
          .cast<String, String>(),
      ...
      workerPools: pulumi.Input.decodeList<WorkerPoolResponse>(
        map['workerPools'],
        (value) =>
            WorkerPoolResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
