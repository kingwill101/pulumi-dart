...
class EnvironmentResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataset': dataset,
      'debugOptions': debugOptions.toMap(),
      ...
      'userAgent': userAgent,
      'version': version,
      'workerPools': pulumi.Input.encodeList<WorkerPoolResponse, Map<String, dynamic>>(workerPools, (value) => value.toMap()),
  ...
  factory EnvironmentResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentResponse(
      ...
      debugOptions: DebugOptionsResponse.fromMap((map['debugOptions'] as Map).cast<String, dynamic>()),
      experiments: (map['experiments'] as List).cast<String>(),
      flexResourceSchedulingGoal: map['flexResourceSchedulingGoal'] as String,
      internalExperiments: (map['internalExperiments'] as Map).cast<String, String>(),
      sdkPipelineOptions: (map['sdkPipelineOptions'] as Map).cast<String, String>(),
      ...
      useStreamingEngineResourceBasedBilling: map['useStreamingEngineResourceBasedBilling'] as bool,
      userAgent: (map['userAgent'] as Map).cast<String, String>(),
      version: (map['version'] as Map).cast<String, String>(),
      workerPools: pulumi.Input.decodeList<WorkerPoolResponse>(map['workerPools'], (value) => WorkerPoolResponse.fromMap((value as Map).cast<String, dynamic>())),
