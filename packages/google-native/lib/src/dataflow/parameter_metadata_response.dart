...
class ParameterMetadataResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enumOptions': pulumi.Input.encodeList<ParameterMetadataEnumOptionResponse, Map<String, dynamic>>(enumOptions, (value) => value.toMap()),
      'groupName': groupName,
      'helpText': helpText,
  ...
  factory ParameterMetadataResponse.fromMap(Map<String, dynamic> map) {
    return ParameterMetadataResponse(
      ...
      enumOptions: pulumi.Input.decodeList<ParameterMetadataEnumOptionResponse>(map['enumOptions'], (value) => ParameterMetadataEnumOptionResponse.fromMap((value as Map).cast<String, dynamic>())),
