...
class TaskRunnerSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parallelWorkerSettings': ?parallelWorkerSettings == null ? null : parallelWorkerSettings!.toMap(),
  ...
  factory TaskRunnerSettings.fromMap(Map<String, dynamic> map) {
    return TaskRunnerSettings(
      alsologtostderr: map['alsologtostderr'] == null ? null : map['alsologtostderr'] as bool,
      baseTaskDir: map['baseTaskDir'] == null ? null : map['baseTaskDir'] as String,
      baseUrl: map['baseUrl'] == null ? null : map['baseUrl'] as String,
      commandlinesFileName: map['commandlinesFileName'] == null ? null : map['commandlinesFileName'] as String,
      continueOnException: map['continueOnException'] == null ? null : map['continueOnException'] as bool,
      dataflowApiVersion: map['dataflowApiVersion'] == null ? null : map['dataflowApiVersion'] as String,
      harnessCommand: map['harnessCommand'] == null ? null : map['harnessCommand'] as String,
      languageHint: map['languageHint'] == null ? null : map['languageHint'] as String,
      logDir: map['logDir'] == null ? null : map['logDir'] as String,
      logToSerialconsole: map['logToSerialconsole'] == null ? null : map['logToSerialconsole'] as bool,
      logUploadLocation: map['logUploadLocation'] == null ? null : map['logUploadLocation'] as String,
      oauthScopes: map['oauthScopes'] == null ? null : (map['oauthScopes'] as List).cast<String>(),
      parallelWorkerSettings: map['parallelWorkerSettings'] == null ? null : WorkerSettings.fromMap((map['parallelWorkerSettings'] as Map).cast<String, dynamic>()),
      streamingWorkerMainClass: map['streamingWorkerMainClass'] == null ? null : map['streamingWorkerMainClass'] as String,
      ...
      workflowFileName: map['workflowFileName'] == null ? null : map['workflowFileName'] as String,
    );
  }
}
