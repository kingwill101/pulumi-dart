...
class JobMetadata {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pubsubDetails': ?pubsubDetails == null
          ? null
      ...
      'spannerDetails': ?spannerDetails == null
          ? null
