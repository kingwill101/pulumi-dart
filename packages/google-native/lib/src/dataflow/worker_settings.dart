...
class WorkerSettings {
  ...
  factory WorkerSettings.fromMap(Map<String, dynamic> map) {
    return WorkerSettings(
      ...
      reportingEnabled: map['reportingEnabled'] == null ? null : map['reportingEnabled'] as bool,
      servicePath: map['servicePath'] == null ? null : map['servicePath'] as String,
      shuffleServicePath: map['shuffleServicePath'] == null ? null : map['shuffleServicePath'] as String,
