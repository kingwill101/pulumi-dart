...
class JobArgs {
  ...
  JobArgs({
    ...
    String? view,
        ...
        createdFromSnapshotId =
            pulumi.Input.asOptionalInput<String>(createdFromSnapshotId),
        currentState =
            pulumi.Input.asOptionalInput<JobCurrentState>(currentState),
        currentStateTime =
            pulumi.Input.asOptionalInput<String>(currentStateTime),
        environment = pulumi.Input.asOptionalInput<Environment>(environment),
        executionInfo =
            pulumi.Input.asOptionalInput<JobExecutionInfo>(executionInfo),
        ...
        requestedState =
            pulumi.Input.asOptionalInput<JobRequestedState>(requestedState),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (environmentValue != null) {
      map['environment'] =
          pulumi.Input.mapOptionalInputValue<Environment, Map<String, dynamic>>(
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      clientRequestId: map['clientRequestId'] == null
          ? null
          : map['clientRequestId'] as String,
      createTime:
          map['createTime'] == null ? null : map['createTime'] as String,
      createdFromSnapshotId: map['createdFromSnapshotId'] == null
          ? null
          : map['createdFromSnapshotId'] as String,
      currentState: map['currentState'] == null
          ? null
          : JobCurrentState.fromValue(map['currentState'] as String),
      ...
      replaceJobId:
          map['replaceJobId'] == null ? null : map['replaceJobId'] as String,
      replacedByJobId: map['replacedByJobId'] == null
          ? null
          : map['replacedByJobId'] as String,
      requestedState: map['requestedState'] == null
          ? null
          : JobRequestedState.fromValue(map['requestedState'] as String),
      runtimeUpdatableParams: map['runtimeUpdatableParams'] == null
          ? null
      ...
      stageStates: map['stageStates'] == null
          ? null
      ...
      steps: map['steps'] == null
          ? null
          : pulumi.Input.decodeList<Step>(map['steps'],
              (value) => Step.fromMap((value as Map).cast<String, dynamic>())),
      stepsLocation:
          map['stepsLocation'] == null ? null : map['stepsLocation'] as String,
      tempFiles: map['tempFiles'] == null
          ? null
          : (map['tempFiles'] as List).cast<String>(),
      transformNameMapping: map['transformNameMapping'] == null
          ? null
          : (map['transformNameMapping'] as Map).cast<String, String>(),
      type:
          map['type'] == null ? null : JobType.fromValue(map['type'] as String),
