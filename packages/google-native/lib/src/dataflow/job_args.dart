...
class JobArgs {
  ...
  JobArgs({
    ...
    JobRequestedState? requestedState,
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      clientRequestId: map['clientRequestId'] == null ? null : map['clientRequestId'] as String,
      createTime: map['createTime'] == null ? null : map['createTime'] as String,
      createdFromSnapshotId: map['createdFromSnapshotId'] == null ? null : map['createdFromSnapshotId'] as String,
      currentState: map['currentState'] == null ? null : JobCurrentState.fromValue(map['currentState'] as String),
      ...
      executionInfo: map['executionInfo'] == null ? null : JobExecutionInfo.fromMap((map['executionInfo'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      jobMetadata: map['jobMetadata'] == null ? null : JobMetadata.fromMap((map['jobMetadata'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      pipelineDescription: map['pipelineDescription'] == null ? null : PipelineDescription.fromMap((map['pipelineDescription'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      replaceJobId: map['replaceJobId'] == null ? null : map['replaceJobId'] as String,
      replacedByJobId: map['replacedByJobId'] == null ? null : map['replacedByJobId'] as String,
      requestedState: map['requestedState'] == null ? null : JobRequestedState.fromValue(map['requestedState'] as String),
      runtimeUpdatableParams: map['runtimeUpdatableParams'] == null ? null : RuntimeUpdatableParams.fromMap((map['runtimeUpdatableParams'] as Map).cast<String, dynamic>()),
      satisfiesPzs: map['satisfiesPzs'] == null ? null : map['satisfiesPzs'] as bool,
      stageStates: map['stageStates'] == null ? null : pulumi.Input.decodeList<ExecutionStageState>(map['stageStates'], (value) => ExecutionStageState.fromMap((value as Map).cast<String, dynamic>())),
      ...
      stepsLocation: map['stepsLocation'] == null ? null : map['stepsLocation'] as String,
      tempFiles: map['tempFiles'] == null ? null : (map['tempFiles'] as List).cast<String>(),
      transformNameMapping: map['transformNameMapping'] == null ? null : (map['transformNameMapping'] as Map).cast<String, String>(),
      type: map['type'] == null ? null : JobType.fromValue(map['type'] as String),
