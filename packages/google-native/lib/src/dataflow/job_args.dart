...
class JobArgs {
  ...
  JobArgs({
    ...
    String? view,
       ...
       createdFromSnapshotId = pulumi.Input.asOptionalInput<String>(
         createdFromSnapshotId,
       ),
       currentState = pulumi.Input.asOptionalInput<JobCurrentState>(
         currentState,
       ),
       currentStateTime = pulumi.Input.asOptionalInput<String>(
         currentStateTime,
       ),
       environment = pulumi.Input.asOptionalInput<Environment>(environment),
       executionInfo = pulumi.Input.asOptionalInput<JobExecutionInfo>(
         executionInfo,
       ),
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      replaceJobId: map['replaceJobId'] == null
          ? null
          : map['replaceJobId'] as String,
      ...
      stepsLocation: map['stepsLocation'] == null
          ? null
          : map['stepsLocation'] as String,
      ...
      type: map['type'] == null
          ? null
          : JobType.fromValue(map['type'] as String),
