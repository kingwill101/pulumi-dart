...
class NodeConfigContainerV1beta1 {
  ...
  final EphemeralStorageLocalSsdConfigContainerV1beta1? ephemeralStorageLocalSsdConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<AcceleratorConfigContainerV1beta1, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
  ...
  factory NodeConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeConfigContainerV1beta1(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<AcceleratorConfigContainerV1beta1>(map['accelerators'], (value) => AcceleratorConfigContainerV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : AdvancedMachineFeaturesContainerV1beta1.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      ...
      ephemeralStorageConfig: map['ephemeralStorageConfig'] == null ? null : EphemeralStorageConfig.fromMap((map['ephemeralStorageConfig'] as Map).cast<String, dynamic>()),
      ephemeralStorageLocalSsdConfig: map['ephemeralStorageLocalSsdConfig'] == null ? null : EphemeralStorageLocalSsdConfigContainerV1beta1.fromMap((map['ephemeralStorageLocalSsdConfig'] as Map).cast<String, dynamic>()),
      fastSocket: map['fastSocket'] == null ? null : FastSocketContainerV1beta1.fromMap((map['fastSocket'] as Map).cast<String, dynamic>()),
      gcfsConfig: map['gcfsConfig'] == null ? null : GcfsConfigContainerV1beta1.fromMap((map['gcfsConfig'] as Map).cast<String, dynamic>()),
      gvnic: map['gvnic'] == null ? null : VirtualNICContainerV1beta1.fromMap((map['gvnic'] as Map).cast<String, dynamic>()),
      ...
      kubeletConfig: map['kubeletConfig'] == null ? null : NodeKubeletConfigContainerV1beta1.fromMap((map['kubeletConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linuxNodeConfig: map['linuxNodeConfig'] == null ? null : LinuxNodeConfigContainerV1beta1.fromMap((map['linuxNodeConfig'] as Map).cast<String, dynamic>()),
      localNvmeSsdBlockConfig: map['localNvmeSsdBlockConfig'] == null ? null : LocalNvmeSsdBlockConfigContainerV1beta1.fromMap((map['localNvmeSsdBlockConfig'] as Map).cast<String, dynamic>()),
      ...
      reservationAffinity: map['reservationAffinity'] == null ? null : ReservationAffinityContainerV1beta1.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      ...
      sandboxConfig: map['sandboxConfig'] == null ? null : SandboxConfigContainerV1beta1.fromMap((map['sandboxConfig'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : ShieldedInstanceConfigContainerV1beta1.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      soleTenantConfig: map['soleTenantConfig'] == null ? null : SoleTenantConfigContainerV1beta1.fromMap((map['soleTenantConfig'] as Map).cast<String, dynamic>()),
      ...
      windowsNodeConfig: map['windowsNodeConfig'] == null ? null : WindowsNodeConfigContainerV1beta1.fromMap((map['windowsNodeConfig'] as Map).cast<String, dynamic>()),
      workloadMetadataConfig: map['workloadMetadataConfig'] == null ? null : WorkloadMetadataConfigContainerV1beta1.fromMap((map['workloadMetadataConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
