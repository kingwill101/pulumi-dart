...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.autoscaling = registerOutput<ClusterAutoscalingResponse>(
      'autoscaling',
    );
    ...
    this.confidentialNodes = registerOutput<ConfidentialNodesResponse>(
      'confidentialNodes',
    );
    this.costManagementConfig = registerOutput<CostManagementConfigResponse>(
    ...
    this.databaseEncryption = registerOutput<DatabaseEncryptionResponse>(
      'databaseEncryption',
    );
    this.defaultMaxPodsConstraint = registerOutput<MaxPodsConstraintResponse>(
      'defaultMaxPodsConstraint',
    );
    this.description = registerOutput<String>('description');
    this.enableK8sBetaApis = registerOutput<K8sBetaAPIConfigResponse>(
      'enableK8sBetaApis',
    );
    this.enableKubernetesAlpha = registerOutput<bool>('enableKubernetesAlpha');
    this.enableTpu = registerOutput<bool>('enableTpu');
    this.endpoint = registerOutput<String>('endpoint');
    this.enterpriseConfig = registerOutput<EnterpriseConfigResponse>(
      'enterpriseConfig',
    );
    this.etag = registerOutput<String>('etag');
    this.expireTime = registerOutput<String>('expireTime');
    this.fleet = registerOutput<FleetResponse>('fleet');
    this.identityServiceConfig = registerOutput<IdentityServiceConfigResponse>(
      'identityServiceConfig',
    );
    this.initialClusterVersion = registerOutput<String>(
    ...
    this.ipAllocationPolicy = registerOutput<IPAllocationPolicyResponse>(
      'ipAllocationPolicy',
    );
    ...
    this.meshCertificates = registerOutput<MeshCertificatesResponse>(
      'meshCertificates',
    );
    ...
    this.nodePoolAutoConfig = registerOutput<NodePoolAutoConfigResponse>(
      'nodePoolAutoConfig',
    );
    this.nodePoolDefaults = registerOutput<NodePoolDefaultsResponse>(
      'nodePoolDefaults',
    );
    ...
    this.parentProductConfig = registerOutput<ParentProductConfigResponse>(
      'parentProductConfig',
    );
    ...
    this.releaseChannel = registerOutput<ReleaseChannelResponse>(
      'releaseChannel',
    );
    ...
    this.securityPostureConfig = registerOutput<SecurityPostureConfigResponse>(
