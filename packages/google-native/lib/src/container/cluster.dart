...
class Cluster extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NodePoolResponse>> nodePools;
  ...
  Cluster(
    ...
    this.authenticatorGroupsConfig = registerOutput<AuthenticatorGroupsConfigResponse>('authenticatorGroupsConfig');
    this.autopilot = registerOutput<AutopilotResponse>('autopilot');
    this.autoscaling = registerOutput<ClusterAutoscalingResponse>('autoscaling');
    ...
    this.confidentialNodes = registerOutput<ConfidentialNodesResponse>('confidentialNodes');
    this.costManagementConfig = registerOutput<CostManagementConfigResponse>('costManagementConfig');
    ...
    this.databaseEncryption = registerOutput<DatabaseEncryptionResponse>('databaseEncryption');
    this.defaultMaxPodsConstraint = registerOutput<MaxPodsConstraintResponse>('defaultMaxPodsConstraint');
    this.description = registerOutput<String>('description');
    this.enableK8sBetaApis = registerOutput<K8sBetaAPIConfigResponse>('enableK8sBetaApis');
    this.enableKubernetesAlpha = registerOutput<bool>('enableKubernetesAlpha');
    this.enableTpu = registerOutput<bool>('enableTpu');
    this.endpoint = registerOutput<String>('endpoint');
    this.enterpriseConfig = registerOutput<EnterpriseConfigResponse>('enterpriseConfig');
    this.etag = registerOutput<String>('etag');
    this.expireTime = registerOutput<String>('expireTime');
    this.fleet = registerOutput<FleetResponse>('fleet');
    this.identityServiceConfig = registerOutput<IdentityServiceConfigResponse>('identityServiceConfig');
    ...
    this.ipAllocationPolicy = registerOutput<IPAllocationPolicyResponse>('ipAllocationPolicy');
    ...
    this.masterAuthorizedNetworksConfig = registerOutput<MasterAuthorizedNetworksConfigResponse>('masterAuthorizedNetworksConfig');
    this.meshCertificates = registerOutput<MeshCertificatesResponse>('meshCertificates');
    this.monitoringConfig = registerOutput<MonitoringConfigResponse>('monitoringConfig');
    ...
    this.networkPolicy = registerOutput<NetworkPolicyResponse>('networkPolicy');
    this.nodeConfig = registerOutput<NodeConfigResponse>('nodeConfig');
    this.nodeIpv4CidrSize = registerOutput<int>('nodeIpv4CidrSize');
    this.nodePoolAutoConfig = registerOutput<NodePoolAutoConfigResponse>('nodePoolAutoConfig');
    this.nodePoolDefaults = registerOutput<NodePoolDefaultsResponse>('nodePoolDefaults');
    ...
    this.parentProductConfig = registerOutput<ParentProductConfigResponse>('parentProductConfig');
    this.privateClusterConfig = registerOutput<PrivateClusterConfigResponse>('privateClusterConfig');
    this.project = registerOutput<String>('project');
    this.releaseChannel = registerOutput<ReleaseChannelResponse>('releaseChannel');
    this.resourceLabels = registerOutput<Map<String, String>>('resourceLabels');
    this.resourceUsageExportConfig = registerOutput<ResourceUsageExportConfigResponse>('resourceUsageExportConfig');
    this.securityPostureConfig = registerOutput<SecurityPostureConfigResponse>('securityPostureConfig');
    ...
    this.verticalPodAutoscaling = registerOutput<VerticalPodAutoscalingResponse>('verticalPodAutoscaling');
    this.workloadIdentityConfig = registerOutput<WorkloadIdentityConfigResponse>('workloadIdentityConfig');
