...
class GetClusterResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodePools': pulumi.Input.encodeList<NodePoolResponse, Map<String, dynamic>>(nodePools, (value) => value.toMap()),
  ...
  factory GetClusterResult.fromMap(Map<String, dynamic> map) {
    return GetClusterResult(
      addonsConfig: AddonsConfigResponse.fromMap((map['addonsConfig'] as Map).cast<String, dynamic>()),
      authenticatorGroupsConfig: AuthenticatorGroupsConfigResponse.fromMap((map['authenticatorGroupsConfig'] as Map).cast<String, dynamic>()),
      autopilot: AutopilotResponse.fromMap((map['autopilot'] as Map).cast<String, dynamic>()),
      autoscaling: ClusterAutoscalingResponse.fromMap((map['autoscaling'] as Map).cast<String, dynamic>()),
      ...
      costManagementConfig: CostManagementConfigResponse.fromMap((map['costManagementConfig'] as Map).cast<String, dynamic>()),
      ...
      databaseEncryption: DatabaseEncryptionResponse.fromMap((map['databaseEncryption'] as Map).cast<String, dynamic>()),
      defaultMaxPodsConstraint: MaxPodsConstraintResponse.fromMap((map['defaultMaxPodsConstraint'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      enableK8sBetaApis: K8sBetaAPIConfigResponse.fromMap((map['enableK8sBetaApis'] as Map).cast<String, dynamic>()),
      enableKubernetesAlpha: map['enableKubernetesAlpha'] as bool,
      enableTpu: map['enableTpu'] as bool,
      endpoint: map['endpoint'] as String,
      enterpriseConfig: EnterpriseConfigResponse.fromMap((map['enterpriseConfig'] as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      expireTime: map['expireTime'] as String,
      fleet: FleetResponse.fromMap((map['fleet'] as Map).cast<String, dynamic>()),
      identityServiceConfig: IdentityServiceConfigResponse.fromMap((map['identityServiceConfig'] as Map).cast<String, dynamic>()),
      ...
      ipAllocationPolicy: IPAllocationPolicyResponse.fromMap((map['ipAllocationPolicy'] as Map).cast<String, dynamic>()),
      labelFingerprint: map['labelFingerprint'] as String,
      legacyAbac: LegacyAbacResponse.fromMap((map['legacyAbac'] as Map).cast<String, dynamic>()),
      ...
      masterAuth: MasterAuthResponse.fromMap((map['masterAuth'] as Map).cast<String, dynamic>()),
      ...
      meshCertificates: MeshCertificatesResponse.fromMap((map['meshCertificates'] as Map).cast<String, dynamic>()),
      monitoringConfig: MonitoringConfigResponse.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
      ...
      networkPolicy: NetworkPolicyResponse.fromMap((map['networkPolicy'] as Map).cast<String, dynamic>()),
      ...
      nodePoolAutoConfig: NodePoolAutoConfigResponse.fromMap((map['nodePoolAutoConfig'] as Map).cast<String, dynamic>()),
      nodePoolDefaults: NodePoolDefaultsResponse.fromMap((map['nodePoolDefaults'] as Map).cast<String, dynamic>()),
      nodePools: pulumi.Input.decodeList<NodePoolResponse>(map['nodePools'], (value) => NodePoolResponse.fromMap((value as Map).cast<String, dynamic>())),
      notificationConfig: NotificationConfigResponse.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>()),
      parentProductConfig: ParentProductConfigResponse.fromMap((map['parentProductConfig'] as Map).cast<String, dynamic>()),
      privateClusterConfig: PrivateClusterConfigResponse.fromMap((map['privateClusterConfig'] as Map).cast<String, dynamic>()),
      releaseChannel: ReleaseChannelResponse.fromMap((map['releaseChannel'] as Map).cast<String, dynamic>()),
      resourceLabels: (map['resourceLabels'] as Map).cast<String, String>(),
      resourceUsageExportConfig: ResourceUsageExportConfigResponse.fromMap((map['resourceUsageExportConfig'] as Map).cast<String, dynamic>()),
      ...
      shieldedNodes: ShieldedNodesResponse.fromMap((map['shieldedNodes'] as Map).cast<String, dynamic>()),
      status: map['status'] as String,
      statusMessage: map['statusMessage'] as String,
      subnetwork: map['subnetwork'] as String,
      tpuIpv4CidrBlock: map['tpuIpv4CidrBlock'] as String,
      verticalPodAutoscaling: VerticalPodAutoscalingResponse.fromMap((map['verticalPodAutoscaling'] as Map).cast<String, dynamic>()),
      workloadIdentityConfig: WorkloadIdentityConfigResponse.fromMap((map['workloadIdentityConfig'] as Map).cast<String, dynamic>()),
