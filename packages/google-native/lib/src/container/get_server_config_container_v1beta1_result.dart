...
class GetServerConfigContainerV1beta1Result {
  ...
  factory GetServerConfigContainerV1beta1Result.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetServerConfigContainerV1beta1Result(
      channels:
          pulumi.Input.decodeList<ReleaseChannelConfigResponseContainerV1beta1>(
            map['channels'],
            (value) => ReleaseChannelConfigResponseContainerV1beta1.fromMap(
      ...
      windowsVersionMaps: (map['windowsVersionMaps'] as Map)
          .cast<String, String>(),
    );
  }
}
