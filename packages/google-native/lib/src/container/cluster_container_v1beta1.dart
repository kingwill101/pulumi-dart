...
class ClusterContainerV1beta1 extends pulumi.CustomResource {
  ...
  ClusterContainerV1beta1(
    ...
    this.addonsConfig = registerOutput<AddonsConfigResponseContainerV1beta1>(
      'addonsConfig',
    );
    ...
    this.autopilot = registerOutput<AutopilotResponseContainerV1beta1>(
      'autopilot',
    );
    this.autoscaling =
    ...
    this.clusterTelemetry = registerOutput<ClusterTelemetryResponse>(
      'clusterTelemetry',
    );
    this.conditions =
    ...
    this.legacyAbac = registerOutput<LegacyAbacResponseContainerV1beta1>(
      'legacyAbac',
    );
    this.location = registerOutput<String>('location');
    this.locations = registerOutput<List<String>>('locations');
    this.loggingConfig = registerOutput<LoggingConfigResponseContainerV1beta1>(
      'loggingConfig',
    );
    ...
    this.masterAuth = registerOutput<MasterAuthResponseContainerV1beta1>(
      'masterAuth',
    );
    ...
    this.networkConfig = registerOutput<NetworkConfigResponseContainerV1beta1>(
      'networkConfig',
    );
    this.networkPolicy = registerOutput<NetworkPolicyResponseContainerV1beta1>(
      'networkPolicy',
    );
    this.nodeConfig = registerOutput<NodeConfigResponseContainerV1beta1>(
      'nodeConfig',
    );
    ...
    this.nodePools = registerOutput<List<NodePoolResponseContainerV1beta1>>(
      'nodePools',
    );
    ...
    this.shieldedNodes = registerOutput<ShieldedNodesResponseContainerV1beta1>(
      'shieldedNodes',
    );
    ...
    this.workloadAltsConfig = registerOutput<WorkloadALTSConfigResponse>(
      'workloadAltsConfig',
    );
    this.workloadCertificates = registerOutput<WorkloadCertificatesResponse>(
