...
class AcceleratorConfigResponseContainerV1beta1 {
  ...
  final GPUDriverInstallationConfigResponseContainerV1beta1 gpuDriverInstallationConfig;
  ...
  factory AcceleratorConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return AcceleratorConfigResponseContainerV1beta1(
      ...
      gpuDriverInstallationConfig: GPUDriverInstallationConfigResponseContainerV1beta1.fromMap((map['gpuDriverInstallationConfig'] as Map).cast<String, dynamic>()),
      gpuPartitionSize: map['gpuPartitionSize'] as String,
      gpuSharingConfig: GPUSharingConfigResponseContainerV1beta1.fromMap((map['gpuSharingConfig'] as Map).cast<String, dynamic>()),
