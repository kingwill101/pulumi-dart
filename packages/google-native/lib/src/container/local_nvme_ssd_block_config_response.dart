...
class LocalNvmeSsdBlockConfigResponse {
  ...
  /// Creates a new [LocalNvmeSsdBlockConfigResponse].
  ...
  LocalNvmeSsdBlockConfigResponse({required this.localSsdCount});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'localSsdCount': localSsdCount};
  }

  factory LocalNvmeSsdBlockConfigResponse.fromMap(Map<String, dynamic> map) {
    return LocalNvmeSsdBlockConfigResponse(
