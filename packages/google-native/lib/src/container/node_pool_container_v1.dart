...
class NodePoolContainerV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BestEffortProvisioningResponse> bestEffortProvisioning;
  ...
  NodePoolContainerV1(
    ...
    this.autoscaling = registerOutput<NodePoolAutoscalingResponse>('autoscaling');
    this.bestEffortProvisioning = registerOutput<BestEffortProvisioningResponse>('bestEffortProvisioning');
    this.clusterId = registerOutput<String>('clusterId');
    this.conditions = registerOutput<List<StatusConditionResponse>>('conditions');
    ...
    this.maxPodsConstraint = registerOutput<MaxPodsConstraintResponse>('maxPodsConstraint');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<NodeNetworkConfigResponse>('networkConfig');
    this.placementPolicy = registerOutput<PlacementPolicyResponse>('placementPolicy');
    this.podIpv4CidrSize = registerOutput<int>('podIpv4CidrSize');
    this.project = registerOutput<String>('project');
    this.queuedProvisioning = registerOutput<QueuedProvisioningResponse>('queuedProvisioning');
    this.selfLink = registerOutput<String>('selfLink');
    this.status = registerOutput<String>('status');
    this.statusMessage = registerOutput<String>('statusMessage');
    this.updateInfo = registerOutput<UpdateInfoResponse>('updateInfo');
    this.upgradeSettings = registerOutput<UpgradeSettingsResponse>('upgradeSettings');
