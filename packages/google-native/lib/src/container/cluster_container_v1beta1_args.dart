...
class ClusterContainerV1beta1Args {
  ...
  ClusterContainerV1beta1Args({
    ...
    String? zone,
           ...
           .Input.asOptionalInput<AddonsConfigContainerV1beta1>(addonsConfig),
       authenticatorGroupsConfig =
       ...
       initialClusterVersion = pulumi.Input.asOptionalInput<String>(
         initialClusterVersion,
       ),
       initialNodeCount = pulumi.Input.asOptionalInput<int>(initialNodeCount),
       instanceGroupUrls = pulumi.Input.asOptionalInput<List<String>>(
         instanceGroupUrls,
       ),
       ipAllocationPolicy =
       ...
       loggingConfig = pulumi
           .Input.asOptionalInput<LoggingConfigContainerV1beta1>(loggingConfig),
       ...
       masterAuthorizedNetworksConfig =
           pulumi.Input.asOptionalInput<
             MasterAuthorizedNetworksConfigContainerV1beta1
           >(masterAuthorizedNetworksConfig),
       masterIpv4CidrBlock = pulumi.Input.asOptionalInput<String>(
         masterIpv4CidrBlock,
       ),
       meshCertificates =
       ...
       networkConfig = pulumi
           .Input.asOptionalInput<NetworkConfigContainerV1beta1>(networkConfig),
       networkPolicy = pulumi
           .Input.asOptionalInput<NetworkPolicyContainerV1beta1>(networkPolicy),
       ...
       nodePools = pulumi.Input.asOptionalInput<List<NodePoolResource>>(
         nodePools,
       ),
       notificationConfig =
       ...
       protectConfig = pulumi.Input.asOptionalInput<ProtectConfig>(
         protectConfig,
       ),
       releaseChannel =
       ...
       shieldedNodes = pulumi
           .Input.asOptionalInput<ShieldedNodesContainerV1beta1>(shieldedNodes),
       ...
       workloadCertificates = pulumi
           .Input.asOptionalInput<WorkloadCertificates>(workloadCertificates),
       workloadIdentityConfig =
  ...
  factory ClusterContainerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterContainerV1beta1Args(
      ...
      nodePools: map['nodePools'] == null
          ? null
          : (map['nodePools'] as List).cast<NodePoolResource>(),
      ...
      privateCluster: map['privateCluster'] == null
          ? null
          : map['privateCluster'] as bool,
