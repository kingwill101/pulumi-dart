...
class ClusterContainerV1beta1Args {
  ...
  ClusterContainerV1beta1Args({
    ...
    MasterAuthorizedNetworksConfigContainerV1beta1? masterAuthorizedNetworksConfig,
    ...
    List<NodePoolResource>? nodePools,
  ...
  factory ClusterContainerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterContainerV1beta1Args(
      addonsConfig: map['addonsConfig'] == null ? null : AddonsConfigContainerV1beta1.fromMap((map['addonsConfig'] as Map).cast<String, dynamic>()),
      authenticatorGroupsConfig: map['authenticatorGroupsConfig'] == null ? null : AuthenticatorGroupsConfigContainerV1beta1.fromMap((map['authenticatorGroupsConfig'] as Map).cast<String, dynamic>()),
      autopilot: map['autopilot'] == null ? null : AutopilotContainerV1beta1.fromMap((map['autopilot'] as Map).cast<String, dynamic>()),
      autoscaling: map['autoscaling'] == null ? null : ClusterAutoscalingContainerV1beta1.fromMap((map['autoscaling'] as Map).cast<String, dynamic>()),
      binaryAuthorization: map['binaryAuthorization'] == null ? null : BinaryAuthorizationContainerV1beta1.fromMap((map['binaryAuthorization'] as Map).cast<String, dynamic>()),
      clusterIpv4Cidr: map['clusterIpv4Cidr'] == null ? null : map['clusterIpv4Cidr'] as String,
      clusterTelemetry: map['clusterTelemetry'] == null ? null : ClusterTelemetry.fromMap((map['clusterTelemetry'] as Map).cast<String, dynamic>()),
      ...
      confidentialNodes: map['confidentialNodes'] == null ? null : ConfidentialNodesContainerV1beta1.fromMap((map['confidentialNodes'] as Map).cast<String, dynamic>()),
      costManagementConfig: map['costManagementConfig'] == null ? null : CostManagementConfigContainerV1beta1.fromMap((map['costManagementConfig'] as Map).cast<String, dynamic>()),
      databaseEncryption: map['databaseEncryption'] == null ? null : DatabaseEncryptionContainerV1beta1.fromMap((map['databaseEncryption'] as Map).cast<String, dynamic>()),
      defaultMaxPodsConstraint: map['defaultMaxPodsConstraint'] == null ? null : MaxPodsConstraintContainerV1beta1.fromMap((map['defaultMaxPodsConstraint'] as Map).cast<String, dynamic>()),
      ...
      fleet: map['fleet'] == null ? null : FleetContainerV1beta1.fromMap((map['fleet'] as Map).cast<String, dynamic>()),
      identityServiceConfig: map['identityServiceConfig'] == null ? null : IdentityServiceConfigContainerV1beta1.fromMap((map['identityServiceConfig'] as Map).cast<String, dynamic>()),
      ...
      ipAllocationPolicy: map['ipAllocationPolicy'] == null ? null : IPAllocationPolicyContainerV1beta1.fromMap((map['ipAllocationPolicy'] as Map).cast<String, dynamic>()),
      legacyAbac: map['legacyAbac'] == null ? null : LegacyAbacContainerV1beta1.fromMap((map['legacyAbac'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      locations: map['locations'] == null ? null : (map['locations'] as List).cast<String>(),
      loggingConfig: map['loggingConfig'] == null ? null : LoggingConfigContainerV1beta1.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>()),
      loggingService: map['loggingService'] == null ? null : map['loggingService'] as String,
      maintenancePolicy: map['maintenancePolicy'] == null ? null : MaintenancePolicyContainerV1beta1.fromMap((map['maintenancePolicy'] as Map).cast<String, dynamic>()),
      master: map['master'] == null ? null : (map['master'] as Map).cast<String, dynamic>(),
      masterAuth: map['masterAuth'] == null ? null : MasterAuthContainerV1beta1.fromMap((map['masterAuth'] as Map).cast<String, dynamic>()),
      masterAuthorizedNetworksConfig: map['masterAuthorizedNetworksConfig'] == null ? null : MasterAuthorizedNetworksConfigContainerV1beta1.fromMap((map['masterAuthorizedNetworksConfig'] as Map).cast<String, dynamic>()),
      masterIpv4CidrBlock: map['masterIpv4CidrBlock'] == null ? null : map['masterIpv4CidrBlock'] as String,
      meshCertificates: map['meshCertificates'] == null ? null : MeshCertificatesContainerV1beta1.fromMap((map['meshCertificates'] as Map).cast<String, dynamic>()),
      monitoringConfig: map['monitoringConfig'] == null ? null : MonitoringConfigContainerV1beta1.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
      monitoringService: map['monitoringService'] == null ? null : map['monitoringService'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      networkConfig: map['networkConfig'] == null ? null : NetworkConfigContainerV1beta1.fromMap((map['networkConfig'] as Map).cast<String, dynamic>()),
      networkPolicy: map['networkPolicy'] == null ? null : NetworkPolicyContainerV1beta1.fromMap((map['networkPolicy'] as Map).cast<String, dynamic>()),
      nodeConfig: map['nodeConfig'] == null ? null : NodeConfigContainerV1beta1.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodePoolAutoConfig: map['nodePoolAutoConfig'] == null ? null : NodePoolAutoConfigContainerV1beta1.fromMap((map['nodePoolAutoConfig'] as Map).cast<String, dynamic>()),
      nodePoolDefaults: map['nodePoolDefaults'] == null ? null : NodePoolDefaultsContainerV1beta1.fromMap((map['nodePoolDefaults'] as Map).cast<String, dynamic>()),
      nodePools: map['nodePools'] == null ? null : (map['nodePools'] as List).cast<NodePoolResource>(),
      notificationConfig: map['notificationConfig'] == null ? null : NotificationConfigContainerV1beta1.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>()),
      parent: map['parent'] == null ? null : map['parent'] as String,
      parentProductConfig: map['parentProductConfig'] == null ? null : ParentProductConfigContainerV1beta1.fromMap((map['parentProductConfig'] as Map).cast<String, dynamic>()),
      podSecurityPolicyConfig: map['podSecurityPolicyConfig'] == null ? null : PodSecurityPolicyConfig.fromMap((map['podSecurityPolicyConfig'] as Map).cast<String, dynamic>()),
      privateCluster: map['privateCluster'] == null ? null : map['privateCluster'] as bool,
      privateClusterConfig: map['privateClusterConfig'] == null ? null : PrivateClusterConfigContainerV1beta1.fromMap((map['privateClusterConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      protectConfig: map['protectConfig'] == null ? null : ProtectConfig.fromMap((map['protectConfig'] as Map).cast<String, dynamic>()),
      releaseChannel: map['releaseChannel'] == null ? null : ReleaseChannelContainerV1beta1.fromMap((map['releaseChannel'] as Map).cast<String, dynamic>()),
      resourceLabels: map['resourceLabels'] == null ? null : (map['resourceLabels'] as Map).cast<String, String>(),
      resourceUsageExportConfig: map['resourceUsageExportConfig'] == null ? null : ResourceUsageExportConfigContainerV1beta1.fromMap((map['resourceUsageExportConfig'] as Map).cast<String, dynamic>()),
      securityPostureConfig: map['securityPostureConfig'] == null ? null : SecurityPostureConfigContainerV1beta1.fromMap((map['securityPostureConfig'] as Map).cast<String, dynamic>()),
      shieldedNodes: map['shieldedNodes'] == null ? null : ShieldedNodesContainerV1beta1.fromMap((map['shieldedNodes'] as Map).cast<String, dynamic>()),
      subnetwork: map['subnetwork'] == null ? null : map['subnetwork'] as String,
      tpuConfig: map['tpuConfig'] == null ? null : TpuConfig.fromMap((map['tpuConfig'] as Map).cast<String, dynamic>()),
      verticalPodAutoscaling: map['verticalPodAutoscaling'] == null ? null : VerticalPodAutoscalingContainerV1beta1.fromMap((map['verticalPodAutoscaling'] as Map).cast<String, dynamic>()),
      workloadAltsConfig: map['workloadAltsConfig'] == null ? null : WorkloadALTSConfig.fromMap((map['workloadAltsConfig'] as Map).cast<String, dynamic>()),
      workloadCertificates: map['workloadCertificates'] == null ? null : WorkloadCertificates.fromMap((map['workloadCertificates'] as Map).cast<String, dynamic>()),
      workloadIdentityConfig: map['workloadIdentityConfig'] == null ? null : WorkloadIdentityConfigContainerV1beta1.fromMap((map['workloadIdentityConfig'] as Map).cast<String, dynamic>()),
