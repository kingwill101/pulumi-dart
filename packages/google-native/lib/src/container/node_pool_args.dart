...
class NodePoolArgs {
  ...
  NodePoolArgs({
    ...
    String? zone,
       ...
       networkConfig = pulumi.Input.asOptionalInput<NodeNetworkConfig>(
         networkConfig,
       ),
       parent = pulumi.Input.asOptionalInput<String>(parent),
       placementPolicy = pulumi.Input.asOptionalInput<PlacementPolicy>(
         placementPolicy,
       ),
       ...
       upgradeSettings = pulumi.Input.asOptionalInput<UpgradeSettings>(
         upgradeSettings,
       ),
