...
class OpportunisticMaintenanceStrategy {
  ...
  Map<String, dynamic> toMap() {
    ...
    final maintenanceAvailabilityWindowValue = maintenanceAvailabilityWindow;
    if (maintenanceAvailabilityWindowValue != null) {
      map['maintenanceAvailabilityWindow'] = maintenanceAvailabilityWindowValue;
    }
    final minNodesPerPoolValue = minNodesPerPool;
    if (minNodesPerPoolValue != null) {
      map['minNodesPerPool'] = minNodesPerPoolValue;
    }
    final nodeIdleTimeWindowValue = nodeIdleTimeWindow;
    if (nodeIdleTimeWindowValue != null) {
      map['nodeIdleTimeWindow'] = nodeIdleTimeWindowValue;
    }
    return map;
  }
