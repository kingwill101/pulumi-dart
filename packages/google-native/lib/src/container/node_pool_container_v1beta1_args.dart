  ...
  NodePoolContainerV1beta1Args({
    ...
    String? zone,
            ...
            pulumi.Input.asOptionalInput<NodePoolAutoscalingContainerV1beta1>(
                autoscaling),
        bestEffortProvisioning = pulumi.Input.asOptionalInput<
            BestEffortProvisioningContainerV1beta1>(bestEffortProvisioning),
        ...
        conditions =
            pulumi.Input.asOptionalInput<List<StatusConditionContainerV1beta1>>(
                conditions),
        config =
            pulumi.Input.asOptionalInput<NodeConfigContainerV1beta1>(config),
        ...
        management =
            pulumi.Input.asOptionalInput<NodeManagementContainerV1beta1>(
                management),
        maxPodsConstraint =
