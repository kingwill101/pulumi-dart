...
class NodeKubeletConfigResponseContainerV1beta1 {
  ...
  /// Creates a new [NodeKubeletConfigResponseContainerV1beta1].
  ...
  factory NodeKubeletConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeKubeletConfigResponseContainerV1beta1(
      ...
      insecureKubeletReadonlyPortEnabled: map['insecureKubeletReadonlyPortEnabled'] as bool,
      podPidsLimit: map['podPidsLimit'] as String,
    );
  }
}
