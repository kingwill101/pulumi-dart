...
class NodePoolResource extends pulumi.CustomResource {
  ...
  NodePoolResource(
    ...
    this.autoscaling = registerOutput<NodePoolAutoscalingResponseContainerV1beta1>('autoscaling');
    this.bestEffortProvisioning = registerOutput<BestEffortProvisioningResponseContainerV1beta1>('bestEffortProvisioning');
    ...
    this.management = registerOutput<NodeManagementResponseContainerV1beta1>('management');
    this.maxPodsConstraint = registerOutput<MaxPodsConstraintResponseContainerV1beta1>('maxPodsConstraint');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<NodeNetworkConfigResponseContainerV1beta1>('networkConfig');
    this.placementPolicy = registerOutput<PlacementPolicyResponseContainerV1beta1>('placementPolicy');
    this.podIpv4CidrSize = registerOutput<int>('podIpv4CidrSize');
    this.project = registerOutput<String>('project');
    this.queuedProvisioning = registerOutput<QueuedProvisioningResponseContainerV1beta1>('queuedProvisioning');
    this.selfLink = registerOutput<String>('selfLink');
    this.status = registerOutput<String>('status');
    this.statusMessage = registerOutput<String>('statusMessage');
    this.updateInfo = registerOutput<UpdateInfoResponseContainerV1beta1>('updateInfo');
    this.upgradeSettings = registerOutput<UpgradeSettingsResponseContainerV1beta1>('upgradeSettings');
