...
class NetworkConfigContainerV1beta1 {
  ...
  final ClusterNetworkPerformanceConfigContainerV1beta1? networkPerformanceConfig;
  /// The desired state of IPv6 connectivity to Google Services. By default, no private IPv6 access to or from Google Services (all access will be via IPv4)
  final NetworkConfigPrivateIpv6GoogleAccessContainerV1beta1? privateIpv6GoogleAccess;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inTransitEncryptionConfig': ?inTransitEncryptionConfig == null ? null : inTransitEncryptionConfig!.value,
  ...
  factory NetworkConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigContainerV1beta1(
      datapathProvider: map['datapathProvider'] == null ? null : NetworkConfigDatapathProviderContainerV1beta1.fromValue(map['datapathProvider'] as String),
      defaultSnatStatus: map['defaultSnatStatus'] == null ? null : DefaultSnatStatusContainerV1beta1.fromMap((map['defaultSnatStatus'] as Map).cast<String, dynamic>()),
      dnsConfig: map['dnsConfig'] == null ? null : DNSConfigContainerV1beta1.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      ...
      gatewayApiConfig: map['gatewayApiConfig'] == null ? null : GatewayAPIConfigContainerV1beta1.fromMap((map['gatewayApiConfig'] as Map).cast<String, dynamic>()),
      inTransitEncryptionConfig: map['inTransitEncryptionConfig'] == null ? null : NetworkConfigInTransitEncryptionConfig.fromValue(map['inTransitEncryptionConfig'] as String),
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : ClusterNetworkPerformanceConfigContainerV1beta1.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : NetworkConfigPrivateIpv6GoogleAccessContainerV1beta1.fromValue(map['privateIpv6GoogleAccess'] as String),
      serviceExternalIpsConfig: map['serviceExternalIpsConfig'] == null ? null : ServiceExternalIPsConfigContainerV1beta1.fromMap((map['serviceExternalIpsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
