...
class NodeConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<AcceleratorConfig, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
  ...
  factory NodeConfig.fromMap(Map<String, dynamic> map) {
    return NodeConfig(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<AcceleratorConfig>(map['accelerators'], (value) => AcceleratorConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ephemeralStorageLocalSsdConfig: map['ephemeralStorageLocalSsdConfig'] == null ? null : EphemeralStorageLocalSsdConfig.fromMap((map['ephemeralStorageLocalSsdConfig'] as Map).cast<String, dynamic>()),
      fastSocket: map['fastSocket'] == null ? null : FastSocket.fromMap((map['fastSocket'] as Map).cast<String, dynamic>()),
      gcfsConfig: map['gcfsConfig'] == null ? null : GcfsConfig.fromMap((map['gcfsConfig'] as Map).cast<String, dynamic>()),
      gvnic: map['gvnic'] == null ? null : VirtualNIC.fromMap((map['gvnic'] as Map).cast<String, dynamic>()),
      imageType: map['imageType'] == null ? null : map['imageType'] as String,
      kubeletConfig: map['kubeletConfig'] == null ? null : NodeKubeletConfig.fromMap((map['kubeletConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linuxNodeConfig: map['linuxNodeConfig'] == null ? null : LinuxNodeConfig.fromMap((map['linuxNodeConfig'] as Map).cast<String, dynamic>()),
      localNvmeSsdBlockConfig: map['localNvmeSsdBlockConfig'] == null ? null : LocalNvmeSsdBlockConfig.fromMap((map['localNvmeSsdBlockConfig'] as Map).cast<String, dynamic>()),
      ...
      sandboxConfig: map['sandboxConfig'] == null ? null : SandboxConfig.fromMap((map['sandboxConfig'] as Map).cast<String, dynamic>()),
      ...
      soleTenantConfig: map['soleTenantConfig'] == null ? null : SoleTenantConfig.fromMap((map['soleTenantConfig'] as Map).cast<String, dynamic>()),
      ...
      windowsNodeConfig: map['windowsNodeConfig'] == null ? null : WindowsNodeConfig.fromMap((map['windowsNodeConfig'] as Map).cast<String, dynamic>()),
      workloadMetadataConfig: map['workloadMetadataConfig'] == null ? null : WorkloadMetadataConfig.fromMap((map['workloadMetadataConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
