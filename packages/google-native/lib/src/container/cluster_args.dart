...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    String? zone,
       ...
       autoscaling = pulumi.Input.asOptionalInput<ClusterAutoscaling>(
         autoscaling,
       ),
       ...
       costManagementConfig = pulumi
           .Input.asOptionalInput<CostManagementConfig>(costManagementConfig),
       databaseEncryption = pulumi.Input.asOptionalInput<DatabaseEncryption>(
         databaseEncryption,
       ),
       defaultMaxPodsConstraint = pulumi
           .Input.asOptionalInput<MaxPodsConstraint>(defaultMaxPodsConstraint),
       ...
       identityServiceConfig = pulumi
           .Input.asOptionalInput<IdentityServiceConfig>(identityServiceConfig),
       ...
       loggingConfig = pulumi.Input.asOptionalInput<LoggingConfig>(
         loggingConfig,
       ),
       ...
       networkPolicy = pulumi.Input.asOptionalInput<NetworkPolicy>(
         networkPolicy,
       ),
       ...
       nodePools = pulumi.Input.asOptionalInput<List<NodePoolContainerV1>>(
         nodePools,
       ),
       ...
       releaseChannel = pulumi.Input.asOptionalInput<ReleaseChannel>(
         releaseChannel,
       ),
       ...
       securityPostureConfig = pulumi
           .Input.asOptionalInput<SecurityPostureConfig>(securityPostureConfig),
       shieldedNodes = pulumi.Input.asOptionalInput<ShieldedNodes>(
         shieldedNodes,
       ),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      nodePools: map['nodePools'] == null
          ? null
          : (map['nodePools'] as List).cast<NodePoolContainerV1>(),
