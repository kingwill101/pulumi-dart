...
class NodeConfigResponse {
  ...
  factory NodeConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponse(
      ...
      confidentialNodes: ConfidentialNodesResponse.fromMap((map['confidentialNodes'] as Map).cast<String, dynamic>()),
      diskSizeGb: map['diskSizeGb'] as int,
      diskType: map['diskType'] as String,
      ephemeralStorageLocalSsdConfig: EphemeralStorageLocalSsdConfigResponse.fromMap((map['ephemeralStorageLocalSsdConfig'] as Map).cast<String, dynamic>()),
      fastSocket: FastSocketResponse.fromMap((map['fastSocket'] as Map).cast<String, dynamic>()),
      gcfsConfig: GcfsConfigResponse.fromMap((map['gcfsConfig'] as Map).cast<String, dynamic>()),
      gvnic: VirtualNICResponse.fromMap((map['gvnic'] as Map).cast<String, dynamic>()),
      imageType: map['imageType'] as String,
      kubeletConfig: NodeKubeletConfigResponse.fromMap((map['kubeletConfig'] as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      linuxNodeConfig: LinuxNodeConfigResponse.fromMap((map['linuxNodeConfig'] as Map).cast<String, dynamic>()),
      localNvmeSsdBlockConfig: LocalNvmeSsdBlockConfigResponse.fromMap((map['localNvmeSsdBlockConfig'] as Map).cast<String, dynamic>()),
      ...
      sandboxConfig: SandboxConfigResponse.fromMap((map['sandboxConfig'] as Map).cast<String, dynamic>()),
      ...
      soleTenantConfig: SoleTenantConfigResponse.fromMap((map['soleTenantConfig'] as Map).cast<String, dynamic>()),
      ...
      windowsNodeConfig: WindowsNodeConfigResponse.fromMap((map['windowsNodeConfig'] as Map).cast<String, dynamic>()),
      workloadMetadataConfig: WorkloadMetadataConfigResponse.fromMap((map['workloadMetadataConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
