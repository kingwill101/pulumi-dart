...
class DicomStore extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudHealthcareV1DicomStreamConfigResponse>> streamConfigs;
  ...
  DicomStore(
    ...
    this.streamConfigs = registerOutput<List<GoogleCloudHealthcareV1DicomStreamConfigResponse>>('streamConfigs');
  }
}
