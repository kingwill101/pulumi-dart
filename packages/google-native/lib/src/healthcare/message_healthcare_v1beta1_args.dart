...
class MessageHealthcareV1beta1Args {
  ...
  MessageHealthcareV1beta1Args({
    ...
    String? sendTime,
       ...
       patientIds = pulumi
           .Input.asOptionalInput<List<PatientIdHealthcareV1beta1>>(patientIds),
    ...
    return <String, dynamic>{
      ...
      'patientIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<PatientIdHealthcareV1beta1>,
  ...
  factory MessageHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MessageHealthcareV1beta1Args(
      ...
      patientIds: map['patientIds'] == null
          ? null
          : pulumi.Input.decodeList<PatientIdHealthcareV1beta1>(
              map['patientIds'],
              (value) => PatientIdHealthcareV1beta1.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      project: map['project'] == null ? null : map['project'] as String,
      schematizedData: map['schematizedData'] == null
          ? null
          : SchematizedDataHealthcareV1beta1.fromMap(
              (map['schematizedData'] as Map).cast<String, dynamic>(),
            ),
      sendFacility: map['sendFacility'] == null
          ? null
          : map['sendFacility'] as String,
