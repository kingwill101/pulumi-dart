...
class MessageHealthcareV1beta1Args {
  ...
  MessageHealthcareV1beta1Args({
    ...
    String? messageType,
    String? name,
    List<PatientIdHealthcareV1beta1>? patientIds,
    String? project,
    SchematizedDataHealthcareV1beta1? schematizedData,
    String? sendFacility,
    String? sendTime,
  }) :
  ...
  factory MessageHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MessageHealthcareV1beta1Args(
      ...
      patientIds: map['patientIds'] == null ? null : pulumi.Input.decodeList<PatientIdHealthcareV1beta1>(map['patientIds'], (value) => PatientIdHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      schematizedData: map['schematizedData'] == null ? null : SchematizedDataHealthcareV1beta1.fromMap((map['schematizedData'] as Map).cast<String, dynamic>()),
      sendFacility: map['sendFacility'] == null ? null : map['sendFacility'] as String,
      sendTime: map['sendTime'] == null ? null : map['sendTime'] as String,
    );
  }
}
