...
class GoogleCloudHealthcareV1beta1DicomStreamConfigResponse {
  ...
  final GoogleCloudHealthcareV1beta1DicomBigQueryDestinationResponse
      bigqueryDestination;
  ...
  factory GoogleCloudHealthcareV1beta1DicomStreamConfigResponse.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1DicomStreamConfigResponse(
      bigqueryDestination:
          GoogleCloudHealthcareV1beta1DicomBigQueryDestinationResponse.fromMap(
