...
class SchemaPackageHealthcareV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schematizedParsingType': ?schematizedParsingType == null
          ? null
          : schematizedParsingType!.value,
      'types': ?types == null
          ? null
          : pulumi.Input.encodeList<
      ...
      'unexpectedSegmentHandling': ?unexpectedSegmentHandling == null
          ? null
          : unexpectedSegmentHandling!.value,
    };
  }
