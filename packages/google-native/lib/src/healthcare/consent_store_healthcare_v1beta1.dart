...
import 'consent_store_healthcare_v1beta1_args.dart';

/// Creates a new consent store in the parent dataset. Attempting to create a consent store with the same ID as an existing store fails with an ALREADY_EXISTS error.
class ConsentStoreHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [ConsentStoreHealthcareV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConsentStoreHealthcareV1beta1]. {@macro pulumi_healthcare_v1beta1_consent_store_healthcare_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ConsentStoreHealthcareV1beta1(
    String name, {
    ConsentStoreHealthcareV1beta1Args? args,
