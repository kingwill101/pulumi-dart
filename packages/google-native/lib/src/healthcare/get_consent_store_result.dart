...
class GetConsentStoreResult {
  ...
  /// Creates a new [GetConsentStoreResult].
  ...
  Map<String, dynamic> toMap() {
    ...
    map['defaultConsentTtl'] = defaultConsentTtl;
    map['enableConsentCreateOnUpdate'] = enableConsentCreateOnUpdate;
    map['labels'] = labels;
    map['name'] = name;
    return map;
  }

  factory GetConsentStoreResult.fromMap(Map<String, dynamic> map) {
