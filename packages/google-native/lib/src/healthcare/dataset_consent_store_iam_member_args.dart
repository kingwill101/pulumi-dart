...
/// {@template pulumi_healthcare_v1_dataset_consent_store_iam_member_args_doc}
/// The set of arguments for DatasetConsentStoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1_dataset_consent_store_iam_member_args_doc}
class DatasetConsentStoreIamMemberArgs {
  ...
  /// Creates a new [DatasetConsentStoreIamMemberArgs].
  ...
  DatasetConsentStoreIamMemberArgs({
    Condition? condition,
  ...
  factory DatasetConsentStoreIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DatasetConsentStoreIamMemberArgs(
