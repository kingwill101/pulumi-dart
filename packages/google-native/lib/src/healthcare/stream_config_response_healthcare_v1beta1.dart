...
import 'deidentified_store_destination_response_healthcare_v1beta1.dart';
import 'google_cloud_healthcare_v1beta1_fhir_big_query_destination_response.dart';

/// Contains configuration for streaming FHIR export.
class StreamConfigResponseHealthcareV1beta1 {
  ...
  final GoogleCloudHealthcareV1beta1FhirBigQueryDestinationResponse
      bigqueryDestination;
  ...
  final DeidentifiedStoreDestinationResponseHealthcareV1beta1
      deidentifiedStoreDestination;

  /// Supply a FHIR resource type (such as "Patient" or "Observation"). See https://www.hl7.org/fhir/valueset-resource-types.html for a list of all FHIR resource types. The server treats an empty list as an intent to stream all the supported resource types in this FHIR store.
  final List<String> resourceTypes;

  /// Creates a new [StreamConfigResponseHealthcareV1beta1].
  ...
  StreamConfigResponseHealthcareV1beta1({
    required this.bigqueryDestination,
    required this.deidentifiedStoreDestination,
  ...
  Map<String, dynamic> toMap() {
    ...
    map['deidentifiedStoreDestination'] = deidentifiedStoreDestination.toMap();
    map['resourceTypes'] = resourceTypes;
    return map;
  }

  factory StreamConfigResponseHealthcareV1beta1.fromMap(
      Map<String, dynamic> map) {
    return StreamConfigResponseHealthcareV1beta1(
      bigqueryDestination:
          GoogleCloudHealthcareV1beta1FhirBigQueryDestinationResponse.fromMap(
              (map['bigqueryDestination'] as Map).cast<String, dynamic>()),
      deidentifiedStoreDestination:
          DeidentifiedStoreDestinationResponseHealthcareV1beta1.fromMap(
              (map['deidentifiedStoreDestination'] as Map)
                  .cast<String, dynamic>()),
