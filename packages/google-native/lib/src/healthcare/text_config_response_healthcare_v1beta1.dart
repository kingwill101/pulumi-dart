...
class TextConfigResponseHealthcareV1beta1 {
  ...
  final List<InfoTypeTransformationResponseHealthcareV1beta1> additionalTransformations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalTransformations': pulumi.Input.encodeList<InfoTypeTransformationResponseHealthcareV1beta1, Map<String, dynamic>>(additionalTransformations, (value) => value.toMap()),
      'excludeInfoTypes': excludeInfoTypes,
      'profileType': profileType,
      'transformations': pulumi.Input.encodeList<InfoTypeTransformationResponseHealthcareV1beta1, Map<String, dynamic>>(transformations, (value) => value.toMap()),
    };
  }

  factory TextConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return TextConfigResponseHealthcareV1beta1(
      additionalTransformations: pulumi.Input.decodeList<InfoTypeTransformationResponseHealthcareV1beta1>(map['additionalTransformations'], (value) => InfoTypeTransformationResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      excludeInfoTypes: (map['excludeInfoTypes'] as List).cast<String>(),
      profileType: map['profileType'] as String,
      transformations: pulumi.Input.decodeList<InfoTypeTransformationResponseHealthcareV1beta1>(map['transformations'], (value) => InfoTypeTransformationResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
