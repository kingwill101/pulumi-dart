...
class FhirStoreHealthcareV1beta1Args {
  ...
  FhirStoreHealthcareV1beta1Args({
    ...
    FhirStoreVersionHealthcareV1beta1? version,
            ...
            complexDataTypeReferenceParsing),
        consentConfig =
            pulumi.Input.asOptionalInput<ConsentConfig>(consentConfig),
        datasetId = pulumi.Input.asInput<String>(datasetId),
        defaultSearchHandlingStrict =
            pulumi.Input.asOptionalInput<bool>(defaultSearchHandlingStrict),
        disableReferentialIntegrity =
            pulumi.Input.asOptionalInput<bool>(disableReferentialIntegrity),
        disableResourceVersioning =
            pulumi.Input.asOptionalInput<bool>(disableResourceVersioning),
        enableUpdateCreate =
            pulumi.Input.asOptionalInput<bool>(enableUpdateCreate),
        ...
        validationConfig =
            pulumi.Input.asOptionalInput<ValidationConfigHealthcareV1beta1>(
                validationConfig),
        version =
            pulumi.Input.asOptionalInput<FhirStoreVersionHealthcareV1beta1>(
                version);
  ...
  factory FhirStoreHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FhirStoreHealthcareV1beta1Args(
      complexDataTypeReferenceParsing: map['complexDataTypeReferenceParsing'] ==
              null
          ? null
          : FhirStoreComplexDataTypeReferenceParsingHealthcareV1beta1.fromValue(
              map['complexDataTypeReferenceParsing'] as String),
      consentConfig: map['consentConfig'] == null
          ? null
          : ConsentConfig.fromMap(
      ...
      fhirStoreId:
          map['fhirStoreId'] == null ? null : map['fhirStoreId'] as String,
      ...
      notificationConfigs: map['notificationConfigs'] == null
          ? null
          : pulumi.Input.decodeList<FhirNotificationConfigHealthcareV1beta1>(
              map['notificationConfigs'],
              (value) => FhirNotificationConfigHealthcareV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      searchConfig: map['searchConfig'] == null
          ? null
          : SearchConfig.fromMap(
              (map['searchConfig'] as Map).cast<String, dynamic>()),
      streamConfigs: map['streamConfigs'] == null
          ? null
          : pulumi.Input.decodeList<StreamConfigHealthcareV1beta1>(
              map['streamConfigs'],
              (value) => StreamConfigHealthcareV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      validationConfig: map['validationConfig'] == null
          ? null
          : ValidationConfigHealthcareV1beta1.fromMap(
              (map['validationConfig'] as Map).cast<String, dynamic>()),
      version: map['version'] == null
          ? null
          : FhirStoreVersionHealthcareV1beta1.fromValue(
