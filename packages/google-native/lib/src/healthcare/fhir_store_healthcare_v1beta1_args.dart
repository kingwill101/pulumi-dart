...
class FhirStoreHealthcareV1beta1Args {
  ...
  FhirStoreHealthcareV1beta1Args({
    FhirStoreComplexDataTypeReferenceParsingHealthcareV1beta1? complexDataTypeReferenceParsing,
    ...
    String? location,
    NotificationConfigHealthcareV1beta1? notificationConfig,
    List<FhirNotificationConfigHealthcareV1beta1>? notificationConfigs,
    String? project,
    SearchConfig? searchConfig,
    List<StreamConfigHealthcareV1beta1>? streamConfigs,
    ValidationConfigHealthcareV1beta1? validationConfig,
    FhirStoreVersionHealthcareV1beta1? version,
  }) :
  ...
  factory FhirStoreHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FhirStoreHealthcareV1beta1Args(
      complexDataTypeReferenceParsing: map['complexDataTypeReferenceParsing'] == null ? null : FhirStoreComplexDataTypeReferenceParsingHealthcareV1beta1.fromValue(map['complexDataTypeReferenceParsing'] as String),
      consentConfig: map['consentConfig'] == null ? null : ConsentConfig.fromMap((map['consentConfig'] as Map).cast<String, dynamic>()),
      datasetId: map['datasetId'] as String,
      defaultSearchHandlingStrict: map['defaultSearchHandlingStrict'] == null ? null : map['defaultSearchHandlingStrict'] as bool,
      disableReferentialIntegrity: map['disableReferentialIntegrity'] == null ? null : map['disableReferentialIntegrity'] as bool,
      disableResourceVersioning: map['disableResourceVersioning'] == null ? null : map['disableResourceVersioning'] as bool,
      enableUpdateCreate: map['enableUpdateCreate'] == null ? null : map['enableUpdateCreate'] as bool,
      fhirStoreId: map['fhirStoreId'] == null ? null : map['fhirStoreId'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      notificationConfig: map['notificationConfig'] == null ? null : NotificationConfigHealthcareV1beta1.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>()),
      notificationConfigs: map['notificationConfigs'] == null ? null : pulumi.Input.decodeList<FhirNotificationConfigHealthcareV1beta1>(map['notificationConfigs'], (value) => FhirNotificationConfigHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      searchConfig: map['searchConfig'] == null ? null : SearchConfig.fromMap((map['searchConfig'] as Map).cast<String, dynamic>()),
      streamConfigs: map['streamConfigs'] == null ? null : pulumi.Input.decodeList<StreamConfigHealthcareV1beta1>(map['streamConfigs'], (value) => StreamConfigHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      validationConfig: map['validationConfig'] == null ? null : ValidationConfigHealthcareV1beta1.fromMap((map['validationConfig'] as Map).cast<String, dynamic>()),
      version: map['version'] == null ? null : FhirStoreVersionHealthcareV1beta1.fromValue(map['version'] as String),
    );
  }
}
