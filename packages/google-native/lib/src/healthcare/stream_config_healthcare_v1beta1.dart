...
import 'deidentified_store_destination_healthcare_v1beta1.dart';
import 'google_cloud_healthcare_v1beta1_fhir_big_query_destination.dart';

/// Contains configuration for streaming FHIR export.
class StreamConfigHealthcareV1beta1 {
  ...
  final GoogleCloudHealthcareV1beta1FhirBigQueryDestination?
      bigqueryDestination;
  ...
  final DeidentifiedStoreDestinationHealthcareV1beta1?
      deidentifiedStoreDestination;

  /// Supply a FHIR resource type (such as "Patient" or "Observation"). See https://www.hl7.org/fhir/valueset-resource-types.html for a list of all FHIR resource types. The server treats an empty list as an intent to stream all the supported resource types in this FHIR store.
  final List<String>? resourceTypes;

  /// Creates a new [StreamConfigHealthcareV1beta1].
  ...
  Map<String, dynamic> toMap() {
    ...
    final deidentifiedStoreDestinationValue = deidentifiedStoreDestination;
    if (deidentifiedStoreDestinationValue != null) {
      map['deidentifiedStoreDestination'] =
          deidentifiedStoreDestinationValue.toMap();
    }
  ...
  factory StreamConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return StreamConfigHealthcareV1beta1(
      bigqueryDestination: map['bigqueryDestination'] == null
          ? null
          : GoogleCloudHealthcareV1beta1FhirBigQueryDestination.fromMap(
              (map['bigqueryDestination'] as Map).cast<String, dynamic>()),
      deidentifiedStoreDestination: map['deidentifiedStoreDestination'] == null
          ? null
          : DeidentifiedStoreDestinationHealthcareV1beta1.fromMap(
