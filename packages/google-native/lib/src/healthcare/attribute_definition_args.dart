...
class AttributeDefinitionArgs {
  ...
  AttributeDefinitionArgs({
    ...
    required AttributeDefinitionCategory category,
    ...
    String? project,
        ...
        consentDefaultValues =
            pulumi.Input.asOptionalInput<List<String>>(consentDefaultValues),
        consentStoreId = pulumi.Input.asInput<String>(consentStoreId),
        dataMappingDefaultValue =
            pulumi.Input.asOptionalInput<String>(dataMappingDefaultValue),
  ...
  factory AttributeDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return AttributeDefinitionArgs(
      ...
      category:
          AttributeDefinitionCategory.fromValue(map['category'] as String),
      consentDefaultValues: map['consentDefaultValues'] == null
          ? null
          : (map['consentDefaultValues'] as List).cast<String>(),
      consentStoreId: map['consentStoreId'] as String,
      dataMappingDefaultValue: map['dataMappingDefaultValue'] == null
          ? null
          : map['dataMappingDefaultValue'] as String,
