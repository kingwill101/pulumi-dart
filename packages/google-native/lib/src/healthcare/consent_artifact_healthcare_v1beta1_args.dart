...
class ConsentArtifactHealthcareV1beta1Args {
  ...
  ConsentArtifactHealthcareV1beta1Args({
    ...
    SignatureHealthcareV1beta1? witnessSignature,
       ...
       witnessSignature = pulumi
           .Input.asOptionalInput<SignatureHealthcareV1beta1>(witnessSignature);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'consentContentScreenshots':
          ?pulumi.Input.mapOptionalInputValue<
            List<ImageHealthcareV1beta1>,
            List<Map<String, dynamic>>
          >(
            consentContentScreenshots,
            (value) =>
                pulumi.Input.encodeList<
                  ImageHealthcareV1beta1,
                  Map<String, dynamic>
      ...
      'guardianSignature':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(guardianSignature, (value) => value.toMap()),
      'location': ?location,
      'metadata': ?metadata,
      'name': ?name,
      'project': ?project,
      ...
      'userSignature':
          ?pulumi.Input.mapOptionalInputValue<
            SignatureHealthcareV1beta1,
            Map<String, dynamic>
          >(userSignature, (value) => value.toMap()),
      'witnessSignature':
          ?pulumi.Input.mapOptionalInputValue<
            SignatureHealthcareV1beta1,
            Map<String, dynamic>
          >(witnessSignature, (value) => value.toMap()),
    };
  }
  ...
  factory ConsentArtifactHealthcareV1beta1Args.fromMap(
    ...
    return ConsentArtifactHealthcareV1beta1Args(
      consentContentScreenshots: map['consentContentScreenshots'] == null
          ? null
          : pulumi.Input.decodeList<ImageHealthcareV1beta1>(
              map['consentContentScreenshots'],
              (value) => ImageHealthcareV1beta1.fromMap(
      ...
      guardianSignature: map['guardianSignature'] == null
          ? null
          : SignatureHealthcareV1beta1.fromMap(
