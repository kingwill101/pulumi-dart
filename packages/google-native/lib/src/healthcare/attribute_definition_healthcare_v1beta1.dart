...
class AttributeDefinitionHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  AttributeDefinitionHealthcareV1beta1(
    ...
    this.attributeDefinitionId = registerOutput<String>(
      'attributeDefinitionId',
    );
    this.category = registerOutput<String>('category');
    this.consentDefaultValues = registerOutput<List<String>>(
      'consentDefaultValues',
    );
    this.consentStoreId = registerOutput<String>('consentStoreId');
    this.dataMappingDefaultValue = registerOutput<String>(
