...
class Annotation extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Annotation]. {@macro pulumi_healthcare_v1beta1_annotation_args_doc}
  ...
  Annotation(
    ...
    this.annotationSource = registerOutput<AnnotationSourceResponse>('annotationSource');
    ...
    this.imageAnnotation = registerOutput<ImageAnnotationResponse>('imageAnnotation');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.resourceAnnotation = registerOutput<ResourceAnnotationResponse>('resourceAnnotation');
    this.textAnnotation = registerOutput<SensitiveTextAnnotationResponse>('textAnnotation');
  }
}
