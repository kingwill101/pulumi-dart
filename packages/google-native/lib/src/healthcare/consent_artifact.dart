...
class ConsentArtifact extends pulumi.CustomResource {
  ...
  ConsentArtifact(
    ...
    this.consentContentScreenshots = registerOutput<List<ImageResponse>>(
    ...
    this.guardianSignature = registerOutput<SignatureResponse>(
      'guardianSignature',
    );
    ...
    this.witnessSignature = registerOutput<SignatureResponse>(
      'witnessSignature',
    );
  }
}
