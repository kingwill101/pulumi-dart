...
/// {@template pulumi_healthcare_v1beta1_dataset_annotation_store_iam_member_args_doc}
/// The set of arguments for DatasetAnnotationStoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_annotation_store_iam_member_args_doc}
class DatasetAnnotationStoreIamMemberArgs {
  ...
  /// Creates a new [DatasetAnnotationStoreIamMemberArgs].
  ...
  DatasetAnnotationStoreIamMemberArgs({
    Condition? condition,
  ...
  factory DatasetAnnotationStoreIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DatasetAnnotationStoreIamMemberArgs(
