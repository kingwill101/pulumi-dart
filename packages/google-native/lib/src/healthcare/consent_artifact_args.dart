...
class ConsentArtifactArgs {
  ...
  factory ConsentArtifactArgs.fromMap(Map<String, dynamic> map) {
    return ConsentArtifactArgs(
      consentContentScreenshots: map['consentContentScreenshots'] == null ? null : pulumi.Input.decodeList<Image>(map['consentContentScreenshots'], (value) => Image.fromMap((value as Map).cast<String, dynamic>())),
      ...
      guardianSignature: map['guardianSignature'] == null ? null : Signature.fromMap((map['guardianSignature'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      userId: map['userId'] as String,
      userSignature: map['userSignature'] == null ? null : Signature.fromMap((map['userSignature'] as Map).cast<String, dynamic>()),
      witnessSignature: map['witnessSignature'] == null ? null : Signature.fromMap((map['witnessSignature'] as Map).cast<String, dynamic>()),
    );
  }
}
