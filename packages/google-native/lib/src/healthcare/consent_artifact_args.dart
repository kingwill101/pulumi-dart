  ...
  ConsentArtifactArgs({
    ...
    Signature? witnessSignature,
        ...
        consentContentVersion =
            pulumi.Input.asOptionalInput<String>(consentContentVersion),
        consentStoreId = pulumi.Input.asInput<String>(consentStoreId),
        datasetId = pulumi.Input.asInput<String>(datasetId),
        guardianSignature =
            pulumi.Input.asOptionalInput<Signature>(guardianSignature),
        ...
        witnessSignature =
            pulumi.Input.asOptionalInput<Signature>(witnessSignature);
  ...
  factory ConsentArtifactArgs.fromMap(Map<String, dynamic> map) {
    return ConsentArtifactArgs(
      consentContentScreenshots: map['consentContentScreenshots'] == null
          ? null
          : pulumi.Input.decodeList<Image>(map['consentContentScreenshots'],
