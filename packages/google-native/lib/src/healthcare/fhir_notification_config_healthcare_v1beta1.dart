...
class FhirNotificationConfigHealthcareV1beta1 {
  ...
  /// Creates a new [FhirNotificationConfigHealthcareV1beta1].
  ...
  factory FhirNotificationConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return FhirNotificationConfigHealthcareV1beta1(
      ...
      sendFullResource: map['sendFullResource'] == null ? null : map['sendFullResource'] as bool,
      sendPreviousResourceOnDelete: map['sendPreviousResourceOnDelete'] == null ? null : map['sendPreviousResourceOnDelete'] as bool,
    );
  }
}
