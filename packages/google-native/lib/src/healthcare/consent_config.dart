...
class ConsentConfig {
  ...
  factory ConsentConfig.fromMap(Map<String, dynamic> map) {
    return ConsentConfig(
      accessDeterminationLogConfig: map['accessDeterminationLogConfig'] == null ? null : AccessDeterminationLogConfig.fromMap((map['accessDeterminationLogConfig'] as Map).cast<String, dynamic>()),
      accessEnforced: map['accessEnforced'] == null ? null : map['accessEnforced'] as bool,
      consentHeaderHandling: map['consentHeaderHandling'] == null ? null : ConsentHeaderHandling.fromMap((map['consentHeaderHandling'] as Map).cast<String, dynamic>()),
