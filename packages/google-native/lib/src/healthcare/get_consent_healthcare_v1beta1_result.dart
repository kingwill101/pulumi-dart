...
class GetConsentHealthcareV1beta1Result {
  ...
  final List<GoogleCloudHealthcareV1beta1ConsentPolicyResponse> policies;
  ...
  /// Creates a new [GetConsentHealthcareV1beta1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadata': metadata,
      'name': name,
      'policies': pulumi.Input.encodeList<GoogleCloudHealthcareV1beta1ConsentPolicyResponse, Map<String, dynamic>>(policies, (value) => value.toMap()),
  ...
  factory GetConsentHealthcareV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetConsentHealthcareV1beta1Result(
      consentArtifact: map['consentArtifact'] as String,
      expireTime: map['expireTime'] as String,
      metadata: (map['metadata'] as Map).cast<String, String>(),
      name: map['name'] as String,
      policies: pulumi.Input.decodeList<GoogleCloudHealthcareV1beta1ConsentPolicyResponse>(map['policies'], (value) => GoogleCloudHealthcareV1beta1ConsentPolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
