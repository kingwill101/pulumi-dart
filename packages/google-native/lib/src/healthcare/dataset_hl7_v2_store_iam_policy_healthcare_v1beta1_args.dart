...
class DatasetHl7V2StoreIamPolicyHealthcareV1beta1Args {
  ...
  DatasetHl7V2StoreIamPolicyHealthcareV1beta1Args({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigHealthcareV1beta1>>(
                auditConfigs),
        bindings = pulumi.Input.asOptionalInput<List<BindingHealthcareV1beta1>>(
            bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigHealthcareV1beta1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigHealthcareV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingHealthcareV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingHealthcareV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory DatasetHl7V2StoreIamPolicyHealthcareV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return DatasetHl7V2StoreIamPolicyHealthcareV1beta1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigHealthcareV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigHealthcareV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingHealthcareV1beta1>(
              map['bindings'],
              (value) => BindingHealthcareV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
