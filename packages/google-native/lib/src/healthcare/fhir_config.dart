...
class FhirConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fieldMetadataList': ?fieldMetadataList == null ? null : pulumi.Input.encodeList<FieldMetadata, Map<String, dynamic>>(fieldMetadataList!, (value) => value.toMap()),
    };
  }
  ...
  factory FhirConfig.fromMap(Map<String, dynamic> map) {
    return FhirConfig(
      ...
      fieldMetadataList: map['fieldMetadataList'] == null ? null : pulumi.Input.decodeList<FieldMetadata>(map['fieldMetadataList'], (value) => FieldMetadata.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
