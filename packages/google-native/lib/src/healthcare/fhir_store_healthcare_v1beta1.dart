...
import 'fhir_store_healthcare_v1beta1_args.dart';
...
class FhirStoreHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ConsentConfigResponse> consentConfig;
  ...
  late final pulumi.Output<
    List<FhirNotificationConfigResponseHealthcareV1beta1>
  >
  notificationConfigs;
  late final pulumi.Output<String> project;

  /// Configuration for how FHIR resources can be searched.
  late final pulumi.Output<SearchConfigResponse> searchConfig;
  ...
  late final pulumi.Output<List<StreamConfigResponseHealthcareV1beta1>>
  streamConfigs;

  /// Configuration for how to validate incoming FHIR resources against configured profiles.
  late final pulumi.Output<ValidationConfigResponseHealthcareV1beta1>
  validationConfig;

  /// Immutable. The FHIR specification version that this FHIR store supports natively. This field is immutable after store creation. Requests are rejected if they contain FHIR resources of a different version. Version is required for every FHIR store.
  late final pulumi.Output<String> version;

  /// Creates a new [FhirStoreHealthcareV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FhirStoreHealthcareV1beta1]. {@macro pulumi_healthcare_v1beta1_fhir_store_healthcare_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FhirStoreHealthcareV1beta1(
    String name, {
    FhirStoreHealthcareV1beta1Args? args,
    ...
    this.complexDataTypeReferenceParsing = registerOutput<String>(
      'complexDataTypeReferenceParsing',
    );
    this.consentConfig = registerOutput<ConsentConfigResponse>('consentConfig');
    this.datasetId = registerOutput<String>('datasetId');
    this.defaultSearchHandlingStrict = registerOutput<bool>(
      'defaultSearchHandlingStrict',
    );
    this.disableReferentialIntegrity = registerOutput<bool>(
      'disableReferentialIntegrity',
    );
    this.disableResourceVersioning = registerOutput<bool>(
    ...
    this.notificationConfigs =
        registerOutput<List<FhirNotificationConfigResponseHealthcareV1beta1>>(
          'notificationConfigs',
        );
    this.project = registerOutput<String>('project');
    this.searchConfig = registerOutput<SearchConfigResponse>('searchConfig');
    this.streamConfigs =
        registerOutput<List<StreamConfigResponseHealthcareV1beta1>>(
          'streamConfigs',
        );
