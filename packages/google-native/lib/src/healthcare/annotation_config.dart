...
class AnnotationConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final annotationStoreNameValue = annotationStoreName;
    if (annotationStoreNameValue != null) {
      map['annotationStoreName'] = annotationStoreNameValue;
    }
    final storeQuoteValue = storeQuote;
    if (storeQuoteValue != null) {
      map['storeQuote'] = storeQuoteValue;
    }
    return map;
  }
  ...
  factory AnnotationConfig.fromMap(Map<String, dynamic> map) {
    return AnnotationConfig(
      annotationStoreName: map['annotationStoreName'] == null
          ? null
          : map['annotationStoreName'] as String,
