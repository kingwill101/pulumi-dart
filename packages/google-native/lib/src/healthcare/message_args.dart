...
class MessageArgs {
  ...
  factory MessageArgs.fromMap(Map<String, dynamic> map) {
    return MessageArgs(
      ...
      patientIds: map['patientIds'] == null ? null : pulumi.Input.decodeList<PatientId>(map['patientIds'], (value) => PatientId.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      schematizedData: map['schematizedData'] == null ? null : SchematizedData.fromMap((map['schematizedData'] as Map).cast<String, dynamic>()),
