...
class FhirStore extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FhirNotificationConfigResponse>>
  notificationConfigs;
  ...
  FhirStore(
    ...
    this.notificationConfig = registerOutput<NotificationConfigResponse>(
      'notificationConfig',
    );
    ...
    this.streamConfigs = registerOutput<List<StreamConfigResponse>>(
      'streamConfigs',
    );
    this.validationConfig = registerOutput<ValidationConfigResponse>(
      'validationConfig',
    );
