...
/// {@template pulumi_healthcare_v1beta1_dataset_iam_member_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_iam_member_healthcare_v1beta1_args_doc}
class DatasetIamMemberHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetIamMemberHealthcareV1beta1Args].
  ...
  DatasetIamMemberHealthcareV1beta1Args({
    Condition? condition,
  ...
  factory DatasetIamMemberHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetIamMemberHealthcareV1beta1Args(
