...
/// {@template pulumi_healthcare_v1_dataset_dicom_store_iam_member_args_doc}
/// The set of arguments for DatasetDicomStoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1_dataset_dicom_store_iam_member_args_doc}
class DatasetDicomStoreIamMemberArgs {
  ...
  /// Creates a new [DatasetDicomStoreIamMemberArgs].
  ...
  DatasetDicomStoreIamMemberArgs({
    Condition? condition,
  ...
  factory DatasetDicomStoreIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DatasetDicomStoreIamMemberArgs(
