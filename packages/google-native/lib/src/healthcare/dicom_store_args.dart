...
class DicomStoreArgs {
  ...
  DicomStoreArgs({
    ...
    String? project,
    List<GoogleCloudHealthcareV1DicomStreamConfig>? streamConfigs,
  }) :
  ...
  factory DicomStoreArgs.fromMap(Map<String, dynamic> map) {
    return DicomStoreArgs(
      ...
      dicomStoreId: map['dicomStoreId'] == null ? null : map['dicomStoreId'] as String,
      ...
      streamConfigs: map['streamConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudHealthcareV1DicomStreamConfig>(map['streamConfigs'], (value) => GoogleCloudHealthcareV1DicomStreamConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
