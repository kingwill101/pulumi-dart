...
class DicomStoreArgs {
  ...
  factory DicomStoreArgs.fromMap(Map<String, dynamic> map) {
    return DicomStoreArgs(
      ...
      dicomStoreId: map['dicomStoreId'] == null
          ? null
          : map['dicomStoreId'] as String,
      ...
      streamConfigs: map['streamConfigs'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudHealthcareV1DicomStreamConfig>(
              map['streamConfigs'],
              (value) => GoogleCloudHealthcareV1DicomStreamConfig.fromMap(
