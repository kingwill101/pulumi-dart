...
class GetFhirStoreHealthcareV1beta1Result {
  ...
  final List<FhirNotificationConfigResponseHealthcareV1beta1>
      notificationConfigs;
  ...
  GetFhirStoreHealthcareV1beta1Result({
  ...
  factory GetFhirStoreHealthcareV1beta1Result.fromMap(
    ...
    return GetFhirStoreHealthcareV1beta1Result(
      ...
      notificationConfigs: pulumi.Input.decodeList<
              FhirNotificationConfigResponseHealthcareV1beta1>(
          map['notificationConfigs'],
          (value) => FhirNotificationConfigResponseHealthcareV1beta1.fromMap(
              (value as Map).cast<String, dynamic>())),
      searchConfig: SearchConfigResponse.fromMap(
          (map['searchConfig'] as Map).cast<String, dynamic>()),
      streamConfigs:
          pulumi.Input.decodeList<StreamConfigResponseHealthcareV1beta1>(
              map['streamConfigs'],
              (value) => StreamConfigResponseHealthcareV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      validationConfig: ValidationConfigResponseHealthcareV1beta1.fromMap(
