...
class FhirStoreArgs {
  ...
  final pulumi.Input<FhirStoreComplexDataTypeReferenceParsing>? complexDataTypeReferenceParsing;
  ...
  FhirStoreArgs({
    ...
    FhirStoreVersion? version,
      ...
      complexDataTypeReferenceParsing = pulumi.Input.asOptionalInput<FhirStoreComplexDataTypeReferenceParsing>(complexDataTypeReferenceParsing),
      ...
      notificationConfigs = pulumi.Input.asOptionalInput<List<FhirNotificationConfig>>(notificationConfigs),
      project = pulumi.Input.asOptionalInput<String>(project),
      streamConfigs = pulumi.Input.asOptionalInput<List<StreamConfig>>(streamConfigs),
      validationConfig = pulumi.Input.asOptionalInput<ValidationConfig>(validationConfig),
      version = pulumi.Input.asOptionalInput<FhirStoreVersion>(version);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'complexDataTypeReferenceParsing': ?pulumi.Input.mapOptionalInputValue<FhirStoreComplexDataTypeReferenceParsing, String>(complexDataTypeReferenceParsing, (value) => value.value),
      'datasetId': datasetId,
      ...
      'notificationConfigs': ?pulumi.Input.mapOptionalInputValue<List<FhirNotificationConfig>, List<Map<String, dynamic>>>(notificationConfigs, (value) => pulumi.Input.encodeList<FhirNotificationConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'project': ?project,
      'streamConfigs': ?pulumi.Input.mapOptionalInputValue<List<StreamConfig>, List<Map<String, dynamic>>>(streamConfigs, (value) => pulumi.Input.encodeList<StreamConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'validationConfig': ?pulumi.Input.mapOptionalInputValue<ValidationConfig, Map<String, dynamic>>(validationConfig, (value) => value.toMap()),
      'version': ?pulumi.Input.mapOptionalInputValue<FhirStoreVersion, String>(version, (value) => value.value),
    };
  }

  factory FhirStoreArgs.fromMap(Map<String, dynamic> map) {
    return FhirStoreArgs(
      complexDataTypeReferenceParsing: map['complexDataTypeReferenceParsing'] == null ? null : FhirStoreComplexDataTypeReferenceParsing.fromValue(map['complexDataTypeReferenceParsing'] as String),
      ...
      notificationConfigs: map['notificationConfigs'] == null ? null : pulumi.Input.decodeList<FhirNotificationConfig>(map['notificationConfigs'], (value) => FhirNotificationConfig.fromMap((value as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : map['project'] as String,
      streamConfigs: map['streamConfigs'] == null ? null : pulumi.Input.decodeList<StreamConfig>(map['streamConfigs'], (value) => StreamConfig.fromMap((value as Map).cast<String, dynamic>())),
      validationConfig: map['validationConfig'] == null ? null : ValidationConfig.fromMap((map['validationConfig'] as Map).cast<String, dynamic>()),
      version: map['version'] == null ? null : FhirStoreVersion.fromValue(map['version'] as String),
    );
  }
}
