...
class FhirStoreArgs {
  ...
  FhirStoreArgs({
    ...
    FhirStoreVersion? version,
        ...
        streamConfigs =
            pulumi.Input.asOptionalInput<List<StreamConfig>>(streamConfigs),
        validationConfig =
            pulumi.Input.asOptionalInput<ValidationConfig>(validationConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (complexDataTypeReferenceParsingValue != null) {
      map['complexDataTypeReferenceParsing'] =
          pulumi.Input.mapOptionalInputValue<
                  FhirStoreComplexDataTypeReferenceParsing, String>(
    ...
    if (notificationConfigsValue != null) {
      map['notificationConfigs'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<FhirNotificationConfig,
    ...
    if (streamConfigsValue != null) {
      map['streamConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<StreamConfig>, List<Map<String, dynamic>>>(
          streamConfigsValue,
          (value) =>
    ...
    if (validationConfigValue != null) {
      map['validationConfig'] = pulumi.Input.mapOptionalInputValue<
              ValidationConfig, Map<String, dynamic>>(
          validationConfigValue, (value) => value.toMap());
    }
    final versionValue = version;
    if (versionValue != null) {
      map['version'] =
          pulumi.Input.mapOptionalInputValue<FhirStoreVersion, String>(
