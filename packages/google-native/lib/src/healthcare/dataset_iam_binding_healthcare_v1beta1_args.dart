...
/// {@template pulumi_healthcare_v1beta1_dataset_iam_binding_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_iam_binding_healthcare_v1beta1_args_doc}
class DatasetIamBindingHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetIamBindingHealthcareV1beta1Args].
  ...
  DatasetIamBindingHealthcareV1beta1Args({
    Condition? condition,
  ...
  factory DatasetIamBindingHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetIamBindingHealthcareV1beta1Args(
