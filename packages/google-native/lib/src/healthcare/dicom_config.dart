...
class DicomConfig {
  ...
  factory DicomConfig.fromMap(Map<String, dynamic> map) {
    return DicomConfig(
      filterProfile: map['filterProfile'] == null ? null : DicomConfigFilterProfile.fromValue(map['filterProfile'] as String),
      keepList: map['keepList'] == null ? null : TagFilterList.fromMap((map['keepList'] as Map).cast<String, dynamic>()),
      removeList: map['removeList'] == null ? null : TagFilterList.fromMap((map['removeList'] as Map).cast<String, dynamic>()),
