...
class Action {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cleanImageTag': ?cleanImageTag == null ? null : cleanImageTag!.toMap(),
  ...
  factory Action.fromMap(Map<String, dynamic> map) {
    return Action(
      cleanImageTag: map['cleanImageTag'] == null ? null : ImageConfigHealthcareV1beta1.fromMap((map['cleanImageTag'] as Map).cast<String, dynamic>()),
      cleanTextTag: map['cleanTextTag'] == null ? null : (map['cleanTextTag'] as Map).cast<String, dynamic>(),
      deleteTag: map['deleteTag'] == null ? null : (map['deleteTag'] as Map).cast<String, dynamic>(),
      keepTag: map['keepTag'] == null ? null : (map['keepTag'] as Map).cast<String, dynamic>(),
      queries: map['queries'] == null ? null : (map['queries'] as List).cast<String>(),
      recurseTag: map['recurseTag'] == null ? null : (map['recurseTag'] as Map).cast<String, dynamic>(),
      regenUidTag: map['regenUidTag'] == null ? null : (map['regenUidTag'] as Map).cast<String, dynamic>(),
      removeTag: map['removeTag'] == null ? null : (map['removeTag'] as Map).cast<String, dynamic>(),
      resetTag: map['resetTag'] == null ? null : (map['resetTag'] as Map).cast<String, dynamic>(),
    );
  }
}
