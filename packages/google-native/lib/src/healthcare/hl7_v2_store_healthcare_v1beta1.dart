...
class Hl7V2StoreHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<
    List<Hl7V2NotificationConfigResponseHealthcareV1beta1>
  >
  notificationConfigs;
  ...
  Hl7V2StoreHealthcareV1beta1(
    ...
    this.notificationConfigs =
        registerOutput<List<Hl7V2NotificationConfigResponseHealthcareV1beta1>>(
          'notificationConfigs',
        );
    this.parserConfig = registerOutput<ParserConfigResponseHealthcareV1beta1>(
      'parserConfig',
    );
    this.project = registerOutput<String>('project');
    this.rejectDuplicateMessage = registerOutput<bool>(
