...
/// {@template pulumi_healthcare_v1_dataset_fhir_store_iam_policy_args_doc}
/// The set of arguments for DatasetFhirStoreIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1_dataset_fhir_store_iam_policy_args_doc}
class DatasetFhirStoreIamPolicyArgs {
  ...
  /// Creates a new [DatasetFhirStoreIamPolicyArgs].
  ...
  factory DatasetFhirStoreIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DatasetFhirStoreIamPolicyArgs(
