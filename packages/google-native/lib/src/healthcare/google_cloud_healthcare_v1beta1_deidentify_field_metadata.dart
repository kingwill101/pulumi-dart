...
class GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata {
  ...
  factory GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata(
      characterMaskField: map['characterMaskField'] == null ? null : (map['characterMaskField'] as Map).cast<String, dynamic>(),
      cleanTextField: map['cleanTextField'] == null ? null : (map['cleanTextField'] as Map).cast<String, dynamic>(),
      cryptoHashField: map['cryptoHashField'] == null ? null : (map['cryptoHashField'] as Map).cast<String, dynamic>(),
      dateShiftField: map['dateShiftField'] == null ? null : (map['dateShiftField'] as Map).cast<String, dynamic>(),
      keepField: map['keepField'] == null ? null : (map['keepField'] as Map).cast<String, dynamic>(),
      paths: map['paths'] == null ? null : (map['paths'] as List).cast<String>(),
      removeField: map['removeField'] == null ? null : (map['removeField'] as Map).cast<String, dynamic>(),
    );
  }
}
