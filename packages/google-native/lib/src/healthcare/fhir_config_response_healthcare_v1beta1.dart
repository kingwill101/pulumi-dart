...
class FhirConfigResponseHealthcareV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fieldMetadataList': pulumi.Input.encodeList<FieldMetadataResponseHealthcareV1beta1, Map<String, dynamic>>(fieldMetadataList, (value) => value.toMap()),
    };
  }
  ...
  factory FhirConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return FhirConfigResponseHealthcareV1beta1(
      ...
      fieldMetadataList: pulumi.Input.decodeList<FieldMetadataResponseHealthcareV1beta1>(map['fieldMetadataList'], (value) => FieldMetadataResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
