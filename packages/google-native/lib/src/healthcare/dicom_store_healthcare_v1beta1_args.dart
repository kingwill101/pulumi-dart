...
class DicomStoreHealthcareV1beta1Args {
  ...
  DicomStoreHealthcareV1beta1Args({
    ...
    String? project,
    List<GoogleCloudHealthcareV1beta1DicomStreamConfig>? streamConfigs,
  }) :
  ...
  factory DicomStoreHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DicomStoreHealthcareV1beta1Args(
      ...
      streamConfigs: map['streamConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudHealthcareV1beta1DicomStreamConfig>(map['streamConfigs'], (value) => GoogleCloudHealthcareV1beta1DicomStreamConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
