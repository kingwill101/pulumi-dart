...
class LineageEventArgs {
  ...
  LineageEventArgs({
    String? endTime,
    List<GoogleCloudDatacatalogLineageV1EventLink>? links,
    String? location,
    String? name,
  ...
  factory LineageEventArgs.fromMap(Map<String, dynamic> map) {
    return LineageEventArgs(
      ...
      links: map['links'] == null ? null : pulumi.Input.decodeList<GoogleCloudDatacatalogLineageV1EventLink>(map['links'], (value) => GoogleCloudDatacatalogLineageV1EventLink.fromMap((value as Map).cast<String, dynamic>())),
