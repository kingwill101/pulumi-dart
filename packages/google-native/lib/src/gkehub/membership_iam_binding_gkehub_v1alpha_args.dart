...
/// {@template pulumi_gkehub_v1alpha_membership_iam_binding_gkehub_v1alpha_args_doc}
/// The set of arguments for MembershipIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha_membership_iam_binding_gkehub_v1alpha_args_doc}
class MembershipIamBindingGkehubV1alphaArgs {
  ...
  /// Creates a new [MembershipIamBindingGkehubV1alphaArgs].
  ...
  MembershipIamBindingGkehubV1alphaArgs({
    Condition? condition,
  ...
  factory MembershipIamBindingGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipIamBindingGkehubV1alphaArgs(
