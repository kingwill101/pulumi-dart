...
import 'namespace_gkehub_v1beta_args.dart';
import 'namespace_lifecycle_state_response_gkehub_v1beta.dart';

/// Creates a fleet namespace.
/// Auto-naming is currently not supported for this resource.
class NamespaceGkehubV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NamespaceLifecycleStateResponseGkehubV1beta> state;
  ...
  /// Creates a new [NamespaceGkehubV1beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NamespaceGkehubV1beta]. {@macro pulumi_gkehub_v1beta_namespace_gkehub_v1beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  NamespaceGkehubV1beta(
    String name, {
    NamespaceGkehubV1betaArgs? args,
    ...
    this.namespaceLabels = registerOutput<Map<String, String>>(
      'namespaceLabels',
    );
    ...
    this.state = registerOutput<NamespaceLifecycleStateResponseGkehubV1beta>(
      'state',
    );
