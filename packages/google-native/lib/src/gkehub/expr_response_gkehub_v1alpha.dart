...
class ExprResponseGkehubV1alpha {
  ...
  /// Creates a new [ExprResponseGkehubV1alpha].
  ...
  factory ExprResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ExprResponseGkehubV1alpha(
