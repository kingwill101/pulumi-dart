...
class PolicyControllerTemplateLibraryConfigGkehubV1alpha {
  ...
  final PolicyControllerTemplateLibraryConfigInstallationGkehubV1alpha? installation;
  ...
  factory PolicyControllerTemplateLibraryConfigGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return PolicyControllerTemplateLibraryConfigGkehubV1alpha(
      installation: map['installation'] == null ? null : PolicyControllerTemplateLibraryConfigInstallationGkehubV1alpha.fromValue(map['installation'] as String),
    );
  }
}
