...
class FeatureGkehubV1betaArgs {
  ...
  final pulumi.Input<CommonFleetDefaultMemberConfigSpecGkehubV1beta>?
  ...
  FeatureGkehubV1betaArgs({
    ...
    CommonFeatureSpecGkehubV1beta? spec,
        ...
        membershipSpecs =
            pulumi.Input.asOptionalInput<Map<String, String>>(membershipSpecs),
        project = pulumi.Input.asOptionalInput<String>(project),
        requestId = pulumi.Input.asOptionalInput<String>(requestId),
        scopeSpecs =
            pulumi.Input.asOptionalInput<Map<String, String>>(scopeSpecs),
        spec =
            pulumi.Input.asOptionalInput<CommonFeatureSpecGkehubV1beta>(spec);
  ...
  factory FeatureGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGkehubV1betaArgs(
      ...
      fleetDefaultMemberConfig: map['fleetDefaultMemberConfig'] == null
          ? null
          : CommonFleetDefaultMemberConfigSpecGkehubV1beta.fromMap(
      ...
      spec: map['spec'] == null
          ? null
          : CommonFeatureSpecGkehubV1beta.fromMap(
