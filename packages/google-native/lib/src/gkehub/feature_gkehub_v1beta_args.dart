...
class FeatureGkehubV1betaArgs {
  ...
  FeatureGkehubV1betaArgs({
    String? featureId,
    CommonFleetDefaultMemberConfigSpecGkehubV1beta? fleetDefaultMemberConfig,
    ...
    CommonFeatureSpecGkehubV1beta? spec,
  }) :
  ...
  factory FeatureGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGkehubV1betaArgs(
      ...
      fleetDefaultMemberConfig: map['fleetDefaultMemberConfig'] == null ? null : CommonFleetDefaultMemberConfigSpecGkehubV1beta.fromMap((map['fleetDefaultMemberConfig'] as Map).cast<String, dynamic>()),
      ...
      spec: map['spec'] == null ? null : CommonFeatureSpecGkehubV1beta.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
