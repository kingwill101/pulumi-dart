...
class Namespace extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NamespaceLifecycleStateResponse> state;
  ...
  /// [args] Arguments used to configure this [Namespace]. {@macro pulumi_gkehub_v1_namespace_args_doc}
  ...
  Namespace(
    ...
    this.state = registerOutput<NamespaceLifecycleStateResponse>('state');
