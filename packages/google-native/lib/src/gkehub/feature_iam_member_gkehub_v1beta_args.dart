...
/// {@template pulumi_gkehub_v1beta_feature_iam_member_gkehub_v1beta_args_doc}
/// The set of arguments for FeatureIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta_feature_iam_member_gkehub_v1beta_args_doc}
class FeatureIamMemberGkehubV1betaArgs {
  ...
  /// Creates a new [FeatureIamMemberGkehubV1betaArgs].
  ...
  FeatureIamMemberGkehubV1betaArgs({
    Condition? condition,
  ...
  factory FeatureIamMemberGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureIamMemberGkehubV1betaArgs(
