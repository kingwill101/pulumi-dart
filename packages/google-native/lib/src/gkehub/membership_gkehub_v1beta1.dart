...
class MembershipGkehubV1beta1 extends pulumi.CustomResource {
  ...
  MembershipGkehubV1beta1(
    ...
    this.authority = registerOutput<AuthorityResponseGkehubV1beta1>(
      'authority',
    );
    this.createTime = registerOutput<String>('createTime');
    this.deleteTime = registerOutput<String>('deleteTime');
    this.description = registerOutput<String>('description');
    this.endpoint = registerOutput<MembershipEndpointResponseGkehubV1beta1>(
      'endpoint',
    );
    ...
    this.monitoringConfig =
        registerOutput<MonitoringConfigResponseGkehubV1beta1>(
          'monitoringConfig',
        );
