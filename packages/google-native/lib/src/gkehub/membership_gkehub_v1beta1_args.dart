...
class MembershipGkehubV1beta1Args {
  ...
  MembershipGkehubV1beta1Args({
    AuthorityGkehubV1beta1? authority,
    String? description,
    MembershipEndpointGkehubV1beta1? endpoint,
    String? externalId,
    MembershipInfrastructureTypeGkehubV1beta1? infrastructureType,
    Map<String, String>? labels,
    String? location,
    required String membershipId,
    MonitoringConfigGkehubV1beta1? monitoringConfig,
    String? project,
    String? requestId,
  }) :
  ...
  factory MembershipGkehubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1beta1Args(
      authority: map['authority'] == null ? null : AuthorityGkehubV1beta1.fromMap((map['authority'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      endpoint: map['endpoint'] == null ? null : MembershipEndpointGkehubV1beta1.fromMap((map['endpoint'] as Map).cast<String, dynamic>()),
      externalId: map['externalId'] == null ? null : map['externalId'] as String,
      infrastructureType: map['infrastructureType'] == null ? null : MembershipInfrastructureTypeGkehubV1beta1.fromValue(map['infrastructureType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      membershipId: map['membershipId'] as String,
      monitoringConfig: map['monitoringConfig'] == null ? null : MonitoringConfigGkehubV1beta1.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
