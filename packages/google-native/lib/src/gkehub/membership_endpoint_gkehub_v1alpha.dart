...
class MembershipEndpointGkehubV1alpha {
  ...
  factory MembershipEndpointGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointGkehubV1alpha(
      applianceCluster: map['applianceCluster'] == null ? null : ApplianceClusterGkehubV1alpha.fromMap((map['applianceCluster'] as Map).cast<String, dynamic>()),
      edgeCluster: map['edgeCluster'] == null ? null : EdgeClusterGkehubV1alpha.fromMap((map['edgeCluster'] as Map).cast<String, dynamic>()),
      gkeCluster: map['gkeCluster'] == null ? null : GkeClusterGkehubV1alpha.fromMap((map['gkeCluster'] as Map).cast<String, dynamic>()),
      kubernetesResource: map['kubernetesResource'] == null ? null : KubernetesResourceGkehubV1alpha.fromMap((map['kubernetesResource'] as Map).cast<String, dynamic>()),
      multiCloudCluster: map['multiCloudCluster'] == null ? null : MultiCloudClusterGkehubV1alpha.fromMap((map['multiCloudCluster'] as Map).cast<String, dynamic>()),
      onPremCluster: map['onPremCluster'] == null ? null : OnPremClusterGkehubV1alpha.fromMap((map['onPremCluster'] as Map).cast<String, dynamic>()),
    );
  }
}
