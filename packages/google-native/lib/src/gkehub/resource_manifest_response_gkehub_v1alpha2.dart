...
class ResourceManifestResponseGkehubV1alpha2 {
  /// Whether the resource provided in the manifest is `cluster_scoped`. If unset, the manifest is assumed to be namespace scoped. This field is used for REST mapping when applying the resource in a cluster.
  final bool clusterScoped;
  /// YAML manifest of the resource.
  final String manifest;

  /// Creates a new [ResourceManifestResponseGkehubV1alpha2].
  ...
  factory ResourceManifestResponseGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceManifestResponseGkehubV1alpha2(
