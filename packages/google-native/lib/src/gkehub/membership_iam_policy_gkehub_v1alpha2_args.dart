...
class MembershipIamPolicyGkehubV1alpha2Args {
  ...
  MembershipIamPolicyGkehubV1alpha2Args({
    ...
    int? version,
      ...
      auditConfigs = pulumi.Input.asOptionalInput<List<AuditConfigGkehubV1alpha2>>(auditConfigs),
      bindings = pulumi.Input.asOptionalInput<List<BindingGkehubV1alpha2>>(bindings),
  ...
  factory MembershipIamPolicyGkehubV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return MembershipIamPolicyGkehubV1alpha2Args(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Input.decodeList<AuditConfigGkehubV1alpha2>(map['auditConfigs'], (value) => AuditConfigGkehubV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<BindingGkehubV1alpha2>(map['bindings'], (value) => BindingGkehubV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
