...
class MembershipIamPolicyGkehubV1alpha2Args {
  ...
  MembershipIamPolicyGkehubV1alpha2Args({
    List<AuditConfigGkehubV1alpha2>? auditConfigs,
    List<BindingGkehubV1alpha2>? bindings,
    String? etag,
    String? location,
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigGkehubV1alpha2>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingGkehubV1alpha2>>(bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigGkehubV1alpha2>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigGkehubV1alpha2,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingGkehubV1alpha2>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingGkehubV1alpha2,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory MembershipIamPolicyGkehubV1alpha2Args.fromMap(
      Map<String, dynamic> map) {
    return MembershipIamPolicyGkehubV1alpha2Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigGkehubV1alpha2>(
              map['auditConfigs'],
              (value) => AuditConfigGkehubV1alpha2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingGkehubV1alpha2>(
              map['bindings'],
              (value) => BindingGkehubV1alpha2.fromMap(
                  (value as Map).cast<String, dynamic>())),
