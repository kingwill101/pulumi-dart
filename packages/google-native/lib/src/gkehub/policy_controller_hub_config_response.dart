...
class PolicyControllerHubConfigResponse {
  ...
  factory PolicyControllerHubConfigResponse.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponse(
      ...
      deploymentConfigs: (map['deploymentConfigs'] as Map)
          .cast<String, String>(),
      ...
      monitoring: PolicyControllerMonitoringConfigResponse.fromMap(
        (map['monitoring'] as Map).cast<String, dynamic>(),
      ),
      mutationEnabled: map['mutationEnabled'] as bool,
      policyContent: PolicyControllerPolicyContentSpecResponse.fromMap(
