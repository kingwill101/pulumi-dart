...
import 'policy_controller_monitoring_config_response.dart';
import 'policy_controller_policy_content_spec_response.dart';
...
class PolicyControllerHubConfigResponse {
  ...
  final PolicyControllerMonitoringConfigResponse monitoring;
  /// Enables the ability to mutate resources using Policy Controller.
  final bool mutationEnabled;
  /// Specifies the desired policy content on the cluster
  final PolicyControllerPolicyContentSpecResponse policyContent;
  /// Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
  final bool referentialRulesEnabled;

  /// Creates a new [PolicyControllerHubConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policyContent': policyContent.toMap(),
  ...
  factory PolicyControllerHubConfigResponse.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponse(
      ...
      deploymentConfigs: (map['deploymentConfigs'] as Map).cast<String, String>(),
      ...
      monitoring: PolicyControllerMonitoringConfigResponse.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
      mutationEnabled: map['mutationEnabled'] as bool,
      policyContent: PolicyControllerPolicyContentSpecResponse.fromMap((map['policyContent'] as Map).cast<String, dynamic>()),
