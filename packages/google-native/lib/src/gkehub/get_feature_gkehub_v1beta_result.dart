...
class GetFeatureGkehubV1betaResult {
  ...
  final CommonFleetDefaultMemberConfigSpecResponseGkehubV1beta
  ...
  factory GetFeatureGkehubV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetFeatureGkehubV1betaResult(
      ...
      fleetDefaultMemberConfig:
          CommonFleetDefaultMemberConfigSpecResponseGkehubV1beta.fromMap(
      ...
      resourceState: FeatureResourceStateResponseGkehubV1beta.fromMap(
      ...
      spec: CommonFeatureSpecResponseGkehubV1beta.fromMap(
        (map['spec'] as Map).cast<String, dynamic>(),
      ),
      state: CommonFeatureStateResponseGkehubV1beta.fromMap(
