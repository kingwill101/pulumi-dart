...
class PolicyControllerHubConfigResponseGkehubV1beta {
  ...
  /// Creates a new [PolicyControllerHubConfigResponseGkehubV1beta].
  ...
  factory PolicyControllerHubConfigResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponseGkehubV1beta(
      ...
      monitoring: PolicyControllerMonitoringConfigResponseGkehubV1beta.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
      mutationEnabled: map['mutationEnabled'] as bool,
      policyContent: PolicyControllerPolicyContentSpecResponseGkehubV1beta.fromMap((map['policyContent'] as Map).cast<String, dynamic>()),
