...
class MembershipEndpointGkehubV1alpha2 {
  ...
  factory MembershipEndpointGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointGkehubV1alpha2(
      applianceCluster: map['applianceCluster'] == null ? null : ApplianceClusterGkehubV1alpha2.fromMap((map['applianceCluster'] as Map).cast<String, dynamic>()),
      edgeCluster: map['edgeCluster'] == null ? null : EdgeClusterGkehubV1alpha2.fromMap((map['edgeCluster'] as Map).cast<String, dynamic>()),
      gkeCluster: map['gkeCluster'] == null ? null : GkeClusterGkehubV1alpha2.fromMap((map['gkeCluster'] as Map).cast<String, dynamic>()),
      kubernetesResource: map['kubernetesResource'] == null ? null : KubernetesResourceGkehubV1alpha2.fromMap((map['kubernetesResource'] as Map).cast<String, dynamic>()),
      multiCloudCluster: map['multiCloudCluster'] == null ? null : MultiCloudClusterGkehubV1alpha2.fromMap((map['multiCloudCluster'] as Map).cast<String, dynamic>()),
      onPremCluster: map['onPremCluster'] == null ? null : OnPremClusterGkehubV1alpha2.fromMap((map['onPremCluster'] as Map).cast<String, dynamic>()),
    );
  }
}
