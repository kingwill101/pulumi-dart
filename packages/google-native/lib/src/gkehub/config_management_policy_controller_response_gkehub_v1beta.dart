...
import 'config_management_policy_controller_monitoring_response_gkehub_v1beta.dart';

/// Configuration for Policy Controller
class ConfigManagementPolicyControllerResponseGkehubV1beta {
  ...
  final ConfigManagementPolicyControllerMonitoringResponseGkehubV1beta
      monitoring;
  ...
  /// Creates a new [ConfigManagementPolicyControllerResponseGkehubV1beta].
  ...
  ConfigManagementPolicyControllerResponseGkehubV1beta({
  ...
  factory ConfigManagementPolicyControllerResponseGkehubV1beta.fromMap(
      Map<String, dynamic> map) {
    return ConfigManagementPolicyControllerResponseGkehubV1beta(
      ...
      monitoring: ConfigManagementPolicyControllerMonitoringResponseGkehubV1beta
