...
class PolicyControllerHubConfigResponseGkehubV1alpha {
  ...
  final PolicyControllerMonitoringConfigResponseGkehubV1alpha monitoring;
  /// Enables the ability to mutate resources using Policy Controller.
  final bool mutationEnabled;
  /// Specifies the desired policy content on the cluster
  final PolicyControllerPolicyContentSpecResponseGkehubV1alpha policyContent;
  ...
  factory PolicyControllerHubConfigResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponseGkehubV1alpha(
      ...
      monitoring: PolicyControllerMonitoringConfigResponseGkehubV1alpha.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
      mutationEnabled: map['mutationEnabled'] as bool,
      policyContent: PolicyControllerPolicyContentSpecResponseGkehubV1alpha.fromMap((map['policyContent'] as Map).cast<String, dynamic>()),
