...
class MembershipGkehubV1alphaArgs {
  ...
  factory MembershipGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1alphaArgs(
      authority: map['authority'] == null ? null : AuthorityGkehubV1alpha.fromMap((map['authority'] as Map).cast<String, dynamic>()),
      endpoint: map['endpoint'] == null ? null : MembershipEndpointGkehubV1alpha.fromMap((map['endpoint'] as Map).cast<String, dynamic>()),
      externalId: map['externalId'] == null ? null : map['externalId'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      membershipId: map['membershipId'] as String,
      monitoringConfig: map['monitoringConfig'] == null ? null : MonitoringConfigGkehubV1alpha.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
