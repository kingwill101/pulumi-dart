...
class GetScopeResult {
  ...
  final ScopeLifecycleStateResponse state;
  ...
  factory GetScopeResult.fromMap(Map<String, dynamic> map) {
    return GetScopeResult(
      ...
      state: ScopeLifecycleStateResponse.fromMap(
