...
class ConfigManagementConfigSyncResponseGkehubV1beta {
  ...
  factory ConfigManagementConfigSyncResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSyncResponseGkehubV1beta(
      ...
      git: ConfigManagementGitConfigResponseGkehubV1beta.fromMap((map['git'] as Map).cast<String, dynamic>()),
      metricsGcpServiceAccountEmail: map['metricsGcpServiceAccountEmail'] as String,
      oci: ConfigManagementOciConfigResponseGkehubV1beta.fromMap((map['oci'] as Map).cast<String, dynamic>()),
