...
class MembershipEndpointGkehubV1beta1 {
  ...
  factory MembershipEndpointGkehubV1beta1.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointGkehubV1beta1(
      applianceCluster: map['applianceCluster'] == null ? null : ApplianceClusterGkehubV1beta1.fromMap((map['applianceCluster'] as Map).cast<String, dynamic>()),
      edgeCluster: map['edgeCluster'] == null ? null : EdgeClusterGkehubV1beta1.fromMap((map['edgeCluster'] as Map).cast<String, dynamic>()),
      gkeCluster: map['gkeCluster'] == null ? null : GkeClusterGkehubV1beta1.fromMap((map['gkeCluster'] as Map).cast<String, dynamic>()),
      kubernetesResource: map['kubernetesResource'] == null ? null : KubernetesResourceGkehubV1beta1.fromMap((map['kubernetesResource'] as Map).cast<String, dynamic>()),
      multiCloudCluster: map['multiCloudCluster'] == null ? null : MultiCloudClusterGkehubV1beta1.fromMap((map['multiCloudCluster'] as Map).cast<String, dynamic>()),
      onPremCluster: map['onPremCluster'] == null ? null : OnPremClusterGkehubV1beta1.fromMap((map['onPremCluster'] as Map).cast<String, dynamic>()),
    );
  }
}
