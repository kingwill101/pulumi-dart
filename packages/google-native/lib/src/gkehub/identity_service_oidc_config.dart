...
class IdentityServiceOidcConfig {
  ...
  /// Creates a new [IdentityServiceOidcConfig].
  ...
  factory IdentityServiceOidcConfig.fromMap(Map<String, dynamic> map) {
    return IdentityServiceOidcConfig(
      ...
      extraParams: map['extraParams'] == null
          ? null
          : map['extraParams'] as String,
      groupPrefix: map['groupPrefix'] == null
          ? null
          : map['groupPrefix'] as String,
      groupsClaim: map['groupsClaim'] == null
          ? null
          : map['groupsClaim'] as String,
      ...
      userPrefix: map['userPrefix'] == null
          ? null
          : map['userPrefix'] as String,
    );
  }
}
