...
class Feature extends pulumi.CustomResource {
  ...
  Feature(
    ...
    this.fleetDefaultMemberConfig = registerOutput<CommonFleetDefaultMemberConfigSpecResponse>('fleetDefaultMemberConfig');
    ...
    this.resourceState = registerOutput<FeatureResourceStateResponse>('resourceState');
