...
class MonitoringConfigGkehubV1alpha2 {
  ...
  /// Creates a new [MonitoringConfigGkehubV1alpha2].
  ...
  MonitoringConfigGkehubV1alpha2({
    this.cluster,
    this.clusterHash,
  ...
  factory MonitoringConfigGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return MonitoringConfigGkehubV1alpha2(
      ...
      clusterHash: map['clusterHash'] == null ? null : map['clusterHash'] as String,
      kubernetesMetricsPrefix: map['kubernetesMetricsPrefix'] == null ? null : map['kubernetesMetricsPrefix'] as String,
