...
import 'binding_gkehub_v1.dart';

/// {@template pulumi_gkehub_v1_membership_iam_policy_args_doc}
/// The set of arguments for MembershipIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1_membership_iam_policy_args_doc}
class MembershipIamPolicyArgs {
  ...
  final pulumi.Input<List<BindingGkehubV1>>? bindings;
  ...
  MembershipIamPolicyArgs({
    ...
    int? version,
      ...
      bindings = pulumi.Input.asOptionalInput<List<BindingGkehubV1>>(bindings),
  ...
  factory MembershipIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return MembershipIamPolicyArgs(
      ...
      bindings: map['bindings'] == null ? null : (map['bindings'] as List).cast<BindingGkehubV1>(),
