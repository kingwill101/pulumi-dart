...
class FleetGkehubV1alphaArgs {
  ...
  FleetGkehubV1alphaArgs({
    DefaultClusterConfigGkehubV1alpha? defaultClusterConfig,
    String? displayName,
  ...
  factory FleetGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FleetGkehubV1alphaArgs(
      defaultClusterConfig: map['defaultClusterConfig'] == null ? null : DefaultClusterConfigGkehubV1alpha.fromMap((map['defaultClusterConfig'] as Map).cast<String, dynamic>()),
