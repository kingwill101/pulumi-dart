...
class MembershipIamPolicyGkehubV1alphaArgs {
  ...
  MembershipIamPolicyGkehubV1alphaArgs({
    ...
    int? version,
           ...
           .Input.asOptionalInput<List<AuditConfigGkehubV1alpha>>(auditConfigs),
  ...
  factory MembershipIamPolicyGkehubV1alphaArgs.fromMap(
    ...
    return MembershipIamPolicyGkehubV1alphaArgs(
      ...
      bindings: map['bindings'] == null
          ? null
          : (map['bindings'] as List).cast<BindingResource>(),
