...
class Membership extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AuthorityResponse> authority;
  ...
  late final pulumi.Output<MembershipEndpointResponse> endpoint;
  ...
  late final pulumi.Output<MembershipStateResponse> state;
  ...
  /// [args] Arguments used to configure this [Membership]. {@macro pulumi_gkehub_v1_membership_args_doc}
  ...
  Membership(
    ...
    this.authority = registerOutput<AuthorityResponse>('authority');
    ...
    this.monitoringConfig = registerOutput<MonitoringConfigResponse>(
      'monitoringConfig',
    );
