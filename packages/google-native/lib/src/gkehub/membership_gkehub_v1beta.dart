...
import 'membership_gkehub_v1beta_args.dart';
...
class MembershipGkehubV1beta extends pulumi.CustomResource {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  late final pulumi.Output<AuthorityResponseGkehubV1beta> authority;
  ...
  late final pulumi.Output<MembershipEndpointResponseGkehubV1beta> endpoint;
  ...
  late final pulumi.Output<MonitoringConfigResponseGkehubV1beta> monitoringConfig;
  ...
  late final pulumi.Output<MembershipStateResponseGkehubV1beta> state;
  ...
  /// Creates a new [MembershipGkehubV1beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MembershipGkehubV1beta]. {@macro pulumi_gkehub_v1beta_membership_gkehub_v1beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MembershipGkehubV1beta(
    String name, {
    MembershipGkehubV1betaArgs? args,
    ...
    this.authority = registerOutput<AuthorityResponseGkehubV1beta>('authority');
    this.createTime = registerOutput<String>('createTime');
    this.deleteTime = registerOutput<String>('deleteTime');
    this.description = registerOutput<String>('description');
    this.endpoint = registerOutput<MembershipEndpointResponseGkehubV1beta>('endpoint');
    ...
    this.monitoringConfig = registerOutput<MonitoringConfigResponseGkehubV1beta>('monitoringConfig');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.state = registerOutput<MembershipStateResponseGkehubV1beta>('state');
