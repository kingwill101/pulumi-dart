...
class MembershipGkehubV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<MonitoringConfigResponseGkehubV1beta>
  monitoringConfig;
  ...
  MembershipGkehubV1beta(
    ...
    this.endpoint = registerOutput<MembershipEndpointResponseGkehubV1beta>(
      'endpoint',
    );
    ...
    this.monitoringConfig =
        registerOutput<MonitoringConfigResponseGkehubV1beta>(
          'monitoringConfig',
        );
