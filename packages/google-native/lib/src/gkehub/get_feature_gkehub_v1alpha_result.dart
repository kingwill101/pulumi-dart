...
class GetFeatureGkehubV1alphaResult {
  ...
  final CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha
  ...
  factory GetFeatureGkehubV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetFeatureGkehubV1alphaResult(
      ...
      fleetDefaultMemberConfig:
          CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha.fromMap(
      ...
      resourceState: FeatureResourceStateResponseGkehubV1alpha.fromMap(
      ...
      spec: CommonFeatureSpecResponseGkehubV1alpha.fromMap(
        (map['spec'] as Map).cast<String, dynamic>(),
      ),
      state: CommonFeatureStateResponseGkehubV1alpha.fromMap(
