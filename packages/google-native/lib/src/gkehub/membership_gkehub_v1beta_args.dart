...
class MembershipGkehubV1betaArgs {
  ...
  MembershipGkehubV1betaArgs({
    ...
    String? requestId,
            ...
            pulumi.Input.asOptionalInput<AuthorityGkehubV1beta>(authority),
        endpoint = pulumi.Input.asOptionalInput<MembershipEndpointGkehubV1beta>(
            endpoint),
        ...
        monitoringConfig =
            pulumi.Input.asOptionalInput<MonitoringConfigGkehubV1beta>(
                monitoringConfig),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (monitoringConfigValue != null) {
      map['monitoringConfig'] = pulumi.Input.mapOptionalInputValue<
              MonitoringConfigGkehubV1beta, Map<String, dynamic>>(
  ...
  factory MembershipGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1betaArgs(
      authority: map['authority'] == null
          ? null
          : AuthorityGkehubV1beta.fromMap(
              (map['authority'] as Map).cast<String, dynamic>()),
      endpoint: map['endpoint'] == null
          ? null
          : MembershipEndpointGkehubV1beta.fromMap(
      ...
      monitoringConfig: map['monitoringConfig'] == null
          ? null
          : MonitoringConfigGkehubV1beta.fromMap(
