...
class MembershipGkehubV1betaArgs {
  ...
  MembershipGkehubV1betaArgs({
    AuthorityGkehubV1beta? authority,
    MembershipEndpointGkehubV1beta? endpoint,
    String? externalId,
    Map<String, String>? labels,
    String? location,
    required String membershipId,
    MonitoringConfigGkehubV1beta? monitoringConfig,
    String? project,
    String? requestId,
  }) :
      authority = pulumi.Input.asOptionalInput<AuthorityGkehubV1beta>(authority),
      endpoint = pulumi.Input.asOptionalInput<MembershipEndpointGkehubV1beta>(endpoint),
      ...
      monitoringConfig = pulumi.Input.asOptionalInput<MonitoringConfigGkehubV1beta>(monitoringConfig),
  ...
  factory MembershipGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1betaArgs(
      authority: map['authority'] == null ? null : AuthorityGkehubV1beta.fromMap((map['authority'] as Map).cast<String, dynamic>()),
      endpoint: map['endpoint'] == null ? null : MembershipEndpointGkehubV1beta.fromMap((map['endpoint'] as Map).cast<String, dynamic>()),
      externalId: map['externalId'] == null ? null : map['externalId'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      membershipId: map['membershipId'] as String,
      monitoringConfig: map['monitoringConfig'] == null ? null : MonitoringConfigGkehubV1beta.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
