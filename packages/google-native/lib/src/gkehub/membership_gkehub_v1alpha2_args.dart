...
class MembershipGkehubV1alpha2Args {
  ...
  factory MembershipGkehubV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1alpha2Args(
      authority: map['authority'] == null ? null : AuthorityGkehubV1alpha2.fromMap((map['authority'] as Map).cast<String, dynamic>()),
      endpoint: map['endpoint'] == null ? null : MembershipEndpointGkehubV1alpha2.fromMap((map['endpoint'] as Map).cast<String, dynamic>()),
      externalId: map['externalId'] == null ? null : map['externalId'] as String,
      infrastructureType: map['infrastructureType'] == null ? null : MembershipInfrastructureType.fromValue(map['infrastructureType'] as String),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      membershipId: map['membershipId'] as String,
      monitoringConfig: map['monitoringConfig'] == null ? null : MonitoringConfigGkehubV1alpha2.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>()),
