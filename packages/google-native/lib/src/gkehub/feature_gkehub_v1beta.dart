...
class FeatureGkehubV1beta extends pulumi.CustomResource {
  ...
  FeatureGkehubV1beta(
    ...
    this.fleetDefaultMemberConfig = registerOutput<CommonFleetDefaultMemberConfigSpecResponseGkehubV1beta>('fleetDefaultMemberConfig');
    ...
    this.resourceState = registerOutput<FeatureResourceStateResponseGkehubV1beta>('resourceState');
    ...
    this.state = registerOutput<CommonFeatureStateResponseGkehubV1beta>('state');
