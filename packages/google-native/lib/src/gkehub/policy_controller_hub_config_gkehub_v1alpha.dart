...
class PolicyControllerHubConfigGkehubV1alpha {
  ...
  factory PolicyControllerHubConfigGkehubV1alpha.fromMap(
    ...
    return PolicyControllerHubConfigGkehubV1alpha(
      ...
      installSpec: map['installSpec'] == null
          ? null
          : PolicyControllerHubConfigInstallSpecGkehubV1alpha.fromValue(
      ...
      monitoring: map['monitoring'] == null
          ? null
          : PolicyControllerMonitoringConfigGkehubV1alpha.fromMap(
      ...
      policyContent: map['policyContent'] == null
          ? null
          : PolicyControllerPolicyContentSpecGkehubV1alpha.fromMap(
