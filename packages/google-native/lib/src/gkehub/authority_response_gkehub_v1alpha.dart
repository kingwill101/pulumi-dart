...
class AuthorityResponseGkehubV1alpha {
  ...
  /// Creates a new [AuthorityResponseGkehubV1alpha].
  ...
  AuthorityResponseGkehubV1alpha({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['issuer'] = issuer;
    map['oidcJwks'] = oidcJwks;
    map['workloadIdentityPool'] = workloadIdentityPool;
    return map;
  }

  factory AuthorityResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return AuthorityResponseGkehubV1alpha(
