...
import 'config_management_git_config_response_gkehub_v1alpha.dart';
import 'config_management_oci_config_response_gkehub_v1alpha.dart';

/// Configuration for Config Sync
class ConfigManagementConfigSyncResponseGkehubV1alpha {
  ...
  final ConfigManagementGitConfigResponseGkehubV1alpha git;
  ...
  final ConfigManagementOciConfigResponseGkehubV1alpha oci;
  /// Set to true to enable the Config Sync admission webhook to prevent drifts. If set to `false`, disables the Config Sync admission webhook and does not prevent drifts.
  final bool preventDrift;
  /// Specifies whether the Config Sync Repo is in "hierarchical" or "unstructured" mode.
  final String sourceFormat;

  /// Creates a new [ConfigManagementConfigSyncResponseGkehubV1alpha].
  ...
  factory ConfigManagementConfigSyncResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSyncResponseGkehubV1alpha(
      allowVerticalScale: map['allowVerticalScale'] as bool,
      enabled: map['enabled'] as bool,
      git: ConfigManagementGitConfigResponseGkehubV1alpha.fromMap((map['git'] as Map).cast<String, dynamic>()),
      metricsGcpServiceAccountEmail: map['metricsGcpServiceAccountEmail'] as String,
      oci: ConfigManagementOciConfigResponseGkehubV1alpha.fromMap((map['oci'] as Map).cast<String, dynamic>()),
