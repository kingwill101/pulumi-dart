...
class FeatureIamPolicyGkehubV1betaArgs {
  ...
  FeatureIamPolicyGkehubV1betaArgs({
    ...
    List<BindingGkehubV1betaResource>? bindings,
    String? etag,
  ...
  factory FeatureIamPolicyGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureIamPolicyGkehubV1betaArgs(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Input.decodeList<AuditConfigGkehubV1beta>(map['auditConfigs'], (value) => AuditConfigGkehubV1beta.fromMap((value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null ? null : (map['bindings'] as List).cast<BindingGkehubV1betaResource>(),
