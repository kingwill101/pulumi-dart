...
class FeatureIamPolicyGkehubV1betaArgs {
  ...
  FeatureIamPolicyGkehubV1betaArgs({
    ...
    int? version,
           ...
           .Input.asOptionalInput<List<AuditConfigGkehubV1beta>>(auditConfigs),
       bindings = pulumi
           .Input.asOptionalInput<List<BindingGkehubV1betaResource>>(bindings),
  ...
  factory FeatureIamPolicyGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureIamPolicyGkehubV1betaArgs(
      ...
      bindings: map['bindings'] == null
          ? null
          : (map['bindings'] as List).cast<BindingGkehubV1betaResource>(),
