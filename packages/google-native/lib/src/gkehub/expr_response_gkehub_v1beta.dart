...
class ExprResponseGkehubV1beta {
  ...
  /// Creates a new [ExprResponseGkehubV1beta].
  ...
  factory ExprResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ExprResponseGkehubV1beta(
