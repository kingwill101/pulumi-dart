...
class MembershipIamPolicyGkehubV1beta1Args {
  ...
  MembershipIamPolicyGkehubV1beta1Args({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<AuditConfigGkehubV1beta1>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<BindingGkehubV1beta1>>(bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<AuditConfigGkehubV1beta1>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<AuditConfigGkehubV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<BindingGkehubV1beta1>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<BindingGkehubV1beta1,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory MembershipIamPolicyGkehubV1beta1Args.fromMap(
      Map<String, dynamic> map) {
    return MembershipIamPolicyGkehubV1beta1Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<AuditConfigGkehubV1beta1>(
              map['auditConfigs'],
              (value) => AuditConfigGkehubV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<BindingGkehubV1beta1>(
              map['bindings'],
              (value) => BindingGkehubV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>())),
