...
class FeatureGkehubV1alphaArgs {
  ...
  FeatureGkehubV1alphaArgs({
    String? featureId,
    CommonFleetDefaultMemberConfigSpecGkehubV1alpha? fleetDefaultMemberConfig,
    ...
    CommonFeatureSpecGkehubV1alpha? spec,
  }) :
  ...
  factory FeatureGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGkehubV1alphaArgs(
      ...
      fleetDefaultMemberConfig: map['fleetDefaultMemberConfig'] == null ? null : CommonFleetDefaultMemberConfigSpecGkehubV1alpha.fromMap((map['fleetDefaultMemberConfig'] as Map).cast<String, dynamic>()),
      ...
      spec: map['spec'] == null ? null : CommonFeatureSpecGkehubV1alpha.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
