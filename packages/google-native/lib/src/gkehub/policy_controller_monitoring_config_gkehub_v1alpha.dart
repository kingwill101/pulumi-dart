...
class PolicyControllerMonitoringConfigGkehubV1alpha {
  ...
  final List<PolicyControllerMonitoringConfigBackendsItemGkehubV1alpha>?
  backends;
  ...
  PolicyControllerMonitoringConfigGkehubV1alpha({this.backends});
    ...
    return <String, dynamic>{
      'backends': ?backends == null
          ...
          : pulumi.Input.encodeList<
              PolicyControllerMonitoringConfigBackendsItemGkehubV1alpha,
              String
            >(backends!, (value) => value.value),
    };
  }

  factory PolicyControllerMonitoringConfigGkehubV1alpha.fromMap(
      ...
      backends: map['backends'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['backends'],
              (value) =>
                  PolicyControllerMonitoringConfigBackendsItemGkehubV1alpha.fromValue(
                    value as String,
                  ),
            ),
    );
