...
class ClusterUpgradeFleetSpecGkehubV1alpha {
  ...
  final List<ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha>? gkeUpgradeOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gkeUpgradeOverrides': ?gkeUpgradeOverrides == null ? null : pulumi.Input.encodeList<ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha, Map<String, dynamic>>(gkeUpgradeOverrides!, (value) => value.toMap()),
  ...
  factory ClusterUpgradeFleetSpecGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpecGkehubV1alpha(
      gkeUpgradeOverrides: map['gkeUpgradeOverrides'] == null ? null : pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha>(map['gkeUpgradeOverrides'], (value) => ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha.fromMap((value as Map).cast<String, dynamic>())),
