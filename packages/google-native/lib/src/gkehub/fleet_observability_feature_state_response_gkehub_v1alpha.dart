...
class FleetObservabilityFeatureStateResponseGkehubV1alpha {
  ...
  factory FleetObservabilityFeatureStateResponseGkehubV1alpha.fromMap(
    ...
    return FleetObservabilityFeatureStateResponseGkehubV1alpha(
      logging:
          FleetObservabilityFleetObservabilityLoggingStateResponseGkehubV1alpha.fromMap(
            (map['logging'] as Map).cast<String, dynamic>(),
          ),
      monitoring:
          FleetObservabilityFleetObservabilityMonitoringStateResponseGkehubV1alpha.fromMap(
