...
class GetMembershipRbacRoleBindingGkehubV1betaResult {
  ...
  /// Creates a new [GetMembershipRbacRoleBindingGkehubV1betaResult].
  ...
  factory GetMembershipRbacRoleBindingGkehubV1betaResult.fromMap(
      Map<String, dynamic> map) {
    return GetMembershipRbacRoleBindingGkehubV1betaResult(
