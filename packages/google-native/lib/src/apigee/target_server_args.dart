...
class TargetServerArgs {
  ...
  factory TargetServerArgs.fromMap(Map<String, dynamic> map) {
    return TargetServerArgs(
      ...
      protocol: map['protocol'] == null ? null : TargetServerProtocol.fromValue(map['protocol'] as String),
      sSLInfo: map['sSLInfo'] == null ? null : GoogleCloudApigeeV1TlsInfo.fromMap((map['sSLInfo'] as Map).cast<String, dynamic>()),
    );
  }
}
