...
class ReportArgs {
  ...
  factory ReportArgs.fromMap(Map<String, dynamic> map) {
    return ReportArgs(
      ...
      metrics: pulumi.Input.decodeList<GoogleCloudApigeeV1CustomReportMetric>(map['metrics'], (value) => GoogleCloudApigeeV1CustomReportMetric.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      offset: map['offset'] == null ? null : map['offset'] as String,
      organizationId: map['organizationId'] as String,
      properties: map['properties'] == null ? null : pulumi.Input.decodeList<GoogleCloudApigeeV1ReportProperty>(map['properties'], (value) => GoogleCloudApigeeV1ReportProperty.fromMap((value as Map).cast<String, dynamic>())),
      sortByCols: map['sortByCols'] == null ? null : (map['sortByCols'] as List).cast<String>(),
