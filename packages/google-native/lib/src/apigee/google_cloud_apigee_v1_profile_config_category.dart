...
class GoogleCloudApigeeV1ProfileConfigCategory {
  ...
  factory GoogleCloudApigeeV1ProfileConfigCategory.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1ProfileConfigCategory(
      abuse: map['abuse'] == null ? null : (map['abuse'] as Map).cast<String, dynamic>(),
      authorization: map['authorization'] == null ? null : (map['authorization'] as Map).cast<String, dynamic>(),
      cors: map['cors'] == null ? null : (map['cors'] as Map).cast<String, dynamic>(),
      mediation: map['mediation'] == null ? null : (map['mediation'] as Map).cast<String, dynamic>(),
      mtls: map['mtls'] == null ? null : (map['mtls'] as Map).cast<String, dynamic>(),
      threat: map['threat'] == null ? null : (map['threat'] as Map).cast<String, dynamic>(),
    );
  }
}
