...
class AliasArgs {
  ...
  factory AliasArgs.fromMap(Map<String, dynamic> map) {
    return AliasArgs(
      ...
      ignoreExpiryValidation: map['ignoreExpiryValidation'] == null ? null : map['ignoreExpiryValidation'] as bool,
      ignoreNewlineValidation: map['ignoreNewlineValidation'] == null ? null : map['ignoreNewlineValidation'] as bool,
