...
class OrganizationEnvironmentIamPolicyArgs {
  ...
  OrganizationEnvironmentIamPolicyArgs({
    ...
    int? version,
            ...
            pulumi.Input.asOptionalInput<List<GoogleIamV1AuditConfig>>(
                auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<GoogleIamV1Binding>>(bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<GoogleIamV1AuditConfig>, List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<GoogleIamV1AuditConfig,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<GoogleIamV1Binding>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) =>
              pulumi.Input.encodeList<GoogleIamV1Binding, Map<String, dynamic>>(
  ...
  factory OrganizationEnvironmentIamPolicyArgs.fromMap(
