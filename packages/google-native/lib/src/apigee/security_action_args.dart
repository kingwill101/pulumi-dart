...
class SecurityActionArgs {
  ...
  SecurityActionArgs({
    ...
    required GoogleCloudApigeeV1SecurityActionConditionConfig conditionConfig,
    ...
    required SecurityActionState state,
    String? ttl,
       ...
       conditionConfig =
           ...
           >(conditionConfig),
       deny = pulumi
           .Input.asOptionalInput<GoogleCloudApigeeV1SecurityActionDeny>(deny),
       description = pulumi.Input.asOptionalInput<String>(description),
       environmentId = pulumi.Input.asInput<String>(environmentId),
       expireTime = pulumi.Input.asOptionalInput<String>(expireTime),
       flag = pulumi
           .Input.asOptionalInput<GoogleCloudApigeeV1SecurityActionFlag>(flag),
    ...
    return <String, dynamic>{
      ...
      'conditionConfig':
          pulumi.Input.mapInputValue<
            GoogleCloudApigeeV1SecurityActionConditionConfig,
            Map<String, dynamic>
          >(conditionConfig, (value) => value.toMap()),
      'deny':
      ...
      'flag':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(flag, (value) => value.toMap()),
      'name': ?name,
      'organizationId': organizationId,
      'securityActionId': securityActionId,
      'state': pulumi.Input.mapInputValue<SecurityActionState, String>(
        state,
        (value) => value.value,
      ),
      'ttl': ?ttl,
  ...
  factory SecurityActionArgs.fromMap(Map<String, dynamic> map) {
    return SecurityActionArgs(
      ...
      conditionConfig: GoogleCloudApigeeV1SecurityActionConditionConfig.fromMap(
        (map['conditionConfig'] as Map).cast<String, dynamic>(),
      ),
      deny: map['deny'] == null
          ? null
          : GoogleCloudApigeeV1SecurityActionDeny.fromMap(
      ...
      flag: map['flag'] == null
          ? null
          : GoogleCloudApigeeV1SecurityActionFlag.fromMap(
              (map['flag'] as Map).cast<String, dynamic>(),
            ),
      name: map['name'] == null ? null : map['name'] as String,
      organizationId: map['organizationId'] as String,
      securityActionId: map['securityActionId'] as String,
      state: SecurityActionState.fromValue(map['state'] as String),
