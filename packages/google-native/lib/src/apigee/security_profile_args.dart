...
class SecurityProfileArgs {
  ...
  factory SecurityProfileArgs.fromMap(Map<String, dynamic> map) {
    return SecurityProfileArgs(
      ...
      environments: map['environments'] == null ? null : (map['environments'] as List).cast<Map<String, dynamic>>(),
      name: map['name'] == null ? null : map['name'] as String,
      organizationId: map['organizationId'] as String,
      profileConfig: GoogleCloudApigeeV1ProfileConfig.fromMap((map['profileConfig'] as Map).cast<String, dynamic>()),
      scoringConfigs: map['scoringConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudApigeeV1SecurityProfileScoringConfig>(map['scoringConfigs'], (value) => GoogleCloudApigeeV1SecurityProfileScoringConfig.fromMap((value as Map).cast<String, dynamic>())),
