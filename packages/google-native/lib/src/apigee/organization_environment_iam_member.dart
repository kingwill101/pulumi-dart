...
class OrganizationEnvironmentIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationEnvironmentIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationEnvironmentIamMember]. {@macro pulumi_apigee_v1_organization_environment_iam_member_args_doc}
