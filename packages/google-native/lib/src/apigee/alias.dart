...
class Alias extends pulumi.CustomResource {
  ...
  Alias(String name, {AliasArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.certsInfo = registerOutput<GoogleCloudApigeeV1CertificateResponse>(
      'certsInfo',
    );
    this.environmentId = registerOutput<String>('environmentId');
    this.format = registerOutput<String>('format');
    this.ignoreExpiryValidation = registerOutput<bool?>(
      'ignoreExpiryValidation',
    );
    this.ignoreNewlineValidation = registerOutput<bool?>(
