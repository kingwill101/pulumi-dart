...
class QueryArgs {
  ...
  QueryArgs({
    ...
    required dynamic timeRange,
        ...
        envgroupHostname =
            pulumi.Input.asOptionalInput<String>(envgroupHostname),
        ...
        reportDefinitionId =
            pulumi.Input.asOptionalInput<String>(reportDefinitionId),
  ...
  factory QueryArgs.fromMap(Map<String, dynamic> map) {
    return QueryArgs(
      ...
      metrics: map['metrics'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudApigeeV1QueryMetric>(
              map['metrics'],
              (value) => GoogleCloudApigeeV1QueryMetric.fromMap(
