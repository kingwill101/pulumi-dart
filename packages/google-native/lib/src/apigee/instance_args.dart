...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    InstancePeeringCidrRange? peeringCidrRange,
  }) : consumerAcceptList = pulumi.Input.asOptionalInput<List<String>>(
         consumerAcceptList,
       ),
       ...
       peeringCidrRange = pulumi
           .Input.asOptionalInput<InstancePeeringCidrRange>(peeringCidrRange);
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      consumerAcceptList: map['consumerAcceptList'] == null
          ? null
          : (map['consumerAcceptList'] as List).cast<String>(),
      ...
      peeringCidrRange: map['peeringCidrRange'] == null
          ? null
          : InstancePeeringCidrRange.fromValue(
