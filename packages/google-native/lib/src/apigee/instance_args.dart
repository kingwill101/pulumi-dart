...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      consumerAcceptList: map['consumerAcceptList'] == null ? null : (map['consumerAcceptList'] as List).cast<String>(),
      ...
      peeringCidrRange: map['peeringCidrRange'] == null ? null : InstancePeeringCidrRange.fromValue(map['peeringCidrRange'] as String),
    );
  }
}
