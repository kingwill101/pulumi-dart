...
class GoogleCloudApigeeV1OperationConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': pulumi.Input.encodeList<GoogleCloudApigeeV1OperationResponse, Map<String, dynamic>>(operations, (value) => value.toMap()),
      'quota': quota.toMap(),
    };
  }
  ...
  factory GoogleCloudApigeeV1OperationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1OperationConfigResponse(
      ...
      operations: pulumi.Input.decodeList<GoogleCloudApigeeV1OperationResponse>(map['operations'], (value) => GoogleCloudApigeeV1OperationResponse.fromMap((value as Map).cast<String, dynamic>())),
