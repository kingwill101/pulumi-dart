...
class HostSecurityReport extends pulumi.CustomResource {
  ...
  /// Creates a new [HostSecurityReport].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HostSecurityReport]. {@macro pulumi_apigee_v1_host_security_report_args_doc}
