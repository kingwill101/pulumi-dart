...
class RatePlanArgs {
  ...
  factory RatePlanArgs.fromMap(Map<String, dynamic> map) {
    return RatePlanArgs(
      ...
      billingPeriod: map['billingPeriod'] == null ? null : RatePlanBillingPeriod.fromValue(map['billingPeriod'] as String),
      consumptionPricingRates: map['consumptionPricingRates'] == null ? null : pulumi.Input.decodeList<GoogleCloudApigeeV1RateRange>(map['consumptionPricingRates'], (value) => GoogleCloudApigeeV1RateRange.fromMap((value as Map).cast<String, dynamic>())),
      consumptionPricingType: map['consumptionPricingType'] == null ? null : RatePlanConsumptionPricingType.fromValue(map['consumptionPricingType'] as String),
      currencyCode: map['currencyCode'] == null ? null : map['currencyCode'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      endTime: map['endTime'] == null ? null : map['endTime'] as String,
      fixedFeeFrequency: map['fixedFeeFrequency'] == null ? null : map['fixedFeeFrequency'] as int,
      fixedRecurringFee: map['fixedRecurringFee'] == null ? null : GoogleTypeMoney.fromMap((map['fixedRecurringFee'] as Map).cast<String, dynamic>()),
      organizationId: map['organizationId'] as String,
      paymentFundingModel: map['paymentFundingModel'] == null ? null : RatePlanPaymentFundingModel.fromValue(map['paymentFundingModel'] as String),
      revenueShareRates: map['revenueShareRates'] == null ? null : pulumi.Input.decodeList<GoogleCloudApigeeV1RevenueShareRange>(map['revenueShareRates'], (value) => GoogleCloudApigeeV1RevenueShareRange.fromMap((value as Map).cast<String, dynamic>())),
      revenueShareType: map['revenueShareType'] == null ? null : RatePlanRevenueShareType.fromValue(map['revenueShareType'] as String),
      setupFee: map['setupFee'] == null ? null : GoogleTypeMoney.fromMap((map['setupFee'] as Map).cast<String, dynamic>()),
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      state: map['state'] == null ? null : RatePlanState.fromValue(map['state'] as String),
    );
  }
}
