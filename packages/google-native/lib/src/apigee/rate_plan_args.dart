  ...
  RatePlanArgs({
    ...
    RatePlanState? state,
       ...
       revenueShareRates =
           ...
           >(revenueShareRates),
       revenueShareType = pulumi
           .Input.asOptionalInput<RatePlanRevenueShareType>(revenueShareType),
    ...
    return <String, dynamic>{
      ...
      'consumptionPricingType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(consumptionPricingType, (value) => value.value),
      ...
      'paymentFundingModel':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(paymentFundingModel, (value) => value.value),
      'revenueShareRates':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudApigeeV1RevenueShareRange>,
            List<Map<String, dynamic>>
