...
class GetSecurityProfileResult {
  ...
  final List<GoogleCloudApigeeV1SecurityProfileEnvironmentResponse> environments;
  ...
  final List<GoogleCloudApigeeV1SecurityProfileScoringConfigResponse> scoringConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'environments': pulumi.Input.encodeList<GoogleCloudApigeeV1SecurityProfileEnvironmentResponse, Map<String, dynamic>>(environments, (value) => value.toMap()),
      'maxScore': maxScore,
      'minScore': minScore,
      'name': name,
      ...
      'scoringConfigs': pulumi.Input.encodeList<GoogleCloudApigeeV1SecurityProfileScoringConfigResponse, Map<String, dynamic>>(scoringConfigs, (value) => value.toMap()),
    };
  }
  ...
  factory GetSecurityProfileResult.fromMap(Map<String, dynamic> map) {
    return GetSecurityProfileResult(
      ...
      environments: pulumi.Input.decodeList<GoogleCloudApigeeV1SecurityProfileEnvironmentResponse>(map['environments'], (value) => GoogleCloudApigeeV1SecurityProfileEnvironmentResponse.fromMap((value as Map).cast<String, dynamic>())),
      maxScore: map['maxScore'] as int,
      minScore: map['minScore'] as int,
      name: map['name'] as String,
      profileConfig: GoogleCloudApigeeV1ProfileConfigResponse.fromMap((map['profileConfig'] as Map).cast<String, dynamic>()),
      ...
      scoringConfigs: pulumi.Input.decodeList<GoogleCloudApigeeV1SecurityProfileScoringConfigResponse>(map['scoringConfigs'], (value) => GoogleCloudApigeeV1SecurityProfileScoringConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
