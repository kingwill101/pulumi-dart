...
class OrganizationArgs {
  ...
  OrganizationArgs({
    ...
    OrganizationType? type,
        ...
        apiConsumerDataLocation =
            pulumi.Input.asOptionalInput<String>(apiConsumerDataLocation),
        attributes = pulumi.Input.asOptionalInput<List<String>>(attributes),
        authorizedNetwork =
            pulumi.Input.asOptionalInput<String>(authorizedNetwork),
        billingType =
            pulumi.Input.asOptionalInput<OrganizationBillingType>(billingType),
        controlPlaneEncryptionKeyName =
            pulumi.Input.asOptionalInput<String>(controlPlaneEncryptionKeyName),
        customerName = pulumi.Input.asOptionalInput<String>(customerName),
        description = pulumi.Input.asOptionalInput<String>(description),
        disableVpcPeering =
            pulumi.Input.asOptionalInput<bool>(disableVpcPeering),
        ...
        runtimeType_ =
            pulumi.Input.asInput<OrganizationRuntimeType>(runtimeType_),
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      ...
      portalDisabled:
          map['portalDisabled'] == null ? null : map['portalDisabled'] as bool,
