...
/// {@template pulumi_apigee_v1_organization_environment_iam_member_args_doc}
/// The set of arguments for OrganizationEnvironmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigee_v1_organization_environment_iam_member_args_doc}
class OrganizationEnvironmentIamMemberArgs {
  ...
  /// Creates a new [OrganizationEnvironmentIamMemberArgs].
  ...
  OrganizationEnvironmentIamMemberArgs({
    Condition? condition,
  ...
  factory OrganizationEnvironmentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationEnvironmentIamMemberArgs(
