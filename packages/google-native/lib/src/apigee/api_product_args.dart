...
class ApiProductArgs {
  ...
  ApiProductArgs({
    ...
    List<String>? proxies,
    String? quota,
    ApiProductQuotaCounterScope? quotaCounterScope,
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      apiResources: map['apiResources'] == null ? null : (map['apiResources'] as List).cast<String>(),
      approvalType: map['approvalType'] == null ? null : map['approvalType'] as String,
      ...
      graphqlOperationGroup: map['graphqlOperationGroup'] == null ? null : GoogleCloudApigeeV1GraphQLOperationGroup.fromMap((map['graphqlOperationGroup'] as Map).cast<String, dynamic>()),
      grpcOperationGroup: map['grpcOperationGroup'] == null ? null : GoogleCloudApigeeV1GrpcOperationGroup.fromMap((map['grpcOperationGroup'] as Map).cast<String, dynamic>()),
      lastModifiedAt: map['lastModifiedAt'] == null ? null : map['lastModifiedAt'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      operationGroup: map['operationGroup'] == null ? null : GoogleCloudApigeeV1OperationGroup.fromMap((map['operationGroup'] as Map).cast<String, dynamic>()),
      organizationId: map['organizationId'] as String,
      proxies: map['proxies'] == null ? null : (map['proxies'] as List).cast<String>(),
      quota: map['quota'] == null ? null : map['quota'] as String,
      quotaCounterScope: map['quotaCounterScope'] == null ? null : ApiProductQuotaCounterScope.fromValue(map['quotaCounterScope'] as String),
      quotaInterval: map['quotaInterval'] == null ? null : map['quotaInterval'] as String,
      quotaTimeUnit: map['quotaTimeUnit'] == null ? null : map['quotaTimeUnit'] as String,
