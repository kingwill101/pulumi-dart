...
class ApiProductArgs {
    ...
    return <String, dynamic>{
      ...
      'quotaCounterScope':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(quotaCounterScope, (value) => value.value),
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      ...
      approvalType: map['approvalType'] == null
          ? null
          : map['approvalType'] as String,
      ...
      quotaCounterScope: map['quotaCounterScope'] == null
          ? null
          : ApiProductQuotaCounterScope.fromValue(
              map['quotaCounterScope'] as String,
            ),
      quotaInterval: map['quotaInterval'] == null
          ? null
          : map['quotaInterval'] as String,
      quotaTimeUnit: map['quotaTimeUnit'] == null
          ? null
          : map['quotaTimeUnit'] as String,
