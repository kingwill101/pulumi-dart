...
class EndpointAttachmentArgs {
  ...
  }) : endpointAttachmentId = pulumi.Input.asOptionalInput<String>(
         endpointAttachmentId,
       ),
       location = pulumi.Input.asOptionalInput<String>(location),
       name = pulumi.Input.asOptionalInput<String>(name),
       organizationId = pulumi.Input.asInput<String>(organizationId),
       serviceAttachment = pulumi.Input.asOptionalInput<String>(
         serviceAttachment,
       );
  ...
  factory EndpointAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return EndpointAttachmentArgs(
      endpointAttachmentId: map['endpointAttachmentId'] == null
          ? null
