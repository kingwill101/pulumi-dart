...
class GoogleCloudApigeeV1GraphQLOperationGroupResponse {
  ...
  final List<GoogleCloudApigeeV1GraphQLOperationConfigResponse> operationConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operationConfigs': pulumi.Input.encodeList<GoogleCloudApigeeV1GraphQLOperationConfigResponse, Map<String, dynamic>>(operationConfigs, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudApigeeV1GraphQLOperationGroupResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1GraphQLOperationGroupResponse(
      ...
      operationConfigs: pulumi.Input.decodeList<GoogleCloudApigeeV1GraphQLOperationConfigResponse>(map['operationConfigs'], (value) => GoogleCloudApigeeV1GraphQLOperationConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
