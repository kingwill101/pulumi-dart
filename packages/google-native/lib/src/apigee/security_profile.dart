...
class SecurityProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudApigeeV1SecurityProfileEnvironmentResponse>> environments;
  ...
  late final pulumi.Output<List<GoogleCloudApigeeV1SecurityProfileScoringConfigResponse>> scoringConfigs;
  ...
  SecurityProfile(
    ...
    this.environments = registerOutput<List<GoogleCloudApigeeV1SecurityProfileEnvironmentResponse>>('environments');
    this.maxScore = registerOutput<int>('maxScore');
    this.minScore = registerOutput<int>('minScore');
    this.name = registerOutput<String>('name');
    this.organizationId = registerOutput<String>('organizationId');
    this.profileConfig = registerOutput<GoogleCloudApigeeV1ProfileConfigResponse>('profileConfig');
    ...
    this.scoringConfigs = registerOutput<List<GoogleCloudApigeeV1SecurityProfileScoringConfigResponse>>('scoringConfigs');
