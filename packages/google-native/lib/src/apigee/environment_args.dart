...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    EnvironmentType? type,
            ...
            pulumi.Input.asOptionalInput<EnvironmentApiProxyType>(apiProxyType),
        deploymentType =
            pulumi.Input.asOptionalInput<EnvironmentDeploymentType>(
                deploymentType),
        description = pulumi.Input.asOptionalInput<String>(description),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        forwardProxyUri = pulumi.Input.asOptionalInput<String>(forwardProxyUri),
        hasAttachedFlowHooks =
            pulumi.Input.asOptionalInput<bool>(hasAttachedFlowHooks),
        name = pulumi.Input.asOptionalInput<String>(name),
        nodeConfig =
            pulumi.Input.asOptionalInput<GoogleCloudApigeeV1NodeConfig>(
                nodeConfig),
        organizationId = pulumi.Input.asInput<String>(organizationId),
        properties =
            pulumi.Input.asOptionalInput<GoogleCloudApigeeV1Properties>(
                properties),
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      apiProxyType: map['apiProxyType'] == null
          ? null
          : EnvironmentApiProxyType.fromValue(map['apiProxyType'] as String),
      deploymentType: map['deploymentType'] == null
          ? null
          : EnvironmentDeploymentType.fromValue(
      ...
      hasAttachedFlowHooks: map['hasAttachedFlowHooks'] == null
          ? null
          : map['hasAttachedFlowHooks'] as bool,
      ...
      type: map['type'] == null
          ? null
          : EnvironmentType.fromValue(map['type'] as String),
    );
  }
}
