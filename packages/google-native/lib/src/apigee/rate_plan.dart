...
class RatePlan extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudApigeeV1RateRangeResponse>> consumptionPricingRates;
  ...
  late final pulumi.Output<List<GoogleCloudApigeeV1RevenueShareRangeResponse>> revenueShareRates;
  ...
  RatePlan(
    ...
    this.consumptionPricingRates = registerOutput<List<GoogleCloudApigeeV1RateRangeResponse>>('consumptionPricingRates');
    this.consumptionPricingType = registerOutput<String>('consumptionPricingType');
    ...
    this.fixedRecurringFee = registerOutput<GoogleTypeMoneyResponse>('fixedRecurringFee');
    ...
    this.revenueShareRates = registerOutput<List<GoogleCloudApigeeV1RevenueShareRangeResponse>>('revenueShareRates');
