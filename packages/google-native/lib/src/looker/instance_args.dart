...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      adminSettings: map['adminSettings'] == null ? null : AdminSettings.fromMap((map['adminSettings'] as Map).cast<String, dynamic>()),
      ...
      denyMaintenancePeriod: map['denyMaintenancePeriod'] == null ? null : DenyMaintenancePeriod.fromMap((map['denyMaintenancePeriod'] as Map).cast<String, dynamic>()),
      ...
      maintenanceSchedule: map['maintenanceSchedule'] == null ? null : MaintenanceSchedule.fromMap((map['maintenanceSchedule'] as Map).cast<String, dynamic>()),
      ...
      oauthConfig: map['oauthConfig'] == null ? null : OAuthConfig.fromMap((map['oauthConfig'] as Map).cast<String, dynamic>()),
      platformEdition: map['platformEdition'] == null ? null : InstancePlatformEdition.fromValue(map['platformEdition'] as String),
      privateIpEnabled: map['privateIpEnabled'] == null ? null : map['privateIpEnabled'] as bool,
      project: map['project'] == null ? null : map['project'] as String,
      publicIpEnabled: map['publicIpEnabled'] == null ? null : map['publicIpEnabled'] as bool,
      reservedRange: map['reservedRange'] == null ? null : map['reservedRange'] as String,
      userMetadata: map['userMetadata'] == null ? null : UserMetadata.fromMap((map['userMetadata'] as Map).cast<String, dynamic>()),
    );
  }
}
