...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    UserMetadata? userMetadata,
  }) : adminSettings = pulumi.Input.asOptionalInput<AdminSettings>(
         adminSettings,
       ),
       ...
       denyMaintenancePeriod = pulumi
           .Input.asOptionalInput<DenyMaintenancePeriod>(denyMaintenancePeriod),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      reservedRange: map['reservedRange'] == null
          ? null
          : map['reservedRange'] as String,
