...
/// {@template pulumi_looker_v1_instance_backup_iam_member_args_doc}
/// The set of arguments for InstanceBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_looker_v1_instance_backup_iam_member_args_doc}
class InstanceBackupIamMemberArgs {
  ...
  /// Creates a new [InstanceBackupIamMemberArgs].
  ...
  factory InstanceBackupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InstanceBackupIamMemberArgs(
