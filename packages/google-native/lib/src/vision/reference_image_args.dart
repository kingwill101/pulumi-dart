...
class ReferenceImageArgs {
  ...
  ReferenceImageArgs({
    ...
    required String uri,
            ...
            pulumi.Input.asOptionalInput<List<BoundingPoly>>(boundingPolys),
        location = pulumi.Input.asOptionalInput<String>(location),
        name = pulumi.Input.asOptionalInput<String>(name),
        productId = pulumi.Input.asInput<String>(productId),
        project = pulumi.Input.asOptionalInput<String>(project),
        referenceImageId =
            pulumi.Input.asOptionalInput<String>(referenceImageId),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (boundingPolysValue != null) {
      map['boundingPolys'] = pulumi.Input.mapOptionalInputValue<
              List<BoundingPoly>, List<Map<String, dynamic>>>(
          boundingPolysValue,
          (value) =>
  ...
  factory ReferenceImageArgs.fromMap(Map<String, dynamic> map) {
    return ReferenceImageArgs(
      ...
      referenceImageId: map['referenceImageId'] == null
          ? null
