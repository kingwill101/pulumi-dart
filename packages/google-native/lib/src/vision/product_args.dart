...
class ProductArgs {
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      productCategory: map['productCategory'] == null ? null : map['productCategory'] as String,
      productId: map['productId'] == null ? null : map['productId'] as String,
      productLabels: map['productLabels'] == null ? null : pulumi.Input.decodeList<KeyValue>(map['productLabels'], (value) => KeyValue.fromMap((value as Map).cast<String, dynamic>())),
