...
class Product extends pulumi.CustomResource {
  ...
  Product(
    ...
    this.audience = registerOutput<GoogleCloudRetailV2AudienceResponse>(
      'audience',
    );
    ...
    this.colorInfo = registerOutput<GoogleCloudRetailV2ColorInfoResponse>(
      'colorInfo',
    );
    ...
    this.images = registerOutput<List<GoogleCloudRetailV2ImageResponse>>(
      'images',
    );
    ...
    this.priceInfo = registerOutput<GoogleCloudRetailV2PriceInfoResponse>(
      'priceInfo',
    );
    ...
    this.variants = registerOutput<List<GoogleCloudRetailV2ProductResponse>>(
      'variants',
    );
  }
}
