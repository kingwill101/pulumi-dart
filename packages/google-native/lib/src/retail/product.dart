...
class Product extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2FulfillmentInfoResponse>> fulfillmentInfo;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2LocalInventoryResponse>> localInventories;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2PromotionResponse>> promotions;
  ...
  Product(
    ...
    this.audience = registerOutput<GoogleCloudRetailV2AudienceResponse>('audience');
    ...
    this.colorInfo = registerOutput<GoogleCloudRetailV2ColorInfoResponse>('colorInfo');
    this.conditions = registerOutput<List<String>>('conditions');
    this.description = registerOutput<String>('description');
    this.expireTime = registerOutput<String>('expireTime');
    this.fulfillmentInfo = registerOutput<List<GoogleCloudRetailV2FulfillmentInfoResponse>>('fulfillmentInfo');
    this.gtin = registerOutput<String>('gtin');
    this.images = registerOutput<List<GoogleCloudRetailV2ImageResponse>>('images');
    this.languageCode = registerOutput<String>('languageCode');
    this.localInventories = registerOutput<List<GoogleCloudRetailV2LocalInventoryResponse>>('localInventories');
    this.location = registerOutput<String>('location');
    this.materials = registerOutput<List<String>>('materials');
    this.name = registerOutput<String>('name');
    this.patterns = registerOutput<List<String>>('patterns');
    this.priceInfo = registerOutput<GoogleCloudRetailV2PriceInfoResponse>('priceInfo');
    this.primaryProductId = registerOutput<String>('primaryProductId');
    this.productId = registerOutput<String>('productId');
    this.project = registerOutput<String>('project');
    this.promotions = registerOutput<List<GoogleCloudRetailV2PromotionResponse>>('promotions');
    ...
    this.variants = registerOutput<List<GoogleCloudRetailV2ProductResponse>>('variants');
  }
}
