...
class GoogleCloudRetailV2alphaCondition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeTimeRange': ?activeTimeRange == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2alphaConditionTimeRange, Map<String, dynamic>>(activeTimeRange!, (value) => value.toMap()),
      'pageCategories': ?pageCategories,
      'queryTerms': ?queryTerms == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2alphaConditionQueryTerm, Map<String, dynamic>>(queryTerms!, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRetailV2alphaCondition.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaCondition(
      activeTimeRange: map['activeTimeRange'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2alphaConditionTimeRange>(map['activeTimeRange'], (value) => GoogleCloudRetailV2alphaConditionTimeRange.fromMap((value as Map).cast<String, dynamic>())),
      pageCategories: map['pageCategories'] == null ? null : (map['pageCategories'] as List).cast<String>(),
      queryTerms: map['queryTerms'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2alphaConditionQueryTerm>(map['queryTerms'], (value) => GoogleCloudRetailV2alphaConditionQueryTerm.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
