...
class ProductRetailV2alphaArgs {
  ...
  ProductRetailV2alphaArgs({
    ...
    String? uri,
       ...
       audience = pulumi
           .Input.asOptionalInput<GoogleCloudRetailV2alphaAudience>(audience),
       availability =
       ...
       colorInfo = pulumi
           .Input.asOptionalInput<GoogleCloudRetailV2alphaColorInfo>(colorInfo),
       ...
       images = pulumi
           .Input.asOptionalInput<List<GoogleCloudRetailV2alphaImage>>(images),
       ...
       priceInfo = pulumi
           .Input.asOptionalInput<GoogleCloudRetailV2alphaPriceInfo>(priceInfo),
