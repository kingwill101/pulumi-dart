...
class ProductRetailV2alphaArgs {
  ...
  ProductRetailV2alphaArgs({
    ...
    String? uri,
        ...
        audience =
            pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaAudience>(
                audience),
        availability =
            pulumi.Input.asOptionalInput<ProductAvailabilityRetailV2alpha>(
                availability),
        availableQuantity =
        ...
        colorInfo =
            pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaColorInfo>(
                colorInfo),
        ...
        images =
            pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2alphaImage>>(
                images),
        ...
        priceInfo =
            pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaPriceInfo>(
                priceInfo),
        primaryProductId =
        ...
        rating = pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaRating>(
            rating),
        retrievableFields =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (imagesValue != null) {
      map['images'] = pulumi.Input.mapOptionalInputValue<
          ...
          imagesValue,
          (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaImage,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (promotionsValue != null) {
      map['promotions'] = pulumi.Input.mapOptionalInputValue<
              ...
              List<Map<String, dynamic>>>(
          promotionsValue,
          (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaPromotion,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory ProductRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2alphaArgs(
      ...
      availability: map['availability'] == null
          ? null
          : ProductAvailabilityRetailV2alpha.fromValue(
      ...
      type: map['type'] == null
          ? null
          : ProductTypeRetailV2alpha.fromValue(map['type'] as String),
