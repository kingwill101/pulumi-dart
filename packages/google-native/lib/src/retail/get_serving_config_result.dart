...
class GetServingConfigResult {
  ...
  final GoogleCloudRetailV2SearchRequestDynamicFacetSpecResponse
  dynamicFacetSpec;
  ...
  final GoogleCloudRetailV2SearchRequestPersonalizationSpecResponse
  personalizationSpec;
  ...
  factory GetServingConfigResult.fromMap(Map<String, dynamic> map) {
    return GetServingConfigResult(
      ...
      doNotAssociateControlIds: (map['doNotAssociateControlIds'] as List)
          .cast<String>(),
      dynamicFacetSpec:
          GoogleCloudRetailV2SearchRequestDynamicFacetSpecResponse.fromMap(
      ...
      onewaySynonymsControlIds: (map['onewaySynonymsControlIds'] as List)
          .cast<String>(),
      personalizationSpec:
          GoogleCloudRetailV2SearchRequestPersonalizationSpecResponse.fromMap(
      ...
      replacementControlIds: (map['replacementControlIds'] as List)
          .cast<String>(),
      solutionTypes: (map['solutionTypes'] as List).cast<String>(),
      twowaySynonymsControlIds: (map['twowaySynonymsControlIds'] as List)
          .cast<String>(),
    );
  }
}
