...
import 'model_retail_v2alpha_args.dart';

/// Creates a new model.
class ModelRetailV2alpha extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse>
      modelFeaturesConfig;
  ...
  late final pulumi
      .Output<GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse>
  ...
  late final pulumi
      .Output<List<GoogleCloudRetailV2alphaModelServingConfigListResponse>>
      servingConfigLists;
  ...
  /// Creates a new [ModelRetailV2alpha].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ModelRetailV2alpha]. {@macro pulumi_retail_v2alpha_model_retail_v2alpha_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ModelRetailV2alpha(
    String name, {
    ModelRetailV2alphaArgs? args,
