...
import 'google_cloud_retail_v2beta_search_request_facet_spec_facet_key.dart';
...
class GoogleCloudRetailV2betaSearchRequestFacetSpec {
  ...
  final bool? enableDynamicPosition;
  ...
  final List<String>? excludedFilterKeys;

  /// The facet key specification.
  final GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey facetKey;
  ...
  /// Creates a new [GoogleCloudRetailV2betaSearchRequestFacetSpec].
  ...
  Map<String, dynamic> toMap() {
    ...
    final enableDynamicPositionValue = enableDynamicPosition;
    if (enableDynamicPositionValue != null) {
      map['enableDynamicPosition'] = enableDynamicPositionValue;
    }
    final excludedFilterKeysValue = excludedFilterKeys;
    if (excludedFilterKeysValue != null) {
      map['excludedFilterKeys'] = excludedFilterKeysValue;
    }
    map['facetKey'] = facetKey.toMap();
  ...
  factory GoogleCloudRetailV2betaSearchRequestFacetSpec.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaSearchRequestFacetSpec(
      enableDynamicPosition: map['enableDynamicPosition'] == null
          ? null
          : map['enableDynamicPosition'] as bool,
      excludedFilterKeys: map['excludedFilterKeys'] == null
          ? null
          : (map['excludedFilterKeys'] as List).cast<String>(),
      facetKey: GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.fromMap(
          (map['facetKey'] as Map).cast<String, dynamic>()),
