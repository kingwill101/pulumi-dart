...
class GoogleCloudRetailV2betaConditionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeTimeRange': pulumi.Input.encodeList<GoogleCloudRetailV2betaConditionTimeRangeResponse, Map<String, dynamic>>(activeTimeRange, (value) => value.toMap()),
      'pageCategories': pageCategories,
      'queryTerms': pulumi.Input.encodeList<GoogleCloudRetailV2betaConditionQueryTermResponse, Map<String, dynamic>>(queryTerms, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudRetailV2betaConditionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaConditionResponse(
      activeTimeRange: pulumi.Input.decodeList<GoogleCloudRetailV2betaConditionTimeRangeResponse>(map['activeTimeRange'], (value) => GoogleCloudRetailV2betaConditionTimeRangeResponse.fromMap((value as Map).cast<String, dynamic>())),
      pageCategories: (map['pageCategories'] as List).cast<String>(),
      queryTerms: pulumi.Input.decodeList<GoogleCloudRetailV2betaConditionQueryTermResponse>(map['queryTerms'], (value) => GoogleCloudRetailV2betaConditionQueryTermResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
