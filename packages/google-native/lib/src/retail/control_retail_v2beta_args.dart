...
class ControlRetailV2betaArgs {
  ...
  factory ControlRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ControlRetailV2betaArgs(
      ...
      facetSpec: map['facetSpec'] == null ? null : GoogleCloudRetailV2betaSearchRequestFacetSpec.fromMap((map['facetSpec'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rule: map['rule'] == null ? null : GoogleCloudRetailV2betaRule.fromMap((map['rule'] as Map).cast<String, dynamic>()),
      searchSolutionUseCase: map['searchSolutionUseCase'] == null ? null : pulumi.Input.decodeList<ControlSearchSolutionUseCaseItemRetailV2beta>(map['searchSolutionUseCase'], (value) => ControlSearchSolutionUseCaseItemRetailV2beta.fromValue(value as String)),
      solutionTypes: pulumi.Input.decodeList<ControlSolutionTypesItemRetailV2beta>(map['solutionTypes'], (value) => ControlSolutionTypesItemRetailV2beta.fromValue(value as String)),
    );
  }
}
