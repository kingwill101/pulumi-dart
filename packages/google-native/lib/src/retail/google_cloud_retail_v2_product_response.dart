...
class GoogleCloudRetailV2ProductResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['gtin'] = gtin;
    map['images'] = pulumi.Input.encodeList<GoogleCloudRetailV2ImageResponse,
  ...
  factory GoogleCloudRetailV2ProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ProductResponse(
      ...
      audience: GoogleCloudRetailV2AudienceResponse.fromMap(
      ...
      colorInfo: GoogleCloudRetailV2ColorInfoResponse.fromMap(
      ...
      images: pulumi.Input.decodeList<GoogleCloudRetailV2ImageResponse>(
          map['images'],
      ...
      promotions: pulumi.Input.decodeList<GoogleCloudRetailV2PromotionResponse>(
          map['promotions'],
          (value) => GoogleCloudRetailV2PromotionResponse.fromMap(
              (value as Map).cast<String, dynamic>())),
      publishTime: map['publishTime'] as String,
      rating: GoogleCloudRetailV2RatingResponse.fromMap(
      ...
      variants: pulumi.Input.decodeList<GoogleCloudRetailV2ProductResponse>(
          map['variants'],
