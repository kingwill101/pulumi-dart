...
class ProductArgs {
  ...
  ProductArgs({
    ...
    String? uri,
        ...
        audience =
            pulumi.Input.asOptionalInput<GoogleCloudRetailV2Audience>(audience),
        availability =
            pulumi.Input.asOptionalInput<ProductAvailability>(availability),
        availableQuantity =
        ...
        rating =
            pulumi.Input.asOptionalInput<GoogleCloudRetailV2Rating>(rating),
        retrievableFields =
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      audience: map['audience'] == null
          ? null
          : GoogleCloudRetailV2Audience.fromMap(
              (map['audience'] as Map).cast<String, dynamic>()),
      availability: map['availability'] == null
          ? null
          : ProductAvailability.fromValue(map['availability'] as String),
      ...
      colorInfo: map['colorInfo'] == null
          ? null
          : GoogleCloudRetailV2ColorInfo.fromMap(
      ...
      fulfillmentInfo: map['fulfillmentInfo'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudRetailV2FulfillmentInfo>(
              map['fulfillmentInfo'],
              (value) => GoogleCloudRetailV2FulfillmentInfo.fromMap(
                  (value as Map).cast<String, dynamic>())),
      gtin: map['gtin'] == null ? null : map['gtin'] as String,
      id: map['id'] == null ? null : map['id'] as String,
      images: map['images'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudRetailV2Image>(
              map['images'],
              (value) => GoogleCloudRetailV2Image.fromMap(
                  (value as Map).cast<String, dynamic>())),
      languageCode:
      ...
      priceInfo: map['priceInfo'] == null
          ? null
          : GoogleCloudRetailV2PriceInfo.fromMap(
      ...
      promotions: map['promotions'] == null
          ? null
          : pulumi.Input.decodeList<GoogleCloudRetailV2Promotion>(
              map['promotions'],
              (value) => GoogleCloudRetailV2Promotion.fromMap(
                  (value as Map).cast<String, dynamic>())),
      publishTime:
          map['publishTime'] == null ? null : map['publishTime'] as String,
      rating: map['rating'] == null
          ? null
          : GoogleCloudRetailV2Rating.fromMap(
      ...
      type: map['type'] == null
          ? null
          : ProductType.fromValue(map['type'] as String),
