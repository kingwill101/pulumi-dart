...
class ProductRetailV2beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaFulfillmentInfoResponse>>
  fulfillmentInfo;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaLocalInventoryResponse>>
  localInventories;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaPromotionResponse>>
  promotions;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaProductResponse>>
  variants;
  ...
  ProductRetailV2beta(
    ...
    this.audience = registerOutput<GoogleCloudRetailV2betaAudienceResponse>(
      'audience',
    );
    ...
    this.collectionMemberIds = registerOutput<List<String>>(
      'collectionMemberIds',
    );
    this.colorInfo = registerOutput<GoogleCloudRetailV2betaColorInfoResponse>(
      'colorInfo',
    );
    ...
    this.images = registerOutput<List<GoogleCloudRetailV2betaImageResponse>>(
      'images',
    );
    ...
    this.priceInfo = registerOutput<GoogleCloudRetailV2betaPriceInfoResponse>(
      'priceInfo',
    );
    ...
    this.rating = registerOutput<GoogleCloudRetailV2betaRatingResponse>(
      'rating',
    );
