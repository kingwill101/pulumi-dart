...
class GoogleCloudRetailV2AudienceResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2AudienceResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'ageGroups': ageGroups, 'genders': genders};
  }

  factory GoogleCloudRetailV2AudienceResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudRetailV2AudienceResponse(
      ageGroups: (map['ageGroups'] as List).cast<String>(),
      genders: (map['genders'] as List).cast<String>(),
    );
  }
}
