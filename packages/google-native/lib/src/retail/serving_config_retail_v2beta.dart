...
class ServingConfigRetailV2beta extends pulumi.CustomResource {
  ...
  ServingConfigRetailV2beta(
    ...
    this.doNotAssociateControlIds = registerOutput<List<String>>(
    ...
    this.dynamicFacetSpec =
        registerOutput<
          GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse
        >('dynamicFacetSpec');
    this.enableCategoryFilterLevel = registerOutput<String>(
    ...
    this.onewaySynonymsControlIds = registerOutput<List<String>>(
    ...
    this.redirectControlIds = registerOutput<List<String>>(
      'redirectControlIds',
    );
    this.replacementControlIds = registerOutput<List<String>>(
    ...
    this.twowaySynonymsControlIds = registerOutput<List<String>>(
