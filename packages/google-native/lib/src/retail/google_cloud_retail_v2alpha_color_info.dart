...
class GoogleCloudRetailV2alphaColorInfo {
  ...
  /// Creates a new [GoogleCloudRetailV2alphaColorInfo].
  ...
  Map<String, dynamic> toMap() {
    ...
    final colorFamiliesValue = colorFamilies;
    if (colorFamiliesValue != null) {
      map['colorFamilies'] = colorFamiliesValue;
    }
  ...
  factory GoogleCloudRetailV2alphaColorInfo.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaColorInfo(
      colorFamilies: map['colorFamilies'] == null
          ? null
          : (map['colorFamilies'] as List).cast<String>(),
      colors:
