...
class GoogleCloudRetailV2betaSearchRequestFacetSpecResponse {
  ...
  final GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse facetKey;
  ...
  factory GoogleCloudRetailV2betaSearchRequestFacetSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaSearchRequestFacetSpecResponse(
      ...
      facetKey: GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse.fromMap((map['facetKey'] as Map).cast<String, dynamic>()),
