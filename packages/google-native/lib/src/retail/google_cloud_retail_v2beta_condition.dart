...
class GoogleCloudRetailV2betaCondition {
  ...
  final List<GoogleCloudRetailV2betaConditionTimeRange>? activeTimeRange;
  ...
  final List<GoogleCloudRetailV2betaConditionQueryTerm>? queryTerms;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeTimeRange': ?activeTimeRange == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2betaConditionTimeRange, Map<String, dynamic>>(activeTimeRange!, (value) => value.toMap()),
      'pageCategories': ?pageCategories,
      'queryTerms': ?queryTerms == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2betaConditionQueryTerm, Map<String, dynamic>>(queryTerms!, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRetailV2betaCondition.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaCondition(
      activeTimeRange: map['activeTimeRange'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2betaConditionTimeRange>(map['activeTimeRange'], (value) => GoogleCloudRetailV2betaConditionTimeRange.fromMap((value as Map).cast<String, dynamic>())),
      pageCategories: map['pageCategories'] == null ? null : (map['pageCategories'] as List).cast<String>(),
      queryTerms: map['queryTerms'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2betaConditionQueryTerm>(map['queryTerms'], (value) => GoogleCloudRetailV2betaConditionQueryTerm.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
