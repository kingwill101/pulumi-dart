...
class ModelRetailV2beta extends pulumi.CustomResource {
  ...
  late final pulumi
      .Output<GoogleCloudRetailV2betaModelModelFeaturesConfigResponse>
      modelFeaturesConfig;
  ...
  late final pulumi
      .Output<List<GoogleCloudRetailV2betaModelServingConfigListResponse>>
      servingConfigLists;
  ...
  ModelRetailV2beta(
    ...
    this.servingConfigLists = registerOutput<
            List<GoogleCloudRetailV2betaModelServingConfigListResponse>>(
        'servingConfigLists');
