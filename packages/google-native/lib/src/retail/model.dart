...
class Model extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudRetailV2ModelModelFeaturesConfigResponse> modelFeaturesConfig;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2ModelServingConfigListResponse>> servingConfigLists;
  ...
  /// [args] Arguments used to configure this [Model]. {@macro pulumi_retail_v2_model_args_doc}
  ...
  Model(
    ...
    this.modelFeaturesConfig = registerOutput<GoogleCloudRetailV2ModelModelFeaturesConfigResponse>('modelFeaturesConfig');
    ...
    this.servingConfigLists = registerOutput<List<GoogleCloudRetailV2ModelServingConfigListResponse>>('servingConfigLists');
