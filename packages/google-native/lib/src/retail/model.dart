...
class Model extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudRetailV2ModelModelFeaturesConfigResponse>
  modelFeaturesConfig;
  ...
  late final pulumi.Output<
    List<GoogleCloudRetailV2ModelServingConfigListResponse>
  >
  servingConfigLists;
  ...
  Model(String name, {ModelArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.optimizationObjective = registerOutput<String>(
      'optimizationObjective',
    );
    this.periodicTuningState = registerOutput<String>('periodicTuningState');
    this.project = registerOutput<String>('project');
    this.servingConfigLists =
        registerOutput<List<GoogleCloudRetailV2ModelServingConfigListResponse>>(
          'servingConfigLists',
        );
