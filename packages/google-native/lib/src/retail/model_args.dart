...
class ModelArgs {
  ...
  ModelArgs({
    ...
    required String type,
       ...
       filteringOption = pulumi.Input.asOptionalInput<ModelFilteringOption>(
         filteringOption,
       ),
       ...
       periodicTuningState =
           pulumi.Input.asOptionalInput<ModelPeriodicTuningState>(
             periodicTuningState,
           ),
       project = pulumi.Input.asOptionalInput<String>(project),
       trainingState = pulumi.Input.asOptionalInput<ModelTrainingState>(
         trainingState,
       ),
  ...
  factory ModelArgs.fromMap(Map<String, dynamic> map) {
    return ModelArgs(
      ...
      filteringOption: map['filteringOption'] == null
          ? null
          : ModelFilteringOption.fromValue(map['filteringOption'] as String),
      ...
      periodicTuningState: map['periodicTuningState'] == null
          ? null
          : ModelPeriodicTuningState.fromValue(
              map['periodicTuningState'] as String,
            ),
      project: map['project'] == null ? null : map['project'] as String,
      trainingState: map['trainingState'] == null
          ? null
          : ModelTrainingState.fromValue(map['trainingState'] as String),
