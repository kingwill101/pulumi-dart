...
class ModelRetailV2betaArgs {
  ...
  ModelRetailV2betaArgs({
    ...
    bool? dryRun,
    ModelFilteringOptionRetailV2beta? filteringOption,
    String? location,
    GoogleCloudRetailV2betaModelModelFeaturesConfig? modelFeaturesConfig,
    String? name,
    String? optimizationObjective,
    ModelPeriodicTuningStateRetailV2beta? periodicTuningState,
    String? project,
    ModelTrainingStateRetailV2beta? trainingState,
  ...
  factory ModelRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ModelRetailV2betaArgs(
      ...
      filteringOption: map['filteringOption'] == null ? null : ModelFilteringOptionRetailV2beta.fromValue(map['filteringOption'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      modelFeaturesConfig: map['modelFeaturesConfig'] == null ? null : GoogleCloudRetailV2betaModelModelFeaturesConfig.fromMap((map['modelFeaturesConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      optimizationObjective: map['optimizationObjective'] == null ? null : map['optimizationObjective'] as String,
      periodicTuningState: map['periodicTuningState'] == null ? null : ModelPeriodicTuningStateRetailV2beta.fromValue(map['periodicTuningState'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      trainingState: map['trainingState'] == null ? null : ModelTrainingStateRetailV2beta.fromValue(map['trainingState'] as String),
