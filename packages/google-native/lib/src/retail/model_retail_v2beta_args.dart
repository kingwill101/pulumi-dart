...
class ModelRetailV2betaArgs {
  ...
  ModelRetailV2betaArgs({
    ...
    required String type,
       ...
       optimizationObjective = pulumi.Input.asOptionalInput<String>(
    ...
    return <String, dynamic>{
      ...
      'filteringOption':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(filteringOption, (value) => value.value),
      'location': ?location,
      'modelFeaturesConfig':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudRetailV2betaModelModelFeaturesConfig,
      ...
      'periodicTuningState':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(periodicTuningState, (value) => value.value),
      'project': ?project,
      'trainingState':
          ?pulumi.Input.mapOptionalInputValue<
            ModelTrainingStateRetailV2beta,
            String
          >(trainingState, (value) => value.value),
      'type': type,
    };
  }
  ...
  factory ModelRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ModelRetailV2betaArgs(
      ...
      filteringOption: map['filteringOption'] == null
          ? null
          : ModelFilteringOptionRetailV2beta.fromValue(
              map['filteringOption'] as String,
            ),
      location: map['location'] == null ? null : map['location'] as String,
      modelFeaturesConfig: map['modelFeaturesConfig'] == null
          ? null
          : GoogleCloudRetailV2betaModelModelFeaturesConfig.fromMap(
      ...
      periodicTuningState: map['periodicTuningState'] == null
          ? null
          : ModelPeriodicTuningStateRetailV2beta.fromValue(
              map['periodicTuningState'] as String,
            ),
      project: map['project'] == null ? null : map['project'] as String,
      trainingState: map['trainingState'] == null
          ? null
          : ModelTrainingStateRetailV2beta.fromValue(
