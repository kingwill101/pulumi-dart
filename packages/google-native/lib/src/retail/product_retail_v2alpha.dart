...
class ProductRetailV2alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2alphaLocalInventoryResponse>>
  localInventories;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2alphaPromotionResponse>>
  promotions;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2alphaProductResponse>>
  variants;
  ...
  ProductRetailV2alpha(
    ...
    this.audience = registerOutput<GoogleCloudRetailV2alphaAudienceResponse>(
      'audience',
    );
    ...
    this.colorInfo = registerOutput<GoogleCloudRetailV2alphaColorInfoResponse>(
      'colorInfo',
    );
    ...
    this.images = registerOutput<List<GoogleCloudRetailV2alphaImageResponse>>(
      'images',
    );
    ...
    this.priceInfo = registerOutput<GoogleCloudRetailV2alphaPriceInfoResponse>(
      'priceInfo',
    );
    ...
    this.rating = registerOutput<GoogleCloudRetailV2alphaRatingResponse>(
      'rating',
    );
