...
class GetServingConfigRetailV2betaResult {
  ...
  final GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse dynamicFacetSpec;
  ...
  final GoogleCloudRetailV2betaSearchRequestPersonalizationSpecResponse personalizationSpec;
  ...
  /// Creates a new [GetServingConfigRetailV2betaResult].
  ...
  factory GetServingConfigRetailV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetServingConfigRetailV2betaResult(
      ...
      dynamicFacetSpec: GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse.fromMap((map['dynamicFacetSpec'] as Map).cast<String, dynamic>()),
      ...
      personalizationSpec: GoogleCloudRetailV2betaSearchRequestPersonalizationSpecResponse.fromMap((map['personalizationSpec'] as Map).cast<String, dynamic>()),
