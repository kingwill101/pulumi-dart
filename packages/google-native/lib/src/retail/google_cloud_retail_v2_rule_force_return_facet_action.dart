...
class GoogleCloudRetailV2RuleForceReturnFacetAction {
  ...
  final List<GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment>? facetPositionAdjustments;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'facetPositionAdjustments': ?facetPositionAdjustments == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment, Map<String, dynamic>>(facetPositionAdjustments!, (value) => value.toMap()),
    };
  }
