...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contains': ?contains,
      'intervals': ?intervals == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2alphaInterval, Map<String, dynamic>>(intervals!, (value) => value.toMap()),
      'key': key,
      'orderBy': ?orderBy,
      'prefixes': ?prefixes,
      'query': ?query,
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey(
      ...
      intervals: map['intervals'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2alphaInterval>(map['intervals'], (value) => GoogleCloudRetailV2alphaInterval.fromMap((value as Map).cast<String, dynamic>())),
