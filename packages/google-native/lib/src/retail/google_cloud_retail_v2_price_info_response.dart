...
class GoogleCloudRetailV2PriceInfoResponse {
  ...
  final GoogleCloudRetailV2PriceInfoPriceRangeResponse priceRange;
  ...
  factory GoogleCloudRetailV2PriceInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2PriceInfoResponse(
      ...
      priceRange: GoogleCloudRetailV2PriceInfoPriceRangeResponse.fromMap((map['priceRange'] as Map).cast<String, dynamic>()),
    );
  }
}
