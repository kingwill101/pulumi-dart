...
import 'google_cloud_retail_v2alpha_product_response.dart';
...
class GetProductRetailV2alphaResult {
  ...
  /// Creates a new [GetProductRetailV2alphaResult].
    ...
    return <String, dynamic>{
      ...
      'fulfillmentInfo':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(fulfillmentInfo, (value) => value.toMap()),
      'gtin': gtin,
      'images':
          pulumi.Input.encodeList<
      ...
      'localInventories':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(localInventories, (value) => value.toMap()),
      'materials': materials,
      'name': name,
      'patterns': patterns,
  ...
  factory GetProductRetailV2alphaResult.fromMap(Map<String, dynamic> map) {
    return GetProductRetailV2alphaResult(
      ...
      fulfillmentInfo:
          ...
          >(
            map['fulfillmentInfo'],
            (value) => GoogleCloudRetailV2alphaFulfillmentInfoResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      gtin: map['gtin'] as String,
      images: pulumi.Input.decodeList<GoogleCloudRetailV2alphaImageResponse>(
        map['images'],
      ...
      promotions:
          pulumi.Input.decodeList<GoogleCloudRetailV2alphaPromotionResponse>(
            map['promotions'],
      ...
      variants:
          pulumi.Input.decodeList<GoogleCloudRetailV2alphaProductResponse>(
            map['variants'],
