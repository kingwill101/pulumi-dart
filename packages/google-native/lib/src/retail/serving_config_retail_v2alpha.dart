...
class ServingConfigRetailV2alpha extends pulumi.CustomResource {
  ...
  ServingConfigRetailV2alpha(
    ...
    this.dynamicFacetSpec = registerOutput<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse>('dynamicFacetSpec');
    ...
    this.personalizationSpec = registerOutput<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse>('personalizationSpec');
