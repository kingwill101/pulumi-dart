...
class ServingConfigRetailV2alphaArgs {
  ...
  ServingConfigRetailV2alphaArgs({
    ...
    ServingConfigDiversityTypeRetailV2alpha? diversityType,
    ...
    required List<ServingConfigSolutionTypesItemRetailV2alpha> solutionTypes,
  ...
  factory ServingConfigRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2alphaArgs(
      ...
      diversityType: map['diversityType'] == null ? null : ServingConfigDiversityTypeRetailV2alpha.fromValue(map['diversityType'] as String),
      doNotAssociateControlIds: map['doNotAssociateControlIds'] == null ? null : (map['doNotAssociateControlIds'] as List).cast<String>(),
      dynamicFacetSpec: map['dynamicFacetSpec'] == null ? null : GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec.fromMap((map['dynamicFacetSpec'] as Map).cast<String, dynamic>()),
      ...
      personalizationSpec: map['personalizationSpec'] == null ? null : GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec.fromMap((map['personalizationSpec'] as Map).cast<String, dynamic>()),
      ...
      solutionTypes: pulumi.Input.decodeList<ServingConfigSolutionTypesItemRetailV2alpha>(map['solutionTypes'], (value) => ServingConfigSolutionTypesItemRetailV2alpha.fromValue(value as String)),
