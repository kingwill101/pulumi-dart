...
class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['key'] = key;
    final orderByValue = orderBy;
    if (orderByValue != null) {
      map['orderBy'] = orderByValue;
    }
    ...
    final restrictedValuesValue = restrictedValues;
    if (restrictedValuesValue != null) {
      map['restrictedValues'] = restrictedValuesValue;
    }
    final returnMinMaxValue = returnMinMax;
    if (returnMinMaxValue != null) {
      map['returnMinMax'] = returnMinMaxValue;
    }
    return map;
  }

  factory GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.fromMap(
    ...
    return GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey(
      ...
      restrictedValues: map['restrictedValues'] == null
          ? null
          : (map['restrictedValues'] as List).cast<String>(),
      returnMinMax:
          map['returnMinMax'] == null ? null : map['returnMinMax'] as bool,
    );
  }
}
