...
class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey {
  ...
  final List<GoogleCloudRetailV2betaInterval>? intervals;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contains': ?contains,
      'intervals': ?intervals == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2betaInterval, Map<String, dynamic>>(intervals!, (value) => value.toMap()),
      'key': key,
      'orderBy': ?orderBy,
      'prefixes': ?prefixes,
      'query': ?query,
  ...
  factory GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey(
      ...
      intervals: map['intervals'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2betaInterval>(map['intervals'], (value) => GoogleCloudRetailV2betaInterval.fromMap((value as Map).cast<String, dynamic>())),
      key: map['key'] as String,
      orderBy: map['orderBy'] == null ? null : map['orderBy'] as String,
      prefixes: map['prefixes'] == null ? null : (map['prefixes'] as List).cast<String>(),
      query: map['query'] == null ? null : map['query'] as String,
      restrictedValues: map['restrictedValues'] == null ? null : (map['restrictedValues'] as List).cast<String>(),
      returnMinMax: map['returnMinMax'] == null ? null : map['returnMinMax'] as bool,
    );
  }
}
