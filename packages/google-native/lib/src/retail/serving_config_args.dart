...
class ServingConfigArgs {
  ...
  ServingConfigArgs({
    ...
    ServingConfigDiversityType? diversityType,
    ...
    List<String>? twowaySynonymsControlIds,
        ...
        diversityType =
            pulumi.Input.asOptionalInput<ServingConfigDiversityType>(
                diversityType),
        ...
        solutionTypes =
            pulumi.Input.asInput<List<ServingConfigSolutionTypesItem>>(
                solutionTypes),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['solutionTypes'] = pulumi.Input.mapInputValue<
            List<ServingConfigSolutionTypesItem>, List<String>>(
        solutionTypes,
        (value) =>
