...
class ProductRetailV2betaArgs {
  ...
  factory ProductRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2betaArgs(
      ...
      audience: map['audience'] == null ? null : GoogleCloudRetailV2betaAudience.fromMap((map['audience'] as Map).cast<String, dynamic>()),
      availability: map['availability'] == null ? null : ProductAvailabilityRetailV2beta.fromValue(map['availability'] as String),
      ...
      colorInfo: map['colorInfo'] == null ? null : GoogleCloudRetailV2betaColorInfo.fromMap((map['colorInfo'] as Map).cast<String, dynamic>()),
      ...
      fulfillmentInfo: map['fulfillmentInfo'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2betaFulfillmentInfo>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2betaFulfillmentInfo.fromMap((value as Map).cast<String, dynamic>())),
      gtin: map['gtin'] == null ? null : map['gtin'] as String,
      id: map['id'] == null ? null : map['id'] as String,
      images: map['images'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2betaImage>(map['images'], (value) => GoogleCloudRetailV2betaImage.fromMap((value as Map).cast<String, dynamic>())),
      ...
      priceInfo: map['priceInfo'] == null ? null : GoogleCloudRetailV2betaPriceInfo.fromMap((map['priceInfo'] as Map).cast<String, dynamic>()),
      primaryProductId: map['primaryProductId'] == null ? null : map['primaryProductId'] as String,
      productId: map['productId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      promotions: map['promotions'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2betaPromotion>(map['promotions'], (value) => GoogleCloudRetailV2betaPromotion.fromMap((value as Map).cast<String, dynamic>())),
      publishTime: map['publishTime'] == null ? null : map['publishTime'] as String,
      rating: map['rating'] == null ? null : GoogleCloudRetailV2betaRating.fromMap((map['rating'] as Map).cast<String, dynamic>()),
      ...
      type: map['type'] == null ? null : ProductTypeRetailV2beta.fromValue(map['type'] as String),
