...
class ProductRetailV2betaArgs {
  ...
  ProductRetailV2betaArgs({
    ...
    String? uri,
       ...
       colorInfo = pulumi
           .Input.asOptionalInput<GoogleCloudRetailV2betaColorInfo>(colorInfo),
       ...
       images = pulumi
           .Input.asOptionalInput<List<GoogleCloudRetailV2betaImage>>(images),
       ...
       priceInfo = pulumi
           .Input.asOptionalInput<GoogleCloudRetailV2betaPriceInfo>(priceInfo),
       primaryProductId = pulumi.Input.asOptionalInput<String>(
         primaryProductId,
       ),
       ...
       retrievableFields = pulumi.Input.asOptionalInput<String>(
         retrievableFields,
       ),
  ...
  factory ProductRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2betaArgs(
      ...
      availableTime: map['availableTime'] == null
          ? null
          : map['availableTime'] as String,
      branchId: map['branchId'] as String,
      brands: map['brands'] == null
          ? null
          : (map['brands'] as List).cast<String>(),
      ...
      publishTime: map['publishTime'] == null
          ? null
          : map['publishTime'] as String,
