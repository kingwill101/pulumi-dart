...
class ServingConfigRetailV2betaArgs {
  ...
  final pulumi.Input<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec>?
      dynamicFacetSpec;
  ...
  final pulumi.Input<GoogleCloudRetailV2betaSearchRequestPersonalizationSpec>?
      personalizationSpec;
  ...
  final pulumi.Input<List<ServingConfigSolutionTypesItemRetailV2beta>>
      solutionTypes;
  ...
  ServingConfigRetailV2betaArgs({
    ...
    List<String>? twowaySynonymsControlIds,
        ...
        diversityType = pulumi.Input.asOptionalInput<
            ServingConfigDiversityTypeRetailV2beta>(diversityType),
        doNotAssociateControlIds = pulumi.Input.asOptionalInput<List<String>>(
            doNotAssociateControlIds),
        dynamicFacetSpec = pulumi.Input.asOptionalInput<
                GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec>(
            dynamicFacetSpec),
        enableCategoryFilterLevel =
            pulumi.Input.asOptionalInput<String>(enableCategoryFilterLevel),
        facetControlIds =
            pulumi.Input.asOptionalInput<List<String>>(facetControlIds),
        filterControlIds =
            pulumi.Input.asOptionalInput<List<String>>(filterControlIds),
        ignoreControlIds =
            pulumi.Input.asOptionalInput<List<String>>(ignoreControlIds),
        ...
        personalizationSpec = pulumi.Input.asOptionalInput<
                GoogleCloudRetailV2betaSearchRequestPersonalizationSpec>(
            personalizationSpec),
        priceRerankingLevel =
            pulumi.Input.asOptionalInput<String>(priceRerankingLevel),
        project = pulumi.Input.asOptionalInput<String>(project),
        redirectControlIds =
            pulumi.Input.asOptionalInput<List<String>>(redirectControlIds),
        replacementControlIds =
            pulumi.Input.asOptionalInput<List<String>>(replacementControlIds),
        servingConfigId = pulumi.Input.asInput<String>(servingConfigId),
        solutionTypes = pulumi.Input.asInput<
            List<ServingConfigSolutionTypesItemRetailV2beta>>(solutionTypes),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (diversityTypeValue != null) {
      map['diversityType'] = pulumi.Input.mapOptionalInputValue<
          ServingConfigDiversityTypeRetailV2beta,
          String>(diversityTypeValue, (value) => value.value);
    }
    ...
    if (dynamicFacetSpecValue != null) {
      map['dynamicFacetSpec'] = pulumi.Input.mapOptionalInputValue<
              GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec,
              Map<String, dynamic>>(
    ...
    if (personalizationSpecValue != null) {
      map['personalizationSpec'] = pulumi.Input.mapOptionalInputValue<
              GoogleCloudRetailV2betaSearchRequestPersonalizationSpec,
              Map<String, dynamic>>(
    ...
    map['solutionTypes'] = pulumi.Input.mapInputValue<
            List<ServingConfigSolutionTypesItemRetailV2beta>, List<String>>(
        solutionTypes,
        (value) => pulumi.Input.encodeList<
            ServingConfigSolutionTypesItemRetailV2beta,
  ...
  factory ServingConfigRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2betaArgs(
      ...
      diversityType: map['diversityType'] == null
          ? null
          : ServingConfigDiversityTypeRetailV2beta.fromValue(
      ...
      dynamicFacetSpec: map['dynamicFacetSpec'] == null
          ? null
          : GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec.fromMap(
      ...
      personalizationSpec: map['personalizationSpec'] == null
          ? null
          : GoogleCloudRetailV2betaSearchRequestPersonalizationSpec.fromMap(
      ...
      solutionTypes:
          pulumi.Input.decodeList<ServingConfigSolutionTypesItemRetailV2beta>(
              map['solutionTypes'],
              (value) => ServingConfigSolutionTypesItemRetailV2beta.fromValue(
                  value as String)),
