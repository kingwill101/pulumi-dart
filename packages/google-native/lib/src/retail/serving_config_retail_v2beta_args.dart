...
class ServingConfigRetailV2betaArgs {
  ...
  ServingConfigRetailV2betaArgs({
    ...
    ServingConfigDiversityTypeRetailV2beta? diversityType,
    List<String>? doNotAssociateControlIds,
    GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec? dynamicFacetSpec,
    ...
    GoogleCloudRetailV2betaSearchRequestPersonalizationSpec? personalizationSpec,
    String? priceRerankingLevel,
    String? project,
    List<String>? redirectControlIds,
    List<String>? replacementControlIds,
    required String servingConfigId,
    required List<ServingConfigSolutionTypesItemRetailV2beta> solutionTypes,
  ...
  factory ServingConfigRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2betaArgs(
      ...
      diversityType: map['diversityType'] == null ? null : ServingConfigDiversityTypeRetailV2beta.fromValue(map['diversityType'] as String),
      doNotAssociateControlIds: map['doNotAssociateControlIds'] == null ? null : (map['doNotAssociateControlIds'] as List).cast<String>(),
      dynamicFacetSpec: map['dynamicFacetSpec'] == null ? null : GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec.fromMap((map['dynamicFacetSpec'] as Map).cast<String, dynamic>()),
      ...
      personalizationSpec: map['personalizationSpec'] == null ? null : GoogleCloudRetailV2betaSearchRequestPersonalizationSpec.fromMap((map['personalizationSpec'] as Map).cast<String, dynamic>()),
      ...
      solutionTypes: pulumi.Input.decodeList<ServingConfigSolutionTypesItemRetailV2beta>(map['solutionTypes'], (value) => ServingConfigSolutionTypesItemRetailV2beta.fromValue(value as String)),
