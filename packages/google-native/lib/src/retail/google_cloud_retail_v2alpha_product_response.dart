...
class GoogleCloudRetailV2alphaProductResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fulfillmentInfo': pulumi.Input.encodeList<GoogleCloudRetailV2alphaFulfillmentInfoResponse, Map<String, dynamic>>(fulfillmentInfo, (value) => value.toMap()),
      'gtin': gtin,
      'images': pulumi.Input.encodeList<GoogleCloudRetailV2alphaImageResponse, Map<String, dynamic>>(images, (value) => value.toMap()),
      'languageCode': languageCode,
      'localInventories': pulumi.Input.encodeList<GoogleCloudRetailV2alphaLocalInventoryResponse, Map<String, dynamic>>(localInventories, (value) => value.toMap()),
      'materials': materials,
      'name': name,
      'patterns': patterns,
      'priceInfo': priceInfo.toMap(),
      'primaryProductId': primaryProductId,
      'promotions': pulumi.Input.encodeList<GoogleCloudRetailV2alphaPromotionResponse, Map<String, dynamic>>(promotions, (value) => value.toMap()),
      ...
      'type': type,
      'uri': uri,
      'variants': pulumi.Input.encodeList<GoogleCloudRetailV2alphaProductResponse, Map<String, dynamic>>(variants, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudRetailV2alphaProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaProductResponse(
      ...
      audience: GoogleCloudRetailV2alphaAudienceResponse.fromMap((map['audience'] as Map).cast<String, dynamic>()),
      ...
      colorInfo: GoogleCloudRetailV2alphaColorInfoResponse.fromMap((map['colorInfo'] as Map).cast<String, dynamic>()),
      conditions: (map['conditions'] as List).cast<String>(),
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      fulfillmentInfo: pulumi.Input.decodeList<GoogleCloudRetailV2alphaFulfillmentInfoResponse>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2alphaFulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
      gtin: map['gtin'] as String,
      images: pulumi.Input.decodeList<GoogleCloudRetailV2alphaImageResponse>(map['images'], (value) => GoogleCloudRetailV2alphaImageResponse.fromMap((value as Map).cast<String, dynamic>())),
      languageCode: map['languageCode'] as String,
      localInventories: pulumi.Input.decodeList<GoogleCloudRetailV2alphaLocalInventoryResponse>(map['localInventories'], (value) => GoogleCloudRetailV2alphaLocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>())),
      materials: (map['materials'] as List).cast<String>(),
      name: map['name'] as String,
      patterns: (map['patterns'] as List).cast<String>(),
      priceInfo: GoogleCloudRetailV2alphaPriceInfoResponse.fromMap((map['priceInfo'] as Map).cast<String, dynamic>()),
      primaryProductId: map['primaryProductId'] as String,
      promotions: pulumi.Input.decodeList<GoogleCloudRetailV2alphaPromotionResponse>(map['promotions'], (value) => GoogleCloudRetailV2alphaPromotionResponse.fromMap((value as Map).cast<String, dynamic>())),
      publishTime: map['publishTime'] as String,
      rating: GoogleCloudRetailV2alphaRatingResponse.fromMap((map['rating'] as Map).cast<String, dynamic>()),
      ...
      variants: pulumi.Input.decodeList<GoogleCloudRetailV2alphaProductResponse>(map['variants'], (value) => GoogleCloudRetailV2alphaProductResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
