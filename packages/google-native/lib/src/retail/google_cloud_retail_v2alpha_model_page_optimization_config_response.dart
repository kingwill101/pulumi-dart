...
class GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse {
  ...
  final List<GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse> panels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'panels': pulumi.Input.encodeList<GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse, Map<String, dynamic>>(panels, (value) => value.toMap()),
  ...
  factory GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse(
      ...
      panels: pulumi.Input.decodeList<GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse>(map['panels'], (value) => GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse.fromMap((value as Map).cast<String, dynamic>())),
