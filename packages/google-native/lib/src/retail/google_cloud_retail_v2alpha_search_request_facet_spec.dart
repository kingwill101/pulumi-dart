...
class GoogleCloudRetailV2alphaSearchRequestFacetSpec {
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaSearchRequestFacetSpec(
      enableDynamicPosition: map['enableDynamicPosition'] == null ? null : map['enableDynamicPosition'] as bool,
      excludedFilterKeys: map['excludedFilterKeys'] == null ? null : (map['excludedFilterKeys'] as List).cast<String>(),
      facetKey: GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey.fromMap((map['facetKey'] as Map).cast<String, dynamic>()),
