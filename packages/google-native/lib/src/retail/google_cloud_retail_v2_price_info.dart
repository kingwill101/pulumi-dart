...
class GoogleCloudRetailV2PriceInfo {
  ...
  /// Creates a new [GoogleCloudRetailV2PriceInfo].
  ...
  factory GoogleCloudRetailV2PriceInfo.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2PriceInfo(
      ...
      priceEffectiveTime: map['priceEffectiveTime'] == null ? null : map['priceEffectiveTime'] as String,
      priceExpireTime: map['priceExpireTime'] == null ? null : map['priceExpireTime'] as String,
    );
  }
}
