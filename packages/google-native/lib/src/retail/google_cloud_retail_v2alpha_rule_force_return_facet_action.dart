...
class GoogleCloudRetailV2alphaRuleForceReturnFacetAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'facetPositionAdjustments': ?facetPositionAdjustments == null
          ? null
  ...
  factory GoogleCloudRetailV2alphaRuleForceReturnFacetAction.fromMap(
      ...
      facetPositionAdjustments: map['facetPositionAdjustments'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustment.fromMap(
