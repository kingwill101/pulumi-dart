...
class ModelRetailV2alphaArgs {
  ...
  factory ModelRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ModelRetailV2alphaArgs(
      ...
      filteringOption: map['filteringOption'] == null ? null : ModelFilteringOptionRetailV2alpha.fromValue(map['filteringOption'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      modelFeaturesConfig: map['modelFeaturesConfig'] == null ? null : GoogleCloudRetailV2alphaModelModelFeaturesConfig.fromMap((map['modelFeaturesConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      optimizationObjective: map['optimizationObjective'] == null ? null : map['optimizationObjective'] as String,
      pageOptimizationConfig: map['pageOptimizationConfig'] == null ? null : GoogleCloudRetailV2alphaModelPageOptimizationConfig.fromMap((map['pageOptimizationConfig'] as Map).cast<String, dynamic>()),
      periodicTuningState: map['periodicTuningState'] == null ? null : ModelPeriodicTuningStateRetailV2alpha.fromValue(map['periodicTuningState'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      trainingState: map['trainingState'] == null ? null : ModelTrainingStateRetailV2alpha.fromValue(map['trainingState'] as String),
