...
class TimeSeriesFilterRatio {
  ...
  factory TimeSeriesFilterRatio.fromMap(Map<String, dynamic> map) {
    return TimeSeriesFilterRatio(
      denominator: map['denominator'] == null ? null : RatioPart.fromMap((map['denominator'] as Map).cast<String, dynamic>()),
      numerator: map['numerator'] == null ? null : RatioPart.fromMap((map['numerator'] as Map).cast<String, dynamic>()),
