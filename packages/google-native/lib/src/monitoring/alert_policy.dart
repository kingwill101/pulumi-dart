...
class AlertPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ConditionResponse>> conditions;
  ...
  AlertPolicy(
    ...
    this.conditions = registerOutput<List<ConditionResponse>>('conditions');
    ...
    this.mutationRecord = registerOutput<MutationRecordResponse>('mutationRecord');
    ...
    this.validity = registerOutput<StatusResponse>('validity');
  }
}
