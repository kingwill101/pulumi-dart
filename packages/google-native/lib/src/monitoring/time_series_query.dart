...
class TimeSeriesQuery {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'opsAnalyticsQuery': ?opsAnalyticsQuery == null
          ? null
          : opsAnalyticsQuery!.toMap(),
      'outputFullDuration': ?outputFullDuration,
      'prometheusQuery': ?prometheusQuery,
      'timeSeriesFilter': ?timeSeriesFilter == null
          ? null
          : timeSeriesFilter!.toMap(),
      'timeSeriesFilterRatio': ?timeSeriesFilterRatio == null
          ? null
          : timeSeriesFilterRatio!.toMap(),
  ...
  factory TimeSeriesQuery.fromMap(Map<String, dynamic> map) {
    return TimeSeriesQuery(
      ...
      unitOverride: map['unitOverride'] == null
          ? null
          : map['unitOverride'] as String,
    );
  }
}
