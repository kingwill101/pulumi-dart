...
class AlertPolicyArgs {
  ...
  AlertPolicyArgs({
    ...
    Status? validity,
            ...
            pulumi.Input.asOptionalInput<AlertStrategy>(alertStrategy),
        ...
        mutationRecord =
            pulumi.Input.asOptionalInput<MutationRecord>(mutationRecord),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (conditionsValue != null) {
      map['conditions'] = pulumi.Input.mapOptionalInputValue<List<Condition>,
  ...
  factory AlertPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AlertPolicyArgs(
      alertStrategy: map['alertStrategy'] == null
          ? null
          : AlertStrategy.fromMap(
              (map['alertStrategy'] as Map).cast<String, dynamic>()),
      combiner: map['combiner'] == null
          ? null
          : AlertPolicyCombiner.fromValue(map['combiner'] as String),
      ...
      mutationRecord: map['mutationRecord'] == null
          ? null
          : MutationRecord.fromMap(
              (map['mutationRecord'] as Map).cast<String, dynamic>()),
      ...
      severity: map['severity'] == null
          ? null
          : AlertPolicySeverity.fromValue(map['severity'] as String),
      userLabels: map['userLabels'] == null
          ? null
          : (map['userLabels'] as Map).cast<String, String>(),
      validity: map['validity'] == null
          ? null
          : Status.fromMap((map['validity'] as Map).cast<String, dynamic>()),
    );
  }
}
