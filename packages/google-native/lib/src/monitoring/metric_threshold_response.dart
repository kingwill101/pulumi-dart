...
class MetricThresholdResponse {
  ...
  final List<AggregationResponseMonitoringV3> denominatorAggregations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'denominatorAggregations': pulumi.Input.encodeList<AggregationResponseMonitoringV3, Map<String, dynamic>>(denominatorAggregations, (value) => value.toMap()),
      'denominatorFilter': denominatorFilter,
      'duration': duration,
      'evaluationMissingData': evaluationMissingData,
      'filter': filter,
      'forecastOptions': forecastOptions.toMap(),
  ...
  factory MetricThresholdResponse.fromMap(Map<String, dynamic> map) {
    return MetricThresholdResponse(
      ...
      denominatorAggregations: pulumi.Input.decodeList<AggregationResponseMonitoringV3>(map['denominatorAggregations'], (value) => AggregationResponseMonitoringV3.fromMap((value as Map).cast<String, dynamic>())),
      denominatorFilter: map['denominatorFilter'] as String,
      duration: map['duration'] as String,
      evaluationMissingData: map['evaluationMissingData'] as String,
      filter: map['filter'] as String,
      forecastOptions: ForecastOptionsResponse.fromMap((map['forecastOptions'] as Map).cast<String, dynamic>()),
