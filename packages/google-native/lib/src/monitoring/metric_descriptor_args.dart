...
class MetricDescriptorArgs {
  ...
  MetricDescriptorArgs({
    ...
    MetricDescriptorLaunchStage? launchStage,
    MetricDescriptorMetadata? metadata,
    MetricDescriptorMetricKind? metricKind,
    List<String>? monitoredResourceTypes,
    String? name,
    String? project,
    String? type,
    String? unit,
    MetricDescriptorValueType? valueType,
  })  : description = pulumi.Input.asOptionalInput<String>(description),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        labels = pulumi.Input.asOptionalInput<List<LabelDescriptor>>(labels),
        launchStage = pulumi.Input.asOptionalInput<MetricDescriptorLaunchStage>(
            launchStage),
        metadata =
            pulumi.Input.asOptionalInput<MetricDescriptorMetadata>(metadata),
        metricKind = pulumi.Input.asOptionalInput<MetricDescriptorMetricKind>(
            metricKind),
        monitoredResourceTypes =
            pulumi.Input.asOptionalInput<List<String>>(monitoredResourceTypes),
        name = pulumi.Input.asOptionalInput<String>(name),
        project = pulumi.Input.asOptionalInput<String>(project),
        type = pulumi.Input.asOptionalInput<String>(type),
        unit = pulumi.Input.asOptionalInput<String>(unit),
        valueType =
            pulumi.Input.asOptionalInput<MetricDescriptorValueType>(valueType);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (labelsValue != null) {
      map['labels'] = pulumi.Input.mapOptionalInputValue<List<LabelDescriptor>,
    ...
    if (valueTypeValue != null) {
      map['valueType'] =
          pulumi.Input.mapOptionalInputValue<MetricDescriptorValueType, String>(
