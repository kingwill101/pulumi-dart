...
class NotificationChannelArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': ?enabled,
      'labels': ?labels,
      'mutationRecords': ?pulumi.Input.mapOptionalInputValue<List<MutationRecord>, List<Map<String, dynamic>>>(mutationRecords, (value) => pulumi.Input.encodeList<MutationRecord, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      'project': ?project,
      'type': ?type,
      'userLabels': ?userLabels,
      'verificationStatus': ?pulumi.Input.mapOptionalInputValue<NotificationChannelVerificationStatus, String>(verificationStatus, (value) => value.value),
    };
  }

  factory NotificationChannelArgs.fromMap(Map<String, dynamic> map) {
    return NotificationChannelArgs(
      creationRecord: map['creationRecord'] == null ? null : MutationRecord.fromMap((map['creationRecord'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      mutationRecords: map['mutationRecords'] == null ? null : pulumi.Input.decodeList<MutationRecord>(map['mutationRecords'], (value) => MutationRecord.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      type: map['type'] == null ? null : map['type'] as String,
      userLabels: map['userLabels'] == null ? null : (map['userLabels'] as Map).cast<String, String>(),
      verificationStatus: map['verificationStatus'] == null ? null : NotificationChannelVerificationStatus.fromValue(map['verificationStatus'] as String),
    );
  }
}
