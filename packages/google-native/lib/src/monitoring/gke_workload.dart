...
class GkeWorkload {
  ...
  factory GkeWorkload.fromMap(Map<String, dynamic> map) {
    return GkeWorkload(
      ...
      topLevelControllerName: map['topLevelControllerName'] == null ? null : map['topLevelControllerName'] as String,
      topLevelControllerType: map['topLevelControllerType'] == null ? null : map['topLevelControllerType'] as String,
    );
  }
}
