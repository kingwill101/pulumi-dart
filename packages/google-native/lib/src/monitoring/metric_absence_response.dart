...
class MetricAbsenceResponse {
  ...
  final List<AggregationResponseMonitoringV3> aggregations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregations': pulumi.Input.encodeList<AggregationResponseMonitoringV3, Map<String, dynamic>>(aggregations, (value) => value.toMap()),
      'duration': duration,
      'filter': filter,
  ...
  factory MetricAbsenceResponse.fromMap(Map<String, dynamic> map) {
    return MetricAbsenceResponse(
      aggregations: pulumi.Input.decodeList<AggregationResponseMonitoringV3>(map['aggregations'], (value) => AggregationResponseMonitoringV3.fromMap((value as Map).cast<String, dynamic>())),
      duration: map['duration'] as String,
      filter: map['filter'] as String,
      trigger: TriggerResponse.fromMap((map['trigger'] as Map).cast<String, dynamic>()),
    );
  }
}
