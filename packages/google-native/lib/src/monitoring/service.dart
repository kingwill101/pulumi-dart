...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    this.cloudEndpoints = registerOutput<CloudEndpointsResponse>('cloudEndpoints');
    this.cloudRun = registerOutput<CloudRunResponse>('cloudRun');
    ...
    this.istioCanonicalService = registerOutput<IstioCanonicalServiceResponse>('istioCanonicalService');
