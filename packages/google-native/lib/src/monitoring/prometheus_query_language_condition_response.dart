...
class PrometheusQueryLanguageConditionResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['alertRule'] = alertRule;
    map['duration'] = duration;
    map['evaluationInterval'] = evaluationInterval;
    map['labels'] = labels;
    map['query'] = query;
    map['ruleGroup'] = ruleGroup;
    return map;
  }

  factory PrometheusQueryLanguageConditionResponse.fromMap(
      Map<String, dynamic> map) {
    return PrometheusQueryLanguageConditionResponse(
      alertRule: map['alertRule'] as String,
      duration: map['duration'] as String,
      evaluationInterval: map['evaluationInterval'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      query: map['query'] as String,
      ruleGroup: map['ruleGroup'] as String,
    );
  }
}
