...
class ServiceLevelObjectiveArgs {
  ...
  factory ServiceLevelObjectiveArgs.fromMap(Map<String, dynamic> map) {
    return ServiceLevelObjectiveArgs(
      calendarPeriod: map['calendarPeriod'] == null ? null : ServiceLevelObjectiveCalendarPeriod.fromValue(map['calendarPeriod'] as String),
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      goal: map['goal'] == null ? null : map['goal'] as double,
      name: map['name'] == null ? null : map['name'] as String,
      rollingPeriod: map['rollingPeriod'] == null ? null : map['rollingPeriod'] as String,
      serviceId: map['serviceId'] as String,
      serviceLevelIndicator: map['serviceLevelIndicator'] == null ? null : ServiceLevelIndicator.fromMap((map['serviceLevelIndicator'] as Map).cast<String, dynamic>()),
      serviceLevelObjectiveId: map['serviceLevelObjectiveId'] == null ? null : map['serviceLevelObjectiveId'] as String,
