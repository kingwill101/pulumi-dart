...
class ServiceLevelObjectiveArgs {
  ...
  ServiceLevelObjectiveArgs({
    ...
    required String v3Id1,
       ...
       serviceLevelIndicator = pulumi
           .Input.asOptionalInput<ServiceLevelIndicator>(serviceLevelIndicator),
       serviceLevelObjectiveId = pulumi.Input.asOptionalInput<String>(
    ...
    return <String, dynamic>{
      'calendarPeriod':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(calendarPeriod, (value) => value.value),
  ...
  factory ServiceLevelObjectiveArgs.fromMap(Map<String, dynamic> map) {
    return ServiceLevelObjectiveArgs(
      ...
      rollingPeriod: map['rollingPeriod'] == null
          ? null
          : map['rollingPeriod'] as String,
