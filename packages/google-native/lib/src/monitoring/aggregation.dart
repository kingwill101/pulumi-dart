...
class Aggregation {
  ...
  final AggregationCrossSeriesReducer? crossSeriesReducer;
  ...
  final AggregationPerSeriesAligner? perSeriesAligner;
  ...
  factory Aggregation.fromMap(Map<String, dynamic> map) {
    return Aggregation(
      ...
      crossSeriesReducer: map['crossSeriesReducer'] == null ? null : AggregationCrossSeriesReducer.fromValue(map['crossSeriesReducer'] as String),
      groupByFields: map['groupByFields'] == null ? null : (map['groupByFields'] as List).cast<String>(),
      perSeriesAligner: map['perSeriesAligner'] == null ? null : AggregationPerSeriesAligner.fromValue(map['perSeriesAligner'] as String),
    );
  }
}
