...
class Aggregation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crossSeriesReducer': ?crossSeriesReducer == null
          ? null
          : crossSeriesReducer!.value,
      'groupByFields': ?groupByFields,
      'perSeriesAligner': ?perSeriesAligner == null
          ? null
  ...
  factory Aggregation.fromMap(Map<String, dynamic> map) {
    return Aggregation(
      ...
      crossSeriesReducer: map['crossSeriesReducer'] == null
          ? null
          : AggregationCrossSeriesReducer.fromValue(
      ...
      perSeriesAligner: map['perSeriesAligner'] == null
          ? null
          : AggregationPerSeriesAligner.fromValue(
