...
class LogMatchResponse {
  ...
  /// Creates a new [LogMatchResponse].
  ...
  LogMatchResponse({required this.filter, required this.labelExtractors});
  ...
  factory LogMatchResponse.fromMap(Map<String, dynamic> map) {
