...
class UptimeCheckConfigArgs {
  ...
  UptimeCheckConfigArgs({
    UptimeCheckConfigCheckerType? checkerType,
    List<ContentMatcher>? contentMatchers,
    String? displayName,
    HttpCheck? httpCheck,
    List<InternalChecker>? internalCheckers,
    bool? isInternal,
    MonitoredResourceMonitoringV3? monitoredResource,
    String? name,
    String? period,
    String? project,
    ...
    Map<String, String>? userLabels,
  }) : checkerType = pulumi.Input.asOptionalInput<UptimeCheckConfigCheckerType>(
         checkerType,
       ),
       contentMatchers = pulumi.Input.asOptionalInput<List<ContentMatcher>>(
         contentMatchers,
       ),
       ...
       resourceGroup = pulumi.Input.asOptionalInput<ResourceGroup>(
         resourceGroup,
       ),
       selectedRegions =
           pulumi.Input.asOptionalInput<
             List<UptimeCheckConfigSelectedRegionsItem>
           >(selectedRegions),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'monitoredResource':
          ?pulumi.Input.mapOptionalInputValue<
            MonitoredResourceMonitoringV3,
            Map<String, dynamic>
          >(monitoredResource, (value) => value.toMap()),
      'name': ?name,
      'period': ?period,
      'project': ?project,
      'resourceGroup':
      ...
      'syntheticMonitor':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(syntheticMonitor, (value) => value.toMap()),
      'tcpCheck':
