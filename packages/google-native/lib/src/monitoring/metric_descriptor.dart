...
class MetricDescriptor extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<LabelDescriptorResponse>> labels;

  /// Optional. The launch stage of the metric definition.
  late final pulumi.Output<String> launchStage;

  /// Optional. Metadata which can be used to guide usage of the metric.
  late final pulumi.Output<MetricDescriptorMetadataResponse> metadata;
  ...
  /// [args] Arguments used to configure this [MetricDescriptor]. {@macro pulumi_monitoring_v3_metric_descriptor_args_doc}
  ...
  MetricDescriptor(
    ...
    this.labels = registerOutput<List<LabelDescriptorResponse>>('labels');
    this.launchStage = registerOutput<String>('launchStage');
    this.metadata = registerOutput<MetricDescriptorMetadataResponse>(
      'metadata',
    );
    this.metricKind = registerOutput<String>('metricKind');
    this.monitoredResourceTypes = registerOutput<List<String>>(
