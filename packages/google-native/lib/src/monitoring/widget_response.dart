...
class WidgetResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertChart': alertChart.toMap(),
      'blank': blank,
      'collapsibleGroup': collapsibleGroup.toMap(),
      'errorReportingPanel': errorReportingPanel.toMap(),
      'incidentList': incidentList.toMap(),
      'logsPanel': logsPanel.toMap(),
      'pieChart': pieChart.toMap(),
      'scorecard': scorecard.toMap(),
      'text': text.toMap(),
      'timeSeriesTable': timeSeriesTable.toMap(),
      'title': title,
      'xyChart': xyChart.toMap(),
    };
  }
