...
class XyChartResponse {
  ...
  factory XyChartResponse.fromMap(Map<String, dynamic> map) {
    return XyChartResponse(
      ...
      xAxis: AxisResponse.fromMap(
        (map['xAxis'] as Map).cast<String, dynamic>(),
      ),
      y2Axis: AxisResponse.fromMap(
        (map['y2Axis'] as Map).cast<String, dynamic>(),
      ),
      yAxis: AxisResponse.fromMap(
        (map['yAxis'] as Map).cast<String, dynamic>(),
      ),
    );
  }
}
