...
class DashboardArgs {
  ...
  factory DashboardArgs.fromMap(Map<String, dynamic> map) {
    return DashboardArgs(
      columnLayout: map['columnLayout'] == null ? null : ColumnLayout.fromMap((map['columnLayout'] as Map).cast<String, dynamic>()),
      dashboardFilters: map['dashboardFilters'] == null ? null : pulumi.Input.decodeList<DashboardFilter>(map['dashboardFilters'], (value) => DashboardFilter.fromMap((value as Map).cast<String, dynamic>())),
      displayName: map['displayName'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      gridLayout: map['gridLayout'] == null ? null : GridLayout.fromMap((map['gridLayout'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      mosaicLayout: map['mosaicLayout'] == null ? null : MosaicLayout.fromMap((map['mosaicLayout'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      rowLayout: map['rowLayout'] == null ? null : RowLayout.fromMap((map['rowLayout'] as Map).cast<String, dynamic>()),
    );
  }
}
