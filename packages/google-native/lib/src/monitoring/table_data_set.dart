...
class TableDataSet {
  ...
  Map<String, dynamic> toMap() {
    ...
    final tableDisplayOptionsValue = tableDisplayOptions;
    if (tableDisplayOptionsValue != null) {
      map['tableDisplayOptions'] = tableDisplayOptionsValue.toMap();
    }
    final tableTemplateValue = tableTemplate;
    if (tableTemplateValue != null) {
      map['tableTemplate'] = tableTemplateValue;
    }
  ...
  factory TableDataSet.fromMap(Map<String, dynamic> map) {
    return TableDataSet(
      ...
      tableDisplayOptions: map['tableDisplayOptions'] == null
          ? null
          : TableDisplayOptions.fromMap(
              (map['tableDisplayOptions'] as Map).cast<String, dynamic>()),
      tableTemplate:
          map['tableTemplate'] == null ? null : map['tableTemplate'] as String,
