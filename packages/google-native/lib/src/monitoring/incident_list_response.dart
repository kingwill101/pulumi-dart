...
class IncidentListResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'monitoredResources': pulumi.Input.encodeList<MonitoredResourceResponse, Map<String, dynamic>>(monitoredResources, (value) => value.toMap()),
  ...
  factory IncidentListResponse.fromMap(Map<String, dynamic> map) {
    return IncidentListResponse(
      monitoredResources: pulumi.Input.decodeList<MonitoredResourceResponse>(map['monitoredResources'], (value) => MonitoredResourceResponse.fromMap((value as Map).cast<String, dynamic>())),
