...
class WindowsBasedSliResponse {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['goodBadMetricFilter'] = goodBadMetricFilter;
    map['goodTotalRatioThreshold'] = goodTotalRatioThreshold.toMap();
    map['metricMeanInRange'] = metricMeanInRange.toMap();
    map['metricSumInRange'] = metricSumInRange.toMap();
    map['windowPeriod'] = windowPeriod;
    return map;
  }
