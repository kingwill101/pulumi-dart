...
class NotificationChannel extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MutationRecordResponse>> mutationRecords;
  ...
  NotificationChannel(
    ...
    this.creationRecord = registerOutput<MutationRecordResponse>('creationRecord');
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.enabled = registerOutput<bool>('enabled');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.mutationRecords = registerOutput<List<MutationRecordResponse>>('mutationRecords');
