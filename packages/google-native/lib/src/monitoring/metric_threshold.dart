...
class MetricThreshold {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'comparison': ?comparison == null ? null : comparison!.value,
      'denominatorAggregations': ?denominatorAggregations == null
          ? null
          : pulumi.Input.encodeList<
              AggregationMonitoringV3,
              Map<String, dynamic>
      ...
      'duration': ?duration,
      'evaluationMissingData': ?evaluationMissingData == null
          ? null
          : evaluationMissingData!.value,
      'filter': filter,
      'forecastOptions': ?forecastOptions == null
          ? null
          : forecastOptions!.toMap(),
