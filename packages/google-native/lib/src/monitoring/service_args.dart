...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    required String v3Id1,
       ...
       cloudEndpoints = pulumi.Input.asOptionalInput<CloudEndpoints>(
         cloudEndpoints,
       ),
       ...
       istioCanonicalService = pulumi
           .Input.asOptionalInput<IstioCanonicalService>(istioCanonicalService),
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      basicService: map['basicService'] == null
          ? null
          : BasicService.fromMap(
              (map['basicService'] as Map).cast<String, dynamic>(),
            ),
      cloudEndpoints: map['cloudEndpoints'] == null
          ? null
          : CloudEndpoints.fromMap(
      ...
      clusterIstio: map['clusterIstio'] == null
          ? null
          : ClusterIstio.fromMap(
      ...
      gkeNamespace: map['gkeNamespace'] == null
          ? null
          : GkeNamespace.fromMap(
              (map['gkeNamespace'] as Map).cast<String, dynamic>(),
            ),
      gkeService: map['gkeService'] == null
          ? null
          : GkeService.fromMap(
