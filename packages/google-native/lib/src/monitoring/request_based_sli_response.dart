...
class RequestBasedSliResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'distributionCut': distributionCut.toMap(),
      'goodTotalRatio': goodTotalRatio.toMap(),
    };
  }

  factory RequestBasedSliResponse.fromMap(Map<String, dynamic> map) {
    return RequestBasedSliResponse(
      distributionCut: DistributionCutResponse.fromMap((map['distributionCut'] as Map).cast<String, dynamic>()),
      goodTotalRatio: TimeSeriesRatioResponse.fromMap((map['goodTotalRatio'] as Map).cast<String, dynamic>()),
    );
  }
}
