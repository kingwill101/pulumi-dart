...
class ConditionResponse {
  ...
  final MonitoringQueryLanguageConditionResponse conditionMonitoringQueryLanguage;
  /// A condition that uses the Prometheus query language to define alerts.
  final PrometheusQueryLanguageConditionResponse conditionPrometheusQueryLanguage;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditionAbsent': conditionAbsent.toMap(),
      'conditionMatchedLog': conditionMatchedLog.toMap(),
      'conditionMonitoringQueryLanguage': conditionMonitoringQueryLanguage.toMap(),
      'conditionPrometheusQueryLanguage': conditionPrometheusQueryLanguage.toMap(),
      'conditionThreshold': conditionThreshold.toMap(),
  ...
  factory ConditionResponse.fromMap(Map<String, dynamic> map) {
    return ConditionResponse(
      conditionAbsent: MetricAbsenceResponse.fromMap((map['conditionAbsent'] as Map).cast<String, dynamic>()),
      conditionMatchedLog: LogMatchResponse.fromMap((map['conditionMatchedLog'] as Map).cast<String, dynamic>()),
      conditionMonitoringQueryLanguage: MonitoringQueryLanguageConditionResponse.fromMap((map['conditionMonitoringQueryLanguage'] as Map).cast<String, dynamic>()),
      conditionPrometheusQueryLanguage: PrometheusQueryLanguageConditionResponse.fromMap((map['conditionPrometheusQueryLanguage'] as Map).cast<String, dynamic>()),
      conditionThreshold: MetricThresholdResponse.fromMap((map['conditionThreshold'] as Map).cast<String, dynamic>()),
