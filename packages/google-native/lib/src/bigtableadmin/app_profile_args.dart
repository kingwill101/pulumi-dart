  ...
  AppProfileArgs({
    ...
    StandardIsolation? standardIsolation,
        ...
        singleClusterRouting =
            pulumi.Input.asOptionalInput<SingleClusterRouting>(
                singleClusterRouting),
        standardIsolation =
            pulumi.Input.asOptionalInput<StandardIsolation>(standardIsolation);
    ...
    return AppProfileArgs(
      ...
      multiClusterRoutingUseAny: map['multiClusterRoutingUseAny'] == null
          ...
          : MultiClusterRoutingUseAny.fromMap(
              (map['multiClusterRoutingUseAny'] as Map)
                  .cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      priority: map['priority'] == null
          ? null
          : AppProfilePriority.fromValue(map['priority'] as String),
