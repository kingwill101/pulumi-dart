...
class AppProfile extends pulumi.CustomResource {
  ...
  AppProfile(
    ...
    this.multiClusterRoutingUseAny = registerOutput<MultiClusterRoutingUseAnyResponse>('multiClusterRoutingUseAny');
    this.name = registerOutput<String>('name');
    this.priority = registerOutput<String>('priority');
    this.project = registerOutput<String>('project');
    this.singleClusterRouting = registerOutput<SingleClusterRoutingResponse>('singleClusterRouting');
    this.standardIsolation = registerOutput<StandardIsolationResponse>('standardIsolation');
  }
}
