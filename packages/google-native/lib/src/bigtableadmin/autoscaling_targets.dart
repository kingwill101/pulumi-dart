...
class AutoscalingTargets {
  ...
  Map<String, dynamic> toMap() {
    ...
    final cpuUtilizationPercentValue = cpuUtilizationPercent;
    if (cpuUtilizationPercentValue != null) {
      map['cpuUtilizationPercent'] = cpuUtilizationPercentValue;
    }
    final storageUtilizationGibPerNodeValue = storageUtilizationGibPerNode;
    if (storageUtilizationGibPerNodeValue != null) {
      map['storageUtilizationGibPerNode'] = storageUtilizationGibPerNodeValue;
    }
    return map;
  }
