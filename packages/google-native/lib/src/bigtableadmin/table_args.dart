...
class TableArgs {
  ...
  TableArgs({
    ...
    required String tableId,
            ...
            changeStreamConfig),
        columnFamilies =
            pulumi.Input.asOptionalInput<Map<String, String>>(columnFamilies),
        deletionProtection =
            pulumi.Input.asOptionalInput<bool>(deletionProtection),
        granularity =
            pulumi.Input.asOptionalInput<TableGranularity>(granularity),
        initialSplits =
            pulumi.Input.asOptionalInput<List<Split>>(initialSplits),
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      ...
      initialSplits: map['initialSplits'] == null
          ? null
          : pulumi.Input.decodeList<Split>(map['initialSplits'],
