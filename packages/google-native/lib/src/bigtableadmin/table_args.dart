...
class TableArgs {
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      changeStreamConfig: map['changeStreamConfig'] == null ? null : ChangeStreamConfig.fromMap((map['changeStreamConfig'] as Map).cast<String, dynamic>()),
      columnFamilies: map['columnFamilies'] == null ? null : (map['columnFamilies'] as Map).cast<String, String>(),
      deletionProtection: map['deletionProtection'] == null ? null : map['deletionProtection'] as bool,
      granularity: map['granularity'] == null ? null : TableGranularity.fromValue(map['granularity'] as String),
      initialSplits: map['initialSplits'] == null ? null : pulumi.Input.decodeList<Split>(map['initialSplits'], (value) => Split.fromMap((value as Map).cast<String, dynamic>())),
