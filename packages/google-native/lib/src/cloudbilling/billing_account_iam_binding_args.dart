...
/// {@template pulumi_cloudbilling_v1_billing_account_iam_binding_args_doc}
/// The set of arguments for BillingAccountIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudbilling_v1_billing_account_iam_binding_args_doc}
class BillingAccountIamBindingArgs {
  ...
  /// Creates a new [BillingAccountIamBindingArgs].
  ...
  factory BillingAccountIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return BillingAccountIamBindingArgs(
