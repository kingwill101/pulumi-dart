...
import 'billing_account_iam_policy_args.dart';
...
class BillingAccountIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [BillingAccountIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BillingAccountIamPolicy]. {@macro pulumi_cloudbilling_v1_billing_account_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BillingAccountIamPolicy(
    String name, {
    BillingAccountIamPolicyArgs? args,
