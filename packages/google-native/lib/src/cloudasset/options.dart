...
class Options {
  ...
  factory Options.fromMap(Map<String, dynamic> map) {
    return Options(
      analyzeServiceAccountImpersonation: map['analyzeServiceAccountImpersonation'] == null ? null : map['analyzeServiceAccountImpersonation'] as bool,
      expandGroups: map['expandGroups'] == null ? null : map['expandGroups'] as bool,
      expandResources: map['expandResources'] == null ? null : map['expandResources'] as bool,
      expandRoles: map['expandRoles'] == null ? null : map['expandRoles'] as bool,
      outputGroupEdges: map['outputGroupEdges'] == null ? null : map['outputGroupEdges'] as bool,
      outputResourceEdges: map['outputResourceEdges'] == null ? null : map['outputResourceEdges'] as bool,
    );
  }
}
