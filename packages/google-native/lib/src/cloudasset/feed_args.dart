...
class FeedArgs {
  ...
  FeedArgs({
    ...
    required FeedOutputConfig feedOutputConfig,
    ...
    required String v1Id1,
        ...
        contentType =
            pulumi.Input.asOptionalInput<FeedContentType>(contentType),
        feedId = pulumi.Input.asInput<String>(feedId),
        feedOutputConfig =
            pulumi.Input.asInput<FeedOutputConfig>(feedOutputConfig),
        name = pulumi.Input.asInput<String>(name),
        relationshipTypes =
            pulumi.Input.asOptionalInput<List<String>>(relationshipTypes),
  ...
  factory FeedArgs.fromMap(Map<String, dynamic> map) {
    return FeedArgs(
      ...
      contentType: map['contentType'] == null
          ? null
          : FeedContentType.fromValue(map['contentType'] as String),
      feedId: map['feedId'] as String,
      feedOutputConfig: FeedOutputConfig.fromMap(
          (map['feedOutputConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      relationshipTypes: map['relationshipTypes'] == null
          ? null
          : (map['relationshipTypes'] as List).cast<String>(),
