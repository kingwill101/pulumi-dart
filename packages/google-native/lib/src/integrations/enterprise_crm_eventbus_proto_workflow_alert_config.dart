...
class EnterpriseCrmEventbusProtoWorkflowAlertConfig {
  ...
  final EnterpriseCrmEventbusProtoWorkflowAlertConfigThresholdType? thresholdType;
  ...
  factory EnterpriseCrmEventbusProtoWorkflowAlertConfig.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoWorkflowAlertConfig(
      ...
      metricType: map['metricType'] == null ? null : EnterpriseCrmEventbusProtoWorkflowAlertConfigMetricType.fromValue(map['metricType'] as String),
      ...
      thresholdType: map['thresholdType'] == null ? null : EnterpriseCrmEventbusProtoWorkflowAlertConfigThresholdType.fromValue(map['thresholdType'] as String),
