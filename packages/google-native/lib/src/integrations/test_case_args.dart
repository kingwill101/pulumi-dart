...
class TestCaseArgs {
  ...
  factory TestCaseArgs.fromMap(Map<String, dynamic> map) {
    return TestCaseArgs(
      ...
      databasePersistencePolicy: map['databasePersistencePolicy'] == null ? null : TestCaseDatabasePersistencePolicy.fromValue(map['databasePersistencePolicy'] as String),
      ...
      lockHolderEmail: map['lockHolderEmail'] == null ? null : map['lockHolderEmail'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      testCaseId: map['testCaseId'] as String,
      testInputParameters: map['testInputParameters'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaIntegrationParameter>(map['testInputParameters'], (value) => GoogleCloudIntegrationsV1alphaIntegrationParameter.fromMap((value as Map).cast<String, dynamic>())),
      testTaskConfigs: map['testTaskConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTestTaskConfig>(map['testTaskConfigs'], (value) => GoogleCloudIntegrationsV1alphaTestTaskConfig.fromMap((value as Map).cast<String, dynamic>())),
