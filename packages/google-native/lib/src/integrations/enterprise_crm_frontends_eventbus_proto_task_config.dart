...
class EnterpriseCrmFrontendsEventbusProtoTaskConfig {
  ...
  final EnterpriseCrmFrontendsEventbusProtoTaskConfigExternalTaskType? externalTaskType;
  ...
  final EnterpriseCrmFrontendsEventbusProtoTaskConfigJsonValidationOption? jsonValidationOption;
  ...
  final EnterpriseCrmFrontendsEventbusProtoTaskConfigNextTasksExecutionPolicy? nextTasksExecutionPolicy;
  ...
  final EnterpriseCrmFrontendsEventbusProtoTaskConfigTaskExecutionStrategy? taskExecutionStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertConfigs': ?alertConfigs == null ? null : pulumi.Input.encodeList<EnterpriseCrmEventbusProtoTaskAlertConfig, Map<String, dynamic>>(alertConfigs!, (value) => value.toMap()),
      'createTime': ?createTime,
      'creatorEmail': ?creatorEmail,
      'description': ?description,
      'disableStrictTypeValidation': ?disableStrictTypeValidation,
      'errorCatcherId': ?errorCatcherId,
      'externalTaskType': ?externalTaskType == null ? null : externalTaskType!.value,
      'failurePolicy': ?failurePolicy == null ? null : failurePolicy!.toMap(),
      'incomingEdgeCount': ?incomingEdgeCount,
      'jsonValidationOption': ?jsonValidationOption == null ? null : jsonValidationOption!.value,
      'label': ?label,
      'lastModifiedTime': ?lastModifiedTime,
      'nextTasks': ?nextTasks == null ? null : pulumi.Input.encodeList<EnterpriseCrmEventbusProtoNextTask, Map<String, dynamic>>(nextTasks!, (value) => value.toMap()),
      ...
      'rollbackStrategy': ?rollbackStrategy == null ? null : rollbackStrategy!.toMap(),
      'successPolicy': ?successPolicy == null ? null : successPolicy!.toMap(),
      'synchronousCallFailurePolicy': ?synchronousCallFailurePolicy == null ? null : synchronousCallFailurePolicy!.toMap(),
      'taskEntity': ?taskEntity == null ? null : taskEntity!.toMap(),
      'taskExecutionStrategy': ?taskExecutionStrategy == null ? null : taskExecutionStrategy!.value,
      'taskName': ?taskName,
  ...
  factory EnterpriseCrmFrontendsEventbusProtoTaskConfig.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoTaskConfig(
      alertConfigs: map['alertConfigs'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmEventbusProtoTaskAlertConfig>(map['alertConfigs'], (value) => EnterpriseCrmEventbusProtoTaskAlertConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      disableStrictTypeValidation: map['disableStrictTypeValidation'] == null ? null : map['disableStrictTypeValidation'] as bool,
      errorCatcherId: map['errorCatcherId'] == null ? null : map['errorCatcherId'] as String,
      externalTaskType: map['externalTaskType'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTaskConfigExternalTaskType.fromValue(map['externalTaskType'] as String),
      failurePolicy: map['failurePolicy'] == null ? null : EnterpriseCrmEventbusProtoFailurePolicy.fromMap((map['failurePolicy'] as Map).cast<String, dynamic>()),
      incomingEdgeCount: map['incomingEdgeCount'] == null ? null : map['incomingEdgeCount'] as int,
      jsonValidationOption: map['jsonValidationOption'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTaskConfigJsonValidationOption.fromValue(map['jsonValidationOption'] as String),
      label: map['label'] == null ? null : map['label'] as String,
      lastModifiedTime: map['lastModifiedTime'] == null ? null : map['lastModifiedTime'] as String,
      nextTasks: map['nextTasks'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmEventbusProtoNextTask>(map['nextTasks'], (value) => EnterpriseCrmEventbusProtoNextTask.fromMap((value as Map).cast<String, dynamic>())),
      nextTasksExecutionPolicy: map['nextTasksExecutionPolicy'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTaskConfigNextTasksExecutionPolicy.fromValue(map['nextTasksExecutionPolicy'] as String),
      ...
      precondition: map['precondition'] == null ? null : map['precondition'] as String,
      preconditionLabel: map['preconditionLabel'] == null ? null : map['preconditionLabel'] as String,
      rollbackStrategy: map['rollbackStrategy'] == null ? null : EnterpriseCrmFrontendsEventbusProtoRollbackStrategy.fromMap((map['rollbackStrategy'] as Map).cast<String, dynamic>()),
      successPolicy: map['successPolicy'] == null ? null : EnterpriseCrmEventbusProtoSuccessPolicy.fromMap((map['successPolicy'] as Map).cast<String, dynamic>()),
      synchronousCallFailurePolicy: map['synchronousCallFailurePolicy'] == null ? null : EnterpriseCrmEventbusProtoFailurePolicy.fromMap((map['synchronousCallFailurePolicy'] as Map).cast<String, dynamic>()),
      taskEntity: map['taskEntity'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTaskEntity.fromMap((map['taskEntity'] as Map).cast<String, dynamic>()),
      taskExecutionStrategy: map['taskExecutionStrategy'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTaskConfigTaskExecutionStrategy.fromValue(map['taskExecutionStrategy'] as String),
      ...
      taskTemplateName: map['taskTemplateName'] == null ? null : map['taskTemplateName'] as String,
      taskType: map['taskType'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTaskConfigTaskType.fromValue(map['taskType'] as String),
    );
  }
}
