...
class EnterpriseCrmFrontendsEventbusProtoParameterEntry {
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParameterEntry.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoParameterEntry(
      dataType: map['dataType'] == null ? null : EnterpriseCrmFrontendsEventbusProtoParameterEntryDataType.fromValue(map['dataType'] as String),
      key: map['key'] == null ? null : map['key'] as String,
      value: map['value'] == null ? null : EnterpriseCrmFrontendsEventbusProtoParameterValueType.fromMap((map['value'] as Map).cast<String, dynamic>()),
    );
  }
}
