...
class AuthConfigArgs {
  ...
  factory AuthConfigArgs.fromMap(Map<String, dynamic> map) {
    return AuthConfigArgs(
      ...
      clientCertificateEncryptedPrivateKey: map['clientCertificateEncryptedPrivateKey'] == null ? null : map['clientCertificateEncryptedPrivateKey'] as String,
      clientCertificatePassphrase: map['clientCertificatePassphrase'] == null ? null : map['clientCertificatePassphrase'] as String,
      clientCertificateSslCertificate: map['clientCertificateSslCertificate'] == null ? null : map['clientCertificateSslCertificate'] as String,
      creatorEmail: map['creatorEmail'] == null ? null : map['creatorEmail'] as String,
      credentialType: map['credentialType'] == null ? null : AuthConfigCredentialType.fromValue(map['credentialType'] as String),
      decryptedCredential: map['decryptedCredential'] == null ? null : GoogleCloudIntegrationsV1alphaCredential.fromMap((map['decryptedCredential'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      encryptedCredential: map['encryptedCredential'] == null ? null : map['encryptedCredential'] as String,
      expiryNotificationDuration: map['expiryNotificationDuration'] == null ? null : (map['expiryNotificationDuration'] as List).cast<String>(),
      ...
      state: map['state'] == null ? null : AuthConfigState.fromValue(map['state'] as String),
      validTime: map['validTime'] == null ? null : map['validTime'] as String,
      visibility: map['visibility'] == null ? null : AuthConfigVisibility.fromValue(map['visibility'] as String),
    );
  }
}
