...
class AuthConfigArgs {
  ...
  AuthConfigArgs({
    ...
    AuthConfigVisibility? visibility,
       ...
       clientCertificateEncryptedPrivateKey = pulumi
           .Input.asOptionalInput<String>(clientCertificateEncryptedPrivateKey),
       ...
       encryptedCredential = pulumi.Input.asOptionalInput<String>(
         encryptedCredential,
       ),
       ...
       visibility = pulumi.Input.asOptionalInput<AuthConfigVisibility>(
         visibility,
       );
