...
class TemplatesVersionArgs {
  ...
  factory TemplatesVersionArgs.fromMap(Map<String, dynamic> map) {
    return TemplatesVersionArgs(
      databasePersistencePolicy: map['databasePersistencePolicy'] == null ? null : TemplatesVersionDatabasePersistencePolicy.fromValue(map['databasePersistencePolicy'] as String),
      ...
      parentIntegrationVersionId: map['parentIntegrationVersionId'] == null ? null : map['parentIntegrationVersionId'] as String,
      productId: map['productId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      taskConfigs: map['taskConfigs'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfig>(map['taskConfigs'], (value) => EnterpriseCrmFrontendsEventbusProtoTaskConfig.fromMap((value as Map).cast<String, dynamic>())),
      teardown: map['teardown'] == null ? null : EnterpriseCrmEventbusProtoTeardown.fromMap((map['teardown'] as Map).cast<String, dynamic>()),
      templateParameters: map['templateParameters'] == null ? null : EnterpriseCrmFrontendsEventbusProtoWorkflowParameters.fromMap((map['templateParameters'] as Map).cast<String, dynamic>()),
      triggerConfigs: map['triggerConfigs'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>(map['triggerConfigs'], (value) => EnterpriseCrmFrontendsEventbusProtoTriggerConfig.fromMap((value as Map).cast<String, dynamic>())),
