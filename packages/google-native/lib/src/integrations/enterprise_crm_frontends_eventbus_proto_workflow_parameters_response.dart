...
class EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse {
  ...
  final List<EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse> parameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parameters': pulumi.Input.encodeList<EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse(
      parameters: pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse>(map['parameters'], (value) => EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
