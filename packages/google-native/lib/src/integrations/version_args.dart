...
class VersionArgs {
    ...
    String? userLabel,
       ...
       integrationParametersInternal =
           pulumi.Input.asOptionalInput<
             EnterpriseCrmFrontendsEventbusProtoWorkflowParameters
           >(integrationParametersInternal),
       lastModifierEmail = pulumi.Input.asOptionalInput<String>(
         lastModifierEmail,
       ),
       ...
       parentTemplateId = pulumi.Input.asOptionalInput<String>(
         parentTemplateId,
       ),
       ...
       taskConfigsInternal =
           ...
           >(taskConfigsInternal),
       teardown = pulumi
           .Input.asOptionalInput<EnterpriseCrmEventbusProtoTeardown>(teardown),
       triggerConfigs =
           pulumi.Input.asOptionalInput<
    ...
    return <String, dynamic>{
      ...
      'databasePersistencePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(databasePersistencePolicy, (value) => value.value),
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      ...
      lockHolder: map['lockHolder'] == null
          ? null
          : map['lockHolder'] as String,
      newIntegration: map['newIntegration'] == null
          ? null
          : map['newIntegration'] as bool,
      ...
      triggerConfigs: map['triggerConfigs'] == null
          ? null
          : pulumi
                .Input.decodeList<GoogleCloudIntegrationsV1alphaTriggerConfig>(
              map['triggerConfigs'],
