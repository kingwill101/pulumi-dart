...
class VersionArgs {
  ...
  VersionArgs({
    ...
    List<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>? triggerConfigsInternal,
    String? userLabel,
  }) :
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      cloudLoggingDetails: map['cloudLoggingDetails'] == null ? null : GoogleCloudIntegrationsV1alphaCloudLoggingDetails.fromMap((map['cloudLoggingDetails'] as Map).cast<String, dynamic>()),
      createSampleIntegrations: map['createSampleIntegrations'] == null ? null : map['createSampleIntegrations'] as bool,
      databasePersistencePolicy: map['databasePersistencePolicy'] == null ? null : VersionDatabasePersistencePolicy.fromValue(map['databasePersistencePolicy'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      errorCatcherConfigs: map['errorCatcherConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaErrorCatcherConfig>(map['errorCatcherConfigs'], (value) => GoogleCloudIntegrationsV1alphaErrorCatcherConfig.fromMap((value as Map).cast<String, dynamic>())),
      integrationId: map['integrationId'] as String,
      integrationParameters: map['integrationParameters'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaIntegrationParameter>(map['integrationParameters'], (value) => GoogleCloudIntegrationsV1alphaIntegrationParameter.fromMap((value as Map).cast<String, dynamic>())),
      integrationParametersInternal: map['integrationParametersInternal'] == null ? null : EnterpriseCrmFrontendsEventbusProtoWorkflowParameters.fromMap((map['integrationParametersInternal'] as Map).cast<String, dynamic>()),
      lastModifierEmail: map['lastModifierEmail'] == null ? null : map['lastModifierEmail'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      lockHolder: map['lockHolder'] == null ? null : map['lockHolder'] as String,
      newIntegration: map['newIntegration'] == null ? null : map['newIntegration'] as bool,
      origin: map['origin'] == null ? null : VersionOrigin.fromValue(map['origin'] as String),
      parentTemplateId: map['parentTemplateId'] == null ? null : map['parentTemplateId'] as String,
      productId: map['productId'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      runAsServiceAccount: map['runAsServiceAccount'] == null ? null : map['runAsServiceAccount'] as String,
      snapshotNumber: map['snapshotNumber'] == null ? null : map['snapshotNumber'] as String,
      taskConfigs: map['taskConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTaskConfig>(map['taskConfigs'], (value) => GoogleCloudIntegrationsV1alphaTaskConfig.fromMap((value as Map).cast<String, dynamic>())),
      taskConfigsInternal: map['taskConfigsInternal'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfig>(map['taskConfigsInternal'], (value) => EnterpriseCrmFrontendsEventbusProtoTaskConfig.fromMap((value as Map).cast<String, dynamic>())),
      teardown: map['teardown'] == null ? null : EnterpriseCrmEventbusProtoTeardown.fromMap((map['teardown'] as Map).cast<String, dynamic>()),
      triggerConfigs: map['triggerConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTriggerConfig>(map['triggerConfigs'], (value) => GoogleCloudIntegrationsV1alphaTriggerConfig.fromMap((value as Map).cast<String, dynamic>())),
      triggerConfigsInternal: map['triggerConfigsInternal'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>(map['triggerConfigsInternal'], (value) => EnterpriseCrmFrontendsEventbusProtoTriggerConfig.fromMap((value as Map).cast<String, dynamic>())),
