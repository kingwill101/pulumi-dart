...
class EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse {
  ...
  final EnterpriseCrmFrontendsEventbusProtoRollbackStrategyResponse rollbackStrategy;
  ...
  final EnterpriseCrmEventbusProtoFailurePolicyResponse synchronousCallFailurePolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertConfigs': pulumi.Input.encodeList<EnterpriseCrmEventbusProtoTaskAlertConfigResponse, Map<String, dynamic>>(alertConfigs, (value) => value.toMap()),
  ...
  factory EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse(
      alertConfigs: pulumi.Input.decodeList<EnterpriseCrmEventbusProtoTaskAlertConfigResponse>(map['alertConfigs'], (value) => EnterpriseCrmEventbusProtoTaskAlertConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      failurePolicy: EnterpriseCrmEventbusProtoFailurePolicyResponse.fromMap((map['failurePolicy'] as Map).cast<String, dynamic>()),
      incomingEdgeCount: map['incomingEdgeCount'] as int,
      jsonValidationOption: map['jsonValidationOption'] as String,
      label: map['label'] as String,
      lastModifiedTime: map['lastModifiedTime'] as String,
      nextTasks: pulumi.Input.decodeList<EnterpriseCrmEventbusProtoNextTaskResponse>(map['nextTasks'], (value) => EnterpriseCrmEventbusProtoNextTaskResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rollbackStrategy: EnterpriseCrmFrontendsEventbusProtoRollbackStrategyResponse.fromMap((map['rollbackStrategy'] as Map).cast<String, dynamic>()),
      successPolicy: EnterpriseCrmEventbusProtoSuccessPolicyResponse.fromMap((map['successPolicy'] as Map).cast<String, dynamic>()),
      synchronousCallFailurePolicy: EnterpriseCrmEventbusProtoFailurePolicyResponse.fromMap((map['synchronousCallFailurePolicy'] as Map).cast<String, dynamic>()),
      taskEntity: EnterpriseCrmFrontendsEventbusProtoTaskEntityResponse.fromMap((map['taskEntity'] as Map).cast<String, dynamic>()),
