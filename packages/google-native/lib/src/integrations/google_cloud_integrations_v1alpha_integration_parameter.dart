  ...
  factory GoogleCloudIntegrationsV1alphaIntegrationParameter.fromMap(
    ...
    return GoogleCloudIntegrationsV1alphaIntegrationParameter(
      dataType: map['dataType'] == null
          ? null
          : GoogleCloudIntegrationsV1alphaIntegrationParameterDataType.fromValue(
      ...
      inputOutputType: map['inputOutputType'] == null
          ? null
          : GoogleCloudIntegrationsV1alphaIntegrationParameterInputOutputType.fromValue(
              map['inputOutputType'] as String,
            ),
      isTransient: map['isTransient'] == null
          ? null
          : map['isTransient'] as bool,
