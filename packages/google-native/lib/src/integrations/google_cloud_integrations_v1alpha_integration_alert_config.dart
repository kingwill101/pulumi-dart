...
class GoogleCloudIntegrationsV1alphaIntegrationAlertConfig {
  ...
  /// The type of metric.
  final GoogleCloudIntegrationsV1alphaIntegrationAlertConfigMetricType? metricType;
  ...
  final GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdType? thresholdType;
  /// The metric value, above or below which the alert should be triggered.
  final GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValue? thresholdValue;
  ...
  factory GoogleCloudIntegrationsV1alphaIntegrationAlertConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaIntegrationAlertConfig(
      ...
      alertThreshold: map['alertThreshold'] == null ? null : map['alertThreshold'] as int,
      disableAlert: map['disableAlert'] == null ? null : map['disableAlert'] as bool,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      durationThreshold: map['durationThreshold'] == null ? null : map['durationThreshold'] as String,
      metricType: map['metricType'] == null ? null : GoogleCloudIntegrationsV1alphaIntegrationAlertConfigMetricType.fromValue(map['metricType'] as String),
      onlyFinalAttempt: map['onlyFinalAttempt'] == null ? null : map['onlyFinalAttempt'] as bool,
      thresholdType: map['thresholdType'] == null ? null : GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdType.fromValue(map['thresholdType'] as String),
      thresholdValue: map['thresholdValue'] == null ? null : GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValue.fromMap((map['thresholdValue'] as Map).cast<String, dynamic>()),
    );
  }
}
