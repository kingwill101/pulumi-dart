...
class GoogleCloudIntegrationsV1alphaClientCertificate {
  ...
  /// Creates a new [GoogleCloudIntegrationsV1alphaClientCertificate].
  ...
  Map<String, dynamic> toMap() {
    ...
    final encryptedPrivateKeyValue = encryptedPrivateKey;
    if (encryptedPrivateKeyValue != null) {
      map['encryptedPrivateKey'] = encryptedPrivateKeyValue;
    }
    final passphraseValue = passphrase;
    if (passphraseValue != null) {
      map['passphrase'] = passphraseValue;
    }
    final sslCertificateValue = sslCertificate;
    if (sslCertificateValue != null) {
      map['sslCertificate'] = sslCertificateValue;
    }
    return map;
  }

  factory GoogleCloudIntegrationsV1alphaClientCertificate.fromMap(
      Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaClientCertificate(
      encryptedPrivateKey: map['encryptedPrivateKey'] == null
          ? null
          : map['encryptedPrivateKey'] as String,
      passphrase:
          map['passphrase'] == null ? null : map['passphrase'] as String,
      sslCertificate: map['sslCertificate'] == null
          ? null
          : map['sslCertificate'] as String,
    );
  }
}
