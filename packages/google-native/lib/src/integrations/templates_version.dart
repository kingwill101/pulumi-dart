  ...
  TemplatesVersion(
    ...
    this.errorCatcherConfigs =
        registerOutput<
          List<GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse>
        >('errorCatcherConfigs');
    this.integrationtemplateId = registerOutput<String>(
      'integrationtemplateId',
    );
    this.lastModifierEmail = registerOutput<String>('lastModifierEmail');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.parentIntegrationVersionId = registerOutput<String>(
    ...
    this.taskConfigs =
        registerOutput<
          List<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse>
        >('taskConfigs');
    this.teardown = registerOutput<EnterpriseCrmEventbusProtoTeardownResponse>(
      'teardown',
    );
