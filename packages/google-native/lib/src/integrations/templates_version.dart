...
class TemplatesVersion extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse>> taskConfigs;
  ...
  late final pulumi.Output<List<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse>> triggerConfigs;
  /// Auto-generated.
  ...
  TemplatesVersion(
    ...
    this.integrationtemplateId = registerOutput<String>('integrationtemplateId');
    this.lastModifierEmail = registerOutput<String>('lastModifierEmail');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.parentIntegrationVersionId = registerOutput<String>('parentIntegrationVersionId');
    this.productId = registerOutput<String>('productId');
    this.project = registerOutput<String>('project');
    this.snapshotNumber = registerOutput<String>('snapshotNumber');
    this.status = registerOutput<String>('status');
    this.taskConfigs = registerOutput<List<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse>>('taskConfigs');
    this.teardown = registerOutput<EnterpriseCrmEventbusProtoTeardownResponse>('teardown');
    this.templateParameters = registerOutput<EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse>('templateParameters');
    this.triggerConfigs = registerOutput<List<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse>>('triggerConfigs');
