...
class GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode {
  ...
  Map<String, dynamic> toMap() {
    ...
    final applyReauthPolicyValue = applyReauthPolicy;
    if (applyReauthPolicyValue != null) {
      map['applyReauthPolicy'] = applyReauthPolicyValue;
    }
    ...
    final authParamsValue = authParams;
    if (authParamsValue != null) {
      map['authParams'] = authParamsValue.toMap();
    }
