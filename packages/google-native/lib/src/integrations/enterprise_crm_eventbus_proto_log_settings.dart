...
class EnterpriseCrmEventbusProtoLogSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sanitizeOptions': ?sanitizeOptions == null ? null : sanitizeOptions!.toMap(),
      'seedPeriod': ?seedPeriod == null ? null : seedPeriod!.value,
      'seedScope': ?seedScope == null ? null : seedScope!.value,
      'shorteningLimits': ?shorteningLimits == null ? null : shorteningLimits!.toMap(),
    };
  }

  factory EnterpriseCrmEventbusProtoLogSettings.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoLogSettings(
      logFieldName: map['logFieldName'] == null ? null : map['logFieldName'] as String,
      sanitizeOptions: map['sanitizeOptions'] == null ? null : EnterpriseCrmLoggingGwsSanitizeOptions.fromMap((map['sanitizeOptions'] as Map).cast<String, dynamic>()),
      seedPeriod: map['seedPeriod'] == null ? null : EnterpriseCrmEventbusProtoLogSettingsSeedPeriod.fromValue(map['seedPeriod'] as String),
      seedScope: map['seedScope'] == null ? null : EnterpriseCrmEventbusProtoLogSettingsSeedScope.fromValue(map['seedScope'] as String),
      shorteningLimits: map['shorteningLimits'] == null ? null : EnterpriseCrmLoggingGwsFieldLimits.fromMap((map['shorteningLimits'] as Map).cast<String, dynamic>()),
    );
  }
}
