...
class GoogleCloudIntegrationsV1alphaErrorCatcherConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startErrorTasks': pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaNextTask, Map<String, dynamic>>(startErrorTasks, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudIntegrationsV1alphaErrorCatcherConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaErrorCatcherConfig(
      ...
      startErrorTasks: pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaNextTask>(map['startErrorTasks'], (value) => GoogleCloudIntegrationsV1alphaNextTask.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
