...
class BlockchainNodeArgs {
  ...
  BlockchainNodeArgs({
    ...
    String? requestId,
       ...
       blockchainType = pulumi
           .Input.asOptionalInput<BlockchainNodeBlockchainType>(blockchainType),
       ethereumDetails = pulumi.Input.asOptionalInput<EthereumDetails>(
         ethereumDetails,
       ),
    ...
    return <String, dynamic>{
      ...
      'blockchainType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(blockchainType, (value) => value.value),
      'ethereumDetails':
          ?pulumi.Input.mapOptionalInputValue<
            EthereumDetails,
            Map<String, dynamic>
  ...
  factory BlockchainNodeArgs.fromMap(Map<String, dynamic> map) {
    return BlockchainNodeArgs(
      ...
      blockchainType: map['blockchainType'] == null
          ? null
          : BlockchainNodeBlockchainType.fromValue(
      ...
      privateServiceConnectEnabled: map['privateServiceConnectEnabled'] == null
          ? null
          : map['privateServiceConnectEnabled'] as bool,
