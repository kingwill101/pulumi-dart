...
class CertificateProviderInstanceNetworksecurityV1beta1 {
  /// Plugin instance name, used to locate and load CertificateProvider instance configuration. Set to "google_cloud_private_spiffe" to use Certificate Authority Service certificate provider instance.
  final String pluginInstance;

  /// Creates a new [CertificateProviderInstanceNetworksecurityV1beta1].
  ...
  factory CertificateProviderInstanceNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return CertificateProviderInstanceNetworksecurityV1beta1(
