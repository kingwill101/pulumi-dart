...
/// {@template pulumi_networksecurity_v1_server_tls_policy_iam_binding_args_doc}
/// The set of arguments for ServerTlsPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1_server_tls_policy_iam_binding_args_doc}
class ServerTlsPolicyIamBindingArgs {
  ...
  /// Creates a new [ServerTlsPolicyIamBindingArgs].
  ...
  factory ServerTlsPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyIamBindingArgs(
