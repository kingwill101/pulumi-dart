...
/// {@template pulumi_networksecurity_v1_client_tls_policy_iam_binding_args_doc}
/// The set of arguments for ClientTlsPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1_client_tls_policy_iam_binding_args_doc}
class ClientTlsPolicyIamBindingArgs {
  ...
  /// Creates a new [ClientTlsPolicyIamBindingArgs].
  ...
  factory ClientTlsPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyIamBindingArgs(
