...
class RuleNetworksecurityV1beta1Args {
  ...
  RuleNetworksecurityV1beta1Args({
    ...
    bool? tlsInspectionEnabled,
  }) : applicationMatcher = pulumi.Input.asOptionalInput<String>(
         applicationMatcher,
       ),
       basicProfile = pulumi
           .Input.asInput<RuleBasicProfileNetworksecurityV1beta1>(basicProfile),
       ...
       tlsInspectionEnabled = pulumi.Input.asOptionalInput<bool>(
  ...
  factory RuleNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RuleNetworksecurityV1beta1Args(
      ...
      basicProfile: RuleBasicProfileNetworksecurityV1beta1.fromValue(
        map['basicProfile'] as String,
      ),
