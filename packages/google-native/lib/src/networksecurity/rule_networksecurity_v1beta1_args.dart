...
class RuleNetworksecurityV1beta1Args {
  ...
  RuleNetworksecurityV1beta1Args({
    ...
    required RuleBasicProfileNetworksecurityV1beta1 basicProfile,
    String? description,
    ...
    bool? tlsInspectionEnabled,
      ...
      basicProfile = pulumi.Input.asInput<RuleBasicProfileNetworksecurityV1beta1>(basicProfile),
  ...
  factory RuleNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RuleNetworksecurityV1beta1Args(
      applicationMatcher: map['applicationMatcher'] == null ? null : map['applicationMatcher'] as String,
      basicProfile: RuleBasicProfileNetworksecurityV1beta1.fromValue(map['basicProfile'] as String),
      description: map['description'] == null ? null : map['description'] as String,
      enabled: map['enabled'] as bool,
      gatewaySecurityPolicyId: map['gatewaySecurityPolicyId'] as String,
      gatewaySecurityPolicyRuleId: map['gatewaySecurityPolicyRuleId'] == null ? null : map['gatewaySecurityPolicyRuleId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] as String,
      priority: map['priority'] as int,
      project: map['project'] == null ? null : map['project'] as String,
      sessionMatcher: map['sessionMatcher'] as String,
      tlsInspectionEnabled: map['tlsInspectionEnabled'] == null ? null : map['tlsInspectionEnabled'] as bool,
    );
  }
}
