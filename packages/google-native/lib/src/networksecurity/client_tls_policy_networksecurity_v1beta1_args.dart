...
class ClientTlsPolicyNetworksecurityV1beta1Args {
  ...
  factory ClientTlsPolicyNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyNetworksecurityV1beta1Args(
      clientCertificate: map['clientCertificate'] == null ? null : GoogleCloudNetworksecurityV1beta1CertificateProvider.fromMap((map['clientCertificate'] as Map).cast<String, dynamic>()),
      ...
      serverValidationCa: map['serverValidationCa'] == null ? null : pulumi.Input.decodeList<ValidationCANetworksecurityV1beta1>(map['serverValidationCa'], (value) => ValidationCANetworksecurityV1beta1.fromMap((value as Map).cast<String, dynamic>())),
