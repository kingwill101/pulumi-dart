...
class MTLSPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientValidationCa': ?clientValidationCa == null ? null : pulumi.Input.encodeList<ValidationCA, Map<String, dynamic>>(clientValidationCa!, (value) => value.toMap()),
  ...
  factory MTLSPolicy.fromMap(Map<String, dynamic> map) {
    return MTLSPolicy(
      clientValidationCa: map['clientValidationCa'] == null ? null : pulumi.Input.decodeList<ValidationCA>(map['clientValidationCa'], (value) => ValidationCA.fromMap((value as Map).cast<String, dynamic>())),
      clientValidationMode: map['clientValidationMode'] == null ? null : MTLSPolicyClientValidationMode.fromValue(map['clientValidationMode'] as String),
