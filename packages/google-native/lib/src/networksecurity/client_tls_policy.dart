...
class ClientTlsPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ValidationCAResponse>> serverValidationCa;
  ...
  ClientTlsPolicy(
    ...
    this.clientCertificate = registerOutput<GoogleCloudNetworksecurityV1CertificateProviderResponse>('clientCertificate');
    ...
    this.serverValidationCa = registerOutput<List<ValidationCAResponse>>('serverValidationCa');
