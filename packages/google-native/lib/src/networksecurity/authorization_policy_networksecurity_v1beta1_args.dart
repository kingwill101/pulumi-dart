...
class AuthorizationPolicyNetworksecurityV1beta1Args {
  ...
  AuthorizationPolicyNetworksecurityV1beta1Args({
    ...
    String? name,
    String? project,
    List<RuleNetworksecurityV1beta1>? rules,
  })  : action = pulumi.Input.asInput<
            AuthorizationPolicyActionNetworksecurityV1beta1>(action),
  ...
  factory AuthorizationPolicyNetworksecurityV1beta1Args.fromMap(
    ...
    return AuthorizationPolicyNetworksecurityV1beta1Args(
      ...
      rules: map['rules'] == null
          ? null
          : pulumi.Input.decodeList<RuleNetworksecurityV1beta1>(
              map['rules'],
              (value) => RuleNetworksecurityV1beta1.fromMap(
