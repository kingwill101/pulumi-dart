...
class TlsInspectionPolicyArgs {
  ...
  factory TlsInspectionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return TlsInspectionPolicyArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : TlsInspectionPolicyMinTlsVersion.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      tlsFeatureProfile: map['tlsFeatureProfile'] == null ? null : TlsInspectionPolicyTlsFeatureProfile.fromValue(map['tlsFeatureProfile'] as String),
