...
class MTLSPolicyNetworksecurityV1beta1 {
  ...
  final MTLSPolicyClientValidationModeNetworksecurityV1beta1?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (clientValidationCaValue != null) {
      map['clientValidationCa'] = pulumi.Input.encodeList<
              ValidationCANetworksecurityV1beta1, Map<String, dynamic>>(
  ...
  factory MTLSPolicyNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return MTLSPolicyNetworksecurityV1beta1(
      ...
      clientValidationMode: map['clientValidationMode'] == null
          ? null
          : MTLSPolicyClientValidationModeNetworksecurityV1beta1.fromValue(
