...
class OrganizationAddressGroupNetworksecurityV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<OrganizationAddressGroupTypeNetworksecurityV1beta1, String>(type, (value) => value.value),
    };
  }
  ...
  factory OrganizationAddressGroupNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OrganizationAddressGroupNetworksecurityV1beta1Args(
      ...
      type: OrganizationAddressGroupTypeNetworksecurityV1beta1.fromValue(map['type'] as String),
    );
  }
}
