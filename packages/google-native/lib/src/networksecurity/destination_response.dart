...
class DestinationResponse {
  ...
  final HttpHeaderMatchResponse httpHeaderMatch;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hosts': hosts,
      'httpHeaderMatch': httpHeaderMatch.toMap(),
      'methods': methods,
      'ports': ports,
    };
  }
  ...
  factory DestinationResponse.fromMap(Map<String, dynamic> map) {
    return DestinationResponse(
      ...
      httpHeaderMatch: HttpHeaderMatchResponse.fromMap((map['httpHeaderMatch'] as Map).cast<String, dynamic>()),
