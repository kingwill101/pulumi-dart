...
import 'organization_address_group_networksecurity_v1beta1_args.dart';

/// Creates a new address group in a given project and location.
/// Auto-naming is currently not supported for this resource.
class OrganizationAddressGroupNetworksecurityV1beta1
  ...
  /// Creates a new [OrganizationAddressGroupNetworksecurityV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationAddressGroupNetworksecurityV1beta1]. {@macro pulumi_networksecurity_v1beta1_organization_address_group_networksecurity_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  OrganizationAddressGroupNetworksecurityV1beta1(
    String name, {
    OrganizationAddressGroupNetworksecurityV1beta1Args? args,
