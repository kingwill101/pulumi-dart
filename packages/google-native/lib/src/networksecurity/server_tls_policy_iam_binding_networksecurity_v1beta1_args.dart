...
/// {@template pulumi_networksecurity_v1beta1_server_tls_policy_iam_binding_networksecurity_v1beta1_args_doc}
/// The set of arguments for ServerTlsPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1beta1_server_tls_policy_iam_binding_networksecurity_v1beta1_args_doc}
class ServerTlsPolicyIamBindingNetworksecurityV1beta1Args {
  ...
  /// Creates a new [ServerTlsPolicyIamBindingNetworksecurityV1beta1Args].
  ...
  ServerTlsPolicyIamBindingNetworksecurityV1beta1Args({
    Condition? condition,
  ...
  factory ServerTlsPolicyIamBindingNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyIamBindingNetworksecurityV1beta1Args(
