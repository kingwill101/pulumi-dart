...
class GetAuthorizationPolicyNetworksecurityV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['labels'] = labels;
    map['name'] = name;
    map['rules'] = pulumi.Input.encodeList<RuleResponseNetworksecurityV1beta1,
        Map<String, dynamic>>(rules, (value) => value.toMap());
    map['updateTime'] = updateTime;
    return map;
  }

  factory GetAuthorizationPolicyNetworksecurityV1beta1Result.fromMap(
    ...
    return GetAuthorizationPolicyNetworksecurityV1beta1Result(
      ...
      rules: pulumi.Input.decodeList<RuleResponseNetworksecurityV1beta1>(
          map['rules'],
          (value) => RuleResponseNetworksecurityV1beta1.fromMap(
