...
class TlsInspectionPolicyNetworksecurityV1beta1Args {
  ...
  final pulumi.Input<TlsInspectionPolicyMinTlsVersionNetworksecurityV1beta1>? minTlsVersion;
  ...
  final pulumi.Input<TlsInspectionPolicyTlsFeatureProfileNetworksecurityV1beta1>? tlsFeatureProfile;
  ...
  TlsInspectionPolicyNetworksecurityV1beta1Args({
    ...
    String? name,
    String? project,
    TlsInspectionPolicyTlsFeatureProfileNetworksecurityV1beta1? tlsFeatureProfile,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<TlsInspectionPolicyMinTlsVersionNetworksecurityV1beta1, String>(minTlsVersion, (value) => value.value),
      'name': ?name,
      'project': ?project,
      'tlsFeatureProfile': ?pulumi.Input.mapOptionalInputValue<TlsInspectionPolicyTlsFeatureProfileNetworksecurityV1beta1, String>(tlsFeatureProfile, (value) => value.value),
  ...
  factory TlsInspectionPolicyNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TlsInspectionPolicyNetworksecurityV1beta1Args(
      ...
      customTlsFeatures: map['customTlsFeatures'] == null ? null : (map['customTlsFeatures'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      excludePublicCaSet: map['excludePublicCaSet'] == null ? null : map['excludePublicCaSet'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      minTlsVersion: map['minTlsVersion'] == null ? null : TlsInspectionPolicyMinTlsVersionNetworksecurityV1beta1.fromValue(map['minTlsVersion'] as String),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      tlsFeatureProfile: map['tlsFeatureProfile'] == null ? null : TlsInspectionPolicyTlsFeatureProfileNetworksecurityV1beta1.fromValue(map['tlsFeatureProfile'] as String),
