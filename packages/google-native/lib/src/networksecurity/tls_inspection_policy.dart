...
class TlsInspectionPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [TlsInspectionPolicy]. {@macro pulumi_networksecurity_v1_tls_inspection_policy_args_doc}
  ...
  TlsInspectionPolicy(
    ...
    this.tlsInspectionPolicyId = registerOutput<String>('tlsInspectionPolicyId');
