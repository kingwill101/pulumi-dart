...
class ServerTlsPolicyNetworksecurityV1beta1Args {
  ...
  ServerTlsPolicyNetworksecurityV1beta1Args({
    ...
    String? location,
    MTLSPolicyNetworksecurityV1beta1? mtlsPolicy,
    String? name,
    String? project,
  ...
  factory ServerTlsPolicyNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyNetworksecurityV1beta1Args(
      ...
      mtlsPolicy: map['mtlsPolicy'] == null ? null : MTLSPolicyNetworksecurityV1beta1.fromMap((map['mtlsPolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      serverCertificate: map['serverCertificate'] == null ? null : GoogleCloudNetworksecurityV1beta1CertificateProvider.fromMap((map['serverCertificate'] as Map).cast<String, dynamic>()),
