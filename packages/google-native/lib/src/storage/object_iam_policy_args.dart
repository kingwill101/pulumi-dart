...
class ObjectIamPolicyArgs {
  ...
  factory ObjectIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ObjectIamPolicyArgs(
      bindings: map['bindings'] == null ? null : pulumi.Input.decodeList<ObjectIamPolicyBindingsItem>(map['bindings'], (value) => ObjectIamPolicyBindingsItem.fromMap((value as Map).cast<String, dynamic>())),
