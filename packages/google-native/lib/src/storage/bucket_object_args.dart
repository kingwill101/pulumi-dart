...
class BucketObjectArgs {
  ...
  BucketObjectArgs({
    ...
    String? updated,
    String? userProject,
  }) : acl = pulumi.Input.asOptionalInput<List<ObjectAccessControlStorageV1>>(
         acl,
       ),
       ...
       retentionExpirationTime = pulumi.Input.asOptionalInput<String>(
       ...
       timeStorageClassUpdated = pulumi.Input.asOptionalInput<String>(
  ...
  factory BucketObjectArgs.fromMap(Map<String, dynamic> map) {
    return BucketObjectArgs(
      acl: map['acl'] == null
          ? null
          : (map['acl'] as List).cast<ObjectAccessControlStorageV1>(),
      bucket: map['bucket'] as String,
      cacheControl: map['cacheControl'] == null
          ? null
          : map['cacheControl'] as String,
      componentCount: map['componentCount'] == null
          ? null
          : map['componentCount'] as int,
      ...
      timeDeleted: map['timeDeleted'] == null
          ? null
          : map['timeDeleted'] as String,
