...
class BucketObjectArgs {
  ...
  BucketObjectArgs({
    List<ObjectAccessControlStorageV1>? acl,
  ...
  factory BucketObjectArgs.fromMap(Map<String, dynamic> map) {
    return BucketObjectArgs(
      acl: map['acl'] == null ? null : (map['acl'] as List).cast<ObjectAccessControlStorageV1>(),
      bucket: map['bucket'] as String,
      cacheControl: map['cacheControl'] == null ? null : map['cacheControl'] as String,
      componentCount: map['componentCount'] == null ? null : map['componentCount'] as int,
      ...
      customerEncryption: map['customerEncryption'] == null ? null : BucketObjectCustomerEncryption.fromMap((map['customerEncryption'] as Map).cast<String, dynamic>()),
      etag: map['etag'] == null ? null : map['etag'] as String,
      eventBasedHold: map['eventBasedHold'] == null ? null : map['eventBasedHold'] as bool,
      generation: map['generation'] == null ? null : map['generation'] as String,
      hardDeleteTime: map['hardDeleteTime'] == null ? null : map['hardDeleteTime'] as String,
      ...
      owner: map['owner'] == null ? null : BucketObjectOwner.fromMap((map['owner'] as Map).cast<String, dynamic>()),
      ...
      retention: map['retention'] == null ? null : BucketObjectRetention.fromMap((map['retention'] as Map).cast<String, dynamic>()),
      retentionExpirationTime: map['retentionExpirationTime'] == null ? null : map['retentionExpirationTime'] as String,
      selfLink: map['selfLink'] == null ? null : map['selfLink'] as String,
      size: map['size'] == null ? null : map['size'] as String,
      softDeleteTime: map['softDeleteTime'] == null ? null : map['softDeleteTime'] as String,
      source: map['source'] == null ? null : map['source'],
      storageClass: map['storageClass'] == null ? null : map['storageClass'] as String,
      temporaryHold: map['temporaryHold'] == null ? null : map['temporaryHold'] as bool,
      timeCreated: map['timeCreated'] == null ? null : map['timeCreated'] as String,
      timeDeleted: map['timeDeleted'] == null ? null : map['timeDeleted'] as String,
      timeStorageClassUpdated: map['timeStorageClassUpdated'] == null ? null : map['timeStorageClassUpdated'] as String,
