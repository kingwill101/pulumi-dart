...
class ManagedFolderIamPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ManagedFolderIamPolicyBindingsItemResponse>> bindings;
  ...
  ManagedFolderIamPolicy(
    ...
    this.bindings = registerOutput<List<ManagedFolderIamPolicyBindingsItemResponse>>('bindings');
