...
class BucketArgs {
  ...
  factory BucketArgs.fromMap(Map<String, dynamic> map) {
    return BucketArgs(
      acl: map['acl'] == null ? null : (map['acl'] as List).cast<BucketAccessControlStorageV1>(),
      autoclass: map['autoclass'] == null ? null : BucketAutoclass.fromMap((map['autoclass'] as Map).cast<String, dynamic>()),
      billing: map['billing'] == null ? null : BucketBilling.fromMap((map['billing'] as Map).cast<String, dynamic>()),
      cors: map['cors'] == null ? null : pulumi.Input.decodeList<BucketCorsItem>(map['cors'], (value) => BucketCorsItem.fromMap((value as Map).cast<String, dynamic>())),
      ...
      defaultObjectAcl: map['defaultObjectAcl'] == null ? null : (map['defaultObjectAcl'] as List).cast<ObjectAccessControlStorageV1>(),
      ...
      iamConfiguration: map['iamConfiguration'] == null ? null : BucketIamConfiguration.fromMap((map['iamConfiguration'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      kind: map['kind'] == null ? null : map['kind'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      lifecycle: map['lifecycle'] == null ? null : BucketLifecycle.fromMap((map['lifecycle'] as Map).cast<String, dynamic>()),
      ...
      objectRetention: map['objectRetention'] == null ? null : BucketObjectRetention.fromMap((map['objectRetention'] as Map).cast<String, dynamic>()),
      owner: map['owner'] == null ? null : BucketOwner.fromMap((map['owner'] as Map).cast<String, dynamic>()),
      predefinedAcl: map['predefinedAcl'] == null ? null : map['predefinedAcl'] as String,
      predefinedDefaultObjectAcl: map['predefinedDefaultObjectAcl'] == null ? null : map['predefinedDefaultObjectAcl'] as String,
