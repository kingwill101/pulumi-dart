...
class BucketArgs {
  ...
  BucketArgs({
    ...
    BucketWebsite? website,
  })  : acl = pulumi.Input.asOptionalInput<List<BucketAccessControl>>(acl),
        ...
        defaultObjectAcl =
            pulumi.Input.asOptionalInput<List<ObjectAccessControl>>(
                defaultObjectAcl),
        ...
        predefinedDefaultObjectAcl =
            pulumi.Input.asOptionalInput<String>(predefinedDefaultObjectAcl),
  ...
  factory BucketArgs.fromMap(Map<String, dynamic> map) {
    return BucketArgs(
      acl: map['acl'] == null
          ? null
          : pulumi.Input.decodeList<BucketAccessControl>(
              map['acl'],
              (value) => BucketAccessControl.fromMap(
