...
/// {@template pulumi_storage_v1_object_iam_binding_args_doc}
/// The set of arguments for ObjectIamBinding.
/// {@endtemplate}
/// {@macro pulumi_storage_v1_object_iam_binding_args_doc}
class ObjectIamBindingArgs {
  ...
  /// Creates a new [ObjectIamBindingArgs].
  ...
  factory ObjectIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ObjectIamBindingArgs(
