...
class Bucket extends pulumi.CustomResource {
  ...
  Bucket(String name, {BucketArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.defaultObjectAcl = registerOutput<List<ObjectAccessControlResponse>>(
      'defaultObjectAcl',
    );
    ...
    this.iamConfiguration = registerOutput<BucketIamConfigurationResponse>(
      'iamConfiguration',
    );
