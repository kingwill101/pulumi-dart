...
class Bucket extends pulumi.CustomResource {
  ...
  Bucket(
    ...
    this.customPlacementConfig = registerOutput<BucketCustomPlacementConfigResponse>('customPlacementConfig');
    this.defaultEventBasedHold = registerOutput<bool>('defaultEventBasedHold');
    this.defaultObjectAcl = registerOutput<List<ObjectAccessControlResponse>>('defaultObjectAcl');
    ...
    this.iamConfiguration = registerOutput<BucketIamConfigurationResponse>('iamConfiguration');
    ...
    this.objectRetention = registerOutput<BucketObjectRetentionResponse>('objectRetention');
    this.owner = registerOutput<BucketOwnerResponse>('owner');
    this.predefinedAcl = registerOutput<String?>('predefinedAcl');
    this.predefinedDefaultObjectAcl = registerOutput<String?>('predefinedDefaultObjectAcl');
    this.project = registerOutput<String>('project');
    this.projectNumber = registerOutput<String>('projectNumber');
    this.projection = registerOutput<String?>('projection');
    this.retentionPolicy = registerOutput<BucketRetentionPolicyResponse>('retentionPolicy');
    this.rpo = registerOutput<String>('rpo');
    this.satisfiesPZS = registerOutput<bool>('satisfiesPZS');
    this.selfLink = registerOutput<String>('selfLink');
    this.softDeletePolicy = registerOutput<BucketSoftDeletePolicyResponse>('softDeletePolicy');
