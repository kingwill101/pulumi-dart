...
class GetBucketObjectArgs {
  ...
  GetBucketObjectArgs({
    ...
    String? userProject,
       ...
       ifGenerationMatch = pulumi.Input.asOptionalInput<String>(
         ifGenerationMatch,
       ),
       ifGenerationNotMatch = pulumi.Input.asOptionalInput<String>(
  ...
  factory GetBucketObjectArgs.fromMap(Map<String, dynamic> map) {
    return GetBucketObjectArgs(
      ...
      softDeleted: map['softDeleted'] == null
          ? null
          : map['softDeleted'] as bool,
