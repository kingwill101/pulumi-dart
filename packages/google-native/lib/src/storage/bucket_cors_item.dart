...
class BucketCorsItem {
  ...
  factory BucketCorsItem.fromMap(Map<String, dynamic> map) {
    return BucketCorsItem(
      ...
      method: map['method'] == null ? null : (map['method'] as List).cast<String>(),
      origin: map['origin'] == null ? null : (map['origin'] as List).cast<String>(),
      responseHeader: map['responseHeader'] == null ? null : (map['responseHeader'] as List).cast<String>(),
    );
  }
}
