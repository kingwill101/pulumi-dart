...
class GetBucketResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['acl'] = pulumi.Input.encodeList<BucketAccessControlResponse,
        Map<String, dynamic>>(acl, (value) => value.toMap());
    map['autoclass'] = autoclass.toMap();
    map['billing'] = billing.toMap();
    map['cors'] =
        pulumi.Input.encodeList<BucketCorsItemResponse, Map<String, dynamic>>(
    ...
    map['defaultObjectAcl'] = pulumi.Input.encodeList<
        ObjectAccessControlResponse,
        Map<String, dynamic>>(defaultObjectAcl, (value) => value.toMap());
  ...
  factory GetBucketResult.fromMap(Map<String, dynamic> map) {
    return GetBucketResult(
      acl: pulumi.Input.decodeList<BucketAccessControlResponse>(
          map['acl'],
      ...
      cors: pulumi.Input.decodeList<BucketCorsItemResponse>(
          map['cors'],
      ...
      defaultObjectAcl: pulumi.Input.decodeList<ObjectAccessControlResponse>(
