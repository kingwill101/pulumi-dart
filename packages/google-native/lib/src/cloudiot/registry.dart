...
class Registry extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EventNotificationConfigResponse>>
  ...
  late final pulumi.Output<StateNotificationConfigResponse>
  ...
  Registry(
    ...
    this.credentials = registerOutput<List<RegistryCredentialResponse>>(
      'credentials',
    );
