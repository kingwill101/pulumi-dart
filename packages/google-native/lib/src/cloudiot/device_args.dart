...
class DeviceArgs {
  ...
  factory DeviceArgs.fromMap(Map<String, dynamic> map) {
    return DeviceArgs(
      ...
      config: map['config'] == null ? null : DeviceConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      credentials: map['credentials'] == null ? null : pulumi.Input.decodeList<DeviceCredential>(map['credentials'], (value) => DeviceCredential.fromMap((value as Map).cast<String, dynamic>())),
      gatewayConfig: map['gatewayConfig'] == null ? null : GatewayConfig.fromMap((map['gatewayConfig'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      logLevel: map['logLevel'] == null ? null : DeviceLogLevel.fromValue(map['logLevel'] as String),
