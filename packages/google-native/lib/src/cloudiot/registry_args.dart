...
class RegistryArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'location': ?location,
      'logLevel': ?pulumi.Input.mapOptionalInputValue<RegistryLogLevel, String>(logLevel, (value) => value.value),
  ...
  factory RegistryArgs.fromMap(Map<String, dynamic> map) {
    return RegistryArgs(
      credentials: map['credentials'] == null ? null : pulumi.Input.decodeList<RegistryCredential>(map['credentials'], (value) => RegistryCredential.fromMap((value as Map).cast<String, dynamic>())),
      eventNotificationConfigs: map['eventNotificationConfigs'] == null ? null : pulumi.Input.decodeList<EventNotificationConfig>(map['eventNotificationConfigs'], (value) => EventNotificationConfig.fromMap((value as Map).cast<String, dynamic>())),
      httpConfig: map['httpConfig'] == null ? null : HttpConfig.fromMap((map['httpConfig'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      logLevel: map['logLevel'] == null ? null : RegistryLogLevel.fromValue(map['logLevel'] as String),
      mqttConfig: map['mqttConfig'] == null ? null : MqttConfig.fromMap((map['mqttConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      stateNotificationConfig: map['stateNotificationConfig'] == null ? null : StateNotificationConfig.fromMap((map['stateNotificationConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
