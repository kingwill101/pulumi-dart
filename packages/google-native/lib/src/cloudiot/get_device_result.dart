...
class GetDeviceResult {
  ...
  final StatusResponse lastErrorStatus;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blocked': blocked,
      'config': config.toMap(),
      'credentials': pulumi.Input.encodeList<DeviceCredentialResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'gatewayConfig': gatewayConfig.toMap(),
      'lastConfigAckTime': lastConfigAckTime,
      'lastConfigSendTime': lastConfigSendTime,
      'lastErrorStatus': lastErrorStatus.toMap(),
  ...
  factory GetDeviceResult.fromMap(Map<String, dynamic> map) {
    return GetDeviceResult(
      ...
      config: DeviceConfigResponse.fromMap((map['config'] as Map).cast<String, dynamic>()),
      credentials: pulumi.Input.decodeList<DeviceCredentialResponse>(map['credentials'], (value) => DeviceCredentialResponse.fromMap((value as Map).cast<String, dynamic>())),
      gatewayConfig: GatewayConfigResponse.fromMap((map['gatewayConfig'] as Map).cast<String, dynamic>()),
      lastConfigAckTime: map['lastConfigAckTime'] as String,
      lastConfigSendTime: map['lastConfigSendTime'] as String,
      lastErrorStatus: StatusResponse.fromMap((map['lastErrorStatus'] as Map).cast<String, dynamic>()),
      ...
      state: DeviceStateResponse.fromMap((map['state'] as Map).cast<String, dynamic>()),
    );
  }
}
