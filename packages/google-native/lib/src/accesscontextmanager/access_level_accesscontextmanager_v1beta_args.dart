...
class AccessLevelAccesscontextmanagerV1betaArgs {
  ...
  factory AccessLevelAccesscontextmanagerV1betaArgs.fromMap(Map<String, dynamic> map) {
    return AccessLevelAccesscontextmanagerV1betaArgs(
      ...
      basic: map['basic'] == null ? null : BasicLevelAccesscontextmanagerV1beta.fromMap((map['basic'] as Map).cast<String, dynamic>()),
      custom: map['custom'] == null ? null : CustomLevelAccesscontextmanagerV1beta.fromMap((map['custom'] as Map).cast<String, dynamic>()),
