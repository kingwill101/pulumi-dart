...
class AccessLevelAccesscontextmanagerV1beta extends pulumi.CustomResource {
  ...
  AccessLevelAccesscontextmanagerV1beta(
    ...
    this.basic = registerOutput<BasicLevelResponseAccesscontextmanagerV1beta>('basic');
    this.custom = registerOutput<CustomLevelResponseAccesscontextmanagerV1beta>('custom');
