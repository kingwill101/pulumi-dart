...
class Condition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vpcNetworkSources': ?vpcNetworkSources == null ? null : pulumi.Input.encodeList<VpcNetworkSource, Map<String, dynamic>>(vpcNetworkSources!, (value) => value.toMap()),
    };
  }

  factory Condition.fromMap(Map<String, dynamic> map) {
    return Condition(
      devicePolicy: map['devicePolicy'] == null ? null : DevicePolicy.fromMap((map['devicePolicy'] as Map).cast<String, dynamic>()),
      ...
      vpcNetworkSources: map['vpcNetworkSources'] == null ? null : pulumi.Input.decodeList<VpcNetworkSource>(map['vpcNetworkSources'], (value) => VpcNetworkSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
