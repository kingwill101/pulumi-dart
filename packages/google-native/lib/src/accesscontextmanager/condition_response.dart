...
class ConditionResponse {
  ...
  final DevicePolicyResponse devicePolicy;
  ...
  final List<VpcNetworkSourceResponse> vpcNetworkSources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'devicePolicy': devicePolicy.toMap(),
  ...
  factory ConditionResponse.fromMap(Map<String, dynamic> map) {
    return ConditionResponse(
      devicePolicy: DevicePolicyResponse.fromMap(
      ...
      requiredAccessLevels: (map['requiredAccessLevels'] as List)
          .cast<String>(),
