...
class DevicePolicyAccesscontextmanagerV1beta {
  ...
  final List<DevicePolicyAllowedDeviceManagementLevelsItemAccesscontextmanagerV1beta>? allowedDeviceManagementLevels;
  /// Allowed encryptions statuses, an empty list allows all statuses.
  final List<DevicePolicyAllowedEncryptionStatusesItemAccesscontextmanagerV1beta>? allowedEncryptionStatuses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedDeviceManagementLevels': ?allowedDeviceManagementLevels == null ? null : pulumi.Input.encodeList<DevicePolicyAllowedDeviceManagementLevelsItemAccesscontextmanagerV1beta, String>(allowedDeviceManagementLevels!, (value) => value.value),
      'allowedEncryptionStatuses': ?allowedEncryptionStatuses == null ? null : pulumi.Input.encodeList<DevicePolicyAllowedEncryptionStatusesItemAccesscontextmanagerV1beta, String>(allowedEncryptionStatuses!, (value) => value.value),
      'osConstraints': ?osConstraints == null ? null : pulumi.Input.encodeList<OsConstraintAccesscontextmanagerV1beta, Map<String, dynamic>>(osConstraints!, (value) => value.toMap()),
  ...
  factory DevicePolicyAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return DevicePolicyAccesscontextmanagerV1beta(
      ...
      allowedEncryptionStatuses: map['allowedEncryptionStatuses'] == null ? null : pulumi.Input.decodeList<DevicePolicyAllowedEncryptionStatusesItemAccesscontextmanagerV1beta>(map['allowedEncryptionStatuses'], (value) => DevicePolicyAllowedEncryptionStatusesItemAccesscontextmanagerV1beta.fromValue(value as String)),
      osConstraints: map['osConstraints'] == null ? null : pulumi.Input.decodeList<OsConstraintAccesscontextmanagerV1beta>(map['osConstraints'], (value) => OsConstraintAccesscontextmanagerV1beta.fromMap((value as Map).cast<String, dynamic>())),
