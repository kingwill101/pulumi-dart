...
class AccessLevelArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (customValue != null) {
      map['custom'] =
          pulumi.Input.mapOptionalInputValue<CustomLevel, Map<String, dynamic>>(
  ...
  factory AccessLevelArgs.fromMap(Map<String, dynamic> map) {
    return AccessLevelArgs(
      ...
      basic: map['basic'] == null
          ? null
          : BasicLevel.fromMap((map['basic'] as Map).cast<String, dynamic>()),
      custom: map['custom'] == null
          ? null
          : CustomLevel.fromMap((map['custom'] as Map).cast<String, dynamic>()),
      description:
