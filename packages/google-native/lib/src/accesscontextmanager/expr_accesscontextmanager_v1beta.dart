...
class ExprAccesscontextmanagerV1beta {
  ...
  /// Creates a new [ExprAccesscontextmanagerV1beta].
  ...
  factory ExprAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return ExprAccesscontextmanagerV1beta(
