...
class ResponsePolicyRuleArgs {
  ...
  factory ResponsePolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return ResponsePolicyRuleArgs(
      behavior: map['behavior'] == null ? null : ResponsePolicyRuleBehaviorDnsV1beta2.fromValue(map['behavior'] as String),
      ...
      localData: map['localData'] == null ? null : ResponsePolicyRuleLocalDataDnsV1beta2.fromMap((map['localData'] as Map).cast<String, dynamic>()),
