...
class RRSetRoutingPolicyPrimaryBackupPolicyResponseDnsV1beta2 {
  ...
  factory RRSetRoutingPolicyPrimaryBackupPolicyResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyPrimaryBackupPolicyResponseDnsV1beta2(
      backupGeoTargets: RRSetRoutingPolicyGeoPolicyResponseDnsV1beta2.fromMap((map['backupGeoTargets'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      primaryTargets: RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2.fromMap((map['primaryTargets'] as Map).cast<String, dynamic>()),
