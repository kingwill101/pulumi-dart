  ...
  factory PolicyDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return PolicyDnsV1beta2Args(
      alternativeNameServerConfig: map['alternativeNameServerConfig'] == null
          ? null
          : PolicyAlternativeNameServerConfigDnsV1beta2.fromMap(
      ...
      networks: map['networks'] == null
          ? null
          : pulumi.Input.decodeList<PolicyNetworkDnsV1beta2>(
              map['networks'],
              (value) => PolicyNetworkDnsV1beta2.fromMap(
