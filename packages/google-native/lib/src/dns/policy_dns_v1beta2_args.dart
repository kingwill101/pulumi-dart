...
class PolicyDnsV1beta2Args {
  ...
  PolicyDnsV1beta2Args({
    PolicyAlternativeNameServerConfigDnsV1beta2? alternativeNameServerConfig,
    ...
    String? kind,
    String? name,
    List<PolicyNetworkDnsV1beta2>? networks,
    String? project,
  }) :
      alternativeNameServerConfig = pulumi.Input.asOptionalInput<PolicyAlternativeNameServerConfigDnsV1beta2>(alternativeNameServerConfig),
      ...
      networks = pulumi.Input.asOptionalInput<List<PolicyNetworkDnsV1beta2>>(networks),
  ...
  factory PolicyDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return PolicyDnsV1beta2Args(
      alternativeNameServerConfig: map['alternativeNameServerConfig'] == null ? null : PolicyAlternativeNameServerConfigDnsV1beta2.fromMap((map['alternativeNameServerConfig'] as Map).cast<String, dynamic>()),
      ...
      networks: map['networks'] == null ? null : pulumi.Input.decodeList<PolicyNetworkDnsV1beta2>(map['networks'], (value) => PolicyNetworkDnsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
