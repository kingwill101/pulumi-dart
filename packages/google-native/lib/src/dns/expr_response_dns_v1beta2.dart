...
class ExprResponseDnsV1beta2 {
  ...
  /// Creates a new [ExprResponseDnsV1beta2].
  ...
  factory ExprResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return ExprResponseDnsV1beta2(
