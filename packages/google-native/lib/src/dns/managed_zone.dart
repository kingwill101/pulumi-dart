...
class ManagedZone extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ManagedZoneCloudLoggingConfigResponse>
  cloudLoggingConfig;
  ...
  late final pulumi.Output<ManagedZoneForwardingConfigResponse>
  forwardingConfig;
  ...
  late final pulumi.Output<ManagedZonePrivateVisibilityConfigResponse>
  privateVisibilityConfig;
  late final pulumi.Output<String> project;

  /// The presence of this field indicates that this is a managed reverse lookup zone and Cloud DNS resolves reverse lookup queries using automatically configured records for VPC resources. This only applies to networks listed under private_visibility_config.
  late final pulumi.Output<ManagedZoneReverseLookupConfigResponse>
  reverseLookupConfig;

  /// This field links to the associated service directory namespace. Do not set this field for public zones or forwarding zones.
  late final pulumi.Output<ManagedZoneServiceDirectoryConfigResponse>
  ...
  ManagedZone(
    ...
    this.dnssecConfig = registerOutput<ManagedZoneDnsSecConfigResponse>(
      'dnssecConfig',
    );
    this.forwardingConfig = registerOutput<ManagedZoneForwardingConfigResponse>(
      'forwardingConfig',
    );
    ...
    this.peeringConfig = registerOutput<ManagedZonePeeringConfigResponse>(
      'peeringConfig',
    );
