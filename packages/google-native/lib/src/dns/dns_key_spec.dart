...
class DnsKeySpec {
  ...
  factory DnsKeySpec.fromMap(Map<String, dynamic> map) {
    return DnsKeySpec(
      algorithm: map['algorithm'] == null ? null : DnsKeySpecAlgorithm.fromValue(map['algorithm'] as String),
      keyLength: map['keyLength'] == null ? null : map['keyLength'] as int,
      keyType: map['keyType'] == null ? null : DnsKeySpecKeyType.fromValue(map['keyType'] as String),
