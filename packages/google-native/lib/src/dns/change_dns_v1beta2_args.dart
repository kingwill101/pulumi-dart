...
class ChangeDnsV1beta2Args {
  ...
  factory ChangeDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ChangeDnsV1beta2Args(
      additions: map['additions'] == null ? null : (map['additions'] as List).cast<ResourceRecordSetResource>(),
      clientOperationId: map['clientOperationId'] == null ? null : map['clientOperationId'] as String,
      deletions: map['deletions'] == null ? null : (map['deletions'] as List).cast<ResourceRecordSetResource>(),
