...
class ResponsePolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResponsePolicyGKEClusterResponseDnsV1beta2>>
  gkeClusters;
  ...
  late final pulumi.Output<List<ResponsePolicyNetworkResponseDnsV1beta2>>
  networks;
  ...
  ResponsePolicy(
    ...
    this.gkeClusters =
        registerOutput<List<ResponsePolicyGKEClusterResponseDnsV1beta2>>(
          'gkeClusters',
        );
    this.kind = registerOutput<String>('kind');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.networks =
        registerOutput<List<ResponsePolicyNetworkResponseDnsV1beta2>>(
          'networks',
        );
