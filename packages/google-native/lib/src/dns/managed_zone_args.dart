...
class ManagedZoneArgs {
  ...
  factory ManagedZoneArgs.fromMap(Map<String, dynamic> map) {
    return ManagedZoneArgs(
      ...
      reverseLookupConfig: map['reverseLookupConfig'] == null ? null : ManagedZoneReverseLookupConfig.fromMap((map['reverseLookupConfig'] as Map).cast<String, dynamic>()),
      ...
      visibility: map['visibility'] == null ? null : ManagedZoneVisibility.fromValue(map['visibility'] as String),
    );
  }
}
