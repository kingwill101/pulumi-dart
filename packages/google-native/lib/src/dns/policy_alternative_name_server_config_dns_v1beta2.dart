...
class PolicyAlternativeNameServerConfigDnsV1beta2 {
  ...
  final List<PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2>? targetNameServers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'kind': ?kind,
      'targetNameServers': ?targetNameServers == null ? null : pulumi.Input.encodeList<PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2, Map<String, dynamic>>(targetNameServers!, (value) => value.toMap()),
    };
  }
  ...
  factory PolicyAlternativeNameServerConfigDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return PolicyAlternativeNameServerConfigDnsV1beta2(
      ...
      targetNameServers: map['targetNameServers'] == null ? null : pulumi.Input.decodeList<PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2>(map['targetNameServers'], (value) => PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
