...
class ManagedZoneDnsV1beta2Args {
  ...
  ManagedZoneDnsV1beta2Args({
    ...
    ManagedZoneVisibilityDnsV1beta2? visibility,
        ...
        cloudLoggingConfig = pulumi.Input.asOptionalInput<
            ManagedZoneCloudLoggingConfigDnsV1beta2>(cloudLoggingConfig),
        ...
        serviceDirectoryConfig = pulumi.Input.asOptionalInput<
            ...
            serviceDirectoryConfig),
        visibility =
            pulumi.Input.asOptionalInput<ManagedZoneVisibilityDnsV1beta2>(
                visibility);
  ...
  factory ManagedZoneDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ManagedZoneDnsV1beta2Args(
      ...
      creationTime:
          map['creationTime'] == null ? null : map['creationTime'] as String,
      description:
      ...
      nameServerSet:
          map['nameServerSet'] == null ? null : map['nameServerSet'] as String,
