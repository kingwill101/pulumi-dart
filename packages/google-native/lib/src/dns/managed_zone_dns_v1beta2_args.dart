...
class ManagedZoneDnsV1beta2Args {
  ...
  ManagedZoneDnsV1beta2Args({
    ...
    ManagedZoneVisibilityDnsV1beta2? visibility,
      ...
      cloudLoggingConfig = pulumi.Input.asOptionalInput<ManagedZoneCloudLoggingConfigDnsV1beta2>(cloudLoggingConfig),
      ...
      dnssecConfig = pulumi.Input.asOptionalInput<ManagedZoneDnsSecConfigDnsV1beta2>(dnssecConfig),
      forwardingConfig = pulumi.Input.asOptionalInput<ManagedZoneForwardingConfigDnsV1beta2>(forwardingConfig),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      name = pulumi.Input.asOptionalInput<String>(name),
      nameServerSet = pulumi.Input.asOptionalInput<String>(nameServerSet),
      peeringConfig = pulumi.Input.asOptionalInput<ManagedZonePeeringConfigDnsV1beta2>(peeringConfig),
      privateVisibilityConfig = pulumi.Input.asOptionalInput<ManagedZonePrivateVisibilityConfigDnsV1beta2>(privateVisibilityConfig),
      project = pulumi.Input.asOptionalInput<String>(project),
      reverseLookupConfig = pulumi.Input.asOptionalInput<ManagedZoneReverseLookupConfigDnsV1beta2>(reverseLookupConfig),
      serviceDirectoryConfig = pulumi.Input.asOptionalInput<ManagedZoneServiceDirectoryConfigDnsV1beta2>(serviceDirectoryConfig),
      visibility = pulumi.Input.asOptionalInput<ManagedZoneVisibilityDnsV1beta2>(visibility);
  ...
  factory ManagedZoneDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ManagedZoneDnsV1beta2Args(
      ...
      cloudLoggingConfig: map['cloudLoggingConfig'] == null ? null : ManagedZoneCloudLoggingConfigDnsV1beta2.fromMap((map['cloudLoggingConfig'] as Map).cast<String, dynamic>()),
      ...
      dnssecConfig: map['dnssecConfig'] == null ? null : ManagedZoneDnsSecConfigDnsV1beta2.fromMap((map['dnssecConfig'] as Map).cast<String, dynamic>()),
      forwardingConfig: map['forwardingConfig'] == null ? null : ManagedZoneForwardingConfigDnsV1beta2.fromMap((map['forwardingConfig'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      nameServerSet: map['nameServerSet'] == null ? null : map['nameServerSet'] as String,
      peeringConfig: map['peeringConfig'] == null ? null : ManagedZonePeeringConfigDnsV1beta2.fromMap((map['peeringConfig'] as Map).cast<String, dynamic>()),
      privateVisibilityConfig: map['privateVisibilityConfig'] == null ? null : ManagedZonePrivateVisibilityConfigDnsV1beta2.fromMap((map['privateVisibilityConfig'] as Map).cast<String, dynamic>()),
      project: map['project'] == null ? null : map['project'] as String,
      reverseLookupConfig: map['reverseLookupConfig'] == null ? null : ManagedZoneReverseLookupConfigDnsV1beta2.fromMap((map['reverseLookupConfig'] as Map).cast<String, dynamic>()),
      serviceDirectoryConfig: map['serviceDirectoryConfig'] == null ? null : ManagedZoneServiceDirectoryConfigDnsV1beta2.fromMap((map['serviceDirectoryConfig'] as Map).cast<String, dynamic>()),
      visibility: map['visibility'] == null ? null : ManagedZoneVisibilityDnsV1beta2.fromValue(map['visibility'] as String),
    );
  }
}
