...
class ManagedZoneIamPolicyDnsV1beta2Args {
  ...
  ManagedZoneIamPolicyDnsV1beta2Args({
    ...
    int? version,
           ...
           pulumi.Input.asOptionalInput<List<GoogleIamV1AuditConfigDnsV1beta2>>(
             auditConfigs,
           ),
       bindings = pulumi
           .Input.asOptionalInput<List<GoogleIamV1BindingDnsV1beta2>>(bindings),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bindings':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleIamV1BindingDnsV1beta2>,
            List<Map<String, dynamic>>
          >(
            bindings,
            (value) =>
                pulumi.Input.encodeList<
                  GoogleIamV1BindingDnsV1beta2,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'etag': ?etag,
