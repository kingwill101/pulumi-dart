...
class ManagedZoneIamPolicyDnsV1beta2Args {
  ...
  ManagedZoneIamPolicyDnsV1beta2Args({
    ...
    int? version,
            ...
            List<GoogleIamV1AuditConfigDnsV1beta2>>(auditConfigs),
        bindings =
            pulumi.Input.asOptionalInput<List<GoogleIamV1BindingDnsV1beta2>>(
                bindings),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (auditConfigsValue != null) {
      map['auditConfigs'] = pulumi.Input.mapOptionalInputValue<
              List<GoogleIamV1AuditConfigDnsV1beta2>,
              List<Map<String, dynamic>>>(
          auditConfigsValue,
          (value) => pulumi.Input.encodeList<GoogleIamV1AuditConfigDnsV1beta2,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final bindingsValue = bindings;
    if (bindingsValue != null) {
      map['bindings'] = pulumi.Input.mapOptionalInputValue<
              List<GoogleIamV1BindingDnsV1beta2>, List<Map<String, dynamic>>>(
          bindingsValue,
          (value) => pulumi.Input.encodeList<GoogleIamV1BindingDnsV1beta2,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory ManagedZoneIamPolicyDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ManagedZoneIamPolicyDnsV1beta2Args(
      auditConfigs: map['auditConfigs'] == null
          ? null
          : pulumi.Input.decodeList<GoogleIamV1AuditConfigDnsV1beta2>(
              map['auditConfigs'],
              (value) => GoogleIamV1AuditConfigDnsV1beta2.fromMap(
                  (value as Map).cast<String, dynamic>())),
      bindings: map['bindings'] == null
          ? null
          : pulumi.Input.decodeList<GoogleIamV1BindingDnsV1beta2>(
              map['bindings'],
              (value) => GoogleIamV1BindingDnsV1beta2.fromMap(
                  (value as Map).cast<String, dynamic>())),
