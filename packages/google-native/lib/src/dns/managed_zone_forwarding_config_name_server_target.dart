...
class ManagedZoneForwardingConfigNameServerTarget {
  ...
  final ManagedZoneForwardingConfigNameServerTargetForwardingPath? forwardingPath;
  ...
  factory ManagedZoneForwardingConfigNameServerTarget.fromMap(Map<String, dynamic> map) {
    return ManagedZoneForwardingConfigNameServerTarget(
      forwardingPath: map['forwardingPath'] == null ? null : ManagedZoneForwardingConfigNameServerTargetForwardingPath.fromValue(map['forwardingPath'] as String),
