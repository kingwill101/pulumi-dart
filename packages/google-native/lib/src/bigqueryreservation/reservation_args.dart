...
class ReservationArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'edition': ?pulumi.Input.mapOptionalInputValue<ReservationEdition, String>(edition, (value) => value.value),
  ...
  factory ReservationArgs.fromMap(Map<String, dynamic> map) {
    return ReservationArgs(
      autoscale: map['autoscale'] == null ? null : Autoscale.fromMap((map['autoscale'] as Map).cast<String, dynamic>()),
      concurrency: map['concurrency'] == null ? null : map['concurrency'] as String,
      edition: map['edition'] == null ? null : ReservationEdition.fromValue(map['edition'] as String),
      ...
      slotCapacity: map['slotCapacity'] == null ? null : map['slotCapacity'] as String,
    );
  }
}
