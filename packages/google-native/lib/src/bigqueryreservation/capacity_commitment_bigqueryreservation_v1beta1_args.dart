...
class CapacityCommitmentBigqueryreservationV1beta1Args {
  ...
  factory CapacityCommitmentBigqueryreservationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CapacityCommitmentBigqueryreservationV1beta1Args(
      ...
      enforceSingleAdminProjectPerOrg: map['enforceSingleAdminProjectPerOrg'] == null ? null : map['enforceSingleAdminProjectPerOrg'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      multiRegionAuxiliary: map['multiRegionAuxiliary'] == null ? null : map['multiRegionAuxiliary'] as bool,
      plan: map['plan'] == null ? null : CapacityCommitmentPlanBigqueryreservationV1beta1.fromValue(map['plan'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      renewalPlan: map['renewalPlan'] == null ? null : CapacityCommitmentRenewalPlanBigqueryreservationV1beta1.fromValue(map['renewalPlan'] as String),
