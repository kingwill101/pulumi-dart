...
class CapacityCommitmentArgs {
  ...
  factory CapacityCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return CapacityCommitmentArgs(
      ...
      edition: map['edition'] == null ? null : CapacityCommitmentEdition.fromValue(map['edition'] as String),
      ...
      plan: map['plan'] == null ? null : CapacityCommitmentPlan.fromValue(map['plan'] as String),
      project: map['project'] == null ? null : map['project'] as String,
      renewalPlan: map['renewalPlan'] == null ? null : CapacityCommitmentRenewalPlan.fromValue(map['renewalPlan'] as String),
