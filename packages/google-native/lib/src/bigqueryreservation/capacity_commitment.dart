...
class CapacityCommitment extends pulumi.CustomResource {
  ...
  CapacityCommitment(
    ...
    this.enforceSingleAdminProjectPerOrg = registerOutput<bool?>(
      'enforceSingleAdminProjectPerOrg',
    );
    this.failureStatus = registerOutput<StatusResponse>('failureStatus');
    this.isFlatRate = registerOutput<bool>('isFlatRate');
