...
import 'authorized_certificate_appengine_v1alpha_args.dart';
import 'certificate_raw_data_response_appengine_v1alpha.dart';
import 'managed_certificate_response_appengine_v1alpha.dart';

/// Uploads the specified SSL certificate.
/// Auto-naming is currently not supported for this resource.
class AuthorizedCertificateAppengineV1alpha extends pulumi.CustomResource {
  late final pulumi.Output<String> appId;
  /// The SSL certificate serving the AuthorizedCertificate resource. This must be obtained independently from a certificate authority.
  late final pulumi.Output<CertificateRawDataResponseAppengineV1alpha> certificateRawData;
  ...
  late final pulumi.Output<ManagedCertificateResponseAppengineV1alpha> managedCertificate;
  ...
  /// Creates a new [AuthorizedCertificateAppengineV1alpha].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AuthorizedCertificateAppengineV1alpha]. {@macro pulumi_appengine_v1alpha_authorized_certificate_appengine_v1alpha_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AuthorizedCertificateAppengineV1alpha(
    String name, {
    AuthorizedCertificateAppengineV1alphaArgs? args,
    ...
    this.certificateRawData = registerOutput<CertificateRawDataResponseAppengineV1alpha>('certificateRawData');
    ...
    this.managedCertificate = registerOutput<ManagedCertificateResponseAppengineV1alpha>('managedCertificate');
    this.name = registerOutput<String>('name');
    this.visibleDomainMappings = registerOutput<List<String>>('visibleDomainMappings');
  }
}
