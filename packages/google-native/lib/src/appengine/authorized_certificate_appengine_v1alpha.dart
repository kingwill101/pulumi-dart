...
class AuthorizedCertificateAppengineV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CertificateRawDataResponseAppengineV1alpha>
  certificateRawData;
  ...
  late final pulumi.Output<ManagedCertificateResponseAppengineV1alpha>
  managedCertificate;
  ...
  AuthorizedCertificateAppengineV1alpha(
    ...
    this.visibleDomainMappings = registerOutput<List<String>>(
