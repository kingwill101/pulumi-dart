...
class IngressRuleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?pulumi.Input.mapOptionalInputValue<IngressRuleAction, String>(
        action,
        (value) => value.value,
      ),
      'appId': appId,
  ...
  factory IngressRuleArgs.fromMap(Map<String, dynamic> map) {
    return IngressRuleArgs(
      action: map['action'] == null
          ? null
          : IngressRuleAction.fromValue(map['action'] as String),
      appId: map['appId'] as String,
      description: map['description'] == null
          ? null
          : map['description'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      sourceRange: map['sourceRange'] == null
          ? null
          : map['sourceRange'] as String,
    );
  }
}
