...
class GetVersionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'errorHandlers':
          pulumi.Input.encodeList<ErrorHandlerResponse, Map<String, dynamic>>(
            errorHandlers,
            (value) => value.toMap(),
          ),
      'flexibleRuntimeSettings': flexibleRuntimeSettings.toMap(),
      'generatedCustomerMetadata': generatedCustomerMetadata,
      'handlers': pulumi.Input.encodeList<UrlMapResponse, Map<String, dynamic>>(
        handlers,
        (value) => value.toMap(),
      ),
      ...
      'libraries':
          pulumi.Input.encodeList<LibraryResponse, Map<String, dynamic>>(
            libraries,
            (value) => value.toMap(),
          ),
  ...
  factory GetVersionResult.fromMap(Map<String, dynamic> map) {
    return GetVersionResult(
      ...
      buildEnvVariables: (map['buildEnvVariables'] as Map)
          .cast<String, String>(),
      ...
      errorHandlers: pulumi.Input.decodeList<ErrorHandlerResponse>(
        map['errorHandlers'],
      ...
      generatedCustomerMetadata: (map['generatedCustomerMetadata'] as Map)
          .cast<String, String>(),
      handlers: pulumi.Input.decodeList<UrlMapResponse>(
        map['handlers'],
        (value) =>
      ...
      libraries: pulumi.Input.decodeList<LibraryResponse>(
        map['libraries'],
        (value) =>
