...
class VersionAppengineV1beta extends pulumi.CustomResource {
  ...
  VersionAppengineV1beta(
    ...
    this.apiConfig = registerOutput<ApiConfigHandlerResponseAppengineV1beta>(
      'apiConfig',
    );
    ...
    this.basicScaling = registerOutput<BasicScalingResponseAppengineV1beta>(
      'basicScaling',
    );
    this.betaSettings = registerOutput<Map<String, String>>('betaSettings');
    this.buildEnvVariables = registerOutput<Map<String, String>>(
      'buildEnvVariables',
    );
    this.createTime = registerOutput<String>('createTime');
    this.createdBy = registerOutput<String>('createdBy');
    this.defaultExpiration = registerOutput<String>('defaultExpiration');
    this.deployment = registerOutput<DeploymentResponseAppengineV1beta>(
      'deployment',
    );
    ...
    this.entrypoint = registerOutput<EntrypointResponseAppengineV1beta>(
      'entrypoint',
    );
    ...
    this.handlers = registerOutput<List<UrlMapResponseAppengineV1beta>>(
      'handlers',
    );
    this.healthCheck = registerOutput<HealthCheckResponseAppengineV1beta>(
      'healthCheck',
    );
    this.inboundServices = registerOutput<List<String>>('inboundServices');
    this.instanceClass = registerOutput<String>('instanceClass');
    this.libraries = registerOutput<List<LibraryResponseAppengineV1beta>>(
      'libraries',
    );
    this.livenessCheck = registerOutput<LivenessCheckResponseAppengineV1beta>(
      'livenessCheck',
    );
    this.manualScaling = registerOutput<ManualScalingResponseAppengineV1beta>(
      'manualScaling',
    );
    ...
    this.readinessCheck = registerOutput<ReadinessCheckResponseAppengineV1beta>(
      'readinessCheck',
    );
    this.resources = registerOutput<ResourcesResponseAppengineV1beta>(
      'resources',
    );
