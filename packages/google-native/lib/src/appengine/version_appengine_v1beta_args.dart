...
class VersionAppengineV1betaArgs {
  ...
  VersionAppengineV1betaArgs({
    ...
    List<String>? zones,
            ...
            pulumi.Input.asOptionalInput<ApiConfigHandlerAppengineV1beta>(
                apiConfig),
        ...
        automaticScaling =
            pulumi.Input.asOptionalInput<AutomaticScalingAppengineV1beta>(
                automaticScaling),
        basicScaling =
            pulumi.Input.asOptionalInput<BasicScalingAppengineV1beta>(
                basicScaling),
        betaSettings =
        ...
        deployment =
            pulumi.Input.asOptionalInput<DeploymentAppengineV1beta>(deployment),
        endpointsApiService =
            pulumi.Input.asOptionalInput<EndpointsApiServiceAppengineV1beta>(
                endpointsApiService),
        entrypoint =
            pulumi.Input.asOptionalInput<EntrypointAppengineV1beta>(entrypoint),
        ...
        generatedCustomerMetadata =
            pulumi.Input.asOptionalInput<Map<String, String>>(
                generatedCustomerMetadata),
        handlers =
            pulumi.Input.asOptionalInput<List<UrlMapAppengineV1beta>>(handlers),
        ...
        libraries = pulumi.Input.asOptionalInput<List<LibraryAppengineV1beta>>(
            libraries),
        livenessCheck =
            pulumi.Input.asOptionalInput<LivenessCheckAppengineV1beta>(
                livenessCheck),
        manualScaling =
            pulumi.Input.asOptionalInput<ManualScalingAppengineV1beta>(
                manualScaling),
        ...
        readinessCheck =
            pulumi.Input.asOptionalInput<ReadinessCheckAppengineV1beta>(
                readinessCheck),
        resources =
            pulumi.Input.asOptionalInput<ResourcesAppengineV1beta>(resources),
  ...
  factory VersionAppengineV1betaArgs.fromMap(Map<String, dynamic> map) {
    return VersionAppengineV1betaArgs(
      ...
      servingStatus: map['servingStatus'] == null
          ? null
          : VersionServingStatusAppengineV1beta.fromValue(
