...
class VersionAppengineV1betaArgs {
  ...
  VersionAppengineV1betaArgs({
    ...
    List<String>? zones,
           ...
           .Input.asOptionalInput<ApiConfigHandlerAppengineV1beta>(apiConfig),
       ...
       livenessCheck = pulumi
           .Input.asOptionalInput<LivenessCheckAppengineV1beta>(livenessCheck),
       manualScaling = pulumi
           .Input.asOptionalInput<ManualScalingAppengineV1beta>(manualScaling),
    ...
    return <String, dynamic>{
      ...
      'servingStatus':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(servingStatus, (value) => value.value),
