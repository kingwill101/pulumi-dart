...
class App extends pulumi.CustomResource {
  ...
  App(
    ...
    this.dispatchRules = registerOutput<List<UrlDispatchRuleResponse>>('dispatchRules');
    this.featureSettings = registerOutput<FeatureSettingsResponse>('featureSettings');
    ...
    this.iap = registerOutput<IdentityAwareProxyResponse>('iap');
