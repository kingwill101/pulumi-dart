...
class VersionArgs {
  ...
  VersionArgs({
    ...
    List<UrlMap>? handlers,
    HealthCheck? healthCheck,
    String? id,
    List<VersionInboundServicesItem>? inboundServices,
    ...
    VersionServingStatus? servingStatus,
    bool? threadsafe,
    bool? vm,
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      apiConfig: map['apiConfig'] == null ? null : ApiConfigHandler.fromMap((map['apiConfig'] as Map).cast<String, dynamic>()),
      appEngineApis: map['appEngineApis'] == null ? null : map['appEngineApis'] as bool,
      appId: map['appId'] as String,
      automaticScaling: map['automaticScaling'] == null ? null : AutomaticScaling.fromMap((map['automaticScaling'] as Map).cast<String, dynamic>()),
      basicScaling: map['basicScaling'] == null ? null : BasicScaling.fromMap((map['basicScaling'] as Map).cast<String, dynamic>()),
      ...
      endpointsApiService: map['endpointsApiService'] == null ? null : EndpointsApiService.fromMap((map['endpointsApiService'] as Map).cast<String, dynamic>()),
      entrypoint: map['entrypoint'] == null ? null : Entrypoint.fromMap((map['entrypoint'] as Map).cast<String, dynamic>()),
      ...
      errorHandlers: map['errorHandlers'] == null ? null : pulumi.Input.decodeList<ErrorHandler>(map['errorHandlers'], (value) => ErrorHandler.fromMap((value as Map).cast<String, dynamic>())),
      flexibleRuntimeSettings: map['flexibleRuntimeSettings'] == null ? null : FlexibleRuntimeSettings.fromMap((map['flexibleRuntimeSettings'] as Map).cast<String, dynamic>()),
      ...
      handlers: map['handlers'] == null ? null : pulumi.Input.decodeList<UrlMap>(map['handlers'], (value) => UrlMap.fromMap((value as Map).cast<String, dynamic>())),
      healthCheck: map['healthCheck'] == null ? null : HealthCheck.fromMap((map['healthCheck'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      inboundServices: map['inboundServices'] == null ? null : pulumi.Input.decodeList<VersionInboundServicesItem>(map['inboundServices'], (value) => VersionInboundServicesItem.fromValue(value as String)),
      instanceClass: map['instanceClass'] == null ? null : map['instanceClass'] as String,
      libraries: map['libraries'] == null ? null : pulumi.Input.decodeList<Library>(map['libraries'], (value) => Library.fromMap((value as Map).cast<String, dynamic>())),
      livenessCheck: map['livenessCheck'] == null ? null : LivenessCheck.fromMap((map['livenessCheck'] as Map).cast<String, dynamic>()),
      manualScaling: map['manualScaling'] == null ? null : ManualScaling.fromMap((map['manualScaling'] as Map).cast<String, dynamic>()),
      ...
      readinessCheck: map['readinessCheck'] == null ? null : ReadinessCheck.fromMap((map['readinessCheck'] as Map).cast<String, dynamic>()),
      resources: map['resources'] == null ? null : Resources.fromMap((map['resources'] as Map).cast<String, dynamic>()),
      ...
      servingStatus: map['servingStatus'] == null ? null : VersionServingStatus.fromValue(map['servingStatus'] as String),
      threadsafe: map['threadsafe'] == null ? null : map['threadsafe'] as bool,
      vm: map['vm'] == null ? null : map['vm'] as bool,
      vpcAccessConnector: map['vpcAccessConnector'] == null ? null : VpcAccessConnector.fromMap((map['vpcAccessConnector'] as Map).cast<String, dynamic>()),
