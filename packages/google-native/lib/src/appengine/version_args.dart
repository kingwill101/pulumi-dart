...
class VersionArgs {
  ...
  VersionArgs({
    ...
    List<String>? zones,
        ...
        automaticScaling =
            pulumi.Input.asOptionalInput<AutomaticScaling>(automaticScaling),
        basicScaling = pulumi.Input.asOptionalInput<BasicScaling>(basicScaling),
        betaSettings =
            pulumi.Input.asOptionalInput<Map<String, String>>(betaSettings),
        buildEnvVariables = pulumi.Input.asOptionalInput<Map<String, String>>(
            buildEnvVariables),
        defaultExpiration =
            pulumi.Input.asOptionalInput<String>(defaultExpiration),
        ...
        errorHandlers =
            pulumi.Input.asOptionalInput<List<ErrorHandler>>(errorHandlers),
        ...
        livenessCheck =
            pulumi.Input.asOptionalInput<LivenessCheck>(livenessCheck),
        manualScaling =
            pulumi.Input.asOptionalInput<ManualScaling>(manualScaling),
        network = pulumi.Input.asOptionalInput<Network>(network),
        nobuildFilesRegex =
            pulumi.Input.asOptionalInput<String>(nobuildFilesRegex),
        readinessCheck =
            pulumi.Input.asOptionalInput<ReadinessCheck>(readinessCheck),
        ...
        runtimeMainExecutablePath =
            pulumi.Input.asOptionalInput<String>(runtimeMainExecutablePath),
        serviceAccount = pulumi.Input.asOptionalInput<String>(serviceAccount),
        serviceId = pulumi.Input.asInput<String>(serviceId),
        servingStatus =
            pulumi.Input.asOptionalInput<VersionServingStatus>(servingStatus),
    ...
    return VersionArgs(
      ...
      handlers: map['handlers'] == null
          ...
          : pulumi.Input.decodeList<UrlMap>(
              map['handlers'],
              (value) =>
                  UrlMap.fromMap((value as Map).cast<String, dynamic>())),
