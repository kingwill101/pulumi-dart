...
class DomainMappingAppengineV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResourceRecordResponseAppengineV1beta>>
  resourceRecords;
  ...
  DomainMappingAppengineV1beta(
    ...
    this.resourceRecords =
        registerOutput<List<ResourceRecordResponseAppengineV1beta>>(
          'resourceRecords',
        );
    this.sslSettings = registerOutput<SslSettingsResponseAppengineV1beta>(
      'sslSettings',
    );
  }
}
