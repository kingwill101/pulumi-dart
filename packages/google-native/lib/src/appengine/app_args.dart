...
class AppArgs {
  ...
  AppArgs({
    ...
    AppServingStatus? servingStatus,
      ...
      databaseType = pulumi.Input.asOptionalInput<AppDatabaseType>(databaseType),
      defaultCookieExpiration = pulumi.Input.asOptionalInput<String>(defaultCookieExpiration),
      dispatchRules = pulumi.Input.asOptionalInput<List<UrlDispatchRule>>(dispatchRules),
      featureSettings = pulumi.Input.asOptionalInput<FeatureSettings>(featureSettings),
      ...
      servingStatus = pulumi.Input.asOptionalInput<AppServingStatus>(servingStatus);
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      databaseType: map['databaseType'] == null ? null : AppDatabaseType.fromValue(map['databaseType'] as String),
      defaultCookieExpiration: map['defaultCookieExpiration'] == null ? null : map['defaultCookieExpiration'] as String,
      dispatchRules: map['dispatchRules'] == null ? null : pulumi.Input.decodeList<UrlDispatchRule>(map['dispatchRules'], (value) => UrlDispatchRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      iap: map['iap'] == null ? null : IdentityAwareProxy.fromMap((map['iap'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      servingStatus: map['servingStatus'] == null ? null : AppServingStatus.fromValue(map['servingStatus'] as String),
    );
  }
}
