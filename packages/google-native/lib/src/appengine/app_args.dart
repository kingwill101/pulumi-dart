...
class AppArgs {
  ...
  AppArgs({
    ...
    AppServingStatus? servingStatus,
       ...
       databaseType = pulumi.Input.asOptionalInput<AppDatabaseType>(
         databaseType,
       ),
       defaultCookieExpiration = pulumi.Input.asOptionalInput<String>(
         defaultCookieExpiration,
       ),
       dispatchRules = pulumi.Input.asOptionalInput<List<UrlDispatchRule>>(
         dispatchRules,
       ),
       featureSettings = pulumi.Input.asOptionalInput<FeatureSettings>(
         featureSettings,
       ),
       ...
       servingStatus = pulumi.Input.asOptionalInput<AppServingStatus>(
         servingStatus,
       );
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      authDomain: map['authDomain'] == null
          ? null
          : map['authDomain'] as String,
