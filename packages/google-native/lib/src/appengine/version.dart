...
class Version extends pulumi.CustomResource {
  ...
  Version(
    ...
    this.automaticScaling = registerOutput<AutomaticScalingResponse>(
      'automaticScaling',
    );
    ...
    this.endpointsApiService = registerOutput<EndpointsApiServiceResponse>(
      'endpointsApiService',
    );
    ...
    this.errorHandlers = registerOutput<List<ErrorHandlerResponse>>(
      'errorHandlers',
    );
    ...
    this.readinessCheck = registerOutput<ReadinessCheckResponse>(
      'readinessCheck',
    );
    ...
    this.vpcAccessConnector = registerOutput<VpcAccessConnectorResponse>(
      'vpcAccessConnector',
    );
