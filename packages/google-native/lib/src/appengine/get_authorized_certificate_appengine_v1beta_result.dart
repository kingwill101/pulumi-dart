...
class GetAuthorizedCertificateAppengineV1betaResult {
  ...
  factory GetAuthorizedCertificateAppengineV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetAuthorizedCertificateAppengineV1betaResult(
      certificateRawData: CertificateRawDataResponseAppengineV1beta.fromMap((map['certificateRawData'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      domainMappingsCount: map['domainMappingsCount'] as int,
      domainNames: (map['domainNames'] as List).cast<String>(),
      expireTime: map['expireTime'] as String,
      managedCertificate: ManagedCertificateResponseAppengineV1beta.fromMap((map['managedCertificate'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      visibleDomainMappings: (map['visibleDomainMappings'] as List).cast<String>(),
    );
  }
}
