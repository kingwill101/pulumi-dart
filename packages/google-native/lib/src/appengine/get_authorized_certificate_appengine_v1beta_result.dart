...
class GetAuthorizedCertificateAppengineV1betaResult {
  /// The SSL certificate serving the AuthorizedCertificate resource. This must be obtained independently from a certificate authority.
  final CertificateRawDataResponseAppengineV1beta certificateRawData;
  ...
  final ManagedCertificateResponseAppengineV1beta managedCertificate;
  ...
  /// Creates a new [GetAuthorizedCertificateAppengineV1betaResult].
  ...
  factory GetAuthorizedCertificateAppengineV1betaResult.fromMap(
      Map<String, dynamic> map) {
    return GetAuthorizedCertificateAppengineV1betaResult(
      certificateRawData: CertificateRawDataResponseAppengineV1beta.fromMap(
      ...
      managedCertificate: ManagedCertificateResponseAppengineV1beta.fromMap(
