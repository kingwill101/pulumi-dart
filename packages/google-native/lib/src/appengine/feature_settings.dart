...
class FeatureSettings {
  ...
  factory FeatureSettings.fromMap(Map<String, dynamic> map) {
    return FeatureSettings(
      splitHealthChecks: map['splitHealthChecks'] == null ? null : map['splitHealthChecks'] as bool,
      useContainerOptimizedOs: map['useContainerOptimizedOs'] == null ? null : map['useContainerOptimizedOs'] as bool,
    );
  }
}
