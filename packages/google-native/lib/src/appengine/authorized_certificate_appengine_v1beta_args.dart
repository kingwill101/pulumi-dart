...
class AuthorizedCertificateAppengineV1betaArgs {
  ...
  AuthorizedCertificateAppengineV1betaArgs({
    ...
    String? displayName,
        ...
        certificateRawData =
            pulumi.Input.asOptionalInput<CertificateRawDataAppengineV1beta>(
                certificateRawData),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (certificateRawDataValue != null) {
      map['certificateRawData'] = pulumi.Input.mapOptionalInputValue<
              CertificateRawDataAppengineV1beta, Map<String, dynamic>>(
