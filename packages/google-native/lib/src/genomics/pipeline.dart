...
class Pipeline extends pulumi.CustomResource {
  ...
  Pipeline(
    ...
    this.inputParameters = registerOutput<List<PipelineParameterResponse>>('inputParameters');
    this.name = registerOutput<String>('name');
    this.outputParameters = registerOutput<List<PipelineParameterResponse>>('outputParameters');
