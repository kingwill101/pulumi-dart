...
class LocalCopy {
  ...
  LocalCopy({required this.disk, required this.path});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'disk': disk, 'path': path};
  }

  factory LocalCopy.fromMap(Map<String, dynamic> map) {
    return LocalCopy(disk: map['disk'] as String, path: map['path'] as String);
  }
}
