...
class GetRolloutResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['approveTime'] = approveTime;
    map['controllerRollout'] = controllerRollout;
    map['createTime'] = createTime;
    map['deployEndTime'] = deployEndTime;
    map['deployFailureCause'] = deployFailureCause;
    map['deployStartTime'] = deployStartTime;
    map['deployingBuild'] = deployingBuild;
    map['description'] = description;
    map['enqueueTime'] = enqueueTime;
    map['etag'] = etag;
  ...
  factory GetRolloutResult.fromMap(Map<String, dynamic> map) {
    return GetRolloutResult(
      ...
      rolledBackByRollouts:
          (map['rolledBackByRollouts'] as List).cast<String>(),
