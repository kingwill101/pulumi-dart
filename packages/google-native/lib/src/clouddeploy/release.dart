...
class Release extends pulumi.CustomResource {
  ...
  Release(
    ...
    this.buildArtifacts = registerOutput<List<BuildArtifactResponse>>(
      'buildArtifacts',
    );
    ...
    this.deliveryPipelineSnapshot = registerOutput<DeliveryPipelineResponse>(
    ...
    this.targetArtifacts = registerOutput<Map<String, String>>(
      'targetArtifacts',
    );
    this.targetRenders = registerOutput<Map<String, String>>('targetRenders');
    this.targetSnapshots = registerOutput<List<TargetResponse>>(
      'targetSnapshots',
    );
