...
class ReleaseArgs {
  ...
  factory ReleaseArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseArgs(
      ...
      buildArtifacts: map['buildArtifacts'] == null ? null : pulumi.Input.decodeList<BuildArtifact>(map['buildArtifacts'], (value) => BuildArtifact.fromMap((value as Map).cast<String, dynamic>())),
      ...
      skaffoldConfigPath: map['skaffoldConfigPath'] == null ? null : map['skaffoldConfigPath'] as String,
      skaffoldConfigUri: map['skaffoldConfigUri'] == null ? null : map['skaffoldConfigUri'] as String,
      skaffoldVersion: map['skaffoldVersion'] == null ? null : map['skaffoldVersion'] as String,
    );
  }
}
