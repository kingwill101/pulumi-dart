...
class ReleaseArgs {
  ...
  ReleaseArgs({
    ...
    String? skaffoldVersion,
       ...
       buildArtifacts = pulumi.Input.asOptionalInput<List<BuildArtifact>>(
         buildArtifacts,
       ),
       ...
       skaffoldConfigPath = pulumi.Input.asOptionalInput<String>(
         skaffoldConfigPath,
       ),
       skaffoldConfigUri = pulumi.Input.asOptionalInput<String>(
         skaffoldConfigUri,
       ),
    ...
    return ReleaseArgs(
      ...
      buildArtifacts: map['buildArtifacts'] == null
          ...
          : pulumi.Input.decodeList<BuildArtifact>(
              map['buildArtifacts'],
              (value) =>
                  BuildArtifact.fromMap((value as Map).cast<String, dynamic>()),
            ),
