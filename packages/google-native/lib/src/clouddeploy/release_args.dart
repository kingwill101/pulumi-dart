...
class ReleaseArgs {
  ...
  ReleaseArgs({
    ...
    String? skaffoldVersion,
        ...
        buildArtifacts =
            pulumi.Input.asOptionalInput<List<BuildArtifact>>(buildArtifacts),
        ...
        skaffoldConfigPath =
            pulumi.Input.asOptionalInput<String>(skaffoldConfigPath),
        skaffoldConfigUri =
            pulumi.Input.asOptionalInput<String>(skaffoldConfigUri),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (buildArtifactsValue != null) {
      map['buildArtifacts'] = pulumi.Input.mapOptionalInputValue<
              List<BuildArtifact>, List<Map<String, dynamic>>>(
          buildArtifactsValue,
          (value) =>
              pulumi.Input.encodeList<BuildArtifact, Map<String, dynamic>>(
  ...
  factory ReleaseArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseArgs(
      ...
      buildArtifacts: map['buildArtifacts'] == null
          ? null
          : pulumi.Input.decodeList<BuildArtifact>(
              map['buildArtifacts'],
              (value) => BuildArtifact.fromMap(
      ...
      skaffoldConfigPath: map['skaffoldConfigPath'] == null
          ? null
          : map['skaffoldConfigPath'] as String,
      skaffoldConfigUri: map['skaffoldConfigUri'] == null
          ? null
          : map['skaffoldConfigUri'] as String,
      skaffoldVersion: map['skaffoldVersion'] == null
          ? null
          : map['skaffoldVersion'] as String,
    );
  }
}
