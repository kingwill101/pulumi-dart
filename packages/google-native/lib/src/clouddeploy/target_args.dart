...
class TargetArgs {
  ...
  TargetArgs({
    ...
    String? description,
    String? etag,
    List<ExecutionConfig>? executionConfigs,
    GkeCluster? gke,
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      anthosCluster: map['anthosCluster'] == null ? null : AnthosCluster.fromMap((map['anthosCluster'] as Map).cast<String, dynamic>()),
      deployParameters: map['deployParameters'] == null ? null : (map['deployParameters'] as Map).cast<String, String>(),
      description: map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      executionConfigs: map['executionConfigs'] == null ? null : pulumi.Input.decodeList<ExecutionConfig>(map['executionConfigs'], (value) => ExecutionConfig.fromMap((value as Map).cast<String, dynamic>())),
      gke: map['gke'] == null ? null : GkeCluster.fromMap((map['gke'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      multiTarget: map['multiTarget'] == null ? null : MultiTarget.fromMap((map['multiTarget'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      requireApproval: map['requireApproval'] == null ? null : map['requireApproval'] as bool,
      run: map['run'] == null ? null : CloudRunLocation.fromMap((map['run'] as Map).cast<String, dynamic>()),
