...
class TargetArgs {
  ...
  TargetArgs({
    ...
    required String targetId,
        ...
        anthosCluster =
            pulumi.Input.asOptionalInput<AnthosCluster>(anthosCluster),
        deployParameters =
            pulumi.Input.asOptionalInput<Map<String, String>>(deployParameters),
        description = pulumi.Input.asOptionalInput<String>(description),
        etag = pulumi.Input.asOptionalInput<String>(etag),
        executionConfigs = pulumi.Input.asOptionalInput<List<ExecutionConfig>>(
            executionConfigs),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (anthosClusterValue != null) {
      map['anthosCluster'] = pulumi.Input.mapOptionalInputValue<AnthosCluster,
    ...
    if (multiTargetValue != null) {
      map['multiTarget'] =
          pulumi.Input.mapOptionalInputValue<MultiTarget, Map<String, dynamic>>(
    ...
    final runValue = run;
    if (runValue != null) {
      map['run'] = pulumi.Input.mapOptionalInputValue<CloudRunLocation,
          Map<String, dynamic>>(runValue, (value) => value.toMap());
    }
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      anthosCluster: map['anthosCluster'] == null
          ? null
          : AnthosCluster.fromMap(
              (map['anthosCluster'] as Map).cast<String, dynamic>()),
      deployParameters: map['deployParameters'] == null
          ? null
          : (map['deployParameters'] as Map).cast<String, String>(),
      description:
          map['description'] == null ? null : map['description'] as String,
      etag: map['etag'] == null ? null : map['etag'] as String,
      executionConfigs: map['executionConfigs'] == null
          ? null
          : pulumi.Input.decodeList<ExecutionConfig>(
              map['executionConfigs'],
              (value) => ExecutionConfig.fromMap(
                  (value as Map).cast<String, dynamic>())),
      gke: map['gke'] == null
          ? null
          : GkeCluster.fromMap((map['gke'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null
          ? null
          : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      multiTarget: map['multiTarget'] == null
          ? null
          : MultiTarget.fromMap(
              (map['multiTarget'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] == null ? null : map['project'] as String,
      requestId: map['requestId'] == null ? null : map['requestId'] as String,
      requireApproval: map['requireApproval'] == null
          ? null
          : map['requireApproval'] as bool,
      run: map['run'] == null
          ? null
