...
class CanaryResponse {
  ...
  factory CanaryResponse.fromMap(Map<String, dynamic> map) {
    return CanaryResponse(
      canaryDeployment: CanaryDeploymentResponse.fromMap((map['canaryDeployment'] as Map).cast<String, dynamic>()),
      customCanaryDeployment: CustomCanaryDeploymentResponse.fromMap((map['customCanaryDeployment'] as Map).cast<String, dynamic>()),
