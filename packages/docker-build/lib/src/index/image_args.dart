...
class ImageArgs {
  ...
  ImageArgs({
    ...
    List<CacheFrom>? cacheFrom,
    List<CacheTo>? cacheTo,
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      ...
      builder: map['builder'] == null ? null : BuilderConfig.fromMap((map['builder'] as Map).cast<String, dynamic>()),
      cacheFrom: map['cacheFrom'] == null ? null : pulumi.Input.decodeList<CacheFrom>(map['cacheFrom'], (value) => CacheFrom.fromMap((value as Map).cast<String, dynamic>())),
      cacheTo: map['cacheTo'] == null ? null : pulumi.Input.decodeList<CacheTo>(map['cacheTo'], (value) => CacheTo.fromMap((value as Map).cast<String, dynamic>())),
      context: map['context'] == null ? null : BuildContext.fromMap((map['context'] as Map).cast<String, dynamic>()),
      dockerfile: map['dockerfile'] == null ? null : Dockerfile.fromMap((map['dockerfile'] as Map).cast<String, dynamic>()),
      exec: map['exec'] == null ? null : map['exec'] as bool,
      exports: map['exports'] == null ? null : pulumi.Input.decodeList<Export>(map['exports'], (value) => Export.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      load: map['load'] == null ? null : map['load'] as bool,
      network: map['network'] == null ? null : NetworkMode.fromValue(map['network'] as String),
      noCache: map['noCache'] == null ? null : map['noCache'] as bool,
      platforms: map['platforms'] == null ? null : pulumi.Input.decodeList<Platform>(map['platforms'], (value) => Platform.fromValue(value as String)),
      pull: map['pull'] == null ? null : map['pull'] as bool,
      push: map['push'] as bool,
      registries: map['registries'] == null ? null : pulumi.Input.decodeList<Registry>(map['registries'], (value) => Registry.fromMap((value as Map).cast<String, dynamic>())),
      secrets: map['secrets'] == null ? null : (map['secrets'] as Map).cast<String, String>(),
      ssh: map['ssh'] == null ? null : pulumi.Input.decodeList<SSH>(map['ssh'], (value) => SSH.fromMap((value as Map).cast<String, dynamic>())),
