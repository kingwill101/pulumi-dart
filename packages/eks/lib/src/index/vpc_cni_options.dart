...
class VpcCniOptions {
  ...
  final bool? cniConfigureRpfilter;
  ...
  ///
  /// Defaults to false.
  final bool? customNetworkConfig;
  /// Allows the kubelet's liveness and readiness probes to connect via TCP when pod ENI is enabled. This will slightly increase local TCP connection latency.
  final bool? disableTcpEarlyDemux;
  ...
  final bool? enableNetworkPolicy;
  /// Specifies whether to allow IPAMD to add the `vpc.amazonaws.com/has-trunk-attached` label to the node if the instance has capacity to attach an additional ENI. Default is `false`. If using liveness and readiness probes, you will also need to disable TCP early demux.
  final bool? enablePodEni;
  /// IPAMD will start allocating (/28) prefixes to the ENIs with ENABLE_PREFIX_DELEGATION set to true.
  final bool? enablePrefixDelegation;
  ...
  final String? eniConfigLabelDef;
  ...
  final bool? securityContextPrivileged;
  ...
  ///
  /// Defaults to "eni".
  final String? vethPrefix;
  /// Specifies the number of free elastic network interfaces (and all of their available IP addresses) that the ipamD daemon should attempt to keep available for pod assignment on the node.
  ///
  /// Defaults to 1.
  final int? warmEniTarget;
  /// Specifies the number of free IP addresses that the ipamD daemon should attempt to keep available for pod assignment on the node.
  final int? warmIpTarget;
  ...
  factory VpcCniOptions.fromMap(Map<String, dynamic> map) {
    return VpcCniOptions(
      ...
      cniConfigureRpfilter: map['cniConfigureRpfilter'] == null ? null : map['cniConfigureRpfilter'] as bool,
      cniCustomNetworkCfg: map['cniCustomNetworkCfg'] == null ? null : map['cniCustomNetworkCfg'] as bool,
      cniExternalSnat: map['cniExternalSnat'] == null ? null : map['cniExternalSnat'] as bool,
      configurationValues: map['configurationValues'] == null ? null : (map['configurationValues'] as Map).cast<String, dynamic>(),
      customNetworkConfig: map['customNetworkConfig'] == null ? null : map['customNetworkConfig'] as bool,
      disableTcpEarlyDemux: map['disableTcpEarlyDemux'] == null ? null : map['disableTcpEarlyDemux'] as bool,
      enableNetworkPolicy: map['enableNetworkPolicy'] == null ? null : map['enableNetworkPolicy'] as bool,
      enablePodEni: map['enablePodEni'] == null ? null : map['enablePodEni'] as bool,
      enablePrefixDelegation: map['enablePrefixDelegation'] == null ? null : map['enablePrefixDelegation'] as bool,
      eniConfigLabelDef: map['eniConfigLabelDef'] == null ? null : map['eniConfigLabelDef'] as String,
      eniMtu: map['eniMtu'] == null ? null : map['eniMtu'] as int,
      externalSnat: map['externalSnat'] == null ? null : map['externalSnat'] as bool,
      logFile: map['logFile'] == null ? null : map['logFile'] as String,
      logLevel: map['logLevel'] == null ? null : map['logLevel'] as String,
      nodePortSupport: map['nodePortSupport'] == null ? null : map['nodePortSupport'] as bool,
      ...
      securityContextPrivileged: map['securityContextPrivileged'] == null ? null : map['securityContextPrivileged'] as bool,
      serviceAccountRoleArn: map['serviceAccountRoleArn'] == null ? null : map['serviceAccountRoleArn'] as String,
      vethPrefix: map['vethPrefix'] == null ? null : map['vethPrefix'] as String,
      warmEniTarget: map['warmEniTarget'] == null ? null : map['warmEniTarget'] as int,
      warmIpTarget: map['warmIpTarget'] == null ? null : map['warmIpTarget'] as int,
      warmPrefixTarget: map['warmPrefixTarget'] == null ? null : map['warmPrefixTarget'] as int,
    );
  }
}
