...
class VpcCniAddonArgs {
  ...
  VpcCniAddonArgs({
    ...
    bool? cniConfigureRpfilter,
    bool? cniCustomNetworkCfg,
    bool? cniExternalSnat,
    Map<String, dynamic>? configurationValues,
    bool? customNetworkConfig,
    bool? disableTcpEarlyDemux,
    bool? enableNetworkPolicy,
    bool? enablePodEni,
    bool? enablePrefixDelegation,
    String? eniConfigLabelDef,
    int? eniMtu,
    bool? externalSnat,
    String? logFile,
    String? logLevel,
    bool? nodePortSupport,
    ResolveConflictsOnCreate? resolveConflictsOnCreate,
    ResolveConflictsOnUpdate? resolveConflictsOnUpdate,
    bool? securityContextPrivileged,
    String? serviceAccountRoleArn,
    List<Map<String, String>>? tags,
    String? vethPrefix,
    int? warmEniTarget,
    int? warmIpTarget,
    int? warmPrefixTarget,
  }) :
