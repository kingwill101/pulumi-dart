...
class ManagedNodeGroupArgs {
  ...
  ManagedNodeGroupArgs({
    ...
    pulumi_aws_eks.NodeGroupLaunchTemplate? launchTemplate,
    String? nodeGroupName,
    String? nodeGroupNamePrefix,
    pulumi_aws_iam.Role? nodeRole,
    String? nodeRoleArn,
    List<NodeadmOptions>? nodeadmExtraOptions,
    OperatingSystem? operatingSystem,
    String? placementGroupAvailabilityZone,
    String? releaseVersion,
    pulumi_aws_eks.NodeGroupRemoteAccess? remoteAccess,
    pulumi_aws_eks.NodeGroupScalingConfig? scalingConfig,
    List<String>? subnetIds,
    Map<String, String>? tags,
    List<pulumi_aws_eks.NodeGroupTaint>? taints,
    String? userData,
    String? version,
  }) :
  ...
  factory ManagedNodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return ManagedNodeGroupArgs(
      ...
      enableEfaSupport: map['enableEfaSupport'] == null ? null : map['enableEfaSupport'] as bool,
      enableIMDSv2: map['enableIMDSv2'] == null ? null : map['enableIMDSv2'] as bool,
      ...
      launchTemplate: map['launchTemplate'] == null ? null : pulumi_aws_eks.NodeGroupLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>()),
      ...
      nodeRole: map['nodeRole'] == null ? null : map['nodeRole'] as pulumi_aws_iam.Role,
      ...
      placementGroupAvailabilityZone: map['placementGroupAvailabilityZone'] == null ? null : map['placementGroupAvailabilityZone'] as String,
      releaseVersion: map['releaseVersion'] == null ? null : map['releaseVersion'] as String,
      remoteAccess: map['remoteAccess'] == null ? null : pulumi_aws_eks.NodeGroupRemoteAccess.fromMap((map['remoteAccess'] as Map).cast<String, dynamic>()),
      scalingConfig: map['scalingConfig'] == null ? null : pulumi_aws_eks.NodeGroupScalingConfig.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>()),
      subnetIds: map['subnetIds'] == null ? null : (map['subnetIds'] as List).cast<String>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<pulumi_aws_eks.NodeGroupTaint>(map['taints'], (value) => pulumi_aws_eks.NodeGroupTaint.fromMap((value as Map).cast<String, dynamic>())),
