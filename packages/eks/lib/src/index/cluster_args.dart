...
class ClusterArgs {
  ...
  ClusterArgs({
    Map<String, AccessEntry>? accessEntries,
    AuthenticationMode? authenticationMode,
    AutoModeOptions? autoMode,
    bool? bootstrapSelfManagedAddons,
    pulumi_aws_ec2.SecurityGroup? clusterSecurityGroup,
    Map<String, String>? clusterSecurityGroupTags,
    Map<String, String>? clusterTags,
    CoreDnsAddonOptions? corednsAddonOptions,
    bool? createInstanceRole,
    bool? createOidcProvider,
    CreationRoleProvider? creationRoleProvider,
    bool? deletionProtection,
    int? desiredCapacity,
    bool? enableConfigMapMutable,
    ...
    pulumi_aws_iam.Role? instanceRole,
    List<pulumi_aws_iam.Role>? instanceRoles,
    String? instanceType,
    String? ipFamily,
    KubeProxyAddonOptions? kubeProxyAddonOptions,
    String? kubernetesServiceIpAddressRange,
    int? maxSize,
    int? minSize,
    String? name,
    String? nodeAmiId,
    bool? nodeAssociatePublicIpAddress,
    ClusterNodeGroupOptions? nodeGroupOptions,
    String? nodePublicKey,
    bool? nodeRootVolumeEncrypted,
    int? nodeRootVolumeSize,
    Map<String, String>? nodeSecurityGroupTags,
    List<String>? nodeSubnetIds,
    String? nodeUserData,
    List<String>? privateSubnetIds,
    KubeconfigOptions? providerCredentialOpts,
    String? proxy,
    List<String>? publicAccessCidrs,
    List<String>? publicSubnetIds,
    List<RoleMapping>? roleMappings,
    pulumi_aws_iam.Role? serviceRole,
    bool? skipDefaultNodeGroup,
    bool? skipDefaultSecurityGroups,
    String? storageClasses,
    List<String>? subnetIds,
    Map<String, String>? tags,
    pulumi_aws_eks.ClusterUpgradePolicy? upgradePolicy,
    bool? useDefaultVpcCni,
    List<UserMapping>? userMappings,
    String? version,
    VpcCniOptions? vpcCniOptions,
    String? vpcId,
  }) :
      accessEntries = pulumi.Input.asOptionalInput<Map<String, AccessEntry>>(accessEntries),
      authenticationMode = pulumi.Input.asOptionalInput<AuthenticationMode>(authenticationMode),
      autoMode = pulumi.Input.asOptionalInput<AutoModeOptions>(autoMode),
      bootstrapSelfManagedAddons = pulumi.Input.asOptionalInput<bool>(bootstrapSelfManagedAddons),
      clusterSecurityGroup = pulumi.Input.asOptionalInput<pulumi_aws_ec2.SecurityGroup>(clusterSecurityGroup),
      clusterSecurityGroupTags = pulumi.Input.asOptionalInput<Map<String, String>>(clusterSecurityGroupTags),
      clusterTags = pulumi.Input.asOptionalInput<Map<String, String>>(clusterTags),
      corednsAddonOptions = pulumi.Input.asOptionalInput<CoreDnsAddonOptions>(corednsAddonOptions),
      createInstanceRole = pulumi.Input.asOptionalInput<bool>(createInstanceRole),
      createOidcProvider = pulumi.Input.asOptionalInput<bool>(createOidcProvider),
      creationRoleProvider = pulumi.Input.asOptionalInput<CreationRoleProvider>(creationRoleProvider),
      ...
      encryptionConfigKeyArn = pulumi.Input.asOptionalInput<String>(encryptionConfigKeyArn),
      endpointPrivateAccess = pulumi.Input.asOptionalInput<bool>(endpointPrivateAccess),
      endpointPublicAccess = pulumi.Input.asOptionalInput<bool>(endpointPublicAccess),
      fargate = pulumi.Input.asOptionalInput<bool>(fargate),
      gpu = pulumi.Input.asOptionalInput<bool>(gpu),
      instanceProfileName = pulumi.Input.asOptionalInput<String>(instanceProfileName),
      instanceRole = pulumi.Input.asOptionalInput<pulumi_aws_iam.Role>(instanceRole),
      instanceRoles = pulumi.Input.asOptionalInput<List<pulumi_aws_iam.Role>>(instanceRoles),
      instanceType = pulumi.Input.asOptionalInput<String>(instanceType),
      ipFamily = pulumi.Input.asOptionalInput<String>(ipFamily),
      kubeProxyAddonOptions = pulumi.Input.asOptionalInput<KubeProxyAddonOptions>(kubeProxyAddonOptions),
      kubernetesServiceIpAddressRange = pulumi.Input.asOptionalInput<String>(kubernetesServiceIpAddressRange),
      maxSize = pulumi.Input.asOptionalInput<int>(maxSize),
      minSize = pulumi.Input.asOptionalInput<int>(minSize),
      name = pulumi.Input.asOptionalInput<String>(name),
      nodeAmiId = pulumi.Input.asOptionalInput<String>(nodeAmiId),
      nodeAssociatePublicIpAddress = pulumi.Input.asOptionalInput<bool>(nodeAssociatePublicIpAddress),
      nodeGroupOptions = pulumi.Input.asOptionalInput<ClusterNodeGroupOptions>(nodeGroupOptions),
      ...
      nodeSecurityGroupTags = pulumi.Input.asOptionalInput<Map<String, String>>(nodeSecurityGroupTags),
      ...
      privateSubnetIds = pulumi.Input.asOptionalInput<List<String>>(privateSubnetIds),
      providerCredentialOpts = pulumi.Input.asOptionalInput<KubeconfigOptions>(providerCredentialOpts),
      proxy = pulumi.Input.asOptionalInput<String>(proxy),
      publicAccessCidrs = pulumi.Input.asOptionalInput<List<String>>(publicAccessCidrs),
      publicSubnetIds = pulumi.Input.asOptionalInput<List<String>>(publicSubnetIds),
      roleMappings = pulumi.Input.asOptionalInput<List<RoleMapping>>(roleMappings),
      serviceRole = pulumi.Input.asOptionalInput<pulumi_aws_iam.Role>(serviceRole),
      skipDefaultNodeGroup = pulumi.Input.asOptionalInput<bool>(skipDefaultNodeGroup),
      skipDefaultSecurityGroups = pulumi.Input.asOptionalInput<bool>(skipDefaultSecurityGroups),
      storageClasses = pulumi.Input.asOptionalInput<String>(storageClasses),
      subnetIds = pulumi.Input.asOptionalInput<List<String>>(subnetIds),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      upgradePolicy = pulumi.Input.asOptionalInput<pulumi_aws_eks.ClusterUpgradePolicy>(upgradePolicy),
      useDefaultVpcCni = pulumi.Input.asOptionalInput<bool>(useDefaultVpcCni),
      userMappings = pulumi.Input.asOptionalInput<List<UserMapping>>(userMappings),
      version = pulumi.Input.asOptionalInput<String>(version),
      vpcCniOptions = pulumi.Input.asOptionalInput<VpcCniOptions>(vpcCniOptions),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authenticationMode': ?pulumi.Input.mapOptionalInputValue<AuthenticationMode, String>(authenticationMode, (value) => value.value),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      accessEntries: map['accessEntries'] == null ? null : pulumi.Input.decodeMapValues<AccessEntry>(map['accessEntries'], (value) => AccessEntry.fromMap((value as Map).cast<String, dynamic>())),
      authenticationMode: map['authenticationMode'] == null ? null : AuthenticationMode.fromValue(map['authenticationMode'] as String),
      autoMode: map['autoMode'] == null ? null : AutoModeOptions.fromMap((map['autoMode'] as Map).cast<String, dynamic>()),
      bootstrapSelfManagedAddons: map['bootstrapSelfManagedAddons'] == null ? null : map['bootstrapSelfManagedAddons'] as bool,
      clusterSecurityGroup: map['clusterSecurityGroup'] == null ? null : map['clusterSecurityGroup'] as pulumi_aws_ec2.SecurityGroup,
      clusterSecurityGroupTags: map['clusterSecurityGroupTags'] == null ? null : (map['clusterSecurityGroupTags'] as Map).cast<String, String>(),
      clusterTags: map['clusterTags'] == null ? null : (map['clusterTags'] as Map).cast<String, String>(),
      corednsAddonOptions: map['corednsAddonOptions'] == null ? null : CoreDnsAddonOptions.fromMap((map['corednsAddonOptions'] as Map).cast<String, dynamic>()),
      createInstanceRole: map['createInstanceRole'] == null ? null : map['createInstanceRole'] as bool,
      createOidcProvider: map['createOidcProvider'] == null ? null : map['createOidcProvider'] as bool,
      creationRoleProvider: map['creationRoleProvider'] == null ? null : CreationRoleProvider.fromMap((map['creationRoleProvider'] as Map).cast<String, dynamic>()),
      ...
      enableConfigMapMutable: map['enableConfigMapMutable'] == null ? null : map['enableConfigMapMutable'] as bool,
      enabledClusterLogTypes: map['enabledClusterLogTypes'] == null ? null : (map['enabledClusterLogTypes'] as List).cast<String>(),
      encryptionConfigKeyArn: map['encryptionConfigKeyArn'] == null ? null : map['encryptionConfigKeyArn'] as String,
      ...
      fargate: map['fargate'] == null ? null : map['fargate'] as bool,
      ...
      instanceRole: map['instanceRole'] == null ? null : map['instanceRole'] as pulumi_aws_iam.Role,
      instanceRoles: map['instanceRoles'] == null ? null : (map['instanceRoles'] as List).cast<pulumi_aws_iam.Role>(),
      instanceType: map['instanceType'] == null ? null : map['instanceType'] as String,
      ipFamily: map['ipFamily'] == null ? null : map['ipFamily'] as String,
      kubeProxyAddonOptions: map['kubeProxyAddonOptions'] == null ? null : KubeProxyAddonOptions.fromMap((map['kubeProxyAddonOptions'] as Map).cast<String, dynamic>()),
      kubernetesServiceIpAddressRange: map['kubernetesServiceIpAddressRange'] == null ? null : map['kubernetesServiceIpAddressRange'] as String,
      maxSize: map['maxSize'] == null ? null : map['maxSize'] as int,
      minSize: map['minSize'] == null ? null : map['minSize'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      nodeAmiId: map['nodeAmiId'] == null ? null : map['nodeAmiId'] as String,
      nodeAssociatePublicIpAddress: map['nodeAssociatePublicIpAddress'] == null ? null : map['nodeAssociatePublicIpAddress'] as bool,
      nodeGroupOptions: map['nodeGroupOptions'] == null ? null : ClusterNodeGroupOptions.fromMap((map['nodeGroupOptions'] as Map).cast<String, dynamic>()),
      ...
      providerCredentialOpts: map['providerCredentialOpts'] == null ? null : KubeconfigOptions.fromMap((map['providerCredentialOpts'] as Map).cast<String, dynamic>()),
      ...
      roleMappings: map['roleMappings'] == null ? null : pulumi.Input.decodeList<RoleMapping>(map['roleMappings'], (value) => RoleMapping.fromMap((value as Map).cast<String, dynamic>())),
      serviceRole: map['serviceRole'] == null ? null : map['serviceRole'] as pulumi_aws_iam.Role,
      skipDefaultNodeGroup: map['skipDefaultNodeGroup'] == null ? null : map['skipDefaultNodeGroup'] as bool,
      skipDefaultSecurityGroups: map['skipDefaultSecurityGroups'] == null ? null : map['skipDefaultSecurityGroups'] as bool,
      storageClasses: map['storageClasses'] == null ? null : map['storageClasses'] as String,
      subnetIds: map['subnetIds'] == null ? null : (map['subnetIds'] as List).cast<String>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradePolicy: map['upgradePolicy'] == null ? null : pulumi_aws_eks.ClusterUpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>()),
      useDefaultVpcCni: map['useDefaultVpcCni'] == null ? null : map['useDefaultVpcCni'] as bool,
      userMappings: map['userMappings'] == null ? null : pulumi.Input.decodeList<UserMapping>(map['userMappings'], (value) => UserMapping.fromMap((value as Map).cast<String, dynamic>())),
      version: map['version'] == null ? null : map['version'] as String,
      vpcCniOptions: map['vpcCniOptions'] == null ? null : VpcCniOptions.fromMap((map['vpcCniOptions'] as Map).cast<String, dynamic>()),
