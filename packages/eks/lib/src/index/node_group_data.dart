...
class NodeGroupData {
  ...
  final pulumi_aws_autoscaling.Group autoScalingGroup;
  ...
  factory NodeGroupData.fromMap(Map<String, dynamic> map) {
    return NodeGroupData(
      autoScalingGroup: map['autoScalingGroup'] as pulumi_aws_autoscaling.Group,
      extraNodeSecurityGroups: (map['extraNodeSecurityGroups'] as List).cast<pulumi_aws_ec2.SecurityGroup>(),
      nodeSecurityGroup: map['nodeSecurityGroup'] as pulumi_aws_ec2.SecurityGroup,
    );
  }
}
