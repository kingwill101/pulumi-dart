...
class ZoneArgs {
  ...
  ZoneArgs({
    ...
    String? name,
    List<ZonePrimaryNameserver>? primaryNameservers,
    int? ttl,
  }) :
  ...
  factory ZoneArgs.fromMap(Map<String, dynamic> map) {
    return ZoneArgs(
      ...
      primaryNameservers: map['primaryNameservers'] == null ? null : pulumi.Input.decodeList<ZonePrimaryNameserver>(map['primaryNameservers'], (value) => ZonePrimaryNameserver.fromMap((value as Map).cast<String, dynamic>())),
