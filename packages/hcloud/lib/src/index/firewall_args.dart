...
class FirewallArgs {
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      applyTos: map['applyTos'] == null ? null : pulumi.Input.decodeList<FirewallApplyTo>(map['applyTos'], (value) => FirewallApplyTo.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<FirewallRule>(map['rules'], (value) => FirewallRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
