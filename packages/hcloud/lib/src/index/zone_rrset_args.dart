...
class ZoneRrsetArgs {
  ...
  ZoneRrsetArgs({
    ...
    String? name,
    required List<ZoneRrsetRecord> records,
    int? ttl,
  ...
  factory ZoneRrsetArgs.fromMap(Map<String, dynamic> map) {
    return ZoneRrsetArgs(
      changeProtection: map['changeProtection'] == null ? null : map['changeProtection'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      records: pulumi.Input.decodeList<ZoneRrsetRecord>(map['records'], (value) => ZoneRrsetRecord.fromMap((value as Map).cast<String, dynamic>())),
