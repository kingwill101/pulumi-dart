...
class LoadBalancerServiceArgs {
  ...
  factory LoadBalancerServiceArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerServiceArgs(
      ...
      healthCheck: map['healthCheck'] == null ? null : LoadBalancerServiceHealthCheck.fromMap((map['healthCheck'] as Map).cast<String, dynamic>()),
      http: map['http'] == null ? null : LoadBalancerServiceHttp.fromMap((map['http'] as Map).cast<String, dynamic>()),
      listenPort: map['listenPort'] == null ? null : map['listenPort'] as int,
