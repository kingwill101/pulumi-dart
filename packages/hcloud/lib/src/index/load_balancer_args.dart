...
class LoadBalancerArgs {
  ...
  LoadBalancerArgs({
    ...
    String? name,
    String? networkZone,
    List<LoadBalancerTarget>? targets,
  }) :
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      algorithm: map['algorithm'] == null ? null : LoadBalancerAlgorithm.fromMap((map['algorithm'] as Map).cast<String, dynamic>()),
      ...
      networkZone: map['networkZone'] == null ? null : map['networkZone'] as String,
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<LoadBalancerTarget>(map['targets'], (value) => LoadBalancerTarget.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
