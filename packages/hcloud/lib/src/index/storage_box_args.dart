...
class StorageBoxArgs {
  ...
  StorageBoxArgs({
    StorageBoxAccessSettings? accessSettings,
    bool? deleteProtection,
    Map<String, String>? labels,
    required String location,
    String? name,
    required String password,
    StorageBoxSnapshotPlan? snapshotPlan,
    List<String>? sshKeys,
    required String storageBoxType,
  }) :
      ...
      storageBoxType = pulumi.Input.asInput<String>(storageBoxType);
  ...
  factory StorageBoxArgs.fromMap(Map<String, dynamic> map) {
    return StorageBoxArgs(
      accessSettings: map['accessSettings'] == null ? null : StorageBoxAccessSettings.fromMap((map['accessSettings'] as Map).cast<String, dynamic>()),
      deleteProtection: map['deleteProtection'] == null ? null : map['deleteProtection'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      password: map['password'] as String,
      snapshotPlan: map['snapshotPlan'] == null ? null : StorageBoxSnapshotPlan.fromMap((map['snapshotPlan'] as Map).cast<String, dynamic>()),
