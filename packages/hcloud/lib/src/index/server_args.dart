...
class ServerArgs {
  ...
  ServerArgs({
    bool? allowDeprecatedImages,
    bool? backups,
    String? datacenter,
    bool? deleteProtection,
    List<int>? firewallIds,
    bool? ignoreRemoteFirewallIds,
    String? image,
    String? iso,
    bool? keepDisk,
    ...
    String? location,
    String? name,
    List<ServerNetwork>? networks,
    int? placementGroupId,
    List<ServerPublicNet>? publicNets,
    bool? rebuildProtection,
    String? rescue,
    required String serverType,
    bool? shutdownBeforeDeletion,
    List<String>? sshKeys,
    String? userData,
  }) :
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      allowDeprecatedImages: map['allowDeprecatedImages'] == null ? null : map['allowDeprecatedImages'] as bool,
      ...
      firewallIds: map['firewallIds'] == null ? null : (map['firewallIds'] as List).cast<int>(),
      ignoreRemoteFirewallIds: map['ignoreRemoteFirewallIds'] == null ? null : map['ignoreRemoteFirewallIds'] as bool,
      image: map['image'] == null ? null : map['image'] as String,
      iso: map['iso'] == null ? null : map['iso'] as String,
      keepDisk: map['keepDisk'] == null ? null : map['keepDisk'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networks: map['networks'] == null ? null : pulumi.Input.decodeList<ServerNetwork>(map['networks'], (value) => ServerNetwork.fromMap((value as Map).cast<String, dynamic>())),
      placementGroupId: map['placementGroupId'] == null ? null : map['placementGroupId'] as int,
      publicNets: map['publicNets'] == null ? null : pulumi.Input.decodeList<ServerPublicNet>(map['publicNets'], (value) => ServerPublicNet.fromMap((value as Map).cast<String, dynamic>())),
      rebuildProtection: map['rebuildProtection'] == null ? null : map['rebuildProtection'] as bool,
      rescue: map['rescue'] == null ? null : map['rescue'] as String,
      serverType: map['serverType'] as String,
      shutdownBeforeDeletion: map['shutdownBeforeDeletion'] == null ? null : map['shutdownBeforeDeletion'] as bool,
