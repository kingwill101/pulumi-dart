...
class BuildxBuilderArgs {
  ...
  BuildxBuilderArgs({
    bool? append,
    bool? bootstrap,
    String? buildkitConfig,
    String? buildkitFlags,
    BuildxBuilderDockerContainer? dockerContainer,
    String? driver,
    Map<String, String>? driverOptions,
    String? endpoint,
    BuildxBuilderKubernetes? kubernetes,
    String? name,
    String? node,
    List<String>? platforms,
    BuildxBuilderRemote? remote,
    bool? use,
  }) :
  ...
  factory BuildxBuilderArgs.fromMap(Map<String, dynamic> map) {
    return BuildxBuilderArgs(
      append: map['append'] == null ? null : map['append'] as bool,
      bootstrap: map['bootstrap'] == null ? null : map['bootstrap'] as bool,
      buildkitConfig: map['buildkitConfig'] == null ? null : map['buildkitConfig'] as String,
      buildkitFlags: map['buildkitFlags'] == null ? null : map['buildkitFlags'] as String,
      dockerContainer: map['dockerContainer'] == null ? null : BuildxBuilderDockerContainer.fromMap((map['dockerContainer'] as Map).cast<String, dynamic>()),
      ...
      kubernetes: map['kubernetes'] == null ? null : BuildxBuilderKubernetes.fromMap((map['kubernetes'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      node: map['node'] == null ? null : map['node'] as String,
      platforms: map['platforms'] == null ? null : (map['platforms'] as List).cast<String>(),
      remote: map['remote'] == null ? null : BuildxBuilderRemote.fromMap((map['remote'] as Map).cast<String, dynamic>()),
      use: map['use'] == null ? null : map['use'] as bool,
    );
  }
}
