...
/// {@template pulumi_index_container_container_args_doc}
/// The set of arguments for Container.
/// {@endtemplate}
/// {@macro pulumi_index_container_container_args_doc}
class ContainerArgs {
  ...
  ContainerArgs({
    ...
    String? cgroupnsMode,
    List<String>? command,
    int? containerReadRefreshTimeoutMilliseconds,
    int? cpuPeriod,
    int? cpuQuota,
    String? cpuSet,
    int? cpuShares,
    String? cpus,
    int? destroyGraceSeconds,
    List<ContainerDevice>? devices,
    List<String>? dns,
    List<String>? dnsOpts,
    List<String>? dnsSearches,
    String? domainname,
    List<String>? entrypoints,
    List<String>? envs,
    String? gpus,
    List<String>? groupAdds,
    ...
    String? name,
    String? networkMode,
    List<ContainerNetworksAdvanced>? networksAdvanced,
    String? pidMode,
    ...
    bool? tty,
    List<ContainerUlimit>? ulimits,
    List<ContainerUpload>? uploads,
    String? user,
    String? usernsMode,
  ...
  factory ContainerArgs.fromMap(Map<String, dynamic> map) {
    return ContainerArgs(
      attach: map['attach'] == null ? null : map['attach'] as bool,
      capabilities: map['capabilities'] == null ? null : ContainerCapabilities.fromMap((map['capabilities'] as Map).cast<String, dynamic>()),
      cgroupParent: map['cgroupParent'] == null ? null : map['cgroupParent'] as String,
      cgroupnsMode: map['cgroupnsMode'] == null ? null : map['cgroupnsMode'] as String,
      command: map['command'] == null ? null : (map['command'] as List).cast<String>(),
      containerReadRefreshTimeoutMilliseconds: map['containerReadRefreshTimeoutMilliseconds'] == null ? null : map['containerReadRefreshTimeoutMilliseconds'] as int,
      cpuPeriod: map['cpuPeriod'] == null ? null : map['cpuPeriod'] as int,
      cpuQuota: map['cpuQuota'] == null ? null : map['cpuQuota'] as int,
      cpuSet: map['cpuSet'] == null ? null : map['cpuSet'] as String,
      cpuShares: map['cpuShares'] == null ? null : map['cpuShares'] as int,
      cpus: map['cpus'] == null ? null : map['cpus'] as String,
      destroyGraceSeconds: map['destroyGraceSeconds'] == null ? null : map['destroyGraceSeconds'] as int,
      devices: map['devices'] == null ? null : pulumi.Input.decodeList<ContainerDevice>(map['devices'], (value) => ContainerDevice.fromMap((value as Map).cast<String, dynamic>())),
      dns: map['dns'] == null ? null : (map['dns'] as List).cast<String>(),
      dnsOpts: map['dnsOpts'] == null ? null : (map['dnsOpts'] as List).cast<String>(),
      dnsSearches: map['dnsSearches'] == null ? null : (map['dnsSearches'] as List).cast<String>(),
      ...
      gpus: map['gpus'] == null ? null : map['gpus'] as String,
      groupAdds: map['groupAdds'] == null ? null : (map['groupAdds'] as List).cast<String>(),
      healthcheck: map['healthcheck'] == null ? null : ContainerHealthcheck.fromMap((map['healthcheck'] as Map).cast<String, dynamic>()),
      hostname: map['hostname'] == null ? null : map['hostname'] as String,
      hosts: map['hosts'] == null ? null : pulumi.Input.decodeList<ContainerHost>(map['hosts'], (value) => ContainerHost.fromMap((value as Map).cast<String, dynamic>())),
      image: map['image'] as String,
      init: map['init'] == null ? null : map['init'] as bool,
      ...
      logOpts: map['logOpts'] == null ? null : (map['logOpts'] as Map).cast<String, String>(),
      logs: map['logs'] == null ? null : map['logs'] as bool,
      ...
      mounts: map['mounts'] == null ? null : pulumi.Input.decodeList<ContainerMount>(map['mounts'], (value) => ContainerMount.fromMap((value as Map).cast<String, dynamic>())),
      mustRun: map['mustRun'] == null ? null : map['mustRun'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      networkMode: map['networkMode'] == null ? null : map['networkMode'] as String,
      networksAdvanced: map['networksAdvanced'] == null ? null : pulumi.Input.decodeList<ContainerNetworksAdvanced>(map['networksAdvanced'], (value) => ContainerNetworksAdvanced.fromMap((value as Map).cast<String, dynamic>())),
      ...
      publishAllPorts: map['publishAllPorts'] == null ? null : map['publishAllPorts'] as bool,
      readOnly: map['readOnly'] == null ? null : map['readOnly'] as bool,
      removeVolumes: map['removeVolumes'] == null ? null : map['removeVolumes'] as bool,
      restart: map['restart'] == null ? null : map['restart'] as String,
      rm: map['rm'] == null ? null : map['rm'] as bool,
      ...
      start: map['start'] == null ? null : map['start'] as bool,
      stdinOpen: map['stdinOpen'] == null ? null : map['stdinOpen'] as bool,
      stopSignal: map['stopSignal'] == null ? null : map['stopSignal'] as String,
      stopTimeout: map['stopTimeout'] == null ? null : map['stopTimeout'] as int,
      storageOpts: map['storageOpts'] == null ? null : (map['storageOpts'] as Map).cast<String, String>(),
      sysctls: map['sysctls'] == null ? null : (map['sysctls'] as Map).cast<String, String>(),
      tmpfs: map['tmpfs'] == null ? null : (map['tmpfs'] as Map).cast<String, String>(),
      tty: map['tty'] == null ? null : map['tty'] as bool,
      ulimits: map['ulimits'] == null ? null : pulumi.Input.decodeList<ContainerUlimit>(map['ulimits'], (value) => ContainerUlimit.fromMap((value as Map).cast<String, dynamic>())),
      uploads: map['uploads'] == null ? null : pulumi.Input.decodeList<ContainerUpload>(map['uploads'], (value) => ContainerUpload.fromMap((value as Map).cast<String, dynamic>())),
      user: map['user'] == null ? null : map['user'] as String,
      usernsMode: map['usernsMode'] == null ? null : map['usernsMode'] as String,
      volumes: map['volumes'] == null ? null : pulumi.Input.decodeList<ContainerVolume>(map['volumes'], (value) => ContainerVolume.fromMap((value as Map).cast<String, dynamic>())),
