...
class ServiceArgs {
  ...
  ServiceArgs({
    ServiceAuth? auth,
    ServiceConvergeConfig? convergeConfig,
    ServiceEndpointSpec? endpointSpec,
    List<ServiceLabel>? labels,
    ServiceMode? mode,
    String? name,
    ServiceRollbackConfig? rollbackConfig,
    required ServiceTaskSpec taskSpec,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      auth: map['auth'] == null ? null : ServiceAuth.fromMap((map['auth'] as Map).cast<String, dynamic>()),
      convergeConfig: map['convergeConfig'] == null ? null : ServiceConvergeConfig.fromMap((map['convergeConfig'] as Map).cast<String, dynamic>()),
      endpointSpec: map['endpointSpec'] == null ? null : ServiceEndpointSpec.fromMap((map['endpointSpec'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<ServiceLabel>(map['labels'], (value) => ServiceLabel.fromMap((value as Map).cast<String, dynamic>())),
      mode: map['mode'] == null ? null : ServiceMode.fromMap((map['mode'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      rollbackConfig: map['rollbackConfig'] == null ? null : ServiceRollbackConfig.fromMap((map['rollbackConfig'] as Map).cast<String, dynamic>()),
      taskSpec: ServiceTaskSpec.fromMap((map['taskSpec'] as Map).cast<String, dynamic>()),
      updateConfig: map['updateConfig'] == null ? null : ServiceUpdateConfig.fromMap((map['updateConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
