...
class NetworkArgs {
  ...
  NetworkArgs({
    ...
    bool? ingress,
    bool? internal,
    List<NetworkIpamConfig>? ipamConfigs,
    String? ipamDriver,
    Map<String, String>? ipamOptions,
    bool? ipv6,
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      attachable: map['attachable'] == null ? null : map['attachable'] as bool,
      checkDuplicate: map['checkDuplicate'] == null ? null : map['checkDuplicate'] as bool,
      driver: map['driver'] == null ? null : map['driver'] as String,
      ingress: map['ingress'] == null ? null : map['ingress'] as bool,
      internal: map['internal'] == null ? null : map['internal'] as bool,
      ipamConfigs: map['ipamConfigs'] == null ? null : pulumi.Input.decodeList<NetworkIpamConfig>(map['ipamConfigs'], (value) => NetworkIpamConfig.fromMap((value as Map).cast<String, dynamic>())),
      ipamDriver: map['ipamDriver'] == null ? null : map['ipamDriver'] as String,
      ipamOptions: map['ipamOptions'] == null ? null : (map['ipamOptions'] as Map).cast<String, String>(),
      ipv6: map['ipv6'] == null ? null : map['ipv6'] as bool,
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<NetworkLabel>(map['labels'], (value) => NetworkLabel.fromMap((value as Map).cast<String, dynamic>())),
