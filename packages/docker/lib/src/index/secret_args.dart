...
class SecretArgs {
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<SecretLabel>(map['labels'], (value) => SecretLabel.fromMap((value as Map).cast<String, dynamic>())),
