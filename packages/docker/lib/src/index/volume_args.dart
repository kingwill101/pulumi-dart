...
class VolumeArgs {
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      cluster: map['cluster'] == null ? null : VolumeCluster.fromMap((map['cluster'] as Map).cast<String, dynamic>()),
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<VolumeLabel>(map['labels'], (value) => VolumeLabel.fromMap((value as Map).cast<String, dynamic>())),
