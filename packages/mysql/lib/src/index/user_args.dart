...
class UserArgs {
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      authPlugin: map['authPlugin'] == null ? null : map['authPlugin'] as String,
      host: map['host'] == null ? null : map['host'] as String,
      password: map['password'] == null ? null : map['password'] as String,
      plaintextPassword: map['plaintextPassword'] == null ? null : map['plaintextPassword'] as String,
      tlsOption: map['tlsOption'] == null ? null : map['tlsOption'] as String,
