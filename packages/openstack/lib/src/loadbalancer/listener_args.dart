...
class ListenerArgs {
  ...
  ListenerArgs({
    ...
    int? hstsMaxAge,
    bool? hstsPreload,
    Map<String, String>? insertHeaders,
    required String loadbalancerId,
    String? name,
    required String protocol,
    required int protocolPort,
    String? region,
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      ...
      allowedCidrs: map['allowedCidrs'] == null ? null : (map['allowedCidrs'] as List).cast<String>(),
      alpnProtocols: map['alpnProtocols'] == null ? null : (map['alpnProtocols'] as List).cast<String>(),
      clientAuthentication: map['clientAuthentication'] == null ? null : map['clientAuthentication'] as String,
      clientCaTlsContainerRef: map['clientCaTlsContainerRef'] == null ? null : map['clientCaTlsContainerRef'] as String,
      clientCrlContainerRef: map['clientCrlContainerRef'] == null ? null : map['clientCrlContainerRef'] as String,
      connectionLimit: map['connectionLimit'] == null ? null : map['connectionLimit'] as int,
      defaultPoolId: map['defaultPoolId'] == null ? null : map['defaultPoolId'] as String,
      defaultTlsContainerRef: map['defaultTlsContainerRef'] == null ? null : map['defaultTlsContainerRef'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      hstsIncludeSubdomains: map['hstsIncludeSubdomains'] == null ? null : map['hstsIncludeSubdomains'] as bool,
      hstsMaxAge: map['hstsMaxAge'] == null ? null : map['hstsMaxAge'] as int,
      hstsPreload: map['hstsPreload'] == null ? null : map['hstsPreload'] as bool,
      insertHeaders: map['insertHeaders'] == null ? null : (map['insertHeaders'] as Map).cast<String, String>(),
      loadbalancerId: map['loadbalancerId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      protocol: map['protocol'] as String,
      protocolPort: map['protocolPort'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      sniContainerRefs: map['sniContainerRefs'] == null ? null : (map['sniContainerRefs'] as List).cast<String>(),
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      tenantId: map['tenantId'] == null ? null : map['tenantId'] as String,
      timeoutClientData: map['timeoutClientData'] == null ? null : map['timeoutClientData'] as int,
      timeoutMemberConnect: map['timeoutMemberConnect'] == null ? null : map['timeoutMemberConnect'] as int,
      timeoutMemberData: map['timeoutMemberData'] == null ? null : map['timeoutMemberData'] as int,
      timeoutTcpInspect: map['timeoutTcpInspect'] == null ? null : map['timeoutTcpInspect'] as int,
