...
class MembersArgs {
  ...
  factory MembersArgs.fromMap(Map<String, dynamic> map) {
    return MembersArgs(
      members: map['members'] == null ? null : pulumi.Input.decodeList<MembersMember>(map['members'], (value) => MembersMember.fromMap((value as Map).cast<String, dynamic>())),
