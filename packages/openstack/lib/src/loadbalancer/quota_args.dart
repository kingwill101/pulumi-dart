...
class QuotaArgs {
  ...
  factory QuotaArgs.fromMap(Map<String, dynamic> map) {
    return QuotaArgs(
      healthMonitor: map['healthMonitor'] == null ? null : map['healthMonitor'] as int,
      l7Policy: map['l7Policy'] == null ? null : map['l7Policy'] as int,
      l7Rule: map['l7Rule'] == null ? null : map['l7Rule'] as int,
      listener: map['listener'] == null ? null : map['listener'] as int,
      loadbalancer: map['loadbalancer'] == null ? null : map['loadbalancer'] as int,
      member: map['member'] == null ? null : map['member'] as int,
      pool: map['pool'] == null ? null : map['pool'] as int,
