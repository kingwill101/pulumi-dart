...
class PoolArgs {
  ...
  PoolArgs({
    ...
    String? description,
    required String lbMethod,
    String? listenerId,
    String? loadbalancerId,
    String? name,
    PoolPersistence? persistence,
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      caTlsContainerRef: map['caTlsContainerRef'] == null ? null : map['caTlsContainerRef'] as String,
      crlContainerRef: map['crlContainerRef'] == null ? null : map['crlContainerRef'] as String,
      ...
      persistence: map['persistence'] == null ? null : PoolPersistence.fromMap((map['persistence'] as Map).cast<String, dynamic>()),
      protocol: map['protocol'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      tenantId: map['tenantId'] == null ? null : map['tenantId'] as String,
      tlsCiphers: map['tlsCiphers'] == null ? null : map['tlsCiphers'] as String,
      tlsContainerRef: map['tlsContainerRef'] == null ? null : map['tlsContainerRef'] as String,
