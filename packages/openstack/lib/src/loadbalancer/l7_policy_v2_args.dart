...
class L7PolicyV2Args {
  ...
  factory L7PolicyV2Args.fromMap(Map<String, dynamic> map) {
    return L7PolicyV2Args(
      ...
      redirectHttpCode: map['redirectHttpCode'] == null ? null : map['redirectHttpCode'] as int,
      redirectPoolId: map['redirectPoolId'] == null ? null : map['redirectPoolId'] as String,
      redirectPrefix: map['redirectPrefix'] == null ? null : map['redirectPrefix'] as String,
