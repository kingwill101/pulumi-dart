...
class QuotaV2Args {
  ...
  factory QuotaV2Args.fromMap(Map<String, dynamic> map) {
    return QuotaV2Args(
      apiExportSize: map['apiExportSize'] == null ? null : map['apiExportSize'] as int,
      projectId: map['projectId'] as String,
      recordsetRecords: map['recordsetRecords'] == null ? null : map['recordsetRecords'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      zoneRecords: map['zoneRecords'] == null ? null : map['zoneRecords'] as int,
      zoneRecordsets: map['zoneRecordsets'] == null ? null : map['zoneRecordsets'] as int,
      zones: map['zones'] == null ? null : map['zones'] as int,
    );
  }
}
