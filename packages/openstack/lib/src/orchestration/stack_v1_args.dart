...
class StackV1Args {
  ...
  StackV1Args({
    List<StackV1StackOutput>? stackOutputs,
    List<String>? capabilities,
    String? creationTime,
    String? description,
    bool? disableRollback,
    Map<String, String>? environmentOpts,
    String? name,
    ...
    required Map<String, String> templateOpts,
    int? timeout,
    String? updatedTime,
  }) :
  ...
  factory StackV1Args.fromMap(Map<String, dynamic> map) {
    return StackV1Args(
      stackOutputs: map['StackOutputs'] == null ? null : pulumi.Input.decodeList<StackV1StackOutput>(map['StackOutputs'], (value) => StackV1StackOutput.fromMap((value as Map).cast<String, dynamic>())),
      ...
      environmentOpts: map['environmentOpts'] == null ? null : (map['environmentOpts'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      notificationTopics: map['notificationTopics'] == null ? null : (map['notificationTopics'] as List).cast<String>(),
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      region: map['region'] == null ? null : map['region'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      statusReason: map['statusReason'] == null ? null : map['statusReason'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      templateDescription: map['templateDescription'] == null ? null : map['templateDescription'] as String,
      templateOpts: (map['templateOpts'] as Map).cast<String, String>(),
