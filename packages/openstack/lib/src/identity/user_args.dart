...
class UserArgs {
  ...
  UserArgs({
    ...
    bool? ignoreChangePasswordUponFirstUse,
    bool? ignoreLockoutFailureAttempts,
    bool? ignorePasswordExpiry,
    bool? multiFactorAuthEnabled,
    List<UserMultiFactorAuthRule>? multiFactorAuthRules,
    String? name,
    String? password,
    String? region,
  }) :
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      defaultProjectId: map['defaultProjectId'] == null ? null : map['defaultProjectId'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      domainId: map['domainId'] == null ? null : map['domainId'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      extra: map['extra'] == null ? null : (map['extra'] as Map).cast<String, String>(),
      ignoreChangePasswordUponFirstUse: map['ignoreChangePasswordUponFirstUse'] == null ? null : map['ignoreChangePasswordUponFirstUse'] as bool,
      ignoreLockoutFailureAttempts: map['ignoreLockoutFailureAttempts'] == null ? null : map['ignoreLockoutFailureAttempts'] as bool,
      ignorePasswordExpiry: map['ignorePasswordExpiry'] == null ? null : map['ignorePasswordExpiry'] as bool,
      multiFactorAuthEnabled: map['multiFactorAuthEnabled'] == null ? null : map['multiFactorAuthEnabled'] as bool,
      multiFactorAuthRules: map['multiFactorAuthRules'] == null ? null : pulumi.Input.decodeList<UserMultiFactorAuthRule>(map['multiFactorAuthRules'], (value) => UserMultiFactorAuthRule.fromMap((value as Map).cast<String, dynamic>())),
