...
class SiteConnectionArgs {
  ...
  SiteConnectionArgs({
    bool? adminStateUp,
    String? description,
    List<SiteConnectionDpd>? dpds,
    required String ikepolicyId,
    String? initiator,
    required String ipsecpolicyId,
    ...
    String? peerEpGroupId,
    required String peerId,
    required String psk,
    String? region,
    String? tenantId,
    Map<String, String>? valueSpecs,
    required String vpnserviceId,
  }) :
  ...
  factory SiteConnectionArgs.fromMap(Map<String, dynamic> map) {
    return SiteConnectionArgs(
      ...
      dpds: map['dpds'] == null ? null : pulumi.Input.decodeList<SiteConnectionDpd>(map['dpds'], (value) => SiteConnectionDpd.fromMap((value as Map).cast<String, dynamic>())),
      ikepolicyId: map['ikepolicyId'] as String,
      initiator: map['initiator'] == null ? null : map['initiator'] as String,
      ipsecpolicyId: map['ipsecpolicyId'] as String,
      localEpGroupId: map['localEpGroupId'] == null ? null : map['localEpGroupId'] as String,
      ...
      peerCidrs: map['peerCidrs'] == null ? null : (map['peerCidrs'] as List).cast<String>(),
      peerEpGroupId: map['peerEpGroupId'] == null ? null : map['peerEpGroupId'] as String,
      ...
      vpnserviceId: map['vpnserviceId'] as String,
    );
  }
}
