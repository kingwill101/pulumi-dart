...
class ContainerObjectArgs {
  ...
  factory ContainerObjectArgs.fromMap(Map<String, dynamic> map) {
    return ContainerObjectArgs(
      ...
      copyFrom: map['copyFrom'] == null ? null : map['copyFrom'] as String,
      deleteAfter: map['deleteAfter'] == null ? null : map['deleteAfter'] as int,
      deleteAt: map['deleteAt'] == null ? null : map['deleteAt'] as String,
      detectContentType: map['detectContentType'] == null ? null : map['detectContentType'] as bool,
      etag: map['etag'] == null ? null : map['etag'] as String,
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      objectManifest: map['objectManifest'] == null ? null : map['objectManifest'] as String,
