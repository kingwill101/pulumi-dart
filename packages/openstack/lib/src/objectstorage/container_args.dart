...
class ContainerArgs {
  ...
  ContainerArgs({
    String? containerRead,
    String? containerSyncKey,
    String? containerSyncTo,
    String? containerWrite,
    String? contentType,
    bool? forceDestroy,
    ...
    bool? versioning,
    ContainerVersioningLegacy? versioningLegacy,
  }) :
  ...
  factory ContainerArgs.fromMap(Map<String, dynamic> map) {
    return ContainerArgs(
      containerRead: map['containerRead'] == null ? null : map['containerRead'] as String,
      containerSyncKey: map['containerSyncKey'] == null ? null : map['containerSyncKey'] as String,
      containerSyncTo: map['containerSyncTo'] == null ? null : map['containerSyncTo'] as String,
      containerWrite: map['containerWrite'] == null ? null : map['containerWrite'] as String,
      ...
      storagePolicy: map['storagePolicy'] == null ? null : map['storagePolicy'] as String,
      versioning: map['versioning'] == null ? null : map['versioning'] as bool,
      versioningLegacy: map['versioningLegacy'] == null ? null : ContainerVersioningLegacy.fromMap((map['versioningLegacy'] as Map).cast<String, dynamic>()),
    );
  }
}
