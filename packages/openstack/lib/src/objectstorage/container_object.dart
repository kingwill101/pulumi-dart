...
class ContainerObject extends pulumi.CustomResource {
  ...
  ContainerObject(
    ...
    this.copyFrom = registerOutput<String?>('copyFrom');
    this.date = registerOutput<String>('date');
    this.deleteAfter = registerOutput<int?>('deleteAfter');
    this.deleteAt = registerOutput<String>('deleteAt');
    this.detectContentType = registerOutput<bool?>('detectContentType');
    this.etag = registerOutput<String>('etag');
    this.lastModified = registerOutput<String>('lastModified');
    this.metadata = registerOutput<Map<String, String>?>('metadata');
    this.name = registerOutput<String>('name');
    this.objectManifest = registerOutput<String>('objectManifest');
    this.region = registerOutput<String>('region');
    this.source = registerOutput<String?>('source');
    this.transId = registerOutput<String>('transId');
  }
}
