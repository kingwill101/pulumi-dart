...
class VolumeArgs {
  ...
  VolumeArgs({
    ...
    String? description,
    bool? enableOnlineResize,
    String? imageId,
    Map<String, String>? metadata,
    String? name,
    String? region,
    List<VolumeSchedulerHint>? schedulerHints,
    required int size,
    String? snapshotId,
    String? sourceReplica,
    String? sourceVolId,
    String? volumeRetypePolicy,
    String? volumeType,
  }) :
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      ...
      consistencyGroupId: map['consistencyGroupId'] == null ? null : map['consistencyGroupId'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      enableOnlineResize: map['enableOnlineResize'] == null ? null : map['enableOnlineResize'] as bool,
      imageId: map['imageId'] == null ? null : map['imageId'] as String,
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      schedulerHints: map['schedulerHints'] == null ? null : pulumi.Input.decodeList<VolumeSchedulerHint>(map['schedulerHints'], (value) => VolumeSchedulerHint.fromMap((value as Map).cast<String, dynamic>())),
      size: map['size'] as int,
      snapshotId: map['snapshotId'] == null ? null : map['snapshotId'] as String,
      sourceReplica: map['sourceReplica'] == null ? null : map['sourceReplica'] as String,
      sourceVolId: map['sourceVolId'] == null ? null : map['sourceVolId'] as String,
      volumeRetypePolicy: map['volumeRetypePolicy'] == null ? null : map['volumeRetypePolicy'] as String,
