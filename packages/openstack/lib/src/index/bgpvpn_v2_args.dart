...
class BgpvpnV2Args {
  ...
  factory BgpvpnV2Args.fromMap(Map<String, dynamic> map) {
    return BgpvpnV2Args(
      exportTargets: map['exportTargets'] == null ? null : (map['exportTargets'] as List).cast<String>(),
      importTargets: map['importTargets'] == null ? null : (map['importTargets'] as List).cast<String>(),
      localPref: map['localPref'] == null ? null : map['localPref'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      projectId: map['projectId'] == null ? null : map['projectId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      routeDistinguishers: map['routeDistinguishers'] == null ? null : (map['routeDistinguishers'] as List).cast<String>(),
      routeTargets: map['routeTargets'] == null ? null : (map['routeTargets'] as List).cast<String>(),
