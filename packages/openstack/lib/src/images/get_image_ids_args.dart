...
/// {@template pulumi_images_get_image_ids_get_image_ids_args_doc}
/// Arguments for getImageIds.
/// {@endtemplate}
/// {@macro pulumi_images_get_image_ids_get_image_ids_args_doc}
class GetImageIdsArgs {
  ...
  factory GetImageIdsArgs.fromMap(Map<String, dynamic> map) {
    return GetImageIdsArgs(
