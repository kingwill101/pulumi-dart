...
class Image extends pulumi.CustomResource {
  ...
  Image(
    ...
    this.containerFormat = registerOutput<String>('containerFormat');
    this.createdAt = registerOutput<String>('createdAt');
    this.decompress = registerOutput<bool?>('decompress');
    this.diskFormat = registerOutput<String>('diskFormat');
    this.file = registerOutput<String>('file');
    this.hidden = registerOutput<bool?>('hidden');
    this.imageCachePath = registerOutput<String?>('imageCachePath');
    this.imageId = registerOutput<String>('imageId');
    this.imageSourcePassword = registerOutput<String?>('imageSourcePassword');
    this.imageSourceUrl = registerOutput<String?>('imageSourceUrl');
    this.imageSourceUsername = registerOutput<String?>('imageSourceUsername');
    this.localFilePath = registerOutput<String?>('localFilePath');
    this.metadata = registerOutput<Map<String, String>>('metadata');
    this.minDiskGb = registerOutput<int?>('minDiskGb');
    this.minRamMb = registerOutput<int?>('minRamMb');
    this.name = registerOutput<String>('name');
    this.owner = registerOutput<String>('owner');
    this.properties = registerOutput<Map<String, String>>('properties');
    this.protected = registerOutput<bool?>('protected');
    ...
    this.verifyChecksum = registerOutput<bool?>('verifyChecksum');
    this.visibility = registerOutput<String?>('visibility');
    this.webDownload = registerOutput<bool?>('webDownload');
  }
}
