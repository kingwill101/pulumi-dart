...
class ContainerV1Args {
  ...
  ContainerV1Args({
    ...
    String? name,
    String? region,
    List<ContainerV1SecretRef>? secretRefs,
  ...
  factory ContainerV1Args.fromMap(Map<String, dynamic> map) {
    return ContainerV1Args(
      acl: map['acl'] == null ? null : ContainerV1Acl.fromMap((map['acl'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      secretRefs: map['secretRefs'] == null ? null : pulumi.Input.decodeList<ContainerV1SecretRef>(map['secretRefs'], (value) => ContainerV1SecretRef.fromMap((value as Map).cast<String, dynamic>())),
