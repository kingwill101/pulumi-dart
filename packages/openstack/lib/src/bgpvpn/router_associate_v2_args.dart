...
/// {@template pulumi_bgpvpn_router_associate_v2_router_associate_v2_args_doc}
/// The set of arguments for RouterAssociateV2.
/// {@endtemplate}
/// {@macro pulumi_bgpvpn_router_associate_v2_router_associate_v2_args_doc}
class RouterAssociateV2Args {
  ...
  /// Creates a new [RouterAssociateV2Args].
  ...
  factory RouterAssociateV2Args.fromMap(Map<String, dynamic> map) {
    return RouterAssociateV2Args(
      advertiseExtraRoutes: map['advertiseExtraRoutes'] == null ? null : map['advertiseExtraRoutes'] as bool,
