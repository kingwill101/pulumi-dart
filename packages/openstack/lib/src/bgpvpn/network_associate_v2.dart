...
import 'network_associate_v2_args.dart';
...
class NetworkAssociateV2 extends pulumi.CustomResource {
  ...
  /// Creates a new [NetworkAssociateV2].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NetworkAssociateV2]. {@macro pulumi_bgpvpn_network_associate_v2_network_associate_v2_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  NetworkAssociateV2(
    String name, {
    NetworkAssociateV2Args? args,
