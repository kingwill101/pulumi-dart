...
class PortForwardingV2Args {
  ...
  PortForwardingV2Args({
    ...
    required String floatingipId,
    required String internalIpAddress,
    required int internalPort,
    required String internalPortId,
  ...
  factory PortForwardingV2Args.fromMap(Map<String, dynamic> map) {
    return PortForwardingV2Args(
      ...
      floatingipId: map['floatingipId'] as String,
      internalIpAddress: map['internalIpAddress'] as String,
      internalPort: map['internalPort'] as int,
      internalPortId: map['internalPortId'] as String,
