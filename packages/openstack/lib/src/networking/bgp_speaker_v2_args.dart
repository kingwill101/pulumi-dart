...
class BgpSpeakerV2Args {
  ...
  BgpSpeakerV2Args({
    bool? advertiseFloatingIpHostRoutes,
    bool? advertiseTenantNetworks,
    int? ipVersion,
    required int localAs,
    String? name,
    ...
    String? tenantId,
      ...
      localAs = pulumi.Input.asInput<int>(localAs),
  ...
  factory BgpSpeakerV2Args.fromMap(Map<String, dynamic> map) {
    return BgpSpeakerV2Args(
      advertiseFloatingIpHostRoutes: map['advertiseFloatingIpHostRoutes'] == null ? null : map['advertiseFloatingIpHostRoutes'] as bool,
      advertiseTenantNetworks: map['advertiseTenantNetworks'] == null ? null : map['advertiseTenantNetworks'] as bool,
      ipVersion: map['ipVersion'] == null ? null : map['ipVersion'] as int,
      localAs: map['localAs'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      networks: map['networks'] == null ? null : (map['networks'] as List).cast<String>(),
