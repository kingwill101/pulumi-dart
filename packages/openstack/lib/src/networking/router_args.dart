...
class RouterArgs {
  ...
  RouterArgs({
    ...
    bool? distributed,
    bool? enableSnat,
    List<RouterExternalFixedIp>? externalFixedIps,
    String? externalNetworkId,
    String? externalQosPolicyId,
    List<String>? externalSubnetIds,
    String? name,
    String? region,
    List<String>? tags,
    String? tenantId,
    Map<String, String>? valueSpecs,
    RouterVendorOptions? vendorOptions,
  }) :
  ...
  factory RouterArgs.fromMap(Map<String, dynamic> map) {
    return RouterArgs(
      ...
      availabilityZoneHints: map['availabilityZoneHints'] == null ? null : (map['availabilityZoneHints'] as List).cast<String>(),
      ...
      externalFixedIps: map['externalFixedIps'] == null ? null : pulumi.Input.decodeList<RouterExternalFixedIp>(map['externalFixedIps'], (value) => RouterExternalFixedIp.fromMap((value as Map).cast<String, dynamic>())),
      externalNetworkId: map['externalNetworkId'] == null ? null : map['externalNetworkId'] as String,
      externalQosPolicyId: map['externalQosPolicyId'] == null ? null : map['externalQosPolicyId'] as String,
      externalSubnetIds: map['externalSubnetIds'] == null ? null : (map['externalSubnetIds'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      tenantId: map['tenantId'] == null ? null : map['tenantId'] as String,
      valueSpecs: map['valueSpecs'] == null ? null : (map['valueSpecs'] as Map).cast<String, String>(),
      vendorOptions: map['vendorOptions'] == null ? null : RouterVendorOptions.fromMap((map['vendorOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
