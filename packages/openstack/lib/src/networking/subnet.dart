...
class Subnet extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SubnetAllocationPool>> allocationPools;
  ...
  Subnet(
    ...
    this.allocationPools = registerOutput<List<SubnetAllocationPool>>('allocationPools');
    this.cidr = registerOutput<String>('cidr');
    this.description = registerOutput<String?>('description');
    this.dnsNameservers = registerOutput<List<String>?>('dnsNameservers');
    this.dnsPublishFixedIp = registerOutput<bool?>('dnsPublishFixedIp');
    this.enableDhcp = registerOutput<bool?>('enableDhcp');
    this.gatewayIp = registerOutput<String>('gatewayIp');
    this.ipVersion = registerOutput<int?>('ipVersion');
    this.ipv6AddressMode = registerOutput<String>('ipv6AddressMode');
    this.ipv6RaMode = registerOutput<String>('ipv6RaMode');
    this.name = registerOutput<String>('name');
    this.networkId = registerOutput<String>('networkId');
    this.noGateway = registerOutput<bool?>('noGateway');
    this.prefixLength = registerOutput<int?>('prefixLength');
    this.region = registerOutput<String>('region');
    this.segmentId = registerOutput<String?>('segmentId');
    this.serviceTypes = registerOutput<List<String>>('serviceTypes');
    this.subnetpoolId = registerOutput<String?>('subnetpoolId');
