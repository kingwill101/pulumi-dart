...
class SubnetArgs {
  ...
  SubnetArgs({
    List<SubnetAllocationPool>? allocationPools,
    String? cidr,
    String? description,
  ...
  factory SubnetArgs.fromMap(Map<String, dynamic> map) {
    return SubnetArgs(
      allocationPools: map['allocationPools'] == null ? null : pulumi.Input.decodeList<SubnetAllocationPool>(map['allocationPools'], (value) => SubnetAllocationPool.fromMap((value as Map).cast<String, dynamic>())),
      cidr: map['cidr'] == null ? null : map['cidr'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      dnsNameservers: map['dnsNameservers'] == null ? null : (map['dnsNameservers'] as List).cast<String>(),
      dnsPublishFixedIp: map['dnsPublishFixedIp'] == null ? null : map['dnsPublishFixedIp'] as bool,
      enableDhcp: map['enableDhcp'] == null ? null : map['enableDhcp'] as bool,
      ...
      ipv6RaMode: map['ipv6RaMode'] == null ? null : map['ipv6RaMode'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkId: map['networkId'] as String,
      noGateway: map['noGateway'] == null ? null : map['noGateway'] as bool,
      ...
      serviceTypes: map['serviceTypes'] == null ? null : (map['serviceTypes'] as List).cast<String>(),
