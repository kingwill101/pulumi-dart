...
class TrunkArgs {
  ...
  factory TrunkArgs.fromMap(Map<String, dynamic> map) {
    return TrunkArgs(
      ...
      subPorts: map['subPorts'] == null ? null : pulumi.Input.decodeList<TrunkSubPort>(map['subPorts'], (value) => TrunkSubPort.fromMap((value as Map).cast<String, dynamic>())),
