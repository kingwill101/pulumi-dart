...
class RouterRoutesV2Args {
  ...
  RouterRoutesV2Args({
    ...
    List<RouterRoutesV2Route>? routes,
  }) :
  ...
  factory RouterRoutesV2Args.fromMap(Map<String, dynamic> map) {
    return RouterRoutesV2Args(
      ...
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<RouterRoutesV2Route>(map['routes'], (value) => RouterRoutesV2Route.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
