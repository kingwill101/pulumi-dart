...
class GetInstanceV2Args {
  ...
  GetInstanceV2Args({
    required String id,
    List<GetInstanceV2Network>? networks,
    String? region,
    String? userData,
  }) :
  ...
  factory GetInstanceV2Args.fromMap(Map<String, dynamic> map) {
    return GetInstanceV2Args(
      id: map['id'] as String,
      networks: map['networks'] == null ? null : pulumi.Input.decodeList<GetInstanceV2Network>(map['networks'], (value) => GetInstanceV2Network.fromMap((value as Map).cast<String, dynamic>())),
