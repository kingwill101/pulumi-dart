...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? availabilityZoneHints,
    List<InstanceBlockDevice>? blockDevices,
    bool? configDrive,
    String? flavorId,
    String? flavorName,
    bool? forceDelete,
    ...
    List<InstancePersonality>? personalities,
    String? powerState,
    String? region,
    List<InstanceSchedulerHint>? schedulerHints,
    List<String>? securityGroups,
    bool? stopBeforeDestroy,
    List<String>? tags,
    String? userData,
    InstanceVendorOptions? vendorOptions,
  }) :
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      availabilityZoneHints: map['availabilityZoneHints'] == null ? null : map['availabilityZoneHints'] as String,
      blockDevices: map['blockDevices'] == null ? null : pulumi.Input.decodeList<InstanceBlockDevice>(map['blockDevices'], (value) => InstanceBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      configDrive: map['configDrive'] == null ? null : map['configDrive'] as bool,
      flavorId: map['flavorId'] == null ? null : map['flavorId'] as String,
      flavorName: map['flavorName'] == null ? null : map['flavorName'] as String,
      forceDelete: map['forceDelete'] == null ? null : map['forceDelete'] as bool,
      hypervisorHostname: map['hypervisorHostname'] == null ? null : map['hypervisorHostname'] as String,
      ...
      personalities: map['personalities'] == null ? null : pulumi.Input.decodeList<InstancePersonality>(map['personalities'], (value) => InstancePersonality.fromMap((value as Map).cast<String, dynamic>())),
      powerState: map['powerState'] == null ? null : map['powerState'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      schedulerHints: map['schedulerHints'] == null ? null : pulumi.Input.decodeList<InstanceSchedulerHint>(map['schedulerHints'], (value) => InstanceSchedulerHint.fromMap((value as Map).cast<String, dynamic>())),
      securityGroups: map['securityGroups'] == null ? null : (map['securityGroups'] as List).cast<String>(),
      stopBeforeDestroy: map['stopBeforeDestroy'] == null ? null : map['stopBeforeDestroy'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      userData: map['userData'] == null ? null : map['userData'] as String,
      vendorOptions: map['vendorOptions'] == null ? null : InstanceVendorOptions.fromMap((map['vendorOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
