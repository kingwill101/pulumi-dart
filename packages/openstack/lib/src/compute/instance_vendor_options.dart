...
class InstanceVendorOptions {
  ...
  final bool? detachPortsBeforeDestroy;
  /// Boolean to control whether
  /// to ignore manual confirmation of the instance resizing. This can be helpful
  /// to work with some OpenStack clouds which automatically confirm resizing of
  /// instances after some timeout.
  final bool? ignoreResizeConfirmation;
  ...
  factory InstanceVendorOptions.fromMap(Map<String, dynamic> map) {
    return InstanceVendorOptions(
      detachPortsBeforeDestroy: map['detachPortsBeforeDestroy'] == null ? null : map['detachPortsBeforeDestroy'] as bool,
      ignoreResizeConfirmation: map['ignoreResizeConfirmation'] == null ? null : map['ignoreResizeConfirmation'] as bool,
    );
  }
}
