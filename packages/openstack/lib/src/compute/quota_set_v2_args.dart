...
/// {@template pulumi_compute_quota_set_v2_quota_set_v2_args_doc}
/// The set of arguments for QuotaSetV2.
/// {@endtemplate}
/// {@macro pulumi_compute_quota_set_v2_quota_set_v2_args_doc}
class QuotaSetV2Args {
  ...
  factory QuotaSetV2Args.fromMap(Map<String, dynamic> map) {
    return QuotaSetV2Args(
      ...
      fixedIps: map['fixedIps'] == null ? null : map['fixedIps'] as int,
      floatingIps: map['floatingIps'] == null ? null : map['floatingIps'] as int,
      injectedFileContentBytes: map['injectedFileContentBytes'] == null ? null : map['injectedFileContentBytes'] as int,
      injectedFilePathBytes: map['injectedFilePathBytes'] == null ? null : map['injectedFilePathBytes'] as int,
      injectedFiles: map['injectedFiles'] == null ? null : map['injectedFiles'] as int,
      instances: map['instances'] == null ? null : map['instances'] as int,
      keyPairs: map['keyPairs'] == null ? null : map['keyPairs'] as int,
      metadataItems: map['metadataItems'] == null ? null : map['metadataItems'] as int,
      projectId: map['projectId'] as String,
      ram: map['ram'] == null ? null : map['ram'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      securityGroupRules: map['securityGroupRules'] == null ? null : map['securityGroupRules'] as int,
      securityGroups: map['securityGroups'] == null ? null : map['securityGroups'] as int,
      serverGroupMembers: map['serverGroupMembers'] == null ? null : map['serverGroupMembers'] as int,
      serverGroups: map['serverGroups'] == null ? null : map['serverGroups'] as int,
    );
  }
}
