...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.autoResolveBestVoicesEnabled = registerOutput<bool?>(
      'autoResolveBestVoicesEnabled',
    );
    this.contactFlowLogsEnabled = registerOutput<bool?>(
    ...
    this.identityManagementType = registerOutput<String>(
    ...
    this.multiPartyConferenceEnabled = registerOutput<bool?>(
