...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      autoResolveBestVoicesEnabled: map['autoResolveBestVoicesEnabled'] == null ? null : map['autoResolveBestVoicesEnabled'] as bool,
      contactFlowLogsEnabled: map['contactFlowLogsEnabled'] == null ? null : map['contactFlowLogsEnabled'] as bool,
      contactLensEnabled: map['contactLensEnabled'] == null ? null : map['contactLensEnabled'] as bool,
      directoryId: map['directoryId'] == null ? null : map['directoryId'] as String,
      earlyMediaEnabled: map['earlyMediaEnabled'] == null ? null : map['earlyMediaEnabled'] as bool,
      ...
      multiPartyConferenceEnabled: map['multiPartyConferenceEnabled'] == null ? null : map['multiPartyConferenceEnabled'] as bool,
