...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    Map<String, String>? tags,
       ...
       contactFlowLogsEnabled = pulumi.Input.asOptionalInput<bool>(
         contactFlowLogsEnabled,
       ),
       contactLensEnabled = pulumi.Input.asOptionalInput<bool>(
         contactLensEnabled,
       ),
       directoryId = pulumi.Input.asOptionalInput<String>(directoryId),
       earlyMediaEnabled = pulumi.Input.asOptionalInput<bool>(
         earlyMediaEnabled,
       ),
       identityManagementType = pulumi.Input.asInput<String>(
