...
class UserArgs {
  ...
  UserArgs({
    ...
    Map<String, String>? tags,
       ...
       identityInfo = pulumi.Input.asOptionalInput<UserIdentityInfo>(
         identityInfo,
       ),
       ...
       securityProfileIds = pulumi.Input.asInput<List<String>>(
         securityProfileIds,
       ),
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      directoryUserId: map['directoryUserId'] == null
          ? null
          : map['directoryUserId'] as String,
      hierarchyGroupId: map['hierarchyGroupId'] == null
          ? null
          : map['hierarchyGroupId'] as String,
      identityInfo: map['identityInfo'] == null
          ? null
          : UserIdentityInfo.fromMap(
              (map['identityInfo'] as Map).cast<String, dynamic>(),
            ),
      instanceId: map['instanceId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      password: map['password'] == null ? null : map['password'] as String,
      phoneConfig: UserPhoneConfig.fromMap(
