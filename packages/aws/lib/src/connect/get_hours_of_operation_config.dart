...
class GetHoursOfOperationConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'day': day,
      'endTimes': pulumi.Input.encodeList<GetHoursOfOperationConfigEndTime, Map<String, dynamic>>(endTimes, (value) => value.toMap()),
      'startTimes': pulumi.Input.encodeList<GetHoursOfOperationConfigStartTime, Map<String, dynamic>>(startTimes, (value) => value.toMap()),
    };
  }
  ...
  factory GetHoursOfOperationConfig.fromMap(Map<String, dynamic> map) {
    return GetHoursOfOperationConfig(
      ...
      endTimes: pulumi.Input.decodeList<GetHoursOfOperationConfigEndTime>(map['endTimes'], (value) => GetHoursOfOperationConfigEndTime.fromMap((value as Map).cast<String, dynamic>())),
      startTimes: pulumi.Input.decodeList<GetHoursOfOperationConfigStartTime>(map['startTimes'], (value) => GetHoursOfOperationConfigStartTime.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
