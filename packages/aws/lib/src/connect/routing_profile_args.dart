...
class RoutingProfileArgs {
  ...
  RoutingProfileArgs({
    ...
    required List<RoutingProfileMediaConcurrency> mediaConcurrencies,
    String? name,
  ...
  factory RoutingProfileArgs.fromMap(Map<String, dynamic> map) {
    return RoutingProfileArgs(
      ...
      mediaConcurrencies: pulumi.Input.decodeList<RoutingProfileMediaConcurrency>(map['mediaConcurrencies'], (value) => RoutingProfileMediaConcurrency.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      queueConfigs: map['queueConfigs'] == null ? null : pulumi.Input.decodeList<RoutingProfileQueueConfig>(map['queueConfigs'], (value) => RoutingProfileQueueConfig.fromMap((value as Map).cast<String, dynamic>())),
