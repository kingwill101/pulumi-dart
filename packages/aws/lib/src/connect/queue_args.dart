...
class QueueArgs {
  ...
  QueueArgs({
    ...
    int? maxContacts,
    String? name,
    QueueOutboundCallerConfig? outboundCallerConfig,
    ...
    Map<String, String>? tags,
       ...
       quickConnectIds = pulumi.Input.asOptionalInput<List<String>>(
         quickConnectIds,
       ),
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      ...
      maxContacts: map['maxContacts'] == null
          ? null
          : map['maxContacts'] as int,
