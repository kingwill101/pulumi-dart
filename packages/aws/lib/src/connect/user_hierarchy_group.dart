...
class UserHierarchyGroup extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [UserHierarchyGroup]. {@macro pulumi_connect_user_hierarchy_group_user_hierarchy_group_args_doc}
  ...
  UserHierarchyGroup(
    ...
    this.hierarchyPaths = registerOutput<List<UserHierarchyGroupHierarchyPath>>(
      'hierarchyPaths',
    );
