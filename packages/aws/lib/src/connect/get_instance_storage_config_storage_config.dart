...
class GetInstanceStorageConfigStorageConfig {
  ...
  final List<GetInstanceStorageConfigStorageConfigKinesisFirehoseConfig>
  kinesisFirehoseConfigs;

  /// A block that specifies the configuration of the Kinesis data stream. Documented below.
  final List<GetInstanceStorageConfigStorageConfigKinesisStreamConfig>
  kinesisStreamConfigs;

  /// A block that specifies the configuration of the Kinesis video stream. Documented below.
  final List<GetInstanceStorageConfigStorageConfigKinesisVideoStreamConfig>
    ...
    return <String, dynamic>{
      'kinesisFirehoseConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(kinesisFirehoseConfigs, (value) => value.toMap()),
      'kinesisStreamConfigs':
          pulumi.Input.encodeList<
            GetInstanceStorageConfigStorageConfigKinesisStreamConfig,
            Map<String, dynamic>
          >(kinesisStreamConfigs, (value) => value.toMap()),
      'kinesisVideoStreamConfigs':
          pulumi.Input.encodeList<
