...
class InstanceStorageConfigArgs {
  ...
  InstanceStorageConfigArgs({
    ...
    required InstanceStorageConfigStorageConfig storageConfig,
  })  : instanceId = pulumi.Input.asInput<String>(instanceId),
        region = pulumi.Input.asOptionalInput<String>(region),
        resourceType = pulumi.Input.asInput<String>(resourceType),
        storageConfig =
            pulumi.Input.asInput<InstanceStorageConfigStorageConfig>(
                storageConfig);
  ...
  factory InstanceStorageConfigArgs.fromMap(Map<String, dynamic> map) {
    return InstanceStorageConfigArgs(
      ...
      storageConfig: InstanceStorageConfigStorageConfig.fromMap(
