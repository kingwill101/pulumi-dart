...
class RoutingProfileMediaConcurrency {
  ...
  final RoutingProfileMediaConcurrencyCrossChannelBehavior? crossChannelBehavior;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crossChannelBehavior': ?crossChannelBehavior == null ? null : crossChannelBehavior!.toMap(),
    };
  }
  ...
  factory RoutingProfileMediaConcurrency.fromMap(Map<String, dynamic> map) {
    return RoutingProfileMediaConcurrency(
      ...
      crossChannelBehavior: map['crossChannelBehavior'] == null ? null : RoutingProfileMediaConcurrencyCrossChannelBehavior.fromMap((map['crossChannelBehavior'] as Map).cast<String, dynamic>()),
    );
  }
}
