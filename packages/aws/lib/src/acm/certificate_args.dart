...
class CertificateArgs {
  ...
  CertificateArgs({
    ...
    List<CertificateValidationOption>? validationOptions,
            ...
            pulumi.Input.asOptionalInput<String>(certificateAuthorityArn),
        ...
        earlyRenewalDuration =
            pulumi.Input.asOptionalInput<String>(earlyRenewalDuration),
        ...
        subjectAlternativeNames =
            pulumi.Input.asOptionalInput<List<String>>(subjectAlternativeNames),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        validationMethod =
            pulumi.Input.asOptionalInput<String>(validationMethod),
        validationOptions =
