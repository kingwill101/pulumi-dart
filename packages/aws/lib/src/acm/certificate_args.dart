...
class CertificateArgs {
  ...
  factory CertificateArgs.fromMap(Map<String, dynamic> map) {
    return CertificateArgs(
      ...
      earlyRenewalDuration: map['earlyRenewalDuration'] == null ? null : map['earlyRenewalDuration'] as String,
      keyAlgorithm: map['keyAlgorithm'] == null ? null : map['keyAlgorithm'] as String,
      options: map['options'] == null ? null : CertificateOptions.fromMap((map['options'] as Map).cast<String, dynamic>()),
      ...
      validationMethod: map['validationMethod'] == null ? null : map['validationMethod'] as String,
      validationOptions: map['validationOptions'] == null ? null : pulumi.Input.decodeList<CertificateValidationOption>(map['validationOptions'], (value) => CertificateValidationOption.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
