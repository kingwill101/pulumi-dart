...
class LifecyclePolicyResourceSelection {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'recipes': ?recipes == null ? null : pulumi.Input.encodeList<LifecyclePolicyResourceSelectionRecipe, Map<String, dynamic>>(recipes!, (value) => value.toMap()),
      'tagMap': ?tagMap,
    };
  }
  ...
  factory LifecyclePolicyResourceSelection.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyResourceSelection(
      recipes: map['recipes'] == null ? null : pulumi.Input.decodeList<LifecyclePolicyResourceSelectionRecipe>(map['recipes'], (value) => LifecyclePolicyResourceSelectionRecipe.fromMap((value as Map).cast<String, dynamic>())),
