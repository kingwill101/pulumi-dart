...
class DistributionConfigurationArgs {
  ...
  factory DistributionConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return DistributionConfigurationArgs(
      ...
      distributions: pulumi.Input.decodeList<DistributionConfigurationDistribution>(map['distributions'], (value) => DistributionConfigurationDistribution.fromMap((value as Map).cast<String, dynamic>())),
