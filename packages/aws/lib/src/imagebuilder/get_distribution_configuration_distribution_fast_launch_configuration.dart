...
class GetDistributionConfigurationDistributionFastLaunchConfiguration {
  ...
  final List<GetDistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate> launchTemplates;
  ...
  final List<GetDistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration> snapshotConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accountId': accountId,
      'enabled': enabled,
      'launchTemplates': pulumi.Input.encodeList<GetDistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate, Map<String, dynamic>>(launchTemplates, (value) => value.toMap()),
      'maxParallelLaunches': maxParallelLaunches,
      'snapshotConfigurations': pulumi.Input.encodeList<GetDistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration, Map<String, dynamic>>(snapshotConfigurations, (value) => value.toMap()),
    };
  }
  ...
  factory GetDistributionConfigurationDistributionFastLaunchConfiguration.fromMap(Map<String, dynamic> map) {
    return GetDistributionConfigurationDistributionFastLaunchConfiguration(
      ...
      launchTemplates: pulumi.Input.decodeList<GetDistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate>(map['launchTemplates'], (value) => GetDistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate.fromMap((value as Map).cast<String, dynamic>())),
      maxParallelLaunches: map['maxParallelLaunches'] as int,
      snapshotConfigurations: pulumi.Input.decodeList<GetDistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration>(map['snapshotConfigurations'], (value) => GetDistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
