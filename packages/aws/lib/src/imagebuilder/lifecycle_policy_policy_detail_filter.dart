...
class LifecyclePolicyPolicyDetailFilter {
  ...
  Map<String, dynamic> toMap() {
    ...
    final retainAtLeastValue = retainAtLeast;
    if (retainAtLeastValue != null) {
      map['retainAtLeast'] = retainAtLeastValue;
    }
    map['type'] = type;
  ...
  factory LifecyclePolicyPolicyDetailFilter.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyPolicyDetailFilter(
      retainAtLeast:
          map['retainAtLeast'] == null ? null : map['retainAtLeast'] as int,
