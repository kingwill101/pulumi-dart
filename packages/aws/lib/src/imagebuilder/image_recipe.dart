...
class ImageRecipe extends pulumi.CustomResource {
  ...
  ImageRecipe(
    ...
    this.blockDeviceMappings = registerOutput<List<ImageRecipeBlockDeviceMapping>?>('blockDeviceMappings');
    ...
    this.systemsManagerAgent = registerOutput<ImageRecipeSystemsManagerAgent>('systemsManagerAgent');
