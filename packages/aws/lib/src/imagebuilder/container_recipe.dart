...
class ContainerRecipe extends pulumi.CustomResource {
  ...
  /// Creates a new [ContainerRecipe].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ContainerRecipe]. {@macro pulumi_imagebuilder_container_recipe_container_recipe_args_doc}
  ...
  ContainerRecipe(
    ...
    this.components = registerOutput<List<ContainerRecipeComponent>>('components');
    this.containerType = registerOutput<String>('containerType');
    this.dateCreated = registerOutput<String>('dateCreated');
    this.description = registerOutput<String?>('description');
    this.dockerfileTemplateData = registerOutput<String>('dockerfileTemplateData');
    this.dockerfileTemplateUri = registerOutput<String?>('dockerfileTemplateUri');
    this.encrypted = registerOutput<bool>('encrypted');
    this.instanceConfiguration = registerOutput<ContainerRecipeInstanceConfiguration?>('instanceConfiguration');
    ...
    this.targetRepository = registerOutput<ContainerRecipeTargetRepository>('targetRepository');
