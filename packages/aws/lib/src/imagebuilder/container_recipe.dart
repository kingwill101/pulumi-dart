...
class ContainerRecipe extends pulumi.CustomResource {
  ...
  ContainerRecipe(
    ...
    this.components = registerOutput<List<ContainerRecipeComponent>>(
      'components',
    );
    this.containerType = registerOutput<String>('containerType');
    this.dateCreated = registerOutput<String>('dateCreated');
    this.description = registerOutput<String?>('description');
    this.dockerfileTemplateData = registerOutput<String>(
      'dockerfileTemplateData',
    );
    this.dockerfileTemplateUri = registerOutput<String?>(
    ...
    this.targetRepository = registerOutput<ContainerRecipeTargetRepository>(
      'targetRepository',
    );
