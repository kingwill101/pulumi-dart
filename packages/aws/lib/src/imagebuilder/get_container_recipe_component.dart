...
class GetContainerRecipeComponent {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parameters': pulumi.Input.encodeList<GetContainerRecipeComponentParameter, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory GetContainerRecipeComponent.fromMap(Map<String, dynamic> map) {
    return GetContainerRecipeComponent(
      ...
      parameters: pulumi.Input.decodeList<GetContainerRecipeComponentParameter>(map['parameters'], (value) => GetContainerRecipeComponentParameter.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
