...
class Image extends pulumi.CustomResource {
  ...
  Image(String name, {ImageArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.distributionConfigurationArn = registerOutput<String?>(
      'distributionConfigurationArn',
    );
    this.enhancedImageMetadataEnabled = registerOutput<bool?>(
    ...
    this.imageTestsConfiguration = registerOutput<ImageImageTestsConfiguration>(
      'imageTestsConfiguration',
    );
    this.infrastructureConfigurationArn = registerOutput<String>(
      'infrastructureConfigurationArn',
    );
    this.loggingConfiguration = registerOutput<ImageLoggingConfiguration?>(
      'loggingConfiguration',
    );
    this.name = registerOutput<String>('name');
    this.osVersion = registerOutput<String>('osVersion');
    this.outputResources = registerOutput<List<ImageOutputResource>>(
      'outputResources',
    );
