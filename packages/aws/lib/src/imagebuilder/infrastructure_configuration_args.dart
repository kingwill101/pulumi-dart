...
class InfrastructureConfigurationArgs {
  ...
  factory InfrastructureConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return InfrastructureConfigurationArgs(
      ...
      instanceMetadataOptions: map['instanceMetadataOptions'] == null ? null : InfrastructureConfigurationInstanceMetadataOptions.fromMap((map['instanceMetadataOptions'] as Map).cast<String, dynamic>()),
      ...
      logging: map['logging'] == null ? null : InfrastructureConfigurationLogging.fromMap((map['logging'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      placement: map['placement'] == null ? null : InfrastructureConfigurationPlacement.fromMap((map['placement'] as Map).cast<String, dynamic>()),
      ...
      terminateInstanceOnFailure: map['terminateInstanceOnFailure'] == null ? null : map['terminateInstanceOnFailure'] as bool,
    );
  }
}
