...
class LifecyclePolicy extends pulumi.CustomResource {
  ...
  LifecyclePolicy(
    ...
    this.policyDetails = registerOutput<List<LifecyclePolicyPolicyDetail>>('policyDetails');
    this.region = registerOutput<String>('region');
    this.resourceSelection = registerOutput<LifecyclePolicyResourceSelection>('resourceSelection');
