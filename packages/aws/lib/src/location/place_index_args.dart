...
class PlaceIndexArgs {
  ...
  PlaceIndexArgs({
    ...
    PlaceIndexDataSourceConfiguration? dataSourceConfiguration,
    String? description,
  ...
  factory PlaceIndexArgs.fromMap(Map<String, dynamic> map) {
    return PlaceIndexArgs(
      ...
      dataSourceConfiguration: map['dataSourceConfiguration'] == null ? null : PlaceIndexDataSourceConfiguration.fromMap((map['dataSourceConfiguration'] as Map).cast<String, dynamic>()),
