...
class RuleArgs {
  ...
  factory RuleArgs.fromMap(Map<String, dynamic> map) {
    return RuleArgs(
      ...
      excludeResourceTags: map['excludeResourceTags'] == null ? null : pulumi.Input.decodeList<RuleExcludeResourceTag>(map['excludeResourceTags'], (value) => RuleExcludeResourceTag.fromMap((value as Map).cast<String, dynamic>())),
      lockConfiguration: map['lockConfiguration'] == null ? null : RuleLockConfiguration.fromMap((map['lockConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      resourceTags: map['resourceTags'] == null ? null : pulumi.Input.decodeList<RuleResourceTag>(map['resourceTags'], (value) => RuleResourceTag.fromMap((value as Map).cast<String, dynamic>())),
      resourceType: map['resourceType'] as String,
      retentionPeriod: RuleRetentionPeriod.fromMap((map['retentionPeriod'] as Map).cast<String, dynamic>()),
