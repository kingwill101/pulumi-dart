...
class Rule extends pulumi.CustomResource {
  ...
  Rule(String name, {RuleArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.excludeResourceTags = registerOutput<List<RuleExcludeResourceTag>?>(
      'excludeResourceTags',
    );
    this.lockConfiguration = registerOutput<RuleLockConfiguration?>(
      'lockConfiguration',
    );
    ...
    this.retentionPeriod = registerOutput<RuleRetentionPeriod>(
      'retentionPeriod',
    );
