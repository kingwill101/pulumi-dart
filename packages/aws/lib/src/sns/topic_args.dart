...
class TopicArgs {
  ...
  TopicArgs({
    ...
    String? tracingConfig,
        ...
        fifoThroughputScope =
            pulumi.Input.asOptionalInput<String>(fifoThroughputScope),
        ...
        httpFailureFeedbackRoleArn =
            pulumi.Input.asOptionalInput<String>(httpFailureFeedbackRoleArn),
        httpSuccessFeedbackRoleArn =
            pulumi.Input.asOptionalInput<String>(httpSuccessFeedbackRoleArn),
        httpSuccessFeedbackSampleRate =
            pulumi.Input.asOptionalInput<int>(httpSuccessFeedbackSampleRate),
        kmsMasterKeyId = pulumi.Input.asOptionalInput<String>(kmsMasterKeyId),
        lambdaFailureFeedbackRoleArn =
            pulumi.Input.asOptionalInput<String>(lambdaFailureFeedbackRoleArn),
        lambdaSuccessFeedbackRoleArn =
            pulumi.Input.asOptionalInput<String>(lambdaSuccessFeedbackRoleArn),
        lambdaSuccessFeedbackSampleRate =
            pulumi.Input.asOptionalInput<int>(lambdaSuccessFeedbackSampleRate),
        ...
        sqsFailureFeedbackRoleArn =
            pulumi.Input.asOptionalInput<String>(sqsFailureFeedbackRoleArn),
        sqsSuccessFeedbackRoleArn =
            pulumi.Input.asOptionalInput<String>(sqsSuccessFeedbackRoleArn),
        sqsSuccessFeedbackSampleRate =
            pulumi.Input.asOptionalInput<int>(sqsSuccessFeedbackSampleRate),
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ...
      archivePolicy:
          map['archivePolicy'] == null ? null : map['archivePolicy'] as String,
      ...
      tracingConfig:
          map['tracingConfig'] == null ? null : map['tracingConfig'] as String,
    );
  }
}
