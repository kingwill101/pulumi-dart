...
class TopicArgs {
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      applicationFailureFeedbackRoleArn: map['applicationFailureFeedbackRoleArn'] == null ? null : map['applicationFailureFeedbackRoleArn'] as String,
      applicationSuccessFeedbackRoleArn: map['applicationSuccessFeedbackRoleArn'] == null ? null : map['applicationSuccessFeedbackRoleArn'] as String,
      applicationSuccessFeedbackSampleRate: map['applicationSuccessFeedbackSampleRate'] == null ? null : map['applicationSuccessFeedbackSampleRate'] as int,
      archivePolicy: map['archivePolicy'] == null ? null : map['archivePolicy'] as String,
      contentBasedDeduplication: map['contentBasedDeduplication'] == null ? null : map['contentBasedDeduplication'] as bool,
      deliveryPolicy: map['deliveryPolicy'] == null ? null : map['deliveryPolicy'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      fifoThroughputScope: map['fifoThroughputScope'] == null ? null : map['fifoThroughputScope'] as String,
      fifoTopic: map['fifoTopic'] == null ? null : map['fifoTopic'] as bool,
      firehoseFailureFeedbackRoleArn: map['firehoseFailureFeedbackRoleArn'] == null ? null : map['firehoseFailureFeedbackRoleArn'] as String,
      firehoseSuccessFeedbackRoleArn: map['firehoseSuccessFeedbackRoleArn'] == null ? null : map['firehoseSuccessFeedbackRoleArn'] as String,
      firehoseSuccessFeedbackSampleRate: map['firehoseSuccessFeedbackSampleRate'] == null ? null : map['firehoseSuccessFeedbackSampleRate'] as int,
      httpFailureFeedbackRoleArn: map['httpFailureFeedbackRoleArn'] == null ? null : map['httpFailureFeedbackRoleArn'] as String,
      httpSuccessFeedbackRoleArn: map['httpSuccessFeedbackRoleArn'] == null ? null : map['httpSuccessFeedbackRoleArn'] as String,
      httpSuccessFeedbackSampleRate: map['httpSuccessFeedbackSampleRate'] == null ? null : map['httpSuccessFeedbackSampleRate'] as int,
      kmsMasterKeyId: map['kmsMasterKeyId'] == null ? null : map['kmsMasterKeyId'] as String,
      lambdaFailureFeedbackRoleArn: map['lambdaFailureFeedbackRoleArn'] == null ? null : map['lambdaFailureFeedbackRoleArn'] as String,
      lambdaSuccessFeedbackRoleArn: map['lambdaSuccessFeedbackRoleArn'] == null ? null : map['lambdaSuccessFeedbackRoleArn'] as String,
      lambdaSuccessFeedbackSampleRate: map['lambdaSuccessFeedbackSampleRate'] == null ? null : map['lambdaSuccessFeedbackSampleRate'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      policy: map['policy'] == null ? null : map['policy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      signatureVersion: map['signatureVersion'] == null ? null : map['signatureVersion'] as int,
      sqsFailureFeedbackRoleArn: map['sqsFailureFeedbackRoleArn'] == null ? null : map['sqsFailureFeedbackRoleArn'] as String,
      sqsSuccessFeedbackRoleArn: map['sqsSuccessFeedbackRoleArn'] == null ? null : map['sqsSuccessFeedbackRoleArn'] as String,
      sqsSuccessFeedbackSampleRate: map['sqsSuccessFeedbackSampleRate'] == null ? null : map['sqsSuccessFeedbackSampleRate'] as int,
