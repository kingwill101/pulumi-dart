...
class PlatformApplication extends pulumi.CustomResource {
  ...
  PlatformApplication(
    ...
    this.applePlatformBundleId = registerOutput<String?>(
      'applePlatformBundleId',
    );
    this.applePlatformTeamId = registerOutput<String?>('applePlatformTeamId');
    this.arn = registerOutput<String>('arn');
    this.eventDeliveryFailureTopicArn = registerOutput<String?>(
      'eventDeliveryFailureTopicArn',
    );
    this.eventEndpointCreatedTopicArn = registerOutput<String?>(
      'eventEndpointCreatedTopicArn',
    );
    this.eventEndpointDeletedTopicArn = registerOutput<String?>(
      'eventEndpointDeletedTopicArn',
    );
    this.eventEndpointUpdatedTopicArn = registerOutput<String?>(
      'eventEndpointUpdatedTopicArn',
    );
    this.failureFeedbackRoleArn = registerOutput<String?>(
    ...
    this.successFeedbackRoleArn = registerOutput<String?>(
      'successFeedbackRoleArn',
    );
    this.successFeedbackSampleRate = registerOutput<String?>(
