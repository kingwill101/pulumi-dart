...
class PlatformApplication extends pulumi.CustomResource {
  ...
  /// Creates a new [PlatformApplication].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PlatformApplication]. {@macro pulumi_sns_platform_application_platform_application_args_doc}
  ...
  PlatformApplication(
    ...
    this.applePlatformBundleId = registerOutput<String?>('applePlatformBundleId');
    this.applePlatformTeamId = registerOutput<String?>('applePlatformTeamId');
    this.arn = registerOutput<String>('arn');
    this.eventDeliveryFailureTopicArn = registerOutput<String?>('eventDeliveryFailureTopicArn');
    this.eventEndpointCreatedTopicArn = registerOutput<String?>('eventEndpointCreatedTopicArn');
    this.eventEndpointDeletedTopicArn = registerOutput<String?>('eventEndpointDeletedTopicArn');
    this.eventEndpointUpdatedTopicArn = registerOutput<String?>('eventEndpointUpdatedTopicArn');
    this.failureFeedbackRoleArn = registerOutput<String?>('failureFeedbackRoleArn');
    ...
    this.successFeedbackRoleArn = registerOutput<String?>('successFeedbackRoleArn');
    this.successFeedbackSampleRate = registerOutput<String?>('successFeedbackSampleRate');
  }
}
