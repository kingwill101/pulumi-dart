...
class PlatformApplicationArgs {
  ...
  PlatformApplicationArgs({
    ...
    String? successFeedbackSampleRate,
  }) : applePlatformBundleId = pulumi.Input.asOptionalInput<String>(
         applePlatformBundleId,
       ),
       applePlatformTeamId = pulumi.Input.asOptionalInput<String>(
         applePlatformTeamId,
       ),
       ...
       failureFeedbackRoleArn = pulumi.Input.asOptionalInput<String>(
       ...
       platformPrincipal = pulumi.Input.asOptionalInput<String>(
         platformPrincipal,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       successFeedbackRoleArn = pulumi.Input.asOptionalInput<String>(
