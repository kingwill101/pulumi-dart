...
class PlatformApplicationArgs {
  ...
  factory PlatformApplicationArgs.fromMap(Map<String, dynamic> map) {
    return PlatformApplicationArgs(
      applePlatformBundleId: map['applePlatformBundleId'] == null ? null : map['applePlatformBundleId'] as String,
      applePlatformTeamId: map['applePlatformTeamId'] == null ? null : map['applePlatformTeamId'] as String,
      eventDeliveryFailureTopicArn: map['eventDeliveryFailureTopicArn'] == null ? null : map['eventDeliveryFailureTopicArn'] as String,
      eventEndpointCreatedTopicArn: map['eventEndpointCreatedTopicArn'] == null ? null : map['eventEndpointCreatedTopicArn'] as String,
      eventEndpointDeletedTopicArn: map['eventEndpointDeletedTopicArn'] == null ? null : map['eventEndpointDeletedTopicArn'] as String,
      eventEndpointUpdatedTopicArn: map['eventEndpointUpdatedTopicArn'] == null ? null : map['eventEndpointUpdatedTopicArn'] as String,
      ...
      platformPrincipal: map['platformPrincipal'] == null ? null : map['platformPrincipal'] as String,
