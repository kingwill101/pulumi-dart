...
class SmsPreferencesArgs {
  ...
  factory SmsPreferencesArgs.fromMap(Map<String, dynamic> map) {
    return SmsPreferencesArgs(
      ...
      defaultSmsType: map['defaultSmsType'] == null ? null : map['defaultSmsType'] as String,
      deliveryStatusIamRoleArn: map['deliveryStatusIamRoleArn'] == null ? null : map['deliveryStatusIamRoleArn'] as String,
      deliveryStatusSuccessSamplingRate: map['deliveryStatusSuccessSamplingRate'] == null ? null : map['deliveryStatusSuccessSamplingRate'] as String,
      monthlySpendLimit: map['monthlySpendLimit'] == null ? null : map['monthlySpendLimit'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      usageReportS3Bucket: map['usageReportS3Bucket'] == null ? null : map['usageReportS3Bucket'] as String,
    );
  }
}
