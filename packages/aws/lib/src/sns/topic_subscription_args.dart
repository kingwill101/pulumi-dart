...
class TopicSubscriptionArgs {
  ...
  TopicSubscriptionArgs({
    ...
    required String topic,
       ...
       endpointAutoConfirms = pulumi.Input.asOptionalInput<bool>(
         endpointAutoConfirms,
       ),
       filterPolicy = pulumi.Input.asOptionalInput<String>(filterPolicy),
       filterPolicyScope = pulumi.Input.asOptionalInput<String>(
         filterPolicyScope,
       ),
       protocol = pulumi.Input.asInput<String>(protocol),
       rawMessageDelivery = pulumi.Input.asOptionalInput<bool>(
         rawMessageDelivery,
       ),
       ...
       subscriptionRoleArn = pulumi.Input.asOptionalInput<String>(
         subscriptionRoleArn,
       ),
  ...
  factory TopicSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return TopicSubscriptionArgs(
      ...
      filterPolicy: map['filterPolicy'] == null
          ? null
          : map['filterPolicy'] as String,
      ...
      replayPolicy: map['replayPolicy'] == null
          ? null
          : map['replayPolicy'] as String,
