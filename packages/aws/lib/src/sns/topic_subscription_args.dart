...
class TopicSubscriptionArgs {
  ...
  factory TopicSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return TopicSubscriptionArgs(
      confirmationTimeoutInMinutes: map['confirmationTimeoutInMinutes'] == null ? null : map['confirmationTimeoutInMinutes'] as int,
      deliveryPolicy: map['deliveryPolicy'] == null ? null : map['deliveryPolicy'] as String,
      endpoint: map['endpoint'] as String,
      endpointAutoConfirms: map['endpointAutoConfirms'] == null ? null : map['endpointAutoConfirms'] as bool,
      filterPolicy: map['filterPolicy'] == null ? null : map['filterPolicy'] as String,
      filterPolicyScope: map['filterPolicyScope'] == null ? null : map['filterPolicyScope'] as String,
      protocol: map['protocol'] as String,
      rawMessageDelivery: map['rawMessageDelivery'] == null ? null : map['rawMessageDelivery'] as bool,
      redrivePolicy: map['redrivePolicy'] == null ? null : map['redrivePolicy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      replayPolicy: map['replayPolicy'] == null ? null : map['replayPolicy'] as String,
      subscriptionRoleArn: map['subscriptionRoleArn'] == null ? null : map['subscriptionRoleArn'] as String,
