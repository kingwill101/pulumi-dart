...
class SmsPreferences extends pulumi.CustomResource {
  ...
  SmsPreferences(
    ...
    this.deliveryStatusIamRoleArn = registerOutput<String?>('deliveryStatusIamRoleArn');
    this.deliveryStatusSuccessSamplingRate = registerOutput<String?>('deliveryStatusSuccessSamplingRate');
