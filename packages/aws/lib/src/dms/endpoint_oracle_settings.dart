...
class EndpointOracleSettings {
  ...
  factory EndpointOracleSettings.fromMap(Map<String, dynamic> map) {
    return EndpointOracleSettings(
      ...
      asmPassword: map['asmPassword'] == null
          ? null
          : map['asmPassword'] as String,
      ...
      readAheadBlocks: map['readAheadBlocks'] == null
          ? null
          : map['readAheadBlocks'] as int,
      ...
      retryInterval: map['retryInterval'] == null
          ? null
          : map['retryInterval'] as int,
      secretsManagerOracleAsmAccessRoleArn:
      ...
      usePathPrefix: map['usePathPrefix'] == null
          ? null
          : map['usePathPrefix'] as String,
    );
  }
}
