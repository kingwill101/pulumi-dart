...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    String? databaseName,
    EndpointElasticsearchSettings? elasticsearchSettings,
    required String endpointId,
    required String endpointType,
    required String engineName,
    String? extraConnectionAttributes,
    EndpointKafkaSettings? kafkaSettings,
    EndpointKinesisSettings? kinesisSettings,
    String? kmsKeyArn,
    EndpointMongodbSettings? mongodbSettings,
    EndpointMysqlSettings? mysqlSettings,
    EndpointOracleSettings? oracleSettings,
    String? password,
    bool? pauseReplicationTasks,
    int? port,
    EndpointPostgresSettings? postgresSettings,
    EndpointRedisSettings? redisSettings,
    EndpointRedshiftSettings? redshiftSettings,
    String? region,
    ...
    String? username,
        ...
        extraConnectionAttributes =
            pulumi.Input.asOptionalInput<String>(extraConnectionAttributes),
        kafkaSettings =
            pulumi.Input.asOptionalInput<EndpointKafkaSettings>(kafkaSettings),
        ...
        mongodbSettings = pulumi.Input.asOptionalInput<EndpointMongodbSettings>(
            mongodbSettings),
        mysqlSettings =
            pulumi.Input.asOptionalInput<EndpointMysqlSettings>(mysqlSettings),
        oracleSettings = pulumi.Input.asOptionalInput<EndpointOracleSettings>(
            oracleSettings),
        password = pulumi.Input.asOptionalInput<String>(password),
        pauseReplicationTasks =
            pulumi.Input.asOptionalInput<bool>(pauseReplicationTasks),
        port = pulumi.Input.asOptionalInput<int>(port),
        postgresSettings =
            pulumi.Input.asOptionalInput<EndpointPostgresSettings>(
                postgresSettings),
        redisSettings =
            pulumi.Input.asOptionalInput<EndpointRedisSettings>(redisSettings),
        redshiftSettings =
            pulumi.Input.asOptionalInput<EndpointRedshiftSettings>(
                redshiftSettings),
        region = pulumi.Input.asOptionalInput<String>(region),
        secretsManagerAccessRoleArn =
            pulumi.Input.asOptionalInput<String>(secretsManagerAccessRoleArn),
        secretsManagerArn =
            pulumi.Input.asOptionalInput<String>(secretsManagerArn),
        serverName = pulumi.Input.asOptionalInput<String>(serverName),
        serviceAccessRole =
            pulumi.Input.asOptionalInput<String>(serviceAccessRole),
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      elasticsearchSettings: map['elasticsearchSettings'] == null
          ? null
          : EndpointElasticsearchSettings.fromMap(
              (map['elasticsearchSettings'] as Map).cast<String, dynamic>()),
      endpointId: map['endpointId'] as String,
      endpointType: map['endpointType'] as String,
      engineName: map['engineName'] as String,
      extraConnectionAttributes: map['extraConnectionAttributes'] == null
          ? null
          : map['extraConnectionAttributes'] as String,
      kafkaSettings: map['kafkaSettings'] == null
          ? null
          : EndpointKafkaSettings.fromMap(
              (map['kafkaSettings'] as Map).cast<String, dynamic>()),
      kinesisSettings: map['kinesisSettings'] == null
          ? null
          : EndpointKinesisSettings.fromMap(
              (map['kinesisSettings'] as Map).cast<String, dynamic>()),
      kmsKeyArn: map['kmsKeyArn'] == null ? null : map['kmsKeyArn'] as String,
      mongodbSettings: map['mongodbSettings'] == null
          ? null
          : EndpointMongodbSettings.fromMap(
              (map['mongodbSettings'] as Map).cast<String, dynamic>()),
      mysqlSettings: map['mysqlSettings'] == null
          ? null
          : EndpointMysqlSettings.fromMap(
              (map['mysqlSettings'] as Map).cast<String, dynamic>()),
      oracleSettings: map['oracleSettings'] == null
          ? null
          : EndpointOracleSettings.fromMap(
              (map['oracleSettings'] as Map).cast<String, dynamic>()),
      password: map['password'] == null ? null : map['password'] as String,
      pauseReplicationTasks: map['pauseReplicationTasks'] == null
          ? null
          : map['pauseReplicationTasks'] as bool,
      port: map['port'] == null ? null : map['port'] as int,
      postgresSettings: map['postgresSettings'] == null
          ? null
          : EndpointPostgresSettings.fromMap(
              (map['postgresSettings'] as Map).cast<String, dynamic>()),
      redisSettings: map['redisSettings'] == null
          ? null
          : EndpointRedisSettings.fromMap(
              (map['redisSettings'] as Map).cast<String, dynamic>()),
      redshiftSettings: map['redshiftSettings'] == null
          ? null
          : EndpointRedshiftSettings.fromMap(
              (map['redshiftSettings'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      secretsManagerAccessRoleArn: map['secretsManagerAccessRoleArn'] == null
          ? null
          : map['secretsManagerAccessRoleArn'] as String,
      secretsManagerArn: map['secretsManagerArn'] == null
          ? null
          : map['secretsManagerArn'] as String,
      serverName:
          map['serverName'] == null ? null : map['serverName'] as String,
      serviceAccessRole: map['serviceAccessRole'] == null
          ? null
          : map['serviceAccessRole'] as String,
