...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    String? username,
       ...
       pauseReplicationTasks = pulumi.Input.asOptionalInput<bool>(
         pauseReplicationTasks,
       ),
       port = pulumi.Input.asOptionalInput<int>(port),
       postgresSettings = pulumi
           .Input.asOptionalInput<EndpointPostgresSettings>(postgresSettings),
       redisSettings = pulumi.Input.asOptionalInput<EndpointRedisSettings>(
         redisSettings,
       ),
       redshiftSettings = pulumi
           .Input.asOptionalInput<EndpointRedshiftSettings>(redshiftSettings),
       region = pulumi.Input.asOptionalInput<String>(region),
       secretsManagerAccessRoleArn = pulumi.Input.asOptionalInput<String>(
         secretsManagerAccessRoleArn,
       ),
       secretsManagerArn = pulumi.Input.asOptionalInput<String>(
         secretsManagerArn,
       ),
       serverName = pulumi.Input.asOptionalInput<String>(serverName),
       serviceAccessRole = pulumi.Input.asOptionalInput<String>(
         serviceAccessRole,
       ),
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      serverName: map['serverName'] == null
          ? null
