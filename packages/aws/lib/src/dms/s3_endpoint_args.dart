...
class S3EndpointArgs {
  ...
  S3EndpointArgs({
    ...
    bool? useTaskStartTimeForFullLoadTimestamp,
       ...
       cannedAclForObjects = pulumi.Input.asOptionalInput<String>(
         cannedAclForObjects,
       ),
       cdcInsertsAndUpdates = pulumi.Input.asOptionalInput<bool>(
         cdcInsertsAndUpdates,
       ),
       cdcInsertsOnly = pulumi.Input.asOptionalInput<bool>(cdcInsertsOnly),
       cdcMaxBatchInterval = pulumi.Input.asOptionalInput<int>(
         cdcMaxBatchInterval,
       ),
       ...
       datePartitionDelimiter = pulumi.Input.asOptionalInput<String>(
         datePartitionDelimiter,
       ),
       datePartitionEnabled = pulumi.Input.asOptionalInput<bool>(
         datePartitionEnabled,
       ),
       datePartitionSequence = pulumi.Input.asOptionalInput<String>(
         datePartitionSequence,
       ),
       datePartitionTimezone = pulumi.Input.asOptionalInput<String>(
         datePartitionTimezone,
       ),
       detachTargetOnLobLookupFailureParquet = pulumi
           .Input.asOptionalInput<bool>(detachTargetOnLobLookupFailureParquet),
       ...
       externalTableDefinition = pulumi.Input.asOptionalInput<String>(
         externalTableDefinition,
       ),
       glueCatalogGeneration = pulumi.Input.asOptionalInput<bool>(
         glueCatalogGeneration,
       ),
       ignoreHeaderRows = pulumi.Input.asOptionalInput<int>(ignoreHeaderRows),
       includeOpForFullLoad = pulumi.Input.asOptionalInput<bool>(
       ...
       preserveTransactions = pulumi.Input.asOptionalInput<bool>(
       ...
       serviceAccessRoleArn = pulumi.Input.asInput<String>(
         serviceAccessRoleArn,
       ),
       sslMode = pulumi.Input.asOptionalInput<String>(sslMode),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       timestampColumnName = pulumi.Input.asOptionalInput<String>(
         timestampColumnName,
       ),
       useCsvNoSupValue = pulumi.Input.asOptionalInput<bool>(useCsvNoSupValue),
       useTaskStartTimeForFullLoadTimestamp = pulumi
           .Input.asOptionalInput<bool>(useTaskStartTimeForFullLoadTimestamp);
  ...
  factory S3EndpointArgs.fromMap(Map<String, dynamic> map) {
    return S3EndpointArgs(
      addColumnName: map['addColumnName'] == null
          ? null
          : map['addColumnName'] as bool,
      ...
      cdcInsertsOnly: map['cdcInsertsOnly'] == null
          ? null
          : map['cdcInsertsOnly'] as bool,
      cdcMaxBatchInterval: map['cdcMaxBatchInterval'] == null
          ? null
          : map['cdcMaxBatchInterval'] as int,
      cdcMinFileSize: map['cdcMinFileSize'] == null
          ? null
          : map['cdcMinFileSize'] as int,
      ...
      csvNoSupValue: map['csvNoSupValue'] == null
          ? null
          : map['csvNoSupValue'] as String,
      csvNullValue: map['csvNullValue'] == null
          ? null
          : map['csvNullValue'] as String,
      ...
      dataPageSize: map['dataPageSize'] == null
          ? null
          : map['dataPageSize'] as int,
      ...
      rowGroupLength: map['rowGroupLength'] == null
          ? null
          : map['rowGroupLength'] as int,
