...
class S3EndpointArgs {
  ...
  factory S3EndpointArgs.fromMap(Map<String, dynamic> map) {
    return S3EndpointArgs(
      addColumnName: map['addColumnName'] == null ? null : map['addColumnName'] as bool,
      addTrailingPaddingCharacter: map['addTrailingPaddingCharacter'] == null ? null : map['addTrailingPaddingCharacter'] as bool,
      bucketFolder: map['bucketFolder'] == null ? null : map['bucketFolder'] as String,
      bucketName: map['bucketName'] as String,
      cannedAclForObjects: map['cannedAclForObjects'] == null ? null : map['cannedAclForObjects'] as String,
      cdcInsertsAndUpdates: map['cdcInsertsAndUpdates'] == null ? null : map['cdcInsertsAndUpdates'] as bool,
      cdcInsertsOnly: map['cdcInsertsOnly'] == null ? null : map['cdcInsertsOnly'] as bool,
      cdcMaxBatchInterval: map['cdcMaxBatchInterval'] == null ? null : map['cdcMaxBatchInterval'] as int,
      cdcMinFileSize: map['cdcMinFileSize'] == null ? null : map['cdcMinFileSize'] as int,
      ...
      csvNoSupValue: map['csvNoSupValue'] == null ? null : map['csvNoSupValue'] as String,
      csvNullValue: map['csvNullValue'] == null ? null : map['csvNullValue'] as String,
      csvRowDelimiter: map['csvRowDelimiter'] == null ? null : map['csvRowDelimiter'] as String,
      dataFormat: map['dataFormat'] == null ? null : map['dataFormat'] as String,
      dataPageSize: map['dataPageSize'] == null ? null : map['dataPageSize'] as int,
      datePartitionDelimiter: map['datePartitionDelimiter'] == null ? null : map['datePartitionDelimiter'] as String,
      datePartitionEnabled: map['datePartitionEnabled'] == null ? null : map['datePartitionEnabled'] as bool,
      datePartitionSequence: map['datePartitionSequence'] == null ? null : map['datePartitionSequence'] as String,
      datePartitionTimezone: map['datePartitionTimezone'] == null ? null : map['datePartitionTimezone'] as String,
      detachTargetOnLobLookupFailureParquet: map['detachTargetOnLobLookupFailureParquet'] == null ? null : map['detachTargetOnLobLookupFailureParquet'] as bool,
      dictPageSizeLimit: map['dictPageSizeLimit'] == null ? null : map['dictPageSizeLimit'] as int,
      enableStatistics: map['enableStatistics'] == null ? null : map['enableStatistics'] as bool,
      ...
      externalTableDefinition: map['externalTableDefinition'] == null ? null : map['externalTableDefinition'] as String,
      glueCatalogGeneration: map['glueCatalogGeneration'] == null ? null : map['glueCatalogGeneration'] as bool,
      ignoreHeaderRows: map['ignoreHeaderRows'] == null ? null : map['ignoreHeaderRows'] as int,
      includeOpForFullLoad: map['includeOpForFullLoad'] == null ? null : map['includeOpForFullLoad'] as bool,
      kmsKeyArn: map['kmsKeyArn'] == null ? null : map['kmsKeyArn'] as String,
      maxFileSize: map['maxFileSize'] == null ? null : map['maxFileSize'] as int,
      parquetTimestampInMillisecond: map['parquetTimestampInMillisecond'] == null ? null : map['parquetTimestampInMillisecond'] as bool,
      parquetVersion: map['parquetVersion'] == null ? null : map['parquetVersion'] as String,
      preserveTransactions: map['preserveTransactions'] == null ? null : map['preserveTransactions'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      rfc4180: map['rfc4180'] == null ? null : map['rfc4180'] as bool,
      rowGroupLength: map['rowGroupLength'] == null ? null : map['rowGroupLength'] as int,
      ...
      timestampColumnName: map['timestampColumnName'] == null ? null : map['timestampColumnName'] as String,
      useCsvNoSupValue: map['useCsvNoSupValue'] == null ? null : map['useCsvNoSupValue'] as bool,
      useTaskStartTimeForFullLoadTimestamp: map['useTaskStartTimeForFullLoadTimestamp'] == null ? null : map['useTaskStartTimeForFullLoadTimestamp'] as bool,
    );
  }
}
