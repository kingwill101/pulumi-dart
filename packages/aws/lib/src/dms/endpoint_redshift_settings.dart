...
class EndpointRedshiftSettings {
  ...
  factory EndpointRedshiftSettings.fromMap(Map<String, dynamic> map) {
    return EndpointRedshiftSettings(
      bucketFolder: map['bucketFolder'] == null ? null : map['bucketFolder'] as String,
      ...
      serverSideEncryptionKmsKeyId: map['serverSideEncryptionKmsKeyId'] == null ? null : map['serverSideEncryptionKmsKeyId'] as String,
