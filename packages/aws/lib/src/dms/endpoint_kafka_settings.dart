...
class EndpointKafkaSettings {
  ...
  factory EndpointKafkaSettings.fromMap(Map<String, dynamic> map) {
    return EndpointKafkaSettings(
      ...
      messageMaxBytes: map['messageMaxBytes'] == null
          ? null
          : map['messageMaxBytes'] as int,
      noHexPrefix: map['noHexPrefix'] == null
          ? null
          : map['noHexPrefix'] as bool,
      partitionIncludeSchemaTable: map['partitionIncludeSchemaTable'] == null
          ? null
          : map['partitionIncludeSchemaTable'] as bool,
      saslMechanism: map['saslMechanism'] == null
          ? null
          : map['saslMechanism'] as String,
      saslPassword: map['saslPassword'] == null
          ? null
          : map['saslPassword'] as String,
      saslUsername: map['saslUsername'] == null
          ? null
          : map['saslUsername'] as String,
