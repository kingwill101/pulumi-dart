...
class GetReplicationInstanceResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['replicationInstancePrivateIps'] = replicationInstancePrivateIps;
    map['replicationInstancePublicIps'] = replicationInstancePublicIps;
  ...
  factory GetReplicationInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetReplicationInstanceResult(
      ...
      replicationInstancePrivateIps:
          (map['replicationInstancePrivateIps'] as List).cast<String>(),
      replicationInstancePublicIps:
          (map['replicationInstancePublicIps'] as List).cast<String>(),
