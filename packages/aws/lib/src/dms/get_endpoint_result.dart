...
class GetEndpointResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['elasticsearchSettings'] = pulumi.Input.encodeList<
        GetEndpointElasticsearchSetting,
        Map<String, dynamic>>(elasticsearchSettings, (value) => value.toMap());
    ...
    map['id'] = id;
    map['kafkaSettings'] =
        pulumi.Input.encodeList<GetEndpointKafkaSetting, Map<String, dynamic>>(
            kafkaSettings, (value) => value.toMap());
    map['kinesisSettings'] = pulumi.Input.encodeList<GetEndpointKinesisSetting,
        Map<String, dynamic>>(kinesisSettings, (value) => value.toMap());
    map['kmsKeyArn'] = kmsKeyArn;
    map['mongodbSettings'] = pulumi.Input.encodeList<GetEndpointMongodbSetting,
        Map<String, dynamic>>(mongodbSettings, (value) => value.toMap());
    map['mysqlSettings'] =
        pulumi.Input.encodeList<GetEndpointMysqlSetting, Map<String, dynamic>>(
            mysqlSettings, (value) => value.toMap());
    map['password'] = password;
    map['port'] = port;
    map['postgresSettings'] = pulumi.Input.encodeList<
        GetEndpointPostgresSetting,
        Map<String, dynamic>>(postgresSettings, (value) => value.toMap());
    map['redisSettings'] =
        pulumi.Input.encodeList<GetEndpointRedisSetting, Map<String, dynamic>>(
            redisSettings, (value) => value.toMap());
    map['redshiftSettings'] = pulumi.Input.encodeList<
        GetEndpointRedshiftSetting,
        Map<String, dynamic>>(redshiftSettings, (value) => value.toMap());
    map['region'] = region;
    map['s3Settings'] =
        pulumi.Input.encodeList<GetEndpointS3Setting, Map<String, dynamic>>(
  ...
  factory GetEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointResult(
      ...
      elasticsearchSettings:
          pulumi.Input.decodeList<GetEndpointElasticsearchSetting>(
      ...
      id: map['id'] as String,
      kafkaSettings: pulumi.Input.decodeList<GetEndpointKafkaSetting>(
          map['kafkaSettings'],
          (value) => GetEndpointKafkaSetting.fromMap(
              (value as Map).cast<String, dynamic>())),
      kinesisSettings: pulumi.Input.decodeList<GetEndpointKinesisSetting>(
          map['kinesisSettings'],
          (value) => GetEndpointKinesisSetting.fromMap(
              (value as Map).cast<String, dynamic>())),
      kmsKeyArn: map['kmsKeyArn'] as String,
      mongodbSettings: pulumi.Input.decodeList<GetEndpointMongodbSetting>(
          map['mongodbSettings'],
          (value) => GetEndpointMongodbSetting.fromMap(
              (value as Map).cast<String, dynamic>())),
      mysqlSettings: pulumi.Input.decodeList<GetEndpointMysqlSetting>(
          map['mysqlSettings'],
          (value) => GetEndpointMysqlSetting.fromMap(
              (value as Map).cast<String, dynamic>())),
      password: map['password'] as String,
      port: map['port'] as int,
      postgresSettings: pulumi.Input.decodeList<GetEndpointPostgresSetting>(
          map['postgresSettings'],
          (value) => GetEndpointPostgresSetting.fromMap(
              (value as Map).cast<String, dynamic>())),
      redisSettings: pulumi.Input.decodeList<GetEndpointRedisSetting>(
          map['redisSettings'],
          (value) => GetEndpointRedisSetting.fromMap(
              (value as Map).cast<String, dynamic>())),
      redshiftSettings: pulumi.Input.decodeList<GetEndpointRedshiftSetting>(
          map['redshiftSettings'],
          (value) => GetEndpointRedshiftSetting.fromMap(
              (value as Map).cast<String, dynamic>())),
      region: map['region'] as String,
      s3Settings: pulumi.Input.decodeList<GetEndpointS3Setting>(
          map['s3Settings'],
