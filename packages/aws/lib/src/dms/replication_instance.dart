...
class ReplicationInstance extends pulumi.CustomResource {
  ...
  ReplicationInstance(
    ...
    this.replicationInstanceClass = registerOutput<String>(
      'replicationInstanceClass',
    );
    this.replicationInstanceId = registerOutput<String>(
      'replicationInstanceId',
    );
    this.replicationInstancePrivateIps = registerOutput<List<String>>(
      'replicationInstancePrivateIps',
    );
    this.replicationInstancePublicIps = registerOutput<List<String>>(
      'replicationInstancePublicIps',
    );
    this.replicationSubnetGroupId = registerOutput<String>(
