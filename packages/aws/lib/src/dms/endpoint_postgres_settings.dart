...
class EndpointPostgresSettings {
  ...
  factory EndpointPostgresSettings.fromMap(Map<String, dynamic> map) {
    return EndpointPostgresSettings(
      ...
      captureDdls: map['captureDdls'] == null
          ? null
          : map['captureDdls'] as bool,
      databaseMode: map['databaseMode'] == null
          ? null
          : map['databaseMode'] as String,
      ...
      mapJsonbAsClob: map['mapJsonbAsClob'] == null
          ? null
          : map['mapJsonbAsClob'] as bool,
