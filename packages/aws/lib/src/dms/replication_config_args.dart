...
class ReplicationConfigArgs {
  ...
  ReplicationConfigArgs({
    ...
    required String targetEndpointArn,
            ...
            pulumi.Input.asInput<ReplicationConfigComputeConfig>(computeConfig),
        region = pulumi.Input.asOptionalInput<String>(region),
        replicationConfigIdentifier =
            pulumi.Input.asInput<String>(replicationConfigIdentifier),
        replicationSettings =
            pulumi.Input.asOptionalInput<String>(replicationSettings),
        replicationType = pulumi.Input.asInput<String>(replicationType),
        resourceIdentifier =
            pulumi.Input.asOptionalInput<String>(resourceIdentifier),
        ...
        supplementalSettings =
            pulumi.Input.asOptionalInput<String>(supplementalSettings),
