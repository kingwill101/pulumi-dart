...
class ReplicationConfigArgs {
  ...
  factory ReplicationConfigArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigArgs(
      computeConfig: ReplicationConfigComputeConfig.fromMap((map['computeConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      replicationConfigIdentifier: map['replicationConfigIdentifier'] as String,
      replicationSettings: map['replicationSettings'] == null ? null : map['replicationSettings'] as String,
      ...
      startReplication: map['startReplication'] == null ? null : map['startReplication'] as bool,
      supplementalSettings: map['supplementalSettings'] == null ? null : map['supplementalSettings'] as String,
