...
class ReplicationInstanceArgs {
  ...
  ReplicationInstanceArgs({
    ...
    List<String>? vpcSecurityGroupIds,
       ...
       replicationInstanceClass = pulumi.Input.asInput<String>(
         replicationInstanceClass,
       ),
       replicationInstanceId = pulumi.Input.asInput<String>(
         replicationInstanceId,
       ),
       replicationSubnetGroupId = pulumi.Input.asOptionalInput<String>(
  ...
  factory ReplicationInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationInstanceArgs(
      ...
      kerberosAuthenticationSettings:
          map['kerberosAuthenticationSettings'] == null
          ? null
          : ReplicationInstanceKerberosAuthenticationSettings.fromMap(
              (map['kerberosAuthenticationSettings'] as Map)
                  .cast<String, dynamic>(),
            ),
      ...
      replicationSubnetGroupId: map['replicationSubnetGroupId'] == null
          ? null
