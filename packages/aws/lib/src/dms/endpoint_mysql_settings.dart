...
class EndpointMysqlSettings {
  ...
  factory EndpointMysqlSettings.fromMap(Map<String, dynamic> map) {
    return EndpointMysqlSettings(
      ...
      executeTimeout: map['executeTimeout'] == null
          ? null
          : map['executeTimeout'] as int,
      maxFileSize: map['maxFileSize'] == null
          ? null
          : map['maxFileSize'] as int,
      ...
      targetDbType: map['targetDbType'] == null
          ? null
          : map['targetDbType'] as String,
    );
  }
}
