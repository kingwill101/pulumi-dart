...
class S3Endpoint extends pulumi.CustomResource {
  ...
  S3Endpoint(
    ...
    this.addTrailingPaddingCharacter = registerOutput<bool?>(
    ...
    this.datePartitionDelimiter = registerOutput<String?>(
      'datePartitionDelimiter',
    );
    this.datePartitionEnabled = registerOutput<bool?>('datePartitionEnabled');
    this.datePartitionSequence = registerOutput<String?>(
      'datePartitionSequence',
    );
    this.datePartitionTimezone = registerOutput<String?>(
      'datePartitionTimezone',
    );
    this.detachTargetOnLobLookupFailureParquet = registerOutput<bool?>(
    ...
    this.externalTableDefinition = registerOutput<String?>(
    ...
    this.parquetTimestampInMillisecond = registerOutput<bool?>(
    ...
    this.serverSideEncryptionKmsKeyId = registerOutput<String?>(
    ...
    this.useTaskStartTimeForFullLoadTimestamp = registerOutput<bool?>(
