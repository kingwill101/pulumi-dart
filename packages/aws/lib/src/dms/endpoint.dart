...
class Endpoint extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EndpointElasticsearchSettings?> elasticsearchSettings;
  ...
  Endpoint(
    ...
    this.elasticsearchSettings = registerOutput<EndpointElasticsearchSettings?>('elasticsearchSettings');
    ...
    this.extraConnectionAttributes = registerOutput<String>('extraConnectionAttributes');
    this.kafkaSettings = registerOutput<EndpointKafkaSettings?>('kafkaSettings');
    this.kinesisSettings = registerOutput<EndpointKinesisSettings?>('kinesisSettings');
    this.kmsKeyArn = registerOutput<String>('kmsKeyArn');
    this.mongodbSettings = registerOutput<EndpointMongodbSettings?>('mongodbSettings');
    this.mysqlSettings = registerOutput<EndpointMysqlSettings?>('mysqlSettings');
    this.oracleSettings = registerOutput<EndpointOracleSettings?>('oracleSettings');
    this.password = registerOutput<String?>('password');
    this.pauseReplicationTasks = registerOutput<bool?>('pauseReplicationTasks');
    this.port = registerOutput<int?>('port');
    this.postgresSettings = registerOutput<EndpointPostgresSettings?>('postgresSettings');
    this.redisSettings = registerOutput<EndpointRedisSettings?>('redisSettings');
    this.redshiftSettings = registerOutput<EndpointRedshiftSettings>('redshiftSettings');
    this.region = registerOutput<String>('region');
    this.secretsManagerAccessRoleArn = registerOutput<String?>('secretsManagerAccessRoleArn');
