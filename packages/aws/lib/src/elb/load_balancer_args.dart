...
class LoadBalancerArgs {
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      connectionDraining: map['connectionDraining'] == null ? null : map['connectionDraining'] as bool,
      connectionDrainingTimeout: map['connectionDrainingTimeout'] == null ? null : map['connectionDrainingTimeout'] as int,
      crossZoneLoadBalancing: map['crossZoneLoadBalancing'] == null ? null : map['crossZoneLoadBalancing'] as bool,
      ...
      listeners: pulumi.Input.decodeList<LoadBalancerListener>(map['listeners'], (value) => LoadBalancerListener.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceSecurityGroup: map['sourceSecurityGroup'] == null ? null : map['sourceSecurityGroup'] as String,
