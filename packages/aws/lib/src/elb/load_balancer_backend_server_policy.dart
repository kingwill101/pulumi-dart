...
class LoadBalancerBackendServerPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [LoadBalancerBackendServerPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LoadBalancerBackendServerPolicy]. {@macro pulumi_elb_load_balancer_backend_server_policy_load_balancer_backend_server_policy_args_doc}
