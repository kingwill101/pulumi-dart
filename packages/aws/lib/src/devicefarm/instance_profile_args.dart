...
class InstanceProfileArgs {
  ...
  InstanceProfileArgs({
    ...
    Map<String, String>? tags,
       ...
       excludeAppPackagesFromCleanups = pulumi
           .Input.asOptionalInput<List<String>>(excludeAppPackagesFromCleanups),
  ...
  factory InstanceProfileArgs.fromMap(Map<String, dynamic> map) {
    return InstanceProfileArgs(
      ...
      packageCleanup: map['packageCleanup'] == null
          ? null
          : map['packageCleanup'] as bool,
      rebootAfterUse: map['rebootAfterUse'] == null
          ? null
          : map['rebootAfterUse'] as bool,
