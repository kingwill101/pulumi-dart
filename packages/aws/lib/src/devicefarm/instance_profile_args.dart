...
class InstanceProfileArgs {
  ...
  factory InstanceProfileArgs.fromMap(Map<String, dynamic> map) {
    return InstanceProfileArgs(
      ...
      excludeAppPackagesFromCleanups: map['excludeAppPackagesFromCleanups'] == null ? null : (map['excludeAppPackagesFromCleanups'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      packageCleanup: map['packageCleanup'] == null ? null : map['packageCleanup'] as bool,
      rebootAfterUse: map['rebootAfterUse'] == null ? null : map['rebootAfterUse'] as bool,
