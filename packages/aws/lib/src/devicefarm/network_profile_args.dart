...
class NetworkProfileArgs {
  ...
  NetworkProfileArgs({
    ...
    int? uplinkLossPercent,
       ...
       downlinkBandwidthBits = pulumi.Input.asOptionalInput<int>(
       ...
       downlinkLossPercent = pulumi.Input.asOptionalInput<int>(
         downlinkLossPercent,
       ),
       ...
       uplinkBandwidthBits = pulumi.Input.asOptionalInput<int>(
         uplinkBandwidthBits,
       ),
  ...
  factory NetworkProfileArgs.fromMap(Map<String, dynamic> map) {
    return NetworkProfileArgs(
      ...
      downlinkDelayMs: map['downlinkDelayMs'] == null
          ? null
          : map['downlinkDelayMs'] as int,
      ...
      uplinkDelayMs: map['uplinkDelayMs'] == null
          ? null
          : map['uplinkDelayMs'] as int,
      uplinkJitterMs: map['uplinkJitterMs'] == null
          ? null
          : map['uplinkJitterMs'] as int,
