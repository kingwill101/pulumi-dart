...
class ProjectArgs {
  ...
  ProjectArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<int>(defaultJobTimeoutMinutes),
  ...
  Map<String, dynamic> toMap() {
    ...
    final defaultJobTimeoutMinutesValue = defaultJobTimeoutMinutes;
    if (defaultJobTimeoutMinutesValue != null) {
      map['defaultJobTimeoutMinutes'] = defaultJobTimeoutMinutesValue;
    }
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      defaultJobTimeoutMinutes: map['defaultJobTimeoutMinutes'] == null
          ? null
          : map['defaultJobTimeoutMinutes'] as int,
