...
class ConfigurationTemplateArgs {
  ...
  factory ConfigurationTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationTemplateArgs(
      ...
      settings: map['settings'] == null ? null : pulumi.Input.decodeList<ConfigurationTemplateSetting>(map['settings'], (value) => ConfigurationTemplateSetting.fromMap((value as Map).cast<String, dynamic>())),
