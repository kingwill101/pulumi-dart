...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    String? waitForReadyTimeout,
        ...
        settings =
            pulumi.Input.asOptionalInput<List<EnvironmentSetting>>(settings),
        solutionStackName =
        ...
        waitForReadyTimeout =
            pulumi.Input.asOptionalInput<String>(waitForReadyTimeout);
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      cnamePrefix:
          map['cnamePrefix'] == null ? null : map['cnamePrefix'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      platformArn:
          map['platformArn'] == null ? null : map['platformArn'] as String,
      pollInterval:
          map['pollInterval'] == null ? null : map['pollInterval'] as String,
