...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    String? waitForReadyTimeout,
       ...
       solutionStackName = pulumi.Input.asOptionalInput<String>(
         solutionStackName,
       ),
       ...
       waitForReadyTimeout = pulumi.Input.asOptionalInput<String>(
         waitForReadyTimeout,
       );
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      cnamePrefix: map['cnamePrefix'] == null
          ? null
          : map['cnamePrefix'] as String,
      description: map['description'] == null
          ? null
          : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      platformArn: map['platformArn'] == null
          ? null
          : map['platformArn'] as String,
      pollInterval: map['pollInterval'] == null
          ? null
          : map['pollInterval'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      settings: map['settings'] == null
          ? null
          : pulumi.Input.decodeList<EnvironmentSetting>(
              map['settings'],
              (value) => EnvironmentSetting.fromMap(
      ...
      waitForReadyTimeout: map['waitForReadyTimeout'] == null
          ? null
          : map['waitForReadyTimeout'] as String,
    );
  }
}
