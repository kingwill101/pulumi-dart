...
class GetEbsVolumesArgs {
  ...
  GetEbsVolumesArgs({
    List<GetEbsVolumesFilter>? filters,
    String? region,
    Map<String, String>? tags,
  })  : filters =
            pulumi.Input.asOptionalInput<List<GetEbsVolumesFilter>>(filters),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (filtersValue != null) {
      map['filters'] = pulumi.Input.mapOptionalInputValue<
              List<GetEbsVolumesFilter>, List<Map<String, dynamic>>>(
          filtersValue,
          (value) => pulumi.Input.encodeList<GetEbsVolumesFilter,
