...
class VolumeArgs {
  ...
  VolumeArgs({
    ...
    int? volumeInitializationRate,
        ...
        multiAttachEnabled =
            pulumi.Input.asOptionalInput<bool>(multiAttachEnabled),
        ...
        volumeInitializationRate =
            pulumi.Input.asOptionalInput<int>(volumeInitializationRate);
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      ...
      finalSnapshot:
          map['finalSnapshot'] == null ? null : map['finalSnapshot'] as bool,
