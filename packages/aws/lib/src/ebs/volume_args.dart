...
class VolumeArgs {
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      ...
      finalSnapshot: map['finalSnapshot'] == null ? null : map['finalSnapshot'] as bool,
      iops: map['iops'] == null ? null : map['iops'] as int,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      multiAttachEnabled: map['multiAttachEnabled'] == null ? null : map['multiAttachEnabled'] as bool,
      ...
      volumeInitializationRate: map['volumeInitializationRate'] == null ? null : map['volumeInitializationRate'] as int,
    );
  }
}
