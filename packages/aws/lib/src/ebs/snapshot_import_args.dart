...
class SnapshotImportArgs {
  ...
  factory SnapshotImportArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotImportArgs(
      clientData: map['clientData'] == null ? null : SnapshotImportClientData.fromMap((map['clientData'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      diskContainer: SnapshotImportDiskContainer.fromMap((map['diskContainer'] as Map).cast<String, dynamic>()),
