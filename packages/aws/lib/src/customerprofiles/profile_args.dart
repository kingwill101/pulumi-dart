...
class ProfileArgs {
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      ...
      additionalInformation: map['additionalInformation'] == null ? null : map['additionalInformation'] as String,
      address: map['address'] == null ? null : ProfileAddress.fromMap((map['address'] as Map).cast<String, dynamic>()),
      attributes: map['attributes'] == null ? null : (map['attributes'] as Map).cast<String, String>(),
      billingAddress: map['billingAddress'] == null ? null : ProfileBillingAddress.fromMap((map['billingAddress'] as Map).cast<String, dynamic>()),
      birthDate: map['birthDate'] == null ? null : map['birthDate'] as String,
      businessEmailAddress: map['businessEmailAddress'] == null ? null : map['businessEmailAddress'] as String,
      businessName: map['businessName'] == null ? null : map['businessName'] as String,
      businessPhoneNumber: map['businessPhoneNumber'] == null ? null : map['businessPhoneNumber'] as String,
      ...
      genderString: map['genderString'] == null ? null : map['genderString'] as String,
      homePhoneNumber: map['homePhoneNumber'] == null ? null : map['homePhoneNumber'] as String,
      lastName: map['lastName'] == null ? null : map['lastName'] as String,
      mailingAddress: map['mailingAddress'] == null ? null : ProfileMailingAddress.fromMap((map['mailingAddress'] as Map).cast<String, dynamic>()),
      middleName: map['middleName'] == null ? null : map['middleName'] as String,
      mobilePhoneNumber: map['mobilePhoneNumber'] == null ? null : map['mobilePhoneNumber'] as String,
      partyTypeString: map['partyTypeString'] == null ? null : map['partyTypeString'] as String,
      personalEmailAddress: map['personalEmailAddress'] == null ? null : map['personalEmailAddress'] as String,
      phoneNumber: map['phoneNumber'] == null ? null : map['phoneNumber'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      shippingAddress: map['shippingAddress'] == null ? null : ProfileShippingAddress.fromMap((map['shippingAddress'] as Map).cast<String, dynamic>()),
    );
  }
}
