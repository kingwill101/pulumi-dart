...
class ProfileArgs {
  ...
  ProfileArgs({
    ...
    ProfileShippingAddress? shippingAddress,
        ...
        mailingAddress =
            pulumi.Input.asOptionalInput<ProfileMailingAddress>(mailingAddress),
        middleName = pulumi.Input.asOptionalInput<String>(middleName),
        mobilePhoneNumber =
            pulumi.Input.asOptionalInput<String>(mobilePhoneNumber),
        partyTypeString = pulumi.Input.asOptionalInput<String>(partyTypeString),
        personalEmailAddress =
            pulumi.Input.asOptionalInput<String>(personalEmailAddress),
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      accountNumber:
          map['accountNumber'] == null ? null : map['accountNumber'] as String,
      ...
      businessName:
          map['businessName'] == null ? null : map['businessName'] as String,
      ...
      genderString:
          map['genderString'] == null ? null : map['genderString'] as String,
