...
class DomainArgs {
  ...
  DomainArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<String>(deadLetterQueueUrl),
        defaultEncryptionKey =
            pulumi.Input.asOptionalInput<String>(defaultEncryptionKey),
        defaultExpirationDays =
            pulumi.Input.asInput<int>(defaultExpirationDays),
        domainName = pulumi.Input.asInput<String>(domainName),
        matching = pulumi.Input.asOptionalInput<DomainMatching>(matching),
        region = pulumi.Input.asOptionalInput<String>(region),
        ruleBasedMatching =
            pulumi.Input.asOptionalInput<DomainRuleBasedMatching>(
                ruleBasedMatching),
