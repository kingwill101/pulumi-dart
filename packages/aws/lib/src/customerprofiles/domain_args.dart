...
class DomainArgs {
  ...
  DomainArgs({
    ...
    Map<String, String>? tags,
  }) : deadLetterQueueUrl = pulumi.Input.asOptionalInput<String>(
         deadLetterQueueUrl,
       ),
       defaultEncryptionKey = pulumi.Input.asOptionalInput<String>(
       ...
       ruleBasedMatching = pulumi
           .Input.asOptionalInput<DomainRuleBasedMatching>(ruleBasedMatching),
    ...
    return <String, dynamic>{
      ...
      'matching':
          ?pulumi.Input.mapOptionalInputValue<
            DomainMatching,
            Map<String, dynamic>
          >(matching, (value) => value.toMap()),
      'region': ?region,
      'ruleBasedMatching':
          ?pulumi.Input.mapOptionalInputValue<
            DomainRuleBasedMatching,
            Map<String, dynamic>
          >(ruleBasedMatching, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      deadLetterQueueUrl: map['deadLetterQueueUrl'] == null
          ? null
          : map['deadLetterQueueUrl'] as String,
      defaultEncryptionKey: map['defaultEncryptionKey'] == null
          ? null
          : map['defaultEncryptionKey'] as String,
      defaultExpirationDays: map['defaultExpirationDays'] as int,
      domainName: map['domainName'] as String,
      matching: map['matching'] == null
          ? null
          : DomainMatching.fromMap(
              (map['matching'] as Map).cast<String, dynamic>(),
            ),
      region: map['region'] == null ? null : map['region'] as String,
      ruleBasedMatching: map['ruleBasedMatching'] == null
          ? null
          : DomainRuleBasedMatching.fromMap(
              (map['ruleBasedMatching'] as Map).cast<String, dynamic>(),
            ),
      tags: map['tags'] == null
          ? null
