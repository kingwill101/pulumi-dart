...
class StateMachineArgs {
  ...
  factory StateMachineArgs.fromMap(Map<String, dynamic> map) {
    return StateMachineArgs(
      ...
      encryptionConfiguration: map['encryptionConfiguration'] == null ? null : StateMachineEncryptionConfiguration.fromMap((map['encryptionConfiguration'] as Map).cast<String, dynamic>()),
      loggingConfiguration: map['loggingConfiguration'] == null ? null : StateMachineLoggingConfiguration.fromMap((map['loggingConfiguration'] as Map).cast<String, dynamic>()),
      ...
      tracingConfiguration: map['tracingConfiguration'] == null ? null : StateMachineTracingConfiguration.fromMap((map['tracingConfiguration'] as Map).cast<String, dynamic>()),
