...
class AliasArgs {
  ...
  AliasArgs({
    ...
    String? name,
    String? region,
    required List<AliasRoutingConfiguration> routingConfigurations,
  }) :
  ...
  factory AliasArgs.fromMap(Map<String, dynamic> map) {
    return AliasArgs(
      ...
      routingConfigurations: pulumi.Input.decodeList<AliasRoutingConfiguration>(map['routingConfigurations'], (value) => AliasRoutingConfiguration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
