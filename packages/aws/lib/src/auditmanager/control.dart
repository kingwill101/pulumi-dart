...
class Control extends pulumi.CustomResource {
  ...
  Control(
    ...
    this.actionPlanInstructions = registerOutput<String?>('actionPlanInstructions');
    this.actionPlanTitle = registerOutput<String?>('actionPlanTitle');
    this.arn = registerOutput<String>('arn');
    this.controlMappingSources = registerOutput<List<ControlControlMappingSource>?>('controlMappingSources');
