...
class AccountRegistrationArgs {
  ...
  factory AccountRegistrationArgs.fromMap(Map<String, dynamic> map) {
    return AccountRegistrationArgs(
      delegatedAdminAccount: map['delegatedAdminAccount'] == null ? null : map['delegatedAdminAccount'] as String,
      deregisterOnDestroy: map['deregisterOnDestroy'] == null ? null : map['deregisterOnDestroy'] as bool,
