...
class AssessmentArgs {
  ...
  })  : assessmentReportsDestination = pulumi.Input.asOptionalInput<
  ...
  factory AssessmentArgs.fromMap(Map<String, dynamic> map) {
    return AssessmentArgs(
      assessmentReportsDestination: map['assessmentReportsDestination'] == null
          ? null
          : AssessmentAssessmentReportsDestination.fromMap(
              (map['assessmentReportsDestination'] as Map)
                  .cast<String, dynamic>()),
      description:
      ...
      roles: pulumi.Input.decodeList<AssessmentRole>(
          map['roles'],
          (value) =>
