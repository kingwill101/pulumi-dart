...
class ReplicationConfigurationTemplateArgs {
  ...
  ReplicationConfigurationTemplateArgs({
    ...
    required bool useDedicatedReplicationServer,
            ...
            pulumi.Input.asInput<bool>(associateDefaultSecurityGroup),
        autoReplicateNewDisks =
            pulumi.Input.asOptionalInput<bool>(autoReplicateNewDisks),
        ...
        defaultLargeStagingDiskType =
            pulumi.Input.asInput<String>(defaultLargeStagingDiskType),
        ebsEncryption = pulumi.Input.asInput<String>(ebsEncryption),
        ebsEncryptionKeyArn =
            pulumi.Input.asOptionalInput<String>(ebsEncryptionKeyArn),
        pitPolicies = pulumi.Input.asOptionalInput<
            List<ReplicationConfigurationTemplatePitPolicy>>(pitPolicies),
        region = pulumi.Input.asOptionalInput<String>(region),
        replicationServerInstanceType =
            pulumi.Input.asInput<String>(replicationServerInstanceType),
        replicationServersSecurityGroupsIds =
            pulumi.Input.asInput<List<String>>(
                replicationServersSecurityGroupsIds),
        stagingAreaSubnetId = pulumi.Input.asInput<String>(stagingAreaSubnetId),
        stagingAreaTags =
            pulumi.Input.asInput<Map<String, String>>(stagingAreaTags),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        timeouts = pulumi.Input.asOptionalInput<
            ReplicationConfigurationTemplateTimeouts>(timeouts),
        useDedicatedReplicationServer =
            pulumi.Input.asInput<bool>(useDedicatedReplicationServer);
