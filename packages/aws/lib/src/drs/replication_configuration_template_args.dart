...
class ReplicationConfigurationTemplateArgs {
  ...
  ReplicationConfigurationTemplateArgs({
    ...
    required bool useDedicatedReplicationServer,
  }) : associateDefaultSecurityGroup = pulumi.Input.asInput<bool>(
         associateDefaultSecurityGroup,
       ),
       autoReplicateNewDisks = pulumi.Input.asOptionalInput<bool>(
       ...
       defaultLargeStagingDiskType = pulumi.Input.asInput<String>(
         defaultLargeStagingDiskType,
       ),
       ebsEncryption = pulumi.Input.asInput<String>(ebsEncryption),
       ebsEncryptionKeyArn = pulumi.Input.asOptionalInput<String>(
         ebsEncryptionKeyArn,
       ),
       pitPolicies =
       ...
       replicationServerInstanceType = pulumi.Input.asInput<String>(
       ...
       stagingAreaTags = pulumi.Input.asInput<Map<String, String>>(
         stagingAreaTags,
       ),
       ...
       timeouts =
           ...
           >(timeouts),
       useDedicatedReplicationServer = pulumi.Input.asInput<bool>(
  ...
  factory ReplicationConfigurationTemplateArgs.fromMap(
    ...
    return ReplicationConfigurationTemplateArgs(
      ...
      autoReplicateNewDisks: map['autoReplicateNewDisks'] == null
          ? null
          : map['autoReplicateNewDisks'] as bool,
      ...
      ebsEncryptionKeyArn: map['ebsEncryptionKeyArn'] == null
          ? null
          : map['ebsEncryptionKeyArn'] as String,
      pitPolicies: map['pitPolicies'] == null
          ? null
