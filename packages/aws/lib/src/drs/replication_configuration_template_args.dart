...
class ReplicationConfigurationTemplateArgs {
  ...
  ReplicationConfigurationTemplateArgs({
    ...
    required String dataPlaneRouting,
    required String defaultLargeStagingDiskType,
    required String ebsEncryption,
    String? ebsEncryptionKeyArn,
    List<ReplicationConfigurationTemplatePitPolicy>? pitPolicies,
    String? region,
    ...
    ReplicationConfigurationTemplateTimeouts? timeouts,
  ...
  factory ReplicationConfigurationTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigurationTemplateArgs(
      associateDefaultSecurityGroup: map['associateDefaultSecurityGroup'] as bool,
      autoReplicateNewDisks: map['autoReplicateNewDisks'] == null ? null : map['autoReplicateNewDisks'] as bool,
      bandwidthThrottling: map['bandwidthThrottling'] as int,
      createPublicIp: map['createPublicIp'] as bool,
      dataPlaneRouting: map['dataPlaneRouting'] as String,
      defaultLargeStagingDiskType: map['defaultLargeStagingDiskType'] as String,
      ebsEncryption: map['ebsEncryption'] as String,
      ebsEncryptionKeyArn: map['ebsEncryptionKeyArn'] == null ? null : map['ebsEncryptionKeyArn'] as String,
      pitPolicies: map['pitPolicies'] == null ? null : pulumi.Input.decodeList<ReplicationConfigurationTemplatePitPolicy>(map['pitPolicies'], (value) => ReplicationConfigurationTemplatePitPolicy.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      replicationServerInstanceType: map['replicationServerInstanceType'] as String,
      replicationServersSecurityGroupsIds: (map['replicationServersSecurityGroupsIds'] as List).cast<String>(),
      stagingAreaSubnetId: map['stagingAreaSubnetId'] as String,
      stagingAreaTags: (map['stagingAreaTags'] as Map).cast<String, String>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : ReplicationConfigurationTemplateTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      useDedicatedReplicationServer: map['useDedicatedReplicationServer'] as bool,
    );
  }
}
