...
class QueryLoggingConfigurationDestinationFilters {
  ...
  QueryLoggingConfigurationDestinationFilters({required this.qspThreshold});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'qspThreshold': qspThreshold};
  }

  factory QueryLoggingConfigurationDestinationFilters.fromMap(
