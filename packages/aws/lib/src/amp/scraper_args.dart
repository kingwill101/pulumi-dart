...
class ScraperArgs {
  ...
  ScraperArgs({
    ...
    ScraperTimeouts? timeouts,
       ...
       roleConfiguration = pulumi
           .Input.asOptionalInput<ScraperRoleConfiguration>(roleConfiguration),
  ...
  factory ScraperArgs.fromMap(Map<String, dynamic> map) {
    return ScraperArgs(
      ...
      destination: ScraperDestination.fromMap(
        (map['destination'] as Map).cast<String, dynamic>(),
      ),
      region: map['region'] == null ? null : map['region'] as String,
      roleConfiguration: map['roleConfiguration'] == null
          ? null
          : ScraperRoleConfiguration.fromMap(
              (map['roleConfiguration'] as Map).cast<String, dynamic>(),
            ),
      scrapeConfiguration: map['scrapeConfiguration'] as String,
      source: map['source'] == null
          ? null
          : ScraperSource.fromMap(
