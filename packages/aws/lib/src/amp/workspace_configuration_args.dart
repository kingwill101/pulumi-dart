...
class WorkspaceConfigurationArgs {
  ...
  factory WorkspaceConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceConfigurationArgs(
      limitsPerLabelSets: map['limitsPerLabelSets'] == null ? null : pulumi.Input.decodeList<WorkspaceConfigurationLimitsPerLabelSet>(map['limitsPerLabelSets'], (value) => WorkspaceConfigurationLimitsPerLabelSet.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      retentionPeriodInDays: map['retentionPeriodInDays'] == null ? null : map['retentionPeriodInDays'] as int,
      timeouts: map['timeouts'] == null ? null : WorkspaceConfigurationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
