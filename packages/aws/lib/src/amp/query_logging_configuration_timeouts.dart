...
class QueryLoggingConfigurationTimeouts {
  ...
  /// Creates a new [QueryLoggingConfigurationTimeouts].
  ...
  QueryLoggingConfigurationTimeouts({this.create, this.delete, this.update});
  ...
  factory QueryLoggingConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return QueryLoggingConfigurationTimeouts(
