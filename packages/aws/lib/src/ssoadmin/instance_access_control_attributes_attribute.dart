...
class InstanceAccessControlAttributesAttribute {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'key': key,
      'values': pulumi.Input.encodeList<InstanceAccessControlAttributesAttributeValue, Map<String, dynamic>>(values, (value) => value.toMap()),
    };
  }

  factory InstanceAccessControlAttributesAttribute.fromMap(Map<String, dynamic> map) {
    return InstanceAccessControlAttributesAttribute(
      key: map['key'] as String,
      values: pulumi.Input.decodeList<InstanceAccessControlAttributesAttributeValue>(map['values'], (value) => InstanceAccessControlAttributesAttributeValue.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
