...
class TrustedTokenIssuer extends pulumi.CustomResource {
  ...
  TrustedTokenIssuer(
    ...
    this.trustedTokenIssuerConfiguration = registerOutput<TrustedTokenIssuerTrustedTokenIssuerConfiguration>('trustedTokenIssuerConfiguration');
    this.trustedTokenIssuerType = registerOutput<String>('trustedTokenIssuerType');
  }
}
