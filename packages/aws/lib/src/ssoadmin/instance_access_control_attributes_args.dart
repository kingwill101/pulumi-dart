...
class InstanceAccessControlAttributesArgs {
  ...
  InstanceAccessControlAttributesArgs({
    required List<InstanceAccessControlAttributesAttribute> attributes,
    required String instanceArn,
    String? region,
  })  : attributes = pulumi.Input.asInput<
            List<InstanceAccessControlAttributesAttribute>>(attributes),
  ...
  factory InstanceAccessControlAttributesArgs.fromMap(
    ...
    return InstanceAccessControlAttributesArgs(
      attributes:
          pulumi.Input.decodeList<InstanceAccessControlAttributesAttribute>(
              map['attributes'],
              (value) => InstanceAccessControlAttributesAttribute.fromMap(
