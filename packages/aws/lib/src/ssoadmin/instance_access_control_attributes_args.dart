...
class InstanceAccessControlAttributesArgs {
  ...
  factory InstanceAccessControlAttributesArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAccessControlAttributesArgs(
      attributes: pulumi.Input.decodeList<InstanceAccessControlAttributesAttribute>(map['attributes'], (value) => InstanceAccessControlAttributesAttribute.fromMap((value as Map).cast<String, dynamic>())),
