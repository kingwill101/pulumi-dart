...
class CustomerManagedPolicyAttachmentArgs {
  ...
  CustomerManagedPolicyAttachmentArgs({
    required CustomerManagedPolicyAttachmentCustomerManagedPolicyReference customerManagedPolicyReference,
  ...
  factory CustomerManagedPolicyAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return CustomerManagedPolicyAttachmentArgs(
      customerManagedPolicyReference: CustomerManagedPolicyAttachmentCustomerManagedPolicyReference.fromMap((map['customerManagedPolicyReference'] as Map).cast<String, dynamic>()),
