...
class UserSettingsArgs {
  ...
  UserSettingsArgs({
    ...
    UserSettingsCookieSynchronizationConfiguration? cookieSynchronizationConfiguration,
  ...
  factory UserSettingsArgs.fromMap(Map<String, dynamic> map) {
    return UserSettingsArgs(
      ...
      cookieSynchronizationConfiguration: map['cookieSynchronizationConfiguration'] == null ? null : UserSettingsCookieSynchronizationConfiguration.fromMap((map['cookieSynchronizationConfiguration'] as Map).cast<String, dynamic>()),
      ...
      deepLinkAllowed: map['deepLinkAllowed'] == null ? null : map['deepLinkAllowed'] as String,
      disconnectTimeoutInMinutes: map['disconnectTimeoutInMinutes'] == null ? null : map['disconnectTimeoutInMinutes'] as int,
      downloadAllowed: map['downloadAllowed'] as String,
      idleDisconnectTimeoutInMinutes: map['idleDisconnectTimeoutInMinutes'] == null ? null : map['idleDisconnectTimeoutInMinutes'] as int,
      pasteAllowed: map['pasteAllowed'] as String,
      printAllowed: map['printAllowed'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      toolbarConfiguration: map['toolbarConfiguration'] == null ? null : UserSettingsToolbarConfiguration.fromMap((map['toolbarConfiguration'] as Map).cast<String, dynamic>()),
