...
class PortalTimeouts {
  ...
  PortalTimeouts({this.create, this.delete, this.update});
  ...
  factory PortalTimeouts.fromMap(Map<String, dynamic> map) {
    return PortalTimeouts(
