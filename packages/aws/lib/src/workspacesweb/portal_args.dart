...
class PortalArgs {
  ...
  PortalArgs({
    ...
    PortalTimeouts? timeouts,
        ...
        browserSettingsArn =
            pulumi.Input.asOptionalInput<String>(browserSettingsArn),
        customerManagedKey =
            pulumi.Input.asOptionalInput<String>(customerManagedKey),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        instanceType = pulumi.Input.asOptionalInput<String>(instanceType),
        maxConcurrentSessions =
            pulumi.Input.asOptionalInput<int>(maxConcurrentSessions),
  ...
  factory PortalArgs.fromMap(Map<String, dynamic> map) {
    return PortalArgs(
      ...
      browserSettingsArn: map['browserSettingsArn'] == null
          ? null
      ...
      maxConcurrentSessions: map['maxConcurrentSessions'] == null
          ? null
          : map['maxConcurrentSessions'] as int,
