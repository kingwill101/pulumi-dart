...
class DataProtectionSettingsArgs {
  ...
  DataProtectionSettingsArgs({
    ...
    DataProtectionSettingsInlineRedactionConfiguration? inlineRedactionConfiguration,
    String? region,
  ...
  factory DataProtectionSettingsArgs.fromMap(Map<String, dynamic> map) {
    return DataProtectionSettingsArgs(
      ...
      inlineRedactionConfiguration: map['inlineRedactionConfiguration'] == null ? null : DataProtectionSettingsInlineRedactionConfiguration.fromMap((map['inlineRedactionConfiguration'] as Map).cast<String, dynamic>()),
