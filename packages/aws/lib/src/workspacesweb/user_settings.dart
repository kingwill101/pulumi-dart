...
class UserSettings extends pulumi.CustomResource {
  ...
  late final pulumi.Output<UserSettingsCookieSynchronizationConfiguration?> cookieSynchronizationConfiguration;
  ...
  /// [args] Arguments used to configure this [UserSettings]. {@macro pulumi_workspacesweb_user_settings_user_settings_args_doc}
  ...
  UserSettings(
    ...
    this.cookieSynchronizationConfiguration = registerOutput<UserSettingsCookieSynchronizationConfiguration?>('cookieSynchronizationConfiguration');
    ...
    this.disconnectTimeoutInMinutes = registerOutput<int?>('disconnectTimeoutInMinutes');
    this.downloadAllowed = registerOutput<String>('downloadAllowed');
    this.idleDisconnectTimeoutInMinutes = registerOutput<int?>('idleDisconnectTimeoutInMinutes');
    ...
    this.toolbarConfiguration = registerOutput<UserSettingsToolbarConfiguration?>('toolbarConfiguration');
