...
class SessionLoggerArgs {
  ...
  SessionLoggerArgs({
    ...
    Map<String, String>? tags,
       ...
       eventFilter = pulumi.Input.asInput<SessionLoggerEventFilter>(
         eventFilter,
       ),
  ...
  factory SessionLoggerArgs.fromMap(Map<String, dynamic> map) {
    return SessionLoggerArgs(
      ...
      eventFilter: SessionLoggerEventFilter.fromMap(
        (map['eventFilter'] as Map).cast<String, dynamic>(),
      ),
      logConfiguration: SessionLoggerLogConfiguration.fromMap(
