...
class SessionLoggerArgs {
  ...
  SessionLoggerArgs({
    ...
    String? displayName,
    required SessionLoggerEventFilter eventFilter,
    required SessionLoggerLogConfiguration logConfiguration,
    String? region,
  ...
  factory SessionLoggerArgs.fromMap(Map<String, dynamic> map) {
    return SessionLoggerArgs(
      ...
      eventFilter: SessionLoggerEventFilter.fromMap((map['eventFilter'] as Map).cast<String, dynamic>()),
      logConfiguration: SessionLoggerLogConfiguration.fromMap((map['logConfiguration'] as Map).cast<String, dynamic>()),
