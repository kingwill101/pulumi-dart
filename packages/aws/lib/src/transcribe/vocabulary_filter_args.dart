...
class VocabularyFilterArgs {
  ...
  VocabularyFilterArgs({
    ...
    List<String>? words,
        ...
        vocabularyFilterFileUri =
            pulumi.Input.asOptionalInput<String>(vocabularyFilterFileUri),
        vocabularyFilterName =
            pulumi.Input.asInput<String>(vocabularyFilterName),
  ...
  factory VocabularyFilterArgs.fromMap(Map<String, dynamic> map) {
    return VocabularyFilterArgs(
      ...
      vocabularyFilterFileUri: map['vocabularyFilterFileUri'] == null
          ? null
          : map['vocabularyFilterFileUri'] as String,
      vocabularyFilterName: map['vocabularyFilterName'] as String,
      words:
