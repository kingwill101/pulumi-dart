...
class AppLimits {
  ...
  Map<String, dynamic> toMap() {
    ...
    final maximumDurationValue = maximumDuration;
    if (maximumDurationValue != null) {
      map['maximumDuration'] = maximumDurationValue;
    }
    final messagesPerSecondValue = messagesPerSecond;
    if (messagesPerSecondValue != null) {
      map['messagesPerSecond'] = messagesPerSecondValue;
    }
    final totalValue = total;
    if (totalValue != null) {
      map['total'] = totalValue;
    }
    return map;
  }
  ...
  factory AppLimits.fromMap(Map<String, dynamic> map) {
    return AppLimits(
      ...
      maximumDuration:
          map['maximumDuration'] == null ? null : map['maximumDuration'] as int,
      messagesPerSecond: map['messagesPerSecond'] == null
          ? null
          : map['messagesPerSecond'] as int,
