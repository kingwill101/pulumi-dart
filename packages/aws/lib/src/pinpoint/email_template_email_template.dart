...
class EmailTemplateEmailTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?headers == null ? null : pulumi.Input.encodeList<EmailTemplateEmailTemplateHeader, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'htmlPart': ?htmlPart,
  ...
  factory EmailTemplateEmailTemplate.fromMap(Map<String, dynamic> map) {
    return EmailTemplateEmailTemplate(
      defaultSubstitutions: map['defaultSubstitutions'] == null ? null : map['defaultSubstitutions'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<EmailTemplateEmailTemplateHeader>(map['headers'], (value) => EmailTemplateEmailTemplateHeader.fromMap((value as Map).cast<String, dynamic>())),
      htmlPart: map['htmlPart'] == null ? null : map['htmlPart'] as String,
      recommenderId: map['recommenderId'] == null ? null : map['recommenderId'] as String,
