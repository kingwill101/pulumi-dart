...
class Smsvoicev2PhoneNumberArgs {
  ...
  Smsvoicev2PhoneNumberArgs({
    ...
    String? twoWayChannelRole,
        ...
        numberCapabilities =
            pulumi.Input.asInput<List<String>>(numberCapabilities),
        ...
        selfManagedOptOutsEnabled =
            pulumi.Input.asOptionalInput<bool>(selfManagedOptOutsEnabled),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        timeouts = pulumi.Input.asOptionalInput<Smsvoicev2PhoneNumberTimeouts>(
            timeouts),
        twoWayChannelArn =
            pulumi.Input.asOptionalInput<String>(twoWayChannelArn),
        twoWayChannelEnabled =
            pulumi.Input.asOptionalInput<bool>(twoWayChannelEnabled),
        twoWayChannelRole =
            pulumi.Input.asOptionalInput<String>(twoWayChannelRole);
