...
class Smsvoicev2PhoneNumberArgs {
  ...
  factory Smsvoicev2PhoneNumberArgs.fromMap(Map<String, dynamic> map) {
    return Smsvoicev2PhoneNumberArgs(
      ...
      optOutListName: map['optOutListName'] == null ? null : map['optOutListName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      registrationId: map['registrationId'] == null ? null : map['registrationId'] as String,
      selfManagedOptOutsEnabled: map['selfManagedOptOutsEnabled'] == null ? null : map['selfManagedOptOutsEnabled'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : Smsvoicev2PhoneNumberTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      twoWayChannelArn: map['twoWayChannelArn'] == null ? null : map['twoWayChannelArn'] as String,
      twoWayChannelEnabled: map['twoWayChannelEnabled'] == null ? null : map['twoWayChannelEnabled'] as bool,
      twoWayChannelRole: map['twoWayChannelRole'] == null ? null : map['twoWayChannelRole'] as String,
    );
  }
}
