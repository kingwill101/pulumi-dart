...
class Smsvoicev2PhoneNumberArgs {
  ...
  Smsvoicev2PhoneNumberArgs({
    ...
    required List<String> numberCapabilities,
    ...
    Smsvoicev2PhoneNumberTimeouts? timeouts,
    String? twoWayChannelArn,
    bool? twoWayChannelEnabled,
    String? twoWayChannelRole,
       ...
       numberCapabilities = pulumi.Input.asInput<List<String>>(
         numberCapabilities,
       ),
       ...
       selfManagedOptOutsEnabled = pulumi.Input.asOptionalInput<bool>(
       ...
       twoWayChannelArn = pulumi.Input.asOptionalInput<String>(
         twoWayChannelArn,
       ),
       twoWayChannelEnabled = pulumi.Input.asOptionalInput<bool>(
         twoWayChannelEnabled,
       ),
       twoWayChannelRole = pulumi.Input.asOptionalInput<String>(
         twoWayChannelRole,
       );
  ...
  factory Smsvoicev2PhoneNumberArgs.fromMap(Map<String, dynamic> map) {
    return Smsvoicev2PhoneNumberArgs(
      ...
      numberCapabilities: (map['numberCapabilities'] as List).cast<String>(),
      numberType: map['numberType'] as String,
      optOutListName: map['optOutListName'] == null
          ? null
          : map['optOutListName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      registrationId: map['registrationId'] == null
          ? null
          : map['registrationId'] as String,
      selfManagedOptOutsEnabled: map['selfManagedOptOutsEnabled'] == null
          ? null
          : map['selfManagedOptOutsEnabled'] as bool,
      tags: map['tags'] == null
          ? null
      ...
      twoWayChannelArn: map['twoWayChannelArn'] == null
          ? null
          : map['twoWayChannelArn'] as String,
      twoWayChannelEnabled: map['twoWayChannelEnabled'] == null
          ? null
          : map['twoWayChannelEnabled'] as bool,
      twoWayChannelRole: map['twoWayChannelRole'] == null
          ? null
          : map['twoWayChannelRole'] as String,
    );
  }
}
