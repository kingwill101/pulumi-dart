...
/// {@template pulumi_pinpoint_apns_channel_apns_channel_args_doc}
/// The set of arguments for ApnsChannel.
/// {@endtemplate}
/// {@macro pulumi_pinpoint_apns_channel_apns_channel_args_doc}
class ApnsChannelArgs {
  ...
  factory ApnsChannelArgs.fromMap(Map<String, dynamic> map) {
    return ApnsChannelArgs(
      ...
      defaultAuthenticationMethod: map['defaultAuthenticationMethod'] == null ? null : map['defaultAuthenticationMethod'] as String,
      ...
      tokenKeyId: map['tokenKeyId'] == null ? null : map['tokenKeyId'] as String,
    );
  }
}
