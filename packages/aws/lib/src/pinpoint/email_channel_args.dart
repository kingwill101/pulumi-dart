...
class EmailChannelArgs {
  ...
  EmailChannelArgs({
    ...
    String? roleArn,
        ...
        configurationSet =
            pulumi.Input.asOptionalInput<String>(configurationSet),
        ...
        orchestrationSendingRoleArn =
            pulumi.Input.asOptionalInput<String>(orchestrationSendingRoleArn),
  ...
  factory EmailChannelArgs.fromMap(Map<String, dynamic> map) {
    return EmailChannelArgs(
      ...
      orchestrationSendingRoleArn: map['orchestrationSendingRoleArn'] == null
          ? null
          : map['orchestrationSendingRoleArn'] as String,
