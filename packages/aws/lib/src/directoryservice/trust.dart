...
class Trust extends pulumi.CustomResource {
  ...
  Trust(
    ...
    this.conditionalForwarderIpAddrs = registerOutput<List<String>?>('conditionalForwarderIpAddrs');
    this.createdDateTime = registerOutput<String>('createdDateTime');
    this.deleteAssociatedConditionalForwarder = registerOutput<bool>('deleteAssociatedConditionalForwarder');
    ...
    this.stateLastUpdatedDateTime = registerOutput<String>('stateLastUpdatedDateTime');
