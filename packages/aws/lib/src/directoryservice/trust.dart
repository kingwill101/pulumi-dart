...
class Trust extends pulumi.CustomResource {
  ...
  Trust(String name, {TrustArgs? args, pulumi.CustomResourceOptions? options})
    : super(
    ...
    this.conditionalForwarderIpAddrs = registerOutput<List<String>?>(
      'conditionalForwarderIpAddrs',
    );
    this.createdDateTime = registerOutput<String>('createdDateTime');
    this.deleteAssociatedConditionalForwarder = registerOutput<bool>(
    ...
    this.stateLastUpdatedDateTime = registerOutput<String>(
