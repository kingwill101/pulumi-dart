...
class TrustArgs {
  ...
  TrustArgs({
    ...
    String? trustType,
       ...
       deleteAssociatedConditionalForwarder = pulumi
           .Input.asOptionalInput<bool>(deleteAssociatedConditionalForwarder),
  ...
  factory TrustArgs.fromMap(Map<String, dynamic> map) {
    return TrustArgs(
      conditionalForwarderIpAddrs: map['conditionalForwarderIpAddrs'] == null
          ? null
          : (map['conditionalForwarderIpAddrs'] as List).cast<String>(),
      deleteAssociatedConditionalForwarder:
          map['deleteAssociatedConditionalForwarder'] == null
          ? null
          : map['deleteAssociatedConditionalForwarder'] as bool,
      directoryId: map['directoryId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      remoteDomainName: map['remoteDomainName'] as String,
      selectiveAuth: map['selectiveAuth'] == null
          ? null
          : map['selectiveAuth'] as String,
      trustDirection: map['trustDirection'] as String,
      trustPassword: map['trustPassword'] as String,
      trustType: map['trustType'] == null ? null : map['trustType'] as String,
    );
  }
}
