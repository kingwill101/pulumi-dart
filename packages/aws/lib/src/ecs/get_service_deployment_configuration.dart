...
class GetServiceDeploymentConfiguration {
  ...
  final List<GetServiceDeploymentConfigurationCanaryConfiguration> canaryConfigurations;
  /// Circuit breaker configuration. See `deployment_circuit_breaker` Block for details.
  final List<GetServiceDeploymentConfigurationDeploymentCircuitBreaker> deploymentCircuitBreakers;
  ...
  final List<GetServiceDeploymentConfigurationLinearConfiguration> linearConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alarms': pulumi.Input.encodeList<GetServiceDeploymentConfigurationAlarm, Map<String, dynamic>>(alarms, (value) => value.toMap()),
      'bakeTimeInMinutes': bakeTimeInMinutes,
      'canaryConfigurations': pulumi.Input.encodeList<GetServiceDeploymentConfigurationCanaryConfiguration, Map<String, dynamic>>(canaryConfigurations, (value) => value.toMap()),
      'deploymentCircuitBreakers': pulumi.Input.encodeList<GetServiceDeploymentConfigurationDeploymentCircuitBreaker, Map<String, dynamic>>(deploymentCircuitBreakers, (value) => value.toMap()),
      'lifecycleHooks': pulumi.Input.encodeList<GetServiceDeploymentConfigurationLifecycleHook, Map<String, dynamic>>(lifecycleHooks, (value) => value.toMap()),
      'linearConfigurations': pulumi.Input.encodeList<GetServiceDeploymentConfigurationLinearConfiguration, Map<String, dynamic>>(linearConfigurations, (value) => value.toMap()),
  ...
  factory GetServiceDeploymentConfiguration.fromMap(Map<String, dynamic> map) {
    return GetServiceDeploymentConfiguration(
      alarms: pulumi.Input.decodeList<GetServiceDeploymentConfigurationAlarm>(map['alarms'], (value) => GetServiceDeploymentConfigurationAlarm.fromMap((value as Map).cast<String, dynamic>())),
      bakeTimeInMinutes: map['bakeTimeInMinutes'] as String,
      canaryConfigurations: pulumi.Input.decodeList<GetServiceDeploymentConfigurationCanaryConfiguration>(map['canaryConfigurations'], (value) => GetServiceDeploymentConfigurationCanaryConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      deploymentCircuitBreakers: pulumi.Input.decodeList<GetServiceDeploymentConfigurationDeploymentCircuitBreaker>(map['deploymentCircuitBreakers'], (value) => GetServiceDeploymentConfigurationDeploymentCircuitBreaker.fromMap((value as Map).cast<String, dynamic>())),
      lifecycleHooks: pulumi.Input.decodeList<GetServiceDeploymentConfigurationLifecycleHook>(map['lifecycleHooks'], (value) => GetServiceDeploymentConfigurationLifecycleHook.fromMap((value as Map).cast<String, dynamic>())),
      linearConfigurations: pulumi.Input.decodeList<GetServiceDeploymentConfigurationLinearConfiguration>(map['linearConfigurations'], (value) => GetServiceDeploymentConfigurationLinearConfiguration.fromMap((value as Map).cast<String, dynamic>())),
