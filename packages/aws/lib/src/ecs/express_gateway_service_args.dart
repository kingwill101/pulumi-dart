...
class ExpressGatewayServiceArgs {
  ...
  factory ExpressGatewayServiceArgs.fromMap(Map<String, dynamic> map) {
    return ExpressGatewayServiceArgs(
      ...
      networkConfigurations: map['networkConfigurations'] == null ? null : pulumi.Input.decodeList<ExpressGatewayServiceNetworkConfiguration>(map['networkConfigurations'], (value) => ExpressGatewayServiceNetworkConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      primaryContainer: ExpressGatewayServicePrimaryContainer.fromMap((map['primaryContainer'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      scalingTargets: map['scalingTargets'] == null ? null : pulumi.Input.decodeList<ExpressGatewayServiceScalingTarget>(map['scalingTargets'], (value) => ExpressGatewayServiceScalingTarget.fromMap((value as Map).cast<String, dynamic>())),
      ...
      timeouts: map['timeouts'] == null ? null : ExpressGatewayServiceTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
