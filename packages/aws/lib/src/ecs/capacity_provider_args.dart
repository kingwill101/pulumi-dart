...
class CapacityProviderArgs {
  ...
  factory CapacityProviderArgs.fromMap(Map<String, dynamic> map) {
    return CapacityProviderArgs(
      autoScalingGroupProvider: map['autoScalingGroupProvider'] == null ? null : CapacityProviderAutoScalingGroupProvider.fromMap((map['autoScalingGroupProvider'] as Map).cast<String, dynamic>()),
      cluster: map['cluster'] == null ? null : map['cluster'] as String,
      managedInstancesProvider: map['managedInstancesProvider'] == null ? null : CapacityProviderManagedInstancesProvider.fromMap((map['managedInstancesProvider'] as Map).cast<String, dynamic>()),
