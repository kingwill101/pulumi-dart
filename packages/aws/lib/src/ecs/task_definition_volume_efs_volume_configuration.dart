...
class TaskDefinitionVolumeEfsVolumeConfiguration {
  ...
  final TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfig?
      authorizationConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    final transitEncryptionValue = transitEncryption;
    if (transitEncryptionValue != null) {
      map['transitEncryption'] = transitEncryptionValue;
    }
    final transitEncryptionPortValue = transitEncryptionPort;
    if (transitEncryptionPortValue != null) {
      map['transitEncryptionPort'] = transitEncryptionPortValue;
    }
    return map;
  }

  factory TaskDefinitionVolumeEfsVolumeConfiguration.fromMap(
    ...
    return TaskDefinitionVolumeEfsVolumeConfiguration(
      ...
      transitEncryption: map['transitEncryption'] == null
          ? null
          : map['transitEncryption'] as String,
      transitEncryptionPort: map['transitEncryptionPort'] == null
          ? null
          : map['transitEncryptionPort'] as int,
    );
  }
}
