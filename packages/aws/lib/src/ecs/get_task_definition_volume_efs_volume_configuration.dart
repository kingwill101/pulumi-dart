...
class GetTaskDefinitionVolumeEfsVolumeConfiguration {
  ...
  final List<GetTaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfig>
    ...
    return <String, dynamic>{
      'authorizationConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(authorizationConfigs, (value) => value.toMap()),
    ...
    return GetTaskDefinitionVolumeEfsVolumeConfiguration(
      authorizationConfigs:
          ...
          >(
            ...
            (value) =>
                GetTaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfig.fromMap(
