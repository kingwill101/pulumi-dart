  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dockerVolumeConfiguration': ?dockerVolumeConfiguration == null
          ? null
          : dockerVolumeConfiguration!.toMap(),
      'efsVolumeConfiguration': ?efsVolumeConfiguration == null
          ? null
          : efsVolumeConfiguration!.toMap(),
      'fsxWindowsFileServerVolumeConfiguration':
          ?fsxWindowsFileServerVolumeConfiguration == null
          ? null
          : fsxWindowsFileServerVolumeConfiguration!.toMap(),
      'hostPath': ?hostPath,
      'name': name,
    };
  }
    ...
    return TaskDefinitionVolume(
      ...
      dockerVolumeConfiguration: map['dockerVolumeConfiguration'] == null
          ...
          : TaskDefinitionVolumeDockerVolumeConfiguration.fromMap(
              (map['dockerVolumeConfiguration'] as Map).cast<String, dynamic>(),
            ),
