...
class TaskDefinition extends pulumi.CustomResource {
  ...
  TaskDefinition(
    ...
    this.ephemeralStorage = registerOutput<TaskDefinitionEphemeralStorage?>(
      'ephemeralStorage',
    );
    ...
    this.proxyConfiguration = registerOutput<TaskDefinitionProxyConfiguration?>(
      'proxyConfiguration',
    );
    this.region = registerOutput<String>('region');
    this.requiresCompatibilities = registerOutput<List<String>?>(
      'requiresCompatibilities',
    );
    this.revision = registerOutput<int>('revision');
    this.runtimePlatform = registerOutput<TaskDefinitionRuntimePlatform?>(
      'runtimePlatform',
    );
