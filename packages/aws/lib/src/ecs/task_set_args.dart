...
class TaskSetArgs {
  ...
  factory TaskSetArgs.fromMap(Map<String, dynamic> map) {
    return TaskSetArgs(
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : pulumi.Input.decodeList<TaskSetCapacityProviderStrategy>(map['capacityProviderStrategies'], (value) => TaskSetCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>())),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : pulumi.Input.decodeList<TaskSetLoadBalancer>(map['loadBalancers'], (value) => TaskSetLoadBalancer.fromMap((value as Map).cast<String, dynamic>())),
      networkConfiguration: map['networkConfiguration'] == null ? null : TaskSetNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      platformVersion: map['platformVersion'] == null ? null : map['platformVersion'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      scale: map['scale'] == null ? null : TaskSetScale.fromMap((map['scale'] as Map).cast<String, dynamic>()),
      service: map['service'] as String,
      serviceRegistries: map['serviceRegistries'] == null ? null : TaskSetServiceRegistries.fromMap((map['serviceRegistries'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      taskDefinition: map['taskDefinition'] as String,
      waitUntilStable: map['waitUntilStable'] == null ? null : map['waitUntilStable'] as bool,
      waitUntilStableTimeout: map['waitUntilStableTimeout'] == null ? null : map['waitUntilStableTimeout'] as String,
    );
  }
}
