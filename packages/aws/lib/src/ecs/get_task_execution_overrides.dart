...
class GetTaskExecutionOverrides {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containerOverrides': ?containerOverrides == null ? null : pulumi.Input.encodeList<GetTaskExecutionOverridesContainerOverride, Map<String, dynamic>>(containerOverrides!, (value) => value.toMap()),
      'cpu': ?cpu,
  ...
  factory GetTaskExecutionOverrides.fromMap(Map<String, dynamic> map) {
    return GetTaskExecutionOverrides(
      containerOverrides: map['containerOverrides'] == null ? null : pulumi.Input.decodeList<GetTaskExecutionOverridesContainerOverride>(map['containerOverrides'], (value) => GetTaskExecutionOverridesContainerOverride.fromMap((value as Map).cast<String, dynamic>())),
