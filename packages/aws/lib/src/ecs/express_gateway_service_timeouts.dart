...
class ExpressGatewayServiceTimeouts {
  ...
  /// Creates a new [ExpressGatewayServiceTimeouts].
  ...
  ExpressGatewayServiceTimeouts({this.create, this.delete, this.update});
  ...
  factory ExpressGatewayServiceTimeouts.fromMap(Map<String, dynamic> map) {
    return ExpressGatewayServiceTimeouts(
