...
class TaskDefinitionArgs {
  ...
  TaskDefinitionArgs({
    ...
    List<TaskDefinitionVolume>? volumes,
            ...
            pulumi.Input.asInput<String>(containerDefinitions),
        cpu = pulumi.Input.asOptionalInput<String>(cpu),
        enableFaultInjection =
            pulumi.Input.asOptionalInput<bool>(enableFaultInjection),
        ephemeralStorage =
        ...
        requiresCompatibilities =
            pulumi.Input.asOptionalInput<List<String>>(requiresCompatibilities),
        runtimePlatform =
        ...
        volumes =
            pulumi.Input.asOptionalInput<List<TaskDefinitionVolume>>(volumes);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (placementConstraintsValue != null) {
      map['placementConstraints'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<TaskDefinitionPlacementConstraint,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final proxyConfigurationValue = proxyConfiguration;
    if (proxyConfigurationValue != null) {
      map['proxyConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (runtimePlatformValue != null) {
      map['runtimePlatform'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (volumesValue != null) {
      map['volumes'] = pulumi.Input.mapOptionalInputValue<
              List<TaskDefinitionVolume>, List<Map<String, dynamic>>>(
          volumesValue,
          (value) => pulumi.Input.encodeList<TaskDefinitionVolume,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    return map;
  }
