...
class TaskDefinitionArgs {
  ...
  factory TaskDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return TaskDefinitionArgs(
      ...
      ephemeralStorage: map['ephemeralStorage'] == null ? null : TaskDefinitionEphemeralStorage.fromMap((map['ephemeralStorage'] as Map).cast<String, dynamic>()),
      ...
      placementConstraints: map['placementConstraints'] == null ? null : pulumi.Input.decodeList<TaskDefinitionPlacementConstraint>(map['placementConstraints'], (value) => TaskDefinitionPlacementConstraint.fromMap((value as Map).cast<String, dynamic>())),
      proxyConfiguration: map['proxyConfiguration'] == null ? null : TaskDefinitionProxyConfiguration.fromMap((map['proxyConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      requiresCompatibilities: map['requiresCompatibilities'] == null ? null : (map['requiresCompatibilities'] as List).cast<String>(),
      runtimePlatform: map['runtimePlatform'] == null ? null : TaskDefinitionRuntimePlatform.fromMap((map['runtimePlatform'] as Map).cast<String, dynamic>()),
      ...
      volumes: map['volumes'] == null ? null : pulumi.Input.decodeList<TaskDefinitionVolume>(map['volumes'], (value) => TaskDefinitionVolume.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
