...
class GetTaskExecutionArgs {
  ...
  GetTaskExecutionArgs({
    ...
    required String taskDefinition,
      ...
      capacityProviderStrategies = pulumi.Input.asOptionalInput<List<GetTaskExecutionCapacityProviderStrategy>>(capacityProviderStrategies),
      ...
      networkConfiguration = pulumi.Input.asOptionalInput<GetTaskExecutionNetworkConfiguration>(networkConfiguration),
      overrides = pulumi.Input.asOptionalInput<GetTaskExecutionOverrides>(overrides),
      placementConstraints = pulumi.Input.asOptionalInput<List<GetTaskExecutionPlacementConstraint>>(placementConstraints),
      placementStrategies = pulumi.Input.asOptionalInput<List<GetTaskExecutionPlacementStrategy>>(placementStrategies),
