...
class ReportDefinitionArgs {
  ...
  ReportDefinitionArgs({
    ...
    required String timeUnit,
            ...
            pulumi.Input.asOptionalInput<List<String>>(additionalArtifacts),
        additionalSchemaElements =
            pulumi.Input.asInput<List<String>>(additionalSchemaElements),
        compression = pulumi.Input.asInput<String>(compression),
        format = pulumi.Input.asInput<String>(format),
        refreshClosedReports =
            pulumi.Input.asOptionalInput<bool>(refreshClosedReports),
        reportName = pulumi.Input.asInput<String>(reportName),
        reportVersioning =
            pulumi.Input.asOptionalInput<String>(reportVersioning),
