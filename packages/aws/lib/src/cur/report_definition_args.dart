...
class ReportDefinitionArgs {
  ...
  factory ReportDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return ReportDefinitionArgs(
      additionalArtifacts: map['additionalArtifacts'] == null ? null : (map['additionalArtifacts'] as List).cast<String>(),
      additionalSchemaElements: (map['additionalSchemaElements'] as List).cast<String>(),
      compression: map['compression'] as String,
      format: map['format'] as String,
      refreshClosedReports: map['refreshClosedReports'] == null ? null : map['refreshClosedReports'] as bool,
      reportName: map['reportName'] as String,
      reportVersioning: map['reportVersioning'] == null ? null : map['reportVersioning'] as String,
