...
class DrtAccessRoleArnAssociationTimeouts {
  ...
  /// Creates a new [DrtAccessRoleArnAssociationTimeouts].
  ...
  DrtAccessRoleArnAssociationTimeouts({this.create, this.delete, this.update});
  ...
  factory DrtAccessRoleArnAssociationTimeouts.fromMap(
    Map<String, dynamic> map,
  ) {
    return DrtAccessRoleArnAssociationTimeouts(
