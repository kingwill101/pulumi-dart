...
class ApplicationLayerAutomaticResponseTimeouts {
  ...
  /// Creates a new [ApplicationLayerAutomaticResponseTimeouts].
  ...
  factory ApplicationLayerAutomaticResponseTimeouts.fromMap(Map<String, dynamic> map) {
    return ApplicationLayerAutomaticResponseTimeouts(
