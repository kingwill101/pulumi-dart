...
class PipelineArgs {
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      parallelismConfiguration: map['parallelismConfiguration'] == null ? null : PipelineParallelismConfiguration.fromMap((map['parallelismConfiguration'] as Map).cast<String, dynamic>()),
      pipelineDefinition: map['pipelineDefinition'] == null ? null : map['pipelineDefinition'] as String,
      pipelineDefinitionS3Location: map['pipelineDefinitionS3Location'] == null ? null : PipelinePipelineDefinitionS3Location.fromMap((map['pipelineDefinitionS3Location'] as Map).cast<String, dynamic>()),
      pipelineDescription: map['pipelineDescription'] == null ? null : map['pipelineDescription'] as String,
