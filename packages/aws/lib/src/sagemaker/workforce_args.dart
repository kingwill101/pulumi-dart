...
class WorkforceArgs {
  ...
  factory WorkforceArgs.fromMap(Map<String, dynamic> map) {
    return WorkforceArgs(
      cognitoConfig: map['cognitoConfig'] == null ? null : WorkforceCognitoConfig.fromMap((map['cognitoConfig'] as Map).cast<String, dynamic>()),
      oidcConfig: map['oidcConfig'] == null ? null : WorkforceOidcConfig.fromMap((map['oidcConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      sourceIpConfig: map['sourceIpConfig'] == null ? null : WorkforceSourceIpConfig.fromMap((map['sourceIpConfig'] as Map).cast<String, dynamic>()),
      workforceName: map['workforceName'] as String,
      workforceVpcConfig: map['workforceVpcConfig'] == null ? null : WorkforceWorkforceVpcConfig.fromMap((map['workforceVpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
