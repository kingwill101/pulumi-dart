...
class StudioLifecycleConfig extends pulumi.CustomResource {
  ...
  StudioLifecycleConfig(
    ...
    this.studioLifecycleConfigAppType = registerOutput<String>(
      'studioLifecycleConfigAppType',
    );
    this.studioLifecycleConfigContent = registerOutput<String>(
      'studioLifecycleConfigContent',
    );
    this.studioLifecycleConfigName = registerOutput<String>(
