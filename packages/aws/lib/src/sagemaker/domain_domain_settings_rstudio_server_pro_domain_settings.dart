...
class DomainDomainSettingsRStudioServerProDomainSettings {
  ...
  final DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec? defaultResourceSpec;
  ...
  factory DomainDomainSettingsRStudioServerProDomainSettings.fromMap(Map<String, dynamic> map) {
    return DomainDomainSettingsRStudioServerProDomainSettings(
      defaultResourceSpec: map['defaultResourceSpec'] == null ? null : DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec.fromMap((map['defaultResourceSpec'] as Map).cast<String, dynamic>()),
      domainExecutionRoleArn: map['domainExecutionRoleArn'] as String,
      rStudioConnectUrl: map['rStudioConnectUrl'] == null ? null : map['rStudioConnectUrl'] as String,
      rStudioPackageManagerUrl: map['rStudioPackageManagerUrl'] == null ? null : map['rStudioPackageManagerUrl'] as String,
    );
  }
}
