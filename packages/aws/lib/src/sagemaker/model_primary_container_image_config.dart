...
class ModelPrimaryContainerImageConfig {
  ...
  final ModelPrimaryContainerImageConfigRepositoryAuthConfig? repositoryAuthConfig;
  ...
  factory ModelPrimaryContainerImageConfig.fromMap(Map<String, dynamic> map) {
    return ModelPrimaryContainerImageConfig(
      ...
      repositoryAuthConfig: map['repositoryAuthConfig'] == null ? null : ModelPrimaryContainerImageConfigRepositoryAuthConfig.fromMap((map['repositoryAuthConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
