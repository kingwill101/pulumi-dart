...
class MlflowTrackingServerArgs {
  ...
  factory MlflowTrackingServerArgs.fromMap(Map<String, dynamic> map) {
    return MlflowTrackingServerArgs(
      ...
      automaticModelRegistration: map['automaticModelRegistration'] == null ? null : map['automaticModelRegistration'] as bool,
      mlflowVersion: map['mlflowVersion'] == null ? null : map['mlflowVersion'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      roleArn: map['roleArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      trackingServerName: map['trackingServerName'] as String,
      trackingServerSize: map['trackingServerSize'] == null ? null : map['trackingServerSize'] as String,
