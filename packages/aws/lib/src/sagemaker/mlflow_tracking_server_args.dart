...
class MlflowTrackingServerArgs {
  ...
  MlflowTrackingServerArgs({
    ...
    String? weeklyMaintenanceWindowStart,
       ...
       automaticModelRegistration = pulumi.Input.asOptionalInput<bool>(
       ...
       trackingServerSize = pulumi.Input.asOptionalInput<String>(
         trackingServerSize,
       ),
  ...
  factory MlflowTrackingServerArgs.fromMap(Map<String, dynamic> map) {
    return MlflowTrackingServerArgs(
      ...
      mlflowVersion: map['mlflowVersion'] == null
          ? null
          : map['mlflowVersion'] as String,
