  ...
  UserProfileArgs({
    ...
    UserProfileUserSettings? userSettings,
        ...
        singleSignOnUserIdentifier =
            pulumi.Input.asOptionalInput<String>(singleSignOnUserIdentifier),
        singleSignOnUserValue =
            pulumi.Input.asOptionalInput<String>(singleSignOnUserValue),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        userProfileName = pulumi.Input.asInput<String>(userProfileName),
        userSettings =
            pulumi.Input.asOptionalInput<UserProfileUserSettings>(userSettings);
