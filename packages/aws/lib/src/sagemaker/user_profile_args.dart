...
class UserProfileArgs {
  ...
  factory UserProfileArgs.fromMap(Map<String, dynamic> map) {
    return UserProfileArgs(
      ...
      singleSignOnUserIdentifier: map['singleSignOnUserIdentifier'] == null ? null : map['singleSignOnUserIdentifier'] as String,
      singleSignOnUserValue: map['singleSignOnUserValue'] == null ? null : map['singleSignOnUserValue'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userProfileName: map['userProfileName'] as String,
      userSettings: map['userSettings'] == null ? null : UserProfileUserSettings.fromMap((map['userSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
