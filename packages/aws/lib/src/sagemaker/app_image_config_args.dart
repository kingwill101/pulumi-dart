...
class AppImageConfigArgs {
  ...
  factory AppImageConfigArgs.fromMap(Map<String, dynamic> map) {
    return AppImageConfigArgs(
      ...
      codeEditorAppImageConfig: map['codeEditorAppImageConfig'] == null ? null : AppImageConfigCodeEditorAppImageConfig.fromMap((map['codeEditorAppImageConfig'] as Map).cast<String, dynamic>()),
      jupyterLabImageConfig: map['jupyterLabImageConfig'] == null ? null : AppImageConfigJupyterLabImageConfig.fromMap((map['jupyterLabImageConfig'] as Map).cast<String, dynamic>()),
      kernelGatewayImageConfig: map['kernelGatewayImageConfig'] == null ? null : AppImageConfigKernelGatewayImageConfig.fromMap((map['kernelGatewayImageConfig'] as Map).cast<String, dynamic>()),
