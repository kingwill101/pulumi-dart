...
class LabelingJob extends pulumi.CustomResource {
  ...
  LabelingJob(
    ...
    this.humanTaskConfig = registerOutput<LabelingJobHumanTaskConfig>(
      'humanTaskConfig',
    );
    ...
    this.labelCategoryConfigS3Uri = registerOutput<String?>(
      'labelCategoryConfigS3Uri',
    );
    this.labelCounters = registerOutput<List<LabelingJobLabelCounter>>(
      'labelCounters',
    );
