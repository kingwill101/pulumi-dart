...
class AppArgs {
  ...
  AppArgs({
    ...
    String? userProfileName,
        ...
        resourceSpec =
            pulumi.Input.asOptionalInput<AppResourceSpec>(resourceSpec),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (resourceSpecValue != null) {
      map['resourceSpec'] = pulumi.Input.mapOptionalInputValue<AppResourceSpec,
          Map<String, dynamic>>(resourceSpecValue, (value) => value.toMap());
    }
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      resourceSpec: map['resourceSpec'] == null
          ? null
          : AppResourceSpec.fromMap(
              (map['resourceSpec'] as Map).cast<String, dynamic>()),
      spaceName: map['spaceName'] == null ? null : map['spaceName'] as String,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      userProfileName: map['userProfileName'] == null
          ? null
          : map['userProfileName'] as String,
    );
  }
}
