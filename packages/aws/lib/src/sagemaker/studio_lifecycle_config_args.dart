...
class StudioLifecycleConfigArgs {
  ...
  StudioLifecycleConfigArgs({
    ...
    Map<String, String>? tags,
       ...
       studioLifecycleConfigAppType = pulumi.Input.asInput<String>(
         studioLifecycleConfigAppType,
       ),
       studioLifecycleConfigContent = pulumi.Input.asInput<String>(
         studioLifecycleConfigContent,
       ),
       studioLifecycleConfigName = pulumi.Input.asInput<String>(
