...
class UserProfile extends pulumi.CustomResource {
  ...
  UserProfile(
    ...
    this.singleSignOnUserIdentifier = registerOutput<String?>(
      'singleSignOnUserIdentifier',
    );
    this.singleSignOnUserValue = registerOutput<String?>(
      'singleSignOnUserValue',
    );
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.userProfileName = registerOutput<String>('userProfileName');
    this.userSettings = registerOutput<UserProfileUserSettings?>(
      'userSettings',
    );
  }
}
