...
class Domain extends pulumi.CustomResource {
  ...
  Domain(String name, {DomainArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.appSecurityGroupManagement = registerOutput<String?>(
      'appSecurityGroupManagement',
    );
    this.arn = registerOutput<String>('arn');
    this.authMode = registerOutput<String>('authMode');
    this.defaultSpaceSettings = registerOutput<DomainDefaultSpaceSettings?>(
      'defaultSpaceSettings',
    );
    this.defaultUserSettings = registerOutput<DomainDefaultUserSettings>(
      'defaultUserSettings',
    );
    this.domainName = registerOutput<String>('domainName');
    this.domainSettings = registerOutput<DomainDomainSettings?>(
      'domainSettings',
    );
    this.homeEfsFileSystemId = registerOutput<String>('homeEfsFileSystemId');
    this.kmsKeyId = registerOutput<String?>('kmsKeyId');
    this.region = registerOutput<String>('region');
    this.retentionPolicy = registerOutput<DomainRetentionPolicy?>(
      'retentionPolicy',
    );
    this.securityGroupIdForDomainBoundary = registerOutput<String>(
      'securityGroupIdForDomainBoundary',
    );
    this.singleSignOnApplicationArn = registerOutput<String>(
      'singleSignOnApplicationArn',
    );
    this.singleSignOnManagedApplicationInstanceId = registerOutput<String>(
