...
class ProjectArgs {
  ...
  ProjectArgs({
    ...
    String? region,
    required ProjectServiceCatalogProvisioningDetails serviceCatalogProvisioningDetails,
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      projectDescription: map['projectDescription'] == null ? null : map['projectDescription'] as String,
      projectName: map['projectName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      serviceCatalogProvisioningDetails: ProjectServiceCatalogProvisioningDetails.fromMap((map['serviceCatalogProvisioningDetails'] as Map).cast<String, dynamic>()),
