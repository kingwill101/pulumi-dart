...
class HubArgs {
  ...
  factory HubArgs.fromMap(Map<String, dynamic> map) {
    return HubArgs(
      ...
      hubDisplayName: map['hubDisplayName'] == null ? null : map['hubDisplayName'] as String,
      hubName: map['hubName'] as String,
      hubSearchKeywords: map['hubSearchKeywords'] == null ? null : (map['hubSearchKeywords'] as List).cast<String>(),
      region: map['region'] == null ? null : map['region'] as String,
      s3StorageConfig: map['s3StorageConfig'] == null ? null : HubS3StorageConfig.fromMap((map['s3StorageConfig'] as Map).cast<String, dynamic>()),
