...
class NotebookInstanceArgs {
  ...
  NotebookInstanceArgs({
    ...
    NotebookInstanceInstanceMetadataServiceConfiguration? instanceMetadataServiceConfiguration,
  ...
  factory NotebookInstanceArgs.fromMap(Map<String, dynamic> map) {
    return NotebookInstanceArgs(
      ...
      directInternetAccess: map['directInternetAccess'] == null ? null : map['directInternetAccess'] as String,
      instanceMetadataServiceConfiguration: map['instanceMetadataServiceConfiguration'] == null ? null : NotebookInstanceInstanceMetadataServiceConfiguration.fromMap((map['instanceMetadataServiceConfiguration'] as Map).cast<String, dynamic>()),
      instanceType: map['instanceType'] as String,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      lifecycleConfigName: map['lifecycleConfigName'] == null ? null : map['lifecycleConfigName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      platformIdentifier: map['platformIdentifier'] == null ? null : map['platformIdentifier'] as String,
