...
class NotebookInstanceArgs {
  ...
  NotebookInstanceArgs({
    ...
    int? volumeSize,
       ...
       defaultCodeRepository = pulumi.Input.asOptionalInput<String>(
         defaultCodeRepository,
       ),
       directInternetAccess = pulumi.Input.asOptionalInput<String>(
       ...
       lifecycleConfigName = pulumi.Input.asOptionalInput<String>(
         lifecycleConfigName,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       platformIdentifier = pulumi.Input.asOptionalInput<String>(
         platformIdentifier,
       ),
  ...
  factory NotebookInstanceArgs.fromMap(Map<String, dynamic> map) {
    return NotebookInstanceArgs(
      ...
      rootAccess: map['rootAccess'] == null
          ? null
          : map['rootAccess'] as String,
