  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'captureContentTypeHeader': ?captureContentTypeHeader == null
          ? null
          : captureContentTypeHeader!.toMap(),
      'captureOptions':
          pulumi.Input.encodeList<
            EndpointConfigurationDataCaptureConfigCaptureOption,
            Map<String, dynamic>
          >(captureOptions, (value) => value.toMap()),
    ...
    return EndpointConfigurationDataCaptureConfig(
      captureContentTypeHeader: map['captureContentTypeHeader'] == null
          ...
          : EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader.fromMap(
              (map['captureContentTypeHeader'] as Map).cast<String, dynamic>(),
            ),
      captureOptions:
      ...
      enableCapture: map['enableCapture'] == null
          ? null
          : map['enableCapture'] as bool,
