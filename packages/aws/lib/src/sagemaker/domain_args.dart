...
class DomainArgs {
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      appNetworkAccessType: map['appNetworkAccessType'] == null ? null : map['appNetworkAccessType'] as String,
      appSecurityGroupManagement: map['appSecurityGroupManagement'] == null ? null : map['appSecurityGroupManagement'] as String,
      authMode: map['authMode'] as String,
      defaultSpaceSettings: map['defaultSpaceSettings'] == null ? null : DomainDefaultSpaceSettings.fromMap((map['defaultSpaceSettings'] as Map).cast<String, dynamic>()),
      defaultUserSettings: DomainDefaultUserSettings.fromMap((map['defaultUserSettings'] as Map).cast<String, dynamic>()),
      domainName: map['domainName'] as String,
      domainSettings: map['domainSettings'] == null ? null : DomainDomainSettings.fromMap((map['domainSettings'] as Map).cast<String, dynamic>()),
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      retentionPolicy: map['retentionPolicy'] == null ? null : DomainRetentionPolicy.fromMap((map['retentionPolicy'] as Map).cast<String, dynamic>()),
      subnetIds: (map['subnetIds'] as List).cast<String>(),
      tagPropagation: map['tagPropagation'] == null ? null : map['tagPropagation'] as String,
