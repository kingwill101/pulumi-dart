...
class SpaceArgs {
  ...
  factory SpaceArgs.fromMap(Map<String, dynamic> map) {
    return SpaceArgs(
      ...
      ownershipSettings: map['ownershipSettings'] == null ? null : SpaceOwnershipSettings.fromMap((map['ownershipSettings'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      spaceDisplayName: map['spaceDisplayName'] == null ? null : map['spaceDisplayName'] as String,
      spaceName: map['spaceName'] as String,
      spaceSettings: map['spaceSettings'] == null ? null : SpaceSpaceSettings.fromMap((map['spaceSettings'] as Map).cast<String, dynamic>()),
      spaceSharingSettings: map['spaceSharingSettings'] == null ? null : SpaceSpaceSharingSettings.fromMap((map['spaceSharingSettings'] as Map).cast<String, dynamic>()),
