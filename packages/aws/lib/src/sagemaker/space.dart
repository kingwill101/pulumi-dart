...
class Space extends pulumi.CustomResource {
  ...
  Space(
    ...
    this.ownershipSettings = registerOutput<SpaceOwnershipSettings?>('ownershipSettings');
    ...
    this.spaceSharingSettings = registerOutput<SpaceSpaceSharingSettings?>('spaceSharingSettings');
