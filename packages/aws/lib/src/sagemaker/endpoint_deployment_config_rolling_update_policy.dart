...
class EndpointDeploymentConfigRollingUpdatePolicy {
  ...
  final EndpointDeploymentConfigRollingUpdatePolicyMaximumBatchSize maximumBatchSize;
  ...
  final EndpointDeploymentConfigRollingUpdatePolicyRollbackMaximumBatchSize? rollbackMaximumBatchSize;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rollbackMaximumBatchSize': ?rollbackMaximumBatchSize == null ? null : rollbackMaximumBatchSize!.toMap(),
  ...
  factory EndpointDeploymentConfigRollingUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return EndpointDeploymentConfigRollingUpdatePolicy(
      maximumBatchSize: EndpointDeploymentConfigRollingUpdatePolicyMaximumBatchSize.fromMap((map['maximumBatchSize'] as Map).cast<String, dynamic>()),
      maximumExecutionTimeoutInSeconds: map['maximumExecutionTimeoutInSeconds'] == null ? null : map['maximumExecutionTimeoutInSeconds'] as int,
      rollbackMaximumBatchSize: map['rollbackMaximumBatchSize'] == null ? null : EndpointDeploymentConfigRollingUpdatePolicyRollbackMaximumBatchSize.fromMap((map['rollbackMaximumBatchSize'] as Map).cast<String, dynamic>()),
