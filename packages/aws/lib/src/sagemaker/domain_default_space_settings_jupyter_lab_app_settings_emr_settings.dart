...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings {
  ...
  factory DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings.fromMap(Map<String, dynamic> map) {
    return DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings(
      assumableRoleArns: map['assumableRoleArns'] == null ? null : (map['assumableRoleArns'] as List).cast<String>(),
      executionRoleArns: map['executionRoleArns'] == null ? null : (map['executionRoleArns'] as List).cast<String>(),
    );
  }
}
