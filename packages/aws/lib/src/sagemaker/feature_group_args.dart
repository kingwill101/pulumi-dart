...
class FeatureGroupArgs {
  ...
  factory FeatureGroupArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGroupArgs(
      ...
      featureDefinitions: pulumi.Input.decodeList<FeatureGroupFeatureDefinition>(map['featureDefinitions'], (value) => FeatureGroupFeatureDefinition.fromMap((value as Map).cast<String, dynamic>())),
      featureGroupName: map['featureGroupName'] as String,
      offlineStoreConfig: map['offlineStoreConfig'] == null ? null : FeatureGroupOfflineStoreConfig.fromMap((map['offlineStoreConfig'] as Map).cast<String, dynamic>()),
      onlineStoreConfig: map['onlineStoreConfig'] == null ? null : FeatureGroupOnlineStoreConfig.fromMap((map['onlineStoreConfig'] as Map).cast<String, dynamic>()),
      recordIdentifierFeatureName: map['recordIdentifierFeatureName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      roleArn: map['roleArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      throughputConfig: map['throughputConfig'] == null ? null : FeatureGroupThroughputConfig.fromMap((map['throughputConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
