...
class UserProfileUserSettingsJupyterLabAppSettingsDefaultResourceSpec {
  ...
  /// Creates a new [UserProfileUserSettingsJupyterLabAppSettingsDefaultResourceSpec].
  ...
  factory UserProfileUserSettingsJupyterLabAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
    return UserProfileUserSettingsJupyterLabAppSettingsDefaultResourceSpec(
