...
class SpaceSpaceSettingsCodeEditorAppSettings {
  ...
  final SpaceSpaceSettingsCodeEditorAppSettingsAppLifecycleManagement? appLifecycleManagement;
  /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. See `default_resource_spec` Block below.
  final SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec defaultResourceSpec;
  ...
  factory SpaceSpaceSettingsCodeEditorAppSettings.fromMap(Map<String, dynamic> map) {
    return SpaceSpaceSettingsCodeEditorAppSettings(
      appLifecycleManagement: map['appLifecycleManagement'] == null ? null : SpaceSpaceSettingsCodeEditorAppSettingsAppLifecycleManagement.fromMap((map['appLifecycleManagement'] as Map).cast<String, dynamic>()),
      defaultResourceSpec: SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec.fromMap((map['defaultResourceSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
