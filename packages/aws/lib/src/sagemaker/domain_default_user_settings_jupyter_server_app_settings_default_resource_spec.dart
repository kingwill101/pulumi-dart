...
class DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpec {
  ...
  factory DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
    return DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpec(
