...
class EndpointConfigurationArgs {
  ...
  EndpointConfigurationArgs({
    EndpointConfigurationAsyncInferenceConfig? asyncInferenceConfig,
    EndpointConfigurationDataCaptureConfig? dataCaptureConfig,
    String? executionRoleArn,
    String? kmsKeyArn,
    String? name,
    String? namePrefix,
    required List<EndpointConfigurationProductionVariant> productionVariants,
    String? region,
    List<EndpointConfigurationShadowProductionVariant>? shadowProductionVariants,
  ...
  factory EndpointConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return EndpointConfigurationArgs(
      asyncInferenceConfig: map['asyncInferenceConfig'] == null ? null : EndpointConfigurationAsyncInferenceConfig.fromMap((map['asyncInferenceConfig'] as Map).cast<String, dynamic>()),
      dataCaptureConfig: map['dataCaptureConfig'] == null ? null : EndpointConfigurationDataCaptureConfig.fromMap((map['dataCaptureConfig'] as Map).cast<String, dynamic>()),
      ...
      productionVariants: pulumi.Input.decodeList<EndpointConfigurationProductionVariant>(map['productionVariants'], (value) => EndpointConfigurationProductionVariant.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      shadowProductionVariants: map['shadowProductionVariants'] == null ? null : pulumi.Input.decodeList<EndpointConfigurationShadowProductionVariant>(map['shadowProductionVariants'], (value) => EndpointConfigurationShadowProductionVariant.fromMap((value as Map).cast<String, dynamic>())),
