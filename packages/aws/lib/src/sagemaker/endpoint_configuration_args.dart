...
class EndpointConfigurationArgs {
  ...
  factory EndpointConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return EndpointConfigurationArgs(
      asyncInferenceConfig: map['asyncInferenceConfig'] == null
          ? null
          : EndpointConfigurationAsyncInferenceConfig.fromMap(
              (map['asyncInferenceConfig'] as Map).cast<String, dynamic>(),
            ),
      dataCaptureConfig: map['dataCaptureConfig'] == null
          ? null
          : EndpointConfigurationDataCaptureConfig.fromMap(
              (map['dataCaptureConfig'] as Map).cast<String, dynamic>(),
            ),
      ...
      shadowProductionVariants: map['shadowProductionVariants'] == null
          ? null
          : pulumi
                .Input.decodeList<EndpointConfigurationShadowProductionVariant>(
