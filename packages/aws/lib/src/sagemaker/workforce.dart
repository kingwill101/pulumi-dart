...
class Workforce extends pulumi.CustomResource {
  ...
  Workforce(
    ...
    this.cognitoConfig = registerOutput<WorkforceCognitoConfig?>('cognitoConfig');
    this.oidcConfig = registerOutput<WorkforceOidcConfig?>('oidcConfig');
    this.region = registerOutput<String>('region');
    this.sourceIpConfig = registerOutput<WorkforceSourceIpConfig>('sourceIpConfig');
    this.subdomain = registerOutput<String>('subdomain');
    this.workforceName = registerOutput<String>('workforceName');
    this.workforceVpcConfig = registerOutput<WorkforceWorkforceVpcConfig?>('workforceVpcConfig');
  }
}
