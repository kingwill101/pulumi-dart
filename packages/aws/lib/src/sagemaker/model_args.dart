...
class ModelArgs {
  ...
  ModelArgs({
    ...
    ModelVpcConfig? vpcConfig,
            ...
            pulumi.Input.asOptionalInput<List<ModelContainer>>(containers),
        enableNetworkIsolation =
            pulumi.Input.asOptionalInput<bool>(enableNetworkIsolation),
  ...
  factory ModelArgs.fromMap(Map<String, dynamic> map) {
    return ModelArgs(
      ...
      inferenceExecutionConfig: map['inferenceExecutionConfig'] == null
          ? null
          : ModelInferenceExecutionConfig.fromMap(
              (map['inferenceExecutionConfig'] as Map).cast<String, dynamic>()),
