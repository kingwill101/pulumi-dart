...
class ImageVersionArgs {
  ...
  factory ImageVersionArgs.fromMap(Map<String, dynamic> map) {
    return ImageVersionArgs(
      ...
      mlFramework: map['mlFramework'] == null ? null : map['mlFramework'] as String,
      processor: map['processor'] == null ? null : map['processor'] as String,
      programmingLang: map['programmingLang'] == null ? null : map['programmingLang'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      releaseNotes: map['releaseNotes'] == null ? null : map['releaseNotes'] as String,
      vendorGuidance: map['vendorGuidance'] == null ? null : map['vendorGuidance'] as String,
    );
  }
}
