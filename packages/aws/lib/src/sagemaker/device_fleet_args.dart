...
class DeviceFleetArgs {
  ...
  factory DeviceFleetArgs.fromMap(Map<String, dynamic> map) {
    return DeviceFleetArgs(
      ...
      enableIotRoleAlias: map['enableIotRoleAlias'] == null ? null : map['enableIotRoleAlias'] as bool,
      outputConfig: DeviceFleetOutputConfig.fromMap((map['outputConfig'] as Map).cast<String, dynamic>()),
