  ...
  factory UserProfileUserSettingsCanvasAppSettings.fromMap(
    ...
    return UserProfileUserSettingsCanvasAppSettings(
      directDeploySettings: map['directDeploySettings'] == null
          ? null
          : UserProfileUserSettingsCanvasAppSettingsDirectDeploySettings.fromMap(
              (map['directDeploySettings'] as Map).cast<String, dynamic>(),
            ),
      emrServerlessSettings: map['emrServerlessSettings'] == null
          ? null
          : UserProfileUserSettingsCanvasAppSettingsEmrServerlessSettings.fromMap(
              (map['emrServerlessSettings'] as Map).cast<String, dynamic>(),
            ),
      generativeAiSettings: map['generativeAiSettings'] == null
          ? null
          : UserProfileUserSettingsCanvasAppSettingsGenerativeAiSettings.fromMap(
      ...
      identityProviderOauthSettings:
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting.fromMap(
      ...
      modelRegisterSettings: map['modelRegisterSettings'] == null
          ? null
          : UserProfileUserSettingsCanvasAppSettingsModelRegisterSettings.fromMap(
              (map['modelRegisterSettings'] as Map).cast<String, dynamic>(),
            ),
      timeSeriesForecastingSettings:
          map['timeSeriesForecastingSettings'] == null
          ? null
          : UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings.fromMap(
