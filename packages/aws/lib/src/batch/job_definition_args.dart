...
class JobDefinitionArgs {
  ...
  JobDefinitionArgs({
    ...
    bool? deregisterOnNewRevision,
    String? ecsProperties,
    JobDefinitionEksProperties? eksProperties,
    String? name,
    ...
    bool? propagateTags,
    String? region,
    JobDefinitionRetryStrategy? retryStrategy,
    int? schedulingPriority,
    Map<String, String>? tags,
    JobDefinitionTimeout? timeout,
    required String type,
  }) : containerProperties = pulumi.Input.asOptionalInput<String>(
         containerProperties,
       ),
       deregisterOnNewRevision = pulumi.Input.asOptionalInput<bool>(
       ...
       schedulingPriority = pulumi.Input.asOptionalInput<int>(
         schedulingPriority,
       ),
    ...
    return <String, dynamic>{
      ...
      'retryStrategy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(retryStrategy, (value) => value.toMap()),
  ...
  factory JobDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return JobDefinitionArgs(
      ...
      ecsProperties: map['ecsProperties'] == null
          ? null
          : map['ecsProperties'] as String,
