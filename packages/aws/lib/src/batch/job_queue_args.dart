...
class JobQueueArgs {
  ...
  JobQueueArgs({
    ...
    JobQueueTimeouts? timeouts,
       ...
       schedulingPolicyArn = pulumi.Input.asOptionalInput<String>(
         schedulingPolicyArn,
       ),
  ...
  factory JobQueueArgs.fromMap(Map<String, dynamic> map) {
    return JobQueueArgs(
      computeEnvironmentOrders: map['computeEnvironmentOrders'] == null
          ? null
      ...
      jobStateTimeLimitActions: map['jobStateTimeLimitActions'] == null
          ? null
      ...
      schedulingPolicyArn: map['schedulingPolicyArn'] == null
          ? null
          : map['schedulingPolicyArn'] as String,
