...
class JobQueueArgs {
  ...
  /// [timeouts] Optional.
  JobQueueArgs({
    List<JobQueueComputeEnvironmentOrder>? computeEnvironmentOrders,
    List<JobQueueJobStateTimeLimitAction>? jobStateTimeLimitActions,
    String? name,
  ...
  factory JobQueueArgs.fromMap(Map<String, dynamic> map) {
    return JobQueueArgs(
      computeEnvironmentOrders: map['computeEnvironmentOrders'] == null ? null : pulumi.Input.decodeList<JobQueueComputeEnvironmentOrder>(map['computeEnvironmentOrders'], (value) => JobQueueComputeEnvironmentOrder.fromMap((value as Map).cast<String, dynamic>())),
      jobStateTimeLimitActions: map['jobStateTimeLimitActions'] == null ? null : pulumi.Input.decodeList<JobQueueJobStateTimeLimitAction>(map['jobStateTimeLimitActions'], (value) => JobQueueJobStateTimeLimitAction.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      priority: map['priority'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      schedulingPolicyArn: map['schedulingPolicyArn'] == null ? null : map['schedulingPolicyArn'] as String,
      state: map['state'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : JobQueueTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
