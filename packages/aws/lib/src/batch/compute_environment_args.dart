...
class ComputeEnvironmentArgs {
  ...
  factory ComputeEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return ComputeEnvironmentArgs(
      computeResources: map['computeResources'] == null ? null : ComputeEnvironmentComputeResources.fromMap((map['computeResources'] as Map).cast<String, dynamic>()),
      eksConfiguration: map['eksConfiguration'] == null ? null : ComputeEnvironmentEksConfiguration.fromMap((map['eksConfiguration'] as Map).cast<String, dynamic>()),
      ...
      updatePolicy: map['updatePolicy'] == null ? null : ComputeEnvironmentUpdatePolicy.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
