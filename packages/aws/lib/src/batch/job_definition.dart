...
class JobDefinition extends pulumi.CustomResource {
  ...
  JobDefinition(
    ...
    this.deregisterOnNewRevision = registerOutput<bool?>('deregisterOnNewRevision');
    this.ecsProperties = registerOutput<String?>('ecsProperties');
    this.eksProperties = registerOutput<JobDefinitionEksProperties?>('eksProperties');
    this.name = registerOutput<String>('name');
    this.nodeProperties = registerOutput<String?>('nodeProperties');
    this.parameters = registerOutput<Map<String, String>?>('parameters');
    this.platformCapabilities = registerOutput<List<String>?>('platformCapabilities');
    this.propagateTags = registerOutput<bool?>('propagateTags');
    this.region = registerOutput<String>('region');
    this.retryStrategy = registerOutput<JobDefinitionRetryStrategy?>('retryStrategy');
