...
class ComputeEnvironment extends pulumi.CustomResource {
  ...
  ComputeEnvironment(
    ...
    this.computeResources = registerOutput<ComputeEnvironmentComputeResources>(
      'computeResources',
    );
    this.ecsClusterArn = registerOutput<String>('ecsClusterArn');
    this.eksConfiguration = registerOutput<ComputeEnvironmentEksConfiguration?>(
      'eksConfiguration',
    );
    ...
    this.updatePolicy = registerOutput<ComputeEnvironmentUpdatePolicy>(
      'updatePolicy',
    );
  }
}
