...
class ComputeEnvironmentComputeResources {
  ...
  final List<ComputeEnvironmentComputeResourcesEc2Configuration>? ec2Configurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ec2Configurations': ?ec2Configurations == null ? null : pulumi.Input.encodeList<ComputeEnvironmentComputeResourcesEc2Configuration, Map<String, dynamic>>(ec2Configurations!, (value) => value.toMap()),
  ...
  factory ComputeEnvironmentComputeResources.fromMap(Map<String, dynamic> map) {
    return ComputeEnvironmentComputeResources(
      ...
      bidPercentage: map['bidPercentage'] == null ? null : map['bidPercentage'] as int,
      desiredVcpus: map['desiredVcpus'] == null ? null : map['desiredVcpus'] as int,
      ec2Configurations: map['ec2Configurations'] == null ? null : pulumi.Input.decodeList<ComputeEnvironmentComputeResourcesEc2Configuration>(map['ec2Configurations'], (value) => ComputeEnvironmentComputeResourcesEc2Configuration.fromMap((value as Map).cast<String, dynamic>())),
      ec2KeyPair: map['ec2KeyPair'] == null ? null : map['ec2KeyPair'] as String,
      ...
      launchTemplate: map['launchTemplate'] == null ? null : ComputeEnvironmentComputeResourcesLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>()),
      ...
      spotIamFleetRole: map['spotIamFleetRole'] == null ? null : map['spotIamFleetRole'] as String,
