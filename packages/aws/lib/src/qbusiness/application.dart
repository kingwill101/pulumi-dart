...
class Application extends pulumi.CustomResource {
  ...
  Application(
    ...
    this.attachmentsConfiguration = registerOutput<ApplicationAttachmentsConfiguration>('attachmentsConfiguration');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.encryptionConfiguration = registerOutput<ApplicationEncryptionConfiguration?>('encryptionConfiguration');
    ...
    this.identityCenterInstanceArn = registerOutput<String>('identityCenterInstanceArn');
