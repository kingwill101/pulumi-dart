...
class CustomDbEngineVersion extends pulumi.CustomResource {
  ...
  CustomDbEngineVersion(
    ...
    this.databaseInstallationFilesS3BucketName = registerOutput<String?>(
      'databaseInstallationFilesS3BucketName',
    );
    this.databaseInstallationFilesS3Prefix = registerOutput<String?>(
      'databaseInstallationFilesS3Prefix',
    );
    this.dbParameterGroupFamily = registerOutput<String>(
