...
class ClusterSnapshotCopy extends pulumi.CustomResource {
  ...
  ClusterSnapshotCopy(
    ...
    this.sourceDbClusterSnapshotIdentifier = registerOutput<String>('sourceDbClusterSnapshotIdentifier');
    ...
    this.targetDbClusterSnapshotIdentifier = registerOutput<String>('targetDbClusterSnapshotIdentifier');
