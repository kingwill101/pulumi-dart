...
class SnapshotCopy extends pulumi.CustomResource {
  ...
  SnapshotCopy(
    ...
    this.sourceDbSnapshotIdentifier = registerOutput<String>('sourceDbSnapshotIdentifier');
    ...
    this.targetCustomAvailabilityZone = registerOutput<String?>('targetCustomAvailabilityZone');
    this.targetDbSnapshotIdentifier = registerOutput<String>('targetDbSnapshotIdentifier');
