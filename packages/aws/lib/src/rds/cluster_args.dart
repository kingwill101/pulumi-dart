...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      caCertificateIdentifier: map['caCertificateIdentifier'] == null ? null : map['caCertificateIdentifier'] as String,
      ...
      clusterScalabilityType: map['clusterScalabilityType'] == null ? null : map['clusterScalabilityType'] as String,
      copyTagsToSnapshot: map['copyTagsToSnapshot'] == null ? null : map['copyTagsToSnapshot'] as bool,
      databaseInsightsMode: map['databaseInsightsMode'] == null ? null : map['databaseInsightsMode'] as String,
      ...
      deleteAutomatedBackups: map['deleteAutomatedBackups'] == null ? null : map['deleteAutomatedBackups'] as bool,
      ...
      enableLocalWriteForwarding: map['enableLocalWriteForwarding'] == null ? null : map['enableLocalWriteForwarding'] as bool,
      ...
      engineLifecycleSupport: map['engineLifecycleSupport'] == null ? null : map['engineLifecycleSupport'] as String,
      ...
      masterUserSecretKmsKeyId: map['masterUserSecretKmsKeyId'] == null ? null : map['masterUserSecretKmsKeyId'] as String,
      ...
      s3Import: map['s3Import'] == null ? null : ClusterS3Import.fromMap((map['s3Import'] as Map).cast<String, dynamic>()),
      scalingConfiguration: map['scalingConfiguration'] == null ? null : ClusterScalingConfiguration.fromMap((map['scalingConfiguration'] as Map).cast<String, dynamic>()),
