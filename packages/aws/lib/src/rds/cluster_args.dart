...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterS3Import? s3Import,
    ClusterScalingConfiguration? scalingConfiguration,
    ...
    List<String>? vpcSecurityGroupIds,
       ...
       caCertificateIdentifier = pulumi.Input.asOptionalInput<String>(
       ...
       clusterMembers = pulumi.Input.asOptionalInput<List<String>>(
         clusterMembers,
       ),
       clusterScalabilityType = pulumi.Input.asOptionalInput<String>(
         clusterScalabilityType,
       ),
       copyTagsToSnapshot = pulumi.Input.asOptionalInput<bool>(
         copyTagsToSnapshot,
       ),
       databaseInsightsMode = pulumi.Input.asOptionalInput<String>(
         databaseInsightsMode,
       ),
       databaseName = pulumi.Input.asOptionalInput<String>(databaseName),
       dbClusterInstanceClass = pulumi.Input.asOptionalInput<String>(
       ...
       dbSubnetGroupName = pulumi.Input.asOptionalInput<String>(
         dbSubnetGroupName,
       ),
       dbSystemId = pulumi.Input.asOptionalInput<String>(dbSystemId),
       deleteAutomatedBackups = pulumi.Input.asOptionalInput<bool>(
       ...
       domainIamRoleName = pulumi.Input.asOptionalInput<String>(
         domainIamRoleName,
       ),
       enableGlobalWriteForwarding = pulumi.Input.asOptionalInput<bool>(
         enableGlobalWriteForwarding,
       ),
       enableHttpEndpoint = pulumi.Input.asOptionalInput<bool>(
         enableHttpEndpoint,
       ),
       enableLocalWriteForwarding = pulumi.Input.asOptionalInput<bool>(
         enableLocalWriteForwarding,
       ),
       enabledCloudwatchLogsExports = pulumi
           .Input.asOptionalInput<List<String>>(enabledCloudwatchLogsExports),
       engine = pulumi.Input.asInput<String>(engine),
       engineLifecycleSupport = pulumi.Input.asOptionalInput<String>(
       ...
       manageMasterUserPassword = pulumi.Input.asOptionalInput<bool>(
       ...
       masterUserSecretKmsKeyId = pulumi.Input.asOptionalInput<String>(
         masterUserSecretKmsKeyId,
       ),
       masterUsername = pulumi.Input.asOptionalInput<String>(masterUsername),
       monitoringInterval = pulumi.Input.asOptionalInput<int>(
         monitoringInterval,
       ),
       monitoringRoleArn = pulumi.Input.asOptionalInput<String>(
         monitoringRoleArn,
       ),
       networkType = pulumi.Input.asOptionalInput<String>(networkType),
       performanceInsightsEnabled = pulumi.Input.asOptionalInput<bool>(
    ...
    return <String, dynamic>{
      ...
      's3Import':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterS3Import,
            Map<String, dynamic>
          >(s3Import, (value) => value.toMap()),
      'scalingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterScalingConfiguration,
            Map<String, dynamic>
          >(scalingConfiguration, (value) => value.toMap()),
      'serverlessv2ScalingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterServerlessv2ScalingConfiguration,
            Map<String, dynamic>
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      backtrackWindow: map['backtrackWindow'] == null
          ? null
          : map['backtrackWindow'] as int,
      backupRetentionPeriod: map['backupRetentionPeriod'] == null
          ? null
          : map['backupRetentionPeriod'] as int,
      caCertificateIdentifier: map['caCertificateIdentifier'] == null
          ? null
          : map['caCertificateIdentifier'] as String,
      ...
      clusterMembers: map['clusterMembers'] == null
          ? null
          : (map['clusterMembers'] as List).cast<String>(),
      clusterScalabilityType: map['clusterScalabilityType'] == null
          ? null
          : map['clusterScalabilityType'] as String,
      ...
      dbClusterInstanceClass: map['dbClusterInstanceClass'] == null
          ? null
          : map['dbClusterInstanceClass'] as String,
      dbClusterParameterGroupName: map['dbClusterParameterGroupName'] == null
          ? null
          : map['dbClusterParameterGroupName'] as String,
      dbInstanceParameterGroupName: map['dbInstanceParameterGroupName'] == null
          ? null
          : map['dbInstanceParameterGroupName'] as String,
      dbSubnetGroupName: map['dbSubnetGroupName'] == null
          ? null
          : map['dbSubnetGroupName'] as String,
      dbSystemId: map['dbSystemId'] == null
          ? null
          : map['dbSystemId'] as String,
      ...
      enableGlobalWriteForwarding: map['enableGlobalWriteForwarding'] == null
          ? null
          : map['enableGlobalWriteForwarding'] as bool,
      enableHttpEndpoint: map['enableHttpEndpoint'] == null
          ? null
          : map['enableHttpEndpoint'] as bool,
      enableLocalWriteForwarding: map['enableLocalWriteForwarding'] == null
          ? null
          : map['enableLocalWriteForwarding'] as bool,
      ...
      engineMode: map['engineMode'] == null
          ? null
          : map['engineMode'] as String,
