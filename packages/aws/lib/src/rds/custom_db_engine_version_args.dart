...
class CustomDbEngineVersionArgs {
  ...
  factory CustomDbEngineVersionArgs.fromMap(Map<String, dynamic> map) {
    return CustomDbEngineVersionArgs(
      databaseInstallationFilesS3BucketName: map['databaseInstallationFilesS3BucketName'] == null ? null : map['databaseInstallationFilesS3BucketName'] as String,
      databaseInstallationFilesS3Prefix: map['databaseInstallationFilesS3Prefix'] == null ? null : map['databaseInstallationFilesS3Prefix'] as String,
