...
class OptionGroupOption {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optionSettings': ?optionSettings == null ? null : pulumi.Input.encodeList<OptionGroupOptionOptionSetting, Map<String, dynamic>>(optionSettings!, (value) => value.toMap()),
      'port': ?port,
      'version': ?version,
  ...
  factory OptionGroupOption.fromMap(Map<String, dynamic> map) {
    return OptionGroupOption(
      dbSecurityGroupMemberships: map['dbSecurityGroupMemberships'] == null ? null : (map['dbSecurityGroupMemberships'] as List).cast<String>(),
      optionName: map['optionName'] as String,
      optionSettings: map['optionSettings'] == null ? null : pulumi.Input.decodeList<OptionGroupOptionOptionSetting>(map['optionSettings'], (value) => OptionGroupOptionOptionSetting.fromMap((value as Map).cast<String, dynamic>())),
      port: map['port'] == null ? null : map['port'] as int,
      version: map['version'] == null ? null : map['version'] as String,
      vpcSecurityGroupMemberships: map['vpcSecurityGroupMemberships'] == null ? null : (map['vpcSecurityGroupMemberships'] as List).cast<String>(),
    );
  }
}
