...
class ClusterInstanceArgs {
  ...
  ClusterInstanceArgs({
    ...
    Map<String, String>? tags,
       ...
       caCertIdentifier = pulumi.Input.asOptionalInput<String>(
         caCertIdentifier,
       ),
       ...
       customIamInstanceProfile = pulumi.Input.asOptionalInput<String>(
         customIamInstanceProfile,
       ),
       dbParameterGroupName = pulumi.Input.asOptionalInput<String>(
         dbParameterGroupName,
       ),
       dbSubnetGroupName = pulumi.Input.asOptionalInput<String>(
         dbSubnetGroupName,
       ),
       engine = pulumi.Input.asInput<EngineType>(engine),
       engineVersion = pulumi.Input.asOptionalInput<String>(engineVersion),
       forceDestroy = pulumi.Input.asOptionalInput<bool>(forceDestroy),
       identifier = pulumi.Input.asOptionalInput<String>(identifier),
       identifierPrefix = pulumi.Input.asOptionalInput<String>(
         identifierPrefix,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'engine': pulumi.Input.mapInputValue<EngineType, String>(
        engine,
        (value) => value.value,
      ),
  ...
  factory ClusterInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ClusterInstanceArgs(
      ...
      dbParameterGroupName: map['dbParameterGroupName'] == null
          ? null
          : map['dbParameterGroupName'] as String,
      dbSubnetGroupName: map['dbSubnetGroupName'] == null
          ? null
          : map['dbSubnetGroupName'] as String,
      engine: EngineType.fromValue(map['engine'] as String),
      ...
      promotionTier: map['promotionTier'] == null
          ? null
          : map['promotionTier'] as int,
