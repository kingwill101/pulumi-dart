...
class ClusterInstanceArgs {
  ...
  factory ClusterInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ClusterInstanceArgs(
      ...
      caCertIdentifier: map['caCertIdentifier'] == null ? null : map['caCertIdentifier'] as String,
      ...
      customIamInstanceProfile: map['customIamInstanceProfile'] == null ? null : map['customIamInstanceProfile'] as String,
      dbParameterGroupName: map['dbParameterGroupName'] == null ? null : map['dbParameterGroupName'] as String,
      ...
      identifierPrefix: map['identifierPrefix'] == null ? null : map['identifierPrefix'] as String,
      ...
      promotionTier: map['promotionTier'] == null ? null : map['promotionTier'] as int,
