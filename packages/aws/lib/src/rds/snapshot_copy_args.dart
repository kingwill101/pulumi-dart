  ...
  SnapshotCopyArgs({
    ...
    required String targetDbSnapshotIdentifier,
        ...
        sourceDbSnapshotIdentifier =
            pulumi.Input.asInput<String>(sourceDbSnapshotIdentifier),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        targetCustomAvailabilityZone =
            pulumi.Input.asOptionalInput<String>(targetCustomAvailabilityZone),
        targetDbSnapshotIdentifier =
            pulumi.Input.asInput<String>(targetDbSnapshotIdentifier);
