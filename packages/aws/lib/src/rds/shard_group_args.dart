...
class ShardGroupArgs {
  ...
  factory ShardGroupArgs.fromMap(Map<String, dynamic> map) {
    return ShardGroupArgs(
      computeRedundancy: map['computeRedundancy'] == null ? null : map['computeRedundancy'] as int,
      ...
      timeouts: map['timeouts'] == null ? null : ShardGroupTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
