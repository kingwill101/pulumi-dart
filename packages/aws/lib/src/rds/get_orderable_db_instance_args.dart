...
class GetOrderableDbInstanceArgs {
  ...
  GetOrderableDbInstanceArgs({
    ...
    bool? vpc,
            ...
            pulumi.Input.asOptionalInput<String>(availabilityZoneGroup),
        engine = pulumi.Input.asInput<String>(engine),
        engineLatestVersion =
            pulumi.Input.asOptionalInput<bool>(engineLatestVersion),
        ...
        preferredEngineVersions =
            pulumi.Input.asOptionalInput<List<String>>(preferredEngineVersions),
        preferredInstanceClasses = pulumi.Input.asOptionalInput<List<String>>(
            preferredInstanceClasses),
        readReplicaCapable =
            pulumi.Input.asOptionalInput<bool>(readReplicaCapable),
        region = pulumi.Input.asOptionalInput<String>(region),
        storageType = pulumi.Input.asOptionalInput<String>(storageType),
        supportedEngineModes =
            pulumi.Input.asOptionalInput<List<String>>(supportedEngineModes),
        supportedNetworkTypes =
            pulumi.Input.asOptionalInput<List<String>>(supportedNetworkTypes),
        supportsClusters = pulumi.Input.asOptionalInput<bool>(supportsClusters),
        supportsEnhancedMonitoring =
            pulumi.Input.asOptionalInput<bool>(supportsEnhancedMonitoring),
        supportsGlobalDatabases =
            pulumi.Input.asOptionalInput<bool>(supportsGlobalDatabases),
        ...
        supportsKerberosAuthentication =
            pulumi.Input.asOptionalInput<bool>(supportsKerberosAuthentication),
        supportsMultiAz = pulumi.Input.asOptionalInput<bool>(supportsMultiAz),
        supportsPerformanceInsights =
            pulumi.Input.asOptionalInput<bool>(supportsPerformanceInsights),
        supportsStorageAutoscaling =
            pulumi.Input.asOptionalInput<bool>(supportsStorageAutoscaling),
        supportsStorageEncryption =
            pulumi.Input.asOptionalInput<bool>(supportsStorageEncryption),
  ...
  factory GetOrderableDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceArgs(
      ...
      supportsIops:
          map['supportsIops'] == null ? null : map['supportsIops'] as bool,
      supportsKerberosAuthentication:
