...
class GetOrderableDbInstanceArgs {
  ...
  GetOrderableDbInstanceArgs({
    ...
    String? licenseModel,
    List<String>? preferredEngineVersions,
    ...
    bool? vpc,
  }) : availabilityZoneGroup = pulumi.Input.asOptionalInput<String>(
         availabilityZoneGroup,
       ),
       engine = pulumi.Input.asInput<String>(engine),
       engineLatestVersion = pulumi.Input.asOptionalInput<bool>(
         engineLatestVersion,
       ),
       ...
       preferredEngineVersions = pulumi.Input.asOptionalInput<List<String>>(
         preferredEngineVersions,
       ),
       preferredInstanceClasses = pulumi.Input.asOptionalInput<List<String>>(
         preferredInstanceClasses,
       ),
       readReplicaCapable = pulumi.Input.asOptionalInput<bool>(
         readReplicaCapable,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       storageType = pulumi.Input.asOptionalInput<String>(storageType),
       supportedEngineModes = pulumi.Input.asOptionalInput<List<String>>(
         supportedEngineModes,
       ),
       supportedNetworkTypes = pulumi.Input.asOptionalInput<List<String>>(
         supportedNetworkTypes,
       ),
       supportsClusters = pulumi.Input.asOptionalInput<bool>(supportsClusters),
       supportsEnhancedMonitoring = pulumi.Input.asOptionalInput<bool>(
         supportsEnhancedMonitoring,
       ),
       supportsGlobalDatabases = pulumi.Input.asOptionalInput<bool>(
         supportsGlobalDatabases,
       ),
       supportsIamDatabaseAuthentication = pulumi.Input.asOptionalInput<bool>(
         supportsIamDatabaseAuthentication,
       ),
       supportsIops = pulumi.Input.asOptionalInput<bool>(supportsIops),
       supportsKerberosAuthentication = pulumi.Input.asOptionalInput<bool>(
         supportsKerberosAuthentication,
       ),
       supportsMultiAz = pulumi.Input.asOptionalInput<bool>(supportsMultiAz),
       supportsPerformanceInsights = pulumi.Input.asOptionalInput<bool>(
         supportsPerformanceInsights,
       ),
       supportsStorageAutoscaling = pulumi.Input.asOptionalInput<bool>(
         supportsStorageAutoscaling,
       ),
       supportsStorageEncryption = pulumi.Input.asOptionalInput<bool>(
  ...
  factory GetOrderableDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceArgs(
      availabilityZoneGroup: map['availabilityZoneGroup'] == null
          ? null
          : map['availabilityZoneGroup'] as String,
      ...
      readReplicaCapable: map['readReplicaCapable'] == null
          ? null
          : map['readReplicaCapable'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      storageType: map['storageType'] == null
          ? null
          : map['storageType'] as String,
      supportedEngineModes: map['supportedEngineModes'] == null
          ? null
          : (map['supportedEngineModes'] as List).cast<String>(),
      supportedNetworkTypes: map['supportedNetworkTypes'] == null
          ? null
          : (map['supportedNetworkTypes'] as List).cast<String>(),
      supportsClusters: map['supportsClusters'] == null
          ? null
          : map['supportsClusters'] as bool,
      supportsEnhancedMonitoring: map['supportsEnhancedMonitoring'] == null
          ? null
          : map['supportsEnhancedMonitoring'] as bool,
      supportsGlobalDatabases: map['supportsGlobalDatabases'] == null
          ? null
          : map['supportsGlobalDatabases'] as bool,
      supportsIamDatabaseAuthentication:
          map['supportsIamDatabaseAuthentication'] == null
          ? null
          : map['supportsIamDatabaseAuthentication'] as bool,
      supportsIops: map['supportsIops'] == null
          ? null
          : map['supportsIops'] as bool,
      supportsKerberosAuthentication:
          map['supportsKerberosAuthentication'] == null
          ? null
          : map['supportsKerberosAuthentication'] as bool,
      supportsMultiAz: map['supportsMultiAz'] == null
          ? null
          : map['supportsMultiAz'] as bool,
      supportsPerformanceInsights: map['supportsPerformanceInsights'] == null
          ? null
          : map['supportsPerformanceInsights'] as bool,
      supportsStorageAutoscaling: map['supportsStorageAutoscaling'] == null
          ? null
          : map['supportsStorageAutoscaling'] as bool,
      supportsStorageEncryption: map['supportsStorageEncryption'] == null
          ? null
          : map['supportsStorageEncryption'] as bool,
