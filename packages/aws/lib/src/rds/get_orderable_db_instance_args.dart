...
class GetOrderableDbInstanceArgs {
  ...
  factory GetOrderableDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceArgs(
      availabilityZoneGroup: map['availabilityZoneGroup'] == null ? null : map['availabilityZoneGroup'] as String,
      ...
      readReplicaCapable: map['readReplicaCapable'] == null ? null : map['readReplicaCapable'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      storageType: map['storageType'] == null ? null : map['storageType'] as String,
      supportedEngineModes: map['supportedEngineModes'] == null ? null : (map['supportedEngineModes'] as List).cast<String>(),
      supportedNetworkTypes: map['supportedNetworkTypes'] == null ? null : (map['supportedNetworkTypes'] as List).cast<String>(),
      supportsClusters: map['supportsClusters'] == null ? null : map['supportsClusters'] as bool,
      supportsEnhancedMonitoring: map['supportsEnhancedMonitoring'] == null ? null : map['supportsEnhancedMonitoring'] as bool,
      supportsGlobalDatabases: map['supportsGlobalDatabases'] == null ? null : map['supportsGlobalDatabases'] as bool,
      supportsIamDatabaseAuthentication: map['supportsIamDatabaseAuthentication'] == null ? null : map['supportsIamDatabaseAuthentication'] as bool,
      supportsIops: map['supportsIops'] == null ? null : map['supportsIops'] as bool,
      supportsKerberosAuthentication: map['supportsKerberosAuthentication'] == null ? null : map['supportsKerberosAuthentication'] as bool,
      supportsMultiAz: map['supportsMultiAz'] == null ? null : map['supportsMultiAz'] as bool,
      supportsPerformanceInsights: map['supportsPerformanceInsights'] == null ? null : map['supportsPerformanceInsights'] as bool,
      supportsStorageAutoscaling: map['supportsStorageAutoscaling'] == null ? null : map['supportsStorageAutoscaling'] as bool,
      supportsStorageEncryption: map['supportsStorageEncryption'] == null ? null : map['supportsStorageEncryption'] as bool,
