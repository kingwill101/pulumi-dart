...
class ProxyArgs {
  ...
  factory ProxyArgs.fromMap(Map<String, dynamic> map) {
    return ProxyArgs(
      auths: map['auths'] == null ? null : pulumi.Input.decodeList<ProxyAuth>(map['auths'], (value) => ProxyAuth.fromMap((value as Map).cast<String, dynamic>())),
      debugLogging: map['debugLogging'] == null ? null : map['debugLogging'] as bool,
      defaultAuthScheme: map['defaultAuthScheme'] == null ? null : map['defaultAuthScheme'] as String,
      endpointNetworkType: map['endpointNetworkType'] == null ? null : map['endpointNetworkType'] as String,
      engineFamily: map['engineFamily'] as String,
      idleClientTimeout: map['idleClientTimeout'] == null ? null : map['idleClientTimeout'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      requireTls: map['requireTls'] == null ? null : map['requireTls'] as bool,
      roleArn: map['roleArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetConnectionNetworkType: map['targetConnectionNetworkType'] == null ? null : map['targetConnectionNetworkType'] as String,
