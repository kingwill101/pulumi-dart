...
class ProxyArgs {
  ...
  ProxyArgs({
    ...
    required List<String> vpcSubnetIds,
       ...
       defaultAuthScheme = pulumi.Input.asOptionalInput<String>(
         defaultAuthScheme,
       ),
       endpointNetworkType = pulumi.Input.asOptionalInput<String>(
         endpointNetworkType,
       ),
  ...
  factory ProxyArgs.fromMap(Map<String, dynamic> map) {
    return ProxyArgs(
      ...
      debugLogging: map['debugLogging'] == null
          ? null
          : map['debugLogging'] as bool,
