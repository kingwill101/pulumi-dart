...
class ClusterScalingConfiguration {
  ...
  factory ClusterScalingConfiguration.fromMap(Map<String, dynamic> map) {
    return ClusterScalingConfiguration(
      ...
      secondsBeforeTimeout: map['secondsBeforeTimeout'] == null ? null : map['secondsBeforeTimeout'] as int,
      secondsUntilAutoPause: map['secondsUntilAutoPause'] == null ? null : map['secondsUntilAutoPause'] as int,
      timeoutAction: map['timeoutAction'] == null ? null : map['timeoutAction'] as String,
    );
  }
}
