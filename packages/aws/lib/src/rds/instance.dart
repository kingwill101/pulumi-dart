...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.allowMajorVersionUpgrade = registerOutput<bool?>(
      'allowMajorVersionUpgrade',
    );
    this.applyImmediately = registerOutput<bool?>('applyImmediately');
    this.arn = registerOutput<String>('arn');
    this.autoMinorVersionUpgrade = registerOutput<bool?>(
    ...
    this.blueGreenUpdate = registerOutput<InstanceBlueGreenUpdate?>(
      'blueGreenUpdate',
    );
    ...
    this.customIamInstanceProfile = registerOutput<String?>(
      'customIamInstanceProfile',
    );
    this.customerOwnedIpEnabled = registerOutput<bool?>(
    ...
    this.deleteAutomatedBackups = registerOutput<bool?>(
    ...
    this.enabledCloudwatchLogsExports = registerOutput<List<String>?>(
      'enabledCloudwatchLogsExports',
    );
    this.endpoint = registerOutput<String>('endpoint');
    this.engine = registerOutput<String>('engine');
    this.engineLifecycleSupport = registerOutput<String>(
      'engineLifecycleSupport',
    );
    this.engineVersion = registerOutput<String>('engineVersion');
    this.engineVersionActual = registerOutput<String>('engineVersionActual');
    this.finalSnapshotIdentifier = registerOutput<String?>(
      'finalSnapshotIdentifier',
    );
    this.hostedZoneId = registerOutput<String>('hostedZoneId');
    this.iamDatabaseAuthenticationEnabled = registerOutput<bool?>(
    ...
    this.listenerEndpoints = registerOutput<List<InstanceListenerEndpoint>>(
      'listenerEndpoints',
    );
    this.maintenanceWindow = registerOutput<String>('maintenanceWindow');
    this.manageMasterUserPassword = registerOutput<bool?>(
      'manageMasterUserPassword',
    );
    this.masterUserSecretKmsKeyId = registerOutput<String>(
      'masterUserSecretKmsKeyId',
    );
    this.masterUserSecrets = registerOutput<List<InstanceMasterUserSecret>>(
      'masterUserSecrets',
    );
    ...
    this.ncharCharacterSetName = registerOutput<String>(
    ...
    this.performanceInsightsEnabled = registerOutput<bool?>(
      'performanceInsightsEnabled',
    );
    this.performanceInsightsKmsKeyId = registerOutput<String>(
      'performanceInsightsKmsKeyId',
    );
    this.performanceInsightsRetentionPeriod = registerOutput<int>(
    ...
    this.restoreToPointInTime = registerOutput<InstanceRestoreToPointInTime?>(
