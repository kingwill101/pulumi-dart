...
class ClusterSnapshotCopyArgs {
  ...
  factory ClusterSnapshotCopyArgs.fromMap(Map<String, dynamic> map) {
    return ClusterSnapshotCopyArgs(
      ...
      presignedUrl: map['presignedUrl'] == null ? null : map['presignedUrl'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sharedAccounts: map['sharedAccounts'] == null ? null : (map['sharedAccounts'] as List).cast<String>(),
      sourceDbClusterSnapshotIdentifier: map['sourceDbClusterSnapshotIdentifier'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetDbClusterSnapshotIdentifier: map['targetDbClusterSnapshotIdentifier'] as String,
      timeouts: map['timeouts'] == null ? null : ClusterSnapshotCopyTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
