...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    List<String>? vpcSecurityGroupIds,
       ...
       characterSetName = pulumi.Input.asOptionalInput<String>(
         characterSetName,
       ),
       ...
       customerOwnedIpEnabled = pulumi.Input.asOptionalInput<bool>(
       ...
       dedicatedLogVolume = pulumi.Input.asOptionalInput<bool>(
         dedicatedLogVolume,
       ),
       ...
       domainAuthSecretArn = pulumi.Input.asOptionalInput<String>(
         domainAuthSecretArn,
       ),
       ...
       maxAllocatedStorage = pulumi.Input.asOptionalInput<int>(
         maxAllocatedStorage,
       ),
       ...
       ncharCharacterSetName = pulumi.Input.asOptionalInput<String>(
       ...
       replicateSourceDb = pulumi.Input.asOptionalInput<String>(
         replicateSourceDb,
       ),
       ...
       upgradeStorageConfig = pulumi.Input.asOptionalInput<bool>(
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      backupTarget: map['backupTarget'] == null
          ? null
          : map['backupTarget'] as String,
      ...
      domainFqdn: map['domainFqdn'] == null
          ? null
          : map['domainFqdn'] as String,
      ...
      replicaMode: map['replicaMode'] == null
          ? null
          : map['replicaMode'] as String,
