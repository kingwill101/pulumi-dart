...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      backupTarget: map['backupTarget'] == null ? null : map['backupTarget'] as String,
      backupWindow: map['backupWindow'] == null ? null : map['backupWindow'] as String,
      blueGreenUpdate: map['blueGreenUpdate'] == null ? null : InstanceBlueGreenUpdate.fromMap((map['blueGreenUpdate'] as Map).cast<String, dynamic>()),
      ...
      customerOwnedIpEnabled: map['customerOwnedIpEnabled'] == null ? null : map['customerOwnedIpEnabled'] as bool,
      ...
      domainAuthSecretArn: map['domainAuthSecretArn'] == null ? null : map['domainAuthSecretArn'] as String,
      domainDnsIps: map['domainDnsIps'] == null ? null : (map['domainDnsIps'] as List).cast<String>(),
      ...
      maxAllocatedStorage: map['maxAllocatedStorage'] == null ? null : map['maxAllocatedStorage'] as int,
      ...
      ncharCharacterSetName: map['ncharCharacterSetName'] == null ? null : map['ncharCharacterSetName'] as String,
      ...
      replicaMode: map['replicaMode'] == null ? null : map['replicaMode'] as String,
      replicateSourceDb: map['replicateSourceDb'] == null ? null : map['replicateSourceDb'] as String,
      restoreToPointInTime: map['restoreToPointInTime'] == null ? null : InstanceRestoreToPointInTime.fromMap((map['restoreToPointInTime'] as Map).cast<String, dynamic>()),
      s3Import: map['s3Import'] == null ? null : InstanceS3Import.fromMap((map['s3Import'] as Map).cast<String, dynamic>()),
      ...
      upgradeStorageConfig: map['upgradeStorageConfig'] == null ? null : map['upgradeStorageConfig'] as bool,
