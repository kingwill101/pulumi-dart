...
class ApplicationInitialCapacity {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'initialCapacityConfig': ?initialCapacityConfig == null ? null : initialCapacityConfig!.toMap(),
  ...
  factory ApplicationInitialCapacity.fromMap(Map<String, dynamic> map) {
    return ApplicationInitialCapacity(
      initialCapacityConfig: map['initialCapacityConfig'] == null ? null : ApplicationInitialCapacityInitialCapacityConfig.fromMap((map['initialCapacityConfig'] as Map).cast<String, dynamic>()),
