...
class Application extends pulumi.CustomResource {
  ...
  Application(
    ...
    this.imageConfiguration = registerOutput<ApplicationImageConfiguration>(
      'imageConfiguration',
    );
    this.initialCapacities = registerOutput<List<ApplicationInitialCapacity>?>(
      'initialCapacities',
    );
    ...
    this.maximumCapacity = registerOutput<ApplicationMaximumCapacity>(
      'maximumCapacity',
    );
