...
class Application extends pulumi.CustomResource {
  ...
  Application(
    ...
    this.autoStartConfiguration = registerOutput<ApplicationAutoStartConfiguration>('autoStartConfiguration');
    this.autoStopConfiguration = registerOutput<ApplicationAutoStopConfiguration>('autoStopConfiguration');
    this.imageConfiguration = registerOutput<ApplicationImageConfiguration>('imageConfiguration');
    this.initialCapacities = registerOutput<List<ApplicationInitialCapacity>?>('initialCapacities');
    this.interactiveConfiguration = registerOutput<ApplicationInteractiveConfiguration>('interactiveConfiguration');
    this.maximumCapacity = registerOutput<ApplicationMaximumCapacity>('maximumCapacity');
    this.monitoringConfiguration = registerOutput<ApplicationMonitoringConfiguration?>('monitoringConfiguration');
    this.name = registerOutput<String>('name');
    this.networkConfiguration = registerOutput<ApplicationNetworkConfiguration?>('networkConfiguration');
    this.region = registerOutput<String>('region');
    this.releaseLabel = registerOutput<String>('releaseLabel');
    this.runtimeConfigurations = registerOutput<List<ApplicationRuntimeConfiguration>?>('runtimeConfigurations');
    this.schedulerConfiguration = registerOutput<ApplicationSchedulerConfiguration?>('schedulerConfiguration');
