...
class ApplicationArgs {
  ...
  ApplicationArgs({
    String? architecture,
    ApplicationAutoStartConfiguration? autoStartConfiguration,
    ApplicationAutoStopConfiguration? autoStopConfiguration,
    ApplicationImageConfiguration? imageConfiguration,
    List<ApplicationInitialCapacity>? initialCapacities,
    ApplicationInteractiveConfiguration? interactiveConfiguration,
    ApplicationMaximumCapacity? maximumCapacity,
    ApplicationMonitoringConfiguration? monitoringConfiguration,
    String? name,
    ApplicationNetworkConfiguration? networkConfiguration,
    String? region,
    required String releaseLabel,
    List<ApplicationRuntimeConfiguration>? runtimeConfigurations,
    ApplicationSchedulerConfiguration? schedulerConfiguration,
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      ...
      autoStartConfiguration: map['autoStartConfiguration'] == null ? null : ApplicationAutoStartConfiguration.fromMap((map['autoStartConfiguration'] as Map).cast<String, dynamic>()),
      autoStopConfiguration: map['autoStopConfiguration'] == null ? null : ApplicationAutoStopConfiguration.fromMap((map['autoStopConfiguration'] as Map).cast<String, dynamic>()),
      imageConfiguration: map['imageConfiguration'] == null ? null : ApplicationImageConfiguration.fromMap((map['imageConfiguration'] as Map).cast<String, dynamic>()),
      initialCapacities: map['initialCapacities'] == null ? null : pulumi.Input.decodeList<ApplicationInitialCapacity>(map['initialCapacities'], (value) => ApplicationInitialCapacity.fromMap((value as Map).cast<String, dynamic>())),
      interactiveConfiguration: map['interactiveConfiguration'] == null ? null : ApplicationInteractiveConfiguration.fromMap((map['interactiveConfiguration'] as Map).cast<String, dynamic>()),
      maximumCapacity: map['maximumCapacity'] == null ? null : ApplicationMaximumCapacity.fromMap((map['maximumCapacity'] as Map).cast<String, dynamic>()),
      monitoringConfiguration: map['monitoringConfiguration'] == null ? null : ApplicationMonitoringConfiguration.fromMap((map['monitoringConfiguration'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networkConfiguration: map['networkConfiguration'] == null ? null : ApplicationNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      releaseLabel: map['releaseLabel'] as String,
      runtimeConfigurations: map['runtimeConfigurations'] == null ? null : pulumi.Input.decodeList<ApplicationRuntimeConfiguration>(map['runtimeConfigurations'], (value) => ApplicationRuntimeConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      schedulerConfiguration: map['schedulerConfiguration'] == null ? null : ApplicationSchedulerConfiguration.fromMap((map['schedulerConfiguration'] as Map).cast<String, dynamic>()),
