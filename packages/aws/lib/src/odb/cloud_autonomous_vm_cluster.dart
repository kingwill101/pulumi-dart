...
class CloudAutonomousVmCluster extends pulumi.CustomResource {
  ...
  CloudAutonomousVmCluster(
    ...
    this.autonomousDataStoragePercentage = registerOutput<double>(
      'autonomousDataStoragePercentage',
    );
    this.autonomousDataStorageSizeInTbs = registerOutput<double>(
      'autonomousDataStorageSizeInTbs',
    );
    this.availableAutonomousDataStorageSizeInTbs = registerOutput<double>(
      'availableAutonomousDataStorageSizeInTbs',
    );
    this.availableContainerDatabases = registerOutput<int>(
    ...
    this.exadataStorageInTbsLowestScaledValue = registerOutput<double>(
      'exadataStorageInTbsLowestScaledValue',
    );
    this.hostname = registerOutput<String>('hostname');
    this.isMtlsEnabledVmCluster = registerOutput<bool>(
    ...
    this.maxAcdsLowestScaledValue = registerOutput<int>(
      'maxAcdsLowestScaledValue',
    );
    this.memoryPerOracleComputeUnitInGbs = registerOutput<int>(
      'memoryPerOracleComputeUnitInGbs',
    );
    this.memorySizeInGbs = registerOutput<int>('memorySizeInGbs');
    this.nodeCount = registerOutput<int>('nodeCount');
    this.nonProvisionableAutonomousContainerDatabases = registerOutput<int>(
    ...
    this.odbNodeStorageSizeInGbs = registerOutput<int>(
      'odbNodeStorageSizeInGbs',
    );
    this.percentProgress = registerOutput<double>('percentProgress');
    this.provisionableAutonomousContainerDatabases = registerOutput<int>(
      'provisionableAutonomousContainerDatabases',
    );
    this.provisionedAutonomousContainerDatabases = registerOutput<int>(
    ...
    this.timeDatabaseSslCertificateExpires = registerOutput<String>(
      'timeDatabaseSslCertificateExpires',
    );
    this.timeOrdsCertificateExpires = registerOutput<String>(
      'timeOrdsCertificateExpires',
    );
    this.timeZone = registerOutput<String>('timeZone');
    this.timeouts = registerOutput<CloudAutonomousVmClusterTimeouts?>(
      'timeouts',
    );
    this.totalContainerDatabases = registerOutput<int>(
