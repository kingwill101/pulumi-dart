...
class CloudVmClusterArgs {
  ...
  factory CloudVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterArgs(
      ...
      dataCollectionOptions: CloudVmClusterDataCollectionOptions.fromMap((map['dataCollectionOptions'] as Map).cast<String, dynamic>()),
      ...
      isLocalBackupEnabled: map['isLocalBackupEnabled'] == null ? null : map['isLocalBackupEnabled'] as bool,
      isSparseDiskgroupEnabled: map['isSparseDiskgroupEnabled'] == null ? null : map['isSparseDiskgroupEnabled'] as bool,
      ...
      timeouts: map['timeouts'] == null ? null : CloudVmClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
