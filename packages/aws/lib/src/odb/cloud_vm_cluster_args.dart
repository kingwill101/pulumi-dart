...
class CloudVmClusterArgs {
  ...
  CloudVmClusterArgs({
    ...
    String? timezone,
       ...
       dataStorageSizeInTbs = pulumi.Input.asInput<double>(
         dataStorageSizeInTbs,
       ),
       dbNodeStorageSizeInGbs = pulumi.Input.asOptionalInput<int>(
       ...
       isLocalBackupEnabled = pulumi.Input.asOptionalInput<bool>(
         isLocalBackupEnabled,
       ),
       isSparseDiskgroupEnabled = pulumi.Input.asOptionalInput<bool>(
       ...
       scanListenerPortTcp = pulumi.Input.asOptionalInput<int>(
         scanListenerPortTcp,
       ),
       sshPublicKeys = pulumi.Input.asInput<List<String>>(sshPublicKeys),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       timeouts = pulumi.Input.asOptionalInput<CloudVmClusterTimeouts>(
         timeouts,
       ),
  ...
  factory CloudVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterArgs(
      ...
      memorySizeInGbs: map['memorySizeInGbs'] == null
          ? null
          : map['memorySizeInGbs'] as int,
