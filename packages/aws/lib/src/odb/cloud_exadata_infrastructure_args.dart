...
class CloudExadataInfrastructureArgs {
  ...
  CloudExadataInfrastructureArgs({
    ...
    int? computeCount,
    List<CloudExadataInfrastructureCustomerContactsToSendToOci>? customerContactsToSendToOcis,
  ...
  factory CloudExadataInfrastructureArgs.fromMap(Map<String, dynamic> map) {
    return CloudExadataInfrastructureArgs(
      ...
      customerContactsToSendToOcis: map['customerContactsToSendToOcis'] == null ? null : pulumi.Input.decodeList<CloudExadataInfrastructureCustomerContactsToSendToOci>(map['customerContactsToSendToOcis'], (value) => CloudExadataInfrastructureCustomerContactsToSendToOci.fromMap((value as Map).cast<String, dynamic>())),
      databaseServerType: map['databaseServerType'] == null ? null : map['databaseServerType'] as String,
      displayName: map['displayName'] as String,
      maintenanceWindow: CloudExadataInfrastructureMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      shape: map['shape'] as String,
      storageCount: map['storageCount'] == null ? null : map['storageCount'] as int,
      storageServerType: map['storageServerType'] == null ? null : map['storageServerType'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : CloudExadataInfrastructureTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
