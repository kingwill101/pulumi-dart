    ...
    CloudExadataInfrastructureTimeouts? timeouts,
       ...
       customerContactsToSendToOcis =
           pulumi.Input.asOptionalInput<
             List<CloudExadataInfrastructureCustomerContactsToSendToOci>
           >(customerContactsToSendToOcis),
       databaseServerType = pulumi.Input.asOptionalInput<String>(
         databaseServerType,
       ),
       ...
       storageServerType = pulumi.Input.asOptionalInput<String>(
         storageServerType,
       ),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       timeouts = pulumi
           .Input.asOptionalInput<CloudExadataInfrastructureTimeouts>(timeouts);
