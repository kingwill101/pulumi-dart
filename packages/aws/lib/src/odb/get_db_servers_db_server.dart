...
class GetDbServersDbServer {
  ...
  final List<GetDbServersDbServerDbServerPatchingDetail> dbServerPatchingDetails;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dbServerPatchingDetails': pulumi.Input.encodeList<GetDbServersDbServerDbServerPatchingDetail, Map<String, dynamic>>(dbServerPatchingDetails, (value) => value.toMap()),
  ...
  factory GetDbServersDbServer.fromMap(Map<String, dynamic> map) {
    return GetDbServersDbServer(
      ...
      dbServerPatchingDetails: pulumi.Input.decodeList<GetDbServersDbServerDbServerPatchingDetail>(map['dbServerPatchingDetails'], (value) => GetDbServersDbServerDbServerPatchingDetail.fromMap((value as Map).cast<String, dynamic>())),
