...
class GetDbSystemShapesDbSystemShape {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['availableCoreCount'] = availableCoreCount;
    map['availableCoreCountPerNode'] = availableCoreCountPerNode;
    map['availableDataStorageInTbs'] = availableDataStorageInTbs;
    map['availableDataStoragePerServerInTbs'] =
        availableDataStoragePerServerInTbs;
    map['availableDbNodePerNodeInGbs'] = availableDbNodePerNodeInGbs;
    map['availableDbNodeStorageInGbs'] = availableDbNodeStorageInGbs;
    map['availableMemoryInGbs'] = availableMemoryInGbs;
    map['availableMemoryPerNodeInGbs'] = availableMemoryPerNodeInGbs;
    map['coreCountIncrement'] = coreCountIncrement;
    map['maxStorageCount'] = maxStorageCount;
    map['maximumNodeCount'] = maximumNodeCount;
    map['minCoreCountPerNode'] = minCoreCountPerNode;
    map['minDataStorageInTbs'] = minDataStorageInTbs;
    map['minDbNodeStoragePerNodeInGbs'] = minDbNodeStoragePerNodeInGbs;
    map['minMemoryPerNodeInGbs'] = minMemoryPerNodeInGbs;
    map['minStorageCount'] = minStorageCount;
    map['minimumCoreCount'] = minimumCoreCount;
    map['minimumNodeCount'] = minimumNodeCount;
    map['name'] = name;
    map['runtimeMinimumCoreCount'] = runtimeMinimumCoreCount;
    map['shapeFamily'] = shapeFamily;
