...
class CloudExadataInfrastructure extends pulumi.CustomResource {
  ...
  CloudExadataInfrastructure(
    ...
    this.availableStorageSizeInGbs = registerOutput<int>(
    ...
    this.maxDbNodeStorageSizeInGbs = registerOutput<int>(
    ...
    this.monthlyDbServerVersion = registerOutput<String>(
      'monthlyDbServerVersion',
    );
    this.monthlyStorageServerVersion = registerOutput<String>(
    ...
    this.timeouts = registerOutput<CloudExadataInfrastructureTimeouts?>(
      'timeouts',
    );
