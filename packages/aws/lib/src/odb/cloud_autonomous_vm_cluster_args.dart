...
class CloudAutonomousVmClusterArgs {
  ...
  CloudAutonomousVmClusterArgs({
    ...
    required int totalContainerDatabases,
            ...
            pulumi.Input.asInput<double>(autonomousDataStorageSizeInTbs),
        ...
        isMtlsEnabledVmCluster =
            pulumi.Input.asOptionalInput<bool>(isMtlsEnabledVmCluster),
        ...
        memoryPerOracleComputeUnitInGbs =
            pulumi.Input.asInput<int>(memoryPerOracleComputeUnitInGbs),
        ...
        scanListenerPortNonTls =
            pulumi.Input.asInput<int>(scanListenerPortNonTls),
        scanListenerPortTls = pulumi.Input.asInput<int>(scanListenerPortTls),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        timeZone = pulumi.Input.asOptionalInput<String>(timeZone),
        timeouts =
            pulumi.Input.asOptionalInput<CloudAutonomousVmClusterTimeouts>(
                timeouts),
        totalContainerDatabases =
            pulumi.Input.asInput<int>(totalContainerDatabases);
