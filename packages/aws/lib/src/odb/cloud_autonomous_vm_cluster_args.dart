...
class CloudAutonomousVmClusterArgs {
  ...
  factory CloudAutonomousVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudAutonomousVmClusterArgs(
      ...
      cloudExadataInfrastructureArn: map['cloudExadataInfrastructureArn'] == null ? null : map['cloudExadataInfrastructureArn'] as String,
      cloudExadataInfrastructureId: map['cloudExadataInfrastructureId'] == null ? null : map['cloudExadataInfrastructureId'] as String,
      cpuCoreCountPerNode: map['cpuCoreCountPerNode'] as int,
      dbServers: (map['dbServers'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      isMtlsEnabledVmCluster: map['isMtlsEnabledVmCluster'] == null ? null : map['isMtlsEnabledVmCluster'] as bool,
      licenseModel: map['licenseModel'] == null ? null : map['licenseModel'] as String,
      maintenanceWindow: CloudAutonomousVmClusterMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      ...
      timeouts: map['timeouts'] == null ? null : CloudAutonomousVmClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
