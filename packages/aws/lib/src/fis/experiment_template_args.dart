...
class ExperimentTemplateArgs {
  ...
  ExperimentTemplateArgs({
    required List<ExperimentTemplateAction> actions,
    required String description,
    ExperimentTemplateExperimentOptions? experimentOptions,
    ExperimentTemplateExperimentReportConfiguration? experimentReportConfiguration,
    ExperimentTemplateLogConfiguration? logConfiguration,
    String? region,
    required String roleArn,
    required List<ExperimentTemplateStopCondition> stopConditions,
    Map<String, String>? tags,
    List<ExperimentTemplateTarget>? targets,
  }) :
      actions = pulumi.Input.asInput<List<ExperimentTemplateAction>>(actions),
      ...
      stopConditions = pulumi.Input.asInput<List<ExperimentTemplateStopCondition>>(stopConditions),
  ...
  factory ExperimentTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ExperimentTemplateArgs(
      actions: pulumi.Input.decodeList<ExperimentTemplateAction>(map['actions'], (value) => ExperimentTemplateAction.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] as String,
      experimentOptions: map['experimentOptions'] == null ? null : ExperimentTemplateExperimentOptions.fromMap((map['experimentOptions'] as Map).cast<String, dynamic>()),
      experimentReportConfiguration: map['experimentReportConfiguration'] == null ? null : ExperimentTemplateExperimentReportConfiguration.fromMap((map['experimentReportConfiguration'] as Map).cast<String, dynamic>()),
      logConfiguration: map['logConfiguration'] == null ? null : ExperimentTemplateLogConfiguration.fromMap((map['logConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      roleArn: map['roleArn'] as String,
      stopConditions: pulumi.Input.decodeList<ExperimentTemplateStopCondition>(map['stopConditions'], (value) => ExperimentTemplateStopCondition.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<ExperimentTemplateTarget>(map['targets'], (value) => ExperimentTemplateTarget.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
