...
class ExperimentTemplateArgs {
  ...
  factory ExperimentTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ExperimentTemplateArgs(
      actions: pulumi.Input.decodeList<ExperimentTemplateAction>(
        map['actions'],
      ...
      experimentOptions: map['experimentOptions'] == null
          ? null
          : ExperimentTemplateExperimentOptions.fromMap(
              (map['experimentOptions'] as Map).cast<String, dynamic>(),
            ),
      experimentReportConfiguration:
          map['experimentReportConfiguration'] == null
          ? null
          : ExperimentTemplateExperimentReportConfiguration.fromMap(
              (map['experimentReportConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      ...
      stopConditions: pulumi.Input.decodeList<ExperimentTemplateStopCondition>(
        map['stopConditions'],
