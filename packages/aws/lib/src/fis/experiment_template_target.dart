...
class ExperimentTemplateTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?filters == null ? null : pulumi.Input.encodeList<ExperimentTemplateTargetFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
      'name': name,
      'parameters': ?parameters,
      'resourceArns': ?resourceArns,
      'resourceTags': ?resourceTags == null ? null : pulumi.Input.encodeList<ExperimentTemplateTargetResourceTag, Map<String, dynamic>>(resourceTags!, (value) => value.toMap()),
  ...
  factory ExperimentTemplateTarget.fromMap(Map<String, dynamic> map) {
    return ExperimentTemplateTarget(
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<ExperimentTemplateTargetFilter>(map['filters'], (value) => ExperimentTemplateTargetFilter.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      resourceArns: map['resourceArns'] == null ? null : (map['resourceArns'] as List).cast<String>(),
      resourceTags: map['resourceTags'] == null ? null : pulumi.Input.decodeList<ExperimentTemplateTargetResourceTag>(map['resourceTags'], (value) => ExperimentTemplateTargetResourceTag.fromMap((value as Map).cast<String, dynamic>())),
