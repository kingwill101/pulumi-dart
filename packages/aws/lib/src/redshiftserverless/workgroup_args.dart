...
class WorkgroupArgs {
  ...
  factory WorkgroupArgs.fromMap(Map<String, dynamic> map) {
    return WorkgroupArgs(
      baseCapacity: map['baseCapacity'] == null ? null : map['baseCapacity'] as int,
      configParameters: map['configParameters'] == null ? null : pulumi.Input.decodeList<WorkgroupConfigParameter>(map['configParameters'], (value) => WorkgroupConfigParameter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pricePerformanceTarget: map['pricePerformanceTarget'] == null ? null : WorkgroupPricePerformanceTarget.fromMap((map['pricePerformanceTarget'] as Map).cast<String, dynamic>()),
