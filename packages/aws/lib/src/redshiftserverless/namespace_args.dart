...
class NamespaceArgs {
  ...
  NamespaceArgs({
    ...
    Map<String, String>? tags,
       ...
       adminUserPassword = pulumi.Input.asOptionalInput<String>(
         adminUserPassword,
       ),
       adminUserPasswordWo = pulumi.Input.asOptionalInput<String>(
         adminUserPasswordWo,
       ),
       adminUserPasswordWoVersion = pulumi.Input.asOptionalInput<int>(
       ...
       manageAdminPassword = pulumi.Input.asOptionalInput<bool>(
         manageAdminPassword,
       ),
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      adminUsername: map['adminUsername'] == null
          ? null
          : map['adminUsername'] as String,
