...
class NamespaceArgs {
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      adminPasswordSecretKmsKeyId: map['adminPasswordSecretKmsKeyId'] == null ? null : map['adminPasswordSecretKmsKeyId'] as String,
      adminUserPassword: map['adminUserPassword'] == null ? null : map['adminUserPassword'] as String,
      adminUserPasswordWo: map['adminUserPasswordWo'] == null ? null : map['adminUserPasswordWo'] as String,
      adminUserPasswordWoVersion: map['adminUserPasswordWoVersion'] == null ? null : map['adminUserPasswordWoVersion'] as int,
      ...
      manageAdminPassword: map['manageAdminPassword'] == null ? null : map['manageAdminPassword'] as bool,
