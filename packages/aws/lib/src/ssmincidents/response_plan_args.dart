...
class ResponsePlanArgs {
  ...
  ResponsePlanArgs({
    ResponsePlanAction? action,
    List<String>? chatChannels,
    String? displayName,
    List<String>? engagements,
    required ResponsePlanIncidentTemplate incidentTemplate,
    ResponsePlanIntegration? integration,
    String? name,
    String? region,
    Map<String, String>? tags,
        ...
        incidentTemplate = pulumi.Input.asInput<ResponsePlanIncidentTemplate>(
            incidentTemplate),
        integration =
            pulumi.Input.asOptionalInput<ResponsePlanIntegration>(integration),
