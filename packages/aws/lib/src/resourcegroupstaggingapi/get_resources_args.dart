...
class GetResourcesArgs {
  ...
  }) : excludeCompliantResources = pulumi.Input.asOptionalInput<bool>(
         excludeCompliantResources,
       ),
       includeComplianceDetails = pulumi.Input.asOptionalInput<bool>(
         includeComplianceDetails,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       resourceArnLists = pulumi.Input.asOptionalInput<List<String>>(
         resourceArnLists,
       ),
