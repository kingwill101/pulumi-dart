...
class GetResourcesArgs {
  ...
  GetResourcesArgs({
    ...
    String? region,
    List<String>? resourceArnLists,
    List<String>? resourceTypeFilters,
    List<GetResourcesTagFilter>? tagFilters,
  })  : excludeCompliantResources =
            pulumi.Input.asOptionalInput<bool>(excludeCompliantResources),
        includeComplianceDetails =
            pulumi.Input.asOptionalInput<bool>(includeComplianceDetails),
        region = pulumi.Input.asOptionalInput<String>(region),
        resourceArnLists =
            pulumi.Input.asOptionalInput<List<String>>(resourceArnLists),
        resourceTypeFilters =
            pulumi.Input.asOptionalInput<List<String>>(resourceTypeFilters),
        tagFilters = pulumi.Input.asOptionalInput<List<GetResourcesTagFilter>>(
            tagFilters);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (tagFiltersValue != null) {
      map['tagFilters'] = pulumi.Input.mapOptionalInputValue<
              List<GetResourcesTagFilter>, List<Map<String, dynamic>>>(
          tagFiltersValue,
          (value) => pulumi.Input.encodeList<GetResourcesTagFilter,
