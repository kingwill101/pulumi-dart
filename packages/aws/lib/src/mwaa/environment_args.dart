...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    String? workerReplacementStrategy,
       ...
       endpointManagement = pulumi.Input.asOptionalInput<String>(
         endpointManagement,
       ),
       environmentClass = pulumi.Input.asOptionalInput<String>(
         environmentClass,
       ),
       ...
       pluginsS3ObjectVersion = pulumi.Input.asOptionalInput<String>(
       ...
       requirementsS3Path = pulumi.Input.asOptionalInput<String>(
         requirementsS3Path,
       ),
       ...
       startupScriptS3Path = pulumi.Input.asOptionalInput<String>(
         startupScriptS3Path,
       ),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       webserverAccessMode = pulumi.Input.asOptionalInput<String>(
         webserverAccessMode,
       ),
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      maxWebservers: map['maxWebservers'] == null
          ? null
          : map['maxWebservers'] as int,
      maxWorkers: map['maxWorkers'] == null ? null : map['maxWorkers'] as int,
      minWebservers: map['minWebservers'] == null
          ? null
          : map['minWebservers'] as int,
      ...
      pluginsS3Path: map['pluginsS3Path'] == null
          ? null
          : map['pluginsS3Path'] as String,
