...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    String? kmsKey,
    EnvironmentLoggingConfiguration? loggingConfiguration,
    int? maxWebservers,
    int? maxWorkers,
    int? minWebservers,
    int? minWorkers,
    String? name,
    required EnvironmentNetworkConfiguration networkConfiguration,
    ...
    String? workerReplacementStrategy,
        ...
        endpointManagement =
            pulumi.Input.asOptionalInput<String>(endpointManagement),
        environmentClass =
            pulumi.Input.asOptionalInput<String>(environmentClass),
        ...
        pluginsS3ObjectVersion =
            pulumi.Input.asOptionalInput<String>(pluginsS3ObjectVersion),
        pluginsS3Path = pulumi.Input.asOptionalInput<String>(pluginsS3Path),
        region = pulumi.Input.asOptionalInput<String>(region),
        requirementsS3ObjectVersion =
            pulumi.Input.asOptionalInput<String>(requirementsS3ObjectVersion),
        requirementsS3Path =
            pulumi.Input.asOptionalInput<String>(requirementsS3Path),
        schedulers = pulumi.Input.asOptionalInput<int>(schedulers),
        sourceBucketArn = pulumi.Input.asInput<String>(sourceBucketArn),
        startupScriptS3ObjectVersion =
            pulumi.Input.asOptionalInput<String>(startupScriptS3ObjectVersion),
        startupScriptS3Path =
            pulumi.Input.asOptionalInput<String>(startupScriptS3Path),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        webserverAccessMode =
            pulumi.Input.asOptionalInput<String>(webserverAccessMode),
        weeklyMaintenanceWindowStart =
            pulumi.Input.asOptionalInput<String>(weeklyMaintenanceWindowStart),
        workerReplacementStrategy =
            pulumi.Input.asOptionalInput<String>(workerReplacementStrategy);
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      airflowConfigurationOptions: map['airflowConfigurationOptions'] == null
          ? null
          : (map['airflowConfigurationOptions'] as Map).cast<String, String>(),
      airflowVersion: map['airflowVersion'] == null
          ? null
          : map['airflowVersion'] as String,
      dagS3Path: map['dagS3Path'] as String,
      endpointManagement: map['endpointManagement'] == null
          ? null
          : map['endpointManagement'] as String,
      environmentClass: map['environmentClass'] == null
          ? null
          : map['environmentClass'] as String,
      executionRoleArn: map['executionRoleArn'] as String,
      kmsKey: map['kmsKey'] == null ? null : map['kmsKey'] as String,
      loggingConfiguration: map['loggingConfiguration'] == null
          ? null
          : EnvironmentLoggingConfiguration.fromMap(
              (map['loggingConfiguration'] as Map).cast<String, dynamic>()),
      maxWebservers:
          map['maxWebservers'] == null ? null : map['maxWebservers'] as int,
      maxWorkers: map['maxWorkers'] == null ? null : map['maxWorkers'] as int,
      minWebservers:
          map['minWebservers'] == null ? null : map['minWebservers'] as int,
      minWorkers: map['minWorkers'] == null ? null : map['minWorkers'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      networkConfiguration: EnvironmentNetworkConfiguration.fromMap(
          (map['networkConfiguration'] as Map).cast<String, dynamic>()),
      pluginsS3ObjectVersion: map['pluginsS3ObjectVersion'] == null
          ? null
          : map['pluginsS3ObjectVersion'] as String,
      pluginsS3Path:
          map['pluginsS3Path'] == null ? null : map['pluginsS3Path'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      requirementsS3ObjectVersion: map['requirementsS3ObjectVersion'] == null
          ? null
          : map['requirementsS3ObjectVersion'] as String,
      requirementsS3Path: map['requirementsS3Path'] == null
          ? null
          : map['requirementsS3Path'] as String,
      schedulers: map['schedulers'] == null ? null : map['schedulers'] as int,
      sourceBucketArn: map['sourceBucketArn'] as String,
      startupScriptS3ObjectVersion: map['startupScriptS3ObjectVersion'] == null
          ? null
          : map['startupScriptS3ObjectVersion'] as String,
      startupScriptS3Path: map['startupScriptS3Path'] == null
          ? null
          : map['startupScriptS3Path'] as String,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      webserverAccessMode: map['webserverAccessMode'] == null
          ? null
          : map['webserverAccessMode'] as String,
      weeklyMaintenanceWindowStart: map['weeklyMaintenanceWindowStart'] == null
          ? null
          : map['weeklyMaintenanceWindowStart'] as String,
      workerReplacementStrategy: map['workerReplacementStrategy'] == null
          ? null
          : map['workerReplacementStrategy'] as String,
    );
  }
}
