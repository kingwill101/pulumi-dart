...
class Environment extends pulumi.CustomResource {
  ...
  Environment(
    ...
    this.airflowConfigurationOptions = registerOutput<Map<String, String>?>('airflowConfigurationOptions');
    this.airflowVersion = registerOutput<String>('airflowVersion');
    this.arn = registerOutput<String>('arn');
    this.createdAt = registerOutput<String>('createdAt');
    this.dagS3Path = registerOutput<String>('dagS3Path');
    this.databaseVpcEndpointService = registerOutput<String>('databaseVpcEndpointService');
    ...
    this.lastUpdateds = registerOutput<List<EnvironmentLastUpdated>>('lastUpdateds');
    this.loggingConfiguration = registerOutput<EnvironmentLoggingConfiguration>('loggingConfiguration');
    ...
    this.networkConfiguration = registerOutput<EnvironmentNetworkConfiguration>('networkConfiguration');
    this.pluginsS3ObjectVersion = registerOutput<String>('pluginsS3ObjectVersion');
    this.pluginsS3Path = registerOutput<String?>('pluginsS3Path');
    this.region = registerOutput<String>('region');
    this.requirementsS3ObjectVersion = registerOutput<String>('requirementsS3ObjectVersion');
    ...
    this.startupScriptS3ObjectVersion = registerOutput<String>('startupScriptS3ObjectVersion');
    ...
    this.webserverVpcEndpointService = registerOutput<String>('webserverVpcEndpointService');
    this.weeklyMaintenanceWindowStart = registerOutput<String>('weeklyMaintenanceWindowStart');
    this.workerReplacementStrategy = registerOutput<String>('workerReplacementStrategy');
  }
}
