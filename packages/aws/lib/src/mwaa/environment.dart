...
class Environment extends pulumi.CustomResource {
  ...
  Environment(
    ...
    this.airflowConfigurationOptions = registerOutput<Map<String, String>?>(
      'airflowConfigurationOptions',
    );
    ...
    this.databaseVpcEndpointService = registerOutput<String>(
    ...
    this.lastUpdateds = registerOutput<List<EnvironmentLastUpdated>>(
      'lastUpdateds',
    );
    this.loggingConfiguration = registerOutput<EnvironmentLoggingConfiguration>(
      'loggingConfiguration',
    );
    ...
    this.networkConfiguration = registerOutput<EnvironmentNetworkConfiguration>(
      'networkConfiguration',
    );
    this.pluginsS3ObjectVersion = registerOutput<String>(
      'pluginsS3ObjectVersion',
    );
    this.pluginsS3Path = registerOutput<String?>('pluginsS3Path');
    this.region = registerOutput<String>('region');
    this.requirementsS3ObjectVersion = registerOutput<String>(
    ...
    this.startupScriptS3ObjectVersion = registerOutput<String>(
    ...
    this.webserverVpcEndpointService = registerOutput<String>(
      'webserverVpcEndpointService',
    );
    this.weeklyMaintenanceWindowStart = registerOutput<String>(
      'weeklyMaintenanceWindowStart',
    );
    this.workerReplacementStrategy = registerOutput<String>(
