...
class EnvironmentLoggingConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dagProcessingLogs': ?dagProcessingLogs == null ? null : dagProcessingLogs!.toMap(),
  ...
  factory EnvironmentLoggingConfiguration.fromMap(Map<String, dynamic> map) {
    return EnvironmentLoggingConfiguration(
      dagProcessingLogs: map['dagProcessingLogs'] == null ? null : EnvironmentLoggingConfigurationDagProcessingLogs.fromMap((map['dagProcessingLogs'] as Map).cast<String, dynamic>()),
      schedulerLogs: map['schedulerLogs'] == null ? null : EnvironmentLoggingConfigurationSchedulerLogs.fromMap((map['schedulerLogs'] as Map).cast<String, dynamic>()),
      taskLogs: map['taskLogs'] == null ? null : EnvironmentLoggingConfigurationTaskLogs.fromMap((map['taskLogs'] as Map).cast<String, dynamic>()),
      webserverLogs: map['webserverLogs'] == null ? null : EnvironmentLoggingConfigurationWebserverLogs.fromMap((map['webserverLogs'] as Map).cast<String, dynamic>()),
      workerLogs: map['workerLogs'] == null ? null : EnvironmentLoggingConfigurationWorkerLogs.fromMap((map['workerLogs'] as Map).cast<String, dynamic>()),
    );
  }
}
