...
class ResourceLfTagArgs {
  ...
  factory ResourceLfTagArgs.fromMap(Map<String, dynamic> map) {
    return ResourceLfTagArgs(
      ...
      database: map['database'] == null ? null : ResourceLfTagDatabase.fromMap((map['database'] as Map).cast<String, dynamic>()),
      lfTag: ResourceLfTagLfTag.fromMap((map['lfTag'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      table: map['table'] == null ? null : ResourceLfTagTable.fromMap((map['table'] as Map).cast<String, dynamic>()),
      tableWithColumns: map['tableWithColumns'] == null ? null : ResourceLfTagTableWithColumns.fromMap((map['tableWithColumns'] as Map).cast<String, dynamic>()),
      timeouts: map['timeouts'] == null ? null : ResourceLfTagTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
