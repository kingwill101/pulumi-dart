...
class DataLakeSettingsArgs {
  ...
  DataLakeSettingsArgs({
    ...
    List<String>? trustedResourceOwners,
       ...
       allowExternalDataFiltering = pulumi.Input.asOptionalInput<bool>(
         allowExternalDataFiltering,
       ),
       allowFullTableExternalDataAccess = pulumi.Input.asOptionalInput<bool>(
         allowFullTableExternalDataAccess,
       ),
       authorizedSessionTagValueLists = pulumi
           .Input.asOptionalInput<List<String>>(authorizedSessionTagValueLists),
       ...
       readOnlyAdmins = pulumi.Input.asOptionalInput<List<String>>(
         readOnlyAdmins,
       ),
  ...
  factory DataLakeSettingsArgs.fromMap(Map<String, dynamic> map) {
    return DataLakeSettingsArgs(
      admins: map['admins'] == null
          ? null
          : (map['admins'] as List).cast<String>(),
      ...
      createTableDefaultPermissions:
          ...
          ? null
          : pulumi
                .Input.decodeList<DataLakeSettingsCreateTableDefaultPermission>(
