...
class DataLakeSettingsArgs {
  ...
  DataLakeSettingsArgs({
    ...
    String? catalogId,
    List<DataLakeSettingsCreateDatabaseDefaultPermission>? createDatabaseDefaultPermissions,
    List<DataLakeSettingsCreateTableDefaultPermission>? createTableDefaultPermissions,
  ...
  factory DataLakeSettingsArgs.fromMap(Map<String, dynamic> map) {
    return DataLakeSettingsArgs(
      admins: map['admins'] == null ? null : (map['admins'] as List).cast<String>(),
      allowExternalDataFiltering: map['allowExternalDataFiltering'] == null ? null : map['allowExternalDataFiltering'] as bool,
      allowFullTableExternalDataAccess: map['allowFullTableExternalDataAccess'] == null ? null : map['allowFullTableExternalDataAccess'] as bool,
      authorizedSessionTagValueLists: map['authorizedSessionTagValueLists'] == null ? null : (map['authorizedSessionTagValueLists'] as List).cast<String>(),
      catalogId: map['catalogId'] == null ? null : map['catalogId'] as String,
      createDatabaseDefaultPermissions: map['createDatabaseDefaultPermissions'] == null ? null : pulumi.Input.decodeList<DataLakeSettingsCreateDatabaseDefaultPermission>(map['createDatabaseDefaultPermissions'], (value) => DataLakeSettingsCreateDatabaseDefaultPermission.fromMap((value as Map).cast<String, dynamic>())),
      createTableDefaultPermissions: map['createTableDefaultPermissions'] == null ? null : pulumi.Input.decodeList<DataLakeSettingsCreateTableDefaultPermission>(map['createTableDefaultPermissions'], (value) => DataLakeSettingsCreateTableDefaultPermission.fromMap((value as Map).cast<String, dynamic>())),
      externalDataFilteringAllowLists: map['externalDataFilteringAllowLists'] == null ? null : (map['externalDataFilteringAllowLists'] as List).cast<String>(),
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      readOnlyAdmins: map['readOnlyAdmins'] == null ? null : (map['readOnlyAdmins'] as List).cast<String>(),
      region: map['region'] == null ? null : map['region'] as String,
      trustedResourceOwners: map['trustedResourceOwners'] == null ? null : (map['trustedResourceOwners'] as List).cast<String>(),
    );
  }
}
