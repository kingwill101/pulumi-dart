...
class GetDataLakeSettingsResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['admins'] = admins;
    map['allowExternalDataFiltering'] = allowExternalDataFiltering;
    map['allowFullTableExternalDataAccess'] = allowFullTableExternalDataAccess;
    map['authorizedSessionTagValueLists'] = authorizedSessionTagValueLists;
    ...
    map['externalDataFilteringAllowLists'] = externalDataFilteringAllowLists;
    map['id'] = id;
    map['parameters'] = parameters;
    map['readOnlyAdmins'] = readOnlyAdmins;
    map['region'] = region;
    map['trustedResourceOwners'] = trustedResourceOwners;
    return map;
  }
