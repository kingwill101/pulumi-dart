...
class DataCellsFilterArgs {
  ...
  factory DataCellsFilterArgs.fromMap(Map<String, dynamic> map) {
    return DataCellsFilterArgs(
      ...
      tableData: DataCellsFilterTableData.fromMap((map['tableData'] as Map).cast<String, dynamic>()),
      timeouts: map['timeouts'] == null ? null : DataCellsFilterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
