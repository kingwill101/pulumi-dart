...
class PermissionsArgs {
  ...
  factory PermissionsArgs.fromMap(Map<String, dynamic> map) {
    return PermissionsArgs(
      ...
      dataCellsFilter: map['dataCellsFilter'] == null ? null : PermissionsDataCellsFilter.fromMap((map['dataCellsFilter'] as Map).cast<String, dynamic>()),
      dataLocation: map['dataLocation'] == null ? null : PermissionsDataLocation.fromMap((map['dataLocation'] as Map).cast<String, dynamic>()),
      database: map['database'] == null ? null : PermissionsDatabase.fromMap((map['database'] as Map).cast<String, dynamic>()),
      lfTag: map['lfTag'] == null ? null : PermissionsLfTag.fromMap((map['lfTag'] as Map).cast<String, dynamic>()),
      lfTagPolicy: map['lfTagPolicy'] == null ? null : PermissionsLfTagPolicy.fromMap((map['lfTagPolicy'] as Map).cast<String, dynamic>()),
      permissions: (map['permissions'] as List).cast<String>(),
      permissionsWithGrantOptions: map['permissionsWithGrantOptions'] == null ? null : (map['permissionsWithGrantOptions'] as List).cast<String>(),
      principal: map['principal'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      table: map['table'] == null ? null : PermissionsTable.fromMap((map['table'] as Map).cast<String, dynamic>()),
      tableWithColumns: map['tableWithColumns'] == null ? null : PermissionsTableWithColumns.fromMap((map['tableWithColumns'] as Map).cast<String, dynamic>()),
    );
  }
}
