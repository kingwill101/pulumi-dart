...
class DataLakeSettings extends pulumi.CustomResource {
  ...
  DataLakeSettings(
    ...
    this.allowExternalDataFiltering = registerOutput<bool?>(
      'allowExternalDataFiltering',
    );
    this.allowFullTableExternalDataAccess = registerOutput<bool?>(
      'allowFullTableExternalDataAccess',
    );
    this.authorizedSessionTagValueLists = registerOutput<List<String>>(
      'authorizedSessionTagValueLists',
    );
    ...
    this.externalDataFilteringAllowLists = registerOutput<List<String>>(
      'externalDataFilteringAllowLists',
    );
    this.parameters = registerOutput<Map<String, String>>('parameters');
    this.readOnlyAdmins = registerOutput<List<String>>('readOnlyAdmins');
    this.region = registerOutput<String>('region');
    this.trustedResourceOwners = registerOutput<List<String>>(
