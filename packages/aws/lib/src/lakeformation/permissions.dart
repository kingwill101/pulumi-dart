...
class Permissions extends pulumi.CustomResource {
  ...
  Permissions(
    ...
    this.dataCellsFilter = registerOutput<PermissionsDataCellsFilter?>(
      'dataCellsFilter',
    );
    ...
    this.permissionsWithGrantOptions = registerOutput<List<String>>(
    ...
    this.tableWithColumns = registerOutput<PermissionsTableWithColumns>(
      'tableWithColumns',
    );
  }
}
