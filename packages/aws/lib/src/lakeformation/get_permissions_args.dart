...
class GetPermissionsArgs {
  ...
  factory GetPermissionsArgs.fromMap(Map<String, dynamic> map) {
    return GetPermissionsArgs(
      ...
      dataCellsFilter: map['dataCellsFilter'] == null ? null : GetPermissionsDataCellsFilter.fromMap((map['dataCellsFilter'] as Map).cast<String, dynamic>()),
      dataLocation: map['dataLocation'] == null ? null : GetPermissionsDataLocation.fromMap((map['dataLocation'] as Map).cast<String, dynamic>()),
      database: map['database'] == null ? null : GetPermissionsDatabase.fromMap((map['database'] as Map).cast<String, dynamic>()),
      lfTag: map['lfTag'] == null ? null : GetPermissionsLfTag.fromMap((map['lfTag'] as Map).cast<String, dynamic>()),
      lfTagPolicy: map['lfTagPolicy'] == null ? null : GetPermissionsLfTagPolicy.fromMap((map['lfTagPolicy'] as Map).cast<String, dynamic>()),
      principal: map['principal'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      table: map['table'] == null ? null : GetPermissionsTable.fromMap((map['table'] as Map).cast<String, dynamic>()),
      tableWithColumns: map['tableWithColumns'] == null ? null : GetPermissionsTableWithColumns.fromMap((map['tableWithColumns'] as Map).cast<String, dynamic>()),
    );
  }
}
