...
class OptInResourceData {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'catalogs': ?catalogs == null ? null : pulumi.Input.encodeList<OptInResourceDataCatalog, Map<String, dynamic>>(catalogs!, (value) => value.toMap()),
      'dataCellsFilters': ?dataCellsFilters == null ? null : pulumi.Input.encodeList<OptInResourceDataDataCellsFilter, Map<String, dynamic>>(dataCellsFilters!, (value) => value.toMap()),
      'dataLocations': ?dataLocations == null ? null : pulumi.Input.encodeList<OptInResourceDataDataLocation, Map<String, dynamic>>(dataLocations!, (value) => value.toMap()),
      'database': ?database == null ? null : database!.toMap(),
      'lfTag': ?lfTag == null ? null : lfTag!.toMap(),
      'lfTagExpressions': ?lfTagExpressions == null ? null : pulumi.Input.encodeList<OptInResourceDataLfTagExpression, Map<String, dynamic>>(lfTagExpressions!, (value) => value.toMap()),
      'lfTagPolicies': ?lfTagPolicies == null ? null : pulumi.Input.encodeList<OptInResourceDataLfTagPolicy, Map<String, dynamic>>(lfTagPolicies!, (value) => value.toMap()),
      'table': ?table == null ? null : table!.toMap(),
      'tableWithColumns': ?tableWithColumns == null ? null : tableWithColumns!.toMap(),
    };
  }

  factory OptInResourceData.fromMap(Map<String, dynamic> map) {
    return OptInResourceData(
      catalogs: map['catalogs'] == null ? null : pulumi.Input.decodeList<OptInResourceDataCatalog>(map['catalogs'], (value) => OptInResourceDataCatalog.fromMap((value as Map).cast<String, dynamic>())),
      dataCellsFilters: map['dataCellsFilters'] == null ? null : pulumi.Input.decodeList<OptInResourceDataDataCellsFilter>(map['dataCellsFilters'], (value) => OptInResourceDataDataCellsFilter.fromMap((value as Map).cast<String, dynamic>())),
      dataLocations: map['dataLocations'] == null ? null : pulumi.Input.decodeList<OptInResourceDataDataLocation>(map['dataLocations'], (value) => OptInResourceDataDataLocation.fromMap((value as Map).cast<String, dynamic>())),
      database: map['database'] == null ? null : OptInResourceDataDatabase.fromMap((map['database'] as Map).cast<String, dynamic>()),
      lfTag: map['lfTag'] == null ? null : OptInResourceDataLfTag.fromMap((map['lfTag'] as Map).cast<String, dynamic>()),
      lfTagExpressions: map['lfTagExpressions'] == null ? null : pulumi.Input.decodeList<OptInResourceDataLfTagExpression>(map['lfTagExpressions'], (value) => OptInResourceDataLfTagExpression.fromMap((value as Map).cast<String, dynamic>())),
      lfTagPolicies: map['lfTagPolicies'] == null ? null : pulumi.Input.decodeList<OptInResourceDataLfTagPolicy>(map['lfTagPolicies'], (value) => OptInResourceDataLfTagPolicy.fromMap((value as Map).cast<String, dynamic>())),
      table: map['table'] == null ? null : OptInResourceDataTable.fromMap((map['table'] as Map).cast<String, dynamic>()),
      tableWithColumns: map['tableWithColumns'] == null ? null : OptInResourceDataTableWithColumns.fromMap((map['tableWithColumns'] as Map).cast<String, dynamic>()),
    );
  }
}
