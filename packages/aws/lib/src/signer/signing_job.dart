...
class SigningJob extends pulumi.CustomResource {
  ...
  SigningJob(
    ...
    this.ignoreSigningJobFailure = registerOutput<bool?>(
    ...
    this.revocationRecords = registerOutput<List<SigningJobRevocationRecord>>(
      'revocationRecords',
    );
    this.signatureExpiresAt = registerOutput<String>('signatureExpiresAt');
    this.signedObjects = registerOutput<List<SigningJobSignedObject>>(
      'signedObjects',
    );
