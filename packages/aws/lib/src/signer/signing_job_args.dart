...
class SigningJobArgs {
  ...
  factory SigningJobArgs.fromMap(Map<String, dynamic> map) {
    return SigningJobArgs(
      destination: SigningJobDestination.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      ignoreSigningJobFailure: map['ignoreSigningJobFailure'] == null ? null : map['ignoreSigningJobFailure'] as bool,
      profileName: map['profileName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      source: SigningJobSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
    );
  }
}
