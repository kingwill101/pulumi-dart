...
class SigningProfileArgs {
    ...
    return <String, dynamic>{
      ...
      'signatureValidityPeriod':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(signatureValidityPeriod, (value) => value.toMap()),
      'signingMaterial':
          ?pulumi.Input.mapOptionalInputValue<
            SigningProfileSigningMaterial,
            Map<String, dynamic>
          >(signingMaterial, (value) => value.toMap()),
  ...
  factory SigningProfileArgs.fromMap(Map<String, dynamic> map) {
    return SigningProfileArgs(
      ...
      signatureValidityPeriod: map['signatureValidityPeriod'] == null
          ? null
          : SigningProfileSignatureValidityPeriod.fromMap(
              (map['signatureValidityPeriod'] as Map).cast<String, dynamic>(),
            ),
      signingMaterial: map['signingMaterial'] == null
          ? null
          : SigningProfileSigningMaterial.fromMap(
              (map['signingMaterial'] as Map).cast<String, dynamic>(),
            ),
      signingParameters: map['signingParameters'] == null
          ? null
