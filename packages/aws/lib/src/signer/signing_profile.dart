...
class SigningProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SigningProfileRevocationRecord>>
  revocationRecords;
  ...
  SigningProfile(
    ...
    this.signingMaterial = registerOutput<SigningProfileSigningMaterial>(
      'signingMaterial',
    );
    this.signingParameters = registerOutput<Map<String, String>?>(
      'signingParameters',
    );
