...
class PlanWorkflowStep {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arcRoutingControlConfigs': ?arcRoutingControlConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepArcRoutingControlConfig,
              Map<String, dynamic>
            >(arcRoutingControlConfigs!, (value) => value.toMap()),
      'customActionLambdaConfigs': ?customActionLambdaConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepCustomActionLambdaConfig,
              Map<String, dynamic>
            >(customActionLambdaConfigs!, (value) => value.toMap()),
      'description': ?description,
      'documentDbConfigs': ?documentDbConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepDocumentDbConfig,
              Map<String, dynamic>
            >(documentDbConfigs!, (value) => value.toMap()),
      'ec2AsgCapacityIncreaseConfigs': ?ec2AsgCapacityIncreaseConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepEc2AsgCapacityIncreaseConfig,
              Map<String, dynamic>
            >(ec2AsgCapacityIncreaseConfigs!, (value) => value.toMap()),
      'ecsCapacityIncreaseConfigs': ?ecsCapacityIncreaseConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepEcsCapacityIncreaseConfig,
              Map<String, dynamic>
            >(ecsCapacityIncreaseConfigs!, (value) => value.toMap()),
      'eksResourceScalingConfigs': ?eksResourceScalingConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepEksResourceScalingConfig,
              Map<String, dynamic>
            >(eksResourceScalingConfigs!, (value) => value.toMap()),
      'executionApprovalConfigs': ?executionApprovalConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepExecutionApprovalConfig,
              Map<String, dynamic>
            >(executionApprovalConfigs!, (value) => value.toMap()),
      'executionBlockType': executionBlockType,
      'globalAuroraConfigs': ?globalAuroraConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepGlobalAuroraConfig,
              Map<String, dynamic>
            >(globalAuroraConfigs!, (value) => value.toMap()),
      'name': name,
      'parallelConfigs': ?parallelConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepParallelConfig,
              Map<String, dynamic>
            >(parallelConfigs!, (value) => value.toMap()),
      'regionSwitchPlanConfigs': ?regionSwitchPlanConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepRegionSwitchPlanConfig,
              Map<String, dynamic>
            >(regionSwitchPlanConfigs!, (value) => value.toMap()),
      'route53HealthCheckConfigs': ?route53HealthCheckConfigs == null
          ? null
          : pulumi.Input.encodeList<
              PlanWorkflowStepRoute53HealthCheckConfig,
              Map<String, dynamic>
            >(route53HealthCheckConfigs!, (value) => value.toMap()),
    };
  }
  ...
  factory PlanWorkflowStep.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStep(
      ...
      ec2AsgCapacityIncreaseConfigs:
          map['ec2AsgCapacityIncreaseConfigs'] == null
          ? null
          : pulumi
