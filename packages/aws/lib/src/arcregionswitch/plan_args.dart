...
class PlanArgs {
  ...
  factory PlanArgs.fromMap(Map<String, dynamic> map) {
    return PlanArgs(
      associatedAlarms: map['associatedAlarms'] == null ? null : pulumi.Input.decodeList<PlanAssociatedAlarm>(map['associatedAlarms'], (value) => PlanAssociatedAlarm.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      executionRole: map['executionRole'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      primaryRegion: map['primaryRegion'] == null ? null : map['primaryRegion'] as String,
      recoveryApproach: map['recoveryApproach'] as String,
      recoveryTimeObjectiveMinutes: map['recoveryTimeObjectiveMinutes'] == null ? null : map['recoveryTimeObjectiveMinutes'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      regions: (map['regions'] as List).cast<String>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : PlanTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      triggers: map['triggers'] == null ? null : pulumi.Input.decodeList<PlanTrigger>(map['triggers'], (value) => PlanTrigger.fromMap((value as Map).cast<String, dynamic>())),
      workflows: map['workflows'] == null ? null : pulumi.Input.decodeList<PlanWorkflow>(map['workflows'], (value) => PlanWorkflow.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
