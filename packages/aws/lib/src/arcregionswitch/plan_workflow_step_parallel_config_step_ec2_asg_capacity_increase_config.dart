  ...
  factory PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfig.fromMap(
    ...
    return PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfig(
      asgs: map['asgs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['asgs'],
              (value) =>
                  PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigAsg.fromMap(
      ...
      ungraceful: map['ungraceful'] == null
          ? null
          : PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigUngraceful.fromMap(
