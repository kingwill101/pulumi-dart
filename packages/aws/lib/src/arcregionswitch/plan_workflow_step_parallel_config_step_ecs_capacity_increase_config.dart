  ...
  factory PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfig.fromMap(
    ...
    return PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfig(
      ...
      services: map['services'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['services'],
              (value) =>
                  PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigService.fromMap(
      ...
      ungraceful: map['ungraceful'] == null
          ? null
          : PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigUngraceful.fromMap(
