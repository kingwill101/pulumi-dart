...
class CanarySchedule {
  ...
  factory CanarySchedule.fromMap(Map<String, dynamic> map) {
    return CanarySchedule(
      durationInSeconds: map['durationInSeconds'] == null ? null : map['durationInSeconds'] as int,
      expression: map['expression'] as String,
      retryConfig: map['retryConfig'] == null ? null : CanaryScheduleRetryConfig.fromMap((map['retryConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
