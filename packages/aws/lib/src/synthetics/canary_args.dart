...
class CanaryArgs {
  ...
  CanaryArgs({
    ...
    String? zipFile,
       ...
       failureRetentionPeriod = pulumi.Input.asOptionalInput<int>(
       ...
       successRetentionPeriod = pulumi.Input.asOptionalInput<int>(
  ...
  factory CanaryArgs.fromMap(Map<String, dynamic> map) {
    return CanaryArgs(
      ...
      deleteLambda: map['deleteLambda'] == null
          ? null
          : map['deleteLambda'] as bool,
      ...
      startCanary: map['startCanary'] == null
          ? null
          : map['startCanary'] as bool,
