...
class CanaryArgs {
  ...
  CanaryArgs({
    CanaryArtifactConfig? artifactConfig,
    ...
    String? name,
    String? region,
    CanaryRunConfig? runConfig,
    required String runtimeVersion,
    String? s3Bucket,
    String? s3Key,
    String? s3Version,
    required CanarySchedule schedule,
    bool? startCanary,
    int? successRetentionPeriod,
    Map<String, String>? tags,
    CanaryVpcConfig? vpcConfig,
    String? zipFile,
  }) :
  ...
  factory CanaryArgs.fromMap(Map<String, dynamic> map) {
    return CanaryArgs(
      artifactConfig: map['artifactConfig'] == null ? null : CanaryArtifactConfig.fromMap((map['artifactConfig'] as Map).cast<String, dynamic>()),
      artifactS3Location: map['artifactS3Location'] as String,
      deleteLambda: map['deleteLambda'] == null ? null : map['deleteLambda'] as bool,
      executionRoleArn: map['executionRoleArn'] as String,
      failureRetentionPeriod: map['failureRetentionPeriod'] == null ? null : map['failureRetentionPeriod'] as int,
      handler: map['handler'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      runConfig: map['runConfig'] == null ? null : CanaryRunConfig.fromMap((map['runConfig'] as Map).cast<String, dynamic>()),
      runtimeVersion: map['runtimeVersion'] as String,
      s3Bucket: map['s3Bucket'] == null ? null : map['s3Bucket'] as String,
      s3Key: map['s3Key'] == null ? null : map['s3Key'] as String,
      s3Version: map['s3Version'] == null ? null : map['s3Version'] as String,
      schedule: CanarySchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
      startCanary: map['startCanary'] == null ? null : map['startCanary'] as bool,
      successRetentionPeriod: map['successRetentionPeriod'] == null ? null : map['successRetentionPeriod'] as int,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      vpcConfig: map['vpcConfig'] == null ? null : CanaryVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
