...
class CanaryArgs {
  ...
  CanaryArgs({
    ...
    String? zipFile,
            ...
            pulumi.Input.asOptionalInput<CanaryArtifactConfig>(artifactConfig),
        ...
        failureRetentionPeriod =
            pulumi.Input.asOptionalInput<int>(failureRetentionPeriod),
        ...
        successRetentionPeriod =
            pulumi.Input.asOptionalInput<int>(successRetentionPeriod),
  ...
  factory CanaryArgs.fromMap(Map<String, dynamic> map) {
    return CanaryArgs(
      artifactConfig: map['artifactConfig'] == null
          ? null
          : CanaryArtifactConfig.fromMap(
              (map['artifactConfig'] as Map).cast<String, dynamic>()),
      artifactS3Location: map['artifactS3Location'] as String,
      deleteLambda:
          map['deleteLambda'] == null ? null : map['deleteLambda'] as bool,
      executionRoleArn: map['executionRoleArn'] as String,
      failureRetentionPeriod: map['failureRetentionPeriod'] == null
          ? null
          : map['failureRetentionPeriod'] as int,
      handler: map['handler'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      runConfig: map['runConfig'] == null
          ? null
          : CanaryRunConfig.fromMap(
              (map['runConfig'] as Map).cast<String, dynamic>()),
      ...
      schedule: CanarySchedule.fromMap(
          (map['schedule'] as Map).cast<String, dynamic>()),
      startCanary:
          map['startCanary'] == null ? null : map['startCanary'] as bool,
      successRetentionPeriod: map['successRetentionPeriod'] == null
          ? null
          : map['successRetentionPeriod'] as int,
      tags: map['tags'] == null
          ? null
