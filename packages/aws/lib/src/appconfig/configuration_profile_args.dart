...
class ConfigurationProfileArgs {
  ...
  ConfigurationProfileArgs({
    ...
    List<ConfigurationProfileValidator>? validators,
       ...
       retrievalRoleArn = pulumi.Input.asOptionalInput<String>(
         retrievalRoleArn,
       ),
    ...
    return <String, dynamic>{
      ...
      'validators':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigurationProfileValidator>,
  ...
  factory ConfigurationProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationProfileArgs(
      ...
      retrievalRoleArn: map['retrievalRoleArn'] == null
          ? null
          : map['retrievalRoleArn'] as String,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      type: map['type'] == null ? null : map['type'] as String,
      validators: map['validators'] == null
          ? null
          : pulumi.Input.decodeList<ConfigurationProfileValidator>(
              map['validators'],
              (value) => ConfigurationProfileValidator.fromMap(
