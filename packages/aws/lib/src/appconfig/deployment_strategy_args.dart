...
class DeploymentStrategyArgs {
  ...
  DeploymentStrategyArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asInput<int>(deploymentDurationInMinutes),
        description = pulumi.Input.asOptionalInput<String>(description),
        finalBakeTimeInMinutes =
            pulumi.Input.asOptionalInput<int>(finalBakeTimeInMinutes),
  ...
  factory DeploymentStrategyArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentStrategyArgs(
      ...
      growthType:
          map['growthType'] == null ? null : map['growthType'] as String,
