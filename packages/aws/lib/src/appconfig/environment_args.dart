...
class EnvironmentArgs {
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      monitors: map['monitors'] == null ? null : pulumi.Input.decodeList<EnvironmentMonitor>(map['monitors'], (value) => EnvironmentMonitor.fromMap((value as Map).cast<String, dynamic>())),
