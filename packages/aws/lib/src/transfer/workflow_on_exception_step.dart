...
class WorkflowOnExceptionStep {
  ...
  factory WorkflowOnExceptionStep.fromMap(Map<String, dynamic> map) {
    return WorkflowOnExceptionStep(
      copyStepDetails: map['copyStepDetails'] == null ? null : WorkflowOnExceptionStepCopyStepDetails.fromMap((map['copyStepDetails'] as Map).cast<String, dynamic>()),
      customStepDetails: map['customStepDetails'] == null ? null : WorkflowOnExceptionStepCustomStepDetails.fromMap((map['customStepDetails'] as Map).cast<String, dynamic>()),
      decryptStepDetails: map['decryptStepDetails'] == null ? null : WorkflowOnExceptionStepDecryptStepDetails.fromMap((map['decryptStepDetails'] as Map).cast<String, dynamic>()),
      deleteStepDetails: map['deleteStepDetails'] == null ? null : WorkflowOnExceptionStepDeleteStepDetails.fromMap((map['deleteStepDetails'] as Map).cast<String, dynamic>()),
      tagStepDetails: map['tagStepDetails'] == null ? null : WorkflowOnExceptionStepTagStepDetails.fromMap((map['tagStepDetails'] as Map).cast<String, dynamic>()),
