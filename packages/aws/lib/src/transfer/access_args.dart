...
class AccessArgs {
    ...
    required String serverId,
        ...
        homeDirectoryMappings =
            pulumi.Input.asOptionalInput<List<AccessHomeDirectoryMapping>>(
                homeDirectoryMappings),
        homeDirectoryType =
            pulumi.Input.asOptionalInput<String>(homeDirectoryType),
        policy = pulumi.Input.asOptionalInput<String>(policy),
        posixProfile =
            pulumi.Input.asOptionalInput<AccessPosixProfile>(posixProfile),
  ...
  factory AccessArgs.fromMap(Map<String, dynamic> map) {
    return AccessArgs(
      ...
      homeDirectory:
          map['homeDirectory'] == null ? null : map['homeDirectory'] as String,
