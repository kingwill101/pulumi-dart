...
/// {@template pulumi_transfer_access_access_args_doc}
/// The set of arguments for Access.
/// {@endtemplate}
/// {@macro pulumi_transfer_access_access_args_doc}
class AccessArgs {
  ...
  AccessArgs({
    ...
    List<AccessHomeDirectoryMapping>? homeDirectoryMappings,
    String? homeDirectoryType,
    String? policy,
    AccessPosixProfile? posixProfile,
    String? region,
    String? role,
  ...
  factory AccessArgs.fromMap(Map<String, dynamic> map) {
    return AccessArgs(
      ...
      homeDirectoryMappings: map['homeDirectoryMappings'] == null ? null : pulumi.Input.decodeList<AccessHomeDirectoryMapping>(map['homeDirectoryMappings'], (value) => AccessHomeDirectoryMapping.fromMap((value as Map).cast<String, dynamic>())),
      homeDirectoryType: map['homeDirectoryType'] == null ? null : map['homeDirectoryType'] as String,
      policy: map['policy'] == null ? null : map['policy'] as String,
      posixProfile: map['posixProfile'] == null ? null : AccessPosixProfile.fromMap((map['posixProfile'] as Map).cast<String, dynamic>()),
