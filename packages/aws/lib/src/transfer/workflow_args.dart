...
class WorkflowArgs {
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      ...
      onExceptionSteps: map['onExceptionSteps'] == null ? null : pulumi.Input.decodeList<WorkflowOnExceptionStep>(map['onExceptionSteps'], (value) => WorkflowOnExceptionStep.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      steps: pulumi.Input.decodeList<WorkflowStep>(map['steps'], (value) => WorkflowStep.fromMap((value as Map).cast<String, dynamic>())),
