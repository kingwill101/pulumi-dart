...
class ConnectorArgs {
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      as2Config: map['as2Config'] == null ? null : ConnectorAs2Config.fromMap((map['as2Config'] as Map).cast<String, dynamic>()),
      egressConfig: map['egressConfig'] == null ? null : ConnectorEgressConfig.fromMap((map['egressConfig'] as Map).cast<String, dynamic>()),
      ...
      sftpConfig: map['sftpConfig'] == null ? null : ConnectorSftpConfig.fromMap((map['sftpConfig'] as Map).cast<String, dynamic>()),
