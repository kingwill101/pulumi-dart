...
class ConnectorArgs {
  ...
  ConnectorArgs({
    ...
    String? url,
       ...
       securityPolicyName = pulumi.Input.asOptionalInput<String>(
         securityPolicyName,
       ),
       sftpConfig = pulumi.Input.asOptionalInput<ConnectorSftpConfig>(
         sftpConfig,
       ),
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      loggingRole: map['loggingRole'] == null
          ? null
          : map['loggingRole'] as String,
