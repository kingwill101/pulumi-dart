...
class GetConnectorAs2Config {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['basicAuthSecretId'] = basicAuthSecretId;
    ...
    map['mdnSigningAlgorithm'] = mdnSigningAlgorithm;
    map['messageSubject'] = messageSubject;
    map['partnerProfileId'] = partnerProfileId;
    map['singingAlgorithm'] = singingAlgorithm;
    return map;
  }
