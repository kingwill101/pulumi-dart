...
class UserArgs {
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      ...
      homeDirectoryMappings: map['homeDirectoryMappings'] == null ? null : pulumi.Input.decodeList<UserHomeDirectoryMapping>(map['homeDirectoryMappings'], (value) => UserHomeDirectoryMapping.fromMap((value as Map).cast<String, dynamic>())),
      homeDirectoryType: map['homeDirectoryType'] == null ? null : map['homeDirectoryType'] as String,
      policy: map['policy'] == null ? null : map['policy'] as String,
      posixProfile: map['posixProfile'] == null ? null : UserPosixProfile.fromMap((map['posixProfile'] as Map).cast<String, dynamic>()),
