...
class Server extends pulumi.CustomResource {
  ...
  Server(
    ...
    this.endpointDetails = registerOutput<ServerEndpointDetails?>('endpointDetails');
    ...
    this.postAuthenticationLoginBanner = registerOutput<String?>('postAuthenticationLoginBanner');
    this.preAuthenticationLoginBanner = registerOutput<String?>('preAuthenticationLoginBanner');
    this.protocolDetails = registerOutput<ServerProtocolDetails>('protocolDetails');
    this.protocols = registerOutput<List<String>>('protocols');
    this.region = registerOutput<String>('region');
    this.s3StorageOptions = registerOutput<ServerS3StorageOptions>('s3StorageOptions');
    this.securityPolicyName = registerOutput<String?>('securityPolicyName');
    this.sftpAuthenticationMethods = registerOutput<String>('sftpAuthenticationMethods');
    this.structuredLogDestinations = registerOutput<List<String>?>('structuredLogDestinations');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.url = registerOutput<String?>('url');
    this.workflowDetails = registerOutput<ServerWorkflowDetails?>('workflowDetails');
  }
}
