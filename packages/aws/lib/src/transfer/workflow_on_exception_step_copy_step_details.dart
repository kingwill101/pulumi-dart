...
class WorkflowOnExceptionStepCopyStepDetails {
  ...
  final WorkflowOnExceptionStepCopyStepDetailsDestinationFileLocation? destinationFileLocation;
  ...
  factory WorkflowOnExceptionStepCopyStepDetails.fromMap(Map<String, dynamic> map) {
    return WorkflowOnExceptionStepCopyStepDetails(
      destinationFileLocation: map['destinationFileLocation'] == null ? null : WorkflowOnExceptionStepCopyStepDetailsDestinationFileLocation.fromMap((map['destinationFileLocation'] as Map).cast<String, dynamic>()),
