...
class ServerProtocolDetails {
  ...
  factory ServerProtocolDetails.fromMap(Map<String, dynamic> map) {
    return ServerProtocolDetails(
      as2Transports: map['as2Transports'] == null ? null : (map['as2Transports'] as List).cast<String>(),
      passiveIp: map['passiveIp'] == null ? null : map['passiveIp'] as String,
      setStatOption: map['setStatOption'] == null ? null : map['setStatOption'] as String,
      tlsSessionResumptionMode: map['tlsSessionResumptionMode'] == null ? null : map['tlsSessionResumptionMode'] as String,
    );
  }
}
