...
class WebAppArgs {
  ...
  factory WebAppArgs.fromMap(Map<String, dynamic> map) {
    return WebAppArgs(
      accessEndpoint: map['accessEndpoint'] == null ? null : map['accessEndpoint'] as String,
      endpointDetails: map['endpointDetails'] == null ? null : WebAppEndpointDetails.fromMap((map['endpointDetails'] as Map).cast<String, dynamic>()),
      identityProviderDetails: WebAppIdentityProviderDetails.fromMap((map['identityProviderDetails'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      webAppEndpointPolicy: map['webAppEndpointPolicy'] == null ? null : map['webAppEndpointPolicy'] as String,
      webAppUnits: map['webAppUnits'] == null ? null : pulumi.Input.decodeList<WebAppWebAppUnit>(map['webAppUnits'], (value) => WebAppWebAppUnit.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
