...
class RepositoryArgs {
  ...
  factory RepositoryArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryArgs(
      ...
      externalConnections: map['externalConnections'] == null ? null : RepositoryExternalConnections.fromMap((map['externalConnections'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      repository: map['repository'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upstreams: map['upstreams'] == null ? null : pulumi.Input.decodeList<RepositoryUpstream>(map['upstreams'], (value) => RepositoryUpstream.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
