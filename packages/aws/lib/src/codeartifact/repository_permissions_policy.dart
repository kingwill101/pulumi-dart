...
class RepositoryPermissionsPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RepositoryPermissionsPolicy]. {@macro pulumi_codeartifact_repository_permissions_policy_repository_permissions_policy_args_doc}
