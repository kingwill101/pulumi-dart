...
class GetServiceArgs {
  ...
  factory GetServiceArgs.fromMap(Map<String, dynamic> map) {
    return GetServiceArgs(
      ...
      reverseDnsName: map['reverseDnsName'] == null ? null : map['reverseDnsName'] as String,
      reverseDnsPrefix: map['reverseDnsPrefix'] == null ? null : map['reverseDnsPrefix'] as String,
