...
class ConnectPeer extends pulumi.CustomResource {
  ...
  ConnectPeer(
    ...
    this.bgpTransitGatewayAddresses = registerOutput<List<String>>('bgpTransitGatewayAddresses');
    ...
    this.transitGatewayAddress = registerOutput<String>('transitGatewayAddress');
