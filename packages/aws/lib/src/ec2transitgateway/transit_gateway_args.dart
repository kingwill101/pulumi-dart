...
class TransitGatewayArgs {
  ...
  factory TransitGatewayArgs.fromMap(Map<String, dynamic> map) {
    return TransitGatewayArgs(
      amazonSideAsn: map['amazonSideAsn'] == null ? null : map['amazonSideAsn'] as int,
      autoAcceptSharedAttachments: map['autoAcceptSharedAttachments'] == null ? null : map['autoAcceptSharedAttachments'] as String,
      defaultRouteTableAssociation: map['defaultRouteTableAssociation'] == null ? null : map['defaultRouteTableAssociation'] as String,
      defaultRouteTablePropagation: map['defaultRouteTablePropagation'] == null ? null : map['defaultRouteTablePropagation'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      dnsSupport: map['dnsSupport'] == null ? null : map['dnsSupport'] as String,
      encryptionSupport: map['encryptionSupport'] == null ? null : map['encryptionSupport'] as String,
      multicastSupport: map['multicastSupport'] == null ? null : map['multicastSupport'] as String,
      ...
      transitGatewayCidrBlocks: map['transitGatewayCidrBlocks'] == null ? null : (map['transitGatewayCidrBlocks'] as List).cast<String>(),
      vpnEcmpSupport: map['vpnEcmpSupport'] == null ? null : map['vpnEcmpSupport'] as String,
    );
  }
}
