...
class TransitGatewayArgs {
  ...
  TransitGatewayArgs({
    ...
    String? vpnEcmpSupport,
        ...
        autoAcceptSharedAttachments =
            pulumi.Input.asOptionalInput<String>(autoAcceptSharedAttachments),
        defaultRouteTableAssociation =
            pulumi.Input.asOptionalInput<String>(defaultRouteTableAssociation),
        defaultRouteTablePropagation =
            pulumi.Input.asOptionalInput<String>(defaultRouteTablePropagation),
        description = pulumi.Input.asOptionalInput<String>(description),
        dnsSupport = pulumi.Input.asOptionalInput<String>(dnsSupport),
        encryptionSupport =
            pulumi.Input.asOptionalInput<String>(encryptionSupport),
        multicastSupport =
            pulumi.Input.asOptionalInput<String>(multicastSupport),
  ...
  factory TransitGatewayArgs.fromMap(Map<String, dynamic> map) {
    return TransitGatewayArgs(
      amazonSideAsn:
          map['amazonSideAsn'] == null ? null : map['amazonSideAsn'] as int,
