...
class PeeringAttachmentArgs {
  ...
  factory PeeringAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return PeeringAttachmentArgs(
      options: map['options'] == null ? null : PeeringAttachmentOptions.fromMap((map['options'] as Map).cast<String, dynamic>()),
      peerAccountId: map['peerAccountId'] == null ? null : map['peerAccountId'] as String,
