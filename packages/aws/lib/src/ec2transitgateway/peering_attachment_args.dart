...
class PeeringAttachmentArgs {
  ...
  factory PeeringAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return PeeringAttachmentArgs(
      ...
      peerAccountId:
          map['peerAccountId'] == null ? null : map['peerAccountId'] as String,
