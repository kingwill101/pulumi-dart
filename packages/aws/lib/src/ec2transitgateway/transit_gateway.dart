...
class TransitGateway extends pulumi.CustomResource {
  ...
  TransitGateway(
    ...
    this.associationDefaultRouteTableId = registerOutput<String>(
      'associationDefaultRouteTableId',
    );
    this.autoAcceptSharedAttachments = registerOutput<String?>(
      'autoAcceptSharedAttachments',
    );
    this.defaultRouteTableAssociation = registerOutput<String?>(
      'defaultRouteTableAssociation',
    );
    this.defaultRouteTablePropagation = registerOutput<String?>(
    ...
    this.propagationDefaultRouteTableId = registerOutput<String>(
    ...
    this.transitGatewayCidrBlocks = registerOutput<List<String>?>(
