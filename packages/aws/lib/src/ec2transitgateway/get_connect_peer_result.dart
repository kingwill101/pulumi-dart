...
class GetConnectPeerResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['arn'] = arn;
    map['bgpAsn'] = bgpAsn;
    map['bgpPeerAddress'] = bgpPeerAddress;
    map['bgpTransitGatewayAddresses'] = bgpTransitGatewayAddresses;
    ...
    map['region'] = region;
    map['tags'] = tags;
    map['transitGatewayAddress'] = transitGatewayAddress;
    map['transitGatewayAttachmentId'] = transitGatewayAttachmentId;
    map['transitGatewayConnectPeerId'] = transitGatewayConnectPeerId;
    return map;
  }
