...
class MulticastDomainArgs {
  ...
  MulticastDomainArgs({
    ...
    required String transitGatewayId,
            ...
            pulumi.Input.asOptionalInput<String>(autoAcceptSharedAssociations),
        igmpv2Support = pulumi.Input.asOptionalInput<String>(igmpv2Support),
        region = pulumi.Input.asOptionalInput<String>(region),
        staticSourcesSupport =
            pulumi.Input.asOptionalInput<String>(staticSourcesSupport),
  ...
  factory MulticastDomainArgs.fromMap(Map<String, dynamic> map) {
    return MulticastDomainArgs(
      ...
      igmpv2Support:
          map['igmpv2Support'] == null ? null : map['igmpv2Support'] as String,
