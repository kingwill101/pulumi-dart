...
class MulticastDomainArgs {
  ...
  factory MulticastDomainArgs.fromMap(Map<String, dynamic> map) {
    return MulticastDomainArgs(
      autoAcceptSharedAssociations: map['autoAcceptSharedAssociations'] == null ? null : map['autoAcceptSharedAssociations'] as String,
      igmpv2Support: map['igmpv2Support'] == null ? null : map['igmpv2Support'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      staticSourcesSupport: map['staticSourcesSupport'] == null ? null : map['staticSourcesSupport'] as String,
