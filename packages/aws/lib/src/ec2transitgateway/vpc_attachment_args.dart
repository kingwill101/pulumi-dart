...
class VpcAttachmentArgs {
  ...
  VpcAttachmentArgs({
    ...
    required String vpcId,
            ...
            pulumi.Input.asOptionalInput<String>(applianceModeSupport),
  ...
  factory VpcAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return VpcAttachmentArgs(
      ...
      dnsSupport:
          map['dnsSupport'] == null ? null : map['dnsSupport'] as String,
      ipv6Support:
          map['ipv6Support'] == null ? null : map['ipv6Support'] as String,
