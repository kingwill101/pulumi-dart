...
class VpcAttachmentArgs {
  ...
  factory VpcAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return VpcAttachmentArgs(
      applianceModeSupport: map['applianceModeSupport'] == null ? null : map['applianceModeSupport'] as String,
      dnsSupport: map['dnsSupport'] == null ? null : map['dnsSupport'] as String,
      ipv6Support: map['ipv6Support'] == null ? null : map['ipv6Support'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      securityGroupReferencingSupport: map['securityGroupReferencingSupport'] == null ? null : map['securityGroupReferencingSupport'] as String,
