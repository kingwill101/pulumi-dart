...
class InstanceConnectEndpointArgs {
  ...
  factory InstanceConnectEndpointArgs.fromMap(Map<String, dynamic> map) {
    return InstanceConnectEndpointArgs(
      ...
      preserveClientIp: map['preserveClientIp'] == null ? null : map['preserveClientIp'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      securityGroupIds: map['securityGroupIds'] == null ? null : (map['securityGroupIds'] as List).cast<String>(),
      subnetId: map['subnetId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : InstanceConnectEndpointTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
