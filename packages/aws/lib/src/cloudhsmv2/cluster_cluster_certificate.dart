...
class ClusterClusterCertificate {
  ...
  Map<String, dynamic> toMap() {
    ...
    final awsHardwareCertificateValue = awsHardwareCertificate;
    if (awsHardwareCertificateValue != null) {
      map['awsHardwareCertificate'] = awsHardwareCertificateValue;
    }
    final clusterCertificateValue = clusterCertificate;
    if (clusterCertificateValue != null) {
      map['clusterCertificate'] = clusterCertificateValue;
    }
    final clusterCsrValue = clusterCsr;
    if (clusterCsrValue != null) {
      map['clusterCsr'] = clusterCsrValue;
    }
    final hsmCertificateValue = hsmCertificate;
    if (hsmCertificateValue != null) {
      map['hsmCertificate'] = hsmCertificateValue;
    }
    final manufacturerHardwareCertificateValue =
        manufacturerHardwareCertificate;
    if (manufacturerHardwareCertificateValue != null) {
      map['manufacturerHardwareCertificate'] =
          manufacturerHardwareCertificateValue;
    }
    return map;
  }
  ...
  factory ClusterClusterCertificate.fromMap(Map<String, dynamic> map) {
    return ClusterClusterCertificate(
      ...
      clusterCsr:
          map['clusterCsr'] == null ? null : map['clusterCsr'] as String,
