...
class UserPoolEmailConfiguration {
  ...
  factory UserPoolEmailConfiguration.fromMap(Map<String, dynamic> map) {
    return UserPoolEmailConfiguration(
      configurationSet: map['configurationSet'] == null ? null : map['configurationSet'] as String,
      emailSendingAccount: map['emailSendingAccount'] == null ? null : map['emailSendingAccount'] as String,
      fromEmailAddress: map['fromEmailAddress'] == null ? null : map['fromEmailAddress'] as String,
      replyToEmailAddress: map['replyToEmailAddress'] == null ? null : map['replyToEmailAddress'] as String,
