...
class User extends pulumi.CustomResource {
  ...
  User(String name, {UserArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.clientMetadata = registerOutput<Map<String, String>?>(
      'clientMetadata',
    );
    this.creationDate = registerOutput<String>('creationDate');
    this.desiredDeliveryMediums = registerOutput<List<String>?>(
    ...
    this.validationData = registerOutput<Map<String, String>?>(
      'validationData',
    );
  }
}
