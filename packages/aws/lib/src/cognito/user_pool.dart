...
class UserPool extends pulumi.CustomResource {
  ...
  UserPool(
    ...
    this.accountRecoverySetting = registerOutput<UserPoolAccountRecoverySetting?>('accountRecoverySetting');
    this.adminCreateUserConfig = registerOutput<UserPoolAdminCreateUserConfig>('adminCreateUserConfig');
    this.aliasAttributes = registerOutput<List<String>?>('aliasAttributes');
    this.arn = registerOutput<String>('arn');
    this.autoVerifiedAttributes = registerOutput<List<String>?>('autoVerifiedAttributes');
    ...
    this.deviceConfiguration = registerOutput<UserPoolDeviceConfiguration?>('deviceConfiguration');
    this.domain = registerOutput<String>('domain');
    this.emailConfiguration = registerOutput<UserPoolEmailConfiguration?>('emailConfiguration');
    this.emailMfaConfiguration = registerOutput<UserPoolEmailMfaConfiguration?>('emailMfaConfiguration');
    this.emailVerificationMessage = registerOutput<String>('emailVerificationMessage');
    this.emailVerificationSubject = registerOutput<String>('emailVerificationSubject');
    ...
    this.passwordPolicy = registerOutput<UserPoolPasswordPolicy>('passwordPolicy');
    ...
    this.smsAuthenticationMessage = registerOutput<String?>('smsAuthenticationMessage');
    this.smsConfiguration = registerOutput<UserPoolSmsConfiguration>('smsConfiguration');
    this.smsVerificationMessage = registerOutput<String>('smsVerificationMessage');
    this.softwareTokenMfaConfiguration = registerOutput<UserPoolSoftwareTokenMfaConfiguration?>('softwareTokenMfaConfiguration');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.userAttributeUpdateSettings = registerOutput<UserPoolUserAttributeUpdateSettings?>('userAttributeUpdateSettings');
    this.userPoolAddOns = registerOutput<UserPoolUserPoolAddOns?>('userPoolAddOns');
    this.userPoolTier = registerOutput<String>('userPoolTier');
    this.usernameAttributes = registerOutput<List<String>?>('usernameAttributes');
    this.usernameConfiguration = registerOutput<UserPoolUsernameConfiguration>('usernameConfiguration');
    this.verificationMessageTemplate = registerOutput<UserPoolVerificationMessageTemplate>('verificationMessageTemplate');
    this.webAuthnConfiguration = registerOutput<UserPoolWebAuthnConfiguration?>('webAuthnConfiguration');
  }
}
