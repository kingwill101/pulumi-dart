...
class UserPoolPasswordPolicy {
  ...
  Map<String, dynamic> toMap() {
    ...
    final minimumLengthValue = minimumLength;
    if (minimumLengthValue != null) {
      map['minimumLength'] = minimumLengthValue;
    }
    final passwordHistorySizeValue = passwordHistorySize;
    if (passwordHistorySizeValue != null) {
      map['passwordHistorySize'] = passwordHistorySizeValue;
    }
    final requireLowercaseValue = requireLowercase;
    if (requireLowercaseValue != null) {
      map['requireLowercase'] = requireLowercaseValue;
    }
    ...
    final requireUppercaseValue = requireUppercase;
    if (requireUppercaseValue != null) {
      map['requireUppercase'] = requireUppercaseValue;
    }
    final temporaryPasswordValidityDaysValue = temporaryPasswordValidityDays;
    if (temporaryPasswordValidityDaysValue != null) {
      map['temporaryPasswordValidityDays'] = temporaryPasswordValidityDaysValue;
    }
    return map;
  }
  ...
  factory UserPoolPasswordPolicy.fromMap(Map<String, dynamic> map) {
    return UserPoolPasswordPolicy(
      minimumLength:
          map['minimumLength'] == null ? null : map['minimumLength'] as int,
