...
class GetIdentityPoolResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'arn': arn,
      'cognitoIdentityProviders': pulumi.Input.encodeList<GetIdentityPoolCognitoIdentityProvider, Map<String, dynamic>>(cognitoIdentityProviders, (value) => value.toMap()),
  ...
  factory GetIdentityPoolResult.fromMap(Map<String, dynamic> map) {
    return GetIdentityPoolResult(
      ...
      openidConnectProviderArns: (map['openidConnectProviderArns'] as List).cast<String>(),
      region: map['region'] as String,
      samlProviderArns: (map['samlProviderArns'] as List).cast<String>(),
      supportedLoginProviders: (map['supportedLoginProviders'] as Map).cast<String, String>(),
