...
class IdentityPoolRoleAttachmentRoleMapping {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mappingRules': ?mappingRules == null ? null : pulumi.Input.encodeList<IdentityPoolRoleAttachmentRoleMappingMappingRule, Map<String, dynamic>>(mappingRules!, (value) => value.toMap()),
      'type': type,
    };
  }
  ...
  factory IdentityPoolRoleAttachmentRoleMapping.fromMap(Map<String, dynamic> map) {
    return IdentityPoolRoleAttachmentRoleMapping(
      ambiguousRoleResolution: map['ambiguousRoleResolution'] == null ? null : map['ambiguousRoleResolution'] as String,
      identityProvider: map['identityProvider'] as String,
      mappingRules: map['mappingRules'] == null ? null : pulumi.Input.decodeList<IdentityPoolRoleAttachmentRoleMappingMappingRule>(map['mappingRules'], (value) => IdentityPoolRoleAttachmentRoleMappingMappingRule.fromMap((value as Map).cast<String, dynamic>())),
