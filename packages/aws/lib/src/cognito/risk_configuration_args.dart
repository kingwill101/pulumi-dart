...
class RiskConfigurationArgs {
  ...
  RiskConfigurationArgs({
    RiskConfigurationAccountTakeoverRiskConfiguration? accountTakeoverRiskConfiguration,
    String? clientId,
    RiskConfigurationCompromisedCredentialsRiskConfiguration? compromisedCredentialsRiskConfiguration,
    String? region,
  ...
  factory RiskConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RiskConfigurationArgs(
      accountTakeoverRiskConfiguration: map['accountTakeoverRiskConfiguration'] == null ? null : RiskConfigurationAccountTakeoverRiskConfiguration.fromMap((map['accountTakeoverRiskConfiguration'] as Map).cast<String, dynamic>()),
      clientId: map['clientId'] == null ? null : map['clientId'] as String,
      compromisedCredentialsRiskConfiguration: map['compromisedCredentialsRiskConfiguration'] == null ? null : RiskConfigurationCompromisedCredentialsRiskConfiguration.fromMap((map['compromisedCredentialsRiskConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      riskExceptionConfiguration: map['riskExceptionConfiguration'] == null ? null : RiskConfigurationRiskExceptionConfiguration.fromMap((map['riskExceptionConfiguration'] as Map).cast<String, dynamic>()),
