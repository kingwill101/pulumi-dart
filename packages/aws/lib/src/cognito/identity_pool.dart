...
class IdentityPool extends pulumi.CustomResource {
  ...
  IdentityPool(
    ...
    this.allowUnauthenticatedIdentities = registerOutput<bool?>('allowUnauthenticatedIdentities');
    this.arn = registerOutput<String>('arn');
    this.cognitoIdentityProviders = registerOutput<List<IdentityPoolCognitoIdentityProvider>?>('cognitoIdentityProviders');
    this.developerProviderName = registerOutput<String?>('developerProviderName');
    this.identityPoolName = registerOutput<String>('identityPoolName');
    this.openidConnectProviderArns = registerOutput<List<String>?>('openidConnectProviderArns');
    this.region = registerOutput<String>('region');
    this.samlProviderArns = registerOutput<List<String>?>('samlProviderArns');
    this.supportedLoginProviders = registerOutput<Map<String, String>?>('supportedLoginProviders');
