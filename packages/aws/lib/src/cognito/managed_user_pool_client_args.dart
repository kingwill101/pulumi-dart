...
class ManagedUserPoolClientArgs {
  ...
  factory ManagedUserPoolClientArgs.fromMap(Map<String, dynamic> map) {
    return ManagedUserPoolClientArgs(
      ...
      analyticsConfiguration: map['analyticsConfiguration'] == null ? null : ManagedUserPoolClientAnalyticsConfiguration.fromMap((map['analyticsConfiguration'] as Map).cast<String, dynamic>()),
      ...
      namePattern: map['namePattern'] == null ? null : map['namePattern'] as String,
      ...
      refreshTokenRotation: map['refreshTokenRotation'] == null ? null : ManagedUserPoolClientRefreshTokenRotation.fromMap((map['refreshTokenRotation'] as Map).cast<String, dynamic>()),
      ...
      tokenValidityUnits: map['tokenValidityUnits'] == null ? null : ManagedUserPoolClientTokenValidityUnits.fromMap((map['tokenValidityUnits'] as Map).cast<String, dynamic>()),
