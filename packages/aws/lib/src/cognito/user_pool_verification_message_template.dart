...
class UserPoolVerificationMessageTemplate {
  ...
  factory UserPoolVerificationMessageTemplate.fromMap(Map<String, dynamic> map) {
    return UserPoolVerificationMessageTemplate(
      defaultEmailOption: map['defaultEmailOption'] == null ? null : map['defaultEmailOption'] as String,
      emailMessage: map['emailMessage'] == null ? null : map['emailMessage'] as String,
      emailMessageByLink: map['emailMessageByLink'] == null ? null : map['emailMessageByLink'] as String,
      emailSubject: map['emailSubject'] == null ? null : map['emailSubject'] as String,
      emailSubjectByLink: map['emailSubjectByLink'] == null ? null : map['emailSubjectByLink'] as String,
