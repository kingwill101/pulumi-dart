...
class RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration {
  ...
  final RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmail?
      blockEmail;
  ...
  final RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationMfaEmail?
      mfaEmail;

  /// The email template used when a detected risk event is allowed. See notify email type below.
  final RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmail?
      noActionEmail;
  ...
  Map<String, dynamic> toMap() {
    ...
    final blockEmailValue = blockEmail;
    if (blockEmailValue != null) {
      map['blockEmail'] = blockEmailValue.toMap();
    }
    final fromValue = from;
    if (fromValue != null) {
      map['from'] = fromValue;
    }
    final mfaEmailValue = mfaEmail;
    if (mfaEmailValue != null) {
      map['mfaEmail'] = mfaEmailValue.toMap();
    }
    final noActionEmailValue = noActionEmail;
    if (noActionEmailValue != null) {
      map['noActionEmail'] = noActionEmailValue.toMap();
    }
    final replyToValue = replyTo;
    if (replyToValue != null) {
      map['replyTo'] = replyToValue;
    }
