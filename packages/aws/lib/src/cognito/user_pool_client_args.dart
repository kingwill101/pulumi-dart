...
/// {@template pulumi_cognito_user_pool_client_user_pool_client_args_doc}
/// The set of arguments for UserPoolClient.
/// {@endtemplate}
/// {@macro pulumi_cognito_user_pool_client_user_pool_client_args_doc}
class UserPoolClientArgs {
  ...
  /// Creates a new [UserPoolClientArgs].
  ...
  UserPoolClientArgs({
    ...
    UserPoolClientAnalyticsConfiguration? analyticsConfiguration,
    ...
    UserPoolClientRefreshTokenRotation? refreshTokenRotation,
    int? refreshTokenValidity,
    String? region,
    List<String>? supportedIdentityProviders,
    UserPoolClientTokenValidityUnits? tokenValidityUnits,
  ...
  factory UserPoolClientArgs.fromMap(Map<String, dynamic> map) {
    return UserPoolClientArgs(
      accessTokenValidity: map['accessTokenValidity'] == null ? null : map['accessTokenValidity'] as int,
      allowedOauthFlows: map['allowedOauthFlows'] == null ? null : (map['allowedOauthFlows'] as List).cast<String>(),
      allowedOauthFlowsUserPoolClient: map['allowedOauthFlowsUserPoolClient'] == null ? null : map['allowedOauthFlowsUserPoolClient'] as bool,
      allowedOauthScopes: map['allowedOauthScopes'] == null ? null : (map['allowedOauthScopes'] as List).cast<String>(),
      analyticsConfiguration: map['analyticsConfiguration'] == null ? null : UserPoolClientAnalyticsConfiguration.fromMap((map['analyticsConfiguration'] as Map).cast<String, dynamic>()),
      authSessionValidity: map['authSessionValidity'] == null ? null : map['authSessionValidity'] as int,
      callbackUrls: map['callbackUrls'] == null ? null : (map['callbackUrls'] as List).cast<String>(),
      defaultRedirectUri: map['defaultRedirectUri'] == null ? null : map['defaultRedirectUri'] as String,
      enablePropagateAdditionalUserContextData: map['enablePropagateAdditionalUserContextData'] == null ? null : map['enablePropagateAdditionalUserContextData'] as bool,
      enableTokenRevocation: map['enableTokenRevocation'] == null ? null : map['enableTokenRevocation'] as bool,
      explicitAuthFlows: map['explicitAuthFlows'] == null ? null : (map['explicitAuthFlows'] as List).cast<String>(),
      generateSecret: map['generateSecret'] == null ? null : map['generateSecret'] as bool,
      idTokenValidity: map['idTokenValidity'] == null ? null : map['idTokenValidity'] as int,
      logoutUrls: map['logoutUrls'] == null ? null : (map['logoutUrls'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      preventUserExistenceErrors: map['preventUserExistenceErrors'] == null ? null : map['preventUserExistenceErrors'] as String,
      readAttributes: map['readAttributes'] == null ? null : (map['readAttributes'] as List).cast<String>(),
      refreshTokenRotation: map['refreshTokenRotation'] == null ? null : UserPoolClientRefreshTokenRotation.fromMap((map['refreshTokenRotation'] as Map).cast<String, dynamic>()),
      refreshTokenValidity: map['refreshTokenValidity'] == null ? null : map['refreshTokenValidity'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      supportedIdentityProviders: map['supportedIdentityProviders'] == null ? null : (map['supportedIdentityProviders'] as List).cast<String>(),
      tokenValidityUnits: map['tokenValidityUnits'] == null ? null : UserPoolClientTokenValidityUnits.fromMap((map['tokenValidityUnits'] as Map).cast<String, dynamic>()),
      userPoolId: map['userPoolId'] as String,
      writeAttributes: map['writeAttributes'] == null ? null : (map['writeAttributes'] as List).cast<String>(),
    );
  }
}
