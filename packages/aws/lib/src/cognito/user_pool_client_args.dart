...
class UserPoolClientArgs {
  ...
  UserPoolClientArgs({
    ...
    List<String>? writeAttributes,
  }) : accessTokenValidity = pulumi.Input.asOptionalInput<int>(
         accessTokenValidity,
       ),
       allowedOauthFlows = pulumi.Input.asOptionalInput<List<String>>(
         allowedOauthFlows,
       ),
       allowedOauthFlowsUserPoolClient = pulumi.Input.asOptionalInput<bool>(
         allowedOauthFlowsUserPoolClient,
       ),
       allowedOauthScopes = pulumi.Input.asOptionalInput<List<String>>(
         allowedOauthScopes,
       ),
       analyticsConfiguration =
       ...
       authSessionValidity = pulumi.Input.asOptionalInput<int>(
         authSessionValidity,
       ),
       callbackUrls = pulumi.Input.asOptionalInput<List<String>>(callbackUrls),
       defaultRedirectUri = pulumi.Input.asOptionalInput<String>(
         defaultRedirectUri,
       ),
       ...
       enableTokenRevocation = pulumi.Input.asOptionalInput<bool>(
         enableTokenRevocation,
       ),
       explicitAuthFlows = pulumi.Input.asOptionalInput<List<String>>(
         explicitAuthFlows,
       ),
       ...
       readAttributes = pulumi.Input.asOptionalInput<List<String>>(
         readAttributes,
       ),
       ...
       refreshTokenValidity = pulumi.Input.asOptionalInput<int>(
       ...
       writeAttributes = pulumi.Input.asOptionalInput<List<String>>(
         writeAttributes,
       );
  ...
  factory UserPoolClientArgs.fromMap(Map<String, dynamic> map) {
    return UserPoolClientArgs(
      ...
      generateSecret: map['generateSecret'] == null
          ? null
          : map['generateSecret'] as bool,
      idTokenValidity: map['idTokenValidity'] == null
          ? null
          : map['idTokenValidity'] as int,
