...
class UserPoolArgs {
  ...
  factory UserPoolArgs.fromMap(Map<String, dynamic> map) {
    return UserPoolArgs(
      accountRecoverySetting: map['accountRecoverySetting'] == null ? null : UserPoolAccountRecoverySetting.fromMap((map['accountRecoverySetting'] as Map).cast<String, dynamic>()),
      adminCreateUserConfig: map['adminCreateUserConfig'] == null ? null : UserPoolAdminCreateUserConfig.fromMap((map['adminCreateUserConfig'] as Map).cast<String, dynamic>()),
      aliasAttributes: map['aliasAttributes'] == null ? null : (map['aliasAttributes'] as List).cast<String>(),
      autoVerifiedAttributes: map['autoVerifiedAttributes'] == null ? null : (map['autoVerifiedAttributes'] as List).cast<String>(),
      deletionProtection: map['deletionProtection'] == null ? null : map['deletionProtection'] as String,
      deviceConfiguration: map['deviceConfiguration'] == null ? null : UserPoolDeviceConfiguration.fromMap((map['deviceConfiguration'] as Map).cast<String, dynamic>()),
      emailConfiguration: map['emailConfiguration'] == null ? null : UserPoolEmailConfiguration.fromMap((map['emailConfiguration'] as Map).cast<String, dynamic>()),
      emailMfaConfiguration: map['emailMfaConfiguration'] == null ? null : UserPoolEmailMfaConfiguration.fromMap((map['emailMfaConfiguration'] as Map).cast<String, dynamic>()),
      emailVerificationMessage: map['emailVerificationMessage'] == null ? null : map['emailVerificationMessage'] as String,
      emailVerificationSubject: map['emailVerificationSubject'] == null ? null : map['emailVerificationSubject'] as String,
      lambdaConfig: map['lambdaConfig'] == null ? null : UserPoolLambdaConfig.fromMap((map['lambdaConfig'] as Map).cast<String, dynamic>()),
      mfaConfiguration: map['mfaConfiguration'] == null ? null : map['mfaConfiguration'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      passwordPolicy: map['passwordPolicy'] == null ? null : UserPoolPasswordPolicy.fromMap((map['passwordPolicy'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      schemas: map['schemas'] == null ? null : pulumi.Input.decodeList<UserPoolSchema>(map['schemas'], (value) => UserPoolSchema.fromMap((value as Map).cast<String, dynamic>())),
      signInPolicy: map['signInPolicy'] == null ? null : UserPoolSignInPolicy.fromMap((map['signInPolicy'] as Map).cast<String, dynamic>()),
      smsAuthenticationMessage: map['smsAuthenticationMessage'] == null ? null : map['smsAuthenticationMessage'] as String,
      smsConfiguration: map['smsConfiguration'] == null ? null : UserPoolSmsConfiguration.fromMap((map['smsConfiguration'] as Map).cast<String, dynamic>()),
      smsVerificationMessage: map['smsVerificationMessage'] == null ? null : map['smsVerificationMessage'] as String,
      softwareTokenMfaConfiguration: map['softwareTokenMfaConfiguration'] == null ? null : UserPoolSoftwareTokenMfaConfiguration.fromMap((map['softwareTokenMfaConfiguration'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userAttributeUpdateSettings: map['userAttributeUpdateSettings'] == null ? null : UserPoolUserAttributeUpdateSettings.fromMap((map['userAttributeUpdateSettings'] as Map).cast<String, dynamic>()),
      userPoolAddOns: map['userPoolAddOns'] == null ? null : UserPoolUserPoolAddOns.fromMap((map['userPoolAddOns'] as Map).cast<String, dynamic>()),
      userPoolTier: map['userPoolTier'] == null ? null : map['userPoolTier'] as String,
      usernameAttributes: map['usernameAttributes'] == null ? null : (map['usernameAttributes'] as List).cast<String>(),
      usernameConfiguration: map['usernameConfiguration'] == null ? null : UserPoolUsernameConfiguration.fromMap((map['usernameConfiguration'] as Map).cast<String, dynamic>()),
      verificationMessageTemplate: map['verificationMessageTemplate'] == null ? null : UserPoolVerificationMessageTemplate.fromMap((map['verificationMessageTemplate'] as Map).cast<String, dynamic>()),
      webAuthnConfiguration: map['webAuthnConfiguration'] == null ? null : UserPoolWebAuthnConfiguration.fromMap((map['webAuthnConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
