...
class UserPoolArgs {
  ...
  UserPoolArgs({
    ...
    UserPoolWebAuthnConfiguration? webAuthnConfiguration,
       ...
       aliasAttributes = pulumi.Input.asOptionalInput<List<String>>(
         aliasAttributes,
       ),
       ...
       emailVerificationMessage = pulumi.Input.asOptionalInput<String>(
         emailVerificationMessage,
       ),
       emailVerificationSubject = pulumi.Input.asOptionalInput<String>(
         emailVerificationSubject,
       ),
       lambdaConfig = pulumi.Input.asOptionalInput<UserPoolLambdaConfig>(
         lambdaConfig,
       ),
       mfaConfiguration = pulumi.Input.asOptionalInput<String>(
         mfaConfiguration,
       ),
       ...
       smsAuthenticationMessage = pulumi.Input.asOptionalInput<String>(
         smsAuthenticationMessage,
       ),
       smsConfiguration = pulumi
           .Input.asOptionalInput<UserPoolSmsConfiguration>(smsConfiguration),
       smsVerificationMessage = pulumi.Input.asOptionalInput<String>(
       ...
       usernameAttributes = pulumi.Input.asOptionalInput<List<String>>(
         usernameAttributes,
       ),
  ...
  factory UserPoolArgs.fromMap(Map<String, dynamic> map) {
    return UserPoolArgs(
      ...
      userPoolTier: map['userPoolTier'] == null
          ? null
          : map['userPoolTier'] as String,
