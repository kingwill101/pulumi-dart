...
class UserArgs {
  ...
  UserArgs({
    ...
    Map<String, String>? validationData,
       ...
       forceAliasCreation = pulumi.Input.asOptionalInput<bool>(
         forceAliasCreation,
       ),
       messageAction = pulumi.Input.asOptionalInput<String>(messageAction),
       password = pulumi.Input.asOptionalInput<String>(password),
       region = pulumi.Input.asOptionalInput<String>(region),
       temporaryPassword = pulumi.Input.asOptionalInput<String>(
         temporaryPassword,
       ),
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      ...
      messageAction: map['messageAction'] == null
          ? null
          : map['messageAction'] as String,
