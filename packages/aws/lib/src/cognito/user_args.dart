...
class UserArgs {
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      ...
      clientMetadata: map['clientMetadata'] == null ? null : (map['clientMetadata'] as Map).cast<String, String>(),
      desiredDeliveryMediums: map['desiredDeliveryMediums'] == null ? null : (map['desiredDeliveryMediums'] as List).cast<String>(),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      forceAliasCreation: map['forceAliasCreation'] == null ? null : map['forceAliasCreation'] as bool,
      messageAction: map['messageAction'] == null ? null : map['messageAction'] as String,
      password: map['password'] == null ? null : map['password'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      temporaryPassword: map['temporaryPassword'] == null ? null : map['temporaryPassword'] as String,
      userPoolId: map['userPoolId'] as String,
      username: map['username'] as String,
      validationData: map['validationData'] == null ? null : (map['validationData'] as Map).cast<String, String>(),
    );
  }
}
