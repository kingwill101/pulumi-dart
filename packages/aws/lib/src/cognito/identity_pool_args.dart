  ...
  IdentityPoolArgs({
    ...
    Map<String, String>? tags,
        ...
        allowUnauthenticatedIdentities =
            pulumi.Input.asOptionalInput<bool>(allowUnauthenticatedIdentities),
        cognitoIdentityProviders = pulumi.Input.asOptionalInput<
                List<IdentityPoolCognitoIdentityProvider>>(
            cognitoIdentityProviders),
        developerProviderName =
            pulumi.Input.asOptionalInput<String>(developerProviderName),
        ...
        samlProviderArns =
            pulumi.Input.asOptionalInput<List<String>>(samlProviderArns),
