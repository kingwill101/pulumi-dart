...
class IdentityPoolArgs {
  ...
  factory IdentityPoolArgs.fromMap(Map<String, dynamic> map) {
    return IdentityPoolArgs(
      allowClassicFlow: map['allowClassicFlow'] == null ? null : map['allowClassicFlow'] as bool,
      allowUnauthenticatedIdentities: map['allowUnauthenticatedIdentities'] == null ? null : map['allowUnauthenticatedIdentities'] as bool,
      cognitoIdentityProviders: map['cognitoIdentityProviders'] == null ? null : pulumi.Input.decodeList<IdentityPoolCognitoIdentityProvider>(map['cognitoIdentityProviders'], (value) => IdentityPoolCognitoIdentityProvider.fromMap((value as Map).cast<String, dynamic>())),
      developerProviderName: map['developerProviderName'] == null ? null : map['developerProviderName'] as String,
      identityPoolName: map['identityPoolName'] as String,
      openidConnectProviderArns: map['openidConnectProviderArns'] == null ? null : (map['openidConnectProviderArns'] as List).cast<String>(),
      region: map['region'] == null ? null : map['region'] as String,
      samlProviderArns: map['samlProviderArns'] == null ? null : (map['samlProviderArns'] as List).cast<String>(),
      supportedLoginProviders: map['supportedLoginProviders'] == null ? null : (map['supportedLoginProviders'] as Map).cast<String, String>(),
