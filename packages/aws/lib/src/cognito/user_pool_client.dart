...
class UserPoolClient extends pulumi.CustomResource {
  ...
  UserPoolClient(
    ...
    this.analyticsConfiguration = registerOutput<UserPoolClientAnalyticsConfiguration?>('analyticsConfiguration');
    ...
    this.refreshTokenRotation = registerOutput<UserPoolClientRefreshTokenRotation?>('refreshTokenRotation');
    ...
    this.tokenValidityUnits = registerOutput<UserPoolClientTokenValidityUnits?>('tokenValidityUnits');
