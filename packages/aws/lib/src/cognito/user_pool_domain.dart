...
class UserPoolDomain extends pulumi.CustomResource {
  ...
  UserPoolDomain(
    ...
    this.cloudfrontDistribution = registerOutput<String>(
      'cloudfrontDistribution',
    );
    this.cloudfrontDistributionArn = registerOutput<String>(
      'cloudfrontDistributionArn',
    );
    this.cloudfrontDistributionZoneId = registerOutput<String>(
