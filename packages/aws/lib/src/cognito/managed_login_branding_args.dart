...
class ManagedLoginBrandingArgs {
  ...
  factory ManagedLoginBrandingArgs.fromMap(Map<String, dynamic> map) {
    return ManagedLoginBrandingArgs(
      assets: map['assets'] == null ? null : pulumi.Input.decodeList<ManagedLoginBrandingAsset>(map['assets'], (value) => ManagedLoginBrandingAsset.fromMap((value as Map).cast<String, dynamic>())),
      clientId: map['clientId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      settings: map['settings'] == null ? null : map['settings'] as String,
      useCognitoProvidedValues: map['useCognitoProvidedValues'] == null ? null : map['useCognitoProvidedValues'] as bool,
