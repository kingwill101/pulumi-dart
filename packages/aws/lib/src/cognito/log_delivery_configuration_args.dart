...
class LogDeliveryConfigurationArgs {
  ...
  LogDeliveryConfigurationArgs({
    required List<LogDeliveryConfigurationLogConfiguration> logConfigurations,
    String? region,
  ...
  factory LogDeliveryConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return LogDeliveryConfigurationArgs(
      logConfigurations: pulumi.Input.decodeList<LogDeliveryConfigurationLogConfiguration>(map['logConfigurations'], (value) => LogDeliveryConfigurationLogConfiguration.fromMap((value as Map).cast<String, dynamic>())),
