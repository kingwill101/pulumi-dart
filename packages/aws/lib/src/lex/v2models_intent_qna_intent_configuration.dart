...
class V2modelsIntentQnaIntentConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bedrockModelConfiguration': ?bedrockModelConfiguration == null
          ? null
          : bedrockModelConfiguration!.toMap(),
      'dataSourceConfiguration': ?dataSourceConfiguration == null
          ? null
          : dataSourceConfiguration!.toMap(),
    };
  }
    ...
    return V2modelsIntentQnaIntentConfiguration(
      bedrockModelConfiguration: map['bedrockModelConfiguration'] == null
          ...
          : V2modelsIntentQnaIntentConfigurationBedrockModelConfiguration.fromMap(
              (map['bedrockModelConfiguration'] as Map).cast<String, dynamic>(),
            ),
