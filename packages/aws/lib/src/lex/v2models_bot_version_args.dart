...
class V2modelsBotVersionArgs {
  ...
  V2modelsBotVersionArgs({
    ...
    String? botVersion,
    String? description,
    required Map<String, V2modelsBotVersionLocaleSpecification> localeSpecification,
    String? region,
    V2modelsBotVersionTimeouts? timeouts,
  }) :
      botId = pulumi.Input.asInput<String>(botId),
      botVersion = pulumi.Input.asOptionalInput<String>(botVersion),
      description = pulumi.Input.asOptionalInput<String>(description),
      localeSpecification = pulumi.Input.asInput<Map<String, V2modelsBotVersionLocaleSpecification>>(localeSpecification),
  ...
  factory V2modelsBotVersionArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsBotVersionArgs(
      ...
      botVersion: map['botVersion'] == null ? null : map['botVersion'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      localeSpecification: pulumi.Input.decodeMapValues<V2modelsBotVersionLocaleSpecification>(map['localeSpecification'], (value) => V2modelsBotVersionLocaleSpecification.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      timeouts: map['timeouts'] == null ? null : V2modelsBotVersionTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
