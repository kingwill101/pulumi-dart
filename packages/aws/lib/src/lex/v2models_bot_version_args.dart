...
class V2modelsBotVersionArgs {
  ...
  V2modelsBotVersionArgs({
    ...
    String? botVersion,
    String? description,
    required Map<String, V2modelsBotVersionLocaleSpecification>
        localeSpecification,
    String? region,
    V2modelsBotVersionTimeouts? timeouts,
        ...
        localeSpecification = pulumi.Input.asInput<
                Map<String, V2modelsBotVersionLocaleSpecification>>(
            localeSpecification),
        region = pulumi.Input.asOptionalInput<String>(region),
        timeouts =
            pulumi.Input.asOptionalInput<V2modelsBotVersionTimeouts>(timeouts);
  ...
  Map<String, dynamic> toMap() {
    ...
    map['localeSpecification'] = pulumi.Input.mapInputValue<
            Map<String, V2modelsBotVersionLocaleSpecification>,
  ...
  factory V2modelsBotVersionArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsBotVersionArgs(
      ...
      botVersion:
          map['botVersion'] == null ? null : map['botVersion'] as String,
      description:
