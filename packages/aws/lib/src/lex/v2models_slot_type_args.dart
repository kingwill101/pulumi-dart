...
class V2modelsSlotTypeArgs {
  ...
  factory V2modelsSlotTypeArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotTypeArgs(
      ...
      compositeSlotTypeSettings: map['compositeSlotTypeSettings'] == null ? null : pulumi.Input.decodeList<V2modelsSlotTypeCompositeSlotTypeSetting>(map['compositeSlotTypeSettings'], (value) => V2modelsSlotTypeCompositeSlotTypeSetting.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      externalSourceSettings: map['externalSourceSettings'] == null ? null : pulumi.Input.decodeList<V2modelsSlotTypeExternalSourceSetting>(map['externalSourceSettings'], (value) => V2modelsSlotTypeExternalSourceSetting.fromMap((value as Map).cast<String, dynamic>())),
      localeId: map['localeId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parentSlotTypeSignature: map['parentSlotTypeSignature'] == null ? null : map['parentSlotTypeSignature'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      slotTypeValues: map['slotTypeValues'] == null ? null : pulumi.Input.decodeList<V2modelsSlotTypeSlotTypeValue>(map['slotTypeValues'], (value) => V2modelsSlotTypeSlotTypeValue.fromMap((value as Map).cast<String, dynamic>())),
      timeouts: map['timeouts'] == null ? null : V2modelsSlotTypeTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      valueSelectionSetting: map['valueSelectionSetting'] == null ? null : V2modelsSlotTypeValueSelectionSetting.fromMap((map['valueSelectionSetting'] as Map).cast<String, dynamic>()),
    );
  }
}
