...
class V2modelsSlotTypeArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (compositeSlotTypeSettingsValue != null) {
      map['compositeSlotTypeSettings'] = pulumi.Input.mapOptionalInputValue<
              List<V2modelsSlotTypeCompositeSlotTypeSetting>,
    ...
    if (externalSourceSettingsValue != null) {
      map['externalSourceSettings'] = pulumi.Input.mapOptionalInputValue<
              List<V2modelsSlotTypeExternalSourceSetting>,
              List<Map<String, dynamic>>>(
    ...
    if (slotTypeValuesValue != null) {
      map['slotTypeValues'] = pulumi.Input.mapOptionalInputValue<
              List<V2modelsSlotTypeSlotTypeValue>, List<Map<String, dynamic>>>(
          slotTypeValuesValue,
          (value) => pulumi.Input.encodeList<V2modelsSlotTypeSlotTypeValue,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (valueSelectionSettingValue != null) {
      map['valueSelectionSetting'] = pulumi.Input.mapOptionalInputValue<
