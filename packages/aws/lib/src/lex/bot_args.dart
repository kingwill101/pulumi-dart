...
class BotArgs {
  ...
  BotArgs({
    ...
    String? voiceId,
            ...
            pulumi.Input.asInput<BotAbortStatement>(abortStatement),
        childDirected = pulumi.Input.asInput<bool>(childDirected),
        clarificationPrompt =
            pulumi.Input.asOptionalInput<BotClarificationPrompt>(
                clarificationPrompt),
        ...
        enableModelImprovements =
            pulumi.Input.asOptionalInput<bool>(enableModelImprovements),
        ...
        nluIntentConfidenceThreshold =
            pulumi.Input.asOptionalInput<double>(nluIntentConfidenceThreshold),
  ...
  factory BotArgs.fromMap(Map<String, dynamic> map) {
    return BotArgs(
      abortStatement: BotAbortStatement.fromMap(
          (map['abortStatement'] as Map).cast<String, dynamic>()),
      childDirected: map['childDirected'] as bool,
      clarificationPrompt: map['clarificationPrompt'] == null
          ? null
          : BotClarificationPrompt.fromMap(
              (map['clarificationPrompt'] as Map).cast<String, dynamic>()),
      createVersion:
          map['createVersion'] == null ? null : map['createVersion'] as bool,
      description:
          map['description'] == null ? null : map['description'] as String,
      detectSentiment: map['detectSentiment'] == null
          ? null
          : map['detectSentiment'] as bool,
      enableModelImprovements: map['enableModelImprovements'] == null
          ? null
          : map['enableModelImprovements'] as bool,
      idleSessionTtlInSeconds: map['idleSessionTtlInSeconds'] == null
          ? null
          : map['idleSessionTtlInSeconds'] as int,
      intents: pulumi.Input.decodeList<BotIntent>(map['intents'],
          (value) => BotIntent.fromMap((value as Map).cast<String, dynamic>())),
      locale: map['locale'] == null ? null : map['locale'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nluIntentConfidenceThreshold: map['nluIntentConfidenceThreshold'] == null
          ? null
          : map['nluIntentConfidenceThreshold'] as double,
      processBehavior: map['processBehavior'] == null
          ? null
          : map['processBehavior'] as String,
