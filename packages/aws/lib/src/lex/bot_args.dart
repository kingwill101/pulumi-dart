...
class BotArgs {
  ...
  BotArgs({
    ...
    String? voiceId,
       ...
       clarificationPrompt = pulumi
           .Input.asOptionalInput<BotClarificationPrompt>(clarificationPrompt),
       ...
       enableModelImprovements = pulumi.Input.asOptionalInput<bool>(
         enableModelImprovements,
       ),
       idleSessionTtlInSeconds = pulumi.Input.asOptionalInput<int>(
  ...
  factory BotArgs.fromMap(Map<String, dynamic> map) {
    return BotArgs(
      ...
      intents: pulumi.Input.decodeList<BotIntent>(
        map['intents'],
