      ...
      conditionalBranches: map['conditionalBranches'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  V2modelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationFailureConditionalConditionalBranch.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      defaultBranch: map['defaultBranch'] == null
          ? null
          : V2modelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationFailureConditionalDefaultBranch.fromMap(
