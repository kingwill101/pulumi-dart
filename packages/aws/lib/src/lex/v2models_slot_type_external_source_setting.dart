...
class V2modelsSlotTypeExternalSourceSetting {
  ...
  V2modelsSlotTypeExternalSourceSetting({this.grammarSlotTypeSettings});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'grammarSlotTypeSettings': ?grammarSlotTypeSettings == null
          ? null
          : pulumi.Input.encodeList<
              V2modelsSlotTypeExternalSourceSettingGrammarSlotTypeSetting,
              Map<String, dynamic>
            >(grammarSlotTypeSettings!, (value) => value.toMap()),
    };
  }
      ...
      grammarSlotTypeSettings: map['grammarSlotTypeSettings'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  V2modelsSlotTypeExternalSourceSettingGrammarSlotTypeSetting.fromMap(
