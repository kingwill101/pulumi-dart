...
class V2modelsIntent extends pulumi.CustomResource {
  ...
  V2modelsIntent(
    ...
    this.closingSetting = registerOutput<V2modelsIntentClosingSetting?>(
      'closingSetting',
    );
    ...
    this.dialogCodeHook = registerOutput<V2modelsIntentDialogCodeHook?>(
      'dialogCodeHook',
    );
    ...
    this.inputContexts = registerOutput<List<V2modelsIntentInputContext>?>(
      'inputContexts',
    );
    ...
    this.outputContexts = registerOutput<List<V2modelsIntentOutputContext>?>(
      'outputContexts',
    );
    ...
    this.slotPriorities = registerOutput<List<V2modelsIntentSlotPriority>?>(
      'slotPriorities',
    );
