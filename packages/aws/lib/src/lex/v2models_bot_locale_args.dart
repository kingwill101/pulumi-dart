...
class V2modelsBotLocaleArgs {
  ...
  V2modelsBotLocaleArgs({
    ...
    V2modelsBotLocaleVoiceSettings? voiceSettings,
        ...
        nLuIntentConfidenceThreshold =
            pulumi.Input.asInput<double>(nLuIntentConfidenceThreshold),
        name = pulumi.Input.asOptionalInput<String>(name),
        region = pulumi.Input.asOptionalInput<String>(region),
        timeouts =
            pulumi.Input.asOptionalInput<V2modelsBotLocaleTimeouts>(timeouts),
        voiceSettings =
  ...
  factory V2modelsBotLocaleArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsBotLocaleArgs(
      ...
      voiceSettings: map['voiceSettings'] == null
          ? null
          : V2modelsBotLocaleVoiceSettings.fromMap(
              (map['voiceSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
