  ...
  factory V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroup.fromMap(
    ...
    return V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroup(
      message: map['message'] == null
          ? null
          : V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupMessage.fromMap(
      ...
      variations: map['variations'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['variations'],
              (value) =>
                  V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariation.fromMap(
