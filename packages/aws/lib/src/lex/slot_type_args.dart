...
class SlotTypeArgs {
  ...
  factory SlotTypeArgs.fromMap(Map<String, dynamic> map) {
    return SlotTypeArgs(
      ...
      enumerationValues: pulumi.Input.decodeList<SlotTypeEnumerationValue>(map['enumerationValues'], (value) => SlotTypeEnumerationValue.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      valueSelectionStrategy: map['valueSelectionStrategy'] == null ? null : map['valueSelectionStrategy'] as String,
    );
  }
}
