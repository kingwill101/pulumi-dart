...
class V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchResponse {
  ...
  factory V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchResponse.fromMap(
      ...
      messageGroups: map['messageGroups'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['messageGroups'],
              (value) =>
                  V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchResponseMessageGroup.fromMap(
