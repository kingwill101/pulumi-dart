...
class V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecification {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'promptAttemptsSpecifications': ?promptAttemptsSpecifications == null
          ? null
          : pulumi.Input.encodeList<
              V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecificationPromptAttemptsSpecification,
              Map<String, dynamic>
            >(promptAttemptsSpecifications!, (value) => value.toMap()),
    };
  }
      ...
      messageGroups: map['messageGroups'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['messageGroups'],
              (value) =>
                  V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecificationMessageGroup.fromMap(
      ...
      promptAttemptsSpecifications: map['promptAttemptsSpecifications'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecificationPromptAttemptsSpecification.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
    );
