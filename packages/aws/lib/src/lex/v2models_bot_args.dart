...
class V2modelsBotArgs {
  ...
  V2modelsBotArgs({
    ...
    String? type,
            ...
            pulumi.Input.asInput<List<V2modelsBotDataPrivacy>>(dataPrivacies),
        description = pulumi.Input.asOptionalInput<String>(description),
        idleSessionTtlInSeconds =
            pulumi.Input.asInput<int>(idleSessionTtlInSeconds),
        members =
            pulumi.Input.asOptionalInput<List<V2modelsBotMember>>(members),
        name = pulumi.Input.asOptionalInput<String>(name),
        region = pulumi.Input.asOptionalInput<String>(region),
        roleArn = pulumi.Input.asInput<String>(roleArn),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        testBotAliasTags =
            pulumi.Input.asOptionalInput<Map<String, String>>(testBotAliasTags),
  ...
  factory V2modelsBotArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsBotArgs(
      dataPrivacies: pulumi.Input.decodeList<V2modelsBotDataPrivacy>(
          map['dataPrivacies'],
      ...
      testBotAliasTags: map['testBotAliasTags'] == null
          ? null
          : (map['testBotAliasTags'] as Map).cast<String, String>(),
