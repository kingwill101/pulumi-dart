...
class V2modelsIntentClosingSettingConditional {
  ...
  final List<V2modelsIntentClosingSettingConditionalConditionalBranch>? conditionalBranches;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'active': active,
      'conditionalBranches': ?conditionalBranches == null ? null : pulumi.Input.encodeList<V2modelsIntentClosingSettingConditionalConditionalBranch, Map<String, dynamic>>(conditionalBranches!, (value) => value.toMap()),
  ...
  factory V2modelsIntentClosingSettingConditional.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingConditional(
      ...
      conditionalBranches: map['conditionalBranches'] == null ? null : pulumi.Input.decodeList<V2modelsIntentClosingSettingConditionalConditionalBranch>(map['conditionalBranches'], (value) => V2modelsIntentClosingSettingConditionalConditionalBranch.fromMap((value as Map).cast<String, dynamic>())),
      defaultBranch: map['defaultBranch'] == null ? null : V2modelsIntentClosingSettingConditionalDefaultBranch.fromMap((map['defaultBranch'] as Map).cast<String, dynamic>()),
    );
  }
}
