...
class V2modelsBotTimeouts {
  ...
  /// Creates a new [V2modelsBotTimeouts].
  ...
  V2modelsBotTimeouts({this.create, this.delete, this.update});
  ...
  factory V2modelsBotTimeouts.fromMap(Map<String, dynamic> map) {
    return V2modelsBotTimeouts(
