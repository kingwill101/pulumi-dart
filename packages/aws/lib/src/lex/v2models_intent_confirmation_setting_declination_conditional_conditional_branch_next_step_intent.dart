...
class V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepIntent {
  ...
  factory V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepIntent.fromMap(
      ...
      slots: map['slots'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['slots'],
              (value) =>
                  V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepIntentSlot.fromMap(
