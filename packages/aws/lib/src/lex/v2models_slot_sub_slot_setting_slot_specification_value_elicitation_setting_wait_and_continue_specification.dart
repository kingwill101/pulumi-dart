...
class V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecification {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'active': ?active,
      'continueResponses': ?continueResponses == null
          ? null
          : pulumi.Input.encodeList<
              V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationContinueResponse,
              Map<String, dynamic>
            >(continueResponses!, (value) => value.toMap()),
      'stillWaitingResponses': ?stillWaitingResponses == null
          ? null
          : pulumi.Input.encodeList<
              V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationStillWaitingResponse,
              Map<String, dynamic>
            >(stillWaitingResponses!, (value) => value.toMap()),
      'waitingResponses': ?waitingResponses == null
          ? null
          : pulumi.Input.encodeList<
              V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationWaitingResponse,
              Map<String, dynamic>
            >(waitingResponses!, (value) => value.toMap()),
    };
  }
      ...
      continueResponses: map['continueResponses'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationContinueResponse.fromMap(
      ...
      stillWaitingResponses: map['stillWaitingResponses'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationStillWaitingResponse.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      waitingResponses: map['waitingResponses'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationWaitingResponse.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
    );
