...
class V2modelsIntentArgs {
  ...
  factory V2modelsIntentArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentArgs(
      ...
      closingSetting: map['closingSetting'] == null ? null : V2modelsIntentClosingSetting.fromMap((map['closingSetting'] as Map).cast<String, dynamic>()),
      confirmationSetting: map['confirmationSetting'] == null ? null : V2modelsIntentConfirmationSetting.fromMap((map['confirmationSetting'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      dialogCodeHook: map['dialogCodeHook'] == null ? null : V2modelsIntentDialogCodeHook.fromMap((map['dialogCodeHook'] as Map).cast<String, dynamic>()),
      fulfillmentCodeHook: map['fulfillmentCodeHook'] == null ? null : V2modelsIntentFulfillmentCodeHook.fromMap((map['fulfillmentCodeHook'] as Map).cast<String, dynamic>()),
      initialResponseSetting: map['initialResponseSetting'] == null ? null : V2modelsIntentInitialResponseSetting.fromMap((map['initialResponseSetting'] as Map).cast<String, dynamic>()),
      inputContexts: map['inputContexts'] == null ? null : pulumi.Input.decodeList<V2modelsIntentInputContext>(map['inputContexts'], (value) => V2modelsIntentInputContext.fromMap((value as Map).cast<String, dynamic>())),
      kendraConfiguration: map['kendraConfiguration'] == null ? null : V2modelsIntentKendraConfiguration.fromMap((map['kendraConfiguration'] as Map).cast<String, dynamic>()),
      localeId: map['localeId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      outputContexts: map['outputContexts'] == null ? null : pulumi.Input.decodeList<V2modelsIntentOutputContext>(map['outputContexts'], (value) => V2modelsIntentOutputContext.fromMap((value as Map).cast<String, dynamic>())),
      parentIntentSignature: map['parentIntentSignature'] == null ? null : map['parentIntentSignature'] as String,
      qnaIntentConfiguration: map['qnaIntentConfiguration'] == null ? null : V2modelsIntentQnaIntentConfiguration.fromMap((map['qnaIntentConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      sampleUtterances: map['sampleUtterances'] == null ? null : pulumi.Input.decodeList<V2modelsIntentSampleUtterance>(map['sampleUtterances'], (value) => V2modelsIntentSampleUtterance.fromMap((value as Map).cast<String, dynamic>())),
      slotPriorities: map['slotPriorities'] == null ? null : pulumi.Input.decodeList<V2modelsIntentSlotPriority>(map['slotPriorities'], (value) => V2modelsIntentSlotPriority.fromMap((value as Map).cast<String, dynamic>())),
      timeouts: map['timeouts'] == null ? null : V2modelsIntentTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
