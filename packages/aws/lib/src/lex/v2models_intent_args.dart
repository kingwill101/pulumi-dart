...
class V2modelsIntentArgs {
  ...
  V2modelsIntentArgs({
    ...
    V2modelsIntentTimeouts? timeouts,
        ...
        closingSetting =
            pulumi.Input.asOptionalInput<V2modelsIntentClosingSetting>(
                closingSetting),
        confirmationSetting =
        ...
        dialogCodeHook =
            pulumi.Input.asOptionalInput<V2modelsIntentDialogCodeHook>(
                dialogCodeHook),
        fulfillmentCodeHook =
        ...
        parentIntentSignature =
            pulumi.Input.asOptionalInput<String>(parentIntentSignature),
        qnaIntentConfiguration =
        ...
        slotPriorities =
            pulumi.Input.asOptionalInput<List<V2modelsIntentSlotPriority>>(
                slotPriorities),
        timeouts =
            pulumi.Input.asOptionalInput<V2modelsIntentTimeouts>(timeouts);
  ...
  Map<String, dynamic> toMap() {
    ...
    if (closingSettingValue != null) {
      map['closingSetting'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (confirmationSettingValue != null) {
      map['confirmationSetting'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (fulfillmentCodeHookValue != null) {
      map['fulfillmentCodeHook'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (initialResponseSettingValue != null) {
      map['initialResponseSetting'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (inputContextsValue != null) {
      map['inputContexts'] = pulumi.Input.mapOptionalInputValue<
              List<V2modelsIntentInputContext>, List<Map<String, dynamic>>>(
          inputContextsValue,
          (value) => pulumi.Input.encodeList<V2modelsIntentInputContext,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final kendraConfigurationValue = kendraConfiguration;
    if (kendraConfigurationValue != null) {
      map['kendraConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (outputContextsValue != null) {
      map['outputContexts'] = pulumi.Input.mapOptionalInputValue<
          ...
          outputContextsValue,
          (value) => pulumi.Input.encodeList<V2modelsIntentOutputContext,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (qnaIntentConfigurationValue != null) {
      map['qnaIntentConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (sampleUtterancesValue != null) {
      map['sampleUtterances'] = pulumi.Input.mapOptionalInputValue<
              List<V2modelsIntentSampleUtterance>, List<Map<String, dynamic>>>(
          sampleUtterancesValue,
          (value) => pulumi.Input.encodeList<V2modelsIntentSampleUtterance,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final slotPrioritiesValue = slotPriorities;
    if (slotPrioritiesValue != null) {
      map['slotPriorities'] = pulumi.Input.mapOptionalInputValue<
              List<V2modelsIntentSlotPriority>, List<Map<String, dynamic>>>(
          slotPrioritiesValue,
          (value) => pulumi.Input.encodeList<V2modelsIntentSlotPriority,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
