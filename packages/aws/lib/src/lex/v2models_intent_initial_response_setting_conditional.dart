...
class V2modelsIntentInitialResponseSettingConditional {
  ...
  final List<V2modelsIntentInitialResponseSettingConditionalConditionalBranch>? conditionalBranches;
  ...
  final V2modelsIntentInitialResponseSettingConditionalDefaultBranch? defaultBranch;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'active': active,
      'conditionalBranches': ?conditionalBranches == null ? null : pulumi.Input.encodeList<V2modelsIntentInitialResponseSettingConditionalConditionalBranch, Map<String, dynamic>>(conditionalBranches!, (value) => value.toMap()),
  ...
  factory V2modelsIntentInitialResponseSettingConditional.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentInitialResponseSettingConditional(
      ...
      conditionalBranches: map['conditionalBranches'] == null ? null : pulumi.Input.decodeList<V2modelsIntentInitialResponseSettingConditionalConditionalBranch>(map['conditionalBranches'], (value) => V2modelsIntentInitialResponseSettingConditionalConditionalBranch.fromMap((value as Map).cast<String, dynamic>())),
      defaultBranch: map['defaultBranch'] == null ? null : V2modelsIntentInitialResponseSettingConditionalDefaultBranch.fromMap((map['defaultBranch'] as Map).cast<String, dynamic>()),
    );
  }
}
