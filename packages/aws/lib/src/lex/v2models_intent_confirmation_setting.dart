...
class V2modelsIntentConfirmationSetting {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'confirmationConditional': ?confirmationConditional == null
          ? null
          : confirmationConditional!.toMap(),
      'confirmationNextStep': ?confirmationNextStep == null
          ? null
          : confirmationNextStep!.toMap(),
      'confirmationResponse': ?confirmationResponse == null
          ? null
          : confirmationResponse!.toMap(),
      'declinationConditional': ?declinationConditional == null
          ? null
          : declinationConditional!.toMap(),
      'declinationNextStep': ?declinationNextStep == null
          ? null
          : declinationNextStep!.toMap(),
      'declinationResponse': ?declinationResponse == null
          ? null
          : declinationResponse!.toMap(),
      'elicitationCodeHook': ?elicitationCodeHook == null
          ? null
          : elicitationCodeHook!.toMap(),
