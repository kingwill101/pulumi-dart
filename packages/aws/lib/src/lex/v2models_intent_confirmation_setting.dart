...
class V2modelsIntentConfirmationSetting {
  ...
  final V2modelsIntentConfirmationSettingConfirmationConditional? confirmationConditional;
  ...
  final V2modelsIntentConfirmationSettingConfirmationNextStep? confirmationNextStep;
  /// Configuration block for message groups that Amazon Lex uses to respond the user input. See `confirmation_response`.
  final V2modelsIntentConfirmationSettingConfirmationResponse? confirmationResponse;
  /// Configuration block for conditional branches to evaluate after the intent is declined. See `declination_conditional`.
  final V2modelsIntentConfirmationSettingDeclinationConditional? declinationConditional;
  ...
  final V2modelsIntentConfirmationSettingDeclinationNextStep? declinationNextStep;
  ...
  final V2modelsIntentConfirmationSettingDeclinationResponse? declinationResponse;
  /// Configuration block for when the code hook is invoked during confirmation prompt retries. See `elicitation_code_hook`.
  final V2modelsIntentConfirmationSettingElicitationCodeHook? elicitationCodeHook;
  ...
  final V2modelsIntentConfirmationSettingPromptSpecification? promptSpecification;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'confirmationConditional': ?confirmationConditional == null ? null : confirmationConditional!.toMap(),
      'confirmationNextStep': ?confirmationNextStep == null ? null : confirmationNextStep!.toMap(),
      'confirmationResponse': ?confirmationResponse == null ? null : confirmationResponse!.toMap(),
      'declinationConditional': ?declinationConditional == null ? null : declinationConditional!.toMap(),
      'declinationNextStep': ?declinationNextStep == null ? null : declinationNextStep!.toMap(),
      'declinationResponse': ?declinationResponse == null ? null : declinationResponse!.toMap(),
      'elicitationCodeHook': ?elicitationCodeHook == null ? null : elicitationCodeHook!.toMap(),
  ...
  factory V2modelsIntentConfirmationSetting.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSetting(
      ...
      codeHook: map['codeHook'] == null ? null : V2modelsIntentConfirmationSettingCodeHook.fromMap((map['codeHook'] as Map).cast<String, dynamic>()),
      confirmationConditional: map['confirmationConditional'] == null ? null : V2modelsIntentConfirmationSettingConfirmationConditional.fromMap((map['confirmationConditional'] as Map).cast<String, dynamic>()),
      confirmationNextStep: map['confirmationNextStep'] == null ? null : V2modelsIntentConfirmationSettingConfirmationNextStep.fromMap((map['confirmationNextStep'] as Map).cast<String, dynamic>()),
      confirmationResponse: map['confirmationResponse'] == null ? null : V2modelsIntentConfirmationSettingConfirmationResponse.fromMap((map['confirmationResponse'] as Map).cast<String, dynamic>()),
      declinationConditional: map['declinationConditional'] == null ? null : V2modelsIntentConfirmationSettingDeclinationConditional.fromMap((map['declinationConditional'] as Map).cast<String, dynamic>()),
      declinationNextStep: map['declinationNextStep'] == null ? null : V2modelsIntentConfirmationSettingDeclinationNextStep.fromMap((map['declinationNextStep'] as Map).cast<String, dynamic>()),
      declinationResponse: map['declinationResponse'] == null ? null : V2modelsIntentConfirmationSettingDeclinationResponse.fromMap((map['declinationResponse'] as Map).cast<String, dynamic>()),
      elicitationCodeHook: map['elicitationCodeHook'] == null ? null : V2modelsIntentConfirmationSettingElicitationCodeHook.fromMap((map['elicitationCodeHook'] as Map).cast<String, dynamic>()),
      failureConditional: map['failureConditional'] == null ? null : V2modelsIntentConfirmationSettingFailureConditional.fromMap((map['failureConditional'] as Map).cast<String, dynamic>()),
      failureNextStep: map['failureNextStep'] == null ? null : V2modelsIntentConfirmationSettingFailureNextStep.fromMap((map['failureNextStep'] as Map).cast<String, dynamic>()),
      failureResponse: map['failureResponse'] == null ? null : V2modelsIntentConfirmationSettingFailureResponse.fromMap((map['failureResponse'] as Map).cast<String, dynamic>()),
      promptSpecification: map['promptSpecification'] == null ? null : V2modelsIntentConfirmationSettingPromptSpecification.fromMap((map['promptSpecification'] as Map).cast<String, dynamic>()),
    );
  }
}
