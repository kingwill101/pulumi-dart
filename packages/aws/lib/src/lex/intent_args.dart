...
class IntentArgs {
  ...
  IntentArgs({
    ...
    List<IntentSlot>? slots,
       ...
       confirmationPrompt = pulumi
           .Input.asOptionalInput<IntentConfirmationPrompt>(confirmationPrompt),
       ...
       rejectionStatement = pulumi
           .Input.asOptionalInput<IntentRejectionStatement>(rejectionStatement),
       sampleUtterances = pulumi.Input.asOptionalInput<List<String>>(
         sampleUtterances,
       ),
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      conclusionStatement: map['conclusionStatement'] == null
          ? null
          : IntentConclusionStatement.fromMap(
              (map['conclusionStatement'] as Map).cast<String, dynamic>(),
            ),
      confirmationPrompt: map['confirmationPrompt'] == null
          ? null
          : IntentConfirmationPrompt.fromMap(
              (map['confirmationPrompt'] as Map).cast<String, dynamic>(),
            ),
      createVersion: map['createVersion'] == null
          ? null
          : map['createVersion'] as bool,
      ...
      followUpPrompt: map['followUpPrompt'] == null
          ? null
          : IntentFollowUpPrompt.fromMap(
              (map['followUpPrompt'] as Map).cast<String, dynamic>(),
            ),
      fulfillmentActivity: IntentFulfillmentActivity.fromMap(
      ...
      rejectionStatement: map['rejectionStatement'] == null
          ? null
      ...
      sampleUtterances: map['sampleUtterances'] == null
          ? null
          : (map['sampleUtterances'] as List).cast<String>(),
