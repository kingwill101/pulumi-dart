...
class IntentArgs {
  ...
  IntentArgs({
    ...
    List<IntentSlot>? slots,
        ...
        dialogCodeHook =
            pulumi.Input.asOptionalInput<IntentDialogCodeHook>(dialogCodeHook),
        followUpPrompt =
            pulumi.Input.asOptionalInput<IntentFollowUpPrompt>(followUpPrompt),
        ...
        rejectionStatement =
            pulumi.Input.asOptionalInput<IntentRejectionStatement>(
                rejectionStatement),
        sampleUtterances =
            pulumi.Input.asOptionalInput<List<String>>(sampleUtterances),
