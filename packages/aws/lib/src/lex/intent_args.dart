...
class IntentArgs {
  ...
  IntentArgs({
    IntentConclusionStatement? conclusionStatement,
    IntentConfirmationPrompt? confirmationPrompt,
    bool? createVersion,
    String? description,
    IntentDialogCodeHook? dialogCodeHook,
    IntentFollowUpPrompt? followUpPrompt,
    required IntentFulfillmentActivity fulfillmentActivity,
    String? name,
    String? parentIntentSignature,
    String? region,
    IntentRejectionStatement? rejectionStatement,
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      conclusionStatement: map['conclusionStatement'] == null ? null : IntentConclusionStatement.fromMap((map['conclusionStatement'] as Map).cast<String, dynamic>()),
      confirmationPrompt: map['confirmationPrompt'] == null ? null : IntentConfirmationPrompt.fromMap((map['confirmationPrompt'] as Map).cast<String, dynamic>()),
      createVersion: map['createVersion'] == null ? null : map['createVersion'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      dialogCodeHook: map['dialogCodeHook'] == null ? null : IntentDialogCodeHook.fromMap((map['dialogCodeHook'] as Map).cast<String, dynamic>()),
      followUpPrompt: map['followUpPrompt'] == null ? null : IntentFollowUpPrompt.fromMap((map['followUpPrompt'] as Map).cast<String, dynamic>()),
      fulfillmentActivity: IntentFulfillmentActivity.fromMap((map['fulfillmentActivity'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      parentIntentSignature: map['parentIntentSignature'] == null ? null : map['parentIntentSignature'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      rejectionStatement: map['rejectionStatement'] == null ? null : IntentRejectionStatement.fromMap((map['rejectionStatement'] as Map).cast<String, dynamic>()),
      sampleUtterances: map['sampleUtterances'] == null ? null : (map['sampleUtterances'] as List).cast<String>(),
      slots: map['slots'] == null ? null : pulumi.Input.decodeList<IntentSlot>(map['slots'], (value) => IntentSlot.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
