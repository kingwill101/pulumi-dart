...
class IntentFollowUpPromptPrompt {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'messages': pulumi.Input.encodeList<IntentFollowUpPromptPromptMessage, Map<String, dynamic>>(messages, (value) => value.toMap()),
  ...
  factory IntentFollowUpPromptPrompt.fromMap(Map<String, dynamic> map) {
    return IntentFollowUpPromptPrompt(
      ...
      messages: pulumi.Input.decodeList<IntentFollowUpPromptPromptMessage>(map['messages'], (value) => IntentFollowUpPromptPromptMessage.fromMap((value as Map).cast<String, dynamic>())),
