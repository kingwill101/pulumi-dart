  ...
  factory V2modelsIntentInitialResponseSettingInitialResponseMessageGroup.fromMap(
    ...
    return V2modelsIntentInitialResponseSettingInitialResponseMessageGroup(
      message: map['message'] == null
          ? null
          : V2modelsIntentInitialResponseSettingInitialResponseMessageGroupMessage.fromMap(
      ...
      variations: map['variations'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['variations'],
              (value) =>
                  V2modelsIntentInitialResponseSettingInitialResponseMessageGroupVariation.fromMap(
