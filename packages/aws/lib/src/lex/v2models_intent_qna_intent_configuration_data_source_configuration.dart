...
class V2modelsIntentQnaIntentConfigurationDataSourceConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bedrockKnowledgeStoreConfiguration':
          ?bedrockKnowledgeStoreConfiguration == null
          ? null
          : bedrockKnowledgeStoreConfiguration!.toMap(),
      'kendraConfiguration': ?kendraConfiguration == null
          ? null
          : kendraConfiguration!.toMap(),
      'opensearchConfiguration': ?opensearchConfiguration == null
          ? null
          : opensearchConfiguration!.toMap(),
    };
  }
  ...
  factory V2modelsIntentQnaIntentConfigurationDataSourceConfiguration.fromMap(
    ...
    return V2modelsIntentQnaIntentConfigurationDataSourceConfiguration(
      bedrockKnowledgeStoreConfiguration:
          map['bedrockKnowledgeStoreConfiguration'] == null
          ? null
          : V2modelsIntentQnaIntentConfigurationDataSourceConfigurationBedrockKnowledgeStoreConfiguration.fromMap(
              (map['bedrockKnowledgeStoreConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      kendraConfiguration: map['kendraConfiguration'] == null
          ? null
          : V2modelsIntentQnaIntentConfigurationDataSourceConfigurationKendraConfiguration.fromMap(
              (map['kendraConfiguration'] as Map).cast<String, dynamic>(),
            ),
      opensearchConfiguration: map['opensearchConfiguration'] == null
          ? null
          : V2modelsIntentQnaIntentConfigurationDataSourceConfigurationOpensearchConfiguration.fromMap(
              (map['opensearchConfiguration'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
