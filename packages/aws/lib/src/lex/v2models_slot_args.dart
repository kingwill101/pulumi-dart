...
class V2modelsSlotArgs {
  ...
  factory V2modelsSlotArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotArgs(
      ...
      multipleValuesSettings: map['multipleValuesSettings'] == null ? null : pulumi.Input.decodeList<V2modelsSlotMultipleValuesSetting>(map['multipleValuesSettings'], (value) => V2modelsSlotMultipleValuesSetting.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      obfuscationSettings: map['obfuscationSettings'] == null ? null : pulumi.Input.decodeList<V2modelsSlotObfuscationSetting>(map['obfuscationSettings'], (value) => V2modelsSlotObfuscationSetting.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      slotTypeId: map['slotTypeId'] == null ? null : map['slotTypeId'] as String,
      subSlotSettings: map['subSlotSettings'] == null ? null : pulumi.Input.decodeList<V2modelsSlotSubSlotSetting>(map['subSlotSettings'], (value) => V2modelsSlotSubSlotSetting.fromMap((value as Map).cast<String, dynamic>())),
      timeouts: map['timeouts'] == null ? null : V2modelsSlotTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      valueElicitationSetting: V2modelsSlotValueElicitationSetting.fromMap((map['valueElicitationSetting'] as Map).cast<String, dynamic>()),
    );
  }
}
