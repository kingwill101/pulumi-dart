...
class V2modelsSlotTypeValueSelectionSetting {
  ...
  final List<V2modelsSlotTypeValueSelectionSettingAdvancedRecognitionSetting>? advancedRecognitionSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advancedRecognitionSettings': ?advancedRecognitionSettings == null ? null : pulumi.Input.encodeList<V2modelsSlotTypeValueSelectionSettingAdvancedRecognitionSetting, Map<String, dynamic>>(advancedRecognitionSettings!, (value) => value.toMap()),
      'regexFilters': ?regexFilters == null ? null : pulumi.Input.encodeList<V2modelsSlotTypeValueSelectionSettingRegexFilter, Map<String, dynamic>>(regexFilters!, (value) => value.toMap()),
  ...
  factory V2modelsSlotTypeValueSelectionSetting.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotTypeValueSelectionSetting(
      advancedRecognitionSettings: map['advancedRecognitionSettings'] == null ? null : pulumi.Input.decodeList<V2modelsSlotTypeValueSelectionSettingAdvancedRecognitionSetting>(map['advancedRecognitionSettings'], (value) => V2modelsSlotTypeValueSelectionSettingAdvancedRecognitionSetting.fromMap((value as Map).cast<String, dynamic>())),
      regexFilters: map['regexFilters'] == null ? null : pulumi.Input.decodeList<V2modelsSlotTypeValueSelectionSettingRegexFilter>(map['regexFilters'], (value) => V2modelsSlotTypeValueSelectionSettingRegexFilter.fromMap((value as Map).cast<String, dynamic>())),
