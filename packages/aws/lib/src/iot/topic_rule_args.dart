...
class TopicRuleArgs {
  ...
  factory TopicRuleArgs.fromMap(Map<String, dynamic> map) {
    return TopicRuleArgs(
      cloudwatchAlarms: map['cloudwatchAlarms'] == null ? null : pulumi.Input.decodeList<TopicRuleCloudwatchAlarm>(map['cloudwatchAlarms'], (value) => TopicRuleCloudwatchAlarm.fromMap((value as Map).cast<String, dynamic>())),
      cloudwatchLogs: map['cloudwatchLogs'] == null ? null : pulumi.Input.decodeList<TopicRuleCloudwatchLog>(map['cloudwatchLogs'], (value) => TopicRuleCloudwatchLog.fromMap((value as Map).cast<String, dynamic>())),
      cloudwatchMetrics: map['cloudwatchMetrics'] == null ? null : pulumi.Input.decodeList<TopicRuleCloudwatchMetric>(map['cloudwatchMetrics'], (value) => TopicRuleCloudwatchMetric.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      dynamodbs: map['dynamodbs'] == null ? null : pulumi.Input.decodeList<TopicRuleDynamodb>(map['dynamodbs'], (value) => TopicRuleDynamodb.fromMap((value as Map).cast<String, dynamic>())),
      dynamodbv2s: map['dynamodbv2s'] == null ? null : pulumi.Input.decodeList<TopicRuleDynamodbv2>(map['dynamodbv2s'], (value) => TopicRuleDynamodbv2.fromMap((value as Map).cast<String, dynamic>())),
      elasticsearch: map['elasticsearch'] == null ? null : pulumi.Input.decodeList<TopicRuleElasticsearch>(map['elasticsearch'], (value) => TopicRuleElasticsearch.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] as bool,
      errorAction: map['errorAction'] == null ? null : TopicRuleErrorAction.fromMap((map['errorAction'] as Map).cast<String, dynamic>()),
      firehoses: map['firehoses'] == null ? null : pulumi.Input.decodeList<TopicRuleFirehose>(map['firehoses'], (value) => TopicRuleFirehose.fromMap((value as Map).cast<String, dynamic>())),
      https: map['https'] == null ? null : pulumi.Input.decodeList<TopicRuleHttp>(map['https'], (value) => TopicRuleHttp.fromMap((value as Map).cast<String, dynamic>())),
      iotAnalytics: map['iotAnalytics'] == null ? null : pulumi.Input.decodeList<TopicRuleIotAnalytic>(map['iotAnalytics'], (value) => TopicRuleIotAnalytic.fromMap((value as Map).cast<String, dynamic>())),
      iotEvents: map['iotEvents'] == null ? null : pulumi.Input.decodeList<TopicRuleIotEvent>(map['iotEvents'], (value) => TopicRuleIotEvent.fromMap((value as Map).cast<String, dynamic>())),
      kafkas: map['kafkas'] == null ? null : pulumi.Input.decodeList<TopicRuleKafka>(map['kafkas'], (value) => TopicRuleKafka.fromMap((value as Map).cast<String, dynamic>())),
      kineses: map['kineses'] == null ? null : pulumi.Input.decodeList<TopicRuleKinesis>(map['kineses'], (value) => TopicRuleKinesis.fromMap((value as Map).cast<String, dynamic>())),
      lambdas: map['lambdas'] == null ? null : pulumi.Input.decodeList<TopicRuleLambda>(map['lambdas'], (value) => TopicRuleLambda.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      republishes: map['republishes'] == null ? null : pulumi.Input.decodeList<TopicRuleRepublish>(map['republishes'], (value) => TopicRuleRepublish.fromMap((value as Map).cast<String, dynamic>())),
      s3: map['s3'] == null ? null : pulumi.Input.decodeList<TopicRuleS3>(map['s3'], (value) => TopicRuleS3.fromMap((value as Map).cast<String, dynamic>())),
      sns: map['sns'] == null ? null : pulumi.Input.decodeList<TopicRuleSns>(map['sns'], (value) => TopicRuleSns.fromMap((value as Map).cast<String, dynamic>())),
      sql: map['sql'] as String,
      sqlVersion: map['sqlVersion'] as String,
      sqs: map['sqs'] == null ? null : pulumi.Input.decodeList<TopicRuleSqs>(map['sqs'], (value) => TopicRuleSqs.fromMap((value as Map).cast<String, dynamic>())),
      stepFunctions: map['stepFunctions'] == null ? null : pulumi.Input.decodeList<TopicRuleStepFunction>(map['stepFunctions'], (value) => TopicRuleStepFunction.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timestreams: map['timestreams'] == null ? null : pulumi.Input.decodeList<TopicRuleTimestream>(map['timestreams'], (value) => TopicRuleTimestream.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
