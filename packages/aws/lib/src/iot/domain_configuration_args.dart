...
class DomainConfigurationArgs {
  ...
  factory DomainConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return DomainConfigurationArgs(
      applicationProtocol: map['applicationProtocol'] == null ? null : map['applicationProtocol'] as String,
      authenticationType: map['authenticationType'] == null ? null : map['authenticationType'] as String,
      authorizerConfig: map['authorizerConfig'] == null ? null : DomainConfigurationAuthorizerConfig.fromMap((map['authorizerConfig'] as Map).cast<String, dynamic>()),
      domainName: map['domainName'] == null ? null : map['domainName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      serverCertificateArns: map['serverCertificateArns'] == null ? null : (map['serverCertificateArns'] as List).cast<String>(),
      serviceType: map['serviceType'] == null ? null : map['serviceType'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tlsConfig: map['tlsConfig'] == null ? null : DomainConfigurationTlsConfig.fromMap((map['tlsConfig'] as Map).cast<String, dynamic>()),
      validationCertificateArn: map['validationCertificateArn'] == null ? null : map['validationCertificateArn'] as String,
    );
  }
}
