...
class DomainConfigurationArgs {
  ...
  DomainConfigurationArgs({
    ...
    String? validationCertificateArn,
            ...
            pulumi.Input.asOptionalInput<String>(applicationProtocol),
        authenticationType =
            pulumi.Input.asOptionalInput<String>(authenticationType),
        authorizerConfig =
        ...
        serverCertificateArns =
            pulumi.Input.asOptionalInput<List<String>>(serverCertificateArns),
        ...
        validationCertificateArn =
            pulumi.Input.asOptionalInput<String>(validationCertificateArn);
