...
class TopicRuleDynamodb {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['hashKeyField'] = hashKeyField;
    final hashKeyTypeValue = hashKeyType;
    if (hashKeyTypeValue != null) {
      map['hashKeyType'] = hashKeyTypeValue;
    }
    map['hashKeyValue'] = hashKeyValue;
    final operationValue = operation;
    if (operationValue != null) {
      map['operation'] = operationValue;
    }
    final payloadFieldValue = payloadField;
    if (payloadFieldValue != null) {
      map['payloadField'] = payloadFieldValue;
    }
    final rangeKeyFieldValue = rangeKeyField;
    if (rangeKeyFieldValue != null) {
      map['rangeKeyField'] = rangeKeyFieldValue;
    }
    final rangeKeyTypeValue = rangeKeyType;
    if (rangeKeyTypeValue != null) {
      map['rangeKeyType'] = rangeKeyTypeValue;
    }
    final rangeKeyValueValue = rangeKeyValue;
    if (rangeKeyValueValue != null) {
      map['rangeKeyValue'] = rangeKeyValueValue;
    }
    map['roleArn'] = roleArn;
  ...
  factory TopicRuleDynamodb.fromMap(Map<String, dynamic> map) {
    return TopicRuleDynamodb(
      ...
      hashKeyType:
          map['hashKeyType'] == null ? null : map['hashKeyType'] as String,
      hashKeyValue: map['hashKeyValue'] as String,
      operation: map['operation'] == null ? null : map['operation'] as String,
      payloadField:
          map['payloadField'] == null ? null : map['payloadField'] as String,
      rangeKeyField:
          map['rangeKeyField'] == null ? null : map['rangeKeyField'] as String,
      rangeKeyType:
          map['rangeKeyType'] == null ? null : map['rangeKeyType'] as String,
      rangeKeyValue:
          map['rangeKeyValue'] == null ? null : map['rangeKeyValue'] as String,
