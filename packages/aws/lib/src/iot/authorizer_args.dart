...
class AuthorizerArgs {
  ...
  factory AuthorizerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizerArgs(
      ...
      enableCachingForHttp: map['enableCachingForHttp'] == null ? null : map['enableCachingForHttp'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      signingDisabled: map['signingDisabled'] == null ? null : map['signingDisabled'] as bool,
      status: map['status'] == null ? null : map['status'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tokenKeyName: map['tokenKeyName'] == null ? null : map['tokenKeyName'] as String,
      tokenSigningPublicKeys: map['tokenSigningPublicKeys'] == null ? null : (map['tokenSigningPublicKeys'] as Map).cast<String, String>(),
    );
  }
}
