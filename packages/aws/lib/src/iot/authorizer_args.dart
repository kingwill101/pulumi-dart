...
class AuthorizerArgs {
  ...
  AuthorizerArgs({
    ...
    Map<String, String>? tokenSigningPublicKeys,
  }) : authorizerFunctionArn = pulumi.Input.asInput<String>(
         authorizerFunctionArn,
       ),
       enableCachingForHttp = pulumi.Input.asOptionalInput<bool>(
       ...
       tokenSigningPublicKeys = pulumi
           .Input.asOptionalInput<Map<String, String>>(tokenSigningPublicKeys);
  ...
  factory AuthorizerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizerArgs(
      ...
      tokenKeyName: map['tokenKeyName'] == null
          ? null
          : map['tokenKeyName'] as String,
