...
class TopicRule extends pulumi.CustomResource {
  ...
  TopicRule(
    ...
    this.cloudwatchAlarms = registerOutput<List<TopicRuleCloudwatchAlarm>?>(
      'cloudwatchAlarms',
    );
    this.cloudwatchLogs = registerOutput<List<TopicRuleCloudwatchLog>?>(
      'cloudwatchLogs',
    );
    this.cloudwatchMetrics = registerOutput<List<TopicRuleCloudwatchMetric>?>(
      'cloudwatchMetrics',
    );
    this.description = registerOutput<String?>('description');
    this.dynamodbs = registerOutput<List<TopicRuleDynamodb>?>('dynamodbs');
    this.dynamodbv2s = registerOutput<List<TopicRuleDynamodbv2>?>(
      'dynamodbv2s',
    );
    this.elasticsearch = registerOutput<List<TopicRuleElasticsearch>?>(
      'elasticsearch',
    );
    ...
    this.iotAnalytics = registerOutput<List<TopicRuleIotAnalytic>?>(
      'iotAnalytics',
    );
    ...
    this.stepFunctions = registerOutput<List<TopicRuleStepFunction>?>(
      'stepFunctions',
    );
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.timestreams = registerOutput<List<TopicRuleTimestream>?>(
      'timestreams',
    );
  }
}
