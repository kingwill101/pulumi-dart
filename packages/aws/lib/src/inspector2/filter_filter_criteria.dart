...
class FilterFilterCriteria {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'codeRepositoryProjectNames': ?codeRepositoryProjectNames == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaCodeRepositoryProjectName,
              Map<String, dynamic>
            >(codeRepositoryProjectNames!, (value) => value.toMap()),
      'codeRepositoryProviderTypes': ?codeRepositoryProviderTypes == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaCodeRepositoryProviderType,
              Map<String, dynamic>
            >(codeRepositoryProviderTypes!, (value) => value.toMap()),
      'codeVulnerabilityDetectorNames': ?codeVulnerabilityDetectorNames == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaCodeVulnerabilityDetectorName,
              Map<String, dynamic>
            >(codeVulnerabilityDetectorNames!, (value) => value.toMap()),
      'codeVulnerabilityDetectorTags': ?codeVulnerabilityDetectorTags == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaCodeVulnerabilityDetectorTag,
              Map<String, dynamic>
            >(codeVulnerabilityDetectorTags!, (value) => value.toMap()),
      'codeVulnerabilityFilePaths': ?codeVulnerabilityFilePaths == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaCodeVulnerabilityFilePath,
              Map<String, dynamic>
            >(codeVulnerabilityFilePaths!, (value) => value.toMap()),
      'componentIds': ?componentIds == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaComponentId,
              Map<String, dynamic>
            >(componentIds!, (value) => value.toMap()),
      'componentTypes': ?componentTypes == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaComponentType,
              Map<String, dynamic>
            >(componentTypes!, (value) => value.toMap()),
      'ec2InstanceImageIds': ?ec2InstanceImageIds == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEc2InstanceImageId,
              Map<String, dynamic>
            >(ec2InstanceImageIds!, (value) => value.toMap()),
      'ec2InstanceSubnetIds': ?ec2InstanceSubnetIds == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEc2InstanceSubnetId,
              Map<String, dynamic>
            >(ec2InstanceSubnetIds!, (value) => value.toMap()),
      'ec2InstanceVpcIds': ?ec2InstanceVpcIds == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEc2InstanceVpcId,
              Map<String, dynamic>
            >(ec2InstanceVpcIds!, (value) => value.toMap()),
      'ecrImageArchitectures': ?ecrImageArchitectures == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImageArchitecture,
              Map<String, dynamic>
            >(ecrImageArchitectures!, (value) => value.toMap()),
      'ecrImageHashes': ?ecrImageHashes == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImageHash,
              Map<String, dynamic>
            >(ecrImageHashes!, (value) => value.toMap()),
      'ecrImageInUseCounts': ?ecrImageInUseCounts == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImageInUseCount,
              Map<String, dynamic>
            >(ecrImageInUseCounts!, (value) => value.toMap()),
      'ecrImageLastInUseAts': ?ecrImageLastInUseAts == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImageLastInUseAt,
              Map<String, dynamic>
            >(ecrImageLastInUseAts!, (value) => value.toMap()),
      'ecrImagePushedAts': ?ecrImagePushedAts == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImagePushedAt,
              Map<String, dynamic>
            >(ecrImagePushedAts!, (value) => value.toMap()),
      'ecrImageRegistries': ?ecrImageRegistries == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImageRegistry,
              Map<String, dynamic>
            >(ecrImageRegistries!, (value) => value.toMap()),
      'ecrImageRepositoryNames': ?ecrImageRepositoryNames == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImageRepositoryName,
              Map<String, dynamic>
            >(ecrImageRepositoryNames!, (value) => value.toMap()),
      'ecrImageTags': ?ecrImageTags == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEcrImageTag,
              Map<String, dynamic>
            >(ecrImageTags!, (value) => value.toMap()),
      'epssScores': ?epssScores == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaEpssScore,
              Map<String, dynamic>
            >(epssScores!, (value) => value.toMap()),
      'exploitAvailables': ?exploitAvailables == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaExploitAvailable,
              Map<String, dynamic>
            >(exploitAvailables!, (value) => value.toMap()),
      'findingArns': ?findingArns == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaFindingArn,
              Map<String, dynamic>
            >(findingArns!, (value) => value.toMap()),
      'findingStatuses': ?findingStatuses == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaFindingStatus,
              Map<String, dynamic>
            >(findingStatuses!, (value) => value.toMap()),
      'findingTypes': ?findingTypes == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaFindingType,
              Map<String, dynamic>
            >(findingTypes!, (value) => value.toMap()),
      ...
      'fixAvailables': ?fixAvailables == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaFixAvailable,
              Map<String, dynamic>
            >(fixAvailables!, (value) => value.toMap()),
      'inspectorScores': ?inspectorScores == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaInspectorScore,
              Map<String, dynamic>
            >(inspectorScores!, (value) => value.toMap()),
      'lambdaFunctionExecutionRoleArns':
          ?lambdaFunctionExecutionRoleArns == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaLambdaFunctionExecutionRoleArn,
              Map<String, dynamic>
            >(lambdaFunctionExecutionRoleArns!, (value) => value.toMap()),
      'lambdaFunctionLastModifiedAts': ?lambdaFunctionLastModifiedAts == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaLambdaFunctionLastModifiedAt,
              Map<String, dynamic>
            >(lambdaFunctionLastModifiedAts!, (value) => value.toMap()),
      'lambdaFunctionLayers': ?lambdaFunctionLayers == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaLambdaFunctionLayer,
              Map<String, dynamic>
            >(lambdaFunctionLayers!, (value) => value.toMap()),
      'lambdaFunctionNames': ?lambdaFunctionNames == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaLambdaFunctionName,
              Map<String, dynamic>
            >(lambdaFunctionNames!, (value) => value.toMap()),
      'lambdaFunctionRuntimes': ?lambdaFunctionRuntimes == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaLambdaFunctionRuntime,
              Map<String, dynamic>
            >(lambdaFunctionRuntimes!, (value) => value.toMap()),
      ...
      'relatedVulnerabilities': ?relatedVulnerabilities == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaRelatedVulnerability,
              Map<String, dynamic>
            >(relatedVulnerabilities!, (value) => value.toMap()),
      ...
      'vendorSeverities': ?vendorSeverities == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaVendorSeverity,
              Map<String, dynamic>
            >(vendorSeverities!, (value) => value.toMap()),
      'vulnerabilityIds': ?vulnerabilityIds == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaVulnerabilityId,
              Map<String, dynamic>
            >(vulnerabilityIds!, (value) => value.toMap()),
      'vulnerabilitySources': ?vulnerabilitySources == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaVulnerabilitySource,
              Map<String, dynamic>
            >(vulnerabilitySources!, (value) => value.toMap()),
      'vulnerablePackages': ?vulnerablePackages == null
          ? null
          : pulumi.Input.encodeList<
              FilterFilterCriteriaVulnerablePackage,
              Map<String, dynamic>
            >(vulnerablePackages!, (value) => value.toMap()),
    };
  }
  ...
  factory FilterFilterCriteria.fromMap(Map<String, dynamic> map) {
    return FilterFilterCriteria(
      ...
      lambdaFunctionExecutionRoleArns:
          map['lambdaFunctionExecutionRoleArns'] == null
          ? null
          : pulumi.Input.decodeList<
              FilterFilterCriteriaLambdaFunctionExecutionRoleArn
            >(
