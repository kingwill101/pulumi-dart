...
class OrganizationConfiguration extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [OrganizationConfiguration]. {@macro pulumi_inspector2_organization_configuration_organization_configuration_args_doc}
