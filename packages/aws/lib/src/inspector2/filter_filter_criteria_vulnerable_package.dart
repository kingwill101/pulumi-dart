...
class FilterFilterCriteriaVulnerablePackage {
  ...
  final FilterFilterCriteriaVulnerablePackageSourceLambdaLayerArn? sourceLambdaLayerArn;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'epoches': ?epoches == null ? null : pulumi.Input.encodeList<FilterFilterCriteriaVulnerablePackageEpoch, Map<String, dynamic>>(epoches!, (value) => value.toMap()),
      'filePath': ?filePath == null ? null : filePath!.toMap(),
      'name': ?name == null ? null : name!.toMap(),
      'release': ?release == null ? null : release!.toMap(),
      'sourceLambdaLayerArn': ?sourceLambdaLayerArn == null ? null : sourceLambdaLayerArn!.toMap(),
      'sourceLayerHash': ?sourceLayerHash == null ? null : sourceLayerHash!.toMap(),
  ...
  factory FilterFilterCriteriaVulnerablePackage.fromMap(Map<String, dynamic> map) {
    return FilterFilterCriteriaVulnerablePackage(
      architecture: map['architecture'] == null ? null : FilterFilterCriteriaVulnerablePackageArchitecture.fromMap((map['architecture'] as Map).cast<String, dynamic>()),
      epoches: map['epoches'] == null ? null : pulumi.Input.decodeList<FilterFilterCriteriaVulnerablePackageEpoch>(map['epoches'], (value) => FilterFilterCriteriaVulnerablePackageEpoch.fromMap((value as Map).cast<String, dynamic>())),
      filePath: map['filePath'] == null ? null : FilterFilterCriteriaVulnerablePackageFilePath.fromMap((map['filePath'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : FilterFilterCriteriaVulnerablePackageName.fromMap((map['name'] as Map).cast<String, dynamic>()),
      release: map['release'] == null ? null : FilterFilterCriteriaVulnerablePackageRelease.fromMap((map['release'] as Map).cast<String, dynamic>()),
      sourceLambdaLayerArn: map['sourceLambdaLayerArn'] == null ? null : FilterFilterCriteriaVulnerablePackageSourceLambdaLayerArn.fromMap((map['sourceLambdaLayerArn'] as Map).cast<String, dynamic>()),
      sourceLayerHash: map['sourceLayerHash'] == null ? null : FilterFilterCriteriaVulnerablePackageSourceLayerHash.fromMap((map['sourceLayerHash'] as Map).cast<String, dynamic>()),
      version: map['version'] == null ? null : FilterFilterCriteriaVulnerablePackageVersion.fromMap((map['version'] as Map).cast<String, dynamic>()),
    );
  }
}
