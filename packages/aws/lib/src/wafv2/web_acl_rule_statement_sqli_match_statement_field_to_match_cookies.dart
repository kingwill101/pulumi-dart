...
import 'web_acl_rule_statement_sqli_match_statement_field_to_match_cookies_match_pattern.dart';

class WebAclRuleStatementSqliMatchStatementFieldToMatchCookies {
  ...
  /// Creates a new [WebAclRuleStatementSqliMatchStatementFieldToMatchCookies].
  ...
  factory WebAclRuleStatementSqliMatchStatementFieldToMatchCookies.fromMap(
    ...
    return WebAclRuleStatementSqliMatchStatementFieldToMatchCookies(
      matchPatterns:
          ...
          >(
            map['matchPatterns'],
            (value) =>
                WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern.fromMap(
