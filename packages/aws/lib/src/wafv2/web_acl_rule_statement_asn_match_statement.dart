...
class WebAclRuleStatementAsnMatchStatement {
  ...
  final WebAclRuleStatementAsnMatchStatementForwardedIpConfig? forwardedIpConfig;
  ...
  factory WebAclRuleStatementAsnMatchStatement.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementAsnMatchStatement(
      ...
      forwardedIpConfig: map['forwardedIpConfig'] == null ? null : WebAclRuleStatementAsnMatchStatementForwardedIpConfig.fromMap((map['forwardedIpConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
