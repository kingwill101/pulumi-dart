...
class WebAclRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'challengeConfig': ?challengeConfig == null ? null : challengeConfig!.toMap(),
      'name': name,
      'overrideAction': ?overrideAction == null ? null : overrideAction!.toMap(),
      'priority': priority,
      'ruleLabels': ?ruleLabels == null ? null : pulumi.Input.encodeList<WebAclRuleRuleLabel, Map<String, dynamic>>(ruleLabels!, (value) => value.toMap()),
  ...
  factory WebAclRule.fromMap(Map<String, dynamic> map) {
    return WebAclRule(
      ...
      captchaConfig: map['captchaConfig'] == null ? null : WebAclRuleCaptchaConfig.fromMap((map['captchaConfig'] as Map).cast<String, dynamic>()),
      challengeConfig: map['challengeConfig'] == null ? null : WebAclRuleChallengeConfig.fromMap((map['challengeConfig'] as Map).cast<String, dynamic>()),
      ...
      ruleLabels: map['ruleLabels'] == null ? null : pulumi.Input.decodeList<WebAclRuleRuleLabel>(map['ruleLabels'], (value) => WebAclRuleRuleLabel.fromMap((value as Map).cast<String, dynamic>())),
      statement: WebAclRuleStatement.fromMap((map['statement'] as Map).cast<String, dynamic>()),
      visibilityConfig: WebAclRuleVisibilityConfig.fromMap((map['visibilityConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
