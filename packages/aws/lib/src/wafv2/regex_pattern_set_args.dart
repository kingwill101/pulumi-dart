...
class RegexPatternSetArgs {
  ...
  factory RegexPatternSetArgs.fromMap(Map<String, dynamic> map) {
    return RegexPatternSetArgs(
      ...
      regularExpressions: map['regularExpressions'] == null ? null : pulumi.Input.decodeList<RegexPatternSetRegularExpression>(map['regularExpressions'], (value) => RegexPatternSetRegularExpression.fromMap((value as Map).cast<String, dynamic>())),
