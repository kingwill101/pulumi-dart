...
class WebAclArgs {
  ...
  factory WebAclArgs.fromMap(Map<String, dynamic> map) {
    return WebAclArgs(
      associationConfig: map['associationConfig'] == null ? null : WebAclAssociationConfig.fromMap((map['associationConfig'] as Map).cast<String, dynamic>()),
      captchaConfig: map['captchaConfig'] == null ? null : WebAclCaptchaConfig.fromMap((map['captchaConfig'] as Map).cast<String, dynamic>()),
      challengeConfig: map['challengeConfig'] == null ? null : WebAclChallengeConfig.fromMap((map['challengeConfig'] as Map).cast<String, dynamic>()),
      customResponseBodies: map['customResponseBodies'] == null ? null : pulumi.Input.decodeList<WebAclCustomResponseBody>(map['customResponseBodies'], (value) => WebAclCustomResponseBody.fromMap((value as Map).cast<String, dynamic>())),
      dataProtectionConfig: map['dataProtectionConfig'] == null ? null : WebAclDataProtectionConfig.fromMap((map['dataProtectionConfig'] as Map).cast<String, dynamic>()),
      ...
      tokenDomains: map['tokenDomains'] == null ? null : (map['tokenDomains'] as List).cast<String>(),
      visibilityConfig: WebAclVisibilityConfig.fromMap((map['visibilityConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
