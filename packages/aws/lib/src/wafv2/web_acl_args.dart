...
class WebAclArgs {
  ...
  WebAclArgs({
    ...
    required WebAclVisibilityConfig visibilityConfig,
            ...
            pulumi.Input.asOptionalInput<WebAclAssociationConfig>(
                associationConfig),
        captchaConfig =
            pulumi.Input.asOptionalInput<WebAclCaptchaConfig>(captchaConfig),
        ...
        visibilityConfig =
            pulumi.Input.asInput<WebAclVisibilityConfig>(visibilityConfig);
