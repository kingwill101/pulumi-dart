...
class WebAclRuleGroupAssociationTimeouts {
  ...
  /// Creates a new [WebAclRuleGroupAssociationTimeouts].
  ...
  WebAclRuleGroupAssociationTimeouts({this.create, this.delete, this.update});
  ...
  factory WebAclRuleGroupAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return WebAclRuleGroupAssociationTimeouts(
