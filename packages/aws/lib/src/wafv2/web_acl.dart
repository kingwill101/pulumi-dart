...
class WebAcl extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<WebAclCustomResponseBody>?>
  ...
  WebAcl(String name, {WebAclArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.applicationIntegrationUrl = registerOutput<String>(
      'applicationIntegrationUrl',
    );
    this.arn = registerOutput<String>('arn');
    this.associationConfig = registerOutput<WebAclAssociationConfig?>(
      'associationConfig',
    );
    this.capacity = registerOutput<int>('capacity');
    this.captchaConfig = registerOutput<WebAclCaptchaConfig?>('captchaConfig');
    this.challengeConfig = registerOutput<WebAclChallengeConfig?>(
      'challengeConfig',
    );
    this.customResponseBodies = registerOutput<List<WebAclCustomResponseBody>?>(
      'customResponseBodies',
    );
    this.dataProtectionConfig = registerOutput<WebAclDataProtectionConfig?>(
    ...
    this.visibilityConfig = registerOutput<WebAclVisibilityConfig>(
      'visibilityConfig',
    );
  }
}
