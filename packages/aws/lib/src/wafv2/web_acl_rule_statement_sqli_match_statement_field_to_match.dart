  ...
  factory WebAclRuleStatementSqliMatchStatementFieldToMatch.fromMap(
    ...
    return WebAclRuleStatementSqliMatchStatementFieldToMatch(
      ...
      headerOrders: map['headerOrders'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['headerOrders'],
              (value) =>
                  WebAclRuleStatementSqliMatchStatementFieldToMatchHeaderOrder.fromMap(
      ...
      headers: map['headers'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['headers'],
              (value) =>
                  WebAclRuleStatementSqliMatchStatementFieldToMatchHeader.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      ja3Fingerprint: map['ja3Fingerprint'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint.fromMap(
              (map['ja3Fingerprint'] as Map).cast<String, dynamic>(),
            ),
      ja4Fingerprint: map['ja4Fingerprint'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint.fromMap(
      ...
      singleHeader: map['singleHeader'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchSingleHeader.fromMap(
              (map['singleHeader'] as Map).cast<String, dynamic>(),
            ),
      singleQueryArgument: map['singleQueryArgument'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchSingleQueryArgument.fromMap(
              (map['singleQueryArgument'] as Map).cast<String, dynamic>(),
            ),
      uriFragment: map['uriFragment'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchUriFragment.fromMap(
