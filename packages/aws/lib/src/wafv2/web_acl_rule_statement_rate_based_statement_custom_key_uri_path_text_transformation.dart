...
class WebAclRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation {
  ...
  /// Creates a new [WebAclRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation].
  ...
  factory WebAclRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation.fromMap(Map<String, dynamic> map) {
