...
import 'rule_group_rule_statement_sqli_match_statement_field_to_match_json_body_match_pattern.dart';

class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody {
  ...
  final RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern
  matchPattern;
  ...
  /// Creates a new [RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody].
  ...
  factory RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.fromMap(
    Map<String, dynamic> map,
  ) {
    return RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody(
      invalidFallbackBehavior: map['invalidFallbackBehavior'] == null
          ? null
          : map['invalidFallbackBehavior'] as String,
      matchPattern:
          RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern.fromMap(
