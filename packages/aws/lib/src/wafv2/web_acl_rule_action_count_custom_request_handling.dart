...
class WebAclRuleActionCountCustomRequestHandling {
  ...
  final List<WebAclRuleActionCountCustomRequestHandlingInsertHeader> insertHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'insertHeaders': pulumi.Input.encodeList<WebAclRuleActionCountCustomRequestHandlingInsertHeader, Map<String, dynamic>>(insertHeaders, (value) => value.toMap()),
    };
  }
  ...
  factory WebAclRuleActionCountCustomRequestHandling.fromMap(Map<String, dynamic> map) {
    return WebAclRuleActionCountCustomRequestHandling(
      insertHeaders: pulumi.Input.decodeList<WebAclRuleActionCountCustomRequestHandlingInsertHeader>(map['insertHeaders'], (value) => WebAclRuleActionCountCustomRequestHandlingInsertHeader.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
