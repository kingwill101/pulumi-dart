...
import 'rule_group_rule_statement_xss_match_statement_field_to_match_header_match_pattern.dart';

class RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader {
  ...
  final RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern
  matchPattern;
  ...
  /// Creates a new [RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader].
  ...
  factory RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader.fromMap(
    Map<String, dynamic> map,
  ) {
    return RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader(
      matchPattern:
          RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern.fromMap(
