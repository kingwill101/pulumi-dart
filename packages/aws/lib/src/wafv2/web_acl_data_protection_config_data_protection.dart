...
class WebAclDataProtectionConfigDataProtection {
  ...
  factory WebAclDataProtectionConfigDataProtection.fromMap(Map<String, dynamic> map) {
    return WebAclDataProtectionConfigDataProtection(
      ...
      excludeRateBasedDetails: map['excludeRateBasedDetails'] == null ? null : map['excludeRateBasedDetails'] as bool,
      excludeRuleMatchDetails: map['excludeRuleMatchDetails'] == null ? null : map['excludeRuleMatchDetails'] as bool,
      field: WebAclDataProtectionConfigDataProtectionField.fromMap((map['field'] as Map).cast<String, dynamic>()),
    );
  }
}
