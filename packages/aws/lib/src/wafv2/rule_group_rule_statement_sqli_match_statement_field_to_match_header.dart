...
import 'rule_group_rule_statement_sqli_match_statement_field_to_match_header_match_pattern.dart';

class RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader {
  ...
  final RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern
  matchPattern;
  ...
  /// Creates a new [RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader].
  ...
  factory RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader.fromMap(
    Map<String, dynamic> map,
  ) {
    return RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader(
      matchPattern:
          RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern.fromMap(
