...
class RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader {
  ...
  final RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern matchPattern;
  ...
  factory RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader(
      matchPattern: RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern'] as Map).cast<String, dynamic>()),
