...
class RuleGroupRuleActionCountCustomRequestHandling {
  ...
  final List<RuleGroupRuleActionCountCustomRequestHandlingInsertHeader> insertHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'insertHeaders': pulumi.Input.encodeList<RuleGroupRuleActionCountCustomRequestHandlingInsertHeader, Map<String, dynamic>>(insertHeaders, (value) => value.toMap()),
    };
  }
  ...
  factory RuleGroupRuleActionCountCustomRequestHandling.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleActionCountCustomRequestHandling(
      insertHeaders: pulumi.Input.decodeList<RuleGroupRuleActionCountCustomRequestHandlingInsertHeader>(map['insertHeaders'], (value) => RuleGroupRuleActionCountCustomRequestHandlingInsertHeader.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
