...
class RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies {
  ...
  final List<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPatterns': pulumi.Input.encodeList<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern, Map<String, dynamic>>(matchPatterns, (value) => value.toMap()),
  ...
  factory RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.decodeList<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns'], (value) => RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>())),
