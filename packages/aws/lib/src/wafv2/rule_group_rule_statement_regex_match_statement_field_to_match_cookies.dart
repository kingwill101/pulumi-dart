...
class RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies {
  ...
  final List<RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPatterns': pulumi.Input.encodeList<RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern, Map<String, dynamic>>(matchPatterns, (value) => value.toMap()),
  ...
  factory RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.decodeList<RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns'], (value) => RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>())),
