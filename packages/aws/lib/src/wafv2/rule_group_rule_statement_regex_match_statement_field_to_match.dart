...
class RuleGroupRuleStatementRegexMatchStatementFieldToMatch {
  ...
  final List<RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderOrder>?
  headerOrders;

  /// Inspect the request headers. See Headers below for details.
  final List<RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeader>?
  headers;

  /// Inspect the JA3 fingerprint. See `ja3_fingerprint` below for details.
  final RuleGroupRuleStatementRegexMatchStatementFieldToMatchJa3Fingerprint?
  ja3Fingerprint;

  /// Inspect the JA4 fingerprint. See `ja4_fingerprint` below for details.
  final RuleGroupRuleStatementRegexMatchStatementFieldToMatchJa4Fingerprint?
  ja4Fingerprint;
  ...
  final RuleGroupRuleStatementRegexMatchStatementFieldToMatchSingleHeader?
  singleHeader;

  /// Inspect a single query argument. See Single Query Argument below for details.
  final RuleGroupRuleStatementRegexMatchStatementFieldToMatchSingleQueryArgument?
  singleQueryArgument;
  ...
  final RuleGroupRuleStatementRegexMatchStatementFieldToMatchUriFragment?
  uriFragment;
  ...
  factory RuleGroupRuleStatementRegexMatchStatementFieldToMatch.fromMap(
    ...
    return RuleGroupRuleStatementRegexMatchStatementFieldToMatch(
      ...
      body: map['body'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchBody.fromMap(
              (map['body'] as Map).cast<String, dynamic>(),
            ),
      cookies: map['cookies'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies.fromMap(
      ...
      headerOrders: map['headerOrders'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['headerOrders'],
              (value) =>
                  RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderOrder.fromMap(
      ...
      headers: map['headers'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['headers'],
              (value) =>
                  RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeader.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      ja3Fingerprint: map['ja3Fingerprint'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchJa3Fingerprint.fromMap(
              (map['ja3Fingerprint'] as Map).cast<String, dynamic>(),
            ),
      ja4Fingerprint: map['ja4Fingerprint'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchJa4Fingerprint.fromMap(
              (map['ja4Fingerprint'] as Map).cast<String, dynamic>(),
            ),
      jsonBody: map['jsonBody'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.fromMap(
      ...
      singleHeader: map['singleHeader'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchSingleHeader.fromMap(
              (map['singleHeader'] as Map).cast<String, dynamic>(),
            ),
      singleQueryArgument: map['singleQueryArgument'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchSingleQueryArgument.fromMap(
              (map['singleQueryArgument'] as Map).cast<String, dynamic>(),
            ),
      uriFragment: map['uriFragment'] == null
          ? null
          : RuleGroupRuleStatementRegexMatchStatementFieldToMatchUriFragment.fromMap(
