...
class WebAclRuleGroupAssociationArgs {
  ...
  factory WebAclRuleGroupAssociationArgs.fromMap(Map<String, dynamic> map) {
    return WebAclRuleGroupAssociationArgs(
      managedRuleGroup: map['managedRuleGroup'] == null ? null : WebAclRuleGroupAssociationManagedRuleGroup.fromMap((map['managedRuleGroup'] as Map).cast<String, dynamic>()),
      overrideAction: map['overrideAction'] == null ? null : map['overrideAction'] as String,
      priority: map['priority'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      ruleGroupReference: map['ruleGroupReference'] == null ? null : WebAclRuleGroupAssociationRuleGroupReference.fromMap((map['ruleGroupReference'] as Map).cast<String, dynamic>()),
      ruleName: map['ruleName'] as String,
      timeouts: map['timeouts'] == null ? null : WebAclRuleGroupAssociationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
