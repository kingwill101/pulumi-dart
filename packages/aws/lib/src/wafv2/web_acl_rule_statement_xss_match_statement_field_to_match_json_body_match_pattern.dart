...
class WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern {
  ...
  factory WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern.fromMap(
      Map<String, dynamic> map) {
    return WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern(
      all: map['all'] == null
          ? null
