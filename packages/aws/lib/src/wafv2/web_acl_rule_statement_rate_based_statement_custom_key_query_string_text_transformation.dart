...
class WebAclRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation {
  ...
  /// Creates a new [WebAclRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation].
  ...
  factory WebAclRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation.fromMap(
      Map<String, dynamic> map) {
    return WebAclRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation(
