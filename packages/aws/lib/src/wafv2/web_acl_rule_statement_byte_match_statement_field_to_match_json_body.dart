...
class WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody {
  ...
  final WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
  ...
  factory WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody(
      ...
      matchPattern: WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern.fromMap((map['matchPattern'] as Map).cast<String, dynamic>()),
