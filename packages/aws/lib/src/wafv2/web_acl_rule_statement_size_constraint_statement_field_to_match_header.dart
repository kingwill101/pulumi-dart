...
class WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader {
  ...
  final WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern matchPattern;
  ...
  factory WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader(
      matchPattern: WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern'] as Map).cast<String, dynamic>()),
