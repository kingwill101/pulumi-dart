...
class WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfig {
  ...
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSet? awsManagedRulesAcfpRuleSet;
  /// Configuration for using the anti-DDoS managed rule group. See `aws_managed_rules_anti_ddos_rule_set` for more details.
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAntiDdosRuleSet? awsManagedRulesAntiDdosRuleSet;
  ...
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSet? awsManagedRulesAtpRuleSet;
  ...
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesBotControlRuleSet? awsManagedRulesBotControlRuleSet;
  /// The path of the login endpoint for your application.
  final String? loginPath;
  /// Details about your login page password field. See `password_field` for more details.
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigPasswordField? passwordField;
  /// The payload type for your login endpoint, either JSON or form encoded.
  final String? payloadType;
  /// Details about your login page username field. See `username_field` for more details.
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigUsernameField? usernameField;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsManagedRulesAcfpRuleSet': ?awsManagedRulesAcfpRuleSet == null ? null : awsManagedRulesAcfpRuleSet!.toMap(),
      'awsManagedRulesAntiDdosRuleSet': ?awsManagedRulesAntiDdosRuleSet == null ? null : awsManagedRulesAntiDdosRuleSet!.toMap(),
      'awsManagedRulesAtpRuleSet': ?awsManagedRulesAtpRuleSet == null ? null : awsManagedRulesAtpRuleSet!.toMap(),
      'awsManagedRulesBotControlRuleSet': ?awsManagedRulesBotControlRuleSet == null ? null : awsManagedRulesBotControlRuleSet!.toMap(),
      'loginPath': ?loginPath,
  ...
  factory WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfig.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfig(
      awsManagedRulesAcfpRuleSet: map['awsManagedRulesAcfpRuleSet'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSet.fromMap((map['awsManagedRulesAcfpRuleSet'] as Map).cast<String, dynamic>()),
      awsManagedRulesAntiDdosRuleSet: map['awsManagedRulesAntiDdosRuleSet'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAntiDdosRuleSet.fromMap((map['awsManagedRulesAntiDdosRuleSet'] as Map).cast<String, dynamic>()),
      awsManagedRulesAtpRuleSet: map['awsManagedRulesAtpRuleSet'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSet.fromMap((map['awsManagedRulesAtpRuleSet'] as Map).cast<String, dynamic>()),
      awsManagedRulesBotControlRuleSet: map['awsManagedRulesBotControlRuleSet'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesBotControlRuleSet.fromMap((map['awsManagedRulesBotControlRuleSet'] as Map).cast<String, dynamic>()),
      loginPath: map['loginPath'] == null ? null : map['loginPath'] as String,
      passwordField: map['passwordField'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigPasswordField.fromMap((map['passwordField'] as Map).cast<String, dynamic>()),
      payloadType: map['payloadType'] == null ? null : map['payloadType'] as String,
      usernameField: map['usernameField'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigUsernameField.fromMap((map['usernameField'] as Map).cast<String, dynamic>()),
    );
  }
}
