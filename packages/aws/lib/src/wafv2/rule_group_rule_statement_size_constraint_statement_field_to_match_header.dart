...
class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeader {
  ...
  final RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern
  matchPattern;
  ...
  factory RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeader.fromMap(
    Map<String, dynamic> map,
  ) {
    return RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeader(
      matchPattern:
          RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern.fromMap(
