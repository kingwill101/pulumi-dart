...
class WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverride {
  ...
  final WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUse? actionToUse;
  ...
  factory WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverride.fromMap(Map<String, dynamic> map) {
    return WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverride(
      actionToUse: map['actionToUse'] == null ? null : WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUse.fromMap((map['actionToUse'] as Map).cast<String, dynamic>()),
