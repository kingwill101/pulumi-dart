...
class WebAclDefaultActionBlockCustomResponse {
  ...
  final List<WebAclDefaultActionBlockCustomResponseResponseHeader>? responseHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'responseHeaders': ?responseHeaders == null ? null : pulumi.Input.encodeList<WebAclDefaultActionBlockCustomResponseResponseHeader, Map<String, dynamic>>(responseHeaders!, (value) => value.toMap()),
    };
  }
  ...
  factory WebAclDefaultActionBlockCustomResponse.fromMap(Map<String, dynamic> map) {
    return WebAclDefaultActionBlockCustomResponse(
      ...
      responseHeaders: map['responseHeaders'] == null ? null : pulumi.Input.decodeList<WebAclDefaultActionBlockCustomResponseResponseHeader>(map['responseHeaders'], (value) => WebAclDefaultActionBlockCustomResponseResponseHeader.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
