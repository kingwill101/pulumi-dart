...
class WebAclRuleStatementXssMatchStatementFieldToMatchBody {
  ...
  /// Creates a new [WebAclRuleStatementXssMatchStatementFieldToMatchBody].
  ...
  WebAclRuleStatementXssMatchStatementFieldToMatchBody({this.oversizeHandling});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'oversizeHandling': ?oversizeHandling};
  }

  factory WebAclRuleStatementXssMatchStatementFieldToMatchBody.fromMap(
