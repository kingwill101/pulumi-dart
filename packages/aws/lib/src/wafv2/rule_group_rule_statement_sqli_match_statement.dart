...
class RuleGroupRuleStatementSqliMatchStatement {
  ...
  final List<RuleGroupRuleStatementSqliMatchStatementTextTransformation> textTransformations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'textTransformations': pulumi.Input.encodeList<RuleGroupRuleStatementSqliMatchStatementTextTransformation, Map<String, dynamic>>(textTransformations, (value) => value.toMap()),
    };
  }
  ...
  factory RuleGroupRuleStatementSqliMatchStatement.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSqliMatchStatement(
      fieldToMatch: map['fieldToMatch'] == null ? null : RuleGroupRuleStatementSqliMatchStatementFieldToMatch.fromMap((map['fieldToMatch'] as Map).cast<String, dynamic>()),
      sensitivityLevel: map['sensitivityLevel'] == null ? null : map['sensitivityLevel'] as String,
      textTransformations: pulumi.Input.decodeList<RuleGroupRuleStatementSqliMatchStatementTextTransformation>(map['textTransformations'], (value) => RuleGroupRuleStatementSqliMatchStatementTextTransformation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
