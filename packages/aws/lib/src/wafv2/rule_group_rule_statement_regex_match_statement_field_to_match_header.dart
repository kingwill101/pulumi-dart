...
import 'rule_group_rule_statement_regex_match_statement_field_to_match_header_match_pattern.dart';
...
class RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeader {
  ...
  final RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern matchPattern;
  ...
  /// Creates a new [RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeader].
  ...
  factory RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeader(
      matchPattern: RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern'] as Map).cast<String, dynamic>()),
