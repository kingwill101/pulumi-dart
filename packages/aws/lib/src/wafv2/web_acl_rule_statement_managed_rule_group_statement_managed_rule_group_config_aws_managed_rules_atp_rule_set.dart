...
class WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSet {
  ...
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSetRequestInspection? requestInspection;
  ...
  final WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSetResponseInspection? responseInspection;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loginPath': loginPath,
      'requestInspection': ?requestInspection == null ? null : requestInspection!.toMap(),
  ...
  factory WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSet.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSet(
      ...
      requestInspection: map['requestInspection'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSetRequestInspection.fromMap((map['requestInspection'] as Map).cast<String, dynamic>()),
      responseInspection: map['responseInspection'] == null ? null : WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAtpRuleSetResponseInspection.fromMap((map['responseInspection'] as Map).cast<String, dynamic>()),
    );
  }
}
