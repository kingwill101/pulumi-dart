...
class WebAclRuleActionCaptchaCustomRequestHandling {
  ...
  final List<WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader> insertHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'insertHeaders': pulumi.Input.encodeList<WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader, Map<String, dynamic>>(insertHeaders, (value) => value.toMap()),
    };
  }
  ...
  factory WebAclRuleActionCaptchaCustomRequestHandling.fromMap(Map<String, dynamic> map) {
    return WebAclRuleActionCaptchaCustomRequestHandling(
      insertHeaders: pulumi.Input.decodeList<WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader>(map['insertHeaders'], (value) => WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
