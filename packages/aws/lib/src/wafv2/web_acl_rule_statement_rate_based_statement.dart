...
class WebAclRuleStatementRateBasedStatement {
  ...
  final WebAclRuleStatementRateBasedStatementForwardedIpConfig? forwardedIpConfig;
  ...
  final WebAclRuleStatementRateBasedStatementScopeDownStatement? scopeDownStatement;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customKeys': ?customKeys == null ? null : pulumi.Input.encodeList<WebAclRuleStatementRateBasedStatementCustomKey, Map<String, dynamic>>(customKeys!, (value) => value.toMap()),
  ...
  factory WebAclRuleStatementRateBasedStatement.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementRateBasedStatement(
      ...
      customKeys: map['customKeys'] == null ? null : pulumi.Input.decodeList<WebAclRuleStatementRateBasedStatementCustomKey>(map['customKeys'], (value) => WebAclRuleStatementRateBasedStatementCustomKey.fromMap((value as Map).cast<String, dynamic>())),
      evaluationWindowSec: map['evaluationWindowSec'] == null ? null : map['evaluationWindowSec'] as int,
      forwardedIpConfig: map['forwardedIpConfig'] == null ? null : WebAclRuleStatementRateBasedStatementForwardedIpConfig.fromMap((map['forwardedIpConfig'] as Map).cast<String, dynamic>()),
      limit: map['limit'] as int,
      scopeDownStatement: map['scopeDownStatement'] == null ? null : WebAclRuleStatementRateBasedStatementScopeDownStatement.fromMap((map['scopeDownStatement'] as Map).cast<String, dynamic>()),
    );
  }
}
