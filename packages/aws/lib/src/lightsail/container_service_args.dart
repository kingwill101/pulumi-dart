...
class ContainerServiceArgs {
  ...
  factory ContainerServiceArgs.fromMap(Map<String, dynamic> map) {
    return ContainerServiceArgs(
      ...
      privateRegistryAccess: map['privateRegistryAccess'] == null ? null : ContainerServicePrivateRegistryAccess.fromMap((map['privateRegistryAccess'] as Map).cast<String, dynamic>()),
      publicDomainNames: map['publicDomainNames'] == null ? null : ContainerServicePublicDomainNames.fromMap((map['publicDomainNames'] as Map).cast<String, dynamic>()),
