...
class DistributionCacheBehaviorSettings {
  ...
  final DistributionCacheBehaviorSettingsForwardedQueryStrings? forwardedQueryStrings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'forwardedCookies': ?forwardedCookies == null ? null : forwardedCookies!.toMap(),
      'forwardedHeaders': ?forwardedHeaders == null ? null : forwardedHeaders!.toMap(),
      'forwardedQueryStrings': ?forwardedQueryStrings == null ? null : forwardedQueryStrings!.toMap(),
  ...
  factory DistributionCacheBehaviorSettings.fromMap(Map<String, dynamic> map) {
    return DistributionCacheBehaviorSettings(
      allowedHttpMethods: map['allowedHttpMethods'] == null ? null : map['allowedHttpMethods'] as String,
      cachedHttpMethods: map['cachedHttpMethods'] == null ? null : map['cachedHttpMethods'] as String,
      defaultTtl: map['defaultTtl'] == null ? null : map['defaultTtl'] as int,
      forwardedCookies: map['forwardedCookies'] == null ? null : DistributionCacheBehaviorSettingsForwardedCookies.fromMap((map['forwardedCookies'] as Map).cast<String, dynamic>()),
      forwardedHeaders: map['forwardedHeaders'] == null ? null : DistributionCacheBehaviorSettingsForwardedHeaders.fromMap((map['forwardedHeaders'] as Map).cast<String, dynamic>()),
      forwardedQueryStrings: map['forwardedQueryStrings'] == null ? null : DistributionCacheBehaviorSettingsForwardedQueryStrings.fromMap((map['forwardedQueryStrings'] as Map).cast<String, dynamic>()),
