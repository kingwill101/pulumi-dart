...
class ContainerService extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ContainerServicePublicDomainNames?> publicDomainNames;
  ...
  ContainerService(
    ...
    this.privateRegistryAccess = registerOutput<ContainerServicePrivateRegistryAccess>('privateRegistryAccess');
    this.publicDomainNames = registerOutput<ContainerServicePublicDomainNames?>('publicDomainNames');
