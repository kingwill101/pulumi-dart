...
class Distribution extends pulumi.CustomResource {
  ...
  Distribution(
    ...
    this.alternativeDomainNames = registerOutput<List<String>>('alternativeDomainNames');
    this.arn = registerOutput<String>('arn');
    this.bundleId = registerOutput<String>('bundleId');
    this.cacheBehaviorSettings = registerOutput<DistributionCacheBehaviorSettings?>('cacheBehaviorSettings');
    this.cacheBehaviors = registerOutput<List<DistributionCacheBehavior>?>('cacheBehaviors');
    ...
    this.origin = registerOutput<DistributionOrigin>('origin');
