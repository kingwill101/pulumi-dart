...
class DistributionArgs {
  ...
  factory DistributionArgs.fromMap(Map<String, dynamic> map) {
    return DistributionArgs(
      ...
      cacheBehaviorSettings: map['cacheBehaviorSettings'] == null ? null : DistributionCacheBehaviorSettings.fromMap((map['cacheBehaviorSettings'] as Map).cast<String, dynamic>()),
      cacheBehaviors: map['cacheBehaviors'] == null ? null : pulumi.Input.decodeList<DistributionCacheBehavior>(map['cacheBehaviors'], (value) => DistributionCacheBehavior.fromMap((value as Map).cast<String, dynamic>())),
      ...
      origin: DistributionOrigin.fromMap((map['origin'] as Map).cast<String, dynamic>()),
