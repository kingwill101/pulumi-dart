...
class RouteServerPeerTimeouts {
  ...
  /// Creates a new [RouteServerPeerTimeouts].
  ...
  RouteServerPeerTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory RouteServerPeerTimeouts.fromMap(Map<String, dynamic> map) {
    return RouteServerPeerTimeouts(
