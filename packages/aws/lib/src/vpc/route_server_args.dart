...
class RouteServerArgs {
  ...
  factory RouteServerArgs.fromMap(Map<String, dynamic> map) {
    return RouteServerArgs(
      ...
      persistRoutes: map['persistRoutes'] == null ? null : map['persistRoutes'] as String,
      persistRoutesDuration: map['persistRoutesDuration'] == null ? null : map['persistRoutesDuration'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      snsNotificationsEnabled: map['snsNotificationsEnabled'] == null ? null : map['snsNotificationsEnabled'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : RouteServerTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
