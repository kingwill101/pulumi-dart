...
class RouteServerArgs {
  ...
  RouteServerArgs({
    ...
    RouteServerTimeouts? timeouts,
        ...
        persistRoutesDuration =
            pulumi.Input.asOptionalInput<int>(persistRoutesDuration),
        region = pulumi.Input.asOptionalInput<String>(region),
        snsNotificationsEnabled =
            pulumi.Input.asOptionalInput<bool>(snsNotificationsEnabled),
  ...
  factory RouteServerArgs.fromMap(Map<String, dynamic> map) {
    return RouteServerArgs(
      ...
      persistRoutes:
          map['persistRoutes'] == null ? null : map['persistRoutes'] as String,
