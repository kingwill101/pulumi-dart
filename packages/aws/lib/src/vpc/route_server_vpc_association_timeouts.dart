...
class RouteServerVpcAssociationTimeouts {
  ...
  /// Creates a new [RouteServerVpcAssociationTimeouts].
  ...
  RouteServerVpcAssociationTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory RouteServerVpcAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return RouteServerVpcAssociationTimeouts(
