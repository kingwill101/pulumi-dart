...
class RouteServerPropagationTimeouts {
  ...
  /// Creates a new [RouteServerPropagationTimeouts].
  ...
  RouteServerPropagationTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory RouteServerPropagationTimeouts.fromMap(Map<String, dynamic> map) {
    return RouteServerPropagationTimeouts(
