...
/// {@template pulumi_vpc_security_group_egress_rule_security_group_egress_rule_args_doc}
/// The set of arguments for SecurityGroupEgressRule.
/// {@endtemplate}
/// {@macro pulumi_vpc_security_group_egress_rule_security_group_egress_rule_args_doc}
class SecurityGroupEgressRuleArgs {
  ...
  /// Creates a new [SecurityGroupEgressRuleArgs].
  ...
  factory SecurityGroupEgressRuleArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGroupEgressRuleArgs(
      ...
      referencedSecurityGroupId: map['referencedSecurityGroupId'] == null ? null : map['referencedSecurityGroupId'] as String,
