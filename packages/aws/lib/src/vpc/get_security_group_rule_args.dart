...
class GetSecurityGroupRuleArgs {
  ...
  GetSecurityGroupRuleArgs({
    ...
    String? securityGroupRuleId,
      ...
      filters = pulumi.Input.asOptionalInput<List<GetSecurityGroupRuleFilter>>(filters),
      region = pulumi.Input.asOptionalInput<String>(region),
      securityGroupRuleId = pulumi.Input.asOptionalInput<String>(securityGroupRuleId);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?pulumi.Input.mapOptionalInputValue<List<GetSecurityGroupRuleFilter>, List<Map<String, dynamic>>>(filters, (value) => pulumi.Input.encodeList<GetSecurityGroupRuleFilter, Map<String, dynamic>>(value, (value) => value.toMap())),
      'region': ?region,
  ...
  factory GetSecurityGroupRuleArgs.fromMap(Map<String, dynamic> map) {
    return GetSecurityGroupRuleArgs(
      ...
      securityGroupRuleId: map['securityGroupRuleId'] == null ? null : map['securityGroupRuleId'] as String,
    );
  }
}
