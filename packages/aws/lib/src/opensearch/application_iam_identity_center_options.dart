...
class ApplicationIamIdentityCenterOptions {
  ...
  factory ApplicationIamIdentityCenterOptions.fromMap(Map<String, dynamic> map) {
    return ApplicationIamIdentityCenterOptions(
      ...
      iamIdentityCenterApplicationArn: map['iamIdentityCenterApplicationArn'] == null ? null : map['iamIdentityCenterApplicationArn'] as String,
      iamIdentityCenterInstanceArn: map['iamIdentityCenterInstanceArn'] == null ? null : map['iamIdentityCenterInstanceArn'] as String,
      iamRoleForIdentityCenterApplicationArn: map['iamRoleForIdentityCenterApplicationArn'] == null ? null : map['iamRoleForIdentityCenterApplicationArn'] as String,
    );
  }
}
