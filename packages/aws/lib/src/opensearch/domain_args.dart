...
class DomainArgs {
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      aimlOptions: map['aimlOptions'] == null ? null : DomainAimlOptions.fromMap((map['aimlOptions'] as Map).cast<String, dynamic>()),
      ...
      identityCenterOptions: map['identityCenterOptions'] == null ? null : DomainIdentityCenterOptions.fromMap((map['identityCenterOptions'] as Map).cast<String, dynamic>()),
      ...
      offPeakWindowOptions: map['offPeakWindowOptions'] == null ? null : DomainOffPeakWindowOptions.fromMap((map['offPeakWindowOptions'] as Map).cast<String, dynamic>()),
      ...
      softwareUpdateOptions: map['softwareUpdateOptions'] == null ? null : DomainSoftwareUpdateOptions.fromMap((map['softwareUpdateOptions'] as Map).cast<String, dynamic>()),
