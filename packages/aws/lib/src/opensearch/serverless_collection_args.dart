...
class ServerlessCollectionArgs {
  ...
  factory ServerlessCollectionArgs.fromMap(Map<String, dynamic> map) {
    return ServerlessCollectionArgs(
      ...
      standbyReplicas: map['standbyReplicas'] == null ? null : map['standbyReplicas'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : ServerlessCollectionTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
