...
class OutboundConnectionArgs {
  ...
  factory OutboundConnectionArgs.fromMap(Map<String, dynamic> map) {
    return OutboundConnectionArgs(
      acceptConnection: map['acceptConnection'] == null ? null : map['acceptConnection'] as bool,
      connectionAlias: map['connectionAlias'] as String,
      connectionMode: map['connectionMode'] == null ? null : map['connectionMode'] as String,
      connectionProperties: map['connectionProperties'] == null ? null : OutboundConnectionConnectionProperties.fromMap((map['connectionProperties'] as Map).cast<String, dynamic>()),
      localDomainInfo: OutboundConnectionLocalDomainInfo.fromMap((map['localDomainInfo'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      remoteDomainInfo: OutboundConnectionRemoteDomainInfo.fromMap((map['remoteDomainInfo'] as Map).cast<String, dynamic>()),
    );
  }
}
