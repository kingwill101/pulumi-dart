...
class ApiArgs {
  ...
  factory ApiArgs.fromMap(Map<String, dynamic> map) {
    return ApiArgs(
      apiKeySelectionExpression: map['apiKeySelectionExpression'] == null ? null : map['apiKeySelectionExpression'] as String,
      body: map['body'] == null ? null : map['body'] as String,
      corsConfiguration: map['corsConfiguration'] == null ? null : ApiCorsConfiguration.fromMap((map['corsConfiguration'] as Map).cast<String, dynamic>()),
      ...
      routeSelectionExpression: map['routeSelectionExpression'] == null ? null : map['routeSelectionExpression'] as String,
