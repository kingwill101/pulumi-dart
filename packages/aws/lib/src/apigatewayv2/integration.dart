...
class Integration extends pulumi.CustomResource {
  ...
  Integration(
    ...
    this.contentHandlingStrategy = registerOutput<String?>(
    ...
    this.integrationResponseSelectionExpression = registerOutput<String>(
    ...
    this.requestParameters = registerOutput<Map<String, String>?>(
      'requestParameters',
    );
    this.requestTemplates = registerOutput<Map<String, String>?>(
      'requestTemplates',
    );
    ...
    this.templateSelectionExpression = registerOutput<String?>(
