...
class Integration extends pulumi.CustomResource {
  ...
  Integration(
    ...
    this.integrationResponseSelectionExpression = registerOutput<String>('integrationResponseSelectionExpression');
    ...
    this.requestParameters = registerOutput<Map<String, String>?>('requestParameters');
    this.requestTemplates = registerOutput<Map<String, String>?>('requestTemplates');
    this.responseParameters = registerOutput<List<IntegrationResponseParameter>?>('responseParameters');
