...
class Api extends pulumi.CustomResource {
  ...
  Api(String name, {ApiArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.apiKeySelectionExpression = registerOutput<String?>(
      'apiKeySelectionExpression',
    );
    this.arn = registerOutput<String>('arn');
    this.body = registerOutput<String?>('body');
    this.corsConfiguration = registerOutput<ApiCorsConfiguration?>(
      'corsConfiguration',
    );
    this.credentialsArn = registerOutput<String?>('credentialsArn');
    this.description = registerOutput<String?>('description');
    this.disableExecuteApiEndpoint = registerOutput<bool?>(
    ...
    this.routeSelectionExpression = registerOutput<String?>(
