...
class RouteArgs {
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      ...
      requestParameters: map['requestParameters'] == null ? null : pulumi.Input.decodeList<RouteRequestParameter>(map['requestParameters'], (value) => RouteRequestParameter.fromMap((value as Map).cast<String, dynamic>())),
      routeKey: map['routeKey'] as String,
      routeResponseSelectionExpression: map['routeResponseSelectionExpression'] == null ? null : map['routeResponseSelectionExpression'] as String,
