...
class IntegrationArgs {
  ...
  IntegrationArgs({
    ...
    IntegrationTlsConfig? tlsConfig,
       ...
       contentHandlingStrategy = pulumi.Input.asOptionalInput<String>(
         contentHandlingStrategy,
       ),
       credentialsArn = pulumi.Input.asOptionalInput<String>(credentialsArn),
       description = pulumi.Input.asOptionalInput<String>(description),
       integrationMethod = pulumi.Input.asOptionalInput<String>(
         integrationMethod,
       ),
       integrationSubtype = pulumi.Input.asOptionalInput<String>(
         integrationSubtype,
       ),
       ...
       passthroughBehavior = pulumi.Input.asOptionalInput<String>(
         passthroughBehavior,
       ),
       payloadFormatVersion = pulumi.Input.asOptionalInput<String>(
       ...
       timeoutMilliseconds = pulumi.Input.asOptionalInput<int>(
         timeoutMilliseconds,
       ),
       tlsConfig = pulumi.Input.asOptionalInput<IntegrationTlsConfig>(
         tlsConfig,
       );
