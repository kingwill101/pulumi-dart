...
class IntegrationArgs {
  ...
  IntegrationArgs({
    ...
    IntegrationTlsConfig? tlsConfig,
        ...
        integrationMethod =
            pulumi.Input.asOptionalInput<String>(integrationMethod),
        integrationSubtype =
            pulumi.Input.asOptionalInput<String>(integrationSubtype),
        ...
        passthroughBehavior =
            pulumi.Input.asOptionalInput<String>(passthroughBehavior),
        payloadFormatVersion =
            pulumi.Input.asOptionalInput<String>(payloadFormatVersion),
        region = pulumi.Input.asOptionalInput<String>(region),
        requestParameters = pulumi.Input.asOptionalInput<Map<String, String>>(
            requestParameters),
        requestTemplates =
            pulumi.Input.asOptionalInput<Map<String, String>>(requestTemplates),
        responseParameters =
        ...
        timeoutMilliseconds =
            pulumi.Input.asOptionalInput<int>(timeoutMilliseconds),
        tlsConfig =
            pulumi.Input.asOptionalInput<IntegrationTlsConfig>(tlsConfig);
  ...
  factory IntegrationArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationArgs(
      ...
      credentialsArn: map['credentialsArn'] == null
          ? null
          : map['credentialsArn'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      integrationMethod: map['integrationMethod'] == null
          ? null
          : map['integrationMethod'] as String,
      integrationSubtype: map['integrationSubtype'] == null
          ? null
          : map['integrationSubtype'] as String,
      integrationType: map['integrationType'] as String,
      integrationUri: map['integrationUri'] == null
          ? null
          : map['integrationUri'] as String,
      passthroughBehavior: map['passthroughBehavior'] == null
          ? null
          : map['passthroughBehavior'] as String,
      payloadFormatVersion: map['payloadFormatVersion'] == null
          ? null
          : map['payloadFormatVersion'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      requestParameters: map['requestParameters'] == null
          ? null
          : (map['requestParameters'] as Map).cast<String, String>(),
      requestTemplates: map['requestTemplates'] == null
          ? null
          : (map['requestTemplates'] as Map).cast<String, String>(),
      ...
      timeoutMilliseconds: map['timeoutMilliseconds'] == null
          ? null
          : map['timeoutMilliseconds'] as int,
