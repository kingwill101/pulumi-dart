...
class IntegrationArgs {
  ...
  IntegrationArgs({
    ...
    List<IntegrationResponseParameter>? responseParameters,
    String? templateSelectionExpression,
    int? timeoutMilliseconds,
    IntegrationTlsConfig? tlsConfig,
  }) :
  ...
  factory IntegrationArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationArgs(
      ...
      credentialsArn: map['credentialsArn'] == null ? null : map['credentialsArn'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      integrationMethod: map['integrationMethod'] == null ? null : map['integrationMethod'] as String,
      integrationSubtype: map['integrationSubtype'] == null ? null : map['integrationSubtype'] as String,
      integrationType: map['integrationType'] as String,
      integrationUri: map['integrationUri'] == null ? null : map['integrationUri'] as String,
      passthroughBehavior: map['passthroughBehavior'] == null ? null : map['passthroughBehavior'] as String,
      payloadFormatVersion: map['payloadFormatVersion'] == null ? null : map['payloadFormatVersion'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      requestParameters: map['requestParameters'] == null ? null : (map['requestParameters'] as Map).cast<String, String>(),
      requestTemplates: map['requestTemplates'] == null ? null : (map['requestTemplates'] as Map).cast<String, String>(),
      responseParameters: map['responseParameters'] == null ? null : pulumi.Input.decodeList<IntegrationResponseParameter>(map['responseParameters'], (value) => IntegrationResponseParameter.fromMap((value as Map).cast<String, dynamic>())),
      templateSelectionExpression: map['templateSelectionExpression'] == null ? null : map['templateSelectionExpression'] as String,
      timeoutMilliseconds: map['timeoutMilliseconds'] == null ? null : map['timeoutMilliseconds'] as int,
      tlsConfig: map['tlsConfig'] == null ? null : IntegrationTlsConfig.fromMap((map['tlsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
