...
class Authorizer extends pulumi.CustomResource {
  ...
  Authorizer(
    ...
    this.authorizerCredentialsArn = registerOutput<String?>(
      'authorizerCredentialsArn',
    );
    this.authorizerPayloadFormatVersion = registerOutput<String?>(
      'authorizerPayloadFormatVersion',
    );
    this.authorizerResultTtlInSeconds = registerOutput<int>(
    ...
    this.jwtConfiguration = registerOutput<AuthorizerJwtConfiguration?>(
      'jwtConfiguration',
    );
