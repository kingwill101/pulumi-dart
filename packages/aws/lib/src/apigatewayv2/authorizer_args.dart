...
class AuthorizerArgs {
  ...
  AuthorizerArgs({
    ...
    String? region,
       ...
       authorizerCredentialsArn = pulumi.Input.asOptionalInput<String>(
       ...
       enableSimpleResponses = pulumi.Input.asOptionalInput<bool>(
         enableSimpleResponses,
       ),
       identitySources = pulumi.Input.asOptionalInput<List<String>>(
         identitySources,
       ),
       jwtConfiguration = pulumi
           .Input.asOptionalInput<AuthorizerJwtConfiguration>(jwtConfiguration),
    ...
    return <String, dynamic>{
      ...
      'jwtConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(jwtConfiguration, (value) => value.toMap()),
      'name': ?name,
      'region': ?region,
    };
  }
  ...
  factory AuthorizerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizerArgs(
      ...
      authorizerUri: map['authorizerUri'] == null
          ? null
          : map['authorizerUri'] as String,
