...
class Stage extends pulumi.CustomResource {
  ...
  Stage(String name, {StageArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.defaultRouteSettings = registerOutput<StageDefaultRouteSettings?>(
    ...
    this.routeSettings = registerOutput<List<StageRouteSetting>?>(
      'routeSettings',
    );
    this.stageVariables = registerOutput<Map<String, String>?>(
      'stageVariables',
    );
