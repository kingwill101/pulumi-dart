...
class Stage extends pulumi.CustomResource {
  ...
  Stage(
    ...
    this.defaultRouteSettings = registerOutput<StageDefaultRouteSettings?>('defaultRouteSettings');
    ...
    this.routeSettings = registerOutput<List<StageRouteSetting>?>('routeSettings');
    this.stageVariables = registerOutput<Map<String, String>?>('stageVariables');
