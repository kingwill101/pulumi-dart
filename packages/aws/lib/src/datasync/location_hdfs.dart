...
class LocationHdfs extends pulumi.CustomResource {
  ...
  LocationHdfs(
    ...
    this.kerberosKrb5ConfBase64 = registerOutput<String?>('kerberosKrb5ConfBase64');
    ...
    this.qopConfiguration = registerOutput<LocationHdfsQopConfiguration>('qopConfiguration');
