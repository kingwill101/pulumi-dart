...
class LocationFsxOntapFileSystemArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'protocol': pulumi.Input.mapInputValue<LocationFsxOntapFileSystemProtocol, Map<String, dynamic>>(protocol, (value) => value.toMap()),
      'region': ?region,
  ...
  factory LocationFsxOntapFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return LocationFsxOntapFileSystemArgs(
      protocol: LocationFsxOntapFileSystemProtocol.fromMap((map['protocol'] as Map).cast<String, dynamic>()),
