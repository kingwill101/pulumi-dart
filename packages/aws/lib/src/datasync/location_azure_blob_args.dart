...
class LocationAzureBlobArgs {
  ...
  LocationAzureBlobArgs({
    ...
    String? region,
    LocationAzureBlobSasConfiguration? sasConfiguration,
    String? subdirectory,
  ...
  factory LocationAzureBlobArgs.fromMap(Map<String, dynamic> map) {
    return LocationAzureBlobArgs(
      accessTier: map['accessTier'] == null
          ? null
          : map['accessTier'] as String,
      agentArns: (map['agentArns'] as List).cast<String>(),
      authenticationType: map['authenticationType'] as String,
      blobType: map['blobType'] == null ? null : map['blobType'] as String,
      containerUrl: map['containerUrl'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sasConfiguration: map['sasConfiguration'] == null
          ? null
          : LocationAzureBlobSasConfiguration.fromMap(
              (map['sasConfiguration'] as Map).cast<String, dynamic>(),
            ),
