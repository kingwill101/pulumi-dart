...
class TaskOptions {
  ...
  factory TaskOptions.fromMap(Map<String, dynamic> map) {
    return TaskOptions(
      ...
      bytesPerSecond: map['bytesPerSecond'] == null
          ? null
          : map['bytesPerSecond'] as int,
      ...
      objectTags: map['objectTags'] == null
          ? null
          : map['objectTags'] as String,
      overwriteMode: map['overwriteMode'] == null
          ? null
          : map['overwriteMode'] as String,
      ...
      taskQueueing: map['taskQueueing'] == null
          ? null
          : map['taskQueueing'] as String,
      transferMode: map['transferMode'] == null
          ? null
          : map['transferMode'] as String,
      uid: map['uid'] == null ? null : map['uid'] as String,
      verifyMode: map['verifyMode'] == null
          ? null
          : map['verifyMode'] as String,
    );
  }
}
