...
class NfsLocationArgs {
  ...
  NfsLocationArgs({
    NfsLocationMountOptions? mountOptions,
    required NfsLocationOnPremConfig onPremConfig,
    String? region,
    required String serverHostname,
    required String subdirectory,
    Map<String, String>? tags,
  })  : mountOptions =
            pulumi.Input.asOptionalInput<NfsLocationMountOptions>(mountOptions),
        onPremConfig =
            pulumi.Input.asInput<NfsLocationOnPremConfig>(onPremConfig),
