...
class TaskArgs {
  ...
  TaskArgs({
    ...
    TaskTaskReportConfig? taskReportConfig,
       ...
       destinationLocationArn = pulumi.Input.asInput<String>(
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      ...
      taskReportConfig: map['taskReportConfig'] == null
          ? null
          : TaskTaskReportConfig.fromMap(
              (map['taskReportConfig'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
