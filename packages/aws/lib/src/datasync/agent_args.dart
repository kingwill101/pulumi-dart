...
class AgentArgs {
  ...
  factory AgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentArgs(
      ...
      privateLinkEndpoint: map['privateLinkEndpoint'] == null ? null : map['privateLinkEndpoint'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      securityGroupArns: map['securityGroupArns'] == null ? null : (map['securityGroupArns'] as List).cast<String>(),
      subnetArns: map['subnetArns'] == null ? null : (map['subnetArns'] as List).cast<String>(),
