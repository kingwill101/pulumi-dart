...
class LocationHdfsArgs {
  ...
  LocationHdfsArgs({
    ...
    Map<String, String>? tags,
        ...
        kerberosKeytabBase64 =
            pulumi.Input.asOptionalInput<String>(kerberosKeytabBase64),
        kerberosKrb5Conf =
            pulumi.Input.asOptionalInput<String>(kerberosKrb5Conf),
        kerberosKrb5ConfBase64 =
            pulumi.Input.asOptionalInput<String>(kerberosKrb5ConfBase64),
        kerberosPrincipal =
            pulumi.Input.asOptionalInput<String>(kerberosPrincipal),
        kmsKeyProviderUri =
            pulumi.Input.asOptionalInput<String>(kmsKeyProviderUri),
        ...
        replicationFactor =
            pulumi.Input.asOptionalInput<int>(replicationFactor),
  ...
  factory LocationHdfsArgs.fromMap(Map<String, dynamic> map) {
    return LocationHdfsArgs(
      ...
      kerberosKeytab: map['kerberosKeytab'] == null
          ? null
          : map['kerberosKeytab'] as String,
      kerberosKeytabBase64: map['kerberosKeytabBase64'] == null
          ? null
          : map['kerberosKeytabBase64'] as String,
      kerberosKrb5Conf: map['kerberosKrb5Conf'] == null
          ? null
          : map['kerberosKrb5Conf'] as String,
      kerberosKrb5ConfBase64: map['kerberosKrb5ConfBase64'] == null
          ? null
          : map['kerberosKrb5ConfBase64'] as String,
      kerberosPrincipal: map['kerberosPrincipal'] == null
          ? null
          : map['kerberosPrincipal'] as String,
      kmsKeyProviderUri: map['kmsKeyProviderUri'] == null
          ? null
          : map['kmsKeyProviderUri'] as String,
      nameNodes: pulumi.Input.decodeList<LocationHdfsNameNode>(
          map['nameNodes'],
          (value) => LocationHdfsNameNode.fromMap(
              (value as Map).cast<String, dynamic>())),
      qopConfiguration: map['qopConfiguration'] == null
          ? null
          : LocationHdfsQopConfiguration.fromMap(
              (map['qopConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      replicationFactor: map['replicationFactor'] == null
          ? null
          : map['replicationFactor'] as int,
      simpleUser:
          map['simpleUser'] == null ? null : map['simpleUser'] as String,
      subdirectory:
