...
class LocationHdfsArgs {
  ...
  LocationHdfsArgs({
    ...
    Map<String, String>? tags,
       ...
       kerberosKeytabBase64 = pulumi.Input.asOptionalInput<String>(
         kerberosKeytabBase64,
       ),
       kerberosKrb5Conf = pulumi.Input.asOptionalInput<String>(
         kerberosKrb5Conf,
       ),
       kerberosKrb5ConfBase64 = pulumi.Input.asOptionalInput<String>(
         kerberosKrb5ConfBase64,
       ),
       kerberosPrincipal = pulumi.Input.asOptionalInput<String>(
         kerberosPrincipal,
       ),
       kmsKeyProviderUri = pulumi.Input.asOptionalInput<String>(
         kmsKeyProviderUri,
       ),
  ...
  factory LocationHdfsArgs.fromMap(Map<String, dynamic> map) {
    return LocationHdfsArgs(
      ...
      simpleUser: map['simpleUser'] == null
          ? null
          : map['simpleUser'] as String,
