...
class RecommendationPreferencesArgs {
  ...
  RecommendationPreferencesArgs({
    ...
    RecommendationPreferencesExternalMetricsPreference? externalMetricsPreference,
    String? inferredWorkloadTypes,
    String? lookBackPeriod,
    List<RecommendationPreferencesPreferredResource>? preferredResources,
    String? region,
    required String resourceType,
    String? savingsEstimationMode,
    required RecommendationPreferencesScope scope,
    List<RecommendationPreferencesUtilizationPreference>? utilizationPreferences,
  }) :
  ...
  factory RecommendationPreferencesArgs.fromMap(Map<String, dynamic> map) {
    return RecommendationPreferencesArgs(
      enhancedInfrastructureMetrics: map['enhancedInfrastructureMetrics'] == null ? null : map['enhancedInfrastructureMetrics'] as String,
      externalMetricsPreference: map['externalMetricsPreference'] == null ? null : RecommendationPreferencesExternalMetricsPreference.fromMap((map['externalMetricsPreference'] as Map).cast<String, dynamic>()),
      inferredWorkloadTypes: map['inferredWorkloadTypes'] == null ? null : map['inferredWorkloadTypes'] as String,
      lookBackPeriod: map['lookBackPeriod'] == null ? null : map['lookBackPeriod'] as String,
      preferredResources: map['preferredResources'] == null ? null : pulumi.Input.decodeList<RecommendationPreferencesPreferredResource>(map['preferredResources'], (value) => RecommendationPreferencesPreferredResource.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      resourceType: map['resourceType'] as String,
      savingsEstimationMode: map['savingsEstimationMode'] == null ? null : map['savingsEstimationMode'] as String,
      scope: RecommendationPreferencesScope.fromMap((map['scope'] as Map).cast<String, dynamic>()),
      utilizationPreferences: map['utilizationPreferences'] == null ? null : pulumi.Input.decodeList<RecommendationPreferencesUtilizationPreference>(map['utilizationPreferences'], (value) => RecommendationPreferencesUtilizationPreference.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
