...
class RecommendationPreferencesArgs {
  ...
  RecommendationPreferencesArgs({
    ...
    List<RecommendationPreferencesUtilizationPreference>?
        utilizationPreferences,
            ...
            pulumi.Input.asOptionalInput<String>(enhancedInfrastructureMetrics),
        externalMetricsPreference = pulumi.Input.asOptionalInput<
                RecommendationPreferencesExternalMetricsPreference>(
            externalMetricsPreference),
        inferredWorkloadTypes =
            pulumi.Input.asOptionalInput<String>(inferredWorkloadTypes),
        ...
        savingsEstimationMode =
            pulumi.Input.asOptionalInput<String>(savingsEstimationMode),
  ...
  factory RecommendationPreferencesArgs.fromMap(Map<String, dynamic> map) {
    return RecommendationPreferencesArgs(
      enhancedInfrastructureMetrics:
          map['enhancedInfrastructureMetrics'] == null
              ? null
              : map['enhancedInfrastructureMetrics'] as String,
      externalMetricsPreference: map['externalMetricsPreference'] == null
          ? null
          : RecommendationPreferencesExternalMetricsPreference.fromMap(
              (map['externalMetricsPreference'] as Map)
                  .cast<String, dynamic>()),
      inferredWorkloadTypes: map['inferredWorkloadTypes'] == null
          ? null
          : map['inferredWorkloadTypes'] as String,
      lookBackPeriod: map['lookBackPeriod'] == null
          ? null
          : map['lookBackPeriod'] as String,
      preferredResources: map['preferredResources'] == null
          ? null
      ...
      scope: RecommendationPreferencesScope.fromMap(
          (map['scope'] as Map).cast<String, dynamic>()),
      utilizationPreferences: map['utilizationPreferences'] == null
          ? null
