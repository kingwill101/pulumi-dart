...
class UserArgs {
  ...
  UserArgs({
    ...
    String? userType,
        ...
        phoneNumbers =
            pulumi.Input.asOptionalInput<UserPhoneNumbers>(phoneNumbers),
        preferredLanguage =
            pulumi.Input.asOptionalInput<String>(preferredLanguage),
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      ...
      profileUrl:
          map['profileUrl'] == null ? null : map['profileUrl'] as String,
