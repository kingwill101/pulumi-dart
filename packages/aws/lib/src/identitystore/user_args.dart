...
class UserArgs {
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      addresses: map['addresses'] == null ? null : UserAddresses.fromMap((map['addresses'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      emails: map['emails'] == null ? null : UserEmails.fromMap((map['emails'] as Map).cast<String, dynamic>()),
      identityStoreId: map['identityStoreId'] as String,
      locale: map['locale'] == null ? null : map['locale'] as String,
      name: map['name'] == null ? null : UserName.fromMap((map['name'] as Map).cast<String, dynamic>()),
      nickname: map['nickname'] == null ? null : map['nickname'] as String,
      phoneNumbers: map['phoneNumbers'] == null ? null : UserPhoneNumbers.fromMap((map['phoneNumbers'] as Map).cast<String, dynamic>()),
      preferredLanguage: map['preferredLanguage'] == null ? null : map['preferredLanguage'] as String,
      profileUrl: map['profileUrl'] == null ? null : map['profileUrl'] as String,
