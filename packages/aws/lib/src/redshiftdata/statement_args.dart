...
class StatementArgs {
  ...
  factory StatementArgs.fromMap(Map<String, dynamic> map) {
    return StatementArgs(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<StatementParameter>(map['parameters'], (value) => StatementParameter.fromMap((value as Map).cast<String, dynamic>())),
