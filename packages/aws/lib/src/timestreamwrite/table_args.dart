...
class TableArgs {
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      ...
      magneticStoreWriteProperties: map['magneticStoreWriteProperties'] == null ? null : TableMagneticStoreWriteProperties.fromMap((map['magneticStoreWriteProperties'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      retentionProperties: map['retentionProperties'] == null ? null : TableRetentionProperties.fromMap((map['retentionProperties'] as Map).cast<String, dynamic>()),
