...
class InsightFiltersLastObservedAt {
  ...
  final InsightFiltersLastObservedAtDateRange? dateRange;
  ...
  factory InsightFiltersLastObservedAt.fromMap(Map<String, dynamic> map) {
    return InsightFiltersLastObservedAt(
      dateRange: map['dateRange'] == null ? null : InsightFiltersLastObservedAtDateRange.fromMap((map['dateRange'] as Map).cast<String, dynamic>()),
