...
class ConfigurationPolicyConfigurationPolicy {
  ...
  final ConfigurationPolicyConfigurationPolicySecurityControlsConfiguration? securityControlsConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'securityControlsConfiguration': ?securityControlsConfiguration == null ? null : securityControlsConfiguration!.toMap(),
  ...
  factory ConfigurationPolicyConfigurationPolicy.fromMap(Map<String, dynamic> map) {
    return ConfigurationPolicyConfigurationPolicy(
      enabledStandardArns: map['enabledStandardArns'] == null ? null : (map['enabledStandardArns'] as List).cast<String>(),
      securityControlsConfiguration: map['securityControlsConfiguration'] == null ? null : ConfigurationPolicyConfigurationPolicySecurityControlsConfiguration.fromMap((map['securityControlsConfiguration'] as Map).cast<String, dynamic>()),
