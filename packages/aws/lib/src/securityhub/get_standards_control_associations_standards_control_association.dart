...
class GetStandardsControlAssociationsStandardsControlAssociation {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['relatedRequirements'] = relatedRequirements;
    map['securityControlArn'] = securityControlArn;
    map['securityControlId'] = securityControlId;
    map['standardsArn'] = standardsArn;
    map['standardsControlDescription'] = standardsControlDescription;
    map['standardsControlTitle'] = standardsControlTitle;
    map['updatedAt'] = updatedAt;
    map['updatedReason'] = updatedReason;
    return map;
  }
