...
class OrganizationConfigurationArgs {
  ...
  OrganizationConfigurationArgs({
    ...
    OrganizationConfigurationOrganizationConfiguration? organizationConfiguration,
    String? region,
  }) :
  ...
  factory OrganizationConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationConfigurationArgs(
      ...
      autoEnableStandards: map['autoEnableStandards'] == null ? null : map['autoEnableStandards'] as String,
      organizationConfiguration: map['organizationConfiguration'] == null ? null : OrganizationConfigurationOrganizationConfiguration.fromMap((map['organizationConfiguration'] as Map).cast<String, dynamic>()),
