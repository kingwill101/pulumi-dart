...
class AutomationRuleCriteria {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsAccountIds': ?awsAccountIds == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaAwsAccountId,
              Map<String, dynamic>
            >(awsAccountIds!, (value) => value.toMap()),
      'awsAccountNames': ?awsAccountNames == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaAwsAccountName,
              Map<String, dynamic>
            >(awsAccountNames!, (value) => value.toMap()),
      'companyNames': ?companyNames == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaCompanyName,
              Map<String, dynamic>
            >(companyNames!, (value) => value.toMap()),
      'complianceAssociatedStandardsIds':
          ?complianceAssociatedStandardsIds == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaComplianceAssociatedStandardsId,
              Map<String, dynamic>
            >(complianceAssociatedStandardsIds!, (value) => value.toMap()),
      'complianceSecurityControlIds': ?complianceSecurityControlIds == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaComplianceSecurityControlId,
              Map<String, dynamic>
            >(complianceSecurityControlIds!, (value) => value.toMap()),
      'complianceStatuses': ?complianceStatuses == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaComplianceStatus,
              Map<String, dynamic>
            >(complianceStatuses!, (value) => value.toMap()),
      'confidences': ?confidences == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaConfidence,
              Map<String, dynamic>
            >(confidences!, (value) => value.toMap()),
      'createdAts': ?createdAts == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaCreatedAt,
              Map<String, dynamic>
            >(createdAts!, (value) => value.toMap()),
      'criticalities': ?criticalities == null
          ? null
          : pulumi.Input.encodeList<
      ...
      'descriptions': ?descriptions == null
          ...
          : pulumi.Input.encodeList<
              ...
              Map<String, dynamic>
            >(descriptions!, (value) => value.toMap()),
      'firstObservedAts': ?firstObservedAts == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaFirstObservedAt,
              Map<String, dynamic>
            >(firstObservedAts!, (value) => value.toMap()),
      'generatorIds': ?generatorIds == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaGeneratorId,
              Map<String, dynamic>
            >(generatorIds!, (value) => value.toMap()),
      'ids': ?ids == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaId,
              Map<String, dynamic>
            >(ids!, (value) => value.toMap()),
      'lastObservedAts': ?lastObservedAts == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaLastObservedAt,
              Map<String, dynamic>
            >(lastObservedAts!, (value) => value.toMap()),
      'noteTexts': ?noteTexts == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaNoteText,
              Map<String, dynamic>
            >(noteTexts!, (value) => value.toMap()),
      'noteUpdatedAts': ?noteUpdatedAts == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaNoteUpdatedAt,
              Map<String, dynamic>
            >(noteUpdatedAts!, (value) => value.toMap()),
      'noteUpdatedBies': ?noteUpdatedBies == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaNoteUpdatedBy,
              Map<String, dynamic>
            >(noteUpdatedBies!, (value) => value.toMap()),
      'productArns': ?productArns == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaProductArn,
              Map<String, dynamic>
            >(productArns!, (value) => value.toMap()),
      'productNames': ?productNames == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaProductName,
              Map<String, dynamic>
            >(productNames!, (value) => value.toMap()),
      'recordStates': ?recordStates == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaRecordState,
              Map<String, dynamic>
            >(recordStates!, (value) => value.toMap()),
      'relatedFindingsIds': ?relatedFindingsIds == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaRelatedFindingsId,
              Map<String, dynamic>
            >(relatedFindingsIds!, (value) => value.toMap()),
      'relatedFindingsProductArns': ?relatedFindingsProductArns == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaRelatedFindingsProductArn,
              Map<String, dynamic>
            >(relatedFindingsProductArns!, (value) => value.toMap()),
      'resourceApplicationArns': ?resourceApplicationArns == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourceApplicationArn,
              Map<String, dynamic>
            >(resourceApplicationArns!, (value) => value.toMap()),
      'resourceApplicationNames': ?resourceApplicationNames == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourceApplicationName,
              Map<String, dynamic>
            >(resourceApplicationNames!, (value) => value.toMap()),
      'resourceDetailsOthers': ?resourceDetailsOthers == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourceDetailsOther,
              Map<String, dynamic>
            >(resourceDetailsOthers!, (value) => value.toMap()),
      'resourceIds': ?resourceIds == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourceId,
              Map<String, dynamic>
            >(resourceIds!, (value) => value.toMap()),
      'resourcePartitions': ?resourcePartitions == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourcePartition,
              Map<String, dynamic>
            >(resourcePartitions!, (value) => value.toMap()),
      'resourceRegions': ?resourceRegions == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourceRegion,
              Map<String, dynamic>
            >(resourceRegions!, (value) => value.toMap()),
      'resourceTags': ?resourceTags == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourceTag,
              Map<String, dynamic>
            >(resourceTags!, (value) => value.toMap()),
      'resourceTypes': ?resourceTypes == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaResourceType,
              Map<String, dynamic>
            >(resourceTypes!, (value) => value.toMap()),
      'severityLabels': ?severityLabels == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaSeverityLabel,
              Map<String, dynamic>
            >(severityLabels!, (value) => value.toMap()),
      'sourceUrls': ?sourceUrls == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaSourceUrl,
              Map<String, dynamic>
            >(sourceUrls!, (value) => value.toMap()),
      'titles': ?titles == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaTitle,
              Map<String, dynamic>
            >(titles!, (value) => value.toMap()),
      'types': ?types == null
          ? null
          : pulumi.Input.encodeList<
      ...
      'updatedAts': ?updatedAts == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaUpdatedAt,
              Map<String, dynamic>
            >(updatedAts!, (value) => value.toMap()),
      ...
      'verificationStates': ?verificationStates == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaVerificationState,
              Map<String, dynamic>
            >(verificationStates!, (value) => value.toMap()),
      'workflowStatuses': ?workflowStatuses == null
          ? null
          : pulumi.Input.encodeList<
              AutomationRuleCriteriaWorkflowStatus,
              Map<String, dynamic>
            >(workflowStatuses!, (value) => value.toMap()),
    };
  }
