...
class AutomationRuleArgs {
  ...
  factory AutomationRuleArgs.fromMap(Map<String, dynamic> map) {
    return AutomationRuleArgs(
      actions: pulumi.Input.decodeList<AutomationRuleAction>(map['actions'], (value) => AutomationRuleAction.fromMap((value as Map).cast<String, dynamic>())),
      criteria: AutomationRuleCriteria.fromMap((map['criteria'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      isTerminal: map['isTerminal'] == null ? null : map['isTerminal'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      ruleName: map['ruleName'] as String,
      ruleOrder: map['ruleOrder'] as int,
      ruleStatus: map['ruleStatus'] == null ? null : map['ruleStatus'] as String,
