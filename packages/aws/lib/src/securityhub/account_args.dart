...
class AccountArgs {
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      autoEnableControls: map['autoEnableControls'] == null ? null : map['autoEnableControls'] as bool,
      controlFindingGenerator: map['controlFindingGenerator'] == null ? null : map['controlFindingGenerator'] as String,
      enableDefaultStandards: map['enableDefaultStandards'] == null ? null : map['enableDefaultStandards'] as bool,
