...
class AccountArgs {
  ...
  AccountArgs({
    ...
    String? region,
  }) : autoEnableControls = pulumi.Input.asOptionalInput<bool>(
         autoEnableControls,
       ),
       controlFindingGenerator = pulumi.Input.asOptionalInput<String>(
         controlFindingGenerator,
       ),
       enableDefaultStandards = pulumi.Input.asOptionalInput<bool>(
