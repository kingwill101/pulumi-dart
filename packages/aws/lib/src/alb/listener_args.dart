...
class ListenerArgs {
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      ...
      defaultActions: pulumi.Input.decodeList<ListenerDefaultAction>(map['defaultActions'], (value) => ListenerDefaultAction.fromMap((value as Map).cast<String, dynamic>())),
      loadBalancerArn: map['loadBalancerArn'] as String,
      mutualAuthentication: map['mutualAuthentication'] == null ? null : ListenerMutualAuthentication.fromMap((map['mutualAuthentication'] as Map).cast<String, dynamic>()),
