...
class ListenerArgs {
  ...
  ListenerArgs({
    ...
    required List<ListenerDefaultAction> defaultActions,
    required String loadBalancerArn,
    ListenerMutualAuthentication? mutualAuthentication,
    int? port,
    String? protocol,
    String? region,
    ...
    bool? routingHttpResponseServerEnabled,
    ...
    int? tcpIdleTimeoutSeconds,
       ...
       defaultActions = pulumi.Input.asInput<List<ListenerDefaultAction>>(
         defaultActions,
       ),
       loadBalancerArn = pulumi.Input.asInput<String>(loadBalancerArn),
       mutualAuthentication =
           pulumi.Input.asOptionalInput<ListenerMutualAuthentication>(
             mutualAuthentication,
           ),
       ...
       tcpIdleTimeoutSeconds = pulumi.Input.asOptionalInput<int>(
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      alpnPolicy: map['alpnPolicy'] == null
          ? null
          : map['alpnPolicy'] as String,
      certificateArn: map['certificateArn'] == null
          ? null
          : map['certificateArn'] as String,
      defaultActions: pulumi.Input.decodeList<ListenerDefaultAction>(
        map['defaultActions'],
      ...
      mutualAuthentication: map['mutualAuthentication'] == null
          ? null
          : ListenerMutualAuthentication.fromMap(
      ...
      routingHttpRequestXAmznMtlsClientcertHeaderName:
          ...
          ? null
          : map['routingHttpRequestXAmznMtlsClientcertHeaderName'] as String,
      routingHttpRequestXAmznMtlsClientcertIssuerHeaderName:
      ...
      routingHttpRequestXAmznTlsCipherSuiteHeaderName:
          ...
          ? null
          : map['routingHttpRequestXAmznTlsCipherSuiteHeaderName'] as String,
      routingHttpRequestXAmznTlsVersionHeaderName:
      ...
      routingHttpResponseAccessControlMaxAgeHeaderValue:
          ...
          ? null
          : map['routingHttpResponseAccessControlMaxAgeHeaderValue'] as String,
      routingHttpResponseContentSecurityPolicyHeaderValue:
      ...
      routingHttpResponseXContentTypeOptionsHeaderValue:
          ...
          ? null
          : map['routingHttpResponseXContentTypeOptionsHeaderValue'] as String,
      routingHttpResponseXFrameOptionsHeaderValue:
