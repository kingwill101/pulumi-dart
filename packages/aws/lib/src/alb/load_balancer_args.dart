...
class LoadBalancerArgs {
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      accessLogs: map['accessLogs'] == null ? null : LoadBalancerAccessLogs.fromMap((map['accessLogs'] as Map).cast<String, dynamic>()),
      clientKeepAlive: map['clientKeepAlive'] == null ? null : map['clientKeepAlive'] as int,
      connectionLogs: map['connectionLogs'] == null ? null : LoadBalancerConnectionLogs.fromMap((map['connectionLogs'] as Map).cast<String, dynamic>()),
      ...
      healthCheckLogs: map['healthCheckLogs'] == null ? null : LoadBalancerHealthCheckLogs.fromMap((map['healthCheckLogs'] as Map).cast<String, dynamic>()),
      ...
      ipamPools: map['ipamPools'] == null ? null : LoadBalancerIpamPools.fromMap((map['ipamPools'] as Map).cast<String, dynamic>()),
      loadBalancerType: map['loadBalancerType'] == null ? null : LoadBalancerType.fromValue(map['loadBalancerType'] as String),
      minimumLoadBalancerCapacity: map['minimumLoadBalancerCapacity'] == null ? null : LoadBalancerMinimumLoadBalancerCapacity.fromMap((map['minimumLoadBalancerCapacity'] as Map).cast<String, dynamic>()),
      ...
      subnetMappings: map['subnetMappings'] == null ? null : pulumi.Input.decodeList<LoadBalancerSubnetMapping>(map['subnetMappings'], (value) => LoadBalancerSubnetMapping.fromMap((value as Map).cast<String, dynamic>())),
