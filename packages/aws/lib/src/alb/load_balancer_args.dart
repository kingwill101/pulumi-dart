...
class LoadBalancerArgs {
  ...
  LoadBalancerArgs({
    ...
    String? xffHeaderProcessingMode,
       ...
       connectionLogs = pulumi
           .Input.asOptionalInput<LoadBalancerConnectionLogs>(connectionLogs),
       ...
       healthCheckLogs = pulumi
           .Input.asOptionalInput<LoadBalancerHealthCheckLogs>(healthCheckLogs),
       ...
       ipamPools = pulumi.Input.asOptionalInput<LoadBalancerIpamPools>(
         ipamPools,
       ),
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      loadBalancerType: map['loadBalancerType'] == null
          ? null
          : LoadBalancerType.fromValue(map['loadBalancerType'] as String),
