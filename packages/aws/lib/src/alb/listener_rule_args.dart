...
class ListenerRuleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': pulumi.Input.mapInputValue<List<ListenerRuleAction>, List<Map<String, dynamic>>>(actions, (value) => pulumi.Input.encodeList<ListenerRuleAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'conditions': pulumi.Input.mapInputValue<List<ListenerRuleCondition>, List<Map<String, dynamic>>>(conditions, (value) => pulumi.Input.encodeList<ListenerRuleCondition, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ListenerRuleArgs.fromMap(Map<String, dynamic> map) {
    return ListenerRuleArgs(
      actions: pulumi.Input.decodeList<ListenerRuleAction>(map['actions'], (value) => ListenerRuleAction.fromMap((value as Map).cast<String, dynamic>())),
      conditions: pulumi.Input.decodeList<ListenerRuleCondition>(map['conditions'], (value) => ListenerRuleCondition.fromMap((value as Map).cast<String, dynamic>())),
      listenerArn: map['listenerArn'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      transforms: map['transforms'] == null ? null : pulumi.Input.decodeList<ListenerRuleTransform>(map['transforms'], (value) => ListenerRuleTransform.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
