...
class LoadBalancer extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LoadBalancerMinimumLoadBalancerCapacity?>
  ...
  LoadBalancer(
    ...
    this.connectionLogs = registerOutput<LoadBalancerConnectionLogs?>(
      'connectionLogs',
    );
    ...
    this.dnsRecordClientRoutingPolicy = registerOutput<String?>(
      'dnsRecordClientRoutingPolicy',
    );
    this.dropInvalidHeaderFields = registerOutput<bool?>(
      'dropInvalidHeaderFields',
    );
    this.enableCrossZoneLoadBalancing = registerOutput<bool?>(
      'enableCrossZoneLoadBalancing',
    );
    this.enableDeletionProtection = registerOutput<bool?>(
      'enableDeletionProtection',
    );
    this.enableHttp2 = registerOutput<bool?>('enableHttp2');
    this.enableTlsVersionAndCipherSuiteHeaders = registerOutput<bool?>(
    ...
    this.healthCheckLogs = registerOutput<LoadBalancerHealthCheckLogs?>(
      'healthCheckLogs',
    );
    ...
    this.loadBalancerType = registerOutput<LoadBalancerType?>(
      'loadBalancerType',
    );
    ...
    this.secondaryIpsAutoAssignedPerSubnet = registerOutput<int>(
      'secondaryIpsAutoAssignedPerSubnet',
    );
    this.securityGroups = registerOutput<List<String>>('securityGroups');
    this.subnetMappings = registerOutput<List<LoadBalancerSubnetMapping>>(
      'subnetMappings',
    );
    ...
    this.xffHeaderProcessingMode = registerOutput<String?>(
