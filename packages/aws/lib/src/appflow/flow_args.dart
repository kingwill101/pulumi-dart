...
class FlowArgs {
  ...
  factory FlowArgs.fromMap(Map<String, dynamic> map) {
    return FlowArgs(
      ...
      destinationFlowConfigs: pulumi.Input.decodeList<FlowDestinationFlowConfig>(map['destinationFlowConfigs'], (value) => FlowDestinationFlowConfig.fromMap((value as Map).cast<String, dynamic>())),
      kmsArn: map['kmsArn'] == null ? null : map['kmsArn'] as String,
      metadataCatalogConfig: map['metadataCatalogConfig'] == null ? null : FlowMetadataCatalogConfig.fromMap((map['metadataCatalogConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sourceFlowConfig: FlowSourceFlowConfig.fromMap((map['sourceFlowConfig'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tasks: pulumi.Input.decodeList<FlowTask>(map['tasks'], (value) => FlowTask.fromMap((value as Map).cast<String, dynamic>())),
      triggerConfig: FlowTriggerConfig.fromMap((map['triggerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
