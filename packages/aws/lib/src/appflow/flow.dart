...
class Flow extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FlowDestinationFlowConfig>>
  destinationFlowConfigs;
  ...
  Flow(String name, {FlowArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.metadataCatalogConfig = registerOutput<FlowMetadataCatalogConfig>(
      'metadataCatalogConfig',
    );
    this.name = registerOutput<String>('name');
    this.region = registerOutput<String>('region');
    this.sourceFlowConfig = registerOutput<FlowSourceFlowConfig>(
      'sourceFlowConfig',
    );
