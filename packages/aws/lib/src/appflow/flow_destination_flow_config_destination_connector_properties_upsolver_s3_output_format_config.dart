...
class FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfig {
  ...
  final FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigAggregationConfig?
      aggregationConfig;
  ...
  final FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigPrefixConfig
      prefixConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['prefixConfig'] = prefixConfig.toMap();
    return map;
  }
