...
class FlowSourceFlowConfigSourceConnectorPropertiesS3 {
  ...
  final FlowSourceFlowConfigSourceConnectorPropertiesS3S3InputFormatConfig? s3InputFormatConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      's3InputFormatConfig': ?s3InputFormatConfig == null ? null : s3InputFormatConfig!.toMap(),
    };
  }
  ...
  factory FlowSourceFlowConfigSourceConnectorPropertiesS3.fromMap(Map<String, dynamic> map) {
    return FlowSourceFlowConfigSourceConnectorPropertiesS3(
      ...
      s3InputFormatConfig: map['s3InputFormatConfig'] == null ? null : FlowSourceFlowConfigSourceConnectorPropertiesS3S3InputFormatConfig.fromMap((map['s3InputFormatConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
