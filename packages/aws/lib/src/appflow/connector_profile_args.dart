...
class ConnectorProfileArgs {
    ...
    return <String, dynamic>{
      ...
      'connectorProfileConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(connectorProfileConfig, (value) => value.toMap()),
  ...
  factory ConnectorProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorProfileArgs(
      ...
      connectorLabel: map['connectorLabel'] == null
          ? null
          : map['connectorLabel'] as String,
      connectorProfileConfig: ConnectorProfileConnectorProfileConfig.fromMap(
        (map['connectorProfileConfig'] as Map).cast<String, dynamic>(),
      ),
