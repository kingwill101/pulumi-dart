...
class ConnectorProfileArgs {
  ...
  ConnectorProfileArgs({
    ...
    required ConnectorProfileConnectorProfileConfig connectorProfileConfig,
  ...
  factory ConnectorProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorProfileArgs(
      ...
      connectorLabel: map['connectorLabel'] == null ? null : map['connectorLabel'] as String,
      connectorProfileConfig: ConnectorProfileConnectorProfileConfig.fromMap((map['connectorProfileConfig'] as Map).cast<String, dynamic>()),
