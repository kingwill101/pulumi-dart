...
class FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig {
  ...
  /// Creates a new [FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig].
  ...
  factory FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig.fromMap(
      Map<String, dynamic> map) {
    return FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig(
      bucketName:
