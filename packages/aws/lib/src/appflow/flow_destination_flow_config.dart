...
class FlowDestinationFlowConfig {
  ...
  final FlowDestinationFlowConfigDestinationConnectorProperties destinationConnectorProperties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinationConnectorProperties': destinationConnectorProperties.toMap(),
    };
  }
  ...
  factory FlowDestinationFlowConfig.fromMap(Map<String, dynamic> map) {
    return FlowDestinationFlowConfig(
      ...
      destinationConnectorProperties: FlowDestinationFlowConfigDestinationConnectorProperties.fromMap((map['destinationConnectorProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
