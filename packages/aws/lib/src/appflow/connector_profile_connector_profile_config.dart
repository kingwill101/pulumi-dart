...
class ConnectorProfileConnectorProfileConfig {
  ...
  final ConnectorProfileConnectorProfileConfigConnectorProfileCredentials connectorProfileCredentials;
  /// The connector-specific properties of the profile configuration. See Connector Profile Properties for more details.
  final ConnectorProfileConnectorProfileConfigConnectorProfileProperties connectorProfileProperties;
  ...
  factory ConnectorProfileConnectorProfileConfig.fromMap(Map<String, dynamic> map) {
    return ConnectorProfileConnectorProfileConfig(
      connectorProfileCredentials: ConnectorProfileConnectorProfileConfigConnectorProfileCredentials.fromMap((map['connectorProfileCredentials'] as Map).cast<String, dynamic>()),
      connectorProfileProperties: ConnectorProfileConnectorProfileConfigConnectorProfileProperties.fromMap((map['connectorProfileProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
