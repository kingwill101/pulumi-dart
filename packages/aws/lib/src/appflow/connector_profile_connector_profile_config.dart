...
class ConnectorProfileConnectorProfileConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['connectorProfileCredentials'] = connectorProfileCredentials.toMap();
    map['connectorProfileProperties'] = connectorProfileProperties.toMap();
    return map;
  }
    ...
    return ConnectorProfileConnectorProfileConfig(
      connectorProfileCredentials:
          ConnectorProfileConnectorProfileConfigConnectorProfileCredentials
              .fromMap((map['connectorProfileCredentials'] as Map)
                  .cast<String, dynamic>()),
      connectorProfileProperties:
          ConnectorProfileConnectorProfileConfigConnectorProfileProperties
              .fromMap((map['connectorProfileProperties'] as Map)
                  .cast<String, dynamic>()),
    );
  }
}
