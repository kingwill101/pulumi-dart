...
class EventConnectionArgs {
  ...
  EventConnectionArgs({
    ...
    String? region,
            ...
            pulumi.Input.asInput<EventConnectionAuthParameters>(authParameters),
