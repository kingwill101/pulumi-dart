...
class EventConnectionArgs {
  ...
  EventConnectionArgs({
    required EventConnectionAuthParameters authParameters,
    required String authorizationType,
    String? description,
    EventConnectionInvocationConnectivityParameters? invocationConnectivityParameters,
  ...
  factory EventConnectionArgs.fromMap(Map<String, dynamic> map) {
    return EventConnectionArgs(
      authParameters: EventConnectionAuthParameters.fromMap((map['authParameters'] as Map).cast<String, dynamic>()),
      authorizationType: map['authorizationType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      invocationConnectivityParameters: map['invocationConnectivityParameters'] == null ? null : EventConnectionInvocationConnectivityParameters.fromMap((map['invocationConnectivityParameters'] as Map).cast<String, dynamic>()),
