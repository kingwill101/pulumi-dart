...
class MetricAlarmArgs {
  ...
  MetricAlarmArgs({
    ...
    String? unit,
       ...
       evaluateLowSampleCountPercentiles = pulumi.Input.asOptionalInput<String>(
         evaluateLowSampleCountPercentiles,
       ),
       evaluationPeriods = pulumi.Input.asInput<int>(evaluationPeriods),
       extendedStatistic = pulumi.Input.asOptionalInput<String>(
         extendedStatistic,
       ),
       ...
       metricQueries = pulumi
           .Input.asOptionalInput<List<MetricAlarmMetricQuery>>(metricQueries),
       ...
       thresholdMetricId = pulumi.Input.asOptionalInput<String>(
         thresholdMetricId,
       ),
       treatMissingData = pulumi.Input.asOptionalInput<String>(
         treatMissingData,
       ),
