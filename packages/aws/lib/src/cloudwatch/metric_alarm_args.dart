...
class MetricAlarmArgs {
  ...
  factory MetricAlarmArgs.fromMap(Map<String, dynamic> map) {
    return MetricAlarmArgs(
      ...
      evaluateLowSampleCountPercentiles: map['evaluateLowSampleCountPercentiles'] == null ? null : map['evaluateLowSampleCountPercentiles'] as String,
      ...
      metricQueries: map['metricQueries'] == null ? null : pulumi.Input.decodeList<MetricAlarmMetricQuery>(map['metricQueries'], (value) => MetricAlarmMetricQuery.fromMap((value as Map).cast<String, dynamic>())),
