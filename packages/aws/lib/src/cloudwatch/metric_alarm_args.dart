...
class MetricAlarmArgs {
  ...
  MetricAlarmArgs({
    ...
    String? metricName,
    List<MetricAlarmMetricQuery>? metricQueries,
    String? name,
    String? namespace,
    ...
    String? unit,
        ...
        datapointsToAlarm =
            pulumi.Input.asOptionalInput<int>(datapointsToAlarm),
        dimensions =
        ...
        extendedStatistic =
            pulumi.Input.asOptionalInput<String>(extendedStatistic),
        ...
        metricQueries =
            pulumi.Input.asOptionalInput<List<MetricAlarmMetricQuery>>(
                metricQueries),
        ...
        thresholdMetricId =
            pulumi.Input.asOptionalInput<String>(thresholdMetricId),
        treatMissingData =
            pulumi.Input.asOptionalInput<String>(treatMissingData),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (metricQueriesValue != null) {
      map['metricQueries'] = pulumi.Input.mapOptionalInputValue<
              List<MetricAlarmMetricQuery>, List<Map<String, dynamic>>>(
          metricQueriesValue,
          (value) => pulumi.Input.encodeList<MetricAlarmMetricQuery,
  ...
  factory MetricAlarmArgs.fromMap(Map<String, dynamic> map) {
    return MetricAlarmArgs(
      ...
      datapointsToAlarm: map['datapointsToAlarm'] == null
          ? null
          : map['datapointsToAlarm'] as int,
      dimensions: map['dimensions'] == null
          ? null
          : (map['dimensions'] as Map).cast<String, String>(),
      evaluateLowSampleCountPercentiles:
          map['evaluateLowSampleCountPercentiles'] == null
              ? null
              : map['evaluateLowSampleCountPercentiles'] as String,
      evaluationPeriods: map['evaluationPeriods'] as int,
      extendedStatistic: map['extendedStatistic'] == null
          ? null
          : map['extendedStatistic'] as String,
      ...
      metricQueries: map['metricQueries'] == null
          ? null
      ...
      thresholdMetricId: map['thresholdMetricId'] == null
          ? null
          : map['thresholdMetricId'] as String,
      treatMissingData: map['treatMissingData'] == null
          ? null
          : map['treatMissingData'] as String,
