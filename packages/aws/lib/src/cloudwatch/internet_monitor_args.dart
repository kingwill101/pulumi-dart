...
class InternetMonitorArgs {
  ...
  InternetMonitorArgs({
    ...
    InternetMonitorInternetMeasurementsLogDelivery? internetMeasurementsLogDelivery,
  ...
  factory InternetMonitorArgs.fromMap(Map<String, dynamic> map) {
    return InternetMonitorArgs(
      healthEventsConfig: map['healthEventsConfig'] == null ? null : InternetMonitorHealthEventsConfig.fromMap((map['healthEventsConfig'] as Map).cast<String, dynamic>()),
      internetMeasurementsLogDelivery: map['internetMeasurementsLogDelivery'] == null ? null : InternetMonitorInternetMeasurementsLogDelivery.fromMap((map['internetMeasurementsLogDelivery'] as Map).cast<String, dynamic>()),
      maxCityNetworksToMonitor: map['maxCityNetworksToMonitor'] == null ? null : map['maxCityNetworksToMonitor'] as int,
      ...
      trafficPercentageToMonitor: map['trafficPercentageToMonitor'] == null ? null : map['trafficPercentageToMonitor'] as int,
    );
  }
}
