...
class LogAnomalyDetectorArgs {
  ...
  }) : anomalyVisibilityTime = pulumi.Input.asOptionalInput<int>(
         anomalyVisibilityTime,
       ),
       detectorName = pulumi.Input.asOptionalInput<String>(detectorName),
       enabled = pulumi.Input.asInput<bool>(enabled),
       evaluationFrequency = pulumi.Input.asOptionalInput<String>(
         evaluationFrequency,
       ),
  ...
  factory LogAnomalyDetectorArgs.fromMap(Map<String, dynamic> map) {
    return LogAnomalyDetectorArgs(
      ...
      detectorName: map['detectorName'] == null
          ? null
          : map['detectorName'] as String,
      enabled: map['enabled'] as bool,
      evaluationFrequency: map['evaluationFrequency'] == null
          ? null
          : map['evaluationFrequency'] as String,
      filterPattern: map['filterPattern'] == null
          ? null
          : map['filterPattern'] as String,
