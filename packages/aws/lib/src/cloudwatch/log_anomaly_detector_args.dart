...
class LogAnomalyDetectorArgs {
  ...
  factory LogAnomalyDetectorArgs.fromMap(Map<String, dynamic> map) {
    return LogAnomalyDetectorArgs(
      anomalyVisibilityTime: map['anomalyVisibilityTime'] == null ? null : map['anomalyVisibilityTime'] as int,
      detectorName: map['detectorName'] == null ? null : map['detectorName'] as String,
