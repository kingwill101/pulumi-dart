...
class LogDelivery extends pulumi.CustomResource {
  ...
  LogDelivery(
    ...
    this.deliveryDestinationArn = registerOutput<String>('deliveryDestinationArn');
    ...
    this.s3DeliveryConfigurations = registerOutput<List<LogDeliveryS3DeliveryConfiguration>>('s3DeliveryConfigurations');
