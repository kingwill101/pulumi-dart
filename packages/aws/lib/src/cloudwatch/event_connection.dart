...
class EventConnection extends pulumi.CustomResource {
  ...
  EventConnection(
    ...
    this.authParameters = registerOutput<EventConnectionAuthParameters>('authParameters');
    this.authorizationType = registerOutput<String>('authorizationType');
    this.description = registerOutput<String?>('description');
    this.invocationConnectivityParameters = registerOutput<EventConnectionInvocationConnectivityParameters?>('invocationConnectivityParameters');
