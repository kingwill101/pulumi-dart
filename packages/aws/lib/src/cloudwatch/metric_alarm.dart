...
class MetricAlarm extends pulumi.CustomResource {
  ...
  MetricAlarm(
    ...
    this.evaluateLowSampleCountPercentiles = registerOutput<String>('evaluateLowSampleCountPercentiles');
    ...
    this.metricQueries = registerOutput<List<MetricAlarmMetricQuery>?>('metricQueries');
