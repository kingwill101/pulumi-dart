...
class MetricStream extends pulumi.CustomResource {
  ...
  MetricStream(
    ...
    this.excludeFilters = registerOutput<List<MetricStreamExcludeFilter>?>(
      'excludeFilters',
    );
    this.firehoseArn = registerOutput<String>('firehoseArn');
    this.includeFilters = registerOutput<List<MetricStreamIncludeFilter>?>(
      'includeFilters',
    );
    this.includeLinkedAccountsMetrics = registerOutput<bool?>(
