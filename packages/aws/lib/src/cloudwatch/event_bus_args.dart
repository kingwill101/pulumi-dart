...
class EventBusArgs {
  ...
  factory EventBusArgs.fromMap(Map<String, dynamic> map) {
    return EventBusArgs(
      deadLetterConfig: map['deadLetterConfig'] == null ? null : EventBusDeadLetterConfig.fromMap((map['deadLetterConfig'] as Map).cast<String, dynamic>()),
      ...
      logConfig: map['logConfig'] == null ? null : EventBusLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
