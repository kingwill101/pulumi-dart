...
class EventConnectionAuthParameters {
  ...
  final EventConnectionAuthParametersInvocationHttpParameters? invocationHttpParameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'invocationHttpParameters': ?invocationHttpParameters == null ? null : invocationHttpParameters!.toMap(),
  ...
  factory EventConnectionAuthParameters.fromMap(Map<String, dynamic> map) {
    return EventConnectionAuthParameters(
      apiKey: map['apiKey'] == null ? null : EventConnectionAuthParametersApiKey.fromMap((map['apiKey'] as Map).cast<String, dynamic>()),
      basic: map['basic'] == null ? null : EventConnectionAuthParametersBasic.fromMap((map['basic'] as Map).cast<String, dynamic>()),
      invocationHttpParameters: map['invocationHttpParameters'] == null ? null : EventConnectionAuthParametersInvocationHttpParameters.fromMap((map['invocationHttpParameters'] as Map).cast<String, dynamic>()),
      oauth: map['oauth'] == null ? null : EventConnectionAuthParametersOauth.fromMap((map['oauth'] as Map).cast<String, dynamic>()),
    );
  }
}
