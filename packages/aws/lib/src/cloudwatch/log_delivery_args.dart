...
class LogDeliveryArgs {
  ...
  LogDeliveryArgs({
    ...
    Map<String, String>? tags,
      ...
      deliveryDestinationArn = pulumi.Input.asInput<String>(deliveryDestinationArn),
  ...
  factory LogDeliveryArgs.fromMap(Map<String, dynamic> map) {
    return LogDeliveryArgs(
      ...
      recordFields: map['recordFields'] == null ? null : (map['recordFields'] as List).cast<String>(),
      region: map['region'] == null ? null : map['region'] as String,
      s3DeliveryConfigurations: map['s3DeliveryConfigurations'] == null ? null : pulumi.Input.decodeList<LogDeliveryS3DeliveryConfiguration>(map['s3DeliveryConfigurations'], (value) => LogDeliveryS3DeliveryConfiguration.fromMap((value as Map).cast<String, dynamic>())),
