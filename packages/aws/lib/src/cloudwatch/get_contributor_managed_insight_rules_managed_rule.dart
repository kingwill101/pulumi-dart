...
class GetContributorManagedInsightRulesManagedRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ruleStates': pulumi.Input.encodeList<GetContributorManagedInsightRulesManagedRuleRuleState, Map<String, dynamic>>(ruleStates, (value) => value.toMap()),
  ...
  factory GetContributorManagedInsightRulesManagedRule.fromMap(Map<String, dynamic> map) {
    return GetContributorManagedInsightRulesManagedRule(
      ...
      ruleStates: pulumi.Input.decodeList<GetContributorManagedInsightRulesManagedRuleRuleState>(map['ruleStates'], (value) => GetContributorManagedInsightRulesManagedRuleRuleState.fromMap((value as Map).cast<String, dynamic>())),
