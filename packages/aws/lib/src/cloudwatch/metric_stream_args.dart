...
class MetricStreamArgs {
    ...
    Map<String, String>? tags,
        ...
        includeFilters =
            pulumi.Input.asOptionalInput<List<MetricStreamIncludeFilter>>(
                includeFilters),
        includeLinkedAccountsMetrics =
            pulumi.Input.asOptionalInput<bool>(includeLinkedAccountsMetrics),
  ...
  factory MetricStreamArgs.fromMap(Map<String, dynamic> map) {
    return MetricStreamArgs(
      excludeFilters: map['excludeFilters'] == null
          ? null
          : pulumi.Input.decodeList<MetricStreamExcludeFilter>(
              map['excludeFilters'],
              (value) => MetricStreamExcludeFilter.fromMap(
                  (value as Map).cast<String, dynamic>())),
      firehoseArn: map['firehoseArn'] as String,
      includeFilters: map['includeFilters'] == null
          ? null
          : pulumi.Input.decodeList<MetricStreamIncludeFilter>(
              map['includeFilters'],
              (value) => MetricStreamIncludeFilter.fromMap(
                  (value as Map).cast<String, dynamic>())),
      includeLinkedAccountsMetrics: map['includeLinkedAccountsMetrics'] == null
          ? null
          : map['includeLinkedAccountsMetrics'] as bool,
      ...
      statisticsConfigurations: map['statisticsConfigurations'] == null
          ? null
          : pulumi.Input.decodeList<MetricStreamStatisticsConfiguration>(
              map['statisticsConfigurations'],
              (value) => MetricStreamStatisticsConfiguration.fromMap(
                  (value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null
          ? null
