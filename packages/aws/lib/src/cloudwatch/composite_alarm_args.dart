...
class CompositeAlarmArgs {
  ...
  CompositeAlarmArgs({
    ...
    Map<String, String>? tags,
       ...
       alarmDescription = pulumi.Input.asOptionalInput<String>(
         alarmDescription,
       ),
    ...
    return <String, dynamic>{
      ...
      'actionsSuppressor':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(actionsSuppressor, (value) => value.toMap()),
  ...
  factory CompositeAlarmArgs.fromMap(Map<String, dynamic> map) {
    return CompositeAlarmArgs(
      actionsEnabled: map['actionsEnabled'] == null
          ? null
          : map['actionsEnabled'] as bool,
