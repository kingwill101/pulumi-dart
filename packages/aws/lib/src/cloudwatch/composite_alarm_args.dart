...
class CompositeAlarmArgs {
  ...
  factory CompositeAlarmArgs.fromMap(Map<String, dynamic> map) {
    return CompositeAlarmArgs(
      actionsEnabled: map['actionsEnabled'] == null ? null : map['actionsEnabled'] as bool,
      actionsSuppressor: map['actionsSuppressor'] == null ? null : CompositeAlarmActionsSuppressor.fromMap((map['actionsSuppressor'] as Map).cast<String, dynamic>()),
      alarmActions: map['alarmActions'] == null ? null : (map['alarmActions'] as List).cast<String>(),
      alarmDescription: map['alarmDescription'] == null ? null : map['alarmDescription'] as String,
      alarmName: map['alarmName'] as String,
      alarmRule: map['alarmRule'] as String,
      insufficientDataActions: map['insufficientDataActions'] == null ? null : (map['insufficientDataActions'] as List).cast<String>(),
      okActions: map['okActions'] == null ? null : (map['okActions'] as List).cast<String>(),
