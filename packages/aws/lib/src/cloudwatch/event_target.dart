...
class EventTarget extends pulumi.CustomResource {
  ...
  EventTarget(
    ...
    this.appsyncTarget = registerOutput<EventTargetAppsyncTarget?>(
      'appsyncTarget',
    );
    this.arn = registerOutput<String>('arn');
    this.batchTarget = registerOutput<EventTargetBatchTarget?>('batchTarget');
    this.deadLetterConfig = registerOutput<EventTargetDeadLetterConfig?>(
      'deadLetterConfig',
    );
    ...
    this.inputTransformer = registerOutput<EventTargetInputTransformer?>(
      'inputTransformer',
    );
    this.kinesisTarget = registerOutput<EventTargetKinesisTarget?>(
      'kinesisTarget',
    );
    this.redshiftTarget = registerOutput<EventTargetRedshiftTarget?>(
      'redshiftTarget',
    );
    ...
    this.runCommandTargets = registerOutput<List<EventTargetRunCommandTarget>?>(
      'runCommandTargets',
    );
