...
class EventTargetEcsTarget {
  ...
  final List<EventTargetEcsTargetCapacityProviderStrategy>? capacityProviderStrategies;
  ...
  final List<EventTargetEcsTargetOrderedPlacementStrategy>? orderedPlacementStrategies;
  /// An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime). See Below.
  final List<EventTargetEcsTargetPlacementConstraint>? placementConstraints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'capacityProviderStrategies': ?capacityProviderStrategies == null ? null : pulumi.Input.encodeList<EventTargetEcsTargetCapacityProviderStrategy, Map<String, dynamic>>(capacityProviderStrategies!, (value) => value.toMap()),
      'enableEcsManagedTags': ?enableEcsManagedTags,
      'enableExecuteCommand': ?enableExecuteCommand,
      'group': ?group,
      'launchType': ?launchType,
      'networkConfiguration': ?networkConfiguration == null ? null : networkConfiguration!.toMap(),
      'orderedPlacementStrategies': ?orderedPlacementStrategies == null ? null : pulumi.Input.encodeList<EventTargetEcsTargetOrderedPlacementStrategy, Map<String, dynamic>>(orderedPlacementStrategies!, (value) => value.toMap()),
      'placementConstraints': ?placementConstraints == null ? null : pulumi.Input.encodeList<EventTargetEcsTargetPlacementConstraint, Map<String, dynamic>>(placementConstraints!, (value) => value.toMap()),
  ...
  factory EventTargetEcsTarget.fromMap(Map<String, dynamic> map) {
    return EventTargetEcsTarget(
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : pulumi.Input.decodeList<EventTargetEcsTargetCapacityProviderStrategy>(map['capacityProviderStrategies'], (value) => EventTargetEcsTargetCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>())),
      ...
      networkConfiguration: map['networkConfiguration'] == null ? null : EventTargetEcsTargetNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      orderedPlacementStrategies: map['orderedPlacementStrategies'] == null ? null : pulumi.Input.decodeList<EventTargetEcsTargetOrderedPlacementStrategy>(map['orderedPlacementStrategies'], (value) => EventTargetEcsTargetOrderedPlacementStrategy.fromMap((value as Map).cast<String, dynamic>())),
      placementConstraints: map['placementConstraints'] == null ? null : pulumi.Input.decodeList<EventTargetEcsTargetPlacementConstraint>(map['placementConstraints'], (value) => EventTargetEcsTargetPlacementConstraint.fromMap((value as Map).cast<String, dynamic>())),
