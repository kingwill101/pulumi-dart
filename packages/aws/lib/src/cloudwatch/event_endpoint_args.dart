...
class EventEndpointArgs {
  ...
  EventEndpointArgs({
    ...
    required EventEndpointRoutingConfig routingConfig,
        ...
        eventBuses =
            pulumi.Input.asInput<List<EventEndpointEventBus>>(eventBuses),
        ...
        routingConfig =
            pulumi.Input.asInput<EventEndpointRoutingConfig>(routingConfig);
  ...
  Map<String, dynamic> toMap() {
    ...
    map['eventBuses'] = pulumi.Input.mapInputValue<List<EventEndpointEventBus>,
            List<Map<String, dynamic>>>(
        eventBuses,
        (value) => pulumi.Input.encodeList<EventEndpointEventBus,
    ...
    if (replicationConfigValue != null) {
      map['replicationConfig'] = pulumi.Input.mapOptionalInputValue<
    ...
    map['routingConfig'] = pulumi.Input.mapInputValue<
        EventEndpointRoutingConfig,
        Map<String, dynamic>>(routingConfig, (value) => value.toMap());
    return map;
  }
