...
class EventEndpointArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'eventBuses': pulumi.Input.mapInputValue<List<EventEndpointEventBus>, List<Map<String, dynamic>>>(eventBuses, (value) => pulumi.Input.encodeList<EventEndpointEventBus, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      'region': ?region,
      ...
      'roleArn': ?roleArn,
      'routingConfig': pulumi.Input.mapInputValue<EventEndpointRoutingConfig, Map<String, dynamic>>(routingConfig, (value) => value.toMap()),
    };
  }
  ...
  factory EventEndpointArgs.fromMap(Map<String, dynamic> map) {
    return EventEndpointArgs(
      ...
      eventBuses: pulumi.Input.decodeList<EventEndpointEventBus>(map['eventBuses'], (value) => EventEndpointEventBus.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      replicationConfig: map['replicationConfig'] == null ? null : EventEndpointReplicationConfig.fromMap((map['replicationConfig'] as Map).cast<String, dynamic>()),
      roleArn: map['roleArn'] == null ? null : map['roleArn'] as String,
      routingConfig: EventEndpointRoutingConfig.fromMap((map['routingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
