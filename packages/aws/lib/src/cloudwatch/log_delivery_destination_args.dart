...
class LogDeliveryDestinationArgs {
  ...
  LogDeliveryDestinationArgs({
    LogDeliveryDestinationDeliveryDestinationConfiguration? deliveryDestinationConfiguration,
  ...
  factory LogDeliveryDestinationArgs.fromMap(Map<String, dynamic> map) {
    return LogDeliveryDestinationArgs(
      deliveryDestinationConfiguration: map['deliveryDestinationConfiguration'] == null ? null : LogDeliveryDestinationDeliveryDestinationConfiguration.fromMap((map['deliveryDestinationConfiguration'] as Map).cast<String, dynamic>()),
      deliveryDestinationType: map['deliveryDestinationType'] == null ? null : map['deliveryDestinationType'] as String,
