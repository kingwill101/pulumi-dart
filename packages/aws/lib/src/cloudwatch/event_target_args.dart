...
class EventTargetArgs {
  ...
  EventTargetArgs({
    ...
    String? targetId,
       ...
       ecsTarget = pulumi.Input.asOptionalInput<EventTargetEcsTarget>(
         ecsTarget,
       ),
       ...
       sqsTarget = pulumi.Input.asOptionalInput<EventTargetSqsTarget>(
         sqsTarget,
       ),
    ...
    return <String, dynamic>{
      'appsyncTarget':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(appsyncTarget, (value) => value.toMap()),
      'arn': arn,
      'batchTarget':
          ?pulumi.Input.mapOptionalInputValue<
            EventTargetBatchTarget,
            Map<String, dynamic>
          >(batchTarget, (value) => value.toMap()),
      'deadLetterConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'inputTransformer':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(inputTransformer, (value) => value.toMap()),
      'kinesisTarget':
          ?pulumi.Input.mapOptionalInputValue<
            EventTargetKinesisTarget,
            Map<String, dynamic>
          >(kinesisTarget, (value) => value.toMap()),
      'redshiftTarget':
          ?pulumi.Input.mapOptionalInputValue<
            EventTargetRedshiftTarget,
            Map<String, dynamic>
          >(redshiftTarget, (value) => value.toMap()),
      'region': ?region,
      'retryPolicy':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'sagemakerPipelineTarget':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sagemakerPipelineTarget, (value) => value.toMap()),
      'sqsTarget':
          ?pulumi.Input.mapOptionalInputValue<
            EventTargetSqsTarget,
            Map<String, dynamic>
          >(sqsTarget, (value) => value.toMap()),
      'targetId': ?targetId,
    };
  }
  ...
  factory EventTargetArgs.fromMap(Map<String, dynamic> map) {
    return EventTargetArgs(
      appsyncTarget: map['appsyncTarget'] == null
          ? null
          : EventTargetAppsyncTarget.fromMap(
              (map['appsyncTarget'] as Map).cast<String, dynamic>(),
            ),
      arn: map['arn'] as String,
      batchTarget: map['batchTarget'] == null
          ? null
          : EventTargetBatchTarget.fromMap(
              (map['batchTarget'] as Map).cast<String, dynamic>(),
            ),
      deadLetterConfig: map['deadLetterConfig'] == null
          ? null
          : EventTargetDeadLetterConfig.fromMap(
              (map['deadLetterConfig'] as Map).cast<String, dynamic>(),
            ),
      ecsTarget: map['ecsTarget'] == null
          ? null
          : EventTargetEcsTarget.fromMap(
              (map['ecsTarget'] as Map).cast<String, dynamic>(),
            ),
      ...
      inputTransformer: map['inputTransformer'] == null
          ? null
          : EventTargetInputTransformer.fromMap(
              (map['inputTransformer'] as Map).cast<String, dynamic>(),
            ),
      kinesisTarget: map['kinesisTarget'] == null
          ? null
          : EventTargetKinesisTarget.fromMap(
              (map['kinesisTarget'] as Map).cast<String, dynamic>(),
            ),
      redshiftTarget: map['redshiftTarget'] == null
          ? null
          : EventTargetRedshiftTarget.fromMap(
              (map['redshiftTarget'] as Map).cast<String, dynamic>(),
            ),
      region: map['region'] == null ? null : map['region'] as String,
      retryPolicy: map['retryPolicy'] == null
          ? null
          : EventTargetRetryPolicy.fromMap(
              (map['retryPolicy'] as Map).cast<String, dynamic>(),
            ),
      roleArn: map['roleArn'] == null ? null : map['roleArn'] as String,
      rule: map['rule'] as String,
      runCommandTargets: map['runCommandTargets'] == null
          ? null
          : pulumi.Input.decodeList<EventTargetRunCommandTarget>(
              map['runCommandTargets'],
              (value) => EventTargetRunCommandTarget.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      sagemakerPipelineTarget: map['sagemakerPipelineTarget'] == null
          ? null
          : EventTargetSagemakerPipelineTarget.fromMap(
              (map['sagemakerPipelineTarget'] as Map).cast<String, dynamic>(),
            ),
      sqsTarget: map['sqsTarget'] == null
          ? null
          : EventTargetSqsTarget.fromMap(
              (map['sqsTarget'] as Map).cast<String, dynamic>(),
            ),
