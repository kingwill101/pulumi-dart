...
class EventTargetArgs {
  ...
  EventTargetArgs({
    ...
    String? targetId,
        ...
        batchTarget =
            pulumi.Input.asOptionalInput<EventTargetBatchTarget>(batchTarget),
        deadLetterConfig =
            pulumi.Input.asOptionalInput<EventTargetDeadLetterConfig>(
                deadLetterConfig),
        ecsTarget =
            pulumi.Input.asOptionalInput<EventTargetEcsTarget>(ecsTarget),
        eventBusName = pulumi.Input.asOptionalInput<String>(eventBusName),
        forceDestroy = pulumi.Input.asOptionalInput<bool>(forceDestroy),
        httpTarget =
            pulumi.Input.asOptionalInput<EventTargetHttpTarget>(httpTarget),
        ...
        kinesisTarget = pulumi.Input.asOptionalInput<EventTargetKinesisTarget>(
            kinesisTarget),
        redshiftTarget =
            pulumi.Input.asOptionalInput<EventTargetRedshiftTarget>(
                redshiftTarget),
        region = pulumi.Input.asOptionalInput<String>(region),
        retryPolicy =
            pulumi.Input.asOptionalInput<EventTargetRetryPolicy>(retryPolicy),
        ...
        sagemakerPipelineTarget =
            pulumi.Input.asOptionalInput<EventTargetSagemakerPipelineTarget>(
                sagemakerPipelineTarget),
        sqsTarget =
            pulumi.Input.asOptionalInput<EventTargetSqsTarget>(sqsTarget),
