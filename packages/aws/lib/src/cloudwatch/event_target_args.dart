...
class EventTargetArgs {
  ...
  EventTargetArgs({
    EventTargetAppsyncTarget? appsyncTarget,
    required String arn,
    EventTargetBatchTarget? batchTarget,
    EventTargetDeadLetterConfig? deadLetterConfig,
    EventTargetEcsTarget? ecsTarget,
    String? eventBusName,
    bool? forceDestroy,
    EventTargetHttpTarget? httpTarget,
    String? input,
    String? inputPath,
    EventTargetInputTransformer? inputTransformer,
    EventTargetKinesisTarget? kinesisTarget,
    EventTargetRedshiftTarget? redshiftTarget,
    String? region,
    EventTargetRetryPolicy? retryPolicy,
    String? roleArn,
    required String rule,
    List<EventTargetRunCommandTarget>? runCommandTargets,
    EventTargetSagemakerPipelineTarget? sagemakerPipelineTarget,
    EventTargetSqsTarget? sqsTarget,
    String? targetId,
  }) :
  ...
  factory EventTargetArgs.fromMap(Map<String, dynamic> map) {
    return EventTargetArgs(
      appsyncTarget: map['appsyncTarget'] == null ? null : EventTargetAppsyncTarget.fromMap((map['appsyncTarget'] as Map).cast<String, dynamic>()),
      arn: map['arn'] as String,
      batchTarget: map['batchTarget'] == null ? null : EventTargetBatchTarget.fromMap((map['batchTarget'] as Map).cast<String, dynamic>()),
      deadLetterConfig: map['deadLetterConfig'] == null ? null : EventTargetDeadLetterConfig.fromMap((map['deadLetterConfig'] as Map).cast<String, dynamic>()),
      ecsTarget: map['ecsTarget'] == null ? null : EventTargetEcsTarget.fromMap((map['ecsTarget'] as Map).cast<String, dynamic>()),
      ...
      httpTarget: map['httpTarget'] == null ? null : EventTargetHttpTarget.fromMap((map['httpTarget'] as Map).cast<String, dynamic>()),
      input: map['input'] == null ? null : map['input'] as String,
      inputPath: map['inputPath'] == null ? null : map['inputPath'] as String,
      inputTransformer: map['inputTransformer'] == null ? null : EventTargetInputTransformer.fromMap((map['inputTransformer'] as Map).cast<String, dynamic>()),
      kinesisTarget: map['kinesisTarget'] == null ? null : EventTargetKinesisTarget.fromMap((map['kinesisTarget'] as Map).cast<String, dynamic>()),
      redshiftTarget: map['redshiftTarget'] == null ? null : EventTargetRedshiftTarget.fromMap((map['redshiftTarget'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      retryPolicy: map['retryPolicy'] == null ? null : EventTargetRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      roleArn: map['roleArn'] == null ? null : map['roleArn'] as String,
      rule: map['rule'] as String,
      runCommandTargets: map['runCommandTargets'] == null ? null : pulumi.Input.decodeList<EventTargetRunCommandTarget>(map['runCommandTargets'], (value) => EventTargetRunCommandTarget.fromMap((value as Map).cast<String, dynamic>())),
      sagemakerPipelineTarget: map['sagemakerPipelineTarget'] == null ? null : EventTargetSagemakerPipelineTarget.fromMap((map['sagemakerPipelineTarget'] as Map).cast<String, dynamic>()),
      sqsTarget: map['sqsTarget'] == null ? null : EventTargetSqsTarget.fromMap((map['sqsTarget'] as Map).cast<String, dynamic>()),
