...
class LogTransformerTransformerConfigRenameKey {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entries': pulumi.Input.encodeList<LogTransformerTransformerConfigRenameKeyEntry, Map<String, dynamic>>(entries, (value) => value.toMap()),
    };
  }
  ...
  factory LogTransformerTransformerConfigRenameKey.fromMap(Map<String, dynamic> map) {
    return LogTransformerTransformerConfigRenameKey(
      entries: pulumi.Input.decodeList<LogTransformerTransformerConfigRenameKeyEntry>(map['entries'], (value) => LogTransformerTransformerConfigRenameKeyEntry.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
