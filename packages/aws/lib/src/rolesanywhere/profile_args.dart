...
class ProfileArgs {
  ...
  ProfileArgs({
    ...
    Map<String, String>? tags,
  }) : acceptRoleSessionName = pulumi.Input.asOptionalInput<bool>(
       ...
       requireInstanceProperties = pulumi.Input.asOptionalInput<bool>(
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      ...
      sessionPolicy: map['sessionPolicy'] == null
          ? null
          : map['sessionPolicy'] as String,
      tags: map['tags'] == null
          ? null
