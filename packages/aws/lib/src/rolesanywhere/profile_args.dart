...
class ProfileArgs {
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      acceptRoleSessionName: map['acceptRoleSessionName'] == null ? null : map['acceptRoleSessionName'] as bool,
      ...
      requireInstanceProperties: map['requireInstanceProperties'] == null ? null : map['requireInstanceProperties'] as bool,
      roleArns: map['roleArns'] == null ? null : (map['roleArns'] as List).cast<String>(),
      sessionPolicy: map['sessionPolicy'] == null ? null : map['sessionPolicy'] as String,
