...
class ReceiptRuleArgs {
  ...
  factory ReceiptRuleArgs.fromMap(Map<String, dynamic> map) {
    return ReceiptRuleArgs(
      addHeaderActions: map['addHeaderActions'] == null ? null : pulumi.Input.decodeList<ReceiptRuleAddHeaderAction>(map['addHeaderActions'], (value) => ReceiptRuleAddHeaderAction.fromMap((value as Map).cast<String, dynamic>())),
      after: map['after'] == null ? null : map['after'] as String,
      bounceActions: map['bounceActions'] == null ? null : pulumi.Input.decodeList<ReceiptRuleBounceAction>(map['bounceActions'], (value) => ReceiptRuleBounceAction.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      lambdaActions: map['lambdaActions'] == null ? null : pulumi.Input.decodeList<ReceiptRuleLambdaAction>(map['lambdaActions'], (value) => ReceiptRuleLambdaAction.fromMap((value as Map).cast<String, dynamic>())),
      ...
      s3Actions: map['s3Actions'] == null ? null : pulumi.Input.decodeList<ReceiptRuleS3Action>(map['s3Actions'], (value) => ReceiptRuleS3Action.fromMap((value as Map).cast<String, dynamic>())),
      scanEnabled: map['scanEnabled'] == null ? null : map['scanEnabled'] as bool,
      snsActions: map['snsActions'] == null ? null : pulumi.Input.decodeList<ReceiptRuleSnsAction>(map['snsActions'], (value) => ReceiptRuleSnsAction.fromMap((value as Map).cast<String, dynamic>())),
      stopActions: map['stopActions'] == null ? null : pulumi.Input.decodeList<ReceiptRuleStopAction>(map['stopActions'], (value) => ReceiptRuleStopAction.fromMap((value as Map).cast<String, dynamic>())),
      tlsPolicy: map['tlsPolicy'] == null ? null : map['tlsPolicy'] as String,
      workmailActions: map['workmailActions'] == null ? null : pulumi.Input.decodeList<ReceiptRuleWorkmailAction>(map['workmailActions'], (value) => ReceiptRuleWorkmailAction.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
