...
class Table extends pulumi.CustomResource {
  ...
  Table(String name, {TableArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.capacitySpecification = registerOutput<TableCapacitySpecification>(
      'capacitySpecification',
    );
    this.clientSideTimestamps = registerOutput<TableClientSideTimestamps?>(
      'clientSideTimestamps',
    );
    this.comment = registerOutput<TableComment>('comment');
    this.defaultTimeToLive = registerOutput<int?>('defaultTimeToLive');
    this.encryptionSpecification = registerOutput<TableEncryptionSpecification>(
      'encryptionSpecification',
    );
    ...
    this.schemaDefinition = registerOutput<TableSchemaDefinition>(
      'schemaDefinition',
    );
