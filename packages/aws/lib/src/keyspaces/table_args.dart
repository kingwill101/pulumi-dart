...
class TableArgs {
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      capacitySpecification: map['capacitySpecification'] == null ? null : TableCapacitySpecification.fromMap((map['capacitySpecification'] as Map).cast<String, dynamic>()),
      clientSideTimestamps: map['clientSideTimestamps'] == null ? null : TableClientSideTimestamps.fromMap((map['clientSideTimestamps'] as Map).cast<String, dynamic>()),
      comment: map['comment'] == null ? null : TableComment.fromMap((map['comment'] as Map).cast<String, dynamic>()),
      defaultTimeToLive: map['defaultTimeToLive'] == null ? null : map['defaultTimeToLive'] as int,
      encryptionSpecification: map['encryptionSpecification'] == null ? null : TableEncryptionSpecification.fromMap((map['encryptionSpecification'] as Map).cast<String, dynamic>()),
      keyspaceName: map['keyspaceName'] as String,
      pointInTimeRecovery: map['pointInTimeRecovery'] == null ? null : TablePointInTimeRecovery.fromMap((map['pointInTimeRecovery'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      schemaDefinition: TableSchemaDefinition.fromMap((map['schemaDefinition'] as Map).cast<String, dynamic>()),
      tableName: map['tableName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      ttl: map['ttl'] == null ? null : TableTtl.fromMap((map['ttl'] as Map).cast<String, dynamic>()),
    );
  }
}
