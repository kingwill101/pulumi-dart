...
class PolicySecurityServicePolicyData {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policyOption': ?policyOption == null ? null : policyOption!.toMap(),
      'type': type,
    };
  }
  ...
  factory PolicySecurityServicePolicyData.fromMap(Map<String, dynamic> map) {
    return PolicySecurityServicePolicyData(
      managedServiceData: map['managedServiceData'] == null ? null : map['managedServiceData'] as String,
      policyOption: map['policyOption'] == null ? null : PolicySecurityServicePolicyDataPolicyOption.fromMap((map['policyOption'] as Map).cast<String, dynamic>()),
