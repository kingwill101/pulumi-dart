...
class PolicySecurityServicePolicyDataPolicyOptionNetworkAclCommonPolicyNetworkAclEntrySetFirstEntry {
  ...
  final List<PolicySecurityServicePolicyDataPolicyOptionNetworkAclCommonPolicyNetworkAclEntrySetFirstEntryIcmpTypeCode>? icmpTypeCodes;
  ...
  final List<PolicySecurityServicePolicyDataPolicyOptionNetworkAclCommonPolicyNetworkAclEntrySetFirstEntryPortRange>? portRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cidrBlock': ?cidrBlock,
      'egress': egress,
      'icmpTypeCodes': ?icmpTypeCodes == null ? null : pulumi.Input.encodeList<PolicySecurityServicePolicyDataPolicyOptionNetworkAclCommonPolicyNetworkAclEntrySetFirstEntryIcmpTypeCode, Map<String, dynamic>>(icmpTypeCodes!, (value) => value.toMap()),
      'ipv6CidrBlock': ?ipv6CidrBlock,
      'portRanges': ?portRanges == null ? null : pulumi.Input.encodeList<PolicySecurityServicePolicyDataPolicyOptionNetworkAclCommonPolicyNetworkAclEntrySetFirstEntryPortRange, Map<String, dynamic>>(portRanges!, (value) => value.toMap()),
      'protocol': protocol,
