...
class PolicyArgs {
  ...
  PolicyArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<bool>(deleteAllPolicyResources),
        deleteUnusedFmManagedResources =
            pulumi.Input.asOptionalInput<bool>(deleteUnusedFmManagedResources),
        ...
        remediationEnabled =
            pulumi.Input.asOptionalInput<bool>(remediationEnabled),
        resourceSetIds =
            pulumi.Input.asOptionalInput<List<String>>(resourceSetIds),
        resourceTagLogicalOperator =
            pulumi.Input.asOptionalInput<String>(resourceTagLogicalOperator),
        resourceTags =
            pulumi.Input.asOptionalInput<Map<String, String>>(resourceTags),
        resourceType = pulumi.Input.asOptionalInput<String>(resourceType),
        resourceTypeLists =
            pulumi.Input.asOptionalInput<List<String>>(resourceTypeLists),
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      deleteAllPolicyResources: map['deleteAllPolicyResources'] == null
          ? null
          : map['deleteAllPolicyResources'] as bool,
      deleteUnusedFmManagedResources:
          map['deleteUnusedFmManagedResources'] == null
              ? null
              : map['deleteUnusedFmManagedResources'] as bool,
      description:
          map['description'] == null ? null : map['description'] as String,
      excludeMap: map['excludeMap'] == null
          ? null
          : PolicyExcludeMap.fromMap(
              (map['excludeMap'] as Map).cast<String, dynamic>()),
      excludeResourceTags: map['excludeResourceTags'] as bool,
      includeMap: map['includeMap'] == null
          ? null
          : PolicyIncludeMap.fromMap(
              (map['includeMap'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      remediationEnabled: map['remediationEnabled'] == null
          ? null
          : map['remediationEnabled'] as bool,
      resourceSetIds: map['resourceSetIds'] == null
          ? null
          : (map['resourceSetIds'] as List).cast<String>(),
      resourceTagLogicalOperator: map['resourceTagLogicalOperator'] == null
          ? null
          : map['resourceTagLogicalOperator'] as String,
      ...
      securityServicePolicyData: PolicySecurityServicePolicyData.fromMap(
