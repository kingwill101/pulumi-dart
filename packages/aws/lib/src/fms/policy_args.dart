...
class PolicyArgs {
  ...
  PolicyArgs({
    ...
    Map<String, String>? tags,
  }) : deleteAllPolicyResources = pulumi.Input.asOptionalInput<bool>(
       ...
       remediationEnabled = pulumi.Input.asOptionalInput<bool>(
         remediationEnabled,
       ),
       resourceSetIds = pulumi.Input.asOptionalInput<List<String>>(
         resourceSetIds,
       ),
       ...
       resourceTypeLists = pulumi.Input.asOptionalInput<List<String>>(
         resourceTypeLists,
       ),
