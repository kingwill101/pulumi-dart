...
class Policy extends pulumi.CustomResource {
  ...
  Policy(String name, {PolicyArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.deleteAllPolicyResources = registerOutput<bool?>(
      'deleteAllPolicyResources',
    );
    this.deleteUnusedFmManagedResources = registerOutput<bool?>(
    ...
    this.resourceTagLogicalOperator = registerOutput<String>(
