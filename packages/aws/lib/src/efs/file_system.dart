...
class FileSystem extends pulumi.CustomResource {
  ...
  FileSystem(
    ...
    this.lifecyclePolicies = registerOutput<List<FileSystemLifecyclePolicy>?>(
      'lifecyclePolicies',
    );
    ...
    this.provisionedThroughputInMibps = registerOutput<double?>(
      'provisionedThroughputInMibps',
    );
    this.region = registerOutput<String>('region');
    this.sizeInBytes = registerOutput<List<FileSystemSizeInByte>>(
      'sizeInBytes',
    );
