...
class FileSystemArgs {
  ...
  factory FileSystemArgs.fromMap(Map<String, dynamic> map) {
    return FileSystemArgs(
      ...
      lifecyclePolicies: map['lifecyclePolicies'] == null ? null : pulumi.Input.decodeList<FileSystemLifecyclePolicy>(map['lifecyclePolicies'], (value) => FileSystemLifecyclePolicy.fromMap((value as Map).cast<String, dynamic>())),
      performanceMode: map['performanceMode'] == null ? null : map['performanceMode'] as String,
      protection: map['protection'] == null ? null : FileSystemProtection.fromMap((map['protection'] as Map).cast<String, dynamic>()),
      provisionedThroughputInMibps: map['provisionedThroughputInMibps'] == null ? null : map['provisionedThroughputInMibps'] as double,
