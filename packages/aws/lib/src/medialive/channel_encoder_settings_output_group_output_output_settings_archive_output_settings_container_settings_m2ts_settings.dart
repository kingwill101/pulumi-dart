...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings {
  ...
  final ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings?
  dvbNitSettings;
  final ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings?
  dvbSdtSettings;
  final String? dvbSubPids;
  final ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings?
  dvbTdtSettings;
  ...
  factory ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings.fromMap(
    ...
    return ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings(
      ...
      bufferModel: map['bufferModel'] == null
          ? null
          : map['bufferModel'] as String,
      ccDescriptor: map['ccDescriptor'] == null
          ? null
          : map['ccDescriptor'] as String,
      dvbNitSettings: map['dvbNitSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings.fromMap(
              (map['dvbNitSettings'] as Map).cast<String, dynamic>(),
            ),
      dvbSdtSettings: map['dvbSdtSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings.fromMap(
              (map['dvbSdtSettings'] as Map).cast<String, dynamic>(),
            ),
      dvbSubPids: map['dvbSubPids'] == null
          ? null
          : map['dvbSubPids'] as String,
      dvbTdtSettings: map['dvbTdtSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings.fromMap(
              (map['dvbTdtSettings'] as Map).cast<String, dynamic>(),
            ),
      ...
      ebpLookaheadMs: map['ebpLookaheadMs'] == null
          ? null
          : map['ebpLookaheadMs'] as int,
      ebpPlacement: map['ebpPlacement'] == null
          ? null
          : map['ebpPlacement'] as String,
      ecmPid: map['ecmPid'] == null ? null : map['ecmPid'] as String,
      esRateInPes: map['esRateInPes'] == null
          ? null
          : map['esRateInPes'] as String,
      etvPlatformPid: map['etvPlatformPid'] == null
          ? null
          : map['etvPlatformPid'] as String,
      etvSignalPid: map['etvSignalPid'] == null
          ? null
          : map['etvSignalPid'] as String,
      fragmentTime: map['fragmentTime'] == null
          ? null
          : map['fragmentTime'] as double,
      klv: map['klv'] == null ? null : map['klv'] as String,
      klvDataPids: map['klvDataPids'] == null
          ? null
          : map['klvDataPids'] as String,
      ...
      scte27Pids: map['scte27Pids'] == null
          ? null
          : map['scte27Pids'] as String,
      scte35Control: map['scte35Control'] == null
          ? null
          : map['scte35Control'] as String,
