  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ttmlDestinationSettings': ?ttmlDestinationSettings == null
          ? null
          : ttmlDestinationSettings!.toMap(),
      'webvttDestinationSettings': ?webvttDestinationSettings == null
          ? null
          : webvttDestinationSettings!.toMap(),
    };
  }
    ...
    return ChannelEncoderSettingsCaptionDescriptionDestinationSettings(
      ...
      burnInDestinationSettings: map['burnInDestinationSettings'] == null
          ...
          : ChannelEncoderSettingsCaptionDescriptionDestinationSettingsBurnInDestinationSettings.fromMap(
              (map['burnInDestinationSettings'] as Map).cast<String, dynamic>(),
            ),
      dvbSubDestinationSettings: map['dvbSubDestinationSettings'] == null
          ...
          : ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings.fromMap(
              (map['dvbSubDestinationSettings'] as Map).cast<String, dynamic>(),
            ),
      ebuTtDDestinationSettings: map['ebuTtDDestinationSettings'] == null
          ...
          : ChannelEncoderSettingsCaptionDescriptionDestinationSettingsEbuTtDDestinationSettings.fromMap(
              (map['ebuTtDDestinationSettings'] as Map).cast<String, dynamic>(),
            ),
      ...
      ttmlDestinationSettings: map['ttmlDestinationSettings'] == null
          ...
          : ChannelEncoderSettingsCaptionDescriptionDestinationSettingsTtmlDestinationSettings.fromMap(
              (map['ttmlDestinationSettings'] as Map).cast<String, dynamic>(),
            ),
      webvttDestinationSettings: map['webvttDestinationSettings'] == null
          ...
          : ChannelEncoderSettingsCaptionDescriptionDestinationSettingsWebvttDestinationSettings.fromMap(
              (map['webvttDestinationSettings'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
