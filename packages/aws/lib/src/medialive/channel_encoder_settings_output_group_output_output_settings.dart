  ...
  factory ChannelEncoderSettingsOutputGroupOutputOutputSettings.fromMap(
    ...
    return ChannelEncoderSettingsOutputGroupOutputOutputSettings(
      archiveOutputSettings: map['archiveOutputSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettings.fromMap(
              (map['archiveOutputSettings'] as Map).cast<String, dynamic>(),
            ),
      frameCaptureOutputSettings: map['frameCaptureOutputSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsFrameCaptureOutputSettings.fromMap(
              (map['frameCaptureOutputSettings'] as Map)
                  .cast<String, dynamic>(),
            ),
      hlsOutputSettings: map['hlsOutputSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettings.fromMap(
      ...
      msSmoothOutputSettings: map['msSmoothOutputSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsMsSmoothOutputSettings.fromMap(
              (map['msSmoothOutputSettings'] as Map).cast<String, dynamic>(),
            ),
      multiplexOutputSettings: map['multiplexOutputSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsMultiplexOutputSettings.fromMap(
              (map['multiplexOutputSettings'] as Map).cast<String, dynamic>(),
            ),
      rtmpOutputSettings: map['rtmpOutputSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsRtmpOutputSettings.fromMap(
              (map['rtmpOutputSettings'] as Map).cast<String, dynamic>(),
            ),
      udpOutputSettings: map['udpOutputSettings'] == null
          ? null
          : ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettings.fromMap(
