...
class MultiplexArgs {
  ...
  factory MultiplexArgs.fromMap(Map<String, dynamic> map) {
    return MultiplexArgs(
      ...
      multiplexSettings: map['multiplexSettings'] == null ? null : MultiplexMultiplexSettings.fromMap((map['multiplexSettings'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      startMultiplex: map['startMultiplex'] == null ? null : map['startMultiplex'] as bool,
