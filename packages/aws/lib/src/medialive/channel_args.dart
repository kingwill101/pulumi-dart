...
class ChannelArgs {
  ...
  ChannelArgs({
    ...
    ChannelVpc? vpc,
        ...
        destinations =
            pulumi.Input.asInput<List<ChannelDestination>>(destinations),
        encoderSettings =
            pulumi.Input.asInput<ChannelEncoderSettings>(encoderSettings),
        inputAttachments = pulumi.Input.asInput<List<ChannelInputAttachment>>(
            inputAttachments),
        inputSpecification =
            pulumi.Input.asInput<ChannelInputSpecification>(inputSpecification),
        logLevel = pulumi.Input.asOptionalInput<String>(logLevel),
        maintenance =
            pulumi.Input.asOptionalInput<ChannelMaintenance>(maintenance),
  ...
  factory ChannelArgs.fromMap(Map<String, dynamic> map) {
    return ChannelArgs(
      ...
      destinations: pulumi.Input.decodeList<ChannelDestination>(
          map['destinations'],
          (value) => ChannelDestination.fromMap(
      ...
      startChannel:
          map['startChannel'] == null ? null : map['startChannel'] as bool,
      tags: map['tags'] == null
          ? null
