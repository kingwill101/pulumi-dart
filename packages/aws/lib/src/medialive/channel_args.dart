...
class ChannelArgs {
  ...
  ChannelArgs({
    ...
    ChannelVpc? vpc,
       ...
       destinations = pulumi.Input.asInput<List<ChannelDestination>>(
         destinations,
       ),
       encoderSettings = pulumi.Input.asInput<ChannelEncoderSettings>(
         encoderSettings,
       ),
       ...
       maintenance = pulumi.Input.asOptionalInput<ChannelMaintenance>(
         maintenance,
       ),
    ...
    return <String, dynamic>{
      'cdiInputSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cdiInputSpecification, (value) => value.toMap()),
      ...
      'encoderSettings':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(encoderSettings, (value) => value.toMap()),
      'inputAttachments':
          pulumi.Input.mapInputValue<
            List<ChannelInputAttachment>,
            List<Map<String, dynamic>>
          >(
            inputAttachments,
            (value) =>
      ...
      'inputSpecification':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(inputSpecification, (value) => value.toMap()),
      'logLevel': ?logLevel,
      'maintenance':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelMaintenance,
  ...
  factory ChannelArgs.fromMap(Map<String, dynamic> map) {
    return ChannelArgs(
      cdiInputSpecification: map['cdiInputSpecification'] == null
          ? null
          : ChannelCdiInputSpecification.fromMap(
              (map['cdiInputSpecification'] as Map).cast<String, dynamic>(),
            ),
      channelClass: map['channelClass'] as String,
      destinations: pulumi.Input.decodeList<ChannelDestination>(
        map['destinations'],
        (value) =>
            ChannelDestination.fromMap((value as Map).cast<String, dynamic>()),
      ),
      encoderSettings: ChannelEncoderSettings.fromMap(
        (map['encoderSettings'] as Map).cast<String, dynamic>(),
      ),
      inputAttachments: pulumi.Input.decodeList<ChannelInputAttachment>(
        map['inputAttachments'],
        (value) => ChannelInputAttachment.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      inputSpecification: ChannelInputSpecification.fromMap(
        (map['inputSpecification'] as Map).cast<String, dynamic>(),
      ),
      logLevel: map['logLevel'] == null ? null : map['logLevel'] as String,
      maintenance: map['maintenance'] == null
          ? null
          : ChannelMaintenance.fromMap(
              (map['maintenance'] as Map).cast<String, dynamic>(),
            ),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      roleArn: map['roleArn'] == null ? null : map['roleArn'] as String,
      startChannel: map['startChannel'] == null
          ? null
          : map['startChannel'] as bool,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      vpc: map['vpc'] == null
          ? null
          : ChannelVpc.fromMap((map['vpc'] as Map).cast<String, dynamic>()),
    );
  }
}
