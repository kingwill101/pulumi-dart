...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final frameCaptureCdnSettingsValue = frameCaptureCdnSettings;
    if (frameCaptureCdnSettingsValue != null) {
      map['frameCaptureCdnSettings'] = frameCaptureCdnSettingsValue.toMap();
    }
    return map;
  }
    ...
    return ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettings(
      ...
      frameCaptureCdnSettings: map['frameCaptureCdnSettings'] == null
          ...
          : ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettingsFrameCaptureCdnSettings
              .fromMap((map['frameCaptureCdnSettings'] as Map)
                  .cast<String, dynamic>()),
    );
  }
}
