...
class ChannelEncoderSettingsAudioDescriptionCodecSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final aacSettingsValue = aacSettings;
    if (aacSettingsValue != null) {
      map['aacSettings'] = aacSettingsValue.toMap();
    }
    final ac3SettingsValue = ac3Settings;
    if (ac3SettingsValue != null) {
      map['ac3Settings'] = ac3SettingsValue.toMap();
    }
    final eac3AtmosSettingsValue = eac3AtmosSettings;
    if (eac3AtmosSettingsValue != null) {
      map['eac3AtmosSettings'] = eac3AtmosSettingsValue.toMap();
    }
    final eac3SettingsValue = eac3Settings;
    if (eac3SettingsValue != null) {
      map['eac3Settings'] = eac3SettingsValue.toMap();
    }
    final mp2SettingsValue = mp2Settings;
    if (mp2SettingsValue != null) {
      map['mp2Settings'] = mp2SettingsValue.toMap();
    }
    final passThroughSettingsValue = passThroughSettings;
    if (passThroughSettingsValue != null) {
      map['passThroughSettings'] = passThroughSettingsValue;
    }
    final wavSettingsValue = wavSettings;
    if (wavSettingsValue != null) {
      map['wavSettings'] = wavSettingsValue.toMap();
    }
    return map;
  }
    ...
    return ChannelEncoderSettingsAudioDescriptionCodecSettings(
      aacSettings: map['aacSettings'] == null
          ...
          : ChannelEncoderSettingsAudioDescriptionCodecSettingsAacSettings
              .fromMap((map['aacSettings'] as Map).cast<String, dynamic>()),
      ac3Settings: map['ac3Settings'] == null
          ? null
          : ChannelEncoderSettingsAudioDescriptionCodecSettingsAc3Settings
              .fromMap((map['ac3Settings'] as Map).cast<String, dynamic>()),
      ...
      eac3Settings: map['eac3Settings'] == null
          ...
          : ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3Settings
              .fromMap((map['eac3Settings'] as Map).cast<String, dynamic>()),
      mp2Settings: map['mp2Settings'] == null
          ? null
          : ChannelEncoderSettingsAudioDescriptionCodecSettingsMp2Settings
              .fromMap((map['mp2Settings'] as Map).cast<String, dynamic>()),
      ...
      wavSettings: map['wavSettings'] == null
          ...
          : ChannelEncoderSettingsAudioDescriptionCodecSettingsWavSettings
              .fromMap((map['wavSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
