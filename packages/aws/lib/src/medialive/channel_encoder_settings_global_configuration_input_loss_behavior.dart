...
class ChannelEncoderSettingsGlobalConfigurationInputLossBehavior {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inputLossImageSlate': ?inputLossImageSlate == null
          ? null
          : inputLossImageSlate!.toMap(),
  ...
  factory ChannelEncoderSettingsGlobalConfigurationInputLossBehavior.fromMap(
    ...
    return ChannelEncoderSettingsGlobalConfigurationInputLossBehavior(
      blackFrameMsec: map['blackFrameMsec'] == null
          ? null
          : map['blackFrameMsec'] as int,
      ...
      repeatFrameMsec: map['repeatFrameMsec'] == null
          ? null
          : map['repeatFrameMsec'] as int,
    );
  }
}
