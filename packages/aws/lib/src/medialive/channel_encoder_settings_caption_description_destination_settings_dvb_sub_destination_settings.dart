...
class ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings {
  ...
  final ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettingsFont? font;
  ...
  factory ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings(
      ...
      backgroundOpacity: map['backgroundOpacity'] == null ? null : map['backgroundOpacity'] as int,
      font: map['font'] == null ? null : ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettingsFont.fromMap((map['font'] as Map).cast<String, dynamic>()),
      fontColor: map['fontColor'] == null ? null : map['fontColor'] as String,
      fontOpacity: map['fontOpacity'] == null ? null : map['fontOpacity'] as int,
      fontResolution: map['fontResolution'] == null ? null : map['fontResolution'] as int,
      fontSize: map['fontSize'] == null ? null : map['fontSize'] as String,
      outlineColor: map['outlineColor'] == null ? null : map['outlineColor'] as String,
      outlineSize: map['outlineSize'] == null ? null : map['outlineSize'] as int,
      shadowColor: map['shadowColor'] == null ? null : map['shadowColor'] as String,
      shadowOpacity: map['shadowOpacity'] == null ? null : map['shadowOpacity'] as int,
      shadowXOffset: map['shadowXOffset'] == null ? null : map['shadowXOffset'] as int,
      shadowYOffset: map['shadowYOffset'] == null ? null : map['shadowYOffset'] as int,
      teletextGridControl: map['teletextGridControl'] == null ? null : map['teletextGridControl'] as String,
