...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettings {
  final List<ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySetting>? staticKeySettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'staticKeySettings': ?staticKeySettings == null ? null : pulumi.Input.encodeList<ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySetting, Map<String, dynamic>>(staticKeySettings!, (value) => value.toMap()),
    };
  }
