...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettings {
  ...
  final ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettingsArchiveS3Settings? archiveS3Settings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'archiveS3Settings': ?archiveS3Settings == null ? null : archiveS3Settings!.toMap(),
    };
  }
  ...
  factory ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettings.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettings(
      archiveS3Settings: map['archiveS3Settings'] == null ? null : ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettingsArchiveS3Settings.fromMap((map['archiveS3Settings'] as Map).cast<String, dynamic>()),
    );
  }
}
