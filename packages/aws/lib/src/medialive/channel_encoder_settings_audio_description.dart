  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audioNormalizationSettings': ?audioNormalizationSettings == null
          ? null
          : audioNormalizationSettings!.toMap(),
      'audioSelectorName': audioSelectorName,
      'audioType': ?audioType,
      'audioTypeControl': ?audioTypeControl,
      'audioWatermarkSettings': ?audioWatermarkSettings == null
          ? null
          : audioWatermarkSettings!.toMap(),
    ...
    return ChannelEncoderSettingsAudioDescription(
      audioNormalizationSettings: map['audioNormalizationSettings'] == null
          ...
          : ChannelEncoderSettingsAudioDescriptionAudioNormalizationSettings.fromMap(
              (map['audioNormalizationSettings'] as Map)
                  .cast<String, dynamic>(),
            ),
      ...
      audioWatermarkSettings: map['audioWatermarkSettings'] == null
          ...
          : ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettings.fromMap(
              (map['audioWatermarkSettings'] as Map).cast<String, dynamic>(),
            ),
