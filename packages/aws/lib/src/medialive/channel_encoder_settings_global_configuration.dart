...
class ChannelEncoderSettingsGlobalConfiguration {
  ...
  final ChannelEncoderSettingsGlobalConfigurationInputLossBehavior? inputLossBehavior;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inputLossBehavior': ?inputLossBehavior == null ? null : inputLossBehavior!.toMap(),
  ...
  factory ChannelEncoderSettingsGlobalConfiguration.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsGlobalConfiguration(
      initialAudioGain: map['initialAudioGain'] == null ? null : map['initialAudioGain'] as int,
      inputEndAction: map['inputEndAction'] == null ? null : map['inputEndAction'] as String,
      inputLossBehavior: map['inputLossBehavior'] == null ? null : ChannelEncoderSettingsGlobalConfigurationInputLossBehavior.fromMap((map['inputLossBehavior'] as Map).cast<String, dynamic>()),
      outputLockingMode: map['outputLockingMode'] == null ? null : map['outputLockingMode'] as String,
      outputTimingSource: map['outputTimingSource'] == null ? null : map['outputTimingSource'] as String,
      supportLowFramerateInputs: map['supportLowFramerateInputs'] == null ? null : map['supportLowFramerateInputs'] as String,
    );
  }
}
