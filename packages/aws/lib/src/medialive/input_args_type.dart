...
class InputArgsType {
  ...
  InputArgsType({
    ...
    InputVpc? vpc,
            ...
            pulumi.Input.asOptionalInput<List<InputDestination>>(destinations),
        inputDevices =
            pulumi.Input.asOptionalInput<List<InputInputDevice>>(inputDevices),
        inputSecurityGroups =
            pulumi.Input.asOptionalInput<List<String>>(inputSecurityGroups),
        mediaConnectFlows =
  ...
  factory InputArgsType.fromMap(Map<String, dynamic> map) {
    return InputArgsType(
      ...
      inputDevices: map['inputDevices'] == null
          ? null
          : pulumi.Input.decodeList<InputInputDevice>(
              map['inputDevices'],
              (value) => InputInputDevice.fromMap(
                  (value as Map).cast<String, dynamic>())),
      inputSecurityGroups: map['inputSecurityGroups'] == null
          ? null
          : (map['inputSecurityGroups'] as List).cast<String>(),
      mediaConnectFlows: map['mediaConnectFlows'] == null
          ? null
      ...
      vpc: map['vpc'] == null
          ? null
          : InputVpc.fromMap((map['vpc'] as Map).cast<String, dynamic>()),
    );
  }
}
