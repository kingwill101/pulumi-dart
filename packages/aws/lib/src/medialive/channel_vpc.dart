...
class ChannelVpc {
  ...
  factory ChannelVpc.fromMap(Map<String, dynamic> map) {
    return ChannelVpc(
      ...
      networkInterfaceIds: map['networkInterfaceIds'] == null ? null : (map['networkInterfaceIds'] as List).cast<String>(),
      publicAddressAllocationIds: (map['publicAddressAllocationIds'] as List).cast<String>(),
