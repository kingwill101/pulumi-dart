...
class EnvironmentProfileArgs {
  ...
  factory EnvironmentProfileArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentProfileArgs(
      ...
      environmentBlueprintIdentifier: map['environmentBlueprintIdentifier'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      projectIdentifier: map['projectIdentifier'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      userParameters: map['userParameters'] == null ? null : pulumi.Input.decodeList<EnvironmentProfileUserParameter>(map['userParameters'], (value) => EnvironmentProfileUserParameter.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
