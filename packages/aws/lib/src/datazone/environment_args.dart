...
class EnvironmentArgs {
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      accountIdentifier: map['accountIdentifier'] == null ? null : map['accountIdentifier'] as String,
      accountRegion: map['accountRegion'] == null ? null : map['accountRegion'] as String,
      blueprintIdentifier: map['blueprintIdentifier'] == null ? null : map['blueprintIdentifier'] as String,
      ...
      userParameters: map['userParameters'] == null ? null : pulumi.Input.decodeList<EnvironmentUserParameter>(map['userParameters'], (value) => EnvironmentUserParameter.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
