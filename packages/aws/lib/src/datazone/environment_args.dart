...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    List<EnvironmentUserParameter>? userParameters,
            ...
            pulumi.Input.asOptionalInput<String>(accountIdentifier),
        accountRegion = pulumi.Input.asOptionalInput<String>(accountRegion),
        blueprintIdentifier =
            pulumi.Input.asOptionalInput<String>(blueprintIdentifier),
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      accountRegion:
          map['accountRegion'] == null ? null : map['accountRegion'] as String,
