...
class AssetTypeArgs {
  ...
  factory AssetTypeArgs.fromMap(Map<String, dynamic> map) {
    return AssetTypeArgs(
      ...
      formsInputs: map['formsInputs'] == null ? null : pulumi.Input.decodeList<AssetTypeFormsInput>(map['formsInputs'], (value) => AssetTypeFormsInput.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      owningProjectIdentifier: map['owningProjectIdentifier'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      timeouts: map['timeouts'] == null ? null : AssetTypeTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
