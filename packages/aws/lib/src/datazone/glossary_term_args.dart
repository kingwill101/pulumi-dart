...
class GlossaryTermArgs {
  ...
  }) : domainIdentifier = pulumi.Input.asOptionalInput<String>(
         domainIdentifier,
       ),
  ...
  factory GlossaryTermArgs.fromMap(Map<String, dynamic> map) {
    return GlossaryTermArgs(
      domainIdentifier: map['domainIdentifier'] == null
          ? null
      ...
      termRelations: map['termRelations'] == null
          ? null
          : GlossaryTermTermRelations.fromMap(
              (map['termRelations'] as Map).cast<String, dynamic>(),
            ),
