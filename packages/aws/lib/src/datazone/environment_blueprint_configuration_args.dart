...
class EnvironmentBlueprintConfigurationArgs {
  ...
  EnvironmentBlueprintConfigurationArgs({
    ...
    Map<String, Map<String, String>>? regionalParameters,
       ...
       environmentBlueprintId = pulumi.Input.asInput<String>(
         environmentBlueprintId,
       ),
       manageAccessRoleArn = pulumi.Input.asOptionalInput<String>(
         manageAccessRoleArn,
       ),
       provisioningRoleArn = pulumi.Input.asOptionalInput<String>(
         provisioningRoleArn,
       ),
