...
class EnvironmentBlueprintConfigurationArgs {
  ...
  factory EnvironmentBlueprintConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentBlueprintConfigurationArgs(
      ...
      manageAccessRoleArn: map['manageAccessRoleArn'] == null ? null : map['manageAccessRoleArn'] as String,
      provisioningRoleArn: map['provisioningRoleArn'] == null ? null : map['provisioningRoleArn'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      regionalParameters: map['regionalParameters'] == null ? null : (map['regionalParameters'] as Map).cast<String, Map<String, String>>(),
    );
  }
}
