...
class FormTypeArgs {
  ...
  factory FormTypeArgs.fromMap(Map<String, dynamic> map) {
    return FormTypeArgs(
      ...
      model: FormTypeModel.fromMap((map['model'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      owningProjectIdentifier: map['owningProjectIdentifier'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      timeouts: map['timeouts'] == null ? null : FormTypeTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
