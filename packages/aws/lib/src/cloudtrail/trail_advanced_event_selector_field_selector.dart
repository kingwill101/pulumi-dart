...
class TrailAdvancedEventSelectorFieldSelector {
  ...
  factory TrailAdvancedEventSelectorFieldSelector.fromMap(Map<String, dynamic> map) {
    return TrailAdvancedEventSelectorFieldSelector(
      endsWiths: map['endsWiths'] == null ? null : (map['endsWiths'] as List).cast<String>(),
      equals: map['equals'] == null ? null : (map['equals'] as List).cast<String>(),
      field: map['field'] as String,
      notEndsWiths: map['notEndsWiths'] == null ? null : (map['notEndsWiths'] as List).cast<String>(),
      notEquals: map['notEquals'] == null ? null : (map['notEquals'] as List).cast<String>(),
      notStartsWiths: map['notStartsWiths'] == null ? null : (map['notStartsWiths'] as List).cast<String>(),
      startsWiths: map['startsWiths'] == null ? null : (map['startsWiths'] as List).cast<String>(),
    );
  }
}
