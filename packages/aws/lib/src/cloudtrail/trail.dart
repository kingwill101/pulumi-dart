...
class Trail extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<TrailAdvancedEventSelector>?>
  advancedEventSelectors;
  ...
  Trail(String name, {TrailArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.cloudWatchLogsGroupArn = registerOutput<String?>(
      'cloudWatchLogsGroupArn',
    );
    this.cloudWatchLogsRoleArn = registerOutput<String?>(
      'cloudWatchLogsRoleArn',
    );
    this.enableLogFileValidation = registerOutput<bool?>(
      'enableLogFileValidation',
    );
    this.enableLogging = registerOutput<bool?>('enableLogging');
    this.eventSelectors = registerOutput<List<TrailEventSelector>?>(
      'eventSelectors',
    );
    this.homeRegion = registerOutput<String>('homeRegion');
    this.includeGlobalServiceEvents = registerOutput<bool?>(
      'includeGlobalServiceEvents',
    );
    this.insightSelectors = registerOutput<List<TrailInsightSelector>?>(
      'insightSelectors',
    );
