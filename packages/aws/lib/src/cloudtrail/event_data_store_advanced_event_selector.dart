...
class EventDataStoreAdvancedEventSelector {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fieldSelectors': ?fieldSelectors == null ? null : pulumi.Input.encodeList<EventDataStoreAdvancedEventSelectorFieldSelector, Map<String, dynamic>>(fieldSelectors!, (value) => value.toMap()),
      'name': ?name,
    };
  }
  ...
  factory EventDataStoreAdvancedEventSelector.fromMap(Map<String, dynamic> map) {
    return EventDataStoreAdvancedEventSelector(
      fieldSelectors: map['fieldSelectors'] == null ? null : pulumi.Input.decodeList<EventDataStoreAdvancedEventSelectorFieldSelector>(map['fieldSelectors'], (value) => EventDataStoreAdvancedEventSelectorFieldSelector.fromMap((value as Map).cast<String, dynamic>())),
