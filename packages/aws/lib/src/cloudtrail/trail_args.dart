...
class TrailArgs {
  ...
  factory TrailArgs.fromMap(Map<String, dynamic> map) {
    return TrailArgs(
      advancedEventSelectors: map['advancedEventSelectors'] == null ? null : pulumi.Input.decodeList<TrailAdvancedEventSelector>(map['advancedEventSelectors'], (value) => TrailAdvancedEventSelector.fromMap((value as Map).cast<String, dynamic>())),
      cloudWatchLogsGroupArn: map['cloudWatchLogsGroupArn'] == null ? null : map['cloudWatchLogsGroupArn'] as String,
      ...
      eventSelectors: map['eventSelectors'] == null ? null : pulumi.Input.decodeList<TrailEventSelector>(map['eventSelectors'], (value) => TrailEventSelector.fromMap((value as Map).cast<String, dynamic>())),
      includeGlobalServiceEvents: map['includeGlobalServiceEvents'] == null ? null : map['includeGlobalServiceEvents'] as bool,
      insightSelectors: map['insightSelectors'] == null ? null : pulumi.Input.decodeList<TrailInsightSelector>(map['insightSelectors'], (value) => TrailInsightSelector.fromMap((value as Map).cast<String, dynamic>())),
