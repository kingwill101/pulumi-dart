...
class TrailArgs {
  ...
  TrailArgs({
    ...
    Map<String, String>? tags,
       ...
       cloudWatchLogsGroupArn = pulumi.Input.asOptionalInput<String>(
         cloudWatchLogsGroupArn,
       ),
       cloudWatchLogsRoleArn = pulumi.Input.asOptionalInput<String>(
       ...
       insightSelectors = pulumi
           .Input.asOptionalInput<List<TrailInsightSelector>>(insightSelectors),
