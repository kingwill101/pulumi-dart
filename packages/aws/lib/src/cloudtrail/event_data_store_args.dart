...
class EventDataStoreArgs {
  ...
  factory EventDataStoreArgs.fromMap(Map<String, dynamic> map) {
    return EventDataStoreArgs(
      advancedEventSelectors: map['advancedEventSelectors'] == null ? null : pulumi.Input.decodeList<EventDataStoreAdvancedEventSelector>(map['advancedEventSelectors'], (value) => EventDataStoreAdvancedEventSelector.fromMap((value as Map).cast<String, dynamic>())),
      billingMode: map['billingMode'] == null ? null : map['billingMode'] as String,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      multiRegionEnabled: map['multiRegionEnabled'] == null ? null : map['multiRegionEnabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      organizationEnabled: map['organizationEnabled'] == null ? null : map['organizationEnabled'] as bool,
