...
class DataRepositoryAssociationArgs {
  ...
  factory DataRepositoryAssociationArgs.fromMap(Map<String, dynamic> map) {
    return DataRepositoryAssociationArgs(
      batchImportMetaDataOnCreate: map['batchImportMetaDataOnCreate'] == null ? null : map['batchImportMetaDataOnCreate'] as bool,
      dataRepositoryPath: map['dataRepositoryPath'] as String,
      deleteDataInFilesystem: map['deleteDataInFilesystem'] == null ? null : map['deleteDataInFilesystem'] as bool,
      ...
      s3: map['s3'] == null ? null : DataRepositoryAssociationS3.fromMap((map['s3'] as Map).cast<String, dynamic>()),
