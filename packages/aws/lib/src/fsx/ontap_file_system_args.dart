...
class OntapFileSystemArgs {
  ...
  OntapFileSystemArgs({
    ...
    String? weeklyMaintenanceStartTime,
        ...
        endpointIpAddressRange =
            pulumi.Input.asOptionalInput<String>(endpointIpAddressRange),
        fsxAdminPassword =
            pulumi.Input.asOptionalInput<String>(fsxAdminPassword),
        ...
        routeTableIds =
            pulumi.Input.asOptionalInput<List<String>>(routeTableIds),
        securityGroupIds =
        ...
        throughputCapacityPerHaPair =
            pulumi.Input.asOptionalInput<int>(throughputCapacityPerHaPair),
  ...
  factory OntapFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return OntapFileSystemArgs(
      ...
      fsxAdminPassword: map['fsxAdminPassword'] == null
          ? null
          : map['fsxAdminPassword'] as String,
      ...
      throughputCapacityPerHaPair: map['throughputCapacityPerHaPair'] == null
          ? null
          : map['throughputCapacityPerHaPair'] as int,
