...
class OntapVolume extends pulumi.CustomResource {
  ...
  OntapVolume(
    ...
    this.bypassSnaplockEnterpriseRetention = registerOutput<bool?>(
    ...
    this.flexcacheEndpointType = registerOutput<String>(
    ...
    this.storageEfficiencyEnabled = registerOutput<bool?>(
      'storageEfficiencyEnabled',
    );
    this.storageVirtualMachineId = registerOutput<String>(
      'storageVirtualMachineId',
    );
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.tieringPolicy = registerOutput<OntapVolumeTieringPolicy?>(
      'tieringPolicy',
    );
