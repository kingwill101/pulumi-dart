...
class FileCacheArgs {
  ...
  factory FileCacheArgs.fromMap(Map<String, dynamic> map) {
    return FileCacheArgs(
      copyTagsToDataRepositoryAssociations: map['copyTagsToDataRepositoryAssociations'] == null ? null : map['copyTagsToDataRepositoryAssociations'] as bool,
      dataRepositoryAssociations: map['dataRepositoryAssociations'] == null ? null : pulumi.Input.decodeList<FileCacheDataRepositoryAssociation>(map['dataRepositoryAssociations'], (value) => FileCacheDataRepositoryAssociation.fromMap((value as Map).cast<String, dynamic>())),
      fileCacheType: map['fileCacheType'] as String,
      fileCacheTypeVersion: map['fileCacheTypeVersion'] as String,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      lustreConfigurations: map['lustreConfigurations'] == null ? null : pulumi.Input.decodeList<FileCacheLustreConfiguration>(map['lustreConfigurations'], (value) => FileCacheLustreConfiguration.fromMap((value as Map).cast<String, dynamic>())),
