...
class FileCacheArgs {
  ...
  }) : copyTagsToDataRepositoryAssociations = pulumi
           .Input.asOptionalInput<bool>(copyTagsToDataRepositoryAssociations),
       dataRepositoryAssociations =
           pulumi.Input.asOptionalInput<
             List<FileCacheDataRepositoryAssociation>
           >(dataRepositoryAssociations),
       fileCacheType = pulumi.Input.asInput<String>(fileCacheType),
       fileCacheTypeVersion = pulumi.Input.asInput<String>(
