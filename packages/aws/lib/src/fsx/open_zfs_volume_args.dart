...
class OpenZfsVolumeArgs {
  ...
  OpenZfsVolumeArgs({
    ...
    String? volumeType,
            ...
            pulumi.Input.asOptionalInput<bool>(copyTagsToSnapshots),
        dataCompressionType =
            pulumi.Input.asOptionalInput<String>(dataCompressionType),
        deleteVolumeOptions =
            pulumi.Input.asOptionalInput<String>(deleteVolumeOptions),
        name = pulumi.Input.asOptionalInput<String>(name),
        nfsExports =
            pulumi.Input.asOptionalInput<OpenZfsVolumeNfsExports>(nfsExports),
        originSnapshot =
            pulumi.Input.asOptionalInput<OpenZfsVolumeOriginSnapshot>(
                originSnapshot),
        ...
        storageCapacityQuotaGib =
            pulumi.Input.asOptionalInput<int>(storageCapacityQuotaGib),
        storageCapacityReservationGib =
            pulumi.Input.asOptionalInput<int>(storageCapacityReservationGib),
