...
class OpenZfsVolumeArgs {
  ...
  factory OpenZfsVolumeArgs.fromMap(Map<String, dynamic> map) {
    return OpenZfsVolumeArgs(
      ...
      deleteVolumeOptions: map['deleteVolumeOptions'] == null ? null : map['deleteVolumeOptions'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nfsExports: map['nfsExports'] == null ? null : OpenZfsVolumeNfsExports.fromMap((map['nfsExports'] as Map).cast<String, dynamic>()),
      originSnapshot: map['originSnapshot'] == null ? null : OpenZfsVolumeOriginSnapshot.fromMap((map['originSnapshot'] as Map).cast<String, dynamic>()),
      ...
      storageCapacityQuotaGib: map['storageCapacityQuotaGib'] == null ? null : map['storageCapacityQuotaGib'] as int,
      storageCapacityReservationGib: map['storageCapacityReservationGib'] == null ? null : map['storageCapacityReservationGib'] as int,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userAndGroupQuotas: map['userAndGroupQuotas'] == null ? null : pulumi.Input.decodeList<OpenZfsVolumeUserAndGroupQuota>(map['userAndGroupQuotas'], (value) => OpenZfsVolumeUserAndGroupQuota.fromMap((value as Map).cast<String, dynamic>())),
