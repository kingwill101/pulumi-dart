...
class OpenZfsVolumeArgs {
  ...
  OpenZfsVolumeArgs({
    ...
    String? name,
    OpenZfsVolumeNfsExports? nfsExports,
    OpenZfsVolumeOriginSnapshot? originSnapshot,
    required String parentVolumeId,
    bool? readOnly,
    int? recordSizeKib,
    String? region,
    ...
    List<OpenZfsVolumeUserAndGroupQuota>? userAndGroupQuotas,
    String? volumeType,
  }) : copyTagsToSnapshots = pulumi.Input.asOptionalInput<bool>(
         copyTagsToSnapshots,
       ),
       dataCompressionType = pulumi.Input.asOptionalInput<String>(
         dataCompressionType,
       ),
       deleteVolumeOptions = pulumi.Input.asOptionalInput<String>(
         deleteVolumeOptions,
       ),
       ...
       originSnapshot = pulumi
           .Input.asOptionalInput<OpenZfsVolumeOriginSnapshot>(originSnapshot),
       ...
       storageCapacityQuotaGib = pulumi.Input.asOptionalInput<int>(
    ...
    return <String, dynamic>{
      ...
      'originSnapshot':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(originSnapshot, (value) => value.toMap()),
      ...
      'userAndGroupQuotas':
          ?pulumi.Input.mapOptionalInputValue<
            List<OpenZfsVolumeUserAndGroupQuota>,
  ...
  factory OpenZfsVolumeArgs.fromMap(Map<String, dynamic> map) {
    return OpenZfsVolumeArgs(
      ...
      deleteVolumeOptions: map['deleteVolumeOptions'] == null
          ? null
          : map['deleteVolumeOptions'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nfsExports: map['nfsExports'] == null
          ? null
          : OpenZfsVolumeNfsExports.fromMap(
              (map['nfsExports'] as Map).cast<String, dynamic>(),
            ),
      originSnapshot: map['originSnapshot'] == null
          ? null
          : OpenZfsVolumeOriginSnapshot.fromMap(
              (map['originSnapshot'] as Map).cast<String, dynamic>(),
            ),
      parentVolumeId: map['parentVolumeId'] as String,
      readOnly: map['readOnly'] == null ? null : map['readOnly'] as bool,
      recordSizeKib: map['recordSizeKib'] == null
          ? null
          : map['recordSizeKib'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      storageCapacityQuotaGib: map['storageCapacityQuotaGib'] == null
          ? null
          : map['storageCapacityQuotaGib'] as int,
      storageCapacityReservationGib:
          map['storageCapacityReservationGib'] == null
          ? null
          : map['storageCapacityReservationGib'] as int,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      userAndGroupQuotas: map['userAndGroupQuotas'] == null
          ? null
          : pulumi.Input.decodeList<OpenZfsVolumeUserAndGroupQuota>(
              map['userAndGroupQuotas'],
              (value) => OpenZfsVolumeUserAndGroupQuota.fromMap(
