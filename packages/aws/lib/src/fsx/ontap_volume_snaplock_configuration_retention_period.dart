  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultRetention': ?defaultRetention == null
          ? null
          : defaultRetention!.toMap(),
      'maximumRetention': ?maximumRetention == null
          ? null
          : maximumRetention!.toMap(),
      'minimumRetention': ?minimumRetention == null
          ? null
          : minimumRetention!.toMap(),
    };
  }
  ...
  factory OntapVolumeSnaplockConfigurationRetentionPeriod.fromMap(
    ...
    return OntapVolumeSnaplockConfigurationRetentionPeriod(
      defaultRetention: map['defaultRetention'] == null
          ? null
          : OntapVolumeSnaplockConfigurationRetentionPeriodDefaultRetention.fromMap(
              (map['defaultRetention'] as Map).cast<String, dynamic>(),
            ),
      maximumRetention: map['maximumRetention'] == null
          ? null
          : OntapVolumeSnaplockConfigurationRetentionPeriodMaximumRetention.fromMap(
              (map['maximumRetention'] as Map).cast<String, dynamic>(),
            ),
      minimumRetention: map['minimumRetention'] == null
          ? null
          : OntapVolumeSnaplockConfigurationRetentionPeriodMinimumRetention.fromMap(
