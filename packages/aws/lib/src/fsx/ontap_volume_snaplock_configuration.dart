...
class OntapVolumeSnaplockConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'autocommitPeriod': ?autocommitPeriod == null ? null : autocommitPeriod!.toMap(),
      'privilegedDelete': ?privilegedDelete,
      'retentionPeriod': ?retentionPeriod == null ? null : retentionPeriod!.toMap(),
  ...
  factory OntapVolumeSnaplockConfiguration.fromMap(Map<String, dynamic> map) {
    return OntapVolumeSnaplockConfiguration(
      auditLogVolume: map['auditLogVolume'] == null ? null : map['auditLogVolume'] as bool,
      autocommitPeriod: map['autocommitPeriod'] == null ? null : OntapVolumeSnaplockConfigurationAutocommitPeriod.fromMap((map['autocommitPeriod'] as Map).cast<String, dynamic>()),
      privilegedDelete: map['privilegedDelete'] == null ? null : map['privilegedDelete'] as String,
      retentionPeriod: map['retentionPeriod'] == null ? null : OntapVolumeSnaplockConfigurationRetentionPeriod.fromMap((map['retentionPeriod'] as Map).cast<String, dynamic>()),
      snaplockType: map['snaplockType'] as String,
      volumeAppendModeEnabled: map['volumeAppendModeEnabled'] == null ? null : map['volumeAppendModeEnabled'] as bool,
    );
  }
}
