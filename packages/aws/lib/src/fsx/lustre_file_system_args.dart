...
class LustreFileSystemArgs {
  ...
  LustreFileSystemArgs({
    ...
    LustreFileSystemDataReadCacheConfiguration? dataReadCacheConfiguration,
    ...
    String? kmsKeyId,
    LustreFileSystemLogConfiguration? logConfiguration,
    LustreFileSystemMetadataConfiguration? metadataConfiguration,
    int? perUnitStorageThroughput,
    String? region,
    LustreFileSystemRootSquashConfiguration? rootSquashConfiguration,
  ...
  factory LustreFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return LustreFileSystemArgs(
      autoImportPolicy: map['autoImportPolicy'] == null ? null : map['autoImportPolicy'] as String,
      ...
      copyTagsToBackups: map['copyTagsToBackups'] == null ? null : map['copyTagsToBackups'] as bool,
      ...
      dataReadCacheConfiguration: map['dataReadCacheConfiguration'] == null ? null : LustreFileSystemDataReadCacheConfiguration.fromMap((map['dataReadCacheConfiguration'] as Map).cast<String, dynamic>()),
      deploymentType: map['deploymentType'] == null ? null : map['deploymentType'] as String,
      driveCacheType: map['driveCacheType'] == null ? null : map['driveCacheType'] as String,
      efaEnabled: map['efaEnabled'] == null ? null : map['efaEnabled'] as bool,
      exportPath: map['exportPath'] == null ? null : map['exportPath'] as String,
      fileSystemTypeVersion: map['fileSystemTypeVersion'] == null ? null : map['fileSystemTypeVersion'] as String,
      finalBackupTags: map['finalBackupTags'] == null ? null : (map['finalBackupTags'] as Map).cast<String, String>(),
      importPath: map['importPath'] == null ? null : map['importPath'] as String,
      importedFileChunkSize: map['importedFileChunkSize'] == null ? null : map['importedFileChunkSize'] as int,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      logConfiguration: map['logConfiguration'] == null ? null : LustreFileSystemLogConfiguration.fromMap((map['logConfiguration'] as Map).cast<String, dynamic>()),
      metadataConfiguration: map['metadataConfiguration'] == null ? null : LustreFileSystemMetadataConfiguration.fromMap((map['metadataConfiguration'] as Map).cast<String, dynamic>()),
      perUnitStorageThroughput: map['perUnitStorageThroughput'] == null ? null : map['perUnitStorageThroughput'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      rootSquashConfiguration: map['rootSquashConfiguration'] == null ? null : LustreFileSystemRootSquashConfiguration.fromMap((map['rootSquashConfiguration'] as Map).cast<String, dynamic>()),
      securityGroupIds: map['securityGroupIds'] == null ? null : (map['securityGroupIds'] as List).cast<String>(),
      skipFinalBackup: map['skipFinalBackup'] == null ? null : map['skipFinalBackup'] as bool,
      storageCapacity: map['storageCapacity'] == null ? null : map['storageCapacity'] as int,
      storageType: map['storageType'] == null ? null : map['storageType'] as String,
      subnetIds: map['subnetIds'] as String,
