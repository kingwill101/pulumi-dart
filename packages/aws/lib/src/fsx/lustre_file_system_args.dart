...
class LustreFileSystemArgs {
  ...
  LustreFileSystemArgs({
    ...
    String? weeklyMaintenanceStartTime,
  }) : autoImportPolicy = pulumi.Input.asOptionalInput<String>(
         autoImportPolicy,
       ),
       ...
       dataCompressionType = pulumi.Input.asOptionalInput<String>(
         dataCompressionType,
       ),
       dataReadCacheConfiguration =
       ...
       fileSystemTypeVersion = pulumi.Input.asOptionalInput<String>(
       ...
       perUnitStorageThroughput = pulumi.Input.asOptionalInput<int>(
       ...
       throughputCapacity = pulumi.Input.asOptionalInput<int>(
         throughputCapacity,
       ),
  ...
  factory LustreFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return LustreFileSystemArgs(
      ...
      importPath: map['importPath'] == null
          ? null
          : map['importPath'] as String,
