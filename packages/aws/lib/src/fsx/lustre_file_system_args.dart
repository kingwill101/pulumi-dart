...
class LustreFileSystemArgs {
  ...
  LustreFileSystemArgs({
    ...
    String? weeklyMaintenanceStartTime,
            ...
            pulumi.Input.asOptionalInput<String>(autoImportPolicy),
        ...
        dataCompressionType =
            pulumi.Input.asOptionalInput<String>(dataCompressionType),
        dataReadCacheConfiguration = pulumi.Input.asOptionalInput<
        ...
        fileSystemTypeVersion =
            pulumi.Input.asOptionalInput<String>(fileSystemTypeVersion),
        finalBackupTags =
        ...
        logConfiguration =
            pulumi.Input.asOptionalInput<LustreFileSystemLogConfiguration>(
                logConfiguration),
        metadataConfiguration =
            pulumi.Input.asOptionalInput<LustreFileSystemMetadataConfiguration>(
                metadataConfiguration),
        perUnitStorageThroughput =
            pulumi.Input.asOptionalInput<int>(perUnitStorageThroughput),
        region = pulumi.Input.asOptionalInput<String>(region),
        rootSquashConfiguration = pulumi.Input.asOptionalInput<
            LustreFileSystemRootSquashConfiguration>(rootSquashConfiguration),
        securityGroupIds =
        ...
        throughputCapacity =
            pulumi.Input.asOptionalInput<int>(throughputCapacity),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (dataReadCacheConfigurationValue != null) {
      map['dataReadCacheConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (rootSquashConfigurationValue != null) {
      map['rootSquashConfiguration'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory LustreFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return LustreFileSystemArgs(
      autoImportPolicy: map['autoImportPolicy'] == null
          ? null
          : map['autoImportPolicy'] as String,
      ...
      dataReadCacheConfiguration: map['dataReadCacheConfiguration'] == null
          ? null
          : LustreFileSystemDataReadCacheConfiguration.fromMap(
              (map['dataReadCacheConfiguration'] as Map)
                  .cast<String, dynamic>()),
      deploymentType: map['deploymentType'] == null
          ? null
          : map['deploymentType'] as String,
      driveCacheType: map['driveCacheType'] == null
          ? null
          : map['driveCacheType'] as String,
      efaEnabled: map['efaEnabled'] == null ? null : map['efaEnabled'] as bool,
      exportPath:
          map['exportPath'] == null ? null : map['exportPath'] as String,
      fileSystemTypeVersion: map['fileSystemTypeVersion'] == null
          ? null
          : map['fileSystemTypeVersion'] as String,
      finalBackupTags: map['finalBackupTags'] == null
          ? null
          : (map['finalBackupTags'] as Map).cast<String, String>(),
      importPath:
          map['importPath'] == null ? null : map['importPath'] as String,
      ...
      metadataConfiguration: map['metadataConfiguration'] == null
          ? null
          : LustreFileSystemMetadataConfiguration.fromMap(
              (map['metadataConfiguration'] as Map).cast<String, dynamic>()),
      perUnitStorageThroughput: map['perUnitStorageThroughput'] == null
          ? null
          : map['perUnitStorageThroughput'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      rootSquashConfiguration: map['rootSquashConfiguration'] == null
          ? null
          : LustreFileSystemRootSquashConfiguration.fromMap(
              (map['rootSquashConfiguration'] as Map).cast<String, dynamic>()),
