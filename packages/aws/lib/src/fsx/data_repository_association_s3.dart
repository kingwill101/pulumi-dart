...
class DataRepositoryAssociationS3 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoExportPolicy': ?autoExportPolicy == null ? null : autoExportPolicy!.toMap(),
      'autoImportPolicy': ?autoImportPolicy == null ? null : autoImportPolicy!.toMap(),
    };
  }

  factory DataRepositoryAssociationS3.fromMap(Map<String, dynamic> map) {
    return DataRepositoryAssociationS3(
      autoExportPolicy: map['autoExportPolicy'] == null ? null : DataRepositoryAssociationS3AutoExportPolicy.fromMap((map['autoExportPolicy'] as Map).cast<String, dynamic>()),
      autoImportPolicy: map['autoImportPolicy'] == null ? null : DataRepositoryAssociationS3AutoImportPolicy.fromMap((map['autoImportPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
