...
class OntapVolumeArgs {
  ...
  OntapVolumeArgs({
    OntapVolumeAggregateConfiguration? aggregateConfiguration,
    bool? bypassSnaplockEnterpriseRetention,
    ...
    OntapVolumeSnaplockConfiguration? snaplockConfiguration,
    String? snapshotPolicy,
    bool? storageEfficiencyEnabled,
    required String storageVirtualMachineId,
    Map<String, String>? tags,
    OntapVolumeTieringPolicy? tieringPolicy,
    String? volumeStyle,
    String? volumeType,
  }) :
      ...
      storageVirtualMachineId = pulumi.Input.asInput<String>(storageVirtualMachineId),
  ...
  factory OntapVolumeArgs.fromMap(Map<String, dynamic> map) {
    return OntapVolumeArgs(
      aggregateConfiguration: map['aggregateConfiguration'] == null ? null : OntapVolumeAggregateConfiguration.fromMap((map['aggregateConfiguration'] as Map).cast<String, dynamic>()),
      bypassSnaplockEnterpriseRetention: map['bypassSnaplockEnterpriseRetention'] == null ? null : map['bypassSnaplockEnterpriseRetention'] as bool,
      ...
      junctionPath: map['junctionPath'] == null ? null : map['junctionPath'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      ontapVolumeType: map['ontapVolumeType'] == null ? null : map['ontapVolumeType'] as String,
      ...
      sizeInMegabytes: map['sizeInMegabytes'] == null ? null : map['sizeInMegabytes'] as int,
      skipFinalBackup: map['skipFinalBackup'] == null ? null : map['skipFinalBackup'] as bool,
      snaplockConfiguration: map['snaplockConfiguration'] == null ? null : OntapVolumeSnaplockConfiguration.fromMap((map['snaplockConfiguration'] as Map).cast<String, dynamic>()),
      snapshotPolicy: map['snapshotPolicy'] == null ? null : map['snapshotPolicy'] as String,
      storageEfficiencyEnabled: map['storageEfficiencyEnabled'] == null ? null : map['storageEfficiencyEnabled'] as bool,
      storageVirtualMachineId: map['storageVirtualMachineId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tieringPolicy: map['tieringPolicy'] == null ? null : OntapVolumeTieringPolicy.fromMap((map['tieringPolicy'] as Map).cast<String, dynamic>()),
      volumeStyle: map['volumeStyle'] == null ? null : map['volumeStyle'] as String,
