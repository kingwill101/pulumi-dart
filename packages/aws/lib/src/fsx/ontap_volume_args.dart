...
class OntapVolumeArgs {
  ...
  OntapVolumeArgs({
    ...
    String? volumeType,
            ...
            pulumi.Input.asOptionalInput<OntapVolumeAggregateConfiguration>(
                aggregateConfiguration),
        bypassSnaplockEnterpriseRetention = pulumi.Input.asOptionalInput<bool>(
            bypassSnaplockEnterpriseRetention),
        copyTagsToBackups =
        ...
        snaplockConfiguration =
            pulumi.Input.asOptionalInput<OntapVolumeSnaplockConfiguration>(
                snaplockConfiguration),
        snapshotPolicy = pulumi.Input.asOptionalInput<String>(snapshotPolicy),
        storageEfficiencyEnabled =
            pulumi.Input.asOptionalInput<bool>(storageEfficiencyEnabled),
        storageVirtualMachineId =
            pulumi.Input.asInput<String>(storageVirtualMachineId),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        tieringPolicy = pulumi.Input.asOptionalInput<OntapVolumeTieringPolicy>(
            tieringPolicy),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (aggregateConfigurationValue != null) {
      map['aggregateConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (snaplockConfigurationValue != null) {
      map['snaplockConfiguration'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory OntapVolumeArgs.fromMap(Map<String, dynamic> map) {
    return OntapVolumeArgs(
      aggregateConfiguration: map['aggregateConfiguration'] == null
          ? null
          : OntapVolumeAggregateConfiguration.fromMap(
              (map['aggregateConfiguration'] as Map).cast<String, dynamic>()),
      bypassSnaplockEnterpriseRetention:
          map['bypassSnaplockEnterpriseRetention'] == null
              ? null
              : map['bypassSnaplockEnterpriseRetention'] as bool,
      ...
      junctionPath:
          map['junctionPath'] == null ? null : map['junctionPath'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      ontapVolumeType: map['ontapVolumeType'] == null
          ? null
          : map['ontapVolumeType'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      securityStyle:
          map['securityStyle'] == null ? null : map['securityStyle'] as String,
      sizeInBytes:
          map['sizeInBytes'] == null ? null : map['sizeInBytes'] as String,
      sizeInMegabytes:
          map['sizeInMegabytes'] == null ? null : map['sizeInMegabytes'] as int,
      skipFinalBackup: map['skipFinalBackup'] == null
          ? null
          : map['skipFinalBackup'] as bool,
      snaplockConfiguration: map['snaplockConfiguration'] == null
          ? null
          : OntapVolumeSnaplockConfiguration.fromMap(
              (map['snaplockConfiguration'] as Map).cast<String, dynamic>()),
      snapshotPolicy: map['snapshotPolicy'] == null
          ? null
          : map['snapshotPolicy'] as String,
      storageEfficiencyEnabled: map['storageEfficiencyEnabled'] == null
          ? null
          : map['storageEfficiencyEnabled'] as bool,
      ...
      volumeStyle:
          map['volumeStyle'] == null ? null : map['volumeStyle'] as String,
      volumeType:
