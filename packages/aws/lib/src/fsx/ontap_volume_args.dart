...
class OntapVolumeArgs {
  ...
  OntapVolumeArgs({
    ...
    String? volumeType,
       ...
       storageEfficiencyEnabled = pulumi.Input.asOptionalInput<bool>(
         storageEfficiencyEnabled,
       ),
       storageVirtualMachineId = pulumi.Input.asInput<String>(
  ...
  factory OntapVolumeArgs.fromMap(Map<String, dynamic> map) {
    return OntapVolumeArgs(
      ...
      junctionPath: map['junctionPath'] == null
          ? null
          : map['junctionPath'] as String,
      ...
      sizeInBytes: map['sizeInBytes'] == null
          ? null
          : map['sizeInBytes'] as String,
      sizeInMegabytes: map['sizeInMegabytes'] == null
          ? null
          : map['sizeInMegabytes'] as int,
      ...
      volumeStyle: map['volumeStyle'] == null
          ? null
          : map['volumeStyle'] as String,
