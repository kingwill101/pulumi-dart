...
class OpenZfsVolume extends pulumi.CustomResource {
  ...
  OpenZfsVolume(
    ...
    this.originSnapshot = registerOutput<OpenZfsVolumeOriginSnapshot?>('originSnapshot');
    ...
    this.storageCapacityQuotaGib = registerOutput<int>('storageCapacityQuotaGib');
    this.storageCapacityReservationGib = registerOutput<int>('storageCapacityReservationGib');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.userAndGroupQuotas = registerOutput<List<OpenZfsVolumeUserAndGroupQuota>>('userAndGroupQuotas');
