...
class OpenZfsVolume extends pulumi.CustomResource {
  ...
  OpenZfsVolume(
    ...
    this.originSnapshot = registerOutput<OpenZfsVolumeOriginSnapshot?>(
      'originSnapshot',
    );
    ...
    this.storageCapacityQuotaGib = registerOutput<int>(
      'storageCapacityQuotaGib',
    );
    this.storageCapacityReservationGib = registerOutput<int>(
