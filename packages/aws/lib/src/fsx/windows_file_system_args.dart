...
class WindowsFileSystemArgs {
  ...
  factory WindowsFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return WindowsFileSystemArgs(
      ...
      auditLogConfiguration: map['auditLogConfiguration'] == null ? null : WindowsFileSystemAuditLogConfiguration.fromMap((map['auditLogConfiguration'] as Map).cast<String, dynamic>()),
      ...
      diskIopsConfiguration: map['diskIopsConfiguration'] == null ? null : WindowsFileSystemDiskIopsConfiguration.fromMap((map['diskIopsConfiguration'] as Map).cast<String, dynamic>()),
      ...
      selfManagedActiveDirectory: map['selfManagedActiveDirectory'] == null ? null : WindowsFileSystemSelfManagedActiveDirectory.fromMap((map['selfManagedActiveDirectory'] as Map).cast<String, dynamic>()),
