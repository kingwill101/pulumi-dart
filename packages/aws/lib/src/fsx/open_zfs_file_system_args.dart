...
class OpenZfsFileSystemArgs {
  ...
  OpenZfsFileSystemArgs({
    ...
    String? weeklyMaintenanceStartTime,
        ...
        copyTagsToVolumes =
            pulumi.Input.asOptionalInput<bool>(copyTagsToVolumes),
        dailyAutomaticBackupStartTime =
            pulumi.Input.asOptionalInput<String>(dailyAutomaticBackupStartTime),
        deleteOptions =
            pulumi.Input.asOptionalInput<List<String>>(deleteOptions),
        ...
        readCacheConfiguration = pulumi.Input.asOptionalInput<
            OpenZfsFileSystemReadCacheConfiguration>(readCacheConfiguration),
        region = pulumi.Input.asOptionalInput<String>(region),
        rootVolumeConfiguration = pulumi.Input.asOptionalInput<
            OpenZfsFileSystemRootVolumeConfiguration>(rootVolumeConfiguration),
        routeTableIds =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (readCacheConfigurationValue != null) {
      map['readCacheConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (rootVolumeConfigurationValue != null) {
      map['rootVolumeConfiguration'] = pulumi.Input.mapOptionalInputValue<
