...
class OpenZfsFileSystemArgs {
  ...
  factory OpenZfsFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return OpenZfsFileSystemArgs(
      ...
      copyTagsToVolumes: map['copyTagsToVolumes'] == null ? null : map['copyTagsToVolumes'] as bool,
      dailyAutomaticBackupStartTime: map['dailyAutomaticBackupStartTime'] == null ? null : map['dailyAutomaticBackupStartTime'] as String,
      deleteOptions: map['deleteOptions'] == null ? null : (map['deleteOptions'] as List).cast<String>(),
      deploymentType: map['deploymentType'] as String,
      diskIopsConfiguration: map['diskIopsConfiguration'] == null ? null : OpenZfsFileSystemDiskIopsConfiguration.fromMap((map['diskIopsConfiguration'] as Map).cast<String, dynamic>()),
      ...
      preferredSubnetId: map['preferredSubnetId'] == null ? null : map['preferredSubnetId'] as String,
      readCacheConfiguration: map['readCacheConfiguration'] == null ? null : OpenZfsFileSystemReadCacheConfiguration.fromMap((map['readCacheConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      rootVolumeConfiguration: map['rootVolumeConfiguration'] == null ? null : OpenZfsFileSystemRootVolumeConfiguration.fromMap((map['rootVolumeConfiguration'] as Map).cast<String, dynamic>()),
