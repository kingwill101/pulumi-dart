...
class OntapStorageVirtualMachineArgs {
  ...
  OntapStorageVirtualMachineArgs({
    ...
    Map<String, String>? tags,
       ...
       rootVolumeSecurityStyle = pulumi.Input.asOptionalInput<String>(
         rootVolumeSecurityStyle,
       ),
       svmAdminPassword = pulumi.Input.asOptionalInput<String>(
         svmAdminPassword,
       ),
    ...
    return <String, dynamic>{
      'activeDirectoryConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            OntapStorageVirtualMachineActiveDirectoryConfiguration,
            Map<String, dynamic>
          >(activeDirectoryConfiguration, (value) => value.toMap()),
  ...
  factory OntapStorageVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return OntapStorageVirtualMachineArgs(
      activeDirectoryConfiguration: map['activeDirectoryConfiguration'] == null
          ? null
          : OntapStorageVirtualMachineActiveDirectoryConfiguration.fromMap(
              (map['activeDirectoryConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      fileSystemId: map['fileSystemId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      rootVolumeSecurityStyle: map['rootVolumeSecurityStyle'] == null
          ? null
          : map['rootVolumeSecurityStyle'] as String,
      svmAdminPassword: map['svmAdminPassword'] == null
          ? null
          : map['svmAdminPassword'] as String,
      tags: map['tags'] == null
          ? null
