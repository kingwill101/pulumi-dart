...
class FileCacheDataRepositoryAssociationNf {
  ...
  FileCacheDataRepositoryAssociationNf({this.dnsIps, required this.version});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'dnsIps': ?dnsIps, 'version': version};
  }
  ...
  factory FileCacheDataRepositoryAssociationNf.fromMap(
    ...
    return FileCacheDataRepositoryAssociationNf(
      dnsIps: map['dnsIps'] == null
          ? null
          : (map['dnsIps'] as List).cast<String>(),
