...
class LustreFileSystem extends pulumi.CustomResource {
  ...
  LustreFileSystem(
    ...
    this.fileSystemTypeVersion = registerOutput<String>(
      'fileSystemTypeVersion',
    );
    this.finalBackupTags = registerOutput<Map<String, String>?>(
      'finalBackupTags',
    );
    ...
    this.logConfiguration = registerOutput<LustreFileSystemLogConfiguration>(
      'logConfiguration',
    );
    ...
    this.networkInterfaceIds = registerOutput<List<String>>(
      'networkInterfaceIds',
    );
    this.ownerId = registerOutput<String>('ownerId');
    this.perUnitStorageThroughput = registerOutput<int?>(
    ...
    this.weeklyMaintenanceStartTime = registerOutput<String>(
