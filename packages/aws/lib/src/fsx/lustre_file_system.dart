...
class LustreFileSystem extends pulumi.CustomResource {
  ...
  LustreFileSystem(
    ...
    this.dataReadCacheConfiguration = registerOutput<LustreFileSystemDataReadCacheConfiguration?>('dataReadCacheConfiguration');
    ...
    this.fileSystemTypeVersion = registerOutput<String>('fileSystemTypeVersion');
    ...
    this.logConfiguration = registerOutput<LustreFileSystemLogConfiguration>('logConfiguration');
    this.metadataConfiguration = registerOutput<LustreFileSystemMetadataConfiguration>('metadataConfiguration');
    ...
    this.perUnitStorageThroughput = registerOutput<int?>('perUnitStorageThroughput');
    this.region = registerOutput<String>('region');
    this.rootSquashConfiguration = registerOutput<LustreFileSystemRootSquashConfiguration?>('rootSquashConfiguration');
