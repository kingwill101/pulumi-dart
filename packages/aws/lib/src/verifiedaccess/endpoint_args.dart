...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    required String verifiedAccessGroupId,
  }) : applicationDomain = pulumi.Input.asOptionalInput<String>(
         applicationDomain,
       ),
       attachmentType = pulumi.Input.asInput<String>(attachmentType),
       cidrOptions = pulumi.Input.asOptionalInput<EndpointCidrOptions>(
         cidrOptions,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       domainCertificateArn = pulumi.Input.asOptionalInput<String>(
         domainCertificateArn,
       ),
       endpointDomainPrefix = pulumi.Input.asOptionalInput<String>(
       ...
       rdsOptions = pulumi.Input.asOptionalInput<EndpointRdsOptions>(
         rdsOptions,
       ),
       ...
       sseSpecification = pulumi
           .Input.asOptionalInput<EndpointSseSpecification>(sseSpecification),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       verifiedAccessGroupId = pulumi.Input.asInput<String>(
