...
class Endpoint extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EndpointNetworkInterfaceOptions?> networkInterfaceOptions;
  ...
  Endpoint(
    ...
    this.deviceValidationDomain = registerOutput<String>('deviceValidationDomain');
    ...
    this.loadBalancerOptions = registerOutput<EndpointLoadBalancerOptions?>('loadBalancerOptions');
    this.networkInterfaceOptions = registerOutput<EndpointNetworkInterfaceOptions?>('networkInterfaceOptions');
    ...
    this.sseSpecification = registerOutput<EndpointSseSpecification>('sseSpecification');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.verifiedAccessGroupId = registerOutput<String>('verifiedAccessGroupId');
