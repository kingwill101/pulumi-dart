...
class Endpoint extends pulumi.CustomResource {
  ...
  Endpoint(
    ...
    this.deviceValidationDomain = registerOutput<String>(
    ...
    this.loadBalancerOptions = registerOutput<EndpointLoadBalancerOptions?>(
      'loadBalancerOptions',
    );
    ...
    this.sseSpecification = registerOutput<EndpointSseSpecification>(
      'sseSpecification',
    );
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.verifiedAccessGroupId = registerOutput<String>(
      'verifiedAccessGroupId',
    );
    this.verifiedAccessInstanceId = registerOutput<String>(
