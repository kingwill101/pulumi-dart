...
class FirehoseDeliveryStreamOpensearchserverlessConfiguration {
  ...
  final FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  /// The endpoint to use when communicating with the collection in the Serverless offering for Amazon OpenSearch Service.
  final String collectionEndpoint;
  /// The Serverless offering for Amazon OpenSearch Service index name.
  final String indexName;
  /// The data processing configuration.  See `processing_configuration` block below for details.
  final FirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfiguration? processingConfiguration;
  ...
  final FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration s3Configuration;
  ...
  final FirehoseDeliveryStreamOpensearchserverlessConfigurationVpcConfig? vpcConfig;
  ...
  factory FirehoseDeliveryStreamOpensearchserverlessConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamOpensearchserverlessConfiguration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
      collectionEndpoint: map['collectionEndpoint'] as String,
      indexName: map['indexName'] as String,
      processingConfiguration: map['processingConfiguration'] == null ? null : FirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      ...
      s3Configuration: FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration.fromMap((map['s3Configuration'] as Map).cast<String, dynamic>()),
      vpcConfig: map['vpcConfig'] == null ? null : FirehoseDeliveryStreamOpensearchserverlessConfigurationVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
