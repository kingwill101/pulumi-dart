...
class FirehoseDeliveryStreamExtendedS3Configuration {
  ...
  Map<String, dynamic> toMap() {
    ...
    final customTimeZoneValue = customTimeZone;
    if (customTimeZoneValue != null) {
      map['customTimeZone'] = customTimeZoneValue;
    }
    final dataFormatConversionConfigurationValue =
        dataFormatConversionConfiguration;
    if (dataFormatConversionConfigurationValue != null) {
      map['dataFormatConversionConfiguration'] =
          dataFormatConversionConfigurationValue.toMap();
    }
    final dynamicPartitioningConfigurationValue =
        dynamicPartitioningConfiguration;
    if (dynamicPartitioningConfigurationValue != null) {
      map['dynamicPartitioningConfiguration'] =
          dynamicPartitioningConfigurationValue.toMap();
    }
    final errorOutputPrefixValue = errorOutputPrefix;
    if (errorOutputPrefixValue != null) {
      map['errorOutputPrefix'] = errorOutputPrefixValue;
    }
    final fileExtensionValue = fileExtension;
    if (fileExtensionValue != null) {
      map['fileExtension'] = fileExtensionValue;
    }
  ...
  factory FirehoseDeliveryStreamExtendedS3Configuration.fromMap(
    ...
    return FirehoseDeliveryStreamExtendedS3Configuration(
      ...
      dataFormatConversionConfiguration: map[
                  'dataFormatConversionConfiguration'] ==
              null
          ? null
          : FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration
              .fromMap((map['dataFormatConversionConfiguration'] as Map)
                  .cast<String, dynamic>()),
      dynamicPartitioningConfiguration: map[
                  'dynamicPartitioningConfiguration'] ==
              null
          ? null
          : FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration
              .fromMap((map['dynamicPartitioningConfiguration'] as Map)
                  .cast<String, dynamic>()),
      errorOutputPrefix: map['errorOutputPrefix'] == null
          ? null
          : map['errorOutputPrefix'] as String,
      fileExtension:
          map['fileExtension'] == null ? null : map['fileExtension'] as String,
