...
class FirehoseDeliveryStreamExtendedS3Configuration {
  ...
  final FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  final FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration? dataFormatConversionConfiguration;
  ...
  final FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration? dynamicPartitioningConfiguration;
  ...
  final FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfiguration? processingConfiguration;
  final String roleArn;
  /// The configuration for backup in Amazon S3. Required if `s3_backup_mode` is `Enabled`. Supports the same fields as `s3_configuration` object.
  final FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration? s3BackupConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataFormatConversionConfiguration': ?dataFormatConversionConfiguration == null ? null : dataFormatConversionConfiguration!.toMap(),
      'dynamicPartitioningConfiguration': ?dynamicPartitioningConfiguration == null ? null : dynamicPartitioningConfiguration!.toMap(),
      ...
      'roleArn': roleArn,
      's3BackupConfiguration': ?s3BackupConfiguration == null ? null : s3BackupConfiguration!.toMap(),
  ...
  factory FirehoseDeliveryStreamExtendedS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamExtendedS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
      compressionFormat: map['compressionFormat'] == null ? null : map['compressionFormat'] as String,
      customTimeZone: map['customTimeZone'] == null ? null : map['customTimeZone'] as String,
      dataFormatConversionConfiguration: map['dataFormatConversionConfiguration'] == null ? null : FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration.fromMap((map['dataFormatConversionConfiguration'] as Map).cast<String, dynamic>()),
      dynamicPartitioningConfiguration: map['dynamicPartitioningConfiguration'] == null ? null : FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration.fromMap((map['dynamicPartitioningConfiguration'] as Map).cast<String, dynamic>()),
      errorOutputPrefix: map['errorOutputPrefix'] == null ? null : map['errorOutputPrefix'] as String,
      fileExtension: map['fileExtension'] == null ? null : map['fileExtension'] as String,
      kmsKeyArn: map['kmsKeyArn'] == null ? null : map['kmsKeyArn'] as String,
      prefix: map['prefix'] == null ? null : map['prefix'] as String,
      processingConfiguration: map['processingConfiguration'] == null ? null : FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      roleArn: map['roleArn'] as String,
      s3BackupConfiguration: map['s3BackupConfiguration'] == null ? null : FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.fromMap((map['s3BackupConfiguration'] as Map).cast<String, dynamic>()),
