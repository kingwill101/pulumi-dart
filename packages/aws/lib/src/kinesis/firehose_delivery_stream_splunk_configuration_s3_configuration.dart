...
class FirehoseDeliveryStreamSplunkConfigurationS3Configuration {
  ...
  final FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions?
  ...
  factory FirehoseDeliveryStreamSplunkConfigurationS3Configuration.fromMap(
    ...
    return FirehoseDeliveryStreamSplunkConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null
          ? null
          : FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap(
