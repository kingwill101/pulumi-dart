...
class FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions {
  ...
  /// Creates a new [FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions].
  ...
  factory FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions.fromMap(
      Map<String, dynamic> map) {
    return FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions(
