...
class FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter {
  ...
  /// Creates a new [FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter].
  ...
  factory FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter.fromMap(
    Map<String, dynamic> map,
  ) {
    return FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter(
