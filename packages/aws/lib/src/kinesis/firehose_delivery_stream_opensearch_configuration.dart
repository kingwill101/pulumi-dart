...
class FirehoseDeliveryStreamOpensearchConfiguration {
  ...
  final FirehoseDeliveryStreamOpensearchConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  final FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions? documentIdOptions;
  ...
  final FirehoseDeliveryStreamOpensearchConfigurationProcessingConfiguration? processingConfiguration;
  ...
  final FirehoseDeliveryStreamOpensearchConfigurationS3Configuration s3Configuration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'documentIdOptions': ?documentIdOptions == null ? null : documentIdOptions!.toMap(),
      'domainArn': ?domainArn,
      'indexName': indexName,
  ...
  factory FirehoseDeliveryStreamOpensearchConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamOpensearchConfiguration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamOpensearchConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
      clusterEndpoint: map['clusterEndpoint'] == null ? null : map['clusterEndpoint'] as String,
      documentIdOptions: map['documentIdOptions'] == null ? null : FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions.fromMap((map['documentIdOptions'] as Map).cast<String, dynamic>()),
      domainArn: map['domainArn'] == null ? null : map['domainArn'] as String,
      indexName: map['indexName'] as String,
      indexRotationPeriod: map['indexRotationPeriod'] == null ? null : map['indexRotationPeriod'] as String,
      processingConfiguration: map['processingConfiguration'] == null ? null : FirehoseDeliveryStreamOpensearchConfigurationProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      ...
      s3Configuration: FirehoseDeliveryStreamOpensearchConfigurationS3Configuration.fromMap((map['s3Configuration'] as Map).cast<String, dynamic>()),
      typeName: map['typeName'] == null ? null : map['typeName'] as String,
      vpcConfig: map['vpcConfig'] == null ? null : FirehoseDeliveryStreamOpensearchConfigurationVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
