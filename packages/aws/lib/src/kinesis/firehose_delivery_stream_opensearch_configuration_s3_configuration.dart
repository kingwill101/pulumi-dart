...
class FirehoseDeliveryStreamOpensearchConfigurationS3Configuration {
  ...
  final FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions?
  ...
  factory FirehoseDeliveryStreamOpensearchConfigurationS3Configuration.fromMap(
    ...
    return FirehoseDeliveryStreamOpensearchConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null
          ? null
          : FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap(
