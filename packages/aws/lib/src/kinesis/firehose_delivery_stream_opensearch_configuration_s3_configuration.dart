...
class FirehoseDeliveryStreamOpensearchConfigurationS3Configuration {
  ...
  final FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  factory FirehoseDeliveryStreamOpensearchConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamOpensearchConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
