...
class FirehoseDeliveryStreamSplunkConfiguration {
  ...
  final FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  final FirehoseDeliveryStreamSplunkConfigurationProcessingConfiguration? processingConfiguration;
  ...
  final FirehoseDeliveryStreamSplunkConfigurationS3Configuration s3Configuration;
  final FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration? secretsManagerConfiguration;
  ...
  factory FirehoseDeliveryStreamSplunkConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamSplunkConfiguration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
      hecAcknowledgmentTimeout: map['hecAcknowledgmentTimeout'] == null ? null : map['hecAcknowledgmentTimeout'] as int,
      hecEndpoint: map['hecEndpoint'] as String,
      hecEndpointType: map['hecEndpointType'] == null ? null : map['hecEndpointType'] as String,
      hecToken: map['hecToken'] == null ? null : map['hecToken'] as String,
      processingConfiguration: map['processingConfiguration'] == null ? null : FirehoseDeliveryStreamSplunkConfigurationProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      ...
      s3Configuration: FirehoseDeliveryStreamSplunkConfigurationS3Configuration.fromMap((map['s3Configuration'] as Map).cast<String, dynamic>()),
      secretsManagerConfiguration: map['secretsManagerConfiguration'] == null ? null : FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.fromMap((map['secretsManagerConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
