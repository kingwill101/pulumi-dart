    ...
    return <String, dynamic>{
      'commonAttributes': ?commonAttributes == null
          ...
          : pulumi.Input.encodeList<
              FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfigurationCommonAttribute,
              Map<String, dynamic>
            >(commonAttributes!, (value) => value.toMap()),
      'contentEncoding': ?contentEncoding,
    };
  }

  factory FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfiguration.fromMap(
      ...
      commonAttributes: map['commonAttributes'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfigurationCommonAttribute.fromMap(
