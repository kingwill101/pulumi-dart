...
class FirehoseDeliveryStreamIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions {
  ...
  /// Creates a new [FirehoseDeliveryStreamIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions].
  ...
  factory FirehoseDeliveryStreamIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap(
    Map<String, dynamic> map,
  ) {
    return FirehoseDeliveryStreamIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions(
