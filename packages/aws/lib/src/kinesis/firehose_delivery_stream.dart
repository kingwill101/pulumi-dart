...
class FirehoseDeliveryStream extends pulumi.CustomResource {
  ...
  FirehoseDeliveryStream(
    ...
    this.elasticsearchConfiguration = registerOutput<FirehoseDeliveryStreamElasticsearchConfiguration?>('elasticsearchConfiguration');
    this.extendedS3Configuration = registerOutput<FirehoseDeliveryStreamExtendedS3Configuration?>('extendedS3Configuration');
    this.httpEndpointConfiguration = registerOutput<FirehoseDeliveryStreamHttpEndpointConfiguration?>('httpEndpointConfiguration');
    this.icebergConfiguration = registerOutput<FirehoseDeliveryStreamIcebergConfiguration?>('icebergConfiguration');
    this.kinesisSourceConfiguration = registerOutput<FirehoseDeliveryStreamKinesisSourceConfiguration?>('kinesisSourceConfiguration');
    this.mskSourceConfiguration = registerOutput<FirehoseDeliveryStreamMskSourceConfiguration?>('mskSourceConfiguration');
    this.name = registerOutput<String>('name');
    this.opensearchConfiguration = registerOutput<FirehoseDeliveryStreamOpensearchConfiguration?>('opensearchConfiguration');
    this.opensearchserverlessConfiguration = registerOutput<FirehoseDeliveryStreamOpensearchserverlessConfiguration?>('opensearchserverlessConfiguration');
    this.redshiftConfiguration = registerOutput<FirehoseDeliveryStreamRedshiftConfiguration?>('redshiftConfiguration');
    this.region = registerOutput<String>('region');
    this.serverSideEncryption = registerOutput<FirehoseDeliveryStreamServerSideEncryption?>('serverSideEncryption');
    this.snowflakeConfiguration = registerOutput<FirehoseDeliveryStreamSnowflakeConfiguration?>('snowflakeConfiguration');
    this.splunkConfiguration = registerOutput<FirehoseDeliveryStreamSplunkConfiguration?>('splunkConfiguration');
