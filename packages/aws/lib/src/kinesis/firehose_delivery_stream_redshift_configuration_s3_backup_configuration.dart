...
class FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration {
  ...
  final FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  factory FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
