...
class FirehoseDeliveryStreamRedshiftConfiguration {
  ...
  final FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  final FirehoseDeliveryStreamRedshiftConfigurationProcessingConfiguration? processingConfiguration;
  ...
  final FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration? s3BackupConfiguration;
  /// The Amazon S3 backup mode.  Valid values are `Disabled` and `Enabled`.  Default value is `Disabled`.
  final String? s3BackupMode;
  /// The S3 Configuration. See s3_configuration below for details.
  final FirehoseDeliveryStreamRedshiftConfigurationS3Configuration s3Configuration;
  final FirehoseDeliveryStreamRedshiftConfigurationSecretsManagerConfiguration? secretsManagerConfiguration;
  ...
  factory FirehoseDeliveryStreamRedshiftConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamRedshiftConfiguration(
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
      clusterJdbcurl: map['clusterJdbcurl'] as String,
      copyOptions: map['copyOptions'] == null ? null : map['copyOptions'] as String,
      dataTableColumns: map['dataTableColumns'] == null ? null : map['dataTableColumns'] as String,
      dataTableName: map['dataTableName'] as String,
      password: map['password'] == null ? null : map['password'] as String,
      processingConfiguration: map['processingConfiguration'] == null ? null : FirehoseDeliveryStreamRedshiftConfigurationProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      retryDuration: map['retryDuration'] == null ? null : map['retryDuration'] as int,
      roleArn: map['roleArn'] as String,
      s3BackupConfiguration: map['s3BackupConfiguration'] == null ? null : FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.fromMap((map['s3BackupConfiguration'] as Map).cast<String, dynamic>()),
      s3BackupMode: map['s3BackupMode'] == null ? null : map['s3BackupMode'] as String,
      s3Configuration: FirehoseDeliveryStreamRedshiftConfigurationS3Configuration.fromMap((map['s3Configuration'] as Map).cast<String, dynamic>()),
      secretsManagerConfiguration: map['secretsManagerConfiguration'] == null ? null : FirehoseDeliveryStreamRedshiftConfigurationSecretsManagerConfiguration.fromMap((map['secretsManagerConfiguration'] as Map).cast<String, dynamic>()),
