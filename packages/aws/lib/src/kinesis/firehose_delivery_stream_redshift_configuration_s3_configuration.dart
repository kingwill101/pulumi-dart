...
import 'firehose_delivery_stream_redshift_configuration_s3_configuration_cloudwatch_logging_options.dart';

class FirehoseDeliveryStreamRedshiftConfigurationS3Configuration {
  ...
  final FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  /// Creates a new [FirehoseDeliveryStreamRedshiftConfigurationS3Configuration].
  ...
  factory FirehoseDeliveryStreamRedshiftConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamRedshiftConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
