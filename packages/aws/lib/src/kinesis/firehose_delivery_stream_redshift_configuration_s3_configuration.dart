...
class FirehoseDeliveryStreamRedshiftConfigurationS3Configuration {
  ...
  final FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions?
  ...
  factory FirehoseDeliveryStreamRedshiftConfigurationS3Configuration.fromMap(
    ...
    return FirehoseDeliveryStreamRedshiftConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null
          ? null
          : FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap(
