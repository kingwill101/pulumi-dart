...
class StreamArgs {
  ...
  factory StreamArgs.fromMap(Map<String, dynamic> map) {
    return StreamArgs(
      ...
      enforceConsumerDeletion: map['enforceConsumerDeletion'] == null ? null : map['enforceConsumerDeletion'] as bool,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      maxRecordSizeInKib: map['maxRecordSizeInKib'] == null ? null : map['maxRecordSizeInKib'] as int,
      ...
      shardLevelMetrics: map['shardLevelMetrics'] == null ? null : (map['shardLevelMetrics'] as List).cast<String>(),
      streamModeDetails: map['streamModeDetails'] == null ? null : StreamStreamModeDetails.fromMap((map['streamModeDetails'] as Map).cast<String, dynamic>()),
