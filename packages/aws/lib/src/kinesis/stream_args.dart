...
class StreamArgs {
  ...
  StreamArgs({
    ...
    Map<String, String>? tags,
       ...
       enforceConsumerDeletion = pulumi.Input.asOptionalInput<bool>(
         enforceConsumerDeletion,
       ),
       kmsKeyId = pulumi.Input.asOptionalInput<String>(kmsKeyId),
       maxRecordSizeInKib = pulumi.Input.asOptionalInput<int>(
         maxRecordSizeInKib,
       ),
       ...
       shardLevelMetrics = pulumi.Input.asOptionalInput<List<String>>(
         shardLevelMetrics,
       ),
       streamModeDetails = pulumi
           .Input.asOptionalInput<StreamStreamModeDetails>(streamModeDetails),
