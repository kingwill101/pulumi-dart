...
class AnalyticsApplicationArgs {
  ...
  AnalyticsApplicationArgs({
    ...
    Map<String, String>? tags,
        ...
        inputs =
            pulumi.Input.asOptionalInput<AnalyticsApplicationInputs>(inputs),
        name = pulumi.Input.asOptionalInput<String>(name),
        outputs =
            pulumi.Input.asOptionalInput<List<AnalyticsApplicationOutput>>(
                outputs),
  ...
  factory AnalyticsApplicationArgs.fromMap(Map<String, dynamic> map) {
    return AnalyticsApplicationArgs(
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null
          ? null
          : AnalyticsApplicationCloudwatchLoggingOptions.fromMap(
      ...
      inputs: map['inputs'] == null
          ? null
          : AnalyticsApplicationInputs.fromMap(
              (map['inputs'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      outputs: map['outputs'] == null
          ? null
          : pulumi.Input.decodeList<AnalyticsApplicationOutput>(
              map['outputs'],
              (value) => AnalyticsApplicationOutput.fromMap(
                  (value as Map).cast<String, dynamic>())),
      referenceDataSources: map['referenceDataSources'] == null
          ? null
          : AnalyticsApplicationReferenceDataSources.fromMap(
              (map['referenceDataSources'] as Map).cast<String, dynamic>()),
