...
class OrganizationConfigurationFeatureArgs {
  ...
  OrganizationConfigurationFeatureArgs({
    List<OrganizationConfigurationFeatureAdditionalConfiguration>? additionalConfigurations,
    required String autoEnable,
  ...
  factory OrganizationConfigurationFeatureArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationConfigurationFeatureArgs(
      additionalConfigurations: map['additionalConfigurations'] == null ? null : pulumi.Input.decodeList<OrganizationConfigurationFeatureAdditionalConfiguration>(map['additionalConfigurations'], (value) => OrganizationConfigurationFeatureAdditionalConfiguration.fromMap((value as Map).cast<String, dynamic>())),
