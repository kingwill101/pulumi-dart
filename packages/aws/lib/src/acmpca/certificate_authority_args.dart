...
class CertificateAuthorityArgs {
  ...
  CertificateAuthorityArgs({
    required CertificateAuthorityCertificateAuthorityConfiguration
        certificateAuthorityConfiguration,
    bool? enabled,
    ...
    String? usageMode,
        ...
        keyStorageSecurityStandard =
            pulumi.Input.asOptionalInput<String>(keyStorageSecurityStandard),
        permanentDeletionTimeInDays =
            pulumi.Input.asOptionalInput<int>(permanentDeletionTimeInDays),
  ...
  factory CertificateAuthorityArgs.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityArgs(
      certificateAuthorityConfiguration:
          CertificateAuthorityCertificateAuthorityConfiguration.fromMap(
              (map['certificateAuthorityConfiguration'] as Map)
                  .cast<String, dynamic>()),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      keyStorageSecurityStandard: map['keyStorageSecurityStandard'] == null
          ? null
          : map['keyStorageSecurityStandard'] as String,
      permanentDeletionTimeInDays: map['permanentDeletionTimeInDays'] == null
          ? null
          : map['permanentDeletionTimeInDays'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      revocationConfiguration: map['revocationConfiguration'] == null
          ? null
          : CertificateAuthorityRevocationConfiguration.fromMap(
              (map['revocationConfiguration'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null
          ? null
