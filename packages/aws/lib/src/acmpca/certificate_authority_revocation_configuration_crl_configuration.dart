...
class CertificateAuthorityRevocationConfigurationCrlConfiguration {
  ...
  Map<String, dynamic> toMap() {
    ...
    final customCnameValue = customCname;
    if (customCnameValue != null) {
      map['customCname'] = customCnameValue;
    }
    final customPathValue = customPath;
    if (customPathValue != null) {
      map['customPath'] = customPathValue;
    }
    final enabledValue = enabled;
    if (enabledValue != null) {
      map['enabled'] = enabledValue;
    }
    final expirationInDaysValue = expirationInDays;
    if (expirationInDaysValue != null) {
      map['expirationInDays'] = expirationInDaysValue;
    }
    final s3BucketNameValue = s3BucketName;
    if (s3BucketNameValue != null) {
      map['s3BucketName'] = s3BucketNameValue;
    }
    final s3ObjectAclValue = s3ObjectAcl;
    if (s3ObjectAclValue != null) {
      map['s3ObjectAcl'] = s3ObjectAclValue;
    }
    return map;
  }
  ...
  factory CertificateAuthorityRevocationConfigurationCrlConfiguration.fromMap(
    ...
    return CertificateAuthorityRevocationConfigurationCrlConfiguration(
      customCname:
          map['customCname'] == null ? null : map['customCname'] as String,
      customPath:
          map['customPath'] == null ? null : map['customPath'] as String,
      ...
      s3ObjectAcl:
          map['s3ObjectAcl'] == null ? null : map['s3ObjectAcl'] as String,
    );
  }
}
