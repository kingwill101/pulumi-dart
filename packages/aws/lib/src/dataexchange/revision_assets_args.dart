...
class RevisionAssetsArgs {
  ...
  factory RevisionAssetsArgs.fromMap(Map<String, dynamic> map) {
    return RevisionAssetsArgs(
      assets: map['assets'] == null ? null : pulumi.Input.decodeList<RevisionAssetsAsset>(map['assets'], (value) => RevisionAssetsAsset.fromMap((value as Map).cast<String, dynamic>())),
      ...
      timeouts: map['timeouts'] == null ? null : RevisionAssetsTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
