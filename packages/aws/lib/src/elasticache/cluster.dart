...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.autoMinorVersionUpgrade = registerOutput<String?>(
    ...
    this.configurationEndpoint = registerOutput<String>(
    ...
    this.preferredAvailabilityZones = registerOutput<List<String>?>(
