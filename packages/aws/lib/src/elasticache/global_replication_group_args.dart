...
class GlobalReplicationGroupArgs {
  ...
  factory GlobalReplicationGroupArgs.fromMap(Map<String, dynamic> map) {
    return GlobalReplicationGroupArgs(
      ...
      cacheNodeType: map['cacheNodeType'] == null ? null : map['cacheNodeType'] as String,
      engine: map['engine'] == null ? null : map['engine'] as String,
      engineVersion: map['engineVersion'] == null ? null : map['engineVersion'] as String,
      globalReplicationGroupDescription: map['globalReplicationGroupDescription'] == null ? null : map['globalReplicationGroupDescription'] as String,
      globalReplicationGroupIdSuffix: map['globalReplicationGroupIdSuffix'] as String,
      numNodeGroups: map['numNodeGroups'] == null ? null : map['numNodeGroups'] as int,
