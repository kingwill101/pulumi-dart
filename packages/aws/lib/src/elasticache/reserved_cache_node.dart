...
class ReservedCacheNode extends pulumi.CustomResource {
  ...
  ReservedCacheNode(
    ...
    this.recurringCharges = registerOutput<List<ReservedCacheNodeRecurringCharge>>('recurringCharges');
    this.region = registerOutput<String>('region');
    this.reservedCacheNodesOfferingId = registerOutput<String>('reservedCacheNodesOfferingId');
