...
class ReplicationGroup extends pulumi.CustomResource {
  ...
  ReplicationGroup(
    ...
    this.globalReplicationGroupId = registerOutput<String>(
    ...
    this.preferredCacheClusterAzs = registerOutput<List<String>?>(
      'preferredCacheClusterAzs',
    );
    this.primaryEndpointAddress = registerOutput<String>(
      'primaryEndpointAddress',
    );
    this.readerEndpointAddress = registerOutput<String>(
    ...
    this.transitEncryptionEnabled = registerOutput<bool>(
