...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    bool? transitEncryptionEnabled,
       ...
       autoMinorVersionUpgrade = pulumi.Input.asOptionalInput<String>(
       ...
       preferredOutpostArn = pulumi.Input.asOptionalInput<String>(
         preferredOutpostArn,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       replicationGroupId = pulumi.Input.asOptionalInput<String>(
         replicationGroupId,
       ),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      ipDiscovery: map['ipDiscovery'] == null
          ? null
          : map['ipDiscovery'] as String,
      ...
      numCacheNodes: map['numCacheNodes'] == null
          ? null
          : map['numCacheNodes'] as int,
      outpostMode: map['outpostMode'] == null
          ? null
          : map['outpostMode'] as String,
