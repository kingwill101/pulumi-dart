...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      autoMinorVersionUpgrade: map['autoMinorVersionUpgrade'] == null ? null : map['autoMinorVersionUpgrade'] as String,
      ...
      ipDiscovery: map['ipDiscovery'] == null ? null : map['ipDiscovery'] as String,
      logDeliveryConfigurations: map['logDeliveryConfigurations'] == null ? null : pulumi.Input.decodeList<ClusterLogDeliveryConfiguration>(map['logDeliveryConfigurations'], (value) => ClusterLogDeliveryConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      numCacheNodes: map['numCacheNodes'] == null ? null : map['numCacheNodes'] as int,
      outpostMode: map['outpostMode'] == null ? null : map['outpostMode'] as String,
      parameterGroupName: map['parameterGroupName'] == null ? null : map['parameterGroupName'] as String,
      port: map['port'] == null ? null : map['port'] as int,
      preferredAvailabilityZones: map['preferredAvailabilityZones'] == null ? null : (map['preferredAvailabilityZones'] as List).cast<String>(),
      preferredOutpostArn: map['preferredOutpostArn'] == null ? null : map['preferredOutpostArn'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      replicationGroupId: map['replicationGroupId'] == null ? null : map['replicationGroupId'] as String,
      securityGroupIds: map['securityGroupIds'] == null ? null : (map['securityGroupIds'] as List).cast<String>(),
      snapshotArns: map['snapshotArns'] == null ? null : map['snapshotArns'] as String,
