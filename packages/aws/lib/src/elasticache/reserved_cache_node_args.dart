...
class ReservedCacheNodeArgs {
  ...
  ReservedCacheNodeArgs({
    ...
    ReservedCacheNodeTimeouts? timeouts,
        ...
        reservedCacheNodesOfferingId =
            pulumi.Input.asInput<String>(reservedCacheNodesOfferingId),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        timeouts =
            pulumi.Input.asOptionalInput<ReservedCacheNodeTimeouts>(timeouts);
  ...
  factory ReservedCacheNodeArgs.fromMap(Map<String, dynamic> map) {
    return ReservedCacheNodeArgs(
      cacheNodeCount:
          map['cacheNodeCount'] == null ? null : map['cacheNodeCount'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      reservedCacheNodesOfferingId:
          map['reservedCacheNodesOfferingId'] as String,
      tags: map['tags'] == null
          ? null
