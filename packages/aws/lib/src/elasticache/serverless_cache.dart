...
class ServerlessCache extends pulumi.CustomResource {
  ...
  ServerlessCache(
    ...
    this.cacheUsageLimits = registerOutput<ServerlessCacheCacheUsageLimits?>(
      'cacheUsageLimits',
    );
    ...
    this.readerEndpoints = registerOutput<List<ServerlessCacheReaderEndpoint>>(
      'readerEndpoints',
    );
    this.region = registerOutput<String>('region');
    this.securityGroupIds = registerOutput<List<String>>('securityGroupIds');
    this.snapshotArnsToRestores = registerOutput<List<String>?>(
