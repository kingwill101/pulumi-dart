...
class GlobalReplicationGroup extends pulumi.CustomResource {
  ...
  /// Has the values:
  late final pulumi.Output<List<GlobalReplicationGroupGlobalNodeGroup>>
  globalNodeGroups;
  ...
  GlobalReplicationGroup(
    ...
    this.globalReplicationGroupDescription = registerOutput<String?>(
      'globalReplicationGroupDescription',
    );
    this.globalReplicationGroupId = registerOutput<String>(
      'globalReplicationGroupId',
    );
    this.globalReplicationGroupIdSuffix = registerOutput<String>(
    ...
    this.primaryReplicationGroupId = registerOutput<String>(
