...
class ReplicationGroupArgs {
  ...
  ReplicationGroupArgs({
    ...
    List<String>? userGroupIds,
       ...
       authTokenUpdateStrategy = pulumi.Input.asOptionalInput<String>(
       ...
       dataTieringEnabled = pulumi.Input.asOptionalInput<bool>(
         dataTieringEnabled,
       ),
       ...
       globalReplicationGroupId = pulumi.Input.asOptionalInput<String>(
       ...
       replicasPerNodeGroup = pulumi.Input.asOptionalInput<int>(
  ...
  factory ReplicationGroupArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationGroupArgs(
      ...
      clusterMode: map['clusterMode'] == null
          ? null
          : map['clusterMode'] as String,
      ...
      multiAzEnabled: map['multiAzEnabled'] == null
          ? null
          : map['multiAzEnabled'] as bool,
