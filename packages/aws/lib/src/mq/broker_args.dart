  ...
  BrokerArgs({
    ...
    required List<BrokerUser> users,
        ...
        authenticationStrategy =
            pulumi.Input.asOptionalInput<String>(authenticationStrategy),
        autoMinorVersionUpgrade =
            pulumi.Input.asOptionalInput<bool>(autoMinorVersionUpgrade),
        brokerName = pulumi.Input.asOptionalInput<String>(brokerName),
        configuration =
            pulumi.Input.asOptionalInput<BrokerConfiguration>(configuration),
        dataReplicationMode =
            pulumi.Input.asOptionalInput<String>(dataReplicationMode),
        ...
        encryptionOptions =
            pulumi.Input.asOptionalInput<BrokerEncryptionOptions>(
                encryptionOptions),
  ...
  factory BrokerArgs.fromMap(Map<String, dynamic> map) {
    return BrokerArgs(
      ...
      users: pulumi.Input.decodeList<BrokerUser>(
          map['users'],
          (value) =>
              BrokerUser.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
