...
class BrokerArgs {
  ...
  factory BrokerArgs.fromMap(Map<String, dynamic> map) {
    return BrokerArgs(
      ...
      authenticationStrategy: map['authenticationStrategy'] == null ? null : map['authenticationStrategy'] as String,
      ...
      configuration: map['configuration'] == null ? null : BrokerConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      dataReplicationMode: map['dataReplicationMode'] == null ? null : map['dataReplicationMode'] as String,
      dataReplicationPrimaryBrokerArn: map['dataReplicationPrimaryBrokerArn'] == null ? null : map['dataReplicationPrimaryBrokerArn'] as String,
      deploymentMode: map['deploymentMode'] == null ? null : map['deploymentMode'] as String,
      encryptionOptions: map['encryptionOptions'] == null ? null : BrokerEncryptionOptions.fromMap((map['encryptionOptions'] as Map).cast<String, dynamic>()),
      engineType: map['engineType'] as String,
      engineVersion: map['engineVersion'] as String,
      hostInstanceType: map['hostInstanceType'] as String,
      ldapServerMetadata: map['ldapServerMetadata'] == null ? null : BrokerLdapServerMetadata.fromMap((map['ldapServerMetadata'] as Map).cast<String, dynamic>()),
      logs: map['logs'] == null ? null : BrokerLogs.fromMap((map['logs'] as Map).cast<String, dynamic>()),
      maintenanceWindowStartTime: map['maintenanceWindowStartTime'] == null ? null : BrokerMaintenanceWindowStartTime.fromMap((map['maintenanceWindowStartTime'] as Map).cast<String, dynamic>()),
      ...
      users: pulumi.Input.decodeList<BrokerUser>(map['users'], (value) => BrokerUser.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
