...
class Broker extends pulumi.CustomResource {
  ...
  Broker(String name, {BrokerArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.authenticationStrategy = registerOutput<String>(
    ...
    this.dataReplicationPrimaryBrokerArn = registerOutput<String?>(
      'dataReplicationPrimaryBrokerArn',
    );
    this.deploymentMode = registerOutput<String?>('deploymentMode');
    this.encryptionOptions = registerOutput<BrokerEncryptionOptions?>(
      'encryptionOptions',
    );
    ...
    this.ldapServerMetadata = registerOutput<BrokerLdapServerMetadata?>(
      'ldapServerMetadata',
    );
    ...
    this.pendingDataReplicationMode = registerOutput<String>(
