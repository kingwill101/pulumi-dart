...
class SecretVersionArgs {
  ...
  factory SecretVersionArgs.fromMap(Map<String, dynamic> map) {
    return SecretVersionArgs(
      ...
      secretBinary: map['secretBinary'] == null ? null : map['secretBinary'] as String,
      secretId: map['secretId'] as String,
      secretString: map['secretString'] == null ? null : map['secretString'] as String,
      secretStringWo: map['secretStringWo'] == null ? null : map['secretStringWo'] as String,
      secretStringWoVersion: map['secretStringWoVersion'] == null ? null : map['secretStringWoVersion'] as int,
