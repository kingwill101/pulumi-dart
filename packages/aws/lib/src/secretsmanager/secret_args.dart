...
class SecretArgs {
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      forceOverwriteReplicaSecret: map['forceOverwriteReplicaSecret'] == null ? null : map['forceOverwriteReplicaSecret'] as bool,
      ...
      replicas: map['replicas'] == null ? null : pulumi.Input.decodeList<SecretReplica>(map['replicas'], (value) => SecretReplica.fromMap((value as Map).cast<String, dynamic>())),
