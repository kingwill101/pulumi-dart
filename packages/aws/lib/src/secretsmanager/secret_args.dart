...
class SecretArgs {
  ...
  SecretArgs({
    ...
    Map<String, String>? tags,
        ...
        forceOverwriteReplicaSecret =
            pulumi.Input.asOptionalInput<bool>(forceOverwriteReplicaSecret),
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      forceOverwriteReplicaSecret: map['forceOverwriteReplicaSecret'] == null
          ? null
          : map['forceOverwriteReplicaSecret'] as bool,
