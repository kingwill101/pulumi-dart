...
class PortfolioShareArgs {
  ...
  factory PortfolioShareArgs.fromMap(Map<String, dynamic> map) {
    return PortfolioShareArgs(
      ...
      sharePrincipals: map['sharePrincipals'] == null ? null : map['sharePrincipals'] as bool,
      shareTagOptions: map['shareTagOptions'] == null ? null : map['shareTagOptions'] as bool,
      type: map['type'] as String,
      waitForAcceptance: map['waitForAcceptance'] == null ? null : map['waitForAcceptance'] as bool,
    );
  }
}
