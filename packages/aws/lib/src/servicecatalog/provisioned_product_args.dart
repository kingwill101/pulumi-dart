...
class ProvisionedProductArgs {
  ...
  ProvisionedProductArgs({
    ...
    Map<String, String>? tags,
       ...
       notificationArns = pulumi.Input.asOptionalInput<List<String>>(
         notificationArns,
       ),
       ...
       provisioningArtifactId = pulumi.Input.asOptionalInput<String>(
         provisioningArtifactId,
       ),
       provisioningArtifactName = pulumi.Input.asOptionalInput<String>(
       ...
       retainPhysicalResources = pulumi.Input.asOptionalInput<bool>(
    ...
    return <String, dynamic>{
      ...
      'stackSetProvisioningPreferences':
          ?pulumi.Input.mapOptionalInputValue<
            ProvisionedProductStackSetProvisioningPreferences,
            Map<String, dynamic>
          >(stackSetProvisioningPreferences, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory ProvisionedProductArgs.fromMap(Map<String, dynamic> map) {
    return ProvisionedProductArgs(
      ...
      ignoreErrors: map['ignoreErrors'] == null
          ? null
          : map['ignoreErrors'] as bool,
