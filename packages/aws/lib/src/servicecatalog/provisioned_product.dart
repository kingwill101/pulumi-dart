...
class ProvisionedProduct extends pulumi.CustomResource {
  ...
  ProvisionedProduct(
    ...
    this.cloudwatchDashboardNames = registerOutput<List<String>>(
      'cloudwatchDashboardNames',
    );
    this.createdTime = registerOutput<String>('createdTime');
    this.ignoreErrors = registerOutput<bool?>('ignoreErrors');
    this.lastProvisioningRecordId = registerOutput<String>(
      'lastProvisioningRecordId',
    );
    this.lastRecordId = registerOutput<String>('lastRecordId');
    this.lastSuccessfulProvisioningRecordId = registerOutput<String>(
    ...
    this.provisioningArtifactId = registerOutput<String>(
      'provisioningArtifactId',
    );
    this.provisioningArtifactName = registerOutput<String?>(
    ...
    this.retainPhysicalResources = registerOutput<bool?>(
