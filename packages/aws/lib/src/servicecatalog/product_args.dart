...
class ProductArgs {
  ...
  ProductArgs({
    ...
    required ProductProvisioningArtifactParameters provisioningArtifactParameters,
    String? region,
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      distributor: map['distributor'] == null ? null : map['distributor'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      owner: map['owner'] as String,
      provisioningArtifactParameters: ProductProvisioningArtifactParameters.fromMap((map['provisioningArtifactParameters'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      supportDescription: map['supportDescription'] == null ? null : map['supportDescription'] as String,
