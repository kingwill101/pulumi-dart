...
class StreamProcessorArgs {
  ...
  factory StreamProcessorArgs.fromMap(Map<String, dynamic> map) {
    return StreamProcessorArgs(
      dataSharingPreference: map['dataSharingPreference'] == null ? null : StreamProcessorDataSharingPreference.fromMap((map['dataSharingPreference'] as Map).cast<String, dynamic>()),
      input: StreamProcessorInput.fromMap((map['input'] as Map).cast<String, dynamic>()),
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      notificationChannel: map['notificationChannel'] == null ? null : StreamProcessorNotificationChannel.fromMap((map['notificationChannel'] as Map).cast<String, dynamic>()),
      output: StreamProcessorOutput.fromMap((map['output'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      regionsOfInterests: map['regionsOfInterests'] == null ? null : pulumi.Input.decodeList<StreamProcessorRegionsOfInterest>(map['regionsOfInterests'], (value) => StreamProcessorRegionsOfInterest.fromMap((value as Map).cast<String, dynamic>())),
      roleArn: map['roleArn'] as String,
      settings: StreamProcessorSettings.fromMap((map['settings'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : StreamProcessorTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
