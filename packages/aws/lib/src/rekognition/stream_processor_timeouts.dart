...
class StreamProcessorTimeouts {
  ...
  /// Creates a new [StreamProcessorTimeouts].
  ...
  StreamProcessorTimeouts({this.create, this.delete, this.update});
  ...
  factory StreamProcessorTimeouts.fromMap(Map<String, dynamic> map) {
    return StreamProcessorTimeouts(
