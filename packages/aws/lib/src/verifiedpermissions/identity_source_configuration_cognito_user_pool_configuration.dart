...
class IdentitySourceConfigurationCognitoUserPoolConfiguration {
  ...
  final IdentitySourceConfigurationCognitoUserPoolConfigurationGroupConfiguration? groupConfiguration;
  ...
  factory IdentitySourceConfigurationCognitoUserPoolConfiguration.fromMap(Map<String, dynamic> map) {
    return IdentitySourceConfigurationCognitoUserPoolConfiguration(
      ...
      groupConfiguration: map['groupConfiguration'] == null ? null : IdentitySourceConfigurationCognitoUserPoolConfigurationGroupConfiguration.fromMap((map['groupConfiguration'] as Map).cast<String, dynamic>()),
