...
class IdentitySourceArgs {
  ...
  factory IdentitySourceArgs.fromMap(Map<String, dynamic> map) {
    return IdentitySourceArgs(
      configuration: IdentitySourceConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      policyStoreId: map['policyStoreId'] as String,
      principalEntityType: map['principalEntityType'] == null ? null : map['principalEntityType'] as String,
