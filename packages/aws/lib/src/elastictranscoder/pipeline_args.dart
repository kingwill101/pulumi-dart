...
class PipelineArgs {
    ...
    return <String, dynamic>{
      ...
      'contentConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(contentConfig, (value) => value.toMap()),
      'contentConfigPermissions':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'thumbnailConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(thumbnailConfig, (value) => value.toMap()),
      'thumbnailConfigPermissions':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipelineThumbnailConfigPermission>,
            List<Map<String, dynamic>>
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      awsKmsKeyArn: map['awsKmsKeyArn'] == null
          ? null
          : map['awsKmsKeyArn'] as String,
      ...
      outputBucket: map['outputBucket'] == null
          ? null
          : map['outputBucket'] as String,
