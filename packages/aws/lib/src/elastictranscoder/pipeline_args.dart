...
class PipelineArgs {
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      awsKmsKeyArn: map['awsKmsKeyArn'] == null ? null : map['awsKmsKeyArn'] as String,
      contentConfig: map['contentConfig'] == null ? null : PipelineContentConfig.fromMap((map['contentConfig'] as Map).cast<String, dynamic>()),
      contentConfigPermissions: map['contentConfigPermissions'] == null ? null : pulumi.Input.decodeList<PipelineContentConfigPermission>(map['contentConfigPermissions'], (value) => PipelineContentConfigPermission.fromMap((value as Map).cast<String, dynamic>())),
      inputBucket: map['inputBucket'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      notifications: map['notifications'] == null ? null : PipelineNotifications.fromMap((map['notifications'] as Map).cast<String, dynamic>()),
      outputBucket: map['outputBucket'] == null ? null : map['outputBucket'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      role: map['role'] as String,
      thumbnailConfig: map['thumbnailConfig'] == null ? null : PipelineThumbnailConfig.fromMap((map['thumbnailConfig'] as Map).cast<String, dynamic>()),
      thumbnailConfigPermissions: map['thumbnailConfigPermissions'] == null ? null : pulumi.Input.decodeList<PipelineThumbnailConfigPermission>(map['thumbnailConfigPermissions'], (value) => PipelineThumbnailConfigPermission.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
