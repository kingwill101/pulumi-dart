...
class Preset extends pulumi.CustomResource {
  ...
  Preset(
    ...
    this.audioCodecOptions = registerOutput<PresetAudioCodecOptions>('audioCodecOptions');
    ...
    this.videoCodecOptions = registerOutput<Map<String, String>?>('videoCodecOptions');
    this.videoWatermarks = registerOutput<List<PresetVideoWatermark>?>('videoWatermarks');
  }
}
