...
class Project extends pulumi.CustomResource {
  ...
  Project(
    ...
    this.buildBatchConfig = registerOutput<ProjectBuildBatchConfig?>(
      'buildBatchConfig',
    );
    ...
    this.fileSystemLocations = registerOutput<List<ProjectFileSystemLocation>?>(
      'fileSystemLocations',
    );
    ...
    this.secondaryArtifacts = registerOutput<List<ProjectSecondaryArtifact>?>(
      'secondaryArtifacts',
    );
    ...
    this.secondarySources = registerOutput<List<ProjectSecondarySource>?>(
      'secondarySources',
    );
