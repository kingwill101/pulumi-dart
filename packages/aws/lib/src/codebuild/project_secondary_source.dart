...
class ProjectSecondarySource {
  ...
  factory ProjectSecondarySource.fromMap(Map<String, dynamic> map) {
    return ProjectSecondarySource(
      ...
      gitCloneDepth: map['gitCloneDepth'] == null
          ? null
          : map['gitCloneDepth'] as int,
      ...
      insecureSsl: map['insecureSsl'] == null
          ? null
          : map['insecureSsl'] as bool,
