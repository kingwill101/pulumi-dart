...
class ProjectArgs {
    ...
    ProjectVpcConfig? vpcConfig,
        ...
        fileSystemLocations =
            pulumi.Input.asOptionalInput<List<ProjectFileSystemLocation>>(
                fileSystemLocations),
        logsConfig =
            pulumi.Input.asOptionalInput<ProjectLogsConfig>(logsConfig),
        name = pulumi.Input.asOptionalInput<String>(name),
        projectVisibility =
            pulumi.Input.asOptionalInput<String>(projectVisibility),
        queuedTimeout = pulumi.Input.asOptionalInput<int>(queuedTimeout),
        region = pulumi.Input.asOptionalInput<String>(region),
        resourceAccessRole =
            pulumi.Input.asOptionalInput<String>(resourceAccessRole),
        secondaryArtifacts =
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      ...
      autoRetryLimit:
          map['autoRetryLimit'] == null ? null : map['autoRetryLimit'] as int,
      badgeEnabled:
          map['badgeEnabled'] == null ? null : map['badgeEnabled'] as bool,
      buildBatchConfig: map['buildBatchConfig'] == null
          ? null
          : ProjectBuildBatchConfig.fromMap(
              (map['buildBatchConfig'] as Map).cast<String, dynamic>()),
      buildTimeout:
          map['buildTimeout'] == null ? null : map['buildTimeout'] as int,
      ...
      queuedTimeout:
          map['queuedTimeout'] == null ? null : map['queuedTimeout'] as int,
      ...
      source:
          ProjectSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
      sourceVersion:
