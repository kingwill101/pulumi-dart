...
class ProjectArgs {
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      artifacts: ProjectArtifacts.fromMap((map['artifacts'] as Map).cast<String, dynamic>()),
      autoRetryLimit: map['autoRetryLimit'] == null ? null : map['autoRetryLimit'] as int,
      ...
      buildTimeout: map['buildTimeout'] == null ? null : map['buildTimeout'] as int,
      ...
      environment: ProjectEnvironment.fromMap((map['environment'] as Map).cast<String, dynamic>()),
      ...
      logsConfig: map['logsConfig'] == null ? null : ProjectLogsConfig.fromMap((map['logsConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      projectVisibility: map['projectVisibility'] == null ? null : map['projectVisibility'] as String,
      queuedTimeout: map['queuedTimeout'] == null ? null : map['queuedTimeout'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      resourceAccessRole: map['resourceAccessRole'] == null ? null : map['resourceAccessRole'] as String,
      secondaryArtifacts: map['secondaryArtifacts'] == null ? null : pulumi.Input.decodeList<ProjectSecondaryArtifact>(map['secondaryArtifacts'], (value) => ProjectSecondaryArtifact.fromMap((value as Map).cast<String, dynamic>())),
      secondarySourceVersions: map['secondarySourceVersions'] == null ? null : pulumi.Input.decodeList<ProjectSecondarySourceVersion>(map['secondarySourceVersions'], (value) => ProjectSecondarySourceVersion.fromMap((value as Map).cast<String, dynamic>())),
      secondarySources: map['secondarySources'] == null ? null : pulumi.Input.decodeList<ProjectSecondarySource>(map['secondarySources'], (value) => ProjectSecondarySource.fromMap((value as Map).cast<String, dynamic>())),
      serviceRole: map['serviceRole'] as String,
      source: ProjectSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
      sourceVersion: map['sourceVersion'] == null ? null : map['sourceVersion'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      vpcConfig: map['vpcConfig'] == null ? null : ProjectVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
