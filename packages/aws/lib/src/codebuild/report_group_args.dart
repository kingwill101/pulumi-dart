...
class ReportGroupArgs {
  ...
  ReportGroupArgs({
    ...
    required String type,
       ...
       exportConfig = pulumi.Input.asInput<ReportGroupExportConfig>(
         exportConfig,
       ),
  ...
  factory ReportGroupArgs.fromMap(Map<String, dynamic> map) {
    return ReportGroupArgs(
      deleteReports: map['deleteReports'] == null
          ? null
          : map['deleteReports'] as bool,
      exportConfig: ReportGroupExportConfig.fromMap(
