...
class FleetArgs {
  ...
  FleetArgs({
    ...
    List<FleetVpcConfig>? vpcConfigs,
       ...
       fleetServiceRole = pulumi.Input.asOptionalInput<String>(
         fleetServiceRole,
       ),
       imageId = pulumi.Input.asOptionalInput<String>(imageId),
       name = pulumi.Input.asOptionalInput<String>(name),
       overflowBehavior = pulumi.Input.asOptionalInput<String>(
         overflowBehavior,
       ),
       ...
       vpcConfigs = pulumi.Input.asOptionalInput<List<FleetVpcConfig>>(
         vpcConfigs,
       );
