...
class FleetArgs {
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      computeConfiguration: map['computeConfiguration'] == null ? null : FleetComputeConfiguration.fromMap((map['computeConfiguration'] as Map).cast<String, dynamic>()),
      computeType: map['computeType'] as String,
      environmentType: map['environmentType'] as String,
      fleetServiceRole: map['fleetServiceRole'] == null ? null : map['fleetServiceRole'] as String,
      imageId: map['imageId'] == null ? null : map['imageId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      overflowBehavior: map['overflowBehavior'] == null ? null : map['overflowBehavior'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      scalingConfiguration: map['scalingConfiguration'] == null ? null : FleetScalingConfiguration.fromMap((map['scalingConfiguration'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      vpcConfigs: map['vpcConfigs'] == null ? null : pulumi.Input.decodeList<FleetVpcConfig>(map['vpcConfigs'], (value) => FleetVpcConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
