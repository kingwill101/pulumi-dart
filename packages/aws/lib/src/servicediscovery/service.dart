...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    this.healthCheckConfig = registerOutput<ServiceHealthCheckConfig?>('healthCheckConfig');
    this.healthCheckCustomConfig = registerOutput<ServiceHealthCheckCustomConfig?>('healthCheckCustomConfig');
