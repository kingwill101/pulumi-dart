...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      dnsConfig: map['dnsConfig'] == null ? null : ServiceDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      forceDestroy: map['forceDestroy'] == null ? null : map['forceDestroy'] as bool,
      healthCheckConfig: map['healthCheckConfig'] == null ? null : ServiceHealthCheckConfig.fromMap((map['healthCheckConfig'] as Map).cast<String, dynamic>()),
      healthCheckCustomConfig: map['healthCheckCustomConfig'] == null ? null : ServiceHealthCheckCustomConfig.fromMap((map['healthCheckCustomConfig'] as Map).cast<String, dynamic>()),
