...
class RepositoryAssociationArgs {
  ...
  RepositoryAssociationArgs({
    ...
    Map<String, String>? tags,
        ...
        repository =
            pulumi.Input.asInput<RepositoryAssociationRepository>(repository),
  ...
  factory RepositoryAssociationArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryAssociationArgs(
      kmsKeyDetails: map['kmsKeyDetails'] == null
          ? null
          : RepositoryAssociationKmsKeyDetails.fromMap(
              (map['kmsKeyDetails'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      repository: RepositoryAssociationRepository.fromMap(
