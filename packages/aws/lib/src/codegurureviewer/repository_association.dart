...
class RepositoryAssociation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RepositoryAssociationS3RepositoryDetail>>
  s3RepositoryDetails;
  ...
  RepositoryAssociation(
    ...
    this.kmsKeyDetails = registerOutput<RepositoryAssociationKmsKeyDetails?>(
      'kmsKeyDetails',
    );
    ...
    this.repository = registerOutput<RepositoryAssociationRepository>(
      'repository',
    );
