...
class IndexIndexStatistic {
  ...
  IndexIndexStatistic({this.faqStatistics, this.textDocumentStatistics});
    ...
    return <String, dynamic>{
      'faqStatistics': ?faqStatistics == null
          ...
          : pulumi.Input.encodeList<
              ...
              Map<String, dynamic>
            >(faqStatistics!, (value) => value.toMap()),
      'textDocumentStatistics': ?textDocumentStatistics == null
          ? null
          : pulumi.Input.encodeList<
              IndexIndexStatisticTextDocumentStatistic,
              Map<String, dynamic>
            >(textDocumentStatistics!, (value) => value.toMap()),
    };
  }
