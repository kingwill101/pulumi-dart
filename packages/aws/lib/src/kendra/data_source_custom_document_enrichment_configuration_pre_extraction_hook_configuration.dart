...
class DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration {
  ...
  final DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition?
  invocationCondition;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'invocationCondition': ?invocationCondition == null
          ? null
          : invocationCondition!.toMap(),
      'lambdaArn': lambdaArn,
      's3Bucket': s3Bucket,
    };
  }

  factory DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration(
      invocationCondition: map['invocationCondition'] == null
          ? null
          : DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition.fromMap(
              (map['invocationCondition'] as Map).cast<String, dynamic>(),
            ),
