...
class DataSourceArgs {
  ...
  DataSourceArgs({
    ...
    DataSourceCustomDocumentEnrichmentConfiguration? customDocumentEnrichmentConfiguration,
    String? description,
  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      configuration: map['configuration'] == null ? null : DataSourceConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      customDocumentEnrichmentConfiguration: map['customDocumentEnrichmentConfiguration'] == null ? null : DataSourceCustomDocumentEnrichmentConfiguration.fromMap((map['customDocumentEnrichmentConfiguration'] as Map).cast<String, dynamic>()),
