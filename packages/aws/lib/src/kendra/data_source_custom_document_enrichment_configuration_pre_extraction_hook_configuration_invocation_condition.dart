...
import 'data_source_custom_document_enrichment_configuration_pre_extraction_hook_configuration_invocation_condition_condition_on_value.dart';
...
class DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition {
  ...
  final DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue?
  conditionOnValue;
  ...
  /// Creates a new [DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionOnValue': ?conditionOnValue == null
          ? null
          : conditionOnValue!.toMap(),
      'operator': operator,
    };
  }

  factory DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition.fromMap(
    ...
    return DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition(
      ...
      conditionOnValue: map['conditionOnValue'] == null
          ? null
          : DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue.fromMap(
