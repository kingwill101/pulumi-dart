...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition {
  ...
  final DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue? conditionOnValue;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionOnValue': ?conditionOnValue == null ? null : conditionOnValue!.toMap(),
      'operator': operator,
    };
  }
  ...
  factory DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition.fromMap(Map<String, dynamic> map) {
    return DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition(
      conditionDocumentAttributeKey: map['conditionDocumentAttributeKey'] as String,
      conditionOnValue: map['conditionOnValue'] == null ? null : DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue.fromMap((map['conditionOnValue'] as Map).cast<String, dynamic>()),
