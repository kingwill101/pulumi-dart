...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget {
  ...
  final DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue? targetDocumentAttributeValue;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetDocumentAttributeValue': ?targetDocumentAttributeValue == null ? null : targetDocumentAttributeValue!.toMap(),
  ...
  factory DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget.fromMap(Map<String, dynamic> map) {
    return DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget(
      targetDocumentAttributeKey: map['targetDocumentAttributeKey'] == null ? null : map['targetDocumentAttributeKey'] as String,
      targetDocumentAttributeValue: map['targetDocumentAttributeValue'] == null ? null : DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue.fromMap((map['targetDocumentAttributeValue'] as Map).cast<String, dynamic>()),
      targetDocumentAttributeValueDeletion: map['targetDocumentAttributeValueDeletion'] == null ? null : map['targetDocumentAttributeValueDeletion'] as bool,
    );
  }
}
