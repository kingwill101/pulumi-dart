...
class IndexArgs {
  ...
  IndexArgs({
    ...
    IndexServerSideEncryptionConfiguration? serverSideEncryptionConfiguration,
    ...
    IndexUserTokenConfigurations? userTokenConfigurations,
            ...
            pulumi.Input.asOptionalInput<IndexCapacityUnits>(capacityUnits),
        ...
        userContextPolicy =
            pulumi.Input.asOptionalInput<String>(userContextPolicy),
        userGroupResolutionConfiguration =
