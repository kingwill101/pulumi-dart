...
class DataSourceCustomDocumentEnrichmentConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inlineConfigurations': ?inlineConfigurations == null
          ? null
          : pulumi.Input.encodeList<
              DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration,
              Map<String, dynamic>
            >(inlineConfigurations!, (value) => value.toMap()),
      'postExtractionHookConfiguration':
          ?postExtractionHookConfiguration == null
          ? null
          : postExtractionHookConfiguration!.toMap(),
      'preExtractionHookConfiguration': ?preExtractionHookConfiguration == null
          ? null
          : preExtractionHookConfiguration!.toMap(),
      'roleArn': ?roleArn,
    };
  }
