...
class QuerySuggestionsBlockListArgs {
  ...
  QuerySuggestionsBlockListArgs({
    ...
    required QuerySuggestionsBlockListSourceS3Path sourceS3Path,
    Map<String, String>? tags,
       ...
       sourceS3Path = pulumi
           .Input.asInput<QuerySuggestionsBlockListSourceS3Path>(sourceS3Path),
  ...
  factory QuerySuggestionsBlockListArgs.fromMap(Map<String, dynamic> map) {
    return QuerySuggestionsBlockListArgs(
      ...
      sourceS3Path: QuerySuggestionsBlockListSourceS3Path.fromMap(
