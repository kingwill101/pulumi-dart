...
class NfsFileShare extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NfsFileShareNfsFileShareDefaults?> nfsFileShareDefaults;
  ...
  NfsFileShare(
    ...
    this.cacheAttributes = registerOutput<NfsFileShareCacheAttributes?>('cacheAttributes');
    ...
    this.nfsFileShareDefaults = registerOutput<NfsFileShareNfsFileShareDefaults?>('nfsFileShareDefaults');
