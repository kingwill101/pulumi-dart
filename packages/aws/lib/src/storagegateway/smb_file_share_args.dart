...
class SmbFileShareArgs {
  ...
  factory SmbFileShareArgs.fromMap(Map<String, dynamic> map) {
    return SmbFileShareArgs(
      accessBasedEnumeration: map['accessBasedEnumeration'] == null ? null : map['accessBasedEnumeration'] as bool,
      adminUserLists: map['adminUserLists'] == null ? null : (map['adminUserLists'] as List).cast<String>(),
      ...
      cacheAttributes: map['cacheAttributes'] == null ? null : SmbFileShareCacheAttributes.fromMap((map['cacheAttributes'] as Map).cast<String, dynamic>()),
      caseSensitivity: map['caseSensitivity'] == null ? null : map['caseSensitivity'] as String,
      ...
      invalidUserLists: map['invalidUserLists'] == null ? null : (map['invalidUserLists'] as List).cast<String>(),
      ...
      oplocksEnabled: map['oplocksEnabled'] == null ? null : map['oplocksEnabled'] as bool,
      readOnly: map['readOnly'] == null ? null : map['readOnly'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      requesterPays: map['requesterPays'] == null ? null : map['requesterPays'] as bool,
      roleArn: map['roleArn'] as String,
      smbAclEnabled: map['smbAclEnabled'] == null ? null : map['smbAclEnabled'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      validUserLists: map['validUserLists'] == null ? null : (map['validUserLists'] as List).cast<String>(),
