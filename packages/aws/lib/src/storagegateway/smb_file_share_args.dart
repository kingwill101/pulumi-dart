...
class SmbFileShareArgs {
  ...
  SmbFileShareArgs({
    ...
    List<String>? validUserLists,
    String? vpcEndpointDnsName,
  }) : accessBasedEnumeration = pulumi.Input.asOptionalInput<bool>(
         accessBasedEnumeration,
       ),
       adminUserLists = pulumi.Input.asOptionalInput<List<String>>(
         adminUserLists,
       ),
       auditDestinationArn = pulumi.Input.asOptionalInput<String>(
         auditDestinationArn,
       ),
       ...
       cacheAttributes = pulumi
           .Input.asOptionalInput<SmbFileShareCacheAttributes>(cacheAttributes),
       caseSensitivity = pulumi.Input.asOptionalInput<String>(caseSensitivity),
       defaultStorageClass = pulumi.Input.asOptionalInput<String>(
         defaultStorageClass,
       ),
       fileShareName = pulumi.Input.asOptionalInput<String>(fileShareName),
       gatewayArn = pulumi.Input.asInput<String>(gatewayArn),
       guessMimeTypeEnabled = pulumi.Input.asOptionalInput<bool>(
         guessMimeTypeEnabled,
       ),
       invalidUserLists = pulumi.Input.asOptionalInput<List<String>>(
         invalidUserLists,
       ),
       ...
       notificationPolicy = pulumi.Input.asOptionalInput<String>(
         notificationPolicy,
       ),
       objectAcl = pulumi.Input.asOptionalInput<String>(objectAcl),
       oplocksEnabled = pulumi.Input.asOptionalInput<bool>(oplocksEnabled),
       ...
       smbAclEnabled = pulumi.Input.asOptionalInput<bool>(smbAclEnabled),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       validUserLists = pulumi.Input.asOptionalInput<List<String>>(
         validUserLists,
       ),
       vpcEndpointDnsName = pulumi.Input.asOptionalInput<String>(
         vpcEndpointDnsName,
       );
  ...
  factory SmbFileShareArgs.fromMap(Map<String, dynamic> map) {
    return SmbFileShareArgs(
      accessBasedEnumeration: map['accessBasedEnumeration'] == null
          ? null
          : map['accessBasedEnumeration'] as bool,
      adminUserLists: map['adminUserLists'] == null
          ? null
          : (map['adminUserLists'] as List).cast<String>(),
      ...
      bucketRegion: map['bucketRegion'] == null
          ? null
          : map['bucketRegion'] as String,
      ...
      caseSensitivity: map['caseSensitivity'] == null
          ? null
          : map['caseSensitivity'] as String,
      defaultStorageClass: map['defaultStorageClass'] == null
          ? null
          : map['defaultStorageClass'] as String,
      fileShareName: map['fileShareName'] == null
          ? null
          : map['fileShareName'] as String,
      gatewayArn: map['gatewayArn'] as String,
      guessMimeTypeEnabled: map['guessMimeTypeEnabled'] == null
          ? null
          : map['guessMimeTypeEnabled'] as bool,
      invalidUserLists: map['invalidUserLists'] == null
          ? null
          : (map['invalidUserLists'] as List).cast<String>(),
      kmsEncrypted: map['kmsEncrypted'] == null
          ? null
          : map['kmsEncrypted'] as bool,
      kmsKeyArn: map['kmsKeyArn'] == null ? null : map['kmsKeyArn'] as String,
      locationArn: map['locationArn'] as String,
      notificationPolicy: map['notificationPolicy'] == null
          ? null
          : map['notificationPolicy'] as String,
      objectAcl: map['objectAcl'] == null ? null : map['objectAcl'] as String,
      oplocksEnabled: map['oplocksEnabled'] == null
          ? null
          : map['oplocksEnabled'] as bool,
      ...
      smbAclEnabled: map['smbAclEnabled'] == null
          ? null
          : map['smbAclEnabled'] as bool,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      validUserLists: map['validUserLists'] == null
          ? null
          : (map['validUserLists'] as List).cast<String>(),
      vpcEndpointDnsName: map['vpcEndpointDnsName'] == null
          ? null
          : map['vpcEndpointDnsName'] as String,
    );
  }
}
