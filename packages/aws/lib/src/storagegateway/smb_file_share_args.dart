...
class SmbFileShareArgs {
  ...
  SmbFileShareArgs({
    ...
    String? vpcEndpointDnsName,
            ...
            pulumi.Input.asOptionalInput<bool>(accessBasedEnumeration),
        adminUserLists =
            pulumi.Input.asOptionalInput<List<String>>(adminUserLists),
        auditDestinationArn =
        ...
        defaultStorageClass =
            pulumi.Input.asOptionalInput<String>(defaultStorageClass),
        fileShareName = pulumi.Input.asOptionalInput<String>(fileShareName),
        gatewayArn = pulumi.Input.asInput<String>(gatewayArn),
        guessMimeTypeEnabled =
            pulumi.Input.asOptionalInput<bool>(guessMimeTypeEnabled),
        invalidUserLists =
            pulumi.Input.asOptionalInput<List<String>>(invalidUserLists),
        ...
        notificationPolicy =
            pulumi.Input.asOptionalInput<String>(notificationPolicy),
        ...
        validUserLists =
            pulumi.Input.asOptionalInput<List<String>>(validUserLists),
        vpcEndpointDnsName =
            pulumi.Input.asOptionalInput<String>(vpcEndpointDnsName);
  ...
  factory SmbFileShareArgs.fromMap(Map<String, dynamic> map) {
    return SmbFileShareArgs(
      ...
      bucketRegion:
          map['bucketRegion'] == null ? null : map['bucketRegion'] as String,
      ...
      fileShareName:
          map['fileShareName'] == null ? null : map['fileShareName'] as String,
      ...
      kmsEncrypted:
          map['kmsEncrypted'] == null ? null : map['kmsEncrypted'] as bool,
      ...
      oplocksEnabled:
          map['oplocksEnabled'] == null ? null : map['oplocksEnabled'] as bool,
      ...
      smbAclEnabled:
          map['smbAclEnabled'] == null ? null : map['smbAclEnabled'] as bool,
      tags: map['tags'] == null
          ? null
