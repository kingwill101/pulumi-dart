...
class GatewayArgs {
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      averageDownloadRateLimitInBitsPerSec: map['averageDownloadRateLimitInBitsPerSec'] == null ? null : map['averageDownloadRateLimitInBitsPerSec'] as int,
      averageUploadRateLimitInBitsPerSec: map['averageUploadRateLimitInBitsPerSec'] == null ? null : map['averageUploadRateLimitInBitsPerSec'] as int,
      ...
      gatewayVpcEndpoint: map['gatewayVpcEndpoint'] == null ? null : map['gatewayVpcEndpoint'] as String,
      maintenanceStartTime: map['maintenanceStartTime'] == null ? null : GatewayMaintenanceStartTime.fromMap((map['maintenanceStartTime'] as Map).cast<String, dynamic>()),
      mediumChangerType: map['mediumChangerType'] == null ? null : map['mediumChangerType'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      smbActiveDirectorySettings: map['smbActiveDirectorySettings'] == null ? null : GatewaySmbActiveDirectorySettings.fromMap((map['smbActiveDirectorySettings'] as Map).cast<String, dynamic>()),
      smbFileShareVisibility: map['smbFileShareVisibility'] == null ? null : map['smbFileShareVisibility'] as bool,
      smbGuestPassword: map['smbGuestPassword'] == null ? null : map['smbGuestPassword'] as String,
      smbSecurityStrategy: map['smbSecurityStrategy'] == null ? null : map['smbSecurityStrategy'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tapeDriveType: map['tapeDriveType'] == null ? null : map['tapeDriveType'] as String,
    );
  }
}
