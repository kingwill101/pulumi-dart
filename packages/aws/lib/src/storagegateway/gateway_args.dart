...
class GatewayArgs {
  ...
  GatewayArgs({
    ...
    String? tapeDriveType,
       ...
       cloudwatchLogGroupArn = pulumi.Input.asOptionalInput<String>(
         cloudwatchLogGroupArn,
       ),
       gatewayIpAddress = pulumi.Input.asOptionalInput<String>(
         gatewayIpAddress,
       ),
       ...
       gatewayVpcEndpoint = pulumi.Input.asOptionalInput<String>(
         gatewayVpcEndpoint,
       ),
       ...
       mediumChangerType = pulumi.Input.asOptionalInput<String>(
         mediumChangerType,
       ),
       ...
       smbFileShareVisibility = pulumi.Input.asOptionalInput<bool>(
         smbFileShareVisibility,
       ),
       smbGuestPassword = pulumi.Input.asOptionalInput<String>(
         smbGuestPassword,
       ),
       smbSecurityStrategy = pulumi.Input.asOptionalInput<String>(
         smbSecurityStrategy,
       ),
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      tapeDriveType: map['tapeDriveType'] == null
          ? null
          : map['tapeDriveType'] as String,
    );
  }
}
