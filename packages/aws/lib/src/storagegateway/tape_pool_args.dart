...
class TapePoolArgs {
  ...
  factory TapePoolArgs.fromMap(Map<String, dynamic> map) {
    return TapePoolArgs(
      ...
      retentionLockTimeInDays: map['retentionLockTimeInDays'] == null ? null : map['retentionLockTimeInDays'] as int,
      retentionLockType: map['retentionLockType'] == null ? null : map['retentionLockType'] as String,
