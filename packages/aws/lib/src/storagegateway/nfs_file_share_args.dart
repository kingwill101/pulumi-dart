  ...
  NfsFileShareArgs({
    ...
    String? vpcEndpointDnsName,
       ...
       cacheAttributes = pulumi
           .Input.asOptionalInput<NfsFileShareCacheAttributes>(cacheAttributes),
    ...
    return <String, dynamic>{
      ...
      'nfsFileShareDefaults':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(nfsFileShareDefaults, (value) => value.toMap()),
  ...
  factory NfsFileShareArgs.fromMap(Map<String, dynamic> map) {
    return NfsFileShareArgs(
      ...
      cacheAttributes: map['cacheAttributes'] == null
          ? null
          : NfsFileShareCacheAttributes.fromMap(
      ...
      nfsFileShareDefaults: map['nfsFileShareDefaults'] == null
          ? null
          : NfsFileShareNfsFileShareDefaults.fromMap(
              (map['nfsFileShareDefaults'] as Map).cast<String, dynamic>(),
            ),
