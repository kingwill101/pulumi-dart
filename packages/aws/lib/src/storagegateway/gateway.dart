...
class Gateway extends pulumi.CustomResource {
  ...
  Gateway(
    ...
    this.averageDownloadRateLimitInBitsPerSec = registerOutput<int?>(
      'averageDownloadRateLimitInBitsPerSec',
    );
    this.averageUploadRateLimitInBitsPerSec = registerOutput<int?>(
    ...
    this.maintenanceStartTime = registerOutput<GatewayMaintenanceStartTime>(
    ...
    this.smbFileShareVisibility = registerOutput<bool?>(
