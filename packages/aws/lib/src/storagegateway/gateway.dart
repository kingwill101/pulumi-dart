...
class Gateway extends pulumi.CustomResource {
  ...
  Gateway(
    ...
    this.averageDownloadRateLimitInBitsPerSec = registerOutput<int?>('averageDownloadRateLimitInBitsPerSec');
    this.averageUploadRateLimitInBitsPerSec = registerOutput<int?>('averageUploadRateLimitInBitsPerSec');
    ...
    this.gatewayNetworkInterfaces = registerOutput<List<GatewayGatewayNetworkInterface>>('gatewayNetworkInterfaces');
    ...
    this.maintenanceStartTime = registerOutput<GatewayMaintenanceStartTime>('maintenanceStartTime');
    this.mediumChangerType = registerOutput<String?>('mediumChangerType');
    this.region = registerOutput<String>('region');
    this.smbActiveDirectorySettings = registerOutput<GatewaySmbActiveDirectorySettings?>('smbActiveDirectorySettings');
    this.smbFileShareVisibility = registerOutput<bool?>('smbFileShareVisibility');
