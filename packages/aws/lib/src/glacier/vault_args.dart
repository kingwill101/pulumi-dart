...
class VaultArgs {
  ...
  factory VaultArgs.fromMap(Map<String, dynamic> map) {
    return VaultArgs(
      accessPolicy: map['accessPolicy'] == null ? null : map['accessPolicy'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      notification: map['notification'] == null ? null : VaultNotification.fromMap((map['notification'] as Map).cast<String, dynamic>()),
