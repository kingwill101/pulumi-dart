...
class AppMonitorArgs {
  ...
  AppMonitorArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<AppMonitorAppMonitorConfiguration>(
                appMonitorConfiguration),
        customEvents =
            pulumi.Input.asOptionalInput<AppMonitorCustomEvents>(customEvents),
  ...
  factory AppMonitorArgs.fromMap(Map<String, dynamic> map) {
    return AppMonitorArgs(
      appMonitorConfiguration: map['appMonitorConfiguration'] == null
          ? null
          : AppMonitorAppMonitorConfiguration.fromMap(
              (map['appMonitorConfiguration'] as Map).cast<String, dynamic>()),
      customEvents: map['customEvents'] == null
          ? null
          : AppMonitorCustomEvents.fromMap(
              (map['customEvents'] as Map).cast<String, dynamic>()),
      cwLogEnabled:
          map['cwLogEnabled'] == null ? null : map['cwLogEnabled'] as bool,
      domain: map['domain'] == null ? null : map['domain'] as String,
      domainLists: map['domainLists'] == null
          ? null
          : (map['domainLists'] as List).cast<String>(),
