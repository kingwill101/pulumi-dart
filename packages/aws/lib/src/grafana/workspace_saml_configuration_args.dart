...
class WorkspaceSamlConfigurationArgs {
  ...
  WorkspaceSamlConfigurationArgs({
    ...
    required String workspaceId,
            ...
            pulumi.Input.asOptionalInput<List<String>>(adminRoleValues),
        allowedOrganizations =
            pulumi.Input.asOptionalInput<List<String>>(allowedOrganizations),
        ...
        loginValidityDuration =
            pulumi.Input.asOptionalInput<int>(loginValidityDuration),
  ...
  factory WorkspaceSamlConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceSamlConfigurationArgs(
      ...
      nameAssertion:
          map['nameAssertion'] == null ? null : map['nameAssertion'] as String,
      orgAssertion:
          map['orgAssertion'] == null ? null : map['orgAssertion'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      roleAssertion:
          map['roleAssertion'] == null ? null : map['roleAssertion'] as String,
