...
class WorkspaceSamlConfigurationArgs {
  ...
  factory WorkspaceSamlConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceSamlConfigurationArgs(
      adminRoleValues: map['adminRoleValues'] == null ? null : (map['adminRoleValues'] as List).cast<String>(),
      allowedOrganizations: map['allowedOrganizations'] == null ? null : (map['allowedOrganizations'] as List).cast<String>(),
      editorRoleValues: (map['editorRoleValues'] as List).cast<String>(),
      emailAssertion: map['emailAssertion'] == null ? null : map['emailAssertion'] as String,
      groupsAssertion: map['groupsAssertion'] == null ? null : map['groupsAssertion'] as String,
      idpMetadataUrl: map['idpMetadataUrl'] == null ? null : map['idpMetadataUrl'] as String,
      idpMetadataXml: map['idpMetadataXml'] == null ? null : map['idpMetadataXml'] as String,
      loginAssertion: map['loginAssertion'] == null ? null : map['loginAssertion'] as String,
      loginValidityDuration: map['loginValidityDuration'] == null ? null : map['loginValidityDuration'] as int,
      nameAssertion: map['nameAssertion'] == null ? null : map['nameAssertion'] as String,
      orgAssertion: map['orgAssertion'] == null ? null : map['orgAssertion'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      roleAssertion: map['roleAssertion'] == null ? null : map['roleAssertion'] as String,
