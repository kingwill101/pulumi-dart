...
class WorkspaceArgs {
  ...
  WorkspaceArgs({
    ...
    WorkspaceVpcConfiguration? vpcConfiguration,
       ...
       authenticationProviders = pulumi.Input.asInput<List<String>>(
       ...
       organizationRoleName = pulumi.Input.asOptionalInput<String>(
       ...
       vpcConfiguration = pulumi
           .Input.asOptionalInput<WorkspaceVpcConfiguration>(vpcConfiguration);
  ...
  factory WorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceArgs(
      ...
      stackSetName: map['stackSetName'] == null
          ? null
          : map['stackSetName'] as String,
      tags: map['tags'] == null
          ? null
