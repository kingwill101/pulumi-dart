...
class WorkspaceArgs {
  ...
  factory WorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceArgs(
      ...
      networkAccessControl: map['networkAccessControl'] == null ? null : WorkspaceNetworkAccessControl.fromMap((map['networkAccessControl'] as Map).cast<String, dynamic>()),
      notificationDestinations: map['notificationDestinations'] == null ? null : (map['notificationDestinations'] as List).cast<String>(),
      organizationRoleName: map['organizationRoleName'] == null ? null : map['organizationRoleName'] as String,
      organizationalUnits: map['organizationalUnits'] == null ? null : (map['organizationalUnits'] as List).cast<String>(),
      ...
      vpcConfiguration: map['vpcConfiguration'] == null ? null : WorkspaceVpcConfiguration.fromMap((map['vpcConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
