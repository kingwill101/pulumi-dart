...
class DocumentClassifierArgs {
  ...
  factory DocumentClassifierArgs.fromMap(Map<String, dynamic> map) {
    return DocumentClassifierArgs(
      ...
      inputDataConfig: DocumentClassifierInputDataConfig.fromMap((map['inputDataConfig'] as Map).cast<String, dynamic>()),
      languageCode: map['languageCode'] as String,
      mode: map['mode'] == null ? null : map['mode'] as String,
      modelKmsKeyId: map['modelKmsKeyId'] == null ? null : map['modelKmsKeyId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      outputDataConfig: map['outputDataConfig'] == null ? null : DocumentClassifierOutputDataConfig.fromMap((map['outputDataConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      versionName: map['versionName'] == null ? null : map['versionName'] as String,
      versionNamePrefix: map['versionNamePrefix'] == null ? null : map['versionNamePrefix'] as String,
      volumeKmsKeyId: map['volumeKmsKeyId'] == null ? null : map['volumeKmsKeyId'] as String,
      vpcConfig: map['vpcConfig'] == null ? null : DocumentClassifierVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
