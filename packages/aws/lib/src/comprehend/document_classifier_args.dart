...
class DocumentClassifierArgs {
  ...
  DocumentClassifierArgs({
    ...
    DocumentClassifierVpcConfig? vpcConfig,
        ...
        inputDataConfig =
            pulumi.Input.asInput<DocumentClassifierInputDataConfig>(
                inputDataConfig),
        ...
        versionNamePrefix =
            pulumi.Input.asOptionalInput<String>(versionNamePrefix),
  ...
  factory DocumentClassifierArgs.fromMap(Map<String, dynamic> map) {
    return DocumentClassifierArgs(
      ...
      modelKmsKeyId:
          map['modelKmsKeyId'] == null ? null : map['modelKmsKeyId'] as String,
