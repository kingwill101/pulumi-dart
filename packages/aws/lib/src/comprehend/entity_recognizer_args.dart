...
class EntityRecognizerArgs {
  ...
  factory EntityRecognizerArgs.fromMap(Map<String, dynamic> map) {
    return EntityRecognizerArgs(
      ...
      inputDataConfig: EntityRecognizerInputDataConfig.fromMap((map['inputDataConfig'] as Map).cast<String, dynamic>()),
      ...
      vpcConfig: map['vpcConfig'] == null ? null : EntityRecognizerVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
