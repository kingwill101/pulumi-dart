...
class Table extends pulumi.CustomResource {
  ...
  Table(String name, {TableArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.globalTableWitness = registerOutput<TableGlobalTableWitness>(
      'globalTableWitness',
    );
    ...
    this.onDemandThroughput = registerOutput<TableOnDemandThroughput?>(
      'onDemandThroughput',
    );
    this.pointInTimeRecovery = registerOutput<TablePointInTimeRecovery>(
      'pointInTimeRecovery',
    );
    ...
    this.restoreSourceTableArn = registerOutput<String?>(
      'restoreSourceTableArn',
    );
    this.restoreToLatestTime = registerOutput<bool?>('restoreToLatestTime');
    this.serverSideEncryption = registerOutput<TableServerSideEncryption>(
