...
class GlobalSecondaryIndexArgs {
  ...
  factory GlobalSecondaryIndexArgs.fromMap(Map<String, dynamic> map) {
    return GlobalSecondaryIndexArgs(
      ...
      keySchemas: map['keySchemas'] == null ? null : pulumi.Input.decodeList<GlobalSecondaryIndexKeySchema>(map['keySchemas'], (value) => GlobalSecondaryIndexKeySchema.fromMap((value as Map).cast<String, dynamic>())),
      onDemandThroughput: map['onDemandThroughput'] == null ? null : GlobalSecondaryIndexOnDemandThroughput.fromMap((map['onDemandThroughput'] as Map).cast<String, dynamic>()),
      projection: map['projection'] == null ? null : GlobalSecondaryIndexProjection.fromMap((map['projection'] as Map).cast<String, dynamic>()),
      provisionedThroughput: map['provisionedThroughput'] == null ? null : GlobalSecondaryIndexProvisionedThroughput.fromMap((map['provisionedThroughput'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tableName: map['tableName'] as String,
      timeouts: map['timeouts'] == null ? null : GlobalSecondaryIndexTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      warmThroughput: map['warmThroughput'] == null ? null : GlobalSecondaryIndexWarmThroughput.fromMap((map['warmThroughput'] as Map).cast<String, dynamic>()),
    );
  }
}
