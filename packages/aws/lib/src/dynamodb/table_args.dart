...
class TableArgs {
  ...
  TableArgs({
    ...
    int? writeCapacity,
  }) : attributes = pulumi.Input.asOptionalInput<List<TableAttribute>>(
         attributes,
       ),
       ...
       globalTableWitness = pulumi
           .Input.asOptionalInput<TableGlobalTableWitness>(globalTableWitness),
       hashKey = pulumi.Input.asOptionalInput<String>(hashKey),
       importTable = pulumi.Input.asOptionalInput<TableImportTable>(
         importTable,
       ),
       ...
       onDemandThroughput = pulumi
           .Input.asOptionalInput<TableOnDemandThroughput>(onDemandThroughput),
       pointInTimeRecovery =
       ...
       restoreSourceName = pulumi.Input.asOptionalInput<String>(
         restoreSourceName,
       ),
       restoreSourceTableArn = pulumi.Input.asOptionalInput<String>(
         restoreSourceTableArn,
       ),
       restoreToLatestTime = pulumi.Input.asOptionalInput<bool>(
         restoreToLatestTime,
       ),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'globalSecondaryIndexes':
          ?pulumi.Input.mapOptionalInputValue<
            List<TableGlobalSecondaryIndex>,
            List<Map<String, dynamic>>
          >(
            globalSecondaryIndexes,
            (value) =>
      ...
      'globalTableWitness':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(globalTableWitness, (value) => value.toMap()),
      'hashKey': ?hashKey,
      'importTable':
          ?pulumi.Input.mapOptionalInputValue<
            TableImportTable,
            Map<String, dynamic>
          >(importTable, (value) => value.toMap()),
      'localSecondaryIndexes':
          ?pulumi.Input.mapOptionalInputValue<
            List<TableLocalSecondaryIndex>,
            List<Map<String, dynamic>>
          >(
            localSecondaryIndexes,
            (value) =>
