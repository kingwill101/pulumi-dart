...
class TableArgs {
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      attributes: map['attributes'] == null ? null : pulumi.Input.decodeList<TableAttribute>(map['attributes'], (value) => TableAttribute.fromMap((value as Map).cast<String, dynamic>())),
      ...
      globalSecondaryIndexes: map['globalSecondaryIndexes'] == null ? null : pulumi.Input.decodeList<TableGlobalSecondaryIndex>(map['globalSecondaryIndexes'], (value) => TableGlobalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>())),
      globalTableWitness: map['globalTableWitness'] == null ? null : TableGlobalTableWitness.fromMap((map['globalTableWitness'] as Map).cast<String, dynamic>()),
      hashKey: map['hashKey'] == null ? null : map['hashKey'] as String,
      importTable: map['importTable'] == null ? null : TableImportTable.fromMap((map['importTable'] as Map).cast<String, dynamic>()),
      localSecondaryIndexes: map['localSecondaryIndexes'] == null ? null : pulumi.Input.decodeList<TableLocalSecondaryIndex>(map['localSecondaryIndexes'], (value) => TableLocalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      onDemandThroughput: map['onDemandThroughput'] == null ? null : TableOnDemandThroughput.fromMap((map['onDemandThroughput'] as Map).cast<String, dynamic>()),
      ...
      replicas: map['replicas'] == null ? null : pulumi.Input.decodeList<TableReplica>(map['replicas'], (value) => TableReplica.fromMap((value as Map).cast<String, dynamic>())),
      restoreDateTime: map['restoreDateTime'] == null ? null : map['restoreDateTime'] as String,
      restoreSourceName: map['restoreSourceName'] == null ? null : map['restoreSourceName'] as String,
      restoreSourceTableArn: map['restoreSourceTableArn'] == null ? null : map['restoreSourceTableArn'] as String,
      restoreToLatestTime: map['restoreToLatestTime'] == null ? null : map['restoreToLatestTime'] as bool,
      serverSideEncryption: map['serverSideEncryption'] == null ? null : TableServerSideEncryption.fromMap((map['serverSideEncryption'] as Map).cast<String, dynamic>()),
      streamEnabled: map['streamEnabled'] == null ? null : map['streamEnabled'] as bool,
      streamViewType: map['streamViewType'] == null ? null : map['streamViewType'] as String,
      ...
      warmThroughput: map['warmThroughput'] == null ? null : TableWarmThroughput.fromMap((map['warmThroughput'] as Map).cast<String, dynamic>()),
