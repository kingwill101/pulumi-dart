...
class TableExportArgs {
  ...
  factory TableExportArgs.fromMap(Map<String, dynamic> map) {
    return TableExportArgs(
      exportFormat: map['exportFormat'] == null ? null : map['exportFormat'] as String,
      exportTime: map['exportTime'] == null ? null : map['exportTime'] as String,
      exportType: map['exportType'] == null ? null : map['exportType'] as String,
      incrementalExportSpecification: map['incrementalExportSpecification'] == null ? null : TableExportIncrementalExportSpecification.fromMap((map['incrementalExportSpecification'] as Map).cast<String, dynamic>()),
      ...
      s3SseAlgorithm: map['s3SseAlgorithm'] == null ? null : map['s3SseAlgorithm'] as String,
      s3SseKmsKeyId: map['s3SseKmsKeyId'] == null ? null : map['s3SseKmsKeyId'] as String,
