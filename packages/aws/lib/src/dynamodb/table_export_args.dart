...
class TableExportArgs {
  ...
  factory TableExportArgs.fromMap(Map<String, dynamic> map) {
    return TableExportArgs(
      exportFormat:
          map['exportFormat'] == null ? null : map['exportFormat'] as String,
      exportTime:
          map['exportTime'] == null ? null : map['exportTime'] as String,
      exportType:
          map['exportType'] == null ? null : map['exportType'] as String,
      incrementalExportSpecification:
