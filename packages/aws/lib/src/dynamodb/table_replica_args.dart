...
class TableReplicaArgs {
  ...
  TableReplicaArgs({
    ...
    Map<String, String>? tags,
       ...
       pointInTimeRecovery = pulumi.Input.asOptionalInput<bool>(
         pointInTimeRecovery,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       tableClassOverride = pulumi.Input.asOptionalInput<String>(
         tableClassOverride,
       ),
  ...
  factory TableReplicaArgs.fromMap(Map<String, dynamic> map) {
    return TableReplicaArgs(
      ...
      tableClassOverride: map['tableClassOverride'] == null
          ? null
          : map['tableClassOverride'] as String,
      tags: map['tags'] == null
          ? null
