...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.aquaConfigurationStatus = registerOutput<String>(
      'aquaConfigurationStatus',
    );
    this.arn = registerOutput<String>('arn');
    this.automatedSnapshotRetentionPeriod = registerOutput<int?>(
      'automatedSnapshotRetentionPeriod',
    );
    this.availabilityZone = registerOutput<String>('availabilityZone');
    this.availabilityZoneRelocationEnabled = registerOutput<bool?>(
    ...
    this.clusterNodes = registerOutput<List<ClusterClusterNode>>(
      'clusterNodes',
    );
    this.clusterParameterGroupName = registerOutput<String>(
      'clusterParameterGroupName',
    );
    this.clusterPublicKey = registerOutput<String>('clusterPublicKey');
    this.clusterRevisionNumber = registerOutput<String>(
      'clusterRevisionNumber',
    );
    this.clusterSubnetGroupName = registerOutput<String>(
    ...
    this.masterPasswordSecretArn = registerOutput<String>(
      'masterPasswordSecretArn',
    );
    this.masterPasswordSecretKmsKeyId = registerOutput<String>(
    ...
    this.snapshotClusterIdentifier = registerOutput<String?>(
