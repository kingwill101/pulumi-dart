...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      availabilityZoneRelocationEnabled: map['availabilityZoneRelocationEnabled'] == null ? null : map['availabilityZoneRelocationEnabled'] as bool,
      ...
      defaultIamRoleArn: map['defaultIamRoleArn'] == null ? null : map['defaultIamRoleArn'] as String,
      ...
      snapshotArn: map['snapshotArn'] == null ? null : map['snapshotArn'] as String,
