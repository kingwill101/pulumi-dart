...
class IdcApplicationArgs {
  ...
  IdcApplicationArgs({
    ...
    Map<String, String>? tags,
       ...
       identityNamespace = pulumi.Input.asOptionalInput<String>(
         identityNamespace,
       ),
       redshiftIdcApplicationName = pulumi.Input.asInput<String>(
  ...
  factory IdcApplicationArgs.fromMap(Map<String, dynamic> map) {
    return IdcApplicationArgs(
      ...
      authorizedTokenIssuer: map['authorizedTokenIssuer'] == null
          ? null
          : IdcApplicationAuthorizedTokenIssuer.fromMap(
              (map['authorizedTokenIssuer'] as Map).cast<String, dynamic>(),
            ),
      ...
      serviceIntegration: map['serviceIntegration'] == null
          ? null
          : IdcApplicationServiceIntegration.fromMap(
              (map['serviceIntegration'] as Map).cast<String, dynamic>(),
            ),
      tags: map['tags'] == null
          ? null
