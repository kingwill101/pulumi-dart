...
class IdcApplication extends pulumi.CustomResource {
  ...
  IdcApplication(
    ...
    this.idcManagedApplicationArn = registerOutput<String>(
      'idcManagedApplicationArn',
    );
    this.identityNamespace = registerOutput<String>('identityNamespace');
    this.redshiftIdcApplicationArn = registerOutput<String>(
      'redshiftIdcApplicationArn',
    );
    this.redshiftIdcApplicationName = registerOutput<String>(
      'redshiftIdcApplicationName',
    );
    this.region = registerOutput<String>('region');
    this.serviceIntegration = registerOutput<IdcApplicationServiceIntegration?>(
      'serviceIntegration',
    );
