...
class ConnectorArgs {
  ...
  ConnectorArgs({
    required ConnectorCapacity capacity,
    required Map<String, String> connectorConfiguration,
    String? description,
    required ConnectorKafkaCluster kafkaCluster,
    required ConnectorKafkaClusterClientAuthentication kafkaClusterClientAuthentication,
    required ConnectorKafkaClusterEncryptionInTransit kafkaClusterEncryptionInTransit,
    required String kafkaconnectVersion,
    ConnectorLogDelivery? logDelivery,
    String? name,
    required List<ConnectorPlugin> plugins,
    String? region,
    required String serviceExecutionRoleArn,
    Map<String, String>? tags,
    ConnectorWorkerConfiguration? workerConfiguration,
  }) :
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      capacity: ConnectorCapacity.fromMap((map['capacity'] as Map).cast<String, dynamic>()),
      connectorConfiguration: (map['connectorConfiguration'] as Map).cast<String, String>(),
      description: map['description'] == null ? null : map['description'] as String,
      kafkaCluster: ConnectorKafkaCluster.fromMap((map['kafkaCluster'] as Map).cast<String, dynamic>()),
      kafkaClusterClientAuthentication: ConnectorKafkaClusterClientAuthentication.fromMap((map['kafkaClusterClientAuthentication'] as Map).cast<String, dynamic>()),
      kafkaClusterEncryptionInTransit: ConnectorKafkaClusterEncryptionInTransit.fromMap((map['kafkaClusterEncryptionInTransit'] as Map).cast<String, dynamic>()),
      kafkaconnectVersion: map['kafkaconnectVersion'] as String,
      logDelivery: map['logDelivery'] == null ? null : ConnectorLogDelivery.fromMap((map['logDelivery'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      plugins: pulumi.Input.decodeList<ConnectorPlugin>(map['plugins'], (value) => ConnectorPlugin.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      serviceExecutionRoleArn: map['serviceExecutionRoleArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      workerConfiguration: map['workerConfiguration'] == null ? null : ConnectorWorkerConfiguration.fromMap((map['workerConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
