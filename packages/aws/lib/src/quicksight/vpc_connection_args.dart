...
class VpcConnectionArgs {
  ...
  factory VpcConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VpcConnectionArgs(
      ...
      dnsResolvers: map['dnsResolvers'] == null ? null : (map['dnsResolvers'] as List).cast<String>(),
      ...
      timeouts: map['timeouts'] == null ? null : VpcConnectionTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
