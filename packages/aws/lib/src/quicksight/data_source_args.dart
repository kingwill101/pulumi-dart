...
class DataSourceArgs {
  ...
  DataSourceArgs({
    ...
    DataSourceVpcConnectionProperties? vpcConnectionProperties,
        ...
        credentials =
            pulumi.Input.asOptionalInput<DataSourceCredentials>(credentials),
  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      ...
      parameters: DataSourceParameters.fromMap(
      ...
      sslProperties: map['sslProperties'] == null
          ? null
          : DataSourceSslProperties.fromMap(
              (map['sslProperties'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      type: map['type'] as String,
      vpcConnectionProperties: map['vpcConnectionProperties'] == null
          ? null
          : DataSourceVpcConnectionProperties.fromMap(
              (map['vpcConnectionProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
