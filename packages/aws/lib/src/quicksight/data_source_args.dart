...
class DataSourceArgs {
  ...
  DataSourceArgs({
    ...
    String? name,
    required DataSourceParameters parameters,
    List<DataSourcePermission>? permissions,
    String? region,
    DataSourceSslProperties? sslProperties,
    Map<String, String>? tags,
    required String type,
    DataSourceVpcConnectionProperties? vpcConnectionProperties,
  }) :
  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      ...
      credentials: map['credentials'] == null ? null : DataSourceCredentials.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
      dataSourceId: map['dataSourceId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parameters: DataSourceParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>()),
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<DataSourcePermission>(map['permissions'], (value) => DataSourcePermission.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      sslProperties: map['sslProperties'] == null ? null : DataSourceSslProperties.fromMap((map['sslProperties'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      type: map['type'] as String,
      vpcConnectionProperties: map['vpcConnectionProperties'] == null ? null : DataSourceVpcConnectionProperties.fromMap((map['vpcConnectionProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
