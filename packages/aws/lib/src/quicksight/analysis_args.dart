...
class AnalysisArgs {
  ...
  AnalysisArgs({
    ...
    String? themeArn,
       ...
       parameters = pulumi.Input.asOptionalInput<AnalysisParameters>(
         parameters,
       ),
       permissions = pulumi.Input.asOptionalInput<List<AnalysisPermission>>(
         permissions,
       ),
       recoveryWindowInDays = pulumi.Input.asOptionalInput<int>(
         recoveryWindowInDays,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       sourceEntity = pulumi.Input.asOptionalInput<AnalysisSourceEntity>(
         sourceEntity,
       ),
