...
class AnalysisArgs {
  ...
  factory AnalysisArgs.fromMap(Map<String, dynamic> map) {
    return AnalysisArgs(
      ...
      parameters: map['parameters'] == null ? null : AnalysisParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>()),
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<AnalysisPermission>(map['permissions'], (value) => AnalysisPermission.fromMap((value as Map).cast<String, dynamic>())),
      recoveryWindowInDays: map['recoveryWindowInDays'] == null ? null : map['recoveryWindowInDays'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      sourceEntity: map['sourceEntity'] == null ? null : AnalysisSourceEntity.fromMap((map['sourceEntity'] as Map).cast<String, dynamic>()),
