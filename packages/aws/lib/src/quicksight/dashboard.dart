...
class Dashboard extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DashboardDashboardPublishOptions> dashboardPublishOptions;
  ...
  Dashboard(
    ...
    this.dashboardPublishOptions = registerOutput<DashboardDashboardPublishOptions>('dashboardPublishOptions');
    ...
    this.permissions = registerOutput<List<DashboardPermission>?>('permissions');
