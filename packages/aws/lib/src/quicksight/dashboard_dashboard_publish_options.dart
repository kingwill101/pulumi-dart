    ...
    return DashboardDashboardPublishOptions(
      ...
      exportWithHiddenFieldsOption: map['exportWithHiddenFieldsOption'] == null
          ...
          : DashboardDashboardPublishOptionsExportWithHiddenFieldsOption.fromMap(
              (map['exportWithHiddenFieldsOption'] as Map)
                  .cast<String, dynamic>(),
            ),
      ...
      sheetLayoutElementMaximizationOption:
          map['sheetLayoutElementMaximizationOption'] == null
          ? null
          : DashboardDashboardPublishOptionsSheetLayoutElementMaximizationOption.fromMap(
              (map['sheetLayoutElementMaximizationOption'] as Map)
                  .cast<String, dynamic>(),
            ),
