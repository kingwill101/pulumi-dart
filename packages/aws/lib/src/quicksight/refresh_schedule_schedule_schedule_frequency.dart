...
class RefreshScheduleScheduleScheduleFrequency {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'interval': interval,
      'refreshOnDay': ?refreshOnDay == null ? null : refreshOnDay!.toMap(),
  ...
  factory RefreshScheduleScheduleScheduleFrequency.fromMap(Map<String, dynamic> map) {
    return RefreshScheduleScheduleScheduleFrequency(
      ...
      refreshOnDay: map['refreshOnDay'] == null ? null : RefreshScheduleScheduleScheduleFrequencyRefreshOnDay.fromMap((map['refreshOnDay'] as Map).cast<String, dynamic>()),
      timeOfTheDay: map['timeOfTheDay'] == null ? null : map['timeOfTheDay'] as String,
