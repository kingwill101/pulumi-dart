...
class GetThemeConfigurationSheetTileLayout {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gutters': pulumi.Input.encodeList<GetThemeConfigurationSheetTileLayoutGutter, Map<String, dynamic>>(gutters, (value) => value.toMap()),
      'margins': pulumi.Input.encodeList<GetThemeConfigurationSheetTileLayoutMargin, Map<String, dynamic>>(margins, (value) => value.toMap()),
    };
  }

  factory GetThemeConfigurationSheetTileLayout.fromMap(Map<String, dynamic> map) {
    return GetThemeConfigurationSheetTileLayout(
      gutters: pulumi.Input.decodeList<GetThemeConfigurationSheetTileLayoutGutter>(map['gutters'], (value) => GetThemeConfigurationSheetTileLayoutGutter.fromMap((value as Map).cast<String, dynamic>())),
      margins: pulumi.Input.decodeList<GetThemeConfigurationSheetTileLayoutMargin>(map['margins'], (value) => GetThemeConfigurationSheetTileLayoutMargin.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
