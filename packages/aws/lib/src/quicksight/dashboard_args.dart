...
class DashboardArgs {
  ...
  factory DashboardArgs.fromMap(Map<String, dynamic> map) {
    return DashboardArgs(
      ...
      dashboardPublishOptions: map['dashboardPublishOptions'] == null ? null : DashboardDashboardPublishOptions.fromMap((map['dashboardPublishOptions'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      parameters: map['parameters'] == null ? null : DashboardParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>()),
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<DashboardPermission>(map['permissions'], (value) => DashboardPermission.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      sourceEntity: map['sourceEntity'] == null ? null : DashboardSourceEntity.fromMap((map['sourceEntity'] as Map).cast<String, dynamic>()),
