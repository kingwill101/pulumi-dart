...
class AccountSubscriptionArgs {
  ...
  AccountSubscriptionArgs({
    ...
    String? region,
       ...
       activeDirectoryName = pulumi.Input.asOptionalInput<String>(
         activeDirectoryName,
       ),
       adminGroups = pulumi.Input.asOptionalInput<List<String>>(adminGroups),
       adminProGroups = pulumi.Input.asOptionalInput<List<String>>(
         adminProGroups,
       ),
       authenticationMethod = pulumi.Input.asInput<String>(
         authenticationMethod,
       ),
       authorGroups = pulumi.Input.asOptionalInput<List<String>>(authorGroups),
       authorProGroups = pulumi.Input.asOptionalInput<List<String>>(
         authorProGroups,
       ),
       ...
       readerProGroups = pulumi.Input.asOptionalInput<List<String>>(
         readerProGroups,
       ),
