...
class AccountSubscriptionArgs {
  ...
  factory AccountSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return AccountSubscriptionArgs(
      ...
      activeDirectoryName: map['activeDirectoryName'] == null ? null : map['activeDirectoryName'] as String,
      adminGroups: map['adminGroups'] == null ? null : (map['adminGroups'] as List).cast<String>(),
      adminProGroups: map['adminProGroups'] == null ? null : (map['adminProGroups'] as List).cast<String>(),
      authenticationMethod: map['authenticationMethod'] as String,
      authorGroups: map['authorGroups'] == null ? null : (map['authorGroups'] as List).cast<String>(),
      authorProGroups: map['authorProGroups'] == null ? null : (map['authorProGroups'] as List).cast<String>(),
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      contactNumber: map['contactNumber'] == null ? null : map['contactNumber'] as String,
      ...
      readerGroups: map['readerGroups'] == null ? null : (map['readerGroups'] as List).cast<String>(),
      readerProGroups: map['readerProGroups'] == null ? null : (map['readerProGroups'] as List).cast<String>(),
