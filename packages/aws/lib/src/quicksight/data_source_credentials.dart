...
class DataSourceCredentials {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentialPair': ?credentialPair == null ? null : credentialPair!.toMap(),
      'secretArn': ?secretArn,
    };
  }
  ...
  factory DataSourceCredentials.fromMap(Map<String, dynamic> map) {
    return DataSourceCredentials(
      copySourceArn: map['copySourceArn'] == null ? null : map['copySourceArn'] as String,
      credentialPair: map['credentialPair'] == null ? null : DataSourceCredentialsCredentialPair.fromMap((map['credentialPair'] as Map).cast<String, dynamic>()),
