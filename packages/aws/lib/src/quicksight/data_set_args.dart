...
class DataSetArgs {
  ...
  DataSetArgs({
    ...
    DataSetRowLevelPermissionTagConfiguration? rowLevelPermissionTagConfiguration,
  ...
  factory DataSetArgs.fromMap(Map<String, dynamic> map) {
    return DataSetArgs(
      ...
      columnGroups: map['columnGroups'] == null ? null : pulumi.Input.decodeList<DataSetColumnGroup>(map['columnGroups'], (value) => DataSetColumnGroup.fromMap((value as Map).cast<String, dynamic>())),
      columnLevelPermissionRules: map['columnLevelPermissionRules'] == null ? null : pulumi.Input.decodeList<DataSetColumnLevelPermissionRule>(map['columnLevelPermissionRules'], (value) => DataSetColumnLevelPermissionRule.fromMap((value as Map).cast<String, dynamic>())),
      dataSetId: map['dataSetId'] as String,
      dataSetUsageConfiguration: map['dataSetUsageConfiguration'] == null ? null : DataSetDataSetUsageConfiguration.fromMap((map['dataSetUsageConfiguration'] as Map).cast<String, dynamic>()),
      fieldFolders: map['fieldFolders'] == null ? null : pulumi.Input.decodeList<DataSetFieldFolder>(map['fieldFolders'], (value) => DataSetFieldFolder.fromMap((value as Map).cast<String, dynamic>())),
      importMode: map['importMode'] as String,
      logicalTableMaps: map['logicalTableMaps'] == null ? null : pulumi.Input.decodeList<DataSetLogicalTableMap>(map['logicalTableMaps'], (value) => DataSetLogicalTableMap.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<DataSetPermission>(map['permissions'], (value) => DataSetPermission.fromMap((value as Map).cast<String, dynamic>())),
      physicalTableMaps: map['physicalTableMaps'] == null ? null : pulumi.Input.decodeList<DataSetPhysicalTableMap>(map['physicalTableMaps'], (value) => DataSetPhysicalTableMap.fromMap((value as Map).cast<String, dynamic>())),
      refreshProperties: map['refreshProperties'] == null ? null : DataSetRefreshProperties.fromMap((map['refreshProperties'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      rowLevelPermissionDataSet: map['rowLevelPermissionDataSet'] == null ? null : DataSetRowLevelPermissionDataSet.fromMap((map['rowLevelPermissionDataSet'] as Map).cast<String, dynamic>()),
      rowLevelPermissionTagConfiguration: map['rowLevelPermissionTagConfiguration'] == null ? null : DataSetRowLevelPermissionTagConfiguration.fromMap((map['rowLevelPermissionTagConfiguration'] as Map).cast<String, dynamic>()),
