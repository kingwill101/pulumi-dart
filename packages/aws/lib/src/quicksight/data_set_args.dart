...
class DataSetArgs {
  ...
  DataSetArgs({
    ...
    String? useAs,
       ...
       columnLevelPermissionRules =
           pulumi.Input.asOptionalInput<List<DataSetColumnLevelPermissionRule>>(
             columnLevelPermissionRules,
           ),
       ...
       permissions = pulumi.Input.asOptionalInput<List<DataSetPermission>>(
         permissions,
       ),
       physicalTableMaps =
       ...
       refreshProperties = pulumi
           .Input.asOptionalInput<DataSetRefreshProperties>(refreshProperties),
    ...
    return <String, dynamic>{
      ...
      'dataSetUsageConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataSetUsageConfiguration, (value) => value.toMap()),
      'fieldFolders':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataSetFieldFolder>,
            List<Map<String, dynamic>>
          >(
            fieldFolders,
            (value) =>
      ...
      'refreshProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(refreshProperties, (value) => value.toMap()),
      'region': ?region,
      'rowLevelPermissionDataSet':
          ?pulumi.Input.mapOptionalInputValue<
            DataSetRowLevelPermissionDataSet,
            Map<String, dynamic>
          >(rowLevelPermissionDataSet, (value) => value.toMap()),
      'rowLevelPermissionTagConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            DataSetRowLevelPermissionTagConfiguration,
            Map<String, dynamic>
          >(rowLevelPermissionTagConfiguration, (value) => value.toMap()),
      'tags': ?tags,
      'useAs': ?useAs,
    };
  }
    ...
    return DataSetArgs(
      ...
      dataSetUsageConfiguration: map['dataSetUsageConfiguration'] == null
          ...
          : DataSetDataSetUsageConfiguration.fromMap(
              (map['dataSetUsageConfiguration'] as Map).cast<String, dynamic>(),
            ),
      ...
      rowLevelPermissionDataSet: map['rowLevelPermissionDataSet'] == null
          ...
          : DataSetRowLevelPermissionDataSet.fromMap(
              (map['rowLevelPermissionDataSet'] as Map).cast<String, dynamic>(),
            ),
      rowLevelPermissionTagConfiguration:
