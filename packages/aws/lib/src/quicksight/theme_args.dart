...
class ThemeArgs {
  ...
  factory ThemeArgs.fromMap(Map<String, dynamic> map) {
    return ThemeArgs(
      ...
      configuration: map['configuration'] == null ? null : ThemeConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<ThemePermission>(map['permissions'], (value) => ThemePermission.fromMap((value as Map).cast<String, dynamic>())),
