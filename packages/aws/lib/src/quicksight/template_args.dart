...
class TemplateArgs {
  ...
  factory TemplateArgs.fromMap(Map<String, dynamic> map) {
    return TemplateArgs(
      ...
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<TemplatePermission>(map['permissions'], (value) => TemplatePermission.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      sourceEntity: map['sourceEntity'] == null ? null : TemplateSourceEntity.fromMap((map['sourceEntity'] as Map).cast<String, dynamic>()),
