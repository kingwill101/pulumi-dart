...
class IpRestriction extends pulumi.CustomResource {
  ...
  IpRestriction(
    ...
    this.ipRestrictionRuleMap = registerOutput<Map<String, String>?>(
      'ipRestrictionRuleMap',
    );
    this.region = registerOutput<String>('region');
    this.vpcEndpointIdRestrictionRuleMap = registerOutput<Map<String, String>?>(
      'vpcEndpointIdRestrictionRuleMap',
    );
    this.vpcIdRestrictionRuleMap = registerOutput<Map<String, String>?>(
      'vpcIdRestrictionRuleMap',
    );
  }
}
