...
class DataSourceParameters {
  ...
  Map<String, dynamic> toMap() {
    ...
    final amazonElasticsearchValue = amazonElasticsearch;
    if (amazonElasticsearchValue != null) {
      map['amazonElasticsearch'] = amazonElasticsearchValue.toMap();
    }
    final athenaValue = athena;
    if (athenaValue != null) {
      map['athena'] = athenaValue.toMap();
    }
    final auroraValue = aurora;
    if (auroraValue != null) {
      map['aurora'] = auroraValue.toMap();
    }
    final auroraPostgresqlValue = auroraPostgresql;
    if (auroraPostgresqlValue != null) {
      map['auroraPostgresql'] = auroraPostgresqlValue.toMap();
    }
    final awsIotAnalyticsValue = awsIotAnalytics;
    if (awsIotAnalyticsValue != null) {
      map['awsIotAnalytics'] = awsIotAnalyticsValue.toMap();
    }
    final databricksValue = databricks;
    if (databricksValue != null) {
      map['databricks'] = databricksValue.toMap();
    }
    final jiraValue = jira;
    if (jiraValue != null) {
      map['jira'] = jiraValue.toMap();
    }
    final mariaDbValue = mariaDb;
    if (mariaDbValue != null) {
      map['mariaDb'] = mariaDbValue.toMap();
    }
    final mysqlValue = mysql;
    if (mysqlValue != null) {
      map['mysql'] = mysqlValue.toMap();
    }
    final oracleValue = oracle;
    if (oracleValue != null) {
      map['oracle'] = oracleValue.toMap();
    }
    final postgresqlValue = postgresql;
    if (postgresqlValue != null) {
      map['postgresql'] = postgresqlValue.toMap();
    }
    final prestoValue = presto;
    if (prestoValue != null) {
      map['presto'] = prestoValue.toMap();
    }
    final rdsValue = rds;
    if (rdsValue != null) {
      map['rds'] = rdsValue.toMap();
    }
    ...
    if (sparkValue != null) {
      map['spark'] = sparkValue.toMap();
    }
    final sqlServerValue = sqlServer;
    if (sqlServerValue != null) {
      map['sqlServer'] = sqlServerValue.toMap();
    }
    final teradataValue = teradata;
    if (teradataValue != null) {
      map['teradata'] = teradataValue.toMap();
    }
    final twitterValue = twitter;
    if (twitterValue != null) {
      map['twitter'] = twitterValue.toMap();
    }
    return map;
  }
  ...
  factory DataSourceParameters.fromMap(Map<String, dynamic> map) {
    return DataSourceParameters(
      amazonElasticsearch: map['amazonElasticsearch'] == null
          ? null
          : DataSourceParametersAmazonElasticsearch.fromMap(
              (map['amazonElasticsearch'] as Map).cast<String, dynamic>()),
      athena: map['athena'] == null
          ? null
          : DataSourceParametersAthena.fromMap(
              (map['athena'] as Map).cast<String, dynamic>()),
      aurora: map['aurora'] == null
          ? null
          : DataSourceParametersAurora.fromMap(
              (map['aurora'] as Map).cast<String, dynamic>()),
      auroraPostgresql: map['auroraPostgresql'] == null
          ? null
          : DataSourceParametersAuroraPostgresql.fromMap(
              (map['auroraPostgresql'] as Map).cast<String, dynamic>()),
      awsIotAnalytics: map['awsIotAnalytics'] == null
          ? null
          : DataSourceParametersAwsIotAnalytics.fromMap(
              (map['awsIotAnalytics'] as Map).cast<String, dynamic>()),
      databricks: map['databricks'] == null
          ? null
          : DataSourceParametersDatabricks.fromMap(
              (map['databricks'] as Map).cast<String, dynamic>()),
      jira: map['jira'] == null
          ? null
          : DataSourceParametersJira.fromMap(
              (map['jira'] as Map).cast<String, dynamic>()),
      mariaDb: map['mariaDb'] == null
          ? null
          : DataSourceParametersMariaDb.fromMap(
              (map['mariaDb'] as Map).cast<String, dynamic>()),
      mysql: map['mysql'] == null
          ? null
          : DataSourceParametersMysql.fromMap(
              (map['mysql'] as Map).cast<String, dynamic>()),
      oracle: map['oracle'] == null
          ? null
          : DataSourceParametersOracle.fromMap(
              (map['oracle'] as Map).cast<String, dynamic>()),
      postgresql: map['postgresql'] == null
          ? null
          : DataSourceParametersPostgresql.fromMap(
              (map['postgresql'] as Map).cast<String, dynamic>()),
      presto: map['presto'] == null
          ? null
          : DataSourceParametersPresto.fromMap(
              (map['presto'] as Map).cast<String, dynamic>()),
      rds: map['rds'] == null
          ? null
          : DataSourceParametersRds.fromMap(
              (map['rds'] as Map).cast<String, dynamic>()),
      redshift: map['redshift'] == null
          ? null
          : DataSourceParametersRedshift.fromMap(
              (map['redshift'] as Map).cast<String, dynamic>()),
      s3: map['s3'] == null
          ? null
          : DataSourceParametersS3.fromMap(
              (map['s3'] as Map).cast<String, dynamic>()),
      serviceNow: map['serviceNow'] == null
          ? null
          : DataSourceParametersServiceNow.fromMap(
              (map['serviceNow'] as Map).cast<String, dynamic>()),
      snowflake: map['snowflake'] == null
          ? null
          : DataSourceParametersSnowflake.fromMap(
              (map['snowflake'] as Map).cast<String, dynamic>()),
      spark: map['spark'] == null
          ? null
          : DataSourceParametersSpark.fromMap(
              (map['spark'] as Map).cast<String, dynamic>()),
      sqlServer: map['sqlServer'] == null
          ? null
          : DataSourceParametersSqlServer.fromMap(
              (map['sqlServer'] as Map).cast<String, dynamic>()),
      teradata: map['teradata'] == null
          ? null
          : DataSourceParametersTeradata.fromMap(
              (map['teradata'] as Map).cast<String, dynamic>()),
      twitter: map['twitter'] == null
          ? null
          : DataSourceParametersTwitter.fromMap(
              (map['twitter'] as Map).cast<String, dynamic>()),
    );
  }
}
