...
class CustomPermissionsCapabilities {
  ...
  factory CustomPermissionsCapabilities.fromMap(Map<String, dynamic> map) {
    return CustomPermissionsCapabilities(
      addOrRunAnomalyDetectionForAnalyses: map['addOrRunAnomalyDetectionForAnalyses'] == null ? null : map['addOrRunAnomalyDetectionForAnalyses'] as String,
      createAndUpdateDashboardEmailReports: map['createAndUpdateDashboardEmailReports'] == null ? null : map['createAndUpdateDashboardEmailReports'] as String,
      createAndUpdateDataSources: map['createAndUpdateDataSources'] == null ? null : map['createAndUpdateDataSources'] as String,
      createAndUpdateDatasets: map['createAndUpdateDatasets'] == null ? null : map['createAndUpdateDatasets'] as String,
      createAndUpdateThemes: map['createAndUpdateThemes'] == null ? null : map['createAndUpdateThemes'] as String,
      createAndUpdateThresholdAlerts: map['createAndUpdateThresholdAlerts'] == null ? null : map['createAndUpdateThresholdAlerts'] as String,
      createSharedFolders: map['createSharedFolders'] == null ? null : map['createSharedFolders'] as String,
      createSpiceDataset: map['createSpiceDataset'] == null ? null : map['createSpiceDataset'] as String,
      exportToCsv: map['exportToCsv'] == null ? null : map['exportToCsv'] as String,
      exportToCsvInScheduledReports: map['exportToCsvInScheduledReports'] == null ? null : map['exportToCsvInScheduledReports'] as String,
      exportToExcel: map['exportToExcel'] == null ? null : map['exportToExcel'] as String,
      exportToExcelInScheduledReports: map['exportToExcelInScheduledReports'] == null ? null : map['exportToExcelInScheduledReports'] as String,
      exportToPdf: map['exportToPdf'] == null ? null : map['exportToPdf'] as String,
      exportToPdfInScheduledReports: map['exportToPdfInScheduledReports'] == null ? null : map['exportToPdfInScheduledReports'] as String,
      includeContentInScheduledReportsEmail: map['includeContentInScheduledReportsEmail'] == null ? null : map['includeContentInScheduledReportsEmail'] as String,
      printReports: map['printReports'] == null ? null : map['printReports'] as String,
      renameSharedFolders: map['renameSharedFolders'] == null ? null : map['renameSharedFolders'] as String,
      shareAnalyses: map['shareAnalyses'] == null ? null : map['shareAnalyses'] as String,
      shareDashboards: map['shareDashboards'] == null ? null : map['shareDashboards'] as String,
      shareDataSources: map['shareDataSources'] == null ? null : map['shareDataSources'] as String,
      shareDatasets: map['shareDatasets'] == null ? null : map['shareDatasets'] as String,
      subscribeDashboardEmailReports: map['subscribeDashboardEmailReports'] == null ? null : map['subscribeDashboardEmailReports'] as String,
      viewAccountSpiceCapacity: map['viewAccountSpiceCapacity'] == null ? null : map['viewAccountSpiceCapacity'] as String,
    );
  }
}
