...
class DataSet extends pulumi.CustomResource {
  ...
  DataSet(
    ...
    this.columnGroups = registerOutput<List<DataSetColumnGroup>?>(
      'columnGroups',
    );
    ...
    this.fieldFolders = registerOutput<List<DataSetFieldFolder>?>(
      'fieldFolders',
    );
    this.importMode = registerOutput<String>('importMode');
    this.logicalTableMaps = registerOutput<List<DataSetLogicalTableMap>>(
      'logicalTableMaps',
    );
    this.name = registerOutput<String>('name');
    this.outputColumns = registerOutput<List<DataSetOutputColumn>>(
      'outputColumns',
    );
    this.permissions = registerOutput<List<DataSetPermission>?>('permissions');
    this.physicalTableMaps = registerOutput<List<DataSetPhysicalTableMap>?>(
      'physicalTableMaps',
    );
    this.refreshProperties = registerOutput<DataSetRefreshProperties?>(
      'refreshProperties',
    );
