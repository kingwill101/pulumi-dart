...
class DataSourceParametersS3 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'manifestFileLocation': manifestFileLocation.toMap(),
      'roleArn': ?roleArn,
    };
  }
  ...
  factory DataSourceParametersS3.fromMap(Map<String, dynamic> map) {
    return DataSourceParametersS3(
      manifestFileLocation: DataSourceParametersS3ManifestFileLocation.fromMap((map['manifestFileLocation'] as Map).cast<String, dynamic>()),
