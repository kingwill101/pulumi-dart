...
class PipelineArgs {
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      bufferOptions: map['bufferOptions'] == null ? null : PipelineBufferOptions.fromMap((map['bufferOptions'] as Map).cast<String, dynamic>()),
      encryptionAtRestOptions: map['encryptionAtRestOptions'] == null ? null : PipelineEncryptionAtRestOptions.fromMap((map['encryptionAtRestOptions'] as Map).cast<String, dynamic>()),
      logPublishingOptions: map['logPublishingOptions'] == null ? null : PipelineLogPublishingOptions.fromMap((map['logPublishingOptions'] as Map).cast<String, dynamic>()),
      ...
      pipelineRoleArn: map['pipelineRoleArn'] == null ? null : map['pipelineRoleArn'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : PipelineTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      vpcOptions: map['vpcOptions'] == null ? null : PipelineVpcOptions.fromMap((map['vpcOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
