...
class Pipeline extends pulumi.CustomResource {
  ...
  Pipeline(
    ...
    this.bufferOptions = registerOutput<PipelineBufferOptions?>(
      'bufferOptions',
    );
    ...
    this.ingestEndpointUrls = registerOutput<List<String>>(
      'ingestEndpointUrls',
    );
    this.logPublishingOptions = registerOutput<PipelineLogPublishingOptions?>(
    ...
    this.pipelineConfigurationBody = registerOutput<String>(
      'pipelineConfigurationBody',
    );
