...
class PlanArgs {
  ...
  factory PlanArgs.fromMap(Map<String, dynamic> map) {
    return PlanArgs(
      advancedBackupSettings: map['advancedBackupSettings'] == null ? null : pulumi.Input.decodeList<PlanAdvancedBackupSetting>(map['advancedBackupSettings'], (value) => PlanAdvancedBackupSetting.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      rules: pulumi.Input.decodeList<PlanRule>(map['rules'], (value) => PlanRule.fromMap((value as Map).cast<String, dynamic>())),
      scanSettings: map['scanSettings'] == null ? null : pulumi.Input.decodeList<PlanScanSetting>(map['scanSettings'], (value) => PlanScanSetting.fromMap((value as Map).cast<String, dynamic>())),
