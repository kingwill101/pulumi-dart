...
class GetFrameworkControl {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inputParameters': pulumi.Input.encodeList<GetFrameworkControlInputParameter, Map<String, dynamic>>(inputParameters, (value) => value.toMap()),
      'name': name,
      'scopes': pulumi.Input.encodeList<GetFrameworkControlScope, Map<String, dynamic>>(scopes, (value) => value.toMap()),
    };
  }

  factory GetFrameworkControl.fromMap(Map<String, dynamic> map) {
    return GetFrameworkControl(
      inputParameters: pulumi.Input.decodeList<GetFrameworkControlInputParameter>(map['inputParameters'], (value) => GetFrameworkControlInputParameter.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      scopes: pulumi.Input.decodeList<GetFrameworkControlScope>(map['scopes'], (value) => GetFrameworkControlScope.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
