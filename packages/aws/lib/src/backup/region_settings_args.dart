...
class RegionSettingsArgs {
  ...
  factory RegionSettingsArgs.fromMap(Map<String, dynamic> map) {
    return RegionSettingsArgs(
      ...
      resourceTypeManagementPreference: map['resourceTypeManagementPreference'] == null ? null : (map['resourceTypeManagementPreference'] as Map).cast<String, bool>(),
      resourceTypeOptInPreference: (map['resourceTypeOptInPreference'] as Map).cast<String, bool>(),
    );
  }
}
