...
class FrameworkArgs {
  ...
  FrameworkArgs({
    required List<FrameworkControl> controls,
    String? description,
    String? name,
    String? region,
  ...
  factory FrameworkArgs.fromMap(Map<String, dynamic> map) {
    return FrameworkArgs(
      controls: pulumi.Input.decodeList<FrameworkControl>(map['controls'], (value) => FrameworkControl.fromMap((value as Map).cast<String, dynamic>())),
