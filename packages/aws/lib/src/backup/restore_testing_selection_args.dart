...
class RestoreTestingSelectionArgs {
  ...
  RestoreTestingSelectionArgs({
    ...
    RestoreTestingSelectionProtectedResourceConditions? protectedResourceConditions,
    ...
    int? validationWindowHours,
      ...
      protectedResourceType = pulumi.Input.asInput<String>(protectedResourceType),
      region = pulumi.Input.asOptionalInput<String>(region),
      restoreMetadataOverrides = pulumi.Input.asOptionalInput<Map<String, String>>(restoreMetadataOverrides),
      restoreTestingPlanName = pulumi.Input.asInput<String>(restoreTestingPlanName),
  ...
  factory RestoreTestingSelectionArgs.fromMap(Map<String, dynamic> map) {
    return RestoreTestingSelectionArgs(
      ...
      protectedResourceArns: map['protectedResourceArns'] == null ? null : (map['protectedResourceArns'] as List).cast<String>(),
      protectedResourceConditions: map['protectedResourceConditions'] == null ? null : RestoreTestingSelectionProtectedResourceConditions.fromMap((map['protectedResourceConditions'] as Map).cast<String, dynamic>()),
      protectedResourceType: map['protectedResourceType'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      restoreMetadataOverrides: map['restoreMetadataOverrides'] == null ? null : (map['restoreMetadataOverrides'] as Map).cast<String, String>(),
      restoreTestingPlanName: map['restoreTestingPlanName'] as String,
      validationWindowHours: map['validationWindowHours'] == null ? null : map['validationWindowHours'] as int,
    );
  }
}
