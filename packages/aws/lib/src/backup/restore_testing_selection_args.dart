  ...
  RestoreTestingSelectionArgs({
    ...
    int? validationWindowHours,
        ...
        protectedResourceArns =
            pulumi.Input.asOptionalInput<List<String>>(protectedResourceArns),
        protectedResourceConditions = pulumi.Input.asOptionalInput<
                RestoreTestingSelectionProtectedResourceConditions>(
            protectedResourceConditions),
        protectedResourceType =
            pulumi.Input.asInput<String>(protectedResourceType),
        region = pulumi.Input.asOptionalInput<String>(region),
        restoreMetadataOverrides =
            pulumi.Input.asOptionalInput<Map<String, String>>(
                restoreMetadataOverrides),
        restoreTestingPlanName =
            pulumi.Input.asInput<String>(restoreTestingPlanName),
        validationWindowHours =
            pulumi.Input.asOptionalInput<int>(validationWindowHours);
