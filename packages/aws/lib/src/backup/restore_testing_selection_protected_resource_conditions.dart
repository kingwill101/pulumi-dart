...
class RestoreTestingSelectionProtectedResourceConditions {
  ...
  final List<RestoreTestingSelectionProtectedResourceConditionsStringEqual>? stringEquals;
  ...
  final List<RestoreTestingSelectionProtectedResourceConditionsStringNotEqual>? stringNotEquals;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'stringEquals': ?stringEquals == null ? null : pulumi.Input.encodeList<RestoreTestingSelectionProtectedResourceConditionsStringEqual, Map<String, dynamic>>(stringEquals!, (value) => value.toMap()),
      'stringNotEquals': ?stringNotEquals == null ? null : pulumi.Input.encodeList<RestoreTestingSelectionProtectedResourceConditionsStringNotEqual, Map<String, dynamic>>(stringNotEquals!, (value) => value.toMap()),
    };
  }
  ...
  factory RestoreTestingSelectionProtectedResourceConditions.fromMap(Map<String, dynamic> map) {
    return RestoreTestingSelectionProtectedResourceConditions(
      stringEquals: map['stringEquals'] == null ? null : pulumi.Input.decodeList<RestoreTestingSelectionProtectedResourceConditionsStringEqual>(map['stringEquals'], (value) => RestoreTestingSelectionProtectedResourceConditionsStringEqual.fromMap((value as Map).cast<String, dynamic>())),
      stringNotEquals: map['stringNotEquals'] == null ? null : pulumi.Input.decodeList<RestoreTestingSelectionProtectedResourceConditionsStringNotEqual>(map['stringNotEquals'], (value) => RestoreTestingSelectionProtectedResourceConditionsStringNotEqual.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
