...
class PlanRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'copyActions': ?copyActions == null ? null : pulumi.Input.encodeList<PlanRuleCopyAction, Map<String, dynamic>>(copyActions!, (value) => value.toMap()),
      ...
      'ruleName': ruleName,
      'scanActions': ?scanActions == null ? null : pulumi.Input.encodeList<PlanRuleScanAction, Map<String, dynamic>>(scanActions!, (value) => value.toMap()),
      'schedule': ?schedule,
  ...
  factory PlanRule.fromMap(Map<String, dynamic> map) {
    return PlanRule(
      completionWindow: map['completionWindow'] == null ? null : map['completionWindow'] as int,
      copyActions: map['copyActions'] == null ? null : pulumi.Input.decodeList<PlanRuleCopyAction>(map['copyActions'], (value) => PlanRuleCopyAction.fromMap((value as Map).cast<String, dynamic>())),
      enableContinuousBackup: map['enableContinuousBackup'] == null ? null : map['enableContinuousBackup'] as bool,
      lifecycle: map['lifecycle'] == null ? null : PlanRuleLifecycle.fromMap((map['lifecycle'] as Map).cast<String, dynamic>()),
      recoveryPointTags: map['recoveryPointTags'] == null ? null : (map['recoveryPointTags'] as Map).cast<String, String>(),
      ruleName: map['ruleName'] as String,
      scanActions: map['scanActions'] == null ? null : pulumi.Input.decodeList<PlanRuleScanAction>(map['scanActions'], (value) => PlanRuleScanAction.fromMap((value as Map).cast<String, dynamic>())),
      ...
      startWindow: map['startWindow'] == null ? null : map['startWindow'] as int,
      targetLogicallyAirGappedBackupVaultArn: map['targetLogicallyAirGappedBackupVaultArn'] == null ? null : map['targetLogicallyAirGappedBackupVaultArn'] as String,
