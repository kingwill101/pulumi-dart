...
class ReportPlanArgs {
  ...
  ReportPlanArgs({
    ...
    Map<String, String>? tags,
        ...
        reportDeliveryChannel =
            pulumi.Input.asInput<ReportPlanReportDeliveryChannel>(
                reportDeliveryChannel),
        reportSetting =
            pulumi.Input.asInput<ReportPlanReportSetting>(reportSetting),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['reportDeliveryChannel'] = pulumi.Input.mapInputValue<
        ReportPlanReportDeliveryChannel,
        Map<String, dynamic>>(reportDeliveryChannel, (value) => value.toMap());
    map['reportSetting'] = pulumi.Input.mapInputValue<ReportPlanReportSetting,
        Map<String, dynamic>>(reportSetting, (value) => value.toMap());
  ...
  factory ReportPlanArgs.fromMap(Map<String, dynamic> map) {
    return ReportPlanArgs(
      ...
      reportDeliveryChannel: ReportPlanReportDeliveryChannel.fromMap(
          (map['reportDeliveryChannel'] as Map).cast<String, dynamic>()),
      reportSetting: ReportPlanReportSetting.fromMap(
          (map['reportSetting'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null
          ? null
