...
class GetCoreNetworkPolicyDocumentSegment {
  ...
  factory GetCoreNetworkPolicyDocumentSegment.fromMap(Map<String, dynamic> map) {
    return GetCoreNetworkPolicyDocumentSegment(
      allowFilters: map['allowFilters'] == null ? null : (map['allowFilters'] as List).cast<String>(),
      denyFilters: map['denyFilters'] == null ? null : (map['denyFilters'] as List).cast<String>(),
      description: map['description'] == null ? null : map['description'] as String,
      edgeLocations: map['edgeLocations'] == null ? null : (map['edgeLocations'] as List).cast<String>(),
      isolateAttachments: map['isolateAttachments'] == null ? null : map['isolateAttachments'] as bool,
      name: map['name'] as String,
      requireAttachmentAcceptance: map['requireAttachmentAcceptance'] == null ? null : map['requireAttachmentAcceptance'] as bool,
    );
  }
}
