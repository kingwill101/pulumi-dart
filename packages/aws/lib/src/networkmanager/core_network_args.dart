...
class CoreNetworkArgs {
  ...
  CoreNetworkArgs({
    ...
    List<String>? basePolicyRegions,
    bool? createBasePolicy,
    String? description,
    required String globalNetworkId,
    Map<String, String>? tags,
  })  : basePolicyDocument =
            pulumi.Input.asOptionalInput<String>(basePolicyDocument),
        basePolicyRegions =
            pulumi.Input.asOptionalInput<List<String>>(basePolicyRegions),
  ...
  factory CoreNetworkArgs.fromMap(Map<String, dynamic> map) {
    return CoreNetworkArgs(
      basePolicyDocument: map['basePolicyDocument'] == null
          ? null
          : map['basePolicyDocument'] as String,
      basePolicyRegions: map['basePolicyRegions'] == null
          ? null
          : (map['basePolicyRegions'] as List).cast<String>(),
      createBasePolicy: map['createBasePolicy'] == null
          ? null
          : map['createBasePolicy'] as bool,
      description:
