...
/// {@template pulumi_timestreaminfluxdb_db_cluster_db_cluster_args_doc}
/// The set of arguments for DbCluster.
/// {@endtemplate}
/// {@macro pulumi_timestreaminfluxdb_db_cluster_db_cluster_args_doc}
class DbClusterArgs {
  ...
  DbClusterArgs({
    ...
    String? failoverMode,
    DbClusterLogDeliveryConfiguration? logDeliveryConfiguration,
    String? name,
    String? networkType,
    String? organization,
    String? password,
  ...
  factory DbClusterArgs.fromMap(Map<String, dynamic> map) {
    return DbClusterArgs(
      ...
      logDeliveryConfiguration: map['logDeliveryConfiguration'] == null ? null : DbClusterLogDeliveryConfiguration.fromMap((map['logDeliveryConfiguration'] as Map).cast<String, dynamic>()),
      ...
      timeouts: map['timeouts'] == null ? null : DbClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
