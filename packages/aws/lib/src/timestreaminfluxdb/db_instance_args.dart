...
class DbInstanceArgs {
  ...
  DbInstanceArgs({
    ...
    required List<String> vpcSubnetIds,
       ...
       vpcSecurityGroupIds = pulumi.Input.asInput<List<String>>(
         vpcSecurityGroupIds,
       ),
    ...
    return <String, dynamic>{
      ...
      'logDeliveryConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(logDeliveryConfiguration, (value) => value.toMap()),
      'name': ?name,
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      ...
      dbStorageType: map['dbStorageType'] == null
          ? null
          : map['dbStorageType'] as String,
