...
class DbInstanceArgs {
  ...
  DbInstanceArgs({
    ...
    required String dbInstanceType,
    String? dbParameterGroupIdentifier,
    String? dbStorageType,
    String? deploymentType,
    DbInstanceLogDeliveryConfiguration? logDeliveryConfiguration,
    String? name,
    String? networkType,
    ...
    DbInstanceTimeouts? timeouts,
    required String username,
    required List<String> vpcSecurityGroupIds,
    required List<String> vpcSubnetIds,
  }) :
      allocatedStorage = pulumi.Input.asInput<int>(allocatedStorage),
      bucket = pulumi.Input.asInput<String>(bucket),
      dbInstanceType = pulumi.Input.asInput<String>(dbInstanceType),
      ...
      vpcSecurityGroupIds = pulumi.Input.asInput<List<String>>(vpcSecurityGroupIds),
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      ...
      dbParameterGroupIdentifier: map['dbParameterGroupIdentifier'] == null ? null : map['dbParameterGroupIdentifier'] as String,
      dbStorageType: map['dbStorageType'] == null ? null : map['dbStorageType'] as String,
      deploymentType: map['deploymentType'] == null ? null : map['deploymentType'] as String,
      logDeliveryConfiguration: map['logDeliveryConfiguration'] == null ? null : DbInstanceLogDeliveryConfiguration.fromMap((map['logDeliveryConfiguration'] as Map).cast<String, dynamic>()),
      ...
      timeouts: map['timeouts'] == null ? null : DbInstanceTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
