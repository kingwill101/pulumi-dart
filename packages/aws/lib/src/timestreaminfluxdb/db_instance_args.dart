...
class DbInstanceArgs {
  ...
  DbInstanceArgs({
    ...
    required List<String> vpcSubnetIds,
        ...
        dbParameterGroupIdentifier =
            pulumi.Input.asOptionalInput<String>(dbParameterGroupIdentifier),
        ...
        vpcSecurityGroupIds =
            pulumi.Input.asInput<List<String>>(vpcSecurityGroupIds),
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      ...
      dbParameterGroupIdentifier: map['dbParameterGroupIdentifier'] == null
          ? null
          : map['dbParameterGroupIdentifier'] as String,
      dbStorageType:
          map['dbStorageType'] == null ? null : map['dbStorageType'] as String,
      deploymentType: map['deploymentType'] == null
          ? null
          : map['deploymentType'] as String,
      logDeliveryConfiguration: map['logDeliveryConfiguration'] == null
          ? null
          : DbInstanceLogDeliveryConfiguration.fromMap(
              (map['logDeliveryConfiguration'] as Map).cast<String, dynamic>()),
