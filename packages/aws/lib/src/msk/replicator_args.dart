...
class ReplicatorArgs {
  ...
  ReplicatorArgs({
    String? description,
    required List<ReplicatorKafkaCluster> kafkaClusters,
    String? region,
    required ReplicatorReplicationInfoList replicationInfoList,
    ...
    Map<String, String>? tags,
       ...
       replicationInfoList = pulumi
           .Input.asInput<ReplicatorReplicationInfoList>(replicationInfoList),
