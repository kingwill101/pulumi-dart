...
class ClusterArgs {
  ...
  ClusterArgs({
    required ClusterBrokerNodeGroupInfo brokerNodeGroupInfo,
    ClusterClientAuthentication? clientAuthentication,
    String? clusterName,
    ClusterConfigurationInfo? configurationInfo,
    ClusterEncryptionInfo? encryptionInfo,
    String? enhancedMonitoring,
    required String kafkaVersion,
    ClusterLoggingInfo? loggingInfo,
    required int numberOfBrokerNodes,
    ClusterOpenMonitoring? openMonitoring,
    ClusterRebalancing? rebalancing,
    String? region,
    String? storageMode,
    Map<String, String>? tags,
        ...
        configurationInfo =
            pulumi.Input.asOptionalInput<ClusterConfigurationInfo>(
                configurationInfo),
        encryptionInfo =
            pulumi.Input.asOptionalInput<ClusterEncryptionInfo>(encryptionInfo),
        enhancedMonitoring =
            pulumi.Input.asOptionalInput<String>(enhancedMonitoring),
        kafkaVersion = pulumi.Input.asInput<String>(kafkaVersion),
        loggingInfo =
            pulumi.Input.asOptionalInput<ClusterLoggingInfo>(loggingInfo),
        numberOfBrokerNodes = pulumi.Input.asInput<int>(numberOfBrokerNodes),
        openMonitoring =
            pulumi.Input.asOptionalInput<ClusterOpenMonitoring>(openMonitoring),
        rebalancing =
            pulumi.Input.asOptionalInput<ClusterRebalancing>(rebalancing),
