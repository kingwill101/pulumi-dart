...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.bootstrapBrokersPublicSaslIam = registerOutput<String>(
      'bootstrapBrokersPublicSaslIam',
    );
    this.bootstrapBrokersPublicSaslScram = registerOutput<String>(
      'bootstrapBrokersPublicSaslScram',
    );
    this.bootstrapBrokersPublicTls = registerOutput<String>(
      'bootstrapBrokersPublicTls',
    );
    this.bootstrapBrokersSaslIam = registerOutput<String>(
      'bootstrapBrokersSaslIam',
    );
    this.bootstrapBrokersSaslScram = registerOutput<String>(
      'bootstrapBrokersSaslScram',
    );
    this.bootstrapBrokersTls = registerOutput<String>('bootstrapBrokersTls');
    this.bootstrapBrokersVpcConnectivitySaslIam = registerOutput<String>(
      'bootstrapBrokersVpcConnectivitySaslIam',
    );
    this.bootstrapBrokersVpcConnectivitySaslScram = registerOutput<String>(
      'bootstrapBrokersVpcConnectivitySaslScram',
    );
    this.bootstrapBrokersVpcConnectivityTls = registerOutput<String>(
      'bootstrapBrokersVpcConnectivityTls',
    );
    this.brokerNodeGroupInfo = registerOutput<ClusterBrokerNodeGroupInfo>(
      'brokerNodeGroupInfo',
    );
    this.clientAuthentication = registerOutput<ClusterClientAuthentication?>(
      'clientAuthentication',
    );
    this.clusterName = registerOutput<String>('clusterName');
    this.clusterUuid = registerOutput<String>('clusterUuid');
    this.configurationInfo = registerOutput<ClusterConfigurationInfo?>(
      'configurationInfo',
    );
    this.currentVersion = registerOutput<String>('currentVersion');
    this.encryptionInfo = registerOutput<ClusterEncryptionInfo?>(
      'encryptionInfo',
    );
    ...
    this.openMonitoring = registerOutput<ClusterOpenMonitoring?>(
      'openMonitoring',
    );
    ...
    this.zookeeperConnectString = registerOutput<String>(
      'zookeeperConnectString',
    );
    this.zookeeperConnectStringTls = registerOutput<String>(
