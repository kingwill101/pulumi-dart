...
class ApplicationArgs {
  ...
  ApplicationArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<bool>(autoConfigEnabled),
        autoCreate = pulumi.Input.asOptionalInput<bool>(autoCreate),
        cweMonitorEnabled =
            pulumi.Input.asOptionalInput<bool>(cweMonitorEnabled),
        ...
        opsItemSnsTopicArn =
            pulumi.Input.asOptionalInput<String>(opsItemSnsTopicArn),
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      ...
      groupingType:
          map['groupingType'] == null ? null : map['groupingType'] as String,
