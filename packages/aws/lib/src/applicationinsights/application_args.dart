...
class ApplicationArgs {
  ...
  ApplicationArgs({
    ...
    Map<String, String>? tags,
  }) : autoConfigEnabled = pulumi.Input.asOptionalInput<bool>(
         autoConfigEnabled,
       ),
       autoCreate = pulumi.Input.asOptionalInput<bool>(autoCreate),
       cweMonitorEnabled = pulumi.Input.asOptionalInput<bool>(
         cweMonitorEnabled,
       ),
       ...
       opsItemSnsTopicArn = pulumi.Input.asOptionalInput<String>(
         opsItemSnsTopicArn,
       ),
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      autoConfigEnabled: map['autoConfigEnabled'] == null
          ? null
          : map['autoConfigEnabled'] as bool,
      autoCreate: map['autoCreate'] == null ? null : map['autoCreate'] as bool,
      cweMonitorEnabled: map['cweMonitorEnabled'] == null
          ? null
          : map['cweMonitorEnabled'] as bool,
      groupingType: map['groupingType'] == null
          ? null
          : map['groupingType'] as String,
      opsCenterEnabled: map['opsCenterEnabled'] == null
          ? null
          : map['opsCenterEnabled'] as bool,
      opsItemSnsTopicArn: map['opsItemSnsTopicArn'] == null
          ? null
          : map['opsItemSnsTopicArn'] as String,
