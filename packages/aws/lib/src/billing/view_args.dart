...
class ViewArgs {
  ...
  factory ViewArgs.fromMap(Map<String, dynamic> map) {
    return ViewArgs(
      dataFilterExpression: map['dataFilterExpression'] == null
          ? null
          : ViewDataFilterExpression.fromMap(
              (map['dataFilterExpression'] as Map).cast<String, dynamic>(),
            ),
      description: map['description'] == null
          ? null
          : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      sourceViews: map['sourceViews'] == null
          ? null
          : (map['sourceViews'] as List).cast<String>(),
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null
          ? null
          : ViewTimeouts.fromMap(
