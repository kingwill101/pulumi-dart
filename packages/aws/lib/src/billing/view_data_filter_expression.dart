...
class ViewDataFilterExpression {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tags': ?tags == null ? null : pulumi.Input.encodeList<ViewDataFilterExpressionTag, Map<String, dynamic>>(tags!, (value) => value.toMap()),
  ...
  factory ViewDataFilterExpression.fromMap(Map<String, dynamic> map) {
    return ViewDataFilterExpression(
      dimensions: map['dimensions'] == null ? null : ViewDataFilterExpressionDimensions.fromMap((map['dimensions'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<ViewDataFilterExpressionTag>(map['tags'], (value) => ViewDataFilterExpressionTag.fromMap((value as Map).cast<String, dynamic>())),
      timeRange: map['timeRange'] == null ? null : ViewDataFilterExpressionTimeRange.fromMap((map['timeRange'] as Map).cast<String, dynamic>()),
    );
  }
}
