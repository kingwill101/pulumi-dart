...
class GetDevEnvironmentResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'repositories': ?repositories == null ? null : pulumi.Input.encodeList<GetDevEnvironmentRepository, Map<String, dynamic>>(repositories!, (value) => value.toMap()),
      'spaceName': spaceName,
      'status': status,
  ...
  factory GetDevEnvironmentResult.fromMap(Map<String, dynamic> map) {
    return GetDevEnvironmentResult(
      ...
      repositories: map['repositories'] == null ? null : pulumi.Input.decodeList<GetDevEnvironmentRepository>(map['repositories'], (value) => GetDevEnvironmentRepository.fromMap((value as Map).cast<String, dynamic>())),
