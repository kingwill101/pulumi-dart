...
class DevEnvironment extends pulumi.CustomResource {
  ...
  DevEnvironment(
    ...
    this.inactivityTimeoutMinutes = registerOutput<int?>(
      'inactivityTimeoutMinutes',
    );
    this.instanceType = registerOutput<String>('instanceType');
    this.persistentStorage = registerOutput<DevEnvironmentPersistentStorage>(
      'persistentStorage',
    );
    this.projectName = registerOutput<String>('projectName');
    this.region = registerOutput<String>('region');
    this.repositories = registerOutput<List<DevEnvironmentRepository>?>(
      'repositories',
    );
