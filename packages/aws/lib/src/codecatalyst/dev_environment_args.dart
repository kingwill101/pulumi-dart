...
class DevEnvironmentArgs {
  ...
  factory DevEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return DevEnvironmentArgs(
      ...
      ides: DevEnvironmentIdes.fromMap((map['ides'] as Map).cast<String, dynamic>()),
      inactivityTimeoutMinutes: map['inactivityTimeoutMinutes'] == null ? null : map['inactivityTimeoutMinutes'] as int,
      instanceType: map['instanceType'] as String,
      persistentStorage: DevEnvironmentPersistentStorage.fromMap((map['persistentStorage'] as Map).cast<String, dynamic>()),
      projectName: map['projectName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      repositories: map['repositories'] == null ? null : pulumi.Input.decodeList<DevEnvironmentRepository>(map['repositories'], (value) => DevEnvironmentRepository.fromMap((value as Map).cast<String, dynamic>())),
