...
class DomainArgs {
  ...
  DomainArgs({
    ...
    DomainVpcOptions? vpcOptions,
        ...
        advancedOptions =
            pulumi.Input.asOptionalInput<Map<String, String>>(advancedOptions),
        ...
        autoTuneOptions = pulumi.Input.asOptionalInput<DomainAutoTuneOptions>(
            autoTuneOptions),
        clusterConfig =
            pulumi.Input.asOptionalInput<DomainClusterConfig>(clusterConfig),
        cognitoOptions =
            pulumi.Input.asOptionalInput<DomainCognitoOptions>(cognitoOptions),
        ...
        elasticsearchVersion =
            pulumi.Input.asOptionalInput<String>(elasticsearchVersion),
        encryptAtRest =
            pulumi.Input.asOptionalInput<DomainEncryptAtRest>(encryptAtRest),
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      elasticsearchVersion: map['elasticsearchVersion'] == null
          ? null
          : map['elasticsearchVersion'] as String,
