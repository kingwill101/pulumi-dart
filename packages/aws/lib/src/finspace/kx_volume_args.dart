...
class KxVolumeArgs {
  ...
  factory KxVolumeArgs.fromMap(Map<String, dynamic> map) {
    return KxVolumeArgs(
      ...
      nas1Configurations: map['nas1Configurations'] == null ? null : pulumi.Input.decodeList<KxVolumeNas1Configuration>(map['nas1Configurations'], (value) => KxVolumeNas1Configuration.fromMap((value as Map).cast<String, dynamic>())),
