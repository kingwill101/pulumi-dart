...
class KxClusterArgs {
  ...
  KxClusterArgs({
    ...
    required KxClusterVpcConfiguration vpcConfiguration,
       ...
       commandLineArguments = pulumi.Input.asOptionalInput<Map<String, String>>(
         commandLineArguments,
       ),
       databases = pulumi.Input.asOptionalInput<List<KxClusterDatabase>>(
         databases,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       environmentId = pulumi.Input.asInput<String>(environmentId),
       executionRole = pulumi.Input.asOptionalInput<String>(executionRole),
       initializationScript = pulumi.Input.asOptionalInput<String>(
       ...
       vpcConfiguration = pulumi.Input.asInput<KxClusterVpcConfiguration>(
         vpcConfiguration,
       );
    ...
    return <String, dynamic>{
      'autoScalingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(autoScalingConfiguration, (value) => value.toMap()),
      ...
      'capacityConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(capacityConfiguration, (value) => value.toMap()),
      'code':
          ?pulumi.Input.mapOptionalInputValue<
            KxClusterCode,
            Map<String, dynamic>
      ...
      'savedownStorageConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(savedownStorageConfiguration, (value) => value.toMap()),
      'scalingGroupConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            KxClusterScalingGroupConfiguration,
            Map<String, dynamic>
          >(scalingGroupConfiguration, (value) => value.toMap()),
      'tags': ?tags,
      'tickerplantLogConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<KxClusterTickerplantLogConfiguration>,
    ...
    return KxClusterArgs(
      ...
      scalingGroupConfiguration: map['scalingGroupConfiguration'] == null
          ...
          : KxClusterScalingGroupConfiguration.fromMap(
              (map['scalingGroupConfiguration'] as Map).cast<String, dynamic>(),
            ),
      tags: map['tags'] == null
          ? null
