...
class KxClusterArgs {
  ...
  final pulumi.Input<KxClusterAutoScalingConfiguration>?
  ...
  final pulumi.Input<List<KxClusterCacheStorageConfiguration>>?
  ...
  final pulumi.Input<KxClusterSavedownStorageConfiguration>?
      savedownStorageConfiguration;

  /// The structure that stores the configuration details of a scaling group.
  final pulumi.Input<KxClusterScalingGroupConfiguration>?
  ...
  final pulumi.Input<List<KxClusterTickerplantLogConfiguration>>?
  ...
  KxClusterArgs({
    ...
    required KxClusterVpcConfiguration vpcConfiguration,
            ...
            pulumi.Input.asOptionalInput<KxClusterAutoScalingConfiguration>(
                autoScalingConfiguration),
        availabilityZoneId =
            pulumi.Input.asOptionalInput<String>(availabilityZoneId),
        azMode = pulumi.Input.asInput<String>(azMode),
        cacheStorageConfigurations = pulumi.Input.asOptionalInput<
                List<KxClusterCacheStorageConfiguration>>(
            cacheStorageConfigurations),
        capacityConfiguration =
            pulumi.Input.asOptionalInput<KxClusterCapacityConfiguration>(
                capacityConfiguration),
        ...
        commandLineArguments =
            pulumi.Input.asOptionalInput<Map<String, String>>(
                commandLineArguments),
        databases =
            pulumi.Input.asOptionalInput<List<KxClusterDatabase>>(databases),
        description = pulumi.Input.asOptionalInput<String>(description),
        environmentId = pulumi.Input.asInput<String>(environmentId),
        executionRole = pulumi.Input.asOptionalInput<String>(executionRole),
        initializationScript =
            pulumi.Input.asOptionalInput<String>(initializationScript),
        name = pulumi.Input.asOptionalInput<String>(name),
        region = pulumi.Input.asOptionalInput<String>(region),
        releaseLabel = pulumi.Input.asInput<String>(releaseLabel),
        savedownStorageConfiguration =
            pulumi.Input.asOptionalInput<KxClusterSavedownStorageConfiguration>(
                savedownStorageConfiguration),
        scalingGroupConfiguration =
            pulumi.Input.asOptionalInput<KxClusterScalingGroupConfiguration>(
                scalingGroupConfiguration),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        tickerplantLogConfigurations = pulumi.Input.asOptionalInput<
                List<KxClusterTickerplantLogConfiguration>>(
            tickerplantLogConfigurations),
        type = pulumi.Input.asInput<String>(type),
        vpcConfiguration =
            pulumi.Input.asInput<KxClusterVpcConfiguration>(vpcConfiguration);

  Map<String, dynamic> toMap() {
    final map = <String, dynamic>{};
    final autoScalingConfigurationValue = autoScalingConfiguration;
    if (autoScalingConfigurationValue != null) {
      map['autoScalingConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (cacheStorageConfigurationsValue != null) {
      map['cacheStorageConfigurations'] = pulumi.Input.mapOptionalInputValue<
              List<KxClusterCacheStorageConfiguration>,
              List<Map<String, dynamic>>>(
          cacheStorageConfigurationsValue,
          (value) => pulumi.Input.encodeList<KxClusterCacheStorageConfiguration,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    final capacityConfigurationValue = capacityConfiguration;
    if (capacityConfigurationValue != null) {
      map['capacityConfiguration'] = pulumi.Input.mapOptionalInputValue<
              KxClusterCapacityConfiguration, Map<String, dynamic>>(
          capacityConfigurationValue, (value) => value.toMap());
    }
    final codeValue = code;
    if (codeValue != null) {
      map['code'] = pulumi.Input.mapOptionalInputValue<KxClusterCode,
          Map<String, dynamic>>(codeValue, (value) => value.toMap());
    }
    ...
    if (databasesValue != null) {
      map['databases'] = pulumi.Input.mapOptionalInputValue<
              List<KxClusterDatabase>, List<Map<String, dynamic>>>(
          databasesValue,
          (value) =>
              pulumi.Input.encodeList<KxClusterDatabase, Map<String, dynamic>>(
    ...
    if (savedownStorageConfigurationValue != null) {
      map['savedownStorageConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (scalingGroupConfigurationValue != null) {
      map['scalingGroupConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (tickerplantLogConfigurationsValue != null) {
      map['tickerplantLogConfigurations'] = pulumi.Input.mapOptionalInputValue<
              List<KxClusterTickerplantLogConfiguration>,
              List<Map<String, dynamic>>>(
  ...
  factory KxClusterArgs.fromMap(Map<String, dynamic> map) {
    return KxClusterArgs(
      autoScalingConfiguration: map['autoScalingConfiguration'] == null
          ? null
          : KxClusterAutoScalingConfiguration.fromMap(
              (map['autoScalingConfiguration'] as Map).cast<String, dynamic>()),
      availabilityZoneId: map['availabilityZoneId'] == null
          ? null
          : map['availabilityZoneId'] as String,
      azMode: map['azMode'] as String,
      cacheStorageConfigurations: map['cacheStorageConfigurations'] == null
          ? null
          : pulumi.Input.decodeList<KxClusterCacheStorageConfiguration>(
              map['cacheStorageConfigurations'],
              (value) => KxClusterCacheStorageConfiguration.fromMap(
                  (value as Map).cast<String, dynamic>())),
      capacityConfiguration: map['capacityConfiguration'] == null
          ? null
          : KxClusterCapacityConfiguration.fromMap(
              (map['capacityConfiguration'] as Map).cast<String, dynamic>()),
      code: map['code'] == null
          ? null
          : KxClusterCode.fromMap((map['code'] as Map).cast<String, dynamic>()),
      commandLineArguments: map['commandLineArguments'] == null
          ? null
          : (map['commandLineArguments'] as Map).cast<String, String>(),
      databases: map['databases'] == null
          ? null
          : pulumi.Input.decodeList<KxClusterDatabase>(
              map['databases'],
              (value) => KxClusterDatabase.fromMap(
                  (value as Map).cast<String, dynamic>())),
      description:
      ...
      initializationScript: map['initializationScript'] == null
          ? null
          : map['initializationScript'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      releaseLabel: map['releaseLabel'] as String,
      savedownStorageConfiguration: map['savedownStorageConfiguration'] == null
          ? null
          : KxClusterSavedownStorageConfiguration.fromMap(
              (map['savedownStorageConfiguration'] as Map)
                  .cast<String, dynamic>()),
      scalingGroupConfiguration: map['scalingGroupConfiguration'] == null
          ? null
          : KxClusterScalingGroupConfiguration.fromMap(
              (map['scalingGroupConfiguration'] as Map)
                  .cast<String, dynamic>()),
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      tickerplantLogConfigurations: map['tickerplantLogConfigurations'] == null
          ? null
          : pulumi.Input.decodeList<KxClusterTickerplantLogConfiguration>(
              map['tickerplantLogConfigurations'],
              (value) => KxClusterTickerplantLogConfiguration.fromMap(
                  (value as Map).cast<String, dynamic>())),
      type: map['type'] as String,
      vpcConfiguration: KxClusterVpcConfiguration.fromMap(
