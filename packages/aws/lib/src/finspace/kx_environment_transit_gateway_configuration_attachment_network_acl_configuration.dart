  ...
  factory KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfiguration.fromMap(
    ...
    return KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfiguration(
      ...
      icmpTypeCode: map['icmpTypeCode'] == null
          ? null
          : KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationIcmpTypeCode.fromMap(
              (map['icmpTypeCode'] as Map).cast<String, dynamic>(),
            ),
      portRange: map['portRange'] == null
          ? null
          : KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRange.fromMap(
              (map['portRange'] as Map).cast<String, dynamic>(),
            ),
