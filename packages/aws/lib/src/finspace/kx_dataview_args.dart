...
class KxDataviewArgs {
  ...
  factory KxDataviewArgs.fromMap(Map<String, dynamic> map) {
    return KxDataviewArgs(
      ...
      segmentConfigurations: map['segmentConfigurations'] == null ? null : pulumi.Input.decodeList<KxDataviewSegmentConfiguration>(map['segmentConfigurations'], (value) => KxDataviewSegmentConfiguration.fromMap((value as Map).cast<String, dynamic>())),
