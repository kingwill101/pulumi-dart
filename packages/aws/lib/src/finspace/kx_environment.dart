...
class KxEnvironment extends pulumi.CustomResource {
  ...
  KxEnvironment(
    ...
    this.customDnsConfigurations = registerOutput<List<KxEnvironmentCustomDnsConfiguration>?>('customDnsConfigurations');
    this.description = registerOutput<String?>('description');
    this.infrastructureAccountId = registerOutput<String>('infrastructureAccountId');
    ...
    this.transitGatewayConfiguration = registerOutput<KxEnvironmentTransitGatewayConfiguration?>('transitGatewayConfiguration');
  }
}
