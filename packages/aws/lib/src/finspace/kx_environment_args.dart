    ...
    return <String, dynamic>{
      ...
      'transitGatewayConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            KxEnvironmentTransitGatewayConfiguration,
            Map<String, dynamic>
          >(transitGatewayConfiguration, (value) => value.toMap()),
    };
  }

  factory KxEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return KxEnvironmentArgs(
      customDnsConfigurations: map['customDnsConfigurations'] == null
          ? null
          : pulumi.Input.decodeList<KxEnvironmentCustomDnsConfiguration>(
              map['customDnsConfigurations'],
              (value) => KxEnvironmentCustomDnsConfiguration.fromMap(
      ...
      transitGatewayConfiguration: map['transitGatewayConfiguration'] == null
          ? null
          : KxEnvironmentTransitGatewayConfiguration.fromMap(
              (map['transitGatewayConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
    );
  }
