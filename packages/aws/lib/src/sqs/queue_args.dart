...
class QueueArgs {
  ...
  QueueArgs({
    ...
    int? visibilityTimeoutSeconds,
            ...
            pulumi.Input.asOptionalInput<bool>(contentBasedDeduplication),
        deduplicationScope =
            pulumi.Input.asOptionalInput<String>(deduplicationScope),
        delaySeconds = pulumi.Input.asOptionalInput<int>(delaySeconds),
        fifoQueue = pulumi.Input.asOptionalInput<bool>(fifoQueue),
        fifoThroughputLimit =
            pulumi.Input.asOptionalInput<String>(fifoThroughputLimit),
        kmsDataKeyReusePeriodSeconds =
            pulumi.Input.asOptionalInput<int>(kmsDataKeyReusePeriodSeconds),
        ...
        messageRetentionSeconds =
            pulumi.Input.asOptionalInput<int>(messageRetentionSeconds),
        name = pulumi.Input.asOptionalInput<String>(name),
        namePrefix = pulumi.Input.asOptionalInput<String>(namePrefix),
        policy = pulumi.Input.asOptionalInput<String>(policy),
        receiveWaitTimeSeconds =
            pulumi.Input.asOptionalInput<int>(receiveWaitTimeSeconds),
        redriveAllowPolicy =
            pulumi.Input.asOptionalInput<String>(redriveAllowPolicy),
        redrivePolicy = pulumi.Input.asOptionalInput<String>(redrivePolicy),
        region = pulumi.Input.asOptionalInput<String>(region),
        sqsManagedSseEnabled =
            pulumi.Input.asOptionalInput<bool>(sqsManagedSseEnabled),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        visibilityTimeoutSeconds =
            pulumi.Input.asOptionalInput<int>(visibilityTimeoutSeconds);
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      ...
      delaySeconds:
          map['delaySeconds'] == null ? null : map['delaySeconds'] as int,
      ...
      maxMessageSize:
          map['maxMessageSize'] == null ? null : map['maxMessageSize'] as int,
