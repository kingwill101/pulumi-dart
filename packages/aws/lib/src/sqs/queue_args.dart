...
/// {@template pulumi_sqs_queue_queue_args_doc}
/// The set of arguments for Queue.
/// {@endtemplate}
/// {@macro pulumi_sqs_queue_queue_args_doc}
class QueueArgs {
  ...
  QueueArgs({
    ...
    int? visibilityTimeoutSeconds,
       ...
       deduplicationScope = pulumi.Input.asOptionalInput<String>(
         deduplicationScope,
       ),
       delaySeconds = pulumi.Input.asOptionalInput<int>(delaySeconds),
       fifoQueue = pulumi.Input.asOptionalInput<bool>(fifoQueue),
       fifoThroughputLimit = pulumi.Input.asOptionalInput<String>(
         fifoThroughputLimit,
       ),
       kmsDataKeyReusePeriodSeconds = pulumi.Input.asOptionalInput<int>(
       ...
       messageRetentionSeconds = pulumi.Input.asOptionalInput<int>(
         messageRetentionSeconds,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       namePrefix = pulumi.Input.asOptionalInput<String>(namePrefix),
       policy = pulumi.Input.asOptionalInput<String>(policy),
       receiveWaitTimeSeconds = pulumi.Input.asOptionalInput<int>(
         receiveWaitTimeSeconds,
       ),
       redriveAllowPolicy = pulumi.Input.asOptionalInput<String>(
         redriveAllowPolicy,
       ),
       redrivePolicy = pulumi.Input.asOptionalInput<String>(redrivePolicy),
       region = pulumi.Input.asOptionalInput<String>(region),
       sqsManagedSseEnabled = pulumi.Input.asOptionalInput<bool>(
         sqsManagedSseEnabled,
       ),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       visibilityTimeoutSeconds = pulumi.Input.asOptionalInput<int>(
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      ...
      deduplicationScope: map['deduplicationScope'] == null
          ? null
          : map['deduplicationScope'] as String,
      delaySeconds: map['delaySeconds'] == null
          ? null
          : map['delaySeconds'] as int,
      fifoQueue: map['fifoQueue'] == null ? null : map['fifoQueue'] as bool,
      fifoThroughputLimit: map['fifoThroughputLimit'] == null
          ? null
          : map['fifoThroughputLimit'] as String,
      ...
      maxMessageSize: map['maxMessageSize'] == null
          ? null
          : map['maxMessageSize'] as int,
      messageRetentionSeconds: map['messageRetentionSeconds'] == null
          ? null
          : map['messageRetentionSeconds'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null
          ? null
          : map['namePrefix'] as String,
      policy: map['policy'] == null ? null : map['policy'] as String,
      receiveWaitTimeSeconds: map['receiveWaitTimeSeconds'] == null
          ? null
          : map['receiveWaitTimeSeconds'] as int,
      redriveAllowPolicy: map['redriveAllowPolicy'] == null
          ? null
          : map['redriveAllowPolicy'] as String,
      redrivePolicy: map['redrivePolicy'] == null
          ? null
          : map['redrivePolicy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sqsManagedSseEnabled: map['sqsManagedSseEnabled'] == null
          ? null
          : map['sqsManagedSseEnabled'] as bool,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      visibilityTimeoutSeconds: map['visibilityTimeoutSeconds'] == null
          ? null
          : map['visibilityTimeoutSeconds'] as int,
    );
  }
}
