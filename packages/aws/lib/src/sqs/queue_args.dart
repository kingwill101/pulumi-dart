...
class QueueArgs {
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      ...
      maxMessageSize: map['maxMessageSize'] == null ? null : map['maxMessageSize'] as int,
      messageRetentionSeconds: map['messageRetentionSeconds'] == null ? null : map['messageRetentionSeconds'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      policy: map['policy'] == null ? null : map['policy'] as String,
      receiveWaitTimeSeconds: map['receiveWaitTimeSeconds'] == null ? null : map['receiveWaitTimeSeconds'] as int,
      redriveAllowPolicy: map['redriveAllowPolicy'] == null ? null : map['redriveAllowPolicy'] as String,
      redrivePolicy: map['redrivePolicy'] == null ? null : map['redrivePolicy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sqsManagedSseEnabled: map['sqsManagedSseEnabled'] == null ? null : map['sqsManagedSseEnabled'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      visibilityTimeoutSeconds: map['visibilityTimeoutSeconds'] == null ? null : map['visibilityTimeoutSeconds'] as int,
    );
  }
}
