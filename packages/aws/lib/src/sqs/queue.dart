...
class Queue extends pulumi.CustomResource {
  ...
  Queue(
    ...
    this.kmsDataKeyReusePeriodSeconds = registerOutput<int>('kmsDataKeyReusePeriodSeconds');
    this.kmsMasterKeyId = registerOutput<String?>('kmsMasterKeyId');
    this.maxMessageSize = registerOutput<int?>('maxMessageSize');
    this.messageRetentionSeconds = registerOutput<int?>('messageRetentionSeconds');
    this.name = registerOutput<String>('name');
    this.namePrefix = registerOutput<String>('namePrefix');
    this.policy = registerOutput<String>('policy');
    this.receiveWaitTimeSeconds = registerOutput<int?>('receiveWaitTimeSeconds');
    ...
    this.visibilityTimeoutSeconds = registerOutput<int?>('visibilityTimeoutSeconds');
  }
}
