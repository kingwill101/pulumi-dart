...
class CapacityProviderArgs {
  ...
  CapacityProviderArgs({
    List<CapacityProviderCapacityProviderScalingConfig>? capacityProviderScalingConfigs,
  ...
  factory CapacityProviderArgs.fromMap(Map<String, dynamic> map) {
    return CapacityProviderArgs(
      capacityProviderScalingConfigs: map['capacityProviderScalingConfigs'] == null ? null : pulumi.Input.decodeList<CapacityProviderCapacityProviderScalingConfig>(map['capacityProviderScalingConfigs'], (value) => CapacityProviderCapacityProviderScalingConfig.fromMap((value as Map).cast<String, dynamic>())),
      instanceRequirements: map['instanceRequirements'] == null ? null : pulumi.Input.decodeList<CapacityProviderInstanceRequirement>(map['instanceRequirements'], (value) => CapacityProviderInstanceRequirement.fromMap((value as Map).cast<String, dynamic>())),
      kmsKeyArn: map['kmsKeyArn'] == null ? null : map['kmsKeyArn'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      permissionsConfig: CapacityProviderPermissionsConfig.fromMap((map['permissionsConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : CapacityProviderTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      vpcConfig: CapacityProviderVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
