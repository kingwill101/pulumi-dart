...
class EventSourceMappingProvisionedPollerConfig {
  ...
  factory EventSourceMappingProvisionedPollerConfig.fromMap(Map<String, dynamic> map) {
    return EventSourceMappingProvisionedPollerConfig(
      maximumPollers: map['maximumPollers'] == null ? null : map['maximumPollers'] as int,
      minimumPollers: map['minimumPollers'] == null ? null : map['minimumPollers'] as int,
      pollerGroupName: map['pollerGroupName'] == null ? null : map['pollerGroupName'] as String,
    );
  }
}
