...
class EventSourceMappingSelfManagedKafkaEventSourceConfig {
  ...
  final EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfig? schemaRegistryConfig;
  ...
  factory EventSourceMappingSelfManagedKafkaEventSourceConfig.fromMap(Map<String, dynamic> map) {
    return EventSourceMappingSelfManagedKafkaEventSourceConfig(
      ...
      schemaRegistryConfig: map['schemaRegistryConfig'] == null ? null : EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfig.fromMap((map['schemaRegistryConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
