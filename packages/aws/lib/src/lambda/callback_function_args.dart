...
class CallbackFunctionArgs {
  ...
  CallbackFunctionArgs({
    ...
    FunctionVpcConfig? vpcConfig,
  }) : architectures = pulumi.Input.asOptionalInput<List<String>>(
         architectures,
       ),
       ...
       codePathOptions = pulumi.Input.asOptionalInput<CodePathOptions>(
         codePathOptions,
       ),
       codeSha256 = pulumi.Input.asOptionalInput<String>(codeSha256),
       codeSigningConfigArn = pulumi.Input.asOptionalInput<String>(
         codeSigningConfigArn,
       ),
       deadLetterConfig = pulumi
           .Input.asOptionalInput<FunctionDeadLetterConfig>(deadLetterConfig),
       ...
       ephemeralStorage = pulumi
           .Input.asOptionalInput<FunctionEphemeralStorage>(ephemeralStorage),
       fileSystemConfig = pulumi
           .Input.asOptionalInput<FunctionFileSystemConfig>(fileSystemConfig),
       imageConfig = pulumi.Input.asOptionalInput<FunctionImageConfig>(
         imageConfig,
       ),
  ...
  factory CallbackFunctionArgs.fromMap(Map<String, dynamic> map) {
    return CallbackFunctionArgs(
      ...
      callbackFactory: map['callbackFactory'] == null
          ? null
          : map['callbackFactory'],
      ...
      codeSha256: map['codeSha256'] == null
          ? null
          : map['codeSha256'] as String,
      ...
      layers: map['layers'] == null
          ? null
          : (map['layers'] as List).cast<String>(),
