...
class CallbackFunctionArgs {
  ...
  factory CallbackFunctionArgs.fromMap(Map<String, dynamic> map) {
    return CallbackFunctionArgs(
      ...
      callbackFactory: map['callbackFactory'] == null ? null : map['callbackFactory'],
      ...
      codePathOptions: map['codePathOptions'] == null ? null : CodePathOptions.fromMap((map['codePathOptions'] as Map).cast<String, dynamic>()),
      ...
      policies: map['policies'] == null ? null : (map['policies'] as Map).cast<String, String>(),
      ...
      runtime: map['runtime'] == null ? null : Runtime.fromValue(map['runtime'] as String),
