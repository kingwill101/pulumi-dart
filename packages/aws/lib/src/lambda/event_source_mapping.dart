...
class EventSourceMapping extends pulumi.CustomResource {
  ...
  EventSourceMapping(
    ...
    this.bisectBatchOnFunctionError = registerOutput<bool?>(
    ...
    this.filterCriteria = registerOutput<EventSourceMappingFilterCriteria?>(
      'filterCriteria',
    );
    this.functionArn = registerOutput<String>('functionArn');
    this.functionName = registerOutput<String>('functionName');
    this.functionResponseTypes = registerOutput<List<String>?>(
    ...
    this.maximumBatchingWindowInSeconds = registerOutput<int?>(
      'maximumBatchingWindowInSeconds',
    );
    this.maximumRecordAgeInSeconds = registerOutput<int>(
      'maximumRecordAgeInSeconds',
    );
    this.maximumRetryAttempts = registerOutput<int>('maximumRetryAttempts');
    this.metricsConfig = registerOutput<EventSourceMappingMetricsConfig?>(
      'metricsConfig',
    );
    ...
    this.scalingConfig = registerOutput<EventSourceMappingScalingConfig?>(
      'scalingConfig',
    );
    ...
    this.startingPositionTimestamp = registerOutput<String?>(
      'startingPositionTimestamp',
    );
    this.state = registerOutput<String>('state');
    this.stateTransitionReason = registerOutput<String>(
      'stateTransitionReason',
    );
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.topics = registerOutput<List<String>?>('topics');
    this.tumblingWindowInSeconds = registerOutput<int?>(
