...
class CapacityProviderTimeouts {
  ...
  /// Creates a new [CapacityProviderTimeouts].
  ...
  CapacityProviderTimeouts({this.create, this.delete, this.update});
  ...
  factory CapacityProviderTimeouts.fromMap(Map<String, dynamic> map) {
    return CapacityProviderTimeouts(
