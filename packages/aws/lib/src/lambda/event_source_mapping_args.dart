...
class EventSourceMappingArgs {
  ...
  EventSourceMappingArgs({
    ...
    int? tumblingWindowInSeconds,
        ...
        bisectBatchOnFunctionError =
            pulumi.Input.asOptionalInput<bool>(bisectBatchOnFunctionError),
        destinationConfig =
        ...
        functionResponseTypes =
            pulumi.Input.asOptionalInput<List<String>>(functionResponseTypes),
        kmsKeyArn = pulumi.Input.asOptionalInput<String>(kmsKeyArn),
        maximumBatchingWindowInSeconds =
            pulumi.Input.asOptionalInput<int>(maximumBatchingWindowInSeconds),
        maximumRecordAgeInSeconds =
            pulumi.Input.asOptionalInput<int>(maximumRecordAgeInSeconds),
        maximumRetryAttempts =
            pulumi.Input.asOptionalInput<int>(maximumRetryAttempts),
        metricsConfig =
            pulumi.Input.asOptionalInput<EventSourceMappingMetricsConfig>(
                metricsConfig),
        parallelizationFactor =
            pulumi.Input.asOptionalInput<int>(parallelizationFactor),
        ...
        sourceAccessConfigurations = pulumi.Input.asOptionalInput<
            ...
            sourceAccessConfigurations),
        startingPosition =
            pulumi.Input.asOptionalInput<String>(startingPosition),
        startingPositionTimestamp =
            pulumi.Input.asOptionalInput<String>(startingPositionTimestamp),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        topics = pulumi.Input.asOptionalInput<List<String>>(topics),
        tumblingWindowInSeconds =
            pulumi.Input.asOptionalInput<int>(tumblingWindowInSeconds);
  ...
  factory EventSourceMappingArgs.fromMap(Map<String, dynamic> map) {
    return EventSourceMappingArgs(
      ...
      topics:
          map['topics'] == null ? null : (map['topics'] as List).cast<String>(),
