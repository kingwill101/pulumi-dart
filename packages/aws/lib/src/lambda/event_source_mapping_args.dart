...
class EventSourceMappingArgs {
  ...
  EventSourceMappingArgs({
    EventSourceMappingAmazonManagedKafkaEventSourceConfig? amazonManagedKafkaEventSourceConfig,
    int? batchSize,
    ...
    EventSourceMappingSelfManagedKafkaEventSourceConfig? selfManagedKafkaEventSourceConfig,
    List<EventSourceMappingSourceAccessConfiguration>? sourceAccessConfigurations,
  ...
  factory EventSourceMappingArgs.fromMap(Map<String, dynamic> map) {
    return EventSourceMappingArgs(
      amazonManagedKafkaEventSourceConfig: map['amazonManagedKafkaEventSourceConfig'] == null ? null : EventSourceMappingAmazonManagedKafkaEventSourceConfig.fromMap((map['amazonManagedKafkaEventSourceConfig'] as Map).cast<String, dynamic>()),
      batchSize: map['batchSize'] == null ? null : map['batchSize'] as int,
      bisectBatchOnFunctionError: map['bisectBatchOnFunctionError'] == null ? null : map['bisectBatchOnFunctionError'] as bool,
      destinationConfig: map['destinationConfig'] == null ? null : EventSourceMappingDestinationConfig.fromMap((map['destinationConfig'] as Map).cast<String, dynamic>()),
      documentDbEventSourceConfig: map['documentDbEventSourceConfig'] == null ? null : EventSourceMappingDocumentDbEventSourceConfig.fromMap((map['documentDbEventSourceConfig'] as Map).cast<String, dynamic>()),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      eventSourceArn: map['eventSourceArn'] == null ? null : map['eventSourceArn'] as String,
      filterCriteria: map['filterCriteria'] == null ? null : EventSourceMappingFilterCriteria.fromMap((map['filterCriteria'] as Map).cast<String, dynamic>()),
      functionName: map['functionName'] as String,
      functionResponseTypes: map['functionResponseTypes'] == null ? null : (map['functionResponseTypes'] as List).cast<String>(),
      ...
      metricsConfig: map['metricsConfig'] == null ? null : EventSourceMappingMetricsConfig.fromMap((map['metricsConfig'] as Map).cast<String, dynamic>()),
      parallelizationFactor: map['parallelizationFactor'] == null ? null : map['parallelizationFactor'] as int,
      provisionedPollerConfig: map['provisionedPollerConfig'] == null ? null : EventSourceMappingProvisionedPollerConfig.fromMap((map['provisionedPollerConfig'] as Map).cast<String, dynamic>()),
      queues: map['queues'] == null ? null : map['queues'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      scalingConfig: map['scalingConfig'] == null ? null : EventSourceMappingScalingConfig.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>()),
      selfManagedEventSource: map['selfManagedEventSource'] == null ? null : EventSourceMappingSelfManagedEventSource.fromMap((map['selfManagedEventSource'] as Map).cast<String, dynamic>()),
      selfManagedKafkaEventSourceConfig: map['selfManagedKafkaEventSourceConfig'] == null ? null : EventSourceMappingSelfManagedKafkaEventSourceConfig.fromMap((map['selfManagedKafkaEventSourceConfig'] as Map).cast<String, dynamic>()),
      sourceAccessConfigurations: map['sourceAccessConfigurations'] == null ? null : pulumi.Input.decodeList<EventSourceMappingSourceAccessConfiguration>(map['sourceAccessConfigurations'], (value) => EventSourceMappingSourceAccessConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tumblingWindowInSeconds: map['tumblingWindowInSeconds'] == null ? null : map['tumblingWindowInSeconds'] as int,
    );
  }
}
