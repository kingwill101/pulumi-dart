...
class PermissionArgs {
  ...
  PermissionArgs({
    ...
    String? statementIdPrefix,
       ...
       eventSourceToken = pulumi.Input.asOptionalInput<String>(
         eventSourceToken,
       ),
       function = pulumi.Input.asInput<String>(function),
       functionUrlAuthType = pulumi.Input.asOptionalInput<String>(
         functionUrlAuthType,
       ),
       invokedViaFunctionUrl = pulumi.Input.asOptionalInput<bool>(
