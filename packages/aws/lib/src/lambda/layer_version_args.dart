...
class LayerVersionArgs {
  ...
  factory LayerVersionArgs.fromMap(Map<String, dynamic> map) {
    return LayerVersionArgs(
      ...
      compatibleArchitectures: map['compatibleArchitectures'] == null ? null : (map['compatibleArchitectures'] as List).cast<String>(),
      ...
      licenseInfo: map['licenseInfo'] == null ? null : map['licenseInfo'] as String,
