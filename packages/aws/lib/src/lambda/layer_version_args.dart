...
class LayerVersionArgs {
  ...
  LayerVersionArgs({
    ...
    String? sourceCodeHash,
        ...
        compatibleArchitectures =
            pulumi.Input.asOptionalInput<List<String>>(compatibleArchitectures),
        compatibleRuntimes =
            pulumi.Input.asOptionalInput<List<String>>(compatibleRuntimes),
  ...
  factory LayerVersionArgs.fromMap(Map<String, dynamic> map) {
    return LayerVersionArgs(
      ...
      licenseInfo:
          map['licenseInfo'] == null ? null : map['licenseInfo'] as String,
