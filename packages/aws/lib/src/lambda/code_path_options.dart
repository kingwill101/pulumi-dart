...
class CodePathOptions {
  ...
  factory CodePathOptions.fromMap(Map<String, dynamic> map) {
    return CodePathOptions(
      extraExcludePackages: map['extraExcludePackages'] == null ? null : (map['extraExcludePackages'] as List).cast<String>(),
      extraIncludePackages: map['extraIncludePackages'] == null ? null : (map['extraIncludePackages'] as List).cast<String>(),
      extraIncludePaths: map['extraIncludePaths'] == null ? null : (map['extraIncludePaths'] as List).cast<String>(),
    );
  }
}
