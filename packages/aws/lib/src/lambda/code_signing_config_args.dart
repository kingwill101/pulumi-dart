...
class CodeSigningConfigArgs {
  ...
  factory CodeSigningConfigArgs.fromMap(Map<String, dynamic> map) {
    return CodeSigningConfigArgs(
      allowedPublishers: CodeSigningConfigAllowedPublishers.fromMap((map['allowedPublishers'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      policies: map['policies'] == null ? null : CodeSigningConfigPolicies.fromMap((map['policies'] as Map).cast<String, dynamic>()),
