...
class TargetArgs {
  ...
  final Input<TargetSuspendedState>? suspendedState;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (suspendedStateValue != null) {
      map['suspendedState'] = Input.mapOptionalInputValue<TargetSuspendedState,
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      maxCapacity: Input.asInput<int>(map['maxCapacity']),
      minCapacity: Input.asInput<int>(map['minCapacity']),
      ...
      suspendedState:
          Input.asOptionalInput<TargetSuspendedState>(map['suspendedState']),
