...
import 'pipeline_opensearchingest_args.dart';
...
/// ```
class PipelineOpensearchingest extends pulumi.CustomResource {
  ...
  PipelineOpensearchingest(
    String name, {
    PipelineOpensearchingestArgs? args,
