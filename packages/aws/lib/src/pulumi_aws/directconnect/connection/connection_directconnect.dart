...
import 'connection_directconnect_args.dart';
...
/// ```
class ConnectionDirectconnect extends pulumi.CustomResource {
  ...
  ConnectionDirectconnect(
    String name, {
    ConnectionDirectconnectArgs? args,
