...
class GetConnectionDirectconnectResult {
  ...
  GetConnectionDirectconnectResult({
    required this.arn,
  ...
  factory GetConnectionDirectconnectResult.fromMap(Map<String, dynamic> map) {
    return GetConnectionDirectconnectResult(
