...
///
/// > **NOTE:** AWS allows a Direct Connect hosted transit virtual interface to be deleted from either the allocator's or accepter's side. However, this provider only allows the Direct Connect hosted transit virtual interface to be deleted from the allocator's side by removing the corresponding <span pulumi-lang-nodejs="`aws.directconnect.HostedTransitVirtualInterface`" pulumi-lang-dotnet="`aws.directconnect.HostedTransitVirtualInterface`" pulumi-lang-go="`directconnect.HostedTransitVirtualInterface`" pulumi-lang-python="`directconnect.HostedTransitVirtualInterface`" pulumi-lang-yaml="`aws.directconnect.HostedTransitVirtualInterface`" pulumi-lang-java="`aws.directconnect.HostedTransitVirtualInterface`">`aws.directconnect.HostedTransitVirtualInterface`</span> resource from your configuration. Removing a <span pulumi-lang-nodejs="`aws.directconnect.HostedTransitVirtualInterfaceAcceptor`" pulumi-lang-dotnet="`aws.directconnect.HostedTransitVirtualInterfaceAcceptor`" pulumi-lang-go="`directconnect.HostedTransitVirtualInterfaceAcceptor`" pulumi-lang-python="`directconnect.HostedTransitVirtualInterfaceAcceptor`" pulumi-lang-yaml="`aws.directconnect.HostedTransitVirtualInterfaceAcceptor`" pulumi-lang-java="`aws.directconnect.HostedTransitVirtualInterfaceAcceptor`">`aws.directconnect.HostedTransitVirtualInterfaceAcceptor`</span> resource from your configuration will remove it from your statefile and management, **but will not delete the Direct Connect virtual interface.**
///
/// ## Example Usage
///
