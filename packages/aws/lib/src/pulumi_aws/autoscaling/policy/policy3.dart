...
///
/// > **NOTE:** You may want to omit <span pulumi-lang-nodejs="`desiredCapacity`" pulumi-lang-dotnet="`DesiredCapacity`" pulumi-lang-go="`desiredCapacity`" pulumi-lang-python="`desired_capacity`" pulumi-lang-yaml="`desiredCapacity`" pulumi-lang-java="`desiredCapacity`">`desired_capacity`</span> attribute from attached <span pulumi-lang-nodejs="`aws.autoscaling.Group`" pulumi-lang-dotnet="`aws.autoscaling.Group`" pulumi-lang-go="`autoscaling.Group`" pulumi-lang-python="`autoscaling.Group`" pulumi-lang-yaml="`aws.autoscaling.Group`" pulumi-lang-java="`aws.autoscaling.Group`">`aws.autoscaling.Group`</span>
...
/// ## Import
///
/// Using `pulumi import`, import AutoScaling scaling policy using the role<span pulumi-lang-nodejs=" autoscalingGroupName " pulumi-lang-dotnet=" AutoscalingGroupName " pulumi-lang-go=" autoscalingGroupName " pulumi-lang-python=" autoscaling_group_name " pulumi-lang-yaml=" autoscalingGroupName " pulumi-lang-java=" autoscalingGroupName "> autoscaling_group_name </span>and name separated by `/`. For example:
///
/// ```sh
