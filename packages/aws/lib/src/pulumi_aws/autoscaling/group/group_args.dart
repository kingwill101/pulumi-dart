...
class GroupArgs {
  ...
  final Input<bool>? capacityRebalance;
  ...
  final Input<GroupCapacityReservationSpecification>?
  ...
  final Input<List<Metric>>? enabledMetrics;
  ...
  final Input<bool>? forceDeleteWarmPool;

  /// Time (in seconds) after instance comes into service before checking health.
  final Input<int>? healthCheckGracePeriod;
  ...
  final Input<GroupInstanceMaintenancePolicy>? instanceMaintenancePolicy;

  /// If this block is configured, start an
  /// [Instance Refresh](https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-instance-refresh.html)
  /// when this Auto Scaling Group is updated. Defined below.
  final Input<GroupInstanceRefresh>? instanceRefresh;

  /// Name of the launch configuration to use.
  final Input<String>? launchConfiguration;
  ...
  final Input<int>? maxInstanceLifetime;
  ...
  final Input<List<String>>? terminationPolicies;
  ...
  final Input<String>? waitForCapacityTimeout;
  ...
  final Input<GroupWarmPool>? warmPool;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (availabilityZoneDistributionValue != null) {
      map['availabilityZoneDistribution'] = Input.mapOptionalInputValue<
    ...
    if (enabledMetricsValue != null) {
      map['enabledMetrics'] =
          Input.mapOptionalInputValue<List<Metric>, List<String>>(
              enabledMetricsValue,
              (value) => Input.encodeList<Metric, String>(
    ...
    if (instanceRefreshValue != null) {
      map['instanceRefresh'] = Input.mapOptionalInputValue<GroupInstanceRefresh,
    ...
    if (launchTemplateValue != null) {
      map['launchTemplate'] = Input.mapOptionalInputValue<GroupLaunchTemplate,
    ...
    if (mixedInstancesPolicyValue != null) {
      map['mixedInstancesPolicy'] = Input.mapOptionalInputValue<
    ...
    if (tagsValue != null) {
      map['tags'] = Input.mapOptionalInputValue<List<GroupTag>,
              List<Map<String, dynamic>>>(
          tagsValue,
          (value) => Input.encodeList<GroupTag, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (trafficSourcesValue != null) {
      map['trafficSources'] = Input.mapOptionalInputValue<
              List<GroupTrafficSource>, List<Map<String, dynamic>>>(
          trafficSourcesValue,
          (value) => Input.encodeList<GroupTrafficSource, Map<String, dynamic>>(
              value, (value) => value.toMap()));
    }
    ...
    if (warmPoolValue != null) {
      map['warmPool'] =
          Input.mapOptionalInputValue<GroupWarmPool, Map<String, dynamic>>(
              warmPoolValue, (value) => value.toMap());
    }
    return map;
  }
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      availabilityZoneDistribution:
          Input.asOptionalInput<GroupAvailabilityZoneDistribution>(
              map['availabilityZoneDistribution']),
      availabilityZones:
          Input.asOptionalInput<List<String>>(map['availabilityZones']),
      capacityRebalance: Input.asOptionalInput<bool>(map['capacityRebalance']),
      capacityReservationSpecification:
          Input.asOptionalInput<GroupCapacityReservationSpecification>(
              map['capacityReservationSpecification']),
      context: Input.asOptionalInput<String>(map['context']),
      defaultCooldown: Input.asOptionalInput<int>(map['defaultCooldown']),
      defaultInstanceWarmup:
          Input.asOptionalInput<int>(map['defaultInstanceWarmup']),
      desiredCapacity: Input.asOptionalInput<int>(map['desiredCapacity']),
      desiredCapacityType:
          Input.asOptionalInput<String>(map['desiredCapacityType']),
      enabledMetrics:
          Input.asOptionalInput<List<Metric>>(map['enabledMetrics']),
      forceDelete: Input.asOptionalInput<bool>(map['forceDelete']),
      forceDeleteWarmPool:
          Input.asOptionalInput<bool>(map['forceDeleteWarmPool']),
      healthCheckGracePeriod:
          Input.asOptionalInput<int>(map['healthCheckGracePeriod']),
      healthCheckType: Input.asOptionalInput<String>(map['healthCheckType']),
      ignoreFailedScalingActivities:
          Input.asOptionalInput<bool>(map['ignoreFailedScalingActivities']),
      initialLifecycleHooks:
          Input.asOptionalInput<List<GroupInitialLifecycleHook>>(
              map['initialLifecycleHooks']),
      instanceMaintenancePolicy:
          Input.asOptionalInput<GroupInstanceMaintenancePolicy>(
              map['instanceMaintenancePolicy']),
      instanceRefresh:
          Input.asOptionalInput<GroupInstanceRefresh>(map['instanceRefresh']),
      launchConfiguration:
          Input.asOptionalInput<String>(map['launchConfiguration']),
      launchTemplate:
          Input.asOptionalInput<GroupLaunchTemplate>(map['launchTemplate']),
      loadBalancers: Input.asOptionalInput<List<String>>(map['loadBalancers']),
      maxInstanceLifetime:
          Input.asOptionalInput<int>(map['maxInstanceLifetime']),
      maxSize: Input.asInput<int>(map['maxSize']),
      metricsGranularity:
          Input.asOptionalInput<String>(map['metricsGranularity']),
      minElbCapacity: Input.asOptionalInput<int>(map['minElbCapacity']),
      minSize: Input.asInput<int>(map['minSize']),
      mixedInstancesPolicy: Input.asOptionalInput<GroupMixedInstancesPolicy>(
          map['mixedInstancesPolicy']),
      name: Input.asOptionalInput<String>(map['name']),
      namePrefix: Input.asOptionalInput<String>(map['namePrefix']),
      placementGroup: Input.asOptionalInput<String>(map['placementGroup']),
      protectFromScaleIn:
          Input.asOptionalInput<bool>(map['protectFromScaleIn']),
      region: Input.asOptionalInput<String>(map['region']),
      serviceLinkedRoleArn:
          Input.asOptionalInput<String>(map['serviceLinkedRoleArn']),
      suspendedProcesses:
          Input.asOptionalInput<List<String>>(map['suspendedProcesses']),
      tags: Input.asOptionalInput<List<GroupTag>>(map['tags']),
      targetGroupArns:
          Input.asOptionalInput<List<String>>(map['targetGroupArns']),
      terminationPolicies:
          Input.asOptionalInput<List<String>>(map['terminationPolicies']),
      trafficSources: Input.asOptionalInput<List<GroupTrafficSource>>(
          map['trafficSources']),
      vpcZoneIdentifiers:
          Input.asOptionalInput<List<String>>(map['vpcZoneIdentifiers']),
      waitForCapacityTimeout:
          Input.asOptionalInput<String>(map['waitForCapacityTimeout']),
      waitForElbCapacity: Input.asOptionalInput<int>(map['waitForElbCapacity']),
      warmPool: Input.asOptionalInput<GroupWarmPool>(map['warmPool']),
    );
  }
}
