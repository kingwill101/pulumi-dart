...
/// the <span pulumi-lang-nodejs="`initialLifecycleHook`" pulumi-lang-dotnet="`InitialLifecycleHook`" pulumi-lang-go="`initialLifecycleHook`" pulumi-lang-python="`initial_lifecycle_hook`" pulumi-lang-yaml="`initialLifecycleHook`" pulumi-lang-java="`initialLifecycleHook`">`initial_lifecycle_hook`</span> attribute from the
/// <span pulumi-lang-nodejs="`aws.autoscaling.Group`" pulumi-lang-dotnet="`aws.autoscaling.Group`" pulumi-lang-go="`autoscaling.Group`" pulumi-lang-python="`autoscaling.Group`" pulumi-lang-yaml="`aws.autoscaling.Group`" pulumi-lang-java="`aws.autoscaling.Group`">`aws.autoscaling.Group`</span>
/// resource, or via this one. Hooks added via this resource will not be added
/// until the autoscaling group has been created, and depending on your
/// capacity
/// settings, after the initial instances have been launched, creating unintended
/// behavior. If you need hooks to run on all instances, add them with
/// <span pulumi-lang-nodejs="`initialLifecycleHook`" pulumi-lang-dotnet="`InitialLifecycleHook`" pulumi-lang-go="`initialLifecycleHook`" pulumi-lang-python="`initial_lifecycle_hook`" pulumi-lang-yaml="`initialLifecycleHook`" pulumi-lang-java="`initialLifecycleHook`">`initial_lifecycle_hook`</span> in
/// <span pulumi-lang-nodejs="`aws.autoscaling.Group`" pulumi-lang-dotnet="`aws.autoscaling.Group`" pulumi-lang-go="`autoscaling.Group`" pulumi-lang-python="`autoscaling.Group`" pulumi-lang-yaml="`aws.autoscaling.Group`" pulumi-lang-java="`aws.autoscaling.Group`">`aws.autoscaling.Group`</span>,
...
/// ## Import
///
/// Using `pulumi import`, import AutoScaling Lifecycle Hooks using the role<span pulumi-lang-nodejs=" autoscalingGroupName " pulumi-lang-dotnet=" AutoscalingGroupName " pulumi-lang-go=" autoscalingGroupName " pulumi-lang-python=" autoscaling_group_name " pulumi-lang-yaml=" autoscalingGroupName " pulumi-lang-java=" autoscalingGroupName "> autoscaling_group_name </span>and name separated by `/`. For example:
///
/// ```sh
