...
import '../web_acl_rule_statement_sqli_match_statement_field_to_match_header_order/web_acl_rule_statement_sqli_match_statement_field_to_match_header_order.dart';
import '../web_acl_rule_statement_sqli_match_statement_field_to_match_ja3_fingerprint/web_acl_rule_statement_sqli_match_statement_field_to_match_ja3_fingerprint.dart';
import '../web_acl_rule_statement_sqli_match_statement_field_to_match_ja4_fingerprint/web_acl_rule_statement_sqli_match_statement_field_to_match_ja4_fingerprint.dart';
import '../web_acl_rule_statement_sqli_match_statement_field_to_match_json_body/web_acl_rule_statement_sqli_match_statement_field_to_match_json_body.dart';
import '../web_acl_rule_statement_sqli_match_statement_field_to_match_single_header/web_acl_rule_statement_sqli_match_statement_field_to_match_single_header.dart';
import '../web_acl_rule_statement_sqli_match_statement_field_to_match_single_query_argument/web_acl_rule_statement_sqli_match_statement_field_to_match_single_query_argument.dart';
import '../web_acl_rule_statement_sqli_match_statement_field_to_match_uri_fragment/web_acl_rule_statement_sqli_match_statement_field_to_match_uri_fragment.dart';
...
class WebAclRuleStatementSqliMatchStatementFieldToMatch {
  ...
  final List<WebAclRuleStatementSqliMatchStatementFieldToMatchHeaderOrder>?
      headerOrders;
  ...
  final WebAclRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint?
      ja3Fingerprint;
  ...
  final WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint?
      ja4Fingerprint;
  ...
  final WebAclRuleStatementSqliMatchStatementFieldToMatchSingleHeader?
      singleHeader;
  ...
  final WebAclRuleStatementSqliMatchStatementFieldToMatchSingleQueryArgument?
      singleQueryArgument;
  ...
  final WebAclRuleStatementSqliMatchStatementFieldToMatchUriFragment?
      uriFragment;
  ...
  factory WebAclRuleStatementSqliMatchStatementFieldToMatch.fromMap(
    ...
    return WebAclRuleStatementSqliMatchStatementFieldToMatch(
      ...
      body: map['body'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchBody.fromMap(
              (map['body'] as Map).cast<String, dynamic>()),
      cookies: map['cookies'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchCookies.fromMap(
      ...
      jsonBody: map['jsonBody'] == null
          ? null
          : WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBody.fromMap(
