...
import '../rule_group_rule_statement_byte_match_statement_field_to_match_body/rule_group_rule_statement_byte_match_statement_field_to_match_body.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_cookies/rule_group_rule_statement_byte_match_statement_field_to_match_cookies.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_header/rule_group_rule_statement_byte_match_statement_field_to_match_header.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_header_order/rule_group_rule_statement_byte_match_statement_field_to_match_header_order.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_ja3_fingerprint/rule_group_rule_statement_byte_match_statement_field_to_match_ja3_fingerprint.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_ja4_fingerprint/rule_group_rule_statement_byte_match_statement_field_to_match_ja4_fingerprint.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_json_body/rule_group_rule_statement_byte_match_statement_field_to_match_json_body.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_single_header/rule_group_rule_statement_byte_match_statement_field_to_match_single_header.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_single_query_argument/rule_group_rule_statement_byte_match_statement_field_to_match_single_query_argument.dart';
import '../rule_group_rule_statement_byte_match_statement_field_to_match_uri_fragment/rule_group_rule_statement_byte_match_statement_field_to_match_uri_fragment.dart';
...
class RuleGroupRuleStatementByteMatchStatementFieldToMatch {
  ...
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchBody? body;

  /// Inspect the cookies in the web request. See Cookies below for details.
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies? cookies;

  /// Inspect the request headers. See Header Order below for details.
  final List<RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderOrder>?
      headerOrders;

  /// Inspect the request headers. See Headers below for details.
  final List<RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader>?
      headers;

  /// Inspect the JA3 fingerprint. See `ja3_fingerprint` below for details.
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchJa3Fingerprint?
      ja3Fingerprint;

  /// Inspect the JA4 fingerprint. See `ja4_fingerprint` below for details.
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchJa4Fingerprint?
      ja4Fingerprint;

  /// Inspect the request body as JSON. See JSON Body for details.
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody? jsonBody;
  ...
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleHeader?
      singleHeader;

  /// Inspect a single query argument. See Single Query Argument below for details.
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleQueryArgument?
      singleQueryArgument;
  ...
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchUriFragment?
      uriFragment;
  ...
  factory RuleGroupRuleStatementByteMatchStatementFieldToMatch.fromMap(
    ...
    return RuleGroupRuleStatementByteMatchStatementFieldToMatch(
      ...
      body: map['body'] == null
          ? null
          : RuleGroupRuleStatementByteMatchStatementFieldToMatchBody.fromMap(
              (map['body'] as Map).cast<String, dynamic>()),
      cookies: map['cookies'] == null
          ? null
          : RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies.fromMap(
