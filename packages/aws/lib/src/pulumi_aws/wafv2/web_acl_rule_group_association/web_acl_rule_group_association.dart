...
///
/// !> **Warning:** Verify the rule names in your <span pulumi-lang-nodejs="`ruleActionOverride`" pulumi-lang-dotnet="`RuleActionOverride`" pulumi-lang-go="`ruleActionOverride`" pulumi-lang-python="`rule_action_override`" pulumi-lang-yaml="`ruleActionOverride`" pulumi-lang-java="`ruleActionOverride`">`rule_action_override`</span>s carefully. With managed rule groups, WAF silently ignores any override that uses an invalid rule name. With customer-owned rule groups, invalid rule names in your overrides will cause web ACL updates to fail. An invalid rule name is any name that doesn't exactly match the case-sensitive name of an existing rule in the rule group.
///
/// !> **Warning:** Using this resource will cause the associated Web ACL resource to show configuration drift in the <span pulumi-lang-nodejs="`rule`" pulumi-lang-dotnet="`Rule`" pulumi-lang-go="`rule`" pulumi-lang-python="`rule`" pulumi-lang-yaml="`rule`" pulumi-lang-java="`rule`">`rule`</span> argument unless you add `lifecycle {<span pulumi-lang-nodejs=" ignoreChanges " pulumi-lang-dotnet=" IgnoreChanges " pulumi-lang-go=" ignoreChanges " pulumi-lang-python=" ignore_changes " pulumi-lang-yaml=" ignoreChanges " pulumi-lang-java=" ignoreChanges "> ignore_changes </span>= [rule] }` to the Web ACL resource configuration. This is because this resource modifies the Web ACL's rules outside of the Web ACL resource's direct management.
///
