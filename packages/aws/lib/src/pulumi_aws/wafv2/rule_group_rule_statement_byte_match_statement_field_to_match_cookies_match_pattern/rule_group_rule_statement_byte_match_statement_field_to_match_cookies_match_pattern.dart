...
class RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern {
  ...
  factory RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern.fromMap(
      Map<String, dynamic> map) {
    return RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern(
      all: map['all'] == null
          ? null
