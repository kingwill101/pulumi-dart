...
class RuleGroupRule {
  /// The action that AWS WAF should take on a web request when it matches the rule's statement. Settings at the <span pulumi-lang-nodejs="`aws.wafv2.WebAcl`" pulumi-lang-dotnet="`aws.wafv2.WebAcl`" pulumi-lang-go="`wafv2.WebAcl`" pulumi-lang-python="`wafv2.WebAcl`" pulumi-lang-yaml="`aws.wafv2.WebAcl`" pulumi-lang-java="`aws.wafv2.WebAcl`">`aws.wafv2.WebAcl`</span> level can override the rule action setting. See Action below for details.
  ...
  /// The AWS WAF processing statement for the rule, for example <span pulumi-lang-nodejs="`byteMatchStatement`" pulumi-lang-dotnet="`ByteMatchStatement`" pulumi-lang-go="`byteMatchStatement`" pulumi-lang-python="`byte_match_statement`" pulumi-lang-yaml="`byteMatchStatement`" pulumi-lang-java="`byteMatchStatement`">`byte_match_statement`</span> or <span pulumi-lang-nodejs="`geoMatchStatement`" pulumi-lang-dotnet="`GeoMatchStatement`" pulumi-lang-go="`geoMatchStatement`" pulumi-lang-python="`geo_match_statement`" pulumi-lang-yaml="`geoMatchStatement`" pulumi-lang-java="`geoMatchStatement`">`geo_match_statement`</span>. See Statement below for details.
