...
import 'web_acl_wafv2_args.dart';
...
/// ```
class WebAclWafv2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebAclDefaultActionWafv2> defaultAction;
  ...
  late final pulumi.Output<List<WebAclRuleWafv2>?> rules;
  ...
  WebAclWafv2(
    ...
    this.defaultAction =
        registerOutput<WebAclDefaultActionWafv2>('defaultAction');
    ...
    this.rules = registerOutput<List<WebAclRuleWafv2>?>('rules');
