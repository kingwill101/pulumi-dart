...
import '../web_acl_rule_statement_regex_pattern_set_reference_statement_field_to_match_json_body_match_pattern/web_acl_rule_statement_regex_pattern_set_reference_statement_field_to_match_json_body_match_pattern.dart';

class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody {
  ...
  final WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPattern
      matchPattern;
  ...
  factory WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody.fromMap(
      Map<String, dynamic> map) {
    return WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody(
