...
class GetClusterResult5 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['clusterEndpoints'] =
        Input.encodeList<GetClusterClusterEndpoint, Map<String, dynamic>>(
            clusterEndpoints, (value) => value.toMap());
    ...
    map['shards'] = Input.encodeList<GetClusterShard, Map<String, dynamic>>(
  ...
  factory GetClusterResult5.fromMap(Map<String, dynamic> map) {
    return GetClusterResult5(
      ...
      clusterEndpoints: Input.decodeList<GetClusterClusterEndpoint>(
          map['clusterEndpoints'],
      ...
      shards: Input.decodeList<GetClusterShard>(
          map['shards'],
          (value) =>
