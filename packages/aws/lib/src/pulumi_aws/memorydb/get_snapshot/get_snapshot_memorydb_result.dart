...
class GetSnapshotMemorydbResult {
  /// ARN of the snapshot.
  final String arn;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['arn'] = arn;
    map['clusterConfigurations'] = pulumi.Input.encodeList<
        GetSnapshotClusterConfiguration,
        Map<String, dynamic>>(clusterConfigurations, (value) => value.toMap());
  ...
  factory GetSnapshotMemorydbResult.fromMap(Map<String, dynamic> map) {
    return GetSnapshotMemorydbResult(
