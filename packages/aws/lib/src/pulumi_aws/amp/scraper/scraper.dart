...
///
/// You can use the data source <span pulumi-lang-nodejs="`awsPrometheusScraperConfiguration`" pulumi-lang-dotnet="`AwsPrometheusScraperConfiguration`" pulumi-lang-go="`awsPrometheusScraperConfiguration`" pulumi-lang-python="`aws_prometheus_scraper_configuration`" pulumi-lang-yaml="`awsPrometheusScraperConfiguration`" pulumi-lang-java="`awsPrometheusScraperConfiguration`">`aws_prometheus_scraper_configuration`</span> to use a
...
/// changes with <span pulumi-lang-nodejs="`lifecycle`" pulumi-lang-dotnet="`Lifecycle`" pulumi-lang-go="`lifecycle`" pulumi-lang-python="`lifecycle`" pulumi-lang-yaml="`lifecycle`" pulumi-lang-java="`lifecycle`">`lifecycle`</span>. See example below.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
