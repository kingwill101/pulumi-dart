...
class ListenerDefaultActionFixedResponseLb {
  ...
  ListenerDefaultActionFixedResponseLb({
  ...
  factory ListenerDefaultActionFixedResponseLb.fromMap(
      Map<String, dynamic> map) {
    return ListenerDefaultActionFixedResponseLb(
