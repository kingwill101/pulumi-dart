...
class ListenerDefaultActionAuthenticateOidcLb {
  ...
  ListenerDefaultActionAuthenticateOidcLb({
  ...
  factory ListenerDefaultActionAuthenticateOidcLb.fromMap(
      Map<String, dynamic> map) {
    return ListenerDefaultActionAuthenticateOidcLb(
      authenticationRequestExtraParams:
