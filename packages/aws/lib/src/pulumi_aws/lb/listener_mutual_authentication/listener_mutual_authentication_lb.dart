...
class ListenerMutualAuthenticationLb {
  ...
  ListenerMutualAuthenticationLb({
  ...
  factory ListenerMutualAuthenticationLb.fromMap(Map<String, dynamic> map) {
    return ListenerMutualAuthenticationLb(
