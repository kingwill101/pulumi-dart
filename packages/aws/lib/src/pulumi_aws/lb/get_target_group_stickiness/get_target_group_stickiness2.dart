...
class GetTargetGroupStickiness2 {
  final int cookieDuration;
  final String cookieName;
  final bool enabled;
  final String type;

  GetTargetGroupStickiness2({
  ...
  factory GetTargetGroupStickiness2.fromMap(Map<String, dynamic> map) {
    return GetTargetGroupStickiness2(
