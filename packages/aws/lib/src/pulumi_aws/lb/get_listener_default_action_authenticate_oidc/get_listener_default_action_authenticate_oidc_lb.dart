...
class GetListenerDefaultActionAuthenticateOidcLb {
  ...
  factory GetListenerDefaultActionAuthenticateOidcLb.fromMap(
      Map<String, dynamic> map) {
    return GetListenerDefaultActionAuthenticateOidcLb(
