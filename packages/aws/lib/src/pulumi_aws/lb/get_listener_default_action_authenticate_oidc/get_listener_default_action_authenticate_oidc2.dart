...
class GetListenerDefaultActionAuthenticateOidc2 {
  ...
  factory GetListenerDefaultActionAuthenticateOidc2.fromMap(
      Map<String, dynamic> map) {
    return GetListenerDefaultActionAuthenticateOidc2(
