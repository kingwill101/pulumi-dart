...
class GetTargetGroupHealthCheckLb {
  final bool enabled;
  ...
  factory GetTargetGroupHealthCheckLb.fromMap(Map<String, dynamic> map) {
    return GetTargetGroupHealthCheckLb(
