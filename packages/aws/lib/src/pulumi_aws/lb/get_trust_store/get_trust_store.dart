...
/// > **Note:** <span pulumi-lang-nodejs="`awsAlbTrustStore`" pulumi-lang-dotnet="`AwsAlbTrustStore`" pulumi-lang-go="`awsAlbTrustStore`" pulumi-lang-python="`aws_alb_trust_store`" pulumi-lang-yaml="`awsAlbTrustStore`" pulumi-lang-java="`awsAlbTrustStore`">`aws_alb_trust_store`</span> is known as <span pulumi-lang-nodejs="`aws.lb.TrustStore`" pulumi-lang-dotnet="`aws.lb.TrustStore`" pulumi-lang-go="`lb.TrustStore`" pulumi-lang-python="`lb.TrustStore`" pulumi-lang-yaml="`aws.lb.TrustStore`" pulumi-lang-java="`aws.lb.TrustStore`">`aws.lb.TrustStore`</span>. The functionality is identical.
///
