...
class ListenerRuleTransformUrlRewriteConfigRewriteLb {
  ...
  ListenerRuleTransformUrlRewriteConfigRewriteLb({
    required this.regex,
  ...
  factory ListenerRuleTransformUrlRewriteConfigRewriteLb.fromMap(
      Map<String, dynamic> map) {
    return ListenerRuleTransformUrlRewriteConfigRewriteLb(
