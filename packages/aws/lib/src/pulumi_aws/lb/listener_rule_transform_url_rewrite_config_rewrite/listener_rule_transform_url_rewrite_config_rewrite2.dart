...
class ListenerRuleTransformUrlRewriteConfigRewrite2 {
  ...
  ListenerRuleTransformUrlRewriteConfigRewrite2({
    required this.regex,
  ...
  factory ListenerRuleTransformUrlRewriteConfigRewrite2.fromMap(
      Map<String, dynamic> map) {
    return ListenerRuleTransformUrlRewriteConfigRewrite2(
