...
class ListenerDefaultActionAuthenticateCognito2 {
  ...
  ListenerDefaultActionAuthenticateCognito2({
  ...
  factory ListenerDefaultActionAuthenticateCognito2.fromMap(
      Map<String, dynamic> map) {
    return ListenerDefaultActionAuthenticateCognito2(
      authenticationRequestExtraParams:
