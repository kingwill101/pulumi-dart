...
class LoadBalancerArgs3 {
  /// Access Logs block. See below.
  final Input<LoadBalancerAccessLogs3>? accessLogs;
  ...
  final Input<LoadBalancerConnectionLogs2>? connectionLogs;
  ...
  final Input<LoadBalancerHealthCheckLogs2>? healthCheckLogs;
  ...
  final Input<LoadBalancerIpamPools2>? ipamPools;
  ...
  final Input<LoadBalancerMinimumLoadBalancerCapacity2>?
  ...
  final Input<List<LoadBalancerSubnetMapping2>>? subnetMappings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessLogsValue != null) {
      map['accessLogs'] = Input.mapOptionalInputValue<LoadBalancerAccessLogs3,
    ...
    if (ipamPoolsValue != null) {
      map['ipamPools'] = Input.mapOptionalInputValue<LoadBalancerIpamPools2,
    ...
    if (minimumLoadBalancerCapacityValue != null) {
      map['minimumLoadBalancerCapacity'] = Input.mapOptionalInputValue<
              LoadBalancerMinimumLoadBalancerCapacity2, Map<String, dynamic>>(
    ...
    if (subnetMappingsValue != null) {
      map['subnetMappings'] = Input.mapOptionalInputValue<
              List<LoadBalancerSubnetMapping2>, List<Map<String, dynamic>>>(
          subnetMappingsValue,
          (value) => Input.encodeList<LoadBalancerSubnetMapping2,
  ...
  factory LoadBalancerArgs3.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs3(
      accessLogs:
          Input.asOptionalInput<LoadBalancerAccessLogs3>(map['accessLogs']),
      clientKeepAlive: Input.asOptionalInput<int>(map['clientKeepAlive']),
      connectionLogs: Input.asOptionalInput<LoadBalancerConnectionLogs2>(
          map['connectionLogs']),
      ...
      enforceSecurityGroupInboundRulesOnPrivateLinkTraffic:
          Input.asOptionalInput<String>(
              map['enforceSecurityGroupInboundRulesOnPrivateLinkTraffic']),
      healthCheckLogs: Input.asOptionalInput<LoadBalancerHealthCheckLogs2>(
          map['healthCheckLogs']),
      ...
      ipamPools:
          Input.asOptionalInput<LoadBalancerIpamPools2>(map['ipamPools']),
      loadBalancerType: Input.asOptionalInput<String>(map['loadBalancerType']),
      minimumLoadBalancerCapacity:
          Input.asOptionalInput<LoadBalancerMinimumLoadBalancerCapacity2>(
      ...
      subnetMappings: Input.asOptionalInput<List<LoadBalancerSubnetMapping2>>(
          map['subnetMappings']),
