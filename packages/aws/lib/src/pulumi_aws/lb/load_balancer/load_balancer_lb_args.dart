...
import '../load_balancer_access_logs/load_balancer_access_logs_lb.dart';
import '../load_balancer_connection_logs/load_balancer_connection_logs_lb.dart';
import '../load_balancer_health_check_logs/load_balancer_health_check_logs_lb.dart';
import '../load_balancer_ipam_pools/load_balancer_ipam_pools_lb.dart';
import '../load_balancer_minimum_load_balancer_capacity/load_balancer_minimum_load_balancer_capacity_lb.dart';
import '../load_balancer_subnet_mapping/load_balancer_subnet_mapping_lb.dart';

/// The set of arguments for LoadBalancer.
class LoadBalancerLbArgs {
  /// Access Logs block. See below.
  final pulumi.Input<LoadBalancerAccessLogsLb>? accessLogs;

  /// Client keep alive value in seconds. The valid range is 60-604800 seconds. The default is 3600 seconds.
  final pulumi.Input<int>? clientKeepAlive;

  /// Connection Logs block. See below. Only valid for Load Balancers of type `application`.
  final pulumi.Input<LoadBalancerConnectionLogsLb>? connectionLogs;
  ...
  final pulumi.Input<LoadBalancerHealthCheckLogsLb>? healthCheckLogs;
  ...
  final pulumi.Input<LoadBalancerIpamPoolsLb>? ipamPools;
  ...
  final pulumi.Input<LoadBalancerMinimumLoadBalancerCapacityLb>?
  ...
  final pulumi.Input<List<LoadBalancerSubnetMappingLb>>? subnetMappings;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (minimumLoadBalancerCapacityValue != null) {
      map['minimumLoadBalancerCapacity'] = pulumi.Input.mapOptionalInputValue<
              LoadBalancerMinimumLoadBalancerCapacityLb, Map<String, dynamic>>(
    ...
    if (subnetMappingsValue != null) {
      map['subnetMappings'] = pulumi.Input.mapOptionalInputValue<
              List<LoadBalancerSubnetMappingLb>, List<Map<String, dynamic>>>(
          subnetMappingsValue,
          (value) => pulumi.Input.encodeList<LoadBalancerSubnetMappingLb,
  ...
  factory LoadBalancerLbArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerLbArgs(
      accessLogs: pulumi.Input.asOptionalInput<LoadBalancerAccessLogsLb>(
          map['accessLogs']),
      clientKeepAlive:
          pulumi.Input.asOptionalInput<int>(map['clientKeepAlive']),
      connectionLogs:
          pulumi.Input.asOptionalInput<LoadBalancerConnectionLogsLb>(
              map['connectionLogs']),
      ...
      enforceSecurityGroupInboundRulesOnPrivateLinkTraffic:
          pulumi.Input.asOptionalInput<String>(
              map['enforceSecurityGroupInboundRulesOnPrivateLinkTraffic']),
      healthCheckLogs:
          pulumi.Input.asOptionalInput<LoadBalancerHealthCheckLogsLb>(
              map['healthCheckLogs']),
      ...
      ipamPools: pulumi.Input.asOptionalInput<LoadBalancerIpamPoolsLb>(
          map['ipamPools']),
      loadBalancerType:
      ...
      subnetMappings:
          pulumi.Input.asOptionalInput<List<LoadBalancerSubnetMappingLb>>(
              map['subnetMappings']),
