...
import 'load_balancer_lb_args.dart';
...
/// ```
class LoadBalancerLb extends pulumi.CustomResource {
  /// Access Logs block. See below.
  late final pulumi.Output<LoadBalancerAccessLogsLb?> accessLogs;
  ...
  late final pulumi.Output<LoadBalancerConnectionLogsLb?> connectionLogs;
  ...
  late final pulumi.Output<LoadBalancerHealthCheckLogsLb?> healthCheckLogs;
  ...
  late final pulumi.Output<LoadBalancerIpamPoolsLb?> ipamPools;
  ...
  late final pulumi.Output<LoadBalancerMinimumLoadBalancerCapacityLb?>
  ...
  late final pulumi.Output<List<LoadBalancerSubnetMappingLb>> subnetMappings;
  ...
  LoadBalancerLb(
    ...
    this.accessLogs = registerOutput<LoadBalancerAccessLogsLb?>('accessLogs');
    this.arn = registerOutput<String>('arn');
    this.arnSuffix = registerOutput<String>('arnSuffix');
    this.clientKeepAlive = registerOutput<int?>('clientKeepAlive');
    this.connectionLogs =
        registerOutput<LoadBalancerConnectionLogsLb?>('connectionLogs');
    ...
    this.healthCheckLogs =
        registerOutput<LoadBalancerHealthCheckLogsLb?>('healthCheckLogs');
    ...
    this.ipamPools = registerOutput<LoadBalancerIpamPoolsLb?>('ipamPools');
    this.loadBalancerType = registerOutput<String?>('loadBalancerType');
    this.minimumLoadBalancerCapacity =
        registerOutput<LoadBalancerMinimumLoadBalancerCapacityLb?>(
            'minimumLoadBalancerCapacity');
    ...
    this.subnetMappings =
        registerOutput<List<LoadBalancerSubnetMappingLb>>('subnetMappings');
