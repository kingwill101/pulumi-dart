...
class ListenerRuleConditionHttpHeaderLb {
  ...
  ListenerRuleConditionHttpHeaderLb({
  ...
  factory ListenerRuleConditionHttpHeaderLb.fromMap(Map<String, dynamic> map) {
    return ListenerRuleConditionHttpHeaderLb(
