...
class ListenerRuleActionAuthenticateOidcLb {
  ...
  ListenerRuleActionAuthenticateOidcLb({
  ...
  factory ListenerRuleActionAuthenticateOidcLb.fromMap(
      Map<String, dynamic> map) {
    return ListenerRuleActionAuthenticateOidcLb(
      authenticationRequestExtraParams:
