...
/// ```
class Listener3 extends CustomResource {
  ...
  late final Output<List<ListenerDefaultAction2>> defaultActions;
  ...
  late final Output<ListenerMutualAuthentication2> mutualAuthentication;
