...
class ListenerRuleActionFixedResponseLb {
  ...
  ListenerRuleActionFixedResponseLb({
  ...
  factory ListenerRuleActionFixedResponseLb.fromMap(Map<String, dynamic> map) {
    return ListenerRuleActionFixedResponseLb(
