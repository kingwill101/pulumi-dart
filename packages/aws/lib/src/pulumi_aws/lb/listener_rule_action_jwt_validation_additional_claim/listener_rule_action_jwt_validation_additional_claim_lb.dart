...
class ListenerRuleActionJwtValidationAdditionalClaimLb {
  ...
  factory ListenerRuleActionJwtValidationAdditionalClaimLb.fromMap(
      Map<String, dynamic> map) {
    return ListenerRuleActionJwtValidationAdditionalClaimLb(
