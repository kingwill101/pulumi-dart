...
class ListenerRuleActionJwtValidationAdditionalClaim2 {
  ...
  factory ListenerRuleActionJwtValidationAdditionalClaim2.fromMap(
      Map<String, dynamic> map) {
    return ListenerRuleActionJwtValidationAdditionalClaim2(
