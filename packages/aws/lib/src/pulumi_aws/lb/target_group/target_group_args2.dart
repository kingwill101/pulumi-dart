...
class TargetGroupArgs2 {
  ...
  final Input<TargetGroupHealthCheck2>? healthCheck;
  ...
  final Input<TargetGroupStickiness2>? stickiness;
  ...
  final Input<List<TargetGroupTargetFailover2>>? targetFailovers;

  /// Target health requirements block. See target_group_health for more information.
  final Input<TargetGroupTargetGroupHealth2>? targetGroupHealth;

  /// Target health state block. Only applicable for Network Load Balancer target groups when `protocol` is `TCP` or `TLS`. See target_health_state for more information.
  final Input<List<TargetGroupTargetHealthState2>>? targetHealthStates;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (healthCheckValue != null) {
      map['healthCheck'] = Input.mapOptionalInputValue<TargetGroupHealthCheck2,
    ...
    if (stickinessValue != null) {
      map['stickiness'] = Input.mapOptionalInputValue<TargetGroupStickiness2,
    ...
    if (targetFailoversValue != null) {
      map['targetFailovers'] = Input.mapOptionalInputValue<
              List<TargetGroupTargetFailover2>, List<Map<String, dynamic>>>(
          targetFailoversValue,
          (value) => Input.encodeList<TargetGroupTargetFailover2,
    ...
    if (targetGroupHealthValue != null) {
      map['targetGroupHealth'] = Input.mapOptionalInputValue<
              TargetGroupTargetGroupHealth2, Map<String, dynamic>>(
    ...
    if (targetHealthStatesValue != null) {
      map['targetHealthStates'] = Input.mapOptionalInputValue<
              List<TargetGroupTargetHealthState2>, List<Map<String, dynamic>>>(
          targetHealthStatesValue,
          (value) => Input.encodeList<TargetGroupTargetHealthState2,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
  ...
  factory TargetGroupArgs2.fromMap(Map<String, dynamic> map) {
    return TargetGroupArgs2(
      connectionTermination:
          Input.asOptionalInput<bool>(map['connectionTermination']),
      deregistrationDelay:
          Input.asOptionalInput<int>(map['deregistrationDelay']),
      healthCheck:
          Input.asOptionalInput<TargetGroupHealthCheck2>(map['healthCheck']),
      ...
      stickiness:
          Input.asOptionalInput<TargetGroupStickiness2>(map['stickiness']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      targetControlPort: Input.asOptionalInput<int>(map['targetControlPort']),
      targetFailovers: Input.asOptionalInput<List<TargetGroupTargetFailover2>>(
          map['targetFailovers']),
      targetGroupHealth: Input.asOptionalInput<TargetGroupTargetGroupHealth2>(
          map['targetGroupHealth']),
      targetHealthStates:
          Input.asOptionalInput<List<TargetGroupTargetHealthState2>>(
