...
import '../get_load_balancer_access_logs/get_load_balancer_access_logs3.dart';
import '../get_load_balancer_connection_log/get_load_balancer_connection_log2.dart';
import '../get_load_balancer_health_check_log/get_load_balancer_health_check_log2.dart';
import '../get_load_balancer_ipam_pool/get_load_balancer_ipam_pool2.dart';
import '../get_load_balancer_subnet_mapping/get_load_balancer_subnet_mapping2.dart';

/// Result data returned by getLoadBalancer.
class GetLoadBalancerResult3 {
  final GetLoadBalancerAccessLogs3 accessLogs;
  final String arn;
  final String arnSuffix;
  final int clientKeepAlive;
  final List<GetLoadBalancerConnectionLog2> connectionLogs;
  ...
  final List<GetLoadBalancerHealthCheckLog2> healthCheckLogs;
  ...
  final List<GetLoadBalancerIpamPool2> ipamPools;
  ...
  final List<GetLoadBalancerSubnetMapping2> subnetMappings;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['connectionLogs'] =
        Input.encodeList<GetLoadBalancerConnectionLog2, Map<String, dynamic>>(
    ...
    map['healthCheckLogs'] =
        Input.encodeList<GetLoadBalancerHealthCheckLog2, Map<String, dynamic>>(
    ...
    map['ipamPools'] =
        Input.encodeList<GetLoadBalancerIpamPool2, Map<String, dynamic>>(
    ...
    map['subnetMappings'] =
        Input.encodeList<GetLoadBalancerSubnetMapping2, Map<String, dynamic>>(
  ...
  factory GetLoadBalancerResult3.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerResult3(
      accessLogs: GetLoadBalancerAccessLogs3.fromMap(
          (map['accessLogs'] as Map).cast<String, dynamic>()),
      arn: map['arn'] as String,
      arnSuffix: map['arnSuffix'] as String,
      clientKeepAlive: map['clientKeepAlive'] as int,
      connectionLogs: Input.decodeList<GetLoadBalancerConnectionLog2>(
          map['connectionLogs'],
          (value) => GetLoadBalancerConnectionLog2.fromMap(
      ...
      healthCheckLogs: Input.decodeList<GetLoadBalancerHealthCheckLog2>(
          map['healthCheckLogs'],
          (value) => GetLoadBalancerHealthCheckLog2.fromMap(
              (value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      idleTimeout: map['idleTimeout'] as int,
      internal: map['internal'] as bool,
      ipAddressType: map['ipAddressType'] as String,
      ipamPools: Input.decodeList<GetLoadBalancerIpamPool2>(
          map['ipamPools'],
          (value) => GetLoadBalancerIpamPool2.fromMap(
              (value as Map).cast<String, dynamic>())),
      ...
      subnetMappings: Input.decodeList<GetLoadBalancerSubnetMapping2>(
          map['subnetMappings'],
          (value) => GetLoadBalancerSubnetMapping2.fromMap(
              (value as Map).cast<String, dynamic>())),
