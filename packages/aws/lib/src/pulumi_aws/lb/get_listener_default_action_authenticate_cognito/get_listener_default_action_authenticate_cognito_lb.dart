...
class GetListenerDefaultActionAuthenticateCognitoLb {
  ...
  factory GetListenerDefaultActionAuthenticateCognitoLb.fromMap(
      Map<String, dynamic> map) {
    return GetListenerDefaultActionAuthenticateCognitoLb(
