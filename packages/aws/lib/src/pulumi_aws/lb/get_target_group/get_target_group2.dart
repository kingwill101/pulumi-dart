...
import 'get_target_group_args2.dart';
import 'get_target_group_result2.dart';
...
Future<GetTargetGroupResult2> getTargetGroup2(
  GetTargetGroupArgs2 args, {
  ...
  return GetTargetGroupResult2.fromMap(result);
}
