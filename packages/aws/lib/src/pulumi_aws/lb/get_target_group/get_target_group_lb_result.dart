...
import '../get_target_group_health_check/get_target_group_health_check_lb.dart';
import '../get_target_group_stickiness/get_target_group_stickiness_lb.dart';

/// Result data returned by getTargetGroup.
class GetTargetGroupLbResult {
  final String arn;
  final String arnSuffix;
  final bool connectionTermination;
  final String deregistrationDelay;
  final GetTargetGroupHealthCheckLb healthCheck;
  ...
  final String region;
  final int slowStart;
  final GetTargetGroupStickinessLb stickiness;
  final Map<String, String> tags;
  final int targetControlPort;
  final String targetType;
  final String vpcId;

  GetTargetGroupLbResult({
    required this.arn,
  ...
  factory GetTargetGroupLbResult.fromMap(Map<String, dynamic> map) {
    return GetTargetGroupLbResult(
      ...
      healthCheck: GetTargetGroupHealthCheckLb.fromMap(
      ...
      stickiness: GetTargetGroupStickinessLb.fromMap(
