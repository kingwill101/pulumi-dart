...
class LoadBalancerSubnetMapping2 {
  ...
  factory LoadBalancerSubnetMapping2.fromMap(Map<String, dynamic> map) {
    return LoadBalancerSubnetMapping2(
      allocationId:
