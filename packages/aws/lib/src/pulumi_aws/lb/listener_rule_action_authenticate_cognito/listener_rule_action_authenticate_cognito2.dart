...
class ListenerRuleActionAuthenticateCognito2 {
  ...
  ListenerRuleActionAuthenticateCognito2({
  ...
  factory ListenerRuleActionAuthenticateCognito2.fromMap(
      Map<String, dynamic> map) {
    return ListenerRuleActionAuthenticateCognito2(
      authenticationRequestExtraParams:
