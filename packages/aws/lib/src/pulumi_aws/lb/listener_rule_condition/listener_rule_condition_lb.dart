...
import '../listener_rule_condition_host_header/listener_rule_condition_host_header_lb.dart';
import '../listener_rule_condition_http_header/listener_rule_condition_http_header_lb.dart';
import '../listener_rule_condition_http_request_method/listener_rule_condition_http_request_method_lb.dart';
import '../listener_rule_condition_path_pattern/listener_rule_condition_path_pattern_lb.dart';
import '../listener_rule_condition_query_string/listener_rule_condition_query_string_lb.dart';
import '../listener_rule_condition_source_ip/listener_rule_condition_source_ip_lb.dart';

class ListenerRuleConditionLb {
  /// Host header patterns to match. Host Header block fields documented below.
  final ListenerRuleConditionHostHeaderLb? hostHeader;

  /// HTTP headers to match. HTTP Header block fields documented below.
  final ListenerRuleConditionHttpHeaderLb? httpHeader;

  /// Contains a single `values` item which is a list of HTTP request methods or verbs to match. Maximum size is 40 characters. Only allowed characters are A-Z, hyphen (-) and underscore (\_). Comparison is case sensitive. Wildcards are not supported. Only one needs to match for the condition to be satisfied. AWS recommends that GET and HEAD requests are routed in the same way because the response to a HEAD request may be cached.
  final ListenerRuleConditionHttpRequestMethodLb? httpRequestMethod;

  /// Path patterns to match against the request URL. Path Pattern block fields documented below.
  final ListenerRuleConditionPathPatternLb? pathPattern;

  /// Query strings to match. Query String block fields documented below.
  final List<ListenerRuleConditionQueryStringLb>? queryStrings;
  ...
  final ListenerRuleConditionSourceIpLb? sourceIp;

  ListenerRuleConditionLb({
    this.hostHeader,
    this.httpHeader,
  ...
  factory ListenerRuleConditionLb.fromMap(Map<String, dynamic> map) {
    return ListenerRuleConditionLb(
      hostHeader: map['hostHeader'] == null
          ? null
          : ListenerRuleConditionHostHeaderLb.fromMap(
              (map['hostHeader'] as Map).cast<String, dynamic>()),
      httpHeader: map['httpHeader'] == null
          ? null
          : ListenerRuleConditionHttpHeaderLb.fromMap(
              (map['httpHeader'] as Map).cast<String, dynamic>()),
      httpRequestMethod: map['httpRequestMethod'] == null
          ? null
          : ListenerRuleConditionHttpRequestMethodLb.fromMap(
              (map['httpRequestMethod'] as Map).cast<String, dynamic>()),
      pathPattern: map['pathPattern'] == null
          ? null
          : ListenerRuleConditionPathPatternLb.fromMap(
              (map['pathPattern'] as Map).cast<String, dynamic>()),
      queryStrings: map['queryStrings'] == null
          ? null
          : pulumi.Input.decodeList<ListenerRuleConditionQueryStringLb>(
              map['queryStrings'],
              (value) => ListenerRuleConditionQueryStringLb.fromMap(
                  (value as Map).cast<String, dynamic>())),
      sourceIp: map['sourceIp'] == null
          ? null
          : ListenerRuleConditionSourceIpLb.fromMap(
