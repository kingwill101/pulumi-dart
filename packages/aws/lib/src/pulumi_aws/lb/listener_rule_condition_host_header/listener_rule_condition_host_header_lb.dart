...
class ListenerRuleConditionHostHeaderLb {
  ...
  ListenerRuleConditionHostHeaderLb({
    this.regexValues,
    this.values,
  });
  ...
  factory ListenerRuleConditionHostHeaderLb.fromMap(Map<String, dynamic> map) {
    return ListenerRuleConditionHostHeaderLb(
