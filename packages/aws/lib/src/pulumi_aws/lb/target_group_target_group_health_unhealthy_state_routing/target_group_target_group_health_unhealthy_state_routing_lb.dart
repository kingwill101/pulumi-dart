...
class TargetGroupTargetGroupHealthUnhealthyStateRoutingLb {
  ...
  TargetGroupTargetGroupHealthUnhealthyStateRoutingLb({
  ...
  factory TargetGroupTargetGroupHealthUnhealthyStateRoutingLb.fromMap(
      Map<String, dynamic> map) {
    return TargetGroupTargetGroupHealthUnhealthyStateRoutingLb(
