...
class ListenerDefaultActionJwtValidationAdditionalClaim2 {
  ...
  factory ListenerDefaultActionJwtValidationAdditionalClaim2.fromMap(
      Map<String, dynamic> map) {
    return ListenerDefaultActionJwtValidationAdditionalClaim2(
