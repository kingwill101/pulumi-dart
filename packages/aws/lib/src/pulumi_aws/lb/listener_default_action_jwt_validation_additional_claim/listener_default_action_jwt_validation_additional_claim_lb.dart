...
class ListenerDefaultActionJwtValidationAdditionalClaimLb {
  ...
  factory ListenerDefaultActionJwtValidationAdditionalClaimLb.fromMap(
      Map<String, dynamic> map) {
    return ListenerDefaultActionJwtValidationAdditionalClaimLb(
