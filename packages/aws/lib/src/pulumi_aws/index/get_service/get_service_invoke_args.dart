...
class GetServiceInvokeArgs {
  ...
  factory GetServiceInvokeArgs.fromMap(Map<String, dynamic> map) {
    return GetServiceInvokeArgs(
      dnsName: pulumi.Input.asOptionalInput<String>(map['dnsName']),
      id: pulumi.Input.asOptionalInput<String>(map['id']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      reverseDnsName:
          pulumi.Input.asOptionalInput<String>(map['reverseDnsName']),
      reverseDnsPrefix:
          pulumi.Input.asOptionalInput<String>(map['reverseDnsPrefix']),
