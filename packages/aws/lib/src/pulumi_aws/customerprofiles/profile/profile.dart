...
class Profile extends CustomResource {
  ...
  late final Output<String?> accountNumber;

  /// Any additional information relevant to the customer’s profile.
  late final Output<String?> additionalInformation;
  ...
  late final Output<ProfileAddress?> address;
  ...
  late final Output<ProfileBillingAddress?> billingAddress;

  /// The customer’s birth date.
  late final Output<String?> birthDate;

  /// The customer’s business email address.
  late final Output<String?> businessEmailAddress;

  /// The name of the customer’s business.
  late final Output<String?> businessName;

  /// The customer’s business phone number.
  late final Output<String?> businessPhoneNumber;
  ...
  late final Output<String?> genderString;

  /// The customer’s home phone number.
  late final Output<String?> homePhoneNumber;

  /// The customer’s last name.
  late final Output<String?> lastName;

  /// A block that specifies the customer’s mailing address. Documented below.
  late final Output<ProfileMailingAddress?> mailingAddress;

  /// The customer’s middle name.
  late final Output<String?> middleName;

  /// The customer’s mobile phone number.
  late final Output<String?> mobilePhoneNumber;

  /// The type of profile used to describe the customer.
  late final Output<String?> partyTypeString;

  /// The customer’s personal email address.
  late final Output<String?> personalEmailAddress;
  ...
  late final Output<ProfileShippingAddress?> shippingAddress;
