...
import 'connection_codeconnections_args.dart';
...
/// ```
class ConnectionCodeconnections extends pulumi.CustomResource {
  ...
  ConnectionCodeconnections(
    String name, {
    ConnectionCodeconnectionsArgs? args,
