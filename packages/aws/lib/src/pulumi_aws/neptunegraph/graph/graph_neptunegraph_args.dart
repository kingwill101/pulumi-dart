...
class GraphNeptunegraphArgs {
  ...
  factory GraphNeptunegraphArgs.fromMap(Map<String, dynamic> map) {
    return GraphNeptunegraphArgs(
      deletionProtection:
          pulumi.Input.asOptionalInput<bool>(map['deletionProtection']),
      graphName: pulumi.Input.asOptionalInput<String>(map['graphName']),
      graphNamePrefix:
          pulumi.Input.asOptionalInput<String>(map['graphNamePrefix']),
      kmsKeyIdentifier:
          pulumi.Input.asOptionalInput<String>(map['kmsKeyIdentifier']),
      provisionedMemory: pulumi.Input.asInput<int>(map['provisionedMemory']),
      publicConnectivity:
          pulumi.Input.asOptionalInput<bool>(map['publicConnectivity']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      replicaCount: pulumi.Input.asOptionalInput<int>(map['replicaCount']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      timeouts: pulumi.Input.asOptionalInput<GraphTimeouts>(map['timeouts']),
