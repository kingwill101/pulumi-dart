...
class RecordingConfiguration extends CustomResource {
  ...
  RecordingConfiguration(
    ...
    this.destinationConfiguration =
        Output.createUnknown<RecordingConfigurationDestinationConfiguration>();
    this.name = Output.createUnknown<String>();
    this.recordingReconnectWindowSeconds = Output.createUnknown<int>();
    this.region = Output.createUnknown<String>();
    this.state = Output.createUnknown<String>();
    this.tags = Output.createUnknown<Map<String, String>?>();
    this.tagsAll = Output.createUnknown<Map<String, String>>();
    this.thumbnailConfiguration =
        Output.createUnknown<RecordingConfigurationThumbnailConfiguration>();
  }
}
