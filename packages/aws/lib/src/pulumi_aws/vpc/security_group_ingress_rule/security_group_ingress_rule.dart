...
///
///
/// Using `pulumi import`, import security group ingress rules using the <span pulumi-lang-nodejs="`securityGroupRuleId`" pulumi-lang-dotnet="`SecurityGroupRuleId`" pulumi-lang-go="`securityGroupRuleId`" pulumi-lang-python="`security_group_rule_id`" pulumi-lang-yaml="`securityGroupRuleId`" pulumi-lang-java="`securityGroupRuleId`">`security_group_rule_id`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:vpc/securityGroupIngressRule:SecurityGroupIngressRule example sgr-02108b27edd666983
/// ```
class SecurityGroupIngressRule extends CustomResource {
