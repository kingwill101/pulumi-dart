...
class GetSecurityGroupRuleResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['arn'] = arn;
    map['cidrIpv4'] = cidrIpv4;
    map['cidrIpv6'] = cidrIpv6;
    map['description'] = description;
    final filtersValue = filters;
    if (filtersValue != null) {
      map['filters'] =
          Input.encodeList<GetSecurityGroupRuleFilter, Map<String, dynamic>>(
              filtersValue, (value) => value.toMap());
    }
    map['fromPort'] = fromPort;
    map['id'] = id;
    map['ipProtocol'] = ipProtocol;
    map['isEgress'] = isEgress;
    map['prefixListId'] = prefixListId;
    map['referencedSecurityGroupId'] = referencedSecurityGroupId;
    map['region'] = region;
  ...
  factory GetSecurityGroupRuleResult.fromMap(Map<String, dynamic> map) {
    return GetSecurityGroupRuleResult(
      ...
      filters: map['filters'] == null
          ? null
          : Input.decodeList<GetSecurityGroupRuleFilter>(
              map['filters'],
