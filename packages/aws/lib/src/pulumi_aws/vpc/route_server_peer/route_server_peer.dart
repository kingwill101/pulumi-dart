...
/// ## Import
///
/// Using `pulumi import`, import VPC (Virtual Private Cloud) Route Server using the <span pulumi-lang-nodejs="`routeServerPeerId`" pulumi-lang-dotnet="`RouteServerPeerId`" pulumi-lang-go="`routeServerPeerId`" pulumi-lang-python="`route_server_peer_id`" pulumi-lang-yaml="`routeServerPeerId`" pulumi-lang-java="`routeServerPeerId`">`route_server_peer_id`</span>. For example:
///
/// ```sh
...
class RouteServerPeer extends CustomResource {
  ...
  RouteServerPeer(
    ...
    this.bgpOptions = Output.createUnknown<RouteServerPeerBgpOptions>();
    this.endpointEniAddress = Output.createUnknown<String>();
    this.endpointEniId = Output.createUnknown<String>();
    ...
    this.routeServerPeerId = Output.createUnknown<String>();
    this.subnetId = Output.createUnknown<String>();
    this.tags = Output.createUnknown<Map<String, String>?>();
    this.tagsAll = Output.createUnknown<Map<String, String>>();
    this.timeouts = Output.createUnknown<RouteServerPeerTimeouts?>();
