...
/// <span pulumi-lang-nodejs="`aws.acm.Certificate`" pulumi-lang-dotnet="`aws.acm.Certificate`" pulumi-lang-go="`acm.Certificate`" pulumi-lang-python="`acm.Certificate`" pulumi-lang-yaml="`aws.acm.Certificate`" pulumi-lang-java="`aws.acm.Certificate`">`aws.acm.Certificate`</span> to request a DNS validated certificate,
