...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) ARN of the certificate.
///
///
...
class Certificate extends CustomResource {
  ...
  /// <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span> if a Private certificate eligible for managed renewal is within the <span pulumi-lang-nodejs="`earlyRenewalDuration`" pulumi-lang-dotnet="`EarlyRenewalDuration`" pulumi-lang-go="`earlyRenewalDuration`" pulumi-lang-python="`early_renewal_duration`" pulumi-lang-yaml="`earlyRenewalDuration`" pulumi-lang-java="`earlyRenewalDuration`">`early_renewal_duration`</span> period.
