...
///
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.acmpca.Policy`" pulumi-lang-dotnet="`aws.acmpca.Policy`" pulumi-lang-go="`acmpca.Policy`" pulumi-lang-python="`acmpca.Policy`" pulumi-lang-yaml="`aws.acmpca.Policy`" pulumi-lang-java="`aws.acmpca.Policy`">`aws.acmpca.Policy`</span> using the <span pulumi-lang-nodejs="`resourceArn`" pulumi-lang-dotnet="`ResourceArn`" pulumi-lang-go="`resourceArn`" pulumi-lang-python="`resource_arn`" pulumi-lang-yaml="`resourceArn`" pulumi-lang-java="`resourceArn`">`resource_arn`</span> value. For example:
///
/// ```sh
