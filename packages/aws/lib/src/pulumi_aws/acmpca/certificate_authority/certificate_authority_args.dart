...
class CertificateAuthorityArgs {
  ...
  final pulumi.Input<CertificateAuthorityCertificateAuthorityConfiguration>
  ...
  final pulumi.Input<CertificateAuthorityRevocationConfiguration>?
  ...
  Map<String, dynamic> toMap() {
    ...
    map['certificateAuthorityConfiguration'] = pulumi.Input.mapInputValue<
    ...
    if (revocationConfigurationValue != null) {
      map['revocationConfiguration'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory CertificateAuthorityArgs.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityArgs(
      certificateAuthorityConfiguration: pulumi.Input.asInput<
              CertificateAuthorityCertificateAuthorityConfiguration>(
          map['certificateAuthorityConfiguration']),
      enabled: pulumi.Input.asOptionalInput<bool>(map['enabled']),
      keyStorageSecurityStandard: pulumi.Input.asOptionalInput<String>(
          map['keyStorageSecurityStandard']),
      permanentDeletionTimeInDays:
          pulumi.Input.asOptionalInput<int>(map['permanentDeletionTimeInDays']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      revocationConfiguration: pulumi.Input.asOptionalInput<
              CertificateAuthorityRevocationConfiguration>(
          map['revocationConfiguration']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      type: pulumi.Input.asOptionalInput<String>(map['type']),
      usageMode: pulumi.Input.asOptionalInput<String>(map['usageMode']),
    );
  }
}
