...
class ReplicationConfigurationTemplateArgs {
  ...
  final Input<Map<String, String>> stagingAreaTags;

  /// Set of tags to be associated with the Replication Configuration Template resource.
  final Input<Map<String, String>>? tags;
  final Input<ReplicationConfigurationTemplateTimeouts>? timeouts;

  /// Whether to use a dedicated Replication Server in the replication staging area.
  ///
  /// The following arguments are optional:
  final Input<bool> useDedicatedReplicationServer;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (pitPoliciesValue != null) {
      map['pitPolicies'] = Input.mapOptionalInputValue<
              List<ReplicationConfigurationTemplatePitPolicy>,
              List<Map<String, dynamic>>>(
          pitPoliciesValue,
          (value) => Input.encodeList<ReplicationConfigurationTemplatePitPolicy,
  ...
  factory ReplicationConfigurationTemplateArgs.fromMap(
    ...
    return ReplicationConfigurationTemplateArgs(
      associateDefaultSecurityGroup:
          Input.asInput<bool>(map['associateDefaultSecurityGroup']),
      autoReplicateNewDisks:
          Input.asOptionalInput<bool>(map['autoReplicateNewDisks']),
      bandwidthThrottling: Input.asInput<int>(map['bandwidthThrottling']),
      createPublicIp: Input.asInput<bool>(map['createPublicIp']),
      dataPlaneRouting: Input.asInput<String>(map['dataPlaneRouting']),
      defaultLargeStagingDiskType:
          Input.asInput<String>(map['defaultLargeStagingDiskType']),
      ebsEncryption: Input.asInput<String>(map['ebsEncryption']),
      ebsEncryptionKeyArn:
          Input.asOptionalInput<String>(map['ebsEncryptionKeyArn']),
      pitPolicies: Input.asOptionalInput<
          List<ReplicationConfigurationTemplatePitPolicy>>(map['pitPolicies']),
      region: Input.asOptionalInput<String>(map['region']),
      replicationServerInstanceType:
          Input.asInput<String>(map['replicationServerInstanceType']),
      replicationServersSecurityGroupsIds: Input.asInput<List<String>>(
          map['replicationServersSecurityGroupsIds']),
      stagingAreaSubnetId: Input.asInput<String>(map['stagingAreaSubnetId']),
      stagingAreaTags:
          Input.asInput<Map<String, String>>(map['stagingAreaTags']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      timeouts: Input.asOptionalInput<ReplicationConfigurationTemplateTimeouts>(
          map['timeouts']),
      useDedicatedReplicationServer:
          Input.asInput<bool>(map['useDedicatedReplicationServer']),
    );
  }
}
