...
class SecretRotationArgs {
  ...
  factory SecretRotationArgs.fromMap(Map<String, dynamic> map) {
    return SecretRotationArgs(
      ...
      rotateImmediately:
          pulumi.Input.asOptionalInput<bool>(map['rotateImmediately']),
      rotationLambdaArn:
          pulumi.Input.asOptionalInput<String>(map['rotationLambdaArn']),
      rotationRules: pulumi.Input.asInput<SecretRotationRotationRules>(
          map['rotationRules']),
