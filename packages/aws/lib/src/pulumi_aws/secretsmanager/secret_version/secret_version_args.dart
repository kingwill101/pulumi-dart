...
class SecretVersionArgs {
  ...
  factory SecretVersionArgs.fromMap(Map<String, dynamic> map) {
    return SecretVersionArgs(
      ...
      secretBinary: pulumi.Input.asOptionalInput<String>(map['secretBinary']),
      secretId: pulumi.Input.asInput<String>(map['secretId']),
      secretString: pulumi.Input.asOptionalInput<String>(map['secretString']),
      secretStringWo:
          pulumi.Input.asOptionalInput<String>(map['secretStringWo']),
      secretStringWoVersion:
          pulumi.Input.asOptionalInput<int>(map['secretStringWoVersion']),
      versionStages:
          pulumi.Input.asOptionalInput<List<String>>(map['versionStages']),
    );
  }
}
