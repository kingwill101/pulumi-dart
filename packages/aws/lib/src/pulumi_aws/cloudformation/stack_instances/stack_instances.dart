...
///
/// > **NOTE:** This resource will manage all stack instances for the specified <span pulumi-lang-nodejs="`stackSetName`" pulumi-lang-dotnet="`StackSetName`" pulumi-lang-go="`stackSetName`" pulumi-lang-python="`stack_set_name`" pulumi-lang-yaml="`stackSetName`" pulumi-lang-java="`stackSetName`">`stack_set_name`</span>. If you create stack instances outside of Terraform or import existing infrastructure, ensure that your configuration includes all accounts and regions where stack instances exist for the stack set. Failing to include all accounts and regions will cause Terraform to continuously report differences between your configuration and the actual infrastructure.
///
/// > **NOTE:** All target accounts must have an IAM Role created that matches the name of the execution role configured in the stack (the <span pulumi-lang-nodejs="`executionRoleName`" pulumi-lang-dotnet="`ExecutionRoleName`" pulumi-lang-go="`executionRoleName`" pulumi-lang-python="`execution_role_name`" pulumi-lang-yaml="`executionRoleName`" pulumi-lang-java="`executionRoleName`">`execution_role_name`</span> argument in the <span pulumi-lang-nodejs="`aws.cloudformation.StackSet`" pulumi-lang-dotnet="`aws.cloudformation.StackSet`" pulumi-lang-go="`cloudformation.StackSet`" pulumi-lang-python="`cloudformation.StackSet`" pulumi-lang-yaml="`aws.cloudformation.StackSet`" pulumi-lang-java="`aws.cloudformation.StackSet`">`aws.cloudformation.StackSet`</span> resource) in a trust relationship with the administrative account or administration IAM Role. The execution role must have appropriate permissions to manage resources defined in the template along with those required for stacks to operate. See the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-prereqs.html) for more details.
///
/// > **NOTE:** To retain the Stack during Terraform resource destroy, ensure <span pulumi-lang-nodejs="`retainStacks " pulumi-lang-dotnet="`RetainStacks " pulumi-lang-go="`retainStacks " pulumi-lang-python="`retain_stacks " pulumi-lang-yaml="`retainStacks " pulumi-lang-java="`retainStacks ">`retain_stacks </span>= true` has been successfully applied into the Terraform state first. This must be completed _before_ an apply that would destroy the resource.
///
/// ## Example Usage
///
/// ### Basic Usage
...
/// ## Import
///
/// Import CloudFormation stack instances that target OUs, using the stack set name, <span pulumi-lang-nodejs="`callAs`" pulumi-lang-dotnet="`CallAs`" pulumi-lang-go="`callAs`" pulumi-lang-python="`call_as`" pulumi-lang-yaml="`callAs`" pulumi-lang-java="`callAs`">`call_as`</span>, and "OU" separated by commas (`,`). For example:
///
///
/// Using `pulumi import`, import CloudFormation stack instances using the stack set name and <span pulumi-lang-nodejs="`callAs`" pulumi-lang-dotnet="`CallAs`" pulumi-lang-go="`callAs`" pulumi-lang-python="`call_as`" pulumi-lang-yaml="`callAs`" pulumi-lang-java="`callAs`">`call_as`</span> separated by commas (`,`). If you are importing a stack instance targeting OUs, see the example below. For example:
///
/// ```sh
/// $ pulumi import aws:cloudformation/stackInstances:StackInstances example example,SELF
/// ```
///
/// Using `pulumi import`, Import CloudFormation stack instances that target OUs, using the stack set name, <span pulumi-lang-nodejs="`callAs`" pulumi-lang-dotnet="`CallAs`" pulumi-lang-go="`callAs`" pulumi-lang-python="`call_as`" pulumi-lang-yaml="`callAs`" pulumi-lang-java="`callAs`">`call_as`</span>, and "OU" separated by commas (`,`). For example:
///
/// ```sh
...
class StackInstances extends CustomResource {
  ...
  /// List of stack instances created from an organizational unit deployment target. This may not always be set depending on whether CloudFormation returns summaries for your configuration. See <span pulumi-lang-nodejs="`stackInstanceSummaries`" pulumi-lang-dotnet="`StackInstanceSummaries`" pulumi-lang-go="`stackInstanceSummaries`" pulumi-lang-python="`stack_instance_summaries`" pulumi-lang-yaml="`stackInstanceSummaries`" pulumi-lang-java="`stackInstanceSummaries`">`stack_instance_summaries`</span>.
  ...
  StackInstances(
    ...
    this.accounts = Output.createUnknown<List<String>>();
    this.callAs = Output.createUnknown<String?>();
    this.deploymentTargets =
        Output.createUnknown<StackInstancesDeploymentTargets?>();
    this.operationPreferences =
        Output.createUnknown<StackInstancesOperationPreferences?>();
    this.parameterOverrides = Output.createUnknown<Map<String, String>?>();
    this.region = Output.createUnknown<String>();
    this.regions = Output.createUnknown<List<String>>();
    this.retainStacks = Output.createUnknown<bool?>();
    this.stackInstanceSummaries =
        Output.createUnknown<List<StackInstancesStackInstanceSummary>>();
