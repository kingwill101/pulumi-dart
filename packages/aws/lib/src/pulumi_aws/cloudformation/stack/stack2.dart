...
/// ## Import
///
/// Using `pulumi import`, import Cloudformation Stacks using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:cloudformation/stack:Stack stack networking-stack
/// ```
class Stack2 extends CustomResource {
  ...
  late final Output<bool?> disableRollback;
  ...
  late final Output<String?> onFailure;
  ...
  late final Output<String> policyBody;
  ...
  late final Output<String?> policyUrl;
  ...
  late final Output<int?> timeoutInMinutes;
