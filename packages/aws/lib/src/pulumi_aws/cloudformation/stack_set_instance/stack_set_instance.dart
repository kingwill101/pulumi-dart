...
///
///
/// Import CloudFormation StackSet Instances when acting a delegated administrator in a member account using the StackSet name, target AWS account ID or slash (`/`) separated list of organizational unit IDs, target AWS Region and <span pulumi-lang-nodejs="`callAs`" pulumi-lang-dotnet="`CallAs`" pulumi-lang-go="`callAs`" pulumi-lang-python="`call_as`" pulumi-lang-yaml="`callAs`" pulumi-lang-java="`callAs`">`call_as`</span> value separated by commas (`,`). For example:
///
///
...
/// ```
///
/// Using `pulumi import`, import CloudFormation StackSet Instances when acting a delegated administrator in a member account using the StackSet name, target AWS account ID or slash (`/`) separated list of organizational unit IDs, target AWS Region and <span pulumi-lang-nodejs="`callAs`" pulumi-lang-dotnet="`CallAs`" pulumi-lang-go="`callAs`" pulumi-lang-python="`call_as`" pulumi-lang-yaml="`callAs`" pulumi-lang-java="`callAs`">`call_as`</span> value separated by commas (`,`). For example:
///
/// ```sh
...
class StackSetInstance extends CustomResource {
  ...
  /// List of stack instances created from an organizational unit deployment target. This will only be populated when <span pulumi-lang-nodejs="`deploymentTargets`" pulumi-lang-dotnet="`DeploymentTargets`" pulumi-lang-go="`deploymentTargets`" pulumi-lang-python="`deployment_targets`" pulumi-lang-yaml="`deploymentTargets`" pulumi-lang-java="`deploymentTargets`">`deployment_targets`</span> is set. See <span pulumi-lang-nodejs="`stackInstanceSummaries`" pulumi-lang-dotnet="`StackInstanceSummaries`" pulumi-lang-go="`stackInstanceSummaries`" pulumi-lang-python="`stack_instance_summaries`" pulumi-lang-yaml="`stackInstanceSummaries`" pulumi-lang-java="`stackInstanceSummaries`">`stack_instance_summaries`</span>.
