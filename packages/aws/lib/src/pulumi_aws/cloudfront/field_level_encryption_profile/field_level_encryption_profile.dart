...
/// ## Import
///
/// Using `pulumi import`, import Cloudfront Field Level Encryption Profile using the <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
...
class FieldLevelEncryptionProfile extends CustomResource {
  ...
  FieldLevelEncryptionProfile(
    ...
    this.encryptionEntities =
        Output.createUnknown<FieldLevelEncryptionProfileEncryptionEntities>();
