  ...
  factory OriginAccessControlArgs.fromMap(Map<String, dynamic> map) {
    return OriginAccessControlArgs(
      ...
      originAccessControlOriginType:
          pulumi.Input.asInput<String>(map['originAccessControlOriginType']),
      signingBehavior: pulumi.Input.asInput<String>(map['signingBehavior']),
      signingProtocol: pulumi.Input.asInput<String>(map['signingProtocol']),
    );
  }
}
