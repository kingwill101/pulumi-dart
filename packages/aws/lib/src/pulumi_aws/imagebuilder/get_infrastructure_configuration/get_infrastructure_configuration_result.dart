...
class GetInfrastructureConfigurationResult {
  ...
  final List<GetInfrastructureConfigurationInstanceMetadataOption>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['tags'] = tags;
    map['terminateInstanceOnFailure'] = terminateInstanceOnFailure;
    return map;
  }

  factory GetInfrastructureConfigurationResult.fromMap(
    ...
    return GetInfrastructureConfigurationResult(
      ...
      instanceMetadataOptions: pulumi.Input.decodeList<
          ...
          (value) =>
              GetInfrastructureConfigurationInstanceMetadataOption.fromMap(
