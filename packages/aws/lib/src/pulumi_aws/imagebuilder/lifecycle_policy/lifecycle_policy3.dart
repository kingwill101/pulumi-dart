...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the Image Builder lifecycle policy.
///
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.imagebuilder.LifecyclePolicy`" pulumi-lang-dotnet="`aws.imagebuilder.LifecyclePolicy`" pulumi-lang-go="`imagebuilder.LifecyclePolicy`" pulumi-lang-python="`imagebuilder.LifecyclePolicy`" pulumi-lang-yaml="`aws.imagebuilder.LifecyclePolicy`" pulumi-lang-java="`aws.imagebuilder.LifecyclePolicy`">`aws.imagebuilder.LifecyclePolicy`</span> using the Amazon Resource Name (ARN). For example:
///
/// ```sh
