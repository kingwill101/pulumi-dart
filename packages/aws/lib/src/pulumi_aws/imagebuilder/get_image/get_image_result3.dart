...
class GetImageResult3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['imageTestsConfigurations'] =
        Input.encodeList<GetImageImageTestsConfiguration, Map<String, dynamic>>(
    ...
    map['outputResources'] =
        Input.encodeList<GetImageOutputResource, Map<String, dynamic>>(
  ...
  factory GetImageResult3.fromMap(Map<String, dynamic> map) {
    return GetImageResult3(
      ...
      outputResources: Input.decodeList<GetImageOutputResource>(
          map['outputResources'],
