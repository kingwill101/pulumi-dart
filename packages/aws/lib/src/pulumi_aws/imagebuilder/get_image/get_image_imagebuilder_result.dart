...
import '../get_image_image_scanning_configuration/get_image_image_scanning_configuration.dart';
import '../get_image_image_tests_configuration/get_image_image_tests_configuration.dart';
import '../get_image_output_resource/get_image_output_resource.dart';

/// Result data returned by getImage.
class GetImageImagebuilderResult {
  final String arn;
  ...
  factory GetImageImagebuilderResult.fromMap(Map<String, dynamic> map) {
    return GetImageImagebuilderResult(
