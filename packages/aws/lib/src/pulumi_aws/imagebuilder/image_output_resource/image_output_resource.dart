...
class ImageOutputResource {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (amisValue != null) {
      map['amis'] =
          Input.encodeList<ImageOutputResourceAmi, Map<String, dynamic>>(
              amisValue, (value) => value.toMap());
    }
    final containersValue = containers;
    if (containersValue != null) {
      map['containers'] =
          Input.encodeList<ImageOutputResourceContainer, Map<String, dynamic>>(
  ...
  factory ImageOutputResource.fromMap(Map<String, dynamic> map) {
    return ImageOutputResource(
      amis: map['amis'] == null
          ? null
          : Input.decodeList<ImageOutputResourceAmi>(
              map['amis'],
              (value) => ImageOutputResourceAmi.fromMap(
                  (value as Map).cast<String, dynamic>())),
      containers: map['containers'] == null
          ? null
          : Input.decodeList<ImageOutputResourceContainer>(
              map['containers'],
