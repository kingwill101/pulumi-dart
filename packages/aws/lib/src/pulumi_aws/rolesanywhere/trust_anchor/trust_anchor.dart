...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.rolesanywhere.TrustAnchor`" pulumi-lang-dotnet="`aws.rolesanywhere.TrustAnchor`" pulumi-lang-go="`rolesanywhere.TrustAnchor`" pulumi-lang-python="`rolesanywhere.TrustAnchor`" pulumi-lang-yaml="`aws.rolesanywhere.TrustAnchor`" pulumi-lang-java="`aws.rolesanywhere.TrustAnchor`">`aws.rolesanywhere.TrustAnchor`</span> using its <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
