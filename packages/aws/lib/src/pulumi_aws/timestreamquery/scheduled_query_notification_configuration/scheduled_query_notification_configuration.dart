...
import '../scheduled_query_notification_configuration_sns_configuration/scheduled_query_notification_configuration_sns_configuration.dart';
...
class ScheduledQueryNotificationConfiguration {
  ...
  final ScheduledQueryNotificationConfigurationSnsConfiguration
      snsConfiguration;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['snsConfiguration'] = snsConfiguration.toMap();
    return map;
  }
