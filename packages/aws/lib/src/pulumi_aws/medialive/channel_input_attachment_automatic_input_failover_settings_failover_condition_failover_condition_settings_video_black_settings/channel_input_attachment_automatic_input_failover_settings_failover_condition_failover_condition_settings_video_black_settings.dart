...
class ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsVideoBlackSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final blackDetectThresholdValue = blackDetectThreshold;
    if (blackDetectThresholdValue != null) {
      map['blackDetectThreshold'] = blackDetectThresholdValue;
    }
    final videoBlackThresholdMsecValue = videoBlackThresholdMsec;
    if (videoBlackThresholdMsecValue != null) {
      map['videoBlackThresholdMsec'] = videoBlackThresholdMsecValue;
    }
    return map;
  }
