...
import '../channel_encoder_settings_caption_description_destination_settings_dvb_sub_destination_settings_font/channel_encoder_settings_caption_description_destination_settings_dvb_sub_destination_settings_font.dart';
...
class ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings {
  ...
  final ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettingsFont?
      font;
  ...
  Map<String, dynamic> toMap() {
    ...
    final outlineColorValue = outlineColor;
    if (outlineColorValue != null) {
      map['outlineColor'] = outlineColorValue;
    }
    ...
    final teletextGridControlValue = teletextGridControl;
    if (teletextGridControlValue != null) {
      map['teletextGridControl'] = teletextGridControlValue;
    }
  ...
  factory ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings.fromMap(
    ...
    return ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings(
      ...
      outlineColor:
          map['outlineColor'] == null ? null : map['outlineColor'] as String,
      outlineSize:
      ...
      teletextGridControl: map['teletextGridControl'] == null
          ? null
          : map['teletextGridControl'] as String,
