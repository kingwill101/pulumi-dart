...
class ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettings {
  ...
  Map<String, dynamic> toMap() {
    ...
    final nielsenCbetSettingsValue = nielsenCbetSettings;
    if (nielsenCbetSettingsValue != null) {
      map['nielsenCbetSettings'] = nielsenCbetSettingsValue.toMap();
    }
    final nielsenDistributionTypeValue = nielsenDistributionType;
    if (nielsenDistributionTypeValue != null) {
      map['nielsenDistributionType'] = nielsenDistributionTypeValue;
    }
