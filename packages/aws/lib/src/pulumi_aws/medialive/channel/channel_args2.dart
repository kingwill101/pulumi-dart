...
class ChannelArgs2 {
  ...
  final Input<ChannelCdiInputSpecification>? cdiInputSpecification;

  /// Concise argument description.
  final Input<String> channelClass;

  /// Destinations for channel. See Destinations for more details.
  final Input<List<ChannelDestination>> destinations;

  /// Encoder settings. See Encoder Settings for more details.
  final Input<ChannelEncoderSettings> encoderSettings;

  /// Input attachments for the channel. See Input Attachments for more details.
  final Input<List<ChannelInputAttachment>> inputAttachments;

  /// Specification of network and file inputs for the channel.
  final Input<ChannelInputSpecification> inputSpecification;

  /// The log level to write to Cloudwatch logs.
  final Input<String>? logLevel;

  /// Maintenance settings for this channel. See Maintenance for more details.
  final Input<ChannelMaintenance>? maintenance;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (cdiInputSpecificationValue != null) {
      map['cdiInputSpecification'] = Input.mapOptionalInputValue<
              ChannelCdiInputSpecification, Map<String, dynamic>>(
          cdiInputSpecificationValue, (value) => value.toMap());
    }
    map['channelClass'] = channelClass;
    map['destinations'] = Input.mapInputValue<List<ChannelDestination>,
            List<Map<String, dynamic>>>(
        destinations,
        (value) => Input.encodeList<ChannelDestination, Map<String, dynamic>>(
            value, (value) => value.toMap()));
    map['encoderSettings'] =
        Input.mapInputValue<ChannelEncoderSettings, Map<String, dynamic>>(
            encoderSettings, (value) => value.toMap());
    map['inputAttachments'] = Input.mapInputValue<List<ChannelInputAttachment>,
            List<Map<String, dynamic>>>(
        inputAttachments,
        (value) =>
            Input.encodeList<ChannelInputAttachment, Map<String, dynamic>>(
                value, (value) => value.toMap()));
    map['inputSpecification'] =
        Input.mapInputValue<ChannelInputSpecification, Map<String, dynamic>>(
    ...
    if (maintenanceValue != null) {
      map['maintenance'] =
          Input.mapOptionalInputValue<ChannelMaintenance, Map<String, dynamic>>(
    ...
    if (vpcValue != null) {
      map['vpc'] =
          Input.mapOptionalInputValue<ChannelVpc, Map<String, dynamic>>(
  ...
  factory ChannelArgs2.fromMap(Map<String, dynamic> map) {
    return ChannelArgs2(
      cdiInputSpecification:
          Input.asOptionalInput<ChannelCdiInputSpecification>(
              map['cdiInputSpecification']),
      channelClass: Input.asInput<String>(map['channelClass']),
      destinations:
          Input.asInput<List<ChannelDestination>>(map['destinations']),
      encoderSettings:
          Input.asInput<ChannelEncoderSettings>(map['encoderSettings']),
      inputAttachments:
          Input.asInput<List<ChannelInputAttachment>>(map['inputAttachments']),
      inputSpecification:
          Input.asInput<ChannelInputSpecification>(map['inputSpecification']),
      logLevel: Input.asOptionalInput<String>(map['logLevel']),
      maintenance:
          Input.asOptionalInput<ChannelMaintenance>(map['maintenance']),
      name: Input.asOptionalInput<String>(map['name']),
      region: Input.asOptionalInput<String>(map['region']),
      roleArn: Input.asOptionalInput<String>(map['roleArn']),
      startChannel: Input.asOptionalInput<bool>(map['startChannel']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      vpc: Input.asOptionalInput<ChannelVpc>(map['vpc']),
    );
  }
}
