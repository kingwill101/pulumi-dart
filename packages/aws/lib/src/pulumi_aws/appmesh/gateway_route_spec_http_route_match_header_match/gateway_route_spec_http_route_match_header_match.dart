...
import '../gateway_route_spec_http_route_match_header_match_range/gateway_route_spec_http_route_match_header_match_range.dart';
...
class GatewayRouteSpecHttpRouteMatchHeaderMatch {
  ...
  factory GatewayRouteSpecHttpRouteMatchHeaderMatch.fromMap(
    ...
    return GatewayRouteSpecHttpRouteMatchHeaderMatch(
      ...
      range: map['range'] == null
          ? null
          : GatewayRouteSpecHttpRouteMatchHeaderMatchRange.fromMap(
