...
class GetMeshSpec {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['egressFilters'] =
        Input.encodeList<GetMeshSpecEgressFilter, Map<String, dynamic>>(
            egressFilters, (value) => value.toMap());
    map['serviceDiscoveries'] =
        Input.encodeList<GetMeshSpecServiceDiscovery, Map<String, dynamic>>(
  ...
  factory GetMeshSpec.fromMap(Map<String, dynamic> map) {
    return GetMeshSpec(
      egressFilters: Input.decodeList<GetMeshSpecEgressFilter>(
          map['egressFilters'],
          (value) => GetMeshSpecEgressFilter.fromMap(
              (value as Map).cast<String, dynamic>())),
      serviceDiscoveries: Input.decodeList<GetMeshSpecServiceDiscovery>(
          map['serviceDiscoveries'],
