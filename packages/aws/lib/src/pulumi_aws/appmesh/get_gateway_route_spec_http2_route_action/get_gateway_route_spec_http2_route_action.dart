...
class GetGatewayRouteSpecHttp2RouteAction {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['targets'] = Input.encodeList<GetGatewayRouteSpecHttp2RouteActionTarget,
  ...
  factory GetGatewayRouteSpecHttp2RouteAction.fromMap(
    ...
    return GetGatewayRouteSpecHttp2RouteAction(
      rewrites: Input.decodeList<GetGatewayRouteSpecHttp2RouteActionRewrite>(
          map['rewrites'],
          (value) => GetGatewayRouteSpecHttp2RouteActionRewrite.fromMap(
              (value as Map).cast<String, dynamic>())),
      targets: Input.decodeList<GetGatewayRouteSpecHttp2RouteActionTarget>(
          map['targets'],
