...
import '../gateway_route_spec_http_route_match_header/gateway_route_spec_http_route_match_header.dart';
import '../gateway_route_spec_http_route_match_hostname/gateway_route_spec_http_route_match_hostname.dart';
import '../gateway_route_spec_http_route_match_path/gateway_route_spec_http_route_match_path.dart';
import '../gateway_route_spec_http_route_match_query_parameter/gateway_route_spec_http_route_match_query_parameter.dart';
...
class GatewayRouteSpecHttpRouteMatch {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (headersValue != null) {
      map['headers'] = Input.encodeList<GatewayRouteSpecHttpRouteMatchHeader,
  ...
  factory GatewayRouteSpecHttpRouteMatch.fromMap(Map<String, dynamic> map) {
    return GatewayRouteSpecHttpRouteMatch(
      headers: map['headers'] == null
          ? null
          : Input.decodeList<GatewayRouteSpecHttpRouteMatchHeader>(
              map['headers'],
      ...
      queryParameters: map['queryParameters'] == null
          ? null
          : Input.decodeList<GatewayRouteSpecHttpRouteMatchQueryParameter>(
              map['queryParameters'],
