...
import '../get_virtual_gateway_spec_listener_connection_pool/get_virtual_gateway_spec_listener_connection_pool.dart';
import '../get_virtual_gateway_spec_listener_health_check/get_virtual_gateway_spec_listener_health_check.dart';
import '../get_virtual_gateway_spec_listener_port_mapping/get_virtual_gateway_spec_listener_port_mapping.dart';
import '../get_virtual_gateway_spec_listener_tl/get_virtual_gateway_spec_listener_tl.dart';
...
class GetVirtualGatewaySpecListener {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['tls'] =
        Input.encodeList<GetVirtualGatewaySpecListenerTl, Map<String, dynamic>>(
  ...
  factory GetVirtualGatewaySpecListener.fromMap(Map<String, dynamic> map) {
    return GetVirtualGatewaySpecListener(
      connectionPools:
          Input.decodeList<GetVirtualGatewaySpecListenerConnectionPool>(
              map['connectionPools'],
              (value) => GetVirtualGatewaySpecListenerConnectionPool.fromMap(
                  (value as Map).cast<String, dynamic>())),
      healthChecks: Input.decodeList<GetVirtualGatewaySpecListenerHealthCheck>(
          map['healthChecks'],
          (value) => GetVirtualGatewaySpecListenerHealthCheck.fromMap(
              (value as Map).cast<String, dynamic>())),
      portMappings: Input.decodeList<GetVirtualGatewaySpecListenerPortMapping>(
          map['portMappings'],
          (value) => GetVirtualGatewaySpecListenerPortMapping.fromMap(
              (value as Map).cast<String, dynamic>())),
      tls: Input.decodeList<GetVirtualGatewaySpecListenerTl>(
          map['tls'],
