...
import '../gateway_route_spec_http_route_action/gateway_route_spec_http_route_action.dart';
import '../gateway_route_spec_http_route_match/gateway_route_spec_http_route_match.dart';
...
class GatewayRouteSpecHttpRoute {
  ...
  factory GatewayRouteSpecHttpRoute.fromMap(Map<String, dynamic> map) {
    return GatewayRouteSpecHttpRoute(
      action: GatewayRouteSpecHttpRouteAction.fromMap(
          (map['action'] as Map).cast<String, dynamic>()),
      match: GatewayRouteSpecHttpRouteMatch.fromMap(
