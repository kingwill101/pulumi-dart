...
class GetRouteSpecHttp2Route {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['actions'] = pulumi.Input.encodeList<GetRouteSpecHttp2RouteAction,
        Map<String, dynamic>>(actions, (value) => value.toMap());
    map['matches'] = pulumi.Input.encodeList<GetRouteSpecHttp2RouteMatch,
    ...
    map['timeouts'] = pulumi.Input.encodeList<GetRouteSpecHttp2RouteTimeout,
