...
class GetVirtualNodeSpec {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['backendDefaults'] = Input.encodeList<GetVirtualNodeSpecBackendDefault,
        Map<String, dynamic>>(backendDefaults, (value) => value.toMap());
    map['backends'] =
        Input.encodeList<GetVirtualNodeSpecBackend, Map<String, dynamic>>(
            backends, (value) => value.toMap());
    map['listeners'] =
        Input.encodeList<GetVirtualNodeSpecListener, Map<String, dynamic>>(
            listeners, (value) => value.toMap());
    map['loggings'] =
        Input.encodeList<GetVirtualNodeSpecLogging, Map<String, dynamic>>(
  ...
  factory GetVirtualNodeSpec.fromMap(Map<String, dynamic> map) {
    return GetVirtualNodeSpec(
      backendDefaults: Input.decodeList<GetVirtualNodeSpecBackendDefault>(
          map['backendDefaults'],
          (value) => GetVirtualNodeSpecBackendDefault.fromMap(
              (value as Map).cast<String, dynamic>())),
      backends: Input.decodeList<GetVirtualNodeSpecBackend>(
          map['backends'],
          (value) => GetVirtualNodeSpecBackend.fromMap(
              (value as Map).cast<String, dynamic>())),
      listeners: Input.decodeList<GetVirtualNodeSpecListener>(
          map['listeners'],
          (value) => GetVirtualNodeSpecListener.fromMap(
              (value as Map).cast<String, dynamic>())),
      loggings: Input.decodeList<GetVirtualNodeSpecLogging>(
          map['loggings'],
          (value) => GetVirtualNodeSpecLogging.fromMap(
              (value as Map).cast<String, dynamic>())),
      serviceDiscoveries: Input.decodeList<GetVirtualNodeSpecServiceDiscovery>(
