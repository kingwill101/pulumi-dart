...
/// * <span pulumi-lang-nodejs="`policyArn`" pulumi-lang-dotnet="`PolicyArn`" pulumi-lang-go="`policyArn`" pulumi-lang-python="`policy_arn`" pulumi-lang-yaml="`policyArn`" pulumi-lang-java="`policyArn`">`policy_arn`</span> (String) ARN of the IAM policy.
///
/// #### Optional
///
