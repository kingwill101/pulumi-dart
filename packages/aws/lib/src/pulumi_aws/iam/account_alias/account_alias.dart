...
/// ## Import
///
/// Using `pulumi import`, import the current Account Alias using the <span pulumi-lang-nodejs="`accountAlias`" pulumi-lang-dotnet="`AccountAlias`" pulumi-lang-go="`accountAlias`" pulumi-lang-python="`account_alias`" pulumi-lang-yaml="`accountAlias`" pulumi-lang-java="`accountAlias`">`account_alias`</span>. For example:
///
/// ```sh
