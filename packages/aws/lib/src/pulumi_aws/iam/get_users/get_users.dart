...
///
/// Users whose username contains <span pulumi-lang-nodejs="`abc`" pulumi-lang-dotnet="`Abc`" pulumi-lang-go="`abc`" pulumi-lang-python="`abc`" pulumi-lang-yaml="`abc`" pulumi-lang-java="`abc`">`abc`</span>
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
