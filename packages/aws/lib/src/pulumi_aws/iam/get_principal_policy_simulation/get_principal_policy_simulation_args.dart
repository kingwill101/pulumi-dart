...
class GetPrincipalPolicySimulationArgs {
  ...
  factory GetPrincipalPolicySimulationArgs.fromMap(Map<String, dynamic> map) {
    return GetPrincipalPolicySimulationArgs(
      actionNames: pulumi.Input.asInput<List<String>>(map['actionNames']),
      additionalPoliciesJsons: pulumi.Input.asOptionalInput<List<String>>(
          map['additionalPoliciesJsons']),
      callerArn: pulumi.Input.asOptionalInput<String>(map['callerArn']),
      contexts: pulumi.Input.asOptionalInput<
          List<GetPrincipalPolicySimulationContext>>(map['contexts']),
      permissionsBoundaryPoliciesJsons:
          pulumi.Input.asOptionalInput<List<String>>(
              map['permissionsBoundaryPoliciesJsons']),
      policySourceArn: pulumi.Input.asInput<String>(map['policySourceArn']),
      resourceArns:
          pulumi.Input.asOptionalInput<List<String>>(map['resourceArns']),
      resourceHandlingOption:
          pulumi.Input.asOptionalInput<String>(map['resourceHandlingOption']),
      resourceOwnerAccountId:
          pulumi.Input.asOptionalInput<String>(map['resourceOwnerAccountId']),
      resourcePolicyJson:
          pulumi.Input.asOptionalInput<String>(map['resourcePolicyJson']),
    );
  }
}
