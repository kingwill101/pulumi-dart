...
class GetPolicyDocumentArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (statementsValue != null) {
      map['statements'] = pulumi.Input.mapOptionalInputValue<
              List<GetPolicyDocumentStatement>, List<Map<String, dynamic>>>(
          statementsValue,
          (value) => pulumi.Input.encodeList<GetPolicyDocumentStatement,
  ...
  factory GetPolicyDocumentArgs.fromMap(Map<String, dynamic> map) {
    return GetPolicyDocumentArgs(
      overrideJson: pulumi.Input.asOptionalInput<String>(map['overrideJson']),
      overridePolicyDocuments: pulumi.Input.asOptionalInput<List<String>>(
          map['overridePolicyDocuments']),
      policyId: pulumi.Input.asOptionalInput<String>(map['policyId']),
      sourceJson: pulumi.Input.asOptionalInput<String>(map['sourceJson']),
      sourcePolicyDocuments: pulumi.Input.asOptionalInput<List<String>>(
          map['sourcePolicyDocuments']),
      statements:
          pulumi.Input.asOptionalInput<List<GetPolicyDocumentStatement>>(
              map['statements']),
