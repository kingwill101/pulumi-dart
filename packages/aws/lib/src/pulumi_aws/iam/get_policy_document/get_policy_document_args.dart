...
class GetPolicyDocumentArgs {
  ...
  /// List of IAM policy documents that are merged together into the exported document. In merging, statements with non-blank <span pulumi-lang-nodejs="`sid`" pulumi-lang-dotnet="`Sid`" pulumi-lang-go="`sid`" pulumi-lang-python="`sid`" pulumi-lang-yaml="`sid`" pulumi-lang-java="`sid`">`sid`</span>s will override statements with the same <span pulumi-lang-nodejs="`sid`" pulumi-lang-dotnet="`Sid`" pulumi-lang-go="`sid`" pulumi-lang-python="`sid`" pulumi-lang-yaml="`sid`" pulumi-lang-java="`sid`">`sid`</span> from earlier documents in the list. Statements with non-blank <span pulumi-lang-nodejs="`sid`" pulumi-lang-dotnet="`Sid`" pulumi-lang-go="`sid`" pulumi-lang-python="`sid`" pulumi-lang-yaml="`sid`" pulumi-lang-java="`sid`">`sid`</span>s will also override statements with the same <span pulumi-lang-nodejs="`sid`" pulumi-lang-dotnet="`Sid`" pulumi-lang-go="`sid`" pulumi-lang-python="`sid`" pulumi-lang-yaml="`sid`" pulumi-lang-java="`sid`">`sid`</span> from <span pulumi-lang-nodejs="`sourcePolicyDocuments`" pulumi-lang-dotnet="`SourcePolicyDocuments`" pulumi-lang-go="`sourcePolicyDocuments`" pulumi-lang-python="`source_policy_documents`" pulumi-lang-yaml="`sourcePolicyDocuments`" pulumi-lang-java="`sourcePolicyDocuments`">`source_policy_documents`</span>.  Non-overriding statements will be added to the exported document.
  ...
  /// List of IAM policy documents that are merged together into the exported document. Statements defined in <span pulumi-lang-nodejs="`sourcePolicyDocuments`" pulumi-lang-dotnet="`SourcePolicyDocuments`" pulumi-lang-go="`sourcePolicyDocuments`" pulumi-lang-python="`source_policy_documents`" pulumi-lang-yaml="`sourcePolicyDocuments`" pulumi-lang-java="`sourcePolicyDocuments`">`source_policy_documents`</span> must have unique <span pulumi-lang-nodejs="`sid`" pulumi-lang-dotnet="`Sid`" pulumi-lang-go="`sid`" pulumi-lang-python="`sid`" pulumi-lang-yaml="`sid`" pulumi-lang-java="`sid`">`sid`</span>s. Statements with the same <span pulumi-lang-nodejs="`sid`" pulumi-lang-dotnet="`Sid`" pulumi-lang-go="`sid`" pulumi-lang-python="`sid`" pulumi-lang-yaml="`sid`" pulumi-lang-java="`sid`">`sid`</span> from <span pulumi-lang-nodejs="`overridePolicyDocuments`" pulumi-lang-dotnet="`OverridePolicyDocuments`" pulumi-lang-go="`overridePolicyDocuments`" pulumi-lang-python="`override_policy_documents`" pulumi-lang-yaml="`overridePolicyDocuments`" pulumi-lang-java="`overridePolicyDocuments`">`override_policy_documents`</span> will override source statements.
