...
/// <span pulumi-lang-nodejs="`aws.iam.GroupMembership`" pulumi-lang-dotnet="`aws.iam.GroupMembership`" pulumi-lang-go="`iam.GroupMembership`" pulumi-lang-python="`iam.GroupMembership`" pulumi-lang-yaml="`aws.iam.GroupMembership`" pulumi-lang-java="`aws.iam.GroupMembership`">`aws.iam.GroupMembership`</span> resource.
///
/// ## Example Usage
///
