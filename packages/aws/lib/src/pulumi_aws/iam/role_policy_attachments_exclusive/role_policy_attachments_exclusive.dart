...
///
/// !> This resource takes exclusive ownership over managed IAM policies attached to a role. This includes removal of managed IAM policies which are not explicitly configured. To prevent persistent drift, ensure any <span pulumi-lang-nodejs="`aws.iam.RolePolicyAttachment`" pulumi-lang-dotnet="`aws.iam.RolePolicyAttachment`" pulumi-lang-go="`iam.RolePolicyAttachment`" pulumi-lang-python="`iam.RolePolicyAttachment`" pulumi-lang-yaml="`aws.iam.RolePolicyAttachment`" pulumi-lang-java="`aws.iam.RolePolicyAttachment`">`aws.iam.RolePolicyAttachment`</span> resources managed alongside this resource are included in the <span pulumi-lang-nodejs="`policyArns`" pulumi-lang-dotnet="`PolicyArns`" pulumi-lang-go="`policyArns`" pulumi-lang-python="`policy_arns`" pulumi-lang-yaml="`policyArns`" pulumi-lang-java="`policyArns`">`policy_arns`</span> argument.
///
...
/// ## Import
///
/// Using `pulumi import`, import exclusive management of managed IAM policy assignments using the <span pulumi-lang-nodejs="`roleName`" pulumi-lang-dotnet="`RoleName`" pulumi-lang-go="`roleName`" pulumi-lang-python="`role_name`" pulumi-lang-yaml="`roleName`" pulumi-lang-java="`roleName`">`role_name`</span>. For example:
///
/// ```sh
