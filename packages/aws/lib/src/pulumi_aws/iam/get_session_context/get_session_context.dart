...
/// This data source provides information on the IAM source role of an STS assumed role. For non-role ARNs, this data source simply passes the ARN through in <span pulumi-lang-nodejs="`issuerArn`" pulumi-lang-dotnet="`IssuerArn`" pulumi-lang-go="`issuerArn`" pulumi-lang-python="`issuer_arn`" pulumi-lang-yaml="`issuerArn`" pulumi-lang-java="`issuerArn`">`issuer_arn`</span>.
///
...
///
/// Combined with <span pulumi-lang-nodejs="`aws.getCallerIdentity`" pulumi-lang-dotnet="`aws.getCallerIdentity`" pulumi-lang-go="`getCallerIdentity`" pulumi-lang-python="`get_caller_identity`" pulumi-lang-yaml="`aws.getCallerIdentity`" pulumi-lang-java="`aws.getCallerIdentity`">`aws.getCallerIdentity`</span>, you can get the current user's source IAM role ARN (<span pulumi-lang-nodejs="`issuerArn`" pulumi-lang-dotnet="`IssuerArn`" pulumi-lang-go="`issuerArn`" pulumi-lang-python="`issuer_arn`" pulumi-lang-yaml="`issuerArn`" pulumi-lang-java="`issuerArn`">`issuer_arn`</span>) if you're using an assumed role. If you're not using an assumed role, the caller's (e.g., an IAM user's) ARN will simply be passed through. In environments where both IAM users and individuals using assumed roles need to apply the same configurations, this data source enables seamless use.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
