...
import '../application_initial_capacity_initial_capacity_config_worker_configuration/application_initial_capacity_initial_capacity_config_worker_configuration.dart';
...
class ApplicationInitialCapacityInitialCapacityConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (workerConfigurationValue != null) {
      map['workerConfiguration'] = workerConfigurationValue.toMap();
    }
