...
import '../service_source_configuration_code_repository_code_configuration/service_source_configuration_code_repository_code_configuration.dart';
import '../service_source_configuration_code_repository_source_code_version/service_source_configuration_code_repository_source_code_version.dart';
...
class ServiceSourceConfigurationCodeRepository {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['sourceCodeVersion'] = sourceCodeVersion.toMap();
    final sourceDirectoryValue = sourceDirectory;
    if (sourceDirectoryValue != null) {
      map['sourceDirectory'] = sourceDirectoryValue;
    }
    return map;
  }
