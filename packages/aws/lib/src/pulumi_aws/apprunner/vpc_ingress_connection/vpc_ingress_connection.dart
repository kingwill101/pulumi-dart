...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the App Runner VPC ingress connection.
///
///
/// Using `pulumi import`, import App Runner VPC Ingress Connection using the <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
...
class VpcIngressConnection extends CustomResource {
  ...
  VpcIngressConnection(
    ...
    this.ingressVpcConfiguration =
        Output.createUnknown<VpcIngressConnectionIngressVpcConfiguration>();
