...
/// ## Import
///
/// Using `pulumi import`, import WorkSpaces Web Trust Store using the <span pulumi-lang-nodejs="`trustStoreArn`" pulumi-lang-dotnet="`TrustStoreArn`" pulumi-lang-go="`trustStoreArn`" pulumi-lang-python="`trust_store_arn`" pulumi-lang-yaml="`trustStoreArn`" pulumi-lang-java="`trustStoreArn`">`trust_store_arn`</span>. For example:
///
/// ```sh
