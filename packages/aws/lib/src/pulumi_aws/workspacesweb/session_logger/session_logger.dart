...
/// ## Import
///
/// Using `pulumi import`, import WorkSpaces Web Session Logger using the <span pulumi-lang-nodejs="`sessionLoggerArn`" pulumi-lang-dotnet="`SessionLoggerArn`" pulumi-lang-go="`sessionLoggerArn`" pulumi-lang-python="`session_logger_arn`" pulumi-lang-yaml="`sessionLoggerArn`" pulumi-lang-java="`sessionLoggerArn`">`session_logger_arn`</span>. For example:
///
/// ```sh
