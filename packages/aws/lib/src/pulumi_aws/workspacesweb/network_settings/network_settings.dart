...
/// ## Import
///
/// Using `pulumi import`, import WorkSpaces Web Network Settings using the <span pulumi-lang-nodejs="`networkSettingsArn`" pulumi-lang-dotnet="`NetworkSettingsArn`" pulumi-lang-go="`networkSettingsArn`" pulumi-lang-python="`network_settings_arn`" pulumi-lang-yaml="`networkSettingsArn`" pulumi-lang-java="`networkSettingsArn`">`network_settings_arn`</span>. For example:
///
/// ```sh
