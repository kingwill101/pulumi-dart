...
/// ## Import
///
/// Using `pulumi import`, import WorkSpaces Web IP Access Settings using the <span pulumi-lang-nodejs="`ipAccessSettingsArn`" pulumi-lang-dotnet="`IpAccessSettingsArn`" pulumi-lang-go="`ipAccessSettingsArn`" pulumi-lang-python="`ip_access_settings_arn`" pulumi-lang-yaml="`ipAccessSettingsArn`" pulumi-lang-java="`ipAccessSettingsArn`">`ip_access_settings_arn`</span>. For example:
///
/// ```sh
