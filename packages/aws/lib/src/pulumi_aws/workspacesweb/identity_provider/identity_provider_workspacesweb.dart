...
import 'identity_provider_workspacesweb_args.dart';
...
/// ```
class IdentityProviderWorkspacesweb extends pulumi.CustomResource {
  ...
  IdentityProviderWorkspacesweb(
    String name, {
    IdentityProviderWorkspaceswebArgs? args,
