...
///
/// > **NOTE:** A permission set can have at most one permissions boundary attached; using more than one <span pulumi-lang-nodejs="`aws.ssoadmin.PermissionsBoundaryAttachment`" pulumi-lang-dotnet="`aws.ssoadmin.PermissionsBoundaryAttachment`" pulumi-lang-go="`ssoadmin.PermissionsBoundaryAttachment`" pulumi-lang-python="`ssoadmin.PermissionsBoundaryAttachment`" pulumi-lang-yaml="`aws.ssoadmin.PermissionsBoundaryAttachment`" pulumi-lang-java="`aws.ssoadmin.PermissionsBoundaryAttachment`">`aws.ssoadmin.PermissionsBoundaryAttachment`</span> references the same permission set will show a permanent difference.
///
/// ## Example Usage
///
...
/// ## Import
///
/// Using `pulumi import`, import SSO Admin Permissions Boundary Attachments using the <span pulumi-lang-nodejs="`permissionSetArn`" pulumi-lang-dotnet="`PermissionSetArn`" pulumi-lang-go="`permissionSetArn`" pulumi-lang-python="`permission_set_arn`" pulumi-lang-yaml="`permissionSetArn`" pulumi-lang-java="`permissionSetArn`">`permission_set_arn`</span> and <span pulumi-lang-nodejs="`instanceArn`" pulumi-lang-dotnet="`InstanceArn`" pulumi-lang-go="`instanceArn`" pulumi-lang-python="`instance_arn`" pulumi-lang-yaml="`instanceArn`" pulumi-lang-java="`instanceArn`">`instance_arn`</span>, separated by a comma (`,`). For example:
///
/// ```sh
