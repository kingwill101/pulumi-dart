...
///
/// !> **WARNING:** Do not use this resource together with the <span pulumi-lang-nodejs="`aws.ssoadmin.ManagedPolicyAttachmentsExclusive`" pulumi-lang-dotnet="`aws.ssoadmin.ManagedPolicyAttachmentsExclusive`" pulumi-lang-go="`ssoadmin.ManagedPolicyAttachmentsExclusive`" pulumi-lang-python="`ssoadmin.ManagedPolicyAttachmentsExclusive`" pulumi-lang-yaml="`aws.ssoadmin.ManagedPolicyAttachmentsExclusive`" pulumi-lang-java="`aws.ssoadmin.ManagedPolicyAttachmentsExclusive`">`aws.ssoadmin.ManagedPolicyAttachmentsExclusive`</span> resource for the same permission set. Doing so will cause a conflict and will lead to managed policies being removed.
///
/// ## Example Usage
///
/// ### Basic Usage
...
/// ## Import
///
/// Using `pulumi import`, import SSO Managed Policy Attachments using the <span pulumi-lang-nodejs="`managedPolicyArn`" pulumi-lang-dotnet="`ManagedPolicyArn`" pulumi-lang-go="`managedPolicyArn`" pulumi-lang-python="`managed_policy_arn`" pulumi-lang-yaml="`managedPolicyArn`" pulumi-lang-java="`managedPolicyArn`">`managed_policy_arn`</span>, <span pulumi-lang-nodejs="`permissionSetArn`" pulumi-lang-dotnet="`PermissionSetArn`" pulumi-lang-go="`permissionSetArn`" pulumi-lang-python="`permission_set_arn`" pulumi-lang-yaml="`permissionSetArn`" pulumi-lang-java="`permissionSetArn`">`permission_set_arn`</span>, and <span pulumi-lang-nodejs="`instanceArn`" pulumi-lang-dotnet="`InstanceArn`" pulumi-lang-go="`instanceArn`" pulumi-lang-python="`instance_arn`" pulumi-lang-yaml="`instanceArn`" pulumi-lang-java="`instanceArn`">`instance_arn`</span> separated by a comma (`,`). For example:
///
/// ```sh
