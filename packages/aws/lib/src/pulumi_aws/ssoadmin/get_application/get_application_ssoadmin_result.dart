...
class GetApplicationSsoadminResult {
  /// AWS account ID.
  ...
  factory GetApplicationSsoadminResult.fromMap(Map<String, dynamic> map) {
    return GetApplicationSsoadminResult(
