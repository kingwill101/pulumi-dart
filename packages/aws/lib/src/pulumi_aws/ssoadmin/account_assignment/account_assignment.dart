...
///
/// > Because destruction of a managed policy attachment resource also re-provisions the associated permission set to all accounts, explicitly indicating the dependency with the account assignment resource via the <span pulumi-lang-nodejs="`dependsOn`" pulumi-lang-dotnet="`DependsOn`" pulumi-lang-go="`dependsOn`" pulumi-lang-python="`depends_on`" pulumi-lang-yaml="`dependsOn`" pulumi-lang-java="`dependsOn`">`depends_on`</span> meta argument is necessary to ensure proper deletion order when these resources are used together.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import SSO Account Assignments using the <span pulumi-lang-nodejs="`principalId`" pulumi-lang-dotnet="`PrincipalId`" pulumi-lang-go="`principalId`" pulumi-lang-python="`principal_id`" pulumi-lang-yaml="`principalId`" pulumi-lang-java="`principalId`">`principal_id`</span>, <span pulumi-lang-nodejs="`principalType`" pulumi-lang-dotnet="`PrincipalType`" pulumi-lang-go="`principalType`" pulumi-lang-python="`principal_type`" pulumi-lang-yaml="`principalType`" pulumi-lang-java="`principalType`">`principal_type`</span>, <span pulumi-lang-nodejs="`targetId`" pulumi-lang-dotnet="`TargetId`" pulumi-lang-go="`targetId`" pulumi-lang-python="`target_id`" pulumi-lang-yaml="`targetId`" pulumi-lang-java="`targetId`">`target_id`</span>, <span pulumi-lang-nodejs="`targetType`" pulumi-lang-dotnet="`TargetType`" pulumi-lang-go="`targetType`" pulumi-lang-python="`target_type`" pulumi-lang-yaml="`targetType`" pulumi-lang-java="`targetType`">`target_type`</span>, <span pulumi-lang-nodejs="`permissionSetArn`" pulumi-lang-dotnet="`PermissionSetArn`" pulumi-lang-go="`permissionSetArn`" pulumi-lang-python="`permission_set_arn`" pulumi-lang-yaml="`permissionSetArn`" pulumi-lang-java="`permissionSetArn`">`permission_set_arn`</span>, <span pulumi-lang-nodejs="`instanceArn`" pulumi-lang-dotnet="`InstanceArn`" pulumi-lang-go="`instanceArn`" pulumi-lang-python="`instance_arn`" pulumi-lang-yaml="`instanceArn`" pulumi-lang-java="`instanceArn`">`instance_arn`</span> separated by commas (`,`). For example:
///
/// ```sh
