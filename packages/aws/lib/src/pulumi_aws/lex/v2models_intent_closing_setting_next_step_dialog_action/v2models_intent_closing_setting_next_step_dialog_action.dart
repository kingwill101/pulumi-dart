...
class V2modelsIntentClosingSettingNextStepDialogAction {
  ...
  factory V2modelsIntentClosingSettingNextStepDialogAction.fromMap(
      Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingNextStepDialogAction(
      slotToElicit:
