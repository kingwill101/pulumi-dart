...
class V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue {
  ...
  factory V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue.fromMap(
      Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue(
