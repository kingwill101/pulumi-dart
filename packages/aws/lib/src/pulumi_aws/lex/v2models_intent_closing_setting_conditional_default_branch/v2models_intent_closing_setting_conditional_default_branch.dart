...
import '../v2models_intent_closing_setting_conditional_default_branch_next_step/v2models_intent_closing_setting_conditional_default_branch_next_step.dart';
import '../v2models_intent_closing_setting_conditional_default_branch_response/v2models_intent_closing_setting_conditional_default_branch_response.dart';
...
class V2modelsIntentClosingSettingConditionalDefaultBranch {
  ...
  final V2modelsIntentClosingSettingConditionalDefaultBranchNextStep? nextStep;
  ...
  final V2modelsIntentClosingSettingConditionalDefaultBranchResponse? response;
  ...
  factory V2modelsIntentClosingSettingConditionalDefaultBranch.fromMap(
