...
import '../v2models_intent_confirmation_setting_prompt_specification_message_group_message/v2models_intent_confirmation_setting_prompt_specification_message_group_message.dart';
import '../v2models_intent_confirmation_setting_prompt_specification_message_group_variation/v2models_intent_confirmation_setting_prompt_specification_message_group_variation.dart';

class V2modelsIntentConfirmationSettingPromptSpecificationMessageGroup {
  /// Configuration block for the primary message that Amazon Lex should send to the user. See `message`.
  final V2modelsIntentConfirmationSettingPromptSpecificationMessageGroupMessage?
      message;
