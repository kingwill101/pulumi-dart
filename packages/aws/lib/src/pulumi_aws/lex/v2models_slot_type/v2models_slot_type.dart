...
///
/// ###<span pulumi-lang-nodejs=" valueSelectionSetting " pulumi-lang-dotnet=" ValueSelectionSetting " pulumi-lang-go=" valueSelectionSetting " pulumi-lang-python=" value_selection_setting " pulumi-lang-yaml=" valueSelectionSetting " pulumi-lang-java=" valueSelectionSetting "> value_selection_setting </span>Usage
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import Lex V2 Models Slot Type using using a comma-delimited string concatenating <span pulumi-lang-nodejs="`botId`" pulumi-lang-dotnet="`BotId`" pulumi-lang-go="`botId`" pulumi-lang-python="`bot_id`" pulumi-lang-yaml="`botId`" pulumi-lang-java="`botId`">`bot_id`</span>, <span pulumi-lang-nodejs="`botVersion`" pulumi-lang-dotnet="`BotVersion`" pulumi-lang-go="`botVersion`" pulumi-lang-python="`bot_version`" pulumi-lang-yaml="`botVersion`" pulumi-lang-java="`botVersion`">`bot_version`</span>, <span pulumi-lang-nodejs="`localeId`" pulumi-lang-dotnet="`LocaleId`" pulumi-lang-go="`localeId`" pulumi-lang-python="`locale_id`" pulumi-lang-yaml="`localeId`" pulumi-lang-java="`localeId`">`locale_id`</span>, and <span pulumi-lang-nodejs="`slotTypeId`" pulumi-lang-dotnet="`SlotTypeId`" pulumi-lang-go="`slotTypeId`" pulumi-lang-python="`slot_type_id`" pulumi-lang-yaml="`slotTypeId`" pulumi-lang-java="`slotTypeId`">`slot_type_id`</span>. For example:
///
/// ```sh
