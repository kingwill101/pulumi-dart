...
class V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction {
  ...
  factory V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.fromMap(
      Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction(
      slotToElicit:
