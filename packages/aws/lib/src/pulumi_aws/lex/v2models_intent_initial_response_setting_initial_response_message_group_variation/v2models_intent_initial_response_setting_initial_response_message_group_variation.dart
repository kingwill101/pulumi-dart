...
import '../v2models_intent_initial_response_setting_initial_response_message_group_variation_custom_payload/v2models_intent_initial_response_setting_initial_response_message_group_variation_custom_payload.dart';
import '../v2models_intent_initial_response_setting_initial_response_message_group_variation_image_response_card/v2models_intent_initial_response_setting_initial_response_message_group_variation_image_response_card.dart';
import '../v2models_intent_initial_response_setting_initial_response_message_group_variation_plain_text_message/v2models_intent_initial_response_setting_initial_response_message_group_variation_plain_text_message.dart';
import '../v2models_intent_initial_response_setting_initial_response_message_group_variation_ssml_message/v2models_intent_initial_response_setting_initial_response_message_group_variation_ssml_message.dart';

class V2modelsIntentInitialResponseSettingInitialResponseMessageGroupVariation {
  /// Configuration block for a message in a custom format defined by the client application. See `custom_payload`.
  final V2modelsIntentInitialResponseSettingInitialResponseMessageGroupVariationCustomPayload?
      customPayload;

  /// Configuration block for a message that defines a response card that the client application can show to the user. See `image_response_card`.
  final V2modelsIntentInitialResponseSettingInitialResponseMessageGroupVariationImageResponseCard?
      imageResponseCard;

  /// Configuration block for a message in plain text format. See `plain_text_message`.
  final V2modelsIntentInitialResponseSettingInitialResponseMessageGroupVariationPlainTextMessage?
      plainTextMessage;

  /// Configuration block for a message in Speech Synthesis Markup Language (SSML). See `ssml_message`.
  final V2modelsIntentInitialResponseSettingInitialResponseMessageGroupVariationSsmlMessage?
      ssmlMessage;
  ...
  factory V2modelsIntentInitialResponseSettingInitialResponseMessageGroupVariation.fromMap(
