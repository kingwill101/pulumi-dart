...
///
/// ### <span pulumi-lang-nodejs="`confirmationSetting`" pulumi-lang-dotnet="`ConfirmationSetting`" pulumi-lang-go="`confirmationSetting`" pulumi-lang-python="`confirmation_setting`" pulumi-lang-yaml="`confirmationSetting`" pulumi-lang-java="`confirmationSetting`">`confirmation_setting`</span> Example
///
/// When using <span pulumi-lang-nodejs="`confirmationSetting`" pulumi-lang-dotnet="`ConfirmationSetting`" pulumi-lang-go="`confirmationSetting`" pulumi-lang-python="`confirmation_setting`" pulumi-lang-yaml="`confirmationSetting`" pulumi-lang-java="`confirmationSetting`">`confirmation_setting`</span>, if you do not provide a <span pulumi-lang-nodejs="`promptAttemptsSpecification`" pulumi-lang-dotnet="`PromptAttemptsSpecification`" pulumi-lang-go="`promptAttemptsSpecification`" pulumi-lang-python="`prompt_attempts_specification`" pulumi-lang-yaml="`promptAttemptsSpecification`" pulumi-lang-java="`promptAttemptsSpecification`">`prompt_attempts_specification`</span>, AWS Lex will provide default <span pulumi-lang-nodejs="`promptAttemptsSpecification`" pulumi-lang-dotnet="`PromptAttemptsSpecification`" pulumi-lang-go="`promptAttemptsSpecification`" pulumi-lang-python="`prompt_attempts_specification`" pulumi-lang-yaml="`promptAttemptsSpecification`" pulumi-lang-java="`promptAttemptsSpecification`">`prompt_attempts_specification`</span>s. As a result, Terraform will report a difference in the configuration. To avoid this behavior, include the default <span pulumi-lang-nodejs="`promptAttemptsSpecification`" pulumi-lang-dotnet="`PromptAttemptsSpecification`" pulumi-lang-go="`promptAttemptsSpecification`" pulumi-lang-python="`prompt_attempts_specification`" pulumi-lang-yaml="`promptAttemptsSpecification`" pulumi-lang-java="`promptAttemptsSpecification`">`prompt_attempts_specification`</span> configuration shown below.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
