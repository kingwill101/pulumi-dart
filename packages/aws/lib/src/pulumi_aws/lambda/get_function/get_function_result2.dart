...
class GetFunctionResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['arn'] = arn;
    map['capacityProviderConfigs'] = Input.encodeList<
    ...
    map['durableConfigs'] =
        Input.encodeList<GetFunctionDurableConfig, Map<String, dynamic>>(
            durableConfigs, (value) => value.toMap());
    map['environment'] = environment.toMap();
    map['ephemeralStorages'] =
        Input.encodeList<GetFunctionEphemeralStorage, Map<String, dynamic>>(
            ephemeralStorages, (value) => value.toMap());
    map['fileSystemConfigs'] =
        Input.encodeList<GetFunctionFileSystemConfig, Map<String, dynamic>>(
    ...
    map['layers'] = layers;
    map['loggingConfigs'] =
        Input.encodeList<GetFunctionLoggingConfig, Map<String, dynamic>>(
    ...
    map['tags'] = tags;
    map['tenancyConfigs'] =
        Input.encodeList<GetFunctionTenancyConfig, Map<String, dynamic>>(
  ...
  factory GetFunctionResult2.fromMap(Map<String, dynamic> map) {
    return GetFunctionResult2(
      ...
      capacityProviderConfigs:
          Input.decodeList<GetFunctionCapacityProviderConfig>(
      ...
      durableConfigs: Input.decodeList<GetFunctionDurableConfig>(
          map['durableConfigs'],
      ...
      ephemeralStorages: Input.decodeList<GetFunctionEphemeralStorage>(
          map['ephemeralStorages'],
          (value) => GetFunctionEphemeralStorage.fromMap(
              (value as Map).cast<String, dynamic>())),
      fileSystemConfigs: Input.decodeList<GetFunctionFileSystemConfig>(
          map['fileSystemConfigs'],
      ...
      loggingConfigs: Input.decodeList<GetFunctionLoggingConfig>(
          map['loggingConfigs'],
      ...
      tenancyConfigs: Input.decodeList<GetFunctionTenancyConfig>(
          map['tenancyConfigs'],
