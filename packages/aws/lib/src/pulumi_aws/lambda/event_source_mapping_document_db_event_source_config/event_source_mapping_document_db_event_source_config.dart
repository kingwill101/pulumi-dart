...
class EventSourceMappingDocumentDbEventSourceConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final collectionNameValue = collectionName;
    if (collectionNameValue != null) {
      map['collectionName'] = collectionNameValue;
    }
    map['databaseName'] = databaseName;
    final fullDocumentValue = fullDocument;
    if (fullDocumentValue != null) {
      map['fullDocument'] = fullDocumentValue;
    }
    return map;
  }

  factory EventSourceMappingDocumentDbEventSourceConfig.fromMap(
    ...
    return EventSourceMappingDocumentDbEventSourceConfig(
      ...
      fullDocument:
          map['fullDocument'] == null ? null : map['fullDocument'] as String,
    );
  }
}
