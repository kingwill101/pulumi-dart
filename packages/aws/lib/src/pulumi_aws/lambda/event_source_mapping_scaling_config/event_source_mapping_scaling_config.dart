...
class EventSourceMappingScalingConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final maximumConcurrencyValue = maximumConcurrency;
    if (maximumConcurrencyValue != null) {
      map['maximumConcurrency'] = maximumConcurrencyValue;
    }
    return map;
  }
  ...
  factory EventSourceMappingScalingConfig.fromMap(Map<String, dynamic> map) {
    return EventSourceMappingScalingConfig(
      maximumConcurrency: map['maximumConcurrency'] == null
          ? null
