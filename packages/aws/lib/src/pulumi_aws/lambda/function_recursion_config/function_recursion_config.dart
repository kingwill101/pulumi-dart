...
///
/// > **Note:** Destruction of this resource will return the <span pulumi-lang-nodejs="`recursiveLoop`" pulumi-lang-dotnet="`RecursiveLoop`" pulumi-lang-go="`recursiveLoop`" pulumi-lang-python="`recursive_loop`" pulumi-lang-yaml="`recursiveLoop`" pulumi-lang-java="`recursiveLoop`">`recursive_loop`</span> configuration back to the default value of `Terminate`.
///
/// ## Example Usage
///
