...
class CodeSigningConfigArgs {
  ...
  final Input<CodeSigningConfigAllowedPublishers> allowedPublishers;
  ...
  final Input<CodeSigningConfigPolicies>? policies;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['allowedPublishers'] = Input.mapInputValue<
    ...
    if (policiesValue != null) {
      map['policies'] = Input.mapOptionalInputValue<CodeSigningConfigPolicies,
  ...
  factory CodeSigningConfigArgs.fromMap(Map<String, dynamic> map) {
    return CodeSigningConfigArgs(
      allowedPublishers: Input.asInput<CodeSigningConfigAllowedPublishers>(
          map['allowedPublishers']),
      description: Input.asOptionalInput<String>(map['description']),
      policies:
          Input.asOptionalInput<CodeSigningConfigPolicies>(map['policies']),
