...
import 'capacity_provider_lambda_args.dart';
...
/// ```
class CapacityProviderLambda extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CapacityProviderCapacityProviderScalingConfig>>
      capacityProviderScalingConfigs;

  /// Configuration block for instance requirements settings. See Instance Requirements below.
  late final pulumi.Output<List<CapacityProviderInstanceRequirement>>
  ...
  CapacityProviderLambda(
    String name, {
    CapacityProviderLambdaArgs? args,
