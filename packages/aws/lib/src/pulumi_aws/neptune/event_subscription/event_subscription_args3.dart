...
class EventSubscriptionArgs3 {
  /// A boolean flag to enable/disable the subscription. Defaults to true.
  final Input<bool>? enabled;

  /// A list of event categories for a <span pulumi-lang-nodejs="`sourceType`" pulumi-lang-dotnet="`SourceType`" pulumi-lang-go="`sourceType`" pulumi-lang-python="`source_type`" pulumi-lang-yaml="`sourceType`" pulumi-lang-java="`sourceType`">`source_type`</span> that you want to subscribe to. Run `aws neptune describe-event-categories` to find all the event categories.
  ...
  /// The name of the Neptune event subscription. Conflicts with <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>.
  ...
  factory EventSubscriptionArgs3.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionArgs3(
