...
class EventSubscriptionNeptuneArgs {
  ...
  factory EventSubscriptionNeptuneArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionNeptuneArgs(
