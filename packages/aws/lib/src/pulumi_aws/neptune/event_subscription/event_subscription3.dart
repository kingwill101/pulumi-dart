...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.neptune.EventSubscription`" pulumi-lang-dotnet="`aws.neptune.EventSubscription`" pulumi-lang-go="`neptune.EventSubscription`" pulumi-lang-python="`neptune.EventSubscription`" pulumi-lang-yaml="`aws.neptune.EventSubscription`" pulumi-lang-java="`aws.neptune.EventSubscription`">`aws.neptune.EventSubscription`</span> using the event subscription name. For example:
///
/// ```sh
