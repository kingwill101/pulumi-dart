...
import 'event_subscription_neptune_args.dart';
...
/// ```
class EventSubscriptionNeptune extends pulumi.CustomResource {
  ...
  EventSubscriptionNeptune(
    String name, {
    EventSubscriptionNeptuneArgs? args,
