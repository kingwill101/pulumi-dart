...
class GetOrderableDbInstanceNeptuneArgs {
  ...
  GetOrderableDbInstanceNeptuneArgs({
    this.engine,
    this.engineVersion,
    this.instanceClass,
    this.licenseModel,
  ...
  factory GetOrderableDbInstanceNeptuneArgs.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceNeptuneArgs(
