...
class GetOrderableDbInstanceNeptuneResult {
  ...
  GetOrderableDbInstanceNeptuneResult({
  ...
  factory GetOrderableDbInstanceNeptuneResult.fromMap(
      Map<String, dynamic> map) {
    return GetOrderableDbInstanceNeptuneResult(
