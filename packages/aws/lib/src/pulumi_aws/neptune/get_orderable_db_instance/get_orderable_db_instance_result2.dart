...
class GetOrderableDbInstanceResult2 {
  ...
  factory GetOrderableDbInstanceResult2.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceResult2(
