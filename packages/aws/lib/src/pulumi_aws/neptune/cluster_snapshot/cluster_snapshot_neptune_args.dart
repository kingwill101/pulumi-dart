...
class ClusterSnapshotNeptuneArgs {
  ...
  factory ClusterSnapshotNeptuneArgs.fromMap(Map<String, dynamic> map) {
    return ClusterSnapshotNeptuneArgs(
      dbClusterIdentifier:
