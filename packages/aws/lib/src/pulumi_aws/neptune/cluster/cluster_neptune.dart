...
import 'cluster_neptune_args.dart';
...
/// ```
class ClusterNeptune extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ClusterServerlessV2ScalingConfigurationNeptune?>
  ...
  ClusterNeptune(
    ...
    this.serverlessV2ScalingConfiguration =
        registerOutput<ClusterServerlessV2ScalingConfigurationNeptune?>(
            'serverlessV2ScalingConfiguration');
