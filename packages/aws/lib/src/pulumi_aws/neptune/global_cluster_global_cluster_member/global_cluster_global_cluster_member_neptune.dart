...
class GlobalClusterGlobalClusterMemberNeptune {
  ...
  GlobalClusterGlobalClusterMemberNeptune({
    this.dbClusterArn,
    this.isWriter,
  });
  ...
  factory GlobalClusterGlobalClusterMemberNeptune.fromMap(
      Map<String, dynamic> map) {
    return GlobalClusterGlobalClusterMemberNeptune(
      dbClusterArn:
