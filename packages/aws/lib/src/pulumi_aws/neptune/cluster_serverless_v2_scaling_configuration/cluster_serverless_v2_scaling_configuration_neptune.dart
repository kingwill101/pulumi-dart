...
class ClusterServerlessV2ScalingConfigurationNeptune {
  ...
  factory ClusterServerlessV2ScalingConfigurationNeptune.fromMap(
      Map<String, dynamic> map) {
    return ClusterServerlessV2ScalingConfigurationNeptune(
      maxCapacity:
