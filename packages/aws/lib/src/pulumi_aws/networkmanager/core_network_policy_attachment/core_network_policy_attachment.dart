...
/// - Option 2: Pass a list of regions to the <span pulumi-lang-nodejs="`aws.networkmanager.CoreNetwork`" pulumi-lang-dotnet="`aws.networkmanager.CoreNetwork`" pulumi-lang-go="`networkmanager.CoreNetwork`" pulumi-lang-python="`networkmanager.CoreNetwork`" pulumi-lang-yaml="`aws.networkmanager.CoreNetwork`" pulumi-lang-java="`aws.networkmanager.CoreNetwork`">`aws.networkmanager.CoreNetwork`</span> resource <span pulumi-lang-nodejs="`basePolicyRegions`" pulumi-lang-dotnet="`BasePolicyRegions`" pulumi-lang-go="`basePolicyRegions`" pulumi-lang-python="`base_policy_regions`" pulumi-lang-yaml="`basePolicyRegions`" pulumi-lang-java="`basePolicyRegions`">`base_policy_regions`</span> argument. In the example below, `us-west-2` and `us-east-1` are specified in the base policy.
///
/// ### Option 1 - using<span pulumi-lang-nodejs=" basePolicyDocument
/// " pulumi-lang-dotnet=" BasePolicyDocument
/// " pulumi-lang-go=" basePolicyDocument
...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.networkmanager.CoreNetworkPolicyAttachment`" pulumi-lang-dotnet="`aws.networkmanager.CoreNetworkPolicyAttachment`" pulumi-lang-go="`networkmanager.CoreNetworkPolicyAttachment`" pulumi-lang-python="`networkmanager.CoreNetworkPolicyAttachment`" pulumi-lang-yaml="`aws.networkmanager.CoreNetworkPolicyAttachment`" pulumi-lang-java="`aws.networkmanager.CoreNetworkPolicyAttachment`">`aws.networkmanager.CoreNetworkPolicyAttachment`</span> using the core network ID. For example:
///
/// ```sh
