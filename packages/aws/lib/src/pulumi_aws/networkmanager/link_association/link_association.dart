...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.networkmanager.LinkAssociation`" pulumi-lang-dotnet="`aws.networkmanager.LinkAssociation`" pulumi-lang-go="`networkmanager.LinkAssociation`" pulumi-lang-python="`networkmanager.LinkAssociation`" pulumi-lang-yaml="`aws.networkmanager.LinkAssociation`" pulumi-lang-java="`aws.networkmanager.LinkAssociation`">`aws.networkmanager.LinkAssociation`</span> using the global network ID, link ID and device ID. For example:
///
/// ```sh
