...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.networkmanager.SiteToSiteVpnAttachment`" pulumi-lang-dotnet="`aws.networkmanager.SiteToSiteVpnAttachment`" pulumi-lang-go="`networkmanager.SiteToSiteVpnAttachment`" pulumi-lang-python="`networkmanager.SiteToSiteVpnAttachment`" pulumi-lang-yaml="`aws.networkmanager.SiteToSiteVpnAttachment`" pulumi-lang-java="`aws.networkmanager.SiteToSiteVpnAttachment`">`aws.networkmanager.SiteToSiteVpnAttachment`</span> using the attachment ID. For example:
///
/// ```sh
/// $ pulumi import aws:networkmanager/siteToSiteVpnAttachment:SiteToSiteVpnAttachment example attachment-0f8fa60d2238d1bd8
/// ```
class SiteToSiteVpnAttachment extends CustomResource {
  ...
  late final Output<String> vpnConnectionArn;
  ...
  SiteToSiteVpnAttachment(
    ...
    this.vpnConnectionArn = Output.createUnknown<String>();
  }
}
