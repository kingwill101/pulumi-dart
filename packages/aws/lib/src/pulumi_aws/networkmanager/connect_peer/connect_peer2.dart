...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.networkmanager.ConnectPeer`" pulumi-lang-dotnet="`aws.networkmanager.ConnectPeer`" pulumi-lang-go="`networkmanager.ConnectPeer`" pulumi-lang-python="`networkmanager.ConnectPeer`" pulumi-lang-yaml="`aws.networkmanager.ConnectPeer`" pulumi-lang-java="`aws.networkmanager.ConnectPeer`">`aws.networkmanager.ConnectPeer`</span> using the connect peer ID. For example:
///
/// ```sh
