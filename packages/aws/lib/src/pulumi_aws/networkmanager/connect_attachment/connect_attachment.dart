...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.networkmanager.ConnectAttachment`" pulumi-lang-dotnet="`aws.networkmanager.ConnectAttachment`" pulumi-lang-go="`networkmanager.ConnectAttachment`" pulumi-lang-python="`networkmanager.ConnectAttachment`" pulumi-lang-yaml="`aws.networkmanager.ConnectAttachment`" pulumi-lang-java="`aws.networkmanager.ConnectAttachment`">`aws.networkmanager.ConnectAttachment`</span> using the attachment ID. For example:
///
/// ```sh
...
class ConnectAttachment extends CustomResource {
  ...
  ConnectAttachment(
    ...
    this.options = Output.createUnknown<ConnectAttachmentOptions>();
