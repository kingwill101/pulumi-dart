...
class BrokerArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (encryptionOptionsValue != null) {
      map['encryptionOptions'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (ldapServerMetadataValue != null) {
      map['ldapServerMetadata'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (maintenanceWindowStartTimeValue != null) {
      map['maintenanceWindowStartTime'] = pulumi.Input.mapOptionalInputValue<
    ...
    map['users'] = pulumi.Input.mapInputValue<List<BrokerUser>,
            List<Map<String, dynamic>>>(
        users,
        (value) => pulumi.Input.encodeList<BrokerUser, Map<String, dynamic>>(
  ...
  factory BrokerArgs.fromMap(Map<String, dynamic> map) {
    return BrokerArgs(
      ...
      configuration: pulumi.Input.asOptionalInput<BrokerConfiguration>(
          map['configuration']),
      dataReplicationMode:
          pulumi.Input.asOptionalInput<String>(map['dataReplicationMode']),
      dataReplicationPrimaryBrokerArn: pulumi.Input.asOptionalInput<String>(
          map['dataReplicationPrimaryBrokerArn']),
      deploymentMode:
          pulumi.Input.asOptionalInput<String>(map['deploymentMode']),
      encryptionOptions: pulumi.Input.asOptionalInput<BrokerEncryptionOptions>(
      ...
      hostInstanceType: pulumi.Input.asInput<String>(map['hostInstanceType']),
      ldapServerMetadata:
          pulumi.Input.asOptionalInput<BrokerLdapServerMetadata>(
              map['ldapServerMetadata']),
      logs: pulumi.Input.asOptionalInput<BrokerLogs>(map['logs']),
      maintenanceWindowStartTime:
      ...
      users: pulumi.Input.asInput<List<BrokerUser>>(map['users']),
    );
  }
}
