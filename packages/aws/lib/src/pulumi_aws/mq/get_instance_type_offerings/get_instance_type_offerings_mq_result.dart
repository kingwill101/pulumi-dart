...
class GetInstanceTypeOfferingsMqResult {
  ...
  GetInstanceTypeOfferingsMqResult({
  ...
  factory GetInstanceTypeOfferingsMqResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypeOfferingsMqResult(
      brokerInstanceOptions:
