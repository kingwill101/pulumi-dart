...
import '../get_instance_type_offerings_broker_instance_option/get_instance_type_offerings_broker_instance_option.dart';

/// Result data returned by getInstanceTypeOfferings.
class GetInstanceTypeOfferingsResult2 {
  ...
  GetInstanceTypeOfferingsResult2({
  ...
  Map<String, dynamic> toMap() {
    ...
    map['brokerInstanceOptions'] = Input.encodeList<
  ...
  factory GetInstanceTypeOfferingsResult2.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypeOfferingsResult2(
      brokerInstanceOptions:
          Input.decodeList<GetInstanceTypeOfferingsBrokerInstanceOption>(
