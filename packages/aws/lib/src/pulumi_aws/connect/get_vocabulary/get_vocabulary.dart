...
///
/// By <span pulumi-lang-nodejs="`vocabularyId`" pulumi-lang-dotnet="`VocabularyId`" pulumi-lang-go="`vocabularyId`" pulumi-lang-python="`vocabulary_id`" pulumi-lang-yaml="`vocabularyId`" pulumi-lang-java="`vocabularyId`">`vocabulary_id`</span>
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
