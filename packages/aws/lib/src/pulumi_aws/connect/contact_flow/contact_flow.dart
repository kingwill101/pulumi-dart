...
/// ## Import
///
/// Using `pulumi import`, import Amazon Connect Contact Flows using the <span pulumi-lang-nodejs="`instanceId`" pulumi-lang-dotnet="`InstanceId`" pulumi-lang-go="`instanceId`" pulumi-lang-python="`instance_id`" pulumi-lang-yaml="`instanceId`" pulumi-lang-java="`instanceId`">`instance_id`</span> and <span pulumi-lang-nodejs="`contactFlowId`" pulumi-lang-dotnet="`ContactFlowId`" pulumi-lang-go="`contactFlowId`" pulumi-lang-python="`contact_flow_id`" pulumi-lang-yaml="`contactFlowId`" pulumi-lang-java="`contactFlowId`">`contact_flow_id`</span> separated by a colon (`:`). For example:
///
/// ```sh
