...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.connect.BotAssociation`" pulumi-lang-dotnet="`aws.connect.BotAssociation`" pulumi-lang-go="`connect.BotAssociation`" pulumi-lang-python="`connect.BotAssociation`" pulumi-lang-yaml="`aws.connect.BotAssociation`" pulumi-lang-java="`aws.connect.BotAssociation`">`aws.connect.BotAssociation`</span> using the Amazon Connect instance ID, Lex (V1) bot name, and Lex (V1) bot region separated by colons (`:`). For example:
///
/// ```sh
