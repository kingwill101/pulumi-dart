...
/// ## Import
///
/// Using `pulumi import`, import Amazon Connect Vocabularies using the <span pulumi-lang-nodejs="`instanceId`" pulumi-lang-dotnet="`InstanceId`" pulumi-lang-go="`instanceId`" pulumi-lang-python="`instance_id`" pulumi-lang-yaml="`instanceId`" pulumi-lang-java="`instanceId`">`instance_id`</span> and <span pulumi-lang-nodejs="`vocabularyId`" pulumi-lang-dotnet="`VocabularyId`" pulumi-lang-go="`vocabularyId`" pulumi-lang-python="`vocabulary_id`" pulumi-lang-yaml="`vocabularyId`" pulumi-lang-java="`vocabularyId`">`vocabulary_id`</span> separated by a colon (`:`). For example:
///
/// ```sh
