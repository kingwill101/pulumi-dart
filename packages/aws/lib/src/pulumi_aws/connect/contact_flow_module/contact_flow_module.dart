...
/// See example below which uses <span pulumi-lang-nodejs="`jq`" pulumi-lang-dotnet="`Jq`" pulumi-lang-go="`jq`" pulumi-lang-python="`jq`" pulumi-lang-yaml="`jq`" pulumi-lang-java="`jq`">`jq`</span> to extract the `Content` attribute and saves it to a local file.
///
/// ## Example Usage
///
/// ### Basic
...
/// ## Import
///
/// Using `pulumi import`, import Amazon Connect Contact Flow Modules using the <span pulumi-lang-nodejs="`instanceId`" pulumi-lang-dotnet="`InstanceId`" pulumi-lang-go="`instanceId`" pulumi-lang-python="`instance_id`" pulumi-lang-yaml="`instanceId`" pulumi-lang-java="`instanceId`">`instance_id`</span> and <span pulumi-lang-nodejs="`contactFlowModuleId`" pulumi-lang-dotnet="`ContactFlowModuleId`" pulumi-lang-go="`contactFlowModuleId`" pulumi-lang-python="`contact_flow_module_id`" pulumi-lang-yaml="`contactFlowModuleId`" pulumi-lang-java="`contactFlowModuleId`">`contact_flow_module_id`</span> separated by a colon (`:`). For example:
///
/// ```sh
...
/// ```
class ContactFlowModule extends CustomResource {
  /// The Amazon Resource Name (ARN) of the Contact Flow Module.
  late final Output<String> arn;

  /// The identifier of the Contact Flow Module.
  late final Output<String> contactFlowModuleId;

  /// Specifies the content of the Contact Flow Module, provided as a JSON string, written in Amazon Connect Contact Flow Language. If defined, the <span pulumi-lang-nodejs="`filename`" pulumi-lang-dotnet="`Filename`" pulumi-lang-go="`filename`" pulumi-lang-python="`filename`" pulumi-lang-yaml="`filename`" pulumi-lang-java="`filename`">`filename`</span> argument cannot be used.
  late final Output<String> content;

  /// Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the Contact Flow Module source specified with <span pulumi-lang-nodejs="`filename`" pulumi-lang-dotnet="`Filename`" pulumi-lang-go="`filename`" pulumi-lang-python="`filename`" pulumi-lang-yaml="`filename`" pulumi-lang-java="`filename`">`filename`</span>.
  late final Output<String?> contentHash;

  /// Specifies the description of the Contact Flow Module.
  late final Output<String?> description;

  /// The path to the Contact Flow Module source within the local filesystem. Conflicts with <span pulumi-lang-nodejs="`content`" pulumi-lang-dotnet="`Content`" pulumi-lang-go="`content`" pulumi-lang-python="`content`" pulumi-lang-yaml="`content`" pulumi-lang-java="`content`">`content`</span>.
  ...
  /// Tags to apply to the Contact Flow Module. If configured with a provider <span pulumi-lang-nodejs="`defaultTags`" pulumi-lang-dotnet="`DefaultTags`" pulumi-lang-go="`defaultTags`" pulumi-lang-python="`default_tags`" pulumi-lang-yaml="`defaultTags`" pulumi-lang-java="`defaultTags`">`default_tags`</span> configuration block present, tags with matching keys will overwrite those defined at the provider-level.
