...
/// ## Import
///
/// Using `pulumi import`, import Amazon Connect Instance Storage Configs using the <span pulumi-lang-nodejs="`instanceId`" pulumi-lang-dotnet="`InstanceId`" pulumi-lang-go="`instanceId`" pulumi-lang-python="`instance_id`" pulumi-lang-yaml="`instanceId`" pulumi-lang-java="`instanceId`">`instance_id`</span>, <span pulumi-lang-nodejs="`associationId`" pulumi-lang-dotnet="`AssociationId`" pulumi-lang-go="`associationId`" pulumi-lang-python="`association_id`" pulumi-lang-yaml="`associationId`" pulumi-lang-java="`associationId`">`association_id`</span>, and <span pulumi-lang-nodejs="`resourceType`" pulumi-lang-dotnet="`ResourceType`" pulumi-lang-go="`resourceType`" pulumi-lang-python="`resource_type`" pulumi-lang-yaml="`resourceType`" pulumi-lang-java="`resourceType`">`resource_type`</span> separated by a colon (`:`). For example:
///
/// ```sh
