...
/// ## Import
///
/// Using `pulumi import`, import Amazon Connect Queues using the <span pulumi-lang-nodejs="`instanceId`" pulumi-lang-dotnet="`InstanceId`" pulumi-lang-go="`instanceId`" pulumi-lang-python="`instance_id`" pulumi-lang-yaml="`instanceId`" pulumi-lang-java="`instanceId`">`instance_id`</span> and <span pulumi-lang-nodejs="`queueId`" pulumi-lang-dotnet="`QueueId`" pulumi-lang-go="`queueId`" pulumi-lang-python="`queue_id`" pulumi-lang-yaml="`queueId`" pulumi-lang-java="`queueId`">`queue_id`</span> separated by a colon (`:`). For example:
///
/// ```sh
...
class Queue extends CustomResource {
  ...
  Queue(
    ...
    this.maxContacts = Output.createUnknown<int?>();
    this.name = Output.createUnknown<String>();
    this.outboundCallerConfig =
        Output.createUnknown<QueueOutboundCallerConfig?>();
    this.queueId = Output.createUnknown<String>();
    this.quickConnectIds = Output.createUnknown<List<String>?>();
