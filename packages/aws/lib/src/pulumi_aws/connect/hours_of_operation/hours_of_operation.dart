...
/// ## Import
///
/// Using `pulumi import`, import Amazon Connect Hours of Operations using the <span pulumi-lang-nodejs="`instanceId`" pulumi-lang-dotnet="`InstanceId`" pulumi-lang-go="`instanceId`" pulumi-lang-python="`instance_id`" pulumi-lang-yaml="`instanceId`" pulumi-lang-java="`instanceId`">`instance_id`</span> and <span pulumi-lang-nodejs="`hoursOfOperationId`" pulumi-lang-dotnet="`HoursOfOperationId`" pulumi-lang-go="`hoursOfOperationId`" pulumi-lang-python="`hours_of_operation_id`" pulumi-lang-yaml="`hoursOfOperationId`" pulumi-lang-java="`hoursOfOperationId`">`hours_of_operation_id`</span> separated by a colon (`:`). For example:
///
/// ```sh
