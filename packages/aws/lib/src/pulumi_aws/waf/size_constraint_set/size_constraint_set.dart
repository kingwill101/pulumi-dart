...
/// Use the <span pulumi-lang-nodejs="`aws.waf.SizeConstraintSet`" pulumi-lang-dotnet="`aws.waf.SizeConstraintSet`" pulumi-lang-go="`waf.SizeConstraintSet`" pulumi-lang-python="`waf.SizeConstraintSet`" pulumi-lang-yaml="`aws.waf.SizeConstraintSet`" pulumi-lang-java="`aws.waf.SizeConstraintSet`">`aws.waf.SizeConstraintSet`</span> resource to manage WAF size constraint sets.
///
/// ## Example Usage
///
...
class SizeConstraintSet extends CustomResource {
  ...
  SizeConstraintSet(
    ...
    this.sizeConstraints =
        Output.createUnknown<List<SizeConstraintSetSizeConstraint>?>();
  }
}
