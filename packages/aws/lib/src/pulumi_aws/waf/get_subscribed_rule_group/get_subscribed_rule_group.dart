...
/// <span pulumi-lang-nodejs="`aws.waf.getSubscribedRuleGroup`" pulumi-lang-dotnet="`aws.waf.getSubscribedRuleGroup`" pulumi-lang-go="`waf.getSubscribedRuleGroup`" pulumi-lang-python="`waf_get_subscribed_rule_group`" pulumi-lang-yaml="`aws.waf.getSubscribedRuleGroup`" pulumi-lang-java="`aws.waf.getSubscribedRuleGroup`">`aws.waf.getSubscribedRuleGroup`</span> retrieves information about a Managed WAF Rule Group from AWS Marketplace (needs to be subscribed to first).
///
/// ## Example Usage
///
