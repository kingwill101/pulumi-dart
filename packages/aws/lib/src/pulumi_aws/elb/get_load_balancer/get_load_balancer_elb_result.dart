...
import '../get_load_balancer_access_logs/get_load_balancer_access_logs_elb.dart';
...
class GetLoadBalancerElbResult {
  final GetLoadBalancerAccessLogsElb accessLogs;
  final String arn;
  ...
  factory GetLoadBalancerElbResult.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerElbResult(
      accessLogs: GetLoadBalancerAccessLogsElb.fromMap(
