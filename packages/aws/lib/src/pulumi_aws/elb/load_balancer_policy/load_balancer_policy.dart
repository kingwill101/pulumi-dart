...
class LoadBalancerPolicy extends CustomResource {
  /// The load balancer on which the policy is defined.
  late final Output<String> loadBalancerName;

  /// Policy attribute to apply to the policy.
  late final Output<List<LoadBalancerPolicyPolicyAttribute>> policyAttributes;

  /// The name of the load balancer policy.
  late final Output<String> policyName;

  /// The policy type.
  late final Output<String> policyTypeName;
