...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.ec2transitgateway.MulticastDomain`" pulumi-lang-dotnet="`aws.ec2transitgateway.MulticastDomain`" pulumi-lang-go="`ec2transitgateway.MulticastDomain`" pulumi-lang-python="`ec2transitgateway.MulticastDomain`" pulumi-lang-yaml="`aws.ec2transitgateway.MulticastDomain`" pulumi-lang-java="`aws.ec2transitgateway.MulticastDomain`">`aws.ec2transitgateway.MulticastDomain`</span> using the EC2 Transit Gateway Multicast Domain identifier. For example:
///
/// ```sh
