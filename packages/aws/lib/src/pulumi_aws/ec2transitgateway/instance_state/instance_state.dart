...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.ec2transitgateway.InstanceState`" pulumi-lang-dotnet="`aws.ec2transitgateway.InstanceState`" pulumi-lang-go="`ec2transitgateway.InstanceState`" pulumi-lang-python="`ec2transitgateway.InstanceState`" pulumi-lang-yaml="`aws.ec2transitgateway.InstanceState`" pulumi-lang-java="`aws.ec2transitgateway.InstanceState`">`aws.ec2transitgateway.InstanceState`</span> using the <span pulumi-lang-nodejs="`instanceId`" pulumi-lang-dotnet="`InstanceId`" pulumi-lang-go="`instanceId`" pulumi-lang-python="`instance_id`" pulumi-lang-yaml="`instanceId`" pulumi-lang-java="`instanceId`">`instance_id`</span> attribute. For example:
///
/// ```sh
