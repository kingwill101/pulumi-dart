...
import 'route_table_association_args2.dart';
...
///
/// When associating a Direct Connect Gateway attachment, reference the <span pulumi-lang-nodejs="`transitGatewayAttachmentId`" pulumi-lang-dotnet="`TransitGatewayAttachmentId`" pulumi-lang-go="`transitGatewayAttachmentId`" pulumi-lang-python="`transit_gateway_attachment_id`" pulumi-lang-yaml="`transitGatewayAttachmentId`" pulumi-lang-java="`transitGatewayAttachmentId`">`transit_gateway_attachment_id`</span> attribute directly from the <span pulumi-lang-nodejs="`aws.directconnect.GatewayAssociation`" pulumi-lang-dotnet="`aws.directconnect.GatewayAssociation`" pulumi-lang-go="`directconnect.GatewayAssociation`" pulumi-lang-python="`directconnect.GatewayAssociation`" pulumi-lang-yaml="`aws.directconnect.GatewayAssociation`" pulumi-lang-java="`aws.directconnect.GatewayAssociation`">`aws.directconnect.GatewayAssociation`</span> resource (available in v6.5.0+):
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// <!--End PulumiCodeChooser -->
///
/// > **NOTE:** When the <span pulumi-lang-nodejs="`transitGatewayAttachmentId`" pulumi-lang-dotnet="`TransitGatewayAttachmentId`" pulumi-lang-go="`transitGatewayAttachmentId`" pulumi-lang-python="`transit_gateway_attachment_id`" pulumi-lang-yaml="`transitGatewayAttachmentId`" pulumi-lang-java="`transitGatewayAttachmentId`">`transit_gateway_attachment_id`</span> changes (for example, when a VPC attachment is replaced), this resource will be recreated. This is the correct behavior to maintain consistency between the attachment and its route table association.
///
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.ec2transitgateway.RouteTableAssociation`" pulumi-lang-dotnet="`aws.ec2transitgateway.RouteTableAssociation`" pulumi-lang-go="`ec2transitgateway.RouteTableAssociation`" pulumi-lang-python="`ec2transitgateway.RouteTableAssociation`" pulumi-lang-yaml="`aws.ec2transitgateway.RouteTableAssociation`" pulumi-lang-java="`aws.ec2transitgateway.RouteTableAssociation`">`aws.ec2transitgateway.RouteTableAssociation`</span> using the EC2 Transit Gateway Route Table identifier, an underscore, and the EC2 Transit Gateway Attachment identifier. For example:
///
/// ```sh
...
/// ```
class RouteTableAssociation2 extends CustomResource {
  ...
  late final Output<bool?> replaceExistingAssociation;
  ...
  RouteTableAssociation2(
    String name, {
    RouteTableAssociationArgs2? args,
    ...
    this.replaceExistingAssociation = Output.createUnknown<bool?>();
