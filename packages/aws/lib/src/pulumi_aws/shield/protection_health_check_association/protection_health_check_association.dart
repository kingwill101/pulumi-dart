...
/// ## Import
///
/// Using `pulumi import`, import Shield protection health check association resources using the <span pulumi-lang-nodejs="`shieldProtectionId`" pulumi-lang-dotnet="`ShieldProtectionId`" pulumi-lang-go="`shieldProtectionId`" pulumi-lang-python="`shield_protection_id`" pulumi-lang-yaml="`shieldProtectionId`" pulumi-lang-java="`shieldProtectionId`">`shield_protection_id`</span> and <span pulumi-lang-nodejs="`healthCheckArn`" pulumi-lang-dotnet="`HealthCheckArn`" pulumi-lang-go="`healthCheckArn`" pulumi-lang-python="`health_check_arn`" pulumi-lang-yaml="`healthCheckArn`" pulumi-lang-java="`healthCheckArn`">`health_check_arn`</span>. For example:
///
/// ```sh
...
/// ```
class ProtectionHealthCheckAssociation extends CustomResource {
  /// The ARN (Amazon Resource Name) of the Route53 Health Check resource which will be associated to the protected resource.
  late final Output<String> healthCheckArn;

  /// The ID of the protected resource.
  late final Output<String> shieldProtectionId;
