...
///
/// > **NOTE on blue/green deployments:** When using <span pulumi-lang-nodejs="`greenFleetProvisioningOption`" pulumi-lang-dotnet="`GreenFleetProvisioningOption`" pulumi-lang-go="`greenFleetProvisioningOption`" pulumi-lang-python="`green_fleet_provisioning_option`" pulumi-lang-yaml="`greenFleetProvisioningOption`" pulumi-lang-java="`greenFleetProvisioningOption`">`green_fleet_provisioning_option`</span> with the `COPY_AUTO_SCALING_GROUP` action, CodeDeploy will create a new ASG with a different name. This ASG is _not_ managed by this provider and will conflict with existing configuration and state. You may want to use a different approach to managing deployments that involve multiple ASG, such as `DISCOVER_EXISTING` with separate blue and green ASG.
///
/// ## Example Usage
///
...
/// ## Import
///
/// Using `pulumi import`, import CodeDeploy Deployment Groups using <span pulumi-lang-nodejs="`appName`" pulumi-lang-dotnet="`AppName`" pulumi-lang-go="`appName`" pulumi-lang-python="`app_name`" pulumi-lang-yaml="`appName`" pulumi-lang-java="`appName`">`app_name`</span>, a colon, and <span pulumi-lang-nodejs="`deploymentGroupName`" pulumi-lang-dotnet="`DeploymentGroupName`" pulumi-lang-go="`deploymentGroupName`" pulumi-lang-python="`deployment_group_name`" pulumi-lang-yaml="`deploymentGroupName`" pulumi-lang-java="`deploymentGroupName`">`deployment_group_name`</span>. For example:
///
/// ```sh
