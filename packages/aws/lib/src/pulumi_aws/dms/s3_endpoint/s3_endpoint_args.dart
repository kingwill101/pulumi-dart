...
class S3EndpointArgs {
  ...
  factory S3EndpointArgs.fromMap(Map<String, dynamic> map) {
    return S3EndpointArgs(
      addColumnName: pulumi.Input.asOptionalInput<bool>(map['addColumnName']),
      addTrailingPaddingCharacter: pulumi.Input.asOptionalInput<bool>(
          map['addTrailingPaddingCharacter']),
      bucketFolder: pulumi.Input.asOptionalInput<String>(map['bucketFolder']),
      bucketName: pulumi.Input.asInput<String>(map['bucketName']),
      cannedAclForObjects:
          pulumi.Input.asOptionalInput<String>(map['cannedAclForObjects']),
      cdcInsertsAndUpdates:
          pulumi.Input.asOptionalInput<bool>(map['cdcInsertsAndUpdates']),
      cdcInsertsOnly: pulumi.Input.asOptionalInput<bool>(map['cdcInsertsOnly']),
      cdcMaxBatchInterval:
          pulumi.Input.asOptionalInput<int>(map['cdcMaxBatchInterval']),
      cdcMinFileSize: pulumi.Input.asOptionalInput<int>(map['cdcMinFileSize']),
      cdcPath: pulumi.Input.asOptionalInput<String>(map['cdcPath']),
      certificateArn:
          pulumi.Input.asOptionalInput<String>(map['certificateArn']),
      compressionType:
          pulumi.Input.asOptionalInput<String>(map['compressionType']),
      csvDelimiter: pulumi.Input.asOptionalInput<String>(map['csvDelimiter']),
      csvNoSupValue: pulumi.Input.asOptionalInput<String>(map['csvNoSupValue']),
      csvNullValue: pulumi.Input.asOptionalInput<String>(map['csvNullValue']),
      csvRowDelimiter:
          pulumi.Input.asOptionalInput<String>(map['csvRowDelimiter']),
      dataFormat: pulumi.Input.asOptionalInput<String>(map['dataFormat']),
      dataPageSize: pulumi.Input.asOptionalInput<int>(map['dataPageSize']),
      datePartitionDelimiter:
          pulumi.Input.asOptionalInput<String>(map['datePartitionDelimiter']),
      datePartitionEnabled:
          pulumi.Input.asOptionalInput<bool>(map['datePartitionEnabled']),
      datePartitionSequence:
          pulumi.Input.asOptionalInput<String>(map['datePartitionSequence']),
      datePartitionTimezone:
          pulumi.Input.asOptionalInput<String>(map['datePartitionTimezone']),
      detachTargetOnLobLookupFailureParquet: pulumi.Input.asOptionalInput<bool>(
          map['detachTargetOnLobLookupFailureParquet']),
      dictPageSizeLimit:
          pulumi.Input.asOptionalInput<int>(map['dictPageSizeLimit']),
      enableStatistics:
          pulumi.Input.asOptionalInput<bool>(map['enableStatistics']),
      ...
      externalTableDefinition:
          pulumi.Input.asOptionalInput<String>(map['externalTableDefinition']),
      glueCatalogGeneration:
          pulumi.Input.asOptionalInput<bool>(map['glueCatalogGeneration']),
      ignoreHeaderRows:
          pulumi.Input.asOptionalInput<int>(map['ignoreHeaderRows']),
      includeOpForFullLoad:
          pulumi.Input.asOptionalInput<bool>(map['includeOpForFullLoad']),
      kmsKeyArn: pulumi.Input.asOptionalInput<String>(map['kmsKeyArn']),
      maxFileSize: pulumi.Input.asOptionalInput<int>(map['maxFileSize']),
      parquetTimestampInMillisecond: pulumi.Input.asOptionalInput<bool>(
          map['parquetTimestampInMillisecond']),
      parquetVersion:
          pulumi.Input.asOptionalInput<String>(map['parquetVersion']),
      preserveTransactions:
          pulumi.Input.asOptionalInput<bool>(map['preserveTransactions']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      rfc4180: pulumi.Input.asOptionalInput<bool>(map['rfc4180']),
      rowGroupLength: pulumi.Input.asOptionalInput<int>(map['rowGroupLength']),
      serverSideEncryptionKmsKeyId: pulumi.Input.asOptionalInput<String>(
          map['serverSideEncryptionKmsKeyId']),
      serviceAccessRoleArn:
          pulumi.Input.asInput<String>(map['serviceAccessRoleArn']),
      sslMode: pulumi.Input.asOptionalInput<String>(map['sslMode']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      timestampColumnName:
          pulumi.Input.asOptionalInput<String>(map['timestampColumnName']),
      useCsvNoSupValue:
          pulumi.Input.asOptionalInput<bool>(map['useCsvNoSupValue']),
      useTaskStartTimeForFullLoadTimestamp: pulumi.Input.asOptionalInput<bool>(
          map['useTaskStartTimeForFullLoadTimestamp']),
    );
  }
}
