...
class ReportPlanReportSetting {
  ...
  Map<String, dynamic> toMap() {
    ...
    final frameworkArnsValue = frameworkArns;
    if (frameworkArnsValue != null) {
      map['frameworkArns'] = frameworkArnsValue;
    }
    final numberOfFrameworksValue = numberOfFrameworks;
    if (numberOfFrameworksValue != null) {
      map['numberOfFrameworks'] = numberOfFrameworksValue;
    }
    final organizationUnitsValue = organizationUnits;
    if (organizationUnitsValue != null) {
      map['organizationUnits'] = organizationUnitsValue;
    }
