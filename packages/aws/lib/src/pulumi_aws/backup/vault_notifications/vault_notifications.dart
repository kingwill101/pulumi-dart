...
/// ## Import
///
/// Using `pulumi import`, import Backup vault notifications using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:backup/vaultNotifications:VaultNotifications test TestVault
/// ```
class VaultNotifications extends CustomResource {
  /// The ARN of the vault.
  late final Output<String> backupVaultArn;

  /// An array of events that indicate the status of jobs to back up resources to the backup vault.
  late final Output<List<String>> backupVaultEvents;
