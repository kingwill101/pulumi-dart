...
import '../get_framework_control/get_framework_control.dart';

/// Result data returned by getFramework.
class GetFrameworkResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['arn'] = arn;
    map['controls'] =
        Input.encodeList<GetFrameworkControl, Map<String, dynamic>>(
  ...
  factory GetFrameworkResult2.fromMap(Map<String, dynamic> map) {
    return GetFrameworkResult2(
      arn: map['arn'] as String,
      controls: Input.decodeList<GetFrameworkControl>(
          map['controls'],
