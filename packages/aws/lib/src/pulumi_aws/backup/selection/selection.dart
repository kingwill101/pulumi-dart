...
/// ## Import
///
/// Using `pulumi import`, import Backup selection using the role<span pulumi-lang-nodejs=" planId " pulumi-lang-dotnet=" PlanId " pulumi-lang-go=" planId " pulumi-lang-python=" plan_id " pulumi-lang-yaml=" planId " pulumi-lang-java=" planId "> plan_id </span>and id separated by `|`. For example:
///
/// ```sh
