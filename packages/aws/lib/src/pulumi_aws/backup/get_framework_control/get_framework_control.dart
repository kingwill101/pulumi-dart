...
class GetFrameworkControl {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['scopes'] =
        pulumi.Input.encodeList<GetFrameworkControlScope, Map<String, dynamic>>(
  ...
  factory GetFrameworkControl.fromMap(Map<String, dynamic> map) {
    return GetFrameworkControl(
      inputParameters:
          pulumi.Input.decodeList<GetFrameworkControlInputParameter>(
              map['inputParameters'],
              (value) => GetFrameworkControlInputParameter.fromMap(
                  (value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      scopes: pulumi.Input.decodeList<GetFrameworkControlScope>(
          map['scopes'],
