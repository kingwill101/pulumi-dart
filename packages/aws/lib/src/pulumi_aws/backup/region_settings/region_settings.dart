...
/// ## Import
///
/// Using `pulumi import`, import Backup Region Settings using the <span pulumi-lang-nodejs="`region`" pulumi-lang-dotnet="`Region`" pulumi-lang-go="`region`" pulumi-lang-python="`region`" pulumi-lang-yaml="`region`" pulumi-lang-java="`region`">`region`</span>. For example:
///
/// ```sh
