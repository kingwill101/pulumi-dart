...
/// ### ALB
///
/// If the type is ALB, <span pulumi-lang-nodejs="`healthCheck`" pulumi-lang-dotnet="`HealthCheck`" pulumi-lang-go="`healthCheck`" pulumi-lang-python="`health_check`" pulumi-lang-yaml="`healthCheck`" pulumi-lang-java="`healthCheck`">`health_check`</span> block is not supported.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ### Lambda
///
/// If the type is Lambda, <span pulumi-lang-nodejs="`config`" pulumi-lang-dotnet="`Config`" pulumi-lang-go="`config`" pulumi-lang-python="`config`" pulumi-lang-yaml="`config`" pulumi-lang-java="`config`">`config`</span> block is not supported.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import VPC Lattice Target Group using the <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
...
class TargetGroup3 extends CustomResource {
  ...
  TargetGroup3(
    ...
    this.config = Output.createUnknown<TargetGroupConfig?>();
