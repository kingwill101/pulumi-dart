...
class ListenerDefaultActionForwardTargetGroupVpclattice {
  ...
  factory ListenerDefaultActionForwardTargetGroupVpclattice.fromMap(
      Map<String, dynamic> map) {
    return ListenerDefaultActionForwardTargetGroupVpclattice(
