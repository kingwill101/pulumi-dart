...
class LoadBalancerArgs {
  ...
  final Input<LoadBalancerAccessLogs>? accessLogs;

  /// Client keep alive value in seconds. The valid range is 60-604800 seconds. The default is 3600 seconds.
  final Input<int>? clientKeepAlive;
  ...
  final Input<LoadBalancerConnectionLogs>? connectionLogs;
  ...
  final Input<String>? dnsRecordClientRoutingPolicy;
  ...
  final Input<bool>? dropInvalidHeaderFields;
  ...
  final Input<bool>? enableCrossZoneLoadBalancing;
  ...
  final Input<bool>? enableDeletionProtection;
  ...
  final Input<bool>? enableTlsVersionAndCipherSuiteHeaders;
  ...
  final Input<bool>? enableWafFailOpen;
  ...
  final Input<bool>? enableXffClientPort;
  ...
  final Input<bool>? enableZonalShift;
  ...
  final Input<String>? enforceSecurityGroupInboundRulesOnPrivateLinkTraffic;
  ...
  final Input<LoadBalancerHealthCheckLogs>? healthCheckLogs;
  ...
  final Input<LoadBalancerIpamPools>? ipamPools;
  ...
  final Input<LoadBalancerType>? loadBalancerType;
  ...
  final Input<LoadBalancerMinimumLoadBalancerCapacity>?
  ...
  final Input<bool>? preserveHostHeader;
  ...
  final Input<int>? secondaryIpsAutoAssignedPerSubnet;
  ...
  final Input<List<LoadBalancerSubnetMapping>>? subnetMappings;
  ...
  final Input<String>? xffHeaderProcessingMode;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (accessLogsValue != null) {
      map['accessLogs'] = Input.mapOptionalInputValue<LoadBalancerAccessLogs,
    ...
    if (connectionLogsValue != null) {
      map['connectionLogs'] = Input.mapOptionalInputValue<
    ...
    if (healthCheckLogsValue != null) {
      map['healthCheckLogs'] = Input.mapOptionalInputValue<
    ...
    if (ipamPoolsValue != null) {
      map['ipamPools'] = Input.mapOptionalInputValue<LoadBalancerIpamPools,
    ...
    if (loadBalancerTypeValue != null) {
      map['loadBalancerType'] =
          Input.mapOptionalInputValue<LoadBalancerType, String>(
    ...
    if (minimumLoadBalancerCapacityValue != null) {
      map['minimumLoadBalancerCapacity'] = Input.mapOptionalInputValue<
    ...
    if (subnetMappingsValue != null) {
      map['subnetMappings'] = Input.mapOptionalInputValue<
          ...
          subnetMappingsValue,
          (value) =>
              Input.encodeList<LoadBalancerSubnetMapping, Map<String, dynamic>>(
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      accessLogs:
          Input.asOptionalInput<LoadBalancerAccessLogs>(map['accessLogs']),
      clientKeepAlive: Input.asOptionalInput<int>(map['clientKeepAlive']),
      connectionLogs: Input.asOptionalInput<LoadBalancerConnectionLogs>(
          map['connectionLogs']),
      ...
      dnsRecordClientRoutingPolicy:
          Input.asOptionalInput<String>(map['dnsRecordClientRoutingPolicy']),
      dropInvalidHeaderFields:
          Input.asOptionalInput<bool>(map['dropInvalidHeaderFields']),
      enableCrossZoneLoadBalancing:
          Input.asOptionalInput<bool>(map['enableCrossZoneLoadBalancing']),
      enableDeletionProtection:
          Input.asOptionalInput<bool>(map['enableDeletionProtection']),
      enableHttp2: Input.asOptionalInput<bool>(map['enableHttp2']),
      enableTlsVersionAndCipherSuiteHeaders: Input.asOptionalInput<bool>(
          map['enableTlsVersionAndCipherSuiteHeaders']),
      enableWafFailOpen: Input.asOptionalInput<bool>(map['enableWafFailOpen']),
      enableXffClientPort:
          Input.asOptionalInput<bool>(map['enableXffClientPort']),
      enableZonalShift: Input.asOptionalInput<bool>(map['enableZonalShift']),
      enforceSecurityGroupInboundRulesOnPrivateLinkTraffic:
          Input.asOptionalInput<String>(
              map['enforceSecurityGroupInboundRulesOnPrivateLinkTraffic']),
      healthCheckLogs: Input.asOptionalInput<LoadBalancerHealthCheckLogs>(
          map['healthCheckLogs']),
      ...
      ipamPools: Input.asOptionalInput<LoadBalancerIpamPools>(map['ipamPools']),
      loadBalancerType:
          Input.asOptionalInput<LoadBalancerType>(map['loadBalancerType']),
      minimumLoadBalancerCapacity:
          Input.asOptionalInput<LoadBalancerMinimumLoadBalancerCapacity>(
              map['minimumLoadBalancerCapacity']),
      name: Input.asOptionalInput<String>(map['name']),
      namePrefix: Input.asOptionalInput<String>(map['namePrefix']),
      preserveHostHeader:
          Input.asOptionalInput<bool>(map['preserveHostHeader']),
      region: Input.asOptionalInput<String>(map['region']),
      secondaryIpsAutoAssignedPerSubnet:
          Input.asOptionalInput<int>(map['secondaryIpsAutoAssignedPerSubnet']),
      securityGroups:
          Input.asOptionalInput<List<String>>(map['securityGroups']),
      subnetMappings: Input.asOptionalInput<List<LoadBalancerSubnetMapping>>(
          map['subnetMappings']),
      subnets: Input.asOptionalInput<List<String>>(map['subnets']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      xffHeaderProcessingMode:
          Input.asOptionalInput<String>(map['xffHeaderProcessingMode']),
    );
  }
}
