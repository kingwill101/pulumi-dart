...
class PortfolioShareArgs {
  ...
  factory PortfolioShareArgs.fromMap(Map<String, dynamic> map) {
    return PortfolioShareArgs(
      ...
      sharePrincipals:
          pulumi.Input.asOptionalInput<bool>(map['sharePrincipals']),
      shareTagOptions:
          pulumi.Input.asOptionalInput<bool>(map['shareTagOptions']),
      type: pulumi.Input.asInput<String>(map['type']),
      waitForAcceptance:
          pulumi.Input.asOptionalInput<bool>(map['waitForAcceptance']),
    );
  }
}
