...
class CentralizationRuleForOrganizationRuleDestinationDestinationLogsConfigurationLogsEncryptionConfiguration {
  ...
  Map<String, dynamic> toMap() {
    ...
    final encryptionConflictResolutionStrategyValue =
        encryptionConflictResolutionStrategy;
    if (encryptionConflictResolutionStrategyValue != null) {
      map['encryptionConflictResolutionStrategy'] =
          encryptionConflictResolutionStrategyValue;
    }
    map['encryptionStrategy'] = encryptionStrategy;
