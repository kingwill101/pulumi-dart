...
class RestApiArgs {
  ...
  factory RestApiArgs.fromMap(Map<String, dynamic> map) {
    return RestApiArgs(
      apiKeySource: pulumi.Input.asOptionalInput<String>(map['apiKeySource']),
      binaryMediaTypes:
          pulumi.Input.asOptionalInput<List<String>>(map['binaryMediaTypes']),
      body: pulumi.Input.asOptionalInput<String>(map['body']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      disableExecuteApiEndpoint:
          pulumi.Input.asOptionalInput<bool>(map['disableExecuteApiEndpoint']),
      ...
      minimumCompressionSize:
          pulumi.Input.asOptionalInput<String>(map['minimumCompressionSize']),
      ...
      putRestApiMode:
          pulumi.Input.asOptionalInput<String>(map['putRestApiMode']),
