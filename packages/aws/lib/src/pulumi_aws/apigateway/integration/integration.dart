...
/// Note that the <span pulumi-lang-nodejs="`timeout`" pulumi-lang-dotnet="`Timeout`" pulumi-lang-go="`timeout`" pulumi-lang-python="`timeout`" pulumi-lang-yaml="`timeout`" pulumi-lang-java="`timeout`">`timeout`</span> of the <span pulumi-lang-nodejs="`aws.lambda.Function`" pulumi-lang-dotnet="`aws.lambda.Function`" pulumi-lang-go="`lambda.Function`" pulumi-lang-python="`lambda.Function`" pulumi-lang-yaml="`aws.lambda.Function`" pulumi-lang-java="`aws.lambda.Function`">`aws.lambda.Function`</span> may need to be adjusted.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigateway.Integration`" pulumi-lang-dotnet="`aws.apigateway.Integration`" pulumi-lang-go="`apigateway.Integration`" pulumi-lang-python="`apigateway.Integration`" pulumi-lang-yaml="`aws.apigateway.Integration`" pulumi-lang-java="`aws.apigateway.Integration`">`aws.apigateway.Integration`</span> using `REST-API-ID/RESOURCE-ID/HTTP-METHOD`. For example:
///
/// ```sh
