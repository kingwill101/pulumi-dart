...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigateway.Method`" pulumi-lang-dotnet="`aws.apigateway.Method`" pulumi-lang-go="`apigateway.Method`" pulumi-lang-python="`apigateway.Method`" pulumi-lang-yaml="`aws.apigateway.Method`" pulumi-lang-java="`aws.apigateway.Method`">`aws.apigateway.Method`</span> using `REST-API-ID/RESOURCE-ID/HTTP-METHOD`. For example:
///
/// ```sh
