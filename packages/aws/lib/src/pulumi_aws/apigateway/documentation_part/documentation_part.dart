...
/// ## Import
///
/// Using `pulumi import`, import API Gateway<span pulumi-lang-nodejs=" documentationParts " pulumi-lang-dotnet=" DocumentationParts " pulumi-lang-go=" documentationParts " pulumi-lang-python=" documentation_parts " pulumi-lang-yaml=" documentationParts " pulumi-lang-java=" documentationParts "> documentation_parts </span>using `REST-API-ID/DOC-PART-ID`. For example:
///
/// ```sh
