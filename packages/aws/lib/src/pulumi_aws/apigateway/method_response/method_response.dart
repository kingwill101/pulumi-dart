...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigateway.MethodResponse`" pulumi-lang-dotnet="`aws.apigateway.MethodResponse`" pulumi-lang-go="`apigateway.MethodResponse`" pulumi-lang-python="`apigateway.MethodResponse`" pulumi-lang-yaml="`aws.apigateway.MethodResponse`" pulumi-lang-java="`aws.apigateway.MethodResponse`">`aws.apigateway.MethodResponse`</span> using `REST-API-ID/RESOURCE-ID/HTTP-METHOD/STATUS-CODE`. For example:
///
/// ```sh
