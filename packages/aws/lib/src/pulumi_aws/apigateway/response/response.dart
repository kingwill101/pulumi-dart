...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigateway.Response`" pulumi-lang-dotnet="`aws.apigateway.Response`" pulumi-lang-go="`apigateway.Response`" pulumi-lang-python="`apigateway.Response`" pulumi-lang-yaml="`aws.apigateway.Response`" pulumi-lang-java="`aws.apigateway.Response`">`aws.apigateway.Response`</span> using `REST-API-ID/RESPONSE-TYPE`. For example:
///
/// ```sh
