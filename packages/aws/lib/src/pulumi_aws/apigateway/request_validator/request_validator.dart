...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigateway.RequestValidator`" pulumi-lang-dotnet="`aws.apigateway.RequestValidator`" pulumi-lang-go="`apigateway.RequestValidator`" pulumi-lang-python="`apigateway.RequestValidator`" pulumi-lang-yaml="`aws.apigateway.RequestValidator`" pulumi-lang-java="`aws.apigateway.RequestValidator`">`aws.apigateway.RequestValidator`</span> using `REST-API-ID/REQUEST-VALIDATOR-ID`. For example:
///
/// ```sh
