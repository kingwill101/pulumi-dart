...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigateway.RestApiPolicy`" pulumi-lang-dotnet="`aws.apigateway.RestApiPolicy`" pulumi-lang-go="`apigateway.RestApiPolicy`" pulumi-lang-python="`apigateway.RestApiPolicy`" pulumi-lang-yaml="`aws.apigateway.RestApiPolicy`" pulumi-lang-java="`aws.apigateway.RestApiPolicy`">`aws.apigateway.RestApiPolicy`</span> using the REST API ID. For example:
///
/// ```sh
