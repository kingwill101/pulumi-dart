...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigateway.IntegrationResponse`" pulumi-lang-dotnet="`aws.apigateway.IntegrationResponse`" pulumi-lang-go="`apigateway.IntegrationResponse`" pulumi-lang-python="`apigateway.IntegrationResponse`" pulumi-lang-yaml="`aws.apigateway.IntegrationResponse`" pulumi-lang-java="`aws.apigateway.IntegrationResponse`">`aws.apigateway.IntegrationResponse`</span> using `REST-API-ID/RESOURCE-ID/HTTP-METHOD/STATUS-CODE`. For example:
///
/// ```sh
