...
class GetImagesEcrpublicResult {
  /// The provider-assigned unique ID for this managed resource.
  final String id;
  final List<GetImagesImageIdEcrpublic>? imageIds;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (imageIdsValue != null) {
      map['imageIds'] = pulumi.Input.encodeList<GetImagesImageIdEcrpublic,
          Map<String, dynamic>>(imageIdsValue, (value) => value.toMap());
    }
    map['images'] =
  ...
  factory GetImagesEcrpublicResult.fromMap(Map<String, dynamic> map) {
    return GetImagesEcrpublicResult(
      id: map['id'] as String,
      imageIds: map['imageIds'] == null
          ? null
          : pulumi.Input.decodeList<GetImagesImageIdEcrpublic>(
              map['imageIds'],
              (value) => GetImagesImageIdEcrpublic.fromMap(
