...
class GetImagesImageIdEcrpublic {
  ...
  factory GetImagesImageIdEcrpublic.fromMap(Map<String, dynamic> map) {
    return GetImagesImageIdEcrpublic(
      imageDigest:
