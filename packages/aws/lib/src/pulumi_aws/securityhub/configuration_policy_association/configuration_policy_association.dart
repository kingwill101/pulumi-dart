...
///
/// > **NOTE:** This resource requires <span pulumi-lang-nodejs="`aws.securityhub.OrganizationConfiguration`" pulumi-lang-dotnet="`aws.securityhub.OrganizationConfiguration`" pulumi-lang-go="`securityhub.OrganizationConfiguration`" pulumi-lang-python="`securityhub.OrganizationConfiguration`" pulumi-lang-yaml="`aws.securityhub.OrganizationConfiguration`" pulumi-lang-java="`aws.securityhub.OrganizationConfiguration`">`aws.securityhub.OrganizationConfiguration`</span> to be configured with type `CENTRAL`. More information about Security Hub central configuration and configuration policies can be found in the [How Security Hub configuration policies work](https://docs.aws.amazon.com/securityhub/latest/userguide/configuration-policies-overview.html) documentation.
///
/// ## Example Usage
///
