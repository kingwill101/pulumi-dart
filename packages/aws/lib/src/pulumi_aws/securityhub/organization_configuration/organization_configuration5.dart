...
///
/// > **NOTE:** This resource requires an <span pulumi-lang-nodejs="`aws.securityhub.OrganizationAdminAccount`" pulumi-lang-dotnet="`aws.securityhub.OrganizationAdminAccount`" pulumi-lang-go="`securityhub.OrganizationAdminAccount`" pulumi-lang-python="`securityhub.OrganizationAdminAccount`" pulumi-lang-yaml="`aws.securityhub.OrganizationAdminAccount`" pulumi-lang-java="`aws.securityhub.OrganizationAdminAccount`">`aws.securityhub.OrganizationAdminAccount`</span> to be configured (not necessarily with Pulumi). More information about managing Security Hub in an organization can be found in the [Managing administrator and member accounts](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-accounts.html) documentation.
///
/// > **NOTE:** In order to set the <span pulumi-lang-nodejs="`configurationType`" pulumi-lang-dotnet="`ConfigurationType`" pulumi-lang-go="`configurationType`" pulumi-lang-python="`configuration_type`" pulumi-lang-yaml="`configurationType`" pulumi-lang-java="`configurationType`">`configuration_type`</span> to `CENTRAL`, the delegated admin must be a member account of the organization and not the management account. Central configuration also requires an <span pulumi-lang-nodejs="`aws.securityhub.FindingAggregator`" pulumi-lang-dotnet="`aws.securityhub.FindingAggregator`" pulumi-lang-go="`securityhub.FindingAggregator`" pulumi-lang-python="`securityhub.FindingAggregator`" pulumi-lang-yaml="`aws.securityhub.FindingAggregator`" pulumi-lang-java="`aws.securityhub.FindingAggregator`">`aws.securityhub.FindingAggregator`</span> to be configured.
///
