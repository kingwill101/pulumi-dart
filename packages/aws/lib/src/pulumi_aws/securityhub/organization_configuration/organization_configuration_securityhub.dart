...
import 'organization_configuration_securityhub_args.dart';
...
/// ```
class OrganizationConfigurationSecurityhub extends pulumi.CustomResource {
  ...
  OrganizationConfigurationSecurityhub(
    String name, {
    OrganizationConfigurationSecurityhubArgs? args,
