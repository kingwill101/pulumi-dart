...
import '../insight_filters_process_terminated_at_date_range/insight_filters_process_terminated_at_date_range.dart';
...
class InsightFiltersProcessTerminatedAt {
  ...
  final InsightFiltersProcessTerminatedAtDateRange? dateRange;
  ...
  factory InsightFiltersProcessTerminatedAt.fromMap(Map<String, dynamic> map) {
    return InsightFiltersProcessTerminatedAt(
      dateRange: map['dateRange'] == null
          ? null
          : InsightFiltersProcessTerminatedAtDateRange.fromMap(
