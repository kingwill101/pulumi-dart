...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the Security Hub automation rule.
///
///
...
/// ```
class AutomationRule extends CustomResource {
  ...
  late final Output<List<AutomationRuleAction>> actions;
  ...
  late final Output<AutomationRuleCriteria> criteria;
  ...
  late final Output<bool> isTerminal;
  ...
  late final Output<int> ruleOrder;

  /// Whether the rule is active after it is created.
  late final Output<String> ruleStatus;
