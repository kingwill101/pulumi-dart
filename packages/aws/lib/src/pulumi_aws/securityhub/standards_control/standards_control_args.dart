...
class StandardsControlArgs {
  ...
  factory StandardsControlArgs.fromMap(Map<String, dynamic> map) {
    return StandardsControlArgs(
      controlStatus: pulumi.Input.asInput<String>(map['controlStatus']),
      disabledReason:
          pulumi.Input.asOptionalInput<String>(map['disabledReason']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      standardsControlArn:
          pulumi.Input.asInput<String>(map['standardsControlArn']),
    );
  }
}
