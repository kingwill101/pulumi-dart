...
///
/// The <span pulumi-lang-nodejs="`aws.securityhub.StandardsControlAssociation`" pulumi-lang-dotnet="`aws.securityhub.StandardsControlAssociation`" pulumi-lang-go="`securityhub.StandardsControlAssociation`" pulumi-lang-python="`securityhub.StandardsControlAssociation`" pulumi-lang-yaml="`aws.securityhub.StandardsControlAssociation`" pulumi-lang-java="`aws.securityhub.StandardsControlAssociation`">`aws.securityhub.StandardsControlAssociation`</span>, similarly to <span pulumi-lang-nodejs="`aws.securityhub.StandardsControl`" pulumi-lang-dotnet="`aws.securityhub.StandardsControl`" pulumi-lang-go="`securityhub.StandardsControl`" pulumi-lang-python="`securityhub.StandardsControl`" pulumi-lang-yaml="`aws.securityhub.StandardsControl`" pulumi-lang-java="`aws.securityhub.StandardsControl`">`aws.securityhub.StandardsControl`</span>,
