...
import '../automation_rule_criteria_updated_at_date_range/automation_rule_criteria_updated_at_date_range.dart';

class AutomationRuleCriteriaUpdatedAt {
  /// A configuration block of the date range for the date filter. See date_range below for more details.
  final AutomationRuleCriteriaUpdatedAtDateRange? dateRange;
  ...
  factory AutomationRuleCriteriaUpdatedAt.fromMap(Map<String, dynamic> map) {
    return AutomationRuleCriteriaUpdatedAt(
      dateRange: map['dateRange'] == null
          ? null
          : AutomationRuleCriteriaUpdatedAtDateRange.fromMap(
