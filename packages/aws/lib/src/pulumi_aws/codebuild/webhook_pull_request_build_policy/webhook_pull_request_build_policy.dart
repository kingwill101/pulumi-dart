...
class WebhookPullRequestBuildPolicy {
  /// List of repository roles that have approval privileges for pull request builds when comment approval is required. This argument must be specified only when <span pulumi-lang-nodejs="`requiresCommentApproval`" pulumi-lang-dotnet="`RequiresCommentApproval`" pulumi-lang-go="`requiresCommentApproval`" pulumi-lang-python="`requires_comment_approval`" pulumi-lang-yaml="`requiresCommentApproval`" pulumi-lang-java="`requiresCommentApproval`">`requires_comment_approval`</span> is not `DISABLED`. See the [AWS documentation](https://docs.aws.amazon.com/codebuild/latest/userguide/pull-request-build-policy.html#pull-request-build-policy.configuration) for valid values and defaults.
