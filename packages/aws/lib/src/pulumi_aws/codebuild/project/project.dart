...
/// <span pulumi-lang-nodejs="`aws.codebuild.Webhook`" pulumi-lang-dotnet="`aws.codebuild.Webhook`" pulumi-lang-go="`codebuild.Webhook`" pulumi-lang-python="`codebuild.Webhook`" pulumi-lang-yaml="`aws.codebuild.Webhook`" pulumi-lang-java="`aws.codebuild.Webhook`">`aws.codebuild.Webhook`</span> resource, which manages the webhook to the
...
/// ### Runner Project
///
/// While no special configuration is required for <span pulumi-lang-nodejs="`aws.codebuild.Project`" pulumi-lang-dotnet="`aws.codebuild.Project`" pulumi-lang-go="`codebuild.Project`" pulumi-lang-python="`codebuild.Project`" pulumi-lang-yaml="`aws.codebuild.Project`" pulumi-lang-java="`aws.codebuild.Project`">`aws.codebuild.Project`</span> to create a project as a Runner Project, an <span pulumi-lang-nodejs="`aws.codebuild.Webhook`" pulumi-lang-dotnet="`aws.codebuild.Webhook`" pulumi-lang-go="`codebuild.Webhook`" pulumi-lang-python="`codebuild.Webhook`" pulumi-lang-yaml="`aws.codebuild.Webhook`" pulumi-lang-java="`aws.codebuild.Webhook`">`aws.codebuild.Webhook`</span> resource with an appropriate <span pulumi-lang-nodejs="`filterGroup`" pulumi-lang-dotnet="`FilterGroup`" pulumi-lang-go="`filterGroup`" pulumi-lang-python="`filter_group`" pulumi-lang-yaml="`filterGroup`" pulumi-lang-java="`filterGroup`">`filter_group`</span> is required.
/// See the <span pulumi-lang-nodejs="`aws.codebuild.Webhook`" pulumi-lang-dotnet="`aws.codebuild.Webhook`" pulumi-lang-go="`codebuild.Webhook`" pulumi-lang-python="`codebuild.Webhook`" pulumi-lang-yaml="`aws.codebuild.Webhook`" pulumi-lang-java="`aws.codebuild.Webhook`">`aws.codebuild.Webhook`</span> resource documentation example for more details.
///
/// ## Import
///
/// ### Identity Schema
...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the CodeBuild project.
///
///
/// Using `pulumi import`, import CodeBuild Project using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
...
class Project extends CustomResource {
  ...
  /// URL of the build badge when <span pulumi-lang-nodejs="`badgeEnabled`" pulumi-lang-dotnet="`BadgeEnabled`" pulumi-lang-go="`badgeEnabled`" pulumi-lang-python="`badge_enabled`" pulumi-lang-yaml="`badgeEnabled`" pulumi-lang-java="`badgeEnabled`">`badge_enabled`</span> is enabled.
