...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the CodeBuild report group.
///
///
...
/// ```
class ReportGroup extends CustomResource {
  ...
  late final Output<bool?> deleteReports;

  /// Information about the destination where the raw data of this Report Group is exported. see Export Config documented below.
  late final Output<ReportGroupExportConfig> exportConfig;
  ...
  ReportGroup(
    ...
    this.deleteReports = Output.createUnknown<bool?>();
    this.exportConfig = Output.createUnknown<ReportGroupExportConfig>();
