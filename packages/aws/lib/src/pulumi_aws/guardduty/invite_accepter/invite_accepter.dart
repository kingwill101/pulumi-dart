...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.guardduty.InviteAccepter`" pulumi-lang-dotnet="`aws.guardduty.InviteAccepter`" pulumi-lang-go="`guardduty.InviteAccepter`" pulumi-lang-python="`guardduty.InviteAccepter`" pulumi-lang-yaml="`aws.guardduty.InviteAccepter`" pulumi-lang-java="`aws.guardduty.InviteAccepter`">`aws.guardduty.InviteAccepter`</span> using the member GuardDuty detector ID. For example:
///
/// ```sh
