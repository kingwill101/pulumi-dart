...
class FleetArgs {
  ...
  final Input<FleetComputeCapacity> computeCapacity;

  /// Description to display.
  final Input<String>? description;

  /// Amount of time that a streaming session remains active after users disconnect.
  final Input<int>? disconnectTimeoutInSeconds;

  /// Human-readable friendly name for the AppStream fleet.
  final Input<String>? displayName;

  /// Configuration block for the name of the directory and organizational unit (OU) to use to join the fleet to a Microsoft Active Directory domain. See below.
  final Input<FleetDomainJoinInfo>? domainJoinInfo;
  ...
  final Input<int>? maxSessionsPerInstance;

  /// Maximum amount of time that a streaming session can remain active, in seconds.
  final Input<int>? maxUserDurationInSeconds;
  ...
  final Input<String>? streamView;

  /// Map of tags to attach to AppStream instances.
  final Input<Map<String, String>>? tags;

  /// Configuration block for the VPC configuration for the image builder. See below.
  final Input<FleetVpcConfig>? vpcConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['computeCapacity'] =
        Input.mapInputValue<FleetComputeCapacity, Map<String, dynamic>>(
    ...
    if (domainJoinInfoValue != null) {
      map['domainJoinInfo'] = Input.mapOptionalInputValue<FleetDomainJoinInfo,
    ...
    if (vpcConfigValue != null) {
      map['vpcConfig'] =
          Input.mapOptionalInputValue<FleetVpcConfig, Map<String, dynamic>>(
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      computeCapacity:
          Input.asInput<FleetComputeCapacity>(map['computeCapacity']),
      description: Input.asOptionalInput<String>(map['description']),
      disconnectTimeoutInSeconds:
          Input.asOptionalInput<int>(map['disconnectTimeoutInSeconds']),
      displayName: Input.asOptionalInput<String>(map['displayName']),
      domainJoinInfo:
          Input.asOptionalInput<FleetDomainJoinInfo>(map['domainJoinInfo']),
      ...
      idleDisconnectTimeoutInSeconds:
          Input.asOptionalInput<int>(map['idleDisconnectTimeoutInSeconds']),
      ...
      maxSessionsPerInstance:
          Input.asOptionalInput<int>(map['maxSessionsPerInstance']),
      maxUserDurationInSeconds:
          Input.asOptionalInput<int>(map['maxUserDurationInSeconds']),
      name: Input.asOptionalInput<String>(map['name']),
      region: Input.asOptionalInput<String>(map['region']),
      streamView: Input.asOptionalInput<String>(map['streamView']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      vpcConfig: Input.asOptionalInput<FleetVpcConfig>(map['vpcConfig']),
    );
  }
}
