...
class ResolverEndpointArgs {
  ...
  factory ResolverEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ResolverEndpointArgs(
      ...
      protocols: pulumi.Input.asOptionalInput<List<String>>(map['protocols']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      resolverEndpointType:
          pulumi.Input.asOptionalInput<String>(map['resolverEndpointType']),
      rniEnhancedMetricsEnabled:
          pulumi.Input.asOptionalInput<bool>(map['rniEnhancedMetricsEnabled']),
      securityGroupIds:
