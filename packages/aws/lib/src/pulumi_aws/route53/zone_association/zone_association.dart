...
/// Manages a Route53 Hosted Zone VPC association. VPC associations can only be made on private zones. See the <span pulumi-lang-nodejs="`aws.route53.VpcAssociationAuthorization`" pulumi-lang-dotnet="`aws.route53.VpcAssociationAuthorization`" pulumi-lang-go="`route53.VpcAssociationAuthorization`" pulumi-lang-python="`route53.VpcAssociationAuthorization`" pulumi-lang-yaml="`aws.route53.VpcAssociationAuthorization`" pulumi-lang-java="`aws.route53.VpcAssociationAuthorization`">`aws.route53.VpcAssociationAuthorization`</span> resource for setting up cross-account associations.
///
/// > **NOTE:** Unless explicit association ordering is required (e.g., a separate cross-account association authorization), usage of this resource is not recommended. Use the <span pulumi-lang-nodejs="`vpc`" pulumi-lang-dotnet="`Vpc`" pulumi-lang-go="`vpc`" pulumi-lang-python="`vpc`" pulumi-lang-yaml="`vpc`" pulumi-lang-java="`vpc`">`vpc`</span> configuration blocks available within the <span pulumi-lang-nodejs="`aws.route53.Zone`" pulumi-lang-dotnet="`aws.route53.Zone`" pulumi-lang-go="`route53.Zone`" pulumi-lang-python="`route53.Zone`" pulumi-lang-yaml="`aws.route53.Zone`" pulumi-lang-java="`aws.route53.Zone`">`aws.route53.Zone`</span> resource instead.
///
/// > **NOTE:** This provider provides both this standalone Zone VPC Association resource and exclusive VPC associations defined in-line in the <span pulumi-lang-nodejs="`aws.route53.Zone`" pulumi-lang-dotnet="`aws.route53.Zone`" pulumi-lang-go="`route53.Zone`" pulumi-lang-python="`route53.Zone`" pulumi-lang-yaml="`aws.route53.Zone`" pulumi-lang-java="`aws.route53.Zone`">`aws.route53.Zone`</span> resource via <span pulumi-lang-nodejs="`vpc`" pulumi-lang-dotnet="`Vpc`" pulumi-lang-go="`vpc`" pulumi-lang-python="`vpc`" pulumi-lang-yaml="`vpc`" pulumi-lang-java="`vpc`">`vpc`</span> configuration blocks. At this time, you cannot use those in-line VPC associations in conjunction with this resource and the same zone ID otherwise it will cause a perpetual difference in plan output. You can optionally use [`ignoreChanges`](https://www.pulumi.com/docs/intro/concepts/programming-model/#ignorechanges) in the <span pulumi-lang-nodejs="`aws.route53.Zone`" pulumi-lang-dotnet="`aws.route53.Zone`" pulumi-lang-go="`route53.Zone`" pulumi-lang-python="`route53.Zone`" pulumi-lang-yaml="`aws.route53.Zone`" pulumi-lang-java="`aws.route53.Zone`">`aws.route53.Zone`</span> resource to manage additional associations via this resource.
///
/// ## Example Usage
///
