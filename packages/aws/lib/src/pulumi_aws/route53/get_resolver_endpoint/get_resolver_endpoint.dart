...
/// <span pulumi-lang-nodejs="`aws.route53.ResolverEndpoint`" pulumi-lang-dotnet="`aws.route53.ResolverEndpoint`" pulumi-lang-go="`route53.ResolverEndpoint`" pulumi-lang-python="`route53.ResolverEndpoint`" pulumi-lang-yaml="`aws.route53.ResolverEndpoint`" pulumi-lang-java="`aws.route53.ResolverEndpoint`">`aws.route53.ResolverEndpoint`</span> provides details about a specific Route53 Resolver Endpoint.
///
