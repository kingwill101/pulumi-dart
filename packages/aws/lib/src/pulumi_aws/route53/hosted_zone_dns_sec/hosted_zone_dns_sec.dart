...
///
/// > **Note:** Route53 hosted zones are global resources, and as such any <span pulumi-lang-nodejs="`aws.kms.Key`" pulumi-lang-dotnet="`aws.kms.Key`" pulumi-lang-go="`kms.Key`" pulumi-lang-python="`kms.Key`" pulumi-lang-yaml="`aws.kms.Key`" pulumi-lang-java="`aws.kms.Key`">`aws.kms.Key`</span> that you use as part of a signing key needs to be located in the `us-east-1` region. In the example below, the main AWS provider declaration is for `us-east-1`, however if you are provisioning your AWS resources in a different region, you will need to specify a provider alias and use that attached to the <span pulumi-lang-nodejs="`aws.kms.Key`" pulumi-lang-dotnet="`aws.kms.Key`" pulumi-lang-go="`kms.Key`" pulumi-lang-python="`kms.Key`" pulumi-lang-yaml="`aws.kms.Key`" pulumi-lang-java="`aws.kms.Key`">`aws.kms.Key`</span> resource as described in the provider alias documentation.
///
/// ## Example Usage
///
...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.route53.HostedZoneDnsSec`" pulumi-lang-dotnet="`aws.route53.HostedZoneDnsSec`" pulumi-lang-go="`route53.HostedZoneDnsSec`" pulumi-lang-python="`route53.HostedZoneDnsSec`" pulumi-lang-yaml="`aws.route53.HostedZoneDnsSec`" pulumi-lang-java="`aws.route53.HostedZoneDnsSec`">`aws.route53.HostedZoneDnsSec`</span> resources using the Route 53 Hosted Zone identifier. For example:
///
/// ```sh
