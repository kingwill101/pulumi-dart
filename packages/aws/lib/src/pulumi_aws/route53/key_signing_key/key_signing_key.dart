...
/// Manages a Route 53 Key Signing Key. To manage Domain Name System Security Extensions (DNSSEC) for a Hosted Zone, see the <span pulumi-lang-nodejs="`aws.route53.HostedZoneDnsSec`" pulumi-lang-dotnet="`aws.route53.HostedZoneDnsSec`" pulumi-lang-go="`route53.HostedZoneDnsSec`" pulumi-lang-python="`route53.HostedZoneDnsSec`" pulumi-lang-yaml="`aws.route53.HostedZoneDnsSec`" pulumi-lang-java="`aws.route53.HostedZoneDnsSec`">`aws.route53.HostedZoneDnsSec`</span> resource. For more information about managing DNSSEC in Route 53, see the [Route 53 Developer Guide](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-configuring-dnssec.html).
///
/// ## Example Usage
///
...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.route53.KeySigningKey`" pulumi-lang-dotnet="`aws.route53.KeySigningKey`" pulumi-lang-go="`route53.KeySigningKey`" pulumi-lang-python="`route53.KeySigningKey`" pulumi-lang-yaml="`aws.route53.KeySigningKey`" pulumi-lang-java="`aws.route53.KeySigningKey`">`aws.route53.KeySigningKey`</span> resources using the Route 53 Hosted Zone identifier and KMS Key identifier, separated by a comma (`,`). For example:
///
/// ```sh
/// $ pulumi import aws:route53/keySigningKey:KeySigningKey example Z1D633PJN98FT9,example
/// ```
class KeySigningKey extends CustomResource {
  /// A string used to represent the delegation signer digest algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.3](https://tools.ietf.org/html/rfc8624#section-3.3).
  late final Output<String> digestAlgorithmMnemonic;
  ...
  late final Output<int> digestAlgorithmType;

  /// A cryptographic digest of a DNSKEY resource record (RR). DNSKEY records are used to publish the public key that resolvers can use to verify DNSSEC signatures that are used to secure certain kinds of information provided by the DNS system.
  late final Output<String> digestValue;

  /// A string that represents a DNSKEY record.
  late final Output<String> dnskeyRecord;

  /// A string that represents a delegation signer (DS) record.
  late final Output<String> dsRecord;

  /// An integer that specifies how the key is used. For key-signing key (KSK), this value is always 257.
  late final Output<int> flag;
  ...
  late final Output<String> keyManagementServiceArn;
  ...
  late final Output<String> signingAlgorithmMnemonic;
  ...
  late final Output<int> signingAlgorithmType;
