  ...
  factory HealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckArgs(
      childHealthThreshold:
          pulumi.Input.asOptionalInput<int>(map['childHealthThreshold']),
      childHealthchecks:
          pulumi.Input.asOptionalInput<List<String>>(map['childHealthchecks']),
      cloudwatchAlarmName:
          pulumi.Input.asOptionalInput<String>(map['cloudwatchAlarmName']),
      cloudwatchAlarmRegion:
          pulumi.Input.asOptionalInput<String>(map['cloudwatchAlarmRegion']),
      disabled: pulumi.Input.asOptionalInput<bool>(map['disabled']),
      enableSni: pulumi.Input.asOptionalInput<bool>(map['enableSni']),
      failureThreshold:
          pulumi.Input.asOptionalInput<int>(map['failureThreshold']),
      fqdn: pulumi.Input.asOptionalInput<String>(map['fqdn']),
      insufficientDataHealthStatus: pulumi.Input.asOptionalInput<String>(
          map['insufficientDataHealthStatus']),
      invertHealthcheck:
          pulumi.Input.asOptionalInput<bool>(map['invertHealthcheck']),
      ipAddress: pulumi.Input.asOptionalInput<String>(map['ipAddress']),
      measureLatency: pulumi.Input.asOptionalInput<bool>(map['measureLatency']),
      ...
      requestInterval:
          pulumi.Input.asOptionalInput<int>(map['requestInterval']),
      resourcePath: pulumi.Input.asOptionalInput<String>(map['resourcePath']),
      routingControlArn:
          pulumi.Input.asOptionalInput<String>(map['routingControlArn']),
