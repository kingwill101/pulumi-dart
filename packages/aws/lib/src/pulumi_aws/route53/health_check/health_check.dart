...
///
/// The <span pulumi-lang-nodejs="`triggers`" pulumi-lang-dotnet="`Triggers`" pulumi-lang-go="`triggers`" pulumi-lang-python="`triggers`" pulumi-lang-yaml="`triggers`" pulumi-lang-java="`triggers`">`triggers`</span> argument allows the Route53 health check to be synchronized when a change to the upstream CloudWatch alarm is made.
/// In the configuration below, the health check will be synchronized any time the <span pulumi-lang-nodejs="`threshold`" pulumi-lang-dotnet="`Threshold`" pulumi-lang-go="`threshold`" pulumi-lang-python="`threshold`" pulumi-lang-yaml="`threshold`" pulumi-lang-java="`threshold`">`threshold`</span> of the alarm is changed.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import Route53 Health Checks using the health check <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
