...
/// <span pulumi-lang-nodejs="`aws.route53.ResolverFirewallConfig`" pulumi-lang-dotnet="`aws.route53.ResolverFirewallConfig`" pulumi-lang-go="`route53.ResolverFirewallConfig`" pulumi-lang-python="`route53.ResolverFirewallConfig`" pulumi-lang-yaml="`aws.route53.ResolverFirewallConfig`" pulumi-lang-java="`aws.route53.ResolverFirewallConfig`">`aws.route53.ResolverFirewallConfig`</span> provides details about a specific a Route 53 Resolver DNS Firewall config.
///
