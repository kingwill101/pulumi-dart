...
class RecordArgs {
  ...
  factory RecordArgs.fromMap(Map<String, dynamic> map) {
    return RecordArgs(
      aliases: pulumi.Input.asOptionalInput<List<RecordAlias>>(map['aliases']),
      allowOverwrite: pulumi.Input.asOptionalInput<bool>(map['allowOverwrite']),
      cidrRoutingPolicy: pulumi.Input.asOptionalInput<RecordCidrRoutingPolicy>(
      ...
      healthCheckId: pulumi.Input.asOptionalInput<String>(map['healthCheckId']),
      ...
      multivalueAnswerRoutingPolicy: pulumi.Input.asOptionalInput<bool>(
          map['multivalueAnswerRoutingPolicy']),
      name: pulumi.Input.asInput<String>(map['name']),
      records: pulumi.Input.asOptionalInput<List<String>>(map['records']),
      setIdentifier: pulumi.Input.asOptionalInput<String>(map['setIdentifier']),
