...
import '../get_records_resource_record_set_geoproximity_location_coordinates/get_records_resource_record_set_geoproximity_location_coordinates.dart';
...
class GetRecordsResourceRecordSetGeoproximityLocation {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['bias'] = bias;
    map['coordinates'] = coordinates.toMap();
    map['localZoneGroup'] = localZoneGroup;
    return map;
  }
