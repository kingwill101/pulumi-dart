...
import 'event_rule_notifications_args.dart';
...
/// ```
class EventRuleNotifications extends pulumi.CustomResource {
  ...
  EventRuleNotifications(
    String name, {
    EventRuleNotificationsArgs? args,
