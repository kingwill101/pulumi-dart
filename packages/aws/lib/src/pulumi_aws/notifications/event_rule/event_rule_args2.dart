...
class EventRuleArgs2 {
  ...
  factory EventRuleArgs2.fromMap(Map<String, dynamic> map) {
    return EventRuleArgs2(
      eventPattern: Input.asOptionalInput<String>(map['eventPattern']),
      eventType: Input.asInput<String>(map['eventType']),
