...
/// ## Import
///
/// Using `pulumi import`, import Transcribe MedicalVocabulary using the <span pulumi-lang-nodejs="`vocabularyName`" pulumi-lang-dotnet="`VocabularyName`" pulumi-lang-go="`vocabularyName`" pulumi-lang-python="`vocabulary_name`" pulumi-lang-yaml="`vocabularyName`" pulumi-lang-java="`vocabularyName`">`vocabulary_name`</span>. For example:
///
/// ```sh
...
class MedicalVocabulary extends CustomResource {
  ...
  /// A map of tags to assign to the MedicalVocabulary. If configured with a provider <span pulumi-lang-nodejs="`defaultTags`" pulumi-lang-dotnet="`DefaultTags`" pulumi-lang-go="`defaultTags`" pulumi-lang-python="`default_tags`" pulumi-lang-yaml="`defaultTags`" pulumi-lang-java="`defaultTags`">`default_tags`</span> configuration block present, tags with matching keys will overwrite those defined at the provider-level.
