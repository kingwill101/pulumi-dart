...
/// ## Import
///
/// Using `pulumi import`, import Transcribe Vocabulary using the <span pulumi-lang-nodejs="`vocabularyName`" pulumi-lang-dotnet="`VocabularyName`" pulumi-lang-go="`vocabularyName`" pulumi-lang-python="`vocabulary_name`" pulumi-lang-yaml="`vocabularyName`" pulumi-lang-java="`vocabularyName`">`vocabulary_name`</span>. For example:
///
/// ```sh
