...
/// ## Import
///
/// Using `pulumi import`, import Transcribe LanguageModel using the <span pulumi-lang-nodejs="`modelName`" pulumi-lang-dotnet="`ModelName`" pulumi-lang-go="`modelName`" pulumi-lang-python="`model_name`" pulumi-lang-yaml="`modelName`" pulumi-lang-java="`modelName`">`model_name`</span>. For example:
///
/// ```sh
