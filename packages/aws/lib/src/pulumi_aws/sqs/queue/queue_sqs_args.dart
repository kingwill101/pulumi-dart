...
class QueueSqsArgs {
  ...
  factory QueueSqsArgs.fromMap(Map<String, dynamic> map) {
    return QueueSqsArgs(
      contentBasedDeduplication:
          pulumi.Input.asOptionalInput<bool>(map['contentBasedDeduplication']),
      deduplicationScope:
          pulumi.Input.asOptionalInput<String>(map['deduplicationScope']),
      delaySeconds: pulumi.Input.asOptionalInput<int>(map['delaySeconds']),
      fifoQueue: pulumi.Input.asOptionalInput<bool>(map['fifoQueue']),
      fifoThroughputLimit:
          pulumi.Input.asOptionalInput<String>(map['fifoThroughputLimit']),
      kmsDataKeyReusePeriodSeconds: pulumi.Input.asOptionalInput<int>(
          map['kmsDataKeyReusePeriodSeconds']),
      kmsMasterKeyId:
          pulumi.Input.asOptionalInput<String>(map['kmsMasterKeyId']),
      maxMessageSize: pulumi.Input.asOptionalInput<int>(map['maxMessageSize']),
      messageRetentionSeconds:
          pulumi.Input.asOptionalInput<int>(map['messageRetentionSeconds']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      namePrefix: pulumi.Input.asOptionalInput<String>(map['namePrefix']),
      policy: pulumi.Input.asOptionalInput<String>(map['policy']),
      receiveWaitTimeSeconds:
          pulumi.Input.asOptionalInput<int>(map['receiveWaitTimeSeconds']),
      redriveAllowPolicy:
          pulumi.Input.asOptionalInput<String>(map['redriveAllowPolicy']),
      redrivePolicy: pulumi.Input.asOptionalInput<String>(map['redrivePolicy']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      sqsManagedSseEnabled:
          pulumi.Input.asOptionalInput<bool>(map['sqsManagedSseEnabled']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      visibilityTimeoutSeconds:
          pulumi.Input.asOptionalInput<int>(map['visibilityTimeoutSeconds']),
    );
  }
}
