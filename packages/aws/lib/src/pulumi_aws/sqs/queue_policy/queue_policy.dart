...
///
/// !> AWS will hang indefinitely when creating or updating an <span pulumi-lang-nodejs="`aws.sqs.Queue`" pulumi-lang-dotnet="`aws.sqs.Queue`" pulumi-lang-go="`sqs.Queue`" pulumi-lang-python="`sqs.Queue`" pulumi-lang-yaml="`aws.sqs.Queue`" pulumi-lang-java="`aws.sqs.Queue`">`aws.sqs.Queue`</span> with an associated policy if `Version = "2012-10-17"` is not explicitly set in the policy. See below for an example of how to avoid this issue.
///
/// ## Example Usage
///
/// ### Basic Usage
