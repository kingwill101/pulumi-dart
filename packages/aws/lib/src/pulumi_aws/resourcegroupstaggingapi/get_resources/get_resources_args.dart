  ...
  factory GetResourcesArgs.fromMap(Map<String, dynamic> map) {
    return GetResourcesArgs(
      excludeCompliantResources:
          pulumi.Input.asOptionalInput<bool>(map['excludeCompliantResources']),
      includeComplianceDetails:
          pulumi.Input.asOptionalInput<bool>(map['includeComplianceDetails']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      resourceArnLists:
          pulumi.Input.asOptionalInput<List<String>>(map['resourceArnLists']),
      resourceTypeFilters: pulumi.Input.asOptionalInput<List<String>>(
          map['resourceTypeFilters']),
