...
class ClusterRestoreToPointInTimeRds {
  ...
  ClusterRestoreToPointInTimeRds({
    this.restoreToTime,
    this.restoreType,
  ...
  factory ClusterRestoreToPointInTimeRds.fromMap(Map<String, dynamic> map) {
    return ClusterRestoreToPointInTimeRds(
      restoreToTime:
