...
class EventSubscriptionRdsArgs {
  ...
  factory EventSubscriptionRdsArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionRdsArgs(
      ...
      snsTopic: pulumi.Input.asInput<String>(map['snsTopic']),
