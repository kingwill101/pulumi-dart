...
class GetEngineVersionResult3 {
  ...
  factory GetEngineVersionResult3.fromMap(Map<String, dynamic> map) {
    return GetEngineVersionResult3(
      ...
      filters: map['filters'] == null
          ? null
          : Input.decodeList<GetEngineVersionFilter>(
              map['filters'],
