...
class GetEngineVersionRdsArgs {
  ...
  factory GetEngineVersionRdsArgs.fromMap(Map<String, dynamic> map) {
    return GetEngineVersionRdsArgs(
      defaultOnly: pulumi.Input.asOptionalInput<bool>(map['defaultOnly']),
      engine: pulumi.Input.asInput<String>(map['engine']),
      filters: pulumi.Input.asOptionalInput<List<GetEngineVersionFilter>>(
          map['filters']),
