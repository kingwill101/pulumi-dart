...
class GetOrderableDbInstanceRdsArgs {
  ...
  factory GetOrderableDbInstanceRdsArgs.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceRdsArgs(
      availabilityZoneGroup:
          pulumi.Input.asOptionalInput<String>(map['availabilityZoneGroup']),
      engine: pulumi.Input.asInput<String>(map['engine']),
      engineLatestVersion:
          pulumi.Input.asOptionalInput<bool>(map['engineLatestVersion']),
      ...
      preferredEngineVersions: pulumi.Input.asOptionalInput<List<String>>(
          map['preferredEngineVersions']),
      preferredInstanceClasses: pulumi.Input.asOptionalInput<List<String>>(
          map['preferredInstanceClasses']),
      readReplicaCapable:
          pulumi.Input.asOptionalInput<bool>(map['readReplicaCapable']),
      ...
      supportedEngineModes: pulumi.Input.asOptionalInput<List<String>>(
          map['supportedEngineModes']),
      supportedNetworkTypes: pulumi.Input.asOptionalInput<List<String>>(
          map['supportedNetworkTypes']),
      supportsClusters:
          pulumi.Input.asOptionalInput<bool>(map['supportsClusters']),
      supportsEnhancedMonitoring:
          pulumi.Input.asOptionalInput<bool>(map['supportsEnhancedMonitoring']),
      supportsGlobalDatabases:
          pulumi.Input.asOptionalInput<bool>(map['supportsGlobalDatabases']),
      supportsIamDatabaseAuthentication: pulumi.Input.asOptionalInput<bool>(
          map['supportsIamDatabaseAuthentication']),
      supportsIops: pulumi.Input.asOptionalInput<bool>(map['supportsIops']),
      supportsKerberosAuthentication: pulumi.Input.asOptionalInput<bool>(
          map['supportsKerberosAuthentication']),
      supportsMultiAz:
          pulumi.Input.asOptionalInput<bool>(map['supportsMultiAz']),
      supportsPerformanceInsights: pulumi.Input.asOptionalInput<bool>(
          map['supportsPerformanceInsights']),
      supportsStorageAutoscaling:
          pulumi.Input.asOptionalInput<bool>(map['supportsStorageAutoscaling']),
      supportsStorageEncryption:
          pulumi.Input.asOptionalInput<bool>(map['supportsStorageEncryption']),
      vpc: pulumi.Input.asOptionalInput<bool>(map['vpc']),
    );
  }
}
