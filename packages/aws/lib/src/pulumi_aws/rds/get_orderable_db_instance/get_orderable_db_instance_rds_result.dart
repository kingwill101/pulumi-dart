...
class GetOrderableDbInstanceRdsResult {
  ...
  GetOrderableDbInstanceRdsResult({
  ...
  factory GetOrderableDbInstanceRdsResult.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceRdsResult(
