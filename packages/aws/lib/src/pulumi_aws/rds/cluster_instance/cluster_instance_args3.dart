...
class ClusterInstanceArgs3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['engine'] =
        Input.mapInputValue<EngineType, String>(engine, (value) => value.value);
  ...
  factory ClusterInstanceArgs3.fromMap(Map<String, dynamic> map) {
    return ClusterInstanceArgs3(
      ...
      dbParameterGroupName:
          Input.asOptionalInput<String>(map['dbParameterGroupName']),
      dbSubnetGroupName:
          Input.asOptionalInput<String>(map['dbSubnetGroupName']),
      engine: Input.asInput<EngineType>(map['engine']),
