...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the RDS integration.
///
///
/// Using `pulumi import`, import RDS (Relational Database) Integration using the <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
...
/// ```
class Integration3 extends CustomResource {
  ...
  late final Output<String> dataFilter;
  ...
  late final Output<IntegrationTimeouts?> timeouts;

  Integration3(
    String name, {
    IntegrationArgs3? args,
