...
class IntegrationRdsArgs {
  ...
  factory IntegrationRdsArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationRdsArgs(
      additionalEncryptionContext:
          pulumi.Input.asOptionalInput<Map<String, String>>(
              map['additionalEncryptionContext']),
      dataFilter: pulumi.Input.asOptionalInput<String>(map['dataFilter']),
      ...
      timeouts:
          pulumi.Input.asOptionalInput<IntegrationTimeouts>(map['timeouts']),
    );
  }
}
