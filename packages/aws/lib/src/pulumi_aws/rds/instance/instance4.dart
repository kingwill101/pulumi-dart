...
/// <span pulumi-lang-nodejs="`allocatedStorage`" pulumi-lang-dotnet="`AllocatedStorage`" pulumi-lang-go="`allocatedStorage`" pulumi-lang-python="`allocated_storage`" pulumi-lang-yaml="`allocatedStorage`" pulumi-lang-java="`allocatedStorage`">`allocated_storage`</span>, and are reflected in the next maintenance window. Because
/// of this, this provider may report a difference in its planning phase because a
/// modification has not yet taken place. You can use the <span pulumi-lang-nodejs="`applyImmediately`" pulumi-lang-dotnet="`ApplyImmediately`" pulumi-lang-go="`applyImmediately`" pulumi-lang-python="`apply_immediately`" pulumi-lang-yaml="`applyImmediately`" pulumi-lang-java="`applyImmediately`">`apply_immediately`</span> flag
/// to instruct the service to apply the change immediately (see documentation
/// below).
///
/// When upgrading the major version of an engine, <span pulumi-lang-nodejs="`allowMajorVersionUpgrade`" pulumi-lang-dotnet="`AllowMajorVersionUpgrade`" pulumi-lang-go="`allowMajorVersionUpgrade`" pulumi-lang-python="`allow_major_version_upgrade`" pulumi-lang-yaml="`allowMajorVersionUpgrade`" pulumi-lang-java="`allowMajorVersionUpgrade`">`allow_major_version_upgrade`</span> must be set to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>.
///
...
///
/// Enable low-downtime updates by setting `blue_green_update.enabled` to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>.
///
/// ## Example Usage
///
/// ### Basic Usage
...
/// ### Storage Autoscaling
///
/// To enable Storage Autoscaling with instances that support the feature, define the <span pulumi-lang-nodejs="`maxAllocatedStorage`" pulumi-lang-dotnet="`MaxAllocatedStorage`" pulumi-lang-go="`maxAllocatedStorage`" pulumi-lang-python="`max_allocated_storage`" pulumi-lang-yaml="`maxAllocatedStorage`" pulumi-lang-java="`maxAllocatedStorage`">`max_allocated_storage`</span> argument higher than the <span pulumi-lang-nodejs="`allocatedStorage`" pulumi-lang-dotnet="`AllocatedStorage`" pulumi-lang-go="`allocatedStorage`" pulumi-lang-python="`allocated_storage`" pulumi-lang-yaml="`allocatedStorage`" pulumi-lang-java="`allocatedStorage`">`allocated_storage`</span> argument. This provider will automatically hide differences with the <span pulumi-lang-nodejs="`allocatedStorage`" pulumi-lang-dotnet="`AllocatedStorage`" pulumi-lang-go="`allocatedStorage`" pulumi-lang-python="`allocated_storage`" pulumi-lang-yaml="`allocatedStorage`" pulumi-lang-java="`allocatedStorage`">`allocated_storage`</span> argument value if autoscaling occurs.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import DB Instances using the <span pulumi-lang-nodejs="`identifier`" pulumi-lang-dotnet="`Identifier`" pulumi-lang-go="`identifier`" pulumi-lang-python="`identifier`" pulumi-lang-yaml="`identifier`" pulumi-lang-java="`identifier`">`identifier`</span>. For example:
///
/// ```sh
