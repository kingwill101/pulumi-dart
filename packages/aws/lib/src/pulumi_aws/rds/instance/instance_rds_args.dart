...
class InstanceRdsArgs {
  ...
  factory InstanceRdsArgs.fromMap(Map<String, dynamic> map) {
    return InstanceRdsArgs(
      allocatedStorage:
      ...
      backupTarget: pulumi.Input.asOptionalInput<String>(map['backupTarget']),
      backupWindow: pulumi.Input.asOptionalInput<String>(map['backupWindow']),
      ...
      characterSetName:
          pulumi.Input.asOptionalInput<String>(map['characterSetName']),
      copyTagsToSnapshot:
      ...
      customerOwnedIpEnabled:
          pulumi.Input.asOptionalInput<bool>(map['customerOwnedIpEnabled']),
      ...
      dedicatedLogVolume:
          pulumi.Input.asOptionalInput<bool>(map['dedicatedLogVolume']),
      ...
      domainAuthSecretArn:
          pulumi.Input.asOptionalInput<String>(map['domainAuthSecretArn']),
      domainDnsIps:
          pulumi.Input.asOptionalInput<List<String>>(map['domainDnsIps']),
      domainFqdn: pulumi.Input.asOptionalInput<String>(map['domainFqdn']),
      domainIamRoleName:
          pulumi.Input.asOptionalInput<String>(map['domainIamRoleName']),
      domainOu: pulumi.Input.asOptionalInput<String>(map['domainOu']),
      ...
      maxAllocatedStorage:
          pulumi.Input.asOptionalInput<int>(map['maxAllocatedStorage']),
      monitoringInterval:
      ...
      ncharCharacterSetName:
          pulumi.Input.asOptionalInput<String>(map['ncharCharacterSetName']),
      ...
      passwordWoVersion:
          pulumi.Input.asOptionalInput<int>(map['passwordWoVersion']),
      ...
      replicaMode: pulumi.Input.asOptionalInput<String>(map['replicaMode']),
      replicateSourceDb:
          pulumi.Input.asOptionalInput<String>(map['replicateSourceDb']),
      restoreToPointInTime:
          pulumi.Input.asOptionalInput<InstanceRestoreToPointInTime>(
              map['restoreToPointInTime']),
      s3Import: pulumi.Input.asOptionalInput<InstanceS3Import>(map['s3Import']),
      skipFinalSnapshot:
      ...
      storageThroughput:
          pulumi.Input.asOptionalInput<int>(map['storageThroughput']),
      ...
      upgradeStorageConfig:
          pulumi.Input.asOptionalInput<bool>(map['upgradeStorageConfig']),
