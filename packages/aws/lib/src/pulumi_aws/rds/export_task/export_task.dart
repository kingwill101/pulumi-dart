...
/// ## Import
///
/// Using `pulumi import`, import a RDS (Relational Database) Export Task using the <span pulumi-lang-nodejs="`exportTaskIdentifier`" pulumi-lang-dotnet="`ExportTaskIdentifier`" pulumi-lang-go="`exportTaskIdentifier`" pulumi-lang-python="`export_task_identifier`" pulumi-lang-yaml="`exportTaskIdentifier`" pulumi-lang-java="`exportTaskIdentifier`">`export_task_identifier`</span>. For example:
///
/// ```sh
