...
class ProxyArgs {
  ...
  factory ProxyArgs.fromMap(Map<String, dynamic> map) {
    return ProxyArgs(
      auths: pulumi.Input.asOptionalInput<List<ProxyAuth>>(map['auths']),
      debugLogging: pulumi.Input.asOptionalInput<bool>(map['debugLogging']),
      defaultAuthScheme:
          pulumi.Input.asOptionalInput<String>(map['defaultAuthScheme']),
      endpointNetworkType:
          pulumi.Input.asOptionalInput<String>(map['endpointNetworkType']),
      engineFamily: pulumi.Input.asInput<String>(map['engineFamily']),
      idleClientTimeout:
          pulumi.Input.asOptionalInput<int>(map['idleClientTimeout']),
      ...
      targetConnectionNetworkType: pulumi.Input.asOptionalInput<String>(
          map['targetConnectionNetworkType']),
