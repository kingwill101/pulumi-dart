...
///
/// > **Note:** This resource always calls the RDS [`StartActivityStream`][2] API with the `ApplyImmediately` parameter set to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>. This is because the provider needs the activity stream to be started in order for it to get the associated attributes.
///
/// > **Note:** This resource depends on having at least one <span pulumi-lang-nodejs="`aws.rds.ClusterInstance`" pulumi-lang-dotnet="`aws.rds.ClusterInstance`" pulumi-lang-go="`rds.ClusterInstance`" pulumi-lang-python="`rds.ClusterInstance`" pulumi-lang-yaml="`aws.rds.ClusterInstance`" pulumi-lang-java="`aws.rds.ClusterInstance`">`aws.rds.ClusterInstance`</span> created. To avoid race conditions when all resources are being created together, add an explicit resource reference using the resource <span pulumi-lang-nodejs="`dependsOn`" pulumi-lang-dotnet="`DependsOn`" pulumi-lang-go="`dependsOn`" pulumi-lang-python="`depends_on`" pulumi-lang-yaml="`dependsOn`" pulumi-lang-java="`dependsOn`">`depends_on`</span> meta-argument.
///
...
/// ## Import
///
/// Using `pulumi import`, import RDS Aurora Cluster Database Activity Streams using the <span pulumi-lang-nodejs="`resourceArn`" pulumi-lang-dotnet="`ResourceArn`" pulumi-lang-go="`resourceArn`" pulumi-lang-python="`resource_arn`" pulumi-lang-yaml="`resourceArn`" pulumi-lang-java="`resourceArn`">`resource_arn`</span>. For example:
///
/// ```sh
