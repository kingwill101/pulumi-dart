...
class ClusterActivityStreamArgs {
  /// Specifies whether the database activity stream includes engine-native audit fields. This option only applies to an Oracle DB instance. By default, no engine-native audit fields are included. Defaults <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span>.
  ///
  ...
  /// Specifies the mode of the database activity stream. Database events such as a change or access generate an activity stream event. The database session can handle these events either synchronously or asynchronously. One of: <span pulumi-lang-nodejs="`sync`" pulumi-lang-dotnet="`Sync`" pulumi-lang-go="`sync`" pulumi-lang-python="`sync`" pulumi-lang-yaml="`sync`" pulumi-lang-java="`sync`">`sync`</span>, <span pulumi-lang-nodejs="`async`" pulumi-lang-dotnet="`Async`" pulumi-lang-go="`async`" pulumi-lang-python="`async`" pulumi-lang-yaml="`async`" pulumi-lang-java="`async`">`async`</span>.
