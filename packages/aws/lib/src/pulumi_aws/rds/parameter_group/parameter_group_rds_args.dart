...
class ParameterGroupRdsArgs {
  ...
  final pulumi.Input<List<ParameterGroupParameterRds>>? parameters;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (parametersValue != null) {
      map['parameters'] = pulumi.Input.mapOptionalInputValue<
              List<ParameterGroupParameterRds>, List<Map<String, dynamic>>>(
          parametersValue,
          (value) => pulumi.Input.encodeList<ParameterGroupParameterRds,
  ...
  factory ParameterGroupRdsArgs.fromMap(Map<String, dynamic> map) {
    return ParameterGroupRdsArgs(
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      family: pulumi.Input.asInput<String>(map['family']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      namePrefix: pulumi.Input.asOptionalInput<String>(map['namePrefix']),
      parameters:
          pulumi.Input.asOptionalInput<List<ParameterGroupParameterRds>>(
              map['parameters']),
