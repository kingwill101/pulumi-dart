...
class GlobalClusterGlobalClusterMemberRds {
  ...
  GlobalClusterGlobalClusterMemberRds({
    this.dbClusterArn,
    this.isWriter,
  });
  ...
  factory GlobalClusterGlobalClusterMemberRds.fromMap(
      Map<String, dynamic> map) {
    return GlobalClusterGlobalClusterMemberRds(
      dbClusterArn:
