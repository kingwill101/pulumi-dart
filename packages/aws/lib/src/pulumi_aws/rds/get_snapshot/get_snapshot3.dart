...
/// See the <span pulumi-lang-nodejs="`aws.rds.ClusterSnapshot`" pulumi-lang-dotnet="`aws.rds.ClusterSnapshot`" pulumi-lang-go="`rds.ClusterSnapshot`" pulumi-lang-python="`rds.ClusterSnapshot`" pulumi-lang-yaml="`aws.rds.ClusterSnapshot`" pulumi-lang-java="`aws.rds.ClusterSnapshot`">`aws.rds.ClusterSnapshot`</span> data source for DB Cluster snapshots.
///
/// ## Example Usage
///
