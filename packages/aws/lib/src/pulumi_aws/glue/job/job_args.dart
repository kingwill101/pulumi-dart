...
class JobArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['command'] =
        pulumi.Input.mapInputValue<JobCommand, Map<String, dynamic>>(
    ...
    if (executionPropertyValue != null) {
      map['executionProperty'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (notificationPropertyValue != null) {
      map['notificationProperty'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (sourceControlDetailsValue != null) {
      map['sourceControlDetails'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      command: pulumi.Input.asInput<JobCommand>(map['command']),
      connections:
          pulumi.Input.asOptionalInput<List<String>>(map['connections']),
      defaultArguments: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['defaultArguments']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      executionClass:
          pulumi.Input.asOptionalInput<String>(map['executionClass']),
      executionProperty: pulumi.Input.asOptionalInput<JobExecutionProperty>(
          map['executionProperty']),
      glueVersion: pulumi.Input.asOptionalInput<String>(map['glueVersion']),
      jobMode: pulumi.Input.asOptionalInput<String>(map['jobMode']),
      jobRunQueuingEnabled:
          pulumi.Input.asOptionalInput<bool>(map['jobRunQueuingEnabled']),
      maintenanceWindow:
