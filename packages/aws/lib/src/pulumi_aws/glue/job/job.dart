...
///
/// > Glue functionality, such as monitoring and logging of jobs, is typically managed with the <span pulumi-lang-nodejs="`defaultArguments`" pulumi-lang-dotnet="`DefaultArguments`" pulumi-lang-go="`defaultArguments`" pulumi-lang-python="`default_arguments`" pulumi-lang-yaml="`defaultArguments`" pulumi-lang-java="`defaultArguments`">`default_arguments`</span> argument. See the [Special Parameters Used by AWS Glue](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-programming-etl-glue-arguments.html) topic in the Glue developer guide for additional information.
///
/// ## Example Usage
///
/// ### Python Glue Job
...
/// ## Import
///
/// Using `pulumi import`, import Glue Jobs using <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
