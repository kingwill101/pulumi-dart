...
/// The workflow graph (DAG) can be build using the <span pulumi-lang-nodejs="`aws.glue.Trigger`" pulumi-lang-dotnet="`aws.glue.Trigger`" pulumi-lang-go="`glue.Trigger`" pulumi-lang-python="`glue.Trigger`" pulumi-lang-yaml="`aws.glue.Trigger`" pulumi-lang-java="`aws.glue.Trigger`">`aws.glue.Trigger`</span> resource.
...
/// ## Import
///
/// Using `pulumi import`, import Glue Workflows using <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
