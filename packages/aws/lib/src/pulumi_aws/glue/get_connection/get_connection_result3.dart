...
class GetConnectionResult3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['physicalConnectionRequirements'] = Input.encodeList<
  ...
  factory GetConnectionResult3.fromMap(Map<String, dynamic> map) {
    return GetConnectionResult3(
      ...
      physicalConnectionRequirements:
          Input.decodeList<GetConnectionPhysicalConnectionRequirement>(
