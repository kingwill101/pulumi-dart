...
class GetCatalogTableArgs {
  ...
  /// The time as of when to read the table contents. If not set, the most recent transaction commit time will be used. Cannot be specified along with <span pulumi-lang-nodejs="`transactionId`" pulumi-lang-dotnet="`TransactionId`" pulumi-lang-go="`transactionId`" pulumi-lang-python="`transaction_id`" pulumi-lang-yaml="`transactionId`" pulumi-lang-java="`transactionId`">`transaction_id`</span>. Specified in RFC 3339 format, e.g. `2006-01-02T15:04:05Z07:00`.
