...
class Connection5 extends CustomResource {
  ...
  /// Map of physical connection requirements, such as VPC and SecurityGroup. See <span pulumi-lang-nodejs="`physicalConnectionRequirements`" pulumi-lang-dotnet="`PhysicalConnectionRequirements`" pulumi-lang-go="`physicalConnectionRequirements`" pulumi-lang-python="`physical_connection_requirements`" pulumi-lang-yaml="`physicalConnectionRequirements`" pulumi-lang-java="`physicalConnectionRequirements`">`physical_connection_requirements`</span> Block for details.
