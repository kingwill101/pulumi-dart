...
/// ## Import
///
/// Using `pulumi import`, import an AWS FinSpace Kx Database using the <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span> (environment ID and database name, comma-delimited). For example:
///
/// ```sh
