...
class KxClusterSavedownStorageConfiguration {
  ...
  Map<String, dynamic> toMap() {
    ...
    final volumeNameValue = volumeName;
    if (volumeNameValue != null) {
      map['volumeName'] = volumeNameValue;
    }
    return map;
  }

  factory KxClusterSavedownStorageConfiguration.fromMap(
      Map<String, dynamic> map) {
    return KxClusterSavedownStorageConfiguration(
      size: map['size'] == null ? null : map['size'] as int,
      type: map['type'] == null ? null : map['type'] as String,
      volumeName:
          map['volumeName'] == null ? null : map['volumeName'] as String,
    );
  }
}
