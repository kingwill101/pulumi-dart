...
class KxVolumeArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (nas1ConfigurationsValue != null) {
      map['nas1Configurations'] = Input.mapOptionalInputValue<
              List<KxVolumeNas1Configuration>, List<Map<String, dynamic>>>(
          nas1ConfigurationsValue,
          (value) =>
              Input.encodeList<KxVolumeNas1Configuration, Map<String, dynamic>>(
  ...
  factory KxVolumeArgs.fromMap(Map<String, dynamic> map) {
    return KxVolumeArgs(
      ...
      nas1Configurations:
          Input.asOptionalInput<List<KxVolumeNas1Configuration>>(
