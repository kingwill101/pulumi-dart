...
///
/// > **NOTE:** The underlying <span pulumi-lang-nodejs="`aws.securitylake.DataLake`" pulumi-lang-dotnet="`aws.securitylake.DataLake`" pulumi-lang-go="`securitylake.DataLake`" pulumi-lang-python="`securitylake.DataLake`" pulumi-lang-yaml="`aws.securitylake.DataLake`" pulumi-lang-java="`aws.securitylake.DataLake`">`aws.securitylake.DataLake`</span> must be configured before creating the <span pulumi-lang-nodejs="`aws.securitylake.CustomLogSource`" pulumi-lang-dotnet="`aws.securitylake.CustomLogSource`" pulumi-lang-go="`securitylake.CustomLogSource`" pulumi-lang-python="`securitylake.CustomLogSource`" pulumi-lang-yaml="`aws.securitylake.CustomLogSource`" pulumi-lang-java="`aws.securitylake.CustomLogSource`">`aws.securitylake.CustomLogSource`</span>. Use a <span pulumi-lang-nodejs="`dependsOn`" pulumi-lang-dotnet="`DependsOn`" pulumi-lang-go="`dependsOn`" pulumi-lang-python="`depends_on`" pulumi-lang-yaml="`dependsOn`" pulumi-lang-java="`dependsOn`">`depends_on`</span> statement.
///
/// ## Example Usage
///
/// ### Basic Usage
