...
///
/// > **NOTE:** The underlying <span pulumi-lang-nodejs="`aws.securitylake.DataLake`" pulumi-lang-dotnet="`aws.securitylake.DataLake`" pulumi-lang-go="`securitylake.DataLake`" pulumi-lang-python="`securitylake.DataLake`" pulumi-lang-yaml="`aws.securitylake.DataLake`" pulumi-lang-java="`aws.securitylake.DataLake`">`aws.securitylake.DataLake`</span> must be configured before creating other Security Lake resources. Use a <span pulumi-lang-nodejs="`dependsOn`" pulumi-lang-dotnet="`DependsOn`" pulumi-lang-go="`dependsOn`" pulumi-lang-python="`depends_on`" pulumi-lang-yaml="`dependsOn`" pulumi-lang-java="`dependsOn`">`depends_on`</span> statement.
///
/// ## Example Usage
///
...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the Security Lake data lake.
///
///
...
class DataLake extends CustomResource {
  ...
  DataLake(
    ...
    this.configuration = Output.createUnknown<DataLakeConfiguration>();
    this.metaStoreManagerRoleArn = Output.createUnknown<String>();
    this.region = Output.createUnknown<String>();
    this.s3BucketArn = Output.createUnknown<String>();
    this.tags = Output.createUnknown<Map<String, String>?>();
    this.tagsAll = Output.createUnknown<Map<String, String>>();
    this.timeouts = Output.createUnknown<DataLakeTimeouts?>();
  }
}
