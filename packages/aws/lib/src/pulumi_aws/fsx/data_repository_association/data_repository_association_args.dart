  ...
  factory DataRepositoryAssociationArgs.fromMap(Map<String, dynamic> map) {
    return DataRepositoryAssociationArgs(
      batchImportMetaDataOnCreate: pulumi.Input.asOptionalInput<bool>(
          map['batchImportMetaDataOnCreate']),
      dataRepositoryPath:
          pulumi.Input.asInput<String>(map['dataRepositoryPath']),
      deleteDataInFilesystem:
          pulumi.Input.asOptionalInput<bool>(map['deleteDataInFilesystem']),
      fileSystemId: pulumi.Input.asInput<String>(map['fileSystemId']),
      fileSystemPath: pulumi.Input.asInput<String>(map['fileSystemPath']),
      importedFileChunkSize:
          pulumi.Input.asOptionalInput<int>(map['importedFileChunkSize']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      s3: pulumi.Input.asOptionalInput<DataRepositoryAssociationS3>(map['s3']),
