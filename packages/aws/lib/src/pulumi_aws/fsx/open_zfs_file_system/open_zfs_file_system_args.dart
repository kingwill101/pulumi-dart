...
class OpenZfsFileSystemArgs {
  ...
  factory OpenZfsFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return OpenZfsFileSystemArgs(
      ...
      copyTagsToVolumes:
          pulumi.Input.asOptionalInput<bool>(map['copyTagsToVolumes']),
      dailyAutomaticBackupStartTime: pulumi.Input.asOptionalInput<String>(
          map['dailyAutomaticBackupStartTime']),
      deleteOptions:
          pulumi.Input.asOptionalInput<List<String>>(map['deleteOptions']),
      ...
      readCacheConfiguration:
          pulumi.Input.asOptionalInput<OpenZfsFileSystemReadCacheConfiguration>(
