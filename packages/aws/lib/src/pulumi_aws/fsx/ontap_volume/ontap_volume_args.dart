  ...
  factory OntapVolumeArgs.fromMap(Map<String, dynamic> map) {
    return OntapVolumeArgs(
      ...
      finalBackupTags: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['finalBackupTags']),
      junctionPath: pulumi.Input.asOptionalInput<String>(map['junctionPath']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      ontapVolumeType:
          pulumi.Input.asOptionalInput<String>(map['ontapVolumeType']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      securityStyle: pulumi.Input.asOptionalInput<String>(map['securityStyle']),
      sizeInBytes: pulumi.Input.asOptionalInput<String>(map['sizeInBytes']),
      sizeInMegabytes:
          pulumi.Input.asOptionalInput<int>(map['sizeInMegabytes']),
      skipFinalBackup:
      ...
      snapshotPolicy:
          pulumi.Input.asOptionalInput<String>(map['snapshotPolicy']),
      storageEfficiencyEnabled:
          pulumi.Input.asOptionalInput<bool>(map['storageEfficiencyEnabled']),
      storageVirtualMachineId:
          pulumi.Input.asInput<String>(map['storageVirtualMachineId']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      tieringPolicy: pulumi.Input.asOptionalInput<OntapVolumeTieringPolicy>(
          map['tieringPolicy']),
      volumeStyle: pulumi.Input.asOptionalInput<String>(map['volumeStyle']),
