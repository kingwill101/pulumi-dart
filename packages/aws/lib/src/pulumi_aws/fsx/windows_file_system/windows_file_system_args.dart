...
class WindowsFileSystemArgs {
  ...
  factory WindowsFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return WindowsFileSystemArgs(
      activeDirectoryId:
          pulumi.Input.asOptionalInput<String>(map['activeDirectoryId']),
      aliases: pulumi.Input.asOptionalInput<List<String>>(map['aliases']),
      auditLogConfiguration:
          pulumi.Input.asOptionalInput<WindowsFileSystemAuditLogConfiguration>(
      ...
      copyTagsToBackups:
          pulumi.Input.asOptionalInput<bool>(map['copyTagsToBackups']),
      ...
      diskIopsConfiguration:
          pulumi.Input.asOptionalInput<WindowsFileSystemDiskIopsConfiguration>(
      ...
      preferredSubnetId:
          pulumi.Input.asOptionalInput<String>(map['preferredSubnetId']),
      ...
      skipFinalBackup:
          pulumi.Input.asOptionalInput<bool>(map['skipFinalBackup']),
      storageCapacity:
          pulumi.Input.asOptionalInput<int>(map['storageCapacity']),
