...
class OntapVolumeTieringPolicy {
  ...
  Map<String, dynamic> toMap() {
    ...
    final coolingPeriodValue = coolingPeriod;
    if (coolingPeriodValue != null) {
      map['coolingPeriod'] = coolingPeriodValue;
    }
  ...
  factory OntapVolumeTieringPolicy.fromMap(Map<String, dynamic> map) {
    return OntapVolumeTieringPolicy(
      coolingPeriod:
          map['coolingPeriod'] == null ? null : map['coolingPeriod'] as int,
