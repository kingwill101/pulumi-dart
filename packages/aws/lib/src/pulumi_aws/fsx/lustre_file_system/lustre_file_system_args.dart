...
class LustreFileSystemArgs {
  ...
  factory LustreFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return LustreFileSystemArgs(
      autoImportPolicy:
          pulumi.Input.asOptionalInput<String>(map['autoImportPolicy']),
      ...
      driveCacheType:
          pulumi.Input.asOptionalInput<String>(map['driveCacheType']),
      efaEnabled: pulumi.Input.asOptionalInput<bool>(map['efaEnabled']),
      exportPath: pulumi.Input.asOptionalInput<String>(map['exportPath']),
      fileSystemTypeVersion:
          pulumi.Input.asOptionalInput<String>(map['fileSystemTypeVersion']),
      finalBackupTags: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['finalBackupTags']),
      importPath: pulumi.Input.asOptionalInput<String>(map['importPath']),
      importedFileChunkSize:
          pulumi.Input.asOptionalInput<int>(map['importedFileChunkSize']),
      ...
      perUnitStorageThroughput:
          pulumi.Input.asOptionalInput<int>(map['perUnitStorageThroughput']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      rootSquashConfiguration:
          pulumi.Input.asOptionalInput<LustreFileSystemRootSquashConfiguration>(
      ...
      subnetIds: pulumi.Input.asInput<String>(map['subnetIds']),
