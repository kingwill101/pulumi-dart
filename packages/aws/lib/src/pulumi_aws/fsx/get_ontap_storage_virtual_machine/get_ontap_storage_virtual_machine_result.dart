...
import '../get_ontap_storage_virtual_machine_lifecycle_transition_reason/get_ontap_storage_virtual_machine_lifecycle_transition_reason.dart';
...
class GetOntapStorageVirtualMachineResult {
  ...
  final List<GetOntapStorageVirtualMachineActiveDirectoryConfiguration>
  ...
  final List<GetOntapStorageVirtualMachineLifecycleTransitionReason>
      lifecycleTransitionReasons;
  ...
  factory GetOntapStorageVirtualMachineResult.fromMap(
    ...
    return GetOntapStorageVirtualMachineResult(
      activeDirectoryConfigurations: pulumi.Input.decodeList<
          ...
          (value) =>
              GetOntapStorageVirtualMachineActiveDirectoryConfiguration.fromMap(
      ...
      lifecycleTransitionReasons: pulumi.Input.decodeList<
          ...
          (value) =>
              GetOntapStorageVirtualMachineLifecycleTransitionReason.fromMap(
                  (value as Map).cast<String, dynamic>())),
