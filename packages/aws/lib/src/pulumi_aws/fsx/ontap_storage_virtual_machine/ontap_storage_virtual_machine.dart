...
/// ## Import
///
/// Using `pulumi import`, import FSx Storage Virtual Machine using the <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:fsx/ontapStorageVirtualMachine:OntapStorageVirtualMachine example svm-12345678abcdef123
/// ```
///
/// Certain resource arguments, like <span pulumi-lang-nodejs="`svmAdminPassword`" pulumi-lang-dotnet="`SvmAdminPassword`" pulumi-lang-go="`svmAdminPassword`" pulumi-lang-python="`svm_admin_password`" pulumi-lang-yaml="`svmAdminPassword`" pulumi-lang-java="`svmAdminPassword`">`svm_admin_password`</span> and the <span pulumi-lang-nodejs="`selfManagedActiveDirectory`" pulumi-lang-dotnet="`SelfManagedActiveDirectory`" pulumi-lang-go="`selfManagedActiveDirectory`" pulumi-lang-python="`self_managed_active_directory`" pulumi-lang-yaml="`selfManagedActiveDirectory`" pulumi-lang-java="`selfManagedActiveDirectory`">`self_managed_active_directory`</span> configuation block <span pulumi-lang-nodejs="`password`" pulumi-lang-dotnet="`Password`" pulumi-lang-go="`password`" pulumi-lang-python="`password`" pulumi-lang-yaml="`password`" pulumi-lang-java="`password`">`password`</span>, do not have a FSx API method for reading the information after creation. If these arguments are set in the Pulumi program on an imported resource, Pulumi will always show a difference. To workaround this behavior, either omit the argument from the Pulumi program or use <span pulumi-lang-nodejs="`ignoreChanges`" pulumi-lang-dotnet="`IgnoreChanges`" pulumi-lang-go="`ignoreChanges`" pulumi-lang-python="`ignore_changes`" pulumi-lang-yaml="`ignoreChanges`" pulumi-lang-java="`ignoreChanges`">`ignore_changes`</span> to hide the difference. For example:
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
