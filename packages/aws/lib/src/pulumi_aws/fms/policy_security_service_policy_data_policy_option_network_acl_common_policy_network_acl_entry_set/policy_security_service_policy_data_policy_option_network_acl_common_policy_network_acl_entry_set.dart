...
class PolicySecurityServicePolicyDataPolicyOptionNetworkAclCommonPolicyNetworkAclEntrySet {
  /// The rules that you want to run first in the Firewall Manager managed network ACLs. Firewall manager creates entries with ID value between 1 and 5000. See the <span pulumi-lang-nodejs="`firstEntry`" pulumi-lang-dotnet="`FirstEntry`" pulumi-lang-go="`firstEntry`" pulumi-lang-python="`first_entry`" pulumi-lang-yaml="`firstEntry`" pulumi-lang-java="`firstEntry`">`first_entry`</span> block.
  final List<
  ...
  /// The rules that you want to run last in the Firewall Manager managed network ACLs. Firewall manager creates entries with ID value between 32000 and 32766. See the <span pulumi-lang-nodejs="`lastEntry`" pulumi-lang-dotnet="`LastEntry`" pulumi-lang-go="`lastEntry`" pulumi-lang-python="`last_entry`" pulumi-lang-yaml="`lastEntry`" pulumi-lang-java="`lastEntry`">`last_entry`</span> block.
  final List<
