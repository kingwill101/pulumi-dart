...
class ClusterElasticacheArgs {
  ...
  factory ClusterElasticacheArgs.fromMap(Map<String, dynamic> map) {
    return ClusterElasticacheArgs(
      applyImmediately:
          pulumi.Input.asOptionalInput<bool>(map['applyImmediately']),
      autoMinorVersionUpgrade:
          pulumi.Input.asOptionalInput<String>(map['autoMinorVersionUpgrade']),
      availabilityZone:
          pulumi.Input.asOptionalInput<String>(map['availabilityZone']),
      azMode: pulumi.Input.asOptionalInput<String>(map['azMode']),
      clusterId: pulumi.Input.asOptionalInput<String>(map['clusterId']),
      ...
      numCacheNodes: pulumi.Input.asOptionalInput<int>(map['numCacheNodes']),
      outpostMode: pulumi.Input.asOptionalInput<String>(map['outpostMode']),
      parameterGroupName:
      ...
      preferredOutpostArn:
          pulumi.Input.asOptionalInput<String>(map['preferredOutpostArn']),
      ...
      snapshotArns: pulumi.Input.asOptionalInput<String>(map['snapshotArns']),
