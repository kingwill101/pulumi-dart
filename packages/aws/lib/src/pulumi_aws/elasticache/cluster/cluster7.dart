...
/// <span pulumi-lang-nodejs="`aws.elasticache.ReplicationGroup`" pulumi-lang-dotnet="`aws.elasticache.ReplicationGroup`" pulumi-lang-go="`elasticache.ReplicationGroup`" pulumi-lang-python="`elasticache.ReplicationGroup`" pulumi-lang-yaml="`aws.elasticache.ReplicationGroup`" pulumi-lang-java="`aws.elasticache.ReplicationGroup`">`aws.elasticache.ReplicationGroup`</span> resource.
///
/// > **Note:** When you change an attribute, such as <span pulumi-lang-nodejs="`numCacheNodes`" pulumi-lang-dotnet="`NumCacheNodes`" pulumi-lang-go="`numCacheNodes`" pulumi-lang-python="`num_cache_nodes`" pulumi-lang-yaml="`numCacheNodes`" pulumi-lang-java="`numCacheNodes`">`num_cache_nodes`</span>, by default
/// it is applied in the next maintenance window. Because of this, this provider may report
/// a difference in its planning phase because the actual modification has not yet taken
/// place. You can use the <span pulumi-lang-nodejs="`applyImmediately`" pulumi-lang-dotnet="`ApplyImmediately`" pulumi-lang-go="`applyImmediately`" pulumi-lang-python="`apply_immediately`" pulumi-lang-yaml="`applyImmediately`" pulumi-lang-java="`applyImmediately`">`apply_immediately`</span> flag to instruct the service to apply the
/// change immediately. Using <span pulumi-lang-nodejs="`applyImmediately`" pulumi-lang-dotnet="`ApplyImmediately`" pulumi-lang-go="`applyImmediately`" pulumi-lang-python="`apply_immediately`" pulumi-lang-yaml="`applyImmediately`" pulumi-lang-java="`applyImmediately`">`apply_immediately`</span> can result in a brief downtime as the server reboots.
...
///
/// > **Note:** Any attribute changes that re-create the resource will be applied immediately, regardless of the value of <span pulumi-lang-nodejs="`applyImmediately`" pulumi-lang-dotnet="`ApplyImmediately`" pulumi-lang-go="`applyImmediately`" pulumi-lang-python="`apply_immediately`" pulumi-lang-yaml="`applyImmediately`" pulumi-lang-java="`applyImmediately`">`apply_immediately`</span>.
///
/// ## Example Usage
///
/// ### Memcached Cluster
...
/// ## Import
///
/// Using `pulumi import`, import ElastiCache Clusters using the <span pulumi-lang-nodejs="`clusterId`" pulumi-lang-dotnet="`ClusterId`" pulumi-lang-go="`clusterId`" pulumi-lang-python="`cluster_id`" pulumi-lang-yaml="`clusterId`" pulumi-lang-java="`clusterId`">`cluster_id`</span>. For example:
///
/// ```sh
...
class Cluster7 extends CustomResource {
  ...
  late final Output<String?> autoMinorVersionUpgrade;
  ...
  late final Output<String> ipDiscovery;
  ...
  late final Output<List<ClusterLogDeliveryConfiguration>?>
      logDeliveryConfigurations;
  ...
  late final Output<int> numCacheNodes;

  /// Specify the outpost mode that will apply to the cache cluster creation. Valid values are `"single-outpost"` and `"cross-outpost"`, however AWS currently only supports `"single-outpost"` mode.
  late final Output<String?> outpostMode;
  ...
  late final Output<List<String>?> preferredAvailabilityZones;

  /// The outpost ARN in which the cache cluster will be created.
  late final Output<String> preferredOutpostArn;

  /// Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
  late final Output<String> region;

  /// ID of the replication group to which this cluster should belong. If this parameter is specified, the cluster is added to the specified replication group as a read replica; otherwise, the cluster is a standalone primary that is not part of any replication group.
  late final Output<String> replicationGroupId;
  ...
  late final Output<String?> snapshotArns;
