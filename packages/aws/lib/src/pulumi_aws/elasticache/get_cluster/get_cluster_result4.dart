...
class GetClusterResult4 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['cacheNodes'] =
        Input.encodeList<GetClusterCacheNode, Map<String, dynamic>>(
  ...
  factory GetClusterResult4.fromMap(Map<String, dynamic> map) {
    return GetClusterResult4(
      ...
      cacheNodes: Input.decodeList<GetClusterCacheNode>(
          map['cacheNodes'],
      ...
      logDeliveryConfigurations:
          Input.decodeList<GetClusterLogDeliveryConfiguration>(
