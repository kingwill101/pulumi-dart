...
import '../get_cluster_cache_node/get_cluster_cache_node.dart';
import '../get_cluster_log_delivery_configuration/get_cluster_log_delivery_configuration.dart';

/// Result data returned by getCluster.
class GetClusterElasticacheResult {
  final String arn;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['cacheNodes'] =
        pulumi.Input.encodeList<GetClusterCacheNode, Map<String, dynamic>>(
            cacheNodes, (value) => value.toMap());
    map['clusterAddress'] = clusterAddress;
    map['clusterId'] = clusterId;
    map['configurationEndpoint'] = configurationEndpoint;
    map['engine'] = engine;
    map['engineVersion'] = engineVersion;
    map['id'] = id;
    map['ipDiscovery'] = ipDiscovery;
    map['logDeliveryConfigurations'] = pulumi.Input.encodeList<
            GetClusterLogDeliveryConfiguration, Map<String, dynamic>>(
        logDeliveryConfigurations, (value) => value.toMap());
    map['maintenanceWindow'] = maintenanceWindow;
    map['networkType'] = networkType;
    map['nodeType'] = nodeType;
    map['notificationTopicArn'] = notificationTopicArn;
    map['numCacheNodes'] = numCacheNodes;
    map['parameterGroupName'] = parameterGroupName;
    map['port'] = port;
    map['preferredOutpostArn'] = preferredOutpostArn;
    map['region'] = region;
  ...
  factory GetClusterElasticacheResult.fromMap(Map<String, dynamic> map) {
    return GetClusterElasticacheResult(
      arn: map['arn'] as String,
      availabilityZone: map['availabilityZone'] as String,
      cacheNodes: pulumi.Input.decodeList<GetClusterCacheNode>(
          map['cacheNodes'],
          (value) => GetClusterCacheNode.fromMap(
