...
/// see the <span pulumi-lang-nodejs="`aws.elasticache.Cluster`" pulumi-lang-dotnet="`aws.elasticache.Cluster`" pulumi-lang-go="`elasticache.Cluster`" pulumi-lang-python="`elasticache.Cluster`" pulumi-lang-yaml="`aws.elasticache.Cluster`" pulumi-lang-java="`aws.elasticache.Cluster`">`aws.elasticache.Cluster`</span> resource.
///
/// > **Note:** When you change an attribute, such as <span pulumi-lang-nodejs="`engineVersion`" pulumi-lang-dotnet="`EngineVersion`" pulumi-lang-go="`engineVersion`" pulumi-lang-python="`engine_version`" pulumi-lang-yaml="`engineVersion`" pulumi-lang-java="`engineVersion`">`engine_version`</span>, by
/// default the ElastiCache API applies it in the next maintenance window. Because
/// of this, this provider may report a difference in its planning phase because the
/// actual modification has not yet taken place. You can use the
/// <span pulumi-lang-nodejs="`applyImmediately`" pulumi-lang-dotnet="`ApplyImmediately`" pulumi-lang-go="`applyImmediately`" pulumi-lang-python="`apply_immediately`" pulumi-lang-yaml="`applyImmediately`" pulumi-lang-java="`applyImmediately`">`apply_immediately`</span> flag to instruct the service to apply the change
/// immediately. Using <span pulumi-lang-nodejs="`applyImmediately`" pulumi-lang-dotnet="`ApplyImmediately`" pulumi-lang-go="`applyImmediately`" pulumi-lang-python="`apply_immediately`" pulumi-lang-yaml="`applyImmediately`" pulumi-lang-java="`applyImmediately`">`apply_immediately`</span> can result in a brief downtime as
/// servers reboots.
...
///
/// > **Note:** Be aware of the terminology collision around "cluster" for <span pulumi-lang-nodejs="`aws.elasticache.ReplicationGroup`" pulumi-lang-dotnet="`aws.elasticache.ReplicationGroup`" pulumi-lang-go="`elasticache.ReplicationGroup`" pulumi-lang-python="`elasticache.ReplicationGroup`" pulumi-lang-yaml="`aws.elasticache.ReplicationGroup`" pulumi-lang-java="`aws.elasticache.ReplicationGroup`">`aws.elasticache.ReplicationGroup`</span>. For example, it is possible to create a ["Cluster Mode Disabled [Redis] Cluster"](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Clusters.Create.CON.Redis.html). With "Cluster Mode Enabled", the data will be stored in shards (called "node groups"). See [Redis Cluster Configuration](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/cluster-create-determine-requirements.html#redis-cluster-configuration) for a diagram of the differences. To enable cluster mode, use a parameter group that has cluster mode enabled. The default parameter groups provided by AWS end with ".cluster.on", for example `default.redis6.x.cluster.on`.
///
/// ## Example Usage
///
...
///
/// * Adjusting <span pulumi-lang-nodejs="`numCacheClusters`" pulumi-lang-dotnet="`NumCacheClusters`" pulumi-lang-go="`numCacheClusters`" pulumi-lang-python="`num_cache_clusters`" pulumi-lang-yaml="`numCacheClusters`" pulumi-lang-java="`numCacheClusters`">`num_cache_clusters`</span> directly. This will attempt to automatically add or remove replicas, but provides no granular control (e.g., preferred availability zone, cache cluster ID) for the added or removed replicas. This also currently expects cache cluster IDs in the form of `replication_group_id-00#`.
/// * Otherwise for fine grained control of the underlying cache clusters, they can be added or removed with the <span pulumi-lang-nodejs="`aws.elasticache.Cluster`" pulumi-lang-dotnet="`aws.elasticache.Cluster`" pulumi-lang-go="`elasticache.Cluster`" pulumi-lang-python="`elasticache.Cluster`" pulumi-lang-yaml="`aws.elasticache.Cluster`" pulumi-lang-java="`aws.elasticache.Cluster`">`aws.elasticache.Cluster`</span> resource and its <span pulumi-lang-nodejs="`replicationGroupId`" pulumi-lang-dotnet="`ReplicationGroupId`" pulumi-lang-go="`replicationGroupId`" pulumi-lang-python="`replication_group_id`" pulumi-lang-yaml="`replicationGroupId`" pulumi-lang-java="`replicationGroupId`">`replication_group_id`</span> attribute. In this situation, you will need to utilize [`ignoreChanges`](https://www.pulumi.com/docs/intro/concepts/programming-model/#ignorechanges) to prevent perpetual differences with the <span pulumi-lang-nodejs="`numberCacheCluster`" pulumi-lang-dotnet="`NumberCacheCluster`" pulumi-lang-go="`numberCacheCluster`" pulumi-lang-python="`number_cache_cluster`" pulumi-lang-yaml="`numberCacheCluster`" pulumi-lang-java="`numberCacheCluster`">`number_cache_cluster`</span> attribute.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// <!--End PulumiCodeChooser -->
///
/// > **Note:** We currently do not support passing a <span pulumi-lang-nodejs="`primaryClusterId`" pulumi-lang-dotnet="`PrimaryClusterId`" pulumi-lang-go="`primaryClusterId`" pulumi-lang-python="`primary_cluster_id`" pulumi-lang-yaml="`primaryClusterId`" pulumi-lang-java="`primaryClusterId`">`primary_cluster_id`</span> in order to create the Replication Group.
///
...
/// <!--End PulumiCodeChooser -->
///
/// > When adding a new <span pulumi-lang-nodejs="`authToken`" pulumi-lang-dotnet="`AuthToken`" pulumi-lang-go="`authToken`" pulumi-lang-python="`auth_token`" pulumi-lang-yaml="`authToken`" pulumi-lang-java="`authToken`">`auth_token`</span> to a previously passwordless replication group, using the `ROTATE` update strategy will result in support for **both** the new token and passwordless authentication. To immediately require authorization when adding the initial token, use the `SET` strategy instead. See the [Authenticating with the Redis AUTH command](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/auth.html) guide for additional details.
///
/// ## Import
///
/// Using `pulumi import`, import ElastiCache Replication Groups using the <span pulumi-lang-nodejs="`replicationGroupId`" pulumi-lang-dotnet="`ReplicationGroupId`" pulumi-lang-go="`replicationGroupId`" pulumi-lang-python="`replication_group_id`" pulumi-lang-yaml="`replicationGroupId`" pulumi-lang-java="`replicationGroupId`">`replication_group_id`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:elasticache/replicationGroup:ReplicationGroup my_replication_group replication-group-1
/// ```
class ReplicationGroup extends CustomResource {
  ...
  late final Output<String?> authToken;
  ...
  late final Output<String?> authTokenUpdateStrategy;
  ...
  late final Output<String> clusterMode;

  /// Address of the replication group configuration endpoint when cluster mode is enabled.
  late final Output<String> configurationEndpointAddress;
  ...
  late final Output<bool> dataTieringEnabled;
  ...
  late final Output<List<ReplicationGroupLogDeliveryConfiguration>?>
      logDeliveryConfigurations;
  ...
  late final Output<List<String>> memberClusters;
  ...
  late final Output<bool?> multiAzEnabled;
  ...
  late final Output<List<ReplicationGroupNodeGroupConfiguration>>
      nodeGroupConfigurations;
  ...
  late final Output<int> numCacheClusters;
  ...
  late final Output<int> replicasPerNodeGroup;
  ...
  late final Output<List<String>?> userGroupIds;
