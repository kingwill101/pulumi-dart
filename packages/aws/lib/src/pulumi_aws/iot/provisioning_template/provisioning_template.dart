...
/// ## Import
///
/// Using `pulumi import`, import IoT fleet provisioning templates using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
...
class ProvisioningTemplate extends CustomResource {
  ...
  ProvisioningTemplate(
    ...
    this.defaultVersionId = Output.createUnknown<int>();
    this.description = Output.createUnknown<String?>();
    this.enabled = Output.createUnknown<bool?>();
    this.name = Output.createUnknown<String>();
    this.preProvisioningHook =
        Output.createUnknown<ProvisioningTemplatePreProvisioningHook?>();
