...
class CaCertificate extends CustomResource {
  ...
  late final Output<bool> allowAutoRegistration;

  /// The ARN of the created CA certificate.
  late final Output<String> arn;

  /// PEM encoded CA certificate.
  late final Output<String> caCertificatePem;

  /// The certificate mode in which the CA will be registered. Valid values: `DEFAULT` and `SNI_ONLY`. Default: `DEFAULT`.
  late final Output<String?> certificateMode;

  /// The customer version of the CA certificate.
  late final Output<int> customerVersion;

  /// The generation ID of the CA certificate.
  late final Output<String> generationId;

  /// Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
  late final Output<String> region;

  /// Information about the registration configuration. See below.
  late final Output<CaCertificateRegistrationConfig?> registrationConfig;
  ...
  late final Output<List<CaCertificateValidity>> validities;
  ...
  late final Output<String?> verificationCertificatePem;
