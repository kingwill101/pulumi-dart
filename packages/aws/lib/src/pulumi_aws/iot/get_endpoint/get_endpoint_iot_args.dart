...
class GetEndpointIotArgs {
  ...
  factory GetEndpointIotArgs.fromMap(Map<String, dynamic> map) {
    return GetEndpointIotArgs(
      endpointType: pulumi.Input.asOptionalInput<String>(map['endpointType']),
