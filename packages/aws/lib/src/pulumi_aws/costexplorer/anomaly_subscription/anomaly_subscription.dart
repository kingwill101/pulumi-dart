...
/// <!--End PulumiCodeChooser -->
///
/// ### Using an <span pulumi-lang-nodejs="`and`" pulumi-lang-dotnet="`And`" pulumi-lang-go="`and`" pulumi-lang-python="`and`" pulumi-lang-yaml="`and`" pulumi-lang-java="`and`">`and`</span> Expression
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the Cost Explorer anomaly subscription.
///
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.costexplorer.AnomalySubscription`" pulumi-lang-dotnet="`aws.costexplorer.AnomalySubscription`" pulumi-lang-go="`costexplorer.AnomalySubscription`" pulumi-lang-python="`costexplorer.AnomalySubscription`" pulumi-lang-yaml="`aws.costexplorer.AnomalySubscription`" pulumi-lang-java="`aws.costexplorer.AnomalySubscription`">`aws.costexplorer.AnomalySubscription`</span> using the <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
