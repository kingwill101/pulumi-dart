...
class GetCostCategoryRuleRuleAndNotCostCategory {
  /// Key for the tag.
  final String key;
  ...
  factory GetCostCategoryRuleRuleAndNotCostCategory.fromMap(
      Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndNotCostCategory(
