...
class AnomalySubscriptionThresholdExpressionDimension {
  ...
  factory AnomalySubscriptionThresholdExpressionDimension.fromMap(
      Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionDimension(
