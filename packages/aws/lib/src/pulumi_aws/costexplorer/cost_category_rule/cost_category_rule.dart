...
import '../cost_category_rule_inherited_value/cost_category_rule_inherited_value.dart';
import '../cost_category_rule_rule/cost_category_rule_rule.dart';
...
class CostCategoryRule {
  ...
  Map<String, dynamic> toMap() {
    ...
    final inheritedValueValue = inheritedValue;
    if (inheritedValueValue != null) {
      map['inheritedValue'] = inheritedValueValue.toMap();
    }
