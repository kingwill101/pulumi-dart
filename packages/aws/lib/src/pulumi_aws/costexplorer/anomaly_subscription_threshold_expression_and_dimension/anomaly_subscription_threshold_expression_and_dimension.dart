...
class AnomalySubscriptionThresholdExpressionAndDimension {
  ...
  factory AnomalySubscriptionThresholdExpressionAndDimension.fromMap(
      Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionAndDimension(
