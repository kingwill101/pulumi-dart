...
class GetTableResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['magneticStoreWriteProperties'] = Input.encodeList<
    ...
    map['retentionProperties'] =
        Input.encodeList<GetTableRetentionProperty, Map<String, dynamic>>(
            retentionProperties, (value) => value.toMap());
    map['schemas'] = Input.encodeList<GetTableSchema, Map<String, dynamic>>(
        schemas, (value) => value.toMap());
    map['tableStatus'] = tableStatus;
    return map;
  }

  factory GetTableResult2.fromMap(Map<String, dynamic> map) {
    return GetTableResult2(
      ...
      magneticStoreWriteProperties:
          Input.decodeList<GetTableMagneticStoreWriteProperty>(
              map['magneticStoreWriteProperties'],
              (value) => GetTableMagneticStoreWriteProperty.fromMap(
                  (value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      region: map['region'] as String,
      retentionProperties: Input.decodeList<GetTableRetentionProperty>(
          map['retentionProperties'],
          (value) => GetTableRetentionProperty.fromMap(
              (value as Map).cast<String, dynamic>())),
      schemas: Input.decodeList<GetTableSchema>(
          map['schemas'],
          (value) =>
