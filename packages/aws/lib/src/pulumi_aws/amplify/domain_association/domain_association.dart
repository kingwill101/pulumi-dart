...
/// ## Import
///
/// Using `pulumi import`, import Amplify domain association using <span pulumi-lang-nodejs="`appId`" pulumi-lang-dotnet="`AppId`" pulumi-lang-go="`appId`" pulumi-lang-python="`app_id`" pulumi-lang-yaml="`appId`" pulumi-lang-java="`appId`">`app_id`</span> and <span pulumi-lang-nodejs="`domainName`" pulumi-lang-dotnet="`DomainName`" pulumi-lang-go="`domainName`" pulumi-lang-python="`domain_name`" pulumi-lang-yaml="`domainName`" pulumi-lang-java="`domainName`">`domain_name`</span>. For example:
///
/// ```sh
