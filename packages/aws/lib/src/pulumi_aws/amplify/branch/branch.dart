...
/// ### Notifications
///
/// Amplify Console uses EventBridge (formerly known as CloudWatch Events) and SNS for email notifications.  To implement the same functionality, you need to set <span pulumi-lang-nodejs="`enableNotification`" pulumi-lang-dotnet="`EnableNotification`" pulumi-lang-go="`enableNotification`" pulumi-lang-python="`enable_notification`" pulumi-lang-yaml="`enableNotification`" pulumi-lang-java="`enableNotification`">`enable_notification`</span> in a <span pulumi-lang-nodejs="`aws.amplify.Branch`" pulumi-lang-dotnet="`aws.amplify.Branch`" pulumi-lang-go="`amplify.Branch`" pulumi-lang-python="`amplify.Branch`" pulumi-lang-yaml="`aws.amplify.Branch`" pulumi-lang-java="`aws.amplify.Branch`">`aws.amplify.Branch`</span> resource, as well as creating an EventBridge Rule, an SNS topic, and SNS subscriptions.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import Amplify branch using <span pulumi-lang-nodejs="`appId`" pulumi-lang-dotnet="`AppId`" pulumi-lang-go="`appId`" pulumi-lang-python="`app_id`" pulumi-lang-yaml="`appId`" pulumi-lang-java="`appId`">`app_id`</span> and <span pulumi-lang-nodejs="`branchName`" pulumi-lang-dotnet="`BranchName`" pulumi-lang-go="`branchName`" pulumi-lang-python="`branch_name`" pulumi-lang-yaml="`branchName`" pulumi-lang-java="`branchName`">`branch_name`</span>. For example:
///
/// ```sh
