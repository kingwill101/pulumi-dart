...
/// ## Import
///
/// Using `pulumi import`, import Amplify backend environment using <span pulumi-lang-nodejs="`appId`" pulumi-lang-dotnet="`AppId`" pulumi-lang-go="`appId`" pulumi-lang-python="`app_id`" pulumi-lang-yaml="`appId`" pulumi-lang-java="`appId`">`app_id`</span> and <span pulumi-lang-nodejs="`environmentName`" pulumi-lang-dotnet="`EnvironmentName`" pulumi-lang-go="`environmentName`" pulumi-lang-python="`environment_name`" pulumi-lang-yaml="`environmentName`" pulumi-lang-java="`environmentName`">`environment_name`</span>. For example:
///
/// ```sh
