...
import 'resource_policy_dynamodb_args.dart';
...
/// ```
class ResourcePolicyDynamodb extends pulumi.CustomResource {
  ...
  ResourcePolicyDynamodb(
    String name, {
    ResourcePolicyDynamodbArgs? args,
