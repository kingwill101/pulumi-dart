...
/// ## Import
///
/// Using `pulumi import`, import DynamoDB Kinesis Streaming Destinations using the <span pulumi-lang-nodejs="`tableName`" pulumi-lang-dotnet="`TableName`" pulumi-lang-go="`tableName`" pulumi-lang-python="`table_name`" pulumi-lang-yaml="`tableName`" pulumi-lang-java="`tableName`">`table_name`</span> and <span pulumi-lang-nodejs="`streamArn`" pulumi-lang-dotnet="`StreamArn`" pulumi-lang-go="`streamArn`" pulumi-lang-python="`stream_arn`" pulumi-lang-yaml="`streamArn`" pulumi-lang-java="`streamArn`">`stream_arn`</span> separated by `,`. For example:
///
/// ```sh
