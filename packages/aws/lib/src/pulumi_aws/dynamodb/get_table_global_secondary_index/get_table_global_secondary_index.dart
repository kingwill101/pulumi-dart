...
class GetTableGlobalSecondaryIndex {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['hashKey'] = hashKey;
    map['keySchemas'] = Input.encodeList<GetTableGlobalSecondaryIndexKeySchema,
        Map<String, dynamic>>(keySchemas, (value) => value.toMap());
    map['name'] = name;
    map['nonKeyAttributes'] = nonKeyAttributes;
    map['onDemandThroughputs'] = Input.encodeList<
    ...
    map['warmThroughputs'] = Input.encodeList<
  ...
  factory GetTableGlobalSecondaryIndex.fromMap(Map<String, dynamic> map) {
    return GetTableGlobalSecondaryIndex(
      ...
      keySchemas: Input.decodeList<GetTableGlobalSecondaryIndexKeySchema>(
          map['keySchemas'],
      ...
      warmThroughputs:
          Input.decodeList<GetTableGlobalSecondaryIndexWarmThroughput>(
              map['warmThroughputs'],
