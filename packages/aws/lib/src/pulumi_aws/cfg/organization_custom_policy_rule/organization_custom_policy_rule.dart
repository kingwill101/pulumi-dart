...
/// ## Import
///
/// Using `pulumi import`, import a Config Organization Custom Policy Rule using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span> argument. For example:
///
/// ```sh
/// $ pulumi import aws:cfg/organizationCustomPolicyRule:OrganizationCustomPolicyRule example example_rule_name
/// ```
class OrganizationCustomPolicyRule extends CustomResource {
  ...
  late final Output<List<String>?> debugLogDeliveryAccounts;
  ...
  late final Output<String> policyRuntime;

  /// Policy definition containing the rule logic.
  late final Output<String> policyText;
