...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the CodeStar notification rule.
///
///
...
/// ```
class NotificationRule extends CustomResource {
  /// The codestar notification rule ARN.
  late final Output<String> arn;

  /// The level of detail to include in the notifications for this resource. Possible values are `BASIC` and `FULL`.
  late final Output<String> detailType;

  /// A list of event types associated with this notification rule.
  /// For list of allowed events see [here](https://docs.aws.amazon.com/codestar-notifications/latest/userguide/concepts.html#concepts-api).
  late final Output<List<String>> eventTypeIds;
  ...
  late final Output<List<NotificationRuleTarget>?> targets;
