...
class NotificationRuleArgs {
  ...
  final Input<String> detailType;

  /// A list of event types associated with this notification rule.
  /// For list of allowed events see [here](https://docs.aws.amazon.com/codestar-notifications/latest/userguide/concepts.html#concepts-api).
  final Input<List<String>> eventTypeIds;
  ...
  final Input<List<NotificationRuleTarget>>? targets;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (targetsValue != null) {
      map['targets'] = Input.mapOptionalInputValue<List<NotificationRuleTarget>,
              List<Map<String, dynamic>>>(
          targetsValue,
          (value) =>
              Input.encodeList<NotificationRuleTarget, Map<String, dynamic>>(
  ...
  factory NotificationRuleArgs.fromMap(Map<String, dynamic> map) {
    return NotificationRuleArgs(
      detailType: Input.asInput<String>(map['detailType']),
      eventTypeIds: Input.asInput<List<String>>(map['eventTypeIds']),
      ...
      targets:
          Input.asOptionalInput<List<NotificationRuleTarget>>(map['targets']),
    );
  }
}
