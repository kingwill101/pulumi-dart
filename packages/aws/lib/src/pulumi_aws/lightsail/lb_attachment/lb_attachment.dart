...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.lightsail.LbAttachment`" pulumi-lang-dotnet="`aws.lightsail.LbAttachment`" pulumi-lang-go="`lightsail.LbAttachment`" pulumi-lang-python="`lightsail.LbAttachment`" pulumi-lang-yaml="`aws.lightsail.LbAttachment`" pulumi-lang-java="`aws.lightsail.LbAttachment`">`aws.lightsail.LbAttachment`</span> using the name attribute. For example:
///
/// ```sh
