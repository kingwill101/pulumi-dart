...
class DistributionOriginLightsail {
  ...
  factory DistributionOriginLightsail.fromMap(Map<String, dynamic> map) {
    return DistributionOriginLightsail(
