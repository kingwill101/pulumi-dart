...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.lightsail.Disk_attachment`" pulumi-lang-dotnet="`aws.lightsail.Disk_attachment`" pulumi-lang-go="`lightsail.Disk_attachment`" pulumi-lang-python="`lightsail.Disk_attachment`" pulumi-lang-yaml="`aws.lightsail.Disk_attachment`" pulumi-lang-java="`aws.lightsail.Disk_attachment`">`aws.lightsail.Disk_attachment`</span> using the id attribute. For example:
///
/// ```sh
