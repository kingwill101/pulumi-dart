...
class DatabaseLightsailArgs {
  ...
  factory DatabaseLightsailArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseLightsailArgs(
      applyImmediately:
          pulumi.Input.asOptionalInput<bool>(map['applyImmediately']),
      availabilityZone:
          pulumi.Input.asOptionalInput<String>(map['availabilityZone']),
      backupRetentionEnabled:
          pulumi.Input.asOptionalInput<bool>(map['backupRetentionEnabled']),
      ...
      masterDatabaseName:
          pulumi.Input.asInput<String>(map['masterDatabaseName']),
      masterPassword: pulumi.Input.asInput<String>(map['masterPassword']),
      masterUsername: pulumi.Input.asInput<String>(map['masterUsername']),
      ...
      relationalDatabaseName:
          pulumi.Input.asInput<String>(map['relationalDatabaseName']),
      skipFinalSnapshot:
