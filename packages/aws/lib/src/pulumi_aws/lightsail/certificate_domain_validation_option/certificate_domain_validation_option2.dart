...
class CertificateDomainValidationOption2 {
  ...
  CertificateDomainValidationOption2({
    this.domainName,
  ...
  factory CertificateDomainValidationOption2.fromMap(Map<String, dynamic> map) {
    return CertificateDomainValidationOption2(
      domainName:
