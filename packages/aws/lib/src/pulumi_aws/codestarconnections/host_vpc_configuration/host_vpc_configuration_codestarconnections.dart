...
class HostVpcConfigurationCodestarconnections {
  ...
  HostVpcConfigurationCodestarconnections({
  ...
  factory HostVpcConfigurationCodestarconnections.fromMap(
      Map<String, dynamic> map) {
    return HostVpcConfigurationCodestarconnections(
