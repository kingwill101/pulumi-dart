...
class ConnectionCodestarconnectionsArgs {
  ...
  ConnectionCodestarconnectionsArgs({
    this.hostArn,
    this.name,
    this.providerType,
    this.region,
  ...
  factory ConnectionCodestarconnectionsArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionCodestarconnectionsArgs(
