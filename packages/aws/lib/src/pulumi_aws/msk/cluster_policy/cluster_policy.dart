...
/// ## Import
///
/// Using `pulumi import`, import Managed Streaming for Kafka Cluster Policy using the <span pulumi-lang-nodejs="`clusterArn`" pulumi-lang-dotnet="`ClusterArn`" pulumi-lang-go="`clusterArn`" pulumi-lang-python="`cluster_arn`" pulumi-lang-yaml="`clusterArn`" pulumi-lang-java="`clusterArn`">`cluster_arn`</span>. For example:
///
/// ```sh
