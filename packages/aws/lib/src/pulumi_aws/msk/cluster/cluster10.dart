...
///
/// > **Note:** This resource manages _provisioned_ clusters. To manage a _serverless_ Amazon MSK cluster, use the <span pulumi-lang-nodejs="`aws.msk.ServerlessCluster`" pulumi-lang-dotnet="`aws.msk.ServerlessCluster`" pulumi-lang-go="`msk.ServerlessCluster`" pulumi-lang-python="`msk.ServerlessCluster`" pulumi-lang-yaml="`aws.msk.ServerlessCluster`" pulumi-lang-java="`aws.msk.ServerlessCluster`">`aws.msk.ServerlessCluster`</span> resource.
///
/// ## Example Usage
///
/// ### Basic
...
///
/// ### With<span pulumi-lang-nodejs=" volumeThroughput " pulumi-lang-dotnet=" VolumeThroughput " pulumi-lang-go=" volumeThroughput " pulumi-lang-python=" volume_throughput " pulumi-lang-yaml=" volumeThroughput " pulumi-lang-java=" volumeThroughput "> volume_throughput </span>argument
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import MSK clusters using the cluster <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
...
class Cluster10 extends CustomResource {
  ...
  /// One or more DNS names (or IP addresses) and SASL IAM port pairs. For example, `b-1.exampleClusterName.abcde.c2.kafka.us-east-1.amazonaws.com:9098,b-2.exampleClusterName.abcde.c2.kafka.us-east-1.amazonaws.com:9098,b-3.exampleClusterName.abcde.c2.kafka.us-east-1.amazonaws.com:9098`. This attribute will have a value if `encryption_info.0.encryption_in_transit.0.client_broker` is set to `TLS_PLAINTEXT` or `TLS` and `client_authentication.0.sasl.0.iam` is set to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>. The resource sorts the list alphabetically. AWS may not always return all endpoints so the values may not be stable across applies.
  late final Output<String> bootstrapBrokersSaslIam;

  /// One or more DNS names (or IP addresses) and SASL SCRAM port pairs. For example, `b-1.exampleClusterName.abcde.c2.kafka.us-east-1.amazonaws.com:9096,b-2.exampleClusterName.abcde.c2.kafka.us-east-1.amazonaws.com:9096,b-3.exampleClusterName.abcde.c2.kafka.us-east-1.amazonaws.com:9096`. This attribute will have a value if `encryption_info.0.encryption_in_transit.0.client_broker` is set to `TLS_PLAINTEXT` or `TLS` and `client_authentication.0.sasl.0.scram` is set to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>. The resource sorts the list alphabetically. AWS may not always return all endpoints so the values may not be stable across applies.
