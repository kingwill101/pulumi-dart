...
import '../replicator_replication_info_list_topic_replication_starting_position/replicator_replication_info_list_topic_replication_starting_position.dart';
import '../replicator_replication_info_list_topic_replication_topic_name_configuration/replicator_replication_info_list_topic_replication_topic_name_configuration.dart';
...
class ReplicatorReplicationInfoListTopicReplication {
  ...
  Map<String, dynamic> toMap() {
    ...
    final copyAccessControlListsForTopicsValue =
        copyAccessControlListsForTopics;
    if (copyAccessControlListsForTopicsValue != null) {
      map['copyAccessControlListsForTopics'] =
          copyAccessControlListsForTopicsValue;
    }
    final copyTopicConfigurationsValue = copyTopicConfigurations;
    if (copyTopicConfigurationsValue != null) {
      map['copyTopicConfigurations'] = copyTopicConfigurationsValue;
    }
    final detectAndCopyNewTopicsValue = detectAndCopyNewTopics;
    if (detectAndCopyNewTopicsValue != null) {
      map['detectAndCopyNewTopics'] = detectAndCopyNewTopicsValue;
    }
    final startingPositionValue = startingPosition;
    if (startingPositionValue != null) {
      map['startingPosition'] = startingPositionValue.toMap();
    }
    final topicNameConfigurationValue = topicNameConfiguration;
    if (topicNameConfigurationValue != null) {
      map['topicNameConfiguration'] = topicNameConfigurationValue.toMap();
    }
    final topicsToExcludesValue = topicsToExcludes;
    if (topicsToExcludesValue != null) {
      map['topicsToExcludes'] = topicsToExcludesValue;
    }
    map['topicsToReplicates'] = topicsToReplicates;
    return map;
  }
    ...
    return ReplicatorReplicationInfoListTopicReplication(
      ...
      topicNameConfiguration: map['topicNameConfiguration'] == null
          ...
          : ReplicatorReplicationInfoListTopicReplicationTopicNameConfiguration
              .fromMap((map['topicNameConfiguration'] as Map)
                  .cast<String, dynamic>()),
