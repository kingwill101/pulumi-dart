...
import '../get_cluster_broker_node_group_info/get_cluster_broker_node_group_info.dart';

/// Result data returned by getCluster.
class GetClusterMskResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['brokerNodeGroupInfos'] = pulumi.Input.encodeList<
        GetClusterBrokerNodeGroupInfo,
        Map<String, dynamic>>(brokerNodeGroupInfos, (value) => value.toMap());
    ...
    map['region'] = region;
    map['tags'] = tags;
    map['zookeeperConnectString'] = zookeeperConnectString;
    map['zookeeperConnectStringTls'] = zookeeperConnectStringTls;
    return map;
  }

  factory GetClusterMskResult.fromMap(Map<String, dynamic> map) {
    return GetClusterMskResult(
      ...
      brokerNodeGroupInfos:
          pulumi.Input.decodeList<GetClusterBrokerNodeGroupInfo>(
              map['brokerNodeGroupInfos'],
              (value) => GetClusterBrokerNodeGroupInfo.fromMap(
