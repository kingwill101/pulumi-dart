...
class BucketLoggingV2Args {
  ...
  final Input<List<BucketLoggingV2TargetGrant>>? targetGrants;

  /// Amazon S3 key format for log objects. See below.
  final Input<BucketLoggingV2TargetObjectKeyFormat>? targetObjectKeyFormat;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (targetGrantsValue != null) {
      map['targetGrants'] = Input.mapOptionalInputValue<
          ...
          targetGrantsValue,
          (value) => Input.encodeList<BucketLoggingV2TargetGrant,
  ...
  factory BucketLoggingV2Args.fromMap(Map<String, dynamic> map) {
    return BucketLoggingV2Args(
      ...
      targetGrants: Input.asOptionalInput<List<BucketLoggingV2TargetGrant>>(
          map['targetGrants']),
      targetObjectKeyFormat:
          Input.asOptionalInput<BucketLoggingV2TargetObjectKeyFormat>(
