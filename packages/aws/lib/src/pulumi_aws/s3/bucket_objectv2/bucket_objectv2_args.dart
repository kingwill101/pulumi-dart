...
class BucketObjectv2Args {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (overrideProviderValue != null) {
      map['overrideProvider'] = pulumi.Input.mapOptionalInputValue<
              BucketObjectv2OverrideProvider, Map<String, dynamic>>(
  ...
  factory BucketObjectv2Args.fromMap(Map<String, dynamic> map) {
    return BucketObjectv2Args(
      ...
      contentBase64: pulumi.Input.asOptionalInput<String>(map['contentBase64']),
      contentDisposition:
      ...
      overrideProvider:
          pulumi.Input.asOptionalInput<BucketObjectv2OverrideProvider>(
      ...
      sourceHash: pulumi.Input.asOptionalInput<String>(map['sourceHash']),
