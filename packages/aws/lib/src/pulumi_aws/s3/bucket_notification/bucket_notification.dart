...
///
/// > **NOTE:** S3 Buckets only support a single notification configuration resource. Declaring multiple <span pulumi-lang-nodejs="`aws.s3.BucketNotification`" pulumi-lang-dotnet="`aws.s3.BucketNotification`" pulumi-lang-go="`s3.BucketNotification`" pulumi-lang-python="`s3.BucketNotification`" pulumi-lang-yaml="`aws.s3.BucketNotification`" pulumi-lang-java="`aws.s3.BucketNotification`">`aws.s3.BucketNotification`</span> resources to the same S3 Bucket will cause a perpetual difference in configuration. This resource will overwrite any existing event notifications configured for the S3 bucket it's associated with. See the example "Trigger multiple Lambda functions" for an option of how to configure multiple triggers within this resource.
///
...
/// <!--End PulumiCodeChooser -->
///
/// For JSON syntax, use an array instead of defining the <span pulumi-lang-nodejs="`queue`" pulumi-lang-dotnet="`Queue`" pulumi-lang-go="`queue`" pulumi-lang-python="`queue`" pulumi-lang-yaml="`queue`" pulumi-lang-java="`queue`">`queue`</span> key twice.
///
/// ```json
/// {
...
/// ## Import
///
/// Using `pulumi import`, import S3 bucket notification using the <span pulumi-lang-nodejs="`bucket`" pulumi-lang-dotnet="`Bucket`" pulumi-lang-go="`bucket`" pulumi-lang-python="`bucket`" pulumi-lang-yaml="`bucket`" pulumi-lang-java="`bucket`">`bucket`</span>. For example:
///
/// ```sh
