...
/// ```
class BucketV2 extends CustomResource {
  ...
  late final Output<List<BucketV2CorsRule>> corsRules;
  ...
  late final Output<List<BucketV2Grant>> grants;
  ...
  late final Output<List<BucketV2LifecycleRule>> lifecycleRules;
  ...
  late final Output<List<BucketV2Logging>> loggings;
  ...
  late final Output<BucketV2ObjectLockConfiguration> objectLockConfiguration;
  ...
  late final Output<List<BucketV2ReplicationConfiguration>>
  ...
  late final Output<List<BucketV2ServerSideEncryptionConfiguration>>
  ...
  late final Output<List<BucketV2Versioning>> versionings;
  ...
  late final Output<List<BucketV2Website>> websites;
