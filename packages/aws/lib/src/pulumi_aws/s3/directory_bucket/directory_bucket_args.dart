...
class DirectoryBucketArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['location'] = pulumi.Input.mapInputValue<DirectoryBucketLocation,
  ...
  factory DirectoryBucketArgs.fromMap(Map<String, dynamic> map) {
    return DirectoryBucketArgs(
      ...
      dataRedundancy:
          pulumi.Input.asOptionalInput<String>(map['dataRedundancy']),
      forceDestroy: pulumi.Input.asOptionalInput<bool>(map['forceDestroy']),
      location: pulumi.Input.asInput<DirectoryBucketLocation>(map['location']),
