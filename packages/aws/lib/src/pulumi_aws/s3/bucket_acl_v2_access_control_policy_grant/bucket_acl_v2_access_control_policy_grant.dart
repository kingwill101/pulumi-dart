...
import '../bucket_acl_v2_access_control_policy_grant_grantee/bucket_acl_v2_access_control_policy_grant_grantee.dart';

class BucketAclV2AccessControlPolicyGrant {
  /// Configuration block for the person being granted permissions. See below.
  final BucketAclV2AccessControlPolicyGrantGrantee? grantee;
  ...
  factory BucketAclV2AccessControlPolicyGrant.fromMap(
      Map<String, dynamic> map) {
    return BucketAclV2AccessControlPolicyGrant(
      grantee: map['grantee'] == null
          ? null
          : BucketAclV2AccessControlPolicyGrantGrantee.fromMap(
