...
class BucketLifecycleConfigurationRuleTransition {
  ...
  factory BucketLifecycleConfigurationRuleTransition.fromMap(
      Map<String, dynamic> map) {
    return BucketLifecycleConfigurationRuleTransition(
