...
class RecommendationPreferencesPreferredResource {
  ...
  Map<String, dynamic> toMap() {
    ...
    final excludeListsValue = excludeLists;
    if (excludeListsValue != null) {
      map['excludeLists'] = excludeListsValue;
    }
    final includeListsValue = includeLists;
    if (includeListsValue != null) {
      map['includeLists'] = includeListsValue;
    }
    map['name'] = name;
    return map;
  }

  factory RecommendationPreferencesPreferredResource.fromMap(
      Map<String, dynamic> map) {
    return RecommendationPreferencesPreferredResource(
      excludeLists: map['excludeLists'] == null
          ? null
          : (map['excludeLists'] as List).cast<String>(),
      includeLists: map['includeLists'] == null
          ? null
          : (map['includeLists'] as List).cast<String>(),
