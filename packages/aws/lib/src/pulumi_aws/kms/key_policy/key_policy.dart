...
/// ## Import
///
/// Using `pulumi import`, import KMS Key Policies using the <span pulumi-lang-nodejs="`keyId`" pulumi-lang-dotnet="`KeyId`" pulumi-lang-go="`keyId`" pulumi-lang-python="`key_id`" pulumi-lang-yaml="`keyId`" pulumi-lang-java="`keyId`">`key_id`</span>. For example:
///
/// ```sh
