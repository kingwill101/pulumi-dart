...
class KeyArgs {
  ...
  final Input<String>? customerMasterKeySpec;
  ...
  final Input<bool>? enableKeyRotation;
  ...
  final Input<int>? rotationPeriodInDays;
  ...
  factory KeyArgs.fromMap(Map<String, dynamic> map) {
    return KeyArgs(
      ...
      customerMasterKeySpec:
          Input.asOptionalInput<String>(map['customerMasterKeySpec']),
      deletionWindowInDays:
          Input.asOptionalInput<int>(map['deletionWindowInDays']),
      description: Input.asOptionalInput<String>(map['description']),
      enableKeyRotation: Input.asOptionalInput<bool>(map['enableKeyRotation']),
      ...
      rotationPeriodInDays:
          Input.asOptionalInput<int>(map['rotationPeriodInDays']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      xksKeyId: Input.asOptionalInput<String>(map['xksKeyId']),
    );
  }
}
