...
import 'application_kinesisanalyticsv2_args.dart';
...
/// ```
class ApplicationKinesisanalyticsv2 extends pulumi.CustomResource {
  ...
  ApplicationKinesisanalyticsv2(
    String name, {
    ApplicationKinesisanalyticsv2Args? args,
