...
///
/// > **Note:** Kinesis Data Analytics for SQL applications created using this resource cannot currently be viewed in the AWS Console. To manage Kinesis Data Analytics for SQL applications that can also be viewed in the AWS Console, use the <span pulumi-lang-nodejs="`aws.kinesis.AnalyticsApplication`" pulumi-lang-dotnet="`aws.kinesis.AnalyticsApplication`" pulumi-lang-go="`kinesis.AnalyticsApplication`" pulumi-lang-python="`kinesis.AnalyticsApplication`" pulumi-lang-yaml="`aws.kinesis.AnalyticsApplication`" pulumi-lang-java="`aws.kinesis.AnalyticsApplication`">`aws.kinesis.AnalyticsApplication`</span> resource.
///
/// ## Example Usage
///
...
class Application6 extends CustomResource {
  ...
  /// A map of tags to assign to the application. If configured with a provider <span pulumi-lang-nodejs="`defaultTags`" pulumi-lang-dotnet="`DefaultTags`" pulumi-lang-go="`defaultTags`" pulumi-lang-python="`default_tags`" pulumi-lang-yaml="`defaultTags`" pulumi-lang-java="`defaultTags`">`default_tags`</span> configuration block present, tags with matching keys will overwrite those defined at the provider-level
  late final Output<Map<String, String>?> tags;

  /// A map of tags assigned to the resource, including those inherited from the provider <span pulumi-lang-nodejs="`defaultTags`" pulumi-lang-dotnet="`DefaultTags`" pulumi-lang-go="`defaultTags`" pulumi-lang-python="`default_tags`" pulumi-lang-yaml="`defaultTags`" pulumi-lang-java="`defaultTags`">`default_tags`</span> configuration block.
  late final Output<Map<String, String>> tagsAll;

  /// The current application version. Kinesis Data Analytics updates the <span pulumi-lang-nodejs="`versionId`" pulumi-lang-dotnet="`VersionId`" pulumi-lang-go="`versionId`" pulumi-lang-python="`version_id`" pulumi-lang-yaml="`versionId`" pulumi-lang-java="`versionId`">`version_id`</span> each time the application is updated.
