...
class ApplicationKinesisanalyticsv2Args {
  ...
  ApplicationKinesisanalyticsv2Args({
  ...
  factory ApplicationKinesisanalyticsv2Args.fromMap(Map<String, dynamic> map) {
    return ApplicationKinesisanalyticsv2Args(
      applicationConfiguration:
          pulumi.Input.asOptionalInput<ApplicationApplicationConfiguration>(
              map['applicationConfiguration']),
      applicationMode:
          pulumi.Input.asOptionalInput<String>(map['applicationMode']),
      cloudwatchLoggingOptions:
      ...
      runtimeEnvironment:
          pulumi.Input.asInput<String>(map['runtimeEnvironment']),
      serviceExecutionRole:
          pulumi.Input.asInput<String>(map['serviceExecutionRole']),
      startApplication:
