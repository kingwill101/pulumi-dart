...
import '../data_source_custom_document_enrichment_configuration_inline_configuration_target_target_document_attribute_value/data_source_custom_document_enrichment_configuration_inline_configuration_target_target_document_attribute_value.dart';
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget {
  ...
  Map<String, dynamic> toMap() {
    ...
    final targetDocumentAttributeKeyValue = targetDocumentAttributeKey;
    if (targetDocumentAttributeKeyValue != null) {
      map['targetDocumentAttributeKey'] = targetDocumentAttributeKeyValue;
    }
    final targetDocumentAttributeValueValue = targetDocumentAttributeValue;
    if (targetDocumentAttributeValueValue != null) {
      map['targetDocumentAttributeValue'] =
          targetDocumentAttributeValueValue.toMap();
    }
    final targetDocumentAttributeValueDeletionValue =
        targetDocumentAttributeValueDeletion;
    if (targetDocumentAttributeValueDeletionValue != null) {
      map['targetDocumentAttributeValueDeletion'] =
          targetDocumentAttributeValueDeletionValue;
    }
    return map;
  }
    ...
    return DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget(
      ...
      targetDocumentAttributeValue: map['targetDocumentAttributeValue'] == null
          ...
          : DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue
              .fromMap((map['targetDocumentAttributeValue'] as Map)
                  .cast<String, dynamic>()),
      targetDocumentAttributeValueDeletion:
