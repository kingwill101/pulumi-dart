...
/// ```
class Experience extends CustomResource {
  ...
  late final Output<ExperienceConfiguration> configuration;

  /// A description for your Amazon Kendra experience.
  late final Output<String?> description;

  /// Shows the endpoint URLs for your Amazon Kendra experiences. The URLs are unique and fully hosted by AWS.
  late final Output<List<ExperienceEndpoint>> endpoints;

  /// The unique identifier of the experience.
  late final Output<String> experienceId;
  ...
  Experience(
    ...
    this.configuration = Output.createUnknown<ExperienceConfiguration>();
    this.description = Output.createUnknown<String?>();
    this.endpoints = Output.createUnknown<List<ExperienceEndpoint>>();
    this.experienceId = Output.createUnknown<String>();
