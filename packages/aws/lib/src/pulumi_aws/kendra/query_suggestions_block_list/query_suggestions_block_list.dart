...
/// Use the <span pulumi-lang-nodejs="`awsKendraIndexBlockList`" pulumi-lang-dotnet="`AwsKendraIndexBlockList`" pulumi-lang-go="`awsKendraIndexBlockList`" pulumi-lang-python="`aws_kendra_index_block_list`" pulumi-lang-yaml="`awsKendraIndexBlockList`" pulumi-lang-java="`awsKendraIndexBlockList`">`aws_kendra_index_block_list`</span> resource to manage an AWS Kendra block list used for query suggestions for an index.
///
/// ## Example Usage
///
/// ### Basic Usage
...
/// ## Import
///
/// Using `pulumi import`, import the <span pulumi-lang-nodejs="`aws.kendra.QuerySuggestionsBlockList`" pulumi-lang-dotnet="`aws.kendra.QuerySuggestionsBlockList`" pulumi-lang-go="`kendra.QuerySuggestionsBlockList`" pulumi-lang-python="`kendra.QuerySuggestionsBlockList`" pulumi-lang-yaml="`aws.kendra.QuerySuggestionsBlockList`" pulumi-lang-java="`aws.kendra.QuerySuggestionsBlockList`">`aws.kendra.QuerySuggestionsBlockList`</span> resource using the unique identifiers of the block list and index separated by a slash (`/`). For example:
///
/// ```sh
...
class QuerySuggestionsBlockList extends CustomResource {
  ...
  /// Map of tags assigned to the resource, including those inherited from the provider's<span pulumi-lang-nodejs=" defaultTags " pulumi-lang-dotnet=" DefaultTags " pulumi-lang-go=" defaultTags " pulumi-lang-python=" default_tags " pulumi-lang-yaml=" defaultTags " pulumi-lang-java=" defaultTags "> default_tags </span>configuration block.
  ...
  QuerySuggestionsBlockList(
    ...
    this.querySuggestionsBlockListId = Output.createUnknown<String>();
    this.region = Output.createUnknown<String>();
    this.roleArn = Output.createUnknown<String>();
    this.sourceS3Path =
        Output.createUnknown<QuerySuggestionsBlockListSourceS3Path>();
