...
class DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfigurationBasicAuthentication {
  ...
  /// The port number of the website host you want to connect to using authentication credentials. For example, the port for `https://a.example.com/page1.html` is <span pulumi-lang-nodejs="`443`" pulumi-lang-dotnet="`443`" pulumi-lang-go="`443`" pulumi-lang-python="`443`" pulumi-lang-yaml="`443`" pulumi-lang-java="`443`">`443`</span>, the standard port for HTTPS.
  final int port;
