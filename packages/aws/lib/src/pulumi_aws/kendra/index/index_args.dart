...
class IndexArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (capacityUnitsValue != null) {
      map['capacityUnits'] = pulumi.Input.mapOptionalInputValue<
          IndexCapacityUnits,
          Map<String, dynamic>>(capacityUnitsValue, (value) => value.toMap());
    }
    ...
    if (userTokenConfigurationsValue != null) {
      map['userTokenConfigurations'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory IndexArgs.fromMap(Map<String, dynamic> map) {
    return IndexArgs(
      ...
      documentMetadataConfigurationUpdates: pulumi.Input.asOptionalInput<
              List<IndexDocumentMetadataConfigurationUpdate>>(
          map['documentMetadataConfigurationUpdates']),
      ...
      userContextPolicy:
          pulumi.Input.asOptionalInput<String>(map['userContextPolicy']),
      userGroupResolutionConfiguration:
