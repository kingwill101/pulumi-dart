...
class Index extends CustomResource {
  ...
  late final Output<IndexCapacityUnits> capacityUnits;
  ...
  late final Output<List<IndexDocumentMetadataConfigurationUpdate>>
  ...
  late final Output<List<IndexIndexStatistic>> indexStatistics;
  ...
  late final Output<IndexServerSideEncryptionConfiguration?>
  ...
  late final Output<String?> userContextPolicy;
  ...
  late final Output<IndexUserGroupResolutionConfiguration?>
      userGroupResolutionConfiguration;

  /// A block that specifies the user token configuration. Detailed below.
  late final Output<IndexUserTokenConfigurations?> userTokenConfigurations;
