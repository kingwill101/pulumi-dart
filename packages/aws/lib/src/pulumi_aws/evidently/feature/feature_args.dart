...
class FeatureArgs {
  ...
  factory FeatureArgs.fromMap(Map<String, dynamic> map) {
    return FeatureArgs(
      defaultVariation:
          pulumi.Input.asOptionalInput<String>(map['defaultVariation']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      entityOverrides: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['entityOverrides']),
      evaluationStrategy:
          pulumi.Input.asOptionalInput<String>(map['evaluationStrategy']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      project: pulumi.Input.asInput<String>(map['project']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      variations:
          pulumi.Input.asInput<List<FeatureVariation>>(map['variations']),
    );
  }
}
