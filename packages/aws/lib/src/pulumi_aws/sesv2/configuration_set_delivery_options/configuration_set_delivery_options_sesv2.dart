...
class ConfigurationSetDeliveryOptionsSesv2 {
  ...
  ConfigurationSetDeliveryOptionsSesv2({
  ...
  factory ConfigurationSetDeliveryOptionsSesv2.fromMap(
      Map<String, dynamic> map) {
    return ConfigurationSetDeliveryOptionsSesv2(
