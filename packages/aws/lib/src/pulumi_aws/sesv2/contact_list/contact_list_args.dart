...
class ContactListArgs {
  ...
  final Input<String> contactListName;
  ...
  final Input<List<ContactListTopic>>? topics;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (topicsValue != null) {
      map['topics'] = Input.mapOptionalInputValue<List<ContactListTopic>,
              List<Map<String, dynamic>>>(
          topicsValue,
          (value) => Input.encodeList<ContactListTopic, Map<String, dynamic>>(
  ...
  factory ContactListArgs.fromMap(Map<String, dynamic> map) {
    return ContactListArgs(
      contactListName: Input.asInput<String>(map['contactListName']),
      description: Input.asOptionalInput<String>(map['description']),
      region: Input.asOptionalInput<String>(map['region']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      topics: Input.asOptionalInput<List<ContactListTopic>>(map['topics']),
    );
  }
}
