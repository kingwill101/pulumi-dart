...
class GetEmailIdentityDkimSigningAttribute {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['currentSigningKeyLength'] = currentSigningKeyLength;
    map['domainSigningPrivateKey'] = domainSigningPrivateKey;
    map['domainSigningSelector'] = domainSigningSelector;
    map['lastKeyGenerationTimestamp'] = lastKeyGenerationTimestamp;
    map['nextSigningKeyLength'] = nextSigningKeyLength;
    map['signingAttributesOrigin'] = signingAttributesOrigin;
    map['status'] = status;
    map['tokens'] = tokens;
    return map;
  }
