...
import '../get_email_identity_dkim_signing_attribute/get_email_identity_dkim_signing_attribute.dart';

/// Result data returned by getEmailIdentity.
class GetEmailIdentityResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dkimSigningAttributes'] = Input.encodeList<
        GetEmailIdentityDkimSigningAttribute,
        Map<String, dynamic>>(dkimSigningAttributes, (value) => value.toMap());
    ...
    map['verifiedForSendingStatus'] = verifiedForSendingStatus;
    return map;
  }

  factory GetEmailIdentityResult2.fromMap(Map<String, dynamic> map) {
    return GetEmailIdentityResult2(
      arn: map['arn'] as String,
      configurationSetName: map['configurationSetName'] as String,
      dkimSigningAttributes:
          Input.decodeList<GetEmailIdentityDkimSigningAttribute>(
