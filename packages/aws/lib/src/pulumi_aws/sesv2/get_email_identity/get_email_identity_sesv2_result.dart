...
class GetEmailIdentitySesv2Result {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dkimSigningAttributes'] = pulumi.Input.encodeList<
  ...
  factory GetEmailIdentitySesv2Result.fromMap(Map<String, dynamic> map) {
    return GetEmailIdentitySesv2Result(
