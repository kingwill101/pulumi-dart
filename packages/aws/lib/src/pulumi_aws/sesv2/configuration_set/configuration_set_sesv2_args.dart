...
class ConfigurationSetSesv2Args {
  ...
  final pulumi.Input<ConfigurationSetDeliveryOptionsSesv2>? deliveryOptions;
  ...
  final pulumi.Input<ConfigurationSetTrackingOptionsSesv2>? trackingOptions;
  ...
  factory ConfigurationSetSesv2Args.fromMap(Map<String, dynamic> map) {
    return ConfigurationSetSesv2Args(
      configurationSetName:
          pulumi.Input.asInput<String>(map['configurationSetName']),
      deliveryOptions:
          pulumi.Input.asOptionalInput<ConfigurationSetDeliveryOptionsSesv2>(
              map['deliveryOptions']),
      ...
      trackingOptions:
          pulumi.Input.asOptionalInput<ConfigurationSetTrackingOptionsSesv2>(
              map['trackingOptions']),
