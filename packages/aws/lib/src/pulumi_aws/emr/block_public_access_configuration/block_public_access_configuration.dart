...
/// <!--End PulumiCodeChooser -->
///
/// > **NOTE:** If an <span pulumi-lang-nodejs="`aws.emr.BlockPublicAccessConfiguration`" pulumi-lang-dotnet="`aws.emr.BlockPublicAccessConfiguration`" pulumi-lang-go="`emr.BlockPublicAccessConfiguration`" pulumi-lang-python="`emr.BlockPublicAccessConfiguration`" pulumi-lang-yaml="`aws.emr.BlockPublicAccessConfiguration`" pulumi-lang-java="`aws.emr.BlockPublicAccessConfiguration`">`aws.emr.BlockPublicAccessConfiguration`</span> resource is destroyed, the configuration will reset to this default configuration.
///
/// ### Multiple Permitted Public Security Group Rule Ranges
///
/// The resource permits specification of multiple <span pulumi-lang-nodejs="`permittedPublicSecurityGroupRuleRange`" pulumi-lang-dotnet="`PermittedPublicSecurityGroupRuleRange`" pulumi-lang-go="`permittedPublicSecurityGroupRuleRange`" pulumi-lang-python="`permitted_public_security_group_rule_range`" pulumi-lang-yaml="`permittedPublicSecurityGroupRuleRange`" pulumi-lang-java="`permittedPublicSecurityGroupRuleRange`">`permitted_public_security_group_rule_range`</span> blocks.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
