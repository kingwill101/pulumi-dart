...
class InstanceFleetInstanceTypeConfig {
  ...
  /// The number of units that a provisioned instance of this type provides toward fulfilling the target capacities defined in <span pulumi-lang-nodejs="`aws.emr.InstanceFleet`" pulumi-lang-dotnet="`aws.emr.InstanceFleet`" pulumi-lang-go="`emr.InstanceFleet`" pulumi-lang-python="`emr.InstanceFleet`" pulumi-lang-yaml="`aws.emr.InstanceFleet`" pulumi-lang-java="`aws.emr.InstanceFleet`">`aws.emr.InstanceFleet`</span>.
