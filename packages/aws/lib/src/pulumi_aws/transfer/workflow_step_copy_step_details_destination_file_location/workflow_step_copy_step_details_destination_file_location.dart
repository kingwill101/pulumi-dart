...
import '../workflow_step_copy_step_details_destination_file_location_efs_file_location/workflow_step_copy_step_details_destination_file_location_efs_file_location.dart';
import '../workflow_step_copy_step_details_destination_file_location_s3_file_location/workflow_step_copy_step_details_destination_file_location_s3_file_location.dart';

class WorkflowStepCopyStepDetailsDestinationFileLocation {
  /// Specifies the details for the EFS file being copied.
  final WorkflowStepCopyStepDetailsDestinationFileLocationEfsFileLocation?
      efsFileLocation;

  /// Specifies the details for the S3 file being copied.
  final WorkflowStepCopyStepDetailsDestinationFileLocationS3FileLocation?
      s3FileLocation;
