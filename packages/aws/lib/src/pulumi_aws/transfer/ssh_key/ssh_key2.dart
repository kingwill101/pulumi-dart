...
/// ## Import
///
/// Using `pulumi import`, import Transfer SSH Public Key using the <span pulumi-lang-nodejs="`serverId`" pulumi-lang-dotnet="`ServerId`" pulumi-lang-go="`serverId`" pulumi-lang-python="`server_id`" pulumi-lang-yaml="`serverId`" pulumi-lang-java="`serverId`">`server_id`</span> and <span pulumi-lang-nodejs="`userName`" pulumi-lang-dotnet="`UserName`" pulumi-lang-go="`userName`" pulumi-lang-python="`user_name`" pulumi-lang-yaml="`userName`" pulumi-lang-java="`userName`">`user_name`</span> and <span pulumi-lang-nodejs="`sshPublicKeyId`" pulumi-lang-dotnet="`SshPublicKeyId`" pulumi-lang-go="`sshPublicKeyId`" pulumi-lang-python="`ssh_public_key_id`" pulumi-lang-yaml="`sshPublicKeyId`" pulumi-lang-java="`sshPublicKeyId`">`ssh_public_key_id`</span> separated by `/`. For example:
///
/// ```sh
