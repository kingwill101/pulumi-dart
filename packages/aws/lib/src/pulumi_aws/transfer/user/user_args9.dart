...
class UserArgs9 {
  ...
  final Input<List<UserHomeDirectoryMapping>>? homeDirectoryMappings;
  ...
  final Input<UserPosixProfile>? posixProfile;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (homeDirectoryMappingsValue != null) {
      map['homeDirectoryMappings'] = Input.mapOptionalInputValue<
          ...
          (value) =>
              Input.encodeList<UserHomeDirectoryMapping, Map<String, dynamic>>(
    ...
    if (posixProfileValue != null) {
      map['posixProfile'] =
          Input.mapOptionalInputValue<UserPosixProfile, Map<String, dynamic>>(
  ...
  factory UserArgs9.fromMap(Map<String, dynamic> map) {
    return UserArgs9(
      homeDirectory: Input.asOptionalInput<String>(map['homeDirectory']),
      homeDirectoryMappings:
          Input.asOptionalInput<List<UserHomeDirectoryMapping>>(
      ...
      posixProfile:
          Input.asOptionalInput<UserPosixProfile>(map['posixProfile']),
