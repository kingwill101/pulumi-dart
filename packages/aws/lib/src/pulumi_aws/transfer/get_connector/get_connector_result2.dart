...
import '../get_connector_as2_config/get_connector_as2_config.dart';
import '../get_connector_egress_config/get_connector_egress_config.dart';
import '../get_connector_sftp_config/get_connector_sftp_config.dart';
...
class GetConnectorResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['arn'] = arn;
    map['as2Configs'] =
        Input.encodeList<GetConnectorAs2Config, Map<String, dynamic>>(
            as2Configs, (value) => value.toMap());
    map['egressConfigs'] =
        Input.encodeList<GetConnectorEgressConfig, Map<String, dynamic>>(
            egressConfigs, (value) => value.toMap());
    map['id'] = id;
    map['loggingRole'] = loggingRole;
    map['region'] = region;
    map['securityPolicyName'] = securityPolicyName;
    map['serviceManagedEgressIpAddresses'] = serviceManagedEgressIpAddresses;
    map['sftpConfigs'] =
        Input.encodeList<GetConnectorSftpConfig, Map<String, dynamic>>(
            sftpConfigs, (value) => value.toMap());
    map['tags'] = tags;
    map['url'] = url;
    return map;
  }
  ...
  factory GetConnectorResult2.fromMap(Map<String, dynamic> map) {
    return GetConnectorResult2(
      ...
      as2Configs: Input.decodeList<GetConnectorAs2Config>(
          map['as2Configs'],
          (value) => GetConnectorAs2Config.fromMap(
              (value as Map).cast<String, dynamic>())),
      egressConfigs: Input.decodeList<GetConnectorEgressConfig>(
          map['egressConfigs'],
          (value) => GetConnectorEgressConfig.fromMap(
              (value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      ...
      serviceManagedEgressIpAddresses:
          (map['serviceManagedEgressIpAddresses'] as List).cast<String>(),
      sftpConfigs: Input.decodeList<GetConnectorSftpConfig>(
          map['sftpConfigs'],
          (value) => GetConnectorSftpConfig.fromMap(
              (value as Map).cast<String, dynamic>())),
