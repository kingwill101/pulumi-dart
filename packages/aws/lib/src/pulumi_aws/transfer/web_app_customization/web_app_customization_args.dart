...
class WebAppCustomizationArgs {
  ...
  final Input<String>? faviconFile;
  ...
  factory WebAppCustomizationArgs.fromMap(Map<String, dynamic> map) {
    return WebAppCustomizationArgs(
      faviconFile: Input.asOptionalInput<String>(map['faviconFile']),
      logoFile: Input.asOptionalInput<String>(map['logoFile']),
