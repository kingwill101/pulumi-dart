...
class ServerArgs {
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      ...
      function: pulumi.Input.asOptionalInput<String>(map['function']),
      hostKey: pulumi.Input.asOptionalInput<String>(map['hostKey']),
      identityProviderType:
          pulumi.Input.asOptionalInput<String>(map['identityProviderType']),
      invocationRole:
          pulumi.Input.asOptionalInput<String>(map['invocationRole']),
      ...
      postAuthenticationLoginBanner: pulumi.Input.asOptionalInput<String>(
          map['postAuthenticationLoginBanner']),
      preAuthenticationLoginBanner: pulumi.Input.asOptionalInput<String>(
          map['preAuthenticationLoginBanner']),
