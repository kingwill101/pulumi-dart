...
import 'replication_configuration_efs_args.dart';
...
/// ```
class ReplicationConfigurationEfs extends pulumi.CustomResource {
  ...
  ReplicationConfigurationEfs(
    String name, {
    ReplicationConfigurationEfsArgs? args,
