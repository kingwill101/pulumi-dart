...
/// ## Import
///
/// Using `pulumi import`, import EKS Fargate Profiles using the <span pulumi-lang-nodejs="`clusterName`" pulumi-lang-dotnet="`ClusterName`" pulumi-lang-go="`clusterName`" pulumi-lang-python="`cluster_name`" pulumi-lang-yaml="`clusterName`" pulumi-lang-java="`clusterName`">`cluster_name`</span> and <span pulumi-lang-nodejs="`fargateProfileName`" pulumi-lang-dotnet="`FargateProfileName`" pulumi-lang-go="`fargateProfileName`" pulumi-lang-python="`fargate_profile_name`" pulumi-lang-yaml="`fargateProfileName`" pulumi-lang-java="`fargateProfileName`">`fargate_profile_name`</span> separated by a colon (`:`). For example:
///
/// ```sh
