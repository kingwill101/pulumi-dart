...
class AddonArgs {
  ...
  final Input<String>? addonVersion;
  ...
  final Input<String>? resolveConflictsOnCreate;
  ...
  final Input<String>? resolveConflictsOnUpdate;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (podIdentityAssociationsValue != null) {
      map['podIdentityAssociations'] = Input.mapOptionalInputValue<
              List<AddonPodIdentityAssociation>, List<Map<String, dynamic>>>(
          podIdentityAssociationsValue,
          (value) => Input.encodeList<AddonPodIdentityAssociation,
  ...
  factory AddonArgs.fromMap(Map<String, dynamic> map) {
    return AddonArgs(
      ...
      addonVersion: Input.asOptionalInput<String>(map['addonVersion']),
      clusterName: Input.asInput<String>(map['clusterName']),
      configurationValues:
          Input.asOptionalInput<String>(map['configurationValues']),
      podIdentityAssociations:
          Input.asOptionalInput<List<AddonPodIdentityAssociation>>(
              map['podIdentityAssociations']),
      preserve: Input.asOptionalInput<bool>(map['preserve']),
      region: Input.asOptionalInput<String>(map['region']),
      resolveConflictsOnCreate:
          Input.asOptionalInput<String>(map['resolveConflictsOnCreate']),
      resolveConflictsOnUpdate:
          Input.asOptionalInput<String>(map['resolveConflictsOnUpdate']),
      serviceAccountRoleArn:
          Input.asOptionalInput<String>(map['serviceAccountRoleArn']),
