...
///
/// > **NOTE:** When using EKS Auto Mode `compute_config.enabled`, `kubernetes_network_config.elastic_load_balancing.enabled`, and `storage_config.block_storage.enabled` must *ALL be set to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>. Likewise for disabling EKS Auto Mode, all three arguments must be set to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span>. Enabling EKS Auto Mode also requires that <span pulumi-lang-nodejs="`bootstrapSelfManagedAddons`" pulumi-lang-dotnet="`BootstrapSelfManagedAddons`" pulumi-lang-go="`bootstrapSelfManagedAddons`" pulumi-lang-python="`bootstrap_self_managed_addons`" pulumi-lang-yaml="`bootstrapSelfManagedAddons`" pulumi-lang-java="`bootstrapSelfManagedAddons`">`bootstrap_self_managed_addons`</span> is set to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span>.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import EKS Clusters using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
...
class Cluster6 extends CustomResource {
  ...
  late final Output<ClusterAccessConfig> accessConfig;
  ...
  late final Output<bool?> bootstrapSelfManagedAddons;

  /// Attribute block containing `certificate-authority-data` for your cluster. Detailed below.
  late final Output<ClusterCertificateAuthority> certificateAuthority;

  /// The ID of your local Amazon EKS cluster on the AWS Outpost. This attribute isn't available for an AWS EKS cluster on AWS cloud.
  late final Output<String> clusterId;

  /// Configuration block with compute configuration for EKS Auto Mode. Detailed below.
  late final Output<ClusterComputeConfig> computeConfig;
  ...
  late final Output<ClusterControlPlaneScalingConfig> controlPlaneScalingConfig;

  /// Unix epoch timestamp in seconds for when the cluster was created.
  late final Output<String> createdAt;
  late final Output<List<String>?> defaultAddonsToRemoves;
  ...
  late final Output<List<String>?> enabledClusterLogTypes;
  ...
  late final Output<bool?> forceUpdateVersion;

  /// Attribute block containing identity provider information for your cluster. Only available on Kubernetes version 1.13 and 1.14 clusters created or upgraded on or after September 3, 2019. Detailed below.
  late final Output<List<ClusterIdentity>> identities;
  ...
  late final Output<ClusterKubernetesNetworkConfig> kubernetesNetworkConfig;

  /// Name of the cluster. Must be between 1-100 characters in length. Must begin with an alphanumeric character, and must only contain alphanumeric characters, dashes and underscores (`^[0-9A-Za-z][A-Za-z0-9\-_]*$`).
  late final Output<String> name;

  /// Configuration block representing the configuration of your local Amazon EKS cluster on an AWS Outpost. This block isn't available for creating Amazon EKS clusters on the AWS cloud.
  late final Output<ClusterOutpostConfig?> outpostConfig;
  ...
  late final Output<ClusterRemoteNetworkConfig?> remoteNetworkConfig;
  ...
  late final Output<ClusterStorageConfig> storageConfig;
  ...
  late final Output<ClusterUpgradePolicy> upgradePolicy;
  ...
  late final Output<ClusterVpcConfig> vpcConfig;

  /// Configuration block with zonal shift configuration for the cluster. Detailed below.
  late final Output<ClusterZonalShiftConfig?> zonalShiftConfig;
