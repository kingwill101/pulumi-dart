...
///
/// > **NOTE:** For the MAIL FROM domain to be fully usable, this resource should be paired with the<span pulumi-lang-nodejs=" aws.ses.DomainIdentity " pulumi-lang-dotnet=" aws.ses.DomainIdentity " pulumi-lang-go=" ses.DomainIdentity " pulumi-lang-python=" ses.DomainIdentity " pulumi-lang-yaml=" aws.ses.DomainIdentity " pulumi-lang-java=" aws.ses.DomainIdentity "> aws.ses.DomainIdentity </span>resource. To validate the MAIL FROM domain, a DNS MX record is required. To pass SPF checks, a DNS TXT record may also be required. See the [Amazon SES MAIL FROM documentation](https://docs.aws.amazon.com/ses/latest/dg/mail-from.html) for more information.
///
/// ## Example Usage
///
...
/// ## Import
///
/// Using `pulumi import`, import MAIL FROM domain using the <span pulumi-lang-nodejs="`domain`" pulumi-lang-dotnet="`Domain`" pulumi-lang-go="`domain`" pulumi-lang-python="`domain`" pulumi-lang-yaml="`domain`" pulumi-lang-java="`domain`">`domain`</span> attribute. For example:
///
/// ```sh
