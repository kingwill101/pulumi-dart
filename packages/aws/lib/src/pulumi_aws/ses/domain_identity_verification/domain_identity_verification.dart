...
/// <span pulumi-lang-nodejs="`aws.ses.DomainIdentity`" pulumi-lang-dotnet="`aws.ses.DomainIdentity`" pulumi-lang-go="`ses.DomainIdentity`" pulumi-lang-python="`ses.DomainIdentity`" pulumi-lang-yaml="`aws.ses.DomainIdentity`" pulumi-lang-java="`aws.ses.DomainIdentity`">`aws.ses.DomainIdentity`</span> to request an SES domain identity,
