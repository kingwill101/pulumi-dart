...
///
/// Domain ownership needs to be confirmed first using<span pulumi-lang-nodejs=" sesDomainIdentity " pulumi-lang-dotnet=" SesDomainIdentity " pulumi-lang-go=" sesDomainIdentity " pulumi-lang-python=" ses_domain_identity " pulumi-lang-yaml=" sesDomainIdentity " pulumi-lang-java=" sesDomainIdentity "> ses_domain_identity </span>Resource
///
/// ## Example Usage
///
...
/// ## Import
///
/// Using `pulumi import`, import DKIM tokens using the <span pulumi-lang-nodejs="`domain`" pulumi-lang-dotnet="`Domain`" pulumi-lang-go="`domain`" pulumi-lang-python="`domain`" pulumi-lang-yaml="`domain`" pulumi-lang-java="`domain`">`domain`</span> attribute. For example:
///
/// ```sh
/// $ pulumi import aws:ses/domainDkim:DomainDkim example example.com
/// ```
class DomainDkim extends CustomResource {
  ...
  late final Output<List<String>> dkimTokens;
