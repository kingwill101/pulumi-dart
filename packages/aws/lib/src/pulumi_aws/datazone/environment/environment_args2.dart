...
class EnvironmentArgs2 {
  ...
  final Input<String>? accountIdentifier;

  /// The Amazon Web Services region where the environment exists.
  final Input<String>? accountRegion;

  /// The blueprint with which the environment is created.
  final Input<String>? blueprintIdentifier;
  ...
  final Input<String> profileIdentifier;
  ...
  final Input<EnvironmentTimeouts>? timeouts;
  ...
  final Input<List<EnvironmentUserParameter>>? userParameters;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (timeoutsValue != null) {
      map['timeouts'] = Input.mapOptionalInputValue<EnvironmentTimeouts,
    ...
    if (userParametersValue != null) {
      map['userParameters'] = Input.mapOptionalInputValue<
          ...
          userParametersValue,
          (value) =>
              Input.encodeList<EnvironmentUserParameter, Map<String, dynamic>>(
  ...
  factory EnvironmentArgs2.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs2(
      accountIdentifier:
          Input.asOptionalInput<String>(map['accountIdentifier']),
      accountRegion: Input.asOptionalInput<String>(map['accountRegion']),
      blueprintIdentifier:
          Input.asOptionalInput<String>(map['blueprintIdentifier']),
      ...
      profileIdentifier: Input.asInput<String>(map['profileIdentifier']),
      projectIdentifier: Input.asInput<String>(map['projectIdentifier']),
      region: Input.asOptionalInput<String>(map['region']),
      timeouts: Input.asOptionalInput<EnvironmentTimeouts>(map['timeouts']),
      userParameters: Input.asOptionalInput<List<EnvironmentUserParameter>>(
          map['userParameters']),
    );
  }
}
