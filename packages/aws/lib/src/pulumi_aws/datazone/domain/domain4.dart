...
/// ## Import
///
/// Using `pulumi import`, import DataZone Domain using the <span pulumi-lang-nodejs="`domainId`" pulumi-lang-dotnet="`DomainId`" pulumi-lang-go="`domainId`" pulumi-lang-python="`domain_id`" pulumi-lang-yaml="`domainId`" pulumi-lang-java="`domainId`">`domain_id`</span>. For example:
///
/// ```sh
