...
class GetApplicationServerlessrepositoryResult {
  ...
  GetApplicationServerlessrepositoryResult({
  ...
  factory GetApplicationServerlessrepositoryResult.fromMap(
      Map<String, dynamic> map) {
    return GetApplicationServerlessrepositoryResult(
