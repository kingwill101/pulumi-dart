...
/// ## Import
///
/// Using `pulumi import`, import Auto Scaling scaling plans using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:autoscalingplans/scalingPlan:ScalingPlan example MyScale1
/// ```
class ScalingPlan extends CustomResource {
  /// CloudFormation stack or set of tags. You can create one scaling plan per application source.
  late final Output<ScalingPlanApplicationSource> applicationSource;
  ...
  late final Output<List<ScalingPlanScalingInstruction>> scalingInstructions;

  /// The version number of the scaling plan. This value is always 1.
  late final Output<int> scalingPlanVersion;
