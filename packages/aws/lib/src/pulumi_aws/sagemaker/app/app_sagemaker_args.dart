...
class AppSagemakerArgs {
  ...
  factory AppSagemakerArgs.fromMap(Map<String, dynamic> map) {
    return AppSagemakerArgs(
      appName: pulumi.Input.asInput<String>(map['appName']),
      appType: pulumi.Input.asInput<String>(map['appType']),
      domainId: pulumi.Input.asInput<String>(map['domainId']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      resourceSpec:
          pulumi.Input.asOptionalInput<AppResourceSpec>(map['resourceSpec']),
      spaceName: pulumi.Input.asOptionalInput<String>(map['spaceName']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      userProfileName:
          pulumi.Input.asOptionalInput<String>(map['userProfileName']),
    );
  }
}
