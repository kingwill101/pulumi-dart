...
class MlflowTrackingServerArgs {
  ...
  factory MlflowTrackingServerArgs.fromMap(Map<String, dynamic> map) {
    return MlflowTrackingServerArgs(
      artifactStoreUri: pulumi.Input.asInput<String>(map['artifactStoreUri']),
      automaticModelRegistration:
          pulumi.Input.asOptionalInput<bool>(map['automaticModelRegistration']),
      mlflowVersion: pulumi.Input.asOptionalInput<String>(map['mlflowVersion']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      roleArn: pulumi.Input.asInput<String>(map['roleArn']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      trackingServerName:
          pulumi.Input.asInput<String>(map['trackingServerName']),
      trackingServerSize:
          pulumi.Input.asOptionalInput<String>(map['trackingServerSize']),
