...
class DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec {
  ...
  factory DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec.fromMap(
      Map<String, dynamic> map) {
    return DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec(
      instanceType:
