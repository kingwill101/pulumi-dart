...
class MonitoringScheduleArgs {
  ...
  final Input<MonitoringScheduleMonitoringScheduleConfig>
  ...
  Map<String, dynamic> toMap() {
    ...
    map['monitoringScheduleConfig'] = Input.mapInputValue<
  ...
  factory MonitoringScheduleArgs.fromMap(Map<String, dynamic> map) {
    return MonitoringScheduleArgs(
      monitoringScheduleConfig:
          Input.asInput<MonitoringScheduleMonitoringScheduleConfig>(
              map['monitoringScheduleConfig']),
