...
///
/// > **NOTE:** The AWS provider creates a validly constructed <span pulumi-lang-nodejs="`registryPath`" pulumi-lang-dotnet="`RegistryPath`" pulumi-lang-go="`registryPath`" pulumi-lang-python="`registry_path`" pulumi-lang-yaml="`registryPath`" pulumi-lang-java="`registryPath`">`registry_path`</span> but does not verify that the <span pulumi-lang-nodejs="`registryPath`" pulumi-lang-dotnet="`RegistryPath`" pulumi-lang-go="`registryPath`" pulumi-lang-python="`registry_path`" pulumi-lang-yaml="`registryPath`" pulumi-lang-java="`registryPath`">`registry_path`</span> corresponds to an existing image. For example, using a <span pulumi-lang-nodejs="`registryPath`" pulumi-lang-dotnet="`RegistryPath`" pulumi-lang-go="`registryPath`" pulumi-lang-python="`registry_path`" pulumi-lang-yaml="`registryPath`" pulumi-lang-java="`registryPath`">`registry_path`</span> containing an <span pulumi-lang-nodejs="`imageTag`" pulumi-lang-dotnet="`ImageTag`" pulumi-lang-go="`imageTag`" pulumi-lang-python="`image_tag`" pulumi-lang-yaml="`imageTag`" pulumi-lang-java="`imageTag`">`image_tag`</span> that does not correspond to a Docker image in the ECR repository, will result in an error.
///
/// ## Example Usage
///
/// Basic usage:
