...
class UserProfileSagemakerArgs {
  ...
  factory UserProfileSagemakerArgs.fromMap(Map<String, dynamic> map) {
    return UserProfileSagemakerArgs(
      ...
      singleSignOnUserIdentifier: pulumi.Input.asOptionalInput<String>(
          map['singleSignOnUserIdentifier']),
      singleSignOnUserValue:
          pulumi.Input.asOptionalInput<String>(map['singleSignOnUserValue']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      userProfileName: pulumi.Input.asInput<String>(map['userProfileName']),
