...
import '../endpoint_configuration_async_inference_config_client_config/endpoint_configuration_async_inference_config_client_config.dart';
import '../endpoint_configuration_async_inference_config_output_config/endpoint_configuration_async_inference_config_output_config.dart';
...
class EndpointConfigurationAsyncInferenceConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    final clientConfigValue = clientConfig;
    if (clientConfigValue != null) {
      map['clientConfig'] = clientConfigValue.toMap();
    }
