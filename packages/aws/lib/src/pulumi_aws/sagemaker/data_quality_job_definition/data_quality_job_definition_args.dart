...
class DataQualityJobDefinitionArgs {
  ...
  final Input<DataQualityJobDefinitionNetworkConfig>? networkConfig;
  ...
  final Input<DataQualityJobDefinitionStoppingCondition>? stoppingCondition;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dataQualityAppSpecification'] = Input.mapInputValue<
    ...
    if (stoppingConditionValue != null) {
      map['stoppingCondition'] = Input.mapOptionalInputValue<
  ...
  factory DataQualityJobDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return DataQualityJobDefinitionArgs(
      dataQualityAppSpecification:
          Input.asInput<DataQualityJobDefinitionDataQualityAppSpecification>(
              map['dataQualityAppSpecification']),
      dataQualityBaselineConfig: Input.asOptionalInput<
              DataQualityJobDefinitionDataQualityBaselineConfig>(
          map['dataQualityBaselineConfig']),
      dataQualityJobInput:
          Input.asInput<DataQualityJobDefinitionDataQualityJobInput>(
              map['dataQualityJobInput']),
      dataQualityJobOutputConfig:
          Input.asInput<DataQualityJobDefinitionDataQualityJobOutputConfig>(
              map['dataQualityJobOutputConfig']),
      jobResources: Input.asInput<DataQualityJobDefinitionJobResources>(
          map['jobResources']),
      name: Input.asOptionalInput<String>(map['name']),
      networkConfig:
          Input.asOptionalInput<DataQualityJobDefinitionNetworkConfig>(
              map['networkConfig']),
      region: Input.asOptionalInput<String>(map['region']),
      roleArn: Input.asInput<String>(map['roleArn']),
      stoppingCondition:
          Input.asOptionalInput<DataQualityJobDefinitionStoppingCondition>(
              map['stoppingCondition']),
