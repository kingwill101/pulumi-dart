...
import '../monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_monitoring_output_config/monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_monitoring_output_config.dart';
import '../monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_monitoring_resources/monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_monitoring_resources.dart';
import '../monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_network_config/monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_network_config.dart';
import '../monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_stopping_condition/monitoring_schedule_monitoring_schedule_config_monitoring_job_definition_stopping_condition.dart';
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinition {
  ...
  final MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionBaseline?
      baseline;
  ...
  final MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringAppSpecification
      monitoringAppSpecification;

  /// Inputs for the monitoring job. Fields are documented below.
  final MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputs
      monitoringInputs;

  /// Outputs from the monitoring job to be uploaded to Amazon S3. Fields are documented below.
  final MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringOutputConfig
  ...
  final MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringResources
      monitoringResources;

  /// Networking options for the monitoring job. Fields are documented below.
  final MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionNetworkConfig?
      networkConfig;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (baselineValue != null) {
      map['baseline'] = baselineValue.toMap();
    }
    final environmentValue = environment;
    if (environmentValue != null) {
      map['environment'] = environmentValue;
    }
    map['monitoringAppSpecification'] = monitoringAppSpecification.toMap();
    map['monitoringInputs'] = monitoringInputs.toMap();
    map['monitoringOutputConfig'] = monitoringOutputConfig.toMap();
    map['monitoringResources'] = monitoringResources.toMap();
  ...
  factory MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinition.fromMap(
    ...
    return MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinition(
      baseline: map['baseline'] == null
          ...
          : MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionBaseline
              .fromMap((map['baseline'] as Map).cast<String, dynamic>()),
