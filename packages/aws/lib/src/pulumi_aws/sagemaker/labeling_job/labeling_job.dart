...
/// ## Import
///
/// Using `pulumi import`, import labeling jobs using the <span pulumi-lang-nodejs="`labelingJobName`" pulumi-lang-dotnet="`LabelingJobName`" pulumi-lang-go="`labelingJobName`" pulumi-lang-python="`labeling_job_name`" pulumi-lang-yaml="`labelingJobName`" pulumi-lang-java="`labelingJobName`">`labeling_job_name`</span>. For example:
///
/// ```sh
