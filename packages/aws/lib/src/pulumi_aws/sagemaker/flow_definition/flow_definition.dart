...
/// ## Import
///
/// Using `pulumi import`, import SageMaker AI Flow Definitions using the <span pulumi-lang-nodejs="`flowDefinitionName`" pulumi-lang-dotnet="`FlowDefinitionName`" pulumi-lang-go="`flowDefinitionName`" pulumi-lang-python="`flow_definition_name`" pulumi-lang-yaml="`flowDefinitionName`" pulumi-lang-java="`flowDefinitionName`">`flow_definition_name`</span>. For example:
///
/// ```sh
...
class FlowDefinition extends CustomResource {
  ...
  FlowDefinition(
    ...
    this.flowDefinitionName = Output.createUnknown<String>();
    this.humanLoopActivationConfig =
        Output.createUnknown<FlowDefinitionHumanLoopActivationConfig?>();
    this.humanLoopConfig =
        Output.createUnknown<FlowDefinitionHumanLoopConfig>();
    this.humanLoopRequestSource =
        Output.createUnknown<FlowDefinitionHumanLoopRequestSource?>();
    this.outputConfig = Output.createUnknown<FlowDefinitionOutputConfig>();
