...
import '../model_container_image_config_repository_auth_config/model_container_image_config_repository_auth_config.dart';
  ...
  factory ModelContainerImageConfig.fromMap(Map<String, dynamic> map) {
    return ModelContainerImageConfig(
      ...
      repositoryAuthConfig: map['repositoryAuthConfig'] == null
          ? null
          : ModelContainerImageConfigRepositoryAuthConfig.fromMap(
