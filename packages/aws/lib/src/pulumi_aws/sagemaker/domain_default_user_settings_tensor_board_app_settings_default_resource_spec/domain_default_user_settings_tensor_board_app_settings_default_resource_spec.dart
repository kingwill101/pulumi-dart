...
class DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec {
  ...
  factory DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec.fromMap(
      Map<String, dynamic> map) {
    return DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec(
      instanceType:
