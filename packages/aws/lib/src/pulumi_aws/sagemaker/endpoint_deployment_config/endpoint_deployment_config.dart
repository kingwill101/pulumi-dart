...
import '../endpoint_deployment_config_auto_rollback_configuration/endpoint_deployment_config_auto_rollback_configuration.dart';
import '../endpoint_deployment_config_blue_green_update_policy/endpoint_deployment_config_blue_green_update_policy.dart';
import '../endpoint_deployment_config_rolling_update_policy/endpoint_deployment_config_rolling_update_policy.dart';
...
class EndpointDeploymentConfig {
  ...
  final EndpointDeploymentConfigAutoRollbackConfiguration?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (autoRollbackConfigurationValue != null) {
      map['autoRollbackConfiguration'] = autoRollbackConfigurationValue.toMap();
    }
    final blueGreenUpdatePolicyValue = blueGreenUpdatePolicy;
    if (blueGreenUpdatePolicyValue != null) {
      map['blueGreenUpdatePolicy'] = blueGreenUpdatePolicyValue.toMap();
    }
    final rollingUpdatePolicyValue = rollingUpdatePolicy;
    if (rollingUpdatePolicyValue != null) {
      map['rollingUpdatePolicy'] = rollingUpdatePolicyValue.toMap();
    }
    return map;
  }
  ...
  factory EndpointDeploymentConfig.fromMap(Map<String, dynamic> map) {
    return EndpointDeploymentConfig(
      autoRollbackConfiguration: map['autoRollbackConfiguration'] == null
          ? null
          : EndpointDeploymentConfigAutoRollbackConfiguration.fromMap(
              (map['autoRollbackConfiguration'] as Map)
                  .cast<String, dynamic>()),
      blueGreenUpdatePolicy: map['blueGreenUpdatePolicy'] == null
          ? null
          : EndpointDeploymentConfigBlueGreenUpdatePolicy.fromMap(
              (map['blueGreenUpdatePolicy'] as Map).cast<String, dynamic>()),
      rollingUpdatePolicy: map['rollingUpdatePolicy'] == null
          ? null
          : EndpointDeploymentConfigRollingUpdatePolicy.fromMap(
              (map['rollingUpdatePolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
