...
import '../user_profile_user_settings_canvas_app_settings_identity_provider_oauth_setting/user_profile_user_settings_canvas_app_settings_identity_provider_oauth_setting.dart';
import '../user_profile_user_settings_canvas_app_settings_kendra_settings/user_profile_user_settings_canvas_app_settings_kendra_settings.dart';
import '../user_profile_user_settings_canvas_app_settings_model_register_settings/user_profile_user_settings_canvas_app_settings_model_register_settings.dart';
import '../user_profile_user_settings_canvas_app_settings_time_series_forecasting_settings/user_profile_user_settings_canvas_app_settings_time_series_forecasting_settings.dart';
import '../user_profile_user_settings_canvas_app_settings_workspace_settings/user_profile_user_settings_canvas_app_settings_workspace_settings.dart';
...
class UserProfileUserSettingsCanvasAppSettings {
  ...
  final UserProfileUserSettingsCanvasAppSettingsModelRegisterSettings?
      modelRegisterSettings;

  /// Time series forecast settings for the Canvas app. See Time Series Forecasting Settings below.
  final UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings?
      timeSeriesForecastingSettings;

  /// The workspace settings for the SageMaker AI Canvas application. See Workspace Settings below.
  final UserProfileUserSettingsCanvasAppSettingsWorkspaceSettings?
      workspaceSettings;
  ...
  factory UserProfileUserSettingsCanvasAppSettings.fromMap(
    ...
    return UserProfileUserSettingsCanvasAppSettings(
      ...
      kendraSettings: map['kendraSettings'] == null
          ? null
          : UserProfileUserSettingsCanvasAppSettingsKendraSettings.fromMap(
      ...
      workspaceSettings: map['workspaceSettings'] == null
          ? null
          : UserProfileUserSettingsCanvasAppSettingsWorkspaceSettings.fromMap(
