...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.appsync.Function`" pulumi-lang-dotnet="`aws.appsync.Function`" pulumi-lang-go="`appsync.Function`" pulumi-lang-python="`appsync.Function`" pulumi-lang-yaml="`aws.appsync.Function`" pulumi-lang-java="`aws.appsync.Function`">`aws.appsync.Function`</span> using the AppSync API ID and Function ID separated by `-`. For example:
///
/// ```sh
