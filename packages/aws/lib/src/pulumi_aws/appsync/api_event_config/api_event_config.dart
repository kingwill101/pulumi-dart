...
class ApiEventConfig {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['authProviders'] = pulumi.Input.encodeList<ApiEventConfigAuthProvider,
        Map<String, dynamic>>(authProviders, (value) => value.toMap());
    map['connectionAuthModes'] = pulumi.Input.encodeList<
        ApiEventConfigConnectionAuthMode,
        Map<String, dynamic>>(connectionAuthModes, (value) => value.toMap());
    map['defaultPublishAuthModes'] = pulumi.Input.encodeList<
            ApiEventConfigDefaultPublishAuthMode, Map<String, dynamic>>(
        defaultPublishAuthModes, (value) => value.toMap());
    map['defaultSubscribeAuthModes'] = pulumi.Input.encodeList<
