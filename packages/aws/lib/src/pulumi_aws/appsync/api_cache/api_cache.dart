...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.appsync.ApiCache`" pulumi-lang-dotnet="`aws.appsync.ApiCache`" pulumi-lang-go="`appsync.ApiCache`" pulumi-lang-python="`appsync.ApiCache`" pulumi-lang-yaml="`aws.appsync.ApiCache`" pulumi-lang-java="`aws.appsync.ApiCache`">`aws.appsync.ApiCache`</span> using the AppSync API ID. For example:
///
/// ```sh
