...
/// ## Import
///
/// Using `pulumi import`, import AppSync Event API using the <span pulumi-lang-nodejs="`apiId`" pulumi-lang-dotnet="`ApiId`" pulumi-lang-go="`apiId`" pulumi-lang-python="`api_id`" pulumi-lang-yaml="`apiId`" pulumi-lang-java="`apiId`">`api_id`</span>. For example:
///
/// ```sh
