...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the IVS Chat logging configuration.
///
///
...
class LoggingConfiguration extends CustomResource {
  ...
  LoggingConfiguration(
    ...
    this.destinationConfiguration =
        Output.createUnknown<LoggingConfigurationDestinationConfiguration?>();
