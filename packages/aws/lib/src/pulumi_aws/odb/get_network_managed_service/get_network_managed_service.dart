...
class GetNetworkManagedService {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['kmsAccesses'] = Input.encodeList<GetNetworkManagedServiceKmsAccess,
    ...
    map['s3Accesses'] = Input.encodeList<GetNetworkManagedServiceS3Access,
    ...
    map['stsAccesses'] = Input.encodeList<GetNetworkManagedServiceStsAccess,
        Map<String, dynamic>>(stsAccesses, (value) => value.toMap());
    map['zeroTlAccesses'] = Input.encodeList<
  ...
  factory GetNetworkManagedService.fromMap(Map<String, dynamic> map) {
    return GetNetworkManagedService(
      kmsAccesses: Input.decodeList<GetNetworkManagedServiceKmsAccess>(
          map['kmsAccesses'],
          (value) => GetNetworkManagedServiceKmsAccess.fromMap(
              (value as Map).cast<String, dynamic>())),
      managedS3BackupAccesses:
          Input.decodeList<GetNetworkManagedServiceManagedS3BackupAccess>(
      ...
      s3Accesses: Input.decodeList<GetNetworkManagedServiceS3Access>(
          map['s3Accesses'],
          (value) => GetNetworkManagedServiceS3Access.fromMap(
              (value as Map).cast<String, dynamic>())),
      serviceNetworkArn: map['serviceNetworkArn'] as String,
      serviceNetworkEndpoints:
          Input.decodeList<GetNetworkManagedServiceServiceNetworkEndpoint>(
              map['serviceNetworkEndpoints'],
              (value) => GetNetworkManagedServiceServiceNetworkEndpoint.fromMap(
                  (value as Map).cast<String, dynamic>())),
      stsAccesses: Input.decodeList<GetNetworkManagedServiceStsAccess>(
          map['stsAccesses'],
          (value) => GetNetworkManagedServiceStsAccess.fromMap(
              (value as Map).cast<String, dynamic>())),
      zeroTlAccesses: Input.decodeList<GetNetworkManagedServiceZeroTlAccess>(
          map['zeroTlAccesses'],
