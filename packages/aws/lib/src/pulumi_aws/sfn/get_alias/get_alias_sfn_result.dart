...
class GetAliasSfnResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['name'] = name;
    map['region'] = region;
    map['routingConfigurations'] = pulumi.Input.encodeList<
        GetAliasRoutingConfiguration,
        Map<String, dynamic>>(routingConfigurations, (value) => value.toMap());
    map['statemachineArn'] = statemachineArn;
    return map;
  }

  factory GetAliasSfnResult.fromMap(Map<String, dynamic> map) {
    return GetAliasSfnResult(
