...
class GetServiceServicediscoveryResult {
  /// ARN of the service.
  final String arn;
  ...
  GetServiceServicediscoveryResult({
    required this.arn,
  ...
  factory GetServiceServicediscoveryResult.fromMap(Map<String, dynamic> map) {
    return GetServiceServicediscoveryResult(
