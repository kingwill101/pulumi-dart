...
class Control extends CustomResource {
  ...
  Control(
    ...
    this.actionPlanInstructions = Output.createUnknown<String?>();
    this.actionPlanTitle = Output.createUnknown<String?>();
    this.arn = Output.createUnknown<String>();
    this.controlMappingSources =
        Output.createUnknown<List<ControlControlMappingSource>?>();
    this.description = Output.createUnknown<String?>();
    this.name = Output.createUnknown<String>();
    this.region = Output.createUnknown<String>();
    this.tags = Output.createUnknown<Map<String, String>?>();
    this.tagsAll = Output.createUnknown<Map<String, String>>();
    this.testingInformation = Output.createUnknown<String?>();
