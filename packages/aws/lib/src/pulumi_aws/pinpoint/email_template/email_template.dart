...
/// ## Import
///
/// Using `pulumi import`, import Pinpoint Email Template using the <span pulumi-lang-nodejs="`templateName`" pulumi-lang-dotnet="`TemplateName`" pulumi-lang-go="`templateName`" pulumi-lang-python="`template_name`" pulumi-lang-yaml="`templateName`" pulumi-lang-java="`templateName`">`template_name`</span>. For example:
///
/// ```sh
