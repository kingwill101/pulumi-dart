...
class PolicyDocumentElasticsearch {
  ...
  factory PolicyDocumentElasticsearch.fromMap(Map<String, dynamic> map) {
    return PolicyDocumentElasticsearch(
