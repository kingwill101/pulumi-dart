...
class GetDomainResult2 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['advancedSecurityOptions'] =
        Input.encodeList<GetDomainAdvancedSecurityOption, Map<String, dynamic>>(
            advancedSecurityOptions, (value) => value.toMap());
    map['arn'] = arn;
    map['autoTuneOptions'] =
        Input.encodeList<GetDomainAutoTuneOption, Map<String, dynamic>>(
            autoTuneOptions, (value) => value.toMap());
    map['clusterConfigs'] =
        Input.encodeList<GetDomainClusterConfig, Map<String, dynamic>>(
            clusterConfigs, (value) => value.toMap());
    map['cognitoOptions'] =
        Input.encodeList<GetDomainCognitoOption, Map<String, dynamic>>(
    ...
    map['ebsOptions'] =
        Input.encodeList<GetDomainEbsOption, Map<String, dynamic>>(
            ebsOptions, (value) => value.toMap());
    map['elasticsearchVersion'] = elasticsearchVersion;
    map['encryptionAtRests'] =
        Input.encodeList<GetDomainEncryptionAtRest, Map<String, dynamic>>(
            encryptionAtRests, (value) => value.toMap());
    map['endpoint'] = endpoint;
    map['id'] = id;
    map['kibanaEndpoint'] = kibanaEndpoint;
    map['logPublishingOptions'] =
        Input.encodeList<GetDomainLogPublishingOption, Map<String, dynamic>>(
            logPublishingOptions, (value) => value.toMap());
    map['nodeToNodeEncryptions'] =
        Input.encodeList<GetDomainNodeToNodeEncryption, Map<String, dynamic>>(
            nodeToNodeEncryptions, (value) => value.toMap());
    map['processing'] = processing;
    map['region'] = region;
    map['snapshotOptions'] =
        Input.encodeList<GetDomainSnapshotOption, Map<String, dynamic>>(
            snapshotOptions, (value) => value.toMap());
    map['tags'] = tags;
    map['vpcOptions'] =
        Input.encodeList<GetDomainVpcOption, Map<String, dynamic>>(
  ...
  factory GetDomainResult2.fromMap(Map<String, dynamic> map) {
    return GetDomainResult2(
      ...
      advancedSecurityOptions:
          Input.decodeList<GetDomainAdvancedSecurityOption>(
              map['advancedSecurityOptions'],
              (value) => GetDomainAdvancedSecurityOption.fromMap(
                  (value as Map).cast<String, dynamic>())),
      arn: map['arn'] as String,
      autoTuneOptions: Input.decodeList<GetDomainAutoTuneOption>(
          map['autoTuneOptions'],
          (value) => GetDomainAutoTuneOption.fromMap(
              (value as Map).cast<String, dynamic>())),
      clusterConfigs: Input.decodeList<GetDomainClusterConfig>(
          map['clusterConfigs'],
          (value) => GetDomainClusterConfig.fromMap(
              (value as Map).cast<String, dynamic>())),
      cognitoOptions: Input.decodeList<GetDomainCognitoOption>(
          map['cognitoOptions'],
      ...
      ebsOptions: Input.decodeList<GetDomainEbsOption>(
          map['ebsOptions'],
          (value) => GetDomainEbsOption.fromMap(
              (value as Map).cast<String, dynamic>())),
      elasticsearchVersion: map['elasticsearchVersion'] as String,
      encryptionAtRests: Input.decodeList<GetDomainEncryptionAtRest>(
          map['encryptionAtRests'],
      ...
      logPublishingOptions: Input.decodeList<GetDomainLogPublishingOption>(
          map['logPublishingOptions'],
          (value) => GetDomainLogPublishingOption.fromMap(
              (value as Map).cast<String, dynamic>())),
      nodeToNodeEncryptions: Input.decodeList<GetDomainNodeToNodeEncryption>(
          map['nodeToNodeEncryptions'],
          (value) => GetDomainNodeToNodeEncryption.fromMap(
              (value as Map).cast<String, dynamic>())),
      processing: map['processing'] as bool,
      region: map['region'] as String,
      snapshotOptions: Input.decodeList<GetDomainSnapshotOption>(
          map['snapshotOptions'],
          (value) => GetDomainSnapshotOption.fromMap(
              (value as Map).cast<String, dynamic>())),
      tags: (map['tags'] as Map).cast<String, String>(),
      vpcOptions: Input.decodeList<GetDomainVpcOption>(
          map['vpcOptions'],
