...
import '../get_domain_advanced_security_option/get_domain_advanced_security_option.dart';
import '../get_domain_auto_tune_option/get_domain_auto_tune_option.dart';
import '../get_domain_cluster_config/get_domain_cluster_config.dart';
import '../get_domain_cognito_option/get_domain_cognito_option.dart';
import '../get_domain_ebs_option/get_domain_ebs_option.dart';
import '../get_domain_encryption_at_rest/get_domain_encryption_at_rest.dart';
import '../get_domain_log_publishing_option/get_domain_log_publishing_option.dart';
import '../get_domain_node_to_node_encryption/get_domain_node_to_node_encryption.dart';
import '../get_domain_snapshot_option/get_domain_snapshot_option.dart';
import '../get_domain_vpc_option/get_domain_vpc_option.dart';

/// Result data returned by getDomain.
class GetDomainElasticsearchResult {
  ...
  factory GetDomainElasticsearchResult.fromMap(Map<String, dynamic> map) {
    return GetDomainElasticsearchResult(
