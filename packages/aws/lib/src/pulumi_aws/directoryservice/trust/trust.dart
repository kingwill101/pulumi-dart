...
class Trust extends CustomResource {
  ...
  /// Date and time when the Trust state in <span pulumi-lang-nodejs="`trustState`" pulumi-lang-dotnet="`TrustState`" pulumi-lang-go="`trustState`" pulumi-lang-python="`trust_state`" pulumi-lang-yaml="`trustState`" pulumi-lang-java="`trustState`">`trust_state`</span> was last updated.
  ...
  /// Reason for the Trust state set in <span pulumi-lang-nodejs="`trustState`" pulumi-lang-dotnet="`TrustState`" pulumi-lang-go="`trustState`" pulumi-lang-python="`trust_state`" pulumi-lang-yaml="`trustState`" pulumi-lang-java="`trustState`">`trust_state`</span>.
