...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.macie2.OrganizationAdminAccount`" pulumi-lang-dotnet="`aws.macie2.OrganizationAdminAccount`" pulumi-lang-go="`macie2.OrganizationAdminAccount`" pulumi-lang-python="`macie2.OrganizationAdminAccount`" pulumi-lang-yaml="`aws.macie2.OrganizationAdminAccount`" pulumi-lang-java="`aws.macie2.OrganizationAdminAccount`">`aws.macie2.OrganizationAdminAccount`</span> using the id. For example:
///
/// ```sh
