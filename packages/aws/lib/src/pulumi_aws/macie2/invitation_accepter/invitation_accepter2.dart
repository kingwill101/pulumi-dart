...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.macie2.InvitationAccepter`" pulumi-lang-dotnet="`aws.macie2.InvitationAccepter`" pulumi-lang-go="`macie2.InvitationAccepter`" pulumi-lang-python="`macie2.InvitationAccepter`" pulumi-lang-yaml="`aws.macie2.InvitationAccepter`" pulumi-lang-java="`aws.macie2.InvitationAccepter`">`aws.macie2.InvitationAccepter`</span> using the admin account ID. For example:
///
/// ```sh
