...
class EventTargetInputTransformer {
  ...
  Map<String, dynamic> toMap() {
    ...
    final inputPathsValue = inputPaths;
    if (inputPathsValue != null) {
      map['inputPaths'] = inputPathsValue;
    }
    map['inputTemplate'] = inputTemplate;
    return map;
  }

  factory EventTargetInputTransformer.fromMap(Map<String, dynamic> map) {
    return EventTargetInputTransformer(
      inputPaths: map['inputPaths'] == null
          ? null
          : (map['inputPaths'] as Map).cast<String, String>(),
