...
class LogSubscriptionFilterArgs {
  ...
  factory LogSubscriptionFilterArgs.fromMap(Map<String, dynamic> map) {
    return LogSubscriptionFilterArgs(
      ...
      distribution: pulumi.Input.asOptionalInput<String>(map['distribution']),
      emitSystemFields:
          pulumi.Input.asOptionalInput<List<String>>(map['emitSystemFields']),
      filterPattern: pulumi.Input.asInput<String>(map['filterPattern']),
      logGroup: pulumi.Input.asInput<String>(map['logGroup']),
