...
/// ## Import
///
/// Using `pulumi import`, import this resource using the <span pulumi-lang-nodejs="`policyName`" pulumi-lang-dotnet="`PolicyName`" pulumi-lang-go="`policyName`" pulumi-lang-python="`policy_name`" pulumi-lang-yaml="`policyName`" pulumi-lang-java="`policyName`">`policy_name`</span> and <span pulumi-lang-nodejs="`policyType`" pulumi-lang-dotnet="`PolicyType`" pulumi-lang-go="`policyType`" pulumi-lang-python="`policy_type`" pulumi-lang-yaml="`policyType`" pulumi-lang-java="`policyType`">`policy_type`</span> separated by `:`. For example:
///
/// ```sh
