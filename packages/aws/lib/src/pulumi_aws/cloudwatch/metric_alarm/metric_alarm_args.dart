...
class MetricAlarmArgs {
  ...
  factory MetricAlarmArgs.fromMap(Map<String, dynamic> map) {
    return MetricAlarmArgs(
      ...
      comparisonOperator:
          pulumi.Input.asInput<String>(map['comparisonOperator']),
      datapointsToAlarm:
          pulumi.Input.asOptionalInput<int>(map['datapointsToAlarm']),
      dimensions:
      ...
      evaluateLowSampleCountPercentiles: pulumi.Input.asOptionalInput<String>(
          map['evaluateLowSampleCountPercentiles']),
      evaluationPeriods: pulumi.Input.asInput<int>(map['evaluationPeriods']),
      extendedStatistic:
          pulumi.Input.asOptionalInput<String>(map['extendedStatistic']),
      ...
      metricQueries: pulumi.Input.asOptionalInput<List<MetricAlarmMetricQuery>>(
          map['metricQueries']),
      ...
      period: pulumi.Input.asOptionalInput<int>(map['period']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      statistic: pulumi.Input.asOptionalInput<String>(map['statistic']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      threshold: pulumi.Input.asOptionalInput<double>(map['threshold']),
      thresholdMetricId:
          pulumi.Input.asOptionalInput<String>(map['thresholdMetricId']),
      treatMissingData:
          pulumi.Input.asOptionalInput<String>(map['treatMissingData']),
