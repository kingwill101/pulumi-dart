...
class MetricStreamArgs {
  ...
  final pulumi.Input<List<MetricStreamStatisticsConfiguration>>?
  ...
  Map<String, dynamic> toMap() {
    ...
    if (excludeFiltersValue != null) {
      map['excludeFilters'] = pulumi.Input.mapOptionalInputValue<
              List<MetricStreamExcludeFilter>, List<Map<String, dynamic>>>(
          excludeFiltersValue,
          (value) => pulumi.Input.encodeList<MetricStreamExcludeFilter,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    map['firehoseArn'] = firehoseArn;
    final includeFiltersValue = includeFilters;
    if (includeFiltersValue != null) {
      map['includeFilters'] = pulumi.Input.mapOptionalInputValue<
              List<MetricStreamIncludeFilter>, List<Map<String, dynamic>>>(
          includeFiltersValue,
          (value) => pulumi.Input.encodeList<MetricStreamIncludeFilter,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (statisticsConfigurationsValue != null) {
      map['statisticsConfigurations'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory MetricStreamArgs.fromMap(Map<String, dynamic> map) {
    return MetricStreamArgs(
      excludeFilters:
          pulumi.Input.asOptionalInput<List<MetricStreamExcludeFilter>>(
              map['excludeFilters']),
      firehoseArn: pulumi.Input.asInput<String>(map['firehoseArn']),
      includeFilters:
          pulumi.Input.asOptionalInput<List<MetricStreamIncludeFilter>>(
              map['includeFilters']),
      includeLinkedAccountsMetrics: pulumi.Input.asOptionalInput<bool>(
          map['includeLinkedAccountsMetrics']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      namePrefix: pulumi.Input.asOptionalInput<String>(map['namePrefix']),
      outputFormat: pulumi.Input.asInput<String>(map['outputFormat']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      roleArn: pulumi.Input.asInput<String>(map['roleArn']),
      statisticsConfigurations: pulumi.Input.asOptionalInput<
              List<MetricStreamStatisticsConfiguration>>(
