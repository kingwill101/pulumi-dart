...
/// ## Import
///
/// Using `pulumi import`, import CloudWatch dashboards using the <span pulumi-lang-nodejs="`dashboardName`" pulumi-lang-dotnet="`DashboardName`" pulumi-lang-go="`dashboardName`" pulumi-lang-python="`dashboard_name`" pulumi-lang-yaml="`dashboardName`" pulumi-lang-java="`dashboardName`">`dashboard_name`</span>. For example:
///
/// ```sh
...
class Dashboard extends CustomResource {
  ...
  late final Output<String> dashboardArn;

  /// The detailed information about the dashboard, including what widgets are included and their location on the dashboard. You can read more about the body structure in the [documentation](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/CloudWatch-Dashboard-Body-Structure.html).
  late final Output<String> dashboardBody;

  /// The name of the dashboard.
  late final Output<String> dashboardName;
