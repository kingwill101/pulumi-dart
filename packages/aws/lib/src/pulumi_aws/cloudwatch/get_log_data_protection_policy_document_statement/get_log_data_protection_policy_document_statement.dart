...
import '../get_log_data_protection_policy_document_statement_operation/get_log_data_protection_policy_document_statement_operation.dart';
...
class GetLogDataProtectionPolicyDocumentStatement {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['dataIdentifiers'] = dataIdentifiers;
