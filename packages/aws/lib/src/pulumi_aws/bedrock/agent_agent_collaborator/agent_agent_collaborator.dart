...
/// ## Import
///
/// Using `pulumi import`, import Bedrock Agents Agent Collaborator using a comma-delimited string combining <span pulumi-lang-nodejs="`agentId`" pulumi-lang-dotnet="`AgentId`" pulumi-lang-go="`agentId`" pulumi-lang-python="`agent_id`" pulumi-lang-yaml="`agentId`" pulumi-lang-java="`agentId`">`agent_id`</span>, <span pulumi-lang-nodejs="`agentVersion`" pulumi-lang-dotnet="`AgentVersion`" pulumi-lang-go="`agentVersion`" pulumi-lang-python="`agent_version`" pulumi-lang-yaml="`agentVersion`" pulumi-lang-java="`agentVersion`">`agent_version`</span>, and <span pulumi-lang-nodejs="`collaboratorId`" pulumi-lang-dotnet="`CollaboratorId`" pulumi-lang-go="`collaboratorId`" pulumi-lang-python="`collaborator_id`" pulumi-lang-yaml="`collaboratorId`" pulumi-lang-java="`collaboratorId`">`collaborator_id`</span>. For example:
///
/// ```sh
