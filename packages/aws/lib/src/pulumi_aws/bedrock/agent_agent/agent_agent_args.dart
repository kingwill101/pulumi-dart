...
class AgentAgentArgs {
  ...
  factory AgentAgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentAgentArgs(
      agentCollaboration:
          pulumi.Input.asOptionalInput<String>(map['agentCollaboration']),
      agentName: pulumi.Input.asInput<String>(map['agentName']),
      agentResourceRoleArn:
          pulumi.Input.asInput<String>(map['agentResourceRoleArn']),
      customerEncryptionKeyArn:
          pulumi.Input.asOptionalInput<String>(map['customerEncryptionKeyArn']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      foundationModel: pulumi.Input.asInput<String>(map['foundationModel']),
      guardrailConfigurations:
      ...
      timeouts:
          pulumi.Input.asOptionalInput<AgentAgentTimeouts>(map['timeouts']),
    );
  }
}
