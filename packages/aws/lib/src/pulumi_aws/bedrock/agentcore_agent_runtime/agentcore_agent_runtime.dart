...
/// ## Import
///
/// Using `pulumi import`, import Bedrock AgentCore Agent Runtime using <span pulumi-lang-nodejs="`agentRuntimeId`" pulumi-lang-dotnet="`AgentRuntimeId`" pulumi-lang-go="`agentRuntimeId`" pulumi-lang-python="`agent_runtime_id`" pulumi-lang-yaml="`agentRuntimeId`" pulumi-lang-java="`agentRuntimeId`">`agent_runtime_id`</span>. For example:
///
/// ```sh
...
class AgentcoreAgentRuntime extends CustomResource {
  ...
  /// Workload identity details for the agent runtime. See <span pulumi-lang-nodejs="`workloadIdentityDetails`" pulumi-lang-dotnet="`WorkloadIdentityDetails`" pulumi-lang-go="`workloadIdentityDetails`" pulumi-lang-python="`workload_identity_details`" pulumi-lang-yaml="`workloadIdentityDetails`" pulumi-lang-java="`workloadIdentityDetails`">`workload_identity_details`</span> below.
