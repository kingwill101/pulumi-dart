...
import '../agent_prompt_variant_template_configuration_chat_tool_configuration_tool_choice_tool/agent_prompt_variant_template_configuration_chat_tool_configuration_tool_choice_tool.dart';
...
class AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoice {
  ...
  final AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoiceTool?
      tool;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (toolValue != null) {
      map['tool'] = toolValue.toMap();
    }
    return map;
  }

  factory AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoice.fromMap(
    ...
    return AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoice(
      ...
      tool: map['tool'] == null
          ...
          : AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoiceTool
              .fromMap((map['tool'] as Map).cast<String, dynamic>()),
    );
  }
}
