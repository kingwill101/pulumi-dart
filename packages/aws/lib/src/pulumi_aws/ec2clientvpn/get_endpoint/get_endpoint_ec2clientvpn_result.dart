...
class GetEndpointEc2clientvpnResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['arn'] = arn;
    map['authenticationOptions'] = pulumi.Input.encodeList<
        GetEndpointAuthenticationOption,
        Map<String, dynamic>>(authenticationOptions, (value) => value.toMap());
    map['clientCidrBlock'] = clientCidrBlock;
    map['clientConnectOptions'] = pulumi.Input.encodeList<
        GetEndpointClientConnectOption,
        Map<String, dynamic>>(clientConnectOptions, (value) => value.toMap());
    map['clientLoginBannerOptions'] = pulumi.Input.encodeList<
            GetEndpointClientLoginBannerOption, Map<String, dynamic>>(
        clientLoginBannerOptions, (value) => value.toMap());
    map['clientRouteEnforcementOptions'] = pulumi.Input.encodeList<
    ...
    map['connectionLogOptions'] = pulumi.Input.encodeList<
  ...
  factory GetEndpointEc2clientvpnResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointEc2clientvpnResult(
      arn: map['arn'] as String,
      authenticationOptions:
          pulumi.Input.decodeList<GetEndpointAuthenticationOption>(
      ...
      clientConnectOptions:
          pulumi.Input.decodeList<GetEndpointClientConnectOption>(
              map['clientConnectOptions'],
              (value) => GetEndpointClientConnectOption.fromMap(
                  (value as Map).cast<String, dynamic>())),
      clientLoginBannerOptions:
          pulumi.Input.decodeList<GetEndpointClientLoginBannerOption>(
              map['clientLoginBannerOptions'],
              (value) => GetEndpointClientLoginBannerOption.fromMap(
                  (value as Map).cast<String, dynamic>())),
      clientRouteEnforcementOptions:
          pulumi.Input.decodeList<GetEndpointClientRouteEnforcementOption>(
      ...
      connectionLogOptions:
          pulumi.Input.decodeList<GetEndpointConnectionLogOption>(
