...
/// ```
/// <!--End PulumiCodeChooser -->
class EnvironmentEC2 extends CustomResource {
  /// The ARN of the environment.
  late final Output<String> arn;

  /// The number of minutes until the running instance is shut down after the environment has last been used.
  late final Output<int?> automaticStopTimeMinutes;
  ...
  late final Output<String> ownerArn;
  ...
  /// The type of the environment (e.g., <span pulumi-lang-nodejs="`ssh`" pulumi-lang-dotnet="`Ssh`" pulumi-lang-go="`ssh`" pulumi-lang-python="`ssh`" pulumi-lang-yaml="`ssh`" pulumi-lang-java="`ssh`">`ssh`</span> or <span pulumi-lang-nodejs="`ec2`" pulumi-lang-dotnet="`Ec2`" pulumi-lang-go="`ec2`" pulumi-lang-python="`ec2`" pulumi-lang-yaml="`ec2`" pulumi-lang-java="`ec2`">`ec2`</span>).
