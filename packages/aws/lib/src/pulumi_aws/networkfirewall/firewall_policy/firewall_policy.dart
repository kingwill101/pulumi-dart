...
/// ## Import
///
/// Using `pulumi import`, import Network Firewall Policies using their <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
...
class FirewallPolicy extends CustomResource {
  ...
  late final Output<FirewallPolicyEncryptionConfiguration?>
      encryptionConfiguration;

  /// A configuration block describing the rule groups and policy actions to use in the firewall policy. See Firewall Policy below for details.
  late final Output<FirewallPolicyFirewallPolicy> firewallPolicy;
