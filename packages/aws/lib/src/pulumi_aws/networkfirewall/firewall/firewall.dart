...
///
/// A full example of how to create a Transit Gateway in one AWS account, share it with a second AWS account, and create Network Firewall in the second account to the Transit Gateway via the <span pulumi-lang-nodejs="`aws.networkfirewall.Firewall`" pulumi-lang-dotnet="`aws.networkfirewall.Firewall`" pulumi-lang-go="`networkfirewall.Firewall`" pulumi-lang-python="`networkfirewall.Firewall`" pulumi-lang-yaml="`aws.networkfirewall.Firewall`" pulumi-lang-java="`aws.networkfirewall.Firewall`">`aws.networkfirewall.Firewall`</span> and <span pulumi-lang-nodejs="`awsNetworkfirewallNetworkFirewallTransitGatewayAttachmentAccepter`" pulumi-lang-dotnet="`AwsNetworkfirewallNetworkFirewallTransitGatewayAttachmentAccepter`" pulumi-lang-go="`awsNetworkfirewallNetworkFirewallTransitGatewayAttachmentAccepter`" pulumi-lang-python="`aws_networkfirewall_network_firewall_transit_gateway_attachment_accepter`" pulumi-lang-yaml="`awsNetworkfirewallNetworkFirewallTransitGatewayAttachmentAccepter`" pulumi-lang-java="`awsNetworkfirewallNetworkFirewallTransitGatewayAttachmentAccepter`">`aws_networkfirewall_network_firewall_transit_gateway_attachment_accepter`</span> resources can be found in the `./examples/network-firewall-cross-account-transit-gateway` directory within the Github Repository
///
/// ## Import
///
/// Using `pulumi import`, import Network Firewall Firewalls using their <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
...
class Firewall extends CustomResource {
  ...
  /// A setting indicating whether the firewall is protected against changes to its Availability Zone configuration. When set to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>, you must first disable this protection before adding or removing Availability Zones.
  late final Output<bool?> availabilityZoneChangeProtection;
  ...
  late final Output<List<FirewallAvailabilityZoneMapping>>
      availabilityZoneMappings;

  /// A flag indicating whether the firewall is protected against deletion. Use this setting to protect against accidentally deleting a firewall that is in use. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span>.
  ...
  late final Output<List<String>?> enabledAnalysisTypes;

  /// KMS encryption configuration settings. See Encryption Configuration below for details.
  late final Output<FirewallEncryptionConfiguration?> encryptionConfiguration;

  /// The Amazon Resource Name (ARN) of the VPC Firewall policy.
  late final Output<String> firewallPolicyArn;

  /// A flag indicating whether the firewall is protected against a change to the firewall policy association. Use this setting to protect against accidentally modifying the firewall policy for a firewall that is in use. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span>.
  late final Output<bool?> firewallPolicyChangeProtection;

  /// Nested list of information about the current status of the firewall.
  late final Output<List<FirewallFirewallStatus>> firewallStatuses;
  ...
  /// A flag indicating whether the firewall is protected against changes to the subnet associations. Use this setting to protect against accidentally modifying the subnet associations for a firewall that is in use. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span>.
  late final Output<bool?> subnetChangeProtection;
  ...
  late final Output<List<FirewallSubnetMapping>?> subnetMappings;
  ...
  late final Output<String> transitGatewayOwnerAccountId;
