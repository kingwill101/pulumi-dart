...
class FirewallTransitGatewayAttachmentAccepterTimeouts {
  ...
  factory FirewallTransitGatewayAttachmentAccepterTimeouts.fromMap(
      Map<String, dynamic> map) {
    return FirewallTransitGatewayAttachmentAccepterTimeouts(
