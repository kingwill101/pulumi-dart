...
/// ## Import
///
/// Using `pulumi import`, import Network Firewall Logging Configurations using the <span pulumi-lang-nodejs="`firewallArn`" pulumi-lang-dotnet="`FirewallArn`" pulumi-lang-go="`firewallArn`" pulumi-lang-python="`firewall_arn`" pulumi-lang-yaml="`firewallArn`" pulumi-lang-java="`firewallArn`">`firewall_arn`</span>. For example:
///
/// ```sh
