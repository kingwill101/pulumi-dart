...
class ApplicationApplicationinsightsArgs {
  ...
  ApplicationApplicationinsightsArgs({
  ...
  factory ApplicationApplicationinsightsArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationApplicationinsightsArgs(
      autoConfigEnabled:
          pulumi.Input.asOptionalInput<bool>(map['autoConfigEnabled']),
      autoCreate: pulumi.Input.asOptionalInput<bool>(map['autoCreate']),
      cweMonitorEnabled:
          pulumi.Input.asOptionalInput<bool>(map['cweMonitorEnabled']),
      groupingType: pulumi.Input.asOptionalInput<String>(map['groupingType']),
      opsCenterEnabled:
          pulumi.Input.asOptionalInput<bool>(map['opsCenterEnabled']),
      opsItemSnsTopicArn:
          pulumi.Input.asOptionalInput<String>(map['opsItemSnsTopicArn']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      resourceGroupName: pulumi.Input.asInput<String>(map['resourceGroupName']),
