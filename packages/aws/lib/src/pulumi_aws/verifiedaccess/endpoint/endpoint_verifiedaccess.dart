...
import 'endpoint_verifiedaccess_args.dart';
...
/// ```
class EndpointVerifiedaccess extends pulumi.CustomResource {
  ...
  EndpointVerifiedaccess(
    String name, {
    EndpointVerifiedaccessArgs? args,
