...
/// ## Import
///
/// Using `pulumi import`, import Verified Access Instance Trust Provider Attachments using the <span pulumi-lang-nodejs="`verifiedaccessInstanceId`" pulumi-lang-dotnet="`VerifiedaccessInstanceId`" pulumi-lang-go="`verifiedaccessInstanceId`" pulumi-lang-python="`verifiedaccess_instance_id`" pulumi-lang-yaml="`verifiedaccessInstanceId`" pulumi-lang-java="`verifiedaccessInstanceId`">`verifiedaccess_instance_id`</span> and <span pulumi-lang-nodejs="`verifiedaccessTrustProviderId`" pulumi-lang-dotnet="`VerifiedaccessTrustProviderId`" pulumi-lang-go="`verifiedaccessTrustProviderId`" pulumi-lang-python="`verifiedaccess_trust_provider_id`" pulumi-lang-yaml="`verifiedaccessTrustProviderId`" pulumi-lang-java="`verifiedaccessTrustProviderId`">`verifiedaccess_trust_provider_id`</span> separated by a forward slash (`/`). For example:
///
/// ```sh
