...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.storagegateway.Cache`" pulumi-lang-dotnet="`aws.storagegateway.Cache`" pulumi-lang-go="`storagegateway.Cache`" pulumi-lang-python="`storagegateway.Cache`" pulumi-lang-yaml="`aws.storagegateway.Cache`" pulumi-lang-java="`aws.storagegateway.Cache`">`aws.storagegateway.Cache`</span> using the gateway Amazon Resource Name (ARN) and local disk identifier separated with a colon (`:`). For example:
///
/// ```sh
