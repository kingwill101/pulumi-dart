...
class GatewayStoragegatewayArgs {
  ...
  factory GatewayStoragegatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayStoragegatewayArgs(
      activationKey: pulumi.Input.asOptionalInput<String>(map['activationKey']),
      averageDownloadRateLimitInBitsPerSec: pulumi.Input.asOptionalInput<int>(
          map['averageDownloadRateLimitInBitsPerSec']),
      ...
      gatewayIpAddress:
          pulumi.Input.asOptionalInput<String>(map['gatewayIpAddress']),
      gatewayName: pulumi.Input.asInput<String>(map['gatewayName']),
      gatewayTimezone: pulumi.Input.asInput<String>(map['gatewayTimezone']),
      gatewayType: pulumi.Input.asOptionalInput<String>(map['gatewayType']),
      gatewayVpcEndpoint:
          pulumi.Input.asOptionalInput<String>(map['gatewayVpcEndpoint']),
      maintenanceStartTime:
          pulumi.Input.asOptionalInput<GatewayMaintenanceStartTime>(
              map['maintenanceStartTime']),
      mediumChangerType:
          pulumi.Input.asOptionalInput<String>(map['mediumChangerType']),
      ...
      smbFileShareVisibility:
          pulumi.Input.asOptionalInput<bool>(map['smbFileShareVisibility']),
      smbGuestPassword:
          pulumi.Input.asOptionalInput<String>(map['smbGuestPassword']),
      smbSecurityStrategy:
          pulumi.Input.asOptionalInput<String>(map['smbSecurityStrategy']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      tapeDriveType: pulumi.Input.asOptionalInput<String>(map['tapeDriveType']),
    );
  }
}
