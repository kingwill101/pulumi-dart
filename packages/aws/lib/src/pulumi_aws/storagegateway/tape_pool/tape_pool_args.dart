  ...
  factory TapePoolArgs.fromMap(Map<String, dynamic> map) {
    return TapePoolArgs(
      ...
      retentionLockTimeInDays:
          pulumi.Input.asOptionalInput<int>(map['retentionLockTimeInDays']),
      retentionLockType:
          pulumi.Input.asOptionalInput<String>(map['retentionLockType']),
      storageClass: pulumi.Input.asInput<String>(map['storageClass']),
