...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.storagegateway.FileSystemAssociation`" pulumi-lang-dotnet="`aws.storagegateway.FileSystemAssociation`" pulumi-lang-go="`storagegateway.FileSystemAssociation`" pulumi-lang-python="`storagegateway.FileSystemAssociation`" pulumi-lang-yaml="`aws.storagegateway.FileSystemAssociation`" pulumi-lang-java="`aws.storagegateway.FileSystemAssociation`">`aws.storagegateway.FileSystemAssociation`</span> using the FSx file system association Amazon Resource Name (ARN). For example:
///
/// ```sh
