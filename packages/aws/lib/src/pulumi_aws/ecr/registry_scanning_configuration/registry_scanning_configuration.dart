...
/// ## Import
///
/// Using `pulumi import`, import ECR Scanning Configurations using the <span pulumi-lang-nodejs="`registryId`" pulumi-lang-dotnet="`RegistryId`" pulumi-lang-go="`registryId`" pulumi-lang-python="`registry_id`" pulumi-lang-yaml="`registryId`" pulumi-lang-java="`registryId`">`registry_id`</span>. For example:
///
/// ```sh
