...
class GetAuthorizationTokenResult2 {
  ...
  factory GetAuthorizationTokenResult2.fromMap(Map<String, dynamic> map) {
    return GetAuthorizationTokenResult2(
