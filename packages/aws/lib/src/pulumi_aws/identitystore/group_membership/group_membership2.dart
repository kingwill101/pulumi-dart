...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.identitystore.GroupMembership`" pulumi-lang-dotnet="`aws.identitystore.GroupMembership`" pulumi-lang-go="`identitystore.GroupMembership`" pulumi-lang-python="`identitystore.GroupMembership`" pulumi-lang-yaml="`aws.identitystore.GroupMembership`" pulumi-lang-java="`aws.identitystore.GroupMembership`">`aws.identitystore.GroupMembership`</span> using the `identity_store_id/membership_id`. For example:
///
/// ```sh
