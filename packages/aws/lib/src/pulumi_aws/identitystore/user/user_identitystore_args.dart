...
class UserIdentitystoreArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (addressesValue != null) {
      map['addresses'] = pulumi.Input.mapOptionalInputValue<UserAddresses,
          Map<String, dynamic>>(addressesValue, (value) => value.toMap());
    }
    ...
    if (phoneNumbersValue != null) {
      map['phoneNumbers'] = pulumi.Input.mapOptionalInputValue<UserPhoneNumbers,
          Map<String, dynamic>>(phoneNumbersValue, (value) => value.toMap());
    }
  ...
  factory UserIdentitystoreArgs.fromMap(Map<String, dynamic> map) {
    return UserIdentitystoreArgs(
      addresses: pulumi.Input.asOptionalInput<UserAddresses>(map['addresses']),
      displayName: pulumi.Input.asInput<String>(map['displayName']),
      emails: pulumi.Input.asOptionalInput<UserEmails>(map['emails']),
      identityStoreId: pulumi.Input.asInput<String>(map['identityStoreId']),
      locale: pulumi.Input.asOptionalInput<String>(map['locale']),
      name: pulumi.Input.asOptionalInput<UserName>(map['name']),
      nickname: pulumi.Input.asOptionalInput<String>(map['nickname']),
      phoneNumbers:
          pulumi.Input.asOptionalInput<UserPhoneNumbers>(map['phoneNumbers']),
      preferredLanguage:
          pulumi.Input.asOptionalInput<String>(map['preferredLanguage']),
      profileUrl: pulumi.Input.asOptionalInput<String>(map['profileUrl']),
