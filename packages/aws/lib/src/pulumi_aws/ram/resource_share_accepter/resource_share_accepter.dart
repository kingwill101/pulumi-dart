...
/// Manage accepting a Resource Access Manager (RAM) Resource Share invitation. From a _receiver_ AWS account, accept an invitation to share resources that were shared by a _sender_ AWS account. To create a resource share in the _sender_, see the <span pulumi-lang-nodejs="`aws.ram.ResourceShare`" pulumi-lang-dotnet="`aws.ram.ResourceShare`" pulumi-lang-go="`ram.ResourceShare`" pulumi-lang-python="`ram.ResourceShare`" pulumi-lang-yaml="`aws.ram.ResourceShare`" pulumi-lang-java="`aws.ram.ResourceShare`">`aws.ram.ResourceShare`</span> resource.
///
/// > **Note:** If both AWS accounts are in the same Organization and [RAM Sharing with AWS Organizations is enabled](https://docs.aws.amazon.com/ram/latest/userguide/getting-started-sharing.html#getting-started-sharing-orgs), this resource is not necessary as RAM Resource Share invitations are not used.
///
/// ## Example Usage
///
/// This configuration provides an example of using multiple AWS providers to configure two different AWS accounts. In the _sender_ account, the configuration creates a <span pulumi-lang-nodejs="`aws.ram.ResourceShare`" pulumi-lang-dotnet="`aws.ram.ResourceShare`" pulumi-lang-go="`ram.ResourceShare`" pulumi-lang-python="`ram.ResourceShare`" pulumi-lang-yaml="`aws.ram.ResourceShare`" pulumi-lang-java="`aws.ram.ResourceShare`">`aws.ram.ResourceShare`</span> and uses a data source in the _receiver_ account to create a <span pulumi-lang-nodejs="`aws.ram.PrincipalAssociation`" pulumi-lang-dotnet="`aws.ram.PrincipalAssociation`" pulumi-lang-go="`ram.PrincipalAssociation`" pulumi-lang-python="`ram.PrincipalAssociation`" pulumi-lang-yaml="`aws.ram.PrincipalAssociation`" pulumi-lang-java="`aws.ram.PrincipalAssociation`">`aws.ram.PrincipalAssociation`</span> resource with the _receiver's_ account ID. In the _receiver_ account, the configuration accepts the invitation to share resources with the <span pulumi-lang-nodejs="`aws.ram.ResourceShareAccepter`" pulumi-lang-dotnet="`aws.ram.ResourceShareAccepter`" pulumi-lang-go="`ram.ResourceShareAccepter`" pulumi-lang-python="`ram.ResourceShareAccepter`" pulumi-lang-yaml="`aws.ram.ResourceShareAccepter`" pulumi-lang-java="`aws.ram.ResourceShareAccepter`">`aws.ram.ResourceShareAccepter`</span>.
///
