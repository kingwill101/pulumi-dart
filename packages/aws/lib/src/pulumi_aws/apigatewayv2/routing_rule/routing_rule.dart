...
/// ## Import
///
/// Using `pulumi import`, import API Gateway V2 Routing Rule using the <span pulumi-lang-nodejs="`routingRuleArn`" pulumi-lang-dotnet="`RoutingRuleArn`" pulumi-lang-go="`routingRuleArn`" pulumi-lang-python="`routing_rule_arn`" pulumi-lang-yaml="`routingRuleArn`" pulumi-lang-java="`routingRuleArn`">`routing_rule_arn`</span>. For example:
///
/// ```sh
...
class RoutingRule extends CustomResource {
  ...
  late final Output<List<RoutingRuleAction>> actions;

  /// Conditions configuration. See below.
  late final Output<List<RoutingRuleCondition>> conditions;
  ...
  late final Output<String> routingRuleArn;

  /// ID of the Routing Rule.
  late final Output<String> routingRuleId;
