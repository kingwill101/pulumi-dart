...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigatewayv2.Route`" pulumi-lang-dotnet="`aws.apigatewayv2.Route`" pulumi-lang-go="`apigatewayv2.Route`" pulumi-lang-python="`apigatewayv2.Route`" pulumi-lang-yaml="`aws.apigatewayv2.Route`" pulumi-lang-java="`aws.apigatewayv2.Route`">`aws.apigatewayv2.Route`</span> using the API identifier and route identifier. For example:
///
/// ```sh
