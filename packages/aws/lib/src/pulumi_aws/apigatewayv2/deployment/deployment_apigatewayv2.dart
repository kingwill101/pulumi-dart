...
import 'deployment_apigatewayv2_args.dart';
...
class DeploymentApigatewayv2 extends pulumi.CustomResource {
  /// API identifier.
  ...
  DeploymentApigatewayv2(
    String name, {
    DeploymentApigatewayv2Args? args,
