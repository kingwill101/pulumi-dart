...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.apigatewayv2.Model`" pulumi-lang-dotnet="`aws.apigatewayv2.Model`" pulumi-lang-go="`apigatewayv2.Model`" pulumi-lang-python="`apigatewayv2.Model`" pulumi-lang-yaml="`aws.apigatewayv2.Model`" pulumi-lang-java="`aws.apigatewayv2.Model`">`aws.apigatewayv2.Model`</span> using the API identifier and model identifier. For example:
///
/// ```sh
