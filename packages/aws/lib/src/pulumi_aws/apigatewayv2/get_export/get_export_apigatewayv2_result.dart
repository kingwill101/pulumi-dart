...
class GetExportApigatewayv2Result {
  final String apiId;
  ...
  factory GetExportApigatewayv2Result.fromMap(Map<String, dynamic> map) {
    return GetExportApigatewayv2Result(
