...
class ApiArgs {
  ...
  factory ApiArgs.fromMap(Map<String, dynamic> map) {
    return ApiArgs(
      ...
      routeKey: pulumi.Input.asOptionalInput<String>(map['routeKey']),
      routeSelectionExpression:
          pulumi.Input.asOptionalInput<String>(map['routeSelectionExpression']),
