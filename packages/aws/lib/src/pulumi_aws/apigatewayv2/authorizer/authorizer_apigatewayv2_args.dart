...
class AuthorizerApigatewayv2Args {
  /// API identifier.
  ...
  factory AuthorizerApigatewayv2Args.fromMap(Map<String, dynamic> map) {
    return AuthorizerApigatewayv2Args(
      apiId: pulumi.Input.asInput<String>(map['apiId']),
      authorizerCredentialsArn:
          pulumi.Input.asOptionalInput<String>(map['authorizerCredentialsArn']),
      ...
      enableSimpleResponses:
          pulumi.Input.asOptionalInput<bool>(map['enableSimpleResponses']),
      identitySources:
          pulumi.Input.asOptionalInput<List<String>>(map['identitySources']),
      jwtConfiguration:
