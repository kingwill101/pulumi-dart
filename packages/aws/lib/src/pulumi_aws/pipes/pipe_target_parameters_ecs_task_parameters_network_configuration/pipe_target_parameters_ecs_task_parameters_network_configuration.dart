...
import '../pipe_target_parameters_ecs_task_parameters_network_configuration_aws_vpc_configuration/pipe_target_parameters_ecs_task_parameters_network_configuration_aws_vpc_configuration.dart';
...
class PipeTargetParametersEcsTaskParametersNetworkConfiguration {
  ...
  Map<String, dynamic> toMap() {
    ...
    final awsVpcConfigurationValue = awsVpcConfiguration;
    if (awsVpcConfigurationValue != null) {
      map['awsVpcConfiguration'] = awsVpcConfigurationValue.toMap();
    }
    return map;
  }
