...
import '../pipe_target_parameters_batch_job_parameters_retry_strategy/pipe_target_parameters_batch_job_parameters_retry_strategy.dart';
...
class PipeTargetParametersBatchJobParameters {
  ...
  final PipeTargetParametersBatchJobParametersContainerOverrides?
      containerOverrides;
  ...
  Map<String, dynamic> toMap() {
    ...
    final arrayPropertiesValue = arrayProperties;
    if (arrayPropertiesValue != null) {
      map['arrayProperties'] = arrayPropertiesValue.toMap();
    }
    final containerOverridesValue = containerOverrides;
    if (containerOverridesValue != null) {
      map['containerOverrides'] = containerOverridesValue.toMap();
    }
    ...
    if (retryStrategyValue != null) {
      map['retryStrategy'] = retryStrategyValue.toMap();
    }
    return map;
  }

  factory PipeTargetParametersBatchJobParameters.fromMap(
      Map<String, dynamic> map) {
    return PipeTargetParametersBatchJobParameters(
      arrayProperties: map['arrayProperties'] == null
          ? null
          : PipeTargetParametersBatchJobParametersArrayProperties.fromMap(
              (map['arrayProperties'] as Map).cast<String, dynamic>()),
      containerOverrides: map['containerOverrides'] == null
          ? null
          : PipeTargetParametersBatchJobParametersContainerOverrides.fromMap(
      ...
      retryStrategy: map['retryStrategy'] == null
          ? null
          : PipeTargetParametersBatchJobParametersRetryStrategy.fromMap(
