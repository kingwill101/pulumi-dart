...
class FleetRuntimeConfiguration {
  ...
  Map<String, dynamic> toMap() {
    ...
    final gameSessionActivationTimeoutSecondsValue =
        gameSessionActivationTimeoutSeconds;
    if (gameSessionActivationTimeoutSecondsValue != null) {
      map['gameSessionActivationTimeoutSeconds'] =
          gameSessionActivationTimeoutSecondsValue;
    }
    final maxConcurrentGameSessionActivationsValue =
        maxConcurrentGameSessionActivations;
    if (maxConcurrentGameSessionActivationsValue != null) {
      map['maxConcurrentGameSessionActivations'] =
          maxConcurrentGameSessionActivationsValue;
    }
