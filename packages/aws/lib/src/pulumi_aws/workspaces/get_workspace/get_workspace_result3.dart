...
class GetWorkspaceResult3 {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['workspaceProperties'] =
        Input.encodeList<GetWorkspaceWorkspaceProperty, Map<String, dynamic>>(
            workspaceProperties, (value) => value.toMap());
    return map;
  }

  factory GetWorkspaceResult3.fromMap(Map<String, dynamic> map) {
    return GetWorkspaceResult3(
      ...
      workspaceProperties: Input.decodeList<GetWorkspaceWorkspaceProperty>(
          map['workspaceProperties'],
