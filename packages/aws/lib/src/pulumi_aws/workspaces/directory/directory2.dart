...
/// ```
class Directory2 extends CustomResource {
  ...
  late final Output<DirectoryActiveDirectoryConfig?> activeDirectoryConfig;
  ...
  late final Output<DirectoryCertificateBasedAuthProperties>
      certificateBasedAuthProperties;

  /// The user name for the service account.
  late final Output<String> customerUserName;
  ...
  /// The directory type.
  late final Output<String> directoryType;

  /// The IP addresses of the DNS servers for the directory.
  late final Output<List<String>> dnsIpAddresses;

  /// The identifier of the IAM role. This is the role that allows Amazon WorkSpaces to make calls to other services, such as Amazon EC2, on your behalf.
  late final Output<String> iamRoleId;

  /// The identifiers of the IP access control groups associated with the directory.
  late final Output<List<String>> ipGroupIds;

  /// Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
  late final Output<String> region;

  /// The registration code for the directory. This is the code that users enter in their Amazon WorkSpaces client application to connect to the directory.
  late final Output<String> registrationCode;

  /// Configuration of SAML authentication integration. Defined below.
  late final Output<DirectorySamlProperties> samlProperties;
  ...
  late final Output<DirectorySelfServicePermissions> selfServicePermissions;
  ...
  late final Output<String> userIdentityType;

  /// Specifies which devices and operating systems users can use to access their WorkSpaces. Defined below.
  late final Output<DirectoryWorkspaceAccessProperties>
      workspaceAccessProperties;

  /// Default properties that are used for creating WorkSpaces. Defined below.
  late final Output<DirectoryWorkspaceCreationProperties>
      workspaceCreationProperties;
  ...
  late final Output<String?> workspaceDirectoryDescription;
  ...
  late final Output<String?> workspaceDirectoryName;
  ...
  late final Output<String?> workspaceType;
