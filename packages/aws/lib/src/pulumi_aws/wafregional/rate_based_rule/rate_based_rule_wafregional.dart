...
import 'rate_based_rule_wafregional_args.dart';
...
/// ```
class RateBasedRuleWafregional extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RateBasedRulePredicateWafregional>?> predicates;
  ...
  RateBasedRuleWafregional(
    String name, {
    RateBasedRuleWafregionalArgs? args,
    ...
    this.predicates =
        registerOutput<List<RateBasedRulePredicateWafregional>?>('predicates');
