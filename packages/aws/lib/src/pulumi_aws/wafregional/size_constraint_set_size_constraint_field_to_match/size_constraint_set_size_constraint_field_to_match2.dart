...
class SizeConstraintSetSizeConstraintFieldToMatch2 {
  ...
  SizeConstraintSetSizeConstraintFieldToMatch2({
    this.data,
    required this.type,
  });
  ...
  factory SizeConstraintSetSizeConstraintFieldToMatch2.fromMap(
      Map<String, dynamic> map) {
    return SizeConstraintSetSizeConstraintFieldToMatch2(
