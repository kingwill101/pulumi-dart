...
import '../byte_match_set_byte_match_tuple_field_to_match/byte_match_set_byte_match_tuple_field_to_match_wafregional.dart';

class ByteMatchSetByteMatchTupleWafregional {
  /// Settings for the ByteMatchTuple. FieldToMatch documented below.
  final ByteMatchSetByteMatchTupleFieldToMatchWafregional fieldToMatch;
  ...
  factory ByteMatchSetByteMatchTupleWafregional.fromMap(
      Map<String, dynamic> map) {
    return ByteMatchSetByteMatchTupleWafregional(
      fieldToMatch: ByteMatchSetByteMatchTupleFieldToMatchWafregional.fromMap(
