...
import 'size_constraint_set_wafregional_args.dart';
...
/// ```
class SizeConstraintSetWafregional extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SizeConstraintSetSizeConstraintWafregional>?>
      sizeConstraints;

  SizeConstraintSetWafregional(
    String name, {
    SizeConstraintSetWafregionalArgs? args,
    ...
    this.sizeConstraints =
        registerOutput<List<SizeConstraintSetSizeConstraintWafregional>?>(
            'sizeConstraints');
  }
}
