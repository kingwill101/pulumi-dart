...
import '../size_constraint_set_size_constraint_field_to_match/size_constraint_set_size_constraint_field_to_match_wafregional.dart';

class SizeConstraintSetSizeConstraintWafregional {
  ...
  final SizeConstraintSetSizeConstraintFieldToMatchWafregional fieldToMatch;
  ...
  factory SizeConstraintSetSizeConstraintWafregional.fromMap(
      Map<String, dynamic> map) {
    return SizeConstraintSetSizeConstraintWafregional(
      comparisonOperator: map['comparisonOperator'] as String,
      fieldToMatch:
          SizeConstraintSetSizeConstraintFieldToMatchWafregional.fromMap(
