...
import '../regex_match_set_regex_match_tuple_field_to_match/regex_match_set_regex_match_tuple_field_to_match_wafregional.dart';

class RegexMatchSetRegexMatchTupleWafregional {
  /// The part of a web request that you want to search, such as a specified header or a query string.
  final RegexMatchSetRegexMatchTupleFieldToMatchWafregional fieldToMatch;
  ...
  factory RegexMatchSetRegexMatchTupleWafregional.fromMap(
      Map<String, dynamic> map) {
    return RegexMatchSetRegexMatchTupleWafregional(
      fieldToMatch: RegexMatchSetRegexMatchTupleFieldToMatchWafregional.fromMap(
