...
class PlatformApplicationArgs {
  ...
  final Input<String>? applePlatformBundleId;

  /// The identifier that's assigned to your Apple developer account team. Must be 10 alphanumeric characters.
  final Input<String>? applePlatformTeamId;

  /// The ARN of the SNS Topic triggered when a delivery to any of the platform endpoints associated with your platform application encounters a permanent failure.
  final Input<String>? eventDeliveryFailureTopicArn;

  /// The ARN of the SNS Topic triggered when a new platform endpoint is added to your platform application.
  final Input<String>? eventEndpointCreatedTopicArn;

  /// The ARN of the SNS Topic triggered when an existing platform endpoint is deleted from your platform application.
  final Input<String>? eventEndpointDeletedTopicArn;

  /// The ARN of the SNS Topic triggered when an existing platform endpoint is changed from your platform application.
  final Input<String>? eventEndpointUpdatedTopicArn;

  /// The IAM role ARN permitted to receive failure feedback for this application and give SNS write access to use CloudWatch logs on your behalf.
  final Input<String>? failureFeedbackRoleArn;
  ...
  factory PlatformApplicationArgs.fromMap(Map<String, dynamic> map) {
    return PlatformApplicationArgs(
      applePlatformBundleId:
          Input.asOptionalInput<String>(map['applePlatformBundleId']),
      applePlatformTeamId:
          Input.asOptionalInput<String>(map['applePlatformTeamId']),
      eventDeliveryFailureTopicArn:
          Input.asOptionalInput<String>(map['eventDeliveryFailureTopicArn']),
      eventEndpointCreatedTopicArn:
          Input.asOptionalInput<String>(map['eventEndpointCreatedTopicArn']),
      eventEndpointDeletedTopicArn:
          Input.asOptionalInput<String>(map['eventEndpointDeletedTopicArn']),
      eventEndpointUpdatedTopicArn:
          Input.asOptionalInput<String>(map['eventEndpointUpdatedTopicArn']),
      failureFeedbackRoleArn:
          Input.asOptionalInput<String>(map['failureFeedbackRoleArn']),
      name: Input.asOptionalInput<String>(map['name']),
      platform: Input.asInput<String>(map['platform']),
      platformCredential: Input.asInput<String>(map['platformCredential']),
      platformPrincipal:
          Input.asOptionalInput<String>(map['platformPrincipal']),
      region: Input.asOptionalInput<String>(map['region']),
      successFeedbackRoleArn:
          Input.asOptionalInput<String>(map['successFeedbackRoleArn']),
      successFeedbackSampleRate:
          Input.asOptionalInput<String>(map['successFeedbackSampleRate']),
    );
  }
}
