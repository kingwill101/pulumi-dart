...
/// ## Import
///
/// Using `pulumi import`, import Verified Permissions Policy Store Schema using the <span pulumi-lang-nodejs="`policyStoreId`" pulumi-lang-dotnet="`PolicyStoreId`" pulumi-lang-go="`policyStoreId`" pulumi-lang-python="`policy_store_id`" pulumi-lang-yaml="`policyStoreId`" pulumi-lang-java="`policyStoreId`">`policy_store_id`</span>. For example:
///
/// ```sh
