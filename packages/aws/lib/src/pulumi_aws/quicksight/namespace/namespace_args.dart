...
class NamespaceArgs {
  ...
  final Input<String>? identityStore;
  ...
  final Input<NamespaceTimeouts>? timeouts;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (timeoutsValue != null) {
      map['timeouts'] =
          Input.mapOptionalInputValue<NamespaceTimeouts, Map<String, dynamic>>(
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      identityStore: Input.asOptionalInput<String>(map['identityStore']),
      namespace: Input.asInput<String>(map['namespace']),
      region: Input.asOptionalInput<String>(map['region']),
      tags: Input.asOptionalInput<Map<String, String>>(map['tags']),
      timeouts: Input.asOptionalInput<NamespaceTimeouts>(map['timeouts']),
    );
  }
}
