...
///
/// ### With<span pulumi-lang-nodejs=" useAs
/// " pulumi-lang-dotnet=" UseAs
/// " pulumi-lang-go=" useAs
/// " pulumi-lang-python=" use_as
/// " pulumi-lang-yaml=" useAs
/// " pulumi-lang-java=" useAs
/// "> use_as
/// </span>
/// <!--Start PulumiCodeChooser -->
/// ```typescript
...
class DataSet2 extends CustomResource {
  ...
  /// The final set of columns available for use in analyses and dashboards after all data preparation and transformation steps have been applied within the data set.  See <span pulumi-lang-nodejs="`outputColumns`" pulumi-lang-dotnet="`OutputColumns`" pulumi-lang-go="`outputColumns`" pulumi-lang-python="`output_columns`" pulumi-lang-yaml="`outputColumns`" pulumi-lang-java="`outputColumns`">`output_columns`</span> Block below.
