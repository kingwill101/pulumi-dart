...
class DataSetQuicksightArgs {
  ...
  factory DataSetQuicksightArgs.fromMap(Map<String, dynamic> map) {
    return DataSetQuicksightArgs(
      ...
      fieldFolders: pulumi.Input.asOptionalInput<List<DataSetFieldFolder>>(
          map['fieldFolders']),
      importMode: pulumi.Input.asInput<String>(map['importMode']),
      logicalTableMaps:
      ...
      refreshProperties: pulumi.Input.asOptionalInput<DataSetRefreshProperties>(
      ...
      useAs: pulumi.Input.asOptionalInput<String>(map['useAs']),
    );
  }
}
