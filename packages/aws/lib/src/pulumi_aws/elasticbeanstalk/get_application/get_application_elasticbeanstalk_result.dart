...
class GetApplicationElasticbeanstalkResult {
  ...
  GetApplicationElasticbeanstalkResult({
  ...
  factory GetApplicationElasticbeanstalkResult.fromMap(
      Map<String, dynamic> map) {
    return GetApplicationElasticbeanstalkResult(
