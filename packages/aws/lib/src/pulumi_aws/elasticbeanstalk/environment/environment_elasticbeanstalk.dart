...
import 'environment_elasticbeanstalk_args.dart';
...
/// ```
class EnvironmentElasticbeanstalk extends pulumi.CustomResource {
  ...
  EnvironmentElasticbeanstalk(
    String name, {
    EnvironmentElasticbeanstalkArgs? args,
