...
class TeamsChannelConfigurationArgs {
  ...
  final Input<String>? channelName;
  ...
  final Input<String>? teamName;

  /// ID of the Microsoft Teams tenant.
  ///
  /// The following arguments are optional:
  final Input<String> tenantId;
  final Input<TeamsChannelConfigurationTimeouts>? timeouts;
  ...
  factory TeamsChannelConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return TeamsChannelConfigurationArgs(
      ...
      channelName: Input.asOptionalInput<String>(map['channelName']),
      ...
      teamId: Input.asInput<String>(map['teamId']),
      teamName: Input.asOptionalInput<String>(map['teamName']),
      tenantId: Input.asInput<String>(map['tenantId']),
      timeouts: Input.asOptionalInput<TeamsChannelConfigurationTimeouts>(
          map['timeouts']),
