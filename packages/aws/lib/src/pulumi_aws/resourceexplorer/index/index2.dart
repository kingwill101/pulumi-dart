...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the Resource Explorer index.
///
///
/// Using `pulumi import`, import Resource Explorer indexes using the <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
...
class Index2 extends CustomResource {
  ...
  late final Output<IndexTimeouts?> timeouts;
  ...
  Index2(
    ...
    this.timeouts = Output.createUnknown<IndexTimeouts?>();
