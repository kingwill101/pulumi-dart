...
class ResourcePolicyXrayArgs {
  ...
  factory ResourcePolicyXrayArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyXrayArgs(
      bypassPolicyLockoutCheck:
          pulumi.Input.asOptionalInput<bool>(map['bypassPolicyLockoutCheck']),
      policyDocument: pulumi.Input.asInput<String>(map['policyDocument']),
      policyName: pulumi.Input.asInput<String>(map['policyName']),
      policyRevisionId:
          pulumi.Input.asOptionalInput<String>(map['policyRevisionId']),
