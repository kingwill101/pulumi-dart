...
import '../capacity_provider_managed_instances_provider_instance_launch_template_instance_requirements/capacity_provider_managed_instances_provider_instance_launch_template_instance_requirements.dart';
import '../capacity_provider_managed_instances_provider_instance_launch_template_network_configuration/capacity_provider_managed_instances_provider_instance_launch_template_network_configuration.dart';
import '../capacity_provider_managed_instances_provider_instance_launch_template_storage_configuration/capacity_provider_managed_instances_provider_instance_launch_template_storage_configuration.dart';
...
class CapacityProviderManagedInstancesProviderInstanceLaunchTemplate {
  ...
  Map<String, dynamic> toMap() {
    ...
    final capacityOptionTypeValue = capacityOptionType;
    if (capacityOptionTypeValue != null) {
      map['capacityOptionType'] = capacityOptionTypeValue;
    }
    map['ec2InstanceProfileArn'] = ec2InstanceProfileArn;
    ...
    map['networkConfiguration'] = networkConfiguration.toMap();
    final storageConfigurationValue = storageConfiguration;
    if (storageConfigurationValue != null) {
      map['storageConfiguration'] = storageConfigurationValue.toMap();
    }
    return map;
  }
  ...
  factory CapacityProviderManagedInstancesProviderInstanceLaunchTemplate.fromMap(
    ...
    return CapacityProviderManagedInstancesProviderInstanceLaunchTemplate(
      ...
      monitoring:
          map['monitoring'] == null ? null : map['monitoring'] as String,
      networkConfiguration:
