...
/// ```
class ServiceEcs extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ServiceNetworkConfigurationEcs?>
  ...
  ServiceEcs(
    ...
    this.networkConfiguration =
        registerOutput<ServiceNetworkConfigurationEcs?>('networkConfiguration');
