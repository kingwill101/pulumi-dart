...
class GetClusterEcsResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['serviceConnectDefaults'] = pulumi.Input.encodeList<
        GetClusterServiceConnectDefault,
        Map<String, dynamic>>(serviceConnectDefaults, (value) => value.toMap());
    map['settings'] =
  ...
  factory GetClusterEcsResult.fromMap(Map<String, dynamic> map) {
    return GetClusterEcsResult(
