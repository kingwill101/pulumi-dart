...
class ServiceNetworkConfiguration2 {
  ...
  factory ServiceNetworkConfiguration2.fromMap(Map<String, dynamic> map) {
    return ServiceNetworkConfiguration2(
      assignPublicIp:
