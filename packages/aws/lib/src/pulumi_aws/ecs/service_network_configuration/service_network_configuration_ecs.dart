...
class ServiceNetworkConfigurationEcs {
  ...
  ServiceNetworkConfigurationEcs({
    this.assignPublicIp,
    this.securityGroups,
  ...
  factory ServiceNetworkConfigurationEcs.fromMap(Map<String, dynamic> map) {
    return ServiceNetworkConfigurationEcs(
      assignPublicIp:
