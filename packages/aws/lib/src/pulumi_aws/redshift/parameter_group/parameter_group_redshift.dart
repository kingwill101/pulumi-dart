...
import 'parameter_group_redshift_args.dart';
...
/// ```
class ParameterGroupRedshift extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ParameterGroupParameterRedshift>?> parameters;
  ...
  ParameterGroupRedshift(
    String name, {
    ParameterGroupRedshiftArgs? args,
    ...
    this.parameters =
        registerOutput<List<ParameterGroupParameterRedshift>?>('parameters');
