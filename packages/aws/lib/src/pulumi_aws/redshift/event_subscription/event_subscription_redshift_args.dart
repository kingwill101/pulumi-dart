...
class EventSubscriptionRedshiftArgs {
  ...
  factory EventSubscriptionRedshiftArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionRedshiftArgs(
      enabled: pulumi.Input.asOptionalInput<bool>(map['enabled']),
      eventCategories:
          pulumi.Input.asOptionalInput<List<String>>(map['eventCategories']),
