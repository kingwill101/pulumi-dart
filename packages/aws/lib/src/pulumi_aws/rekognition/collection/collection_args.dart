...
class CollectionArgs {
  ...
  final Input<CollectionTimeouts>? timeouts;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (timeoutsValue != null) {
      map['timeouts'] =
          Input.mapOptionalInputValue<CollectionTimeouts, Map<String, dynamic>>(
  ...
  factory CollectionArgs.fromMap(Map<String, dynamic> map) {
    return CollectionArgs(
      ...
      timeouts: Input.asOptionalInput<CollectionTimeouts>(map['timeouts']),
    );
  }
}
