...
import '../get_job_definition_eks_property_pod_property_init_container_volume_mount/get_job_definition_eks_property_pod_property_init_container_volume_mount.dart';
...
class GetJobDefinitionEksPropertyPodPropertyInitContainer {
  ...
  final List<GetJobDefinitionEksPropertyPodPropertyInitContainerResource>
      resources;

  /// The security context for a job.
  final List<GetJobDefinitionEksPropertyPodPropertyInitContainerSecurityContext>
      securityContexts;

  /// The volume mounts for the container.
  final List<GetJobDefinitionEksPropertyPodPropertyInitContainerVolumeMount>
      volumeMounts;
