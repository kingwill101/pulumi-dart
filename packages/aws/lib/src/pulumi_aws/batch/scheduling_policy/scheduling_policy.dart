...
/// ## Import
///
/// Using `pulumi import`, import Batch Scheduling Policy using the <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
...
class SchedulingPolicy extends CustomResource {
  ...
  SchedulingPolicy(
    ...
    this.fairSharePolicy =
        Output.createUnknown<SchedulingPolicyFairSharePolicy?>();
