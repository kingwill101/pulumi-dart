...
class JobDefinitionArgs {
  ...
  factory JobDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return JobDefinitionArgs(
      containerProperties:
          pulumi.Input.asOptionalInput<String>(map['containerProperties']),
      deregisterOnNewRevision:
          pulumi.Input.asOptionalInput<bool>(map['deregisterOnNewRevision']),
      ecsProperties: pulumi.Input.asOptionalInput<String>(map['ecsProperties']),
      eksProperties: pulumi.Input.asOptionalInput<JobDefinitionEksProperties>(
          map['eksProperties']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      nodeProperties:
          pulumi.Input.asOptionalInput<String>(map['nodeProperties']),
      parameters:
          pulumi.Input.asOptionalInput<Map<String, String>>(map['parameters']),
      platformCapabilities: pulumi.Input.asOptionalInput<List<String>>(
          map['platformCapabilities']),
      propagateTags: pulumi.Input.asOptionalInput<bool>(map['propagateTags']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      retryStrategy: pulumi.Input.asOptionalInput<JobDefinitionRetryStrategy>(
          map['retryStrategy']),
      schedulingPriority:
          pulumi.Input.asOptionalInput<int>(map['schedulingPriority']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      timeout:
          pulumi.Input.asOptionalInput<JobDefinitionTimeout>(map['timeout']),
