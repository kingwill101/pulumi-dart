...
///
/// > **Note:** To prevent a race condition during environment deletion, make sure to set <span pulumi-lang-nodejs="`dependsOn`" pulumi-lang-dotnet="`DependsOn`" pulumi-lang-go="`dependsOn`" pulumi-lang-python="`depends_on`" pulumi-lang-yaml="`dependsOn`" pulumi-lang-java="`dependsOn`">`depends_on`</span> to the related <span pulumi-lang-nodejs="`aws.iam.RolePolicyAttachment`" pulumi-lang-dotnet="`aws.iam.RolePolicyAttachment`" pulumi-lang-go="`iam.RolePolicyAttachment`" pulumi-lang-python="`iam.RolePolicyAttachment`" pulumi-lang-yaml="`aws.iam.RolePolicyAttachment`" pulumi-lang-java="`aws.iam.RolePolicyAttachment`">`aws.iam.RolePolicyAttachment`</span>;
...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the compute environment.
///
///
/// Using `pulumi import`, import AWS Batch compute using the <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`">`name`</span>. For example:
///
/// ```sh
