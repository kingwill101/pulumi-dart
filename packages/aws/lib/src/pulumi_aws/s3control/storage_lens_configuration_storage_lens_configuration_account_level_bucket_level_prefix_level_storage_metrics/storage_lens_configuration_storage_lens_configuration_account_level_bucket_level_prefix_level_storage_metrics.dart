...
import '../storage_lens_configuration_storage_lens_configuration_account_level_bucket_level_prefix_level_storage_metrics_selection_criteria/storage_lens_configuration_storage_lens_configuration_account_level_bucket_level_prefix_level_storage_metrics_selection_criteria.dart';
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetrics {
  ...
  final StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteria?
      selectionCriteria;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (selectionCriteriaValue != null) {
      map['selectionCriteria'] = selectionCriteriaValue.toMap();
    }
    return map;
  }
    ...
    return StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetrics(
      ...
      selectionCriteria: map['selectionCriteria'] == null
          ...
          : StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteria
              .fromMap(
                  (map['selectionCriteria'] as Map).cast<String, dynamic>()),
    );
  }
}
