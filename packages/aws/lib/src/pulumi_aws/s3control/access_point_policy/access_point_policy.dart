...
/// ## Import
///
/// Using `pulumi import`, import Access Point policies using the <span pulumi-lang-nodejs="`accessPointArn`" pulumi-lang-dotnet="`AccessPointArn`" pulumi-lang-go="`accessPointArn`" pulumi-lang-python="`access_point_arn`" pulumi-lang-yaml="`accessPointArn`" pulumi-lang-java="`accessPointArn`">`access_point_arn`</span>. For example:
///
/// ```sh
