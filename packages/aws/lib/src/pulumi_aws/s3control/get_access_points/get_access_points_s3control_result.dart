...
class GetAccessPointsS3controlResult {
  ...
  GetAccessPointsS3controlResult({
  ...
  factory GetAccessPointsS3controlResult.fromMap(Map<String, dynamic> map) {
    return GetAccessPointsS3controlResult(
