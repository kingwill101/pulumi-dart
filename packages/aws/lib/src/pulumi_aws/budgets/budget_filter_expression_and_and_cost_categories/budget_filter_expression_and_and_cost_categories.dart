...
class BudgetFilterExpressionAndAndCostCategories {
  ...
  factory BudgetFilterExpressionAndAndCostCategories.fromMap(
      Map<String, dynamic> map) {
    return BudgetFilterExpressionAndAndCostCategories(
