...
import 'get_connection_args5.dart';
import 'get_connection_result5.dart';
...
/// ```
/// <!--End PulumiCodeChooser -->
Future<GetConnectionResult5> getConnection5(
  GetConnectionArgs5 args, {
  ...
  return GetConnectionResult5.fromMap(result);
}
