...
class GetConnectionVpnResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (filtersValue != null) {
      map['filters'] =
          pulumi.Input.encodeList<GetConnectionFilter, Map<String, dynamic>>(
    ...
    map['region'] = region;
    map['routes'] =
        pulumi.Input.encodeList<GetConnectionRoute, Map<String, dynamic>>(
            routes, (value) => value.toMap());
    map['state'] = state;
    map['tags'] = tags;
    map['transitGatewayId'] = transitGatewayId;
    map['type'] = type;
    map['vgwTelemetries'] = pulumi.Input.encodeList<GetConnectionVgwTelemetry,
  ...
  factory GetConnectionVpnResult.fromMap(Map<String, dynamic> map) {
    return GetConnectionVpnResult(
      ...
      routes: pulumi.Input.decodeList<GetConnectionRoute>(
          map['routes'],
      ...
      vgwTelemetries: pulumi.Input.decodeList<GetConnectionVgwTelemetry>(
          map['vgwTelemetries'],
