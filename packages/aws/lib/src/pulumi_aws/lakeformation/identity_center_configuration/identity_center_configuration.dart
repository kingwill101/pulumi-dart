...
/// ## Import
///
/// Using `pulumi import`, import Lake Formation Identity Center Configuration using the <span pulumi-lang-nodejs="`catalogId`" pulumi-lang-dotnet="`CatalogId`" pulumi-lang-go="`catalogId`" pulumi-lang-python="`catalog_id`" pulumi-lang-yaml="`catalogId`" pulumi-lang-java="`catalogId`">`catalog_id`</span>. For example:
///
/// ```sh
