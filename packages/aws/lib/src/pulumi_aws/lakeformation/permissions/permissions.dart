...
///
/// > **NOTE:** In general, the <span pulumi-lang-nodejs="`principal`" pulumi-lang-dotnet="`Principal`" pulumi-lang-go="`principal`" pulumi-lang-python="`principal`" pulumi-lang-yaml="`principal`" pulumi-lang-java="`principal`">`principal`</span> should _NOT_ be a Lake Formation administrator or the entity (e.g., IAM role) that is running the deployment. Administrators have implicit permissions. These should be managed by granting or not granting administrator rights using <span pulumi-lang-nodejs="`aws.lakeformation.DataLakeSettings`" pulumi-lang-dotnet="`aws.lakeformation.DataLakeSettings`" pulumi-lang-go="`lakeformation.DataLakeSettings`" pulumi-lang-python="`lakeformation.DataLakeSettings`" pulumi-lang-yaml="`aws.lakeformation.DataLakeSettings`" pulumi-lang-java="`aws.lakeformation.DataLakeSettings`">`aws.lakeformation.DataLakeSettings`</span>, _not_ with this resource.
///
...
///
/// 1. Use this resource (<span pulumi-lang-nodejs="`aws.lakeformation.Permissions`" pulumi-lang-dotnet="`aws.lakeformation.Permissions`" pulumi-lang-go="`lakeformation.Permissions`" pulumi-lang-python="`lakeformation.Permissions`" pulumi-lang-yaml="`aws.lakeformation.Permissions`" pulumi-lang-java="`aws.lakeformation.Permissions`">`aws.lakeformation.Permissions`</span>), change the default security settings using <span pulumi-lang-nodejs="`aws.lakeformation.DataLakeSettings`" pulumi-lang-dotnet="`aws.lakeformation.DataLakeSettings`" pulumi-lang-go="`lakeformation.DataLakeSettings`" pulumi-lang-python="`lakeformation.DataLakeSettings`" pulumi-lang-yaml="`aws.lakeformation.DataLakeSettings`" pulumi-lang-java="`aws.lakeformation.DataLakeSettings`">`aws.lakeformation.DataLakeSettings`</span>, and remove existing `IAMAllowedPrincipals` permissions
/// 2. Use `IAMAllowedPrincipals` without <span pulumi-lang-nodejs="`aws.lakeformation.Permissions`" pulumi-lang-dotnet="`aws.lakeformation.Permissions`" pulumi-lang-go="`lakeformation.Permissions`" pulumi-lang-python="`lakeformation.Permissions`" pulumi-lang-yaml="`aws.lakeformation.Permissions`" pulumi-lang-java="`aws.lakeformation.Permissions`">`aws.lakeformation.Permissions`</span>
///
/// This example shows removing the `IAMAllowedPrincipals` default security settings and making the caller a Lake Formation admin. Since <span pulumi-lang-nodejs="`createDatabaseDefaultPermissions`" pulumi-lang-dotnet="`CreateDatabaseDefaultPermissions`" pulumi-lang-go="`createDatabaseDefaultPermissions`" pulumi-lang-python="`create_database_default_permissions`" pulumi-lang-yaml="`createDatabaseDefaultPermissions`" pulumi-lang-java="`createDatabaseDefaultPermissions`">`create_database_default_permissions`</span> and <span pulumi-lang-nodejs="`createTableDefaultPermissions`" pulumi-lang-dotnet="`CreateTableDefaultPermissions`" pulumi-lang-go="`createTableDefaultPermissions`" pulumi-lang-python="`create_table_default_permissions`" pulumi-lang-yaml="`createTableDefaultPermissions`" pulumi-lang-java="`createTableDefaultPermissions`">`create_table_default_permissions`</span> are not set in the <span pulumi-lang-nodejs="`aws.lakeformation.DataLakeSettings`" pulumi-lang-dotnet="`aws.lakeformation.DataLakeSettings`" pulumi-lang-go="`lakeformation.DataLakeSettings`" pulumi-lang-python="`lakeformation.DataLakeSettings`" pulumi-lang-yaml="`aws.lakeformation.DataLakeSettings`" pulumi-lang-java="`aws.lakeformation.DataLakeSettings`">`aws.lakeformation.DataLakeSettings`</span> resource, they are cleared.
///
...
///
/// There are two ways to avoid these errors. First, and the way we recommend, is to avoid using this resource with principals that have implicit permissions. A second, error-prone option, is to grant explicit permissions (and <span pulumi-lang-nodejs="`permissionsWithGrantOption`" pulumi-lang-dotnet="`PermissionsWithGrantOption`" pulumi-lang-go="`permissionsWithGrantOption`" pulumi-lang-python="`permissions_with_grant_option`" pulumi-lang-yaml="`permissionsWithGrantOption`" pulumi-lang-java="`permissionsWithGrantOption`">`permissions_with_grant_option`</span>) to "overwrite" a principal's implicit permissions, which you can then revoke with this resource. For more information, see [Implicit Lake Formation Permissions](https://docs.aws.amazon.com/lake-formation/latest/dg/implicit-permissions.html).
///
/// If the <span pulumi-lang-nodejs="`principal`" pulumi-lang-dotnet="`Principal`" pulumi-lang-go="`principal`" pulumi-lang-python="`principal`" pulumi-lang-yaml="`principal`" pulumi-lang-java="`principal`">`principal`</span> is also a data lake administrator, AWS grants implicit permissions that can cause errors using this resource. For example, AWS implicitly grants a <span pulumi-lang-nodejs="`principal`" pulumi-lang-dotnet="`Principal`" pulumi-lang-go="`principal`" pulumi-lang-python="`principal`" pulumi-lang-yaml="`principal`" pulumi-lang-java="`principal`">`principal`</span>/administrator <span pulumi-lang-nodejs="`permissions`" pulumi-lang-dotnet="`Permissions`" pulumi-lang-go="`permissions`" pulumi-lang-python="`permissions`" pulumi-lang-yaml="`permissions`" pulumi-lang-java="`permissions`">`permissions`</span> and <span pulumi-lang-nodejs="`permissionsWithGrantOption`" pulumi-lang-dotnet="`PermissionsWithGrantOption`" pulumi-lang-go="`permissionsWithGrantOption`" pulumi-lang-python="`permissions_with_grant_option`" pulumi-lang-yaml="`permissionsWithGrantOption`" pulumi-lang-java="`permissionsWithGrantOption`">`permissions_with_grant_option`</span> of `ALL`, `ALTER`, `DELETE`, `DESCRIBE`, `DROP`, `INSERT`, and `SELECT` on a table. If you use this resource to explicitly grant the <span pulumi-lang-nodejs="`principal`" pulumi-lang-dotnet="`Principal`" pulumi-lang-go="`principal`" pulumi-lang-python="`principal`" pulumi-lang-yaml="`principal`" pulumi-lang-java="`principal`">`principal`</span>/administrator <span pulumi-lang-nodejs="`permissions`" pulumi-lang-dotnet="`Permissions`" pulumi-lang-go="`permissions`" pulumi-lang-python="`permissions`" pulumi-lang-yaml="`permissions`" pulumi-lang-java="`permissions`">`permissions`</span> but _not_ <span pulumi-lang-nodejs="`permissionsWithGrantOption`" pulumi-lang-dotnet="`PermissionsWithGrantOption`" pulumi-lang-go="`permissionsWithGrantOption`" pulumi-lang-python="`permissions_with_grant_option`" pulumi-lang-yaml="`permissionsWithGrantOption`" pulumi-lang-java="`permissionsWithGrantOption`">`permissions_with_grant_option`</span> of `ALL`, `ALTER`, `DELETE`, `DESCRIBE`, `DROP`, `INSERT`, and `SELECT` on the table, this resource will read the implicit <span pulumi-lang-nodejs="`permissionsWithGrantOption`" pulumi-lang-dotnet="`PermissionsWithGrantOption`" pulumi-lang-go="`permissionsWithGrantOption`" pulumi-lang-python="`permissions_with_grant_option`" pulumi-lang-yaml="`permissionsWithGrantOption`" pulumi-lang-java="`permissionsWithGrantOption`">`permissions_with_grant_option`</span> and attempt to revoke them when the resource is destroyed. Doing so will cause an `InvalidInputException: No permissions revoked` error because you cannot revoke implicit permissions _per se_. To workaround this problem, explicitly grant the <span pulumi-lang-nodejs="`principal`" pulumi-lang-dotnet="`Principal`" pulumi-lang-go="`principal`" pulumi-lang-python="`principal`" pulumi-lang-yaml="`principal`" pulumi-lang-java="`principal`">`principal`</span>/administrator <span pulumi-lang-nodejs="`permissions`" pulumi-lang-dotnet="`Permissions`" pulumi-lang-go="`permissions`" pulumi-lang-python="`permissions`" pulumi-lang-yaml="`permissions`" pulumi-lang-java="`permissions`">`permissions`</span> _and_ <span pulumi-lang-nodejs="`permissionsWithGrantOption`" pulumi-lang-dotnet="`PermissionsWithGrantOption`" pulumi-lang-go="`permissionsWithGrantOption`" pulumi-lang-python="`permissions_with_grant_option`" pulumi-lang-yaml="`permissionsWithGrantOption`" pulumi-lang-java="`permissionsWithGrantOption`">`permissions_with_grant_option`</span>, which can then be revoked. Similarly, granting a <span pulumi-lang-nodejs="`principal`" pulumi-lang-dotnet="`Principal`" pulumi-lang-go="`principal`" pulumi-lang-python="`principal`" pulumi-lang-yaml="`principal`" pulumi-lang-java="`principal`">`principal`</span>/administrator permissions on a table with columns and providing <span pulumi-lang-nodejs="`columnNames`" pulumi-lang-dotnet="`ColumnNames`" pulumi-lang-go="`columnNames`" pulumi-lang-python="`column_names`" pulumi-lang-yaml="`columnNames`" pulumi-lang-java="`columnNames`">`column_names`</span>, will result in a `InvalidInputException: Permissions modification is invalid` error because you are narrowing the implicit permissions. Instead, set <span pulumi-lang-nodejs="`wildcard`" pulumi-lang-dotnet="`Wildcard`" pulumi-lang-go="`wildcard`" pulumi-lang-python="`wildcard`" pulumi-lang-yaml="`wildcard`" pulumi-lang-java="`wildcard`">`wildcard`</span> to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span> and remove the <span pulumi-lang-nodejs="`columnNames`" pulumi-lang-dotnet="`ColumnNames`" pulumi-lang-go="`columnNames`" pulumi-lang-python="`column_names`" pulumi-lang-yaml="`columnNames`" pulumi-lang-java="`columnNames`">`column_names`</span>.
///
/// ## Example Usage
///
...
/// ```
/// <!--End PulumiCodeChooser -->
class Permissions extends CustomResource {
  ...
  late final Output<bool?> catalogResource;

  /// Configuration block for a data cells filter resource. Detailed below.
  late final Output<PermissionsDataCellsFilter?> dataCellsFilter;

  /// Configuration block for a data location resource. Detailed below.
  late final Output<PermissionsDataLocation> dataLocation;

  /// Configuration block for a database resource. Detailed below.
  late final Output<PermissionsDatabase> database;

  /// Configuration block for an LF-tag resource. Detailed below.
  late final Output<PermissionsLfTag> lfTag;

  /// Configuration block for an LF-tag policy resource. Detailed below.
  late final Output<PermissionsLfTagPolicy> lfTagPolicy;
  ...
  late final Output<List<String>> permissionsWithGrantOptions;
  ...
  ///
  /// > **NOTE:** We highly recommend that the <span pulumi-lang-nodejs="`principal`" pulumi-lang-dotnet="`Principal`" pulumi-lang-go="`principal`" pulumi-lang-python="`principal`" pulumi-lang-yaml="`principal`" pulumi-lang-java="`principal`">`principal`</span> _NOT_ be a Lake Formation administrator (granted using <span pulumi-lang-nodejs="`aws.lakeformation.DataLakeSettings`" pulumi-lang-dotnet="`aws.lakeformation.DataLakeSettings`" pulumi-lang-go="`lakeformation.DataLakeSettings`" pulumi-lang-python="`lakeformation.DataLakeSettings`" pulumi-lang-yaml="`aws.lakeformation.DataLakeSettings`" pulumi-lang-java="`aws.lakeformation.DataLakeSettings`">`aws.lakeformation.DataLakeSettings`</span>). The entity (e.g., IAM role) running the deployment will most likely need to be a Lake Formation administrator. As such, the entity will have implicit permissions and does not need permissions granted through this resource.
  ///
  ...
  late final Output<PermissionsTable> table;

  /// Configuration block for a table with columns resource. Detailed below.
  ///
  /// The following arguments are optional:
  late final Output<PermissionsTableWithColumns> tableWithColumns;
