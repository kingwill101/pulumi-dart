...
class PermissionsArgs {
  ...
  factory PermissionsArgs.fromMap(Map<String, dynamic> map) {
    return PermissionsArgs(
      ...
      dataCellsFilter: pulumi.Input.asOptionalInput<PermissionsDataCellsFilter>(
          map['dataCellsFilter']),
      dataLocation: pulumi.Input.asOptionalInput<PermissionsDataLocation>(
          map['dataLocation']),
      database:
          pulumi.Input.asOptionalInput<PermissionsDatabase>(map['database']),
      lfTag: pulumi.Input.asOptionalInput<PermissionsLfTag>(map['lfTag']),
      lfTagPolicy: pulumi.Input.asOptionalInput<PermissionsLfTagPolicy>(
          map['lfTagPolicy']),
      permissions: pulumi.Input.asInput<List<String>>(map['permissions']),
      permissionsWithGrantOptions: pulumi.Input.asOptionalInput<List<String>>(
          map['permissionsWithGrantOptions']),
      principal: pulumi.Input.asInput<String>(map['principal']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      table: pulumi.Input.asOptionalInput<PermissionsTable>(map['table']),
      tableWithColumns:
