...
class GetResourceLakeformationResult {
  final String arn;
  ...
  GetResourceLakeformationResult({
    required this.arn,
  ...
  factory GetResourceLakeformationResult.fromMap(Map<String, dynamic> map) {
    return GetResourceLakeformationResult(
