...
import '../connector_profile_connector_profile_config_connector_profile_credentials_sapo_data_basic_auth_credentials/connector_profile_connector_profile_config_connector_profile_credentials_sapo_data_basic_auth_credentials.dart';
import '../connector_profile_connector_profile_config_connector_profile_credentials_sapo_data_oauth_credentials/connector_profile_connector_profile_config_connector_profile_credentials_sapo_data_oauth_credentials.dart';
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoData {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (basicAuthCredentialsValue != null) {
      map['basicAuthCredentials'] = basicAuthCredentialsValue.toMap();
    }
    final oauthCredentialsValue = oauthCredentials;
    if (oauthCredentialsValue != null) {
      map['oauthCredentials'] = oauthCredentialsValue.toMap();
    }
    return map;
  }
