...
class GetNetworkInsightsAnalysisExplanationPrefixList {
  ...
  factory GetNetworkInsightsAnalysisExplanationPrefixList.fromMap(
      Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationPrefixList(
