...
/// <span pulumi-lang-nodejs="`aws.ec2.Eip`" pulumi-lang-dotnet="`aws.ec2.Eip`" pulumi-lang-go="`ec2.Eip`" pulumi-lang-python="`ec2.Eip`" pulumi-lang-yaml="`aws.ec2.Eip`" pulumi-lang-java="`aws.ec2.Eip`">`aws.ec2.Eip`</span> provides details about a specific Elastic IP.
///
/// ## Example Usage
///
