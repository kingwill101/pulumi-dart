...
class AllowedImagesSettingsArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (imageCriterionsValue != null) {
      map['imageCriterions'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory AllowedImagesSettingsArgs.fromMap(Map<String, dynamic> map) {
    return AllowedImagesSettingsArgs(
      imageCriterions: pulumi.Input.asOptionalInput<
          List<AllowedImagesSettingsImageCriterion>>(map['imageCriterions']),
