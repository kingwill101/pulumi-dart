...
class GetDedicatedHostArgs {
  ...
  final Input<List<GetDedicatedHostFilter>>? filters;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (filtersValue != null) {
      map['filters'] = Input.mapOptionalInputValue<List<GetDedicatedHostFilter>,
  ...
  factory GetDedicatedHostArgs.fromMap(Map<String, dynamic> map) {
    return GetDedicatedHostArgs(
      filters:
          Input.asOptionalInput<List<GetDedicatedHostFilter>>(map['filters']),
