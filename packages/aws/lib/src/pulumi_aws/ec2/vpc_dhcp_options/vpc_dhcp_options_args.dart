...
class VpcDhcpOptionsArgs {
  ...
  factory VpcDhcpOptionsArgs.fromMap(Map<String, dynamic> map) {
    return VpcDhcpOptionsArgs(
      ...
      domainNameServers:
          pulumi.Input.asOptionalInput<List<String>>(map['domainNameServers']),
      ipv6AddressPreferredLeaseTime: pulumi.Input.asOptionalInput<String>(
          map['ipv6AddressPreferredLeaseTime']),
      netbiosNameServers:
          pulumi.Input.asOptionalInput<List<String>>(map['netbiosNameServers']),
      netbiosNodeType:
          pulumi.Input.asOptionalInput<String>(map['netbiosNodeType']),
      ntpServers: pulumi.Input.asOptionalInput<List<String>>(map['ntpServers']),
