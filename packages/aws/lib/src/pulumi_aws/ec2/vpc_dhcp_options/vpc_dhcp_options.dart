...
/// * <span pulumi-lang-nodejs="`domainNameServers`" pulumi-lang-dotnet="`DomainNameServers`" pulumi-lang-go="`domainNameServers`" pulumi-lang-python="`domain_name_servers`" pulumi-lang-yaml="`domainNameServers`" pulumi-lang-java="`domainNameServers`">`domain_name_servers`</span>, <span pulumi-lang-nodejs="`netbiosNameServers`" pulumi-lang-dotnet="`NetbiosNameServers`" pulumi-lang-go="`netbiosNameServers`" pulumi-lang-python="`netbios_name_servers`" pulumi-lang-yaml="`netbiosNameServers`" pulumi-lang-java="`netbiosNameServers`">`netbios_name_servers`</span>, <span pulumi-lang-nodejs="`ntpServers`" pulumi-lang-dotnet="`NtpServers`" pulumi-lang-go="`ntpServers`" pulumi-lang-python="`ntp_servers`" pulumi-lang-yaml="`ntpServers`" pulumi-lang-java="`ntpServers`">`ntp_servers`</span> are limited by AWS to maximum four servers only.
/// * To actually use the DHCP Options Set you need to associate it to a VPC using <span pulumi-lang-nodejs="`aws.ec2.VpcDhcpOptionsAssociation`" pulumi-lang-dotnet="`aws.ec2.VpcDhcpOptionsAssociation`" pulumi-lang-go="`ec2.VpcDhcpOptionsAssociation`" pulumi-lang-python="`ec2.VpcDhcpOptionsAssociation`" pulumi-lang-yaml="`aws.ec2.VpcDhcpOptionsAssociation`" pulumi-lang-java="`aws.ec2.VpcDhcpOptionsAssociation`">`aws.ec2.VpcDhcpOptionsAssociation`</span>.
/// * If you delete a DHCP Options Set, all VPCs using it will be associated to AWS's <span pulumi-lang-nodejs="`default`" pulumi-lang-dotnet="`Default`" pulumi-lang-go="`default`" pulumi-lang-python="`default`" pulumi-lang-yaml="`default`" pulumi-lang-java="`default`">`default`</span> DHCP Option Set.
/// * In most cases unless you're configuring your own DNS you'll want to set <span pulumi-lang-nodejs="`domainNameServers`" pulumi-lang-dotnet="`DomainNameServers`" pulumi-lang-go="`domainNameServers`" pulumi-lang-python="`domain_name_servers`" pulumi-lang-yaml="`domainNameServers`" pulumi-lang-java="`domainNameServers`">`domain_name_servers`</span> to `AmazonProvidedDNS`.
///
/// ## Import
///
...
class VpcDhcpOptions extends CustomResource {
  ...
  VpcDhcpOptions(
    ...
    this.domainNameServers = Output.createUnknown<List<String>?>();
    this.ipv6AddressPreferredLeaseTime = Output.createUnknown<String?>();
    this.netbiosNameServers = Output.createUnknown<List<String>?>();
    this.netbiosNodeType = Output.createUnknown<String?>();
    this.ntpServers = Output.createUnknown<List<String>?>();
