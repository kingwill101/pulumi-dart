...
/// <span pulumi-lang-nodejs="`aws.ec2.Subnet`" pulumi-lang-dotnet="`aws.ec2.Subnet`" pulumi-lang-go="`ec2.Subnet`" pulumi-lang-python="`ec2.Subnet`" pulumi-lang-yaml="`aws.ec2.Subnet`" pulumi-lang-java="`aws.ec2.Subnet`">`aws.ec2.Subnet`</span> provides details about a specific VPC subnet.
///
