...
import '../launch_template_instance_requirements_accelerator_count/launch_template_instance_requirements_accelerator_count.dart';
import '../launch_template_instance_requirements_accelerator_total_memory_mib/launch_template_instance_requirements_accelerator_total_memory_mib.dart';
import '../launch_template_instance_requirements_baseline_ebs_bandwidth_mbps/launch_template_instance_requirements_baseline_ebs_bandwidth_mbps.dart';
import '../launch_template_instance_requirements_memory_gib_per_vcpu/launch_template_instance_requirements_memory_gib_per_vcpu.dart';
import '../launch_template_instance_requirements_memory_mib/launch_template_instance_requirements_memory_mib.dart';
import '../launch_template_instance_requirements_network_bandwidth_gbps/launch_template_instance_requirements_network_bandwidth_gbps.dart';
import '../launch_template_instance_requirements_network_interface_count/launch_template_instance_requirements_network_interface_count.dart';
import '../launch_template_instance_requirements_total_local_storage_gb/launch_template_instance_requirements_total_local_storage_gb.dart';
import '../launch_template_instance_requirements_vcpu_count/launch_template_instance_requirements_vcpu_count.dart';
  ...
  factory LaunchTemplateInstanceRequirements.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateInstanceRequirements(
      acceleratorCount: map['acceleratorCount'] == null
          ? null
          : LaunchTemplateInstanceRequirementsAcceleratorCount.fromMap(
      ...
      acceleratorTotalMemoryMib: map['acceleratorTotalMemoryMib'] == null
          ? null
          : LaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib.fromMap(
              (map['acceleratorTotalMemoryMib'] as Map)
                  .cast<String, dynamic>()),
      ...
      baselineEbsBandwidthMbps: map['baselineEbsBandwidthMbps'] == null
          ? null
          : LaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps.fromMap(
      ...
      memoryGibPerVcpu: map['memoryGibPerVcpu'] == null
          ? null
          : LaunchTemplateInstanceRequirementsMemoryGibPerVcpu.fromMap(
              (map['memoryGibPerVcpu'] as Map).cast<String, dynamic>()),
      memoryMib: LaunchTemplateInstanceRequirementsMemoryMib.fromMap(
          (map['memoryMib'] as Map).cast<String, dynamic>()),
      networkBandwidthGbps: map['networkBandwidthGbps'] == null
          ? null
          : LaunchTemplateInstanceRequirementsNetworkBandwidthGbps.fromMap(
              (map['networkBandwidthGbps'] as Map).cast<String, dynamic>()),
      networkInterfaceCount: map['networkInterfaceCount'] == null
          ? null
          : LaunchTemplateInstanceRequirementsNetworkInterfaceCount.fromMap(
      ...
      totalLocalStorageGb: map['totalLocalStorageGb'] == null
          ? null
          : LaunchTemplateInstanceRequirementsTotalLocalStorageGb.fromMap(
              (map['totalLocalStorageGb'] as Map).cast<String, dynamic>()),
      vcpuCount: LaunchTemplateInstanceRequirementsVcpuCount.fromMap(
