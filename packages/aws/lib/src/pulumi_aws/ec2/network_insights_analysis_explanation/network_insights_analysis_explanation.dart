...
import '../network_insights_analysis_explanation_acl/network_insights_analysis_explanation_acl.dart';
import '../network_insights_analysis_explanation_acl_rule/network_insights_analysis_explanation_acl_rule.dart';
import '../network_insights_analysis_explanation_attached_to/network_insights_analysis_explanation_attached_to.dart';
import '../network_insights_analysis_explanation_classic_load_balancer_listener/network_insights_analysis_explanation_classic_load_balancer_listener.dart';
import '../network_insights_analysis_explanation_component/network_insights_analysis_explanation_component.dart';
import '../network_insights_analysis_explanation_customer_gateway/network_insights_analysis_explanation_customer_gateway.dart';
import '../network_insights_analysis_explanation_destination/network_insights_analysis_explanation_destination.dart';
import '../network_insights_analysis_explanation_destination_vpc/network_insights_analysis_explanation_destination_vpc.dart';
import '../network_insights_analysis_explanation_elastic_load_balancer_listener/network_insights_analysis_explanation_elastic_load_balancer_listener.dart';
import '../network_insights_analysis_explanation_ingress_route_table/network_insights_analysis_explanation_ingress_route_table.dart';
import '../network_insights_analysis_explanation_internet_gateway/network_insights_analysis_explanation_internet_gateway.dart';
import '../network_insights_analysis_explanation_load_balancer_target_group/network_insights_analysis_explanation_load_balancer_target_group.dart';
import '../network_insights_analysis_explanation_nat_gateway/network_insights_analysis_explanation_nat_gateway.dart';
import '../network_insights_analysis_explanation_network_interface/network_insights_analysis_explanation_network_interface.dart';
import '../network_insights_analysis_explanation_port_range/network_insights_analysis_explanation_port_range.dart';
import '../network_insights_analysis_explanation_prefix_list/network_insights_analysis_explanation_prefix_list.dart';
import '../network_insights_analysis_explanation_route_table/network_insights_analysis_explanation_route_table.dart';
import '../network_insights_analysis_explanation_route_table_route/network_insights_analysis_explanation_route_table_route.dart';
import '../network_insights_analysis_explanation_security_group/network_insights_analysis_explanation_security_group.dart';
import '../network_insights_analysis_explanation_security_group_rule/network_insights_analysis_explanation_security_group_rule.dart';
import '../network_insights_analysis_explanation_source_vpc/network_insights_analysis_explanation_source_vpc.dart';
import '../network_insights_analysis_explanation_subnet/network_insights_analysis_explanation_subnet.dart';
import '../network_insights_analysis_explanation_subnet_route_table/network_insights_analysis_explanation_subnet_route_table.dart';
import '../network_insights_analysis_explanation_transit_gateway/network_insights_analysis_explanation_transit_gateway.dart';
import '../network_insights_analysis_explanation_transit_gateway_attachment/network_insights_analysis_explanation_transit_gateway_attachment.dart';
import '../network_insights_analysis_explanation_transit_gateway_route_table/network_insights_analysis_explanation_transit_gateway_route_table.dart';
import '../network_insights_analysis_explanation_transit_gateway_route_table_route/network_insights_analysis_explanation_transit_gateway_route_table_route.dart';
import '../network_insights_analysis_explanation_vpc/network_insights_analysis_explanation_vpc.dart';
import '../network_insights_analysis_explanation_vpc_endpoint/network_insights_analysis_explanation_vpc_endpoint.dart';
import '../network_insights_analysis_explanation_vpc_peering_connection/network_insights_analysis_explanation_vpc_peering_connection.dart';
import '../network_insights_analysis_explanation_vpn_connection/network_insights_analysis_explanation_vpn_connection.dart';
import '../network_insights_analysis_explanation_vpn_gateway/network_insights_analysis_explanation_vpn_gateway.dart';
...
class NetworkInsightsAnalysisExplanation {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (aclsValue != null) {
      map['acls'] = Input.encodeList<NetworkInsightsAnalysisExplanationAcl,
    ...
    if (vpcsValue != null) {
      map['vpcs'] = Input.encodeList<NetworkInsightsAnalysisExplanationVpc,
  ...
  factory NetworkInsightsAnalysisExplanation.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAnalysisExplanation(
      aclRules: map['aclRules'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationAclRule>(
              map['aclRules'],
              (value) => NetworkInsightsAnalysisExplanationAclRule.fromMap(
                  (value as Map).cast<String, dynamic>())),
      acls: map['acls'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationAcl>(
              map['acls'],
      ...
      customerGateways: map['customerGateways'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationCustomerGateway>(
      ...
      destinationVpcs: map['destinationVpcs'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationDestinationVpc>(
              map['destinationVpcs'],
              (value) =>
      ...
      internetGateways: map['internetGateways'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationInternetGateway>(
      ...
      routeTableRoutes: map['routeTableRoutes'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationRouteTableRoute>(
      ...
      securityGroup: map['securityGroup'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationSecurityGroup>(
              map['securityGroup'],
              (value) =>
      ...
      subnets: map['subnets'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationSubnet>(
              map['subnets'],
      ...
      transitGateways: map['transitGateways'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationTransitGateway>(
              map['transitGateways'],
              (value) =>
      ...
      vpcs: map['vpcs'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationVpc>(
              map['vpcs'],
              (value) => NetworkInsightsAnalysisExplanationVpc.fromMap(
                  (value as Map).cast<String, dynamic>())),
      vpnConnections: map['vpnConnections'] == null
          ? null
          : Input.decodeList<NetworkInsightsAnalysisExplanationVpnConnection>(
              map['vpnConnections'],
              (value) =>
