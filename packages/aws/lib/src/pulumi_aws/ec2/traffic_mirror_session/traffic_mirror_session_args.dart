...
class TrafficMirrorSessionArgs {
  ...
  factory TrafficMirrorSessionArgs.fromMap(Map<String, dynamic> map) {
    return TrafficMirrorSessionArgs(
      ...
      packetLength: pulumi.Input.asOptionalInput<int>(map['packetLength']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      sessionNumber: pulumi.Input.asInput<int>(map['sessionNumber']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      trafficMirrorFilterId:
          pulumi.Input.asInput<String>(map['trafficMirrorFilterId']),
      trafficMirrorTargetId:
          pulumi.Input.asInput<String>(map['trafficMirrorTargetId']),
      virtualNetworkId:
          pulumi.Input.asOptionalInput<int>(map['virtualNetworkId']),
    );
  }
}
