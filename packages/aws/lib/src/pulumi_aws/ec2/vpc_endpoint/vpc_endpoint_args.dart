...
class VpcEndpointArgs {
  ...
  factory VpcEndpointArgs.fromMap(Map<String, dynamic> map) {
    return VpcEndpointArgs(
      ...
      dnsOptions: pulumi.Input.asOptionalInput<VpcEndpointDnsOptions>(
          map['dnsOptions']),
      ...
      resourceConfigurationArn:
          pulumi.Input.asOptionalInput<String>(map['resourceConfigurationArn']),
      routeTableIds:
      ...
      serviceNetworkArn:
          pulumi.Input.asOptionalInput<String>(map['serviceNetworkArn']),
