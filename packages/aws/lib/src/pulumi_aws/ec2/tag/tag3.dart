...
///
/// > **NOTE:** This tagging resource should not be combined with the providers resource for managing the parent resource. For example, using <span pulumi-lang-nodejs="`aws.ec2.Vpc`" pulumi-lang-dotnet="`aws.ec2.Vpc`" pulumi-lang-go="`ec2.Vpc`" pulumi-lang-python="`ec2.Vpc`" pulumi-lang-yaml="`aws.ec2.Vpc`" pulumi-lang-java="`aws.ec2.Vpc`">`aws.ec2.Vpc`</span> and <span pulumi-lang-nodejs="`aws.ec2.Tag`" pulumi-lang-dotnet="`aws.ec2.Tag`" pulumi-lang-go="`ec2.Tag`" pulumi-lang-python="`ec2.Tag`" pulumi-lang-yaml="`aws.ec2.Tag`" pulumi-lang-java="`aws.ec2.Tag`">`aws.ec2.Tag`</span> to manage tags of the same VPC will cause a perpetual difference where the <span pulumi-lang-nodejs="`aws.ec2.Vpc`" pulumi-lang-dotnet="`aws.ec2.Vpc`" pulumi-lang-go="`ec2.Vpc`" pulumi-lang-python="`ec2.Vpc`" pulumi-lang-yaml="`aws.ec2.Vpc`" pulumi-lang-java="`aws.ec2.Vpc`">`aws.ec2.Vpc`</span> resource will try to remove the tag being added by the <span pulumi-lang-nodejs="`aws.ec2.Tag`" pulumi-lang-dotnet="`aws.ec2.Tag`" pulumi-lang-go="`ec2.Tag`" pulumi-lang-python="`ec2.Tag`" pulumi-lang-yaml="`aws.ec2.Tag`" pulumi-lang-java="`aws.ec2.Tag`">`aws.ec2.Tag`</span> resource.
///
///
/// ## Example Usage
///
...
/// ## Import
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.ec2.Tag`" pulumi-lang-dotnet="`aws.ec2.Tag`" pulumi-lang-go="`ec2.Tag`" pulumi-lang-python="`ec2.Tag`" pulumi-lang-yaml="`aws.ec2.Tag`" pulumi-lang-java="`aws.ec2.Tag`">`aws.ec2.Tag`</span> using the EC2 resource identifier and key, separated by a comma (`,`). For example:
///
/// ```sh
