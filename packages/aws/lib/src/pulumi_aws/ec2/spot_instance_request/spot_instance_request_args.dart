...
class SpotInstanceRequestArgs {
  ...
  factory SpotInstanceRequestArgs.fromMap(Map<String, dynamic> map) {
    return SpotInstanceRequestArgs(
      ...
      ebsBlockDevices:
          pulumi.Input.asOptionalInput<List<SpotInstanceRequestEbsBlockDevice>>(
              map['ebsBlockDevices']),
      ...
      instanceInterruptionBehavior: pulumi.Input.asOptionalInput<String>(
          map['instanceInterruptionBehavior']),
      ...
      launchGroup: pulumi.Input.asOptionalInput<String>(map['launchGroup']),
      launchTemplate:
      ...
      networkInterfaces: pulumi.Input.asOptionalInput<
          List<SpotInstanceRequestNetworkInterface>>(map['networkInterfaces']),
      placementGroup:
      ...
      spotType: pulumi.Input.asOptionalInput<String>(map['spotType']),
