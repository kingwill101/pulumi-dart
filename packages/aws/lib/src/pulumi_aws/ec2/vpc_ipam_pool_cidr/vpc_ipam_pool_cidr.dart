...
///
/// > **NOTE:** Provisioning Public IPv4 or Public IPv6 require [steps outside the scope of this resource](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-byoip.html#prepare-for-byoip). The resource accepts <span pulumi-lang-nodejs="`message`" pulumi-lang-dotnet="`Message`" pulumi-lang-go="`message`" pulumi-lang-python="`message`" pulumi-lang-yaml="`message`" pulumi-lang-java="`message`">`message`</span> and <span pulumi-lang-nodejs="`signature`" pulumi-lang-dotnet="`Signature`" pulumi-lang-go="`signature`" pulumi-lang-python="`signature`" pulumi-lang-yaml="`signature`" pulumi-lang-java="`signature`">`signature`</span> as part of the <span pulumi-lang-nodejs="`cidrAuthorizationContext`" pulumi-lang-dotnet="`CidrAuthorizationContext`" pulumi-lang-go="`cidrAuthorizationContext`" pulumi-lang-python="`cidr_authorization_context`" pulumi-lang-yaml="`cidrAuthorizationContext`" pulumi-lang-java="`cidrAuthorizationContext`">`cidr_authorization_context`</span> attribute but those must be generated ahead of time. Public IPv6 CIDRs that are provisioned into a Pool with <span pulumi-lang-nodejs="`publiclyAdvertisable " pulumi-lang-dotnet="`PubliclyAdvertisable " pulumi-lang-go="`publiclyAdvertisable " pulumi-lang-python="`publicly_advertisable " pulumi-lang-yaml="`publiclyAdvertisable " pulumi-lang-java="`publiclyAdvertisable ">`publicly_advertisable </span>= true` and all public IPv4 CIDRs also require creating a Route Origin Authorization (ROA) object in your Regional Internet Registry (RIR).
///
...
class VpcIpamPoolCidr extends CustomResource {
  ...
  /// The unique ID generated by AWS for the pool cidr. Typically this is the resource <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span> but this attribute was added to the API calls after the fact and is therefore not used as the resource id.
