...
/// provides the capability to assign security groups via the [<span pulumi-lang-nodejs="`aws.ec2.Instance`" pulumi-lang-dotnet="`aws.ec2.Instance`" pulumi-lang-go="`ec2.Instance`" pulumi-lang-python="`ec2.Instance`" pulumi-lang-yaml="`aws.ec2.Instance`" pulumi-lang-java="`aws.ec2.Instance`">`aws.ec2.Instance`</span>][1]
/// and the [<span pulumi-lang-nodejs="`aws.ec2.NetworkInterface`" pulumi-lang-dotnet="`aws.ec2.NetworkInterface`" pulumi-lang-go="`ec2.NetworkInterface`" pulumi-lang-python="`ec2.NetworkInterface`" pulumi-lang-yaml="`aws.ec2.NetworkInterface`" pulumi-lang-java="`aws.ec2.NetworkInterface`">`aws.ec2.NetworkInterface`</span>][2] resources. Using this resource in
...
/// by <span pulumi-lang-nodejs="`instance`" pulumi-lang-dotnet="`Instance`" pulumi-lang-go="`instance`" pulumi-lang-python="`instance`" pulumi-lang-yaml="`instance`" pulumi-lang-java="`instance`">`instance`</span>) in the default security group, creating a security group
/// (provided by <span pulumi-lang-nodejs="`sg`" pulumi-lang-dotnet="`Sg`" pulumi-lang-go="`sg`" pulumi-lang-python="`sg`" pulumi-lang-yaml="`sg`" pulumi-lang-java="`sg`">`sg`</span>) and then attaching the security group to the instance's
/// primary network interface via the <span pulumi-lang-nodejs="`aws.ec2.NetworkInterfaceSecurityGroupAttachment`" pulumi-lang-dotnet="`aws.ec2.NetworkInterfaceSecurityGroupAttachment`" pulumi-lang-go="`ec2.NetworkInterfaceSecurityGroupAttachment`" pulumi-lang-python="`ec2.NetworkInterfaceSecurityGroupAttachment`" pulumi-lang-yaml="`aws.ec2.NetworkInterfaceSecurityGroupAttachment`" pulumi-lang-java="`aws.ec2.NetworkInterfaceSecurityGroupAttachment`">`aws.ec2.NetworkInterfaceSecurityGroupAttachment`</span> resource,
/// named <span pulumi-lang-nodejs="`sgAttachment`" pulumi-lang-dotnet="`SgAttachment`" pulumi-lang-go="`sgAttachment`" pulumi-lang-python="`sg_attachment`" pulumi-lang-yaml="`sgAttachment`" pulumi-lang-java="`sgAttachment`">`sg_attachment`</span>:
///
...
///
/// In this example, <span pulumi-lang-nodejs="`instance`" pulumi-lang-dotnet="`Instance`" pulumi-lang-go="`instance`" pulumi-lang-python="`instance`" pulumi-lang-yaml="`instance`" pulumi-lang-java="`instance`">`instance`</span> is provided by the <span pulumi-lang-nodejs="`aws.ec2.Instance`" pulumi-lang-dotnet="`aws.ec2.Instance`" pulumi-lang-go="`ec2.Instance`" pulumi-lang-python="`ec2.Instance`" pulumi-lang-yaml="`aws.ec2.Instance`" pulumi-lang-java="`aws.ec2.Instance`">`aws.ec2.Instance`</span> data source,
/// fetching an external instance, possibly not managed by this provider.
/// <span pulumi-lang-nodejs="`sgAttachment`" pulumi-lang-dotnet="`SgAttachment`" pulumi-lang-go="`sgAttachment`" pulumi-lang-python="`sg_attachment`" pulumi-lang-yaml="`sgAttachment`" pulumi-lang-java="`sgAttachment`">`sg_attachment`</span> then attaches to the output instance's <span pulumi-lang-nodejs="`networkInterfaceId`" pulumi-lang-dotnet="`NetworkInterfaceId`" pulumi-lang-go="`networkInterfaceId`" pulumi-lang-python="`network_interface_id`" pulumi-lang-yaml="`networkInterfaceId`" pulumi-lang-java="`networkInterfaceId`">`network_interface_id`</span>:
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
