  ...
  factory VpcIpamPoolArgs.fromMap(Map<String, dynamic> map) {
    return VpcIpamPoolArgs(
      ...
      allocationMaxNetmaskLength:
          pulumi.Input.asOptionalInput<int>(map['allocationMaxNetmaskLength']),
      allocationMinNetmaskLength:
          pulumi.Input.asOptionalInput<int>(map['allocationMinNetmaskLength']),
      allocationResourceTags: pulumi.Input.asOptionalInput<Map<String, String>>(
          map['allocationResourceTags']),
      autoImport: pulumi.Input.asOptionalInput<bool>(map['autoImport']),
      awsService: pulumi.Input.asOptionalInput<String>(map['awsService']),
      cascade: pulumi.Input.asOptionalInput<bool>(map['cascade']),
      description: pulumi.Input.asOptionalInput<String>(map['description']),
      ipamScopeId: pulumi.Input.asInput<String>(map['ipamScopeId']),
      locale: pulumi.Input.asOptionalInput<String>(map['locale']),
      publicIpSource:
          pulumi.Input.asOptionalInput<String>(map['publicIpSource']),
      publiclyAdvertisable:
          pulumi.Input.asOptionalInput<bool>(map['publiclyAdvertisable']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      sourceIpamPoolId:
          pulumi.Input.asOptionalInput<String>(map['sourceIpamPoolId']),
