...
class InstanceRootBlockDevice {
  ...
  /// Device name, e.g., `/dev/sdh` or <span pulumi-lang-nodejs="`xvdh`" pulumi-lang-dotnet="`Xvdh`" pulumi-lang-go="`xvdh`" pulumi-lang-python="`xvdh`" pulumi-lang-yaml="`xvdh`" pulumi-lang-java="`xvdh`">`xvdh`</span>.
