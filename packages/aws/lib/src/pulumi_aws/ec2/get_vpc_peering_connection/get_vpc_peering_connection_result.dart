...
import '../get_vpc_peering_connection_peer_cidr_block_set/get_vpc_peering_connection_peer_cidr_block_set.dart';
import '../get_vpc_peering_connection_peer_ipv6_cidr_block_set/get_vpc_peering_connection_peer_ipv6_cidr_block_set.dart';
...
class GetVpcPeeringConnectionResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['requesterRegion'] = requesterRegion;
    map['status'] = status;
    map['tags'] = tags;
    map['vpcId'] = vpcId;
    return map;
