...
///
/// > **Note:** The <span pulumi-lang-nodejs="`aws.ec2.VpnGateway`" pulumi-lang-dotnet="`aws.ec2.VpnGateway`" pulumi-lang-go="`ec2.VpnGateway`" pulumi-lang-python="`ec2.VpnGateway`" pulumi-lang-yaml="`aws.ec2.VpnGateway`" pulumi-lang-java="`aws.ec2.VpnGateway`">`aws.ec2.VpnGateway`</span>
/// resource can also automatically attach the Virtual Private Gateway it creates
/// to an existing VPC by setting the <span pulumi-lang-nodejs="`vpcId`" pulumi-lang-dotnet="`VpcId`" pulumi-lang-go="`vpcId`" pulumi-lang-python="`vpc_id`" pulumi-lang-yaml="`vpcId`" pulumi-lang-java="`vpcId`">`vpc_id`</span> attribute accordingly.
///
/// ## Example Usage
///
