...
/// Provides a security group rule resource. Represents a single <span pulumi-lang-nodejs="`ingress`" pulumi-lang-dotnet="`Ingress`" pulumi-lang-go="`ingress`" pulumi-lang-python="`ingress`" pulumi-lang-yaml="`ingress`" pulumi-lang-java="`ingress`">`ingress`</span> or <span pulumi-lang-nodejs="`egress`" pulumi-lang-dotnet="`Egress`" pulumi-lang-go="`egress`" pulumi-lang-python="`egress`" pulumi-lang-yaml="`egress`" pulumi-lang-java="`egress`">`egress`</span> group rule, which can be added to external Security Groups.
///
/// > **NOTE:** Avoid using the <span pulumi-lang-nodejs="`aws.ec2.SecurityGroupRule`" pulumi-lang-dotnet="`aws.ec2.SecurityGroupRule`" pulumi-lang-go="`ec2.SecurityGroupRule`" pulumi-lang-python="`ec2.SecurityGroupRule`" pulumi-lang-yaml="`aws.ec2.SecurityGroupRule`" pulumi-lang-java="`aws.ec2.SecurityGroupRule`">`aws.ec2.SecurityGroupRule`</span> resource, as it struggles with managing multiple CIDR blocks, and, due to the historical lack of unique IDs, tags and descriptions. To avoid these problems, use the current best practice of the <span pulumi-lang-nodejs="`aws.vpc.SecurityGroupEgressRule`" pulumi-lang-dotnet="`aws.vpc.SecurityGroupEgressRule`" pulumi-lang-go="`vpc.SecurityGroupEgressRule`" pulumi-lang-python="`vpc.SecurityGroupEgressRule`" pulumi-lang-yaml="`aws.vpc.SecurityGroupEgressRule`" pulumi-lang-java="`aws.vpc.SecurityGroupEgressRule`">`aws.vpc.SecurityGroupEgressRule`</span> and <span pulumi-lang-nodejs="`aws.vpc.SecurityGroupIngressRule`" pulumi-lang-dotnet="`aws.vpc.SecurityGroupIngressRule`" pulumi-lang-go="`vpc.SecurityGroupIngressRule`" pulumi-lang-python="`vpc.SecurityGroupIngressRule`" pulumi-lang-yaml="`aws.vpc.SecurityGroupIngressRule`" pulumi-lang-java="`aws.vpc.SecurityGroupIngressRule`">`aws.vpc.SecurityGroupIngressRule`</span> resources with one CIDR block per rule.
///
/// !> **WARNING:** You should not use the <span pulumi-lang-nodejs="`aws.ec2.SecurityGroupRule`" pulumi-lang-dotnet="`aws.ec2.SecurityGroupRule`" pulumi-lang-go="`ec2.SecurityGroupRule`" pulumi-lang-python="`ec2.SecurityGroupRule`" pulumi-lang-yaml="`aws.ec2.SecurityGroupRule`" pulumi-lang-java="`aws.ec2.SecurityGroupRule`">`aws.ec2.SecurityGroupRule`</span> resource in conjunction with <span pulumi-lang-nodejs="`aws.vpc.SecurityGroupEgressRule`" pulumi-lang-dotnet="`aws.vpc.SecurityGroupEgressRule`" pulumi-lang-go="`vpc.SecurityGroupEgressRule`" pulumi-lang-python="`vpc.SecurityGroupEgressRule`" pulumi-lang-yaml="`aws.vpc.SecurityGroupEgressRule`" pulumi-lang-java="`aws.vpc.SecurityGroupEgressRule`">`aws.vpc.SecurityGroupEgressRule`</span> and <span pulumi-lang-nodejs="`aws.vpc.SecurityGroupIngressRule`" pulumi-lang-dotnet="`aws.vpc.SecurityGroupIngressRule`" pulumi-lang-go="`vpc.SecurityGroupIngressRule`" pulumi-lang-python="`vpc.SecurityGroupIngressRule`" pulumi-lang-yaml="`aws.vpc.SecurityGroupIngressRule`" pulumi-lang-java="`aws.vpc.SecurityGroupIngressRule`">`aws.vpc.SecurityGroupIngressRule`</span> resources or with an <span pulumi-lang-nodejs="`aws.ec2.SecurityGroup`" pulumi-lang-dotnet="`aws.ec2.SecurityGroup`" pulumi-lang-go="`ec2.SecurityGroup`" pulumi-lang-python="`ec2.SecurityGroup`" pulumi-lang-yaml="`aws.ec2.SecurityGroup`" pulumi-lang-java="`aws.ec2.SecurityGroup`">`aws.ec2.SecurityGroup`</span> resource that has in-line rules. Doing so may cause rule conflicts, perpetual differences, and result in rules being overwritten.
///
/// > **NOTE:** Setting `protocol = "all"` or `protocol = -1` with <span pulumi-lang-nodejs="`fromPort`" pulumi-lang-dotnet="`FromPort`" pulumi-lang-go="`fromPort`" pulumi-lang-python="`from_port`" pulumi-lang-yaml="`fromPort`" pulumi-lang-java="`fromPort`">`from_port`</span> and <span pulumi-lang-nodejs="`toPort`" pulumi-lang-dotnet="`ToPort`" pulumi-lang-go="`toPort`" pulumi-lang-python="`to_port`" pulumi-lang-yaml="`toPort`" pulumi-lang-java="`toPort`">`to_port`</span> will result in the EC2 API creating a security group rule with all ports open. This API behavior cannot be controlled by this provider and may generate warnings in the future.
///
...
/// <!--End PulumiCodeChooser -->
///
/// You can also find a specific Prefix List using the <span pulumi-lang-nodejs="`aws.ec2.getPrefixList`" pulumi-lang-dotnet="`aws.ec2.getPrefixList`" pulumi-lang-go="`ec2.getPrefixList`" pulumi-lang-python="`ec2_get_prefix_list`" pulumi-lang-yaml="`aws.ec2.getPrefixList`" pulumi-lang-java="`aws.ec2.getPrefixList`">`aws.ec2.getPrefixList`</span>
/// or <span pulumi-lang-nodejs="`ec2ManagedPrefixList`" pulumi-lang-dotnet="`Ec2ManagedPrefixList`" pulumi-lang-go="`ec2ManagedPrefixList`" pulumi-lang-python="`ec2_managed_prefix_list`" pulumi-lang-yaml="`ec2ManagedPrefixList`" pulumi-lang-java="`ec2ManagedPrefixList`">`ec2_managed_prefix_list`</span> data sources:
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
///
///
/// **Using `pulumi import` to import** Security Group Rules using the <span pulumi-lang-nodejs="`securityGroupId`" pulumi-lang-dotnet="`SecurityGroupId`" pulumi-lang-go="`securityGroupId`" pulumi-lang-python="`security_group_id`" pulumi-lang-yaml="`securityGroupId`" pulumi-lang-java="`securityGroupId`">`security_group_id`</span>, <span pulumi-lang-nodejs="`type`" pulumi-lang-dotnet="`Type`" pulumi-lang-go="`type`" pulumi-lang-python="`type`" pulumi-lang-yaml="`type`" pulumi-lang-java="`type`">`type`</span>, <span pulumi-lang-nodejs="`protocol`" pulumi-lang-dotnet="`Protocol`" pulumi-lang-go="`protocol`" pulumi-lang-python="`protocol`" pulumi-lang-yaml="`protocol`" pulumi-lang-java="`protocol`">`protocol`</span>, <span pulumi-lang-nodejs="`fromPort`" pulumi-lang-dotnet="`FromPort`" pulumi-lang-go="`fromPort`" pulumi-lang-python="`from_port`" pulumi-lang-yaml="`fromPort`" pulumi-lang-java="`fromPort`">`from_port`</span>, <span pulumi-lang-nodejs="`toPort`" pulumi-lang-dotnet="`ToPort`" pulumi-lang-go="`toPort`" pulumi-lang-python="`to_port`" pulumi-lang-yaml="`toPort`" pulumi-lang-java="`toPort`">`to_port`</span>, and source(s)/destination(s) (such as a <span pulumi-lang-nodejs="`cidrBlock`" pulumi-lang-dotnet="`CidrBlock`" pulumi-lang-go="`cidrBlock`" pulumi-lang-python="`cidr_block`" pulumi-lang-yaml="`cidrBlock`" pulumi-lang-java="`cidrBlock`">`cidr_block`</span>) separated by underscores (`_`). All parts are required. For example:
///
...
class SecurityGroupRule extends CustomResource {
  ...
  late final Output<List<String>?> ipv6CidrBlocks;

  /// List of Prefix List IDs.
  late final Output<List<String>?> prefixListIds;
  ...
  /// If the <span pulumi-lang-nodejs="`aws.ec2.SecurityGroupRule`" pulumi-lang-dotnet="`aws.ec2.SecurityGroupRule`" pulumi-lang-go="`ec2.SecurityGroupRule`" pulumi-lang-python="`ec2.SecurityGroupRule`" pulumi-lang-yaml="`aws.ec2.SecurityGroupRule`" pulumi-lang-java="`aws.ec2.SecurityGroupRule`">`aws.ec2.SecurityGroupRule`</span> resource has a single source or destination then this is the AWS Security Group Rule resource ID. Otherwise it is empty.
