...
class GetNetworkInsightsAnalysisExplanationSourceVpc {
  ...
  factory GetNetworkInsightsAnalysisExplanationSourceVpc.fromMap(
      Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationSourceVpc(
