...
class AmiFromInstance extends CustomResource {
  ...
  AmiFromInstance(
    ...
    this.ebsBlockDevices =
        Output.createUnknown<List<AmiFromInstanceEbsBlockDevice>>();
    this.enaSupport = Output.createUnknown<bool>();
    this.ephemeralBlockDevices =
        Output.createUnknown<List<AmiFromInstanceEphemeralBlockDevice>>();
    ...
    this.snapshotWithoutReboot = Output.createUnknown<bool?>();
    this.sourceInstanceId = Output.createUnknown<String>();
