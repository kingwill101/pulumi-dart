...
class SpotFleetRequestArgs {
  ...
  factory SpotFleetRequestArgs.fromMap(Map<String, dynamic> map) {
    return SpotFleetRequestArgs(
      allocationStrategy:
          pulumi.Input.asOptionalInput<String>(map['allocationStrategy']),
      ...
      iamFleetRole: pulumi.Input.asInput<String>(map['iamFleetRole']),
      instanceInterruptionBehaviour: pulumi.Input.asOptionalInput<String>(
          map['instanceInterruptionBehaviour']),
      instancePoolsToUseCount:
          pulumi.Input.asOptionalInput<int>(map['instancePoolsToUseCount']),
      ...
      onDemandAllocationStrategy: pulumi.Input.asOptionalInput<String>(
          map['onDemandAllocationStrategy']),
      onDemandMaxTotalPrice:
          pulumi.Input.asOptionalInput<String>(map['onDemandMaxTotalPrice']),
      onDemandTargetCapacity:
          pulumi.Input.asOptionalInput<int>(map['onDemandTargetCapacity']),
      ...
      targetCapacity: pulumi.Input.asInput<int>(map['targetCapacity']),
      targetCapacityUnitType:
          pulumi.Input.asOptionalInput<String>(map['targetCapacityUnitType']),
      targetGroupArns:
          pulumi.Input.asOptionalInput<List<String>>(map['targetGroupArns']),
      terminateInstancesOnDelete: pulumi.Input.asOptionalInput<String>(
          map['terminateInstancesOnDelete']),
      ...
      waitForFulfillment:
          pulumi.Input.asOptionalInput<bool>(map['waitForFulfillment']),
    );
  }
}
