...
/// <!--End PulumiCodeChooser -->
///
/// > **NOTE:** This provider does not support the functionality where multiple <span pulumi-lang-nodejs="`subnetId`" pulumi-lang-dotnet="`SubnetId`" pulumi-lang-go="`subnetId`" pulumi-lang-python="`subnet_id`" pulumi-lang-yaml="`subnetId`" pulumi-lang-java="`subnetId`">`subnet_id`</span> or <span pulumi-lang-nodejs="`availabilityZone`" pulumi-lang-dotnet="`AvailabilityZone`" pulumi-lang-go="`availabilityZone`" pulumi-lang-python="`availability_zone`" pulumi-lang-yaml="`availabilityZone`" pulumi-lang-java="`availabilityZone`">`availability_zone`</span> parameters can be specified in the same
...
/// <!--End PulumiCodeChooser -->
///
/// > In this example, we use a <span pulumi-lang-nodejs="`dynamic`" pulumi-lang-dotnet="`Dynamic`" pulumi-lang-go="`dynamic`" pulumi-lang-python="`dynamic`" pulumi-lang-yaml="`dynamic`" pulumi-lang-java="`dynamic`">`dynamic`</span> block to define zero or more <span pulumi-lang-nodejs="`launchSpecification`" pulumi-lang-dotnet="`LaunchSpecification`" pulumi-lang-go="`launchSpecification`" pulumi-lang-python="`launch_specification`" pulumi-lang-yaml="`launchSpecification`" pulumi-lang-java="`launchSpecification`">`launch_specification`</span> blocks, producing one for each element in the list of subnet ids.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import Spot Fleet Requests using <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
