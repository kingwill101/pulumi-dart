...
class VpnConnectionArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (tunnel1LogOptionsValue != null) {
      map['tunnel1LogOptions'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (tunnel2LogOptionsValue != null) {
      map['tunnel2LogOptions'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory VpnConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VpnConnectionArgs(
      customerGatewayId: pulumi.Input.asInput<String>(map['customerGatewayId']),
      enableAcceleration:
          pulumi.Input.asOptionalInput<bool>(map['enableAcceleration']),
      localIpv4NetworkCidr:
          pulumi.Input.asOptionalInput<String>(map['localIpv4NetworkCidr']),
      localIpv6NetworkCidr:
          pulumi.Input.asOptionalInput<String>(map['localIpv6NetworkCidr']),
      outsideIpAddressType:
          pulumi.Input.asOptionalInput<String>(map['outsideIpAddressType']),
      presharedKeyStorage:
          pulumi.Input.asOptionalInput<String>(map['presharedKeyStorage']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      remoteIpv4NetworkCidr:
          pulumi.Input.asOptionalInput<String>(map['remoteIpv4NetworkCidr']),
      remoteIpv6NetworkCidr:
          pulumi.Input.asOptionalInput<String>(map['remoteIpv6NetworkCidr']),
      staticRoutesOnly:
          pulumi.Input.asOptionalInput<bool>(map['staticRoutesOnly']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      transitGatewayId:
          pulumi.Input.asOptionalInput<String>(map['transitGatewayId']),
      transportTransitGatewayAttachmentId: pulumi.Input.asOptionalInput<String>(
          map['transportTransitGatewayAttachmentId']),
      tunnel1DpdTimeoutAction:
          pulumi.Input.asOptionalInput<String>(map['tunnel1DpdTimeoutAction']),
      tunnel1DpdTimeoutSeconds:
          pulumi.Input.asOptionalInput<int>(map['tunnel1DpdTimeoutSeconds']),
      tunnel1EnableTunnelLifecycleControl: pulumi.Input.asOptionalInput<bool>(
          map['tunnel1EnableTunnelLifecycleControl']),
      tunnel1IkeVersions:
          pulumi.Input.asOptionalInput<List<String>>(map['tunnel1IkeVersions']),
      tunnel1InsideCidr:
          pulumi.Input.asOptionalInput<String>(map['tunnel1InsideCidr']),
      tunnel1InsideIpv6Cidr:
          pulumi.Input.asOptionalInput<String>(map['tunnel1InsideIpv6Cidr']),
      tunnel1LogOptions:
          pulumi.Input.asOptionalInput<VpnConnectionTunnel1LogOptions>(
              map['tunnel1LogOptions']),
      tunnel1Phase1DhGroupNumbers: pulumi.Input.asOptionalInput<List<int>>(
          map['tunnel1Phase1DhGroupNumbers']),
      tunnel1Phase1EncryptionAlgorithms:
      ...
      tunnel1Phase1IntegrityAlgorithms:
          pulumi.Input.asOptionalInput<List<String>>(
              map['tunnel1Phase1IntegrityAlgorithms']),
      tunnel1Phase1LifetimeSeconds: pulumi.Input.asOptionalInput<int>(
          map['tunnel1Phase1LifetimeSeconds']),
      tunnel1Phase2DhGroupNumbers: pulumi.Input.asOptionalInput<List<int>>(
          map['tunnel1Phase2DhGroupNumbers']),
      tunnel1Phase2EncryptionAlgorithms:
          pulumi.Input.asOptionalInput<List<String>>(
              map['tunnel1Phase2EncryptionAlgorithms']),
      tunnel1Phase2IntegrityAlgorithms:
          pulumi.Input.asOptionalInput<List<String>>(
              map['tunnel1Phase2IntegrityAlgorithms']),
      tunnel1Phase2LifetimeSeconds: pulumi.Input.asOptionalInput<int>(
          map['tunnel1Phase2LifetimeSeconds']),
      tunnel1PresharedKey:
          pulumi.Input.asOptionalInput<String>(map['tunnel1PresharedKey']),
      tunnel1RekeyFuzzPercentage:
          pulumi.Input.asOptionalInput<int>(map['tunnel1RekeyFuzzPercentage']),
      tunnel1RekeyMarginTimeSeconds: pulumi.Input.asOptionalInput<int>(
          map['tunnel1RekeyMarginTimeSeconds']),
      tunnel1ReplayWindowSize:
          pulumi.Input.asOptionalInput<int>(map['tunnel1ReplayWindowSize']),
      tunnel1StartupAction:
          pulumi.Input.asOptionalInput<String>(map['tunnel1StartupAction']),
      tunnel2DpdTimeoutAction:
          pulumi.Input.asOptionalInput<String>(map['tunnel2DpdTimeoutAction']),
      tunnel2DpdTimeoutSeconds:
          pulumi.Input.asOptionalInput<int>(map['tunnel2DpdTimeoutSeconds']),
      tunnel2EnableTunnelLifecycleControl: pulumi.Input.asOptionalInput<bool>(
          map['tunnel2EnableTunnelLifecycleControl']),
      tunnel2IkeVersions:
          pulumi.Input.asOptionalInput<List<String>>(map['tunnel2IkeVersions']),
      tunnel2InsideCidr:
          pulumi.Input.asOptionalInput<String>(map['tunnel2InsideCidr']),
      tunnel2InsideIpv6Cidr:
          pulumi.Input.asOptionalInput<String>(map['tunnel2InsideIpv6Cidr']),
      tunnel2LogOptions:
          pulumi.Input.asOptionalInput<VpnConnectionTunnel2LogOptions>(
              map['tunnel2LogOptions']),
      tunnel2Phase1DhGroupNumbers: pulumi.Input.asOptionalInput<List<int>>(
          map['tunnel2Phase1DhGroupNumbers']),
      tunnel2Phase1EncryptionAlgorithms:
          pulumi.Input.asOptionalInput<List<String>>(
              map['tunnel2Phase1EncryptionAlgorithms']),
      tunnel2Phase1IntegrityAlgorithms:
          pulumi.Input.asOptionalInput<List<String>>(
              map['tunnel2Phase1IntegrityAlgorithms']),
      tunnel2Phase1LifetimeSeconds: pulumi.Input.asOptionalInput<int>(
          map['tunnel2Phase1LifetimeSeconds']),
      tunnel2Phase2DhGroupNumbers: pulumi.Input.asOptionalInput<List<int>>(
          map['tunnel2Phase2DhGroupNumbers']),
      tunnel2Phase2EncryptionAlgorithms:
          pulumi.Input.asOptionalInput<List<String>>(
              map['tunnel2Phase2EncryptionAlgorithms']),
      tunnel2Phase2IntegrityAlgorithms:
          pulumi.Input.asOptionalInput<List<String>>(
              map['tunnel2Phase2IntegrityAlgorithms']),
      tunnel2Phase2LifetimeSeconds: pulumi.Input.asOptionalInput<int>(
          map['tunnel2Phase2LifetimeSeconds']),
      tunnel2PresharedKey:
          pulumi.Input.asOptionalInput<String>(map['tunnel2PresharedKey']),
      tunnel2RekeyFuzzPercentage:
          pulumi.Input.asOptionalInput<int>(map['tunnel2RekeyFuzzPercentage']),
      tunnel2RekeyMarginTimeSeconds: pulumi.Input.asOptionalInput<int>(
          map['tunnel2RekeyMarginTimeSeconds']),
      tunnel2ReplayWindowSize:
          pulumi.Input.asOptionalInput<int>(map['tunnel2ReplayWindowSize']),
      tunnel2StartupAction:
          pulumi.Input.asOptionalInput<String>(map['tunnel2StartupAction']),
      tunnelBandwidth:
          pulumi.Input.asOptionalInput<String>(map['tunnelBandwidth']),
      tunnelInsideIpVersion:
          pulumi.Input.asOptionalInput<String>(map['tunnelInsideIpVersion']),
      type: pulumi.Input.asInput<String>(map['type']),
      vpnConcentratorId:
          pulumi.Input.asOptionalInput<String>(map['vpnConcentratorId']),
