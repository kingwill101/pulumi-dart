...
class GetVpcEndpointArgs {
  ...
  factory GetVpcEndpointArgs.fromMap(Map<String, dynamic> map) {
    return GetVpcEndpointArgs(
      filters: pulumi.Input.asOptionalInput<List<GetVpcEndpointFilter>>(
          map['filters']),
      id: pulumi.Input.asOptionalInput<String>(map['id']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      serviceName: pulumi.Input.asOptionalInput<String>(map['serviceName']),
      serviceRegion: pulumi.Input.asOptionalInput<String>(map['serviceRegion']),
      state: pulumi.Input.asOptionalInput<String>(map['state']),
      tags: pulumi.Input.asOptionalInput<Map<String, String>>(map['tags']),
      vpcEndpointType:
          pulumi.Input.asOptionalInput<String>(map['vpcEndpointType']),
