...
class EndpointAccessVpcEndpointNetworkInterfaceRedshiftserverless {
  ...
  factory EndpointAccessVpcEndpointNetworkInterfaceRedshiftserverless.fromMap(
      Map<String, dynamic> map) {
    return EndpointAccessVpcEndpointNetworkInterfaceRedshiftserverless(
