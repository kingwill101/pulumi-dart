...
import 'namespace_redshiftserverless_args.dart';
...
/// ```
class NamespaceRedshiftserverless extends pulumi.CustomResource {
  ...
  NamespaceRedshiftserverless(
    String name, {
    NamespaceRedshiftserverlessArgs? args,
