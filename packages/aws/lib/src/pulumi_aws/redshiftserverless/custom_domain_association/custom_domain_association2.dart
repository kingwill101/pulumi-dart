...
/// ## Import
///
/// Using `pulumi import`, import Redshift Serverless Custom Domain Association using the <span pulumi-lang-nodejs="`workgroupName`" pulumi-lang-dotnet="`WorkgroupName`" pulumi-lang-go="`workgroupName`" pulumi-lang-python="`workgroup_name`" pulumi-lang-yaml="`workgroupName`" pulumi-lang-java="`workgroupName`">`workgroup_name`</span> and <span pulumi-lang-nodejs="`customDomainName`" pulumi-lang-dotnet="`CustomDomainName`" pulumi-lang-go="`customDomainName`" pulumi-lang-python="`custom_domain_name`" pulumi-lang-yaml="`customDomainName`" pulumi-lang-java="`customDomainName`">`custom_domain_name`</span>, separated by the coma. For example:
///
/// ```sh
