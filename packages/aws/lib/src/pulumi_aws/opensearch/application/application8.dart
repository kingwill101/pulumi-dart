...
/// ## Import
///
/// Using `pulumi import`, import OpenSearch applications using the <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:opensearch/application:Application example app-1234567890abcdef0
/// ```
class Application8 extends CustomResource {
  /// Configuration block(s) for OpenSearch application settings. See App Config below.
  late final Output<List<ApplicationAppConfig>?> appConfigs;
  ...
  late final Output<List<ApplicationDataSource>?> dataSources;
  ...
  late final Output<ApplicationIamIdentityCenterOptions?>
      iamIdentityCenterOptions;
  ...
  late final Output<ApplicationTimeouts2?> timeouts;

  Application8(
    String name, {
    ApplicationArgs8? args,
