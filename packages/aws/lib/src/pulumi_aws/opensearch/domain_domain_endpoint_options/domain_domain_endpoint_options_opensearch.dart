...
class DomainDomainEndpointOptionsOpensearch {
  ...
  DomainDomainEndpointOptionsOpensearch({
    this.customEndpoint,
  ...
  factory DomainDomainEndpointOptionsOpensearch.fromMap(
      Map<String, dynamic> map) {
    return DomainDomainEndpointOptionsOpensearch(
