...
class GetDomainLogPublishingOption2 {
  ...
  factory GetDomainLogPublishingOption2.fromMap(Map<String, dynamic> map) {
    return GetDomainLogPublishingOption2(
