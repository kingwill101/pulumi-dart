...
class DomainAdvancedSecurityOptionsMasterUserOptionsOpensearch {
  ...
  DomainAdvancedSecurityOptionsMasterUserOptionsOpensearch({
    this.masterUserArn,
    this.masterUserName,
  ...
  factory DomainAdvancedSecurityOptionsMasterUserOptionsOpensearch.fromMap(
      Map<String, dynamic> map) {
    return DomainAdvancedSecurityOptionsMasterUserOptionsOpensearch(
      masterUserArn:
