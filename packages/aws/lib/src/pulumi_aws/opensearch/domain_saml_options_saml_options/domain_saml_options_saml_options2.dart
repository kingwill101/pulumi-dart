...
import '../domain_saml_options_saml_options_idp/domain_saml_options_saml_options_idp2.dart';

class DomainSamlOptionsSamlOptions2 {
  /// Whether SAML authentication is enabled.
  final bool? enabled;

  /// Information from your identity provider.
  final DomainSamlOptionsSamlOptionsIdp2? idp;
  ...
  factory DomainSamlOptionsSamlOptions2.fromMap(Map<String, dynamic> map) {
    return DomainSamlOptionsSamlOptions2(
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      idp: map['idp'] == null
          ? null
          : DomainSamlOptionsSamlOptionsIdp2.fromMap(
