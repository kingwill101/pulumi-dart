...
import '../domain_saml_options_saml_options_idp/domain_saml_options_saml_options_idp_opensearch.dart';

class DomainSamlOptionsSamlOptionsOpensearch {
  /// Whether SAML authentication is enabled.
  final bool? enabled;

  /// Information from your identity provider.
  final DomainSamlOptionsSamlOptionsIdpOpensearch? idp;
  ...
  factory DomainSamlOptionsSamlOptionsOpensearch.fromMap(
      Map<String, dynamic> map) {
    return DomainSamlOptionsSamlOptionsOpensearch(
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      idp: map['idp'] == null
          ? null
          : DomainSamlOptionsSamlOptionsIdpOpensearch.fromMap(
