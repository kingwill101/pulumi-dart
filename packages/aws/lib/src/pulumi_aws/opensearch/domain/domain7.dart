...
///
/// * OpenSearch has <span pulumi-lang-nodejs="`engineVersion`" pulumi-lang-dotnet="`EngineVersion`" pulumi-lang-go="`engineVersion`" pulumi-lang-python="`engine_version`" pulumi-lang-yaml="`engineVersion`" pulumi-lang-java="`engineVersion`">`engine_version`</span> while Elasticsearch has <span pulumi-lang-nodejs="`elasticsearchVersion`" pulumi-lang-dotnet="`ElasticsearchVersion`" pulumi-lang-go="`elasticsearchVersion`" pulumi-lang-python="`elasticsearch_version`" pulumi-lang-yaml="`elasticsearchVersion`" pulumi-lang-java="`elasticsearchVersion`">`elasticsearch_version`</span>
/// * Versions are specified differently - _e.g._, `Elasticsearch_7.10` with OpenSearch vs. `7.10` for Elasticsearch.
/// * <span pulumi-lang-nodejs="`instanceType`" pulumi-lang-dotnet="`InstanceType`" pulumi-lang-go="`instanceType`" pulumi-lang-python="`instance_type`" pulumi-lang-yaml="`instanceType`" pulumi-lang-java="`instanceType`">`instance_type`</span> argument values end in <span pulumi-lang-nodejs="`search`" pulumi-lang-dotnet="`Search`" pulumi-lang-go="`search`" pulumi-lang-python="`search`" pulumi-lang-yaml="`search`" pulumi-lang-java="`search`">`search`</span> for OpenSearch vs. <span pulumi-lang-nodejs="`elasticsearch`" pulumi-lang-dotnet="`Elasticsearch`" pulumi-lang-go="`elasticsearch`" pulumi-lang-python="`elasticsearch`" pulumi-lang-yaml="`elasticsearch`" pulumi-lang-java="`elasticsearch`">`elasticsearch`</span> for Elasticsearch (_e.g._, `t2.micro.search` vs. `t2.micro.elasticsearch`).
...
/// * IAM policy actions, such as those you will find in <span pulumi-lang-nodejs="`accessPolicies`" pulumi-lang-dotnet="`AccessPolicies`" pulumi-lang-go="`accessPolicies`" pulumi-lang-python="`access_policies`" pulumi-lang-yaml="`accessPolicies`" pulumi-lang-java="`accessPolicies`">`access_policies`</span>, are prefaced with `es:` for both.
///
/// ## Example Usage
///
/// ### Basic Usage
...
/// ### Access Policy
///
/// > See also: <span pulumi-lang-nodejs="`aws.opensearch.DomainPolicy`" pulumi-lang-dotnet="`aws.opensearch.DomainPolicy`" pulumi-lang-go="`opensearch.DomainPolicy`" pulumi-lang-python="`opensearch.DomainPolicy`" pulumi-lang-yaml="`aws.opensearch.DomainPolicy`" pulumi-lang-java="`aws.opensearch.DomainPolicy`">`aws.opensearch.DomainPolicy`</span> resource
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ### Second apply
///
/// Notice that the only change is `advanced_security_options.0.enabled` is now set to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`">`true`</span>.
///
/// <!--Start PulumiCodeChooser -->
/// ```typescript
/// import * as pulumi from "@pulumi/pulumi";
...
/// ## Import
///
/// Using `pulumi import`, import OpenSearch domains using the <span pulumi-lang-nodejs="`domainName`" pulumi-lang-dotnet="`DomainName`" pulumi-lang-go="`domainName`" pulumi-lang-python="`domain_name`" pulumi-lang-yaml="`domainName`" pulumi-lang-java="`domainName`">`domain_name`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:opensearch/domain:Domain example domain_name
/// ```
class Domain7 extends CustomResource {
  ...
  late final Output<DomainAdvancedSecurityOptions2> advancedSecurityOptions;

  /// Configuration block for parameters required to enable all machine learning features. Detailed below.
  late final Output<DomainAimlOptions> aimlOptions;

  /// ARN of the domain.
  late final Output<String> arn;

  /// Configuration block for the Auto-Tune options of the domain. Detailed below.
  late final Output<DomainAutoTuneOptions2> autoTuneOptions;

  /// Configuration block for the cluster of the domain. Detailed below.
  late final Output<DomainClusterConfig2> clusterConfig;

  /// Configuration block for authenticating dashboard with Cognito. Detailed below.
  late final Output<DomainCognitoOptions2?> cognitoOptions;
  ...
  late final Output<String> dashboardEndpointV2;

  /// Configuration block for domain endpoint HTTP(S) related options. Detailed below.
  late final Output<DomainDomainEndpointOptions2> domainEndpointOptions;

  /// Dual stack hosted zone ID for the domain.
  late final Output<String> domainEndpointV2HostedZoneId;
  ...
  late final Output<DomainEbsOptions2> ebsOptions;
  ...
  late final Output<DomainEncryptAtRest2> encryptAtRest;
  ...
  late final Output<String> endpointV2;
  ...
  late final Output<DomainIdentityCenterOptions?> identityCenterOptions;
  ...
  late final Output<List<DomainLogPublishingOption2>?> logPublishingOptions;

  /// Configuration block for node-to-node encryption options. Detailed below.
  late final Output<DomainNodeToNodeEncryption2> nodeToNodeEncryption;
  ...
  late final Output<DomainOffPeakWindowOptions> offPeakWindowOptions;

  /// Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
  late final Output<String> region;

  /// Configuration block for snapshot related options. Detailed below. DEPRECATED. For domains running OpenSearch 5.3 and later, Amazon OpenSearch takes hourly automated snapshots, making this setting irrelevant. For domains running earlier versions, OpenSearch takes daily automated snapshots.
  late final Output<DomainSnapshotOptions2?> snapshotOptions;

  /// Software update options for the domain. Detailed below.
  late final Output<DomainSoftwareUpdateOptions> softwareUpdateOptions;
  ...
  late final Output<DomainVpcOptions2?> vpcOptions;
