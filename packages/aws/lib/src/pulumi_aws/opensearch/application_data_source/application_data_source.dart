...
class ApplicationDataSource {
  ...
  Map<String, dynamic> toMap() {
    ...
    final dataSourceArnValue = dataSourceArn;
    if (dataSourceArnValue != null) {
      map['dataSourceArn'] = dataSourceArnValue;
    }
    final dataSourceDescriptionValue = dataSourceDescription;
    if (dataSourceDescriptionValue != null) {
      map['dataSourceDescription'] = dataSourceDescriptionValue;
    }
    return map;
  }
  ...
  factory ApplicationDataSource.fromMap(Map<String, dynamic> map) {
    return ApplicationDataSource(
      dataSourceArn:
          map['dataSourceArn'] == null ? null : map['dataSourceArn'] as String,
