...
class DomainClusterConfigZoneAwarenessConfigOpensearch {
  /// Number of Availability Zones for the domain to use with `zone_awareness_enabled`. Defaults to `2`. Valid values: `2` or `3`.
  final int? availabilityZoneCount;

  DomainClusterConfigZoneAwarenessConfigOpensearch({
  ...
  factory DomainClusterConfigZoneAwarenessConfigOpensearch.fromMap(
      Map<String, dynamic> map) {
    return DomainClusterConfigZoneAwarenessConfigOpensearch(
