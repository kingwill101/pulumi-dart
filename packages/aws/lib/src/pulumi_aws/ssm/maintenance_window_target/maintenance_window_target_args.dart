...
class MaintenanceWindowTargetArgs {
  ...
  final Input<String>? ownerInformation;
  ...
  final Input<List<MaintenanceWindowTargetTarget>> targets;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['targets'] = Input.mapInputValue<List<MaintenanceWindowTargetTarget>,
            List<Map<String, dynamic>>>(
        targets,
        (value) => Input.encodeList<MaintenanceWindowTargetTarget,
  ...
  factory MaintenanceWindowTargetArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowTargetArgs(
      ...
      ownerInformation: Input.asOptionalInput<String>(map['ownerInformation']),
      region: Input.asOptionalInput<String>(map['region']),
      resourceType: Input.asInput<String>(map['resourceType']),
      targets:
          Input.asInput<List<MaintenanceWindowTargetTarget>>(map['targets']),
