...
/// ## Import
///
/// Using `pulumi import`, import AWS SSM Activation using the <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:ssm/activation:Activation example e488f2f6-e686-4afb-8a04-ef6dfEXAMPLE
/// ```
///
/// > **Note:** The <span pulumi-lang-nodejs="`activationCode`" pulumi-lang-dotnet="`ActivationCode`" pulumi-lang-go="`activationCode`" pulumi-lang-python="`activation_code`" pulumi-lang-yaml="`activationCode`" pulumi-lang-java="`activationCode`">`activation_code`</span> attribute cannot be imported.
