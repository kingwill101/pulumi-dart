...
/// #### Required
///
/// * <span pulumi-lang-nodejs="`associationId`" pulumi-lang-dotnet="`AssociationId`" pulumi-lang-go="`associationId`" pulumi-lang-python="`association_id`" pulumi-lang-yaml="`associationId`" pulumi-lang-java="`associationId`">`association_id`</span> - (String) ID of the SSM association.
///
/// #### Optional
///
...
///
///
/// Using `pulumi import`, import SSM associations using the <span pulumi-lang-nodejs="`associationId`" pulumi-lang-dotnet="`AssociationId`" pulumi-lang-go="`associationId`" pulumi-lang-python="`association_id`" pulumi-lang-yaml="`associationId`" pulumi-lang-java="`associationId`">`association_id`</span>. For example:
///
/// ```sh
/// $ pulumi import aws:ssm/association:Association example 10abcdef-0abc-1234-5678-90abcdef123456
/// ```
class Association2 extends CustomResource {
  ...
  late final Output<bool?> applyOnlyAtCronInterval;
  ...
  late final Output<String?> associationName;
  ...
  late final Output<String?> syncCompliance;
  ...
  late final Output<List<AssociationTarget>> targets;
  ...
  late final Output<int?> waitForSuccessTimeoutSeconds;

  Association2(
    String name, {
    AssociationArgs2? args,
