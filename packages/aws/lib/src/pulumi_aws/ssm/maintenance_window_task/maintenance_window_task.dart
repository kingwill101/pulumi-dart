...
/// * <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`">`id`</span> - (String) ID of the maintenance window task.
///
/// #### Optional
///
...
///
///
/// Using `pulumi import`, import AWS Maintenance Window Task using the <span pulumi-lang-nodejs="`windowId`" pulumi-lang-dotnet="`WindowId`" pulumi-lang-go="`windowId`" pulumi-lang-python="`window_id`" pulumi-lang-yaml="`windowId`" pulumi-lang-java="`windowId`">`window_id`</span> and <span pulumi-lang-nodejs="`windowTaskId`" pulumi-lang-dotnet="`WindowTaskId`" pulumi-lang-go="`windowTaskId`" pulumi-lang-python="`window_task_id`" pulumi-lang-yaml="`windowTaskId`" pulumi-lang-java="`windowTaskId`">`window_task_id`</span> separated by `/`. For example:
///
/// ```sh
/// $ pulumi import aws:ssm/maintenanceWindowTask:MaintenanceWindowTask example <window_id>/<window_task_id>
/// ```
class MaintenanceWindowTask extends CustomResource {
  /// The ARN of the maintenance window task.
  late final Output<String> arn;

  /// Indicates whether tasks should continue to run after the cutoff time specified in the maintenance windows is reached. Valid values are `CONTINUE_TASK` and `CANCEL_TASK`.
  late final Output<String?> cutoffBehavior;
  ...
  late final Output<List<MaintenanceWindowTaskTarget>?> targets;

  /// The ARN of the task to execute.
  late final Output<String> taskArn;

  /// Configuration block with parameters for task execution.
  late final Output<MaintenanceWindowTaskTaskInvocationParameters?>
      taskInvocationParameters;

  /// The type of task being registered. Valid values: `AUTOMATION`, `LAMBDA`, `RUN_COMMAND` or `STEP_FUNCTIONS`.
  late final Output<String> taskType;

  /// The Id of the maintenance window to register the task with.
  late final Output<String> windowId;

  /// The ID of the maintenance window task.
  late final Output<String> windowTaskId;
