...
class EventDataStoreArgs {
  ...
  factory EventDataStoreArgs.fromMap(Map<String, dynamic> map) {
    return EventDataStoreArgs(
      advancedEventSelectors: pulumi.Input.asOptionalInput<
              List<EventDataStoreAdvancedEventSelector>>(
      ...
      multiRegionEnabled:
          pulumi.Input.asOptionalInput<bool>(map['multiRegionEnabled']),
      name: pulumi.Input.asOptionalInput<String>(map['name']),
      organizationEnabled:
          pulumi.Input.asOptionalInput<bool>(map['organizationEnabled']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      retentionPeriod:
          pulumi.Input.asOptionalInput<int>(map['retentionPeriod']),
      suspend: pulumi.Input.asOptionalInput<String>(map['suspend']),
