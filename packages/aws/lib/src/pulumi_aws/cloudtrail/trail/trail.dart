...
/// For capturing events from services like IAM, <span pulumi-lang-nodejs="`includeGlobalServiceEvents`" pulumi-lang-dotnet="`IncludeGlobalServiceEvents`" pulumi-lang-go="`includeGlobalServiceEvents`" pulumi-lang-python="`include_global_service_events`" pulumi-lang-yaml="`includeGlobalServiceEvents`" pulumi-lang-java="`includeGlobalServiceEvents`">`include_global_service_events`</span> must be enabled.
///
...
/// ## Import
///
/// Using `pulumi import`, import Cloudtrails using the <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span>. For example:
///
/// ```sh
