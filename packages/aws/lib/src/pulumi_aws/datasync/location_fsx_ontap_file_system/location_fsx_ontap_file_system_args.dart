...
class LocationFsxOntapFileSystemArgs {
  ...
  final Input<LocationFsxOntapFileSystemProtocol> protocol;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['protocol'] = Input.mapInputValue<LocationFsxOntapFileSystemProtocol,
  ...
  factory LocationFsxOntapFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return LocationFsxOntapFileSystemArgs(
      protocol:
          Input.asInput<LocationFsxOntapFileSystemProtocol>(map['protocol']),
      region: Input.asOptionalInput<String>(map['region']),
      securityGroupArns: Input.asInput<List<String>>(map['securityGroupArns']),
      storageVirtualMachineArn:
          Input.asInput<String>(map['storageVirtualMachineArn']),
