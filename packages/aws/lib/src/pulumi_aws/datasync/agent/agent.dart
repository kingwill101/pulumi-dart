...
///
/// > **NOTE:** One of <span pulumi-lang-nodejs="`activationKey`" pulumi-lang-dotnet="`ActivationKey`" pulumi-lang-go="`activationKey`" pulumi-lang-python="`activation_key`" pulumi-lang-yaml="`activationKey`" pulumi-lang-java="`activationKey`">`activation_key`</span> or <span pulumi-lang-nodejs="`ipAddress`" pulumi-lang-dotnet="`IpAddress`" pulumi-lang-go="`ipAddress`" pulumi-lang-python="`ip_address`" pulumi-lang-yaml="`ipAddress`" pulumi-lang-java="`ipAddress`">`ip_address`</span> must be provided for resource creation (agent activation). Neither is required for resource import. If using <span pulumi-lang-nodejs="`ipAddress`" pulumi-lang-dotnet="`IpAddress`" pulumi-lang-go="`ipAddress`" pulumi-lang-python="`ip_address`" pulumi-lang-yaml="`ipAddress`" pulumi-lang-java="`ipAddress`">`ip_address`</span>, this provider must be able to make an HTTP (port 80) GET request to the specified IP address from where it is running. The agent will turn off that HTTP server after activation.
///
/// ## Example Usage
///
...
/// #### Required
///
/// - <span pulumi-lang-nodejs="`arn`" pulumi-lang-dotnet="`Arn`" pulumi-lang-go="`arn`" pulumi-lang-python="`arn`" pulumi-lang-yaml="`arn`" pulumi-lang-java="`arn`">`arn`</span> (String) Amazon Resource Name (ARN) of the DataSync agent.
///
///
/// Using `pulumi import`, import <span pulumi-lang-nodejs="`aws.datasync.Agent`" pulumi-lang-dotnet="`aws.datasync.Agent`" pulumi-lang-go="`datasync.Agent`" pulumi-lang-python="`datasync.Agent`" pulumi-lang-yaml="`aws.datasync.Agent`" pulumi-lang-java="`aws.datasync.Agent`">`aws.datasync.Agent`</span> using the DataSync Agent Amazon Resource Name (ARN). For example:
///
/// ```sh
