...
class ResourceCloudcontrolArgs {
  ...
  factory ResourceCloudcontrolArgs.fromMap(Map<String, dynamic> map) {
    return ResourceCloudcontrolArgs(
      desiredState: pulumi.Input.asInput<String>(map['desiredState']),
