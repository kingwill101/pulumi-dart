...
class DbInstanceArgs {
  ...
  final Input<DbInstanceLogDeliveryConfiguration>? logDeliveryConfiguration;
  ...
  final Input<DbInstanceTimeouts>? timeouts;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (timeoutsValue != null) {
      map['timeouts'] =
          Input.mapOptionalInputValue<DbInstanceTimeouts, Map<String, dynamic>>(
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      allocatedStorage: Input.asInput<int>(map['allocatedStorage']),
      ...
      logDeliveryConfiguration:
          Input.asOptionalInput<DbInstanceLogDeliveryConfiguration>(
      ...
      timeouts: Input.asOptionalInput<DbInstanceTimeouts>(map['timeouts']),
