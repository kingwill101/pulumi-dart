...
class NotificationChannelArgs {
  ...
  NotificationChannelArgs({
    NotificationChannelFilters? filters,
    String? region,
    required NotificationChannelSns sns,
  }) :
  ...
  factory NotificationChannelArgs.fromMap(Map<String, dynamic> map) {
    return NotificationChannelArgs(
      filters: map['filters'] == null ? null : NotificationChannelFilters.fromMap((map['filters'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      sns: NotificationChannelSns.fromMap((map['sns'] as Map).cast<String, dynamic>()),
    );
  }
}
