...
class ResourceCollectionArgs {
  ...
  factory ResourceCollectionArgs.fromMap(Map<String, dynamic> map) {
    return ResourceCollectionArgs(
      cloudformation: map['cloudformation'] == null ? null : ResourceCollectionCloudformation.fromMap((map['cloudformation'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : ResourceCollectionTags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
