...
class ResourceConfigurationArgs {
  ...
  ResourceConfigurationArgs({
    ...
    String? protocol,
    String? region,
    ResourceConfigurationResourceConfigurationDefinition? resourceConfigurationDefinition,
  ...
  factory ResourceConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ResourceConfigurationArgs(
      allowAssociationToShareableServiceNetwork: map['allowAssociationToShareableServiceNetwork'] == null ? null : map['allowAssociationToShareableServiceNetwork'] as bool,
      customDomainName: map['customDomainName'] == null ? null : map['customDomainName'] as String,
      domainVerificationId: map['domainVerificationId'] == null ? null : map['domainVerificationId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      portRanges: map['portRanges'] == null ? null : (map['portRanges'] as List).cast<String>(),
      protocol: map['protocol'] == null ? null : map['protocol'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      resourceConfigurationDefinition: map['resourceConfigurationDefinition'] == null ? null : ResourceConfigurationResourceConfigurationDefinition.fromMap((map['resourceConfigurationDefinition'] as Map).cast<String, dynamic>()),
      resourceConfigurationGroupId: map['resourceConfigurationGroupId'] == null ? null : map['resourceConfigurationGroupId'] as String,
      resourceGatewayIdentifier: map['resourceGatewayIdentifier'] == null ? null : map['resourceGatewayIdentifier'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : ResourceConfigurationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
