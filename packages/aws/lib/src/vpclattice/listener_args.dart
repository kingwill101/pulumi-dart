...
class ListenerArgs {
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      defaultAction: ListenerDefaultAction.fromMap((map['defaultAction'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      port: map['port'] == null ? null : map['port'] as int,
      protocol: map['protocol'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      serviceArn: map['serviceArn'] == null ? null : map['serviceArn'] as String,
      serviceIdentifier: map['serviceIdentifier'] == null ? null : map['serviceIdentifier'] as String,
