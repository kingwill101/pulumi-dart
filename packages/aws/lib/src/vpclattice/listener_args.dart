...
class ListenerArgs {
  ...
  ListenerArgs({
    ...
    Map<String, String>? tags,
  }) : defaultAction = pulumi.Input.asInput<ListenerDefaultAction>(
         defaultAction,
       ),
       ...
       serviceIdentifier = pulumi.Input.asOptionalInput<String>(
         serviceIdentifier,
       ),
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      ...
      serviceArn: map['serviceArn'] == null
          ? null
          : map['serviceArn'] as String,
