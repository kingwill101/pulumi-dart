...
class ResourceConfigurationTimeouts {
  ...
  /// Creates a new [ResourceConfigurationTimeouts].
  ...
  ResourceConfigurationTimeouts({this.create, this.delete, this.update});
  ...
  factory ResourceConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return ResourceConfigurationTimeouts(
