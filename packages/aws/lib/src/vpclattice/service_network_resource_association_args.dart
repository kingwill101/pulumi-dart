...
class ServiceNetworkResourceAssociationArgs {
  ...
  factory ServiceNetworkResourceAssociationArgs.fromMap(Map<String, dynamic> map) {
    return ServiceNetworkResourceAssociationArgs(
      ...
      resourceConfigurationIdentifier: map['resourceConfigurationIdentifier'] as String,
      serviceNetworkIdentifier: map['serviceNetworkIdentifier'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : ServiceNetworkResourceAssociationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
