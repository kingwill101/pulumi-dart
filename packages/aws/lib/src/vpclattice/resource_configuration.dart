...
class ResourceConfiguration extends pulumi.CustomResource {
  ...
  ResourceConfiguration(
    ...
    this.allowAssociationToShareableServiceNetwork = registerOutput<bool>(
      'allowAssociationToShareableServiceNetwork',
    );
    this.arn = registerOutput<String>('arn');
    this.customDomainName = registerOutput<String?>('customDomainName');
    this.domainVerificationArn = registerOutput<String>(
      'domainVerificationArn',
    );
    this.domainVerificationId = registerOutput<String>('domainVerificationId');
    this.domainVerificationStatus = registerOutput<String>(
    ...
    this.resourceConfigurationGroupId = registerOutput<String?>(
      'resourceConfigurationGroupId',
    );
    this.resourceGatewayIdentifier = registerOutput<String>(
