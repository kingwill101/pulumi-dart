...
class WorkgroupConfigurationResultConfiguration {
  ...
  final WorkgroupConfigurationResultConfigurationAclConfiguration? aclConfiguration;
  /// Configuration block with encryption settings. See Encryption Configuration below.
  final WorkgroupConfigurationResultConfigurationEncryptionConfiguration? encryptionConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aclConfiguration': ?aclConfiguration == null ? null : aclConfiguration!.toMap(),
  ...
  factory WorkgroupConfigurationResultConfiguration.fromMap(Map<String, dynamic> map) {
    return WorkgroupConfigurationResultConfiguration(
      aclConfiguration: map['aclConfiguration'] == null ? null : WorkgroupConfigurationResultConfigurationAclConfiguration.fromMap((map['aclConfiguration'] as Map).cast<String, dynamic>()),
      encryptionConfiguration: map['encryptionConfiguration'] == null ? null : WorkgroupConfigurationResultConfigurationEncryptionConfiguration.fromMap((map['encryptionConfiguration'] as Map).cast<String, dynamic>()),
