...
class CapacityReservationTimeouts {
  ...
  /// Creates a new [CapacityReservationTimeouts].
  ...
  CapacityReservationTimeouts({this.create, this.delete, this.update});
  ...
  factory CapacityReservationTimeouts.fromMap(Map<String, dynamic> map) {
    return CapacityReservationTimeouts(
