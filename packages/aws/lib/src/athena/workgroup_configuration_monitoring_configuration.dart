  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'managedLoggingConfiguration': ?managedLoggingConfiguration == null
          ? null
          : managedLoggingConfiguration!.toMap(),
      's3LoggingConfiguration': ?s3LoggingConfiguration == null
          ? null
          : s3LoggingConfiguration!.toMap(),
    };
  }
    ...
    return WorkgroupConfigurationMonitoringConfiguration(
      ...
      managedLoggingConfiguration: map['managedLoggingConfiguration'] == null
          ...
          : WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfiguration.fromMap(
              (map['managedLoggingConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      s3LoggingConfiguration: map['s3LoggingConfiguration'] == null
          ...
          : WorkgroupConfigurationMonitoringConfigurationS3LoggingConfiguration.fromMap(
              (map['s3LoggingConfiguration'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
