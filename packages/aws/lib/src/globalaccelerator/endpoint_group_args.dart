...
class EndpointGroupArgs {
  ...
  EndpointGroupArgs({
    ...
    double? trafficDialPercentage,
        ...
        healthCheckIntervalSeconds =
            pulumi.Input.asOptionalInput<int>(healthCheckIntervalSeconds),
        ...
        healthCheckProtocol =
            pulumi.Input.asOptionalInput<String>(healthCheckProtocol),
        ...
        trafficDialPercentage =
            pulumi.Input.asOptionalInput<double>(trafficDialPercentage);
  ...
  factory EndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return EndpointGroupArgs(
      ...
      healthCheckPort:
          map['healthCheckPort'] == null ? null : map['healthCheckPort'] as int,
      ...
      portOverrides: map['portOverrides'] == null
          ...
          : pulumi.Input.decodeList<EndpointGroupPortOverride>(
              ...
              (value) => EndpointGroupPortOverride.fromMap(
                  (value as Map).cast<String, dynamic>())),
      thresholdCount:
          map['thresholdCount'] == null ? null : map['thresholdCount'] as int,
