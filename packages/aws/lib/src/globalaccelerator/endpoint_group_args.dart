...
class EndpointGroupArgs {
  ...
  factory EndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return EndpointGroupArgs(
      endpointConfigurations: map['endpointConfigurations'] == null ? null : pulumi.Input.decodeList<EndpointGroupEndpointConfiguration>(map['endpointConfigurations'], (value) => EndpointGroupEndpointConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      portOverrides: map['portOverrides'] == null ? null : pulumi.Input.decodeList<EndpointGroupPortOverride>(map['portOverrides'], (value) => EndpointGroupPortOverride.fromMap((value as Map).cast<String, dynamic>())),
      thresholdCount: map['thresholdCount'] == null ? null : map['thresholdCount'] as int,
      trafficDialPercentage: map['trafficDialPercentage'] == null ? null : map['trafficDialPercentage'] as double,
    );
  }
}
