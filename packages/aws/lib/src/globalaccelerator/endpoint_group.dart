...
class EndpointGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EndpointGroupEndpointConfiguration>?>
  endpointConfigurations;
  ...
  EndpointGroup(
    ...
    this.healthCheckIntervalSeconds = registerOutput<int?>(
    ...
    this.portOverrides = registerOutput<List<EndpointGroupPortOverride>?>(
      'portOverrides',
    );
    this.thresholdCount = registerOutput<int?>('thresholdCount');
    this.trafficDialPercentage = registerOutput<double?>(
