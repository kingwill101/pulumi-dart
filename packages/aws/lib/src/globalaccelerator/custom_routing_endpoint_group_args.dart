...
class CustomRoutingEndpointGroupArgs {
  ...
  CustomRoutingEndpointGroupArgs({
    required List<CustomRoutingEndpointGroupDestinationConfiguration> destinationConfigurations,
    List<CustomRoutingEndpointGroupEndpointConfiguration>? endpointConfigurations,
  ...
  factory CustomRoutingEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return CustomRoutingEndpointGroupArgs(
      destinationConfigurations: pulumi.Input.decodeList<CustomRoutingEndpointGroupDestinationConfiguration>(map['destinationConfigurations'], (value) => CustomRoutingEndpointGroupDestinationConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      endpointConfigurations: map['endpointConfigurations'] == null ? null : pulumi.Input.decodeList<CustomRoutingEndpointGroupEndpointConfiguration>(map['endpointConfigurations'], (value) => CustomRoutingEndpointGroupEndpointConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      endpointGroupRegion: map['endpointGroupRegion'] == null ? null : map['endpointGroupRegion'] as String,
