...
class CatalogTableArgs {
  ...
  CatalogTableArgs({
    ...
    String? description,
    String? name,
    CatalogTableOpenTableFormatInput? openTableFormatInput,
    String? owner,
    Map<String, String>? parameters,
    List<CatalogTablePartitionIndex>? partitionIndices,
    List<CatalogTablePartitionKey>? partitionKeys,
    String? region,
    int? retention,
    CatalogTableStorageDescriptor? storageDescriptor,
    String? tableType,
    CatalogTableTargetTable? targetTable,
  ...
  factory CatalogTableArgs.fromMap(Map<String, dynamic> map) {
    return CatalogTableArgs(
      ...
      openTableFormatInput: map['openTableFormatInput'] == null ? null : CatalogTableOpenTableFormatInput.fromMap((map['openTableFormatInput'] as Map).cast<String, dynamic>()),
      owner: map['owner'] == null ? null : map['owner'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      partitionIndices: map['partitionIndices'] == null ? null : pulumi.Input.decodeList<CatalogTablePartitionIndex>(map['partitionIndices'], (value) => CatalogTablePartitionIndex.fromMap((value as Map).cast<String, dynamic>())),
      partitionKeys: map['partitionKeys'] == null ? null : pulumi.Input.decodeList<CatalogTablePartitionKey>(map['partitionKeys'], (value) => CatalogTablePartitionKey.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      retention: map['retention'] == null ? null : map['retention'] as int,
      storageDescriptor: map['storageDescriptor'] == null ? null : CatalogTableStorageDescriptor.fromMap((map['storageDescriptor'] as Map).cast<String, dynamic>()),
      tableType: map['tableType'] == null ? null : map['tableType'] as String,
      targetTable: map['targetTable'] == null ? null : CatalogTableTargetTable.fromMap((map['targetTable'] as Map).cast<String, dynamic>()),
      viewExpandedText: map['viewExpandedText'] == null ? null : map['viewExpandedText'] as String,
      viewOriginalText: map['viewOriginalText'] == null ? null : map['viewOriginalText'] as String,
    );
  }
}
