...
class CatalogTableArgs {
  ...
  CatalogTableArgs({
    ...
    String? viewOriginalText,
        ...
        targetTable =
            pulumi.Input.asOptionalInput<CatalogTableTargetTable>(targetTable),
        viewExpandedText =
            pulumi.Input.asOptionalInput<String>(viewExpandedText),
        viewOriginalText =
            pulumi.Input.asOptionalInput<String>(viewOriginalText);
  ...
  factory CatalogTableArgs.fromMap(Map<String, dynamic> map) {
    return CatalogTableArgs(
      ...
      openTableFormatInput: map['openTableFormatInput'] == null
          ? null
          : CatalogTableOpenTableFormatInput.fromMap(
              (map['openTableFormatInput'] as Map).cast<String, dynamic>()),
      owner: map['owner'] == null ? null : map['owner'] as String,
      parameters: map['parameters'] == null
          ? null
          : (map['parameters'] as Map).cast<String, String>(),
      partitionIndices: map['partitionIndices'] == null
          ? null
      ...
      viewExpandedText: map['viewExpandedText'] == null
          ? null
          : map['viewExpandedText'] as String,
      viewOriginalText: map['viewOriginalText'] == null
          ? null
          : map['viewOriginalText'] as String,
    );
  }
}
