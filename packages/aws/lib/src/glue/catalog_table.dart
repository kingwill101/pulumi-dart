...
class CatalogTable extends pulumi.CustomResource {
  ...
  CatalogTable(
    ...
    this.partitionIndices = registerOutput<List<CatalogTablePartitionIndex>>(
      'partitionIndices',
    );
    this.partitionKeys = registerOutput<List<CatalogTablePartitionKey>?>(
      'partitionKeys',
    );
    this.region = registerOutput<String>('region');
    this.retention = registerOutput<int?>('retention');
    this.storageDescriptor = registerOutput<CatalogTableStorageDescriptor?>(
      'storageDescriptor',
    );
