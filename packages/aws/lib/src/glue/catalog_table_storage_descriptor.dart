...
class CatalogTableStorageDescriptor {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'columns': ?columns == null ? null : pulumi.Input.encodeList<CatalogTableStorageDescriptorColumn, Map<String, dynamic>>(columns!, (value) => value.toMap()),
      ...
      'schemaReference': ?schemaReference == null ? null : schemaReference!.toMap(),
      'serDeInfo': ?serDeInfo == null ? null : serDeInfo!.toMap(),
      'skewedInfo': ?skewedInfo == null ? null : skewedInfo!.toMap(),
      'sortColumns': ?sortColumns == null ? null : pulumi.Input.encodeList<CatalogTableStorageDescriptorSortColumn, Map<String, dynamic>>(sortColumns!, (value) => value.toMap()),
  ...
  factory CatalogTableStorageDescriptor.fromMap(Map<String, dynamic> map) {
    return CatalogTableStorageDescriptor(
      additionalLocations: map['additionalLocations'] == null ? null : (map['additionalLocations'] as List).cast<String>(),
      bucketColumns: map['bucketColumns'] == null ? null : (map['bucketColumns'] as List).cast<String>(),
      columns: map['columns'] == null ? null : pulumi.Input.decodeList<CatalogTableStorageDescriptorColumn>(map['columns'], (value) => CatalogTableStorageDescriptorColumn.fromMap((value as Map).cast<String, dynamic>())),
      ...
      numberOfBuckets: map['numberOfBuckets'] == null ? null : map['numberOfBuckets'] as int,
      outputFormat: map['outputFormat'] == null ? null : map['outputFormat'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      schemaReference: map['schemaReference'] == null ? null : CatalogTableStorageDescriptorSchemaReference.fromMap((map['schemaReference'] as Map).cast<String, dynamic>()),
      serDeInfo: map['serDeInfo'] == null ? null : CatalogTableStorageDescriptorSerDeInfo.fromMap((map['serDeInfo'] as Map).cast<String, dynamic>()),
      skewedInfo: map['skewedInfo'] == null ? null : CatalogTableStorageDescriptorSkewedInfo.fromMap((map['skewedInfo'] as Map).cast<String, dynamic>()),
      sortColumns: map['sortColumns'] == null ? null : pulumi.Input.decodeList<CatalogTableStorageDescriptorSortColumn>(map['sortColumns'], (value) => CatalogTableStorageDescriptorSortColumn.fromMap((value as Map).cast<String, dynamic>())),
      storedAsSubDirectories: map['storedAsSubDirectories'] == null ? null : map['storedAsSubDirectories'] as bool,
    );
  }
}
