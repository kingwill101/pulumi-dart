...
class DataCatalogEncryptionSettingsArgs {
  ...
  DataCatalogEncryptionSettingsArgs({
    String? catalogId,
    required DataCatalogEncryptionSettingsDataCatalogEncryptionSettings dataCatalogEncryptionSettings,
    String? region,
  }) :
  ...
  factory DataCatalogEncryptionSettingsArgs.fromMap(Map<String, dynamic> map) {
    return DataCatalogEncryptionSettingsArgs(
      ...
      dataCatalogEncryptionSettings: DataCatalogEncryptionSettingsDataCatalogEncryptionSettings.fromMap((map['dataCatalogEncryptionSettings'] as Map).cast<String, dynamic>()),
