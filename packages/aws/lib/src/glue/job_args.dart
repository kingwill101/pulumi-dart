...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      command: JobCommand.fromMap((map['command'] as Map).cast<String, dynamic>()),
      connections: map['connections'] == null ? null : (map['connections'] as List).cast<String>(),
      defaultArguments: map['defaultArguments'] == null ? null : (map['defaultArguments'] as Map).cast<String, String>(),
      description: map['description'] == null ? null : map['description'] as String,
      executionClass: map['executionClass'] == null ? null : map['executionClass'] as String,
      executionProperty: map['executionProperty'] == null ? null : JobExecutionProperty.fromMap((map['executionProperty'] as Map).cast<String, dynamic>()),
      glueVersion: map['glueVersion'] == null ? null : map['glueVersion'] as String,
      jobMode: map['jobMode'] == null ? null : map['jobMode'] as String,
      jobRunQueuingEnabled: map['jobRunQueuingEnabled'] == null ? null : map['jobRunQueuingEnabled'] as bool,
      ...
      nonOverridableArguments: map['nonOverridableArguments'] == null ? null : (map['nonOverridableArguments'] as Map).cast<String, String>(),
      notificationProperty: map['notificationProperty'] == null ? null : JobNotificationProperty.fromMap((map['notificationProperty'] as Map).cast<String, dynamic>()),
      ...
      sourceControlDetails: map['sourceControlDetails'] == null ? null : JobSourceControlDetails.fromMap((map['sourceControlDetails'] as Map).cast<String, dynamic>()),
