...
class SecurityConfigurationEncryptionConfigurationJobBookmarksEncryption {
  ...
  Map<String, dynamic> toMap() {
    ...
    final jobBookmarksEncryptionModeValue = jobBookmarksEncryptionMode;
    if (jobBookmarksEncryptionModeValue != null) {
      map['jobBookmarksEncryptionMode'] = jobBookmarksEncryptionModeValue;
    }
