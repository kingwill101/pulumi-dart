...
class Classifier extends pulumi.CustomResource {
  ...
  Classifier(
    ...
    this.csvClassifier = registerOutput<ClassifierCsvClassifier?>(
      'csvClassifier',
    );
    this.grokClassifier = registerOutput<ClassifierGrokClassifier?>(
      'grokClassifier',
    );
    this.jsonClassifier = registerOutput<ClassifierJsonClassifier?>(
      'jsonClassifier',
    );
    this.name = registerOutput<String>('name');
    this.region = registerOutput<String>('region');
    this.xmlClassifier = registerOutput<ClassifierXmlClassifier?>(
      'xmlClassifier',
    );
  }
}
