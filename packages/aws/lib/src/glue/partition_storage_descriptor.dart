...
class PartitionStorageDescriptor {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'columns': ?columns == null ? null : pulumi.Input.encodeList<PartitionStorageDescriptorColumn, Map<String, dynamic>>(columns!, (value) => value.toMap()),
      ...
      'sortColumns': ?sortColumns == null ? null : pulumi.Input.encodeList<PartitionStorageDescriptorSortColumn, Map<String, dynamic>>(sortColumns!, (value) => value.toMap()),
  ...
  factory PartitionStorageDescriptor.fromMap(Map<String, dynamic> map) {
    return PartitionStorageDescriptor(
      ...
      columns: map['columns'] == null ? null : pulumi.Input.decodeList<PartitionStorageDescriptorColumn>(map['columns'], (value) => PartitionStorageDescriptorColumn.fromMap((value as Map).cast<String, dynamic>())),
      ...
      serDeInfo: map['serDeInfo'] == null ? null : PartitionStorageDescriptorSerDeInfo.fromMap((map['serDeInfo'] as Map).cast<String, dynamic>()),
      skewedInfo: map['skewedInfo'] == null ? null : PartitionStorageDescriptorSkewedInfo.fromMap((map['skewedInfo'] as Map).cast<String, dynamic>()),
      sortColumns: map['sortColumns'] == null ? null : pulumi.Input.decodeList<PartitionStorageDescriptorSortColumn>(map['sortColumns'], (value) => PartitionStorageDescriptorSortColumn.fromMap((value as Map).cast<String, dynamic>())),
