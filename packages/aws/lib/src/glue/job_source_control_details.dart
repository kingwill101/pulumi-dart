...
class JobSourceControlDetails {
  ...
  Map<String, dynamic> toMap() {
    ...
    final authStrategyValue = authStrategy;
    if (authStrategyValue != null) {
      map['authStrategy'] = authStrategyValue;
    }
    ...
    final lastCommitIdValue = lastCommitId;
    if (lastCommitIdValue != null) {
      map['lastCommitId'] = lastCommitIdValue;
    }
