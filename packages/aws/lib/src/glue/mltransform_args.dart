...
class MLTransformArgs {
  ...
  factory MLTransformArgs.fromMap(Map<String, dynamic> map) {
    return MLTransformArgs(
      ...
      inputRecordTables: pulumi.Input.decodeList<MLTransformInputRecordTable>(map['inputRecordTables'], (value) => MLTransformInputRecordTable.fromMap((value as Map).cast<String, dynamic>())),
      ...
      parameters: MLTransformParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>()),
