...
class DevEndpointArgs {
  ...
  factory DevEndpointArgs.fromMap(Map<String, dynamic> map) {
    return DevEndpointArgs(
      ...
      extraJarsS3Path: map['extraJarsS3Path'] == null ? null : map['extraJarsS3Path'] as String,
      extraPythonLibsS3Path: map['extraPythonLibsS3Path'] == null ? null : map['extraPythonLibsS3Path'] as String,
      ...
      publicKeys: map['publicKeys'] == null ? null : (map['publicKeys'] as List).cast<String>(),
