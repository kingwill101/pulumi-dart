...
class CrawlerArgs {
  ...
  CrawlerArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<List<CrawlerCatalogTarget>>(
                catalogTargets),
        ...
        dynamodbTargets =
            pulumi.Input.asOptionalInput<List<CrawlerDynamodbTarget>>(
                dynamodbTargets),
        hudiTargets =
            pulumi.Input.asOptionalInput<List<CrawlerHudiTarget>>(hudiTargets),
        icebergTargets =
            pulumi.Input.asOptionalInput<List<CrawlerIcebergTarget>>(
                icebergTargets),
        jdbcTargets =
            pulumi.Input.asOptionalInput<List<CrawlerJdbcTarget>>(jdbcTargets),
        lakeFormationConfiguration =
        ...
        lineageConfiguration =
            pulumi.Input.asOptionalInput<CrawlerLineageConfiguration>(
                lineageConfiguration),
        mongodbTargets =
            pulumi.Input.asOptionalInput<List<CrawlerMongodbTarget>>(
                mongodbTargets),
        name = pulumi.Input.asOptionalInput<String>(name),
        recrawlPolicy =
            pulumi.Input.asOptionalInput<CrawlerRecrawlPolicy>(recrawlPolicy),
        region = pulumi.Input.asOptionalInput<String>(region),
        role = pulumi.Input.asInput<String>(role),
        s3Targets =
            pulumi.Input.asOptionalInput<List<CrawlerS3Target>>(s3Targets),
