...
class CrawlerArgs {
  ...
  factory CrawlerArgs.fromMap(Map<String, dynamic> map) {
    return CrawlerArgs(
      catalogTargets: map['catalogTargets'] == null ? null : pulumi.Input.decodeList<CrawlerCatalogTarget>(map['catalogTargets'], (value) => CrawlerCatalogTarget.fromMap((value as Map).cast<String, dynamic>())),
      classifiers: map['classifiers'] == null ? null : (map['classifiers'] as List).cast<String>(),
      configuration: map['configuration'] == null ? null : map['configuration'] as String,
      databaseName: map['databaseName'] as String,
      deltaTargets: map['deltaTargets'] == null ? null : pulumi.Input.decodeList<CrawlerDeltaTarget>(map['deltaTargets'], (value) => CrawlerDeltaTarget.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      dynamodbTargets: map['dynamodbTargets'] == null ? null : pulumi.Input.decodeList<CrawlerDynamodbTarget>(map['dynamodbTargets'], (value) => CrawlerDynamodbTarget.fromMap((value as Map).cast<String, dynamic>())),
      hudiTargets: map['hudiTargets'] == null ? null : pulumi.Input.decodeList<CrawlerHudiTarget>(map['hudiTargets'], (value) => CrawlerHudiTarget.fromMap((value as Map).cast<String, dynamic>())),
      icebergTargets: map['icebergTargets'] == null ? null : pulumi.Input.decodeList<CrawlerIcebergTarget>(map['icebergTargets'], (value) => CrawlerIcebergTarget.fromMap((value as Map).cast<String, dynamic>())),
      jdbcTargets: map['jdbcTargets'] == null ? null : pulumi.Input.decodeList<CrawlerJdbcTarget>(map['jdbcTargets'], (value) => CrawlerJdbcTarget.fromMap((value as Map).cast<String, dynamic>())),
      lakeFormationConfiguration: map['lakeFormationConfiguration'] == null ? null : CrawlerLakeFormationConfiguration.fromMap((map['lakeFormationConfiguration'] as Map).cast<String, dynamic>()),
      lineageConfiguration: map['lineageConfiguration'] == null ? null : CrawlerLineageConfiguration.fromMap((map['lineageConfiguration'] as Map).cast<String, dynamic>()),
      mongodbTargets: map['mongodbTargets'] == null ? null : pulumi.Input.decodeList<CrawlerMongodbTarget>(map['mongodbTargets'], (value) => CrawlerMongodbTarget.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      recrawlPolicy: map['recrawlPolicy'] == null ? null : CrawlerRecrawlPolicy.fromMap((map['recrawlPolicy'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      role: map['role'] as String,
      s3Targets: map['s3Targets'] == null ? null : pulumi.Input.decodeList<CrawlerS3Target>(map['s3Targets'], (value) => CrawlerS3Target.fromMap((value as Map).cast<String, dynamic>())),
      schedule: map['schedule'] == null ? null : map['schedule'] as String,
      schemaChangePolicy: map['schemaChangePolicy'] == null ? null : CrawlerSchemaChangePolicy.fromMap((map['schemaChangePolicy'] as Map).cast<String, dynamic>()),
