...
class CatalogDatabaseArgs {
  ...
  CatalogDatabaseArgs({
    String? catalogId,
    List<CatalogDatabaseCreateTableDefaultPermission>? createTableDefaultPermissions,
    String? description,
  ...
  factory CatalogDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return CatalogDatabaseArgs(
      ...
      createTableDefaultPermissions: map['createTableDefaultPermissions'] == null ? null : pulumi.Input.decodeList<CatalogDatabaseCreateTableDefaultPermission>(map['createTableDefaultPermissions'], (value) => CatalogDatabaseCreateTableDefaultPermission.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      federatedDatabase: map['federatedDatabase'] == null ? null : CatalogDatabaseFederatedDatabase.fromMap((map['federatedDatabase'] as Map).cast<String, dynamic>()),
      locationUri: map['locationUri'] == null ? null : map['locationUri'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetDatabase: map['targetDatabase'] == null ? null : CatalogDatabaseTargetDatabase.fromMap((map['targetDatabase'] as Map).cast<String, dynamic>()),
    );
  }
}
