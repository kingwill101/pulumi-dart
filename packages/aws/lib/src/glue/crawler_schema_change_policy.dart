...
class CrawlerSchemaChangePolicy {
  ...
  Map<String, dynamic> toMap() {
    ...
    final deleteBehaviorValue = deleteBehavior;
    if (deleteBehaviorValue != null) {
      map['deleteBehavior'] = deleteBehaviorValue;
    }
    final updateBehaviorValue = updateBehavior;
    if (updateBehaviorValue != null) {
      map['updateBehavior'] = updateBehaviorValue;
    }
    return map;
  }
  ...
  factory CrawlerSchemaChangePolicy.fromMap(Map<String, dynamic> map) {
    return CrawlerSchemaChangePolicy(
      deleteBehavior: map['deleteBehavior'] == null
          ? null
          : map['deleteBehavior'] as String,
      updateBehavior: map['updateBehavior'] == null
          ? null
          : map['updateBehavior'] as String,
    );
  }
}
