...
class TriggerArgs {
  ...
  factory TriggerArgs.fromMap(Map<String, dynamic> map) {
    return TriggerArgs(
      actions: pulumi.Input.decodeList<TriggerAction>(
        map['actions'],
        (value) =>
      ...
      eventBatchingConditions: map['eventBatchingConditions'] == null
          ? null
      ...
      startOnCreation: map['startOnCreation'] == null
          ? null
          : map['startOnCreation'] as bool,
      tags: map['tags'] == null
          ? null
