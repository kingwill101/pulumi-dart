...
class CatalogDatabase extends pulumi.CustomResource {
  ...
  CatalogDatabase(
    ...
    this.createTableDefaultPermissions = registerOutput<List<CatalogDatabaseCreateTableDefaultPermission>>('createTableDefaultPermissions');
    this.description = registerOutput<String?>('description');
    this.federatedDatabase = registerOutput<CatalogDatabaseFederatedDatabase?>('federatedDatabase');
    ...
    this.targetDatabase = registerOutput<CatalogDatabaseTargetDatabase?>('targetDatabase');
  }
}
