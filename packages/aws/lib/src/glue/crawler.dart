...
class Crawler extends pulumi.CustomResource {
  ...
  Crawler(
    ...
    this.catalogTargets = registerOutput<List<CrawlerCatalogTarget>?>(
      'catalogTargets',
    );
    this.classifiers = registerOutput<List<String>?>('classifiers');
    this.configuration = registerOutput<String?>('configuration');
    this.databaseName = registerOutput<String>('databaseName');
    this.deltaTargets = registerOutput<List<CrawlerDeltaTarget>?>(
      'deltaTargets',
    );
    this.description = registerOutput<String?>('description');
    this.dynamodbTargets = registerOutput<List<CrawlerDynamodbTarget>?>(
      'dynamodbTargets',
    );
    this.hudiTargets = registerOutput<List<CrawlerHudiTarget>?>('hudiTargets');
    this.icebergTargets = registerOutput<List<CrawlerIcebergTarget>?>(
      'icebergTargets',
    );
    ...
    this.lineageConfiguration = registerOutput<CrawlerLineageConfiguration?>(
      'lineageConfiguration',
    );
    this.mongodbTargets = registerOutput<List<CrawlerMongodbTarget>?>(
      'mongodbTargets',
    );
    ...
    this.schemaChangePolicy = registerOutput<CrawlerSchemaChangePolicy?>(
      'schemaChangePolicy',
    );
