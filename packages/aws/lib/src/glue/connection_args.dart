...
class ConnectionArgs {
  ...
  ConnectionArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<Map<String, String>>(athenaProperties),
        ...
        matchCriterias =
            pulumi.Input.asOptionalInput<List<String>>(matchCriterias),
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      athenaProperties: map['athenaProperties'] == null
          ? null
          : (map['athenaProperties'] as Map).cast<String, String>(),
      ...
      matchCriterias: map['matchCriterias'] == null
          ? null
          : (map['matchCriterias'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      physicalConnectionRequirements:
          map['physicalConnectionRequirements'] == null
              ? null
              : ConnectionPhysicalConnectionRequirements.fromMap(
                  (map['physicalConnectionRequirements'] as Map)
                      .cast<String, dynamic>()),
