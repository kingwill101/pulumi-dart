...
class ClassifierArgs {
  ...
  factory ClassifierArgs.fromMap(Map<String, dynamic> map) {
    return ClassifierArgs(
      csvClassifier: map['csvClassifier'] == null
          ? null
          : ClassifierCsvClassifier.fromMap(
              (map['csvClassifier'] as Map).cast<String, dynamic>(),
            ),
      grokClassifier: map['grokClassifier'] == null
          ? null
          : ClassifierGrokClassifier.fromMap(
              (map['grokClassifier'] as Map).cast<String, dynamic>(),
            ),
      jsonClassifier: map['jsonClassifier'] == null
          ? null
          : ClassifierJsonClassifier.fromMap(
              (map['jsonClassifier'] as Map).cast<String, dynamic>(),
            ),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      xmlClassifier: map['xmlClassifier'] == null
          ? null
          : ClassifierXmlClassifier.fromMap(
              (map['xmlClassifier'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
