...
class DevEndpoint extends pulumi.CustomResource {
  ...
  DevEndpoint(
    ...
    this.extraPythonLibsS3Path = registerOutput<String?>('extraPythonLibsS3Path');
    ...
    this.zeppelinRemoteSparkInterpreterPort = registerOutput<int>('zeppelinRemoteSparkInterpreterPort');
  }
}
