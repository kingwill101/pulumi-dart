...
class GroupMixedInstancesPolicyLaunchTemplate {
  ...
  final GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification launchTemplateSpecification;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'overrides': ?overrides == null ? null : pulumi.Input.encodeList<GroupMixedInstancesPolicyLaunchTemplateOverride, Map<String, dynamic>>(overrides!, (value) => value.toMap()),
    };
  }
  ...
  factory GroupMixedInstancesPolicyLaunchTemplate.fromMap(Map<String, dynamic> map) {
    return GroupMixedInstancesPolicyLaunchTemplate(
      launchTemplateSpecification: GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification.fromMap((map['launchTemplateSpecification'] as Map).cast<String, dynamic>()),
      overrides: map['overrides'] == null ? null : pulumi.Input.decodeList<GroupMixedInstancesPolicyLaunchTemplateOverride>(map['overrides'], (value) => GroupMixedInstancesPolicyLaunchTemplateOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
