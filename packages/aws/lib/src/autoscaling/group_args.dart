...
class GroupArgs {
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      availabilityZoneDistribution: map['availabilityZoneDistribution'] == null ? null : GroupAvailabilityZoneDistribution.fromMap((map['availabilityZoneDistribution'] as Map).cast<String, dynamic>()),
      availabilityZones: map['availabilityZones'] == null ? null : (map['availabilityZones'] as List).cast<String>(),
      capacityRebalance: map['capacityRebalance'] == null ? null : map['capacityRebalance'] as bool,
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : GroupCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>()),
      context: map['context'] == null ? null : map['context'] as String,
      defaultCooldown: map['defaultCooldown'] == null ? null : map['defaultCooldown'] as int,
      defaultInstanceWarmup: map['defaultInstanceWarmup'] == null ? null : map['defaultInstanceWarmup'] as int,
      desiredCapacity: map['desiredCapacity'] == null ? null : map['desiredCapacity'] as int,
      desiredCapacityType: map['desiredCapacityType'] == null ? null : map['desiredCapacityType'] as String,
      enabledMetrics: map['enabledMetrics'] == null ? null : pulumi.Input.decodeList<Metric>(map['enabledMetrics'], (value) => Metric.fromValue(value as String)),
      forceDelete: map['forceDelete'] == null ? null : map['forceDelete'] as bool,
      forceDeleteWarmPool: map['forceDeleteWarmPool'] == null ? null : map['forceDeleteWarmPool'] as bool,
      healthCheckGracePeriod: map['healthCheckGracePeriod'] == null ? null : map['healthCheckGracePeriod'] as int,
      healthCheckType: map['healthCheckType'] == null ? null : map['healthCheckType'] as String,
      ignoreFailedScalingActivities: map['ignoreFailedScalingActivities'] == null ? null : map['ignoreFailedScalingActivities'] as bool,
      initialLifecycleHooks: map['initialLifecycleHooks'] == null ? null : pulumi.Input.decodeList<GroupInitialLifecycleHook>(map['initialLifecycleHooks'], (value) => GroupInitialLifecycleHook.fromMap((value as Map).cast<String, dynamic>())),
      instanceMaintenancePolicy: map['instanceMaintenancePolicy'] == null ? null : GroupInstanceMaintenancePolicy.fromMap((map['instanceMaintenancePolicy'] as Map).cast<String, dynamic>()),
      instanceRefresh: map['instanceRefresh'] == null ? null : GroupInstanceRefresh.fromMap((map['instanceRefresh'] as Map).cast<String, dynamic>()),
      launchConfiguration: map['launchConfiguration'] == null ? null : map['launchConfiguration'] as String,
      launchTemplate: map['launchTemplate'] == null ? null : GroupLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>()),
      loadBalancers: map['loadBalancers'] == null ? null : (map['loadBalancers'] as List).cast<String>(),
      maxInstanceLifetime: map['maxInstanceLifetime'] == null ? null : map['maxInstanceLifetime'] as int,
      maxSize: map['maxSize'] as int,
      metricsGranularity: map['metricsGranularity'] == null ? null : map['metricsGranularity'] as String,
      minElbCapacity: map['minElbCapacity'] == null ? null : map['minElbCapacity'] as int,
      minSize: map['minSize'] as int,
      mixedInstancesPolicy: map['mixedInstancesPolicy'] == null ? null : GroupMixedInstancesPolicy.fromMap((map['mixedInstancesPolicy'] as Map).cast<String, dynamic>()),
      ...
      serviceLinkedRoleArn: map['serviceLinkedRoleArn'] == null ? null : map['serviceLinkedRoleArn'] as String,
      suspendedProcesses: map['suspendedProcesses'] == null ? null : (map['suspendedProcesses'] as List).cast<String>(),
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<GroupTag>(map['tags'], (value) => GroupTag.fromMap((value as Map).cast<String, dynamic>())),
      targetGroupArns: map['targetGroupArns'] == null ? null : (map['targetGroupArns'] as List).cast<String>(),
      terminationPolicies: map['terminationPolicies'] == null ? null : (map['terminationPolicies'] as List).cast<String>(),
      trafficSources: map['trafficSources'] == null ? null : pulumi.Input.decodeList<GroupTrafficSource>(map['trafficSources'], (value) => GroupTrafficSource.fromMap((value as Map).cast<String, dynamic>())),
      vpcZoneIdentifiers: map['vpcZoneIdentifiers'] == null ? null : (map['vpcZoneIdentifiers'] as List).cast<String>(),
      waitForCapacityTimeout: map['waitForCapacityTimeout'] == null ? null : map['waitForCapacityTimeout'] as String,
      waitForElbCapacity: map['waitForElbCapacity'] == null ? null : map['waitForElbCapacity'] as int,
      warmPool: map['warmPool'] == null ? null : GroupWarmPool.fromMap((map['warmPool'] as Map).cast<String, dynamic>()),
    );
  }
}
