...
class GroupArgs {
  ...
  GroupArgs({
    ...
    GroupWarmPool? warmPool,
        ...
        capacityRebalance =
            pulumi.Input.asOptionalInput<bool>(capacityRebalance),
        capacityReservationSpecification =
        ...
        defaultInstanceWarmup =
            pulumi.Input.asOptionalInput<int>(defaultInstanceWarmup),
        desiredCapacity = pulumi.Input.asOptionalInput<int>(desiredCapacity),
        desiredCapacityType =
            pulumi.Input.asOptionalInput<String>(desiredCapacityType),
        enabledMetrics =
            pulumi.Input.asOptionalInput<List<Metric>>(enabledMetrics),
        forceDelete = pulumi.Input.asOptionalInput<bool>(forceDelete),
        forceDeleteWarmPool =
            pulumi.Input.asOptionalInput<bool>(forceDeleteWarmPool),
        healthCheckGracePeriod =
            pulumi.Input.asOptionalInput<int>(healthCheckGracePeriod),
        healthCheckType = pulumi.Input.asOptionalInput<String>(healthCheckType),
        ignoreFailedScalingActivities =
            pulumi.Input.asOptionalInput<bool>(ignoreFailedScalingActivities),
        ...
        instanceMaintenancePolicy =
            pulumi.Input.asOptionalInput<GroupInstanceMaintenancePolicy>(
                instanceMaintenancePolicy),
        instanceRefresh =
            pulumi.Input.asOptionalInput<GroupInstanceRefresh>(instanceRefresh),
        launchConfiguration =
            pulumi.Input.asOptionalInput<String>(launchConfiguration),
        launchTemplate =
            pulumi.Input.asOptionalInput<GroupLaunchTemplate>(launchTemplate),
        loadBalancers =
            pulumi.Input.asOptionalInput<List<String>>(loadBalancers),
        maxInstanceLifetime =
            pulumi.Input.asOptionalInput<int>(maxInstanceLifetime),
        maxSize = pulumi.Input.asInput<int>(maxSize),
        metricsGranularity =
            pulumi.Input.asOptionalInput<String>(metricsGranularity),
        ...
        protectFromScaleIn =
            pulumi.Input.asOptionalInput<bool>(protectFromScaleIn),
        region = pulumi.Input.asOptionalInput<String>(region),
        serviceLinkedRoleArn =
            pulumi.Input.asOptionalInput<String>(serviceLinkedRoleArn),
        suspendedProcesses =
            pulumi.Input.asOptionalInput<List<String>>(suspendedProcesses),
        tags = pulumi.Input.asOptionalInput<List<GroupTag>>(tags),
        targetGroupArns =
            pulumi.Input.asOptionalInput<List<String>>(targetGroupArns),
        terminationPolicies =
            pulumi.Input.asOptionalInput<List<String>>(terminationPolicies),
        trafficSources = pulumi.Input.asOptionalInput<List<GroupTrafficSource>>(
            trafficSources),
        vpcZoneIdentifiers =
            pulumi.Input.asOptionalInput<List<String>>(vpcZoneIdentifiers),
        waitForCapacityTimeout =
            pulumi.Input.asOptionalInput<String>(waitForCapacityTimeout),
        waitForElbCapacity =
            pulumi.Input.asOptionalInput<int>(waitForElbCapacity),
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      defaultCooldown:
          map['defaultCooldown'] == null ? null : map['defaultCooldown'] as int,
      ...
      enabledMetrics: map['enabledMetrics'] == null
          ? null
          : pulumi.Input.decodeList<Metric>(map['enabledMetrics'],
      ...
      instanceMaintenancePolicy: map['instanceMaintenancePolicy'] == null
          ...
          : GroupInstanceMaintenancePolicy.fromMap(
              (map['instanceMaintenancePolicy'] as Map)
                  .cast<String, dynamic>()),
      ...
      minElbCapacity:
          map['minElbCapacity'] == null ? null : map['minElbCapacity'] as int,
