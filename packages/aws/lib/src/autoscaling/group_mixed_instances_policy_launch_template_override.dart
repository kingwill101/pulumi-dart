...
class GroupMixedInstancesPolicyLaunchTemplateOverride {
  ...
  final GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements? instanceRequirements;
  /// Override the instance type in the Launch Template.
  final String? instanceType;
  /// Override the instance launch template specification in the Launch Template.
  final GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecification? launchTemplateSpecification;
  ...
  factory GroupMixedInstancesPolicyLaunchTemplateOverride.fromMap(Map<String, dynamic> map) {
    return GroupMixedInstancesPolicyLaunchTemplateOverride(
      instanceRequirements: map['instanceRequirements'] == null ? null : GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements.fromMap((map['instanceRequirements'] as Map).cast<String, dynamic>()),
      instanceType: map['instanceType'] == null ? null : map['instanceType'] as String,
      launchTemplateSpecification: map['launchTemplateSpecification'] == null ? null : GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecification.fromMap((map['launchTemplateSpecification'] as Map).cast<String, dynamic>()),
