...
class MonitorArgs {
  ...
  factory MonitorArgs.fromMap(Map<String, dynamic> map) {
    return MonitorArgs(
      localResources: pulumi.Input.decodeList<MonitorLocalResource>(map['localResources'], (value) => MonitorLocalResource.fromMap((value as Map).cast<String, dynamic>())),
      monitorName: map['monitorName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      remoteResources: map['remoteResources'] == null ? null : pulumi.Input.decodeList<MonitorRemoteResource>(map['remoteResources'], (value) => MonitorRemoteResource.fromMap((value as Map).cast<String, dynamic>())),
      scopeArn: map['scopeArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : MonitorTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
