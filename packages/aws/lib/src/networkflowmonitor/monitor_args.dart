...
class MonitorArgs {
  ...
  MonitorArgs({
    ...
    MonitorTimeouts? timeouts,
       ...
       remoteResources = pulumi
           .Input.asOptionalInput<List<MonitorRemoteResource>>(remoteResources),
  ...
  factory MonitorArgs.fromMap(Map<String, dynamic> map) {
    return MonitorArgs(
      localResources: pulumi.Input.decodeList<MonitorLocalResource>(
        map['localResources'],
      ...
      remoteResources: map['remoteResources'] == null
          ? null
