...
class MonitorTimeouts {
  ...
  MonitorTimeouts({this.create, this.delete, this.update});
  ...
  factory MonitorTimeouts.fromMap(Map<String, dynamic> map) {
    return MonitorTimeouts(
