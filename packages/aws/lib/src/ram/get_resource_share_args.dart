...
class GetResourceShareArgs {
  ...
  GetResourceShareArgs({
    List<GetResourceShareFilter>? filters,
    String? name,
    String? region,
    required String resourceOwner,
    String? resourceShareStatus,
    Map<String, String>? tags,
  })  : filters =
            pulumi.Input.asOptionalInput<List<GetResourceShareFilter>>(filters),
        name = pulumi.Input.asOptionalInput<String>(name),
        region = pulumi.Input.asOptionalInput<String>(region),
        resourceOwner = pulumi.Input.asInput<String>(resourceOwner),
        resourceShareStatus =
            pulumi.Input.asOptionalInput<String>(resourceShareStatus),
