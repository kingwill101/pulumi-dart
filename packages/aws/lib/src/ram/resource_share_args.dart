...
class ResourceShareArgs {
  ...
  factory ResourceShareArgs.fromMap(Map<String, dynamic> map) {
    return ResourceShareArgs(
      allowExternalPrincipals: map['allowExternalPrincipals'] == null ? null : map['allowExternalPrincipals'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      permissionArns: map['permissionArns'] == null ? null : (map['permissionArns'] as List).cast<String>(),
