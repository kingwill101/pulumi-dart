...
class PermissionArgs {
  ...
  factory PermissionArgs.fromMap(Map<String, dynamic> map) {
    return PermissionArgs(
      ...
      policyTemplate: map['policyTemplate'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      resourceType: map['resourceType'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : PermissionTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
