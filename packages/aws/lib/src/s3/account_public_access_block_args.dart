...
/// {@template pulumi_s3_account_public_access_block_account_public_access_block_args_doc}
/// The set of arguments for AccountPublicAccessBlock.
/// {@endtemplate}
/// {@macro pulumi_s3_account_public_access_block_account_public_access_block_args_doc}
class AccountPublicAccessBlockArgs {
  ...
  AccountPublicAccessBlockArgs({
    ...
    bool? restrictPublicBuckets,
        ...
        blockPublicPolicy =
            pulumi.Input.asOptionalInput<bool>(blockPublicPolicy),
        ignorePublicAcls = pulumi.Input.asOptionalInput<bool>(ignorePublicAcls),
        restrictPublicBuckets =
            pulumi.Input.asOptionalInput<bool>(restrictPublicBuckets);
