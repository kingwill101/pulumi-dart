...
class BucketObjectArgs {
  ...
  BucketObjectArgs({
    ...
    String? websiteRedirect,
        ...
        objectLockLegalHoldStatus =
            pulumi.Input.asOptionalInput<String>(objectLockLegalHoldStatus),
        objectLockMode = pulumi.Input.asOptionalInput<String>(objectLockMode),
        objectLockRetainUntilDate =
            pulumi.Input.asOptionalInput<String>(objectLockRetainUntilDate),
        region = pulumi.Input.asOptionalInput<String>(region),
        serverSideEncryption =
            pulumi.Input.asOptionalInput<String>(serverSideEncryption),
  ...
  factory BucketObjectArgs.fromMap(Map<String, dynamic> map) {
    return BucketObjectArgs(
      ...
      contentBase64:
          map['contentBase64'] == null ? null : map['contentBase64'] as String,
      ...
      objectLockLegalHoldStatus: map['objectLockLegalHoldStatus'] == null
          ? null
          : map['objectLockLegalHoldStatus'] as String,
      objectLockMode: map['objectLockMode'] == null
          ? null
          : map['objectLockMode'] as String,
      objectLockRetainUntilDate: map['objectLockRetainUntilDate'] == null
          ? null
          : map['objectLockRetainUntilDate'] as String,
      ...
      sourceHash:
          map['sourceHash'] == null ? null : map['sourceHash'] as String,
      storageClass:
          map['storageClass'] == null ? null : map['storageClass'] as String,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      websiteRedirect: map['websiteRedirect'] == null
          ? null
          : map['websiteRedirect'] as String,
    );
  }
}
