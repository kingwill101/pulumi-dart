...
class AnalyticsConfigurationArgs {
  ...
  AnalyticsConfigurationArgs({
    ...
    AnalyticsConfigurationStorageClassAnalysis? storageClassAnalysis,
        ...
        filter =
            pulumi.Input.asOptionalInput<AnalyticsConfigurationFilter>(filter),
  ...
  factory AnalyticsConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return AnalyticsConfigurationArgs(
      ...
      storageClassAnalysis: map['storageClassAnalysis'] == null
          ? null
          : AnalyticsConfigurationStorageClassAnalysis.fromMap(
              (map['storageClassAnalysis'] as Map).cast<String, dynamic>()),
    );
  }
}
