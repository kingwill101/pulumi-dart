...
class BucketV2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BucketV2ObjectLockConfiguration>
  ...
  late final pulumi.Output<List<BucketV2ReplicationConfiguration>>
  ...
  late final pulumi.Output<List<BucketV2ServerSideEncryptionConfiguration>>
  ...
  BucketV2(
    ...
    this.lifecycleRules = registerOutput<List<BucketV2LifecycleRule>>(
      'lifecycleRules',
    );
