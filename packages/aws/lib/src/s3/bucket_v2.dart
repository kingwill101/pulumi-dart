...
class BucketV2 extends pulumi.CustomResource {
  ...
  BucketV2(
    ...
    this.bucketRegionalDomainName = registerOutput<String>('bucketRegionalDomainName');
    ...
    this.lifecycleRules = registerOutput<List<BucketV2LifecycleRule>>('lifecycleRules');
    this.loggings = registerOutput<List<BucketV2Logging>>('loggings');
    this.objectLockConfiguration = registerOutput<BucketV2ObjectLockConfiguration>('objectLockConfiguration');
    this.objectLockEnabled = registerOutput<bool>('objectLockEnabled');
    this.policy = registerOutput<String>('policy');
    this.region = registerOutput<String>('region');
    this.replicationConfigurations = registerOutput<List<BucketV2ReplicationConfiguration>>('replicationConfigurations');
    this.requestPayer = registerOutput<String>('requestPayer');
    this.serverSideEncryptionConfigurations = registerOutput<List<BucketV2ServerSideEncryptionConfiguration>>('serverSideEncryptionConfigurations');
