...
class BucketLifecycleConfigurationArgs {
  ...
  factory BucketLifecycleConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleConfigurationArgs(
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<BucketLifecycleConfigurationRule>(map['rules'], (value) => BucketLifecycleConfigurationRule.fromMap((value as Map).cast<String, dynamic>())),
      timeouts: map['timeouts'] == null ? null : BucketLifecycleConfigurationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
