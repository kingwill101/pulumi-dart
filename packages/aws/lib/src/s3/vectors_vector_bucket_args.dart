...
class VectorsVectorBucketArgs {
  ...
  VectorsVectorBucketArgs({
    List<VectorsVectorBucketEncryptionConfiguration>? encryptionConfigurations,
    bool? forceDestroy,
    String? region,
  ...
  factory VectorsVectorBucketArgs.fromMap(Map<String, dynamic> map) {
    return VectorsVectorBucketArgs(
      encryptionConfigurations: map['encryptionConfigurations'] == null ? null : pulumi.Input.decodeList<VectorsVectorBucketEncryptionConfiguration>(map['encryptionConfigurations'], (value) => VectorsVectorBucketEncryptionConfiguration.fromMap((value as Map).cast<String, dynamic>())),
