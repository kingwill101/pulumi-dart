  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessControlTranslation': ?accessControlTranslation == null
          ? null
          : accessControlTranslation!.toMap(),
      'account': ?account,
      'bucket': bucket,
  ...
  factory BucketReplicationConfigRuleDestination.fromMap(
    ...
    return BucketReplicationConfigRuleDestination(
      accessControlTranslation: map['accessControlTranslation'] == null
          ? null
          : BucketReplicationConfigRuleDestinationAccessControlTranslation.fromMap(
              (map['accessControlTranslation'] as Map).cast<String, dynamic>(),
            ),
      account: map['account'] == null ? null : map['account'] as String,
      bucket: map['bucket'] as String,
      encryptionConfiguration: map['encryptionConfiguration'] == null
          ? null
          : BucketReplicationConfigRuleDestinationEncryptionConfiguration.fromMap(
