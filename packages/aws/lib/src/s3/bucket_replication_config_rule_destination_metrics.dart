...
class BucketReplicationConfigRuleDestinationMetrics {
  ...
  final BucketReplicationConfigRuleDestinationMetricsEventThreshold? eventThreshold;
  ...
  factory BucketReplicationConfigRuleDestinationMetrics.fromMap(Map<String, dynamic> map) {
    return BucketReplicationConfigRuleDestinationMetrics(
      eventThreshold: map['eventThreshold'] == null ? null : BucketReplicationConfigRuleDestinationMetricsEventThreshold.fromMap((map['eventThreshold'] as Map).cast<String, dynamic>()),
