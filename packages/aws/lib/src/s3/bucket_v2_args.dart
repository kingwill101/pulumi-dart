...
/// {@template pulumi_s3_bucket_v2_bucket_v2_args_doc}
/// The set of arguments for BucketV2.
/// {@endtemplate}
/// {@macro pulumi_s3_bucket_v2_bucket_v2_args_doc}
class BucketV2Args {
  ...
  BucketV2Args({
    ...
    String? bucket,
    String? bucketPrefix,
    List<BucketV2CorsRule>? corsRules,
    bool? forceDestroy,
    List<BucketV2Grant>? grants,
    List<BucketV2LifecycleRule>? lifecycleRules,
    List<BucketV2Logging>? loggings,
    BucketV2ObjectLockConfiguration? objectLockConfiguration,
    bool? objectLockEnabled,
    String? policy,
    String? region,
    List<BucketV2ReplicationConfiguration>? replicationConfigurations,
    String? requestPayer,
    List<BucketV2ServerSideEncryptionConfiguration>? serverSideEncryptionConfigurations,
    Map<String, String>? tags,
    Map<String, String>? tagsAll,
    List<BucketV2Versioning>? versionings,
    List<BucketV2Website>? websites,
  }) :
  ...
  factory BucketV2Args.fromMap(Map<String, dynamic> map) {
    return BucketV2Args(
      ...
      corsRules: map['corsRules'] == null ? null : pulumi.Input.decodeList<BucketV2CorsRule>(map['corsRules'], (value) => BucketV2CorsRule.fromMap((value as Map).cast<String, dynamic>())),
      forceDestroy: map['forceDestroy'] == null ? null : map['forceDestroy'] as bool,
      grants: map['grants'] == null ? null : pulumi.Input.decodeList<BucketV2Grant>(map['grants'], (value) => BucketV2Grant.fromMap((value as Map).cast<String, dynamic>())),
      lifecycleRules: map['lifecycleRules'] == null ? null : pulumi.Input.decodeList<BucketV2LifecycleRule>(map['lifecycleRules'], (value) => BucketV2LifecycleRule.fromMap((value as Map).cast<String, dynamic>())),
      loggings: map['loggings'] == null ? null : pulumi.Input.decodeList<BucketV2Logging>(map['loggings'], (value) => BucketV2Logging.fromMap((value as Map).cast<String, dynamic>())),
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : BucketV2ObjectLockConfiguration.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>()),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : map['objectLockEnabled'] as bool,
      policy: map['policy'] == null ? null : map['policy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      replicationConfigurations: map['replicationConfigurations'] == null ? null : pulumi.Input.decodeList<BucketV2ReplicationConfiguration>(map['replicationConfigurations'], (value) => BucketV2ReplicationConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      requestPayer: map['requestPayer'] == null ? null : map['requestPayer'] as String,
      serverSideEncryptionConfigurations: map['serverSideEncryptionConfigurations'] == null ? null : pulumi.Input.decodeList<BucketV2ServerSideEncryptionConfiguration>(map['serverSideEncryptionConfigurations'], (value) => BucketV2ServerSideEncryptionConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tagsAll: map['tagsAll'] == null ? null : (map['tagsAll'] as Map).cast<String, String>(),
      versionings: map['versionings'] == null ? null : pulumi.Input.decodeList<BucketV2Versioning>(map['versionings'], (value) => BucketV2Versioning.fromMap((value as Map).cast<String, dynamic>())),
      websites: map['websites'] == null ? null : pulumi.Input.decodeList<BucketV2Website>(map['websites'], (value) => BucketV2Website.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
