...
class BucketV2Args {
  ...
  BucketV2Args({
    ...
    List<BucketV2Website>? websites,
  }) : accelerationStatus = pulumi.Input.asOptionalInput<String>(
         accelerationStatus,
       ),
       ...
       lifecycleRules = pulumi
           .Input.asOptionalInput<List<BucketV2LifecycleRule>>(lifecycleRules),
       ...
       objectLockEnabled = pulumi.Input.asOptionalInput<bool>(
         objectLockEnabled,
       ),
