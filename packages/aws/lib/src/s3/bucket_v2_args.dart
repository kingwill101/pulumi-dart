...
class BucketV2Args {
  ...
  BucketV2Args({
    ...
    List<BucketV2Website>? websites,
            ...
            pulumi.Input.asOptionalInput<String>(accelerationStatus),
        acl = pulumi.Input.asOptionalInput<String>(acl),
        bucket = pulumi.Input.asOptionalInput<String>(bucket),
        bucketPrefix = pulumi.Input.asOptionalInput<String>(bucketPrefix),
        corsRules =
            pulumi.Input.asOptionalInput<List<BucketV2CorsRule>>(corsRules),
        forceDestroy = pulumi.Input.asOptionalInput<bool>(forceDestroy),
        grants = pulumi.Input.asOptionalInput<List<BucketV2Grant>>(grants),
        lifecycleRules =
            pulumi.Input.asOptionalInput<List<BucketV2LifecycleRule>>(
                lifecycleRules),
        loggings =
            pulumi.Input.asOptionalInput<List<BucketV2Logging>>(loggings),
        objectLockConfiguration =
            pulumi.Input.asOptionalInput<BucketV2ObjectLockConfiguration>(
                objectLockConfiguration),
        objectLockEnabled =
            pulumi.Input.asOptionalInput<bool>(objectLockEnabled),
        policy = pulumi.Input.asOptionalInput<String>(policy),
        region = pulumi.Input.asOptionalInput<String>(region),
        replicationConfigurations = pulumi.Input.asOptionalInput<
            List<BucketV2ReplicationConfiguration>>(replicationConfigurations),
        ...
        versionings =
            pulumi.Input.asOptionalInput<List<BucketV2Versioning>>(versionings),
        websites =
            pulumi.Input.asOptionalInput<List<BucketV2Website>>(websites);
  ...
  factory BucketV2Args.fromMap(Map<String, dynamic> map) {
    return BucketV2Args(
      ...
      lifecycleRules: map['lifecycleRules'] == null
          ...
          : pulumi.Input.decodeList<BucketV2LifecycleRule>(
              ...
              (value) => BucketV2LifecycleRule.fromMap(
                  (value as Map).cast<String, dynamic>())),
      loggings: map['loggings'] == null
          ? null
          : pulumi.Input.decodeList<BucketV2Logging>(
              map['loggings'],
              (value) => BucketV2Logging.fromMap(
                  (value as Map).cast<String, dynamic>())),
      ...
      replicationConfigurations: map['replicationConfigurations'] == null
          ? null
      ...
      serverSideEncryptionConfigurations:
          map['serverSideEncryptionConfigurations'] == null
              ? null
      ...
      versionings: map['versionings'] == null
          ? null
