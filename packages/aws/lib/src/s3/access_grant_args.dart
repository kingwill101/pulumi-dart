...
class AccessGrantArgs {
  ...
  AccessGrantArgs({
    AccessGrantAccessGrantsLocationConfiguration? accessGrantsLocationConfiguration,
  ...
  factory AccessGrantArgs.fromMap(Map<String, dynamic> map) {
    return AccessGrantArgs(
      accessGrantsLocationConfiguration: map['accessGrantsLocationConfiguration'] == null ? null : AccessGrantAccessGrantsLocationConfiguration.fromMap((map['accessGrantsLocationConfiguration'] as Map).cast<String, dynamic>()),
      accessGrantsLocationId: map['accessGrantsLocationId'] as String,
      accountId: map['accountId'] == null ? null : map['accountId'] as String,
      grantee: AccessGrantGrantee.fromMap((map['grantee'] as Map).cast<String, dynamic>()),
      permission: map['permission'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      s3PrefixType: map['s3PrefixType'] == null ? null : map['s3PrefixType'] as String,
