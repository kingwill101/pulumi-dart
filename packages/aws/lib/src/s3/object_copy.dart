...
class ObjectCopy extends pulumi.CustomResource {
  ...
  ObjectCopy(
    ...
    this.copyIfUnmodifiedSince = registerOutput<String?>(
    ...
    this.expectedSourceBucketOwner = registerOutput<String?>(
    ...
    this.objectLockLegalHoldStatus = registerOutput<String>(
      'objectLockLegalHoldStatus',
    );
    this.objectLockMode = registerOutput<String>('objectLockMode');
    this.objectLockRetainUntilDate = registerOutput<String>(
      'objectLockRetainUntilDate',
    );
    this.overrideProvider = registerOutput<ObjectCopyOverrideProvider?>(
      'overrideProvider',
    );
    ...
    this.sourceCustomerAlgorithm = registerOutput<String?>(
