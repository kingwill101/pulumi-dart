...
class BucketNotificationArgs {
  ...
  factory BucketNotificationArgs.fromMap(Map<String, dynamic> map) {
    return BucketNotificationArgs(
      ...
      eventbridge: map['eventbridge'] == null ? null : map['eventbridge'] as bool,
      lambdaFunctions: map['lambdaFunctions'] == null ? null : pulumi.Input.decodeList<BucketNotificationLambdaFunction>(map['lambdaFunctions'], (value) => BucketNotificationLambdaFunction.fromMap((value as Map).cast<String, dynamic>())),
      queues: map['queues'] == null ? null : pulumi.Input.decodeList<BucketNotificationQueue>(map['queues'], (value) => BucketNotificationQueue.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      topics: map['topics'] == null ? null : pulumi.Input.decodeList<BucketNotificationTopic>(map['topics'], (value) => BucketNotificationTopic.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
