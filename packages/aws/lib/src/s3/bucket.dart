...
class Bucket extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<BucketGrant>> grants;
  ...
  Bucket(
    ...
    this.objectLockConfiguration = registerOutput<BucketObjectLockConfiguration>('objectLockConfiguration');
    this.objectLockEnabled = registerOutput<bool>('objectLockEnabled');
    this.policy = registerOutput<String>('policy');
    this.region = registerOutput<String>('region');
    this.replicationConfiguration = registerOutput<BucketReplicationConfiguration>('replicationConfiguration');
    this.requestPayer = registerOutput<String>('requestPayer');
    this.serverSideEncryptionConfiguration = registerOutput<BucketServerSideEncryptionConfiguration>('serverSideEncryptionConfiguration');
