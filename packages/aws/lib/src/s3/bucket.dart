...
class Bucket extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BucketObjectLockConfiguration>
  ...
  late final pulumi.Output<BucketReplicationConfiguration>
  ...
  late final pulumi.Output<BucketServerSideEncryptionConfiguration>
  ...
  Bucket(String name, {BucketArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.bucketRegionalDomainName = registerOutput<String>(
    ...
    this.lifecycleRules = registerOutput<List<BucketLifecycleRule>>(
      'lifecycleRules',
    );
