...
class BucketV2ReplicationConfigurationRuleDestination {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessControlTranslations': ?accessControlTranslations == null
          ? null
          : pulumi.Input.encodeList<
              BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation,
              Map<String, dynamic>
            >(accessControlTranslations!, (value) => value.toMap()),
      'accountId': ?accountId,
      'bucket': bucket,
      ...
      'replicationTimes': ?replicationTimes == null
          ? null
          : pulumi.Input.encodeList<
              BucketV2ReplicationConfigurationRuleDestinationReplicationTime,
              Map<String, dynamic>
            >(replicationTimes!, (value) => value.toMap()),
