...
class BucketV2ReplicationConfigurationRuleDestination {
  ...
  final List<BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation>? accessControlTranslations;
  ...
  final List<BucketV2ReplicationConfigurationRuleDestinationReplicationTime>? replicationTimes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessControlTranslations': ?accessControlTranslations == null ? null : pulumi.Input.encodeList<BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation, Map<String, dynamic>>(accessControlTranslations!, (value) => value.toMap()),
      'accountId': ?accountId,
      'bucket': bucket,
      'metrics': ?metrics == null ? null : pulumi.Input.encodeList<BucketV2ReplicationConfigurationRuleDestinationMetric, Map<String, dynamic>>(metrics!, (value) => value.toMap()),
      'replicaKmsKeyId': ?replicaKmsKeyId,
      'replicationTimes': ?replicationTimes == null ? null : pulumi.Input.encodeList<BucketV2ReplicationConfigurationRuleDestinationReplicationTime, Map<String, dynamic>>(replicationTimes!, (value) => value.toMap()),
  ...
  factory BucketV2ReplicationConfigurationRuleDestination.fromMap(Map<String, dynamic> map) {
    return BucketV2ReplicationConfigurationRuleDestination(
      ...
      metrics: map['metrics'] == null ? null : pulumi.Input.decodeList<BucketV2ReplicationConfigurationRuleDestinationMetric>(map['metrics'], (value) => BucketV2ReplicationConfigurationRuleDestinationMetric.fromMap((value as Map).cast<String, dynamic>())),
      replicaKmsKeyId: map['replicaKmsKeyId'] == null ? null : map['replicaKmsKeyId'] as String,
      replicationTimes: map['replicationTimes'] == null ? null : pulumi.Input.decodeList<BucketV2ReplicationConfigurationRuleDestinationReplicationTime>(map['replicationTimes'], (value) => BucketV2ReplicationConfigurationRuleDestinationReplicationTime.fromMap((value as Map).cast<String, dynamic>())),
