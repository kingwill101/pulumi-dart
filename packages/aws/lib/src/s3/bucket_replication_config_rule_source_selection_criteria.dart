...
class BucketReplicationConfigRuleSourceSelectionCriteria {
  ...
  final BucketReplicationConfigRuleSourceSelectionCriteriaReplicaModifications? replicaModifications;
  ...
  final BucketReplicationConfigRuleSourceSelectionCriteriaSseKmsEncryptedObjects? sseKmsEncryptedObjects;
  ...
  factory BucketReplicationConfigRuleSourceSelectionCriteria.fromMap(Map<String, dynamic> map) {
    return BucketReplicationConfigRuleSourceSelectionCriteria(
      replicaModifications: map['replicaModifications'] == null ? null : BucketReplicationConfigRuleSourceSelectionCriteriaReplicaModifications.fromMap((map['replicaModifications'] as Map).cast<String, dynamic>()),
      sseKmsEncryptedObjects: map['sseKmsEncryptedObjects'] == null ? null : BucketReplicationConfigRuleSourceSelectionCriteriaSseKmsEncryptedObjects.fromMap((map['sseKmsEncryptedObjects'] as Map).cast<String, dynamic>()),
    );
  }
}
