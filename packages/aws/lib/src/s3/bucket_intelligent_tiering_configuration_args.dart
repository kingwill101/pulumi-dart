...
class BucketIntelligentTieringConfigurationArgs {
  ...
  factory BucketIntelligentTieringConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return BucketIntelligentTieringConfigurationArgs(
      ...
      filter: map['filter'] == null ? null : BucketIntelligentTieringConfigurationFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      tierings: pulumi.Input.decodeList<BucketIntelligentTieringConfigurationTiering>(map['tierings'], (value) => BucketIntelligentTieringConfigurationTiering.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
