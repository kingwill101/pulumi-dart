...
class BucketReplicationConfigArgs {
  ...
  BucketReplicationConfigArgs({
    ...
    required List<BucketReplicationConfigRule> rules,
    String? token,
  }) :
  ...
  factory BucketReplicationConfigArgs.fromMap(Map<String, dynamic> map) {
    return BucketReplicationConfigArgs(
      ...
      rules: pulumi.Input.decodeList<BucketReplicationConfigRule>(map['rules'], (value) => BucketReplicationConfigRule.fromMap((value as Map).cast<String, dynamic>())),
