...
class BucketAclAccessControlPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'grants': ?grants == null ? null : pulumi.Input.encodeList<BucketAclAccessControlPolicyGrant, Map<String, dynamic>>(grants!, (value) => value.toMap()),
      'owner': owner.toMap(),
    };
  }
  ...
  factory BucketAclAccessControlPolicy.fromMap(Map<String, dynamic> map) {
    return BucketAclAccessControlPolicy(
      grants: map['grants'] == null ? null : pulumi.Input.decodeList<BucketAclAccessControlPolicyGrant>(map['grants'], (value) => BucketAclAccessControlPolicyGrant.fromMap((value as Map).cast<String, dynamic>())),
      owner: BucketAclAccessControlPolicyOwner.fromMap((map['owner'] as Map).cast<String, dynamic>()),
    );
  }
}
