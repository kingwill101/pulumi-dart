...
class BucketLoggingV2Args {
  ...
  BucketLoggingV2Args({
    ...
    List<BucketLoggingV2TargetGrant>? targetGrants,
    BucketLoggingV2TargetObjectKeyFormat? targetObjectKeyFormat,
  ...
  factory BucketLoggingV2Args.fromMap(Map<String, dynamic> map) {
    return BucketLoggingV2Args(
      ...
      targetGrants: map['targetGrants'] == null ? null : pulumi.Input.decodeList<BucketLoggingV2TargetGrant>(map['targetGrants'], (value) => BucketLoggingV2TargetGrant.fromMap((value as Map).cast<String, dynamic>())),
      targetObjectKeyFormat: map['targetObjectKeyFormat'] == null ? null : BucketLoggingV2TargetObjectKeyFormat.fromMap((map['targetObjectKeyFormat'] as Map).cast<String, dynamic>()),
