...
class DirectoryBucketArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': pulumi.Input.mapInputValue<DirectoryBucketLocation, Map<String, dynamic>>(location, (value) => value.toMap()),
      'region': ?region,
      'tags': ?tags,
      'type': ?type,
    };
  ...
  factory DirectoryBucketArgs.fromMap(Map<String, dynamic> map) {
    return DirectoryBucketArgs(
      ...
      dataRedundancy: map['dataRedundancy'] == null ? null : map['dataRedundancy'] as String,
      forceDestroy: map['forceDestroy'] == null ? null : map['forceDestroy'] as bool,
      location: DirectoryBucketLocation.fromMap((map['location'] as Map).cast<String, dynamic>()),
