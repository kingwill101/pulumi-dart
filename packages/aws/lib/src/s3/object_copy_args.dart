...
class ObjectCopyArgs {
  ...
  ObjectCopyArgs({
    ...
    String? websiteRedirect,
        ...
        checksumAlgorithm =
            pulumi.Input.asOptionalInput<String>(checksumAlgorithm),
        contentDisposition =
        ...
        copyIfModifiedSince =
            pulumi.Input.asOptionalInput<String>(copyIfModifiedSince),
        copyIfNoneMatch = pulumi.Input.asOptionalInput<String>(copyIfNoneMatch),
        copyIfUnmodifiedSince =
            pulumi.Input.asOptionalInput<String>(copyIfUnmodifiedSince),
        customerAlgorithm =
            pulumi.Input.asOptionalInput<String>(customerAlgorithm),
        ...
        expectedSourceBucketOwner =
            pulumi.Input.asOptionalInput<String>(expectedSourceBucketOwner),
        ...
        kmsEncryptionContext =
            pulumi.Input.asOptionalInput<String>(kmsEncryptionContext),
        kmsKeyId = pulumi.Input.asOptionalInput<String>(kmsKeyId),
        metadata = pulumi.Input.asOptionalInput<Map<String, String>>(metadata),
        metadataDirective =
            pulumi.Input.asOptionalInput<String>(metadataDirective),
        ...
        sourceCustomerAlgorithm =
            pulumi.Input.asOptionalInput<String>(sourceCustomerAlgorithm),
        sourceCustomerKey =
            pulumi.Input.asOptionalInput<String>(sourceCustomerKey),
        sourceCustomerKeyMd5 =
            pulumi.Input.asOptionalInput<String>(sourceCustomerKeyMd5),
        storageClass = pulumi.Input.asOptionalInput<String>(storageClass),
        taggingDirective =
            pulumi.Input.asOptionalInput<String>(taggingDirective),
  ...
  factory ObjectCopyArgs.fromMap(Map<String, dynamic> map) {
    return ObjectCopyArgs(
      ...
      copyIfMatch:
          map['copyIfMatch'] == null ? null : map['copyIfMatch'] as String,
      ...
      customerKey:
          map['customerKey'] == null ? null : map['customerKey'] as String,
