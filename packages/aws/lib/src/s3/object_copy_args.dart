...
class ObjectCopyArgs {
  ...
  ObjectCopyArgs({
    ...
    String? websiteRedirect,
       ...
       checksumAlgorithm = pulumi.Input.asOptionalInput<String>(
         checksumAlgorithm,
       ),
       ...
       copyIfModifiedSince = pulumi.Input.asOptionalInput<String>(
         copyIfModifiedSince,
       ),
       copyIfNoneMatch = pulumi.Input.asOptionalInput<String>(copyIfNoneMatch),
       copyIfUnmodifiedSince = pulumi.Input.asOptionalInput<String>(
         copyIfUnmodifiedSince,
       ),
       customerAlgorithm = pulumi.Input.asOptionalInput<String>(
         customerAlgorithm,
       ),
       ...
       kmsEncryptionContext = pulumi.Input.asOptionalInput<String>(
         kmsEncryptionContext,
       ),
       kmsKeyId = pulumi.Input.asOptionalInput<String>(kmsKeyId),
       metadata = pulumi.Input.asOptionalInput<Map<String, String>>(metadata),
       metadataDirective = pulumi.Input.asOptionalInput<String>(
         metadataDirective,
       ),
       ...
       overrideProvider = pulumi
           .Input.asOptionalInput<ObjectCopyOverrideProvider>(overrideProvider),
       ...
       sourceCustomerAlgorithm = pulumi.Input.asOptionalInput<String>(
         sourceCustomerAlgorithm,
       ),
       sourceCustomerKey = pulumi.Input.asOptionalInput<String>(
         sourceCustomerKey,
       ),
       sourceCustomerKeyMd5 = pulumi.Input.asOptionalInput<String>(
         sourceCustomerKeyMd5,
       ),
       storageClass = pulumi.Input.asOptionalInput<String>(storageClass),
       taggingDirective = pulumi.Input.asOptionalInput<String>(
         taggingDirective,
       ),
  ...
  factory ObjectCopyArgs.fromMap(Map<String, dynamic> map) {
    return ObjectCopyArgs(
      ...
      checksumAlgorithm: map['checksumAlgorithm'] == null
          ? null
          : map['checksumAlgorithm'] as String,
      ...
      copyIfMatch: map['copyIfMatch'] == null
          ? null
          : map['copyIfMatch'] as String,
      copyIfModifiedSince: map['copyIfModifiedSince'] == null
          ? null
          : map['copyIfModifiedSince'] as String,
      copyIfNoneMatch: map['copyIfNoneMatch'] == null
          ? null
          : map['copyIfNoneMatch'] as String,
      copyIfUnmodifiedSince: map['copyIfUnmodifiedSince'] == null
          ? null
          : map['copyIfUnmodifiedSince'] as String,
      customerAlgorithm: map['customerAlgorithm'] == null
          ? null
          : map['customerAlgorithm'] as String,
      customerKey: map['customerKey'] == null
          ? null
          : map['customerKey'] as String,
      customerKeyMd5: map['customerKeyMd5'] == null
          ? null
          : map['customerKeyMd5'] as String,
      expectedBucketOwner: map['expectedBucketOwner'] == null
          ? null
          : map['expectedBucketOwner'] as String,
      expectedSourceBucketOwner: map['expectedSourceBucketOwner'] == null
          ? null
          : map['expectedSourceBucketOwner'] as String,
      ...
      grants: map['grants'] == null
          ...
          : pulumi.Input.decodeList<ObjectCopyGrant>(
              map['grants'],
              (value) => ObjectCopyGrant.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      key: map['key'] as String,
      kmsEncryptionContext: map['kmsEncryptionContext'] == null
          ? null
          : map['kmsEncryptionContext'] as String,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      metadata: map['metadata'] == null
          ? null
          : (map['metadata'] as Map).cast<String, String>(),
      metadataDirective: map['metadataDirective'] == null
          ? null
          : map['metadataDirective'] as String,
      ...
      overrideProvider: map['overrideProvider'] == null
          ? null
          : ObjectCopyOverrideProvider.fromMap(
              (map['overrideProvider'] as Map).cast<String, dynamic>(),
            ),
      ...
      sourceCustomerAlgorithm: map['sourceCustomerAlgorithm'] == null
          ? null
          : map['sourceCustomerAlgorithm'] as String,
      sourceCustomerKey: map['sourceCustomerKey'] == null
          ? null
          : map['sourceCustomerKey'] as String,
      sourceCustomerKeyMd5: map['sourceCustomerKeyMd5'] == null
          ? null
          : map['sourceCustomerKeyMd5'] as String,
      storageClass: map['storageClass'] == null
          ? null
          : map['storageClass'] as String,
      taggingDirective: map['taggingDirective'] == null
          ? null
          : map['taggingDirective'] as String,
      tags: map['tags'] == null
          ? null
