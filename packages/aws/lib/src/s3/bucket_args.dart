...
class BucketArgs {
  ...
  BucketArgs({
    ...
    String? requestPayer,
    BucketServerSideEncryptionConfiguration? serverSideEncryptionConfiguration,
  ...
  factory BucketArgs.fromMap(Map<String, dynamic> map) {
    return BucketArgs(
      ...
      grants: map['grants'] == null ? null : pulumi.Input.decodeList<BucketGrant>(map['grants'], (value) => BucketGrant.fromMap((value as Map).cast<String, dynamic>())),
      ...
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : BucketObjectLockConfiguration.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>()),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : map['objectLockEnabled'] as bool,
      policy: map['policy'] == null ? null : map['policy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      replicationConfiguration: map['replicationConfiguration'] == null ? null : BucketReplicationConfiguration.fromMap((map['replicationConfiguration'] as Map).cast<String, dynamic>()),
      requestPayer: map['requestPayer'] == null ? null : map['requestPayer'] as String,
      serverSideEncryptionConfiguration: map['serverSideEncryptionConfiguration'] == null ? null : BucketServerSideEncryptionConfiguration.fromMap((map['serverSideEncryptionConfiguration'] as Map).cast<String, dynamic>()),
