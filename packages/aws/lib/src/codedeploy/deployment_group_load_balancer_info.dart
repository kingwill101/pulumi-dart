...
class DeploymentGroupLoadBalancerInfo {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'elbInfos': ?elbInfos == null
          ? null
          : pulumi.Input.encodeList<
              DeploymentGroupLoadBalancerInfoElbInfo,
              Map<String, dynamic>
            >(elbInfos!, (value) => value.toMap()),
      'targetGroupInfos': ?targetGroupInfos == null
          ? null
          : pulumi.Input.encodeList<
              DeploymentGroupLoadBalancerInfoTargetGroupInfo,
              Map<String, dynamic>
            >(targetGroupInfos!, (value) => value.toMap()),
      'targetGroupPairInfo': ?targetGroupPairInfo == null
          ? null
          : targetGroupPairInfo!.toMap(),
    };
  }
