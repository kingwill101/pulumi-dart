...
class DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccess {
  ...
  Map<String, dynamic> toMap() {
    ...
    final terminationWaitTimeInMinutesValue = terminationWaitTimeInMinutes;
    if (terminationWaitTimeInMinutesValue != null) {
      map['terminationWaitTimeInMinutes'] = terminationWaitTimeInMinutesValue;
    }
    return map;
  }
