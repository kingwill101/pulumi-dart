  ...
  DeploymentGroupArgs({
    ...
    List<DeploymentGroupTriggerConfiguration>? triggerConfigurations,
       ...
       autoRollbackConfiguration =
           ...
           >(autoRollbackConfiguration),
       autoscalingGroups = pulumi.Input.asOptionalInput<List<String>>(
         autoscalingGroups,
       ),
       blueGreenDeploymentConfig =
           pulumi.Input.asOptionalInput<
       ...
       ec2TagSets = pulumi
           .Input.asOptionalInput<List<DeploymentGroupEc2TagSet>>(ec2TagSets),
       ...
       terminationHookEnabled = pulumi.Input.asOptionalInput<bool>(
    ...
    return DeploymentGroupArgs(
      ...
      blueGreenDeploymentConfig: map['blueGreenDeploymentConfig'] == null
          ...
          : DeploymentGroupBlueGreenDeploymentConfig.fromMap(
              (map['blueGreenDeploymentConfig'] as Map).cast<String, dynamic>(),
            ),
