...
class DeploymentGroupArgs {
  ...
  DeploymentGroupArgs({
    ...
    List<DeploymentGroupOnPremisesInstanceTagFilter>? onPremisesInstanceTagFilters,
  ...
  factory DeploymentGroupArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentGroupArgs(
      alarmConfiguration: map['alarmConfiguration'] == null ? null : DeploymentGroupAlarmConfiguration.fromMap((map['alarmConfiguration'] as Map).cast<String, dynamic>()),
      appName: map['appName'] as String,
      autoRollbackConfiguration: map['autoRollbackConfiguration'] == null ? null : DeploymentGroupAutoRollbackConfiguration.fromMap((map['autoRollbackConfiguration'] as Map).cast<String, dynamic>()),
      autoscalingGroups: map['autoscalingGroups'] == null ? null : (map['autoscalingGroups'] as List).cast<String>(),
      blueGreenDeploymentConfig: map['blueGreenDeploymentConfig'] == null ? null : DeploymentGroupBlueGreenDeploymentConfig.fromMap((map['blueGreenDeploymentConfig'] as Map).cast<String, dynamic>()),
      ...
      deploymentStyle: map['deploymentStyle'] == null ? null : DeploymentGroupDeploymentStyle.fromMap((map['deploymentStyle'] as Map).cast<String, dynamic>()),
      ec2TagFilters: map['ec2TagFilters'] == null ? null : pulumi.Input.decodeList<DeploymentGroupEc2TagFilter>(map['ec2TagFilters'], (value) => DeploymentGroupEc2TagFilter.fromMap((value as Map).cast<String, dynamic>())),
      ec2TagSets: map['ec2TagSets'] == null ? null : pulumi.Input.decodeList<DeploymentGroupEc2TagSet>(map['ec2TagSets'], (value) => DeploymentGroupEc2TagSet.fromMap((value as Map).cast<String, dynamic>())),
      ecsService: map['ecsService'] == null ? null : DeploymentGroupEcsService.fromMap((map['ecsService'] as Map).cast<String, dynamic>()),
      loadBalancerInfo: map['loadBalancerInfo'] == null ? null : DeploymentGroupLoadBalancerInfo.fromMap((map['loadBalancerInfo'] as Map).cast<String, dynamic>()),
      onPremisesInstanceTagFilters: map['onPremisesInstanceTagFilters'] == null ? null : pulumi.Input.decodeList<DeploymentGroupOnPremisesInstanceTagFilter>(map['onPremisesInstanceTagFilters'], (value) => DeploymentGroupOnPremisesInstanceTagFilter.fromMap((value as Map).cast<String, dynamic>())),
      outdatedInstancesStrategy: map['outdatedInstancesStrategy'] == null ? null : map['outdatedInstancesStrategy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      serviceRoleArn: map['serviceRoleArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      terminationHookEnabled: map['terminationHookEnabled'] == null ? null : map['terminationHookEnabled'] as bool,
      triggerConfigurations: map['triggerConfigurations'] == null ? null : pulumi.Input.decodeList<DeploymentGroupTriggerConfiguration>(map['triggerConfigurations'], (value) => DeploymentGroupTriggerConfiguration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
