...
class ResourcePolicyArgs {
  ...
  ResourcePolicyArgs({
    ...
    String? region,
  }) : bypassPolicyLockoutCheck = pulumi.Input.asOptionalInput<bool>(
         bypassPolicyLockoutCheck,
       ),
       policyDocument = pulumi.Input.asInput<String>(policyDocument),
       policyName = pulumi.Input.asInput<String>(policyName),
       policyRevisionId = pulumi.Input.asOptionalInput<String>(
         policyRevisionId,
       ),
  ...
  factory ResourcePolicyArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyArgs(
      bypassPolicyLockoutCheck: map['bypassPolicyLockoutCheck'] == null
          ? null
          : map['bypassPolicyLockoutCheck'] as bool,
      policyDocument: map['policyDocument'] as String,
      policyName: map['policyName'] as String,
      policyRevisionId: map['policyRevisionId'] == null
          ? null
          : map['policyRevisionId'] as String,
