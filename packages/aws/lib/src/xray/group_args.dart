...
class GroupArgs {
  ...
  GroupArgs({
    ...
    GroupInsightsConfiguration? insightsConfiguration,
    String? region,
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      filterExpression: map['filterExpression'] as String,
      groupName: map['groupName'] as String,
      insightsConfiguration: map['insightsConfiguration'] == null ? null : GroupInsightsConfiguration.fromMap((map['insightsConfiguration'] as Map).cast<String, dynamic>()),
