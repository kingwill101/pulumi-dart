...
class TeamsChannelConfigurationArgs {
  ...
  TeamsChannelConfigurationArgs({
    ...
    bool? userAuthorizationRequired,
        ...
        guardrailPolicyArns =
            pulumi.Input.asOptionalInput<List<String>>(guardrailPolicyArns),
        ...
        timeouts =
            pulumi.Input.asOptionalInput<TeamsChannelConfigurationTimeouts>(
                timeouts),
        userAuthorizationRequired =
            pulumi.Input.asOptionalInput<bool>(userAuthorizationRequired);
  ...
  factory TeamsChannelConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return TeamsChannelConfigurationArgs(
      ...
      channelName:
          map['channelName'] == null ? null : map['channelName'] as String,
