...
class TeamsChannelConfigurationTimeouts {
  ...
  /// Creates a new [TeamsChannelConfigurationTimeouts].
  ...
  TeamsChannelConfigurationTimeouts({this.create, this.delete, this.update});
  ...
  factory TeamsChannelConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return TeamsChannelConfigurationTimeouts(
