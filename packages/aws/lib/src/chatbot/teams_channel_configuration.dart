...
class TeamsChannelConfiguration extends pulumi.CustomResource {
  ...
  TeamsChannelConfiguration(
    ...
    this.guardrailPolicyArns = registerOutput<List<String>>('guardrailPolicyArns');
    ...
    this.timeouts = registerOutput<TeamsChannelConfigurationTimeouts?>('timeouts');
    this.userAuthorizationRequired = registerOutput<bool>('userAuthorizationRequired');
  }
}
