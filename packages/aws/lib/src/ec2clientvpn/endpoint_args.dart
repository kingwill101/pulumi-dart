...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    int? vpnPort,
        ...
        connectionLogOptions =
            pulumi.Input.asInput<EndpointConnectionLogOptions>(
                connectionLogOptions),
        description = pulumi.Input.asOptionalInput<String>(description),
        disconnectOnSessionTimeout =
            pulumi.Input.asOptionalInput<bool>(disconnectOnSessionTimeout),
        dnsServers = pulumi.Input.asOptionalInput<List<String>>(dnsServers),
        endpointIpAddressType =
            pulumi.Input.asOptionalInput<String>(endpointIpAddressType),
        region = pulumi.Input.asOptionalInput<String>(region),
        securityGroupIds =
            pulumi.Input.asOptionalInput<List<String>>(securityGroupIds),
        selfServicePortal =
            pulumi.Input.asOptionalInput<String>(selfServicePortal),
        serverCertificateArn =
            pulumi.Input.asInput<String>(serverCertificateArn),
        sessionTimeoutHours =
            pulumi.Input.asOptionalInput<int>(sessionTimeoutHours),
        splitTunnel = pulumi.Input.asOptionalInput<bool>(splitTunnel),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        trafficIpAddressType =
            pulumi.Input.asOptionalInput<String>(trafficIpAddressType),
        transportProtocol =
            pulumi.Input.asOptionalInput<String>(transportProtocol),
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      splitTunnel:
          map['splitTunnel'] == null ? null : map['splitTunnel'] as bool,
      tags: map['tags'] == null
          ? null
