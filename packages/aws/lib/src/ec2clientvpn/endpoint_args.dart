...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    int? vpnPort,
       ...
       connectionLogOptions = pulumi
           .Input.asInput<EndpointConnectionLogOptions>(connectionLogOptions),
       description = pulumi.Input.asOptionalInput<String>(description),
       disconnectOnSessionTimeout = pulumi.Input.asOptionalInput<bool>(
         disconnectOnSessionTimeout,
       ),
       dnsServers = pulumi.Input.asOptionalInput<List<String>>(dnsServers),
       endpointIpAddressType = pulumi.Input.asOptionalInput<String>(
       ...
       selfServicePortal = pulumi.Input.asOptionalInput<String>(
         selfServicePortal,
       ),
       serverCertificateArn = pulumi.Input.asInput<String>(
         serverCertificateArn,
       ),
       sessionTimeoutHours = pulumi.Input.asOptionalInput<int>(
         sessionTimeoutHours,
       ),
       splitTunnel = pulumi.Input.asOptionalInput<bool>(splitTunnel),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       trafficIpAddressType = pulumi.Input.asOptionalInput<String>(
         trafficIpAddressType,
       ),
       transportProtocol = pulumi.Input.asOptionalInput<String>(
         transportProtocol,
       ),
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      clientCidrBlock: map['clientCidrBlock'] == null
          ? null
          : map['clientCidrBlock'] as String,
      clientConnectOptions: map['clientConnectOptions'] == null
          ? null
          : EndpointClientConnectOptions.fromMap(
              (map['clientConnectOptions'] as Map).cast<String, dynamic>(),
            ),
      clientLoginBannerOptions: map['clientLoginBannerOptions'] == null
          ? null
          : EndpointClientLoginBannerOptions.fromMap(
              (map['clientLoginBannerOptions'] as Map).cast<String, dynamic>(),
            ),
      clientRouteEnforcementOptions:
          map['clientRouteEnforcementOptions'] == null
          ? null
          : EndpointClientRouteEnforcementOptions.fromMap(
              (map['clientRouteEnforcementOptions'] as Map)
                  .cast<String, dynamic>(),
            ),
      connectionLogOptions: EndpointConnectionLogOptions.fromMap(
        (map['connectionLogOptions'] as Map).cast<String, dynamic>(),
      ),
      description: map['description'] == null
          ? null
          : map['description'] as String,
      disconnectOnSessionTimeout: map['disconnectOnSessionTimeout'] == null
          ? null
          : map['disconnectOnSessionTimeout'] as bool,
      dnsServers: map['dnsServers'] == null
          ? null
          : (map['dnsServers'] as List).cast<String>(),
      endpointIpAddressType: map['endpointIpAddressType'] == null
          ? null
          : map['endpointIpAddressType'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      securityGroupIds: map['securityGroupIds'] == null
          ? null
          : (map['securityGroupIds'] as List).cast<String>(),
      selfServicePortal: map['selfServicePortal'] == null
          ? null
          : map['selfServicePortal'] as String,
      serverCertificateArn: map['serverCertificateArn'] as String,
      sessionTimeoutHours: map['sessionTimeoutHours'] == null
          ? null
          : map['sessionTimeoutHours'] as int,
      splitTunnel: map['splitTunnel'] == null
          ? null
          : map['splitTunnel'] as bool,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      trafficIpAddressType: map['trafficIpAddressType'] == null
          ? null
          : map['trafficIpAddressType'] as String,
      transportProtocol: map['transportProtocol'] == null
          ? null
          : map['transportProtocol'] as String,
