...
class Endpoint extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<EndpointAuthenticationOption>>
  authenticationOptions;
  ...
  Endpoint(
    ...
    this.clientConnectOptions = registerOutput<EndpointClientConnectOptions>(
    ...
    this.connectionLogOptions = registerOutput<EndpointConnectionLogOptions>(
      'connectionLogOptions',
    );
    this.description = registerOutput<String?>('description');
    this.disconnectOnSessionTimeout = registerOutput<bool>(
      'disconnectOnSessionTimeout',
    );
    this.dnsName = registerOutput<String>('dnsName');
    this.dnsServers = registerOutput<List<String>?>('dnsServers');
    this.endpointIpAddressType = registerOutput<String>(
