...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      clusterEndpointEncryptionType: map['clusterEndpointEncryptionType'] == null ? null : map['clusterEndpointEncryptionType'] as String,
      ...
      serverSideEncryption: map['serverSideEncryption'] == null ? null : ClusterServerSideEncryption.fromMap((map['serverSideEncryption'] as Map).cast<String, dynamic>()),
