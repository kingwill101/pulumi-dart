...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.clusterEndpointEncryptionType = registerOutput<String?>('clusterEndpointEncryptionType');
    ...
    this.serverSideEncryption = registerOutput<ClusterServerSideEncryption?>('serverSideEncryption');
