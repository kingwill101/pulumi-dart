...
class RecorderArgs {
  ...
  RecorderArgs({
    ...
    required String roleArn,
        ...
        recordingGroup = pulumi.Input.asOptionalInput<RecorderRecordingGroup>(
            recordingGroup),
        recordingMode =
            pulumi.Input.asOptionalInput<RecorderRecordingMode>(recordingMode),
  ...
  factory RecorderArgs.fromMap(Map<String, dynamic> map) {
    return RecorderArgs(
      ...
      recordingGroup: map['recordingGroup'] == null
          ? null
          : RecorderRecordingGroup.fromMap(
              (map['recordingGroup'] as Map).cast<String, dynamic>()),
      recordingMode: map['recordingMode'] == null
          ? null
          : RecorderRecordingMode.fromMap(
              (map['recordingMode'] as Map).cast<String, dynamic>()),
