...
class RecorderRecordingMode {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recordingModeOverride': ?recordingModeOverride == null ? null : recordingModeOverride!.toMap(),
    };
  }

  factory RecorderRecordingMode.fromMap(Map<String, dynamic> map) {
    return RecorderRecordingMode(
      recordingFrequency: map['recordingFrequency'] == null ? null : map['recordingFrequency'] as String,
      recordingModeOverride: map['recordingModeOverride'] == null ? null : RecorderRecordingModeRecordingModeOverride.fromMap((map['recordingModeOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
