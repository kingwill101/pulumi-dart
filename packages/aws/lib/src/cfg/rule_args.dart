...
class RuleArgs {
  ...
  factory RuleArgs.fromMap(Map<String, dynamic> map) {
    return RuleArgs(
      ...
      evaluationModes: map['evaluationModes'] == null ? null : pulumi.Input.decodeList<RuleEvaluationMode>(map['evaluationModes'], (value) => RuleEvaluationMode.fromMap((value as Map).cast<String, dynamic>())),
      inputParameters: map['inputParameters'] == null ? null : map['inputParameters'] as String,
      ...
      scope: map['scope'] == null ? null : RuleScope.fromMap((map['scope'] as Map).cast<String, dynamic>()),
      source: RuleSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
