...
class RuleSource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customPolicyDetails': ?customPolicyDetails == null ? null : customPolicyDetails!.toMap(),
      'owner': owner,
      'sourceDetails': ?sourceDetails == null ? null : pulumi.Input.encodeList<RuleSourceSourceDetail, Map<String, dynamic>>(sourceDetails!, (value) => value.toMap()),
  ...
  factory RuleSource.fromMap(Map<String, dynamic> map) {
    return RuleSource(
      customPolicyDetails: map['customPolicyDetails'] == null ? null : RuleSourceCustomPolicyDetails.fromMap((map['customPolicyDetails'] as Map).cast<String, dynamic>()),
      owner: map['owner'] as String,
      sourceDetails: map['sourceDetails'] == null ? null : pulumi.Input.decodeList<RuleSourceSourceDetail>(map['sourceDetails'], (value) => RuleSourceSourceDetail.fromMap((value as Map).cast<String, dynamic>())),
