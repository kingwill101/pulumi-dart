...
class RemediationConfigurationArgs {
  ...
  factory RemediationConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RemediationConfigurationArgs(
      ...
      executionControls: map['executionControls'] == null ? null : RemediationConfigurationExecutionControls.fromMap((map['executionControls'] as Map).cast<String, dynamic>()),
      maximumAutomaticAttempts: map['maximumAutomaticAttempts'] == null ? null : map['maximumAutomaticAttempts'] as int,
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<RemediationConfigurationParameter>(map['parameters'], (value) => RemediationConfigurationParameter.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      resourceType: map['resourceType'] == null ? null : map['resourceType'] as String,
      retryAttemptSeconds: map['retryAttemptSeconds'] == null ? null : map['retryAttemptSeconds'] as int,
