...
class RemediationConfigurationParameter {
  ...
  factory RemediationConfigurationParameter.fromMap(Map<String, dynamic> map) {
    return RemediationConfigurationParameter(
      ...
      resourceValue: map['resourceValue'] == null ? null : map['resourceValue'] as String,
      staticValue: map['staticValue'] == null ? null : map['staticValue'] as String,
      staticValues: map['staticValues'] == null ? null : (map['staticValues'] as List).cast<String>(),
    );
  }
}
