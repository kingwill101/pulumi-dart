...
class RecorderRecordingGroup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exclusionByResourceTypes': ?exclusionByResourceTypes == null
          ? null
          : pulumi.Input.encodeList<
              RecorderRecordingGroupExclusionByResourceType,
              Map<String, dynamic>
            >(exclusionByResourceTypes!, (value) => value.toMap()),
      'includeGlobalResourceTypes': ?includeGlobalResourceTypes,
      'recordingStrategies': ?recordingStrategies == null
          ? null
          : pulumi.Input.encodeList<
              RecorderRecordingGroupRecordingStrategy,
              Map<String, dynamic>
            >(recordingStrategies!, (value) => value.toMap()),
  ...
  factory RecorderRecordingGroup.fromMap(Map<String, dynamic> map) {
    return RecorderRecordingGroup(
      allSupported: map['allSupported'] == null
          ? null
          : map['allSupported'] as bool,
