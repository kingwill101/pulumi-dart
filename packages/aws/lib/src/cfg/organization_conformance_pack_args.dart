...
class OrganizationConformancePackArgs {
  ...
  }) : deliveryS3Bucket = pulumi.Input.asOptionalInput<String>(
         deliveryS3Bucket,
       ),
       deliveryS3KeyPrefix = pulumi.Input.asOptionalInput<String>(
         deliveryS3KeyPrefix,
       ),
       excludedAccounts = pulumi.Input.asOptionalInput<List<String>>(
         excludedAccounts,
       ),
       inputParameters =
  ...
  factory OrganizationConformancePackArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationConformancePackArgs(
      deliveryS3Bucket: map['deliveryS3Bucket'] == null
          ? null
          : map['deliveryS3Bucket'] as String,
      deliveryS3KeyPrefix: map['deliveryS3KeyPrefix'] == null
          ? null
          : map['deliveryS3KeyPrefix'] as String,
      ...
      templateS3Uri: map['templateS3Uri'] == null
          ? null
          : map['templateS3Uri'] as String,
    );
  }
}
