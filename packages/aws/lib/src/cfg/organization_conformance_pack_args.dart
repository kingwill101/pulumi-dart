...
class OrganizationConformancePackArgs {
  ...
  OrganizationConformancePackArgs({
    ...
    String? templateS3Uri,
            ...
            pulumi.Input.asOptionalInput<String>(deliveryS3Bucket),
        deliveryS3KeyPrefix =
            pulumi.Input.asOptionalInput<String>(deliveryS3KeyPrefix),
        excludedAccounts =
  ...
  factory OrganizationConformancePackArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationConformancePackArgs(
      ...
      templateS3Uri:
          map['templateS3Uri'] == null ? null : map['templateS3Uri'] as String,
    );
  }
}
