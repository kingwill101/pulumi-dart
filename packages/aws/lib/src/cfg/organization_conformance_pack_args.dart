...
class OrganizationConformancePackArgs {
  ...
  OrganizationConformancePackArgs({
    ...
    List<OrganizationConformancePackInputParameter>? inputParameters,
    String? name,
    String? region,
    String? templateBody,
  ...
  factory OrganizationConformancePackArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationConformancePackArgs(
      deliveryS3Bucket: map['deliveryS3Bucket'] == null ? null : map['deliveryS3Bucket'] as String,
      deliveryS3KeyPrefix: map['deliveryS3KeyPrefix'] == null ? null : map['deliveryS3KeyPrefix'] as String,
      excludedAccounts: map['excludedAccounts'] == null ? null : (map['excludedAccounts'] as List).cast<String>(),
      inputParameters: map['inputParameters'] == null ? null : pulumi.Input.decodeList<OrganizationConformancePackInputParameter>(map['inputParameters'], (value) => OrganizationConformancePackInputParameter.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      templateBody: map['templateBody'] == null ? null : map['templateBody'] as String,
      templateS3Uri: map['templateS3Uri'] == null ? null : map['templateS3Uri'] as String,
    );
  }
}
