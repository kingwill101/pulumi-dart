...
class ConformancePackArgs {
  ...
  ConformancePackArgs({
    ...
    List<ConformancePackInputParameter>? inputParameters,
    String? name,
    String? region,
    String? templateBody,
  ...
  factory ConformancePackArgs.fromMap(Map<String, dynamic> map) {
    return ConformancePackArgs(
      ...
      inputParameters: map['inputParameters'] == null ? null : pulumi.Input.decodeList<ConformancePackInputParameter>(map['inputParameters'], (value) => ConformancePackInputParameter.fromMap((value as Map).cast<String, dynamic>())),
