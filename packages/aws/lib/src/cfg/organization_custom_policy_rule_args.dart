...
class OrganizationCustomPolicyRuleArgs {
  ...
  factory OrganizationCustomPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationCustomPolicyRuleArgs(
      debugLogDeliveryAccounts: map['debugLogDeliveryAccounts'] == null ? null : (map['debugLogDeliveryAccounts'] as List).cast<String>(),
      ...
      resourceIdScope: map['resourceIdScope'] == null ? null : map['resourceIdScope'] as String,
