...
class UserArgs {
  ...
  UserArgs({
    ...
    required UserAuthenticationMode authenticationMode,
    String? region,
    Map<String, String>? tags,
    required String userName,
  }) : accessString = pulumi.Input.asInput<String>(accessString),
       authenticationMode = pulumi.Input.asInput<UserAuthenticationMode>(
         authenticationMode,
       ),
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      ...
      authenticationMode: UserAuthenticationMode.fromMap(
