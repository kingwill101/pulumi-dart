...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      dataTiering: map['dataTiering'] == null ? null : map['dataTiering'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      engine: map['engine'] == null ? null : map['engine'] as String,
      engineVersion: map['engineVersion'] == null ? null : map['engineVersion'] as String,
      finalSnapshotName: map['finalSnapshotName'] == null ? null : map['finalSnapshotName'] as String,
      kmsKeyArn: map['kmsKeyArn'] == null ? null : map['kmsKeyArn'] as String,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : map['maintenanceWindow'] as String,
      multiRegionClusterName: map['multiRegionClusterName'] == null ? null : map['multiRegionClusterName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      nodeType: map['nodeType'] as String,
      numReplicasPerShard: map['numReplicasPerShard'] == null ? null : map['numReplicasPerShard'] as int,
