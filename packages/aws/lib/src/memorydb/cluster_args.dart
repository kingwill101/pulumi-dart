...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    bool? tlsEnabled,
       ...
       multiRegionClusterName = pulumi.Input.asOptionalInput<String>(
         multiRegionClusterName,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       namePrefix = pulumi.Input.asOptionalInput<String>(namePrefix),
       nodeType = pulumi.Input.asInput<String>(nodeType),
       numReplicasPerShard = pulumi.Input.asOptionalInput<int>(
         numReplicasPerShard,
       ),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      dataTiering: map['dataTiering'] == null
          ? null
          : map['dataTiering'] as bool,
