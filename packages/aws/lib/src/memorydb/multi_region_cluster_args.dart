...
class MultiRegionClusterArgs {
  ...
  factory MultiRegionClusterArgs.fromMap(Map<String, dynamic> map) {
    return MultiRegionClusterArgs(
      ...
      multiRegionClusterNameSuffix: map['multiRegionClusterNameSuffix'] as String,
      multiRegionParameterGroupName: map['multiRegionParameterGroupName'] == null ? null : map['multiRegionParameterGroupName'] as String,
      nodeType: map['nodeType'] as String,
      numShards: map['numShards'] == null ? null : map['numShards'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : MultiRegionClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
