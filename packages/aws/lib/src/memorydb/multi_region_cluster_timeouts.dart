...
class MultiRegionClusterTimeouts {
  ...
  /// Creates a new [MultiRegionClusterTimeouts].
  ...
  MultiRegionClusterTimeouts({this.create, this.delete, this.update});
  ...
  factory MultiRegionClusterTimeouts.fromMap(Map<String, dynamic> map) {
    return MultiRegionClusterTimeouts(
