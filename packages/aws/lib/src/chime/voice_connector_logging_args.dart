...
class VoiceConnectorLoggingArgs {
  ...
  factory VoiceConnectorLoggingArgs.fromMap(Map<String, dynamic> map) {
    return VoiceConnectorLoggingArgs(
      enableMediaMetricLogs: map['enableMediaMetricLogs'] == null ? null : map['enableMediaMetricLogs'] as bool,
      enableSipLogs: map['enableSipLogs'] == null ? null : map['enableSipLogs'] as bool,
