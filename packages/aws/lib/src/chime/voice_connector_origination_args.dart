...
class VoiceConnectorOriginationArgs {
  ...
  VoiceConnectorOriginationArgs({
    bool? disabled,
    String? region,
    required List<VoiceConnectorOriginationRoute> routes,
    required String voiceConnectorId,
  })  : disabled = pulumi.Input.asOptionalInput<bool>(disabled),
        region = pulumi.Input.asOptionalInput<String>(region),
        routes =
            pulumi.Input.asInput<List<VoiceConnectorOriginationRoute>>(routes),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['routes'] = pulumi.Input.mapInputValue<
            List<VoiceConnectorOriginationRoute>, List<Map<String, dynamic>>>(
        routes,
        (value) => pulumi.Input.encodeList<VoiceConnectorOriginationRoute,
  ...
  factory VoiceConnectorOriginationArgs.fromMap(Map<String, dynamic> map) {
    return VoiceConnectorOriginationArgs(
      ...
      routes: pulumi.Input.decodeList<VoiceConnectorOriginationRoute>(
          map['routes'],
