...
class StackSetArgs {
  ...
  factory StackSetArgs.fromMap(Map<String, dynamic> map) {
    return StackSetArgs(
      ...
      autoDeployment: map['autoDeployment'] == null ? null : StackSetAutoDeployment.fromMap((map['autoDeployment'] as Map).cast<String, dynamic>()),
      ...
      managedExecution: map['managedExecution'] == null ? null : StackSetManagedExecution.fromMap((map['managedExecution'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      operationPreferences: map['operationPreferences'] == null ? null : StackSetOperationPreferences.fromMap((map['operationPreferences'] as Map).cast<String, dynamic>()),
