...
class StackSetArgs {
  ...
  StackSetArgs({
    ...
    StackSetAutoDeployment? autoDeployment,
    String? callAs,
    List<String>? capabilities,
    String? description,
    String? executionRoleName,
    StackSetManagedExecution? managedExecution,
    String? name,
    ...
    String? templateBody,
    String? templateUrl,
  }) : administrationRoleArn = pulumi.Input.asOptionalInput<String>(
       ...
       executionRoleName = pulumi.Input.asOptionalInput<String>(
         executionRoleName,
       ),
       managedExecution = pulumi
           .Input.asOptionalInput<StackSetManagedExecution>(managedExecution),
  ...
  factory StackSetArgs.fromMap(Map<String, dynamic> map) {
    return StackSetArgs(
      administrationRoleArn: map['administrationRoleArn'] == null
          ? null
          : map['administrationRoleArn'] as String,
      autoDeployment: map['autoDeployment'] == null
          ? null
          : StackSetAutoDeployment.fromMap(
              (map['autoDeployment'] as Map).cast<String, dynamic>(),
            ),
      ...
      executionRoleName: map['executionRoleName'] == null
          ? null
          : map['executionRoleName'] as String,
      managedExecution: map['managedExecution'] == null
          ? null
          : StackSetManagedExecution.fromMap(
              (map['managedExecution'] as Map).cast<String, dynamic>(),
            ),
      name: map['name'] == null ? null : map['name'] as String,
      operationPreferences: map['operationPreferences'] == null
          ? null
          : StackSetOperationPreferences.fromMap(
              (map['operationPreferences'] as Map).cast<String, dynamic>(),
            ),
      parameters: map['parameters'] == null
          ? null
          : (map['parameters'] as Map).cast<String, String>(),
      permissionModel: map['permissionModel'] == null
          ? null
          : map['permissionModel'] as String,
