...
class StackSetArgs {
  ...
  StackSetArgs({
    ...
    String? templateUrl,
            ...
            pulumi.Input.asOptionalInput<String>(administrationRoleArn),
        ...
        executionRoleName =
            pulumi.Input.asOptionalInput<String>(executionRoleName),
        managedExecution =
            pulumi.Input.asOptionalInput<StackSetManagedExecution>(
                managedExecution),
