...
class StackSetInstanceArgs {
  ...
  factory StackSetInstanceArgs.fromMap(Map<String, dynamic> map) {
    return StackSetInstanceArgs(
      ...
      deploymentTargets: map['deploymentTargets'] == null ? null : StackSetInstanceDeploymentTargets.fromMap((map['deploymentTargets'] as Map).cast<String, dynamic>()),
      operationPreferences: map['operationPreferences'] == null ? null : StackSetInstanceOperationPreferences.fromMap((map['operationPreferences'] as Map).cast<String, dynamic>()),
      parameterOverrides: map['parameterOverrides'] == null ? null : (map['parameterOverrides'] as Map).cast<String, String>(),
      region: map['region'] == null ? null : map['region'] as String,
      retainStack: map['retainStack'] == null ? null : map['retainStack'] as bool,
      stackSetInstanceRegion: map['stackSetInstanceRegion'] == null ? null : map['stackSetInstanceRegion'] as String,
