...
class StackInstances extends pulumi.CustomResource {
  ...
  StackInstances(
    ...
    this.deploymentTargets = registerOutput<StackInstancesDeploymentTargets?>('deploymentTargets');
    this.operationPreferences = registerOutput<StackInstancesOperationPreferences?>('operationPreferences');
    ...
    this.stackInstanceSummaries = registerOutput<List<StackInstancesStackInstanceSummary>>('stackInstanceSummaries');
