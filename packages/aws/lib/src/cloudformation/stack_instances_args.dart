...
class StackInstancesArgs {
  ...
  factory StackInstancesArgs.fromMap(Map<String, dynamic> map) {
    return StackInstancesArgs(
      ...
      deploymentTargets: map['deploymentTargets'] == null ? null : StackInstancesDeploymentTargets.fromMap((map['deploymentTargets'] as Map).cast<String, dynamic>()),
      operationPreferences: map['operationPreferences'] == null ? null : StackInstancesOperationPreferences.fromMap((map['operationPreferences'] as Map).cast<String, dynamic>()),
