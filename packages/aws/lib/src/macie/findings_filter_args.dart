...
class FindingsFilterArgs {
  ...
  FindingsFilterArgs({
    ...
    String? description,
    required FindingsFilterFindingCriteria findingCriteria,
    String? name,
    String? namePrefix,
    int? position,
    String? region,
  ...
  factory FindingsFilterArgs.fromMap(Map<String, dynamic> map) {
    return FindingsFilterArgs(
      ...
      findingCriteria: FindingsFilterFindingCriteria.fromMap((map['findingCriteria'] as Map).cast<String, dynamic>()),
