...
class FindingsFilterArgs {
  ...
  FindingsFilterArgs({
    ...
    Map<String, String>? tags,
        ...
        findingCriteria = pulumi.Input.asInput<FindingsFilterFindingCriteria>(
            findingCriteria),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['findingCriteria'] = pulumi.Input.mapInputValue<
  ...
  factory FindingsFilterArgs.fromMap(Map<String, dynamic> map) {
    return FindingsFilterArgs(
      ...
      findingCriteria: FindingsFilterFindingCriteria.fromMap(
