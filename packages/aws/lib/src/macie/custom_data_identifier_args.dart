...
class CustomDataIdentifierArgs {
  ...
  factory CustomDataIdentifierArgs.fromMap(Map<String, dynamic> map) {
    return CustomDataIdentifierArgs(
      ...
      ignoreWords: map['ignoreWords'] == null ? null : (map['ignoreWords'] as List).cast<String>(),
      keywords: map['keywords'] == null ? null : (map['keywords'] as List).cast<String>(),
      maximumMatchDistance: map['maximumMatchDistance'] == null ? null : map['maximumMatchDistance'] as int,
