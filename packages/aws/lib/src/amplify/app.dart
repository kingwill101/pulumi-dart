...
class App extends pulumi.CustomResource {
  ...
  App(String name, {AppArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.autoBranchCreationConfig = registerOutput<AppAutoBranchCreationConfig>(
      'autoBranchCreationConfig',
    );
    this.autoBranchCreationPatterns = registerOutput<List<String>?>(
      'autoBranchCreationPatterns',
    );
    ...
    this.enableAutoBranchCreation = registerOutput<bool?>(
    ...
    this.enableBranchAutoDeletion = registerOutput<bool?>(
    ...
    this.productionBranches = registerOutput<List<AppProductionBranch>>(
      'productionBranches',
    );
