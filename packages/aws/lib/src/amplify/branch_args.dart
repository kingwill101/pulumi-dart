...
class BranchArgs {
  ...
  factory BranchArgs.fromMap(Map<String, dynamic> map) {
    return BranchArgs(
      ...
      backendEnvironmentArn: map['backendEnvironmentArn'] == null ? null : map['backendEnvironmentArn'] as String,
      ...
      enableNotification: map['enableNotification'] == null ? null : map['enableNotification'] as bool,
      ...
      enableSkewProtection: map['enableSkewProtection'] == null ? null : map['enableSkewProtection'] as bool,
