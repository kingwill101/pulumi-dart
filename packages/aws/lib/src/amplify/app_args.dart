...
class AppArgs {
  ...
  AppArgs({
    ...
    Map<String, String>? tags,
        ...
        customRules =
            pulumi.Input.asOptionalInput<List<AppCustomRule>>(customRules),
        description = pulumi.Input.asOptionalInput<String>(description),
        enableAutoBranchCreation =
            pulumi.Input.asOptionalInput<bool>(enableAutoBranchCreation),
        enableBasicAuth = pulumi.Input.asOptionalInput<bool>(enableBasicAuth),
        enableBranchAutoBuild =
            pulumi.Input.asOptionalInput<bool>(enableBranchAutoBuild),
        enableBranchAutoDeletion =
            pulumi.Input.asOptionalInput<bool>(enableBranchAutoDeletion),
        environmentVariables =
            pulumi.Input.asOptionalInput<Map<String, String>>(
                environmentVariables),
        iamServiceRoleArn =
            pulumi.Input.asOptionalInput<String>(iamServiceRoleArn),
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      autoBranchCreationConfig: map['autoBranchCreationConfig'] == null
          ? null
          : AppAutoBranchCreationConfig.fromMap(
              (map['autoBranchCreationConfig'] as Map).cast<String, dynamic>()),
      autoBranchCreationPatterns: map['autoBranchCreationPatterns'] == null
          ? null
          : (map['autoBranchCreationPatterns'] as List).cast<String>(),
      ...
      cacheConfig: map['cacheConfig'] == null
          ? null
          : AppCacheConfig.fromMap(
              (map['cacheConfig'] as Map).cast<String, dynamic>()),
      computeRoleArn: map['computeRoleArn'] == null
          ? null
          : map['computeRoleArn'] as String,
      customHeaders:
          map['customHeaders'] == null ? null : map['customHeaders'] as String,
      customRules: map['customRules'] == null
          ? null
          : pulumi.Input.decodeList<AppCustomRule>(
              map['customRules'],
              (value) => AppCustomRule.fromMap(
                  (value as Map).cast<String, dynamic>())),
      description:
          map['description'] == null ? null : map['description'] as String,
      enableAutoBranchCreation: map['enableAutoBranchCreation'] == null
          ? null
          : map['enableAutoBranchCreation'] as bool,
      enableBasicAuth: map['enableBasicAuth'] == null
          ? null
          : map['enableBasicAuth'] as bool,
      enableBranchAutoBuild: map['enableBranchAutoBuild'] == null
          ? null
          : map['enableBranchAutoBuild'] as bool,
      enableBranchAutoDeletion: map['enableBranchAutoDeletion'] == null
          ? null
          : map['enableBranchAutoDeletion'] as bool,
      environmentVariables: map['environmentVariables'] == null
          ? null
          : (map['environmentVariables'] as Map).cast<String, String>(),
      iamServiceRoleArn: map['iamServiceRoleArn'] == null
          ? null
          : map['iamServiceRoleArn'] as String,
      jobConfig: map['jobConfig'] == null
          ? null
          : AppJobConfig.fromMap(
              (map['jobConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      oauthToken:
          map['oauthToken'] == null ? null : map['oauthToken'] as String,
