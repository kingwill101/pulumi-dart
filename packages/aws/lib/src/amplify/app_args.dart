...
class AppArgs {
  ...
  AppArgs({
    ...
    Map<String, String>? tags,
       ...
       customRules = pulumi.Input.asOptionalInput<List<AppCustomRule>>(
         customRules,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       enableAutoBranchCreation = pulumi.Input.asOptionalInput<bool>(
         enableAutoBranchCreation,
       ),
       enableBasicAuth = pulumi.Input.asOptionalInput<bool>(enableBasicAuth),
       enableBranchAutoBuild = pulumi.Input.asOptionalInput<bool>(
         enableBranchAutoBuild,
       ),
       enableBranchAutoDeletion = pulumi.Input.asOptionalInput<bool>(
         enableBranchAutoDeletion,
       ),
       environmentVariables = pulumi.Input.asOptionalInput<Map<String, String>>(
         environmentVariables,
       ),
       iamServiceRoleArn = pulumi.Input.asOptionalInput<String>(
         iamServiceRoleArn,
       ),
