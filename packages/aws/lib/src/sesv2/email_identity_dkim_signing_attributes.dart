...
class EmailIdentityDkimSigningAttributes {
  ...
  Map<String, dynamic> toMap() {
    ...
    final currentSigningKeyLengthValue = currentSigningKeyLength;
    if (currentSigningKeyLengthValue != null) {
      map['currentSigningKeyLength'] = currentSigningKeyLengthValue;
    }
    final domainSigningPrivateKeyValue = domainSigningPrivateKey;
    if (domainSigningPrivateKeyValue != null) {
      map['domainSigningPrivateKey'] = domainSigningPrivateKeyValue;
    }
    final domainSigningSelectorValue = domainSigningSelector;
    if (domainSigningSelectorValue != null) {
      map['domainSigningSelector'] = domainSigningSelectorValue;
    }
    final lastKeyGenerationTimestampValue = lastKeyGenerationTimestamp;
    if (lastKeyGenerationTimestampValue != null) {
      map['lastKeyGenerationTimestamp'] = lastKeyGenerationTimestampValue;
    }
    final nextSigningKeyLengthValue = nextSigningKeyLength;
    if (nextSigningKeyLengthValue != null) {
      map['nextSigningKeyLength'] = nextSigningKeyLengthValue;
    }
    final signingAttributesOriginValue = signingAttributesOrigin;
    if (signingAttributesOriginValue != null) {
      map['signingAttributesOrigin'] = signingAttributesOriginValue;
    }
  ...
  factory EmailIdentityDkimSigningAttributes.fromMap(Map<String, dynamic> map) {
    return EmailIdentityDkimSigningAttributes(
      currentSigningKeyLength: map['currentSigningKeyLength'] == null
          ? null
          : map['currentSigningKeyLength'] as String,
      domainSigningPrivateKey: map['domainSigningPrivateKey'] == null
          ? null
          : map['domainSigningPrivateKey'] as String,
      domainSigningSelector: map['domainSigningSelector'] == null
          ? null
          : map['domainSigningSelector'] as String,
      lastKeyGenerationTimestamp: map['lastKeyGenerationTimestamp'] == null
          ? null
          : map['lastKeyGenerationTimestamp'] as String,
      nextSigningKeyLength: map['nextSigningKeyLength'] == null
          ? null
          : map['nextSigningKeyLength'] as String,
      signingAttributesOrigin: map['signingAttributesOrigin'] == null
          ? null
          : map['signingAttributesOrigin'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      tokens:
          map['tokens'] == null ? null : (map['tokens'] as List).cast<String>(),
    );
  }
}
