...
class ConfigurationSetArgs {
  ...
  factory ConfigurationSetArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationSetArgs(
      ...
      deliveryOptions: map['deliveryOptions'] == null ? null : ConfigurationSetDeliveryOptions.fromMap((map['deliveryOptions'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      reputationOptions: map['reputationOptions'] == null ? null : ConfigurationSetReputationOptions.fromMap((map['reputationOptions'] as Map).cast<String, dynamic>()),
      sendingOptions: map['sendingOptions'] == null ? null : ConfigurationSetSendingOptions.fromMap((map['sendingOptions'] as Map).cast<String, dynamic>()),
      suppressionOptions: map['suppressionOptions'] == null ? null : ConfigurationSetSuppressionOptions.fromMap((map['suppressionOptions'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      trackingOptions: map['trackingOptions'] == null ? null : ConfigurationSetTrackingOptions.fromMap((map['trackingOptions'] as Map).cast<String, dynamic>()),
      vdmOptions: map['vdmOptions'] == null ? null : ConfigurationSetVdmOptions.fromMap((map['vdmOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
