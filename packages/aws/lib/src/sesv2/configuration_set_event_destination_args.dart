...
class ConfigurationSetEventDestinationArgs {
  ...
  ConfigurationSetEventDestinationArgs({
    ...
    String? region,
        ...
        eventDestination = pulumi.Input.asInput<
            ConfigurationSetEventDestinationEventDestination>(eventDestination),
        eventDestinationName =
            pulumi.Input.asInput<String>(eventDestinationName),
        region = pulumi.Input.asOptionalInput<String>(region);

  Map<String, dynamic> toMap() {
    final map = <String, dynamic>{};
    map['configurationSetName'] = configurationSetName;
    map['eventDestination'] = pulumi.Input.mapInputValue<
