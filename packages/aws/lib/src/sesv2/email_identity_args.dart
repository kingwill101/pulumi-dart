...
class EmailIdentityArgs {
  ...
  EmailIdentityArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<String>(configurationSetName),
  ...
  factory EmailIdentityArgs.fromMap(Map<String, dynamic> map) {
    return EmailIdentityArgs(
      configurationSetName: map['configurationSetName'] == null
          ? null
          : map['configurationSetName'] as String,
      dkimSigningAttributes: map['dkimSigningAttributes'] == null
          ? null
          : EmailIdentityDkimSigningAttributes.fromMap(
              (map['dkimSigningAttributes'] as Map).cast<String, dynamic>()),
