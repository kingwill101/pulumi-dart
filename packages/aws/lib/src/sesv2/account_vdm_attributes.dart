...
class AccountVdmAttributes extends pulumi.CustomResource {
  ...
  AccountVdmAttributes(
    ...
    this.dashboardAttributes = registerOutput<AccountVdmAttributesDashboardAttributes>('dashboardAttributes');
    this.guardianAttributes = registerOutput<AccountVdmAttributesGuardianAttributes>('guardianAttributes');
