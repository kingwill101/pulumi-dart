...
class AddonArgs {
  ...
  AddonArgs({
    ...
    Map<String, String>? tags,
       ...
       configurationValues = pulumi.Input.asOptionalInput<String>(
         configurationValues,
       ),
       podIdentityAssociations =
       ...
       resolveConflictsOnCreate = pulumi.Input.asOptionalInput<String>(
         resolveConflictsOnCreate,
       ),
       resolveConflictsOnUpdate = pulumi.Input.asOptionalInput<String>(
         resolveConflictsOnUpdate,
       ),
       serviceAccountRoleArn = pulumi.Input.asOptionalInput<String>(
  ...
  factory AddonArgs.fromMap(Map<String, dynamic> map) {
    return AddonArgs(
      ...
      addonVersion: map['addonVersion'] == null
          ? null
          : map['addonVersion'] as String,
      clusterName: map['clusterName'] as String,
      configurationValues: map['configurationValues'] == null
          ? null
          : map['configurationValues'] as String,
      podIdentityAssociations: map['podIdentityAssociations'] == null
          ? null
      ...
      resolveConflictsOnCreate: map['resolveConflictsOnCreate'] == null
          ? null
          : map['resolveConflictsOnCreate'] as String,
      resolveConflictsOnUpdate: map['resolveConflictsOnUpdate'] == null
          ? null
          : map['resolveConflictsOnUpdate'] as String,
      serviceAccountRoleArn: map['serviceAccountRoleArn'] == null
          ? null
          : map['serviceAccountRoleArn'] as String,
      tags: map['tags'] == null
          ? null
