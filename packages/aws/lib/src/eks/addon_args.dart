...
class AddonArgs {
  ...
  AddonArgs({
    ...
    Map<String, String>? tags,
        ...
        configurationValues =
            pulumi.Input.asOptionalInput<String>(configurationValues),
        podIdentityAssociations =
        ...
        resolveConflictsOnCreate =
            pulumi.Input.asOptionalInput<String>(resolveConflictsOnCreate),
        resolveConflictsOnUpdate =
            pulumi.Input.asOptionalInput<String>(resolveConflictsOnUpdate),
        serviceAccountRoleArn =
            pulumi.Input.asOptionalInput<String>(serviceAccountRoleArn),
  ...
  factory AddonArgs.fromMap(Map<String, dynamic> map) {
    return AddonArgs(
      ...
      addonVersion:
          map['addonVersion'] == null ? null : map['addonVersion'] as String,
