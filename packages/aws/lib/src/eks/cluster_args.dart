...
class ClusterArgs {
  ...
  ClusterArgs({
    ClusterAccessConfig? accessConfig,
    bool? bootstrapSelfManagedAddons,
    ClusterComputeConfig? computeConfig,
    ClusterControlPlaneScalingConfig? controlPlaneScalingConfig,
    List<String>? defaultAddonsToRemoves,
    bool? deletionProtection,
    List<String>? enabledClusterLogTypes,
    ClusterEncryptionConfig? encryptionConfig,
    bool? forceUpdateVersion,
    ClusterKubernetesNetworkConfig? kubernetesNetworkConfig,
    String? name,
    ClusterOutpostConfig? outpostConfig,
    String? region,
    ClusterRemoteNetworkConfig? remoteNetworkConfig,
    required String roleArn,
    ClusterStorageConfig? storageConfig,
    Map<String, String>? tags,
    ClusterUpgradePolicy? upgradePolicy,
    String? version,
    required ClusterVpcConfig vpcConfig,
    ClusterZonalShiftConfig? zonalShiftConfig,
  })  : accessConfig =
            pulumi.Input.asOptionalInput<ClusterAccessConfig>(accessConfig),
        bootstrapSelfManagedAddons =
            pulumi.Input.asOptionalInput<bool>(bootstrapSelfManagedAddons),
        computeConfig =
            pulumi.Input.asOptionalInput<ClusterComputeConfig>(computeConfig),
        controlPlaneScalingConfig =
            pulumi.Input.asOptionalInput<ClusterControlPlaneScalingConfig>(
                controlPlaneScalingConfig),
        defaultAddonsToRemoves =
            pulumi.Input.asOptionalInput<List<String>>(defaultAddonsToRemoves),
        deletionProtection =
            pulumi.Input.asOptionalInput<bool>(deletionProtection),
        enabledClusterLogTypes =
            pulumi.Input.asOptionalInput<List<String>>(enabledClusterLogTypes),
        encryptionConfig =
        ...
        outpostConfig =
            pulumi.Input.asOptionalInput<ClusterOutpostConfig>(outpostConfig),
        ...
        storageConfig =
            pulumi.Input.asOptionalInput<ClusterStorageConfig>(storageConfig),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        upgradePolicy =
            pulumi.Input.asOptionalInput<ClusterUpgradePolicy>(upgradePolicy),
        version = pulumi.Input.asOptionalInput<String>(version),
        vpcConfig = pulumi.Input.asInput<ClusterVpcConfig>(vpcConfig),
        zonalShiftConfig =
            pulumi.Input.asOptionalInput<ClusterZonalShiftConfig>(
                zonalShiftConfig);
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      bootstrapSelfManagedAddons: map['bootstrapSelfManagedAddons'] == null
          ? null
          : map['bootstrapSelfManagedAddons'] as bool,
      computeConfig: map['computeConfig'] == null
          ? null
          : ClusterComputeConfig.fromMap(
              (map['computeConfig'] as Map).cast<String, dynamic>()),
      controlPlaneScalingConfig: map['controlPlaneScalingConfig'] == null
          ? null
          : ClusterControlPlaneScalingConfig.fromMap(
              (map['controlPlaneScalingConfig'] as Map)
                  .cast<String, dynamic>()),
      defaultAddonsToRemoves: map['defaultAddonsToRemoves'] == null
          ? null
          : (map['defaultAddonsToRemoves'] as List).cast<String>(),
      deletionProtection: map['deletionProtection'] == null
          ? null
          : map['deletionProtection'] as bool,
      enabledClusterLogTypes: map['enabledClusterLogTypes'] == null
          ? null
      ...
      kubernetesNetworkConfig: map['kubernetesNetworkConfig'] == null
          ? null
          : ClusterKubernetesNetworkConfig.fromMap(
              (map['kubernetesNetworkConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      outpostConfig: map['outpostConfig'] == null
          ? null
          : ClusterOutpostConfig.fromMap(
              (map['outpostConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      remoteNetworkConfig: map['remoteNetworkConfig'] == null
          ? null
          : ClusterRemoteNetworkConfig.fromMap(
              (map['remoteNetworkConfig'] as Map).cast<String, dynamic>()),
      ...
      vpcConfig: ClusterVpcConfig.fromMap(
          (map['vpcConfig'] as Map).cast<String, dynamic>()),
      zonalShiftConfig: map['zonalShiftConfig'] == null
          ? null
          : ClusterZonalShiftConfig.fromMap(
              (map['zonalShiftConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
