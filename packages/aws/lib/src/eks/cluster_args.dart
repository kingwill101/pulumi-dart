...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      accessConfig: map['accessConfig'] == null ? null : ClusterAccessConfig.fromMap((map['accessConfig'] as Map).cast<String, dynamic>()),
      ...
      controlPlaneScalingConfig: map['controlPlaneScalingConfig'] == null ? null : ClusterControlPlaneScalingConfig.fromMap((map['controlPlaneScalingConfig'] as Map).cast<String, dynamic>()),
      defaultAddonsToRemoves: map['defaultAddonsToRemoves'] == null ? null : (map['defaultAddonsToRemoves'] as List).cast<String>(),
      ...
      kubernetesNetworkConfig: map['kubernetesNetworkConfig'] == null ? null : ClusterKubernetesNetworkConfig.fromMap((map['kubernetesNetworkConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      outpostConfig: map['outpostConfig'] == null ? null : ClusterOutpostConfig.fromMap((map['outpostConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      remoteNetworkConfig: map['remoteNetworkConfig'] == null ? null : ClusterRemoteNetworkConfig.fromMap((map['remoteNetworkConfig'] as Map).cast<String, dynamic>()),
      roleArn: map['roleArn'] as String,
      storageConfig: map['storageConfig'] == null ? null : ClusterStorageConfig.fromMap((map['storageConfig'] as Map).cast<String, dynamic>()),
      ...
      vpcConfig: ClusterVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
      zonalShiftConfig: map['zonalShiftConfig'] == null ? null : ClusterZonalShiftConfig.fromMap((map['zonalShiftConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
