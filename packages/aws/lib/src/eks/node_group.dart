...
class NodeGroup extends pulumi.CustomResource {
  ...
  NodeGroup(
    ...
    this.launchTemplate = registerOutput<NodeGroupLaunchTemplate?>(
      'launchTemplate',
    );
    this.nodeGroupName = registerOutput<String>('nodeGroupName');
    this.nodeGroupNamePrefix = registerOutput<String>('nodeGroupNamePrefix');
    this.nodeRepairConfig = registerOutput<NodeGroupNodeRepairConfig>(
      'nodeRepairConfig',
    );
    ...
    this.scalingConfig = registerOutput<NodeGroupScalingConfig>(
      'scalingConfig',
    );
