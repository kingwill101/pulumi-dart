...
class NodeGroupArgs {
  ...
  NodeGroupArgs({
    ...
    String? version,
        ...
        forceUpdateVersion =
            pulumi.Input.asOptionalInput<bool>(forceUpdateVersion),
        instanceTypes =
        ...
        nodeGroupNamePrefix =
            pulumi.Input.asOptionalInput<String>(nodeGroupNamePrefix),
        nodeRepairConfig =
            pulumi.Input.asOptionalInput<NodeGroupNodeRepairConfig>(
                nodeRepairConfig),
        ...
        remoteAccess =
            pulumi.Input.asOptionalInput<NodeGroupRemoteAccess>(remoteAccess),
        scalingConfig =
            pulumi.Input.asInput<NodeGroupScalingConfig>(scalingConfig),
        ...
        updateConfig =
            pulumi.Input.asOptionalInput<NodeGroupUpdateConfig>(updateConfig),
  ...
  factory NodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs(
      ...
      capacityType:
          map['capacityType'] == null ? null : map['capacityType'] as String,
      clusterName: map['clusterName'] as String,
      diskSize: map['diskSize'] == null ? null : map['diskSize'] as int,
      forceUpdateVersion: map['forceUpdateVersion'] == null
          ? null
          : map['forceUpdateVersion'] as bool,
      ...
      nodeGroupName:
          map['nodeGroupName'] == null ? null : map['nodeGroupName'] as String,
      nodeGroupNamePrefix: map['nodeGroupNamePrefix'] == null
          ? null
          : map['nodeGroupNamePrefix'] as String,
      nodeRepairConfig: map['nodeRepairConfig'] == null
          ? null
          : NodeGroupNodeRepairConfig.fromMap(
              (map['nodeRepairConfig'] as Map).cast<String, dynamic>()),
      nodeRoleArn: map['nodeRoleArn'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      releaseVersion: map['releaseVersion'] == null
          ? null
          : map['releaseVersion'] as String,
      remoteAccess: map['remoteAccess'] == null
          ? null
          : NodeGroupRemoteAccess.fromMap(
              (map['remoteAccess'] as Map).cast<String, dynamic>()),
      scalingConfig: NodeGroupScalingConfig.fromMap(
      ...
      taints: map['taints'] == null
          ...
          : pulumi.Input.decodeList<NodeGroupTaint>(
              map['taints'],
              (value) => NodeGroupTaint.fromMap(
                  (value as Map).cast<String, dynamic>())),
      updateConfig: map['updateConfig'] == null
          ? null
          : NodeGroupUpdateConfig.fromMap(
              (map['updateConfig'] as Map).cast<String, dynamic>()),
