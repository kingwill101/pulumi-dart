...
class NodeGroupArgs {
  ...
  NodeGroupArgs({
    ...
    String? version,
       ...
       forceUpdateVersion = pulumi.Input.asOptionalInput<bool>(
         forceUpdateVersion,
       ),
       instanceTypes = pulumi.Input.asOptionalInput<List<String>>(
         instanceTypes,
       ),
       ...
       nodeGroupNamePrefix = pulumi.Input.asOptionalInput<String>(
         nodeGroupNamePrefix,
       ),
       nodeRepairConfig = pulumi
           .Input.asOptionalInput<NodeGroupNodeRepairConfig>(nodeRepairConfig),
       ...
       scalingConfig = pulumi.Input.asInput<NodeGroupScalingConfig>(
         scalingConfig,
       ),
  ...
  factory NodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupArgs(
      ...
      capacityType: map['capacityType'] == null
          ? null
          : map['capacityType'] as String,
      ...
      nodeGroupName: map['nodeGroupName'] == null
          ? null
          : map['nodeGroupName'] as String,
