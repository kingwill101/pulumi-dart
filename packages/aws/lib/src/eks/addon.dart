...
class Addon extends pulumi.CustomResource {
  ...
  Addon(String name, {AddonArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.resolveConflictsOnCreate = registerOutput<String?>(
      'resolveConflictsOnCreate',
    );
    this.resolveConflictsOnUpdate = registerOutput<String?>(
      'resolveConflictsOnUpdate',
    );
    this.serviceAccountRoleArn = registerOutput<String?>(
