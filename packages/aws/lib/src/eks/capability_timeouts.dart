...
class CapabilityTimeouts {
  ...
  /// Creates a new [CapabilityTimeouts].
  ...
  CapabilityTimeouts({this.create, this.delete, this.update});
  ...
  factory CapabilityTimeouts.fromMap(Map<String, dynamic> map) {
