...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.bootstrapSelfManagedAddons = registerOutput<bool?>(
      'bootstrapSelfManagedAddons',
    );
    this.certificateAuthority = registerOutput<ClusterCertificateAuthority>(
    ...
    this.defaultAddonsToRemoves = registerOutput<List<String>?>(
      'defaultAddonsToRemoves',
    );
    this.deletionProtection = registerOutput<bool>('deletionProtection');
    this.enabledClusterLogTypes = registerOutput<List<String>?>(
    ...
    this.remoteNetworkConfig = registerOutput<ClusterRemoteNetworkConfig?>(
      'remoteNetworkConfig',
    );
    ...
    this.zonalShiftConfig = registerOutput<ClusterZonalShiftConfig?>(
      'zonalShiftConfig',
    );
  }
}
