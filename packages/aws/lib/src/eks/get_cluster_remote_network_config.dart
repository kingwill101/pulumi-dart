...
class GetClusterRemoteNetworkConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'remoteNodeNetworks': pulumi.Input.encodeList<GetClusterRemoteNetworkConfigRemoteNodeNetwork, Map<String, dynamic>>(remoteNodeNetworks, (value) => value.toMap()),
      'remotePodNetworks': pulumi.Input.encodeList<GetClusterRemoteNetworkConfigRemotePodNetwork, Map<String, dynamic>>(remotePodNetworks, (value) => value.toMap()),
    };
  }

  factory GetClusterRemoteNetworkConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterRemoteNetworkConfig(
      remoteNodeNetworks: pulumi.Input.decodeList<GetClusterRemoteNetworkConfigRemoteNodeNetwork>(map['remoteNodeNetworks'], (value) => GetClusterRemoteNetworkConfigRemoteNodeNetwork.fromMap((value as Map).cast<String, dynamic>())),
      remotePodNetworks: pulumi.Input.decodeList<GetClusterRemoteNetworkConfigRemotePodNetwork>(map['remotePodNetworks'], (value) => GetClusterRemoteNetworkConfigRemotePodNetwork.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
