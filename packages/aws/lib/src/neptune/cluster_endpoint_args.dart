...
class ClusterEndpointArgs {
  ...
  ClusterEndpointArgs({
    required String clusterEndpointIdentifier,
    ...
    Map<String, String>? tags,
  }) : clusterEndpointIdentifier = pulumi.Input.asInput<String>(
       ...
       excludedMembers = pulumi.Input.asOptionalInput<List<String>>(
         excludedMembers,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       staticMembers = pulumi.Input.asOptionalInput<List<String>>(
         staticMembers,
       ),
