...
class ClusterParameterGroupArgs {
  ...
  factory ClusterParameterGroupArgs.fromMap(Map<String, dynamic> map) {
    return ClusterParameterGroupArgs(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<ClusterParameterGroupParameter>(map['parameters'], (value) => ClusterParameterGroupParameter.fromMap((value as Map).cast<String, dynamic>())),
