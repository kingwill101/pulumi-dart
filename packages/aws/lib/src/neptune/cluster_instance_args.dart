...
class ClusterInstanceArgs {
  ...
  ClusterInstanceArgs({
    ...
    Map<String, String>? tags,
        ...
        neptuneParameterGroupName =
            pulumi.Input.asOptionalInput<String>(neptuneParameterGroupName),
  ...
  factory ClusterInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ClusterInstanceArgs(
      ...
      neptuneParameterGroupName: map['neptuneParameterGroupName'] == null
          ? null
          : map['neptuneParameterGroupName'] as String,
