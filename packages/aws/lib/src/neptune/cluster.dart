...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.enableCloudwatchLogsExports = registerOutput<List<String>?>(
    ...
    this.neptuneClusterParameterGroupName = registerOutput<String>(
      'neptuneClusterParameterGroupName',
    );
    this.neptuneInstanceParameterGroupName = registerOutput<String?>(
