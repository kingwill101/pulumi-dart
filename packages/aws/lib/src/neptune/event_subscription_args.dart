...
class EventSubscriptionArgs {
  ...
  EventSubscriptionArgs({
    ...
    Map<String, String>? tags,
       ...
       eventCategories = pulumi.Input.asOptionalInput<List<String>>(
         eventCategories,
       ),
  ...
  factory EventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionArgs(
      ...
      eventCategories: map['eventCategories'] == null
          ? null
      ...
      sourceIds: map['sourceIds'] == null
          ? null
          : (map['sourceIds'] as List).cast<String>(),
