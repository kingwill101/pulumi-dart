...
class VpcIpamResourceDiscoveryArgs {
  ...
  VpcIpamResourceDiscoveryArgs({
    ...
    List<VpcIpamResourceDiscoveryOrganizationalUnitExclusion>? organizationalUnitExclusions,
    String? region,
  ...
  factory VpcIpamResourceDiscoveryArgs.fromMap(Map<String, dynamic> map) {
    return VpcIpamResourceDiscoveryArgs(
      ...
      operatingRegions: pulumi.Input.decodeList<VpcIpamResourceDiscoveryOperatingRegion>(map['operatingRegions'], (value) => VpcIpamResourceDiscoveryOperatingRegion.fromMap((value as Map).cast<String, dynamic>())),
      organizationalUnitExclusions: map['organizationalUnitExclusions'] == null ? null : pulumi.Input.decodeList<VpcIpamResourceDiscoveryOrganizationalUnitExclusion>(map['organizationalUnitExclusions'], (value) => VpcIpamResourceDiscoveryOrganizationalUnitExclusion.fromMap((value as Map).cast<String, dynamic>())),
