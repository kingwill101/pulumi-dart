...
class GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponent {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponent].
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponent.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponent(
