...
class LaunchTemplate extends pulumi.CustomResource {
  ...
  LaunchTemplate(
    ...
    this.enclaveOptions = registerOutput<LaunchTemplateEnclaveOptions?>(
      'enclaveOptions',
    );
    this.hibernationOptions = registerOutput<LaunchTemplateHibernationOptions?>(
      'hibernationOptions',
    );
    this.iamInstanceProfile = registerOutput<LaunchTemplateIamInstanceProfile?>(
      'iamInstanceProfile',
    );
    ...
    this.maintenanceOptions = registerOutput<LaunchTemplateMaintenanceOptions?>(
      'maintenanceOptions',
    );
    this.metadataOptions = registerOutput<LaunchTemplateMetadataOptions>(
      'metadataOptions',
    );
