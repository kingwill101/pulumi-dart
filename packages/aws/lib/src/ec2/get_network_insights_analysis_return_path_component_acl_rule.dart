...
class GetNetworkInsightsAnalysisReturnPathComponentAclRule {
  final String cidr;
  final bool egress;
  final List<GetNetworkInsightsAnalysisReturnPathComponentAclRulePortRange> portRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cidr': cidr,
      'egress': egress,
      'portRanges': pulumi.Input.encodeList<GetNetworkInsightsAnalysisReturnPathComponentAclRulePortRange, Map<String, dynamic>>(portRanges, (value) => value.toMap()),
      'protocol': protocol,
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponentAclRule.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisReturnPathComponentAclRule(
      ...
      portRanges: pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentAclRulePortRange>(map['portRanges'], (value) => GetNetworkInsightsAnalysisReturnPathComponentAclRulePortRange.fromMap((value as Map).cast<String, dynamic>())),
