...
class FlowLog extends pulumi.CustomResource {
  ...
  FlowLog(
    ...
    this.deliverCrossAccountRole = registerOutput<String?>(
      'deliverCrossAccountRole',
    );
    this.destinationOptions = registerOutput<FlowLogDestinationOptions?>(
      'destinationOptions',
    );
    ...
    this.maxAggregationInterval = registerOutput<int?>(
