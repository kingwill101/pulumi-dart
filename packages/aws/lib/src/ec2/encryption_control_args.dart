...
class EncryptionControlArgs {
  ...
  EncryptionControlArgs({
    ...
    String? vpcPeeringExclusion,
  }) : egressOnlyInternetGatewayExclusion = pulumi
           .Input.asOptionalInput<String>(egressOnlyInternetGatewayExclusion),
       elasticFileSystemExclusion = pulumi.Input.asOptionalInput<String>(
         elasticFileSystemExclusion,
       ),
       internetGatewayExclusion = pulumi.Input.asOptionalInput<String>(
       ...
       natGatewayExclusion = pulumi.Input.asOptionalInput<String>(
         natGatewayExclusion,
       ),
       ...
       vpcLatticeExclusion = pulumi.Input.asOptionalInput<String>(
         vpcLatticeExclusion,
       ),
       vpcPeeringExclusion = pulumi.Input.asOptionalInput<String>(
         vpcPeeringExclusion,
       );
