...
class EncryptionControlArgs {
  ...
  EncryptionControlArgs({
    ...
    EncryptionControlTimeouts? timeouts,
    ...
    String? vpcPeeringExclusion,
        ...
        elasticFileSystemExclusion =
            pulumi.Input.asOptionalInput<String>(elasticFileSystemExclusion),
        internetGatewayExclusion =
            pulumi.Input.asOptionalInput<String>(internetGatewayExclusion),
        lambdaExclusion = pulumi.Input.asOptionalInput<String>(lambdaExclusion),
        mode = pulumi.Input.asInput<String>(mode),
        natGatewayExclusion =
            pulumi.Input.asOptionalInput<String>(natGatewayExclusion),
        region = pulumi.Input.asOptionalInput<String>(region),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        timeouts =
            pulumi.Input.asOptionalInput<EncryptionControlTimeouts>(timeouts),
        virtualPrivateGatewayExclusion = pulumi.Input.asOptionalInput<String>(
            virtualPrivateGatewayExclusion),
        vpcId = pulumi.Input.asInput<String>(vpcId),
        vpcLatticeExclusion =
            pulumi.Input.asOptionalInput<String>(vpcLatticeExclusion),
        vpcPeeringExclusion =
            pulumi.Input.asOptionalInput<String>(vpcPeeringExclusion);
  ...
  factory EncryptionControlArgs.fromMap(Map<String, dynamic> map) {
    return EncryptionControlArgs(
      egressOnlyInternetGatewayExclusion:
          map['egressOnlyInternetGatewayExclusion'] == null
              ? null
              : map['egressOnlyInternetGatewayExclusion'] as String,
      elasticFileSystemExclusion: map['elasticFileSystemExclusion'] == null
          ? null
          : map['elasticFileSystemExclusion'] as String,
      internetGatewayExclusion: map['internetGatewayExclusion'] == null
          ? null
          : map['internetGatewayExclusion'] as String,
      lambdaExclusion: map['lambdaExclusion'] == null
          ? null
          : map['lambdaExclusion'] as String,
      mode: map['mode'] as String,
      natGatewayExclusion: map['natGatewayExclusion'] == null
          ? null
          : map['natGatewayExclusion'] as String,
      ...
      timeouts: map['timeouts'] == null
          ? null
          : EncryptionControlTimeouts.fromMap(
              (map['timeouts'] as Map).cast<String, dynamic>()),
      virtualPrivateGatewayExclusion:
          map['virtualPrivateGatewayExclusion'] == null
              ? null
              : map['virtualPrivateGatewayExclusion'] as String,
      vpcId: map['vpcId'] as String,
      vpcLatticeExclusion: map['vpcLatticeExclusion'] == null
          ? null
          : map['vpcLatticeExclusion'] as String,
      vpcPeeringExclusion: map['vpcPeeringExclusion'] == null
          ? null
          : map['vpcPeeringExclusion'] as String,
    );
  }
}
