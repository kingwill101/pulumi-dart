...
class GetNetworkInsightsAnalysisForwardPathComponentVpc {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisForwardPathComponentVpc].
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentVpc.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisForwardPathComponentVpc(
