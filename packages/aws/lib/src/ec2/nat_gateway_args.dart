...
class NatGatewayArgs {
  ...
  NatGatewayArgs({
    ...
    String? vpcId,
        ...
        availabilityMode =
            pulumi.Input.asOptionalInput<String>(availabilityMode),
        availabilityZoneAddresses = pulumi.Input.asOptionalInput<
            List<NatGatewayAvailabilityZoneAddress>>(availabilityZoneAddresses),
        connectivityType =
            pulumi.Input.asOptionalInput<String>(connectivityType),
        privateIp = pulumi.Input.asOptionalInput<String>(privateIp),
        region = pulumi.Input.asOptionalInput<String>(region),
        secondaryAllocationIds =
            pulumi.Input.asOptionalInput<List<String>>(secondaryAllocationIds),
        secondaryPrivateIpAddressCount =
            pulumi.Input.asOptionalInput<int>(secondaryPrivateIpAddressCount),
