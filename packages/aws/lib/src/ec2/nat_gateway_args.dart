...
class NatGatewayArgs {
  ...
  factory NatGatewayArgs.fromMap(Map<String, dynamic> map) {
    return NatGatewayArgs(
      ...
      availabilityZoneAddresses: map['availabilityZoneAddresses'] == null ? null : pulumi.Input.decodeList<NatGatewayAvailabilityZoneAddress>(map['availabilityZoneAddresses'], (value) => NatGatewayAvailabilityZoneAddress.fromMap((value as Map).cast<String, dynamic>())),
      ...
      secondaryAllocationIds: map['secondaryAllocationIds'] == null ? null : (map['secondaryAllocationIds'] as List).cast<String>(),
