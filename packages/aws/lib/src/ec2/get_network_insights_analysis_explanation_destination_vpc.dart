...
class GetNetworkInsightsAnalysisExplanationDestinationVpc {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationDestinationVpc].
  ...
  factory GetNetworkInsightsAnalysisExplanationDestinationVpc.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationDestinationVpc(
