...
class FleetArgs {
  ...
  FleetArgs({
    ...
    String? validUntil,
        ...
        fulfilledCapacity =
            pulumi.Input.asOptionalInput<double>(fulfilledCapacity),
        fulfilledOnDemandCapacity =
            pulumi.Input.asOptionalInput<double>(fulfilledOnDemandCapacity),
        launchTemplateConfigs =
            pulumi.Input.asInput<List<FleetLaunchTemplateConfig>>(
                launchTemplateConfigs),
        onDemandOptions =
            pulumi.Input.asOptionalInput<FleetOnDemandOptions>(onDemandOptions),
        region = pulumi.Input.asOptionalInput<String>(region),
        replaceUnhealthyInstances =
            pulumi.Input.asOptionalInput<bool>(replaceUnhealthyInstances),
        spotOptions =
            pulumi.Input.asOptionalInput<FleetSpotOptions>(spotOptions),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        targetCapacitySpecification =
            pulumi.Input.asInput<FleetTargetCapacitySpecification>(
                targetCapacitySpecification),
        terminateInstances =
            pulumi.Input.asOptionalInput<bool>(terminateInstances),
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      fleetInstanceSets: map['fleetInstanceSets'] == null
          ? null
          : pulumi.Input.decodeList<FleetFleetInstanceSet>(
              map['fleetInstanceSets'],
              (value) => FleetFleetInstanceSet.fromMap(
                  (value as Map).cast<String, dynamic>())),
      fleetState:
          map['fleetState'] == null ? null : map['fleetState'] as String,
      fulfilledCapacity: map['fulfilledCapacity'] == null
          ? null
          : map['fulfilledCapacity'] as double,
      fulfilledOnDemandCapacity: map['fulfilledOnDemandCapacity'] == null
          ? null
          : map['fulfilledOnDemandCapacity'] as double,
      launchTemplateConfigs: pulumi.Input.decodeList<FleetLaunchTemplateConfig>(
          map['launchTemplateConfigs'],
          (value) => FleetLaunchTemplateConfig.fromMap(
              (value as Map).cast<String, dynamic>())),
      onDemandOptions: map['onDemandOptions'] == null
          ? null
          : FleetOnDemandOptions.fromMap(
              (map['onDemandOptions'] as Map).cast<String, dynamic>()),
      ...
      spotOptions: map['spotOptions'] == null
          ? null
          : FleetSpotOptions.fromMap(
              (map['spotOptions'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      targetCapacitySpecification: FleetTargetCapacitySpecification.fromMap(
          (map['targetCapacitySpecification'] as Map).cast<String, dynamic>()),
      terminateInstances: map['terminateInstances'] == null
          ? null
          : map['terminateInstances'] as bool,
      terminateInstancesWithExpiration:
