...
class FleetArgs {
  ...
  FleetArgs({
    ...
    List<FleetFleetInstanceSet>? fleetInstanceSets,
    String? fleetState,
    double? fulfilledCapacity,
    double? fulfilledOnDemandCapacity,
    required List<FleetLaunchTemplateConfig> launchTemplateConfigs,
    FleetOnDemandOptions? onDemandOptions,
    String? region,
    bool? replaceUnhealthyInstances,
    FleetSpotOptions? spotOptions,
    Map<String, String>? tags,
    required FleetTargetCapacitySpecification targetCapacitySpecification,
    ...
    String? validUntil,
      ...
      launchTemplateConfigs = pulumi.Input.asInput<List<FleetLaunchTemplateConfig>>(launchTemplateConfigs),
      ...
      targetCapacitySpecification = pulumi.Input.asInput<FleetTargetCapacitySpecification>(targetCapacitySpecification),
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      fleetInstanceSets: map['fleetInstanceSets'] == null ? null : pulumi.Input.decodeList<FleetFleetInstanceSet>(map['fleetInstanceSets'], (value) => FleetFleetInstanceSet.fromMap((value as Map).cast<String, dynamic>())),
      fleetState: map['fleetState'] == null ? null : map['fleetState'] as String,
      fulfilledCapacity: map['fulfilledCapacity'] == null ? null : map['fulfilledCapacity'] as double,
      fulfilledOnDemandCapacity: map['fulfilledOnDemandCapacity'] == null ? null : map['fulfilledOnDemandCapacity'] as double,
      launchTemplateConfigs: pulumi.Input.decodeList<FleetLaunchTemplateConfig>(map['launchTemplateConfigs'], (value) => FleetLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>())),
      onDemandOptions: map['onDemandOptions'] == null ? null : FleetOnDemandOptions.fromMap((map['onDemandOptions'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      replaceUnhealthyInstances: map['replaceUnhealthyInstances'] == null ? null : map['replaceUnhealthyInstances'] as bool,
      spotOptions: map['spotOptions'] == null ? null : FleetSpotOptions.fromMap((map['spotOptions'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetCapacitySpecification: FleetTargetCapacitySpecification.fromMap((map['targetCapacitySpecification'] as Map).cast<String, dynamic>()),
