...
class FleetArgs {
  ...
  FleetArgs({
    ...
    String? validUntil,
       ...
       fulfilledCapacity = pulumi.Input.asOptionalInput<double>(
         fulfilledCapacity,
       ),
       ...
       replaceUnhealthyInstances = pulumi.Input.asOptionalInput<bool>(
         replaceUnhealthyInstances,
       ),
       spotOptions = pulumi.Input.asOptionalInput<FleetSpotOptions>(
         spotOptions,
       ),
       ...
       terminateInstances = pulumi.Input.asOptionalInput<bool>(
         terminateInstances,
       ),
    ...
    return <String, dynamic>{
      ...
      'onDemandOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(onDemandOptions, (value) => value.toMap()),
      'region': ?region,
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      fleetState: map['fleetState'] == null
          ? null
          : map['fleetState'] as String,
