...
class FleetOnDemandOptions {
  ...
  final FleetOnDemandOptionsCapacityReservationOptions? capacityReservationOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'capacityReservationOptions': ?capacityReservationOptions == null ? null : capacityReservationOptions!.toMap(),
  ...
  factory FleetOnDemandOptions.fromMap(Map<String, dynamic> map) {
    return FleetOnDemandOptions(
      ...
      capacityReservationOptions: map['capacityReservationOptions'] == null ? null : FleetOnDemandOptionsCapacityReservationOptions.fromMap((map['capacityReservationOptions'] as Map).cast<String, dynamic>()),
