...
class VpcIpamArgs {
  ...
  VpcIpamArgs({
    ...
    required List<VpcIpamOperatingRegion> operatingRegions,
    String? region,
  ...
  factory VpcIpamArgs.fromMap(Map<String, dynamic> map) {
    return VpcIpamArgs(
      ...
      enablePrivateGua: map['enablePrivateGua'] == null ? null : map['enablePrivateGua'] as bool,
      meteredAccount: map['meteredAccount'] == null ? null : map['meteredAccount'] as String,
      operatingRegions: pulumi.Input.decodeList<VpcIpamOperatingRegion>(map['operatingRegions'], (value) => VpcIpamOperatingRegion.fromMap((value as Map).cast<String, dynamic>())),
