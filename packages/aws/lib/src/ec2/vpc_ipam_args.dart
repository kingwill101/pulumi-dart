...
class VpcIpamArgs {
  ...
  factory VpcIpamArgs.fromMap(Map<String, dynamic> map) {
    return VpcIpamArgs(
      ...
      enablePrivateGua: map['enablePrivateGua'] == null
          ? null
          : map['enablePrivateGua'] as bool,
      meteredAccount: map['meteredAccount'] == null
          ? null
          : map['meteredAccount'] as String,
      operatingRegions: pulumi.Input.decodeList<VpcIpamOperatingRegion>(
        map['operatingRegions'],
        (value) => VpcIpamOperatingRegion.fromMap(
