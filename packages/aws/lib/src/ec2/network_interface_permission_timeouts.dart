...
class NetworkInterfacePermissionTimeouts {
  ...
  /// Creates a new [NetworkInterfacePermissionTimeouts].
  ...
  NetworkInterfacePermissionTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory NetworkInterfacePermissionTimeouts.fromMap(Map<String, dynamic> map) {
    return NetworkInterfacePermissionTimeouts(
