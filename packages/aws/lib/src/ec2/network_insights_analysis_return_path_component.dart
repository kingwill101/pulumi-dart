      ...
      additionalDetails: map['additionalDetails'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentAdditionalDetail.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      ...
      destinationVpcs: map['destinationVpcs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['destinationVpcs'],
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentDestinationVpc.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      inboundHeaders: map['inboundHeaders'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['inboundHeaders'],
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentInboundHeader.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      outboundHeaders: map['outboundHeaders'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['outboundHeaders'],
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentOutboundHeader.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      routeTableRoutes: map['routeTableRoutes'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      securityGroupRules: map['securityGroupRules'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentSecurityGroupRule.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      ...
      transitGatewayRouteTableRoutes:
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentTransitGatewayRouteTableRoute.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      transitGateways: map['transitGateways'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['transitGateways'],
              (value) =>
                  NetworkInsightsAnalysisReturnPathComponentTransitGateway.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
      vpcs: map['vpcs'] == null
