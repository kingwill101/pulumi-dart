...
class EncryptionControlTimeouts {
  ...
  /// Creates a new [EncryptionControlTimeouts].
  ...
  EncryptionControlTimeouts({this.create, this.delete, this.update});
  ...
  factory EncryptionControlTimeouts.fromMap(Map<String, dynamic> map) {
    return EncryptionControlTimeouts(
