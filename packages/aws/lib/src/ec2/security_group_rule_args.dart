...
class SecurityGroupRuleArgs {
  ...
  SecurityGroupRuleArgs({
    ...
    required String type,
       ...
       ipv6CidrBlocks = pulumi.Input.asOptionalInput<List<String>>(
         ipv6CidrBlocks,
       ),
       prefixListIds = pulumi.Input.asOptionalInput<List<String>>(
         prefixListIds,
       ),
       ...
       sourceSecurityGroupId = pulumi.Input.asOptionalInput<String>(
