...
class SecondarySubnetArgs {
  ...
  SecondarySubnetArgs({
    ...
    String? region,
    required String secondaryNetworkId,
    Map<String, String>? tags,
    SecondarySubnetTimeouts? timeouts,
  }) :
  ...
  factory SecondarySubnetArgs.fromMap(Map<String, dynamic> map) {
    return SecondarySubnetArgs(
      ...
      secondaryNetworkId: map['secondaryNetworkId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : SecondarySubnetTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
