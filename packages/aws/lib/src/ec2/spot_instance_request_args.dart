...
class SpotInstanceRequestArgs {
  ...
  SpotInstanceRequestArgs({
    ...
    SpotInstanceRequestCapacityReservationSpecification? capacityReservationSpecification,
    ...
    List<SpotInstanceRequestSecondaryNetworkInterface>? secondaryNetworkInterfaces,
  ...
  factory SpotInstanceRequestArgs.fromMap(Map<String, dynamic> map) {
    return SpotInstanceRequestArgs(
      ...
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : SpotInstanceRequestCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>()),
      cpuOptions: map['cpuOptions'] == null ? null : SpotInstanceRequestCpuOptions.fromMap((map['cpuOptions'] as Map).cast<String, dynamic>()),
      creditSpecification: map['creditSpecification'] == null ? null : SpotInstanceRequestCreditSpecification.fromMap((map['creditSpecification'] as Map).cast<String, dynamic>()),
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : pulumi.Input.decodeList<SpotInstanceRequestEbsBlockDevice>(map['ebsBlockDevices'], (value) => SpotInstanceRequestEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      ...
      enclaveOptions: map['enclaveOptions'] == null ? null : SpotInstanceRequestEnclaveOptions.fromMap((map['enclaveOptions'] as Map).cast<String, dynamic>()),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : pulumi.Input.decodeList<SpotInstanceRequestEphemeralBlockDevice>(map['ephemeralBlockDevices'], (value) => SpotInstanceRequestEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      ...
      launchGroup: map['launchGroup'] == null ? null : map['launchGroup'] as String,
      launchTemplate: map['launchTemplate'] == null ? null : SpotInstanceRequestLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>()),
      maintenanceOptions: map['maintenanceOptions'] == null ? null : SpotInstanceRequestMaintenanceOptions.fromMap((map['maintenanceOptions'] as Map).cast<String, dynamic>()),
      metadataOptions: map['metadataOptions'] == null ? null : SpotInstanceRequestMetadataOptions.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>()),
      monitoring: map['monitoring'] == null ? null : map['monitoring'] as bool,
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<SpotInstanceRequestNetworkInterface>(map['networkInterfaces'], (value) => SpotInstanceRequestNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      ...
      privateDnsNameOptions: map['privateDnsNameOptions'] == null ? null : SpotInstanceRequestPrivateDnsNameOptions.fromMap((map['privateDnsNameOptions'] as Map).cast<String, dynamic>()),
      privateIp: map['privateIp'] == null ? null : map['privateIp'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      rootBlockDevice: map['rootBlockDevice'] == null ? null : SpotInstanceRequestRootBlockDevice.fromMap((map['rootBlockDevice'] as Map).cast<String, dynamic>()),
      secondaryNetworkInterfaces: map['secondaryNetworkInterfaces'] == null ? null : pulumi.Input.decodeList<SpotInstanceRequestSecondaryNetworkInterface>(map['secondaryNetworkInterfaces'], (value) => SpotInstanceRequestSecondaryNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
