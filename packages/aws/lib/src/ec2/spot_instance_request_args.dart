...
class SpotInstanceRequestArgs {
  ...
  SpotInstanceRequestArgs({
    ...
    bool? waitForFulfillment,
        ...
        capacityReservationSpecification = pulumi.Input.asOptionalInput<
            ...
            capacityReservationSpecification),
        cpuOptions =
            pulumi.Input.asOptionalInput<SpotInstanceRequestCpuOptions>(
                cpuOptions),
        creditSpecification = pulumi.Input.asOptionalInput<
            SpotInstanceRequestCreditSpecification>(creditSpecification),
        ...
        enablePrimaryIpv6 =
            pulumi.Input.asOptionalInput<bool>(enablePrimaryIpv6),
        enclaveOptions =
        ...
        hostResourceGroupArn =
            pulumi.Input.asOptionalInput<String>(hostResourceGroupArn),
        iamInstanceProfile =
        ...
        instanceInterruptionBehavior =
            pulumi.Input.asOptionalInput<String>(instanceInterruptionBehavior),
        instanceType = pulumi.Input.asOptionalInput<String>(instanceType),
        ipv6AddressCount = pulumi.Input.asOptionalInput<int>(ipv6AddressCount),
        ipv6Addresses =
            pulumi.Input.asOptionalInput<List<String>>(ipv6Addresses),
        ...
        placementGroupId =
            pulumi.Input.asOptionalInput<String>(placementGroupId),
        placementPartitionNumber =
            pulumi.Input.asOptionalInput<int>(placementPartitionNumber),
        privateDnsNameOptions = pulumi.Input.asOptionalInput<
            SpotInstanceRequestPrivateDnsNameOptions>(privateDnsNameOptions),
        ...
        rootBlockDevice =
            pulumi.Input.asOptionalInput<SpotInstanceRequestRootBlockDevice>(
                rootBlockDevice),
        secondaryNetworkInterfaces = pulumi.Input.asOptionalInput<
                List<SpotInstanceRequestSecondaryNetworkInterface>>(
            secondaryNetworkInterfaces),
        secondaryPrivateIps =
            pulumi.Input.asOptionalInput<List<String>>(secondaryPrivateIps),
        securityGroups =
        ...
        userDataReplaceOnChange =
            pulumi.Input.asOptionalInput<bool>(userDataReplaceOnChange),
        validFrom = pulumi.Input.asOptionalInput<String>(validFrom),
        validUntil = pulumi.Input.asOptionalInput<String>(validUntil),
        volumeTags =
            pulumi.Input.asOptionalInput<Map<String, String>>(volumeTags),
        vpcSecurityGroupIds =
  ...
  Map<String, dynamic> toMap() {
    ...
    if (ebsBlockDevicesValue != null) {
      map['ebsBlockDevices'] = pulumi.Input.mapOptionalInputValue<
          ...
          (value) => pulumi.Input.encodeList<SpotInstanceRequestEbsBlockDevice,
  ...
  factory SpotInstanceRequestArgs.fromMap(Map<String, dynamic> map) {
    return SpotInstanceRequestArgs(
      ...
      hibernation:
          map['hibernation'] == null ? null : map['hibernation'] as bool,
      ...
      launchGroup:
          map['launchGroup'] == null ? null : map['launchGroup'] as String,
