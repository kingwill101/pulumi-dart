...
class VpcPeeringConnectionAccepterArgs {
  ...
  factory VpcPeeringConnectionAccepterArgs.fromMap(Map<String, dynamic> map) {
    return VpcPeeringConnectionAccepterArgs(
      accepter: map['accepter'] == null ? null : VpcPeeringConnectionAccepterAccepter.fromMap((map['accepter'] as Map).cast<String, dynamic>()),
      autoAccept: map['autoAccept'] == null ? null : map['autoAccept'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      requester: map['requester'] == null ? null : VpcPeeringConnectionAccepterRequester.fromMap((map['requester'] as Map).cast<String, dynamic>()),
