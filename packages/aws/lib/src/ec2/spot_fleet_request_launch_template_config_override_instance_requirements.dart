...
class SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirements {
  ...
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount?
  acceleratorCount;
  ...
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib?
  ...
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps?
  ...
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu?
  memoryGibPerVcpu;

  /// Block describing the minimum and maximum amount of memory (MiB). Default is no maximum.
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib?
  memoryMib;

  /// Block describing the minimum and maximum amount of network bandwidth, in gigabits per second (Gbps). Default is no minimum or maximum.
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps?
  networkBandwidthGbps;

  /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount?
  ...
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb?
  totalLocalStorageGb;

  /// Block describing the minimum and maximum number of vCPUs. Default is no maximum.
  final SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount?
  vcpuCount;
  ...
  factory SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirements.fromMap(
    Map<String, dynamic> map,
  ) {
    return SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirements(
      acceleratorCount: map['acceleratorCount'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount.fromMap(
      ...
      acceleratorTotalMemoryMib: map['acceleratorTotalMemoryMib'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib.fromMap(
      ...
      baselineEbsBandwidthMbps: map['baselineEbsBandwidthMbps'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps.fromMap(
      ...
      memoryGibPerVcpu: map['memoryGibPerVcpu'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu.fromMap(
              (map['memoryGibPerVcpu'] as Map).cast<String, dynamic>(),
            ),
      memoryMib: map['memoryMib'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib.fromMap(
              (map['memoryMib'] as Map).cast<String, dynamic>(),
            ),
      networkBandwidthGbps: map['networkBandwidthGbps'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps.fromMap(
              (map['networkBandwidthGbps'] as Map).cast<String, dynamic>(),
            ),
      networkInterfaceCount: map['networkInterfaceCount'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount.fromMap(
      ...
      totalLocalStorageGb: map['totalLocalStorageGb'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb.fromMap(
              (map['totalLocalStorageGb'] as Map).cast<String, dynamic>(),
            ),
      vcpuCount: map['vcpuCount'] == null
          ? null
          : SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount.fromMap(
