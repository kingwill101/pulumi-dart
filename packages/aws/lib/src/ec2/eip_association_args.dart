...
class EipAssociationArgs {
  ...
  EipAssociationArgs({
    ...
    String? region,
       ...
       allowReassociation = pulumi.Input.asOptionalInput<bool>(
         allowReassociation,
       ),
       ...
       privateIpAddress = pulumi.Input.asOptionalInput<String>(
         privateIpAddress,
       ),
  ...
  factory EipAssociationArgs.fromMap(Map<String, dynamic> map) {
    return EipAssociationArgs(
      ...
      allowReassociation: map['allowReassociation'] == null
          ? null
          : map['allowReassociation'] as bool,
