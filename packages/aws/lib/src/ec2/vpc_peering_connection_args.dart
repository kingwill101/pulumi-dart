...
class VpcPeeringConnectionArgs {
  ...
  factory VpcPeeringConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VpcPeeringConnectionArgs(
      accepter: map['accepter'] == null ? null : VpcPeeringConnectionAccepter.fromMap((map['accepter'] as Map).cast<String, dynamic>()),
      ...
      requester: map['requester'] == null ? null : VpcPeeringConnectionRequester.fromMap((map['requester'] as Map).cast<String, dynamic>()),
