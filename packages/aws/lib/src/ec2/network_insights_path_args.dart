...
class NetworkInsightsPathArgs {
  ...
  NetworkInsightsPathArgs({
    ...
    int? destinationPort,
    NetworkInsightsPathFilterAtDestination? filterAtDestination,
    NetworkInsightsPathFilterAtSource? filterAtSource,
    ...
    Map<String, String>? tags,
        ...
        filterAtDestination = pulumi.Input.asOptionalInput<
            NetworkInsightsPathFilterAtDestination>(filterAtDestination),
        filterAtSource =
  ...
  factory NetworkInsightsPathArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsPathArgs(
      ...
      destinationIp:
          map['destinationIp'] == null ? null : map['destinationIp'] as String,
      destinationPort:
          map['destinationPort'] == null ? null : map['destinationPort'] as int,
      filterAtDestination: map['filterAtDestination'] == null
          ? null
          : NetworkInsightsPathFilterAtDestination.fromMap(
              (map['filterAtDestination'] as Map).cast<String, dynamic>()),
      filterAtSource: map['filterAtSource'] == null
          ? null
          : NetworkInsightsPathFilterAtSource.fromMap(
              (map['filterAtSource'] as Map).cast<String, dynamic>()),
