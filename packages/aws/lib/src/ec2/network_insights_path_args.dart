...
class NetworkInsightsPathArgs {
  ...
  factory NetworkInsightsPathArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsPathArgs(
      ...
      filterAtDestination: map['filterAtDestination'] == null ? null : NetworkInsightsPathFilterAtDestination.fromMap((map['filterAtDestination'] as Map).cast<String, dynamic>()),
      filterAtSource: map['filterAtSource'] == null ? null : NetworkInsightsPathFilterAtSource.fromMap((map['filterAtSource'] as Map).cast<String, dynamic>()),
