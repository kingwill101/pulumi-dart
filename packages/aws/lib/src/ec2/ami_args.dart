...
class AmiArgs {
  ...
  AmiArgs({
    ...
    String? virtualizationType,
        ...
        virtualizationType =
            pulumi.Input.asOptionalInput<String>(virtualizationType);
  ...
  factory AmiArgs.fromMap(Map<String, dynamic> map) {
    return AmiArgs(
      ...
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null
          ...
          : pulumi.Input.decodeList<AmiEphemeralBlockDevice>(
              ...
              (value) => AmiEphemeralBlockDevice.fromMap(
                  (value as Map).cast<String, dynamic>())),
      imageLocation:
          map['imageLocation'] == null ? null : map['imageLocation'] as String,
      imdsSupport:
          map['imdsSupport'] == null ? null : map['imdsSupport'] as String,
      ...
      rootDeviceName: map['rootDeviceName'] == null
          ? null
          : map['rootDeviceName'] as String,
      sriovNetSupport: map['sriovNetSupport'] == null
          ? null
          : map['sriovNetSupport'] as String,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      tpmSupport:
          map['tpmSupport'] == null ? null : map['tpmSupport'] as String,
      uefiData: map['uefiData'] == null ? null : map['uefiData'] as String,
      virtualizationType: map['virtualizationType'] == null
          ? null
          : map['virtualizationType'] as String,
    );
  }
}
