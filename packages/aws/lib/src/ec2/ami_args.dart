...
class AmiArgs {
  ...
  AmiArgs({
    ...
    String? virtualizationType,
       ...
       virtualizationType = pulumi.Input.asOptionalInput<String>(
         virtualizationType,
       );
  ...
  factory AmiArgs.fromMap(Map<String, dynamic> map) {
    return AmiArgs(
      ...
      imageLocation: map['imageLocation'] == null
          ? null
          : map['imageLocation'] as String,
      imdsSupport: map['imdsSupport'] == null
          ? null
          : map['imdsSupport'] as String,
      ...
      tpmSupport: map['tpmSupport'] == null
          ? null
          : map['tpmSupport'] as String,
