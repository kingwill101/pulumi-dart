...
class GetVpcPeeringConnectionArgs {
  ...
  GetVpcPeeringConnectionArgs({
    ...
    String? vpcId,
       ...
       filters = pulumi
           .Input.asOptionalInput<List<GetVpcPeeringConnectionFilter>>(filters),
    ...
    return <String, dynamic>{
      ...
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetVpcPeeringConnectionFilter>,
  ...
  factory GetVpcPeeringConnectionArgs.fromMap(Map<String, dynamic> map) {
    return GetVpcPeeringConnectionArgs(
      ...
      peerCidrBlock: map['peerCidrBlock'] == null
          ? null
          : map['peerCidrBlock'] as String,
      peerOwnerId: map['peerOwnerId'] == null
          ? null
          : map['peerOwnerId'] as String,
