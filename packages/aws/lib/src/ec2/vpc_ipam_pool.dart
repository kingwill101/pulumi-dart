...
class VpcIpamPool extends pulumi.CustomResource {
  ...
  VpcIpamPool(
    ...
    this.allocationDefaultNetmaskLength = registerOutput<int?>(
      'allocationDefaultNetmaskLength',
    );
    this.allocationMaxNetmaskLength = registerOutput<int?>(
      'allocationMaxNetmaskLength',
    );
    this.allocationMinNetmaskLength = registerOutput<int?>(
      'allocationMinNetmaskLength',
    );
    this.allocationResourceTags = registerOutput<Map<String, String>?>(
    ...
    this.sourceResource = registerOutput<VpcIpamPoolSourceResource?>(
      'sourceResource',
    );
