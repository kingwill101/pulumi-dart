...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    List<String>? vpcSecurityGroupIds,
        ...
        capacityReservationSpecification = pulumi.Input.asOptionalInput<
            ...
            capacityReservationSpecification),
        cpuOptions =
            pulumi.Input.asOptionalInput<InstanceCpuOptions>(cpuOptions),
        creditSpecification =
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      primaryNetworkInterface: map['primaryNetworkInterface'] == null
          ? null
          : InstancePrimaryNetworkInterface.fromMap(
              (map['primaryNetworkInterface'] as Map).cast<String, dynamic>()),
