...
class CapacityReservationArgs {
  ...
  factory CapacityReservationArgs.fromMap(Map<String, dynamic> map) {
    return CapacityReservationArgs(
      ...
      endDateType: map['endDateType'] == null ? null : map['endDateType'] as String,
      ephemeralStorage: map['ephemeralStorage'] == null ? null : map['ephemeralStorage'] as bool,
      instanceCount: map['instanceCount'] as int,
      instanceMatchCriteria: map['instanceMatchCriteria'] == null ? null : map['instanceMatchCriteria'] as String,
      instancePlatform: map['instancePlatform'] as String,
      instanceType: map['instanceType'] as String,
      outpostArn: map['outpostArn'] == null ? null : map['outpostArn'] as String,
      placementGroupArn: map['placementGroupArn'] == null ? null : map['placementGroupArn'] as String,
