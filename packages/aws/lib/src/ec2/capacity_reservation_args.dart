...
class CapacityReservationArgs {
  ...
  CapacityReservationArgs({
    ...
    String? tenancy,
       ...
       instanceMatchCriteria = pulumi.Input.asOptionalInput<String>(
       ...
       placementGroupArn = pulumi.Input.asOptionalInput<String>(
         placementGroupArn,
       ),
  ...
  factory CapacityReservationArgs.fromMap(Map<String, dynamic> map) {
    return CapacityReservationArgs(
      ...
      endDateType: map['endDateType'] == null
          ? null
          : map['endDateType'] as String,
