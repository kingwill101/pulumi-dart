...
class SpotFleetRequest extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SpotFleetRequestLaunchSpecification>?>
  launchSpecifications;

  /// Launch template configuration block. See Launch Template Configs below for more details. Conflicts with `launch_specification`. At least one of `launch_specification` or `launch_template_config` is required.
  late final pulumi.Output<List<SpotFleetRequestLaunchTemplateConfig>?>
  launchTemplateConfigs;
  ...
  late final pulumi.Output<SpotFleetRequestSpotMaintenanceStrategies?>
  ...
  SpotFleetRequest(
    ...
    this.excessCapacityTerminationPolicy = registerOutput<String?>(
      'excessCapacityTerminationPolicy',
    );
    this.fleetType = registerOutput<String?>('fleetType');
    this.iamFleetRole = registerOutput<String>('iamFleetRole');
    this.instanceInterruptionBehaviour = registerOutput<String?>(
      'instanceInterruptionBehaviour',
    );
    this.instancePoolsToUseCount = registerOutput<int?>(
    ...
    this.onDemandAllocationStrategy = registerOutput<String?>(
      'onDemandAllocationStrategy',
    );
    this.onDemandMaxTotalPrice = registerOutput<String?>(
      'onDemandMaxTotalPrice',
    );
    this.onDemandTargetCapacity = registerOutput<int?>(
      'onDemandTargetCapacity',
    );
    this.region = registerOutput<String>('region');
    this.replaceUnhealthyInstances = registerOutput<bool?>(
    ...
    this.targetCapacityUnitType = registerOutput<String?>(
      'targetCapacityUnitType',
    );
    this.targetGroupArns = registerOutput<List<String>>('targetGroupArns');
    this.terminateInstancesOnDelete = registerOutput<String?>(
      'terminateInstancesOnDelete',
    );
    this.terminateInstancesWithExpiration = registerOutput<bool?>(
      'terminateInstancesWithExpiration',
    );
