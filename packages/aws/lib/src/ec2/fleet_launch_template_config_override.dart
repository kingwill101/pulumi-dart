...
class FleetLaunchTemplateConfigOverride {
  ...
  final FleetLaunchTemplateConfigOverrideInstanceRequirements? instanceRequirements;
  /// Instance type.
  ...
  factory FleetLaunchTemplateConfigOverride.fromMap(Map<String, dynamic> map) {
    return FleetLaunchTemplateConfigOverride(
      ...
      instanceRequirements: map['instanceRequirements'] == null ? null : FleetLaunchTemplateConfigOverrideInstanceRequirements.fromMap((map['instanceRequirements'] as Map).cast<String, dynamic>()),
