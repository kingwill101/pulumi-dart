...
class VpcDhcpOptionsArgs {
  ...
  factory VpcDhcpOptionsArgs.fromMap(Map<String, dynamic> map) {
    return VpcDhcpOptionsArgs(
      ...
      domainNameServers: map['domainNameServers'] == null ? null : (map['domainNameServers'] as List).cast<String>(),
      ipv6AddressPreferredLeaseTime: map['ipv6AddressPreferredLeaseTime'] == null ? null : map['ipv6AddressPreferredLeaseTime'] as String,
      netbiosNameServers: map['netbiosNameServers'] == null ? null : (map['netbiosNameServers'] as List).cast<String>(),
      netbiosNodeType: map['netbiosNodeType'] == null ? null : map['netbiosNodeType'] as String,
