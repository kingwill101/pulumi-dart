...
class VpcDhcpOptionsArgs {
  ...
  VpcDhcpOptionsArgs({
    ...
    Map<String, String>? tags,
        ...
        domainNameServers =
            pulumi.Input.asOptionalInput<List<String>>(domainNameServers),
        ipv6AddressPreferredLeaseTime =
            pulumi.Input.asOptionalInput<String>(ipv6AddressPreferredLeaseTime),
        netbiosNameServers =
            pulumi.Input.asOptionalInput<List<String>>(netbiosNameServers),
