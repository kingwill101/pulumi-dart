...
class VpcIpamPoolArgs {
  ...
  VpcIpamPoolArgs({
    ...
    Map<String, String>? tags,
       ...
       allocationDefaultNetmaskLength = pulumi.Input.asOptionalInput<int>(
         allocationDefaultNetmaskLength,
       ),
       allocationMaxNetmaskLength = pulumi.Input.asOptionalInput<int>(
         allocationMaxNetmaskLength,
       ),
       allocationMinNetmaskLength = pulumi.Input.asOptionalInput<int>(
         allocationMinNetmaskLength,
       ),
       allocationResourceTags = pulumi
           .Input.asOptionalInput<Map<String, String>>(allocationResourceTags),
       ...
       publiclyAdvertisable = pulumi.Input.asOptionalInput<bool>(
         publiclyAdvertisable,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       sourceIpamPoolId = pulumi.Input.asOptionalInput<String>(
         sourceIpamPoolId,
       ),
       sourceResource = pulumi.Input.asOptionalInput<VpcIpamPoolSourceResource>(
         sourceResource,
       ),
  ...
  factory VpcIpamPoolArgs.fromMap(Map<String, dynamic> map) {
    return VpcIpamPoolArgs(
      ...
      allocationDefaultNetmaskLength:
          map['allocationDefaultNetmaskLength'] == null
          ? null
          : map['allocationDefaultNetmaskLength'] as int,
      allocationMaxNetmaskLength: map['allocationMaxNetmaskLength'] == null
          ? null
          : map['allocationMaxNetmaskLength'] as int,
      allocationMinNetmaskLength: map['allocationMinNetmaskLength'] == null
          ? null
          : map['allocationMinNetmaskLength'] as int,
      allocationResourceTags: map['allocationResourceTags'] == null
          ? null
          : (map['allocationResourceTags'] as Map).cast<String, String>(),
      autoImport: map['autoImport'] == null ? null : map['autoImport'] as bool,
      awsService: map['awsService'] == null
          ? null
          : map['awsService'] as String,
      ...
      publicIpSource: map['publicIpSource'] == null
          ? null
          : map['publicIpSource'] as String,
      publiclyAdvertisable: map['publiclyAdvertisable'] == null
          ? null
          : map['publiclyAdvertisable'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      sourceIpamPoolId: map['sourceIpamPoolId'] == null
          ? null
          : map['sourceIpamPoolId'] as String,
      sourceResource: map['sourceResource'] == null
          ? null
          : VpcIpamPoolSourceResource.fromMap(
              (map['sourceResource'] as Map).cast<String, dynamic>(),
            ),
      tags: map['tags'] == null
          ? null
