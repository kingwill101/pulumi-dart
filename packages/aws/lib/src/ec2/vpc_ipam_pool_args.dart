...
class VpcIpamPoolArgs {
  ...
  VpcIpamPoolArgs({
    ...
    Map<String, String>? tags,
        ...
        allocationDefaultNetmaskLength =
            pulumi.Input.asOptionalInput<int>(allocationDefaultNetmaskLength),
        allocationMaxNetmaskLength =
            pulumi.Input.asOptionalInput<int>(allocationMaxNetmaskLength),
        allocationMinNetmaskLength =
            pulumi.Input.asOptionalInput<int>(allocationMinNetmaskLength),
        ...
        publiclyAdvertisable =
            pulumi.Input.asOptionalInput<bool>(publiclyAdvertisable),
        region = pulumi.Input.asOptionalInput<String>(region),
        sourceIpamPoolId =
            pulumi.Input.asOptionalInput<String>(sourceIpamPoolId),
        sourceResource =
            pulumi.Input.asOptionalInput<VpcIpamPoolSourceResource>(
                sourceResource),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (sourceResourceValue != null) {
      map['sourceResource'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory VpcIpamPoolArgs.fromMap(Map<String, dynamic> map) {
    return VpcIpamPoolArgs(
      ...
      awsService:
          map['awsService'] == null ? null : map['awsService'] as String,
