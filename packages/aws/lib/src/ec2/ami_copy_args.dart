...
class AmiCopyArgs {
  ...
  factory AmiCopyArgs.fromMap(Map<String, dynamic> map) {
    return AmiCopyArgs(
      ...
      destinationOutpostArn: map['destinationOutpostArn'] == null ? null : map['destinationOutpostArn'] as String,
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : pulumi.Input.decodeList<AmiCopyEbsBlockDevice>(map['ebsBlockDevices'], (value) => AmiCopyEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      encrypted: map['encrypted'] == null ? null : map['encrypted'] as bool,
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : pulumi.Input.decodeList<AmiCopyEphemeralBlockDevice>(map['ephemeralBlockDevices'], (value) => AmiCopyEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
