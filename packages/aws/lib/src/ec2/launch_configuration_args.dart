...
class LaunchConfigurationArgs {
  ...
  factory LaunchConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return LaunchConfigurationArgs(
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : pulumi.Input.decodeList<LaunchConfigurationEbsBlockDevice>(map['ebsBlockDevices'], (value) => LaunchConfigurationEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      ebsOptimized: map['ebsOptimized'] == null ? null : map['ebsOptimized'] as bool,
      enableMonitoring: map['enableMonitoring'] == null ? null : map['enableMonitoring'] as bool,
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : pulumi.Input.decodeList<LaunchConfigurationEphemeralBlockDevice>(map['ephemeralBlockDevices'], (value) => LaunchConfigurationEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      iamInstanceProfile: map['iamInstanceProfile'] == null ? null : map['iamInstanceProfile'] as String,
      imageId: map['imageId'] as String,
      instanceType: map['instanceType'] as String,
      keyName: map['keyName'] == null ? null : map['keyName'] as String,
      metadataOptions: map['metadataOptions'] == null ? null : LaunchConfigurationMetadataOptions.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>()),
      ...
      rootBlockDevice: map['rootBlockDevice'] == null ? null : LaunchConfigurationRootBlockDevice.fromMap((map['rootBlockDevice'] as Map).cast<String, dynamic>()),
