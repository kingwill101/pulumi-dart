...
class FlowLogArgs {
  ...
  FlowLogArgs({
    ...
    String? vpcId,
  }) : deliverCrossAccountRole = pulumi.Input.asOptionalInput<String>(
       ...
       maxAggregationInterval = pulumi.Input.asOptionalInput<int>(
         maxAggregationInterval,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       regionalNatGatewayId = pulumi.Input.asOptionalInput<String>(
  ...
  factory FlowLogArgs.fromMap(Map<String, dynamic> map) {
    return FlowLogArgs(
      ...
      trafficType: map['trafficType'] == null
          ? null
          : map['trafficType'] as String,
