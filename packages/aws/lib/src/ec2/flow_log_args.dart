...
class FlowLogArgs {
  ...
  factory FlowLogArgs.fromMap(Map<String, dynamic> map) {
    return FlowLogArgs(
      ...
      destinationOptions: map['destinationOptions'] == null ? null : FlowLogDestinationOptions.fromMap((map['destinationOptions'] as Map).cast<String, dynamic>()),
      ...
      regionalNatGatewayId: map['regionalNatGatewayId'] == null ? null : map['regionalNatGatewayId'] as String,
