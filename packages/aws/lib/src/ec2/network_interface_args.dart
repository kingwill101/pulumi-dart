...
class NetworkInterfaceArgs {
  ...
  NetworkInterfaceArgs({
    ...
    Map<String, String>? tags,
        ...
        ipv6AddressListEnabled =
            pulumi.Input.asOptionalInput<bool>(ipv6AddressListEnabled),
        ipv6AddressLists =
            pulumi.Input.asOptionalInput<List<String>>(ipv6AddressLists),
        ipv6Addresses =
        ...
        privateIpListEnabled =
            pulumi.Input.asOptionalInput<bool>(privateIpListEnabled),
        privateIpLists =
            pulumi.Input.asOptionalInput<List<String>>(privateIpLists),
  ...
  factory NetworkInterfaceArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceArgs(
      ...
      privateIpsCount:
          map['privateIpsCount'] == null ? null : map['privateIpsCount'] as int,
