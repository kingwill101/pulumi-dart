...
class NetworkInterfaceArgs {
  ...
  factory NetworkInterfaceArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceArgs(
      attachments: map['attachments'] == null ? null : pulumi.Input.decodeList<NetworkInterfaceAttachment>(map['attachments'], (value) => NetworkInterfaceAttachment.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ipv6AddressListEnabled: map['ipv6AddressListEnabled'] == null ? null : map['ipv6AddressListEnabled'] as bool,
      ipv6AddressLists: map['ipv6AddressLists'] == null ? null : (map['ipv6AddressLists'] as List).cast<String>(),
      ...
      privateIpListEnabled: map['privateIpListEnabled'] == null ? null : map['privateIpListEnabled'] as bool,
      privateIpLists: map['privateIpLists'] == null ? null : (map['privateIpLists'] as List).cast<String>(),
