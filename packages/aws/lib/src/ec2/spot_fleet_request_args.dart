...
class SpotFleetRequestArgs {
  ...
  SpotFleetRequestArgs({
    ...
    bool? waitForFulfillment,
  }) : allocationStrategy = pulumi.Input.asOptionalInput<String>(
         allocationStrategy,
       ),
       ...
       instancePoolsToUseCount = pulumi.Input.asOptionalInput<int>(
       ...
       onDemandMaxTotalPrice = pulumi.Input.asOptionalInput<String>(
         onDemandMaxTotalPrice,
       ),
       onDemandTargetCapacity = pulumi.Input.asOptionalInput<int>(
       ...
       targetCapacityUnitType = pulumi.Input.asOptionalInput<String>(
    ...
    return SpotFleetRequestArgs(
      ...
      spotMaintenanceStrategies: map['spotMaintenanceStrategies'] == null
          ...
          : SpotFleetRequestSpotMaintenanceStrategies.fromMap(
              (map['spotMaintenanceStrategies'] as Map).cast<String, dynamic>(),
            ),
