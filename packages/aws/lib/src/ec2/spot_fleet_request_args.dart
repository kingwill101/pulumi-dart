...
class SpotFleetRequestArgs {
  ...
  factory SpotFleetRequestArgs.fromMap(Map<String, dynamic> map) {
    return SpotFleetRequestArgs(
      ...
      instanceInterruptionBehaviour: map['instanceInterruptionBehaviour'] == null ? null : map['instanceInterruptionBehaviour'] as String,
      instancePoolsToUseCount: map['instancePoolsToUseCount'] == null ? null : map['instancePoolsToUseCount'] as int,
      launchSpecifications: map['launchSpecifications'] == null ? null : pulumi.Input.decodeList<SpotFleetRequestLaunchSpecification>(map['launchSpecifications'], (value) => SpotFleetRequestLaunchSpecification.fromMap((value as Map).cast<String, dynamic>())),
      launchTemplateConfigs: map['launchTemplateConfigs'] == null ? null : pulumi.Input.decodeList<SpotFleetRequestLaunchTemplateConfig>(map['launchTemplateConfigs'], (value) => SpotFleetRequestLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      onDemandMaxTotalPrice: map['onDemandMaxTotalPrice'] == null ? null : map['onDemandMaxTotalPrice'] as String,
      ...
      spotMaintenanceStrategies: map['spotMaintenanceStrategies'] == null ? null : SpotFleetRequestSpotMaintenanceStrategies.fromMap((map['spotMaintenanceStrategies'] as Map).cast<String, dynamic>()),
      ...
      terminateInstancesOnDelete: map['terminateInstancesOnDelete'] == null ? null : map['terminateInstancesOnDelete'] as String,
      ...
      waitForFulfillment: map['waitForFulfillment'] == null ? null : map['waitForFulfillment'] as bool,
    );
  }
}
