...
class EipArgs {
  ...
  EipArgs({
    ...
    Map<String, String>? tags,
        ...
        associateWithPrivateIp =
            pulumi.Input.asOptionalInput<String>(associateWithPrivateIp),
        ...
        networkBorderGroup =
            pulumi.Input.asOptionalInput<String>(networkBorderGroup),
        networkInterface =
            pulumi.Input.asOptionalInput<String>(networkInterface),
  ...
  factory EipArgs.fromMap(Map<String, dynamic> map) {
    return EipArgs(
      ...
      associateWithPrivateIp: map['associateWithPrivateIp'] == null
          ? null
          : map['associateWithPrivateIp'] as String,
      ...
      networkBorderGroup: map['networkBorderGroup'] == null
          ? null
          : map['networkBorderGroup'] as String,
      networkInterface: map['networkInterface'] == null
          ? null
          : map['networkInterface'] as String,
      publicIpv4Pool: map['publicIpv4Pool'] == null
          ? null
          : map['publicIpv4Pool'] as String,
