...
class EipArgs {
  ...
  EipArgs({
    ...
    Map<String, String>? tags,
       ...
       associateWithPrivateIp = pulumi.Input.asOptionalInput<String>(
       ...
       networkBorderGroup = pulumi.Input.asOptionalInput<String>(
         networkBorderGroup,
       ),
       networkInterface = pulumi.Input.asOptionalInput<String>(
         networkInterface,
       ),
