...
class ManagedPrefixListArgs {
  ...
  ManagedPrefixListArgs({
    ...
    List<ManagedPrefixListEntry>? entries,
    ...
    Map<String, String>? tags,
        ...
        entries =
            pulumi.Input.asOptionalInput<List<ManagedPrefixListEntry>>(entries),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (entriesValue != null) {
      map['entries'] = pulumi.Input.mapOptionalInputValue<
              List<ManagedPrefixListEntry>, List<Map<String, dynamic>>>(
          entriesValue,
          (value) => pulumi.Input.encodeList<ManagedPrefixListEntry,
