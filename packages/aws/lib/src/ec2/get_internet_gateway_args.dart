...
class GetInternetGatewayArgs {
  ...
  GetInternetGatewayArgs({
    ...
    Map<String, String>? tags,
      ...
      filters = pulumi.Input.asOptionalInput<List<GetInternetGatewayFilter>>(filters),
  ...
  factory GetInternetGatewayArgs.fromMap(Map<String, dynamic> map) {
    return GetInternetGatewayArgs(
      ...
      internetGatewayId: map['internetGatewayId'] == null ? null : map['internetGatewayId'] as String,
