...
class Fleet extends pulumi.CustomResource {
  ...
  Fleet(
    ...
    this.fleetInstanceSets = registerOutput<List<FleetFleetInstanceSet>>('fleetInstanceSets');
    this.fleetState = registerOutput<String>('fleetState');
    this.fulfilledCapacity = registerOutput<double>('fulfilledCapacity');
    this.fulfilledOnDemandCapacity = registerOutput<double>('fulfilledOnDemandCapacity');
    this.launchTemplateConfigs = registerOutput<List<FleetLaunchTemplateConfig>>('launchTemplateConfigs');
    this.onDemandOptions = registerOutput<FleetOnDemandOptions?>('onDemandOptions');
    ...
    this.targetCapacitySpecification = registerOutput<FleetTargetCapacitySpecification>('targetCapacitySpecification');
