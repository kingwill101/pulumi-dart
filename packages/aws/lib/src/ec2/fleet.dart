...
class Fleet extends pulumi.CustomResource {
  ...
  Fleet(String name, {FleetArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.fleetInstanceSets = registerOutput<List<FleetFleetInstanceSet>>(
      'fleetInstanceSets',
    );
    this.fleetState = registerOutput<String>('fleetState');
    this.fulfilledCapacity = registerOutput<double>('fulfilledCapacity');
    this.fulfilledOnDemandCapacity = registerOutput<double>(
    ...
    this.onDemandOptions = registerOutput<FleetOnDemandOptions?>(
      'onDemandOptions',
    );
