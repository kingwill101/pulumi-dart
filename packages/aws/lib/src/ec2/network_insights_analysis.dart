...
class NetworkInsightsAnalysis extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkInsightsAnalysisAlternatePathHint>>
  alternatePathHints;
  ...
  late final pulumi.Output<List<NetworkInsightsAnalysisExplanation>>
  explanations;
  ...
  late final pulumi.Output<List<NetworkInsightsAnalysisForwardPathComponent>>
  ...
  late final pulumi.Output<List<NetworkInsightsAnalysisReturnPathComponent>>
  ...
  NetworkInsightsAnalysis(
    ...
    this.networkInsightsPathId = registerOutput<String>(
