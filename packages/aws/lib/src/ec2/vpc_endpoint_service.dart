...
class VpcEndpointService extends pulumi.CustomResource {
  ...
  VpcEndpointService(
    ...
    this.baseEndpointDnsNames = registerOutput<List<String>>(
      'baseEndpointDnsNames',
    );
    this.gatewayLoadBalancerArns = registerOutput<List<String>?>(
      'gatewayLoadBalancerArns',
    );
    this.managesVpcEndpoints = registerOutput<bool>('managesVpcEndpoints');
    this.networkLoadBalancerArns = registerOutput<List<String>?>(
      'networkLoadBalancerArns',
    );
    ...
    this.supportedIpAddressTypes = registerOutput<List<String>>(
