...
class VolumeAttachmentArgs {
  ...
  factory VolumeAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentArgs(
      ...
      forceDetach: map['forceDetach'] == null ? null : map['forceDetach'] as bool,
      instanceId: map['instanceId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      skipDestroy: map['skipDestroy'] == null ? null : map['skipDestroy'] as bool,
      stopInstanceBeforeDetaching: map['stopInstanceBeforeDetaching'] == null ? null : map['stopInstanceBeforeDetaching'] as bool,
