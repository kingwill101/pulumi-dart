...
class VpnConnectionVgwTelemetry {
  ...
  factory VpnConnectionVgwTelemetry.fromMap(Map<String, dynamic> map) {
    return VpnConnectionVgwTelemetry(
      acceptedRouteCount: map['acceptedRouteCount'] == null ? null : map['acceptedRouteCount'] as int,
      certificateArn: map['certificateArn'] == null ? null : map['certificateArn'] as String,
      lastStatusChange: map['lastStatusChange'] == null ? null : map['lastStatusChange'] as String,
      outsideIpAddress: map['outsideIpAddress'] == null ? null : map['outsideIpAddress'] as String,
