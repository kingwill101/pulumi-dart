...
class GetNetworkInsightsAnalysisForwardPathComponentAttachedTo {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisForwardPathComponentAttachedTo].
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentAttachedTo.fromMap(
      Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisForwardPathComponentAttachedTo(
