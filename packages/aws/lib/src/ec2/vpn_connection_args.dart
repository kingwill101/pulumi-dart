...
class VpnConnectionArgs {
  ...
  VpnConnectionArgs({
    ...
    String? vpnGatewayId,
       ...
       enableAcceleration = pulumi.Input.asOptionalInput<bool>(
         enableAcceleration,
       ),
       localIpv4NetworkCidr = pulumi.Input.asOptionalInput<String>(
         localIpv4NetworkCidr,
       ),
       localIpv6NetworkCidr = pulumi.Input.asOptionalInput<String>(
         localIpv6NetworkCidr,
       ),
       outsideIpAddressType = pulumi.Input.asOptionalInput<String>(
         outsideIpAddressType,
       ),
       presharedKeyStorage = pulumi.Input.asOptionalInput<String>(
         presharedKeyStorage,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       remoteIpv4NetworkCidr = pulumi.Input.asOptionalInput<String>(
         remoteIpv4NetworkCidr,
       ),
       remoteIpv6NetworkCidr = pulumi.Input.asOptionalInput<String>(
       ...
       transportTransitGatewayAttachmentId = pulumi
           .Input.asOptionalInput<String>(transportTransitGatewayAttachmentId),
       tunnel1DpdTimeoutAction = pulumi.Input.asOptionalInput<String>(
         tunnel1DpdTimeoutAction,
       ),
       tunnel1DpdTimeoutSeconds = pulumi.Input.asOptionalInput<int>(
       ...
       tunnel1IkeVersions = pulumi.Input.asOptionalInput<List<String>>(
         tunnel1IkeVersions,
       ),
       tunnel1InsideCidr = pulumi.Input.asOptionalInput<String>(
         tunnel1InsideCidr,
       ),
       tunnel1InsideIpv6Cidr = pulumi.Input.asOptionalInput<String>(
       ...
       tunnel1PresharedKey = pulumi.Input.asOptionalInput<String>(
         tunnel1PresharedKey,
       ),
       tunnel1RekeyFuzzPercentage = pulumi.Input.asOptionalInput<int>(
         tunnel1RekeyFuzzPercentage,
       ),
       tunnel1RekeyMarginTimeSeconds = pulumi.Input.asOptionalInput<int>(
         tunnel1RekeyMarginTimeSeconds,
       ),
       tunnel1ReplayWindowSize = pulumi.Input.asOptionalInput<int>(
         tunnel1ReplayWindowSize,
       ),
       tunnel1StartupAction = pulumi.Input.asOptionalInput<String>(
         tunnel1StartupAction,
       ),
       tunnel2DpdTimeoutAction = pulumi.Input.asOptionalInput<String>(
         tunnel2DpdTimeoutAction,
       ),
       tunnel2DpdTimeoutSeconds = pulumi.Input.asOptionalInput<int>(
       ...
       tunnel2IkeVersions = pulumi.Input.asOptionalInput<List<String>>(
         tunnel2IkeVersions,
       ),
       tunnel2InsideCidr = pulumi.Input.asOptionalInput<String>(
         tunnel2InsideCidr,
       ),
       tunnel2InsideIpv6Cidr = pulumi.Input.asOptionalInput<String>(
       ...
       tunnel2PresharedKey = pulumi.Input.asOptionalInput<String>(
         tunnel2PresharedKey,
       ),
       tunnel2RekeyFuzzPercentage = pulumi.Input.asOptionalInput<int>(
         tunnel2RekeyFuzzPercentage,
       ),
       tunnel2RekeyMarginTimeSeconds = pulumi.Input.asOptionalInput<int>(
         tunnel2RekeyMarginTimeSeconds,
       ),
       tunnel2ReplayWindowSize = pulumi.Input.asOptionalInput<int>(
         tunnel2ReplayWindowSize,
       ),
       tunnel2StartupAction = pulumi.Input.asOptionalInput<String>(
         tunnel2StartupAction,
       ),
       tunnelBandwidth = pulumi.Input.asOptionalInput<String>(tunnelBandwidth),
       tunnelInsideIpVersion = pulumi.Input.asOptionalInput<String>(
         tunnelInsideIpVersion,
       ),
       type = pulumi.Input.asInput<String>(type),
       vpnConcentratorId = pulumi.Input.asOptionalInput<String>(
         vpnConcentratorId,
       ),
  ...
  factory VpnConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VpnConnectionArgs(
      ...
      tunnel1Phase1EncryptionAlgorithms:
          ...
          ? null
          : (map['tunnel1Phase1EncryptionAlgorithms'] as List).cast<String>(),
      tunnel1Phase1IntegrityAlgorithms:
          map['tunnel1Phase1IntegrityAlgorithms'] == null
          ? null
          : (map['tunnel1Phase1IntegrityAlgorithms'] as List).cast<String>(),
      ...
      tunnel1Phase2EncryptionAlgorithms:
          ...
          ? null
          : (map['tunnel1Phase2EncryptionAlgorithms'] as List).cast<String>(),
      tunnel1Phase2IntegrityAlgorithms:
          map['tunnel1Phase2IntegrityAlgorithms'] == null
          ? null
          : (map['tunnel1Phase2IntegrityAlgorithms'] as List).cast<String>(),
      ...
      tunnel2Phase1EncryptionAlgorithms:
          ...
          ? null
          : (map['tunnel2Phase1EncryptionAlgorithms'] as List).cast<String>(),
      tunnel2Phase1IntegrityAlgorithms:
          map['tunnel2Phase1IntegrityAlgorithms'] == null
          ? null
          : (map['tunnel2Phase1IntegrityAlgorithms'] as List).cast<String>(),
      ...
      tunnel2Phase2EncryptionAlgorithms:
          ...
          ? null
          : (map['tunnel2Phase2EncryptionAlgorithms'] as List).cast<String>(),
      tunnel2Phase2IntegrityAlgorithms:
          map['tunnel2Phase2IntegrityAlgorithms'] == null
          ? null
          : (map['tunnel2Phase2IntegrityAlgorithms'] as List).cast<String>(),
