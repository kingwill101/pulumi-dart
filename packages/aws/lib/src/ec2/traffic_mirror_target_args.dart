...
class TrafficMirrorTargetArgs {
  ...
  factory TrafficMirrorTargetArgs.fromMap(Map<String, dynamic> map) {
    return TrafficMirrorTargetArgs(
      ...
      gatewayLoadBalancerEndpointId: map['gatewayLoadBalancerEndpointId'] == null ? null : map['gatewayLoadBalancerEndpointId'] as String,
      networkInterfaceId: map['networkInterfaceId'] == null ? null : map['networkInterfaceId'] as String,
      networkLoadBalancerArn: map['networkLoadBalancerArn'] == null ? null : map['networkLoadBalancerArn'] as String,
