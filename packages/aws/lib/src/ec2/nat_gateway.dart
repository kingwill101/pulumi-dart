...
class NatGateway extends pulumi.CustomResource {
  ...
  NatGateway(
    ...
    this.regionalNatGatewayAutoMode = registerOutput<String>(
      'regionalNatGatewayAutoMode',
    );
    this.routeTableId = registerOutput<String>('routeTableId');
    this.secondaryAllocationIds = registerOutput<List<String>>(
      'secondaryAllocationIds',
    );
    this.secondaryPrivateIpAddressCount = registerOutput<int>(
      'secondaryPrivateIpAddressCount',
    );
    this.secondaryPrivateIpAddresses = registerOutput<List<String>>(
      'secondaryPrivateIpAddresses',
    );
