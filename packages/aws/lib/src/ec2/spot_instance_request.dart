...
class SpotInstanceRequest extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SpotInstanceRequestEbsBlockDevice>>
  ebsBlockDevices;
  ...
  late final pulumi.Output<List<SpotInstanceRequestEphemeralBlockDevice>>
  ...
  late final pulumi.Output<List<SpotInstanceRequestNetworkInterface>>
  networkInterfaces;
  ...
  late final pulumi.Output<List<SpotInstanceRequestPrimaryNetworkInterface>>
  ...
  late final pulumi.Output<List<SpotInstanceRequestSecondaryNetworkInterface>>
  ...
  SpotInstanceRequest(
    ...
    this.cpuOptions = registerOutput<SpotInstanceRequestCpuOptions>(
      'cpuOptions',
    );
    ...
    this.enclaveOptions = registerOutput<SpotInstanceRequestEnclaveOptions>(
      'enclaveOptions',
    );
    ...
    this.instanceInterruptionBehavior = registerOutput<String?>(
    ...
    this.launchTemplate = registerOutput<SpotInstanceRequestLaunchTemplate?>(
      'launchTemplate',
    );
    ...
    this.metadataOptions = registerOutput<SpotInstanceRequestMetadataOptions>(
      'metadataOptions',
    );
    ...
    this.rootBlockDevice = registerOutput<SpotInstanceRequestRootBlockDevice>(
      'rootBlockDevice',
    );
