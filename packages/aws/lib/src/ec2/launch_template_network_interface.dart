  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectionTrackingSpecification':
          ...
          ? null
          : connectionTrackingSpecification!.toMap(),
      'deleteOnTermination': ?deleteOnTermination,
      'description': ?description,
      'deviceIndex': ?deviceIndex,
      'enaSrdSpecification': ?enaSrdSpecification == null
          ? null
          : enaSrdSpecification!.toMap(),
    ...
    return LaunchTemplateNetworkInterface(
      ...
      connectionTrackingSpecification:
          ...
          : LaunchTemplateNetworkInterfaceConnectionTrackingSpecification.fromMap(
              (map['connectionTrackingSpecification'] as Map)
                  .cast<String, dynamic>(),
            ),
      ...
      primaryIpv6: map['primaryIpv6'] == null
          ? null
          : map['primaryIpv6'] as String,
