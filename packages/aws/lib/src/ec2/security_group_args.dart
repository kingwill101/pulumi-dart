...
class SecurityGroupArgs {
  ...
  factory SecurityGroupArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGroupArgs(
      ...
      egress: map['egress'] == null ? null : pulumi.Input.decodeList<SecurityGroupEgress>(map['egress'], (value) => SecurityGroupEgress.fromMap((value as Map).cast<String, dynamic>())),
      ingress: map['ingress'] == null ? null : pulumi.Input.decodeList<SecurityGroupIngress>(map['ingress'], (value) => SecurityGroupIngress.fromMap((value as Map).cast<String, dynamic>())),
