...
class GetNetworkInsightsAnalysisExplanationSubnet {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationSubnet].
  ...
  factory GetNetworkInsightsAnalysisExplanationSubnet.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationSubnet(
