...
class GetNetworkInsightsAnalysisExplanationSecurityGroup {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationSecurityGroup].
  ...
  factory GetNetworkInsightsAnalysisExplanationSecurityGroup.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetNetworkInsightsAnalysisExplanationSecurityGroup(
