...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.associatePublicIpAddress = registerOutput<bool>(
    ...
    this.creditSpecification = registerOutput<InstanceCreditSpecification?>(
      'creditSpecification',
    );
    ...
    this.ebsBlockDevices = registerOutput<List<InstanceEbsBlockDevice>>(
      'ebsBlockDevices',
    );
    this.ebsOptimized = registerOutput<bool>('ebsOptimized');
    this.enablePrimaryIpv6 = registerOutput<bool>('enablePrimaryIpv6');
    this.enclaveOptions = registerOutput<InstanceEnclaveOptions>(
      'enclaveOptions',
    );
    ...
    this.instanceInitiatedShutdownBehavior = registerOutput<String>(
      'instanceInitiatedShutdownBehavior',
    );
    this.instanceLifecycle = registerOutput<String>('instanceLifecycle');
    this.instanceMarketOptions = registerOutput<InstanceInstanceMarketOptions>(
      'instanceMarketOptions',
    );
    ...
    this.launchTemplate = registerOutput<InstanceLaunchTemplate?>(
      'launchTemplate',
    );
    this.maintenanceOptions = registerOutput<InstanceMaintenanceOptions>(
      'maintenanceOptions',
    );
    this.metadataOptions = registerOutput<InstanceMetadataOptions>(
      'metadataOptions',
    );
    this.monitoring = registerOutput<bool>('monitoring');
    this.networkInterfaces = registerOutput<List<InstanceNetworkInterface>>(
      'networkInterfaces',
    );
    ...
    this.placementPartitionNumber = registerOutput<int>(
    ...
    this.primaryNetworkInterfaceId = registerOutput<String>(
      'primaryNetworkInterfaceId',
    );
    this.privateDns = registerOutput<String>('privateDns');
    this.privateDnsNameOptions = registerOutput<InstancePrivateDnsNameOptions>(
    ...
    this.rootBlockDevice = registerOutput<InstanceRootBlockDevice>(
      'rootBlockDevice',
    );
    ...
    this.userDataReplaceOnChange = registerOutput<bool?>(
