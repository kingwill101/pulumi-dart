...
class Instance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InstanceCapacityReservationSpecification> capacityReservationSpecification;
  ...
  late final pulumi.Output<InstancePrimaryNetworkInterface> primaryNetworkInterface;
  ...
  Instance(
    ...
    this.capacityReservationSpecification = registerOutput<InstanceCapacityReservationSpecification>('capacityReservationSpecification');
    this.cpuOptions = registerOutput<InstanceCpuOptions>('cpuOptions');
    this.creditSpecification = registerOutput<InstanceCreditSpecification?>('creditSpecification');
    ...
    this.ebsBlockDevices = registerOutput<List<InstanceEbsBlockDevice>>('ebsBlockDevices');
    this.ebsOptimized = registerOutput<bool>('ebsOptimized');
    this.enablePrimaryIpv6 = registerOutput<bool>('enablePrimaryIpv6');
    this.enclaveOptions = registerOutput<InstanceEnclaveOptions>('enclaveOptions');
    this.ephemeralBlockDevices = registerOutput<List<InstanceEphemeralBlockDevice>>('ephemeralBlockDevices');
    ...
    this.instanceMarketOptions = registerOutput<InstanceInstanceMarketOptions>('instanceMarketOptions');
    ...
    this.launchTemplate = registerOutput<InstanceLaunchTemplate?>('launchTemplate');
    this.maintenanceOptions = registerOutput<InstanceMaintenanceOptions>('maintenanceOptions');
    this.metadataOptions = registerOutput<InstanceMetadataOptions>('metadataOptions');
    ...
    this.primaryNetworkInterface = registerOutput<InstancePrimaryNetworkInterface>('primaryNetworkInterface');
    ...
    this.privateDnsNameOptions = registerOutput<InstancePrivateDnsNameOptions>('privateDnsNameOptions');
    ...
    this.rootBlockDevice = registerOutput<InstanceRootBlockDevice>('rootBlockDevice');
    this.secondaryNetworkInterfaces = registerOutput<List<InstanceSecondaryNetworkInterface>>('secondaryNetworkInterfaces');
    ...
    this.spotInstanceRequestId = registerOutput<String>('spotInstanceRequestId');
