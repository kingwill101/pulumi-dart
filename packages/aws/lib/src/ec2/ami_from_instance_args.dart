...
class AmiFromInstanceArgs {
  ...
  factory AmiFromInstanceArgs.fromMap(Map<String, dynamic> map) {
    return AmiFromInstanceArgs(
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : pulumi.Input.decodeList<AmiFromInstanceEbsBlockDevice>(map['ebsBlockDevices'], (value) => AmiFromInstanceEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : pulumi.Input.decodeList<AmiFromInstanceEphemeralBlockDevice>(map['ephemeralBlockDevices'], (value) => AmiFromInstanceEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      snapshotWithoutReboot: map['snapshotWithoutReboot'] == null ? null : map['snapshotWithoutReboot'] as bool,
