...
class LaunchTemplateArgs {
  ...
  LaunchTemplateArgs({
    ...
    String? name,
    String? namePrefix,
    List<LaunchTemplateNetworkInterface>? networkInterfaces,
    ...
    String? ramDiskId,
    String? region,
    List<LaunchTemplateSecondaryInterface>? secondaryInterfaces,
  ...
  factory LaunchTemplateArgs.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateArgs(
      blockDeviceMappings: map['blockDeviceMappings'] == null ? null : pulumi.Input.decodeList<LaunchTemplateBlockDeviceMapping>(map['blockDeviceMappings'], (value) => LaunchTemplateBlockDeviceMapping.fromMap((value as Map).cast<String, dynamic>())),
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : LaunchTemplateCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>()),
      cpuOptions: map['cpuOptions'] == null ? null : LaunchTemplateCpuOptions.fromMap((map['cpuOptions'] as Map).cast<String, dynamic>()),
      creditSpecification: map['creditSpecification'] == null ? null : LaunchTemplateCreditSpecification.fromMap((map['creditSpecification'] as Map).cast<String, dynamic>()),
      defaultVersion: map['defaultVersion'] == null ? null : map['defaultVersion'] as int,
      ...
      ebsOptimized: map['ebsOptimized'] == null ? null : map['ebsOptimized'] as String,
      enclaveOptions: map['enclaveOptions'] == null ? null : LaunchTemplateEnclaveOptions.fromMap((map['enclaveOptions'] as Map).cast<String, dynamic>()),
      hibernationOptions: map['hibernationOptions'] == null ? null : LaunchTemplateHibernationOptions.fromMap((map['hibernationOptions'] as Map).cast<String, dynamic>()),
      iamInstanceProfile: map['iamInstanceProfile'] == null ? null : LaunchTemplateIamInstanceProfile.fromMap((map['iamInstanceProfile'] as Map).cast<String, dynamic>()),
      ...
      instanceMarketOptions: map['instanceMarketOptions'] == null ? null : LaunchTemplateInstanceMarketOptions.fromMap((map['instanceMarketOptions'] as Map).cast<String, dynamic>()),
      instanceRequirements: map['instanceRequirements'] == null ? null : LaunchTemplateInstanceRequirements.fromMap((map['instanceRequirements'] as Map).cast<String, dynamic>()),
      instanceType: map['instanceType'] == null ? null : map['instanceType'] as String,
      kernelId: map['kernelId'] == null ? null : map['kernelId'] as String,
      keyName: map['keyName'] == null ? null : map['keyName'] as String,
      licenseSpecifications: map['licenseSpecifications'] == null ? null : pulumi.Input.decodeList<LaunchTemplateLicenseSpecification>(map['licenseSpecifications'], (value) => LaunchTemplateLicenseSpecification.fromMap((value as Map).cast<String, dynamic>())),
      maintenanceOptions: map['maintenanceOptions'] == null ? null : LaunchTemplateMaintenanceOptions.fromMap((map['maintenanceOptions'] as Map).cast<String, dynamic>()),
      metadataOptions: map['metadataOptions'] == null ? null : LaunchTemplateMetadataOptions.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>()),
      monitoring: map['monitoring'] == null ? null : LaunchTemplateMonitoring.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<LaunchTemplateNetworkInterface>(map['networkInterfaces'], (value) => LaunchTemplateNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      networkPerformanceOptions: map['networkPerformanceOptions'] == null ? null : LaunchTemplateNetworkPerformanceOptions.fromMap((map['networkPerformanceOptions'] as Map).cast<String, dynamic>()),
      placement: map['placement'] == null ? null : LaunchTemplatePlacement.fromMap((map['placement'] as Map).cast<String, dynamic>()),
      privateDnsNameOptions: map['privateDnsNameOptions'] == null ? null : LaunchTemplatePrivateDnsNameOptions.fromMap((map['privateDnsNameOptions'] as Map).cast<String, dynamic>()),
      ramDiskId: map['ramDiskId'] == null ? null : map['ramDiskId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      secondaryInterfaces: map['secondaryInterfaces'] == null ? null : pulumi.Input.decodeList<LaunchTemplateSecondaryInterface>(map['secondaryInterfaces'], (value) => LaunchTemplateSecondaryInterface.fromMap((value as Map).cast<String, dynamic>())),
      securityGroupNames: map['securityGroupNames'] == null ? null : (map['securityGroupNames'] as List).cast<String>(),
      tagSpecifications: map['tagSpecifications'] == null ? null : pulumi.Input.decodeList<LaunchTemplateTagSpecification>(map['tagSpecifications'], (value) => LaunchTemplateTagSpecification.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      updateDefaultVersion: map['updateDefaultVersion'] == null ? null : map['updateDefaultVersion'] as bool,
