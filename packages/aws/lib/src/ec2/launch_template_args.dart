...
class LaunchTemplateArgs {
  ...
  LaunchTemplateArgs({
    ...
    List<String>? vpcSecurityGroupIds,
       ...
       enclaveOptions = pulumi
           .Input.asOptionalInput<LaunchTemplateEnclaveOptions>(enclaveOptions),
       hibernationOptions =
       ...
       securityGroupNames = pulumi.Input.asOptionalInput<List<String>>(
         securityGroupNames,
       ),
       tagSpecifications =
       ...
       updateDefaultVersion = pulumi.Input.asOptionalInput<bool>(
    ...
    return LaunchTemplateArgs(
      ...
      networkPerformanceOptions: map['networkPerformanceOptions'] == null
          ...
          : LaunchTemplateNetworkPerformanceOptions.fromMap(
              (map['networkPerformanceOptions'] as Map).cast<String, dynamic>(),
            ),
