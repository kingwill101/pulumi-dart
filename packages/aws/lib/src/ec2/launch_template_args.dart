...
class LaunchTemplateArgs {
  ...
  LaunchTemplateArgs({
    ...
    List<String>? vpcSecurityGroupIds,
  })  : blockDeviceMappings = pulumi.Input.asOptionalInput<
            List<LaunchTemplateBlockDeviceMapping>>(blockDeviceMappings),
        capacityReservationSpecification = pulumi.Input.asOptionalInput<
                LaunchTemplateCapacityReservationSpecification>(
            capacityReservationSpecification),
        cpuOptions =
            pulumi.Input.asOptionalInput<LaunchTemplateCpuOptions>(cpuOptions),
        creditSpecification =
        ...
        disableApiTermination =
            pulumi.Input.asOptionalInput<bool>(disableApiTermination),
        ...
        metadataOptions =
            pulumi.Input.asOptionalInput<LaunchTemplateMetadataOptions>(
                metadataOptions),
        monitoring =
            pulumi.Input.asOptionalInput<LaunchTemplateMonitoring>(monitoring),
        name = pulumi.Input.asOptionalInput<String>(name),
        namePrefix = pulumi.Input.asOptionalInput<String>(namePrefix),
        networkInterfaces =
            pulumi.Input.asOptionalInput<List<LaunchTemplateNetworkInterface>>(
                networkInterfaces),
        networkPerformanceOptions = pulumi.Input.asOptionalInput<
            LaunchTemplateNetworkPerformanceOptions>(networkPerformanceOptions),
        placement =
            pulumi.Input.asOptionalInput<LaunchTemplatePlacement>(placement),
        privateDnsNameOptions =
        ...
        secondaryInterfaces = pulumi.Input.asOptionalInput<
            List<LaunchTemplateSecondaryInterface>>(secondaryInterfaces),
        securityGroupNames =
        ...
        updateDefaultVersion =
            pulumi.Input.asOptionalInput<bool>(updateDefaultVersion),
  ...
  factory LaunchTemplateArgs.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateArgs(
      ...
      instanceMarketOptions: map['instanceMarketOptions'] == null
          ? null
          : LaunchTemplateInstanceMarketOptions.fromMap(
              (map['instanceMarketOptions'] as Map).cast<String, dynamic>()),
      ...
      licenseSpecifications: map['licenseSpecifications'] == null
          ? null
      ...
      networkInterfaces: map['networkInterfaces'] == null
          ...
          : pulumi.Input.decodeList<LaunchTemplateNetworkInterface>(
              ...
              (value) => LaunchTemplateNetworkInterface.fromMap(
                  (value as Map).cast<String, dynamic>())),
      networkPerformanceOptions: map['networkPerformanceOptions'] == null
          ? null
          : LaunchTemplateNetworkPerformanceOptions.fromMap(
              (map['networkPerformanceOptions'] as Map)
                  .cast<String, dynamic>()),
      ...
      secondaryInterfaces: map['secondaryInterfaces'] == null
          ? null
      ...
      updateDefaultVersion: map['updateDefaultVersion'] == null
          ? null
          : map['updateDefaultVersion'] as bool,
