...
class VpcEndpointArgs {
  ...
  VpcEndpointArgs({
    ...
    required String vpcId,
        ...
        dnsOptions =
            pulumi.Input.asOptionalInput<VpcEndpointDnsOptions>(dnsOptions),
        ...
        resourceConfigurationArn =
            pulumi.Input.asOptionalInput<String>(resourceConfigurationArn),
        routeTableIds =
        ...
        serviceNetworkArn =
            pulumi.Input.asOptionalInput<String>(serviceNetworkArn),
        serviceRegion = pulumi.Input.asOptionalInput<String>(serviceRegion),
        subnetConfigurations =
            pulumi.Input.asOptionalInput<List<VpcEndpointSubnetConfiguration>>(
                subnetConfigurations),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (subnetConfigurationsValue != null) {
      map['subnetConfigurations'] = pulumi.Input.mapOptionalInputValue<
              List<VpcEndpointSubnetConfiguration>, List<Map<String, dynamic>>>(
          subnetConfigurationsValue,
          (value) => pulumi.Input.encodeList<VpcEndpointSubnetConfiguration,
