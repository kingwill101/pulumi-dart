...
class VpcEndpointArgs {
  ...
  factory VpcEndpointArgs.fromMap(Map<String, dynamic> map) {
    return VpcEndpointArgs(
      ...
      dnsOptions: map['dnsOptions'] == null ? null : VpcEndpointDnsOptions.fromMap((map['dnsOptions'] as Map).cast<String, dynamic>()),
      ...
      subnetConfigurations: map['subnetConfigurations'] == null ? null : pulumi.Input.decodeList<VpcEndpointSubnetConfiguration>(map['subnetConfigurations'], (value) => VpcEndpointSubnetConfiguration.fromMap((value as Map).cast<String, dynamic>())),
