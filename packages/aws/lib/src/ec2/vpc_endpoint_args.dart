...
class VpcEndpointArgs {
  ...
  VpcEndpointArgs({
    ...
    required String vpcId,
       ...
       resourceConfigurationArn = pulumi.Input.asOptionalInput<String>(
       ...
       serviceNetworkArn = pulumi.Input.asOptionalInput<String>(
         serviceNetworkArn,
       ),
  ...
  factory VpcEndpointArgs.fromMap(Map<String, dynamic> map) {
    return VpcEndpointArgs(
      ...
      serviceRegion: map['serviceRegion'] == null
          ? null
          : map['serviceRegion'] as String,
