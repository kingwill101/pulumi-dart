...
class TrafficMirrorFilterRule extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TrafficMirrorFilterRuleDestinationPortRange?> destinationPortRange;
  ...
  late final pulumi.Output<TrafficMirrorFilterRuleSourcePortRange?> sourcePortRange;
  ...
  TrafficMirrorFilterRule(
    ...
    this.destinationPortRange = registerOutput<TrafficMirrorFilterRuleDestinationPortRange?>('destinationPortRange');
    ...
    this.sourcePortRange = registerOutput<TrafficMirrorFilterRuleSourcePortRange?>('sourcePortRange');
