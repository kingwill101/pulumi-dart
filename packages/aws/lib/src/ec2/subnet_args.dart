...
class SubnetArgs {
  ...
  SubnetArgs({
    ...
    required String vpcId,
            ...
            pulumi.Input.asOptionalInput<bool>(assignIpv6AddressOnCreation),
        availabilityZone =
        ...
        enableLniAtDeviceIndex =
            pulumi.Input.asOptionalInput<int>(enableLniAtDeviceIndex),
        ...
        ipv4NetmaskLength =
            pulumi.Input.asOptionalInput<int>(ipv4NetmaskLength),
        ...
        ipv6NetmaskLength =
            pulumi.Input.asOptionalInput<int>(ipv6NetmaskLength),
        mapCustomerOwnedIpOnLaunch =
            pulumi.Input.asOptionalInput<bool>(mapCustomerOwnedIpOnLaunch),
        mapPublicIpOnLaunch =
            pulumi.Input.asOptionalInput<bool>(mapPublicIpOnLaunch),
  ...
  factory SubnetArgs.fromMap(Map<String, dynamic> map) {
    return SubnetArgs(
      ...
      enableDns64:
          map['enableDns64'] == null ? null : map['enableDns64'] as bool,
