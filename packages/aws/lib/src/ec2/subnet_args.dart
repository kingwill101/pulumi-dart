...
class SubnetArgs {
  ...
  SubnetArgs({
    ...
    required String vpcId,
       ...
       availabilityZoneId = pulumi.Input.asOptionalInput<String>(
         availabilityZoneId,
       ),
       ...
       enableLniAtDeviceIndex = pulumi.Input.asOptionalInput<int>(
         enableLniAtDeviceIndex,
       ),
       enableResourceNameDnsARecordOnLaunch = pulumi
           .Input.asOptionalInput<bool>(enableResourceNameDnsARecordOnLaunch),
       ...
       mapCustomerOwnedIpOnLaunch = pulumi.Input.asOptionalInput<bool>(
         mapCustomerOwnedIpOnLaunch,
       ),
       mapPublicIpOnLaunch = pulumi.Input.asOptionalInput<bool>(
         mapPublicIpOnLaunch,
       ),
  ...
  factory SubnetArgs.fromMap(Map<String, dynamic> map) {
    return SubnetArgs(
      assignIpv6AddressOnCreation: map['assignIpv6AddressOnCreation'] == null
          ? null
          : map['assignIpv6AddressOnCreation'] as bool,
      ...
      enableDns64: map['enableDns64'] == null
          ? null
          : map['enableDns64'] as bool,
      enableLniAtDeviceIndex: map['enableLniAtDeviceIndex'] == null
          ? null
          : map['enableLniAtDeviceIndex'] as int,
      enableResourceNameDnsARecordOnLaunch:
          map['enableResourceNameDnsARecordOnLaunch'] == null
          ? null
          : map['enableResourceNameDnsARecordOnLaunch'] as bool,
      enableResourceNameDnsAaaaRecordOnLaunch:
          map['enableResourceNameDnsAaaaRecordOnLaunch'] == null
          ? null
      ...
      mapCustomerOwnedIpOnLaunch: map['mapCustomerOwnedIpOnLaunch'] == null
          ? null
          : map['mapCustomerOwnedIpOnLaunch'] as bool,
      mapPublicIpOnLaunch: map['mapPublicIpOnLaunch'] == null
          ? null
          : map['mapPublicIpOnLaunch'] as bool,
      outpostArn: map['outpostArn'] == null
          ? null
          : map['outpostArn'] as String,
      privateDnsHostnameTypeOnLaunch:
          map['privateDnsHostnameTypeOnLaunch'] == null
          ? null
