...
class VpcIpamPoolCidrArgs {
  ...
  factory VpcIpamPoolCidrArgs.fromMap(Map<String, dynamic> map) {
    return VpcIpamPoolCidrArgs(
      ...
      cidrAuthorizationContext: map['cidrAuthorizationContext'] == null ? null : VpcIpamPoolCidrCidrAuthorizationContext.fromMap((map['cidrAuthorizationContext'] as Map).cast<String, dynamic>()),
