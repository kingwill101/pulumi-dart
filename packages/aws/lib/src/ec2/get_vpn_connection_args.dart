...
class GetVpnConnectionArgs {
  ...
  factory GetVpnConnectionArgs.fromMap(Map<String, dynamic> map) {
    return GetVpnConnectionArgs(
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<GetVpnConnectionFilter>(map['filters'], (value) => GetVpnConnectionFilter.fromMap((value as Map).cast<String, dynamic>())),
