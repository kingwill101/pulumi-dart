...
class ScheduledQueryRecentlyFailedRunExecutionStat {
  ...
  factory ScheduledQueryRecentlyFailedRunExecutionStat.fromMap(
    ...
    return ScheduledQueryRecentlyFailedRunExecutionStat(
      bytesMetered: map['bytesMetered'] == null
          ? null
          : map['bytesMetered'] as int,
      ...
      queryResultRows: map['queryResultRows'] == null
          ? null
          : map['queryResultRows'] as int,
      recordsIngested: map['recordsIngested'] == null
          ? null
          : map['recordsIngested'] as int,
    );
  }
}
