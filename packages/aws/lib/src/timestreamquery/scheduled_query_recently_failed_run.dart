...
class ScheduledQueryRecentlyFailedRun {
  ...
  final List<ScheduledQueryRecentlyFailedRunErrorReportLocation>? errorReportLocations;
  ...
  final List<ScheduledQueryRecentlyFailedRunQueryInsightsResponse>? queryInsightsResponses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorReportLocations': ?errorReportLocations == null ? null : pulumi.Input.encodeList<ScheduledQueryRecentlyFailedRunErrorReportLocation, Map<String, dynamic>>(errorReportLocations!, (value) => value.toMap()),
      'executionStats': ?executionStats == null ? null : pulumi.Input.encodeList<ScheduledQueryRecentlyFailedRunExecutionStat, Map<String, dynamic>>(executionStats!, (value) => value.toMap()),
      'failureReason': ?failureReason,
      'invocationTime': ?invocationTime,
      'queryInsightsResponses': ?queryInsightsResponses == null ? null : pulumi.Input.encodeList<ScheduledQueryRecentlyFailedRunQueryInsightsResponse, Map<String, dynamic>>(queryInsightsResponses!, (value) => value.toMap()),
      'runStatus': ?runStatus,
  ...
  factory ScheduledQueryRecentlyFailedRun.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRecentlyFailedRun(
      errorReportLocations: map['errorReportLocations'] == null ? null : pulumi.Input.decodeList<ScheduledQueryRecentlyFailedRunErrorReportLocation>(map['errorReportLocations'], (value) => ScheduledQueryRecentlyFailedRunErrorReportLocation.fromMap((value as Map).cast<String, dynamic>())),
      executionStats: map['executionStats'] == null ? null : pulumi.Input.decodeList<ScheduledQueryRecentlyFailedRunExecutionStat>(map['executionStats'], (value) => ScheduledQueryRecentlyFailedRunExecutionStat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      queryInsightsResponses: map['queryInsightsResponses'] == null ? null : pulumi.Input.decodeList<ScheduledQueryRecentlyFailedRunQueryInsightsResponse>(map['queryInsightsResponses'], (value) => ScheduledQueryRecentlyFailedRunQueryInsightsResponse.fromMap((value as Map).cast<String, dynamic>())),
