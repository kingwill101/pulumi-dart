...
class ScheduledQueryArgs {
  ...
  ScheduledQueryArgs({
    ...
    ScheduledQueryTimeouts? timeouts,
      ...
      errorReportConfiguration = pulumi.Input.asInput<ScheduledQueryErrorReportConfiguration>(errorReportConfiguration),
      ...
      notificationConfiguration = pulumi.Input.asInput<ScheduledQueryNotificationConfiguration>(notificationConfiguration),
      ...
      scheduleConfiguration = pulumi.Input.asInput<ScheduledQueryScheduleConfiguration>(scheduleConfiguration),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      targetConfiguration = pulumi.Input.asInput<ScheduledQueryTargetConfiguration>(targetConfiguration),
  ...
  factory ScheduledQueryArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryArgs(
      errorReportConfiguration: ScheduledQueryErrorReportConfiguration.fromMap((map['errorReportConfiguration'] as Map).cast<String, dynamic>()),
      executionRoleArn: map['executionRoleArn'] as String,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      lastRunSummaries: map['lastRunSummaries'] == null ? null : pulumi.Input.decodeList<ScheduledQueryLastRunSummary>(map['lastRunSummaries'], (value) => ScheduledQueryLastRunSummary.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      notificationConfiguration: ScheduledQueryNotificationConfiguration.fromMap((map['notificationConfiguration'] as Map).cast<String, dynamic>()),
      queryString: map['queryString'] as String,
      recentlyFailedRuns: map['recentlyFailedRuns'] == null ? null : pulumi.Input.decodeList<ScheduledQueryRecentlyFailedRun>(map['recentlyFailedRuns'], (value) => ScheduledQueryRecentlyFailedRun.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      scheduleConfiguration: ScheduledQueryScheduleConfiguration.fromMap((map['scheduleConfiguration'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetConfiguration: ScheduledQueryTargetConfiguration.fromMap((map['targetConfiguration'] as Map).cast<String, dynamic>()),
      timeouts: map['timeouts'] == null ? null : ScheduledQueryTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
