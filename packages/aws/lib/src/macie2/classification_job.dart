...
class ClassificationJob extends pulumi.CustomResource {
  ...
  ClassificationJob(
    ...
    this.customDataIdentifierIds = registerOutput<List<String>>(
    ...
    this.s3JobDefinition = registerOutput<ClassificationJobS3JobDefinition>(
      's3JobDefinition',
    );
    this.samplingPercentage = registerOutput<int>('samplingPercentage');
    this.scheduleFrequency = registerOutput<ClassificationJobScheduleFrequency>(
      'scheduleFrequency',
    );
