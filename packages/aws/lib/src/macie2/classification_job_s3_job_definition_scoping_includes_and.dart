...
class ClassificationJobS3JobDefinitionScopingIncludesAnd {
  ...
  final ClassificationJobS3JobDefinitionScopingIncludesAndSimpleScopeTerm? simpleScopeTerm;
  /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an object from the job. (documented below)
  final ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTerm? tagScopeTerm;
  ...
  factory ClassificationJobS3JobDefinitionScopingIncludesAnd.fromMap(Map<String, dynamic> map) {
    return ClassificationJobS3JobDefinitionScopingIncludesAnd(
      simpleScopeTerm: map['simpleScopeTerm'] == null ? null : ClassificationJobS3JobDefinitionScopingIncludesAndSimpleScopeTerm.fromMap((map['simpleScopeTerm'] as Map).cast<String, dynamic>()),
      tagScopeTerm: map['tagScopeTerm'] == null ? null : ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTerm.fromMap((map['tagScopeTerm'] as Map).cast<String, dynamic>()),
    );
  }
}
