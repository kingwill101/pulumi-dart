...
class ClassificationJobArgs {
  ...
  factory ClassificationJobArgs.fromMap(Map<String, dynamic> map) {
    return ClassificationJobArgs(
      customDataIdentifierIds: map['customDataIdentifierIds'] == null ? null : (map['customDataIdentifierIds'] as List).cast<String>(),
      ...
      s3JobDefinition: ClassificationJobS3JobDefinition.fromMap((map['s3JobDefinition'] as Map).cast<String, dynamic>()),
      samplingPercentage: map['samplingPercentage'] == null ? null : map['samplingPercentage'] as int,
      scheduleFrequency: map['scheduleFrequency'] == null ? null : ClassificationJobScheduleFrequency.fromMap((map['scheduleFrequency'] as Map).cast<String, dynamic>()),
