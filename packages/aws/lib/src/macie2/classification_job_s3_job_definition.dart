...
class ClassificationJobS3JobDefinition {
  ...
  final List<ClassificationJobS3JobDefinitionBucketDefinition>? bucketDefinitions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bucketDefinitions': ?bucketDefinitions == null ? null : pulumi.Input.encodeList<ClassificationJobS3JobDefinitionBucketDefinition, Map<String, dynamic>>(bucketDefinitions!, (value) => value.toMap()),
  ...
  factory ClassificationJobS3JobDefinition.fromMap(Map<String, dynamic> map) {
    return ClassificationJobS3JobDefinition(
      bucketCriteria: map['bucketCriteria'] == null ? null : ClassificationJobS3JobDefinitionBucketCriteria.fromMap((map['bucketCriteria'] as Map).cast<String, dynamic>()),
      bucketDefinitions: map['bucketDefinitions'] == null ? null : pulumi.Input.decodeList<ClassificationJobS3JobDefinitionBucketDefinition>(map['bucketDefinitions'], (value) => ClassificationJobS3JobDefinitionBucketDefinition.fromMap((value as Map).cast<String, dynamic>())),
      scoping: map['scoping'] == null ? null : ClassificationJobS3JobDefinitionScoping.fromMap((map['scoping'] as Map).cast<String, dynamic>()),
    );
  }
}
