...
class GraphArgs {
  ...
  factory GraphArgs.fromMap(Map<String, dynamic> map) {
    return GraphArgs(
      ...
      graphNamePrefix: map['graphNamePrefix'] == null ? null : map['graphNamePrefix'] as String,
      ...
      publicConnectivity: map['publicConnectivity'] == null ? null : map['publicConnectivity'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      replicaCount: map['replicaCount'] == null ? null : map['replicaCount'] as int,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : GraphTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      vectorSearchConfiguration: map['vectorSearchConfiguration'] == null ? null : GraphVectorSearchConfiguration.fromMap((map['vectorSearchConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
