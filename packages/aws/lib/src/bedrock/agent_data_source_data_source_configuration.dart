    ...
    return AgentDataSourceDataSourceConfiguration(
      confluenceConfiguration: map['confluenceConfiguration'] == null
          ...
          : AgentDataSourceDataSourceConfigurationConfluenceConfiguration.fromMap(
              (map['confluenceConfiguration'] as Map).cast<String, dynamic>(),
            ),
      ...
      salesforceConfiguration: map['salesforceConfiguration'] == null
          ...
          : AgentDataSourceDataSourceConfigurationSalesforceConfiguration.fromMap(
              (map['salesforceConfiguration'] as Map).cast<String, dynamic>(),
            ),
      sharePointConfiguration: map['sharePointConfiguration'] == null
          ...
          : AgentDataSourceDataSourceConfigurationSharePointConfiguration.fromMap(
              (map['sharePointConfiguration'] as Map).cast<String, dynamic>(),
            ),
