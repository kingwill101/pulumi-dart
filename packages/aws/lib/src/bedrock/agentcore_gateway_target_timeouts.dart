...
class AgentcoreGatewayTargetTimeouts {
  ...
  /// Creates a new [AgentcoreGatewayTargetTimeouts].
  ...
  AgentcoreGatewayTargetTimeouts({this.create, this.delete, this.update});
  ...
  factory AgentcoreGatewayTargetTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreGatewayTargetTimeouts(
