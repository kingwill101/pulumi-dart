    ...
    return <String, dynamic>{
      'authorizationServerMetadatas':
          pulumi.Input.encodeList<
            AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata,
            Map<String, dynamic>
          >(authorizationServerMetadatas, (value) => value.toMap()),
      'discoveryUrl': discoveryUrl,
    };
  }

  factory AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscovery.fromMap(
    ...
    return AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscovery(
      authorizationServerMetadatas:
          ...
          >(
            ...
            (value) =>
                AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata.fromMap(
