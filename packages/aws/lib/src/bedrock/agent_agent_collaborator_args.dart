...
class AgentAgentCollaboratorArgs {
  ...
  factory AgentAgentCollaboratorArgs.fromMap(Map<String, dynamic> map) {
    return AgentAgentCollaboratorArgs(
      agentDescriptor: AgentAgentCollaboratorAgentDescriptor.fromMap((map['agentDescriptor'] as Map).cast<String, dynamic>()),
      ...
      relayConversationHistory: map['relayConversationHistory'] == null ? null : map['relayConversationHistory'] as String,
      timeouts: map['timeouts'] == null ? null : AgentAgentCollaboratorTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
