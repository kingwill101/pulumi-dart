...
class Guardrail extends pulumi.CustomResource {
  ...
  Guardrail(
    ...
    this.blockedInputMessaging = registerOutput<String>(
      'blockedInputMessaging',
    );
    this.blockedOutputsMessaging = registerOutput<String>(
      'blockedOutputsMessaging',
    );
    this.contentPolicyConfig = registerOutput<GuardrailContentPolicyConfig?>(
      'contentPolicyConfig',
    );
    ...
    this.crossRegionConfig = registerOutput<GuardrailCrossRegionConfig?>(
      'crossRegionConfig',
    );
    ...
    this.topicPolicyConfig = registerOutput<GuardrailTopicPolicyConfig?>(
      'topicPolicyConfig',
    );
    this.version = registerOutput<String>('version');
    this.wordPolicyConfig = registerOutput<GuardrailWordPolicyConfig?>(
      'wordPolicyConfig',
    );
  }
}
