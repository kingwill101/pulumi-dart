...
class AgentAgentActionGroupArgs {
  ...
  factory AgentAgentActionGroupArgs.fromMap(Map<String, dynamic> map) {
    return AgentAgentActionGroupArgs(
      actionGroupExecutor: map['actionGroupExecutor'] == null ? null : AgentAgentActionGroupActionGroupExecutor.fromMap((map['actionGroupExecutor'] as Map).cast<String, dynamic>()),
      actionGroupName: map['actionGroupName'] as String,
      actionGroupState: map['actionGroupState'] == null ? null : map['actionGroupState'] as String,
      agentId: map['agentId'] as String,
      agentVersion: map['agentVersion'] as String,
      apiSchema: map['apiSchema'] == null ? null : AgentAgentActionGroupApiSchema.fromMap((map['apiSchema'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      functionSchema: map['functionSchema'] == null ? null : AgentAgentActionGroupFunctionSchema.fromMap((map['functionSchema'] as Map).cast<String, dynamic>()),
      parentActionGroupSignature: map['parentActionGroupSignature'] == null ? null : map['parentActionGroupSignature'] as String,
      prepareAgent: map['prepareAgent'] == null ? null : map['prepareAgent'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      skipResourceInUseCheck: map['skipResourceInUseCheck'] == null ? null : map['skipResourceInUseCheck'] as bool,
      timeouts: map['timeouts'] == null ? null : AgentAgentActionGroupTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
