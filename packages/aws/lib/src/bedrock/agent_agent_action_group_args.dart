...
class AgentAgentActionGroupArgs {
  ...
  AgentAgentActionGroupArgs({
    ...
    AgentAgentActionGroupTimeouts? timeouts,
        ...
        actionGroupState =
            pulumi.Input.asOptionalInput<String>(actionGroupState),
        agentId = pulumi.Input.asInput<String>(agentId),
        agentVersion = pulumi.Input.asInput<String>(agentVersion),
        apiSchema =
            pulumi.Input.asOptionalInput<AgentAgentActionGroupApiSchema>(
                apiSchema),
        ...
        parentActionGroupSignature =
            pulumi.Input.asOptionalInput<String>(parentActionGroupSignature),
        prepareAgent = pulumi.Input.asOptionalInput<bool>(prepareAgent),
        region = pulumi.Input.asOptionalInput<String>(region),
        skipResourceInUseCheck =
            pulumi.Input.asOptionalInput<bool>(skipResourceInUseCheck),
