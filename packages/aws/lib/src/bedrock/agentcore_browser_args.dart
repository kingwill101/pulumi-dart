...
class AgentcoreBrowserArgs {
  ...
  factory AgentcoreBrowserArgs.fromMap(Map<String, dynamic> map) {
    return AgentcoreBrowserArgs(
      ...
      networkConfiguration: AgentcoreBrowserNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      recording: map['recording'] == null ? null : AgentcoreBrowserRecording.fromMap((map['recording'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : AgentcoreBrowserTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
