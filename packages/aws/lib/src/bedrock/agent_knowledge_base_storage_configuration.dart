  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mongoDbAtlasConfiguration': ?mongoDbAtlasConfiguration == null
          ? null
          : mongoDbAtlasConfiguration!.toMap(),
      'neptuneAnalyticsConfiguration': ?neptuneAnalyticsConfiguration == null
          ? null
          : neptuneAnalyticsConfiguration!.toMap(),
      'opensearchManagedClusterConfiguration':
          ?opensearchManagedClusterConfiguration == null
          ? null
          : opensearchManagedClusterConfiguration!.toMap(),
      'opensearchServerlessConfiguration':
          ?opensearchServerlessConfiguration == null
          ? null
          : opensearchServerlessConfiguration!.toMap(),
      'pineconeConfiguration': ?pineconeConfiguration == null
          ? null
          : pineconeConfiguration!.toMap(),
      'rdsConfiguration': ?rdsConfiguration == null
          ? null
          : rdsConfiguration!.toMap(),
      'redisEnterpriseCloudConfiguration':
          ?redisEnterpriseCloudConfiguration == null
          ? null
          : redisEnterpriseCloudConfiguration!.toMap(),
      's3VectorsConfiguration': ?s3VectorsConfiguration == null
          ? null
          : s3VectorsConfiguration!.toMap(),
      'type': type,
    };
  }
    ...
    return AgentKnowledgeBaseStorageConfiguration(
      mongoDbAtlasConfiguration: map['mongoDbAtlasConfiguration'] == null
          ...
          : AgentKnowledgeBaseStorageConfigurationMongoDbAtlasConfiguration.fromMap(
              (map['mongoDbAtlasConfiguration'] as Map).cast<String, dynamic>(),
            ),
      neptuneAnalyticsConfiguration:
          map['neptuneAnalyticsConfiguration'] == null
          ? null
          : AgentKnowledgeBaseStorageConfigurationNeptuneAnalyticsConfiguration.fromMap(
              (map['neptuneAnalyticsConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      opensearchManagedClusterConfiguration:
          map['opensearchManagedClusterConfiguration'] == null
          ? null
          : AgentKnowledgeBaseStorageConfigurationOpensearchManagedClusterConfiguration.fromMap(
              (map['opensearchManagedClusterConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      opensearchServerlessConfiguration:
      ...
      redisEnterpriseCloudConfiguration:
          map['redisEnterpriseCloudConfiguration'] == null
          ? null
          : AgentKnowledgeBaseStorageConfigurationRedisEnterpriseCloudConfiguration.fromMap(
              (map['redisEnterpriseCloudConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      s3VectorsConfiguration: map['s3VectorsConfiguration'] == null
          ...
          : AgentKnowledgeBaseStorageConfigurationS3VectorsConfiguration.fromMap(
              (map['s3VectorsConfiguration'] as Map).cast<String, dynamic>(),
            ),
