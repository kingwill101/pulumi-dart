...
class AgentAgentCollaboratorTimeouts {
  ...
  /// Creates a new [AgentAgentCollaboratorTimeouts].
  ...
  AgentAgentCollaboratorTimeouts({this.create, this.delete, this.update});
  ...
  factory AgentAgentCollaboratorTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentAgentCollaboratorTimeouts(
