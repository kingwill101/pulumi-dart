  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'embeddingModelConfiguration': ?embeddingModelConfiguration == null
          ? null
          : embeddingModelConfiguration!.toMap(),
      'supplementalDataStorageConfiguration':
          ?supplementalDataStorageConfiguration == null
          ? null
          : supplementalDataStorageConfiguration!.toMap(),
    };
  }
    ...
    return AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfiguration(
      ...
      embeddingModelConfiguration: map['embeddingModelConfiguration'] == null
          ...
          : AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationEmbeddingModelConfiguration.fromMap(
              (map['embeddingModelConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      supplementalDataStorageConfiguration:
          map['supplementalDataStorageConfiguration'] == null
          ? null
          : AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfiguration.fromMap(
              (map['supplementalDataStorageConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
    );
  }
