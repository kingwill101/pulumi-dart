  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'chunkingConfiguration': ?chunkingConfiguration == null
          ? null
          : chunkingConfiguration!.toMap(),
      'customTransformationConfiguration':
          ?customTransformationConfiguration == null
          ? null
          : customTransformationConfiguration!.toMap(),
      'parsingConfiguration': ?parsingConfiguration == null
          ? null
          : parsingConfiguration!.toMap(),
    };
  }
    ...
    return AgentDataSourceVectorIngestionConfiguration(
      chunkingConfiguration: map['chunkingConfiguration'] == null
          ...
          : AgentDataSourceVectorIngestionConfigurationChunkingConfiguration.fromMap(
              (map['chunkingConfiguration'] as Map).cast<String, dynamic>(),
            ),
      customTransformationConfiguration:
          map['customTransformationConfiguration'] == null
          ? null
          : AgentDataSourceVectorIngestionConfigurationCustomTransformationConfiguration.fromMap(
              (map['customTransformationConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
