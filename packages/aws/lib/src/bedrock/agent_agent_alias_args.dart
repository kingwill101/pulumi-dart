...
class AgentAgentAliasArgs {
  ...
  AgentAgentAliasArgs({
    ...
    AgentAgentAliasTimeouts? timeouts,
        ...
        timeouts =
            pulumi.Input.asOptionalInput<AgentAgentAliasTimeouts>(timeouts);
  ...
  factory AgentAgentAliasArgs.fromMap(Map<String, dynamic> map) {
    return AgentAgentAliasArgs(
      ...
      routingConfigurations: map['routingConfigurations'] == null
          ? null
          : pulumi.Input.decodeList<AgentAgentAliasRoutingConfiguration>(
              map['routingConfigurations'],
              (value) => AgentAgentAliasRoutingConfiguration.fromMap(
      ...
      timeouts: map['timeouts'] == null
          ? null
          : AgentAgentAliasTimeouts.fromMap(
