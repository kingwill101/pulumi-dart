...
class AgentAgent extends pulumi.CustomResource {
  ...
  AgentAgent(
    ...
    this.guardrailConfigurations = registerOutput<List<AgentAgentGuardrailConfiguration>?>('guardrailConfigurations');
    this.idleSessionTtlInSeconds = registerOutput<int>('idleSessionTtlInSeconds');
    this.instruction = registerOutput<String>('instruction');
    this.memoryConfigurations = registerOutput<List<AgentAgentMemoryConfiguration>>('memoryConfigurations');
    this.prepareAgent = registerOutput<bool>('prepareAgent');
    this.preparedAt = registerOutput<String>('preparedAt');
    this.promptOverrideConfigurations = registerOutput<List<AgentAgentPromptOverrideConfiguration>>('promptOverrideConfigurations');
