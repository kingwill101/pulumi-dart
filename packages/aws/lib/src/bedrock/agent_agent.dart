...
class AgentAgent extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<AgentAgentGuardrailConfiguration>?>
  ...
  late final pulumi.Output<List<AgentAgentMemoryConfiguration>>
  ...
  late final pulumi.Output<List<AgentAgentPromptOverrideConfiguration>>
  ...
  AgentAgent(
    ...
    this.customerEncryptionKeyArn = registerOutput<String?>(
