...
class AgentAgentAliasTimeouts {
  ...
  /// Creates a new [AgentAgentAliasTimeouts].
  ...
  AgentAgentAliasTimeouts({this.create, this.delete, this.update});
  ...
  factory AgentAgentAliasTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentAgentAliasTimeouts(
