...
class AgentDataSourceVectorIngestionConfigurationParsingConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bedrockDataAutomationConfiguration':
          ?bedrockDataAutomationConfiguration == null
          ? null
          : bedrockDataAutomationConfiguration!.toMap(),
      'bedrockFoundationModelConfiguration':
          ?bedrockFoundationModelConfiguration == null
          ? null
          : bedrockFoundationModelConfiguration!.toMap(),
  ...
  factory AgentDataSourceVectorIngestionConfigurationParsingConfiguration.fromMap(
    ...
    return AgentDataSourceVectorIngestionConfigurationParsingConfiguration(
      bedrockDataAutomationConfiguration:
          map['bedrockDataAutomationConfiguration'] == null
          ? null
          : AgentDataSourceVectorIngestionConfigurationParsingConfigurationBedrockDataAutomationConfiguration.fromMap(
              (map['bedrockDataAutomationConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      bedrockFoundationModelConfiguration:
          map['bedrockFoundationModelConfiguration'] == null
          ? null
          : AgentDataSourceVectorIngestionConfigurationParsingConfigurationBedrockFoundationModelConfiguration.fromMap(
              (map['bedrockFoundationModelConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
