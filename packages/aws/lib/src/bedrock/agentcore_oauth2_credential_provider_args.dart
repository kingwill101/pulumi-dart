...
class AgentcoreOauth2CredentialProviderArgs {
  ...
  AgentcoreOauth2CredentialProviderArgs({
    required String credentialProviderVendor,
    String? name,
    AgentcoreOauth2CredentialProviderOauth2ProviderConfig? oauth2ProviderConfig,
    String? region,
  }) :
  ...
  factory AgentcoreOauth2CredentialProviderArgs.fromMap(Map<String, dynamic> map) {
    return AgentcoreOauth2CredentialProviderArgs(
      credentialProviderVendor: map['credentialProviderVendor'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      oauth2ProviderConfig: map['oauth2ProviderConfig'] == null ? null : AgentcoreOauth2CredentialProviderOauth2ProviderConfig.fromMap((map['oauth2ProviderConfig'] as Map).cast<String, dynamic>()),
