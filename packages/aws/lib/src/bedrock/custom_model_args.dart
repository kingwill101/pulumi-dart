...
class CustomModelArgs {
  ...
  CustomModelArgs({
    ...
    CustomModelVpcConfig? vpcConfig,
        ...
        customModelKmsKeyId =
            pulumi.Input.asOptionalInput<String>(customModelKmsKeyId),
        customModelName = pulumi.Input.asInput<String>(customModelName),
        customizationType =
            pulumi.Input.asOptionalInput<String>(customizationType),
        hyperparameters =
            pulumi.Input.asInput<Map<String, String>>(hyperparameters),
        jobName = pulumi.Input.asInput<String>(jobName),
        outputDataConfig =
            pulumi.Input.asInput<CustomModelOutputDataConfig>(outputDataConfig),
        region = pulumi.Input.asOptionalInput<String>(region),
        roleArn = pulumi.Input.asInput<String>(roleArn),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        timeouts = pulumi.Input.asOptionalInput<CustomModelTimeouts>(timeouts),
        trainingDataConfig =
            pulumi.Input.asInput<CustomModelTrainingDataConfig>(
                trainingDataConfig),
        validationDataConfig =
            pulumi.Input.asOptionalInput<CustomModelValidationDataConfig>(
                validationDataConfig),
        vpcConfig =
            pulumi.Input.asOptionalInput<CustomModelVpcConfig>(vpcConfig);
