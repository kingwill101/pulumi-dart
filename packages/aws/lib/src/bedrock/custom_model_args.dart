...
class CustomModelArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobName': jobName,
      'outputDataConfig': pulumi.Input.mapInputValue<CustomModelOutputDataConfig, Map<String, dynamic>>(outputDataConfig, (value) => value.toMap()),
      'region': ?region,
      'roleArn': roleArn,
      'tags': ?tags,
      'timeouts': ?pulumi.Input.mapOptionalInputValue<CustomModelTimeouts, Map<String, dynamic>>(timeouts, (value) => value.toMap()),
      'trainingDataConfig': pulumi.Input.mapInputValue<CustomModelTrainingDataConfig, Map<String, dynamic>>(trainingDataConfig, (value) => value.toMap()),
  ...
  factory CustomModelArgs.fromMap(Map<String, dynamic> map) {
    return CustomModelArgs(
      ...
      customModelKmsKeyId: map['customModelKmsKeyId'] == null ? null : map['customModelKmsKeyId'] as String,
      customModelName: map['customModelName'] as String,
      customizationType: map['customizationType'] == null ? null : map['customizationType'] as String,
      hyperparameters: (map['hyperparameters'] as Map).cast<String, String>(),
      jobName: map['jobName'] as String,
      outputDataConfig: CustomModelOutputDataConfig.fromMap((map['outputDataConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      roleArn: map['roleArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : CustomModelTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
      trainingDataConfig: CustomModelTrainingDataConfig.fromMap((map['trainingDataConfig'] as Map).cast<String, dynamic>()),
      validationDataConfig: map['validationDataConfig'] == null ? null : CustomModelValidationDataConfig.fromMap((map['validationDataConfig'] as Map).cast<String, dynamic>()),
      vpcConfig: map['vpcConfig'] == null ? null : CustomModelVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
