...
class AgentcoreAgentRuntimeEndpointTimeouts {
  ...
  /// Creates a new [AgentcoreAgentRuntimeEndpointTimeouts].
  ...
  factory AgentcoreAgentRuntimeEndpointTimeouts.fromMap(
    Map<String, dynamic> map,
  ) {
    return AgentcoreAgentRuntimeEndpointTimeouts(
