...
class AgentAgentActionGroupTimeouts {
  ...
  /// Creates a new [AgentAgentActionGroupTimeouts].
  ...
  AgentAgentActionGroupTimeouts({this.create, this.update});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'update': ?update};
  }

  factory AgentAgentActionGroupTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentAgentActionGroupTimeouts(
