...
class AgentAgentArgs {
  ...
  AgentAgentArgs({
    ...
    List<AgentAgentGuardrailConfiguration>? guardrailConfigurations,
    int? idleSessionTtlInSeconds,
    String? instruction,
    List<AgentAgentMemoryConfiguration>? memoryConfigurations,
    bool? prepareAgent,
    List<AgentAgentPromptOverrideConfiguration>? promptOverrideConfigurations,
    String? region,
    bool? skipResourceInUseCheck,
    Map<String, String>? tags,
    AgentAgentTimeouts? timeouts,
  }) :
  ...
  factory AgentAgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentAgentArgs(
      agentCollaboration: map['agentCollaboration'] == null ? null : map['agentCollaboration'] as String,
      agentName: map['agentName'] as String,
      agentResourceRoleArn: map['agentResourceRoleArn'] as String,
      customerEncryptionKeyArn: map['customerEncryptionKeyArn'] == null ? null : map['customerEncryptionKeyArn'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      foundationModel: map['foundationModel'] as String,
      guardrailConfigurations: map['guardrailConfigurations'] == null ? null : pulumi.Input.decodeList<AgentAgentGuardrailConfiguration>(map['guardrailConfigurations'], (value) => AgentAgentGuardrailConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      idleSessionTtlInSeconds: map['idleSessionTtlInSeconds'] == null ? null : map['idleSessionTtlInSeconds'] as int,
      instruction: map['instruction'] == null ? null : map['instruction'] as String,
      memoryConfigurations: map['memoryConfigurations'] == null ? null : pulumi.Input.decodeList<AgentAgentMemoryConfiguration>(map['memoryConfigurations'], (value) => AgentAgentMemoryConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      prepareAgent: map['prepareAgent'] == null ? null : map['prepareAgent'] as bool,
      promptOverrideConfigurations: map['promptOverrideConfigurations'] == null ? null : pulumi.Input.decodeList<AgentAgentPromptOverrideConfiguration>(map['promptOverrideConfigurations'], (value) => AgentAgentPromptOverrideConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      skipResourceInUseCheck: map['skipResourceInUseCheck'] == null ? null : map['skipResourceInUseCheck'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : AgentAgentTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
