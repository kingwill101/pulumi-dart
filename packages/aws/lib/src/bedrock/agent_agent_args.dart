...
class AgentAgentArgs {
  ...
  AgentAgentArgs({
    ...
    AgentAgentTimeouts? timeouts,
  }) : agentCollaboration = pulumi.Input.asOptionalInput<String>(
         agentCollaboration,
       ),
       agentName = pulumi.Input.asInput<String>(agentName),
       agentResourceRoleArn = pulumi.Input.asInput<String>(
       ...
       guardrailConfigurations =
           pulumi.Input.asOptionalInput<List<AgentAgentGuardrailConfiguration>>(
             guardrailConfigurations,
           ),
