...
class AgentAgentArgs {
  ...
  AgentAgentArgs({
    ...
    AgentAgentTimeouts? timeouts,
            ...
            pulumi.Input.asOptionalInput<String>(agentCollaboration),
        agentName = pulumi.Input.asInput<String>(agentName),
        agentResourceRoleArn =
            pulumi.Input.asInput<String>(agentResourceRoleArn),
        ...
        guardrailConfigurations = pulumi.Input.asOptionalInput<
            List<AgentAgentGuardrailConfiguration>>(guardrailConfigurations),
        idleSessionTtlInSeconds =
            pulumi.Input.asOptionalInput<int>(idleSessionTtlInSeconds),
        instruction = pulumi.Input.asOptionalInput<String>(instruction),
        memoryConfigurations =
            pulumi.Input.asOptionalInput<List<AgentAgentMemoryConfiguration>>(
                memoryConfigurations),
        prepareAgent = pulumi.Input.asOptionalInput<bool>(prepareAgent),
        promptOverrideConfigurations = pulumi.Input.asOptionalInput<
  ...
  Map<String, dynamic> toMap() {
    ...
    if (guardrailConfigurationsValue != null) {
      map['guardrailConfigurations'] = pulumi.Input.mapOptionalInputValue<
              List<AgentAgentGuardrailConfiguration>,
              List<Map<String, dynamic>>>(
          guardrailConfigurationsValue,
          (value) => pulumi.Input.encodeList<AgentAgentGuardrailConfiguration,
    ...
    if (memoryConfigurationsValue != null) {
      map['memoryConfigurations'] = pulumi.Input.mapOptionalInputValue<
              List<AgentAgentMemoryConfiguration>, List<Map<String, dynamic>>>(
          memoryConfigurationsValue,
          (value) => pulumi.Input.encodeList<AgentAgentMemoryConfiguration,
              Map<String, dynamic>>(value, (value) => value.toMap()));
    }
    ...
    if (promptOverrideConfigurationsValue != null) {
      map['promptOverrideConfigurations'] = pulumi.Input.mapOptionalInputValue<
              List<AgentAgentPromptOverrideConfiguration>,
              List<Map<String, dynamic>>>(
    ...
    if (timeoutsValue != null) {
      map['timeouts'] = pulumi.Input.mapOptionalInputValue<AgentAgentTimeouts,
  ...
  factory AgentAgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentAgentArgs(
      agentCollaboration: map['agentCollaboration'] == null
          ? null
          : map['agentCollaboration'] as String,
      ...
      idleSessionTtlInSeconds: map['idleSessionTtlInSeconds'] == null
          ? null
          : map['idleSessionTtlInSeconds'] as int,
      instruction:
          map['instruction'] == null ? null : map['instruction'] as String,
      memoryConfigurations: map['memoryConfigurations'] == null
          ? null
      ...
      promptOverrideConfigurations: map['promptOverrideConfigurations'] == null
          ? null
