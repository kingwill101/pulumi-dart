...
class AgentPromptArgs {
  ...
  AgentPromptArgs({
    ...
    List<AgentPromptVariant>? variants,
            ...
            pulumi.Input.asOptionalInput<String>(customerEncryptionKeyArn),
        ...
        variants =
            pulumi.Input.asOptionalInput<List<AgentPromptVariant>>(variants);
  ...
  factory AgentPromptArgs.fromMap(Map<String, dynamic> map) {
    return AgentPromptArgs(
      customerEncryptionKeyArn: map['customerEncryptionKeyArn'] == null
          ? null
          : map['customerEncryptionKeyArn'] as String,
      defaultVariant: map['defaultVariant'] == null
          ? null
          : map['defaultVariant'] as String,
      description:
