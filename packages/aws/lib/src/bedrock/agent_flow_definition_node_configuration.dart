...
class AgentFlowDefinitionNodeConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inlineCode': ?inlineCode == null ? null : inlineCode!.toMap(),
      'input': ?input,
      'iterator': ?iterator,
      'knowledgeBase': ?knowledgeBase == null ? null : knowledgeBase!.toMap(),
      'lambdaFunction': ?lambdaFunction == null ? null : lambdaFunction!.toMap(),
      'lex': ?lex == null ? null : lex!.toMap(),
      'output': ?output,
      'prompt': ?prompt == null ? null : prompt!.toMap(),
      'retrieval': ?retrieval == null ? null : retrieval!.toMap(),
  ...
  factory AgentFlowDefinitionNodeConfiguration.fromMap(Map<String, dynamic> map) {
    return AgentFlowDefinitionNodeConfiguration(
      agent: map['agent'] == null ? null : AgentFlowDefinitionNodeConfigurationAgent.fromMap((map['agent'] as Map).cast<String, dynamic>()),
      collector: map['collector'] == null ? null : (map['collector'] as Map).cast<String, dynamic>(),
      condition: map['condition'] == null ? null : AgentFlowDefinitionNodeConfigurationCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      inlineCode: map['inlineCode'] == null ? null : AgentFlowDefinitionNodeConfigurationInlineCode.fromMap((map['inlineCode'] as Map).cast<String, dynamic>()),
      input: map['input'] == null ? null : (map['input'] as Map).cast<String, dynamic>(),
      iterator: map['iterator'] == null ? null : (map['iterator'] as Map).cast<String, dynamic>(),
      knowledgeBase: map['knowledgeBase'] == null ? null : AgentFlowDefinitionNodeConfigurationKnowledgeBase.fromMap((map['knowledgeBase'] as Map).cast<String, dynamic>()),
      lambdaFunction: map['lambdaFunction'] == null ? null : AgentFlowDefinitionNodeConfigurationLambdaFunction.fromMap((map['lambdaFunction'] as Map).cast<String, dynamic>()),
      lex: map['lex'] == null ? null : AgentFlowDefinitionNodeConfigurationLex.fromMap((map['lex'] as Map).cast<String, dynamic>()),
      output: map['output'] == null ? null : (map['output'] as Map).cast<String, dynamic>(),
      prompt: map['prompt'] == null ? null : AgentFlowDefinitionNodeConfigurationPrompt.fromMap((map['prompt'] as Map).cast<String, dynamic>()),
      retrieval: map['retrieval'] == null ? null : AgentFlowDefinitionNodeConfigurationRetrieval.fromMap((map['retrieval'] as Map).cast<String, dynamic>()),
      storage: map['storage'] == null ? null : AgentFlowDefinitionNodeConfigurationStorage.fromMap((map['storage'] as Map).cast<String, dynamic>()),
    );
  }
}
