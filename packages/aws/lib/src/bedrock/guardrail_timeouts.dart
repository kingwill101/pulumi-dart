...
class GuardrailTimeouts {
  ...
  /// Creates a new [GuardrailTimeouts].
  ...
  GuardrailTimeouts({this.create, this.delete, this.update});
  ...
  factory GuardrailTimeouts.fromMap(Map<String, dynamic> map) {
    return GuardrailTimeouts(
