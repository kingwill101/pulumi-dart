...
class AgentAgentPromptOverrideConfigurationPromptConfiguration {
  ...
  final List<AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration> inferenceConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inferenceConfigurations': pulumi.Input.encodeList<AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration, Map<String, dynamic>>(inferenceConfigurations, (value) => value.toMap()),
  ...
  factory AgentAgentPromptOverrideConfigurationPromptConfiguration.fromMap(Map<String, dynamic> map) {
    return AgentAgentPromptOverrideConfigurationPromptConfiguration(
      ...
      inferenceConfigurations: pulumi.Input.decodeList<AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration>(map['inferenceConfigurations'], (value) => AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration.fromMap((value as Map).cast<String, dynamic>())),
