...
class GuardrailArgs {
  ...
  GuardrailArgs({
    ...
    GuardrailWordPolicyConfig? wordPolicyConfig,
  }) : blockedInputMessaging = pulumi.Input.asInput<String>(
         blockedInputMessaging,
       ),
       blockedOutputsMessaging = pulumi.Input.asInput<String>(
       ...
       wordPolicyConfig = pulumi
           .Input.asOptionalInput<GuardrailWordPolicyConfig>(wordPolicyConfig);
