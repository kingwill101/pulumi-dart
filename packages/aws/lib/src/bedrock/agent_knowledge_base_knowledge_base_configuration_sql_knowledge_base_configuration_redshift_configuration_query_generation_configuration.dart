...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfiguration {
  ...
  final AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContext? generationContext;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'generationContext': ?generationContext == null ? null : generationContext!.toMap(),
    };
  }
  ...
  factory AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfiguration.fromMap(Map<String, dynamic> map) {
    return AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfiguration(
      executionTimeoutSeconds: map['executionTimeoutSeconds'] == null ? null : map['executionTimeoutSeconds'] as int,
      generationContext: map['generationContext'] == null ? null : AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContext.fromMap((map['generationContext'] as Map).cast<String, dynamic>()),
    );
  }
}
