...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfig {
  ...
  final List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfigOauthDiscovery>? oauthDiscoveries;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oauthDiscoveries': ?oauthDiscoveries == null ? null : pulumi.Input.encodeList<AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfigOauthDiscovery, Map<String, dynamic>>(oauthDiscoveries!, (value) => value.toMap()),
    };
  }
