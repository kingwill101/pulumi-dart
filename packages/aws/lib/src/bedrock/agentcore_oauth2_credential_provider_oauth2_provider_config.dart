...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customOauth2ProviderConfig': ?customOauth2ProviderConfig == null
          ? null
          : customOauth2ProviderConfig!.toMap(),
      'githubOauth2ProviderConfig': ?githubOauth2ProviderConfig == null
          ? null
          : githubOauth2ProviderConfig!.toMap(),
      'googleOauth2ProviderConfig': ?googleOauth2ProviderConfig == null
          ? null
          : googleOauth2ProviderConfig!.toMap(),
      'microsoftOauth2ProviderConfig': ?microsoftOauth2ProviderConfig == null
          ? null
          : microsoftOauth2ProviderConfig!.toMap(),
      'salesforceOauth2ProviderConfig': ?salesforceOauth2ProviderConfig == null
          ? null
          : salesforceOauth2ProviderConfig!.toMap(),
      'slackOauth2ProviderConfig': ?slackOauth2ProviderConfig == null
          ? null
          : slackOauth2ProviderConfig!.toMap(),
    };
  }
  ...
  factory AgentcoreOauth2CredentialProviderOauth2ProviderConfig.fromMap(
    ...
    return AgentcoreOauth2CredentialProviderOauth2ProviderConfig(
      customOauth2ProviderConfig: map['customOauth2ProviderConfig'] == null
          ? null
          : AgentcoreOauth2CredentialProviderOauth2ProviderConfigCustomOauth2ProviderConfig.fromMap(
              (map['customOauth2ProviderConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      githubOauth2ProviderConfig: map['githubOauth2ProviderConfig'] == null
          ? null
          : AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfig.fromMap(
              (map['githubOauth2ProviderConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      googleOauth2ProviderConfig: map['googleOauth2ProviderConfig'] == null
          ? null
          : AgentcoreOauth2CredentialProviderOauth2ProviderConfigGoogleOauth2ProviderConfig.fromMap(
              (map['googleOauth2ProviderConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      microsoftOauth2ProviderConfig:
          map['microsoftOauth2ProviderConfig'] == null
          ? null
          : AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfig.fromMap(
              (map['microsoftOauth2ProviderConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      salesforceOauth2ProviderConfig:
          map['salesforceOauth2ProviderConfig'] == null
          ? null
          : AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig.fromMap(
              (map['salesforceOauth2ProviderConfig'] as Map)
                  .cast<String, dynamic>(),
            ),
      slackOauth2ProviderConfig: map['slackOauth2ProviderConfig'] == null
          ? null
          : AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig.fromMap(
              (map['slackOauth2ProviderConfig'] as Map).cast<String, dynamic>(),
            ),
    );
  }
}
