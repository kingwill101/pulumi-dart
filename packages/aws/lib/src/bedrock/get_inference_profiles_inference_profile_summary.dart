...
class GetInferenceProfilesInferenceProfileSummary {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'models': pulumi.Input.encodeList<GetInferenceProfilesInferenceProfileSummaryModel, Map<String, dynamic>>(models, (value) => value.toMap()),
      'status': status,
      'type': type,
      'updatedAt': updatedAt,
    };
  ...
  factory GetInferenceProfilesInferenceProfileSummary.fromMap(Map<String, dynamic> map) {
    return GetInferenceProfilesInferenceProfileSummary(
      ...
      models: pulumi.Input.decodeList<GetInferenceProfilesInferenceProfileSummaryModel>(map['models'], (value) => GetInferenceProfilesInferenceProfileSummaryModel.fromMap((value as Map).cast<String, dynamic>())),
