...
class GraphQLApiArgs {
  ...
  GraphQLApiArgs({
    List<GraphQLApiAdditionalAuthenticationProvider>? additionalAuthenticationProviders,
    String? apiType,
  ...
  factory GraphQLApiArgs.fromMap(Map<String, dynamic> map) {
    return GraphQLApiArgs(
      additionalAuthenticationProviders: map['additionalAuthenticationProviders'] == null ? null : pulumi.Input.decodeList<GraphQLApiAdditionalAuthenticationProvider>(map['additionalAuthenticationProviders'], (value) => GraphQLApiAdditionalAuthenticationProvider.fromMap((value as Map).cast<String, dynamic>())),
      apiType: map['apiType'] == null ? null : map['apiType'] as String,
      authenticationType: map['authenticationType'] as String,
      enhancedMetricsConfig: map['enhancedMetricsConfig'] == null ? null : GraphQLApiEnhancedMetricsConfig.fromMap((map['enhancedMetricsConfig'] as Map).cast<String, dynamic>()),
      introspectionConfig: map['introspectionConfig'] == null ? null : map['introspectionConfig'] as String,
      lambdaAuthorizerConfig: map['lambdaAuthorizerConfig'] == null ? null : GraphQLApiLambdaAuthorizerConfig.fromMap((map['lambdaAuthorizerConfig'] as Map).cast<String, dynamic>()),
      logConfig: map['logConfig'] == null ? null : GraphQLApiLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      mergedApiExecutionRoleArn: map['mergedApiExecutionRoleArn'] == null ? null : map['mergedApiExecutionRoleArn'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      openidConnectConfig: map['openidConnectConfig'] == null ? null : GraphQLApiOpenidConnectConfig.fromMap((map['openidConnectConfig'] as Map).cast<String, dynamic>()),
      ...
      userPoolConfig: map['userPoolConfig'] == null ? null : GraphQLApiUserPoolConfig.fromMap((map['userPoolConfig'] as Map).cast<String, dynamic>()),
