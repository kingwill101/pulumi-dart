...
class GraphQLApiArgs {
    ...
    bool? xrayEnabled,
        ...
        enhancedMetricsConfig =
            pulumi.Input.asOptionalInput<GraphQLApiEnhancedMetricsConfig>(
                enhancedMetricsConfig),
        introspectionConfig =
            pulumi.Input.asOptionalInput<String>(introspectionConfig),
        lambdaAuthorizerConfig =
            pulumi.Input.asOptionalInput<GraphQLApiLambdaAuthorizerConfig>(
                lambdaAuthorizerConfig),
        logConfig =
            pulumi.Input.asOptionalInput<GraphQLApiLogConfig>(logConfig),
        mergedApiExecutionRoleArn =
            pulumi.Input.asOptionalInput<String>(mergedApiExecutionRoleArn),
        ...
        resolverCountLimit =
            pulumi.Input.asOptionalInput<int>(resolverCountLimit),
  ...
  factory GraphQLApiArgs.fromMap(Map<String, dynamic> map) {
    return GraphQLApiArgs(
      ...
      queryDepthLimit:
          map['queryDepthLimit'] == null ? null : map['queryDepthLimit'] as int,
      ...
      xrayEnabled:
          map['xrayEnabled'] == null ? null : map['xrayEnabled'] as bool,
    );
  }
}
