...
class DataSourceArgs {
  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      ...
      dynamodbConfig: map['dynamodbConfig'] == null ? null : DataSourceDynamodbConfig.fromMap((map['dynamodbConfig'] as Map).cast<String, dynamic>()),
      elasticsearchConfig: map['elasticsearchConfig'] == null ? null : DataSourceElasticsearchConfig.fromMap((map['elasticsearchConfig'] as Map).cast<String, dynamic>()),
      eventBridgeConfig: map['eventBridgeConfig'] == null ? null : DataSourceEventBridgeConfig.fromMap((map['eventBridgeConfig'] as Map).cast<String, dynamic>()),
      httpConfig: map['httpConfig'] == null ? null : DataSourceHttpConfig.fromMap((map['httpConfig'] as Map).cast<String, dynamic>()),
      lambdaConfig: map['lambdaConfig'] == null ? null : DataSourceLambdaConfig.fromMap((map['lambdaConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      opensearchserviceConfig: map['opensearchserviceConfig'] == null ? null : DataSourceOpensearchserviceConfig.fromMap((map['opensearchserviceConfig'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      relationalDatabaseConfig: map['relationalDatabaseConfig'] == null ? null : DataSourceRelationalDatabaseConfig.fromMap((map['relationalDatabaseConfig'] as Map).cast<String, dynamic>()),
