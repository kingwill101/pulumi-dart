...
class DataSource extends pulumi.CustomResource {
  ...
  DataSource(
    ...
    this.dynamodbConfig = registerOutput<DataSourceDynamodbConfig?>(
      'dynamodbConfig',
    );
    this.elasticsearchConfig = registerOutput<DataSourceElasticsearchConfig?>(
      'elasticsearchConfig',
    );
    this.eventBridgeConfig = registerOutput<DataSourceEventBridgeConfig?>(
      'eventBridgeConfig',
    );
