...
class SourceApiAssociationArgs {
  ...
  SourceApiAssociationArgs({
    ...
    String? region,
    String? sourceApiArn,
    List<SourceApiAssociationSourceApiAssociationConfig>? sourceApiAssociationConfigs,
    String? sourceApiId,
  ...
  factory SourceApiAssociationArgs.fromMap(Map<String, dynamic> map) {
    return SourceApiAssociationArgs(
      ...
      mergedApiArn: map['mergedApiArn'] == null ? null : map['mergedApiArn'] as String,
      mergedApiId: map['mergedApiId'] == null ? null : map['mergedApiId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sourceApiArn: map['sourceApiArn'] == null ? null : map['sourceApiArn'] as String,
      sourceApiAssociationConfigs: map['sourceApiAssociationConfigs'] == null ? null : pulumi.Input.decodeList<SourceApiAssociationSourceApiAssociationConfig>(map['sourceApiAssociationConfigs'], (value) => SourceApiAssociationSourceApiAssociationConfig.fromMap((value as Map).cast<String, dynamic>())),
      sourceApiId: map['sourceApiId'] == null ? null : map['sourceApiId'] as String,
      timeouts: map['timeouts'] == null ? null : SourceApiAssociationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
