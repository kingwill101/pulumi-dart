...
class SourceApiAssociationArgs {
  ...
  factory SourceApiAssociationArgs.fromMap(Map<String, dynamic> map) {
    return SourceApiAssociationArgs(
      ...
      mergedApiArn: map['mergedApiArn'] == null
          ? null
          : map['mergedApiArn'] as String,
      mergedApiId: map['mergedApiId'] == null
          ? null
          : map['mergedApiId'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sourceApiArn: map['sourceApiArn'] == null
          ? null
          : map['sourceApiArn'] as String,
      ...
      sourceApiId: map['sourceApiId'] == null
          ? null
          : map['sourceApiId'] as String,
