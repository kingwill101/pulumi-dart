...
class GraphQLApi extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GraphQLApiAdditionalAuthenticationProvider>?>
  additionalAuthenticationProviders;
  ...
  late final pulumi.Output<GraphQLApiEnhancedMetricsConfig?>
  ...
  late final pulumi.Output<GraphQLApiLambdaAuthorizerConfig?>
  lambdaAuthorizerConfig;
  ...
  GraphQLApi(
    ...
    this.mergedApiExecutionRoleArn = registerOutput<String?>(
      'mergedApiExecutionRoleArn',
    );
    this.name = registerOutput<String>('name');
    this.openidConnectConfig = registerOutput<GraphQLApiOpenidConnectConfig?>(
      'openidConnectConfig',
    );
    ...
    this.userPoolConfig = registerOutput<GraphQLApiUserPoolConfig?>(
      'userPoolConfig',
    );
