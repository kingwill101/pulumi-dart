...
class GraphQLApi extends pulumi.CustomResource {
  ...
  GraphQLApi(
    ...
    this.additionalAuthenticationProviders = registerOutput<List<GraphQLApiAdditionalAuthenticationProvider>?>('additionalAuthenticationProviders');
    this.apiType = registerOutput<String?>('apiType');
    this.arn = registerOutput<String>('arn');
    this.authenticationType = registerOutput<String>('authenticationType');
    this.enhancedMetricsConfig = registerOutput<GraphQLApiEnhancedMetricsConfig?>('enhancedMetricsConfig');
    this.introspectionConfig = registerOutput<String?>('introspectionConfig');
    this.lambdaAuthorizerConfig = registerOutput<GraphQLApiLambdaAuthorizerConfig?>('lambdaAuthorizerConfig');
    this.logConfig = registerOutput<GraphQLApiLogConfig?>('logConfig');
    this.mergedApiExecutionRoleArn = registerOutput<String?>('mergedApiExecutionRoleArn');
    this.name = registerOutput<String>('name');
    this.openidConnectConfig = registerOutput<GraphQLApiOpenidConnectConfig?>('openidConnectConfig');
    ...
    this.userPoolConfig = registerOutput<GraphQLApiUserPoolConfig?>('userPoolConfig');
