  ...
  FunctionArgs({
    ...
    FunctionSyncConfig? syncConfig,
        ...
        requestMappingTemplate =
            pulumi.Input.asOptionalInput<String>(requestMappingTemplate),
        responseMappingTemplate =
            pulumi.Input.asOptionalInput<String>(responseMappingTemplate),
        runtime = pulumi.Input.asOptionalInput<FunctionRuntime>(runtime),
        syncConfig =
            pulumi.Input.asOptionalInput<FunctionSyncConfig>(syncConfig);
