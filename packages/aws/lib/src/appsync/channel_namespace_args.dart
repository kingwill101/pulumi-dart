...
class ChannelNamespaceArgs {
  ...
  ChannelNamespaceArgs({
    ...
    String? codeHandlers,
    ChannelNamespaceHandlerConfigs? handlerConfigs,
    String? name,
    List<ChannelNamespacePublishAuthMode>? publishAuthModes,
    String? region,
    List<ChannelNamespaceSubscribeAuthMode>? subscribeAuthModes,
  ...
  factory ChannelNamespaceArgs.fromMap(Map<String, dynamic> map) {
    return ChannelNamespaceArgs(
      ...
      codeHandlers: map['codeHandlers'] == null ? null : map['codeHandlers'] as String,
      handlerConfigs: map['handlerConfigs'] == null ? null : ChannelNamespaceHandlerConfigs.fromMap((map['handlerConfigs'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      publishAuthModes: map['publishAuthModes'] == null ? null : pulumi.Input.decodeList<ChannelNamespacePublishAuthMode>(map['publishAuthModes'], (value) => ChannelNamespacePublishAuthMode.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      subscribeAuthModes: map['subscribeAuthModes'] == null ? null : pulumi.Input.decodeList<ChannelNamespaceSubscribeAuthMode>(map['subscribeAuthModes'], (value) => ChannelNamespaceSubscribeAuthMode.fromMap((value as Map).cast<String, dynamic>())),
