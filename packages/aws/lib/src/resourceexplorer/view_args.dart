...
class ViewArgs {
  ...
  factory ViewArgs.fromMap(Map<String, dynamic> map) {
    return ViewArgs(
      defaultView: map['defaultView'] == null ? null : map['defaultView'] as bool,
      filters: map['filters'] == null ? null : ViewFilters.fromMap((map['filters'] as Map).cast<String, dynamic>()),
      includedProperties: map['includedProperties'] == null ? null : pulumi.Input.decodeList<ViewIncludedProperty>(map['includedProperties'], (value) => ViewIncludedProperty.fromMap((value as Map).cast<String, dynamic>())),
