...
class GameServerGroupArgs {
  ...
  factory GameServerGroupArgs.fromMap(Map<String, dynamic> map) {
    return GameServerGroupArgs(
      autoScalingPolicy: map['autoScalingPolicy'] == null ? null : GameServerGroupAutoScalingPolicy.fromMap((map['autoScalingPolicy'] as Map).cast<String, dynamic>()),
      balancingStrategy: map['balancingStrategy'] == null ? null : map['balancingStrategy'] as String,
      gameServerGroupName: map['gameServerGroupName'] as String,
      gameServerProtectionPolicy: map['gameServerProtectionPolicy'] == null ? null : map['gameServerProtectionPolicy'] as String,
      instanceDefinitions: pulumi.Input.decodeList<GameServerGroupInstanceDefinition>(map['instanceDefinitions'], (value) => GameServerGroupInstanceDefinition.fromMap((value as Map).cast<String, dynamic>())),
      launchTemplate: GameServerGroupLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>()),
      maxSize: map['maxSize'] as int,
      minSize: map['minSize'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      roleArn: map['roleArn'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      vpcSubnets: map['vpcSubnets'] == null ? null : (map['vpcSubnets'] as List).cast<String>(),
    );
  }
}
