  ...
  GameServerGroupArgs({
    ...
    List<String>? vpcSubnets,
            ...
            pulumi.Input.asOptionalInput<GameServerGroupAutoScalingPolicy>(
                autoScalingPolicy),
        balancingStrategy =
            pulumi.Input.asOptionalInput<String>(balancingStrategy),
        gameServerGroupName = pulumi.Input.asInput<String>(gameServerGroupName),
        gameServerProtectionPolicy =
            pulumi.Input.asOptionalInput<String>(gameServerProtectionPolicy),
        instanceDefinitions =
            pulumi.Input.asInput<List<GameServerGroupInstanceDefinition>>(
                instanceDefinitions),
        launchTemplate =
            pulumi.Input.asInput<GameServerGroupLaunchTemplate>(launchTemplate),
