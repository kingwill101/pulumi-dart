...
class GameServerGroup extends pulumi.CustomResource {
  ...
  GameServerGroup(
    ...
    this.autoScalingPolicy = registerOutput<GameServerGroupAutoScalingPolicy?>(
      'autoScalingPolicy',
    );
    ...
    this.gameServerProtectionPolicy = registerOutput<String>(
    ...
    this.launchTemplate = registerOutput<GameServerGroupLaunchTemplate>(
      'launchTemplate',
    );
