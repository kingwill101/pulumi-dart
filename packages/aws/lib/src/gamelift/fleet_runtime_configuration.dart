...
class FleetRuntimeConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serverProcesses': ?serverProcesses == null ? null : pulumi.Input.encodeList<FleetRuntimeConfigurationServerProcess, Map<String, dynamic>>(serverProcesses!, (value) => value.toMap()),
    };
  }

  factory FleetRuntimeConfiguration.fromMap(Map<String, dynamic> map) {
    return FleetRuntimeConfiguration(
      gameSessionActivationTimeoutSeconds: map['gameSessionActivationTimeoutSeconds'] == null ? null : map['gameSessionActivationTimeoutSeconds'] as int,
      maxConcurrentGameSessionActivations: map['maxConcurrentGameSessionActivations'] == null ? null : map['maxConcurrentGameSessionActivations'] as int,
      serverProcesses: map['serverProcesses'] == null ? null : pulumi.Input.decodeList<FleetRuntimeConfigurationServerProcess>(map['serverProcesses'], (value) => FleetRuntimeConfigurationServerProcess.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
