...
class FleetArgs {
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      certificateConfiguration: map['certificateConfiguration'] == null ? null : FleetCertificateConfiguration.fromMap((map['certificateConfiguration'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      ec2InboundPermissions: map['ec2InboundPermissions'] == null ? null : pulumi.Input.decodeList<FleetEc2InboundPermission>(map['ec2InboundPermissions'], (value) => FleetEc2InboundPermission.fromMap((value as Map).cast<String, dynamic>())),
      ec2InstanceType: map['ec2InstanceType'] as String,
      fleetType: map['fleetType'] == null ? null : map['fleetType'] as String,
      instanceRoleArn: map['instanceRoleArn'] == null ? null : map['instanceRoleArn'] as String,
      metricGroups: map['metricGroups'] == null ? null : (map['metricGroups'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      newGameSessionProtectionPolicy: map['newGameSessionProtectionPolicy'] == null ? null : map['newGameSessionProtectionPolicy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      resourceCreationLimitPolicy: map['resourceCreationLimitPolicy'] == null ? null : FleetResourceCreationLimitPolicy.fromMap((map['resourceCreationLimitPolicy'] as Map).cast<String, dynamic>()),
      runtimeConfiguration: map['runtimeConfiguration'] == null ? null : FleetRuntimeConfiguration.fromMap((map['runtimeConfiguration'] as Map).cast<String, dynamic>()),
