...
class GameSessionQueueArgs {
  ...
  factory GameSessionQueueArgs.fromMap(Map<String, dynamic> map) {
    return GameSessionQueueArgs(
      customEventData: map['customEventData'] == null ? null : map['customEventData'] as String,
      destinations: map['destinations'] == null ? null : (map['destinations'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      notificationTarget: map['notificationTarget'] == null ? null : map['notificationTarget'] as String,
      playerLatencyPolicies: map['playerLatencyPolicies'] == null ? null : pulumi.Input.decodeList<GameSessionQueuePlayerLatencyPolicy>(map['playerLatencyPolicies'], (value) => GameSessionQueuePlayerLatencyPolicy.fromMap((value as Map).cast<String, dynamic>())),
