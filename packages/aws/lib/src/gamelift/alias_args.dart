...
class AliasArgs {
  ...
  AliasArgs({
    ...
    Map<String, String>? tags,
        ...
        routingStrategy =
            pulumi.Input.asInput<AliasRoutingStrategy>(routingStrategy),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['routingStrategy'] =
        pulumi.Input.mapInputValue<AliasRoutingStrategy, Map<String, dynamic>>(
  ...
  factory AliasArgs.fromMap(Map<String, dynamic> map) {
    return AliasArgs(
      ...
      routingStrategy: AliasRoutingStrategy.fromMap(
