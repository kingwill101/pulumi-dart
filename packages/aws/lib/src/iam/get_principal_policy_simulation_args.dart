...
class GetPrincipalPolicySimulationArgs {
  ...
  GetPrincipalPolicySimulationArgs({
    ...
    String? resourcePolicyJson,
       ...
       resourceHandlingOption = pulumi.Input.asOptionalInput<String>(
         resourceHandlingOption,
       ),
       resourceOwnerAccountId = pulumi.Input.asOptionalInput<String>(
         resourceOwnerAccountId,
       ),
       resourcePolicyJson = pulumi.Input.asOptionalInput<String>(
         resourcePolicyJson,
       );
