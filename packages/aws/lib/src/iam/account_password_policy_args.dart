...
class AccountPasswordPolicyArgs {
  ...
  AccountPasswordPolicyArgs({
    ...
    bool? requireUppercaseCharacters,
  }) : allowUsersToChangePassword = pulumi.Input.asOptionalInput<bool>(
       ...
       minimumPasswordLength = pulumi.Input.asOptionalInput<int>(
         minimumPasswordLength,
       ),
       passwordReusePrevention = pulumi.Input.asOptionalInput<int>(
         passwordReusePrevention,
       ),
       requireLowercaseCharacters = pulumi.Input.asOptionalInput<bool>(
       ...
       requireUppercaseCharacters = pulumi.Input.asOptionalInput<bool>(
  ...
  factory AccountPasswordPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AccountPasswordPolicyArgs(
      ...
      maxPasswordAge: map['maxPasswordAge'] == null
          ? null
          : map['maxPasswordAge'] as int,
