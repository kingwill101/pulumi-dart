...
class GetPolicyDocumentArgs {
  ...
  GetPolicyDocumentArgs({
    String? overrideJson,
    List<String>? overridePolicyDocuments,
    String? policyId,
    String? sourceJson,
    List<String>? sourcePolicyDocuments,
    ...
    String? version,
        ...
        overridePolicyDocuments =
            pulumi.Input.asOptionalInput<List<String>>(overridePolicyDocuments),
        policyId = pulumi.Input.asOptionalInput<String>(policyId),
        sourceJson = pulumi.Input.asOptionalInput<String>(sourceJson),
        sourcePolicyDocuments =
            pulumi.Input.asOptionalInput<List<String>>(sourcePolicyDocuments),
        statements =
