...
class AccountPasswordPolicy extends pulumi.CustomResource {
  ...
  AccountPasswordPolicy(
    ...
    this.allowUsersToChangePassword = registerOutput<bool?>(
    ...
    this.passwordReusePrevention = registerOutput<int>(
      'passwordReusePrevention',
    );
    this.requireLowercaseCharacters = registerOutput<bool>(
      'requireLowercaseCharacters',
    );
    this.requireNumbers = registerOutput<bool>('requireNumbers');
    this.requireSymbols = registerOutput<bool>('requireSymbols');
    this.requireUppercaseCharacters = registerOutput<bool>(
