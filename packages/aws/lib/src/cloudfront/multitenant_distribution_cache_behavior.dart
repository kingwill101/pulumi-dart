...
class MultitenantDistributionCacheBehavior {
  ...
  final List<MultitenantDistributionCacheBehaviorFunctionAssociation>? functionAssociations;
  /// Configuration block for Lambda@Edge associations. See Lambda Function Association below.
  final List<MultitenantDistributionCacheBehaviorLambdaFunctionAssociation>? lambdaFunctionAssociations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'functionAssociations': ?functionAssociations == null ? null : pulumi.Input.encodeList<MultitenantDistributionCacheBehaviorFunctionAssociation, Map<String, dynamic>>(functionAssociations!, (value) => value.toMap()),
      'lambdaFunctionAssociations': ?lambdaFunctionAssociations == null ? null : pulumi.Input.encodeList<MultitenantDistributionCacheBehaviorLambdaFunctionAssociation, Map<String, dynamic>>(lambdaFunctionAssociations!, (value) => value.toMap()),
  ...
  factory MultitenantDistributionCacheBehavior.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionCacheBehavior(
      allowedMethods: MultitenantDistributionCacheBehaviorAllowedMethods.fromMap((map['allowedMethods'] as Map).cast<String, dynamic>()),
      ...
      functionAssociations: map['functionAssociations'] == null ? null : pulumi.Input.decodeList<MultitenantDistributionCacheBehaviorFunctionAssociation>(map['functionAssociations'], (value) => MultitenantDistributionCacheBehaviorFunctionAssociation.fromMap((value as Map).cast<String, dynamic>())),
      lambdaFunctionAssociations: map['lambdaFunctionAssociations'] == null ? null : pulumi.Input.decodeList<MultitenantDistributionCacheBehaviorLambdaFunctionAssociation>(map['lambdaFunctionAssociations'], (value) => MultitenantDistributionCacheBehaviorLambdaFunctionAssociation.fromMap((value as Map).cast<String, dynamic>())),
      ...
      trustedKeyGroups: map['trustedKeyGroups'] == null ? null : MultitenantDistributionCacheBehaviorTrustedKeyGroups.fromMap((map['trustedKeyGroups'] as Map).cast<String, dynamic>()),
