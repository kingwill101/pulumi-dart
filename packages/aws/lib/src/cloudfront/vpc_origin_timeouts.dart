...
class VpcOriginTimeouts {
  ...
  /// Creates a new [VpcOriginTimeouts].
  ...
  VpcOriginTimeouts({this.create, this.delete, this.update});
  ...
  factory VpcOriginTimeouts.fromMap(Map<String, dynamic> map) {
    return VpcOriginTimeouts(
