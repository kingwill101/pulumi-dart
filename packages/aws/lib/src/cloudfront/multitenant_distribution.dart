...
class MultitenantDistribution extends pulumi.CustomResource {
  ...
  MultitenantDistribution(
    ...
    this.inProgressInvalidationBatches = registerOutput<int>(
    ...
    this.origins = registerOutput<List<MultitenantDistributionOrigin>?>(
      'origins',
    );
    this.restrictions = registerOutput<MultitenantDistributionRestrictions?>(
      'restrictions',
    );
    this.status = registerOutput<String>('status');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.tenantConfig = registerOutput<MultitenantDistributionTenantConfig>(
      'tenantConfig',
    );
    this.timeouts = registerOutput<MultitenantDistributionTimeouts?>(
      'timeouts',
    );
