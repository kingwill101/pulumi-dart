...
class DistributionOrigin {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customHeaders': ?customHeaders == null ? null : pulumi.Input.encodeList<DistributionOriginCustomHeader, Map<String, dynamic>>(customHeaders!, (value) => value.toMap()),
      ...
      'vpcOriginConfig': ?vpcOriginConfig == null ? null : vpcOriginConfig!.toMap(),
    };
  }
  ...
  factory DistributionOrigin.fromMap(Map<String, dynamic> map) {
    return DistributionOrigin(
      ...
      customHeaders: map['customHeaders'] == null ? null : pulumi.Input.decodeList<DistributionOriginCustomHeader>(map['customHeaders'], (value) => DistributionOriginCustomHeader.fromMap((value as Map).cast<String, dynamic>())),
      customOriginConfig: map['customOriginConfig'] == null ? null : DistributionOriginCustomOriginConfig.fromMap((map['customOriginConfig'] as Map).cast<String, dynamic>()),
      ...
      originShield: map['originShield'] == null ? null : DistributionOriginOriginShield.fromMap((map['originShield'] as Map).cast<String, dynamic>()),
      responseCompletionTimeout: map['responseCompletionTimeout'] == null ? null : map['responseCompletionTimeout'] as int,
      s3OriginConfig: map['s3OriginConfig'] == null ? null : DistributionOriginS3OriginConfig.fromMap((map['s3OriginConfig'] as Map).cast<String, dynamic>()),
      vpcOriginConfig: map['vpcOriginConfig'] == null ? null : DistributionOriginVpcOriginConfig.fromMap((map['vpcOriginConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
