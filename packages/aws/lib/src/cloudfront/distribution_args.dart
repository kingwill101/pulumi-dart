...
class DistributionArgs {
  ...
  DistributionArgs({
    ...
    String? comment,
    DistributionConnectionFunctionAssociation? connectionFunctionAssociation,
    String? continuousDeploymentPolicyId,
    List<DistributionCustomErrorResponse>? customErrorResponses,
    required DistributionDefaultCacheBehavior defaultCacheBehavior,
    String? defaultRootObject,
    required bool enabled,
    String? httpVersion,
    bool? isIpv6Enabled,
    DistributionLoggingConfig? loggingConfig,
    List<DistributionOrderedCacheBehavior>? orderedCacheBehaviors,
    List<DistributionOriginGroup>? originGroups,
    required List<DistributionOrigin> origins,
    String? priceClass,
    required DistributionRestrictions restrictions,
    bool? retainOnDelete,
    bool? staging,
    Map<String, String>? tags,
    required DistributionViewerCertificate viewerCertificate,
    ...
    String? webAclId,
       ...
       originGroups = pulumi
           .Input.asOptionalInput<List<DistributionOriginGroup>>(originGroups),
       origins = pulumi.Input.asInput<List<DistributionOrigin>>(origins),
       priceClass = pulumi.Input.asOptionalInput<String>(priceClass),
       restrictions = pulumi.Input.asInput<DistributionRestrictions>(
         restrictions,
       ),
       ...
       waitForDeployment = pulumi.Input.asOptionalInput<bool>(
         waitForDeployment,
       ),
  ...
  factory DistributionArgs.fromMap(Map<String, dynamic> map) {
    return DistributionArgs(
      ...
      isIpv6Enabled: map['isIpv6Enabled'] == null
          ? null
          : map['isIpv6Enabled'] as bool,
      ...
      origins: pulumi.Input.decodeList<DistributionOrigin>(
        map['origins'],
        (value) =>
            DistributionOrigin.fromMap((value as Map).cast<String, dynamic>()),
      ),
      priceClass: map['priceClass'] == null
          ? null
          : map['priceClass'] as String,
      restrictions: DistributionRestrictions.fromMap(
        (map['restrictions'] as Map).cast<String, dynamic>(),
      ),
      retainOnDelete: map['retainOnDelete'] == null
          ? null
          : map['retainOnDelete'] as bool,
