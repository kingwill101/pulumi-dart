...
class GetResponseHeadersPolicyCorsConfig {
  ...
  final List<GetResponseHeadersPolicyCorsConfigAccessControlAllowHeader> accessControlAllowHeaders;
  /// Object that contains an attribute `items` that contains a list of HTTP methods that CloudFront includes as values for the Access-Control-Allow-Methods HTTP response header. Valid values: `GET` | `POST` | `OPTIONS` | `PUT` | `DELETE` | `HEAD` | `ALL`
  final List<GetResponseHeadersPolicyCorsConfigAccessControlAllowMethod> accessControlAllowMethods;
  /// Object that contains an attribute `items` that contains a list of origins that CloudFront can use as the value for the Access-Control-Allow-Origin HTTP response header.
  final List<GetResponseHeadersPolicyCorsConfigAccessControlAllowOrigin> accessControlAllowOrigins;
  /// Object that contains an attribute `items` that contains a list of HTTP headers that CloudFront includes as values for the Access-Control-Expose-Headers HTTP response header.
  final List<GetResponseHeadersPolicyCorsConfigAccessControlExposeHeader> accessControlExposeHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'accessControlAllowHeaders': pulumi.Input.encodeList<GetResponseHeadersPolicyCorsConfigAccessControlAllowHeader, Map<String, dynamic>>(accessControlAllowHeaders, (value) => value.toMap()),
      'accessControlAllowMethods': pulumi.Input.encodeList<GetResponseHeadersPolicyCorsConfigAccessControlAllowMethod, Map<String, dynamic>>(accessControlAllowMethods, (value) => value.toMap()),
      'accessControlAllowOrigins': pulumi.Input.encodeList<GetResponseHeadersPolicyCorsConfigAccessControlAllowOrigin, Map<String, dynamic>>(accessControlAllowOrigins, (value) => value.toMap()),
      'accessControlExposeHeaders': pulumi.Input.encodeList<GetResponseHeadersPolicyCorsConfigAccessControlExposeHeader, Map<String, dynamic>>(accessControlExposeHeaders, (value) => value.toMap()),
  ...
  factory GetResponseHeadersPolicyCorsConfig.fromMap(Map<String, dynamic> map) {
    return GetResponseHeadersPolicyCorsConfig(
      ...
      accessControlAllowHeaders: pulumi.Input.decodeList<GetResponseHeadersPolicyCorsConfigAccessControlAllowHeader>(map['accessControlAllowHeaders'], (value) => GetResponseHeadersPolicyCorsConfigAccessControlAllowHeader.fromMap((value as Map).cast<String, dynamic>())),
      accessControlAllowMethods: pulumi.Input.decodeList<GetResponseHeadersPolicyCorsConfigAccessControlAllowMethod>(map['accessControlAllowMethods'], (value) => GetResponseHeadersPolicyCorsConfigAccessControlAllowMethod.fromMap((value as Map).cast<String, dynamic>())),
      accessControlAllowOrigins: pulumi.Input.decodeList<GetResponseHeadersPolicyCorsConfigAccessControlAllowOrigin>(map['accessControlAllowOrigins'], (value) => GetResponseHeadersPolicyCorsConfigAccessControlAllowOrigin.fromMap((value as Map).cast<String, dynamic>())),
      accessControlExposeHeaders: pulumi.Input.decodeList<GetResponseHeadersPolicyCorsConfigAccessControlExposeHeader>(map['accessControlExposeHeaders'], (value) => GetResponseHeadersPolicyCorsConfigAccessControlExposeHeader.fromMap((value as Map).cast<String, dynamic>())),
