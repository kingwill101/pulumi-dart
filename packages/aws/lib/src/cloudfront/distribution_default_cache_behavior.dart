...
class DistributionDefaultCacheBehavior {
  ...
  final List<DistributionDefaultCacheBehaviorFunctionAssociation>? functionAssociations;
  /// A config block that sets the grpc config.
  final DistributionDefaultCacheBehaviorGrpcConfig? grpcConfig;
  /// A config block that triggers a lambda function with specific actions (maximum 4).
  final List<DistributionDefaultCacheBehaviorLambdaFunctionAssociation>? lambdaFunctionAssociations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'forwardedValues': ?forwardedValues == null ? null : forwardedValues!.toMap(),
      'functionAssociations': ?functionAssociations == null ? null : pulumi.Input.encodeList<DistributionDefaultCacheBehaviorFunctionAssociation, Map<String, dynamic>>(functionAssociations!, (value) => value.toMap()),
      'grpcConfig': ?grpcConfig == null ? null : grpcConfig!.toMap(),
      'lambdaFunctionAssociations': ?lambdaFunctionAssociations == null ? null : pulumi.Input.encodeList<DistributionDefaultCacheBehaviorLambdaFunctionAssociation, Map<String, dynamic>>(lambdaFunctionAssociations!, (value) => value.toMap()),
      'maxTtl': ?maxTtl,
      'minTtl': ?minTtl,
  ...
  factory DistributionDefaultCacheBehavior.fromMap(Map<String, dynamic> map) {
    return DistributionDefaultCacheBehavior(
      ...
      forwardedValues: map['forwardedValues'] == null ? null : DistributionDefaultCacheBehaviorForwardedValues.fromMap((map['forwardedValues'] as Map).cast<String, dynamic>()),
      functionAssociations: map['functionAssociations'] == null ? null : pulumi.Input.decodeList<DistributionDefaultCacheBehaviorFunctionAssociation>(map['functionAssociations'], (value) => DistributionDefaultCacheBehaviorFunctionAssociation.fromMap((value as Map).cast<String, dynamic>())),
      grpcConfig: map['grpcConfig'] == null ? null : DistributionDefaultCacheBehaviorGrpcConfig.fromMap((map['grpcConfig'] as Map).cast<String, dynamic>()),
      lambdaFunctionAssociations: map['lambdaFunctionAssociations'] == null ? null : pulumi.Input.decodeList<DistributionDefaultCacheBehaviorLambdaFunctionAssociation>(map['lambdaFunctionAssociations'], (value) => DistributionDefaultCacheBehaviorLambdaFunctionAssociation.fromMap((value as Map).cast<String, dynamic>())),
      ...
      smoothStreaming: map['smoothStreaming'] == null ? null : map['smoothStreaming'] as bool,
      targetOriginId: map['targetOriginId'] as String,
      trustedKeyGroups: map['trustedKeyGroups'] == null ? null : (map['trustedKeyGroups'] as List).cast<String>(),
      trustedSigners: map['trustedSigners'] == null ? null : (map['trustedSigners'] as List).cast<String>(),
