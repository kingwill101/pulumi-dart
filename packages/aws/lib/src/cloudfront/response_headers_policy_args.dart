...
class ResponseHeadersPolicyArgs {
  ...
  factory ResponseHeadersPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ResponseHeadersPolicyArgs(
      ...
      corsConfig: map['corsConfig'] == null ? null : ResponseHeadersPolicyCorsConfig.fromMap((map['corsConfig'] as Map).cast<String, dynamic>()),
      customHeadersConfig: map['customHeadersConfig'] == null ? null : ResponseHeadersPolicyCustomHeadersConfig.fromMap((map['customHeadersConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      removeHeadersConfig: map['removeHeadersConfig'] == null ? null : ResponseHeadersPolicyRemoveHeadersConfig.fromMap((map['removeHeadersConfig'] as Map).cast<String, dynamic>()),
      securityHeadersConfig: map['securityHeadersConfig'] == null ? null : ResponseHeadersPolicySecurityHeadersConfig.fromMap((map['securityHeadersConfig'] as Map).cast<String, dynamic>()),
      serverTimingHeadersConfig: map['serverTimingHeadersConfig'] == null ? null : ResponseHeadersPolicyServerTimingHeadersConfig.fromMap((map['serverTimingHeadersConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
