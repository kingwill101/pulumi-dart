...
class DistributionTenantTimeouts {
  ...
  /// Creates a new [DistributionTenantTimeouts].
  ...
  DistributionTenantTimeouts({this.create, this.delete, this.update});
  ...
  factory DistributionTenantTimeouts.fromMap(Map<String, dynamic> map) {
    return DistributionTenantTimeouts(
