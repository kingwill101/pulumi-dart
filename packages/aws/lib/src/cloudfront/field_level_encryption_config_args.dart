...
class FieldLevelEncryptionConfigArgs {
  ...
  FieldLevelEncryptionConfigArgs({
    String? comment,
    required FieldLevelEncryptionConfigContentTypeProfileConfig
        contentTypeProfileConfig,
    required FieldLevelEncryptionConfigQueryArgProfileConfig
        queryArgProfileConfig,
  })  : comment = pulumi.Input.asOptionalInput<String>(comment),
        contentTypeProfileConfig = pulumi.Input.asInput<
                FieldLevelEncryptionConfigContentTypeProfileConfig>(
            contentTypeProfileConfig),
        queryArgProfileConfig = pulumi.Input.asInput<
    ...
    return FieldLevelEncryptionConfigArgs(
      ...
      contentTypeProfileConfig:
          FieldLevelEncryptionConfigContentTypeProfileConfig.fromMap(
              (map['contentTypeProfileConfig'] as Map).cast<String, dynamic>()),
      queryArgProfileConfig:
          FieldLevelEncryptionConfigQueryArgProfileConfig.fromMap(
              (map['queryArgProfileConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
