...
class FieldLevelEncryptionConfigArgs {
  ...
  FieldLevelEncryptionConfigArgs({
    String? comment,
    required FieldLevelEncryptionConfigContentTypeProfileConfig contentTypeProfileConfig,
    required FieldLevelEncryptionConfigQueryArgProfileConfig queryArgProfileConfig,
  }) :
  ...
  factory FieldLevelEncryptionConfigArgs.fromMap(Map<String, dynamic> map) {
    return FieldLevelEncryptionConfigArgs(
      ...
      contentTypeProfileConfig: FieldLevelEncryptionConfigContentTypeProfileConfig.fromMap((map['contentTypeProfileConfig'] as Map).cast<String, dynamic>()),
      queryArgProfileConfig: FieldLevelEncryptionConfigQueryArgProfileConfig.fromMap((map['queryArgProfileConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
