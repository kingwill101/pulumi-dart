...
class ConnectionFunctionArgs {
  ...
  ConnectionFunctionArgs({
    ...
    required ConnectionFunctionConnectionFunctionConfig connectionFunctionConfig,
    String? name,
    bool? publish,
  ...
  factory ConnectionFunctionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionFunctionArgs(
      ...
      connectionFunctionConfig: ConnectionFunctionConnectionFunctionConfig.fromMap((map['connectionFunctionConfig'] as Map).cast<String, dynamic>()),
