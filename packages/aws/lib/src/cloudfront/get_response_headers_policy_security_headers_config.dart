...
class GetResponseHeadersPolicySecurityHeadersConfig {
  ...
  final List<GetResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy> contentSecurityPolicies;
  ...
  final List<GetResponseHeadersPolicySecurityHeadersConfigContentTypeOption> contentTypeOptions;
  ...
  final List<GetResponseHeadersPolicySecurityHeadersConfigFrameOption> frameOptions;
  ...
  final List<GetResponseHeadersPolicySecurityHeadersConfigReferrerPolicy> referrerPolicies;
  ...
  final List<GetResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity> strictTransportSecurities;
  ...
  final List<GetResponseHeadersPolicySecurityHeadersConfigXssProtection> xssProtections;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentSecurityPolicies': pulumi.Input.encodeList<GetResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy, Map<String, dynamic>>(contentSecurityPolicies, (value) => value.toMap()),
      'contentTypeOptions': pulumi.Input.encodeList<GetResponseHeadersPolicySecurityHeadersConfigContentTypeOption, Map<String, dynamic>>(contentTypeOptions, (value) => value.toMap()),
      'frameOptions': pulumi.Input.encodeList<GetResponseHeadersPolicySecurityHeadersConfigFrameOption, Map<String, dynamic>>(frameOptions, (value) => value.toMap()),
      'referrerPolicies': pulumi.Input.encodeList<GetResponseHeadersPolicySecurityHeadersConfigReferrerPolicy, Map<String, dynamic>>(referrerPolicies, (value) => value.toMap()),
      'strictTransportSecurities': pulumi.Input.encodeList<GetResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity, Map<String, dynamic>>(strictTransportSecurities, (value) => value.toMap()),
      'xssProtections': pulumi.Input.encodeList<GetResponseHeadersPolicySecurityHeadersConfigXssProtection, Map<String, dynamic>>(xssProtections, (value) => value.toMap()),
    };
  }
  ...
  factory GetResponseHeadersPolicySecurityHeadersConfig.fromMap(Map<String, dynamic> map) {
    return GetResponseHeadersPolicySecurityHeadersConfig(
      contentSecurityPolicies: pulumi.Input.decodeList<GetResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy>(map['contentSecurityPolicies'], (value) => GetResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy.fromMap((value as Map).cast<String, dynamic>())),
      contentTypeOptions: pulumi.Input.decodeList<GetResponseHeadersPolicySecurityHeadersConfigContentTypeOption>(map['contentTypeOptions'], (value) => GetResponseHeadersPolicySecurityHeadersConfigContentTypeOption.fromMap((value as Map).cast<String, dynamic>())),
      frameOptions: pulumi.Input.decodeList<GetResponseHeadersPolicySecurityHeadersConfigFrameOption>(map['frameOptions'], (value) => GetResponseHeadersPolicySecurityHeadersConfigFrameOption.fromMap((value as Map).cast<String, dynamic>())),
      referrerPolicies: pulumi.Input.decodeList<GetResponseHeadersPolicySecurityHeadersConfigReferrerPolicy>(map['referrerPolicies'], (value) => GetResponseHeadersPolicySecurityHeadersConfigReferrerPolicy.fromMap((value as Map).cast<String, dynamic>())),
      strictTransportSecurities: pulumi.Input.decodeList<GetResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity>(map['strictTransportSecurities'], (value) => GetResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity.fromMap((value as Map).cast<String, dynamic>())),
      xssProtections: pulumi.Input.decodeList<GetResponseHeadersPolicySecurityHeadersConfigXssProtection>(map['xssProtections'], (value) => GetResponseHeadersPolicySecurityHeadersConfigXssProtection.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
