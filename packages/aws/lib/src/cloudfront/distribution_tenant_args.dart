...
class DistributionTenantArgs {
  ...
  DistributionTenantArgs({
    ...
    bool? waitForDeployment,
            ...
            pulumi.Input.asOptionalInput<String>(connectionGroupId),
        customizations =
        ...
        timeouts =
            pulumi.Input.asOptionalInput<DistributionTenantTimeouts>(timeouts),
        waitForDeployment =
    ...
    return DistributionTenantArgs(
      ...
      managedCertificateRequest: map['managedCertificateRequest'] == null
          ...
          : DistributionTenantManagedCertificateRequest.fromMap(
              (map['managedCertificateRequest'] as Map)
                  .cast<String, dynamic>()),
