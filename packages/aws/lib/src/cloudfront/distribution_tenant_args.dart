...
class DistributionTenantArgs {
  ...
  }) : connectionGroupId = pulumi.Input.asOptionalInput<String>(
         connectionGroupId,
       ),
       customizations =
  ...
  factory DistributionTenantArgs.fromMap(Map<String, dynamic> map) {
    return DistributionTenantArgs(
      connectionGroupId: map['connectionGroupId'] == null
          ? null
          : map['connectionGroupId'] as String,
      customizations: map['customizations'] == null
          ? null
          : DistributionTenantCustomizations.fromMap(
              (map['customizations'] as Map).cast<String, dynamic>(),
            ),
      ...
      managedCertificateRequest: map['managedCertificateRequest'] == null
          ? null
          : DistributionTenantManagedCertificateRequest.fromMap(
              (map['managedCertificateRequest'] as Map).cast<String, dynamic>(),
            ),
