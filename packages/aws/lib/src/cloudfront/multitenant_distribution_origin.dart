...
class MultitenantDistributionOrigin {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customOriginConfigs': ?customOriginConfigs == null
          ? null
          : pulumi.Input.encodeList<
              MultitenantDistributionOriginCustomOriginConfig,
              Map<String, dynamic>
            >(customOriginConfigs!, (value) => value.toMap()),
      'domainName': domainName,
      'id': id,
      'originAccessControlId': ?originAccessControlId,
      'originPath': ?originPath,
      'originShields': ?originShields == null
          ? null
          : pulumi.Input.encodeList<
              MultitenantDistributionOriginOriginShield,
              Map<String, dynamic>
            >(originShields!, (value) => value.toMap()),
      'responseCompletionTimeout': ?responseCompletionTimeout,
      'vpcOriginConfigs': ?vpcOriginConfigs == null
          ? null
          : pulumi.Input.encodeList<
              MultitenantDistributionOriginVpcOriginConfig,
              Map<String, dynamic>
            >(vpcOriginConfigs!, (value) => value.toMap()),
    };
  }
