...
class Distribution extends pulumi.CustomResource {
  ...
  Distribution(
    ...
    this.continuousDeploymentPolicyId = registerOutput<String>(
    ...
    this.inProgressValidationBatches = registerOutput<int>(
      'inProgressValidationBatches',
    );
    this.isIpv6Enabled = registerOutput<bool?>('isIpv6Enabled');
    this.lastModifiedTime = registerOutput<String>('lastModifiedTime');
    this.loggingConfig = registerOutput<DistributionLoggingConfig?>(
      'loggingConfig',
    );
    ...
    this.originGroups = registerOutput<List<DistributionOriginGroup>?>(
      'originGroups',
    );
    this.origins = registerOutput<List<DistributionOrigin>>('origins');
    this.priceClass = registerOutput<String?>('priceClass');
    this.restrictions = registerOutput<DistributionRestrictions>(
      'restrictions',
    );
    ...
    this.trustedKeyGroups = registerOutput<List<DistributionTrustedKeyGroup>>(
      'trustedKeyGroups',
    );
    this.trustedSigners = registerOutput<List<DistributionTrustedSigner>>(
      'trustedSigners',
    );
    this.viewerCertificate = registerOutput<DistributionViewerCertificate>(
      'viewerCertificate',
    );
    this.viewerMtlsConfig = registerOutput<DistributionViewerMtlsConfig?>(
      'viewerMtlsConfig',
    );
