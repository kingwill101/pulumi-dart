...
class ContinuousDeploymentPolicyArgs {
  ...
  ContinuousDeploymentPolicyArgs({
    ...
    required ContinuousDeploymentPolicyStagingDistributionDnsNames stagingDistributionDnsNames,
  ...
  factory ContinuousDeploymentPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ContinuousDeploymentPolicyArgs(
      ...
      stagingDistributionDnsNames: ContinuousDeploymentPolicyStagingDistributionDnsNames.fromMap((map['stagingDistributionDnsNames'] as Map).cast<String, dynamic>()),
      trafficConfig: map['trafficConfig'] == null ? null : ContinuousDeploymentPolicyTrafficConfig.fromMap((map['trafficConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
