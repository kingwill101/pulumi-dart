...
class RepositoryCreationTemplateArgs {
  ...
  RepositoryCreationTemplateArgs({
    ...
    Map<String, String>? resourceTags,
        ...
        repositoryPolicy =
            pulumi.Input.asOptionalInput<String>(repositoryPolicy),
        resourceTags =
  ...
  factory RepositoryCreationTemplateArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryCreationTemplateArgs(
      ...
      imageTagMutabilityExclusionFilters: map[
                  'imageTagMutabilityExclusionFilters'] ==
              null
          ? null
          : pulumi.Input.decodeList<
      ...
      lifecyclePolicy: map['lifecyclePolicy'] == null
          ? null
          : map['lifecyclePolicy'] as String,
      prefix: map['prefix'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      repositoryPolicy: map['repositoryPolicy'] == null
          ? null
          : map['repositoryPolicy'] as String,
