...
class PullThroughCacheRuleArgs {
  ...
  factory PullThroughCacheRuleArgs.fromMap(Map<String, dynamic> map) {
    return PullThroughCacheRuleArgs(
      credentialArn: map['credentialArn'] == null ? null : map['credentialArn'] as String,
      ...
      upstreamRepositoryPrefix: map['upstreamRepositoryPrefix'] == null ? null : map['upstreamRepositoryPrefix'] as String,
    );
  }
}
