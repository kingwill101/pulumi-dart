...
class PullThroughCacheRuleArgs {
  ...
  PullThroughCacheRuleArgs({
    ...
    String? upstreamRepositoryPrefix,
        ...
        upstreamRepositoryPrefix =
            pulumi.Input.asOptionalInput<String>(upstreamRepositoryPrefix);
  ...
  factory PullThroughCacheRuleArgs.fromMap(Map<String, dynamic> map) {
    return PullThroughCacheRuleArgs(
      credentialArn:
          map['credentialArn'] == null ? null : map['credentialArn'] as String,
      customRoleArn:
          map['customRoleArn'] == null ? null : map['customRoleArn'] as String,
