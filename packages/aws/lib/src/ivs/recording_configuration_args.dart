...
class RecordingConfigurationArgs {
  ...
  RecordingConfigurationArgs({
    required RecordingConfigurationDestinationConfiguration destinationConfiguration,
    String? name,
  ...
  factory RecordingConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RecordingConfigurationArgs(
      destinationConfiguration: RecordingConfigurationDestinationConfiguration.fromMap((map['destinationConfiguration'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      recordingReconnectWindowSeconds: map['recordingReconnectWindowSeconds'] == null ? null : map['recordingReconnectWindowSeconds'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      thumbnailConfiguration: map['thumbnailConfiguration'] == null ? null : RecordingConfigurationThumbnailConfiguration.fromMap((map['thumbnailConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
