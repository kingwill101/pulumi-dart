...
class ChannelArgs {
  ...
  ChannelArgs({
    ...
    String? type,
        ...
        recordingConfigurationArn =
            pulumi.Input.asOptionalInput<String>(recordingConfigurationArn),
  ...
  factory ChannelArgs.fromMap(Map<String, dynamic> map) {
    return ChannelArgs(
      ...
      latencyMode:
          map['latencyMode'] == null ? null : map['latencyMode'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      recordingConfigurationArn: map['recordingConfigurationArn'] == null
          ? null
          : map['recordingConfigurationArn'] as String,
