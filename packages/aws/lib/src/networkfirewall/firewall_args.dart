...
class FirewallArgs {
  ...
  FirewallArgs({
    ...
    List<FirewallAvailabilityZoneMapping>? availabilityZoneMappings,
    bool? deleteProtection,
    String? description,
    List<String>? enabledAnalysisTypes,
    FirewallEncryptionConfiguration? encryptionConfiguration,
    required String firewallPolicyArn,
    bool? firewallPolicyChangeProtection,
    String? name,
    String? region,
    bool? subnetChangeProtection,
    List<FirewallSubnetMapping>? subnetMappings,
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      availabilityZoneChangeProtection: map['availabilityZoneChangeProtection'] == null ? null : map['availabilityZoneChangeProtection'] as bool,
      availabilityZoneMappings: map['availabilityZoneMappings'] == null ? null : pulumi.Input.decodeList<FirewallAvailabilityZoneMapping>(map['availabilityZoneMappings'], (value) => FirewallAvailabilityZoneMapping.fromMap((value as Map).cast<String, dynamic>())),
      deleteProtection: map['deleteProtection'] == null ? null : map['deleteProtection'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      enabledAnalysisTypes: map['enabledAnalysisTypes'] == null ? null : (map['enabledAnalysisTypes'] as List).cast<String>(),
      encryptionConfiguration: map['encryptionConfiguration'] == null ? null : FirewallEncryptionConfiguration.fromMap((map['encryptionConfiguration'] as Map).cast<String, dynamic>()),
      ...
      subnetMappings: map['subnetMappings'] == null ? null : pulumi.Input.decodeList<FirewallSubnetMapping>(map['subnetMappings'], (value) => FirewallSubnetMapping.fromMap((value as Map).cast<String, dynamic>())),
