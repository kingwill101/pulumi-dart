...
class FirewallArgs {
  ...
  FirewallArgs({
    ...
    String? vpcId,
        ...
        enabledAnalysisTypes =
            pulumi.Input.asOptionalInput<List<String>>(enabledAnalysisTypes),
        ...
        firewallPolicyChangeProtection =
            pulumi.Input.asOptionalInput<bool>(firewallPolicyChangeProtection),
        name = pulumi.Input.asOptionalInput<String>(name),
        region = pulumi.Input.asOptionalInput<String>(region),
        subnetChangeProtection =
            pulumi.Input.asOptionalInput<bool>(subnetChangeProtection),
        subnetMappings =
            pulumi.Input.asOptionalInput<List<FirewallSubnetMapping>>(
                subnetMappings),
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      availabilityZoneChangeProtection:
          map['availabilityZoneChangeProtection'] == null
              ? null
              : map['availabilityZoneChangeProtection'] as bool,
      availabilityZoneMappings: map['availabilityZoneMappings'] == null
          ? null
          : pulumi.Input.decodeList<FirewallAvailabilityZoneMapping>(
              map['availabilityZoneMappings'],
              (value) => FirewallAvailabilityZoneMapping.fromMap(
