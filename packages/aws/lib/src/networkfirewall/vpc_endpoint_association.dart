...
class VpcEndpointAssociation extends pulumi.CustomResource {
  ...
  VpcEndpointAssociation(
    ...
    this.subnetMapping = registerOutput<VpcEndpointAssociationSubnetMapping>(
      'subnetMapping',
    );
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.timeouts = registerOutput<VpcEndpointAssociationTimeouts?>('timeouts');
    this.vpcEndpointAssociationArn = registerOutput<String>(
      'vpcEndpointAssociationArn',
    );
    this.vpcEndpointAssociationId = registerOutput<String>(
