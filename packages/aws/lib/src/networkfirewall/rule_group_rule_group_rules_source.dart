...
class RuleGroupRuleGroupRulesSource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'rulesSourceList': ?rulesSourceList == null
          ? null
          : rulesSourceList!.toMap(),
      'rulesString': ?rulesString,
      'statefulRules': ?statefulRules == null
          ? null
          : pulumi.Input.encodeList<
              RuleGroupRuleGroupRulesSourceStatefulRule,
              Map<String, dynamic>
            >(statefulRules!, (value) => value.toMap()),
      'statelessRulesAndCustomActions': ?statelessRulesAndCustomActions == null
          ? null
          : statelessRulesAndCustomActions!.toMap(),
    };
  }
  ...
  factory RuleGroupRuleGroupRulesSource.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleGroupRulesSource(
      ...
      rulesString: map['rulesString'] == null
          ? null
          : map['rulesString'] as String,
      ...
      statelessRulesAndCustomActions:
          map['statelessRulesAndCustomActions'] == null
          ? null
