...
class FirewallPolicyArgs {
  ...
  FirewallPolicyArgs({
    String? description,
    FirewallPolicyEncryptionConfiguration? encryptionConfiguration,
    required FirewallPolicyFirewallPolicy firewallPolicy,
    String? name,
    String? region,
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      ...
      encryptionConfiguration: map['encryptionConfiguration'] == null ? null : FirewallPolicyEncryptionConfiguration.fromMap((map['encryptionConfiguration'] as Map).cast<String, dynamic>()),
      firewallPolicy: FirewallPolicyFirewallPolicy.fromMap((map['firewallPolicy'] as Map).cast<String, dynamic>()),
