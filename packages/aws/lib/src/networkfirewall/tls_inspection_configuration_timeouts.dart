...
class TlsInspectionConfigurationTimeouts {
  ...
  /// Creates a new [TlsInspectionConfigurationTimeouts].
  ...
  TlsInspectionConfigurationTimeouts({this.create, this.delete, this.update});
  ...
  factory TlsInspectionConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return TlsInspectionConfigurationTimeouts(
