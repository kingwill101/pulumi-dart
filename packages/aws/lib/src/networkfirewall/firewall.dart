...
class Firewall extends pulumi.CustomResource {
  ...
  Firewall(
    ...
    this.availabilityZoneChangeProtection = registerOutput<bool?>('availabilityZoneChangeProtection');
    this.availabilityZoneMappings = registerOutput<List<FirewallAvailabilityZoneMapping>>('availabilityZoneMappings');
    this.deleteProtection = registerOutput<bool?>('deleteProtection');
    this.description = registerOutput<String?>('description');
    this.enabledAnalysisTypes = registerOutput<List<String>?>('enabledAnalysisTypes');
    this.encryptionConfiguration = registerOutput<FirewallEncryptionConfiguration?>('encryptionConfiguration');
    this.firewallPolicyArn = registerOutput<String>('firewallPolicyArn');
    this.firewallPolicyChangeProtection = registerOutput<bool?>('firewallPolicyChangeProtection');
    this.firewallStatuses = registerOutput<List<FirewallFirewallStatus>>('firewallStatuses');
    this.name = registerOutput<String>('name');
    this.region = registerOutput<String>('region');
    this.subnetChangeProtection = registerOutput<bool?>('subnetChangeProtection');
    this.subnetMappings = registerOutput<List<FirewallSubnetMapping>?>('subnetMappings');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.transitGatewayId = registerOutput<String?>('transitGatewayId');
    this.transitGatewayOwnerAccountId = registerOutput<String>('transitGatewayOwnerAccountId');
