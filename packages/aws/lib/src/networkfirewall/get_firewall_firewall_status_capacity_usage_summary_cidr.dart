...
class GetFirewallFirewallStatusCapacityUsageSummaryCidr {
  ...
  final List<GetFirewallFirewallStatusCapacityUsageSummaryCidrIpSetReference> ipSetReferences;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipSetReferences': pulumi.Input.encodeList<GetFirewallFirewallStatusCapacityUsageSummaryCidrIpSetReference, Map<String, dynamic>>(ipSetReferences, (value) => value.toMap()),
  ...
  factory GetFirewallFirewallStatusCapacityUsageSummaryCidr.fromMap(Map<String, dynamic> map) {
    return GetFirewallFirewallStatusCapacityUsageSummaryCidr(
      ...
      ipSetReferences: pulumi.Input.decodeList<GetFirewallFirewallStatusCapacityUsageSummaryCidrIpSetReference>(map['ipSetReferences'], (value) => GetFirewallFirewallStatusCapacityUsageSummaryCidrIpSetReference.fromMap((value as Map).cast<String, dynamic>())),
