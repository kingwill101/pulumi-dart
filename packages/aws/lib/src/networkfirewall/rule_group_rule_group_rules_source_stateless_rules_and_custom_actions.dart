    ...
    return <String, dynamic>{
      'customActions': ?customActions == null
          ...
          : pulumi.Input.encodeList<
              RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomAction,
              Map<String, dynamic>
            >(customActions!, (value) => value.toMap()),
      'statelessRules':
          pulumi.Input.encodeList<
            RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRule,
            Map<String, dynamic>
          >(statelessRules, (value) => value.toMap()),
    };
  }
    ...
    return RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActions(
      customActions: map['customActions'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['customActions'],
              (value) =>
                  RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomAction.fromMap(
      ...
      statelessRules:
          ...
          >(
            map['statelessRules'],
            (value) =>
                RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRule.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
    );
