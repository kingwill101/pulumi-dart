...
class VpcEndpointAssociationTimeouts {
  ...
  /// Creates a new [VpcEndpointAssociationTimeouts].
  ...
  VpcEndpointAssociationTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory VpcEndpointAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return VpcEndpointAssociationTimeouts(
