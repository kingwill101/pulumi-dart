...
class LoggingConfiguration extends pulumi.CustomResource {
  ...
  LoggingConfiguration(
    ...
    this.enableMonitoringDashboard = registerOutput<bool>('enableMonitoringDashboard');
    this.firewallArn = registerOutput<String>('firewallArn');
    this.loggingConfiguration = registerOutput<LoggingConfigurationLoggingConfiguration>('loggingConfiguration');
