...
class FirewallFirewallStatus {
  ...
  final List<FirewallFirewallStatusTransitGatewayAttachmentSyncState>? transitGatewayAttachmentSyncStates;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'syncStates': ?syncStates == null ? null : pulumi.Input.encodeList<FirewallFirewallStatusSyncState, Map<String, dynamic>>(syncStates!, (value) => value.toMap()),
      'transitGatewayAttachmentSyncStates': ?transitGatewayAttachmentSyncStates == null ? null : pulumi.Input.encodeList<FirewallFirewallStatusTransitGatewayAttachmentSyncState, Map<String, dynamic>>(transitGatewayAttachmentSyncStates!, (value) => value.toMap()),
    };
  }

  factory FirewallFirewallStatus.fromMap(Map<String, dynamic> map) {
    return FirewallFirewallStatus(
      syncStates: map['syncStates'] == null ? null : pulumi.Input.decodeList<FirewallFirewallStatusSyncState>(map['syncStates'], (value) => FirewallFirewallStatusSyncState.fromMap((value as Map).cast<String, dynamic>())),
