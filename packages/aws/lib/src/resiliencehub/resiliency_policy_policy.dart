...
class ResiliencyPolicyPolicy {
  ...
  factory ResiliencyPolicyPolicy.fromMap(Map<String, dynamic> map) {
    return ResiliencyPolicyPolicy(
      az: map['az'] == null ? null : ResiliencyPolicyPolicyAz.fromMap((map['az'] as Map).cast<String, dynamic>()),
      hardware: map['hardware'] == null ? null : ResiliencyPolicyPolicyHardware.fromMap((map['hardware'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : ResiliencyPolicyPolicyRegion.fromMap((map['region'] as Map).cast<String, dynamic>()),
      software: map['software'] == null ? null : ResiliencyPolicyPolicySoftware.fromMap((map['software'] as Map).cast<String, dynamic>()),
    );
  }
}
