...
class ResiliencyPolicyArgs {
  ...
  factory ResiliencyPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ResiliencyPolicyArgs(
      dataLocationConstraint: map['dataLocationConstraint'] == null ? null : map['dataLocationConstraint'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      policy: map['policy'] == null ? null : ResiliencyPolicyPolicy.fromMap((map['policy'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tier: map['tier'] as String,
      timeouts: map['timeouts'] == null ? null : ResiliencyPolicyTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
