...
class ScheduleArgs {
  ...
  factory ScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduleArgs(
      actionAfterCompletion: map['actionAfterCompletion'] == null ? null : map['actionAfterCompletion'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      endDate: map['endDate'] == null ? null : map['endDate'] as String,
      flexibleTimeWindow: ScheduleFlexibleTimeWindow.fromMap((map['flexibleTimeWindow'] as Map).cast<String, dynamic>()),
      ...
      target: ScheduleTarget.fromMap((map['target'] as Map).cast<String, dynamic>()),
    );
  }
}
