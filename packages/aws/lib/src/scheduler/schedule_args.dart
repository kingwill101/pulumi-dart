...
class ScheduleArgs {
  ...
  ScheduleArgs({
    ...
    String? description,
    String? endDate,
    required ScheduleFlexibleTimeWindow flexibleTimeWindow,
    String? groupName,
    String? kmsKeyArn,
    String? name,
    String? namePrefix,
    ...
    required ScheduleTarget target,
            ...
            pulumi.Input.asOptionalInput<String>(actionAfterCompletion),
        ...
        scheduleExpressionTimezone =
            pulumi.Input.asOptionalInput<String>(scheduleExpressionTimezone),
  ...
  factory ScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduleArgs(
      actionAfterCompletion: map['actionAfterCompletion'] == null
          ? null
          : map['actionAfterCompletion'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      endDate: map['endDate'] == null ? null : map['endDate'] as String,
      flexibleTimeWindow: ScheduleFlexibleTimeWindow.fromMap(
          (map['flexibleTimeWindow'] as Map).cast<String, dynamic>()),
