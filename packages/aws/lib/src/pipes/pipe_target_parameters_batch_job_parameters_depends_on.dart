...
class PipeTargetParametersBatchJobParametersDependsOn {
  ...
  PipeTargetParametersBatchJobParametersDependsOn({this.jobId, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'jobId': ?jobId, 'type': ?type};
  }

  factory PipeTargetParametersBatchJobParametersDependsOn.fromMap(
