...
class PipeArgs {
  ...
  factory PipeArgs.fromMap(Map<String, dynamic> map) {
    return PipeArgs(
      ...
      enrichment: map['enrichment'] == null ? null : map['enrichment'] as String,
      enrichmentParameters: map['enrichmentParameters'] == null ? null : PipeEnrichmentParameters.fromMap((map['enrichmentParameters'] as Map).cast<String, dynamic>()),
      kmsKeyIdentifier: map['kmsKeyIdentifier'] == null ? null : map['kmsKeyIdentifier'] as String,
      logConfiguration: map['logConfiguration'] == null ? null : PipeLogConfiguration.fromMap((map['logConfiguration'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      roleArn: map['roleArn'] as String,
      source: map['source'] as String,
      sourceParameters: map['sourceParameters'] == null ? null : PipeSourceParameters.fromMap((map['sourceParameters'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      target: map['target'] as String,
      targetParameters: map['targetParameters'] == null ? null : PipeTargetParameters.fromMap((map['targetParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
