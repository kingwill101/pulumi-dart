...
class PipeSourceParameters {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activemqBrokerParameters': ?activemqBrokerParameters == null
          ? null
          : activemqBrokerParameters!.toMap(),
      'dynamodbStreamParameters': ?dynamodbStreamParameters == null
          ? null
          : dynamodbStreamParameters!.toMap(),
      'filterCriteria': ?filterCriteria == null
          ? null
          : filterCriteria!.toMap(),
      ...
      'managedStreamingKafkaParameters':
          ...
          ? null
          : managedStreamingKafkaParameters!.toMap(),
      'rabbitmqBrokerParameters': ?rabbitmqBrokerParameters == null
          ? null
          : rabbitmqBrokerParameters!.toMap(),
      'selfManagedKafkaParameters': ?selfManagedKafkaParameters == null
          ? null
          : selfManagedKafkaParameters!.toMap(),
