...
class PipeSourceParametersDynamodbStreamParameters {
  ...
  final PipeSourceParametersDynamodbStreamParametersDeadLetterConfig? deadLetterConfig;
  ...
  factory PipeSourceParametersDynamodbStreamParameters.fromMap(Map<String, dynamic> map) {
    return PipeSourceParametersDynamodbStreamParameters(
      ...
      deadLetterConfig: map['deadLetterConfig'] == null ? null : PipeSourceParametersDynamodbStreamParametersDeadLetterConfig.fromMap((map['deadLetterConfig'] as Map).cast<String, dynamic>()),
