...
class PipeSourceParametersDynamodbStreamParameters {
  ...
  final PipeSourceParametersDynamodbStreamParametersDeadLetterConfig?
  deadLetterConfig;
  ...
  factory PipeSourceParametersDynamodbStreamParameters.fromMap(
    ...
    return PipeSourceParametersDynamodbStreamParameters(
      ...
      deadLetterConfig: map['deadLetterConfig'] == null
          ? null
          : PipeSourceParametersDynamodbStreamParametersDeadLetterConfig.fromMap(
