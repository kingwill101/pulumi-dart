...
class Pipe extends pulumi.CustomResource {
  ...
  Pipe(String name, {PipeArgs? args, pulumi.CustomResourceOptions? options})
    : super(
        'aws:pipes/pipe:Pipe',
        name,
    ...
    this.enrichmentParameters = registerOutput<PipeEnrichmentParameters?>(
      'enrichmentParameters',
    );
    this.kmsKeyIdentifier = registerOutput<String?>('kmsKeyIdentifier');
    this.logConfiguration = registerOutput<PipeLogConfiguration?>(
      'logConfiguration',
    );
    ...
    this.sourceParameters = registerOutput<PipeSourceParameters>(
      'sourceParameters',
    );
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.target = registerOutput<String>('target');
    this.targetParameters = registerOutput<PipeTargetParameters?>(
      'targetParameters',
    );
  }
}
