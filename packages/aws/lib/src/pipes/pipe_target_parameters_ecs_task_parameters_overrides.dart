    ...
    return <String, dynamic>{
      'containerOverrides': ?containerOverrides == null
          ...
          : pulumi.Input.encodeList<
              ...
              Map<String, dynamic>
            >(containerOverrides!, (value) => value.toMap()),
      'cpu': ?cpu,
      ...
      'inferenceAcceleratorOverrides': ?inferenceAcceleratorOverrides == null
          ...
          : pulumi.Input.encodeList<
              PipeTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverride,
              Map<String, dynamic>
            >(inferenceAcceleratorOverrides!, (value) => value.toMap()),
      'memory': ?memory,
  ...
  factory PipeTargetParametersEcsTaskParametersOverrides.fromMap(
    ...
    return PipeTargetParametersEcsTaskParametersOverrides(
      containerOverrides: map['containerOverrides'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              ...
              (value) =>
                  PipeTargetParametersEcsTaskParametersOverridesContainerOverride.fromMap(
      ...
      ephemeralStorage: map['ephemeralStorage'] == null
          ? null
          : PipeTargetParametersEcsTaskParametersOverridesEphemeralStorage.fromMap(
      ...
      inferenceAcceleratorOverrides:
          map['inferenceAcceleratorOverrides'] == null
          ? null
          : pulumi.Input.decodeList<
              PipeTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverride
            >(
              ...
              (value) =>
                  PipeTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverride.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
