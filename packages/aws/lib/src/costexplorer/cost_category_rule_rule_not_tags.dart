...
class CostCategoryRuleRuleNotTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [CostCategoryRuleRuleNotTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleNotTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleNotTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotTags(
