...
class GetTagsFilterCostCategory {
  ...
  /// Creates a new [GetTagsFilterCostCategory].
  ...
  GetTagsFilterCostCategory({this.key, this.matchOptions, this.values});
  ...
  factory GetTagsFilterCostCategory.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterCostCategory(
