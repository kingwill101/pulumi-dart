...
class AnomalySubscriptionThresholdExpressionNotTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionNotTags].
  /// [key] Key for the tag.
  ...
  factory AnomalySubscriptionThresholdExpressionNotTags.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionNotTags(
