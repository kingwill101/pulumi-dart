...
class GetCostCategoryRuleRuleNotNotTag {
  /// Key for the tag.
  final String key;
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotNotTag].
  /// [key] Key for the tag.
  ...
  factory GetCostCategoryRuleRuleNotNotTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotNotTag(
