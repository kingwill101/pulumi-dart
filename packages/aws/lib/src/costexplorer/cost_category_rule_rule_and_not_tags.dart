...
class CostCategoryRuleRuleAndNotTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [CostCategoryRuleRuleAndNotTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleAndNotTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleAndNotTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndNotTags(
