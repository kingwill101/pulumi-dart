...
class CostCategoryRuleRuleAndOrTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [CostCategoryRuleRuleAndOrTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleAndOrTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleAndOrTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndOrTags(
