...
class CostCategoryRuleRuleNotNotCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleNotNotCostCategory].
  ...
  factory CostCategoryRuleRuleNotNotCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotNotCostCategory(
