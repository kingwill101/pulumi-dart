...
class GetTagsFilterAndDimension {
  ...
  /// Creates a new [GetTagsFilterAndDimension].
  ...
  GetTagsFilterAndDimension({this.key, this.matchOptions, this.values});
  ...
  factory GetTagsFilterAndDimension.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterAndDimension(
