...
class CostCategoryRuleRuleOrNot {
  ...
  factory CostCategoryRuleRuleOrNot.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrNot(
      costCategory: map['costCategory'] == null ? null : CostCategoryRuleRuleOrNotCostCategory.fromMap((map['costCategory'] as Map).cast<String, dynamic>()),
      dimension: map['dimension'] == null ? null : CostCategoryRuleRuleOrNotDimension.fromMap((map['dimension'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : CostCategoryRuleRuleOrNotTags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
    );
  }
}
