...
class GetTagsFilterNotDimension {
  ...
  /// Creates a new [GetTagsFilterNotDimension].
  ...
  GetTagsFilterNotDimension({this.key, this.matchOptions, this.values});
  ...
  factory GetTagsFilterNotDimension.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterNotDimension(
