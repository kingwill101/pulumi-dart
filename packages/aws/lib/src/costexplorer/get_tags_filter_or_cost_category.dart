...
class GetTagsFilterOrCostCategory {
  ...
  /// Creates a new [GetTagsFilterOrCostCategory].
  ...
  GetTagsFilterOrCostCategory({this.key, this.matchOptions, this.values});
  ...
  factory GetTagsFilterOrCostCategory.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterOrCostCategory(
