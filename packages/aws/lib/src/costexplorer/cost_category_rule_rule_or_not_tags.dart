...
class CostCategoryRuleRuleOrNotTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [CostCategoryRuleRuleOrNotTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleOrNotTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleOrNotTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrNotTags(
