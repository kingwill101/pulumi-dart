...
class GetCostCategoryRuleRuleNotAndTag {
  /// Key for the tag.
  final String key;
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotAndTag].
  /// [key] Key for the tag.
  ...
  factory GetCostCategoryRuleRuleNotAndTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotAndTag(
