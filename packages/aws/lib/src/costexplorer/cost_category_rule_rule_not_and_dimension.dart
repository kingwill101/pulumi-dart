...
class CostCategoryRuleRuleNotAndDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleNotAndDimension].
  ...
  factory CostCategoryRuleRuleNotAndDimension.fromMap(
    Map<String, dynamic> map,
  ) {
    return CostCategoryRuleRuleNotAndDimension(
