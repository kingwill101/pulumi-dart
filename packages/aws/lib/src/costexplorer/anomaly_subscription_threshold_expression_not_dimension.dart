...
class AnomalySubscriptionThresholdExpressionNotDimension {
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionNotDimension].
  ...
  factory AnomalySubscriptionThresholdExpressionNotDimension.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionNotDimension(
