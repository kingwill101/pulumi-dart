...
class CostCategoryArgs {
  ...
  factory CostCategoryArgs.fromMap(Map<String, dynamic> map) {
    return CostCategoryArgs(
      ...
      effectiveStart: map['effectiveStart'] == null ? null : map['effectiveStart'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      ruleVersion: map['ruleVersion'] as String,
      rules: pulumi.Input.decodeList<CostCategoryRule>(map['rules'], (value) => CostCategoryRule.fromMap((value as Map).cast<String, dynamic>())),
      splitChargeRules: map['splitChargeRules'] == null ? null : pulumi.Input.decodeList<CostCategorySplitChargeRule>(map['splitChargeRules'], (value) => CostCategorySplitChargeRule.fromMap((value as Map).cast<String, dynamic>())),
