...
class GetCostCategoryRuleRuleCostCategory {
  /// Key for the tag.
  final String key;
  ...
  /// Creates a new [GetCostCategoryRuleRuleCostCategory].
  /// [key] Key for the tag.
  ...
  factory GetCostCategoryRuleRuleCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleCostCategory(
