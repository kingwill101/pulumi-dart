...
class GetCostCategoryRuleRuleOrAndTag {
  /// Key for the tag.
  final String key;
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrAndTag].
  /// [key] Key for the tag.
  ...
  factory GetCostCategoryRuleRuleOrAndTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrAndTag(
