...
class GetCostCategoryRuleRuleNotCostCategory {
  /// Key for the tag.
  final String key;
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotCostCategory].
  /// [key] Key for the tag.
  ...
  factory GetCostCategoryRuleRuleNotCostCategory.fromMap(
      Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotCostCategory(
