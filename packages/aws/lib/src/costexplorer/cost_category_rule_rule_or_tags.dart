...
class CostCategoryRuleRuleOrTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [CostCategoryRuleRuleOrTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleOrTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleOrTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrTags(
