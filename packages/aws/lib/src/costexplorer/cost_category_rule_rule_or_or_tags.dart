...
class CostCategoryRuleRuleOrOrTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [CostCategoryRuleRuleOrOrTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleOrOrTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleOrOrTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrOrTags(
