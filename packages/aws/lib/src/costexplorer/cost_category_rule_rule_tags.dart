...
class CostCategoryRuleRuleTags {
  /// Key for the tag.
  final String? key;
  ...
  /// Creates a new [CostCategoryRuleRuleTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleTags(
