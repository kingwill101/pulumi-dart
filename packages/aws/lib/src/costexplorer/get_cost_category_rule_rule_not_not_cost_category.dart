...
class GetCostCategoryRuleRuleNotNotCostCategory {
  /// Key for the tag.
  final String key;
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotNotCostCategory].
  /// [key] Key for the tag.
  ...
  factory GetCostCategoryRuleRuleNotNotCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotNotCostCategory(
