...
class GetCostCategoryRuleRuleDimension {
  /// Key for the tag.
  final String key;
  ...
  /// Creates a new [GetCostCategoryRuleRuleDimension].
  /// [key] Key for the tag.
  ...
  factory GetCostCategoryRuleRuleDimension.fromMap(Map<String, dynamic> map) {
