...
class CostCategoryRuleRuleOrOrCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleOrOrCostCategory].
  ...
  factory CostCategoryRuleRuleOrOrCostCategory.fromMap(
      Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrOrCostCategory(
