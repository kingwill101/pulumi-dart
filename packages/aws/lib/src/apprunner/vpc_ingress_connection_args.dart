...
class VpcIngressConnectionArgs {
  ...
  VpcIngressConnectionArgs({
    required VpcIngressConnectionIngressVpcConfiguration
        ingressVpcConfiguration,
    String? name,
    String? region,
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asInput<VpcIngressConnectionIngressVpcConfiguration>(
                ingressVpcConfiguration),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['ingressVpcConfiguration'] = pulumi.Input.mapInputValue<
