...
class ServiceSourceConfiguration {
  ...
  final ServiceSourceConfigurationAuthenticationConfiguration? authenticationConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'codeRepository': ?codeRepository == null ? null : codeRepository!.toMap(),
  ...
  factory ServiceSourceConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceSourceConfiguration(
      authenticationConfiguration: map['authenticationConfiguration'] == null ? null : ServiceSourceConfigurationAuthenticationConfiguration.fromMap((map['authenticationConfiguration'] as Map).cast<String, dynamic>()),
      autoDeploymentsEnabled: map['autoDeploymentsEnabled'] == null ? null : map['autoDeploymentsEnabled'] as bool,
      codeRepository: map['codeRepository'] == null ? null : ServiceSourceConfigurationCodeRepository.fromMap((map['codeRepository'] as Map).cast<String, dynamic>()),
      imageRepository: map['imageRepository'] == null ? null : ServiceSourceConfigurationImageRepository.fromMap((map['imageRepository'] as Map).cast<String, dynamic>()),
    );
  }
}
