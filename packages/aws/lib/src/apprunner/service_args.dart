...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<String>(autoScalingConfigurationArn),
        encryptionConfiguration =
            pulumi.Input.asOptionalInput<ServiceEncryptionConfiguration>(
                encryptionConfiguration),
        healthCheckConfiguration =
            pulumi.Input.asOptionalInput<ServiceHealthCheckConfiguration>(
                healthCheckConfiguration),
        instanceConfiguration =
            pulumi.Input.asOptionalInput<ServiceInstanceConfiguration>(
                instanceConfiguration),
        networkConfiguration =
            pulumi.Input.asOptionalInput<ServiceNetworkConfiguration>(
                networkConfiguration),
        observabilityConfiguration =
            pulumi.Input.asOptionalInput<ServiceObservabilityConfiguration>(
                observabilityConfiguration),
        region = pulumi.Input.asOptionalInput<String>(region),
        serviceName = pulumi.Input.asInput<String>(serviceName),
        sourceConfiguration = pulumi.Input.asInput<ServiceSourceConfiguration>(
            sourceConfiguration),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (healthCheckConfigurationValue != null) {
      map['healthCheckConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (observabilityConfigurationValue != null) {
      map['observabilityConfiguration'] = pulumi.Input.mapOptionalInputValue<
    ...
    map['sourceConfiguration'] = pulumi.Input.mapInputValue<
        ServiceSourceConfiguration,
        Map<String, dynamic>>(sourceConfiguration, (value) => value.toMap());
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      autoScalingConfigurationArn: map['autoScalingConfigurationArn'] == null
          ? null
      ...
      healthCheckConfiguration: map['healthCheckConfiguration'] == null
          ? null
          : ServiceHealthCheckConfiguration.fromMap(
              (map['healthCheckConfiguration'] as Map).cast<String, dynamic>()),
      ...
      observabilityConfiguration: map['observabilityConfiguration'] == null
          ? null
          : ServiceObservabilityConfiguration.fromMap(
              (map['observabilityConfiguration'] as Map)
                  .cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      serviceName: map['serviceName'] as String,
      sourceConfiguration: ServiceSourceConfiguration.fromMap(
