...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    this.autoScalingConfigurationArn = registerOutput<String>(
    ...
    this.instanceConfiguration = registerOutput<ServiceInstanceConfiguration>(
    ...
    this.sourceConfiguration = registerOutput<ServiceSourceConfiguration>(
      'sourceConfiguration',
    );
