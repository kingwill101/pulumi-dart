...
class ServiceNetworkConfigurationEgressConfiguration {
  ...
  Map<String, dynamic> toMap() {
    ...
    final egressTypeValue = egressType;
    if (egressTypeValue != null) {
      map['egressType'] = egressTypeValue;
    }
    final vpcConnectorArnValue = vpcConnectorArn;
    if (vpcConnectorArnValue != null) {
      map['vpcConnectorArn'] = vpcConnectorArnValue;
    }
    return map;
  }
  ...
  factory ServiceNetworkConfigurationEgressConfiguration.fromMap(
    ...
    return ServiceNetworkConfigurationEgressConfiguration(
      egressType:
          map['egressType'] == null ? null : map['egressType'] as String,
