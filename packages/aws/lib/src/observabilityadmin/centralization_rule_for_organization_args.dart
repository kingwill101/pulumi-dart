...
class CentralizationRuleForOrganizationArgs {
  ...
  CentralizationRuleForOrganizationArgs({
    String? region,
    required CentralizationRuleForOrganizationRule rule,
    required String ruleName,
    Map<String, String>? tags,
    CentralizationRuleForOrganizationTimeouts? timeouts,
  }) :
      region = pulumi.Input.asOptionalInput<String>(region),
      rule = pulumi.Input.asInput<CentralizationRuleForOrganizationRule>(rule),
  ...
  factory CentralizationRuleForOrganizationArgs.fromMap(Map<String, dynamic> map) {
    return CentralizationRuleForOrganizationArgs(
      ...
      rule: CentralizationRuleForOrganizationRule.fromMap((map['rule'] as Map).cast<String, dynamic>()),
      ruleName: map['ruleName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : CentralizationRuleForOrganizationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
