...
class AccountArgs {
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      closeOnDeletion: map['closeOnDeletion'] == null ? null : map['closeOnDeletion'] as bool,
      createGovcloud: map['createGovcloud'] == null ? null : map['createGovcloud'] as bool,
      email: map['email'] as String,
      iamUserAccessToBilling: map['iamUserAccessToBilling'] == null ? null : map['iamUserAccessToBilling'] as String,
