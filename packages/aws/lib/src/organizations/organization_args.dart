...
class OrganizationArgs {
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      awsServiceAccessPrincipals: map['awsServiceAccessPrincipals'] == null ? null : (map['awsServiceAccessPrincipals'] as List).cast<String>(),
      enabledPolicyTypes: map['enabledPolicyTypes'] == null ? null : (map['enabledPolicyTypes'] as List).cast<String>(),
