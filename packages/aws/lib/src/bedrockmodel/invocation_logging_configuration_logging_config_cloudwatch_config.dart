...
class InvocationLoggingConfigurationLoggingConfigCloudwatchConfig {
  ...
  final InvocationLoggingConfigurationLoggingConfigCloudwatchConfigLargeDataDeliveryS3Config? largeDataDeliveryS3Config;
  /// Log group name.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'largeDataDeliveryS3Config': ?largeDataDeliveryS3Config == null ? null : largeDataDeliveryS3Config!.toMap(),
  ...
  factory InvocationLoggingConfigurationLoggingConfigCloudwatchConfig.fromMap(Map<String, dynamic> map) {
    return InvocationLoggingConfigurationLoggingConfigCloudwatchConfig(
      largeDataDeliveryS3Config: map['largeDataDeliveryS3Config'] == null ? null : InvocationLoggingConfigurationLoggingConfigCloudwatchConfigLargeDataDeliveryS3Config.fromMap((map['largeDataDeliveryS3Config'] as Map).cast<String, dynamic>()),
