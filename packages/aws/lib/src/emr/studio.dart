...
class Studio extends pulumi.CustomResource {
  ...
  Studio(
    ...
    this.engineSecurityGroupId = registerOutput<String>('engineSecurityGroupId');
    this.idpAuthUrl = registerOutput<String?>('idpAuthUrl');
    this.idpRelayStateParameterName = registerOutput<String?>('idpRelayStateParameterName');
