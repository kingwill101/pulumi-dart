...
class InstanceFleetArgs {
  ...
  InstanceFleetArgs({
    ...
    int? targetSpotCapacity,
       ...
       targetOnDemandCapacity = pulumi.Input.asOptionalInput<int>(
         targetOnDemandCapacity,
       ),
       targetSpotCapacity = pulumi.Input.asOptionalInput<int>(
         targetSpotCapacity,
       );
  ...
  factory InstanceFleetArgs.fromMap(Map<String, dynamic> map) {
    return InstanceFleetArgs(
      ...
      instanceTypeConfigs: map['instanceTypeConfigs'] == null
          ? null
          : pulumi.Input.decodeList<InstanceFleetInstanceTypeConfig>(
              map['instanceTypeConfigs'],
              (value) => InstanceFleetInstanceTypeConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
      launchSpecifications: map['launchSpecifications'] == null
          ? null
          : InstanceFleetLaunchSpecifications.fromMap(
