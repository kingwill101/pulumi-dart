...
class ClusterEc2Attributes {
  ...
  factory ClusterEc2Attributes.fromMap(Map<String, dynamic> map) {
    return ClusterEc2Attributes(
      additionalMasterSecurityGroups: map['additionalMasterSecurityGroups'] == null ? null : map['additionalMasterSecurityGroups'] as String,
      additionalSlaveSecurityGroups: map['additionalSlaveSecurityGroups'] == null ? null : map['additionalSlaveSecurityGroups'] as String,
