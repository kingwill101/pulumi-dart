...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    bool? visibleToAllUsers,
       ...
       configurationsJson = pulumi.Input.asOptionalInput<String>(
         configurationsJson,
       ),
       coreInstanceFleet = pulumi
           .Input.asOptionalInput<ClusterCoreInstanceFleet>(coreInstanceFleet),
       coreInstanceGroup = pulumi
           .Input.asOptionalInput<ClusterCoreInstanceGroup>(coreInstanceGroup),
       ...
       listStepsStates = pulumi.Input.asOptionalInput<List<String>>(
         listStepsStates,
       ),
       logEncryptionKmsKeyId = pulumi.Input.asOptionalInput<String>(
       ...
       scaleDownBehavior = pulumi.Input.asOptionalInput<String>(
         scaleDownBehavior,
       ),
       ...
       stepConcurrencyLevel = pulumi.Input.asOptionalInput<int>(
         stepConcurrencyLevel,
       ),
       steps = pulumi.Input.asOptionalInput<List<ClusterStep>>(steps),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       terminationProtection = pulumi.Input.asOptionalInput<bool>(
         terminationProtection,
       ),
       unhealthyNodeReplacement = pulumi.Input.asOptionalInput<bool>(
         unhealthyNodeReplacement,
       ),
       visibleToAllUsers = pulumi.Input.asOptionalInput<bool>(
         visibleToAllUsers,
       );
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      customAmiId: map['customAmiId'] == null
          ? null
          : map['customAmiId'] as String,
