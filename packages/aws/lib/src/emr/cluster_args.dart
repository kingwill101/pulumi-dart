...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      additionalInfo: map['additionalInfo'] == null ? null : map['additionalInfo'] as String,
      applications: map['applications'] == null ? null : (map['applications'] as List).cast<String>(),
      autoTerminationPolicy: map['autoTerminationPolicy'] == null ? null : ClusterAutoTerminationPolicy.fromMap((map['autoTerminationPolicy'] as Map).cast<String, dynamic>()),
      autoscalingRole: map['autoscalingRole'] == null ? null : map['autoscalingRole'] as String,
      bootstrapActions: map['bootstrapActions'] == null ? null : pulumi.Input.decodeList<ClusterBootstrapAction>(map['bootstrapActions'], (value) => ClusterBootstrapAction.fromMap((value as Map).cast<String, dynamic>())),
      configurations: map['configurations'] == null ? null : map['configurations'] as String,
      configurationsJson: map['configurationsJson'] == null ? null : map['configurationsJson'] as String,
      coreInstanceFleet: map['coreInstanceFleet'] == null ? null : ClusterCoreInstanceFleet.fromMap((map['coreInstanceFleet'] as Map).cast<String, dynamic>()),
      coreInstanceGroup: map['coreInstanceGroup'] == null ? null : ClusterCoreInstanceGroup.fromMap((map['coreInstanceGroup'] as Map).cast<String, dynamic>()),
      ...
      ec2Attributes: map['ec2Attributes'] == null ? null : ClusterEc2Attributes.fromMap((map['ec2Attributes'] as Map).cast<String, dynamic>()),
      keepJobFlowAliveWhenNoSteps: map['keepJobFlowAliveWhenNoSteps'] == null ? null : map['keepJobFlowAliveWhenNoSteps'] as bool,
      kerberosAttributes: map['kerberosAttributes'] == null ? null : ClusterKerberosAttributes.fromMap((map['kerberosAttributes'] as Map).cast<String, dynamic>()),
      listStepsStates: map['listStepsStates'] == null ? null : (map['listStepsStates'] as List).cast<String>(),
      ...
      masterInstanceFleet: map['masterInstanceFleet'] == null ? null : ClusterMasterInstanceFleet.fromMap((map['masterInstanceFleet'] as Map).cast<String, dynamic>()),
      masterInstanceGroup: map['masterInstanceGroup'] == null ? null : ClusterMasterInstanceGroup.fromMap((map['masterInstanceGroup'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      osReleaseLabel: map['osReleaseLabel'] == null ? null : map['osReleaseLabel'] as String,
      placementGroupConfigs: map['placementGroupConfigs'] == null ? null : pulumi.Input.decodeList<ClusterPlacementGroupConfig>(map['placementGroupConfigs'], (value) => ClusterPlacementGroupConfig.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      releaseLabel: map['releaseLabel'] as String,
      scaleDownBehavior: map['scaleDownBehavior'] == null ? null : map['scaleDownBehavior'] as String,
      ...
      steps: map['steps'] == null ? null : pulumi.Input.decodeList<ClusterStep>(map['steps'], (value) => ClusterStep.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      terminationProtection: map['terminationProtection'] == null ? null : map['terminationProtection'] as bool,
