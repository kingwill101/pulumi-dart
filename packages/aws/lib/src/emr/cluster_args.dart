...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterAutoTerminationPolicy? autoTerminationPolicy,
    String? autoscalingRole,
    List<ClusterBootstrapAction>? bootstrapActions,
    String? configurations,
    String? configurationsJson,
    ClusterCoreInstanceFleet? coreInstanceFleet,
    ClusterCoreInstanceGroup? coreInstanceGroup,
    String? customAmiId,
    int? ebsRootVolumeSize,
    ClusterEc2Attributes? ec2Attributes,
    bool? keepJobFlowAliveWhenNoSteps,
    ClusterKerberosAttributes? kerberosAttributes,
    List<String>? listStepsStates,
    String? logEncryptionKmsKeyId,
    String? logUri,
    ClusterMasterInstanceFleet? masterInstanceFleet,
    ClusterMasterInstanceGroup? masterInstanceGroup,
    String? name,
    String? osReleaseLabel,
    List<ClusterPlacementGroupConfig>? placementGroupConfigs,
    String? region,
    ...
    bool? visibleToAllUsers,
        ...
        configurationsJson =
            pulumi.Input.asOptionalInput<String>(configurationsJson),
        coreInstanceFleet =
            pulumi.Input.asOptionalInput<ClusterCoreInstanceFleet>(
                coreInstanceFleet),
        coreInstanceGroup =
            pulumi.Input.asOptionalInput<ClusterCoreInstanceGroup>(
                coreInstanceGroup),
        customAmiId = pulumi.Input.asOptionalInput<String>(customAmiId),
        ebsRootVolumeSize =
            pulumi.Input.asOptionalInput<int>(ebsRootVolumeSize),
        ec2Attributes =
            pulumi.Input.asOptionalInput<ClusterEc2Attributes>(ec2Attributes),
        keepJobFlowAliveWhenNoSteps =
            pulumi.Input.asOptionalInput<bool>(keepJobFlowAliveWhenNoSteps),
        kerberosAttributes =
            pulumi.Input.asOptionalInput<ClusterKerberosAttributes>(
                kerberosAttributes),
        listStepsStates =
            pulumi.Input.asOptionalInput<List<String>>(listStepsStates),
        logEncryptionKmsKeyId =
            pulumi.Input.asOptionalInput<String>(logEncryptionKmsKeyId),
        ...
        scaleDownBehavior =
            pulumi.Input.asOptionalInput<String>(scaleDownBehavior),
        securityConfiguration =
            pulumi.Input.asOptionalInput<String>(securityConfiguration),
        serviceRole = pulumi.Input.asInput<String>(serviceRole),
        stepConcurrencyLevel =
            pulumi.Input.asOptionalInput<int>(stepConcurrencyLevel),
        steps = pulumi.Input.asOptionalInput<List<ClusterStep>>(steps),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        terminationProtection =
            pulumi.Input.asOptionalInput<bool>(terminationProtection),
        unhealthyNodeReplacement =
            pulumi.Input.asOptionalInput<bool>(unhealthyNodeReplacement),
        visibleToAllUsers =
            pulumi.Input.asOptionalInput<bool>(visibleToAllUsers);
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      additionalInfo: map['additionalInfo'] == null
          ? null
          : map['additionalInfo'] as String,
      applications: map['applications'] == null
          ? null
          : (map['applications'] as List).cast<String>(),
      autoTerminationPolicy: map['autoTerminationPolicy'] == null
          ? null
          : ClusterAutoTerminationPolicy.fromMap(
              (map['autoTerminationPolicy'] as Map).cast<String, dynamic>()),
      autoscalingRole: map['autoscalingRole'] == null
          ? null
          : map['autoscalingRole'] as String,
      bootstrapActions: map['bootstrapActions'] == null
          ? null
      ...
      configurations: map['configurations'] == null
          ? null
          : map['configurations'] as String,
      configurationsJson: map['configurationsJson'] == null
          ? null
          : map['configurationsJson'] as String,
      coreInstanceFleet: map['coreInstanceFleet'] == null
          ? null
          : ClusterCoreInstanceFleet.fromMap(
              (map['coreInstanceFleet'] as Map).cast<String, dynamic>()),
      coreInstanceGroup: map['coreInstanceGroup'] == null
          ? null
          : ClusterCoreInstanceGroup.fromMap(
              (map['coreInstanceGroup'] as Map).cast<String, dynamic>()),
      customAmiId:
          map['customAmiId'] == null ? null : map['customAmiId'] as String,
      ebsRootVolumeSize: map['ebsRootVolumeSize'] == null
          ? null
          : map['ebsRootVolumeSize'] as int,
      ec2Attributes: map['ec2Attributes'] == null
          ? null
          : ClusterEc2Attributes.fromMap(
              (map['ec2Attributes'] as Map).cast<String, dynamic>()),
      keepJobFlowAliveWhenNoSteps: map['keepJobFlowAliveWhenNoSteps'] == null
          ? null
          : map['keepJobFlowAliveWhenNoSteps'] as bool,
      kerberosAttributes: map['kerberosAttributes'] == null
          ? null
          : ClusterKerberosAttributes.fromMap(
              (map['kerberosAttributes'] as Map).cast<String, dynamic>()),
      listStepsStates: map['listStepsStates'] == null
          ? null
          : (map['listStepsStates'] as List).cast<String>(),
      logEncryptionKmsKeyId: map['logEncryptionKmsKeyId'] == null
          ? null
          : map['logEncryptionKmsKeyId'] as String,
      logUri: map['logUri'] == null ? null : map['logUri'] as String,
      masterInstanceFleet: map['masterInstanceFleet'] == null
          ? null
          : ClusterMasterInstanceFleet.fromMap(
              (map['masterInstanceFleet'] as Map).cast<String, dynamic>()),
      masterInstanceGroup: map['masterInstanceGroup'] == null
          ? null
          : ClusterMasterInstanceGroup.fromMap(
              (map['masterInstanceGroup'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      osReleaseLabel: map['osReleaseLabel'] == null
          ? null
          : map['osReleaseLabel'] as String,
      placementGroupConfigs: map['placementGroupConfigs'] == null
          ? null
      ...
      scaleDownBehavior: map['scaleDownBehavior'] == null
          ? null
          : map['scaleDownBehavior'] as String,
      ...
      stepConcurrencyLevel: map['stepConcurrencyLevel'] == null
          ? null
          : map['stepConcurrencyLevel'] as int,
      ...
      terminationProtection: map['terminationProtection'] == null
          ? null
          : map['terminationProtection'] as bool,
      unhealthyNodeReplacement: map['unhealthyNodeReplacement'] == null
          ? null
          : map['unhealthyNodeReplacement'] as bool,
      visibleToAllUsers: map['visibleToAllUsers'] == null
          ? null
          : map['visibleToAllUsers'] as bool,
    );
  }
}
