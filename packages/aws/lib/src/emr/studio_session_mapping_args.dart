...
class StudioSessionMappingArgs {
  ...
  factory StudioSessionMappingArgs.fromMap(Map<String, dynamic> map) {
    return StudioSessionMappingArgs(
      identityId: map['identityId'] == null
          ? null
          : map['identityId'] as String,
      identityName: map['identityName'] == null
          ? null
          : map['identityName'] as String,
      identityType: map['identityType'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      sessionPolicyArn: map['sessionPolicyArn'] as String,
