...
class BlockPublicAccessConfigurationArgs {
  ...
  BlockPublicAccessConfigurationArgs({
    ...
    List<BlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRange>? permittedPublicSecurityGroupRuleRanges,
    String? region,
  }) :
  ...
  factory BlockPublicAccessConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return BlockPublicAccessConfigurationArgs(
      blockPublicSecurityGroupRules: map['blockPublicSecurityGroupRules'] as bool,
