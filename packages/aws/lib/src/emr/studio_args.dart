...
class StudioArgs {
  ...
  StudioArgs({
    ...
    required String workspaceSecurityGroupId,
        ...
        engineSecurityGroupId =
            pulumi.Input.asInput<String>(engineSecurityGroupId),
        idpAuthUrl = pulumi.Input.asOptionalInput<String>(idpAuthUrl),
        idpRelayStateParameterName =
            pulumi.Input.asOptionalInput<String>(idpRelayStateParameterName),
        ...
        workspaceSecurityGroupId =
            pulumi.Input.asInput<String>(workspaceSecurityGroupId);
  ...
  factory StudioArgs.fromMap(Map<String, dynamic> map) {
    return StudioArgs(
      ...
      idpAuthUrl:
          map['idpAuthUrl'] == null ? null : map['idpAuthUrl'] as String,
      idpRelayStateParameterName: map['idpRelayStateParameterName'] == null
          ? null
          : map['idpRelayStateParameterName'] as String,
