...
class StudioArgs {
  ...
  StudioArgs({
    ...
    required String workspaceSecurityGroupId,
       ...
       engineSecurityGroupId = pulumi.Input.asInput<String>(
       ...
       workspaceSecurityGroupId = pulumi.Input.asInput<String>(
  ...
  factory StudioArgs.fromMap(Map<String, dynamic> map) {
    return StudioArgs(
      ...
      idpAuthUrl: map['idpAuthUrl'] == null
          ? null
          : map['idpAuthUrl'] as String,
