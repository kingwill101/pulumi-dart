...
class ClusterKerberosAttributes {
  ...
  Map<String, dynamic> toMap() {
    ...
    final adDomainJoinPasswordValue = adDomainJoinPassword;
    if (adDomainJoinPasswordValue != null) {
      map['adDomainJoinPassword'] = adDomainJoinPasswordValue;
    }
    final adDomainJoinUserValue = adDomainJoinUser;
    if (adDomainJoinUserValue != null) {
      map['adDomainJoinUser'] = adDomainJoinUserValue;
    }
    final crossRealmTrustPrincipalPasswordValue =
        crossRealmTrustPrincipalPassword;
    if (crossRealmTrustPrincipalPasswordValue != null) {
      map['crossRealmTrustPrincipalPassword'] =
          crossRealmTrustPrincipalPasswordValue;
    }
    map['kdcAdminPassword'] = kdcAdminPassword;
    map['realm'] = realm;
    return map;
  }
  ...
  factory ClusterKerberosAttributes.fromMap(Map<String, dynamic> map) {
    return ClusterKerberosAttributes(
      adDomainJoinPassword: map['adDomainJoinPassword'] == null
          ? null
          : map['adDomainJoinPassword'] as String,
      adDomainJoinUser: map['adDomainJoinUser'] == null
          ? null
          : map['adDomainJoinUser'] as String,
      crossRealmTrustPrincipalPassword:
          map['crossRealmTrustPrincipalPassword'] == null
              ? null
              : map['crossRealmTrustPrincipalPassword'] as String,
      kdcAdminPassword: map['kdcAdminPassword'] as String,
