...
class ClusterCoreInstanceFleetInstanceTypeConfig {
  ...
  final List<ClusterCoreInstanceFleetInstanceTypeConfigConfiguration>?
  configurations;
  ...
  factory ClusterCoreInstanceFleetInstanceTypeConfig.fromMap(
      ...
      configurations: map['configurations'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['configurations'],
              (value) =>
                  ClusterCoreInstanceFleetInstanceTypeConfigConfiguration.fromMap(
      ...
      ebsConfigs: map['ebsConfigs'] == null
          ...
          : pulumi.Input.decodeList<
            ...
            >(
              map['ebsConfigs'],
              (value) =>
                  ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
            ),
