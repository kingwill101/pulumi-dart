...
class ManagedScalingPolicyArgs {
  ...
  ManagedScalingPolicyArgs({
    ...
    required List<ManagedScalingPolicyComputeLimit> computeLimits,
    String? region,
    String? scalingStrategy,
    int? utilizationPerformanceIndex,
  }) :
  ...
  factory ManagedScalingPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ManagedScalingPolicyArgs(
      ...
      computeLimits: pulumi.Input.decodeList<ManagedScalingPolicyComputeLimit>(map['computeLimits'], (value) => ManagedScalingPolicyComputeLimit.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      scalingStrategy: map['scalingStrategy'] == null ? null : map['scalingStrategy'] as String,
      utilizationPerformanceIndex: map['utilizationPerformanceIndex'] == null ? null : map['utilizationPerformanceIndex'] as int,
    );
  }
}
