...
class ManagedScalingPolicyArgs {
  ...
  ManagedScalingPolicyArgs({
    ...
    int? utilizationPerformanceIndex,
       ...
       utilizationPerformanceIndex = pulumi.Input.asOptionalInput<int>(
         utilizationPerformanceIndex,
       );
  ...
  factory ManagedScalingPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ManagedScalingPolicyArgs(
      ...
      computeLimits: pulumi.Input.decodeList<ManagedScalingPolicyComputeLimit>(
        map['computeLimits'],
      ...
      scalingStrategy: map['scalingStrategy'] == null
          ? null
          : map['scalingStrategy'] as String,
      utilizationPerformanceIndex: map['utilizationPerformanceIndex'] == null
          ? null
          : map['utilizationPerformanceIndex'] as int,
    );
  }
}
