...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.autoTerminationPolicy = registerOutput<ClusterAutoTerminationPolicy?>(
      'autoTerminationPolicy',
    );
    this.autoscalingRole = registerOutput<String?>('autoscalingRole');
    this.bootstrapActions = registerOutput<List<ClusterBootstrapAction>?>(
      'bootstrapActions',
    );
    ...
    this.coreInstanceFleet = registerOutput<ClusterCoreInstanceFleet>(
      'coreInstanceFleet',
    );
    this.coreInstanceGroup = registerOutput<ClusterCoreInstanceGroup>(
      'coreInstanceGroup',
    );
    ...
    this.keepJobFlowAliveWhenNoSteps = registerOutput<bool>(
      'keepJobFlowAliveWhenNoSteps',
    );
    this.kerberosAttributes = registerOutput<ClusterKerberosAttributes?>(
      'kerberosAttributes',
    );
    this.listStepsStates = registerOutput<List<String>?>('listStepsStates');
    this.logEncryptionKmsKeyId = registerOutput<String?>(
      'logEncryptionKmsKeyId',
    );
    this.logUri = registerOutput<String?>('logUri');
    this.masterInstanceFleet = registerOutput<ClusterMasterInstanceFleet>(
      'masterInstanceFleet',
    );
    this.masterInstanceGroup = registerOutput<ClusterMasterInstanceGroup>(
      'masterInstanceGroup',
    );
    ...
    this.securityConfiguration = registerOutput<String?>(
    ...
    this.unhealthyNodeReplacement = registerOutput<bool?>(
