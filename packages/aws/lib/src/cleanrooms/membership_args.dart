...
class MembershipArgs {
  ...
  factory MembershipArgs.fromMap(Map<String, dynamic> map) {
    return MembershipArgs(
      ...
      defaultResultConfiguration: map['defaultResultConfiguration'] == null
          ? null
          : MembershipDefaultResultConfiguration.fromMap(
              (map['defaultResultConfiguration'] as Map)
                  .cast<String, dynamic>(),
            ),
      paymentConfiguration: map['paymentConfiguration'] == null
          ? null
          : MembershipPaymentConfiguration.fromMap(
              (map['paymentConfiguration'] as Map).cast<String, dynamic>(),
            ),
