...
class CollaborationArgs {
  ...
  factory CollaborationArgs.fromMap(Map<String, dynamic> map) {
    return CollaborationArgs(
      analyticsEngine: map['analyticsEngine'] == null ? null : map['analyticsEngine'] as String,
      creatorDisplayName: map['creatorDisplayName'] as String,
      creatorMemberAbilities: (map['creatorMemberAbilities'] as List).cast<String>(),
      dataEncryptionMetadata: map['dataEncryptionMetadata'] == null ? null : CollaborationDataEncryptionMetadata.fromMap((map['dataEncryptionMetadata'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      members: map['members'] == null ? null : pulumi.Input.decodeList<CollaborationMember>(map['members'], (value) => CollaborationMember.fromMap((value as Map).cast<String, dynamic>())),
