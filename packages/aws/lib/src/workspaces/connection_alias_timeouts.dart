...
class ConnectionAliasTimeouts {
  ...
  /// Creates a new [ConnectionAliasTimeouts].
  ...
  ConnectionAliasTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory ConnectionAliasTimeouts.fromMap(Map<String, dynamic> map) {
    return ConnectionAliasTimeouts(
