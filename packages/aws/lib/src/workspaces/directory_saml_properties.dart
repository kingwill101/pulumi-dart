...
class DirectorySamlProperties {
  ...
  factory DirectorySamlProperties.fromMap(Map<String, dynamic> map) {
    return DirectorySamlProperties(
      relayStateParameterName: map['relayStateParameterName'] == null ? null : map['relayStateParameterName'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      userAccessUrl: map['userAccessUrl'] == null ? null : map['userAccessUrl'] as String,
    );
  }
}
