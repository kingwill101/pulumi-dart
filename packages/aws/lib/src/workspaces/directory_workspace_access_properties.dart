...
class DirectoryWorkspaceAccessProperties {
  ...
  Map<String, dynamic> toMap() {
    ...
    final deviceTypeAndroidValue = deviceTypeAndroid;
    if (deviceTypeAndroidValue != null) {
      map['deviceTypeAndroid'] = deviceTypeAndroidValue;
    }
    final deviceTypeChromeosValue = deviceTypeChromeos;
    if (deviceTypeChromeosValue != null) {
      map['deviceTypeChromeos'] = deviceTypeChromeosValue;
    }
    final deviceTypeIosValue = deviceTypeIos;
    if (deviceTypeIosValue != null) {
      map['deviceTypeIos'] = deviceTypeIosValue;
    }
    final deviceTypeLinuxValue = deviceTypeLinux;
    if (deviceTypeLinuxValue != null) {
      map['deviceTypeLinux'] = deviceTypeLinuxValue;
    }
    final deviceTypeOsxValue = deviceTypeOsx;
    if (deviceTypeOsxValue != null) {
      map['deviceTypeOsx'] = deviceTypeOsxValue;
    }
    final deviceTypeWebValue = deviceTypeWeb;
    if (deviceTypeWebValue != null) {
      map['deviceTypeWeb'] = deviceTypeWebValue;
    }
    final deviceTypeWindowsValue = deviceTypeWindows;
    if (deviceTypeWindowsValue != null) {
      map['deviceTypeWindows'] = deviceTypeWindowsValue;
    }
    final deviceTypeZeroclientValue = deviceTypeZeroclient;
    if (deviceTypeZeroclientValue != null) {
      map['deviceTypeZeroclient'] = deviceTypeZeroclientValue;
    }
    return map;
  }
  ...
  factory DirectoryWorkspaceAccessProperties.fromMap(Map<String, dynamic> map) {
    return DirectoryWorkspaceAccessProperties(
      ...
      deviceTypeIos:
          map['deviceTypeIos'] == null ? null : map['deviceTypeIos'] as String,
      deviceTypeLinux: map['deviceTypeLinux'] == null
          ? null
          : map['deviceTypeLinux'] as String,
      deviceTypeOsx:
          map['deviceTypeOsx'] == null ? null : map['deviceTypeOsx'] as String,
      deviceTypeWeb:
          map['deviceTypeWeb'] == null ? null : map['deviceTypeWeb'] as String,
