...
class Directory extends pulumi.CustomResource {
  ...
  Directory(
    ...
    this.samlProperties = registerOutput<DirectorySamlProperties>(
      'samlProperties',
    );
    ...
    this.workspaceDirectoryDescription = registerOutput<String?>(
      'workspaceDirectoryDescription',
    );
    this.workspaceDirectoryName = registerOutput<String?>(
