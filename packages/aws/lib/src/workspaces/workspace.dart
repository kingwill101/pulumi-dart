...
class Workspace extends pulumi.CustomResource {
  ...
  Workspace(
    ...
    this.rootVolumeEncryptionEnabled = registerOutput<bool?>(
    ...
    this.userVolumeEncryptionEnabled = registerOutput<bool?>(
      'userVolumeEncryptionEnabled',
    );
    this.volumeEncryptionKey = registerOutput<String?>('volumeEncryptionKey');
    this.workspaceProperties = registerOutput<WorkspaceWorkspaceProperties>(
      'workspaceProperties',
    );
  }
}
