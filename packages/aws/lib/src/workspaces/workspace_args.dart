...
class WorkspaceArgs {
  ...
  factory WorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceArgs(
      ...
      rootVolumeEncryptionEnabled: map['rootVolumeEncryptionEnabled'] == null ? null : map['rootVolumeEncryptionEnabled'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userName: map['userName'] as String,
      userVolumeEncryptionEnabled: map['userVolumeEncryptionEnabled'] == null ? null : map['userVolumeEncryptionEnabled'] as bool,
      volumeEncryptionKey: map['volumeEncryptionKey'] == null ? null : map['volumeEncryptionKey'] as String,
      workspaceProperties: map['workspaceProperties'] == null ? null : WorkspaceWorkspaceProperties.fromMap((map['workspaceProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
