  ...
  WorkspaceArgs({
    ...
    WorkspaceWorkspaceProperties? workspaceProperties,
        ...
        rootVolumeEncryptionEnabled =
            pulumi.Input.asOptionalInput<bool>(rootVolumeEncryptionEnabled),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        userName = pulumi.Input.asInput<String>(userName),
        userVolumeEncryptionEnabled =
            pulumi.Input.asOptionalInput<bool>(userVolumeEncryptionEnabled),
        volumeEncryptionKey =
            pulumi.Input.asOptionalInput<String>(volumeEncryptionKey),
        workspaceProperties =
