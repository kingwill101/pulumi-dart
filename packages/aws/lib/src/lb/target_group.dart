...
class TargetGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<TargetGroupTargetHealthState>>
  targetHealthStates;
  ...
  /// [args] Arguments used to configure this [TargetGroup]. {@macro pulumi_lb_target_group_target_group_args_doc}
  ...
  TargetGroup(
    ...
    this.lambdaMultiValueHeadersEnabled = registerOutput<bool?>(
      'lambdaMultiValueHeadersEnabled',
    );
    this.loadBalancerArns = registerOutput<List<String>>('loadBalancerArns');
    this.loadBalancingAlgorithmType = registerOutput<String>(
      'loadBalancingAlgorithmType',
    );
    this.loadBalancingAnomalyMitigation = registerOutput<String>(
      'loadBalancingAnomalyMitigation',
    );
    this.loadBalancingCrossZoneEnabled = registerOutput<String>(
    ...
    this.targetFailovers = registerOutput<List<TargetGroupTargetFailover>>(
      'targetFailovers',
    );
    this.targetGroupHealth = registerOutput<TargetGroupTargetGroupHealth>(
      'targetGroupHealth',
    );
