...
class GetListenerRuleAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jwtValidations': ?jwtValidations == null
          ? null
          : pulumi.Input.encodeList<
