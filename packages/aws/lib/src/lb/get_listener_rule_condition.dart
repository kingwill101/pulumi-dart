...
class GetListenerRuleCondition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hostHeaders': ?hostHeaders == null
          ? null
          : pulumi.Input.encodeList<
              GetListenerRuleConditionHostHeader,
              Map<String, dynamic>
            >(hostHeaders!, (value) => value.toMap()),
      ...
      'httpRequestMethods': ?httpRequestMethods == null
          ...
          : pulumi.Input.encodeList<
              ...
              Map<String, dynamic>
            >(httpRequestMethods!, (value) => value.toMap()),
      'pathPatterns': ?pathPatterns == null
          ? null
          : pulumi.Input.encodeList<
              GetListenerRuleConditionPathPattern,
              Map<String, dynamic>
            >(pathPatterns!, (value) => value.toMap()),
      ...
      'sourceIps': ?sourceIps == null
          ? null
          : pulumi.Input.encodeList<
              GetListenerRuleConditionSourceIp,
              Map<String, dynamic>
            >(sourceIps!, (value) => value.toMap()),
    };
  }
