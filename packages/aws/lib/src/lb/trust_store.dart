...
class TrustStore extends pulumi.CustomResource {
  ...
  TrustStore(
    ...
    this.caCertificatesBundleS3Bucket = registerOutput<String>(
      'caCertificatesBundleS3Bucket',
    );
    this.caCertificatesBundleS3Key = registerOutput<String>(
      'caCertificatesBundleS3Key',
    );
    this.caCertificatesBundleS3ObjectVersion = registerOutput<String?>(
