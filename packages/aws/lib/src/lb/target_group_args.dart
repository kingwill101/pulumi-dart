...
class TargetGroupArgs {
  ...
  TargetGroupArgs({
    ...
    String? targetType,
    String? vpcId,
  }) : connectionTermination = pulumi.Input.asOptionalInput<bool>(
         connectionTermination,
       ),
       deregistrationDelay = pulumi.Input.asOptionalInput<int>(
         deregistrationDelay,
       ),
       ...
       preserveClientIp = pulumi.Input.asOptionalInput<String>(
         preserveClientIp,
       ),
