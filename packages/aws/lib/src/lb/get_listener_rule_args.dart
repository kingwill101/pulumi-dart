...
class GetListenerRuleArgs {
  ...
  GetListenerRuleArgs({
    ...
    List<GetListenerRuleTransform>? transforms,
       ...
       conditions = pulumi
           .Input.asOptionalInput<List<GetListenerRuleCondition>>(conditions),
       listenerArn = pulumi.Input.asOptionalInput<String>(listenerArn),
       priority = pulumi.Input.asOptionalInput<int>(priority),
       region = pulumi.Input.asOptionalInput<String>(region),
       transforms = pulumi
           .Input.asOptionalInput<List<GetListenerRuleTransform>>(transforms);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleAction>,
  ...
  factory GetListenerRuleArgs.fromMap(Map<String, dynamic> map) {
    return GetListenerRuleArgs(
      ...
      listenerArn: map['listenerArn'] == null
          ? null
          : map['listenerArn'] as String,
