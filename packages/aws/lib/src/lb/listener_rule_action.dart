...
class ListenerRuleAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authenticateCognito': ?authenticateCognito == null ? null : authenticateCognito!.toMap(),
      'authenticateOidc': ?authenticateOidc == null ? null : authenticateOidc!.toMap(),
  ...
  factory ListenerRuleAction.fromMap(Map<String, dynamic> map) {
    return ListenerRuleAction(
      authenticateCognito: map['authenticateCognito'] == null ? null : ListenerRuleActionAuthenticateCognito.fromMap((map['authenticateCognito'] as Map).cast<String, dynamic>()),
      authenticateOidc: map['authenticateOidc'] == null ? null : ListenerRuleActionAuthenticateOidc.fromMap((map['authenticateOidc'] as Map).cast<String, dynamic>()),
      ...
      jwtValidation: map['jwtValidation'] == null ? null : ListenerRuleActionJwtValidation.fromMap((map['jwtValidation'] as Map).cast<String, dynamic>()),
      order: map['order'] == null ? null : map['order'] as int,
      redirect: map['redirect'] == null ? null : ListenerRuleActionRedirect.fromMap((map['redirect'] as Map).cast<String, dynamic>()),
