...
class Listener extends pulumi.CustomResource {
  ...
  Listener(
    ...
    this.defaultActions = registerOutput<List<ListenerDefaultAction>>(
      'defaultActions',
    );
    this.loadBalancerArn = registerOutput<String>('loadBalancerArn');
    this.mutualAuthentication = registerOutput<ListenerMutualAuthentication>(
      'mutualAuthentication',
    );
    ...
    this.routingHttpRequestXAmznTlsVersionHeaderName = registerOutput<String>(
    ...
    this.routingHttpResponseServerEnabled = registerOutput<bool>(
    ...
    this.routingHttpResponseXFrameOptionsHeaderValue = registerOutput<String>(
