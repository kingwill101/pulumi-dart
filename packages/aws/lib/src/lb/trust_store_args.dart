...
class TrustStoreArgs {
  ...
  }) : caCertificatesBundleS3Bucket = pulumi.Input.asInput<String>(
         caCertificatesBundleS3Bucket,
       ),
       caCertificatesBundleS3Key = pulumi.Input.asInput<String>(
         caCertificatesBundleS3Key,
       ),
       caCertificatesBundleS3ObjectVersion = pulumi
           .Input.asOptionalInput<String>(caCertificatesBundleS3ObjectVersion),
  ...
  factory TrustStoreArgs.fromMap(Map<String, dynamic> map) {
    return TrustStoreArgs(
      caCertificatesBundleS3Bucket:
          map['caCertificatesBundleS3Bucket'] as String,
      caCertificatesBundleS3Key: map['caCertificatesBundleS3Key'] as String,
      caCertificatesBundleS3ObjectVersion:
          map['caCertificatesBundleS3ObjectVersion'] == null
          ? null
          : map['caCertificatesBundleS3ObjectVersion'] as String,
