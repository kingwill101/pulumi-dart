...
class LaunchArgs {
  ...
  LaunchArgs({
    ...
    Map<String, String>? tags,
       ...
       randomizationSalt = pulumi.Input.asOptionalInput<String>(
         randomizationSalt,
       ),
  ...
  factory LaunchArgs.fromMap(Map<String, dynamic> map) {
    return LaunchArgs(
      ...
      groups: pulumi.Input.decodeList<LaunchGroup>(
        map['groups'],
        (value) => LaunchGroup.fromMap((value as Map).cast<String, dynamic>()),
      ),
      metricMonitors: map['metricMonitors'] == null
          ? null
      ...
      randomizationSalt: map['randomizationSalt'] == null
          ? null
          : map['randomizationSalt'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      scheduledSplitsConfig: map['scheduledSplitsConfig'] == null
          ? null
          : LaunchScheduledSplitsConfig.fromMap(
              (map['scheduledSplitsConfig'] as Map).cast<String, dynamic>(),
            ),
      tags: map['tags'] == null
          ? null
