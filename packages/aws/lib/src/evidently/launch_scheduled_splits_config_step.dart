...
class LaunchScheduledSplitsConfigStep {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'segmentOverrides': ?segmentOverrides == null ? null : pulumi.Input.encodeList<LaunchScheduledSplitsConfigStepSegmentOverride, Map<String, dynamic>>(segmentOverrides!, (value) => value.toMap()),
      'startTime': startTime,
    };
  }
  ...
  factory LaunchScheduledSplitsConfigStep.fromMap(Map<String, dynamic> map) {
    return LaunchScheduledSplitsConfigStep(
      ...
      segmentOverrides: map['segmentOverrides'] == null ? null : pulumi.Input.decodeList<LaunchScheduledSplitsConfigStepSegmentOverride>(map['segmentOverrides'], (value) => LaunchScheduledSplitsConfigStepSegmentOverride.fromMap((value as Map).cast<String, dynamic>())),
