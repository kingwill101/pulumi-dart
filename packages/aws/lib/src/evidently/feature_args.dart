...
class FeatureArgs {
  ...
  FeatureArgs({
    ...
    required List<FeatureVariation> variations,
  })  : defaultVariation =
            pulumi.Input.asOptionalInput<String>(defaultVariation),
        description = pulumi.Input.asOptionalInput<String>(description),
        entityOverrides =
            pulumi.Input.asOptionalInput<Map<String, String>>(entityOverrides),
        evaluationStrategy =
            pulumi.Input.asOptionalInput<String>(evaluationStrategy),
  ...
  Map<String, dynamic> toMap() {
    ...
    map['variations'] = pulumi.Input.mapInputValue<List<FeatureVariation>,
            List<Map<String, dynamic>>>(
        variations,
        (value) =>
            pulumi.Input.encodeList<FeatureVariation, Map<String, dynamic>>(
  ...
  factory FeatureArgs.fromMap(Map<String, dynamic> map) {
    return FeatureArgs(
      defaultVariation: map['defaultVariation'] == null
          ? null
          : map['defaultVariation'] as String,
      description:
          map['description'] == null ? null : map['description'] as String,
      entityOverrides: map['entityOverrides'] == null
          ? null
          : (map['entityOverrides'] as Map).cast<String, String>(),
      evaluationStrategy: map['evaluationStrategy'] == null
          ? null
          : map['evaluationStrategy'] as String,
      ...
      variations: pulumi.Input.decodeList<FeatureVariation>(
          map['variations'],
          (value) =>
              FeatureVariation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
