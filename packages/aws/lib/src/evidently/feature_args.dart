...
class FeatureArgs {
  ...
  factory FeatureArgs.fromMap(Map<String, dynamic> map) {
    return FeatureArgs(
      defaultVariation: map['defaultVariation'] == null ? null : map['defaultVariation'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      entityOverrides: map['entityOverrides'] == null ? null : (map['entityOverrides'] as Map).cast<String, String>(),
      evaluationStrategy: map['evaluationStrategy'] == null ? null : map['evaluationStrategy'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      project: map['project'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      variations: pulumi.Input.decodeList<FeatureVariation>(map['variations'], (value) => FeatureVariation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
