...
class FeatureArgs {
  ...
  }) : defaultVariation = pulumi.Input.asOptionalInput<String>(
         defaultVariation,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       entityOverrides = pulumi.Input.asOptionalInput<Map<String, String>>(
         entityOverrides,
       ),
       evaluationStrategy = pulumi.Input.asOptionalInput<String>(
         evaluationStrategy,
       ),
