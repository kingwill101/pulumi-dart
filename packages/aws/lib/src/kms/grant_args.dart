...
class GrantArgs {
  ...
  factory GrantArgs.fromMap(Map<String, dynamic> map) {
    return GrantArgs(
      constraints: map['constraints'] == null ? null : pulumi.Input.decodeList<GrantConstraint>(map['constraints'], (value) => GrantConstraint.fromMap((value as Map).cast<String, dynamic>())),
      grantCreationTokens: map['grantCreationTokens'] == null ? null : (map['grantCreationTokens'] as List).cast<String>(),
      granteePrincipal: map['granteePrincipal'] as String,
      keyId: map['keyId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      operations: (map['operations'] as List).cast<String>(),
      region: map['region'] == null ? null : map['region'] as String,
      retireOnDelete: map['retireOnDelete'] == null ? null : map['retireOnDelete'] as bool,
      retiringPrincipal: map['retiringPrincipal'] == null ? null : map['retiringPrincipal'] as String,
    );
  }
}
