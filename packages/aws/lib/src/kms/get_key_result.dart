...
class GetKeyResult {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['multiRegionConfigurations'] = pulumi.Input.encodeList<
            GetKeyMultiRegionConfiguration, Map<String, dynamic>>(
        multiRegionConfigurations, (value) => value.toMap());
    map['origin'] = origin;
    map['pendingDeletionWindowInDays'] = pendingDeletionWindowInDays;
    map['region'] = region;
    map['validTo'] = validTo;
    map['xksKeyConfigurations'] = pulumi.Input.encodeList<
        GetKeyXksKeyConfiguration,
        Map<String, dynamic>>(xksKeyConfigurations, (value) => value.toMap());
    return map;
  }
  ...
  factory GetKeyResult.fromMap(Map<String, dynamic> map) {
    return GetKeyResult(
      ...
      multiRegionConfigurations:
          pulumi.Input.decodeList<GetKeyMultiRegionConfiguration>(
      ...
      xksKeyConfigurations: pulumi.Input.decodeList<GetKeyXksKeyConfiguration>(
