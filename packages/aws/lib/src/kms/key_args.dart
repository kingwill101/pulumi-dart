...
class KeyArgs {
  ...
  KeyArgs({
    ...
    String? xksKeyId,
        ...
        customerMasterKeySpec =
            pulumi.Input.asOptionalInput<String>(customerMasterKeySpec),
        deletionWindowInDays =
            pulumi.Input.asOptionalInput<int>(deletionWindowInDays),
        description = pulumi.Input.asOptionalInput<String>(description),
        enableKeyRotation =
            pulumi.Input.asOptionalInput<bool>(enableKeyRotation),
        ...
        rotationPeriodInDays =
            pulumi.Input.asOptionalInput<int>(rotationPeriodInDays),
  ...
  factory KeyArgs.fromMap(Map<String, dynamic> map) {
    return KeyArgs(
      ...
      multiRegion:
          map['multiRegion'] == null ? null : map['multiRegion'] as bool,
