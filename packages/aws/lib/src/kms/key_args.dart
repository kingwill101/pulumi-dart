...
class KeyArgs {
  ...
  factory KeyArgs.fromMap(Map<String, dynamic> map) {
    return KeyArgs(
      ...
      customKeyStoreId: map['customKeyStoreId'] == null ? null : map['customKeyStoreId'] as String,
      customerMasterKeySpec: map['customerMasterKeySpec'] == null ? null : map['customerMasterKeySpec'] as String,
      deletionWindowInDays: map['deletionWindowInDays'] == null ? null : map['deletionWindowInDays'] as int,
      description: map['description'] == null ? null : map['description'] as String,
      enableKeyRotation: map['enableKeyRotation'] == null ? null : map['enableKeyRotation'] as bool,
      ...
      rotationPeriodInDays: map['rotationPeriodInDays'] == null ? null : map['rotationPeriodInDays'] as int,
