...
class CustomKeyStoreArgs {
  ...
  CustomKeyStoreArgs({
    ...
    String? xksProxyVpcEndpointServiceName,
            ...
            pulumi.Input.asOptionalInput<String>(cloudHsmClusterId),
        customKeyStoreName = pulumi.Input.asInput<String>(customKeyStoreName),
        customKeyStoreType =
            pulumi.Input.asOptionalInput<String>(customKeyStoreType),
        keyStorePassword =
            pulumi.Input.asOptionalInput<String>(keyStorePassword),
        region = pulumi.Input.asOptionalInput<String>(region),
        trustAnchorCertificate =
            pulumi.Input.asOptionalInput<String>(trustAnchorCertificate),
        xksProxyAuthenticationCredential = pulumi.Input.asOptionalInput<
                CustomKeyStoreXksProxyAuthenticationCredential>(
            xksProxyAuthenticationCredential),
        xksProxyConnectivity =
            pulumi.Input.asOptionalInput<String>(xksProxyConnectivity),
        xksProxyUriEndpoint =
            pulumi.Input.asOptionalInput<String>(xksProxyUriEndpoint),
