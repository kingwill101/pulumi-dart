...
class CustomKeyStoreArgs {
  ...
  CustomKeyStoreArgs({
    ...
    CustomKeyStoreXksProxyAuthenticationCredential? xksProxyAuthenticationCredential,
  ...
  factory CustomKeyStoreArgs.fromMap(Map<String, dynamic> map) {
    return CustomKeyStoreArgs(
      cloudHsmClusterId: map['cloudHsmClusterId'] == null ? null : map['cloudHsmClusterId'] as String,
      customKeyStoreName: map['customKeyStoreName'] as String,
      customKeyStoreType: map['customKeyStoreType'] == null ? null : map['customKeyStoreType'] as String,
      keyStorePassword: map['keyStorePassword'] == null ? null : map['keyStorePassword'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      trustAnchorCertificate: map['trustAnchorCertificate'] == null ? null : map['trustAnchorCertificate'] as String,
      xksProxyAuthenticationCredential: map['xksProxyAuthenticationCredential'] == null ? null : CustomKeyStoreXksProxyAuthenticationCredential.fromMap((map['xksProxyAuthenticationCredential'] as Map).cast<String, dynamic>()),
      xksProxyConnectivity: map['xksProxyConnectivity'] == null ? null : map['xksProxyConnectivity'] as String,
      xksProxyUriEndpoint: map['xksProxyUriEndpoint'] == null ? null : map['xksProxyUriEndpoint'] as String,
      xksProxyUriPath: map['xksProxyUriPath'] == null ? null : map['xksProxyUriPath'] as String,
      xksProxyVpcEndpointServiceName: map['xksProxyVpcEndpointServiceName'] == null ? null : map['xksProxyVpcEndpointServiceName'] as String,
    );
  }
}
