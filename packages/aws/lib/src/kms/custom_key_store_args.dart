...
class CustomKeyStoreArgs {
    ...
    String? xksProxyVpcEndpointServiceName,
  }) : cloudHsmClusterId = pulumi.Input.asOptionalInput<String>(
         cloudHsmClusterId,
       ),
       customKeyStoreName = pulumi.Input.asInput<String>(customKeyStoreName),
       customKeyStoreType = pulumi.Input.asOptionalInput<String>(
         customKeyStoreType,
       ),
       keyStorePassword = pulumi.Input.asOptionalInput<String>(
         keyStorePassword,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       trustAnchorCertificate = pulumi.Input.asOptionalInput<String>(
       ...
       xksProxyAuthenticationCredential =
           pulumi.Input.asOptionalInput<
             CustomKeyStoreXksProxyAuthenticationCredential
           >(xksProxyAuthenticationCredential),
       xksProxyConnectivity = pulumi.Input.asOptionalInput<String>(
         xksProxyConnectivity,
       ),
       xksProxyUriEndpoint = pulumi.Input.asOptionalInput<String>(
         xksProxyUriEndpoint,
       ),
    ...
    return <String, dynamic>{
      ...
      'xksProxyAuthenticationCredential':
          ?pulumi.Input.mapOptionalInputValue<
            CustomKeyStoreXksProxyAuthenticationCredential,
            Map<String, dynamic>
          >(xksProxyAuthenticationCredential, (value) => value.toMap()),
  ...
  factory CustomKeyStoreArgs.fromMap(Map<String, dynamic> map) {
    return CustomKeyStoreArgs(
      cloudHsmClusterId: map['cloudHsmClusterId'] == null
          ? null
          : map['cloudHsmClusterId'] as String,
      customKeyStoreName: map['customKeyStoreName'] as String,
      customKeyStoreType: map['customKeyStoreType'] == null
          ? null
          : map['customKeyStoreType'] as String,
      keyStorePassword: map['keyStorePassword'] == null
          ? null
          : map['keyStorePassword'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      trustAnchorCertificate: map['trustAnchorCertificate'] == null
          ? null
          : map['trustAnchorCertificate'] as String,
      xksProxyAuthenticationCredential:
          map['xksProxyAuthenticationCredential'] == null
          ? null
          : CustomKeyStoreXksProxyAuthenticationCredential.fromMap(
              (map['xksProxyAuthenticationCredential'] as Map)
                  .cast<String, dynamic>(),
            ),
      xksProxyConnectivity: map['xksProxyConnectivity'] == null
          ? null
          : map['xksProxyConnectivity'] as String,
      xksProxyUriEndpoint: map['xksProxyUriEndpoint'] == null
          ? null
          : map['xksProxyUriEndpoint'] as String,
      xksProxyUriPath: map['xksProxyUriPath'] == null
          ? null
          : map['xksProxyUriPath'] as String,
      xksProxyVpcEndpointServiceName:
          map['xksProxyVpcEndpointServiceName'] == null
          ? null
          : map['xksProxyVpcEndpointServiceName'] as String,
    );
  }
}
