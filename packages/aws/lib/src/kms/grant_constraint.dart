...
class GrantConstraint {
  ...
  factory GrantConstraint.fromMap(Map<String, dynamic> map) {
    return GrantConstraint(
      encryptionContextEquals: map['encryptionContextEquals'] == null ? null : (map['encryptionContextEquals'] as Map).cast<String, String>(),
      encryptionContextSubset: map['encryptionContextSubset'] == null ? null : (map['encryptionContextSubset'] as Map).cast<String, String>(),
    );
  }
}
