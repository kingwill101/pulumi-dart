...
/// {@template pulumi_kms_replica_external_key_replica_external_key_args_doc}
/// The set of arguments for ReplicaExternalKey.
/// {@endtemplate}
/// {@macro pulumi_kms_replica_external_key_replica_external_key_args_doc}
class ReplicaExternalKeyArgs {
  ...
  /// Creates a new [ReplicaExternalKeyArgs].
  ...
  ReplicaExternalKeyArgs({
    ...
    String? validTo,
        ...
        keyMaterialBase64 =
            pulumi.Input.asOptionalInput<String>(keyMaterialBase64),
  ...
  factory ReplicaExternalKeyArgs.fromMap(Map<String, dynamic> map) {
    return ReplicaExternalKeyArgs(
      ...
      keyMaterialBase64: map['keyMaterialBase64'] == null
          ? null
          : map['keyMaterialBase64'] as String,
      policy: map['policy'] == null ? null : map['policy'] as String,
      primaryKeyArn: map['primaryKeyArn'] as String,
