...
class DomainScalingParameters {
  ...
  Map<String, dynamic> toMap() {
    ...
    final desiredInstanceTypeValue = desiredInstanceType;
    if (desiredInstanceTypeValue != null) {
      map['desiredInstanceType'] = desiredInstanceTypeValue;
    }
    final desiredPartitionCountValue = desiredPartitionCount;
    if (desiredPartitionCountValue != null) {
      map['desiredPartitionCount'] = desiredPartitionCountValue;
    }
    final desiredReplicationCountValue = desiredReplicationCount;
    if (desiredReplicationCountValue != null) {
      map['desiredReplicationCount'] = desiredReplicationCountValue;
    }
    return map;
  }
