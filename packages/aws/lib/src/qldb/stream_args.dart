...
class StreamArgs {
  ...
  factory StreamArgs.fromMap(Map<String, dynamic> map) {
    return StreamArgs(
      exclusiveEndTime: map['exclusiveEndTime'] == null ? null : map['exclusiveEndTime'] as String,
      inclusiveStartTime: map['inclusiveStartTime'] as String,
      kinesisConfiguration: StreamKinesisConfiguration.fromMap((map['kinesisConfiguration'] as Map).cast<String, dynamic>()),
