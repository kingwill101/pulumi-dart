...
class IpSetArgs {
  ...
  IpSetArgs({List<IpSetIpSetDescriptor>? ipSetDescriptors, String? name})
    : ipSetDescriptors = pulumi
          .Input.asOptionalInput<List<IpSetIpSetDescriptor>>(ipSetDescriptors),
