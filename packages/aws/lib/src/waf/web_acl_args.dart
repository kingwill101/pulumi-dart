...
class WebAclArgs {
  ...
  factory WebAclArgs.fromMap(Map<String, dynamic> map) {
    return WebAclArgs(
      defaultAction: WebAclDefaultAction.fromMap((map['defaultAction'] as Map).cast<String, dynamic>()),
      loggingConfiguration: map['loggingConfiguration'] == null ? null : WebAclLoggingConfiguration.fromMap((map['loggingConfiguration'] as Map).cast<String, dynamic>()),
      metricName: map['metricName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<WebAclRule>(map['rules'], (value) => WebAclRule.fromMap((value as Map).cast<String, dynamic>())),
