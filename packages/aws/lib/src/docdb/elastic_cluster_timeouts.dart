...
class ElasticClusterTimeouts {
  ...
  /// Creates a new [ElasticClusterTimeouts].
  ...
  ElasticClusterTimeouts({this.create, this.delete, this.update});
  ...
  factory ElasticClusterTimeouts.fromMap(Map<String, dynamic> map) {
    return ElasticClusterTimeouts(
