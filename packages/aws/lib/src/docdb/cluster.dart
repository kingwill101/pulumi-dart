...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.clusterIdentifierPrefix = registerOutput<String>(
    ...
    this.dbClusterParameterGroupName = registerOutput<String>(
    ...
    this.globalClusterIdentifier = registerOutput<String?>(
    ...
    this.masterPasswordWoVersion = registerOutput<int?>(
      'masterPasswordWoVersion',
    );
    this.masterUserSecrets = registerOutput<List<ClusterMasterUserSecret>>(
      'masterUserSecrets',
    );
    ...
    this.restoreToPointInTime = registerOutput<ClusterRestoreToPointInTime?>(
