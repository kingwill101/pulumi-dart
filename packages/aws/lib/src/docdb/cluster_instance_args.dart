...
class ClusterInstanceArgs {
  ...
  ClusterInstanceArgs({
    ...
    Map<String, String>? tags,
        ...
        certificateRotationRestart =
            pulumi.Input.asOptionalInput<String>(certificateRotationRestart),
        clusterIdentifier = pulumi.Input.asInput<String>(clusterIdentifier),
        copyTagsToSnapshot =
            pulumi.Input.asOptionalInput<bool>(copyTagsToSnapshot),
        enablePerformanceInsights =
            pulumi.Input.asOptionalInput<bool>(enablePerformanceInsights),
  ...
  factory ClusterInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ClusterInstanceArgs(
      ...
      promotionTier:
          map['promotionTier'] == null ? null : map['promotionTier'] as int,
