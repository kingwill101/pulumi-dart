...
class ClusterInstanceArgs {
  ...
  ClusterInstanceArgs({
    ...
    String? certificateRotationRestart,
  ...
  factory ClusterInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ClusterInstanceArgs(
      ...
      certificateRotationRestart: map['certificateRotationRestart'] == null ? null : map['certificateRotationRestart'] as String,
      ...
      enablePerformanceInsights: map['enablePerformanceInsights'] == null ? null : map['enablePerformanceInsights'] as bool,
