...
class ParameterArgs {
  ...
  factory ParameterArgs.fromMap(Map<String, dynamic> map) {
    return ParameterArgs(
      allowedPattern: map['allowedPattern'] == null ? null : map['allowedPattern'] as String,
      arn: map['arn'] == null ? null : map['arn'] as String,
      dataType: map['dataType'] == null ? null : map['dataType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      insecureValue: map['insecureValue'] == null ? null : map['insecureValue'] as String,
      ...
      valueWoVersion: map['valueWoVersion'] == null ? null : map['valueWoVersion'] as int,
    );
  }
}
