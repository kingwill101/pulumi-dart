...
class PatchBaseline extends pulumi.CustomResource {
  ...
  PatchBaseline(
    ...
    this.approvalRules = registerOutput<List<PatchBaselineApprovalRule>?>(
      'approvalRules',
    );
    this.approvedPatches = registerOutput<List<String>?>('approvedPatches');
    this.approvedPatchesComplianceLevel = registerOutput<String?>(
      'approvedPatchesComplianceLevel',
    );
    this.approvedPatchesEnableNonSecurity = registerOutput<bool?>(
      'approvedPatchesEnableNonSecurity',
    );
    this.arn = registerOutput<String>('arn');
    this.availableSecurityUpdatesComplianceStatus = registerOutput<String>(
      'availableSecurityUpdatesComplianceStatus',
    );
    this.description = registerOutput<String?>('description');
    this.globalFilters = registerOutput<List<PatchBaselineGlobalFilter>?>(
      'globalFilters',
    );
    ...
    this.rejectedPatchesAction = registerOutput<String>(
