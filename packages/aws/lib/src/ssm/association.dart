...
class Association extends pulumi.CustomResource {
  ...
  Association(
    ...
    this.applyOnlyAtCronInterval = registerOutput<bool?>(
    ...
    this.automationTargetParameterName = registerOutput<String?>(
    ...
    this.outputLocation = registerOutput<AssociationOutputLocation?>(
      'outputLocation',
    );
    ...
    this.waitForSuccessTimeoutSeconds = registerOutput<int?>(
