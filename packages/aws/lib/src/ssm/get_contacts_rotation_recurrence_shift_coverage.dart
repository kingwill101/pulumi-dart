...
class GetContactsRotationRecurrenceShiftCoverage {
  final List<GetContactsRotationRecurrenceShiftCoverageCoverageTime> coverageTimes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'coverageTimes': pulumi.Input.encodeList<GetContactsRotationRecurrenceShiftCoverageCoverageTime, Map<String, dynamic>>(coverageTimes, (value) => value.toMap()),
  ...
  factory GetContactsRotationRecurrenceShiftCoverage.fromMap(Map<String, dynamic> map) {
    return GetContactsRotationRecurrenceShiftCoverage(
      coverageTimes: pulumi.Input.decodeList<GetContactsRotationRecurrenceShiftCoverageCoverageTime>(map['coverageTimes'], (value) => GetContactsRotationRecurrenceShiftCoverageCoverageTime.fromMap((value as Map).cast<String, dynamic>())),
