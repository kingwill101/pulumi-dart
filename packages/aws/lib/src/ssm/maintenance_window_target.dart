...
class MaintenanceWindowTarget extends pulumi.CustomResource {
  ...
  /// Creates a new [MaintenanceWindowTarget].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MaintenanceWindowTarget]. {@macro pulumi_ssm_maintenance_window_target_maintenance_window_target_args_doc}
  ...
  MaintenanceWindowTarget(
    ...
    this.targets = registerOutput<List<MaintenanceWindowTargetTarget>>(
      'targets',
    );
