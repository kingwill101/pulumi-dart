...
class MaintenanceWindowTaskArgs {
  ...
  factory MaintenanceWindowTaskArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowTaskArgs(
      cutoffBehavior: map['cutoffBehavior'] == null ? null : map['cutoffBehavior'] as String,
      ...
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<MaintenanceWindowTaskTarget>(map['targets'], (value) => MaintenanceWindowTaskTarget.fromMap((value as Map).cast<String, dynamic>())),
      taskArn: map['taskArn'] as String,
      taskInvocationParameters: map['taskInvocationParameters'] == null ? null : MaintenanceWindowTaskTaskInvocationParameters.fromMap((map['taskInvocationParameters'] as Map).cast<String, dynamic>()),
