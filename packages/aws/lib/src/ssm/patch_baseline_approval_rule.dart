...
class PatchBaselineApprovalRule {
  ...
  /// [approveAfterDays] Number of days after the release date of each patch matched by the rule the patch is marked as approved in the patch baseline. Valid Range: 0 to 360. Conflicts with `approve_until_date`.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'patchFilters': pulumi.Input.encodeList<PatchBaselineApprovalRulePatchFilter, Map<String, dynamic>>(patchFilters, (value) => value.toMap()),
    };
  }

  factory PatchBaselineApprovalRule.fromMap(Map<String, dynamic> map) {
    return PatchBaselineApprovalRule(
      approveAfterDays: map['approveAfterDays'] == null ? null : map['approveAfterDays'] as int,
      approveUntilDate: map['approveUntilDate'] == null ? null : map['approveUntilDate'] as String,
      complianceLevel: map['complianceLevel'] == null ? null : map['complianceLevel'] as String,
      enableNonSecurity: map['enableNonSecurity'] == null ? null : map['enableNonSecurity'] as bool,
      patchFilters: pulumi.Input.decodeList<PatchBaselineApprovalRulePatchFilter>(map['patchFilters'], (value) => PatchBaselineApprovalRulePatchFilter.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
