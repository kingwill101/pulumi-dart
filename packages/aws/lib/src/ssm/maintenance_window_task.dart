...
class MaintenanceWindowTask extends pulumi.CustomResource {
  ...
  MaintenanceWindowTask(
    ...
    this.targets = registerOutput<List<MaintenanceWindowTaskTarget>?>('targets');
    this.taskArn = registerOutput<String>('taskArn');
    this.taskInvocationParameters = registerOutput<MaintenanceWindowTaskTaskInvocationParameters?>('taskInvocationParameters');
