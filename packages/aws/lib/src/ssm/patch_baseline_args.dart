  ...
  PatchBaselineArgs({
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<List<PatchBaselineApprovalRule>>(
                approvalRules),
        approvedPatches =
            pulumi.Input.asOptionalInput<List<String>>(approvedPatches),
        ...
        rejectedPatches =
            pulumi.Input.asOptionalInput<List<String>>(rejectedPatches),
        rejectedPatchesAction =
            pulumi.Input.asOptionalInput<String>(rejectedPatchesAction),
        sources =
            pulumi.Input.asOptionalInput<List<PatchBaselineSource>>(sources),
