...
class PatchBaselineArgs {
  ...
  factory PatchBaselineArgs.fromMap(Map<String, dynamic> map) {
    return PatchBaselineArgs(
      approvalRules: map['approvalRules'] == null ? null : pulumi.Input.decodeList<PatchBaselineApprovalRule>(map['approvalRules'], (value) => PatchBaselineApprovalRule.fromMap((value as Map).cast<String, dynamic>())),
      approvedPatches: map['approvedPatches'] == null ? null : (map['approvedPatches'] as List).cast<String>(),
      approvedPatchesComplianceLevel: map['approvedPatchesComplianceLevel'] == null ? null : map['approvedPatchesComplianceLevel'] as String,
      ...
      availableSecurityUpdatesComplianceStatus: map['availableSecurityUpdatesComplianceStatus'] == null ? null : map['availableSecurityUpdatesComplianceStatus'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      globalFilters: map['globalFilters'] == null ? null : pulumi.Input.decodeList<PatchBaselineGlobalFilter>(map['globalFilters'], (value) => PatchBaselineGlobalFilter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<PatchBaselineSource>(map['sources'], (value) => PatchBaselineSource.fromMap((value as Map).cast<String, dynamic>())),
