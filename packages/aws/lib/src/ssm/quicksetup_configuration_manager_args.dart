...
class QuicksetupConfigurationManagerArgs {
  ...
  QuicksetupConfigurationManagerArgs({
    required QuicksetupConfigurationManagerConfigurationDefinition configurationDefinition,
    String? description,
    String? name,
    String? region,
    Map<String, String>? tags,
    QuicksetupConfigurationManagerTimeouts? timeouts,
  }) :
  ...
  factory QuicksetupConfigurationManagerArgs.fromMap(Map<String, dynamic> map) {
    return QuicksetupConfigurationManagerArgs(
      configurationDefinition: QuicksetupConfigurationManagerConfigurationDefinition.fromMap((map['configurationDefinition'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : QuicksetupConfigurationManagerTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
