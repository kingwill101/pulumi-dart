...
class AssociationArgs {
  ...
  factory AssociationArgs.fromMap(Map<String, dynamic> map) {
    return AssociationArgs(
      applyOnlyAtCronInterval: map['applyOnlyAtCronInterval'] == null ? null : map['applyOnlyAtCronInterval'] as bool,
      associationName: map['associationName'] == null ? null : map['associationName'] as String,
      automationTargetParameterName: map['automationTargetParameterName'] == null ? null : map['automationTargetParameterName'] as String,
      calendarNames: map['calendarNames'] == null ? null : (map['calendarNames'] as List).cast<String>(),
      complianceSeverity: map['complianceSeverity'] == null ? null : map['complianceSeverity'] as String,
      ...
      outputLocation: map['outputLocation'] == null ? null : AssociationOutputLocation.fromMap((map['outputLocation'] as Map).cast<String, dynamic>()),
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      region: map['region'] == null ? null : map['region'] as String,
      scheduleExpression: map['scheduleExpression'] == null ? null : map['scheduleExpression'] as String,
      syncCompliance: map['syncCompliance'] == null ? null : map['syncCompliance'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<AssociationTarget>(map['targets'], (value) => AssociationTarget.fromMap((value as Map).cast<String, dynamic>())),
      waitForSuccessTimeoutSeconds: map['waitForSuccessTimeoutSeconds'] == null ? null : map['waitForSuccessTimeoutSeconds'] as int,
    );
  }
}
