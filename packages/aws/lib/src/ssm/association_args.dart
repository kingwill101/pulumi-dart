...
class AssociationArgs {
  ...
  AssociationArgs({
    ...
    String? maxErrors,
    String? name,
    AssociationOutputLocation? outputLocation,
    Map<String, String>? parameters,
    String? region,
    String? scheduleExpression,
    String? syncCompliance,
    Map<String, String>? tags,
    List<AssociationTarget>? targets,
    int? waitForSuccessTimeoutSeconds,
  })  : applyOnlyAtCronInterval =
            pulumi.Input.asOptionalInput<bool>(applyOnlyAtCronInterval),
        associationName = pulumi.Input.asOptionalInput<String>(associationName),
        automationTargetParameterName =
            pulumi.Input.asOptionalInput<String>(automationTargetParameterName),
        calendarNames =
            pulumi.Input.asOptionalInput<List<String>>(calendarNames),
        complianceSeverity =
            pulumi.Input.asOptionalInput<String>(complianceSeverity),
        ...
        outputLocation =
            pulumi.Input.asOptionalInput<AssociationOutputLocation>(
                outputLocation),
        parameters =
        ...
        targets =
            pulumi.Input.asOptionalInput<List<AssociationTarget>>(targets),
        waitForSuccessTimeoutSeconds =
            pulumi.Input.asOptionalInput<int>(waitForSuccessTimeoutSeconds);
  ...
  factory AssociationArgs.fromMap(Map<String, dynamic> map) {
    return AssociationArgs(
      applyOnlyAtCronInterval: map['applyOnlyAtCronInterval'] == null
          ? null
          : map['applyOnlyAtCronInterval'] as bool,
      associationName: map['associationName'] == null
          ? null
          : map['associationName'] as String,
      automationTargetParameterName:
          map['automationTargetParameterName'] == null
              ? null
              : map['automationTargetParameterName'] as String,
      calendarNames: map['calendarNames'] == null
          ? null
          : (map['calendarNames'] as List).cast<String>(),
      complianceSeverity: map['complianceSeverity'] == null
          ? null
          : map['complianceSeverity'] as String,
      ...
      outputLocation: map['outputLocation'] == null
          ...
          : AssociationOutputLocation.fromMap(
              (map['outputLocation'] as Map).cast<String, dynamic>()),
      ...
      syncCompliance: map['syncCompliance'] == null
          ? null
          : map['syncCompliance'] as String,
      tags: map['tags'] == null
          ? null
      ...
      waitForSuccessTimeoutSeconds: map['waitForSuccessTimeoutSeconds'] == null
          ? null
          : map['waitForSuccessTimeoutSeconds'] as int,
    );
  }
}
