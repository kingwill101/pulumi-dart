...
class AssociationArgs {
  ...
  AssociationArgs({
    ...
    int? waitForSuccessTimeoutSeconds,
  }) : applyOnlyAtCronInterval = pulumi.Input.asOptionalInput<bool>(
         applyOnlyAtCronInterval,
       ),
       ...
       calendarNames = pulumi.Input.asOptionalInput<List<String>>(
         calendarNames,
       ),
       complianceSeverity = pulumi.Input.asOptionalInput<String>(
         complianceSeverity,
       ),
