...
class ScheduledAction extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ScheduledActionScalableTargetAction> scalableTargetAction;
  ...
  ScheduledAction(
    ...
    this.scalableTargetAction = registerOutput<ScheduledActionScalableTargetAction>('scalableTargetAction');
