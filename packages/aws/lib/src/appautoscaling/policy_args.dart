...
class PolicyArgs {
  ...
  PolicyArgs({
    String? name,
    String? policyType,
    PolicyPredictiveScalingPolicyConfiguration? predictiveScalingPolicyConfiguration,
    String? region,
    ...
    PolicyTargetTrackingScalingPolicyConfiguration? targetTrackingScalingPolicyConfiguration,
  }) :
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      ...
      predictiveScalingPolicyConfiguration: map['predictiveScalingPolicyConfiguration'] == null ? null : PolicyPredictiveScalingPolicyConfiguration.fromMap((map['predictiveScalingPolicyConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      resourceId: map['resourceId'] as String,
      scalableDimension: map['scalableDimension'] as String,
      serviceNamespace: map['serviceNamespace'] as String,
      stepScalingPolicyConfiguration: map['stepScalingPolicyConfiguration'] == null ? null : PolicyStepScalingPolicyConfiguration.fromMap((map['stepScalingPolicyConfiguration'] as Map).cast<String, dynamic>()),
      targetTrackingScalingPolicyConfiguration: map['targetTrackingScalingPolicyConfiguration'] == null ? null : PolicyTargetTrackingScalingPolicyConfiguration.fromMap((map['targetTrackingScalingPolicyConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
