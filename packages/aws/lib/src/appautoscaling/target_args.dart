...
class TargetArgs {
  ...
  TargetArgs({
    ...
    TargetSuspendedState? suspendedState,
    Map<String, String>? tags,
        ...
        suspendedState =
            pulumi.Input.asOptionalInput<TargetSuspendedState>(suspendedState),
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      suspendedState: map['suspendedState'] == null
          ? null
          : TargetSuspendedState.fromMap(
              (map['suspendedState'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null
          ? null
