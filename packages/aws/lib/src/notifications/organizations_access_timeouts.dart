...
class OrganizationsAccessTimeouts {
  ...
  /// Creates a new [OrganizationsAccessTimeouts].
  ...
  OrganizationsAccessTimeouts({this.create, this.delete, this.update});
  ...
  factory OrganizationsAccessTimeouts.fromMap(Map<String, dynamic> map) {
    return OrganizationsAccessTimeouts(
