...
class SubscriberTimeouts {
  ...
  /// Creates a new [SubscriberTimeouts].
  ...
  SubscriberTimeouts({this.create, this.delete, this.update});
  ...
  factory SubscriberTimeouts.fromMap(Map<String, dynamic> map) {
    return SubscriberTimeouts(
