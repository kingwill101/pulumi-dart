...
class AccountArgs {
  ...
  AccountArgs({String? cloudwatchRoleArn, String? region})
    : cloudwatchRoleArn = pulumi.Input.asOptionalInput<String>(
        cloudwatchRoleArn,
      ),
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      cloudwatchRoleArn: map['cloudwatchRoleArn'] == null
          ? null
          : map['cloudwatchRoleArn'] as String,
