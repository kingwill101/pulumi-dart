...
class StageArgs {
  ...
  StageArgs({
    ...
    StageCanarySettings? canarySettings,
    ...
    bool? xrayTracingEnabled,
       ...
       cacheClusterEnabled = pulumi.Input.asOptionalInput<bool>(
         cacheClusterEnabled,
       ),
       cacheClusterSize = pulumi.Input.asOptionalInput<String>(
         cacheClusterSize,
       ),
       ...
       documentationVersion = pulumi.Input.asOptionalInput<String>(
       ...
       xrayTracingEnabled = pulumi.Input.asOptionalInput<bool>(
         xrayTracingEnabled,
       );
