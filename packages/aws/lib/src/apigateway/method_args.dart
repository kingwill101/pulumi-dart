...
class MethodArgs {
  ...
  MethodArgs({
    ...
    required String restApi,
       ...
       requestValidatorId = pulumi.Input.asOptionalInput<String>(
         requestValidatorId,
       ),
  ...
  factory MethodArgs.fromMap(Map<String, dynamic> map) {
    return MethodArgs(
      apiKeyRequired: map['apiKeyRequired'] == null
          ? null
          : map['apiKeyRequired'] as bool,
      ...
      authorizerId: map['authorizerId'] == null
          ? null
          : map['authorizerId'] as String,
      httpMethod: map['httpMethod'] as String,
      operationName: map['operationName'] == null
          ? null
          : map['operationName'] as String,
      ...
      requestParameters: map['requestParameters'] == null
          ? null
          : (map['requestParameters'] as Map).cast<String, bool>(),
      requestValidatorId: map['requestValidatorId'] == null
          ? null
          : map['requestValidatorId'] as String,
