...
class RequestValidatorArgs {
  ...
  factory RequestValidatorArgs.fromMap(Map<String, dynamic> map) {
    return RequestValidatorArgs(
      ...
      validateRequestBody: map['validateRequestBody'] == null ? null : map['validateRequestBody'] as bool,
      validateRequestParameters: map['validateRequestParameters'] == null ? null : map['validateRequestParameters'] as bool,
    );
  }
}
