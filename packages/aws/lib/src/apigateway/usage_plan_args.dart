...
class UsagePlanArgs {
  ...
  UsagePlanArgs({
    ...
    UsagePlanThrottleSettings? throttleSettings,
       ...
       throttleSettings = pulumi
           .Input.asOptionalInput<UsagePlanThrottleSettings>(throttleSettings);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiStages':
          ?pulumi.Input.mapOptionalInputValue<
            List<UsagePlanApiStage>,
      ...
      'quotaSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(quotaSettings, (value) => value.toMap()),
      'region': ?region,
      'tags': ?tags,
      'throttleSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(throttleSettings, (value) => value.toMap()),
    };
  }
  ...
  factory UsagePlanArgs.fromMap(Map<String, dynamic> map) {
    return UsagePlanArgs(
      ...
      productCode: map['productCode'] == null
          ? null
