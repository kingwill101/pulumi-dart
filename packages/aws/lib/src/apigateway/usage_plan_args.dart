...
class UsagePlanArgs {
  ...
  UsagePlanArgs({
    ...
    UsagePlanThrottleSettings? throttleSettings,
            ...
            pulumi.Input.asOptionalInput<List<UsagePlanApiStage>>(apiStages),
        description = pulumi.Input.asOptionalInput<String>(description),
        name = pulumi.Input.asOptionalInput<String>(name),
        productCode = pulumi.Input.asOptionalInput<String>(productCode),
        quotaSettings =
            pulumi.Input.asOptionalInput<UsagePlanQuotaSettings>(quotaSettings),
        region = pulumi.Input.asOptionalInput<String>(region),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        throttleSettings =
            pulumi.Input.asOptionalInput<UsagePlanThrottleSettings>(
                throttleSettings);
  ...
  factory UsagePlanArgs.fromMap(Map<String, dynamic> map) {
    return UsagePlanArgs(
      apiStages: map['apiStages'] == null
          ? null
          : pulumi.Input.decodeList<UsagePlanApiStage>(
              map['apiStages'],
              (value) => UsagePlanApiStage.fromMap(
                  (value as Map).cast<String, dynamic>())),
      description:
          map['description'] == null ? null : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      productCode:
          map['productCode'] == null ? null : map['productCode'] as String,
      quotaSettings: map['quotaSettings'] == null
          ? null
          : UsagePlanQuotaSettings.fromMap(
              (map['quotaSettings'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      throttleSettings: map['throttleSettings'] == null
          ? null
          : UsagePlanThrottleSettings.fromMap(
              (map['throttleSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
