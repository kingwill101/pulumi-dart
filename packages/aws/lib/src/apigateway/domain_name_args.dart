...
class DomainNameArgs {
  ...
  factory DomainNameArgs.fromMap(Map<String, dynamic> map) {
    return DomainNameArgs(
      ...
      certificatePrivateKey: map['certificatePrivateKey'] == null ? null : map['certificatePrivateKey'] as String,
      domainName: map['domainName'] as String,
      endpointAccessMode: map['endpointAccessMode'] == null ? null : map['endpointAccessMode'] as String,
      endpointConfiguration: map['endpointConfiguration'] == null ? null : DomainNameEndpointConfiguration.fromMap((map['endpointConfiguration'] as Map).cast<String, dynamic>()),
      mutualTlsAuthentication: map['mutualTlsAuthentication'] == null ? null : DomainNameMutualTlsAuthentication.fromMap((map['mutualTlsAuthentication'] as Map).cast<String, dynamic>()),
      ...
      regionalCertificateArn: map['regionalCertificateArn'] == null ? null : map['regionalCertificateArn'] as String,
      regionalCertificateName: map['regionalCertificateName'] == null ? null : map['regionalCertificateName'] as String,
