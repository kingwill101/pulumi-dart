...
class DomainNameArgs {
  ...
  DomainNameArgs({
    ...
    DomainNameEndpointConfiguration? endpointConfiguration,
    ...
    Map<String, String>? tags,
       ...
       certificatePrivateKey = pulumi.Input.asOptionalInput<String>(
         certificatePrivateKey,
       ),
       domainName = pulumi.Input.asInput<String>(domainName),
       endpointAccessMode = pulumi.Input.asOptionalInput<String>(
         endpointAccessMode,
       ),
       ...
       ownershipVerificationCertificateArn = pulumi
           .Input.asOptionalInput<String>(ownershipVerificationCertificateArn),
       policy = pulumi.Input.asOptionalInput<String>(policy),
       region = pulumi.Input.asOptionalInput<String>(region),
       regionalCertificateArn = pulumi.Input.asOptionalInput<String>(
         regionalCertificateArn,
       ),
       regionalCertificateName = pulumi.Input.asOptionalInput<String>(
  ...
  factory DomainNameArgs.fromMap(Map<String, dynamic> map) {
    return DomainNameArgs(
      ...
      certificatePrivateKey: map['certificatePrivateKey'] == null
          ? null
          : map['certificatePrivateKey'] as String,
      domainName: map['domainName'] as String,
      endpointAccessMode: map['endpointAccessMode'] == null
          ? null
          : map['endpointAccessMode'] as String,
      endpointConfiguration: map['endpointConfiguration'] == null
          ? null
          : DomainNameEndpointConfiguration.fromMap(
      ...
      regionalCertificateArn: map['regionalCertificateArn'] == null
          ? null
          : map['regionalCertificateArn'] as String,
      regionalCertificateName: map['regionalCertificateName'] == null
          ? null
          : map['regionalCertificateName'] as String,
