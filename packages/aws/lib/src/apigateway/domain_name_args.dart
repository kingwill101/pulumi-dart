  ...
  DomainNameArgs({
    ...
    Map<String, String>? tags,
        ...
        certificatePrivateKey =
            pulumi.Input.asOptionalInput<String>(certificatePrivateKey),
        domainName = pulumi.Input.asInput<String>(domainName),
        endpointAccessMode =
            pulumi.Input.asOptionalInput<String>(endpointAccessMode),
        ...
        regionalCertificateArn =
            pulumi.Input.asOptionalInput<String>(regionalCertificateArn),
        regionalCertificateName =
            pulumi.Input.asOptionalInput<String>(regionalCertificateName),
