...
class RestApiArgs {
  ...
  factory RestApiArgs.fromMap(Map<String, dynamic> map) {
    return RestApiArgs(
      apiKeySource: map['apiKeySource'] == null ? null : map['apiKeySource'] as String,
      ...
      endpointConfiguration: map['endpointConfiguration'] == null ? null : RestApiEndpointConfiguration.fromMap((map['endpointConfiguration'] as Map).cast<String, dynamic>()),
      failOnWarnings: map['failOnWarnings'] == null ? null : map['failOnWarnings'] as bool,
      minimumCompressionSize: map['minimumCompressionSize'] == null ? null : map['minimumCompressionSize'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      policy: map['policy'] == null ? null : map['policy'] as String,
      putRestApiMode: map['putRestApiMode'] == null ? null : map['putRestApiMode'] as String,
