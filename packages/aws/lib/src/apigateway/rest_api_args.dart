...
class RestApiArgs {
  ...
  RestApiArgs({
    ...
    Map<String, String>? tags,
        ...
        binaryMediaTypes =
            pulumi.Input.asOptionalInput<List<String>>(binaryMediaTypes),
        ...
        minimumCompressionSize =
            pulumi.Input.asOptionalInput<String>(minimumCompressionSize),
  ...
  factory RestApiArgs.fromMap(Map<String, dynamic> map) {
    return RestApiArgs(
      apiKeySource:
          map['apiKeySource'] == null ? null : map['apiKeySource'] as String,
