...
class IntegrationArgs {
  ...
  factory IntegrationArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationArgs(
      cacheKeyParameters: map['cacheKeyParameters'] == null ? null : (map['cacheKeyParameters'] as List).cast<String>(),
      ...
      contentHandling: map['contentHandling'] == null ? null : map['contentHandling'] as String,
      credentials: map['credentials'] == null ? null : map['credentials'] as String,
      httpMethod: map['httpMethod'] as String,
      integrationHttpMethod: map['integrationHttpMethod'] == null ? null : map['integrationHttpMethod'] as String,
      integrationTarget: map['integrationTarget'] == null ? null : map['integrationTarget'] as String,
      ...
      responseTransferMode: map['responseTransferMode'] == null ? null : map['responseTransferMode'] as String,
