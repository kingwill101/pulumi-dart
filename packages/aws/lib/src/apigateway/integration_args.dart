...
class IntegrationArgs {
  ...
  IntegrationArgs({
    ...
    String? uri,
            ...
            pulumi.Input.asOptionalInput<List<String>>(cacheKeyParameters),
        ...
        integrationHttpMethod =
            pulumi.Input.asOptionalInput<String>(integrationHttpMethod),
        integrationTarget =
            pulumi.Input.asOptionalInput<String>(integrationTarget),
        passthroughBehavior =
        ...
        responseTransferMode =
            pulumi.Input.asOptionalInput<String>(responseTransferMode),
