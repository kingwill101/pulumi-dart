...
class IntegrationArgs {
  ...
  IntegrationArgs({
    ...
    String? uri,
  }) : cacheKeyParameters = pulumi.Input.asOptionalInput<List<String>>(
         cacheKeyParameters,
       ),
       ...
       integrationHttpMethod = pulumi.Input.asOptionalInput<String>(
         integrationHttpMethod,
       ),
       integrationTarget = pulumi.Input.asOptionalInput<String>(
         integrationTarget,
       ),
       ...
       responseTransferMode = pulumi.Input.asOptionalInput<String>(
  ...
  factory IntegrationArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationArgs(
      cacheKeyParameters: map['cacheKeyParameters'] == null
          ? null
          : (map['cacheKeyParameters'] as List).cast<String>(),
      ...
      integrationHttpMethod: map['integrationHttpMethod'] == null
          ? null
          : map['integrationHttpMethod'] as String,
      integrationTarget: map['integrationTarget'] == null
          ? null
          : map['integrationTarget'] as String,
      ...
      responseTransferMode: map['responseTransferMode'] == null
          ? null
          : map['responseTransferMode'] as String,
