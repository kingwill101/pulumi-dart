...
class AuthorizerArgs {
  ...
  factory AuthorizerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizerArgs(
      authorizerCredentials: map['authorizerCredentials'] == null ? null : map['authorizerCredentials'] as String,
      ...
      identitySource: map['identitySource'] == null ? null : map['identitySource'] as String,
      ...
      providerArns: map['providerArns'] == null ? null : (map['providerArns'] as List).cast<String>(),
