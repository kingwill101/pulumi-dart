...
class AuthorizerArgs {
  ...
  AuthorizerArgs({
    ...
    String? type,
            ...
            pulumi.Input.asOptionalInput<String>(authorizerCredentials),
        ...
        identityValidationExpression =
            pulumi.Input.asOptionalInput<String>(identityValidationExpression),
  ...
  factory AuthorizerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizerArgs(
      authorizerCredentials: map['authorizerCredentials'] == null
          ? null
          : map['authorizerCredentials'] as String,
      ...
      identitySource: map['identitySource'] == null
          ? null
          : map['identitySource'] as String,
      identityValidationExpression: map['identityValidationExpression'] == null
          ? null
          : map['identityValidationExpression'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      providerArns: map['providerArns'] == null
          ? null
          : (map['providerArns'] as List).cast<String>(),
