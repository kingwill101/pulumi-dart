...
class ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParameters {
  ...
  final ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParametersCsvMappingParameters? csvMappingParameters;
  /// Provides additional mapping information when JSON is the record format on the streaming source.
  final ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParametersJsonMappingParameters? jsonMappingParameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'csvMappingParameters': ?csvMappingParameters == null ? null : csvMappingParameters!.toMap(),
      'jsonMappingParameters': ?jsonMappingParameters == null ? null : jsonMappingParameters!.toMap(),
    };
  }
  ...
  factory ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParameters.fromMap(Map<String, dynamic> map) {
    return ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParameters(
      csvMappingParameters: map['csvMappingParameters'] == null ? null : ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParametersCsvMappingParameters.fromMap((map['csvMappingParameters'] as Map).cast<String, dynamic>()),
      jsonMappingParameters: map['jsonMappingParameters'] == null ? null : ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParametersJsonMappingParameters.fromMap((map['jsonMappingParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
