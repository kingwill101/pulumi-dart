...
class Application extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ApplicationApplicationConfiguration> applicationConfiguration;
  ...
  late final pulumi.Output<ApplicationCloudwatchLoggingOptions?> cloudwatchLoggingOptions;
  ...
  Application(
    ...
    this.applicationConfiguration = registerOutput<ApplicationApplicationConfiguration>('applicationConfiguration');
    this.applicationMode = registerOutput<String>('applicationMode');
    this.arn = registerOutput<String>('arn');
    this.cloudwatchLoggingOptions = registerOutput<ApplicationCloudwatchLoggingOptions?>('cloudwatchLoggingOptions');
