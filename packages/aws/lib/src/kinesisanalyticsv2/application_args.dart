...
class ApplicationArgs {
  ...
  ApplicationArgs({
    ApplicationApplicationConfiguration? applicationConfiguration,
    String? applicationMode,
    ApplicationCloudwatchLoggingOptions? cloudwatchLoggingOptions,
    String? description,
    bool? forceStop,
    String? name,
    String? region,
    ...
    Map<String, String>? tags,
            ...
            pulumi.Input.asOptionalInput<ApplicationApplicationConfiguration>(
                applicationConfiguration),
        applicationMode = pulumi.Input.asOptionalInput<String>(applicationMode),
        cloudwatchLoggingOptions =
            pulumi.Input.asOptionalInput<ApplicationCloudwatchLoggingOptions>(
                cloudwatchLoggingOptions),
        ...
        serviceExecutionRole =
            pulumi.Input.asInput<String>(serviceExecutionRole),
  ...
  Map<String, dynamic> toMap() {
    ...
    if (applicationConfigurationValue != null) {
      map['applicationConfiguration'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      applicationConfiguration: map['applicationConfiguration'] == null
          ? null
          : ApplicationApplicationConfiguration.fromMap(
              (map['applicationConfiguration'] as Map).cast<String, dynamic>()),
      applicationMode: map['applicationMode'] == null
          ? null
          : map['applicationMode'] as String,
      ...
      runtimeEnvironment: map['runtimeEnvironment'] as String,
      serviceExecutionRole: map['serviceExecutionRole'] as String,
      startApplication: map['startApplication'] == null
          ? null
          : map['startApplication'] as bool,
      tags: map['tags'] == null
          ? null
