...
class ApplicationArgs {
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      applicationConfiguration: map['applicationConfiguration'] == null ? null : ApplicationApplicationConfiguration.fromMap((map['applicationConfiguration'] as Map).cast<String, dynamic>()),
      applicationMode: map['applicationMode'] == null ? null : map['applicationMode'] as String,
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : ApplicationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
