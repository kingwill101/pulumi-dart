...
class StackArgs {
  ...
  StackArgs({
    ...
    List<StackUserSetting>? userSettings,
  }) : accessEndpoints = pulumi
           .Input.asOptionalInput<List<StackAccessEndpoint>>(accessEndpoints),
       applicationSettings =
       ...
       embedHostDomains = pulumi.Input.asOptionalInput<List<String>>(
         embedHostDomains,
       ),
  ...
  factory StackArgs.fromMap(Map<String, dynamic> map) {
    return StackArgs(
      ...
      feedbackUrl: map['feedbackUrl'] == null
          ? null
          : map['feedbackUrl'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      redirectUrl: map['redirectUrl'] == null
          ? null
          : map['redirectUrl'] as String,
