...
class StackArgs {
  ...
  StackArgs({
    ...
    List<StackUserSetting>? userSettings,
            ...
            pulumi.Input.asOptionalInput<List<StackAccessEndpoint>>(
                accessEndpoints),
        applicationSettings =
        ...
        embedHostDomains =
            pulumi.Input.asOptionalInput<List<String>>(embedHostDomains),
        ...
        userSettings =
            pulumi.Input.asOptionalInput<List<StackUserSetting>>(userSettings);
  ...
  factory StackArgs.fromMap(Map<String, dynamic> map) {
    return StackArgs(
      ...
      embedHostDomains: map['embedHostDomains'] == null
          ? null
          : (map['embedHostDomains'] as List).cast<String>(),
      feedbackUrl:
          map['feedbackUrl'] == null ? null : map['feedbackUrl'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      redirectUrl:
          map['redirectUrl'] == null ? null : map['redirectUrl'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      storageConnectors: map['storageConnectors'] == null
          ? null
          : pulumi.Input.decodeList<StackStorageConnector>(
              map['storageConnectors'],
              (value) => StackStorageConnector.fromMap(
                  (value as Map).cast<String, dynamic>())),
      streamingExperienceSettings: map['streamingExperienceSettings'] == null
          ? null
          : StackStreamingExperienceSettings.fromMap(
              (map['streamingExperienceSettings'] as Map)
                  .cast<String, dynamic>()),
      tags: map['tags'] == null
          ? null
