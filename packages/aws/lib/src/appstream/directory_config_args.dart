...
class DirectoryConfigArgs {
  ...
  DirectoryConfigArgs({
    ...
    required DirectoryConfigServiceAccountCredentials serviceAccountCredentials,
       ...
       organizationalUnitDistinguishedNames = pulumi
           .Input.asInput<List<String>>(organizationalUnitDistinguishedNames),
  ...
  factory DirectoryConfigArgs.fromMap(Map<String, dynamic> map) {
    return DirectoryConfigArgs(
      certificateBasedAuthProperties:
          ...
          ? null
          : DirectoryConfigCertificateBasedAuthProperties.fromMap(
              (map['certificateBasedAuthProperties'] as Map)
                  .cast<String, dynamic>(),
            ),
      directoryName: map['directoryName'] as String,
      organizationalUnitDistinguishedNames:
          (map['organizationalUnitDistinguishedNames'] as List).cast<String>(),
      region: map['region'] == null ? null : map['region'] as String,
      serviceAccountCredentials:
          DirectoryConfigServiceAccountCredentials.fromMap(
