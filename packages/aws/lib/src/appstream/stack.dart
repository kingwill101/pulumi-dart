...
class Stack extends pulumi.CustomResource {
  ...
  Stack(String name, {StackArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.accessEndpoints = registerOutput<List<StackAccessEndpoint>>(
      'accessEndpoints',
    );
    this.applicationSettings = registerOutput<StackApplicationSettings>(
      'applicationSettings',
    );
    ...
    this.storageConnectors = registerOutput<List<StackStorageConnector>>(
      'storageConnectors',
    );
