...
class ImageBuilder extends pulumi.CustomResource {
  ...
  ImageBuilder(
    ...
    this.accessEndpoints = registerOutput<List<ImageBuilderAccessEndpoint>?>(
      'accessEndpoints',
    );
    this.appstreamAgentVersion = registerOutput<String>(
    ...
    this.domainJoinInfo = registerOutput<ImageBuilderDomainJoinInfo>(
      'domainJoinInfo',
    );
    this.enableDefaultInternetAccess = registerOutput<bool>(
