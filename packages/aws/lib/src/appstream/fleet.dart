...
class Fleet extends pulumi.CustomResource {
  ...
  Fleet(String name, {FleetArgs? args, pulumi.CustomResourceOptions? options})
    ...
    this.computeCapacity = registerOutput<FleetComputeCapacity>(
      'computeCapacity',
    );
    this.createdTime = registerOutput<String>('createdTime');
    this.description = registerOutput<String>('description');
    this.disconnectTimeoutInSeconds = registerOutput<int>(
    ...
    this.idleDisconnectTimeoutInSeconds = registerOutput<int?>(
      'idleDisconnectTimeoutInSeconds',
    );
    this.imageArn = registerOutput<String>('imageArn');
    this.imageName = registerOutput<String>('imageName');
    this.instanceType = registerOutput<String>('instanceType');
    this.maxSessionsPerInstance = registerOutput<int?>(
      'maxSessionsPerInstance',
    );
    this.maxUserDurationInSeconds = registerOutput<int>(
