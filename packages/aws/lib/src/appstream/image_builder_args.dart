...
class ImageBuilderArgs {
  ...
  factory ImageBuilderArgs.fromMap(Map<String, dynamic> map) {
    return ImageBuilderArgs(
      accessEndpoints: map['accessEndpoints'] == null ? null : pulumi.Input.decodeList<ImageBuilderAccessEndpoint>(map['accessEndpoints'], (value) => ImageBuilderAccessEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      appstreamAgentVersion: map['appstreamAgentVersion'] == null ? null : map['appstreamAgentVersion'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      domainJoinInfo: map['domainJoinInfo'] == null ? null : ImageBuilderDomainJoinInfo.fromMap((map['domainJoinInfo'] as Map).cast<String, dynamic>()),
      ...
      vpcConfig: map['vpcConfig'] == null ? null : ImageBuilderVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
