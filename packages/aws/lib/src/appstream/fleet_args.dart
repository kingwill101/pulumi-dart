...
class FleetArgs {
  ...
  FleetArgs({
    ...
    FleetVpcConfig? vpcConfig,
            ...
            pulumi.Input.asInput<FleetComputeCapacity>(computeCapacity),
        description = pulumi.Input.asOptionalInput<String>(description),
        disconnectTimeoutInSeconds =
            pulumi.Input.asOptionalInput<int>(disconnectTimeoutInSeconds),
        displayName = pulumi.Input.asOptionalInput<String>(displayName),
        domainJoinInfo =
            pulumi.Input.asOptionalInput<FleetDomainJoinInfo>(domainJoinInfo),
        ...
        idleDisconnectTimeoutInSeconds =
            pulumi.Input.asOptionalInput<int>(idleDisconnectTimeoutInSeconds),
        ...
        maxSessionsPerInstance =
            pulumi.Input.asOptionalInput<int>(maxSessionsPerInstance),
        maxUserDurationInSeconds =
            pulumi.Input.asOptionalInput<int>(maxUserDurationInSeconds),
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      computeCapacity: FleetComputeCapacity.fromMap(
          (map['computeCapacity'] as Map).cast<String, dynamic>()),
      description:
          map['description'] == null ? null : map['description'] as String,
      disconnectTimeoutInSeconds: map['disconnectTimeoutInSeconds'] == null
          ? null
          : map['disconnectTimeoutInSeconds'] as int,
      displayName:
      ...
      idleDisconnectTimeoutInSeconds:
          map['idleDisconnectTimeoutInSeconds'] == null
              ? null
              : map['idleDisconnectTimeoutInSeconds'] as int,
      imageArn: map['imageArn'] == null ? null : map['imageArn'] as String,
      imageName: map['imageName'] == null ? null : map['imageName'] as String,
      instanceType: map['instanceType'] as String,
      maxSessionsPerInstance: map['maxSessionsPerInstance'] == null
          ? null
          : map['maxSessionsPerInstance'] as int,
      maxUserDurationInSeconds: map['maxUserDurationInSeconds'] == null
          ? null
          : map['maxUserDurationInSeconds'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      streamView:
          map['streamView'] == null ? null : map['streamView'] as String,
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      vpcConfig: map['vpcConfig'] == null
          ? null
          : FleetVpcConfig.fromMap(
