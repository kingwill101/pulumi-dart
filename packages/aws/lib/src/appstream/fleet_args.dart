...
class FleetArgs {
  ...
  FleetArgs({
    ...
    FleetVpcConfig? vpcConfig,
  }) : computeCapacity = pulumi.Input.asInput<FleetComputeCapacity>(
         computeCapacity,
       ),
       description = pulumi.Input.asOptionalInput<String>(description),
       disconnectTimeoutInSeconds = pulumi.Input.asOptionalInput<int>(
       ...
       maxSessionsPerInstance = pulumi.Input.asOptionalInput<int>(
         maxSessionsPerInstance,
       ),
       maxUserDurationInSeconds = pulumi.Input.asOptionalInput<int>(
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      streamView: map['streamView'] == null
          ? null
          : map['streamView'] as String,
      tags: map['tags'] == null
          ? null
