...
class IngestionDestinationArgs {
  ...
  IngestionDestinationArgs({
    ...
    required IngestionDestinationDestinationConfiguration destinationConfiguration,
    required String ingestionArn,
    required IngestionDestinationProcessingConfiguration processingConfiguration,
    String? region,
    Map<String, String>? tags,
    IngestionDestinationTimeouts? timeouts,
  }) :
  ...
  factory IngestionDestinationArgs.fromMap(Map<String, dynamic> map) {
    return IngestionDestinationArgs(
      ...
      destinationConfiguration: IngestionDestinationDestinationConfiguration.fromMap((map['destinationConfiguration'] as Map).cast<String, dynamic>()),
      ingestionArn: map['ingestionArn'] as String,
      processingConfiguration: IngestionDestinationProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : IngestionDestinationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
