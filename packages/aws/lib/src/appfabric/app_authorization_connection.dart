...
class AppAuthorizationConnection extends pulumi.CustomResource {
  ...
  AppAuthorizationConnection(
    ...
    this.authRequest = registerOutput<AppAuthorizationConnectionAuthRequest?>(
      'authRequest',
    );
    this.region = registerOutput<String>('region');
    this.tenants = registerOutput<List<AppAuthorizationConnectionTenant>>(
      'tenants',
    );
    this.timeouts = registerOutput<AppAuthorizationConnectionTimeouts?>(
      'timeouts',
    );
  }
}
