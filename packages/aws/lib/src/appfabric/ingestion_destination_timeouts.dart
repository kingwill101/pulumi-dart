...
class IngestionDestinationTimeouts {
  ...
  /// Creates a new [IngestionDestinationTimeouts].
  ...
  IngestionDestinationTimeouts({this.create, this.delete, this.update});
  ...
  factory IngestionDestinationTimeouts.fromMap(Map<String, dynamic> map) {
    return IngestionDestinationTimeouts(
