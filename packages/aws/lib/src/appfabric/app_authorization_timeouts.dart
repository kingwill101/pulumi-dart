...
class AppAuthorizationTimeouts {
  ...
  /// Creates a new [AppAuthorizationTimeouts].
  ...
  AppAuthorizationTimeouts({this.create, this.delete, this.update});
  ...
  factory AppAuthorizationTimeouts.fromMap(Map<String, dynamic> map) {
    return AppAuthorizationTimeouts(
