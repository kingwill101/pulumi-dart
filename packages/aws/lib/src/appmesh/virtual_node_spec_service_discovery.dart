...
class VirtualNodeSpecServiceDiscovery {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsCloudMap': ?awsCloudMap == null ? null : awsCloudMap!.toMap(),
  ...
  factory VirtualNodeSpecServiceDiscovery.fromMap(Map<String, dynamic> map) {
    return VirtualNodeSpecServiceDiscovery(
      awsCloudMap: map['awsCloudMap'] == null ? null : VirtualNodeSpecServiceDiscoveryAwsCloudMap.fromMap((map['awsCloudMap'] as Map).cast<String, dynamic>()),
      dns: map['dns'] == null ? null : VirtualNodeSpecServiceDiscoveryDns.fromMap((map['dns'] as Map).cast<String, dynamic>()),
    );
  }
}
