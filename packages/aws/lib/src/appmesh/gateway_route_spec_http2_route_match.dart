...
class GatewayRouteSpecHttp2RouteMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers': ?headers == null ? null : pulumi.Input.encodeList<GatewayRouteSpecHttp2RouteMatchHeader, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'hostname': ?hostname == null ? null : hostname!.toMap(),
      'path': ?path == null ? null : path!.toMap(),
      'port': ?port,
      'prefix': ?prefix,
      'queryParameters': ?queryParameters == null ? null : pulumi.Input.encodeList<GatewayRouteSpecHttp2RouteMatchQueryParameter, Map<String, dynamic>>(queryParameters!, (value) => value.toMap()),
    };
  }

  factory GatewayRouteSpecHttp2RouteMatch.fromMap(Map<String, dynamic> map) {
    return GatewayRouteSpecHttp2RouteMatch(
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<GatewayRouteSpecHttp2RouteMatchHeader>(map['headers'], (value) => GatewayRouteSpecHttp2RouteMatchHeader.fromMap((value as Map).cast<String, dynamic>())),
      hostname: map['hostname'] == null ? null : GatewayRouteSpecHttp2RouteMatchHostname.fromMap((map['hostname'] as Map).cast<String, dynamic>()),
      path: map['path'] == null ? null : GatewayRouteSpecHttp2RouteMatchPath.fromMap((map['path'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      prefix: map['prefix'] == null ? null : map['prefix'] as String,
      queryParameters: map['queryParameters'] == null ? null : pulumi.Input.decodeList<GatewayRouteSpecHttp2RouteMatchQueryParameter>(map['queryParameters'], (value) => GatewayRouteSpecHttp2RouteMatchQueryParameter.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
