...
class GetGatewayRouteSpecHttpRouteMatchHeader {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'invert': invert,
      'matches': pulumi.Input.encodeList<GetGatewayRouteSpecHttpRouteMatchHeaderMatch, Map<String, dynamic>>(matches, (value) => value.toMap()),
      'name': name,
    };
  }
  ...
  factory GetGatewayRouteSpecHttpRouteMatchHeader.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttpRouteMatchHeader(
      ...
      matches: pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteMatchHeaderMatch>(map['matches'], (value) => GetGatewayRouteSpecHttpRouteMatchHeaderMatch.fromMap((value as Map).cast<String, dynamic>())),
