...
class VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust {
  ...
  factory VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust.fromMap(
    ...
    return VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust(
      acm: map['acm'] == null
          ? null
          : VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustAcm.fromMap(
              (map['acm'] as Map).cast<String, dynamic>(),
            ),
      file: map['file'] == null
          ? null
          : VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFile.fromMap(
              (map['file'] as Map).cast<String, dynamic>(),
            ),
      sds: map['sds'] == null
          ? null
          : VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustSds.fromMap(
