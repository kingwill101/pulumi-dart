...
class RouteSpecHttpRouteMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers': ?headers == null ? null : pulumi.Input.encodeList<RouteSpecHttpRouteMatchHeader, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'method': ?method,
      'path': ?path == null ? null : path!.toMap(),
      'port': ?port,
      'prefix': ?prefix,
      'queryParameters': ?queryParameters == null ? null : pulumi.Input.encodeList<RouteSpecHttpRouteMatchQueryParameter, Map<String, dynamic>>(queryParameters!, (value) => value.toMap()),
      'scheme': ?scheme,
    };
  }
  ...
  factory RouteSpecHttpRouteMatch.fromMap(Map<String, dynamic> map) {
    return RouteSpecHttpRouteMatch(
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<RouteSpecHttpRouteMatchHeader>(map['headers'], (value) => RouteSpecHttpRouteMatchHeader.fromMap((value as Map).cast<String, dynamic>())),
      method: map['method'] == null ? null : map['method'] as String,
      path: map['path'] == null ? null : RouteSpecHttpRouteMatchPath.fromMap((map['path'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as int,
      prefix: map['prefix'] == null ? null : map['prefix'] as String,
      queryParameters: map['queryParameters'] == null ? null : pulumi.Input.decodeList<RouteSpecHttpRouteMatchQueryParameter>(map['queryParameters'], (value) => RouteSpecHttpRouteMatchQueryParameter.fromMap((value as Map).cast<String, dynamic>())),
