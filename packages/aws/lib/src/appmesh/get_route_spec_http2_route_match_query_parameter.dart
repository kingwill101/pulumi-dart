...
class GetRouteSpecHttp2RouteMatchQueryParameter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matches': pulumi.Input.encodeList<GetRouteSpecHttp2RouteMatchQueryParameterMatch, Map<String, dynamic>>(matches, (value) => value.toMap()),
      'name': name,
    };
  }
  ...
  factory GetRouteSpecHttp2RouteMatchQueryParameter.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttp2RouteMatchQueryParameter(
      matches: pulumi.Input.decodeList<GetRouteSpecHttp2RouteMatchQueryParameterMatch>(map['matches'], (value) => GetRouteSpecHttp2RouteMatchQueryParameterMatch.fromMap((value as Map).cast<String, dynamic>())),
