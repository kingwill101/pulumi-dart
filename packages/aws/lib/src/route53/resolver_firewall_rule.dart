...
class ResolverFirewallRule extends pulumi.CustomResource {
  ...
  ResolverFirewallRule(
    ...
    this.firewallDomainRedirectionAction = registerOutput<String?>('firewallDomainRedirectionAction');
    this.firewallRuleGroupId = registerOutput<String>('firewallRuleGroupId');
    this.firewallThreatProtectionId = registerOutput<String>('firewallThreatProtectionId');
