...
class HealthCheckArgs {
  ...
  factory HealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckArgs(
      childHealthThreshold: map['childHealthThreshold'] == null ? null : map['childHealthThreshold'] as int,
      childHealthchecks: map['childHealthchecks'] == null ? null : (map['childHealthchecks'] as List).cast<String>(),
      cloudwatchAlarmName: map['cloudwatchAlarmName'] == null ? null : map['cloudwatchAlarmName'] as String,
      cloudwatchAlarmRegion: map['cloudwatchAlarmRegion'] == null ? null : map['cloudwatchAlarmRegion'] as String,
      ...
      insufficientDataHealthStatus: map['insufficientDataHealthStatus'] == null ? null : map['insufficientDataHealthStatus'] as String,
      invertHealthcheck: map['invertHealthcheck'] == null ? null : map['invertHealthcheck'] as bool,
      ipAddress: map['ipAddress'] == null ? null : map['ipAddress'] as String,
      measureLatency: map['measureLatency'] == null ? null : map['measureLatency'] as bool,
      ...
      requestInterval: map['requestInterval'] == null ? null : map['requestInterval'] as int,
      resourcePath: map['resourcePath'] == null ? null : map['resourcePath'] as String,
      routingControlArn: map['routingControlArn'] == null ? null : map['routingControlArn'] as String,
