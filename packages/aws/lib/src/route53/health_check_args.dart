...
class HealthCheckArgs {
  ...
  HealthCheckArgs({
    ...
    required String type,
            ...
            pulumi.Input.asOptionalInput<int>(childHealthThreshold),
        childHealthchecks =
            pulumi.Input.asOptionalInput<List<String>>(childHealthchecks),
        cloudwatchAlarmName =
            pulumi.Input.asOptionalInput<String>(cloudwatchAlarmName),
        cloudwatchAlarmRegion =
            pulumi.Input.asOptionalInput<String>(cloudwatchAlarmRegion),
        ...
        insufficientDataHealthStatus =
            pulumi.Input.asOptionalInput<String>(insufficientDataHealthStatus),
        invertHealthcheck =
            pulumi.Input.asOptionalInput<bool>(invertHealthcheck),
        ...
        routingControlArn =
            pulumi.Input.asOptionalInput<String>(routingControlArn),
  ...
  factory HealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckArgs(
      ...
      measureLatency:
          map['measureLatency'] == null ? null : map['measureLatency'] as bool,
      ...
      requestInterval:
          map['requestInterval'] == null ? null : map['requestInterval'] as int,
      resourcePath:
