...
class RecordGeoproximityRoutingPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsRegion': ?awsRegion,
      'bias': ?bias,
      'coordinates': ?coordinates == null ? null : pulumi.Input.encodeList<RecordGeoproximityRoutingPolicyCoordinate, Map<String, dynamic>>(coordinates!, (value) => value.toMap()),
  ...
  factory RecordGeoproximityRoutingPolicy.fromMap(Map<String, dynamic> map) {
    return RecordGeoproximityRoutingPolicy(
      ...
      coordinates: map['coordinates'] == null ? null : pulumi.Input.decodeList<RecordGeoproximityRoutingPolicyCoordinate>(map['coordinates'], (value) => RecordGeoproximityRoutingPolicyCoordinate.fromMap((value as Map).cast<String, dynamic>())),
