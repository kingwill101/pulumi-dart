...
class SafetyRuleArgs {
  ...
  SafetyRuleArgs({
    ...
    String? name,
    required SafetyRuleRuleConfig ruleConfig,
    Map<String, String>? tags,
    List<String>? targetControls,
    required int waitPeriodMs,
  })  : assertedControls =
            pulumi.Input.asOptionalInput<List<String>>(assertedControls),
        controlPanelArn = pulumi.Input.asInput<String>(controlPanelArn),
        gatingControls =
            pulumi.Input.asOptionalInput<List<String>>(gatingControls),
        name = pulumi.Input.asOptionalInput<String>(name),
        ruleConfig = pulumi.Input.asInput<SafetyRuleRuleConfig>(ruleConfig),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        targetControls =
            pulumi.Input.asOptionalInput<List<String>>(targetControls),
