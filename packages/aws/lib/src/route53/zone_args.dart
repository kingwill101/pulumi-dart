...
class ZoneArgs {
  ...
  factory ZoneArgs.fromMap(Map<String, dynamic> map) {
    return ZoneArgs(
      ...
      delegationSetId: map['delegationSetId'] == null ? null : map['delegationSetId'] as String,
      ...
      vpcs: map['vpcs'] == null ? null : pulumi.Input.decodeList<ZoneVpc>(map['vpcs'], (value) => ZoneVpc.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
