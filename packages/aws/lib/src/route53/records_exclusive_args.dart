...
class RecordsExclusiveArgs {
  ...
  factory RecordsExclusiveArgs.fromMap(Map<String, dynamic> map) {
    return RecordsExclusiveArgs(
      resourceRecordSets: map['resourceRecordSets'] == null ? null : pulumi.Input.decodeList<RecordsExclusiveResourceRecordSet>(map['resourceRecordSets'], (value) => RecordsExclusiveResourceRecordSet.fromMap((value as Map).cast<String, dynamic>())),
      timeouts: map['timeouts'] == null ? null : RecordsExclusiveTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
