...
class DomainArgs {
  ...
  DomainArgs({
    ...
    bool? transferLock,
       ...
       billingContacts = pulumi
           .Input.asOptionalInput<List<DomainBillingContact>>(billingContacts),
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      durationInYears: map['durationInYears'] == null
          ? null
          : map['durationInYears'] as int,
