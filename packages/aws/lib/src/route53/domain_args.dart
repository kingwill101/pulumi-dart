...
class DomainArgs {
  ...
  DomainArgs({
    ...
    bool? transferLock,
        ...
        billingContacts =
            pulumi.Input.asOptionalInput<List<DomainBillingContact>>(
                billingContacts),
        ...
        nameServers =
            pulumi.Input.asOptionalInput<List<DomainNameServer>>(nameServers),
        registrantContact =
            pulumi.Input.asInput<DomainRegistrantContact>(registrantContact),
        registrantPrivacy =
            pulumi.Input.asOptionalInput<bool>(registrantPrivacy),
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      adminContact: DomainAdminContact.fromMap(
          (map['adminContact'] as Map).cast<String, dynamic>()),
      adminPrivacy:
          map['adminPrivacy'] == null ? null : map['adminPrivacy'] as bool,
      autoRenew: map['autoRenew'] == null ? null : map['autoRenew'] as bool,
      billingContacts: map['billingContacts'] == null
          ? null
          : pulumi.Input.decodeList<DomainBillingContact>(
              map['billingContacts'],
              (value) => DomainBillingContact.fromMap(
                  (value as Map).cast<String, dynamic>())),
      billingPrivacy:
          map['billingPrivacy'] == null ? null : map['billingPrivacy'] as bool,
      domainName: map['domainName'] as String,
      durationInYears:
          map['durationInYears'] == null ? null : map['durationInYears'] as int,
      nameServers: map['nameServers'] == null
          ? null
          : pulumi.Input.decodeList<DomainNameServer>(
              map['nameServers'],
              (value) => DomainNameServer.fromMap(
                  (value as Map).cast<String, dynamic>())),
      registrantContact: DomainRegistrantContact.fromMap(
      ...
      techContact: DomainTechContact.fromMap(
          (map['techContact'] as Map).cast<String, dynamic>()),
      techPrivacy:
          map['techPrivacy'] == null ? null : map['techPrivacy'] as bool,
      timeouts: map['timeouts'] == null
          ? null
          : DomainTimeouts.fromMap(
              (map['timeouts'] as Map).cast<String, dynamic>()),
      transferLock:
          map['transferLock'] == null ? null : map['transferLock'] as bool,
    );
  }
}
