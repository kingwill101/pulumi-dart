...
class RegisteredDomain extends pulumi.CustomResource {
  ...
  RegisteredDomain(
    ...
    this.adminContact = registerOutput<RegisteredDomainAdminContact>(
      'adminContact',
    );
    this.adminPrivacy = registerOutput<bool?>('adminPrivacy');
    this.autoRenew = registerOutput<bool?>('autoRenew');
    this.billingContact = registerOutput<RegisteredDomainBillingContact>(
      'billingContact',
    );
    ...
    this.nameServers = registerOutput<List<RegisteredDomainNameServer>>(
      'nameServers',
    );
    this.registrantContact = registerOutput<RegisteredDomainRegistrantContact>(
      'registrantContact',
    );
    ...
    this.techContact = registerOutput<RegisteredDomainTechContact>(
      'techContact',
    );
