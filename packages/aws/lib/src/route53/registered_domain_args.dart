...
class RegisteredDomainArgs {
  ...
  factory RegisteredDomainArgs.fromMap(Map<String, dynamic> map) {
    return RegisteredDomainArgs(
      adminContact: map['adminContact'] == null ? null : RegisteredDomainAdminContact.fromMap((map['adminContact'] as Map).cast<String, dynamic>()),
      adminPrivacy: map['adminPrivacy'] == null ? null : map['adminPrivacy'] as bool,
      autoRenew: map['autoRenew'] == null ? null : map['autoRenew'] as bool,
      billingContact: map['billingContact'] == null ? null : RegisteredDomainBillingContact.fromMap((map['billingContact'] as Map).cast<String, dynamic>()),
      billingPrivacy: map['billingPrivacy'] == null ? null : map['billingPrivacy'] as bool,
      domainName: map['domainName'] as String,
      nameServers: map['nameServers'] == null ? null : pulumi.Input.decodeList<RegisteredDomainNameServer>(map['nameServers'], (value) => RegisteredDomainNameServer.fromMap((value as Map).cast<String, dynamic>())),
      registrantContact: map['registrantContact'] == null ? null : RegisteredDomainRegistrantContact.fromMap((map['registrantContact'] as Map).cast<String, dynamic>()),
      registrantPrivacy: map['registrantPrivacy'] == null ? null : map['registrantPrivacy'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      techContact: map['techContact'] == null ? null : RegisteredDomainTechContact.fromMap((map['techContact'] as Map).cast<String, dynamic>()),
