...
class ResolverFirewallRuleArgs {
  ...
  ResolverFirewallRuleArgs({
    ...
    String? region,
        ...
        blockOverrideDnsType =
            pulumi.Input.asOptionalInput<String>(blockOverrideDnsType),
        blockOverrideDomain =
            pulumi.Input.asOptionalInput<String>(blockOverrideDomain),
        ...
        confidenceThreshold =
            pulumi.Input.asOptionalInput<String>(confidenceThreshold),
        dnsThreatProtection =
            pulumi.Input.asOptionalInput<String>(dnsThreatProtection),
        firewallDomainListId =
            pulumi.Input.asOptionalInput<String>(firewallDomainListId),
  ...
  factory ResolverFirewallRuleArgs.fromMap(Map<String, dynamic> map) {
    return ResolverFirewallRuleArgs(
      ...
      blockResponse:
          map['blockResponse'] == null ? null : map['blockResponse'] as String,
