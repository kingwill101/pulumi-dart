...
class ResolverFirewallRuleArgs {
  ...
  factory ResolverFirewallRuleArgs.fromMap(Map<String, dynamic> map) {
    return ResolverFirewallRuleArgs(
      ...
      blockOverrideDnsType: map['blockOverrideDnsType'] == null ? null : map['blockOverrideDnsType'] as String,
      blockOverrideDomain: map['blockOverrideDomain'] == null ? null : map['blockOverrideDomain'] as String,
      blockOverrideTtl: map['blockOverrideTtl'] == null ? null : map['blockOverrideTtl'] as int,
      blockResponse: map['blockResponse'] == null ? null : map['blockResponse'] as String,
      confidenceThreshold: map['confidenceThreshold'] == null ? null : map['confidenceThreshold'] as String,
      dnsThreatProtection: map['dnsThreatProtection'] == null ? null : map['dnsThreatProtection'] as String,
      firewallDomainListId: map['firewallDomainListId'] == null ? null : map['firewallDomainListId'] as String,
      firewallDomainRedirectionAction: map['firewallDomainRedirectionAction'] == null ? null : map['firewallDomainRedirectionAction'] as String,
