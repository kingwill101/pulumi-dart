...
class RecordArgs {
  ...
  factory RecordArgs.fromMap(Map<String, dynamic> map) {
    return RecordArgs(
      aliases: map['aliases'] == null ? null : pulumi.Input.decodeList<RecordAlias>(map['aliases'], (value) => RecordAlias.fromMap((value as Map).cast<String, dynamic>())),
      allowOverwrite: map['allowOverwrite'] == null ? null : map['allowOverwrite'] as bool,
      cidrRoutingPolicy: map['cidrRoutingPolicy'] == null ? null : RecordCidrRoutingPolicy.fromMap((map['cidrRoutingPolicy'] as Map).cast<String, dynamic>()),
      failoverRoutingPolicies: map['failoverRoutingPolicies'] == null ? null : pulumi.Input.decodeList<RecordFailoverRoutingPolicy>(map['failoverRoutingPolicies'], (value) => RecordFailoverRoutingPolicy.fromMap((value as Map).cast<String, dynamic>())),
      geolocationRoutingPolicies: map['geolocationRoutingPolicies'] == null ? null : pulumi.Input.decodeList<RecordGeolocationRoutingPolicy>(map['geolocationRoutingPolicies'], (value) => RecordGeolocationRoutingPolicy.fromMap((value as Map).cast<String, dynamic>())),
      geoproximityRoutingPolicy: map['geoproximityRoutingPolicy'] == null ? null : RecordGeoproximityRoutingPolicy.fromMap((map['geoproximityRoutingPolicy'] as Map).cast<String, dynamic>()),
      healthCheckId: map['healthCheckId'] == null ? null : map['healthCheckId'] as String,
      latencyRoutingPolicies: map['latencyRoutingPolicies'] == null ? null : pulumi.Input.decodeList<RecordLatencyRoutingPolicy>(map['latencyRoutingPolicies'], (value) => RecordLatencyRoutingPolicy.fromMap((value as Map).cast<String, dynamic>())),
      multivalueAnswerRoutingPolicy: map['multivalueAnswerRoutingPolicy'] == null ? null : map['multivalueAnswerRoutingPolicy'] as bool,
      ...
      weightedRoutingPolicies: map['weightedRoutingPolicies'] == null ? null : pulumi.Input.decodeList<RecordWeightedRoutingPolicy>(map['weightedRoutingPolicies'], (value) => RecordWeightedRoutingPolicy.fromMap((value as Map).cast<String, dynamic>())),
