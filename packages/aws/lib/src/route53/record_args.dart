...
class RecordArgs {
  ...
  RecordArgs({
    ...
    required String zoneId,
       ...
       cidrRoutingPolicy = pulumi
           .Input.asOptionalInput<RecordCidrRoutingPolicy>(cidrRoutingPolicy),
       failoverRoutingPolicies =
       ...
       multivalueAnswerRoutingPolicy = pulumi.Input.asOptionalInput<bool>(
    ...
    return <String, dynamic>{
      'aliases':
          ...
          >(
            aliases,
            (value) =>
                pulumi.Input.encodeList<RecordAlias, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'cidrRoutingPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cidrRoutingPolicy, (value) => value.toMap()),
      'failoverRoutingPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecordFailoverRoutingPolicy>,
            List<Map<String, dynamic>>
          >(
            failoverRoutingPolicies,
            (value) =>
      ...
      'geolocationRoutingPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecordGeolocationRoutingPolicy>,
            List<Map<String, dynamic>>
          >(
            geolocationRoutingPolicies,
            (value) =>
      ...
      'geoproximityRoutingPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(geoproximityRoutingPolicy, (value) => value.toMap()),
      'healthCheckId': ?healthCheckId,
      'latencyRoutingPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecordLatencyRoutingPolicy>,
            List<Map<String, dynamic>>
          >(
            latencyRoutingPolicies,
            (value) =>
      ...
      'weightedRoutingPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecordWeightedRoutingPolicy>,
            List<Map<String, dynamic>>
          >(
            weightedRoutingPolicies,
            (value) =>
  ...
  factory RecordArgs.fromMap(Map<String, dynamic> map) {
    return RecordArgs(
      ...
      allowOverwrite: map['allowOverwrite'] == null
          ? null
          : map['allowOverwrite'] as bool,
      ...
      geoproximityRoutingPolicy: map['geoproximityRoutingPolicy'] == null
          ...
          : RecordGeoproximityRoutingPolicy.fromMap(
              (map['geoproximityRoutingPolicy'] as Map).cast<String, dynamic>(),
            ),
      healthCheckId: map['healthCheckId'] == null
          ? null
          : map['healthCheckId'] as String,
      ...
      setIdentifier: map['setIdentifier'] == null
          ? null
          : map['setIdentifier'] as String,
