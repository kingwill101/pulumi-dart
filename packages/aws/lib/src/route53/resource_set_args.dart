...
class ResourceSetArgs {
  ...
  ResourceSetArgs({
    ...
    required List<ResourceSetResource> resources,
  ...
  factory ResourceSetArgs.fromMap(Map<String, dynamic> map) {
    return ResourceSetArgs(
      resourceSetName: map['resourceSetName'] as String,
      resourceSetType: map['resourceSetType'] as String,
      resources: pulumi.Input.decodeList<ResourceSetResource>(map['resources'], (value) => ResourceSetResource.fromMap((value as Map).cast<String, dynamic>())),
