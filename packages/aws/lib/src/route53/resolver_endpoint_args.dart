...
class ResolverEndpointArgs {
  ...
  ResolverEndpointArgs({
    ...
    required List<ResolverEndpointIpAddress> ipAddresses,
    String? name,
    ...
    bool? targetNameServerMetricsEnabled,
        ...
        ipAddresses =
            pulumi.Input.asInput<List<ResolverEndpointIpAddress>>(ipAddresses),
        name = pulumi.Input.asOptionalInput<String>(name),
        protocols = pulumi.Input.asOptionalInput<List<String>>(protocols),
        region = pulumi.Input.asOptionalInput<String>(region),
        resolverEndpointType =
            pulumi.Input.asOptionalInput<String>(resolverEndpointType),
        rniEnhancedMetricsEnabled =
            pulumi.Input.asOptionalInput<bool>(rniEnhancedMetricsEnabled),
        securityGroupIds = pulumi.Input.asInput<List<String>>(securityGroupIds),
        tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
        targetNameServerMetricsEnabled =
            pulumi.Input.asOptionalInput<bool>(targetNameServerMetricsEnabled);

  Map<String, dynamic> toMap() {
    final map = <String, dynamic>{};
    map['direction'] = direction;
    map['ipAddresses'] = pulumi.Input.mapInputValue<
            List<ResolverEndpointIpAddress>, List<Map<String, dynamic>>>(
        ipAddresses,
        (value) => pulumi.Input.encodeList<ResolverEndpointIpAddress,
  ...
  factory ResolverEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ResolverEndpointArgs(
      ...
      ipAddresses: pulumi.Input.decodeList<ResolverEndpointIpAddress>(
          map['ipAddresses'],
          (value) => ResolverEndpointIpAddress.fromMap(
      ...
      resolverEndpointType: map['resolverEndpointType'] == null
          ? null
          : map['resolverEndpointType'] as String,
      rniEnhancedMetricsEnabled: map['rniEnhancedMetricsEnabled'] == null
          ? null
          : map['rniEnhancedMetricsEnabled'] as bool,
      securityGroupIds: (map['securityGroupIds'] as List).cast<String>(),
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      targetNameServerMetricsEnabled:
          map['targetNameServerMetricsEnabled'] == null
              ? null
