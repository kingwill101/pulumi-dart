...
class ResolverEndpointArgs {
  ...
  factory ResolverEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ResolverEndpointArgs(
      ...
      ipAddresses: pulumi.Input.decodeList<ResolverEndpointIpAddress>(map['ipAddresses'], (value) => ResolverEndpointIpAddress.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      protocols: map['protocols'] == null ? null : (map['protocols'] as List).cast<String>(),
      region: map['region'] == null ? null : map['region'] as String,
      resolverEndpointType: map['resolverEndpointType'] == null ? null : map['resolverEndpointType'] as String,
      rniEnhancedMetricsEnabled: map['rniEnhancedMetricsEnabled'] == null ? null : map['rniEnhancedMetricsEnabled'] as bool,
      securityGroupIds: (map['securityGroupIds'] as List).cast<String>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetNameServerMetricsEnabled: map['targetNameServerMetricsEnabled'] == null ? null : map['targetNameServerMetricsEnabled'] as bool,
    );
  }
}
