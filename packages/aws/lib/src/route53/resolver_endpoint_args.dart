...
class ResolverEndpointArgs {
  ...
  ResolverEndpointArgs({
    ...
    bool? targetNameServerMetricsEnabled,
       ...
       ipAddresses = pulumi.Input.asInput<List<ResolverEndpointIpAddress>>(
         ipAddresses,
       ),
       name = pulumi.Input.asOptionalInput<String>(name),
       protocols = pulumi.Input.asOptionalInput<List<String>>(protocols),
       region = pulumi.Input.asOptionalInput<String>(region),
       resolverEndpointType = pulumi.Input.asOptionalInput<String>(
         resolverEndpointType,
       ),
       rniEnhancedMetricsEnabled = pulumi.Input.asOptionalInput<bool>(
         rniEnhancedMetricsEnabled,
       ),
       securityGroupIds = pulumi.Input.asInput<List<String>>(securityGroupIds),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       targetNameServerMetricsEnabled = pulumi.Input.asOptionalInput<bool>(
    ...
    return <String, dynamic>{
      ...
      'ipAddresses':
          pulumi.Input.mapInputValue<
            List<ResolverEndpointIpAddress>,
