...
class ProfilesAssociationTimeouts {
  ...
  /// Creates a new [ProfilesAssociationTimeouts].
  ...
  ProfilesAssociationTimeouts({this.create, this.delete, this.update});
  ...
  factory ProfilesAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return ProfilesAssociationTimeouts(
