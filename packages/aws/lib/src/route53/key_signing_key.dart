...
class KeySigningKey extends pulumi.CustomResource {
  ...
  KeySigningKey(
    ...
    this.digestAlgorithmMnemonic = registerOutput<String>(
    ...
    this.keyManagementServiceArn = registerOutput<String>(
      'keyManagementServiceArn',
    );
    this.keyTag = registerOutput<int>('keyTag');
    this.name = registerOutput<String>('name');
    this.publicKey = registerOutput<String>('publicKey');
    this.signingAlgorithmMnemonic = registerOutput<String>(
