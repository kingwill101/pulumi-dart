...
class ProfilesResourceAssociationArgs {
  ...
  factory ProfilesResourceAssociationArgs.fromMap(Map<String, dynamic> map) {
    return ProfilesResourceAssociationArgs(
      ...
      resourceProperties: map['resourceProperties'] == null ? null : map['resourceProperties'] as String,
      timeouts: map['timeouts'] == null ? null : ProfilesResourceAssociationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
