...
class DelegationSignerRecordArgs {
  ...
  factory DelegationSignerRecordArgs.fromMap(Map<String, dynamic> map) {
    return DelegationSignerRecordArgs(
      ...
      signingAttributes: map['signingAttributes'] == null ? null : DelegationSignerRecordSigningAttributes.fromMap((map['signingAttributes'] as Map).cast<String, dynamic>()),
      timeouts: map['timeouts'] == null ? null : DelegationSignerRecordTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
