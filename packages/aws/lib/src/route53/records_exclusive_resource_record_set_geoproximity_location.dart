...
class RecordsExclusiveResourceRecordSetGeoproximityLocation {
  ...
  final RecordsExclusiveResourceRecordSetGeoproximityLocationCoordinates? coordinates;
  ...
  factory RecordsExclusiveResourceRecordSetGeoproximityLocation.fromMap(Map<String, dynamic> map) {
    return RecordsExclusiveResourceRecordSetGeoproximityLocation(
      ...
      coordinates: map['coordinates'] == null ? null : RecordsExclusiveResourceRecordSetGeoproximityLocationCoordinates.fromMap((map['coordinates'] as Map).cast<String, dynamic>()),
