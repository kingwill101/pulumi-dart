...
class ResolverEndpoint extends pulumi.CustomResource {
  ...
  ResolverEndpoint(
    ...
    this.ipAddresses = registerOutput<List<ResolverEndpointIpAddress>>(
      'ipAddresses',
    );
    ...
    this.rniEnhancedMetricsEnabled = registerOutput<bool>(
      'rniEnhancedMetricsEnabled',
    );
    this.securityGroupIds = registerOutput<List<String>>('securityGroupIds');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.targetNameServerMetricsEnabled = registerOutput<bool>(
