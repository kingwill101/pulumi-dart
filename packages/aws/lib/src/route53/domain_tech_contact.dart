...
class DomainTechContact {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'email': ?email,
      'extraParams': ?extraParams == null ? null : pulumi.Input.encodeList<DomainTechContactExtraParam, Map<String, dynamic>>(extraParams!, (value) => value.toMap()),
      'fax': ?fax,
      'firstName': ?firstName,
      'lastName': ?lastName,
  ...
  factory DomainTechContact.fromMap(Map<String, dynamic> map) {
    return DomainTechContact(
      ...
      extraParams: map['extraParams'] == null ? null : pulumi.Input.decodeList<DomainTechContactExtraParam>(map['extraParams'], (value) => DomainTechContactExtraParam.fromMap((value as Map).cast<String, dynamic>())),
