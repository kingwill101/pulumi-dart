...
class JobTemplateJobTemplateDataJobDriver {
  ...
  final JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriver? sparkSubmitJobDriver;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'sparkSqlJobDriver': ?sparkSqlJobDriver == null ? null : sparkSqlJobDriver!.toMap(),
      'sparkSubmitJobDriver': ?sparkSubmitJobDriver == null ? null : sparkSubmitJobDriver!.toMap(),
    };
  }

  factory JobTemplateJobTemplateDataJobDriver.fromMap(Map<String, dynamic> map) {
    return JobTemplateJobTemplateDataJobDriver(
      sparkSqlJobDriver: map['sparkSqlJobDriver'] == null ? null : JobTemplateJobTemplateDataJobDriverSparkSqlJobDriver.fromMap((map['sparkSqlJobDriver'] as Map).cast<String, dynamic>()),
      sparkSubmitJobDriver: map['sparkSubmitJobDriver'] == null ? null : JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriver.fromMap((map['sparkSubmitJobDriver'] as Map).cast<String, dynamic>()),
    );
  }
}
