...
class GetVirtualClusterContainerProvider {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': id,
      'infos': pulumi.Input.encodeList<GetVirtualClusterContainerProviderInfo, Map<String, dynamic>>(infos, (value) => value.toMap()),
      'type': type,
    };
  }
  ...
  factory GetVirtualClusterContainerProvider.fromMap(Map<String, dynamic> map) {
    return GetVirtualClusterContainerProvider(
      id: map['id'] as String,
      infos: pulumi.Input.decodeList<GetVirtualClusterContainerProviderInfo>(map['infos'], (value) => GetVirtualClusterContainerProviderInfo.fromMap((value as Map).cast<String, dynamic>())),
