...
class JobTemplateJobTemplateDataConfigurationOverridesApplicationConfiguration {
  ...
  final List<JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationConfiguration>? configurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'configurations': ?configurations == null ? null : pulumi.Input.encodeList<JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationConfiguration, Map<String, dynamic>>(configurations!, (value) => value.toMap()),
