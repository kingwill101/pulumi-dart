...
class PipelineArgs {
  ...
  PipelineArgs({
    ...
    List<PipelineVariable>? variables,
            ...
            pulumi.Input.asInput<List<PipelineArtifactStore>>(artifactStores),
        ...
        triggers =
            pulumi.Input.asOptionalInput<List<PipelineTrigger>>(triggers),
        variables =
            pulumi.Input.asOptionalInput<List<PipelineVariable>>(variables);
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      ...
      executionMode:
          map['executionMode'] == null ? null : map['executionMode'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      pipelineType:
          map['pipelineType'] == null ? null : map['pipelineType'] as String,
