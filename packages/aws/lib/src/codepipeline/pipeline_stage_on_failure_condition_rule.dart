...
import 'pipeline_stage_on_failure_condition_rule_rule_type_id.dart';
...
class PipelineStageOnFailureConditionRule {
  ...
  final PipelineStageOnFailureConditionRuleRuleTypeId ruleTypeId;
  /// The action timeout for the rule.
  final int? timeoutInMinutes;

  /// Creates a new [PipelineStageOnFailureConditionRule].
  ...
  factory PipelineStageOnFailureConditionRule.fromMap(Map<String, dynamic> map) {
    return PipelineStageOnFailureConditionRule(
      ...
      ruleTypeId: PipelineStageOnFailureConditionRuleRuleTypeId.fromMap((map['ruleTypeId'] as Map).cast<String, dynamic>()),
