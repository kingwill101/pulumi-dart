...
class CustomActionTypeArgs {
  ...
  factory CustomActionTypeArgs.fromMap(Map<String, dynamic> map) {
    return CustomActionTypeArgs(
      ...
      configurationProperties: map['configurationProperties'] == null ? null : pulumi.Input.decodeList<CustomActionTypeConfigurationProperty>(map['configurationProperties'], (value) => CustomActionTypeConfigurationProperty.fromMap((value as Map).cast<String, dynamic>())),
      inputArtifactDetails: CustomActionTypeInputArtifactDetails.fromMap((map['inputArtifactDetails'] as Map).cast<String, dynamic>()),
      outputArtifactDetails: CustomActionTypeOutputArtifactDetails.fromMap((map['outputArtifactDetails'] as Map).cast<String, dynamic>()),
      providerName: map['providerName'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      settings: map['settings'] == null ? null : CustomActionTypeSettings.fromMap((map['settings'] as Map).cast<String, dynamic>()),
