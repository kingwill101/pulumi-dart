...
class PipelineTriggerGitConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'pullRequests': ?pullRequests == null ? null : pulumi.Input.encodeList<PipelineTriggerGitConfigurationPullRequest, Map<String, dynamic>>(pullRequests!, (value) => value.toMap()),
      'pushes': ?pushes == null ? null : pulumi.Input.encodeList<PipelineTriggerGitConfigurationPush, Map<String, dynamic>>(pushes!, (value) => value.toMap()),
  ...
  factory PipelineTriggerGitConfiguration.fromMap(Map<String, dynamic> map) {
    return PipelineTriggerGitConfiguration(
      pullRequests: map['pullRequests'] == null ? null : pulumi.Input.decodeList<PipelineTriggerGitConfigurationPullRequest>(map['pullRequests'], (value) => PipelineTriggerGitConfigurationPullRequest.fromMap((value as Map).cast<String, dynamic>())),
      pushes: map['pushes'] == null ? null : pulumi.Input.decodeList<PipelineTriggerGitConfigurationPush>(map['pushes'], (value) => PipelineTriggerGitConfigurationPush.fromMap((value as Map).cast<String, dynamic>())),
