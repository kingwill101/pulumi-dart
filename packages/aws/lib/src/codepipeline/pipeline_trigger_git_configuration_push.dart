...
class PipelineTriggerGitConfigurationPush {
  ...
  factory PipelineTriggerGitConfigurationPush.fromMap(Map<String, dynamic> map) {
    return PipelineTriggerGitConfigurationPush(
      branches: map['branches'] == null ? null : PipelineTriggerGitConfigurationPushBranches.fromMap((map['branches'] as Map).cast<String, dynamic>()),
      filePaths: map['filePaths'] == null ? null : PipelineTriggerGitConfigurationPushFilePaths.fromMap((map['filePaths'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : PipelineTriggerGitConfigurationPushTags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
    );
  }
}
