...
class KeyArgs {
  ...
  factory KeyArgs.fromMap(Map<String, dynamic> map) {
    return KeyArgs(
      ...
      keyAttributes: map['keyAttributes'] == null ? null : pulumi.Input.decodeList<KeyKeyAttribute>(map['keyAttributes'], (value) => KeyKeyAttribute.fromMap((value as Map).cast<String, dynamic>())),
      keyCheckValueAlgorithm: map['keyCheckValueAlgorithm'] == null ? null : map['keyCheckValueAlgorithm'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : KeyTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
