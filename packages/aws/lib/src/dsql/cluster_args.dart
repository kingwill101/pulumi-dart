...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      kmsEncryptionKey: map['kmsEncryptionKey'] == null ? null : map['kmsEncryptionKey'] as String,
      multiRegionProperties: map['multiRegionProperties'] == null ? null : ClusterMultiRegionProperties.fromMap((map['multiRegionProperties'] as Map).cast<String, dynamic>()),
      region: map['region'] == null ? null : map['region'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeouts: map['timeouts'] == null ? null : ClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
