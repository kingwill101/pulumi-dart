...
class BudgetFilterExpressionNot {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ands': ?ands == null ? null : pulumi.Input.encodeList<BudgetFilterExpressionNotAnd, Map<String, dynamic>>(ands!, (value) => value.toMap()),
      ...
      'ors': ?ors == null ? null : pulumi.Input.encodeList<BudgetFilterExpressionNotOr, Map<String, dynamic>>(ors!, (value) => value.toMap()),
  ...
  factory BudgetFilterExpressionNot.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionNot(
      ands: map['ands'] == null ? null : pulumi.Input.decodeList<BudgetFilterExpressionNotAnd>(map['ands'], (value) => BudgetFilterExpressionNotAnd.fromMap((value as Map).cast<String, dynamic>())),
      costCategories: map['costCategories'] == null ? null : BudgetFilterExpressionNotCostCategories.fromMap((map['costCategories'] as Map).cast<String, dynamic>()),
      dimensions: map['dimensions'] == null ? null : BudgetFilterExpressionNotDimensions.fromMap((map['dimensions'] as Map).cast<String, dynamic>()),
      not: map['not'] == null ? null : BudgetFilterExpressionNotNot.fromMap((map['not'] as Map).cast<String, dynamic>()),
      ors: map['ors'] == null ? null : pulumi.Input.decodeList<BudgetFilterExpressionNotOr>(map['ors'], (value) => BudgetFilterExpressionNotOr.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : BudgetFilterExpressionNotTags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
    );
  }
}
