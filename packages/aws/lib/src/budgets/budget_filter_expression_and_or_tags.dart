...
class BudgetFilterExpressionAndOrTags {
  ...
  /// Creates a new [BudgetFilterExpressionAndOrTags].
  ...
  BudgetFilterExpressionAndOrTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionAndOrTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndOrTags(
