...
class BudgetCostTypes {
  ...
  factory BudgetCostTypes.fromMap(Map<String, dynamic> map) {
    return BudgetCostTypes(
      includeCredit: map['includeCredit'] == null
          ? null
          : map['includeCredit'] as bool,
      ...
      includeRefund: map['includeRefund'] == null
          ? null
          : map['includeRefund'] as bool,
      includeSubscription: map['includeSubscription'] == null
          ? null
          : map['includeSubscription'] as bool,
      includeSupport: map['includeSupport'] == null
          ? null
          : map['includeSupport'] as bool,
      includeTax: map['includeTax'] == null ? null : map['includeTax'] as bool,
      includeUpfront: map['includeUpfront'] == null
          ? null
          : map['includeUpfront'] as bool,
      useAmortized: map['useAmortized'] == null
          ? null
          : map['useAmortized'] as bool,
