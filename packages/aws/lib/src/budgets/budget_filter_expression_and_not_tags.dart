...
class BudgetFilterExpressionAndNotTags {
  ...
  /// Creates a new [BudgetFilterExpressionAndNotTags].
  ...
  BudgetFilterExpressionAndNotTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionAndNotTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndNotTags(
