...
class BudgetFilterExpressionAndNotCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionAndNotCostCategories].
  ...
  factory BudgetFilterExpressionAndNotCostCategories.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndNotCostCategories(
