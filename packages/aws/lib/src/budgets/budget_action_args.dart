...
class BudgetActionArgs {
  ...
  factory BudgetActionArgs.fromMap(Map<String, dynamic> map) {
    return BudgetActionArgs(
      ...
      actionThreshold: BudgetActionActionThreshold.fromMap((map['actionThreshold'] as Map).cast<String, dynamic>()),
      actionType: map['actionType'] as String,
      approvalModel: map['approvalModel'] as String,
      budgetName: map['budgetName'] as String,
      definition: BudgetActionDefinition.fromMap((map['definition'] as Map).cast<String, dynamic>()),
      executionRoleArn: map['executionRoleArn'] as String,
      notificationType: map['notificationType'] as String,
      subscribers: pulumi.Input.decodeList<BudgetActionSubscriber>(map['subscribers'], (value) => BudgetActionSubscriber.fromMap((value as Map).cast<String, dynamic>())),
