...
class BudgetArgs {
  ...
  factory BudgetArgs.fromMap(Map<String, dynamic> map) {
    return BudgetArgs(
      ...
      autoAdjustData: map['autoAdjustData'] == null ? null : BudgetAutoAdjustData.fromMap((map['autoAdjustData'] as Map).cast<String, dynamic>()),
      billingViewArn: map['billingViewArn'] == null ? null : map['billingViewArn'] as String,
      budgetType: map['budgetType'] as String,
      costFilters: map['costFilters'] == null ? null : pulumi.Input.decodeList<BudgetCostFilter>(map['costFilters'], (value) => BudgetCostFilter.fromMap((value as Map).cast<String, dynamic>())),
      costTypes: map['costTypes'] == null ? null : BudgetCostTypes.fromMap((map['costTypes'] as Map).cast<String, dynamic>()),
      filterExpression: map['filterExpression'] == null ? null : BudgetFilterExpression.fromMap((map['filterExpression'] as Map).cast<String, dynamic>()),
      limitAmount: map['limitAmount'] == null ? null : map['limitAmount'] as String,
      ...
      notifications: map['notifications'] == null ? null : pulumi.Input.decodeList<BudgetNotification>(map['notifications'], (value) => BudgetNotification.fromMap((value as Map).cast<String, dynamic>())),
      plannedLimits: map['plannedLimits'] == null ? null : pulumi.Input.decodeList<BudgetPlannedLimit>(map['plannedLimits'], (value) => BudgetPlannedLimit.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timePeriodEnd: map['timePeriodEnd'] == null ? null : map['timePeriodEnd'] as String,
      timePeriodStart: map['timePeriodStart'] == null ? null : map['timePeriodStart'] as String,
