...
class Association extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Association]. {@macro pulumi_licensemanager_association_association_args_doc}
  ...
  Association(
    ...
    this.licenseConfigurationArn = registerOutput<String>(
