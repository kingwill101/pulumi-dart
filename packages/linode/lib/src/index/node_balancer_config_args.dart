...
class NodeBalancerConfigArgs {
  ...
  factory NodeBalancerConfigArgs.fromMap(Map<String, dynamic> map) {
    return NodeBalancerConfigArgs(
      ...
      checkAttempts: map['checkAttempts'] == null ? null : map['checkAttempts'] as int,
      checkBody: map['checkBody'] == null ? null : map['checkBody'] as String,
      checkInterval: map['checkInterval'] == null ? null : map['checkInterval'] as int,
      checkPassive: map['checkPassive'] == null ? null : map['checkPassive'] as bool,
      checkPath: map['checkPath'] == null ? null : map['checkPath'] as String,
      checkTimeout: map['checkTimeout'] == null ? null : map['checkTimeout'] as int,
      cipherSuite: map['cipherSuite'] == null ? null : map['cipherSuite'] as String,
      nodebalancerId: map['nodebalancerId'] as int,
      port: map['port'] == null ? null : map['port'] as int,
      protocol: map['protocol'] == null ? null : map['protocol'] as String,
      proxyProtocol: map['proxyProtocol'] == null ? null : map['proxyProtocol'] as String,
      sslCert: map['sslCert'] == null ? null : map['sslCert'] as String,
      sslKey: map['sslKey'] == null ? null : map['sslKey'] as String,
      stickiness: map['stickiness'] == null ? null : map['stickiness'] as String,
      udpCheckPort: map['udpCheckPort'] == null ? null : map['udpCheckPort'] as int,
    );
  }
}
