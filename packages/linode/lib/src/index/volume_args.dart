...
class VolumeArgs {
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      ...
      sourceVolumeId: map['sourceVolumeId'] == null ? null : map['sourceVolumeId'] as int,
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      timeouts: map['timeouts'] == null ? null : VolumeTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>()),
    );
  }
}
