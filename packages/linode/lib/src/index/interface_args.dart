...
class InterfaceArgs {
  ...
  InterfaceArgs({
    InterfaceDefaultRoute? defaultRoute,
    int? firewallId,
  ...
  factory InterfaceArgs.fromMap(Map<String, dynamic> map) {
    return InterfaceArgs(
      defaultRoute: map['defaultRoute'] == null ? null : InterfaceDefaultRoute.fromMap((map['defaultRoute'] as Map).cast<String, dynamic>()),
      firewallId: map['firewallId'] == null ? null : map['firewallId'] as int,
      linodeId: map['linodeId'] as int,
      public: map['public'] == null ? null : InterfacePublic.fromMap((map['public'] as Map).cast<String, dynamic>()),
      vlan: map['vlan'] == null ? null : InterfaceVlan.fromMap((map['vlan'] as Map).cast<String, dynamic>()),
      vpc: map['vpc'] == null ? null : InterfaceVpc.fromMap((map['vpc'] as Map).cast<String, dynamic>()),
    );
  }
}
