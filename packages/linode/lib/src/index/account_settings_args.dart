...
class AccountSettingsArgs {
  ...
  factory AccountSettingsArgs.fromMap(Map<String, dynamic> map) {
    return AccountSettingsArgs(
      ...
      interfacesForNewLinodes: map['interfacesForNewLinodes'] == null ? null : map['interfacesForNewLinodes'] as String,
      longviewSubscription: map['longviewSubscription'] == null ? null : map['longviewSubscription'] as String,
