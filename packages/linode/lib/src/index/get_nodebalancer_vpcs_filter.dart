...
class GetNodebalancerVpcsFilter {
  ...
  /// Creates a new [GetNodebalancerVpcsFilter].
  ...
  factory GetNodebalancerVpcsFilter.fromMap(Map<String, dynamic> map) {
    return GetNodebalancerVpcsFilter(
