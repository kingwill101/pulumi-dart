...
class ObjectStorageBucketArgs {
  ...
  ObjectStorageBucketArgs({
    String? accessKey,
    String? acl,
    ObjectStorageBucketCert? cert,
    String? cluster,
    bool? corsEnabled,
    String? endpointType,
    required String label,
    List<ObjectStorageBucketLifecycleRule>? lifecycleRules,
    String? region,
    String? s3Endpoint,
    String? secretKey,
    bool? versioning,
  ...
  factory ObjectStorageBucketArgs.fromMap(Map<String, dynamic> map) {
    return ObjectStorageBucketArgs(
      ...
      cert: map['cert'] == null ? null : ObjectStorageBucketCert.fromMap((map['cert'] as Map).cast<String, dynamic>()),
      cluster: map['cluster'] == null ? null : map['cluster'] as String,
      corsEnabled: map['corsEnabled'] == null ? null : map['corsEnabled'] as bool,
      endpointType: map['endpointType'] == null ? null : map['endpointType'] as String,
      label: map['label'] as String,
      lifecycleRules: map['lifecycleRules'] == null ? null : pulumi.Input.decodeList<ObjectStorageBucketLifecycleRule>(map['lifecycleRules'], (value) => ObjectStorageBucketLifecycleRule.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : map['region'] as String,
      s3Endpoint: map['s3Endpoint'] == null ? null : map['s3Endpoint'] as String,
