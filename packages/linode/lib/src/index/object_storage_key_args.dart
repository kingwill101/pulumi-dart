...
class ObjectStorageKeyArgs {
  ...
  ObjectStorageKeyArgs({
    List<ObjectStorageKeyBucketAccess>? bucketAccesses,
  ...
  factory ObjectStorageKeyArgs.fromMap(Map<String, dynamic> map) {
    return ObjectStorageKeyArgs(
      bucketAccesses: map['bucketAccesses'] == null ? null : pulumi.Input.decodeList<ObjectStorageKeyBucketAccess>(map['bucketAccesses'], (value) => ObjectStorageKeyBucketAccess.fromMap((value as Map).cast<String, dynamic>())),
