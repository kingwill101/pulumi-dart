...
class GetUserArgs {
  ...
  /// [vpcGrants] Optional.
  GetUserArgs({
    List<GetUserDatabaseGrant>? databaseGrants,
    List<GetUserDomainGrant>? domainGrants,
    List<GetUserFirewallGrant>? firewallGrants,
    List<GetUserImageGrant>? imageGrants,
    List<GetUserLinodeGrant>? linodeGrants,
    List<GetUserLongviewGrant>? longviewGrants,
    List<GetUserNodebalancerGrant>? nodebalancerGrants,
    List<GetUserStackscriptGrant>? stackscriptGrants,
    required String username,
    List<GetUserVolumeGrant>? volumeGrants,
    List<GetUserVpcGrant>? vpcGrants,
  }) :
  ...
  factory GetUserArgs.fromMap(Map<String, dynamic> map) {
    return GetUserArgs(
      databaseGrants: map['databaseGrants'] == null ? null : pulumi.Input.decodeList<GetUserDatabaseGrant>(map['databaseGrants'], (value) => GetUserDatabaseGrant.fromMap((value as Map).cast<String, dynamic>())),
      domainGrants: map['domainGrants'] == null ? null : pulumi.Input.decodeList<GetUserDomainGrant>(map['domainGrants'], (value) => GetUserDomainGrant.fromMap((value as Map).cast<String, dynamic>())),
      firewallGrants: map['firewallGrants'] == null ? null : pulumi.Input.decodeList<GetUserFirewallGrant>(map['firewallGrants'], (value) => GetUserFirewallGrant.fromMap((value as Map).cast<String, dynamic>())),
      imageGrants: map['imageGrants'] == null ? null : pulumi.Input.decodeList<GetUserImageGrant>(map['imageGrants'], (value) => GetUserImageGrant.fromMap((value as Map).cast<String, dynamic>())),
      linodeGrants: map['linodeGrants'] == null ? null : pulumi.Input.decodeList<GetUserLinodeGrant>(map['linodeGrants'], (value) => GetUserLinodeGrant.fromMap((value as Map).cast<String, dynamic>())),
      longviewGrants: map['longviewGrants'] == null ? null : pulumi.Input.decodeList<GetUserLongviewGrant>(map['longviewGrants'], (value) => GetUserLongviewGrant.fromMap((value as Map).cast<String, dynamic>())),
      nodebalancerGrants: map['nodebalancerGrants'] == null ? null : pulumi.Input.decodeList<GetUserNodebalancerGrant>(map['nodebalancerGrants'], (value) => GetUserNodebalancerGrant.fromMap((value as Map).cast<String, dynamic>())),
      stackscriptGrants: map['stackscriptGrants'] == null ? null : pulumi.Input.decodeList<GetUserStackscriptGrant>(map['stackscriptGrants'], (value) => GetUserStackscriptGrant.fromMap((value as Map).cast<String, dynamic>())),
      username: map['username'] as String,
      volumeGrants: map['volumeGrants'] == null ? null : pulumi.Input.decodeList<GetUserVolumeGrant>(map['volumeGrants'], (value) => GetUserVolumeGrant.fromMap((value as Map).cast<String, dynamic>())),
      vpcGrants: map['vpcGrants'] == null ? null : pulumi.Input.decodeList<GetUserVpcGrant>(map['vpcGrants'], (value) => GetUserVpcGrant.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
