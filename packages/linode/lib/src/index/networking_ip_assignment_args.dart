...
class NetworkingIpAssignmentArgs {
  ...
  NetworkingIpAssignmentArgs({
    List<NetworkingIpAssignmentAssignment>? assignments,
  ...
  factory NetworkingIpAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return NetworkingIpAssignmentArgs(
      assignments: map['assignments'] == null ? null : pulumi.Input.decodeList<NetworkingIpAssignmentAssignment>(map['assignments'], (value) => NetworkingIpAssignmentAssignment.fromMap((value as Map).cast<String, dynamic>())),
