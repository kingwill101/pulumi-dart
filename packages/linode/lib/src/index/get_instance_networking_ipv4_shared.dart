...
import 'get_instance_networking_ipv4_shared_vpc_nat11.dart';

class GetInstanceNetworkingIpv4Shared {
  /// The address.
  ...
  final GetInstanceNetworkingIpv4SharedVpcNat11 vpcNat11;

  /// Creates a new [GetInstanceNetworkingIpv4Shared].
  /// [address] The address.
  ...
  factory GetInstanceNetworkingIpv4Shared.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv4Shared(
      ...
      vpcNat11: GetInstanceNetworkingIpv4SharedVpcNat11.fromMap((map['vpcNat11'] as Map).cast<String, dynamic>()),
    );
  }
}
