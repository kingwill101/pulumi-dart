...
class GetDatabaseMysqlV2Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pendingUpdates': pulumi.Input.encodeList<GetDatabaseMysqlV2PendingUpdate, Map<String, dynamic>>(pendingUpdates, (value) => value.toMap()),
      'platform': platform,
      'port': port,
  ...
  factory GetDatabaseMysqlV2Result.fromMap(Map<String, dynamic> map) {
    return GetDatabaseMysqlV2Result(
      ...
      engineConfigBinlogRetentionPeriod: map['engineConfigBinlogRetentionPeriod'] as int,
      engineConfigMysqlConnectTimeout: map['engineConfigMysqlConnectTimeout'] as int,
      engineConfigMysqlDefaultTimeZone: map['engineConfigMysqlDefaultTimeZone'] as String,
      engineConfigMysqlGroupConcatMaxLen: map['engineConfigMysqlGroupConcatMaxLen'] as double,
      engineConfigMysqlInformationSchemaStatsExpiry: map['engineConfigMysqlInformationSchemaStatsExpiry'] as int,
      engineConfigMysqlInnodbChangeBufferMaxSize: map['engineConfigMysqlInnodbChangeBufferMaxSize'] as int,
      engineConfigMysqlInnodbFlushNeighbors: map['engineConfigMysqlInnodbFlushNeighbors'] as int,
      engineConfigMysqlInnodbFtMinTokenSize: map['engineConfigMysqlInnodbFtMinTokenSize'] as int,
      engineConfigMysqlInnodbFtServerStopwordTable: map['engineConfigMysqlInnodbFtServerStopwordTable'] as String,
      engineConfigMysqlInnodbLockWaitTimeout: map['engineConfigMysqlInnodbLockWaitTimeout'] as int,
      engineConfigMysqlInnodbLogBufferSize: map['engineConfigMysqlInnodbLogBufferSize'] as int,
      engineConfigMysqlInnodbOnlineAlterLogMaxSize: map['engineConfigMysqlInnodbOnlineAlterLogMaxSize'] as int,
      engineConfigMysqlInnodbReadIoThreads: map['engineConfigMysqlInnodbReadIoThreads'] as int,
      engineConfigMysqlInnodbRollbackOnTimeout: map['engineConfigMysqlInnodbRollbackOnTimeout'] as bool,
      engineConfigMysqlInnodbThreadConcurrency: map['engineConfigMysqlInnodbThreadConcurrency'] as int,
      engineConfigMysqlInnodbWriteIoThreads: map['engineConfigMysqlInnodbWriteIoThreads'] as int,
      engineConfigMysqlInteractiveTimeout: map['engineConfigMysqlInteractiveTimeout'] as int,
      engineConfigMysqlInternalTmpMemStorageEngine: map['engineConfigMysqlInternalTmpMemStorageEngine'] as String,
      engineConfigMysqlMaxAllowedPacket: map['engineConfigMysqlMaxAllowedPacket'] as int,
      engineConfigMysqlMaxHeapTableSize: map['engineConfigMysqlMaxHeapTableSize'] as int,
      engineConfigMysqlNetBufferLength: map['engineConfigMysqlNetBufferLength'] as int,
      engineConfigMysqlNetReadTimeout: map['engineConfigMysqlNetReadTimeout'] as int,
      engineConfigMysqlNetWriteTimeout: map['engineConfigMysqlNetWriteTimeout'] as int,
      engineConfigMysqlSortBufferSize: map['engineConfigMysqlSortBufferSize'] as int,
      engineConfigMysqlSqlMode: map['engineConfigMysqlSqlMode'] as String,
      engineConfigMysqlSqlRequirePrimaryKey: map['engineConfigMysqlSqlRequirePrimaryKey'] as bool,
      engineConfigMysqlTmpTableSize: map['engineConfigMysqlTmpTableSize'] as int,
      ...
      pendingUpdates: pulumi.Input.decodeList<GetDatabaseMysqlV2PendingUpdate>(map['pendingUpdates'], (value) => GetDatabaseMysqlV2PendingUpdate.fromMap((value as Map).cast<String, dynamic>())),
      platform: map['platform'] as String,
      port: map['port'] as int,
      privateNetwork: GetDatabaseMysqlV2PrivateNetwork.fromMap((map['privateNetwork'] as Map).cast<String, dynamic>()),
      ...
      updates: GetDatabaseMysqlV2Updates.fromMap((map['updates'] as Map).cast<String, dynamic>()),
