...
import 'database_mysql_args.dart';
...
class DatabaseMysql extends pulumi.CustomResource {
  ...
  /// Creates a new [DatabaseMysql].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatabaseMysql]. {@macro pulumi_index_database_mysql_database_mysql_args_doc}
  ...
  DatabaseMysql(
    ...
    this.updates = registerOutput<DatabaseMysqlUpdates>('updates');
