...
class UserArgs {
  ...
  UserArgs({
    List<UserDomainGrant>? domainGrants,
    required String email,
    List<UserFirewallGrant>? firewallGrants,
    UserGlobalGrants? globalGrants,
    List<UserImageGrant>? imageGrants,
    List<UserLinodeGrant>? linodeGrants,
    List<UserLongviewGrant>? longviewGrants,
    List<UserNodebalancerGrant>? nodebalancerGrants,
    bool? restricted,
    List<UserStackscriptGrant>? stackscriptGrants,
    required String username,
    List<UserVolumeGrant>? volumeGrants,
    List<UserVpcGrant>? vpcGrants,
  }) :
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      domainGrants: map['domainGrants'] == null ? null : pulumi.Input.decodeList<UserDomainGrant>(map['domainGrants'], (value) => UserDomainGrant.fromMap((value as Map).cast<String, dynamic>())),
      email: map['email'] as String,
      firewallGrants: map['firewallGrants'] == null ? null : pulumi.Input.decodeList<UserFirewallGrant>(map['firewallGrants'], (value) => UserFirewallGrant.fromMap((value as Map).cast<String, dynamic>())),
      globalGrants: map['globalGrants'] == null ? null : UserGlobalGrants.fromMap((map['globalGrants'] as Map).cast<String, dynamic>()),
      imageGrants: map['imageGrants'] == null ? null : pulumi.Input.decodeList<UserImageGrant>(map['imageGrants'], (value) => UserImageGrant.fromMap((value as Map).cast<String, dynamic>())),
      linodeGrants: map['linodeGrants'] == null ? null : pulumi.Input.decodeList<UserLinodeGrant>(map['linodeGrants'], (value) => UserLinodeGrant.fromMap((value as Map).cast<String, dynamic>())),
      longviewGrants: map['longviewGrants'] == null ? null : pulumi.Input.decodeList<UserLongviewGrant>(map['longviewGrants'], (value) => UserLongviewGrant.fromMap((value as Map).cast<String, dynamic>())),
      nodebalancerGrants: map['nodebalancerGrants'] == null ? null : pulumi.Input.decodeList<UserNodebalancerGrant>(map['nodebalancerGrants'], (value) => UserNodebalancerGrant.fromMap((value as Map).cast<String, dynamic>())),
      restricted: map['restricted'] == null ? null : map['restricted'] as bool,
      stackscriptGrants: map['stackscriptGrants'] == null ? null : pulumi.Input.decodeList<UserStackscriptGrant>(map['stackscriptGrants'], (value) => UserStackscriptGrant.fromMap((value as Map).cast<String, dynamic>())),
      username: map['username'] as String,
      volumeGrants: map['volumeGrants'] == null ? null : pulumi.Input.decodeList<UserVolumeGrant>(map['volumeGrants'], (value) => UserVolumeGrant.fromMap((value as Map).cast<String, dynamic>())),
      vpcGrants: map['vpcGrants'] == null ? null : pulumi.Input.decodeList<UserVpcGrant>(map['vpcGrants'], (value) => UserVpcGrant.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
