...
class LkeClusterControlPlaneAcl {
  ...
  final List<LkeClusterControlPlaneAclAddress>? addresses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addresses': ?addresses == null ? null : pulumi.Input.encodeList<LkeClusterControlPlaneAclAddress, Map<String, dynamic>>(addresses!, (value) => value.toMap()),
      'enabled': ?enabled,
    };
  }
  ...
  factory LkeClusterControlPlaneAcl.fromMap(Map<String, dynamic> map) {
    return LkeClusterControlPlaneAcl(
      addresses: map['addresses'] == null ? null : pulumi.Input.decodeList<LkeClusterControlPlaneAclAddress>(map['addresses'], (value) => LkeClusterControlPlaneAclAddress.fromMap((value as Map).cast<String, dynamic>())),
