...
class GetProducerImageShareGroupMembersFilter {
  ...
  /// Creates a new [GetProducerImageShareGroupMembersFilter].
  ...
  factory GetProducerImageShareGroupMembersFilter.fromMap(Map<String, dynamic> map) {
    return GetProducerImageShareGroupMembersFilter(
