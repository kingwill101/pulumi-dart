...
class FirewallSettingsArgs {
  ...
  FirewallSettingsArgs({
    FirewallSettingsDefaultFirewallIds? defaultFirewallIds,
  }) :
  ...
  factory FirewallSettingsArgs.fromMap(Map<String, dynamic> map) {
    return FirewallSettingsArgs(
      defaultFirewallIds: map['defaultFirewallIds'] == null ? null : FirewallSettingsDefaultFirewallIds.fromMap((map['defaultFirewallIds'] as Map).cast<String, dynamic>()),
    );
  }
}
