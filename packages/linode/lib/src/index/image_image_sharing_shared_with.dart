...
class ImageImageSharingSharedWith {
  ...
  factory ImageImageSharingSharedWith.fromMap(Map<String, dynamic> map) {
    return ImageImageSharingSharedWith(
      sharegroupCount: map['sharegroupCount'] == null ? null : map['sharegroupCount'] as int,
      sharegroupListUrl: map['sharegroupListUrl'] == null ? null : map['sharegroupListUrl'] as String,
    );
  }
}
