...
class RegistryImageArgs {
  ...
  }) : insecureSkipVerify = pulumi.Input.asOptionalInput<bool>(
         insecureSkipVerify,
       ),
  ...
  factory RegistryImageArgs.fromMap(Map<String, dynamic> map) {
    return RegistryImageArgs(
      insecureSkipVerify: map['insecureSkipVerify'] == null
          ? null
          : map['insecureSkipVerify'] as bool,
      keepRemotely: map['keepRemotely'] == null
          ? null
          : map['keepRemotely'] as bool,
