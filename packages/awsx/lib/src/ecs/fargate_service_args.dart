...
class FargateServiceArgs {
  ...
  FargateServiceArgs({
    ...
    FargateServiceTaskDefinition? taskDefinitionArgs,
  ...
  factory FargateServiceArgs.fromMap(Map<String, dynamic> map) {
    return FargateServiceArgs(
      ...
      taskDefinitionArgs: map['taskDefinitionArgs'] == null ? null : FargateServiceTaskDefinition.fromMap((map['taskDefinitionArgs'] as Map).cast<String, dynamic>()),
