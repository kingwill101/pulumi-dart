...
class EC2ServiceArgs {
  ...
  EC2ServiceArgs({
    pulumi_aws_ecs.ServiceAlarms? alarms,
    String? availabilityZoneRebalancing,
    List<pulumi_aws_ecs.ServiceCapacityProviderStrategy>? capacityProviderStrategies,
    String? cluster,
    bool? continueBeforeSteadyState,
    pulumi_aws_ecs.ServiceDeploymentCircuitBreaker? deploymentCircuitBreaker,
    pulumi_aws_ecs.ServiceDeploymentConfiguration? deploymentConfiguration,
    pulumi_aws_ecs.ServiceDeploymentController? deploymentController,
    ...
    String? iamRole,
    List<pulumi_aws_ecs.ServiceLoadBalancer>? loadBalancers,
    String? name,
    pulumi_aws_ecs.ServiceNetworkConfiguration? networkConfiguration,
    List<pulumi_aws_ecs.ServiceOrderedPlacementStrategy>? orderedPlacementStrategies,
    List<pulumi_aws_ecs.ServicePlacementConstraint>? placementConstraints,
    String? platformVersion,
    String? propagateTags,
    String? region,
    String? schedulingStrategy,
    pulumi_aws_ecs.ServiceServiceConnectConfiguration? serviceConnectConfiguration,
    pulumi_aws_ecs.ServiceServiceRegistries? serviceRegistries,
    bool? sigintRollback,
    Map<String, String>? tags,
    String? taskDefinition,
    EC2ServiceTaskDefinition? taskDefinitionArgs,
    Map<String, String>? triggers,
    pulumi_aws_ecs.ServiceVolumeConfiguration? volumeConfiguration,
    List<pulumi_aws_ecs.ServiceVpcLatticeConfiguration>? vpcLatticeConfigurations,
  }) :
  ...
  factory EC2ServiceArgs.fromMap(Map<String, dynamic> map) {
    return EC2ServiceArgs(
      alarms: map['alarms'] == null ? null : pulumi_aws_ecs.ServiceAlarms.fromMap((map['alarms'] as Map).cast<String, dynamic>()),
      availabilityZoneRebalancing: map['availabilityZoneRebalancing'] == null ? null : map['availabilityZoneRebalancing'] as String,
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : pulumi.Input.decodeList<pulumi_aws_ecs.ServiceCapacityProviderStrategy>(map['capacityProviderStrategies'], (value) => pulumi_aws_ecs.ServiceCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>())),
      cluster: map['cluster'] == null ? null : map['cluster'] as String,
      continueBeforeSteadyState: map['continueBeforeSteadyState'] == null ? null : map['continueBeforeSteadyState'] as bool,
      deploymentCircuitBreaker: map['deploymentCircuitBreaker'] == null ? null : pulumi_aws_ecs.ServiceDeploymentCircuitBreaker.fromMap((map['deploymentCircuitBreaker'] as Map).cast<String, dynamic>()),
      deploymentConfiguration: map['deploymentConfiguration'] == null ? null : pulumi_aws_ecs.ServiceDeploymentConfiguration.fromMap((map['deploymentConfiguration'] as Map).cast<String, dynamic>()),
      deploymentController: map['deploymentController'] == null ? null : pulumi_aws_ecs.ServiceDeploymentController.fromMap((map['deploymentController'] as Map).cast<String, dynamic>()),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : pulumi.Input.decodeList<pulumi_aws_ecs.ServiceLoadBalancer>(map['loadBalancers'], (value) => pulumi_aws_ecs.ServiceLoadBalancer.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      networkConfiguration: map['networkConfiguration'] == null ? null : pulumi_aws_ecs.ServiceNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      orderedPlacementStrategies: map['orderedPlacementStrategies'] == null ? null : pulumi.Input.decodeList<pulumi_aws_ecs.ServiceOrderedPlacementStrategy>(map['orderedPlacementStrategies'], (value) => pulumi_aws_ecs.ServiceOrderedPlacementStrategy.fromMap((value as Map).cast<String, dynamic>())),
      placementConstraints: map['placementConstraints'] == null ? null : pulumi.Input.decodeList<pulumi_aws_ecs.ServicePlacementConstraint>(map['placementConstraints'], (value) => pulumi_aws_ecs.ServicePlacementConstraint.fromMap((value as Map).cast<String, dynamic>())),
      ...
      serviceConnectConfiguration: map['serviceConnectConfiguration'] == null ? null : pulumi_aws_ecs.ServiceServiceConnectConfiguration.fromMap((map['serviceConnectConfiguration'] as Map).cast<String, dynamic>()),
      serviceRegistries: map['serviceRegistries'] == null ? null : pulumi_aws_ecs.ServiceServiceRegistries.fromMap((map['serviceRegistries'] as Map).cast<String, dynamic>()),
      ...
      taskDefinitionArgs: map['taskDefinitionArgs'] == null ? null : EC2ServiceTaskDefinition.fromMap((map['taskDefinitionArgs'] as Map).cast<String, dynamic>()),
      triggers: map['triggers'] == null ? null : (map['triggers'] as Map).cast<String, String>(),
      volumeConfiguration: map['volumeConfiguration'] == null ? null : pulumi_aws_ecs.ServiceVolumeConfiguration.fromMap((map['volumeConfiguration'] as Map).cast<String, dynamic>()),
      vpcLatticeConfigurations: map['vpcLatticeConfigurations'] == null ? null : pulumi.Input.decodeList<pulumi_aws_ecs.ServiceVpcLatticeConfiguration>(map['vpcLatticeConfigurations'], (value) => pulumi_aws_ecs.ServiceVpcLatticeConfiguration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
