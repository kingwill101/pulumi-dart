...
class Bucket {
  ...
  final pulumi_aws_s3.BucketServerSideEncryptionConfiguration?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'corsRules': ?corsRules == null
          ? null
          : pulumi.Input.encodeList<
              pulumi_aws_s3.BucketCorsRule,
              Map<String, dynamic>
            >(corsRules!, (value) => value.toMap()),
      ...
      'lifecycleRules': ?lifecycleRules == null
          ? null
          : pulumi.Input.encodeList<
      ...
      'serverSideEncryptionConfiguration':
          ...
          ? null
          : serverSideEncryptionConfiguration!.toMap(),
      'tags': ?tags,
