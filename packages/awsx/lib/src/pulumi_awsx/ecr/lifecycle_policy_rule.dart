...
class LifecyclePolicyRule {
  ...
  Map<String, dynamic> toMap() {
    ...
    final maximumAgeLimitValue = maximumAgeLimit;
    if (maximumAgeLimitValue != null) {
      map['maximumAgeLimit'] = maximumAgeLimitValue;
    }
    final maximumNumberOfImagesValue = maximumNumberOfImages;
    if (maximumNumberOfImagesValue != null) {
      map['maximumNumberOfImages'] = maximumNumberOfImagesValue;
    }
  ...
  factory LifecyclePolicyRule.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyRule(
      ...
      maximumAgeLimit: map['maximumAgeLimit'] == null
          ? null
          : map['maximumAgeLimit'] as double,
      maximumNumberOfImages: map['maximumNumberOfImages'] == null
          ? null
          : map['maximumNumberOfImages'] as double,
