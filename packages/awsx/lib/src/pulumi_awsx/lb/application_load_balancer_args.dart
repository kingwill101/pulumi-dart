...
class ApplicationLoadBalancerArgs {
  ...
  final Input<Map<String, dynamic>>? accessLogs;
  ...
  final Input<Map<String, dynamic>>? connectionLogs;
  ...
  final Input<DefaultSecurityGroup>? defaultSecurityGroup;

  /// Options creating a default target group.
  final Input<TargetGroup>? defaultTargetGroup;

  /// Port to use to connect with the target. Valid values are ports 1-65535. Defaults to 80.
  final Input<int>? defaultTargetGroupPort;
  ...
  final Input<Map<String, dynamic>>? healthCheckLogs;
  ...
  final Input<Map<String, dynamic>>? minimumLoadBalancerCapacity;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (defaultSecurityGroupValue != null) {
      map['defaultSecurityGroup'] = Input.mapOptionalInputValue<
              DefaultSecurityGroup, Map<String, dynamic>>(
    ...
    if (defaultTargetGroupValue != null) {
      map['defaultTargetGroup'] =
          Input.mapOptionalInputValue<TargetGroup, Map<String, dynamic>>(
    ...
    if (listenerValue != null) {
      map['listener'] =
          Input.mapOptionalInputValue<Listener, Map<String, dynamic>>(
              listenerValue, (value) => value.toMap());
    }
    final listenersValue = listeners;
    if (listenersValue != null) {
      map['listeners'] = Input.mapOptionalInputValue<List<Listener>,
              List<Map<String, dynamic>>>(
          listenersValue,
          (value) => Input.encodeList<Listener, Map<String, dynamic>>(
  ...
  factory ApplicationLoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationLoadBalancerArgs(
      accessLogs:
          Input.asOptionalInput<Map<String, dynamic>>(map['accessLogs']),
      clientKeepAlive: Input.asOptionalInput<int>(map['clientKeepAlive']),
      connectionLogs:
          Input.asOptionalInput<Map<String, dynamic>>(map['connectionLogs']),
      customerOwnedIpv4Pool:
          Input.asOptionalInput<String>(map['customerOwnedIpv4Pool']),
      defaultSecurityGroup: Input.asOptionalInput<DefaultSecurityGroup>(
          map['defaultSecurityGroup']),
      defaultTargetGroup:
          Input.asOptionalInput<TargetGroup>(map['defaultTargetGroup']),
      defaultTargetGroupPort:
          Input.asOptionalInput<int>(map['defaultTargetGroupPort']),
      ...
      enforceSecurityGroupInboundRulesOnPrivateLinkTraffic:
          Input.asOptionalInput<String>(
              map['enforceSecurityGroupInboundRulesOnPrivateLinkTraffic']),
      healthCheckLogs:
          Input.asOptionalInput<Map<String, dynamic>>(map['healthCheckLogs']),
      ...
      ipamPools: Input.asOptionalInput<Map<String, dynamic>>(map['ipamPools']),
      listener: Input.asOptionalInput<Listener>(map['listener']),
      listeners: Input.asOptionalInput<List<Listener>>(map['listeners']),
      minimumLoadBalancerCapacity: Input.asOptionalInput<Map<String, dynamic>>(
      ...
      subnetMappings: Input.asOptionalInput<List<Map<String, dynamic>>>(
          map['subnetMappings']),
      subnets: Input.asOptionalInput<List<dynamic>>(map['subnets']),
