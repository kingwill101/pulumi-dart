...
class Vpc extends ComponentResource {
  ...
  late final Output<List<dynamic>> eips;

  /// The Internet Gateway for the VPC.
  late final Output<dynamic> internetGateway;
  late final Output<List<String>> isolatedSubnetIds;

  /// The NAT Gateways for the VPC. If no NAT Gateways are specified, this will be an empty list.
  late final Output<List<dynamic>> natGateways;
  ...
  late final Output<List<dynamic>> routeTableAssociations;

  /// The Route Tables for the VPC.
  late final Output<List<dynamic>> routeTables;

  /// The Routes for the VPC.
  late final Output<List<dynamic>> routes;

  /// The resolved subnet specs layout deployed to each availability zone.
  late final Output<List<ResolvedSubnetSpec>> subnetLayout;

  /// The VPC's subnets.
  late final Output<List<dynamic>> subnets;

  /// The VPC.
  late final Output<dynamic> vpc;

  /// The VPC Endpoints that are enabled
  late final Output<List<dynamic>> vpcEndpoints;
