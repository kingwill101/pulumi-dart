...
class VpcArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (natGatewaysValue != null) {
      map['natGateways'] = pulumi.Input.mapOptionalInputValue<
    ...
    if (subnetSpecsValue != null) {
      map['subnetSpecs'] = pulumi.Input.mapOptionalInputValue<List<SubnetSpec>,
              List<Map<String, dynamic>>>(
          subnetSpecsValue,
          (value) => pulumi.Input.encodeList<SubnetSpec, Map<String, dynamic>>(
    ...
    if (vpcEndpointSpecsValue != null) {
      map['vpcEndpointSpecs'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory VpcArgs.fromMap(Map<String, dynamic> map) {
    return VpcArgs(
      ...
      availabilityZoneCidrMask:
          pulumi.Input.asOptionalInput<int>(map['availabilityZoneCidrMask']),
      availabilityZoneNames: pulumi.Input.asOptionalInput<List<String>>(
          map['availabilityZoneNames']),
      ...
      numberOfAvailabilityZones:
          pulumi.Input.asOptionalInput<int>(map['numberOfAvailabilityZones']),
      region: pulumi.Input.asOptionalInput<String>(map['region']),
      subnetSpecs:
          pulumi.Input.asOptionalInput<List<SubnetSpec>>(map['subnetSpecs']),
