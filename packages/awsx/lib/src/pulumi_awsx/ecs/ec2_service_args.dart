...
class EC2ServiceArgs {
  ...
  final Input<List<Map<String, dynamic>>>? capacityProviderStrategies;
  ...
  final Input<List<Map<String, dynamic>>>? orderedPlacementStrategies;
  ...
  final Input<EC2ServiceTaskDefinition>? taskDefinitionArgs;
  ...
  Map<String, dynamic> toMap() {
    ...
    if (taskDefinitionArgsValue != null) {
      map['taskDefinitionArgs'] = Input.mapOptionalInputValue<
              EC2ServiceTaskDefinition, Map<String, dynamic>>(
  ...
  factory EC2ServiceArgs.fromMap(Map<String, dynamic> map) {
    return EC2ServiceArgs(
      ...
      taskDefinitionArgs: Input.asOptionalInput<EC2ServiceTaskDefinition>(
