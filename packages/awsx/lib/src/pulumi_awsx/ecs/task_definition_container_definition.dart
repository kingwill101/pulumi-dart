...
class TaskDefinitionContainerDefinition {
  ...
  factory TaskDefinitionContainerDefinition.fromMap(Map<String, dynamic> map) {
    return TaskDefinitionContainerDefinition(
      ...
      interactive:
          map['interactive'] == null ? null : map['interactive'] as bool,
      links:
          map['links'] == null ? null : (map['links'] as List).cast<String>(),
      ...
      pseudoTerminal:
          map['pseudoTerminal'] == null ? null : map['pseudoTerminal'] as bool,
      ...
      secrets: map['secrets'] == null
          ...
          : Input.decodeList<TaskDefinitionSecret>(
              ...
              (value) => TaskDefinitionSecret.fromMap(
                  (value as Map).cast<String, dynamic>())),
      startTimeout:
          map['startTimeout'] == null ? null : map['startTimeout'] as int,
      stopTimeout:
