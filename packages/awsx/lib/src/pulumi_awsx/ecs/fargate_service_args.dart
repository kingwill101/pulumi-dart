...
class FargateServiceArgs {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (taskDefinitionArgsValue != null) {
      map['taskDefinitionArgs'] = pulumi.Input.mapOptionalInputValue<
  ...
  factory FargateServiceArgs.fromMap(Map<String, dynamic> map) {
    return FargateServiceArgs(
      alarms: pulumi.Input.asOptionalInput<Map<String, dynamic>>(map['alarms']),
      assignPublicIp: pulumi.Input.asOptionalInput<bool>(map['assignPublicIp']),
      ...
      continueBeforeSteadyState:
          pulumi.Input.asOptionalInput<bool>(map['continueBeforeSteadyState']),
      ...
      deploymentController: pulumi.Input.asOptionalInput<Map<String, dynamic>>(
      ...
      networkConfiguration: pulumi.Input.asOptionalInput<Map<String, dynamic>>(
      ...
      taskDefinitionArgs:
          pulumi.Input.asOptionalInput<FargateServiceTaskDefinition>(
