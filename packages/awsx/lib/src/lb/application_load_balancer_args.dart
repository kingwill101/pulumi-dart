...
class ApplicationLoadBalancerArgs {
  ...
  ApplicationLoadBalancerArgs({
    pulumi_aws_lb.LoadBalancerAccessLogs? accessLogs,
    int? clientKeepAlive,
    pulumi_aws_lb.LoadBalancerConnectionLogs? connectionLogs,
    ...
    pulumi_aws_lb.LoadBalancerHealthCheckLogs? healthCheckLogs,
    int? idleTimeout,
    bool? internal,
    String? ipAddressType,
    pulumi_aws_lb.LoadBalancerIpamPools? ipamPools,
    Listener? listener,
    List<Listener>? listeners,
    pulumi_aws_lb.LoadBalancerMinimumLoadBalancerCapacity? minimumLoadBalancerCapacity,
    String? name,
    String? namePrefix,
    ...
    List<pulumi_aws_lb.LoadBalancerSubnetMapping>? subnetMappings,
    List<pulumi_aws_ec2.Subnet>? subnets,
  ...
  factory ApplicationLoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationLoadBalancerArgs(
      accessLogs: map['accessLogs'] == null ? null : pulumi_aws_lb.LoadBalancerAccessLogs.fromMap((map['accessLogs'] as Map).cast<String, dynamic>()),
      clientKeepAlive: map['clientKeepAlive'] == null ? null : map['clientKeepAlive'] as int,
      connectionLogs: map['connectionLogs'] == null ? null : pulumi_aws_lb.LoadBalancerConnectionLogs.fromMap((map['connectionLogs'] as Map).cast<String, dynamic>()),
      customerOwnedIpv4Pool: map['customerOwnedIpv4Pool'] == null ? null : map['customerOwnedIpv4Pool'] as String,
      defaultSecurityGroup: map['defaultSecurityGroup'] == null ? null : DefaultSecurityGroup.fromMap((map['defaultSecurityGroup'] as Map).cast<String, dynamic>()),
      defaultTargetGroup: map['defaultTargetGroup'] == null ? null : TargetGroup.fromMap((map['defaultTargetGroup'] as Map).cast<String, dynamic>()),
      defaultTargetGroupPort: map['defaultTargetGroupPort'] == null ? null : map['defaultTargetGroupPort'] as int,
      desyncMitigationMode: map['desyncMitigationMode'] == null ? null : map['desyncMitigationMode'] as String,
      dnsRecordClientRoutingPolicy: map['dnsRecordClientRoutingPolicy'] == null ? null : map['dnsRecordClientRoutingPolicy'] as String,
      dropInvalidHeaderFields: map['dropInvalidHeaderFields'] == null ? null : map['dropInvalidHeaderFields'] as bool,
      enableDeletionProtection: map['enableDeletionProtection'] == null ? null : map['enableDeletionProtection'] as bool,
      enableHttp2: map['enableHttp2'] == null ? null : map['enableHttp2'] as bool,
      enableTlsVersionAndCipherSuiteHeaders: map['enableTlsVersionAndCipherSuiteHeaders'] == null ? null : map['enableTlsVersionAndCipherSuiteHeaders'] as bool,
      enableWafFailOpen: map['enableWafFailOpen'] == null ? null : map['enableWafFailOpen'] as bool,
      enableXffClientPort: map['enableXffClientPort'] == null ? null : map['enableXffClientPort'] as bool,
      enableZonalShift: map['enableZonalShift'] == null ? null : map['enableZonalShift'] as bool,
      ...
      healthCheckLogs: map['healthCheckLogs'] == null ? null : pulumi_aws_lb.LoadBalancerHealthCheckLogs.fromMap((map['healthCheckLogs'] as Map).cast<String, dynamic>()),
      ...
      ipamPools: map['ipamPools'] == null ? null : pulumi_aws_lb.LoadBalancerIpamPools.fromMap((map['ipamPools'] as Map).cast<String, dynamic>()),
      listener: map['listener'] == null ? null : Listener.fromMap((map['listener'] as Map).cast<String, dynamic>()),
      listeners: map['listeners'] == null ? null : pulumi.Input.decodeList<Listener>(map['listeners'], (value) => Listener.fromMap((value as Map).cast<String, dynamic>())),
      minimumLoadBalancerCapacity: map['minimumLoadBalancerCapacity'] == null ? null : pulumi_aws_lb.LoadBalancerMinimumLoadBalancerCapacity.fromMap((map['minimumLoadBalancerCapacity'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      preserveHostHeader: map['preserveHostHeader'] == null ? null : map['preserveHostHeader'] as bool,
      region: map['region'] == null ? null : map['region'] as String,
      secondaryIpsAutoAssignedPerSubnet: map['secondaryIpsAutoAssignedPerSubnet'] == null ? null : map['secondaryIpsAutoAssignedPerSubnet'] as int,
      ...
      subnetMappings: map['subnetMappings'] == null ? null : pulumi.Input.decodeList<pulumi_aws_lb.LoadBalancerSubnetMapping>(map['subnetMappings'], (value) => pulumi_aws_lb.LoadBalancerSubnetMapping.fromMap((value as Map).cast<String, dynamic>())),
      subnets: map['subnets'] == null ? null : (map['subnets'] as List).cast<pulumi_aws_ec2.Subnet>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      xffHeaderProcessingMode: map['xffHeaderProcessingMode'] == null ? null : map['xffHeaderProcessingMode'] as String,
    );
  }
}
