...
class NetworkLoadBalancerArgs {
  ...
  NetworkLoadBalancerArgs({
    ...
    String? xffHeaderProcessingMode,
           ...
           pulumi.Input.asOptionalInput<pulumi_aws_lb.LoadBalancerAccessLogs>(
             accessLogs,
           ),
       ...
       ipamPools =
           pulumi.Input.asOptionalInput<pulumi_aws_lb.LoadBalancerIpamPools>(
             ipamPools,
           ),
       ...
       subnetMappings =
           ...
           >(subnetMappings),
       subnets = pulumi.Input.asOptionalInput<List<pulumi_aws_ec2.Subnet>>(
         subnets,
       ),
  ...
  factory NetworkLoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return NetworkLoadBalancerArgs(
      ...
      subnets: map['subnets'] == null
          ? null
          : (map['subnets'] as List).cast<pulumi_aws_ec2.Subnet>(),
      tags: map['tags'] == null
          ? null
