...
class VpcArgs {
  ...
  VpcArgs({
    ...
    NatGatewayConfiguration? natGateways,
    int? numberOfAvailabilityZones,
    String? region,
    List<SubnetSpec>? subnetSpecs,
    SubnetAllocationStrategy? subnetStrategy,
    Map<String, String>? tags,
    List<VpcEndpointSpec>? vpcEndpointSpecs,
  }) :
  ...
  factory VpcArgs.fromMap(Map<String, dynamic> map) {
    return VpcArgs(
      assignGeneratedIpv6CidrBlock: map['assignGeneratedIpv6CidrBlock'] == null ? null : map['assignGeneratedIpv6CidrBlock'] as bool,
      availabilityZoneCidrMask: map['availabilityZoneCidrMask'] == null ? null : map['availabilityZoneCidrMask'] as int,
      availabilityZoneNames: map['availabilityZoneNames'] == null ? null : (map['availabilityZoneNames'] as List).cast<String>(),
      ...
      enableNetworkAddressUsageMetrics: map['enableNetworkAddressUsageMetrics'] == null ? null : map['enableNetworkAddressUsageMetrics'] as bool,
      ...
      ipv6CidrBlockNetworkBorderGroup: map['ipv6CidrBlockNetworkBorderGroup'] == null ? null : map['ipv6CidrBlockNetworkBorderGroup'] as String,
      ...
      natGateways: map['natGateways'] == null ? null : NatGatewayConfiguration.fromMap((map['natGateways'] as Map).cast<String, dynamic>()),
      numberOfAvailabilityZones: map['numberOfAvailabilityZones'] == null ? null : map['numberOfAvailabilityZones'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      subnetSpecs: map['subnetSpecs'] == null ? null : pulumi.Input.decodeList<SubnetSpec>(map['subnetSpecs'], (value) => SubnetSpec.fromMap((value as Map).cast<String, dynamic>())),
      subnetStrategy: map['subnetStrategy'] == null ? null : SubnetAllocationStrategy.fromValue(map['subnetStrategy'] as String),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      vpcEndpointSpecs: map['vpcEndpointSpecs'] == null ? null : pulumi.Input.decodeList<VpcEndpointSpec>(map['vpcEndpointSpecs'], (value) => VpcEndpointSpec.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
