...
class VpcArgs {
  ...
  VpcArgs({
    ...
    List<VpcEndpointSpec>? vpcEndpointSpecs,
       ...
       availabilityZoneCidrMask = pulumi.Input.asOptionalInput<int>(
         availabilityZoneCidrMask,
       ),
       availabilityZoneNames = pulumi.Input.asOptionalInput<List<String>>(
       ...
       natGateways = pulumi.Input.asOptionalInput<NatGatewayConfiguration>(
         natGateways,
       ),
       numberOfAvailabilityZones = pulumi.Input.asOptionalInput<int>(
         numberOfAvailabilityZones,
       ),
       region = pulumi.Input.asOptionalInput<String>(region),
       subnetSpecs = pulumi.Input.asOptionalInput<List<SubnetSpec>>(
         subnetSpecs,
       ),
       subnetStrategy = pulumi.Input.asOptionalInput<SubnetAllocationStrategy>(
         subnetStrategy,
       ),
       tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
       vpcEndpointSpecs = pulumi.Input.asOptionalInput<List<VpcEndpointSpec>>(
         vpcEndpointSpecs,
       );
  ...
  Map<String, dynamic> toMap() {
    ...
    if (natGatewaysValue != null) {
      map['natGateways'] =
          pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(natGatewaysValue, (value) => value.toMap());
    }
    ...
    if (subnetSpecsValue != null) {
      map['subnetSpecs'] =
          ...
          >(
            subnetSpecsValue,
            (value) =>
                pulumi.Input.encodeList<SubnetSpec, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          );
    ...
    if (subnetStrategyValue != null) {
      map['subnetStrategy'] =
          pulumi.Input.mapOptionalInputValue<SubnetAllocationStrategy, String>(
            subnetStrategyValue,
            (value) => value.value,
          );
    }
    ...
    if (vpcEndpointSpecsValue != null) {
      map['vpcEndpointSpecs'] =
          pulumi.Input.mapOptionalInputValue<
            List<VpcEndpointSpec>,
            List<Map<String, dynamic>>
          >(
            vpcEndpointSpecsValue,
            (value) =>
                pulumi.Input.encodeList<VpcEndpointSpec, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          );
  ...
  factory VpcArgs.fromMap(Map<String, dynamic> map) {
    return VpcArgs(
      ...
      availabilityZoneCidrMask: map['availabilityZoneCidrMask'] == null
          ? null
          : map['availabilityZoneCidrMask'] as int,
      availabilityZoneNames: map['availabilityZoneNames'] == null
          ? null
          : (map['availabilityZoneNames'] as List).cast<String>(),
      ...
      instanceTenancy: map['instanceTenancy'] == null
          ? null
          : map['instanceTenancy'] as String,
      ...
      natGateways: map['natGateways'] == null
          ? null
          : NatGatewayConfiguration.fromMap(
              (map['natGateways'] as Map).cast<String, dynamic>(),
            ),
      numberOfAvailabilityZones: map['numberOfAvailabilityZones'] == null
          ? null
          : map['numberOfAvailabilityZones'] as int,
      region: map['region'] == null ? null : map['region'] as String,
      subnetSpecs: map['subnetSpecs'] == null
          ? null
          : pulumi.Input.decodeList<SubnetSpec>(
              map['subnetSpecs'],
              (value) =>
                  SubnetSpec.fromMap((value as Map).cast<String, dynamic>()),
            ),
      subnetStrategy: map['subnetStrategy'] == null
          ? null
          : SubnetAllocationStrategy.fromValue(map['subnetStrategy'] as String),
      tags: map['tags'] == null
          ? null
          : (map['tags'] as Map).cast<String, String>(),
      vpcEndpointSpecs: map['vpcEndpointSpecs'] == null
          ? null
          : pulumi.Input.decodeList<VpcEndpointSpec>(
              map['vpcEndpointSpecs'],
              (value) => VpcEndpointSpec.fromMap(
