...
class Vpc extends pulumi.ComponentResource {
  ...
  late final pulumi.Output<List<pulumi_aws_ec2.RouteTableAssociation>>
  ...
  Vpc(String name, {VpcArgs? args, pulumi.ComponentResourceOptions? options})
    ...
    this.internetGateway = registerOutput<pulumi_aws_ec2.InternetGateway>(
      'internetGateway',
    );
    this.isolatedSubnetIds = registerOutput<List<String>>('isolatedSubnetIds');
    this.natGateways = registerOutput<List<pulumi_aws_ec2.NatGateway>>(
      'natGateways',
    );
    ...
    this.routeTableAssociations =
        registerOutput<List<pulumi_aws_ec2.RouteTableAssociation>>(
          'routeTableAssociations',
        );
    this.routeTables = registerOutput<List<pulumi_aws_ec2.RouteTable>>(
      'routeTables',
    );
    ...
    this.vpcEndpoints = registerOutput<List<pulumi_aws_ec2.VpcEndpoint>>(
      'vpcEndpoints',
    );
