...
class GetGenaiAgentTemplate {
  ...
  final List<GetGenaiAgentTemplateKnowledgeBase>? knowledgeBases;
  /// Maximum tokens allowed
  final int? maxTokens;
  /// Model of the Agent Template
  final List<GetGenaiAgentTemplateModel>? models;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'k': ?k,
      'knowledgeBases': ?knowledgeBases == null ? null : pulumi.Input.encodeList<GetGenaiAgentTemplateKnowledgeBase, Map<String, dynamic>>(knowledgeBases!, (value) => value.toMap()),
      'maxTokens': ?maxTokens,
      'models': ?models == null ? null : pulumi.Input.encodeList<GetGenaiAgentTemplateModel, Map<String, dynamic>>(models!, (value) => value.toMap()),
      'name': ?name,
  ...
  factory GetGenaiAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentTemplate(
      ...
      knowledgeBases: map['knowledgeBases'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentTemplateKnowledgeBase>(map['knowledgeBases'], (value) => GetGenaiAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>())),
      maxTokens: map['maxTokens'] == null ? null : map['maxTokens'] as int,
      models: map['models'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentTemplateModel>(map['models'], (value) => GetGenaiAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>())),
