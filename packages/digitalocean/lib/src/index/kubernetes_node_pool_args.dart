...
class KubernetesNodePoolArgs {
  ...
  KubernetesNodePoolArgs({
    ...
    List<String>? tags,
    List<KubernetesNodePoolTaint>? taints,
  }) :
  ...
  factory KubernetesNodePoolArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesNodePoolArgs(
      ...
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<KubernetesNodePoolTaint>(map['taints'], (value) => KubernetesNodePoolTaint.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
