...
class GetAppSpecFunctionBitbucket {
  ...
  /// Creates a new [GetAppSpecFunctionBitbucket].
  ...
  factory GetAppSpecFunctionBitbucket.fromMap(Map<String, dynamic> map) {
    return GetAppSpecFunctionBitbucket(
