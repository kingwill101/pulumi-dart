...
class DropletAutoscaleArgs {
  ...
  DropletAutoscaleArgs({
    required DropletAutoscaleConfig config,
    required DropletAutoscaleDropletTemplate dropletTemplate,
    String? name,
  }) :
  ...
  factory DropletAutoscaleArgs.fromMap(Map<String, dynamic> map) {
    return DropletAutoscaleArgs(
      config: DropletAutoscaleConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      dropletTemplate: DropletAutoscaleDropletTemplate.fromMap((map['dropletTemplate'] as Map).cast<String, dynamic>()),
