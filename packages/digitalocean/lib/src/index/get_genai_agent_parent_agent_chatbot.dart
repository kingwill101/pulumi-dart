...
class GetGenaiAgentParentAgentChatbot {
  ...
  /// Creates a new [GetGenaiAgentParentAgentChatbot].
  ...
  factory GetGenaiAgentParentAgentChatbot.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentParentAgentChatbot(
