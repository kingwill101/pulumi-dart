...
class DatabaseUserArgs {
  ...
  DatabaseUserArgs({
    ...
    String? name,
    List<DatabaseUserSetting>? settings,
  }) :
  ...
  factory DatabaseUserArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseUserArgs(
      ...
      mysqlAuthPlugin: map['mysqlAuthPlugin'] == null ? null : map['mysqlAuthPlugin'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      settings: map['settings'] == null ? null : pulumi.Input.decodeList<DatabaseUserSetting>(map['settings'], (value) => DatabaseUserSetting.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
