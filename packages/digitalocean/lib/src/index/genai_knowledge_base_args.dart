...
class GenaiKnowledgeBaseArgs {
  ...
  GenaiKnowledgeBaseArgs({
    ...
    bool? isPublic,
    List<GenaiKnowledgeBaseLastIndexingJob>? lastIndexingJobs,
    String? name,
  ...
  factory GenaiKnowledgeBaseArgs.fromMap(Map<String, dynamic> map) {
    return GenaiKnowledgeBaseArgs(
      ...
      lastIndexingJobs: map['lastIndexingJobs'] == null ? null : pulumi.Input.decodeList<GenaiKnowledgeBaseLastIndexingJob>(map['lastIndexingJobs'], (value) => GenaiKnowledgeBaseLastIndexingJob.fromMap((value as Map).cast<String, dynamic>())),
