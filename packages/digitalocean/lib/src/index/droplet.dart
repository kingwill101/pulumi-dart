...
class Droplet extends pulumi.CustomResource {
  ...
  Droplet(
    ...
    this.backupPolicy = registerOutput<DropletBackupPolicy?>('backupPolicy');
    this.backups = registerOutput<bool?>('backups');
    this.createdAt = registerOutput<String>('createdAt');
    this.disk = registerOutput<int>('disk');
    this.dropletAgent = registerOutput<bool?>('dropletAgent');
    this.dropletUrn = registerOutput<String>('dropletUrn');
    this.gracefulShutdown = registerOutput<bool?>('gracefulShutdown');
    this.image = registerOutput<String>('image');
    this.ipv4Address = registerOutput<String>('ipv4Address');
    this.ipv4AddressPrivate = registerOutput<String>('ipv4AddressPrivate');
    ...
    this.priceHourly = registerOutput<double>('priceHourly');
    this.priceMonthly = registerOutput<double>('priceMonthly');
    this.privateNetworking = registerOutput<bool>('privateNetworking');
    ...
    this.volumeIds = registerOutput<List<String>>('volumeIds');
