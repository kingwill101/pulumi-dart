...
class GenaiAgentTemplateModel {
  ...
  final List<GenaiAgentTemplateModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GenaiAgentTemplateModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GenaiAgentTemplateModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': ?createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GenaiAgentTemplateModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GenaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GenaiAgentTemplateModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GenaiAgentTemplateModelAgreement>(map['agreements'], (value) => GenaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GenaiAgentTemplateModelVersion>(map['versions'], (value) => GenaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
