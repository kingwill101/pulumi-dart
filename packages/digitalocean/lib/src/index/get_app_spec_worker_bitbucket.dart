...
class GetAppSpecWorkerBitbucket {
  ...
  /// Creates a new [GetAppSpecWorkerBitbucket].
  ...
  factory GetAppSpecWorkerBitbucket.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerBitbucket(
