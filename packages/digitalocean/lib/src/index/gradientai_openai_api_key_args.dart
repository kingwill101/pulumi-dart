...
class GradientaiOpenaiApiKeyArgs {
  ...
  GradientaiOpenaiApiKeyArgs({
    ...
    List<GradientaiOpenaiApiKeyModel>? models,
    String? name,
  }) :
  ...
  factory GradientaiOpenaiApiKeyArgs.fromMap(Map<String, dynamic> map) {
    return GradientaiOpenaiApiKeyArgs(
      ...
      models: map['models'] == null ? null : pulumi.Input.decodeList<GradientaiOpenaiApiKeyModel>(map['models'], (value) => GradientaiOpenaiApiKeyModel.fromMap((value as Map).cast<String, dynamic>())),
