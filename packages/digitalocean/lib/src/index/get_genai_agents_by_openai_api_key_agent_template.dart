...
class GetGenaiAgentsByOpenaiApiKeyAgentTemplate {
  ...
  final List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase>? knowledgeBases;
  /// Maximum tokens allowed
  final int? maxTokens;
  /// Model of the Agent Template
  final List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel>? models;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'k': ?k,
      'knowledgeBases': ?knowledgeBases == null ? null : pulumi.Input.encodeList<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase, Map<String, dynamic>>(knowledgeBases!, (value) => value.toMap()),
      'maxTokens': ?maxTokens,
      'models': ?models == null ? null : pulumi.Input.encodeList<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel, Map<String, dynamic>>(models!, (value) => value.toMap()),
      'name': ?name,
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentTemplate(
      ...
      knowledgeBases: map['knowledgeBases'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase>(map['knowledgeBases'], (value) => GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>())),
      maxTokens: map['maxTokens'] == null ? null : map['maxTokens'] as int,
      models: map['models'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel>(map['models'], (value) => GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>())),
