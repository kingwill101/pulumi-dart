...
class GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo].
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo(
