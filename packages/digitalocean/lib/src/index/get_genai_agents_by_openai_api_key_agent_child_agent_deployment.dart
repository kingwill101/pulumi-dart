...
class GetGenaiAgentsByOpenaiApiKeyAgentChildAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentChildAgentDeployment].
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentChildAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentChildAgentDeployment(
