...
class GetGenaiAgentChildAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentChildAgentApiKeyInfo].
  ...
  factory GetGenaiAgentChildAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentChildAgentApiKeyInfo(
