...
class GetGradientaiAgentChildAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGradientaiAgentChildAgentDeployment].
  ...
  factory GetGradientaiAgentChildAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentChildAgentDeployment(
