...
class AppSpecFunctionAlert {
  ...
  final AppSpecFunctionAlertDestinations? destinations;
  ...
  factory AppSpecFunctionAlert.fromMap(Map<String, dynamic> map) {
    return AppSpecFunctionAlert(
      destinations: map['destinations'] == null ? null : AppSpecFunctionAlertDestinations.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
