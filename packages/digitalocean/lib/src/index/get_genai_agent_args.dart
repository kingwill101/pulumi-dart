...
class GetGenaiAgentArgs {
  ...
  /// [userId] Optional.
  GetGenaiAgentArgs({
    List<GetGenaiAgentAgentGuardrail>? agentGuardrails,
    required String agentId,
    List<GetGenaiAgentAnthropicApiKey>? anthropicApiKeys,
    List<GetGenaiAgentApiKeyInfo>? apiKeyInfos,
    List<GetGenaiAgentApiKey>? apiKeys,
    List<GetGenaiAgentChatbotIdentifier>? chatbotIdentifiers,
    List<GetGenaiAgentChatbot>? chatbots,
    List<GetGenaiAgentDeployment>? deployments,
    String? description,
    List<GetGenaiAgentFunction>? functions,
    String? ifCase,
    int? k,
    List<GetGenaiAgentKnowledgeBase>? knowledgeBases,
    int? maxTokens,
    List<GetGenaiAgentModel>? models,
    List<GetGenaiAgentOpenAiApiKey>? openAiApiKeys,
    ...
    List<String>? tags,
    double? temperature,
    List<GetGenaiAgentTemplate>? templates,
    double? topP,
    String? url,
    String? userId,
  }) :
  ...
  factory GetGenaiAgentArgs.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentArgs(
      ...
      models: map['models'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentModel>(map['models'], (value) => GetGenaiAgentModel.fromMap((value as Map).cast<String, dynamic>())),
