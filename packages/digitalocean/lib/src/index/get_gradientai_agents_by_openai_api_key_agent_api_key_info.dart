...
class GetGradientaiAgentsByOpenaiApiKeyAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGradientaiAgentsByOpenaiApiKeyAgentApiKeyInfo].
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentApiKeyInfo(
