...
class DatabaseOpensearchConfigArgs {
  ...
  DatabaseOpensearchConfigArgs({
    ...
    int? httpMaxContentLengthBytes,
    int? httpMaxHeaderSizeBytes,
    int? httpMaxInitialLineLengthBytes,
    int? indicesFielddataCacheSizePercentage,
    int? indicesMemoryIndexBufferSizePercentage,
    int? indicesMemoryMaxIndexBufferSizeMb,
    int? indicesMemoryMinIndexBufferSizeMb,
    int? indicesQueriesCacheSizePercentage,
    int? indicesQueryBoolMaxClauseCount,
    int? indicesRecoveryMaxConcurrentFileChunks,
    int? indicesRecoveryMaxMbPerSec,
    bool? ismEnabled,
    bool? ismHistoryEnabled,
    int? ismHistoryMaxAgeHours,
    int? ismHistoryMaxDocs,
    int? ismHistoryRolloverCheckPeriodHours,
    int? ismHistoryRolloverRetentionPeriodDays,
    bool? overrideMainResponseVersion,
    bool? pluginsAlertingFilterByBackendRolesEnabled,
    List<String>? reindexRemoteWhitelists,
  ...
  factory DatabaseOpensearchConfigArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseOpensearchConfigArgs(
      actionAutoCreateIndexEnabled: map['actionAutoCreateIndexEnabled'] == null ? null : map['actionAutoCreateIndexEnabled'] as bool,
      actionDestructiveRequiresName: map['actionDestructiveRequiresName'] == null ? null : map['actionDestructiveRequiresName'] as bool,
      clusterId: map['clusterId'] as String,
      clusterMaxShardsPerNode: map['clusterMaxShardsPerNode'] == null ? null : map['clusterMaxShardsPerNode'] as int,
      clusterRoutingAllocationNodeConcurrentRecoveries: map['clusterRoutingAllocationNodeConcurrentRecoveries'] == null ? null : map['clusterRoutingAllocationNodeConcurrentRecoveries'] as int,
      enableSecurityAudit: map['enableSecurityAudit'] == null ? null : map['enableSecurityAudit'] as bool,
      httpMaxContentLengthBytes: map['httpMaxContentLengthBytes'] == null ? null : map['httpMaxContentLengthBytes'] as int,
      httpMaxHeaderSizeBytes: map['httpMaxHeaderSizeBytes'] == null ? null : map['httpMaxHeaderSizeBytes'] as int,
      httpMaxInitialLineLengthBytes: map['httpMaxInitialLineLengthBytes'] == null ? null : map['httpMaxInitialLineLengthBytes'] as int,
      indicesFielddataCacheSizePercentage: map['indicesFielddataCacheSizePercentage'] == null ? null : map['indicesFielddataCacheSizePercentage'] as int,
      indicesMemoryIndexBufferSizePercentage: map['indicesMemoryIndexBufferSizePercentage'] == null ? null : map['indicesMemoryIndexBufferSizePercentage'] as int,
      indicesMemoryMaxIndexBufferSizeMb: map['indicesMemoryMaxIndexBufferSizeMb'] == null ? null : map['indicesMemoryMaxIndexBufferSizeMb'] as int,
      indicesMemoryMinIndexBufferSizeMb: map['indicesMemoryMinIndexBufferSizeMb'] == null ? null : map['indicesMemoryMinIndexBufferSizeMb'] as int,
      indicesQueriesCacheSizePercentage: map['indicesQueriesCacheSizePercentage'] == null ? null : map['indicesQueriesCacheSizePercentage'] as int,
      indicesQueryBoolMaxClauseCount: map['indicesQueryBoolMaxClauseCount'] == null ? null : map['indicesQueryBoolMaxClauseCount'] as int,
      indicesRecoveryMaxConcurrentFileChunks: map['indicesRecoveryMaxConcurrentFileChunks'] == null ? null : map['indicesRecoveryMaxConcurrentFileChunks'] as int,
      indicesRecoveryMaxMbPerSec: map['indicesRecoveryMaxMbPerSec'] == null ? null : map['indicesRecoveryMaxMbPerSec'] as int,
      ismEnabled: map['ismEnabled'] == null ? null : map['ismEnabled'] as bool,
      ismHistoryEnabled: map['ismHistoryEnabled'] == null ? null : map['ismHistoryEnabled'] as bool,
      ismHistoryMaxAgeHours: map['ismHistoryMaxAgeHours'] == null ? null : map['ismHistoryMaxAgeHours'] as int,
      ismHistoryMaxDocs: map['ismHistoryMaxDocs'] == null ? null : map['ismHistoryMaxDocs'] as int,
      ismHistoryRolloverCheckPeriodHours: map['ismHistoryRolloverCheckPeriodHours'] == null ? null : map['ismHistoryRolloverCheckPeriodHours'] as int,
      ismHistoryRolloverRetentionPeriodDays: map['ismHistoryRolloverRetentionPeriodDays'] == null ? null : map['ismHistoryRolloverRetentionPeriodDays'] as int,
      overrideMainResponseVersion: map['overrideMainResponseVersion'] == null ? null : map['overrideMainResponseVersion'] as bool,
      pluginsAlertingFilterByBackendRolesEnabled: map['pluginsAlertingFilterByBackendRolesEnabled'] == null ? null : map['pluginsAlertingFilterByBackendRolesEnabled'] as bool,
      reindexRemoteWhitelists: map['reindexRemoteWhitelists'] == null ? null : (map['reindexRemoteWhitelists'] as List).cast<String>(),
      scriptMaxCompilationsRate: map['scriptMaxCompilationsRate'] == null ? null : map['scriptMaxCompilationsRate'] as String,
      searchMaxBuckets: map['searchMaxBuckets'] == null ? null : map['searchMaxBuckets'] as int,
      threadPoolAnalyzeQueueSize: map['threadPoolAnalyzeQueueSize'] == null ? null : map['threadPoolAnalyzeQueueSize'] as int,
      threadPoolAnalyzeSize: map['threadPoolAnalyzeSize'] == null ? null : map['threadPoolAnalyzeSize'] as int,
      threadPoolForceMergeSize: map['threadPoolForceMergeSize'] == null ? null : map['threadPoolForceMergeSize'] as int,
      threadPoolGetQueueSize: map['threadPoolGetQueueSize'] == null ? null : map['threadPoolGetQueueSize'] as int,
      threadPoolGetSize: map['threadPoolGetSize'] == null ? null : map['threadPoolGetSize'] as int,
      threadPoolSearchQueueSize: map['threadPoolSearchQueueSize'] == null ? null : map['threadPoolSearchQueueSize'] as int,
      threadPoolSearchSize: map['threadPoolSearchSize'] == null ? null : map['threadPoolSearchSize'] as int,
      threadPoolSearchThrottledQueueSize: map['threadPoolSearchThrottledQueueSize'] == null ? null : map['threadPoolSearchThrottledQueueSize'] as int,
      threadPoolSearchThrottledSize: map['threadPoolSearchThrottledSize'] == null ? null : map['threadPoolSearchThrottledSize'] as int,
      threadPoolWriteQueueSize: map['threadPoolWriteQueueSize'] == null ? null : map['threadPoolWriteQueueSize'] as int,
      threadPoolWriteSize: map['threadPoolWriteSize'] == null ? null : map['threadPoolWriteSize'] as int,
    );
  }
}
