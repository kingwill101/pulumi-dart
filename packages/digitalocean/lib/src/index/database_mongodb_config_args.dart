...
class DatabaseMongodbConfigArgs {
  ...
  factory DatabaseMongodbConfigArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseMongodbConfigArgs(
      ...
      defaultReadConcern: map['defaultReadConcern'] == null ? null : map['defaultReadConcern'] as String,
      defaultWriteConcern: map['defaultWriteConcern'] == null ? null : map['defaultWriteConcern'] as String,
      slowOpThresholdMs: map['slowOpThresholdMs'] == null ? null : map['slowOpThresholdMs'] as int,
      transactionLifetimeLimitSeconds: map['transactionLifetimeLimitSeconds'] == null ? null : map['transactionLifetimeLimitSeconds'] as int,
      verbosity: map['verbosity'] == null ? null : map['verbosity'] as int,
    );
  }
}
