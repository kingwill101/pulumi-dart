...
class DatabaseValkeyConfigArgs {
  ...
  factory DatabaseValkeyConfigArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseValkeyConfigArgs(
      ...
      frequentSnapshots: map['frequentSnapshots'] == null ? null : map['frequentSnapshots'] as bool,
      ...
      valkeyActiveExpireEffort: map['valkeyActiveExpireEffort'] == null ? null : map['valkeyActiveExpireEffort'] as int,
      valkeyMaxmemoryPolicy: map['valkeyMaxmemoryPolicy'] == null ? null : map['valkeyMaxmemoryPolicy'] as String,
    );
  }
}
