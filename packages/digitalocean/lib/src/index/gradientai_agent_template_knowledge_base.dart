...
class GradientaiAgentTemplateKnowledgeBase {
  ...
  final GradientaiAgentTemplateKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  GradientaiAgentTemplateKnowledgeBase({
    this.addedToAgentAt,
    this.createdAt,
    this.databaseId,
  ...
  factory GradientaiAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GradientaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
