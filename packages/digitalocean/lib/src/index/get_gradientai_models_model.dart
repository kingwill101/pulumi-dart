...
class GetGradientaiModelsModel {
  ...
  final List<GetGradientaiModelsModelAgreement> agreements;
  ...
  final List<GetGradientaiModelsModelVersion> versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': pulumi.Input.encodeList<GetGradientaiModelsModelAgreement, Map<String, dynamic>>(agreements, (value) => value.toMap()),
      'createdAt': createdAt,
      'id': id,
      ...
      'url': url,
      'uuid': uuid,
      'versions': pulumi.Input.encodeList<GetGradientaiModelsModelVersion, Map<String, dynamic>>(versions, (value) => value.toMap()),
    };
  }

  factory GetGradientaiModelsModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiModelsModel(
      agreements: pulumi.Input.decodeList<GetGradientaiModelsModelAgreement>(map['agreements'], (value) => GetGradientaiModelsModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: pulumi.Input.decodeList<GetGradientaiModelsModelVersion>(map['versions'], (value) => GetGradientaiModelsModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
