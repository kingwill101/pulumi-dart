...
import 'genai_openai_api_key_model_agreement.dart';
import 'genai_openai_api_key_model_version.dart';

class GenaiOpenaiApiKeyModel {
  /// Agreement information for the model
  final List<GenaiOpenaiApiKeyModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GenaiOpenaiApiKeyModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GenaiOpenaiApiKeyModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': ?createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GenaiOpenaiApiKeyModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GenaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GenaiOpenaiApiKeyModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GenaiOpenaiApiKeyModelAgreement>(map['agreements'], (value) => GenaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GenaiOpenaiApiKeyModelVersion>(map['versions'], (value) => GenaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
