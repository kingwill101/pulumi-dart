...
class GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase {
  ...
  final GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
