...
class AppArgs {
  ...
  AppArgs({
    List<AppDedicatedIp>? dedicatedIps,
    int? deploymentPerPage,
    String? projectId,
    AppSpec? spec,
  }) :
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      dedicatedIps: map['dedicatedIps'] == null ? null : pulumi.Input.decodeList<AppDedicatedIp>(map['dedicatedIps'], (value) => AppDedicatedIp.fromMap((value as Map).cast<String, dynamic>())),
      deploymentPerPage: map['deploymentPerPage'] == null ? null : map['deploymentPerPage'] as int,
      projectId: map['projectId'] == null ? null : map['projectId'] as String,
      spec: map['spec'] == null ? null : AppSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
