...
class GradientaiAgentTemplateModel {
  ...
  final List<GradientaiAgentTemplateModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GradientaiAgentTemplateModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GradientaiAgentTemplateModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': ?createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GradientaiAgentTemplateModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GradientaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentTemplateModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GradientaiAgentTemplateModelAgreement>(map['agreements'], (value) => GradientaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GradientaiAgentTemplateModelVersion>(map['versions'], (value) => GradientaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
