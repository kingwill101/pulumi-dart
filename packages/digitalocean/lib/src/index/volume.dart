...
class Volume extends pulumi.CustomResource {
  ...
  Volume(
    ...
    this.filesystemLabel = registerOutput<String>('filesystemLabel');
    this.filesystemType = registerOutput<String>('filesystemType');
    this.initialFilesystemLabel = registerOutput<String?>('initialFilesystemLabel');
    this.initialFilesystemType = registerOutput<String?>('initialFilesystemType');
    this.name = registerOutput<String>('name');
    this.region = registerOutput<String>('region');
    this.size = registerOutput<int>('size');
    this.snapshotId = registerOutput<String?>('snapshotId');
    this.tags = registerOutput<List<String>?>('tags');
    this.volumeUrn = registerOutput<String>('volumeUrn');
  }
}
