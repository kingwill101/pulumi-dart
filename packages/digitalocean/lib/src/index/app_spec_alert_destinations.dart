...
class AppSpecAlertDestinations {
  ...
  final List<AppSpecAlertDestinationsSlackWebhook>? slackWebhooks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'emails': ?emails,
      'slackWebhooks': ?slackWebhooks == null ? null : pulumi.Input.encodeList<AppSpecAlertDestinationsSlackWebhook, Map<String, dynamic>>(slackWebhooks!, (value) => value.toMap()),
    };
  }
  ...
  factory AppSpecAlertDestinations.fromMap(Map<String, dynamic> map) {
    return AppSpecAlertDestinations(
      ...
      slackWebhooks: map['slackWebhooks'] == null ? null : pulumi.Input.decodeList<AppSpecAlertDestinationsSlackWebhook>(map['slackWebhooks'], (value) => AppSpecAlertDestinationsSlackWebhook.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
