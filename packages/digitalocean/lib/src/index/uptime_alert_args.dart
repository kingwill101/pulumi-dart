...
class UptimeAlertArgs {
  ...
  UptimeAlertArgs({
    ...
    String? comparison,
    String? name,
    required List<UptimeAlertNotification> notifications,
    String? period,
    int? threshold,
  ...
  factory UptimeAlertArgs.fromMap(Map<String, dynamic> map) {
    return UptimeAlertArgs(
      ...
      notifications: pulumi.Input.decodeList<UptimeAlertNotification>(map['notifications'], (value) => UptimeAlertNotification.fromMap((value as Map).cast<String, dynamic>())),
