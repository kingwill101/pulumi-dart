...
class DatabaseOnlineMigrationArgs {
  ...
  DatabaseOnlineMigrationArgs({
    ...
    required DatabaseOnlineMigrationSource source,
  }) :
  ...
  factory DatabaseOnlineMigrationArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseOnlineMigrationArgs(
      ...
      disableSsl: map['disableSsl'] == null ? null : map['disableSsl'] as bool,
      ignoreDbs: map['ignoreDbs'] == null ? null : (map['ignoreDbs'] as List).cast<String>(),
      source: DatabaseOnlineMigrationSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
    );
  }
}
