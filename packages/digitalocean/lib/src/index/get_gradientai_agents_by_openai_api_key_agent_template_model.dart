...
class GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel {
  ...
  final List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement>(map['agreements'], (value) => GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion>(map['versions'], (value) => GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
