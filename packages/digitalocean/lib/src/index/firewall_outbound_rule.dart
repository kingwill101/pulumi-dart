...
class FirewallOutboundRule {
  ...
  final List<int>? destinationDropletIds;
  /// An array containing the IDs of
  /// the Kubernetes clusters to which the outbound traffic will be allowed.
  final List<String>? destinationKubernetesIds;
  /// An array containing the IDs
  /// of the Load Balancers to which the outbound traffic will be allowed.
  final List<String>? destinationLoadBalancerUids;
  ...
  factory FirewallOutboundRule.fromMap(Map<String, dynamic> map) {
    return FirewallOutboundRule(
      ...
      destinationDropletIds: map['destinationDropletIds'] == null ? null : (map['destinationDropletIds'] as List).cast<int>(),
      destinationKubernetesIds: map['destinationKubernetesIds'] == null ? null : (map['destinationKubernetesIds'] as List).cast<String>(),
      destinationLoadBalancerUids: map['destinationLoadBalancerUids'] == null ? null : (map['destinationLoadBalancerUids'] as List).cast<String>(),
      destinationTags: map['destinationTags'] == null ? null : (map['destinationTags'] as List).cast<String>(),
