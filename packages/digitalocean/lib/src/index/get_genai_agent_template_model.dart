...
class GetGenaiAgentTemplateModel {
  ...
  final List<GetGenaiAgentTemplateModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGenaiAgentTemplateModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGenaiAgentTemplateModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGenaiAgentTemplateModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGenaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentTemplateModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentTemplateModelAgreement>(map['agreements'], (value) => GetGenaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentTemplateModelVersion>(map['versions'], (value) => GetGenaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
