...
class DatabaseKafkaTopicArgs {
  ...
  DatabaseKafkaTopicArgs({
    ...
    List<DatabaseKafkaTopicConfig>? configs,
    String? name,
    int? partitionCount,
  ...
  factory DatabaseKafkaTopicArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseKafkaTopicArgs(
      ...
      configs: map['configs'] == null ? null : pulumi.Input.decodeList<DatabaseKafkaTopicConfig>(map['configs'], (value) => DatabaseKafkaTopicConfig.fromMap((value as Map).cast<String, dynamic>())),
