...
class GetGradientaiAgentsAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGradientaiAgentsAgentAnthropicApiKey].
  ...
  factory GetGradientaiAgentsAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentAnthropicApiKey(
