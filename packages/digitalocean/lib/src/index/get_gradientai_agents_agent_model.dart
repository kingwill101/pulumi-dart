...
class GetGradientaiAgentsAgentModel {
  ...
  final List<GetGradientaiAgentsAgentModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGradientaiAgentsAgentModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGradientaiAgentsAgentModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGradientaiAgentsAgentModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGradientaiAgentsAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentsAgentModelAgreement>(map['agreements'], (value) => GetGradientaiAgentsAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentsAgentModelVersion>(map['versions'], (value) => GetGradientaiAgentsAgentModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
