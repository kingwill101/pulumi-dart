...
class GetGradientaiAgentsAgentParentAgentChatbot {
  ...
  /// Creates a new [GetGradientaiAgentsAgentParentAgentChatbot].
  ...
  GetGradientaiAgentsAgentParentAgentChatbot({
  ...
  factory GetGradientaiAgentsAgentParentAgentChatbot.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentParentAgentChatbot(
