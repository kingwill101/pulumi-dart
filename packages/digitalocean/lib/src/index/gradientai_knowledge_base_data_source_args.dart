...
class GradientaiKnowledgeBaseDataSourceArgs {
  ...
  GradientaiKnowledgeBaseDataSourceArgs({
    ...
    GradientaiKnowledgeBaseDataSourceSpacesDataSource? spacesDataSource,
    GradientaiKnowledgeBaseDataSourceWebCrawlerDataSource? webCrawlerDataSource,
  }) :
  ...
  factory GradientaiKnowledgeBaseDataSourceArgs.fromMap(Map<String, dynamic> map) {
    return GradientaiKnowledgeBaseDataSourceArgs(
      ...
      spacesDataSource: map['spacesDataSource'] == null ? null : GradientaiKnowledgeBaseDataSourceSpacesDataSource.fromMap((map['spacesDataSource'] as Map).cast<String, dynamic>()),
      webCrawlerDataSource: map['webCrawlerDataSource'] == null ? null : GradientaiKnowledgeBaseDataSourceWebCrawlerDataSource.fromMap((map['webCrawlerDataSource'] as Map).cast<String, dynamic>()),
    );
  }
}
