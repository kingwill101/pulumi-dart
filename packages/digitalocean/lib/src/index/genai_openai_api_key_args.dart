...
class GenaiOpenaiApiKeyArgs {
  ...
  GenaiOpenaiApiKeyArgs({
    ...
    List<GenaiOpenaiApiKeyModel>? models,
    String? name,
  }) :
  ...
  factory GenaiOpenaiApiKeyArgs.fromMap(Map<String, dynamic> map) {
    return GenaiOpenaiApiKeyArgs(
      ...
      models: map['models'] == null ? null : pulumi.Input.decodeList<GenaiOpenaiApiKeyModel>(map['models'], (value) => GenaiOpenaiApiKeyModel.fromMap((value as Map).cast<String, dynamic>())),
