...
class GenaiAgentTemplateKnowledgeBase {
  ...
  final GenaiAgentTemplateKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GenaiAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GenaiAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GenaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
