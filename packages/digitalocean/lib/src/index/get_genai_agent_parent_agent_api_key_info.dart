...
class GetGenaiAgentParentAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentParentAgentApiKeyInfo].
  ...
  factory GetGenaiAgentParentAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentParentAgentApiKeyInfo(
