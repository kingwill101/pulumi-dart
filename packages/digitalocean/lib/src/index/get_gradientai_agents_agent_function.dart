...
class GetGradientaiAgentsAgentFunction {
  /// API Key value
  final String? apiKey;
  ...
  /// Creates a new [GetGradientaiAgentsAgentFunction].
  ...
  factory GetGradientaiAgentsAgentFunction.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentFunction(
