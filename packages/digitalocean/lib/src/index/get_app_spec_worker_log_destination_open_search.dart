...
class GetAppSpecWorkerLogDestinationOpenSearch {
  ...
  final GetAppSpecWorkerLogDestinationOpenSearchBasicAuth basicAuth;
  ...
  factory GetAppSpecWorkerLogDestinationOpenSearch.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerLogDestinationOpenSearch(
      basicAuth: GetAppSpecWorkerLogDestinationOpenSearchBasicAuth.fromMap((map['basicAuth'] as Map).cast<String, dynamic>()),
