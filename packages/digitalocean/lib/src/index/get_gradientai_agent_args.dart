...
class GetGradientaiAgentArgs {
  ...
  GetGradientaiAgentArgs({
    List<GetGradientaiAgentAgentGuardrail>? agentGuardrails,
    required String agentId,
    List<GetGradientaiAgentAnthropicApiKey>? anthropicApiKeys,
    List<GetGradientaiAgentApiKeyInfo>? apiKeyInfos,
    List<GetGradientaiAgentApiKey>? apiKeys,
    List<GetGradientaiAgentChatbotIdentifier>? chatbotIdentifiers,
    List<GetGradientaiAgentChatbot>? chatbots,
    List<GetGradientaiAgentDeployment>? deployments,
    String? description,
    List<GetGradientaiAgentFunction>? functions,
    String? ifCase,
    int? k,
    List<GetGradientaiAgentKnowledgeBase>? knowledgeBases,
    int? maxTokens,
    List<GetGradientaiAgentModel>? models,
    List<GetGradientaiAgentOpenAiApiKey>? openAiApiKeys,
    ...
    List<String>? tags,
    double? temperature,
    List<GetGradientaiAgentTemplate>? templates,
    double? topP,
    String? url,
    String? userId,
  }) :
  ...
  factory GetGradientaiAgentArgs.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentArgs(
      ...
      models: map['models'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentModel>(map['models'], (value) => GetGradientaiAgentModel.fromMap((value as Map).cast<String, dynamic>())),
