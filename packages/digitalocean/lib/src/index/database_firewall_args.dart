...
class DatabaseFirewallArgs {
  ...
  DatabaseFirewallArgs({
    ...
    required List<DatabaseFirewallRule> rules,
  }) :
  ...
  factory DatabaseFirewallArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseFirewallArgs(
      ...
      rules: pulumi.Input.decodeList<DatabaseFirewallRule>(map['rules'], (value) => DatabaseFirewallRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
