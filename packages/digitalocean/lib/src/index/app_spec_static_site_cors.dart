...
class AppSpecStaticSiteCors {
  ...
  final AppSpecStaticSiteCorsAllowOrigins? allowOrigins;
  ...
  factory AppSpecStaticSiteCors.fromMap(Map<String, dynamic> map) {
    return AppSpecStaticSiteCors(
      ...
      allowOrigins: map['allowOrigins'] == null ? null : AppSpecStaticSiteCorsAllowOrigins.fromMap((map['allowOrigins'] as Map).cast<String, dynamic>()),
