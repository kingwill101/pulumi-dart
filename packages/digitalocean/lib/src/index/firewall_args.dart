...
class FirewallArgs {
  ...
  FirewallArgs({
    List<int>? dropletIds,
    List<FirewallInboundRule>? inboundRules,
    String? name,
    List<FirewallOutboundRule>? outboundRules,
    List<String>? tags,
  }) :
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      ...
      inboundRules: map['inboundRules'] == null ? null : pulumi.Input.decodeList<FirewallInboundRule>(map['inboundRules'], (value) => FirewallInboundRule.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      outboundRules: map['outboundRules'] == null ? null : pulumi.Input.decodeList<FirewallOutboundRule>(map['outboundRules'], (value) => FirewallOutboundRule.fromMap((value as Map).cast<String, dynamic>())),
