...
class GetGradientaiOpenaiApiKeyModel {
  ...
  final List<GetGradientaiOpenaiApiKeyModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGradientaiOpenaiApiKeyModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGradientaiOpenaiApiKeyModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGradientaiOpenaiApiKeyModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGradientaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiOpenaiApiKeyModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelAgreement>(map['agreements'], (value) => GetGradientaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelVersion>(map['versions'], (value) => GetGradientaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
