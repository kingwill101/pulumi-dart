...
class GetAppArgs {
  ...
  GetAppArgs({
    ...
    List<GetAppDedicatedIp>? dedicatedIps,
  }) :
  ...
  factory GetAppArgs.fromMap(Map<String, dynamic> map) {
    return GetAppArgs(
      ...
      dedicatedIps: map['dedicatedIps'] == null ? null : pulumi.Input.decodeList<GetAppDedicatedIp>(map['dedicatedIps'], (value) => GetAppDedicatedIp.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
