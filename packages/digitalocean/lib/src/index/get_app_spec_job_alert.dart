...
class GetAppSpecJobAlert {
  final GetAppSpecJobAlertDestinations? destinations;
  ...
  factory GetAppSpecJobAlert.fromMap(Map<String, dynamic> map) {
    return GetAppSpecJobAlert(
      destinations: map['destinations'] == null ? null : GetAppSpecJobAlertDestinations.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
