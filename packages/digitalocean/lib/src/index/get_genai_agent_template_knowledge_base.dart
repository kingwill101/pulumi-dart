...
class GetGenaiAgentTemplateKnowledgeBase {
  ...
  final GetGenaiAgentTemplateKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GetGenaiAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GetGenaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
