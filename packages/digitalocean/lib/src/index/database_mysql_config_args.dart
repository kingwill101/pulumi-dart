...
class DatabaseMysqlConfigArgs {
  ...
  factory DatabaseMysqlConfigArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseMysqlConfigArgs(
      ...
      binlogRetentionPeriod: map['binlogRetentionPeriod'] == null ? null : map['binlogRetentionPeriod'] as int,
      ...
      groupConcatMaxLen: map['groupConcatMaxLen'] == null ? null : map['groupConcatMaxLen'] as int,
      informationSchemaStatsExpiry: map['informationSchemaStatsExpiry'] == null ? null : map['informationSchemaStatsExpiry'] as int,
      innodbFtMinTokenSize: map['innodbFtMinTokenSize'] == null ? null : map['innodbFtMinTokenSize'] as int,
      innodbFtServerStopwordTable: map['innodbFtServerStopwordTable'] == null ? null : map['innodbFtServerStopwordTable'] as String,
      innodbLockWaitTimeout: map['innodbLockWaitTimeout'] == null ? null : map['innodbLockWaitTimeout'] as int,
      innodbLogBufferSize: map['innodbLogBufferSize'] == null ? null : map['innodbLogBufferSize'] as int,
      innodbOnlineAlterLogMaxSize: map['innodbOnlineAlterLogMaxSize'] == null ? null : map['innodbOnlineAlterLogMaxSize'] as int,
      innodbPrintAllDeadlocks: map['innodbPrintAllDeadlocks'] == null ? null : map['innodbPrintAllDeadlocks'] as bool,
      innodbRollbackOnTimeout: map['innodbRollbackOnTimeout'] == null ? null : map['innodbRollbackOnTimeout'] as bool,
      interactiveTimeout: map['interactiveTimeout'] == null ? null : map['interactiveTimeout'] as int,
      internalTmpMemStorageEngine: map['internalTmpMemStorageEngine'] == null ? null : map['internalTmpMemStorageEngine'] as String,
      longQueryTime: map['longQueryTime'] == null ? null : map['longQueryTime'] as double,
      maxAllowedPacket: map['maxAllowedPacket'] == null ? null : map['maxAllowedPacket'] as int,
      maxHeapTableSize: map['maxHeapTableSize'] == null ? null : map['maxHeapTableSize'] as int,
      netReadTimeout: map['netReadTimeout'] == null ? null : map['netReadTimeout'] as int,
      netWriteTimeout: map['netWriteTimeout'] == null ? null : map['netWriteTimeout'] as int,
      slowQueryLog: map['slowQueryLog'] == null ? null : map['slowQueryLog'] as bool,
      sortBufferSize: map['sortBufferSize'] == null ? null : map['sortBufferSize'] as int,
      sqlMode: map['sqlMode'] == null ? null : map['sqlMode'] as String,
      sqlRequirePrimaryKey: map['sqlRequirePrimaryKey'] == null ? null : map['sqlRequirePrimaryKey'] as bool,
      tmpTableSize: map['tmpTableSize'] == null ? null : map['tmpTableSize'] as int,
      waitTimeout: map['waitTimeout'] == null ? null : map['waitTimeout'] as int,
    );
  }
}
