...
class GenaiKnowledgeBaseDataSourceArgs {
  ...
  GenaiKnowledgeBaseDataSourceArgs({
    ...
    GenaiKnowledgeBaseDataSourceSpacesDataSource? spacesDataSource,
    GenaiKnowledgeBaseDataSourceWebCrawlerDataSource? webCrawlerDataSource,
  }) :
  ...
  factory GenaiKnowledgeBaseDataSourceArgs.fromMap(Map<String, dynamic> map) {
    return GenaiKnowledgeBaseDataSourceArgs(
      ...
      spacesDataSource: map['spacesDataSource'] == null ? null : GenaiKnowledgeBaseDataSourceSpacesDataSource.fromMap((map['spacesDataSource'] as Map).cast<String, dynamic>()),
      webCrawlerDataSource: map['webCrawlerDataSource'] == null ? null : GenaiKnowledgeBaseDataSourceWebCrawlerDataSource.fromMap((map['webCrawlerDataSource'] as Map).cast<String, dynamic>()),
    );
  }
}
