...
class DomainDevicesMemBalloon {
  ...
  final DomainDevicesMemBalloonStats? stats;
  ...
  factory DomainDevicesMemBalloon.fromMap(Map<String, dynamic> map) {
    return DomainDevicesMemBalloon(
      acpi: map['acpi'] == null ? null : DomainDevicesMemBalloonAcpi.fromMap((map['acpi'] as Map).cast<String, dynamic>()),
      address: map['address'] == null ? null : (map['address'] as Map).cast<String, dynamic>(),
      alias: map['alias'] == null ? null : DomainDevicesMemBalloonAlias.fromMap((map['alias'] as Map).cast<String, dynamic>()),
      autoDeflate: map['autoDeflate'] == null ? null : map['autoDeflate'] as String,
      driver: map['driver'] == null ? null : DomainDevicesMemBalloonDriver.fromMap((map['driver'] as Map).cast<String, dynamic>()),
      freePageReporting: map['freePageReporting'] == null ? null : map['freePageReporting'] as String,
      model: map['model'] as String,
      stats: map['stats'] == null ? null : DomainDevicesMemBalloonStats.fromMap((map['stats'] as Map).cast<String, dynamic>()),
    );
  }
}
