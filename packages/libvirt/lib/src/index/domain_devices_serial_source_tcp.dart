...
class DomainDevicesSerialSourceTcp {
  ...
  final DomainDevicesSerialSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesSerialSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesSerialSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
