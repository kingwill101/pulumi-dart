...
class DomainDevicesDiskBackingStoreSourceReservationsSourceTcp {
  ...
  final DomainDevicesDiskBackingStoreSourceReservationsSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesDiskBackingStoreSourceReservationsSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
