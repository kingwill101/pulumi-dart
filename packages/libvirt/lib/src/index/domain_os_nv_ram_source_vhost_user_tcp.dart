...
class DomainOsNvRamSourceVhostUserTcp {
  ...
  final DomainOsNvRamSourceVhostUserTcpReconnect? reconnect;
  ...
  factory DomainOsNvRamSourceVhostUserTcp.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainOsNvRamSourceVhostUserTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
