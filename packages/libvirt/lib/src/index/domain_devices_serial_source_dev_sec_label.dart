...
class DomainDevicesSerialSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesSerialSourceDevSecLabel].
  ...
  factory DomainDevicesSerialSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourceDevSecLabel(
