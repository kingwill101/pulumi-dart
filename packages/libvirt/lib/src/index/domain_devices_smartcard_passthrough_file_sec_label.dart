...
class DomainDevicesSmartcardPassthroughFileSecLabel {
  ...
  /// Creates a new [DomainDevicesSmartcardPassthroughFileSecLabel].
  ...
  factory DomainDevicesSmartcardPassthroughFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughFileSecLabel(
