...
class DomainDevicesDiskBackingStoreSourceCookies {
  ...
  final List<DomainDevicesDiskBackingStoreSourceCookiesCookie>? cookies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cookies': ?cookies == null ? null : pulumi.Input.encodeList<DomainDevicesDiskBackingStoreSourceCookiesCookie, Map<String, dynamic>>(cookies!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesDiskBackingStoreSourceCookies.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceCookies(
      cookies: map['cookies'] == null ? null : pulumi.Input.decodeList<DomainDevicesDiskBackingStoreSourceCookiesCookie>(map['cookies'], (value) => DomainDevicesDiskBackingStoreSourceCookiesCookie.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
