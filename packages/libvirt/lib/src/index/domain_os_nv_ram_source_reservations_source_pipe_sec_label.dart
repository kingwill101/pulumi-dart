...
class DomainOsNvRamSourceReservationsSourcePipeSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceReservationsSourcePipeSecLabel].
  ...
  factory DomainOsNvRamSourceReservationsSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourcePipeSecLabel(
