...
class VolumeArgs {
  ...
  VolumeArgs({
    ...
    VolumeBackingStore? backingStore,
    double? capacity,
    String? capacityUnit,
    VolumeCreate? create,
    String? name,
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      allocationUnit: map['allocationUnit'] == null ? null : map['allocationUnit'] as String,
      backingStore: map['backingStore'] == null ? null : VolumeBackingStore.fromMap((map['backingStore'] as Map).cast<String, dynamic>()),
      capacity: map['capacity'] == null ? null : map['capacity'] as double,
      capacityUnit: map['capacityUnit'] == null ? null : map['capacityUnit'] as String,
      create: map['create'] == null ? null : VolumeCreate.fromMap((map['create'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      physicalUnit: map['physicalUnit'] == null ? null : map['physicalUnit'] as String,
      pool: map['pool'] as String,
      target: map['target'] == null ? null : VolumeTarget.fromMap((map['target'] as Map).cast<String, dynamic>()),
