...
class DomainDevicesDiskSourceVhostUserTcp {
  ...
  final DomainDevicesDiskSourceVhostUserTcpReconnect? reconnect;
  ...
  factory DomainDevicesDiskSourceVhostUserTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVhostUserTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesDiskSourceVhostUserTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
