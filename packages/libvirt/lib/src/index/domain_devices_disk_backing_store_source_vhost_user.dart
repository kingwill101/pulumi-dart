...
class DomainDevicesDiskBackingStoreSourceVhostUser {
  ...
  final DomainDevicesDiskBackingStoreSourceVhostUserDbus? dbus;
  /// Defines the device path for the source of the EGD backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserDev? dev;
  /// Defines a file source for the RNG EGD backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserFile? file;
  /// Configures the NMDM (null modem) device source for the EGD backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserNmdm? nmdm;
  ...
  final DomainDevicesDiskBackingStoreSourceVhostUserPipe? pipe;
  /// Defines a pseudo-terminal (PTY) source for the EGD backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserPty? pty;
  /// Configures the QEMU guest agent for the random number generator backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserQemuvdAgent? qemuvdAgent;
  /// Configures the SPICE port settings for the random number generator backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserSpicePort? spicePort;
  ...
  final DomainDevicesDiskBackingStoreSourceVhostUserTcp? tcp;
  /// Configures UDP settings for the random number generator backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserUdp? udp;
  /// Configures UNIX domain socket settings for the random number generator backend.
  final DomainDevicesDiskBackingStoreSourceVhostUserUnix? unix;
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUser.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUser(
      dbus: map['dbus'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserDbus.fromMap((map['dbus'] as Map).cast<String, dynamic>()),
      dev: map['dev'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserDev.fromMap((map['dev'] as Map).cast<String, dynamic>()),
      file: map['file'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserFile.fromMap((map['file'] as Map).cast<String, dynamic>()),
      nmdm: map['nmdm'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserNmdm.fromMap((map['nmdm'] as Map).cast<String, dynamic>()),
      null_: map['null'] == null ? null : map['null'] as bool,
      pipe: map['pipe'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserPipe.fromMap((map['pipe'] as Map).cast<String, dynamic>()),
      pty: map['pty'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserPty.fromMap((map['pty'] as Map).cast<String, dynamic>()),
      qemuvdAgent: map['qemuvdAgent'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserQemuvdAgent.fromMap((map['qemuvdAgent'] as Map).cast<String, dynamic>()),
      spicePort: map['spicePort'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserSpicePort.fromMap((map['spicePort'] as Map).cast<String, dynamic>()),
      spiceVmc: map['spiceVmc'] == null ? null : map['spiceVmc'] as bool,
      stdIo: map['stdIo'] == null ? null : map['stdIo'] as bool,
      tcp: map['tcp'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserTcp.fromMap((map['tcp'] as Map).cast<String, dynamic>()),
      udp: map['udp'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserUdp.fromMap((map['udp'] as Map).cast<String, dynamic>()),
      unix: map['unix'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserUnix.fromMap((map['unix'] as Map).cast<String, dynamic>()),
