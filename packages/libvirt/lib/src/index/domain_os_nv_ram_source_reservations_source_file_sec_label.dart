...
class DomainOsNvRamSourceReservationsSourceFileSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceReservationsSourceFileSecLabel].
  ...
  factory DomainOsNvRamSourceReservationsSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourceFileSecLabel(
