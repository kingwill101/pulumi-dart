...
class DomainOsNvRamSourceReservationsSourceTcp {
  ...
  final DomainOsNvRamSourceReservationsSourceTcpReconnect? reconnect;
  ...
  factory DomainOsNvRamSourceReservationsSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainOsNvRamSourceReservationsSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
