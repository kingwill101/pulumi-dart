...
class DomainDevicesParallelSourceDev {
  ...
  final List<DomainDevicesParallelSourceDevSecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesParallelSourceDevSecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesParallelSourceDev.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceDev(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesParallelSourceDevSecLabel>(map['secLabels'], (value) => DomainDevicesParallelSourceDevSecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
