...
class Network extends pulumi.CustomResource {
  ...
  Network(
    ...
    this.bandwidth = registerOutput<NetworkBandwidth?>('bandwidth');
    this.bridge = registerOutput<NetworkBridge?>('bridge');
    this.dns = registerOutput<NetworkDns?>('dns');
    this.domain = registerOutput<NetworkDomain?>('domain');
    this.forward = registerOutput<NetworkForward?>('forward');
    this.ips = registerOutput<List<NetworkIp>?>('ips');
    this.ipv6 = registerOutput<String?>('ipv6');
    this.mac = registerOutput<NetworkMac?>('mac');
    this.metadata = registerOutput<NetworkMetadata?>('metadata');
    this.mtu = registerOutput<NetworkMtu?>('mtu');
    this.name = registerOutput<String>('name');
    this.portGroups = registerOutput<List<NetworkPortGroup>?>('portGroups');
    this.portOptions = registerOutput<NetworkPortOptions?>('portOptions');
    this.routes = registerOutput<List<NetworkRoute>?>('routes');
    this.trustGuestRxFilters = registerOutput<String?>('trustGuestRxFilters');
    this.uuid = registerOutput<String>('uuid');
    this.virtualPort = registerOutput<NetworkVirtualPort?>('virtualPort');
    this.vlan = registerOutput<NetworkVlan?>('vlan');
  }
}
