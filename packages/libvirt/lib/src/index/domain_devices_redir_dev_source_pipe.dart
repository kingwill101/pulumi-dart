...
class DomainDevicesRedirDevSourcePipe {
  ...
  final List<DomainDevicesRedirDevSourcePipeSecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesRedirDevSourcePipeSecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesRedirDevSourcePipe.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourcePipe(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesRedirDevSourcePipeSecLabel>(map['secLabels'], (value) => DomainDevicesRedirDevSourcePipeSecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
