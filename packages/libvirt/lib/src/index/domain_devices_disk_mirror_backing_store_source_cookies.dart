...
class DomainDevicesDiskMirrorBackingStoreSourceCookies {
  ...
  final List<DomainDevicesDiskMirrorBackingStoreSourceCookiesCookie>? cookies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cookies': ?cookies == null ? null : pulumi.Input.encodeList<DomainDevicesDiskMirrorBackingStoreSourceCookiesCookie, Map<String, dynamic>>(cookies!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceCookies.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceCookies(
      cookies: map['cookies'] == null ? null : pulumi.Input.decodeList<DomainDevicesDiskMirrorBackingStoreSourceCookiesCookie>(map['cookies'], (value) => DomainDevicesDiskMirrorBackingStoreSourceCookiesCookie.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
