...
class DomainDevicesSerialSourcePty {
  ...
  final List<DomainDevicesSerialSourcePtySecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesSerialSourcePtySecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesSerialSourcePty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourcePty(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesSerialSourcePtySecLabel>(map['secLabels'], (value) => DomainDevicesSerialSourcePtySecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
