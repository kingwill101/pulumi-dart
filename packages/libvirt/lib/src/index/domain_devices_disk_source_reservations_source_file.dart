...
class DomainDevicesDiskSourceReservationsSourceFile {
  ...
  final List<DomainDevicesDiskSourceReservationsSourceFileSecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'append': ?append,
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesDiskSourceReservationsSourceFileSecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesDiskSourceReservationsSourceFile.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourceFile(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesDiskSourceReservationsSourceFileSecLabel>(map['secLabels'], (value) => DomainDevicesDiskSourceReservationsSourceFileSecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
