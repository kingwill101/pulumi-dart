...
class DomainDevicesTpmBackendExternalSourceTcp {
  ...
  final DomainDevicesTpmBackendExternalSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesTpmBackendExternalSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendExternalSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesTpmBackendExternalSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
