...
class DomainDevicesDiskMirrorSourceNetwork {
  ...
  final DomainDevicesDiskMirrorSourceNetworkReconnect? reconnect;
  /// Enables snapshot capabilities for the network storage source, allowing for point-in-time volumes.
  final DomainDevicesDiskMirrorSourceNetworkSnapshot? snapshot;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hosts': ?hosts == null ? null : pulumi.Input.encodeList<DomainDevicesDiskMirrorSourceNetworkHost, Map<String, dynamic>>(hosts!, (value) => value.toMap()),
  ...
  factory DomainDevicesDiskMirrorSourceNetwork.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceNetwork(
      auth: map['auth'] == null ? null : DomainDevicesDiskMirrorSourceNetworkAuth.fromMap((map['auth'] as Map).cast<String, dynamic>()),
      config: map['config'] == null ? null : DomainDevicesDiskMirrorSourceNetworkConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      hosts: map['hosts'] == null ? null : pulumi.Input.decodeList<DomainDevicesDiskMirrorSourceNetworkHost>(map['hosts'], (value) => DomainDevicesDiskMirrorSourceNetworkHost.fromMap((value as Map).cast<String, dynamic>())),
      identity: map['identity'] == null ? null : DomainDevicesDiskMirrorSourceNetworkIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      initiator: map['initiator'] == null ? null : DomainDevicesDiskMirrorSourceNetworkInitiator.fromMap((map['initiator'] as Map).cast<String, dynamic>()),
      knownHosts: map['knownHosts'] == null ? null : DomainDevicesDiskMirrorSourceNetworkKnownHosts.fromMap((map['knownHosts'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      protocol: map['protocol'] == null ? null : map['protocol'] as String,
      query: map['query'] == null ? null : map['query'] as String,
      reconnect: map['reconnect'] == null ? null : DomainDevicesDiskMirrorSourceNetworkReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
      snapshot: map['snapshot'] == null ? null : DomainDevicesDiskMirrorSourceNetworkSnapshot.fromMap((map['snapshot'] as Map).cast<String, dynamic>()),
