...
class DomainDevicesDiskBackingStoreSourceVhostUserTcp {
  ...
  final DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect? reconnect;
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
