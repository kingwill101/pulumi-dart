...
class DomainDevicesDiskMirrorSourceVhostUser {
  ...
  final DomainDevicesDiskMirrorSourceVhostUserDbus? dbus;
  /// Defines the device path for the source of the EGD backend.
  final DomainDevicesDiskMirrorSourceVhostUserDev? dev;
  /// Defines a file source for the RNG EGD backend.
  final DomainDevicesDiskMirrorSourceVhostUserFile? file;
  /// Configures the NMDM (null modem) device source for the EGD backend.
  final DomainDevicesDiskMirrorSourceVhostUserNmdm? nmdm;
  ...
  final DomainDevicesDiskMirrorSourceVhostUserPipe? pipe;
  /// Defines a pseudo-terminal (PTY) source for the EGD backend.
  final DomainDevicesDiskMirrorSourceVhostUserPty? pty;
  /// Configures the QEMU guest agent for the random number generator backend.
  final DomainDevicesDiskMirrorSourceVhostUserQemuvdAgent? qemuvdAgent;
  /// Configures the SPICE port settings for the random number generator backend.
  final DomainDevicesDiskMirrorSourceVhostUserSpicePort? spicePort;
  ...
  final DomainDevicesDiskMirrorSourceVhostUserTcp? tcp;
  /// Configures UDP settings for the random number generator backend.
  final DomainDevicesDiskMirrorSourceVhostUserUdp? udp;
  /// Configures UNIX domain socket settings for the random number generator backend.
  final DomainDevicesDiskMirrorSourceVhostUserUnix? unix;
  ...
  factory DomainDevicesDiskMirrorSourceVhostUser.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUser(
      dbus: map['dbus'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserDbus.fromMap((map['dbus'] as Map).cast<String, dynamic>()),
      dev: map['dev'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserDev.fromMap((map['dev'] as Map).cast<String, dynamic>()),
      file: map['file'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserFile.fromMap((map['file'] as Map).cast<String, dynamic>()),
      nmdm: map['nmdm'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserNmdm.fromMap((map['nmdm'] as Map).cast<String, dynamic>()),
      null_: map['null'] == null ? null : map['null'] as bool,
      pipe: map['pipe'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserPipe.fromMap((map['pipe'] as Map).cast<String, dynamic>()),
      pty: map['pty'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserPty.fromMap((map['pty'] as Map).cast<String, dynamic>()),
      qemuvdAgent: map['qemuvdAgent'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserQemuvdAgent.fromMap((map['qemuvdAgent'] as Map).cast<String, dynamic>()),
      spicePort: map['spicePort'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserSpicePort.fromMap((map['spicePort'] as Map).cast<String, dynamic>()),
      spiceVmc: map['spiceVmc'] == null ? null : map['spiceVmc'] as bool,
      stdIo: map['stdIo'] == null ? null : map['stdIo'] as bool,
      tcp: map['tcp'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserTcp.fromMap((map['tcp'] as Map).cast<String, dynamic>()),
      udp: map['udp'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserUdp.fromMap((map['udp'] as Map).cast<String, dynamic>()),
      unix: map['unix'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserUnix.fromMap((map['unix'] as Map).cast<String, dynamic>()),
