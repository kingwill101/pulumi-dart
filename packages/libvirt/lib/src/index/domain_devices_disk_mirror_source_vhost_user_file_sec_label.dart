...
class DomainDevicesDiskMirrorSourceVhostUserFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceVhostUserFileSecLabel].
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserFileSecLabel(
