...
class PoolArgs {
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      availableUnit: map['availableUnit'] == null ? null : map['availableUnit'] as String,
      capacityUnit: map['capacityUnit'] == null ? null : map['capacityUnit'] as String,
      features: map['features'] == null ? null : PoolFeatures.fromMap((map['features'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      refresh: map['refresh'] == null ? null : PoolRefresh.fromMap((map['refresh'] as Map).cast<String, dynamic>()),
      source: map['source'] == null ? null : PoolSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
      target: map['target'] == null ? null : PoolTarget.fromMap((map['target'] as Map).cast<String, dynamic>()),
