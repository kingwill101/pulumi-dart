...
class DomainDevicesTpmBackendExternalSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesTpmBackendExternalSourceFileSecLabel].
  ...
  factory DomainDevicesTpmBackendExternalSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendExternalSourceFileSecLabel(
