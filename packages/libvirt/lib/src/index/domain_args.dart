...
class DomainArgs {
  ...
  DomainArgs({
    bool? autostart,
    DomainBlockIoTune? blockIoTune,
    String? bootloader,
    String? bootloaderArgs,
    DomainClock? clock,
    DomainCpu? cpu,
    DomainCpuTune? cpuTune,
    DomainCreate? create,
    double? currentMemory,
    String? currentMemoryUnit,
    DomainDefaultIoThread? defaultIoThread,
    String? description,
    DomainDestroy? destroy,
    DomainDevices? devices,
    DomainFeatures? features,
    String? genId,
    String? hwuuid,
    DomainIdMap? idMap,
    DomainIoThreadIDs? ioThreadIDs,
    double? ioThreads,
    DomainKeyWrap? keyWrap,
    DomainLaunchSecurity? launchSecurity,
    double? maximumMemory,
    double? maximumMemorySlots,
    String? maximumMemoryUnit,
    double? memory,
    DomainMemoryBacking? memoryBacking,
    String? memoryDumpCore,
    DomainMemoryTune? memoryTune,
    String? memoryUnit,
    DomainMetadata? metadata,
    String? name,
    DomainNumaTune? numaTune,
    String? onCrash,
    String? onPoweroff,
    String? onReboot,
    DomainOs? os,
    ...
    bool? running,
    List<DomainSecLabel>? secLabels,
    List<DomainSysInfo>? sysInfos,
    DomainThrottleGroups? throttleGroups,
    String? title,
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      blockIoTune: map['blockIoTune'] == null ? null : DomainBlockIoTune.fromMap((map['blockIoTune'] as Map).cast<String, dynamic>()),
      bootloader: map['bootloader'] == null ? null : map['bootloader'] as String,
      bootloaderArgs: map['bootloaderArgs'] == null ? null : map['bootloaderArgs'] as String,
      clock: map['clock'] == null ? null : DomainClock.fromMap((map['clock'] as Map).cast<String, dynamic>()),
      cpu: map['cpu'] == null ? null : DomainCpu.fromMap((map['cpu'] as Map).cast<String, dynamic>()),
      cpuTune: map['cpuTune'] == null ? null : DomainCpuTune.fromMap((map['cpuTune'] as Map).cast<String, dynamic>()),
      create: map['create'] == null ? null : DomainCreate.fromMap((map['create'] as Map).cast<String, dynamic>()),
      currentMemory: map['currentMemory'] == null ? null : map['currentMemory'] as double,
      currentMemoryUnit: map['currentMemoryUnit'] == null ? null : map['currentMemoryUnit'] as String,
      defaultIoThread: map['defaultIoThread'] == null ? null : DomainDefaultIoThread.fromMap((map['defaultIoThread'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      destroy: map['destroy'] == null ? null : DomainDestroy.fromMap((map['destroy'] as Map).cast<String, dynamic>()),
      devices: map['devices'] == null ? null : DomainDevices.fromMap((map['devices'] as Map).cast<String, dynamic>()),
      features: map['features'] == null ? null : DomainFeatures.fromMap((map['features'] as Map).cast<String, dynamic>()),
      genId: map['genId'] == null ? null : map['genId'] as String,
      hwuuid: map['hwuuid'] == null ? null : map['hwuuid'] as String,
      idMap: map['idMap'] == null ? null : DomainIdMap.fromMap((map['idMap'] as Map).cast<String, dynamic>()),
      ioThreadIDs: map['ioThreadIDs'] == null ? null : DomainIoThreadIDs.fromMap((map['ioThreadIDs'] as Map).cast<String, dynamic>()),
      ioThreads: map['ioThreads'] == null ? null : map['ioThreads'] as double,
      keyWrap: map['keyWrap'] == null ? null : DomainKeyWrap.fromMap((map['keyWrap'] as Map).cast<String, dynamic>()),
      launchSecurity: map['launchSecurity'] == null ? null : DomainLaunchSecurity.fromMap((map['launchSecurity'] as Map).cast<String, dynamic>()),
      maximumMemory: map['maximumMemory'] == null ? null : map['maximumMemory'] as double,
      maximumMemorySlots: map['maximumMemorySlots'] == null ? null : map['maximumMemorySlots'] as double,
      maximumMemoryUnit: map['maximumMemoryUnit'] == null ? null : map['maximumMemoryUnit'] as String,
      memory: map['memory'] == null ? null : map['memory'] as double,
      memoryBacking: map['memoryBacking'] == null ? null : DomainMemoryBacking.fromMap((map['memoryBacking'] as Map).cast<String, dynamic>()),
      memoryDumpCore: map['memoryDumpCore'] == null ? null : map['memoryDumpCore'] as String,
      memoryTune: map['memoryTune'] == null ? null : DomainMemoryTune.fromMap((map['memoryTune'] as Map).cast<String, dynamic>()),
      memoryUnit: map['memoryUnit'] == null ? null : map['memoryUnit'] as String,
      metadata: map['metadata'] == null ? null : DomainMetadata.fromMap((map['metadata'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      numaTune: map['numaTune'] == null ? null : DomainNumaTune.fromMap((map['numaTune'] as Map).cast<String, dynamic>()),
      onCrash: map['onCrash'] == null ? null : map['onCrash'] as String,
      onPoweroff: map['onPoweroff'] == null ? null : map['onPoweroff'] as String,
      onReboot: map['onReboot'] == null ? null : map['onReboot'] as String,
      os: map['os'] == null ? null : DomainOs.fromMap((map['os'] as Map).cast<String, dynamic>()),
      perf: map['perf'] == null ? null : DomainPerf.fromMap((map['perf'] as Map).cast<String, dynamic>()),
      pm: map['pm'] == null ? null : DomainPm.fromMap((map['pm'] as Map).cast<String, dynamic>()),
      resource: map['resource'] == null ? null : DomainResource.fromMap((map['resource'] as Map).cast<String, dynamic>()),
      running: map['running'] == null ? null : map['running'] as bool,
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainSecLabel>(map['secLabels'], (value) => DomainSecLabel.fromMap((value as Map).cast<String, dynamic>())),
      sysInfos: map['sysInfos'] == null ? null : pulumi.Input.decodeList<DomainSysInfo>(map['sysInfos'], (value) => DomainSysInfo.fromMap((value as Map).cast<String, dynamic>())),
      throttleGroups: map['throttleGroups'] == null ? null : DomainThrottleGroups.fromMap((map['throttleGroups'] as Map).cast<String, dynamic>()),
      title: map['title'] == null ? null : map['title'] as String,
      type: map['type'] as String,
      vcpu: map['vcpu'] == null ? null : map['vcpu'] as double,
      vcpuCpuset: map['vcpuCpuset'] == null ? null : map['vcpuCpuset'] as String,
      vcpuCurrent: map['vcpuCurrent'] == null ? null : map['vcpuCurrent'] as double,
      vcpuPlacement: map['vcpuPlacement'] == null ? null : map['vcpuPlacement'] as String,
      vcpus: map['vcpus'] == null ? null : DomainVcpus.fromMap((map['vcpus'] as Map).cast<String, dynamic>()),
    );
  }
}
