...
class DomainSysInfoSmbiosSystem {
  ...
  final List<DomainSysInfoSmbiosSystemEntry>? entries;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entries': ?entries == null ? null : pulumi.Input.encodeList<DomainSysInfoSmbiosSystemEntry, Map<String, dynamic>>(entries!, (value) => value.toMap()),
    };
  }

  factory DomainSysInfoSmbiosSystem.fromMap(Map<String, dynamic> map) {
    return DomainSysInfoSmbiosSystem(
      entries: map['entries'] == null ? null : pulumi.Input.decodeList<DomainSysInfoSmbiosSystemEntry>(map['entries'], (value) => DomainSysInfoSmbiosSystemEntry.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
