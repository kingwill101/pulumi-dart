...
class DomainDevicesDiskMirrorSourceVhostUserTcp {
  ...
  final DomainDevicesDiskMirrorSourceVhostUserTcpReconnect? reconnect;
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesDiskMirrorSourceVhostUserTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
