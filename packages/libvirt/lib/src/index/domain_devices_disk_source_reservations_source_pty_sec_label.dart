...
class DomainDevicesDiskSourceReservationsSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceReservationsSourcePtySecLabel].
  ...
  factory DomainDevicesDiskSourceReservationsSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourcePtySecLabel(
