...
class DomainCpuNumaCellDistances {
  ...
  final List<DomainCpuNumaCellDistancesSibling>? siblings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'siblings': ?siblings == null ? null : pulumi.Input.encodeList<DomainCpuNumaCellDistancesSibling, Map<String, dynamic>>(siblings!, (value) => value.toMap()),
    };
  }

  factory DomainCpuNumaCellDistances.fromMap(Map<String, dynamic> map) {
    return DomainCpuNumaCellDistances(
      siblings: map['siblings'] == null ? null : pulumi.Input.decodeList<DomainCpuNumaCellDistancesSibling>(map['siblings'], (value) => DomainCpuNumaCellDistancesSibling.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
