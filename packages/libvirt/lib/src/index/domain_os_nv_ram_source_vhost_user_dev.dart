...
class DomainOsNvRamSourceVhostUserDev {
  ...
  final List<DomainOsNvRamSourceVhostUserDevSecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainOsNvRamSourceVhostUserDevSecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainOsNvRamSourceVhostUserDev.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserDev(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainOsNvRamSourceVhostUserDevSecLabel>(map['secLabels'], (value) => DomainOsNvRamSourceVhostUserDevSecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
