...
class DomainDevicesDiskBackingStoreSourceVolumeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVolumeSecLabel].
  ...
  factory DomainDevicesDiskBackingStoreSourceVolumeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVolumeSecLabel(
