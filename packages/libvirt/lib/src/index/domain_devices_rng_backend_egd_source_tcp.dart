...
class DomainDevicesRngBackendEgdSourceTcp {
  ...
  final DomainDevicesRngBackendEgdSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesRngBackendEgdSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackendEgdSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesRngBackendEgdSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
