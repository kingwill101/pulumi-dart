...
class DomainDevicesDiskBackingStoreSourceReservationsSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceReservationsSourceDevSecLabel].
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourceDevSecLabel(
