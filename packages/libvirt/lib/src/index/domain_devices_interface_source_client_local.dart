...
class DomainDevicesInterfaceSourceClientLocal {
  ...
  /// Creates a new [DomainDevicesInterfaceSourceClientLocal].
  ...
  factory DomainDevicesInterfaceSourceClientLocal.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceClientLocal(
