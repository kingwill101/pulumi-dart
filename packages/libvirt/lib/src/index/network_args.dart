...
class NetworkArgs {
  ...
  NetworkArgs({
    ...
    NetworkMtu? mtu,
    String? name,
    List<NetworkPortGroup>? portGroups,
    NetworkPortOptions? portOptions,
    List<NetworkRoute>? routes,
    String? trustGuestRxFilters,
    NetworkVirtualPort? virtualPort,
    NetworkVlan? vlan,
  }) :
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      ...
      bandwidth: map['bandwidth'] == null ? null : NetworkBandwidth.fromMap((map['bandwidth'] as Map).cast<String, dynamic>()),
      bridge: map['bridge'] == null ? null : NetworkBridge.fromMap((map['bridge'] as Map).cast<String, dynamic>()),
      dns: map['dns'] == null ? null : NetworkDns.fromMap((map['dns'] as Map).cast<String, dynamic>()),
      domain: map['domain'] == null ? null : NetworkDomain.fromMap((map['domain'] as Map).cast<String, dynamic>()),
      forward: map['forward'] == null ? null : NetworkForward.fromMap((map['forward'] as Map).cast<String, dynamic>()),
      ips: map['ips'] == null ? null : pulumi.Input.decodeList<NetworkIp>(map['ips'], (value) => NetworkIp.fromMap((value as Map).cast<String, dynamic>())),
      ipv6: map['ipv6'] == null ? null : map['ipv6'] as String,
      mac: map['mac'] == null ? null : NetworkMac.fromMap((map['mac'] as Map).cast<String, dynamic>()),
      metadata: map['metadata'] == null ? null : NetworkMetadata.fromMap((map['metadata'] as Map).cast<String, dynamic>()),
      mtu: map['mtu'] == null ? null : NetworkMtu.fromMap((map['mtu'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      portGroups: map['portGroups'] == null ? null : pulumi.Input.decodeList<NetworkPortGroup>(map['portGroups'], (value) => NetworkPortGroup.fromMap((value as Map).cast<String, dynamic>())),
      portOptions: map['portOptions'] == null ? null : NetworkPortOptions.fromMap((map['portOptions'] as Map).cast<String, dynamic>()),
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<NetworkRoute>(map['routes'], (value) => NetworkRoute.fromMap((value as Map).cast<String, dynamic>())),
      trustGuestRxFilters: map['trustGuestRxFilters'] == null ? null : map['trustGuestRxFilters'] as String,
      virtualPort: map['virtualPort'] == null ? null : NetworkVirtualPort.fromMap((map['virtualPort'] as Map).cast<String, dynamic>()),
      vlan: map['vlan'] == null ? null : NetworkVlan.fromMap((map['vlan'] as Map).cast<String, dynamic>()),
    );
  }
}
