...
class DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnixSecLabel].
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnixSecLabel(
