...
class DomainDevicesDiskSourceVhostUserPipeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceVhostUserPipeSecLabel].
  ...
  factory DomainDevicesDiskSourceVhostUserPipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVhostUserPipeSecLabel(
