...
class DomainDevicesDiskSourceReservationsSourceTcp {
  ...
  final DomainDevicesDiskSourceReservationsSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesDiskSourceReservationsSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesDiskSourceReservationsSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
