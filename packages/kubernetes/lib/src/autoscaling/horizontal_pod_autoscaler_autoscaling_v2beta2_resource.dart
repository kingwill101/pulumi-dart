...
class HorizontalPodAutoscalerAutoscalingV2beta2Resource extends pulumi.CustomResource {
  ...
  HorizontalPodAutoscalerAutoscalingV2beta2Resource(
    ...
    this.spec = registerOutput<HorizontalPodAutoscalerSpecAutoscalingV2beta2>('spec');
    this.status = registerOutput<HorizontalPodAutoscalerStatusAutoscalingV2beta2?>('status');
  }
}
