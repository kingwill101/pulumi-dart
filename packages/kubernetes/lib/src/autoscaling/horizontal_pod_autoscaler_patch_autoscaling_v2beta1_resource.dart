...
class HorizontalPodAutoscalerPatchAutoscalingV2beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<HorizontalPodAutoscalerSpecPatchAutoscalingV2beta1?> spec;
  /// status is the current information about the autoscaler.
  late final pulumi.Output<HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1?> status;
  ...
  HorizontalPodAutoscalerPatchAutoscalingV2beta1Resource(
    ...
    this.spec = registerOutput<HorizontalPodAutoscalerSpecPatchAutoscalingV2beta1?>('spec');
    this.status = registerOutput<HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1?>('status');
  }
}
