...
class HorizontalPodAutoscalerListAutoscalingV2beta1 {
  ...
  final List<HorizontalPodAutoscalerAutoscalingV2beta1> items;
  ...
  HorizontalPodAutoscalerListAutoscalingV2beta1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<HorizontalPodAutoscalerAutoscalingV2beta1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory HorizontalPodAutoscalerListAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerListAutoscalingV2beta1(
      ...
      items: pulumi.Input.decodeList<HorizontalPodAutoscalerAutoscalingV2beta1>(map['items'], (value) => HorizontalPodAutoscalerAutoscalingV2beta1.fromMap((value as Map).cast<String, dynamic>())),
