...
class HorizontalPodAutoscalerSpecAutoscalingV2beta1 {
  ...
  final List<MetricSpecAutoscalingV2beta1>? metrics;
  /// minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down.  It defaults to 1 pod.  minReplicas is allowed to be 0 if the alpha feature gate HPAScaleToZero is enabled and at least one Object or External metric is configured.  Scaling is active as long as at least one metric value is available.
  final int? minReplicas;
  /// scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.
  final CrossVersionObjectReferenceAutoscalingV2beta1 scaleTargetRef;
  ...
  HorizontalPodAutoscalerSpecAutoscalingV2beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics': ?metrics == null ? null : pulumi.Input.encodeList<MetricSpecAutoscalingV2beta1, Map<String, dynamic>>(metrics!, (value) => value.toMap()),
  ...
  factory HorizontalPodAutoscalerSpecAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerSpecAutoscalingV2beta1(
      ...
      metrics: map['metrics'] == null ? null : pulumi.Input.decodeList<MetricSpecAutoscalingV2beta1>(map['metrics'], (value) => MetricSpecAutoscalingV2beta1.fromMap((value as Map).cast<String, dynamic>())),
      minReplicas: map['minReplicas'] == null ? null : map['minReplicas'] as int,
      scaleTargetRef: CrossVersionObjectReferenceAutoscalingV2beta1.fromMap((map['scaleTargetRef'] as Map).cast<String, dynamic>()),
    );
  }
}
