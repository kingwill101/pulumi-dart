...
import 'hpascaling_policy_patch_autoscaling_v2beta2.dart';
...
class HPAScalingRulesPatchAutoscalingV2beta2 {
  ...
  final List<HPAScalingPolicyPatchAutoscalingV2beta2>? policies;
  ...
  /// Creates a new [HPAScalingRulesPatchAutoscalingV2beta2].
  ...
  HPAScalingRulesPatchAutoscalingV2beta2({
    this.policies,
    this.selectPolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'policies': ?policies == null ? null : pulumi.Input.encodeList<HPAScalingPolicyPatchAutoscalingV2beta2, Map<String, dynamic>>(policies!, (value) => value.toMap()),
  ...
  factory HPAScalingRulesPatchAutoscalingV2beta2.fromMap(Map<String, dynamic> map) {
    return HPAScalingRulesPatchAutoscalingV2beta2(
      policies: map['policies'] == null ? null : pulumi.Input.decodeList<HPAScalingPolicyPatchAutoscalingV2beta2>(map['policies'], (value) => HPAScalingPolicyPatchAutoscalingV2beta2.fromMap((value as Map).cast<String, dynamic>())),
