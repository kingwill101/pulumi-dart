...
class HPAScalingRules {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'policies': ?policies == null ? null : pulumi.Input.encodeList<HPAScalingPolicy, Map<String, dynamic>>(policies!, (value) => value.toMap()),
  ...
  factory HPAScalingRules.fromMap(Map<String, dynamic> map) {
    return HPAScalingRules(
      policies: map['policies'] == null ? null : pulumi.Input.decodeList<HPAScalingPolicy>(map['policies'], (value) => HPAScalingPolicy.fromMap((value as Map).cast<String, dynamic>())),
