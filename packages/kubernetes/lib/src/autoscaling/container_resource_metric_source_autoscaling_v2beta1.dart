...
class ContainerResourceMetricSourceAutoscalingV2beta1 {
  ...
  factory ContainerResourceMetricSourceAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return ContainerResourceMetricSourceAutoscalingV2beta1(
      container: map['container'] as String,
      name: map['name'] as String,
      targetAverageUtilization: map['targetAverageUtilization'] == null ? null : map['targetAverageUtilization'] as int,
