...
class ClusterTrustBundleListCertificatesK8sIoV1beta1 {
  ...
  final List<ClusterTrustBundleCertificatesK8sIoV1beta1> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<ClusterTrustBundleCertificatesK8sIoV1beta1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory ClusterTrustBundleListCertificatesK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundleListCertificatesK8sIoV1beta1(
      ...
      items: pulumi.Input.decodeList<ClusterTrustBundleCertificatesK8sIoV1beta1>(map['items'], (value) => ClusterTrustBundleCertificatesK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
