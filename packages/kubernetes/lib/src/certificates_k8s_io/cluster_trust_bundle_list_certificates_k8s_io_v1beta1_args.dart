...
class ClusterTrustBundleListCertificatesK8sIoV1beta1Args {
  ...
  ClusterTrustBundleListCertificatesK8sIoV1beta1Args({
    String? apiVersion,
    required List<ClusterTrustBundleResource> items,
    String? kind,
    ListMeta? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ClusterTrustBundleResource>>(items),
  ...
  factory ClusterTrustBundleListCertificatesK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundleListCertificatesK8sIoV1beta1Args(
      ...
      items: (map['items'] as List).cast<ClusterTrustBundleResource>(),
