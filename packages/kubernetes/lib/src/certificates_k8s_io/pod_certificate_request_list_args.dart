...
/// {@template pulumi_certificates_k8s_io_v1beta1_pod_certificate_request_list_args_doc}
/// The set of arguments for PodCertificateRequestList.
/// {@endtemplate}
/// {@macro pulumi_certificates_k8s_io_v1beta1_pod_certificate_request_list_args_doc}
class PodCertificateRequestListArgs {
  ...
  /// Creates a new [PodCertificateRequestListArgs].
  ...
  PodCertificateRequestListArgs({
    String? apiVersion,
    required List<PodCertificateRequestCertificatesK8sIoV1beta1> items,
    String? kind,
    ListMeta? metadata,
  }) :
  ...
  factory PodCertificateRequestListArgs.fromMap(Map<String, dynamic> map) {
    return PodCertificateRequestListArgs(
      ...
      items: (map['items'] as List).cast<PodCertificateRequestCertificatesK8sIoV1beta1>(),
