...
class CertificateSigningRequestPatchCertificatesK8sIoV1beta1Args {
  ...
  CertificateSigningRequestPatchCertificatesK8sIoV1beta1Args({
    ...
    CertificateSigningRequestSpecPatchCertificatesK8sIoV1beta1? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<CertificateSigningRequestSpecPatchCertificatesK8sIoV1beta1>(spec);
  ...
  factory CertificateSigningRequestPatchCertificatesK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
