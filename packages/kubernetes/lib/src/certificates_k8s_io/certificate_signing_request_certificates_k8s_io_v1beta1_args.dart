...
class CertificateSigningRequestCertificatesK8sIoV1beta1Args {
  ...
  CertificateSigningRequestCertificatesK8sIoV1beta1Args({
    ...
    String? kind,
    ObjectMeta? metadata,
    CertificateSigningRequestSpecCertificatesK8sIoV1beta1? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<CertificateSigningRequestSpecCertificatesK8sIoV1beta1>(spec);
