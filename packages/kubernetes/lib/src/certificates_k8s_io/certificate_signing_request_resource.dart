...
class CertificateSigningRequestResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CertificateSigningRequestSpecCertificatesK8sIoV1beta1> spec;
  /// Derived information about the request.
  late final pulumi.Output<CertificateSigningRequestStatusCertificatesK8sIoV1beta1?> status;
  ...
  CertificateSigningRequestResource(
    ...
    this.spec = registerOutput<CertificateSigningRequestSpecCertificatesK8sIoV1beta1>('spec');
    this.status = registerOutput<CertificateSigningRequestStatusCertificatesK8sIoV1beta1?>('status');
  }
}
