...
class CustomResourceDefinitionApiextensionsK8sIoV1beta1Args {
  ...
  CustomResourceDefinitionApiextensionsK8sIoV1beta1Args({
    ...
    String? kind,
    ObjectMeta? metadata,
    required CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1 spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1>(spec);
