...
/// {@template pulumi_apiextensions_k8s_io_v1_custom_resource_definition_patch_args_doc}
/// The set of arguments for CustomResourceDefinitionPatch.
/// {@endtemplate}
/// {@macro pulumi_apiextensions_k8s_io_v1_custom_resource_definition_patch_args_doc}
class CustomResourceDefinitionPatchArgs {
  ...
  /// Creates a new [CustomResourceDefinitionPatchArgs].
  ...
  CustomResourceDefinitionPatchArgs({
    ...
    CustomResourceDefinitionSpecPatch? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<CustomResourceDefinitionSpecPatch>(spec);
  ...
  factory CustomResourceDefinitionPatchArgs.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionPatchArgs(
