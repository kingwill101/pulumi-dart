...
class CustomResourceDefinitionResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1> spec;
  /// status indicates the actual state of the CustomResourceDefinition
  late final pulumi.Output<CustomResourceDefinitionStatusApiextensionsK8sIoV1beta1?> status;
  ...
  CustomResourceDefinitionResource(
    ...
    this.spec = registerOutput<CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1>('spec');
    this.status = registerOutput<CustomResourceDefinitionStatusApiextensionsK8sIoV1beta1?>('status');
  }
}
