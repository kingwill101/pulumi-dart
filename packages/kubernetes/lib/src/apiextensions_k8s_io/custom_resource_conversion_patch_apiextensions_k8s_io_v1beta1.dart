...
class CustomResourceConversionPatchApiextensionsK8sIoV1beta1 {
  ...
  final WebhookClientConfigPatchApiextensionsK8sIoV1beta1? webhookClientConfig;
  ...
  factory CustomResourceConversionPatchApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceConversionPatchApiextensionsK8sIoV1beta1(
      ...
      webhookClientConfig: map['webhookClientConfig'] == null ? null : WebhookClientConfigPatchApiextensionsK8sIoV1beta1.fromMap((map['webhookClientConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
