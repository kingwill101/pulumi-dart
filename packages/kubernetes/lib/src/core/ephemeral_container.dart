...
class EphemeralContainer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resizePolicy': ?resizePolicy == null ? null : pulumi.Input.encodeList<ContainerResizePolicy, Map<String, dynamic>>(resizePolicy!, (value) => value.toMap()),
      'resources': ?resources == null ? null : resources!.toMap(),
      'restartPolicy': ?restartPolicy,
      'restartPolicyRules': ?restartPolicyRules == null ? null : pulumi.Input.encodeList<ContainerRestartRule, Map<String, dynamic>>(restartPolicyRules!, (value) => value.toMap()),
      ...
      'tty': ?tty,
      'volumeDevices': ?volumeDevices == null ? null : pulumi.Input.encodeList<VolumeDevice, Map<String, dynamic>>(volumeDevices!, (value) => value.toMap()),
  ...
  factory EphemeralContainer.fromMap(Map<String, dynamic> map) {
    return EphemeralContainer(
      ...
      lifecycle: map['lifecycle'] == null ? null : Lifecycle.fromMap((map['lifecycle'] as Map).cast<String, dynamic>()),
      ...
      resizePolicy: map['resizePolicy'] == null ? null : pulumi.Input.decodeList<ContainerResizePolicy>(map['resizePolicy'], (value) => ContainerResizePolicy.fromMap((value as Map).cast<String, dynamic>())),
      ...
      restartPolicyRules: map['restartPolicyRules'] == null ? null : pulumi.Input.decodeList<ContainerRestartRule>(map['restartPolicyRules'], (value) => ContainerRestartRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      volumeDevices: map['volumeDevices'] == null ? null : pulumi.Input.decodeList<VolumeDevice>(map['volumeDevices'], (value) => VolumeDevice.fromMap((value as Map).cast<String, dynamic>())),
