...
class LifecyclePatch {
  ...
  final LifecycleHandlerPatch? postStart;
  ...
  final LifecycleHandlerPatch? preStop;
  ...
  factory LifecyclePatch.fromMap(Map<String, dynamic> map) {
    return LifecyclePatch(
      postStart: map['postStart'] == null ? null : LifecycleHandlerPatch.fromMap((map['postStart'] as Map).cast<String, dynamic>()),
      preStop: map['preStop'] == null ? null : LifecycleHandlerPatch.fromMap((map['preStop'] as Map).cast<String, dynamic>()),
