...
class PersistentVolumeClaim {
  ...
  factory PersistentVolumeClaim.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeClaim(
      ...
      spec: map['spec'] == null ? null : PersistentVolumeClaimSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : PersistentVolumeClaimStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
