...
class PodSpecPatch {
  ...
  final List<EphemeralContainerPatch>? ephemeralContainers;
  /// HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified.
  final List<HostAliasPatch>? hostAliases;
  ...
  final List<ContainerPatch>? initContainers;
  ...
  final List<PodReadinessGatePatch>? readinessGates;
  /// ResourceClaims defines which ResourceClaims must be allocated and reserved before the Pod is allowed to start. The resources will be made available to those containers which consume them by name.
  ///
  /// This is a stable field but requires that the DynamicResourceAllocation feature gate is enabled.
  ///
  /// This field is immutable.
  final List<PodResourceClaimPatch>? resourceClaims;
  ...
  final List<PodSchedulingGatePatch>? schedulingGates;
  /// SecurityContext holds pod-level security attributes and common container settings. Optional: Defaults to empty.  See type description for default values of each field.
  final PodSecurityContextPatch? securityContext;
  ...
  final List<TopologySpreadConstraintPatch>? topologySpreadConstraints;
  ...
  final WorkloadReferencePatch? workloadRef;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': ?containers == null ? null : pulumi.Input.encodeList<ContainerPatch, Map<String, dynamic>>(containers!, (value) => value.toMap()),
      'dnsConfig': ?dnsConfig == null ? null : dnsConfig!.toMap(),
      'dnsPolicy': ?dnsPolicy,
      'enableServiceLinks': ?enableServiceLinks,
      'ephemeralContainers': ?ephemeralContainers == null ? null : pulumi.Input.encodeList<EphemeralContainerPatch, Map<String, dynamic>>(ephemeralContainers!, (value) => value.toMap()),
      'hostAliases': ?hostAliases == null ? null : pulumi.Input.encodeList<HostAliasPatch, Map<String, dynamic>>(hostAliases!, (value) => value.toMap()),
      'hostIPC': ?hostIPC,
      ...
      'initContainers': ?initContainers == null ? null : pulumi.Input.encodeList<ContainerPatch, Map<String, dynamic>>(initContainers!, (value) => value.toMap()),
      'nodeName': ?nodeName,
      ...
      'readinessGates': ?readinessGates == null ? null : pulumi.Input.encodeList<PodReadinessGatePatch, Map<String, dynamic>>(readinessGates!, (value) => value.toMap()),
      'resourceClaims': ?resourceClaims == null ? null : pulumi.Input.encodeList<PodResourceClaimPatch, Map<String, dynamic>>(resourceClaims!, (value) => value.toMap()),
      'resources': ?resources == null ? null : resources!.toMap(),
      'restartPolicy': ?restartPolicy,
      'runtimeClassName': ?runtimeClassName,
      'schedulerName': ?schedulerName,
      'schedulingGates': ?schedulingGates == null ? null : pulumi.Input.encodeList<PodSchedulingGatePatch, Map<String, dynamic>>(schedulingGates!, (value) => value.toMap()),
      ...
      'topologySpreadConstraints': ?topologySpreadConstraints == null ? null : pulumi.Input.encodeList<TopologySpreadConstraintPatch, Map<String, dynamic>>(topologySpreadConstraints!, (value) => value.toMap()),
  ...
  factory PodSpecPatch.fromMap(Map<String, dynamic> map) {
    return PodSpecPatch(
      ...
      affinity: map['affinity'] == null ? null : AffinityPatch.fromMap((map['affinity'] as Map).cast<String, dynamic>()),
      automountServiceAccountToken: map['automountServiceAccountToken'] == null ? null : map['automountServiceAccountToken'] as bool,
      containers: map['containers'] == null ? null : pulumi.Input.decodeList<ContainerPatch>(map['containers'], (value) => ContainerPatch.fromMap((value as Map).cast<String, dynamic>())),
      dnsConfig: map['dnsConfig'] == null ? null : PodDNSConfigPatch.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      ...
      ephemeralContainers: map['ephemeralContainers'] == null ? null : pulumi.Input.decodeList<EphemeralContainerPatch>(map['ephemeralContainers'], (value) => EphemeralContainerPatch.fromMap((value as Map).cast<String, dynamic>())),
      hostAliases: map['hostAliases'] == null ? null : pulumi.Input.decodeList<HostAliasPatch>(map['hostAliases'], (value) => HostAliasPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      initContainers: map['initContainers'] == null ? null : pulumi.Input.decodeList<ContainerPatch>(map['initContainers'], (value) => ContainerPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      os: map['os'] == null ? null : PodOSPatch.fromMap((map['os'] as Map).cast<String, dynamic>()),
      ...
      readinessGates: map['readinessGates'] == null ? null : pulumi.Input.decodeList<PodReadinessGatePatch>(map['readinessGates'], (value) => PodReadinessGatePatch.fromMap((value as Map).cast<String, dynamic>())),
      resourceClaims: map['resourceClaims'] == null ? null : pulumi.Input.decodeList<PodResourceClaimPatch>(map['resourceClaims'], (value) => PodResourceClaimPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      schedulingGates: map['schedulingGates'] == null ? null : pulumi.Input.decodeList<PodSchedulingGatePatch>(map['schedulingGates'], (value) => PodSchedulingGatePatch.fromMap((value as Map).cast<String, dynamic>())),
      securityContext: map['securityContext'] == null ? null : PodSecurityContextPatch.fromMap((map['securityContext'] as Map).cast<String, dynamic>()),
      ...
      topologySpreadConstraints: map['topologySpreadConstraints'] == null ? null : pulumi.Input.decodeList<TopologySpreadConstraintPatch>(map['topologySpreadConstraints'], (value) => TopologySpreadConstraintPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      workloadRef: map['workloadRef'] == null ? null : WorkloadReferencePatch.fromMap((map['workloadRef'] as Map).cast<String, dynamic>()),
    );
  }
}
