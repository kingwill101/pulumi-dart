...
class ResourceQuotaPatch {
  ...
  final ResourceQuotaSpecPatch? spec;
  /// Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final ResourceQuotaStatusPatch? status;
  ...
  factory ResourceQuotaPatch.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaPatch(
      ...
      spec: map['spec'] == null ? null : ResourceQuotaSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : ResourceQuotaStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
