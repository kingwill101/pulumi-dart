...
class ServicePatch {
  ...
  final ServiceSpecPatch? spec;
  /// Most recently observed status of the service. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final ServiceStatusPatch? status;
  ...
  factory ServicePatch.fromMap(Map<String, dynamic> map) {
    return ServicePatch(
      ...
      status: map['status'] == null ? null : ServiceStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
