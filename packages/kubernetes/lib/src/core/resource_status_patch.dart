...
class ResourceStatusPatch {
  ...
  final List<ResourceHealthPatch>? resources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': ?name,
      'resources': ?resources == null ? null : pulumi.Input.encodeList<ResourceHealthPatch, Map<String, dynamic>>(resources!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceStatusPatch.fromMap(Map<String, dynamic> map) {
    return ResourceStatusPatch(
      ...
      resources: map['resources'] == null ? null : pulumi.Input.decodeList<ResourceHealthPatch>(map['resources'], (value) => ResourceHealthPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
