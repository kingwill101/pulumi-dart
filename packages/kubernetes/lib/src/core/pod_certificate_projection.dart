...
class PodCertificateProjection {
  ...
  /// Creates a new [PodCertificateProjection].
  ...
  factory PodCertificateProjection.fromMap(Map<String, dynamic> map) {
    return PodCertificateProjection(
      certificateChainPath: map['certificateChainPath'] == null ? null : map['certificateChainPath'] as String,
      credentialBundlePath: map['credentialBundlePath'] == null ? null : map['credentialBundlePath'] as String,
      ...
      userAnnotations: map['userAnnotations'] == null ? null : (map['userAnnotations'] as Map).cast<String, String>(),
    );
  }
}
