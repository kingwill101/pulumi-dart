...
import 'container_state_patch.dart';
import 'container_user_patch.dart';
import 'resource_requirements_patch.dart';
import 'resource_status_patch.dart';
import 'volume_mount_status_patch.dart';
...
class ContainerStatusPatch {
  ...
  final List<ResourceStatusPatch>? allocatedResourcesStatus;
  ...
  final ContainerStatePatch? lastState;
  ...
  final ContainerStatePatch? state;
  /// StopSignal reports the effective stop signal for this container
  final String? stopSignal;
  /// User represents user identity information initially attached to the first process of the container
  final ContainerUserPatch? user;
  /// Status of volume mounts.
  final List<VolumeMountStatusPatch>? volumeMounts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allocatedResourcesStatus': ?allocatedResourcesStatus == null ? null : pulumi.Input.encodeList<ResourceStatusPatch, Map<String, dynamic>>(allocatedResourcesStatus!, (value) => value.toMap()),
      ...
      'volumeMounts': ?volumeMounts == null ? null : pulumi.Input.encodeList<VolumeMountStatusPatch, Map<String, dynamic>>(volumeMounts!, (value) => value.toMap()),
    };
  }
  ...
  factory ContainerStatusPatch.fromMap(Map<String, dynamic> map) {
    return ContainerStatusPatch(
      ...
      allocatedResourcesStatus: map['allocatedResourcesStatus'] == null ? null : pulumi.Input.decodeList<ResourceStatusPatch>(map['allocatedResourcesStatus'], (value) => ResourceStatusPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      lastState: map['lastState'] == null ? null : ContainerStatePatch.fromMap((map['lastState'] as Map).cast<String, dynamic>()),
      ...
      state: map['state'] == null ? null : ContainerStatePatch.fromMap((map['state'] as Map).cast<String, dynamic>()),
      stopSignal: map['stopSignal'] == null ? null : map['stopSignal'] as String,
      user: map['user'] == null ? null : ContainerUserPatch.fromMap((map['user'] as Map).cast<String, dynamic>()),
      volumeMounts: map['volumeMounts'] == null ? null : pulumi.Input.decodeList<VolumeMountStatusPatch>(map['volumeMounts'], (value) => VolumeMountStatusPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
