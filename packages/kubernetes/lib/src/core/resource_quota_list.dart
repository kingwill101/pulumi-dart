...
class ResourceQuotaList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<ResourceQuota, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory ResourceQuotaList.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaList(
      ...
      items: pulumi.Input.decodeList<ResourceQuota>(map['items'], (value) => ResourceQuota.fromMap((value as Map).cast<String, dynamic>())),
