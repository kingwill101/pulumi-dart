...
class PersistentVolumeClaimList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<PersistentVolumeClaim, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory PersistentVolumeClaimList.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeClaimList(
      ...
      items: pulumi.Input.decodeList<PersistentVolumeClaim>(map['items'], (value) => PersistentVolumeClaim.fromMap((value as Map).cast<String, dynamic>())),
