...
import 'typed_object_reference_patch.dart';
import 'volume_resource_requirements_patch.dart';

/// PersistentVolumeClaimSpec describes the common attributes of storage devices and allows a Source for provider-specific attributes
class PersistentVolumeClaimSpecPatch {
  ...
  final TypedLocalObjectReferencePatch? dataSource;
  ...
  final TypedObjectReferencePatch? dataSourceRef;
  ...
  final VolumeResourceRequirementsPatch? resources;
  ...
  /// Creates a new [PersistentVolumeClaimSpecPatch].
  ...
  factory PersistentVolumeClaimSpecPatch.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeClaimSpecPatch(
      ...
      dataSource: map['dataSource'] == null ? null : TypedLocalObjectReferencePatch.fromMap((map['dataSource'] as Map).cast<String, dynamic>()),
      dataSourceRef: map['dataSourceRef'] == null ? null : TypedObjectReferencePatch.fromMap((map['dataSourceRef'] as Map).cast<String, dynamic>()),
      resources: map['resources'] == null ? null : VolumeResourceRequirementsPatch.fromMap((map['resources'] as Map).cast<String, dynamic>()),
