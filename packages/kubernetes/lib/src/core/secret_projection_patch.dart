...
class SecretProjectionPatch {
  ...
  final List<KeyToPathPatch>? items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'items': ?items == null ? null : pulumi.Input.encodeList<KeyToPathPatch, Map<String, dynamic>>(items!, (value) => value.toMap()),
      'name': ?name,
      'optional': ?optional,
    };
  }
  ...
  factory SecretProjectionPatch.fromMap(Map<String, dynamic> map) {
    return SecretProjectionPatch(
      items: map['items'] == null ? null : pulumi.Input.decodeList<KeyToPathPatch>(map['items'], (value) => KeyToPathPatch.fromMap((value as Map).cast<String, dynamic>())),
