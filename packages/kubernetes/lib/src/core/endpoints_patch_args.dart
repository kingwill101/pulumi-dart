...
class EndpointsPatchArgs {
  ...
  EndpointsPatchArgs({
    ...
    List<EndpointSubsetPatch>? subsets,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      subsets = pulumi.Input.asOptionalInput<List<EndpointSubsetPatch>>(subsets);
  ...
  factory EndpointsPatchArgs.fromMap(Map<String, dynamic> map) {
    return EndpointsPatchArgs(
      ...
      subsets: map['subsets'] == null ? null : pulumi.Input.decodeList<EndpointSubsetPatch>(map['subsets'], (value) => EndpointSubsetPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
