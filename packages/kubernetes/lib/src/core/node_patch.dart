...
class NodePatch {
  ...
  final NodeSpecPatch? spec;
  /// Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final NodeStatusPatch? status;
  ...
  factory NodePatch.fromMap(Map<String, dynamic> map) {
    return NodePatch(
      ...
      spec: map['spec'] == null ? null : NodeSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : NodeStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
