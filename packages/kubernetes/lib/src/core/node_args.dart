...
/// {@template pulumi_core_v1_node_args_doc}
/// The set of arguments for Node.
/// {@endtemplate}
/// {@macro pulumi_core_v1_node_args_doc}
class NodeArgs {
  ...
  NodeArgs({
    ...
    NodeSpec? spec,
      ...
      spec = pulumi.Input.asOptionalInput<NodeSpec>(spec);
  ...
  factory NodeArgs.fromMap(Map<String, dynamic> map) {
    return NodeArgs(
      ...
      spec: map['spec'] == null ? null : NodeSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
