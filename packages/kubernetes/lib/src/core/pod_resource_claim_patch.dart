...
import 'claim_source_patch.dart';
...
class PodResourceClaimPatch {
  ...
  final ClaimSourcePatch? source;

  /// Creates a new [PodResourceClaimPatch].
  ...
  factory PodResourceClaimPatch.fromMap(Map<String, dynamic> map) {
    return PodResourceClaimPatch(
      ...
      resourceClaimTemplateName: map['resourceClaimTemplateName'] == null ? null : map['resourceClaimTemplateName'] as String,
      source: map['source'] == null ? null : ClaimSourcePatch.fromMap((map['source'] as Map).cast<String, dynamic>()),
    );
  }
}
