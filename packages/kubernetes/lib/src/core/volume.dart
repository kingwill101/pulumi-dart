...
class Volume {
  ...
  factory Volume.fromMap(Map<String, dynamic> map) {
    return Volume(
      ...
      azureFile: map['azureFile'] == null ? null : AzureFileVolumeSource.fromMap((map['azureFile'] as Map).cast<String, dynamic>()),
      cephfs: map['cephfs'] == null ? null : CephFSVolumeSource.fromMap((map['cephfs'] as Map).cast<String, dynamic>()),
      cinder: map['cinder'] == null ? null : CinderVolumeSource.fromMap((map['cinder'] as Map).cast<String, dynamic>()),
      configMap: map['configMap'] == null ? null : ConfigMapVolumeSource.fromMap((map['configMap'] as Map).cast<String, dynamic>()),
      csi: map['csi'] == null ? null : CSIVolumeSource.fromMap((map['csi'] as Map).cast<String, dynamic>()),
      downwardAPI: map['downwardAPI'] == null ? null : DownwardAPIVolumeSource.fromMap((map['downwardAPI'] as Map).cast<String, dynamic>()),
      emptyDir: map['emptyDir'] == null ? null : EmptyDirVolumeSource.fromMap((map['emptyDir'] as Map).cast<String, dynamic>()),
      ephemeral: map['ephemeral'] == null ? null : EphemeralVolumeSource.fromMap((map['ephemeral'] as Map).cast<String, dynamic>()),
      fc: map['fc'] == null ? null : FCVolumeSource.fromMap((map['fc'] as Map).cast<String, dynamic>()),
      flexVolume: map['flexVolume'] == null ? null : FlexVolumeSource.fromMap((map['flexVolume'] as Map).cast<String, dynamic>()),
      ...
      gitRepo: map['gitRepo'] == null ? null : GitRepoVolumeSource.fromMap((map['gitRepo'] as Map).cast<String, dynamic>()),
      glusterfs: map['glusterfs'] == null ? null : GlusterfsVolumeSource.fromMap((map['glusterfs'] as Map).cast<String, dynamic>()),
      hostPath: map['hostPath'] == null ? null : HostPathVolumeSource.fromMap((map['hostPath'] as Map).cast<String, dynamic>()),
      image: map['image'] == null ? null : ImageVolumeSource.fromMap((map['image'] as Map).cast<String, dynamic>()),
      iscsi: map['iscsi'] == null ? null : ISCSIVolumeSource.fromMap((map['iscsi'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      nfs: map['nfs'] == null ? null : NFSVolumeSource.fromMap((map['nfs'] as Map).cast<String, dynamic>()),
      persistentVolumeClaim: map['persistentVolumeClaim'] == null ? null : PersistentVolumeClaimVolumeSource.fromMap((map['persistentVolumeClaim'] as Map).cast<String, dynamic>()),
      ...
      projected: map['projected'] == null ? null : ProjectedVolumeSource.fromMap((map['projected'] as Map).cast<String, dynamic>()),
      quobyte: map['quobyte'] == null ? null : QuobyteVolumeSource.fromMap((map['quobyte'] as Map).cast<String, dynamic>()),
      rbd: map['rbd'] == null ? null : RBDVolumeSource.fromMap((map['rbd'] as Map).cast<String, dynamic>()),
      scaleIO: map['scaleIO'] == null ? null : ScaleIOVolumeSource.fromMap((map['scaleIO'] as Map).cast<String, dynamic>()),
      secret: map['secret'] == null ? null : SecretVolumeSource.fromMap((map['secret'] as Map).cast<String, dynamic>()),
      storageos: map['storageos'] == null ? null : StorageOSVolumeSource.fromMap((map['storageos'] as Map).cast<String, dynamic>()),
