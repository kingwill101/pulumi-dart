...
class RuntimeClassListNodeK8sIoV1alpha1 {
  ...
  final List<RuntimeClassNodeK8sIoV1alpha1> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<RuntimeClassNodeK8sIoV1alpha1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory RuntimeClassListNodeK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RuntimeClassListNodeK8sIoV1alpha1(
      ...
      items: pulumi.Input.decodeList<RuntimeClassNodeK8sIoV1alpha1>(map['items'], (value) => RuntimeClassNodeK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
