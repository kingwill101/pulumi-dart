...
class RuntimeClassNodeK8sIoV1beta1 {
  ...
  final OverheadNodeK8sIoV1beta1? overhead;
  /// Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.
  final SchedulingNodeK8sIoV1beta1? scheduling;

  /// Creates a new [RuntimeClassNodeK8sIoV1beta1].
  ...
  factory RuntimeClassNodeK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return RuntimeClassNodeK8sIoV1beta1(
      apiVersion: map['apiVersion'] == null ? null : map['apiVersion'] as String,
      handler: map['handler'] as String,
      kind: map['kind'] == null ? null : map['kind'] as String,
      metadata: map['metadata'] == null ? null : ObjectMeta.fromMap((map['metadata'] as Map).cast<String, dynamic>()),
      overhead: map['overhead'] == null ? null : OverheadNodeK8sIoV1beta1.fromMap((map['overhead'] as Map).cast<String, dynamic>()),
      scheduling: map['scheduling'] == null ? null : SchedulingNodeK8sIoV1beta1.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
    );
  }
}
