...
import 'service_reference_apiregistration_k8s_io_v1beta1.dart';

/// APIServiceSpec contains information for locating and communicating with a server. Only https is supported, though you are able to disable certificate verification.
class APIServiceSpecApiregistrationK8sIoV1beta1 {
  ...
  final ServiceReferenceApiregistrationK8sIoV1beta1 service;
  ...
  /// Creates a new [APIServiceSpecApiregistrationK8sIoV1beta1].
  ...
  APIServiceSpecApiregistrationK8sIoV1beta1({
    this.caBundle,
    this.group,
  ...
  factory APIServiceSpecApiregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return APIServiceSpecApiregistrationK8sIoV1beta1(
      ...
      groupPriorityMinimum: map['groupPriorityMinimum'] as int,
      insecureSkipTLSVerify: map['insecureSkipTLSVerify'] == null ? null : map['insecureSkipTLSVerify'] as bool,
      service: ServiceReferenceApiregistrationK8sIoV1beta1.fromMap((map['service'] as Map).cast<String, dynamic>()),
      version: map['version'] == null ? null : map['version'] as String,
      versionPriority: map['versionPriority'] as int,
    );
  }
}
