...
class EndpointDiscoveryK8sIoV1beta1 {
  ...
  final EndpointConditionsDiscoveryK8sIoV1beta1? conditions;
  ...
  factory EndpointDiscoveryK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return EndpointDiscoveryK8sIoV1beta1(
      ...
      conditions: map['conditions'] == null ? null : EndpointConditionsDiscoveryK8sIoV1beta1.fromMap((map['conditions'] as Map).cast<String, dynamic>()),
