...
class Endpoint {
  ...
  factory Endpoint.fromMap(Map<String, dynamic> map) {
    return Endpoint(
      ...
      conditions: map['conditions'] == null ? null : EndpointConditions.fromMap((map['conditions'] as Map).cast<String, dynamic>()),
      deprecatedTopology: map['deprecatedTopology'] == null ? null : (map['deprecatedTopology'] as Map).cast<String, String>(),
      hints: map['hints'] == null ? null : EndpointHints.fromMap((map['hints'] as Map).cast<String, dynamic>()),
