...
/// {@template pulumi_events_k8s_io_v1_event_patch_args_doc}
/// The set of arguments for EventPatch.
/// {@endtemplate}
/// {@macro pulumi_events_k8s_io_v1_event_patch_args_doc}
class EventPatchArgs {
  ...
  EventPatchArgs({
    ...
    EventSourcePatch? deprecatedSource,
    String? eventTime,
    String? kind,
    ObjectMetaPatch? metadata,
    String? note,
    String? reason,
    ObjectReferencePatch? regarding,
    ObjectReferencePatch? related,
    String? reportingController,
    String? reportingInstance,
    EventSeriesPatch? series,
    String? type,
  }) :
