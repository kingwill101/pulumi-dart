...
class PodDisruptionBudgetPolicyV1beta1Args {
  ...
  PodDisruptionBudgetPolicyV1beta1Args({
    ...
    String? kind,
    ObjectMeta? metadata,
    PodDisruptionBudgetSpecPolicyV1beta1? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<PodDisruptionBudgetSpecPolicyV1beta1>(spec);
  ...
  factory PodDisruptionBudgetPolicyV1beta1Args.fromMap(Map<String, dynamic> map) {
