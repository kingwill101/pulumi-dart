...
class ValidatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ValidatingWebhookPatch>?> webhooks;
  ...
  ValidatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1(
    ...
    this.webhooks = registerOutput<List<ValidatingWebhookPatch>?>('webhooks');
  }
}
