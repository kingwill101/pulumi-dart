...
class MutatingAdmissionPolicyListArgs {
  ...
  MutatingAdmissionPolicyListArgs({
    String? apiVersion,
    required List<MutatingAdmissionPolicyAdmissionregistrationK8sIoV1alpha1> items,
    String? kind,
    ListMeta? metadata,
  }) :
  ...
  factory MutatingAdmissionPolicyListArgs.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyListArgs(
      ...
      items: (map['items'] as List).cast<MutatingAdmissionPolicyAdmissionregistrationK8sIoV1alpha1>(),
