...
class ValidatingAdmissionPolicyListAdmissionregistrationK8sIoV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1>> items;
  ...
  ValidatingAdmissionPolicyListAdmissionregistrationK8sIoV1(
    ...
    this.items = registerOutput<List<ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1>>('items');
