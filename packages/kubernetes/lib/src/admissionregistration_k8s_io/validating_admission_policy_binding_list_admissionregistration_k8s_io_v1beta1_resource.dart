...
class ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource>> items;
  ...
  ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1Resource(
    ...
    this.items = registerOutput<List<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource>>('items');
