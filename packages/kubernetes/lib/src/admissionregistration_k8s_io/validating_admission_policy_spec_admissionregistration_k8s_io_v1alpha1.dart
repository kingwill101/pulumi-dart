...
class ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1 {
  ...
  final List<AuditAnnotationAdmissionregistrationK8sIoV1alpha1>? auditAnnotations;
  ...
  final List<MatchConditionAdmissionregistrationK8sIoV1alpha1>? matchConditions;
  /// MatchConstraints specifies what resources this policy is designed to validate. The AdmissionPolicy cares about a request if it matches _all_ Constraints. However, in order to prevent clusters from being put into an unstable state that cannot be recovered from via the API ValidatingAdmissionPolicy cannot match ValidatingAdmissionPolicy and ValidatingAdmissionPolicyBinding. Required.
  final MatchResourcesAdmissionregistrationK8sIoV1alpha1? matchConstraints;
  /// ParamKind specifies the kind of resources used to parameterize this policy. If absent, there are no parameters for this policy and the param CEL variable will not be provided to validation expressions. If ParamKind refers to a non-existent kind, this policy definition is mis-configured and the FailurePolicy is applied. If paramKind is specified but paramRef is unset in ValidatingAdmissionPolicyBinding, the params variable will be null.
  final ParamKindAdmissionregistrationK8sIoV1alpha1? paramKind;
  ...
  final List<ValidationAdmissionregistrationK8sIoV1alpha1> validations;
  /// Variables contain definitions of variables that can be used in composition of other expressions. Each variable is defined as a named CEL expression. The variables defined here will be available under `variables` in other expressions of the policy except MatchConditions because MatchConditions are evaluated before the rest of the policy.
  ///
  /// The expression of a variable can refer to other variables defined earlier in the list but not those after. Thus, Variables must be sorted by the order of first appearance and acyclic.
  final List<VariableAdmissionregistrationK8sIoV1alpha1>? variables;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditAnnotations': ?auditAnnotations == null ? null : pulumi.Input.encodeList<AuditAnnotationAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(auditAnnotations!, (value) => value.toMap()),
      'failurePolicy': ?failurePolicy,
      'matchConditions': ?matchConditions == null ? null : pulumi.Input.encodeList<MatchConditionAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(matchConditions!, (value) => value.toMap()),
      'matchConstraints': ?matchConstraints == null ? null : matchConstraints!.toMap(),
      'paramKind': ?paramKind == null ? null : paramKind!.toMap(),
      'validations': pulumi.Input.encodeList<ValidationAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(validations, (value) => value.toMap()),
      'variables': ?variables == null ? null : pulumi.Input.encodeList<VariableAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(variables!, (value) => value.toMap()),
    };
  }
  ...
  factory ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1(
      auditAnnotations: map['auditAnnotations'] == null ? null : pulumi.Input.decodeList<AuditAnnotationAdmissionregistrationK8sIoV1alpha1>(map['auditAnnotations'], (value) => AuditAnnotationAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      failurePolicy: map['failurePolicy'] == null ? null : map['failurePolicy'] as String,
      matchConditions: map['matchConditions'] == null ? null : pulumi.Input.decodeList<MatchConditionAdmissionregistrationK8sIoV1alpha1>(map['matchConditions'], (value) => MatchConditionAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      matchConstraints: map['matchConstraints'] == null ? null : MatchResourcesAdmissionregistrationK8sIoV1alpha1.fromMap((map['matchConstraints'] as Map).cast<String, dynamic>()),
      paramKind: map['paramKind'] == null ? null : ParamKindAdmissionregistrationK8sIoV1alpha1.fromMap((map['paramKind'] as Map).cast<String, dynamic>()),
      validations: pulumi.Input.decodeList<ValidationAdmissionregistrationK8sIoV1alpha1>(map['validations'], (value) => ValidationAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      variables: map['variables'] == null ? null : pulumi.Input.decodeList<VariableAdmissionregistrationK8sIoV1alpha1>(map['variables'], (value) => VariableAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
