...
class MutatingWebhookConfigurationListArgs {
  ...
  MutatingWebhookConfigurationListArgs({
    String? apiVersion,
    required List<MutatingWebhookConfigurationAdmissionregistrationK8sIoV1> items,
    String? kind,
    ListMeta? metadata,
  }) :
  ...
  factory MutatingWebhookConfigurationListArgs.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookConfigurationListArgs(
      ...
      items: (map['items'] as List).cast<MutatingWebhookConfigurationAdmissionregistrationK8sIoV1>(),
