...
class ValidatingAdmissionPolicyPatch {
  ...
  final ValidatingAdmissionPolicySpecPatch? spec;
  /// The status of the ValidatingAdmissionPolicy, including warnings that are useful to determine if the policy behaves in the expected way. Populated by the system. Read-only.
  final ValidatingAdmissionPolicyStatusPatch? status;
  ...
  factory ValidatingAdmissionPolicyPatch.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyPatch(
      ...
      status: map['status'] == null ? null : ValidatingAdmissionPolicyStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
