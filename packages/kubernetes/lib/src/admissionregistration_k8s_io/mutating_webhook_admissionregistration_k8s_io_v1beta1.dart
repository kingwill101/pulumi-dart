...
import 'rule_with_operations_admissionregistration_k8s_io_v1beta1.dart';
import 'webhook_client_config_admissionregistration_k8s_io_v1beta1.dart';
...
class MutatingWebhookAdmissionregistrationK8sIoV1beta1 {
  ...
  final WebhookClientConfigAdmissionregistrationK8sIoV1beta1 clientConfig;
  ...
  final List<RuleWithOperationsAdmissionregistrationK8sIoV1beta1>? rules;
  ...
  /// Creates a new [MutatingWebhookAdmissionregistrationK8sIoV1beta1].
  ...
  MutatingWebhookAdmissionregistrationK8sIoV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?rules == null ? null : pulumi.Input.encodeList<RuleWithOperationsAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(rules!, (value) => value.toMap()),
  ...
  factory MutatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookAdmissionregistrationK8sIoV1beta1(
      admissionReviewVersions: map['admissionReviewVersions'] == null ? null : (map['admissionReviewVersions'] as List).cast<String>(),
      clientConfig: WebhookClientConfigAdmissionregistrationK8sIoV1beta1.fromMap((map['clientConfig'] as Map).cast<String, dynamic>()),
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RuleWithOperationsAdmissionregistrationK8sIoV1beta1>(map['rules'], (value) => RuleWithOperationsAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      sideEffects: map['sideEffects'] == null ? null : map['sideEffects'] as String,
