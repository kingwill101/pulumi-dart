...
class MatchResources {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludeResourceRules': ?excludeResourceRules == null ? null : pulumi.Input.encodeList<NamedRuleWithOperations, Map<String, dynamic>>(excludeResourceRules!, (value) => value.toMap()),
      ...
      'resourceRules': ?resourceRules == null ? null : pulumi.Input.encodeList<NamedRuleWithOperations, Map<String, dynamic>>(resourceRules!, (value) => value.toMap()),
    };
  }

  factory MatchResources.fromMap(Map<String, dynamic> map) {
    return MatchResources(
      excludeResourceRules: map['excludeResourceRules'] == null ? null : pulumi.Input.decodeList<NamedRuleWithOperations>(map['excludeResourceRules'], (value) => NamedRuleWithOperations.fromMap((value as Map).cast<String, dynamic>())),
      ...
      resourceRules: map['resourceRules'] == null ? null : pulumi.Input.decodeList<NamedRuleWithOperations>(map['resourceRules'], (value) => NamedRuleWithOperations.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
