...
class ValidationPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [ValidationPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  factory ValidationPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidationPatchAdmissionregistrationK8sIoV1alpha1(
      expression: map['expression'] == null ? null : map['expression'] as String,
      message: map['message'] == null ? null : map['message'] as String,
      messageExpression: map['messageExpression'] == null ? null : map['messageExpression'] as String,
