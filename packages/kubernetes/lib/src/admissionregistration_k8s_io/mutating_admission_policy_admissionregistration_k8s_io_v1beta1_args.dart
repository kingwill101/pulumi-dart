...
class MutatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1Args {
  ...
  MutatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1Args({
    String? apiVersion,
    String? kind,
    ObjectMeta? metadata,
    MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1>(spec);
  ...
  factory MutatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
