...
class ValidatingWebhookConfigurationListResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ValidatingWebhookConfigurationResource>> items;
  ...
  ValidatingWebhookConfigurationListResource(
    String name, {
    ValidatingWebhookConfigurationListAdmissionregistrationK8sIoV1beta1Args? args,
    ...
    this.items = registerOutput<List<ValidatingWebhookConfigurationResource>>('items');
