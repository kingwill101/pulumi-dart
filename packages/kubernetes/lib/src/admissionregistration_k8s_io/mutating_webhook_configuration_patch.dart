...
class MutatingWebhookConfigurationPatch {
  ...
  final List<MutatingWebhookPatch>? webhooks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'webhooks': ?webhooks == null ? null : pulumi.Input.encodeList<MutatingWebhookPatch, Map<String, dynamic>>(webhooks!, (value) => value.toMap()),
    };
  }
