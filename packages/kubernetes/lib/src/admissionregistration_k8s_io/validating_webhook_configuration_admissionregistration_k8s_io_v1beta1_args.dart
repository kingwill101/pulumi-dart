...
/// {@template pulumi_admissionregistration_k8s_io_v1beta1_validating_webhook_configuration_admissionregistration_k8s_io_v1beta1_args_doc}
/// The set of arguments for ValidatingWebhookConfiguration.
/// {@endtemplate}
/// {@macro pulumi_admissionregistration_k8s_io_v1beta1_validating_webhook_configuration_admissionregistration_k8s_io_v1beta1_args_doc}
class ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args {
  ...
  /// Creates a new [ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args].
  ...
  ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args({
    ...
    String? kind,
    ObjectMeta? metadata,
    List<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>? webhooks,
  }) :
  ...
  factory ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args(
      ...
      webhooks: map['webhooks'] == null ? null : pulumi.Input.decodeList<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>(map['webhooks'], (value) => ValidatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
