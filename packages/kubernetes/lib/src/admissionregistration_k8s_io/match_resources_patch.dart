...
import 'named_rule_with_operations_patch.dart';

/// MatchResources decides whether to run the admission control policy on an object based on whether it meets the match criteria. The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
class MatchResourcesPatch {
  /// ExcludeResourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy should not care about. The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
  final List<NamedRuleWithOperationsPatch>? excludeResourceRules;
  ...
  final List<NamedRuleWithOperationsPatch>? resourceRules;

  /// Creates a new [MatchResourcesPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludeResourceRules': ?excludeResourceRules == null ? null : pulumi.Input.encodeList<NamedRuleWithOperationsPatch, Map<String, dynamic>>(excludeResourceRules!, (value) => value.toMap()),
      ...
      'resourceRules': ?resourceRules == null ? null : pulumi.Input.encodeList<NamedRuleWithOperationsPatch, Map<String, dynamic>>(resourceRules!, (value) => value.toMap()),
    };
  }

  factory MatchResourcesPatch.fromMap(Map<String, dynamic> map) {
    return MatchResourcesPatch(
      excludeResourceRules: map['excludeResourceRules'] == null ? null : pulumi.Input.decodeList<NamedRuleWithOperationsPatch>(map['excludeResourceRules'], (value) => NamedRuleWithOperationsPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      resourceRules: map['resourceRules'] == null ? null : pulumi.Input.decodeList<NamedRuleWithOperationsPatch>(map['resourceRules'], (value) => NamedRuleWithOperationsPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
