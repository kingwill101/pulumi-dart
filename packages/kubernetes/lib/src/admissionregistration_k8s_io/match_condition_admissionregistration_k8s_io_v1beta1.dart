...
class MatchConditionAdmissionregistrationK8sIoV1beta1 {
  ...
  /// Creates a new [MatchConditionAdmissionregistrationK8sIoV1beta1].
  ...
  factory MatchConditionAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MatchConditionAdmissionregistrationK8sIoV1beta1(
