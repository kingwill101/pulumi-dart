...
class MutatingWebhookConfigurationListAdmissionregistrationK8sIoV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MutatingWebhookConfigurationAdmissionregistrationK8sIoV1>> items;
  ...
  MutatingWebhookConfigurationListAdmissionregistrationK8sIoV1(
    ...
    this.items = registerOutput<List<MutatingWebhookConfigurationAdmissionregistrationK8sIoV1>>('items');
