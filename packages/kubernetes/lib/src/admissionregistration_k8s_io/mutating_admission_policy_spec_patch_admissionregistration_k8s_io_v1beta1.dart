...
import 'mutation_patch_admissionregistration_k8s_io_v1beta1.dart';
...
class MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  final List<MutationPatchAdmissionregistrationK8sIoV1beta1>? mutations;
  ...
  /// Creates a new [MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1].
  ...
  MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1({
    this.failurePolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mutations': ?mutations == null ? null : pulumi.Input.encodeList<MutationPatchAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(mutations!, (value) => value.toMap()),
  ...
  factory MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1(
      ...
      mutations: map['mutations'] == null ? null : pulumi.Input.decodeList<MutationPatchAdmissionregistrationK8sIoV1beta1>(map['mutations'], (value) => MutationPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
