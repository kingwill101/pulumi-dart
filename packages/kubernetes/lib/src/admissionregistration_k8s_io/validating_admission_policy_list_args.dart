...
class ValidatingAdmissionPolicyListArgs {
  ...
  ValidatingAdmissionPolicyListArgs({
    String? apiVersion,
    required List<ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1> items,
    String? kind,
    ListMeta? metadata,
  }) :
  ...
  factory ValidatingAdmissionPolicyListArgs.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyListArgs(
      ...
      items: (map['items'] as List).cast<ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1>(),
