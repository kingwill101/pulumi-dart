...
class MutatingWebhook {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchConditions': ?matchConditions == null ? null : pulumi.Input.encodeList<MatchCondition, Map<String, dynamic>>(matchConditions!, (value) => value.toMap()),
      ...
      'rules': ?rules == null ? null : pulumi.Input.encodeList<RuleWithOperations, Map<String, dynamic>>(rules!, (value) => value.toMap()),
      'sideEffects': sideEffects,
      'timeoutSeconds': ?timeoutSeconds,
    };
  }

  factory MutatingWebhook.fromMap(Map<String, dynamic> map) {
    return MutatingWebhook(
      admissionReviewVersions: (map['admissionReviewVersions'] as List).cast<String>(),
      ...
      matchConditions: map['matchConditions'] == null ? null : pulumi.Input.decodeList<MatchCondition>(map['matchConditions'], (value) => MatchCondition.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RuleWithOperations>(map['rules'], (value) => RuleWithOperations.fromMap((value as Map).cast<String, dynamic>())),
