...
class ValidatingWebhookConfigurationListArgs {
  ...
  ValidatingWebhookConfigurationListArgs({
    String? apiVersion,
    required List<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1> items,
    String? kind,
    ListMeta? metadata,
  }) :
  ...
  factory ValidatingWebhookConfigurationListArgs.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookConfigurationListArgs(
      ...
      items: (map['items'] as List).cast<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1>(),
