...
class MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1 {
  ...
  final List<MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1(
      ...
      items: pulumi.Input.decodeList<MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1>(map['items'], (value) => MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
