...
class ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1 {
  ...
  /// Creates a new [ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1].
  ...
  ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1({
    this.matchResources,
    this.paramRef,
    this.policyName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchResources': ?matchResources == null ? null : matchResources!.toMap(),
      'paramRef': ?paramRef == null ? null : paramRef!.toMap(),
      'policyName': ?policyName,
      'validationActions': ?validationActions,
    };
  }

  factory ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1(
      matchResources: map['matchResources'] == null ? null : MatchResourcesAdmissionregistrationK8sIoV1beta1.fromMap((map['matchResources'] as Map).cast<String, dynamic>()),
      paramRef: map['paramRef'] == null ? null : ParamRefAdmissionregistrationK8sIoV1beta1.fromMap((map['paramRef'] as Map).cast<String, dynamic>()),
      policyName: map['policyName'] == null ? null : map['policyName'] as String,
      validationActions: map['validationActions'] == null ? null : (map['validationActions'] as List).cast<String>(),
    );
  }
}
