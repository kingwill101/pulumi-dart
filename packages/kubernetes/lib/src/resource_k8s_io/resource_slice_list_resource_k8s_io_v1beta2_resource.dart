...
class ResourceSliceListResourceK8sIoV1beta2Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResourceSliceResourceK8sIoV1beta2Resource>> items;
  ...
  ResourceSliceListResourceK8sIoV1beta2Resource(
    ...
    this.items = registerOutput<List<ResourceSliceResourceK8sIoV1beta2Resource>>('items');
