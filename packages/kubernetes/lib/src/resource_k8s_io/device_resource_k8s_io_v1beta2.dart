...
class DeviceResourceK8sIoV1beta2 {
  ...
  final Map<String, DeviceAttributeResourceK8sIoV1beta2>? attributes;
  ...
  ///
  /// The maximum number of attributes and capacities combined is 32.
  final Map<String, DeviceCapacityResourceK8sIoV1beta2>? capacity;
  /// ConsumesCounters defines a list of references to sharedCounters and the set of counters that the device will consume from those counter sets.
  ///
  /// There can only be a single entry per counterSet.
  ///
  /// The maximum number of device counter consumptions per device is 2.
  final List<DeviceCounterConsumptionResourceK8sIoV1beta2>? consumesCounters;
  ...
  final List<DeviceTaintResourceK8sIoV1beta2>? taints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'attributes': ?attributes == null ? null : pulumi.Input.encodeMapValues<DeviceAttributeResourceK8sIoV1beta2, Map<String, dynamic>>(attributes!, (value) => value.toMap()),
      'bindingConditions': ?bindingConditions,
      'bindingFailureConditions': ?bindingFailureConditions,
      'bindsToNode': ?bindsToNode,
      'capacity': ?capacity == null ? null : pulumi.Input.encodeMapValues<DeviceCapacityResourceK8sIoV1beta2, Map<String, dynamic>>(capacity!, (value) => value.toMap()),
      'consumesCounters': ?consumesCounters == null ? null : pulumi.Input.encodeList<DeviceCounterConsumptionResourceK8sIoV1beta2, Map<String, dynamic>>(consumesCounters!, (value) => value.toMap()),
      'name': name,
      'nodeName': ?nodeName,
      'nodeSelector': ?nodeSelector == null ? null : nodeSelector!.toMap(),
      'taints': ?taints == null ? null : pulumi.Input.encodeList<DeviceTaintResourceK8sIoV1beta2, Map<String, dynamic>>(taints!, (value) => value.toMap()),
    };
  }
  ...
  factory DeviceResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceResourceK8sIoV1beta2(
      ...
      attributes: map['attributes'] == null ? null : pulumi.Input.decodeMapValues<DeviceAttributeResourceK8sIoV1beta2>(map['attributes'], (value) => DeviceAttributeResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      ...
      capacity: map['capacity'] == null ? null : pulumi.Input.decodeMapValues<DeviceCapacityResourceK8sIoV1beta2>(map['capacity'], (value) => DeviceCapacityResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      consumesCounters: map['consumesCounters'] == null ? null : pulumi.Input.decodeList<DeviceCounterConsumptionResourceK8sIoV1beta2>(map['consumesCounters'], (value) => DeviceCounterConsumptionResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      ...
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<DeviceTaintResourceK8sIoV1beta2>(map['taints'], (value) => DeviceTaintResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
