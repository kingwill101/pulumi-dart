...
class DevicePatch {
  ...
  final List<DeviceCounterConsumptionPatch>? consumesCounters;
  ...
  final List<DeviceTaintPatch>? taints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumesCounters': ?consumesCounters == null ? null : pulumi.Input.encodeList<DeviceCounterConsumptionPatch, Map<String, dynamic>>(consumesCounters!, (value) => value.toMap()),
      'name': ?name,
      'nodeName': ?nodeName,
      'nodeSelector': ?nodeSelector == null ? null : nodeSelector!.toMap(),
      'taints': ?taints == null ? null : pulumi.Input.encodeList<DeviceTaintPatch, Map<String, dynamic>>(taints!, (value) => value.toMap()),
    };
  }
  ...
  factory DevicePatch.fromMap(Map<String, dynamic> map) {
    return DevicePatch(
      ...
      consumesCounters: map['consumesCounters'] == null ? null : pulumi.Input.decodeList<DeviceCounterConsumptionPatch>(map['consumesCounters'], (value) => DeviceCounterConsumptionPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<DeviceTaintPatch>(map['taints'], (value) => DeviceTaintPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
