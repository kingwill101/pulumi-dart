...
class AllocationResultPatchResourceK8sIoV1beta1 {
  ...
  final DeviceAllocationResultPatchResourceK8sIoV1beta1? devices;
  ...
  factory AllocationResultPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatchResourceK8sIoV1beta1(
      ...
      devices: map['devices'] == null ? null : DeviceAllocationResultPatchResourceK8sIoV1beta1.fromMap((map['devices'] as Map).cast<String, dynamic>()),
