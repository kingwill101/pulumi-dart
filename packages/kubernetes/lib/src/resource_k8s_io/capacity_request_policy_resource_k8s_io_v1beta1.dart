...
class CapacityRequestPolicyResourceK8sIoV1beta1 {
  ...
  final CapacityRequestPolicyRangeResourceK8sIoV1beta1? validRange;
  ...
  factory CapacityRequestPolicyResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicyResourceK8sIoV1beta1(
      ...
      validRange: map['validRange'] == null ? null : CapacityRequestPolicyRangeResourceK8sIoV1beta1.fromMap((map['validRange'] as Map).cast<String, dynamic>()),
