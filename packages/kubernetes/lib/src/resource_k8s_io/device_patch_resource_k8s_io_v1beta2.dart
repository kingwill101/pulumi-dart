...
import 'device_counter_consumption_patch_resource_k8s_io_v1beta2.dart';
import 'device_taint_patch_resource_k8s_io_v1beta2.dart';

/// Device represents one individual hardware instance that can be selected based on its attributes. Besides the name, exactly one field must be set.
class DevicePatchResourceK8sIoV1beta2 {
  ...
  final List<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>? consumesCounters;
  ...
  final List<DeviceTaintPatchResourceK8sIoV1beta2>? taints;

  /// Creates a new [DevicePatchResourceK8sIoV1beta2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumesCounters': ?consumesCounters == null ? null : pulumi.Input.encodeList<DeviceCounterConsumptionPatchResourceK8sIoV1beta2, Map<String, dynamic>>(consumesCounters!, (value) => value.toMap()),
      'name': ?name,
      'nodeName': ?nodeName,
      'nodeSelector': ?nodeSelector == null ? null : nodeSelector!.toMap(),
      'taints': ?taints == null ? null : pulumi.Input.encodeList<DeviceTaintPatchResourceK8sIoV1beta2, Map<String, dynamic>>(taints!, (value) => value.toMap()),
    };
  }

  factory DevicePatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DevicePatchResourceK8sIoV1beta2(
      ...
      consumesCounters: map['consumesCounters'] == null ? null : pulumi.Input.decodeList<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>(map['consumesCounters'], (value) => DeviceCounterConsumptionPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      ...
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<DeviceTaintPatchResourceK8sIoV1beta2>(map['taints'], (value) => DeviceTaintPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
