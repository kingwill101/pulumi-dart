...
class ResourceSliceSpecPatchResourceK8sIoV1beta1 {
  ...
  final List<DevicePatchResourceK8sIoV1beta1>? devices;
  ...
  final ResourcePoolPatchResourceK8sIoV1beta1? pool;
  ...
  final List<CounterSetPatchResourceK8sIoV1beta1>? sharedCounters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allNodes': ?allNodes,
      'devices': ?devices == null ? null : pulumi.Input.encodeList<DevicePatchResourceK8sIoV1beta1, Map<String, dynamic>>(devices!, (value) => value.toMap()),
      'driver': ?driver,
      'nodeName': ?nodeName,
      ...
      'sharedCounters': ?sharedCounters == null ? null : pulumi.Input.encodeList<CounterSetPatchResourceK8sIoV1beta1, Map<String, dynamic>>(sharedCounters!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceSliceSpecPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecPatchResourceK8sIoV1beta1(
      ...
      devices: map['devices'] == null ? null : pulumi.Input.decodeList<DevicePatchResourceK8sIoV1beta1>(map['devices'], (value) => DevicePatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pool: map['pool'] == null ? null : ResourcePoolPatchResourceK8sIoV1beta1.fromMap((map['pool'] as Map).cast<String, dynamic>()),
      sharedCounters: map['sharedCounters'] == null ? null : pulumi.Input.decodeList<CounterSetPatchResourceK8sIoV1beta1>(map['sharedCounters'], (value) => CounterSetPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
