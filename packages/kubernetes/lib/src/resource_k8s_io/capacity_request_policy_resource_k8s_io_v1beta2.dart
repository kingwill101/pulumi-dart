...
class CapacityRequestPolicyResourceK8sIoV1beta2 {
  ...
  final CapacityRequestPolicyRangeResourceK8sIoV1beta2? validRange;
  ...
  factory CapacityRequestPolicyResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicyResourceK8sIoV1beta2(
      ...
      validRange: map['validRange'] == null ? null : CapacityRequestPolicyRangeResourceK8sIoV1beta2.fromMap((map['validRange'] as Map).cast<String, dynamic>()),
