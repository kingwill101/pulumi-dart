...
class DeviceSubRequestPatch {
  ...
  final CapacityRequirementsPatch? capacity;
  ...
  /// Creates a new [DeviceSubRequestPatch].
  ...
  factory DeviceSubRequestPatch.fromMap(Map<String, dynamic> map) {
    return DeviceSubRequestPatch(
      ...
      capacity: map['capacity'] == null ? null : CapacityRequirementsPatch.fromMap((map['capacity'] as Map).cast<String, dynamic>()),
