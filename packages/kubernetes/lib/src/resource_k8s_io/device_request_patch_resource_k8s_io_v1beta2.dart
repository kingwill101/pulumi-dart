...
class DeviceRequestPatchResourceK8sIoV1beta2 {
  ...
  final ExactDeviceRequestPatchResourceK8sIoV1beta2? exactly;
  ...
  final List<DeviceSubRequestPatchResourceK8sIoV1beta2>? firstAvailable;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'firstAvailable': ?firstAvailable == null ? null : pulumi.Input.encodeList<DeviceSubRequestPatchResourceK8sIoV1beta2, Map<String, dynamic>>(firstAvailable!, (value) => value.toMap()),
      'name': ?name,
    };
  }
  ...
  factory DeviceRequestPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceRequestPatchResourceK8sIoV1beta2(
      exactly: map['exactly'] == null ? null : ExactDeviceRequestPatchResourceK8sIoV1beta2.fromMap((map['exactly'] as Map).cast<String, dynamic>()),
      firstAvailable: map['firstAvailable'] == null ? null : pulumi.Input.decodeList<DeviceSubRequestPatchResourceK8sIoV1beta2>(map['firstAvailable'], (value) => DeviceSubRequestPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
