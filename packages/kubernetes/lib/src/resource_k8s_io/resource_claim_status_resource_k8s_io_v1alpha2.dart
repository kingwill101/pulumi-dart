...
class ResourceClaimStatusResourceK8sIoV1alpha2 {
  ...
  final AllocationResultResourceK8sIoV1alpha2? allocation;
  ...
  final List<ResourceClaimConsumerReferenceResourceK8sIoV1alpha2>? reservedFor;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reservedFor': ?reservedFor == null ? null : pulumi.Input.encodeList<ResourceClaimConsumerReferenceResourceK8sIoV1alpha2, Map<String, dynamic>>(reservedFor!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceClaimStatusResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusResourceK8sIoV1alpha2(
      allocation: map['allocation'] == null ? null : AllocationResultResourceK8sIoV1alpha2.fromMap((map['allocation'] as Map).cast<String, dynamic>()),
      ...
      reservedFor: map['reservedFor'] == null ? null : pulumi.Input.decodeList<ResourceClaimConsumerReferenceResourceK8sIoV1alpha2>(map['reservedFor'], (value) => ResourceClaimConsumerReferenceResourceK8sIoV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
