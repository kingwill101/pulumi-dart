...
class DeviceSubRequestPatchResourceK8sIoV1beta2 {
  ...
  final CapacityRequirementsPatchResourceK8sIoV1beta2? capacity;
  ...
  factory DeviceSubRequestPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceSubRequestPatchResourceK8sIoV1beta2(
      ...
      capacity: map['capacity'] == null ? null : CapacityRequirementsPatchResourceK8sIoV1beta2.fromMap((map['capacity'] as Map).cast<String, dynamic>()),
