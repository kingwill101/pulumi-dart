...
class DeviceTaintRulePatch {
  ...
  final DeviceTaintRuleSpecPatch? spec;
  /// Status provides information about what was requested in the spec.
  final DeviceTaintRuleStatusPatch? status;
  ...
  factory DeviceTaintRulePatch.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRulePatch(
      ...
      status: map['status'] == null ? null : DeviceTaintRuleStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
