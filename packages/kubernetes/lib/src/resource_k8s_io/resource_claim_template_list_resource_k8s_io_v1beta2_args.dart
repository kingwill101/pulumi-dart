...
class ResourceClaimTemplateListResourceK8sIoV1beta2Args {
  ...
  ResourceClaimTemplateListResourceK8sIoV1beta2Args({
    String? apiVersion,
    required List<ResourceClaimTemplateResourceK8sIoV1beta2Resource> items,
    String? kind,
    ListMeta? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ResourceClaimTemplateResourceK8sIoV1beta2Resource>>(items),
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplateListResourceK8sIoV1beta2Args(
      ...
      items: (map['items'] as List).cast<ResourceClaimTemplateResourceK8sIoV1beta2Resource>(),
