...
class PodSchedulingListArgs {
  ...
  PodSchedulingListArgs({
    String? apiVersion,
    required List<PodSchedulingResourceK8sIoV1alpha1> items,
    String? kind,
    ListMeta? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<PodSchedulingResourceK8sIoV1alpha1>>(items),
  ...
  factory PodSchedulingListArgs.fromMap(Map<String, dynamic> map) {
    return PodSchedulingListArgs(
      ...
      items: (map['items'] as List).cast<PodSchedulingResourceK8sIoV1alpha1>(),
