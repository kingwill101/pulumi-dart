...
class DeviceAttributePatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [DeviceAttributePatchResourceK8sIoV1beta1].
  ...
  DeviceAttributePatchResourceK8sIoV1beta1({
    this.bool,
    this.int,
    this.string,
    this.version,
  ...
  factory DeviceAttributePatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceAttributePatchResourceK8sIoV1beta1(
