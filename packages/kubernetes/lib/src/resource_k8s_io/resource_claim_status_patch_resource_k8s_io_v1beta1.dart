...
class ResourceClaimStatusPatchResourceK8sIoV1beta1 {
  ...
  final AllocationResultPatchResourceK8sIoV1beta1? allocation;
  /// Devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.
  final List<AllocatedDeviceStatusPatchResourceK8sIoV1beta1>? devices;
  ...
  final List<ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1>? reservedFor;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices': ?devices == null ? null : pulumi.Input.encodeList<AllocatedDeviceStatusPatchResourceK8sIoV1beta1, Map<String, dynamic>>(devices!, (value) => value.toMap()),
      'reservedFor': ?reservedFor == null ? null : pulumi.Input.encodeList<ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1, Map<String, dynamic>>(reservedFor!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceClaimStatusPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusPatchResourceK8sIoV1beta1(
      allocation: map['allocation'] == null ? null : AllocationResultPatchResourceK8sIoV1beta1.fromMap((map['allocation'] as Map).cast<String, dynamic>()),
      devices: map['devices'] == null ? null : pulumi.Input.decodeList<AllocatedDeviceStatusPatchResourceK8sIoV1beta1>(map['devices'], (value) => AllocatedDeviceStatusPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      reservedFor: map['reservedFor'] == null ? null : pulumi.Input.decodeList<ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1>(map['reservedFor'], (value) => ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
