...
class ResourceClaimSpecResourceK8sIoV1alpha3 {
  ...
  final DeviceClaimResourceK8sIoV1alpha3? devices;
  ...
  factory ResourceClaimSpecResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecResourceK8sIoV1alpha3(
      controller: map['controller'] == null ? null : map['controller'] as String,
      devices: map['devices'] == null ? null : DeviceClaimResourceK8sIoV1alpha3.fromMap((map['devices'] as Map).cast<String, dynamic>()),
    );
  }
}
