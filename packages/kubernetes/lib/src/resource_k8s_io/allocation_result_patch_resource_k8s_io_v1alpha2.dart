...
class AllocationResultPatchResourceK8sIoV1alpha2 {
  ...
  final List<ResourceHandlePatch>? resourceHandles;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceHandles': ?resourceHandles == null ? null : pulumi.Input.encodeList<ResourceHandlePatch, Map<String, dynamic>>(resourceHandles!, (value) => value.toMap()),
      'shareable': ?shareable,
    };
  }
  ...
  factory AllocationResultPatchResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatchResourceK8sIoV1alpha2(
      ...
      resourceHandles: map['resourceHandles'] == null ? null : pulumi.Input.decodeList<ResourceHandlePatch>(map['resourceHandles'], (value) => ResourceHandlePatch.fromMap((value as Map).cast<String, dynamic>())),
