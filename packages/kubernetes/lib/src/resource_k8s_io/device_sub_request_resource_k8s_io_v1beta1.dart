...
class DeviceSubRequestResourceK8sIoV1beta1 {
  ...
  final CapacityRequirementsResourceK8sIoV1beta1? capacity;
  ...
  final List<DeviceTolerationResourceK8sIoV1beta1>? tolerations;
  ...
  DeviceSubRequestResourceK8sIoV1beta1({
    this.allocationMode,
    this.capacity,
    this.count,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tolerations': ?tolerations == null ? null : pulumi.Input.encodeList<DeviceTolerationResourceK8sIoV1beta1, Map<String, dynamic>>(tolerations!, (value) => value.toMap()),
    };
  }
  ...
  factory DeviceSubRequestResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceSubRequestResourceK8sIoV1beta1(
      ...
      capacity: map['capacity'] == null ? null : CapacityRequirementsResourceK8sIoV1beta1.fromMap((map['capacity'] as Map).cast<String, dynamic>()),
      ...
      tolerations: map['tolerations'] == null ? null : pulumi.Input.decodeList<DeviceTolerationResourceK8sIoV1beta1>(map['tolerations'], (value) => DeviceTolerationResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
