...
class ResourceClaimTemplateSpecResourceK8sIoV1alpha1 {
  ...
  /// Creates a new [ResourceClaimTemplateSpecResourceK8sIoV1alpha1].
  ...
  factory ResourceClaimTemplateSpecResourceK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplateSpecResourceK8sIoV1alpha1(
