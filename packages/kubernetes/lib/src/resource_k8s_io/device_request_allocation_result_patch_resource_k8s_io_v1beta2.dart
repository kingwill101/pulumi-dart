...
class DeviceRequestAllocationResultPatchResourceK8sIoV1beta2 {
  ...
  final List<DeviceTolerationPatchResourceK8sIoV1beta2>? tolerations;

  /// Creates a new [DeviceRequestAllocationResultPatchResourceK8sIoV1beta2].
  ...
  DeviceRequestAllocationResultPatchResourceK8sIoV1beta2({
    this.adminAccess,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'request': ?request,
      'shareID': ?shareID,
      'tolerations': ?tolerations == null ? null : pulumi.Input.encodeList<DeviceTolerationPatchResourceK8sIoV1beta2, Map<String, dynamic>>(tolerations!, (value) => value.toMap()),
    };
  }
  ...
  factory DeviceRequestAllocationResultPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceRequestAllocationResultPatchResourceK8sIoV1beta2(
      ...
      tolerations: map['tolerations'] == null ? null : pulumi.Input.decodeList<DeviceTolerationPatchResourceK8sIoV1beta2>(map['tolerations'], (value) => DeviceTolerationPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
