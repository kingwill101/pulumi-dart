...
class ResourceClassPatchArgs {
  ...
  ResourceClassPatchArgs({
    ...
    ResourceClassParametersReferencePatch? parametersRef,
    NodeSelectorPatch? suitableNodes,
  }) :
  ...
  factory ResourceClassPatchArgs.fromMap(Map<String, dynamic> map) {
    return ResourceClassPatchArgs(
      ...
      parametersRef: map['parametersRef'] == null ? null : ResourceClassParametersReferencePatch.fromMap((map['parametersRef'] as Map).cast<String, dynamic>()),
