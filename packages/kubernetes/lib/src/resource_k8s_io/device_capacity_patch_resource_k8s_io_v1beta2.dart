...
class DeviceCapacityPatchResourceK8sIoV1beta2 {
  ...
  final CapacityRequestPolicyPatchResourceK8sIoV1beta2? requestPolicy;
  ...
  factory DeviceCapacityPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceCapacityPatchResourceK8sIoV1beta2(
      requestPolicy: map['requestPolicy'] == null ? null : CapacityRequestPolicyPatchResourceK8sIoV1beta2.fromMap((map['requestPolicy'] as Map).cast<String, dynamic>()),
