...
/// {@template pulumi_resource_k8s_io_v1_resource_slice_args_doc}
/// The set of arguments for ResourceSlice.
/// {@endtemplate}
/// {@macro pulumi_resource_k8s_io_v1_resource_slice_args_doc}
class ResourceSliceArgs {
  ...
  /// Creates a new [ResourceSliceArgs].
  ...
  ResourceSliceArgs({
    ...
    String? kind,
    ObjectMeta? metadata,
    required ResourceSliceSpec spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<ResourceSliceSpec>(spec);
  ...
  factory ResourceSliceArgs.fromMap(Map<String, dynamic> map) {
    return ResourceSliceArgs(
