...
class CapacityRequestPolicy {
  ...
  final CapacityRequestPolicyRange? validRange;
  ...
  factory CapacityRequestPolicy.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicy(
      ...
      validRange: map['validRange'] == null ? null : CapacityRequestPolicyRange.fromMap((map['validRange'] as Map).cast<String, dynamic>()),
