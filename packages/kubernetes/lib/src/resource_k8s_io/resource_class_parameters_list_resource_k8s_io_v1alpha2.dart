...
class ResourceClassParametersListResourceK8sIoV1alpha2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResourceClassParametersResourceK8sIoV1alpha2>> items;
  ...
  ResourceClassParametersListResourceK8sIoV1alpha2(
    ...
    this.items = registerOutput<List<ResourceClassParametersResourceK8sIoV1alpha2>>('items');
