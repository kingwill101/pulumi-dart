...
class DevicePatchResourceK8sIoV1beta1 {
  ...
  final BasicDevicePatchResourceK8sIoV1beta1? basic;
  ...
  factory DevicePatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DevicePatchResourceK8sIoV1beta1(
      basic: map['basic'] == null ? null : BasicDevicePatchResourceK8sIoV1beta1.fromMap((map['basic'] as Map).cast<String, dynamic>()),
