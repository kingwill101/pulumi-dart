...
class DeviceCapacityResourceK8sIoV1beta1 {
  ...
  final CapacityRequestPolicyResourceK8sIoV1beta1? requestPolicy;
  ...
  factory DeviceCapacityResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceCapacityResourceK8sIoV1beta1(
      requestPolicy: map['requestPolicy'] == null ? null : CapacityRequestPolicyResourceK8sIoV1beta1.fromMap((map['requestPolicy'] as Map).cast<String, dynamic>()),
