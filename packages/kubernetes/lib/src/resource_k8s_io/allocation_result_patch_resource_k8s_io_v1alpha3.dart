...
class AllocationResultPatchResourceK8sIoV1alpha3 {
  ...
  final DeviceAllocationResultPatchResourceK8sIoV1alpha3? devices;
  ...
  factory AllocationResultPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatchResourceK8sIoV1alpha3(
      ...
      devices: map['devices'] == null ? null : DeviceAllocationResultPatchResourceK8sIoV1alpha3.fromMap((map['devices'] as Map).cast<String, dynamic>()),
