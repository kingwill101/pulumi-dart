...
class ResourcePoolPatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [ResourcePoolPatchResourceK8sIoV1beta1].
  ...
  factory ResourcePoolPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourcePoolPatchResourceK8sIoV1beta1(
      generation: map['generation'] == null ? null : map['generation'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      resourceSliceCount: map['resourceSliceCount'] == null ? null : map['resourceSliceCount'] as int,
    );
  }
}
