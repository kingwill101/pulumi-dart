...
class ResourceSliceSpecPatch {
  ...
  final List<DevicePatch>? devices;
  ...
  final List<CounterSetPatch>? sharedCounters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allNodes': ?allNodes,
      'devices': ?devices == null ? null : pulumi.Input.encodeList<DevicePatch, Map<String, dynamic>>(devices!, (value) => value.toMap()),
      'driver': ?driver,
      'nodeName': ?nodeName,
      ...
      'sharedCounters': ?sharedCounters == null ? null : pulumi.Input.encodeList<CounterSetPatch, Map<String, dynamic>>(sharedCounters!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceSliceSpecPatch.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecPatch(
      ...
      devices: map['devices'] == null ? null : pulumi.Input.decodeList<DevicePatch>(map['devices'], (value) => DevicePatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pool: map['pool'] == null ? null : ResourcePoolPatch.fromMap((map['pool'] as Map).cast<String, dynamic>()),
      sharedCounters: map['sharedCounters'] == null ? null : pulumi.Input.decodeList<CounterSetPatch>(map['sharedCounters'], (value) => CounterSetPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
