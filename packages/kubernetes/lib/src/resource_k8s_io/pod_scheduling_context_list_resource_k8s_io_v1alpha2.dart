...
class PodSchedulingContextListResourceK8sIoV1alpha2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PodSchedulingContextResourceK8sIoV1alpha2>> items;
  ...
  PodSchedulingContextListResourceK8sIoV1alpha2(
    ...
    this.items = registerOutput<List<PodSchedulingContextResourceK8sIoV1alpha2>>('items');
