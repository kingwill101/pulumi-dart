...
class DeviceConstraintResourceK8sIoV1beta2 {
  ...
  /// Creates a new [DeviceConstraintResourceK8sIoV1beta2].
  ...
  DeviceConstraintResourceK8sIoV1beta2({
  ...
  factory DeviceConstraintResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceConstraintResourceK8sIoV1beta2(
