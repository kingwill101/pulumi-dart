...
class ResourceClassParametersResourceK8sIoV1alpha2 extends pulumi.CustomResource {
  /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  late final pulumi.Output<String> apiVersion;
  /// Filters describes additional contraints that must be met when using the class.
  late final pulumi.Output<List<ResourceFilter>> filters;
  ...
  late final pulumi.Output<ResourceClassParametersReferenceResourceK8sIoV1alpha2> generatedFrom;
  ...
  late final pulumi.Output<List<VendorParameters>> vendorParameters;
  ...
  ResourceClassParametersResourceK8sIoV1alpha2(
    ...
    this.filters = registerOutput<List<ResourceFilter>>('filters');
    this.generatedFrom = registerOutput<ResourceClassParametersReferenceResourceK8sIoV1alpha2>('generatedFrom');
    this.kind = registerOutput<String>('kind');
    this.metadata = registerOutput<ObjectMeta>('metadata');
    this.vendorParameters = registerOutput<List<VendorParameters>>('vendorParameters');
  }
}
