...
class ResourceClassPatchResourceK8sIoV1alpha2Args {
  ...
  ResourceClassPatchResourceK8sIoV1alpha2Args({
    ...
    ResourceClassParametersReferencePatchResourceK8sIoV1alpha2? parametersRef,
  ...
  factory ResourceClassPatchResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClassPatchResourceK8sIoV1alpha2Args(
      ...
      parametersRef: map['parametersRef'] == null ? null : ResourceClassParametersReferencePatchResourceK8sIoV1alpha2.fromMap((map['parametersRef'] as Map).cast<String, dynamic>()),
