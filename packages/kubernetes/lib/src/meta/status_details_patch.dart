...
class StatusDetailsPatch {
  ...
  final List<StatusCausePatch>? causes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'causes': ?causes == null ? null : pulumi.Input.encodeList<StatusCausePatch, Map<String, dynamic>>(causes!, (value) => value.toMap()),
      'group': ?group,
      'kind': ?kind,
      'name': ?name,
  ...
  factory StatusDetailsPatch.fromMap(Map<String, dynamic> map) {
    return StatusDetailsPatch(
      causes: map['causes'] == null ? null : pulumi.Input.decodeList<StatusCausePatch>(map['causes'], (value) => StatusCausePatch.fromMap((value as Map).cast<String, dynamic>())),
