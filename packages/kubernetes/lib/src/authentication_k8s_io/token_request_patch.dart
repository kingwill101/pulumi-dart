...
class TokenRequestPatch {
  ...
  final TokenRequestSpecPatch? spec;
  /// Status is filled in by the server and indicates whether the token can be authenticated.
  final TokenRequestStatusPatch? status;
  ...
  factory TokenRequestPatch.fromMap(Map<String, dynamic> map) {
    return TokenRequestPatch(
      ...
      spec: map['spec'] == null ? null : TokenRequestSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : TokenRequestStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
