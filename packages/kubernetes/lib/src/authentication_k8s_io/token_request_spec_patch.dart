...
class TokenRequestSpecPatch {
  ...
  final BoundObjectReferencePatch? boundObjectRef;
  ...
  factory TokenRequestSpecPatch.fromMap(Map<String, dynamic> map) {
    return TokenRequestSpecPatch(
      ...
      boundObjectRef: map['boundObjectRef'] == null ? null : BoundObjectReferencePatch.fromMap((map['boundObjectRef'] as Map).cast<String, dynamic>()),
