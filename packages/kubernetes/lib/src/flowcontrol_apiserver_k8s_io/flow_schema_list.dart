...
class FlowSchemaList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<FlowSchema, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory FlowSchemaList.fromMap(Map<String, dynamic> map) {
    return FlowSchemaList(
      ...
      items: pulumi.Input.decodeList<FlowSchema>(map['items'], (value) => FlowSchema.fromMap((value as Map).cast<String, dynamic>())),
