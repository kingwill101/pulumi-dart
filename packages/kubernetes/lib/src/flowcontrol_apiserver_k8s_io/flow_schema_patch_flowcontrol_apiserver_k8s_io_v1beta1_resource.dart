...
class FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta1Resource(
    ...
    this.spec = registerOutput<FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta1?>('spec');
    this.status = registerOutput<FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta1?>('status');
  }
}
