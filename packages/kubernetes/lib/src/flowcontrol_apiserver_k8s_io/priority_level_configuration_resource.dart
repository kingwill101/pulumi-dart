...
class PriorityLevelConfigurationResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1> spec;
  /// `status` is the current status of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  late final pulumi.Output<PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1alpha1?> status;
  ...
  PriorityLevelConfigurationResource(
    ...
    this.spec = registerOutput<PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1>('spec');
    this.status = registerOutput<PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1alpha1?>('status');
  }
}
