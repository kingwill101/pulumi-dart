...
class LimitedPriorityLevelConfiguration {
  ...
  /// Creates a new [LimitedPriorityLevelConfiguration].
  ...
  factory LimitedPriorityLevelConfiguration.fromMap(Map<String, dynamic> map) {
    return LimitedPriorityLevelConfiguration(
      ...
      limitResponse: map['limitResponse'] == null ? null : LimitResponse.fromMap((map['limitResponse'] as Map).cast<String, dynamic>()),
