...
class PriorityLevelConfigurationSpec {
  ...
  final ExemptPriorityLevelConfiguration? exempt;
  ...
  factory PriorityLevelConfigurationSpec.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpec(
      exempt: map['exempt'] == null ? null : ExemptPriorityLevelConfiguration.fromMap((map['exempt'] as Map).cast<String, dynamic>()),
      limited: map['limited'] == null ? null : LimitedPriorityLevelConfiguration.fromMap((map['limited'] as Map).cast<String, dynamic>()),
