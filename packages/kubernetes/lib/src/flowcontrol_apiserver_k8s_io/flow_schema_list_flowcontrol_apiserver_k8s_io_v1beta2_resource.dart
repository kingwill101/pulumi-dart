...
class FlowSchemaListFlowcontrolApiserverK8sIoV1beta2Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FlowSchemaFlowcontrolApiserverK8sIoV1beta2Resource>> items;
  ...
  FlowSchemaListFlowcontrolApiserverK8sIoV1beta2Resource(
    ...
    this.items = registerOutput<List<FlowSchemaFlowcontrolApiserverK8sIoV1beta2Resource>>('items');
