...
class QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  /// Creates a new [QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1].
  ...
  QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1({
    this.handSize,
  ...
  factory QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1(
      handSize: map['handSize'] == null ? null : map['handSize'] as int,
      queueLengthLimit: map['queueLengthLimit'] == null ? null : map['queueLengthLimit'] as int,
      queues: map['queues'] == null ? null : map['queues'] as int,
    );
  }
}
