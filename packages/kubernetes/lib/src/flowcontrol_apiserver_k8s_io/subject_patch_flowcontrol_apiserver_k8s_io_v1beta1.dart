...
class SubjectPatchFlowcontrolApiserverK8sIoV1beta1 {
  final GroupSubjectPatchFlowcontrolApiserverK8sIoV1beta1? group;
  /// Required
  final String? kind;
  final ServiceAccountSubjectPatchFlowcontrolApiserverK8sIoV1beta1? serviceAccount;
  final UserSubjectPatchFlowcontrolApiserverK8sIoV1beta1? user;
  ...
  factory SubjectPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return SubjectPatchFlowcontrolApiserverK8sIoV1beta1(
      group: map['group'] == null ? null : GroupSubjectPatchFlowcontrolApiserverK8sIoV1beta1.fromMap((map['group'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      serviceAccount: map['serviceAccount'] == null ? null : ServiceAccountSubjectPatchFlowcontrolApiserverK8sIoV1beta1.fromMap((map['serviceAccount'] as Map).cast<String, dynamic>()),
      user: map['user'] == null ? null : UserSubjectPatchFlowcontrolApiserverK8sIoV1beta1.fromMap((map['user'] as Map).cast<String, dynamic>()),
    );
  }
}
