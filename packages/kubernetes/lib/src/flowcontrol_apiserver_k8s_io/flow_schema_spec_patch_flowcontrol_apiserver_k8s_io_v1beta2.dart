...
class FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta2 {
  ...
  final FlowDistinguisherMethodPatchFlowcontrolApiserverK8sIoV1beta2? distinguisherMethod;
  ...
  final PriorityLevelConfigurationReferencePatchFlowcontrolApiserverK8sIoV1beta2? priorityLevelConfiguration;
  /// `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
  final List<PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta2>? rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?rules == null ? null : pulumi.Input.encodeList<PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta2, Map<String, dynamic>>(rules!, (value) => value.toMap()),
    };
  }
  ...
  factory FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta2(
      distinguisherMethod: map['distinguisherMethod'] == null ? null : FlowDistinguisherMethodPatchFlowcontrolApiserverK8sIoV1beta2.fromMap((map['distinguisherMethod'] as Map).cast<String, dynamic>()),
      matchingPrecedence: map['matchingPrecedence'] == null ? null : map['matchingPrecedence'] as int,
      priorityLevelConfiguration: map['priorityLevelConfiguration'] == null ? null : PriorityLevelConfigurationReferencePatchFlowcontrolApiserverK8sIoV1beta2.fromMap((map['priorityLevelConfiguration'] as Map).cast<String, dynamic>()),
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta2>(map['rules'], (value) => PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
