...
class FlowSchemaListFlowcontrolApiserverK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FlowSchemaFlowcontrolApiserverK8sIoV1beta1Resource>> items;
  ...
  FlowSchemaListFlowcontrolApiserverK8sIoV1beta1Resource(
    ...
    this.items = registerOutput<List<FlowSchemaFlowcontrolApiserverK8sIoV1beta1Resource>>('items');
