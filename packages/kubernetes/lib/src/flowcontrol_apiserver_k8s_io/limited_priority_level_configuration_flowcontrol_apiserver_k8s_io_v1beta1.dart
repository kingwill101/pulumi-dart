...
import 'limit_response_flowcontrol_apiserver_k8s_io_v1beta1.dart';

/// LimitedPriorityLevelConfiguration specifies how to handle requests that are subject to limits. It addresses two issues:
/// * How are requests for this priority level limited?
/// * What should be done with requests that exceed the limit?
class LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final LimitResponseFlowcontrolApiserverK8sIoV1beta1? limitResponse;

  /// Creates a new [LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta1].
  ...
  LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta1({
  ...
  factory LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta1(
      ...
      limitResponse: map['limitResponse'] == null ? null : LimitResponseFlowcontrolApiserverK8sIoV1beta1.fromMap((map['limitResponse'] as Map).cast<String, dynamic>()),
    );
  }
}
