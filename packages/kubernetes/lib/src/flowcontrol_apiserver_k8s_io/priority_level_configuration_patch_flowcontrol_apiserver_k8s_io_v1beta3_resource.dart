...
class PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3Resource extends pulumi.CustomResource {
  ...
  PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3Resource(
    ...
    this.spec = registerOutput<PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3?>('spec');
    this.status = registerOutput<PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta3?>('status');
  }
}
