...
class FlowSchemaFlowcontrolApiserverK8sIoV1beta3Resource extends pulumi.CustomResource {
  ...
  FlowSchemaFlowcontrolApiserverK8sIoV1beta3Resource(
    ...
    this.spec = registerOutput<FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3>('spec');
    this.status = registerOutput<FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3?>('status');
  }
}
