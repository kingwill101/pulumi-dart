...
class ClusterRolePatchRbacAuthorizationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  ClusterRolePatchRbacAuthorizationK8sIoV1beta1Resource(
    ...
    this.aggregationRule = registerOutput<AggregationRulePatchRbacAuthorizationK8sIoV1beta1?>('aggregationRule');
    this.apiVersion = registerOutput<String?>('apiVersion');
    this.kind = registerOutput<String?>('kind');
    this.metadata = registerOutput<ObjectMetaPatch?>('metadata');
    this.rules = registerOutput<List<PolicyRulePatchRbacAuthorizationK8sIoV1beta1>?>('rules');
  }
}
