...
class RoleListRbacAuthorizationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RoleRbacAuthorizationK8sIoV1beta1Resource>> items;
  ...
  RoleListRbacAuthorizationK8sIoV1beta1Resource(
    ...
    this.items = registerOutput<List<RoleRbacAuthorizationK8sIoV1beta1Resource>>('items');
