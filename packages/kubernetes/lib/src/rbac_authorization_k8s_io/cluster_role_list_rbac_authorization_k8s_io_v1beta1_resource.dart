...
class ClusterRoleListRbacAuthorizationK8sIoV1beta1Resource extends pulumi.CustomResource {
  /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  late final pulumi.Output<String> apiVersion;
  /// Items is a list of ClusterRoles
  late final pulumi.Output<List<ClusterRoleRbacAuthorizationK8sIoV1beta1Resource>> items;
  ...
  ClusterRoleListRbacAuthorizationK8sIoV1beta1Resource(
    ...
    this.items = registerOutput<List<ClusterRoleRbacAuthorizationK8sIoV1beta1Resource>>('items');
