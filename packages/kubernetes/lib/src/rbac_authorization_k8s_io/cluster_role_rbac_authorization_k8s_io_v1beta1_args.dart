...
/// {@template pulumi_rbac_authorization_k8s_io_v1beta1_cluster_role_rbac_authorization_k8s_io_v1beta1_args_doc}
...
class ClusterRoleRbacAuthorizationK8sIoV1beta1Args {
  ...
  ClusterRoleRbacAuthorizationK8sIoV1beta1Args({
    AggregationRuleRbacAuthorizationK8sIoV1beta1? aggregationRule,
    String? apiVersion,
    String? kind,
    ObjectMeta? metadata,
    List<PolicyRuleRbacAuthorizationK8sIoV1beta1>? rules,
  }) :
      aggregationRule = pulumi.Input.asOptionalInput<AggregationRuleRbacAuthorizationK8sIoV1beta1>(aggregationRule),
  ...
  factory ClusterRoleRbacAuthorizationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterRoleRbacAuthorizationK8sIoV1beta1Args(
