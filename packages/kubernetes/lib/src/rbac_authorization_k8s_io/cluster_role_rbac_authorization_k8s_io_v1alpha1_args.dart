...
class ClusterRoleRbacAuthorizationK8sIoV1alpha1Args {
  ...
  ClusterRoleRbacAuthorizationK8sIoV1alpha1Args({
    AggregationRuleRbacAuthorizationK8sIoV1alpha1? aggregationRule,
    String? apiVersion,
    String? kind,
    ObjectMeta? metadata,
  ...
  factory ClusterRoleRbacAuthorizationK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ClusterRoleRbacAuthorizationK8sIoV1alpha1Args(
      aggregationRule: map['aggregationRule'] == null ? null : AggregationRuleRbacAuthorizationK8sIoV1alpha1.fromMap((map['aggregationRule'] as Map).cast<String, dynamic>()),
