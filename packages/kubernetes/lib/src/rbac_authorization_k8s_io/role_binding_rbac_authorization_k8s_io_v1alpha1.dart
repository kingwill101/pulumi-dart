...
class RoleBindingRbacAuthorizationK8sIoV1alpha1 {
  ...
  /// Creates a new [RoleBindingRbacAuthorizationK8sIoV1alpha1].
  ...
  RoleBindingRbacAuthorizationK8sIoV1alpha1({
    this.apiVersion,
    this.kind,
    this.metadata,
  ...
  factory RoleBindingRbacAuthorizationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RoleBindingRbacAuthorizationK8sIoV1alpha1(
