...
class RoleBindingPatchRbacAuthorizationK8sIoV1alpha1 {
  ...
  final RoleRefPatchRbacAuthorizationK8sIoV1alpha1? roleRef;
  /// Subjects holds references to the objects the role applies to.
  final List<SubjectPatchRbacAuthorizationK8sIoV1alpha1>? subjects;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subjects': ?subjects == null ? null : pulumi.Input.encodeList<SubjectPatchRbacAuthorizationK8sIoV1alpha1, Map<String, dynamic>>(subjects!, (value) => value.toMap()),
    };
  }
  ...
  factory RoleBindingPatchRbacAuthorizationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RoleBindingPatchRbacAuthorizationK8sIoV1alpha1(
      ...
      roleRef: map['roleRef'] == null ? null : RoleRefPatchRbacAuthorizationK8sIoV1alpha1.fromMap((map['roleRef'] as Map).cast<String, dynamic>()),
      subjects: map['subjects'] == null ? null : pulumi.Input.decodeList<SubjectPatchRbacAuthorizationK8sIoV1alpha1>(map['subjects'], (value) => SubjectPatchRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
