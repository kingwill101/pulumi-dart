...
import 'cluster_role_binding_patch_rbac_authorization_k8s_io_v1alpha1_args.dart';
...
class ClusterRoleBindingPatchResource extends pulumi.CustomResource {
  ...
  /// Creates a new [ClusterRoleBindingPatchResource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ClusterRoleBindingPatchResource]. {@macro pulumi_rbac_authorization_k8s_io_v1alpha1_cluster_role_binding_patch_rbac_authorization_k8s_io_v1alpha1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ClusterRoleBindingPatchResource(
    String name, {
    ClusterRoleBindingPatchRbacAuthorizationK8sIoV1alpha1Args? args,
