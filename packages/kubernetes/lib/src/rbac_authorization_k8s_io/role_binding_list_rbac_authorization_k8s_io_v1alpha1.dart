...
class RoleBindingListRbacAuthorizationK8sIoV1alpha1 {
  ...
  final List<RoleBindingRbacAuthorizationK8sIoV1alpha1> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<RoleBindingRbacAuthorizationK8sIoV1alpha1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory RoleBindingListRbacAuthorizationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RoleBindingListRbacAuthorizationK8sIoV1alpha1(
      ...
      items: pulumi.Input.decodeList<RoleBindingRbacAuthorizationK8sIoV1alpha1>(map['items'], (value) => RoleBindingRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
