...
import 'deployment_strategy_patch_apps_v1beta2.dart';

/// DeploymentSpec is the specification of the desired behavior of the Deployment.
class DeploymentSpecPatchAppsV1beta2 {
  ...
  final DeploymentStrategyPatchAppsV1beta2? strategy;
  /// Template describes the pods that will be created.
  final PodTemplateSpecPatch? template;

  /// Creates a new [DeploymentSpecPatchAppsV1beta2].
  ...
  factory DeploymentSpecPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentSpecPatchAppsV1beta2(
      ...
      strategy: map['strategy'] == null ? null : DeploymentStrategyPatchAppsV1beta2.fromMap((map['strategy'] as Map).cast<String, dynamic>()),
