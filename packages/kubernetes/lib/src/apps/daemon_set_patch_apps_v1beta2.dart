...
class DaemonSetPatchAppsV1beta2 {
  ...
  final DaemonSetSpecPatchAppsV1beta2? spec;
  /// The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final DaemonSetStatusPatchAppsV1beta2? status;
  ...
  factory DaemonSetPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DaemonSetPatchAppsV1beta2(
      ...
      spec: map['spec'] == null ? null : DaemonSetSpecPatchAppsV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : DaemonSetStatusPatchAppsV1beta2.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
