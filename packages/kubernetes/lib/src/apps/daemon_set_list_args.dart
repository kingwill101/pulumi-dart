...
import 'daemon_set_apps_v1.dart';

/// {@template pulumi_apps_v1_daemon_set_list_args_doc}
/// The set of arguments for DaemonSetList.
/// {@endtemplate}
/// {@macro pulumi_apps_v1_daemon_set_list_args_doc}
class DaemonSetListArgs {
  /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  final pulumi.Input<String>? apiVersion;
  /// A list of daemon sets.
  final pulumi.Input<List<DaemonSetAppsV1>> items;
  ...
  DaemonSetListArgs({
    String? apiVersion,
    required List<DaemonSetAppsV1> items,
    String? kind,
    ListMeta? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<DaemonSetAppsV1>>(items),
  ...
  factory DaemonSetListArgs.fromMap(Map<String, dynamic> map) {
    return DaemonSetListArgs(
      ...
      items: (map['items'] as List).cast<DaemonSetAppsV1>(),
