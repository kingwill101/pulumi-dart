...
class StatefulSetStatusPatchAppsV1beta1 {
  ...
  final List<StatefulSetConditionPatchAppsV1beta1>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<StatefulSetConditionPatchAppsV1beta1, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory StatefulSetStatusPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetStatusPatchAppsV1beta1(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<StatefulSetConditionPatchAppsV1beta1>(map['conditions'], (value) => StatefulSetConditionPatchAppsV1beta1.fromMap((value as Map).cast<String, dynamic>())),
