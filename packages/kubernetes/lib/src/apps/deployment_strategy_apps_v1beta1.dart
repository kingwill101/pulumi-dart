...
class DeploymentStrategyAppsV1beta1 {
  ...
  final RollingUpdateDeploymentAppsV1beta1? rollingUpdate;
  ...
  factory DeploymentStrategyAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentStrategyAppsV1beta1(
      rollingUpdate: map['rollingUpdate'] == null ? null : RollingUpdateDeploymentAppsV1beta1.fromMap((map['rollingUpdate'] as Map).cast<String, dynamic>()),
