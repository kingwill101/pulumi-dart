...
class DeploymentConditionPatchAppsV1beta1 {
  ...
  DeploymentConditionPatchAppsV1beta1({
  ...
  factory DeploymentConditionPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentConditionPatchAppsV1beta1(
