...
class StatefulSetSpecAppsV1beta1 {
  ...
  final StatefulSetUpdateStrategyAppsV1beta1? updateStrategy;
  ...
  factory StatefulSetSpecAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecAppsV1beta1(
      ...
      updateStrategy: map['updateStrategy'] == null ? null : StatefulSetUpdateStrategyAppsV1beta1.fromMap((map['updateStrategy'] as Map).cast<String, dynamic>()),
