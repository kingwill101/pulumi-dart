...
/// {@template pulumi_apps_v1beta1_controller_revision_patch_apps_v1beta1_args_doc}
/// The set of arguments for ControllerRevisionPatch.
/// {@endtemplate}
/// {@macro pulumi_apps_v1beta1_controller_revision_patch_apps_v1beta1_args_doc}
class ControllerRevisionPatchAppsV1beta1Args {
  ...
  /// Creates a new [ControllerRevisionPatchAppsV1beta1Args].
  ...
  ControllerRevisionPatchAppsV1beta1Args({
    String? apiVersion,
    dynamic data,
    String? kind,
