...
class StatefulSetSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'volumeClaimTemplates': ?volumeClaimTemplates == null ? null : pulumi.Input.encodeList<PersistentVolumeClaim, Map<String, dynamic>>(volumeClaimTemplates!, (value) => value.toMap()),
    };
  }
  ...
  factory StatefulSetSpec.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpec(
      ...
      ordinals: map['ordinals'] == null ? null : StatefulSetOrdinals.fromMap((map['ordinals'] as Map).cast<String, dynamic>()),
      persistentVolumeClaimRetentionPolicy: map['persistentVolumeClaimRetentionPolicy'] == null ? null : StatefulSetPersistentVolumeClaimRetentionPolicy.fromMap((map['persistentVolumeClaimRetentionPolicy'] as Map).cast<String, dynamic>()),
      ...
      updateStrategy: map['updateStrategy'] == null ? null : StatefulSetUpdateStrategy.fromMap((map['updateStrategy'] as Map).cast<String, dynamic>()),
      volumeClaimTemplates: map['volumeClaimTemplates'] == null ? null : pulumi.Input.decodeList<PersistentVolumeClaim>(map['volumeClaimTemplates'], (value) => PersistentVolumeClaim.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
