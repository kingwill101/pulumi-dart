...
class StatefulSetSpecAppsV1beta2 {
  ...
  final StatefulSetUpdateStrategyAppsV1beta2? updateStrategy;
  ...
  factory StatefulSetSpecAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecAppsV1beta2(
      ...
      updateStrategy: map['updateStrategy'] == null ? null : StatefulSetUpdateStrategyAppsV1beta2.fromMap((map['updateStrategy'] as Map).cast<String, dynamic>()),
