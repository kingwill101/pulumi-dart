...
import 'deployment_condition_apps_v1beta2.dart';
...
class DeploymentStatusAppsV1beta2 {
  ...
  final List<DeploymentConditionAppsV1beta2>? conditions;
  ...
  /// Creates a new [DeploymentStatusAppsV1beta2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<DeploymentConditionAppsV1beta2, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory DeploymentStatusAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusAppsV1beta2(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<DeploymentConditionAppsV1beta2>(map['conditions'], (value) => DeploymentConditionAppsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
