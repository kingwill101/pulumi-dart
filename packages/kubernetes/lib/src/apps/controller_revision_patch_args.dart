...
/// {@template pulumi_apps_v1_controller_revision_patch_args_doc}
/// The set of arguments for ControllerRevisionPatch.
/// {@endtemplate}
/// {@macro pulumi_apps_v1_controller_revision_patch_args_doc}
class ControllerRevisionPatchArgs {
  ...
  /// Creates a new [ControllerRevisionPatchArgs].
  ...
  factory ControllerRevisionPatchArgs.fromMap(Map<String, dynamic> map) {
    return ControllerRevisionPatchArgs(
