...
class StorageVersionMigrationResource extends pulumi.CustomResource {
  ...
  StorageVersionMigrationResource(
    ...
    this.spec = registerOutput<StorageVersionMigrationSpecStoragemigrationK8sIoV1beta1>('spec');
    this.status = registerOutput<StorageVersionMigrationStatusStoragemigrationK8sIoV1beta1?>('status');
  }
}
