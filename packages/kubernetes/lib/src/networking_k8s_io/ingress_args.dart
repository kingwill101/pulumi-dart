...
/// {@template pulumi_networking_k8s_io_v1_ingress_args_doc}
/// The set of arguments for Ingress.
/// {@endtemplate}
/// {@macro pulumi_networking_k8s_io_v1_ingress_args_doc}
class IngressArgs {
  ...
  factory IngressArgs.fromMap(Map<String, dynamic> map) {
    return IngressArgs(
      ...
      spec: map['spec'] == null ? null : IngressSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
