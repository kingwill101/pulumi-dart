...
class ServiceCIDR {
  ...
  factory ServiceCIDR.fromMap(Map<String, dynamic> map) {
    return ServiceCIDR(
      ...
      spec: map['spec'] == null ? null : ServiceCIDRSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : ServiceCIDRStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
