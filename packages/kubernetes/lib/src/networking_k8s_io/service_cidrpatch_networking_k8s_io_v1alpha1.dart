...
class ServiceCIDRPatchNetworkingK8sIoV1alpha1 {
  ...
  final ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1? spec;
  /// status represents the current state of the ServiceCIDR. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final ServiceCIDRStatusPatchNetworkingK8sIoV1alpha1? status;
  ...
  factory ServiceCIDRPatchNetworkingK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ServiceCIDRPatchNetworkingK8sIoV1alpha1(
      ...
      status: map['status'] == null ? null : ServiceCIDRStatusPatchNetworkingK8sIoV1alpha1.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
