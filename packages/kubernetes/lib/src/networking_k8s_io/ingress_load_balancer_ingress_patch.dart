...
class IngressLoadBalancerIngressPatch {
  ...
  final List<IngressPortStatusPatch>? ports;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hostname': ?hostname,
      'ip': ?ip,
      'ports': ?ports == null ? null : pulumi.Input.encodeList<IngressPortStatusPatch, Map<String, dynamic>>(ports!, (value) => value.toMap()),
    };
  }
  ...
  factory IngressLoadBalancerIngressPatch.fromMap(Map<String, dynamic> map) {
    return IngressLoadBalancerIngressPatch(
      ...
      ports: map['ports'] == null ? null : pulumi.Input.decodeList<IngressPortStatusPatch>(map['ports'], (value) => IngressPortStatusPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
