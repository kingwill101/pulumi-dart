...
/// {@template pulumi_networking_k8s_io_v1_network_policy_args_doc}
/// The set of arguments for NetworkPolicy.
/// {@endtemplate}
/// {@macro pulumi_networking_k8s_io_v1_network_policy_args_doc}
class NetworkPolicyArgs {
  ...
  factory NetworkPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NetworkPolicyArgs(
      ...
      spec: map['spec'] == null ? null : NetworkPolicySpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
