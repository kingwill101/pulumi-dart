...
class IngressRulePatchNetworkingK8sIoV1beta1 {
  ...
  final String? host;
  final HTTPIngressRuleValuePatchNetworkingK8sIoV1beta1? http;
  ...
  factory IngressRulePatchNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return IngressRulePatchNetworkingK8sIoV1beta1(
      ...
      http: map['http'] == null ? null : HTTPIngressRuleValuePatchNetworkingK8sIoV1beta1.fromMap((map['http'] as Map).cast<String, dynamic>()),
    );
  }
}
