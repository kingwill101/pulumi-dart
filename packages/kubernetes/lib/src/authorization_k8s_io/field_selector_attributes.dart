...
import '../meta/field_selector_requirement.dart';
...
class FieldSelectorAttributes {
  ...
  /// Creates a new [FieldSelectorAttributes].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requirements': ?requirements == null ? null : pulumi.Input.encodeList<FieldSelectorRequirement, Map<String, dynamic>>(requirements!, (value) => value.toMap()),
    };
  }

  factory FieldSelectorAttributes.fromMap(Map<String, dynamic> map) {
    return FieldSelectorAttributes(
      rawSelector: map['rawSelector'] == null ? null : map['rawSelector'] as String,
      requirements: map['requirements'] == null ? null : pulumi.Input.decodeList<FieldSelectorRequirement>(map['requirements'], (value) => FieldSelectorRequirement.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
