...
class LabelSelectorAttributesPatch {
  ...
  final List<LabelSelectorRequirementPatch>? requirements;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requirements': ?requirements == null ? null : pulumi.Input.encodeList<LabelSelectorRequirementPatch, Map<String, dynamic>>(requirements!, (value) => value.toMap()),
    };
  }
  ...
  factory LabelSelectorAttributesPatch.fromMap(Map<String, dynamic> map) {
    return LabelSelectorAttributesPatch(
      ...
      requirements: map['requirements'] == null ? null : pulumi.Input.decodeList<LabelSelectorRequirementPatch>(map['requirements'], (value) => LabelSelectorRequirementPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
