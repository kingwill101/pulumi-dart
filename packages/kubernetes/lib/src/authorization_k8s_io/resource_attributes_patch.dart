...
class ResourceAttributesPatch {
  ...
  final FieldSelectorAttributesPatch? fieldSelector;
  /// Group is the API Group of the Resource.  "*" means all.
  final String? group;
  /// labelSelector describes the limitation on access based on labels.  It can only limit access, not broaden it.
  final LabelSelectorAttributesPatch? labelSelector;
  ...
  factory ResourceAttributesPatch.fromMap(Map<String, dynamic> map) {
    return ResourceAttributesPatch(
      fieldSelector: map['fieldSelector'] == null ? null : FieldSelectorAttributesPatch.fromMap((map['fieldSelector'] as Map).cast<String, dynamic>()),
      group: map['group'] == null ? null : map['group'] as String,
      labelSelector: map['labelSelector'] == null ? null : LabelSelectorAttributesPatch.fromMap((map['labelSelector'] as Map).cast<String, dynamic>()),
