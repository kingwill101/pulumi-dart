...
class FieldSelectorAttributesPatch {
  ...
  final List<FieldSelectorRequirementPatch>? requirements;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requirements': ?requirements == null ? null : pulumi.Input.encodeList<FieldSelectorRequirementPatch, Map<String, dynamic>>(requirements!, (value) => value.toMap()),
    };
  }
  ...
  factory FieldSelectorAttributesPatch.fromMap(Map<String, dynamic> map) {
    return FieldSelectorAttributesPatch(
      ...
      requirements: map['requirements'] == null ? null : pulumi.Input.decodeList<FieldSelectorRequirementPatch>(map['requirements'], (value) => FieldSelectorRequirementPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
