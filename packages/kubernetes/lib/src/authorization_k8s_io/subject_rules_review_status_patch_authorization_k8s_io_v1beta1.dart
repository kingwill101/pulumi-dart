...
class SubjectRulesReviewStatusPatchAuthorizationK8sIoV1beta1 {
  ...
  final List<NonResourceRulePatchAuthorizationK8sIoV1beta1>? nonResourceRules;
  /// ResourceRules is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
  final List<ResourceRulePatchAuthorizationK8sIoV1beta1>? resourceRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nonResourceRules': ?nonResourceRules == null ? null : pulumi.Input.encodeList<NonResourceRulePatchAuthorizationK8sIoV1beta1, Map<String, dynamic>>(nonResourceRules!, (value) => value.toMap()),
      'resourceRules': ?resourceRules == null ? null : pulumi.Input.encodeList<ResourceRulePatchAuthorizationK8sIoV1beta1, Map<String, dynamic>>(resourceRules!, (value) => value.toMap()),
    };
  }
  ...
  factory SubjectRulesReviewStatusPatchAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return SubjectRulesReviewStatusPatchAuthorizationK8sIoV1beta1(
      ...
      nonResourceRules: map['nonResourceRules'] == null ? null : pulumi.Input.decodeList<NonResourceRulePatchAuthorizationK8sIoV1beta1>(map['nonResourceRules'], (value) => NonResourceRulePatchAuthorizationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      resourceRules: map['resourceRules'] == null ? null : pulumi.Input.decodeList<ResourceRulePatchAuthorizationK8sIoV1beta1>(map['resourceRules'], (value) => ResourceRulePatchAuthorizationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
