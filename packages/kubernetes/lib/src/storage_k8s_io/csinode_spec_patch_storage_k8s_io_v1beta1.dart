...
class CSINodeSpecPatchStorageK8sIoV1beta1 {
  ...
  final List<CSINodeDriverPatchStorageK8sIoV1beta1>? drivers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'drivers': ?drivers == null ? null : pulumi.Input.encodeList<CSINodeDriverPatchStorageK8sIoV1beta1, Map<String, dynamic>>(drivers!, (value) => value.toMap()),
    };
  }

  factory CSINodeSpecPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeSpecPatchStorageK8sIoV1beta1(
      drivers: map['drivers'] == null ? null : pulumi.Input.decodeList<CSINodeDriverPatchStorageK8sIoV1beta1>(map['drivers'], (value) => CSINodeDriverPatchStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
