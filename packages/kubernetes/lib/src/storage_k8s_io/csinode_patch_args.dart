...
/// {@template pulumi_storage_k8s_io_v1_csinode_patch_args_doc}
/// The set of arguments for CSINodePatch.
/// {@endtemplate}
/// {@macro pulumi_storage_k8s_io_v1_csinode_patch_args_doc}
class CSINodePatchArgs {
  ...
  /// Creates a new [CSINodePatchArgs].
  ...
  factory CSINodePatchArgs.fromMap(Map<String, dynamic> map) {
    return CSINodePatchArgs(
