...
class CSIStorageCapacityListArgs {
  ...
  CSIStorageCapacityListArgs({
    String? apiVersion,
    required List<CSIStorageCapacityStorageK8sIoV1> items,
    String? kind,
    ListMeta? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<CSIStorageCapacityStorageK8sIoV1>>(items),
  ...
  factory CSIStorageCapacityListArgs.fromMap(Map<String, dynamic> map) {
    return CSIStorageCapacityListArgs(
      ...
      items: (map['items'] as List).cast<CSIStorageCapacityStorageK8sIoV1>(),
