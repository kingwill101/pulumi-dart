...
class VolumeAttachmentStorageK8sIoV1alpha1Args {
  ...
  VolumeAttachmentStorageK8sIoV1alpha1Args({
    String? apiVersion,
    String? kind,
    ObjectMeta? metadata,
    required VolumeAttachmentSpecStorageK8sIoV1alpha1 spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<VolumeAttachmentSpecStorageK8sIoV1alpha1>(spec);
  ...
  factory VolumeAttachmentStorageK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStorageK8sIoV1alpha1Args(
      ...
      spec: VolumeAttachmentSpecStorageK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
