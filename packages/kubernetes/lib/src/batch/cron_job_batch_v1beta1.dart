...
class CronJobBatchV1beta1 {
  ...
  final CronJobSpecBatchV1beta1? spec;
  /// Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final CronJobStatusBatchV1beta1? status;
  ...
  factory CronJobBatchV1beta1.fromMap(Map<String, dynamic> map) {
    return CronJobBatchV1beta1(
      ...
      spec: map['spec'] == null ? null : CronJobSpecBatchV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : CronJobStatusBatchV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
