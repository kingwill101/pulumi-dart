...
class JobStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<JobCondition, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
      'failed': ?failed,
  ...
  factory JobStatus.fromMap(Map<String, dynamic> map) {
    return JobStatus(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<JobCondition>(map['conditions'], (value) => JobCondition.fromMap((value as Map).cast<String, dynamic>())),
      ...
      uncountedTerminatedPods: map['uncountedTerminatedPods'] == null ? null : UncountedTerminatedPods.fromMap((map['uncountedTerminatedPods'] as Map).cast<String, dynamic>()),
    );
  }
}
