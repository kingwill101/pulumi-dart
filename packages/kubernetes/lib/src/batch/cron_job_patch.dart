...
class CronJobPatch {
  ...
  final CronJobSpecPatch? spec;
  /// Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final CronJobStatusPatch? status;
  ...
  factory CronJobPatch.fromMap(Map<String, dynamic> map) {
    return CronJobPatch(
      ...
      status: map['status'] == null ? null : CronJobStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
