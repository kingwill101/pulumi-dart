...
class JobStatusPatch {
  ...
  final List<JobConditionPatch>? conditions;
  ...
  final UncountedTerminatedPodsPatch? uncountedTerminatedPods;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<JobConditionPatch, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
      'failed': ?failed,
      ...
      'uncountedTerminatedPods': ?uncountedTerminatedPods == null ? null : uncountedTerminatedPods!.toMap(),
    };
  }

  factory JobStatusPatch.fromMap(Map<String, dynamic> map) {
    return JobStatusPatch(
      active: map['active'] == null ? null : map['active'] as int,
      completedIndexes: map['completedIndexes'] == null ? null : map['completedIndexes'] as String,
      completionTime: map['completionTime'] == null ? null : map['completionTime'] as String,
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<JobConditionPatch>(map['conditions'], (value) => JobConditionPatch.fromMap((value as Map).cast<String, dynamic>())),
      failed: map['failed'] == null ? null : map['failed'] as int,
      failedIndexes: map['failedIndexes'] == null ? null : map['failedIndexes'] as String,
      ready: map['ready'] == null ? null : map['ready'] as int,
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      succeeded: map['succeeded'] == null ? null : map['succeeded'] as int,
      terminating: map['terminating'] == null ? null : map['terminating'] as int,
      uncountedTerminatedPods: map['uncountedTerminatedPods'] == null ? null : UncountedTerminatedPodsPatch.fromMap((map['uncountedTerminatedPods'] as Map).cast<String, dynamic>()),
    );
  }
}
