...
class ReplicaSetExtensionsV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [ReplicaSetExtensionsV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ReplicaSetExtensionsV1beta1]. {@macro pulumi_extensions_v1beta1_replica_set_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ReplicaSetExtensionsV1beta1(
    String name, {
    ReplicaSetArgs? args,
