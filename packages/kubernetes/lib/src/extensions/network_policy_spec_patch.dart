...
class NetworkPolicySpecPatch {
  ...
  final List<NetworkPolicyEgressRulePatch>? egress;
  /// List of ingress rules to be applied to the selected pods. Traffic is allowed to a pod if there are no NetworkPolicies selecting the pod OR if the traffic source is the pod's local node, OR if the traffic matches at least one ingress rule across all of the NetworkPolicy objects whose podSelector matches the pod. If this field is empty then this NetworkPolicy does not allow any traffic (and serves solely to ensure that the pods it selects are isolated by default).
  final List<NetworkPolicyIngressRulePatch>? ingress;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'egress': ?egress == null ? null : pulumi.Input.encodeList<NetworkPolicyEgressRulePatch, Map<String, dynamic>>(egress!, (value) => value.toMap()),
      'ingress': ?ingress == null ? null : pulumi.Input.encodeList<NetworkPolicyIngressRulePatch, Map<String, dynamic>>(ingress!, (value) => value.toMap()),
  ...
  factory NetworkPolicySpecPatch.fromMap(Map<String, dynamic> map) {
    return NetworkPolicySpecPatch(
      egress: map['egress'] == null ? null : pulumi.Input.decodeList<NetworkPolicyEgressRulePatch>(map['egress'], (value) => NetworkPolicyEgressRulePatch.fromMap((value as Map).cast<String, dynamic>())),
      ingress: map['ingress'] == null ? null : pulumi.Input.decodeList<NetworkPolicyIngressRulePatch>(map['ingress'], (value) => NetworkPolicyIngressRulePatch.fromMap((value as Map).cast<String, dynamic>())),
