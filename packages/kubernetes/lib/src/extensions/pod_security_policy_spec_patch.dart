...
class PodSecurityPolicySpecPatch {
  ...
  final List<AllowedCSIDriverPatch>? allowedCSIDrivers;
  ...
  final List<AllowedFlexVolumePatch>? allowedFlexVolumes;
  /// allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.
  final List<AllowedHostPathPatch>? allowedHostPaths;
  ...
  final FSGroupStrategyOptionsPatch? fsGroup;
  ...
  final List<HostPortRangePatch>? hostPorts;
  ...
  final RunAsGroupStrategyOptionsPatch? runAsGroup;
  /// runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
  final RunAsUserStrategyOptionsPatch? runAsUser;
  /// runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled.
  final RuntimeClassStrategyOptionsPatch? runtimeClass;
  /// seLinux is the strategy that will dictate the allowable labels that may be set.
  final SELinuxStrategyOptionsPatch? seLinux;
  /// supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
  final SupplementalGroupsStrategyOptionsPatch? supplementalGroups;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowedCSIDrivers': ?allowedCSIDrivers == null ? null : pulumi.Input.encodeList<AllowedCSIDriverPatch, Map<String, dynamic>>(allowedCSIDrivers!, (value) => value.toMap()),
      'allowedCapabilities': ?allowedCapabilities,
      'allowedFlexVolumes': ?allowedFlexVolumes == null ? null : pulumi.Input.encodeList<AllowedFlexVolumePatch, Map<String, dynamic>>(allowedFlexVolumes!, (value) => value.toMap()),
      'allowedHostPaths': ?allowedHostPaths == null ? null : pulumi.Input.encodeList<AllowedHostPathPatch, Map<String, dynamic>>(allowedHostPaths!, (value) => value.toMap()),
      ...
      'fsGroup': ?fsGroup == null ? null : fsGroup!.toMap(),
      'hostIPC': ?hostIPC,
      'hostNetwork': ?hostNetwork,
      'hostPID': ?hostPID,
      'hostPorts': ?hostPorts == null ? null : pulumi.Input.encodeList<HostPortRangePatch, Map<String, dynamic>>(hostPorts!, (value) => value.toMap()),
      'privileged': ?privileged,
      'readOnlyRootFilesystem': ?readOnlyRootFilesystem,
      'requiredDropCapabilities': ?requiredDropCapabilities,
      'runAsGroup': ?runAsGroup == null ? null : runAsGroup!.toMap(),
      'runAsUser': ?runAsUser == null ? null : runAsUser!.toMap(),
      'runtimeClass': ?runtimeClass == null ? null : runtimeClass!.toMap(),
      'seLinux': ?seLinux == null ? null : seLinux!.toMap(),
      'supplementalGroups': ?supplementalGroups == null ? null : supplementalGroups!.toMap(),
      'volumes': ?volumes,
    };
  }
  ...
  factory PodSecurityPolicySpecPatch.fromMap(Map<String, dynamic> map) {
    return PodSecurityPolicySpecPatch(
      ...
      allowedCSIDrivers: map['allowedCSIDrivers'] == null ? null : pulumi.Input.decodeList<AllowedCSIDriverPatch>(map['allowedCSIDrivers'], (value) => AllowedCSIDriverPatch.fromMap((value as Map).cast<String, dynamic>())),
      allowedCapabilities: map['allowedCapabilities'] == null ? null : (map['allowedCapabilities'] as List).cast<String>(),
      allowedFlexVolumes: map['allowedFlexVolumes'] == null ? null : pulumi.Input.decodeList<AllowedFlexVolumePatch>(map['allowedFlexVolumes'], (value) => AllowedFlexVolumePatch.fromMap((value as Map).cast<String, dynamic>())),
      allowedHostPaths: map['allowedHostPaths'] == null ? null : pulumi.Input.decodeList<AllowedHostPathPatch>(map['allowedHostPaths'], (value) => AllowedHostPathPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      fsGroup: map['fsGroup'] == null ? null : FSGroupStrategyOptionsPatch.fromMap((map['fsGroup'] as Map).cast<String, dynamic>()),
      ...
      hostPorts: map['hostPorts'] == null ? null : pulumi.Input.decodeList<HostPortRangePatch>(map['hostPorts'], (value) => HostPortRangePatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      runAsGroup: map['runAsGroup'] == null ? null : RunAsGroupStrategyOptionsPatch.fromMap((map['runAsGroup'] as Map).cast<String, dynamic>()),
      runAsUser: map['runAsUser'] == null ? null : RunAsUserStrategyOptionsPatch.fromMap((map['runAsUser'] as Map).cast<String, dynamic>()),
      runtimeClass: map['runtimeClass'] == null ? null : RuntimeClassStrategyOptionsPatch.fromMap((map['runtimeClass'] as Map).cast<String, dynamic>()),
      seLinux: map['seLinux'] == null ? null : SELinuxStrategyOptionsPatch.fromMap((map['seLinux'] as Map).cast<String, dynamic>()),
      supplementalGroups: map['supplementalGroups'] == null ? null : SupplementalGroupsStrategyOptionsPatch.fromMap((map['supplementalGroups'] as Map).cast<String, dynamic>()),
