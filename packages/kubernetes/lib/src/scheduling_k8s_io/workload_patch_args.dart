...
class WorkloadPatchArgs {
  ...
  factory WorkloadPatchArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadPatchArgs(
      ...
      spec: map['spec'] == null ? null : WorkloadSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>()),
    );
  }
}
