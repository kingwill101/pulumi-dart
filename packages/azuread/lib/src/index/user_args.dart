...
class UserArgs {
  ...
  UserArgs({
    ...
    String? country,
    String? department,
    bool? disablePasswordExpiration,
    bool? disableStrongPassword,
    ...
    required String userPrincipalName,
      ...
      userPrincipalName = pulumi.Input.asInput<String>(userPrincipalName);
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      ...
      ageGroup: map['ageGroup'] == null ? null : map['ageGroup'] as String,
      businessPhones: map['businessPhones'] == null ? null : (map['businessPhones'] as List).cast<String>(),
      city: map['city'] == null ? null : map['city'] as String,
      companyName: map['companyName'] == null ? null : map['companyName'] as String,
      consentProvidedForMinor: map['consentProvidedForMinor'] == null ? null : map['consentProvidedForMinor'] as String,
      costCenter: map['costCenter'] == null ? null : map['costCenter'] as String,
      country: map['country'] == null ? null : map['country'] as String,
      department: map['department'] == null ? null : map['department'] as String,
      disablePasswordExpiration: map['disablePasswordExpiration'] == null ? null : map['disablePasswordExpiration'] as bool,
      disableStrongPassword: map['disableStrongPassword'] == null ? null : map['disableStrongPassword'] as bool,
      displayName: map['displayName'] as String,
      division: map['division'] == null ? null : map['division'] as String,
      employeeHireDate: map['employeeHireDate'] == null ? null : map['employeeHireDate'] as String,
      employeeId: map['employeeId'] == null ? null : map['employeeId'] as String,
      employeeType: map['employeeType'] == null ? null : map['employeeType'] as String,
      faxNumber: map['faxNumber'] == null ? null : map['faxNumber'] as String,
      forcePasswordChange: map['forcePasswordChange'] == null ? null : map['forcePasswordChange'] as bool,
      ...
      managerId: map['managerId'] == null ? null : map['managerId'] as String,
      mobilePhone: map['mobilePhone'] == null ? null : map['mobilePhone'] as String,
      officeLocation: map['officeLocation'] == null ? null : map['officeLocation'] as String,
      onpremisesImmutableId: map['onpremisesImmutableId'] == null ? null : map['onpremisesImmutableId'] as String,
      otherMails: map['otherMails'] == null ? null : (map['otherMails'] as List).cast<String>(),
      password: map['password'] == null ? null : map['password'] as String,
      postalCode: map['postalCode'] == null ? null : map['postalCode'] as String,
      preferredLanguage: map['preferredLanguage'] == null ? null : map['preferredLanguage'] as String,
      showInAddressList: map['showInAddressList'] == null ? null : map['showInAddressList'] as bool,
      ...
      usageLocation: map['usageLocation'] == null ? null : map['usageLocation'] as String,
