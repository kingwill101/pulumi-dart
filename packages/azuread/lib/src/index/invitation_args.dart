...
class InvitationArgs {
  ...
  factory InvitationArgs.fromMap(Map<String, dynamic> map) {
    return InvitationArgs(
      message: map['message'] == null ? null : InvitationMessage.fromMap((map['message'] as Map).cast<String, dynamic>()),
      redirectUrl: map['redirectUrl'] as String,
      userDisplayName: map['userDisplayName'] == null ? null : map['userDisplayName'] as String,
