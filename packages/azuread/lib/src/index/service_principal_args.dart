...
class ServicePrincipalArgs {
  ...
  ServicePrincipalArgs({
    ...
    String? description,
    List<ServicePrincipalFeatureTag>? featureTags,
    List<ServicePrincipalFeature>? features,
    String? loginUrl,
    String? notes,
  ...
  factory ServicePrincipalArgs.fromMap(Map<String, dynamic> map) {
    return ServicePrincipalArgs(
      accountEnabled: map['accountEnabled'] == null ? null : map['accountEnabled'] as bool,
      alternativeNames: map['alternativeNames'] == null ? null : (map['alternativeNames'] as List).cast<String>(),
      appRoleAssignmentRequired: map['appRoleAssignmentRequired'] == null ? null : map['appRoleAssignmentRequired'] as bool,
      clientId: map['clientId'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      featureTags: map['featureTags'] == null ? null : pulumi.Input.decodeList<ServicePrincipalFeatureTag>(map['featureTags'], (value) => ServicePrincipalFeatureTag.fromMap((value as Map).cast<String, dynamic>())),
      features: map['features'] == null ? null : pulumi.Input.decodeList<ServicePrincipalFeature>(map['features'], (value) => ServicePrincipalFeature.fromMap((value as Map).cast<String, dynamic>())),
      loginUrl: map['loginUrl'] == null ? null : map['loginUrl'] as String,
      notes: map['notes'] == null ? null : map['notes'] as String,
      notificationEmailAddresses: map['notificationEmailAddresses'] == null ? null : (map['notificationEmailAddresses'] as List).cast<String>(),
      owners: map['owners'] == null ? null : (map['owners'] as List).cast<String>(),
      preferredSingleSignOnMode: map['preferredSingleSignOnMode'] == null ? null : map['preferredSingleSignOnMode'] as String,
      samlSingleSignOn: map['samlSingleSignOn'] == null ? null : ServicePrincipalSamlSingleSignOn.fromMap((map['samlSingleSignOn'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      useExisting: map['useExisting'] == null ? null : map['useExisting'] as bool,
    );
  }
}
