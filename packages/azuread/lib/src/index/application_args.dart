...
class ApplicationArgs {
  ...
  ApplicationArgs({
    ApplicationApi? api,
    List<ApplicationAppRole>? appRoles,
    String? description,
    bool? deviceOnlyAuthEnabled,
    required String displayName,
    bool? fallbackPublicClientEnabled,
    List<ApplicationFeatureTag>? featureTags,
    ...
    List<ApplicationRequiredResourceAccess>? requiredResourceAccesses,
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      api: map['api'] == null ? null : ApplicationApi.fromMap((map['api'] as Map).cast<String, dynamic>()),
      appRoles: map['appRoles'] == null ? null : pulumi.Input.decodeList<ApplicationAppRole>(map['appRoles'], (value) => ApplicationAppRole.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      deviceOnlyAuthEnabled: map['deviceOnlyAuthEnabled'] == null ? null : map['deviceOnlyAuthEnabled'] as bool,
      displayName: map['displayName'] as String,
      fallbackPublicClientEnabled: map['fallbackPublicClientEnabled'] == null ? null : map['fallbackPublicClientEnabled'] as bool,
      featureTags: map['featureTags'] == null ? null : pulumi.Input.decodeList<ApplicationFeatureTag>(map['featureTags'], (value) => ApplicationFeatureTag.fromMap((value as Map).cast<String, dynamic>())),
      groupMembershipClaims: map['groupMembershipClaims'] == null ? null : (map['groupMembershipClaims'] as List).cast<String>(),
      identifierUris: map['identifierUris'] == null ? null : (map['identifierUris'] as List).cast<String>(),
      logoImage: map['logoImage'] == null ? null : map['logoImage'] as String,
      marketingUrl: map['marketingUrl'] == null ? null : map['marketingUrl'] as String,
      notes: map['notes'] == null ? null : map['notes'] as String,
      oauth2PostResponseRequired: map['oauth2PostResponseRequired'] == null ? null : map['oauth2PostResponseRequired'] as bool,
      optionalClaims: map['optionalClaims'] == null ? null : ApplicationOptionalClaims.fromMap((map['optionalClaims'] as Map).cast<String, dynamic>()),
      owners: map['owners'] == null ? null : (map['owners'] as List).cast<String>(),
      password: map['password'] == null ? null : ApplicationPassword.fromMap((map['password'] as Map).cast<String, dynamic>()),
      ...
      publicClient: map['publicClient'] == null ? null : ApplicationPublicClient.fromMap((map['publicClient'] as Map).cast<String, dynamic>()),
      requiredResourceAccesses: map['requiredResourceAccesses'] == null ? null : pulumi.Input.decodeList<ApplicationRequiredResourceAccess>(map['requiredResourceAccesses'], (value) => ApplicationRequiredResourceAccess.fromMap((value as Map).cast<String, dynamic>())),
      ...
      singlePageApplication: map['singlePageApplication'] == null ? null : ApplicationSinglePageApplication.fromMap((map['singlePageApplication'] as Map).cast<String, dynamic>()),
      ...
      web: map['web'] == null ? null : ApplicationWeb.fromMap((map['web'] as Map).cast<String, dynamic>()),
    );
  }
}
