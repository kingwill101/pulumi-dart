...
class ApplicationOptionalClaimsArgs {
  ...
  ApplicationOptionalClaimsArgs({
    List<ApplicationOptionalClaimsAccessToken>? accessTokens,
    required String applicationId,
    List<ApplicationOptionalClaimsIdToken>? idTokens,
    List<ApplicationOptionalClaimsSaml2Token>? saml2Tokens,
  }) :
