...
class ServicePrincipalDelegatedPermissionGrantArgs {
  ...
  ServicePrincipalDelegatedPermissionGrantArgs({
    ...
    required String resourceServicePrincipalObjectId,
    required String servicePrincipalObjectId,
    String? userObjectId,
  }) :
  ...
  factory ServicePrincipalDelegatedPermissionGrantArgs.fromMap(Map<String, dynamic> map) {
    return ServicePrincipalDelegatedPermissionGrantArgs(
      claimValues: (map['claimValues'] as List).cast<String>(),
      resourceServicePrincipalObjectId: map['resourceServicePrincipalObjectId'] as String,
      servicePrincipalObjectId: map['servicePrincipalObjectId'] as String,
