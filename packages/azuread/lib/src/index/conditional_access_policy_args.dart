...
class ConditionalAccessPolicyArgs {
  ...
  ConditionalAccessPolicyArgs({
    required ConditionalAccessPolicyConditions conditions,
    required String displayName,
    ConditionalAccessPolicyGrantControls? grantControls,
    ConditionalAccessPolicySessionControls? sessionControls,
  ...
  factory ConditionalAccessPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ConditionalAccessPolicyArgs(
      conditions: ConditionalAccessPolicyConditions.fromMap((map['conditions'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      grantControls: map['grantControls'] == null ? null : ConditionalAccessPolicyGrantControls.fromMap((map['grantControls'] as Map).cast<String, dynamic>()),
      sessionControls: map['sessionControls'] == null ? null : ConditionalAccessPolicySessionControls.fromMap((map['sessionControls'] as Map).cast<String, dynamic>()),
