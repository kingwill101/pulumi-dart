...
class ApplicationApi {
  ...
  final List<ApplicationApiOauth2PermissionScope>? oauth2PermissionScopes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oauth2PermissionScopes': ?oauth2PermissionScopes == null ? null : pulumi.Input.encodeList<ApplicationApiOauth2PermissionScope, Map<String, dynamic>>(oauth2PermissionScopes!, (value) => value.toMap()),
  ...
  factory ApplicationApi.fromMap(Map<String, dynamic> map) {
    return ApplicationApi(
      knownClientApplications: map['knownClientApplications'] == null ? null : (map['knownClientApplications'] as List).cast<String>(),
      mappedClaimsEnabled: map['mappedClaimsEnabled'] == null ? null : map['mappedClaimsEnabled'] as bool,
      oauth2PermissionScopes: map['oauth2PermissionScopes'] == null ? null : pulumi.Input.decodeList<ApplicationApiOauth2PermissionScope>(map['oauth2PermissionScopes'], (value) => ApplicationApiOauth2PermissionScope.fromMap((value as Map).cast<String, dynamic>())),
