...
class GetUsersArgs {
  ...
  factory GetUsersArgs.fromMap(Map<String, dynamic> map) {
    return GetUsersArgs(
      employeeIds: map['employeeIds'] == null ? null : (map['employeeIds'] as List).cast<String>(),
      ignoreMissing: map['ignoreMissing'] == null ? null : map['ignoreMissing'] as bool,
      mailNicknames: map['mailNicknames'] == null ? null : (map['mailNicknames'] as List).cast<String>(),
      mails: map['mails'] == null ? null : (map['mails'] as List).cast<String>(),
      ...
      userPrincipalNames: map['userPrincipalNames'] == null ? null : (map['userPrincipalNames'] as List).cast<String>(),
    );
  }
}
