...
class ApplicationRegistration extends pulumi.CustomResource {
  ...
  ApplicationRegistration(
    ...
    this.implicitAccessTokenIssuanceEnabled = registerOutput<bool?>('implicitAccessTokenIssuanceEnabled');
    this.implicitIdTokenIssuanceEnabled = registerOutput<bool?>('implicitIdTokenIssuanceEnabled');
    ...
    this.requestedAccessTokenVersion = registerOutput<int?>('requestedAccessTokenVersion');
