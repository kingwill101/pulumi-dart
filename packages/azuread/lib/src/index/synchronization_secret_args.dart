...
class SynchronizationSecretArgs {
  ...
  SynchronizationSecretArgs({
    List<SynchronizationSecretCredential>? credentials,
  ...
  factory SynchronizationSecretArgs.fromMap(Map<String, dynamic> map) {
    return SynchronizationSecretArgs(
      credentials: map['credentials'] == null ? null : pulumi.Input.decodeList<SynchronizationSecretCredential>(map['credentials'], (value) => SynchronizationSecretCredential.fromMap((value as Map).cast<String, dynamic>())),
