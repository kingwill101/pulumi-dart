...
class AdministrativeUnitRoleMemberArgs {
  ...
  AdministrativeUnitRoleMemberArgs({
    required String administrativeUnitObjectId,
    required String memberObjectId,
    required String roleObjectId,
  }) :
  ...
  factory AdministrativeUnitRoleMemberArgs.fromMap(Map<String, dynamic> map) {
    return AdministrativeUnitRoleMemberArgs(
      administrativeUnitObjectId: map['administrativeUnitObjectId'] as String,
      memberObjectId: map['memberObjectId'] as String,
      roleObjectId: map['roleObjectId'] as String,
    );
  }
}
