...
class AdministrativeUnitMemberArgs {
  ...
  factory AdministrativeUnitMemberArgs.fromMap(Map<String, dynamic> map) {
    return AdministrativeUnitMemberArgs(
      administrativeUnitObjectId: map['administrativeUnitObjectId'] == null ? null : map['administrativeUnitObjectId'] as String,
      memberObjectId: map['memberObjectId'] == null ? null : map['memberObjectId'] as String,
    );
  }
}
