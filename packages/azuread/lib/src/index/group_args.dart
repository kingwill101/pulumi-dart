...
class GroupArgs {
  ...
  GroupArgs({
    ...
    GroupDynamicMembership? dynamicMembership,
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      dynamicMembership: map['dynamicMembership'] == null ? null : GroupDynamicMembership.fromMap((map['dynamicMembership'] as Map).cast<String, dynamic>()),
