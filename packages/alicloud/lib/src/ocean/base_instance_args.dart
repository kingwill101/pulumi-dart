...
class BaseInstanceArgs {
  ...
  BaseInstanceArgs({
    ...
    required List<String> zones,
      ...
      diskSize = pulumi.Input.asInput<int>(diskSize),
      ...
      series = pulumi.Input.asInput<String>(series),
  ...
  factory BaseInstanceArgs.fromMap(Map<String, dynamic> map) {
    return BaseInstanceArgs(
      ...
      backupRetainMode: map['backupRetainMode'] == null ? null : map['backupRetainMode'] as String,
      cpuArch: map['cpuArch'] == null ? null : map['cpuArch'] as String,
      ...
      nodeNum: map['nodeNum'] == null ? null : map['nodeNum'] as String,
      obVersion: map['obVersion'] == null ? null : map['obVersion'] as String,
      paymentType: map['paymentType'] as String,
      period: map['period'] == null ? null : map['period'] as int,
      periodUnit: map['periodUnit'] == null ? null : map['periodUnit'] as String,
      primaryInstance: map['primaryInstance'] == null ? null : map['primaryInstance'] as String,
      primaryRegion: map['primaryRegion'] == null ? null : map['primaryRegion'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      series: map['series'] as String,
      upgradeSpecNative: map['upgradeSpecNative'] == null ? null : map['upgradeSpecNative'] as bool,
