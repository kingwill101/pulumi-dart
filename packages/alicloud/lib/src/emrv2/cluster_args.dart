...
class ClusterArgs {
  ...
  ClusterArgs({
    List<ClusterApplicationConfig>? applicationConfigs,
    required List<String> applications,
    List<ClusterBootstrapScript>? bootstrapScripts,
    required String clusterName,
    required String clusterType,
    bool? deletionProtection,
    String? deployMode,
    String? logCollectStrategy,
    required List<ClusterNodeAttribute> nodeAttributes,
    required List<ClusterNodeGroup> nodeGroups,
    String? paymentType,
    required String releaseVersion,
    String? resourceGroupId,
    String? securityMode,
    ClusterSubscriptionConfig? subscriptionConfig,
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      applicationConfigs: map['applicationConfigs'] == null ? null : pulumi.Input.decodeList<ClusterApplicationConfig>(map['applicationConfigs'], (value) => ClusterApplicationConfig.fromMap((value as Map).cast<String, dynamic>())),
      applications: (map['applications'] as List).cast<String>(),
      bootstrapScripts: map['bootstrapScripts'] == null ? null : pulumi.Input.decodeList<ClusterBootstrapScript>(map['bootstrapScripts'], (value) => ClusterBootstrapScript.fromMap((value as Map).cast<String, dynamic>())),
      ...
      deployMode: map['deployMode'] == null ? null : map['deployMode'] as String,
      logCollectStrategy: map['logCollectStrategy'] == null ? null : map['logCollectStrategy'] as String,
      nodeAttributes: pulumi.Input.decodeList<ClusterNodeAttribute>(map['nodeAttributes'], (value) => ClusterNodeAttribute.fromMap((value as Map).cast<String, dynamic>())),
      nodeGroups: pulumi.Input.decodeList<ClusterNodeGroup>(map['nodeGroups'], (value) => ClusterNodeGroup.fromMap((value as Map).cast<String, dynamic>())),
      ...
      securityMode: map['securityMode'] == null ? null : map['securityMode'] as String,
      subscriptionConfig: map['subscriptionConfig'] == null ? null : ClusterSubscriptionConfig.fromMap((map['subscriptionConfig'] as Map).cast<String, dynamic>()),
