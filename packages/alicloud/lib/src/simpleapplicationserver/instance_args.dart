...
/// {@template pulumi_simpleapplicationserver_instance_instance_args_doc}
/// The set of arguments for Instance.
/// {@endtemplate}
/// {@macro pulumi_simpleapplicationserver_instance_instance_args_doc}
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      dataDiskSize: map['dataDiskSize'] == null ? null : map['dataDiskSize'] as int,
