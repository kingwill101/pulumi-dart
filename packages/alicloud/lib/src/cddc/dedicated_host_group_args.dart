...
class DedicatedHostGroupArgs {
  ...
  factory DedicatedHostGroupArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedHostGroupArgs(
      ...
      cpuAllocationRatio: map['cpuAllocationRatio'] == null ? null : map['cpuAllocationRatio'] as int,
      dedicatedHostGroupDesc: map['dedicatedHostGroupDesc'] == null ? null : map['dedicatedHostGroupDesc'] as String,
      diskAllocationRatio: map['diskAllocationRatio'] == null ? null : map['diskAllocationRatio'] as int,
      engine: map['engine'] as String,
      hostReplacePolicy: map['hostReplacePolicy'] == null ? null : map['hostReplacePolicy'] as String,
      memAllocationRatio: map['memAllocationRatio'] == null ? null : map['memAllocationRatio'] as int,
      openPermission: map['openPermission'] == null ? null : map['openPermission'] as bool,
