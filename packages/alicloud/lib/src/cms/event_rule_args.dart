...
class EventRuleArgs {
  ...
  EventRuleArgs({
    List<EventRuleContactParameter>? contactParameters,
    String? description,
    required EventRuleEventPattern eventPattern,
    List<EventRuleFcParameter>? fcParameters,
    String? groupId,
    List<EventRuleMnsParameter>? mnsParameters,
    List<EventRuleOpenApiParameter>? openApiParameters,
    required String ruleName,
    int? silenceTime,
    List<EventRuleSlsParameter>? slsParameters,
    String? status,
    List<EventRuleWebhookParameter>? webhookParameters,
  }) :
  ...
  factory EventRuleArgs.fromMap(Map<String, dynamic> map) {
    return EventRuleArgs(
      contactParameters: map['contactParameters'] == null ? null : pulumi.Input.decodeList<EventRuleContactParameter>(map['contactParameters'], (value) => EventRuleContactParameter.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      eventPattern: EventRuleEventPattern.fromMap((map['eventPattern'] as Map).cast<String, dynamic>()),
      fcParameters: map['fcParameters'] == null ? null : pulumi.Input.decodeList<EventRuleFcParameter>(map['fcParameters'], (value) => EventRuleFcParameter.fromMap((value as Map).cast<String, dynamic>())),
      groupId: map['groupId'] == null ? null : map['groupId'] as String,
      mnsParameters: map['mnsParameters'] == null ? null : pulumi.Input.decodeList<EventRuleMnsParameter>(map['mnsParameters'], (value) => EventRuleMnsParameter.fromMap((value as Map).cast<String, dynamic>())),
      openApiParameters: map['openApiParameters'] == null ? null : pulumi.Input.decodeList<EventRuleOpenApiParameter>(map['openApiParameters'], (value) => EventRuleOpenApiParameter.fromMap((value as Map).cast<String, dynamic>())),
      ruleName: map['ruleName'] as String,
      silenceTime: map['silenceTime'] == null ? null : map['silenceTime'] as int,
      slsParameters: map['slsParameters'] == null ? null : pulumi.Input.decodeList<EventRuleSlsParameter>(map['slsParameters'], (value) => EventRuleSlsParameter.fromMap((value as Map).cast<String, dynamic>())),
      status: map['status'] == null ? null : map['status'] as String,
      webhookParameters: map['webhookParameters'] == null ? null : pulumi.Input.decodeList<EventRuleWebhookParameter>(map['webhookParameters'], (value) => EventRuleWebhookParameter.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
