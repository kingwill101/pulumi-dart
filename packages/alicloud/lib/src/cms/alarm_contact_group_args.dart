...
class AlarmContactGroupArgs {
  ...
  AlarmContactGroupArgs({
    required String alarmContactGroupName,
  ...
  factory AlarmContactGroupArgs.fromMap(Map<String, dynamic> map) {
    return AlarmContactGroupArgs(
      ...
      contacts: map['contacts'] == null ? null : (map['contacts'] as List).cast<String>(),
      describe: map['describe'] == null ? null : map['describe'] as String,
      enableSubscribed: map['enableSubscribed'] == null ? null : map['enableSubscribed'] as bool,
    );
  }
}
