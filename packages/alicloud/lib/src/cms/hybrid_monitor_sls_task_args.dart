...
class HybridMonitorSlsTaskArgs {
  ...
  HybridMonitorSlsTaskArgs({
    List<HybridMonitorSlsTaskAttachLabel>? attachLabels,
    int? collectInterval,
    required String collectTargetType,
    String? description,
    required String namespace,
    required HybridMonitorSlsTaskSlsProcessConfig slsProcessConfig,
  ...
  factory HybridMonitorSlsTaskArgs.fromMap(Map<String, dynamic> map) {
    return HybridMonitorSlsTaskArgs(
      attachLabels: map['attachLabels'] == null ? null : pulumi.Input.decodeList<HybridMonitorSlsTaskAttachLabel>(map['attachLabels'], (value) => HybridMonitorSlsTaskAttachLabel.fromMap((value as Map).cast<String, dynamic>())),
      collectInterval: map['collectInterval'] == null ? null : map['collectInterval'] as int,
      collectTargetType: map['collectTargetType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      namespace: map['namespace'] as String,
      slsProcessConfig: HybridMonitorSlsTaskSlsProcessConfig.fromMap((map['slsProcessConfig'] as Map).cast<String, dynamic>()),
