...
class MetricRuleTemplateArgs {
  ...
  MetricRuleTemplateArgs({
    List<MetricRuleTemplateAlertTemplate>? alertTemplates,
    String? applyMode,
    String? description,
    String? enableEndTime,
    String? enableStartTime,
    String? groupId,
    required String metricRuleTemplateName,
    String? notifyLevel,
    int? silenceTime,
    String? webhook,
  }) :
  ...
  factory MetricRuleTemplateArgs.fromMap(Map<String, dynamic> map) {
    return MetricRuleTemplateArgs(
      alertTemplates: map['alertTemplates'] == null ? null : pulumi.Input.decodeList<MetricRuleTemplateAlertTemplate>(map['alertTemplates'], (value) => MetricRuleTemplateAlertTemplate.fromMap((value as Map).cast<String, dynamic>())),
      applyMode: map['applyMode'] == null ? null : map['applyMode'] as String,
      ...
      notifyLevel: map['notifyLevel'] == null ? null : map['notifyLevel'] as String,
