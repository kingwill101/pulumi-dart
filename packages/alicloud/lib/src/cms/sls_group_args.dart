...
class SlsGroupArgs {
  ...
  SlsGroupArgs({
    required List<SlsGroupSlsGroupConfig> slsGroupConfigs,
    String? slsGroupDescription,
    required String slsGroupName,
  }) :
      slsGroupConfigs = pulumi.Input.asInput<List<SlsGroupSlsGroupConfig>>(slsGroupConfigs),
      slsGroupDescription = pulumi.Input.asOptionalInput<String>(slsGroupDescription),
      slsGroupName = pulumi.Input.asInput<String>(slsGroupName);
  ...
  factory SlsGroupArgs.fromMap(Map<String, dynamic> map) {
    return SlsGroupArgs(
      slsGroupConfigs: pulumi.Input.decodeList<SlsGroupSlsGroupConfig>(map['slsGroupConfigs'], (value) => SlsGroupSlsGroupConfig.fromMap((value as Map).cast<String, dynamic>())),
      slsGroupDescription: map['slsGroupDescription'] == null ? null : map['slsGroupDescription'] as String,
