...
class MonitorGroupInstancesArgs {
  ...
  MonitorGroupInstancesArgs({
    ...
    required List<MonitorGroupInstancesInstance> instances,
  }) :
  ...
  factory MonitorGroupInstancesArgs.fromMap(Map<String, dynamic> map) {
    return MonitorGroupInstancesArgs(
      ...
      instances: pulumi.Input.decodeList<MonitorGroupInstancesInstance>(map['instances'], (value) => MonitorGroupInstancesInstance.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
