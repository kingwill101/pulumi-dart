...
class AlarmArgs {
  ...
  AlarmArgs({
    AlarmCompositeExpression? compositeExpression,
    required List<String> contactGroups,
    Map<String, String>? dimensions,
    String? effectiveInterval,
    bool? enabled,
    int? endTime,
    AlarmEscalationsCritical? escalationsCritical,
    AlarmEscalationsInfo? escalationsInfo,
    AlarmEscalationsWarn? escalationsWarn,
    required String metric,
    String? metricDimensions,
    String? name,
    int? period,
    required String project,
    List<AlarmPrometheus>? prometheuses,
    int? silenceTime,
    int? startTime,
    Map<String, String>? tags,
    List<AlarmTarget>? targets,
    String? webhook,
  }) :
  ...
  factory AlarmArgs.fromMap(Map<String, dynamic> map) {
    return AlarmArgs(
      compositeExpression: map['compositeExpression'] == null ? null : AlarmCompositeExpression.fromMap((map['compositeExpression'] as Map).cast<String, dynamic>()),
      ...
      escalationsCritical: map['escalationsCritical'] == null ? null : AlarmEscalationsCritical.fromMap((map['escalationsCritical'] as Map).cast<String, dynamic>()),
      escalationsInfo: map['escalationsInfo'] == null ? null : AlarmEscalationsInfo.fromMap((map['escalationsInfo'] as Map).cast<String, dynamic>()),
      escalationsWarn: map['escalationsWarn'] == null ? null : AlarmEscalationsWarn.fromMap((map['escalationsWarn'] as Map).cast<String, dynamic>()),
      metric: map['metric'] as String,
      metricDimensions: map['metricDimensions'] == null ? null : map['metricDimensions'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      period: map['period'] == null ? null : map['period'] as int,
      project: map['project'] as String,
      prometheuses: map['prometheuses'] == null ? null : pulumi.Input.decodeList<AlarmPrometheus>(map['prometheuses'], (value) => AlarmPrometheus.fromMap((value as Map).cast<String, dynamic>())),
      ...
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<AlarmTarget>(map['targets'], (value) => AlarmTarget.fromMap((value as Map).cast<String, dynamic>())),
