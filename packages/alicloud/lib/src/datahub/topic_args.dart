...
class TopicArgs {
  ...
  TopicArgs({
    ...
    Map<String, String>? recordSchema,
    String? recordType,
    int? shardCount,
  }) :
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ...
      lifeCycle: map['lifeCycle'] == null ? null : map['lifeCycle'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      projectName: map['projectName'] as String,
      recordSchema: map['recordSchema'] == null ? null : (map['recordSchema'] as Map).cast<String, String>(),
