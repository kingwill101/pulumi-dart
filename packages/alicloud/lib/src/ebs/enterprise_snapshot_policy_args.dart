...
class EnterpriseSnapshotPolicyArgs {
  ...
  EnterpriseSnapshotPolicyArgs({
    EnterpriseSnapshotPolicyCrossRegionCopyInfo? crossRegionCopyInfo,
    String? desc,
    required String enterpriseSnapshotPolicyName,
    String? resourceGroupId,
    required EnterpriseSnapshotPolicyRetainRule retainRule,
    required EnterpriseSnapshotPolicySchedule schedule,
    EnterpriseSnapshotPolicySpecialRetainRules? specialRetainRules,
    String? status,
    EnterpriseSnapshotPolicyStorageRule? storageRule,
    ...
    required String targetType,
      ...
      enterpriseSnapshotPolicyName = pulumi.Input.asInput<String>(enterpriseSnapshotPolicyName),
      resourceGroupId = pulumi.Input.asOptionalInput<String>(resourceGroupId),
      retainRule = pulumi.Input.asInput<EnterpriseSnapshotPolicyRetainRule>(retainRule),
      schedule = pulumi.Input.asInput<EnterpriseSnapshotPolicySchedule>(schedule),
  ...
  factory EnterpriseSnapshotPolicyArgs.fromMap(Map<String, dynamic> map) {
    return EnterpriseSnapshotPolicyArgs(
      crossRegionCopyInfo: map['crossRegionCopyInfo'] == null ? null : EnterpriseSnapshotPolicyCrossRegionCopyInfo.fromMap((map['crossRegionCopyInfo'] as Map).cast<String, dynamic>()),
      desc: map['desc'] == null ? null : map['desc'] as String,
      enterpriseSnapshotPolicyName: map['enterpriseSnapshotPolicyName'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      retainRule: EnterpriseSnapshotPolicyRetainRule.fromMap((map['retainRule'] as Map).cast<String, dynamic>()),
      schedule: EnterpriseSnapshotPolicySchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
      specialRetainRules: map['specialRetainRules'] == null ? null : EnterpriseSnapshotPolicySpecialRetainRules.fromMap((map['specialRetainRules'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : map['status'] as String,
      storageRule: map['storageRule'] == null ? null : EnterpriseSnapshotPolicyStorageRule.fromMap((map['storageRule'] as Map).cast<String, dynamic>()),
