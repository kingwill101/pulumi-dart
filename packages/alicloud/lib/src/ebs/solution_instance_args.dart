...
class SolutionInstanceArgs {
  ...
  SolutionInstanceArgs({
    String? description,
    List<SolutionInstanceParameter>? parameters,
  ...
  factory SolutionInstanceArgs.fromMap(Map<String, dynamic> map) {
    return SolutionInstanceArgs(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<SolutionInstanceParameter>(map['parameters'], (value) => SolutionInstanceParameter.fromMap((value as Map).cast<String, dynamic>())),
