...
class DiskReplicaPairArgs {
  ...
  factory DiskReplicaPairArgs.fromMap(Map<String, dynamic> map) {
    return DiskReplicaPairArgs(
      ...
      diskReplicaPairName: map['diskReplicaPairName'] == null ? null : map['diskReplicaPairName'] as String,
      oneShot: map['oneShot'] == null ? null : map['oneShot'] as bool,
      pairName: map['pairName'] == null ? null : map['pairName'] as String,
