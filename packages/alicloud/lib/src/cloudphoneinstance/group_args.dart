...
class GroupArgs {
  ...
  GroupArgs({
    ...
    required String instanceGroupSpec,
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      gpuAcceleration: map['gpuAcceleration'] == null ? null : map['gpuAcceleration'] as bool,
      imageId: map['imageId'] as String,
      instanceGroupName: map['instanceGroupName'] == null ? null : map['instanceGroupName'] as String,
      instanceGroupSpec: map['instanceGroupSpec'] as String,
      numberOfInstances: map['numberOfInstances'] == null ? null : map['numberOfInstances'] as int,
