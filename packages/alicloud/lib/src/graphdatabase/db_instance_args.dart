...
class DbInstanceArgs {
  ...
  DbInstanceArgs({
    required String dbInstanceCategory,
    String? dbInstanceDescription,
    List<DbInstanceDbInstanceIpArray>? dbInstanceIpArrays,
    required String dbInstanceNetworkType,
    required String dbInstanceStorageType,
    required String dbNodeClass,
    required int dbNodeStorage,
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      ...
      dbInstanceIpArrays: map['dbInstanceIpArrays'] == null ? null : pulumi.Input.decodeList<DbInstanceDbInstanceIpArray>(map['dbInstanceIpArrays'], (value) => DbInstanceDbInstanceIpArray.fromMap((value as Map).cast<String, dynamic>())),
