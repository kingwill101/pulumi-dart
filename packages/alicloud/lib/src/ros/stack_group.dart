...
class StackGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<StackGroupParameter>?> parameters;
  ...
  StackGroup(
    ...
    this.administrationRoleName = registerOutput<String>('administrationRoleName');
    this.autoDeployment = registerOutput<StackGroupAutoDeployment?>('autoDeployment');
    ...
    this.parameters = registerOutput<List<StackGroupParameter>?>('parameters');
    this.permissionModel = registerOutput<String>('permissionModel');
    this.resourceGroupId = registerOutput<String>('resourceGroupId');
    this.stackGroupId = registerOutput<String>('stackGroupId');
