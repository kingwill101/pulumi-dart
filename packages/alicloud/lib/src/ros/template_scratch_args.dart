...
class TemplateScratchArgs {
  ...
  TemplateScratchArgs({
    ...
    List<TemplateScratchPreferenceParameter>? preferenceParameters,
    TemplateScratchSourceResourceGroup? sourceResourceGroup,
    List<TemplateScratchSourceResource>? sourceResources,
    TemplateScratchSourceTag? sourceTag,
    required String templateScratchType,
  }) :
  ...
  factory TemplateScratchArgs.fromMap(Map<String, dynamic> map) {
    return TemplateScratchArgs(
      ...
      executionMode: map['executionMode'] == null ? null : map['executionMode'] as String,
      logicalIdStrategy: map['logicalIdStrategy'] == null ? null : map['logicalIdStrategy'] as String,
      preferenceParameters: map['preferenceParameters'] == null ? null : pulumi.Input.decodeList<TemplateScratchPreferenceParameter>(map['preferenceParameters'], (value) => TemplateScratchPreferenceParameter.fromMap((value as Map).cast<String, dynamic>())),
      sourceResourceGroup: map['sourceResourceGroup'] == null ? null : TemplateScratchSourceResourceGroup.fromMap((map['sourceResourceGroup'] as Map).cast<String, dynamic>()),
      sourceResources: map['sourceResources'] == null ? null : pulumi.Input.decodeList<TemplateScratchSourceResource>(map['sourceResources'], (value) => TemplateScratchSourceResource.fromMap((value as Map).cast<String, dynamic>())),
      sourceTag: map['sourceTag'] == null ? null : TemplateScratchSourceTag.fromMap((map['sourceTag'] as Map).cast<String, dynamic>()),
