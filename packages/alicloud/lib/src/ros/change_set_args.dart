...
class ChangeSetArgs {
  ...
  ChangeSetArgs({
    ...
    List<ChangeSetParameter>? parameters,
    String? ramRoleName,
    ...
    bool? usePreviousParameters,
      ...
      changeSetName = pulumi.Input.asInput<String>(changeSetName),
  ...
  factory ChangeSetArgs.fromMap(Map<String, dynamic> map) {
    return ChangeSetArgs(
      ...
      changeSetType: map['changeSetType'] == null ? null : map['changeSetType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      disableRollback: map['disableRollback'] == null ? null : map['disableRollback'] as bool,
      notificationUrls: map['notificationUrls'] == null ? null : (map['notificationUrls'] as List).cast<String>(),
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<ChangeSetParameter>(map['parameters'], (value) => ChangeSetParameter.fromMap((value as Map).cast<String, dynamic>())),
      ramRoleName: map['ramRoleName'] == null ? null : map['ramRoleName'] as String,
      replacementOption: map['replacementOption'] == null ? null : map['replacementOption'] as String,
      stackId: map['stackId'] == null ? null : map['stackId'] as String,
      stackName: map['stackName'] == null ? null : map['stackName'] as String,
      stackPolicyBody: map['stackPolicyBody'] == null ? null : map['stackPolicyBody'] as String,
      stackPolicyDuringUpdateBody: map['stackPolicyDuringUpdateBody'] == null ? null : map['stackPolicyDuringUpdateBody'] as String,
      stackPolicyDuringUpdateUrl: map['stackPolicyDuringUpdateUrl'] == null ? null : map['stackPolicyDuringUpdateUrl'] as String,
      ...
      usePreviousParameters: map['usePreviousParameters'] == null ? null : map['usePreviousParameters'] as bool,
    );
  }
}
