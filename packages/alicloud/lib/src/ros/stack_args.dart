...
class StackArgs {
  ...
  StackArgs({
    ...
    List<StackParameter>? parameters,
    String? ramRoleName,
    String? replacementOption,
    bool? retainAllResources,
  ...
  factory StackArgs.fromMap(Map<String, dynamic> map) {
    return StackArgs(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<StackParameter>(map['parameters'], (value) => StackParameter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      retainAllResources: map['retainAllResources'] == null ? null : map['retainAllResources'] as bool,
