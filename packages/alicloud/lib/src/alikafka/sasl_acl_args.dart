...
class SaslAclArgs {
  ...
  SaslAclArgs({
    required String aclOperationType,
    String? aclOperationTypes,
    String? aclPermissionType,
    required String aclResourceName,
    required String aclResourcePatternType,
  ...
  factory SaslAclArgs.fromMap(Map<String, dynamic> map) {
    return SaslAclArgs(
      ...
      aclOperationTypes: map['aclOperationTypes'] == null ? null : map['aclOperationTypes'] as String,
      aclPermissionType: map['aclPermissionType'] == null ? null : map['aclPermissionType'] as String,
