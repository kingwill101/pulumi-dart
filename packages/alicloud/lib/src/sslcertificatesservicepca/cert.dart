...
class Cert extends pulumi.CustomResource {
  ...
  Cert(
    ...
    this.afterTime = registerOutput<int?>('afterTime');
    this.algorithm = registerOutput<String>('algorithm');
    this.aliasName = registerOutput<String?>('aliasName');
    this.beforeTime = registerOutput<int?>('beforeTime');
    this.commonName = registerOutput<String?>('commonName');
    this.countryCode = registerOutput<String?>('countryCode');
    this.customIdentifier = registerOutput<String?>('customIdentifier');
    this.days = registerOutput<int>('days');
    this.enableCrl = registerOutput<int?>('enableCrl');
    this.immediately = registerOutput<int?>('immediately');
    this.locality = registerOutput<String?>('locality');
    this.months = registerOutput<int?>('months');
    ...
    this.sanType = registerOutput<String?>('sanType');
    this.sanValue = registerOutput<String?>('sanValue');
    this.state = registerOutput<String?>('state');
    this.status = registerOutput<String>('status');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.uploadFlag = registerOutput<int?>('uploadFlag');
