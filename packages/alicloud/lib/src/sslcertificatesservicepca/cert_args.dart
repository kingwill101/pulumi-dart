...
class CertArgs {
  ...
  factory CertArgs.fromMap(Map<String, dynamic> map) {
    return CertArgs(
      ...
      customIdentifier: map['customIdentifier'] == null ? null : map['customIdentifier'] as String,
      days: map['days'] == null ? null : map['days'] as int,
      enableCrl: map['enableCrl'] == null ? null : map['enableCrl'] as int,
      immediately: map['immediately'] == null ? null : map['immediately'] as int,
      locality: map['locality'] == null ? null : map['locality'] as String,
      months: map['months'] == null ? null : map['months'] as int,
      ...
      parentIdentifier: map['parentIdentifier'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      sanType: map['sanType'] == null ? null : map['sanType'] as String,
      sanValue: map['sanValue'] == null ? null : map['sanValue'] as String,
      state: map['state'] == null ? null : map['state'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      uploadFlag: map['uploadFlag'] == null ? null : map['uploadFlag'] as int,
