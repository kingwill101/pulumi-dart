...
class IpsecServerArgs {
  ...
  IpsecServerArgs({
    ...
    List<IpsecServerIkeConfig>? ikeConfigs,
    List<IpsecServerIpsecConfig>? ipsecConfigs,
  ...
  factory IpsecServerArgs.fromMap(Map<String, dynamic> map) {
    return IpsecServerArgs(
      ...
      ikeConfigs: map['ikeConfigs'] == null ? null : pulumi.Input.decodeList<IpsecServerIkeConfig>(map['ikeConfigs'], (value) => IpsecServerIkeConfig.fromMap((value as Map).cast<String, dynamic>())),
      ipsecConfigs: map['ipsecConfigs'] == null ? null : pulumi.Input.decodeList<IpsecServerIpsecConfig>(map['ipsecConfigs'], (value) => IpsecServerIpsecConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pskEnabled: map['pskEnabled'] == null ? null : map['pskEnabled'] as bool,
