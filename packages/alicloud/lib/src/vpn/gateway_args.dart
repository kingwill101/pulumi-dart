...
class GatewayArgs {
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      autoPropagate: map['autoPropagate'] == null ? null : map['autoPropagate'] as bool,
      bandwidth: map['bandwidth'] as int,
      description: map['description'] == null ? null : map['description'] as String,
      disasterRecoveryVswitchId: map['disasterRecoveryVswitchId'] == null ? null : map['disasterRecoveryVswitchId'] as String,
      ...
      sslConnections: map['sslConnections'] == null ? null : map['sslConnections'] as int,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      vpcId: map['vpcId'] as String,
      vpnGatewayName: map['vpnGatewayName'] == null ? null : map['vpnGatewayName'] as String,
