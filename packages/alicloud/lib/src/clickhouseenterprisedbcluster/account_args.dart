...
class AccountArgs {
  ...
  AccountArgs({
    ...
    String? description,
    AccountDmlAuthSetting? dmlAuthSetting,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      dmlAuthSetting: map['dmlAuthSetting'] == null ? null : AccountDmlAuthSetting.fromMap((map['dmlAuthSetting'] as Map).cast<String, dynamic>()),
