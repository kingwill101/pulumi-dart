...
class NamespaceArgs {
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      enableMicroRegistration: map['enableMicroRegistration'] == null ? null : map['enableMicroRegistration'] as bool,
      namespaceDescription: map['namespaceDescription'] == null ? null : map['namespaceDescription'] as String,
      namespaceId: map['namespaceId'] == null ? null : map['namespaceId'] as String,
      namespaceName: map['namespaceName'] as String,
      namespaceShortId: map['namespaceShortId'] == null ? null : map['namespaceShortId'] as String,
    );
  }
}
