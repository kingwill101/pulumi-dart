...
class LoadBalancerInternetArgs {
  ...
  LoadBalancerInternetArgs({
    ...
    required List<LoadBalancerInternetInternet> internets,
  }) :
  ...
  factory LoadBalancerInternetArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerInternetArgs(
      ...
      internets: pulumi.Input.decodeList<LoadBalancerInternetInternet>(map['internets'], (value) => LoadBalancerInternetInternet.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
