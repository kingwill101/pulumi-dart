...
class IngressArgs {
  ...
  factory IngressArgs.fromMap(Map<String, dynamic> map) {
    return IngressArgs(
      ...
      certIds: map['certIds'] == null ? null : map['certIds'] as String,
      defaultRule: map['defaultRule'] == null ? null : IngressDefaultRule.fromMap((map['defaultRule'] as Map).cast<String, dynamic>()),
      ...
      loadBalanceType: map['loadBalanceType'] == null ? null : map['loadBalanceType'] as String,
      namespaceId: map['namespaceId'] as String,
      rules: pulumi.Input.decodeList<IngressRule>(map['rules'], (value) => IngressRule.fromMap((value as Map).cast<String, dynamic>())),
