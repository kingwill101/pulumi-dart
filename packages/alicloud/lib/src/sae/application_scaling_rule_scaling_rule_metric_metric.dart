...
class ApplicationScalingRuleScalingRuleMetricMetric {
  ...
  final String? slbLogStore;
  /// The project of the Log Service.
  final String? slbProject;
  /// SLB listening port.
  final String? vport;
  ...
  factory ApplicationScalingRuleScalingRuleMetricMetric.fromMap(Map<String, dynamic> map) {
    return ApplicationScalingRuleScalingRuleMetricMetric(
      metricTargetAverageUtilization: map['metricTargetAverageUtilization'] == null ? null : map['metricTargetAverageUtilization'] as int,
      metricType: map['metricType'] == null ? null : map['metricType'] as String,
      slbId: map['slbId'] == null ? null : map['slbId'] as String,
      slbLogStore: map['slbLogStore'] == null ? null : map['slbLogStore'] as String,
      slbProject: map['slbProject'] == null ? null : map['slbProject'] as String,
      vport: map['vport'] == null ? null : map['vport'] as String,
    );
  }
}
