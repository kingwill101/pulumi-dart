...
class LoadBalancerIntranetArgs {
  ...
  LoadBalancerIntranetArgs({
    ...
    required List<LoadBalancerIntranetIntranet> intranets,
  }) :
  ...
  factory LoadBalancerIntranetArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerIntranetArgs(
      ...
      intranetSlbId: map['intranetSlbId'] == null ? null : map['intranetSlbId'] as String,
      intranets: pulumi.Input.decodeList<LoadBalancerIntranetIntranet>(map['intranets'], (value) => LoadBalancerIntranetIntranet.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
