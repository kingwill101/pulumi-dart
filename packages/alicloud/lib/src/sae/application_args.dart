...
class ApplicationArgs {
  ...
  ApplicationArgs({
    ...
    String? command,
    String? commandArgs,
    List<String>? commandArgsV2s,
    String? configMapMountDesc,
    List<ApplicationConfigMapMountDescV2>? configMapMountDescV2s,
    int? cpu,
    String? customHostAlias,
    List<ApplicationCustomHostAliasV2>? customHostAliasV2s,
    bool? deploy,
    ...
    String? jdk,
    ApplicationKafkaConfigs? kafkaConfigs,
    String? liveness,
    ApplicationLivenessV2? livenessV2,
    int? memory,
    String? microRegistration,
    int? minReadyInstanceRatio,
    int? minReadyInstances,
    String? namespaceId,
    List<ApplicationNasConfig>? nasConfigs,
    String? ossAkId,
    String? ossAkSecret,
    String? ossMountDescs,
    List<ApplicationOssMountDescsV2>? ossMountDescsV2s,
    ...
    String? postStart,
    ApplicationPostStartV2? postStartV2,
    String? preStop,
    ApplicationPreStopV2? preStopV2,
    String? programmingLanguage,
    ApplicationPvtzDiscoverySvc? pvtzDiscoverySvc,
    String? readiness,
    ApplicationReadinessV2? readinessV2,
    ...
    String? timezone,
    String? tomcatConfig,
    ApplicationTomcatConfigV2? tomcatConfigV2,
    String? updateStrategy,
    ApplicationUpdateStrategyV2? updateStrategyV2,
    String? vpcId,
    String? vswitchId,
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      acrAssumeRoleArn: map['acrAssumeRoleArn'] == null ? null : map['acrAssumeRoleArn'] as String,
      acrInstanceId: map['acrInstanceId'] == null ? null : map['acrInstanceId'] as String,
      appDescription: map['appDescription'] == null ? null : map['appDescription'] as String,
      appName: map['appName'] as String,
      autoConfig: map['autoConfig'] == null ? null : map['autoConfig'] as bool,
      autoEnableApplicationScalingRule: map['autoEnableApplicationScalingRule'] == null ? null : map['autoEnableApplicationScalingRule'] as bool,
      batchWaitTime: map['batchWaitTime'] == null ? null : map['batchWaitTime'] as int,
      changeOrderDesc: map['changeOrderDesc'] == null ? null : map['changeOrderDesc'] as String,
      command: map['command'] == null ? null : map['command'] as String,
      commandArgs: map['commandArgs'] == null ? null : map['commandArgs'] as String,
      commandArgsV2s: map['commandArgsV2s'] == null ? null : (map['commandArgsV2s'] as List).cast<String>(),
      configMapMountDesc: map['configMapMountDesc'] == null ? null : map['configMapMountDesc'] as String,
      configMapMountDescV2s: map['configMapMountDescV2s'] == null ? null : pulumi.Input.decodeList<ApplicationConfigMapMountDescV2>(map['configMapMountDescV2s'], (value) => ApplicationConfigMapMountDescV2.fromMap((value as Map).cast<String, dynamic>())),
      cpu: map['cpu'] == null ? null : map['cpu'] as int,
      customHostAlias: map['customHostAlias'] == null ? null : map['customHostAlias'] as String,
      customHostAliasV2s: map['customHostAliasV2s'] == null ? null : pulumi.Input.decodeList<ApplicationCustomHostAliasV2>(map['customHostAliasV2s'], (value) => ApplicationCustomHostAliasV2.fromMap((value as Map).cast<String, dynamic>())),
      deploy: map['deploy'] == null ? null : map['deploy'] as bool,
      edasContainerVersion: map['edasContainerVersion'] == null ? null : map['edasContainerVersion'] as String,
      enableAhas: map['enableAhas'] == null ? null : map['enableAhas'] as String,
      enableGreyTagRoute: map['enableGreyTagRoute'] == null ? null : map['enableGreyTagRoute'] as bool,
      envs: map['envs'] == null ? null : map['envs'] as String,
      imagePullSecrets: map['imagePullSecrets'] == null ? null : map['imagePullSecrets'] as String,
      imageUrl: map['imageUrl'] == null ? null : map['imageUrl'] as String,
      jarStartArgs: map['jarStartArgs'] == null ? null : map['jarStartArgs'] as String,
      jarStartOptions: map['jarStartOptions'] == null ? null : map['jarStartOptions'] as String,
      jdk: map['jdk'] == null ? null : map['jdk'] as String,
      kafkaConfigs: map['kafkaConfigs'] == null ? null : ApplicationKafkaConfigs.fromMap((map['kafkaConfigs'] as Map).cast<String, dynamic>()),
      liveness: map['liveness'] == null ? null : map['liveness'] as String,
      livenessV2: map['livenessV2'] == null ? null : ApplicationLivenessV2.fromMap((map['livenessV2'] as Map).cast<String, dynamic>()),
      memory: map['memory'] == null ? null : map['memory'] as int,
      microRegistration: map['microRegistration'] == null ? null : map['microRegistration'] as String,
      ...
      nasConfigs: map['nasConfigs'] == null ? null : pulumi.Input.decodeList<ApplicationNasConfig>(map['nasConfigs'], (value) => ApplicationNasConfig.fromMap((value as Map).cast<String, dynamic>())),
      ossAkId: map['ossAkId'] == null ? null : map['ossAkId'] as String,
      ossAkSecret: map['ossAkSecret'] == null ? null : map['ossAkSecret'] as String,
      ossMountDescs: map['ossMountDescs'] == null ? null : map['ossMountDescs'] as String,
      ossMountDescsV2s: map['ossMountDescsV2s'] == null ? null : pulumi.Input.decodeList<ApplicationOssMountDescsV2>(map['ossMountDescsV2s'], (value) => ApplicationOssMountDescsV2.fromMap((value as Map).cast<String, dynamic>())),
      packageType: map['packageType'] as String,
      packageUrl: map['packageUrl'] == null ? null : map['packageUrl'] as String,
      packageVersion: map['packageVersion'] == null ? null : map['packageVersion'] as String,
      php: map['php'] == null ? null : map['php'] as String,
      phpArmsConfigLocation: map['phpArmsConfigLocation'] == null ? null : map['phpArmsConfigLocation'] as String,
      phpConfig: map['phpConfig'] == null ? null : map['phpConfig'] as String,
      phpConfigLocation: map['phpConfigLocation'] == null ? null : map['phpConfigLocation'] as String,
      postStart: map['postStart'] == null ? null : map['postStart'] as String,
      postStartV2: map['postStartV2'] == null ? null : ApplicationPostStartV2.fromMap((map['postStartV2'] as Map).cast<String, dynamic>()),
      preStop: map['preStop'] == null ? null : map['preStop'] as String,
      preStopV2: map['preStopV2'] == null ? null : ApplicationPreStopV2.fromMap((map['preStopV2'] as Map).cast<String, dynamic>()),
      programmingLanguage: map['programmingLanguage'] == null ? null : map['programmingLanguage'] as String,
      pvtzDiscoverySvc: map['pvtzDiscoverySvc'] == null ? null : ApplicationPvtzDiscoverySvc.fromMap((map['pvtzDiscoverySvc'] as Map).cast<String, dynamic>()),
      readiness: map['readiness'] == null ? null : map['readiness'] as String,
      readinessV2: map['readinessV2'] == null ? null : ApplicationReadinessV2.fromMap((map['readinessV2'] as Map).cast<String, dynamic>()),
      replicas: map['replicas'] as int,
      securityGroupId: map['securityGroupId'] == null ? null : map['securityGroupId'] as String,
      slsConfigs: map['slsConfigs'] == null ? null : map['slsConfigs'] as String,
      ...
      tomcatConfig: map['tomcatConfig'] == null ? null : map['tomcatConfig'] as String,
      tomcatConfigV2: map['tomcatConfigV2'] == null ? null : ApplicationTomcatConfigV2.fromMap((map['tomcatConfigV2'] as Map).cast<String, dynamic>()),
      updateStrategy: map['updateStrategy'] == null ? null : map['updateStrategy'] as String,
      updateStrategyV2: map['updateStrategyV2'] == null ? null : ApplicationUpdateStrategyV2.fromMap((map['updateStrategyV2'] as Map).cast<String, dynamic>()),
      vpcId: map['vpcId'] == null ? null : map['vpcId'] as String,
      vswitchId: map['vswitchId'] == null ? null : map['vswitchId'] as String,
      warStartOptions: map['warStartOptions'] == null ? null : map['warStartOptions'] as String,
      webContainer: map['webContainer'] == null ? null : map['webContainer'] as String,
    );
  }
}
