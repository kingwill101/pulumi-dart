...
class BucketCnameArgs {
  ...
  BucketCnameArgs({
    ...
    BucketCnameCertificate? certificate,
  ...
  factory BucketCnameArgs.fromMap(Map<String, dynamic> map) {
    return BucketCnameArgs(
      ...
      certificate: map['certificate'] == null ? null : BucketCnameCertificate.fromMap((map['certificate'] as Map).cast<String, dynamic>()),
      deleteCertificate: map['deleteCertificate'] == null ? null : map['deleteCertificate'] as bool,
      domain: map['domain'] as String,
      force: map['force'] == null ? null : map['force'] as bool,
      previousCertId: map['previousCertId'] == null ? null : map['previousCertId'] as String,
    );
  }
}
