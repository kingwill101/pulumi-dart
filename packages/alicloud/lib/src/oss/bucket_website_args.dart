...
class BucketWebsiteArgs {
  ...
  BucketWebsiteArgs({
    ...
    BucketWebsiteErrorDocument? errorDocument,
    BucketWebsiteIndexDocument? indexDocument,
    BucketWebsiteRoutingRules? routingRules,
  }) :
  ...
  factory BucketWebsiteArgs.fromMap(Map<String, dynamic> map) {
    return BucketWebsiteArgs(
      ...
      errorDocument: map['errorDocument'] == null ? null : BucketWebsiteErrorDocument.fromMap((map['errorDocument'] as Map).cast<String, dynamic>()),
      indexDocument: map['indexDocument'] == null ? null : BucketWebsiteIndexDocument.fromMap((map['indexDocument'] as Map).cast<String, dynamic>()),
      routingRules: map['routingRules'] == null ? null : BucketWebsiteRoutingRules.fromMap((map['routingRules'] as Map).cast<String, dynamic>()),
    );
  }
}
