...
class BucketOverwriteConfigArgs {
  ...
  BucketOverwriteConfigArgs({
    ...
    List<BucketOverwriteConfigRule>? rules,
  }) :
  ...
  factory BucketOverwriteConfigArgs.fromMap(Map<String, dynamic> map) {
    return BucketOverwriteConfigArgs(
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<BucketOverwriteConfigRule>(map['rules'], (value) => BucketOverwriteConfigRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
