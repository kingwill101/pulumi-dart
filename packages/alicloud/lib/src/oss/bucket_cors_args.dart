...
class BucketCorsArgs {
  ...
  BucketCorsArgs({
    ...
    required List<BucketCorsCorsRule> corsRules,
    bool? responseVary,
  }) :
  ...
  factory BucketCorsArgs.fromMap(Map<String, dynamic> map) {
    return BucketCorsArgs(
      ...
      corsRules: pulumi.Input.decodeList<BucketCorsCorsRule>(map['corsRules'], (value) => BucketCorsCorsRule.fromMap((value as Map).cast<String, dynamic>())),
      responseVary: map['responseVary'] == null ? null : map['responseVary'] as bool,
    );
  }
}
