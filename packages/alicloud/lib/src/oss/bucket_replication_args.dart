...
class BucketReplicationArgs {
  ...
  BucketReplicationArgs({
    ...
    required BucketReplicationDestination destination,
    BucketReplicationEncryptionConfiguration? encryptionConfiguration,
    String? historicalObjectReplication,
    BucketReplicationPrefixSet? prefixSet,
    BucketReplicationProgress? progress,
    BucketReplicationRtc? rtc,
    BucketReplicationSourceSelectionCriteria? sourceSelectionCriteria,
    String? syncRole,
  }) :
  ...
  factory BucketReplicationArgs.fromMap(Map<String, dynamic> map) {
    return BucketReplicationArgs(
      ...
      destination: BucketReplicationDestination.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      encryptionConfiguration: map['encryptionConfiguration'] == null ? null : BucketReplicationEncryptionConfiguration.fromMap((map['encryptionConfiguration'] as Map).cast<String, dynamic>()),
      historicalObjectReplication: map['historicalObjectReplication'] == null ? null : map['historicalObjectReplication'] as String,
      prefixSet: map['prefixSet'] == null ? null : BucketReplicationPrefixSet.fromMap((map['prefixSet'] as Map).cast<String, dynamic>()),
      progress: map['progress'] == null ? null : BucketReplicationProgress.fromMap((map['progress'] as Map).cast<String, dynamic>()),
      rtc: map['rtc'] == null ? null : BucketReplicationRtc.fromMap((map['rtc'] as Map).cast<String, dynamic>()),
      sourceSelectionCriteria: map['sourceSelectionCriteria'] == null ? null : BucketReplicationSourceSelectionCriteria.fromMap((map['sourceSelectionCriteria'] as Map).cast<String, dynamic>()),
      syncRole: map['syncRole'] == null ? null : map['syncRole'] as String,
    );
  }
}
