...
class FileSystemSmbAcl {
  ...
  final bool? enableAnonymousAccess;
  ...
  final bool? rejectUnencryptedAccess;
  ...
  factory FileSystemSmbAcl.fromMap(Map<String, dynamic> map) {
    return FileSystemSmbAcl(
      enableAnonymousAccess: map['enableAnonymousAccess'] == null ? null : map['enableAnonymousAccess'] as bool,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      encryptData: map['encryptData'] == null ? null : map['encryptData'] as bool,
      homeDirPath: map['homeDirPath'] == null ? null : map['homeDirPath'] as String,
      rejectUnencryptedAccess: map['rejectUnencryptedAccess'] == null ? null : map['rejectUnencryptedAccess'] as bool,
      superAdminSid: map['superAdminSid'] == null ? null : map['superAdminSid'] as String,
    );
  }
}
