...
class FileSystemArgs {
  ...
  FileSystemArgs({
    ...
    String? keytabMd5,
    String? kmsKeyId,
    FileSystemNfsAcl? nfsAcl,
    FileSystemOptions? options,
    required String protocolType,
    FileSystemRecycleBin? recycleBin,
    String? redundancyType,
    List<String>? redundancyVswitchIds,
    String? resourceGroupId,
    FileSystemSmbAcl? smbAcl,
    String? snapshotId,
  ...
  factory FileSystemArgs.fromMap(Map<String, dynamic> map) {
    return FileSystemArgs(
      ...
      encryptType: map['encryptType'] == null ? null : map['encryptType'] as int,
      fileSystemType: map['fileSystemType'] == null ? null : map['fileSystemType'] as String,
      keytab: map['keytab'] == null ? null : map['keytab'] as String,
      keytabMd5: map['keytabMd5'] == null ? null : map['keytabMd5'] as String,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      nfsAcl: map['nfsAcl'] == null ? null : FileSystemNfsAcl.fromMap((map['nfsAcl'] as Map).cast<String, dynamic>()),
      options: map['options'] == null ? null : FileSystemOptions.fromMap((map['options'] as Map).cast<String, dynamic>()),
      protocolType: map['protocolType'] as String,
      recycleBin: map['recycleBin'] == null ? null : FileSystemRecycleBin.fromMap((map['recycleBin'] as Map).cast<String, dynamic>()),
      redundancyType: map['redundancyType'] == null ? null : map['redundancyType'] as String,
      redundancyVswitchIds: map['redundancyVswitchIds'] == null ? null : (map['redundancyVswitchIds'] as List).cast<String>(),
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      smbAcl: map['smbAcl'] == null ? null : FileSystemSmbAcl.fromMap((map['smbAcl'] as Map).cast<String, dynamic>()),
