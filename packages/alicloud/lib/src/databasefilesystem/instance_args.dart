...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      deleteSnapshot: map['deleteSnapshot'] == null ? null : map['deleteSnapshot'] as bool,
      ecsLists: map['ecsLists'] == null ? null : pulumi.Input.decodeList<InstanceEcsList>(map['ecsLists'], (value) => InstanceEcsList.fromMap((value as Map).cast<String, dynamic>())),
      enableRaid: map['enableRaid'] == null ? null : map['enableRaid'] as bool,
      encryption: map['encryption'] == null ? null : map['encryption'] as bool,
      fsName: map['fsName'] == null ? null : map['fsName'] as String,
      ...
      raidStripeUnitNumber: map['raidStripeUnitNumber'] == null ? null : map['raidStripeUnitNumber'] as int,
      size: map['size'] as int,
      snapshotId: map['snapshotId'] == null ? null : map['snapshotId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      usedScene: map['usedScene'] == null ? null : map['usedScene'] as String,
