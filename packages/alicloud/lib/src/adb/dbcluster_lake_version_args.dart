...
class DBClusterLakeVersionArgs {
  ...
  DBClusterLakeVersionArgs({
    ...
    bool? diskEncryption,
    bool? enableDefaultResourceGroup,
    bool? enableSsl,
    String? kmsId,
    ...
    String? reservedNodeSize,
    String? resourceGroupId,
    String? restoreToTime,
    String? restoreType,
    String? secondaryVswitchId,
    String? secondaryZoneId,
    String? securityIps,
    String? sourceDbClusterId,
  ...
  factory DBClusterLakeVersionArgs.fromMap(Map<String, dynamic> map) {
    return DBClusterLakeVersionArgs(
      ...
      enableDefaultResourceGroup: map['enableDefaultResourceGroup'] == null ? null : map['enableDefaultResourceGroup'] as bool,
      ...
      reservedNodeCount: map['reservedNodeCount'] == null ? null : map['reservedNodeCount'] as int,
      reservedNodeSize: map['reservedNodeSize'] == null ? null : map['reservedNodeSize'] as String,
      ...
      secondaryVswitchId: map['secondaryVswitchId'] == null ? null : map['secondaryVswitchId'] as String,
      ...
      sourceDbClusterId: map['sourceDbClusterId'] == null ? null : map['sourceDbClusterId'] as String,
      storageResource: map['storageResource'] == null ? null : map['storageResource'] as String,
