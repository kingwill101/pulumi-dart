...
class ResourceGroupArgs {
  ...
  ResourceGroupArgs({
    ...
    String? groupType,
    int? maxClusterCount,
    String? maxComputeResource,
    int? minClusterCount,
    String? minComputeResource,
    int? nodeNum,
    List<String>? users,
  }) :
  ...
  factory ResourceGroupArgs.fromMap(Map<String, dynamic> map) {
    return ResourceGroupArgs(
      ...
      clusterSizeResource: map['clusterSizeResource'] == null ? null : map['clusterSizeResource'] as String,
      dbClusterId: map['dbClusterId'] as String,
      engine: map['engine'] == null ? null : map['engine'] as String,
      engineParams: map['engineParams'] == null ? null : (map['engineParams'] as Map).cast<String, String>(),
      groupName: map['groupName'] as String,
      groupType: map['groupType'] == null ? null : map['groupType'] as String,
      maxClusterCount: map['maxClusterCount'] == null ? null : map['maxClusterCount'] as int,
      maxComputeResource: map['maxComputeResource'] == null ? null : map['maxComputeResource'] as String,
      minClusterCount: map['minClusterCount'] == null ? null : map['minClusterCount'] as int,
      minComputeResource: map['minComputeResource'] == null ? null : map['minComputeResource'] as String,
      nodeNum: map['nodeNum'] == null ? null : map['nodeNum'] as int,
