...
class LakeAccountArgs {
  ...
  LakeAccountArgs({
    ...
    List<LakeAccountAccountPrivilege>? accountPrivileges,
    String? accountType,
  ...
  factory LakeAccountArgs.fromMap(Map<String, dynamic> map) {
    return LakeAccountArgs(
      ...
      accountPrivileges: map['accountPrivileges'] == null ? null : pulumi.Input.decodeList<LakeAccountAccountPrivilege>(map['accountPrivileges'], (value) => LakeAccountAccountPrivilege.fromMap((value as Map).cast<String, dynamic>())),
