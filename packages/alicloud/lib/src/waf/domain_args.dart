...
class DomainArgs {
  ...
  DomainArgs({
    ...
    String? domain,
    String? domainName,
    List<String>? http2Ports,
    List<String>? httpPorts,
    String? httpToUserIp,
    List<String>? httpsPorts,
    String? httpsRedirect,
    required String instanceId,
    required String isAccessProduct,
    String? loadBalancing,
    List<DomainLogHeader>? logHeaders,
    int? readTime,
    ...
    int? writeTime,
      ...
      isAccessProduct = pulumi.Input.asInput<String>(isAccessProduct),
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      connectionTime: map['connectionTime'] == null ? null : map['connectionTime'] as int,
      domain: map['domain'] == null ? null : map['domain'] as String,
      domainName: map['domainName'] == null ? null : map['domainName'] as String,
      http2Ports: map['http2Ports'] == null ? null : (map['http2Ports'] as List).cast<String>(),
      httpPorts: map['httpPorts'] == null ? null : (map['httpPorts'] as List).cast<String>(),
      httpToUserIp: map['httpToUserIp'] == null ? null : map['httpToUserIp'] as String,
      httpsPorts: map['httpsPorts'] == null ? null : (map['httpsPorts'] as List).cast<String>(),
      httpsRedirect: map['httpsRedirect'] == null ? null : map['httpsRedirect'] as String,
      instanceId: map['instanceId'] as String,
      isAccessProduct: map['isAccessProduct'] as String,
      loadBalancing: map['loadBalancing'] == null ? null : map['loadBalancing'] as String,
      logHeaders: map['logHeaders'] == null ? null : pulumi.Input.decodeList<DomainLogHeader>(map['logHeaders'], (value) => DomainLogHeader.fromMap((value as Map).cast<String, dynamic>())),
      readTime: map['readTime'] == null ? null : map['readTime'] as int,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      sourceIps: map['sourceIps'] == null ? null : (map['sourceIps'] as List).cast<String>(),
      writeTime: map['writeTime'] == null ? null : map['writeTime'] as int,
    );
  }
}
