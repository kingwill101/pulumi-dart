...
class GetContainerGroupsGroup {
  ...
  final List<GetContainerGroupsGroupContainer> containers;
  /// The amount of CPU resources allocated to the container group.
  final double cpu;
  final int discount;
  /// The DNS settings.
  final List<GetContainerGroupsGroupDnsConfig> dnsConfigs;
  /// The security context of the container group.
  final List<GetContainerGroupsGroupEciSecurityContext> eciSecurityContexts;
  /// The ID of the ENI instance.
  final String eniInstanceId;
  /// The events of the container group. Maximum: `50`.
  final List<GetContainerGroupsGroupEvent> events;
  ...
  final List<GetContainerGroupsGroupVolume> volumes;
  /// The if of vpc.
  final String vpcId;
  /// The vswitch id.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': pulumi.Input.encodeList<GetContainerGroupsGroupContainer, Map<String, dynamic>>(containers, (value) => value.toMap()),
      'cpu': cpu,
      'discount': discount,
      'dnsConfigs': pulumi.Input.encodeList<GetContainerGroupsGroupDnsConfig, Map<String, dynamic>>(dnsConfigs, (value) => value.toMap()),
      'eciSecurityContexts': pulumi.Input.encodeList<GetContainerGroupsGroupEciSecurityContext, Map<String, dynamic>>(eciSecurityContexts, (value) => value.toMap()),
      'eniInstanceId': eniInstanceId,
      'events': pulumi.Input.encodeList<GetContainerGroupsGroupEvent, Map<String, dynamic>>(events, (value) => value.toMap()),
      'expiredTime': expiredTime,
      'failedTime': failedTime,
      'hostAliases': pulumi.Input.encodeList<GetContainerGroupsGroupHostAlias, Map<String, dynamic>>(hostAliases, (value) => value.toMap()),
      'id': id,
      'initContainers': pulumi.Input.encodeList<GetContainerGroupsGroupInitContainer, Map<String, dynamic>>(initContainers, (value) => value.toMap()),
      ...
      'tags': tags,
      'volumes': pulumi.Input.encodeList<GetContainerGroupsGroupVolume, Map<String, dynamic>>(volumes, (value) => value.toMap()),
      'vpcId': vpcId,
      'vswitchId': vswitchId,
      'zoneId': zoneId,
    };
  ...
  factory GetContainerGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupsGroup(
      ...
      containers: pulumi.Input.decodeList<GetContainerGroupsGroupContainer>(map['containers'], (value) => GetContainerGroupsGroupContainer.fromMap((value as Map).cast<String, dynamic>())),
      cpu: map['cpu'] as double,
      discount: map['discount'] as int,
      dnsConfigs: pulumi.Input.decodeList<GetContainerGroupsGroupDnsConfig>(map['dnsConfigs'], (value) => GetContainerGroupsGroupDnsConfig.fromMap((value as Map).cast<String, dynamic>())),
      eciSecurityContexts: pulumi.Input.decodeList<GetContainerGroupsGroupEciSecurityContext>(map['eciSecurityContexts'], (value) => GetContainerGroupsGroupEciSecurityContext.fromMap((value as Map).cast<String, dynamic>())),
      eniInstanceId: map['eniInstanceId'] as String,
      events: pulumi.Input.decodeList<GetContainerGroupsGroupEvent>(map['events'], (value) => GetContainerGroupsGroupEvent.fromMap((value as Map).cast<String, dynamic>())),
      expiredTime: map['expiredTime'] as String,
      failedTime: map['failedTime'] as String,
      hostAliases: pulumi.Input.decodeList<GetContainerGroupsGroupHostAlias>(map['hostAliases'], (value) => GetContainerGroupsGroupHostAlias.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      initContainers: pulumi.Input.decodeList<GetContainerGroupsGroupInitContainer>(map['initContainers'], (value) => GetContainerGroupsGroupInitContainer.fromMap((value as Map).cast<String, dynamic>())),
      ...
      succeededTime: map['succeededTime'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      volumes: pulumi.Input.decodeList<GetContainerGroupsGroupVolume>(map['volumes'], (value) => GetContainerGroupsGroupVolume.fromMap((value as Map).cast<String, dynamic>())),
