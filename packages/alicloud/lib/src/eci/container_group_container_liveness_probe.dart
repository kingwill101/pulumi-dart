...
class ContainerGroupContainerLivenessProbe {
  ...
  final List<ContainerGroupContainerLivenessProbeExec>? execs;
  ...
  final List<ContainerGroupContainerLivenessProbeHttpGet>? httpGets;
  ...
  final List<ContainerGroupContainerLivenessProbeTcpSocket>? tcpSockets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'execs': ?execs == null ? null : pulumi.Input.encodeList<ContainerGroupContainerLivenessProbeExec, Map<String, dynamic>>(execs!, (value) => value.toMap()),
      'failureThreshold': ?failureThreshold,
      'httpGets': ?httpGets == null ? null : pulumi.Input.encodeList<ContainerGroupContainerLivenessProbeHttpGet, Map<String, dynamic>>(httpGets!, (value) => value.toMap()),
      'initialDelaySeconds': ?initialDelaySeconds,
      'periodSeconds': ?periodSeconds,
      'successThreshold': ?successThreshold,
      'tcpSockets': ?tcpSockets == null ? null : pulumi.Input.encodeList<ContainerGroupContainerLivenessProbeTcpSocket, Map<String, dynamic>>(tcpSockets!, (value) => value.toMap()),
  ...
  factory ContainerGroupContainerLivenessProbe.fromMap(Map<String, dynamic> map) {
    return ContainerGroupContainerLivenessProbe(
      execs: map['execs'] == null ? null : pulumi.Input.decodeList<ContainerGroupContainerLivenessProbeExec>(map['execs'], (value) => ContainerGroupContainerLivenessProbeExec.fromMap((value as Map).cast<String, dynamic>())),
      failureThreshold: map['failureThreshold'] == null ? null : map['failureThreshold'] as int,
      httpGets: map['httpGets'] == null ? null : pulumi.Input.decodeList<ContainerGroupContainerLivenessProbeHttpGet>(map['httpGets'], (value) => ContainerGroupContainerLivenessProbeHttpGet.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tcpSockets: map['tcpSockets'] == null ? null : pulumi.Input.decodeList<ContainerGroupContainerLivenessProbeTcpSocket>(map['tcpSockets'], (value) => ContainerGroupContainerLivenessProbeTcpSocket.fromMap((value as Map).cast<String, dynamic>())),
