...
class SiteArgs {
  ...
  SiteArgs({
    String? accessType,
    String? addClientGeolocationHeader,
    String? addRealClientIpHeader,
    String? cacheArchitectureMode,
    String? cacheReserveEnable,
    ...
    String? siteNameExclusive,
    int? siteVersion,
    String? tagName,
    Map<String, String>? tags,
    bool? versionManagement,
  }) :
  ...
  factory SiteArgs.fromMap(Map<String, dynamic> map) {
    return SiteArgs(
      ...
      addClientGeolocationHeader: map['addClientGeolocationHeader'] == null ? null : map['addClientGeolocationHeader'] as String,
      addRealClientIpHeader: map['addRealClientIpHeader'] == null ? null : map['addRealClientIpHeader'] as String,
      cacheArchitectureMode: map['cacheArchitectureMode'] == null ? null : map['cacheArchitectureMode'] as String,
      cacheReserveEnable: map['cacheReserveEnable'] == null ? null : map['cacheReserveEnable'] as String,
      cacheReserveInstanceId: map['cacheReserveInstanceId'] == null ? null : map['cacheReserveInstanceId'] as String,
      caseInsensitive: map['caseInsensitive'] == null ? null : map['caseInsensitive'] as String,
      ...
      developmentMode: map['developmentMode'] == null ? null : map['developmentMode'] as String,
      flattenMode: map['flattenMode'] == null ? null : map['flattenMode'] as String,
      instanceId: map['instanceId'] as String,
      ipv6Enable: map['ipv6Enable'] == null ? null : map['ipv6Enable'] as String,
      ipv6Region: map['ipv6Region'] == null ? null : map['ipv6Region'] as String,
      paused: map['paused'] == null ? null : map['paused'] as bool,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      seoBypass: map['seoBypass'] == null ? null : map['seoBypass'] as String,
      siteName: map['siteName'] as String,
      siteNameExclusive: map['siteNameExclusive'] == null ? null : map['siteNameExclusive'] as String,
      ...
      versionManagement: map['versionManagement'] == null ? null : map['versionManagement'] as bool,
    );
  }
}
