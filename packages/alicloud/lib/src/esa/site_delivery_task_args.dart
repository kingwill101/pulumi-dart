...
class SiteDeliveryTaskArgs {
  ...
  SiteDeliveryTaskArgs({
    required String businessType,
    required String dataCenter,
    required String deliveryType,
    double? discardRate,
    required String fieldName,
    SiteDeliveryTaskHttpDelivery? httpDelivery,
    SiteDeliveryTaskKafkaDelivery? kafkaDelivery,
    SiteDeliveryTaskOssDelivery? ossDelivery,
    SiteDeliveryTaskS3Delivery? s3Delivery,
    required String siteId,
    SiteDeliveryTaskSlsDelivery? slsDelivery,
    String? status,
    required String taskName,
  }) :
      businessType = pulumi.Input.asInput<String>(businessType),
      dataCenter = pulumi.Input.asInput<String>(dataCenter),
      deliveryType = pulumi.Input.asInput<String>(deliveryType),
      discardRate = pulumi.Input.asOptionalInput<double>(discardRate),
      fieldName = pulumi.Input.asInput<String>(fieldName),
  ...
  factory SiteDeliveryTaskArgs.fromMap(Map<String, dynamic> map) {
    return SiteDeliveryTaskArgs(
      ...
      discardRate: map['discardRate'] == null ? null : map['discardRate'] as double,
      fieldName: map['fieldName'] as String,
      httpDelivery: map['httpDelivery'] == null ? null : SiteDeliveryTaskHttpDelivery.fromMap((map['httpDelivery'] as Map).cast<String, dynamic>()),
      kafkaDelivery: map['kafkaDelivery'] == null ? null : SiteDeliveryTaskKafkaDelivery.fromMap((map['kafkaDelivery'] as Map).cast<String, dynamic>()),
      ossDelivery: map['ossDelivery'] == null ? null : SiteDeliveryTaskOssDelivery.fromMap((map['ossDelivery'] as Map).cast<String, dynamic>()),
      s3Delivery: map['s3Delivery'] == null ? null : SiteDeliveryTaskS3Delivery.fromMap((map['s3Delivery'] as Map).cast<String, dynamic>()),
      siteId: map['siteId'] as String,
      slsDelivery: map['slsDelivery'] == null ? null : SiteDeliveryTaskSlsDelivery.fromMap((map['slsDelivery'] as Map).cast<String, dynamic>()),
