...
class HttpRequestHeaderModificationRuleArgs {
  ...
  HttpRequestHeaderModificationRuleArgs({
    required List<HttpRequestHeaderModificationRuleRequestHeaderModification> requestHeaderModifications,
    String? rule,
    String? ruleEnable,
    String? ruleName,
    int? sequence,
    ...
    int? siteVersion,
      ...
      requestHeaderModifications = pulumi.Input.asInput<List<HttpRequestHeaderModificationRuleRequestHeaderModification>>(requestHeaderModifications),
  ...
  factory HttpRequestHeaderModificationRuleArgs.fromMap(Map<String, dynamic> map) {
    return HttpRequestHeaderModificationRuleArgs(
      requestHeaderModifications: pulumi.Input.decodeList<HttpRequestHeaderModificationRuleRequestHeaderModification>(map['requestHeaderModifications'], (value) => HttpRequestHeaderModificationRuleRequestHeaderModification.fromMap((value as Map).cast<String, dynamic>())),
