...
class OriginPoolArgs {
  ...
  OriginPoolArgs({
    bool? enabled,
    required String originPoolName,
    List<OriginPoolOrigin>? origins,
  ...
  factory OriginPoolArgs.fromMap(Map<String, dynamic> map) {
    return OriginPoolArgs(
      ...
      originPoolName: map['originPoolName'] as String,
      origins: map['origins'] == null ? null : pulumi.Input.decodeList<OriginPoolOrigin>(map['origins'], (value) => OriginPoolOrigin.fromMap((value as Map).cast<String, dynamic>())),
