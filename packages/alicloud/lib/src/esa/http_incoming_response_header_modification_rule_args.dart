...
class HttpIncomingResponseHeaderModificationRuleArgs {
  ...
  HttpIncomingResponseHeaderModificationRuleArgs({
    required List<HttpIncomingResponseHeaderModificationRuleResponseHeaderModification> responseHeaderModifications,
    String? rule,
    String? ruleEnable,
    String? ruleName,
    int? sequence,
  ...
  factory HttpIncomingResponseHeaderModificationRuleArgs.fromMap(Map<String, dynamic> map) {
    return HttpIncomingResponseHeaderModificationRuleArgs(
      responseHeaderModifications: pulumi.Input.decodeList<HttpIncomingResponseHeaderModificationRuleResponseHeaderModification>(map['responseHeaderModifications'], (value) => HttpIncomingResponseHeaderModificationRuleResponseHeaderModification.fromMap((value as Map).cast<String, dynamic>())),
