...
class HttpsBasicConfigurationArgs {
  ...
  factory HttpsBasicConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return HttpsBasicConfigurationArgs(
      ...
      ciphersuiteGroup: map['ciphersuiteGroup'] == null ? null : map['ciphersuiteGroup'] as String,
      http2: map['http2'] == null ? null : map['http2'] as String,
      http3: map['http3'] == null ? null : map['http3'] as String,
      https: map['https'] == null ? null : map['https'] as String,
      ...
      tls10: map['tls10'] == null ? null : map['tls10'] as String,
      tls11: map['tls11'] == null ? null : map['tls11'] as String,
      tls12: map['tls12'] == null ? null : map['tls12'] as String,
      tls13: map['tls13'] == null ? null : map['tls13'] as String,
    );
  }
}
