...
class RecordArgs {
  ...
  factory RecordArgs.fromMap(Map<String, dynamic> map) {
    return RecordArgs(
      authConf: map['authConf'] == null ? null : RecordAuthConf.fromMap((map['authConf'] as Map).cast<String, dynamic>()),
      bizName: map['bizName'] == null ? null : map['bizName'] as String,
      comment: map['comment'] == null ? null : map['comment'] as String,
      data: RecordData.fromMap((map['data'] as Map).cast<String, dynamic>()),
      hostPolicy: map['hostPolicy'] == null ? null : map['hostPolicy'] as String,
      proxied: map['proxied'] == null ? null : map['proxied'] as bool,
