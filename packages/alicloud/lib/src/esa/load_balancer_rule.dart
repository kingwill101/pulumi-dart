...
class LoadBalancerRule {
  ...
  final LoadBalancerRuleFixedResponse? fixedResponse;
  ...
  factory LoadBalancerRule.fromMap(Map<String, dynamic> map) {
    return LoadBalancerRule(
      fixedResponse: map['fixedResponse'] == null ? null : LoadBalancerRuleFixedResponse.fromMap((map['fixedResponse'] as Map).cast<String, dynamic>()),
      overrides: map['overrides'] == null ? null : map['overrides'] as String,
      ...
      terminates: map['terminates'] == null ? null : map['terminates'] as bool,
    );
  }
}
