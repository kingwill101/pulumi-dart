...
class AccountArgs {
  ...
  AccountArgs({
    ...
    List<AccountAccountTag>? accountTags,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      accountId: map['accountId'] == null ? null : map['accountId'] as int,
      accountNamePrefix: map['accountNamePrefix'] == null ? null : map['accountNamePrefix'] as String,
      accountTags: map['accountTags'] == null ? null : pulumi.Input.decodeList<AccountAccountTag>(map['accountTags'], (value) => AccountAccountTag.fromMap((value as Map).cast<String, dynamic>())),
      baselineId: map['baselineId'] as String,
      defaultDomainName: map['defaultDomainName'] == null ? null : map['defaultDomainName'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      folderId: map['folderId'] == null ? null : map['folderId'] as String,
      payerAccountId: map['payerAccountId'] == null ? null : map['payerAccountId'] as int,
    );
  }
}
