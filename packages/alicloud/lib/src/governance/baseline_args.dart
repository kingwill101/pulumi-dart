...
class BaselineArgs {
  ...
  BaselineArgs({
    List<BaselineBaselineItem>? baselineItems,
    String? baselineName,
    String? description,
  }) :
  ...
  factory BaselineArgs.fromMap(Map<String, dynamic> map) {
    return BaselineArgs(
      baselineItems: map['baselineItems'] == null ? null : pulumi.Input.decodeList<BaselineBaselineItem>(map['baselineItems'], (value) => BaselineBaselineItem.fromMap((value as Map).cast<String, dynamic>())),
      baselineName: map['baselineName'] == null ? null : map['baselineName'] as String,
