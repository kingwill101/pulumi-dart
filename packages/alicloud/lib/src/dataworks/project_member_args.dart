...
class ProjectMemberArgs {
  ...
  factory ProjectMemberArgs.fromMap(Map<String, dynamic> map) {
    return ProjectMemberArgs(
      ...
      roles: map['roles'] == null ? null : pulumi.Input.decodeList<ProjectMemberRole>(map['roles'], (value) => ProjectMemberRole.fromMap((value as Map).cast<String, dynamic>())),
