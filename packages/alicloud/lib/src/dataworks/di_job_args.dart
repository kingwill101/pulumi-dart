...
class DiJobArgs {
  ...
  DiJobArgs({
    String? description,
    required List<DiJobDestinationDataSourceSetting> destinationDataSourceSettings,
    required String destinationDataSourceType,
    required String jobName,
    DiJobJobSettings? jobSettings,
    required String migrationType,
    int? projectId,
    required DiJobResourceSettings resourceSettings,
    required List<DiJobSourceDataSourceSetting> sourceDataSourceSettings,
    required String sourceDataSourceType,
    required List<DiJobTableMapping> tableMappings,
    List<DiJobTransformationRule>? transformationRules,
  }) :
  ...
  factory DiJobArgs.fromMap(Map<String, dynamic> map) {
    return DiJobArgs(
      ...
      destinationDataSourceSettings: pulumi.Input.decodeList<DiJobDestinationDataSourceSetting>(map['destinationDataSourceSettings'], (value) => DiJobDestinationDataSourceSetting.fromMap((value as Map).cast<String, dynamic>())),
      destinationDataSourceType: map['destinationDataSourceType'] as String,
      jobName: map['jobName'] as String,
      jobSettings: map['jobSettings'] == null ? null : DiJobJobSettings.fromMap((map['jobSettings'] as Map).cast<String, dynamic>()),
      migrationType: map['migrationType'] as String,
      projectId: map['projectId'] == null ? null : map['projectId'] as int,
      resourceSettings: DiJobResourceSettings.fromMap((map['resourceSettings'] as Map).cast<String, dynamic>()),
      sourceDataSourceSettings: pulumi.Input.decodeList<DiJobSourceDataSourceSetting>(map['sourceDataSourceSettings'], (value) => DiJobSourceDataSourceSetting.fromMap((value as Map).cast<String, dynamic>())),
      sourceDataSourceType: map['sourceDataSourceType'] as String,
      tableMappings: pulumi.Input.decodeList<DiJobTableMapping>(map['tableMappings'], (value) => DiJobTableMapping.fromMap((value as Map).cast<String, dynamic>())),
      transformationRules: map['transformationRules'] == null ? null : pulumi.Input.decodeList<DiJobTransformationRule>(map['transformationRules'], (value) => DiJobTransformationRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
