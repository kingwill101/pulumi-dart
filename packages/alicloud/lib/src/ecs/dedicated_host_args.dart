...
class DedicatedHostArgs {
  ...
  DedicatedHostArgs({
    ...
    required String dedicatedHostType,
    String? description,
    bool? detailFee,
    bool? dryRun,
    String? expiredTime,
    int? minQuantity,
    List<DedicatedHostNetworkAttribute>? networkAttributes,
    String? paymentType,
  ...
  factory DedicatedHostArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedHostArgs(
      actionOnMaintenance: map['actionOnMaintenance'] == null ? null : map['actionOnMaintenance'] as String,
      autoPlacement: map['autoPlacement'] == null ? null : map['autoPlacement'] as String,
      ...
      detailFee: map['detailFee'] == null ? null : map['detailFee'] as bool,
      dryRun: map['dryRun'] == null ? null : map['dryRun'] as bool,
      expiredTime: map['expiredTime'] == null ? null : map['expiredTime'] as String,
      minQuantity: map['minQuantity'] == null ? null : map['minQuantity'] as int,
      networkAttributes: map['networkAttributes'] == null ? null : pulumi.Input.decodeList<DedicatedHostNetworkAttribute>(map['networkAttributes'], (value) => DedicatedHostNetworkAttribute.fromMap((value as Map).cast<String, dynamic>())),
      paymentType: map['paymentType'] == null ? null : map['paymentType'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      saleCycle: map['saleCycle'] == null ? null : map['saleCycle'] as String,
