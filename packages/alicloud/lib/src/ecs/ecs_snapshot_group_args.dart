...
class EcsSnapshotGroupArgs {
  ...
  factory EcsSnapshotGroupArgs.fromMap(Map<String, dynamic> map) {
    return EcsSnapshotGroupArgs(
      ...
      diskIds: map['diskIds'] == null ? null : (map['diskIds'] as List).cast<String>(),
      excludeDiskIds: map['excludeDiskIds'] == null ? null : (map['excludeDiskIds'] as List).cast<String>(),
