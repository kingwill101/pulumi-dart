...
class SecurityGroupRuleArgs {
  ...
  factory SecurityGroupRuleArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGroupRuleArgs(
      ...
      ipv6CidrIp: map['ipv6CidrIp'] == null ? null : map['ipv6CidrIp'] as String,
      ...
      sourceGroupOwnerAccount: map['sourceGroupOwnerAccount'] == null ? null : map['sourceGroupOwnerAccount'] as String,
      sourceSecurityGroupId: map['sourceSecurityGroupId'] == null ? null : map['sourceSecurityGroupId'] as String,
