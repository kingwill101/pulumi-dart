...
class EcsNetworkInterfaceAttachmentArgs {
  ...
  EcsNetworkInterfaceAttachmentArgs({
    ...
    bool? waitForNetworkConfigurationReady,
  }) :
  ...
  factory EcsNetworkInterfaceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return EcsNetworkInterfaceAttachmentArgs(
      ...
      trunkNetworkInstanceId: map['trunkNetworkInstanceId'] == null ? null : map['trunkNetworkInstanceId'] as String,
      waitForNetworkConfigurationReady: map['waitForNetworkConfigurationReady'] == null ? null : map['waitForNetworkConfigurationReady'] as bool,
    );
  }
}
