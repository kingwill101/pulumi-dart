...
class SecurityGroupArgs {
  ...
  factory SecurityGroupArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGroupArgs(
      ...
      innerAccess: map['innerAccess'] == null ? null : map['innerAccess'] as bool,
      innerAccessPolicy: map['innerAccessPolicy'] == null ? null : map['innerAccessPolicy'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      securityGroupName: map['securityGroupName'] == null ? null : map['securityGroupName'] as String,
      securityGroupType: map['securityGroupType'] == null ? null : map['securityGroupType'] as String,
