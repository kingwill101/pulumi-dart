...
class ReservedInstanceArgs {
  ...
  factory ReservedInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ReservedInstanceArgs(
      ...
      instanceAmount: map['instanceAmount'] == null ? null : map['instanceAmount'] as int,
      ...
      reservedInstanceName: map['reservedInstanceName'] == null ? null : map['reservedInstanceName'] as String,
