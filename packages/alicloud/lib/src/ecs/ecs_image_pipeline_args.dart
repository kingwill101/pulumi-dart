...
class EcsImagePipelineArgs {
  ...
  EcsImagePipelineArgs({
    List<String>? addAccounts,
    required String baseImage,
    required String baseImageType,
    String? buildContent,
  ...
  factory EcsImagePipelineArgs.fromMap(Map<String, dynamic> map) {
    return EcsImagePipelineArgs(
      addAccounts: map['addAccounts'] == null ? null : (map['addAccounts'] as List).cast<String>(),
      baseImage: map['baseImage'] as String,
      baseImageType: map['baseImageType'] as String,
      buildContent: map['buildContent'] == null ? null : map['buildContent'] as String,
      deleteInstanceOnFailure: map['deleteInstanceOnFailure'] == null ? null : map['deleteInstanceOnFailure'] as bool,
      ...
      toRegionIds: map['toRegionIds'] == null ? null : (map['toRegionIds'] as List).cast<String>(),
