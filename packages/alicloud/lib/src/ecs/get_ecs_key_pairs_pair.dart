...
class GetEcsKeyPairsPair {
  ...
  final List<GetEcsKeyPairsPairInstance> instances;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'instances': pulumi.Input.encodeList<GetEcsKeyPairsPairInstance, Map<String, dynamic>>(instances, (value) => value.toMap()),
      'keyName': keyName,
  ...
  factory GetEcsKeyPairsPair.fromMap(Map<String, dynamic> map) {
    return GetEcsKeyPairsPair(
      ...
      id: map['id'] as String,
      instances: pulumi.Input.decodeList<GetEcsKeyPairsPairInstance>(map['instances'], (value) => GetEcsKeyPairsPairInstance.fromMap((value as Map).cast<String, dynamic>())),
