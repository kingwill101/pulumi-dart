...
class EcsInvocationArgs {
  ...
  factory EcsInvocationArgs.fromMap(Map<String, dynamic> map) {
    return EcsInvocationArgs(
      ...
      timed: map['timed'] == null ? null : map['timed'] as bool,
      username: map['username'] == null ? null : map['username'] as String,
      windowsPasswordName: map['windowsPasswordName'] == null ? null : map['windowsPasswordName'] as String,
    );
  }
}
