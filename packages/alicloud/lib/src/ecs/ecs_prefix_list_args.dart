...
class EcsPrefixListArgs {
  ...
  EcsPrefixListArgs({
    ...
    String? description,
    required List<EcsPrefixListEntry> entries,
  ...
  factory EcsPrefixListArgs.fromMap(Map<String, dynamic> map) {
    return EcsPrefixListArgs(
      ...
      entries: pulumi.Input.decodeList<EcsPrefixListEntry>(map['entries'], (value) => EcsPrefixListEntry.fromMap((value as Map).cast<String, dynamic>())),
