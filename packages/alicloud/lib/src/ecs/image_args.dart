...
class ImageArgs {
  ...
  ImageArgs({
    ...
    List<ImageDiskDeviceMapping>? diskDeviceMappings,
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      ...
      detectionStrategy: map['detectionStrategy'] == null ? null : map['detectionStrategy'] as String,
      diskDeviceMappings: map['diskDeviceMappings'] == null ? null : pulumi.Input.decodeList<ImageDiskDeviceMapping>(map['diskDeviceMappings'], (value) => ImageDiskDeviceMapping.fromMap((value as Map).cast<String, dynamic>())),
      features: map['features'] == null ? null : ImageFeatures.fromMap((map['features'] as Map).cast<String, dynamic>()),
