...
class ElasticityAssuranceArgs {
  ...
  ElasticityAssuranceArgs({
    String? assuranceTimes,
    bool? autoRenew,
    int? autoRenewPeriod,
    String? autoRenewPeriodUnit,
    String? description,
    required int instanceAmount,
  ...
  factory ElasticityAssuranceArgs.fromMap(Map<String, dynamic> map) {
    return ElasticityAssuranceArgs(
      assuranceTimes: map['assuranceTimes'] == null ? null : map['assuranceTimes'] as String,
      ...
      privatePoolOptionsName: map['privatePoolOptionsName'] == null ? null : map['privatePoolOptionsName'] as String,
