...
class IndustrialPidLoopArgs {
  ...
  IndustrialPidLoopArgs({
    required String pidLoopConfiguration,
    required String pidLoopDcsType,
    String? pidLoopDesc,
    required bool pidLoopIsCrucial,
    required String pidLoopName,
    required String pidLoopType,
  ...
  factory IndustrialPidLoopArgs.fromMap(Map<String, dynamic> map) {
    return IndustrialPidLoopArgs(
      ...
      pidLoopDesc: map['pidLoopDesc'] == null ? null : map['pidLoopDesc'] as String,
