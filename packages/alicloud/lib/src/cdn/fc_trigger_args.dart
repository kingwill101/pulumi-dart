...
class FcTriggerArgs {
  ...
  FcTriggerArgs({
    required String eventMetaName,
    required String eventMetaVersion,
    String? functionArn,
    required String notes,
    required String roleArn,
    required String sourceArn,
    required String triggerArn,
  }) :
  ...
  factory FcTriggerArgs.fromMap(Map<String, dynamic> map) {
    return FcTriggerArgs(
      eventMetaName: map['eventMetaName'] as String,
      eventMetaVersion: map['eventMetaVersion'] as String,
      functionArn: map['functionArn'] == null ? null : map['functionArn'] as String,
      notes: map['notes'] as String,
      roleArn: map['roleArn'] as String,
      sourceArn: map['sourceArn'] as String,
      triggerArn: map['triggerArn'] as String,
    );
  }
}
