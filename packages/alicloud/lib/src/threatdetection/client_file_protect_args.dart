...
class ClientFileProtectArgs {
  ...
  ClientFileProtectArgs({
    int? alertLevel,
    required List<String> fileOps,
    required List<String> filePaths,
    required List<String> procPaths,
  ...
  factory ClientFileProtectArgs.fromMap(Map<String, dynamic> map) {
    return ClientFileProtectArgs(
      alertLevel: map['alertLevel'] == null ? null : map['alertLevel'] as int,
      fileOps: (map['fileOps'] as List).cast<String>(),
      filePaths: (map['filePaths'] as List).cast<String>(),
      procPaths: (map['procPaths'] as List).cast<String>(),
      ruleAction: map['ruleAction'] as String,
      ruleName: map['ruleName'] as String,
      status: map['status'] == null ? null : map['status'] as int,
      switchId: map['switchId'] == null ? null : map['switchId'] as String,
    );
  }
}
