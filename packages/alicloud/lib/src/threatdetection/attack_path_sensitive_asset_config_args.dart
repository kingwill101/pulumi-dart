...
class AttackPathSensitiveAssetConfigArgs {
  ...
  AttackPathSensitiveAssetConfigArgs({
    required List<AttackPathSensitiveAssetConfigAttackPathAssetList> attackPathAssetLists,
  }) :
  ...
  factory AttackPathSensitiveAssetConfigArgs.fromMap(Map<String, dynamic> map) {
    return AttackPathSensitiveAssetConfigArgs(
      attackPathAssetLists: pulumi.Input.decodeList<AttackPathSensitiveAssetConfigAttackPathAssetList>(map['attackPathAssetLists'], (value) => AttackPathSensitiveAssetConfigAttackPathAssetList.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
