...
class HoneypotNodeArgs {
  ...
  HoneypotNodeArgs({
    ...
    required int availableProbeNum,
    required String nodeName,
    List<String>? securityGroupProbeIpLists,
  }) :
  ...
  factory HoneypotNodeArgs.fromMap(Map<String, dynamic> map) {
    return HoneypotNodeArgs(
      allowHoneypotAccessInternet: map['allowHoneypotAccessInternet'] == null ? null : map['allowHoneypotAccessInternet'] as bool,
      availableProbeNum: map['availableProbeNum'] as int,
      nodeName: map['nodeName'] as String,
      securityGroupProbeIpLists: map['securityGroupProbeIpLists'] == null ? null : (map['securityGroupProbeIpLists'] as List).cast<String>(),
    );
  }
}
