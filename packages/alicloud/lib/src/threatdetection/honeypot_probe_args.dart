...
class HoneypotProbeArgs {
  ...
  HoneypotProbeArgs({
    bool? arp,
    required String controlNodeId,
    required String displayName,
    List<HoneypotProbeHoneypotBindList>? honeypotBindLists,
    bool? ping,
    required String probeType,
    String? probeVersion,
    String? proxyIp,
    List<String>? serviceIpLists,
    String? uuid,
    String? vpcId,
  }) :
  ...
  factory HoneypotProbeArgs.fromMap(Map<String, dynamic> map) {
    return HoneypotProbeArgs(
      arp: map['arp'] == null ? null : map['arp'] as bool,
      controlNodeId: map['controlNodeId'] as String,
      displayName: map['displayName'] as String,
      honeypotBindLists: map['honeypotBindLists'] == null ? null : pulumi.Input.decodeList<HoneypotProbeHoneypotBindList>(map['honeypotBindLists'], (value) => HoneypotProbeHoneypotBindList.fromMap((value as Map).cast<String, dynamic>())),
      ping: map['ping'] == null ? null : map['ping'] as bool,
      probeType: map['probeType'] as String,
      probeVersion: map['probeVersion'] == null ? null : map['probeVersion'] as String,
      proxyIp: map['proxyIp'] == null ? null : map['proxyIp'] as String,
      serviceIpLists: map['serviceIpLists'] == null ? null : (map['serviceIpLists'] as List).cast<String>(),
