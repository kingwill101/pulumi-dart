...
class WebLockConfigArgs {
  ...
  factory WebLockConfigArgs.fromMap(Map<String, dynamic> map) {
    return WebLockConfigArgs(
      ...
      exclusiveDir: map['exclusiveDir'] == null ? null : map['exclusiveDir'] as String,
      exclusiveFile: map['exclusiveFile'] == null ? null : map['exclusiveFile'] as String,
      exclusiveFileType: map['exclusiveFileType'] == null ? null : map['exclusiveFileType'] as String,
      inclusiveFileType: map['inclusiveFileType'] == null ? null : map['inclusiveFileType'] as String,
