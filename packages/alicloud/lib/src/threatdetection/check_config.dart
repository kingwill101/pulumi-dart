...
class CheckConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CheckConfigSelectedCheck>?> selectedChecks;
  ...
  CheckConfig(
    ...
    this.configure = registerOutput<String?>('configure');
    this.cycleDays = registerOutput<List<int>?>('cycleDays');
    this.enableAddCheck = registerOutput<bool?>('enableAddCheck');
    this.enableAutoCheck = registerOutput<bool?>('enableAutoCheck');
    this.endTime = registerOutput<int?>('endTime');
    this.selectedChecks = registerOutput<List<CheckConfigSelectedCheck>?>('selectedChecks');
    this.startTime = registerOutput<int?>('startTime');
    this.systemConfig = registerOutput<bool?>('systemConfig');
    this.vendors = registerOutput<List<String>?>('vendors');
  }
}
