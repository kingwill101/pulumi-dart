...
class ImageEventOperationArgs {
  ...
  factory ImageEventOperationArgs.fromMap(Map<String, dynamic> map) {
    return ImageEventOperationArgs(
      ...
      eventKey: map['eventKey'] == null ? null : map['eventKey'] as String,
      eventName: map['eventName'] == null ? null : map['eventName'] as String,
      eventType: map['eventType'] as String,
      note: map['note'] == null ? null : map['note'] as String,
      operationCode: map['operationCode'] as String,
      scenarios: map['scenarios'] == null ? null : map['scenarios'] as String,
