...
class OpenApiExplorerApiMcpServerArgs {
  ...
  OpenApiExplorerApiMcpServerArgs({
    List<OpenApiExplorerApiMcpServerAdditionalApiDescription>? additionalApiDescriptions,
    required List<OpenApiExplorerApiMcpServerApi> apis,
    String? assumeRoleExtraPolicy,
    String? assumeRoleName,
    String? description,
    bool? enableAssumeRole,
    bool? enableCustomVpcWhitelist,
    String? instructions,
    String? language,
    String? name,
    String? oauthClientId,
    List<OpenApiExplorerApiMcpServerPrompt>? prompts,
    String? publicAccess,
    List<String>? systemTools,
    List<OpenApiExplorerApiMcpServerTerraformTool>? terraformTools,
    List<String>? vpcWhitelists,
  }) :
      ...
      apis = pulumi.Input.asInput<List<OpenApiExplorerApiMcpServerApi>>(apis),
  ...
  factory OpenApiExplorerApiMcpServerArgs.fromMap(Map<String, dynamic> map) {
    return OpenApiExplorerApiMcpServerArgs(
      additionalApiDescriptions: map['additionalApiDescriptions'] == null ? null : pulumi.Input.decodeList<OpenApiExplorerApiMcpServerAdditionalApiDescription>(map['additionalApiDescriptions'], (value) => OpenApiExplorerApiMcpServerAdditionalApiDescription.fromMap((value as Map).cast<String, dynamic>())),
      apis: pulumi.Input.decodeList<OpenApiExplorerApiMcpServerApi>(map['apis'], (value) => OpenApiExplorerApiMcpServerApi.fromMap((value as Map).cast<String, dynamic>())),
      assumeRoleExtraPolicy: map['assumeRoleExtraPolicy'] == null ? null : map['assumeRoleExtraPolicy'] as String,
      assumeRoleName: map['assumeRoleName'] == null ? null : map['assumeRoleName'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      enableAssumeRole: map['enableAssumeRole'] == null ? null : map['enableAssumeRole'] as bool,
      enableCustomVpcWhitelist: map['enableCustomVpcWhitelist'] == null ? null : map['enableCustomVpcWhitelist'] as bool,
      ...
      oauthClientId: map['oauthClientId'] == null ? null : map['oauthClientId'] as String,
      prompts: map['prompts'] == null ? null : pulumi.Input.decodeList<OpenApiExplorerApiMcpServerPrompt>(map['prompts'], (value) => OpenApiExplorerApiMcpServerPrompt.fromMap((value as Map).cast<String, dynamic>())),
      publicAccess: map['publicAccess'] == null ? null : map['publicAccess'] as String,
      systemTools: map['systemTools'] == null ? null : (map['systemTools'] as List).cast<String>(),
      terraformTools: map['terraformTools'] == null ? null : pulumi.Input.decodeList<OpenApiExplorerApiMcpServerTerraformTool>(map['terraformTools'], (value) => OpenApiExplorerApiMcpServerTerraformTool.fromMap((value as Map).cast<String, dynamic>())),
      vpcWhitelists: map['vpcWhitelists'] == null ? null : (map['vpcWhitelists'] as List).cast<String>(),
    );
  }
}
