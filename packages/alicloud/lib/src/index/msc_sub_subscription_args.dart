...
class MscSubSubscriptionArgs {
  ...
  factory MscSubSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return MscSubSubscriptionArgs(
      ...
      emailStatus: map['emailStatus'] == null ? null : map['emailStatus'] as int,
      itemName: map['itemName'] as String,
      pmsgStatus: map['pmsgStatus'] == null ? null : map['pmsgStatus'] as int,
      smsStatus: map['smsStatus'] == null ? null : map['smsStatus'] as int,
      ttsStatus: map['ttsStatus'] == null ? null : map['ttsStatus'] as int,
      webhookIds: map['webhookIds'] == null ? null : (map['webhookIds'] as List).cast<String>(),
      webhookStatus: map['webhookStatus'] == null ? null : map['webhookStatus'] as int,
    );
  }
}
