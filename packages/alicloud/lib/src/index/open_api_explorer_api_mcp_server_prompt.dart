...
class OpenApiExplorerApiMcpServerPrompt {
  ...
  final List<OpenApiExplorerApiMcpServerPromptArgument>? arguments;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arguments': ?arguments == null ? null : pulumi.Input.encodeList<OpenApiExplorerApiMcpServerPromptArgument, Map<String, dynamic>>(arguments!, (value) => value.toMap()),
      'content': ?content,
  ...
  factory OpenApiExplorerApiMcpServerPrompt.fromMap(Map<String, dynamic> map) {
    return OpenApiExplorerApiMcpServerPrompt(
      arguments: map['arguments'] == null ? null : pulumi.Input.decodeList<OpenApiExplorerApiMcpServerPromptArgument>(map['arguments'], (value) => OpenApiExplorerApiMcpServerPromptArgument.fromMap((value as Map).cast<String, dynamic>())),
