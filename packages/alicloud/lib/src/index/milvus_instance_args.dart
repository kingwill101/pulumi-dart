...
class MilvusInstanceArgs {
  ...
  MilvusInstanceArgs({
    bool? autoBackup,
    List<MilvusInstanceComponent>? components,
    ...
    List<MilvusInstanceVswitchId>? vswitchIds,
    String? zoneId,
  }) :
  ...
  factory MilvusInstanceArgs.fromMap(Map<String, dynamic> map) {
    return MilvusInstanceArgs(
      autoBackup: map['autoBackup'] == null ? null : map['autoBackup'] as bool,
      components: map['components'] == null ? null : pulumi.Input.decodeList<MilvusInstanceComponent>(map['components'], (value) => MilvusInstanceComponent.fromMap((value as Map).cast<String, dynamic>())),
      configuration: map['configuration'] == null ? null : map['configuration'] as String,
      dbAdminPassword: map['dbAdminPassword'] == null ? null : map['dbAdminPassword'] as String,
      ...
      multiZoneMode: map['multiZoneMode'] == null ? null : map['multiZoneMode'] as String,
      ...
      vswitchIds: map['vswitchIds'] == null ? null : pulumi.Input.decodeList<MilvusInstanceVswitchId>(map['vswitchIds'], (value) => MilvusInstanceVswitchId.fromMap((value as Map).cast<String, dynamic>())),
