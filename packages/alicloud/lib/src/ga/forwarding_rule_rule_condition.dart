...
class ForwardingRuleRuleCondition {
  ...
  final List<ForwardingRuleRuleConditionHostConfig>? hostConfigs;
  /// The configuration of the path. See `path_config` below.
  final ForwardingRuleRuleConditionPathConfig? pathConfig;
  ...
  final String? ruleConditionValue;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hostConfigs': ?hostConfigs == null ? null : pulumi.Input.encodeList<ForwardingRuleRuleConditionHostConfig, Map<String, dynamic>>(hostConfigs!, (value) => value.toMap()),
  ...
  factory ForwardingRuleRuleCondition.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleRuleCondition(
      hostConfigs: map['hostConfigs'] == null ? null : pulumi.Input.decodeList<ForwardingRuleRuleConditionHostConfig>(map['hostConfigs'], (value) => ForwardingRuleRuleConditionHostConfig.fromMap((value as Map).cast<String, dynamic>())),
      pathConfig: map['pathConfig'] == null ? null : ForwardingRuleRuleConditionPathConfig.fromMap((map['pathConfig'] as Map).cast<String, dynamic>()),
      ruleConditionType: map['ruleConditionType'] as String,
      ruleConditionValue: map['ruleConditionValue'] == null ? null : map['ruleConditionValue'] as String,
    );
  }
}
