...
class AclArgs {
  ...
  AclArgs({
    List<AclAclEntry>? aclEntries,
    String? aclName,
    required String addressIpVersion,
    bool? dryRun,
    ...
    Map<String, String>? tags,
      ...
      addressIpVersion = pulumi.Input.asInput<String>(addressIpVersion),
  ...
  factory AclArgs.fromMap(Map<String, dynamic> map) {
    return AclArgs(
      aclEntries: map['aclEntries'] == null ? null : pulumi.Input.decodeList<AclAclEntry>(map['aclEntries'], (value) => AclAclEntry.fromMap((value as Map).cast<String, dynamic>())),
