...
class ForwardingRuleArgs {
  ...
  ForwardingRuleArgs({
    ...
    int? priority,
    required List<ForwardingRuleRuleAction> ruleActions,
    required List<ForwardingRuleRuleCondition> ruleConditions,
  }) :
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      ruleActions: pulumi.Input.decodeList<ForwardingRuleRuleAction>(map['ruleActions'], (value) => ForwardingRuleRuleAction.fromMap((value as Map).cast<String, dynamic>())),
      ruleConditions: pulumi.Input.decodeList<ForwardingRuleRuleCondition>(map['ruleConditions'], (value) => ForwardingRuleRuleCondition.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
