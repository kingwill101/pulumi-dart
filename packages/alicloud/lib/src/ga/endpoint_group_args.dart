...
class EndpointGroupArgs {
  ...
  EndpointGroupArgs({
    ...
    String? description,
    required List<EndpointGroupEndpointConfiguration> endpointConfigurations,
    required String endpointGroupRegion,
    String? endpointGroupType,
    String? endpointProtocolVersion,
    String? endpointRequestProtocol,
    ...
    String? name,
    EndpointGroupPortOverrides? portOverrides,
    ...
    int? trafficPercentage,
      ...
      endpointConfigurations = pulumi.Input.asInput<List<EndpointGroupEndpointConfiguration>>(endpointConfigurations),
  ...
  factory EndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return EndpointGroupArgs(
      ...
      endpointConfigurations: pulumi.Input.decodeList<EndpointGroupEndpointConfiguration>(map['endpointConfigurations'], (value) => EndpointGroupEndpointConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      endpointProtocolVersion: map['endpointProtocolVersion'] == null ? null : map['endpointProtocolVersion'] as String,
      endpointRequestProtocol: map['endpointRequestProtocol'] == null ? null : map['endpointRequestProtocol'] as String,
      ...
      portOverrides: map['portOverrides'] == null ? null : EndpointGroupPortOverrides.fromMap((map['portOverrides'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      thresholdCount: map['thresholdCount'] == null ? null : map['thresholdCount'] as int,
