...
class CustomRoutingEndpointTrafficPolicyArgs {
  ...
  CustomRoutingEndpointTrafficPolicyArgs({
    ...
    List<CustomRoutingEndpointTrafficPolicyPortRange>? portRanges,
  }) :
  ...
  factory CustomRoutingEndpointTrafficPolicyArgs.fromMap(Map<String, dynamic> map) {
    return CustomRoutingEndpointTrafficPolicyArgs(
      ...
      portRanges: map['portRanges'] == null ? null : pulumi.Input.decodeList<CustomRoutingEndpointTrafficPolicyPortRange>(map['portRanges'], (value) => CustomRoutingEndpointTrafficPolicyPortRange.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
