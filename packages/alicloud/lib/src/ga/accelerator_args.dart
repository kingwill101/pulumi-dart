...
class AcceleratorArgs {
  ...
  factory AcceleratorArgs.fromMap(Map<String, dynamic> map) {
    return AcceleratorArgs(
      acceleratorName: map['acceleratorName'] == null ? null : map['acceleratorName'] as String,
      ...
      crossBorderMode: map['crossBorderMode'] == null ? null : map['crossBorderMode'] as String,
