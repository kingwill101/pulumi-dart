...
class EtlArgs {
  ...
  EtlArgs({
    ...
    required String etlName,
    required List<EtlEtlSink> etlSinks,
    String? etlType,
    int? fromTime,
    String? kmsEncryptedAccessKeyId,
    String? kmsEncryptedAccessKeySecret,
    Map<String, String>? kmsEncryptionAccessKeyIdContext,
    Map<String, String>? kmsEncryptionAccessKeySecretContext,
    String? lang,
  ...
  factory EtlArgs.fromMap(Map<String, dynamic> map) {
    return EtlArgs(
      ...
      createTime: map['createTime'] == null ? null : map['createTime'] as int,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      etlName: map['etlName'] as String,
      etlSinks: pulumi.Input.decodeList<EtlEtlSink>(map['etlSinks'], (value) => EtlEtlSink.fromMap((value as Map).cast<String, dynamic>())),
      etlType: map['etlType'] == null ? null : map['etlType'] as String,
      ...
      kmsEncryptionAccessKeyIdContext: map['kmsEncryptionAccessKeyIdContext'] == null ? null : (map['kmsEncryptionAccessKeyIdContext'] as Map).cast<String, String>(),
      kmsEncryptionAccessKeySecretContext: map['kmsEncryptionAccessKeySecretContext'] == null ? null : (map['kmsEncryptionAccessKeySecretContext'] as Map).cast<String, String>(),
      lang: map['lang'] == null ? null : map['lang'] as String,
      lastModifiedTime: map['lastModifiedTime'] == null ? null : map['lastModifiedTime'] as int,
