...
class StoreIndexArgs {
  ...
  StoreIndexArgs({
    List<StoreIndexFieldSearch>? fieldSearches,
    StoreIndexFullText? fullText,
    bool? logReduce,
  ...
  factory StoreIndexArgs.fromMap(Map<String, dynamic> map) {
    return StoreIndexArgs(
      fieldSearches: map['fieldSearches'] == null ? null : pulumi.Input.decodeList<StoreIndexFieldSearch>(map['fieldSearches'], (value) => StoreIndexFieldSearch.fromMap((value as Map).cast<String, dynamic>())),
      fullText: map['fullText'] == null ? null : StoreIndexFullText.fromMap((map['fullText'] as Map).cast<String, dynamic>()),
