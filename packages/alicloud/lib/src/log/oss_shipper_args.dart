...
class OssShipperArgs {
  ...
  OssShipperArgs({
    ...
    String? csvConfigNullidentifier,
    ...
    String? ossPrefix,
    List<OssShipperParquetConfig>? parquetConfigs,
  ...
  factory OssShipperArgs.fromMap(Map<String, dynamic> map) {
    return OssShipperArgs(
      ...
      csvConfigNullidentifier: map['csvConfigNullidentifier'] == null ? null : map['csvConfigNullidentifier'] as String,
      ...
      parquetConfigs: map['parquetConfigs'] == null ? null : pulumi.Input.decodeList<OssShipperParquetConfig>(map['parquetConfigs'], (value) => OssShipperParquetConfig.fromMap((value as Map).cast<String, dynamic>())),
