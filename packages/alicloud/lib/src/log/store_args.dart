...
class StoreArgs {
  ...
  StoreArgs({
    bool? appendMeta,
    bool? autoSplit,
    bool? enableWebTracking,
    StoreEncryptConf? encryptConf,
    int? hotTtl,
    int? infrequentAccessTtl,
    String? logstoreName,
  ...
  factory StoreArgs.fromMap(Map<String, dynamic> map) {
    return StoreArgs(
      appendMeta: map['appendMeta'] == null ? null : map['appendMeta'] as bool,
      autoSplit: map['autoSplit'] == null ? null : map['autoSplit'] as bool,
      enableWebTracking: map['enableWebTracking'] == null ? null : map['enableWebTracking'] as bool,
      encryptConf: map['encryptConf'] == null ? null : StoreEncryptConf.fromMap((map['encryptConf'] as Map).cast<String, dynamic>()),
      hotTtl: map['hotTtl'] == null ? null : map['hotTtl'] as int,
      infrequentAccessTtl: map['infrequentAccessTtl'] == null ? null : map['infrequentAccessTtl'] as int,
      logstoreName: map['logstoreName'] == null ? null : map['logstoreName'] as String,
      maxSplitShardCount: map['maxSplitShardCount'] == null ? null : map['maxSplitShardCount'] as int,
      meteringMode: map['meteringMode'] == null ? null : map['meteringMode'] as String,
      ...
      telemetryType: map['telemetryType'] == null ? null : map['telemetryType'] as String,
    );
  }
}
