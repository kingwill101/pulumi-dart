...
class LoadBalancerArgs {
  ...
  LoadBalancerArgs({
    List<LoadBalancerBackendServer>? backendServers,
    required String ensRegionId,
    String? loadBalancerName,
    required String loadBalancerSpec,
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      backendServers: map['backendServers'] == null ? null : pulumi.Input.decodeList<LoadBalancerBackendServer>(map['backendServers'], (value) => LoadBalancerBackendServer.fromMap((value as Map).cast<String, dynamic>())),
