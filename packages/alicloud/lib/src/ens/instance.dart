...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.netDistrictCode = registerOutput<String?>('netDistrictCode');
    ...
    this.publicIpIdentification = registerOutput<bool?>('publicIpIdentification');
    this.scheduleAreaLevel = registerOutput<String>('scheduleAreaLevel');
    this.schedulingPriceStrategy = registerOutput<String?>('schedulingPriceStrategy');
    this.schedulingStrategy = registerOutput<String?>('schedulingStrategy');
    this.securityId = registerOutput<String>('securityId');
    this.spotStrategy = registerOutput<String?>('spotStrategy');
    this.status = registerOutput<String>('status');
    this.systemDisk = registerOutput<InstanceSystemDisk?>('systemDisk');
