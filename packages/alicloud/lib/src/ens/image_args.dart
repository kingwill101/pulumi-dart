...
class ImageArgs {
  ...
  ImageArgs({
    String? deleteAfterImageUpload,
    required String imageName,
    String? instanceId,
    String? targetOssRegionId,
  }) :
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      deleteAfterImageUpload: map['deleteAfterImageUpload'] == null ? null : map['deleteAfterImageUpload'] as String,
      imageName: map['imageName'] as String,
      instanceId: map['instanceId'] == null ? null : map['instanceId'] as String,
      targetOssRegionId: map['targetOssRegionId'] == null ? null : map['targetOssRegionId'] as String,
    );
  }
}
