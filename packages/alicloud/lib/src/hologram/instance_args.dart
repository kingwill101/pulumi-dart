...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      endpoints: map['endpoints'] == null ? null : pulumi.Input.decodeList<InstanceEndpoint>(map['endpoints'], (value) => InstanceEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      gatewayCount: map['gatewayCount'] == null ? null : map['gatewayCount'] as int,
      initialDatabases: map['initialDatabases'] == null ? null : map['initialDatabases'] as String,
      instanceName: map['instanceName'] as String,
      instanceType: map['instanceType'] as String,
      leaderInstanceId: map['leaderInstanceId'] == null ? null : map['leaderInstanceId'] as String,
