...
class GatewayArgs {
  ...
  GatewayArgs({
    ...
    GatewayNetworkAccessConfig? networkAccessConfig,
    required String paymentType,
    String? resourceGroupId,
    String? spec,
    Map<String, String>? tags,
    GatewayVpc? vpc,
    GatewayVswitch? vswitch,
    required GatewayZoneConfig zoneConfig,
    List<GatewayZone>? zones,
  }) :
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      logConfig: map['logConfig'] == null ? null : GatewayLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      networkAccessConfig: map['networkAccessConfig'] == null ? null : GatewayNetworkAccessConfig.fromMap((map['networkAccessConfig'] as Map).cast<String, dynamic>()),
      paymentType: map['paymentType'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      spec: map['spec'] == null ? null : map['spec'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      vpc: map['vpc'] == null ? null : GatewayVpc.fromMap((map['vpc'] as Map).cast<String, dynamic>()),
      vswitch: map['vswitch'] == null ? null : GatewayVswitch.fromMap((map['vswitch'] as Map).cast<String, dynamic>()),
      zoneConfig: GatewayZoneConfig.fromMap((map['zoneConfig'] as Map).cast<String, dynamic>()),
      zones: map['zones'] == null ? null : pulumi.Input.decodeList<GatewayZone>(map['zones'], (value) => GatewayZone.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
