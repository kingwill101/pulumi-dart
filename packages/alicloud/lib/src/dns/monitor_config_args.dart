...
class MonitorConfigArgs {
  ...
  MonitorConfigArgs({
    required String addrPoolId,
    required int evaluationCount,
    required int interval,
    required List<MonitorConfigIspCityNode> ispCityNodes,
    String? lang,
    required String monitorExtendInfo,
  ...
  factory MonitorConfigArgs.fromMap(Map<String, dynamic> map) {
    return MonitorConfigArgs(
      ...
      ispCityNodes: pulumi.Input.decodeList<MonitorConfigIspCityNode>(map['ispCityNodes'], (value) => MonitorConfigIspCityNode.fromMap((value as Map).cast<String, dynamic>())),
      lang: map['lang'] == null ? null : map['lang'] as String,
      monitorExtendInfo: map['monitorExtendInfo'] as String,
