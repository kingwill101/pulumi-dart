...
class CustomLineArgs {
  ...
  /// [lang] The lang.
  CustomLineArgs({
    required String customLineName,
    required String domainName,
    required List<CustomLineIpSegmentList> ipSegmentLists,
    String? lang,
  }) :
  ...
  factory CustomLineArgs.fromMap(Map<String, dynamic> map) {
    return CustomLineArgs(
      ...
      ipSegmentLists: pulumi.Input.decodeList<CustomLineIpSegmentList>(map['ipSegmentLists'], (value) => CustomLineIpSegmentList.fromMap((value as Map).cast<String, dynamic>())),
