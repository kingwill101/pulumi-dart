...
class AclArgs {
  ...
  factory AclArgs.fromMap(Map<String, dynamic> map) {
    return AclArgs(
      entryLists: map['entryLists'] == null ? null : pulumi.Input.decodeList<AclEntryList>(map['entryLists'], (value) => AclEntryList.fromMap((value as Map).cast<String, dynamic>())),
