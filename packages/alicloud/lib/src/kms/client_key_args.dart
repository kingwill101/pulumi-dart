...
class ClientKeyArgs {
  ...
  ClientKeyArgs({
    required String aapName,
    String? notAfter,
    String? notBefore,
    required String password,
    String? privateKeyDataFile,
  }) :
