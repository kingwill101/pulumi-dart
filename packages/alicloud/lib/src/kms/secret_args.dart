...
class SecretArgs {
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      enableAutomaticRotation: map['enableAutomaticRotation'] == null ? null : map['enableAutomaticRotation'] as bool,
      encryptionKeyId: map['encryptionKeyId'] == null ? null : map['encryptionKeyId'] as String,
      extendedConfig: map['extendedConfig'] == null ? null : map['extendedConfig'] as String,
      forceDeleteWithoutRecovery: map['forceDeleteWithoutRecovery'] == null ? null : map['forceDeleteWithoutRecovery'] as bool,
      policy: map['policy'] == null ? null : map['policy'] as String,
      recoveryWindowInDays: map['recoveryWindowInDays'] == null ? null : map['recoveryWindowInDays'] as int,
      rotationInterval: map['rotationInterval'] == null ? null : map['rotationInterval'] as String,
      secretData: map['secretData'] as String,
      secretDataType: map['secretDataType'] == null ? null : map['secretDataType'] as String,
      secretName: map['secretName'] as String,
      secretType: map['secretType'] == null ? null : map['secretType'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      versionId: map['versionId'] as String,
      versionStages: map['versionStages'] == null ? null : (map['versionStages'] as List).cast<String>(),
    );
  }
}
