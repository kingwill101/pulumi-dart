...
class NetworkRuleArgs {
  ...
  NetworkRuleArgs({
    String? description,
    String? networkRuleName,
    required List<String> sourcePrivateIps,
  }) :
  ...
  factory NetworkRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkRuleArgs(
      ...
      networkRuleName: map['networkRuleName'] == null ? null : map['networkRuleName'] as String,
      sourcePrivateIps: (map['sourcePrivateIps'] as List).cast<String>(),
    );
  }
}
