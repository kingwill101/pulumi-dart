...
class GlobalSecurityIpGroupArgs {
  ...
  GlobalSecurityIpGroupArgs({
    required String globalIgName,
    required String globalSecurityIpList,
  }) :
  ...
  factory GlobalSecurityIpGroupArgs.fromMap(Map<String, dynamic> map) {
    return GlobalSecurityIpGroupArgs(
      globalIgName: map['globalIgName'] as String,
      globalSecurityIpList: map['globalSecurityIpList'] as String,
    );
  }
}
