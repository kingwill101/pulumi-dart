...
class BizTypeArgs {
  ...
  BizTypeArgs({
    String? bizTypeImport,
    required String bizTypeName,
    bool? citeTemplate,
    String? description,
    String? industryInfo,
  }) :
      bizTypeImport = pulumi.Input.asOptionalInput<String>(bizTypeImport),
      bizTypeName = pulumi.Input.asInput<String>(bizTypeName),
  ...
  factory BizTypeArgs.fromMap(Map<String, dynamic> map) {
    return BizTypeArgs(
      bizTypeImport: map['bizTypeImport'] == null ? null : map['bizTypeImport'] as String,
      bizTypeName: map['bizTypeName'] as String,
      citeTemplate: map['citeTemplate'] == null ? null : map['citeTemplate'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      industryInfo: map['industryInfo'] == null ? null : map['industryInfo'] as String,
    );
  }
}
