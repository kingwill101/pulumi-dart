...
class ScalingConfigurationArgs {
  ...
  ScalingConfigurationArgs({
    ...
    List<ScalingConfigurationCustomPriority>? customPriorities,
    List<ScalingConfigurationDataDisk>? dataDisks,
    ...
    String? instanceName,
    List<ScalingConfigurationInstancePatternInfo>? instancePatternInfos,
    String? instanceType,
    List<ScalingConfigurationInstanceTypeOverride>? instanceTypeOverrides,
    ...
    List<ScalingConfigurationNetworkInterface>? networkInterfaces,
    bool? override,
    String? password,
    ...
    int? spotDuration,
    List<ScalingConfigurationSpotPriceLimit>? spotPriceLimits,
    String? spotStrategy,
    String? substitute,
  ...
  factory ScalingConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ScalingConfigurationArgs(
      ...
      customPriorities: map['customPriorities'] == null ? null : pulumi.Input.decodeList<ScalingConfigurationCustomPriority>(map['customPriorities'], (value) => ScalingConfigurationCustomPriority.fromMap((value as Map).cast<String, dynamic>())),
      dataDisks: map['dataDisks'] == null ? null : pulumi.Input.decodeList<ScalingConfigurationDataDisk>(map['dataDisks'], (value) => ScalingConfigurationDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      dedicatedHostClusterId: map['dedicatedHostClusterId'] == null ? null : map['dedicatedHostClusterId'] as String,
      ...
      imageOptionsLoginAsNonRoot: map['imageOptionsLoginAsNonRoot'] == null ? null : map['imageOptionsLoginAsNonRoot'] as bool,
      instanceDescription: map['instanceDescription'] == null ? null : map['instanceDescription'] as String,
      ...
      instancePatternInfos: map['instancePatternInfos'] == null ? null : pulumi.Input.decodeList<ScalingConfigurationInstancePatternInfo>(map['instancePatternInfos'], (value) => ScalingConfigurationInstancePatternInfo.fromMap((value as Map).cast<String, dynamic>())),
      instanceType: map['instanceType'] == null ? null : map['instanceType'] as String,
      instanceTypeOverrides: map['instanceTypeOverrides'] == null ? null : pulumi.Input.decodeList<ScalingConfigurationInstanceTypeOverride>(map['instanceTypeOverrides'], (value) => ScalingConfigurationInstanceTypeOverride.fromMap((value as Map).cast<String, dynamic>())),
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<ScalingConfigurationNetworkInterface>(map['networkInterfaces'], (value) => ScalingConfigurationNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      ...
      spotPriceLimits: map['spotPriceLimits'] == null ? null : pulumi.Input.decodeList<ScalingConfigurationSpotPriceLimit>(map['spotPriceLimits'], (value) => ScalingConfigurationSpotPriceLimit.fromMap((value as Map).cast<String, dynamic>())),
      spotStrategy: map['spotStrategy'] == null ? null : map['spotStrategy'] as String,
      substitute: map['substitute'] == null ? null : map['substitute'] as String,
