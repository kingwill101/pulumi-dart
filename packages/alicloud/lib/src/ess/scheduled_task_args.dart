...
class ScheduledTaskArgs {
  ...
  factory ScheduledTaskArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledTaskArgs(
      ...
      maxValue: map['maxValue'] == null ? null : map['maxValue'] as int,
      minValue: map['minValue'] == null ? null : map['minValue'] as int,
      recurrenceEndTime: map['recurrenceEndTime'] == null ? null : map['recurrenceEndTime'] as String,
      ...
      scheduledTaskName: map['scheduledTaskName'] == null ? null : map['scheduledTaskName'] as String,
      taskEnabled: map['taskEnabled'] == null ? null : map['taskEnabled'] as bool,
    );
  }
}
