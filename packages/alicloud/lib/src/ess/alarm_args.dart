...
class AlarmArgs {
  ...
  AlarmArgs({
    required List<String> alarmActions,
    ...
    bool? enable,
    int? evaluationCount,
    List<AlarmExpression>? expressions,
    String? expressionsLogicOperator,
    String? metricName,
    String? metricType,
    String? name,
    int? period,
  ...
  factory AlarmArgs.fromMap(Map<String, dynamic> map) {
    return AlarmArgs(
      ...
      cloudMonitorGroupId: map['cloudMonitorGroupId'] == null ? null : map['cloudMonitorGroupId'] as int,
      ...
      effective: map['effective'] == null ? null : map['effective'] as String,
      enable: map['enable'] == null ? null : map['enable'] as bool,
      evaluationCount: map['evaluationCount'] == null ? null : map['evaluationCount'] as int,
      expressions: map['expressions'] == null ? null : pulumi.Input.decodeList<AlarmExpression>(map['expressions'], (value) => AlarmExpression.fromMap((value as Map).cast<String, dynamic>())),
      expressionsLogicOperator: map['expressionsLogicOperator'] == null ? null : map['expressionsLogicOperator'] as String,
