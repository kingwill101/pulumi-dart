...
class ScalingRuleArgs {
  ...
  ScalingRuleArgs({
    ...
    int? adjustmentValue,
    ScalingRuleAlarmDimension? alarmDimension,
    int? cooldown,
    bool? disableScaleIn,
    int? estimatedInstanceWarmup,
    List<ScalingRuleHybridMetric>? hybridMetrics,
    ...
    List<ScalingRuleStepAdjustment>? stepAdjustments,
    double? targetValue,
  }) :
  ...
  factory ScalingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ScalingRuleArgs(
      ...
      adjustmentValue: map['adjustmentValue'] == null ? null : map['adjustmentValue'] as int,
      alarmDimension: map['alarmDimension'] == null ? null : ScalingRuleAlarmDimension.fromMap((map['alarmDimension'] as Map).cast<String, dynamic>()),
      ...
      hybridMetrics: map['hybridMetrics'] == null ? null : pulumi.Input.decodeList<ScalingRuleHybridMetric>(map['hybridMetrics'], (value) => ScalingRuleHybridMetric.fromMap((value as Map).cast<String, dynamic>())),
      hybridMonitorNamespace: map['hybridMonitorNamespace'] == null ? null : map['hybridMonitorNamespace'] as String,
      initialMaxSize: map['initialMaxSize'] == null ? null : map['initialMaxSize'] as int,
      ...
      predictiveTaskBufferTime: map['predictiveTaskBufferTime'] == null ? null : map['predictiveTaskBufferTime'] as int,
      predictiveValueBehavior: map['predictiveValueBehavior'] == null ? null : map['predictiveValueBehavior'] as String,
      predictiveValueBuffer: map['predictiveValueBuffer'] == null ? null : map['predictiveValueBuffer'] as int,
      scaleInEvaluationCount: map['scaleInEvaluationCount'] == null ? null : map['scaleInEvaluationCount'] as int,
      scaleOutEvaluationCount: map['scaleOutEvaluationCount'] == null ? null : map['scaleOutEvaluationCount'] as int,
      scalingGroupId: map['scalingGroupId'] as String,
      scalingRuleName: map['scalingRuleName'] == null ? null : map['scalingRuleName'] as String,
      scalingRuleType: map['scalingRuleType'] == null ? null : map['scalingRuleType'] as String,
      stepAdjustments: map['stepAdjustments'] == null ? null : pulumi.Input.decodeList<ScalingRuleStepAdjustment>(map['stepAdjustments'], (value) => ScalingRuleStepAdjustment.fromMap((value as Map).cast<String, dynamic>())),
