...
class ScalingGroupArgs {
  ...
  ScalingGroupArgs({
    List<ScalingGroupAlbServerGroup>? albServerGroups,
    ...
    List<ScalingGroupLaunchTemplateOverride>? launchTemplateOverrides,
    ...
    List<String>? protectedInstances,
    List<String>? removalPolicies,
  ...
  factory ScalingGroupArgs.fromMap(Map<String, dynamic> map) {
    return ScalingGroupArgs(
      albServerGroups: map['albServerGroups'] == null ? null : pulumi.Input.decodeList<ScalingGroupAlbServerGroup>(map['albServerGroups'], (value) => ScalingGroupAlbServerGroup.fromMap((value as Map).cast<String, dynamic>())),
      allocationStrategy: map['allocationStrategy'] == null ? null : map['allocationStrategy'] as String,
      autoRebalance: map['autoRebalance'] == null ? null : map['autoRebalance'] as bool,
      azBalance: map['azBalance'] == null ? null : map['azBalance'] as bool,
      balanceMode: map['balanceMode'] == null ? null : map['balanceMode'] as String,
      capacityOptionsCompensateWithOnDemand: map['capacityOptionsCompensateWithOnDemand'] == null ? null : map['capacityOptionsCompensateWithOnDemand'] as bool,
      capacityOptionsOnDemandBaseCapacity: map['capacityOptionsOnDemandBaseCapacity'] == null ? null : map['capacityOptionsOnDemandBaseCapacity'] as int,
      capacityOptionsOnDemandPercentageAboveBaseCapacity: map['capacityOptionsOnDemandPercentageAboveBaseCapacity'] == null ? null : map['capacityOptionsOnDemandPercentageAboveBaseCapacity'] as int,
      capacityOptionsPriceComparisonMode: map['capacityOptionsPriceComparisonMode'] == null ? null : map['capacityOptionsPriceComparisonMode'] as String,
      capacityOptionsSpotAutoReplaceOnDemand: map['capacityOptionsSpotAutoReplaceOnDemand'] == null ? null : map['capacityOptionsSpotAutoReplaceOnDemand'] as bool,
      compensateWithOnDemand: map['compensateWithOnDemand'] == null ? null : map['compensateWithOnDemand'] as bool,
      containerGroupId: map['containerGroupId'] == null ? null : map['containerGroupId'] as String,
      dbInstanceIds: map['dbInstanceIds'] == null ? null : (map['dbInstanceIds'] as List).cast<String>(),
      ...
      groupDeletionProtection: map['groupDeletionProtection'] == null ? null : map['groupDeletionProtection'] as bool,
      ...
      healthCheckTypes: map['healthCheckTypes'] == null ? null : (map['healthCheckTypes'] as List).cast<String>(),
      instanceId: map['instanceId'] == null ? null : map['instanceId'] as String,
      launchTemplateId: map['launchTemplateId'] == null ? null : map['launchTemplateId'] as String,
      launchTemplateOverrides: map['launchTemplateOverrides'] == null ? null : pulumi.Input.decodeList<ScalingGroupLaunchTemplateOverride>(map['launchTemplateOverrides'], (value) => ScalingGroupLaunchTemplateOverride.fromMap((value as Map).cast<String, dynamic>())),
      ...
      protectedInstances: map['protectedInstances'] == null ? null : (map['protectedInstances'] as List).cast<String>(),
      removalPolicies: map['removalPolicies'] == null ? null : (map['removalPolicies'] as List).cast<String>(),
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      scalingGroupName: map['scalingGroupName'] == null ? null : map['scalingGroupName'] as String,
      ...
      stopInstanceTimeout: map['stopInstanceTimeout'] == null ? null : map['stopInstanceTimeout'] as int,
