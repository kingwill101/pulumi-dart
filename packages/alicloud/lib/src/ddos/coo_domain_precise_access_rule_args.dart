...
/// {@template pulumi_ddos_coo_domain_precise_access_rule_coo_domain_precise_access_rule_args_doc}
/// The set of arguments for CooDomainPreciseAccessRule.
/// {@endtemplate}
/// {@macro pulumi_ddos_coo_domain_precise_access_rule_coo_domain_precise_access_rule_args_doc}
class CooDomainPreciseAccessRuleArgs {
  ...
  /// Creates a new [CooDomainPreciseAccessRuleArgs].
  ...
  CooDomainPreciseAccessRuleArgs({
    ...
    required List<CooDomainPreciseAccessRuleCondition> conditions,
    required String domain,
    int? expires,
    String? name,
  }) :
      action = pulumi.Input.asInput<String>(action),
      conditions = pulumi.Input.asInput<List<CooDomainPreciseAccessRuleCondition>>(conditions),
  ...
  factory CooDomainPreciseAccessRuleArgs.fromMap(Map<String, dynamic> map) {
    return CooDomainPreciseAccessRuleArgs(
      ...
      conditions: pulumi.Input.decodeList<CooDomainPreciseAccessRuleCondition>(map['conditions'], (value) => CooDomainPreciseAccessRuleCondition.fromMap((value as Map).cast<String, dynamic>())),
