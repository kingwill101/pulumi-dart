...
class CooWebCcRuleRuleDetailStatusCode {
  ...
  factory CooWebCcRuleRuleDetailStatusCode.fromMap(Map<String, dynamic> map) {
    return CooWebCcRuleRuleDetailStatusCode(
      ...
      countThreshold: map['countThreshold'] == null ? null : map['countThreshold'] as int,
      enabled: map['enabled'] as bool,
      ratioThreshold: map['ratioThreshold'] == null ? null : map['ratioThreshold'] as int,
      useRatio: map['useRatio'] as bool,
    );
  }
}
