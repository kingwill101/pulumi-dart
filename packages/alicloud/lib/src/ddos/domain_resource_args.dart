...
class DomainResourceArgs {
  ...
  DomainResourceArgs({
    ...
    String? key,
    bool? ocspEnabled,
    required List<DomainResourceProxyType> proxyTypes,
    ...
    List<String>? whiteLists,
      ...
      proxyTypes = pulumi.Input.asInput<List<DomainResourceProxyType>>(proxyTypes),
      realServers = pulumi.Input.asInput<List<String>>(realServers),
      rsType = pulumi.Input.asInput<int>(rsType),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'proxyTypes': pulumi.Input.mapInputValue<List<DomainResourceProxyType>, List<Map<String, dynamic>>>(proxyTypes, (value) => pulumi.Input.encodeList<DomainResourceProxyType, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DomainResourceArgs.fromMap(Map<String, dynamic> map) {
    return DomainResourceArgs(
      aiMode: map['aiMode'] == null ? null : map['aiMode'] as String,
      aiTemplate: map['aiTemplate'] == null ? null : map['aiTemplate'] as String,
      blackLists: map['blackLists'] == null ? null : (map['blackLists'] as List).cast<String>(),
      bwListEnable: map['bwListEnable'] == null ? null : map['bwListEnable'] as int,
      ccGlobalSwitch: map['ccGlobalSwitch'] == null ? null : map['ccGlobalSwitch'] as String,
      cert: map['cert'] == null ? null : map['cert'] as String,
      certIdentifier: map['certIdentifier'] == null ? null : map['certIdentifier'] as String,
      ...
      httpsExt: map['httpsExt'] == null ? null : map['httpsExt'] as String,
      instanceIds: (map['instanceIds'] as List).cast<String>(),
      key: map['key'] == null ? null : map['key'] as String,
      ocspEnabled: map['ocspEnabled'] == null ? null : map['ocspEnabled'] as bool,
      proxyTypes: pulumi.Input.decodeList<DomainResourceProxyType>(map['proxyTypes'], (value) => DomainResourceProxyType.fromMap((value as Map).cast<String, dynamic>())),
      realServers: (map['realServers'] as List).cast<String>(),
      rsType: map['rsType'] as int,
      whiteLists: map['whiteLists'] == null ? null : (map['whiteLists'] as List).cast<String>(),
    );
  }
}
