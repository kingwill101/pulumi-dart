...
class PortArgs {
  ...
  PortArgs({
    String? backendPort,
    PortConfig? config,
    required String frontendPort,
    required String frontendProtocol,
    required String instanceId,
    required List<String> realServers,
  }) :
  ...
  factory PortArgs.fromMap(Map<String, dynamic> map) {
    return PortArgs(
      backendPort: map['backendPort'] == null ? null : map['backendPort'] as String,
      config: map['config'] == null ? null : PortConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
