...
class AccessConfigurationArgs {
  ...
  AccessConfigurationArgs({
    required String accessConfigurationName,
    String? description,
    required String directoryId,
    bool? forceRemovePermissionPolicies,
    List<AccessConfigurationPermissionPolicy>? permissionPolicies,
    String? relayState,
    int? sessionDuration,
  }) :
  ...
  factory AccessConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return AccessConfigurationArgs(
      ...
      forceRemovePermissionPolicies: map['forceRemovePermissionPolicies'] == null ? null : map['forceRemovePermissionPolicies'] as bool,
      permissionPolicies: map['permissionPolicies'] == null ? null : pulumi.Input.decodeList<AccessConfigurationPermissionPolicy>(map['permissionPolicies'], (value) => AccessConfigurationPermissionPolicy.fromMap((value as Map).cast<String, dynamic>())),
      relayState: map['relayState'] == null ? null : map['relayState'] as String,
      sessionDuration: map['sessionDuration'] == null ? null : map['sessionDuration'] as int,
    );
  }
}
