...
class ProvisionedProductArgs {
  ...
  factory ProvisionedProductArgs.fromMap(Map<String, dynamic> map) {
    return ProvisionedProductArgs(
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<ProvisionedProductParameter>(map['parameters'], (value) => ProvisionedProductParameter.fromMap((value as Map).cast<String, dynamic>())),
      portfolioId: map['portfolioId'] == null ? null : map['portfolioId'] as String,
      productId: map['productId'] as String,
      productVersionId: map['productVersionId'] as String,
      provisionedProductId: map['provisionedProductId'] == null ? null : map['provisionedProductId'] as String,
