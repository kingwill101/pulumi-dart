...
class CollectionPolicyArgs {
  ...
  CollectionPolicyArgs({
    CollectionPolicyCentralizeConfig? centralizeConfig,
    bool? centralizeEnabled,
    required String dataCode,
    CollectionPolicyDataConfig? dataConfig,
    required bool enabled,
    required CollectionPolicyPolicyConfig policyConfig,
    required String policyName,
    required String productCode,
    CollectionPolicyResourceDirectory? resourceDirectory,
  }) :
  ...
  factory CollectionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return CollectionPolicyArgs(
      centralizeConfig: map['centralizeConfig'] == null ? null : CollectionPolicyCentralizeConfig.fromMap((map['centralizeConfig'] as Map).cast<String, dynamic>()),
      centralizeEnabled: map['centralizeEnabled'] == null ? null : map['centralizeEnabled'] as bool,
      dataCode: map['dataCode'] as String,
      dataConfig: map['dataConfig'] == null ? null : CollectionPolicyDataConfig.fromMap((map['dataConfig'] as Map).cast<String, dynamic>()),
      enabled: map['enabled'] as bool,
      policyConfig: CollectionPolicyPolicyConfig.fromMap((map['policyConfig'] as Map).cast<String, dynamic>()),
      policyName: map['policyName'] as String,
      productCode: map['productCode'] as String,
      resourceDirectory: map['resourceDirectory'] == null ? null : CollectionPolicyResourceDirectory.fromMap((map['resourceDirectory'] as Map).cast<String, dynamic>()),
    );
  }
}
