...
class AlertArgs {
  ...
  AlertArgs({
    ...
    required AlertConfiguration configuration,
    String? description,
    required String displayName,
    required String projectName,
    required AlertSchedule schedule,
    String? status,
  }) :
  ...
  factory AlertArgs.fromMap(Map<String, dynamic> map) {
    return AlertArgs(
      ...
      configuration: AlertConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] as String,
      projectName: map['projectName'] as String,
      schedule: AlertSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
