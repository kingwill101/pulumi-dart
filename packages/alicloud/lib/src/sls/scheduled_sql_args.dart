...
class ScheduledSqlArgs {
  ...
  ScheduledSqlArgs({
    ...
    required ScheduledSqlSchedule schedule,
    required ScheduledSqlScheduledSqlConfiguration scheduledSqlConfiguration,
    required String scheduledSqlName,
    String? status,
  }) :
  ...
  factory ScheduledSqlArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledSqlArgs(
      ...
      schedule: ScheduledSqlSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
      scheduledSqlConfiguration: ScheduledSqlScheduledSqlConfiguration.fromMap((map['scheduledSqlConfiguration'] as Map).cast<String, dynamic>()),
      scheduledSqlName: map['scheduledSqlName'] as String,
