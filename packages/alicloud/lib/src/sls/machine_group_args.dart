...
class MachineGroupArgs {
  ...
  MachineGroupArgs({
    MachineGroupGroupAttribute? groupAttribute,
    required String groupName,
    String? groupType,
    required String machineIdentifyType,
    required List<String> machineLists,
  ...
  factory MachineGroupArgs.fromMap(Map<String, dynamic> map) {
    return MachineGroupArgs(
      groupAttribute: map['groupAttribute'] == null ? null : MachineGroupGroupAttribute.fromMap((map['groupAttribute'] as Map).cast<String, dynamic>()),
      groupName: map['groupName'] as String,
      groupType: map['groupType'] == null ? null : map['groupType'] as String,
      machineIdentifyType: map['machineIdentifyType'] as String,
      machineLists: (map['machineLists'] as List).cast<String>(),
