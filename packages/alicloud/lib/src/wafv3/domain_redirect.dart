...
class DomainRedirect {
  ...
  final List<String>? backupBackends;
  ...
  final int? http2OriginMaxConcurrency;
  ...
  final List<DomainRedirectRequestHeader>? requestHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestHeaders': ?requestHeaders == null ? null : pulumi.Input.encodeList<DomainRedirectRequestHeader, Map<String, dynamic>>(requestHeaders!, (value) => value.toMap()),
      'retry': ?retry,
  ...
  factory DomainRedirect.fromMap(Map<String, dynamic> map) {
    return DomainRedirect(
      ...
      backupBackends: map['backupBackends'] == null ? null : (map['backupBackends'] as List).cast<String>(),
      connectTimeout: map['connectTimeout'] == null ? null : map['connectTimeout'] as int,
      focusHttpBackend: map['focusHttpBackend'] == null ? null : map['focusHttpBackend'] as bool,
      http2Origin: map['http2Origin'] == null ? null : map['http2Origin'] as bool,
      http2OriginMaxConcurrency: map['http2OriginMaxConcurrency'] == null ? null : map['http2OriginMaxConcurrency'] as int,
      keepalive: map['keepalive'] == null ? null : map['keepalive'] as bool,
      keepaliveRequests: map['keepaliveRequests'] == null ? null : map['keepaliveRequests'] as int,
      keepaliveTimeout: map['keepaliveTimeout'] == null ? null : map['keepaliveTimeout'] as int,
      loadbalance: map['loadbalance'] as String,
      maxBodySize: map['maxBodySize'] == null ? null : map['maxBodySize'] as int,
      readTimeout: map['readTimeout'] == null ? null : map['readTimeout'] as int,
      requestHeaders: map['requestHeaders'] == null ? null : pulumi.Input.decodeList<DomainRedirectRequestHeader>(map['requestHeaders'], (value) => DomainRedirectRequestHeader.fromMap((value as Map).cast<String, dynamic>())),
      retry: map['retry'] == null ? null : map['retry'] as bool,
      sniEnabled: map['sniEnabled'] == null ? null : map['sniEnabled'] as bool,
      sniHost: map['sniHost'] == null ? null : map['sniHost'] as String,
      writeTimeout: map['writeTimeout'] == null ? null : map['writeTimeout'] as int,
      xffProto: map['xffProto'] == null ? null : map['xffProto'] as bool,
    );
  }
}
