...
class DefenseRuleConfigGrayConfig {
  ...
  factory DefenseRuleConfigGrayConfig.fromMap(Map<String, dynamic> map) {
    return DefenseRuleConfigGrayConfig(
      grayRate: map['grayRate'] == null ? null : map['grayRate'] as int,
      graySubKey: map['graySubKey'] == null ? null : map['graySubKey'] as String,
      grayTarget: map['grayTarget'] == null ? null : map['grayTarget'] as String,
    );
  }
}
