...
class DefenseTemplateArgs {
  ...
  DefenseTemplateArgs({
    ...
    required String defenseTemplateName,
    String? description,
    ...
    required String templateOrigin,
  ...
  factory DefenseTemplateArgs.fromMap(Map<String, dynamic> map) {
    return DefenseTemplateArgs(
      ...
      defenseTemplateName: map['defenseTemplateName'] as String,
      ...
      templateOrigin: map['templateOrigin'] as String,
