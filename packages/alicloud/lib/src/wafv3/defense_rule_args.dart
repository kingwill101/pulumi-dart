...
class DefenseRuleArgs {
  ...
  DefenseRuleArgs({
    required DefenseRuleConfig config,
    String? defenseOrigin,
    required String defenseScene,
    required String defenseType,
  ...
  factory DefenseRuleArgs.fromMap(Map<String, dynamic> map) {
    return DefenseRuleArgs(
      config: DefenseRuleConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
      defenseOrigin: map['defenseOrigin'] == null ? null : map['defenseOrigin'] as String,
      defenseScene: map['defenseScene'] as String,
      defenseType: map['defenseType'] as String,
      ...
      templateId: map['templateId'] == null ? null : map['templateId'] as int,
    );
  }
}
