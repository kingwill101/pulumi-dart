...
class DomainListen {
  ...
  factory DomainListen.fromMap(Map<String, dynamic> map) {
    return DomainListen(
      ...
      cipherSuite: map['cipherSuite'] == null ? null : map['cipherSuite'] as int,
      customCiphers: map['customCiphers'] == null ? null : (map['customCiphers'] as List).cast<String>(),
      enableTlsv3: map['enableTlsv3'] == null ? null : map['enableTlsv3'] as bool,
      exclusiveIp: map['exclusiveIp'] == null ? null : map['exclusiveIp'] as bool,
      focusHttps: map['focusHttps'] == null ? null : map['focusHttps'] as bool,
      http2Enabled: map['http2Enabled'] == null ? null : map['http2Enabled'] as bool,
      httpPorts: map['httpPorts'] == null ? null : (map['httpPorts'] as List).cast<int>(),
      httpsPorts: map['httpsPorts'] == null ? null : (map['httpsPorts'] as List).cast<int>(),
      ipv6Enabled: map['ipv6Enabled'] == null ? null : map['ipv6Enabled'] as bool,
      protectionResource: map['protectionResource'] == null ? null : map['protectionResource'] as String,
      sm2AccessOnly: map['sm2AccessOnly'] == null ? null : map['sm2AccessOnly'] as bool,
      sm2CertId: map['sm2CertId'] == null ? null : map['sm2CertId'] as String,
      sm2Enabled: map['sm2Enabled'] == null ? null : map['sm2Enabled'] as bool,
      tlsVersion: map['tlsVersion'] == null ? null : map['tlsVersion'] as String,
      xffHeaderMode: map['xffHeaderMode'] == null ? null : map['xffHeaderMode'] as int,
      xffHeaders: map['xffHeaders'] == null ? null : (map['xffHeaders'] as List).cast<String>(),
    );
  }
}
