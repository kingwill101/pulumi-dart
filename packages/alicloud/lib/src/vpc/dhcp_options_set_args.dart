...
class DhcpOptionsSetArgs {
  ...
  factory DhcpOptionsSetArgs.fromMap(Map<String, dynamic> map) {
    return DhcpOptionsSetArgs(
      associateVpcs: map['associateVpcs'] == null ? null : pulumi.Input.decodeList<DhcpOptionsSetAssociateVpc>(map['associateVpcs'], (value) => DhcpOptionsSetAssociateVpc.fromMap((value as Map).cast<String, dynamic>())),
      dhcpOptionsSetDescription: map['dhcpOptionsSetDescription'] == null ? null : map['dhcpOptionsSetDescription'] as String,
      ...
      domainNameServers: map['domainNameServers'] == null ? null : map['domainNameServers'] as String,
      dryRun: map['dryRun'] == null ? null : map['dryRun'] as bool,
      ipv6LeaseTime: map['ipv6LeaseTime'] == null ? null : map['ipv6LeaseTime'] as String,
      leaseTime: map['leaseTime'] == null ? null : map['leaseTime'] as String,
