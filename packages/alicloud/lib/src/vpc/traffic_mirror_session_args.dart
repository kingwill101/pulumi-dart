...
class TrafficMirrorSessionArgs {
  ...
  TrafficMirrorSessionArgs({
    ...
    required List<String> trafficMirrorSourceIds,
    required String trafficMirrorTargetId,
    required String trafficMirrorTargetType,
  ...
  factory TrafficMirrorSessionArgs.fromMap(Map<String, dynamic> map) {
    return TrafficMirrorSessionArgs(
      ...
      trafficMirrorSessionDescription: map['trafficMirrorSessionDescription'] == null ? null : map['trafficMirrorSessionDescription'] as String,
