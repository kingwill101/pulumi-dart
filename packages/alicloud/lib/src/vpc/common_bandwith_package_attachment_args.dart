...
class CommonBandwithPackageAttachmentArgs {
  ...
  CommonBandwithPackageAttachmentArgs({
    ...
    bool? cancelCommonBandwidthPackageIpBandwidth,
  ...
  factory CommonBandwithPackageAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return CommonBandwithPackageAttachmentArgs(
      bandwidthPackageBandwidth: map['bandwidthPackageBandwidth'] == null ? null : map['bandwidthPackageBandwidth'] as String,
      bandwidthPackageId: map['bandwidthPackageId'] as String,
      cancelCommonBandwidthPackageIpBandwidth: map['cancelCommonBandwidthPackageIpBandwidth'] == null ? null : map['cancelCommonBandwidthPackageIpBandwidth'] as bool,
