...
class NetworkAclAttachmentArgs {
  ...
  NetworkAclAttachmentArgs({
    ...
    required List<NetworkAclAttachmentResource> resources,
  }) :
  ...
  factory NetworkAclAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAclAttachmentArgs(
      ...
      resources: pulumi.Input.decodeList<NetworkAclAttachmentResource>(map['resources'], (value) => NetworkAclAttachmentResource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
