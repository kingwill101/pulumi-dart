...
class BgpGroupArgs {
  ...
  factory BgpGroupArgs.fromMap(Map<String, dynamic> map) {
    return BgpGroupArgs(
      ...
      bgpGroupName: map['bgpGroupName'] == null ? null : map['bgpGroupName'] as String,
      clearAuthKey: map['clearAuthKey'] == null ? null : map['clearAuthKey'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      ipVersion: map['ipVersion'] == null ? null : map['ipVersion'] as String,
      isFakeAsn: map['isFakeAsn'] == null ? null : map['isFakeAsn'] as bool,
      localAsn: map['localAsn'] == null ? null : map['localAsn'] as int,
      peerAsn: map['peerAsn'] as int,
      routeLimit: map['routeLimit'] == null ? null : map['routeLimit'] as int,
