...
class NatIpCidrArgs {
  ...
  factory NatIpCidrArgs.fromMap(Map<String, dynamic> map) {
    return NatIpCidrArgs(
      ...
      natIpCidrDescription: map['natIpCidrDescription'] == null ? null : map['natIpCidrDescription'] as String,
      natIpCidrName: map['natIpCidrName'] == null ? null : map['natIpCidrName'] as String,
    );
  }
}
