...
class NatGatewayArgs {
  ...
  NatGatewayArgs({
    NatGatewayAccessMode? accessMode,
  ...
  factory NatGatewayArgs.fromMap(Map<String, dynamic> map) {
    return NatGatewayArgs(
      accessMode: map['accessMode'] == null ? null : NatGatewayAccessMode.fromMap((map['accessMode'] as Map).cast<String, dynamic>()),
      ...
      eipBindMode: map['eipBindMode'] == null ? null : map['eipBindMode'] as String,
      force: map['force'] == null ? null : map['force'] as bool,
      icmpReplyEnabled: map['icmpReplyEnabled'] == null ? null : map['icmpReplyEnabled'] as bool,
