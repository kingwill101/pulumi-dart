...
class VPCRouteEntryArgs {
  ...
  VPCRouteEntryArgs({
    ...
    List<VPCRouteEntryNextHop>? nextHops,
    String? nexthopId,
    String? nexthopType,
    String? routeEntryName,
    List<VPCRouteEntryRoutePublishTarget>? routePublishTargets,
  ...
  factory VPCRouteEntryArgs.fromMap(Map<String, dynamic> map) {
    return VPCRouteEntryArgs(
      ...
      nextHops: map['nextHops'] == null ? null : pulumi.Input.decodeList<VPCRouteEntryNextHop>(map['nextHops'], (value) => VPCRouteEntryNextHop.fromMap((value as Map).cast<String, dynamic>())),
      nexthopId: map['nexthopId'] == null ? null : map['nexthopId'] as String,
      nexthopType: map['nexthopType'] == null ? null : map['nexthopType'] as String,
      routeEntryName: map['routeEntryName'] == null ? null : map['routeEntryName'] as String,
      routePublishTargets: map['routePublishTargets'] == null ? null : pulumi.Input.decodeList<VPCRouteEntryRoutePublishTarget>(map['routePublishTargets'], (value) => VPCRouteEntryRoutePublishTarget.fromMap((value as Map).cast<String, dynamic>())),
