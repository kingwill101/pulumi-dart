...
class NetworkInterfaceArgs {
  ...
  factory NetworkInterfaceArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceArgs(
      ...
      privateIps: map['privateIps'] == null ? null : (map['privateIps'] as List).cast<String>(),
      privateIpsCount: map['privateIpsCount'] == null ? null : map['privateIpsCount'] as int,
      queueNumber: map['queueNumber'] == null ? null : map['queueNumber'] as int,
