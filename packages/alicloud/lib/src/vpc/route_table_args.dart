...
class RouteTableArgs {
  ...
  factory RouteTableArgs.fromMap(Map<String, dynamic> map) {
    return RouteTableArgs(
      associateType: map['associateType'] == null ? null : map['associateType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      routePropagationEnable: map['routePropagationEnable'] == null ? null : map['routePropagationEnable'] as bool,
