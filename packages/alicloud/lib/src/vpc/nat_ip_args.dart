...
class NatIpArgs {
  ...
  factory NatIpArgs.fromMap(Map<String, dynamic> map) {
    return NatIpArgs(
      ...
      natIpCidrId: map['natIpCidrId'] == null ? null : map['natIpCidrId'] as String,
      natIpDescription: map['natIpDescription'] == null ? null : map['natIpDescription'] as String,
      natIpName: map['natIpName'] == null ? null : map['natIpName'] as String,
    );
  }
}
