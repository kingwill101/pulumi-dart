...
class NetworkAclEntriesArgs {
  ...
  NetworkAclEntriesArgs({
    List<NetworkAclEntriesEgress>? egresses,
    List<NetworkAclEntriesIngress>? ingresses,
  ...
  factory NetworkAclEntriesArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAclEntriesArgs(
      egresses: map['egresses'] == null ? null : pulumi.Input.decodeList<NetworkAclEntriesEgress>(map['egresses'], (value) => NetworkAclEntriesEgress.fromMap((value as Map).cast<String, dynamic>())),
      ingresses: map['ingresses'] == null ? null : pulumi.Input.decodeList<NetworkAclEntriesIngress>(map['ingresses'], (value) => NetworkAclEntriesIngress.fromMap((value as Map).cast<String, dynamic>())),
