...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    required String sdCbool,
    required String sdc,
    required String sddpVersion,
    required String udCbool,
    required String udc,
  }) :
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      dataphin: map['dataphin'] == null ? null : map['dataphin'] as String,
      dataphinCount: map['dataphinCount'] == null ? null : map['dataphinCount'] as String,
      logistics: map['logistics'] == null ? null : map['logistics'] as String,
      modifyType: map['modifyType'] == null ? null : map['modifyType'] as String,
      ossSize: map['ossSize'] == null ? null : map['ossSize'] as String,
      ...
      sdCbool: map['sdCbool'] as String,
      sdc: map['sdc'] as String,
      sddpVersion: map['sddpVersion'] as String,
      udCbool: map['udCbool'] as String,
      udc: map['udc'] as String,
    );
  }
}
