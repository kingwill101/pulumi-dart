...
class DataLimitArgs {
  ...
  factory DataLimitArgs.fromMap(Map<String, dynamic> map) {
    return DataLimitArgs(
      auditStatus: map['auditStatus'] == null ? null : map['auditStatus'] as int,
      engineType: map['engineType'] == null ? null : map['engineType'] as String,
      lang: map['lang'] == null ? null : map['lang'] as String,
      logStoreDay: map['logStoreDay'] == null ? null : map['logStoreDay'] as int,
      parentId: map['parentId'] == null ? null : map['parentId'] as String,
      password: map['password'] == null ? null : map['password'] as String,
      port: map['port'] == null ? null : map['port'] as int,
      resourceType: map['resourceType'] as String,
      serviceRegionId: map['serviceRegionId'] == null ? null : map['serviceRegionId'] as String,
