...
/// {@template pulumi_eflo_invocation_invocation_args_doc}
/// The set of arguments for Invocation.
/// {@endtemplate}
/// {@macro pulumi_eflo_invocation_invocation_args_doc}
class InvocationArgs {
  ...
  InvocationArgs({
    ...
    String? workingDir,
      ...
      launcher = pulumi.Input.asOptionalInput<String>(launcher),
      name = pulumi.Input.asOptionalInput<String>(name),
      nodeIdLists = pulumi.Input.asOptionalInput<List<String>>(nodeIdLists),
      parameters = pulumi.Input.asOptionalInput<Map<String, String>>(parameters),
      repeatMode = pulumi.Input.asOptionalInput<String>(repeatMode),
      terminationMode = pulumi.Input.asOptionalInput<String>(terminationMode),
  ...
  factory InvocationArgs.fromMap(Map<String, dynamic> map) {
    return InvocationArgs(
      commandContent: map['commandContent'] == null ? null : map['commandContent'] as String,
      ...
      launcher: map['launcher'] == null ? null : map['launcher'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nodeIdLists: map['nodeIdLists'] == null ? null : (map['nodeIdLists'] as List).cast<String>(),
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      repeatMode: map['repeatMode'] == null ? null : map['repeatMode'] as String,
      terminationMode: map['terminationMode'] == null ? null : map['terminationMode'] as String,
