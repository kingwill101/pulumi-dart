...
class OidcProviderArgs {
  ...
  OidcProviderArgs({
    ...
    required String oidcProviderName,
  }) :
  ...
  factory OidcProviderArgs.fromMap(Map<String, dynamic> map) {
    return OidcProviderArgs(
      ...
      fingerprints: map['fingerprints'] == null ? null : (map['fingerprints'] as List).cast<String>(),
      issuanceLimitTime: map['issuanceLimitTime'] == null ? null : map['issuanceLimitTime'] as int,
