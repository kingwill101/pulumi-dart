...
class GetSubscriptionJobsJob {
  ...
  final bool subscriptionDataTypeDdl;
  /// Whether to subscribe the DML type of data. Valid values: `true`, `false`.
  final bool subscriptionDataTypeDml;
  /// Network information.
  final List<GetSubscriptionJobsJobSubscriptionHost> subscriptionHosts;
  /// The type of subscription instance network. Valid value: `classic`, `vpc`.
  final String subscriptionInstanceNetworkType;
  /// The ID of subscription instance vpc.
  final String subscriptionInstanceVpcId;
  /// The ID of subscription instance vswitch.
  final String subscriptionInstanceVswitchId;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subscriptionHosts': pulumi.Input.encodeList<GetSubscriptionJobsJobSubscriptionHost, Map<String, dynamic>>(subscriptionHosts, (value) => value.toMap()),
  ...
  factory GetSubscriptionJobsJob.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionJobsJob(
      ...
      subscriptionDataTypeDdl: map['subscriptionDataTypeDdl'] as bool,
      subscriptionDataTypeDml: map['subscriptionDataTypeDml'] as bool,
      subscriptionHosts: pulumi.Input.decodeList<GetSubscriptionJobsJobSubscriptionHost>(map['subscriptionHosts'], (value) => GetSubscriptionJobsJobSubscriptionHost.fromMap((value as Map).cast<String, dynamic>())),
      subscriptionInstanceNetworkType: map['subscriptionInstanceNetworkType'] as String,
      subscriptionInstanceVpcId: map['subscriptionInstanceVpcId'] as String,
      subscriptionInstanceVswitchId: map['subscriptionInstanceVswitchId'] as String,
