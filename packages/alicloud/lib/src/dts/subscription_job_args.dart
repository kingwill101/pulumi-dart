...
/// {@template pulumi_dts_subscription_job_subscription_job_args_doc}
/// The set of arguments for SubscriptionJob.
/// {@endtemplate}
/// {@macro pulumi_dts_subscription_job_subscription_job_args_doc}
class SubscriptionJobArgs {
  ...
  /// Creates a new [SubscriptionJobArgs].
  ...
  SubscriptionJobArgs({
    ...
    required String sourceEndpointRegion,
  ...
  factory SubscriptionJobArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionJobArgs(
      ...
      dbList: map['dbList'] == null ? null : map['dbList'] as String,
      ...
      dtsInstanceId: map['dtsInstanceId'] == null ? null : map['dtsInstanceId'] as String,
      ...
      subscriptionDataTypeDdl: map['subscriptionDataTypeDdl'] == null ? null : map['subscriptionDataTypeDdl'] as bool,
      subscriptionDataTypeDml: map['subscriptionDataTypeDml'] == null ? null : map['subscriptionDataTypeDml'] as bool,
      subscriptionInstanceNetworkType: map['subscriptionInstanceNetworkType'] == null ? null : map['subscriptionInstanceNetworkType'] as String,
      subscriptionInstanceVpcId: map['subscriptionInstanceVpcId'] == null ? null : map['subscriptionInstanceVpcId'] as String,
      subscriptionInstanceVswitchId: map['subscriptionInstanceVswitchId'] == null ? null : map['subscriptionInstanceVswitchId'] as String,
