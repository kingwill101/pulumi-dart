...
/// {@template pulumi_dts_synchronization_job_synchronization_job_args_doc}
/// The set of arguments for SynchronizationJob.
/// {@endtemplate}
/// {@macro pulumi_dts_synchronization_job_synchronization_job_args_doc}
class SynchronizationJobArgs {
  ...
  SynchronizationJobArgs({
    ...
    String? sourceEndpointVswitchId,
    String? status,
    ...
    String? synchronizationDirection,
      ...
      dtsJobName = pulumi.Input.asInput<String>(dtsJobName),
  ...
  factory SynchronizationJobArgs.fromMap(Map<String, dynamic> map) {
    return SynchronizationJobArgs(
      ...
      dataCheckConfigure: map['dataCheckConfigure'] == null ? null : map['dataCheckConfigure'] as String,
      ...
      delayNotice: map['delayNotice'] == null ? null : map['delayNotice'] as bool,
      delayPhone: map['delayPhone'] == null ? null : map['delayPhone'] as String,
      ...
      destinationEndpointOwnerId: map['destinationEndpointOwnerId'] == null ? null : map['destinationEndpointOwnerId'] as String,
      ...
      destinationEndpointRole: map['destinationEndpointRole'] == null ? null : map['destinationEndpointRole'] as String,
      destinationEndpointUserName: map['destinationEndpointUserName'] == null ? null : map['destinationEndpointUserName'] as String,
      dtsBisLabel: map['dtsBisLabel'] == null ? null : map['dtsBisLabel'] as String,
      dtsInstanceId: map['dtsInstanceId'] as String,
      dtsJobName: map['dtsJobName'] as String,
      errorNotice: map['errorNotice'] == null ? null : map['errorNotice'] as bool,
      errorPhone: map['errorPhone'] == null ? null : map['errorPhone'] as String,
      instanceClass: map['instanceClass'] == null ? null : map['instanceClass'] as String,
      jobParameters: map['jobParameters'] == null ? null : map['jobParameters'] as String,
      reserve: map['reserve'] == null ? null : map['reserve'] as String,
      ...
      sourceEndpointVswitchId: map['sourceEndpointVswitchId'] == null ? null : map['sourceEndpointVswitchId'] as String,
