...
class StudioApplicationArgs {
  ...
  StudioApplicationArgs({
    ...
    List<StudioApplicationInstance>? instances,
  ...
  factory StudioApplicationArgs.fromMap(Map<String, dynamic> map) {
    return StudioApplicationArgs(
      ...
      areaId: map['areaId'] == null ? null : map['areaId'] as String,
      configuration: map['configuration'] == null ? null : (map['configuration'] as Map).cast<String, String>(),
      instances: map['instances'] == null ? null : pulumi.Input.decodeList<StudioApplicationInstance>(map['instances'], (value) => StudioApplicationInstance.fromMap((value as Map).cast<String, dynamic>())),
