...
class ApiDestinationArgs {
  ...
  ApiDestinationArgs({
    required String apiDestinationName,
    required String connectionName,
    String? description,
    required ApiDestinationHttpApiParameters httpApiParameters,
  }) :
  ...
  factory ApiDestinationArgs.fromMap(Map<String, dynamic> map) {
    return ApiDestinationArgs(
      apiDestinationName: map['apiDestinationName'] as String,
      connectionName: map['connectionName'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      httpApiParameters: ApiDestinationHttpApiParameters.fromMap((map['httpApiParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
