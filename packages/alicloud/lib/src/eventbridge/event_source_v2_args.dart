...
class EventSourceV2Args {
  ...
  EventSourceV2Args({
    ...
    EventSourceV2SourceHttpEventParameters? sourceHttpEventParameters,
    EventSourceV2SourceKafkaParameters? sourceKafkaParameters,
    EventSourceV2SourceMnsParameters? sourceMnsParameters,
    EventSourceV2SourceOssEventParameters? sourceOssEventParameters,
    EventSourceV2SourceRabbitMqParameters? sourceRabbitMqParameters,
    EventSourceV2SourceRocketmqParameters? sourceRocketmqParameters,
    EventSourceV2SourceScheduledEventParameters? sourceScheduledEventParameters,
    EventSourceV2SourceSlsParameters? sourceSlsParameters,
  }) :
  ...
  factory EventSourceV2Args.fromMap(Map<String, dynamic> map) {
    return EventSourceV2Args(
      ...
      sourceHttpEventParameters: map['sourceHttpEventParameters'] == null ? null : EventSourceV2SourceHttpEventParameters.fromMap((map['sourceHttpEventParameters'] as Map).cast<String, dynamic>()),
      sourceKafkaParameters: map['sourceKafkaParameters'] == null ? null : EventSourceV2SourceKafkaParameters.fromMap((map['sourceKafkaParameters'] as Map).cast<String, dynamic>()),
      sourceMnsParameters: map['sourceMnsParameters'] == null ? null : EventSourceV2SourceMnsParameters.fromMap((map['sourceMnsParameters'] as Map).cast<String, dynamic>()),
      sourceOssEventParameters: map['sourceOssEventParameters'] == null ? null : EventSourceV2SourceOssEventParameters.fromMap((map['sourceOssEventParameters'] as Map).cast<String, dynamic>()),
      sourceRabbitMqParameters: map['sourceRabbitMqParameters'] == null ? null : EventSourceV2SourceRabbitMqParameters.fromMap((map['sourceRabbitMqParameters'] as Map).cast<String, dynamic>()),
      sourceRocketmqParameters: map['sourceRocketmqParameters'] == null ? null : EventSourceV2SourceRocketmqParameters.fromMap((map['sourceRocketmqParameters'] as Map).cast<String, dynamic>()),
      sourceScheduledEventParameters: map['sourceScheduledEventParameters'] == null ? null : EventSourceV2SourceScheduledEventParameters.fromMap((map['sourceScheduledEventParameters'] as Map).cast<String, dynamic>()),
      sourceSlsParameters: map['sourceSlsParameters'] == null ? null : EventSourceV2SourceSlsParameters.fromMap((map['sourceSlsParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
