...
class ConnectionArgs {
  ...
  ConnectionArgs({
    ConnectionAuthParameters? authParameters,
    required String connectionName,
    String? description,
    required ConnectionNetworkParameters networkParameters,
  }) :
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      authParameters: map['authParameters'] == null ? null : ConnectionAuthParameters.fromMap((map['authParameters'] as Map).cast<String, dynamic>()),
      connectionName: map['connectionName'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      networkParameters: ConnectionNetworkParameters.fromMap((map['networkParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
