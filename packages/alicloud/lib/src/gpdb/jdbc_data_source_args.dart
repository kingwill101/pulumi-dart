...
class JdbcDataSourceArgs {
  ...
  factory JdbcDataSourceArgs.fromMap(Map<String, dynamic> map) {
    return JdbcDataSourceArgs(
      ...
      jdbcConnectionString: map['jdbcConnectionString'] == null ? null : map['jdbcConnectionString'] as String,
      jdbcPassword: map['jdbcPassword'] == null ? null : map['jdbcPassword'] as String,
      jdbcUserName: map['jdbcUserName'] as String,
    );
  }
}
