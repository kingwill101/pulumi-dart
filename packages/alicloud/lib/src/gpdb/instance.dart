...
class Instance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InstanceIpWhitelist>> ipWhitelists;
  ...
  Instance(
    ...
    this.createSampleData = registerOutput<bool>('createSampleData');
    this.dataShareStatus = registerOutput<String>('dataShareStatus');
    ...
    this.dbInstanceMode = registerOutput<String>('dbInstanceMode');
    ...
    this.prodType = registerOutput<String>('prodType');
    this.resourceGroupId = registerOutput<String>('resourceGroupId');
    this.resourceManagementMode = registerOutput<String>('resourceManagementMode');
    this.securityIpLists = registerOutput<List<String>?>('securityIpLists');
    this.segDiskPerformanceLevel = registerOutput<String>('segDiskPerformanceLevel');
    this.segNodeNum = registerOutput<int>('segNodeNum');
    this.segStorageType = registerOutput<String>('segStorageType');
    this.serverlessMode = registerOutput<String>('serverlessMode');
    this.sslEnabled = registerOutput<int>('sslEnabled');
    this.status = registerOutput<String>('status');
    this.storageSize = registerOutput<int>('storageSize');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.usedTime = registerOutput<String?>('usedTime');
    this.vectorConfigurationStatus = registerOutput<String>('vectorConfigurationStatus');
