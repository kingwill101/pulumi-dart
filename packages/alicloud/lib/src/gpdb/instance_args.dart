...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? dataShareStatus,
    String? dbInstanceCategory,
    String? dbInstanceClass,
    required String dbInstanceMode,
    String? description,
    ...
    String? instanceSpec,
    List<InstanceIpWhitelist>? ipWhitelists,
    ...
    String? resourceManagementMode,
    List<String>? securityIpLists,
    String? segDiskPerformanceLevel,
    int? segNodeNum,
    String? segStorageType,
    String? serverlessMode,
    int? sslEnabled,
    int? storageSize,
    Map<String, String>? tags,
    String? usedTime,
    String? vectorConfigurationStatus,
    String? vpcId,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      createSampleData: map['createSampleData'] == null ? null : map['createSampleData'] as bool,
      dataShareStatus: map['dataShareStatus'] == null ? null : map['dataShareStatus'] as String,
      dbInstanceCategory: map['dbInstanceCategory'] == null ? null : map['dbInstanceCategory'] as String,
      ...
      instanceGroupCount: map['instanceGroupCount'] == null ? null : map['instanceGroupCount'] as int,
      ...
      ipWhitelists: map['ipWhitelists'] == null ? null : pulumi.Input.decodeList<InstanceIpWhitelist>(map['ipWhitelists'], (value) => InstanceIpWhitelist.fromMap((value as Map).cast<String, dynamic>())),
      ...
      masterCu: map['masterCu'] == null ? null : map['masterCu'] as int,
      masterNodeNum: map['masterNodeNum'] == null ? null : map['masterNodeNum'] as int,
      ...
      prodType: map['prodType'] == null ? null : map['prodType'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      resourceManagementMode: map['resourceManagementMode'] == null ? null : map['resourceManagementMode'] as String,
      securityIpLists: map['securityIpLists'] == null ? null : (map['securityIpLists'] as List).cast<String>(),
      segDiskPerformanceLevel: map['segDiskPerformanceLevel'] == null ? null : map['segDiskPerformanceLevel'] as String,
      segNodeNum: map['segNodeNum'] == null ? null : map['segNodeNum'] as int,
      segStorageType: map['segStorageType'] == null ? null : map['segStorageType'] as String,
      serverlessMode: map['serverlessMode'] == null ? null : map['serverlessMode'] as String,
      ...
      vectorConfigurationStatus: map['vectorConfigurationStatus'] == null ? null : map['vectorConfigurationStatus'] as String,
