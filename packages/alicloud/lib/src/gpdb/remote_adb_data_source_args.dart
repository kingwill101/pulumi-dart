...
class RemoteAdbDataSourceArgs {
  ...
  RemoteAdbDataSourceArgs({
    ...
    required String localDatabase,
    required String localDbInstanceId,
    required String managerUserName,
    required String managerUserPassword,
    required String remoteDatabase,
    required String remoteDbInstanceId,
  ...
  factory RemoteAdbDataSourceArgs.fromMap(Map<String, dynamic> map) {
    return RemoteAdbDataSourceArgs(
      ...
      localDatabase: map['localDatabase'] as String,
      localDbInstanceId: map['localDbInstanceId'] as String,
      managerUserName: map['managerUserName'] as String,
      managerUserPassword: map['managerUserPassword'] as String,
      remoteDatabase: map['remoteDatabase'] as String,
      remoteDbInstanceId: map['remoteDbInstanceId'] as String,
