...
class HadoopDataSourceArgs {
  ...
  HadoopDataSourceArgs({
    ...
    String? emrInstanceId,
    String? hadoopCoreConf,
    String? hadoopCreateType,
    String? hadoopHostsAddress,
    String? hdfsConf,
    String? hiveConf,
    String? mapReduceConf,
    String? yarnConf,
  }) :
  ...
  factory HadoopDataSourceArgs.fromMap(Map<String, dynamic> map) {
    return HadoopDataSourceArgs(
      ...
      emrInstanceId: map['emrInstanceId'] == null ? null : map['emrInstanceId'] as String,
      hadoopCoreConf: map['hadoopCoreConf'] == null ? null : map['hadoopCoreConf'] as String,
      hadoopCreateType: map['hadoopCreateType'] == null ? null : map['hadoopCreateType'] as String,
      hadoopHostsAddress: map['hadoopHostsAddress'] == null ? null : map['hadoopHostsAddress'] as String,
      hdfsConf: map['hdfsConf'] == null ? null : map['hdfsConf'] as String,
      hiveConf: map['hiveConf'] == null ? null : map['hiveConf'] as String,
      mapReduceConf: map['mapReduceConf'] == null ? null : map['mapReduceConf'] as String,
      yarnConf: map['yarnConf'] == null ? null : map['yarnConf'] as String,
    );
  }
}
