...
class GetAccountDeletionCheckTaskResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'abandonAbleChecks': pulumi.Input.encodeList<GetAccountDeletionCheckTaskAbandonAbleCheck, Map<String, dynamic>>(abandonAbleChecks, (value) => value.toMap()),
      'accountId': accountId,
      'allowDelete': allowDelete,
      'id': id,
      'notAllowReasons': pulumi.Input.encodeList<GetAccountDeletionCheckTaskNotAllowReason, Map<String, dynamic>>(notAllowReasons, (value) => value.toMap()),
      'status': status,
    };
  }
  ...
  factory GetAccountDeletionCheckTaskResult.fromMap(Map<String, dynamic> map) {
    return GetAccountDeletionCheckTaskResult(
      abandonAbleChecks: pulumi.Input.decodeList<GetAccountDeletionCheckTaskAbandonAbleCheck>(map['abandonAbleChecks'], (value) => GetAccountDeletionCheckTaskAbandonAbleCheck.fromMap((value as Map).cast<String, dynamic>())),
      accountId: map['accountId'] as String,
      allowDelete: map['allowDelete'] as bool,
      id: map['id'] as String,
      notAllowReasons: pulumi.Input.decodeList<GetAccountDeletionCheckTaskNotAllowReason>(map['notAllowReasons'], (value) => GetAccountDeletionCheckTaskNotAllowReason.fromMap((value as Map).cast<String, dynamic>())),
