...
class AutoGroupingRuleArgs {
  ...
  AutoGroupingRuleArgs({
    String? excludeRegionIdsScope,
    String? excludeResourceGroupIdsScope,
    String? excludeResourceIdsScope,
    String? excludeResourceTypesScope,
    String? regionIdsScope,
    String? resourceGroupIdsScope,
    String? resourceIdsScope,
    String? resourceTypesScope,
    required List<AutoGroupingRuleRuleContent> ruleContents,
    String? ruleDesc,
  ...
  factory AutoGroupingRuleArgs.fromMap(Map<String, dynamic> map) {
    return AutoGroupingRuleArgs(
      excludeRegionIdsScope: map['excludeRegionIdsScope'] == null ? null : map['excludeRegionIdsScope'] as String,
      excludeResourceGroupIdsScope: map['excludeResourceGroupIdsScope'] == null ? null : map['excludeResourceGroupIdsScope'] as String,
      excludeResourceIdsScope: map['excludeResourceIdsScope'] == null ? null : map['excludeResourceIdsScope'] as String,
      excludeResourceTypesScope: map['excludeResourceTypesScope'] == null ? null : map['excludeResourceTypesScope'] as String,
      ...
      resourceIdsScope: map['resourceIdsScope'] == null ? null : map['resourceIdsScope'] as String,
      resourceTypesScope: map['resourceTypesScope'] == null ? null : map['resourceTypesScope'] as String,
      ruleContents: pulumi.Input.decodeList<AutoGroupingRuleRuleContent>(map['ruleContents'], (value) => AutoGroupingRuleRuleContent.fromMap((value as Map).cast<String, dynamic>())),
      ruleDesc: map['ruleDesc'] == null ? null : map['ruleDesc'] as String,
