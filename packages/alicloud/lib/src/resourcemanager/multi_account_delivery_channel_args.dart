...
class MultiAccountDeliveryChannelArgs {
  ...
  MultiAccountDeliveryChannelArgs({
    required String deliveryChannelDescription,
    required MultiAccountDeliveryChannelDeliveryChannelFilter deliveryChannelFilter,
    required String multiAccountDeliveryChannelName,
    MultiAccountDeliveryChannelResourceChangeDelivery? resourceChangeDelivery,
    MultiAccountDeliveryChannelResourceSnapshotDelivery? resourceSnapshotDelivery,
  }) :
  ...
  factory MultiAccountDeliveryChannelArgs.fromMap(Map<String, dynamic> map) {
    return MultiAccountDeliveryChannelArgs(
      deliveryChannelDescription: map['deliveryChannelDescription'] as String,
      deliveryChannelFilter: MultiAccountDeliveryChannelDeliveryChannelFilter.fromMap((map['deliveryChannelFilter'] as Map).cast<String, dynamic>()),
      multiAccountDeliveryChannelName: map['multiAccountDeliveryChannelName'] as String,
      resourceChangeDelivery: map['resourceChangeDelivery'] == null ? null : MultiAccountDeliveryChannelResourceChangeDelivery.fromMap((map['resourceChangeDelivery'] as Map).cast<String, dynamic>()),
      resourceSnapshotDelivery: map['resourceSnapshotDelivery'] == null ? null : MultiAccountDeliveryChannelResourceSnapshotDelivery.fromMap((map['resourceSnapshotDelivery'] as Map).cast<String, dynamic>()),
    );
  }
}
