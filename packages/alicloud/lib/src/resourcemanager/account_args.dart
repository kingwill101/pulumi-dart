...
class AccountArgs {
  ...
  AccountArgs({
    List<String>? abandonAbleCheckIds,
    List<String>? abandonableCheckIds,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      abandonAbleCheckIds: map['abandonAbleCheckIds'] == null ? null : (map['abandonAbleCheckIds'] as List).cast<String>(),
      abandonableCheckIds: map['abandonableCheckIds'] == null ? null : (map['abandonableCheckIds'] as List).cast<String>(),
      ...
      payerAccountId: map['payerAccountId'] == null ? null : map['payerAccountId'] as String,
      resellAccountType: map['resellAccountType'] == null ? null : map['resellAccountType'] as String,
