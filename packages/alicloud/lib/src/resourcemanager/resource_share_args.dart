...
class ResourceShareArgs {
  ...
  ResourceShareArgs({
    ...
    required String resourceShareName,
    List<ResourceShareResource>? resources,
  ...
  factory ResourceShareArgs.fromMap(Map<String, dynamic> map) {
    return ResourceShareArgs(
      allowExternalTargets: map['allowExternalTargets'] == null ? null : map['allowExternalTargets'] as bool,
      permissionNames: map['permissionNames'] == null ? null : (map['permissionNames'] as List).cast<String>(),
      ...
      resources: map['resources'] == null ? null : pulumi.Input.decodeList<ResourceShareResource>(map['resources'], (value) => ResourceShareResource.fromMap((value as Map).cast<String, dynamic>())),
