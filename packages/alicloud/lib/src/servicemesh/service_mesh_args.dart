...
class ServiceMeshArgs {
  ...
  ServiceMeshArgs({
    ...
    String? clusterSpec,
    bool? customizedPrometheus,
    String? edition,
    ServiceMeshExtraConfiguration? extraConfiguration,
    bool? force,
    ServiceMeshLoadBalancer? loadBalancer,
    ServiceMeshMeshConfig? meshConfig,
    required ServiceMeshNetwork network,
  ...
  factory ServiceMeshArgs.fromMap(Map<String, dynamic> map) {
    return ServiceMeshArgs(
      ...
      customizedPrometheus: map['customizedPrometheus'] == null ? null : map['customizedPrometheus'] as bool,
      edition: map['edition'] == null ? null : map['edition'] as String,
      extraConfiguration: map['extraConfiguration'] == null ? null : ServiceMeshExtraConfiguration.fromMap((map['extraConfiguration'] as Map).cast<String, dynamic>()),
      force: map['force'] == null ? null : map['force'] as bool,
      loadBalancer: map['loadBalancer'] == null ? null : ServiceMeshLoadBalancer.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>()),
      meshConfig: map['meshConfig'] == null ? null : ServiceMeshMeshConfig.fromMap((map['meshConfig'] as Map).cast<String, dynamic>()),
      network: ServiceMeshNetwork.fromMap((map['network'] as Map).cast<String, dynamic>()),
      prometheusUrl: map['prometheusUrl'] == null ? null : map['prometheusUrl'] as String,
      serviceMeshName: map['serviceMeshName'] == null ? null : map['serviceMeshName'] as String,
