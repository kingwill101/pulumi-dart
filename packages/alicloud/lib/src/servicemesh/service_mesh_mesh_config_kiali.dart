...
class ServiceMeshMeshConfigKiali {
  ...
  final String? aggregatedKialiAddress;
  ...
  final String? customPrometheusUrl;
  ...
  final String? distributedKialiAccessTokens;
  ...
  final String? kialiArmsAuthTokens;
  ...
  final String? kialiServiceAnnotations;
  ...
  final ServiceMeshMeshConfigKialiOpenIdConfig? openIdConfig;
  ...
  final ServiceMeshMeshConfigKialiRamOauthConfig? ramOauthConfig;
  ...
  final ServiceMeshMeshConfigKialiServerConfig? serverConfig;
  ...
  final bool? usePopulatedArmsPrometheus;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'openIdConfig': ?openIdConfig == null ? null : openIdConfig!.toMap(),
      'ramOauthConfig': ?ramOauthConfig == null ? null : ramOauthConfig!.toMap(),
      'serverConfig': ?serverConfig == null ? null : serverConfig!.toMap(),
      'url': ?url,
  ...
  factory ServiceMeshMeshConfigKiali.fromMap(Map<String, dynamic> map) {
    return ServiceMeshMeshConfigKiali(
      aggregatedKialiAddress: map['aggregatedKialiAddress'] == null ? null : map['aggregatedKialiAddress'] as String,
      authStrategy: map['authStrategy'] == null ? null : map['authStrategy'] as String,
      customPrometheusUrl: map['customPrometheusUrl'] == null ? null : map['customPrometheusUrl'] as String,
      distributedKialiAccessTokens: map['distributedKialiAccessTokens'] == null ? null : map['distributedKialiAccessTokens'] as String,
      distributedKialiAddresses: map['distributedKialiAddresses'] == null ? null : map['distributedKialiAddresses'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      integrateClb: map['integrateClb'] == null ? null : map['integrateClb'] as bool,
      kialiArmsAuthTokens: map['kialiArmsAuthTokens'] == null ? null : map['kialiArmsAuthTokens'] as String,
      kialiServiceAnnotations: map['kialiServiceAnnotations'] == null ? null : map['kialiServiceAnnotations'] as String,
      openIdConfig: map['openIdConfig'] == null ? null : ServiceMeshMeshConfigKialiOpenIdConfig.fromMap((map['openIdConfig'] as Map).cast<String, dynamic>()),
      ramOauthConfig: map['ramOauthConfig'] == null ? null : ServiceMeshMeshConfigKialiRamOauthConfig.fromMap((map['ramOauthConfig'] as Map).cast<String, dynamic>()),
      serverConfig: map['serverConfig'] == null ? null : ServiceMeshMeshConfigKialiServerConfig.fromMap((map['serverConfig'] as Map).cast<String, dynamic>()),
      url: map['url'] == null ? null : map['url'] as String,
      usePopulatedArmsPrometheus: map['usePopulatedArmsPrometheus'] == null ? null : map['usePopulatedArmsPrometheus'] as bool,
    );
  }
}
