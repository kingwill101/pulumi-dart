...
class ChainArgs {
  ...
  ChainArgs({
    List<ChainChainConfig>? chainConfigs,
  ...
  factory ChainArgs.fromMap(Map<String, dynamic> map) {
    return ChainArgs(
      chainConfigs: map['chainConfigs'] == null ? null : pulumi.Input.decodeList<ChainChainConfig>(map['chainConfigs'], (value) => ChainChainConfig.fromMap((value as Map).cast<String, dynamic>())),
