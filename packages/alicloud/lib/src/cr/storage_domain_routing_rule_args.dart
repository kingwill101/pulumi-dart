...
class StorageDomainRoutingRuleArgs {
  ...
  StorageDomainRoutingRuleArgs({
    ...
    required List<StorageDomainRoutingRuleRoute> routes,
  }) :
  ...
  factory StorageDomainRoutingRuleArgs.fromMap(Map<String, dynamic> map) {
    return StorageDomainRoutingRuleArgs(
      ...
      routes: pulumi.Input.decodeList<StorageDomainRoutingRuleRoute>(map['routes'], (value) => StorageDomainRoutingRuleRoute.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
