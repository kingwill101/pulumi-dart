...
class QueueArgs {
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      autoDeleteState: map['autoDeleteState'] == null ? null : map['autoDeleteState'] as bool,
      autoExpireState: map['autoExpireState'] == null ? null : map['autoExpireState'] as String,
      deadLetterExchange: map['deadLetterExchange'] == null ? null : map['deadLetterExchange'] as String,
      deadLetterRoutingKey: map['deadLetterRoutingKey'] == null ? null : map['deadLetterRoutingKey'] as String,
      instanceId: map['instanceId'] as String,
      maxLength: map['maxLength'] == null ? null : map['maxLength'] as String,
      maximumPriority: map['maximumPriority'] == null ? null : map['maximumPriority'] as int,
      messageTtl: map['messageTtl'] == null ? null : map['messageTtl'] as String,
