...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    int? period,
    String? periodCycle,
    int? provisionedCapacity,
    String? queueCapacity,
    int? renewalDuration,
    String? renewalDurationUnit,
    String? renewalStatus,
    String? serverlessChargeType,
    String? storageSize,
    bool? supportEip,
    bool? supportTracing,
    int? tracingStorageTime,
  }) :
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      maxEipTps: map['maxEipTps'] == null ? null : map['maxEipTps'] as String,
      maxTps: map['maxTps'] == null ? null : map['maxTps'] as String,
      modifyType: map['modifyType'] == null ? null : map['modifyType'] as String,
      paymentType: map['paymentType'] as String,
      period: map['period'] == null ? null : map['period'] as int,
      periodCycle: map['periodCycle'] == null ? null : map['periodCycle'] as String,
      provisionedCapacity: map['provisionedCapacity'] == null ? null : map['provisionedCapacity'] as int,
      queueCapacity: map['queueCapacity'] == null ? null : map['queueCapacity'] as String,
      ...
      serverlessChargeType: map['serverlessChargeType'] == null ? null : map['serverlessChargeType'] as String,
      storageSize: map['storageSize'] == null ? null : map['storageSize'] as String,
      supportEip: map['supportEip'] == null ? null : map['supportEip'] as bool,
      supportTracing: map['supportTracing'] == null ? null : map['supportTracing'] as bool,
      tracingStorageTime: map['tracingStorageTime'] == null ? null : map['tracingStorageTime'] as int,
    );
  }
}
