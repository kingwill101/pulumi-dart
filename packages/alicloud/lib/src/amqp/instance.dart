...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.maxEipTps = registerOutput<String>('maxEipTps');
    this.maxTps = registerOutput<String>('maxTps');
    this.modifyType = registerOutput<String?>('modifyType');
    this.paymentType = registerOutput<String>('paymentType');
    this.period = registerOutput<int?>('period');
    this.periodCycle = registerOutput<String?>('periodCycle');
    this.provisionedCapacity = registerOutput<int?>('provisionedCapacity');
    this.queueCapacity = registerOutput<String>('queueCapacity');
    ...
    this.serverlessChargeType = registerOutput<String?>('serverlessChargeType');
    this.status = registerOutput<String>('status');
    this.storageSize = registerOutput<String>('storageSize');
    this.supportEip = registerOutput<bool?>('supportEip');
    this.supportTracing = registerOutput<bool?>('supportTracing');
    this.tracingStorageTime = registerOutput<int>('tracingStorageTime');
  }
}
