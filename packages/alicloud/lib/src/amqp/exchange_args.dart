...
class ExchangeArgs {
  ...
  factory ExchangeArgs.fromMap(Map<String, dynamic> map) {
    return ExchangeArgs(
      alternateExchange: map['alternateExchange'] == null ? null : map['alternateExchange'] as String,
      ...
      xDelayedType: map['xDelayedType'] == null ? null : map['xDelayedType'] as String,
    );
  }
}
