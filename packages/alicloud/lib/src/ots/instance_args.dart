...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    String? instanceType,
    String? name,
    List<String>? networkSourceAcls,
    List<String>? networkTypeAcls,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      accessedBy: map['accessedBy'] == null ? null : map['accessedBy'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      instanceType: map['instanceType'] == null ? null : map['instanceType'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkSourceAcls: map['networkSourceAcls'] == null ? null : (map['networkSourceAcls'] as List).cast<String>(),
      networkTypeAcls: map['networkTypeAcls'] == null ? null : (map['networkTypeAcls'] as List).cast<String>(),
