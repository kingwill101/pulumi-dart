...
class TableArgs {
  ...
  TableArgs({
    bool? allowUpdate,
    List<TableDefinedColumn>? definedColumns,
    String? deviationCellVersionInSec,
    bool? enableSse,
    required String instanceName,
    required int maxVersion,
    required List<TablePrimaryKey> primaryKeys,
    String? sseKeyId,
    String? sseKeyType,
    String? sseRoleArn,
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      allowUpdate: map['allowUpdate'] == null ? null : map['allowUpdate'] as bool,
      definedColumns: map['definedColumns'] == null ? null : pulumi.Input.decodeList<TableDefinedColumn>(map['definedColumns'], (value) => TableDefinedColumn.fromMap((value as Map).cast<String, dynamic>())),
      deviationCellVersionInSec: map['deviationCellVersionInSec'] == null ? null : map['deviationCellVersionInSec'] as String,
      enableSse: map['enableSse'] == null ? null : map['enableSse'] as bool,
      instanceName: map['instanceName'] as String,
      maxVersion: map['maxVersion'] as int,
      primaryKeys: pulumi.Input.decodeList<TablePrimaryKey>(map['primaryKeys'], (value) => TablePrimaryKey.fromMap((value as Map).cast<String, dynamic>())),
      sseKeyId: map['sseKeyId'] == null ? null : map['sseKeyId'] as String,
      sseKeyType: map['sseKeyType'] == null ? null : map['sseKeyType'] as String,
      sseRoleArn: map['sseRoleArn'] == null ? null : map['sseRoleArn'] as String,
