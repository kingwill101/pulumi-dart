...
class SecondaryIndexArgs {
  ...
  factory SecondaryIndexArgs.fromMap(Map<String, dynamic> map) {
    return SecondaryIndexArgs(
      definedColumns: map['definedColumns'] == null ? null : (map['definedColumns'] as List).cast<String>(),
      includeBaseData: map['includeBaseData'] as bool,
