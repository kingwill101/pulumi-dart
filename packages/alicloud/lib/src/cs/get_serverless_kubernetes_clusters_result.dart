...
import 'get_serverless_kubernetes_clusters_cluster.dart';

/// Result data returned by getServerlessKubernetesClusters.
class GetServerlessKubernetesClustersResult {
  ...
  /// Creates a new [GetServerlessKubernetesClustersResult].
