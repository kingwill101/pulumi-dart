...
class KubernetesPermissionArgs {
  ...
  KubernetesPermissionArgs({
    List<KubernetesPermissionPermission>? permissions,
    required String uid,
  }) :
  ...
  factory KubernetesPermissionArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesPermissionArgs(
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<KubernetesPermissionPermission>(map['permissions'], (value) => KubernetesPermissionPermission.fromMap((value as Map).cast<String, dynamic>())),
