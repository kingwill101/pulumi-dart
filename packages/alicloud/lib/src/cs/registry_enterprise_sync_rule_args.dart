...
class RegistryEnterpriseSyncRuleArgs {
  ...
  RegistryEnterpriseSyncRuleArgs({
    ...
    required String targetNamespaceName,
  ...
  factory RegistryEnterpriseSyncRuleArgs.fromMap(Map<String, dynamic> map) {
    return RegistryEnterpriseSyncRuleArgs(
      ...
      syncRuleName: map['syncRuleName'] == null ? null : map['syncRuleName'] as String,
      syncScope: map['syncScope'] == null ? null : map['syncScope'] as String,
      syncTrigger: map['syncTrigger'] == null ? null : map['syncTrigger'] as String,
      ...
      targetRepoName: map['targetRepoName'] == null ? null : map['targetRepoName'] as String,
      targetUserId: map['targetUserId'] == null ? null : map['targetUserId'] as String,
    );
  }
}
