...
class KubernetesPermission extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<KubernetesPermissionPermission>?> permissions;
  ...
  KubernetesPermission(
    ...
    this.permissions = registerOutput<List<KubernetesPermissionPermission>?>('permissions');
