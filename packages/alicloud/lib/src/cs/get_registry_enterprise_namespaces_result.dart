...
class GetRegistryEnterpriseNamespacesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nameRegex': ?nameRegex,
      'names': names,
      'namespaces': pulumi.Input.encodeList<GetRegistryEnterpriseNamespacesNamespace, Map<String, dynamic>>(namespaces, (value) => value.toMap()),
      'outputFile': ?outputFile,
    };
  }

  factory GetRegistryEnterpriseNamespacesResult.fromMap(Map<String, dynamic> map) {
    return GetRegistryEnterpriseNamespacesResult(
      ...
      namespaces: pulumi.Input.decodeList<GetRegistryEnterpriseNamespacesNamespace>(map['namespaces'], (value) => GetRegistryEnterpriseNamespacesNamespace.fromMap((value as Map).cast<String, dynamic>())),
