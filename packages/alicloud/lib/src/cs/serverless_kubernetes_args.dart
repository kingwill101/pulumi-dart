...
class ServerlessKubernetesArgs {
  ...
  ServerlessKubernetesArgs({
    List<ServerlessKubernetesAddon>? addons,
    String? clientCert,
    String? clientKey,
    String? clusterCaCert,
    String? clusterSpec,
    String? customSan,
    List<ServerlessKubernetesDeleteOption>? deleteOptions,
    ...
    String? loggingType,
    ServerlessKubernetesMaintenanceWindow? maintenanceWindow,
    String? name,
    String? namePrefix,
    bool? newNatGateway,
    ServerlessKubernetesOperationPolicy? operationPolicy,
    bool? privateZone,
    String? resourceGroupId,
    List<String>? retainResources,
    String? securityGroupId,
    String? serviceCidr,
    List<String>? serviceDiscoveryTypes,
  ...
  factory ServerlessKubernetesArgs.fromMap(Map<String, dynamic> map) {
    return ServerlessKubernetesArgs(
      addons: map['addons'] == null ? null : pulumi.Input.decodeList<ServerlessKubernetesAddon>(map['addons'], (value) => ServerlessKubernetesAddon.fromMap((value as Map).cast<String, dynamic>())),
      ...
      deleteOptions: map['deleteOptions'] == null ? null : pulumi.Input.decodeList<ServerlessKubernetesDeleteOption>(map['deleteOptions'], (value) => ServerlessKubernetesDeleteOption.fromMap((value as Map).cast<String, dynamic>())),
      ...
      endpointPublicAccessEnabled: map['endpointPublicAccessEnabled'] == null ? null : map['endpointPublicAccessEnabled'] as bool,
      ...
      loggingType: map['loggingType'] == null ? null : map['loggingType'] as String,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : ServerlessKubernetesMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      ...
      operationPolicy: map['operationPolicy'] == null ? null : ServerlessKubernetesOperationPolicy.fromMap((map['operationPolicy'] as Map).cast<String, dynamic>()),
      privateZone: map['privateZone'] == null ? null : map['privateZone'] as bool,
      ...
      serviceDiscoveryTypes: map['serviceDiscoveryTypes'] == null ? null : (map['serviceDiscoveryTypes'] as List).cast<String>(),
