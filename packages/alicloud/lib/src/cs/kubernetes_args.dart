...
class KubernetesArgs {
  ...
  KubernetesArgs({
    ...
    String? customSan,
    List<KubernetesDeleteOption>? deleteOptions,
    ...
    String? masterDiskPerformanceLevel,
    int? masterDiskSize,
    String? masterDiskSnapshotPolicyId,
    String? masterInstanceChargeType,
    required List<String> masterInstanceTypes,
    int? masterPeriod,
    String? masterPeriodUnit,
    required List<String> masterVswitchIds,
    String? name,
    String? namePrefix,
    bool? newNatGateway,
    int? nodeCidrMask,
    ...
    String? version,
      ...
      masterInstanceTypes = pulumi.Input.asInput<List<String>>(masterInstanceTypes),
      ...
      masterVswitchIds = pulumi.Input.asInput<List<String>>(masterVswitchIds),
  ...
  factory KubernetesArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesArgs(
      addons: map['addons'] == null ? null : pulumi.Input.decodeList<KubernetesAddon>(map['addons'], (value) => KubernetesAddon.fromMap((value as Map).cast<String, dynamic>())),
      ...
      deleteOptions: map['deleteOptions'] == null ? null : pulumi.Input.decodeList<KubernetesDeleteOption>(map['deleteOptions'], (value) => KubernetesDeleteOption.fromMap((value as Map).cast<String, dynamic>())),
      deletionProtection: map['deletionProtection'] == null ? null : map['deletionProtection'] as bool,
      enableSsh: map['enableSsh'] == null ? null : map['enableSsh'] as bool,
      ...
      masterAutoRenew: map['masterAutoRenew'] == null ? null : map['masterAutoRenew'] as bool,
      masterAutoRenewPeriod: map['masterAutoRenewPeriod'] == null ? null : map['masterAutoRenewPeriod'] as int,
      masterDiskCategory: map['masterDiskCategory'] == null ? null : map['masterDiskCategory'] as String,
      masterDiskPerformanceLevel: map['masterDiskPerformanceLevel'] == null ? null : map['masterDiskPerformanceLevel'] as String,
      masterDiskSize: map['masterDiskSize'] == null ? null : map['masterDiskSize'] as int,
      masterDiskSnapshotPolicyId: map['masterDiskSnapshotPolicyId'] == null ? null : map['masterDiskSnapshotPolicyId'] as String,
      masterInstanceChargeType: map['masterInstanceChargeType'] == null ? null : map['masterInstanceChargeType'] as String,
      masterInstanceTypes: (map['masterInstanceTypes'] as List).cast<String>(),
      masterPeriod: map['masterPeriod'] == null ? null : map['masterPeriod'] as int,
      masterPeriodUnit: map['masterPeriodUnit'] == null ? null : map['masterPeriodUnit'] as String,
      masterVswitchIds: (map['masterVswitchIds'] as List).cast<String>(),
      ...
      runtime: map['runtime'] == null ? null : KubernetesRuntime.fromMap((map['runtime'] as Map).cast<String, dynamic>()),
