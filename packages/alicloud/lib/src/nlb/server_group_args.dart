...
class ServerGroupArgs {
  ...
  ServerGroupArgs({
    ...
    ServerGroupHealthCheck? healthCheck,
  ...
  factory ServerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ServerGroupArgs(
      ...
      anyPortEnabled: map['anyPortEnabled'] == null ? null : map['anyPortEnabled'] as bool,
      connectionDrain: map['connectionDrain'] == null ? null : map['connectionDrain'] as bool,
      ...
      healthCheck: map['healthCheck'] == null ? null : ServerGroupHealthCheck.fromMap((map['healthCheck'] as Map).cast<String, dynamic>()),
      preserveClientIpEnabled: map['preserveClientIpEnabled'] == null ? null : map['preserveClientIpEnabled'] as bool,
