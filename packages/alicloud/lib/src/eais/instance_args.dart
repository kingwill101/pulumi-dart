...
class InstanceArgs {
  ...
  InstanceArgs({
    String? category,
    List<InstanceEnvironmentVar>? environmentVars,
    bool? force,
    String? image,
    String? instanceName,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      environmentVars: map['environmentVars'] == null ? null : pulumi.Input.decodeList<InstanceEnvironmentVar>(map['environmentVars'], (value) => InstanceEnvironmentVar.fromMap((value as Map).cast<String, dynamic>())),
