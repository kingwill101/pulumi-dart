...
class RocketMQInstanceArgs {
  ...
  RocketMQInstanceArgs({
    RocketMQInstanceAclInfo? aclInfo,
    bool? autoRenew,
    int? autoRenewPeriod,
    ...
    required RocketMQInstanceNetworkInfo networkInfo,
    required String paymentType,
    int? period,
    String? periodUnit,
    RocketMQInstanceProductInfo? productInfo,
    String? remark,
    String? resourceGroupId,
    required String seriesCode,
    required String serviceCode,
    RocketMQInstanceSoftware? software,
    required String subSeriesCode,
  ...
  factory RocketMQInstanceArgs.fromMap(Map<String, dynamic> map) {
    return RocketMQInstanceArgs(
      aclInfo: map['aclInfo'] == null ? null : RocketMQInstanceAclInfo.fromMap((map['aclInfo'] as Map).cast<String, dynamic>()),
      ...
      autoRenewPeriodUnit: map['autoRenewPeriodUnit'] == null ? null : map['autoRenewPeriodUnit'] as String,
      ...
      networkInfo: RocketMQInstanceNetworkInfo.fromMap((map['networkInfo'] as Map).cast<String, dynamic>()),
      paymentType: map['paymentType'] as String,
      period: map['period'] == null ? null : map['period'] as int,
      periodUnit: map['periodUnit'] == null ? null : map['periodUnit'] as String,
      productInfo: map['productInfo'] == null ? null : RocketMQInstanceProductInfo.fromMap((map['productInfo'] as Map).cast<String, dynamic>()),
      remark: map['remark'] == null ? null : map['remark'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      seriesCode: map['seriesCode'] as String,
      serviceCode: map['serviceCode'] as String,
      software: map['software'] == null ? null : RocketMQInstanceSoftware.fromMap((map['software'] as Map).cast<String, dynamic>()),
      subSeriesCode: map['subSeriesCode'] as String,
