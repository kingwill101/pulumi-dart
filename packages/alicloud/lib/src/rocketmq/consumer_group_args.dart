...
class ConsumerGroupArgs {
  ...
  ConsumerGroupArgs({
    required ConsumerGroupConsumeRetryPolicy consumeRetryPolicy,
    required String consumerGroupId,
  ...
  factory ConsumerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ConsumerGroupArgs(
      consumeRetryPolicy: ConsumerGroupConsumeRetryPolicy.fromMap((map['consumeRetryPolicy'] as Map).cast<String, dynamic>()),
      consumerGroupId: map['consumerGroupId'] as String,
      deliveryOrderType: map['deliveryOrderType'] == null ? null : map['deliveryOrderType'] as String,
      instanceId: map['instanceId'] as String,
      maxReceiveTps: map['maxReceiveTps'] == null ? null : map['maxReceiveTps'] as int,
