...
class GatewayFileShareArgs {
  ...
  GatewayFileShareArgs({
    ...
    bool? fastReclaim,
    int? feLimit,
    required String gatewayFileShareName,
    ...
    bool? windowsAcl,
      ...
      gatewayFileShareName = pulumi.Input.asInput<String>(gatewayFileShareName),
  ...
  factory GatewayFileShareArgs.fromMap(Map<String, dynamic> map) {
    return GatewayFileShareArgs(
      ...
      backendLimit: map['backendLimit'] == null ? null : map['backendLimit'] as int,
      browsable: map['browsable'] == null ? null : map['browsable'] as bool,
      bypassCacheRead: map['bypassCacheRead'] == null ? null : map['bypassCacheRead'] as bool,
      cacheMode: map['cacheMode'] == null ? null : map['cacheMode'] as String,
      directIo: map['directIo'] == null ? null : map['directIo'] as bool,
      downloadLimit: map['downloadLimit'] == null ? null : map['downloadLimit'] as int,
      fastReclaim: map['fastReclaim'] == null ? null : map['fastReclaim'] as bool,
      feLimit: map['feLimit'] == null ? null : map['feLimit'] as int,
      gatewayFileShareName: map['gatewayFileShareName'] as String,
      gatewayId: map['gatewayId'] as String,
      ignoreDelete: map['ignoreDelete'] == null ? null : map['ignoreDelete'] as bool,
      inPlace: map['inPlace'] == null ? null : map['inPlace'] as bool,
      lagPeriod: map['lagPeriod'] == null ? null : map['lagPeriod'] as int,
      localPath: map['localPath'] as String,
      nfsV4Optimization: map['nfsV4Optimization'] == null ? null : map['nfsV4Optimization'] as bool,
      ...
      partialSyncPaths: map['partialSyncPaths'] == null ? null : map['partialSyncPaths'] as String,
      ...
      remoteSync: map['remoteSync'] == null ? null : map['remoteSync'] as bool,
      remoteSyncDownload: map['remoteSyncDownload'] == null ? null : map['remoteSyncDownload'] as bool,
      roClientList: map['roClientList'] == null ? null : map['roClientList'] as String,
      roUserList: map['roUserList'] == null ? null : map['roUserList'] as String,
      rwClientList: map['rwClientList'] == null ? null : map['rwClientList'] as String,
      rwUserList: map['rwUserList'] == null ? null : map['rwUserList'] as String,
      squash: map['squash'] == null ? null : map['squash'] as String,
      supportArchive: map['supportArchive'] == null ? null : map['supportArchive'] as bool,
      transferAcceleration: map['transferAcceleration'] == null ? null : map['transferAcceleration'] as bool,
      windowsAcl: map['windowsAcl'] == null ? null : map['windowsAcl'] as bool,
    );
  }
}
