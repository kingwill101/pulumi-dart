...
class ExpressSync extends pulumi.CustomResource {
  ...
  /// Creates a new [ExpressSync].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ExpressSync]. {@macro pulumi_cloudstoragegateway_express_sync_express_sync_args_doc}
