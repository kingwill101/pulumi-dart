...
class ReportTemplateArgs {
  ...
  ReportTemplateArgs({
    String? reportFileFormats,
    String? reportGranularity,
    String? reportLanguage,
    List<ReportTemplateReportScope>? reportScopes,
    String? reportTemplateDescription,
    required String reportTemplateName,
  ...
  factory ReportTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ReportTemplateArgs(
      reportFileFormats: map['reportFileFormats'] == null ? null : map['reportFileFormats'] as String,
      reportGranularity: map['reportGranularity'] == null ? null : map['reportGranularity'] as String,
      reportLanguage: map['reportLanguage'] == null ? null : map['reportLanguage'] as String,
      reportScopes: map['reportScopes'] == null ? null : pulumi.Input.decodeList<ReportTemplateReportScope>(map['reportScopes'], (value) => ReportTemplateReportScope.fromMap((value as Map).cast<String, dynamic>())),
      reportTemplateDescription: map['reportTemplateDescription'] == null ? null : map['reportTemplateDescription'] as String,
      reportTemplateName: map['reportTemplateName'] as String,
      subscriptionFrequency: map['subscriptionFrequency'] == null ? null : map['subscriptionFrequency'] as String,
    );
  }
}
