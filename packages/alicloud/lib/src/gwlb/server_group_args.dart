...
class ServerGroupArgs {
  ...
  ServerGroupArgs({
    ...
    bool? dryRun,
    ServerGroupHealthCheckConfig? healthCheckConfig,
    String? protocol,
  ...
  factory ServerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ServerGroupArgs(
      ...
      healthCheckConfig: map['healthCheckConfig'] == null ? null : ServerGroupHealthCheckConfig.fromMap((map['healthCheckConfig'] as Map).cast<String, dynamic>()),
