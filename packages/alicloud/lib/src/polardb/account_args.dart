...
class AccountArgs {
  ...
  AccountArgs({
    ...
    String? accountPasswordValidTime,
    String? accountType,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      accountLockState: map['accountLockState'] == null ? null : map['accountLockState'] as String,
      accountName: map['accountName'] as String,
      accountPassword: map['accountPassword'] == null ? null : map['accountPassword'] as String,
      accountPasswordValidTime: map['accountPasswordValidTime'] == null ? null : map['accountPasswordValidTime'] as String,
