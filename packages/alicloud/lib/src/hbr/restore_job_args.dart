...
class RestoreJobArgs {
  ...
  factory RestoreJobArgs.fromMap(Map<String, dynamic> map) {
    return RestoreJobArgs(
      ...
      include: map['include'] == null ? null : map['include'] as String,
      options: map['options'] == null ? null : map['options'] as String,
      otsDetail: map['otsDetail'] == null ? null : RestoreJobOtsDetail.fromMap((map['otsDetail'] as Map).cast<String, dynamic>()),
      restoreJobId: map['restoreJobId'] == null ? null : map['restoreJobId'] as String,
      restoreType: map['restoreType'] as String,
      snapshotHash: map['snapshotHash'] as String,
      snapshotId: map['snapshotId'] as String,
      sourceType: map['sourceType'] as String,
      targetBucket: map['targetBucket'] == null ? null : map['targetBucket'] as String,
      targetClientId: map['targetClientId'] == null ? null : map['targetClientId'] as String,
      targetCreateTime: map['targetCreateTime'] == null ? null : map['targetCreateTime'] as String,
      targetDataSourceId: map['targetDataSourceId'] == null ? null : map['targetDataSourceId'] as String,
      targetFileSystemId: map['targetFileSystemId'] == null ? null : map['targetFileSystemId'] as String,
      targetInstanceId: map['targetInstanceId'] == null ? null : map['targetInstanceId'] as String,
      targetInstanceName: map['targetInstanceName'] == null ? null : map['targetInstanceName'] as String,
      ...
      targetTableName: map['targetTableName'] == null ? null : map['targetTableName'] as String,
      targetTime: map['targetTime'] == null ? null : map['targetTime'] as String,
      udmDetail: map['udmDetail'] == null ? null : map['udmDetail'] as String,
