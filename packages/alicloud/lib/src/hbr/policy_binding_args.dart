...
class PolicyBindingArgs {
  ...
  PolicyBindingArgs({
    PolicyBindingAdvancedOptions? advancedOptions,
    ...
    String? exclude,
    String? include,
    String? policyBindingDescription,
    String? policyId,
    String? source,
    String? sourceType,
    String? speedLimit,
  ...
  factory PolicyBindingArgs.fromMap(Map<String, dynamic> map) {
    return PolicyBindingArgs(
      advancedOptions: map['advancedOptions'] == null ? null : PolicyBindingAdvancedOptions.fromMap((map['advancedOptions'] as Map).cast<String, dynamic>()),
      ...
      policyBindingDescription: map['policyBindingDescription'] == null ? null : map['policyBindingDescription'] as String,
      ...
      speedLimit: map['speedLimit'] == null ? null : map['speedLimit'] as String,
    );
  }
}
