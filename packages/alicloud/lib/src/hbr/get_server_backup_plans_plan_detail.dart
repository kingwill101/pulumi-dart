...
class GetServerBackupPlansPlanDetail {
  ...
  /// Creates a new [GetServerBackupPlansPlanDetail].
  ...
  GetServerBackupPlansPlanDetail({
    ...
    required this.destinationRetention,
    required this.diskIdLists,
    required this.doCopy,
    required this.enableFsFreeze,
    required this.postScriptPath,
    required this.preScriptPath,
  ...
  factory GetServerBackupPlansPlanDetail.fromMap(Map<String, dynamic> map) {
    return GetServerBackupPlansPlanDetail(
      appConsistent: map['appConsistent'] as bool,
      destinationRegionId: map['destinationRegionId'] as String,
      destinationRetention: map['destinationRetention'] as int,
      diskIdLists: (map['diskIdLists'] as List).cast<String>(),
      doCopy: map['doCopy'] as bool,
      enableFsFreeze: map['enableFsFreeze'] as bool,
      postScriptPath: map['postScriptPath'] as String,
      preScriptPath: map['preScriptPath'] as String,
