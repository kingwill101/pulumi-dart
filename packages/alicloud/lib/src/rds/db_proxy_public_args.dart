...
class DbProxyPublicArgs {
  ...
  DbProxyPublicArgs({
    ...
    required String dbProxyConnectionStringNetType,
    required String dbProxyEndpointId,
    String? dbProxyNewConnectStringPort,
  }) :
  ...
  factory DbProxyPublicArgs.fromMap(Map<String, dynamic> map) {
    return DbProxyPublicArgs(
      ...
      dbProxyConnectionStringNetType: map['dbProxyConnectionStringNetType'] as String,
      dbProxyEndpointId: map['dbProxyEndpointId'] as String,
      dbProxyNewConnectStringPort: map['dbProxyNewConnectStringPort'] == null ? null : map['dbProxyNewConnectStringPort'] as String,
    );
  }
}
