...
class RdsCloneDbInstanceArgs {
  ...
  RdsCloneDbInstanceArgs({
    ...
    String? maintainTime,
    List<RdsCloneDbInstanceParameter>? parameters,
    String? password,
    required String paymentType,
    String? period,
    List<RdsCloneDbInstancePgHbaConf>? pgHbaConfs,
    String? port,
    ...
    String? serverCert,
    String? serverKey,
    List<RdsCloneDbInstanceServerlessConfig>? serverlessConfigs,
    String? sourceBiz,
  ...
  factory RdsCloneDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return RdsCloneDbInstanceArgs(
      ...
      dbInstanceStorage: map['dbInstanceStorage'] == null ? null : map['dbInstanceStorage'] as int,
      dbInstanceStorageType: map['dbInstanceStorageType'] as String,
      dbName: map['dbName'] == null ? null : map['dbName'] as String,
      dbNames: map['dbNames'] == null ? null : map['dbNames'] as String,
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<RdsCloneDbInstanceParameter>(map['parameters'], (value) => RdsCloneDbInstanceParameter.fromMap((value as Map).cast<String, dynamic>())),
      password: map['password'] == null ? null : map['password'] as String,
      paymentType: map['paymentType'] as String,
      period: map['period'] == null ? null : map['period'] as String,
      pgHbaConfs: map['pgHbaConfs'] == null ? null : pulumi.Input.decodeList<RdsCloneDbInstancePgHbaConf>(map['pgHbaConfs'], (value) => RdsCloneDbInstancePgHbaConf.fromMap((value as Map).cast<String, dynamic>())),
      ...
      restoreTable: map['restoreTable'] == null ? null : map['restoreTable'] as String,
      ...
      serverlessConfigs: map['serverlessConfigs'] == null ? null : pulumi.Input.decodeList<RdsCloneDbInstanceServerlessConfig>(map['serverlessConfigs'], (value) => RdsCloneDbInstanceServerlessConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tableMeta: map['tableMeta'] == null ? null : map['tableMeta'] as String,
      ...
      zoneIdSlaveA: map['zoneIdSlaveA'] == null ? null : map['zoneIdSlaveA'] as String,
      zoneIdSlaveB: map['zoneIdSlaveB'] == null ? null : map['zoneIdSlaveB'] as String,
    );
  }
}
