...
class AiInstanceArgs {
  ...
  AiInstanceArgs({
    ...
    List<AiInstanceAuthConfigList>? authConfigLists,
    String? caType,
    ...
    int? sslEnabled,
    String? status,
    List<AiInstanceStorageConfigList>? storageConfigLists,
  }) :
  ...
  factory AiInstanceArgs.fromMap(Map<String, dynamic> map) {
    return AiInstanceArgs(
      ...
      authConfigLists: map['authConfigLists'] == null ? null : pulumi.Input.decodeList<AiInstanceAuthConfigList>(map['authConfigLists'], (value) => AiInstanceAuthConfigList.fromMap((value as Map).cast<String, dynamic>())),
      caType: map['caType'] == null ? null : map['caType'] as String,
      dashboardPassword: map['dashboardPassword'] == null ? null : map['dashboardPassword'] as String,
      databasePassword: map['databasePassword'] == null ? null : map['databasePassword'] as String,
      dbInstanceName: map['dbInstanceName'] == null ? null : map['dbInstanceName'] as String,
      initializeWithExistingData: map['initializeWithExistingData'] == null ? null : map['initializeWithExistingData'] as bool,
      ...
      storageConfigLists: map['storageConfigLists'] == null ? null : pulumi.Input.decodeList<AiInstanceStorageConfigList>(map['storageConfigLists'], (value) => AiInstanceStorageConfigList.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
