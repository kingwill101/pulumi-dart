...
class DbNode extends pulumi.CustomResource {
  ...
  DbNode(
    ...
    this.classCode = registerOutput<String>('classCode');
    this.dbInstanceId = registerOutput<String>('dbInstanceId');
    this.nodeId = registerOutput<String>('nodeId');
    this.nodeRegionId = registerOutput<String>('nodeRegionId');
    this.nodeRole = registerOutput<String>('nodeRole');
