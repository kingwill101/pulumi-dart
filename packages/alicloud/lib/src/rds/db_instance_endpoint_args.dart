...
class DbInstanceEndpointArgs {
  ...
  DbInstanceEndpointArgs({
    ...
    String? dbInstanceEndpointDescription,
    required String dbInstanceId,
    required List<DbInstanceEndpointNodeItem> nodeItems,
  ...
  factory DbInstanceEndpointArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceEndpointArgs(
      ...
      dbInstanceEndpointDescription: map['dbInstanceEndpointDescription'] == null ? null : map['dbInstanceEndpointDescription'] as String,
      dbInstanceId: map['dbInstanceId'] as String,
      nodeItems: pulumi.Input.decodeList<DbInstanceEndpointNodeItem>(map['nodeItems'], (value) => DbInstanceEndpointNodeItem.fromMap((value as Map).cast<String, dynamic>())),
