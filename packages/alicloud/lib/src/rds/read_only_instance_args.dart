...
class ReadOnlyInstanceArgs {
  ...
  ReadOnlyInstanceArgs({
    ...
    String? instanceName,
    required int instanceStorage,
    required String instanceType,
    required String masterDbInstanceId,
    String? modifyMode,
    List<ReadOnlyInstanceParameter>? parameters,
    int? period,
    ...
    bool? upgradeDbInstanceKernelVersion,
    String? upgradeTime,
    String? vswitchId,
    String? whitelistNetworkType,
    String? zoneId,
  }) :
  ...
  factory ReadOnlyInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ReadOnlyInstanceArgs(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<ReadOnlyInstanceParameter>(map['parameters'], (value) => ReadOnlyInstanceParameter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      targetMinorVersion: map['targetMinorVersion'] == null ? null : map['targetMinorVersion'] as String,
      upgradeDbInstanceKernelVersion: map['upgradeDbInstanceKernelVersion'] == null ? null : map['upgradeDbInstanceKernelVersion'] as bool,
      upgradeTime: map['upgradeTime'] == null ? null : map['upgradeTime'] as String,
      vswitchId: map['vswitchId'] == null ? null : map['vswitchId'] as String,
      whitelistNetworkType: map['whitelistNetworkType'] == null ? null : map['whitelistNetworkType'] as String,
