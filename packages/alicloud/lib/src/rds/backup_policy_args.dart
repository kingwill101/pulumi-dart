...
class BackupPolicyArgs {
  ...
  BackupPolicyArgs({
    int? archiveBackupKeepCount,
    String? archiveBackupKeepPolicy,
    int? archiveBackupRetentionPeriod,
    ...
    bool? enableIncrementDataBackup,
    String? highSpaceUsageProtection,
    required String instanceId,
    int? localLogRetentionHours,
    int? localLogRetentionSpace,
    bool? logBackup,
    String? logBackupFrequency,
    int? logBackupLocalRetentionNumber,
  ...
  factory BackupPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyArgs(
      archiveBackupKeepCount: map['archiveBackupKeepCount'] == null ? null : map['archiveBackupKeepCount'] as int,
      archiveBackupKeepPolicy: map['archiveBackupKeepPolicy'] == null ? null : map['archiveBackupKeepPolicy'] as String,
      archiveBackupRetentionPeriod: map['archiveBackupRetentionPeriod'] == null ? null : map['archiveBackupRetentionPeriod'] as int,
      backupInterval: map['backupInterval'] == null ? null : map['backupInterval'] as String,
      backupMethod: map['backupMethod'] == null ? null : map['backupMethod'] as String,
      ...
      enableIncrementDataBackup: map['enableIncrementDataBackup'] == null ? null : map['enableIncrementDataBackup'] as bool,
      highSpaceUsageProtection: map['highSpaceUsageProtection'] == null ? null : map['highSpaceUsageProtection'] as String,
      instanceId: map['instanceId'] as String,
      localLogRetentionHours: map['localLogRetentionHours'] == null ? null : map['localLogRetentionHours'] as int,
      localLogRetentionSpace: map['localLogRetentionSpace'] == null ? null : map['localLogRetentionSpace'] as int,
      logBackup: map['logBackup'] == null ? null : map['logBackup'] as bool,
      logBackupFrequency: map['logBackupFrequency'] == null ? null : map['logBackupFrequency'] as String,
      logBackupLocalRetentionNumber: map['logBackupLocalRetentionNumber'] == null ? null : map['logBackupLocalRetentionNumber'] as int,
      logBackupRetentionPeriod: map['logBackupRetentionPeriod'] == null ? null : map['logBackupRetentionPeriod'] as int,
      logRetentionPeriod: map['logRetentionPeriod'] == null ? null : map['logRetentionPeriod'] as int,
