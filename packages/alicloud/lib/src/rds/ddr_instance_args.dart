...
class DdrInstanceArgs {
  ...
  DdrInstanceArgs({
    ...
    List<DdrInstanceParameter>? parameters,
    required String paymentType,
    int? period,
    List<DdrInstancePgHbaConf>? pgHbaConfs,
    String? port,
  ...
  factory DdrInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DdrInstanceArgs(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<DdrInstanceParameter>(map['parameters'], (value) => DdrInstanceParameter.fromMap((value as Map).cast<String, dynamic>())),
      paymentType: map['paymentType'] as String,
      period: map['period'] == null ? null : map['period'] as int,
      pgHbaConfs: map['pgHbaConfs'] == null ? null : pulumi.Input.decodeList<DdrInstancePgHbaConf>(map['pgHbaConfs'], (value) => DdrInstancePgHbaConf.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceDbInstanceName: map['sourceDbInstanceName'] == null ? null : map['sourceDbInstanceName'] as String,
