...
/// {@template pulumi_rds_custom_custom_args_doc}
/// The set of arguments for Custom.
/// {@endtemplate}
/// {@macro pulumi_rds_custom_custom_args_doc}
class CustomArgs {
  ...
  CustomArgs({
    ...
    bool? autoPay,
    bool? autoRenew,
    String? createExtraParam,
    String? createMode,
    List<CustomDataDisk>? dataDisks,
  ...
  factory CustomArgs.fromMap(Map<String, dynamic> map) {
    return CustomArgs(
      ...
      createExtraParam: map['createExtraParam'] == null ? null : map['createExtraParam'] as String,
      createMode: map['createMode'] == null ? null : map['createMode'] as String,
      dataDisks: map['dataDisks'] == null ? null : pulumi.Input.decodeList<CustomDataDisk>(map['dataDisks'], (value) => CustomDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      ...
      supportCase: map['supportCase'] == null ? null : map['supportCase'] as String,
      systemDisk: map['systemDisk'] == null ? null : CustomSystemDisk.fromMap((map['systemDisk'] as Map).cast<String, dynamic>()),
