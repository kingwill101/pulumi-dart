...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    List<InstanceBabelfishConfig>? babelfishConfigs,
    ...
    String? nodeId,
    String? optimizedWrites,
    List<InstanceParameter>? parameters,
    int? period,
    bool? pgBouncerEnabled,
    List<InstancePgHbaConf>? pgHbaConfs,
    String? port,
    ...
    String? securityIpMode,
    String? securityIpType,
    List<String>? securityIps,
    String? serverCert,
    String? serverKey,
    List<InstanceServerlessConfig>? serverlessConfigs,
    int? sqlCollectorConfigValue,
    String? sqlCollectorStatus,
    String? sslAction,
    String? sslConnectionString,
    String? storageAutoScale,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      babelfishConfigs: map['babelfishConfigs'] == null ? null : pulumi.Input.decodeList<InstanceBabelfishConfig>(map['babelfishConfigs'], (value) => InstanceBabelfishConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      coldDataEnabled: map['coldDataEnabled'] == null ? null : map['coldDataEnabled'] as bool,
      ...
      dbIsIgnoreCase: map['dbIsIgnoreCase'] == null ? null : map['dbIsIgnoreCase'] as bool,
      dbParamGroupId: map['dbParamGroupId'] == null ? null : map['dbParamGroupId'] as String,
      dbTimeZone: map['dbTimeZone'] == null ? null : map['dbTimeZone'] as String,
      ...
      force: map['force'] == null ? null : map['force'] as String,
      forceRestart: map['forceRestart'] == null ? null : map['forceRestart'] as bool,
      freshWhiteListReadins: map['freshWhiteListReadins'] == null ? null : map['freshWhiteListReadins'] as String,
      haConfig: map['haConfig'] == null ? null : map['haConfig'] as String,
      ...
      manualHaTime: map['manualHaTime'] == null ? null : map['manualHaTime'] as String,
      modifyMode: map['modifyMode'] == null ? null : map['modifyMode'] as String,
      monitoringPeriod: map['monitoringPeriod'] == null ? null : map['monitoringPeriod'] as int,
      nodeId: map['nodeId'] == null ? null : map['nodeId'] as String,
      optimizedWrites: map['optimizedWrites'] == null ? null : map['optimizedWrites'] as String,
      ...
      pgBouncerEnabled: map['pgBouncerEnabled'] == null ? null : map['pgBouncerEnabled'] as bool,
      pgHbaConfs: map['pgHbaConfs'] == null ? null : pulumi.Input.decodeList<InstancePgHbaConf>(map['pgHbaConfs'], (value) => InstancePgHbaConf.fromMap((value as Map).cast<String, dynamic>())),
      ...
      securityIpMode: map['securityIpMode'] == null ? null : map['securityIpMode'] as String,
      ...
      serverlessConfigs: map['serverlessConfigs'] == null ? null : pulumi.Input.decodeList<InstanceServerlessConfig>(map['serverlessConfigs'], (value) => InstanceServerlessConfig.fromMap((value as Map).cast<String, dynamic>())),
      sqlCollectorConfigValue: map['sqlCollectorConfigValue'] == null ? null : map['sqlCollectorConfigValue'] as int,
      sqlCollectorStatus: map['sqlCollectorStatus'] == null ? null : map['sqlCollectorStatus'] as String,
      sslAction: map['sslAction'] == null ? null : map['sslAction'] as String,
      sslConnectionString: map['sslConnectionString'] == null ? null : map['sslConnectionString'] as String,
      storageAutoScale: map['storageAutoScale'] == null ? null : map['storageAutoScale'] as String,
      storageThreshold: map['storageThreshold'] == null ? null : map['storageThreshold'] as int,
      storageUpperBound: map['storageUpperBound'] == null ? null : map['storageUpperBound'] as int,
      ...
      tdeEncryptionKey: map['tdeEncryptionKey'] == null ? null : map['tdeEncryptionKey'] as String,
      tdeStatus: map['tdeStatus'] == null ? null : map['tdeStatus'] as String,
      templateIdLists: map['templateIdLists'] == null ? null : (map['templateIdLists'] as List).cast<int>(),
