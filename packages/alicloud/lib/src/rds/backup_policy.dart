...
class BackupPolicy extends pulumi.CustomResource {
  ...
  BackupPolicy(
    ...
    this.archiveBackupKeepCount = registerOutput<int>('archiveBackupKeepCount');
    this.archiveBackupKeepPolicy = registerOutput<String>('archiveBackupKeepPolicy');
    this.archiveBackupRetentionPeriod = registerOutput<int>('archiveBackupRetentionPeriod');
    ...
    this.backupPriority = registerOutput<int?>('backupPriority');
    ...
    this.enableIncrementDataBackup = registerOutput<bool>('enableIncrementDataBackup');
    this.highSpaceUsageProtection = registerOutput<String?>('highSpaceUsageProtection');
    this.instanceId = registerOutput<String>('instanceId');
    this.localLogRetentionHours = registerOutput<int>('localLogRetentionHours');
    this.localLogRetentionSpace = registerOutput<int>('localLogRetentionSpace');
    this.logBackup = registerOutput<bool>('logBackup');
    this.logBackupFrequency = registerOutput<String>('logBackupFrequency');
    this.logBackupLocalRetentionNumber = registerOutput<int>('logBackupLocalRetentionNumber');
    this.logBackupRetentionPeriod = registerOutput<int>('logBackupRetentionPeriod');
    this.logRetentionPeriod = registerOutput<int>('logRetentionPeriod');
