...
class ServiceGroupMonitoringAgentProcessArgs {
  ...
  ServiceGroupMonitoringAgentProcessArgs({
    required List<ServiceGroupMonitoringAgentProcessAlertConfig> alertConfigs,
    required String groupId,
    String? matchExpressFilterRelation,
    List<ServiceGroupMonitoringAgentProcessMatchExpress>? matchExpresses,
  ...
  factory ServiceGroupMonitoringAgentProcessArgs.fromMap(Map<String, dynamic> map) {
    return ServiceGroupMonitoringAgentProcessArgs(
      alertConfigs: pulumi.Input.decodeList<ServiceGroupMonitoringAgentProcessAlertConfig>(map['alertConfigs'], (value) => ServiceGroupMonitoringAgentProcessAlertConfig.fromMap((value as Map).cast<String, dynamic>())),
      groupId: map['groupId'] as String,
      matchExpressFilterRelation: map['matchExpressFilterRelation'] == null ? null : map['matchExpressFilterRelation'] as String,
      matchExpresses: map['matchExpresses'] == null ? null : pulumi.Input.decodeList<ServiceGroupMonitoringAgentProcessMatchExpress>(map['matchExpresses'], (value) => ServiceGroupMonitoringAgentProcessMatchExpress.fromMap((value as Map).cast<String, dynamic>())),
