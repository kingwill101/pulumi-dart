...
class QuotaPlanArgs {
  ...
  factory QuotaPlanArgs.fromMap(Map<String, dynamic> map) {
    return QuotaPlanArgs(
      isEffective: map['isEffective'] == null ? null : map['isEffective'] as bool,
      nickname: map['nickname'] as String,
      planName: map['planName'] as String,
      quota: map['quota'] == null ? null : QuotaPlanQuota.fromMap((map['quota'] as Map).cast<String, dynamic>()),
    );
  }
}
