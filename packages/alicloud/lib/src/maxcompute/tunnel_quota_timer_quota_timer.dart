...
class TunnelQuotaTimerQuotaTimer {
  ...
  final TunnelQuotaTimerQuotaTimerTunnelQuotaParameter? tunnelQuotaParameter;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'beginTime': beginTime,
      'endTime': endTime,
      'tunnelQuotaParameter': ?tunnelQuotaParameter == null ? null : tunnelQuotaParameter!.toMap(),
    };
  }

  factory TunnelQuotaTimerQuotaTimer.fromMap(Map<String, dynamic> map) {
    return TunnelQuotaTimerQuotaTimer(
      beginTime: map['beginTime'] as String,
      endTime: map['endTime'] as String,
      tunnelQuotaParameter: map['tunnelQuotaParameter'] == null ? null : TunnelQuotaTimerQuotaTimerTunnelQuotaParameter.fromMap((map['tunnelQuotaParameter'] as Map).cast<String, dynamic>()),
    );
  }
}
