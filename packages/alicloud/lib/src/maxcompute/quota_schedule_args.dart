...
class QuotaScheduleArgs {
  ...
  QuotaScheduleArgs({
    ...
    List<QuotaScheduleScheduleList>? scheduleLists,
  ...
  factory QuotaScheduleArgs.fromMap(Map<String, dynamic> map) {
    return QuotaScheduleArgs(
      ...
      scheduleLists: map['scheduleLists'] == null ? null : pulumi.Input.decodeList<QuotaScheduleScheduleList>(map['scheduleLists'], (value) => QuotaScheduleScheduleList.fromMap((value as Map).cast<String, dynamic>())),
