...
class ProjectSecurityProperties {
  ...
  final ProjectSecurityPropertiesProjectProtection? projectProtection;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'projectProtection': ?projectProtection == null ? null : projectProtection!.toMap(),
      'usingAcl': ?usingAcl,
  ...
  factory ProjectSecurityProperties.fromMap(Map<String, dynamic> map) {
    return ProjectSecurityProperties(
      enableDownloadPrivilege: map['enableDownloadPrivilege'] == null ? null : map['enableDownloadPrivilege'] as bool,
      labelSecurity: map['labelSecurity'] == null ? null : map['labelSecurity'] as bool,
      objectCreatorHasAccessPermission: map['objectCreatorHasAccessPermission'] == null ? null : map['objectCreatorHasAccessPermission'] as bool,
      objectCreatorHasGrantPermission: map['objectCreatorHasGrantPermission'] == null ? null : map['objectCreatorHasGrantPermission'] as bool,
      projectProtection: map['projectProtection'] == null ? null : ProjectSecurityPropertiesProjectProtection.fromMap((map['projectProtection'] as Map).cast<String, dynamic>()),
      usingAcl: map['usingAcl'] == null ? null : map['usingAcl'] as bool,
      usingPolicy: map['usingPolicy'] == null ? null : map['usingPolicy'] as bool,
    );
  }
}
