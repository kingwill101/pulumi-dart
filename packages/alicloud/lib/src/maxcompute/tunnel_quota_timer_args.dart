...
class TunnelQuotaTimerArgs {
  ...
  TunnelQuotaTimerArgs({
    ...
    List<TunnelQuotaTimerQuotaTimer>? quotaTimers,
    String? timeZone,
  }) :
  ...
  factory TunnelQuotaTimerArgs.fromMap(Map<String, dynamic> map) {
    return TunnelQuotaTimerArgs(
      ...
      quotaTimers: map['quotaTimers'] == null ? null : pulumi.Input.decodeList<TunnelQuotaTimerQuotaTimer>(map['quotaTimers'], (value) => TunnelQuotaTimerQuotaTimer.fromMap((value as Map).cast<String, dynamic>())),
