...
/// {@template pulumi_maxcompute_quota_quota_args_doc}
/// The set of arguments for Quota.
/// {@endtemplate}
/// {@macro pulumi_maxcompute_quota_quota_args_doc}
class QuotaArgs {
  ...
  QuotaArgs({
    ...
    List<QuotaSubQuotaInfoList>? subQuotaInfoLists,
  }) :
  ...
  factory QuotaArgs.fromMap(Map<String, dynamic> map) {
    return QuotaArgs(
      ...
      commodityData: map['commodityData'] == null ? null : map['commodityData'] as String,
      partNickName: map['partNickName'] == null ? null : map['partNickName'] as String,
      paymentType: map['paymentType'] as String,
      subQuotaInfoLists: map['subQuotaInfoLists'] == null ? null : pulumi.Input.decodeList<QuotaSubQuotaInfoList>(map['subQuotaInfoLists'], (value) => QuotaSubQuotaInfoList.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
