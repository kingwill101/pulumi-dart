...
class ProjectProperties {
  ...
  final ProjectPropertiesEncryption? encryption;
  ...
  final ProjectPropertiesTableLifecycle? tableLifecycle;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tableLifecycle': ?tableLifecycle == null ? null : tableLifecycle!.toMap(),
      'timezone': ?timezone,
  ...
  factory ProjectProperties.fromMap(Map<String, dynamic> map) {
    return ProjectProperties(
      allowFullScan: map['allowFullScan'] == null ? null : map['allowFullScan'] as bool,
      enableDecimal2: map['enableDecimal2'] == null ? null : map['enableDecimal2'] as bool,
      enableDr: map['enableDr'] == null ? null : map['enableDr'] as bool,
      encryption: map['encryption'] == null ? null : ProjectPropertiesEncryption.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      retentionDays: map['retentionDays'] == null ? null : map['retentionDays'] as int,
      sqlMeteringMax: map['sqlMeteringMax'] == null ? null : map['sqlMeteringMax'] as String,
      tableLifecycle: map['tableLifecycle'] == null ? null : ProjectPropertiesTableLifecycle.fromMap((map['tableLifecycle'] as Map).cast<String, dynamic>()),
      timezone: map['timezone'] == null ? null : map['timezone'] as String,
      typeSystem: map['typeSystem'] == null ? null : map['typeSystem'] as String,
    );
  }
}
