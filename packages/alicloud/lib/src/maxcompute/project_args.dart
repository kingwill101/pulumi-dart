...
class ProjectArgs {
  ...
  ProjectArgs({
    String? comment,
    String? defaultQuota,
    ProjectIpWhiteList? ipWhiteList,
    String? isLogical,
    String? productType,
    String? projectName,
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      ...
      defaultQuota: map['defaultQuota'] == null ? null : map['defaultQuota'] as String,
      ipWhiteList: map['ipWhiteList'] == null ? null : ProjectIpWhiteList.fromMap((map['ipWhiteList'] as Map).cast<String, dynamic>()),
      isLogical: map['isLogical'] == null ? null : map['isLogical'] as String,
      ...
      securityProperties: map['securityProperties'] == null ? null : ProjectSecurityProperties.fromMap((map['securityProperties'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : map['status'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      threeTierModel: map['threeTierModel'] == null ? null : map['threeTierModel'] as bool,
    );
  }
}
