...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    required String environmentSubType,
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      bindResourceId: map['bindResourceId'] == null ? null : map['bindResourceId'] as String,
      dropMetrics: map['dropMetrics'] == null ? null : map['dropMetrics'] as String,
      environmentName: map['environmentName'] == null ? null : map['environmentName'] as String,
      environmentSubType: map['environmentSubType'] as String,
      environmentType: map['environmentType'] as String,
      managedType: map['managedType'] == null ? null : map['managedType'] as String,
