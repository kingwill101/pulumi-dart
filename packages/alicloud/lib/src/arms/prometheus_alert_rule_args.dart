...
class PrometheusAlertRuleArgs {
  ...
  PrometheusAlertRuleArgs({
    List<PrometheusAlertRuleAnnotation>? annotations,
    required String clusterId,
    String? dispatchRuleId,
    required String duration,
    required String expression,
    List<PrometheusAlertRuleLabel>? labels,
    required String message,
    String? notifyType,
    required String prometheusAlertRuleName,
    String? type,
  }) :
  ...
  factory PrometheusAlertRuleArgs.fromMap(Map<String, dynamic> map) {
    return PrometheusAlertRuleArgs(
      annotations: map['annotations'] == null ? null : pulumi.Input.decodeList<PrometheusAlertRuleAnnotation>(map['annotations'], (value) => PrometheusAlertRuleAnnotation.fromMap((value as Map).cast<String, dynamic>())),
      clusterId: map['clusterId'] as String,
      dispatchRuleId: map['dispatchRuleId'] == null ? null : map['dispatchRuleId'] as String,
      duration: map['duration'] as String,
      expression: map['expression'] as String,
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<PrometheusAlertRuleLabel>(map['labels'], (value) => PrometheusAlertRuleLabel.fromMap((value as Map).cast<String, dynamic>())),
      message: map['message'] as String,
      notifyType: map['notifyType'] == null ? null : map['notifyType'] as String,
