...
class WorkspaceModelVersionArgs {
  ...
  WorkspaceModelVersionArgs({
    ...
    Map<String, String>? inferenceSpec,
    List<WorkspaceModelVersionLabel>? labels,
    Map<String, String>? metrics,
    required String modelId,
    String? options,
    String? sourceId,
    String? sourceType,
    Map<String, String>? trainingSpec,
    required String uri,
  ...
  factory WorkspaceModelVersionArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceModelVersionArgs(
      ...
      formatType: map['formatType'] == null ? null : map['formatType'] as String,
      frameworkType: map['frameworkType'] == null ? null : map['frameworkType'] as String,
      inferenceSpec: map['inferenceSpec'] == null ? null : (map['inferenceSpec'] as Map).cast<String, String>(),
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<WorkspaceModelVersionLabel>(map['labels'], (value) => WorkspaceModelVersionLabel.fromMap((value as Map).cast<String, dynamic>())),
      metrics: map['metrics'] == null ? null : (map['metrics'] as Map).cast<String, String>(),
      ...
      trainingSpec: map['trainingSpec'] == null ? null : (map['trainingSpec'] as Map).cast<String, String>(),
