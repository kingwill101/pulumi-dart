...
class WorkspaceDataset extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<WorkspaceDatasetLabel>?> labels;
  ...
  WorkspaceDataset(
    ...
    this.datasetName = registerOutput<String>('datasetName');
    this.description = registerOutput<String?>('description');
    this.labels = registerOutput<List<WorkspaceDatasetLabel>?>('labels');
