...
class WorkspaceCodeSourceArgs {
  ...
  WorkspaceCodeSourceArgs({
    ...
    String? codeBranch,
    String? codeCommit,
    required String codeRepo,
    String? codeRepoAccessToken,
    String? codeRepoUserName,
    String? description,
  ...
  factory WorkspaceCodeSourceArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceCodeSourceArgs(
      ...
      codeBranch: map['codeBranch'] == null ? null : map['codeBranch'] as String,
      codeCommit: map['codeCommit'] == null ? null : map['codeCommit'] as String,
      codeRepo: map['codeRepo'] as String,
      codeRepoAccessToken: map['codeRepoAccessToken'] == null ? null : map['codeRepoAccessToken'] as String,
      codeRepoUserName: map['codeRepoUserName'] == null ? null : map['codeRepoUserName'] as String,
