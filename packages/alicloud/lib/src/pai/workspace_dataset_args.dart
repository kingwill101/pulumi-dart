...
class WorkspaceDatasetArgs {
  ...
  WorkspaceDatasetArgs({
    ...
    String? description,
    List<WorkspaceDatasetLabel>? labels,
    String? options,
  ...
  factory WorkspaceDatasetArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceDatasetArgs(
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<WorkspaceDatasetLabel>(map['labels'], (value) => WorkspaceDatasetLabel.fromMap((value as Map).cast<String, dynamic>())),
