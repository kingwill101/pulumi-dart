...
class WorkspaceModelArgs {
  ...
  WorkspaceModelArgs({
    ...
    List<WorkspaceModelLabel>? labels,
  ...
  factory WorkspaceModelArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceModelArgs(
      ...
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<WorkspaceModelLabel>(map['labels'], (value) => WorkspaceModelLabel.fromMap((value as Map).cast<String, dynamic>())),
      modelDescription: map['modelDescription'] == null ? null : map['modelDescription'] as String,
      modelDoc: map['modelDoc'] == null ? null : map['modelDoc'] as String,
      modelName: map['modelName'] as String,
      modelType: map['modelType'] == null ? null : map['modelType'] as String,
      orderNumber: map['orderNumber'] == null ? null : map['orderNumber'] as int,
