...
class WorkspaceDatasetversionArgs {
  ...
  WorkspaceDatasetversionArgs({
    ...
    String? description,
    List<WorkspaceDatasetversionLabel>? labels,
    String? options,
  ...
  factory WorkspaceDatasetversionArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceDatasetversionArgs(
      dataCount: map['dataCount'] == null ? null : map['dataCount'] as int,
      dataSize: map['dataSize'] == null ? null : map['dataSize'] as int,
      dataSourceType: map['dataSourceType'] as String,
      datasetId: map['datasetId'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      labels: map['labels'] == null ? null : pulumi.Input.decodeList<WorkspaceDatasetversionLabel>(map['labels'], (value) => WorkspaceDatasetversionLabel.fromMap((value as Map).cast<String, dynamic>())),
