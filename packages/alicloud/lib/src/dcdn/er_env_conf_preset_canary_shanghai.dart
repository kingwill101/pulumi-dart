...
class ErEnvConfPresetCanaryShanghai {
  ...
  /// Creates a new [ErEnvConfPresetCanaryShanghai].
  ...
  factory ErEnvConfPresetCanaryShanghai.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryShanghai(
