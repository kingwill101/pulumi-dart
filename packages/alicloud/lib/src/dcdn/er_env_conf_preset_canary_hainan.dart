...
class ErEnvConfPresetCanaryHainan {
  ...
  /// Creates a new [ErEnvConfPresetCanaryHainan].
  ...
  factory ErEnvConfPresetCanaryHainan.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryHainan(
