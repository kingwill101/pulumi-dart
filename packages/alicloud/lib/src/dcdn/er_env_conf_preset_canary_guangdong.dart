...
class ErEnvConfPresetCanaryGuangdong {
  ...
  /// Creates a new [ErEnvConfPresetCanaryGuangdong].
  ...
  factory ErEnvConfPresetCanaryGuangdong.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryGuangdong(
