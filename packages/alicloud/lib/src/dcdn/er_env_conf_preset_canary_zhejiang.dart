...
class ErEnvConfPresetCanaryZhejiang {
  ...
  /// Creates a new [ErEnvConfPresetCanaryZhejiang].
  ...
  factory ErEnvConfPresetCanaryZhejiang.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryZhejiang(
