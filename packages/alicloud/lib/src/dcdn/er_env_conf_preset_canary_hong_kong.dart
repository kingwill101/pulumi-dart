...
class ErEnvConfPresetCanaryHongKong {
  ...
  /// Creates a new [ErEnvConfPresetCanaryHongKong].
  ...
  factory ErEnvConfPresetCanaryHongKong.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryHongKong(
