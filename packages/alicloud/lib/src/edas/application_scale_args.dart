...
class ApplicationScaleArgs {
  ...
  ApplicationScaleArgs({
    ...
    required String deployGroup,
    required List<String> ecuInfos,
    bool? forceStatus,
  }) :
  ...
  factory ApplicationScaleArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationScaleArgs(
      ...
      deployGroup: map['deployGroup'] as String,
      ecuInfos: (map['ecuInfos'] as List).cast<String>(),
      forceStatus: map['forceStatus'] == null ? null : map['forceStatus'] as bool,
    );
  }
}
