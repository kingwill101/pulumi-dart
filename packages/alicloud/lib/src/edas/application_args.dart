...
class ApplicationArgs {
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      ...
      buildPackId: map['buildPackId'] == null ? null : map['buildPackId'] as int,
      clusterId: map['clusterId'] as String,
      descriotion: map['descriotion'] == null ? null : map['descriotion'] as String,
      ecuInfos: map['ecuInfos'] == null ? null : (map['ecuInfos'] as List).cast<String>(),
      ...
      warUrl: map['warUrl'] == null ? null : map['warUrl'] as String,
    );
  }
}
