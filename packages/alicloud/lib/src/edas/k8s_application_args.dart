...
class K8sApplicationArgs {
  ...
  K8sApplicationArgs({
    ...
    int? internetSlbPort,
    String? internetSlbProtocol,
    int? internetTargetPort,
    String? jdk,
    int? limitMCpu,
    int? limitMem,
    String? liveness,
  ...
  factory K8sApplicationArgs.fromMap(Map<String, dynamic> map) {
    return K8sApplicationArgs(
      applicationDescriotion: map['applicationDescriotion'] == null ? null : map['applicationDescriotion'] as String,
      applicationName: map['applicationName'] as String,
      clusterId: map['clusterId'] as String,
      command: map['command'] == null ? null : map['command'] as String,
      commandArgs: map['commandArgs'] == null ? null : (map['commandArgs'] as List).cast<String>(),
      edasContainerVersion: map['edasContainerVersion'] == null ? null : map['edasContainerVersion'] as String,
      envs: map['envs'] == null ? null : (map['envs'] as Map).cast<String, String>(),
      imageUrl: map['imageUrl'] == null ? null : map['imageUrl'] as String,
      internetSlbId: map['internetSlbId'] == null ? null : map['internetSlbId'] as String,
      internetSlbPort: map['internetSlbPort'] == null ? null : map['internetSlbPort'] as int,
      internetSlbProtocol: map['internetSlbProtocol'] == null ? null : map['internetSlbProtocol'] as String,
      internetTargetPort: map['internetTargetPort'] == null ? null : map['internetTargetPort'] as int,
      jdk: map['jdk'] == null ? null : map['jdk'] as String,
      limitMCpu: map['limitMCpu'] == null ? null : map['limitMCpu'] as int,
      limitMem: map['limitMem'] == null ? null : map['limitMem'] as int,
      liveness: map['liveness'] == null ? null : map['liveness'] as String,
      localVolume: map['localVolume'] == null ? null : map['localVolume'] as String,
      logicalRegionId: map['logicalRegionId'] == null ? null : map['logicalRegionId'] as String,
      mountDescs: map['mountDescs'] == null ? null : map['mountDescs'] as String,
      ...
      requestsMCpu: map['requestsMCpu'] == null ? null : map['requestsMCpu'] as int,
      requestsMem: map['requestsMem'] == null ? null : map['requestsMem'] as int,
