...
class AggregateCompliancePackArgs {
  ...
  AggregateCompliancePackArgs({
    required String aggregateCompliancePackName,
    required String aggregatorId,
    String? compliancePackTemplateId,
    List<AggregateCompliancePackConfigRuleId>? configRuleIds,
    List<AggregateCompliancePackConfigRule>? configRules,
  ...
  factory AggregateCompliancePackArgs.fromMap(Map<String, dynamic> map) {
    return AggregateCompliancePackArgs(
      ...
      compliancePackTemplateId: map['compliancePackTemplateId'] == null ? null : map['compliancePackTemplateId'] as String,
      configRuleIds: map['configRuleIds'] == null ? null : pulumi.Input.decodeList<AggregateCompliancePackConfigRuleId>(map['configRuleIds'], (value) => AggregateCompliancePackConfigRuleId.fromMap((value as Map).cast<String, dynamic>())),
      configRules: map['configRules'] == null ? null : pulumi.Input.decodeList<AggregateCompliancePackConfigRule>(map['configRules'], (value) => AggregateCompliancePackConfigRule.fromMap((value as Map).cast<String, dynamic>())),
