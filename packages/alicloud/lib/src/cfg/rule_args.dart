...
class RuleArgs {
  ...
  RuleArgs({
    ...
    String? scopeComplianceResourceTypes,
  ...
  factory RuleArgs.fromMap(Map<String, dynamic> map) {
    return RuleArgs(
      configRuleTriggerTypes: map['configRuleTriggerTypes'] == null ? null : map['configRuleTriggerTypes'] as String,
      ...
      resourceTypesScopes: map['resourceTypesScopes'] == null ? null : (map['resourceTypesScopes'] as List).cast<String>(),
      riskLevel: map['riskLevel'] as int,
      ruleName: map['ruleName'] as String,
      scopeComplianceResourceTypes: map['scopeComplianceResourceTypes'] == null ? null : map['scopeComplianceResourceTypes'] as String,
      sourceDetailMessageType: map['sourceDetailMessageType'] == null ? null : map['sourceDetailMessageType'] as String,
      sourceIdentifier: map['sourceIdentifier'] as String,
      sourceMaximumExecutionFrequency: map['sourceMaximumExecutionFrequency'] == null ? null : map['sourceMaximumExecutionFrequency'] as String,
