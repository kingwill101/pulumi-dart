...
class CompliancePackArgs {
  ...
  CompliancePackArgs({
    required String compliancePackName,
    String? compliancePackTemplateId,
    List<CompliancePackConfigRuleId>? configRuleIds,
    List<CompliancePackConfigRule>? configRules,
  ...
  factory CompliancePackArgs.fromMap(Map<String, dynamic> map) {
    return CompliancePackArgs(
      ...
      configRuleIds: map['configRuleIds'] == null ? null : pulumi.Input.decodeList<CompliancePackConfigRuleId>(map['configRuleIds'], (value) => CompliancePackConfigRuleId.fromMap((value as Map).cast<String, dynamic>())),
      configRules: map['configRules'] == null ? null : pulumi.Input.decodeList<CompliancePackConfigRule>(map['configRules'], (value) => CompliancePackConfigRule.fromMap((value as Map).cast<String, dynamic>())),
