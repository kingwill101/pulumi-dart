...
/// {@template pulumi_cfg_delivery_delivery_args_doc}
/// The set of arguments for Delivery.
/// {@endtemplate}
/// {@macro pulumi_cfg_delivery_delivery_args_doc}
class DeliveryArgs {
  ...
  factory DeliveryArgs.fromMap(Map<String, dynamic> map) {
    return DeliveryArgs(
      configurationItemChangeNotification: map['configurationItemChangeNotification'] == null ? null : map['configurationItemChangeNotification'] as bool,
      configurationSnapshot: map['configurationSnapshot'] == null ? null : map['configurationSnapshot'] as bool,
      ...
      nonCompliantNotification: map['nonCompliantNotification'] == null ? null : map['nonCompliantNotification'] as bool,
