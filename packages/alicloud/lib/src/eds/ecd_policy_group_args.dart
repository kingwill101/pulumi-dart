...
class EcdPolicyGroupArgs {
  ...
  EcdPolicyGroupArgs({
    List<EcdPolicyGroupAuthorizeAccessPolicyRule>? authorizeAccessPolicyRules,
    List<EcdPolicyGroupAuthorizeSecurityPolicyRule>? authorizeSecurityPolicyRules,
  ...
  factory EcdPolicyGroupArgs.fromMap(Map<String, dynamic> map) {
    return EcdPolicyGroupArgs(
      authorizeAccessPolicyRules: map['authorizeAccessPolicyRules'] == null ? null : pulumi.Input.decodeList<EcdPolicyGroupAuthorizeAccessPolicyRule>(map['authorizeAccessPolicyRules'], (value) => EcdPolicyGroupAuthorizeAccessPolicyRule.fromMap((value as Map).cast<String, dynamic>())),
      authorizeSecurityPolicyRules: map['authorizeSecurityPolicyRules'] == null ? null : pulumi.Input.decodeList<EcdPolicyGroupAuthorizeSecurityPolicyRule>(map['authorizeSecurityPolicyRules'], (value) => EcdPolicyGroupAuthorizeSecurityPolicyRule.fromMap((value as Map).cast<String, dynamic>())),
      cameraRedirect: map['cameraRedirect'] == null ? null : map['cameraRedirect'] as String,
      clipboard: map['clipboard'] == null ? null : map['clipboard'] as String,
      domainList: map['domainList'] == null ? null : map['domainList'] as String,
      htmlAccess: map['htmlAccess'] == null ? null : map['htmlAccess'] as String,
      htmlFileTransfer: map['htmlFileTransfer'] == null ? null : map['htmlFileTransfer'] as String,
      localDrive: map['localDrive'] == null ? null : map['localDrive'] as String,
      policyGroupName: map['policyGroupName'] == null ? null : map['policyGroupName'] as String,
      recording: map['recording'] == null ? null : map['recording'] as String,
      recordingEndTime: map['recordingEndTime'] == null ? null : map['recordingEndTime'] as String,
      recordingExpires: map['recordingExpires'] == null ? null : map['recordingExpires'] as int,
      recordingFps: map['recordingFps'] == null ? null : map['recordingFps'] as int,
      recordingStartTime: map['recordingStartTime'] == null ? null : map['recordingStartTime'] as String,
      usbRedirect: map['usbRedirect'] == null ? null : map['usbRedirect'] as String,
      visualQuality: map['visualQuality'] == null ? null : map['visualQuality'] as String,
      watermark: map['watermark'] == null ? null : map['watermark'] as String,
      watermarkTransparency: map['watermarkTransparency'] == null ? null : map['watermarkTransparency'] as String,
      watermarkType: map['watermarkType'] == null ? null : map['watermarkType'] as String,
    );
  }
}
