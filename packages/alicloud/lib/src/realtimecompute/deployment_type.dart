...
class DeploymentType extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DeploymentLocalVariable>?> localVariables;
  ...
  DeploymentType(
    ...
    this.artifact = registerOutput<DeploymentArtifact>('artifact');
    this.batchResourceSetting = registerOutput<DeploymentBatchResourceSetting?>('batchResourceSetting');
    this.deploymentId = registerOutput<String>('deploymentId');
    this.deploymentName = registerOutput<String>('deploymentName');
    this.deploymentTarget = registerOutput<DeploymentDeploymentTarget>('deploymentTarget');
    this.description = registerOutput<String?>('description');
    this.engineVersion = registerOutput<String>('engineVersion');
    this.executionMode = registerOutput<String>('executionMode');
    this.flinkConf = registerOutput<Map<String, String>>('flinkConf');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.localVariables = registerOutput<List<DeploymentLocalVariable>?>('localVariables');
    this.logging = registerOutput<DeploymentLogging>('logging');
    this.namespace = registerOutput<String>('namespace');
    this.resourceId = registerOutput<String>('resourceId');
    this.streamingResourceSetting = registerOutput<DeploymentStreamingResourceSetting>('streamingResourceSetting');
  }
}
