...
class JobArgs {
  ...
  JobArgs({
    String? deploymentId,
    List<JobLocalVariable>? localVariables,
    required String namespace,
    required String resourceId,
    String? resourceQueueName,
    JobRestoreStrategy? restoreStrategy,
    JobStatus? status,
    String? stopStrategy,
  }) :
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      localVariables: map['localVariables'] == null ? null : pulumi.Input.decodeList<JobLocalVariable>(map['localVariables'], (value) => JobLocalVariable.fromMap((value as Map).cast<String, dynamic>())),
      namespace: map['namespace'] as String,
      resourceId: map['resourceId'] as String,
      resourceQueueName: map['resourceQueueName'] == null ? null : map['resourceQueueName'] as String,
      restoreStrategy: map['restoreStrategy'] == null ? null : JobRestoreStrategy.fromMap((map['restoreStrategy'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : JobStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
      stopStrategy: map['stopStrategy'] == null ? null : map['stopStrategy'] as String,
    );
  }
}
