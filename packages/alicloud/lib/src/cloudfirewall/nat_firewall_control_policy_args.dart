...
class NatFirewallControlPolicyArgs {
  ...
  NatFirewallControlPolicyArgs({
    ...
    required List<String> applicationNameLists,
  ...
  factory NatFirewallControlPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NatFirewallControlPolicyArgs(
      ...
      applicationNameLists: (map['applicationNameLists'] as List).cast<String>(),
      ...
      domainResolveType: map['domainResolveType'] == null ? null : map['domainResolveType'] as int,
      ...
      newOrder: map['newOrder'] as String,
