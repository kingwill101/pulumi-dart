...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.accountNumber = registerOutput<int?>('accountNumber');
    this.bandWidth = registerOutput<int?>('bandWidth');
    this.cfwAccount = registerOutput<bool?>('cfwAccount');
    this.cfwLog = registerOutput<bool?>('cfwLog');
    this.cfwLogStorage = registerOutput<int?>('cfwLogStorage');
    this.createTime = registerOutput<String>('createTime');
    this.endTime = registerOutput<String>('endTime');
    this.fwVpcNumber = registerOutput<int>('fwVpcNumber');
    this.instanceCount = registerOutput<int?>('instanceCount');
    this.ipNumber = registerOutput<int>('ipNumber');
    ...
    this.userStatus = registerOutput<bool>('userStatus');
  }
}
