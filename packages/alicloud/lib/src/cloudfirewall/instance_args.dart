...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      accountNumber: map['accountNumber'] == null ? null : map['accountNumber'] as int,
      bandWidth: map['bandWidth'] == null ? null : map['bandWidth'] as int,
      cfwAccount: map['cfwAccount'] == null ? null : map['cfwAccount'] as bool,
      cfwLog: map['cfwLog'] == null ? null : map['cfwLog'] as bool,
      cfwLogStorage: map['cfwLogStorage'] == null ? null : map['cfwLogStorage'] as int,
      fwVpcNumber: map['fwVpcNumber'] == null ? null : map['fwVpcNumber'] as int,
      instanceCount: map['instanceCount'] == null ? null : map['instanceCount'] as int,
      ipNumber: map['ipNumber'] == null ? null : map['ipNumber'] as int,
      logistics: map['logistics'] == null ? null : map['logistics'] as String,
