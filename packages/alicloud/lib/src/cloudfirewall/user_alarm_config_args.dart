...
class UserAlarmConfigArgs {
  ...
  UserAlarmConfigArgs({
    required List<UserAlarmConfigAlarmConfig> alarmConfigs,
    String? alarmLang,
    List<UserAlarmConfigContactConfig>? contactConfigs,
    String? lang,
    List<UserAlarmConfigNotifyConfig>? notifyConfigs,
    String? useDefaultContact,
  }) :
      alarmConfigs = pulumi.Input.asInput<List<UserAlarmConfigAlarmConfig>>(alarmConfigs),
  ...
  factory UserAlarmConfigArgs.fromMap(Map<String, dynamic> map) {
    return UserAlarmConfigArgs(
      alarmConfigs: pulumi.Input.decodeList<UserAlarmConfigAlarmConfig>(map['alarmConfigs'], (value) => UserAlarmConfigAlarmConfig.fromMap((value as Map).cast<String, dynamic>())),
      alarmLang: map['alarmLang'] == null ? null : map['alarmLang'] as String,
      contactConfigs: map['contactConfigs'] == null ? null : pulumi.Input.decodeList<UserAlarmConfigContactConfig>(map['contactConfigs'], (value) => UserAlarmConfigContactConfig.fromMap((value as Map).cast<String, dynamic>())),
      lang: map['lang'] == null ? null : map['lang'] as String,
      notifyConfigs: map['notifyConfigs'] == null ? null : pulumi.Input.decodeList<UserAlarmConfigNotifyConfig>(map['notifyConfigs'], (value) => UserAlarmConfigNotifyConfig.fromMap((value as Map).cast<String, dynamic>())),
      useDefaultContact: map['useDefaultContact'] == null ? null : map['useDefaultContact'] as String,
    );
  }
}
