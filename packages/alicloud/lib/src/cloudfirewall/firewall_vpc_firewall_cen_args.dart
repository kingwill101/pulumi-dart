...
class FirewallVpcFirewallCenArgs {
  ...
  FirewallVpcFirewallCenArgs({
    ...
    String? lang,
    required FirewallVpcFirewallCenLocalVpc localVpc,
    String? memberUid,
    required String status,
    required String vpcFirewallName,
    required String vpcRegion,
  }) :
  ...
  factory FirewallVpcFirewallCenArgs.fromMap(Map<String, dynamic> map) {
    return FirewallVpcFirewallCenArgs(
      ...
      localVpc: FirewallVpcFirewallCenLocalVpc.fromMap((map['localVpc'] as Map).cast<String, dynamic>()),
      memberUid: map['memberUid'] == null ? null : map['memberUid'] as String,
      status: map['status'] as String,
      vpcFirewallName: map['vpcFirewallName'] as String,
      vpcRegion: map['vpcRegion'] as String,
    );
  }
}
