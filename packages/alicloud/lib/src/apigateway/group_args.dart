...
class GroupArgs {
  ...
  GroupArgs({
    ...
    String? instanceId,
    String? name,
    GroupUserLogConfig? userLogConfig,
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      userLogConfig: map['userLogConfig'] == null ? null : GroupUserLogConfig.fromMap((map['userLogConfig'] as Map).cast<String, dynamic>()),
      vpcIntranetEnable: map['vpcIntranetEnable'] == null ? null : map['vpcIntranetEnable'] as bool,
    );
  }
}
