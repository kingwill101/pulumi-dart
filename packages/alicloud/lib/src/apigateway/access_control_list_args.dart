...
class AccessControlListArgs {
  ...
  AccessControlListArgs({
    required String accessControlListName,
    List<AccessControlListAclEntry>? aclEntrys,
  ...
  factory AccessControlListArgs.fromMap(Map<String, dynamic> map) {
    return AccessControlListArgs(
      accessControlListName: map['accessControlListName'] as String,
      aclEntrys: map['aclEntrys'] == null ? null : pulumi.Input.decodeList<AccessControlListAclEntry>(map['aclEntrys'], (value) => AccessControlListAclEntry.fromMap((value as Map).cast<String, dynamic>())),
