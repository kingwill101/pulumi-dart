...
class BackendArgs {
  ...
  BackendArgs({
    ...
    bool? createEventBridgeServiceLinkedRole,
    String? description,
  }) :
  ...
  factory BackendArgs.fromMap(Map<String, dynamic> map) {
    return BackendArgs(
      ...
      createEventBridgeServiceLinkedRole: map['createEventBridgeServiceLinkedRole'] == null ? null : map['createEventBridgeServiceLinkedRole'] as bool,
