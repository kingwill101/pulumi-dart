...
class PhysicalConnectionArgs {
  ...
  factory PhysicalConnectionArgs.fromMap(Map<String, dynamic> map) {
    return PhysicalConnectionArgs(
      ...
      peerLocation: map['peerLocation'] == null ? null : map['peerLocation'] as String,
      period: map['period'] == null ? null : map['period'] as int,
      physicalConnectionName: map['physicalConnectionName'] == null ? null : map['physicalConnectionName'] as String,
      portType: map['portType'] == null ? null : map['portType'] as String,
      pricingCycle: map['pricingCycle'] == null ? null : map['pricingCycle'] as String,
      redundantPhysicalConnectionId: map['redundantPhysicalConnectionId'] == null ? null : map['redundantPhysicalConnectionId'] as String,
