...
class TrafficQosQueueArgs {
  ...
  factory TrafficQosQueueArgs.fromMap(Map<String, dynamic> map) {
    return TrafficQosQueueArgs(
      bandwidthPercent: map['bandwidthPercent'] == null ? null : map['bandwidthPercent'] as String,
      qosId: map['qosId'] as String,
      queueDescription: map['queueDescription'] == null ? null : map['queueDescription'] as String,
      queueName: map['queueName'] == null ? null : map['queueName'] as String,
      queueType: map['queueType'] as String,
    );
  }
}
