...
class RouterTrAssociationArgs {
  ...
  RouterTrAssociationArgs({
    ...
    required String associationRegionId,
    String? cenId,
    required String ecrId,
    String? transitRouterId,
    int? transitRouterOwnerId,
  }) :
  ...
  factory RouterTrAssociationArgs.fromMap(Map<String, dynamic> map) {
    return RouterTrAssociationArgs(
      ...
      associationRegionId: map['associationRegionId'] as String,
      ...
      transitRouterOwnerId: map['transitRouterOwnerId'] == null ? null : map['transitRouterOwnerId'] as int,
    );
  }
}
