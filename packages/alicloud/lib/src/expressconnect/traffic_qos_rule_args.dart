...
class TrafficQosRuleArgs {
  ...
  factory TrafficQosRuleArgs.fromMap(Map<String, dynamic> map) {
    return TrafficQosRuleArgs(
      ...
      dstIpv6Cidr: map['dstIpv6Cidr'] == null ? null : map['dstIpv6Cidr'] as String,
      dstPortRange: map['dstPortRange'] == null ? null : map['dstPortRange'] as String,
      matchDscp: map['matchDscp'] == null ? null : map['matchDscp'] as int,
      priority: map['priority'] as int,
      protocol: map['protocol'] as String,
      qosId: map['qosId'] as String,
      queueId: map['queueId'] as String,
      remarkingDscp: map['remarkingDscp'] == null ? null : map['remarkingDscp'] as int,
      ruleDescription: map['ruleDescription'] == null ? null : map['ruleDescription'] as String,
      ruleName: map['ruleName'] == null ? null : map['ruleName'] as String,
      srcCidr: map['srcCidr'] == null ? null : map['srcCidr'] as String,
      srcIpv6Cidr: map['srcIpv6Cidr'] == null ? null : map['srcIpv6Cidr'] as String,
      srcPortRange: map['srcPortRange'] == null ? null : map['srcPortRange'] as String,
    );
  }
}
