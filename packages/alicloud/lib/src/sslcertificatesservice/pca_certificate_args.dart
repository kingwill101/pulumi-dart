...
/// {@template pulumi_sslcertificatesservice_pca_certificate_pca_certificate_args_doc}
/// The set of arguments for PcaCertificate.
/// {@endtemplate}
/// {@macro pulumi_sslcertificatesservice_pca_certificate_pca_certificate_args_doc}
class PcaCertificateArgs {
  ...
  /// Creates a new [PcaCertificateArgs].
  ...
  factory PcaCertificateArgs.fromMap(Map<String, dynamic> map) {
    return PcaCertificateArgs(
      ...
      crlDay: map['crlDay'] == null ? null : map['crlDay'] as int,
      enableCrl: map['enableCrl'] == null ? null : map['enableCrl'] as bool,
      ...
      parentIdentifier: map['parentIdentifier'] == null ? null : map['parentIdentifier'] as String,
      pathLenConstraint: map['pathLenConstraint'] == null ? null : map['pathLenConstraint'] as int,
