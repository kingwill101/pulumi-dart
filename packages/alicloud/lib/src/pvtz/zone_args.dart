...
class ZoneArgs {
  ...
  factory ZoneArgs.fromMap(Map<String, dynamic> map) {
    return ZoneArgs(
      ...
      proxyPattern: map['proxyPattern'] == null ? null : map['proxyPattern'] as String,
      ...
      userInfos: map['userInfos'] == null ? null : pulumi.Input.decodeList<ZoneUserInfo>(map['userInfos'], (value) => ZoneUserInfo.fromMap((value as Map).cast<String, dynamic>())),
