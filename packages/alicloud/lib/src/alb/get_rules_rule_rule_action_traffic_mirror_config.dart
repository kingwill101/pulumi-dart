...
class GetRulesRuleRuleActionTrafficMirrorConfig {
  ...
  final List<GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig> mirrorGroupConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mirrorGroupConfigs': pulumi.Input.encodeList<GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig, Map<String, dynamic>>(mirrorGroupConfigs, (value) => value.toMap()),
  ...
  factory GetRulesRuleRuleActionTrafficMirrorConfig.fromMap(Map<String, dynamic> map) {
    return GetRulesRuleRuleActionTrafficMirrorConfig(
      mirrorGroupConfigs: pulumi.Input.decodeList<GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig>(map['mirrorGroupConfigs'], (value) => GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig.fromMap((value as Map).cast<String, dynamic>())),
