...
class RuleArgs {
  ...
  RuleArgs({
    ...
    required List<RuleRuleAction> ruleActions,
    required List<RuleRuleCondition> ruleConditions,
  ...
  factory RuleArgs.fromMap(Map<String, dynamic> map) {
    return RuleArgs(
      ...
      ruleActions: pulumi.Input.decodeList<RuleRuleAction>(map['ruleActions'], (value) => RuleRuleAction.fromMap((value as Map).cast<String, dynamic>())),
      ruleConditions: pulumi.Input.decodeList<RuleRuleCondition>(map['ruleConditions'], (value) => RuleRuleCondition.fromMap((value as Map).cast<String, dynamic>())),
