...
class ListenerAclConfig {
  ...
  final List<ListenerAclConfigAclRelation>? aclRelations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aclRelations': ?aclRelations == null ? null : pulumi.Input.encodeList<ListenerAclConfigAclRelation, Map<String, dynamic>>(aclRelations!, (value) => value.toMap()),
      'aclType': ?aclType,
    };
  }
  ...
  factory ListenerAclConfig.fromMap(Map<String, dynamic> map) {
    return ListenerAclConfig(
      aclRelations: map['aclRelations'] == null ? null : pulumi.Input.decodeList<ListenerAclConfigAclRelation>(map['aclRelations'], (value) => ListenerAclConfigAclRelation.fromMap((value as Map).cast<String, dynamic>())),
