...
class ListenerArgs {
  ...
  ListenerArgs({
    ...
    ListenerAccessLogTracingConfig? accessLogTracingConfig,
    ListenerAclConfig? aclConfig,
    List<ListenerCaCertificate>? caCertificates,
    bool? caEnabled,
    ListenerCertificates? certificates,
    ...
    ListenerQuicConfig? quicConfig,
    int? requestTimeout,
    String? securityPolicyId,
    String? status,
    Map<String, String>? tags,
    ListenerXForwardedForConfig? xForwardedForConfig,
  }) :
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      accessLogRecordCustomizedHeadersEnabled: map['accessLogRecordCustomizedHeadersEnabled'] == null ? null : map['accessLogRecordCustomizedHeadersEnabled'] as bool,
      accessLogTracingConfig: map['accessLogTracingConfig'] == null ? null : ListenerAccessLogTracingConfig.fromMap((map['accessLogTracingConfig'] as Map).cast<String, dynamic>()),
      aclConfig: map['aclConfig'] == null ? null : ListenerAclConfig.fromMap((map['aclConfig'] as Map).cast<String, dynamic>()),
      caCertificates: map['caCertificates'] == null ? null : pulumi.Input.decodeList<ListenerCaCertificate>(map['caCertificates'], (value) => ListenerCaCertificate.fromMap((value as Map).cast<String, dynamic>())),
      caEnabled: map['caEnabled'] == null ? null : map['caEnabled'] as bool,
      certificates: map['certificates'] == null ? null : ListenerCertificates.fromMap((map['certificates'] as Map).cast<String, dynamic>()),
      ...
      gzipEnabled: map['gzipEnabled'] == null ? null : map['gzipEnabled'] as bool,
      ...
      quicConfig: map['quicConfig'] == null ? null : ListenerQuicConfig.fromMap((map['quicConfig'] as Map).cast<String, dynamic>()),
      ...
      xForwardedForConfig: map['xForwardedForConfig'] == null ? null : ListenerXForwardedForConfig.fromMap((map['xForwardedForConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
