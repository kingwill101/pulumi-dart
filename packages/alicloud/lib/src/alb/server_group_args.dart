...
class ServerGroupArgs {
  ...
  ServerGroupArgs({
    ServerGroupConnectionDrainConfig? connectionDrainConfig,
    bool? crossZoneEnabled,
    bool? dryRun,
    required ServerGroupHealthCheckConfig healthCheckConfig,
    ...
    List<ServerGroupServer>? servers,
    String? serviceName,
    ServerGroupSlowStartConfig? slowStartConfig,
    ServerGroupStickySessionConfig? stickySessionConfig,
    Map<String, String>? tags,
    ServerGroupUchConfig? uchConfig,
  ...
  factory ServerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ServerGroupArgs(
      connectionDrainConfig: map['connectionDrainConfig'] == null ? null : ServerGroupConnectionDrainConfig.fromMap((map['connectionDrainConfig'] as Map).cast<String, dynamic>()),
      ...
      healthCheckConfig: ServerGroupHealthCheckConfig.fromMap((map['healthCheckConfig'] as Map).cast<String, dynamic>()),
      healthCheckTemplateId: map['healthCheckTemplateId'] == null ? null : map['healthCheckTemplateId'] as String,
      ...
      servers: map['servers'] == null ? null : pulumi.Input.decodeList<ServerGroupServer>(map['servers'], (value) => ServerGroupServer.fromMap((value as Map).cast<String, dynamic>())),
      serviceName: map['serviceName'] == null ? null : map['serviceName'] as String,
      slowStartConfig: map['slowStartConfig'] == null ? null : ServerGroupSlowStartConfig.fromMap((map['slowStartConfig'] as Map).cast<String, dynamic>()),
      stickySessionConfig: map['stickySessionConfig'] == null ? null : ServerGroupStickySessionConfig.fromMap((map['stickySessionConfig'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      uchConfig: map['uchConfig'] == null ? null : ServerGroupUchConfig.fromMap((map['uchConfig'] as Map).cast<String, dynamic>()),
      upstreamKeepaliveEnabled: map['upstreamKeepaliveEnabled'] == null ? null : map['upstreamKeepaliveEnabled'] as bool,
