...
class HealthCheckTemplateArgs {
  ...
  HealthCheckTemplateArgs({
    ...
    required String healthCheckTemplateName,
  ...
  factory HealthCheckTemplateArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckTemplateArgs(
      ...
      healthCheckCodes: map['healthCheckCodes'] == null ? null : (map['healthCheckCodes'] as List).cast<String>(),
      ...
      healthCheckHttpVersion: map['healthCheckHttpVersion'] == null ? null : map['healthCheckHttpVersion'] as String,
