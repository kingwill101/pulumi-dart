...
class SecurityPreferenceArgs {
  ...
  SecurityPreferenceArgs({
    ...
    bool? allowUserToLoginWithPasskey,
    ...
    int? maxIdleDaysForAccessKeys,
    int? maxIdleDaysForUsers,
    String? mfaOperationForLogin,
  ...
  factory SecurityPreferenceArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPreferenceArgs(
      allowUserToChangePassword: map['allowUserToChangePassword'] == null ? null : map['allowUserToChangePassword'] as bool,
      allowUserToLoginWithPasskey: map['allowUserToLoginWithPasskey'] == null ? null : map['allowUserToLoginWithPasskey'] as bool,
      allowUserToManageAccessKeys: map['allowUserToManageAccessKeys'] == null ? null : map['allowUserToManageAccessKeys'] as bool,
      allowUserToManageMfaDevices: map['allowUserToManageMfaDevices'] == null ? null : map['allowUserToManageMfaDevices'] as bool,
      allowUserToManagePersonalDingTalk: map['allowUserToManagePersonalDingTalk'] == null ? null : map['allowUserToManagePersonalDingTalk'] as bool,
      enableSaveMfaTicket: map['enableSaveMfaTicket'] == null ? null : map['enableSaveMfaTicket'] as bool,
      enforceMfaForLogin: map['enforceMfaForLogin'] == null ? null : map['enforceMfaForLogin'] as bool,
      loginNetworkMasks: map['loginNetworkMasks'] == null ? null : map['loginNetworkMasks'] as String,
      loginSessionDuration: map['loginSessionDuration'] == null ? null : map['loginSessionDuration'] as int,
      maxIdleDaysForAccessKeys: map['maxIdleDaysForAccessKeys'] == null ? null : map['maxIdleDaysForAccessKeys'] as int,
      maxIdleDaysForUsers: map['maxIdleDaysForUsers'] == null ? null : map['maxIdleDaysForUsers'] as int,
      mfaOperationForLogin: map['mfaOperationForLogin'] == null ? null : map['mfaOperationForLogin'] as String,
      operationForRiskLogin: map['operationForRiskLogin'] == null ? null : map['operationForRiskLogin'] as String,
      verificationTypes: map['verificationTypes'] == null ? null : (map['verificationTypes'] as List).cast<String>(),
    );
  }
}
