...
class RoleArgs {
  ...
  factory RoleArgs.fromMap(Map<String, dynamic> map) {
    return RoleArgs(
      assumeRolePolicyDocument: map['assumeRolePolicyDocument'] == null ? null : map['assumeRolePolicyDocument'] as String,
      ...
      ramUsers: map['ramUsers'] == null ? null : (map['ramUsers'] as List).cast<String>(),
