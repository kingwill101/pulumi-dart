...
class LoginProfileArgs {
  ...
  factory LoginProfileArgs.fromMap(Map<String, dynamic> map) {
    return LoginProfileArgs(
      mfaBindRequired: map['mfaBindRequired'] == null ? null : map['mfaBindRequired'] as bool,
      password: map['password'] as String,
      passwordResetRequired: map['passwordResetRequired'] == null ? null : map['passwordResetRequired'] as bool,
