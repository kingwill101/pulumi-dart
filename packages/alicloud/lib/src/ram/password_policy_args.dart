...
/// {@template pulumi_ram_password_policy_password_policy_args_doc}
/// The set of arguments for PasswordPolicy.
/// {@endtemplate}
/// {@macro pulumi_ram_password_policy_password_policy_args_doc}
class PasswordPolicyArgs {
  ...
  /// Creates a new [PasswordPolicyArgs].
  ...
  factory PasswordPolicyArgs.fromMap(Map<String, dynamic> map) {
    return PasswordPolicyArgs(
      ...
      maxLoginAttemps: map['maxLoginAttemps'] == null ? null : map['maxLoginAttemps'] as int,
      maxPasswordAge: map['maxPasswordAge'] == null ? null : map['maxPasswordAge'] as int,
      minimumPasswordDifferentCharacter: map['minimumPasswordDifferentCharacter'] == null ? null : map['minimumPasswordDifferentCharacter'] as int,
