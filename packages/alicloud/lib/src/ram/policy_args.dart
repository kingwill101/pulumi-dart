...
class PolicyArgs {
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      ...
      rotateStrategy: map['rotateStrategy'] == null ? null : map['rotateStrategy'] as String,
      statements: map['statements'] == null ? null : pulumi.Input.decodeList<PolicyStatement>(map['statements'], (value) => PolicyStatement.fromMap((value as Map).cast<String, dynamic>())),
