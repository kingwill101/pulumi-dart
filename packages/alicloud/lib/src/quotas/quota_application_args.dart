...
class QuotaApplicationArgs {
  ...
  QuotaApplicationArgs({
    ...
    List<QuotaApplicationDimension>? dimensions,
  ...
  factory QuotaApplicationArgs.fromMap(Map<String, dynamic> map) {
    return QuotaApplicationArgs(
      ...
      dimensions: map['dimensions'] == null ? null : pulumi.Input.decodeList<QuotaApplicationDimension>(map['dimensions'], (value) => QuotaApplicationDimension.fromMap((value as Map).cast<String, dynamic>())),
