...
class SmartagFlowLogArgs {
  ...
  factory SmartagFlowLogArgs.fromMap(Map<String, dynamic> map) {
    return SmartagFlowLogArgs(
      activeAging: map['activeAging'] == null ? null : map['activeAging'] as int,
      description: map['description'] == null ? null : map['description'] as String,
      flowLogName: map['flowLogName'] == null ? null : map['flowLogName'] as String,
      inactiveAging: map['inactiveAging'] == null ? null : map['inactiveAging'] as int,
      logstoreName: map['logstoreName'] == null ? null : map['logstoreName'] as String,
      netflowServerIp: map['netflowServerIp'] == null ? null : map['netflowServerIp'] as String,
      netflowServerPort: map['netflowServerPort'] == null ? null : map['netflowServerPort'] as int,
      netflowVersion: map['netflowVersion'] == null ? null : map['netflowVersion'] as String,
      outputType: map['outputType'] as String,
      projectName: map['projectName'] == null ? null : map['projectName'] as String,
      slsRegionId: map['slsRegionId'] == null ? null : map['slsRegionId'] as String,
