...
class TransitRouterCidrArgs {
  ...
  factory TransitRouterCidrArgs.fromMap(Map<String, dynamic> map) {
    return TransitRouterCidrArgs(
      ...
      publishCidrRoute: map['publishCidrRoute'] == null ? null : map['publishCidrRoute'] as bool,
      transitRouterCidrName: map['transitRouterCidrName'] == null ? null : map['transitRouterCidrName'] as String,
