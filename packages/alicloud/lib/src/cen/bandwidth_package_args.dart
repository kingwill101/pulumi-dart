...
class BandwidthPackageArgs {
  ...
  BandwidthPackageArgs({
    ...
    List<String>? geographicRegionIds,
    String? name,
    String? paymentType,
    int? period,
  }) :
  ...
  factory BandwidthPackageArgs.fromMap(Map<String, dynamic> map) {
    return BandwidthPackageArgs(
      ...
      cenBandwidthPackageName: map['cenBandwidthPackageName'] == null ? null : map['cenBandwidthPackageName'] as String,
      chargeType: map['chargeType'] == null ? null : map['chargeType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      geographicRegionAId: map['geographicRegionAId'] == null ? null : map['geographicRegionAId'] as String,
      geographicRegionBId: map['geographicRegionBId'] == null ? null : map['geographicRegionBId'] as String,
      geographicRegionIds: map['geographicRegionIds'] == null ? null : (map['geographicRegionIds'] as List).cast<String>(),
