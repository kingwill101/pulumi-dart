...
class TransitRouteTableAggregationArgs {
  ...
  TransitRouteTableAggregationArgs({
    required String transitRouteTableAggregationCidr,
    ...
    List<String>? transitRouteTableAggregationScopeLists,
    required String transitRouteTableId,
  }) :
  ...
  factory TransitRouteTableAggregationArgs.fromMap(Map<String, dynamic> map) {
    return TransitRouteTableAggregationArgs(
      ...
      transitRouteTableAggregationDescription: map['transitRouteTableAggregationDescription'] == null ? null : map['transitRouteTableAggregationDescription'] as String,
      transitRouteTableAggregationName: map['transitRouteTableAggregationName'] == null ? null : map['transitRouteTableAggregationName'] as String,
      transitRouteTableAggregationScope: map['transitRouteTableAggregationScope'] == null ? null : map['transitRouteTableAggregationScope'] as String,
      transitRouteTableAggregationScopeLists: map['transitRouteTableAggregationScopeLists'] == null ? null : (map['transitRouteTableAggregationScopeLists'] as List).cast<String>(),
