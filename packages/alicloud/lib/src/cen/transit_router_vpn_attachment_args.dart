...
class TransitRouterVpnAttachmentArgs {
  ...
  TransitRouterVpnAttachmentArgs({
    ...
    required String vpnId,
    String? vpnOwnerId,
    List<TransitRouterVpnAttachmentZone>? zones,
  }) :
      ...
      vpnId = pulumi.Input.asInput<String>(vpnId),
  ...
  factory TransitRouterVpnAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return TransitRouterVpnAttachmentArgs(
      ...
      vpnOwnerId: map['vpnOwnerId'] == null ? null : map['vpnOwnerId'] as String,
      zones: map['zones'] == null ? null : pulumi.Input.decodeList<TransitRouterVpnAttachmentZone>(map['zones'], (value) => TransitRouterVpnAttachmentZone.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
