...
class RouteMapArgs {
  ...
  RouteMapArgs({
    ...
    required String cenRegionId,
    String? cidrMatchMode,
    String? communityMatchMode,
    String? communityOperateMode,
    String? description,
    List<String>? destinationChildInstanceTypes,
    List<String>? destinationCidrBlocks,
    List<String>? destinationInstanceIds,
    bool? destinationInstanceIdsReverseMatch,
    List<String>? destinationRouteTableIds,
    required String mapResult,
    List<String>? matchAsns,
    List<String>? matchCommunitySets,
    int? nextPriority,
    List<String>? operateCommunitySets,
    int? preference,
    List<String>? prependAsPaths,
    required int priority,
    List<String>? routeTypes,
    List<String>? sourceChildInstanceTypes,
    List<String>? sourceInstanceIds,
    bool? sourceInstanceIdsReverseMatch,
    List<String>? sourceRegionIds,
    List<String>? sourceRouteTableIds,
    String? transitRouterRouteTableId,
    required String transmitDirection,
  }) :
  ...
  factory RouteMapArgs.fromMap(Map<String, dynamic> map) {
    return RouteMapArgs(
      asPathMatchMode: map['asPathMatchMode'] == null ? null : map['asPathMatchMode'] as String,
      cenId: map['cenId'] as String,
      cenRegionId: map['cenRegionId'] as String,
      cidrMatchMode: map['cidrMatchMode'] == null ? null : map['cidrMatchMode'] as String,
      communityMatchMode: map['communityMatchMode'] == null ? null : map['communityMatchMode'] as String,
      communityOperateMode: map['communityOperateMode'] == null ? null : map['communityOperateMode'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      destinationChildInstanceTypes: map['destinationChildInstanceTypes'] == null ? null : (map['destinationChildInstanceTypes'] as List).cast<String>(),
      destinationCidrBlocks: map['destinationCidrBlocks'] == null ? null : (map['destinationCidrBlocks'] as List).cast<String>(),
      destinationInstanceIds: map['destinationInstanceIds'] == null ? null : (map['destinationInstanceIds'] as List).cast<String>(),
      destinationInstanceIdsReverseMatch: map['destinationInstanceIdsReverseMatch'] == null ? null : map['destinationInstanceIdsReverseMatch'] as bool,
      destinationRouteTableIds: map['destinationRouteTableIds'] == null ? null : (map['destinationRouteTableIds'] as List).cast<String>(),
      mapResult: map['mapResult'] as String,
      matchAsns: map['matchAsns'] == null ? null : (map['matchAsns'] as List).cast<String>(),
      matchCommunitySets: map['matchCommunitySets'] == null ? null : (map['matchCommunitySets'] as List).cast<String>(),
      nextPriority: map['nextPriority'] == null ? null : map['nextPriority'] as int,
      operateCommunitySets: map['operateCommunitySets'] == null ? null : (map['operateCommunitySets'] as List).cast<String>(),
      preference: map['preference'] == null ? null : map['preference'] as int,
      prependAsPaths: map['prependAsPaths'] == null ? null : (map['prependAsPaths'] as List).cast<String>(),
      priority: map['priority'] as int,
      routeTypes: map['routeTypes'] == null ? null : (map['routeTypes'] as List).cast<String>(),
      sourceChildInstanceTypes: map['sourceChildInstanceTypes'] == null ? null : (map['sourceChildInstanceTypes'] as List).cast<String>(),
      sourceInstanceIds: map['sourceInstanceIds'] == null ? null : (map['sourceInstanceIds'] as List).cast<String>(),
      sourceInstanceIdsReverseMatch: map['sourceInstanceIdsReverseMatch'] == null ? null : map['sourceInstanceIdsReverseMatch'] as bool,
      sourceRegionIds: map['sourceRegionIds'] == null ? null : (map['sourceRegionIds'] as List).cast<String>(),
      sourceRouteTableIds: map['sourceRouteTableIds'] == null ? null : (map['sourceRouteTableIds'] as List).cast<String>(),
