...
class TransitRouterRouteTableArgs {
  ...
  factory TransitRouterRouteTableArgs.fromMap(Map<String, dynamic> map) {
    return TransitRouterRouteTableArgs(
      ...
      transitRouterRouteTableDescription: map['transitRouterRouteTableDescription'] == null ? null : map['transitRouterRouteTableDescription'] as String,
      transitRouterRouteTableName: map['transitRouterRouteTableName'] == null ? null : map['transitRouterRouteTableName'] as String,
    );
  }
}
