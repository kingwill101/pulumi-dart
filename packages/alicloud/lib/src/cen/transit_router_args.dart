...
class TransitRouterArgs {
  ...
  factory TransitRouterArgs.fromMap(Map<String, dynamic> map) {
    return TransitRouterArgs(
      ...
      transitRouterDescription: map['transitRouterDescription'] == null ? null : map['transitRouterDescription'] as String,
      transitRouterName: map['transitRouterName'] == null ? null : map['transitRouterName'] as String,
    );
  }
}
