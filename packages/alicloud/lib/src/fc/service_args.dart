...
class ServiceArgs {
  ...
  ServiceArgs({
    String? description,
    bool? internetAccess,
    ServiceLogConfig? logConfig,
    String? name,
    String? namePrefix,
    ServiceNasConfig? nasConfig,
    bool? publish,
    String? role,
    Map<String, String>? tags,
    ServiceTracingConfig? tracingConfig,
    ServiceVpcConfig? vpcConfig,
  }) :
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      logConfig: map['logConfig'] == null ? null : ServiceLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      namePrefix: map['namePrefix'] == null ? null : map['namePrefix'] as String,
      nasConfig: map['nasConfig'] == null ? null : ServiceNasConfig.fromMap((map['nasConfig'] as Map).cast<String, dynamic>()),
      publish: map['publish'] == null ? null : map['publish'] as bool,
      role: map['role'] == null ? null : map['role'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tracingConfig: map['tracingConfig'] == null ? null : ServiceTracingConfig.fromMap((map['tracingConfig'] as Map).cast<String, dynamic>()),
      vpcConfig: map['vpcConfig'] == null ? null : ServiceVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
