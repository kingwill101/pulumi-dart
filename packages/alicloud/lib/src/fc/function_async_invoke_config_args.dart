...
class FunctionAsyncInvokeConfigArgs {
  ...
  FunctionAsyncInvokeConfigArgs({
    FunctionAsyncInvokeConfigDestinationConfig? destinationConfig,
    required String functionName,
    int? maximumEventAgeInSeconds,
    int? maximumRetryAttempts,
    String? qualifier,
    required String serviceName,
    bool? statefulInvocation,
  }) :
  ...
  factory FunctionAsyncInvokeConfigArgs.fromMap(Map<String, dynamic> map) {
    return FunctionAsyncInvokeConfigArgs(
      destinationConfig: map['destinationConfig'] == null ? null : FunctionAsyncInvokeConfigDestinationConfig.fromMap((map['destinationConfig'] as Map).cast<String, dynamic>()),
      ...
      statefulInvocation: map['statefulInvocation'] == null ? null : map['statefulInvocation'] as bool,
    );
  }
}
