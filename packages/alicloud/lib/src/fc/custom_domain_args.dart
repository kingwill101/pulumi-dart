...
class CustomDomainArgs {
  ...
  CustomDomainArgs({
    CustomDomainCertConfig? certConfig,
    required String domainName,
    required String protocol,
    List<CustomDomainRouteConfig>? routeConfigs,
  }) :
  ...
  factory CustomDomainArgs.fromMap(Map<String, dynamic> map) {
    return CustomDomainArgs(
      certConfig: map['certConfig'] == null ? null : CustomDomainCertConfig.fromMap((map['certConfig'] as Map).cast<String, dynamic>()),
      domainName: map['domainName'] as String,
      protocol: map['protocol'] as String,
      routeConfigs: map['routeConfigs'] == null ? null : pulumi.Input.decodeList<CustomDomainRouteConfig>(map['routeConfigs'], (value) => CustomDomainRouteConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
