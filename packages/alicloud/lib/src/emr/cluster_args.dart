...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    String? depositType,
    bool? easEnable,
    required String emrVer,
    bool? highAvailabilityEnable,
    List<ClusterHostGroup>? hostGroups,
    bool? isOpenPublicIp,
    String? keyPairName,
    String? masterPwd,
    ClusterMetaStoreConf? metaStoreConf,
    String? metaStoreType,
    ClusterModifyClusterServiceConfig? modifyClusterServiceConfig,
    String? name,
    List<String>? optionSoftwareLists,
    int? period,
    ...
    required String zoneId,
      ...
      emrVer = pulumi.Input.asInput<String>(emrVer),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      configs: map['configs'] == null ? null : pulumi.Input.decodeList<ClusterConfig>(map['configs'], (value) => ClusterConfig.fromMap((value as Map).cast<String, dynamic>())),
      depositType: map['depositType'] == null ? null : map['depositType'] as String,
      easEnable: map['easEnable'] == null ? null : map['easEnable'] as bool,
      emrVer: map['emrVer'] as String,
      highAvailabilityEnable: map['highAvailabilityEnable'] == null ? null : map['highAvailabilityEnable'] as bool,
      hostGroups: map['hostGroups'] == null ? null : pulumi.Input.decodeList<ClusterHostGroup>(map['hostGroups'], (value) => ClusterHostGroup.fromMap((value as Map).cast<String, dynamic>())),
      isOpenPublicIp: map['isOpenPublicIp'] == null ? null : map['isOpenPublicIp'] as bool,
      keyPairName: map['keyPairName'] == null ? null : map['keyPairName'] as String,
      masterPwd: map['masterPwd'] == null ? null : map['masterPwd'] as String,
      metaStoreConf: map['metaStoreConf'] == null ? null : ClusterMetaStoreConf.fromMap((map['metaStoreConf'] as Map).cast<String, dynamic>()),
      metaStoreType: map['metaStoreType'] == null ? null : map['metaStoreType'] as String,
      modifyClusterServiceConfig: map['modifyClusterServiceConfig'] == null ? null : ClusterModifyClusterServiceConfig.fromMap((map['modifyClusterServiceConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      optionSoftwareLists: map['optionSoftwareLists'] == null ? null : (map['optionSoftwareLists'] as List).cast<String>(),
      period: map['period'] == null ? null : map['period'] as int,
      relatedClusterId: map['relatedClusterId'] == null ? null : map['relatedClusterId'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      securityGroupId: map['securityGroupId'] == null ? null : map['securityGroupId'] as String,
      sshEnable: map['sshEnable'] == null ? null : map['sshEnable'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      useLocalMetadb: map['useLocalMetadb'] == null ? null : map['useLocalMetadb'] as bool,
      userDefinedEmrEcsRole: map['userDefinedEmrEcsRole'] == null ? null : map['userDefinedEmrEcsRole'] as String,
