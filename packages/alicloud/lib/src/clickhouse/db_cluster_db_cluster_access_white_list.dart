...
class DbClusterDbClusterAccessWhiteList {
  ...
  final String? dbClusterIpArrayAttribute;
  /// Whitelist group name.
  final String? dbClusterIpArrayName;
  ...
  factory DbClusterDbClusterAccessWhiteList.fromMap(Map<String, dynamic> map) {
    return DbClusterDbClusterAccessWhiteList(
      dbClusterIpArrayAttribute: map['dbClusterIpArrayAttribute'] == null ? null : map['dbClusterIpArrayAttribute'] as String,
      dbClusterIpArrayName: map['dbClusterIpArrayName'] == null ? null : map['dbClusterIpArrayName'] as String,
