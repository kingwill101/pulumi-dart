...
class PolicyArgs {
  ...
  PolicyArgs({
    ...
    String? clipboard,
    String? lockResolution,
    PolicyNetRedirectPolicy? netRedirectPolicy,
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      ...
      lockResolution: map['lockResolution'] == null ? null : map['lockResolution'] as String,
      netRedirectPolicy: map['netRedirectPolicy'] == null ? null : PolicyNetRedirectPolicy.fromMap((map['netRedirectPolicy'] as Map).cast<String, dynamic>()),
      policyGroupName: map['policyGroupName'] == null ? null : map['policyGroupName'] as String,
      resolutionHeight: map['resolutionHeight'] == null ? null : map['resolutionHeight'] as int,
      resolutionWidth: map['resolutionWidth'] == null ? null : map['resolutionWidth'] as int,
    );
  }
}
