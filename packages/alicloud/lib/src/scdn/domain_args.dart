...
class DomainArgs {
  ...
  DomainArgs({
    String? bizName,
    List<DomainCertInfo>? certInfos,
    String? checkUrl,
    required String domainName,
    String? forceSet,
    String? resourceGroupId,
    required List<DomainSource> sources,
    String? status,
  }) :
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      certInfos: map['certInfos'] == null ? null : pulumi.Input.decodeList<DomainCertInfo>(map['certInfos'], (value) => DomainCertInfo.fromMap((value as Map).cast<String, dynamic>())),
      checkUrl: map['checkUrl'] == null ? null : map['checkUrl'] as String,
      domainName: map['domainName'] as String,
      forceSet: map['forceSet'] == null ? null : map['forceSet'] as String,
      resourceGroupId: map['resourceGroupId'] == null ? null : map['resourceGroupId'] as String,
      sources: pulumi.Input.decodeList<DomainSource>(map['sources'], (value) => DomainSource.fromMap((value as Map).cast<String, dynamic>())),
