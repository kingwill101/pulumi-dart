...
class ServiceState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'queryKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceQueryKey>,
            List<Map<String, dynamic>>
          >(
            queryKeys,
            (value) =>
                pulumi.Input.encodeList<ServiceQueryKey, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      customerManagedKeyEncryptionComplianceStatus: (() {
        final guardedValue =
            map['customerManagedKeyEncryptionComplianceStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customerManagedKeyEnforcementEnabled: (() {
      ...
      queryKeys: (() {
        final guardedValue = map['queryKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceQueryKey>(
            guardedValue,
            (value) =>
                ServiceQueryKey.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      replicaCount: (() {
