...
class ServiceState {
  ...
  /// [allowedIps] Specifies a list of inbound IPv4 or CIDRs that are allowed to access the Search Service. If the incoming IP request is from an IP address which is not included in the `allowedIps` it will be blocked by the Search Services firewall.
  ...
  /// [sku] The SKU which should be used for this Search Service. Possible values include `basic`, `free`, `standard`, `standard2`, `standard3`, `storageOptimizedL1` and `storageOptimizedL2`.
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      authenticationFailureMode: (() { final guardedValue = map['authenticationFailureMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      customerManagedKeyEncryptionComplianceStatus: (() { final guardedValue = map['customerManagedKeyEncryptionComplianceStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      customerManagedKeyEnforcementEnabled: (() { final guardedValue = map['customerManagedKeyEnforcementEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      endpoint: (() { final guardedValue = map['endpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      hostingMode: (() { final guardedValue = map['hostingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      queryKeys: (() { final guardedValue = map['queryKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceQueryKey>(guardedValue, (value) => ServiceQueryKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      semanticSearchSku: (() { final guardedValue = map['semanticSearchSku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
