...
class ServiceArgs {
  ...
  final pulumi.Input<ServiceAuthenticationConfiguration>?
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      accessPolicyObjectIds: (() {
        final guardedValue = map['accessPolicyObjectIds'];
      ...
      authenticationConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceAuthenticationConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      configurationExportStorageAccountName: (() {
        final guardedValue = map['configurationExportStorageAccountName'];
        if (guardedValue == null) return null;
      ...
      corsConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceCorsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      cosmosdbKeyVaultKeyVersionlessId: (() {
        final guardedValue = map['cosmosdbKeyVaultKeyVersionlessId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cosmosdbThroughput: (() {
        final guardedValue = map['cosmosdbThroughput'];
        if (guardedValue == null) return null;
