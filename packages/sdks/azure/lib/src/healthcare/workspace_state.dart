...
class WorkspaceState {
  ...
  factory WorkspaceState.fromMap(Map<String, dynamic> map) {
    return WorkspaceState(
      ...
      privateEndpointConnections: (() { final guardedValue = map['privateEndpointConnections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkspacePrivateEndpointConnection>(guardedValue, (value) => WorkspacePrivateEndpointConnection.fromMap((value as Map).cast<String, dynamic>()))); })(),
