...
class FhirServiceState {
  ...
  factory FhirServiceState.fromMap(Map<String, dynamic> map) {
    return FhirServiceState(
      ...
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FhirServiceAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
