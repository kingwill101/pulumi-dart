...
class DicomServiceState {
  ...
  factory DicomServiceState.fromMap(Map<String, dynamic> map) {
    return DicomServiceState(
      authentications: (() { final guardedValue = map['authentications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DicomServiceAuthentication>(guardedValue, (value) => DicomServiceAuthentication.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      privateEndpoints: (() { final guardedValue = map['privateEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DicomServicePrivateEndpoint>(guardedValue, (value) => DicomServicePrivateEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
