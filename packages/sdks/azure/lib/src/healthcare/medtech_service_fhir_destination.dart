...
class MedtechServiceFhirDestination extends pulumi.CustomResource {
  ...
  MedtechServiceFhirDestination(
    ...
    this.destinationFhirMappingJson = registerOutput<String>('destinationFhirMappingJson');
    this.destinationFhirServiceId = registerOutput<String>('destinationFhirServiceId');
    this.destinationIdentityResolutionType = registerOutput<String>('destinationIdentityResolutionType');
    this.location = registerOutput<String>('location');
    this.medtechServiceId = registerOutput<String>('medtechServiceId');
