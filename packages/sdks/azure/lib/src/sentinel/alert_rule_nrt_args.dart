...
class AlertRuleNrtArgs {
  ...
  factory AlertRuleNrtArgs.fromMap(Map<String, dynamic> map) {
    return AlertRuleNrtArgs(
      alertDetailsOverrides: map['alertDetailsOverrides'] == null ? null : (pulumi.Input.decodeList<AlertRuleNrtAlertDetailsOverride>(map['alertDetailsOverrides']!, (value) => AlertRuleNrtAlertDetailsOverride.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      entityMappings: map['entityMappings'] == null ? null : (pulumi.Input.decodeList<AlertRuleNrtEntityMapping>(map['entityMappings']!, (value) => AlertRuleNrtEntityMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
      eventGrouping: (AlertRuleNrtEventGrouping.fromMap((map['eventGrouping'] as Map).cast<String, dynamic>())).input(),
      incident: map['incident'] == null ? null : (AlertRuleNrtIncident.fromMap((map['incident']! as Map).cast<String, dynamic>())).input(),
      logAnalyticsWorkspaceId: (map['logAnalyticsWorkspaceId'] as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      query: (map['query'] as String).input(),
      sentinelEntityMappings: map['sentinelEntityMappings'] == null ? null : (pulumi.Input.decodeList<AlertRuleNrtSentinelEntityMapping>(map['sentinelEntityMappings']!, (value) => AlertRuleNrtSentinelEntityMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
