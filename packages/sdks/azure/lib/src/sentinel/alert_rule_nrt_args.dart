...
class AlertRuleNrtArgs {
  ...
  AlertRuleNrtArgs({
    ...
    required pulumi.Output<AlertRuleNrtEventGrouping> eventGrouping,
  ...
  factory AlertRuleNrtArgs.fromMap(Map<String, dynamic> map) {
    return AlertRuleNrtArgs(
      ...
      eventGrouping: pulumi.Output.create<AlertRuleNrtEventGrouping>(AlertRuleNrtEventGrouping.fromMap((map['eventGrouping'] as Map).cast<String, dynamic>())),
