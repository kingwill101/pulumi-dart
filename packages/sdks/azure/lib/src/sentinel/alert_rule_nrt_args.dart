...
class AlertRuleNrtArgs {
  ...
  final pulumi.Input<List<AlertRuleNrtAlertDetailsOverride>>?
  ...
  final pulumi.Input<List<AlertRuleNrtSentinelEntityMapping>>?
    ...
    return <String, dynamic>{
      'alertDetailsOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertRuleNrtAlertDetailsOverride>,
      ...
      'entityMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertRuleNrtEntityMapping>,
            List<Map<String, dynamic>>
          >(
            entityMappings,
            (value) =>
      ...
      'sentinelEntityMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertRuleNrtSentinelEntityMapping>,
            List<Map<String, dynamic>>
          >(
            sentinelEntityMappings,
            (value) =>
    ...
    return AlertRuleNrtArgs(
      alertDetailsOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertRuleNrtAlertDetailsOverride>(
            guardedValue,
            (value) => AlertRuleNrtAlertDetailsOverride.fromMap(
      ...
      entityMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertRuleNrtEntityMapping>(
            guardedValue,
            (value) => AlertRuleNrtEntityMapping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      eventGrouping: pulumi.Input.fromValue(
        AlertRuleNrtEventGrouping.fromMap(
          (map['eventGrouping']! as Map).cast<String, dynamic>(),
        ),
      ),
      incident: (() {
      ...
      sentinelEntityMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertRuleNrtSentinelEntityMapping>(
            guardedValue,
            (value) => AlertRuleNrtSentinelEntityMapping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
