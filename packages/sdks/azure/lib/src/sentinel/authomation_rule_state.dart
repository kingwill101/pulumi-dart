...
class AuthomationRuleState {
  ...
  /// Creates a new [AuthomationRuleState].
  ...
  factory AuthomationRuleState.fromMap(Map<String, dynamic> map) {
    return AuthomationRuleState(
      actionIncidentTasks: (() { final guardedValue = map['actionIncidentTasks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthomationRuleActionIncidentTask>(guardedValue, (value) => AuthomationRuleActionIncidentTask.fromMap((value as Map).cast<String, dynamic>()))); })(),
      actionIncidents: (() { final guardedValue = map['actionIncidents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthomationRuleActionIncident>(guardedValue, (value) => AuthomationRuleActionIncident.fromMap((value as Map).cast<String, dynamic>()))); })(),
      actionPlaybooks: (() { final guardedValue = map['actionPlaybooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthomationRuleActionPlaybook>(guardedValue, (value) => AuthomationRuleActionPlaybook.fromMap((value as Map).cast<String, dynamic>()))); })(),
