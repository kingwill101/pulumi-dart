...
import 'data_connector_threat_intelligence_state.dart';
...
/// }
/// resource "azure_sentinel_dataconnectorthreatintelligence" "example" {
///   name                       = "example"
...
class DataConnectorThreatIntelligence extends pulumi.CustomResource {
  ...
  /// Gets an existing [DataConnectorThreatIntelligence] resource's state with the given [name] and [id].
  static DataConnectorThreatIntelligence get(
    String name,
    pulumi.Input<String> id, {
    DataConnectorThreatIntelligenceState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DataConnectorThreatIntelligence._get(
      name,
      state: state?.toMap(),
  ...
  DataConnectorThreatIntelligence._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [DataConnectorThreatIntelligence] resource.
  DataConnectorThreatIntelligence.reference(String urn)
    : super(
        'azure:sentinel/dataConnectorThreatIntelligence:DataConnectorThreatIntelligence',
