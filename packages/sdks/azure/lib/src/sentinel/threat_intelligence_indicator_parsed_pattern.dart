...
class ThreatIntelligenceIndicatorParsedPattern {
  ...
  final pulumi.Input<
    List<ThreatIntelligenceIndicatorParsedPatternPatternTypeValue>
  >?
  patternTypeValues;
  ...
  factory ThreatIntelligenceIndicatorParsedPattern.fromMap(
      ...
      patternTypeValues: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ThreatIntelligenceIndicatorParsedPatternPatternTypeValue.fromMap(
