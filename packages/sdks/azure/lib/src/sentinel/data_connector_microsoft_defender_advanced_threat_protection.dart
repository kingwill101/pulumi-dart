...
/// }
/// resource "azure_sentinel_dataconnectormicrosoftdefenderadvancedthreatprotection" "example" {
///   name                       = "example"
...
/// ```
class DataConnectorMicrosoftDefenderAdvancedThreatProtection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DataConnectorMicrosoftDefenderAdvancedThreatProtection] resource.
  DataConnectorMicrosoftDefenderAdvancedThreatProtection.reference(String urn)
    : super(
        'azure:sentinel/dataConnectorMicrosoftDefenderAdvancedThreatProtection:DataConnectorMicrosoftDefenderAdvancedThreatProtection',
