...
class AuthomationRule extends pulumi.CustomResource {
  ...
  /// Creates a new [AuthomationRule].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AuthomationRule]. {@macro pulumi_sentinel_authomation_rule_authomation_rule_args_doc}
