...
class AlertRuleScheduledState {
  ...
  final pulumi.Input<List<AlertRuleScheduledAlertDetailsOverride>>?
  ...
  final pulumi.Input<List<AlertRuleScheduledSentinelEntityMapping>>?
    ...
    return <String, dynamic>{
      'alertDetailsOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertRuleScheduledAlertDetailsOverride>,
      ...
      'entityMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertRuleScheduledEntityMapping>,
            List<Map<String, dynamic>>
          >(
            entityMappings,
            (value) =>
      ...
      'eventGrouping':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(eventGrouping, (value) => value.toMap()),
      'incident':
          ?pulumi.Input.mapOptionalInputValue<
            AlertRuleScheduledIncident,
            Map<String, dynamic>
          >(incident, (value) => value.toMap()),
      ...
      'sentinelEntityMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertRuleScheduledSentinelEntityMapping>,
            List<Map<String, dynamic>>
          >(
            sentinelEntityMappings,
            (value) =>
  ...
  factory AlertRuleScheduledState.fromMap(Map<String, dynamic> map) {
    return AlertRuleScheduledState(
      alertDetailsOverrides: (() {
        final guardedValue = map['alertDetailsOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertRuleScheduledAlertDetailsOverride>(
            guardedValue,
            (value) => AlertRuleScheduledAlertDetailsOverride.fromMap(
      ...
      alertRuleTemplateVersion: (() {
        final guardedValue = map['alertRuleTemplateVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customDetails: (() {
      ...
      entityMappings: (() {
        final guardedValue = map['entityMappings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertRuleScheduledEntityMapping>(
            guardedValue,
            (value) => AlertRuleScheduledEntityMapping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      eventGrouping: (() {
        final guardedValue = map['eventGrouping'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertRuleScheduledEventGrouping.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      incident: (() {
        final guardedValue = map['incident'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertRuleScheduledIncident.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      queryFrequency: (() {
        final guardedValue = map['queryFrequency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryPeriod: (() {
        final guardedValue = map['queryPeriod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sentinelEntityMappings: (() {
        final guardedValue = map['sentinelEntityMappings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertRuleScheduledSentinelEntityMapping>(
            guardedValue,
            (value) => AlertRuleScheduledSentinelEntityMapping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      suppressionDuration: (() {
        final guardedValue = map['suppressionDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      suppressionEnabled: (() {
        final guardedValue = map['suppressionEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      tactics: (() {
      ...
      triggerOperator: (() {
        final guardedValue = map['triggerOperator'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      triggerThreshold: (() {
        final guardedValue = map['triggerThreshold'];
        if (guardedValue == null) return null;
