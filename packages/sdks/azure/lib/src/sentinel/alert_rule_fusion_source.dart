...
class AlertRuleFusionSource {
  ...
  AlertRuleFusionSource({this.enabled, required this.name, this.subTypes});
    ...
    return <String, dynamic>{
      ...
      'subTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertRuleFusionSourceSubType>,
  ...
  factory AlertRuleFusionSource.fromMap(Map<String, dynamic> map) {
    return AlertRuleFusionSource(
      ...
      subTypes: (() {
        final guardedValue = map['subTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertRuleFusionSourceSubType>(
            guardedValue,
            (value) => AlertRuleFusionSourceSubType.fromMap(
