...
class AlertRuleScheduledEntityMapping {
  ...
  final List<AlertRuleScheduledEntityMappingFieldMapping> fieldMappings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fieldMappings': pulumi.Input.encodeList<AlertRuleScheduledEntityMappingFieldMapping, Map<String, dynamic>>(fieldMappings, (value) => value.toMap()),
    };
  }
  ...
  factory AlertRuleScheduledEntityMapping.fromMap(Map<String, dynamic> map) {
    return AlertRuleScheduledEntityMapping(
      ...
      fieldMappings: pulumi.Input.decodeList<AlertRuleScheduledEntityMappingFieldMapping>(map['fieldMappings'], (value) => AlertRuleScheduledEntityMappingFieldMapping.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
