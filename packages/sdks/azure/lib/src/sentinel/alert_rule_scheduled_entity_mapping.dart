...
class AlertRuleScheduledEntityMapping {
  ...
  final pulumi.Input<List<AlertRuleScheduledEntityMappingFieldMapping>>
  fieldMappings;
    ...
    return <String, dynamic>{
      ...
      'fieldMappings':
          pulumi.Input.mapInputValue<
            List<AlertRuleScheduledEntityMappingFieldMapping>,
  ...
  factory AlertRuleScheduledEntityMapping.fromMap(Map<String, dynamic> map) {
    return AlertRuleScheduledEntityMapping(
      ...
      fieldMappings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AlertRuleScheduledEntityMappingFieldMapping>(
          map['fieldMappings']!,
          (value) => AlertRuleScheduledEntityMappingFieldMapping.fromMap(
