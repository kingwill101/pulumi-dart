...
class AlertRuleScheduledEntityMapping {
  ...
  factory AlertRuleScheduledEntityMapping.fromMap(Map<String, dynamic> map) {
    return AlertRuleScheduledEntityMapping(
      ...
      fieldMappings: (pulumi.Input.decodeList<AlertRuleScheduledEntityMappingFieldMapping>(map['fieldMappings'], (value) => AlertRuleScheduledEntityMappingFieldMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
