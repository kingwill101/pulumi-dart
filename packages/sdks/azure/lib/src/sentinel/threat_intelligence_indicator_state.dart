...
class ThreatIntelligenceIndicatorState {
  ...
  final pulumi.Input<List<ThreatIntelligenceIndicatorExternalReference>>?
  externalReferences;

  /// One or more `granular_marking` blocks as defined below.
  final pulumi.Input<List<ThreatIntelligenceIndicatorGranularMarking>>?
  granularMarkings;
  ...
  final pulumi.Input<List<ThreatIntelligenceIndicatorKillChainPhase>>?
  killChainPhases;
  ...
  final pulumi.Input<List<ThreatIntelligenceIndicatorParsedPattern>>?
  parsedPatterns;
    ...
    return <String, dynamic>{
      ...
      'externalReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<ThreatIntelligenceIndicatorExternalReference>,
      ...
      'granularMarkings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ThreatIntelligenceIndicatorGranularMarking>,
            List<Map<String, dynamic>>
          >(
            granularMarkings,
            (value) =>
      ...
      'killChainPhases':
          ?pulumi.Input.mapOptionalInputValue<
            List<ThreatIntelligenceIndicatorKillChainPhase>,
            List<Map<String, dynamic>>
          >(
            killChainPhases,
            (value) =>
      ...
      'parsedPatterns':
          ?pulumi.Input.mapOptionalInputValue<
            List<ThreatIntelligenceIndicatorParsedPattern>,
            List<Map<String, dynamic>>
          >(
            parsedPatterns,
            (value) =>
    ...
    return ThreatIntelligenceIndicatorState(
      ...
      externalReferences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ThreatIntelligenceIndicatorExternalReference>(
            guardedValue,
            (value) => ThreatIntelligenceIndicatorExternalReference.fromMap(
      ...
      granularMarkings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ThreatIntelligenceIndicatorGranularMarking>(
            guardedValue,
            (value) => ThreatIntelligenceIndicatorGranularMarking.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      killChainPhases: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ThreatIntelligenceIndicatorKillChainPhase>(
            guardedValue,
            (value) => ThreatIntelligenceIndicatorKillChainPhase.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      parsedPatterns: (() {
        final guardedValue = map['parsedPatterns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ThreatIntelligenceIndicatorParsedPattern>(
            guardedValue,
            (value) => ThreatIntelligenceIndicatorParsedPattern.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      validateFromUtc: (() {
        final guardedValue = map['validateFromUtc'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      validateUntilUtc: (() {
        final guardedValue = map['validateUntilUtc'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      workspaceId: (() {
