...
import 'data_connector_azure_active_directory_state.dart';
...
/// }
/// resource "azure_sentinel_dataconnectorazureactivedirectory" "example" {
///   name                       = "example"
...
class DataConnectorAzureActiveDirectory extends pulumi.CustomResource {
  ...
  /// Gets an existing [DataConnectorAzureActiveDirectory] resource's state with the given [name] and [id].
  static DataConnectorAzureActiveDirectory get(
    String name,
    pulumi.Input<String> id, {
    DataConnectorAzureActiveDirectoryState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DataConnectorAzureActiveDirectory._get(
      name,
      state: state?.toMap(),
  ...
  DataConnectorAzureActiveDirectory._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [DataConnectorAzureActiveDirectory] resource.
  DataConnectorAzureActiveDirectory.reference(String urn)
    : super(
        'azure:sentinel/dataConnectorAzureActiveDirectory:DataConnectorAzureActiveDirectory',
