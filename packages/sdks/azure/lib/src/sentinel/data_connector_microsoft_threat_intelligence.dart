...
import 'data_connector_microsoft_threat_intelligence_args.dart';
import 'data_connector_microsoft_threat_intelligence_state.dart';
...
class DataConnectorMicrosoftThreatIntelligence extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String> microsoftEmergingThreatFeedLookbackDate;
  ...
  /// Creates a new [DataConnectorMicrosoftThreatIntelligence].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataConnectorMicrosoftThreatIntelligence]. {@macro pulumi_sentinel_data_connector_microsoft_threat_intelligence_data_connector_microsoft_threat_intelligence_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DataConnectorMicrosoftThreatIntelligence(
    String name, {
    DataConnectorMicrosoftThreatIntelligenceArgs? args,
    ...
    this.microsoftEmergingThreatFeedLookbackDate = registerOutput<String>('microsoftEmergingThreatFeedLookbackDate');
    this.name = registerOutput<String>('name');
    this.tenantId = registerOutput<String>('tenantId');
  }

  /// Gets an existing [DataConnectorMicrosoftThreatIntelligence] resource's state with the given [name] and [id].
  static DataConnectorMicrosoftThreatIntelligence get(
    String name,
  ...
  DataConnectorMicrosoftThreatIntelligence._get(
    String name, {
