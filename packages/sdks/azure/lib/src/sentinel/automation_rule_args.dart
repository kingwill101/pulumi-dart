...
class AutomationRuleArgs {
  ...
  final pulumi.Input<List<AutomationRuleActionIncidentTask>>?
  actionIncidentTasks;
    ...
    return <String, dynamic>{
      'actionIncidentTasks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutomationRuleActionIncidentTask>,
      ...
      'actionIncidents':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutomationRuleActionIncident>,
            List<Map<String, dynamic>>
          >(
            actionIncidents,
            (value) =>
      ...
      'actionPlaybooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutomationRuleActionPlaybook>,
            List<Map<String, dynamic>>
          >(
            actionPlaybooks,
            (value) =>
  ...
  factory AutomationRuleArgs.fromMap(Map<String, dynamic> map) {
    return AutomationRuleArgs(
      actionIncidentTasks: (() {
        final guardedValue = map['actionIncidentTasks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutomationRuleActionIncidentTask>(
            guardedValue,
            (value) => AutomationRuleActionIncidentTask.fromMap(
      ...
      actionIncidents: (() {
        final guardedValue = map['actionIncidents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutomationRuleActionIncident>(
            guardedValue,
            (value) => AutomationRuleActionIncident.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      actionPlaybooks: (() {
        final guardedValue = map['actionPlaybooks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutomationRuleActionPlaybook>(
            guardedValue,
            (value) => AutomationRuleActionPlaybook.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      conditionJson: (() {
        final guardedValue = map['conditionJson'];
        if (guardedValue == null) return null;
      ...
      triggersOn: (() {
        final guardedValue = map['triggersOn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      triggersWhen: (() {
        final guardedValue = map['triggersWhen'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
