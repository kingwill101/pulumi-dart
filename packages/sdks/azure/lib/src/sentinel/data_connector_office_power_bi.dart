...
import 'data_connector_office_power_bi_args.dart';
import 'data_connector_office_power_bi_state.dart';
...
/// }
/// resource "azure_sentinel_dataconnectorofficepowerbi" "example" {
///   name                       = "example"
...
class DataConnectorOfficePowerBi extends pulumi.CustomResource {
  ...
  /// Creates a new [DataConnectorOfficePowerBi].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataConnectorOfficePowerBi]. {@macro pulumi_sentinel_data_connector_office_power_bi_data_connector_office_power_bi_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DataConnectorOfficePowerBi(
    String name, {
    DataConnectorOfficePowerBiArgs? args,
  ...
  /// Gets an existing [DataConnectorOfficePowerBi] resource's state with the given [name] and [id].
  static DataConnectorOfficePowerBi get(
    String name,
  ...
  DataConnectorOfficePowerBi._get(
    String name, {
