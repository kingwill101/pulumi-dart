...
import 'data_connector_office_irm_state.dart';
...
/// }
/// resource "azure_sentinel_dataconnectorofficeirm" "example" {
///   name                       = "example"
...
class DataConnectorOfficeIrm extends pulumi.CustomResource {
  ...
  /// Gets an existing [DataConnectorOfficeIrm] resource's state with the given [name] and [id].
  static DataConnectorOfficeIrm get(
    String name,
    pulumi.Input<String> id, {
    DataConnectorOfficeIrmState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DataConnectorOfficeIrm._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DataConnectorOfficeIrm] resource.
  DataConnectorOfficeIrm.reference(String urn)
    : super(
        'azure:sentinel/dataConnectorOfficeIrm:DataConnectorOfficeIrm',
