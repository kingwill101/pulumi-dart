...
class AlertRuleScheduledAlertDetailsOverride {
  ...
  final List<AlertRuleScheduledAlertDetailsOverrideDynamicProperty>? dynamicProperties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dynamicProperties': ?dynamicProperties == null ? null : pulumi.Input.encodeList<AlertRuleScheduledAlertDetailsOverrideDynamicProperty, Map<String, dynamic>>(dynamicProperties!, (value) => value.toMap()),
  ...
  factory AlertRuleScheduledAlertDetailsOverride.fromMap(Map<String, dynamic> map) {
    return AlertRuleScheduledAlertDetailsOverride(
      ...
      dynamicProperties: map['dynamicProperties'] == null ? null : pulumi.Input.decodeList<AlertRuleScheduledAlertDetailsOverrideDynamicProperty>(map['dynamicProperties'], (value) => AlertRuleScheduledAlertDetailsOverrideDynamicProperty.fromMap((value as Map).cast<String, dynamic>())),
