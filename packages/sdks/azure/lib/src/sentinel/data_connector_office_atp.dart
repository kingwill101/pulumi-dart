...
/// }
/// resource "azure_sentinel_dataconnectorofficeatp" "example" {
///   name                       = "example"
...
class DataConnectorOfficeAtp extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DataConnectorOfficeAtp] resource.
  DataConnectorOfficeAtp.reference(String urn)
    : super(
        'azure:sentinel/dataConnectorOfficeAtp:DataConnectorOfficeAtp',
