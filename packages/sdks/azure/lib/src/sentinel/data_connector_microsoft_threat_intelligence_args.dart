...
class DataConnectorMicrosoftThreatIntelligenceArgs {
  ...
  factory DataConnectorMicrosoftThreatIntelligenceArgs.fromMap(
    ...
    return DataConnectorMicrosoftThreatIntelligenceArgs(
      ...
      microsoftEmergingThreatFeedLookbackDate: pulumi.Input.fromValue(
        map['microsoftEmergingThreatFeedLookbackDate'] as String,
      ),
      name: (() {
