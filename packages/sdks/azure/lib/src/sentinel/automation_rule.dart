...
class AutomationRule extends pulumi.CustomResource {
  ...
  AutomationRule(
    ...
    this.actionIncidentTasks = registerOutput<List<AutomationRuleActionIncidentTask>?>('actionIncidentTasks');
    this.actionIncidents = registerOutput<List<AutomationRuleActionIncident>?>('actionIncidents');
    this.actionPlaybooks = registerOutput<List<AutomationRuleActionPlaybook>?>('actionPlaybooks');
