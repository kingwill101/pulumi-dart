...
class Grafana extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GrafanaAzureMonitorWorkspaceIntegration>?> azureMonitorWorkspaceIntegrations;
  ...
  Grafana(
    ...
    azureMonitorWorkspaceIntegrations = registerOutput<List<GrafanaAzureMonitorWorkspaceIntegration>?>('azureMonitorWorkspaceIntegrations', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<GrafanaAzureMonitorWorkspaceIntegration>(guardedValue, (value) => GrafanaAzureMonitorWorkspaceIntegration.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    outboundIps = registerOutput<List<String>>('outboundIps', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
