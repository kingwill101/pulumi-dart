...
class Grafana extends pulumi.CustomResource {
  ...
  Grafana(
    ...
    this.apiKeyEnabled = registerOutput<bool?>('apiKeyEnabled');
    this.autoGeneratedDomainNameLabelScope = registerOutput<String?>('autoGeneratedDomainNameLabelScope');
    this.azureMonitorWorkspaceIntegrations = registerOutput<List<GrafanaAzureMonitorWorkspaceIntegration>?>('azureMonitorWorkspaceIntegrations');
    this.deterministicOutboundIpEnabled = registerOutput<bool?>('deterministicOutboundIpEnabled');
    this.endpoint = registerOutput<String>('endpoint');
    this.grafanaMajorVersion = registerOutput<String>('grafanaMajorVersion');
    this.grafanaVersion = registerOutput<String>('grafanaVersion');
    this.identity = registerOutput<GrafanaIdentity?>('identity');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.outboundIps = registerOutput<List<String>>('outboundIps');
    ...
    this.smtp = registerOutput<GrafanaSmtp?>('smtp');
