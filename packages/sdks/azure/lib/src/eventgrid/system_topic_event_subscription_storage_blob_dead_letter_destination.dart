...
class SystemTopicEventSubscriptionStorageBlobDeadLetterDestination {
  ...
  factory SystemTopicEventSubscriptionStorageBlobDeadLetterDestination.fromMap(
    ...
    return SystemTopicEventSubscriptionStorageBlobDeadLetterDestination(
      ...
      storageBlobContainerName: pulumi.Input.fromValue(
        map['storageBlobContainerName'] as String,
      ),
    );
  }
}
