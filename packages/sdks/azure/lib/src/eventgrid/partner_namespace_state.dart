...
class PartnerNamespaceState {
  ...
  factory PartnerNamespaceState.fromMap(Map<String, dynamic> map) {
    return PartnerNamespaceState(
      ...
      inboundIpRules: (() { final guardedValue = map['inboundIpRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PartnerNamespaceInboundIpRule>(guardedValue, (value) => PartnerNamespaceInboundIpRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
