...
class NamespaceState {
  ...
  final pulumi.Input<List<NamespaceTopicSpacesConfiguration>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'topicSpacesConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceTopicSpacesConfiguration>,
            List<Map<String, dynamic>>
          >(
            topicSpacesConfigurations,
            (value) =>
  ...
  factory NamespaceState.fromMap(Map<String, dynamic> map) {
    return NamespaceState(
      ...
      inboundIpRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceInboundIpRule>(
            guardedValue,
            (value) => NamespaceInboundIpRule.fromMap(
      ...
      topicSpacesConfigurations: (() {
        final guardedValue = map['topicSpacesConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceTopicSpacesConfiguration>(
            guardedValue,
            (value) => NamespaceTopicSpacesConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
