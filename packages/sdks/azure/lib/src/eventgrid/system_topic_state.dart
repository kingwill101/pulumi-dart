...
class SystemTopicState {
  ...
  SystemTopicState({
    ...
    pulumi.Output<String>? metricArmResourceId,
    pulumi.Output<String>? metricResourceId,
    ...
    pulumi.Output<String>? topicType,
      ...
      metricArmResourceId = pulumi.Input.asOptionalInput<String>(metricArmResourceId),
      metricResourceId = pulumi.Input.asOptionalInput<String>(metricResourceId),
  ...
  factory SystemTopicState.fromMap(Map<String, dynamic> map) {
    return SystemTopicState(
      ...
      metricArmResourceId: map['metricArmResourceId'] == null ? null : pulumi.Output.create<String>(map['metricArmResourceId'] as String),
      metricResourceId: map['metricResourceId'] == null ? null : pulumi.Output.create<String>(map['metricResourceId'] as String),
