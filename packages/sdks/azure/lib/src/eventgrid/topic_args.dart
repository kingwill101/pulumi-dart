    ...
    return TopicArgs(
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          TopicIdentity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      inboundIpRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TopicInboundIpRule>(
            guardedValue,
            (value) => TopicInboundIpRule.fromMap(
      ...
      inputMappingDefaultValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TopicInputMappingDefaultValues.fromMap(
      ...
      inputMappingFields: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TopicInputMappingFields.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
