...
class SystemTopicEventSubscriptionArgs {
  ...
  final pulumi.Input<SystemTopicEventSubscriptionAdvancedFilter>?
  advancedFilter;
  ...
  final pulumi.Input<SystemTopicEventSubscriptionAzureFunctionEndpoint>?
  ...
  final pulumi.Input<SystemTopicEventSubscriptionDeadLetterIdentity>?
  deadLetterIdentity;

  /// A `delivery_identity` block as defined below.
  final pulumi.Input<SystemTopicEventSubscriptionDeliveryIdentity>?
  deliveryIdentity;

  /// One or more `delivery_property` blocks as defined below.
  final pulumi.Input<List<SystemTopicEventSubscriptionDeliveryProperty>>?
  deliveryProperties;
  ...
  final pulumi.Input<SystemTopicEventSubscriptionStorageQueueEndpoint>?
  ...
  final pulumi.Input<SystemTopicEventSubscriptionWebhookEndpoint>?
  webhookEndpoint;
  ...
  factory SystemTopicEventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SystemTopicEventSubscriptionArgs(
      advancedFilter: (() {
        final guardedValue = map['advancedFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionAdvancedFilter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      advancedFilteringOnArraysEnabled: (() {
        final guardedValue = map['advancedFilteringOnArraysEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      azureFunctionEndpoint: (() {
        final guardedValue = map['azureFunctionEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionAzureFunctionEndpoint.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      deadLetterIdentity: (() {
        final guardedValue = map['deadLetterIdentity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionDeadLetterIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      deliveryIdentity: (() {
        final guardedValue = map['deliveryIdentity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionDeliveryIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      deliveryProperties: (() {
        final guardedValue = map['deliveryProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SystemTopicEventSubscriptionDeliveryProperty>(
            guardedValue,
            (value) => SystemTopicEventSubscriptionDeliveryProperty.fromMap(
      ...
      eventhubEndpointId: (() {
        final guardedValue = map['eventhubEndpointId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      expirationTimeUtc: (() {
      ...
      hybridConnectionEndpointId: (() {
        final guardedValue = map['hybridConnectionEndpointId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      includedEventTypes: (() {
        final guardedValue = map['includedEventTypes'];
        if (guardedValue == null) return null;
      ...
      retryPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionRetryPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      serviceBusQueueEndpointId: (() {
        final guardedValue = map['serviceBusQueueEndpointId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceBusTopicEndpointId: (() {
        final guardedValue = map['serviceBusTopicEndpointId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageBlobDeadLetterDestination: (() {
        final guardedValue = map['storageBlobDeadLetterDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionStorageBlobDeadLetterDestination.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      storageQueueEndpoint: (() {
        final guardedValue = map['storageQueueEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionStorageQueueEndpoint.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      subjectFilter: (() {
        final guardedValue = map['subjectFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionSubjectFilter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      webhookEndpoint: (() {
        final guardedValue = map['webhookEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystemTopicEventSubscriptionWebhookEndpoint.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
