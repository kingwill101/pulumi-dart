...
class SystemTopicEventSubscriptionArgs {
  ...
  SystemTopicEventSubscriptionArgs({
    pulumi.Output<SystemTopicEventSubscriptionAdvancedFilter>? advancedFilter,
    pulumi.Output<bool>? advancedFilteringOnArraysEnabled,
    pulumi.Output<SystemTopicEventSubscriptionAzureFunctionEndpoint>? azureFunctionEndpoint,
    pulumi.Output<SystemTopicEventSubscriptionDeadLetterIdentity>? deadLetterIdentity,
    pulumi.Output<SystemTopicEventSubscriptionDeliveryIdentity>? deliveryIdentity,
    pulumi.Output<List<SystemTopicEventSubscriptionDeliveryProperty>>? deliveryProperties,
    pulumi.Output<String>? eventDeliverySchema,
    pulumi.Output<String>? eventhubEndpointId,
    pulumi.Output<String>? expirationTimeUtc,
    pulumi.Output<String>? hybridConnectionEndpointId,
    pulumi.Output<List<String>>? includedEventTypes,
    pulumi.Output<List<String>>? labels,
    pulumi.Output<String>? name,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<SystemTopicEventSubscriptionRetryPolicy>? retryPolicy,
    pulumi.Output<String>? serviceBusQueueEndpointId,
    pulumi.Output<String>? serviceBusTopicEndpointId,
    pulumi.Output<SystemTopicEventSubscriptionStorageBlobDeadLetterDestination>? storageBlobDeadLetterDestination,
    pulumi.Output<SystemTopicEventSubscriptionStorageQueueEndpoint>? storageQueueEndpoint,
    pulumi.Output<SystemTopicEventSubscriptionSubjectFilter>? subjectFilter,
    required pulumi.Output<String> systemTopic,
    pulumi.Output<SystemTopicEventSubscriptionWebhookEndpoint>? webhookEndpoint,
  }) :
  ...
  factory SystemTopicEventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SystemTopicEventSubscriptionArgs(
      advancedFilter: map['advancedFilter'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionAdvancedFilter>(SystemTopicEventSubscriptionAdvancedFilter.fromMap((map['advancedFilter'] as Map).cast<String, dynamic>())),
      advancedFilteringOnArraysEnabled: map['advancedFilteringOnArraysEnabled'] == null ? null : pulumi.Output.create<bool>(map['advancedFilteringOnArraysEnabled'] as bool),
      azureFunctionEndpoint: map['azureFunctionEndpoint'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionAzureFunctionEndpoint>(SystemTopicEventSubscriptionAzureFunctionEndpoint.fromMap((map['azureFunctionEndpoint'] as Map).cast<String, dynamic>())),
      deadLetterIdentity: map['deadLetterIdentity'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionDeadLetterIdentity>(SystemTopicEventSubscriptionDeadLetterIdentity.fromMap((map['deadLetterIdentity'] as Map).cast<String, dynamic>())),
      deliveryIdentity: map['deliveryIdentity'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionDeliveryIdentity>(SystemTopicEventSubscriptionDeliveryIdentity.fromMap((map['deliveryIdentity'] as Map).cast<String, dynamic>())),
      deliveryProperties: map['deliveryProperties'] == null ? null : pulumi.Output.create<List<SystemTopicEventSubscriptionDeliveryProperty>>(pulumi.Input.decodeList<SystemTopicEventSubscriptionDeliveryProperty>(map['deliveryProperties'], (value) => SystemTopicEventSubscriptionDeliveryProperty.fromMap((value as Map).cast<String, dynamic>()))),
      eventDeliverySchema: map['eventDeliverySchema'] == null ? null : pulumi.Output.create<String>(map['eventDeliverySchema'] as String),
      eventhubEndpointId: map['eventhubEndpointId'] == null ? null : pulumi.Output.create<String>(map['eventhubEndpointId'] as String),
      expirationTimeUtc: map['expirationTimeUtc'] == null ? null : pulumi.Output.create<String>(map['expirationTimeUtc'] as String),
      hybridConnectionEndpointId: map['hybridConnectionEndpointId'] == null ? null : pulumi.Output.create<String>(map['hybridConnectionEndpointId'] as String),
      includedEventTypes: map['includedEventTypes'] == null ? null : pulumi.Output.create<List<String>>((map['includedEventTypes'] as List).cast<String>()),
      labels: map['labels'] == null ? null : pulumi.Output.create<List<String>>((map['labels'] as List).cast<String>()),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      retryPolicy: map['retryPolicy'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionRetryPolicy>(SystemTopicEventSubscriptionRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>())),
      serviceBusQueueEndpointId: map['serviceBusQueueEndpointId'] == null ? null : pulumi.Output.create<String>(map['serviceBusQueueEndpointId'] as String),
      serviceBusTopicEndpointId: map['serviceBusTopicEndpointId'] == null ? null : pulumi.Output.create<String>(map['serviceBusTopicEndpointId'] as String),
      storageBlobDeadLetterDestination: map['storageBlobDeadLetterDestination'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionStorageBlobDeadLetterDestination>(SystemTopicEventSubscriptionStorageBlobDeadLetterDestination.fromMap((map['storageBlobDeadLetterDestination'] as Map).cast<String, dynamic>())),
      storageQueueEndpoint: map['storageQueueEndpoint'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionStorageQueueEndpoint>(SystemTopicEventSubscriptionStorageQueueEndpoint.fromMap((map['storageQueueEndpoint'] as Map).cast<String, dynamic>())),
      subjectFilter: map['subjectFilter'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionSubjectFilter>(SystemTopicEventSubscriptionSubjectFilter.fromMap((map['subjectFilter'] as Map).cast<String, dynamic>())),
      systemTopic: pulumi.Output.create<String>(map['systemTopic'] as String),
      webhookEndpoint: map['webhookEndpoint'] == null ? null : pulumi.Output.create<SystemTopicEventSubscriptionWebhookEndpoint>(SystemTopicEventSubscriptionWebhookEndpoint.fromMap((map['webhookEndpoint'] as Map).cast<String, dynamic>())),
    );
  }
}
