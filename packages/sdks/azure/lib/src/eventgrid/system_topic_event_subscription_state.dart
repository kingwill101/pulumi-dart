...
class SystemTopicEventSubscriptionState {
  ...
  const SystemTopicEventSubscriptionState({
    this.advancedFilter,
  ...
  factory SystemTopicEventSubscriptionState.fromMap(Map<String, dynamic> map) {
    return SystemTopicEventSubscriptionState(
      ...
      systemTopic: (() { final guardedValue = map['systemTopic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
