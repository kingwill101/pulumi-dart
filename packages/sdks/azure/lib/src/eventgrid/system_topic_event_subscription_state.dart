...
class SystemTopicEventSubscriptionState {
  ...
  SystemTopicEventSubscriptionState({
    ...
    pulumi.Output<String>? systemTopic,
    pulumi.Output<SystemTopicEventSubscriptionWebhookEndpoint>? webhookEndpoint,
      ...
      systemTopic = pulumi.Input.asOptionalInput<String>(systemTopic),
  ...
  factory SystemTopicEventSubscriptionState.fromMap(Map<String, dynamic> map) {
    return SystemTopicEventSubscriptionState(
      ...
      systemTopic: map['systemTopic'] == null ? null : pulumi.Output.create<String>(map['systemTopic'] as String),
