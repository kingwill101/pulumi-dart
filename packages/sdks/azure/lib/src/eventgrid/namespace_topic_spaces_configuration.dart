...
class NamespaceTopicSpacesConfiguration {
  ...
  final pulumi.Input<
    List<NamespaceTopicSpacesConfigurationDynamicRoutingEnrichment>
  >?
  ...
  factory NamespaceTopicSpacesConfiguration.fromMap(Map<String, dynamic> map) {
    return NamespaceTopicSpacesConfiguration(
      alternativeAuthenticationNameSources: (() {
        final guardedValue = map['alternativeAuthenticationNameSources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      dynamicRoutingEnrichments: (() {
        final guardedValue = map['dynamicRoutingEnrichments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NamespaceTopicSpacesConfigurationDynamicRoutingEnrichment.fromMap(
      ...
      routeTopicId: (() {
        final guardedValue = map['routeTopicId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      staticRoutingEnrichments: (() {
        final guardedValue = map['staticRoutingEnrichments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            NamespaceTopicSpacesConfigurationStaticRoutingEnrichment
          >(
            guardedValue,
            (value) =>
                NamespaceTopicSpacesConfigurationStaticRoutingEnrichment.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
