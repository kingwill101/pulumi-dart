...
class GetDomainResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'identities':
          pulumi.Input.encodeList<GetDomainIdentity, Map<String, dynamic>>(
            identities,
            (value) => value.toMap(),
          ),
      'inboundIpRules':
          pulumi.Input.encodeList<GetDomainInboundIpRule, Map<String, dynamic>>(
            inboundIpRules,
            (value) => value.toMap(),
          ),
  ...
  factory GetDomainResult.fromMap(Map<String, dynamic> map) {
    return GetDomainResult(
      ...
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetDomainIdentity>(
        map['identities']!,
        (value) =>
            GetDomainIdentity.fromMap((value as Map).cast<String, dynamic>()),
      ),
      inboundIpRules: pulumi.Input.decodeList<GetDomainInboundIpRule>(
        map['inboundIpRules']!,
        (value) => GetDomainInboundIpRule.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      inputMappingDefaultValues:
          pulumi.Input.decodeList<GetDomainInputMappingDefaultValue>(
            map['inputMappingDefaultValues']!,
            (value) => GetDomainInputMappingDefaultValue.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      inputMappingFields: pulumi.Input.decodeList<GetDomainInputMappingField>(
        map['inputMappingFields']!,
        (value) => GetDomainInputMappingField.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
