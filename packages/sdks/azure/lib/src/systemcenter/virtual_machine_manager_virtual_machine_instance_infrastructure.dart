...
class VirtualMachineManagerVirtualMachineInstanceInfrastructure {
  ...
  factory VirtualMachineManagerVirtualMachineInstanceInfrastructure.fromMap(
    ...
    return VirtualMachineManagerVirtualMachineInstanceInfrastructure(
      ...
      systemCenterVirtualMachineManagerCloudId: (() {
        final guardedValue = map['systemCenterVirtualMachineManagerCloudId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      systemCenterVirtualMachineManagerInventoryItemId: (() {
        final guardedValue =
            map['systemCenterVirtualMachineManagerInventoryItemId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      systemCenterVirtualMachineManagerTemplateId: (() {
        final guardedValue = map['systemCenterVirtualMachineManagerTemplateId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      systemCenterVirtualMachineManagerVirtualMachineServerId: (() {
        final guardedValue =
            map['systemCenterVirtualMachineManagerVirtualMachineServerId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
