...
class VirtualMachineManagerVirtualMachineInstanceState {
  ...
  final pulumi.Input<VirtualMachineManagerVirtualMachineInstanceHardware>?
  hardware;

  /// An `infrastructure` block as defined below.
  final pulumi.Input<VirtualMachineManagerVirtualMachineInstanceInfrastructure>?
  infrastructure;
  ...
  final pulumi.Input<
    List<VirtualMachineManagerVirtualMachineInstanceNetworkInterface>
  >?
  networkInterfaces;
  ...
  final pulumi.Input<
    List<VirtualMachineManagerVirtualMachineInstanceStorageDisk>
  >?
  storageDisks;
    ...
    return <String, dynamic>{
      ...
      'hardware':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(hardware, (value) => value.toMap()),
      'infrastructure':
          ?pulumi.Input.mapOptionalInputValue<
            VirtualMachineManagerVirtualMachineInstanceInfrastructure,
            Map<String, dynamic>
          >(infrastructure, (value) => value.toMap()),
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachineManagerVirtualMachineInstanceNetworkInterface>,
  ...
  factory VirtualMachineManagerVirtualMachineInstanceState.fromMap(
    ...
    return VirtualMachineManagerVirtualMachineInstanceState(
      ...
      hardware: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachineManagerVirtualMachineInstanceHardware.fromMap(
      ...
      infrastructure: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineManagerVirtualMachineInstanceInfrastructure.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      networkInterfaces: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VirtualMachineManagerVirtualMachineInstanceNetworkInterface.fromMap(
      ...
      operatingSystem: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineManagerVirtualMachineInstanceOperatingSystem.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageDisks: (() {
        final guardedValue = map['storageDisks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            VirtualMachineManagerVirtualMachineInstanceStorageDisk
          >(
            guardedValue,
            (value) =>
                VirtualMachineManagerVirtualMachineInstanceStorageDisk.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      systemCenterVirtualMachineManagerAvailabilitySetIds: (() {
        final guardedValue =
            map['systemCenterVirtualMachineManagerAvailabilitySetIds'];
        if (guardedValue == null) return null;
