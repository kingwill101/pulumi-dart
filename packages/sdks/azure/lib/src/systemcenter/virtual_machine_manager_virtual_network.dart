...
import 'virtual_machine_manager_virtual_network_args.dart';
import 'virtual_machine_manager_virtual_network_state.dart';
...
///   password            = "H@Sh1CoR3!"
/// }
/// resource "azure_systemcenter_virtualmachinemanagervirtualnetwork" "example" {
///   name                                                           = "example-scvmmvnet"
///   resource_group_name                                            = azure_core_resourcegroup.example.name
///   location                                                       = azure_core_resourcegroup.example.location
...
/// ```
class VirtualMachineManagerVirtualNetwork extends pulumi.CustomResource {
  ...
  /// Creates a new [VirtualMachineManagerVirtualNetwork].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VirtualMachineManagerVirtualNetwork]. {@macro pulumi_systemcenter_virtual_machine_manager_virtual_network_virtual_machine_manager_virtual_network_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  VirtualMachineManagerVirtualNetwork(
    String name, {
    VirtualMachineManagerVirtualNetworkArgs? args,
  ...
  /// Gets an existing [VirtualMachineManagerVirtualNetwork] resource's state with the given [name] and [id].
  static VirtualMachineManagerVirtualNetwork get(
    String name,
    pulumi.Input<String> id, {
    VirtualMachineManagerVirtualNetworkState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return VirtualMachineManagerVirtualNetwork._get(
      name,
      state: state?.toMap(),
  ...
  VirtualMachineManagerVirtualNetwork._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [VirtualMachineManagerVirtualNetwork] resource.
  VirtualMachineManagerVirtualNetwork.reference(String urn)
    : super(
        'azure:systemcenter/virtualMachineManagerVirtualNetwork:VirtualMachineManagerVirtualNetwork',
