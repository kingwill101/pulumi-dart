...
class DatasetBlobStorageArgs {
  ...
  factory DatasetBlobStorageArgs.fromMap(Map<String, dynamic> map) {
    return DatasetBlobStorageArgs(
      ...
      storageAccount: pulumi.Input.fromValue(DatasetBlobStorageStorageAccount.fromMap((map['storageAccount']! as Map).cast<String, dynamic>())),
    );
  }
}
