...
class ResourceGroupPolicyAssignmentOverride {
  ...
  final pulumi.Input<List<ResourceGroupPolicyAssignmentOverrideSelector>>?
  selectors;
  ...
  ResourceGroupPolicyAssignmentOverride({this.selectors, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGroupPolicyAssignmentOverrideSelector>,
  ...
  factory ResourceGroupPolicyAssignmentOverride.fromMap(
    ...
    return ResourceGroupPolicyAssignmentOverride(
      selectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ResourceGroupPolicyAssignmentOverrideSelector>(
            guardedValue,
            (value) => ResourceGroupPolicyAssignmentOverrideSelector.fromMap(
