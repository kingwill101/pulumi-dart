...
class ResourcePolicyAssignmentResourceSelector {
  ...
  final pulumi.Input<List<ResourcePolicyAssignmentResourceSelectorSelector>>
  selectors;
    ...
    return <String, dynamic>{
      ...
      'selectors':
          pulumi.Input.mapInputValue<
            List<ResourcePolicyAssignmentResourceSelectorSelector>,
  ...
  factory ResourcePolicyAssignmentResourceSelector.fromMap(
    ...
    return ResourcePolicyAssignmentResourceSelector(
      ...
      selectors: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<ResourcePolicyAssignmentResourceSelectorSelector>(
          map['selectors']!,
          (value) => ResourcePolicyAssignmentResourceSelectorSelector.fromMap(
