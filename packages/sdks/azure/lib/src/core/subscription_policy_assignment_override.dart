...
class SubscriptionPolicyAssignmentOverride {
  ...
  final pulumi.Input<List<SubscriptionPolicyAssignmentOverrideSelector>>?
  selectors;
  ...
  SubscriptionPolicyAssignmentOverride({this.selectors, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriptionPolicyAssignmentOverrideSelector>,
  ...
  factory SubscriptionPolicyAssignmentOverride.fromMap(
    ...
    return SubscriptionPolicyAssignmentOverride(
      selectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubscriptionPolicyAssignmentOverrideSelector>(
            guardedValue,
            (value) => SubscriptionPolicyAssignmentOverrideSelector.fromMap(
