...
/// {@template pulumi_core_resource_group_policy_remediation_resource_group_policy_remediation_args_doc}
/// The set of arguments for ResourceGroupPolicyRemediation.
/// {@endtemplate}
/// {@macro pulumi_core_resource_group_policy_remediation_resource_group_policy_remediation_args_doc}
class ResourceGroupPolicyRemediationArgs {
  ...
  /// Creates a new [ResourceGroupPolicyRemediationArgs].
  ...
  factory ResourceGroupPolicyRemediationArgs.fromMap(Map<String, dynamic> map) {
    return ResourceGroupPolicyRemediationArgs(
      failurePercentage: (() { final guardedValue = map['failurePercentage']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      parallelDeployments: (() { final guardedValue = map['parallelDeployments']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      resourceCount: (() { final guardedValue = map['resourceCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
