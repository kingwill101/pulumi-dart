...
class ResourceGroupCostManagementExportArgs {
  ...
  const ResourceGroupCostManagementExportArgs({
    this.active,
  ...
  factory ResourceGroupCostManagementExportArgs.fromMap(Map<String, dynamic> map) {
    return ResourceGroupCostManagementExportArgs(
      ...
      exportDataOptions: pulumi.Input.fromValue(ResourceGroupCostManagementExportExportDataOptions.fromMap((map['exportDataOptions']! as Map).cast<String, dynamic>())),
      exportDataStorageLocation: pulumi.Input.fromValue(ResourceGroupCostManagementExportExportDataStorageLocation.fromMap((map['exportDataStorageLocation']! as Map).cast<String, dynamic>())),
