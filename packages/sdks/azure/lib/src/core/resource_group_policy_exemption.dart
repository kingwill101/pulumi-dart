...
import 'resource_group_policy_exemption_state.dart';
...
class ResourceGroupPolicyExemption extends pulumi.CustomResource {
  ...
  /// Gets an existing [ResourceGroupPolicyExemption] resource's state with the given [name] and [id].
  static ResourceGroupPolicyExemption get(
    String name,
  ...
  ResourceGroupPolicyExemption._get(
    String name, {
