...
class ResourcePolicyAssignmentOverride {
  ...
  factory ResourcePolicyAssignmentOverride.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyAssignmentOverride(
      selectors: (() { final guardedValue = map['selectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourcePolicyAssignmentOverrideSelector>(guardedValue, (value) => ResourcePolicyAssignmentOverrideSelector.fromMap((value as Map).cast<String, dynamic>()))); })(),
