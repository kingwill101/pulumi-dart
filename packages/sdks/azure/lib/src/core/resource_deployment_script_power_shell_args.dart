...
class ResourceDeploymentScriptPowerShellArgs {
  ...
  final pulumi.Input<
    List<ResourceDeploymentScriptPowerShellEnvironmentVariable>
  >?
  ...
  final pulumi.Input<ResourceDeploymentScriptPowerShellStorageAccount>?
  storageAccount;
  ...
  factory ResourceDeploymentScriptPowerShellArgs.fromMap(
    ...
    return ResourceDeploymentScriptPowerShellArgs(
      ...
      container: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceDeploymentScriptPowerShellContainer.fromMap(
      ...
      environmentVariables: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceDeploymentScriptPowerShellEnvironmentVariable.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceDeploymentScriptPowerShellIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageAccount: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceDeploymentScriptPowerShellStorageAccount.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
