...
class ResourceDeploymentScriptPowerShellArgs {
  ...
  factory ResourceDeploymentScriptPowerShellArgs.fromMap(Map<String, dynamic> map) {
    return ResourceDeploymentScriptPowerShellArgs(
      ...
      container: map['container'] == null ? null : (ResourceDeploymentScriptPowerShellContainer.fromMap((map['container'] as Map).cast<String, dynamic>())).input(),
      environmentVariables: map['environmentVariables'] == null ? null : (pulumi.Input.decodeList<ResourceDeploymentScriptPowerShellEnvironmentVariable>(map['environmentVariables'], (value) => ResourceDeploymentScriptPowerShellEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>()))).input(),
      forceUpdateTag: map['forceUpdateTag'] == null ? null : (map['forceUpdateTag'] as String).input(),
      identity: map['identity'] == null ? null : (ResourceDeploymentScriptPowerShellIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())).input(),
      ...
      storageAccount: map['storageAccount'] == null ? null : (ResourceDeploymentScriptPowerShellStorageAccount.fromMap((map['storageAccount'] as Map).cast<String, dynamic>())).input(),
