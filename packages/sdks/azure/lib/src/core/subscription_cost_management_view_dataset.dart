...
class SubscriptionCostManagementViewDataset {
  ...
  final pulumi.Input<List<SubscriptionCostManagementViewDatasetAggregation>>
  aggregations;
  ...
  final pulumi.Input<List<SubscriptionCostManagementViewDatasetGrouping>>?
  groupings;

  /// One or more `sorting` blocks as defined below, containing the order by expression to be used in the report
  final pulumi.Input<List<SubscriptionCostManagementViewDatasetSorting>>?
  sortings;
    ...
    return <String, dynamic>{
      'aggregations':
          pulumi.Input.mapInputValue<
            List<SubscriptionCostManagementViewDatasetAggregation>,
      ...
      'groupings':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriptionCostManagementViewDatasetGrouping>,
            List<Map<String, dynamic>>
          >(
            groupings,
            (value) =>
      ...
      'sortings':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriptionCostManagementViewDatasetSorting>,
            List<Map<String, dynamic>>
          >(
            sortings,
            (value) =>
  ...
  factory SubscriptionCostManagementViewDataset.fromMap(
    Map<String, dynamic> map,
  ) {
    return SubscriptionCostManagementViewDataset(
      aggregations: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<SubscriptionCostManagementViewDatasetAggregation>(
          map['aggregations']!,
          (value) => SubscriptionCostManagementViewDatasetAggregation.fromMap(
      ...
      groupings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<SubscriptionCostManagementViewDatasetGrouping>(
            guardedValue,
            (value) => SubscriptionCostManagementViewDatasetGrouping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sortings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubscriptionCostManagementViewDatasetSorting>(
            guardedValue,
            (value) => SubscriptionCostManagementViewDatasetSorting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
