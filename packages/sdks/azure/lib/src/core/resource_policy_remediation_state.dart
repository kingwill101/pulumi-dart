...
class ResourcePolicyRemediationState {
  ...
  /// Creates a new [ResourcePolicyRemediationState].
  ...
  factory ResourcePolicyRemediationState.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyRemediationState(
