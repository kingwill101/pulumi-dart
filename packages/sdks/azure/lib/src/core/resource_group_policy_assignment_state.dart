...
class ResourceGroupPolicyAssignmentState {
  ...
  final pulumi.Input<List<ResourceGroupPolicyAssignmentNonComplianceMessage>>?
  ...
  final pulumi.Input<List<ResourceGroupPolicyAssignmentResourceSelector>>?
  resourceSelectors;

  /// Creates a new [ResourceGroupPolicyAssignmentState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nonComplianceMessages':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGroupPolicyAssignmentNonComplianceMessage>,
      ...
      'overrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGroupPolicyAssignmentOverride>,
            List<Map<String, dynamic>>
          >(
            overrides,
            (value) =>
      ...
      'resourceSelectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGroupPolicyAssignmentResourceSelector>,
            List<Map<String, dynamic>>
          >(
            resourceSelectors,
            (value) =>
  ...
  factory ResourceGroupPolicyAssignmentState.fromMap(Map<String, dynamic> map) {
    return ResourceGroupPolicyAssignmentState(
      description: (() {
      ...
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceGroupPolicyAssignmentIdentity.fromMap(
      ...
      nonComplianceMessages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceGroupPolicyAssignmentNonComplianceMessage.fromMap(
      ...
      overrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceGroupPolicyAssignmentOverride>(
            guardedValue,
            (value) => ResourceGroupPolicyAssignmentOverride.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      resourceSelectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ResourceGroupPolicyAssignmentResourceSelector>(
            guardedValue,
            (value) => ResourceGroupPolicyAssignmentResourceSelector.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
