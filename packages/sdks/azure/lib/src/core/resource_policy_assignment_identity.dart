...
class ResourcePolicyAssignmentIdentity {
  ...
  /// Creates a new [ResourcePolicyAssignmentIdentity].
  ...
  factory ResourcePolicyAssignmentIdentity.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyAssignmentIdentity(
