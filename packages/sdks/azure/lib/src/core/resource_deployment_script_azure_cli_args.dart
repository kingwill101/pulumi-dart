...
class ResourceDeploymentScriptAzureCliArgs {
  ...
  factory ResourceDeploymentScriptAzureCliArgs.fromMap(Map<String, dynamic> map) {
    return ResourceDeploymentScriptAzureCliArgs(
      ...
      container: (() { final guardedValue = map['container']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceDeploymentScriptAzureCliContainer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      environmentVariables: (() { final guardedValue = map['environmentVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceDeploymentScriptAzureCliEnvironmentVariable>(guardedValue, (value) => ResourceDeploymentScriptAzureCliEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceDeploymentScriptAzureCliIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageAccount: (() { final guardedValue = map['storageAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceDeploymentScriptAzureCliStorageAccount.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
