...
class ResourceDeploymentScriptAzureCliArgs {
  ...
  factory ResourceDeploymentScriptAzureCliArgs.fromMap(Map<String, dynamic> map) {
    return ResourceDeploymentScriptAzureCliArgs(
      ...
      container: map['container'] == null ? null : (ResourceDeploymentScriptAzureCliContainer.fromMap((map['container'] as Map).cast<String, dynamic>())).input(),
      environmentVariables: map['environmentVariables'] == null ? null : (pulumi.Input.decodeList<ResourceDeploymentScriptAzureCliEnvironmentVariable>(map['environmentVariables'], (value) => ResourceDeploymentScriptAzureCliEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>()))).input(),
      forceUpdateTag: map['forceUpdateTag'] == null ? null : (map['forceUpdateTag'] as String).input(),
      identity: map['identity'] == null ? null : (ResourceDeploymentScriptAzureCliIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())).input(),
      ...
      storageAccount: map['storageAccount'] == null ? null : (ResourceDeploymentScriptAzureCliStorageAccount.fromMap((map['storageAccount'] as Map).cast<String, dynamic>())).input(),
