...
class ResourceGroupCostManagementViewState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kpis':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGroupCostManagementViewKpi>,
      ...
      'pivots':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGroupCostManagementViewPivot>,
            List<Map<String, dynamic>>
          >(
            pivots,
            (value) =>
  ...
  factory ResourceGroupCostManagementViewState.fromMap(
    ...
    return ResourceGroupCostManagementViewState(
      ...
      dataset: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceGroupCostManagementViewDataset.fromMap(
      ...
      kpis: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceGroupCostManagementViewKpi>(
            guardedValue,
            (value) => ResourceGroupCostManagementViewKpi.fromMap(
      ...
      pivots: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceGroupCostManagementViewPivot>(
            guardedValue,
            (value) => ResourceGroupCostManagementViewPivot.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
