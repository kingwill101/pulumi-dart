...
class ResourceGroupCostManagementViewDataset {
  ...
  factory ResourceGroupCostManagementViewDataset.fromMap(Map<String, dynamic> map) {
    return ResourceGroupCostManagementViewDataset(
      aggregations: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceGroupCostManagementViewDatasetAggregation>(map['aggregations']!, (value) => ResourceGroupCostManagementViewDatasetAggregation.fromMap((value as Map).cast<String, dynamic>()))),
      granularity: pulumi.Input.fromValue(map['granularity'] as String),
      groupings: (() { final guardedValue = map['groupings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceGroupCostManagementViewDatasetGrouping>(guardedValue, (value) => ResourceGroupCostManagementViewDatasetGrouping.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sortings: (() { final guardedValue = map['sortings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceGroupCostManagementViewDatasetSorting>(guardedValue, (value) => ResourceGroupCostManagementViewDatasetSorting.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
