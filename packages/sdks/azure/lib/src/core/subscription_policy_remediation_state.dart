...
class SubscriptionPolicyRemediationState {
  ...
  /// Creates a new [SubscriptionPolicyRemediationState].
  ...
  const SubscriptionPolicyRemediationState({
  ...
  factory SubscriptionPolicyRemediationState.fromMap(Map<String, dynamic> map) {
    return SubscriptionPolicyRemediationState(
