...
class SubscriptionPolicyAssignmentState {
  ...
  final pulumi.Input<List<SubscriptionPolicyAssignmentNonComplianceMessage>>?
  ...
  final pulumi.Input<List<SubscriptionPolicyAssignmentResourceSelector>>?
  resourceSelectors;
  ...
  /// Creates a new [SubscriptionPolicyAssignmentState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nonComplianceMessages':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriptionPolicyAssignmentNonComplianceMessage>,
      ...
      'overrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriptionPolicyAssignmentOverride>,
            List<Map<String, dynamic>>
          >(
            overrides,
            (value) =>
      ...
      'resourceSelectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriptionPolicyAssignmentResourceSelector>,
            List<Map<String, dynamic>>
          >(
            resourceSelectors,
            (value) =>
  ...
  factory SubscriptionPolicyAssignmentState.fromMap(Map<String, dynamic> map) {
    return SubscriptionPolicyAssignmentState(
      description: (() {
      ...
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          SubscriptionPolicyAssignmentIdentity.fromMap(
      ...
      nonComplianceMessages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => SubscriptionPolicyAssignmentNonComplianceMessage.fromMap(
      ...
      overrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubscriptionPolicyAssignmentOverride>(
            guardedValue,
            (value) => SubscriptionPolicyAssignmentOverride.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      resourceSelectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubscriptionPolicyAssignmentResourceSelector>(
            guardedValue,
            (value) => SubscriptionPolicyAssignmentResourceSelector.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
