...
class ResourceProviderRegistrationState {
  ...
  ResourceProviderRegistrationState({this.features, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'features':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceProviderRegistrationFeature>,
    ...
    return ResourceProviderRegistrationState(
      features: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceProviderRegistrationFeature>(
            guardedValue,
            (value) => ResourceProviderRegistrationFeature.fromMap(
