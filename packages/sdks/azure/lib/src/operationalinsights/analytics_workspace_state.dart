...
class AnalyticsWorkspaceState {
  ...
  factory AnalyticsWorkspaceState.fromMap(Map<String, dynamic> map) {
    return AnalyticsWorkspaceState(
      ...
      primarySharedKey: (() { final guardedValue = map['primarySharedKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      secondarySharedKey: (() { final guardedValue = map['secondarySharedKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
