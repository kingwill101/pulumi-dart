  ...
  factory AnalyticsWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return AnalyticsWorkspaceArgs(
      allowResourceOnlyPermissions: (() {
        final guardedValue = map['allowResourceOnlyPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      cmkForQueryForced: (() {
        final guardedValue = map['cmkForQueryForced'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dailyQuotaGb: (() {
      ...
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          AnalyticsWorkspaceIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      immediateDataPurgeOn30DaysEnabled: (() {
        final guardedValue = map['immediateDataPurgeOn30DaysEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      reservationCapacityInGbPerDay: (() {
        final guardedValue = map['reservationCapacityInGbPerDay'];
        if (guardedValue == null) return null;
