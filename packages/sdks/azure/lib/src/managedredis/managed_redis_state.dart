...
class ManagedRedisState {
  ...
  factory ManagedRedisState.fromMap(Map<String, dynamic> map) {
    return ManagedRedisState(
      customerManagedKey: (() { final guardedValue = map['customerManagedKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedRedisCustomerManagedKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultDatabase: (() { final guardedValue = map['defaultDatabase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedRedisDefaultDatabase.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      highAvailabilityEnabled: (() { final guardedValue = map['highAvailabilityEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      hostname: (() { final guardedValue = map['hostname']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedRedisIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
