...
class GeoReplicationState {
  ...
  const GeoReplicationState({
    this.linkedManagedRedisIds,
    this.managedRedisId,
  });
  ...
  factory GeoReplicationState.fromMap(Map<String, dynamic> map) {
    return GeoReplicationState(
      linkedManagedRedisIds: (() { final guardedValue = map['linkedManagedRedisIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
