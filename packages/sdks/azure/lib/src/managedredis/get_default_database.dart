...
class GetDefaultDatabase {
  ...
  factory GetDefaultDatabase.fromMap(Map<String, dynamic> map) {
    return GetDefaultDatabase(
      accessKeysAuthenticationEnabled: pulumi.Input.fromValue(
        map['accessKeysAuthenticationEnabled'] as bool,
      ),
      clientProtocol: pulumi.Input.fromValue(map['clientProtocol'] as String),
      clusteringPolicy: pulumi.Input.fromValue(
        map['clusteringPolicy'] as String,
      ),
      evictionPolicy: pulumi.Input.fromValue(map['evictionPolicy'] as String),
      geoReplicationGroupName: pulumi.Input.fromValue(
        map['geoReplicationGroupName'] as String,
      ),
      geoReplicationLinkedDatabaseIds: pulumi.Input.fromValue(
        (map['geoReplicationLinkedDatabaseIds'] as List).cast<String>(),
      ),
      id: pulumi.Input.fromValue(map['id'] as String),
      modules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDefaultDatabaseModule>(
          map['modules']!,
          (value) => GetDefaultDatabaseModule.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      persistenceAppendOnlyFileBackupFrequency: pulumi.Input.fromValue(
        map['persistenceAppendOnlyFileBackupFrequency'] as String,
      ),
      persistenceRedisDatabaseBackupFrequency: pulumi.Input.fromValue(
        map['persistenceRedisDatabaseBackupFrequency'] as String,
      ),
