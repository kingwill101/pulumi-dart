...
class ManagedRedisDefaultDatabase {
    ...
    return <String, dynamic>{
      ...
      'modules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedRedisDefaultDatabaseModule>,
  ...
  factory ManagedRedisDefaultDatabase.fromMap(Map<String, dynamic> map) {
    return ManagedRedisDefaultDatabase(
      ...
      clientProtocol: (() {
        final guardedValue = map['clientProtocol'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clusteringPolicy: (() {
        final guardedValue = map['clusteringPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      evictionPolicy: (() {
      ...
      geoReplicationGroupName: (() {
        final guardedValue = map['geoReplicationGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      id: (() {
      ...
      modules: (() {
        final guardedValue = map['modules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedRedisDefaultDatabaseModule>(
            guardedValue,
            (value) => ManagedRedisDefaultDatabaseModule.fromMap(
      ...
      persistenceAppendOnlyFileBackupFrequency: (() {
        final guardedValue = map['persistenceAppendOnlyFileBackupFrequency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      persistenceRedisDatabaseBackupFrequency: (() {
        final guardedValue = map['persistenceRedisDatabaseBackupFrequency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      port: (() {
