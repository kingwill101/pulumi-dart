...
import 'string_variable_state.dart';
...
///   sku_name            = "Basic"
/// }
/// resource "azure_automation_stringvariable" "example" {
///   name                    = "tfex-example-var"
///   resource_group_name     = azure_core_resourcegroup.example.name
...
class StringVariable extends pulumi.CustomResource {
  ...
  /// Gets an existing [StringVariable] resource's state with the given [name] and [id].
  static StringVariable get(
    String name,
    pulumi.Input<String> id, {
    StringVariableState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return StringVariable._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [StringVariable] resource.
  StringVariable.reference(String urn)
    : super(
        'azure:automation/stringVariable:StringVariable',
