...
import 'connection_certificate_state.dart';
...
/// }
/// resource "azure_automation_connectioncertificate" "example" {
///   name                        = "connection-example"
///   resource_group_name         = azure_core_resourcegroup.example.name
///   automation_account_name     = azure_automation_account.example.name
///   automation_certificate_name = azure_automation_certificate.example.name
...
class ConnectionCertificate extends pulumi.CustomResource {
  ...
  /// Gets an existing [ConnectionCertificate] resource's state with the given [name] and [id].
  static ConnectionCertificate get(
    String name,
