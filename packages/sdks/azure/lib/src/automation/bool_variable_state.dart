...
class BoolVariableState {
  ...
  /// Creates a new [BoolVariableState].
  ...
  factory BoolVariableState.fromMap(Map<String, dynamic> map) {
    return BoolVariableState(
