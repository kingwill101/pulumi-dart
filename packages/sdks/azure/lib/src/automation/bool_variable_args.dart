...
/// {@template pulumi_automation_bool_variable_bool_variable_args_doc}
/// The set of arguments for BoolVariable.
/// {@endtemplate}
/// {@macro pulumi_automation_bool_variable_bool_variable_args_doc}
class BoolVariableArgs {
  ...
  /// Creates a new [BoolVariableArgs].
  ...
  factory BoolVariableArgs.fromMap(Map<String, dynamic> map) {
    return BoolVariableArgs(
