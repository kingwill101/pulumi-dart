...
class SoftwareUpdateConfigurationState {
  ...
  factory SoftwareUpdateConfigurationState.fromMap(Map<String, dynamic> map) {
    return SoftwareUpdateConfigurationState(
      ...
      schedule: (() { final guardedValue = map['schedule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SoftwareUpdateConfigurationSchedule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
