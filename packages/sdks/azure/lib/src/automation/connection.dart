...
class Connection extends pulumi.CustomResource {
  ...
  Connection(
    ...
    values = registerOutput<Map<String, String>>('values', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
  }
