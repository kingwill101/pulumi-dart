...
class GetVariablesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bools': pulumi.Input.encodeList<GetVariablesBool, Map<String, dynamic>>(
        bools,
        (value) => value.toMap(),
      ),
      'datetimes':
          pulumi.Input.encodeList<GetVariablesDatetime, Map<String, dynamic>>(
            datetimes,
            (value) => value.toMap(),
          ),
      'encrypteds':
          pulumi.Input.encodeList<GetVariablesEncrypted, Map<String, dynamic>>(
            encrypteds,
            (value) => value.toMap(),
          ),
      'id': id,
      'ints': pulumi.Input.encodeList<GetVariablesInt, Map<String, dynamic>>(
        ints,
        (value) => value.toMap(),
      ),
      'nulls': pulumi.Input.encodeList<GetVariablesNull, Map<String, dynamic>>(
        nulls,
        (value) => value.toMap(),
      ),
      'objects':
          pulumi.Input.encodeList<GetVariablesObject, Map<String, dynamic>>(
            objects,
            (value) => value.toMap(),
          ),
      'strings':
          pulumi.Input.encodeList<GetVariablesString, Map<String, dynamic>>(
            strings,
            (value) => value.toMap(),
          ),
    };
  ...
  factory GetVariablesResult.fromMap(Map<String, dynamic> map) {
    return GetVariablesResult(
      ...
      bools: pulumi.Input.decodeList<GetVariablesBool>(
        map['bools']!,
        (value) =>
            GetVariablesBool.fromMap((value as Map).cast<String, dynamic>()),
      ),
      datetimes: pulumi.Input.decodeList<GetVariablesDatetime>(
        map['datetimes']!,
        (value) => GetVariablesDatetime.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      encrypteds: pulumi.Input.decodeList<GetVariablesEncrypted>(
        map['encrypteds']!,
        (value) => GetVariablesEncrypted.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      id: map['id'] as String,
      ints: pulumi.Input.decodeList<GetVariablesInt>(
        map['ints']!,
        (value) =>
            GetVariablesInt.fromMap((value as Map).cast<String, dynamic>()),
      ),
      nulls: pulumi.Input.decodeList<GetVariablesNull>(
        map['nulls']!,
        (value) =>
            GetVariablesNull.fromMap((value as Map).cast<String, dynamic>()),
      ),
      objects: pulumi.Input.decodeList<GetVariablesObject>(
        map['objects']!,
        (value) =>
            GetVariablesObject.fromMap((value as Map).cast<String, dynamic>()),
      ),
      strings: pulumi.Input.decodeList<GetVariablesString>(
        map['strings']!,
        (value) =>
            GetVariablesString.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
