...
class AccountState {
  ...
  factory AccountState.fromMap(Map<String, dynamic> map) {
    return AccountState(
      dscPrimaryAccessKey: (() { final guardedValue = map['dscPrimaryAccessKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dscSecondaryAccessKey: (() { final guardedValue = map['dscSecondaryAccessKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dscServerEndpoint: (() { final guardedValue = map['dscServerEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      encryptions: (() { final guardedValue = map['encryptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccountEncryption>(guardedValue, (value) => AccountEncryption.fromMap((value as Map).cast<String, dynamic>()))); })(),
      hybridServiceUrl: (() { final guardedValue = map['hybridServiceUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      privateEndpointConnections: (() { final guardedValue = map['privateEndpointConnections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccountPrivateEndpointConnection>(guardedValue, (value) => AccountPrivateEndpointConnection.fromMap((value as Map).cast<String, dynamic>()))); })(),
