...
class SoftwareUpdateConfigurationSchedule {
  ...
  factory SoftwareUpdateConfigurationSchedule.fromMap(Map<String, dynamic> map) {
    return SoftwareUpdateConfigurationSchedule(
      ...
      expiryTimeOffsetMinutes: (() { final guardedValue = map['expiryTimeOffsetMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      nextRunOffsetMinutes: (() { final guardedValue = map['nextRunOffsetMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      startTime: (() { final guardedValue = map['startTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      startTimeOffsetMinutes: (() { final guardedValue = map['startTimeOffsetMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
