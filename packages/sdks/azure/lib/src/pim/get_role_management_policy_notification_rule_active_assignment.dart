...
class GetRoleManagementPolicyNotificationRuleActiveAssignment {
  ...
  factory GetRoleManagementPolicyNotificationRuleActiveAssignment.fromMap(Map<String, dynamic> map) {
    return GetRoleManagementPolicyNotificationRuleActiveAssignment(
      adminNotifications: (pulumi.Input.decodeList<GetRoleManagementPolicyNotificationRuleActiveAssignmentAdminNotification>(map['adminNotifications'], (value) => GetRoleManagementPolicyNotificationRuleActiveAssignmentAdminNotification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      approverNotifications: (pulumi.Input.decodeList<GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification>(map['approverNotifications'], (value) => GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      assigneeNotifications: (pulumi.Input.decodeList<GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification>(map['assigneeNotifications'], (value) => GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
