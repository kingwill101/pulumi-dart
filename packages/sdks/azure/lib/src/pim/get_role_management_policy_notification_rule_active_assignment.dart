...
class GetRoleManagementPolicyNotificationRuleActiveAssignment {
  ...
  factory GetRoleManagementPolicyNotificationRuleActiveAssignment.fromMap(
    ...
    return GetRoleManagementPolicyNotificationRuleActiveAssignment(
      adminNotifications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRoleManagementPolicyNotificationRuleActiveAssignmentAdminNotification.fromMap(
      ...
      approverNotifications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      assigneeNotifications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
