...
class RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotifications {
  ...
  /// Creates a new [RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotifications].
  ...
  const RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotifications({
