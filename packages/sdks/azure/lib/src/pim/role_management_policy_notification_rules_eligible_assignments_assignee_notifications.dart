...
class RoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications {
  ...
  /// Creates a new [RoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications].
  ...
  const RoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications({
  ...
  factory RoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications.fromMap(Map<String, dynamic> map) {
    return RoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications(
