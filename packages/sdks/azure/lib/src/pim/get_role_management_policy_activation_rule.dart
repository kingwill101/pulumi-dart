...
class GetRoleManagementPolicyActivationRule {
  ...
  factory GetRoleManagementPolicyActivationRule.fromMap(Map<String, dynamic> map) {
    return GetRoleManagementPolicyActivationRule(
      approvalStages: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRoleManagementPolicyActivationRuleApprovalStage>(map['approvalStages']!, (value) => GetRoleManagementPolicyActivationRuleApprovalStage.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      requiredConditionalAccessAuthenticationContext: pulumi.Input.fromValue(map['requiredConditionalAccessAuthenticationContext'] as String),
    );
  }
}
