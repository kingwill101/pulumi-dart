...
class RoleManagementPolicyActivationRules {
  ...
  final pulumi.Input<RoleManagementPolicyActivationRulesApprovalStage>?
  approvalStage;
  ...
  factory RoleManagementPolicyActivationRules.fromMap(
    ...
    return RoleManagementPolicyActivationRules(
      approvalStage: (() {
        ...
        return pulumi.Input.fromValue(
          RoleManagementPolicyActivationRulesApprovalStage.fromMap(
