...
class RoleManagementPolicyActivationRules {
  ...
  /// [requireApproval] Is approval required for activation. If `true` an `approvalStage` block must be provided.
  /// [requireJustification] Is a justification required during activation of the role.
  /// [requireMultifactorAuthentication] Is multi-factor authentication required to activate the role. Conflicts with `requiredConditionalAccessAuthenticationContext`.
  /// [requireTicketInfo] Is ticket information requrired during activation of the role.
  /// [requiredConditionalAccessAuthenticationContext] The Entra ID Conditional Access context that must be present for activation. Conflicts with `requireMultifactorAuthentication`.
  const RoleManagementPolicyActivationRules({
    this.approvalStage,
