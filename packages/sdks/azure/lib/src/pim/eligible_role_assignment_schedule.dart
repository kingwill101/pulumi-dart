...
class EligibleRoleAssignmentSchedule {
  ...
  factory EligibleRoleAssignmentSchedule.fromMap(Map<String, dynamic> map) {
    return EligibleRoleAssignmentSchedule(
      expiration: (() { final guardedValue = map['expiration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EligibleRoleAssignmentScheduleExpiration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
