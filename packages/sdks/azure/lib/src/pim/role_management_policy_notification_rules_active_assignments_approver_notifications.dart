...
class RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications {
  ...
  /// Creates a new [RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications].
  ...
  const RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications({
  ...
  factory RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications.fromMap(Map<String, dynamic> map) {
    return RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications(
