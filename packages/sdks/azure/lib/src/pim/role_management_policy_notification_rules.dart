...
class RoleManagementPolicyNotificationRules {
  ...
  final pulumi.Input<RoleManagementPolicyNotificationRulesActiveAssignments>?
  activeAssignments;

  /// A `notification_target` block as defined below for configuring notifications on activation of eligible role.
  final pulumi.Input<RoleManagementPolicyNotificationRulesEligibleActivations>?
  eligibleActivations;

  /// A `notification_target` block as defined below to configure notification on eligible role assignments.
  final pulumi.Input<RoleManagementPolicyNotificationRulesEligibleAssignments>?
  eligibleAssignments;
    ...
    return <String, dynamic>{
      'activeAssignments':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(activeAssignments, (value) => value.toMap()),
      'eligibleActivations':
          ?pulumi.Input.mapOptionalInputValue<
            RoleManagementPolicyNotificationRulesEligibleActivations,
            Map<String, dynamic>
          >(eligibleActivations, (value) => value.toMap()),
      'eligibleAssignments':
          ?pulumi.Input.mapOptionalInputValue<
            RoleManagementPolicyNotificationRulesEligibleAssignments,
            Map<String, dynamic>
          >(eligibleAssignments, (value) => value.toMap()),
    };
  }

  factory RoleManagementPolicyNotificationRules.fromMap(
    Map<String, dynamic> map,
  ) {
    return RoleManagementPolicyNotificationRules(
      activeAssignments: (() {
        final guardedValue = map['activeAssignments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoleManagementPolicyNotificationRulesActiveAssignments.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      eligibleActivations: (() {
        final guardedValue = map['eligibleActivations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoleManagementPolicyNotificationRulesEligibleActivations.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      eligibleAssignments: (() {
        final guardedValue = map['eligibleAssignments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoleManagementPolicyNotificationRulesEligibleAssignments.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
