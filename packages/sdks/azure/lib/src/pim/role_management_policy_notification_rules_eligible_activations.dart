...
class RoleManagementPolicyNotificationRulesEligibleActivations {
  ...
  factory RoleManagementPolicyNotificationRulesEligibleActivations.fromMap(
    ...
    return RoleManagementPolicyNotificationRulesEligibleActivations(
      adminNotifications: (() {
        ...
        return pulumi.Input.fromValue(
          RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications.fromMap(
      ...
      approverNotifications: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      assigneeNotifications: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
