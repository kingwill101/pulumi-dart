...
class GetRoleManagementPolicyActivationRuleApprovalStage {
  ...
  factory GetRoleManagementPolicyActivationRuleApprovalStage.fromMap(Map<String, dynamic> map) {
    return GetRoleManagementPolicyActivationRuleApprovalStage(
      primaryApprovers: (pulumi.Input.decodeList<GetRoleManagementPolicyActivationRuleApprovalStagePrimaryApprover>(map['primaryApprovers'], (value) => GetRoleManagementPolicyActivationRuleApprovalStagePrimaryApprover.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
