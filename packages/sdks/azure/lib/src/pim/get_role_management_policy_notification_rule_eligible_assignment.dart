...
class GetRoleManagementPolicyNotificationRuleEligibleAssignment {
  ...
  factory GetRoleManagementPolicyNotificationRuleEligibleAssignment.fromMap(
    ...
    return GetRoleManagementPolicyNotificationRuleEligibleAssignment(
      adminNotifications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRoleManagementPolicyNotificationRuleEligibleAssignmentAdminNotification.fromMap(
      ...
      approverNotifications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      assigneeNotifications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
