...
class GetRoleManagementPolicyNotificationRuleEligibleAssignment {
  ...
  factory GetRoleManagementPolicyNotificationRuleEligibleAssignment.fromMap(Map<String, dynamic> map) {
    return GetRoleManagementPolicyNotificationRuleEligibleAssignment(
      adminNotifications: (pulumi.Input.decodeList<GetRoleManagementPolicyNotificationRuleEligibleAssignmentAdminNotification>(map['adminNotifications'], (value) => GetRoleManagementPolicyNotificationRuleEligibleAssignmentAdminNotification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      approverNotifications: (pulumi.Input.decodeList<GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification>(map['approverNotifications'], (value) => GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      assigneeNotifications: (pulumi.Input.decodeList<GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification>(map['assigneeNotifications'], (value) => GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
