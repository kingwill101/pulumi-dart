...
class GetRoleManagementPolicyNotificationRule {
  ...
  factory GetRoleManagementPolicyNotificationRule.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRoleManagementPolicyNotificationRule(
      activeAssignments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRoleManagementPolicyNotificationRuleActiveAssignment
        >(
          map['activeAssignments']!,
          (value) =>
              GetRoleManagementPolicyNotificationRuleActiveAssignment.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      eligibleActivations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRoleManagementPolicyNotificationRuleEligibleActivation
        >(
          map['eligibleActivations']!,
          (value) =>
              GetRoleManagementPolicyNotificationRuleEligibleActivation.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      eligibleAssignments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRoleManagementPolicyNotificationRuleEligibleAssignment
        >(
          map['eligibleAssignments']!,
          (value) =>
              GetRoleManagementPolicyNotificationRuleEligibleAssignment.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
