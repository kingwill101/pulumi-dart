...
class GetWorkspaceCustomParameter {
  ...
  factory GetWorkspaceCustomParameter.fromMap(Map<String, dynamic> map) {
    return GetWorkspaceCustomParameter(
      ...
      privateSubnetName: pulumi.Input.fromValue(map['privateSubnetName'] as String),
      publicIpName: pulumi.Input.fromValue(map['publicIpName'] as String),
      publicSubnetName: pulumi.Input.fromValue(map['publicSubnetName'] as String),
      storageAccountName: pulumi.Input.fromValue(map['storageAccountName'] as String),
      storageAccountSkuName: pulumi.Input.fromValue(map['storageAccountSkuName'] as String),
      virtualNetworkId: pulumi.Input.fromValue(map['virtualNetworkId'] as String),
      vnetAddressPrefix: pulumi.Input.fromValue(map['vnetAddressPrefix'] as String),
    );
  }
}
