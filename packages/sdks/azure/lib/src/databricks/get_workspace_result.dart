...
class GetWorkspaceResult {
  ...
  final List<GetWorkspaceEnhancedSecurityCompliance>
  enhancedSecurityCompliances;
    ...
    return <String, dynamic>{
      ...
      'enhancedSecurityCompliances':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(enhancedSecurityCompliances, (value) => value.toMap()),
      'id': id,
      'location': location,
      'managedDiskIdentities':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(managedDiskIdentities, (value) => value.toMap()),
      'name': name,
      ...
      'storageAccountIdentities':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(storageAccountIdentities, (value) => value.toMap()),
      'tags': ?tags,
  ...
  factory GetWorkspaceResult.fromMap(Map<String, dynamic> map) {
    return GetWorkspaceResult(
      customParameters: pulumi.Input.decodeList<GetWorkspaceCustomParameter>(
        map['customParameters']!,
        (value) => GetWorkspaceCustomParameter.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      enhancedSecurityCompliances:
          pulumi.Input.decodeList<GetWorkspaceEnhancedSecurityCompliance>(
            map['enhancedSecurityCompliances']!,
            (value) => GetWorkspaceEnhancedSecurityCompliance.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      id: map['id'] as String,
      ...
      managedDiskIdentities:
          pulumi.Input.decodeList<GetWorkspaceManagedDiskIdentity>(
            map['managedDiskIdentities']!,
            (value) => GetWorkspaceManagedDiskIdentity.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      storageAccountIdentities:
          pulumi.Input.decodeList<GetWorkspaceStorageAccountIdentity>(
            map['storageAccountIdentities']!,
            (value) => GetWorkspaceStorageAccountIdentity.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      tags: (() {
