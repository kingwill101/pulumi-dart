...
class WorkspaceCustomParameters {
  ...
  factory WorkspaceCustomParameters.fromMap(Map<String, dynamic> map) {
    return WorkspaceCustomParameters(
      ...
      privateSubnetName: (() {
        final guardedValue = map['privateSubnetName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateSubnetNetworkSecurityGroupAssociationId: (() {
        final guardedValue =
            map['privateSubnetNetworkSecurityGroupAssociationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publicIpName: (() {
      ...
      publicSubnetName: (() {
        final guardedValue = map['publicSubnetName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publicSubnetNetworkSecurityGroupAssociationId: (() {
        final guardedValue =
            map['publicSubnetNetworkSecurityGroupAssociationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageAccountName: (() {
