...
class MonitorTagRuleState {
  ...
  factory MonitorTagRuleState.fromMap(Map<String, dynamic> map) {
    return MonitorTagRuleState(
      ...
      logs: (() { final guardedValue = map['logs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MonitorTagRuleLog>(guardedValue, (value) => MonitorTagRuleLog.fromMap((value as Map).cast<String, dynamic>()))); })(),
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MonitorTagRuleMetric>(guardedValue, (value) => MonitorTagRuleMetric.fromMap((value as Map).cast<String, dynamic>()))); })(),
