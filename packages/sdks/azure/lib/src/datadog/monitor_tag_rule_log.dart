...
class MonitorTagRuleLog {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?filters == null ? null : pulumi.Input.encodeList<MonitorTagRuleLogFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
  ...
  factory MonitorTagRuleLog.fromMap(Map<String, dynamic> map) {
    return MonitorTagRuleLog(
      aadLogEnabled: map['aadLogEnabled'] == null ? null : map['aadLogEnabled'] as bool,
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<MonitorTagRuleLogFilter>(map['filters'], (value) => MonitorTagRuleLogFilter.fromMap((value as Map).cast<String, dynamic>())),
      resourceLogEnabled: map['resourceLogEnabled'] == null ? null : map['resourceLogEnabled'] as bool,
