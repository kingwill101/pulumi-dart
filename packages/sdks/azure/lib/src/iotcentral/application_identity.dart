...
class ApplicationIdentity {
  ...
  /// Creates a new [ApplicationIdentity].
  ...
  ApplicationIdentity({this.principalId, this.tenantId, required this.type});
  ...
  factory ApplicationIdentity.fromMap(Map<String, dynamic> map) {
