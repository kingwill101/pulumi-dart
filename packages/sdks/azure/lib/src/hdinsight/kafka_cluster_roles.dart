    ...
    return <String, dynamic>{
      'headNode':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(headNode, (value) => value.toMap()),
      'kafkaManagementNode':
          ?pulumi.Input.mapOptionalInputValue<
            KafkaClusterRolesKafkaManagementNode,
            Map<String, dynamic>
          >(kafkaManagementNode, (value) => value.toMap()),
      'workerNode':
          pulumi.Input.mapInputValue<
            KafkaClusterRolesWorkerNode,
            Map<String, dynamic>
          >(workerNode, (value) => value.toMap()),
      'zookeeperNode':
          pulumi.Input.mapInputValue<
            KafkaClusterRolesZookeeperNode,
            Map<String, dynamic>
          >(zookeeperNode, (value) => value.toMap()),
    };
  }

  factory KafkaClusterRoles.fromMap(Map<String, dynamic> map) {
    return KafkaClusterRoles(
      headNode: pulumi.Input.fromValue(
        KafkaClusterRolesHeadNode.fromMap(
          (map['headNode']! as Map).cast<String, dynamic>(),
        ),
      ),
      kafkaManagementNode: (() {
        final guardedValue = map['kafkaManagementNode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaClusterRolesKafkaManagementNode.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      workerNode: pulumi.Input.fromValue(
        KafkaClusterRolesWorkerNode.fromMap(
          (map['workerNode']! as Map).cast<String, dynamic>(),
        ),
      ),
      zookeeperNode: pulumi.Input.fromValue(
        KafkaClusterRolesZookeeperNode.fromMap(
          (map['zookeeperNode']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
