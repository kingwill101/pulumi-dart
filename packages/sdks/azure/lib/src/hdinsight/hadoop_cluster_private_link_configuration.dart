...
class HadoopClusterPrivateLinkConfiguration {
  ...
  final pulumi.Input<HadoopClusterPrivateLinkConfigurationIpConfiguration>
  ipConfiguration;
  ...
  factory HadoopClusterPrivateLinkConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return HadoopClusterPrivateLinkConfiguration(
      groupId: pulumi.Input.fromValue(map['groupId'] as String),
      ipConfiguration: pulumi.Input.fromValue(
        HadoopClusterPrivateLinkConfigurationIpConfiguration.fromMap(
