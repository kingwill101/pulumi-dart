...
class HBaseClusterMetastoresHive {
  ...
  /// Creates a new [HBaseClusterMetastoresHive].
  ...
  const HBaseClusterMetastoresHive({
  ...
  factory HBaseClusterMetastoresHive.fromMap(Map<String, dynamic> map) {
    return HBaseClusterMetastoresHive(
