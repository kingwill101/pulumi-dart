...
class InteractiveQueryClusterMetastores {
  ...
  InteractiveQueryClusterMetastores({this.ambari, this.hive, this.oozie});
    ...
    return InteractiveQueryClusterMetastores(
      ambari: (() {
        ...
        return pulumi.Input.fromValue(
          InteractiveQueryClusterMetastoresAmbari.fromMap(
      ...
      hive: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InteractiveQueryClusterMetastoresHive.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      oozie: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InteractiveQueryClusterMetastoresOozie.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
