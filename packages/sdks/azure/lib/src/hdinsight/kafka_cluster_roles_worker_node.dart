...
class KafkaClusterRolesWorkerNode {
  ...
  final pulumi.Input<List<KafkaClusterRolesWorkerNodeScriptAction>>?
  scriptActions;
    ...
    return <String, dynamic>{
      ...
      'scriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<KafkaClusterRolesWorkerNodeScriptAction>,
  ...
  factory KafkaClusterRolesWorkerNode.fromMap(Map<String, dynamic> map) {
    return KafkaClusterRolesWorkerNode(
      numberOfDisksPerNode: pulumi.Input.fromValue(
        map['numberOfDisksPerNode'] as int,
      ),
      password: (() {
      ...
      scriptActions: (() {
        final guardedValue = map['scriptActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KafkaClusterRolesWorkerNodeScriptAction>(
            guardedValue,
            (value) => KafkaClusterRolesWorkerNodeScriptAction.fromMap(
