...
class InteractiveQueryClusterPrivateLinkConfigurationIpConfiguration {
  ...
  /// Creates a new [InteractiveQueryClusterPrivateLinkConfigurationIpConfiguration].
  ...
  const InteractiveQueryClusterPrivateLinkConfigurationIpConfiguration({
    required this.name,
    this.primary,
  ...
  factory InteractiveQueryClusterPrivateLinkConfigurationIpConfiguration.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterPrivateLinkConfigurationIpConfiguration(
