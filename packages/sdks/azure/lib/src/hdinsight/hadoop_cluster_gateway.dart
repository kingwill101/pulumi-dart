...
class HadoopClusterGateway {
  ...
  HadoopClusterGateway({required this.password, required this.username});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'password': password, 'username': username};
  }

  factory HadoopClusterGateway.fromMap(Map<String, dynamic> map) {
    return HadoopClusterGateway(
