...
class HadoopClusterRolesEdgeNode {
  ...
  final pulumi.Input<List<HadoopClusterRolesEdgeNodeHttpsEndpoint>>?
  httpsEndpoints;

  /// A `install_script_action` block as defined below.
  final pulumi.Input<List<HadoopClusterRolesEdgeNodeInstallScriptAction>>
  ...
  final pulumi.Input<List<HadoopClusterRolesEdgeNodeUninstallScriptAction>>?
    ...
    return <String, dynamic>{
      'httpsEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<HadoopClusterRolesEdgeNodeHttpsEndpoint>,
      ...
      'installScriptActions':
          pulumi.Input.mapInputValue<
            List<HadoopClusterRolesEdgeNodeInstallScriptAction>,
            List<Map<String, dynamic>>
          >(
            installScriptActions,
            (value) =>
      ...
      'uninstallScriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<HadoopClusterRolesEdgeNodeUninstallScriptAction>,
            List<Map<String, dynamic>>
          >(
            uninstallScriptActions,
            (value) =>
    ...
    return HadoopClusterRolesEdgeNode(
      httpsEndpoints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HadoopClusterRolesEdgeNodeHttpsEndpoint>(
            guardedValue,
            (value) => HadoopClusterRolesEdgeNodeHttpsEndpoint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      installScriptActions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HadoopClusterRolesEdgeNodeInstallScriptAction>(
          map['installScriptActions']!,
          (value) => HadoopClusterRolesEdgeNodeInstallScriptAction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      uninstallScriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => HadoopClusterRolesEdgeNodeUninstallScriptAction.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
