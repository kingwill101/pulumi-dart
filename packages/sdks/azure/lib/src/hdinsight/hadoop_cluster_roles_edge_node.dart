...
class HadoopClusterRolesEdgeNode {
  ...
  final List<HadoopClusterRolesEdgeNodeHttpsEndpoint>? httpsEndpoints;
  /// A `install_script_action` block as defined below.
  final List<HadoopClusterRolesEdgeNodeInstallScriptAction> installScriptActions;
  ...
  final List<HadoopClusterRolesEdgeNodeUninstallScriptAction>? uninstallScriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpsEndpoints': ?httpsEndpoints == null ? null : pulumi.Input.encodeList<HadoopClusterRolesEdgeNodeHttpsEndpoint, Map<String, dynamic>>(httpsEndpoints!, (value) => value.toMap()),
      'installScriptActions': pulumi.Input.encodeList<HadoopClusterRolesEdgeNodeInstallScriptAction, Map<String, dynamic>>(installScriptActions, (value) => value.toMap()),
      'targetInstanceCount': targetInstanceCount,
      'uninstallScriptActions': ?uninstallScriptActions == null ? null : pulumi.Input.encodeList<HadoopClusterRolesEdgeNodeUninstallScriptAction, Map<String, dynamic>>(uninstallScriptActions!, (value) => value.toMap()),
      'vmSize': vmSize,
    };
  }
  ...
  factory HadoopClusterRolesEdgeNode.fromMap(Map<String, dynamic> map) {
    return HadoopClusterRolesEdgeNode(
      httpsEndpoints: map['httpsEndpoints'] == null ? null : pulumi.Input.decodeList<HadoopClusterRolesEdgeNodeHttpsEndpoint>(map['httpsEndpoints'], (value) => HadoopClusterRolesEdgeNodeHttpsEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      installScriptActions: pulumi.Input.decodeList<HadoopClusterRolesEdgeNodeInstallScriptAction>(map['installScriptActions'], (value) => HadoopClusterRolesEdgeNodeInstallScriptAction.fromMap((value as Map).cast<String, dynamic>())),
      targetInstanceCount: map['targetInstanceCount'] as int,
      uninstallScriptActions: map['uninstallScriptActions'] == null ? null : pulumi.Input.decodeList<HadoopClusterRolesEdgeNodeUninstallScriptAction>(map['uninstallScriptActions'], (value) => HadoopClusterRolesEdgeNodeUninstallScriptAction.fromMap((value as Map).cast<String, dynamic>())),
