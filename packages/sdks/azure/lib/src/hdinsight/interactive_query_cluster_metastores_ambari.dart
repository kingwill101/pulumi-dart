...
class InteractiveQueryClusterMetastoresAmbari {
  ...
  /// Creates a new [InteractiveQueryClusterMetastoresAmbari].
  ...
  factory InteractiveQueryClusterMetastoresAmbari.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterMetastoresAmbari(
