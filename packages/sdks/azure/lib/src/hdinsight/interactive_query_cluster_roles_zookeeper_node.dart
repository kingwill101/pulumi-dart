...
class InteractiveQueryClusterRolesZookeeperNode {
  ...
  final pulumi.Input<
    List<InteractiveQueryClusterRolesZookeeperNodeScriptAction>
  >?
  scriptActions;
  ...
  factory InteractiveQueryClusterRolesZookeeperNode.fromMap(
      ...
      scriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                InteractiveQueryClusterRolesZookeeperNodeScriptAction.fromMap(
