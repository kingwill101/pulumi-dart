...
class HadoopClusterArgs {
  ...
  HadoopClusterArgs({
    ...
    required pulumi.Output<HadoopClusterComponentVersion> componentVersion,
    ...
    required pulumi.Output<HadoopClusterGateway> gateway,
    ...
    required pulumi.Output<HadoopClusterRoles> roles,
  ...
  factory HadoopClusterArgs.fromMap(Map<String, dynamic> map) {
    return HadoopClusterArgs(
      ...
      componentVersion: pulumi.Output.create<HadoopClusterComponentVersion>(HadoopClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())),
      ...
      gateway: pulumi.Output.create<HadoopClusterGateway>(HadoopClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())),
      ...
      roles: pulumi.Output.create<HadoopClusterRoles>(HadoopClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())),
