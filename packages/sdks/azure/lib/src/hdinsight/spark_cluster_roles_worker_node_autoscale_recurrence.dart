...
class SparkClusterRolesWorkerNodeAutoscaleRecurrence {
  ...
  final pulumi.Input<
    List<SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule>
  >
  schedules;
  ...
  factory SparkClusterRolesWorkerNodeAutoscaleRecurrence.fromMap(
    ...
    return SparkClusterRolesWorkerNodeAutoscaleRecurrence(
      schedules: pulumi.Input.fromValue(
        ...
        >(
          map['schedules']!,
          (value) =>
              SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule.fromMap(
