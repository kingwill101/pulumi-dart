...
class SparkClusterRolesHeadNode {
  ...
  final pulumi.Input<List<SparkClusterRolesHeadNodeScriptAction>>?
  scriptActions;
    ...
    return <String, dynamic>{
      ...
      'scriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<SparkClusterRolesHeadNodeScriptAction>,
    ...
    return SparkClusterRolesHeadNode(
      ...
      scriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SparkClusterRolesHeadNodeScriptAction>(
            guardedValue,
            (value) => SparkClusterRolesHeadNodeScriptAction.fromMap(
