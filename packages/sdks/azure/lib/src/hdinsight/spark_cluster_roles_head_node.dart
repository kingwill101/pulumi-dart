...
class SparkClusterRolesHeadNode {
  ...
  final List<SparkClusterRolesHeadNodeScriptAction>? scriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?scriptActions == null ? null : pulumi.Input.encodeList<SparkClusterRolesHeadNodeScriptAction, Map<String, dynamic>>(scriptActions!, (value) => value.toMap()),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory SparkClusterRolesHeadNode.fromMap(Map<String, dynamic> map) {
    return SparkClusterRolesHeadNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : pulumi.Input.decodeList<SparkClusterRolesHeadNodeScriptAction>(map['scriptActions'], (value) => SparkClusterRolesHeadNodeScriptAction.fromMap((value as Map).cast<String, dynamic>())),
