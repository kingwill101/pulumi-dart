...
import 'spark_cluster_roles_head_node_script_action.dart';

class SparkClusterRolesHeadNode {
  ...
  final pulumi.Input<List<SparkClusterRolesHeadNodeScriptAction>?>? scriptActions;
  ...
  /// Creates a new [SparkClusterRolesHeadNode].
  ...
  const SparkClusterRolesHeadNode({
    this.password,
    this.scriptActions,
    this.sshKeys,
    this.subnetId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?pulumi.Input.mapOptionalInputValue<List<SparkClusterRolesHeadNodeScriptAction>, List<Map<String, dynamic>>>(scriptActions, (value) => pulumi.Input.encodeList<SparkClusterRolesHeadNodeScriptAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory SparkClusterRolesHeadNode.fromMap(Map<String, dynamic> map) {
    return SparkClusterRolesHeadNode(
      password: (() { final guardedValue = map['password']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scriptActions: (() { final guardedValue = map['scriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SparkClusterRolesHeadNodeScriptAction>(guardedValue, (value) => SparkClusterRolesHeadNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
