...
class SparkClusterState {
  ...
  SparkClusterState({
    ...
    pulumi.Output<SparkClusterComponentVersion>? componentVersion,
    ...
    pulumi.Output<SparkClusterGateway>? gateway,
    ...
    pulumi.Output<SparkClusterRoles>? roles,
    ...
    pulumi.Output<List<String>>? zones,
      ...
      componentVersion = pulumi.Input.asOptionalInput<SparkClusterComponentVersion>(componentVersion),
      ...
      gateway = pulumi.Input.asOptionalInput<SparkClusterGateway>(gateway),
      ...
      roles = pulumi.Input.asOptionalInput<SparkClusterRoles>(roles),
  ...
  factory SparkClusterState.fromMap(Map<String, dynamic> map) {
    return SparkClusterState(
      ...
      componentVersion: map['componentVersion'] == null ? null : pulumi.Output.create<SparkClusterComponentVersion>(SparkClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())),
      ...
      gateway: map['gateway'] == null ? null : pulumi.Output.create<SparkClusterGateway>(SparkClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())),
      ...
      roles: map['roles'] == null ? null : pulumi.Output.create<SparkClusterRoles>(SparkClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())),
