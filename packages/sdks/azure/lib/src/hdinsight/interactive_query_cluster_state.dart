...
class InteractiveQueryClusterState {
  ...
  const InteractiveQueryClusterState({
    this.clusterVersion,
  ...
  factory InteractiveQueryClusterState.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterState(
      ...
      componentVersion: (() { final guardedValue = map['componentVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InteractiveQueryClusterComponentVersion.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      gateway: (() { final guardedValue = map['gateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InteractiveQueryClusterGateway.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      roles: (() { final guardedValue = map['roles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InteractiveQueryClusterRoles.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
