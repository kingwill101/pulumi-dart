...
class InteractiveQueryClusterState {
  ...
  InteractiveQueryClusterState({
    ...
    pulumi.Output<InteractiveQueryClusterComponentVersion>? componentVersion,
    pulumi.Output<InteractiveQueryClusterComputeIsolation>? computeIsolation,
    pulumi.Output<List<InteractiveQueryClusterDiskEncryption>>? diskEncryptions,
    pulumi.Output<bool>? encryptionInTransitEnabled,
    pulumi.Output<InteractiveQueryClusterExtension>? extension,
    pulumi.Output<InteractiveQueryClusterGateway>? gateway,
    pulumi.Output<String>? httpsEndpoint,
    pulumi.Output<String>? location,
    pulumi.Output<InteractiveQueryClusterMetastores>? metastores,
    pulumi.Output<InteractiveQueryClusterMonitor>? monitor,
    pulumi.Output<String>? name,
    pulumi.Output<InteractiveQueryClusterNetwork>? network,
    pulumi.Output<InteractiveQueryClusterPrivateLinkConfiguration>? privateLinkConfiguration,
    pulumi.Output<String>? resourceGroupName,
    pulumi.Output<InteractiveQueryClusterRoles>? roles,
    pulumi.Output<InteractiveQueryClusterSecurityProfile>? securityProfile,
    pulumi.Output<String>? sshEndpoint,
    pulumi.Output<InteractiveQueryClusterStorageAccountGen2>? storageAccountGen2,
    pulumi.Output<List<InteractiveQueryClusterStorageAccount>>? storageAccounts,
    ...
    pulumi.Output<String>? tlsMinVersion,
      ...
      componentVersion = pulumi.Input.asOptionalInput<InteractiveQueryClusterComponentVersion>(componentVersion),
      ...
      gateway = pulumi.Input.asOptionalInput<InteractiveQueryClusterGateway>(gateway),
      ...
      roles = pulumi.Input.asOptionalInput<InteractiveQueryClusterRoles>(roles),
  ...
  factory InteractiveQueryClusterState.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterState(
      ...
      componentVersion: map['componentVersion'] == null ? null : pulumi.Output.create<InteractiveQueryClusterComponentVersion>(InteractiveQueryClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())),
      computeIsolation: map['computeIsolation'] == null ? null : pulumi.Output.create<InteractiveQueryClusterComputeIsolation>(InteractiveQueryClusterComputeIsolation.fromMap((map['computeIsolation'] as Map).cast<String, dynamic>())),
      diskEncryptions: map['diskEncryptions'] == null ? null : pulumi.Output.create<List<InteractiveQueryClusterDiskEncryption>>(pulumi.Input.decodeList<InteractiveQueryClusterDiskEncryption>(map['diskEncryptions'], (value) => InteractiveQueryClusterDiskEncryption.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      extension: map['extension'] == null ? null : pulumi.Output.create<InteractiveQueryClusterExtension>(InteractiveQueryClusterExtension.fromMap((map['extension'] as Map).cast<String, dynamic>())),
      gateway: map['gateway'] == null ? null : pulumi.Output.create<InteractiveQueryClusterGateway>(InteractiveQueryClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())),
      httpsEndpoint: map['httpsEndpoint'] == null ? null : pulumi.Output.create<String>(map['httpsEndpoint'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      metastores: map['metastores'] == null ? null : pulumi.Output.create<InteractiveQueryClusterMetastores>(InteractiveQueryClusterMetastores.fromMap((map['metastores'] as Map).cast<String, dynamic>())),
      monitor: map['monitor'] == null ? null : pulumi.Output.create<InteractiveQueryClusterMonitor>(InteractiveQueryClusterMonitor.fromMap((map['monitor'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<InteractiveQueryClusterNetwork>(InteractiveQueryClusterNetwork.fromMap((map['network'] as Map).cast<String, dynamic>())),
      privateLinkConfiguration: map['privateLinkConfiguration'] == null ? null : pulumi.Output.create<InteractiveQueryClusterPrivateLinkConfiguration>(InteractiveQueryClusterPrivateLinkConfiguration.fromMap((map['privateLinkConfiguration'] as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] == null ? null : pulumi.Output.create<String>(map['resourceGroupName'] as String),
      roles: map['roles'] == null ? null : pulumi.Output.create<InteractiveQueryClusterRoles>(InteractiveQueryClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())),
      securityProfile: map['securityProfile'] == null ? null : pulumi.Output.create<InteractiveQueryClusterSecurityProfile>(InteractiveQueryClusterSecurityProfile.fromMap((map['securityProfile'] as Map).cast<String, dynamic>())),
      sshEndpoint: map['sshEndpoint'] == null ? null : pulumi.Output.create<String>(map['sshEndpoint'] as String),
      storageAccountGen2: map['storageAccountGen2'] == null ? null : pulumi.Output.create<InteractiveQueryClusterStorageAccountGen2>(InteractiveQueryClusterStorageAccountGen2.fromMap((map['storageAccountGen2'] as Map).cast<String, dynamic>())),
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Output.create<List<InteractiveQueryClusterStorageAccount>>(pulumi.Input.decodeList<InteractiveQueryClusterStorageAccount>(map['storageAccounts'], (value) => InteractiveQueryClusterStorageAccount.fromMap((value as Map).cast<String, dynamic>()))),
