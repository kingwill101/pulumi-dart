...
class KafkaClusterMetastoresOozie {
  ...
  /// Creates a new [KafkaClusterMetastoresOozie].
  ...
  factory KafkaClusterMetastoresOozie.fromMap(Map<String, dynamic> map) {
    return KafkaClusterMetastoresOozie(
