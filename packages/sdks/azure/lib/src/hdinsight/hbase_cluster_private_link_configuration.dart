...
class HBaseClusterPrivateLinkConfiguration {
  ...
  final pulumi.Input<HBaseClusterPrivateLinkConfigurationIpConfiguration>
  ipConfiguration;
  ...
  factory HBaseClusterPrivateLinkConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return HBaseClusterPrivateLinkConfiguration(
      groupId: pulumi.Input.fromValue(map['groupId'] as String),
      ipConfiguration: pulumi.Input.fromValue(
        HBaseClusterPrivateLinkConfigurationIpConfiguration.fromMap(
