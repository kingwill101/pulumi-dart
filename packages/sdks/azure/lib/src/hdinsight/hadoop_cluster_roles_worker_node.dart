...
class HadoopClusterRolesWorkerNode {
  ...
  final HadoopClusterRolesWorkerNodeAutoscale? autoscale;
  ...
  final List<HadoopClusterRolesWorkerNodeScriptAction>? scriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'password': ?password,
      'scriptActions': ?scriptActions == null ? null : pulumi.Input.encodeList<HadoopClusterRolesWorkerNodeScriptAction, Map<String, dynamic>>(scriptActions!, (value) => value.toMap()),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
  ...
  factory HadoopClusterRolesWorkerNode.fromMap(Map<String, dynamic> map) {
    return HadoopClusterRolesWorkerNode(
      autoscale: map['autoscale'] == null ? null : HadoopClusterRolesWorkerNodeAutoscale.fromMap((map['autoscale'] as Map).cast<String, dynamic>()),
      password: map['password'] == null ? null : map['password'] as String,
      scriptActions: map['scriptActions'] == null ? null : pulumi.Input.decodeList<HadoopClusterRolesWorkerNodeScriptAction>(map['scriptActions'], (value) => HadoopClusterRolesWorkerNodeScriptAction.fromMap((value as Map).cast<String, dynamic>())),
