...
class HBaseClusterRolesZookeeperNode {
  ...
  final pulumi.Input<List<HBaseClusterRolesZookeeperNodeScriptAction>>?
  scriptActions;
    ...
    return <String, dynamic>{
      ...
      'scriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<HBaseClusterRolesZookeeperNodeScriptAction>,
    ...
    return HBaseClusterRolesZookeeperNode(
      ...
      scriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HBaseClusterRolesZookeeperNodeScriptAction>(
            guardedValue,
            (value) => HBaseClusterRolesZookeeperNodeScriptAction.fromMap(
