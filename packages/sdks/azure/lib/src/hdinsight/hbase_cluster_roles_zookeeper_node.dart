...
class HBaseClusterRolesZookeeperNode {
  ...
  factory HBaseClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return HBaseClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : (pulumi.Input.decodeList<HBaseClusterRolesZookeeperNodeScriptAction>(map['scriptActions']!, (value) => HBaseClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
