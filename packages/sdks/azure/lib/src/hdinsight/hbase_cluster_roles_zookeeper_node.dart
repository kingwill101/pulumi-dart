...
import 'hbase_cluster_roles_zookeeper_node_script_action.dart';

class HBaseClusterRolesZookeeperNode {
  ...
  final pulumi.Input<List<HBaseClusterRolesZookeeperNodeScriptAction>>? scriptActions;
  ...
  /// Creates a new [HBaseClusterRolesZookeeperNode].
  ...
  const HBaseClusterRolesZookeeperNode({
    this.password,
    this.scriptActions,
    this.sshKeys,
    this.subnetId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?pulumi.Input.mapOptionalInputValue<List<HBaseClusterRolesZookeeperNodeScriptAction>, List<Map<String, dynamic>>>(scriptActions, (value) => pulumi.Input.encodeList<HBaseClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory HBaseClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return HBaseClusterRolesZookeeperNode(
      password: (() { final guardedValue = map['password']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scriptActions: (() { final guardedValue = map['scriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HBaseClusterRolesZookeeperNodeScriptAction>(guardedValue, (value) => HBaseClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
