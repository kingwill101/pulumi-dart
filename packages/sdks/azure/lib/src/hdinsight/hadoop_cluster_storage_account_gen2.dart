...
class HadoopClusterStorageAccountGen2 {
  ...
  /// Creates a new [HadoopClusterStorageAccountGen2].
  ...
  const HadoopClusterStorageAccountGen2({
  ...
  factory HadoopClusterStorageAccountGen2.fromMap(Map<String, dynamic> map) {
    return HadoopClusterStorageAccountGen2(
      ...
      managedIdentityResourceId: pulumi.Input.fromValue(map['managedIdentityResourceId'] as String),
