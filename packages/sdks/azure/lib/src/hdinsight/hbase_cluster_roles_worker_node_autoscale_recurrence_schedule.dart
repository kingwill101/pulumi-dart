...
class HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule {
  ...
  /// Creates a new [HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule].
  ...
  const HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule({
    required this.days,
  ...
  factory HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule.fromMap(Map<String, dynamic> map) {
    return HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule(
