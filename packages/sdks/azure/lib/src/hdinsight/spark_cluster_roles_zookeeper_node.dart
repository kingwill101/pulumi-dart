...
class SparkClusterRolesZookeeperNode {
  ...
  final pulumi.Input<List<SparkClusterRolesZookeeperNodeScriptAction>>?
  scriptActions;
    ...
    return <String, dynamic>{
      ...
      'scriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<SparkClusterRolesZookeeperNodeScriptAction>,
    ...
    return SparkClusterRolesZookeeperNode(
      ...
      scriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SparkClusterRolesZookeeperNodeScriptAction>(
            guardedValue,
            (value) => SparkClusterRolesZookeeperNodeScriptAction.fromMap(
