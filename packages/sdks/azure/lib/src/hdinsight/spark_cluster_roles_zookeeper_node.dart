...
import 'spark_cluster_roles_zookeeper_node_script_action.dart';

class SparkClusterRolesZookeeperNode {
  ...
  final pulumi.Input<List<SparkClusterRolesZookeeperNodeScriptAction>>? scriptActions;
  ...
  /// Creates a new [SparkClusterRolesZookeeperNode].
  ...
  const SparkClusterRolesZookeeperNode({
    this.password,
    this.scriptActions,
    this.sshKeys,
    this.subnetId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?pulumi.Input.mapOptionalInputValue<List<SparkClusterRolesZookeeperNodeScriptAction>, List<Map<String, dynamic>>>(scriptActions, (value) => pulumi.Input.encodeList<SparkClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory SparkClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return SparkClusterRolesZookeeperNode(
      password: (() { final guardedValue = map['password']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scriptActions: (() { final guardedValue = map['scriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SparkClusterRolesZookeeperNodeScriptAction>(guardedValue, (value) => SparkClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
