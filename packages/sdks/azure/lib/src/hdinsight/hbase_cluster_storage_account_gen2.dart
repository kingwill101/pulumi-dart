...
class HBaseClusterStorageAccountGen2 {
  ...
  /// Creates a new [HBaseClusterStorageAccountGen2].
  ...
  const HBaseClusterStorageAccountGen2({
  ...
  factory HBaseClusterStorageAccountGen2.fromMap(Map<String, dynamic> map) {
    return HBaseClusterStorageAccountGen2(
