...
class KafkaClusterRolesZookeeperNode {
  ...
  final pulumi.Input<List<KafkaClusterRolesZookeeperNodeScriptAction>>?
  scriptActions;
    ...
    return <String, dynamic>{
      ...
      'scriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<KafkaClusterRolesZookeeperNodeScriptAction>,
    ...
    return KafkaClusterRolesZookeeperNode(
      ...
      scriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KafkaClusterRolesZookeeperNodeScriptAction>(
            guardedValue,
            (value) => KafkaClusterRolesZookeeperNodeScriptAction.fromMap(
