...
import 'kafka_cluster_roles_zookeeper_node_script_action.dart';

class KafkaClusterRolesZookeeperNode {
  ...
  const KafkaClusterRolesZookeeperNode({
    this.password,
    this.scriptActions,
    this.sshKeys,
    this.subnetId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?pulumi.Input.mapOptionalInputValue<List<KafkaClusterRolesZookeeperNodeScriptAction>, List<Map<String, dynamic>>>(scriptActions, (value) => pulumi.Input.encodeList<KafkaClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory KafkaClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return KafkaClusterRolesZookeeperNode(
      password: (() { final guardedValue = map['password']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scriptActions: (() { final guardedValue = map['scriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KafkaClusterRolesZookeeperNodeScriptAction>(guardedValue, (value) => KafkaClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
