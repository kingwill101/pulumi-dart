...
class KafkaClusterRolesZookeeperNode {
  ...
  factory KafkaClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return KafkaClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : (pulumi.Input.decodeList<KafkaClusterRolesZookeeperNodeScriptAction>(map['scriptActions']!, (value) => KafkaClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
