...
class HadoopClusterPrivateLinkConfigurationIpConfiguration {
  ...
  /// Creates a new [HadoopClusterPrivateLinkConfigurationIpConfiguration].
  ...
  factory HadoopClusterPrivateLinkConfigurationIpConfiguration.fromMap(Map<String, dynamic> map) {
    return HadoopClusterPrivateLinkConfigurationIpConfiguration(
