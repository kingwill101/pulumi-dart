...
class HadoopClusterRolesWorkerNodeAutoscale {
  ...
  final pulumi.Input<HadoopClusterRolesWorkerNodeAutoscaleRecurrence>?
  recurrence;
  ...
  HadoopClusterRolesWorkerNodeAutoscale({this.capacity, this.recurrence});
  ...
  factory HadoopClusterRolesWorkerNodeAutoscale.fromMap(
    ...
    return HadoopClusterRolesWorkerNodeAutoscale(
      capacity: (() {
        ...
        return pulumi.Input.fromValue(
          HadoopClusterRolesWorkerNodeAutoscaleCapacity.fromMap(
      ...
      recurrence: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HadoopClusterRolesWorkerNodeAutoscaleRecurrence.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
