...
import 'kafka_cluster_roles_kafka_management_node_script_action.dart';

class KafkaClusterRolesKafkaManagementNode {
  ...
  final pulumi.Input<List<KafkaClusterRolesKafkaManagementNodeScriptAction>>? scriptActions;
  ...
  /// Creates a new [KafkaClusterRolesKafkaManagementNode].
  /// [password] The Password associated with the local administrator for the Kafka Management Nodes. Changing this forces a new resource to be created.
  ...
  /// [sshKeys] A list of SSH Keys which should be used for the local administrator on the Kafka Management Nodes. Changing this forces a new resource to be created.
  /// [subnetId] The ID of the Subnet within the Virtual Network where the Kafka Management Nodes should be provisioned within. Changing this forces a new resource to be created.
  /// [username] The Username of the local administrator for the Kafka Management Nodes.
  /// [virtualNetworkId] The ID of the Virtual Network where the Kafka Management Nodes should be provisioned within. Changing this forces a new resource to be created.
  ...
  const KafkaClusterRolesKafkaManagementNode({
    this.password,
    this.scriptActions,
    this.sshKeys,
    this.subnetId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?pulumi.Input.mapOptionalInputValue<List<KafkaClusterRolesKafkaManagementNodeScriptAction>, List<Map<String, dynamic>>>(scriptActions, (value) => pulumi.Input.encodeList<KafkaClusterRolesKafkaManagementNodeScriptAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': ?username,
  ...
  factory KafkaClusterRolesKafkaManagementNode.fromMap(Map<String, dynamic> map) {
    return KafkaClusterRolesKafkaManagementNode(
      ...
      scriptActions: (() { final guardedValue = map['scriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KafkaClusterRolesKafkaManagementNodeScriptAction>(guardedValue, (value) => KafkaClusterRolesKafkaManagementNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
