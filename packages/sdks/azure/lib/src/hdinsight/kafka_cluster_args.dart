...
class KafkaClusterArgs {
  ...
  KafkaClusterArgs({
    ...
    required pulumi.Output<KafkaClusterComponentVersion> componentVersion,
    ...
    required pulumi.Output<KafkaClusterGateway> gateway,
    ...
    required pulumi.Output<KafkaClusterRoles> roles,
  ...
  factory KafkaClusterArgs.fromMap(Map<String, dynamic> map) {
    return KafkaClusterArgs(
      ...
      componentVersion: pulumi.Output.create<KafkaClusterComponentVersion>(KafkaClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())),
      ...
      gateway: pulumi.Output.create<KafkaClusterGateway>(KafkaClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())),
      ...
      roles: pulumi.Output.create<KafkaClusterRoles>(KafkaClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())),
