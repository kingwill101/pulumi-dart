...
class KafkaClusterArgs {
  ...
  factory KafkaClusterArgs.fromMap(Map<String, dynamic> map) {
    return KafkaClusterArgs(
      ...
      componentVersion: pulumi.Input.fromValue(KafkaClusterComponentVersion.fromMap((map['componentVersion']! as Map).cast<String, dynamic>())),
      ...
      gateway: pulumi.Input.fromValue(KafkaClusterGateway.fromMap((map['gateway']! as Map).cast<String, dynamic>())),
      ...
      roles: pulumi.Input.fromValue(KafkaClusterRoles.fromMap((map['roles']! as Map).cast<String, dynamic>())),
