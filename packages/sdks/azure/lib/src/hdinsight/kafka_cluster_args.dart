...
class KafkaClusterArgs {
  ...
  final pulumi.Input<KafkaClusterPrivateLinkConfiguration>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskEncryptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<KafkaClusterDiskEncryption>,
      ...
      'gateway':
          pulumi.Input.mapInputValue<KafkaClusterGateway, Map<String, dynamic>>(
            gateway,
            (value) => value.toMap(),
          ),
      'location': ?location,
      ...
      'restProxy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(restProxy, (value) => value.toMap()),
      'roles':
          pulumi.Input.mapInputValue<KafkaClusterRoles, Map<String, dynamic>>(
            roles,
            (value) => value.toMap(),
          ),
      'securityProfile':
      ...
      'storageAccounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<KafkaClusterStorageAccount>,
            List<Map<String, dynamic>>
          >(
            storageAccounts,
            (value) =>
  ...
  factory KafkaClusterArgs.fromMap(Map<String, dynamic> map) {
    return KafkaClusterArgs(
      ...
      componentVersion: pulumi.Input.fromValue(
        KafkaClusterComponentVersion.fromMap(
          (map['componentVersion']! as Map).cast<String, dynamic>(),
        ),
      ),
      computeIsolation: (() {
        ...
        return pulumi.Input.fromValue(
          KafkaClusterComputeIsolation.fromMap(
      ...
      diskEncryptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KafkaClusterDiskEncryption>(
            guardedValue,
            (value) => KafkaClusterDiskEncryption.fromMap(
      ...
      extension: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaClusterExtension.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      gateway: pulumi.Input.fromValue(
        KafkaClusterGateway.fromMap(
      ...
      metastores: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaClusterMetastores.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      privateLinkConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaClusterPrivateLinkConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      restProxy: (() {
        final guardedValue = map['restProxy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaClusterRestProxy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      roles: pulumi.Input.fromValue(
        KafkaClusterRoles.fromMap(
          (map['roles']! as Map).cast<String, dynamic>(),
        ),
      ),
      securityProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaClusterSecurityProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      storageAccountGen2: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaClusterStorageAccountGen2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      storageAccounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KafkaClusterStorageAccount>(
            guardedValue,
            (value) => KafkaClusterStorageAccount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
