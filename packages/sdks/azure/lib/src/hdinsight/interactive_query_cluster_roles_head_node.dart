...
class InteractiveQueryClusterRolesHeadNode {
  ...
  final pulumi.Input<List<InteractiveQueryClusterRolesHeadNodeScriptAction>>?
  scriptActions;
    ...
    return <String, dynamic>{
      ...
      'scriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<InteractiveQueryClusterRolesHeadNodeScriptAction>,
  ...
  factory InteractiveQueryClusterRolesHeadNode.fromMap(
    ...
    return InteractiveQueryClusterRolesHeadNode(
      ...
      scriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => InteractiveQueryClusterRolesHeadNodeScriptAction.fromMap(
