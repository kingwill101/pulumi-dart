...
class HBaseClusterArgs {
  ...
  factory HBaseClusterArgs.fromMap(Map<String, dynamic> map) {
    return HBaseClusterArgs(
      ...
      componentVersion: pulumi.Input.fromValue(HBaseClusterComponentVersion.fromMap((map['componentVersion']! as Map).cast<String, dynamic>())),
      ...
      gateway: pulumi.Input.fromValue(HBaseClusterGateway.fromMap((map['gateway']! as Map).cast<String, dynamic>())),
      ...
      roles: pulumi.Input.fromValue(HBaseClusterRoles.fromMap((map['roles']! as Map).cast<String, dynamic>())),
