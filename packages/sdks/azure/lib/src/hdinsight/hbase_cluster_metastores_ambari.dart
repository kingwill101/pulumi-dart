...
class HBaseClusterMetastoresAmbari {
  ...
  /// Creates a new [HBaseClusterMetastoresAmbari].
  ...
  const HBaseClusterMetastoresAmbari({
  ...
  factory HBaseClusterMetastoresAmbari.fromMap(Map<String, dynamic> map) {
    return HBaseClusterMetastoresAmbari(
