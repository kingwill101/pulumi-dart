...
class HadoopClusterStorageAccount {
  ...
  const HadoopClusterStorageAccount({
  ...
  factory HadoopClusterStorageAccount.fromMap(Map<String, dynamic> map) {
    return HadoopClusterStorageAccount(
