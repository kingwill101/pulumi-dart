...
class HBaseClusterRolesWorkerNodeAutoscaleRecurrence {
  ...
  final List<HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule> schedules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'schedules': pulumi.Input.encodeList<HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule, Map<String, dynamic>>(schedules, (value) => value.toMap()),
      'timezone': timezone,
    };
  }
  ...
  factory HBaseClusterRolesWorkerNodeAutoscaleRecurrence.fromMap(Map<String, dynamic> map) {
    return HBaseClusterRolesWorkerNodeAutoscaleRecurrence(
      schedules: pulumi.Input.decodeList<HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule>(map['schedules'], (value) => HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule.fromMap((value as Map).cast<String, dynamic>())),
