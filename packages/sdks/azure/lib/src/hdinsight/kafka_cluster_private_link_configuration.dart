...
class KafkaClusterPrivateLinkConfiguration {
  ...
  final pulumi.Input<KafkaClusterPrivateLinkConfigurationIpConfiguration>
  ipConfiguration;
  ...
  factory KafkaClusterPrivateLinkConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return KafkaClusterPrivateLinkConfiguration(
      groupId: pulumi.Input.fromValue(map['groupId'] as String),
      ipConfiguration: pulumi.Input.fromValue(
        KafkaClusterPrivateLinkConfigurationIpConfiguration.fromMap(
