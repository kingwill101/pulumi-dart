...
class SparkClusterRolesWorkerNodeScriptAction {
  ...
  /// Creates a new [SparkClusterRolesWorkerNodeScriptAction].
  ...
  factory SparkClusterRolesWorkerNodeScriptAction.fromMap(Map<String, dynamic> map) {
    return SparkClusterRolesWorkerNodeScriptAction(
