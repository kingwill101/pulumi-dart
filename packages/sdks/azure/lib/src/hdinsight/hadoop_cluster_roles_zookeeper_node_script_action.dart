...
class HadoopClusterRolesZookeeperNodeScriptAction {
  ...
  /// Creates a new [HadoopClusterRolesZookeeperNodeScriptAction].
  ...
  factory HadoopClusterRolesZookeeperNodeScriptAction.fromMap(
