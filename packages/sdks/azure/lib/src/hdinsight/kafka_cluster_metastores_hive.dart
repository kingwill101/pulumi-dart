...
class KafkaClusterMetastoresHive {
  ...
  /// Creates a new [KafkaClusterMetastoresHive].
  ...
  factory KafkaClusterMetastoresHive.fromMap(Map<String, dynamic> map) {
    return KafkaClusterMetastoresHive(
