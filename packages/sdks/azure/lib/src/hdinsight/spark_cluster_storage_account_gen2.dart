...
class SparkClusterStorageAccountGen2 {
  ...
  /// Creates a new [SparkClusterStorageAccountGen2].
  ...
  const SparkClusterStorageAccountGen2({
  ...
  factory SparkClusterStorageAccountGen2.fromMap(Map<String, dynamic> map) {
    return SparkClusterStorageAccountGen2(
