...
class SparkClusterArgs {
  ...
  factory SparkClusterArgs.fromMap(Map<String, dynamic> map) {
    return SparkClusterArgs(
      ...
      componentVersion: (SparkClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())).input(),
      ...
      gateway: (SparkClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())).input(),
      ...
      roles: (SparkClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())).input(),
