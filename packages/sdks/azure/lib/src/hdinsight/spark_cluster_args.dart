...
class SparkClusterArgs {
  ...
  factory SparkClusterArgs.fromMap(Map<String, dynamic> map) {
    return SparkClusterArgs(
      ...
      componentVersion: pulumi.Input.fromValue(SparkClusterComponentVersion.fromMap((map['componentVersion']! as Map).cast<String, dynamic>())),
      ...
      gateway: pulumi.Input.fromValue(SparkClusterGateway.fromMap((map['gateway']! as Map).cast<String, dynamic>())),
      ...
      roles: pulumi.Input.fromValue(SparkClusterRoles.fromMap((map['roles']! as Map).cast<String, dynamic>())),
