...
class InteractiveQueryClusterArgs {
  ...
  InteractiveQueryClusterArgs({
    ...
    required pulumi.Output<InteractiveQueryClusterComponentVersion> componentVersion,
    ...
    required pulumi.Output<InteractiveQueryClusterGateway> gateway,
    ...
    required pulumi.Output<InteractiveQueryClusterRoles> roles,
  ...
  factory InteractiveQueryClusterArgs.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterArgs(
      ...
      componentVersion: pulumi.Output.create<InteractiveQueryClusterComponentVersion>(InteractiveQueryClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())),
      ...
      gateway: pulumi.Output.create<InteractiveQueryClusterGateway>(InteractiveQueryClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())),
      ...
      roles: pulumi.Output.create<InteractiveQueryClusterRoles>(InteractiveQueryClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())),
