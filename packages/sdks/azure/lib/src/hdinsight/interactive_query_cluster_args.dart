...
class InteractiveQueryClusterArgs {
  ...
  factory InteractiveQueryClusterArgs.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterArgs(
      ...
      componentVersion: (InteractiveQueryClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())).input(),
      ...
      gateway: (InteractiveQueryClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())).input(),
      ...
      roles: (InteractiveQueryClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())).input(),
