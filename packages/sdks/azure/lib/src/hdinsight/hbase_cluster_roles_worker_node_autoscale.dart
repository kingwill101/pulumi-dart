...
class HBaseClusterRolesWorkerNodeAutoscale {
  ...
  final pulumi.Input<HBaseClusterRolesWorkerNodeAutoscaleRecurrence>?
  recurrence;

  /// Creates a new [HBaseClusterRolesWorkerNodeAutoscale].
  /// [recurrence] A `recurrence` block as defined below.
  HBaseClusterRolesWorkerNodeAutoscale({this.recurrence});
  ...
  factory HBaseClusterRolesWorkerNodeAutoscale.fromMap(
    ...
    return HBaseClusterRolesWorkerNodeAutoscale(
      recurrence: (() {
        ...
        return pulumi.Input.fromValue(
          HBaseClusterRolesWorkerNodeAutoscaleRecurrence.fromMap(
