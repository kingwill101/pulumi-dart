...
class SparkClusterRolesWorkerNodeAutoscale {
  ...
  final pulumi.Input<SparkClusterRolesWorkerNodeAutoscaleRecurrence>?
  recurrence;
  ...
  SparkClusterRolesWorkerNodeAutoscale({this.capacity, this.recurrence});
  ...
  factory SparkClusterRolesWorkerNodeAutoscale.fromMap(
    ...
    return SparkClusterRolesWorkerNodeAutoscale(
      capacity: (() {
        ...
        return pulumi.Input.fromValue(
          SparkClusterRolesWorkerNodeAutoscaleCapacity.fromMap(
      ...
      recurrence: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SparkClusterRolesWorkerNodeAutoscaleRecurrence.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
