...
class HBaseClusterState {
  ...
  HBaseClusterState({
    ...
    pulumi.Output<HBaseClusterComponentVersion>? componentVersion,
    ...
    pulumi.Output<HBaseClusterGateway>? gateway,
    ...
    pulumi.Output<HBaseClusterRoles>? roles,
    ...
    pulumi.Output<String>? tlsMinVersion,
      ...
      componentVersion = pulumi.Input.asOptionalInput<HBaseClusterComponentVersion>(componentVersion),
      ...
      gateway = pulumi.Input.asOptionalInput<HBaseClusterGateway>(gateway),
      ...
      roles = pulumi.Input.asOptionalInput<HBaseClusterRoles>(roles),
  ...
  factory HBaseClusterState.fromMap(Map<String, dynamic> map) {
    return HBaseClusterState(
      ...
      componentVersion: map['componentVersion'] == null ? null : pulumi.Output.create<HBaseClusterComponentVersion>(HBaseClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>())),
      ...
      gateway: map['gateway'] == null ? null : pulumi.Output.create<HBaseClusterGateway>(HBaseClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>())),
      ...
      roles: map['roles'] == null ? null : pulumi.Output.create<HBaseClusterRoles>(HBaseClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>())),
