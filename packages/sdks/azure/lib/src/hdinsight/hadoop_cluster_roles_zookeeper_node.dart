...
class HadoopClusterRolesZookeeperNode {
  ...
  factory HadoopClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return HadoopClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : (pulumi.Input.decodeList<HadoopClusterRolesZookeeperNodeScriptAction>(map['scriptActions']!, (value) => HadoopClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
