...
class HadoopClusterRolesZookeeperNode {
  ...
  final pulumi.Input<List<HadoopClusterRolesZookeeperNodeScriptAction>>?
  scriptActions;
    ...
    return <String, dynamic>{
      ...
      'scriptActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<HadoopClusterRolesZookeeperNodeScriptAction>,
    ...
    return HadoopClusterRolesZookeeperNode(
      ...
      scriptActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HadoopClusterRolesZookeeperNodeScriptAction>(
            guardedValue,
            (value) => HadoopClusterRolesZookeeperNodeScriptAction.fromMap(
