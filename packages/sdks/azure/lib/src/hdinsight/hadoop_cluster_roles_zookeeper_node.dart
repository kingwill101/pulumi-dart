...
class HadoopClusterRolesZookeeperNode {
  ...
  final List<HadoopClusterRolesZookeeperNodeScriptAction>? scriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?scriptActions == null ? null : pulumi.Input.encodeList<HadoopClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(scriptActions!, (value) => value.toMap()),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory HadoopClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return HadoopClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : pulumi.Input.decodeList<HadoopClusterRolesZookeeperNodeScriptAction>(map['scriptActions'], (value) => HadoopClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>())),
