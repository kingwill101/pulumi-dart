...
import 'hadoop_cluster_roles_zookeeper_node_script_action.dart';

class HadoopClusterRolesZookeeperNode {
  ...
  final pulumi.Input<List<HadoopClusterRolesZookeeperNodeScriptAction>>? scriptActions;
  ...
  /// Creates a new [HadoopClusterRolesZookeeperNode].
  ...
  const HadoopClusterRolesZookeeperNode({
    this.password,
    this.scriptActions,
    this.sshKeys,
    this.subnetId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?pulumi.Input.mapOptionalInputValue<List<HadoopClusterRolesZookeeperNodeScriptAction>, List<Map<String, dynamic>>>(scriptActions, (value) => pulumi.Input.encodeList<HadoopClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory HadoopClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return HadoopClusterRolesZookeeperNode(
      password: (() { final guardedValue = map['password']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scriptActions: (() { final guardedValue = map['scriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HadoopClusterRolesZookeeperNodeScriptAction>(guardedValue, (value) => HadoopClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
