...
class InteractiveQueryClusterStorageAccount {
  ...
  /// Creates a new [InteractiveQueryClusterStorageAccount].
  ...
  const InteractiveQueryClusterStorageAccount({
  ...
  factory InteractiveQueryClusterStorageAccount.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterStorageAccount(
