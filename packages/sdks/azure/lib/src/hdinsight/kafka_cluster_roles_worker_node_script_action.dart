...
class KafkaClusterRolesWorkerNodeScriptAction {
  ...
  /// Creates a new [KafkaClusterRolesWorkerNodeScriptAction].
  ...
  factory KafkaClusterRolesWorkerNodeScriptAction.fromMap(
