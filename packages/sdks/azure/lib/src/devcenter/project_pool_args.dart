...
class ProjectPoolArgs {
  ...
  factory ProjectPoolArgs.fromMap(Map<String, dynamic> map) {
    return ProjectPoolArgs(
      ...
      devCenterAttachedNetworkName: pulumi.Input.fromValue(map['devCenterAttachedNetworkName'] as String),
      devCenterProjectId: pulumi.Input.fromValue(map['devCenterProjectId'] as String),
      localAdministratorEnabled: pulumi.Input.fromValue(map['localAdministratorEnabled'] as bool),
