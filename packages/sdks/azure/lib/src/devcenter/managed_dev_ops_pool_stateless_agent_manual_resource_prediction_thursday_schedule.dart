...
class ManagedDevOpsPoolStatelessAgentManualResourcePredictionThursdaySchedule {
  ...
  /// Creates a new [ManagedDevOpsPoolStatelessAgentManualResourcePredictionThursdaySchedule].
  ...
  const ManagedDevOpsPoolStatelessAgentManualResourcePredictionThursdaySchedule({
    required this.count,
    required this.time,
  });
  ...
  factory ManagedDevOpsPoolStatelessAgentManualResourcePredictionThursdaySchedule.fromMap(Map<String, dynamic> map) {
    return ManagedDevOpsPoolStatelessAgentManualResourcePredictionThursdaySchedule(
