...
class ProjectEnvironmentTypeState {
  ...
  factory ProjectEnvironmentTypeState.fromMap(Map<String, dynamic> map) {
    return ProjectEnvironmentTypeState(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectEnvironmentTypeIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
