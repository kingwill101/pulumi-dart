    ...
    return <String, dynamic>{
      ...
      'userRoleAssignments':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(userRoleAssignments, (value) => value.toMap()),
    };
  }

  factory GetProjectEnvironmentTypeResult.fromMap(Map<String, dynamic> map) {
    return GetProjectEnvironmentTypeResult(
      creatorRoleAssignmentRoles: (map['creatorRoleAssignmentRoles'] as List)
          .cast<String>(),
      deploymentTargetId: map['deploymentTargetId'] as String,
      devCenterProjectId: map['devCenterProjectId'] as String,
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetProjectEnvironmentTypeIdentity>(
        map['identities']!,
        (value) => GetProjectEnvironmentTypeIdentity.fromMap(
      ...
      userRoleAssignments:
          pulumi.Input.decodeList<GetProjectEnvironmentTypeUserRoleAssignment>(
            map['userRoleAssignments']!,
            (value) => GetProjectEnvironmentTypeUserRoleAssignment.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
    );
