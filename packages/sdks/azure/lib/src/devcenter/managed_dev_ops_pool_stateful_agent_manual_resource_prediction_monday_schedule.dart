...
class ManagedDevOpsPoolStatefulAgentManualResourcePredictionMondaySchedule {
  ...
  /// Creates a new [ManagedDevOpsPoolStatefulAgentManualResourcePredictionMondaySchedule].
  ...
  const ManagedDevOpsPoolStatefulAgentManualResourcePredictionMondaySchedule({
    required this.count,
    required this.time,
  });
  ...
  factory ManagedDevOpsPoolStatefulAgentManualResourcePredictionMondaySchedule.fromMap(Map<String, dynamic> map) {
    return ManagedDevOpsPoolStatefulAgentManualResourcePredictionMondaySchedule(
