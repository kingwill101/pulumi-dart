...
class ManagedDevOpsPoolStatelessAgentManualResourcePredictionSundaySchedule {
  ...
  /// Creates a new [ManagedDevOpsPoolStatelessAgentManualResourcePredictionSundaySchedule].
  ...
  const ManagedDevOpsPoolStatelessAgentManualResourcePredictionSundaySchedule({
    required this.count,
    required this.time,
  });
  ...
  factory ManagedDevOpsPoolStatelessAgentManualResourcePredictionSundaySchedule.fromMap(Map<String, dynamic> map) {
    return ManagedDevOpsPoolStatelessAgentManualResourcePredictionSundaySchedule(
