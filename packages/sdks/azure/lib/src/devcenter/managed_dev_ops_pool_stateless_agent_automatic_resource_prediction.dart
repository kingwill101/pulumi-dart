...
class ManagedDevOpsPoolStatelessAgentAutomaticResourcePrediction {
  ...
  const ManagedDevOpsPoolStatelessAgentAutomaticResourcePrediction({
  ...
  factory ManagedDevOpsPoolStatelessAgentAutomaticResourcePrediction.fromMap(Map<String, dynamic> map) {
    return ManagedDevOpsPoolStatelessAgentAutomaticResourcePrediction(
