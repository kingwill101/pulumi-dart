  ...
  factory ProjectPoolState.fromMap(Map<String, dynamic> map) {
    return ProjectPoolState(
      ...
      devCenterAttachedNetworkName: (() {
        final guardedValue = map['devCenterAttachedNetworkName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      devCenterProjectId: (() {
      ...
      localAdministratorEnabled: (() {
        final guardedValue = map['localAdministratorEnabled'];
        if (guardedValue == null) return null;
      ...
      stopOnDisconnectGracePeriodMinutes: (() {
        final guardedValue = map['stopOnDisconnectGracePeriodMinutes'];
        if (guardedValue == null) return null;
