...
class ProjectPoolState {
  ...
  factory ProjectPoolState.fromMap(Map<String, dynamic> map) {
    return ProjectPoolState(
      ...
      stopOnDisconnectGracePeriodMinutes: (() { final guardedValue = map['stopOnDisconnectGracePeriodMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
