...
class GetCatalogResult {
    ...
    return <String, dynamic>{
      'catalogAdogits':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(catalogAdogits, (value) => value.toMap()),
      'catalogGithubs':
          pulumi.Input.encodeList<
            GetCatalogCatalogGithub,
            Map<String, dynamic>
          >(catalogGithubs, (value) => value.toMap()),
  ...
  factory GetCatalogResult.fromMap(Map<String, dynamic> map) {
    return GetCatalogResult(
      catalogAdogits: pulumi.Input.decodeList<GetCatalogCatalogAdogit>(
        map['catalogAdogits']!,
        (value) => GetCatalogCatalogAdogit.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      catalogGithubs: pulumi.Input.decodeList<GetCatalogCatalogGithub>(
        map['catalogGithubs']!,
        (value) => GetCatalogCatalogGithub.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
