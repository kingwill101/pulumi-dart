...
/// {@template pulumi_devcenter_managed_dev_ops_pool_managed_dev_ops_pool_args_doc}
/// The set of arguments for ManagedDevOpsPool.
/// {@endtemplate}
/// {@macro pulumi_devcenter_managed_dev_ops_pool_managed_dev_ops_pool_args_doc}
class ManagedDevOpsPoolArgs {
  ...
  const ManagedDevOpsPoolArgs({
    required this.azureDevopsOrganization,
    ...
    this.statelessAgent,
    this.tags,
    required this.virtualMachineScaleSetFabric,
    this.workFolder,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'azureDevopsOrganization': pulumi.Input.mapInputValue<ManagedDevOpsPoolAzureDevopsOrganization, Map<String, dynamic>>(azureDevopsOrganization, (value) => value.toMap()),
      ...
      'tags': ?tags,
      'virtualMachineScaleSetFabric': pulumi.Input.mapInputValue<ManagedDevOpsPoolVirtualMachineScaleSetFabric, Map<String, dynamic>>(virtualMachineScaleSetFabric, (value) => value.toMap()),
      'workFolder': ?workFolder,
    };
  }

  factory ManagedDevOpsPoolArgs.fromMap(Map<String, dynamic> map) {
    return ManagedDevOpsPoolArgs(
      azureDevopsOrganization: pulumi.Input.fromValue(ManagedDevOpsPoolAzureDevopsOrganization.fromMap((map['azureDevopsOrganization']! as Map).cast<String, dynamic>())),
      ...
      virtualMachineScaleSetFabric: pulumi.Input.fromValue(ManagedDevOpsPoolVirtualMachineScaleSetFabric.fromMap((map['virtualMachineScaleSetFabric']! as Map).cast<String, dynamic>())),
