...
import 'workspace_key_state.dart';
...
class WorkspaceKey extends pulumi.CustomResource {
  ...
  /// Gets an existing [WorkspaceKey] resource's state with the given [name] and [id].
  static WorkspaceKey get(
    String name,
    pulumi.Input<String> id, {
    WorkspaceKeyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WorkspaceKey._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WorkspaceKey] resource.
  WorkspaceKey.reference(String urn)
    : super(
        'azure:synapse/workspaceKey:WorkspaceKey',
