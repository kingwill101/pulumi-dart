    ...
    return <String, dynamic>{
      ...
      'libraryRequirement':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(libraryRequirement, (value) => value.toMap()),
  ...
  factory SparkPoolState.fromMap(Map<String, dynamic> map) {
    return SparkPoolState(
      ...
      dynamicExecutorAllocationEnabled: (() {
        final guardedValue = map['dynamicExecutorAllocationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      libraryRequirement: (() {
        final guardedValue = map['libraryRequirement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SparkPoolLibraryRequirement.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sparkLogFolder: (() {
        final guardedValue = map['sparkLogFolder'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sparkVersion: (() {
