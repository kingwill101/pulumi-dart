...
class SparkPoolState {
  ...
  factory SparkPoolState.fromMap(Map<String, dynamic> map) {
    return SparkPoolState(
      autoPause: map['autoPause'] == null ? null : (SparkPoolAutoPause.fromMap((map['autoPause'] as Map).cast<String, dynamic>())).input(),
      autoScale: map['autoScale'] == null ? null : (SparkPoolAutoScale.fromMap((map['autoScale'] as Map).cast<String, dynamic>())).input(),
      ...
      dynamicExecutorAllocationEnabled: map['dynamicExecutorAllocationEnabled'] == null ? null : (map['dynamicExecutorAllocationEnabled'] as bool).input(),
      libraryRequirement: map['libraryRequirement'] == null ? null : (SparkPoolLibraryRequirement.fromMap((map['libraryRequirement'] as Map).cast<String, dynamic>())).input(),
      ...
      sparkConfig: map['sparkConfig'] == null ? null : (SparkPoolSparkConfig.fromMap((map['sparkConfig'] as Map).cast<String, dynamic>())).input(),
      sparkEventsFolder: map['sparkEventsFolder'] == null ? null : (map['sparkEventsFolder'] as String).input(),
      sparkLogFolder: map['sparkLogFolder'] == null ? null : (map['sparkLogFolder'] as String).input(),
