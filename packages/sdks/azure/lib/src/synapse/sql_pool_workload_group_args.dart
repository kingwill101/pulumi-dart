...
class SqlPoolWorkloadGroupArgs {
  ...
  factory SqlPoolWorkloadGroupArgs.fromMap(Map<String, dynamic> map) {
    return SqlPoolWorkloadGroupArgs(
      ...
      maxResourcePercent: pulumi.Input.fromValue(
        map['maxResourcePercent'] as int,
      ),
      ...
      minResourcePercent: pulumi.Input.fromValue(
        map['minResourcePercent'] as int,
      ),
      minResourcePercentPerRequest: (() {
        final guardedValue = map['minResourcePercentPerRequest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      name: (() {
      ...
      queryExecutionTimeoutInSeconds: (() {
        final guardedValue = map['queryExecutionTimeoutInSeconds'];
        if (guardedValue == null) return null;
