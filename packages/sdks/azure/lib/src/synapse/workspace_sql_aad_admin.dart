...
import 'workspace_sql_aad_admin_state.dart';
...
///   }
/// }
/// resource "azure_synapse_workspacesqlaadadmin" "example" {
...
class WorkspaceSqlAadAdmin extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [WorkspaceSqlAadAdmin]. {@macro pulumi_synapse_workspace_sql_aad_admin_workspace_sql_aad_admin_args_doc}
  ...
  static WorkspaceSqlAadAdmin get(
    String name,
    pulumi.Input<String> id, {
    WorkspaceSqlAadAdminState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WorkspaceSqlAadAdmin._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WorkspaceSqlAadAdmin] resource.
  WorkspaceSqlAadAdmin.reference(String urn)
    : super(
        'azure:synapse/workspaceSqlAadAdmin:WorkspaceSqlAadAdmin',
