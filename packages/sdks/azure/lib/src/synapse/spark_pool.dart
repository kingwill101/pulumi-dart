...
class SparkPool extends pulumi.CustomResource {
  ...
  SparkPool(
    ...
    this.autoPause = registerOutput<SparkPoolAutoPause?>('autoPause');
    this.autoScale = registerOutput<SparkPoolAutoScale?>('autoScale');
    this.cacheSize = registerOutput<int?>('cacheSize');
    this.computeIsolationEnabled = registerOutput<bool?>('computeIsolationEnabled');
    this.dynamicExecutorAllocationEnabled = registerOutput<bool?>('dynamicExecutorAllocationEnabled');
    this.libraryRequirement = registerOutput<SparkPoolLibraryRequirement?>('libraryRequirement');
    this.maxExecutors = registerOutput<int?>('maxExecutors');
    this.minExecutors = registerOutput<int?>('minExecutors');
    ...
    this.sparkConfig = registerOutput<SparkPoolSparkConfig?>('sparkConfig');
    this.sparkEventsFolder = registerOutput<String?>('sparkEventsFolder');
    this.sparkLogFolder = registerOutput<String?>('sparkLogFolder');
