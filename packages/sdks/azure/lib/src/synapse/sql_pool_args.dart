...
class SqlPoolArgs {
  ...
  factory SqlPoolArgs.fromMap(Map<String, dynamic> map) {
    return SqlPoolArgs(
      ...
      dataEncrypted: (() {
        final guardedValue = map['dataEncrypted'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      geoBackupPolicyEnabled: (() {
        final guardedValue = map['geoBackupPolicyEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: (() {
      ...
      recoveryDatabaseId: (() {
        final guardedValue = map['recoveryDatabaseId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      restore: (() {
        ...
        return pulumi.Input.fromValue(
          SqlPoolRestore.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
