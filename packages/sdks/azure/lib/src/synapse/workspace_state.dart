...
class WorkspaceState {
  ...
  factory WorkspaceState.fromMap(Map<String, dynamic> map) {
    return WorkspaceState(
      ...
      connectivityEndpoints: map['connectivityEndpoints'] == null ? null : ((map['connectivityEndpoints'] as Map).cast<String, String>()).input(),
      ...
      storageDataLakeGen2FilesystemId: map['storageDataLakeGen2FilesystemId'] == null ? null : (map['storageDataLakeGen2FilesystemId'] as String).input(),
