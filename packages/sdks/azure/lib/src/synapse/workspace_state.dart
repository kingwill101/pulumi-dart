...
class WorkspaceState {
  ...
  WorkspaceState({
    ...
    pulumi.Output<Map<String, String>>? connectivityEndpoints,
    ...
    pulumi.Output<String>? storageDataLakeGen2FilesystemId,
    pulumi.Output<Map<String, String>>? tags,
      ...
      connectivityEndpoints = pulumi.Input.asOptionalInput<Map<String, String>>(connectivityEndpoints),
      ...
      storageDataLakeGen2FilesystemId = pulumi.Input.asOptionalInput<String>(storageDataLakeGen2FilesystemId),
  ...
  factory WorkspaceState.fromMap(Map<String, dynamic> map) {
    return WorkspaceState(
      ...
      connectivityEndpoints: map['connectivityEndpoints'] == null ? null : pulumi.Output.create<Map<String, String>>((map['connectivityEndpoints'] as Map).cast<String, String>()),
      ...
      storageDataLakeGen2FilesystemId: map['storageDataLakeGen2FilesystemId'] == null ? null : pulumi.Output.create<String>(map['storageDataLakeGen2FilesystemId'] as String),
