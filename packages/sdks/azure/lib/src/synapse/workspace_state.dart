...
class WorkspaceState {
  ...
  factory WorkspaceState.fromMap(Map<String, dynamic> map) {
    return WorkspaceState(
      ...
      connectivityEndpoints: (() { final guardedValue = map['connectivityEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      storageDataLakeGen2FilesystemId: (() { final guardedValue = map['storageDataLakeGen2FilesystemId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
