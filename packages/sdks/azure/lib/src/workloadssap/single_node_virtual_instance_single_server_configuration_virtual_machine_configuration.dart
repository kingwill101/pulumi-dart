...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfiguration {
  ...
  factory SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfiguration.fromMap(Map<String, dynamic> map) {
    return SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfiguration(
      image: pulumi.Input.fromValue(SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImage.fromMap((map['image']! as Map).cast<String, dynamic>())),
      osProfile: pulumi.Input.fromValue(SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationOsProfile.fromMap((map['osProfile']! as Map).cast<String, dynamic>())),
