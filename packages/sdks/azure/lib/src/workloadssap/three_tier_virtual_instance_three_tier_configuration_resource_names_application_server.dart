...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServer {
  ...
  final List<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServerVirtualMachine>? virtualMachines;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualMachines': ?virtualMachines == null ? null : pulumi.Input.encodeList<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServerVirtualMachine, Map<String, dynamic>>(virtualMachines!, (value) => value.toMap()),
    };
  }
