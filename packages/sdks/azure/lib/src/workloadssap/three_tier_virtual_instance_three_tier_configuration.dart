    ...
    return <String, dynamic>{
      ...
      'applicationServerConfiguration':
          pulumi.Input.mapInputValue<
            ThreeTierVirtualInstanceThreeTierConfigurationApplicationServerConfiguration,
            Map<String, dynamic>
          >(applicationServerConfiguration, (value) => value.toMap()),
      'centralServerConfiguration':
          pulumi.Input.mapInputValue<
            ThreeTierVirtualInstanceThreeTierConfigurationCentralServerConfiguration,
            Map<String, dynamic>
          >(centralServerConfiguration, (value) => value.toMap()),
      'databaseServerConfiguration':
          pulumi.Input.mapInputValue<
            ThreeTierVirtualInstanceThreeTierConfigurationDatabaseServerConfiguration,
            Map<String, dynamic>
          >(databaseServerConfiguration, (value) => value.toMap()),
      'highAvailabilityType': ?highAvailabilityType,
      'resourceNames':
          ?pulumi.Input.mapOptionalInputValue<
            ThreeTierVirtualInstanceThreeTierConfigurationResourceNames,
            Map<String, dynamic>
          >(resourceNames, (value) => value.toMap()),
      'secondaryIpEnabled': ?secondaryIpEnabled,
      'transportCreateAndMount':
          ?pulumi.Input.mapOptionalInputValue<
            ThreeTierVirtualInstanceThreeTierConfigurationTransportCreateAndMount,
            Map<String, dynamic>
          >(transportCreateAndMount, (value) => value.toMap()),
    };
  }

  factory ThreeTierVirtualInstanceThreeTierConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return ThreeTierVirtualInstanceThreeTierConfiguration(
      appResourceGroupName: pulumi.Input.fromValue(
        map['appResourceGroupName'] as String,
      ),
      applicationServerConfiguration: pulumi.Input.fromValue(
        ThreeTierVirtualInstanceThreeTierConfigurationApplicationServerConfiguration.fromMap(
          (map['applicationServerConfiguration']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      centralServerConfiguration: pulumi.Input.fromValue(
        ThreeTierVirtualInstanceThreeTierConfigurationCentralServerConfiguration.fromMap(
          (map['centralServerConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      databaseServerConfiguration: pulumi.Input.fromValue(
        ThreeTierVirtualInstanceThreeTierConfigurationDatabaseServerConfiguration.fromMap(
          (map['databaseServerConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      resourceNames: (() {
        ...
        return pulumi.Input.fromValue(
          ThreeTierVirtualInstanceThreeTierConfigurationResourceNames.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      secondaryIpEnabled: (() {
        final guardedValue = map['secondaryIpEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      transportCreateAndMount: (() {
        final guardedValue = map['transportCreateAndMount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ThreeTierVirtualInstanceThreeTierConfigurationTransportCreateAndMount.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
