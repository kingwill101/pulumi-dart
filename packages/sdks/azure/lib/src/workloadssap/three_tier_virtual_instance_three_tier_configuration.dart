...
class ThreeTierVirtualInstanceThreeTierConfiguration {
  ...
  /// [applicationServerConfiguration] An `applicationServerConfiguration` block as defined below. Changing this forces a new resource to be created.
  /// [centralServerConfiguration] A `centralServerConfiguration` block as defined below. Changing this forces a new resource to be created.
  /// [databaseServerConfiguration] A `databaseServerConfiguration` block as defined below. Changing this forces a new resource to be created.
  ...
  /// [resourceNames] A `resourceNames` block as defined below. Changing this forces a new resource to be created.
  ...
  /// [transportCreateAndMount] A `transportCreateAndMount` block as defined below. Changing this forces a new resource to be created.
