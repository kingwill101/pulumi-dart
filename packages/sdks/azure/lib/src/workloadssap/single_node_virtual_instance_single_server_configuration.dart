    ...
    return <String, dynamic>{
      ...
      'virtualMachineResourceNames':
          ?pulumi.Input.mapOptionalInputValue<
            SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames,
            Map<String, dynamic>
          >(virtualMachineResourceNames, (value) => value.toMap()),
    };
  }

  factory SingleNodeVirtualInstanceSingleServerConfiguration.fromMap(
    ...
    return SingleNodeVirtualInstanceSingleServerConfiguration(
      ...
      diskVolumeConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SingleNodeVirtualInstanceSingleServerConfigurationDiskVolumeConfiguration.fromMap(
      ...
      virtualMachineConfiguration: pulumi.Input.fromValue(
        SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfiguration.fromMap(
          (map['virtualMachineConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      virtualMachineResourceNames: (() {
        final guardedValue = map['virtualMachineResourceNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames.fromMap(
