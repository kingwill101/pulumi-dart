...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesDatabaseServer {
  ...
  factory ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesDatabaseServer.fromMap(
    ...
    return ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesDatabaseServer(
      ...
      loadBalancer: (() {
        ...
        return pulumi.Input.fromValue(
          ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesDatabaseServerLoadBalancer.fromMap(
      ...
      virtualMachines: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesDatabaseServerVirtualMachine.fromMap(
