...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNames {
  ...
  factory ThreeTierVirtualInstanceThreeTierConfigurationResourceNames.fromMap(
    ...
    return ThreeTierVirtualInstanceThreeTierConfigurationResourceNames(
      applicationServer: (() {
        ...
        return pulumi.Input.fromValue(
          ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServer.fromMap(
      ...
      centralServer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServer.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      databaseServer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesDatabaseServer.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sharedStorage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesSharedStorage.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
