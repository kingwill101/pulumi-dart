...
class SingleNodeVirtualInstanceState {
  ...
  factory SingleNodeVirtualInstanceState.fromMap(Map<String, dynamic> map) {
    return SingleNodeVirtualInstanceState(
      ...
      singleServerConfiguration: (() { final guardedValue = map['singleServerConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SingleNodeVirtualInstanceSingleServerConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
