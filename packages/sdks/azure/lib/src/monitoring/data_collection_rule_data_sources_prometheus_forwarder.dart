...
class DataCollectionRuleDataSourcesPrometheusForwarder {
  ...
  const DataCollectionRuleDataSourcesPrometheusForwarder({
  ...
  factory DataCollectionRuleDataSourcesPrometheusForwarder.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleDataSourcesPrometheusForwarder(
      labelIncludeFilters: (() { final guardedValue = map['labelIncludeFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DataCollectionRuleDataSourcesPrometheusForwarderLabelIncludeFilter>(guardedValue, (value) => DataCollectionRuleDataSourcesPrometheusForwarderLabelIncludeFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
