...
class AutoscaleSettingNotification {
  ...
  AutoscaleSettingNotification({this.email, this.webhooks});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'webhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutoscaleSettingNotificationWebhook>,
    ...
    return AutoscaleSettingNotification(
      email: (() {
        ...
        return pulumi.Input.fromValue(
          AutoscaleSettingNotificationEmail.fromMap(
      ...
      webhooks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutoscaleSettingNotificationWebhook>(
            guardedValue,
            (value) => AutoscaleSettingNotificationWebhook.fromMap(
