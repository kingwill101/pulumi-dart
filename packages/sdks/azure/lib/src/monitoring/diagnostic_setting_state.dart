...
class DiagnosticSettingState {
  ...
  factory DiagnosticSettingState.fromMap(Map<String, dynamic> map) {
    return DiagnosticSettingState(
      enabledLogs: (() { final guardedValue = map['enabledLogs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DiagnosticSettingEnabledLog>(guardedValue, (value) => DiagnosticSettingEnabledLog.fromMap((value as Map).cast<String, dynamic>()))); })(),
      enabledMetrics: (() { final guardedValue = map['enabledMetrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DiagnosticSettingEnabledMetric>(guardedValue, (value) => DiagnosticSettingEnabledMetric.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DiagnosticSettingMetric>(guardedValue, (value) => DiagnosticSettingMetric.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      partnerSolutionId: (() { final guardedValue = map['partnerSolutionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
