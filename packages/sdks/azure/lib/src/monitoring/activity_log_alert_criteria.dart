...
class ActivityLogAlertCriteria {
  ...
  factory ActivityLogAlertCriteria.fromMap(Map<String, dynamic> map) {
    return ActivityLogAlertCriteria(
      ...
      levels: (() { final guardedValue = map['levels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      recommendationCategory: (() { final guardedValue = map['recommendationCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      recommendationImpact: (() { final guardedValue = map['recommendationImpact']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      recommendationType: (() { final guardedValue = map['recommendationType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      resourceHealth: (() { final guardedValue = map['resourceHealth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ActivityLogAlertCriteriaResourceHealth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceProvider: (() { final guardedValue = map['resourceProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceProviders: (() { final guardedValue = map['resourceProviders']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      serviceHealth: (() { final guardedValue = map['serviceHealth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ActivityLogAlertCriteriaServiceHealth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      subStatuses: (() { final guardedValue = map['subStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
