...
class AlertProcessingRuleActionGroupSchedule {
  ...
  factory AlertProcessingRuleActionGroupSchedule.fromMap(Map<String, dynamic> map) {
    return AlertProcessingRuleActionGroupSchedule(
      ...
      recurrence: (() { final guardedValue = map['recurrence']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertProcessingRuleActionGroupScheduleRecurrence.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
