...
class AlertProcessingRuleActionGroupSchedule {
  ...
  final pulumi.Input<AlertProcessingRuleActionGroupScheduleRecurrence>?
  recurrence;
  ...
  factory AlertProcessingRuleActionGroupSchedule.fromMap(
    ...
    return AlertProcessingRuleActionGroupSchedule(
      ...
      recurrence: (() {
        ...
        return pulumi.Input.fromValue(
          AlertProcessingRuleActionGroupScheduleRecurrence.fromMap(
