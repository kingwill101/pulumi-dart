...
class AlertProcessingRuleActionGroupSchedule {
  ...
  final AlertProcessingRuleActionGroupScheduleRecurrence? recurrence;
  ...
  factory AlertProcessingRuleActionGroupSchedule.fromMap(Map<String, dynamic> map) {
    return AlertProcessingRuleActionGroupSchedule(
      ...
      recurrence: map['recurrence'] == null ? null : AlertProcessingRuleActionGroupScheduleRecurrence.fromMap((map['recurrence'] as Map).cast<String, dynamic>()),
