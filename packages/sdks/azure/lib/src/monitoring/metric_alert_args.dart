...
class MetricAlertArgs {
  ...
  factory MetricAlertArgs.fromMap(Map<String, dynamic> map) {
    return MetricAlertArgs(
      ...
      applicationInsightsWebTestLocationAvailabilityCriteria: (() { final guardedValue = map['applicationInsightsWebTestLocationAvailabilityCriteria']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteria.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      criterias: (() { final guardedValue = map['criterias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricAlertCriteria>(guardedValue, (value) => MetricAlertCriteria.fromMap((value as Map).cast<String, dynamic>()))); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dynamicCriteria: (() { final guardedValue = map['dynamicCriteria']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricAlertDynamicCriteria.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      windowSize: (() { final guardedValue = map['windowSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
