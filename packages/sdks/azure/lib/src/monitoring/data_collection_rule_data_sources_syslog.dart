...
class DataCollectionRuleDataSourcesSyslog {
  ...
  const DataCollectionRuleDataSourcesSyslog({
  ...
  factory DataCollectionRuleDataSourcesSyslog.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleDataSourcesSyslog(
      facilityNames: pulumi.Input.fromValue((map['facilityNames'] as List).cast<String>()),
      logLevels: pulumi.Input.fromValue((map['logLevels'] as List).cast<String>()),
