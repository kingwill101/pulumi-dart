...
class ScheduledQueryRulesAlertState {
  ...
  factory ScheduledQueryRulesAlertState.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertState(
      action: map['action'] == null ? null : (ScheduledQueryRulesAlertAction.fromMap((map['action'] as Map).cast<String, dynamic>())).input(),
      ...
      timeWindow: map['timeWindow'] == null ? null : (map['timeWindow'] as int).input(),
      trigger: map['trigger'] == null ? null : (ScheduledQueryRulesAlertTrigger.fromMap((map['trigger'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
