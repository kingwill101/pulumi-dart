...
class ScheduledQueryRulesAlertState {
  ...
  ScheduledQueryRulesAlertState({
    pulumi.Output<ScheduledQueryRulesAlertAction>? action,
    ...
    pulumi.Output<int>? timeWindow,
    pulumi.Output<ScheduledQueryRulesAlertTrigger>? trigger,
  }) :
      action = pulumi.Input.asOptionalInput<ScheduledQueryRulesAlertAction>(action),
      ...
      timeWindow = pulumi.Input.asOptionalInput<int>(timeWindow),
      trigger = pulumi.Input.asOptionalInput<ScheduledQueryRulesAlertTrigger>(trigger);
  ...
  factory ScheduledQueryRulesAlertState.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertState(
      action: map['action'] == null ? null : pulumi.Output.create<ScheduledQueryRulesAlertAction>(ScheduledQueryRulesAlertAction.fromMap((map['action'] as Map).cast<String, dynamic>())),
      ...
      timeWindow: map['timeWindow'] == null ? null : pulumi.Output.create<int>(map['timeWindow'] as int),
      trigger: map['trigger'] == null ? null : pulumi.Output.create<ScheduledQueryRulesAlertTrigger>(ScheduledQueryRulesAlertTrigger.fromMap((map['trigger'] as Map).cast<String, dynamic>())),
    );
  }
}
