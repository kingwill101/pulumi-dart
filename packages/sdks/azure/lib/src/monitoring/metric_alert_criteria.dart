...
class MetricAlertCriteria {
  ...
  factory MetricAlertCriteria.fromMap(Map<String, dynamic> map) {
    return MetricAlertCriteria(
      ...
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricAlertCriteriaDimension>(guardedValue, (value) => MetricAlertCriteriaDimension.fromMap((value as Map).cast<String, dynamic>()))); })(),
