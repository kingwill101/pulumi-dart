...
class DataCollectionRuleDataSources {
  ...
  final pulumi.Input<List<DataCollectionRuleDataSourcesPerformanceCounter>>?
  performanceCounters;

  /// One or more `platform_telemetry` blocks as defined below.
  final pulumi.Input<List<DataCollectionRuleDataSourcesPlatformTelemetry>>?
  platformTelemetries;

  /// One or more `prometheus_forwarder` blocks as defined below.
  final pulumi.Input<List<DataCollectionRuleDataSourcesPrometheusForwarder>>?
  ...
  final pulumi.Input<List<DataCollectionRuleDataSourcesWindowsEventLog>>?
  windowsEventLogs;

  /// One or more `windows_firewall_log` blocks as defined below.
  final pulumi.Input<List<DataCollectionRuleDataSourcesWindowsFirewallLog>>?
  windowsFirewallLogs;
    ...
    return <String, dynamic>{
      'dataImport':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataImport, (value) => value.toMap()),
      'extensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesExtension>,
      ...
      'iisLogs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesIisLog>,
            List<Map<String, dynamic>>
          >(
            iisLogs,
            (value) =>
      ...
      'logFiles':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesLogFile>,
            List<Map<String, dynamic>>
          >(
            logFiles,
            (value) =>
      ...
      'performanceCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesPerformanceCounter>,
            List<Map<String, dynamic>>
          >(
            performanceCounters,
            (value) =>
      ...
      'platformTelemetries':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesPlatformTelemetry>,
            List<Map<String, dynamic>>
          >(
            platformTelemetries,
            (value) =>
      ...
      'prometheusForwarders':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesPrometheusForwarder>,
            List<Map<String, dynamic>>
          >(
            prometheusForwarders,
            (value) =>
      ...
      'syslogs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesSyslog>,
            List<Map<String, dynamic>>
          >(
            syslogs,
            (value) =>
      ...
      'windowsEventLogs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDataSourcesWindowsEventLog>,
            List<Map<String, dynamic>>
          >(
            windowsEventLogs,
            (value) =>
  ...
  factory DataCollectionRuleDataSources.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleDataSources(
      dataImport: (() {
        final guardedValue = map['dataImport'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataCollectionRuleDataSourcesDataImport.fromMap(
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDataSourcesExtension>(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesExtension.fromMap(
      ...
      iisLogs: (() {
        final guardedValue = map['iisLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDataSourcesIisLog>(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesIisLog.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      logFiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDataSourcesLogFile>(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesLogFile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      performanceCounters: (() {
        final guardedValue = map['performanceCounters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesPerformanceCounter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      platformTelemetries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<DataCollectionRuleDataSourcesPlatformTelemetry>(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesPlatformTelemetry.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      prometheusForwarders: (() {
        final guardedValue = map['prometheusForwarders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            DataCollectionRuleDataSourcesPrometheusForwarder
          >(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesPrometheusForwarder.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      syslogs: (() {
        final guardedValue = map['syslogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDataSourcesSyslog>(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesSyslog.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      windowsEventLogs: (() {
        final guardedValue = map['windowsEventLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDataSourcesWindowsEventLog>(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesWindowsEventLog.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      windowsFirewallLogs: (() {
        final guardedValue = map['windowsFirewallLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            DataCollectionRuleDataSourcesWindowsFirewallLog
          >(
            guardedValue,
            (value) => DataCollectionRuleDataSourcesWindowsFirewallLog.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
