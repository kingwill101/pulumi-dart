...
class AlertProcessingRuleSuppressionSchedule {
  ...
  const AlertProcessingRuleSuppressionSchedule({
    this.effectiveFrom,
    this.effectiveUntil,
    this.recurrence,
    this.timeZone,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recurrence': ?pulumi.Input.mapOptionalInputValue<AlertProcessingRuleSuppressionScheduleRecurrence, Map<String, dynamic>>(recurrence, (value) => value.toMap()),
      'timeZone': ?timeZone,
    };
  }
  ...
  factory AlertProcessingRuleSuppressionSchedule.fromMap(Map<String, dynamic> map) {
    return AlertProcessingRuleSuppressionSchedule(
      ...
      recurrence: (() { final guardedValue = map['recurrence']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertProcessingRuleSuppressionScheduleRecurrence.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
