...
class GetDataCollectionRuleDataSource {
  ...
  final pulumi.Input<List<GetDataCollectionRuleDataSourceDataImport>>
  dataImports;
  ...
  final pulumi.Input<List<GetDataCollectionRuleDataSourcePerformanceCounter>>
  performanceCounters;

  /// One or more `platform_telemetry` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDataSourcePlatformTelemetry>>?
  platformTelemetries;

  /// One or more `prometheus_forwarder` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDataSourcePrometheusForwarder>>
  ...
  final pulumi.Input<List<GetDataCollectionRuleDataSourceWindowsEventLog>>
  windowsEventLogs;

  /// One or more `windows_firewall_log` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDataSourceWindowsFirewallLog>>
  windowsFirewallLogs;
    ...
    return <String, dynamic>{
      'dataImports':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourceDataImport>,
      ...
      'extensions':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourceExtension>,
            List<Map<String, dynamic>>
          >(
            extensions,
            (value) =>
      ...
      'iisLogs':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourceIisLog>,
            List<Map<String, dynamic>>
          >(
            iisLogs,
            (value) =>
      ...
      'logFiles':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetDataCollectionRuleDataSourceLogFile>,
            List<Map<String, dynamic>>
          >(
            logFiles,
            (value) =>
      ...
      'performanceCounters':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourcePerformanceCounter>,
            List<Map<String, dynamic>>
          >(
            performanceCounters,
            (value) =>
      ...
      'prometheusForwarders':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourcePrometheusForwarder>,
            List<Map<String, dynamic>>
          >(
            prometheusForwarders,
            (value) =>
      ...
      'syslogs':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourceSyslog>,
            List<Map<String, dynamic>>
          >(
            syslogs,
            (value) =>
      ...
      'windowsEventLogs':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourceWindowsEventLog>,
            List<Map<String, dynamic>>
          >(
            windowsEventLogs,
            (value) =>
      ...
      'windowsFirewallLogs':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourceWindowsFirewallLog>,
            List<Map<String, dynamic>>
          >(
            windowsFirewallLogs,
            (value) =>
  ...
  factory GetDataCollectionRuleDataSource.fromMap(Map<String, dynamic> map) {
    return GetDataCollectionRuleDataSource(
      dataImports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDataSourceDataImport>(
          map['dataImports']!,
          (value) => GetDataCollectionRuleDataSourceDataImport.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      extensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDataSourceExtension>(
          map['extensions']!,
          (value) => GetDataCollectionRuleDataSourceExtension.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      iisLogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDataSourceIisLog>(
          map['iisLogs']!,
          (value) => GetDataCollectionRuleDataSourceIisLog.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      logFiles: (() {
        final guardedValue = map['logFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetDataCollectionRuleDataSourceLogFile>(
            guardedValue,
            (value) => GetDataCollectionRuleDataSourceLogFile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      performanceCounters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDataSourcePerformanceCounter
        >(
          map['performanceCounters']!,
          (value) => GetDataCollectionRuleDataSourcePerformanceCounter.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      platformTelemetries: (() {
        final guardedValue = map['platformTelemetries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            GetDataCollectionRuleDataSourcePlatformTelemetry
          >(
            guardedValue,
            (value) => GetDataCollectionRuleDataSourcePlatformTelemetry.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      prometheusForwarders: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDataSourcePrometheusForwarder
        >(
          map['prometheusForwarders']!,
          (value) => GetDataCollectionRuleDataSourcePrometheusForwarder.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      syslogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDataSourceSyslog>(
          map['syslogs']!,
          (value) => GetDataCollectionRuleDataSourceSyslog.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      windowsEventLogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDataSourceWindowsEventLog>(
          map['windowsEventLogs']!,
          (value) => GetDataCollectionRuleDataSourceWindowsEventLog.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      windowsFirewallLogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDataSourceWindowsFirewallLog
        >(
          map['windowsFirewallLogs']!,
          (value) => GetDataCollectionRuleDataSourceWindowsFirewallLog.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
