...
class ActionGroupArgs {
  ...
  ActionGroupArgs({
    pulumi.Output<List<ActionGroupArmRoleReceiver>>? armRoleReceivers,
    pulumi.Output<List<ActionGroupAutomationRunbookReceiver>>? automationRunbookReceivers,
    pulumi.Output<List<ActionGroupAzureAppPushReceiver>>? azureAppPushReceivers,
    pulumi.Output<List<ActionGroupAzureFunctionReceiver>>? azureFunctionReceivers,
    pulumi.Output<List<ActionGroupEmailReceiver>>? emailReceivers,
    pulumi.Output<bool>? enabled,
    pulumi.Output<List<ActionGroupEventHubReceiver>>? eventHubReceivers,
    pulumi.Output<List<ActionGroupItsmReceiver>>? itsmReceivers,
    pulumi.Output<String>? location,
    pulumi.Output<List<ActionGroupLogicAppReceiver>>? logicAppReceivers,
    pulumi.Output<String>? name,
    required pulumi.Output<String> resourceGroupName,
    required pulumi.Output<String> shortName,
    pulumi.Output<List<ActionGroupSmsReceiver>>? smsReceivers,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<ActionGroupVoiceReceiver>>? voiceReceivers,
    pulumi.Output<List<ActionGroupWebhookReceiver>>? webhookReceivers,
  }) :
  ...
  factory ActionGroupArgs.fromMap(Map<String, dynamic> map) {
    return ActionGroupArgs(
      armRoleReceivers: map['armRoleReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupArmRoleReceiver>>(pulumi.Input.decodeList<ActionGroupArmRoleReceiver>(map['armRoleReceivers'], (value) => ActionGroupArmRoleReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      automationRunbookReceivers: map['automationRunbookReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupAutomationRunbookReceiver>>(pulumi.Input.decodeList<ActionGroupAutomationRunbookReceiver>(map['automationRunbookReceivers'], (value) => ActionGroupAutomationRunbookReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      azureAppPushReceivers: map['azureAppPushReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupAzureAppPushReceiver>>(pulumi.Input.decodeList<ActionGroupAzureAppPushReceiver>(map['azureAppPushReceivers'], (value) => ActionGroupAzureAppPushReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      azureFunctionReceivers: map['azureFunctionReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupAzureFunctionReceiver>>(pulumi.Input.decodeList<ActionGroupAzureFunctionReceiver>(map['azureFunctionReceivers'], (value) => ActionGroupAzureFunctionReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      emailReceivers: map['emailReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupEmailReceiver>>(pulumi.Input.decodeList<ActionGroupEmailReceiver>(map['emailReceivers'], (value) => ActionGroupEmailReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      enabled: map['enabled'] == null ? null : pulumi.Output.create<bool>(map['enabled'] as bool),
      eventHubReceivers: map['eventHubReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupEventHubReceiver>>(pulumi.Input.decodeList<ActionGroupEventHubReceiver>(map['eventHubReceivers'], (value) => ActionGroupEventHubReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      itsmReceivers: map['itsmReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupItsmReceiver>>(pulumi.Input.decodeList<ActionGroupItsmReceiver>(map['itsmReceivers'], (value) => ActionGroupItsmReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      logicAppReceivers: map['logicAppReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupLogicAppReceiver>>(pulumi.Input.decodeList<ActionGroupLogicAppReceiver>(map['logicAppReceivers'], (value) => ActionGroupLogicAppReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      shortName: pulumi.Output.create<String>(map['shortName'] as String),
      smsReceivers: map['smsReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupSmsReceiver>>(pulumi.Input.decodeList<ActionGroupSmsReceiver>(map['smsReceivers'], (value) => ActionGroupSmsReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      voiceReceivers: map['voiceReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupVoiceReceiver>>(pulumi.Input.decodeList<ActionGroupVoiceReceiver>(map['voiceReceivers'], (value) => ActionGroupVoiceReceiver.fromMap((value as Map).cast<String, dynamic>()))),
      webhookReceivers: map['webhookReceivers'] == null ? null : pulumi.Output.create<List<ActionGroupWebhookReceiver>>(pulumi.Input.decodeList<ActionGroupWebhookReceiver>(map['webhookReceivers'], (value) => ActionGroupWebhookReceiver.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
