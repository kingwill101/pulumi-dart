...
class DataCollectionRuleDataSourcesLogFile {
  ...
  const DataCollectionRuleDataSourcesLogFile({
  ...
  factory DataCollectionRuleDataSourcesLogFile.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleDataSourcesLogFile(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataCollectionRuleDataSourcesLogFileSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
