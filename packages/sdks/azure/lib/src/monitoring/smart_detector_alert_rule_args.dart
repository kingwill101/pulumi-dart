...
class SmartDetectorAlertRuleArgs {
  ...
  factory SmartDetectorAlertRuleArgs.fromMap(Map<String, dynamic> map) {
    return SmartDetectorAlertRuleArgs(
      actionGroup: pulumi.Input.fromValue(
        SmartDetectorAlertRuleActionGroup.fromMap(
          (map['actionGroup']! as Map).cast<String, dynamic>(),
        ),
      ),
      description: (() {
      ...
      scopeResourceIds: pulumi.Input.fromValue(
        (map['scopeResourceIds'] as List).cast<String>(),
      ),
      ...
      throttlingDuration: (() {
        final guardedValue = map['throttlingDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
