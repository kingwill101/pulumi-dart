...
class DataCollectionRuleDestinations {
  ...
  final pulumi.Input<DataCollectionRuleDestinationsAzureMonitorMetrics>?
  azureMonitorMetrics;
  ...
  /// One or more `event_hub` blocks as defined below.
  final pulumi.Input<DataCollectionRuleDestinationsEventHubDirect>?
  eventHubDirect;

  /// One or more `log_analytics` blocks as defined below.
  final pulumi.Input<List<DataCollectionRuleDestinationsLogAnalytic>>?
  logAnalytics;

  /// One or more `monitor_account` blocks as defined below.
  final pulumi.Input<List<DataCollectionRuleDestinationsMonitorAccount>>?
  monitorAccounts;

  /// One or more `storage_blob_direct` blocks as defined below.
  final pulumi.Input<List<DataCollectionRuleDestinationsStorageBlobDirect>>?
  storageBlobDirects;

  /// One or more `storage_blob` blocks as defined below.
  final pulumi.Input<List<DataCollectionRuleDestinationsStorageBlob>>?
  storageBlobs;
  ...
  final pulumi.Input<List<DataCollectionRuleDestinationsStorageTableDirect>>?
  storageTableDirects;
    ...
    return <String, dynamic>{
      'azureMonitorMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(azureMonitorMetrics, (value) => value.toMap()),
      'eventHub':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'eventHubDirect':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(eventHubDirect, (value) => value.toMap()),
      'logAnalytics':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDestinationsLogAnalytic>,
      ...
      'monitorAccounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDestinationsMonitorAccount>,
            List<Map<String, dynamic>>
          >(
            monitorAccounts,
            (value) =>
      ...
      'storageBlobDirects':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDestinationsStorageBlobDirect>,
            List<Map<String, dynamic>>
          >(
            storageBlobDirects,
            (value) =>
      ...
      'storageBlobs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDestinationsStorageBlob>,
            List<Map<String, dynamic>>
          >(
            storageBlobs,
            (value) =>
      ...
      'storageTableDirects':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataCollectionRuleDestinationsStorageTableDirect>,
            List<Map<String, dynamic>>
          >(
            storageTableDirects,
            (value) =>
  ...
  factory DataCollectionRuleDestinations.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleDestinations(
      azureMonitorMetrics: (() {
        final guardedValue = map['azureMonitorMetrics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataCollectionRuleDestinationsAzureMonitorMetrics.fromMap(
      ...
      eventHub: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataCollectionRuleDestinationsEventHub.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      eventHubDirect: (() {
        final guardedValue = map['eventHubDirect'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataCollectionRuleDestinationsEventHubDirect.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      logAnalytics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDestinationsLogAnalytic>(
            guardedValue,
            (value) => DataCollectionRuleDestinationsLogAnalytic.fromMap(
      ...
      monitorAccounts: (() {
        final guardedValue = map['monitorAccounts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDestinationsMonitorAccount>(
            guardedValue,
            (value) => DataCollectionRuleDestinationsMonitorAccount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      storageBlobDirects: (() {
        final guardedValue = map['storageBlobDirects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => DataCollectionRuleDestinationsStorageBlobDirect.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      storageBlobs: (() {
        final guardedValue = map['storageBlobs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataCollectionRuleDestinationsStorageBlob>(
            guardedValue,
            (value) => DataCollectionRuleDestinationsStorageBlob.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      storageTableDirects: (() {
        final guardedValue = map['storageTableDirects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            DataCollectionRuleDestinationsStorageTableDirect
          >(
            guardedValue,
            (value) => DataCollectionRuleDestinationsStorageTableDirect.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
