...
class ScheduledQueryRulesLogCriteria {
  ...
  factory ScheduledQueryRulesLogCriteria.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesLogCriteria(
      dimensions: pulumi.Input.fromValue(pulumi.Input.decodeList<ScheduledQueryRulesLogCriteriaDimension>(map['dimensions']!, (value) => ScheduledQueryRulesLogCriteriaDimension.fromMap((value as Map).cast<String, dynamic>()))),
