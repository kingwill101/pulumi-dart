...
class AlertPrometheusRuleGroupRule {
  ...
  final List<AlertPrometheusRuleGroupRuleAction>? actions;
  /// Specifies the Alert rule name.
  final String? alert;
  /// An `alert_resolution` block as defined below.
  final AlertPrometheusRuleGroupRuleAlertResolution? alertResolution;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': ?actions == null ? null : pulumi.Input.encodeList<AlertPrometheusRuleGroupRuleAction, Map<String, dynamic>>(actions!, (value) => value.toMap()),
      'alert': ?alert,
      'alertResolution': ?alertResolution == null ? null : alertResolution!.toMap(),
  ...
  factory AlertPrometheusRuleGroupRule.fromMap(Map<String, dynamic> map) {
    return AlertPrometheusRuleGroupRule(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<AlertPrometheusRuleGroupRuleAction>(map['actions'], (value) => AlertPrometheusRuleGroupRuleAction.fromMap((value as Map).cast<String, dynamic>())),
      alert: map['alert'] == null ? null : map['alert'] as String,
      alertResolution: map['alertResolution'] == null ? null : AlertPrometheusRuleGroupRuleAlertResolution.fromMap((map['alertResolution'] as Map).cast<String, dynamic>()),
