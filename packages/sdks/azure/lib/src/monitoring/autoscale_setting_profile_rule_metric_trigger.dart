...
class AutoscaleSettingProfileRuleMetricTrigger {
  ...
  final pulumi.Input<List<AutoscaleSettingProfileRuleMetricTriggerDimension>>?
  dimensions;
    ...
    return <String, dynamic>{
      'dimensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutoscaleSettingProfileRuleMetricTriggerDimension>,
  ...
  factory AutoscaleSettingProfileRuleMetricTrigger.fromMap(
    ...
    return AutoscaleSettingProfileRuleMetricTrigger(
      dimensions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AutoscaleSettingProfileRuleMetricTriggerDimension.fromMap(
      ...
      divideByInstanceCount: (() {
        final guardedValue = map['divideByInstanceCount'];
        if (guardedValue == null) return null;
      ...
      metricResourceId: pulumi.Input.fromValue(
        map['metricResourceId'] as String,
      ),
