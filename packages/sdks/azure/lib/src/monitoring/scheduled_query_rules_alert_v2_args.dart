...
class ScheduledQueryRulesAlertV2Args {
  ...
  factory ScheduledQueryRulesAlertV2Args.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertV2Args(
      ...
      criterias: (pulumi.Input.decodeList<ScheduledQueryRulesAlertV2Criteria>(map['criterias'], (value) => ScheduledQueryRulesAlertV2Criteria.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      windowDuration: (map['windowDuration'] as String).input(),
