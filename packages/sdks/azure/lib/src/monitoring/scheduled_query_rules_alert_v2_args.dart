...
class ScheduledQueryRulesAlertV2Args {
  ...
  const ScheduledQueryRulesAlertV2Args({
    this.action,
  ...
  factory ScheduledQueryRulesAlertV2Args.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertV2Args(
      ...
      criterias: pulumi.Input.fromValue(pulumi.Input.decodeList<ScheduledQueryRulesAlertV2Criteria>(map['criterias']!, (value) => ScheduledQueryRulesAlertV2Criteria.fromMap((value as Map).cast<String, dynamic>()))),
