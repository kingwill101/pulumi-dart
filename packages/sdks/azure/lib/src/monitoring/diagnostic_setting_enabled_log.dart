...
class DiagnosticSettingEnabledLog {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'retentionPolicy': ?pulumi.Input.mapOptionalInputValue<DiagnosticSettingEnabledLogRetentionPolicy, Map<String, dynamic>>(retentionPolicy, (value) => value.toMap()),
    };
  }
  ...
  factory DiagnosticSettingEnabledLog.fromMap(Map<String, dynamic> map) {
    return DiagnosticSettingEnabledLog(
      ...
      retentionPolicy: (() { final guardedValue = map['retentionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiagnosticSettingEnabledLogRetentionPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
