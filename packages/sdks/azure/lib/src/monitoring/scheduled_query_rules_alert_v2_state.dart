...
class ScheduledQueryRulesAlertV2State {
  ...
  factory ScheduledQueryRulesAlertV2State.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertV2State(
      action: map['action'] == null ? null : (ScheduledQueryRulesAlertV2Action.fromMap((map['action']! as Map).cast<String, dynamic>())).input(),
      autoMitigationEnabled: map['autoMitigationEnabled'] == null ? null : (map['autoMitigationEnabled']! as bool).input(),
      createdWithApiVersion: map['createdWithApiVersion'] == null ? null : (map['createdWithApiVersion']! as String).input(),
      criterias: map['criterias'] == null ? null : (pulumi.Input.decodeList<ScheduledQueryRulesAlertV2Criteria>(map['criterias']!, (value) => ScheduledQueryRulesAlertV2Criteria.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      identity: map['identity'] == null ? null : (ScheduledQueryRulesAlertV2Identity.fromMap((map['identity']! as Map).cast<String, dynamic>())).input(),
      isALegacyLogAnalyticsRule: map['isALegacyLogAnalyticsRule'] == null ? null : (map['isALegacyLogAnalyticsRule']! as bool).input(),
      isWorkspaceAlertsStorageConfigured: map['isWorkspaceAlertsStorageConfigured'] == null ? null : (map['isWorkspaceAlertsStorageConfigured']! as bool).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      muteActionsAfterAlertDuration: map['muteActionsAfterAlertDuration'] == null ? null : (map['muteActionsAfterAlertDuration']! as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      queryTimeRangeOverride: map['queryTimeRangeOverride'] == null ? null : (map['queryTimeRangeOverride']! as String).input(),
      ...
      windowDuration: map['windowDuration'] == null ? null : (map['windowDuration']! as String).input(),
      workspaceAlertsStorageEnabled: map['workspaceAlertsStorageEnabled'] == null ? null : (map['workspaceAlertsStorageEnabled']! as bool).input(),
    );
  }
}
