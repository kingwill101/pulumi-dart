...
class ScheduledQueryRulesAlertV2State {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'criterias':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScheduledQueryRulesAlertV2Criteria>,
    ...
    return ScheduledQueryRulesAlertV2State(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          ScheduledQueryRulesAlertV2Action.fromMap(
      ...
      createdWithApiVersion: (() {
        final guardedValue = map['createdWithApiVersion'];
        if (guardedValue == null) return null;
      ...
      criterias: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScheduledQueryRulesAlertV2Criteria>(
            guardedValue,
            (value) => ScheduledQueryRulesAlertV2Criteria.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScheduledQueryRulesAlertV2Identity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      isALegacyLogAnalyticsRule: (() {
        final guardedValue = map['isALegacyLogAnalyticsRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isWorkspaceAlertsStorageConfigured: (() {
        final guardedValue = map['isWorkspaceAlertsStorageConfigured'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      location: (() {
      ...
      muteActionsAfterAlertDuration: (() {
        final guardedValue = map['muteActionsAfterAlertDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      queryTimeRangeOverride: (() {
        final guardedValue = map['queryTimeRangeOverride'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceGroupName: (() {
      ...
      windowDuration: (() {
        final guardedValue = map['windowDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      workspaceAlertsStorageEnabled: (() {
        final guardedValue = map['workspaceAlertsStorageEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
