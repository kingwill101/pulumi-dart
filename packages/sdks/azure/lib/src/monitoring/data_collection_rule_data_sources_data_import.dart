...
class DataCollectionRuleDataSourcesDataImport {
  ...
  factory DataCollectionRuleDataSourcesDataImport.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleDataSourcesDataImport(
      eventHubDataSources: (pulumi.Input.decodeList<DataCollectionRuleDataSourcesDataImportEventHubDataSource>(map['eventHubDataSources'], (value) => DataCollectionRuleDataSourcesDataImportEventHubDataSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
