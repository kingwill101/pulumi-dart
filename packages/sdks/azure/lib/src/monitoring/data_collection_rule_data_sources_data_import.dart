...
class DataCollectionRuleDataSourcesDataImport {
  ...
  final pulumi.Input<
    List<DataCollectionRuleDataSourcesDataImportEventHubDataSource>
  >
  eventHubDataSources;

  /// Creates a new [DataCollectionRuleDataSourcesDataImport].
  /// [eventHubDataSources] An `event_hub_data_source` block as defined below.
  DataCollectionRuleDataSourcesDataImport({required this.eventHubDataSources});
  ...
  factory DataCollectionRuleDataSourcesDataImport.fromMap(
    ...
    return DataCollectionRuleDataSourcesDataImport(
      eventHubDataSources: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              DataCollectionRuleDataSourcesDataImportEventHubDataSource.fromMap(
