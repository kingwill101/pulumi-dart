...
class GetDataCollectionRuleDataSourceDataImport {
  ...
  final pulumi.Input<
    List<GetDataCollectionRuleDataSourceDataImportEventHubDataSource>
  >
  eventHubDataSources;
  ...
  factory GetDataCollectionRuleDataSourceDataImport.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDataCollectionRuleDataSourceDataImport(
      eventHubDataSources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDataSourceDataImportEventHubDataSource
        >(
          map['eventHubDataSources']!,
          (value) =>
              GetDataCollectionRuleDataSourceDataImportEventHubDataSource.fromMap(
