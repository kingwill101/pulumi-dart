...
class AlertProcessingRuleActionGroupScheduleRecurrence {
  ...
  final pulumi.Input<
    List<AlertProcessingRuleActionGroupScheduleRecurrenceDaily>
  >?
  dailies;

  /// One or more `monthly` blocks as defined above.
  final pulumi.Input<
    List<AlertProcessingRuleActionGroupScheduleRecurrenceMonthly>
  >?
  monthlies;

  /// One or more `weekly` blocks as defined below.
  final pulumi.Input<
    List<AlertProcessingRuleActionGroupScheduleRecurrenceWeekly>
  >?
  weeklies;
  ...
  factory AlertProcessingRuleActionGroupScheduleRecurrence.fromMap(
    Map<String, dynamic> map,
  ) {
    return AlertProcessingRuleActionGroupScheduleRecurrence(
      dailies: (() {
        final guardedValue = map['dailies'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AlertProcessingRuleActionGroupScheduleRecurrenceDaily.fromMap(
      ...
      monthlies: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AlertProcessingRuleActionGroupScheduleRecurrenceMonthly.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      weeklies: (() {
        final guardedValue = map['weeklies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            AlertProcessingRuleActionGroupScheduleRecurrenceWeekly
          >(
            guardedValue,
            (value) =>
                AlertProcessingRuleActionGroupScheduleRecurrenceWeekly.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
