...
class DataCollectionRuleStreamDeclaration {
  ...
  factory DataCollectionRuleStreamDeclaration.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleStreamDeclaration(
      columns: (pulumi.Input.decodeList<DataCollectionRuleStreamDeclarationColumn>(map['columns'], (value) => DataCollectionRuleStreamDeclarationColumn.fromMap((value as Map).cast<String, dynamic>()))).input(),
