...
class DataCollectionRuleStreamDeclaration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns': pulumi.Input.mapInputValue<List<DataCollectionRuleStreamDeclarationColumn>, List<Map<String, dynamic>>>(columns, (value) => pulumi.Input.encodeList<DataCollectionRuleStreamDeclarationColumn, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DataCollectionRuleStreamDeclaration.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleStreamDeclaration(
      columns: pulumi.Input.fromValue(pulumi.Input.decodeList<DataCollectionRuleStreamDeclarationColumn>(map['columns']!, (value) => DataCollectionRuleStreamDeclarationColumn.fromMap((value as Map).cast<String, dynamic>()))),
