...
class AlertProcessingRuleActionGroupState {
  ...
  factory AlertProcessingRuleActionGroupState.fromMap(
    Map<String, dynamic> map,
  ) {
    return AlertProcessingRuleActionGroupState(
      addActionGroupIds: (() {
        final guardedValue = map['addActionGroupIds'];
      ...
      condition: (() {
        ...
        return pulumi.Input.fromValue(
          AlertProcessingRuleActionGroupCondition.fromMap(
      ...
      schedule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertProcessingRuleActionGroupSchedule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
