...
class AutoscaleSettingProfile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutoscaleSettingProfileRule>,
  ...
  factory AutoscaleSettingProfile.fromMap(Map<String, dynamic> map) {
    return AutoscaleSettingProfile(
      capacity: pulumi.Input.fromValue(
        AutoscaleSettingProfileCapacity.fromMap(
          (map['capacity']! as Map).cast<String, dynamic>(),
        ),
      ),
      fixedDate: (() {
        final guardedValue = map['fixedDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoscaleSettingProfileFixedDate.fromMap(
      ...
      recurrence: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoscaleSettingProfileRecurrence.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutoscaleSettingProfileRule>(
            guardedValue,
            (value) => AutoscaleSettingProfileRule.fromMap(
