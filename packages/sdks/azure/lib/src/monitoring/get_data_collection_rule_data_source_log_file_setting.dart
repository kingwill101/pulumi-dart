...
class GetDataCollectionRuleDataSourceLogFileSetting {
  ...
  final pulumi.Input<List<GetDataCollectionRuleDataSourceLogFileSettingText>>
  texts;

  /// Creates a new [GetDataCollectionRuleDataSourceLogFileSetting].
  /// [texts] A `text` block as defined below.
  GetDataCollectionRuleDataSourceLogFileSetting({required this.texts});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'texts':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDataSourceLogFileSettingText>,
  ...
  factory GetDataCollectionRuleDataSourceLogFileSetting.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDataCollectionRuleDataSourceLogFileSetting(
      texts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDataSourceLogFileSettingText
        >(
          map['texts']!,
          (value) => GetDataCollectionRuleDataSourceLogFileSettingText.fromMap(
