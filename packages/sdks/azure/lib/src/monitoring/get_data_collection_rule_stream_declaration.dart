...
class GetDataCollectionRuleStreamDeclaration {
  ...
  factory GetDataCollectionRuleStreamDeclaration.fromMap(Map<String, dynamic> map) {
    return GetDataCollectionRuleStreamDeclaration(
      columns: (pulumi.Input.decodeList<GetDataCollectionRuleStreamDeclarationColumn>(map['columns'], (value) => GetDataCollectionRuleStreamDeclarationColumn.fromMap((value as Map).cast<String, dynamic>()))).input(),
