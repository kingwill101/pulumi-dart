...
class GetDataCollectionRuleStreamDeclaration {
  ...
  final pulumi.Input<List<GetDataCollectionRuleStreamDeclarationColumn>>
  columns;
    ...
    return <String, dynamic>{
      'columns':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleStreamDeclarationColumn>,
  ...
  factory GetDataCollectionRuleStreamDeclaration.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDataCollectionRuleStreamDeclaration(
      columns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleStreamDeclarationColumn>(
          map['columns']!,
          (value) => GetDataCollectionRuleStreamDeclarationColumn.fromMap(
