...
class ScheduledQueryRulesAlertV2Criteria {
  ...
  final pulumi.Input<List<ScheduledQueryRulesAlertV2CriteriaDimension>>?
  dimensions;

  /// A `failing_periods` block as defined below.
  final pulumi.Input<ScheduledQueryRulesAlertV2CriteriaFailingPeriods>?
  failingPeriods;
    ...
    return <String, dynamic>{
      'dimensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScheduledQueryRulesAlertV2CriteriaDimension>,
      ...
      'failingPeriods':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(failingPeriods, (value) => value.toMap()),
    ...
    return ScheduledQueryRulesAlertV2Criteria(
      dimensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScheduledQueryRulesAlertV2CriteriaDimension>(
            guardedValue,
            (value) => ScheduledQueryRulesAlertV2CriteriaDimension.fromMap(
      ...
      failingPeriods: (() {
        final guardedValue = map['failingPeriods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScheduledQueryRulesAlertV2CriteriaFailingPeriods.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      metricMeasureColumn: (() {
        final guardedValue = map['metricMeasureColumn'];
        if (guardedValue == null) return null;
      ...
      resourceIdColumn: (() {
        final guardedValue = map['resourceIdColumn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      threshold: pulumi.Input.fromValue(map['threshold'] as double),
      timeAggregationMethod: pulumi.Input.fromValue(
        map['timeAggregationMethod'] as String,
      ),
    );
  }
}
