...
class ScheduledQueryRulesAlertArgs {
  ...
  const ScheduledQueryRulesAlertArgs({
  ...
  factory ScheduledQueryRulesAlertArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertArgs(
      ...
      frequency: pulumi.Input.fromValue((map['frequency'] as num).toInt()),
      ...
      timeWindow: pulumi.Input.fromValue((map['timeWindow'] as num).toInt()),
