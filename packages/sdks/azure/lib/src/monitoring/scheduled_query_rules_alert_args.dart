  ...
  factory ScheduledQueryRulesAlertArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertArgs(
      action: pulumi.Input.fromValue(
        ScheduledQueryRulesAlertAction.fromMap(
          (map['action']! as Map).cast<String, dynamic>(),
        ),
      ),
      authorizedResourceIds: (() {
        final guardedValue = map['authorizedResourceIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      autoMitigationEnabled: (() {
        final guardedValue = map['autoMitigationEnabled'];
        if (guardedValue == null) return null;
      ...
      queryType: (() {
        final guardedValue = map['queryType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      trigger: pulumi.Input.fromValue(
        ScheduledQueryRulesAlertTrigger.fromMap(
