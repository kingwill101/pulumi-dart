...
class GetDataCollectionRuleDestination {
  ...
  final pulumi.Input<List<GetDataCollectionRuleDestinationAzureMonitorMetric>>
  azureMonitorMetrics;
  ...
  final pulumi.Input<GetDataCollectionRuleDestinationEventHubDirect>?
  eventHubDirect;

  /// One or more `log_analytics` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDestinationLogAnalytic>>
  logAnalytics;

  /// One or more `monitor_account` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDestinationMonitorAccount>>
  monitorAccounts;

  /// One or more `storage_blob_direct` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDestinationStorageBlobDirect>>
  storageBlobDirects;

  /// One or more `storage_blob` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDestinationStorageBlob>>
  storageBlobs;

  /// One or more `storage_table_direct` blocks as defined below.
  final pulumi.Input<List<GetDataCollectionRuleDestinationStorageTableDirect>>
  storageTableDirects;
    ...
    return <String, dynamic>{
      'azureMonitorMetrics':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDestinationAzureMonitorMetric>,
      ...
      'monitorAccounts':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDestinationMonitorAccount>,
            List<Map<String, dynamic>>
          >(
            monitorAccounts,
            (value) =>
      ...
      'storageBlobDirects':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDestinationStorageBlobDirect>,
            List<Map<String, dynamic>>
          >(
            storageBlobDirects,
            (value) =>
      ...
      'storageBlobs':
          pulumi.Input.mapInputValue<
            List<GetDataCollectionRuleDestinationStorageBlob>,
            List<Map<String, dynamic>>
          >(
            storageBlobs,
            (value) =>
  ...
  factory GetDataCollectionRuleDestination.fromMap(Map<String, dynamic> map) {
    return GetDataCollectionRuleDestination(
      azureMonitorMetrics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDestinationAzureMonitorMetric
        >(
          map['azureMonitorMetrics']!,
          (value) => GetDataCollectionRuleDestinationAzureMonitorMetric.fromMap(
      ...
      eventHub: (() {
        ...
        return pulumi.Input.fromValue(
          GetDataCollectionRuleDestinationEventHub.fromMap(
      ...
      eventHubDirect: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetDataCollectionRuleDestinationEventHubDirect.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      logAnalytics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDestinationLogAnalytic>(
          map['logAnalytics']!,
          (value) => GetDataCollectionRuleDestinationLogAnalytic.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      monitorAccounts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDestinationMonitorAccount>(
          map['monitorAccounts']!,
          (value) => GetDataCollectionRuleDestinationMonitorAccount.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      storageBlobDirects: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDestinationStorageBlobDirect
        >(
          map['storageBlobDirects']!,
          (value) => GetDataCollectionRuleDestinationStorageBlobDirect.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      storageBlobs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataCollectionRuleDestinationStorageBlob>(
          map['storageBlobs']!,
          (value) => GetDataCollectionRuleDestinationStorageBlob.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      storageTableDirects: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDestinationStorageTableDirect
        >(
          map['storageTableDirects']!,
          (value) => GetDataCollectionRuleDestinationStorageTableDirect.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
