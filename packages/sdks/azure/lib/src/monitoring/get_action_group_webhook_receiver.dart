...
class GetActionGroupWebhookReceiver {
    ...
    return <String, dynamic>{
      'aadAuths':
          pulumi.Input.mapInputValue<
            List<GetActionGroupWebhookReceiverAadAuth>,
  ...
  factory GetActionGroupWebhookReceiver.fromMap(Map<String, dynamic> map) {
    return GetActionGroupWebhookReceiver(
      aadAuths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetActionGroupWebhookReceiverAadAuth>(
          map['aadAuths']!,
          (value) => GetActionGroupWebhookReceiverAadAuth.fromMap(
