...
class GetDataCollectionRuleDataSourcePrometheusForwarder {
  ...
  final pulumi.Input<
    List<GetDataCollectionRuleDataSourcePrometheusForwarderLabelIncludeFilter>
  >
  labelIncludeFilters;
  ...
  factory GetDataCollectionRuleDataSourcePrometheusForwarder.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDataCollectionRuleDataSourcePrometheusForwarder(
      labelIncludeFilters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataCollectionRuleDataSourcePrometheusForwarderLabelIncludeFilter
        >(
          map['labelIncludeFilters']!,
          (value) =>
              GetDataCollectionRuleDataSourcePrometheusForwarderLabelIncludeFilter.fromMap(
