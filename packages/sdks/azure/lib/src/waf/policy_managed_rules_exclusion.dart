...
class PolicyManagedRulesExclusion {
  ...
  final pulumi.Input<PolicyManagedRulesExclusionExcludedRuleSet>?
  excludedRuleSet;
    ...
    return <String, dynamic>{
      'excludedRuleSet':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(excludedRuleSet, (value) => value.toMap()),
  ...
  factory PolicyManagedRulesExclusion.fromMap(Map<String, dynamic> map) {
    return PolicyManagedRulesExclusion(
      excludedRuleSet: (() {
        final guardedValue = map['excludedRuleSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyManagedRulesExclusionExcludedRuleSet.fromMap(
