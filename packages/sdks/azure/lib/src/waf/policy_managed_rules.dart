...
class PolicyManagedRules {
  ...
  PolicyManagedRules({this.exclusions, required this.managedRuleSets});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exclusions':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyManagedRulesExclusion>,
      ...
      'managedRuleSets':
          pulumi.Input.mapInputValue<
            List<PolicyManagedRulesManagedRuleSet>,
            List<Map<String, dynamic>>
          >(
            managedRuleSets,
            (value) =>
    ...
    return PolicyManagedRules(
      exclusions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyManagedRulesExclusion>(
            guardedValue,
            (value) => PolicyManagedRulesExclusion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      managedRuleSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PolicyManagedRulesManagedRuleSet>(
          map['managedRuleSets']!,
          (value) => PolicyManagedRulesManagedRuleSet.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
