...
class PolicyManagedRulesManagedRuleSet {
  ...
  final pulumi.Input<List<PolicyManagedRulesManagedRuleSetRuleGroupOverride>>?
  ruleGroupOverrides;
    ...
    return <String, dynamic>{
      'ruleGroupOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyManagedRulesManagedRuleSetRuleGroupOverride>,
      ...
      ruleGroupOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyManagedRulesManagedRuleSetRuleGroupOverride.fromMap(
