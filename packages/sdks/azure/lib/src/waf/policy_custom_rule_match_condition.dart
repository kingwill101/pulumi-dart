...
class PolicyCustomRuleMatchCondition {
  ...
  final pulumi.Input<List<PolicyCustomRuleMatchConditionMatchVariable>>
  matchVariables;
    ...
    return <String, dynamic>{
      ...
      'matchVariables':
          pulumi.Input.mapInputValue<
            List<PolicyCustomRuleMatchConditionMatchVariable>,
  ...
  factory PolicyCustomRuleMatchCondition.fromMap(Map<String, dynamic> map) {
    return PolicyCustomRuleMatchCondition(
      ...
      matchVariables: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PolicyCustomRuleMatchConditionMatchVariable>(
          map['matchVariables']!,
          (value) => PolicyCustomRuleMatchConditionMatchVariable.fromMap(
