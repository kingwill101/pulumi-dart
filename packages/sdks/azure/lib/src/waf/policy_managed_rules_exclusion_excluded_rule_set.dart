...
class PolicyManagedRulesExclusionExcludedRuleSet {
  ...
  final pulumi.Input<List<PolicyManagedRulesExclusionExcludedRuleSetRuleGroup>>?
  ruleGroups;
    ...
    return <String, dynamic>{
      'ruleGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyManagedRulesExclusionExcludedRuleSetRuleGroup>,
  ...
  factory PolicyManagedRulesExclusionExcludedRuleSet.fromMap(
      ...
      ruleGroups: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyManagedRulesExclusionExcludedRuleSetRuleGroup.fromMap(
