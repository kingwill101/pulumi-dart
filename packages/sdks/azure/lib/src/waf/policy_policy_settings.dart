...
class PolicyPolicySettings {
  ...
  /// [fileUploadEnforcement] Whether the firewall should block a request with upload size greater then `fileUploadLimitInMb`.
  ...
  /// [logScrubbing] One `logScrubbing` block as defined below.
  ...
  /// [requestBodyEnforcement] Whether the firewall should block a request with body size greater then `maxRequestBodySizeInKb`. Defaults to `true`.
