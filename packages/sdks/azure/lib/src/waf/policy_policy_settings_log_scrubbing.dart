...
class PolicyPolicySettingsLogScrubbing {
  ...
  PolicyPolicySettingsLogScrubbing({this.enabled, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyPolicySettingsLogScrubbingRule>,
    ...
    return PolicyPolicySettingsLogScrubbing(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyPolicySettingsLogScrubbingRule>(
            guardedValue,
            (value) => PolicyPolicySettingsLogScrubbingRule.fromMap(
