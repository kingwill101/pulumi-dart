...
class PolicyManagedRulesManagedRuleSetRuleGroupOverride {
  ...
  final pulumi.Input<
    List<PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule>
  >?
  rules;
  ...
  factory PolicyManagedRulesManagedRuleSetRuleGroupOverride.fromMap(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule.fromMap(
