...
class PolicyManagedRulesManagedRuleSetRuleGroupOverride {
  ...
  final List<PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule>? rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?rules == null ? null : pulumi.Input.encodeList<PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule, Map<String, dynamic>>(rules!, (value) => value.toMap()),
    };
  }
  ...
  factory PolicyManagedRulesManagedRuleSetRuleGroupOverride.fromMap(Map<String, dynamic> map) {
    return PolicyManagedRulesManagedRuleSetRuleGroupOverride(
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule>(map['rules'], (value) => PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
