...
import 'ns_record_args.dart';
import 'ns_record_state.dart';
...
/// }
/// resource "azure_dns_nsrecord" "example" {
///   name                = "test"
...
/// ```
class NsRecord extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NsRecord]. {@macro pulumi_dns_ns_record_ns_record_args_doc}
  ...
  /// Gets an existing [NsRecord] resource's state with the given [name] and [id].
  static NsRecord get(
    String name,
