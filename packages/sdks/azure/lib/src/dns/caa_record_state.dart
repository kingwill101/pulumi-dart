...
class CaaRecordState {
  ...
  factory CaaRecordState.fromMap(Map<String, dynamic> map) {
    return CaaRecordState(
      ...
      records: map['records'] == null ? null : (pulumi.Input.decodeList<CaaRecordRecord>(map['records']!, (value) => CaaRecordRecord.fromMap((value as Map).cast<String, dynamic>()))).input(),
