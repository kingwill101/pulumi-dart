...
/// }
/// resource "azure_dns_ptrrecord" "example" {
///   name                = "test"
...
class PtrRecord extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PtrRecord] resource.
  PtrRecord.reference(String urn)
    : super(
        'azure:dns/ptrRecord:PtrRecord',
