...
class LedgerState {
  ...
  factory LedgerState.fromMap(Map<String, dynamic> map) {
    return LedgerState(
      azureadBasedServicePrincipals: (() { final guardedValue = map['azureadBasedServicePrincipals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LedgerAzureadBasedServicePrincipal>(guardedValue, (value) => LedgerAzureadBasedServicePrincipal.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      identityServiceEndpoint: (() { final guardedValue = map['identityServiceEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ledgerEndpoint: (() { final guardedValue = map['ledgerEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
