...
class ManagedClusterNodeType {
    ...
    return <String, dynamic>{
      ...
      'vmSecrets':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedClusterNodeTypeVmSecret>,
  ...
  factory ManagedClusterNodeType.fromMap(Map<String, dynamic> map) {
    return ManagedClusterNodeType(
      applicationPortRange: pulumi.Input.fromValue(
        map['applicationPortRange'] as String,
      ),
      capacities: (() {
      ...
      ephemeralPortRange: pulumi.Input.fromValue(
        map['ephemeralPortRange'] as String,
      ),
      id: (() {
      ...
      multiplePlacementGroupsEnabled: (() {
        final guardedValue = map['multiplePlacementGroupsEnabled'];
        if (guardedValue == null) return null;
      ...
      stateless: (() {
        final guardedValue = map['stateless'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      vmImageOffer: pulumi.Input.fromValue(map['vmImageOffer'] as String),
      vmImagePublisher: pulumi.Input.fromValue(
        map['vmImagePublisher'] as String,
      ),
      ...
      vmSecrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedClusterNodeTypeVmSecret>(
            guardedValue,
            (value) => ManagedClusterNodeTypeVmSecret.fromMap(
