...
class ClusterUpgradePolicy {
    ...
    return <String, dynamic>{
      'deltaHealthPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(deltaHealthPolicy, (value) => value.toMap()),
      ...
      'healthPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(healthPolicy, (value) => value.toMap()),
  ...
  factory ClusterUpgradePolicy.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradePolicy(
      deltaHealthPolicy: (() {
        final guardedValue = map['deltaHealthPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterUpgradePolicyDeltaHealthPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      forceRestartEnabled: (() {
        final guardedValue = map['forceRestartEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      healthCheckRetryTimeout: (() {
        final guardedValue = map['healthCheckRetryTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      healthCheckStableDuration: (() {
        final guardedValue = map['healthCheckStableDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      healthCheckWaitDuration: (() {
        final guardedValue = map['healthCheckWaitDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      healthPolicy: (() {
        final guardedValue = map['healthPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterUpgradePolicyHealthPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      upgradeDomainTimeout: (() {
        final guardedValue = map['upgradeDomainTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      upgradeReplicaSetCheckTimeout: (() {
        final guardedValue = map['upgradeReplicaSetCheckTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      upgradeTimeout: (() {
        final guardedValue = map['upgradeTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
