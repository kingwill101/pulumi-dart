...
class ClusterUpgradePolicyHealthPolicy {
  ...
  factory ClusterUpgradePolicyHealthPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradePolicyHealthPolicy(
      maxUnhealthyApplicationsPercent: (() { final guardedValue = map['maxUnhealthyApplicationsPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      maxUnhealthyNodesPercent: (() { final guardedValue = map['maxUnhealthyNodesPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
