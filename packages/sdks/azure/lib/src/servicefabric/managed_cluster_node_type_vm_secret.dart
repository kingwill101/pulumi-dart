...
class ManagedClusterNodeTypeVmSecret {
  ...
  factory ManagedClusterNodeTypeVmSecret.fromMap(Map<String, dynamic> map) {
    return ManagedClusterNodeTypeVmSecret(
      certificates: (pulumi.Input.decodeList<ManagedClusterNodeTypeVmSecretCertificate>(map['certificates'], (value) => ManagedClusterNodeTypeVmSecretCertificate.fromMap((value as Map).cast<String, dynamic>()))).input(),
