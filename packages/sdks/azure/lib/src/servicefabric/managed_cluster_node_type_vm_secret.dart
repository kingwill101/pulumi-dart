...
class ManagedClusterNodeTypeVmSecret {
  ...
  final pulumi.Input<List<ManagedClusterNodeTypeVmSecretCertificate>> certificates;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'certificates': pulumi.Input.mapInputValue<List<ManagedClusterNodeTypeVmSecretCertificate>, List<Map<String, dynamic>>>(certificates, (value) => pulumi.Input.encodeList<ManagedClusterNodeTypeVmSecretCertificate, Map<String, dynamic>>(value, (value) => value.toMap())),
      'vaultId': vaultId,
    };
  }
  ...
  factory ManagedClusterNodeTypeVmSecret.fromMap(Map<String, dynamic> map) {
    return ManagedClusterNodeTypeVmSecret(
      certificates: pulumi.Input.fromValue(pulumi.Input.decodeList<ManagedClusterNodeTypeVmSecretCertificate>(map['certificates']!, (value) => ManagedClusterNodeTypeVmSecretCertificate.fromMap((value as Map).cast<String, dynamic>()))),
