...
class ClusterUpgradePolicyDeltaHealthPolicy {
  ...
  factory ClusterUpgradePolicyDeltaHealthPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradePolicyDeltaHealthPolicy(
      maxDeltaUnhealthyApplicationsPercent: (() { final guardedValue = map['maxDeltaUnhealthyApplicationsPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      maxDeltaUnhealthyNodesPercent: (() { final guardedValue = map['maxDeltaUnhealthyNodesPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      maxUpgradeDomainDeltaUnhealthyNodesPercent: (() { final guardedValue = map['maxUpgradeDomainDeltaUnhealthyNodesPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
