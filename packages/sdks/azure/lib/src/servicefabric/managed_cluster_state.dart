...
class ManagedClusterState {
  ...
  ManagedClusterState({
    ...
    pulumi.Output<int>? httpGatewayPort,
    pulumi.Output<List<ManagedClusterLbRule>>? lbRules,
    ...
    pulumi.Output<String>? username,
      ...
      httpGatewayPort = pulumi.Input.asOptionalInput<int>(httpGatewayPort),
      lbRules = pulumi.Input.asOptionalInput<List<ManagedClusterLbRule>>(lbRules),
  ...
  factory ManagedClusterState.fromMap(Map<String, dynamic> map) {
    return ManagedClusterState(
      ...
      httpGatewayPort: map['httpGatewayPort'] == null ? null : pulumi.Output.create<int>(map['httpGatewayPort'] as int),
      lbRules: map['lbRules'] == null ? null : pulumi.Output.create<List<ManagedClusterLbRule>>(pulumi.Input.decodeList<ManagedClusterLbRule>(map['lbRules'], (value) => ManagedClusterLbRule.fromMap((value as Map).cast<String, dynamic>()))),
