...
class ClusterState {
  ...
  final pulumi.Input<List<ClusterClientCertificateCommonName>>?
  clientCertificateCommonNames;

  /// One or more `client_certificate_thumbprint` blocks as defined below.
  final pulumi.Input<List<ClusterClientCertificateThumbprint>>?
  ...
  final pulumi.Input<ClusterReverseProxyCertificateCommonNames>?
    ...
    return <String, dynamic>{
      ...
      'certificateCommonNames':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(certificateCommonNames, (value) => value.toMap()),
      'clientCertificateCommonNames':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterClientCertificateCommonName>,
      ...
      'clientCertificateThumbprints':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterClientCertificateThumbprint>,
            List<Map<String, dynamic>>
          >(
            clientCertificateThumbprints,
            (value) =>
      ...
      'diagnosticsConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(diagnosticsConfig, (value) => value.toMap()),
      'fabricSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterFabricSetting>,
            List<Map<String, dynamic>>
          >(
            fabricSettings,
            (value) =>
      ...
      'nodeTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterNodeType>,
            List<Map<String, dynamic>>
          >(
            nodeTypes,
            (value) =>
                pulumi.Input.encodeList<ClusterNodeType, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'reverseProxyCertificate':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(reverseProxyCertificate, (value) => value.toMap()),
      'reverseProxyCertificateCommonNames':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterReverseProxyCertificateCommonNames,
            Map<String, dynamic>
          >(reverseProxyCertificateCommonNames, (value) => value.toMap()),
    ...
    return ClusterState(
      ...
      azureActiveDirectory: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterAzureActiveDirectory.fromMap(
      ...
      certificate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterCertificate.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      certificateCommonNames: (() {
        final guardedValue = map['certificateCommonNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterCertificateCommonNames.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      clientCertificateCommonNames: (() {
        final guardedValue = map['clientCertificateCommonNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterClientCertificateCommonName>(
            guardedValue,
            (value) => ClusterClientCertificateCommonName.fromMap(
      ...
      clientCertificateThumbprints: (() {
        final guardedValue = map['clientCertificateThumbprints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterClientCertificateThumbprint>(
            guardedValue,
            (value) => ClusterClientCertificateThumbprint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      diagnosticsConfig: (() {
        final guardedValue = map['diagnosticsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterDiagnosticsConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fabricSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterFabricSetting>(
            guardedValue,
            (value) => ClusterFabricSetting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      managementEndpoint: (() {
        final guardedValue = map['managementEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      nodeTypes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterNodeType>(
            guardedValue,
            (value) =>
                ClusterNodeType.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      reliabilityLevel: (() {
        final guardedValue = map['reliabilityLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceGroupName: (() {
      ...
      reverseProxyCertificate: (() {
        final guardedValue = map['reverseProxyCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterReverseProxyCertificate.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      reverseProxyCertificateCommonNames: (() {
        final guardedValue = map['reverseProxyCertificateCommonNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterReverseProxyCertificateCommonNames.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      serviceFabricZonalUpgradeMode: (() {
        final guardedValue = map['serviceFabricZonalUpgradeMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
      ...
      vmssZonalUpgradeMode: (() {
        final guardedValue = map['vmssZonalUpgradeMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
