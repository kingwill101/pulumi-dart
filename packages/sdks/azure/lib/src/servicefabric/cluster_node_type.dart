    ...
    return <String, dynamic>{
      'applicationPorts':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(applicationPorts, (value) => value.toMap()),
      ...
      'ephemeralPorts':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(ephemeralPorts, (value) => value.toMap()),
    ...
    return ClusterNodeType(
      applicationPorts: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterNodeTypeApplicationPorts.fromMap(
      ...
      clientEndpointPort: pulumi.Input.fromValue(
        map['clientEndpointPort'] as int,
      ),
      durabilityLevel: (() {
        final guardedValue = map['durabilityLevel'];
        if (guardedValue == null) return null;
      ...
      ephemeralPorts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeTypeEphemeralPorts.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      multipleAvailabilityZones: (() {
        final guardedValue = map['multipleAvailabilityZones'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      reverseProxyEndpointPort: (() {
        final guardedValue = map['reverseProxyEndpointPort'];
        if (guardedValue == null) return null;
