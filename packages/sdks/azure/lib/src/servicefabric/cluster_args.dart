...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    required pulumi.Output<String> managementEndpoint,
    pulumi.Output<String>? name,
    required pulumi.Output<List<ClusterNodeType>> nodeTypes,
    required pulumi.Output<String> reliabilityLevel,
    ...
    required pulumi.Output<String> upgradeMode,
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      managementEndpoint: pulumi.Output.create<String>(map['managementEndpoint'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      nodeTypes: pulumi.Output.create<List<ClusterNodeType>>(pulumi.Input.decodeList<ClusterNodeType>(map['nodeTypes'], (value) => ClusterNodeType.fromMap((value as Map).cast<String, dynamic>()))),
      reliabilityLevel: pulumi.Output.create<String>(map['reliabilityLevel'] as String),
      ...
      upgradeMode: pulumi.Output.create<String>(map['upgradeMode'] as String),
