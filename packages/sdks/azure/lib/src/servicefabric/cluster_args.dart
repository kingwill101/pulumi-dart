...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      managementEndpoint: (map['managementEndpoint'] as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      nodeTypes: (pulumi.Input.decodeList<ClusterNodeType>(map['nodeTypes'], (value) => ClusterNodeType.fromMap((value as Map).cast<String, dynamic>()))).input(),
      reliabilityLevel: (map['reliabilityLevel'] as String).input(),
      ...
      upgradeMode: (map['upgradeMode'] as String).input(),
