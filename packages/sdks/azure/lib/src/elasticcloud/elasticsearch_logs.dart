    ...
    return <String, dynamic>{
      'filteringTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<ElasticsearchLogsFilteringTag>,
    ...
    return ElasticsearchLogs(
      filteringTags: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ElasticsearchLogsFilteringTag>(
            guardedValue,
            (value) => ElasticsearchLogsFilteringTag.fromMap(
      ...
      sendAzureadLogs: (() {
        final guardedValue = map['sendAzureadLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
