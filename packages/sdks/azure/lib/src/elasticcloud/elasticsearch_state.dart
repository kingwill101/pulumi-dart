...
class ElasticsearchState {
  ...
  factory ElasticsearchState.fromMap(Map<String, dynamic> map) {
    return ElasticsearchState(
      elasticCloudDeploymentId: (() { final guardedValue = map['elasticCloudDeploymentId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      elasticCloudEmailAddress: (() { final guardedValue = map['elasticCloudEmailAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      elasticCloudSsoDefaultUrl: (() { final guardedValue = map['elasticCloudSsoDefaultUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      elasticCloudUserId: (() { final guardedValue = map['elasticCloudUserId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      elasticsearchServiceUrl: (() { final guardedValue = map['elasticsearchServiceUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kibanaServiceUrl: (() { final guardedValue = map['kibanaServiceUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kibanaSsoUri: (() { final guardedValue = map['kibanaSsoUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
