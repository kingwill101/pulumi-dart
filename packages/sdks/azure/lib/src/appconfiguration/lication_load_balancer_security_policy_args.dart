...
class LicationLoadBalancerSecurityPolicyArgs {
  ...
  factory LicationLoadBalancerSecurityPolicyArgs.fromMap(
    ...
    return LicationLoadBalancerSecurityPolicyArgs(
      ...
      webApplicationFirewallPolicyId: pulumi.Input.fromValue(
        map['webApplicationFirewallPolicyId'] as String,
      ),
    );
  }
}
