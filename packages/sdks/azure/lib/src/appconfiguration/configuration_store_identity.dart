...
class ConfigurationStoreIdentity {
  ...
  /// Creates a new [ConfigurationStoreIdentity].
  ...
  factory ConfigurationStoreIdentity.fromMap(Map<String, dynamic> map) {
    return ConfigurationStoreIdentity(
