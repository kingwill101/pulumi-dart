    ...
    return <String, dynamic>{
      ...
      'primaryReadKeys':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(primaryReadKeys, (value) => value.toMap()),
      'primaryWriteKeys':
          pulumi.Input.encodeList<
            GetConfigurationStorePrimaryWriteKey,
            Map<String, dynamic>
          >(primaryWriteKeys, (value) => value.toMap()),
      ...
      'secondaryReadKeys':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(secondaryReadKeys, (value) => value.toMap()),
      'secondaryWriteKeys':
          pulumi.Input.encodeList<
            GetConfigurationStoreSecondaryWriteKey,
            Map<String, dynamic>
          >(secondaryWriteKeys, (value) => value.toMap()),
      'sku': sku,
  ...
  factory GetConfigurationStoreResult.fromMap(Map<String, dynamic> map) {
    return GetConfigurationStoreResult(
      dataPlaneProxyAuthenticationMode:
          map['dataPlaneProxyAuthenticationMode'] as String,
      dataPlaneProxyPrivateLinkDelegationEnabled:
          map['dataPlaneProxyPrivateLinkDelegationEnabled'] as bool,
      encryptions: pulumi.Input.decodeList<GetConfigurationStoreEncryption>(
        map['encryptions']!,
        (value) => GetConfigurationStoreEncryption.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      endpoint: map['endpoint'] as String,
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetConfigurationStoreIdentity>(
        map['identities']!,
        (value) => GetConfigurationStoreIdentity.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      primaryReadKeys:
          pulumi.Input.decodeList<GetConfigurationStorePrimaryReadKey>(
            map['primaryReadKeys']!,
            (value) => GetConfigurationStorePrimaryReadKey.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      primaryWriteKeys:
          pulumi.Input.decodeList<GetConfigurationStorePrimaryWriteKey>(
            map['primaryWriteKeys']!,
            (value) => GetConfigurationStorePrimaryWriteKey.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      replicas: pulumi.Input.decodeList<GetConfigurationStoreReplica>(
        map['replicas']!,
        (value) => GetConfigurationStoreReplica.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      resourceGroupName: map['resourceGroupName'] as String,
      secondaryReadKeys:
          pulumi.Input.decodeList<GetConfigurationStoreSecondaryReadKey>(
            map['secondaryReadKeys']!,
            (value) => GetConfigurationStoreSecondaryReadKey.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      secondaryWriteKeys:
          pulumi.Input.decodeList<GetConfigurationStoreSecondaryWriteKey>(
            map['secondaryWriteKeys']!,
            (value) => GetConfigurationStoreSecondaryWriteKey.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
