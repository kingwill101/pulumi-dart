...
class WorkspaceTableCustomLogArgs {
  ...
  WorkspaceTableCustomLogArgs({
    required pulumi.Output<List<WorkspaceTableCustomLogColumn>> columns,
    ...
    required pulumi.Output<String> workspaceId,
      ...
      columns = pulumi.Input.asInput<List<WorkspaceTableCustomLogColumn>>(columns),
  ...
  factory WorkspaceTableCustomLogArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceTableCustomLogArgs(
      columns: pulumi.Output.create<List<WorkspaceTableCustomLogColumn>>(pulumi.Input.decodeList<WorkspaceTableCustomLogColumn>(map['columns'], (value) => WorkspaceTableCustomLogColumn.fromMap((value as Map).cast<String, dynamic>()))),
