  ...
  factory NatRuleState.fromMap(Map<String, dynamic> map) {
    return NatRuleState(
      ...
      backendIpConfigurationId: (() {
        final guardedValue = map['backendIpConfigurationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      backendPort: (() {
      ...
      frontendIpConfigurationName: (() {
        final guardedValue = map['frontendIpConfigurationName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      frontendPort: (() {
      ...
      frontendPortEnd: (() {
        final guardedValue = map['frontendPortEnd'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      frontendPortStart: (() {
        final guardedValue = map['frontendPortStart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ...
      tcpResetEnabled: (() {
        final guardedValue = map['tcpResetEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
