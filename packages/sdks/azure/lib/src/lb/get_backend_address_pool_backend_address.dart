...
class GetBackendAddressPoolBackendAddress {
  ...
  factory GetBackendAddressPoolBackendAddress.fromMap(Map<String, dynamic> map) {
    return GetBackendAddressPoolBackendAddress(
      inboundNatRulePortMappings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendAddressPoolBackendAddressInboundNatRulePortMapping>(map['inboundNatRulePortMappings']!, (value) => GetBackendAddressPoolBackendAddressInboundNatRulePortMapping.fromMap((value as Map).cast<String, dynamic>()))),
