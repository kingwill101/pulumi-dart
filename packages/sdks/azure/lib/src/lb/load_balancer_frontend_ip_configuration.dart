...
class LoadBalancerFrontendIpConfiguration {
  ...
  final List<String>? loadBalancerRules;
  ...
  factory LoadBalancerFrontendIpConfiguration.fromMap(Map<String, dynamic> map) {
    return LoadBalancerFrontendIpConfiguration(
      ...
      inboundNatRules: map['inboundNatRules'] == null ? null : (map['inboundNatRules'] as List).cast<String>(),
      loadBalancerRules: map['loadBalancerRules'] == null ? null : (map['loadBalancerRules'] as List).cast<String>(),
      name: map['name'] as String,
      outboundRules: map['outboundRules'] == null ? null : (map['outboundRules'] as List).cast<String>(),
