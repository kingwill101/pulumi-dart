...
class GetBackendAddressPoolResult {
  ...
  final List<GetBackendAddressPoolBackendIpConfiguration>
    ...
    return <String, dynamic>{
      'backendAddresses':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(backendAddresses, (value) => value.toMap()),
      'backendIpConfigurations':
          pulumi.Input.encodeList<
            GetBackendAddressPoolBackendIpConfiguration,
            Map<String, dynamic>
          >(backendIpConfigurations, (value) => value.toMap()),
      'id': id,
  ...
  factory GetBackendAddressPoolResult.fromMap(Map<String, dynamic> map) {
    return GetBackendAddressPoolResult(
      backendAddresses:
          pulumi.Input.decodeList<GetBackendAddressPoolBackendAddress>(
            map['backendAddresses']!,
            (value) => GetBackendAddressPoolBackendAddress.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      backendIpConfigurations:
          pulumi.Input.decodeList<GetBackendAddressPoolBackendIpConfiguration>(
            map['backendIpConfigurations']!,
            (value) => GetBackendAddressPoolBackendIpConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      id: map['id'] as String,
