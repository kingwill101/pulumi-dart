...
class OutboundRuleState {
  ...
  final pulumi.Input<List<OutboundRuleFrontendIpConfiguration>>?
    ...
    return <String, dynamic>{
      ...
      'frontendIpConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<OutboundRuleFrontendIpConfiguration>,
    ...
    return OutboundRuleState(
      ...
      frontendIpConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OutboundRuleFrontendIpConfiguration>(
            guardedValue,
            (value) => OutboundRuleFrontendIpConfiguration.fromMap(
