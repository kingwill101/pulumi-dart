...
class TrafficManagerExternalEndpointArgs {
  ...
  const TrafficManagerExternalEndpointArgs({
  ...
  factory TrafficManagerExternalEndpointArgs.fromMap(Map<String, dynamic> map) {
    return TrafficManagerExternalEndpointArgs(
      ...
      customHeaders: (() { final guardedValue = map['customHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TrafficManagerExternalEndpointCustomHeader>(guardedValue, (value) => TrafficManagerExternalEndpointCustomHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      subnets: (() { final guardedValue = map['subnets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TrafficManagerExternalEndpointSubnet>(guardedValue, (value) => TrafficManagerExternalEndpointSubnet.fromMap((value as Map).cast<String, dynamic>()))); })(),
