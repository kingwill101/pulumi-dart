...
class GetVirtualHubConnectionRouting {
  ...
  final pulumi.Input<List<GetVirtualHubConnectionRoutingPropagatedRouteTable>>
  ...
  final pulumi.Input<List<GetVirtualHubConnectionRoutingStaticVnetRoute>>
  staticVnetRoutes;
    ...
    return <String, dynamic>{
      ...
      'propagatedRouteTables':
          pulumi.Input.mapInputValue<
            List<GetVirtualHubConnectionRoutingPropagatedRouteTable>,
      ...
      'staticVnetRoutes':
          pulumi.Input.mapInputValue<
            List<GetVirtualHubConnectionRoutingStaticVnetRoute>,
            List<Map<String, dynamic>>
          >(
            staticVnetRoutes,
            (value) =>
  ...
  factory GetVirtualHubConnectionRouting.fromMap(Map<String, dynamic> map) {
    return GetVirtualHubConnectionRouting(
      ...
      inboundRouteMapId: pulumi.Input.fromValue(
        map['inboundRouteMapId'] as String,
      ),
      outboundRouteMapId: pulumi.Input.fromValue(
        map['outboundRouteMapId'] as String,
      ),
      propagatedRouteTables: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetVirtualHubConnectionRoutingPropagatedRouteTable
        >(
          map['propagatedRouteTables']!,
          (value) => GetVirtualHubConnectionRoutingPropagatedRouteTable.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      staticVnetLocalRouteOverrideCriteria: pulumi.Input.fromValue(
        map['staticVnetLocalRouteOverrideCriteria'] as String,
      ),
      staticVnetPropagateStaticRoutesEnabled: pulumi.Input.fromValue(
        map['staticVnetPropagateStaticRoutesEnabled'] as bool,
      ),
      staticVnetRoutes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualHubConnectionRoutingStaticVnetRoute>(
          map['staticVnetRoutes']!,
          (value) => GetVirtualHubConnectionRoutingStaticVnetRoute.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
