...
class RoutingIntentArgs {
  ...
  factory RoutingIntentArgs.fromMap(Map<String, dynamic> map) {
    return RoutingIntentArgs(
      ...
      routingPolicies: pulumi.Input.fromValue(pulumi.Input.decodeList<RoutingIntentRoutingPolicy>(map['routingPolicies']!, (value) => RoutingIntentRoutingPolicy.fromMap((value as Map).cast<String, dynamic>()))),
