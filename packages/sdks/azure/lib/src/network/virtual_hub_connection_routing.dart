...
class VirtualHubConnectionRouting {
  ...
  final pulumi.Input<VirtualHubConnectionRoutingPropagatedRouteTable>?
  ...
  final pulumi.Input<List<VirtualHubConnectionRoutingStaticVnetRoute>>?
  staticVnetRoutes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'staticVnetRoutes':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualHubConnectionRoutingStaticVnetRoute>,
    ...
    return VirtualHubConnectionRouting(
      ...
      propagatedRouteTable: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualHubConnectionRoutingPropagatedRouteTable.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      staticVnetLocalRouteOverrideCriteria: (() {
        final guardedValue = map['staticVnetLocalRouteOverrideCriteria'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      staticVnetPropagateStaticRoutesEnabled: (() {
        final guardedValue = map['staticVnetPropagateStaticRoutesEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      staticVnetRoutes: (() {
        final guardedValue = map['staticVnetRoutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualHubConnectionRoutingStaticVnetRoute>(
            guardedValue,
            (value) => VirtualHubConnectionRoutingStaticVnetRoute.fromMap(
