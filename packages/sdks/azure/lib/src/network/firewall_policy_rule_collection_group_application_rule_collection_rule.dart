...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule {
  ...
  final pulumi.Input<
    List<FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleProtocol>
  >?
  protocols;
  ...
  factory FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule.fromMap(
    ...
    return FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule(
      ...
      destinationFqdnTags: (() {
        final guardedValue = map['destinationFqdnTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      destinationFqdns: (() {
      ...
      destinationUrls: (() {
        final guardedValue = map['destinationUrls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      httpHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader.fromMap(
      ...
      protocols: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleProtocol.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
