...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule {
  ...
  factory FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule(
      ...
      destinationFqdnTags: map['destinationFqdnTags'] == null ? null : ((map['destinationFqdnTags'] as List).cast<String>()).input(),
      destinationFqdns: map['destinationFqdns'] == null ? null : ((map['destinationFqdns'] as List).cast<String>()).input(),
      destinationUrls: map['destinationUrls'] == null ? null : ((map['destinationUrls'] as List).cast<String>()).input(),
      httpHeaders: map['httpHeaders'] == null ? null : (pulumi.Input.decodeList<FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader>(map['httpHeaders'], (value) => FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: (map['name'] as String).input(),
      protocols: map['protocols'] == null ? null : (pulumi.Input.decodeList<FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleProtocol>(map['protocols'], (value) => FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleProtocol.fromMap((value as Map).cast<String, dynamic>()))).input(),
