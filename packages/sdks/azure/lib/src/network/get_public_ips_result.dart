...
class GetPublicIPsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicIps':
          pulumi.Input.encodeList<GetPublicIPsPublicIp, Map<String, dynamic>>(
            publicIps,
            (value) => value.toMap(),
          ),
  ...
  factory GetPublicIPsResult.fromMap(Map<String, dynamic> map) {
    return GetPublicIPsResult(
      allocationType: (() {
        final guardedValue = map['allocationType'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      attachmentStatus: (() {
        final guardedValue = map['attachmentStatus'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      id: map['id'] as String,
      ...
      publicIps: pulumi.Input.decodeList<GetPublicIPsPublicIp>(
        map['publicIps']!,
        (value) => GetPublicIPsPublicIp.fromMap(
