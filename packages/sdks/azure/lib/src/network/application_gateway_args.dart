...
class ApplicationGatewayArgs {
  ...
  ApplicationGatewayArgs({
    ...
    required pulumi.Output<List<ApplicationGatewayBackendAddressPool>> backendAddressPools,
    required pulumi.Output<List<ApplicationGatewayBackendHttpSetting>> backendHttpSettings,
    pulumi.Output<List<ApplicationGatewayCustomErrorConfiguration>>? customErrorConfigurations,
    ...
    required pulumi.Output<List<ApplicationGatewayFrontendIpConfiguration>> frontendIpConfigurations,
    required pulumi.Output<List<ApplicationGatewayFrontendPort>> frontendPorts,
    required pulumi.Output<List<ApplicationGatewayGatewayIpConfiguration>> gatewayIpConfigurations,
    pulumi.Output<ApplicationGatewayGlobal>? global,
    required pulumi.Output<List<ApplicationGatewayHttpListener>> httpListeners,
    pulumi.Output<ApplicationGatewayIdentity>? identity,
    ...
    required pulumi.Output<List<ApplicationGatewayRequestRoutingRule>> requestRoutingRules,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<List<ApplicationGatewayRewriteRuleSet>>? rewriteRuleSets,
    required pulumi.Output<ApplicationGatewaySku> sku,
    ...
    pulumi.Output<ApplicationGatewayWafConfiguration>? wafConfiguration,
    pulumi.Output<List<String>>? zones,
      ...
      backendAddressPools = pulumi.Input.asInput<List<ApplicationGatewayBackendAddressPool>>(backendAddressPools),
      backendHttpSettings = pulumi.Input.asInput<List<ApplicationGatewayBackendHttpSetting>>(backendHttpSettings),
      customErrorConfigurations = pulumi.Input.asOptionalInput<List<ApplicationGatewayCustomErrorConfiguration>>(customErrorConfigurations),
      ...
      frontendIpConfigurations = pulumi.Input.asInput<List<ApplicationGatewayFrontendIpConfiguration>>(frontendIpConfigurations),
      frontendPorts = pulumi.Input.asInput<List<ApplicationGatewayFrontendPort>>(frontendPorts),
      gatewayIpConfigurations = pulumi.Input.asInput<List<ApplicationGatewayGatewayIpConfiguration>>(gatewayIpConfigurations),
      global = pulumi.Input.asOptionalInput<ApplicationGatewayGlobal>(global),
      httpListeners = pulumi.Input.asInput<List<ApplicationGatewayHttpListener>>(httpListeners),
      identity = pulumi.Input.asOptionalInput<ApplicationGatewayIdentity>(identity),
      ...
      requestRoutingRules = pulumi.Input.asInput<List<ApplicationGatewayRequestRoutingRule>>(requestRoutingRules),
      resourceGroupName = pulumi.Input.asInput<String>(resourceGroupName),
      rewriteRuleSets = pulumi.Input.asOptionalInput<List<ApplicationGatewayRewriteRuleSet>>(rewriteRuleSets),
      sku = pulumi.Input.asInput<ApplicationGatewaySku>(sku),
      ...
      wafConfiguration = pulumi.Input.asOptionalInput<ApplicationGatewayWafConfiguration>(wafConfiguration),
  ...
  factory ApplicationGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayArgs(
      ...
      backendAddressPools: pulumi.Output.create<List<ApplicationGatewayBackendAddressPool>>(pulumi.Input.decodeList<ApplicationGatewayBackendAddressPool>(map['backendAddressPools'], (value) => ApplicationGatewayBackendAddressPool.fromMap((value as Map).cast<String, dynamic>()))),
      backendHttpSettings: pulumi.Output.create<List<ApplicationGatewayBackendHttpSetting>>(pulumi.Input.decodeList<ApplicationGatewayBackendHttpSetting>(map['backendHttpSettings'], (value) => ApplicationGatewayBackendHttpSetting.fromMap((value as Map).cast<String, dynamic>()))),
      customErrorConfigurations: map['customErrorConfigurations'] == null ? null : pulumi.Output.create<List<ApplicationGatewayCustomErrorConfiguration>>(pulumi.Input.decodeList<ApplicationGatewayCustomErrorConfiguration>(map['customErrorConfigurations'], (value) => ApplicationGatewayCustomErrorConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      frontendIpConfigurations: pulumi.Output.create<List<ApplicationGatewayFrontendIpConfiguration>>(pulumi.Input.decodeList<ApplicationGatewayFrontendIpConfiguration>(map['frontendIpConfigurations'], (value) => ApplicationGatewayFrontendIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      frontendPorts: pulumi.Output.create<List<ApplicationGatewayFrontendPort>>(pulumi.Input.decodeList<ApplicationGatewayFrontendPort>(map['frontendPorts'], (value) => ApplicationGatewayFrontendPort.fromMap((value as Map).cast<String, dynamic>()))),
      gatewayIpConfigurations: pulumi.Output.create<List<ApplicationGatewayGatewayIpConfiguration>>(pulumi.Input.decodeList<ApplicationGatewayGatewayIpConfiguration>(map['gatewayIpConfigurations'], (value) => ApplicationGatewayGatewayIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      global: map['global'] == null ? null : pulumi.Output.create<ApplicationGatewayGlobal>(ApplicationGatewayGlobal.fromMap((map['global'] as Map).cast<String, dynamic>())),
      httpListeners: pulumi.Output.create<List<ApplicationGatewayHttpListener>>(pulumi.Input.decodeList<ApplicationGatewayHttpListener>(map['httpListeners'], (value) => ApplicationGatewayHttpListener.fromMap((value as Map).cast<String, dynamic>()))),
      identity: map['identity'] == null ? null : pulumi.Output.create<ApplicationGatewayIdentity>(ApplicationGatewayIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      requestRoutingRules: pulumi.Output.create<List<ApplicationGatewayRequestRoutingRule>>(pulumi.Input.decodeList<ApplicationGatewayRequestRoutingRule>(map['requestRoutingRules'], (value) => ApplicationGatewayRequestRoutingRule.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sku: pulumi.Output.create<ApplicationGatewaySku>(ApplicationGatewaySku.fromMap((map['sku'] as Map).cast<String, dynamic>())),
      ...
      wafConfiguration: map['wafConfiguration'] == null ? null : pulumi.Output.create<ApplicationGatewayWafConfiguration>(ApplicationGatewayWafConfiguration.fromMap((map['wafConfiguration'] as Map).cast<String, dynamic>())),
