...
class FirewallApplicationRuleCollectionArgs {
  ...
  FirewallApplicationRuleCollectionArgs({
    ...
    required pulumi.Output<List<FirewallApplicationRuleCollectionRule>> rules,
  }) :
      ...
      rules = pulumi.Input.asInput<List<FirewallApplicationRuleCollectionRule>>(rules);
  ...
  factory FirewallApplicationRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return FirewallApplicationRuleCollectionArgs(
      ...
      rules: pulumi.Output.create<List<FirewallApplicationRuleCollectionRule>>(pulumi.Input.decodeList<FirewallApplicationRuleCollectionRule>(map['rules'], (value) => FirewallApplicationRuleCollectionRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
