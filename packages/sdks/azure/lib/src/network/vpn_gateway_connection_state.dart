...
class VpnGatewayConnectionState {
  ...
  factory VpnGatewayConnectionState.fromMap(Map<String, dynamic> map) {
    return VpnGatewayConnectionState(
      ...
      remoteVpnSiteId: (() { final guardedValue = map['remoteVpnSiteId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      vpnLinks: (() { final guardedValue = map['vpnLinks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VpnGatewayConnectionVpnLink>(guardedValue, (value) => VpnGatewayConnectionVpnLink.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
