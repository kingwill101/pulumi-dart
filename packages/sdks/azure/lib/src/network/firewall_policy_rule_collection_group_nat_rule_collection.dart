...
class FirewallPolicyRuleCollectionGroupNatRuleCollection {
  ...
  final pulumi.Input<
    List<FirewallPolicyRuleCollectionGroupNatRuleCollectionRule>
  >
  rules;
  ...
  factory FirewallPolicyRuleCollectionGroupNatRuleCollection.fromMap(
    ...
    return FirewallPolicyRuleCollectionGroupNatRuleCollection(
      ...
      rules: pulumi.Input.fromValue(
        ...
        >(
          map['rules']!,
          (value) =>
              FirewallPolicyRuleCollectionGroupNatRuleCollectionRule.fromMap(
