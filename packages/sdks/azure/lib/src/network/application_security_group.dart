...
import 'application_security_group_state.dart';
...
class ApplicationSecurityGroup extends pulumi.CustomResource {
  ...
  /// Gets an existing [ApplicationSecurityGroup] resource's state with the given [name] and [id].
  static ApplicationSecurityGroup get(
    String name,
    pulumi.Input<String> id, {
    ApplicationSecurityGroupState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ApplicationSecurityGroup._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ApplicationSecurityGroup] resource.
  ApplicationSecurityGroup.reference(String urn)
    : super(
        'azure:network/applicationSecurityGroup:ApplicationSecurityGroup',
