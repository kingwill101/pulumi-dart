...
class ApplicationGatewayUrlPathMap {
  ...
  factory ApplicationGatewayUrlPathMap.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayUrlPathMap(
      defaultBackendAddressPoolId: (() { final guardedValue = map['defaultBackendAddressPoolId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultBackendAddressPoolName: (() { final guardedValue = map['defaultBackendAddressPoolName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultBackendHttpSettingsId: (() { final guardedValue = map['defaultBackendHttpSettingsId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultBackendHttpSettingsName: (() { final guardedValue = map['defaultBackendHttpSettingsName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultRedirectConfigurationId: (() { final guardedValue = map['defaultRedirectConfigurationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultRedirectConfigurationName: (() { final guardedValue = map['defaultRedirectConfigurationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultRewriteRuleSetId: (() { final guardedValue = map['defaultRewriteRuleSetId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultRewriteRuleSetName: (() { final guardedValue = map['defaultRewriteRuleSetName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      pathRules: pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayUrlPathMapPathRule>(map['pathRules']!, (value) => ApplicationGatewayUrlPathMapPathRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
