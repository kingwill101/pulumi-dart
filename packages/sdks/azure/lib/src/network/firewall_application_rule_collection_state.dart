...
class FirewallApplicationRuleCollectionState {
  ...
  FirewallApplicationRuleCollectionState({
    ...
    pulumi.Output<List<FirewallApplicationRuleCollectionRule>>? rules,
  }) :
      ...
      rules = pulumi.Input.asOptionalInput<List<FirewallApplicationRuleCollectionRule>>(rules);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?pulumi.Input.mapOptionalInputValue<List<FirewallApplicationRuleCollectionRule>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<FirewallApplicationRuleCollectionRule, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory FirewallApplicationRuleCollectionState.fromMap(Map<String, dynamic> map) {
    return FirewallApplicationRuleCollectionState(
      ...
      rules: map['rules'] == null ? null : pulumi.Output.create<List<FirewallApplicationRuleCollectionRule>>(pulumi.Input.decodeList<FirewallApplicationRuleCollectionRule>(map['rules'], (value) => FirewallApplicationRuleCollectionRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
