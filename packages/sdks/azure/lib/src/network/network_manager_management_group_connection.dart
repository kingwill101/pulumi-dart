...
import 'network_manager_management_group_connection_state.dart';
...
class NetworkManagerManagementGroupConnection extends pulumi.CustomResource {
  ...
  static NetworkManagerManagementGroupConnection get(
    String name,
  ...
  NetworkManagerManagementGroupConnection._get(
    String name, {
