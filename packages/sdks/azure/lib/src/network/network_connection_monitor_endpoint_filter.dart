...
class NetworkConnectionMonitorEndpointFilter {
  ...
  final List<NetworkConnectionMonitorEndpointFilterItem>? items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'items': ?items == null ? null : pulumi.Input.encodeList<NetworkConnectionMonitorEndpointFilterItem, Map<String, dynamic>>(items!, (value) => value.toMap()),
      'type': ?type,
    };
  }
  ...
  factory NetworkConnectionMonitorEndpointFilter.fromMap(Map<String, dynamic> map) {
    return NetworkConnectionMonitorEndpointFilter(
      items: map['items'] == null ? null : pulumi.Input.decodeList<NetworkConnectionMonitorEndpointFilterItem>(map['items'], (value) => NetworkConnectionMonitorEndpointFilterItem.fromMap((value as Map).cast<String, dynamic>())),
