...
class NetworkConnectionMonitorEndpointFilter {
  ...
  NetworkConnectionMonitorEndpointFilter({this.items, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'items':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkConnectionMonitorEndpointFilterItem>,
  ...
  factory NetworkConnectionMonitorEndpointFilter.fromMap(
    ...
    return NetworkConnectionMonitorEndpointFilter(
      items: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkConnectionMonitorEndpointFilterItem>(
            guardedValue,
            (value) => NetworkConnectionMonitorEndpointFilterItem.fromMap(
