...
class ApplicationGatewayRewriteRuleSetRewriteRule {
  ...
  const ApplicationGatewayRewriteRuleSetRewriteRule({
    this.conditions,
    required this.name,
  ...
  factory ApplicationGatewayRewriteRuleSetRewriteRule.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayRewriteRuleSetRewriteRule(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayRewriteRuleSetRewriteRuleCondition>(guardedValue, (value) => ApplicationGatewayRewriteRuleSetRewriteRuleCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
