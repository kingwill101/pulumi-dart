...
class NetworkInterfaceState {
  ...
  factory NetworkInterfaceState.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceState(
      ...
      appliedDnsServers: (() {
        final guardedValue = map['appliedDnsServers'];
        if (guardedValue == null) return null;
      ...
      internalDnsNameLabel: (() {
        final guardedValue = map['internalDnsNameLabel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      internalDomainNameSuffix: (() {
        final guardedValue = map['internalDomainNameSuffix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkInterfaceIpConfiguration>(
            guardedValue,
            (value) => NetworkInterfaceIpConfiguration.fromMap(
      ...
      ipForwardingEnabled: (() {
        final guardedValue = map['ipForwardingEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      location: (() {
