...
class GetVpnGatewayBgpSettingInstance0BgpPeeringAddress {
  ...
  const GetVpnGatewayBgpSettingInstance0BgpPeeringAddress({
  ...
  factory GetVpnGatewayBgpSettingInstance0BgpPeeringAddress.fromMap(Map<String, dynamic> map) {
    return GetVpnGatewayBgpSettingInstance0BgpPeeringAddress(
      ...
      defaultIps: pulumi.Input.fromValue((map['defaultIps'] as List).cast<String>()),
      ipConfigurationId: pulumi.Input.fromValue(map['ipConfigurationId'] as String),
      tunnelIps: pulumi.Input.fromValue((map['tunnelIps'] as List).cast<String>()),
    );
  }
}
