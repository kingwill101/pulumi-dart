...
class NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentState {
  ...
  factory NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentState.fromMap(
    ...
    return NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentState(
      ...
      destinationResourceId: (() {
        final guardedValue = map['destinationResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipTraffic: (() {
        final guardedValue = map['ipTraffic'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentIpTraffic.fromMap(
      ...
      verifierWorkspaceId: (() {
        final guardedValue = map['verifierWorkspaceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
