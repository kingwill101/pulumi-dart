...
class ApplicationGatewayRewriteRuleSet {
  ...
  final pulumi.Input<List<ApplicationGatewayRewriteRuleSetRewriteRule>>?
  rewriteRules;
    ...
    return <String, dynamic>{
      ...
      'rewriteRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationGatewayRewriteRuleSetRewriteRule>,
    ...
    return ApplicationGatewayRewriteRuleSet(
      ...
      rewriteRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationGatewayRewriteRuleSetRewriteRule>(
            guardedValue,
            (value) => ApplicationGatewayRewriteRuleSetRewriteRule.fromMap(
