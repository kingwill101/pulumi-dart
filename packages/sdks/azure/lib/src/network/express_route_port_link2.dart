  ...
  factory ExpressRoutePortLink2.fromMap(Map<String, dynamic> map) {
    return ExpressRoutePortLink2(
      ...
      macsecCakKeyvaultSecretId: (() {
        final guardedValue = map['macsecCakKeyvaultSecretId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      macsecCipher: (() {
        final guardedValue = map['macsecCipher'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      macsecCknKeyvaultSecretId: (() {
        final guardedValue = map['macsecCknKeyvaultSecretId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      macsecSciEnabled: (() {
        final guardedValue = map['macsecSciEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      patchPanelId: (() {
        final guardedValue = map['patchPanelId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rackId: (() {
        final guardedValue = map['rackId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      routerName: (() {
        final guardedValue = map['routerName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
