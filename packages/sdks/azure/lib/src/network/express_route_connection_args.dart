...
class ExpressRouteConnectionArgs {
  ...
  ExpressRouteConnectionArgs({
    ...
    required pulumi.Output<String> expressRouteCircuitPeeringId,
    pulumi.Output<bool>? expressRouteGatewayBypassEnabled,
    required pulumi.Output<String> expressRouteGatewayId,
  ...
  factory ExpressRouteConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteConnectionArgs(
      ...
      expressRouteCircuitPeeringId: pulumi.Output.create<String>(map['expressRouteCircuitPeeringId'] as String),
      ...
      expressRouteGatewayId: pulumi.Output.create<String>(map['expressRouteGatewayId'] as String),
