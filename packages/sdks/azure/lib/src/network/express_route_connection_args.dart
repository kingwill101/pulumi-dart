...
class ExpressRouteConnectionArgs {
  ...
  factory ExpressRouteConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteConnectionArgs(
      ...
      expressRouteCircuitPeeringId: pulumi.Input.fromValue(
        map['expressRouteCircuitPeeringId'] as String,
      ),
      ...
      expressRouteGatewayId: pulumi.Input.fromValue(
        map['expressRouteGatewayId'] as String,
      ),
      name: (() {
