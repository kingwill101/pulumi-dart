...
class TrafficManagerProfileMonitorConfig {
  ...
  final pulumi.Input<List<TrafficManagerProfileMonitorConfigCustomHeader>>?
  customHeaders;
    ...
    return <String, dynamic>{
      'customHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<TrafficManagerProfileMonitorConfigCustomHeader>,
    ...
    return TrafficManagerProfileMonitorConfig(
      customHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<TrafficManagerProfileMonitorConfigCustomHeader>(
            guardedValue,
            (value) => TrafficManagerProfileMonitorConfigCustomHeader.fromMap(
