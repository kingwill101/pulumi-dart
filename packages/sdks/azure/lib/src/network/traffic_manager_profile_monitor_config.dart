...
class TrafficManagerProfileMonitorConfig {
  ...
  factory TrafficManagerProfileMonitorConfig.fromMap(Map<String, dynamic> map) {
    return TrafficManagerProfileMonitorConfig(
      customHeaders: map['customHeaders'] == null ? null : (pulumi.Input.decodeList<TrafficManagerProfileMonitorConfigCustomHeader>(map['customHeaders']!, (value) => TrafficManagerProfileMonitorConfigCustomHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
