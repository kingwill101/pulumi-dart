...
class TrafficManagerAzureEndpointArgs {
  ...
  final pulumi.Input<List<TrafficManagerAzureEndpointCustomHeader>>?
  customHeaders;
    ...
    return <String, dynamic>{
      ...
      'customHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<TrafficManagerAzureEndpointCustomHeader>,
      ...
      'subnets':
          ?pulumi.Input.mapOptionalInputValue<
            List<TrafficManagerAzureEndpointSubnet>,
            List<Map<String, dynamic>>
          >(
            subnets,
            (value) =>
    ...
    return TrafficManagerAzureEndpointArgs(
      ...
      customHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrafficManagerAzureEndpointCustomHeader>(
            guardedValue,
            (value) => TrafficManagerAzureEndpointCustomHeader.fromMap(
      ...
      subnets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrafficManagerAzureEndpointSubnet>(
            guardedValue,
            (value) => TrafficManagerAzureEndpointSubnet.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
