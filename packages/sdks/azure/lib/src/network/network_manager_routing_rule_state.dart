...
class NetworkManagerRoutingRuleState {
  ...
  factory NetworkManagerRoutingRuleState.fromMap(Map<String, dynamic> map) {
    return NetworkManagerRoutingRuleState(
      ...
      destination: (() { final guardedValue = map['destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkManagerRoutingRuleDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nextHop: (() { final guardedValue = map['nextHop']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkManagerRoutingRuleNextHop.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ruleCollectionId: (() { final guardedValue = map['ruleCollectionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
