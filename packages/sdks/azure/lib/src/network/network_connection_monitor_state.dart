...
class NetworkConnectionMonitorState {
  ...
  factory NetworkConnectionMonitorState.fromMap(Map<String, dynamic> map) {
    return NetworkConnectionMonitorState(
      endpoints: (() { final guardedValue = map['endpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkConnectionMonitorEndpoint>(guardedValue, (value) => NetworkConnectionMonitorEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      testConfigurations: (() { final guardedValue = map['testConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkConnectionMonitorTestConfiguration>(guardedValue, (value) => NetworkConnectionMonitorTestConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      testGroups: (() { final guardedValue = map['testGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkConnectionMonitorTestGroup>(guardedValue, (value) => NetworkConnectionMonitorTestGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
