...
class ExpressRouteCircuitPeeringMicrosoftPeeringConfig {
  ...
  factory ExpressRouteCircuitPeeringMicrosoftPeeringConfig.fromMap(
    ...
    return ExpressRouteCircuitPeeringMicrosoftPeeringConfig(
      ...
      advertisedPublicPrefixes: pulumi.Input.fromValue(
        (map['advertisedPublicPrefixes'] as List).cast<String>(),
      ),
      customerAsn: (() {
