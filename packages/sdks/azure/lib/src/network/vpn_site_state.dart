...
class VpnSiteState {
    ...
    return <String, dynamic>{
      ...
      'links':
          ...
          >(
            links,
            (value) =>
                pulumi.Input.encodeList<VpnSiteLink, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory VpnSiteState.fromMap(Map<String, dynamic> map) {
    return VpnSiteState(
      addressCidrs: (() {
        final guardedValue = map['addressCidrs'];
      ...
      links: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpnSiteLink>(
            guardedValue,
            (value) =>
                VpnSiteLink.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      location: (() {
