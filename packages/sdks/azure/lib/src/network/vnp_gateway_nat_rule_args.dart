    ...
    return <String, dynamic>{
      'externalMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<VnpGatewayNatRuleExternalMapping>,
      ...
      'internalMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<VnpGatewayNatRuleInternalMapping>,
            List<Map<String, dynamic>>
          >(
            internalMappings,
            (value) =>
    ...
    return VnpGatewayNatRuleArgs(
      externalMappings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VnpGatewayNatRuleExternalMapping>(
            guardedValue,
            (value) => VnpGatewayNatRuleExternalMapping.fromMap(
      ...
      internalMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VnpGatewayNatRuleInternalMapping>(
            guardedValue,
            (value) => VnpGatewayNatRuleInternalMapping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
