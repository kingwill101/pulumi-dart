...
class NetworkConnectionMonitorTestConfigurationHttpConfiguration {
  ...
  factory NetworkConnectionMonitorTestConfigurationHttpConfiguration.fromMap(
      ...
      requestHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NetworkConnectionMonitorTestConfigurationHttpConfigurationRequestHeader.fromMap(
