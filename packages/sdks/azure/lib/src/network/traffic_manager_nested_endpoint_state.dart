...
class TrafficManagerNestedEndpointState {
  ...
  factory TrafficManagerNestedEndpointState.fromMap(Map<String, dynamic> map) {
    return TrafficManagerNestedEndpointState(
      customHeaders: (() { final guardedValue = map['customHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TrafficManagerNestedEndpointCustomHeader>(guardedValue, (value) => TrafficManagerNestedEndpointCustomHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
