...
class VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy {
  ...
  factory VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy.fromMap(
    ...
    return VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy(
      ...
      saDataSizeInKilobytes: pulumi.Input.fromValue(
        map['saDataSizeInKilobytes'] as int,
      ),
      saLifetimeInSeconds: pulumi.Input.fromValue(
        map['saLifetimeInSeconds'] as int,
      ),
    );
  }
}
