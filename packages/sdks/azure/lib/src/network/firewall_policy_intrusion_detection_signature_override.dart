...
class FirewallPolicyIntrusionDetectionSignatureOverride {
  ...
  FirewallPolicyIntrusionDetectionSignatureOverride({this.id, this.state});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'id': ?id, 'state': ?state};
  }

  factory FirewallPolicyIntrusionDetectionSignatureOverride.fromMap(
