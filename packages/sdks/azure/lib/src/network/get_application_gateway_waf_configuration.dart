...
class GetApplicationGatewayWafConfiguration {
  ...
  factory GetApplicationGatewayWafConfiguration.fromMap(Map<String, dynamic> map) {
    return GetApplicationGatewayWafConfiguration(
      disabledRuleGroups: (pulumi.Input.decodeList<GetApplicationGatewayWafConfigurationDisabledRuleGroup>(map['disabledRuleGroups'], (value) => GetApplicationGatewayWafConfigurationDisabledRuleGroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enabled: (map['enabled'] as bool).input(),
      exclusions: (pulumi.Input.decodeList<GetApplicationGatewayWafConfigurationExclusion>(map['exclusions'], (value) => GetApplicationGatewayWafConfigurationExclusion.fromMap((value as Map).cast<String, dynamic>()))).input(),
      fileUploadLimitMb: (map['fileUploadLimitMb'] as int).input(),
      firewallMode: (map['firewallMode'] as String).input(),
      maxRequestBodySizeKb: (map['maxRequestBodySizeKb'] as int).input(),
      requestBodyCheck: (map['requestBodyCheck'] as bool).input(),
