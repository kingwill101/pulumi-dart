...
class GetApplicationGatewayWafConfiguration {
  ...
  final pulumi.Input<List<GetApplicationGatewayWafConfigurationExclusion>>
  exclusions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exclusions':
          pulumi.Input.mapInputValue<
            List<GetApplicationGatewayWafConfigurationExclusion>,
            List<Map<String, dynamic>>
          >(
            exclusions,
            (value) =>
  ...
  factory GetApplicationGatewayWafConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetApplicationGatewayWafConfiguration(
      disabledRuleGroups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetApplicationGatewayWafConfigurationDisabledRuleGroup
        >(
          map['disabledRuleGroups']!,
          (value) =>
              GetApplicationGatewayWafConfigurationDisabledRuleGroup.fromMap(
      ...
      exclusions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetApplicationGatewayWafConfigurationExclusion>(
          map['exclusions']!,
          (value) => GetApplicationGatewayWafConfigurationExclusion.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      fileUploadLimitMb: pulumi.Input.fromValue(
        map['fileUploadLimitMb'] as int,
      ),
      firewallMode: pulumi.Input.fromValue(map['firewallMode'] as String),
      maxRequestBodySizeKb: pulumi.Input.fromValue(
        map['maxRequestBodySizeKb'] as int,
      ),
