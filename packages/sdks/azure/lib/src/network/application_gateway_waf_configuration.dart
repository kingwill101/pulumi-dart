...
class ApplicationGatewayWafConfiguration {
  ...
  final pulumi.Input<List<ApplicationGatewayWafConfigurationDisabledRuleGroup>>?
  disabledRuleGroups;
  ...
  final pulumi.Input<List<ApplicationGatewayWafConfigurationExclusion>>?
  exclusions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exclusions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationGatewayWafConfigurationExclusion>,
            List<Map<String, dynamic>>
          >(
            exclusions,
            (value) =>
  ...
  factory ApplicationGatewayWafConfiguration.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayWafConfiguration(
      disabledRuleGroups: (() {
        final guardedValue = map['disabledRuleGroups'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ApplicationGatewayWafConfigurationDisabledRuleGroup.fromMap(
      ...
      exclusions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationGatewayWafConfigurationExclusion>(
            guardedValue,
            (value) => ApplicationGatewayWafConfigurationExclusion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      fileUploadLimitMb: (() {
        final guardedValue = map['fileUploadLimitMb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      firewallMode: pulumi.Input.fromValue(map['firewallMode'] as String),
      maxRequestBodySizeKb: (() {
        final guardedValue = map['maxRequestBodySizeKb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      requestBodyCheck: (() {
      ...
      ruleSetType: (() {
        final guardedValue = map['ruleSetType'];
        if (guardedValue == null) return null;
