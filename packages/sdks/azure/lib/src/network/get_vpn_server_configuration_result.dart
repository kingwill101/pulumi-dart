...
class GetVpnServerConfigurationResult {
  ...
  final List<GetVpnServerConfigurationAzureActiveDirectoryAuthentication>
  azureActiveDirectoryAuthentications;

  /// One or more `client_revoked_certificate` blocks as defined below.
  final List<GetVpnServerConfigurationClientRevokedCertificate>
  clientRevokedCertificates;

  /// One or more `client_root_certificate` blocks as defined below.
  final List<GetVpnServerConfigurationClientRootCertificate>
    ...
    return <String, dynamic>{
      'azureActiveDirectoryAuthentications':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(azureActiveDirectoryAuthentications, (value) => value.toMap()),
      'clientRevokedCertificates':
          pulumi.Input.encodeList<
            GetVpnServerConfigurationClientRevokedCertificate,
            Map<String, dynamic>
          >(clientRevokedCertificates, (value) => value.toMap()),
      'clientRootCertificates':
          pulumi.Input.encodeList<
            GetVpnServerConfigurationClientRootCertificate,
            Map<String, dynamic>
          >(clientRootCertificates, (value) => value.toMap()),
      'id': id,
      'ipsecPolicies':
          pulumi.Input.encodeList<
    ...
    return GetVpnServerConfigurationResult(
      azureActiveDirectoryAuthentications:
          ...
          >(
            ...
            (value) =>
                GetVpnServerConfigurationAzureActiveDirectoryAuthentication.fromMap(
      ...
      clientRevokedCertificates:
          pulumi.Input.decodeList<
            GetVpnServerConfigurationClientRevokedCertificate
          >(
            map['clientRevokedCertificates']!,
            (value) =>
                GetVpnServerConfigurationClientRevokedCertificate.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      clientRootCertificates:
          pulumi
              .Input.decodeList<GetVpnServerConfigurationClientRootCertificate>(
            map['clientRootCertificates']!,
            (value) => GetVpnServerConfigurationClientRootCertificate.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      id: map['id'] as String,
      ipsecPolicies:
          pulumi.Input.decodeList<GetVpnServerConfigurationIpsecPolicy>(
            map['ipsecPolicies']!,
            (value) => GetVpnServerConfigurationIpsecPolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      location: map['location'] as String,
      name: map['name'] as String,
      radii: pulumi.Input.decodeList<GetVpnServerConfigurationRadius>(
        map['radii']!,
        (value) => GetVpnServerConfigurationRadius.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      resourceGroupName: map['resourceGroupName'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      vpnAuthenticationTypes: (map['vpnAuthenticationTypes'] as List)
          .cast<String>(),
