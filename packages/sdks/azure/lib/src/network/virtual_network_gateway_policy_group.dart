...
class VirtualNetworkGatewayPolicyGroup {
  ...
  final pulumi.Input<List<VirtualNetworkGatewayPolicyGroupPolicyMember>>
  policyMembers;
    ...
    return <String, dynamic>{
      ...
      'policyMembers':
          pulumi.Input.mapInputValue<
            List<VirtualNetworkGatewayPolicyGroupPolicyMember>,
  ...
  factory VirtualNetworkGatewayPolicyGroup.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayPolicyGroup(
      ...
      policyMembers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VirtualNetworkGatewayPolicyGroupPolicyMember>(
          map['policyMembers']!,
          (value) => VirtualNetworkGatewayPolicyGroupPolicyMember.fromMap(
