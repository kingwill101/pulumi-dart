...
///   }
/// }
/// resource "azure_network_trafficmanagerexternalendpoint" "example" {
///   name                 = "example-endpoint"
...
class TrafficManagerExternalEndpoint extends pulumi.CustomResource {
  ...
  /// Gets an existing [TrafficManagerExternalEndpoint] resource's state with the given [name] and [id].
  static TrafficManagerExternalEndpoint get(
    String name,
  ...
  TrafficManagerExternalEndpoint._get(
    String name, {
