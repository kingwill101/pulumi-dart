...
class ApplicationGatewayRequestRoutingRule {
  ...
  factory ApplicationGatewayRequestRoutingRule.fromMap(
    ...
    return ApplicationGatewayRequestRoutingRule(
      ...
      backendAddressPoolName: (() {
        final guardedValue = map['backendAddressPoolName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      backendHttpSettingsId: (() {
        final guardedValue = map['backendHttpSettingsId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      backendHttpSettingsName: (() {
        final guardedValue = map['backendHttpSettingsName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      httpListenerId: (() {
        final guardedValue = map['httpListenerId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      httpListenerName: pulumi.Input.fromValue(
        map['httpListenerName'] as String,
      ),
      id: (() {
      ...
      redirectConfigurationId: (() {
        final guardedValue = map['redirectConfigurationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      redirectConfigurationName: (() {
        final guardedValue = map['redirectConfigurationName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rewriteRuleSetId: (() {
        final guardedValue = map['rewriteRuleSetId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rewriteRuleSetName: (() {
        final guardedValue = map['rewriteRuleSetName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ruleType: pulumi.Input.fromValue(map['ruleType'] as String),
      urlPathMapId: (() {
        final guardedValue = map['urlPathMapId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      urlPathMapName: (() {
        final guardedValue = map['urlPathMapName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
