...
class GetVpnServerConfigurationRadius {
  ...
  final pulumi.Input<List<GetVpnServerConfigurationRadiusClientRootCertificate>>
  clientRootCertificates;

  /// One or more `server_root_certificate` blocks as defined below.
  final pulumi.Input<List<GetVpnServerConfigurationRadiusServerRootCertificate>>
    ...
    return <String, dynamic>{
      'clientRootCertificates':
          pulumi.Input.mapInputValue<
            List<GetVpnServerConfigurationRadiusClientRootCertificate>,
      ...
      'serverRootCertificates':
          pulumi.Input.mapInputValue<
            List<GetVpnServerConfigurationRadiusServerRootCertificate>,
            List<Map<String, dynamic>>
          >(
            serverRootCertificates,
            (value) =>
      ...
      'servers':
          pulumi.Input.mapInputValue<
            List<GetVpnServerConfigurationRadiusServer>,
            List<Map<String, dynamic>>
          >(
            servers,
            (value) =>
  ...
  factory GetVpnServerConfigurationRadius.fromMap(Map<String, dynamic> map) {
    return GetVpnServerConfigurationRadius(
      clientRootCertificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetVpnServerConfigurationRadiusClientRootCertificate
        >(
          map['clientRootCertificates']!,
          (value) =>
              GetVpnServerConfigurationRadiusClientRootCertificate.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      serverRootCertificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetVpnServerConfigurationRadiusServerRootCertificate
        >(
          map['serverRootCertificates']!,
          (value) =>
              GetVpnServerConfigurationRadiusServerRootCertificate.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      servers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpnServerConfigurationRadiusServer>(
          map['servers']!,
          (value) => GetVpnServerConfigurationRadiusServer.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
