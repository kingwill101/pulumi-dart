...
class NetworkSecurityRuleArgs {
  ...
  factory NetworkSecurityRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityRuleArgs(
      ...
      destinationApplicationSecurityGroupIds: map['destinationApplicationSecurityGroupIds'] == null ? null : (map['destinationApplicationSecurityGroupIds'] as String).input(),
      ...
      sourceApplicationSecurityGroupIds: map['sourceApplicationSecurityGroupIds'] == null ? null : (map['sourceApplicationSecurityGroupIds'] as String).input(),
