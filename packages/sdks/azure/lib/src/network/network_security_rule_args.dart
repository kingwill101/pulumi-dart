...
class NetworkSecurityRuleArgs {
  ...
  factory NetworkSecurityRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityRuleArgs(
      ...
      destinationApplicationSecurityGroupIds: (() { final guardedValue = map['destinationApplicationSecurityGroupIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      sourceApplicationSecurityGroupIds: (() { final guardedValue = map['sourceApplicationSecurityGroupIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
