...
class PointToPointVpnGatewayConnectionConfiguration {
  ...
  factory PointToPointVpnGatewayConnectionConfiguration.fromMap(
    ...
    return PointToPointVpnGatewayConnectionConfiguration(
      ...
      route: (() {
        final guardedValue = map['route'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PointToPointVpnGatewayConnectionConfigurationRoute.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vpnClientAddressPool: pulumi.Input.fromValue(
        PointToPointVpnGatewayConnectionConfigurationVpnClientAddressPool.fromMap(
