...
class FirewallNetworkRuleCollectionArgs {
  ...
  factory FirewallNetworkRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return FirewallNetworkRuleCollectionArgs(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallNetworkRuleCollectionRule>(map['rules']!, (value) => FirewallNetworkRuleCollectionRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
