...
class FirewallPolicyInsightsLogAnalyticsWorkspace {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'firewallLocation': firewallLocation, 'id': id};
  }

  factory FirewallPolicyInsightsLogAnalyticsWorkspace.fromMap(
    Map<String, dynamic> map,
  ) {
    return FirewallPolicyInsightsLogAnalyticsWorkspace(
      firewallLocation: pulumi.Input.fromValue(
        map['firewallLocation'] as String,
      ),
