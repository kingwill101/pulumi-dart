...
class PointToPointVpnGatewayArgs {
  ...
  const PointToPointVpnGatewayArgs({
  ...
  factory PointToPointVpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return PointToPointVpnGatewayArgs(
      connectionConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<PointToPointVpnGatewayConnectionConfiguration>(map['connectionConfigurations']!, (value) => PointToPointVpnGatewayConnectionConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      scaleUnit: pulumi.Input.fromValue((map['scaleUnit'] as num).toInt()),
