...
class FirewallNetworkRuleCollectionState {
  ...
  FirewallNetworkRuleCollectionState({
    ...
    pulumi.Output<List<FirewallNetworkRuleCollectionRule>>? rules,
  }) :
      ...
      rules = pulumi.Input.asOptionalInput<List<FirewallNetworkRuleCollectionRule>>(rules);
  ...
  factory FirewallNetworkRuleCollectionState.fromMap(Map<String, dynamic> map) {
    return FirewallNetworkRuleCollectionState(
      ...
      rules: map['rules'] == null ? null : pulumi.Output.create<List<FirewallNetworkRuleCollectionRule>>(pulumi.Input.decodeList<FirewallNetworkRuleCollectionRule>(map['rules'], (value) => FirewallNetworkRuleCollectionRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
