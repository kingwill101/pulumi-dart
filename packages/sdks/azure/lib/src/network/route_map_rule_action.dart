...
class RouteMapRuleAction {
  ...
  RouteMapRuleAction({this.parameters, required this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouteMapRuleActionParameter>,
    ...
    return RouteMapRuleAction(
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RouteMapRuleActionParameter>(
            guardedValue,
            (value) => RouteMapRuleActionParameter.fromMap(
