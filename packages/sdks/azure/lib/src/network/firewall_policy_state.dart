...
class FirewallPolicyState {
  ...
  FirewallPolicyState({
    ...
    pulumi.Output<List<String>>? ruleCollectionGroups,
    ...
    pulumi.Output<FirewallPolicyTlsCertificate>? tlsCertificate,
      ...
      childPolicies = pulumi.Input.asOptionalInput<List<String>>(childPolicies),
      ...
      firewalls = pulumi.Input.asOptionalInput<List<String>>(firewalls),
      ...
      ruleCollectionGroups = pulumi.Input.asOptionalInput<List<String>>(ruleCollectionGroups),
  ...
  factory FirewallPolicyState.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyState(
      ...
      childPolicies: map['childPolicies'] == null ? null : pulumi.Output.create<List<String>>((map['childPolicies'] as List).cast<String>()),
      ...
      firewalls: map['firewalls'] == null ? null : pulumi.Output.create<List<String>>((map['firewalls'] as List).cast<String>()),
      ...
      ruleCollectionGroups: map['ruleCollectionGroups'] == null ? null : pulumi.Output.create<List<String>>((map['ruleCollectionGroups'] as List).cast<String>()),
