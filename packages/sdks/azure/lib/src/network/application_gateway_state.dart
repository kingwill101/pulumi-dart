...
class ApplicationGatewayState {
  ...
  factory ApplicationGatewayState.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayState(
      ...
      backendHttpSettings: map['backendHttpSettings'] == null ? null : (pulumi.Input.decodeList<ApplicationGatewayBackendHttpSetting>(map['backendHttpSettings']!, (value) => ApplicationGatewayBackendHttpSetting.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      gatewayIpConfigurations: map['gatewayIpConfigurations'] == null ? null : (pulumi.Input.decodeList<ApplicationGatewayGatewayIpConfiguration>(map['gatewayIpConfigurations']!, (value) => ApplicationGatewayGatewayIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      privateEndpointConnections: map['privateEndpointConnections'] == null ? null : (pulumi.Input.decodeList<ApplicationGatewayPrivateEndpointConnection>(map['privateEndpointConnections']!, (value) => ApplicationGatewayPrivateEndpointConnection.fromMap((value as Map).cast<String, dynamic>()))).input(),
