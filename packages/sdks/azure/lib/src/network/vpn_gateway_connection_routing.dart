...
class VpnGatewayConnectionRouting {
  ...
  final pulumi.Input<VpnGatewayConnectionRoutingPropagatedRouteTable>?
  ...
  factory VpnGatewayConnectionRouting.fromMap(Map<String, dynamic> map) {
    return VpnGatewayConnectionRouting(
      associatedRouteTable: pulumi.Input.fromValue(
        map['associatedRouteTable'] as String,
      ),
      inboundRouteMapId: (() {
      ...
      propagatedRouteTable: (() {
        ...
        return pulumi.Input.fromValue(
          VpnGatewayConnectionRoutingPropagatedRouteTable.fromMap(
