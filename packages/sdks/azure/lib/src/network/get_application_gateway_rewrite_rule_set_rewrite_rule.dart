...
class GetApplicationGatewayRewriteRuleSetRewriteRule {
  ...
  factory GetApplicationGatewayRewriteRuleSetRewriteRule.fromMap(Map<String, dynamic> map) {
    return GetApplicationGatewayRewriteRuleSetRewriteRule(
      conditions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationGatewayRewriteRuleSetRewriteRuleCondition>(map['conditions']!, (value) => GetApplicationGatewayRewriteRuleSetRewriteRuleCondition.fromMap((value as Map).cast<String, dynamic>()))),
