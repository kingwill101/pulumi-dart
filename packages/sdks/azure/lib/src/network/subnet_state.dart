    ...
    return <String, dynamic>{
      ...
      'delegations':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubnetDelegation>,
            List<Map<String, dynamic>>
          >(
            delegations,
            (value) =>
                pulumi.Input.encodeList<SubnetDelegation, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'ipAddressPool':
          ?pulumi.Input.mapOptionalInputValue<
            SubnetIpAddressPool,
            Map<String, dynamic>
          >(ipAddressPool, (value) => value.toMap()),
      'name': ?name,
  ...
  factory SubnetState.fromMap(Map<String, dynamic> map) {
    return SubnetState(
      ...
      defaultOutboundAccessEnabled: (() {
        final guardedValue = map['defaultOutboundAccessEnabled'];
        if (guardedValue == null) return null;
      ...
      delegations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubnetDelegation>(
            guardedValue,
            (value) => SubnetDelegation.fromMap(
      ...
      ipAddressPool: (() {
        final guardedValue = map['ipAddressPool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetIpAddressPool.fromMap(
      ...
      privateLinkServiceNetworkPoliciesEnabled: (() {
        final guardedValue = map['privateLinkServiceNetworkPoliciesEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      resourceGroupName: (() {
      ...
      serviceEndpointPolicyIds: (() {
        final guardedValue = map['serviceEndpointPolicyIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      serviceEndpoints: (() {
