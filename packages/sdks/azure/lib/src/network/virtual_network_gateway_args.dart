...
class VirtualNetworkGatewayArgs {
  ...
  VirtualNetworkGatewayArgs({
    ...
    pulumi.Output<VirtualNetworkGatewayBgpSettings>? bgpSettings,
    pulumi.Output<VirtualNetworkGatewayCustomRoute>? customRoute,
    pulumi.Output<String>? defaultLocalNetworkGatewayId,
    pulumi.Output<bool>? dnsForwardingEnabled,
    pulumi.Output<String>? edgeZone,
    pulumi.Output<bool>? enableBgp,
    pulumi.Output<String>? generation,
    required pulumi.Output<List<VirtualNetworkGatewayIpConfiguration>> ipConfigurations,
    pulumi.Output<bool>? ipSecReplayProtectionEnabled,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<List<VirtualNetworkGatewayPolicyGroup>>? policyGroups,
    pulumi.Output<bool>? privateIpAddressEnabled,
    pulumi.Output<bool>? remoteVnetTrafficEnabled,
    required pulumi.Output<String> resourceGroupName,
    required pulumi.Output<String> sku,
    pulumi.Output<Map<String, String>>? tags,
    required pulumi.Output<String> type,
    pulumi.Output<bool>? virtualWanTrafficEnabled,
    pulumi.Output<VirtualNetworkGatewayVpnClientConfiguration>? vpnClientConfiguration,
  ...
  factory VirtualNetworkGatewayArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayArgs(
      ...
      bgpSettings: map['bgpSettings'] == null ? null : pulumi.Output.create<VirtualNetworkGatewayBgpSettings>(VirtualNetworkGatewayBgpSettings.fromMap((map['bgpSettings'] as Map).cast<String, dynamic>())),
      customRoute: map['customRoute'] == null ? null : pulumi.Output.create<VirtualNetworkGatewayCustomRoute>(VirtualNetworkGatewayCustomRoute.fromMap((map['customRoute'] as Map).cast<String, dynamic>())),
      defaultLocalNetworkGatewayId: map['defaultLocalNetworkGatewayId'] == null ? null : pulumi.Output.create<String>(map['defaultLocalNetworkGatewayId'] as String),
      dnsForwardingEnabled: map['dnsForwardingEnabled'] == null ? null : pulumi.Output.create<bool>(map['dnsForwardingEnabled'] as bool),
      ...
      ipConfigurations: pulumi.Output.create<List<VirtualNetworkGatewayIpConfiguration>>(pulumi.Input.decodeList<VirtualNetworkGatewayIpConfiguration>(map['ipConfigurations'], (value) => VirtualNetworkGatewayIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      ipSecReplayProtectionEnabled: map['ipSecReplayProtectionEnabled'] == null ? null : pulumi.Output.create<bool>(map['ipSecReplayProtectionEnabled'] as bool),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      policyGroups: map['policyGroups'] == null ? null : pulumi.Output.create<List<VirtualNetworkGatewayPolicyGroup>>(pulumi.Input.decodeList<VirtualNetworkGatewayPolicyGroup>(map['policyGroups'], (value) => VirtualNetworkGatewayPolicyGroup.fromMap((value as Map).cast<String, dynamic>()))),
      privateIpAddressEnabled: map['privateIpAddressEnabled'] == null ? null : pulumi.Output.create<bool>(map['privateIpAddressEnabled'] as bool),
      remoteVnetTrafficEnabled: map['remoteVnetTrafficEnabled'] == null ? null : pulumi.Output.create<bool>(map['remoteVnetTrafficEnabled'] as bool),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      sku: pulumi.Output.create<String>(map['sku'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      type: pulumi.Output.create<String>(map['type'] as String),
      virtualWanTrafficEnabled: map['virtualWanTrafficEnabled'] == null ? null : pulumi.Output.create<bool>(map['virtualWanTrafficEnabled'] as bool),
      vpnClientConfiguration: map['vpnClientConfiguration'] == null ? null : pulumi.Output.create<VirtualNetworkGatewayVpnClientConfiguration>(VirtualNetworkGatewayVpnClientConfiguration.fromMap((map['vpnClientConfiguration'] as Map).cast<String, dynamic>())),
