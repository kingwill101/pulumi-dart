...
class NetworkManagerAdminRuleArgs {
    ...
    return <String, dynamic>{
      ...
      'destinations':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkManagerAdminRuleDestination>,
      ...
      'sources':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkManagerAdminRuleSource>,
            List<Map<String, dynamic>>
          >(
            sources,
            (value) =>
  ...
  factory NetworkManagerAdminRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkManagerAdminRuleArgs(
      ...
      adminRuleCollectionId: pulumi.Input.fromValue(
        map['adminRuleCollectionId'] as String,
      ),
      description: (() {
      ...
      destinations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkManagerAdminRuleDestination>(
            guardedValue,
            (value) => NetworkManagerAdminRuleDestination.fromMap(
      ...
      sources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkManagerAdminRuleSource>(
            guardedValue,
            (value) => NetworkManagerAdminRuleSource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
