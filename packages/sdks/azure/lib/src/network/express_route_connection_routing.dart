...
class ExpressRouteConnectionRouting {
  ...
  final pulumi.Input<ExpressRouteConnectionRoutingPropagatedRouteTable>?
  ...
  factory ExpressRouteConnectionRouting.fromMap(Map<String, dynamic> map) {
    return ExpressRouteConnectionRouting(
      associatedRouteTableId: (() {
        final guardedValue = map['associatedRouteTableId'];
      ...
      propagatedRouteTable: (() {
        ...
        return pulumi.Input.fromValue(
          ExpressRouteConnectionRoutingPropagatedRouteTable.fromMap(
