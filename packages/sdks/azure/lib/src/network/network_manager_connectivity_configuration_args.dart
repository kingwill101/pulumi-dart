...
class NetworkManagerConnectivityConfigurationArgs {
  ...
  factory NetworkManagerConnectivityConfigurationArgs.fromMap(
    ...
    return NetworkManagerConnectivityConfigurationArgs(
      appliesToGroups: pulumi.Input.fromValue(
        ...
        >(
          map['appliesToGroups']!,
          (value) =>
              NetworkManagerConnectivityConfigurationAppliesToGroup.fromMap(
      ...
      deleteExistingPeeringEnabled: (() {
        final guardedValue = map['deleteExistingPeeringEnabled'];
      ...
      hub: (() {
        ...
        return pulumi.Input.fromValue(
          NetworkManagerConnectivityConfigurationHub.fromMap(
