...
class NetworkManagerConnectivityConfigurationArgs {
  ...
  factory NetworkManagerConnectivityConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return NetworkManagerConnectivityConfigurationArgs(
      appliesToGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkManagerConnectivityConfigurationAppliesToGroup>(map['appliesToGroups']!, (value) => NetworkManagerConnectivityConfigurationAppliesToGroup.fromMap((value as Map).cast<String, dynamic>()))),
