...
class VpnGatewayConnectionVpnLink {
  ...
  final pulumi.Input<List<VpnGatewayConnectionVpnLinkCustomBgpAddress>>?
  customBgpAddresses;
  ...
  final pulumi.Input<List<VpnGatewayConnectionVpnLinkIpsecPolicy>>?
  ipsecPolicies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipsecPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpnGatewayConnectionVpnLinkIpsecPolicy>,
            List<Map<String, dynamic>>
          >(
            ipsecPolicies,
            (value) =>
  ...
  factory VpnGatewayConnectionVpnLink.fromMap(Map<String, dynamic> map) {
    return VpnGatewayConnectionVpnLink(
      bandwidthMbps: (() {
        final guardedValue = map['bandwidthMbps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      bgpEnabled: (() {
        final guardedValue = map['bgpEnabled'];
        if (guardedValue == null) return null;
      ...
      customBgpAddresses: (() {
        final guardedValue = map['customBgpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpnGatewayConnectionVpnLinkCustomBgpAddress>(
            guardedValue,
            (value) => VpnGatewayConnectionVpnLinkCustomBgpAddress.fromMap(
      ...
      egressNatRuleIds: (() {
        final guardedValue = map['egressNatRuleIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ingressNatRuleIds: (() {
        final guardedValue = map['ingressNatRuleIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ipsecPolicies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpnGatewayConnectionVpnLinkIpsecPolicy>(
            guardedValue,
            (value) => VpnGatewayConnectionVpnLinkIpsecPolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      localAzureIpAddressEnabled: (() {
        final guardedValue = map['localAzureIpAddressEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      policyBasedTrafficSelectorEnabled: (() {
        final guardedValue = map['policyBasedTrafficSelectorEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      protocol: (() {
      ...
      ratelimitEnabled: (() {
        final guardedValue = map['ratelimitEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      routeWeight: (() {
        final guardedValue = map['routeWeight'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sharedKey: (() {
