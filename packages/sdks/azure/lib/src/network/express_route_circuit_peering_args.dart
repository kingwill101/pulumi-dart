...
class ExpressRouteCircuitPeeringArgs {
  ...
  final pulumi.Input<ExpressRouteCircuitPeeringMicrosoftPeeringConfig>?
    ...
    return ExpressRouteCircuitPeeringArgs(
      ...
      ipv6: (() {
        ...
        return pulumi.Input.fromValue(
          ExpressRouteCircuitPeeringIpv6.fromMap(
      ...
      microsoftPeeringConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpressRouteCircuitPeeringMicrosoftPeeringConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
