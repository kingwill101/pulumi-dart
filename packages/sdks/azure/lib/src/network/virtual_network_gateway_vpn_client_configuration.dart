...
class VirtualNetworkGatewayVpnClientConfiguration {
  ...
  final pulumi.Input<VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy>?
  ipsecPolicy;
  ...
  final pulumi.Input<
    List<VirtualNetworkGatewayVpnClientConfigurationRadiusServer>
  >?
  radiusServers;
  ...
  final pulumi.Input<
    List<VirtualNetworkGatewayVpnClientConfigurationRootCertificate>
  >?
  rootCertificates;
  ...
  factory VirtualNetworkGatewayVpnClientConfiguration.fromMap(
    ...
    return VirtualNetworkGatewayVpnClientConfiguration(
      ...
      ipsecPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy.fromMap(
      ...
      radiusServers: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VirtualNetworkGatewayVpnClientConfigurationRadiusServer.fromMap(
      ...
      revokedCertificates: (() {
        final guardedValue = map['revokedCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            VirtualNetworkGatewayVpnClientConfigurationRevokedCertificate
          >(
            guardedValue,
            (value) =>
                VirtualNetworkGatewayVpnClientConfigurationRevokedCertificate.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      rootCertificates: (() {
        final guardedValue = map['rootCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            VirtualNetworkGatewayVpnClientConfigurationRootCertificate
          >(
            guardedValue,
            (value) =>
                VirtualNetworkGatewayVpnClientConfigurationRootCertificate.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      virtualNetworkGatewayClientConnections: (() {
        final guardedValue = map['virtualNetworkGatewayClientConnections'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection
          >(
            guardedValue,
            (value) =>
                VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      vpnAuthTypes: (() {
        final guardedValue = map['vpnAuthTypes'];
        if (guardedValue == null) return null;
