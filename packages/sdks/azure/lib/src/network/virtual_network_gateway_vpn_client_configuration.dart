...
class VirtualNetworkGatewayVpnClientConfiguration {
  ...
  /// [ipsecPolicy] An `ipsecPolicy` block as defined below.
  /// [radiusServerAddress] The address of the Radius server.
  /// [radiusServerSecret] The secret used by the Radius server.
  /// [radiusServers] One or more `radiusServer` blocks as defined below.
  /// [revokedCertificates] One or more `revokedCertificate` blocks which are defined below.
  /// [rootCertificates] One or more `rootCertificate` blocks which are defined below. These root certificates are used to sign the client certificate used by the VPN clients to connect to the gateway.
  /// [virtualNetworkGatewayClientConnections] One or more `virtualNetworkGatewayClientConnection` blocks as defined below.
