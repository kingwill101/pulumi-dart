...
class NetworkConnectionMonitorEndpoint {
  ...
  factory NetworkConnectionMonitorEndpoint.fromMap(Map<String, dynamic> map) {
    return NetworkConnectionMonitorEndpoint(
      ...
      excludedIpAddresses: (() { final guardedValue = map['excludedIpAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConnectionMonitorEndpointFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      includedIpAddresses: (() { final guardedValue = map['includedIpAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
