...
class VpnGatewayBgpSettingsInstance1BgpPeeringAddress {
  ...
  const VpnGatewayBgpSettingsInstance1BgpPeeringAddress({
  ...
  factory VpnGatewayBgpSettingsInstance1BgpPeeringAddress.fromMap(Map<String, dynamic> map) {
    return VpnGatewayBgpSettingsInstance1BgpPeeringAddress(
      customIps: pulumi.Input.fromValue((map['customIps'] as List).cast<String>()),
      defaultIps: (() { final guardedValue = map['defaultIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      tunnelIps: (() { final guardedValue = map['tunnelIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
