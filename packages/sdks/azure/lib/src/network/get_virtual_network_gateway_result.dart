...
class GetVirtualNetworkGatewayResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'ipConfigurations': pulumi.Input.encodeList<GetVirtualNetworkGatewayIpConfiguration, Map<String, dynamic>>(ipConfigurations, (value) => value.toMap()),
      'location': location,
      'name': name,
      ...
      'tags': tags,
      'type': type,
      'vpnClientConfigurations': pulumi.Input.encodeList<GetVirtualNetworkGatewayVpnClientConfiguration, Map<String, dynamic>>(vpnClientConfigurations, (value) => value.toMap()),
      'vpnType': vpnType,
    };
  }
  ...
  factory GetVirtualNetworkGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualNetworkGatewayResult(
      ...
      id: map['id'] as String,
      ipConfigurations: pulumi.Input.decodeList<GetVirtualNetworkGatewayIpConfiguration>(map['ipConfigurations']!, (value) => GetVirtualNetworkGatewayIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      vpnClientConfigurations: pulumi.Input.decodeList<GetVirtualNetworkGatewayVpnClientConfiguration>(map['vpnClientConfigurations']!, (value) => GetVirtualNetworkGatewayVpnClientConfiguration.fromMap((value as Map).cast<String, dynamic>())),
