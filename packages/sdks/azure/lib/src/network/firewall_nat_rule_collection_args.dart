...
class FirewallNatRuleCollectionArgs {
  ...
  FirewallNatRuleCollectionArgs({
    ...
    required pulumi.Output<List<FirewallNatRuleCollectionRule>> rules,
  }) :
  ...
  factory FirewallNatRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return FirewallNatRuleCollectionArgs(
      ...
      rules: pulumi.Output.create<List<FirewallNatRuleCollectionRule>>(pulumi.Input.decodeList<FirewallNatRuleCollectionRule>(map['rules'], (value) => FirewallNatRuleCollectionRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
