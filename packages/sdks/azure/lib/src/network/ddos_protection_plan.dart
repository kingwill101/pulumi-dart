...
///   location = "West Europe"
/// }
/// resource "azure_network_ddosprotectionplan" "example" {
///   name                = "example-protection-plan"
...
class DdosProtectionPlan extends pulumi.CustomResource {
  ...
  DdosProtectionPlan(
    ...
    virtualNetworkIds = registerOutput<List<String>>('virtualNetworkIds', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
  }
