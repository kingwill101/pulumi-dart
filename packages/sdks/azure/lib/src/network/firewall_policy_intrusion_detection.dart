...
class FirewallPolicyIntrusionDetection {
  ...
  final pulumi.Input<List<FirewallPolicyIntrusionDetectionSignatureOverride>>?
  signatureOverrides;

  /// One or more `traffic_bypass` blocks as defined below.
  final pulumi.Input<List<FirewallPolicyIntrusionDetectionTrafficBypass>>?
  trafficBypasses;
    ...
    return <String, dynamic>{
      ...
      'signatureOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyIntrusionDetectionSignatureOverride>,
      ...
      'trafficBypasses':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyIntrusionDetectionTrafficBypass>,
            List<Map<String, dynamic>>
          >(
            trafficBypasses,
            (value) =>
  ...
  factory FirewallPolicyIntrusionDetection.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIntrusionDetection(
      ...
      signatureOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyIntrusionDetectionSignatureOverride.fromMap(
      ...
      trafficBypasses: (() {
        final guardedValue = map['trafficBypasses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<FirewallPolicyIntrusionDetectionTrafficBypass>(
            guardedValue,
            (value) => FirewallPolicyIntrusionDetectionTrafficBypass.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
