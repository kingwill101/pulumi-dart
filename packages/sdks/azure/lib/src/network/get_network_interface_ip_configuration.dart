...
class GetNetworkInterfaceIpConfiguration {
  ...
  factory GetNetworkInterfaceIpConfiguration.fromMap(Map<String, dynamic> map) {
    return GetNetworkInterfaceIpConfiguration(
      applicationGatewayBackendAddressPoolsIds: pulumi.Input.fromValue(
        (map['applicationGatewayBackendAddressPoolsIds'] as List)
            .cast<String>(),
      ),
      applicationSecurityGroupIds: pulumi.Input.fromValue(
        (map['applicationSecurityGroupIds'] as List).cast<String>(),
      ),
      gatewayLoadBalancerFrontendIpConfigurationId: pulumi.Input.fromValue(
        map['gatewayLoadBalancerFrontendIpConfigurationId'] as String,
      ),
      loadBalancerBackendAddressPoolsIds: pulumi.Input.fromValue(
        (map['loadBalancerBackendAddressPoolsIds'] as List).cast<String>(),
      ),
