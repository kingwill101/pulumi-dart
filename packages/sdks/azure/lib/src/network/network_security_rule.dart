...
class NetworkSecurityRule extends pulumi.CustomResource {
  ...
  NetworkSecurityRule(
    ...
    this.destinationAddressPrefix = registerOutput<String?>('destinationAddressPrefix');
    this.destinationAddressPrefixes = registerOutput<List<String>?>('destinationAddressPrefixes');
    this.destinationApplicationSecurityGroupIds = registerOutput<String?>('destinationApplicationSecurityGroupIds');
    ...
    this.networkSecurityGroupName = registerOutput<String>('networkSecurityGroupName');
    this.priority = registerOutput<int>('priority');
    this.protocol = registerOutput<String>('protocol');
    this.resourceGroupName = registerOutput<String>('resourceGroupName');
    this.sourceAddressPrefix = registerOutput<String?>('sourceAddressPrefix');
    this.sourceAddressPrefixes = registerOutput<List<String>?>('sourceAddressPrefixes');
    this.sourceApplicationSecurityGroupIds = registerOutput<String?>('sourceApplicationSecurityGroupIds');
