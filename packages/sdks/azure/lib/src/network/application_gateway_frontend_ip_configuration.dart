...
class ApplicationGatewayFrontendIpConfiguration {
  ...
  factory ApplicationGatewayFrontendIpConfiguration.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayFrontendIpConfiguration(
      ...
      privateLinkConfigurationId: (() { final guardedValue = map['privateLinkConfigurationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      privateLinkConfigurationName: (() { final guardedValue = map['privateLinkConfigurationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
