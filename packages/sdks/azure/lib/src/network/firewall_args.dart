...
class FirewallArgs {
  ...
  final pulumi.Input<FirewallManagementIpConfiguration>?
    ...
    return <String, dynamic>{
      ...
      'managementIpConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(managementIpConfiguration, (value) => value.toMap()),
      'name': ?name,
    ...
    return FirewallArgs(
      ...
      ipConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallIpConfiguration>(
            guardedValue,
            (value) => FirewallIpConfiguration.fromMap(
      ...
      managementIpConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirewallManagementIpConfiguration.fromMap(
      ...
      skuTier: pulumi.Input.fromValue(map['skuTier'] as String),
      tags: (() {
