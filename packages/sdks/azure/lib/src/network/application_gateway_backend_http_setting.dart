...
class ApplicationGatewayBackendHttpSetting {
  ...
  final pulumi.Input<
    List<ApplicationGatewayBackendHttpSettingAuthenticationCertificate>
  >?
  authenticationCertificates;

  /// A `connection_draining` block as defined below.
  final pulumi.Input<ApplicationGatewayBackendHttpSettingConnectionDraining>?
  connectionDraining;
  ...
  factory ApplicationGatewayBackendHttpSetting.fromMap(
    ...
    return ApplicationGatewayBackendHttpSetting(
      ...
      authenticationCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ApplicationGatewayBackendHttpSettingAuthenticationCertificate.fromMap(
      ...
      connectionDraining: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationGatewayBackendHttpSettingConnectionDraining.fromMap(
      ...
      dedicatedBackendConnectionEnabled: (() {
        final guardedValue = map['dedicatedBackendConnectionEnabled'];
        if (guardedValue == null) return null;
      ...
      probeName: (() {
        final guardedValue = map['probeName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      trustedRootCertificateNames: (() {
        final guardedValue = map['trustedRootCertificateNames'];
        if (guardedValue == null) return null;
