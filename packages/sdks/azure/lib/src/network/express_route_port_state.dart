    ...
    return <String, dynamic>{
      ...
      'link1':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(link1, (value) => value.toMap()),
      'link2':
          ?pulumi.Input.mapOptionalInputValue<
            ExpressRoutePortLink2,
            Map<String, dynamic>
          >(link2, (value) => value.toMap()),
      'location': ?location,
      'mtu': ?mtu,
      'name': ?name,
    ...
    return ExpressRoutePortState(
      ...
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          ExpressRoutePortIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      link1: (() {
        final guardedValue = map['link1'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpressRoutePortLink1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      link2: (() {
        final guardedValue = map['link2'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpressRoutePortLink2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
