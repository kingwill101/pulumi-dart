...
class TrafficManagerProfileState {
  ...
  factory TrafficManagerProfileState.fromMap(Map<String, dynamic> map) {
    return TrafficManagerProfileState(
      dnsConfig: (() { final guardedValue = map['dnsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TrafficManagerProfileDnsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      monitorConfig: (() { final guardedValue = map['monitorConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TrafficManagerProfileMonitorConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
