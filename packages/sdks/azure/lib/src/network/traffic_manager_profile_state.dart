...
class TrafficManagerProfileState {
  ...
  TrafficManagerProfileState({
    pulumi.Output<TrafficManagerProfileDnsConfig>? dnsConfig,
    pulumi.Output<String>? fqdn,
    pulumi.Output<int>? maxReturn,
    pulumi.Output<TrafficManagerProfileMonitorConfig>? monitorConfig,
    ...
    pulumi.Output<bool>? trafficViewEnabled,
      ...
      dnsConfig = pulumi.Input.asOptionalInput<TrafficManagerProfileDnsConfig>(dnsConfig),
      fqdn = pulumi.Input.asOptionalInput<String>(fqdn),
      maxReturn = pulumi.Input.asOptionalInput<int>(maxReturn),
      monitorConfig = pulumi.Input.asOptionalInput<TrafficManagerProfileMonitorConfig>(monitorConfig),
  ...
  factory TrafficManagerProfileState.fromMap(Map<String, dynamic> map) {
    return TrafficManagerProfileState(
      dnsConfig: map['dnsConfig'] == null ? null : pulumi.Output.create<TrafficManagerProfileDnsConfig>(TrafficManagerProfileDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>())),
      ...
      monitorConfig: map['monitorConfig'] == null ? null : pulumi.Output.create<TrafficManagerProfileMonitorConfig>(TrafficManagerProfileMonitorConfig.fromMap((map['monitorConfig'] as Map).cast<String, dynamic>())),
