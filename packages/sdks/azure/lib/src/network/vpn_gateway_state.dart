...
class VpnGatewayState {
  ...
  factory VpnGatewayState.fromMap(Map<String, dynamic> map) {
    return VpnGatewayState(
      ...
      bgpSettings: (() { final guardedValue = map['bgpSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpnGatewayBgpSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ipConfigurations: (() { final guardedValue = map['ipConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VpnGatewayIpConfiguration>(guardedValue, (value) => VpnGatewayIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
