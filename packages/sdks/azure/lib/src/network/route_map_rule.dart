...
class RouteMapRule {
  ...
  factory RouteMapRule.fromMap(Map<String, dynamic> map) {
    return RouteMapRule(
      actions: (() { final guardedValue = map['actions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouteMapRuleAction>(guardedValue, (value) => RouteMapRuleAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      matchCriterions: (() { final guardedValue = map['matchCriterions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouteMapRuleMatchCriterion>(guardedValue, (value) => RouteMapRuleMatchCriterion.fromMap((value as Map).cast<String, dynamic>()))); })(),
