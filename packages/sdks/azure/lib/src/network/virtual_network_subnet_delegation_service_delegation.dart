...
class VirtualNetworkSubnetDelegationServiceDelegation {
  ...
  /// Creates a new [VirtualNetworkSubnetDelegationServiceDelegation].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'actions': ?actions, 'name': name};
  }

  factory VirtualNetworkSubnetDelegationServiceDelegation.fromMap(
