...
class VirtualNetworkGatewayConnectionArgs {
  ...
  factory VirtualNetworkGatewayConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayConnectionArgs(
      ...
      customBgpAddresses: map['customBgpAddresses'] == null ? null : (VirtualNetworkGatewayConnectionCustomBgpAddresses.fromMap((map['customBgpAddresses']! as Map).cast<String, dynamic>())).input(),
      ...
      expressRouteCircuitId: map['expressRouteCircuitId'] == null ? null : (map['expressRouteCircuitId']! as String).input(),
      ...
      ipsecPolicy: map['ipsecPolicy'] == null ? null : (VirtualNetworkGatewayConnectionIpsecPolicy.fromMap((map['ipsecPolicy']! as Map).cast<String, dynamic>())).input(),
      localAzureIpAddressEnabled: map['localAzureIpAddressEnabled'] == null ? null : (map['localAzureIpAddressEnabled']! as bool).input(),
      localNetworkGatewayId: map['localNetworkGatewayId'] == null ? null : (map['localNetworkGatewayId']! as String).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      peerVirtualNetworkGatewayId: map['peerVirtualNetworkGatewayId'] == null ? null : (map['peerVirtualNetworkGatewayId']! as String).input(),
      ...
      trafficSelectorPolicy: map['trafficSelectorPolicy'] == null ? null : (VirtualNetworkGatewayConnectionTrafficSelectorPolicy.fromMap((map['trafficSelectorPolicy']! as Map).cast<String, dynamic>())).input(),
