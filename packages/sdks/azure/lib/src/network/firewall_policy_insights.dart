...
class FirewallPolicyInsights {
  ...
  final pulumi.Input<List<FirewallPolicyInsightsLogAnalyticsWorkspace>>?
    ...
    return <String, dynamic>{
      ...
      'logAnalyticsWorkspaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyInsightsLogAnalyticsWorkspace>,
  ...
  factory FirewallPolicyInsights.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyInsights(
      defaultLogAnalyticsWorkspaceId: pulumi.Input.fromValue(
        map['defaultLogAnalyticsWorkspaceId'] as String,
      ),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      logAnalyticsWorkspaces: (() {
        final guardedValue = map['logAnalyticsWorkspaces'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyInsightsLogAnalyticsWorkspace>(
            guardedValue,
            (value) => FirewallPolicyInsightsLogAnalyticsWorkspace.fromMap(
