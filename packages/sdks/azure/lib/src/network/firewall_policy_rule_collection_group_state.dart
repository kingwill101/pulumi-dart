...
class FirewallPolicyRuleCollectionGroupState {
  /// One or more `application_rule_collection` blocks as defined below.
  final pulumi.Input<
    List<FirewallPolicyRuleCollectionGroupApplicationRuleCollection>
  >?
  ...
  final pulumi.Input<List<FirewallPolicyRuleCollectionGroupNatRuleCollection>>?
  natRuleCollections;

  /// One or more `network_rule_collection` blocks as defined below.
  final pulumi.Input<
    List<FirewallPolicyRuleCollectionGroupNetworkRuleCollection>
  >?
  ...
  /// Creates a new [FirewallPolicyRuleCollectionGroupState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'natRuleCollections':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyRuleCollectionGroupNatRuleCollection>,
            List<Map<String, dynamic>>
          >(
            natRuleCollections,
            (value) =>
  ...
  factory FirewallPolicyRuleCollectionGroupState.fromMap(
      ...
      applicationRuleCollections: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyRuleCollectionGroupApplicationRuleCollection.fromMap(
      ...
      natRuleCollections: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyRuleCollectionGroupNatRuleCollection.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      networkRuleCollections: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyRuleCollectionGroupNetworkRuleCollection.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
