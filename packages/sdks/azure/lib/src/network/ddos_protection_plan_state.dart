...
class DdosProtectionPlanState {
  ...
  factory DdosProtectionPlanState.fromMap(Map<String, dynamic> map) {
    return DdosProtectionPlanState(
      ...
      virtualNetworkIds: (() { final guardedValue = map['virtualNetworkIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
