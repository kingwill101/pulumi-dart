...
class GetApplicationGatewayUrlPathMap {
  ...
  factory GetApplicationGatewayUrlPathMap.fromMap(Map<String, dynamic> map) {
    return GetApplicationGatewayUrlPathMap(
      defaultBackendAddressPoolId: pulumi.Input.fromValue(map['defaultBackendAddressPoolId'] as String),
      defaultBackendAddressPoolName: pulumi.Input.fromValue(map['defaultBackendAddressPoolName'] as String),
      defaultBackendHttpSettingsId: pulumi.Input.fromValue(map['defaultBackendHttpSettingsId'] as String),
      defaultBackendHttpSettingsName: pulumi.Input.fromValue(map['defaultBackendHttpSettingsName'] as String),
      defaultRedirectConfigurationId: pulumi.Input.fromValue(map['defaultRedirectConfigurationId'] as String),
      defaultRedirectConfigurationName: pulumi.Input.fromValue(map['defaultRedirectConfigurationName'] as String),
      defaultRewriteRuleSetId: pulumi.Input.fromValue(map['defaultRewriteRuleSetId'] as String),
      defaultRewriteRuleSetName: pulumi.Input.fromValue(map['defaultRewriteRuleSetName'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      name: pulumi.Input.fromValue(map['name'] as String),
      pathRules: pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationGatewayUrlPathMapPathRule>(map['pathRules']!, (value) => GetApplicationGatewayUrlPathMapPathRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
