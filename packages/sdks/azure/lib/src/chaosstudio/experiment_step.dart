...
class ExperimentStep {
  ...
  ExperimentStep({required this.branches, required this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'branches':
          pulumi.Input.mapInputValue<
            List<ExperimentStepBranch>,
  ...
  factory ExperimentStep.fromMap(Map<String, dynamic> map) {
    return ExperimentStep(
      branches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ExperimentStepBranch>(
          map['branches']!,
          (value) => ExperimentStepBranch.fromMap(
