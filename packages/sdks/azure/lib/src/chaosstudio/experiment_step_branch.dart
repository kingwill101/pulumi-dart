...
class ExperimentStepBranch {
  ...
  factory ExperimentStepBranch.fromMap(Map<String, dynamic> map) {
    return ExperimentStepBranch(
      actions: (pulumi.Input.decodeList<ExperimentStepBranchAction>(map['actions'], (value) => ExperimentStepBranchAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
