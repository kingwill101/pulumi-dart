...
class ExperimentStepBranch {
  ...
  ExperimentStepBranch({required this.actions, required this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<ExperimentStepBranchAction>,
  ...
  factory ExperimentStepBranch.fromMap(Map<String, dynamic> map) {
    return ExperimentStepBranch(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ExperimentStepBranchAction>(
          map['actions']!,
          (value) => ExperimentStepBranchAction.fromMap(
