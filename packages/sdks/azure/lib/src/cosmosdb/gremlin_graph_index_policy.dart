...
class GremlinGraphIndexPolicy {
  ...
  final pulumi.Input<List<GremlinGraphIndexPolicyCompositeIndex>>?
  compositeIndices;
    ...
    return <String, dynamic>{
      ...
      'compositeIndices':
          ?pulumi.Input.mapOptionalInputValue<
            List<GremlinGraphIndexPolicyCompositeIndex>,
      ...
      'spatialIndices':
          ?pulumi.Input.mapOptionalInputValue<
            List<GremlinGraphIndexPolicySpatialIndex>,
            List<Map<String, dynamic>>
          >(
            spatialIndices,
            (value) =>
    ...
    return GremlinGraphIndexPolicy(
      ...
      compositeIndices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GremlinGraphIndexPolicyCompositeIndex>(
            guardedValue,
            (value) => GremlinGraphIndexPolicyCompositeIndex.fromMap(
      ...
      spatialIndices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GremlinGraphIndexPolicySpatialIndex>(
            guardedValue,
            (value) => GremlinGraphIndexPolicySpatialIndex.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
