...
class MongoCollectionState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'systemIndexes':
          ?pulumi.Input.mapOptionalInputValue<
            List<MongoCollectionSystemIndex>,
            List<Map<String, dynamic>>
          >(
            systemIndexes,
            (value) =>
    ...
    return MongoCollectionState(
      ...
      autoscaleSettings: (() {
        ...
        return pulumi.Input.fromValue(
          MongoCollectionAutoscaleSettings.fromMap(
      ...
      defaultTtlSeconds: (() {
        final guardedValue = map['defaultTtlSeconds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indices: (() {
        final guardedValue = map['indices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MongoCollectionIndex>(
            guardedValue,
            (value) => MongoCollectionIndex.fromMap(
      ...
      systemIndexes: (() {
        final guardedValue = map['systemIndexes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MongoCollectionSystemIndex>(
            guardedValue,
            (value) => MongoCollectionSystemIndex.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
