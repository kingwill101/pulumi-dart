...
import 'mongo_database_state.dart';
...
class MongoDatabase extends pulumi.CustomResource {
  ...
  MongoDatabase(
    ...
    autoscaleSettings = registerOutput<MongoDatabaseAutoscaleSettings?>(
      'autoscaleSettings',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return MongoDatabaseAutoscaleSettings.fromMap(
  ...
  /// Gets an existing [MongoDatabase] resource's state with the given [name] and [id].
