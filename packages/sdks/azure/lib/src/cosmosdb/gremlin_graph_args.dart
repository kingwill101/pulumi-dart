...
class GremlinGraphArgs {
  ...
  final pulumi.Input<GremlinGraphConflictResolutionPolicy>?
    ...
    return GremlinGraphArgs(
      ...
      autoscaleSettings: (() {
        ...
        return pulumi.Input.fromValue(
          GremlinGraphAutoscaleSettings.fromMap(
      ...
      conflictResolutionPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GremlinGraphConflictResolutionPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      indexPolicy: (() {
        final guardedValue = map['indexPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GremlinGraphIndexPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      partitionKeyPath: pulumi.Input.fromValue(
      ...
      uniqueKeys: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GremlinGraphUniqueKey>(
            guardedValue,
            (value) => GremlinGraphUniqueKey.fromMap(
