...
class MongoCollection extends pulumi.CustomResource {
  ...
  MongoCollection(
    ...
    this.autoscaleSettings = registerOutput<MongoCollectionAutoscaleSettings?>('autoscaleSettings');
    this.databaseName = registerOutput<String>('databaseName');
    this.defaultTtlSeconds = registerOutput<int?>('defaultTtlSeconds');
    this.indices = registerOutput<List<MongoCollectionIndex>?>('indices');
    this.name = registerOutput<String>('name');
    this.resourceGroupName = registerOutput<String>('resourceGroupName');
    this.shardKey = registerOutput<String?>('shardKey');
    this.systemIndexes = registerOutput<List<MongoCollectionSystemIndex>>('systemIndexes');
