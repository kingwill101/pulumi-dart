...
class GetRestorableDatabaseAccountsAccount {
  ...
  final pulumi.Input<
    List<GetRestorableDatabaseAccountsAccountRestorableLocation>
  >
  restorableLocations;
  ...
  factory GetRestorableDatabaseAccountsAccount.fromMap(
    ...
    return GetRestorableDatabaseAccountsAccount(
      ...
      restorableLocations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRestorableDatabaseAccountsAccountRestorableLocation
        >(
          map['restorableLocations']!,
          (value) =>
              GetRestorableDatabaseAccountsAccountRestorableLocation.fromMap(
