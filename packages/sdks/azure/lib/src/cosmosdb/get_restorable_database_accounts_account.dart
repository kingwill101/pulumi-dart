...
class GetRestorableDatabaseAccountsAccount {
  ...
  factory GetRestorableDatabaseAccountsAccount.fromMap(Map<String, dynamic> map) {
    return GetRestorableDatabaseAccountsAccount(
      ...
      restorableLocations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRestorableDatabaseAccountsAccountRestorableLocation>(map['restorableLocations']!, (value) => GetRestorableDatabaseAccountsAccountRestorableLocation.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
