...
class CassandraClusterArgs {
  ...
  factory CassandraClusterArgs.fromMap(Map<String, dynamic> map) {
    return CassandraClusterArgs(
      ...
      defaultAdminPassword: pulumi.Input.fromValue(
        map['defaultAdminPassword'] as String,
      ),
      delegatedManagementSubnetId: pulumi.Input.fromValue(
        map['delegatedManagementSubnetId'] as String,
      ),
