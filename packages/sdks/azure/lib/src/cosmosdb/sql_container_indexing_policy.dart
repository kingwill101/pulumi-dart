...
class SqlContainerIndexingPolicy {
  ...
  final pulumi.Input<List<SqlContainerIndexingPolicySpatialIndex>>?
  spatialIndices;
    ...
    return <String, dynamic>{
      'compositeIndices':
          ?pulumi.Input.mapOptionalInputValue<
            List<SqlContainerIndexingPolicyCompositeIndex>,
      ...
      'excludedPaths':
          ?pulumi.Input.mapOptionalInputValue<
            List<SqlContainerIndexingPolicyExcludedPath>,
            List<Map<String, dynamic>>
          >(
            excludedPaths,
            (value) =>
      ...
      'includedPaths':
          ?pulumi.Input.mapOptionalInputValue<
            List<SqlContainerIndexingPolicyIncludedPath>,
            List<Map<String, dynamic>>
          >(
            includedPaths,
            (value) =>
      ...
      'spatialIndices':
          ?pulumi.Input.mapOptionalInputValue<
            List<SqlContainerIndexingPolicySpatialIndex>,
            List<Map<String, dynamic>>
          >(
            spatialIndices,
            (value) =>
  ...
  factory SqlContainerIndexingPolicy.fromMap(Map<String, dynamic> map) {
    return SqlContainerIndexingPolicy(
      compositeIndices: (() {
        final guardedValue = map['compositeIndices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SqlContainerIndexingPolicyCompositeIndex>(
            guardedValue,
            (value) => SqlContainerIndexingPolicyCompositeIndex.fromMap(
      ...
      excludedPaths: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SqlContainerIndexingPolicyExcludedPath>(
            guardedValue,
            (value) => SqlContainerIndexingPolicyExcludedPath.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      includedPaths: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SqlContainerIndexingPolicyIncludedPath>(
            guardedValue,
            (value) => SqlContainerIndexingPolicyIncludedPath.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      spatialIndices: (() {
        final guardedValue = map['spatialIndices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SqlContainerIndexingPolicySpatialIndex>(
            guardedValue,
            (value) => SqlContainerIndexingPolicySpatialIndex.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
