...
class CassandraClusterState {
  ...
  CassandraClusterState({
    ...
    pulumi.Output<String>? defaultAdminPassword,
    ...
    pulumi.Output<String>? version,
      ...
      defaultAdminPassword = pulumi.Input.asOptionalInput<String>(defaultAdminPassword),
  ...
  factory CassandraClusterState.fromMap(Map<String, dynamic> map) {
    return CassandraClusterState(
      ...
      defaultAdminPassword: map['defaultAdminPassword'] == null ? null : pulumi.Output.create<String>(map['defaultAdminPassword'] as String),
