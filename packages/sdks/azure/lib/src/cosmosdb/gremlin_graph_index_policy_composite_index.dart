...
class GremlinGraphIndexPolicyCompositeIndex {
  ...
  factory GremlinGraphIndexPolicyCompositeIndex.fromMap(Map<String, dynamic> map) {
    return GremlinGraphIndexPolicyCompositeIndex(
      indices: (pulumi.Input.decodeList<GremlinGraphIndexPolicyCompositeIndexIndex>(map['indices'], (value) => GremlinGraphIndexPolicyCompositeIndexIndex.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
