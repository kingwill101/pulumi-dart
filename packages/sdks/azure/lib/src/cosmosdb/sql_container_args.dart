...
class SqlContainerArgs {
  ...
  final pulumi.Input<SqlContainerConflictResolutionPolicy>?
  ...
  SqlContainerArgs({
    ...
    required this.partitionKeyPaths,
    ...
    return SqlContainerArgs(
      ...
      autoscaleSettings: (() {
        ...
        return pulumi.Input.fromValue(
          SqlContainerAutoscaleSettings.fromMap(
      ...
      conflictResolutionPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlContainerConflictResolutionPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      indexingPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlContainerIndexingPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      partitionKeyKind: (() {
        final guardedValue = map['partitionKeyKind'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      partitionKeyPaths: pulumi.Input.fromValue(
        (map['partitionKeyPaths'] as List).cast<String>(),
      ),
      partitionKeyVersion: (() {
        final guardedValue = map['partitionKeyVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ...
      uniqueKeys: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SqlContainerUniqueKey>(
            guardedValue,
            (value) => SqlContainerUniqueKey.fromMap(
