...
/// {@template pulumi_cosmosdb_postgresql_cluster_postgresql_cluster_args_doc}
/// The set of arguments for PostgresqlCluster.
/// {@endtemplate}
/// {@macro pulumi_cosmosdb_postgresql_cluster_postgresql_cluster_args_doc}
class PostgresqlClusterArgs {
  ...
  /// Creates a new [PostgresqlClusterArgs].
  ...
  factory PostgresqlClusterArgs.fromMap(Map<String, dynamic> map) {
    return PostgresqlClusterArgs(
      ...
      coordinatorPublicIpAccessEnabled: map['coordinatorPublicIpAccessEnabled'] == null ? null : (map['coordinatorPublicIpAccessEnabled'] as bool).input(),
      ...
      coordinatorVcoreCount: map['coordinatorVcoreCount'] == null ? null : (map['coordinatorVcoreCount'] as int).input(),
      haEnabled: map['haEnabled'] == null ? null : (map['haEnabled'] as bool).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : (PostgresqlClusterMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      nodeCount: (map['nodeCount'] as int).input(),
      nodePublicIpAccessEnabled: map['nodePublicIpAccessEnabled'] == null ? null : (map['nodePublicIpAccessEnabled'] as bool).input(),
      ...
      pointInTimeInUtc: map['pointInTimeInUtc'] == null ? null : (map['pointInTimeInUtc'] as String).input(),
      preferredPrimaryZone: map['preferredPrimaryZone'] == null ? null : (map['preferredPrimaryZone'] as String).input(),
      resourceGroupName: (map['resourceGroupName'] as String).input(),
      shardsOnCoordinatorEnabled: map['shardsOnCoordinatorEnabled'] == null ? null : (map['shardsOnCoordinatorEnabled'] as bool).input(),
      ...
      sqlVersion: map['sqlVersion'] == null ? null : (map['sqlVersion'] as String).input(),
