...
class CassandraDatacenterState {
  ...
  factory CassandraDatacenterState.fromMap(Map<String, dynamic> map) {
    return CassandraDatacenterState(
      ...
      cassandraClusterId: (() { final guardedValue = map['cassandraClusterId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      seedNodeIpAddresses: (() { final guardedValue = map['seedNodeIpAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
