...
class AccountRestore {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gremlinDatabases':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccountRestoreGremlinDatabase>,
            List<Map<String, dynamic>>
          >(
            gremlinDatabases,
            (value) =>
    ...
    return AccountRestore(
      databases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountRestoreDatabase>(
            guardedValue,
            (value) => AccountRestoreDatabase.fromMap(
      ...
      gremlinDatabases: (() {
        final guardedValue = map['gremlinDatabases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountRestoreGremlinDatabase>(
            guardedValue,
            (value) => AccountRestoreGremlinDatabase.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      restoreTimestampInUtc: pulumi.Input.fromValue(
        map['restoreTimestampInUtc'] as String,
      ),
      sourceCosmosdbAccountId: pulumi.Input.fromValue(
        map['sourceCosmosdbAccountId'] as String,
      ),
      tablesToRestores: (() {
        final guardedValue = map['tablesToRestores'];
        if (guardedValue == null) return null;
