...
class GetAccountResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'capabilities':
          pulumi.Input.encodeList<GetAccountCapability, Map<String, dynamic>>(
            capabilities,
            (value) => value.toMap(),
          ),
      'consistencyPolicies':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(consistencyPolicies, (value) => value.toMap()),
      'endpoint': endpoint,
      'freeTierEnabled': freeTierEnabled,
      'geoLocations':
          pulumi.Input.encodeList<GetAccountGeoLocation, Map<String, dynamic>>(
            geoLocations,
            (value) => value.toMap(),
          ),
      'id': id,
  ...
  factory GetAccountResult.fromMap(Map<String, dynamic> map) {
    return GetAccountResult(
      ...
      capabilities: pulumi.Input.decodeList<GetAccountCapability>(
        map['capabilities']!,
        (value) => GetAccountCapability.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      consistencyPolicies: pulumi.Input.decodeList<GetAccountConsistencyPolicy>(
        map['consistencyPolicies']!,
        (value) => GetAccountConsistencyPolicy.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      endpoint: map['endpoint'] as String,
      freeTierEnabled: map['freeTierEnabled'] as bool,
      geoLocations: pulumi.Input.decodeList<GetAccountGeoLocation>(
        map['geoLocations']!,
        (value) => GetAccountGeoLocation.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      id: map['id'] as String,
      ...
      secondaryMongodbConnectionString:
          map['secondaryMongodbConnectionString'] as String,
      secondaryReadonlyKey: map['secondaryReadonlyKey'] as String,
      secondaryReadonlyMongodbConnectionString:
          map['secondaryReadonlyMongodbConnectionString'] as String,
      secondaryReadonlySqlConnectionString:
          map['secondaryReadonlySqlConnectionString'] as String,
      secondarySqlConnectionString:
          map['secondarySqlConnectionString'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      virtualNetworkRules:
          pulumi.Input.decodeList<GetAccountVirtualNetworkRule>(
            map['virtualNetworkRules']!,
            (value) => GetAccountVirtualNetworkRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
