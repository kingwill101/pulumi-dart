...
class SqlRoleDefinitionState {
  ...
  factory SqlRoleDefinitionState.fromMap(Map<String, dynamic> map) {
    return SqlRoleDefinitionState(
      ...
      permissions: (() { final guardedValue = map['permissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SqlRoleDefinitionPermission>(guardedValue, (value) => SqlRoleDefinitionPermission.fromMap((value as Map).cast<String, dynamic>()))); })(),
