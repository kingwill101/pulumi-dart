...
class CassandraDatacenter extends pulumi.CustomResource {
  ...
  CassandraDatacenter(
    ...
    this.availabilityZonesEnabled = registerOutput<bool?>('availabilityZonesEnabled');
    this.backupStorageCustomerKeyUri = registerOutput<String?>('backupStorageCustomerKeyUri');
    this.base64EncodedYamlFragment = registerOutput<String?>('base64EncodedYamlFragment');
    this.cassandraClusterId = registerOutput<String>('cassandraClusterId');
    this.delegatedManagementSubnetId = registerOutput<String>('delegatedManagementSubnetId');
    this.diskCount = registerOutput<int?>('diskCount');
    this.diskSku = registerOutput<String?>('diskSku');
    this.location = registerOutput<String>('location');
    this.managedDiskCustomerKeyUri = registerOutput<String?>('managedDiskCustomerKeyUri');
    this.name = registerOutput<String>('name');
    this.nodeCount = registerOutput<int?>('nodeCount');
    this.seedNodeIpAddresses = registerOutput<List<String>>('seedNodeIpAddresses');
