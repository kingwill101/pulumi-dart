...
class PostgresqlClusterState {
  ...
  factory PostgresqlClusterState.fromMap(Map<String, dynamic> map) {
    return PostgresqlClusterState(
      ...
      earliestRestoreTime: (() {
        final guardedValue = map['earliestRestoreTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      haEnabled: (() {
      ...
      servers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PostgresqlClusterServer>(
            guardedValue,
            (value) => PostgresqlClusterServer.fromMap(
