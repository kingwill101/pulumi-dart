...
class PostgresqlClusterState {
  ...
  factory PostgresqlClusterState.fromMap(Map<String, dynamic> map) {
    return PostgresqlClusterState(
      ...
      earliestRestoreTime: map['earliestRestoreTime'] == null ? null : (map['earliestRestoreTime']! as String).input(),
      ...
      servers: map['servers'] == null ? null : (pulumi.Input.decodeList<PostgresqlClusterServer>(map['servers']!, (value) => PostgresqlClusterServer.fromMap((value as Map).cast<String, dynamic>()))).input(),
