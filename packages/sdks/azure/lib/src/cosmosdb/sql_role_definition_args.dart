...
class SqlRoleDefinitionArgs {
    ...
    return <String, dynamic>{
      ...
      'permissions':
          pulumi.Input.mapInputValue<
            List<SqlRoleDefinitionPermission>,
  ...
  factory SqlRoleDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return SqlRoleDefinitionArgs(
      ...
      assignableScopes: pulumi.Input.fromValue(
        (map['assignableScopes'] as List).cast<String>(),
      ),
      name: (() {
      ...
      permissions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SqlRoleDefinitionPermission>(
          map['permissions']!,
          (value) => SqlRoleDefinitionPermission.fromMap(
