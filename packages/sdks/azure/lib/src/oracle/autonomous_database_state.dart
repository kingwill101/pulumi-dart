...
class AutonomousDatabaseState {
  ...
  factory AutonomousDatabaseState.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseState(
      ...
      dataStorageSizeInTbs: map['dataStorageSizeInTbs'] == null ? null : (map['dataStorageSizeInTbs'] as int).input(),
      dbVersion: map['dbVersion'] == null ? null : (map['dbVersion'] as String).input(),
      dbWorkload: map['dbWorkload'] == null ? null : (map['dbWorkload'] as String).input(),
      displayName: map['displayName'] == null ? null : (map['displayName'] as String).input(),
      licenseModel: map['licenseModel'] == null ? null : (map['licenseModel'] as String).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      longTermBackupSchedule: map['longTermBackupSchedule'] == null ? null : (AutonomousDatabaseLongTermBackupSchedule.fromMap((map['longTermBackupSchedule'] as Map).cast<String, dynamic>())).input(),
