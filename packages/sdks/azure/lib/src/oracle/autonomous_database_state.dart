...
class AutonomousDatabaseState {
  ...
  final pulumi.Input<AutonomousDatabaseLongTermBackupSchedule>?
    ...
    return <String, dynamic>{
      ...
      'longTermBackupSchedule':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(longTermBackupSchedule, (value) => value.toMap()),
  ...
  factory AutonomousDatabaseState.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseState(
      ...
      dbWorkload: (() {
        final guardedValue = map['dbWorkload'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      displayName: (() {
      ...
      longTermBackupSchedule: (() {
        final guardedValue = map['longTermBackupSchedule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutonomousDatabaseLongTermBackupSchedule.fromMap(
