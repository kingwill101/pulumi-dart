...
class CloudVmClusterDataCollectionOptions {
  ...
  factory CloudVmClusterDataCollectionOptions.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterDataCollectionOptions(
      diagnosticsEventsEnabled: (() { final guardedValue = map['diagnosticsEventsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      healthMonitoringEnabled: (() { final guardedValue = map['healthMonitoringEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      incidentLogsEnabled: (() { final guardedValue = map['incidentLogsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
