...
class ExascaleDatabaseStorageVaultState {
  ...
  final pulumi.Input<ExascaleDatabaseStorageVaultHighCapacityDatabaseStorage>?
    ...
    return <String, dynamic>{
      ...
      'highCapacityDatabaseStorage':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(highCapacityDatabaseStorage, (value) => value.toMap()),
      'location': ?location,
      'name': ?name,
  ...
  factory ExascaleDatabaseStorageVaultState.fromMap(Map<String, dynamic> map) {
    return ExascaleDatabaseStorageVaultState(
      additionalFlashCachePercentage: (() {
        final guardedValue = map['additionalFlashCachePercentage'];
      ...
      highCapacityDatabaseStorage: (() {
        final guardedValue = map['highCapacityDatabaseStorage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExascaleDatabaseStorageVaultHighCapacityDatabaseStorage.fromMap(
