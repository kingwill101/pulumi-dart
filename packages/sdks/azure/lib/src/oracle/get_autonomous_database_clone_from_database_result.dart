...
import 'get_autonomous_database_clone_from_database_long_term_backup_schedule.dart';

/// Result data returned by getAutonomousDatabaseCloneFromDatabase.
class GetAutonomousDatabaseCloneFromDatabaseResult {
  ...
  final String? timeUntilReconnectInUtc;
  ...
  /// [cpuCoreCount] The number of CPU cores to be made available to the database. When the ECPU is selected, the value for cpuCoreCount is 0.
  ...
  /// [reconnectCloneEnabled] Indicates whether reconnect clone is enabled.
  /// [refreshableClone] Indicates whether the clone is a refreshable clone.
  /// [refreshableStatus] The current refreshable status of the clone. Values include `Refreshing` and `NotRefreshing`.
  ...
  /// [timeUntilReconnectInUtc] The time until reconnect clone is enabled.
  ...
  const GetAutonomousDatabaseCloneFromDatabaseResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'longTermBackupSchedules': ?(() { final guardedValue = longTermBackupSchedules; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetAutonomousDatabaseCloneFromDatabaseLongTermBackupSchedule, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'reconnectCloneEnabled': ?reconnectCloneEnabled,
      ...
      'timeUntilReconnectInUtc': ?timeUntilReconnectInUtc,
  ...
  factory GetAutonomousDatabaseCloneFromDatabaseResult.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabaseCloneFromDatabaseResult(
      ...
      longTermBackupSchedules: (() { final guardedValue = map['longTermBackupSchedules']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetAutonomousDatabaseCloneFromDatabaseLongTermBackupSchedule>(guardedValue, (value) => GetAutonomousDatabaseCloneFromDatabaseLongTermBackupSchedule.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      reconnectCloneEnabled: (() { final guardedValue = map['reconnectCloneEnabled']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      refreshableClone: (() { final guardedValue = map['refreshableClone']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      refreshableStatus: (() { final guardedValue = map['refreshableStatus']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      timeUntilReconnectInUtc: (() { final guardedValue = map['timeUntilReconnectInUtc']; if (guardedValue == null) return null; return guardedValue as String; })(),
