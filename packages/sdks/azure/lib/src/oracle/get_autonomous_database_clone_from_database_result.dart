...
class GetAutonomousDatabaseCloneFromDatabaseResult {
  ...
  const GetAutonomousDatabaseCloneFromDatabaseResult({
    ...
    required this.reconnectCloneEnabled,
    required this.refreshableClone,
    required this.refreshableStatus,
    ...
    required this.timeUntilReconnectInUtc,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': location,
      'longTermBackupSchedules': pulumi.Input.encodeList<GetAutonomousDatabaseCloneFromDatabaseLongTermBackupSchedule, Map<String, dynamic>>(longTermBackupSchedules, (value) => value.toMap()),
  ...
  factory GetAutonomousDatabaseCloneFromDatabaseResult.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabaseCloneFromDatabaseResult(
      ...
      longTermBackupSchedules: pulumi.Input.decodeList<GetAutonomousDatabaseCloneFromDatabaseLongTermBackupSchedule>(map['longTermBackupSchedules']!, (value) => GetAutonomousDatabaseCloneFromDatabaseLongTermBackupSchedule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      reconnectCloneEnabled: map['reconnectCloneEnabled'] as bool,
      refreshableClone: map['refreshableClone'] as bool,
      refreshableStatus: map['refreshableStatus'] as String,
      ...
      timeUntilReconnectInUtc: map['timeUntilReconnectInUtc'] as String,
