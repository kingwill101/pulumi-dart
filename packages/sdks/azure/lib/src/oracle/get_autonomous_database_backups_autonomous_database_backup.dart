...
class GetAutonomousDatabaseBackupsAutonomousDatabaseBackup {
  ...
  const GetAutonomousDatabaseBackupsAutonomousDatabaseBackup({
  ...
  factory GetAutonomousDatabaseBackupsAutonomousDatabaseBackup.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabaseBackupsAutonomousDatabaseBackup(
      ...
      autonomousDatabaseBackupOcid: pulumi.Input.fromValue(map['autonomousDatabaseBackupOcid'] as String),
      autonomousDatabaseOcid: pulumi.Input.fromValue(map['autonomousDatabaseOcid'] as String),
      databaseBackupSizeInTbs: pulumi.Input.fromValue((map['databaseBackupSizeInTbs'] as num).toDouble()),
      ...
      timeAvailableTil: pulumi.Input.fromValue(map['timeAvailableTil'] as String),
