...
class GetDbServersDbServer {
  ...
  factory GetDbServersDbServer.fromMap(Map<String, dynamic> map) {
    return GetDbServersDbServer(
      autonomousVirtualMachineDs: pulumi.Input.fromValue((map['autonomousVirtualMachineDs'] as List).cast<String>()),
      ...
      dbNodeStorageSizeInGbs: pulumi.Input.fromValue((map['dbNodeStorageSizeInGbs'] as num).toInt()),
      ...
      maxDbNodeStorageInGbs: pulumi.Input.fromValue((map['maxDbNodeStorageInGbs'] as num).toInt()),
      maxMemoryInGbs: pulumi.Input.fromValue((map['maxMemoryInGbs'] as num).toInt()),
      memorySizeInGbs: pulumi.Input.fromValue((map['memorySizeInGbs'] as num).toInt()),
