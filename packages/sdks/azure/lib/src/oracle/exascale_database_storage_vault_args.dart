...
class ExascaleDatabaseStorageVaultArgs {
  ...
  factory ExascaleDatabaseStorageVaultArgs.fromMap(Map<String, dynamic> map) {
    return ExascaleDatabaseStorageVaultArgs(
      additionalFlashCachePercentage: pulumi.Input.fromValue(
      ...
      highCapacityDatabaseStorage: pulumi.Input.fromValue(
        ExascaleDatabaseStorageVaultHighCapacityDatabaseStorage.fromMap(
          (map['highCapacityDatabaseStorage']! as Map).cast<String, dynamic>(),
        ),
      ),
      location: (() {
