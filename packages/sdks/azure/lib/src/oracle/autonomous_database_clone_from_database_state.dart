...
class AutonomousDatabaseCloneFromDatabaseState {
  ...
  const AutonomousDatabaseCloneFromDatabaseState({
    this.adminPassword,
  ...
  factory AutonomousDatabaseCloneFromDatabaseState.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseCloneFromDatabaseState(
      ...
      sourceAutonomousDatabaseId: (() { final guardedValue = map['sourceAutonomousDatabaseId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
