...
class AutonomousDatabaseArgs {
  ...
  AutonomousDatabaseArgs({
    ...
    required pulumi.Output<int> dataStorageSizeInTbs,
    required pulumi.Output<String> dbVersion,
    required pulumi.Output<String> dbWorkload,
  ...
  factory AutonomousDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseArgs(
      ...
      dataStorageSizeInTbs: pulumi.Output.create<int>(map['dataStorageSizeInTbs'] as int),
      dbVersion: pulumi.Output.create<String>(map['dbVersion'] as String),
      dbWorkload: pulumi.Output.create<String>(map['dbWorkload'] as String),
