...
import 'resource_anchor_args.dart';
import 'resource_anchor_state.dart';
...
class ResourceAnchor extends pulumi.CustomResource {
  ...
  /// Creates a new [ResourceAnchor].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ResourceAnchor]. {@macro pulumi_oracle_resource_anchor_resource_anchor_args_doc}
  ...
  static ResourceAnchor get(
    String name,
    pulumi.Input<String> id, {
    ResourceAnchorState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ResourceAnchor._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ResourceAnchor] resource.
  ResourceAnchor.reference(String urn)
    : super(
        'azure:oracle/resourceAnchor:ResourceAnchor',
