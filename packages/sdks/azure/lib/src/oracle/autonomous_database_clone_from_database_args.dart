...
class AutonomousDatabaseCloneFromDatabaseArgs {
  ...
  factory AutonomousDatabaseCloneFromDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseCloneFromDatabaseArgs(
      ...
      dataStorageSizeInTb: pulumi.Input.fromValue((map['dataStorageSizeInTb'] as num).toInt()),
      ...
      refreshableModel: (() { final guardedValue = map['refreshableModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
