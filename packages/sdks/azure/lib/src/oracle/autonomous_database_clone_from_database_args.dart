...
class AutonomousDatabaseCloneFromDatabaseArgs {
  ...
  factory AutonomousDatabaseCloneFromDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseCloneFromDatabaseArgs(
      ...
      autoScalingForStorageEnabled: (map['autoScalingForStorageEnabled'] as bool).input(),
      backupRetentionPeriodInDays: (map['backupRetentionPeriodInDays'] as int).input(),
      characterSet: (map['characterSet'] as String).input(),
      cloneType: (map['cloneType'] as String).input(),
      ...
      dataStorageSizeInTb: (map['dataStorageSizeInTb'] as int).input(),
      databaseVersion: (map['databaseVersion'] as String).input(),
      databaseWorkload: (map['databaseWorkload'] as String).input(),
      ...
      nationalCharacterSet: (map['nationalCharacterSet'] as String).input(),
      refreshableModel: map['refreshableModel'] == null ? null : (map['refreshableModel']! as String).input(),
      resourceGroupName: (map['resourceGroupName'] as String).input(),
      sourceAutonomousDatabaseId: (map['sourceAutonomousDatabaseId'] as String).input(),
