...
class GetDbSystemShapesDbSystemShape {
  ...
  factory GetDbSystemShapesDbSystemShape.fromMap(Map<String, dynamic> map) {
    return GetDbSystemShapesDbSystemShape(
      areServerTypesSupported: pulumi.Input.fromValue(
        map['areServerTypesSupported'] as bool,
      ),
      ...
      maximumStorageCount: pulumi.Input.fromValue(
        map['maximumStorageCount'] as int,
      ),
      minimumCoreCount: pulumi.Input.fromValue(map['minimumCoreCount'] as int),
      minimumCoreCountPerNode: pulumi.Input.fromValue(
        map['minimumCoreCountPerNode'] as int,
      ),
      minimumDataStorageInTbs: pulumi.Input.fromValue(
        map['minimumDataStorageInTbs'] as int,
      ),
      minimumDbNodeStoragePerNodeInGbs: pulumi.Input.fromValue(
        map['minimumDbNodeStoragePerNodeInGbs'] as int,
      ),
      minimumMemoryPerNodeInGbs: pulumi.Input.fromValue(
        map['minimumMemoryPerNodeInGbs'] as int,
      ),
      minimumNodeCount: pulumi.Input.fromValue(map['minimumNodeCount'] as int),
      minimumStorageCount: pulumi.Input.fromValue(
        map['minimumStorageCount'] as int,
      ),
