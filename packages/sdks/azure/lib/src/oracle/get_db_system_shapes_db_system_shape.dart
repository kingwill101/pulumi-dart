...
class GetDbSystemShapesDbSystemShape {
  ...
  factory GetDbSystemShapesDbSystemShape.fromMap(Map<String, dynamic> map) {
    return GetDbSystemShapesDbSystemShape(
      ...
      maximumStorageCount: pulumi.Input.fromValue((map['maximumStorageCount'] as num).toInt()),
      minimumCoreCount: pulumi.Input.fromValue((map['minimumCoreCount'] as num).toInt()),
      minimumCoreCountPerNode: pulumi.Input.fromValue((map['minimumCoreCountPerNode'] as num).toInt()),
      minimumDataStorageInTbs: pulumi.Input.fromValue((map['minimumDataStorageInTbs'] as num).toInt()),
      minimumDbNodeStoragePerNodeInGbs: pulumi.Input.fromValue((map['minimumDbNodeStoragePerNodeInGbs'] as num).toInt()),
      minimumMemoryPerNodeInGbs: pulumi.Input.fromValue((map['minimumMemoryPerNodeInGbs'] as num).toInt()),
      minimumNodeCount: pulumi.Input.fromValue((map['minimumNodeCount'] as num).toInt()),
      minimumStorageCount: pulumi.Input.fromValue((map['minimumStorageCount'] as num).toInt()),
