...
class CacheAccessPolicyState {
  ...
  CacheAccessPolicyState({this.accessRules, this.hpcCacheId, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<CacheAccessPolicyAccessRule>,
    ...
    return CacheAccessPolicyState(
      accessRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CacheAccessPolicyAccessRule>(
            guardedValue,
            (value) => CacheAccessPolicyAccessRule.fromMap(
      ...
      hpcCacheId: (() {
        final guardedValue = map['hpcCacheId'];
        if (guardedValue == null) return null;
