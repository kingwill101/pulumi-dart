...
class CacheNfsTargetState {
    ...
    return <String, dynamic>{
      ...
      'namespaceJunctions':
          ?pulumi.Input.mapOptionalInputValue<
            List<CacheNfsTargetNamespaceJunction>,
  ...
  factory CacheNfsTargetState.fromMap(Map<String, dynamic> map) {
    return CacheNfsTargetState(
      ...
      namespaceJunctions: (() {
        final guardedValue = map['namespaceJunctions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CacheNfsTargetNamespaceJunction>(
            guardedValue,
            (value) => CacheNfsTargetNamespaceJunction.fromMap(
      ...
      targetHostName: (() {
        final guardedValue = map['targetHostName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      usageModel: (() {
