...
class CacheAccessPolicyAccessRule {
  ...
  factory CacheAccessPolicyAccessRule.fromMap(Map<String, dynamic> map) {
    return CacheAccessPolicyAccessRule(
      ...
      anonymousGid: (() {
        final guardedValue = map['anonymousGid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      anonymousUid: (() {
        final guardedValue = map['anonymousUid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      filter: (() {
      ...
      rootSquashEnabled: (() {
        final guardedValue = map['rootSquashEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      scope: pulumi.Input.fromValue(map['scope'] as String),
      submountAccessEnabled: (() {
        final guardedValue = map['submountAccessEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      suidEnabled: (() {
        final guardedValue = map['suidEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
