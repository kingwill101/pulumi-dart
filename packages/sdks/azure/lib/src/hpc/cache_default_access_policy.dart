...
class CacheDefaultAccessPolicy {
  ...
  factory CacheDefaultAccessPolicy.fromMap(Map<String, dynamic> map) {
    return CacheDefaultAccessPolicy(
      accessRules: (pulumi.Input.decodeList<CacheDefaultAccessPolicyAccessRule>(map['accessRules'], (value) => CacheDefaultAccessPolicyAccessRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
