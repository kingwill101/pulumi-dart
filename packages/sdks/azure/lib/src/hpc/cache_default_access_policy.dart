...
class CacheDefaultAccessPolicy {
  ...
  CacheDefaultAccessPolicy({required this.accessRules});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessRules':
          pulumi.Input.mapInputValue<
            List<CacheDefaultAccessPolicyAccessRule>,
  ...
  factory CacheDefaultAccessPolicy.fromMap(Map<String, dynamic> map) {
    return CacheDefaultAccessPolicy(
      accessRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CacheDefaultAccessPolicyAccessRule>(
          map['accessRules']!,
          (value) => CacheDefaultAccessPolicyAccessRule.fromMap(
