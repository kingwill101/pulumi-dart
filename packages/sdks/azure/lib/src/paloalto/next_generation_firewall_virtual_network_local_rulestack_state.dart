...
class NextGenerationFirewallVirtualNetworkLocalRulestackState {
  ...
  final pulumi.Input<
    List<NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat>
  >?
  destinationNats;
  ...
  factory NextGenerationFirewallVirtualNetworkLocalRulestackState.fromMap(
    ...
    return NextGenerationFirewallVirtualNetworkLocalRulestackState(
      destinationNats: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat.fromMap(
      ...
      dnsSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings.fromMap(
      ...
      networkProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
