...
class NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat {
  ...
  factory NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat.fromMap(
    ...
    return NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat(
      backendConfig: (() {
        ...
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNatBackendConfig.fromMap(
      ...
      frontendConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNatFrontendConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
