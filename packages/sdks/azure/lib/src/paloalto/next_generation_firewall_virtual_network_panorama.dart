...
class NextGenerationFirewallVirtualNetworkPanorama extends pulumi.CustomResource {
  ...
  NextGenerationFirewallVirtualNetworkPanorama(
    ...
    this.destinationNats = registerOutput<List<NextGenerationFirewallVirtualNetworkPanoramaDestinationNat>?>('destinationNats');
    this.dnsSettings = registerOutput<NextGenerationFirewallVirtualNetworkPanoramaDnsSettings?>('dnsSettings');
    this.location = registerOutput<String>('location');
    this.marketplaceOfferId = registerOutput<String?>('marketplaceOfferId');
    this.name = registerOutput<String>('name');
    this.networkProfile = registerOutput<NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile>('networkProfile');
    this.panoramaBase64Config = registerOutput<String>('panoramaBase64Config');
    this.panoramas = registerOutput<List<NextGenerationFirewallVirtualNetworkPanoramaPanorama>>('panoramas');
