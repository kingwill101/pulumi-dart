...
class NextGenerationFirewallVirtualNetworkLocalRulestackArgs {
  ...
  const NextGenerationFirewallVirtualNetworkLocalRulestackArgs({
  ...
  factory NextGenerationFirewallVirtualNetworkLocalRulestackArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualNetworkLocalRulestackArgs(
      ...
      networkProfile: pulumi.Input.fromValue(NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfile.fromMap((map['networkProfile']! as Map).cast<String, dynamic>())),
