...
class NextGenerationFirewallVirtualHubPanoramaDestinationNat {
  ...
  factory NextGenerationFirewallVirtualHubPanoramaDestinationNat.fromMap(
    ...
    return NextGenerationFirewallVirtualHubPanoramaDestinationNat(
      backendConfig: (() {
        ...
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualHubPanoramaDestinationNatBackendConfig.fromMap(
      ...
      frontendConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualHubPanoramaDestinationNatFrontendConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
