...
class LocalRulestackRuleState {
  ...
  /// Creates a new [LocalRulestackRuleState].
  ...
  LocalRulestackRuleState({
    ...
    pulumi.Output<LocalRulestackRuleDestination>? destination,
    ...
    pulumi.Output<LocalRulestackRuleSource>? source,
    pulumi.Output<Map<String, String>>? tags,
      ...
      destination = pulumi.Input.asOptionalInput<LocalRulestackRuleDestination>(destination),
      ...
      source = pulumi.Input.asOptionalInput<LocalRulestackRuleSource>(source),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destination': ?pulumi.Input.mapOptionalInputValue<LocalRulestackRuleDestination, Map<String, dynamic>>(destination, (value) => value.toMap()),
      'enabled': ?enabled,
      ...
      'source': ?pulumi.Input.mapOptionalInputValue<LocalRulestackRuleSource, Map<String, dynamic>>(source, (value) => value.toMap()),
      'tags': ?tags,
    };
  }

  factory LocalRulestackRuleState.fromMap(Map<String, dynamic> map) {
    return LocalRulestackRuleState(
      ...
      destination: map['destination'] == null ? null : pulumi.Output.create<LocalRulestackRuleDestination>(LocalRulestackRuleDestination.fromMap((map['destination'] as Map).cast<String, dynamic>())),
      ...
      source: map['source'] == null ? null : pulumi.Output.create<LocalRulestackRuleSource>(LocalRulestackRuleSource.fromMap((map['source'] as Map).cast<String, dynamic>())),
