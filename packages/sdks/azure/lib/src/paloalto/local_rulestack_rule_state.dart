...
class LocalRulestackRuleState {
  ...
  factory LocalRulestackRuleState.fromMap(Map<String, dynamic> map) {
    return LocalRulestackRuleState(
      ...
      destination: map['destination'] == null ? null : (LocalRulestackRuleDestination.fromMap((map['destination']! as Map).cast<String, dynamic>())).input(),
      ...
      source: map['source'] == null ? null : (LocalRulestackRuleSource.fromMap((map['source']! as Map).cast<String, dynamic>())).input(),
