...
class NextGenerationFirewallVirtualHubPanoramaState {
  ...
  final pulumi.Input<List<NextGenerationFirewallVirtualHubPanoramaPanorama>>?
  panoramas;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'panoramas':
          ?pulumi.Input.mapOptionalInputValue<
            List<NextGenerationFirewallVirtualHubPanoramaPanorama>,
            List<Map<String, dynamic>>
          >(
            panoramas,
            (value) =>
  ...
  factory NextGenerationFirewallVirtualHubPanoramaState.fromMap(
    ...
    return NextGenerationFirewallVirtualHubPanoramaState(
      ...
      panoramaBase64Config: (() {
        final guardedValue = map['panoramaBase64Config'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      panoramas: (() {
        final guardedValue = map['panoramas'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            NextGenerationFirewallVirtualHubPanoramaPanorama
          >(
            guardedValue,
            (value) => NextGenerationFirewallVirtualHubPanoramaPanorama.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
