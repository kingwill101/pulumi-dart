...
class NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile {
  ...
  factory NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile.fromMap(
    ...
    return NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile(
      ...
      vnetConfiguration: pulumi.Input.fromValue(
        NextGenerationFirewallVirtualNetworkPanoramaNetworkProfileVnetConfiguration.fromMap(
