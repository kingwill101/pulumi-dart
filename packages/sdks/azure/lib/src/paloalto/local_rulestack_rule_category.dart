...
class LocalRulestackRuleCategory {
  ...
  LocalRulestackRuleCategory({required this.customUrls, this.feeds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'customUrls': customUrls, 'feeds': ?feeds};
  }

  factory LocalRulestackRuleCategory.fromMap(Map<String, dynamic> map) {
    return LocalRulestackRuleCategory(
      customUrls: pulumi.Input.fromValue(
        (map['customUrls'] as List).cast<String>(),
      ),
      feeds: (() {
