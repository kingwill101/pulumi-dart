...
class NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings {
  ...
  /// Creates a new [NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings].
  ...
  const NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings({
  ...
  factory NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings(
