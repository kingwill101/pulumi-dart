...
class NextGenerationFirewallVirtualNetworkStrataCloudManagerArgs {
  ...
  factory NextGenerationFirewallVirtualNetworkStrataCloudManagerArgs.fromMap(
    ...
    return NextGenerationFirewallVirtualNetworkStrataCloudManagerArgs(
      destinationNats: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NextGenerationFirewallVirtualNetworkStrataCloudManagerDestinationNat.fromMap(
      ...
      dnsSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualNetworkStrataCloudManagerDnsSettings.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualNetworkStrataCloudManagerIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      networkProfile: pulumi.Input.fromValue(
        NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfile.fromMap(
      ...
      strataCloudManagerTenantName: pulumi.Input.fromValue(
        map['strataCloudManagerTenantName'] as String,
      ),
      tags: (() {
