...
class NextGenerationFirewallVirtualNetworkPanoramaState {
  ...
  final pulumi.Input<
    List<NextGenerationFirewallVirtualNetworkPanoramaPanorama>
  >?
  panoramas;
  ...
  factory NextGenerationFirewallVirtualNetworkPanoramaState.fromMap(
      ...
      panoramas: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NextGenerationFirewallVirtualNetworkPanoramaPanorama.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
