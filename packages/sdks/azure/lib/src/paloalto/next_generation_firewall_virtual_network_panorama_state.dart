...
class NextGenerationFirewallVirtualNetworkPanoramaState {
  ...
  const NextGenerationFirewallVirtualNetworkPanoramaState({
  ...
  factory NextGenerationFirewallVirtualNetworkPanoramaState.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualNetworkPanoramaState(
      ...
      networkProfile: (() { final guardedValue = map['networkProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      panoramas: (() { final guardedValue = map['panoramas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NextGenerationFirewallVirtualNetworkPanoramaPanorama>(guardedValue, (value) => NextGenerationFirewallVirtualNetworkPanoramaPanorama.fromMap((value as Map).cast<String, dynamic>()))); })(),
