...
import 'local_rulestack_outbound_untrust_certificate_association_args.dart';
import 'local_rulestack_outbound_untrust_certificate_association_state.dart';
...
class LocalRulestackOutboundUntrustCertificateAssociation extends pulumi.CustomResource {
  ...
  /// Creates a new [LocalRulestackOutboundUntrustCertificateAssociation].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LocalRulestackOutboundUntrustCertificateAssociation]. {@macro pulumi_paloalto_local_rulestack_outbound_untrust_certificate_association_local_rulestack_outbound_untrust_certificate_association_args_doc}
  ...
  /// Gets an existing [LocalRulestackOutboundUntrustCertificateAssociation] resource's state with the given [name] and [id].
  static LocalRulestackOutboundUntrustCertificateAssociation get(
    String name,
  ...
  LocalRulestackOutboundUntrustCertificateAssociation._get(
    String name, {
