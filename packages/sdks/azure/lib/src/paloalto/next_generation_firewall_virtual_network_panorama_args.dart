...
class NextGenerationFirewallVirtualNetworkPanoramaArgs {
  ...
  const NextGenerationFirewallVirtualNetworkPanoramaArgs({
  ...
  factory NextGenerationFirewallVirtualNetworkPanoramaArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualNetworkPanoramaArgs(
      destinationNats: (() { final guardedValue = map['destinationNats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NextGenerationFirewallVirtualNetworkPanoramaDestinationNat>(guardedValue, (value) => NextGenerationFirewallVirtualNetworkPanoramaDestinationNat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dnsSettings: (() { final guardedValue = map['dnsSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NextGenerationFirewallVirtualNetworkPanoramaDnsSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      networkProfile: pulumi.Input.fromValue(NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile.fromMap((map['networkProfile']! as Map).cast<String, dynamic>())),
      panoramaBase64Config: pulumi.Input.fromValue(map['panoramaBase64Config'] as String),
