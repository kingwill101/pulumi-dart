...
class NextGenerationFirewallVirtualHubPanoramaArgs {
  ...
  const NextGenerationFirewallVirtualHubPanoramaArgs({
  ...
  factory NextGenerationFirewallVirtualHubPanoramaArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualHubPanoramaArgs(
      ...
      networkProfile: pulumi.Input.fromValue(NextGenerationFirewallVirtualHubPanoramaNetworkProfile.fromMap((map['networkProfile']! as Map).cast<String, dynamic>())),
