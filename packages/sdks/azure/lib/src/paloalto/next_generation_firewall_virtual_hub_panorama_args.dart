...
class NextGenerationFirewallVirtualHubPanoramaArgs {
  ...
  final pulumi.Input<
    List<NextGenerationFirewallVirtualHubPanoramaDestinationNat>
  >?
  destinationNats;

  /// A `dns_settings` block as defined below.
  final pulumi.Input<NextGenerationFirewallVirtualHubPanoramaDnsSettings>?
  dnsSettings;
  ...
  final pulumi.Input<NextGenerationFirewallVirtualHubPanoramaNetworkProfile>
  networkProfile;
  ...
  factory NextGenerationFirewallVirtualHubPanoramaArgs.fromMap(
    ...
    return NextGenerationFirewallVirtualHubPanoramaArgs(
      destinationNats: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NextGenerationFirewallVirtualHubPanoramaDestinationNat.fromMap(
      ...
      dnsSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NextGenerationFirewallVirtualHubPanoramaDnsSettings.fromMap(
      ...
      networkProfile: pulumi.Input.fromValue(
        NextGenerationFirewallVirtualHubPanoramaNetworkProfile.fromMap(
