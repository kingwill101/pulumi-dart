...
class LocalRulestackRuleDestination {
  ...
  factory LocalRulestackRuleDestination.fromMap(Map<String, dynamic> map) {
    return LocalRulestackRuleDestination(
      ...
      localRulestackFqdnListIds: (() { final guardedValue = map['localRulestackFqdnListIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
