...
class LocalRulestackRuleDestination {
  ...
  final List<String>? localRulestackFqdnListIds;
  ...
  final List<String>? localRulestackPrefixListIds;
  ...
  factory LocalRulestackRuleDestination.fromMap(Map<String, dynamic> map) {
    return LocalRulestackRuleDestination(
      ...
      localRulestackFqdnListIds: map['localRulestackFqdnListIds'] == null ? null : (map['localRulestackFqdnListIds'] as List).cast<String>(),
      localRulestackPrefixListIds: map['localRulestackPrefixListIds'] == null ? null : (map['localRulestackPrefixListIds'] as List).cast<String>(),
    );
  }
}
