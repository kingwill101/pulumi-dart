...
class FeaturesEnhancedValidation {
  ...
  /// Creates a new [FeaturesEnhancedValidation].
  ...
  const FeaturesEnhancedValidation({
    this.locations,
  ...
  factory FeaturesEnhancedValidation.fromMap(Map<String, dynamic> map) {
    return FeaturesEnhancedValidation(
