...
class SubscriptionArgs {
  ...
  final pulumi.Input<SubscriptionClientScopedSubscription>?
    ...
    return <String, dynamic>{
      ...
      'clientScopedSubscription':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(clientScopedSubscription, (value) => value.toMap()),
  ...
  factory SubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionArgs(
      ...
      clientScopedSubscription: (() {
        final guardedValue = map['clientScopedSubscription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubscriptionClientScopedSubscription.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      clientScopedSubscriptionEnabled: (() {
        final guardedValue = map['clientScopedSubscriptionEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      deadLetteringOnFilterEvaluationError: (() {
        final guardedValue = map['deadLetteringOnFilterEvaluationError'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      maxDeliveryCount: pulumi.Input.fromValue(map['maxDeliveryCount'] as int),
      name: (() {
