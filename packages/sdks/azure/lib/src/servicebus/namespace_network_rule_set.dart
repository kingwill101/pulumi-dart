    ...
    return <String, dynamic>{
      ...
      'networkRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceNetworkRuleSetNetworkRule>,
    ...
    return NamespaceNetworkRuleSet(
      ...
      networkRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceNetworkRuleSetNetworkRule>(
            guardedValue,
            (value) => NamespaceNetworkRuleSetNetworkRule.fromMap(
      ...
      trustedServicesAllowed: (() {
        final guardedValue = map['trustedServicesAllowed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
