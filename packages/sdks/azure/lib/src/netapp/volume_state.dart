...
class VolumeState {
  ...
  factory VolumeState.fromMap(Map<String, dynamic> map) {
    return VolumeState(
      ...
      storageQuotaInGb: (() { final guardedValue = map['storageQuotaInGb']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      volumePath: (() { final guardedValue = map['volumePath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
