...
class GetVolumeResult {
    ...
    return <String, dynamic>{
      ...
      'dataProtectionBackupPolicies':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(dataProtectionBackupPolicies, (value) => value.toMap()),
      'dataProtectionReplications':
          pulumi.Input.encodeList<
            GetVolumeDataProtectionReplication,
            Map<String, dynamic>
          >(dataProtectionReplications, (value) => value.toMap()),
  ...
  factory GetVolumeResult.fromMap(Map<String, dynamic> map) {
    return GetVolumeResult(
      acceptGrowCapacityPoolForShortTermCloneSplit:
          map['acceptGrowCapacityPoolForShortTermCloneSplit'] as String,
      accountName: map['accountName'] as String,
      dataProtectionBackupPolicies:
          pulumi.Input.decodeList<GetVolumeDataProtectionBackupPolicy>(
            map['dataProtectionBackupPolicies']!,
            (value) => GetVolumeDataProtectionBackupPolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      dataProtectionReplications:
          pulumi.Input.decodeList<GetVolumeDataProtectionReplication>(
            map['dataProtectionReplications']!,
            (value) => GetVolumeDataProtectionReplication.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      smbAccessBasedEnumerationEnabled:
          map['smbAccessBasedEnumerationEnabled'] as bool,
