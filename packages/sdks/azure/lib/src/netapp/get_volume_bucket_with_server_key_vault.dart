...
class GetVolumeBucketWithServerKeyVault {
  ...
  /// Creates a new [GetVolumeBucketWithServerKeyVault].
  ...
  const GetVolumeBucketWithServerKeyVault({
  ...
  factory GetVolumeBucketWithServerKeyVault.fromMap(Map<String, dynamic> map) {
    return GetVolumeBucketWithServerKeyVault(
