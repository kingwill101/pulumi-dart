...
class VolumeGroupSapHanaVolume {
  ...
  factory VolumeGroupSapHanaVolume.fromMap(Map<String, dynamic> map) {
    return VolumeGroupSapHanaVolume(
      ...
      dataProtectionReplication: map['dataProtectionReplication'] == null ? null : (VolumeGroupSapHanaVolumeDataProtectionReplication.fromMap((map['dataProtectionReplication']! as Map).cast<String, dynamic>())).input(),
      dataProtectionSnapshotPolicy: map['dataProtectionSnapshotPolicy'] == null ? null : (VolumeGroupSapHanaVolumeDataProtectionSnapshotPolicy.fromMap((map['dataProtectionSnapshotPolicy']! as Map).cast<String, dynamic>())).input(),
      encryptionKeySource: map['encryptionKeySource'] == null ? null : (map['encryptionKeySource']! as String).input(),
      exportPolicyRules: (pulumi.Input.decodeList<VolumeGroupSapHanaVolumeExportPolicyRule>(map['exportPolicyRules'], (value) => VolumeGroupSapHanaVolumeExportPolicyRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      protocols: (map['protocols'] as String).input(),
