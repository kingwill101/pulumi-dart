...
class VolumeGroupSapHanaVolume {
  ...
  final pulumi.Input<VolumeGroupSapHanaVolumeDataProtectionReplication>?
  dataProtectionReplication;

  /// A `data_protection_snapshot_policy` block as defined below.
  final pulumi.Input<VolumeGroupSapHanaVolumeDataProtectionSnapshotPolicy>?
  ...
  final pulumi.Input<List<VolumeGroupSapHanaVolumeExportPolicyRule>>
  exportPolicyRules;
    ...
    return <String, dynamic>{
      ...
      'exportPolicyRules':
          pulumi.Input.mapInputValue<
            List<VolumeGroupSapHanaVolumeExportPolicyRule>,
    ...
    return VolumeGroupSapHanaVolume(
      ...
      dataProtectionReplication: (() {
        ...
        return pulumi.Input.fromValue(
          VolumeGroupSapHanaVolumeDataProtectionReplication.fromMap(
      ...
      dataProtectionSnapshotPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeGroupSapHanaVolumeDataProtectionSnapshotPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      exportPolicyRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VolumeGroupSapHanaVolumeExportPolicyRule>(
          map['exportPolicyRules']!,
          (value) => VolumeGroupSapHanaVolumeExportPolicyRule.fromMap(
      ...
      mountIpAddresses: (() {
        final guardedValue = map['mountIpAddresses'];
        if (guardedValue == null) return null;
