...
class VolumeBucketKeyVault {
  ...
  /// Creates a new [VolumeBucketKeyVault].
  ...
  factory VolumeBucketKeyVault.fromMap(Map<String, dynamic> map) {
    return VolumeBucketKeyVault(
