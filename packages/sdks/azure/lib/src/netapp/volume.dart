...
class Volume extends pulumi.CustomResource {
  ...
  late final pulumi.Output<VolumeDataProtectionBackupPolicy?>
  ...
  late final pulumi.Output<VolumeDataProtectionReplication?>
  dataProtectionReplication;

  /// A `data_protection_snapshot_policy` block as defined below.
  late final pulumi.Output<VolumeDataProtectionSnapshotPolicy?>
  ...
  Volume(String name, {VolumeArgs? args, pulumi.CustomResourceOptions? options})
    ...
    acceptGrowCapacityPoolForShortTermCloneSplit = registerOutput<String?>(
      'acceptGrowCapacityPoolForShortTermCloneSplit',
    );
    ...
    keyVaultPrivateEndpointId = registerOutput<String>(
    ...
    smb3ProtocolEncryptionEnabled = registerOutput<bool?>(
      'smb3ProtocolEncryptionEnabled',
    );
    smbAccessBasedEnumerationEnabled = registerOutput<bool?>(
      'smbAccessBasedEnumerationEnabled',
    );
    smbContinuousAvailabilityEnabled = registerOutput<bool?>(
