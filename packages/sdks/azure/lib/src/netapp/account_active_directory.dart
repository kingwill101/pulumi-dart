...
class AccountActiveDirectory {
  ...
  factory AccountActiveDirectory.fromMap(Map<String, dynamic> map) {
    return AccountActiveDirectory(
      aesEncryptionEnabled: (() { final guardedValue = map['aesEncryptionEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      dnsServers: pulumi.Input.fromValue((map['dnsServers'] as List).cast<String>()),
      domain: pulumi.Input.fromValue(map['domain'] as String),
      kerberosAdName: (() { final guardedValue = map['kerberosAdName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kerberosKdcIp: (() { final guardedValue = map['kerberosKdcIp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ldapOverTlsEnabled: (() { final guardedValue = map['ldapOverTlsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ldapSigningEnabled: (() { final guardedValue = map['ldapSigningEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      localNfsUsersWithLdapAllowed: (() { final guardedValue = map['localNfsUsersWithLdapAllowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
