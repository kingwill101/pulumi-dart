...
class VolumeArgs {
  ...
  final pulumi.Input<VolumeDataProtectionBackupPolicy>?
  ...
  final pulumi.Input<VolumeDataProtectionReplication>?
  dataProtectionReplication;

  /// A `data_protection_snapshot_policy` block as defined below.
  final pulumi.Input<VolumeDataProtectionSnapshotPolicy>?
    ...
    return <String, dynamic>{
      ...
      'coolAccess':
          ?pulumi.Input.mapOptionalInputValue<
            VolumeCoolAccess,
            Map<String, dynamic>
          >(coolAccess, (value) => value.toMap()),
      'createFromSnapshotResourceId': ?createFromSnapshotResourceId,
      'dataProtectionBackupPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            VolumeDataProtectionBackupPolicy,
            Map<String, dynamic>
          >(dataProtectionBackupPolicy, (value) => value.toMap()),
      'dataProtectionReplication':
          ?pulumi.Input.mapOptionalInputValue<
            VolumeDataProtectionReplication,
            Map<String, dynamic>
          >(dataProtectionReplication, (value) => value.toMap()),
      'dataProtectionSnapshotPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            VolumeDataProtectionSnapshotPolicy,
            Map<String, dynamic>
          >(dataProtectionSnapshotPolicy, (value) => value.toMap()),
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      acceptGrowCapacityPoolForShortTermCloneSplit: (() {
        final guardedValue =
            map['acceptGrowCapacityPoolForShortTermCloneSplit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      accountName: pulumi.Input.fromValue(map['accountName'] as String),
      azureVmwareDataStoreEnabled: (() {
        final guardedValue = map['azureVmwareDataStoreEnabled'];
        if (guardedValue == null) return null;
      ...
      coolAccess: (() {
        ...
        return pulumi.Input.fromValue(
          VolumeCoolAccess.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      createFromSnapshotResourceId: (() {
        final guardedValue = map['createFromSnapshotResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataProtectionBackupPolicy: (() {
        final guardedValue = map['dataProtectionBackupPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeDataProtectionBackupPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      dataProtectionReplication: (() {
        final guardedValue = map['dataProtectionReplication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeDataProtectionReplication.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      dataProtectionSnapshotPolicy: (() {
        final guardedValue = map['dataProtectionSnapshotPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeDataProtectionSnapshotPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      exportPolicyRules: (() {
        final guardedValue = map['exportPolicyRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      keyVaultPrivateEndpointId: (() {
        final guardedValue = map['keyVaultPrivateEndpointId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      largeVolumeEnabled: (() {
        final guardedValue = map['largeVolumeEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      location: (() {
      ...
      smb3ProtocolEncryptionEnabled: (() {
        final guardedValue = map['smb3ProtocolEncryptionEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      smbAccessBasedEnumerationEnabled: (() {
        final guardedValue = map['smbAccessBasedEnumerationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      smbContinuousAvailabilityEnabled: (() {
        final guardedValue = map['smbContinuousAvailabilityEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      smbNonBrowsableEnabled: (() {
        final guardedValue = map['smbNonBrowsableEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      throughputInMibps: (() {
        final guardedValue = map['throughputInMibps'];
        if (guardedValue == null) return null;
