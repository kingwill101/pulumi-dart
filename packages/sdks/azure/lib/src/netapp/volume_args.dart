...
class VolumeArgs {
  ...
  VolumeArgs({
    pulumi.Output<String>? acceptGrowCapacityPoolForShortTermCloneSplit,
    required pulumi.Output<String> accountName,
    pulumi.Output<bool>? azureVmwareDataStoreEnabled,
    pulumi.Output<VolumeCoolAccess>? coolAccess,
    pulumi.Output<String>? createFromSnapshotResourceId,
    pulumi.Output<VolumeDataProtectionBackupPolicy>? dataProtectionBackupPolicy,
    pulumi.Output<VolumeDataProtectionReplication>? dataProtectionReplication,
    pulumi.Output<VolumeDataProtectionSnapshotPolicy>? dataProtectionSnapshotPolicy,
    pulumi.Output<String>? encryptionKeySource,
    pulumi.Output<List<VolumeExportPolicyRule>>? exportPolicyRules,
    pulumi.Output<bool>? kerberosEnabled,
    pulumi.Output<String>? keyVaultPrivateEndpointId,
    pulumi.Output<bool>? largeVolumeEnabled,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<String>? networkFeatures,
    ...
    pulumi.Output<bool>? smb3ProtocolEncryptionEnabled,
    pulumi.Output<bool>? smbAccessBasedEnumerationEnabled,
    pulumi.Output<bool>? smbContinuousAvailabilityEnabled,
    pulumi.Output<bool>? smbNonBrowsableEnabled,
    pulumi.Output<bool>? snapshotDirectoryVisible,
    required pulumi.Output<int> storageQuotaInGb,
    required pulumi.Output<String> subnetId,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<double>? throughputInMibps,
    required pulumi.Output<String> volumePath,
    pulumi.Output<String>? zone,
  }) :
      acceptGrowCapacityPoolForShortTermCloneSplit = pulumi.Input.asOptionalInput<String>(acceptGrowCapacityPoolForShortTermCloneSplit),
      accountName = pulumi.Input.asInput<String>(accountName),
      azureVmwareDataStoreEnabled = pulumi.Input.asOptionalInput<bool>(azureVmwareDataStoreEnabled),
      coolAccess = pulumi.Input.asOptionalInput<VolumeCoolAccess>(coolAccess),
      createFromSnapshotResourceId = pulumi.Input.asOptionalInput<String>(createFromSnapshotResourceId),
      dataProtectionBackupPolicy = pulumi.Input.asOptionalInput<VolumeDataProtectionBackupPolicy>(dataProtectionBackupPolicy),
      dataProtectionReplication = pulumi.Input.asOptionalInput<VolumeDataProtectionReplication>(dataProtectionReplication),
      dataProtectionSnapshotPolicy = pulumi.Input.asOptionalInput<VolumeDataProtectionSnapshotPolicy>(dataProtectionSnapshotPolicy),
      encryptionKeySource = pulumi.Input.asOptionalInput<String>(encryptionKeySource),
      exportPolicyRules = pulumi.Input.asOptionalInput<List<VolumeExportPolicyRule>>(exportPolicyRules),
      kerberosEnabled = pulumi.Input.asOptionalInput<bool>(kerberosEnabled),
      keyVaultPrivateEndpointId = pulumi.Input.asOptionalInput<String>(keyVaultPrivateEndpointId),
      largeVolumeEnabled = pulumi.Input.asOptionalInput<bool>(largeVolumeEnabled),
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      networkFeatures = pulumi.Input.asOptionalInput<String>(networkFeatures),
      ...
      smb3ProtocolEncryptionEnabled = pulumi.Input.asOptionalInput<bool>(smb3ProtocolEncryptionEnabled),
      smbAccessBasedEnumerationEnabled = pulumi.Input.asOptionalInput<bool>(smbAccessBasedEnumerationEnabled),
      smbContinuousAvailabilityEnabled = pulumi.Input.asOptionalInput<bool>(smbContinuousAvailabilityEnabled),
      smbNonBrowsableEnabled = pulumi.Input.asOptionalInput<bool>(smbNonBrowsableEnabled),
      snapshotDirectoryVisible = pulumi.Input.asOptionalInput<bool>(snapshotDirectoryVisible),
      storageQuotaInGb = pulumi.Input.asInput<int>(storageQuotaInGb),
      subnetId = pulumi.Input.asInput<String>(subnetId),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      throughputInMibps = pulumi.Input.asOptionalInput<double>(throughputInMibps),
      volumePath = pulumi.Input.asInput<String>(volumePath),
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      acceptGrowCapacityPoolForShortTermCloneSplit: map['acceptGrowCapacityPoolForShortTermCloneSplit'] == null ? null : pulumi.Output.create<String>(map['acceptGrowCapacityPoolForShortTermCloneSplit'] as String),
      accountName: pulumi.Output.create<String>(map['accountName'] as String),
      azureVmwareDataStoreEnabled: map['azureVmwareDataStoreEnabled'] == null ? null : pulumi.Output.create<bool>(map['azureVmwareDataStoreEnabled'] as bool),
      coolAccess: map['coolAccess'] == null ? null : pulumi.Output.create<VolumeCoolAccess>(VolumeCoolAccess.fromMap((map['coolAccess'] as Map).cast<String, dynamic>())),
      createFromSnapshotResourceId: map['createFromSnapshotResourceId'] == null ? null : pulumi.Output.create<String>(map['createFromSnapshotResourceId'] as String),
      dataProtectionBackupPolicy: map['dataProtectionBackupPolicy'] == null ? null : pulumi.Output.create<VolumeDataProtectionBackupPolicy>(VolumeDataProtectionBackupPolicy.fromMap((map['dataProtectionBackupPolicy'] as Map).cast<String, dynamic>())),
      dataProtectionReplication: map['dataProtectionReplication'] == null ? null : pulumi.Output.create<VolumeDataProtectionReplication>(VolumeDataProtectionReplication.fromMap((map['dataProtectionReplication'] as Map).cast<String, dynamic>())),
      dataProtectionSnapshotPolicy: map['dataProtectionSnapshotPolicy'] == null ? null : pulumi.Output.create<VolumeDataProtectionSnapshotPolicy>(VolumeDataProtectionSnapshotPolicy.fromMap((map['dataProtectionSnapshotPolicy'] as Map).cast<String, dynamic>())),
      encryptionKeySource: map['encryptionKeySource'] == null ? null : pulumi.Output.create<String>(map['encryptionKeySource'] as String),
      exportPolicyRules: map['exportPolicyRules'] == null ? null : pulumi.Output.create<List<VolumeExportPolicyRule>>(pulumi.Input.decodeList<VolumeExportPolicyRule>(map['exportPolicyRules'], (value) => VolumeExportPolicyRule.fromMap((value as Map).cast<String, dynamic>()))),
      kerberosEnabled: map['kerberosEnabled'] == null ? null : pulumi.Output.create<bool>(map['kerberosEnabled'] as bool),
      keyVaultPrivateEndpointId: map['keyVaultPrivateEndpointId'] == null ? null : pulumi.Output.create<String>(map['keyVaultPrivateEndpointId'] as String),
      largeVolumeEnabled: map['largeVolumeEnabled'] == null ? null : pulumi.Output.create<bool>(map['largeVolumeEnabled'] as bool),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkFeatures: map['networkFeatures'] == null ? null : pulumi.Output.create<String>(map['networkFeatures'] as String),
      ...
      smb3ProtocolEncryptionEnabled: map['smb3ProtocolEncryptionEnabled'] == null ? null : pulumi.Output.create<bool>(map['smb3ProtocolEncryptionEnabled'] as bool),
      smbAccessBasedEnumerationEnabled: map['smbAccessBasedEnumerationEnabled'] == null ? null : pulumi.Output.create<bool>(map['smbAccessBasedEnumerationEnabled'] as bool),
      smbContinuousAvailabilityEnabled: map['smbContinuousAvailabilityEnabled'] == null ? null : pulumi.Output.create<bool>(map['smbContinuousAvailabilityEnabled'] as bool),
      smbNonBrowsableEnabled: map['smbNonBrowsableEnabled'] == null ? null : pulumi.Output.create<bool>(map['smbNonBrowsableEnabled'] as bool),
      snapshotDirectoryVisible: map['snapshotDirectoryVisible'] == null ? null : pulumi.Output.create<bool>(map['snapshotDirectoryVisible'] as bool),
      storageQuotaInGb: pulumi.Output.create<int>(map['storageQuotaInGb'] as int),
      subnetId: pulumi.Output.create<String>(map['subnetId'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      throughputInMibps: map['throughputInMibps'] == null ? null : pulumi.Output.create<double>(map['throughputInMibps'] as double),
      volumePath: pulumi.Output.create<String>(map['volumePath'] as String),
