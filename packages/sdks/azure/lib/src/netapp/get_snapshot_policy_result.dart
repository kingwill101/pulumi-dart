...
class GetSnapshotPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dailySchedules': pulumi.Input.encodeList<GetSnapshotPolicyDailySchedule, Map<String, dynamic>>(dailySchedules, (value) => value.toMap()),
      'enabled': enabled,
      'hourlySchedules': pulumi.Input.encodeList<GetSnapshotPolicyHourlySchedule, Map<String, dynamic>>(hourlySchedules, (value) => value.toMap()),
      'id': id,
      'location': location,
      'monthlySchedules': pulumi.Input.encodeList<GetSnapshotPolicyMonthlySchedule, Map<String, dynamic>>(monthlySchedules, (value) => value.toMap()),
      'name': name,
      'resourceGroupName': resourceGroupName,
      'tags': tags,
      'weeklySchedules': pulumi.Input.encodeList<GetSnapshotPolicyWeeklySchedule, Map<String, dynamic>>(weeklySchedules, (value) => value.toMap()),
    };
  }
  ...
  factory GetSnapshotPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetSnapshotPolicyResult(
      ...
      dailySchedules: pulumi.Input.decodeList<GetSnapshotPolicyDailySchedule>(map['dailySchedules']!, (value) => GetSnapshotPolicyDailySchedule.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] as bool,
      hourlySchedules: pulumi.Input.decodeList<GetSnapshotPolicyHourlySchedule>(map['hourlySchedules']!, (value) => GetSnapshotPolicyHourlySchedule.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      location: map['location'] as String,
      monthlySchedules: pulumi.Input.decodeList<GetSnapshotPolicyMonthlySchedule>(map['monthlySchedules']!, (value) => GetSnapshotPolicyMonthlySchedule.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      weeklySchedules: pulumi.Input.decodeList<GetSnapshotPolicyWeeklySchedule>(map['weeklySchedules']!, (value) => GetSnapshotPolicyWeeklySchedule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
