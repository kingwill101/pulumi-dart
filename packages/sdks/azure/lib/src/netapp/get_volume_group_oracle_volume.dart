...
class GetVolumeGroupOracleVolume {
  ...
  final pulumi.Input<List<GetVolumeGroupOracleVolumeDataProtectionReplication>>
  dataProtectionReplications;

  /// A `data_protection_snapshot_policy` block as defined below.
  final pulumi.Input<
    List<GetVolumeGroupOracleVolumeDataProtectionSnapshotPolicy>
  >
  ...
  final pulumi.Input<List<GetVolumeGroupOracleVolumeExportPolicyRule>>
  exportPolicyRules;
    ...
    return <String, dynamic>{
      ...
      'dataProtectionReplications':
          pulumi.Input.mapInputValue<
            List<GetVolumeGroupOracleVolumeDataProtectionReplication>,
      ...
      'exportPolicyRules':
          pulumi.Input.mapInputValue<
            List<GetVolumeGroupOracleVolumeExportPolicyRule>,
            List<Map<String, dynamic>>
          >(
            exportPolicyRules,
            (value) =>
    ...
    return GetVolumeGroupOracleVolume(
      ...
      dataProtectionReplications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetVolumeGroupOracleVolumeDataProtectionReplication.fromMap(
      ...
      dataProtectionSnapshotPolicies: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetVolumeGroupOracleVolumeDataProtectionSnapshotPolicy.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      ...
      exportPolicyRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVolumeGroupOracleVolumeExportPolicyRule>(
          map['exportPolicyRules']!,
          (value) => GetVolumeGroupOracleVolumeExportPolicyRule.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
