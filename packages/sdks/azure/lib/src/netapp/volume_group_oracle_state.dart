...
class VolumeGroupOracleState {
  ...
  factory VolumeGroupOracleState.fromMap(Map<String, dynamic> map) {
    return VolumeGroupOracleState(
      ...
      volumes: (() { final guardedValue = map['volumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeGroupOracleVolume>(guardedValue, (value) => VolumeGroupOracleVolume.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
