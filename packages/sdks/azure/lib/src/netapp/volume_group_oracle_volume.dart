...
class VolumeGroupOracleVolume {
  ...
  final pulumi.Input<VolumeGroupOracleVolumeDataProtectionReplication>?
  dataProtectionReplication;

  /// A `data_protection_snapshot_policy` block as defined below.
  final pulumi.Input<VolumeGroupOracleVolumeDataProtectionSnapshotPolicy>?
  ...
  final pulumi.Input<List<VolumeGroupOracleVolumeExportPolicyRule>>
  exportPolicyRules;
    ...
    return <String, dynamic>{
      ...
      'exportPolicyRules':
          pulumi.Input.mapInputValue<
            List<VolumeGroupOracleVolumeExportPolicyRule>,
    ...
    return VolumeGroupOracleVolume(
      ...
      dataProtectionReplication: (() {
        ...
        return pulumi.Input.fromValue(
          VolumeGroupOracleVolumeDataProtectionReplication.fromMap(
      ...
      dataProtectionSnapshotPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeGroupOracleVolumeDataProtectionSnapshotPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      exportPolicyRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VolumeGroupOracleVolumeExportPolicyRule>(
          map['exportPolicyRules']!,
          (value) => VolumeGroupOracleVolumeExportPolicyRule.fromMap(
