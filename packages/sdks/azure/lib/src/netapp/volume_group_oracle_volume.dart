...
class VolumeGroupOracleVolume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataProtectionReplication': ?pulumi.Input.mapOptionalInputValue<VolumeGroupOracleVolumeDataProtectionReplication, Map<String, dynamic>>(dataProtectionReplication, (value) => value.toMap()),
      'dataProtectionSnapshotPolicy': ?pulumi.Input.mapOptionalInputValue<VolumeGroupOracleVolumeDataProtectionSnapshotPolicy, Map<String, dynamic>>(dataProtectionSnapshotPolicy, (value) => value.toMap()),
      'encryptionKeySource': ?encryptionKeySource,
      'exportPolicyRules': pulumi.Input.mapInputValue<List<VolumeGroupOracleVolumeExportPolicyRule>, List<Map<String, dynamic>>>(exportPolicyRules, (value) => pulumi.Input.encodeList<VolumeGroupOracleVolumeExportPolicyRule, Map<String, dynamic>>(value, (value) => value.toMap())),
      'id': ?id,
  ...
  factory VolumeGroupOracleVolume.fromMap(Map<String, dynamic> map) {
    return VolumeGroupOracleVolume(
      ...
      dataProtectionReplication: (() { final guardedValue = map['dataProtectionReplication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeGroupOracleVolumeDataProtectionReplication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataProtectionSnapshotPolicy: (() { final guardedValue = map['dataProtectionSnapshotPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeGroupOracleVolumeDataProtectionSnapshotPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      exportPolicyRules: pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeGroupOracleVolumeExportPolicyRule>(map['exportPolicyRules']!, (value) => VolumeGroupOracleVolumeExportPolicyRule.fromMap((value as Map).cast<String, dynamic>()))),
