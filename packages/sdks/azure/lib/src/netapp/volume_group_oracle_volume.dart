...
class VolumeGroupOracleVolume {
  ...
  factory VolumeGroupOracleVolume.fromMap(Map<String, dynamic> map) {
    return VolumeGroupOracleVolume(
      ...
      dataProtectionReplication: map['dataProtectionReplication'] == null ? null : (VolumeGroupOracleVolumeDataProtectionReplication.fromMap((map['dataProtectionReplication'] as Map).cast<String, dynamic>())).input(),
      dataProtectionSnapshotPolicy: map['dataProtectionSnapshotPolicy'] == null ? null : (VolumeGroupOracleVolumeDataProtectionSnapshotPolicy.fromMap((map['dataProtectionSnapshotPolicy'] as Map).cast<String, dynamic>())).input(),
      encryptionKeySource: map['encryptionKeySource'] == null ? null : (map['encryptionKeySource'] as String).input(),
      exportPolicyRules: (pulumi.Input.decodeList<VolumeGroupOracleVolumeExportPolicyRule>(map['exportPolicyRules'], (value) => VolumeGroupOracleVolumeExportPolicyRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
