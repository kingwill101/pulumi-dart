...
class VolumeGroupSapHanaArgs {
  ...
  VolumeGroupSapHanaArgs({
    ...
    required pulumi.Output<List<VolumeGroupSapHanaVolume>> volumes,
  }) :
  ...
  factory VolumeGroupSapHanaArgs.fromMap(Map<String, dynamic> map) {
    return VolumeGroupSapHanaArgs(
      ...
      volumes: pulumi.Output.create<List<VolumeGroupSapHanaVolume>>(pulumi.Input.decodeList<VolumeGroupSapHanaVolume>(map['volumes'], (value) => VolumeGroupSapHanaVolume.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
