...
class VolumeGroupOracleArgs {
  ...
  factory VolumeGroupOracleArgs.fromMap(Map<String, dynamic> map) {
    return VolumeGroupOracleArgs(
      ...
      volumes: pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeGroupOracleVolume>(map['volumes']!, (value) => VolumeGroupOracleVolume.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
