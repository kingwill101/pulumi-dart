...
class GetVolumeGroupSapHanaVolume {
  ...
  final pulumi.Input<List<GetVolumeGroupSapHanaVolumeDataProtectionReplication>>
  dataProtectionReplications;

  /// A `data_protection_snapshot_policy` block as defined below.
  final pulumi.Input<
    List<GetVolumeGroupSapHanaVolumeDataProtectionSnapshotPolicy>
  >
  ...
  final pulumi.Input<List<GetVolumeGroupSapHanaVolumeExportPolicyRule>>
  exportPolicyRules;
    ...
    return <String, dynamic>{
      ...
      'dataProtectionReplications':
          pulumi.Input.mapInputValue<
            List<GetVolumeGroupSapHanaVolumeDataProtectionReplication>,
      ...
      'exportPolicyRules':
          pulumi.Input.mapInputValue<
            List<GetVolumeGroupSapHanaVolumeExportPolicyRule>,
            List<Map<String, dynamic>>
          >(
            exportPolicyRules,
            (value) =>
  ...
  factory GetVolumeGroupSapHanaVolume.fromMap(Map<String, dynamic> map) {
    return GetVolumeGroupSapHanaVolume(
      ...
      dataProtectionReplications: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetVolumeGroupSapHanaVolumeDataProtectionReplication
        >(
          map['dataProtectionReplications']!,
          (value) =>
              GetVolumeGroupSapHanaVolumeDataProtectionReplication.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      dataProtectionSnapshotPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetVolumeGroupSapHanaVolumeDataProtectionSnapshotPolicy
        >(
          map['dataProtectionSnapshotPolicies']!,
          (value) =>
              GetVolumeGroupSapHanaVolumeDataProtectionSnapshotPolicy.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      encryptionKeySource: pulumi.Input.fromValue(
        map['encryptionKeySource'] as String,
      ),
      exportPolicyRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVolumeGroupSapHanaVolumeExportPolicyRule>(
          map['exportPolicyRules']!,
          (value) => GetVolumeGroupSapHanaVolumeExportPolicyRule.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      id: pulumi.Input.fromValue(map['id'] as String),
      keyVaultPrivateEndpointId: pulumi.Input.fromValue(
        map['keyVaultPrivateEndpointId'] as String,
      ),
      mountIpAddresses: pulumi.Input.fromValue(
        (map['mountIpAddresses'] as List).cast<String>(),
      ),
      ...
      proximityPlacementGroupId: pulumi.Input.fromValue(
        map['proximityPlacementGroupId'] as String,
      ),
      ...
      snapshotDirectoryVisible: pulumi.Input.fromValue(
        map['snapshotDirectoryVisible'] as bool,
      ),
      storageQuotaInGb: pulumi.Input.fromValue(map['storageQuotaInGb'] as int),
      subnetId: pulumi.Input.fromValue(map['subnetId'] as String),
      tags: pulumi.Input.fromValue((map['tags'] as Map).cast<String, String>()),
      throughputInMibps: pulumi.Input.fromValue(
        map['throughputInMibps'] as double,
      ),
