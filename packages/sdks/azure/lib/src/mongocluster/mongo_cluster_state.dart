...
class MongoClusterState {
  ...
  MongoClusterState({
    ...
    pulumi.Output<List<MongoClusterConnectionString>>? connectionStrings,
    ...
    pulumi.Output<String>? version,
      ...
      connectionStrings = pulumi.Input.asOptionalInput<List<MongoClusterConnectionString>>(connectionStrings),
  ...
  factory MongoClusterState.fromMap(Map<String, dynamic> map) {
    return MongoClusterState(
      ...
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Output.create<List<MongoClusterConnectionString>>(pulumi.Input.decodeList<MongoClusterConnectionString>(map['connectionStrings'], (value) => MongoClusterConnectionString.fromMap((value as Map).cast<String, dynamic>()))),
