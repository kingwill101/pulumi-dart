...
class FlexibleServerAuthentication {
  ...
  final bool? activeDirectoryAuthEnabled;
  ...
  factory FlexibleServerAuthentication.fromMap(Map<String, dynamic> map) {
    return FlexibleServerAuthentication(
      activeDirectoryAuthEnabled: map['activeDirectoryAuthEnabled'] == null ? null : map['activeDirectoryAuthEnabled'] as bool,
      passwordAuthEnabled: map['passwordAuthEnabled'] == null ? null : map['passwordAuthEnabled'] as bool,
