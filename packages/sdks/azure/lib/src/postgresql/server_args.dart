...
class ServerArgs {
  ...
  ServerArgs({
    ...
    pulumi.Output<String>? creationSourceServerId,
    ...
    required pulumi.Output<bool> sslEnforcementEnabled,
    pulumi.Output<String>? sslMinimalTlsVersionEnforced,
    pulumi.Output<int>? storageMb,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<ServerThreatDetectionPolicy>? threatDetectionPolicy,
    required pulumi.Output<String> version,
      ...
      creationSourceServerId = pulumi.Input.asOptionalInput<String>(creationSourceServerId),
      ...
      sslEnforcementEnabled = pulumi.Input.asInput<bool>(sslEnforcementEnabled),
      sslMinimalTlsVersionEnforced = pulumi.Input.asOptionalInput<String>(sslMinimalTlsVersionEnforced),
      storageMb = pulumi.Input.asOptionalInput<int>(storageMb),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      threatDetectionPolicy = pulumi.Input.asOptionalInput<ServerThreatDetectionPolicy>(threatDetectionPolicy),
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      ...
      creationSourceServerId: map['creationSourceServerId'] == null ? null : pulumi.Output.create<String>(map['creationSourceServerId'] as String),
      ...
      sslEnforcementEnabled: pulumi.Output.create<bool>(map['sslEnforcementEnabled'] as bool),
      sslMinimalTlsVersionEnforced: map['sslMinimalTlsVersionEnforced'] == null ? null : pulumi.Output.create<String>(map['sslMinimalTlsVersionEnforced'] as String),
      storageMb: map['storageMb'] == null ? null : pulumi.Output.create<int>(map['storageMb'] as int),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      threatDetectionPolicy: map['threatDetectionPolicy'] == null ? null : pulumi.Output.create<ServerThreatDetectionPolicy>(ServerThreatDetectionPolicy.fromMap((map['threatDetectionPolicy'] as Map).cast<String, dynamic>())),
