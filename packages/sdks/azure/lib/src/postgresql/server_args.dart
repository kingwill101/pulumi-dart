    ...
    return <String, dynamic>{
      ...
      'threatDetectionPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(threatDetectionPolicy, (value) => value.toMap()),
      'version': version,
    };
  }
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      ...
      creationSourceServerId: (() {
        final guardedValue = map['creationSourceServerId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      sslEnforcementEnabled: pulumi.Input.fromValue(
        map['sslEnforcementEnabled'] as bool,
      ),
      sslMinimalTlsVersionEnforced: (() {
        final guardedValue = map['sslMinimalTlsVersionEnforced'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageMb: (() {
      ...
      threatDetectionPolicy: (() {
        final guardedValue = map['threatDetectionPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServerThreatDetectionPolicy.fromMap(
