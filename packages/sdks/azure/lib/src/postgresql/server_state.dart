...
class ServerState {
  ...
  ServerState({
    ...
    pulumi.Output<bool>? sslEnforcementEnabled,
    ...
    pulumi.Output<String>? version,
      ...
      sslEnforcementEnabled = pulumi.Input.asOptionalInput<bool>(sslEnforcementEnabled),
  ...
  factory ServerState.fromMap(Map<String, dynamic> map) {
    return ServerState(
      ...
      sslEnforcementEnabled: map['sslEnforcementEnabled'] == null ? null : pulumi.Output.create<bool>(map['sslEnforcementEnabled'] as bool),
