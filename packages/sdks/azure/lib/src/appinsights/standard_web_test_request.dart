    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<StandardWebTestRequestHeader>,
  ...
  factory StandardWebTestRequest.fromMap(Map<String, dynamic> map) {
    return StandardWebTestRequest(
      ...
      followRedirectsEnabled: (() {
        final guardedValue = map['followRedirectsEnabled'];
        if (guardedValue == null) return null;
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StandardWebTestRequestHeader>(
            guardedValue,
            (value) => StandardWebTestRequestHeader.fromMap(
      ...
      parseDependentRequestsEnabled: (() {
        final guardedValue = map['parseDependentRequestsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
