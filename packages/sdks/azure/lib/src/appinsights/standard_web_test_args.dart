...
class StandardWebTestArgs {
    ...
    return <String, dynamic>{
      ...
      'validationRules':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(validationRules, (value) => value.toMap()),
    };
  }
  ...
  factory StandardWebTestArgs.fromMap(Map<String, dynamic> map) {
    return StandardWebTestArgs(
      ...
      geoLocations: pulumi.Input.fromValue(
        (map['geoLocations'] as List).cast<String>(),
      ),
      location: (() {
      ...
      request: pulumi.Input.fromValue(
        StandardWebTestRequest.fromMap(
      ...
      validationRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StandardWebTestValidationRules.fromMap(
