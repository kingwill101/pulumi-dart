...
class GetReplicationRecoveryPlanRecoveryGroupPreAction {
  ...
  /// Creates a new [GetReplicationRecoveryPlanRecoveryGroupPreAction].
  ...
  factory GetReplicationRecoveryPlanRecoveryGroupPreAction.fromMap(Map<String, dynamic> map) {
    return GetReplicationRecoveryPlanRecoveryGroupPreAction(
