...
class ReplicationRecoveryPlanBootRecoveryGroup {
  ...
  final pulumi.Input<List<ReplicationRecoveryPlanBootRecoveryGroupPostAction>>?
  postActions;

  /// one or more `action` block as defined below. which will be executed before the group recovery.
  final pulumi.Input<List<ReplicationRecoveryPlanBootRecoveryGroupPreAction>>?
  preActions;
    ...
    return <String, dynamic>{
      'postActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReplicationRecoveryPlanBootRecoveryGroupPostAction>,
      ...
      'preActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReplicationRecoveryPlanBootRecoveryGroupPreAction>,
            List<Map<String, dynamic>>
          >(
            preActions,
            (value) =>
  ...
  factory ReplicationRecoveryPlanBootRecoveryGroup.fromMap(
    Map<String, dynamic> map,
  ) {
    return ReplicationRecoveryPlanBootRecoveryGroup(
      postActions: (() {
        final guardedValue = map['postActions'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ReplicationRecoveryPlanBootRecoveryGroupPostAction.fromMap(
      ...
      preActions: (() {
        final guardedValue = map['preActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            ReplicationRecoveryPlanBootRecoveryGroupPreAction
          >(
            guardedValue,
            (value) =>
                ReplicationRecoveryPlanBootRecoveryGroupPreAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      replicatedProtectedItems: (() {
        final guardedValue = map['replicatedProtectedItems'];
        if (guardedValue == null) return null;
