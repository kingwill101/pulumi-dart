...
class ReplicationRecoveryPlanBootRecoveryGroupPostAction {
  ...
  /// Creates a new [ReplicationRecoveryPlanBootRecoveryGroupPostAction].
  ...
  factory ReplicationRecoveryPlanBootRecoveryGroupPostAction.fromMap(
    Map<String, dynamic> map,
  ) {
    return ReplicationRecoveryPlanBootRecoveryGroupPostAction(
      fabricLocation: (() {
        final guardedValue = map['fabricLocation'];
      ...
      manualActionInstruction: (() {
        final guardedValue = map['manualActionInstruction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
