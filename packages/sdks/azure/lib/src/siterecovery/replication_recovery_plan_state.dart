...
class ReplicationRecoveryPlanState {
  ...
  final pulumi.Input<ReplicationRecoveryPlanAzureToAzureSettings>?
  azureToAzureSettings;

  /// One or more `boot_recovery_group` blocks as defined below.
  final pulumi.Input<List<ReplicationRecoveryPlanBootRecoveryGroup>>?
  bootRecoveryGroups;

  /// One `failover_recovery_group` block as defined below.
  final pulumi.Input<ReplicationRecoveryPlanFailoverRecoveryGroup>?
  ...
  final pulumi.Input<ReplicationRecoveryPlanShutdownRecoveryGroup>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bootRecoveryGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReplicationRecoveryPlanBootRecoveryGroup>,
      ...
      'failoverRecoveryGroup':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(failoverRecoveryGroup, (value) => value.toMap()),
      'name': ?name,
      ...
      'shutdownRecoveryGroup':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(shutdownRecoveryGroup, (value) => value.toMap()),
  ...
  factory ReplicationRecoveryPlanState.fromMap(Map<String, dynamic> map) {
    return ReplicationRecoveryPlanState(
      azureToAzureSettings: (() {
        final guardedValue = map['azureToAzureSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReplicationRecoveryPlanAzureToAzureSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      bootRecoveryGroups: (() {
        final guardedValue = map['bootRecoveryGroups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicationRecoveryPlanBootRecoveryGroup>(
            guardedValue,
            (value) => ReplicationRecoveryPlanBootRecoveryGroup.fromMap(
      ...
      failoverRecoveryGroup: (() {
        final guardedValue = map['failoverRecoveryGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReplicationRecoveryPlanFailoverRecoveryGroup.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      shutdownRecoveryGroup: (() {
        final guardedValue = map['shutdownRecoveryGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReplicationRecoveryPlanShutdownRecoveryGroup.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sourceRecoveryFabricId: (() {
        final guardedValue = map['sourceRecoveryFabricId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetRecoveryFabricId: (() {
        final guardedValue = map['targetRecoveryFabricId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
