...
class ReplicatedVMArgs {
  ...
  factory ReplicatedVMArgs.fromMap(Map<String, dynamic> map) {
    return ReplicatedVMArgs(
      ...
      sourceRecoveryProtectionContainerName: (map['sourceRecoveryProtectionContainerName'] as String).input(),
      sourceVmId: (map['sourceVmId'] as String).input(),
      ...
      targetRecoveryProtectionContainerId: (map['targetRecoveryProtectionContainerId'] as String).input(),
