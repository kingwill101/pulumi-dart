...
class ReplicatedVMArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReplicatedVMNetworkInterface>,
            List<Map<String, dynamic>>
          >(
            networkInterfaces,
            (value) =>
      ...
      'unmanagedDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReplicatedVMUnmanagedDisk>,
            List<Map<String, dynamic>>
          >(
            unmanagedDisks,
            (value) =>
    ...
    return ReplicatedVMArgs(
      managedDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicatedVMManagedDisk>(
            guardedValue,
            (value) => ReplicatedVMManagedDisk.fromMap(
      ...
      networkInterfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicatedVMNetworkInterface>(
            guardedValue,
            (value) => ReplicatedVMNetworkInterface.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sourceRecoveryProtectionContainerName: pulumi.Input.fromValue(
        map['sourceRecoveryProtectionContainerName'] as String,
      ),
      ...
      targetBootDiagnosticStorageAccountId: (() {
        final guardedValue = map['targetBootDiagnosticStorageAccountId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetCapacityReservationGroupId: (() {
        final guardedValue = map['targetCapacityReservationGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetEdgeZone: (() {
        final guardedValue = map['targetEdgeZone'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetNetworkId: (() {
      ...
      targetRecoveryFabricId: pulumi.Input.fromValue(
        map['targetRecoveryFabricId'] as String,
      ),
      targetRecoveryProtectionContainerId: pulumi.Input.fromValue(
        map['targetRecoveryProtectionContainerId'] as String,
      ),
      targetResourceGroupId: pulumi.Input.fromValue(
        map['targetResourceGroupId'] as String,
      ),
      targetVirtualMachineScaleSetId: (() {
        final guardedValue = map['targetVirtualMachineScaleSetId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetVirtualMachineSize: (() {
        final guardedValue = map['targetVirtualMachineSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetZone: (() {
      ...
      unmanagedDisks: (() {
        final guardedValue = map['unmanagedDisks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicatedVMUnmanagedDisk>(
            guardedValue,
            (value) => ReplicatedVMUnmanagedDisk.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
