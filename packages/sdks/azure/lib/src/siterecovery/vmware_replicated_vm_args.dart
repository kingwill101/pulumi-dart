...
class VmwareReplicatedVmArgs {
  ...
  VmwareReplicatedVmArgs({
    required pulumi.Output<String> applianceName,
    pulumi.Output<String>? defaultLogStorageAccountId,
    pulumi.Output<String>? defaultRecoveryDiskType,
    pulumi.Output<String>? defaultTargetDiskEncryptionSetId,
    pulumi.Output<String>? licenseType,
    pulumi.Output<List<VmwareReplicatedVmManagedDisk>>? managedDisks,
    pulumi.Output<String>? multiVmGroupName,
    pulumi.Output<String>? name,
    pulumi.Output<List<VmwareReplicatedVmNetworkInterface>>? networkInterfaces,
    required pulumi.Output<String> physicalServerCredentialName,
    required pulumi.Output<String> recoveryReplicationPolicyId,
    required pulumi.Output<String> recoveryVaultId,
    required pulumi.Output<String> sourceVmName,
    pulumi.Output<String>? targetAvailabilitySetId,
    pulumi.Output<String>? targetBootDiagnosticsStorageAccountId,
    ...
    required pulumi.Output<String> targetVmName,
    pulumi.Output<String>? targetVmSize,
    pulumi.Output<String>? targetZone,
    pulumi.Output<String>? testNetworkId,
  }) :
      applianceName = pulumi.Input.asInput<String>(applianceName),
      defaultLogStorageAccountId = pulumi.Input.asOptionalInput<String>(defaultLogStorageAccountId),
      defaultRecoveryDiskType = pulumi.Input.asOptionalInput<String>(defaultRecoveryDiskType),
      defaultTargetDiskEncryptionSetId = pulumi.Input.asOptionalInput<String>(defaultTargetDiskEncryptionSetId),
      licenseType = pulumi.Input.asOptionalInput<String>(licenseType),
      managedDisks = pulumi.Input.asOptionalInput<List<VmwareReplicatedVmManagedDisk>>(managedDisks),
      multiVmGroupName = pulumi.Input.asOptionalInput<String>(multiVmGroupName),
      name = pulumi.Input.asOptionalInput<String>(name),
      networkInterfaces = pulumi.Input.asOptionalInput<List<VmwareReplicatedVmNetworkInterface>>(networkInterfaces),
      physicalServerCredentialName = pulumi.Input.asInput<String>(physicalServerCredentialName),
      ...
      sourceVmName = pulumi.Input.asInput<String>(sourceVmName),
      targetAvailabilitySetId = pulumi.Input.asOptionalInput<String>(targetAvailabilitySetId),
      targetBootDiagnosticsStorageAccountId = pulumi.Input.asOptionalInput<String>(targetBootDiagnosticsStorageAccountId),
      ...
      targetVmName = pulumi.Input.asInput<String>(targetVmName),
      targetVmSize = pulumi.Input.asOptionalInput<String>(targetVmSize),
  ...
  factory VmwareReplicatedVmArgs.fromMap(Map<String, dynamic> map) {
    return VmwareReplicatedVmArgs(
      applianceName: pulumi.Output.create<String>(map['applianceName'] as String),
      defaultLogStorageAccountId: map['defaultLogStorageAccountId'] == null ? null : pulumi.Output.create<String>(map['defaultLogStorageAccountId'] as String),
      defaultRecoveryDiskType: map['defaultRecoveryDiskType'] == null ? null : pulumi.Output.create<String>(map['defaultRecoveryDiskType'] as String),
      defaultTargetDiskEncryptionSetId: map['defaultTargetDiskEncryptionSetId'] == null ? null : pulumi.Output.create<String>(map['defaultTargetDiskEncryptionSetId'] as String),
      licenseType: map['licenseType'] == null ? null : pulumi.Output.create<String>(map['licenseType'] as String),
      managedDisks: map['managedDisks'] == null ? null : pulumi.Output.create<List<VmwareReplicatedVmManagedDisk>>(pulumi.Input.decodeList<VmwareReplicatedVmManagedDisk>(map['managedDisks'], (value) => VmwareReplicatedVmManagedDisk.fromMap((value as Map).cast<String, dynamic>()))),
      multiVmGroupName: map['multiVmGroupName'] == null ? null : pulumi.Output.create<String>(map['multiVmGroupName'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Output.create<List<VmwareReplicatedVmNetworkInterface>>(pulumi.Input.decodeList<VmwareReplicatedVmNetworkInterface>(map['networkInterfaces'], (value) => VmwareReplicatedVmNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      physicalServerCredentialName: pulumi.Output.create<String>(map['physicalServerCredentialName'] as String),
      ...
      sourceVmName: pulumi.Output.create<String>(map['sourceVmName'] as String),
      ...
      targetBootDiagnosticsStorageAccountId: map['targetBootDiagnosticsStorageAccountId'] == null ? null : pulumi.Output.create<String>(map['targetBootDiagnosticsStorageAccountId'] as String),
      ...
      targetVmName: pulumi.Output.create<String>(map['targetVmName'] as String),
      targetVmSize: map['targetVmSize'] == null ? null : pulumi.Output.create<String>(map['targetVmSize'] as String),
