...
class ReplicatedVMState {
  ...
  factory ReplicatedVMState.fromMap(Map<String, dynamic> map) {
    return ReplicatedVMState(
      ...
      sourceRecoveryProtectionContainerName: (() { final guardedValue = map['sourceRecoveryProtectionContainerName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      targetRecoveryProtectionContainerId: (() { final guardedValue = map['targetRecoveryProtectionContainerId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
