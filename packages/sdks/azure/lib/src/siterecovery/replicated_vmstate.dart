...
class ReplicatedVMState {
  ...
  ReplicatedVMState({
    ...
    pulumi.Output<String>? sourceRecoveryProtectionContainerName,
    ...
    pulumi.Output<String>? targetRecoveryProtectionContainerId,
    ...
    pulumi.Output<List<ReplicatedVMUnmanagedDisk>>? unmanagedDisks,
      ...
      sourceRecoveryProtectionContainerName = pulumi.Input.asOptionalInput<String>(sourceRecoveryProtectionContainerName),
      ...
      targetRecoveryProtectionContainerId = pulumi.Input.asOptionalInput<String>(targetRecoveryProtectionContainerId),
  ...
  factory ReplicatedVMState.fromMap(Map<String, dynamic> map) {
    return ReplicatedVMState(
      ...
      sourceRecoveryProtectionContainerName: map['sourceRecoveryProtectionContainerName'] == null ? null : pulumi.Output.create<String>(map['sourceRecoveryProtectionContainerName'] as String),
      ...
      targetRecoveryProtectionContainerId: map['targetRecoveryProtectionContainerId'] == null ? null : pulumi.Output.create<String>(map['targetRecoveryProtectionContainerId'] as String),
