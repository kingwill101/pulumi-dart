...
class ReplicationRecoveryPlanFailoverRecoveryGroupPreAction {
  ...
  /// Creates a new [ReplicationRecoveryPlanFailoverRecoveryGroupPreAction].
  ...
  const ReplicationRecoveryPlanFailoverRecoveryGroupPreAction({
    this.fabricLocation,
  ...
  factory ReplicationRecoveryPlanFailoverRecoveryGroupPreAction.fromMap(Map<String, dynamic> map) {
    return ReplicationRecoveryPlanFailoverRecoveryGroupPreAction(
