...
class VmwareReplicatedVmState {
  ...
  /// Creates a new [VmwareReplicatedVmState].
  ...
  VmwareReplicatedVmState({
    ...
    pulumi.Output<String>? targetResourceGroupId,
    pulumi.Output<String>? targetVmName,
    ...
    pulumi.Output<String>? testNetworkId,
      ...
      physicalServerCredentialName = pulumi.Input.asOptionalInput<String>(physicalServerCredentialName),
      ...
      sourceVmName = pulumi.Input.asOptionalInput<String>(sourceVmName),
      ...
      targetResourceGroupId = pulumi.Input.asOptionalInput<String>(targetResourceGroupId),
      targetVmName = pulumi.Input.asOptionalInput<String>(targetVmName),
  ...
  factory VmwareReplicatedVmState.fromMap(Map<String, dynamic> map) {
    return VmwareReplicatedVmState(
      ...
      physicalServerCredentialName: map['physicalServerCredentialName'] == null ? null : pulumi.Output.create<String>(map['physicalServerCredentialName'] as String),
      ...
      sourceVmName: map['sourceVmName'] == null ? null : pulumi.Output.create<String>(map['sourceVmName'] as String),
      ...
      targetResourceGroupId: map['targetResourceGroupId'] == null ? null : pulumi.Output.create<String>(map['targetResourceGroupId'] as String),
      targetVmName: map['targetVmName'] == null ? null : pulumi.Output.create<String>(map['targetVmName'] as String),
