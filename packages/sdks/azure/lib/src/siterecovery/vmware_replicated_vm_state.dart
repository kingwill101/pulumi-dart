...
class VmwareReplicatedVmState {
  ...
  factory VmwareReplicatedVmState.fromMap(Map<String, dynamic> map) {
    return VmwareReplicatedVmState(
      ...
      physicalServerCredentialName: map['physicalServerCredentialName'] == null ? null : (map['physicalServerCredentialName'] as String).input(),
      ...
      sourceVmName: map['sourceVmName'] == null ? null : (map['sourceVmName'] as String).input(),
