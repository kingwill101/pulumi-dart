...
class ReplicationRecoveryPlanShutdownRecoveryGroup {
  ...
  final pulumi.Input<
    List<ReplicationRecoveryPlanShutdownRecoveryGroupPostAction>
  >?
  postActions;

  /// one or more `action` block as defined below. which will be executed before the group recovery.
  final pulumi.Input<
    List<ReplicationRecoveryPlanShutdownRecoveryGroupPreAction>
  >?
  preActions;
  ...
  factory ReplicationRecoveryPlanShutdownRecoveryGroup.fromMap(
      ...
      postActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ReplicationRecoveryPlanShutdownRecoveryGroupPostAction.fromMap(
      ...
      preActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ReplicationRecoveryPlanShutdownRecoveryGroupPreAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
