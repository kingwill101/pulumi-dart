...
class ReplicatedVMManagedDisk {
  ...
  final pulumi.Input<ReplicatedVMManagedDiskTargetDiskEncryption>?
    ...
    return <String, dynamic>{
      ...
      'targetDiskEncryption':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(targetDiskEncryption, (value) => value.toMap()),
  ...
  factory ReplicatedVMManagedDisk.fromMap(Map<String, dynamic> map) {
    return ReplicatedVMManagedDisk(
      ...
      targetDiskEncryption: (() {
        final guardedValue = map['targetDiskEncryption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReplicatedVMManagedDiskTargetDiskEncryption.fromMap(
      ...
      targetReplicaDiskType: pulumi.Input.fromValue(
        map['targetReplicaDiskType'] as String,
      ),
