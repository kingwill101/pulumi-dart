...
class ProtectionContainerMappingArgs {
  ...
  factory ProtectionContainerMappingArgs.fromMap(Map<String, dynamic> map) {
    return ProtectionContainerMappingArgs(
      ...
      recoverySourceProtectionContainerName: pulumi.Input.fromValue(
        map['recoverySourceProtectionContainerName'] as String,
      ),
      recoveryTargetProtectionContainerId: pulumi.Input.fromValue(
        map['recoveryTargetProtectionContainerId'] as String,
      ),
