...
class ReplicationRecoveryPlanFailoverRecoveryGroup {
  ...
  final pulumi.Input<
    List<ReplicationRecoveryPlanFailoverRecoveryGroupPostAction>
  >?
  postActions;

  /// one or more `action` block as defined below. which will be executed before the group recovery.
  final pulumi.Input<
    List<ReplicationRecoveryPlanFailoverRecoveryGroupPreAction>
  >?
  preActions;
  ...
  factory ReplicationRecoveryPlanFailoverRecoveryGroup.fromMap(
      ...
      postActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ReplicationRecoveryPlanFailoverRecoveryGroupPostAction.fromMap(
      ...
      preActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ReplicationRecoveryPlanFailoverRecoveryGroupPreAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
