...
class ReplicationRecoveryPlanArgs {
  ...
  factory ReplicationRecoveryPlanArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationRecoveryPlanArgs(
      ...
      shutdownRecoveryGroup: pulumi.Input.fromValue(
        ReplicationRecoveryPlanShutdownRecoveryGroup.fromMap(
          (map['shutdownRecoveryGroup']! as Map).cast<String, dynamic>(),
        ),
      ),
      sourceRecoveryFabricId: pulumi.Input.fromValue(
        map['sourceRecoveryFabricId'] as String,
      ),
