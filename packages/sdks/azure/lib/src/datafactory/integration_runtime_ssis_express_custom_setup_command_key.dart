...
class IntegrationRuntimeSsisExpressCustomSetupCommandKey {
  ...
  factory IntegrationRuntimeSsisExpressCustomSetupCommandKey.fromMap(Map<String, dynamic> map) {
    return IntegrationRuntimeSsisExpressCustomSetupCommandKey(
      keyVaultPassword: (() { final guardedValue = map['keyVaultPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntegrationRuntimeSsisExpressCustomSetupCommandKeyKeyVaultPassword.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
