...
class TriggerTumblingWindowState {
  ...
  TriggerTumblingWindowState({
    ...
    pulumi.Output<TriggerTumblingWindowPipeline>? pipeline,
    ...
    pulumi.Output<List<TriggerTumblingWindowTriggerDependency>>? triggerDependencies,
      ...
      pipeline = pulumi.Input.asOptionalInput<TriggerTumblingWindowPipeline>(pipeline),
  ...
  factory TriggerTumblingWindowState.fromMap(Map<String, dynamic> map) {
    return TriggerTumblingWindowState(
      ...
      pipeline: map['pipeline'] == null ? null : pulumi.Output.create<TriggerTumblingWindowPipeline>(TriggerTumblingWindowPipeline.fromMap((map['pipeline'] as Map).cast<String, dynamic>())),
