...
class DatasetPostgresqlState {
  ...
  factory DatasetPostgresqlState.fromMap(Map<String, dynamic> map) {
    return DatasetPostgresqlState(
      ...
      schemaColumns: (() { final guardedValue = map['schemaColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DatasetPostgresqlSchemaColumn>(guardedValue, (value) => DatasetPostgresqlSchemaColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
