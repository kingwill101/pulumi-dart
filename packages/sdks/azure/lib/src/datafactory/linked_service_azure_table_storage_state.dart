...
class LinkedServiceAzureTableStorageState {
  ...
  /// Creates a new [LinkedServiceAzureTableStorageState].
  ...
  const LinkedServiceAzureTableStorageState({
  ...
  factory LinkedServiceAzureTableStorageState.fromMap(Map<String, dynamic> map) {
    return LinkedServiceAzureTableStorageState(
