...
class DataFlowTransformation {
  ...
  factory DataFlowTransformation.fromMap(Map<String, dynamic> map) {
    return DataFlowTransformation(
      dataset: (() { final guardedValue = map['dataset']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataFlowTransformationDataset.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      flowlet: (() { final guardedValue = map['flowlet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataFlowTransformationFlowlet.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      linkedService: (() { final guardedValue = map['linkedService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataFlowTransformationLinkedService.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
