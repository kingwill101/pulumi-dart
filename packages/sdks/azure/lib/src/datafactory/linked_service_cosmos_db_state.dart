...
class LinkedServiceCosmosDbState {
  ...
  /// Creates a new [LinkedServiceCosmosDbState].
  ...
  const LinkedServiceCosmosDbState({
  ...
  factory LinkedServiceCosmosDbState.fromMap(Map<String, dynamic> map) {
    return LinkedServiceCosmosDbState(
