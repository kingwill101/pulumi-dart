...
class IntegrationRuntimeSsisProxy {
  ...
  factory IntegrationRuntimeSsisProxy.fromMap(Map<String, dynamic> map) {
    return IntegrationRuntimeSsisProxy(
      ...
      selfHostedIntegrationRuntimeName: pulumi.Input.fromValue(map['selfHostedIntegrationRuntimeName'] as String),
      stagingStorageLinkedServiceName: pulumi.Input.fromValue(map['stagingStorageLinkedServiceName'] as String),
    );
  }
}
