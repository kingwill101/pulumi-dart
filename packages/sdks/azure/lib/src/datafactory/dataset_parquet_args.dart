...
class DatasetParquetArgs {
  ...
  /// [azureBlobFsLocation] A `azureBlobFsLocation` block as defined below.
  ...
  factory DatasetParquetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetParquetArgs(
      ...
      azureBlobFsLocation: (() { final guardedValue = map['azureBlobFsLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasetParquetAzureBlobFsLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      azureBlobStorageLocation: (() { final guardedValue = map['azureBlobStorageLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasetParquetAzureBlobStorageLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpServerLocation: (() { final guardedValue = map['httpServerLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasetParquetHttpServerLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      schemaColumns: (() { final guardedValue = map['schemaColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DatasetParquetSchemaColumn>(guardedValue, (value) => DatasetParquetSchemaColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
