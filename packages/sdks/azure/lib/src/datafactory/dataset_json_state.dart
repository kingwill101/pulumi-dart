...
class DatasetJsonState {
  ...
  factory DatasetJsonState.fromMap(Map<String, dynamic> map) {
    return DatasetJsonState(
      ...
      azureBlobStorageLocation: (() { final guardedValue = map['azureBlobStorageLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasetJsonAzureBlobStorageLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpServerLocation: (() { final guardedValue = map['httpServerLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasetJsonHttpServerLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      schemaColumns: (() { final guardedValue = map['schemaColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DatasetJsonSchemaColumn>(guardedValue, (value) => DatasetJsonSchemaColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
