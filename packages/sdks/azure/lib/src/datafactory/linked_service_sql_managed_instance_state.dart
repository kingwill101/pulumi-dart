...
class LinkedServiceSqlManagedInstanceState {
  ...
  final pulumi.Input<LinkedServiceSqlManagedInstanceKeyVaultConnectionString>?
  ...
  final pulumi.Input<LinkedServiceSqlManagedInstanceKeyVaultPassword>?
  keyVaultPassword;
  ...
  factory LinkedServiceSqlManagedInstanceState.fromMap(
    ...
    return LinkedServiceSqlManagedInstanceState(
      ...
      keyVaultConnectionString: (() {
        ...
        return pulumi.Input.fromValue(
          LinkedServiceSqlManagedInstanceKeyVaultConnectionString.fromMap(
      ...
      keyVaultPassword: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceSqlManagedInstanceKeyVaultPassword.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
