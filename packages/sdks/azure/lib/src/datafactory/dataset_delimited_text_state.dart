...
class DatasetDelimitedTextState {
  ...
  final pulumi.Input<DatasetDelimitedTextAzureBlobFsLocation>?
  azureBlobFsLocation;

  /// An `azure_blob_storage_location` block as defined below.
  final pulumi.Input<DatasetDelimitedTextAzureBlobStorageLocation>?
  ...
  final pulumi.Input<DatasetDelimitedTextHttpServerLocation>?
  httpServerLocation;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schemaColumns':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatasetDelimitedTextSchemaColumn>,
  ...
  factory DatasetDelimitedTextState.fromMap(Map<String, dynamic> map) {
    return DatasetDelimitedTextState(
      ...
      azureBlobFsLocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetDelimitedTextAzureBlobFsLocation.fromMap(
      ...
      azureBlobStorageLocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetDelimitedTextAzureBlobStorageLocation.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      escapeCharacter: (() {
        final guardedValue = map['escapeCharacter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firstRowAsHeader: (() {
      ...
      httpServerLocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetDelimitedTextHttpServerLocation.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      schemaColumns: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatasetDelimitedTextSchemaColumn>(
            guardedValue,
