...
class IntegrationRuntimeSsisExpressCustomSetup {
  ...
  final pulumi.Input<List<IntegrationRuntimeSsisExpressCustomSetupCommandKey>>?
  commandKeys;

  /// One or more `component` blocks as defined below.
  final pulumi.Input<List<IntegrationRuntimeSsisExpressCustomSetupComponent>>?
  components;
    ...
    return <String, dynamic>{
      'commandKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<IntegrationRuntimeSsisExpressCustomSetupCommandKey>,
      ...
      'components':
          ?pulumi.Input.mapOptionalInputValue<
            List<IntegrationRuntimeSsisExpressCustomSetupComponent>,
            List<Map<String, dynamic>>
          >(
            components,
            (value) =>
  ...
  factory IntegrationRuntimeSsisExpressCustomSetup.fromMap(
    Map<String, dynamic> map,
  ) {
    return IntegrationRuntimeSsisExpressCustomSetup(
      commandKeys: (() {
        final guardedValue = map['commandKeys'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                IntegrationRuntimeSsisExpressCustomSetupCommandKey.fromMap(
      ...
      components: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                IntegrationRuntimeSsisExpressCustomSetupComponent.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
