...
class IntegrationRuntimeSelfHostedState {
  ...
  final pulumi.Input<List<IntegrationRuntimeSelfHostedRbacAuthorization>>?
  rbacAuthorizations;
    ...
    return <String, dynamic>{
      ...
      'rbacAuthorizations':
          ?pulumi.Input.mapOptionalInputValue<
            List<IntegrationRuntimeSelfHostedRbacAuthorization>,
  ...
  factory IntegrationRuntimeSelfHostedState.fromMap(Map<String, dynamic> map) {
    return IntegrationRuntimeSelfHostedState(
      ...
      primaryAuthorizationKey: (() {
        final guardedValue = map['primaryAuthorizationKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rbacAuthorizations: (() {
        final guardedValue = map['rbacAuthorizations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<IntegrationRuntimeSelfHostedRbacAuthorization>(
            guardedValue,
            (value) => IntegrationRuntimeSelfHostedRbacAuthorization.fromMap(
      ...
      secondaryAuthorizationKey: (() {
        final guardedValue = map['secondaryAuthorizationKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      selfContainedInteractiveAuthoringEnabled: (() {
