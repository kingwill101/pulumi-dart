...
class IntegrationRuntimeSelfHostedState {
  ...
  factory IntegrationRuntimeSelfHostedState.fromMap(Map<String, dynamic> map) {
    return IntegrationRuntimeSelfHostedState(
      ...
      primaryAuthorizationKey: (() { final guardedValue = map['primaryAuthorizationKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      secondaryAuthorizationKey: (() { final guardedValue = map['secondaryAuthorizationKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
