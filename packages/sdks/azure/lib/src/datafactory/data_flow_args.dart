...
class DataFlowArgs {
  ...
  DataFlowArgs({
    ...
    required pulumi.Output<List<DataFlowSink>> sinks,
    required pulumi.Output<List<DataFlowSource>> sources,
  ...
  factory DataFlowArgs.fromMap(Map<String, dynamic> map) {
    return DataFlowArgs(
      ...
      sinks: pulumi.Output.create<List<DataFlowSink>>(pulumi.Input.decodeList<DataFlowSink>(map['sinks'], (value) => DataFlowSink.fromMap((value as Map).cast<String, dynamic>()))),
      sources: pulumi.Output.create<List<DataFlowSource>>(pulumi.Input.decodeList<DataFlowSource>(map['sources'], (value) => DataFlowSource.fromMap((value as Map).cast<String, dynamic>()))),
