...
class LinkedServiceSqlManagedInstance extends pulumi.CustomResource {
  ...
  LinkedServiceSqlManagedInstance(
    ...
    this.keyVaultConnectionString = registerOutput<LinkedServiceSqlManagedInstanceKeyVaultConnectionString?>('keyVaultConnectionString');
    this.keyVaultPassword = registerOutput<LinkedServiceSqlManagedInstanceKeyVaultPassword?>('keyVaultPassword');
