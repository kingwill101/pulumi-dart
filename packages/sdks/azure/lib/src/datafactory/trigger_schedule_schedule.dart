...
class TriggerScheduleSchedule {
  ...
  factory TriggerScheduleSchedule.fromMap(Map<String, dynamic> map) {
    return TriggerScheduleSchedule(
      ...
      monthlies: (() { final guardedValue = map['monthlies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TriggerScheduleScheduleMonthly>(guardedValue, (value) => TriggerScheduleScheduleMonthly.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
