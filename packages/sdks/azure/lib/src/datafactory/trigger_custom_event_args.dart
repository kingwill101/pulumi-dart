...
class TriggerCustomEventArgs {
  ...
  factory TriggerCustomEventArgs.fromMap(Map<String, dynamic> map) {
    return TriggerCustomEventArgs(
      ...
      eventgridTopicId: pulumi.Input.fromValue(map['eventgridTopicId'] as String),
      events: pulumi.Input.fromValue((map['events'] as List).cast<String>()),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pipelines: pulumi.Input.fromValue(pulumi.Input.decodeList<TriggerCustomEventPipeline>(map['pipelines']!, (value) => TriggerCustomEventPipeline.fromMap((value as Map).cast<String, dynamic>()))),
