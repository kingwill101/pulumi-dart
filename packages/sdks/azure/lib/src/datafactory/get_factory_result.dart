...
class GetFactoryResult {
    ...
    return <String, dynamic>{
      'githubConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(githubConfigurations, (value) => value.toMap()),
      'id': id,
      'identities':
          pulumi.Input.encodeList<GetFactoryIdentity, Map<String, dynamic>>(
            identities,
            (value) => value.toMap(),
          ),
      'location': location,
      ...
      'vstsConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(vstsConfigurations, (value) => value.toMap()),
    };
  }
  ...
  factory GetFactoryResult.fromMap(Map<String, dynamic> map) {
    return GetFactoryResult(
      githubConfigurations:
          pulumi.Input.decodeList<GetFactoryGithubConfiguration>(
            map['githubConfigurations']!,
            (value) => GetFactoryGithubConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetFactoryIdentity>(
        map['identities']!,
        (value) =>
            GetFactoryIdentity.fromMap((value as Map).cast<String, dynamic>()),
      ),
      location: map['location'] as String,
      name: map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      vstsConfigurations: pulumi.Input.decodeList<GetFactoryVstsConfiguration>(
        map['vstsConfigurations']!,
        (value) => GetFactoryVstsConfiguration.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
    );
