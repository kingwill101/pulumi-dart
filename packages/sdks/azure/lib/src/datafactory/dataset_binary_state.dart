...
class DatasetBinaryState {
  ...
  final pulumi.Input<DatasetBinaryAzureBlobStorageLocation>?
    ...
    return <String, dynamic>{
      ...
      'sftpServerLocation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sftpServerLocation, (value) => value.toMap()),
    };
  }
  ...
  factory DatasetBinaryState.fromMap(Map<String, dynamic> map) {
    return DatasetBinaryState(
      ...
      azureBlobStorageLocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetBinaryAzureBlobStorageLocation.fromMap(
      ...
      compression: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetBinaryCompression.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      httpServerLocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetBinaryHttpServerLocation.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sftpServerLocation: (() {
        final guardedValue = map['sftpServerLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetBinarySftpServerLocation.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
