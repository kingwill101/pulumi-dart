...
class IntegrationRuntimeSsisCatalogInfo {
  ...
  final pulumi.Input<String> serverEndpoint;
  ...
  /// [elasticPoolName] The name of SQL elastic pool where the database will be created for the SSIS catalog. Mutually exclusive with `pricingTier`.
  ...
  factory IntegrationRuntimeSsisCatalogInfo.fromMap(Map<String, dynamic> map) {
    return IntegrationRuntimeSsisCatalogInfo(
      ...
      pricingTier: (() { final guardedValue = map['pricingTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serverEndpoint: pulumi.Input.fromValue(map['serverEndpoint'] as String),
    );
  }
}
