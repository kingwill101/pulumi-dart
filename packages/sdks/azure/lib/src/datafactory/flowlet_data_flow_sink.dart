...
class FlowletDataFlowSink {
  ...
  final pulumi.Input<FlowletDataFlowSinkRejectedLinkedService>?
  rejectedLinkedService;

  /// A `schema_linked_service` block as defined below.
  final pulumi.Input<FlowletDataFlowSinkSchemaLinkedService>?
  schemaLinkedService;
    ...
    return FlowletDataFlowSink(
      dataset: (() {
        ...
        return pulumi.Input.fromValue(
          FlowletDataFlowSinkDataset.fromMap(
      ...
      flowlet: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSinkFlowlet.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      linkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSinkLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rejectedLinkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSinkRejectedLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      schemaLinkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSinkSchemaLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
