...
class LinkedServiceSqlServerState {
  ...
  final pulumi.Input<LinkedServiceSqlServerKeyVaultConnectionString>?
  ...
  factory LinkedServiceSqlServerState.fromMap(Map<String, dynamic> map) {
    return LinkedServiceSqlServerState(
      ...
      keyVaultConnectionString: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceSqlServerKeyVaultConnectionString.fromMap(
      ...
      keyVaultPassword: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceSqlServerKeyVaultPassword.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
