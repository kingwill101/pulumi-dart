...
class LinkedServiceSftpArgs {
  ...
  LinkedServiceSftpArgs({
    ...
    pulumi.Output<List<LinkedServiceSftpKeyVaultPassword>>? keyVaultPasswords,
    pulumi.Output<LinkedServiceSftpKeyVaultPrivateKeyContentBase64>? keyVaultPrivateKeyContentBase64,
    pulumi.Output<LinkedServiceSftpKeyVaultPrivateKeyPassphrase>? keyVaultPrivateKeyPassphrase,
    pulumi.Output<String>? name,
    pulumi.Output<Map<String, String>>? parameters,
    pulumi.Output<String>? password,
    required pulumi.Output<int> port,
    pulumi.Output<String>? privateKeyContentBase64,
    pulumi.Output<String>? privateKeyPassphrase,
    pulumi.Output<String>? privateKeyPath,
    pulumi.Output<bool>? skipHostKeyValidation,
  ...
  factory LinkedServiceSftpArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceSftpArgs(
      ...
      keyVaultPasswords: map['keyVaultPasswords'] == null ? null : pulumi.Output.create<List<LinkedServiceSftpKeyVaultPassword>>(pulumi.Input.decodeList<LinkedServiceSftpKeyVaultPassword>(map['keyVaultPasswords'], (value) => LinkedServiceSftpKeyVaultPassword.fromMap((value as Map).cast<String, dynamic>()))),
      keyVaultPrivateKeyContentBase64: map['keyVaultPrivateKeyContentBase64'] == null ? null : pulumi.Output.create<LinkedServiceSftpKeyVaultPrivateKeyContentBase64>(LinkedServiceSftpKeyVaultPrivateKeyContentBase64.fromMap((map['keyVaultPrivateKeyContentBase64'] as Map).cast<String, dynamic>())),
      keyVaultPrivateKeyPassphrase: map['keyVaultPrivateKeyPassphrase'] == null ? null : pulumi.Output.create<LinkedServiceSftpKeyVaultPrivateKeyPassphrase>(LinkedServiceSftpKeyVaultPrivateKeyPassphrase.fromMap((map['keyVaultPrivateKeyPassphrase'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      parameters: map['parameters'] == null ? null : pulumi.Output.create<Map<String, String>>((map['parameters'] as Map).cast<String, String>()),
      password: map['password'] == null ? null : pulumi.Output.create<String>(map['password'] as String),
      port: pulumi.Output.create<int>(map['port'] as int),
      privateKeyContentBase64: map['privateKeyContentBase64'] == null ? null : pulumi.Output.create<String>(map['privateKeyContentBase64'] as String),
      privateKeyPassphrase: map['privateKeyPassphrase'] == null ? null : pulumi.Output.create<String>(map['privateKeyPassphrase'] as String),
      privateKeyPath: map['privateKeyPath'] == null ? null : pulumi.Output.create<String>(map['privateKeyPath'] as String),
      skipHostKeyValidation: map['skipHostKeyValidation'] == null ? null : pulumi.Output.create<bool>(map['skipHostKeyValidation'] as bool),
