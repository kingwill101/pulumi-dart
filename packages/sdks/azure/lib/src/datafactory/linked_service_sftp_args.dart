...
class LinkedServiceSftpArgs {
  ...
  factory LinkedServiceSftpArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceSftpArgs(
      ...
      keyVaultPasswords: map['keyVaultPasswords'] == null ? null : (pulumi.Input.decodeList<LinkedServiceSftpKeyVaultPassword>(map['keyVaultPasswords']!, (value) => LinkedServiceSftpKeyVaultPassword.fromMap((value as Map).cast<String, dynamic>()))).input(),
      keyVaultPrivateKeyContentBase64: map['keyVaultPrivateKeyContentBase64'] == null ? null : (LinkedServiceSftpKeyVaultPrivateKeyContentBase64.fromMap((map['keyVaultPrivateKeyContentBase64']! as Map).cast<String, dynamic>())).input(),
      keyVaultPrivateKeyPassphrase: map['keyVaultPrivateKeyPassphrase'] == null ? null : (LinkedServiceSftpKeyVaultPrivateKeyPassphrase.fromMap((map['keyVaultPrivateKeyPassphrase']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      parameters: map['parameters'] == null ? null : ((map['parameters']! as Map).cast<String, String>()).input(),
      password: map['password'] == null ? null : (map['password']! as String).input(),
      port: (map['port'] as int).input(),
      privateKeyContentBase64: map['privateKeyContentBase64'] == null ? null : (map['privateKeyContentBase64']! as String).input(),
      privateKeyPassphrase: map['privateKeyPassphrase'] == null ? null : (map['privateKeyPassphrase']! as String).input(),
      privateKeyPath: map['privateKeyPath'] == null ? null : (map['privateKeyPath']! as String).input(),
      skipHostKeyValidation: map['skipHostKeyValidation'] == null ? null : (map['skipHostKeyValidation']! as bool).input(),
