...
class FactoryState {
    ...
    return <String, dynamic>{
      ...
      'githubConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(githubConfiguration, (value) => value.toMap()),
      'globalParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<FactoryGlobalParameter>,
      ...
      'vstsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(vstsConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory FactoryState.fromMap(Map<String, dynamic> map) {
    return FactoryState(
      ...
      customerManagedKeyIdentityId: (() {
        final guardedValue = map['customerManagedKeyIdentityId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      githubConfiguration: (() {
        final guardedValue = map['githubConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FactoryGithubConfiguration.fromMap(
      ...
      globalParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FactoryGlobalParameter>(
            guardedValue,
            (value) => FactoryGlobalParameter.fromMap(
      ...
      vstsConfiguration: (() {
        final guardedValue = map['vstsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FactoryVstsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
