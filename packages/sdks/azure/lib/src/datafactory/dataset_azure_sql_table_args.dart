...
class DatasetAzureSqlTableArgs {
    ...
    return <String, dynamic>{
      ...
      'schemaColumns':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatasetAzureSqlTableSchemaColumn>,
  ...
  factory DatasetAzureSqlTableArgs.fromMap(Map<String, dynamic> map) {
    return DatasetAzureSqlTableArgs(
      ...
      linkedServiceId: pulumi.Input.fromValue(map['linkedServiceId'] as String),
      name: (() {
      ...
      schemaColumns: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatasetAzureSqlTableSchemaColumn>(
            guardedValue,
            (value) => DatasetAzureSqlTableSchemaColumn.fromMap(
