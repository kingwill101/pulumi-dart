...
import 'linked_service_key_vault_args.dart';
import 'linked_service_key_vault_state.dart';
...
class LinkedServiceKeyVault extends pulumi.CustomResource {
  ...
  /// Creates a new [LinkedServiceKeyVault].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LinkedServiceKeyVault]. {@macro pulumi_datafactory_linked_service_key_vault_linked_service_key_vault_args_doc}
  ...
  /// Gets an existing [LinkedServiceKeyVault] resource's state with the given [name] and [id].
  static LinkedServiceKeyVault get(
    String name,
    pulumi.Input<String> id, {
    LinkedServiceKeyVaultState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return LinkedServiceKeyVault._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [LinkedServiceKeyVault] resource.
  LinkedServiceKeyVault.reference(String urn)
    : super(
        'azure:datafactory/linkedServiceKeyVault:LinkedServiceKeyVault',
