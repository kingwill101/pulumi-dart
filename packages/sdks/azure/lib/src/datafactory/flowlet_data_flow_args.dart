...
class FlowletDataFlowArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'transformations':
          ?pulumi.Input.mapOptionalInputValue<
            List<FlowletDataFlowTransformation>,
            List<Map<String, dynamic>>
          >(
            transformations_,
            (value) =>
    ...
    return FlowletDataFlowArgs(
      ...
      sinks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FlowletDataFlowSink>(
            guardedValue,
            (value) => FlowletDataFlowSink.fromMap(
      ...
      sources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FlowletDataFlowSource>(
            guardedValue,
            (value) => FlowletDataFlowSource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      transformations_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FlowletDataFlowTransformation>(
            guardedValue,
            (value) => FlowletDataFlowTransformation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
