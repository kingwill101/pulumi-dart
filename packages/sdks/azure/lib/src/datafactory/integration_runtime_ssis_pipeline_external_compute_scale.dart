...
class IntegrationRuntimeSsisPipelineExternalComputeScale {
  ...
  factory IntegrationRuntimeSsisPipelineExternalComputeScale.fromMap(
    Map<String, dynamic> map,
  ) {
    return IntegrationRuntimeSsisPipelineExternalComputeScale(
      numberOfExternalNodes: (() {
        final guardedValue = map['numberOfExternalNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      numberOfPipelineNodes: (() {
        final guardedValue = map['numberOfPipelineNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      timeToLive: (() {
