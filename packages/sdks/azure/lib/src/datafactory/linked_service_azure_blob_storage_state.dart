...
class LinkedServiceAzureBlobStorageState {
  ...
  final pulumi.Input<LinkedServiceAzureBlobStorageKeyVaultSasToken>?
  keyVaultSasToken;
  ...
  final pulumi.Input<LinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKey>?
    ...
    return <String, dynamic>{
      ...
      'keyVaultSasToken':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(keyVaultSasToken, (value) => value.toMap()),
      'name': ?name,
      ...
      'sasTokenLinkedKeyVaultKey':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sasTokenLinkedKeyVaultKey, (value) => value.toMap()),
      'sasUri': ?sasUri,
      ...
      'servicePrincipalLinkedKeyVaultKey':
          ?pulumi.Input.mapOptionalInputValue<
            LinkedServiceAzureBlobStorageServicePrincipalLinkedKeyVaultKey,
            Map<String, dynamic>
          >(servicePrincipalLinkedKeyVaultKey, (value) => value.toMap()),
  ...
  factory LinkedServiceAzureBlobStorageState.fromMap(Map<String, dynamic> map) {
    return LinkedServiceAzureBlobStorageState(
      ...
      connectionStringInsecure: (() {
        final guardedValue = map['connectionStringInsecure'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataFactoryId: (() {
      ...
      keyVaultSasToken: (() {
        final guardedValue = map['keyVaultSasToken'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceAzureBlobStorageKeyVaultSasToken.fromMap(
      ...
      sasTokenLinkedKeyVaultKey: (() {
        final guardedValue = map['sasTokenLinkedKeyVaultKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceAzureBlobStorageSasTokenLinkedKeyVaultKey.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      servicePrincipalLinkedKeyVaultKey: (() {
        final guardedValue = map['servicePrincipalLinkedKeyVaultKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceAzureBlobStorageServicePrincipalLinkedKeyVaultKey.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      storageKind: (() {
        final guardedValue = map['storageKind'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tenantId: (() {
