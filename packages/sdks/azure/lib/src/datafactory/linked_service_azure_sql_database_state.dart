...
class LinkedServiceAzureSqlDatabaseState {
  ...
  final pulumi.Input<LinkedServiceAzureSqlDatabaseKeyVaultConnectionString>?
  ...
  final pulumi.Input<LinkedServiceAzureSqlDatabaseKeyVaultPassword>?
  keyVaultPassword;
    ...
    return <String, dynamic>{
      ...
      'keyVaultConnectionString':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(keyVaultConnectionString, (value) => value.toMap()),
      'keyVaultPassword':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory LinkedServiceAzureSqlDatabaseState.fromMap(Map<String, dynamic> map) {
    return LinkedServiceAzureSqlDatabaseState(
      ...
      keyVaultConnectionString: (() {
        final guardedValue = map['keyVaultConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceAzureSqlDatabaseKeyVaultConnectionString.fromMap(
      ...
      keyVaultPassword: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinkedServiceAzureSqlDatabaseKeyVaultPassword.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
