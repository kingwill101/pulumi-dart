...
class LinkedServiceAzureDatabricksArgs {
  ...
  factory LinkedServiceAzureDatabricksArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceAzureDatabricksArgs(
      ...
      adbDomain: pulumi.Input.fromValue(map['adbDomain'] as String),
      ...
      existingClusterId: (() { final guardedValue = map['existingClusterId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instancePool: (() { final guardedValue = map['instancePool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinkedServiceAzureDatabricksInstancePool.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      keyVaultPassword: (() { final guardedValue = map['keyVaultPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinkedServiceAzureDatabricksKeyVaultPassword.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      msiWorkSpaceResourceId: (() { final guardedValue = map['msiWorkSpaceResourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      msiWorkspaceId: (() { final guardedValue = map['msiWorkspaceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      newClusterConfig: (() { final guardedValue = map['newClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinkedServiceAzureDatabricksNewClusterConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
