...
class DataFlowSource {
  ...
  final pulumi.Input<DataFlowSourceRejectedLinkedService>?
  ...
  factory DataFlowSource.fromMap(Map<String, dynamic> map) {
    return DataFlowSource(
      ...
      linkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataFlowSourceLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rejectedLinkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataFlowSourceRejectedLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      schemaLinkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataFlowSourceSchemaLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
