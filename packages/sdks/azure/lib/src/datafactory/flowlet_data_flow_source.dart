...
class FlowletDataFlowSource {
  ...
  final pulumi.Input<FlowletDataFlowSourceRejectedLinkedService>?
  rejectedLinkedService;

  /// A `schema_linked_service` block as defined below.
  final pulumi.Input<FlowletDataFlowSourceSchemaLinkedService>?
  schemaLinkedService;
    ...
    return FlowletDataFlowSource(
      dataset: (() {
        ...
        return pulumi.Input.fromValue(
          FlowletDataFlowSourceDataset.fromMap(
      ...
      flowlet: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSourceFlowlet.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      linkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSourceLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rejectedLinkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSourceRejectedLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      schemaLinkedService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowletDataFlowSourceSchemaLinkedService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
