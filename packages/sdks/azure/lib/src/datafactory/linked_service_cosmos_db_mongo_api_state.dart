...
class LinkedServiceCosmosDbMongoApiState {
  ...
  const LinkedServiceCosmosDbMongoApiState({
  ...
  factory LinkedServiceCosmosDbMongoApiState.fromMap(Map<String, dynamic> map) {
    return LinkedServiceCosmosDbMongoApiState(
      ...
      serverVersionIs32OrHigher: (() { final guardedValue = map['serverVersionIs32OrHigher']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
