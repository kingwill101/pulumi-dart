...
class JobArgs {
  ...
  /// [jobStorageAccounts] The details of the job storage account. A `jobStorageAccount` block as defined below.
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      eventsLateArrivalMaxDelayInSeconds: (() { final guardedValue = map['eventsLateArrivalMaxDelayInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      eventsOutOfOrderMaxDelayInSeconds: (() { final guardedValue = map['eventsOutOfOrderMaxDelayInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      jobStorageAccounts: (() { final guardedValue = map['jobStorageAccounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JobJobStorageAccount>(guardedValue, (value) => JobJobStorageAccount.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      streamAnalyticsClusterId: (() { final guardedValue = map['streamAnalyticsClusterId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      streamingUnits: (() { final guardedValue = map['streamingUnits']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      transformationQuery: pulumi.Input.fromValue(map['transformationQuery'] as String),
