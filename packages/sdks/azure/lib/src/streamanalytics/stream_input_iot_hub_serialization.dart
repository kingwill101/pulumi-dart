...
class StreamInputIotHubSerialization {
  ...
  /// Creates a new [StreamInputIotHubSerialization].
  ...
  const StreamInputIotHubSerialization({
    this.encoding,
    this.fieldDelimiter,
    required this.type,
  });
  ...
  factory StreamInputIotHubSerialization.fromMap(Map<String, dynamic> map) {
    return StreamInputIotHubSerialization(
