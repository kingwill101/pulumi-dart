...
class FunctionJavascriptUdaState {
  ...
  factory FunctionJavascriptUdaState.fromMap(Map<String, dynamic> map) {
    return FunctionJavascriptUdaState(
      inputs: (() { final guardedValue = map['inputs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FunctionJavascriptUdaInput>(guardedValue, (value) => FunctionJavascriptUdaInput.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      output: (() { final guardedValue = map['output']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionJavascriptUdaOutput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
