...
class OutputEventHubState {
  ...
  factory OutputEventHubState.fromMap(Map<String, dynamic> map) {
    return OutputEventHubState(
      ...
      serialization: (() { final guardedValue = map['serialization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OutputEventHubSerialization.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
