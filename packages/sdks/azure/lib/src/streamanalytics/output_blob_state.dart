...
class OutputBlobState {
  ...
  factory OutputBlobState.fromMap(Map<String, dynamic> map) {
    return OutputBlobState(
      ...
      serialization: (() { final guardedValue = map['serialization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OutputBlobSerialization.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
