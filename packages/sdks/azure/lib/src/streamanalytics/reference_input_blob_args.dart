...
class ReferenceInputBlobArgs {
  ...
  ReferenceInputBlobArgs({
    ...
    required pulumi.Output<ReferenceInputBlobSerialization> serialization,
  ...
  factory ReferenceInputBlobArgs.fromMap(Map<String, dynamic> map) {
    return ReferenceInputBlobArgs(
      ...
      serialization: pulumi.Output.create<ReferenceInputBlobSerialization>(ReferenceInputBlobSerialization.fromMap((map['serialization'] as Map).cast<String, dynamic>())),
