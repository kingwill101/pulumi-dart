...
class FunctionJavaScriptUDFArgs {
  ...
  factory FunctionJavaScriptUDFArgs.fromMap(Map<String, dynamic> map) {
    return FunctionJavaScriptUDFArgs(
      inputs: pulumi.Input.fromValue(pulumi.Input.decodeList<FunctionJavaScriptUDFInput>(map['inputs']!, (value) => FunctionJavaScriptUDFInput.fromMap((value as Map).cast<String, dynamic>()))),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      output: pulumi.Input.fromValue(FunctionJavaScriptUDFOutput.fromMap((map['output']! as Map).cast<String, dynamic>())),
