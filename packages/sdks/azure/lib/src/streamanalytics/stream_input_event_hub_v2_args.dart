...
class StreamInputEventHubV2Args {
  ...
  const StreamInputEventHubV2Args({
  ...
  factory StreamInputEventHubV2Args.fromMap(Map<String, dynamic> map) {
    return StreamInputEventHubV2Args(
      ...
      serialization: pulumi.Input.fromValue(StreamInputEventHubV2Serialization.fromMap((map['serialization']! as Map).cast<String, dynamic>())),
