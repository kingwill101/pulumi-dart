...
class ReferenceInputBlobState {
  ...
  /// [storageAccountKey] The Access Key which should be used to connect to this Storage Account. Required if `authenticationMode` is `ConnectionString`.
  ...
  factory ReferenceInputBlobState.fromMap(Map<String, dynamic> map) {
    return ReferenceInputBlobState(
      ...
      serialization: (() { final guardedValue = map['serialization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReferenceInputBlobSerialization.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
