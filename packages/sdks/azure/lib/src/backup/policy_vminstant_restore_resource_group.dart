...
class PolicyVMInstantRestoreResourceGroup {
  ...
  PolicyVMInstantRestoreResourceGroup({required this.prefix, this.suffix});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'prefix': prefix, 'suffix': ?suffix};
  }

  factory PolicyVMInstantRestoreResourceGroup.fromMap(
