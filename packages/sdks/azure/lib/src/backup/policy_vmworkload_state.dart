...
class PolicyVMWorkloadState {
  ...
  final pulumi.Input<List<PolicyVMWorkloadProtectionPolicy>>?
  protectionPolicies;
    ...
    return <String, dynamic>{
      ...
      'protectionPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyVMWorkloadProtectionPolicy>,
  ...
  factory PolicyVMWorkloadState.fromMap(Map<String, dynamic> map) {
    return PolicyVMWorkloadState(
      ...
      protectionPolicies: (() {
        final guardedValue = map['protectionPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyVMWorkloadProtectionPolicy>(
            guardedValue,
            (value) => PolicyVMWorkloadProtectionPolicy.fromMap(
      ...
      settings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyVMWorkloadSettings.fromMap(
