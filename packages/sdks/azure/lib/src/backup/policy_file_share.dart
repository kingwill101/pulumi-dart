...
import 'policy_file_share_state.dart';
...
class PolicyFileShare extends pulumi.CustomResource {
  ...
  /// Gets an existing [PolicyFileShare] resource's state with the given [name] and [id].
  static PolicyFileShare get(
    String name,
