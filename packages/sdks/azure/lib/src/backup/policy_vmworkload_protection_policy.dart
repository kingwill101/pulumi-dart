...
class PolicyVMWorkloadProtectionPolicy {
  ...
  final pulumi.Input<PolicyVMWorkloadProtectionPolicyRetentionDaily>?
  retentionDaily;

  /// A `retention_monthly` block as defined below.
  final pulumi.Input<PolicyVMWorkloadProtectionPolicyRetentionMonthly>?
  retentionMonthly;

  /// A `retention_weekly` block as defined below.
  final pulumi.Input<PolicyVMWorkloadProtectionPolicyRetentionWeekly>?
  retentionWeekly;

  /// A `retention_yearly` block as defined below.
  final pulumi.Input<PolicyVMWorkloadProtectionPolicyRetentionYearly>?
  retentionYearly;

  /// A `simple_retention` block as defined below.
  final pulumi.Input<PolicyVMWorkloadProtectionPolicySimpleRetention>?
  simpleRetention;
    ...
    return <String, dynamic>{
      ...
      'simpleRetention':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(simpleRetention, (value) => value.toMap()),
    };
  }
  ...
  factory PolicyVMWorkloadProtectionPolicy.fromMap(Map<String, dynamic> map) {
    return PolicyVMWorkloadProtectionPolicy(
      backup: pulumi.Input.fromValue(
        PolicyVMWorkloadProtectionPolicyBackup.fromMap(
          (map['backup']! as Map).cast<String, dynamic>(),
        ),
      ),
      policyType: pulumi.Input.fromValue(map['policyType'] as String),
      retentionDaily: (() {
        final guardedValue = map['retentionDaily'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyVMWorkloadProtectionPolicyRetentionDaily.fromMap(
      ...
      retentionMonthly: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyVMWorkloadProtectionPolicyRetentionMonthly.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      retentionWeekly: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyVMWorkloadProtectionPolicyRetentionWeekly.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      retentionYearly: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyVMWorkloadProtectionPolicyRetentionYearly.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      simpleRetention: (() {
        final guardedValue = map['simpleRetention'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyVMWorkloadProtectionPolicySimpleRetention.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
