...
class FrontdoorArgs {
  ...
  factory FrontdoorArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorArgs(
      backendPoolHealthProbes: pulumi.Input.fromValue(pulumi.Input.decodeList<FrontdoorBackendPoolHealthProbe>(map['backendPoolHealthProbes']!, (value) => FrontdoorBackendPoolHealthProbe.fromMap((value as Map).cast<String, dynamic>()))),
      backendPoolLoadBalancings: pulumi.Input.fromValue(pulumi.Input.decodeList<FrontdoorBackendPoolLoadBalancing>(map['backendPoolLoadBalancings']!, (value) => FrontdoorBackendPoolLoadBalancing.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      backendPools: pulumi.Input.fromValue(pulumi.Input.decodeList<FrontdoorBackendPool>(map['backendPools']!, (value) => FrontdoorBackendPool.fromMap((value as Map).cast<String, dynamic>()))),
      friendlyName: (() { final guardedValue = map['friendlyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      frontendEndpoints: pulumi.Input.fromValue(pulumi.Input.decodeList<FrontdoorFrontendEndpoint>(map['frontendEndpoints']!, (value) => FrontdoorFrontendEndpoint.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      routingRules: pulumi.Input.fromValue(pulumi.Input.decodeList<FrontdoorRoutingRule>(map['routingRules']!, (value) => FrontdoorRoutingRule.fromMap((value as Map).cast<String, dynamic>()))),
