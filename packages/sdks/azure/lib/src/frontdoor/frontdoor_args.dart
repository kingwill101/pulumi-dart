...
class FrontdoorArgs {
  ...
  factory FrontdoorArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorArgs(
      ...
      backendPools: pulumi.Input.fromValue(
      ...
      routingRules: pulumi.Input.fromValue(
