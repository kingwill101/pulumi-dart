...
class FirewallPolicyManagedRuleOverride {
  ...
  final pulumi.Input<List<FirewallPolicyManagedRuleOverrideExclusion>>?
  exclusions;
    ...
    return <String, dynamic>{
      'exclusions':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyManagedRuleOverrideExclusion>,
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyManagedRuleOverrideRule>,
            List<Map<String, dynamic>>
          >(
            rules,
            (value) =>
    ...
    return FirewallPolicyManagedRuleOverride(
      exclusions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyManagedRuleOverrideExclusion>(
            guardedValue,
            (value) => FirewallPolicyManagedRuleOverrideExclusion.fromMap(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyManagedRuleOverrideRule>(
            guardedValue,
            (value) => FirewallPolicyManagedRuleOverrideRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
