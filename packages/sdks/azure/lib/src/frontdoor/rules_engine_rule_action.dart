...
class RulesEngineRuleAction {
  ...
  factory RulesEngineRuleAction.fromMap(Map<String, dynamic> map) {
    return RulesEngineRuleAction(
      requestHeaders: (() { final guardedValue = map['requestHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RulesEngineRuleActionRequestHeader>(guardedValue, (value) => RulesEngineRuleActionRequestHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      responseHeaders: (() { final guardedValue = map['responseHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RulesEngineRuleActionResponseHeader>(guardedValue, (value) => RulesEngineRuleActionResponseHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
