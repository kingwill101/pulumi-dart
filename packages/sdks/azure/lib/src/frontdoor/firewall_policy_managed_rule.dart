    ...
    return <String, dynamic>{
      'exclusions':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyManagedRuleExclusion>,
      ...
      'overrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyManagedRuleOverride>,
            List<Map<String, dynamic>>
          >(
            overrides,
            (value) =>
    ...
    return FirewallPolicyManagedRule(
      exclusions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyManagedRuleExclusion>(
            guardedValue,
            (value) => FirewallPolicyManagedRuleExclusion.fromMap(
      ...
      overrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyManagedRuleOverride>(
            guardedValue,
            (value) => FirewallPolicyManagedRuleOverride.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
