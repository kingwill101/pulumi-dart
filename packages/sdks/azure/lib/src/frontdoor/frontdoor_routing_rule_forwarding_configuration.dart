...
class FrontdoorRoutingRuleForwardingConfiguration {
  ...
  /// [cacheDuration] Specify the minimum caching duration (in ISO8601 notation e.g. `P1DT2H` for 1 day and 2 hours). Needs to be greater than 0 and smaller than 365 days. `cacheDuration` works only in combination with `cacheEnabled` set to `true`.
  ...
  /// [cacheQueryParameters] Specify query parameters (array). Works only in combination with `cacheQueryParameterStripDirective` set to `StripAllExcept` or `StripOnly`.
  ...
  factory FrontdoorRoutingRuleForwardingConfiguration.fromMap(Map<String, dynamic> map) {
    return FrontdoorRoutingRuleForwardingConfiguration(
      ...
      cacheQueryParameterStripDirective: (() { final guardedValue = map['cacheQueryParameterStripDirective']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cacheQueryParameters: (() { final guardedValue = map['cacheQueryParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      cacheUseDynamicCompression: (() { final guardedValue = map['cacheUseDynamicCompression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
