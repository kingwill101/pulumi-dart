...
class RulesEngineRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchConditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<RulesEngineRuleMatchCondition>,
  ...
  factory RulesEngineRule.fromMap(Map<String, dynamic> map) {
    return RulesEngineRule(
      ...
      matchConditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RulesEngineRuleMatchCondition>(
            guardedValue,
            (value) => RulesEngineRuleMatchCondition.fromMap(
