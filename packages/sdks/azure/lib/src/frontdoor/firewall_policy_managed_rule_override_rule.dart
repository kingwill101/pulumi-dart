...
class FirewallPolicyManagedRuleOverrideRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action,
      'enabled': ?enabled,
      'exclusions': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyManagedRuleOverrideRuleExclusion>, List<Map<String, dynamic>>>(exclusions, (value) => pulumi.Input.encodeList<FirewallPolicyManagedRuleOverrideRuleExclusion, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ruleId': ruleId,
    };
  }
  ...
  factory FirewallPolicyManagedRuleOverrideRule.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyManagedRuleOverrideRule(
      ...
      exclusions: (() { final guardedValue = map['exclusions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyManagedRuleOverrideRuleExclusion>(guardedValue, (value) => FirewallPolicyManagedRuleOverrideRuleExclusion.fromMap((value as Map).cast<String, dynamic>()))); })(),
