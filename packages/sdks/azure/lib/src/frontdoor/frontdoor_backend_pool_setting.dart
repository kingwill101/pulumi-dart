...
class FrontdoorBackendPoolSetting {
  ...
  final int? backendPoolsSendReceiveTimeoutSeconds;
  ...
  final bool enforceBackendPoolsCertificateNameCheck;
  ...
  factory FrontdoorBackendPoolSetting.fromMap(Map<String, dynamic> map) {
    return FrontdoorBackendPoolSetting(
      backendPoolsSendReceiveTimeoutSeconds: map['backendPoolsSendReceiveTimeoutSeconds'] == null ? null : map['backendPoolsSendReceiveTimeoutSeconds'] as int,
      enforceBackendPoolsCertificateNameCheck: map['enforceBackendPoolsCertificateNameCheck'] as bool,
    );
  }
}
