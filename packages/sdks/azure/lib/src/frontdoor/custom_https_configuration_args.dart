...
class CustomHttpsConfigurationArgs {
  ...
  factory CustomHttpsConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return CustomHttpsConfigurationArgs(
      ...
      customHttpsProvisioningEnabled: pulumi.Input.fromValue(map['customHttpsProvisioningEnabled'] as bool),
      frontendEndpointId: pulumi.Input.fromValue(map['frontendEndpointId'] as String),
    );
  }
}
