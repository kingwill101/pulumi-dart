...
class CustomHttpsConfigurationCustomHttpsConfiguration {
  ...
  factory CustomHttpsConfigurationCustomHttpsConfiguration.fromMap(Map<String, dynamic> map) {
    return CustomHttpsConfigurationCustomHttpsConfiguration(
      azureKeyVaultCertificateSecretName: (() { final guardedValue = map['azureKeyVaultCertificateSecretName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      azureKeyVaultCertificateSecretVersion: (() { final guardedValue = map['azureKeyVaultCertificateSecretVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      azureKeyVaultCertificateVaultId: (() { final guardedValue = map['azureKeyVaultCertificateVaultId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      provisioningSubstate: (() { final guardedValue = map['provisioningSubstate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
