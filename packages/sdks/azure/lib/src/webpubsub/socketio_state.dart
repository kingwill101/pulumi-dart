...
class SocketioState {
  ...
  SocketioState({
    ...
    pulumi.Output<bool>? tlsClientCertEnabled,
      ...
      sku = pulumi.Input.asOptionalInput<SocketioSku>(sku),
  ...
  factory SocketioState.fromMap(Map<String, dynamic> map) {
    return SocketioState(
      ...
      sku: map['sku'] == null ? null : pulumi.Output.create<SocketioSku>(SocketioSku.fromMap((map['sku'] as Map).cast<String, dynamic>())),
