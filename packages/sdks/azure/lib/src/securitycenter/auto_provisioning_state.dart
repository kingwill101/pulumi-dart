...
class AutoProvisioningState {
  ...
  factory AutoProvisioningState.fromMap(Map<String, dynamic> map) {
    return AutoProvisioningState(
      autoProvision: (() { final guardedValue = map['autoProvision']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
