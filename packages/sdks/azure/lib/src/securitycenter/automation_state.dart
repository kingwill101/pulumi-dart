...
class AutomationState {
  ...
  factory AutomationState.fromMap(Map<String, dynamic> map) {
    return AutomationState(
      actions: (() { final guardedValue = map['actions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationAction>(guardedValue, (value) => AutomationAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sources: (() { final guardedValue = map['sources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationSource>(guardedValue, (value) => AutomationSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
