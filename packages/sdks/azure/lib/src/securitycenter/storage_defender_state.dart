...
class StorageDefenderState {
  ...
  /// [scanResultsEventGridTopicId] The Event Grid Topic where every scan result will be sent to. When you set an Event Grid custom topic, you must set `overrideSubscriptionSettingsEnabled` to `true` to override the subscription-level settings.
  ...
  factory StorageDefenderState.fromMap(Map<String, dynamic> map) {
    return StorageDefenderState(
      malwareScanningOnUploadCapGbPerMonth: (() { final guardedValue = map['malwareScanningOnUploadCapGbPerMonth']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
