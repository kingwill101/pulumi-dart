...
class AutomationSource {
  ...
  AutomationSource({required this.eventSource, this.ruleSets});
    ...
    return AutomationSource(
      ...
      ruleSets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutomationSourceRuleSet>(
            guardedValue,
            (value) => AutomationSourceRuleSet.fromMap(
