...
class ContactState {
  ...
  factory ContactState.fromMap(Map<String, dynamic> map) {
    return ContactState(
      alertNotifications: (() { final guardedValue = map['alertNotifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      alertsToAdmins: (() { final guardedValue = map['alertsToAdmins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
