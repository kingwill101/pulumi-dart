...
class ZoneVirtualNetworkLinkState {
  ...
  const ZoneVirtualNetworkLinkState({
    this.name,
  ...
  factory ZoneVirtualNetworkLinkState.fromMap(Map<String, dynamic> map) {
    return ZoneVirtualNetworkLinkState(
      ...
      privateDnsZoneName: (() { final guardedValue = map['privateDnsZoneName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      registrationEnabled: (() { final guardedValue = map['registrationEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      resolutionPolicy: (() { final guardedValue = map['resolutionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
