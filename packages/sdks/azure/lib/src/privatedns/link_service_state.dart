...
class LinkServiceState {
  ...
  factory LinkServiceState.fromMap(Map<String, dynamic> map) {
    return LinkServiceState(
      ...
      natIpConfigurations: (() { final guardedValue = map['natIpConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LinkServiceNatIpConfiguration>(guardedValue, (value) => LinkServiceNatIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
