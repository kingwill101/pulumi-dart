...
class ResolverForwardingRuleArgs {
  ...
  factory ResolverForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ResolverForwardingRuleArgs(
      ...
      targetDnsServers: pulumi.Input.fromValue(pulumi.Input.decodeList<ResolverForwardingRuleTargetDnsServer>(map['targetDnsServers']!, (value) => ResolverForwardingRuleTargetDnsServer.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
