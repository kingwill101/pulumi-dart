...
class ZoneState {
  ...
  factory ZoneState.fromMap(Map<String, dynamic> map) {
    return ZoneState(
      ...
      maxNumberOfVirtualNetworkLinks: (() { final guardedValue = map['maxNumberOfVirtualNetworkLinks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxNumberOfVirtualNetworkLinksWithRegistration: (() { final guardedValue = map['maxNumberOfVirtualNetworkLinksWithRegistration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
