...
class ResolverDnsForwardingRulesetState {
  ...
  factory ResolverDnsForwardingRulesetState.fromMap(Map<String, dynamic> map) {
    return ResolverDnsForwardingRulesetState(
      ...
      privateDnsResolverOutboundEndpointIds: map['privateDnsResolverOutboundEndpointIds'] == null ? null : ((map['privateDnsResolverOutboundEndpointIds']! as List).cast<String>()).input(),
