...
class ZoneSoaRecord {
  ...
  factory ZoneSoaRecord.fromMap(Map<String, dynamic> map) {
    return ZoneSoaRecord(
      ...
      expireTime: (() { final guardedValue = map['expireTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      refreshTime: (() { final guardedValue = map['refreshTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      retryTime: (() { final guardedValue = map['retryTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      serialNumber: (() { final guardedValue = map['serialNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
