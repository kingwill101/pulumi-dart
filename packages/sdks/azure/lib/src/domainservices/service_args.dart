...
class ServiceArgs {
    ...
    return <String, dynamic>{
      ...
      'initialReplicaSet':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(initialReplicaSet, (value) => value.toMap()),
      'location': ?location,
      'name': ?name,
      'notifications':
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      filteredSyncEnabled: (() {
        final guardedValue = map['filteredSyncEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      initialReplicaSet: pulumi.Input.fromValue(
        ServiceInitialReplicaSet.fromMap(
          (map['initialReplicaSet']! as Map).cast<String, dynamic>(),
        ),
      ),
      location: (() {
      ...
      secureLdap: (() {
        final guardedValue = map['secureLdap'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceSecureLdap.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
