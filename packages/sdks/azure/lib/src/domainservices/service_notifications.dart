...
class ServiceNotifications {
  ...
  factory ServiceNotifications.fromMap(Map<String, dynamic> map) {
    return ServiceNotifications(
      ...
      notifyDcAdmins: (() { final guardedValue = map['notifyDcAdmins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      notifyGlobalAdmins: (() { final guardedValue = map['notifyGlobalAdmins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
