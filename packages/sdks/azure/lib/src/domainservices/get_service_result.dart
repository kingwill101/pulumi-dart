...
class GetServiceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'notifications':
          pulumi.Input.encodeList<GetServiceNotification, Map<String, dynamic>>(
            notifications,
            (value) => value.toMap(),
          ),
      'replicaSets':
          pulumi.Input.encodeList<GetServiceReplicaSet, Map<String, dynamic>>(
            replicaSets,
            (value) => value.toMap(),
          ),
      ...
      'secureLdaps':
          pulumi.Input.encodeList<GetServiceSecureLdap, Map<String, dynamic>>(
            secureLdaps,
            (value) => value.toMap(),
          ),
      'securities':
          pulumi.Input.encodeList<GetServiceSecurity, Map<String, dynamic>>(
            securities,
            (value) => value.toMap(),
          ),
      'sku': sku,
  ...
  factory GetServiceResult.fromMap(Map<String, dynamic> map) {
    return GetServiceResult(
      ...
      notifications: pulumi.Input.decodeList<GetServiceNotification>(
        map['notifications']!,
        (value) => GetServiceNotification.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      replicaSets: pulumi.Input.decodeList<GetServiceReplicaSet>(
        map['replicaSets']!,
        (value) => GetServiceReplicaSet.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      resourceGroupName: map['resourceGroupName'] as String,
      resourceId: map['resourceId'] as String,
      secureLdaps: pulumi.Input.decodeList<GetServiceSecureLdap>(
        map['secureLdaps']!,
        (value) => GetServiceSecureLdap.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      securities: pulumi.Input.decodeList<GetServiceSecurity>(
        map['securities']!,
        (value) =>
            GetServiceSecurity.fromMap((value as Map).cast<String, dynamic>()),
      ),
