...
class AccountArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataStores':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccountDataStore>,
            List<Map<String, dynamic>>
          >(
            dataStores,
            (value) =>
                pulumi.Input.encodeList<AccountDataStore, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AccountArgs(
      cors: (() {
        ...
        return pulumi.Input.fromValue(
          AccountCors.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      dataStores: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountDataStore>(
            guardedValue,
            (value) => AccountDataStore.fromMap(
