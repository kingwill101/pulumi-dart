...
class GetMonitorEnvironmentProperty {
  final pulumi.Input<List<GetMonitorEnvironmentPropertyEnvironmentInfo>>
  environmentInfos;

  /// Creates a new [GetMonitorEnvironmentProperty].
  /// [environmentInfos] Required.
  GetMonitorEnvironmentProperty({required this.environmentInfos});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'environmentInfos':
          pulumi.Input.mapInputValue<
            List<GetMonitorEnvironmentPropertyEnvironmentInfo>,
  ...
  factory GetMonitorEnvironmentProperty.fromMap(Map<String, dynamic> map) {
    return GetMonitorEnvironmentProperty(
      environmentInfos: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetMonitorEnvironmentPropertyEnvironmentInfo>(
          map['environmentInfos']!,
          (value) => GetMonitorEnvironmentPropertyEnvironmentInfo.fromMap(
