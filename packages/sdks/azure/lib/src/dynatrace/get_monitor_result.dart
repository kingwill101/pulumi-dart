...
class GetMonitorResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'identities':
          pulumi.Input.encodeList<GetMonitorIdentity, Map<String, dynamic>>(
            identities,
            (value) => value.toMap(),
          ),
      'location': location,
      ...
      'name': name,
      'plans': pulumi.Input.encodeList<GetMonitorPlan, Map<String, dynamic>>(
        plans,
        (value) => value.toMap(),
      ),
      'resourceGroupName': resourceGroupName,
      'tags': tags,
      'users': pulumi.Input.encodeList<GetMonitorUser, Map<String, dynamic>>(
        users,
        (value) => value.toMap(),
      ),
    };
  ...
  factory GetMonitorResult.fromMap(Map<String, dynamic> map) {
    return GetMonitorResult(
      environmentProperties:
          pulumi.Input.decodeList<GetMonitorEnvironmentProperty>(
            map['environmentProperties']!,
            (value) => GetMonitorEnvironmentProperty.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetMonitorIdentity>(
        map['identities']!,
        (value) =>
            GetMonitorIdentity.fromMap((value as Map).cast<String, dynamic>()),
      ),
      location: map['location'] as String,
      marketplaceSubscription: map['marketplaceSubscription'] as String,
      monitoringEnabled: map['monitoringEnabled'] as bool,
      name: map['name'] as String,
      plans: pulumi.Input.decodeList<GetMonitorPlan>(
        map['plans']!,
        (value) =>
            GetMonitorPlan.fromMap((value as Map).cast<String, dynamic>()),
      ),
      resourceGroupName: map['resourceGroupName'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      users: pulumi.Input.decodeList<GetMonitorUser>(
        map['users']!,
        (value) =>
            GetMonitorUser.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
