...
class MonitorArgs {
  ...
  factory MonitorArgs.fromMap(Map<String, dynamic> map) {
    return MonitorArgs(
      ...
      identity: pulumi.Input.fromValue(MonitorIdentity.fromMap((map['identity']! as Map).cast<String, dynamic>())),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      marketplaceSubscription: pulumi.Input.fromValue(map['marketplaceSubscription'] as String),
