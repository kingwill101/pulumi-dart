...
class TagRulesMetricRule {
  ...
  factory TagRulesMetricRule.fromMap(Map<String, dynamic> map) {
    return TagRulesMetricRule(
      filteringTags: (() { final guardedValue = map['filteringTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TagRulesMetricRuleFilteringTag>(guardedValue, (value) => TagRulesMetricRuleFilteringTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sendingMetricsEnabled: (() { final guardedValue = map['sendingMetricsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
