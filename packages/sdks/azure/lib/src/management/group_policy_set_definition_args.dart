...
class GroupPolicySetDefinitionArgs {
  ...
  final pulumi.Input<List<GroupPolicySetDefinitionPolicyDefinitionGroup>>?
  policyDefinitionGroups;

  /// One or more `policy_definition_reference` blocks as defined below.
  final pulumi.Input<List<GroupPolicySetDefinitionPolicyDefinitionReference>>
    ...
    return <String, dynamic>{
      ...
      'policyDefinitionGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<GroupPolicySetDefinitionPolicyDefinitionGroup>,
      ...
      'policyDefinitionReferences':
          pulumi.Input.mapInputValue<
            List<GroupPolicySetDefinitionPolicyDefinitionReference>,
            List<Map<String, dynamic>>
          >(
            policyDefinitionReferences,
            (value) =>
    ...
    return GroupPolicySetDefinitionArgs(
      ...
      policyDefinitionGroups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GroupPolicySetDefinitionPolicyDefinitionGroup>(
            guardedValue,
            (value) => GroupPolicySetDefinitionPolicyDefinitionGroup.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      policyDefinitionReferences: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GroupPolicySetDefinitionPolicyDefinitionReference
        >(
          map['policyDefinitionReferences']!,
          (value) => GroupPolicySetDefinitionPolicyDefinitionReference.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
