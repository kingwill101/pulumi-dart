...
class GroupPolicySetDefinitionArgs {
  ...
  const GroupPolicySetDefinitionArgs({
    this.description,
  ...
  factory GroupPolicySetDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return GroupPolicySetDefinitionArgs(
      ...
      policyDefinitionReferences: pulumi.Input.fromValue(pulumi.Input.decodeList<GroupPolicySetDefinitionPolicyDefinitionReference>(map['policyDefinitionReferences']!, (value) => GroupPolicySetDefinitionPolicyDefinitionReference.fromMap((value as Map).cast<String, dynamic>()))),
