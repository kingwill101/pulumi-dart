...
class GroupPolicyAssignmentOverride {
  ...
  GroupPolicyAssignmentOverride({this.selectors, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<GroupPolicyAssignmentOverrideSelector>,
    ...
    return GroupPolicyAssignmentOverride(
      selectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GroupPolicyAssignmentOverrideSelector>(
            guardedValue,
            (value) => GroupPolicyAssignmentOverrideSelector.fromMap(
