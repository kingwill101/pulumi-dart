...
class GroupPolicyAssignmentResourceSelector {
  ...
  final pulumi.Input<List<GroupPolicyAssignmentResourceSelectorSelector>>
  selectors;
  ...
  GroupPolicyAssignmentResourceSelector({this.name, required this.selectors});
    ...
    return <String, dynamic>{
      ...
      'selectors':
          pulumi.Input.mapInputValue<
            List<GroupPolicyAssignmentResourceSelectorSelector>,
  ...
  factory GroupPolicyAssignmentResourceSelector.fromMap(
    ...
    return GroupPolicyAssignmentResourceSelector(
      ...
      selectors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GroupPolicyAssignmentResourceSelectorSelector>(
          map['selectors']!,
          (value) => GroupPolicyAssignmentResourceSelectorSelector.fromMap(
