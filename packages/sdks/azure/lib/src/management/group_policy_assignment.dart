...
class GroupPolicyAssignment extends pulumi.CustomResource {
  ...
  GroupPolicyAssignment(
    ...
    this.identity = registerOutput<GroupPolicyAssignmentIdentity?>('identity');
    ...
    this.nonComplianceMessages = registerOutput<List<GroupPolicyAssignmentNonComplianceMessage>?>('nonComplianceMessages');
    this.notScopes = registerOutput<List<String>?>('notScopes');
    this.overrides = registerOutput<List<GroupPolicyAssignmentOverride>?>('overrides');
    this.parameters = registerOutput<String?>('parameters');
    this.policyDefinitionId = registerOutput<String>('policyDefinitionId');
    this.resourceSelectors = registerOutput<List<GroupPolicyAssignmentResourceSelector>?>('resourceSelectors');
  }
