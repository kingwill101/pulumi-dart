...
class GroupPolicySetDefinitionPolicyDefinitionReference {
  ...
  const GroupPolicySetDefinitionPolicyDefinitionReference({
  ...
  factory GroupPolicySetDefinitionPolicyDefinitionReference.fromMap(Map<String, dynamic> map) {
    return GroupPolicySetDefinitionPolicyDefinitionReference(
