...
class EventHubCaptureDescription {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destination': pulumi.Input.mapInputValue<EventHubCaptureDescriptionDestination, Map<String, dynamic>>(destination, (value) => value.toMap()),
      'enabled': enabled,
      'encoding': encoding,
  ...
  factory EventHubCaptureDescription.fromMap(Map<String, dynamic> map) {
    return EventHubCaptureDescription(
      destination: pulumi.Input.fromValue(EventHubCaptureDescriptionDestination.fromMap((map['destination']! as Map).cast<String, dynamic>())),
      ...
      sizeLimitInBytes: (() { final guardedValue = map['sizeLimitInBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
