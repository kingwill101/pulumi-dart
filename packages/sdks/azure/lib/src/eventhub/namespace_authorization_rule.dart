...
class NamespaceAuthorizationRule extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NamespaceAuthorizationRule]. {@macro pulumi_eventhub_namespace_authorization_rule_namespace_authorization_rule_args_doc}
