...
class EventSubscriptionArgs {
  ...
  EventSubscriptionArgs({
    pulumi.Output<EventSubscriptionAdvancedFilter>? advancedFilter,
    pulumi.Output<bool>? advancedFilteringOnArraysEnabled,
    pulumi.Output<EventSubscriptionAzureFunctionEndpoint>? azureFunctionEndpoint,
    pulumi.Output<EventSubscriptionDeadLetterIdentity>? deadLetterIdentity,
    pulumi.Output<EventSubscriptionDeliveryIdentity>? deliveryIdentity,
    pulumi.Output<List<EventSubscriptionDeliveryProperty>>? deliveryProperties,
    ...
    pulumi.Output<EventSubscriptionRetryPolicy>? retryPolicy,
    required pulumi.Output<String> scope,
    pulumi.Output<String>? serviceBusQueueEndpointId,
    pulumi.Output<String>? serviceBusTopicEndpointId,
    pulumi.Output<EventSubscriptionStorageBlobDeadLetterDestination>? storageBlobDeadLetterDestination,
    pulumi.Output<EventSubscriptionStorageQueueEndpoint>? storageQueueEndpoint,
    pulumi.Output<EventSubscriptionSubjectFilter>? subjectFilter,
    pulumi.Output<EventSubscriptionWebhookEndpoint>? webhookEndpoint,
  }) :
  ...
  factory EventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionArgs(
      advancedFilter: map['advancedFilter'] == null ? null : pulumi.Output.create<EventSubscriptionAdvancedFilter>(EventSubscriptionAdvancedFilter.fromMap((map['advancedFilter'] as Map).cast<String, dynamic>())),
      ...
      azureFunctionEndpoint: map['azureFunctionEndpoint'] == null ? null : pulumi.Output.create<EventSubscriptionAzureFunctionEndpoint>(EventSubscriptionAzureFunctionEndpoint.fromMap((map['azureFunctionEndpoint'] as Map).cast<String, dynamic>())),
      deadLetterIdentity: map['deadLetterIdentity'] == null ? null : pulumi.Output.create<EventSubscriptionDeadLetterIdentity>(EventSubscriptionDeadLetterIdentity.fromMap((map['deadLetterIdentity'] as Map).cast<String, dynamic>())),
      deliveryIdentity: map['deliveryIdentity'] == null ? null : pulumi.Output.create<EventSubscriptionDeliveryIdentity>(EventSubscriptionDeliveryIdentity.fromMap((map['deliveryIdentity'] as Map).cast<String, dynamic>())),
      deliveryProperties: map['deliveryProperties'] == null ? null : pulumi.Output.create<List<EventSubscriptionDeliveryProperty>>(pulumi.Input.decodeList<EventSubscriptionDeliveryProperty>(map['deliveryProperties'], (value) => EventSubscriptionDeliveryProperty.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      retryPolicy: map['retryPolicy'] == null ? null : pulumi.Output.create<EventSubscriptionRetryPolicy>(EventSubscriptionRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>())),
      ...
      storageBlobDeadLetterDestination: map['storageBlobDeadLetterDestination'] == null ? null : pulumi.Output.create<EventSubscriptionStorageBlobDeadLetterDestination>(EventSubscriptionStorageBlobDeadLetterDestination.fromMap((map['storageBlobDeadLetterDestination'] as Map).cast<String, dynamic>())),
      storageQueueEndpoint: map['storageQueueEndpoint'] == null ? null : pulumi.Output.create<EventSubscriptionStorageQueueEndpoint>(EventSubscriptionStorageQueueEndpoint.fromMap((map['storageQueueEndpoint'] as Map).cast<String, dynamic>())),
      subjectFilter: map['subjectFilter'] == null ? null : pulumi.Output.create<EventSubscriptionSubjectFilter>(EventSubscriptionSubjectFilter.fromMap((map['subjectFilter'] as Map).cast<String, dynamic>())),
      webhookEndpoint: map['webhookEndpoint'] == null ? null : pulumi.Output.create<EventSubscriptionWebhookEndpoint>(EventSubscriptionWebhookEndpoint.fromMap((map['webhookEndpoint'] as Map).cast<String, dynamic>())),
    );
  }
}
