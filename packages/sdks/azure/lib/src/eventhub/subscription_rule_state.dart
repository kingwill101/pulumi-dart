...
class SubscriptionRuleState {
  ...
  factory SubscriptionRuleState.fromMap(Map<String, dynamic> map) {
    return SubscriptionRuleState(
      ...
      sqlFilterCompatibilityLevel: (() { final guardedValue = map['sqlFilterCompatibilityLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
