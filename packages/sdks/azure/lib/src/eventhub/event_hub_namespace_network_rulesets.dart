...
class EventHubNamespaceNetworkRulesets {
  ...
  final pulumi.Input<List<EventHubNamespaceNetworkRulesetsVirtualNetworkRule>>?
  virtualNetworkRules;
    ...
    return <String, dynamic>{
      ...
      'ipRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<EventHubNamespaceNetworkRulesetsIpRule>,
      ...
      'virtualNetworkRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<EventHubNamespaceNetworkRulesetsVirtualNetworkRule>,
            List<Map<String, dynamic>>
          >(
            virtualNetworkRules,
            (value) =>
    ...
    return EventHubNamespaceNetworkRulesets(
      ...
      ipRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventHubNamespaceNetworkRulesetsIpRule>(
            guardedValue,
            (value) => EventHubNamespaceNetworkRulesetsIpRule.fromMap(
      ...
      virtualNetworkRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EventHubNamespaceNetworkRulesetsVirtualNetworkRule.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
