...
class DomainArgs {
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      inboundIpRules: (() { final guardedValue = map['inboundIpRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainInboundIpRule>(guardedValue, (value) => DomainInboundIpRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      inputMappingDefaultValues: (() { final guardedValue = map['inputMappingDefaultValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainInputMappingDefaultValues.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      inputMappingFields: (() { final guardedValue = map['inputMappingFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainInputMappingFields.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
