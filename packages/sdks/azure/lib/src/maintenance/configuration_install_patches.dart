...
class ConfigurationInstallPatches {
  ...
  ConfigurationInstallPatches({this.linuxes, this.reboot, this.windows});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'linuxes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigurationInstallPatchesLinux>,
      ...
      'windows':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigurationInstallPatchesWindow>,
            List<Map<String, dynamic>>
          >(
            windows,
            (value) =>
  ...
  factory ConfigurationInstallPatches.fromMap(Map<String, dynamic> map) {
    return ConfigurationInstallPatches(
      linuxes: (() {
        final guardedValue = map['linuxes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConfigurationInstallPatchesLinux>(
            guardedValue,
            (value) => ConfigurationInstallPatchesLinux.fromMap(
      ...
      windows: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConfigurationInstallPatchesWindow>(
            guardedValue,
            (value) => ConfigurationInstallPatchesWindow.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
