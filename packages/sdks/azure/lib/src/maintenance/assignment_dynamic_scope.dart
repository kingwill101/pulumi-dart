...
import 'assignment_dynamic_scope_state.dart';
...
class AssignmentDynamicScope extends pulumi.CustomResource {
  ...
  /// Gets an existing [AssignmentDynamicScope] resource's state with the given [name] and [id].
  static AssignmentDynamicScope get(
    String name,
