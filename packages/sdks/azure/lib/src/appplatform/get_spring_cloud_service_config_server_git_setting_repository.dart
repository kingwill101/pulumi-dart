...
class GetSpringCloudServiceConfigServerGitSettingRepository {
  ...
  final pulumi.Input<
    List<GetSpringCloudServiceConfigServerGitSettingRepositoryHttpBasicAuth>
  >
  httpBasicAuths;
  ...
  final pulumi.Input<
    List<GetSpringCloudServiceConfigServerGitSettingRepositorySshAuth>
  >
  sshAuths;
  ...
  factory GetSpringCloudServiceConfigServerGitSettingRepository.fromMap(
    ...
    return GetSpringCloudServiceConfigServerGitSettingRepository(
      httpBasicAuths: pulumi.Input.fromValue(
        ...
        >(
          map['httpBasicAuths']!,
          (value) =>
              GetSpringCloudServiceConfigServerGitSettingRepositoryHttpBasicAuth.fromMap(
      ...
      sshAuths: pulumi.Input.fromValue(
        ...
        >(
          map['sshAuths']!,
          (value) =>
              GetSpringCloudServiceConfigServerGitSettingRepositorySshAuth.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
