...
class GetSpringCloudServiceConfigServerGitSettingRepository {
  ...
  factory GetSpringCloudServiceConfigServerGitSettingRepository.fromMap(Map<String, dynamic> map) {
    return GetSpringCloudServiceConfigServerGitSettingRepository(
      httpBasicAuths: (pulumi.Input.decodeList<GetSpringCloudServiceConfigServerGitSettingRepositoryHttpBasicAuth>(map['httpBasicAuths'], (value) => GetSpringCloudServiceConfigServerGitSettingRepositoryHttpBasicAuth.fromMap((value as Map).cast<String, dynamic>()))).input(),
      label: (map['label'] as String).input(),
      name: (map['name'] as String).input(),
      patterns: ((map['patterns'] as List).cast<String>()).input(),
      searchPaths: ((map['searchPaths'] as List).cast<String>()).input(),
      sshAuths: (pulumi.Input.decodeList<GetSpringCloudServiceConfigServerGitSettingRepositorySshAuth>(map['sshAuths'], (value) => GetSpringCloudServiceConfigServerGitSettingRepositorySshAuth.fromMap((value as Map).cast<String, dynamic>()))).input(),
