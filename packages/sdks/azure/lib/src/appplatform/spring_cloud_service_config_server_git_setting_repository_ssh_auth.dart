...
class SpringCloudServiceConfigServerGitSettingRepositorySshAuth {
  ...
  /// Creates a new [SpringCloudServiceConfigServerGitSettingRepositorySshAuth].
  ...
  /// [strictHostKeyCheckingEnabled] Indicates whether the Config Server instance will fail to start if the hostKey does not match. Defaults to `true`.
  const SpringCloudServiceConfigServerGitSettingRepositorySshAuth({
    this.hostKey,
