...
class SpringCloudDynatraceApplicationPerformanceMonitoringState {
  ...
  factory SpringCloudDynatraceApplicationPerformanceMonitoringState.fromMap(
    Map<String, dynamic> map,
  ) {
    return SpringCloudDynatraceApplicationPerformanceMonitoringState(
      apiToken: (() {
        final guardedValue = map['apiToken'];
      ...
      connectionPoint: (() {
        final guardedValue = map['connectionPoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      environmentId: (() {
      ...
      tenantToken: (() {
        final guardedValue = map['tenantToken'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
