...
class SpringCloudGatewayRouteConfigArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SpringCloudGatewayRouteConfigRoute>,
    ...
    return SpringCloudGatewayRouteConfigArgs(
      ...
      openApi: (() {
        ...
        return pulumi.Input.fromValue(
          SpringCloudGatewayRouteConfigOpenApi.fromMap(
      ...
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SpringCloudGatewayRouteConfigRoute>(
            guardedValue,
            (value) => SpringCloudGatewayRouteConfigRoute.fromMap(
      ...
      springCloudGatewayId: pulumi.Input.fromValue(
        map['springCloudGatewayId'] as String,
      ),
      ssoValidationEnabled: (() {
        final guardedValue = map['ssoValidationEnabled'];
        if (guardedValue == null) return null;
