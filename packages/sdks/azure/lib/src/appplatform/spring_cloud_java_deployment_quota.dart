...
class SpringCloudJavaDeploymentQuota {
  ...
  /// Creates a new [SpringCloudJavaDeploymentQuota].
  ...
  SpringCloudJavaDeploymentQuota({this.cpu, this.memory});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'cpu': ?cpu, 'memory': ?memory};
  }

  factory SpringCloudJavaDeploymentQuota.fromMap(Map<String, dynamic> map) {
    return SpringCloudJavaDeploymentQuota(
      cpu: (() {
