...
class SpringCloudApplicationInsightsApplicationPerformanceMonitoringState {
  ...
  factory SpringCloudApplicationInsightsApplicationPerformanceMonitoringState.fromMap(
    ...
    return SpringCloudApplicationInsightsApplicationPerformanceMonitoringState(
      ...
      roleInstance: (() {
        final guardedValue = map['roleInstance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      roleName: (() {
      ...
      samplingRequestsPerSecond: (() {
        final guardedValue = map['samplingRequestsPerSecond'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
