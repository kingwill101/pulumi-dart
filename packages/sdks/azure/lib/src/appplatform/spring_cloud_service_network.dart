  ...
  factory SpringCloudServiceNetwork.fromMap(Map<String, dynamic> map) {
    return SpringCloudServiceNetwork(
      appNetworkResourceGroup: (() {
        final guardedValue = map['appNetworkResourceGroup'];
      ...
      readTimeoutSeconds: (() {
        final guardedValue = map['readTimeoutSeconds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      serviceRuntimeNetworkResourceGroup: (() {
        final guardedValue = map['serviceRuntimeNetworkResourceGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceRuntimeSubnetId: pulumi.Input.fromValue(
        map['serviceRuntimeSubnetId'] as String,
      ),
    );
  }
}
