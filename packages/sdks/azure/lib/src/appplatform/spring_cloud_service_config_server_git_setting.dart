...
class SpringCloudServiceConfigServerGitSetting {
  ...
  final pulumi.Input<SpringCloudServiceConfigServerGitSettingHttpBasicAuth>?
  httpBasicAuth;
  ...
  final pulumi.Input<List<SpringCloudServiceConfigServerGitSettingRepository>>?
  repositories;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'repositories':
          ?pulumi.Input.mapOptionalInputValue<
            List<SpringCloudServiceConfigServerGitSettingRepository>,
  ...
  factory SpringCloudServiceConfigServerGitSetting.fromMap(
    ...
    return SpringCloudServiceConfigServerGitSetting(
      httpBasicAuth: (() {
        ...
        return pulumi.Input.fromValue(
          SpringCloudServiceConfigServerGitSettingHttpBasicAuth.fromMap(
      ...
      repositories: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SpringCloudServiceConfigServerGitSettingRepository.fromMap(
      ...
      sshAuth: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SpringCloudServiceConfigServerGitSettingSshAuth.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
