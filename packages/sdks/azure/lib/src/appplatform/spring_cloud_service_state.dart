...
class SpringCloudServiceState {
  ...
  final pulumi.Input<List<SpringCloudServiceRequiredNetworkTrafficRule>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requiredNetworkTrafficRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<SpringCloudServiceRequiredNetworkTrafficRule>,
            List<Map<String, dynamic>>
          >(
            requiredNetworkTrafficRules,
            (value) =>
  ...
  factory SpringCloudServiceState.fromMap(Map<String, dynamic> map) {
    return SpringCloudServiceState(
      ...
      outboundPublicIpAddresses: (() {
        final guardedValue = map['outboundPublicIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      requiredNetworkTrafficRules: (() {
        final guardedValue = map['requiredNetworkTrafficRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SpringCloudServiceRequiredNetworkTrafficRule>(
            guardedValue,
            (value) => SpringCloudServiceRequiredNetworkTrafficRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceRegistryId: (() {
        final guardedValue = map['serviceRegistryId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      skuName: (() {
