...
class SpringCloudServiceState {
  ...
  SpringCloudServiceState({
    ...
    pulumi.Output<List<SpringCloudServiceRequiredNetworkTrafficRule>>? requiredNetworkTrafficRules,
    pulumi.Output<String>? resourceGroupName,
    pulumi.Output<bool>? serviceRegistryEnabled,
    pulumi.Output<String>? serviceRegistryId,
    ...
    pulumi.Output<bool>? zoneRedundant,
      ...
      requiredNetworkTrafficRules = pulumi.Input.asOptionalInput<List<SpringCloudServiceRequiredNetworkTrafficRule>>(requiredNetworkTrafficRules),
      resourceGroupName = pulumi.Input.asOptionalInput<String>(resourceGroupName),
      serviceRegistryEnabled = pulumi.Input.asOptionalInput<bool>(serviceRegistryEnabled),
      serviceRegistryId = pulumi.Input.asOptionalInput<String>(serviceRegistryId),
  ...
  factory SpringCloudServiceState.fromMap(Map<String, dynamic> map) {
    return SpringCloudServiceState(
      ...
      requiredNetworkTrafficRules: map['requiredNetworkTrafficRules'] == null ? null : pulumi.Output.create<List<SpringCloudServiceRequiredNetworkTrafficRule>>(pulumi.Input.decodeList<SpringCloudServiceRequiredNetworkTrafficRule>(map['requiredNetworkTrafficRules'], (value) => SpringCloudServiceRequiredNetworkTrafficRule.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      serviceRegistryId: map['serviceRegistryId'] == null ? null : pulumi.Output.create<String>(map['serviceRegistryId'] as String),
