...
class ChannelTeamsArgs {
  ...
  factory ChannelTeamsArgs.fromMap(Map<String, dynamic> map) {
    return ChannelTeamsArgs(
      ...
      callingEnabled: (() { final guardedValue = map['callingEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
