...
class ChannelFacebookArgs {
  ...
  factory ChannelFacebookArgs.fromMap(Map<String, dynamic> map) {
    return ChannelFacebookArgs(
      ...
      facebookApplicationId: pulumi.Input.fromValue(map['facebookApplicationId'] as String),
      facebookApplicationSecret: pulumi.Input.fromValue(map['facebookApplicationSecret'] as String),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pages: pulumi.Input.fromValue(pulumi.Input.decodeList<ChannelFacebookPage>(map['pages']!, (value) => ChannelFacebookPage.fromMap((value as Map).cast<String, dynamic>()))),
