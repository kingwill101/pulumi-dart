...
class ServiceAzureBot extends pulumi.CustomResource {
  ...
  ServiceAzureBot(
    ...
    this.cmkKeyVaultKeyUrl = registerOutput<String?>('cmkKeyVaultKeyUrl');
    ...
    this.microsoftAppMsiId = registerOutput<String?>('microsoftAppMsiId');
    this.microsoftAppTenantId = registerOutput<String?>('microsoftAppTenantId');
    this.microsoftAppType = registerOutput<String?>('microsoftAppType');
    ...
    this.streamingEndpointEnabled = registerOutput<bool?>('streamingEndpointEnabled');
