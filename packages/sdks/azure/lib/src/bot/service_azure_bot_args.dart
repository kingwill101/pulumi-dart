...
class ServiceAzureBotArgs {
  ...
  factory ServiceAzureBotArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAzureBotArgs(
      cmkKeyVaultKeyUrl: (() {
        final guardedValue = map['cmkKeyVaultKeyUrl'];
      ...
      microsoftAppMsiId: (() {
        final guardedValue = map['microsoftAppMsiId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      microsoftAppTenantId: (() {
        final guardedValue = map['microsoftAppTenantId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      microsoftAppType: (() {
        final guardedValue = map['microsoftAppType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      streamingEndpointEnabled: (() {
        final guardedValue = map['streamingEndpointEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      tags: (() {
