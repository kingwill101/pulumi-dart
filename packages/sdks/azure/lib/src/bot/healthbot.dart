...
///   location = "West Europe"
/// }
/// resource "azure_bot_healthbot" "example" {
///   name                = "example-bot"
...
class Healthbot extends pulumi.CustomResource {
  ...
  static Healthbot get(
    String name,
    pulumi.Input<String> id, {
    HealthbotState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return Healthbot._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [Healthbot] resource.
  Healthbot.reference(String urn)
    : super(
        'azure:bot/healthbot:Healthbot',
