...
class BackupPolicyPostgresqlFlexibleServerRetentionRule {
  ...
  final pulumi.Input<BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteria>
  criteria;

  /// A `life_cycle` block as defined below. Changing this forces a new resource to be created.
  final pulumi.Input<
    List<BackupPolicyPostgresqlFlexibleServerRetentionRuleLifeCycle>
  >
  lifeCycles;
  ...
  factory BackupPolicyPostgresqlFlexibleServerRetentionRule.fromMap(
    Map<String, dynamic> map,
  ) {
    return BackupPolicyPostgresqlFlexibleServerRetentionRule(
      criteria: pulumi.Input.fromValue(
        BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteria.fromMap(
      ...
      lifeCycles: pulumi.Input.fromValue(
        ...
        >(
          map['lifeCycles']!,
          (value) =>
              BackupPolicyPostgresqlFlexibleServerRetentionRuleLifeCycle.fromMap(
