...
class BackupPolicyKubernetesClusterState {
  ...
  factory BackupPolicyKubernetesClusterState.fromMap(Map<String, dynamic> map) {
    return BackupPolicyKubernetesClusterState(
      ...
      defaultRetentionRule: (() { final guardedValue = map['defaultRetentionRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPolicyKubernetesClusterDefaultRetentionRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
