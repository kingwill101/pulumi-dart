...
class BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule {
  ...
  final pulumi.Input<
    List<BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleLifeCycle>
  >
  lifeCycles;
  ...
  factory BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule.fromMap(
    ...
    return BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule(
      lifeCycles: pulumi.Input.fromValue(
        ...
        >(
          map['lifeCycles']!,
          (value) =>
              BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleLifeCycle.fromMap(
