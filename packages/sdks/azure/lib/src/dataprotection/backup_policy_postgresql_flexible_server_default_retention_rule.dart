...
class BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule {
  ...
  factory BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule.fromMap(Map<String, dynamic> map) {
    return BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule(
      lifeCycles: pulumi.Input.fromValue(pulumi.Input.decodeList<BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleLifeCycle>(map['lifeCycles']!, (value) => BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleLifeCycle.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
