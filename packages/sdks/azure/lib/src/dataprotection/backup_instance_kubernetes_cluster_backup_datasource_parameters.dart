...
class BackupInstanceKubernetesClusterBackupDatasourceParameters {
  ...
  factory BackupInstanceKubernetesClusterBackupDatasourceParameters.fromMap(Map<String, dynamic> map) {
    return BackupInstanceKubernetesClusterBackupDatasourceParameters(
      clusterScopedResourcesEnabled: (() { final guardedValue = map['clusterScopedResourcesEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      volumeSnapshotEnabled: (() { final guardedValue = map['volumeSnapshotEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
