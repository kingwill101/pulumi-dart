...
class BackupPolicyMysqlFlexibleServerState {
  ...
  const BackupPolicyMysqlFlexibleServerState({
  ...
  factory BackupPolicyMysqlFlexibleServerState.fromMap(Map<String, dynamic> map) {
    return BackupPolicyMysqlFlexibleServerState(
      ...
      defaultRetentionRule: (() { final guardedValue = map['defaultRetentionRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPolicyMysqlFlexibleServerDefaultRetentionRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
