...
class BackupPolicyMysqlFlexibleServerArgs {
  ...
  BackupPolicyMysqlFlexibleServerArgs({
    ...
    required pulumi.Output<BackupPolicyMysqlFlexibleServerDefaultRetentionRule> defaultRetentionRule,
    ...
    required pulumi.Output<String> vaultId,
      ...
      defaultRetentionRule = pulumi.Input.asInput<BackupPolicyMysqlFlexibleServerDefaultRetentionRule>(defaultRetentionRule),
  ...
  factory BackupPolicyMysqlFlexibleServerArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyMysqlFlexibleServerArgs(
      ...
      defaultRetentionRule: pulumi.Output.create<BackupPolicyMysqlFlexibleServerDefaultRetentionRule>(BackupPolicyMysqlFlexibleServerDefaultRetentionRule.fromMap((map['defaultRetentionRule'] as Map).cast<String, dynamic>())),
