...
class BackupPolicyKubernetesClusterDefaultRetentionRule {
  ...
  BackupPolicyKubernetesClusterDefaultRetentionRule({required this.lifeCycles});
  ...
  factory BackupPolicyKubernetesClusterDefaultRetentionRule.fromMap(
    ...
    return BackupPolicyKubernetesClusterDefaultRetentionRule(
      lifeCycles: pulumi.Input.fromValue(
        ...
        >(
          map['lifeCycles']!,
          (value) =>
              BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycle.fromMap(
