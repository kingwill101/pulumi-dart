...
class BackupPolicyPostgresqlFlexibleServerState {
  ...
  factory BackupPolicyPostgresqlFlexibleServerState.fromMap(Map<String, dynamic> map) {
    return BackupPolicyPostgresqlFlexibleServerState(
      ...
      defaultRetentionRule: (() { final guardedValue = map['defaultRetentionRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      retentionRules: (() { final guardedValue = map['retentionRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackupPolicyPostgresqlFlexibleServerRetentionRule>(guardedValue, (value) => BackupPolicyPostgresqlFlexibleServerRetentionRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
