...
class BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteria {
  ...
  /// Creates a new [BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteria].
  ...
  factory BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteria.fromMap(
    ...
    return BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteria(
      ...
      monthsOfYears: (() {
        final guardedValue = map['monthsOfYears'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      scheduledBackupTimes: (() {
        final guardedValue = map['scheduledBackupTimes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      weeksOfMonths: (() {
