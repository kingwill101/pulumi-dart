...
class BackupPolicyKubernetesClusterRetentionRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'criteria': pulumi.Input.mapInputValue<BackupPolicyKubernetesClusterRetentionRuleCriteria, Map<String, dynamic>>(criteria, (value) => value.toMap()),
      'lifeCycles': pulumi.Input.mapInputValue<List<BackupPolicyKubernetesClusterRetentionRuleLifeCycle>, List<Map<String, dynamic>>>(lifeCycles, (value) => pulumi.Input.encodeList<BackupPolicyKubernetesClusterRetentionRuleLifeCycle, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
      'priority': priority,
    };
  }
  ...
  factory BackupPolicyKubernetesClusterRetentionRule.fromMap(Map<String, dynamic> map) {
    return BackupPolicyKubernetesClusterRetentionRule(
      criteria: pulumi.Input.fromValue(BackupPolicyKubernetesClusterRetentionRuleCriteria.fromMap((map['criteria']! as Map).cast<String, dynamic>())),
      lifeCycles: pulumi.Input.fromValue(pulumi.Input.decodeList<BackupPolicyKubernetesClusterRetentionRuleLifeCycle>(map['lifeCycles']!, (value) => BackupPolicyKubernetesClusterRetentionRuleLifeCycle.fromMap((value as Map).cast<String, dynamic>()))),
