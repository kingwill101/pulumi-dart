...
class BackupPolicyMysqlFlexibleServerRetentionRule {
  ...
  final pulumi.Input<BackupPolicyMysqlFlexibleServerRetentionRuleCriteria>
  criteria;

  /// A `life_cycle` block as defined below. Changing this forces a new resource to be created.
  final pulumi.Input<
    List<BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycle>
  >
  lifeCycles;
  ...
  factory BackupPolicyMysqlFlexibleServerRetentionRule.fromMap(
    Map<String, dynamic> map,
  ) {
    return BackupPolicyMysqlFlexibleServerRetentionRule(
      criteria: pulumi.Input.fromValue(
        BackupPolicyMysqlFlexibleServerRetentionRuleCriteria.fromMap(
      ...
      lifeCycles: pulumi.Input.fromValue(
        ...
        >(
          map['lifeCycles']!,
          (value) =>
              BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycle.fromMap(
