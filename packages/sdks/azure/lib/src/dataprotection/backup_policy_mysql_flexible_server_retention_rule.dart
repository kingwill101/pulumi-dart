...
class BackupPolicyMysqlFlexibleServerRetentionRule {
  ...
  factory BackupPolicyMysqlFlexibleServerRetentionRule.fromMap(Map<String, dynamic> map) {
    return BackupPolicyMysqlFlexibleServerRetentionRule(
      criteria: (BackupPolicyMysqlFlexibleServerRetentionRuleCriteria.fromMap((map['criteria'] as Map).cast<String, dynamic>())).input(),
      lifeCycles: (pulumi.Input.decodeList<BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycle>(map['lifeCycles'], (value) => BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycle.fromMap((value as Map).cast<String, dynamic>()))).input(),
