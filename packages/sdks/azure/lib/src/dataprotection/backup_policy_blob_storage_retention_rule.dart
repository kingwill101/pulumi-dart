...
class BackupPolicyBlobStorageRetentionRule {
  ...
  factory BackupPolicyBlobStorageRetentionRule.fromMap(
    Map<String, dynamic> map,
  ) {
    return BackupPolicyBlobStorageRetentionRule(
      criteria: pulumi.Input.fromValue(
        BackupPolicyBlobStorageRetentionRuleCriteria.fromMap(
          (map['criteria']! as Map).cast<String, dynamic>(),
        ),
      ),
      lifeCycle: pulumi.Input.fromValue(
        BackupPolicyBlobStorageRetentionRuleLifeCycle.fromMap(
