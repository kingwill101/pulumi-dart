...
class ServerState {
  ...
  factory ServerState.fromMap(Map<String, dynamic> map) {
    return ServerState(
      ...
      ipv4FirewallRules: (() {
        final guardedValue = map['ipv4FirewallRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerIpv4FirewallRule>(
            guardedValue,
            (value) => ServerIpv4FirewallRule.fromMap(
      ...
      powerBiServiceEnabled: (() {
        final guardedValue = map['powerBiServiceEnabled'];
        if (guardedValue == null) return null;
      ...
      serverFullName: (() {
        final guardedValue = map['serverFullName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sku: (() {
