...
class IotHubDeviceUpdateInstanceArgs {
  ...
  final pulumi.Input<IotHubDeviceUpdateInstanceDiagnosticStorageAccount>?
    ...
    return <String, dynamic>{
      ...
      'diagnosticStorageAccount':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(diagnosticStorageAccount, (value) => value.toMap()),
      'iothubId': iothubId,
      'name': ?name,
      'tags': ?tags,
    };
  ...
  factory IotHubDeviceUpdateInstanceArgs.fromMap(Map<String, dynamic> map) {
    return IotHubDeviceUpdateInstanceArgs(
      deviceUpdateAccountId: pulumi.Input.fromValue(
        map['deviceUpdateAccountId'] as String,
      ),
      diagnosticEnabled: (() {
        final guardedValue = map['diagnosticEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      diagnosticStorageAccount: (() {
        final guardedValue = map['diagnosticStorageAccount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IotHubDeviceUpdateInstanceDiagnosticStorageAccount.fromMap(
