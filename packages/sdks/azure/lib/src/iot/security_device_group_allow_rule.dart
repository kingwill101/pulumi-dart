  ...
  factory SecurityDeviceGroupAllowRule.fromMap(Map<String, dynamic> map) {
    return SecurityDeviceGroupAllowRule(
      connectionFromIpsNotAlloweds: (() {
        final guardedValue = map['connectionFromIpsNotAlloweds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      connectionToIpsNotAlloweds: (() {
        final guardedValue = map['connectionToIpsNotAlloweds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      localUsersNotAlloweds: (() {
        final guardedValue = map['localUsersNotAlloweds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      processesNotAlloweds: (() {
        final guardedValue = map['processesNotAlloweds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
