...
class FileUpload extends pulumi.CustomResource {
  ...
  FileUpload(
    ...
    this.defaultTtl = registerOutput<String?>('defaultTtl');
    ...
    this.notificationsEnabled = registerOutput<bool?>('notificationsEnabled');
    this.sasTtl = registerOutput<String?>('sasTtl');
  }
