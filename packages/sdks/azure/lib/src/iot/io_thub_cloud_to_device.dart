...
class IoTHubCloudToDevice {
  ...
  IoTHubCloudToDevice({this.defaultTtl, this.feedbacks, this.maxDeliveryCount});
    ...
    return <String, dynamic>{
      ...
      'feedbacks':
          ?pulumi.Input.mapOptionalInputValue<
            List<IoTHubCloudToDeviceFeedback>,
  ...
  factory IoTHubCloudToDevice.fromMap(Map<String, dynamic> map) {
    return IoTHubCloudToDevice(
      ...
      feedbacks: (() {
        final guardedValue = map['feedbacks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IoTHubCloudToDeviceFeedback>(
            guardedValue,
            (value) => IoTHubCloudToDeviceFeedback.fromMap(
