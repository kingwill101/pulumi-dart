...
class IoTHubIdentity {
  ...
  /// Creates a new [IoTHubIdentity].
  /// [identityIds] Specifies a list of User Assigned Managed Identity IDs to be assigned to this IoT Hub.
  /// [principalId] The Principal ID associated with this Managed Service Identity.
  /// [tenantId] The Tenant ID associated with this Managed Service Identity.
  /// [type] Specifies the type of Managed Service Identity that should be configured on this IoT Hub. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
  const IoTHubIdentity({
    this.identityIds,
    this.principalId,
    this.tenantId,
    required this.type,
  ...
  factory IoTHubIdentity.fromMap(Map<String, dynamic> map) {
    return IoTHubIdentity(
