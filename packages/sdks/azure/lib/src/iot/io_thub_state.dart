...
class IoTHubState {
    ...
    return <String, dynamic>{
      'cloudToDevice':
          ?pulumi.Input.mapOptionalInputValue<
            IoTHubCloudToDevice,
            Map<String, dynamic>
          >(cloudToDevice, (value) => value.toMap()),
      'endpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<IoTHubEndpoint>,
          ...
          >(
            endpoints,
            (value) =>
                pulumi.Input.encodeList<IoTHubEndpoint, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'enrichments':
          ?pulumi.Input.mapOptionalInputValue<
            List<IoTHubEnrichment>,
            List<Map<String, dynamic>>
          >(
            enrichments,
            (value) =>
                pulumi.Input.encodeList<IoTHubEnrichment, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'fallbackRoute':
          ?pulumi.Input.mapOptionalInputValue<
            IoTHubFallbackRoute,
            Map<String, dynamic>
          >(fallbackRoute, (value) => value.toMap()),
      'fileUpload':
          ?pulumi.Input.mapOptionalInputValue<
            IoTHubFileUpload,
            Map<String, dynamic>
          >(fileUpload, (value) => value.toMap()),
      'hostname': ?hostname,
      'identity':
          ?pulumi.Input.mapOptionalInputValue<
            IoTHubIdentity,
      ...
      'routes':
          ...
          >(
            routes,
            (value) =>
                pulumi.Input.encodeList<IoTHubRoute, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'sku':
          ?pulumi.Input.mapOptionalInputValue<IoTHubSku, Map<String, dynamic>>(
            sku,
            (value) => value.toMap(),
          ),
      'tags': ?tags,
  ...
  factory IoTHubState.fromMap(Map<String, dynamic> map) {
    return IoTHubState(
      cloudToDevice: (() {
        final guardedValue = map['cloudToDevice'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IoTHubCloudToDevice.fromMap(
      ...
      endpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IoTHubEndpoint>(
            guardedValue,
            (value) =>
                IoTHubEndpoint.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      enrichments: (() {
        final guardedValue = map['enrichments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IoTHubEnrichment>(
            guardedValue,
            (value) => IoTHubEnrichment.fromMap(
      ...
      eventHubEventsEndpoint: (() {
        final guardedValue = map['eventHubEventsEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eventHubEventsNamespace: (() {
        final guardedValue = map['eventHubEventsNamespace'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eventHubEventsPath: (() {
        final guardedValue = map['eventHubEventsPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eventHubOperationsEndpoint: (() {
        final guardedValue = map['eventHubOperationsEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eventHubOperationsPath: (() {
        final guardedValue = map['eventHubOperationsPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eventHubPartitionCount: (() {
        final guardedValue = map['eventHubPartitionCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      eventHubRetentionInDays: (() {
        final guardedValue = map['eventHubRetentionInDays'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      fallbackRoute: (() {
        final guardedValue = map['fallbackRoute'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IoTHubFallbackRoute.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fileUpload: (() {
        final guardedValue = map['fileUpload'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IoTHubFileUpload.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IoTHubIdentity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      networkRuleSets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IoTHubNetworkRuleSet>(
            guardedValue,
            (value) => IoTHubNetworkRuleSet.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IoTHubRoute>(
            guardedValue,
            (value) =>
                IoTHubRoute.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      sharedAccessPolicies: (() {
        final guardedValue = map['sharedAccessPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IoTHubSharedAccessPolicy>(
            guardedValue,
            (value) => IoTHubSharedAccessPolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sku: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IoTHubSku.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
