  ...
  factory IotHubDpsState.fromMap(Map<String, dynamic> map) {
    return IotHubDpsState(
      ...
      deviceProvisioningHostName: (() {
        final guardedValue = map['deviceProvisioningHostName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      idScope: (() {
        final guardedValue = map['idScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipFilterRules: (() {
      ...
      serviceOperationsHostName: (() {
        final guardedValue = map['serviceOperationsHostName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sku: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IotHubDpsSku.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
