    ...
    return <String, dynamic>{
      ...
      'ipRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<IoTHubNetworkRuleSetIpRule>,
  ...
  factory IoTHubNetworkRuleSet.fromMap(Map<String, dynamic> map) {
    return IoTHubNetworkRuleSet(
      applyToBuiltinEventhubEndpoint: (() {
        final guardedValue = map['applyToBuiltinEventhubEndpoint'];
      ...
      ipRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IoTHubNetworkRuleSetIpRule>(
            guardedValue,
            (value) => IoTHubNetworkRuleSetIpRule.fromMap(
