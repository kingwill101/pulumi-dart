...
class SecuritySolutionArgs {
  ...
  final pulumi.Input<List<SecuritySolutionAdditionalWorkspace>>?
  ...
  final pulumi.Input<SecuritySolutionRecommendationsEnabled>?
    ...
    return <String, dynamic>{
      'additionalWorkspaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecuritySolutionAdditionalWorkspace>,
      ...
      'recommendationsEnabled':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(recommendationsEnabled, (value) => value.toMap()),
    ...
    return SecuritySolutionArgs(
      additionalWorkspaces: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SecuritySolutionAdditionalWorkspace>(
            guardedValue,
            (value) => SecuritySolutionAdditionalWorkspace.fromMap(
      ...
      eventsToExports: (() {
        final guardedValue = map['eventsToExports'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      iothubIds: pulumi.Input.fromValue(
        (map['iothubIds'] as List).cast<String>(),
      ),
      location: (() {
      ...
      logUnmaskedIpsEnabled: (() {
        final guardedValue = map['logUnmaskedIpsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: (() {
      ...
      queryForResources: (() {
        final guardedValue = map['queryForResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      querySubscriptionIds: (() {
        final guardedValue = map['querySubscriptionIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      recommendationsEnabled: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecuritySolutionRecommendationsEnabled.fromMap(
