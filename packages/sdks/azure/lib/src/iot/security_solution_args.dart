...
class SecuritySolutionArgs {
  ...
  SecuritySolutionArgs({
    ...
    required pulumi.Output<List<String>> iothubIds,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      iothubIds = pulumi.Input.asInput<List<String>>(iothubIds),
  ...
  factory SecuritySolutionArgs.fromMap(Map<String, dynamic> map) {
    return SecuritySolutionArgs(
      ...
      iothubIds: pulumi.Output.create<List<String>>((map['iothubIds'] as List).cast<String>()),
