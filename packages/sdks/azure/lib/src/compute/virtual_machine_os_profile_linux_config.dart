...
class VirtualMachineOsProfileLinuxConfig {
  ...
  /// [sshKeys] One or more `sshKeys` blocks as defined below. This field is required if `disablePasswordAuthentication` is set to `true`.
  const VirtualMachineOsProfileLinuxConfig({
