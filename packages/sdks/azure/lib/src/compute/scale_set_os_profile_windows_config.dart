...
class ScaleSetOsProfileWindowsConfig {
  ...
  final pulumi.Input<
    List<ScaleSetOsProfileWindowsConfigAdditionalUnattendConfig>
  >?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'winrms':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScaleSetOsProfileWindowsConfigWinrm>,
            List<Map<String, dynamic>>
          >(
            winrms,
            (value) =>
  ...
  factory ScaleSetOsProfileWindowsConfig.fromMap(Map<String, dynamic> map) {
    return ScaleSetOsProfileWindowsConfig(
      additionalUnattendConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ScaleSetOsProfileWindowsConfigAdditionalUnattendConfig.fromMap(
      ...
      winrms: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScaleSetOsProfileWindowsConfigWinrm>(
            guardedValue,
            (value) => ScaleSetOsProfileWindowsConfigWinrm.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
