...
class ScaleSetOsProfileWindowsConfig {
  ...
  final List<ScaleSetOsProfileWindowsConfigAdditionalUnattendConfig>? additionalUnattendConfigs;
  ...
  final List<ScaleSetOsProfileWindowsConfigWinrm>? winrms;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalUnattendConfigs': ?additionalUnattendConfigs == null ? null : pulumi.Input.encodeList<ScaleSetOsProfileWindowsConfigAdditionalUnattendConfig, Map<String, dynamic>>(additionalUnattendConfigs!, (value) => value.toMap()),
      'enableAutomaticUpgrades': ?enableAutomaticUpgrades,
      'provisionVmAgent': ?provisionVmAgent,
      'winrms': ?winrms == null ? null : pulumi.Input.encodeList<ScaleSetOsProfileWindowsConfigWinrm, Map<String, dynamic>>(winrms!, (value) => value.toMap()),
    };
  }

  factory ScaleSetOsProfileWindowsConfig.fromMap(Map<String, dynamic> map) {
    return ScaleSetOsProfileWindowsConfig(
      additionalUnattendConfigs: map['additionalUnattendConfigs'] == null ? null : pulumi.Input.decodeList<ScaleSetOsProfileWindowsConfigAdditionalUnattendConfig>(map['additionalUnattendConfigs'], (value) => ScaleSetOsProfileWindowsConfigAdditionalUnattendConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      winrms: map['winrms'] == null ? null : pulumi.Input.decodeList<ScaleSetOsProfileWindowsConfigWinrm>(map['winrms'], (value) => ScaleSetOsProfileWindowsConfigWinrm.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
