...
class OrchestratedVirtualMachineScaleSetOsProfile {
  ...
  factory OrchestratedVirtualMachineScaleSetOsProfile.fromMap(Map<String, dynamic> map) {
    return OrchestratedVirtualMachineScaleSetOsProfile(
      ...
      linuxConfiguration: (() { final guardedValue = map['linuxConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrchestratedVirtualMachineScaleSetOsProfileLinuxConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      windowsConfiguration: (() { final guardedValue = map['windowsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrchestratedVirtualMachineScaleSetOsProfileWindowsConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
