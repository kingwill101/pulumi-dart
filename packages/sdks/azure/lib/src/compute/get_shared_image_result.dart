    ...
    return <String, dynamic>{
      ...
      'purchasePlans':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(purchasePlans, (value) => value.toMap()),
  ...
  factory GetSharedImageResult.fromMap(Map<String, dynamic> map) {
    return GetSharedImageResult(
      acceleratedNetworkSupportEnabled:
          map['acceleratedNetworkSupportEnabled'] as bool,
      ...
      id: map['id'] as String,
      identifiers: pulumi.Input.decodeList<GetSharedImageIdentifier>(
        map['identifiers']!,
        (value) => GetSharedImageIdentifier.fromMap(
      ...
      purchasePlans: pulumi.Input.decodeList<GetSharedImagePurchasePlan>(
        map['purchasePlans']!,
        (value) => GetSharedImagePurchasePlan.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
