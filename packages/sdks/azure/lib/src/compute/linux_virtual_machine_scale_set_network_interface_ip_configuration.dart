...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
  ...
  factory LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration(
      ...
      publicIpAddresses: map['publicIpAddresses'] == null ? null : (pulumi.Input.decodeList<LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress>(map['publicIpAddresses']!, (value) => LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress.fromMap((value as Map).cast<String, dynamic>()))).input(),
