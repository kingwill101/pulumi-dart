...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
  ...
  factory LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(
      ...
      publicIpAddresses: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress.fromMap(
