...
class LinuxVirtualMachineArgs {
  ...
  LinuxVirtualMachineArgs({
    ...
    required pulumi.Output<LinuxVirtualMachineOsDisk> osDisk,
  ...
  factory LinuxVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineArgs(
      ...
      osDisk: pulumi.Output.create<LinuxVirtualMachineOsDisk>(LinuxVirtualMachineOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())),
