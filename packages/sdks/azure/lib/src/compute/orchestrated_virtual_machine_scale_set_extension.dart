...
class OrchestratedVirtualMachineScaleSetExtension {
  ...
  const OrchestratedVirtualMachineScaleSetExtension({
  ...
  factory OrchestratedVirtualMachineScaleSetExtension.fromMap(Map<String, dynamic> map) {
    return OrchestratedVirtualMachineScaleSetExtension(
      ...
      extensionsToProvisionAfterVmCreations: (() { final guardedValue = map['extensionsToProvisionAfterVmCreations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      forceExtensionExecutionOnChange: (() { final guardedValue = map['forceExtensionExecutionOnChange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      protectedSettingsFromKeyVault: (() { final guardedValue = map['protectedSettingsFromKeyVault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrchestratedVirtualMachineScaleSetExtensionProtectedSettingsFromKeyVault.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
