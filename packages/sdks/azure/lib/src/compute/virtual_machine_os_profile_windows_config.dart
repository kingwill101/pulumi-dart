...
class VirtualMachineOsProfileWindowsConfig {
  ...
  factory VirtualMachineOsProfileWindowsConfig.fromMap(Map<String, dynamic> map) {
    return VirtualMachineOsProfileWindowsConfig(
      additionalUnattendConfigs: (() { final guardedValue = map['additionalUnattendConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig>(guardedValue, (value) => VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      winrms: (() { final guardedValue = map['winrms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineOsProfileWindowsConfigWinrm>(guardedValue, (value) => VirtualMachineOsProfileWindowsConfigWinrm.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
