...
class LinuxVirtualMachineState {
  ...
  factory LinuxVirtualMachineState.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineState(
      additionalCapabilities: map['additionalCapabilities'] == null ? null : (LinuxVirtualMachineAdditionalCapabilities.fromMap((map['additionalCapabilities'] as Map).cast<String, dynamic>())).input(),
      adminPassword: map['adminPassword'] == null ? null : (map['adminPassword'] as String).input(),
      adminSshKeys: map['adminSshKeys'] == null ? null : (pulumi.Input.decodeList<LinuxVirtualMachineAdminSshKey>(map['adminSshKeys'], (value) => LinuxVirtualMachineAdminSshKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      bootDiagnostics: map['bootDiagnostics'] == null ? null : (LinuxVirtualMachineBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>())).input(),
      ...
      galleryApplications: map['galleryApplications'] == null ? null : (pulumi.Input.decodeList<LinuxVirtualMachineGalleryApplication>(map['galleryApplications'], (value) => LinuxVirtualMachineGalleryApplication.fromMap((value as Map).cast<String, dynamic>()))).input(),
      identity: map['identity'] == null ? null : (LinuxVirtualMachineIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())).input(),
      ...
      osDisk: map['osDisk'] == null ? null : (LinuxVirtualMachineOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())).input(),
      osImageNotification: map['osImageNotification'] == null ? null : (LinuxVirtualMachineOsImageNotification.fromMap((map['osImageNotification'] as Map).cast<String, dynamic>())).input(),
      ...
      plan: map['plan'] == null ? null : (LinuxVirtualMachinePlan.fromMap((map['plan'] as Map).cast<String, dynamic>())).input(),
      ...
      secrets: map['secrets'] == null ? null : (pulumi.Input.decodeList<LinuxVirtualMachineSecret>(map['secrets'], (value) => LinuxVirtualMachineSecret.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      sourceImageReference: map['sourceImageReference'] == null ? null : (LinuxVirtualMachineSourceImageReference.fromMap((map['sourceImageReference'] as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      terminationNotification: map['terminationNotification'] == null ? null : (LinuxVirtualMachineTerminationNotification.fromMap((map['terminationNotification'] as Map).cast<String, dynamic>())).input(),
