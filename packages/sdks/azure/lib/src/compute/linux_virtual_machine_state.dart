...
class LinuxVirtualMachineState {
  ...
  LinuxVirtualMachineState({
    pulumi.Output<LinuxVirtualMachineAdditionalCapabilities>? additionalCapabilities,
    pulumi.Output<String>? adminPassword,
    pulumi.Output<List<LinuxVirtualMachineAdminSshKey>>? adminSshKeys,
    pulumi.Output<String>? adminUsername,
    pulumi.Output<bool>? allowExtensionOperations,
    pulumi.Output<String>? availabilitySetId,
    pulumi.Output<LinuxVirtualMachineBootDiagnostics>? bootDiagnostics,
    ...
    pulumi.Output<List<LinuxVirtualMachineGalleryApplication>>? galleryApplications,
    pulumi.Output<LinuxVirtualMachineIdentity>? identity,
    pulumi.Output<String>? licenseType,
    pulumi.Output<String>? location,
    pulumi.Output<double>? maxBidPrice,
    pulumi.Output<String>? name,
    pulumi.Output<List<String>>? networkInterfaceIds,
    pulumi.Output<LinuxVirtualMachineOsDisk>? osDisk,
    pulumi.Output<LinuxVirtualMachineOsImageNotification>? osImageNotification,
    pulumi.Output<String>? osManagedDiskId,
    pulumi.Output<String>? patchAssessmentMode,
    pulumi.Output<String>? patchMode,
    pulumi.Output<LinuxVirtualMachinePlan>? plan,
    ...
    pulumi.Output<List<LinuxVirtualMachineSecret>>? secrets,
    pulumi.Output<bool>? secureBootEnabled,
    pulumi.Output<String>? size,
    pulumi.Output<String>? sourceImageId,
    pulumi.Output<LinuxVirtualMachineSourceImageReference>? sourceImageReference,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<LinuxVirtualMachineTerminationNotification>? terminationNotification,
    ...
    pulumi.Output<String>? zone,
      ...
      osDisk = pulumi.Input.asOptionalInput<LinuxVirtualMachineOsDisk>(osDisk),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osDisk': ?pulumi.Input.mapOptionalInputValue<LinuxVirtualMachineOsDisk, Map<String, dynamic>>(osDisk, (value) => value.toMap()),
  ...
  factory LinuxVirtualMachineState.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineState(
      additionalCapabilities: map['additionalCapabilities'] == null ? null : pulumi.Output.create<LinuxVirtualMachineAdditionalCapabilities>(LinuxVirtualMachineAdditionalCapabilities.fromMap((map['additionalCapabilities'] as Map).cast<String, dynamic>())),
      adminPassword: map['adminPassword'] == null ? null : pulumi.Output.create<String>(map['adminPassword'] as String),
      adminSshKeys: map['adminSshKeys'] == null ? null : pulumi.Output.create<List<LinuxVirtualMachineAdminSshKey>>(pulumi.Input.decodeList<LinuxVirtualMachineAdminSshKey>(map['adminSshKeys'], (value) => LinuxVirtualMachineAdminSshKey.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      bootDiagnostics: map['bootDiagnostics'] == null ? null : pulumi.Output.create<LinuxVirtualMachineBootDiagnostics>(LinuxVirtualMachineBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>())),
      ...
      galleryApplications: map['galleryApplications'] == null ? null : pulumi.Output.create<List<LinuxVirtualMachineGalleryApplication>>(pulumi.Input.decodeList<LinuxVirtualMachineGalleryApplication>(map['galleryApplications'], (value) => LinuxVirtualMachineGalleryApplication.fromMap((value as Map).cast<String, dynamic>()))),
      identity: map['identity'] == null ? null : pulumi.Output.create<LinuxVirtualMachineIdentity>(LinuxVirtualMachineIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      osDisk: map['osDisk'] == null ? null : pulumi.Output.create<LinuxVirtualMachineOsDisk>(LinuxVirtualMachineOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())),
      osImageNotification: map['osImageNotification'] == null ? null : pulumi.Output.create<LinuxVirtualMachineOsImageNotification>(LinuxVirtualMachineOsImageNotification.fromMap((map['osImageNotification'] as Map).cast<String, dynamic>())),
      ...
      plan: map['plan'] == null ? null : pulumi.Output.create<LinuxVirtualMachinePlan>(LinuxVirtualMachinePlan.fromMap((map['plan'] as Map).cast<String, dynamic>())),
      ...
      secrets: map['secrets'] == null ? null : pulumi.Output.create<List<LinuxVirtualMachineSecret>>(pulumi.Input.decodeList<LinuxVirtualMachineSecret>(map['secrets'], (value) => LinuxVirtualMachineSecret.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sourceImageReference: map['sourceImageReference'] == null ? null : pulumi.Output.create<LinuxVirtualMachineSourceImageReference>(LinuxVirtualMachineSourceImageReference.fromMap((map['sourceImageReference'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      terminationNotification: map['terminationNotification'] == null ? null : pulumi.Output.create<LinuxVirtualMachineTerminationNotification>(LinuxVirtualMachineTerminationNotification.fromMap((map['terminationNotification'] as Map).cast<String, dynamic>())),
