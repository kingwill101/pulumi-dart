...
class WindowsVirtualMachineScaleSetScaleIn {
  ...
  WindowsVirtualMachineScaleSetScaleIn({this.forceDeletionEnabled, this.rule});
  ...
  factory WindowsVirtualMachineScaleSetScaleIn.fromMap(
    Map<String, dynamic> map,
  ) {
    return WindowsVirtualMachineScaleSetScaleIn(
      forceDeletionEnabled: (() {
        final guardedValue = map['forceDeletionEnabled'];
