...
class ScaleSetOsProfileSecret {
  ...
  factory ScaleSetOsProfileSecret.fromMap(Map<String, dynamic> map) {
    return ScaleSetOsProfileSecret(
      ...
      vaultCertificates: (() { final guardedValue = map['vaultCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScaleSetOsProfileSecretVaultCertificate>(guardedValue, (value) => ScaleSetOsProfileSecretVaultCertificate.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
