...
class ManagedDiskState {
  ...
  ManagedDiskState({
    ...
    pulumi.Output<int>? diskIopsReadOnly,
    pulumi.Output<int>? diskIopsReadWrite,
    pulumi.Output<int>? diskMbpsReadOnly,
    pulumi.Output<int>? diskMbpsReadWrite,
    pulumi.Output<int>? diskSizeGb,
    pulumi.Output<String>? edgeZone,
    pulumi.Output<ManagedDiskEncryptionSettings>? encryptionSettings,
    pulumi.Output<String>? galleryImageReferenceId,
    pulumi.Output<String>? hyperVGeneration,
    pulumi.Output<String>? imageReferenceId,
    pulumi.Output<String>? location,
    pulumi.Output<int>? logicalSectorSize,
    pulumi.Output<int>? maxShares,
    pulumi.Output<String>? name,
    pulumi.Output<String>? networkAccessPolicy,
    pulumi.Output<bool>? onDemandBurstingEnabled,
    pulumi.Output<bool>? optimizedFrequentAttachEnabled,
    pulumi.Output<String>? osType,
    pulumi.Output<bool>? performancePlusEnabled,
    pulumi.Output<bool>? publicNetworkAccessEnabled,
    pulumi.Output<String>? resourceGroupName,
    pulumi.Output<String>? secureVmDiskEncryptionSetId,
    ...
    pulumi.Output<int>? uploadSizeBytes,
    pulumi.Output<String>? zone,
      ...
      diskIopsReadOnly = pulumi.Input.asOptionalInput<int>(diskIopsReadOnly),
      diskIopsReadWrite = pulumi.Input.asOptionalInput<int>(diskIopsReadWrite),
      diskMbpsReadOnly = pulumi.Input.asOptionalInput<int>(diskMbpsReadOnly),
      diskMbpsReadWrite = pulumi.Input.asOptionalInput<int>(diskMbpsReadWrite),
      diskSizeGb = pulumi.Input.asOptionalInput<int>(diskSizeGb),
      edgeZone = pulumi.Input.asOptionalInput<String>(edgeZone),
      encryptionSettings = pulumi.Input.asOptionalInput<ManagedDiskEncryptionSettings>(encryptionSettings),
      galleryImageReferenceId = pulumi.Input.asOptionalInput<String>(galleryImageReferenceId),
      ...
      logicalSectorSize = pulumi.Input.asOptionalInput<int>(logicalSectorSize),
      ...
      onDemandBurstingEnabled = pulumi.Input.asOptionalInput<bool>(onDemandBurstingEnabled),
      optimizedFrequentAttachEnabled = pulumi.Input.asOptionalInput<bool>(optimizedFrequentAttachEnabled),
      osType = pulumi.Input.asOptionalInput<String>(osType),
      performancePlusEnabled = pulumi.Input.asOptionalInput<bool>(performancePlusEnabled),
      publicNetworkAccessEnabled = pulumi.Input.asOptionalInput<bool>(publicNetworkAccessEnabled),
      resourceGroupName = pulumi.Input.asOptionalInput<String>(resourceGroupName),
      secureVmDiskEncryptionSetId = pulumi.Input.asOptionalInput<String>(secureVmDiskEncryptionSetId),
      ...
      uploadSizeBytes = pulumi.Input.asOptionalInput<int>(uploadSizeBytes),
  ...
  factory ManagedDiskState.fromMap(Map<String, dynamic> map) {
    return ManagedDiskState(
      ...
      diskIopsReadOnly: map['diskIopsReadOnly'] == null ? null : pulumi.Output.create<int>(map['diskIopsReadOnly'] as int),
      diskIopsReadWrite: map['diskIopsReadWrite'] == null ? null : pulumi.Output.create<int>(map['diskIopsReadWrite'] as int),
      diskMbpsReadOnly: map['diskMbpsReadOnly'] == null ? null : pulumi.Output.create<int>(map['diskMbpsReadOnly'] as int),
      diskMbpsReadWrite: map['diskMbpsReadWrite'] == null ? null : pulumi.Output.create<int>(map['diskMbpsReadWrite'] as int),
      ...
      encryptionSettings: map['encryptionSettings'] == null ? null : pulumi.Output.create<ManagedDiskEncryptionSettings>(ManagedDiskEncryptionSettings.fromMap((map['encryptionSettings'] as Map).cast<String, dynamic>())),
      galleryImageReferenceId: map['galleryImageReferenceId'] == null ? null : pulumi.Output.create<String>(map['galleryImageReferenceId'] as String),
      ...
      logicalSectorSize: map['logicalSectorSize'] == null ? null : pulumi.Output.create<int>(map['logicalSectorSize'] as int),
      maxShares: map['maxShares'] == null ? null : pulumi.Output.create<int>(map['maxShares'] as int),
      ...
      onDemandBurstingEnabled: map['onDemandBurstingEnabled'] == null ? null : pulumi.Output.create<bool>(map['onDemandBurstingEnabled'] as bool),
      optimizedFrequentAttachEnabled: map['optimizedFrequentAttachEnabled'] == null ? null : pulumi.Output.create<bool>(map['optimizedFrequentAttachEnabled'] as bool),
      osType: map['osType'] == null ? null : pulumi.Output.create<String>(map['osType'] as String),
      performancePlusEnabled: map['performancePlusEnabled'] == null ? null : pulumi.Output.create<bool>(map['performancePlusEnabled'] as bool),
      publicNetworkAccessEnabled: map['publicNetworkAccessEnabled'] == null ? null : pulumi.Output.create<bool>(map['publicNetworkAccessEnabled'] as bool),
      resourceGroupName: map['resourceGroupName'] == null ? null : pulumi.Output.create<String>(map['resourceGroupName'] as String),
      secureVmDiskEncryptionSetId: map['secureVmDiskEncryptionSetId'] == null ? null : pulumi.Output.create<String>(map['secureVmDiskEncryptionSetId'] as String),
      ...
      uploadSizeBytes: map['uploadSizeBytes'] == null ? null : pulumi.Output.create<int>(map['uploadSizeBytes'] as int),
