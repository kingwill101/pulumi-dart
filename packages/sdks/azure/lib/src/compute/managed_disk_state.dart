    ...
    return ManagedDiskState(
      ...
      encryptionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ManagedDiskEncryptionSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      galleryImageReferenceId: (() {
        final guardedValue = map['galleryImageReferenceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hyperVGeneration: (() {
      ...
      logicalSectorSize: (() {
        final guardedValue = map['logicalSectorSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxShares: (() {
      ...
      onDemandBurstingEnabled: (() {
        final guardedValue = map['onDemandBurstingEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      optimizedFrequentAttachEnabled: (() {
        final guardedValue = map['optimizedFrequentAttachEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      osType: (() {
      ...
      performancePlusEnabled: (() {
        final guardedValue = map['performancePlusEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      uploadSizeBytes: (() {
        final guardedValue = map['uploadSizeBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      zone: (() {
