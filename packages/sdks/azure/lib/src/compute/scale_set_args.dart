...
class ScaleSetArgs {
  ...
  final pulumi.Input<List<ScaleSetStorageProfileDataDisk>>?
  storageProfileDataDisks;

  /// A `storage_profile_image_reference` block as documented below.
  final pulumi.Input<ScaleSetStorageProfileImageReference>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osProfile':
          pulumi.Input.mapInputValue<ScaleSetOsProfile, Map<String, dynamic>>(
            osProfile,
            (value) => value.toMap(),
          ),
      ...
      'sku': pulumi.Input.mapInputValue<ScaleSetSku, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
      'storageProfileDataDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScaleSetStorageProfileDataDisk>,
            List<Map<String, dynamic>>
          >(
            storageProfileDataDisks,
            (value) =>
      ...
      'storageProfileImageReference':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(storageProfileImageReference, (value) => value.toMap()),
      'storageProfileOsDisk':
          pulumi.Input.mapInputValue<
            ScaleSetStorageProfileOsDisk,
            Map<String, dynamic>
          >(storageProfileOsDisk, (value) => value.toMap()),
      'tags': ?tags,
  ...
  factory ScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return ScaleSetArgs(
      automaticOsUpgrade: (() {
        final guardedValue = map['automaticOsUpgrade'];
      ...
      bootDiagnostics: (() {
        ...
        return pulumi.Input.fromValue(
          ScaleSetBootDiagnostics.fromMap(
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScaleSetExtension>(
            guardedValue,
            (value) => ScaleSetExtension.fromMap(
      ...
      networkProfiles: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ScaleSetNetworkProfile>(
          map['networkProfiles']!,
          (value) => ScaleSetNetworkProfile.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      osProfile: pulumi.Input.fromValue(
        ScaleSetOsProfile.fromMap(
      ...
      osProfileLinuxConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScaleSetOsProfileLinuxConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      osProfileSecrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScaleSetOsProfileSecret>(
            guardedValue,
            (value) => ScaleSetOsProfileSecret.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      osProfileWindowsConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScaleSetOsProfileWindowsConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      plan: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScaleSetPlan.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      priority: (() {
      ...
      rollingUpgradePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScaleSetRollingUpgradePolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sku: pulumi.Input.fromValue(
        ScaleSetSku.fromMap((map['sku']! as Map).cast<String, dynamic>()),
      ),
      storageProfileDataDisks: (() {
        final guardedValue = map['storageProfileDataDisks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScaleSetStorageProfileDataDisk>(
            guardedValue,
            (value) => ScaleSetStorageProfileDataDisk.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      storageProfileImageReference: (() {
        final guardedValue = map['storageProfileImageReference'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScaleSetStorageProfileImageReference.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      storageProfileOsDisk: pulumi.Input.fromValue(
        ScaleSetStorageProfileOsDisk.fromMap(
          (map['storageProfileOsDisk']! as Map).cast<String, dynamic>(),
        ),
      ),
      tags: (() {
      ...
      upgradePolicyMode: pulumi.Input.fromValue(
        map['upgradePolicyMode'] as String,
      ),
      zones: (() {
