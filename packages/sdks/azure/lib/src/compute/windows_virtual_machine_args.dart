...
class WindowsVirtualMachineArgs {
  ...
  WindowsVirtualMachineArgs({
    ...
    required pulumi.Output<WindowsVirtualMachineOsDisk> osDisk,
  ...
  factory WindowsVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineArgs(
      ...
      osDisk: pulumi.Output.create<WindowsVirtualMachineOsDisk>(WindowsVirtualMachineOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())),
