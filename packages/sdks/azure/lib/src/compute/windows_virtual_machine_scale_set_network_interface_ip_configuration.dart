...
import 'windows_virtual_machine_scale_set_network_interface_ip_configuration_public_ip_address.dart';
...
class WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
  ...
  final List<WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress>? publicIpAddresses;
  ...
  /// Creates a new [WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'primary': ?primary,
      'publicIpAddresses': ?publicIpAddresses == null ? null : pulumi.Input.encodeList<WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress, Map<String, dynamic>>(publicIpAddresses!, (value) => value.toMap()),
      'subnetId': ?subnetId,
      'version': ?version,
    };
  }
  ...
  factory WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration(
      ...
      publicIpAddresses: map['publicIpAddresses'] == null ? null : pulumi.Input.decodeList<WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress>(map['publicIpAddresses'], (value) => WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress.fromMap((value as Map).cast<String, dynamic>())),
