...
class WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
  ...
  final pulumi.Input<List<WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress>>? publicIpAddresses;
  ...
  const WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration({
  ...
  factory WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration(
      ...
      publicIpAddresses: (() { final guardedValue = map['publicIpAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress>(guardedValue, (value) => WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress.fromMap((value as Map).cast<String, dynamic>()))); })(),
