...
class WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
  ...
  factory WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return WindowsVirtualMachineScaleSetNetworkInterfaceIpConfiguration(
      applicationGatewayBackendAddressPoolIds: (() {
        final guardedValue = map['applicationGatewayBackendAddressPoolIds'];
      ...
      loadBalancerBackendAddressPoolIds: (() {
        final guardedValue = map['loadBalancerBackendAddressPoolIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      loadBalancerInboundNatRulesIds: (() {
        final guardedValue = map['loadBalancerInboundNatRulesIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ...
      publicIpAddresses: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress.fromMap(
