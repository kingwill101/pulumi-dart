...
class LinuxVirtualMachineScaleSetArgs {
  ...
  LinuxVirtualMachineScaleSetArgs({
    ...
    required pulumi.Output<List<LinuxVirtualMachineScaleSetNetworkInterface>> networkInterfaces,
    required pulumi.Output<LinuxVirtualMachineScaleSetOsDisk> osDisk,
  ...
  factory LinuxVirtualMachineScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetArgs(
      ...
      networkInterfaces: pulumi.Output.create<List<LinuxVirtualMachineScaleSetNetworkInterface>>(pulumi.Input.decodeList<LinuxVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces'], (value) => LinuxVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      osDisk: pulumi.Output.create<LinuxVirtualMachineScaleSetOsDisk>(LinuxVirtualMachineScaleSetOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())),
