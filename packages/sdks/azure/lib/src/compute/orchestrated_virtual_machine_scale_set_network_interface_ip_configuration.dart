...
class OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
  ...
  factory OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(
      ...
      publicIpAddresses: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress.fromMap(
