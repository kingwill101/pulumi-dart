...
/// {@template pulumi_compute_virtual_machine_virtual_machine_args_doc}
...
class VirtualMachineArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'storageOsDisk': pulumi.Input.mapInputValue<VirtualMachineStorageOsDisk, Map<String, dynamic>>(storageOsDisk, (value) => value.toMap()),
      'tags': ?tags,
      'vmSize': vmSize,
      'zones': ?zones,
    };
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      bootDiagnostics: (() { final guardedValue = map['bootDiagnostics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineBootDiagnostics.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      deleteDataDisksOnTermination: (() { final guardedValue = map['deleteDataDisksOnTermination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      deleteOsDiskOnTermination: (() { final guardedValue = map['deleteOsDiskOnTermination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      osProfile: (() { final guardedValue = map['osProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineOsProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      osProfileLinuxConfig: (() { final guardedValue = map['osProfileLinuxConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineOsProfileLinuxConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      osProfileSecrets: (() { final guardedValue = map['osProfileSecrets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineOsProfileSecret>(guardedValue, (value) => VirtualMachineOsProfileSecret.fromMap((value as Map).cast<String, dynamic>()))); })(),
      osProfileWindowsConfig: (() { final guardedValue = map['osProfileWindowsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineOsProfileWindowsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      plan: (() { final guardedValue = map['plan']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachinePlan.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageDataDisks: (() { final guardedValue = map['storageDataDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineStorageDataDisk>(guardedValue, (value) => VirtualMachineStorageDataDisk.fromMap((value as Map).cast<String, dynamic>()))); })(),
      storageImageReference: (() { final guardedValue = map['storageImageReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineStorageImageReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      storageOsDisk: pulumi.Input.fromValue(VirtualMachineStorageOsDisk.fromMap((map['storageOsDisk']! as Map).cast<String, dynamic>())),
