...
class VirtualMachineArgs {
  ...
  VirtualMachineArgs({
    ...
    required pulumi.Output<List<String>> networkInterfaceIds,
    ...
    required pulumi.Output<VirtualMachineStorageOsDisk> storageOsDisk,
    ...
    pulumi.Output<String>? zones,
      ...
      storageOsDisk = pulumi.Input.asInput<VirtualMachineStorageOsDisk>(storageOsDisk),
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      networkInterfaceIds: pulumi.Output.create<List<String>>((map['networkInterfaceIds'] as List).cast<String>()),
      ...
      storageOsDisk: pulumi.Output.create<VirtualMachineStorageOsDisk>(VirtualMachineStorageOsDisk.fromMap((map['storageOsDisk'] as Map).cast<String, dynamic>())),
