...
class WindowsVirtualMachineScaleSetState {
  ...
  WindowsVirtualMachineScaleSetState({
    ...
    pulumi.Output<List<WindowsVirtualMachineScaleSetNetworkInterface>>? networkInterfaces,
    pulumi.Output<WindowsVirtualMachineScaleSetOsDisk>? osDisk,
    ...
    pulumi.Output<List<String>>? zones,
      ...
      networkInterfaces = pulumi.Input.asOptionalInput<List<WindowsVirtualMachineScaleSetNetworkInterface>>(networkInterfaces),
      osDisk = pulumi.Input.asOptionalInput<WindowsVirtualMachineScaleSetOsDisk>(osDisk),
  ...
  factory WindowsVirtualMachineScaleSetState.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineScaleSetState(
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Output.create<List<WindowsVirtualMachineScaleSetNetworkInterface>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces'], (value) => WindowsVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      osDisk: map['osDisk'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetOsDisk>(WindowsVirtualMachineScaleSetOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())),
