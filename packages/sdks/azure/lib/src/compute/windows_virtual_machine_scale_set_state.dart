...
class WindowsVirtualMachineScaleSetState {
  ...
  factory WindowsVirtualMachineScaleSetState.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineScaleSetState(
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : (pulumi.Input.decodeList<WindowsVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces'], (value) => WindowsVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
      osDisk: map['osDisk'] == null ? null : (WindowsVirtualMachineScaleSetOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())).input(),
