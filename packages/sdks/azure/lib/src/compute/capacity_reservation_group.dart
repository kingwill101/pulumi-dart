...
import 'capacity_reservation_group_state.dart';
...
class CapacityReservationGroup extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [CapacityReservationGroup]. {@macro pulumi_compute_capacity_reservation_group_capacity_reservation_group_args_doc}
  ...
  /// Gets an existing [CapacityReservationGroup] resource's state with the given [name] and [id].
  static CapacityReservationGroup get(
    String name,
    pulumi.Input<String> id, {
    CapacityReservationGroupState? state,
  }) {
    return CapacityReservationGroup._get(
      name,
      state: state?.toMap(),
