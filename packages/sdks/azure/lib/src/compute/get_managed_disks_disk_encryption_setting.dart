...
class GetManagedDisksDiskEncryptionSetting {
  ...
  factory GetManagedDisksDiskEncryptionSetting.fromMap(Map<String, dynamic> map) {
    return GetManagedDisksDiskEncryptionSetting(
      diskEncryptionKeys: (pulumi.Input.decodeList<GetManagedDisksDiskEncryptionSettingDiskEncryptionKey>(map['diskEncryptionKeys'], (value) => GetManagedDisksDiskEncryptionSettingDiskEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enabled: (map['enabled'] as bool).input(),
      keyEncryptionKeys: (pulumi.Input.decodeList<GetManagedDisksDiskEncryptionSettingKeyEncryptionKey>(map['keyEncryptionKeys'], (value) => GetManagedDisksDiskEncryptionSettingKeyEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
