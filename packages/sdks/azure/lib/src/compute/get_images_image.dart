  ...
  factory GetImagesImage.fromMap(Map<String, dynamic> map) {
    return GetImagesImage(
      dataDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetImagesImageDataDisk>(
          map['dataDisks']!,
          (value) => GetImagesImageDataDisk.fromMap(
      ...
      osDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetImagesImageOsDisk>(
          map['osDisks']!,
          (value) => GetImagesImageOsDisk.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
