...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfiguration {
  ...
  final pulumi.Input<
    List<OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecret>
  >?
  secrets;
  ...
  factory OrchestratedVirtualMachineScaleSetOsProfileWindowsConfiguration.fromMap(
      ...
      additionalUnattendContents: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationAdditionalUnattendContent.fromMap(
      ...
      secrets: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecret.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      winrmListeners: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationWinrmListener.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
