...
class GetOrchestratedVirtualMachineScaleSetResult {
  ...
  final List<GetOrchestratedVirtualMachineScaleSetNetworkInterface>
  networkInterfaces;
  ...
  factory GetOrchestratedVirtualMachineScaleSetResult.fromMap(
    ...
    return GetOrchestratedVirtualMachineScaleSetResult(
      ...
      identities:
          pulumi
              .Input.decodeList<GetOrchestratedVirtualMachineScaleSetIdentity>(
            map['identities']!,
            (value) => GetOrchestratedVirtualMachineScaleSetIdentity.fromMap(
      ...
      networkInterfaces:
          ...
          >(
            ...
            (value) =>
                GetOrchestratedVirtualMachineScaleSetNetworkInterface.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
