...
class OrchestratedVirtualMachineScaleSetOsDisk {
  ...
  final pulumi.Input<OrchestratedVirtualMachineScaleSetOsDiskDiffDiskSettings>?
  diffDiskSettings;
  ...
  factory OrchestratedVirtualMachineScaleSetOsDisk.fromMap(
    ...
    return OrchestratedVirtualMachineScaleSetOsDisk(
      ...
      diffDiskSettings: (() {
        ...
        return pulumi.Input.fromValue(
          OrchestratedVirtualMachineScaleSetOsDiskDiffDiskSettings.fromMap(
