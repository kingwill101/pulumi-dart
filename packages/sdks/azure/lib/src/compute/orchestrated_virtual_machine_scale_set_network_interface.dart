...
class OrchestratedVirtualMachineScaleSetNetworkInterface {
  ...
  final List<OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration> ipConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations': pulumi.Input.encodeList<OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration, Map<String, dynamic>>(ipConfigurations, (value) => value.toMap()),
      'name': name,
  ...
  factory OrchestratedVirtualMachineScaleSetNetworkInterface.fromMap(Map<String, dynamic> map) {
    return OrchestratedVirtualMachineScaleSetNetworkInterface(
      ...
      ipConfigurations: pulumi.Input.decodeList<OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration>(map['ipConfigurations'], (value) => OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
