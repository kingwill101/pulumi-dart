...
class WindowsVirtualMachineScaleSetOsDisk {
  ...
  final pulumi.Input<WindowsVirtualMachineScaleSetOsDiskDiffDiskSettings>?
  diffDiskSettings;
  ...
  factory WindowsVirtualMachineScaleSetOsDisk.fromMap(
    ...
    return WindowsVirtualMachineScaleSetOsDisk(
      ...
      diffDiskSettings: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsVirtualMachineScaleSetOsDiskDiffDiskSettings.fromMap(
