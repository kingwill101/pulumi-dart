...
class SharedImageVersionState {
  ...
  SharedImageVersionState({
    pulumi.Output<String>? blobUri,
    pulumi.Output<bool>? deletionOfReplicatedLocationsEnabled,
    ...
    pulumi.Output<String>? osDiskSnapshotId,
    pulumi.Output<String>? replicationMode,
    pulumi.Output<String>? resourceGroupName,
    pulumi.Output<String>? storageAccountId,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<SharedImageVersionTargetRegion>>? targetRegions,
  }) :
      ...
      targetRegions = pulumi.Input.asOptionalInput<List<SharedImageVersionTargetRegion>>(targetRegions);
  ...
  factory SharedImageVersionState.fromMap(Map<String, dynamic> map) {
    return SharedImageVersionState(
      blobUri: map['blobUri'] == null ? null : pulumi.Output.create<String>(map['blobUri'] as String),
      deletionOfReplicatedLocationsEnabled: map['deletionOfReplicatedLocationsEnabled'] == null ? null : pulumi.Output.create<bool>(map['deletionOfReplicatedLocationsEnabled'] as bool),
      ...
      osDiskSnapshotId: map['osDiskSnapshotId'] == null ? null : pulumi.Output.create<String>(map['osDiskSnapshotId'] as String),
      ...
      targetRegions: map['targetRegions'] == null ? null : pulumi.Output.create<List<SharedImageVersionTargetRegion>>(pulumi.Input.decodeList<SharedImageVersionTargetRegion>(map['targetRegions'], (value) => SharedImageVersionTargetRegion.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
