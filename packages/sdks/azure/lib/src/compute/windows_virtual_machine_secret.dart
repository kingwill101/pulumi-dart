    ...
    return <String, dynamic>{
      'certificates':
          pulumi.Input.mapInputValue<
            List<WindowsVirtualMachineSecretCertificate>,
  ...
  factory WindowsVirtualMachineSecret.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineSecret(
      certificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<WindowsVirtualMachineSecretCertificate>(
          map['certificates']!,
          (value) => WindowsVirtualMachineSecretCertificate.fromMap(
