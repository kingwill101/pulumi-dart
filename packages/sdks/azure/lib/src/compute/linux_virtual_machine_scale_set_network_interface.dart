...
class LinuxVirtualMachineScaleSetNetworkInterface {
  ...
  const LinuxVirtualMachineScaleSetNetworkInterface({
    this.auxiliaryMode,
    this.auxiliarySku,
    this.dnsServers,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations': pulumi.Input.mapInputValue<List<LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration>, List<Map<String, dynamic>>>(ipConfigurations, (value) => pulumi.Input.encodeList<LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
  ...
  factory LinuxVirtualMachineScaleSetNetworkInterface.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetNetworkInterface(
      ...
      ipConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration>(map['ipConfigurations']!, (value) => LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
