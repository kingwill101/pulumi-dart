...
class LinuxVirtualMachineScaleSetNetworkInterface {
  ...
  final pulumi.Input<
    List<LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration>
  >
  ipConfigurations;
  ...
  factory LinuxVirtualMachineScaleSetNetworkInterface.fromMap(
    ...
    return LinuxVirtualMachineScaleSetNetworkInterface(
      ...
      ipConfigurations: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(
