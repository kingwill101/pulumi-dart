...
class OrchestratedVirtualMachineScaleSetOsProfileLinuxConfiguration {
  ...
  final pulumi.Input<
    List<OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecret>
  >?
  secrets;
  ...
  factory OrchestratedVirtualMachineScaleSetOsProfileLinuxConfiguration.fromMap(
      ...
      adminSshKeys: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKey.fromMap(
      ...
      secrets: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecret.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
