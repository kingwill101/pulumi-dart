...
class OrchestratedVirtualMachineScaleSetOsProfileLinuxConfiguration {
  ...
  /// [adminSshKeys] An `adminSshKey` block as defined above.
  ...
  /// [disablePasswordAuthentication] When an `adminPassword` is specified `disablePasswordAuthentication` must be set to `false`. Defaults to `true`.
  ...
  /// [patchMode] Specifies the mode of in-guest patching of this Linux Virtual Machine. Possible values are `ImageDefault` and `AutomaticByPlatform`. Defaults to `ImageDefault`. For more information on patch modes please see the [product documentation](https://docs.microsoft.com/azure/virtual-machines/automatic-vm-guest-patching#patch-orchestration-modes).
  ...
  factory OrchestratedVirtualMachineScaleSetOsProfileLinuxConfiguration.fromMap(Map<String, dynamic> map) {
    return OrchestratedVirtualMachineScaleSetOsProfileLinuxConfiguration(
      ...
      adminSshKeys: (() { final guardedValue = map['adminSshKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKey>(guardedValue, (value) => OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      secrets: (() { final guardedValue = map['secrets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecret>(guardedValue, (value) => OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecret.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
