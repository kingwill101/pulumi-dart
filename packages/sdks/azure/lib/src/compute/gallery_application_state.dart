...
class GalleryApplicationState {
  ...
  factory GalleryApplicationState.fromMap(Map<String, dynamic> map) {
    return GalleryApplicationState(
      ...
      galleryId: (() { final guardedValue = map['galleryId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      supportedOsType: (() { final guardedValue = map['supportedOsType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
