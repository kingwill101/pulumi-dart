...
class SharedImageVersionArgs {
  ...
  SharedImageVersionArgs({
    ...
    required pulumi.Output<List<SharedImageVersionTargetRegion>> targetRegions,
  }) :
  ...
  factory SharedImageVersionArgs.fromMap(Map<String, dynamic> map) {
    return SharedImageVersionArgs(
      ...
      targetRegions: pulumi.Output.create<List<SharedImageVersionTargetRegion>>(pulumi.Input.decodeList<SharedImageVersionTargetRegion>(map['targetRegions'], (value) => SharedImageVersionTargetRegion.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
