...
class OrchestratedVirtualMachineScaleSetDataDisk {
  ...
  /// [diskSizeGb] The size of the Data Disk which should be created. Required if `createOption` is specified as `Empty`.
  /// [lun] The Logical Unit Number of the Data Disk, which must be unique within the Virtual Machine. Required if `createOption` is specified as `Empty`.
  /// [storageAccountType] The Type of Storage Account which should back this Data Disk. Possible values are `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS`, `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, and `UltraSSD_LRS`.
  ...
  const OrchestratedVirtualMachineScaleSetDataDisk({
