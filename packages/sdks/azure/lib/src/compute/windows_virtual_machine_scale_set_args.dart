...
class WindowsVirtualMachineScaleSetArgs {
  ...
  WindowsVirtualMachineScaleSetArgs({
    pulumi.Output<WindowsVirtualMachineScaleSetAdditionalCapabilities>? additionalCapabilities,
    pulumi.Output<List<WindowsVirtualMachineScaleSetAdditionalUnattendContent>>? additionalUnattendContents,
    required pulumi.Output<String> adminPassword,
    required pulumi.Output<String> adminUsername,
    pulumi.Output<WindowsVirtualMachineScaleSetAutomaticInstanceRepair>? automaticInstanceRepair,
    pulumi.Output<WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicy>? automaticOsUpgradePolicy,
    pulumi.Output<WindowsVirtualMachineScaleSetBootDiagnostics>? bootDiagnostics,
    pulumi.Output<String>? capacityReservationGroupId,
    pulumi.Output<String>? computerNamePrefix,
    pulumi.Output<String>? customData,
    pulumi.Output<List<WindowsVirtualMachineScaleSetDataDisk>>? dataDisks,
    ...
    pulumi.Output<List<WindowsVirtualMachineScaleSetExtension>>? extensions,
    pulumi.Output<String>? extensionsTimeBudget,
    pulumi.Output<List<WindowsVirtualMachineScaleSetGalleryApplication>>? galleryApplications,
    pulumi.Output<String>? healthProbeId,
    pulumi.Output<String>? hostGroupId,
    pulumi.Output<WindowsVirtualMachineScaleSetIdentity>? identity,
    required pulumi.Output<int> instances,
    pulumi.Output<String>? licenseType,
    pulumi.Output<String>? location,
    pulumi.Output<double>? maxBidPrice,
    pulumi.Output<String>? name,
    required pulumi.Output<List<WindowsVirtualMachineScaleSetNetworkInterface>> networkInterfaces,
    required pulumi.Output<WindowsVirtualMachineScaleSetOsDisk> osDisk,
    pulumi.Output<bool>? overprovision,
    pulumi.Output<WindowsVirtualMachineScaleSetPlan>? plan,
    ...
    pulumi.Output<WindowsVirtualMachineScaleSetRollingUpgradePolicy>? rollingUpgradePolicy,
    pulumi.Output<WindowsVirtualMachineScaleSetScaleIn>? scaleIn,
    pulumi.Output<List<WindowsVirtualMachineScaleSetSecret>>? secrets,
    ...
    pulumi.Output<WindowsVirtualMachineScaleSetSourceImageReference>? sourceImageReference,
    pulumi.Output<WindowsVirtualMachineScaleSetSpotRestore>? spotRestore,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<WindowsVirtualMachineScaleSetTerminationNotification>? terminationNotification,
    pulumi.Output<String>? timezone,
    pulumi.Output<String>? upgradeMode,
    pulumi.Output<String>? userData,
    pulumi.Output<bool>? vtpmEnabled,
    pulumi.Output<List<WindowsVirtualMachineScaleSetWinrmListener>>? winrmListeners,
  ...
  factory WindowsVirtualMachineScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineScaleSetArgs(
      additionalCapabilities: map['additionalCapabilities'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetAdditionalCapabilities>(WindowsVirtualMachineScaleSetAdditionalCapabilities.fromMap((map['additionalCapabilities'] as Map).cast<String, dynamic>())),
      additionalUnattendContents: map['additionalUnattendContents'] == null ? null : pulumi.Output.create<List<WindowsVirtualMachineScaleSetAdditionalUnattendContent>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetAdditionalUnattendContent>(map['additionalUnattendContents'], (value) => WindowsVirtualMachineScaleSetAdditionalUnattendContent.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      automaticInstanceRepair: map['automaticInstanceRepair'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetAutomaticInstanceRepair>(WindowsVirtualMachineScaleSetAutomaticInstanceRepair.fromMap((map['automaticInstanceRepair'] as Map).cast<String, dynamic>())),
      automaticOsUpgradePolicy: map['automaticOsUpgradePolicy'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicy>(WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicy.fromMap((map['automaticOsUpgradePolicy'] as Map).cast<String, dynamic>())),
      bootDiagnostics: map['bootDiagnostics'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetBootDiagnostics>(WindowsVirtualMachineScaleSetBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>())),
      ...
      dataDisks: map['dataDisks'] == null ? null : pulumi.Output.create<List<WindowsVirtualMachineScaleSetDataDisk>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetDataDisk>(map['dataDisks'], (value) => WindowsVirtualMachineScaleSetDataDisk.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      extensions: map['extensions'] == null ? null : pulumi.Output.create<List<WindowsVirtualMachineScaleSetExtension>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetExtension>(map['extensions'], (value) => WindowsVirtualMachineScaleSetExtension.fromMap((value as Map).cast<String, dynamic>()))),
      extensionsTimeBudget: map['extensionsTimeBudget'] == null ? null : pulumi.Output.create<String>(map['extensionsTimeBudget'] as String),
      galleryApplications: map['galleryApplications'] == null ? null : pulumi.Output.create<List<WindowsVirtualMachineScaleSetGalleryApplication>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetGalleryApplication>(map['galleryApplications'], (value) => WindowsVirtualMachineScaleSetGalleryApplication.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      identity: map['identity'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetIdentity>(WindowsVirtualMachineScaleSetIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      instances: pulumi.Output.create<int>(map['instances'] as int),
      ...
      networkInterfaces: pulumi.Output.create<List<WindowsVirtualMachineScaleSetNetworkInterface>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces'], (value) => WindowsVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      osDisk: pulumi.Output.create<WindowsVirtualMachineScaleSetOsDisk>(WindowsVirtualMachineScaleSetOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>())),
      overprovision: map['overprovision'] == null ? null : pulumi.Output.create<bool>(map['overprovision'] as bool),
      plan: map['plan'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetPlan>(WindowsVirtualMachineScaleSetPlan.fromMap((map['plan'] as Map).cast<String, dynamic>())),
      ...
      rollingUpgradePolicy: map['rollingUpgradePolicy'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetRollingUpgradePolicy>(WindowsVirtualMachineScaleSetRollingUpgradePolicy.fromMap((map['rollingUpgradePolicy'] as Map).cast<String, dynamic>())),
      scaleIn: map['scaleIn'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetScaleIn>(WindowsVirtualMachineScaleSetScaleIn.fromMap((map['scaleIn'] as Map).cast<String, dynamic>())),
      secrets: map['secrets'] == null ? null : pulumi.Output.create<List<WindowsVirtualMachineScaleSetSecret>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetSecret>(map['secrets'], (value) => WindowsVirtualMachineScaleSetSecret.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sourceImageReference: map['sourceImageReference'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetSourceImageReference>(WindowsVirtualMachineScaleSetSourceImageReference.fromMap((map['sourceImageReference'] as Map).cast<String, dynamic>())),
      spotRestore: map['spotRestore'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetSpotRestore>(WindowsVirtualMachineScaleSetSpotRestore.fromMap((map['spotRestore'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      terminationNotification: map['terminationNotification'] == null ? null : pulumi.Output.create<WindowsVirtualMachineScaleSetTerminationNotification>(WindowsVirtualMachineScaleSetTerminationNotification.fromMap((map['terminationNotification'] as Map).cast<String, dynamic>())),
      ...
      winrmListeners: map['winrmListeners'] == null ? null : pulumi.Output.create<List<WindowsVirtualMachineScaleSetWinrmListener>>(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetWinrmListener>(map['winrmListeners'], (value) => WindowsVirtualMachineScaleSetWinrmListener.fromMap((value as Map).cast<String, dynamic>()))),
