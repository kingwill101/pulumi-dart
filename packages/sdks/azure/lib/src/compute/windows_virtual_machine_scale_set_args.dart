...
class WindowsVirtualMachineScaleSetArgs {
  ...
  factory WindowsVirtualMachineScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineScaleSetArgs(
      ...
      networkInterfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces']!, (value) => WindowsVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      osDisk: pulumi.Input.fromValue(WindowsVirtualMachineScaleSetOsDisk.fromMap((map['osDisk']! as Map).cast<String, dynamic>())),
