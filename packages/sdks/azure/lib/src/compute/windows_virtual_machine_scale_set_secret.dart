...
class WindowsVirtualMachineScaleSetSecret {
  ...
  final pulumi.Input<List<WindowsVirtualMachineScaleSetSecretCertificate>>
  certificates;
    ...
    return <String, dynamic>{
      'certificates':
          pulumi.Input.mapInputValue<
            List<WindowsVirtualMachineScaleSetSecretCertificate>,
  ...
  factory WindowsVirtualMachineScaleSetSecret.fromMap(
    Map<String, dynamic> map,
  ) {
    return WindowsVirtualMachineScaleSetSecret(
      certificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<WindowsVirtualMachineScaleSetSecretCertificate>(
          map['certificates']!,
          (value) => WindowsVirtualMachineScaleSetSecretCertificate.fromMap(
