...
class LinuxVirtualMachineScaleSetOsDisk {
  ...
  final pulumi.Input<LinuxVirtualMachineScaleSetOsDiskDiffDiskSettings>? diffDiskSettings;
  ...
  const LinuxVirtualMachineScaleSetOsDisk({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'caching': caching,
      'diffDiskSettings': ?pulumi.Input.mapOptionalInputValue<LinuxVirtualMachineScaleSetOsDiskDiffDiskSettings, Map<String, dynamic>>(diffDiskSettings, (value) => value.toMap()),
  ...
  factory LinuxVirtualMachineScaleSetOsDisk.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetOsDisk(
      ...
      diffDiskSettings: (() { final guardedValue = map['diffDiskSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxVirtualMachineScaleSetOsDiskDiffDiskSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
