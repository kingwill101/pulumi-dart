...
class WindowsVirtualMachineScaleSetRollingUpgradePolicy {
  ...
  factory WindowsVirtualMachineScaleSetRollingUpgradePolicy.fromMap(
    Map<String, dynamic> map,
  ) {
    return WindowsVirtualMachineScaleSetRollingUpgradePolicy(
      crossZoneUpgradesEnabled: (() {
        final guardedValue = map['crossZoneUpgradesEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      maxBatchInstancePercent: pulumi.Input.fromValue(
        map['maxBatchInstancePercent'] as int,
      ),
      maxUnhealthyInstancePercent: pulumi.Input.fromValue(
        map['maxUnhealthyInstancePercent'] as int,
      ),
      maxUnhealthyUpgradedInstancePercent: pulumi.Input.fromValue(
        map['maxUnhealthyUpgradedInstancePercent'] as int,
      ),
      maximumSurgeInstancesEnabled: (() {
        final guardedValue = map['maximumSurgeInstancesEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      pauseTimeBetweenBatches: pulumi.Input.fromValue(
        map['pauseTimeBetweenBatches'] as String,
      ),
      prioritizeUnhealthyInstancesEnabled: (() {
        final guardedValue = map['prioritizeUnhealthyInstancesEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
