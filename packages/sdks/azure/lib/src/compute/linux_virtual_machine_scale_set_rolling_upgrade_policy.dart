...
class LinuxVirtualMachineScaleSetRollingUpgradePolicy {
  ...
  final bool? crossZoneUpgradesEnabled;
  ...
  final bool? maximumSurgeInstancesEnabled;
  ...
  final bool? prioritizeUnhealthyInstancesEnabled;
  ...
  factory LinuxVirtualMachineScaleSetRollingUpgradePolicy.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetRollingUpgradePolicy(
      crossZoneUpgradesEnabled: map['crossZoneUpgradesEnabled'] == null ? null : map['crossZoneUpgradesEnabled'] as bool,
      maxBatchInstancePercent: map['maxBatchInstancePercent'] as int,
      maxUnhealthyInstancePercent: map['maxUnhealthyInstancePercent'] as int,
      maxUnhealthyUpgradedInstancePercent: map['maxUnhealthyUpgradedInstancePercent'] as int,
      maximumSurgeInstancesEnabled: map['maximumSurgeInstancesEnabled'] == null ? null : map['maximumSurgeInstancesEnabled'] as bool,
      pauseTimeBetweenBatches: map['pauseTimeBetweenBatches'] as String,
      prioritizeUnhealthyInstancesEnabled: map['prioritizeUnhealthyInstancesEnabled'] == null ? null : map['prioritizeUnhealthyInstancesEnabled'] as bool,
    );
  }
}
