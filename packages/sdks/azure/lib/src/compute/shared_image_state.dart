...
class SharedImageState {
  ...
  factory SharedImageState.fromMap(Map<String, dynamic> map) {
    return SharedImageState(
      ...
      identifier: (() { final guardedValue = map['identifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SharedImageIdentifier.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
