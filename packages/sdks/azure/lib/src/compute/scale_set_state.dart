...
class ScaleSetState {
  ...
  factory ScaleSetState.fromMap(Map<String, dynamic> map) {
    return ScaleSetState(
      ...
      networkProfiles: map['networkProfiles'] == null ? null : (pulumi.Input.decodeList<ScaleSetNetworkProfile>(map['networkProfiles']!, (value) => ScaleSetNetworkProfile.fromMap((value as Map).cast<String, dynamic>()))).input(),
      osProfile: map['osProfile'] == null ? null : (ScaleSetOsProfile.fromMap((map['osProfile']! as Map).cast<String, dynamic>())).input(),
      ...
      sku: map['sku'] == null ? null : (ScaleSetSku.fromMap((map['sku']! as Map).cast<String, dynamic>())).input(),
      ...
      storageProfileOsDisk: map['storageProfileOsDisk'] == null ? null : (ScaleSetStorageProfileOsDisk.fromMap((map['storageProfileOsDisk']! as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      upgradePolicyMode: map['upgradePolicyMode'] == null ? null : (map['upgradePolicyMode']! as String).input(),
