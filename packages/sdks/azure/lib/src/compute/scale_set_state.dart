...
class ScaleSetState {
  ...
  factory ScaleSetState.fromMap(Map<String, dynamic> map) {
    return ScaleSetState(
      ...
      networkProfiles: (() {
        final guardedValue = map['networkProfiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sku: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScaleSetSku.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      storageProfileDataDisks: (() {
      ...
      storageProfileOsDisk: (() {
        final guardedValue = map['storageProfileOsDisk'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      upgradePolicyMode: (() {
        final guardedValue = map['upgradePolicyMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      zones: (() {
