...
class ScaleSetState {
  ...
  ScaleSetState({
    pulumi.Output<bool>? automaticOsUpgrade,
    pulumi.Output<ScaleSetBootDiagnostics>? bootDiagnostics,
    pulumi.Output<String>? evictionPolicy,
    pulumi.Output<List<ScaleSetExtension>>? extensions,
    pulumi.Output<String>? healthProbeId,
    pulumi.Output<ScaleSetIdentity>? identity,
    pulumi.Output<String>? licenseType,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<List<ScaleSetNetworkProfile>>? networkProfiles,
    pulumi.Output<ScaleSetOsProfile>? osProfile,
    pulumi.Output<ScaleSetOsProfileLinuxConfig>? osProfileLinuxConfig,
    pulumi.Output<List<ScaleSetOsProfileSecret>>? osProfileSecrets,
    pulumi.Output<ScaleSetOsProfileWindowsConfig>? osProfileWindowsConfig,
    pulumi.Output<bool>? overprovision,
    pulumi.Output<ScaleSetPlan>? plan,
    pulumi.Output<String>? priority,
    pulumi.Output<String>? proximityPlacementGroupId,
    pulumi.Output<String>? resourceGroupName,
    pulumi.Output<ScaleSetRollingUpgradePolicy>? rollingUpgradePolicy,
    pulumi.Output<bool>? singlePlacementGroup,
    pulumi.Output<ScaleSetSku>? sku,
    pulumi.Output<List<ScaleSetStorageProfileDataDisk>>? storageProfileDataDisks,
    pulumi.Output<ScaleSetStorageProfileImageReference>? storageProfileImageReference,
    pulumi.Output<ScaleSetStorageProfileOsDisk>? storageProfileOsDisk,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<String>? upgradePolicyMode,
    pulumi.Output<List<String>>? zones,
  }) :
      automaticOsUpgrade = pulumi.Input.asOptionalInput<bool>(automaticOsUpgrade),
      bootDiagnostics = pulumi.Input.asOptionalInput<ScaleSetBootDiagnostics>(bootDiagnostics),
      evictionPolicy = pulumi.Input.asOptionalInput<String>(evictionPolicy),
      extensions = pulumi.Input.asOptionalInput<List<ScaleSetExtension>>(extensions),
      healthProbeId = pulumi.Input.asOptionalInput<String>(healthProbeId),
      identity = pulumi.Input.asOptionalInput<ScaleSetIdentity>(identity),
      licenseType = pulumi.Input.asOptionalInput<String>(licenseType),
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      networkProfiles = pulumi.Input.asOptionalInput<List<ScaleSetNetworkProfile>>(networkProfiles),
      osProfile = pulumi.Input.asOptionalInput<ScaleSetOsProfile>(osProfile),
      osProfileLinuxConfig = pulumi.Input.asOptionalInput<ScaleSetOsProfileLinuxConfig>(osProfileLinuxConfig),
      osProfileSecrets = pulumi.Input.asOptionalInput<List<ScaleSetOsProfileSecret>>(osProfileSecrets),
      osProfileWindowsConfig = pulumi.Input.asOptionalInput<ScaleSetOsProfileWindowsConfig>(osProfileWindowsConfig),
      overprovision = pulumi.Input.asOptionalInput<bool>(overprovision),
      plan = pulumi.Input.asOptionalInput<ScaleSetPlan>(plan),
      ...
      rollingUpgradePolicy = pulumi.Input.asOptionalInput<ScaleSetRollingUpgradePolicy>(rollingUpgradePolicy),
      singlePlacementGroup = pulumi.Input.asOptionalInput<bool>(singlePlacementGroup),
      sku = pulumi.Input.asOptionalInput<ScaleSetSku>(sku),
      storageProfileDataDisks = pulumi.Input.asOptionalInput<List<ScaleSetStorageProfileDataDisk>>(storageProfileDataDisks),
      storageProfileImageReference = pulumi.Input.asOptionalInput<ScaleSetStorageProfileImageReference>(storageProfileImageReference),
      storageProfileOsDisk = pulumi.Input.asOptionalInput<ScaleSetStorageProfileOsDisk>(storageProfileOsDisk),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      upgradePolicyMode = pulumi.Input.asOptionalInput<String>(upgradePolicyMode),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'name': ?name,
      'networkProfiles': ?pulumi.Input.mapOptionalInputValue<List<ScaleSetNetworkProfile>, List<Map<String, dynamic>>>(networkProfiles, (value) => pulumi.Input.encodeList<ScaleSetNetworkProfile, Map<String, dynamic>>(value, (value) => value.toMap())),
      'osProfile': ?pulumi.Input.mapOptionalInputValue<ScaleSetOsProfile, Map<String, dynamic>>(osProfile, (value) => value.toMap()),
      ...
      'sku': ?pulumi.Input.mapOptionalInputValue<ScaleSetSku, Map<String, dynamic>>(sku, (value) => value.toMap()),
      ...
      'storageProfileOsDisk': ?pulumi.Input.mapOptionalInputValue<ScaleSetStorageProfileOsDisk, Map<String, dynamic>>(storageProfileOsDisk, (value) => value.toMap()),
      'tags': ?tags,
  ...
  factory ScaleSetState.fromMap(Map<String, dynamic> map) {
    return ScaleSetState(
      automaticOsUpgrade: map['automaticOsUpgrade'] == null ? null : pulumi.Output.create<bool>(map['automaticOsUpgrade'] as bool),
      bootDiagnostics: map['bootDiagnostics'] == null ? null : pulumi.Output.create<ScaleSetBootDiagnostics>(ScaleSetBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>())),
      evictionPolicy: map['evictionPolicy'] == null ? null : pulumi.Output.create<String>(map['evictionPolicy'] as String),
      extensions: map['extensions'] == null ? null : pulumi.Output.create<List<ScaleSetExtension>>(pulumi.Input.decodeList<ScaleSetExtension>(map['extensions'], (value) => ScaleSetExtension.fromMap((value as Map).cast<String, dynamic>()))),
      healthProbeId: map['healthProbeId'] == null ? null : pulumi.Output.create<String>(map['healthProbeId'] as String),
      identity: map['identity'] == null ? null : pulumi.Output.create<ScaleSetIdentity>(ScaleSetIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      networkProfiles: map['networkProfiles'] == null ? null : pulumi.Output.create<List<ScaleSetNetworkProfile>>(pulumi.Input.decodeList<ScaleSetNetworkProfile>(map['networkProfiles'], (value) => ScaleSetNetworkProfile.fromMap((value as Map).cast<String, dynamic>()))),
      osProfile: map['osProfile'] == null ? null : pulumi.Output.create<ScaleSetOsProfile>(ScaleSetOsProfile.fromMap((map['osProfile'] as Map).cast<String, dynamic>())),
      osProfileLinuxConfig: map['osProfileLinuxConfig'] == null ? null : pulumi.Output.create<ScaleSetOsProfileLinuxConfig>(ScaleSetOsProfileLinuxConfig.fromMap((map['osProfileLinuxConfig'] as Map).cast<String, dynamic>())),
      osProfileSecrets: map['osProfileSecrets'] == null ? null : pulumi.Output.create<List<ScaleSetOsProfileSecret>>(pulumi.Input.decodeList<ScaleSetOsProfileSecret>(map['osProfileSecrets'], (value) => ScaleSetOsProfileSecret.fromMap((value as Map).cast<String, dynamic>()))),
      osProfileWindowsConfig: map['osProfileWindowsConfig'] == null ? null : pulumi.Output.create<ScaleSetOsProfileWindowsConfig>(ScaleSetOsProfileWindowsConfig.fromMap((map['osProfileWindowsConfig'] as Map).cast<String, dynamic>())),
      overprovision: map['overprovision'] == null ? null : pulumi.Output.create<bool>(map['overprovision'] as bool),
      plan: map['plan'] == null ? null : pulumi.Output.create<ScaleSetPlan>(ScaleSetPlan.fromMap((map['plan'] as Map).cast<String, dynamic>())),
      ...
      rollingUpgradePolicy: map['rollingUpgradePolicy'] == null ? null : pulumi.Output.create<ScaleSetRollingUpgradePolicy>(ScaleSetRollingUpgradePolicy.fromMap((map['rollingUpgradePolicy'] as Map).cast<String, dynamic>())),
      singlePlacementGroup: map['singlePlacementGroup'] == null ? null : pulumi.Output.create<bool>(map['singlePlacementGroup'] as bool),
      sku: map['sku'] == null ? null : pulumi.Output.create<ScaleSetSku>(ScaleSetSku.fromMap((map['sku'] as Map).cast<String, dynamic>())),
      storageProfileDataDisks: map['storageProfileDataDisks'] == null ? null : pulumi.Output.create<List<ScaleSetStorageProfileDataDisk>>(pulumi.Input.decodeList<ScaleSetStorageProfileDataDisk>(map['storageProfileDataDisks'], (value) => ScaleSetStorageProfileDataDisk.fromMap((value as Map).cast<String, dynamic>()))),
      storageProfileImageReference: map['storageProfileImageReference'] == null ? null : pulumi.Output.create<ScaleSetStorageProfileImageReference>(ScaleSetStorageProfileImageReference.fromMap((map['storageProfileImageReference'] as Map).cast<String, dynamic>())),
      storageProfileOsDisk: map['storageProfileOsDisk'] == null ? null : pulumi.Output.create<ScaleSetStorageProfileOsDisk>(ScaleSetStorageProfileOsDisk.fromMap((map['storageProfileOsDisk'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      upgradePolicyMode: map['upgradePolicyMode'] == null ? null : pulumi.Output.create<String>(map['upgradePolicyMode'] as String),
