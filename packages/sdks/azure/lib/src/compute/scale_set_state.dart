...
class ScaleSetState {
  ...
  factory ScaleSetState.fromMap(Map<String, dynamic> map) {
    return ScaleSetState(
      ...
      networkProfiles: (() { final guardedValue = map['networkProfiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScaleSetNetworkProfile>(guardedValue, (value) => ScaleSetNetworkProfile.fromMap((value as Map).cast<String, dynamic>()))); })(),
      osProfile: (() { final guardedValue = map['osProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleSetOsProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleSetSku.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageProfileOsDisk: (() { final guardedValue = map['storageProfileOsDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleSetStorageProfileOsDisk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      upgradePolicyMode: (() { final guardedValue = map['upgradePolicyMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
