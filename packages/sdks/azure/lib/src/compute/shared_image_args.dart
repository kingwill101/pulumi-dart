...
class SharedImageArgs {
  ...
  SharedImageArgs({
    ...
    required pulumi.Output<SharedImageIdentifier> identifier,
    ...
    pulumi.Output<bool>? trustedLaunchSupported,
      ...
      identifier = pulumi.Input.asInput<SharedImageIdentifier>(identifier),
  ...
  factory SharedImageArgs.fromMap(Map<String, dynamic> map) {
    return SharedImageArgs(
      ...
      identifier: pulumi.Output.create<SharedImageIdentifier>(SharedImageIdentifier.fromMap((map['identifier'] as Map).cast<String, dynamic>())),
