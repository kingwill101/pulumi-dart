...
class SharedImageArgs {
  ...
  factory SharedImageArgs.fromMap(Map<String, dynamic> map) {
    return SharedImageArgs(
      ...
      maxRecommendedMemoryInGb: (() { final guardedValue = map['maxRecommendedMemoryInGb']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      maxRecommendedVcpuCount: (() { final guardedValue = map['maxRecommendedVcpuCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      minRecommendedMemoryInGb: (() { final guardedValue = map['minRecommendedMemoryInGb']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      minRecommendedVcpuCount: (() { final guardedValue = map['minRecommendedVcpuCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
