...
class GetManagedDiskEncryptionSetting {
  ...
  const GetManagedDiskEncryptionSetting({
  ...
  factory GetManagedDiskEncryptionSetting.fromMap(Map<String, dynamic> map) {
    return GetManagedDiskEncryptionSetting(
      diskEncryptionKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetManagedDiskEncryptionSettingDiskEncryptionKey>(map['diskEncryptionKeys']!, (value) => GetManagedDiskEncryptionSettingDiskEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      keyEncryptionKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetManagedDiskEncryptionSettingKeyEncryptionKey>(map['keyEncryptionKeys']!, (value) => GetManagedDiskEncryptionSettingKeyEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
