...
class VirtualMachineState {
  ...
  factory VirtualMachineState.fromMap(Map<String, dynamic> map) {
    return VirtualMachineState(
      ...
      storageOsDisk: (() { final guardedValue = map['storageOsDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineStorageOsDisk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
