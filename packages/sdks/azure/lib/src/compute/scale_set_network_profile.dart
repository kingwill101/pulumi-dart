...
class ScaleSetNetworkProfile {
  ...
  final pulumi.Input<List<ScaleSetNetworkProfileIpConfiguration>>
  ipConfigurations;
    ...
    return <String, dynamic>{
      ...
      'ipConfigurations':
          pulumi.Input.mapInputValue<
            List<ScaleSetNetworkProfileIpConfiguration>,
  ...
  factory ScaleSetNetworkProfile.fromMap(Map<String, dynamic> map) {
    return ScaleSetNetworkProfile(
      acceleratedNetworking: (() {
        final guardedValue = map['acceleratedNetworking'];
      ...
      dnsSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ScaleSetNetworkProfileDnsSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ipConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ScaleSetNetworkProfileIpConfiguration>(
          map['ipConfigurations']!,
          (value) => ScaleSetNetworkProfileIpConfiguration.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ipForwarding: (() {
        final guardedValue = map['ipForwarding'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
