...
class OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecret {
  ...
  factory OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecret.fromMap(
    ...
    return OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecret(
      certificates: pulumi.Input.fromValue(
        ...
        >(
          map['certificates']!,
          (value) =>
              OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecretCertificate.fromMap(
