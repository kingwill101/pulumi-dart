...
class LinuxVirtualMachineOsDisk {
  ...
  /// [diskEncryptionSetId] The ID of the Disk Encryption Set which should be used to Encrypt this OS Disk. Conflicts with `secureVmDiskEncryptionSetId`.
  ...
  factory LinuxVirtualMachineOsDisk.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineOsDisk(
      ...
      diffDiskSettings: (() { final guardedValue = map['diffDiskSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxVirtualMachineOsDiskDiffDiskSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
