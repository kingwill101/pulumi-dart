...
class GetVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
  ...
  factory GetVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetVirtualMachineScaleSetNetworkInterfaceIpConfiguration(
      applicationGatewayBackendAddressPoolIds: pulumi.Input.fromValue(
        (map['applicationGatewayBackendAddressPoolIds'] as List).cast<String>(),
      ),
      applicationSecurityGroupIds: pulumi.Input.fromValue(
        (map['applicationSecurityGroupIds'] as List).cast<String>(),
      ),
      loadBalancerBackendAddressPoolIds: pulumi.Input.fromValue(
        (map['loadBalancerBackendAddressPoolIds'] as List).cast<String>(),
      ),
      loadBalancerInboundNatRulesIds: pulumi.Input.fromValue(
        (map['loadBalancerInboundNatRulesIds'] as List).cast<String>(),
      ),
      ...
      publicIpAddresses: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress.fromMap(
