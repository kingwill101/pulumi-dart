...
class GalleryApplicationVersionArgs {
  ...
  factory GalleryApplicationVersionArgs.fromMap(Map<String, dynamic> map) {
    return GalleryApplicationVersionArgs(
      ...
      galleryApplicationId: pulumi.Input.fromValue(map['galleryApplicationId'] as String),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      manageAction: pulumi.Input.fromValue(GalleryApplicationVersionManageAction.fromMap((map['manageAction']! as Map).cast<String, dynamic>())),
      ...
      source: pulumi.Input.fromValue(GalleryApplicationVersionSource.fromMap((map['source']! as Map).cast<String, dynamic>())),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      targetRegions: pulumi.Input.fromValue(pulumi.Input.decodeList<GalleryApplicationVersionTargetRegion>(map['targetRegions']!, (value) => GalleryApplicationVersionTargetRegion.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
