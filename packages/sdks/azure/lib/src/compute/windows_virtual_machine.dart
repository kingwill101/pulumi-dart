...
class WindowsVirtualMachine extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WindowsVirtualMachineBootDiagnostics?> bootDiagnostics;
  ...
  late final pulumi.Output<WindowsVirtualMachineOsImageNotification?> osImageNotification;
  ...
  ///
  /// > **NOTE:** One of either `source_image_id` or `source_image_reference` must be set.
  late final pulumi.Output<WindowsVirtualMachineSourceImageReference?> sourceImageReference;
  /// A mapping of tags which should be assigned to this Virtual Machine.
  late final pulumi.Output<Map<String, String>?> tags;
  /// A `termination_notification` block as defined below.
  late final pulumi.Output<WindowsVirtualMachineTerminationNotification> terminationNotification;
  ...
  WindowsVirtualMachine(
    ...
    this.additionalCapabilities = registerOutput<WindowsVirtualMachineAdditionalCapabilities?>('additionalCapabilities');
    this.additionalUnattendContents = registerOutput<List<WindowsVirtualMachineAdditionalUnattendContent>?>('additionalUnattendContents');
    ...
    this.automaticUpdatesEnabled = registerOutput<bool>('automaticUpdatesEnabled');
    this.availabilitySetId = registerOutput<String?>('availabilitySetId');
    this.bootDiagnostics = registerOutput<WindowsVirtualMachineBootDiagnostics?>('bootDiagnostics');
    ...
    this.galleryApplications = registerOutput<List<WindowsVirtualMachineGalleryApplication>?>('galleryApplications');
    this.hotpatchingEnabled = registerOutput<bool>('hotpatchingEnabled');
    this.identity = registerOutput<WindowsVirtualMachineIdentity?>('identity');
    ...
    this.osDisk = registerOutput<WindowsVirtualMachineOsDisk>('osDisk');
    this.osImageNotification = registerOutput<WindowsVirtualMachineOsImageNotification?>('osImageNotification');
    ...
    this.plan = registerOutput<WindowsVirtualMachinePlan?>('plan');
    ...
    this.secrets = registerOutput<List<WindowsVirtualMachineSecret>?>('secrets');
    ...
    this.sourceImageReference = registerOutput<WindowsVirtualMachineSourceImageReference?>('sourceImageReference');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.terminationNotification = registerOutput<WindowsVirtualMachineTerminationNotification>('terminationNotification');
    ...
    this.winrmListeners = registerOutput<List<WindowsVirtualMachineWinrmListener>?>('winrmListeners');
