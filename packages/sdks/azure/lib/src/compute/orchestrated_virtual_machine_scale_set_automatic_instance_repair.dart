...
class OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair {
  ...
  /// [action] The repair action that will be used for repairing unhealthy virtual machines in the scale set. Possible values are `Replace`, `Restart`, and `Reimage`.
  ...
  const OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair({
    this.action,
