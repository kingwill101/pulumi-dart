...
class ManagedDiskEncryptionSettings {
  ...
  factory ManagedDiskEncryptionSettings.fromMap(Map<String, dynamic> map) {
    return ManagedDiskEncryptionSettings(
      diskEncryptionKey: pulumi.Input.fromValue(ManagedDiskEncryptionSettingsDiskEncryptionKey.fromMap((map['diskEncryptionKey']! as Map).cast<String, dynamic>())),
      keyEncryptionKey: (() { final guardedValue = map['keyEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedDiskEncryptionSettingsKeyEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
