...
import 'linux_virtual_machine_scale_set_extension_protected_settings_from_key_vault.dart';
...
class LinuxVirtualMachineScaleSetExtension {
  ...
  /// Creates a new [LinuxVirtualMachineScaleSetExtension].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'protectedSettingsFromKeyVault': ?pulumi.Input.mapOptionalInputValue<LinuxVirtualMachineScaleSetExtensionProtectedSettingsFromKeyVault, Map<String, dynamic>>(protectedSettingsFromKeyVault, (value) => value.toMap()),
  ...
  factory LinuxVirtualMachineScaleSetExtension.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetExtension(
      ...
      protectedSettingsFromKeyVault: (() { final guardedValue = map['protectedSettingsFromKeyVault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxVirtualMachineScaleSetExtensionProtectedSettingsFromKeyVault.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
