...
class LinuxVirtualMachineScaleSetExtension {
  ...
  factory LinuxVirtualMachineScaleSetExtension.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetExtension(
      ...
      protectedSettingsFromKeyVault: map['protectedSettingsFromKeyVault'] == null ? null : (LinuxVirtualMachineScaleSetExtensionProtectedSettingsFromKeyVault.fromMap((map['protectedSettingsFromKeyVault']! as Map).cast<String, dynamic>())).input(),
