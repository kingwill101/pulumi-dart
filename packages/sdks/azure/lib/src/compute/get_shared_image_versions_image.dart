...
class GetSharedImageVersionsImage {
  ...
  final pulumi.Input<List<GetSharedImageVersionsImageTargetRegion>>
  targetRegions;
    ...
    return <String, dynamic>{
      ...
      'targetRegions':
          pulumi.Input.mapInputValue<
            List<GetSharedImageVersionsImageTargetRegion>,
  ...
  factory GetSharedImageVersionsImage.fromMap(Map<String, dynamic> map) {
    return GetSharedImageVersionsImage(
      excludeFromLatest: pulumi.Input.fromValue(
        map['excludeFromLatest'] as bool,
      ),
      ...
      targetRegions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSharedImageVersionsImageTargetRegion>(
          map['targetRegions']!,
          (value) => GetSharedImageVersionsImageTargetRegion.fromMap(
