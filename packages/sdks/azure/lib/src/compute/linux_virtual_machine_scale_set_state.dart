...
class LinuxVirtualMachineScaleSetState {
  ...
  factory LinuxVirtualMachineScaleSetState.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetState(
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : (pulumi.Input.decodeList<LinuxVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces']!, (value) => LinuxVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
      osDisk: map['osDisk'] == null ? null : (LinuxVirtualMachineScaleSetOsDisk.fromMap((map['osDisk']! as Map).cast<String, dynamic>())).input(),
