...
class LinuxVirtualMachineScaleSetState {
  ...
  const LinuxVirtualMachineScaleSetState({
  ...
  factory LinuxVirtualMachineScaleSetState.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetState(
      ...
      networkInterfaces: (() { final guardedValue = map['networkInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LinuxVirtualMachineScaleSetNetworkInterface>(guardedValue, (value) => LinuxVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))); })(),
      osDisk: (() { final guardedValue = map['osDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxVirtualMachineScaleSetOsDisk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
