...
class ScaleSetStorageProfileOsDisk {
  ...
  /// [managedDiskType] Specifies the type of managed disk to create. Value you must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`. Cannot be used when `vhdContainers` or `image` is specified.
  ...
  /// [vhdContainers] Specifies the VHD URI. Cannot be used when `image` or `managedDiskType` is specified.
