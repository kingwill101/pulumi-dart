...
class GetOrchestratedVirtualMachineScaleSetNetworkInterface {
  ...
  factory GetOrchestratedVirtualMachineScaleSetNetworkInterface.fromMap(Map<String, dynamic> map) {
    return GetOrchestratedVirtualMachineScaleSetNetworkInterface(
      ...
      ipConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration>(map['ipConfigurations']!, (value) => GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      ipForwardingEnabled: pulumi.Input.fromValue(map['ipForwardingEnabled'] as bool),
