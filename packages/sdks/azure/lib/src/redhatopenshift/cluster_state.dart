...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      apiServerProfile: (() { final guardedValue = map['apiServerProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterApiServerProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      clusterProfile: (() { final guardedValue = map['clusterProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterClusterProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ingressProfile: (() { final guardedValue = map['ingressProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterIngressProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mainProfile: (() { final guardedValue = map['mainProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterMainProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkProfile: (() { final guardedValue = map['networkProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNetworkProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: (() { final guardedValue = map['resourceGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      servicePrincipal: (() { final guardedValue = map['servicePrincipal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterServicePrincipal.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      workerProfile: (() { final guardedValue = map['workerProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterWorkerProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
