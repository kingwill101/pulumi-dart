...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      apiServerProfile: pulumi.Input.fromValue(ClusterApiServerProfile.fromMap((map['apiServerProfile']! as Map).cast<String, dynamic>())),
      clusterProfile: pulumi.Input.fromValue(ClusterClusterProfile.fromMap((map['clusterProfile']! as Map).cast<String, dynamic>())),
      ingressProfile: pulumi.Input.fromValue(ClusterIngressProfile.fromMap((map['ingressProfile']! as Map).cast<String, dynamic>())),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mainProfile: pulumi.Input.fromValue(ClusterMainProfile.fromMap((map['mainProfile']! as Map).cast<String, dynamic>())),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkProfile: pulumi.Input.fromValue(ClusterNetworkProfile.fromMap((map['networkProfile']! as Map).cast<String, dynamic>())),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      servicePrincipal: pulumi.Input.fromValue(ClusterServicePrincipal.fromMap((map['servicePrincipal']! as Map).cast<String, dynamic>())),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      workerProfile: pulumi.Input.fromValue(ClusterWorkerProfile.fromMap((map['workerProfile']! as Map).cast<String, dynamic>())),
    );
  }
}
