...
class CollectorPolicyIpfxIngestion {
  ...
  CollectorPolicyIpfxIngestion({required this.sourceResourceIds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'sourceResourceIds': sourceResourceIds};
  }

  factory CollectorPolicyIpfxIngestion.fromMap(Map<String, dynamic> map) {
    return CollectorPolicyIpfxIngestion(
      sourceResourceIds: pulumi.Input.fromValue(
        (map['sourceResourceIds'] as List).cast<String>(),
      ),
    );
  }
}
