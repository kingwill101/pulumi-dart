...
class GetPolicyRuleFilter {
  ...
  final pulumi.Input<List<GetPolicyRuleFilterMatchBlobIndexTag>>
  matchBlobIndexTags;
    ...
    return <String, dynamic>{
      ...
      'matchBlobIndexTags':
          pulumi.Input.mapInputValue<
            List<GetPolicyRuleFilterMatchBlobIndexTag>,
  ...
  factory GetPolicyRuleFilter.fromMap(Map<String, dynamic> map) {
    return GetPolicyRuleFilter(
      ...
      matchBlobIndexTags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPolicyRuleFilterMatchBlobIndexTag>(
          map['matchBlobIndexTags']!,
          (value) => GetPolicyRuleFilterMatchBlobIndexTag.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      prefixMatches: pulumi.Input.fromValue(
        (map['prefixMatches'] as List).cast<String>(),
      ),
    );
  }
}
