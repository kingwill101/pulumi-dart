  ...
  factory ContainerImmutabilityPolicyState.fromMap(Map<String, dynamic> map) {
    return ContainerImmutabilityPolicyState(
      immutabilityPeriodInDays: (() {
        final guardedValue = map['immutabilityPeriodInDays'];
      ...
      protectedAppendWritesAllEnabled: (() {
        final guardedValue = map['protectedAppendWritesAllEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      protectedAppendWritesEnabled: (() {
        final guardedValue = map['protectedAppendWritesEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      storageContainerResourceManagerId: (() {
        final guardedValue = map['storageContainerResourceManagerId'];
        if (guardedValue == null) return null;
