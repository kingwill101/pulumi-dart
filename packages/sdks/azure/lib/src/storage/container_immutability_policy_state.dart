...
class ContainerImmutabilityPolicyState {
  ...
  factory ContainerImmutabilityPolicyState.fromMap(Map<String, dynamic> map) {
    return ContainerImmutabilityPolicyState(
      immutabilityPeriodInDays: (() { final guardedValue = map['immutabilityPeriodInDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
