...
class MoverAgentArgs {
  ...
  factory MoverAgentArgs.fromMap(Map<String, dynamic> map) {
    return MoverAgentArgs(
      arcVirtualMachineId: pulumi.Input.fromValue(
        map['arcVirtualMachineId'] as String,
      ),
      arcVirtualMachineUuid: pulumi.Input.fromValue(
        map['arcVirtualMachineUuid'] as String,
      ),
      description: (() {
