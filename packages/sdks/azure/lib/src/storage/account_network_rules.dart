...
class AccountNetworkRules {
  ...
  final List<AccountNetworkRulesPrivateLinkAccess>? privateLinkAccesses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipRules': ?ipRules,
      'privateLinkAccesses': ?privateLinkAccesses == null ? null : pulumi.Input.encodeList<AccountNetworkRulesPrivateLinkAccess, Map<String, dynamic>>(privateLinkAccesses!, (value) => value.toMap()),
  ...
  factory AccountNetworkRules.fromMap(Map<String, dynamic> map) {
    return AccountNetworkRules(
      ...
      privateLinkAccesses: map['privateLinkAccesses'] == null ? null : pulumi.Input.decodeList<AccountNetworkRulesPrivateLinkAccess>(map['privateLinkAccesses'], (value) => AccountNetworkRulesPrivateLinkAccess.fromMap((value as Map).cast<String, dynamic>())),
