...
class AccountNetworkRules {
  ...
  final pulumi.Input<List<AccountNetworkRulesPrivateLinkAccess>>?
  privateLinkAccesses;
    ...
    return <String, dynamic>{
      ...
      'privateLinkAccesses':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccountNetworkRulesPrivateLinkAccess>,
  ...
  factory AccountNetworkRules.fromMap(Map<String, dynamic> map) {
    return AccountNetworkRules(
      ...
      privateLinkAccesses: (() {
        final guardedValue = map['privateLinkAccesses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountNetworkRulesPrivateLinkAccess>(
            guardedValue,
            (value) => AccountNetworkRulesPrivateLinkAccess.fromMap(
