...
class AccountBlobPropertiesCorsRule {
  ...
  /// Creates a new [AccountBlobPropertiesCorsRule].
  /// [allowedHeaders] A list of headers that are allowed to be a part of the cross-origin request.
  /// [allowedMethods] A list of HTTP methods that are allowed to be executed by the origin. Valid options are
  ...
  const AccountBlobPropertiesCorsRule({
