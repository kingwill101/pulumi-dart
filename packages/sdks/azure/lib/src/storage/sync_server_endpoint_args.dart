...
/// {@template pulumi_storage_sync_server_endpoint_sync_server_endpoint_args_doc}
/// The set of arguments for SyncServerEndpoint.
/// {@endtemplate}
...
class SyncServerEndpointArgs {
  ...
  factory SyncServerEndpointArgs.fromMap(Map<String, dynamic> map) {
    return SyncServerEndpointArgs(
      cloudTieringEnabled: (() { final guardedValue = map['cloudTieringEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
