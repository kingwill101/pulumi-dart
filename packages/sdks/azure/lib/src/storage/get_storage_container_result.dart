...
class GetStorageContainerResult {
  ...
  factory GetStorageContainerResult.fromMap(Map<String, dynamic> map) {
    return GetStorageContainerResult(
      containerAccessType: (() { final guardedValue = map['containerAccessType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      encryptionScopeOverrideEnabled: (() { final guardedValue = map['encryptionScopeOverrideEnabled']; if (guardedValue == null) return null; return guardedValue as bool; })(),
