...
class AccountTablePropertiesHourMetrics {
  ...
  /// Creates a new [AccountTablePropertiesHourMetrics].
  ...
  const AccountTablePropertiesHourMetrics({
    this.includeApis,
  ...
  factory AccountTablePropertiesHourMetrics.fromMap(Map<String, dynamic> map) {
    return AccountTablePropertiesHourMetrics(
