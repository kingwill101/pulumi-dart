...
class ShareAcl {
  ...
  factory ShareAcl.fromMap(Map<String, dynamic> map) {
    return ShareAcl(
      accessPolicies: (() { final guardedValue = map['accessPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShareAclAccessPolicy>(guardedValue, (value) => ShareAclAccessPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
