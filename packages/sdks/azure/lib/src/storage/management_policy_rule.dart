...
class ManagementPolicyRule {
  ...
  factory ManagementPolicyRule.fromMap(Map<String, dynamic> map) {
    return ManagementPolicyRule(
      actions: pulumi.Input.fromValue(ManagementPolicyRuleActions.fromMap((map['actions']! as Map).cast<String, dynamic>())),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      filters: pulumi.Input.fromValue(ManagementPolicyRuleFilters.fromMap((map['filters']! as Map).cast<String, dynamic>())),
