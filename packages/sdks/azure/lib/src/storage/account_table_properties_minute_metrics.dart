...
class AccountTablePropertiesMinuteMetrics {
  ...
  /// Creates a new [AccountTablePropertiesMinuteMetrics].
  ...
  const AccountTablePropertiesMinuteMetrics({
    this.includeApis,
  ...
  factory AccountTablePropertiesMinuteMetrics.fromMap(Map<String, dynamic> map) {
    return AccountTablePropertiesMinuteMetrics(
