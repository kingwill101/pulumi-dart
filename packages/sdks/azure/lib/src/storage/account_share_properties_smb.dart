...
class AccountSharePropertiesSmb {
  ...
  factory AccountSharePropertiesSmb.fromMap(Map<String, dynamic> map) {
    return AccountSharePropertiesSmb(
      authenticationTypes: (() { final guardedValue = map['authenticationTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      channelEncryptionTypes: (() { final guardedValue = map['channelEncryptionTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      kerberosTicketEncryptionTypes: (() { final guardedValue = map['kerberosTicketEncryptionTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      multichannelEnabled: (() { final guardedValue = map['multichannelEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
