...
class SyncGroupState {
  ...
  SyncGroupState({
    ...
    pulumi.Output<String>? storageSyncId,
  }) :
      name = pulumi.Input.asOptionalInput<String>(name),
      storageSyncId = pulumi.Input.asOptionalInput<String>(storageSyncId);
  ...
  factory SyncGroupState.fromMap(Map<String, dynamic> map) {
    return SyncGroupState(
      ...
      storageSyncId: map['storageSyncId'] == null ? null : pulumi.Output.create<String>(map['storageSyncId'] as String),
    );
  }
}
