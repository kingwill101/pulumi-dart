...
class AccountState {
  ...
  factory AccountState.fromMap(Map<String, dynamic> map) {
    return AccountState(
      ...
      accountReplicationType: (() { final guardedValue = map['accountReplicationType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      accountTier: (() { final guardedValue = map['accountTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      primaryBlobConnectionString: (() { final guardedValue = map['primaryBlobConnectionString']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryBlobEndpoint: (() { final guardedValue = map['primaryBlobEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryBlobHost: (() { final guardedValue = map['primaryBlobHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryBlobInternetEndpoint: (() { final guardedValue = map['primaryBlobInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryBlobInternetHost: (() { final guardedValue = map['primaryBlobInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryBlobMicrosoftEndpoint: (() { final guardedValue = map['primaryBlobMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryBlobMicrosoftHost: (() { final guardedValue = map['primaryBlobMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      primaryDfsEndpoint: (() { final guardedValue = map['primaryDfsEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryDfsHost: (() { final guardedValue = map['primaryDfsHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryDfsInternetEndpoint: (() { final guardedValue = map['primaryDfsInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryDfsInternetHost: (() { final guardedValue = map['primaryDfsInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryDfsMicrosoftEndpoint: (() { final guardedValue = map['primaryDfsMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryDfsMicrosoftHost: (() { final guardedValue = map['primaryDfsMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryFileEndpoint: (() { final guardedValue = map['primaryFileEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryFileHost: (() { final guardedValue = map['primaryFileHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryFileInternetEndpoint: (() { final guardedValue = map['primaryFileInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryFileInternetHost: (() { final guardedValue = map['primaryFileInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryFileMicrosoftEndpoint: (() { final guardedValue = map['primaryFileMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryFileMicrosoftHost: (() { final guardedValue = map['primaryFileMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      primaryQueueEndpoint: (() { final guardedValue = map['primaryQueueEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryQueueHost: (() { final guardedValue = map['primaryQueueHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryQueueMicrosoftEndpoint: (() { final guardedValue = map['primaryQueueMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryQueueMicrosoftHost: (() { final guardedValue = map['primaryQueueMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryTableEndpoint: (() { final guardedValue = map['primaryTableEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryTableHost: (() { final guardedValue = map['primaryTableHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryTableMicrosoftEndpoint: (() { final guardedValue = map['primaryTableMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryTableMicrosoftHost: (() { final guardedValue = map['primaryTableMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryWebEndpoint: (() { final guardedValue = map['primaryWebEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryWebHost: (() { final guardedValue = map['primaryWebHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryWebInternetEndpoint: (() { final guardedValue = map['primaryWebInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryWebInternetHost: (() { final guardedValue = map['primaryWebInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryWebMicrosoftEndpoint: (() { final guardedValue = map['primaryWebMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      primaryWebMicrosoftHost: (() { final guardedValue = map['primaryWebMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      secondaryBlobConnectionString: (() { final guardedValue = map['secondaryBlobConnectionString']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryBlobEndpoint: (() { final guardedValue = map['secondaryBlobEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryBlobHost: (() { final guardedValue = map['secondaryBlobHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryBlobInternetEndpoint: (() { final guardedValue = map['secondaryBlobInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryBlobInternetHost: (() { final guardedValue = map['secondaryBlobInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryBlobMicrosoftEndpoint: (() { final guardedValue = map['secondaryBlobMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryBlobMicrosoftHost: (() { final guardedValue = map['secondaryBlobMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      secondaryDfsEndpoint: (() { final guardedValue = map['secondaryDfsEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryDfsHost: (() { final guardedValue = map['secondaryDfsHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryDfsInternetEndpoint: (() { final guardedValue = map['secondaryDfsInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryDfsInternetHost: (() { final guardedValue = map['secondaryDfsInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryDfsMicrosoftEndpoint: (() { final guardedValue = map['secondaryDfsMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryDfsMicrosoftHost: (() { final guardedValue = map['secondaryDfsMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryFileEndpoint: (() { final guardedValue = map['secondaryFileEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryFileHost: (() { final guardedValue = map['secondaryFileHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryFileInternetEndpoint: (() { final guardedValue = map['secondaryFileInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryFileInternetHost: (() { final guardedValue = map['secondaryFileInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryFileMicrosoftEndpoint: (() { final guardedValue = map['secondaryFileMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryFileMicrosoftHost: (() { final guardedValue = map['secondaryFileMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      secondaryQueueEndpoint: (() { final guardedValue = map['secondaryQueueEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryQueueHost: (() { final guardedValue = map['secondaryQueueHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryQueueMicrosoftEndpoint: (() { final guardedValue = map['secondaryQueueMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryQueueMicrosoftHost: (() { final guardedValue = map['secondaryQueueMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryTableEndpoint: (() { final guardedValue = map['secondaryTableEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryTableHost: (() { final guardedValue = map['secondaryTableHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryTableMicrosoftEndpoint: (() { final guardedValue = map['secondaryTableMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryTableMicrosoftHost: (() { final guardedValue = map['secondaryTableMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryWebEndpoint: (() { final guardedValue = map['secondaryWebEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryWebHost: (() { final guardedValue = map['secondaryWebHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryWebInternetEndpoint: (() { final guardedValue = map['secondaryWebInternetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryWebInternetHost: (() { final guardedValue = map['secondaryWebInternetHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryWebMicrosoftEndpoint: (() { final guardedValue = map['secondaryWebMicrosoftEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryWebMicrosoftHost: (() { final guardedValue = map['secondaryWebMicrosoftHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
