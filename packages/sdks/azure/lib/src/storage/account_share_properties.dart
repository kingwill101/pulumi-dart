...
class AccountShareProperties {
  ...
  AccountShareProperties({this.corsRules, this.retentionPolicy, this.smb});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'corsRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccountSharePropertiesCorsRule>,
    ...
    return AccountShareProperties(
      corsRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountSharePropertiesCorsRule>(
            guardedValue,
            (value) => AccountSharePropertiesCorsRule.fromMap(
      ...
      retentionPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccountSharePropertiesRetentionPolicy.fromMap(
      ...
      smb: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccountSharePropertiesSmb.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
