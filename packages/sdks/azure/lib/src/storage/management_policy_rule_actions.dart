...
class ManagementPolicyRuleActions {
  ...
  ManagementPolicyRuleActions({this.baseBlob, this.snapshot, this.version});
    ...
    return ManagementPolicyRuleActions(
      baseBlob: (() {
        ...
        return pulumi.Input.fromValue(
          ManagementPolicyRuleActionsBaseBlob.fromMap(
      ...
      snapshot: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagementPolicyRuleActionsSnapshot.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      version: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagementPolicyRuleActionsVersion.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
