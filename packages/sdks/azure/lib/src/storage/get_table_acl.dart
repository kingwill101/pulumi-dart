...
class GetTableAcl {
  ...
  GetTableAcl({required this.accessPolicies, required this.id});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessPolicies':
          pulumi.Input.mapInputValue<
            List<GetTableAclAccessPolicy>,
  ...
  factory GetTableAcl.fromMap(Map<String, dynamic> map) {
    return GetTableAcl(
      accessPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTableAclAccessPolicy>(
          map['accessPolicies']!,
          (value) => GetTableAclAccessPolicy.fromMap(
