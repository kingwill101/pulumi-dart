...
class ContainerImmutabilityPolicyArgs {
  ...
  factory ContainerImmutabilityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ContainerImmutabilityPolicyArgs(
      immutabilityPeriodInDays: pulumi.Input.fromValue(
        map['immutabilityPeriodInDays'] as int,
      ),
      locked: (() {
      ...
      storageContainerResourceManagerId: pulumi.Input.fromValue(
        map['storageContainerResourceManagerId'] as String,
      ),
    );
  }
}
