...
class AccountSasPolicy {
  ...
  factory AccountSasPolicy.fromMap(Map<String, dynamic> map) {
    return AccountSasPolicy(
      expirationAction: (() { final guardedValue = map['expirationAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      expirationPeriod: pulumi.Input.fromValue(map['expirationPeriod'] as String),
    );
  }
}
