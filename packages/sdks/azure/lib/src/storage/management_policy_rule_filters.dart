...
class ManagementPolicyRuleFilters {
  ...
  final pulumi.Input<List<ManagementPolicyRuleFiltersMatchBlobIndexTag>>?
  matchBlobIndexTags;
    ...
    return <String, dynamic>{
      ...
      'matchBlobIndexTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagementPolicyRuleFiltersMatchBlobIndexTag>,
  ...
  factory ManagementPolicyRuleFilters.fromMap(Map<String, dynamic> map) {
    return ManagementPolicyRuleFilters(
      ...
      matchBlobIndexTags: (() {
        final guardedValue = map['matchBlobIndexTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagementPolicyRuleFiltersMatchBlobIndexTag>(
            guardedValue,
            (value) => ManagementPolicyRuleFiltersMatchBlobIndexTag.fromMap(
      ...
      prefixMatches: (() {
        final guardedValue = map['prefixMatches'];
        if (guardedValue == null) return null;
