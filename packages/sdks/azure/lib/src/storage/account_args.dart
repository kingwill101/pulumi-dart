...
class AccountArgs {
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      accountKind: (() { final guardedValue = map['accountKind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      accountReplicationType: pulumi.Input.fromValue(map['accountReplicationType'] as String),
      accountTier: pulumi.Input.fromValue(map['accountTier'] as String),
      allowNestedItemsToBePublic: (() { final guardedValue = map['allowNestedItemsToBePublic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      allowedCopyScope: (() { final guardedValue = map['allowedCopyScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      azureFilesAuthentication: (() { final guardedValue = map['azureFilesAuthentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountAzureFilesAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      blobProperties: (() { final guardedValue = map['blobProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountBlobProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      crossTenantReplicationEnabled: (() { final guardedValue = map['crossTenantReplicationEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      customDomain: (() { final guardedValue = map['customDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountCustomDomain.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dnsEndpointType: (() { final guardedValue = map['dnsEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      httpsTrafficOnlyEnabled: (() { final guardedValue = map['httpsTrafficOnlyEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      immutabilityPolicy: (() { final guardedValue = map['immutabilityPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountImmutabilityPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      largeFileShareEnabled: (() { final guardedValue = map['largeFileShareEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      localUserEnabled: (() { final guardedValue = map['localUserEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      networkRules: (() { final guardedValue = map['networkRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountNetworkRules.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nfsv3Enabled: (() { final guardedValue = map['nfsv3Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      provisionedBillingModelVersion: (() { final guardedValue = map['provisionedBillingModelVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publicNetworkAccessEnabled: (() { final guardedValue = map['publicNetworkAccessEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      queueEncryptionKeyType: (() { final guardedValue = map['queueEncryptionKeyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queueProperties: (() { final guardedValue = map['queueProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountQueueProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      routing: (() { final guardedValue = map['routing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountRouting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sasPolicy: (() { final guardedValue = map['sasPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountSasPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sftpEnabled: (() { final guardedValue = map['sftpEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      shareProperties: (() { final guardedValue = map['shareProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountShareProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sharedAccessKeyEnabled: (() { final guardedValue = map['sharedAccessKeyEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      staticWebsite: (() { final guardedValue = map['staticWebsite']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccountStaticWebsite.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tableEncryptionKeyType: (() { final guardedValue = map['tableEncryptionKeyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
