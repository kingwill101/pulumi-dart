...
class GetStandardSiteConfig {
  ...
  final pulumi.Input<List<GetStandardSiteConfigScmIpRestriction>>
  scmIpRestrictions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scmIpRestrictions':
          pulumi.Input.mapInputValue<
            List<GetStandardSiteConfigScmIpRestriction>,
            List<Map<String, dynamic>>
          >(
            scmIpRestrictions,
            (value) =>
  ...
  factory GetStandardSiteConfig.fromMap(Map<String, dynamic> map) {
    return GetStandardSiteConfig(
      ...
      cors: pulumi.Input.fromValue(
        GetStandardSiteConfigCors.fromMap(
      ...
      ipRestrictions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetStandardSiteConfigIpRestriction>(
          map['ipRestrictions']!,
          (value) => GetStandardSiteConfigIpRestriction.fromMap(
      ...
      scmIpRestrictions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetStandardSiteConfigScmIpRestriction>(
          map['scmIpRestrictions']!,
          (value) => GetStandardSiteConfigScmIpRestriction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      scmMinTlsVersion: pulumi.Input.fromValue(
        map['scmMinTlsVersion'] as String,
      ),
