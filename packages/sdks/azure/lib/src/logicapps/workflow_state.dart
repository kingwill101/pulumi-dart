  ...
  factory WorkflowState.fromMap(Map<String, dynamic> map) {
    return WorkflowState(
      ...
      connectorEndpointIpAddresses: (() {
        final guardedValue = map['connectorEndpointIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      connectorOutboundIpAddresses: (() {
        final guardedValue = map['connectorOutboundIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      enabled: (() {
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkflowIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      integrationServiceEnvironmentId: (() {
        final guardedValue = map['integrationServiceEnvironmentId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      logicAppIntegrationAccountId: (() {
        final guardedValue = map['logicAppIntegrationAccountId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      workflowEndpointIpAddresses: (() {
        final guardedValue = map['workflowEndpointIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      workflowOutboundIpAddresses: (() {
        final guardedValue = map['workflowOutboundIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      workflowParameters: (() {
        final guardedValue = map['workflowParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      workflowSchema: (() {
        final guardedValue = map['workflowSchema'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      workflowVersion: (() {
        final guardedValue = map['workflowVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
