...
import 'integration_account_schema_state.dart';
...
///   sku_name            = "Basic"
/// }
/// resource "azure_logicapps_integrationaccountschema" "example" {
///   name                     = "example-ias"
///   resource_group_name      = azure_core_resourcegroup.example.name
...
class IntegrationAccountSchema extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [IntegrationAccountSchema]. {@macro pulumi_logicapps_integration_account_schema_integration_account_schema_args_doc}
  ...
  static IntegrationAccountSchema get(
    String name,
