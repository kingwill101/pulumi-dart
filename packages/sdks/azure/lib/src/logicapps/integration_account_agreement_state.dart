...
class IntegrationAccountAgreementState {
  ...
  factory IntegrationAccountAgreementState.fromMap(Map<String, dynamic> map) {
    return IntegrationAccountAgreementState(
      agreementType: (() { final guardedValue = map['agreementType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      content: (() { final guardedValue = map['content']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      guestIdentity: (() { final guardedValue = map['guestIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntegrationAccountAgreementGuestIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      guestPartnerName: (() { final guardedValue = map['guestPartnerName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      hostIdentity: (() { final guardedValue = map['hostIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntegrationAccountAgreementHostIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hostPartnerName: (() { final guardedValue = map['hostPartnerName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
