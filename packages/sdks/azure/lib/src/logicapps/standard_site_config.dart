...
class StandardSiteConfig {
  ...
  /// [ipRestrictionDefaultAction] The action to take when no `ipRestriction` rules match. Possible values are `Allow` and `Deny`.
  ...
  /// [scmIpRestrictionDefaultAction] The action to take when no `scmIpRestriction` rules match. Possible values are `Allow` and `Deny`.
  ...
  /// [scmUseMainIpRestriction] Should the Logic App `ipRestriction` configuration be used for the SCM too. Defaults to `false`.
  ...
  factory StandardSiteConfig.fromMap(Map<String, dynamic> map) {
    return StandardSiteConfig(
      ...
      cors: (() { final guardedValue = map['cors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StandardSiteConfigCors.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ipRestrictions: (() { final guardedValue = map['ipRestrictions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StandardSiteConfigIpRestriction>(guardedValue, (value) => StandardSiteConfigIpRestriction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      scmIpRestrictions: (() { final guardedValue = map['scmIpRestrictions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StandardSiteConfigScmIpRestriction>(guardedValue, (value) => StandardSiteConfigScmIpRestriction.fromMap((value as Map).cast<String, dynamic>()))); })(),
