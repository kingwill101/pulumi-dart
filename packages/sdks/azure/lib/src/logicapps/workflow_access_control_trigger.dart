...
class WorkflowAccessControlTrigger {
  ...
  final pulumi.Input<
    List<WorkflowAccessControlTriggerOpenAuthenticationPolicy>
  >?
  ...
  factory WorkflowAccessControlTrigger.fromMap(Map<String, dynamic> map) {
    return WorkflowAccessControlTrigger(
      allowedCallerIpAddressRanges: (() {
        final guardedValue = map['allowedCallerIpAddressRanges'];
      ...
      openAuthenticationPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WorkflowAccessControlTriggerOpenAuthenticationPolicy.fromMap(
