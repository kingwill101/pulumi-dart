...
class GetWorkflowResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'identities':
          pulumi.Input.encodeList<GetWorkflowIdentity, Map<String, dynamic>>(
            identities,
            (value) => value.toMap(),
          ),
      'location': location,
  ...
  factory GetWorkflowResult.fromMap(Map<String, dynamic> map) {
    return GetWorkflowResult(
      ...
      connectorEndpointIpAddresses:
          (map['connectorEndpointIpAddresses'] as List).cast<String>(),
      connectorOutboundIpAddresses:
          (map['connectorOutboundIpAddresses'] as List).cast<String>(),
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetWorkflowIdentity>(
        map['identities']!,
        (value) =>
            GetWorkflowIdentity.fromMap((value as Map).cast<String, dynamic>()),
      ),
      location: map['location'] as String,
      logicAppIntegrationAccountId:
          map['logicAppIntegrationAccountId'] as String,
      name: map['name'] as String,
      parameters: (map['parameters'] as Map).cast<String, String>(),
      resourceGroupName: map['resourceGroupName'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      workflowEndpointIpAddresses: (map['workflowEndpointIpAddresses'] as List)
          .cast<String>(),
      workflowOutboundIpAddresses: (map['workflowOutboundIpAddresses'] as List)
          .cast<String>(),
