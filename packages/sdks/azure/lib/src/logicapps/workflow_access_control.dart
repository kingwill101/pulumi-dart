...
class WorkflowAccessControl {
  ...
  final pulumi.Input<WorkflowAccessControlWorkflowManagement>?
  workflowManagement;
    ...
    return WorkflowAccessControl(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          WorkflowAccessControlAction.fromMap(
      ...
      content: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkflowAccessControlContent.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      trigger: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkflowAccessControlTrigger.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      workflowManagement: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkflowAccessControlWorkflowManagement.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
