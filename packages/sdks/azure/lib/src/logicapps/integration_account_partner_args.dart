...
class IntegrationAccountPartnerArgs {
  ...
  final pulumi.Input<List<IntegrationAccountPartnerBusinessIdentity>>
  businessIdentities;
  ...
  factory IntegrationAccountPartnerArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationAccountPartnerArgs(
      businessIdentities: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IntegrationAccountPartnerBusinessIdentity>(
          map['businessIdentities']!,
          (value) => IntegrationAccountPartnerBusinessIdentity.fromMap(
