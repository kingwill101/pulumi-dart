...
class HciDeploymentSettingScaleUnitHostNetworkIntent {
  ...
  /// [qosPolicyOverride] A `qosPolicyOverride` block as defined below. Changing this forces a new Stack HCI Deployment Setting to be created.
  ...
  /// [virtualSwitchConfigurationOverride] A `virtualSwitchConfigurationOverride` block as defined below. Changing this forces a new Stack HCI Deployment Setting to be created.
  ...
  factory HciDeploymentSettingScaleUnitHostNetworkIntent.fromMap(Map<String, dynamic> map) {
    return HciDeploymentSettingScaleUnitHostNetworkIntent(
      adapterPropertyOverride: (() { final guardedValue = map['adapterPropertyOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HciDeploymentSettingScaleUnitHostNetworkIntentAdapterPropertyOverride.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      adapterPropertyOverrideEnabled: (() { final guardedValue = map['adapterPropertyOverrideEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      adapters: pulumi.Input.fromValue((map['adapters'] as List).cast<String>()),
      name: pulumi.Input.fromValue(map['name'] as String),
      qosPolicyOverride: (() { final guardedValue = map['qosPolicyOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HciDeploymentSettingScaleUnitHostNetworkIntentQosPolicyOverride.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      qosPolicyOverrideEnabled: (() { final guardedValue = map['qosPolicyOverrideEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      trafficTypes: pulumi.Input.fromValue((map['trafficTypes'] as List).cast<String>()),
      virtualSwitchConfigurationOverride: (() { final guardedValue = map['virtualSwitchConfigurationOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HciDeploymentSettingScaleUnitHostNetworkIntentVirtualSwitchConfigurationOverride.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      virtualSwitchConfigurationOverrideEnabled: (() { final guardedValue = map['virtualSwitchConfigurationOverrideEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
