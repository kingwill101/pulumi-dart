...
class HciDeploymentSettingScaleUnitStorage {
  ...
  HciDeploymentSettingScaleUnitStorage({required this.configurationMode});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'configurationMode': configurationMode};
  }

  factory HciDeploymentSettingScaleUnitStorage.fromMap(
    Map<String, dynamic> map,
  ) {
    return HciDeploymentSettingScaleUnitStorage(
      configurationMode: pulumi.Input.fromValue(
        map['configurationMode'] as String,
      ),
    );
  }
}
