...
class HciDeploymentSettingScaleUnitHostNetwork {
  ...
  final pulumi.Input<List<HciDeploymentSettingScaleUnitHostNetworkIntent>>
  intents;
  ...
  factory HciDeploymentSettingScaleUnitHostNetwork.fromMap(
    Map<String, dynamic> map,
  ) {
    return HciDeploymentSettingScaleUnitHostNetwork(
      intents: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HciDeploymentSettingScaleUnitHostNetworkIntent>(
          map['intents']!,
          (value) => HciDeploymentSettingScaleUnitHostNetworkIntent.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      storageAutoIpEnabled: (() {
        final guardedValue = map['storageAutoIpEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      storageConnectivitySwitchlessEnabled: (() {
        final guardedValue = map['storageConnectivitySwitchlessEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      storageNetworks: pulumi.Input.fromValue(
        ...
        >(
          map['storageNetworks']!,
          (value) =>
              HciDeploymentSettingScaleUnitHostNetworkStorageNetwork.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
