...
class HciDeploymentSettingScaleUnitHostNetwork {
  ...
  final List<HciDeploymentSettingScaleUnitHostNetworkIntent> intents;
  ...
  final bool? storageAutoIpEnabled;
  ...
  final bool? storageConnectivitySwitchlessEnabled;
  ...
  final List<HciDeploymentSettingScaleUnitHostNetworkStorageNetwork> storageNetworks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'intents': pulumi.Input.encodeList<HciDeploymentSettingScaleUnitHostNetworkIntent, Map<String, dynamic>>(intents, (value) => value.toMap()),
      'storageAutoIpEnabled': ?storageAutoIpEnabled,
      'storageConnectivitySwitchlessEnabled': ?storageConnectivitySwitchlessEnabled,
      'storageNetworks': pulumi.Input.encodeList<HciDeploymentSettingScaleUnitHostNetworkStorageNetwork, Map<String, dynamic>>(storageNetworks, (value) => value.toMap()),
    };
  }
  ...
  factory HciDeploymentSettingScaleUnitHostNetwork.fromMap(Map<String, dynamic> map) {
    return HciDeploymentSettingScaleUnitHostNetwork(
      intents: pulumi.Input.decodeList<HciDeploymentSettingScaleUnitHostNetworkIntent>(map['intents'], (value) => HciDeploymentSettingScaleUnitHostNetworkIntent.fromMap((value as Map).cast<String, dynamic>())),
      storageAutoIpEnabled: map['storageAutoIpEnabled'] == null ? null : map['storageAutoIpEnabled'] as bool,
      storageConnectivitySwitchlessEnabled: map['storageConnectivitySwitchlessEnabled'] == null ? null : map['storageConnectivitySwitchlessEnabled'] as bool,
      storageNetworks: pulumi.Input.decodeList<HciDeploymentSettingScaleUnitHostNetworkStorageNetwork>(map['storageNetworks'], (value) => HciDeploymentSettingScaleUnitHostNetworkStorageNetwork.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
