    ...
    return <String, dynamic>{
      ...
      'ipPools':
          ?pulumi.Input.mapOptionalInputValue<
            List<HciLogicalNetworkSubnetIpPool>,
      ...
      'routes':
          ?pulumi.Input.mapOptionalInputValue<
            List<HciLogicalNetworkSubnetRoute>,
            List<Map<String, dynamic>>
          >(
            routes,
            (value) =>
    ...
    return HciLogicalNetworkSubnet(
      ...
      ipPools: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HciLogicalNetworkSubnetIpPool>(
            guardedValue,
            (value) => HciLogicalNetworkSubnetIpPool.fromMap(
      ...
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HciLogicalNetworkSubnetRoute>(
            guardedValue,
            (value) => HciLogicalNetworkSubnetRoute.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
