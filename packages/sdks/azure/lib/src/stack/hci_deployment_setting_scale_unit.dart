...
class HciDeploymentSettingScaleUnit {
  ...
  final pulumi.Input<List<HciDeploymentSettingScaleUnitInfrastructureNetwork>>
  ...
  final pulumi.Input<HciDeploymentSettingScaleUnitOptionalService>
  optionalService;

  /// One or more `physical_node` blocks as defined above. Changing this forces a new Stack HCI Deployment Setting to be created.
  final pulumi.Input<List<HciDeploymentSettingScaleUnitPhysicalNode>>
  physicalNodes;
    ...
    return <String, dynamic>{
      ...
      'optionalService':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(optionalService, (value) => value.toMap()),
      'physicalNodes':
          pulumi.Input.mapInputValue<
  ...
  factory HciDeploymentSettingScaleUnit.fromMap(Map<String, dynamic> map) {
    return HciDeploymentSettingScaleUnit(
      activeDirectoryOrganizationalUnitPath: pulumi.Input.fromValue(
        map['activeDirectoryOrganizationalUnitPath'] as String,
      ),
      bitlockerBootVolumeEnabled: (() {
        final guardedValue = map['bitlockerBootVolumeEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      bitlockerDataVolumeEnabled: (() {
        final guardedValue = map['bitlockerDataVolumeEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      cluster: pulumi.Input.fromValue(
        HciDeploymentSettingScaleUnitCluster.fromMap(
          (map['cluster']! as Map).cast<String, dynamic>(),
        ),
      ),
      credentialGuardEnabled: (() {
        final guardedValue = map['credentialGuardEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      domainFqdn: pulumi.Input.fromValue(map['domainFqdn'] as String),
      driftControlEnabled: (() {
        final guardedValue = map['driftControlEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      drtmProtectionEnabled: (() {
        final guardedValue = map['drtmProtectionEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      episodicDataUploadEnabled: (() {
        final guardedValue = map['episodicDataUploadEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      euLocationEnabled: (() {
        final guardedValue = map['euLocationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      hostNetwork: pulumi.Input.fromValue(
        HciDeploymentSettingScaleUnitHostNetwork.fromMap(
          (map['hostNetwork']! as Map).cast<String, dynamic>(),
        ),
      ),
      hvciProtectionEnabled: (() {
        final guardedValue = map['hvciProtectionEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      infrastructureNetworks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          HciDeploymentSettingScaleUnitInfrastructureNetwork
        >(
          map['infrastructureNetworks']!,
          (value) => HciDeploymentSettingScaleUnitInfrastructureNetwork.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      namePrefix: pulumi.Input.fromValue(map['namePrefix'] as String),
      optionalService: pulumi.Input.fromValue(
        HciDeploymentSettingScaleUnitOptionalService.fromMap(
          (map['optionalService']! as Map).cast<String, dynamic>(),
        ),
      ),
      physicalNodes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HciDeploymentSettingScaleUnitPhysicalNode>(
          map['physicalNodes']!,
          (value) => HciDeploymentSettingScaleUnitPhysicalNode.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      sideChannelMitigationEnabled: (() {
        final guardedValue = map['sideChannelMitigationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      smbClusterEncryptionEnabled: (() {
        final guardedValue = map['smbClusterEncryptionEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      smbSigningEnabled: (() {
        final guardedValue = map['smbSigningEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      storage: pulumi.Input.fromValue(
        HciDeploymentSettingScaleUnitStorage.fromMap(
          (map['storage']! as Map).cast<String, dynamic>(),
        ),
      ),
      streamingDataClientEnabled: (() {
        final guardedValue = map['streamingDataClientEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      wdacEnabled: (() {
        final guardedValue = map['wdacEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
