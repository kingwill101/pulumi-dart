...
class HciDeploymentSettingState {
  ...
  factory HciDeploymentSettingState.fromMap(Map<String, dynamic> map) {
    return HciDeploymentSettingState(
      arcResourceIds: (() { final guardedValue = map['arcResourceIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      scaleUnits: (() { final guardedValue = map['scaleUnits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HciDeploymentSettingScaleUnit>(guardedValue, (value) => HciDeploymentSettingScaleUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
      stackHciClusterId: (() { final guardedValue = map['stackHciClusterId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
