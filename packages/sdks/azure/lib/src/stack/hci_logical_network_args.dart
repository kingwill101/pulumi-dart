...
class HciLogicalNetworkArgs {
  ...
  factory HciLogicalNetworkArgs.fromMap(Map<String, dynamic> map) {
    return HciLogicalNetworkArgs(
      ...
      subnet: pulumi.Input.fromValue(HciLogicalNetworkSubnet.fromMap((map['subnet']! as Map).cast<String, dynamic>())),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      virtualSwitchName: pulumi.Input.fromValue(map['virtualSwitchName'] as String),
    );
  }
}
