...
class HciDeploymentSettingScaleUnitCluster {
  ...
  const HciDeploymentSettingScaleUnitCluster({
  ...
  factory HciDeploymentSettingScaleUnitCluster.fromMap(Map<String, dynamic> map) {
    return HciDeploymentSettingScaleUnitCluster(
      azureServiceEndpoint: pulumi.Input.fromValue(map['azureServiceEndpoint'] as String),
      cloudAccountName: pulumi.Input.fromValue(map['cloudAccountName'] as String),
