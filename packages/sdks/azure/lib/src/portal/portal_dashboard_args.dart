...
class PortalDashboardArgs {
  ...
  PortalDashboardArgs({
    required pulumi.Output<String> dashboardProperties,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      dashboardProperties = pulumi.Input.asInput<String>(dashboardProperties),
  ...
  factory PortalDashboardArgs.fromMap(Map<String, dynamic> map) {
    return PortalDashboardArgs(
      dashboardProperties: pulumi.Output.create<String>(map['dashboardProperties'] as String),
