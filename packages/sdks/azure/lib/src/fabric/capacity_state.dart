...
class CapacityState {
  ...
  factory CapacityState.fromMap(Map<String, dynamic> map) {
    return CapacityState(
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacitySku.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
