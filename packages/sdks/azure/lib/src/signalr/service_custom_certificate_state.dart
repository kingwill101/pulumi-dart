...
class ServiceCustomCertificateState {
  ...
  const ServiceCustomCertificateState({
  ...
  factory ServiceCustomCertificateState.fromMap(Map<String, dynamic> map) {
    return ServiceCustomCertificateState(
      certificateVersion: (() { final guardedValue = map['certificateVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
