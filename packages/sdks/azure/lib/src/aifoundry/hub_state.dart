...
class HubState {
  ...
  factory HubState.fromMap(Map<String, dynamic> map) {
    return HubState(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HubIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
