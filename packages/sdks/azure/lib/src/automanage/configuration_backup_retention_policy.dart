...
class ConfigurationBackupRetentionPolicy {
  ...
  final pulumi.Input<ConfigurationBackupRetentionPolicyDailySchedule>?
  dailySchedule;
  ...
  final pulumi.Input<ConfigurationBackupRetentionPolicyWeeklySchedule>?
  weeklySchedule;
    ...
    return ConfigurationBackupRetentionPolicy(
      dailySchedule: (() {
        ...
        return pulumi.Input.fromValue(
          ConfigurationBackupRetentionPolicyDailySchedule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      retentionPolicyType: (() {
        final guardedValue = map['retentionPolicyType'];
        if (guardedValue == null) return null;
      ...
      weeklySchedule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationBackupRetentionPolicyWeeklySchedule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
