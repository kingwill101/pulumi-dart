...
class CertifiateState {
  ...
  CertifiateState({
    pulumi.Output<CertifiateCertificate>? certificate,
    pulumi.Output<List<CertifiateCertificateAttribute>>? certificateAttributes,
    pulumi.Output<String>? certificateData,
    pulumi.Output<String>? certificateDataBase64,
    pulumi.Output<CertifiateCertificatePolicy>? certificatePolicy,
    ...
    pulumi.Output<String>? versionlessSecretId,
      ...
      certificate = pulumi.Input.asOptionalInput<CertifiateCertificate>(certificate),
      certificateAttributes = pulumi.Input.asOptionalInput<List<CertifiateCertificateAttribute>>(certificateAttributes),
      ...
      certificatePolicy = pulumi.Input.asOptionalInput<CertifiateCertificatePolicy>(certificatePolicy),
  ...
  factory CertifiateState.fromMap(Map<String, dynamic> map) {
    return CertifiateState(
      certificate: map['certificate'] == null ? null : pulumi.Output.create<CertifiateCertificate>(CertifiateCertificate.fromMap((map['certificate'] as Map).cast<String, dynamic>())),
      certificateAttributes: map['certificateAttributes'] == null ? null : pulumi.Output.create<List<CertifiateCertificateAttribute>>(pulumi.Input.decodeList<CertifiateCertificateAttribute>(map['certificateAttributes'], (value) => CertifiateCertificateAttribute.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      certificatePolicy: map['certificatePolicy'] == null ? null : pulumi.Output.create<CertifiateCertificatePolicy>(CertifiateCertificatePolicy.fromMap((map['certificatePolicy'] as Map).cast<String, dynamic>())),
