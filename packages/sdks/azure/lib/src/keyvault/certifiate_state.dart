...
class CertifiateState {
  ...
  /// [certificateAttributes] A `certificateAttribute` block as defined below.
  ...
  factory CertifiateState.fromMap(Map<String, dynamic> map) {
    return CertifiateState(
      ...
      certificateAttributes: (() { final guardedValue = map['certificateAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertifiateCertificateAttribute>(guardedValue, (value) => CertifiateCertificateAttribute.fromMap((value as Map).cast<String, dynamic>()))); })(),
