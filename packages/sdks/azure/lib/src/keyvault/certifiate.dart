...
class Certifiate extends pulumi.CustomResource {
  ...
  /// Creates a new [Certifiate].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Certifiate]. {@macro pulumi_keyvault_certifiate_certifiate_args_doc}
  ...
  Certifiate(
    ...
    certificate = registerOutput<CertifiateCertificate?>(
      'certificate',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return CertifiateCertificate.fromMap(
    ...
    certificatePolicy = registerOutput<CertifiateCertificatePolicy>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return CertifiateCertificatePolicy.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
