...
class GetEncryptedValueArgs {
  ...
  factory GetEncryptedValueArgs.fromMap(Map<String, dynamic> map) {
    return GetEncryptedValueArgs(
      ...
      encryptedData: (() { final guardedValue = map['encryptedData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      keyVaultKeyId: pulumi.Input.fromValue(map['keyVaultKeyId'] as String),
      plainTextValue: (() { final guardedValue = map['plainTextValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
