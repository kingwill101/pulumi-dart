...
class KeyVaultArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contacts':
          ?pulumi.Input.mapOptionalInputValue<
            List<KeyVaultContact>,
            List<Map<String, dynamic>>
          >(
            contacts,
            (value) =>
                pulumi.Input.encodeList<KeyVaultContact, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return KeyVaultArgs(
      accessPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeyVaultAccessPolicy>(
            guardedValue,
            (value) => KeyVaultAccessPolicy.fromMap(
      ...
      contacts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeyVaultContact>(
            guardedValue,
            (value) =>
                KeyVaultContact.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      rbacAuthorizationEnabled: (() {
        final guardedValue = map['rbacAuthorizationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
