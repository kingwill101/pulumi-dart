...
class CertificateCertificatePolicyX509CertificateProperties {
  ...
  factory CertificateCertificatePolicyX509CertificateProperties.fromMap(
    ...
    return CertificateCertificatePolicyX509CertificateProperties(
      ...
      subjectAlternativeNames: (() {
        ...
        return pulumi.Input.fromValue(
          CertificateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNames.fromMap(
