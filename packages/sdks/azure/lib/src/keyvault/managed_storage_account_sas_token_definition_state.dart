...
class ManagedStorageAccountSasTokenDefinitionState {
  ...
  factory ManagedStorageAccountSasTokenDefinitionState.fromMap(Map<String, dynamic> map) {
    return ManagedStorageAccountSasTokenDefinitionState(
      managedStorageAccountId: (() { final guardedValue = map['managedStorageAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sasTemplateUri: (() { final guardedValue = map['sasTemplateUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sasType: (() { final guardedValue = map['sasType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      validityPeriod: (() { final guardedValue = map['validityPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
