...
class GetManagedHardwareSecurityModuleRoleDefinitionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'permissions': pulumi.Input.encodeList<GetManagedHardwareSecurityModuleRoleDefinitionPermission, Map<String, dynamic>>(permissions, (value) => value.toMap()),
  ...
  factory GetManagedHardwareSecurityModuleRoleDefinitionResult.fromMap(Map<String, dynamic> map) {
    return GetManagedHardwareSecurityModuleRoleDefinitionResult(
      ...
      permissions: pulumi.Input.decodeList<GetManagedHardwareSecurityModuleRoleDefinitionPermission>(map['permissions'], (value) => GetManagedHardwareSecurityModuleRoleDefinitionPermission.fromMap((value as Map).cast<String, dynamic>())),
