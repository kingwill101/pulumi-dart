...
class CertifiateCertificatePolicy {
  ...
  final pulumi.Input<CertifiateCertificatePolicyIssuerParameters>
  issuerParameters;
  ...
  final pulumi.Input<List<CertifiateCertificatePolicyLifetimeAction>>?
  lifetimeActions;

  /// A `secret_properties` block as defined below.
  final pulumi.Input<CertifiateCertificatePolicySecretProperties>
  secretProperties;

  /// A `x509_certificate_properties` block as defined below. Required when `certificate` block is not specified.
  final pulumi.Input<CertifiateCertificatePolicyX509CertificateProperties>?
    ...
    return <String, dynamic>{
      'issuerParameters':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(issuerParameters, (value) => value.toMap()),
      'keyProperties':
          pulumi.Input.mapInputValue<
            CertifiateCertificatePolicyKeyProperties,
            Map<String, dynamic>
          >(keyProperties, (value) => value.toMap()),
      'lifetimeActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<CertifiateCertificatePolicyLifetimeAction>,
      ...
      'secretProperties':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(secretProperties, (value) => value.toMap()),
      'x509CertificateProperties':
          ?pulumi.Input.mapOptionalInputValue<
            CertifiateCertificatePolicyX509CertificateProperties,
            Map<String, dynamic>
          >(x509CertificateProperties, (value) => value.toMap()),
    };
  }

  factory CertifiateCertificatePolicy.fromMap(Map<String, dynamic> map) {
    return CertifiateCertificatePolicy(
      issuerParameters: pulumi.Input.fromValue(
        CertifiateCertificatePolicyIssuerParameters.fromMap(
          (map['issuerParameters']! as Map).cast<String, dynamic>(),
        ),
      ),
      keyProperties: pulumi.Input.fromValue(
        CertifiateCertificatePolicyKeyProperties.fromMap(
          (map['keyProperties']! as Map).cast<String, dynamic>(),
        ),
      ),
      lifetimeActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CertifiateCertificatePolicyLifetimeAction>(
            guardedValue,
            (value) => CertifiateCertificatePolicyLifetimeAction.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      secretProperties: pulumi.Input.fromValue(
        CertifiateCertificatePolicySecretProperties.fromMap(
          (map['secretProperties']! as Map).cast<String, dynamic>(),
        ),
      ),
      x509CertificateProperties: (() {
        final guardedValue = map['x509CertificateProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CertifiateCertificatePolicyX509CertificateProperties.fromMap(
