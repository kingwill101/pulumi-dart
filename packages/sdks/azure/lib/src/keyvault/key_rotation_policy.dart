...
class KeyRotationPolicy {
  ...
  factory KeyRotationPolicy.fromMap(Map<String, dynamic> map) {
    return KeyRotationPolicy(
      automatic: (() { final guardedValue = map['automatic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyRotationPolicyAutomatic.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      notifyBeforeExpiry: (() { final guardedValue = map['notifyBeforeExpiry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
