...
import 'managed_hardware_security_module_role_assignment_state.dart';
...
class ManagedHardwareSecurityModuleRoleAssignment extends pulumi.CustomResource {
  ...
  /// Gets an existing [ManagedHardwareSecurityModuleRoleAssignment] resource's state with the given [name] and [id].
  static ManagedHardwareSecurityModuleRoleAssignment get(
    String name,
  ...
  ManagedHardwareSecurityModuleRoleAssignment._get(
    String name, {
