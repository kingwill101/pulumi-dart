...
class GetKeyVaultAccessPolicy {
  ...
  factory GetKeyVaultAccessPolicy.fromMap(Map<String, dynamic> map) {
    return GetKeyVaultAccessPolicy(
      ...
      certificatePermissions: pulumi.Input.fromValue(
        (map['certificatePermissions'] as List).cast<String>(),
      ),
      keyPermissions: pulumi.Input.fromValue(
        (map['keyPermissions'] as List).cast<String>(),
      ),
      objectId: pulumi.Input.fromValue(map['objectId'] as String),
      secretPermissions: pulumi.Input.fromValue(
        (map['secretPermissions'] as List).cast<String>(),
      ),
      storagePermissions: pulumi.Input.fromValue(
        (map['storagePermissions'] as List).cast<String>(),
      ),
