  ...
  factory AccessPolicyState.fromMap(Map<String, dynamic> map) {
    return AccessPolicyState(
      ...
      certificatePermissions: (() {
        final guardedValue = map['certificatePermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      keyPermissions: (() {
        final guardedValue = map['keyPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      keyVaultId: (() {
      ...
      secretPermissions: (() {
        final guardedValue = map['secretPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      storagePermissions: (() {
        final guardedValue = map['storagePermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      tenantId: (() {
