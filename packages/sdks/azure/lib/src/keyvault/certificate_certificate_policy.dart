...
class CertificateCertificatePolicy {
  ...
  final pulumi.Input<CertificateCertificatePolicyIssuerParameters>
  issuerParameters;
  ...
  final pulumi.Input<List<CertificateCertificatePolicyLifetimeAction>>?
  lifetimeActions;

  /// A `secret_properties` block as defined below.
  final pulumi.Input<CertificateCertificatePolicySecretProperties>
  secretProperties;

  /// A `x509_certificate_properties` block as defined below. Required when `certificate` block is not specified.
  final pulumi.Input<CertificateCertificatePolicyX509CertificateProperties>?
    ...
    return <String, dynamic>{
      ...
      'lifetimeActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<CertificateCertificatePolicyLifetimeAction>,
  ...
  factory CertificateCertificatePolicy.fromMap(Map<String, dynamic> map) {
    return CertificateCertificatePolicy(
      issuerParameters: pulumi.Input.fromValue(
        CertificateCertificatePolicyIssuerParameters.fromMap(
          (map['issuerParameters']! as Map).cast<String, dynamic>(),
        ),
      ),
      keyProperties: pulumi.Input.fromValue(
        CertificateCertificatePolicyKeyProperties.fromMap(
      ...
      lifetimeActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CertificateCertificatePolicyLifetimeAction>(
            guardedValue,
            (value) => CertificateCertificatePolicyLifetimeAction.fromMap(
      ...
      secretProperties: pulumi.Input.fromValue(
        CertificateCertificatePolicySecretProperties.fromMap(
      ...
      x509CertificateProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CertificateCertificatePolicyX509CertificateProperties.fromMap(
