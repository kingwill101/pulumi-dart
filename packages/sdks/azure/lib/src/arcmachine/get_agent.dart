...
class GetAgent {
    ...
    return <String, dynamic>{
      'extensionsAllowLists':
          pulumi.Input.mapInputValue<
            List<GetAgentExtensionsAllowList>,
      ...
      'extensionsBlockLists':
          pulumi.Input.mapInputValue<
            List<GetAgentExtensionsBlockList>,
            List<Map<String, dynamic>>
          >(
            extensionsBlockLists,
            (value) =>
  ...
  factory GetAgent.fromMap(Map<String, dynamic> map) {
    return GetAgent(
      extensionsAllowLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAgentExtensionsAllowList>(
          map['extensionsAllowLists']!,
          (value) => GetAgentExtensionsAllowList.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      extensionsBlockLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAgentExtensionsBlockList>(
          map['extensionsBlockLists']!,
          (value) => GetAgentExtensionsBlockList.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      extensionsEnabled: pulumi.Input.fromValue(
        map['extensionsEnabled'] as bool,
      ),
      guestConfigurationEnabled: pulumi.Input.fromValue(
        map['guestConfigurationEnabled'] as bool,
      ),
      incomingConnectionsPorts: pulumi.Input.fromValue(
        (map['incomingConnectionsPorts'] as List).cast<String>(),
      ),
      proxyBypasses: pulumi.Input.fromValue(
        (map['proxyBypasses'] as List).cast<String>(),
      ),
