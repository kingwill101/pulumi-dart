...
class GetServiceStatus {
  ...
  factory GetServiceStatus.fromMap(Map<String, dynamic> map) {
    return GetServiceStatus(
      extensionServices: (pulumi.Input.decodeList<GetServiceStatusExtensionService>(map['extensionServices'], (value) => GetServiceStatusExtensionService.fromMap((value as Map).cast<String, dynamic>()))).input(),
      guestConfigurationServices: (pulumi.Input.decodeList<GetServiceStatusGuestConfigurationService>(map['guestConfigurationServices'], (value) => GetServiceStatusGuestConfigurationService.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
