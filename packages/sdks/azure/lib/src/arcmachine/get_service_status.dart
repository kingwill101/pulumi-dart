...
class GetServiceStatus {
  ...
  final pulumi.Input<List<GetServiceStatusGuestConfigurationService>>
    ...
    return <String, dynamic>{
      'extensionServices':
          pulumi.Input.mapInputValue<
            List<GetServiceStatusExtensionService>,
      ...
      'guestConfigurationServices':
          pulumi.Input.mapInputValue<
            List<GetServiceStatusGuestConfigurationService>,
            List<Map<String, dynamic>>
          >(
            guestConfigurationServices,
            (value) =>
  ...
  factory GetServiceStatus.fromMap(Map<String, dynamic> map) {
    return GetServiceStatus(
      extensionServices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceStatusExtensionService>(
          map['extensionServices']!,
          (value) => GetServiceStatusExtensionService.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      guestConfigurationServices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceStatusGuestConfigurationService>(
          map['guestConfigurationServices']!,
          (value) => GetServiceStatusGuestConfigurationService.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
