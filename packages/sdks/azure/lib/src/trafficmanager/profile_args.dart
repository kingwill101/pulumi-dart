...
class ProfileArgs {
  ...
  ProfileArgs({
    required pulumi.Output<ProfileDnsConfig> dnsConfig,
    pulumi.Output<int>? maxReturn,
    required pulumi.Output<ProfileMonitorConfig> monitorConfig,
    ...
    pulumi.Output<bool>? trafficViewEnabled,
      ...
      dnsConfig = pulumi.Input.asInput<ProfileDnsConfig>(dnsConfig),
      maxReturn = pulumi.Input.asOptionalInput<int>(maxReturn),
      monitorConfig = pulumi.Input.asInput<ProfileMonitorConfig>(monitorConfig),
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      dnsConfig: pulumi.Output.create<ProfileDnsConfig>(ProfileDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>())),
      maxReturn: map['maxReturn'] == null ? null : pulumi.Output.create<int>(map['maxReturn'] as int),
      monitorConfig: pulumi.Output.create<ProfileMonitorConfig>(ProfileMonitorConfig.fromMap((map['monitorConfig'] as Map).cast<String, dynamic>())),
