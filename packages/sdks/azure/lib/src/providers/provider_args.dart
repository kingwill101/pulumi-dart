...
class ProviderArgs {
  ...
  factory ProviderArgs.fromMap(Map<String, dynamic> map) {
    return ProviderArgs(
      ...
      msiApiVersion: (() { final guardedValue = map['msiApiVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      resourceProviderRegistrations: (() { final guardedValue = map['resourceProviderRegistrations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceProvidersToRegisters: (() { final guardedValue = map['resourceProvidersToRegisters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      skipProviderRegistration: (() { final guardedValue = map['skipProviderRegistration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      storageUseAzuread: (() { final guardedValue = map['storageUseAzuread']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
