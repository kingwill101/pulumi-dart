...
class EndpointPrivateDnsZoneConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recordSets': ?pulumi.Input.mapOptionalInputValue<List<EndpointPrivateDnsZoneConfigRecordSet>, List<Map<String, dynamic>>>(recordSets, (value) => pulumi.Input.encodeList<EndpointPrivateDnsZoneConfigRecordSet, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory EndpointPrivateDnsZoneConfig.fromMap(Map<String, dynamic> map) {
    return EndpointPrivateDnsZoneConfig(
      ...
      recordSets: (() { final guardedValue = map['recordSets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointPrivateDnsZoneConfigRecordSet>(guardedValue, (value) => EndpointPrivateDnsZoneConfigRecordSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
