...
class GetServiceEndpointConnectionsResult {
  ...
  final List<GetServiceEndpointConnectionsPrivateEndpointConnection>
  ...
  factory GetServiceEndpointConnectionsResult.fromMap(
    ...
    return GetServiceEndpointConnectionsResult(
      ...
      privateEndpointConnections:
          ...
          >(
            ...
            (value) =>
                GetServiceEndpointConnectionsPrivateEndpointConnection.fromMap(
