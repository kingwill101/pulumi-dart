...
class EndpointState {
  ...
  final pulumi.Input<EndpointPrivateServiceConnection>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'privateDnsZoneConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointPrivateDnsZoneConfig>,
            List<Map<String, dynamic>>
          >(
            privateDnsZoneConfigs,
            (value) =>
      ...
      'privateDnsZoneGroup':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(privateDnsZoneGroup, (value) => value.toMap()),
      'privateServiceConnection':
          ?pulumi.Input.mapOptionalInputValue<
            EndpointPrivateServiceConnection,
            Map<String, dynamic>
          >(privateServiceConnection, (value) => value.toMap()),
  ...
  factory EndpointState.fromMap(Map<String, dynamic> map) {
    return EndpointState(
      customDnsConfigs: (() {
        final guardedValue = map['customDnsConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointCustomDnsConfig>(
            guardedValue,
            (value) => EndpointCustomDnsConfig.fromMap(
      ...
      customNetworkInterfaceName: (() {
        final guardedValue = map['customNetworkInterfaceName'];
        if (guardedValue == null) return null;
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointIpConfiguration>(
            guardedValue,
            (value) => EndpointIpConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      networkInterfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointNetworkInterface>(
            guardedValue,
            (value) => EndpointNetworkInterface.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      privateDnsZoneConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPrivateDnsZoneConfig>(
            guardedValue,
            (value) => EndpointPrivateDnsZoneConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      privateDnsZoneGroup: (() {
        final guardedValue = map['privateDnsZoneGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointPrivateDnsZoneGroup.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      privateServiceConnection: (() {
        final guardedValue = map['privateServiceConnection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointPrivateServiceConnection.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
