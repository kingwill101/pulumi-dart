...
class EndpointEventHubArgs {
  ...
  factory EndpointEventHubArgs.fromMap(Map<String, dynamic> map) {
    return EndpointEventHubArgs(
      ...
      eventhubPrimaryConnectionString: pulumi.Input.fromValue(
        map['eventhubPrimaryConnectionString'] as String,
      ),
      eventhubSecondaryConnectionString: pulumi.Input.fromValue(
        map['eventhubSecondaryConnectionString'] as String,
      ),
      name: (() {
