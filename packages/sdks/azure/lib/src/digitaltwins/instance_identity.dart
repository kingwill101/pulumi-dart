...
class InstanceIdentity {
  ...
  /// Creates a new [InstanceIdentity].
  /// [identityIds] A list of User Assigned Managed Identity IDs to be assigned to this Digital Twins instance.
  ...
  factory InstanceIdentity.fromMap(Map<String, dynamic> map) {
