...
class Definition extends pulumi.CustomResource {
  ...
  Definition(
    ...
    permissions = registerOutput<List<DefinitionPermission>?>('permissions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<DefinitionPermission>(guardedValue, (value) => DefinitionPermission.fromMap((value as Map).cast<String, dynamic>())); });
