...
class WindowsVirtualMachineState {
  ...
  WindowsVirtualMachineState({
    ...
    pulumi.Output<WindowsVirtualMachineGalleryImageReference>? galleryImageReference,
    ...
    pulumi.Output<String>? username,
      ...
      galleryImageReference = pulumi.Input.asOptionalInput<WindowsVirtualMachineGalleryImageReference>(galleryImageReference),
  ...
  factory WindowsVirtualMachineState.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineState(
      ...
      galleryImageReference: map['galleryImageReference'] == null ? null : pulumi.Output.create<WindowsVirtualMachineGalleryImageReference>(WindowsVirtualMachineGalleryImageReference.fromMap((map['galleryImageReference'] as Map).cast<String, dynamic>())),
