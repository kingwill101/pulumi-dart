...
class WindowsVirtualMachineState {
  ...
  factory WindowsVirtualMachineState.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineState(
      ...
      galleryImageReference: map['galleryImageReference'] == null ? null : (WindowsVirtualMachineGalleryImageReference.fromMap((map['galleryImageReference'] as Map).cast<String, dynamic>())).input(),
