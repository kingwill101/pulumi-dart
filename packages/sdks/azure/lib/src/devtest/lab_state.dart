...
class LabState {
  ...
  factory LabState.fromMap(Map<String, dynamic> map) {
    return LabState(
      artifactsStorageAccountId: (() { final guardedValue = map['artifactsStorageAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultPremiumStorageAccountId: (() { final guardedValue = map['defaultPremiumStorageAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultStorageAccountId: (() { final guardedValue = map['defaultStorageAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      premiumDataDiskStorageAccountId: (() { final guardedValue = map['premiumDataDiskStorageAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
