...
class LinuxVirtualMachineArgs {
  ...
  LinuxVirtualMachineArgs({
    ...
    required pulumi.Output<LinuxVirtualMachineGalleryImageReference> galleryImageReference,
  ...
  factory LinuxVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineArgs(
      ...
      galleryImageReference: pulumi.Output.create<LinuxVirtualMachineGalleryImageReference>(LinuxVirtualMachineGalleryImageReference.fromMap((map['galleryImageReference'] as Map).cast<String, dynamic>())),
