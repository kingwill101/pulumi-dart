...
class WindowsVirtualMachineArgs {
  ...
  factory WindowsVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineArgs(
      ...
      galleryImageReference: (WindowsVirtualMachineGalleryImageReference.fromMap((map['galleryImageReference'] as Map).cast<String, dynamic>())).input(),
      inboundNatRules: map['inboundNatRules'] == null ? null : (pulumi.Input.decodeList<WindowsVirtualMachineInboundNatRule>(map['inboundNatRules']!, (value) => WindowsVirtualMachineInboundNatRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
