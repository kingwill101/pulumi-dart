...
class WindowsVirtualMachineArgs {
  ...
  factory WindowsVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineArgs(
      ...
      galleryImageReference: pulumi.Input.fromValue(
        WindowsVirtualMachineGalleryImageReference.fromMap(
          (map['galleryImageReference']! as Map).cast<String, dynamic>(),
        ),
      ),
      inboundNatRules: (() {
      ...
      labVirtualNetworkId: pulumi.Input.fromValue(
        map['labVirtualNetworkId'] as String,
      ),
      location: (() {
