...
class GetVirtualNetworkSubnetOverride {
  ...
  factory GetVirtualNetworkSubnetOverride.fromMap(Map<String, dynamic> map) {
    return GetVirtualNetworkSubnetOverride(
      ...
      useInVmCreationPermission: pulumi.Input.fromValue(map['useInVmCreationPermission'] as String),
      usePublicIpAddressPermission: pulumi.Input.fromValue(map['usePublicIpAddressPermission'] as String),
      virtualNetworkPoolName: pulumi.Input.fromValue(map['virtualNetworkPoolName'] as String),
    );
  }
}
