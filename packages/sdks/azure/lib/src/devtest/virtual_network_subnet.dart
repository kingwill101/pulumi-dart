...
class VirtualNetworkSubnet {
  ...
  final pulumi.Input<VirtualNetworkSubnetSharedPublicIpAddress>?
    ...
    return <String, dynamic>{
      ...
      'sharedPublicIpAddress':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sharedPublicIpAddress, (value) => value.toMap()),
  ...
  factory VirtualNetworkSubnet.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkSubnet(
      ...
      sharedPublicIpAddress: (() {
        final guardedValue = map['sharedPublicIpAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworkSubnetSharedPublicIpAddress.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      useInVirtualMachineCreation: (() {
        final guardedValue = map['useInVirtualMachineCreation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      usePublicIpAddress: (() {
        final guardedValue = map['usePublicIpAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
