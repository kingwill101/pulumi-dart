...
class WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2 {
  ...
  /// Creates a new [WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2].
  ...
  const WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2({
  ...
  factory WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2(
