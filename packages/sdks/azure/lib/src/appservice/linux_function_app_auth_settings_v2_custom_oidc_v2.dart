...
class LinuxFunctionAppAuthSettingsV2CustomOidcV2 {
  ...
  /// Creates a new [LinuxFunctionAppAuthSettingsV2CustomOidcV2].
  ...
  factory LinuxFunctionAppAuthSettingsV2CustomOidcV2.fromMap(
    Map<String, dynamic> map,
  ) {
    return LinuxFunctionAppAuthSettingsV2CustomOidcV2(
