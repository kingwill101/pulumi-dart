...
class LinuxWebAppBackupSchedule {
  ...
  /// Creates a new [LinuxWebAppBackupSchedule].
  ...
  const LinuxWebAppBackupSchedule({
  ...
  factory LinuxWebAppBackupSchedule.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppBackupSchedule(
