...
class LinuxWebAppArgs {
  ...
  factory LinuxWebAppArgs.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppArgs(
      ...
      authSettings: map['authSettings'] == null ? null : (LinuxWebAppAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>())).input(),
      authSettingsV2: map['authSettingsV2'] == null ? null : (LinuxWebAppAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>())).input(),
      backup: map['backup'] == null ? null : (LinuxWebAppBackup.fromMap((map['backup'] as Map).cast<String, dynamic>())).input(),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : (pulumi.Input.decodeList<LinuxWebAppConnectionString>(map['connectionStrings'], (value) => LinuxWebAppConnectionString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      identity: map['identity'] == null ? null : (LinuxWebAppIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())).input(),
      ...
      logs: map['logs'] == null ? null : (LinuxWebAppLogs.fromMap((map['logs'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      publicNetworkAccessEnabled: map['publicNetworkAccessEnabled'] == null ? null : (map['publicNetworkAccessEnabled'] as bool).input(),
      resourceGroupName: (map['resourceGroupName'] as String).input(),
      servicePlanId: (map['servicePlanId'] as String).input(),
      siteConfig: (LinuxWebAppSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())).input(),
      stickySettings: map['stickySettings'] == null ? null : (LinuxWebAppStickySettings.fromMap((map['stickySettings'] as Map).cast<String, dynamic>())).input(),
      storageAccounts: map['storageAccounts'] == null ? null : (pulumi.Input.decodeList<LinuxWebAppStorageAccount>(map['storageAccounts'], (value) => LinuxWebAppStorageAccount.fromMap((value as Map).cast<String, dynamic>()))).input(),
