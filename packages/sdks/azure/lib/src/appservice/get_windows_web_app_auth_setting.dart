...
class GetWindowsWebAppAuthSetting {
  ...
  final pulumi.Input<List<GetWindowsWebAppAuthSettingActiveDirectory>>
  activeDirectories;
    ...
    return <String, dynamic>{
      'activeDirectories':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppAuthSettingActiveDirectory>,
      ...
      'facebooks':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppAuthSettingFacebook>,
            List<Map<String, dynamic>>
          >(
            facebooks,
            (value) =>
      ...
      'githubs':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppAuthSettingGithub>,
            List<Map<String, dynamic>>
          >(
            githubs,
            (value) =>
      ...
      'googles':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppAuthSettingGoogle>,
            List<Map<String, dynamic>>
          >(
            googles,
            (value) =>
      ...
      'microsofts':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppAuthSettingMicrosoft>,
            List<Map<String, dynamic>>
          >(
            microsofts,
            (value) =>
      ...
      'twitters':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppAuthSettingTwitter>,
            List<Map<String, dynamic>>
          >(
            twitters,
            (value) =>
  ...
  factory GetWindowsWebAppAuthSetting.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppAuthSetting(
      activeDirectories: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppAuthSettingActiveDirectory>(
          map['activeDirectories']!,
          (value) => GetWindowsWebAppAuthSettingActiveDirectory.fromMap(
      ...
      facebooks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppAuthSettingFacebook>(
          map['facebooks']!,
          (value) => GetWindowsWebAppAuthSettingFacebook.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      githubs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppAuthSettingGithub>(
          map['githubs']!,
          (value) => GetWindowsWebAppAuthSettingGithub.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      googles: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppAuthSettingGoogle>(
          map['googles']!,
          (value) => GetWindowsWebAppAuthSettingGoogle.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      microsofts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppAuthSettingMicrosoft>(
          map['microsofts']!,
          (value) => GetWindowsWebAppAuthSettingMicrosoft.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      twitters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppAuthSettingTwitter>(
          map['twitters']!,
          (value) => GetWindowsWebAppAuthSettingTwitter.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
