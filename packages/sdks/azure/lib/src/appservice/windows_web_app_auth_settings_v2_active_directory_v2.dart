...
class WindowsWebAppAuthSettingsV2ActiveDirectoryV2 {
  ...
  /// Creates a new [WindowsWebAppAuthSettingsV2ActiveDirectoryV2].
  ...
  const WindowsWebAppAuthSettingsV2ActiveDirectoryV2({
  ...
  factory WindowsWebAppAuthSettingsV2ActiveDirectoryV2.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettingsV2ActiveDirectoryV2(
