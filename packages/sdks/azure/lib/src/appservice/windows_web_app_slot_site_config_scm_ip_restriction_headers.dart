...
class WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders].
  ...
  const WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders(
