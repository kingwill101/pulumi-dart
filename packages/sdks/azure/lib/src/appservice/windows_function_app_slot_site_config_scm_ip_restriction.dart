...
class WindowsFunctionAppSlotSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders>?
  headers;
  ...
  factory WindowsFunctionAppSlotSiteConfigScmIpRestriction.fromMap(
    ...
    return WindowsFunctionAppSlotSiteConfigScmIpRestriction(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders.fromMap(
