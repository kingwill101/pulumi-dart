...
class SourceControlGithubActionConfiguration {
  ...
  final pulumi.Input<SourceControlGithubActionConfigurationCodeConfiguration>?
  codeConfiguration;
  ...
  factory SourceControlGithubActionConfiguration.fromMap(
    ...
    return SourceControlGithubActionConfiguration(
      codeConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          SourceControlGithubActionConfigurationCodeConfiguration.fromMap(
      ...
      containerConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourceControlGithubActionConfigurationContainerConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
