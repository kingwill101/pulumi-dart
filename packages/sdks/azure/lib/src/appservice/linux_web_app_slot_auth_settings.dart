...
import 'linux_web_app_slot_auth_settings_active_directory.dart';
import 'linux_web_app_slot_auth_settings_facebook.dart';
import 'linux_web_app_slot_auth_settings_github.dart';
import 'linux_web_app_slot_auth_settings_google.dart';
import 'linux_web_app_slot_auth_settings_microsoft.dart';
import 'linux_web_app_slot_auth_settings_twitter.dart';
...
class LinuxWebAppSlotAuthSettings {
  ...
  /// Creates a new [LinuxWebAppSlotAuthSettings].
  ...
  const LinuxWebAppSlotAuthSettings({
  ...
  factory LinuxWebAppSlotAuthSettings.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotAuthSettings(
      activeDirectory: (() { final guardedValue = map['activeDirectory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotAuthSettingsActiveDirectory.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      facebook: (() { final guardedValue = map['facebook']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotAuthSettingsFacebook.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      github: (() { final guardedValue = map['github']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotAuthSettingsGithub.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      google: (() { final guardedValue = map['google']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotAuthSettingsGoogle.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      microsoft: (() { final guardedValue = map['microsoft']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotAuthSettingsMicrosoft.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      twitter: (() { final guardedValue = map['twitter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotAuthSettingsTwitter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
