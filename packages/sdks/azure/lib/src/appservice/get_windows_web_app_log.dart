    ...
    return <String, dynamic>{
      'applicationLogs':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppLogApplicationLog>,
      ...
      'httpLogs':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppLogHttpLog>,
            List<Map<String, dynamic>>
          >(
            httpLogs,
            (value) =>
  ...
  factory GetWindowsWebAppLog.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppLog(
      applicationLogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppLogApplicationLog>(
          map['applicationLogs']!,
          (value) => GetWindowsWebAppLogApplicationLog.fromMap(
      ...
      httpLogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppLogHttpLog>(
          map['httpLogs']!,
          (value) => GetWindowsWebAppLogHttpLog.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
