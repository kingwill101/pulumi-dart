...
import 'function_app_site_config_scm_ip_restriction_headers.dart';
...
class FunctionAppSiteConfigScmIpRestriction {
  ...
  const FunctionAppSiteConfigScmIpRestriction({
    this.action,
    this.headers,
    this.ipAddress,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?action,
      'headers': ?pulumi.Input.mapOptionalInputValue<FunctionAppSiteConfigScmIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory FunctionAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return FunctionAppSiteConfigScmIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAppSiteConfigScmIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
