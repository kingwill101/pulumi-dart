...
class FunctionAppSiteConfigScmIpRestriction {
  ...
  final FunctionAppSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory FunctionAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return FunctionAppSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : FunctionAppSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
