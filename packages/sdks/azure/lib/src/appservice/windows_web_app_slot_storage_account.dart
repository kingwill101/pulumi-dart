...
class WindowsWebAppSlotStorageAccount {
  ...
  /// Creates a new [WindowsWebAppSlotStorageAccount].
  ...
  const WindowsWebAppSlotStorageAccount({
  ...
  factory WindowsWebAppSlotStorageAccount.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotStorageAccount(
