...
class LinuxFunctionAppArgs {
  ...
  LinuxFunctionAppArgs({
    ...
    required pulumi.Output<LinuxFunctionAppSiteConfig> siteConfig,
  ...
  factory LinuxFunctionAppArgs.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppArgs(
      ...
      siteConfig: pulumi.Output.create<LinuxFunctionAppSiteConfig>(LinuxFunctionAppSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
