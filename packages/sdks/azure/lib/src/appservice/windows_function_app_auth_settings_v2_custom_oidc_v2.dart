...
class WindowsFunctionAppAuthSettingsV2CustomOidcV2 {
  ...
  /// Creates a new [WindowsFunctionAppAuthSettingsV2CustomOidcV2].
  ...
  factory WindowsFunctionAppAuthSettingsV2CustomOidcV2.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppAuthSettingsV2CustomOidcV2(
