...
class GetLinuxWebAppAuthSettingsV2Login {
  ...
  /// Creates a new [GetLinuxWebAppAuthSettingsV2Login].
  ...
  const GetLinuxWebAppAuthSettingsV2Login({
  ...
  factory GetLinuxWebAppAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppAuthSettingsV2Login(
