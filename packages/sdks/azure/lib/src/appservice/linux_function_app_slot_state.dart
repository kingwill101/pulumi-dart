...
class LinuxFunctionAppSlotState {
  ...
  factory LinuxFunctionAppSlotState.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotState(
      ...
      siteConfig: map['siteConfig'] == null ? null : (LinuxFunctionAppSlotSiteConfig.fromMap((map['siteConfig']! as Map).cast<String, dynamic>())).input(),
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<LinuxFunctionAppSlotSiteCredential>(map['siteCredentials']!, (value) => LinuxFunctionAppSlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
