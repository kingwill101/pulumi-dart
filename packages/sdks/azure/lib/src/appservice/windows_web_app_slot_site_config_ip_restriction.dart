...
class WindowsWebAppSlotSiteConfigIpRestriction {
  ...
  final WindowsWebAppSlotSiteConfigIpRestrictionHeaders? headers;
  ...
  factory WindowsWebAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : WindowsWebAppSlotSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
