...
import 'windows_web_app_slot_site_config_ip_restriction_headers.dart';
...
class WindowsWebAppSlotSiteConfigIpRestriction {
  ...
  final pulumi.Input<WindowsWebAppSlotSiteConfigIpRestrictionHeaders>? headers;
  ...
  /// Creates a new [WindowsWebAppSlotSiteConfigIpRestriction].
  ...
  const WindowsWebAppSlotSiteConfigIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppSlotSiteConfigIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory WindowsWebAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
