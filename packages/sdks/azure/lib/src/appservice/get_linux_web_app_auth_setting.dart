...
class GetLinuxWebAppAuthSetting {
  ...
  final pulumi.Input<List<GetLinuxWebAppAuthSettingActiveDirectory>>
  activeDirectories;
    ...
    return <String, dynamic>{
      'activeDirectories':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppAuthSettingActiveDirectory>,
      ...
      'facebooks':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppAuthSettingFacebook>,
            List<Map<String, dynamic>>
          >(
            facebooks,
            (value) =>
      ...
      'githubs':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppAuthSettingGithub>,
            List<Map<String, dynamic>>
          >(
            githubs,
            (value) =>
      ...
      'googles':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppAuthSettingGoogle>,
            List<Map<String, dynamic>>
          >(
            googles,
            (value) =>
      ...
      'microsofts':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppAuthSettingMicrosoft>,
            List<Map<String, dynamic>>
          >(
            microsofts,
            (value) =>
      ...
      'twitters':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppAuthSettingTwitter>,
            List<Map<String, dynamic>>
          >(
            twitters,
            (value) =>
  ...
  factory GetLinuxWebAppAuthSetting.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppAuthSetting(
      activeDirectories: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppAuthSettingActiveDirectory>(
          map['activeDirectories']!,
          (value) => GetLinuxWebAppAuthSettingActiveDirectory.fromMap(
      ...
      facebooks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppAuthSettingFacebook>(
          map['facebooks']!,
          (value) => GetLinuxWebAppAuthSettingFacebook.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      githubs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppAuthSettingGithub>(
          map['githubs']!,
          (value) => GetLinuxWebAppAuthSettingGithub.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      googles: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppAuthSettingGoogle>(
          map['googles']!,
          (value) => GetLinuxWebAppAuthSettingGoogle.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      microsofts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppAuthSettingMicrosoft>(
          map['microsofts']!,
          (value) => GetLinuxWebAppAuthSettingMicrosoft.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      twitters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppAuthSettingTwitter>(
          map['twitters']!,
          (value) => GetLinuxWebAppAuthSettingTwitter.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
