...
class WindowsWebAppAuthSettingsV2MicrosoftV2 {
  ...
  /// Creates a new [WindowsWebAppAuthSettingsV2MicrosoftV2].
  ...
  const WindowsWebAppAuthSettingsV2MicrosoftV2({
  ...
  factory WindowsWebAppAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettingsV2MicrosoftV2(
