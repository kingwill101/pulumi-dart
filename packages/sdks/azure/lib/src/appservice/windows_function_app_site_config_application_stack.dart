...
class WindowsFunctionAppSiteConfigApplicationStack {
  ...
  /// [javaVersion] The Version of Java to use. Supported versions include `1.8`, `11`, `17`, `21`, `25` (In-Preview).
  /// [nodeVersion] The version of Node to run. Possible values include `~12`, `~14`, `~16`, `~18` `~20`, `~22` and `~24`.
  /// [powershellCoreVersion] The version of PowerShell Core to run. Possible values are `7`, `7.2`, `7.4`, and `7.6`.
  ...
  const WindowsFunctionAppSiteConfigApplicationStack({
    this.dotnetVersion,
    this.javaVersion,
    this.nodeVersion,
