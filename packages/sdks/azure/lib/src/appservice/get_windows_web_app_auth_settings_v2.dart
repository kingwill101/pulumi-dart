...
import 'get_windows_web_app_auth_settings_v2_active_directory_v2.dart';
import 'get_windows_web_app_auth_settings_v2_apple_v2.dart';
import 'get_windows_web_app_auth_settings_v2_azure_static_web_app_v2.dart';
import 'get_windows_web_app_auth_settings_v2_custom_oidc_v2.dart';
import 'get_windows_web_app_auth_settings_v2_facebook_v2.dart';
import 'get_windows_web_app_auth_settings_v2_github_v2.dart';
import 'get_windows_web_app_auth_settings_v2_google_v2.dart';
import 'get_windows_web_app_auth_settings_v2_login.dart';
import 'get_windows_web_app_auth_settings_v2_microsoft_v2.dart';
...
class GetWindowsWebAppAuthSettingsV2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeDirectoryV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2ActiveDirectoryV2>, List<Map<String, dynamic>>>(activeDirectoryV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2ActiveDirectoryV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'appleV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2AppleV2>, List<Map<String, dynamic>>>(appleV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2AppleV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'authEnabled': authEnabled,
      'azureStaticWebAppV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2AzureStaticWebAppV2>, List<Map<String, dynamic>>>(azureStaticWebAppV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2AzureStaticWebAppV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'configFilePath': configFilePath,
      'customOidcV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2CustomOidcV2>, List<Map<String, dynamic>>>(customOidcV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2CustomOidcV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'defaultProvider': defaultProvider,
      'excludedPaths': excludedPaths,
      'facebookV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2FacebookV2>, List<Map<String, dynamic>>>(facebookV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2FacebookV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'githubV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2GithubV2>, List<Map<String, dynamic>>>(githubV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2GithubV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'googleV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2GoogleV2>, List<Map<String, dynamic>>>(googleV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2GoogleV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'httpRouteApiPrefix': httpRouteApiPrefix,
      'logins': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2Login>, List<Map<String, dynamic>>>(logins, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2Login, Map<String, dynamic>>(value, (value) => value.toMap())),
      'microsoftV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2MicrosoftV2>, List<Map<String, dynamic>>>(microsoftV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2MicrosoftV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'requireAuthentication': requireAuthentication,
      'requireHttps': requireHttps,
      'runtimeVersion': runtimeVersion,
      'twitterV2s': pulumi.Input.mapInputValue<List<GetWindowsWebAppAuthSettingsV2TwitterV2>, List<Map<String, dynamic>>>(twitterV2s, (value) => pulumi.Input.encodeList<GetWindowsWebAppAuthSettingsV2TwitterV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'unauthenticatedAction': unauthenticatedAction,
    };
  }

  factory GetWindowsWebAppAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppAuthSettingsV2(
      activeDirectoryV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2ActiveDirectoryV2>(map['activeDirectoryV2s']!, (value) => GetWindowsWebAppAuthSettingsV2ActiveDirectoryV2.fromMap((value as Map).cast<String, dynamic>()))),
      appleV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2AppleV2>(map['appleV2s']!, (value) => GetWindowsWebAppAuthSettingsV2AppleV2.fromMap((value as Map).cast<String, dynamic>()))),
      authEnabled: pulumi.Input.fromValue(map['authEnabled'] as bool),
      azureStaticWebAppV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2AzureStaticWebAppV2>(map['azureStaticWebAppV2s']!, (value) => GetWindowsWebAppAuthSettingsV2AzureStaticWebAppV2.fromMap((value as Map).cast<String, dynamic>()))),
      configFilePath: pulumi.Input.fromValue(map['configFilePath'] as String),
      customOidcV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2CustomOidcV2>(map['customOidcV2s']!, (value) => GetWindowsWebAppAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      facebookV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2FacebookV2>(map['facebookV2s']!, (value) => GetWindowsWebAppAuthSettingsV2FacebookV2.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      githubV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2GithubV2>(map['githubV2s']!, (value) => GetWindowsWebAppAuthSettingsV2GithubV2.fromMap((value as Map).cast<String, dynamic>()))),
      googleV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2GoogleV2>(map['googleV2s']!, (value) => GetWindowsWebAppAuthSettingsV2GoogleV2.fromMap((value as Map).cast<String, dynamic>()))),
      httpRouteApiPrefix: pulumi.Input.fromValue(map['httpRouteApiPrefix'] as String),
      logins: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2Login>(map['logins']!, (value) => GetWindowsWebAppAuthSettingsV2Login.fromMap((value as Map).cast<String, dynamic>()))),
      microsoftV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2MicrosoftV2>(map['microsoftV2s']!, (value) => GetWindowsWebAppAuthSettingsV2MicrosoftV2.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      twitterV2s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2TwitterV2>(map['twitterV2s']!, (value) => GetWindowsWebAppAuthSettingsV2TwitterV2.fromMap((value as Map).cast<String, dynamic>()))),
