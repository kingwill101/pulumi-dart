...
class GetWindowsWebAppAuthSettingsV2 {
  ...
  factory GetWindowsWebAppAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppAuthSettingsV2(
      activeDirectoryV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2ActiveDirectoryV2>(map['activeDirectoryV2s'], (value) => GetWindowsWebAppAuthSettingsV2ActiveDirectoryV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      appleV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2AppleV2>(map['appleV2s'], (value) => GetWindowsWebAppAuthSettingsV2AppleV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      authEnabled: (map['authEnabled'] as bool).input(),
      azureStaticWebAppV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2AzureStaticWebAppV2>(map['azureStaticWebAppV2s'], (value) => GetWindowsWebAppAuthSettingsV2AzureStaticWebAppV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      configFilePath: (map['configFilePath'] as String).input(),
      customOidcV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2CustomOidcV2>(map['customOidcV2s'], (value) => GetWindowsWebAppAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      defaultProvider: (map['defaultProvider'] as String).input(),
      excludedPaths: ((map['excludedPaths'] as List).cast<String>()).input(),
      facebookV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2FacebookV2>(map['facebookV2s'], (value) => GetWindowsWebAppAuthSettingsV2FacebookV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      githubV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2GithubV2>(map['githubV2s'], (value) => GetWindowsWebAppAuthSettingsV2GithubV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      googleV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2GoogleV2>(map['googleV2s'], (value) => GetWindowsWebAppAuthSettingsV2GoogleV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      httpRouteApiPrefix: (map['httpRouteApiPrefix'] as String).input(),
      logins: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2Login>(map['logins'], (value) => GetWindowsWebAppAuthSettingsV2Login.fromMap((value as Map).cast<String, dynamic>()))).input(),
      microsoftV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2MicrosoftV2>(map['microsoftV2s'], (value) => GetWindowsWebAppAuthSettingsV2MicrosoftV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      twitterV2s: (pulumi.Input.decodeList<GetWindowsWebAppAuthSettingsV2TwitterV2>(map['twitterV2s'], (value) => GetWindowsWebAppAuthSettingsV2TwitterV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
