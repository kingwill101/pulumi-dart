...
class AppFlexConsumptionAuthSettings {
  ...
  final AppFlexConsumptionAuthSettingsActiveDirectory? activeDirectory;
  ...
  final AppFlexConsumptionAuthSettingsFacebook? facebook;
  /// A `github` block as defined below.
  final AppFlexConsumptionAuthSettingsGithub? github;
  /// A `google` block as defined below.
  final AppFlexConsumptionAuthSettingsGoogle? google;
  /// The OpenID Connect Issuer URI that represents the entity which issues access tokens for this Linux Web App.
  ///
  /// > **Note:** When using Azure Active Directory, this value is the URI of the directory tenant, e.g. <https://sts.windows.net/{tenant-guid}/>.
  final String? issuer;
  /// A `microsoft` block as defined below.
  final AppFlexConsumptionAuthSettingsMicrosoft? microsoft;
  ...
  final AppFlexConsumptionAuthSettingsTwitter? twitter;
  ...
  factory AppFlexConsumptionAuthSettings.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettings(
      activeDirectory: map['activeDirectory'] == null ? null : AppFlexConsumptionAuthSettingsActiveDirectory.fromMap((map['activeDirectory'] as Map).cast<String, dynamic>()),
      ...
      facebook: map['facebook'] == null ? null : AppFlexConsumptionAuthSettingsFacebook.fromMap((map['facebook'] as Map).cast<String, dynamic>()),
      github: map['github'] == null ? null : AppFlexConsumptionAuthSettingsGithub.fromMap((map['github'] as Map).cast<String, dynamic>()),
      google: map['google'] == null ? null : AppFlexConsumptionAuthSettingsGoogle.fromMap((map['google'] as Map).cast<String, dynamic>()),
      issuer: map['issuer'] == null ? null : map['issuer'] as String,
      microsoft: map['microsoft'] == null ? null : AppFlexConsumptionAuthSettingsMicrosoft.fromMap((map['microsoft'] as Map).cast<String, dynamic>()),
      ...
      twitter: map['twitter'] == null ? null : AppFlexConsumptionAuthSettingsTwitter.fromMap((map['twitter'] as Map).cast<String, dynamic>()),
