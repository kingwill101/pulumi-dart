...
class WindowsWebAppSlotAuthSettingsV2AppleV2 {
  ...
  /// Creates a new [WindowsWebAppSlotAuthSettingsV2AppleV2].
  ...
  const WindowsWebAppSlotAuthSettingsV2AppleV2({
  ...
  factory WindowsWebAppSlotAuthSettingsV2AppleV2.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotAuthSettingsV2AppleV2(
