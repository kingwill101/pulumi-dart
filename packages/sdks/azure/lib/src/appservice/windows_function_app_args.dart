...
class WindowsFunctionAppArgs {
  ...
  WindowsFunctionAppArgs({
    ...
    required pulumi.Output<WindowsFunctionAppSiteConfig> siteConfig,
  ...
  factory WindowsFunctionAppArgs.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppArgs(
      ...
      siteConfig: pulumi.Output.create<WindowsFunctionAppSiteConfig>(WindowsFunctionAppSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
