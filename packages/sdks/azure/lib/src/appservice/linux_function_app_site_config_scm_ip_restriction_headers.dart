...
class LinuxFunctionAppSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [LinuxFunctionAppSiteConfigScmIpRestrictionHeaders].
  ...
  const LinuxFunctionAppSiteConfigScmIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory LinuxFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSiteConfigScmIpRestrictionHeaders(
