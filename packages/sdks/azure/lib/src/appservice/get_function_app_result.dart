...
class GetFunctionAppResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'identities':
          pulumi.Input.encodeList<GetFunctionAppIdentity, Map<String, dynamic>>(
            identities,
            (value) => value.toMap(),
          ),
      'location': location,
  ...
  factory GetFunctionAppResult.fromMap(Map<String, dynamic> map) {
    return GetFunctionAppResult(
      ...
      connectionStrings:
          pulumi.Input.decodeList<GetFunctionAppConnectionString>(
            map['connectionStrings']!,
            (value) => GetFunctionAppConnectionString.fromMap(
      ...
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetFunctionAppIdentity>(
        map['identities']!,
        (value) => GetFunctionAppIdentity.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      siteConfigs: pulumi.Input.decodeList<GetFunctionAppSiteConfig>(
        map['siteConfigs']!,
        (value) => GetFunctionAppSiteConfig.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      siteCredentials: pulumi.Input.decodeList<GetFunctionAppSiteCredential>(
        map['siteCredentials']!,
        (value) => GetFunctionAppSiteCredential.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      sourceControls: pulumi.Input.decodeList<GetFunctionAppSourceControl>(
        map['sourceControls']!,
        (value) => GetFunctionAppSourceControl.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      tags: (() {
