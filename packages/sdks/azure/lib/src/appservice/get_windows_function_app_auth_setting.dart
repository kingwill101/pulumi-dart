...
class GetWindowsFunctionAppAuthSetting {
  ...
  const GetWindowsFunctionAppAuthSetting({
  ...
  factory GetWindowsFunctionAppAuthSetting.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppAuthSetting(
      activeDirectories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingActiveDirectory>(map['activeDirectories']!, (value) => GetWindowsFunctionAppAuthSettingActiveDirectory.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      facebooks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingFacebook>(map['facebooks']!, (value) => GetWindowsFunctionAppAuthSettingFacebook.fromMap((value as Map).cast<String, dynamic>()))),
      githubs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingGithub>(map['githubs']!, (value) => GetWindowsFunctionAppAuthSettingGithub.fromMap((value as Map).cast<String, dynamic>()))),
      googles: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingGoogle>(map['googles']!, (value) => GetWindowsFunctionAppAuthSettingGoogle.fromMap((value as Map).cast<String, dynamic>()))),
      issuer: pulumi.Input.fromValue(map['issuer'] as String),
      microsofts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingMicrosoft>(map['microsofts']!, (value) => GetWindowsFunctionAppAuthSettingMicrosoft.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      twitters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingTwitter>(map['twitters']!, (value) => GetWindowsFunctionAppAuthSettingTwitter.fromMap((value as Map).cast<String, dynamic>()))),
