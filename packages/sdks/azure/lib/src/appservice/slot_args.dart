...
class SlotArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'logs':
          ?pulumi.Input.mapOptionalInputValue<SlotLogs, Map<String, dynamic>>(
            logs,
            (value) => value.toMap(),
          ),
      'name': ?name,
  ...
  factory SlotArgs.fromMap(Map<String, dynamic> map) {
    return SlotArgs(
      ...
      connectionStrings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SlotConnectionString>(
            guardedValue,
            (value) => SlotConnectionString.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlotIdentity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      logs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlotLogs.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      siteConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlotSiteConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      storageAccounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SlotStorageAccount>(
            guardedValue,
            (value) => SlotStorageAccount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
