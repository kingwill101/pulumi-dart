...
class LinuxWebAppSlotAuthSettingsFacebook {
  ...
  /// Creates a new [LinuxWebAppSlotAuthSettingsFacebook].
  ...
  const LinuxWebAppSlotAuthSettingsFacebook({
    required this.appId,
    this.appSecret,
  ...
  factory LinuxWebAppSlotAuthSettingsFacebook.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotAuthSettingsFacebook(
