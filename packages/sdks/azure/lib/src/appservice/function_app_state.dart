...
class FunctionAppState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectionStrings':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionAppConnectionString>,
      ...
      'siteCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionAppSiteCredential>,
            List<Map<String, dynamic>>
          >(
            siteCredentials,
            (value) =>
  ...
  factory FunctionAppState.fromMap(Map<String, dynamic> map) {
    return FunctionAppState(
      ...
      authSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppAuthSettings.fromMap(
      ...
      connectionStrings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FunctionAppConnectionString>(
            guardedValue,
            (value) => FunctionAppConnectionString.fromMap(
      ...
      siteCredentials: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FunctionAppSiteCredential>(
            guardedValue,
            (value) => FunctionAppSiteCredential.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sourceControl: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppSourceControl.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
