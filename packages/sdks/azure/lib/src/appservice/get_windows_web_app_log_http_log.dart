...
class GetWindowsWebAppLogHttpLog {
  ...
  final pulumi.Input<List<GetWindowsWebAppLogHttpLogAzureBlobStorage>>
  azureBlobStorages;
    ...
    return <String, dynamic>{
      'azureBlobStorages':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppLogHttpLogAzureBlobStorage>,
      ...
      'fileSystems':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppLogHttpLogFileSystem>,
            List<Map<String, dynamic>>
          >(
            fileSystems,
            (value) =>
  ...
  factory GetWindowsWebAppLogHttpLog.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppLogHttpLog(
      azureBlobStorages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppLogHttpLogAzureBlobStorage>(
          map['azureBlobStorages']!,
          (value) => GetWindowsWebAppLogHttpLogAzureBlobStorage.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      fileSystems: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppLogHttpLogFileSystem>(
          map['fileSystems']!,
          (value) => GetWindowsWebAppLogHttpLogFileSystem.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
