...
class LinuxWebAppSlotAuthSettingsV2Login {
  ...
  /// Creates a new [LinuxWebAppSlotAuthSettingsV2Login].
  ...
  const LinuxWebAppSlotAuthSettingsV2Login({
  ...
  factory LinuxWebAppSlotAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotAuthSettingsV2Login(
