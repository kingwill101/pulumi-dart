...
class ConnectionState {
  ...
  factory ConnectionState.fromMap(Map<String, dynamic> map) {
    return ConnectionState(
      ...
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
