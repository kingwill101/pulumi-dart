...
class AppServiceLogsApplicationLogs {
  ...
  final pulumi.Input<AppServiceLogsApplicationLogsAzureBlobStorage>?
  azureBlobStorage;
  ...
  AppServiceLogsApplicationLogs({this.azureBlobStorage, this.fileSystemLevel});
    ...
    return AppServiceLogsApplicationLogs(
      azureBlobStorage: (() {
        ...
        return pulumi.Input.fromValue(
          AppServiceLogsApplicationLogsAzureBlobStorage.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fileSystemLevel: (() {
        final guardedValue = map['fileSystemLevel'];
        if (guardedValue == null) return null;
