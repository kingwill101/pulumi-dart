...
class FunctionAppSiteConfigIpRestriction {
  ...
  final FunctionAppSiteConfigIpRestrictionHeaders? headers;
  ...
  factory FunctionAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return FunctionAppSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : FunctionAppSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
