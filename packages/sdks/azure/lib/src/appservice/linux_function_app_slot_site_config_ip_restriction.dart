...
class LinuxFunctionAppSlotSiteConfigIpRestriction {
  ...
  final LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders? headers;
  ...
  factory LinuxFunctionAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
