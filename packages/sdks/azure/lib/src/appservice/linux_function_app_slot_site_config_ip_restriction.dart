...
class LinuxFunctionAppSlotSiteConfigIpRestriction {
  ...
  final pulumi.Input<LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders>?
  headers;
  ...
  factory LinuxFunctionAppSlotSiteConfigIpRestriction.fromMap(
    ...
    return LinuxFunctionAppSlotSiteConfigIpRestriction(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap(
