...
class AppServiceAuthSettings {
  ...
  factory AppServiceAuthSettings.fromMap(Map<String, dynamic> map) {
    return AppServiceAuthSettings(
      activeDirectory: (() { final guardedValue = map['activeDirectory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppServiceAuthSettingsActiveDirectory.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      facebook: (() { final guardedValue = map['facebook']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppServiceAuthSettingsFacebook.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      google: (() { final guardedValue = map['google']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppServiceAuthSettingsGoogle.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      microsoft: (() { final guardedValue = map['microsoft']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppServiceAuthSettingsMicrosoft.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      twitter: (() { final guardedValue = map['twitter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppServiceAuthSettingsTwitter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
