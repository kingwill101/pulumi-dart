    ...
    return AppServiceAuthSettings(
      activeDirectory: (() {
        ...
        return pulumi.Input.fromValue(
          AppServiceAuthSettingsActiveDirectory.fromMap(
      ...
      facebook: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppServiceAuthSettingsFacebook.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      google: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppServiceAuthSettingsGoogle.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      microsoft: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppServiceAuthSettingsMicrosoft.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      twitter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppServiceAuthSettingsTwitter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
