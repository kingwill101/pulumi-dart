...
class LinuxFunctionAppSlotSiteConfigScmIpRestriction {
  ...
  final LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory LinuxFunctionAppSlotSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
