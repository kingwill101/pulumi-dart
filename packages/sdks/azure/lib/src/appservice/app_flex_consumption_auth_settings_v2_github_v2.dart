...
class AppFlexConsumptionAuthSettingsV2GithubV2 {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsV2GithubV2].
  ...
  const AppFlexConsumptionAuthSettingsV2GithubV2({
  ...
  factory AppFlexConsumptionAuthSettingsV2GithubV2.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsV2GithubV2(
