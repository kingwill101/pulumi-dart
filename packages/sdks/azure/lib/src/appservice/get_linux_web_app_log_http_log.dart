...
class GetLinuxWebAppLogHttpLog {
  ...
  factory GetLinuxWebAppLogHttpLog.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppLogHttpLog(
      azureBlobStorages: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLinuxWebAppLogHttpLogAzureBlobStorage>(map['azureBlobStorages']!, (value) => GetLinuxWebAppLogHttpLogAzureBlobStorage.fromMap((value as Map).cast<String, dynamic>()))),
      fileSystems: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLinuxWebAppLogHttpLogFileSystem>(map['fileSystems']!, (value) => GetLinuxWebAppLogHttpLogFileSystem.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
