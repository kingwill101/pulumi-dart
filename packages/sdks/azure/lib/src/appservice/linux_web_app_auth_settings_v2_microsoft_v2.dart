...
class LinuxWebAppAuthSettingsV2MicrosoftV2 {
  ...
  const LinuxWebAppAuthSettingsV2MicrosoftV2({
  ...
  factory LinuxWebAppAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2MicrosoftV2(
