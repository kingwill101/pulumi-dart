    ...
    return SlotAuthSettings(
      activeDirectory: (() {
        ...
        return pulumi.Input.fromValue(
          SlotAuthSettingsActiveDirectory.fromMap(
      ...
      facebook: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlotAuthSettingsFacebook.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      google: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlotAuthSettingsGoogle.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      microsoft: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlotAuthSettingsMicrosoft.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      twitter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlotAuthSettingsTwitter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
