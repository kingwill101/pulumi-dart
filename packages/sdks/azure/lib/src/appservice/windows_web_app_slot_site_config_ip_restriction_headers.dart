...
class WindowsWebAppSlotSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [WindowsWebAppSlotSiteConfigIpRestrictionHeaders].
  ...
  const WindowsWebAppSlotSiteConfigIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory WindowsWebAppSlotSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigIpRestrictionHeaders(
