...
class WindowsWebAppSlotAuthSettingsMicrosoft {
  ...
  /// Creates a new [WindowsWebAppSlotAuthSettingsMicrosoft].
  ...
  factory WindowsWebAppSlotAuthSettingsMicrosoft.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotAuthSettingsMicrosoft(
