...
class LinuxWebAppSlotLogsHttpLogs {
  ...
  final pulumi.Input<LinuxWebAppSlotLogsHttpLogsAzureBlobStorage>?
  azureBlobStorage;
  ...
  LinuxWebAppSlotLogsHttpLogs({this.azureBlobStorage, this.fileSystem});
    ...
    return LinuxWebAppSlotLogsHttpLogs(
      azureBlobStorage: (() {
        ...
        return pulumi.Input.fromValue(
          LinuxWebAppSlotLogsHttpLogsAzureBlobStorage.fromMap(
      ...
      fileSystem: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinuxWebAppSlotLogsHttpLogsFileSystem.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
