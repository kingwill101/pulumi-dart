...
import 'windows_function_app_slot_site_config_ip_restriction_headers.dart';
...
class WindowsFunctionAppSlotSiteConfigIpRestriction {
  ...
  final pulumi.Input<WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders>? headers;
  ...
  /// Creates a new [WindowsFunctionAppSlotSiteConfigIpRestriction].
  ...
  const WindowsFunctionAppSlotSiteConfigIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory WindowsFunctionAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotSiteConfigIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
