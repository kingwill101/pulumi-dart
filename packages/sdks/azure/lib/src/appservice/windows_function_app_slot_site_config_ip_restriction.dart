...
class WindowsFunctionAppSlotSiteConfigIpRestriction {
  ...
  final pulumi.Input<WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders>?
  headers;
  ...
  factory WindowsFunctionAppSlotSiteConfigIpRestriction.fromMap(
    ...
    return WindowsFunctionAppSlotSiteConfigIpRestriction(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap(
