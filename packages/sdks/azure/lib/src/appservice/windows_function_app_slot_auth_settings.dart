...
class WindowsFunctionAppSlotAuthSettings {
  ...
  final WindowsFunctionAppSlotAuthSettingsActiveDirectory? activeDirectory;
  ...
  final WindowsFunctionAppSlotAuthSettingsFacebook? facebook;
  /// a `github` block as detailed below.
  final WindowsFunctionAppSlotAuthSettingsGithub? github;
  /// a `google` block as detailed below.
  final WindowsFunctionAppSlotAuthSettingsGoogle? google;
  /// The OpenID Connect Issuer URI that represents the entity which issues access tokens.
  ///
  /// > **Note:** When using Azure Active Directory, this value is the URI of the directory tenant, e.g. <https://sts.windows.net/{tenant-guid}/>.
  final String? issuer;
  /// a `microsoft` block as detailed below.
  final WindowsFunctionAppSlotAuthSettingsMicrosoft? microsoft;
  ...
  final WindowsFunctionAppSlotAuthSettingsTwitter? twitter;
  ...
  factory WindowsFunctionAppSlotAuthSettings.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotAuthSettings(
      activeDirectory: map['activeDirectory'] == null ? null : WindowsFunctionAppSlotAuthSettingsActiveDirectory.fromMap((map['activeDirectory'] as Map).cast<String, dynamic>()),
      ...
      facebook: map['facebook'] == null ? null : WindowsFunctionAppSlotAuthSettingsFacebook.fromMap((map['facebook'] as Map).cast<String, dynamic>()),
      github: map['github'] == null ? null : WindowsFunctionAppSlotAuthSettingsGithub.fromMap((map['github'] as Map).cast<String, dynamic>()),
      google: map['google'] == null ? null : WindowsFunctionAppSlotAuthSettingsGoogle.fromMap((map['google'] as Map).cast<String, dynamic>()),
      issuer: map['issuer'] == null ? null : map['issuer'] as String,
      microsoft: map['microsoft'] == null ? null : WindowsFunctionAppSlotAuthSettingsMicrosoft.fromMap((map['microsoft'] as Map).cast<String, dynamic>()),
      ...
      twitter: map['twitter'] == null ? null : WindowsFunctionAppSlotAuthSettingsTwitter.fromMap((map['twitter'] as Map).cast<String, dynamic>()),
