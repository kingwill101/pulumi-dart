...
class WindowsFunctionAppSlotAuthSettingsTwitter {
  ...
  /// Creates a new [WindowsFunctionAppSlotAuthSettingsTwitter].
  ...
  const WindowsFunctionAppSlotAuthSettingsTwitter({
  ...
  factory WindowsFunctionAppSlotAuthSettingsTwitter.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotAuthSettingsTwitter(
