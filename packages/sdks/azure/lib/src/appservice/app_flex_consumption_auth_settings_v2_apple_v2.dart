...
class AppFlexConsumptionAuthSettingsV2AppleV2 {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsV2AppleV2].
  ...
  const AppFlexConsumptionAuthSettingsV2AppleV2({
  ...
  factory AppFlexConsumptionAuthSettingsV2AppleV2.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsV2AppleV2(
