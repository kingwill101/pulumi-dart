...
class FunctionAppSlotConnectionString {
  ...
  /// Creates a new [FunctionAppSlotConnectionString].
  ...
  const FunctionAppSlotConnectionString({
    required this.name,
    required this.type,
    required this.value,
  });
  ...
  factory FunctionAppSlotConnectionString.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotConnectionString(
