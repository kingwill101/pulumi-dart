...
class WindowsFunctionAppSlotAuthSettingsMicrosoft {
  ...
  /// Creates a new [WindowsFunctionAppSlotAuthSettingsMicrosoft].
  ...
  const WindowsFunctionAppSlotAuthSettingsMicrosoft({
  ...
  factory WindowsFunctionAppSlotAuthSettingsMicrosoft.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotAuthSettingsMicrosoft(
