...
class LinuxWebAppSlotSiteConfigAutoHealSetting {
  ...
  LinuxWebAppSlotSiteConfigAutoHealSetting({this.action, this.trigger});
  ...
  factory LinuxWebAppSlotSiteConfigAutoHealSetting.fromMap(
    ...
    return LinuxWebAppSlotSiteConfigAutoHealSetting(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          LinuxWebAppSlotSiteConfigAutoHealSettingAction.fromMap(
      ...
      trigger: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinuxWebAppSlotSiteConfigAutoHealSettingTrigger.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
