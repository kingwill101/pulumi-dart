...
class WindowsWebAppState {
  ...
  factory WindowsWebAppState.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppState(
      ...
      siteConfig: map['siteConfig'] == null ? null : (WindowsWebAppSiteConfig.fromMap((map['siteConfig']! as Map).cast<String, dynamic>())).input(),
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<WindowsWebAppSiteCredential>(map['siteCredentials']!, (value) => WindowsWebAppSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
