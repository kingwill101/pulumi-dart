...
class WindowsWebAppSlotAuthSettingsV2FacebookV2 {
  ...
  /// Creates a new [WindowsWebAppSlotAuthSettingsV2FacebookV2].
  ...
  const WindowsWebAppSlotAuthSettingsV2FacebookV2({
    required this.appId,
  ...
  factory WindowsWebAppSlotAuthSettingsV2FacebookV2.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotAuthSettingsV2FacebookV2(
