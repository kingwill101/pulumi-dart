...
class LinuxWebAppState {
  ...
  factory LinuxWebAppState.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppState(
      ...
      siteConfig: map['siteConfig'] == null ? null : (LinuxWebAppSiteConfig.fromMap((map['siteConfig']! as Map).cast<String, dynamic>())).input(),
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<LinuxWebAppSiteCredential>(map['siteCredentials']!, (value) => LinuxWebAppSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
