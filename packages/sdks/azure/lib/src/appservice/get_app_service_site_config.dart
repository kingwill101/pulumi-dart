...
class GetAppServiceSiteConfig {
  ...
  factory GetAppServiceSiteConfig.fromMap(Map<String, dynamic> map) {
    return GetAppServiceSiteConfig(
      acrUseManagedIdentityCredentials: pulumi.Input.fromValue(map['acrUseManagedIdentityCredentials'] as bool),
      acrUserManagedIdentityClientId: pulumi.Input.fromValue(map['acrUserManagedIdentityClientId'] as String),
      alwaysOn: pulumi.Input.fromValue(map['alwaysOn'] as bool),
      appCommandLine: pulumi.Input.fromValue(map['appCommandLine'] as String),
      cors: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppServiceSiteConfigCor>(map['cors']!, (value) => GetAppServiceSiteConfigCor.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ipRestrictions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppServiceSiteConfigIpRestriction>(map['ipRestrictions']!, (value) => GetAppServiceSiteConfigIpRestriction.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      scmIpRestrictions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppServiceSiteConfigScmIpRestriction>(map['scmIpRestrictions']!, (value) => GetAppServiceSiteConfigScmIpRestriction.fromMap((value as Map).cast<String, dynamic>()))),
