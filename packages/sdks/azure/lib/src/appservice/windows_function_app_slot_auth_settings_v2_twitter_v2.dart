...
class WindowsFunctionAppSlotAuthSettingsV2TwitterV2 {
  ...
  /// Creates a new [WindowsFunctionAppSlotAuthSettingsV2TwitterV2].
  ...
  const WindowsFunctionAppSlotAuthSettingsV2TwitterV2({
  ...
  factory WindowsFunctionAppSlotAuthSettingsV2TwitterV2.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotAuthSettingsV2TwitterV2(
