...
class GetLinuxFunctionAppResult {
  ...
  factory GetLinuxFunctionAppResult.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppResult(
      ...
      authSettings: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSetting>(
        map['authSettings']!,
        (value) => GetLinuxFunctionAppAuthSetting.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      authSettingsV2s:
          pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2>(
            map['authSettingsV2s']!,
            (value) => GetLinuxFunctionAppAuthSettingsV2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      availability: map['availability'] as String,
      backups: pulumi.Input.decodeList<GetLinuxFunctionAppBackup>(
        map['backups']!,
        (value) => GetLinuxFunctionAppBackup.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      connectionStrings:
          pulumi.Input.decodeList<GetLinuxFunctionAppConnectionString>(
            map['connectionStrings']!,
            (value) => GetLinuxFunctionAppConnectionString.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetLinuxFunctionAppIdentity>(
        map['identities']!,
        (value) => GetLinuxFunctionAppIdentity.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      siteConfigs: pulumi.Input.decodeList<GetLinuxFunctionAppSiteConfig>(
        map['siteConfigs']!,
        (value) => GetLinuxFunctionAppSiteConfig.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      siteCredentials:
          pulumi.Input.decodeList<GetLinuxFunctionAppSiteCredential>(
            map['siteCredentials']!,
            (value) => GetLinuxFunctionAppSiteCredential.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      stickySettings: pulumi.Input.decodeList<GetLinuxFunctionAppStickySetting>(
        map['stickySettings']!,
        (value) => GetLinuxFunctionAppStickySetting.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
