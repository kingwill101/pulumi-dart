...
class GetWindowsFunctionAppSiteConfigScmIpRestriction {
  ...
  factory GetWindowsFunctionAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppSiteConfigScmIpRestriction(
      ...
      headers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigScmIpRestrictionHeader>(map['headers']!, (value) => GetWindowsFunctionAppSiteConfigScmIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>()))),
