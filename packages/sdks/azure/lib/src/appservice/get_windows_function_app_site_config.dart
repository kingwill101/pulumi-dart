...
class GetWindowsFunctionAppSiteConfig {
  ...
  factory GetWindowsFunctionAppSiteConfig.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppSiteConfig(
      ...
      appServiceLogs: (pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigAppServiceLog>(map['appServiceLogs'], (value) => GetWindowsFunctionAppSiteConfigAppServiceLog.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      applicationStacks: (pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigApplicationStack>(map['applicationStacks'], (value) => GetWindowsFunctionAppSiteConfigApplicationStack.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cors: (pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigCor>(map['cors'], (value) => GetWindowsFunctionAppSiteConfigCor.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      ipRestrictions: (pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigIpRestriction>(map['ipRestrictions'], (value) => GetWindowsFunctionAppSiteConfigIpRestriction.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      scmIpRestrictions: (pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigScmIpRestriction>(map['scmIpRestrictions'], (value) => GetWindowsFunctionAppSiteConfigScmIpRestriction.fromMap((value as Map).cast<String, dynamic>()))).input(),
