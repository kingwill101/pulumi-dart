...
class GetWindowsFunctionAppSiteConfig {
  ...
  final pulumi.Input<List<GetWindowsFunctionAppSiteConfigAppServiceLog>>
  appServiceLogs;
  ...
  final pulumi.Input<List<GetWindowsFunctionAppSiteConfigApplicationStack>>
  applicationStacks;
  ...
  final pulumi.Input<List<GetWindowsFunctionAppSiteConfigIpRestriction>>
  ipRestrictions;
  ...
  final pulumi.Input<List<GetWindowsFunctionAppSiteConfigScmIpRestriction>>
  scmIpRestrictions;
    ...
    return <String, dynamic>{
      ...
      'appServiceLogs':
          pulumi.Input.mapInputValue<
            List<GetWindowsFunctionAppSiteConfigAppServiceLog>,
      ...
      'applicationStacks':
          pulumi.Input.mapInputValue<
            List<GetWindowsFunctionAppSiteConfigApplicationStack>,
            List<Map<String, dynamic>>
          >(
            applicationStacks,
            (value) =>
      ...
      'cors':
          pulumi.Input.mapInputValue<
            List<GetWindowsFunctionAppSiteConfigCor>,
            List<Map<String, dynamic>>
          >(
            cors,
            (value) =>
      ...
      'ipRestrictions':
          pulumi.Input.mapInputValue<
            List<GetWindowsFunctionAppSiteConfigIpRestriction>,
            List<Map<String, dynamic>>
          >(
            ipRestrictions,
            (value) =>
      ...
      'scmIpRestrictions':
          pulumi.Input.mapInputValue<
            List<GetWindowsFunctionAppSiteConfigScmIpRestriction>,
            List<Map<String, dynamic>>
          >(
            scmIpRestrictions,
            (value) =>
  ...
  factory GetWindowsFunctionAppSiteConfig.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppSiteConfig(
      ...
      appServiceLogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigAppServiceLog>(
          map['appServiceLogs']!,
          (value) => GetWindowsFunctionAppSiteConfigAppServiceLog.fromMap(
      ...
      applicationStacks: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetWindowsFunctionAppSiteConfigApplicationStack>(
          map['applicationStacks']!,
          (value) => GetWindowsFunctionAppSiteConfigApplicationStack.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      cors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigCor>(
          map['cors']!,
          (value) => GetWindowsFunctionAppSiteConfigCor.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      ipRestrictions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigIpRestriction>(
          map['ipRestrictions']!,
          (value) => GetWindowsFunctionAppSiteConfigIpRestriction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      scmIpRestrictions: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetWindowsFunctionAppSiteConfigScmIpRestriction>(
          map['scmIpRestrictions']!,
          (value) => GetWindowsFunctionAppSiteConfigScmIpRestriction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
