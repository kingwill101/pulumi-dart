...
class AppFlexConsumptionAuthSettingsV2TwitterV2 {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsV2TwitterV2].
  ...
  const AppFlexConsumptionAuthSettingsV2TwitterV2({
  ...
  factory AppFlexConsumptionAuthSettingsV2TwitterV2.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsV2TwitterV2(
