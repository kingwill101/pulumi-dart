...
class GetLinuxFunctionAppSiteConfigApplicationStack {
  ...
  factory GetLinuxFunctionAppSiteConfigApplicationStack.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppSiteConfigApplicationStack(
      dockers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLinuxFunctionAppSiteConfigApplicationStackDocker>(map['dockers']!, (value) => GetLinuxFunctionAppSiteConfigApplicationStackDocker.fromMap((value as Map).cast<String, dynamic>()))),
