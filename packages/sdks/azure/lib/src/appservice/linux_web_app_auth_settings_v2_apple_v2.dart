...
class LinuxWebAppAuthSettingsV2AppleV2 {
  ...
  /// Creates a new [LinuxWebAppAuthSettingsV2AppleV2].
  ...
  factory LinuxWebAppAuthSettingsV2AppleV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2AppleV2(
