...
class LinuxFunctionAppAuthSettingsV2MicrosoftV2 {
  ...
  /// Creates a new [LinuxFunctionAppAuthSettingsV2MicrosoftV2].
  ...
  const LinuxFunctionAppAuthSettingsV2MicrosoftV2({
  ...
  factory LinuxFunctionAppAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppAuthSettingsV2MicrosoftV2(
