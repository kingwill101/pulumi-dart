...
class LinuxWebAppSlotStorageAccount {
  ...
  /// Creates a new [LinuxWebAppSlotStorageAccount].
  ...
  const LinuxWebAppSlotStorageAccount({
  ...
  factory LinuxWebAppSlotStorageAccount.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotStorageAccount(
