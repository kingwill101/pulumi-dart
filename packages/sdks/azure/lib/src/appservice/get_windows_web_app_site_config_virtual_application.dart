...
class GetWindowsWebAppSiteConfigVirtualApplication {
  ...
  final pulumi.Input<
    List<GetWindowsWebAppSiteConfigVirtualApplicationVirtualDirectory>
  >
  virtualDirectories;
  ...
  factory GetWindowsWebAppSiteConfigVirtualApplication.fromMap(
    ...
    return GetWindowsWebAppSiteConfigVirtualApplication(
      ...
      virtualDirectories: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetWindowsWebAppSiteConfigVirtualApplicationVirtualDirectory
        >(
          map['virtualDirectories']!,
          (value) =>
              GetWindowsWebAppSiteConfigVirtualApplicationVirtualDirectory.fromMap(
