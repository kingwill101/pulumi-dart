...
class LinuxWebAppSlotState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'siteCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            List<LinuxWebAppSlotSiteCredential>,
            List<Map<String, dynamic>>
          >(
            siteCredentials,
            (value) =>
  ...
  factory LinuxWebAppSlotState.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotState(
      appMetadata: (() {
        final guardedValue = map['appMetadata'];
      ...
      siteCredentials: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LinuxWebAppSlotSiteCredential>(
            guardedValue,
            (value) => LinuxWebAppSlotSiteCredential.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
