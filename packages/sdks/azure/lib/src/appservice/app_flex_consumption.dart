...
class AppFlexConsumption extends pulumi.CustomResource {
  ...
  AppFlexConsumption(
    ...
    this.alwaysReadies = registerOutput<List<AppFlexConsumptionAlwaysReady>?>('alwaysReadies');
    this.appSettings = registerOutput<Map<String, String>?>('appSettings');
    this.authSettings = registerOutput<AppFlexConsumptionAuthSettings?>('authSettings');
    this.authSettingsV2 = registerOutput<AppFlexConsumptionAuthSettingsV2?>('authSettingsV2');
    ...
    this.connectionStrings = registerOutput<List<AppFlexConsumptionConnectionString>?>('connectionStrings');
    ...
    this.httpConcurrency = registerOutput<int?>('httpConcurrency');
    this.httpsOnly = registerOutput<bool?>('httpsOnly');
    this.identity = registerOutput<AppFlexConsumptionIdentity?>('identity');
    this.instanceMemoryInMb = registerOutput<int?>('instanceMemoryInMb');
    this.kind = registerOutput<String>('kind');
    this.location = registerOutput<String>('location');
    this.maximumInstanceCount = registerOutput<int?>('maximumInstanceCount');
    ...
    this.siteConfig = registerOutput<AppFlexConsumptionSiteConfig>('siteConfig');
    this.siteCredentials = registerOutput<List<AppFlexConsumptionSiteCredential>>('siteCredentials');
    this.stickySettings = registerOutput<AppFlexConsumptionStickySettings?>('stickySettings');
    this.storageAccessKey = registerOutput<String?>('storageAccessKey');
    this.storageAuthenticationType = registerOutput<String>('storageAuthenticationType');
    this.storageContainerEndpoint = registerOutput<String>('storageContainerEndpoint');
    this.storageContainerType = registerOutput<String>('storageContainerType');
    this.storageUserAssignedIdentityId = registerOutput<String?>('storageUserAssignedIdentityId');
