...
class WindowsWebAppAuthSettingsGithub {
  ...
  /// Creates a new [WindowsWebAppAuthSettingsGithub].
  ...
  const WindowsWebAppAuthSettingsGithub({
  ...
  factory WindowsWebAppAuthSettingsGithub.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettingsGithub(
