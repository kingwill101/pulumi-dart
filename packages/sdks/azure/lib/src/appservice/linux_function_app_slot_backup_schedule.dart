...
class LinuxFunctionAppSlotBackupSchedule {
  ...
  const LinuxFunctionAppSlotBackupSchedule({
  ...
  factory LinuxFunctionAppSlotBackupSchedule.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotBackupSchedule(
