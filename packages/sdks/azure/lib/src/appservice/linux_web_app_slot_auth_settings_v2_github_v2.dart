...
class LinuxWebAppSlotAuthSettingsV2GithubV2 {
  ...
  /// Creates a new [LinuxWebAppSlotAuthSettingsV2GithubV2].
  ...
  const LinuxWebAppSlotAuthSettingsV2GithubV2({
  ...
  factory LinuxWebAppSlotAuthSettingsV2GithubV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotAuthSettingsV2GithubV2(
