...
class LinuxWebAppSlotAuthSettingsV2 {
  ...
  final LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2? activeDirectoryV2;
  /// An `apple_v2` block as defined below.
  final LinuxWebAppSlotAuthSettingsV2AppleV2? appleV2;
  /// Should the AuthV2 Settings be enabled. Defaults to `false`.
  final bool? authEnabled;
  /// An `azure_static_web_app_v2` block as defined below.
  final LinuxWebAppSlotAuthSettingsV2AzureStaticWebAppV2? azureStaticWebAppV2;
  /// The path to the App Auth settings.
  ///
  /// > **Note:** Relative Paths are evaluated from the Site Root directory.
  final String? configFilePath;
  /// Zero or more `custom_oidc_v2` blocks as defined below.
  final List<LinuxWebAppSlotAuthSettingsV2CustomOidcV2>? customOidcV2s;
  ...
  final LinuxWebAppSlotAuthSettingsV2FacebookV2? facebookV2;
  ...
  final LinuxWebAppSlotAuthSettingsV2GithubV2? githubV2;
  /// A `google_v2` block as defined below.
  final LinuxWebAppSlotAuthSettingsV2GoogleV2? googleV2;
  /// The prefix that should precede all the authentication and authorisation paths. Defaults to `/.auth`.
  final String? httpRouteApiPrefix;
  /// A `login` block as defined below.
  final LinuxWebAppSlotAuthSettingsV2Login login;
  /// A `microsoft_v2` block as defined below.
  final LinuxWebAppSlotAuthSettingsV2MicrosoftV2? microsoftV2;
  ...
  final LinuxWebAppSlotAuthSettingsV2TwitterV2? twitterV2;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customOidcV2s': ?customOidcV2s == null ? null : pulumi.Input.encodeList<LinuxWebAppSlotAuthSettingsV2CustomOidcV2, Map<String, dynamic>>(customOidcV2s!, (value) => value.toMap()),
  ...
  factory LinuxWebAppSlotAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotAuthSettingsV2(
      activeDirectoryV2: map['activeDirectoryV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2.fromMap((map['activeDirectoryV2'] as Map).cast<String, dynamic>()),
      appleV2: map['appleV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2AppleV2.fromMap((map['appleV2'] as Map).cast<String, dynamic>()),
      authEnabled: map['authEnabled'] == null ? null : map['authEnabled'] as bool,
      azureStaticWebAppV2: map['azureStaticWebAppV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2AzureStaticWebAppV2.fromMap((map['azureStaticWebAppV2'] as Map).cast<String, dynamic>()),
      configFilePath: map['configFilePath'] == null ? null : map['configFilePath'] as String,
      customOidcV2s: map['customOidcV2s'] == null ? null : pulumi.Input.decodeList<LinuxWebAppSlotAuthSettingsV2CustomOidcV2>(map['customOidcV2s'], (value) => LinuxWebAppSlotAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>())),
      ...
      facebookV2: map['facebookV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2FacebookV2.fromMap((map['facebookV2'] as Map).cast<String, dynamic>()),
      ...
      githubV2: map['githubV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2GithubV2.fromMap((map['githubV2'] as Map).cast<String, dynamic>()),
      googleV2: map['googleV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2GoogleV2.fromMap((map['googleV2'] as Map).cast<String, dynamic>()),
      httpRouteApiPrefix: map['httpRouteApiPrefix'] == null ? null : map['httpRouteApiPrefix'] as String,
      login: LinuxWebAppSlotAuthSettingsV2Login.fromMap((map['login'] as Map).cast<String, dynamic>()),
      microsoftV2: map['microsoftV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2MicrosoftV2.fromMap((map['microsoftV2'] as Map).cast<String, dynamic>()),
      ...
      twitterV2: map['twitterV2'] == null ? null : LinuxWebAppSlotAuthSettingsV2TwitterV2.fromMap((map['twitterV2'] as Map).cast<String, dynamic>()),
