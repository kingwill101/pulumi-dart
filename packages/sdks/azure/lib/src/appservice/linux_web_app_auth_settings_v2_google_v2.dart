...
class LinuxWebAppAuthSettingsV2GoogleV2 {
  ...
  /// Creates a new [LinuxWebAppAuthSettingsV2GoogleV2].
  ...
  const LinuxWebAppAuthSettingsV2GoogleV2({
  ...
  factory LinuxWebAppAuthSettingsV2GoogleV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2GoogleV2(
