...
class AppFlexConsumptionAuthSettingsV2Login {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsV2Login].
  ...
  const AppFlexConsumptionAuthSettingsV2Login({
  ...
  factory AppFlexConsumptionAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsV2Login(
      ...
      tokenRefreshExtensionTime: (() { final guardedValue = map['tokenRefreshExtensionTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
