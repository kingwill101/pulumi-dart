...
class GetWindowsWebAppAuthSettingGoogle {
  ...
  /// Creates a new [GetWindowsWebAppAuthSettingGoogle].
  ...
  const GetWindowsWebAppAuthSettingGoogle({
  ...
  factory GetWindowsWebAppAuthSettingGoogle.fromMap(Map<String, dynamic> map) {
