...
class FunctionAppFunctionState {
  ...
  factory FunctionAppFunctionState.fromMap(Map<String, dynamic> map) {
    return FunctionAppFunctionState(
      configJson: (() {
        final guardedValue = map['configJson'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      configUrl: (() {
        final guardedValue = map['configUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      enabled: (() {
      ...
      files: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FunctionAppFunctionFile>(
            guardedValue,
            (value) => FunctionAppFunctionFile.fromMap(
      ...
      invocationUrl: (() {
        final guardedValue = map['invocationUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      language: (() {
      ...
      scriptRootPathUrl: (() {
        final guardedValue = map['scriptRootPathUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      scriptUrl: (() {
      ...
      secretsFileUrl: (() {
        final guardedValue = map['secretsFileUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      testData: (() {
      ...
      testDataUrl: (() {
        final guardedValue = map['testDataUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      url: (() {
