...
class FunctionAppSiteConfig {
  ...
  factory FunctionAppSiteConfig.fromMap(Map<String, dynamic> map) {
    return FunctionAppSiteConfig(
      ...
      cors: map['cors'] == null ? null : (FunctionAppSiteConfigCors.fromMap((map['cors']! as Map).cast<String, dynamic>())).input(),
      ...
      ipRestrictions: map['ipRestrictions'] == null ? null : (pulumi.Input.decodeList<FunctionAppSiteConfigIpRestriction>(map['ipRestrictions']!, (value) => FunctionAppSiteConfigIpRestriction.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      scmIpRestrictions: map['scmIpRestrictions'] == null ? null : (pulumi.Input.decodeList<FunctionAppSiteConfigScmIpRestriction>(map['scmIpRestrictions']!, (value) => FunctionAppSiteConfigScmIpRestriction.fromMap((value as Map).cast<String, dynamic>()))).input(),
