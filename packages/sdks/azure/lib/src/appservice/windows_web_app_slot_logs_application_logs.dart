...
class WindowsWebAppSlotLogsApplicationLogs {
  ...
  final pulumi.Input<WindowsWebAppSlotLogsApplicationLogsAzureBlobStorage>?
  azureBlobStorage;
  ...
  factory WindowsWebAppSlotLogsApplicationLogs.fromMap(
    ...
    return WindowsWebAppSlotLogsApplicationLogs(
      azureBlobStorage: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsWebAppSlotLogsApplicationLogsAzureBlobStorage.fromMap(
