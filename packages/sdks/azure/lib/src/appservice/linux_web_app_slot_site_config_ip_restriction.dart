...
class LinuxWebAppSlotSiteConfigIpRestriction {
  ...
  const LinuxWebAppSlotSiteConfigIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  factory LinuxWebAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotSiteConfigIpRestriction(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
