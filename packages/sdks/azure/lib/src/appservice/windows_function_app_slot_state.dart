...
class WindowsFunctionAppSlotState {
  ...
  WindowsFunctionAppSlotState({
    ...
    pulumi.Output<WindowsFunctionAppSlotSiteConfig>? siteConfig,
    pulumi.Output<List<WindowsFunctionAppSlotSiteCredential>>? siteCredentials,
    ...
    pulumi.Output<bool>? webdeployPublishBasicAuthenticationEnabled,
      ...
      siteConfig = pulumi.Input.asOptionalInput<WindowsFunctionAppSlotSiteConfig>(siteConfig),
      siteCredentials = pulumi.Input.asOptionalInput<List<WindowsFunctionAppSlotSiteCredential>>(siteCredentials),
  ...
  factory WindowsFunctionAppSlotState.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotState(
      ...
      siteConfig: map['siteConfig'] == null ? null : pulumi.Output.create<WindowsFunctionAppSlotSiteConfig>(WindowsFunctionAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
      siteCredentials: map['siteCredentials'] == null ? null : pulumi.Output.create<List<WindowsFunctionAppSlotSiteCredential>>(pulumi.Input.decodeList<WindowsFunctionAppSlotSiteCredential>(map['siteCredentials'], (value) => WindowsFunctionAppSlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))),
