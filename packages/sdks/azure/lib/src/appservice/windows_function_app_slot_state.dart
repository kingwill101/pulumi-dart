...
class WindowsFunctionAppSlotState {
  ...
  const WindowsFunctionAppSlotState({
    this.appSettings,
    this.authSettings,
    this.authSettingsV2,
    this.backup,
  ...
  factory WindowsFunctionAppSlotState.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotState(
      ...
      siteConfig: (() { final guardedValue = map['siteConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsFunctionAppSlotSiteConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      siteCredentials: (() { final guardedValue = map['siteCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsFunctionAppSlotSiteCredential>(guardedValue, (value) => WindowsFunctionAppSlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))); })(),
