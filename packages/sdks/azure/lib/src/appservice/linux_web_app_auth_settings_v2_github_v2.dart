...
class LinuxWebAppAuthSettingsV2GithubV2 {
  ...
  /// Creates a new [LinuxWebAppAuthSettingsV2GithubV2].
  ...
  const LinuxWebAppAuthSettingsV2GithubV2({
  ...
  factory LinuxWebAppAuthSettingsV2GithubV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2GithubV2(
