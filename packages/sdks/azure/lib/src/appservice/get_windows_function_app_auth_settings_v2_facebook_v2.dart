...
class GetWindowsFunctionAppAuthSettingsV2FacebookV2 {
  ...
  /// Creates a new [GetWindowsFunctionAppAuthSettingsV2FacebookV2].
  ...
  factory GetWindowsFunctionAppAuthSettingsV2FacebookV2.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppAuthSettingsV2FacebookV2(
