...
class WindowsFunctionAppSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [WindowsFunctionAppSiteConfigScmIpRestrictionHeaders].
  ...
  const WindowsFunctionAppSiteConfigScmIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory WindowsFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSiteConfigScmIpRestrictionHeaders(
