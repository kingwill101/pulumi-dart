...
class AppServiceLogs {
  ...
  factory AppServiceLogs.fromMap(Map<String, dynamic> map) {
    return AppServiceLogs(
      applicationLogs: (() { final guardedValue = map['applicationLogs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppServiceLogsApplicationLogs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpLogs: (() { final guardedValue = map['httpLogs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppServiceLogsHttpLogs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
