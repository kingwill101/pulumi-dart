...
class LinuxFunctionAppSlotAuthSettingsV2Login {
  ...
  /// Creates a new [LinuxFunctionAppSlotAuthSettingsV2Login].
  ...
  factory LinuxFunctionAppSlotAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotAuthSettingsV2Login(
