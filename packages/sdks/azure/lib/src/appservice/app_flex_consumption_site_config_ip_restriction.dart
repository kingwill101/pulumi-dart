...
class AppFlexConsumptionSiteConfigIpRestriction {
  ...
  final pulumi.Input<AppFlexConsumptionSiteConfigIpRestrictionHeaders>? headers;
  ...
  const AppFlexConsumptionSiteConfigIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<AppFlexConsumptionSiteConfigIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory AppFlexConsumptionSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionSiteConfigIpRestriction(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppFlexConsumptionSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
