...
class GetWindowsWebAppSiteConfigIpRestriction {
  ...
  final pulumi.Input<List<GetWindowsWebAppSiteConfigIpRestrictionHeader>>
  headers;
    ...
    return <String, dynamic>{
      ...
      'headers':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigIpRestrictionHeader>,
  ...
  factory GetWindowsWebAppSiteConfigIpRestriction.fromMap(
    ...
    return GetWindowsWebAppSiteConfigIpRestriction(
      ...
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigIpRestrictionHeader>(
          map['headers']!,
          (value) => GetWindowsWebAppSiteConfigIpRestrictionHeader.fromMap(
