...
class GetWindowsWebAppSiteConfigIpRestriction {
  ...
  factory GetWindowsWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppSiteConfigIpRestriction(
      ...
      headers: (pulumi.Input.decodeList<GetWindowsWebAppSiteConfigIpRestrictionHeader>(map['headers'], (value) => GetWindowsWebAppSiteConfigIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
