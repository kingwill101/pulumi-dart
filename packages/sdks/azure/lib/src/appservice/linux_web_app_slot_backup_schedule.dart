...
class LinuxWebAppSlotBackupSchedule {
  ...
  /// Creates a new [LinuxWebAppSlotBackupSchedule].
  ...
  /// [keepAtLeastOneBackup] Should the service keep at least one backup, regardless of the age of backup? Defaults to `false`.
  ...
  const LinuxWebAppSlotBackupSchedule({
  ...
  factory LinuxWebAppSlotBackupSchedule.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotBackupSchedule(
