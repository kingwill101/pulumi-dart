...
class LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders].
  ...
  const LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders(
