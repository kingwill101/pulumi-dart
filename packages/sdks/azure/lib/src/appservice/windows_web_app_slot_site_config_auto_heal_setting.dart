...
class WindowsWebAppSlotSiteConfigAutoHealSetting {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<WindowsWebAppSlotSiteConfigAutoHealSettingAction, Map<String, dynamic>>(action, (value) => value.toMap()),
      'trigger': pulumi.Input.mapInputValue<WindowsWebAppSlotSiteConfigAutoHealSettingTrigger, Map<String, dynamic>>(trigger, (value) => value.toMap()),
    };
  }
  ...
  factory WindowsWebAppSlotSiteConfigAutoHealSetting.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigAutoHealSetting(
      action: pulumi.Input.fromValue(WindowsWebAppSlotSiteConfigAutoHealSettingAction.fromMap((map['action']! as Map).cast<String, dynamic>())),
      trigger: pulumi.Input.fromValue(WindowsWebAppSlotSiteConfigAutoHealSettingTrigger.fromMap((map['trigger']! as Map).cast<String, dynamic>())),
    );
  }
}
