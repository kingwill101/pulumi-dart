...
class WindowsWebAppSlotSiteConfigAutoHealSetting {
  ...
  factory WindowsWebAppSlotSiteConfigAutoHealSetting.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigAutoHealSetting(
      action: (WindowsWebAppSlotSiteConfigAutoHealSettingAction.fromMap((map['action'] as Map).cast<String, dynamic>())).input(),
      trigger: (WindowsWebAppSlotSiteConfigAutoHealSettingTrigger.fromMap((map['trigger'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
