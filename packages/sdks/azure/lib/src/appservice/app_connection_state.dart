...
class AppConnectionState {
  ...
  factory AppConnectionState.fromMap(Map<String, dynamic> map) {
    return AppConnectionState(
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppConnectionAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
