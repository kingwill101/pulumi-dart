...
class LinuxWebAppAuthSettingsV2 {
  ...
  final pulumi.Input<LinuxWebAppAuthSettingsV2ActiveDirectoryV2>? activeDirectoryV2;
  /// An `appleV2` block as defined below.
  final pulumi.Input<LinuxWebAppAuthSettingsV2AppleV2>? appleV2;
  /// Should the AuthV2 Settings be enabled. Defaults to `false`.
  final pulumi.Input<bool>? authEnabled;
  /// An `azureStaticWebAppV2` block as defined below.
  final pulumi.Input<LinuxWebAppAuthSettingsV2AzureStaticWebAppV2>? azureStaticWebAppV2;
  /// The path to the App Auth settings.
  ///
  /// &gt; **Note:** Relative Paths are evaluated from the Site Root directory.
  final pulumi.Input<String>? configFilePath;
  /// Zero or more `customOidcV2` blocks as defined below.
  final pulumi.Input<List<LinuxWebAppAuthSettingsV2CustomOidcV2>>? customOidcV2s;
  ...
  final pulumi.Input<LinuxWebAppAuthSettingsV2FacebookV2>? facebookV2;
  ...
  final pulumi.Input<LinuxWebAppAuthSettingsV2GithubV2>? githubV2;
  /// A `googleV2` block as defined below.
  final pulumi.Input<LinuxWebAppAuthSettingsV2GoogleV2>? googleV2;
  /// The prefix that should precede all the authentication and authorisation paths. Defaults to `/.auth`.
  final pulumi.Input<String>? httpRouteApiPrefix;
  /// A `login` block as defined below.
  final pulumi.Input<LinuxWebAppAuthSettingsV2Login> login;
  /// A `microsoftV2` block as defined below.
  final pulumi.Input<LinuxWebAppAuthSettingsV2MicrosoftV2>? microsoftV2;
  ...
  final pulumi.Input<LinuxWebAppAuthSettingsV2TwitterV2>? twitterV2;
  ...
  const LinuxWebAppAuthSettingsV2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeDirectoryV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2ActiveDirectoryV2, Map<String, dynamic>>(activeDirectoryV2, (value) => value.toMap()),
      'appleV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2AppleV2, Map<String, dynamic>>(appleV2, (value) => value.toMap()),
      'authEnabled': ?authEnabled,
      'azureStaticWebAppV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2AzureStaticWebAppV2, Map<String, dynamic>>(azureStaticWebAppV2, (value) => value.toMap()),
      'configFilePath': ?configFilePath,
      'customOidcV2s': ?pulumi.Input.mapOptionalInputValue<List<LinuxWebAppAuthSettingsV2CustomOidcV2>, List<Map<String, dynamic>>>(customOidcV2s, (value) => pulumi.Input.encodeList<LinuxWebAppAuthSettingsV2CustomOidcV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'defaultProvider': ?defaultProvider,
      'excludedPaths': ?excludedPaths,
      'facebookV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2FacebookV2, Map<String, dynamic>>(facebookV2, (value) => value.toMap()),
      ...
      'githubV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2GithubV2, Map<String, dynamic>>(githubV2, (value) => value.toMap()),
      'googleV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2GoogleV2, Map<String, dynamic>>(googleV2, (value) => value.toMap()),
      'httpRouteApiPrefix': ?httpRouteApiPrefix,
      'login': pulumi.Input.mapInputValue<LinuxWebAppAuthSettingsV2Login, Map<String, dynamic>>(login, (value) => value.toMap()),
      'microsoftV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2MicrosoftV2, Map<String, dynamic>>(microsoftV2, (value) => value.toMap()),
      'requireAuthentication': ?requireAuthentication,
      'requireHttps': ?requireHttps,
      'runtimeVersion': ?runtimeVersion,
      'twitterV2': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppAuthSettingsV2TwitterV2, Map<String, dynamic>>(twitterV2, (value) => value.toMap()),
  ...
  factory LinuxWebAppAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2(
      activeDirectoryV2: (() { final guardedValue = map['activeDirectoryV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2ActiveDirectoryV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      appleV2: (() { final guardedValue = map['appleV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2AppleV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      azureStaticWebAppV2: (() { final guardedValue = map['azureStaticWebAppV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2AzureStaticWebAppV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      customOidcV2s: (() { final guardedValue = map['customOidcV2s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LinuxWebAppAuthSettingsV2CustomOidcV2>(guardedValue, (value) => LinuxWebAppAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      facebookV2: (() { final guardedValue = map['facebookV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2FacebookV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      githubV2: (() { final guardedValue = map['githubV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2GithubV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      googleV2: (() { final guardedValue = map['googleV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2GoogleV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      login: pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2Login.fromMap((map['login']! as Map).cast<String, dynamic>())),
      microsoftV2: (() { final guardedValue = map['microsoftV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2MicrosoftV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      twitterV2: (() { final guardedValue = map['twitterV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppAuthSettingsV2TwitterV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
