...
class GetWindowsWebAppAuthSettingsV2TwitterV2 {
  ...
  /// Creates a new [GetWindowsWebAppAuthSettingsV2TwitterV2].
  ...
  const GetWindowsWebAppAuthSettingsV2TwitterV2({
  ...
  factory GetWindowsWebAppAuthSettingsV2TwitterV2.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppAuthSettingsV2TwitterV2(
