...
class LinuxWebAppSiteConfigScmIpRestriction {
  ...
  final LinuxWebAppSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory LinuxWebAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : LinuxWebAppSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
