...
class WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestWithPath {
  ...
  const WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestWithPath({
    required this.count,
  ...
  factory WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestWithPath.fromMap(Map<String, dynamic> map) {
