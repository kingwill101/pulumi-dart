...
class LinuxFunctionAppSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<LinuxFunctionAppSiteConfigScmIpRestrictionHeaders>?
  headers;
  ...
  factory LinuxFunctionAppSiteConfigScmIpRestriction.fromMap(
    ...
    return LinuxFunctionAppSiteConfigScmIpRestriction(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          LinuxFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap(
