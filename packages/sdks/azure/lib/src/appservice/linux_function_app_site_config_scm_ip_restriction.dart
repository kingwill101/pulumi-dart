...
import 'linux_function_app_site_config_scm_ip_restriction_headers.dart';
...
class LinuxFunctionAppSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<LinuxFunctionAppSiteConfigScmIpRestrictionHeaders?>? headers;
  ...
  /// Creates a new [LinuxFunctionAppSiteConfigScmIpRestriction].
  ...
  const LinuxFunctionAppSiteConfigScmIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<LinuxFunctionAppSiteConfigScmIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory LinuxFunctionAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSiteConfigScmIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
