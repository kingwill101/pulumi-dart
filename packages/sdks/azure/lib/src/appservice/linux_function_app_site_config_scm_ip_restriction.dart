...
class LinuxFunctionAppSiteConfigScmIpRestriction {
  ...
  final LinuxFunctionAppSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory LinuxFunctionAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : LinuxFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
