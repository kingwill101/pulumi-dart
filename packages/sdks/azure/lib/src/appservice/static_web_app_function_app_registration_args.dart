...
/// {@template pulumi_appservice_static_web_app_function_app_registration_static_web_app_function_app_registration_args_doc}
/// The set of arguments for StaticWebAppFunctionAppRegistration.
/// {@endtemplate}
/// {@macro pulumi_appservice_static_web_app_function_app_registration_static_web_app_function_app_registration_args_doc}
class StaticWebAppFunctionAppRegistrationArgs {
  ...
  factory StaticWebAppFunctionAppRegistrationArgs.fromMap(Map<String, dynamic> map) {
    return StaticWebAppFunctionAppRegistrationArgs(
