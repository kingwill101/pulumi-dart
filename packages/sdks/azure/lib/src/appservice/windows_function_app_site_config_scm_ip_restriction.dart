...
class WindowsFunctionAppSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<WindowsFunctionAppSiteConfigScmIpRestrictionHeaders>?
  headers;
  ...
  factory WindowsFunctionAppSiteConfigScmIpRestriction.fromMap(
    ...
    return WindowsFunctionAppSiteConfigScmIpRestriction(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap(
