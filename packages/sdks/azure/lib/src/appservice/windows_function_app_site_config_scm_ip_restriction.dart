...
class WindowsFunctionAppSiteConfigScmIpRestriction {
  ...
  final WindowsFunctionAppSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory WindowsFunctionAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : WindowsFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
