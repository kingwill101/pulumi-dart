...
class LinuxWebAppSlotAuthSettingsActiveDirectory {
  ...
  /// Creates a new [LinuxWebAppSlotAuthSettingsActiveDirectory].
  ...
  factory LinuxWebAppSlotAuthSettingsActiveDirectory.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotAuthSettingsActiveDirectory(
