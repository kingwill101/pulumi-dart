...
class LinuxWebAppAuthSettingsV2Login {
  ...
  /// Creates a new [LinuxWebAppAuthSettingsV2Login].
  ...
  const LinuxWebAppAuthSettingsV2Login({
  ...
  factory LinuxWebAppAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2Login(
