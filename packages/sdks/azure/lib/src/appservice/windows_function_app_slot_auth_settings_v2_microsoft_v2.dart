...
class WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2 {
  ...
  /// Creates a new [WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2].
  ...
  const WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2({
  ...
  factory WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2(
