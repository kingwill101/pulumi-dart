...
class LinuxFunctionAppSiteConfigApplicationStack {
  ...
  final pulumi.Input<List<LinuxFunctionAppSiteConfigApplicationStackDocker>>?
  dockers;
    ...
    return <String, dynamic>{
      'dockers':
          ?pulumi.Input.mapOptionalInputValue<
            List<LinuxFunctionAppSiteConfigApplicationStackDocker>,
  ...
  factory LinuxFunctionAppSiteConfigApplicationStack.fromMap(
    ...
    return LinuxFunctionAppSiteConfigApplicationStack(
      dockers: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => LinuxFunctionAppSiteConfigApplicationStackDocker.fromMap(
