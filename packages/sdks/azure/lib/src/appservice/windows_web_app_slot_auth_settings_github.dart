...
class WindowsWebAppSlotAuthSettingsGithub {
  ...
  /// Creates a new [WindowsWebAppSlotAuthSettingsGithub].
  ...
  const WindowsWebAppSlotAuthSettingsGithub({
  ...
  factory WindowsWebAppSlotAuthSettingsGithub.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotAuthSettingsGithub(
