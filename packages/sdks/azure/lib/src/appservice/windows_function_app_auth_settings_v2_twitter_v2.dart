...
class WindowsFunctionAppAuthSettingsV2TwitterV2 {
  ...
  /// Creates a new [WindowsFunctionAppAuthSettingsV2TwitterV2].
  ...
  const WindowsFunctionAppAuthSettingsV2TwitterV2({
  ...
  factory WindowsFunctionAppAuthSettingsV2TwitterV2.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppAuthSettingsV2TwitterV2(
