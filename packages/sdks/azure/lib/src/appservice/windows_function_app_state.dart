...
class WindowsFunctionAppState {
  ...
  factory WindowsFunctionAppState.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppState(
      ...
      siteConfig: map['siteConfig'] == null ? null : (WindowsFunctionAppSiteConfig.fromMap((map['siteConfig']! as Map).cast<String, dynamic>())).input(),
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<WindowsFunctionAppSiteCredential>(map['siteCredentials']!, (value) => WindowsFunctionAppSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
