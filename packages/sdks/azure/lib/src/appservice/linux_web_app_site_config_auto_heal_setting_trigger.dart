...
class LinuxWebAppSiteConfigAutoHealSettingTrigger {
  ...
  final pulumi.Input<LinuxWebAppSiteConfigAutoHealSettingTriggerRequests>?
  requests;

  /// A `slow_request` blocks as defined above.
  final pulumi.Input<LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequest>?
  slowRequest;
  ...
  final pulumi.Input<
    List<LinuxWebAppSiteConfigAutoHealSettingTriggerStatusCode>
  >?
  statusCodes;
  ...
  factory LinuxWebAppSiteConfigAutoHealSettingTrigger.fromMap(
    ...
    return LinuxWebAppSiteConfigAutoHealSettingTrigger(
      requests: (() {
        ...
        return pulumi.Input.fromValue(
          LinuxWebAppSiteConfigAutoHealSettingTriggerRequests.fromMap(
      ...
      slowRequest: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequest.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      slowRequestWithPaths: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPath.fromMap(
      ...
      statusCodes: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                LinuxWebAppSiteConfigAutoHealSettingTriggerStatusCode.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
