...
class WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequest {
  ...
  /// Creates a new [WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequest].
  ...
  const WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequest({
    required this.count,
  ...
  factory WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequest.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequest(
