...
import 'linux_web_app_site_config_ip_restriction_headers.dart';
...
class LinuxWebAppSiteConfigIpRestriction {
  ...
  final pulumi.Input<LinuxWebAppSiteConfigIpRestrictionHeaders>? headers;
  ...
  /// Creates a new [LinuxWebAppSiteConfigIpRestriction].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppSiteConfigIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory LinuxWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSiteConfigIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
