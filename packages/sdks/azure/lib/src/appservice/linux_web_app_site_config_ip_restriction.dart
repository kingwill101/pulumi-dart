...
class LinuxWebAppSiteConfigIpRestriction {
  ...
  final LinuxWebAppSiteConfigIpRestrictionHeaders? headers;
  ...
  factory LinuxWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : LinuxWebAppSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
