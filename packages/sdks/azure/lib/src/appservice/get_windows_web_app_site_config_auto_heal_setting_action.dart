...
class GetWindowsWebAppSiteConfigAutoHealSettingAction {
  ...
  final pulumi.Input<
    List<GetWindowsWebAppSiteConfigAutoHealSettingActionCustomAction>
  >
  customActions;
  ...
  factory GetWindowsWebAppSiteConfigAutoHealSettingAction.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetWindowsWebAppSiteConfigAutoHealSettingAction(
      actionType: pulumi.Input.fromValue(map['actionType'] as String),
      customActions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetWindowsWebAppSiteConfigAutoHealSettingActionCustomAction
        >(
          map['customActions']!,
          (value) =>
              GetWindowsWebAppSiteConfigAutoHealSettingActionCustomAction.fromMap(
