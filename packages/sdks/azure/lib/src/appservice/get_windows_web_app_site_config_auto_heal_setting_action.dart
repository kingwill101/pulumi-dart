...
class GetWindowsWebAppSiteConfigAutoHealSettingAction {
  ...
  factory GetWindowsWebAppSiteConfigAutoHealSettingAction.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppSiteConfigAutoHealSettingAction(
      ...
      customActions: (pulumi.Input.decodeList<GetWindowsWebAppSiteConfigAutoHealSettingActionCustomAction>(map['customActions'], (value) => GetWindowsWebAppSiteConfigAutoHealSettingActionCustomAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
