...
class LinuxFunctionAppAuthSettingsV2TwitterV2 {
  ...
  /// Creates a new [LinuxFunctionAppAuthSettingsV2TwitterV2].
  ...
  const LinuxFunctionAppAuthSettingsV2TwitterV2({
  ...
  factory LinuxFunctionAppAuthSettingsV2TwitterV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppAuthSettingsV2TwitterV2(
