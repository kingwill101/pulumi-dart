...
class GetWindowsWebAppSiteConfigAutoHealSettingTrigger {
  ...
  final pulumi.Input<
    List<GetWindowsWebAppSiteConfigAutoHealSettingTriggerRequest>
  >
  requests;

  /// (Optional) One or more `slow_request_with_path` blocks as defined above.
  final pulumi.Input<
    List<GetWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPath>
  >
  slowRequestWithPaths;

  /// A `slow_request` block as defined above.
  final pulumi.Input<
    List<GetWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequest>
  >
  slowRequests;

  /// A `status_code` block as defined above.
  final pulumi.Input<
    List<GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode>
  >
  statusCodes;
  ...
  factory GetWindowsWebAppSiteConfigAutoHealSettingTrigger.fromMap(
    ...
    return GetWindowsWebAppSiteConfigAutoHealSettingTrigger(
      ...
      requests: pulumi.Input.fromValue(
        ...
        >(
          map['requests']!,
          (value) =>
              GetWindowsWebAppSiteConfigAutoHealSettingTriggerRequest.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      slowRequestWithPaths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPath
        >(
          map['slowRequestWithPaths']!,
          (value) =>
              GetWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPath.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      slowRequests: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequest
        >(
          map['slowRequests']!,
          (value) =>
              GetWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequest.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      statusCodes: pulumi.Input.fromValue(
        ...
        >(
          map['statusCodes']!,
          (value) =>
              GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
