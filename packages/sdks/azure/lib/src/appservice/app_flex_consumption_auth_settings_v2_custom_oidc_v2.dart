...
class AppFlexConsumptionAuthSettingsV2CustomOidcV2 {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsV2CustomOidcV2].
  ...
  factory AppFlexConsumptionAuthSettingsV2CustomOidcV2.fromMap(
    Map<String, dynamic> map,
  ) {
    return AppFlexConsumptionAuthSettingsV2CustomOidcV2(
      authorisationEndpoint: (() {
        final guardedValue = map['authorisationEndpoint'];
      ...
      clientCredentialMethod: (() {
        final guardedValue = map['clientCredentialMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      issuerEndpoint: (() {
        final guardedValue = map['issuerEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
