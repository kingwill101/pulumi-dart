...
class GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2 {
  ...
  /// Creates a new [GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2].
  ...
  const GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2({
  ...
  factory GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2(
