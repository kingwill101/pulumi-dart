...
class FunctionAppSlotSiteConfigIpRestriction {
  ...
  const FunctionAppSlotSiteConfigIpRestriction({
    this.action,
    this.headers,
    this.ipAddress,
    this.name,
  ...
  factory FunctionAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotSiteConfigIpRestriction(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
