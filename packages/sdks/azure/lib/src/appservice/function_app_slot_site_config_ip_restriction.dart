...
class FunctionAppSlotSiteConfigIpRestriction {
  ...
  final FunctionAppSlotSiteConfigIpRestrictionHeaders? headers;
  ...
  factory FunctionAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : FunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
