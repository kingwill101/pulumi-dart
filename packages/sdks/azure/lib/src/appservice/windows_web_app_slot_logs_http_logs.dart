...
class WindowsWebAppSlotLogsHttpLogs {
  ...
  final pulumi.Input<WindowsWebAppSlotLogsHttpLogsAzureBlobStorage>?
  azureBlobStorage;
  ...
  WindowsWebAppSlotLogsHttpLogs({this.azureBlobStorage, this.fileSystem});
    ...
    return WindowsWebAppSlotLogsHttpLogs(
      azureBlobStorage: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsWebAppSlotLogsHttpLogsAzureBlobStorage.fromMap(
      ...
      fileSystem: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WindowsWebAppSlotLogsHttpLogsFileSystem.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
