...
import 'linux_web_app_slot_site_config_scm_ip_restriction_headers.dart';
...
class LinuxWebAppSlotSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders>? headers;
  ...
  /// Creates a new [LinuxWebAppSlotSiteConfigScmIpRestriction].
  ...
  const LinuxWebAppSlotSiteConfigScmIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory LinuxWebAppSlotSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotSiteConfigScmIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
