...
class LinuxWebAppSlotSiteConfigScmIpRestriction {
  ...
  final LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory LinuxWebAppSlotSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
