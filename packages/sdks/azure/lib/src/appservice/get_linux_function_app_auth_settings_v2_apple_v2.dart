...
class GetLinuxFunctionAppAuthSettingsV2AppleV2 {
  ...
  /// Creates a new [GetLinuxFunctionAppAuthSettingsV2AppleV2].
  ...
  const GetLinuxFunctionAppAuthSettingsV2AppleV2({
  ...
  factory GetLinuxFunctionAppAuthSettingsV2AppleV2.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppAuthSettingsV2AppleV2(
