...
class LinuxFunctionAppAuthSettingsMicrosoft {
  ...
  /// Creates a new [LinuxFunctionAppAuthSettingsMicrosoft].
  ...
  const LinuxFunctionAppAuthSettingsMicrosoft({
  ...
  factory LinuxFunctionAppAuthSettingsMicrosoft.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppAuthSettingsMicrosoft(
