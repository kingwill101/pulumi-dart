...
import 'slot_site_config_scm_ip_restriction_headers.dart';

class SlotSiteConfigScmIpRestriction {
  /// Allow or Deny access for this IP range. Defaults to `Allow`.
  final pulumi.Input<String>? action;
  /// The `headers` block for this specific `scm_ip_restriction` as defined below.
  final pulumi.Input<SlotSiteConfigScmIpRestrictionHeaders>? headers;
  ...
  /// Creates a new [SlotSiteConfigScmIpRestriction].
  ...
  const SlotSiteConfigScmIpRestriction({
    this.action,
    this.headers,
    this.ipAddress,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?action,
      'headers': ?pulumi.Input.mapOptionalInputValue<SlotSiteConfigScmIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory SlotSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return SlotSiteConfigScmIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlotSiteConfigScmIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
