...
class LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2 {
  ...
  /// Creates a new [LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2].
  ...
  const LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2({
  ...
  factory LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2(
