...
class GetWindowsWebAppAuthSettingsV2Login {
  ...
  const GetWindowsWebAppAuthSettingsV2Login({
  ...
  factory GetWindowsWebAppAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppAuthSettingsV2Login(
      ...
      cookieExpirationConvention: pulumi.Input.fromValue(map['cookieExpirationConvention'] as String),
      cookieExpirationTime: pulumi.Input.fromValue(map['cookieExpirationTime'] as String),
