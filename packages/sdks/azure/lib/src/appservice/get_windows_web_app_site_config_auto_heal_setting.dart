...
class GetWindowsWebAppSiteConfigAutoHealSetting {
  ...
  factory GetWindowsWebAppSiteConfigAutoHealSetting.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppSiteConfigAutoHealSetting(
      actions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppSiteConfigAutoHealSettingAction>(map['actions']!, (value) => GetWindowsWebAppSiteConfigAutoHealSettingAction.fromMap((value as Map).cast<String, dynamic>()))),
      triggers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWindowsWebAppSiteConfigAutoHealSettingTrigger>(map['triggers']!, (value) => GetWindowsWebAppSiteConfigAutoHealSettingTrigger.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
