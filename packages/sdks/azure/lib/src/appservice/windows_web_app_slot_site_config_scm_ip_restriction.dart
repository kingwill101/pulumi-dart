...
class WindowsWebAppSlotSiteConfigScmIpRestriction {
  ...
  final WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory WindowsWebAppSlotSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
