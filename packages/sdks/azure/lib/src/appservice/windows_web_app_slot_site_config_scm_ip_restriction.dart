...
class WindowsWebAppSlotSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders>?
  headers;
  ...
  factory WindowsWebAppSlotSiteConfigScmIpRestriction.fromMap(
    ...
    return WindowsWebAppSlotSiteConfigScmIpRestriction(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders.fromMap(
