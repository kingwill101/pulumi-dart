...
import 'windows_web_app_slot_site_config_scm_ip_restriction_headers.dart';
...
class WindowsWebAppSlotSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders>? headers;
  ...
  /// Creates a new [WindowsWebAppSlotSiteConfigScmIpRestriction].
  ...
  const WindowsWebAppSlotSiteConfigScmIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory WindowsWebAppSlotSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotSiteConfigScmIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
