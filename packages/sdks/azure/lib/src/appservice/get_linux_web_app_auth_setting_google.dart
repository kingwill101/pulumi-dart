...
class GetLinuxWebAppAuthSettingGoogle {
  ...
  /// Creates a new [GetLinuxWebAppAuthSettingGoogle].
  ...
  const GetLinuxWebAppAuthSettingGoogle({
  ...
  factory GetLinuxWebAppAuthSettingGoogle.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppAuthSettingGoogle(
