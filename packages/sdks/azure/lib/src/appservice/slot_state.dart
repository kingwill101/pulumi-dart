...
class SlotState {
  ...
  factory SlotState.fromMap(Map<String, dynamic> map) {
    return SlotState(
      ...
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<SlotSiteCredential>(map['siteCredentials'], (value) => SlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
