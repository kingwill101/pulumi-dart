...
class GetWindowsWebAppSiteConfig {
  ...
  final pulumi.Input<List<GetWindowsWebAppSiteConfigApplicationStack>>
  applicationStacks;

  /// A `auto_heal_setting` block as defined above.
  final pulumi.Input<List<GetWindowsWebAppSiteConfigAutoHealSetting>>
  autoHealSettings;
  ...
  final pulumi.Input<List<GetWindowsWebAppSiteConfigHandlerMapping>>
  handlerMappings;
  ...
  final pulumi.Input<List<GetWindowsWebAppSiteConfigIpRestriction>>
  ipRestrictions;
  ...
  final pulumi.Input<List<GetWindowsWebAppSiteConfigScmIpRestriction>>
  scmIpRestrictions;
  ...
  final pulumi.Input<List<GetWindowsWebAppSiteConfigVirtualApplication>>
  virtualApplications;
    ...
    return <String, dynamic>{
      ...
      'applicationStacks':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigApplicationStack>,
      ...
      'autoHealSettings':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigAutoHealSetting>,
            List<Map<String, dynamic>>
          >(
            autoHealSettings,
            (value) =>
      ...
      'cors':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigCor>,
            List<Map<String, dynamic>>
          >(
            cors,
            (value) =>
      ...
      'handlerMappings':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigHandlerMapping>,
            List<Map<String, dynamic>>
          >(
            handlerMappings,
            (value) =>
      ...
      'ipRestrictions':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigIpRestriction>,
            List<Map<String, dynamic>>
          >(
            ipRestrictions,
            (value) =>
      ...
      'scmIpRestrictions':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigScmIpRestriction>,
            List<Map<String, dynamic>>
          >(
            scmIpRestrictions,
            (value) =>
      ...
      'virtualApplications':
          pulumi.Input.mapInputValue<
            List<GetWindowsWebAppSiteConfigVirtualApplication>,
            List<Map<String, dynamic>>
          >(
            virtualApplications,
            (value) =>
  ...
  factory GetWindowsWebAppSiteConfig.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppSiteConfig(
      ...
      apiDefinitionUrl: pulumi.Input.fromValue(
        map['apiDefinitionUrl'] as String,
      ),
      apiManagementApiId: pulumi.Input.fromValue(
        map['apiManagementApiId'] as String,
      ),
      appCommandLine: pulumi.Input.fromValue(map['appCommandLine'] as String),
      applicationStacks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigApplicationStack>(
          map['applicationStacks']!,
          (value) => GetWindowsWebAppSiteConfigApplicationStack.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      autoHealSettings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigAutoHealSetting>(
          map['autoHealSettings']!,
          (value) => GetWindowsWebAppSiteConfigAutoHealSetting.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      containerRegistryManagedIdentityClientId: pulumi.Input.fromValue(
        map['containerRegistryManagedIdentityClientId'] as String,
      ),
      containerRegistryUseManagedIdentity: pulumi.Input.fromValue(
        map['containerRegistryUseManagedIdentity'] as bool,
      ),
      cors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigCor>(
          map['cors']!,
          (value) => GetWindowsWebAppSiteConfigCor.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      detailedErrorLoggingEnabled: pulumi.Input.fromValue(
        map['detailedErrorLoggingEnabled'] as bool,
      ),
      ftpsState: pulumi.Input.fromValue(map['ftpsState'] as String),
      handlerMappings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigHandlerMapping>(
          map['handlerMappings']!,
          (value) => GetWindowsWebAppSiteConfigHandlerMapping.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      healthCheckEvictionTimeInMin: pulumi.Input.fromValue(
        map['healthCheckEvictionTimeInMin'] as int,
      ),
      ...
      ipRestrictionDefaultAction: pulumi.Input.fromValue(
        map['ipRestrictionDefaultAction'] as String,
      ),
      ipRestrictions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigIpRestriction>(
          map['ipRestrictions']!,
          (value) => GetWindowsWebAppSiteConfigIpRestriction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      loadBalancingMode: pulumi.Input.fromValue(
        map['loadBalancingMode'] as String,
      ),
      ...
      scmIpRestrictionDefaultAction: pulumi.Input.fromValue(
        map['scmIpRestrictionDefaultAction'] as String,
      ),
      scmIpRestrictions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigScmIpRestriction>(
          map['scmIpRestrictions']!,
          (value) => GetWindowsWebAppSiteConfigScmIpRestriction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      scmMinimumTlsVersion: pulumi.Input.fromValue(
        map['scmMinimumTlsVersion'] as String,
      ),
      ...
      virtualApplications: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWindowsWebAppSiteConfigVirtualApplication>(
          map['virtualApplications']!,
          (value) => GetWindowsWebAppSiteConfigVirtualApplication.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
