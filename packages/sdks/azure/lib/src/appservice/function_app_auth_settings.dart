    ...
    return FunctionAppAuthSettings(
      activeDirectory: (() {
        ...
        return pulumi.Input.fromValue(
          FunctionAppAuthSettingsActiveDirectory.fromMap(
      ...
      facebook: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppAuthSettingsFacebook.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      google: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppAuthSettingsGoogle.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      microsoft: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppAuthSettingsMicrosoft.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      twitter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppAuthSettingsTwitter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
