...
class LinuxWebAppSlotSiteConfigApplicationStack {
  ...
  factory LinuxWebAppSlotSiteConfigApplicationStack.fromMap(
    ...
    return LinuxWebAppSlotSiteConfigApplicationStack(
      ...
      javaServer: (() {
        final guardedValue = map['javaServer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      javaServerVersion: (() {
        final guardedValue = map['javaServerVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      javaVersion: (() {
      ...
      rubyVersion: (() {
        final guardedValue = map['rubyVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
