...
class WindowsFunctionAppSlotBackupSchedule {
  ...
  /// Creates a new [WindowsFunctionAppSlotBackupSchedule].
  ...
  const WindowsFunctionAppSlotBackupSchedule({
  ...
  factory WindowsFunctionAppSlotBackupSchedule.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotBackupSchedule(
