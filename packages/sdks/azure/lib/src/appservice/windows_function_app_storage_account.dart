...
class WindowsFunctionAppStorageAccount {
  ...
  /// Creates a new [WindowsFunctionAppStorageAccount].
  ...
  const WindowsFunctionAppStorageAccount({
  ...
  factory WindowsFunctionAppStorageAccount.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppStorageAccount(
