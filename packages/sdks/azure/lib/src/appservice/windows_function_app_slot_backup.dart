...
class WindowsFunctionAppSlotBackup {
  ...
  final pulumi.Input<WindowsFunctionAppSlotBackupSchedule> schedule;
  ...
  const WindowsFunctionAppSlotBackup({
    this.enabled,
    required this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enabled': ?enabled,
      'name': name,
      'schedule': pulumi.Input.mapInputValue<WindowsFunctionAppSlotBackupSchedule, Map<String, dynamic>>(schedule, (value) => value.toMap()),
  ...
  factory WindowsFunctionAppSlotBackup.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotBackup(
      ...
      schedule: pulumi.Input.fromValue(WindowsFunctionAppSlotBackupSchedule.fromMap((map['schedule']! as Map).cast<String, dynamic>())),
