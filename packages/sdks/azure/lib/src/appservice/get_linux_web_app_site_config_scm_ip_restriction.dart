...
class GetLinuxWebAppSiteConfigScmIpRestriction {
  ...
  final pulumi.Input<List<GetLinuxWebAppSiteConfigScmIpRestrictionHeader>>
  headers;
    ...
    return <String, dynamic>{
      ...
      'headers':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppSiteConfigScmIpRestrictionHeader>,
  ...
  factory GetLinuxWebAppSiteConfigScmIpRestriction.fromMap(
    ...
    return GetLinuxWebAppSiteConfigScmIpRestriction(
      ...
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppSiteConfigScmIpRestrictionHeader>(
          map['headers']!,
          (value) => GetLinuxWebAppSiteConfigScmIpRestrictionHeader.fromMap(
