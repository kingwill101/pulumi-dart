...
class LinuxFunctionAppSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [LinuxFunctionAppSiteConfigIpRestrictionHeaders].
  ...
  const LinuxFunctionAppSiteConfigIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory LinuxFunctionAppSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSiteConfigIpRestrictionHeaders(
