...
class WindowsFunctionAppSlotSiteConfig {
  ...
  const WindowsFunctionAppSlotSiteConfig({
    this.alwaysOn,
  ...
  factory WindowsFunctionAppSlotSiteConfig.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotSiteConfig(
      ...
      applicationStack: (() { final guardedValue = map['applicationStack']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsFunctionAppSlotSiteConfigApplicationStack.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ipRestrictions: (() { final guardedValue = map['ipRestrictions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsFunctionAppSlotSiteConfigIpRestriction>(guardedValue, (value) => WindowsFunctionAppSlotSiteConfigIpRestriction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      scmIpRestrictions: (() { final guardedValue = map['scmIpRestrictions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsFunctionAppSlotSiteConfigScmIpRestriction>(guardedValue, (value) => WindowsFunctionAppSlotSiteConfigScmIpRestriction.fromMap((value as Map).cast<String, dynamic>()))); })(),
