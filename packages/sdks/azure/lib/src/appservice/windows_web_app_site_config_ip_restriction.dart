...
class WindowsWebAppSiteConfigIpRestriction {
  ...
  final WindowsWebAppSiteConfigIpRestrictionHeaders? headers;
  ...
  factory WindowsWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : WindowsWebAppSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
