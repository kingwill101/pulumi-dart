...
import 'windows_web_app_site_config_ip_restriction_headers.dart';
...
class WindowsWebAppSiteConfigIpRestriction {
  ...
  final pulumi.Input<WindowsWebAppSiteConfigIpRestrictionHeaders>? headers;
  ...
  /// Creates a new [WindowsWebAppSiteConfigIpRestriction].
  ...
  const WindowsWebAppSiteConfigIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppSiteConfigIpRestrictionHeaders, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ?ipAddress,
      'name': ?name,
      'priority': ?priority,
  ...
  factory WindowsWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSiteConfigIpRestriction(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
