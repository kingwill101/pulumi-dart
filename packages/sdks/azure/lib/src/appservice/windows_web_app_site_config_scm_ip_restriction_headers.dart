...
class WindowsWebAppSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [WindowsWebAppSiteConfigScmIpRestrictionHeaders].
  ...
  const WindowsWebAppSiteConfigScmIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory WindowsWebAppSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSiteConfigScmIpRestrictionHeaders(
