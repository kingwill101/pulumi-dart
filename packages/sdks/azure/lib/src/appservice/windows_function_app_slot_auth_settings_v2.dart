...
class WindowsFunctionAppSlotAuthSettingsV2 {
  ...
  factory WindowsFunctionAppSlotAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotAuthSettingsV2(
      activeDirectoryV2: map['activeDirectoryV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2.fromMap((map['activeDirectoryV2'] as Map).cast<String, dynamic>())).input(),
      appleV2: map['appleV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2AppleV2.fromMap((map['appleV2'] as Map).cast<String, dynamic>())).input(),
      authEnabled: map['authEnabled'] == null ? null : (map['authEnabled'] as bool).input(),
      azureStaticWebAppV2: map['azureStaticWebAppV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2AzureStaticWebAppV2.fromMap((map['azureStaticWebAppV2'] as Map).cast<String, dynamic>())).input(),
      configFilePath: map['configFilePath'] == null ? null : (map['configFilePath'] as String).input(),
      customOidcV2s: map['customOidcV2s'] == null ? null : (pulumi.Input.decodeList<WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2>(map['customOidcV2s'], (value) => WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      facebookV2: map['facebookV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2FacebookV2.fromMap((map['facebookV2'] as Map).cast<String, dynamic>())).input(),
      ...
      githubV2: map['githubV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2GithubV2.fromMap((map['githubV2'] as Map).cast<String, dynamic>())).input(),
      googleV2: map['googleV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2GoogleV2.fromMap((map['googleV2'] as Map).cast<String, dynamic>())).input(),
      httpRouteApiPrefix: map['httpRouteApiPrefix'] == null ? null : (map['httpRouteApiPrefix'] as String).input(),
      login: (WindowsFunctionAppSlotAuthSettingsV2Login.fromMap((map['login'] as Map).cast<String, dynamic>())).input(),
      microsoftV2: map['microsoftV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2.fromMap((map['microsoftV2'] as Map).cast<String, dynamic>())).input(),
      ...
      twitterV2: map['twitterV2'] == null ? null : (WindowsFunctionAppSlotAuthSettingsV2TwitterV2.fromMap((map['twitterV2'] as Map).cast<String, dynamic>())).input(),
