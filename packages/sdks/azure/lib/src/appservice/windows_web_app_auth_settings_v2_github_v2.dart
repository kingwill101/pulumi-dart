...
class WindowsWebAppAuthSettingsV2GithubV2 {
  ...
  /// Creates a new [WindowsWebAppAuthSettingsV2GithubV2].
  ...
  const WindowsWebAppAuthSettingsV2GithubV2({
  ...
  factory WindowsWebAppAuthSettingsV2GithubV2.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettingsV2GithubV2(
