...
class GetLinuxFunctionAppSiteConfigIpRestriction {
  ...
  factory GetLinuxFunctionAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppSiteConfigIpRestriction(
      ...
      headers: (pulumi.Input.decodeList<GetLinuxFunctionAppSiteConfigIpRestrictionHeader>(map['headers'], (value) => GetLinuxFunctionAppSiteConfigIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
