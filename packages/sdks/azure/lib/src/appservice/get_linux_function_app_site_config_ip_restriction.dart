...
class GetLinuxFunctionAppSiteConfigIpRestriction {
  ...
  final pulumi.Input<List<GetLinuxFunctionAppSiteConfigIpRestrictionHeader>>
  headers;
    ...
    return <String, dynamic>{
      ...
      'headers':
          pulumi.Input.mapInputValue<
            List<GetLinuxFunctionAppSiteConfigIpRestrictionHeader>,
  ...
  factory GetLinuxFunctionAppSiteConfigIpRestriction.fromMap(
    ...
    return GetLinuxFunctionAppSiteConfigIpRestriction(
      ...
      headers: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetLinuxFunctionAppSiteConfigIpRestrictionHeader>(
          map['headers']!,
          (value) => GetLinuxFunctionAppSiteConfigIpRestrictionHeader.fromMap(
