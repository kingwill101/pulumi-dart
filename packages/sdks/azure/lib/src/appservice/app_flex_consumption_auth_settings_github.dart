...
class AppFlexConsumptionAuthSettingsGithub {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsGithub].
  ...
  const AppFlexConsumptionAuthSettingsGithub({
  ...
  factory AppFlexConsumptionAuthSettingsGithub.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsGithub(
