...
class AppFlexConsumptionAuthSettingsFacebook {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsFacebook].
  ...
  const AppFlexConsumptionAuthSettingsFacebook({
    required this.appId,
    this.appSecret,
  ...
  factory AppFlexConsumptionAuthSettingsFacebook.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsFacebook(
