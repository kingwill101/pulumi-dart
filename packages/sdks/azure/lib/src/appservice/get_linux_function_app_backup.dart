...
class GetLinuxFunctionAppBackup {
  ...
  factory GetLinuxFunctionAppBackup.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppBackup(
      ...
      schedules: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLinuxFunctionAppBackupSchedule>(map['schedules']!, (value) => GetLinuxFunctionAppBackupSchedule.fromMap((value as Map).cast<String, dynamic>()))),
