...
class WindowsWebAppSlotAuthSettingsActiveDirectory {
  ...
  /// Creates a new [WindowsWebAppSlotAuthSettingsActiveDirectory].
  ...
  const WindowsWebAppSlotAuthSettingsActiveDirectory({
  ...
  factory WindowsWebAppSlotAuthSettingsActiveDirectory.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotAuthSettingsActiveDirectory(
