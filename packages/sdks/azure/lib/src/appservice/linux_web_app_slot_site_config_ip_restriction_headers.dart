...
class LinuxWebAppSlotSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [LinuxWebAppSlotSiteConfigIpRestrictionHeaders].
  ...
  const LinuxWebAppSlotSiteConfigIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory LinuxWebAppSlotSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotSiteConfigIpRestrictionHeaders(
