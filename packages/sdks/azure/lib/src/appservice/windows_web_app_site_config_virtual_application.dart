...
class WindowsWebAppSiteConfigVirtualApplication {
  ...
  final pulumi.Input<
    List<WindowsWebAppSiteConfigVirtualApplicationVirtualDirectory>
  >?
  virtualDirectories;
  ...
  factory WindowsWebAppSiteConfigVirtualApplication.fromMap(
      ...
      virtualDirectories: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WindowsWebAppSiteConfigVirtualApplicationVirtualDirectory.fromMap(
