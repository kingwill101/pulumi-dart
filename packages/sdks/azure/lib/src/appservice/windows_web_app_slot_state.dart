...
class WindowsWebAppSlotState {
  ...
  factory WindowsWebAppSlotState.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotState(
      ...
      authSettings: map['authSettings'] == null ? null : (WindowsWebAppSlotAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>())).input(),
      authSettingsV2: map['authSettingsV2'] == null ? null : (WindowsWebAppSlotAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>())).input(),
      backup: map['backup'] == null ? null : (WindowsWebAppSlotBackup.fromMap((map['backup'] as Map).cast<String, dynamic>())).input(),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : (pulumi.Input.decodeList<WindowsWebAppSlotConnectionString>(map['connectionStrings'], (value) => WindowsWebAppSlotConnectionString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      identity: map['identity'] == null ? null : (WindowsWebAppSlotIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())).input(),
      ...
      logs: map['logs'] == null ? null : (WindowsWebAppSlotLogs.fromMap((map['logs'] as Map).cast<String, dynamic>())).input(),
      ...
      siteConfig: map['siteConfig'] == null ? null : (WindowsWebAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())).input(),
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<WindowsWebAppSlotSiteCredential>(map['siteCredentials'], (value) => WindowsWebAppSlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
      storageAccounts: map['storageAccounts'] == null ? null : (pulumi.Input.decodeList<WindowsWebAppSlotStorageAccount>(map['storageAccounts'], (value) => WindowsWebAppSlotStorageAccount.fromMap((value as Map).cast<String, dynamic>()))).input(),
