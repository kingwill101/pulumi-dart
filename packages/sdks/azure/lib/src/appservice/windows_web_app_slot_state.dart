...
class WindowsWebAppSlotState {
  ...
  WindowsWebAppSlotState({
    ...
    pulumi.Output<WindowsWebAppSlotSiteConfig>? siteConfig,
    pulumi.Output<List<WindowsWebAppSlotSiteCredential>>? siteCredentials,
    ...
    pulumi.Output<String>? zipDeployFile,
      ...
      siteConfig = pulumi.Input.asOptionalInput<WindowsWebAppSlotSiteConfig>(siteConfig),
      siteCredentials = pulumi.Input.asOptionalInput<List<WindowsWebAppSlotSiteCredential>>(siteCredentials),
  ...
  factory WindowsWebAppSlotState.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotState(
      ...
      siteConfig: map['siteConfig'] == null ? null : pulumi.Output.create<WindowsWebAppSlotSiteConfig>(WindowsWebAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
      siteCredentials: map['siteCredentials'] == null ? null : pulumi.Output.create<List<WindowsWebAppSlotSiteCredential>>(pulumi.Input.decodeList<WindowsWebAppSlotSiteCredential>(map['siteCredentials'], (value) => WindowsWebAppSlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))),
