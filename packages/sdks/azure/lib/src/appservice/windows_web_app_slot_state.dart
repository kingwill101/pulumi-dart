...
class WindowsWebAppSlotState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'siteConfig': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppSlotSiteConfig, Map<String, dynamic>>(siteConfig, (value) => value.toMap()),
      'siteCredentials': ?pulumi.Input.mapOptionalInputValue<List<WindowsWebAppSlotSiteCredential>, List<Map<String, dynamic>>>(siteCredentials, (value) => pulumi.Input.encodeList<WindowsWebAppSlotSiteCredential, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory WindowsWebAppSlotState.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotState(
      ...
      authSettings: (() { final guardedValue = map['authSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotAuthSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      authSettingsV2: (() { final guardedValue = map['authSettingsV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotAuthSettingsV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      backup: (() { final guardedValue = map['backup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotBackup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      connectionStrings: (() { final guardedValue = map['connectionStrings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsWebAppSlotConnectionString>(guardedValue, (value) => WindowsWebAppSlotConnectionString.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      logs: (() { final guardedValue = map['logs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotLogs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      siteConfig: (() { final guardedValue = map['siteConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSlotSiteConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      siteCredentials: (() { final guardedValue = map['siteCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsWebAppSlotSiteCredential>(guardedValue, (value) => WindowsWebAppSlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))); })(),
      storageAccounts: (() { final guardedValue = map['storageAccounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsWebAppSlotStorageAccount>(guardedValue, (value) => WindowsWebAppSlotStorageAccount.fromMap((value as Map).cast<String, dynamic>()))); })(),
