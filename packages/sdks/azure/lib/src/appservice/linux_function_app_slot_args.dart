...
class LinuxFunctionAppSlotArgs {
  ...
  LinuxFunctionAppSlotArgs({
    ...
    required pulumi.Output<LinuxFunctionAppSlotSiteConfig> siteConfig,
  ...
  factory LinuxFunctionAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotArgs(
      ...
      siteConfig: pulumi.Output.create<LinuxFunctionAppSlotSiteConfig>(LinuxFunctionAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
