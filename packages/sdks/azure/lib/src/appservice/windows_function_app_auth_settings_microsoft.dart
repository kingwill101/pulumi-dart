...
class WindowsFunctionAppAuthSettingsMicrosoft {
  ...
  /// Creates a new [WindowsFunctionAppAuthSettingsMicrosoft].
  ...
  const WindowsFunctionAppAuthSettingsMicrosoft({
  ...
  factory WindowsFunctionAppAuthSettingsMicrosoft.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppAuthSettingsMicrosoft(
