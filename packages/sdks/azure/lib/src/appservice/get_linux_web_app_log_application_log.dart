...
class GetLinuxWebAppLogApplicationLog {
  ...
  final pulumi.Input<List<GetLinuxWebAppLogApplicationLogAzureBlobStorage>>
  azureBlobStorages;
    ...
    return <String, dynamic>{
      'azureBlobStorages':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppLogApplicationLogAzureBlobStorage>,
  ...
  factory GetLinuxWebAppLogApplicationLog.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppLogApplicationLog(
      azureBlobStorages: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetLinuxWebAppLogApplicationLogAzureBlobStorage>(
          map['azureBlobStorages']!,
          (value) => GetLinuxWebAppLogApplicationLogAzureBlobStorage.fromMap(
