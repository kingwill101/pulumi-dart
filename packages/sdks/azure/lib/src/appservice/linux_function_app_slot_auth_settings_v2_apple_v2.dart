...
class LinuxFunctionAppSlotAuthSettingsV2AppleV2 {
  ...
  /// Creates a new [LinuxFunctionAppSlotAuthSettingsV2AppleV2].
  ...
  const LinuxFunctionAppSlotAuthSettingsV2AppleV2({
  ...
  factory LinuxFunctionAppSlotAuthSettingsV2AppleV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotAuthSettingsV2AppleV2(
