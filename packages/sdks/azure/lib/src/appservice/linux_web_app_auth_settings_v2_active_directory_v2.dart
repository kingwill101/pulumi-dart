...
class LinuxWebAppAuthSettingsV2ActiveDirectoryV2 {
  ...
  /// Creates a new [LinuxWebAppAuthSettingsV2ActiveDirectoryV2].
  ...
  const LinuxWebAppAuthSettingsV2ActiveDirectoryV2({
  ...
  factory LinuxWebAppAuthSettingsV2ActiveDirectoryV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2ActiveDirectoryV2(
