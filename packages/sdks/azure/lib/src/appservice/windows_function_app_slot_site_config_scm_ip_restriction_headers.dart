...
class WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders].
  ...
  const WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders(
