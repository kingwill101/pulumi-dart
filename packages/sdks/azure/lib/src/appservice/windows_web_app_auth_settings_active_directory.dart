...
class WindowsWebAppAuthSettingsActiveDirectory {
  ...
  /// Creates a new [WindowsWebAppAuthSettingsActiveDirectory].
  ...
  const WindowsWebAppAuthSettingsActiveDirectory({
  ...
  factory WindowsWebAppAuthSettingsActiveDirectory.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettingsActiveDirectory(
