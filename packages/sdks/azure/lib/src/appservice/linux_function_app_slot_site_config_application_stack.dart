...
class LinuxFunctionAppSlotSiteConfigApplicationStack {
  ...
  final pulumi.Input<
    List<LinuxFunctionAppSlotSiteConfigApplicationStackDocker>
  >?
  dockers;
  ...
  factory LinuxFunctionAppSlotSiteConfigApplicationStack.fromMap(
    Map<String, dynamic> map,
  ) {
    return LinuxFunctionAppSlotSiteConfigApplicationStack(
      dockers: (() {
        final guardedValue = map['dockers'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                LinuxFunctionAppSlotSiteConfigApplicationStackDocker.fromMap(
      ...
      powershellCoreVersion: (() {
        final guardedValue = map['powershellCoreVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pythonVersion: (() {
      ...
      useCustomRuntime: (() {
        final guardedValue = map['useCustomRuntime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      useDotnetIsolatedRuntime: (() {
        final guardedValue = map['useDotnetIsolatedRuntime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
