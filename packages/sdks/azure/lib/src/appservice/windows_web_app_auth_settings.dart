...
class WindowsWebAppAuthSettings {
  ...
  final WindowsWebAppAuthSettingsActiveDirectory? activeDirectory;
  ...
  final WindowsWebAppAuthSettingsFacebook? facebook;
  /// A `github` block as defined below.
  final WindowsWebAppAuthSettingsGithub? github;
  /// A `google` block as defined below.
  final WindowsWebAppAuthSettingsGoogle? google;
  ...
  final WindowsWebAppAuthSettingsMicrosoft? microsoft;
  ...
  final WindowsWebAppAuthSettingsTwitter? twitter;
  ...
  factory WindowsWebAppAuthSettings.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettings(
      activeDirectory: map['activeDirectory'] == null ? null : WindowsWebAppAuthSettingsActiveDirectory.fromMap((map['activeDirectory'] as Map).cast<String, dynamic>()),
      ...
      facebook: map['facebook'] == null ? null : WindowsWebAppAuthSettingsFacebook.fromMap((map['facebook'] as Map).cast<String, dynamic>()),
      github: map['github'] == null ? null : WindowsWebAppAuthSettingsGithub.fromMap((map['github'] as Map).cast<String, dynamic>()),
      google: map['google'] == null ? null : WindowsWebAppAuthSettingsGoogle.fromMap((map['google'] as Map).cast<String, dynamic>()),
      issuer: map['issuer'] == null ? null : map['issuer'] as String,
      microsoft: map['microsoft'] == null ? null : WindowsWebAppAuthSettingsMicrosoft.fromMap((map['microsoft'] as Map).cast<String, dynamic>()),
      ...
      twitter: map['twitter'] == null ? null : WindowsWebAppAuthSettingsTwitter.fromMap((map['twitter'] as Map).cast<String, dynamic>()),
