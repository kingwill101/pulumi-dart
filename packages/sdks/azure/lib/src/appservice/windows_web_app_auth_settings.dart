...
class WindowsWebAppAuthSettings {
  ...
  factory WindowsWebAppAuthSettings.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettings(
      activeDirectory: map['activeDirectory'] == null ? null : (WindowsWebAppAuthSettingsActiveDirectory.fromMap((map['activeDirectory'] as Map).cast<String, dynamic>())).input(),
      ...
      facebook: map['facebook'] == null ? null : (WindowsWebAppAuthSettingsFacebook.fromMap((map['facebook'] as Map).cast<String, dynamic>())).input(),
      github: map['github'] == null ? null : (WindowsWebAppAuthSettingsGithub.fromMap((map['github'] as Map).cast<String, dynamic>())).input(),
      google: map['google'] == null ? null : (WindowsWebAppAuthSettingsGoogle.fromMap((map['google'] as Map).cast<String, dynamic>())).input(),
      issuer: map['issuer'] == null ? null : (map['issuer'] as String).input(),
      microsoft: map['microsoft'] == null ? null : (WindowsWebAppAuthSettingsMicrosoft.fromMap((map['microsoft'] as Map).cast<String, dynamic>())).input(),
      ...
      twitter: map['twitter'] == null ? null : (WindowsWebAppAuthSettingsTwitter.fromMap((map['twitter'] as Map).cast<String, dynamic>())).input(),
