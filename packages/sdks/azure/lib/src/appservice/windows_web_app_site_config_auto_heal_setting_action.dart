...
class WindowsWebAppSiteConfigAutoHealSettingAction {
  ...
  final pulumi.Input<WindowsWebAppSiteConfigAutoHealSettingActionCustomAction>?
  customAction;
  ...
  factory WindowsWebAppSiteConfigAutoHealSettingAction.fromMap(
    ...
    return WindowsWebAppSiteConfigAutoHealSettingAction(
      ...
      customAction: (() {
        ...
        return pulumi.Input.fromValue(
          WindowsWebAppSiteConfigAutoHealSettingActionCustomAction.fromMap(
