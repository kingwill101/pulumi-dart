...
class GetLinuxFunctionAppAuthSettingsV2MicrosoftV2 {
  ...
  /// Creates a new [GetLinuxFunctionAppAuthSettingsV2MicrosoftV2].
  ...
  const GetLinuxFunctionAppAuthSettingsV2MicrosoftV2({
  ...
  factory GetLinuxFunctionAppAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppAuthSettingsV2MicrosoftV2(
