...
class WindowsFunctionAppSiteConfigIpRestriction {
  ...
  final WindowsFunctionAppSiteConfigIpRestrictionHeaders? headers;
  ...
  factory WindowsFunctionAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : WindowsFunctionAppSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
