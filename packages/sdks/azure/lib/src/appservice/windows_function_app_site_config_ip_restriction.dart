...
import 'windows_function_app_site_config_ip_restriction_headers.dart';
...
class WindowsFunctionAppSiteConfigIpRestriction {
  ...
  const WindowsFunctionAppSiteConfigIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  factory WindowsFunctionAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSiteConfigIpRestriction(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsFunctionAppSiteConfigIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
