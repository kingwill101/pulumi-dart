...
class WindowsFunctionAppIdentity {
  ...
  /// Creates a new [WindowsFunctionAppIdentity].
  /// [identityIds] A list of User Assigned Managed Identity IDs to be assigned to this Windows Function App.
  ...
  factory WindowsFunctionAppIdentity.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppIdentity(
      identityIds: (() {
