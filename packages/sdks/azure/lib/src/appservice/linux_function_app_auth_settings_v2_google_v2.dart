...
class LinuxFunctionAppAuthSettingsV2GoogleV2 {
  ...
  /// Creates a new [LinuxFunctionAppAuthSettingsV2GoogleV2].
  ...
  const LinuxFunctionAppAuthSettingsV2GoogleV2({
  ...
  factory LinuxFunctionAppAuthSettingsV2GoogleV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppAuthSettingsV2GoogleV2(
