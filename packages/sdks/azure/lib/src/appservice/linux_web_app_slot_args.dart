...
class LinuxWebAppSlotArgs {
  ...
  LinuxWebAppSlotArgs({
    ...
    required pulumi.Output<LinuxWebAppSlotSiteConfig> siteConfig,
  ...
  factory LinuxWebAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotArgs(
      ...
      siteConfig: pulumi.Output.create<LinuxWebAppSlotSiteConfig>(LinuxWebAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
