...
class LinuxWebAppSlotArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectionStrings':
          ?pulumi.Input.mapOptionalInputValue<
            List<LinuxWebAppSlotConnectionString>,
      ...
      'storageAccounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<LinuxWebAppSlotStorageAccount>,
            List<Map<String, dynamic>>
          >(
            storageAccounts,
            (value) =>
  ...
  factory LinuxWebAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSlotArgs(
      ...
      authSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinuxWebAppSlotAuthSettings.fromMap(
      ...
      authSettingsV2: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinuxWebAppSlotAuthSettingsV2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      connectionStrings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LinuxWebAppSlotConnectionString>(
            guardedValue,
            (value) => LinuxWebAppSlotConnectionString.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinuxWebAppSlotIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      siteConfig: pulumi.Input.fromValue(
        LinuxWebAppSlotSiteConfig.fromMap(
      ...
      storageAccounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LinuxWebAppSlotStorageAccount>(
            guardedValue,
            (value) => LinuxWebAppSlotStorageAccount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
