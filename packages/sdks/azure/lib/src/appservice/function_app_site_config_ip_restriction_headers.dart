...
class FunctionAppSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [FunctionAppSiteConfigIpRestrictionHeaders].
  ...
  const FunctionAppSiteConfigIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory FunctionAppSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return FunctionAppSiteConfigIpRestrictionHeaders(
