...
class EnvironmentV3State {
  ...
  factory EnvironmentV3State.fromMap(Map<String, dynamic> map) {
    return EnvironmentV3State(
      ...
      windowsOutboundIpAddresses: (() { final guardedValue = map['windowsOutboundIpAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
