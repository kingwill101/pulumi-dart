...
class LinuxFunctionAppSlotAuthSettingsV2GoogleV2 {
  ...
  /// Creates a new [LinuxFunctionAppSlotAuthSettingsV2GoogleV2].
  ...
  const LinuxFunctionAppSlotAuthSettingsV2GoogleV2({
  ...
  factory LinuxFunctionAppSlotAuthSettingsV2GoogleV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotAuthSettingsV2GoogleV2(
