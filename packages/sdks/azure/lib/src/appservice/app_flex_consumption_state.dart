...
class AppFlexConsumptionState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'siteCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppFlexConsumptionSiteCredential>,
            List<Map<String, dynamic>>
          >(
            siteCredentials,
            (value) =>
  ...
  factory AppFlexConsumptionState.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionState(
      ...
      siteCredentials: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppFlexConsumptionSiteCredential>(
            guardedValue,
            (value) => AppFlexConsumptionSiteCredential.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      storageAuthenticationType: (() {
        final guardedValue = map['storageAuthenticationType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageContainerEndpoint: (() {
        final guardedValue = map['storageContainerEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageContainerType: (() {
        final guardedValue = map['storageContainerType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
