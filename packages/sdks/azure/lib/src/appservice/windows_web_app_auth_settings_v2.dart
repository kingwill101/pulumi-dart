...
import 'windows_web_app_auth_settings_v2_active_directory_v2.dart';
import 'windows_web_app_auth_settings_v2_apple_v2.dart';
import 'windows_web_app_auth_settings_v2_azure_static_web_app_v2.dart';
import 'windows_web_app_auth_settings_v2_custom_oidc_v2.dart';
import 'windows_web_app_auth_settings_v2_facebook_v2.dart';
import 'windows_web_app_auth_settings_v2_github_v2.dart';
import 'windows_web_app_auth_settings_v2_google_v2.dart';
import 'windows_web_app_auth_settings_v2_login.dart';
import 'windows_web_app_auth_settings_v2_microsoft_v2.dart';
...
class WindowsWebAppAuthSettingsV2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeDirectoryV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2ActiveDirectoryV2, Map<String, dynamic>>(activeDirectoryV2, (value) => value.toMap()),
      'appleV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2AppleV2, Map<String, dynamic>>(appleV2, (value) => value.toMap()),
      'authEnabled': ?authEnabled,
      'azureStaticWebAppV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2AzureStaticWebAppV2, Map<String, dynamic>>(azureStaticWebAppV2, (value) => value.toMap()),
      'configFilePath': ?configFilePath,
      'customOidcV2s': ?pulumi.Input.mapOptionalInputValue<List<WindowsWebAppAuthSettingsV2CustomOidcV2>, List<Map<String, dynamic>>>(customOidcV2s, (value) => pulumi.Input.encodeList<WindowsWebAppAuthSettingsV2CustomOidcV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'defaultProvider': ?defaultProvider,
      'excludedPaths': ?excludedPaths,
      'facebookV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2FacebookV2, Map<String, dynamic>>(facebookV2, (value) => value.toMap()),
      ...
      'githubV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2GithubV2, Map<String, dynamic>>(githubV2, (value) => value.toMap()),
      'googleV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2GoogleV2, Map<String, dynamic>>(googleV2, (value) => value.toMap()),
      'httpRouteApiPrefix': ?httpRouteApiPrefix,
      'login': pulumi.Input.mapInputValue<WindowsWebAppAuthSettingsV2Login, Map<String, dynamic>>(login, (value) => value.toMap()),
      'microsoftV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2MicrosoftV2, Map<String, dynamic>>(microsoftV2, (value) => value.toMap()),
      'requireAuthentication': ?requireAuthentication,
      'requireHttps': ?requireHttps,
      'runtimeVersion': ?runtimeVersion,
      'twitterV2': ?pulumi.Input.mapOptionalInputValue<WindowsWebAppAuthSettingsV2TwitterV2, Map<String, dynamic>>(twitterV2, (value) => value.toMap()),
      'unauthenticatedAction': ?unauthenticatedAction,
    };
  }

  factory WindowsWebAppAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettingsV2(
      activeDirectoryV2: (() { final guardedValue = map['activeDirectoryV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2ActiveDirectoryV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      appleV2: (() { final guardedValue = map['appleV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2AppleV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      azureStaticWebAppV2: (() { final guardedValue = map['azureStaticWebAppV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2AzureStaticWebAppV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      customOidcV2s: (() { final guardedValue = map['customOidcV2s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WindowsWebAppAuthSettingsV2CustomOidcV2>(guardedValue, (value) => WindowsWebAppAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      facebookV2: (() { final guardedValue = map['facebookV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2FacebookV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      githubV2: (() { final guardedValue = map['githubV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2GithubV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      googleV2: (() { final guardedValue = map['googleV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2GoogleV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      login: pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2Login.fromMap((map['login']! as Map).cast<String, dynamic>())),
      microsoftV2: (() { final guardedValue = map['microsoftV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2MicrosoftV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      twitterV2: (() { final guardedValue = map['twitterV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppAuthSettingsV2TwitterV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
