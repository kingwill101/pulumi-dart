...
class LinuxWebAppSiteConfigAutoHealSetting {
  ...
  factory LinuxWebAppSiteConfigAutoHealSetting.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSiteConfigAutoHealSetting(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSiteConfigAutoHealSettingAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      trigger: (() { final guardedValue = map['trigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxWebAppSiteConfigAutoHealSettingTrigger.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
