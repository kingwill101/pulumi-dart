...
class LinuxWebAppSiteConfigAutoHealSetting {
  ...
  LinuxWebAppSiteConfigAutoHealSetting({this.action, this.trigger});
  ...
  factory LinuxWebAppSiteConfigAutoHealSetting.fromMap(
    ...
    return LinuxWebAppSiteConfigAutoHealSetting(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          LinuxWebAppSiteConfigAutoHealSettingAction.fromMap(
      ...
      trigger: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LinuxWebAppSiteConfigAutoHealSettingTrigger.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
