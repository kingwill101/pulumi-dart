...
class FunctionAppSlotSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [FunctionAppSlotSiteConfigScmIpRestrictionHeaders].
  ...
  const FunctionAppSlotSiteConfigScmIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory FunctionAppSlotSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotSiteConfigScmIpRestrictionHeaders(
