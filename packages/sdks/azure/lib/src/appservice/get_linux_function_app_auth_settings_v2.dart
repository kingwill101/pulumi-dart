...
class GetLinuxFunctionAppAuthSettingsV2 {
  ...
  final List<GetLinuxFunctionAppAuthSettingsV2ActiveDirectoryV2> activeDirectoryV2s;
  /// An `apple_v2` block as defined below.
  final List<GetLinuxFunctionAppAuthSettingsV2AppleV2> appleV2s;
  /// Are the AuthV2 Settings enabled.
  final bool authEnabled;
  /// An `azure_static_web_app_v2` block as defined below.
  final List<GetLinuxFunctionAppAuthSettingsV2AzureStaticWebAppV2> azureStaticWebAppV2s;
  /// The path to the App Auth settings.
  final String configFilePath;
  /// Zero or more `custom_oidc_v2` blocks as defined below.
  final List<GetLinuxFunctionAppAuthSettingsV2CustomOidcV2> customOidcV2s;
  ...
  final List<GetLinuxFunctionAppAuthSettingsV2FacebookV2> facebookV2s;
  ...
  final List<GetLinuxFunctionAppAuthSettingsV2GithubV2> githubV2s;
  /// A `google_v2` block as defined below.
  final List<GetLinuxFunctionAppAuthSettingsV2GoogleV2> googleV2s;
  /// The prefix that should precede all the authentication and authorisation paths.
  final String httpRouteApiPrefix;
  /// A `login` block as defined below.
  final List<GetLinuxFunctionAppAuthSettingsV2Login> logins;
  /// A `microsoft_v2` block as defined below.
  final List<GetLinuxFunctionAppAuthSettingsV2MicrosoftV2> microsoftV2s;
  ...
  final List<GetLinuxFunctionAppAuthSettingsV2TwitterV2> twitterV2s;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeDirectoryV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2ActiveDirectoryV2, Map<String, dynamic>>(activeDirectoryV2s, (value) => value.toMap()),
      'appleV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2AppleV2, Map<String, dynamic>>(appleV2s, (value) => value.toMap()),
      'authEnabled': authEnabled,
      'azureStaticWebAppV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2AzureStaticWebAppV2, Map<String, dynamic>>(azureStaticWebAppV2s, (value) => value.toMap()),
      'configFilePath': configFilePath,
      'customOidcV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2CustomOidcV2, Map<String, dynamic>>(customOidcV2s, (value) => value.toMap()),
      'defaultProvider': defaultProvider,
      'excludedPaths': excludedPaths,
      'facebookV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2FacebookV2, Map<String, dynamic>>(facebookV2s, (value) => value.toMap()),
      ...
      'githubV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2GithubV2, Map<String, dynamic>>(githubV2s, (value) => value.toMap()),
      'googleV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2GoogleV2, Map<String, dynamic>>(googleV2s, (value) => value.toMap()),
      'httpRouteApiPrefix': httpRouteApiPrefix,
      'logins': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2Login, Map<String, dynamic>>(logins, (value) => value.toMap()),
      'microsoftV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2MicrosoftV2, Map<String, dynamic>>(microsoftV2s, (value) => value.toMap()),
      'requireAuthentication': requireAuthentication,
      'requireHttps': requireHttps,
      'runtimeVersion': runtimeVersion,
      'twitterV2s': pulumi.Input.encodeList<GetLinuxFunctionAppAuthSettingsV2TwitterV2, Map<String, dynamic>>(twitterV2s, (value) => value.toMap()),
  ...
  factory GetLinuxFunctionAppAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppAuthSettingsV2(
      activeDirectoryV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2ActiveDirectoryV2>(map['activeDirectoryV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2ActiveDirectoryV2.fromMap((value as Map).cast<String, dynamic>())),
      appleV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2AppleV2>(map['appleV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2AppleV2.fromMap((value as Map).cast<String, dynamic>())),
      authEnabled: map['authEnabled'] as bool,
      azureStaticWebAppV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2AzureStaticWebAppV2>(map['azureStaticWebAppV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2AzureStaticWebAppV2.fromMap((value as Map).cast<String, dynamic>())),
      configFilePath: map['configFilePath'] as String,
      customOidcV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2CustomOidcV2>(map['customOidcV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>())),
      defaultProvider: map['defaultProvider'] as String,
      excludedPaths: (map['excludedPaths'] as List).cast<String>(),
      facebookV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2FacebookV2>(map['facebookV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2FacebookV2.fromMap((value as Map).cast<String, dynamic>())),
      ...
      githubV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2GithubV2>(map['githubV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2GithubV2.fromMap((value as Map).cast<String, dynamic>())),
      googleV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2GoogleV2>(map['googleV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2GoogleV2.fromMap((value as Map).cast<String, dynamic>())),
      httpRouteApiPrefix: map['httpRouteApiPrefix'] as String,
      logins: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2Login>(map['logins'], (value) => GetLinuxFunctionAppAuthSettingsV2Login.fromMap((value as Map).cast<String, dynamic>())),
      microsoftV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2MicrosoftV2>(map['microsoftV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2MicrosoftV2.fromMap((value as Map).cast<String, dynamic>())),
      requireAuthentication: map['requireAuthentication'] as bool,
      requireHttps: map['requireHttps'] as bool,
      runtimeVersion: map['runtimeVersion'] as String,
      twitterV2s: pulumi.Input.decodeList<GetLinuxFunctionAppAuthSettingsV2TwitterV2>(map['twitterV2s'], (value) => GetLinuxFunctionAppAuthSettingsV2TwitterV2.fromMap((value as Map).cast<String, dynamic>())),
