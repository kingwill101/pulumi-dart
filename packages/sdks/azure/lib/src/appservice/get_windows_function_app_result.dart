...
import 'get_windows_function_app_auth_setting.dart';
import 'get_windows_function_app_auth_settings_v2.dart';
import 'get_windows_function_app_backup.dart';
import 'get_windows_function_app_connection_string.dart';
import 'get_windows_function_app_identity.dart';
import 'get_windows_function_app_site_config.dart';
import 'get_windows_function_app_site_credential.dart';
import 'get_windows_function_app_sticky_setting.dart';

/// Result data returned by getWindowsFunctionApp.
class GetWindowsFunctionAppResult {
  ...
  final List<GetWindowsFunctionAppIdentity>? identities;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authSettings': ?(() { final guardedValue = authSettings; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppAuthSetting, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'authSettingsV2s': ?(() { final guardedValue = authSettingsV2s; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppAuthSettingsV2, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'backups': ?(() { final guardedValue = backups; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppBackup, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'connectionStrings': ?(() { final guardedValue = connectionStrings; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppConnectionString, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'httpsOnly': ?httpsOnly,
      'id': ?id,
      'identities': ?(() { final guardedValue = identities; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppIdentity, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'kind': ?kind,
      'location': ?location,
      'name': ?name,
      ...
      'siteConfigs': ?(() { final guardedValue = siteConfigs; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppSiteConfig, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'siteCredentials': ?(() { final guardedValue = siteCredentials; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppSiteCredential, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'stickySettings': ?(() { final guardedValue = stickySettings; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWindowsFunctionAppStickySetting, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetWindowsFunctionAppResult.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppResult(
      ...
      authSettings: (() { final guardedValue = map['authSettings']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppAuthSetting>(guardedValue, (value) => GetWindowsFunctionAppAuthSetting.fromMap((value as Map).cast<String, dynamic>())); })(),
      authSettingsV2s: (() { final guardedValue = map['authSettingsV2s']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingsV2>(guardedValue, (value) => GetWindowsFunctionAppAuthSettingsV2.fromMap((value as Map).cast<String, dynamic>())); })(),
      backups: (() { final guardedValue = map['backups']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppBackup>(guardedValue, (value) => GetWindowsFunctionAppBackup.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      connectionStrings: (() { final guardedValue = map['connectionStrings']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppConnectionString>(guardedValue, (value) => GetWindowsFunctionAppConnectionString.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      identities: (() { final guardedValue = map['identities']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppIdentity>(guardedValue, (value) => GetWindowsFunctionAppIdentity.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      siteConfigs: (() { final guardedValue = map['siteConfigs']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfig>(guardedValue, (value) => GetWindowsFunctionAppSiteConfig.fromMap((value as Map).cast<String, dynamic>())); })(),
      siteCredentials: (() { final guardedValue = map['siteCredentials']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppSiteCredential>(guardedValue, (value) => GetWindowsFunctionAppSiteCredential.fromMap((value as Map).cast<String, dynamic>())); })(),
      stickySettings: (() { final guardedValue = map['stickySettings']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWindowsFunctionAppStickySetting>(guardedValue, (value) => GetWindowsFunctionAppStickySetting.fromMap((value as Map).cast<String, dynamic>())); })(),
