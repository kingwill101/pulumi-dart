...
class GetWindowsFunctionAppResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authSettings': pulumi.Input.encodeList<GetWindowsFunctionAppAuthSetting, Map<String, dynamic>>(authSettings, (value) => value.toMap()),
      'authSettingsV2s': pulumi.Input.encodeList<GetWindowsFunctionAppAuthSettingsV2, Map<String, dynamic>>(authSettingsV2s, (value) => value.toMap()),
      'backups': pulumi.Input.encodeList<GetWindowsFunctionAppBackup, Map<String, dynamic>>(backups, (value) => value.toMap()),
      ...
      'connectionStrings': pulumi.Input.encodeList<GetWindowsFunctionAppConnectionString, Map<String, dynamic>>(connectionStrings, (value) => value.toMap()),
      ...
      'httpsOnly': httpsOnly,
      'id': id,
      'identities': pulumi.Input.encodeList<GetWindowsFunctionAppIdentity, Map<String, dynamic>>(identities, (value) => value.toMap()),
      'kind': kind,
      'location': location,
      'name': name,
      ...
      'siteConfigs': pulumi.Input.encodeList<GetWindowsFunctionAppSiteConfig, Map<String, dynamic>>(siteConfigs, (value) => value.toMap()),
      'siteCredentials': pulumi.Input.encodeList<GetWindowsFunctionAppSiteCredential, Map<String, dynamic>>(siteCredentials, (value) => value.toMap()),
      'stickySettings': pulumi.Input.encodeList<GetWindowsFunctionAppStickySetting, Map<String, dynamic>>(stickySettings, (value) => value.toMap()),
  ...
  factory GetWindowsFunctionAppResult.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppResult(
      ...
      authSettings: pulumi.Input.decodeList<GetWindowsFunctionAppAuthSetting>(map['authSettings']!, (value) => GetWindowsFunctionAppAuthSetting.fromMap((value as Map).cast<String, dynamic>())),
      authSettingsV2s: pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingsV2>(map['authSettingsV2s']!, (value) => GetWindowsFunctionAppAuthSettingsV2.fromMap((value as Map).cast<String, dynamic>())),
      backups: pulumi.Input.decodeList<GetWindowsFunctionAppBackup>(map['backups']!, (value) => GetWindowsFunctionAppBackup.fromMap((value as Map).cast<String, dynamic>())),
      ...
      connectionStrings: pulumi.Input.decodeList<GetWindowsFunctionAppConnectionString>(map['connectionStrings']!, (value) => GetWindowsFunctionAppConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      ...
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetWindowsFunctionAppIdentity>(map['identities']!, (value) => GetWindowsFunctionAppIdentity.fromMap((value as Map).cast<String, dynamic>())),
      ...
      siteConfigs: pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfig>(map['siteConfigs']!, (value) => GetWindowsFunctionAppSiteConfig.fromMap((value as Map).cast<String, dynamic>())),
      siteCredentials: pulumi.Input.decodeList<GetWindowsFunctionAppSiteCredential>(map['siteCredentials']!, (value) => GetWindowsFunctionAppSiteCredential.fromMap((value as Map).cast<String, dynamic>())),
      stickySettings: pulumi.Input.decodeList<GetWindowsFunctionAppStickySetting>(map['stickySettings']!, (value) => GetWindowsFunctionAppStickySetting.fromMap((value as Map).cast<String, dynamic>())),
