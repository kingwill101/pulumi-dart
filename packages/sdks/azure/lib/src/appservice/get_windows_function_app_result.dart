...
class GetWindowsFunctionAppResult {
  ...
  factory GetWindowsFunctionAppResult.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppResult(
      ...
      authSettings: pulumi.Input.decodeList<GetWindowsFunctionAppAuthSetting>(
        map['authSettings']!,
        (value) => GetWindowsFunctionAppAuthSetting.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      authSettingsV2s:
          pulumi.Input.decodeList<GetWindowsFunctionAppAuthSettingsV2>(
            map['authSettingsV2s']!,
            (value) => GetWindowsFunctionAppAuthSettingsV2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      backups: pulumi.Input.decodeList<GetWindowsFunctionAppBackup>(
        map['backups']!,
        (value) => GetWindowsFunctionAppBackup.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      connectionStrings:
          pulumi.Input.decodeList<GetWindowsFunctionAppConnectionString>(
            map['connectionStrings']!,
            (value) => GetWindowsFunctionAppConnectionString.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetWindowsFunctionAppIdentity>(
        map['identities']!,
        (value) => GetWindowsFunctionAppIdentity.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      siteConfigs: pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfig>(
        map['siteConfigs']!,
        (value) => GetWindowsFunctionAppSiteConfig.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      siteCredentials:
          pulumi.Input.decodeList<GetWindowsFunctionAppSiteCredential>(
            map['siteCredentials']!,
            (value) => GetWindowsFunctionAppSiteCredential.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      stickySettings:
          pulumi.Input.decodeList<GetWindowsFunctionAppStickySetting>(
            map['stickySettings']!,
            (value) => GetWindowsFunctionAppStickySetting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
