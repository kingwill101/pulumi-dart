...
class AppFlexConsumptionAuthSettingsV2FacebookV2 {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsV2FacebookV2].
  ...
  const AppFlexConsumptionAuthSettingsV2FacebookV2({
    required this.appId,
  ...
  factory AppFlexConsumptionAuthSettingsV2FacebookV2.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsV2FacebookV2(
