...
class LinuxFunctionAppSlotAuthSettingsV2CustomOidcV2 {
  ...
  /// Creates a new [LinuxFunctionAppSlotAuthSettingsV2CustomOidcV2].
  ...
  const LinuxFunctionAppSlotAuthSettingsV2CustomOidcV2({
  ...
  factory LinuxFunctionAppSlotAuthSettingsV2CustomOidcV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotAuthSettingsV2CustomOidcV2(
