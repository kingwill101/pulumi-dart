...
class SlotSiteConfig {
  ...
  factory SlotSiteConfig.fromMap(Map<String, dynamic> map) {
    return SlotSiteConfig(
      ...
      cors: map['cors'] == null ? null : (SlotSiteConfigCors.fromMap((map['cors'] as Map).cast<String, dynamic>())).input(),
      ...
      ipRestrictions: map['ipRestrictions'] == null ? null : (pulumi.Input.decodeList<SlotSiteConfigIpRestriction>(map['ipRestrictions'], (value) => SlotSiteConfigIpRestriction.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      scmIpRestrictions: map['scmIpRestrictions'] == null ? null : (pulumi.Input.decodeList<SlotSiteConfigScmIpRestriction>(map['scmIpRestrictions'], (value) => SlotSiteConfigScmIpRestriction.fromMap((value as Map).cast<String, dynamic>()))).input(),
