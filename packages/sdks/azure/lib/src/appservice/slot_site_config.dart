...
class SlotSiteConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scmIpRestrictions':
          ?pulumi.Input.mapOptionalInputValue<
            List<SlotSiteConfigScmIpRestriction>,
            List<Map<String, dynamic>>
          >(
            scmIpRestrictions,
            (value) =>
  ...
  factory SlotSiteConfig.fromMap(Map<String, dynamic> map) {
    return SlotSiteConfig(
      ...
      ipRestrictions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SlotSiteConfigIpRestriction>(
            guardedValue,
            (value) => SlotSiteConfigIpRestriction.fromMap(
      ...
      scmIpRestrictions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SlotSiteConfigScmIpRestriction>(
            guardedValue,
            (value) => SlotSiteConfigScmIpRestriction.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
