...
class SlotSiteConfigIpRestriction {
  ...
  final SlotSiteConfigIpRestrictionHeaders? headers;
  ...
  factory SlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return SlotSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : SlotSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
