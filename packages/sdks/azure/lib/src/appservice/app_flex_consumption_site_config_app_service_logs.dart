...
class AppFlexConsumptionSiteConfigAppServiceLogs {
  ...
  factory AppFlexConsumptionSiteConfigAppServiceLogs.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionSiteConfigAppServiceLogs(
      diskQuotaMb: (() { final guardedValue = map['diskQuotaMb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
