...
class LinuxWebAppLogsApplicationLogsAzureBlobStorage {
  ...
  /// Creates a new [LinuxWebAppLogsApplicationLogsAzureBlobStorage].
  ...
  const LinuxWebAppLogsApplicationLogsAzureBlobStorage({
    required this.level,
  ...
  factory LinuxWebAppLogsApplicationLogsAzureBlobStorage.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppLogsApplicationLogsAzureBlobStorage(
