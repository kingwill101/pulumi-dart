...
class FunctionAppSlotAuthSettings {
  ...
  /// [activeDirectory] An `activeDirectory` block as defined below.
  ...
  factory FunctionAppSlotAuthSettings.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotAuthSettings(
      activeDirectory: (() { final guardedValue = map['activeDirectory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAppSlotAuthSettingsActiveDirectory.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      facebook: (() { final guardedValue = map['facebook']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAppSlotAuthSettingsFacebook.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      google: (() { final guardedValue = map['google']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAppSlotAuthSettingsGoogle.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      microsoft: (() { final guardedValue = map['microsoft']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAppSlotAuthSettingsMicrosoft.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      twitter: (() { final guardedValue = map['twitter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAppSlotAuthSettingsTwitter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
