...
class FunctionAppSlotAuthSettings {
  ...
  final pulumi.Input<FunctionAppSlotAuthSettingsActiveDirectory>?
  activeDirectory;
    ...
    return FunctionAppSlotAuthSettings(
      activeDirectory: (() {
        ...
        return pulumi.Input.fromValue(
          FunctionAppSlotAuthSettingsActiveDirectory.fromMap(
      ...
      facebook: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppSlotAuthSettingsFacebook.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      google: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppSlotAuthSettingsGoogle.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      microsoft: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppSlotAuthSettingsMicrosoft.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      twitter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAppSlotAuthSettingsTwitter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
