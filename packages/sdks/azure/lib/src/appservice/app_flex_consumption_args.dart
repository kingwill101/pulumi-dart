...
class AppFlexConsumptionArgs {
  ...
  factory AppFlexConsumptionArgs.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionArgs(
      ...
      siteConfig: pulumi.Input.fromValue(AppFlexConsumptionSiteConfig.fromMap((map['siteConfig']! as Map).cast<String, dynamic>())),
      ...
      storageAuthenticationType: pulumi.Input.fromValue(map['storageAuthenticationType'] as String),
      storageContainerEndpoint: pulumi.Input.fromValue(map['storageContainerEndpoint'] as String),
      storageContainerType: pulumi.Input.fromValue(map['storageContainerType'] as String),
