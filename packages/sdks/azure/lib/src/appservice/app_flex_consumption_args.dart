...
class AppFlexConsumptionArgs {
  ...
  factory AppFlexConsumptionArgs.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionArgs(
      ...
      siteConfig: (AppFlexConsumptionSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      storageAuthenticationType: (map['storageAuthenticationType'] as String).input(),
      storageContainerEndpoint: (map['storageContainerEndpoint'] as String).input(),
      storageContainerType: (map['storageContainerType'] as String).input(),
