...
class AppFlexConsumptionArgs {
  ...
  AppFlexConsumptionArgs({
    ...
    required pulumi.Output<AppFlexConsumptionSiteConfig> siteConfig,
    pulumi.Output<AppFlexConsumptionStickySettings>? stickySettings,
    pulumi.Output<String>? storageAccessKey,
    required pulumi.Output<String> storageAuthenticationType,
    required pulumi.Output<String> storageContainerEndpoint,
    required pulumi.Output<String> storageContainerType,
  ...
  factory AppFlexConsumptionArgs.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionArgs(
      ...
      siteConfig: pulumi.Output.create<AppFlexConsumptionSiteConfig>(AppFlexConsumptionSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
      ...
      storageAuthenticationType: pulumi.Output.create<String>(map['storageAuthenticationType'] as String),
      storageContainerEndpoint: pulumi.Output.create<String>(map['storageContainerEndpoint'] as String),
      storageContainerType: pulumi.Output.create<String>(map['storageContainerType'] as String),
