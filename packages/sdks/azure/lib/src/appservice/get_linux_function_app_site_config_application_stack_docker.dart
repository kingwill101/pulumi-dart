...
class GetLinuxFunctionAppSiteConfigApplicationStackDocker {
  ...
  const GetLinuxFunctionAppSiteConfigApplicationStackDocker({
  ...
  factory GetLinuxFunctionAppSiteConfigApplicationStackDocker.fromMap(Map<String, dynamic> map) {
    return GetLinuxFunctionAppSiteConfigApplicationStackDocker(
      ...
      registryPassword: pulumi.Input.fromValue(map['registryPassword'] as String),
      registryUrl: pulumi.Input.fromValue(map['registryUrl'] as String),
      registryUsername: pulumi.Input.fromValue(map['registryUsername'] as String),
    );
  }
}
