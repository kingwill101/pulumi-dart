...
class LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 {
  ...
  const LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2({
  ...
  factory LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2(
