...
class GetLinuxWebAppSiteConfigIpRestriction {
  ...
  final pulumi.Input<List<GetLinuxWebAppSiteConfigIpRestrictionHeader>> headers;
  ...
  const GetLinuxWebAppSiteConfigIpRestriction({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': pulumi.Input.mapInputValue<List<GetLinuxWebAppSiteConfigIpRestrictionHeader>, List<Map<String, dynamic>>>(headers, (value) => pulumi.Input.encodeList<GetLinuxWebAppSiteConfigIpRestrictionHeader, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ipAddress': ipAddress,
      'name': name,
      'priority': priority,
  ...
  factory GetLinuxWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppSiteConfigIpRestriction(
      ...
      headers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLinuxWebAppSiteConfigIpRestrictionHeader>(map['headers']!, (value) => GetLinuxWebAppSiteConfigIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>()))),
