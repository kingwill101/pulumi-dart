...
class GetLinuxWebAppSiteConfigIpRestriction {
    ...
    return <String, dynamic>{
      ...
      'headers':
          pulumi.Input.mapInputValue<
            List<GetLinuxWebAppSiteConfigIpRestrictionHeader>,
  ...
  factory GetLinuxWebAppSiteConfigIpRestriction.fromMap(
    ...
    return GetLinuxWebAppSiteConfigIpRestriction(
      ...
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinuxWebAppSiteConfigIpRestrictionHeader>(
          map['headers']!,
          (value) => GetLinuxWebAppSiteConfigIpRestrictionHeader.fromMap(
