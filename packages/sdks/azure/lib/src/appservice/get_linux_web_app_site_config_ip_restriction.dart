...
class GetLinuxWebAppSiteConfigIpRestriction {
  ...
  factory GetLinuxWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetLinuxWebAppSiteConfigIpRestriction(
      ...
      headers: (pulumi.Input.decodeList<GetLinuxWebAppSiteConfigIpRestrictionHeader>(map['headers'], (value) => GetLinuxWebAppSiteConfigIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
