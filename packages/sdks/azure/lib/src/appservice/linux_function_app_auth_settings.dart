...
class LinuxFunctionAppAuthSettings {
  ...
  final LinuxFunctionAppAuthSettingsActiveDirectory? activeDirectory;
  ...
  final LinuxFunctionAppAuthSettingsFacebook? facebook;
  /// A `github` block as defined below.
  final LinuxFunctionAppAuthSettingsGithub? github;
  /// A `google` block as defined below.
  final LinuxFunctionAppAuthSettingsGoogle? google;
  /// The OpenID Connect Issuer URI that represents the entity which issues access tokens for this Linux Web App.
  ///
  /// > **Note:** When using Azure Active Directory, this value is the URI of the directory tenant, e.g. <https://sts.windows.net/{tenant-guid}/>.
  final String? issuer;
  /// A `microsoft` block as defined below.
  final LinuxFunctionAppAuthSettingsMicrosoft? microsoft;
  ...
  final LinuxFunctionAppAuthSettingsTwitter? twitter;
  ...
  factory LinuxFunctionAppAuthSettings.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppAuthSettings(
      activeDirectory: map['activeDirectory'] == null ? null : LinuxFunctionAppAuthSettingsActiveDirectory.fromMap((map['activeDirectory'] as Map).cast<String, dynamic>()),
      ...
      facebook: map['facebook'] == null ? null : LinuxFunctionAppAuthSettingsFacebook.fromMap((map['facebook'] as Map).cast<String, dynamic>()),
      github: map['github'] == null ? null : LinuxFunctionAppAuthSettingsGithub.fromMap((map['github'] as Map).cast<String, dynamic>()),
      google: map['google'] == null ? null : LinuxFunctionAppAuthSettingsGoogle.fromMap((map['google'] as Map).cast<String, dynamic>()),
      issuer: map['issuer'] == null ? null : map['issuer'] as String,
      microsoft: map['microsoft'] == null ? null : LinuxFunctionAppAuthSettingsMicrosoft.fromMap((map['microsoft'] as Map).cast<String, dynamic>()),
      ...
      twitter: map['twitter'] == null ? null : LinuxFunctionAppAuthSettingsTwitter.fromMap((map['twitter'] as Map).cast<String, dynamic>()),
