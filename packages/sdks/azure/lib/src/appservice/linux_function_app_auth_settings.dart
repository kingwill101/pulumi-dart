...
class LinuxFunctionAppAuthSettings {
  ...
  const LinuxFunctionAppAuthSettings({
  ...
  factory LinuxFunctionAppAuthSettings.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppAuthSettings(
      activeDirectory: (() { final guardedValue = map['activeDirectory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppAuthSettingsActiveDirectory.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      facebook: (() { final guardedValue = map['facebook']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppAuthSettingsFacebook.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      github: (() { final guardedValue = map['github']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppAuthSettingsGithub.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      google: (() { final guardedValue = map['google']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppAuthSettingsGoogle.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
