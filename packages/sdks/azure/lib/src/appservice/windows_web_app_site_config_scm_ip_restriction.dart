...
class WindowsWebAppSiteConfigScmIpRestriction {
  ...
  const WindowsWebAppSiteConfigScmIpRestriction({
    this.action,
    this.description,
    this.headers,
    this.ipAddress,
  ...
  factory WindowsWebAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSiteConfigScmIpRestriction(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsWebAppSiteConfigScmIpRestrictionHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
