...
class GetWindowsFunctionAppSiteConfigIpRestriction {
  ...
  final pulumi.Input<List<GetWindowsFunctionAppSiteConfigIpRestrictionHeader>>
  headers;
    ...
    return <String, dynamic>{
      ...
      'headers':
          pulumi.Input.mapInputValue<
            List<GetWindowsFunctionAppSiteConfigIpRestrictionHeader>,
  ...
  factory GetWindowsFunctionAppSiteConfigIpRestriction.fromMap(
    ...
    return GetWindowsFunctionAppSiteConfigIpRestriction(
      ...
      headers: pulumi.Input.fromValue(
        ...
        >(
          map['headers']!,
          (value) => GetWindowsFunctionAppSiteConfigIpRestrictionHeader.fromMap(
