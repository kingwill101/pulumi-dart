...
class GetWindowsFunctionAppSiteConfigIpRestriction {
  ...
  factory GetWindowsFunctionAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppSiteConfigIpRestriction(
      ...
      headers: (pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigIpRestrictionHeader>(map['headers'], (value) => GetWindowsFunctionAppSiteConfigIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
