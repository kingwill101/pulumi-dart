...
class FunctionAppSlotSiteConfig {
  ...
  final pulumi.Input<List<FunctionAppSlotSiteConfigIpRestriction>>?
  ipRestrictions;
  ...
  final pulumi.Input<List<FunctionAppSlotSiteConfigScmIpRestriction>>?
  scmIpRestrictions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipRestrictions':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionAppSlotSiteConfigIpRestriction>,
      ...
      'scmIpRestrictions':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionAppSlotSiteConfigScmIpRestriction>,
            List<Map<String, dynamic>>
          >(
            scmIpRestrictions,
            (value) =>
    ...
    return FunctionAppSlotSiteConfig(
      ...
      cors: (() {
        ...
        return pulumi.Input.fromValue(
          FunctionAppSlotSiteConfigCors.fromMap(
      ...
      ipRestrictions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FunctionAppSlotSiteConfigIpRestriction>(
            guardedValue,
            (value) => FunctionAppSlotSiteConfigIpRestriction.fromMap(
      ...
      scmIpRestrictions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FunctionAppSlotSiteConfigScmIpRestriction>(
            guardedValue,
            (value) => FunctionAppSlotSiteConfigScmIpRestriction.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
