...
class CertificateState {
  ...
  factory CertificateState.fromMap(Map<String, dynamic> map) {
    return CertificateState(
      ...
      hostingEnvironmentProfileId: (() { final guardedValue = map['hostingEnvironmentProfileId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
