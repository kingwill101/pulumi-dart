...
class FunctionAppSlotState {
  ...
  factory FunctionAppSlotState.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotState(
      ...
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<FunctionAppSlotSiteCredential>(map['siteCredentials']!, (value) => FunctionAppSlotSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
