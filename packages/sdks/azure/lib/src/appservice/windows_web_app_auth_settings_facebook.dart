...
class WindowsWebAppAuthSettingsFacebook {
  ...
  /// Creates a new [WindowsWebAppAuthSettingsFacebook].
  ...
  const WindowsWebAppAuthSettingsFacebook({
    required this.appId,
    this.appSecret,
  ...
  factory WindowsWebAppAuthSettingsFacebook.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppAuthSettingsFacebook(
