...
class LinuxFunctionAppState {
  ...
  factory LinuxFunctionAppState.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppState(
      ...
      authSettings: map['authSettings'] == null ? null : (LinuxFunctionAppAuthSettings.fromMap((map['authSettings']! as Map).cast<String, dynamic>())).input(),
      authSettingsV2: map['authSettingsV2'] == null ? null : (LinuxFunctionAppAuthSettingsV2.fromMap((map['authSettingsV2']! as Map).cast<String, dynamic>())).input(),
      backup: map['backup'] == null ? null : (LinuxFunctionAppBackup.fromMap((map['backup']! as Map).cast<String, dynamic>())).input(),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : (pulumi.Input.decodeList<LinuxFunctionAppConnectionString>(map['connectionStrings']!, (value) => LinuxFunctionAppConnectionString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      identity: map['identity'] == null ? null : (LinuxFunctionAppIdentity.fromMap((map['identity']! as Map).cast<String, dynamic>())).input(),
      ...
      siteConfig: map['siteConfig'] == null ? null : (LinuxFunctionAppSiteConfig.fromMap((map['siteConfig']! as Map).cast<String, dynamic>())).input(),
      siteCredentials: map['siteCredentials'] == null ? null : (pulumi.Input.decodeList<LinuxFunctionAppSiteCredential>(map['siteCredentials']!, (value) => LinuxFunctionAppSiteCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
      stickySettings: map['stickySettings'] == null ? null : (LinuxFunctionAppStickySettings.fromMap((map['stickySettings']! as Map).cast<String, dynamic>())).input(),
      ...
      storageAccounts: map['storageAccounts'] == null ? null : (pulumi.Input.decodeList<LinuxFunctionAppStorageAccount>(map['storageAccounts']!, (value) => LinuxFunctionAppStorageAccount.fromMap((value as Map).cast<String, dynamic>()))).input(),
