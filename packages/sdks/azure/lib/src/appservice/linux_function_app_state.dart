...
class LinuxFunctionAppState {
  ...
  factory LinuxFunctionAppState.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppState(
      ...
      authSettings: (() { final guardedValue = map['authSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppAuthSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      authSettingsV2: (() { final guardedValue = map['authSettingsV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppAuthSettingsV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      backup: (() { final guardedValue = map['backup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppBackup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      siteConfig: (() { final guardedValue = map['siteConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppSiteConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      siteCredentials: (() { final guardedValue = map['siteCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LinuxFunctionAppSiteCredential>(guardedValue, (value) => LinuxFunctionAppSiteCredential.fromMap((value as Map).cast<String, dynamic>()))); })(),
      stickySettings: (() { final guardedValue = map['stickySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxFunctionAppStickySettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageAccounts: (() { final guardedValue = map['storageAccounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LinuxFunctionAppStorageAccount>(guardedValue, (value) => LinuxFunctionAppStorageAccount.fromMap((value as Map).cast<String, dynamic>()))); })(),
