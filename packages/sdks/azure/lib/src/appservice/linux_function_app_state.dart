...
class LinuxFunctionAppState {
  ...
  LinuxFunctionAppState({
    ...
    pulumi.Output<LinuxFunctionAppAuthSettings>? authSettings,
    pulumi.Output<LinuxFunctionAppAuthSettingsV2>? authSettingsV2,
    pulumi.Output<LinuxFunctionAppBackup>? backup,
    ...
    pulumi.Output<List<LinuxFunctionAppConnectionString>>? connectionStrings,
    ...
    pulumi.Output<LinuxFunctionAppIdentity>? identity,
    ...
    pulumi.Output<LinuxFunctionAppSiteConfig>? siteConfig,
    pulumi.Output<List<LinuxFunctionAppSiteCredential>>? siteCredentials,
    pulumi.Output<LinuxFunctionAppStickySettings>? stickySettings,
    pulumi.Output<String>? storageAccountAccessKey,
    pulumi.Output<String>? storageAccountName,
    pulumi.Output<List<LinuxFunctionAppStorageAccount>>? storageAccounts,
    ...
    pulumi.Output<String>? zipDeployFile,
      ...
      siteConfig = pulumi.Input.asOptionalInput<LinuxFunctionAppSiteConfig>(siteConfig),
      siteCredentials = pulumi.Input.asOptionalInput<List<LinuxFunctionAppSiteCredential>>(siteCredentials),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'siteConfig': ?pulumi.Input.mapOptionalInputValue<LinuxFunctionAppSiteConfig, Map<String, dynamic>>(siteConfig, (value) => value.toMap()),
      'siteCredentials': ?pulumi.Input.mapOptionalInputValue<List<LinuxFunctionAppSiteCredential>, List<Map<String, dynamic>>>(siteCredentials, (value) => pulumi.Input.encodeList<LinuxFunctionAppSiteCredential, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory LinuxFunctionAppState.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppState(
      appSettings: map['appSettings'] == null ? null : pulumi.Output.create<Map<String, String>>((map['appSettings'] as Map).cast<String, String>()),
      authSettings: map['authSettings'] == null ? null : pulumi.Output.create<LinuxFunctionAppAuthSettings>(LinuxFunctionAppAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>())),
      authSettingsV2: map['authSettingsV2'] == null ? null : pulumi.Output.create<LinuxFunctionAppAuthSettingsV2>(LinuxFunctionAppAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>())),
      backup: map['backup'] == null ? null : pulumi.Output.create<LinuxFunctionAppBackup>(LinuxFunctionAppBackup.fromMap((map['backup'] as Map).cast<String, dynamic>())),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Output.create<List<LinuxFunctionAppConnectionString>>(pulumi.Input.decodeList<LinuxFunctionAppConnectionString>(map['connectionStrings'], (value) => LinuxFunctionAppConnectionString.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      identity: map['identity'] == null ? null : pulumi.Output.create<LinuxFunctionAppIdentity>(LinuxFunctionAppIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      siteConfig: map['siteConfig'] == null ? null : pulumi.Output.create<LinuxFunctionAppSiteConfig>(LinuxFunctionAppSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
      siteCredentials: map['siteCredentials'] == null ? null : pulumi.Output.create<List<LinuxFunctionAppSiteCredential>>(pulumi.Input.decodeList<LinuxFunctionAppSiteCredential>(map['siteCredentials'], (value) => LinuxFunctionAppSiteCredential.fromMap((value as Map).cast<String, dynamic>()))),
      stickySettings: map['stickySettings'] == null ? null : pulumi.Output.create<LinuxFunctionAppStickySettings>(LinuxFunctionAppStickySettings.fromMap((map['stickySettings'] as Map).cast<String, dynamic>())),
      ...
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Output.create<List<LinuxFunctionAppStorageAccount>>(pulumi.Input.decodeList<LinuxFunctionAppStorageAccount>(map['storageAccounts'], (value) => LinuxFunctionAppStorageAccount.fromMap((value as Map).cast<String, dynamic>()))),
