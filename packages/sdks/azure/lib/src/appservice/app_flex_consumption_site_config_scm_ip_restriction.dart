...
class AppFlexConsumptionSiteConfigScmIpRestriction {
  ...
  final AppFlexConsumptionSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory AppFlexConsumptionSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : AppFlexConsumptionSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
