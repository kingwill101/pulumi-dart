...
class LinuxWebAppSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [LinuxWebAppSiteConfigScmIpRestrictionHeaders].
  ...
  const LinuxWebAppSiteConfigScmIpRestrictionHeaders({
    this.xAzureFdids,
    this.xFdHealthProbe,
    this.xForwardedFors,
  ...
  factory LinuxWebAppSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppSiteConfigScmIpRestrictionHeaders(
