...
class LinuxWebAppSlotAuthSettingsV2CustomOidcV2 {
  ...
  /// Creates a new [LinuxWebAppSlotAuthSettingsV2CustomOidcV2].
  ...
  factory LinuxWebAppSlotAuthSettingsV2CustomOidcV2.fromMap(
    Map<String, dynamic> map,
  ) {
    return LinuxWebAppSlotAuthSettingsV2CustomOidcV2(
