...
class GetWindowsFunctionAppAuthSettingsV2AppleV2 {
  ...
  /// Creates a new [GetWindowsFunctionAppAuthSettingsV2AppleV2].
  ...
  const GetWindowsFunctionAppAuthSettingsV2AppleV2({
  ...
  factory GetWindowsFunctionAppAuthSettingsV2AppleV2.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppAuthSettingsV2AppleV2(
