...
class ConnectedRegistryState {
  ...
  ConnectedRegistryState({
    ...
    pulumi.Output<String>? syncTokenId,
    pulumi.Output<String>? syncWindow,
      ...
      syncTokenId = pulumi.Input.asOptionalInput<String>(syncTokenId),
  ...
  factory ConnectedRegistryState.fromMap(Map<String, dynamic> map) {
    return ConnectedRegistryState(
      ...
      syncTokenId: map['syncTokenId'] == null ? null : pulumi.Output.create<String>(map['syncTokenId'] as String),
