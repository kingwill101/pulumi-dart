...
/// {@template pulumi_containerservice_registry_webhook_registry_webhook_args_doc}
/// The set of arguments for RegistryWebhook.
/// {@endtemplate}
...
class RegistryWebhookArgs {
  ...
  factory RegistryWebhookArgs.fromMap(Map<String, dynamic> map) {
    return RegistryWebhookArgs(
