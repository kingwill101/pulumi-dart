...
class GetKubernetesClusterOmsAgent {
  ...
  final pulumi.Input<List<GetKubernetesClusterOmsAgentOmsAgentIdentity>>
  omsAgentIdentities;
    ...
    return <String, dynamic>{
      ...
      'omsAgentIdentities':
          pulumi.Input.mapInputValue<
            List<GetKubernetesClusterOmsAgentOmsAgentIdentity>,
  ...
  factory GetKubernetesClusterOmsAgent.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterOmsAgent(
      ...
      msiAuthForMonitoringEnabled: pulumi.Input.fromValue(
        map['msiAuthForMonitoringEnabled'] as bool,
      ),
      omsAgentIdentities: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetKubernetesClusterOmsAgentOmsAgentIdentity>(
          map['omsAgentIdentities']!,
          (value) => GetKubernetesClusterOmsAgentOmsAgentIdentity.fromMap(
