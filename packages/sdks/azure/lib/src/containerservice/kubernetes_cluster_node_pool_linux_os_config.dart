...
class KubernetesClusterNodePoolLinuxOsConfig {
  ...
  final KubernetesClusterNodePoolLinuxOsConfigSysctlConfig? sysctlConfig;
  ...
  factory KubernetesClusterNodePoolLinuxOsConfig.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterNodePoolLinuxOsConfig(
      ...
      sysctlConfig: map['sysctlConfig'] == null ? null : KubernetesClusterNodePoolLinuxOsConfigSysctlConfig.fromMap((map['sysctlConfig'] as Map).cast<String, dynamic>()),
