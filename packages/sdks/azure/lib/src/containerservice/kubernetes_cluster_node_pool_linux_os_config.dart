...
class KubernetesClusterNodePoolLinuxOsConfig {
  ...
  final pulumi.Input<KubernetesClusterNodePoolLinuxOsConfigSysctlConfig>?
  sysctlConfig;
  ...
  factory KubernetesClusterNodePoolLinuxOsConfig.fromMap(
    ...
    return KubernetesClusterNodePoolLinuxOsConfig(
      ...
      sysctlConfig: (() {
        ...
        return pulumi.Input.fromValue(
          KubernetesClusterNodePoolLinuxOsConfigSysctlConfig.fromMap(
