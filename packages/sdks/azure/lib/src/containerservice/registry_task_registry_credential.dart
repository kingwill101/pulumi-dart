...
class RegistryTaskRegistryCredential {
  ...
  RegistryTaskRegistryCredential({this.customs, this.source});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customs':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegistryTaskRegistryCredentialCustom>,
    ...
    return RegistryTaskRegistryCredential(
      customs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegistryTaskRegistryCredentialCustom>(
            guardedValue,
            (value) => RegistryTaskRegistryCredentialCustom.fromMap(
      ...
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegistryTaskRegistryCredentialSource.fromMap(
