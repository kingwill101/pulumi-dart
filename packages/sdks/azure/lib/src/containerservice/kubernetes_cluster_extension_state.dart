...
class KubernetesClusterExtensionState {
  ...
  const KubernetesClusterExtensionState({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aksAssignedIdentities': ?pulumi.Input.mapOptionalInputValue<List<KubernetesClusterExtensionAksAssignedIdentity>, List<Map<String, dynamic>>>(aksAssignedIdentities, (value) => pulumi.Input.encodeList<KubernetesClusterExtensionAksAssignedIdentity, Map<String, dynamic>>(value, (value) => value.toMap())),
      'clusterId': ?clusterId,
  ...
  factory KubernetesClusterExtensionState.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterExtensionState(
      aksAssignedIdentities: (() { final guardedValue = map['aksAssignedIdentities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesClusterExtensionAksAssignedIdentity>(guardedValue, (value) => KubernetesClusterExtensionAksAssignedIdentity.fromMap((value as Map).cast<String, dynamic>()))); })(),
