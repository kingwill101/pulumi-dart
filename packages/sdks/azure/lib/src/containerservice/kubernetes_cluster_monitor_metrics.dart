...
class KubernetesClusterMonitorMetrics {
  ...
  final String? annotationsAllowed;
  ...
  factory KubernetesClusterMonitorMetrics.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterMonitorMetrics(
      annotationsAllowed: map['annotationsAllowed'] == null ? null : map['annotationsAllowed'] as String,
      labelsAllowed: map['labelsAllowed'] == null ? null : map['labelsAllowed'] as String,
    );
  }
}
