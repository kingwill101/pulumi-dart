...
class KubernetesClusterMaintenanceWindowNodeOs {
  ...
  final pulumi.Input<List<KubernetesClusterMaintenanceWindowNodeOsNotAllowed>>?
  notAlloweds;
    ...
    return <String, dynamic>{
      ...
      'notAlloweds':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterMaintenanceWindowNodeOsNotAllowed>,
  ...
  factory KubernetesClusterMaintenanceWindowNodeOs.fromMap(
    ...
    return KubernetesClusterMaintenanceWindowNodeOs(
      ...
      notAlloweds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                KubernetesClusterMaintenanceWindowNodeOsNotAllowed.fromMap(
      ...
      weekIndex: (() {
        final guardedValue = map['weekIndex'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
