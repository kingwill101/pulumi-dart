...
class GroupContainerLivenessProbe {
  ...
  factory GroupContainerLivenessProbe.fromMap(Map<String, dynamic> map) {
    return GroupContainerLivenessProbe(
      ...
      httpGets: (() { final guardedValue = map['httpGets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupContainerLivenessProbeHttpGet>(guardedValue, (value) => GroupContainerLivenessProbeHttpGet.fromMap((value as Map).cast<String, dynamic>()))); })(),
