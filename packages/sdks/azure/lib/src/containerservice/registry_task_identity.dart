...
class RegistryTaskIdentity {
  ...
  /// Creates a new [RegistryTaskIdentity].
  /// [identityIds] Specifies a list of User Assigned Managed Identity IDs to be assigned to this Container Registry Task.
  ...
  factory RegistryTaskIdentity.fromMap(Map<String, dynamic> map) {
    return RegistryTaskIdentity(
