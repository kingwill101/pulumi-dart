...
class GetGroupResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fqdn': fqdn,
      'id': id,
      'identities': pulumi.Input.encodeList<GetGroupIdentity, Map<String, dynamic>>(identities, (value) => value.toMap()),
      'ipAddress': ipAddress,
      'location': location,
      'name': name,
  ...
  factory GetGroupResult.fromMap(Map<String, dynamic> map) {
    return GetGroupResult(
      ...
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetGroupIdentity>(map['identities'], (value) => GetGroupIdentity.fromMap((value as Map).cast<String, dynamic>())),
