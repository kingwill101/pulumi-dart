...
import 'registry_credential_set_state.dart';
...
class RegistryCredentialSet extends pulumi.CustomResource {
  ...
  /// Gets an existing [RegistryCredentialSet] resource's state with the given [name] and [id].
  static RegistryCredentialSet get(
    String name,
