...
class AutomaticClusterIdentity {
  ...
  /// Creates a new [AutomaticClusterIdentity].
  ...
  /// [type] Specifies the type of Managed Service Identity that should be configured on this Kubernetes Cluster. Possible values are `SystemAssigned` or `UserAssigned`.  `UserAssigned` is required for bring your own networking
  const AutomaticClusterIdentity({
    this.identityIds,
    this.principalId,
    this.tenantId,
    required this.type,
  ...
  factory AutomaticClusterIdentity.fromMap(Map<String, dynamic> map) {
    return AutomaticClusterIdentity(
