...
class FleetUpdateRunManagedClusterUpdate {
  ...
  final pulumi.Input<FleetUpdateRunManagedClusterUpdateNodeImageSelection>?
  nodeImageSelection;
    ...
    return FleetUpdateRunManagedClusterUpdate(
      nodeImageSelection: (() {
        ...
        return pulumi.Input.fromValue(
          FleetUpdateRunManagedClusterUpdateNodeImageSelection.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      upgrade: pulumi.Input.fromValue(
        FleetUpdateRunManagedClusterUpdateUpgrade.fromMap(
