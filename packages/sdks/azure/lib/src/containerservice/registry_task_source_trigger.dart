...
class RegistryTaskSourceTrigger {
  ...
  factory RegistryTaskSourceTrigger.fromMap(Map<String, dynamic> map) {
    return RegistryTaskSourceTrigger(
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskSourceTriggerAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
