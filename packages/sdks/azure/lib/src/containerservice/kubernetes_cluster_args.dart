...
class KubernetesClusterArgs {
  ...
  KubernetesClusterArgs({
    pulumi.Output<KubernetesClusterAciConnectorLinux>? aciConnectorLinux,
    pulumi.Output<bool>? aiToolchainOperatorEnabled,
    pulumi.Output<KubernetesClusterApiServerAccessProfile>? apiServerAccessProfile,
    pulumi.Output<KubernetesClusterAutoScalerProfile>? autoScalerProfile,
    pulumi.Output<String>? automaticUpgradeChannel,
    pulumi.Output<KubernetesClusterAzureActiveDirectoryRoleBasedAccessControl>? azureActiveDirectoryRoleBasedAccessControl,
    pulumi.Output<bool>? azurePolicyEnabled,
    pulumi.Output<KubernetesClusterBootstrapProfile>? bootstrapProfile,
    pulumi.Output<KubernetesClusterConfidentialComputing>? confidentialComputing,
    pulumi.Output<bool>? costAnalysisEnabled,
    pulumi.Output<List<String>>? customCaTrustCertificatesBase64s,
    required pulumi.Output<KubernetesClusterDefaultNodePool> defaultNodePool,
    pulumi.Output<String>? diskEncryptionSetId,
    pulumi.Output<String>? dnsPrefix,
    pulumi.Output<String>? dnsPrefixPrivateCluster,
    pulumi.Output<String>? edgeZone,
    pulumi.Output<bool>? httpApplicationRoutingEnabled,
    pulumi.Output<KubernetesClusterHttpProxyConfig>? httpProxyConfig,
    pulumi.Output<KubernetesClusterIdentity>? identity,
    pulumi.Output<bool>? imageCleanerEnabled,
    pulumi.Output<int>? imageCleanerIntervalHours,
    pulumi.Output<KubernetesClusterIngressApplicationGateway>? ingressApplicationGateway,
    pulumi.Output<KubernetesClusterKeyManagementService>? keyManagementService,
    pulumi.Output<KubernetesClusterKeyVaultSecretsProvider>? keyVaultSecretsProvider,
    pulumi.Output<KubernetesClusterKubeletIdentity>? kubeletIdentity,
    pulumi.Output<String>? kubernetesVersion,
    pulumi.Output<KubernetesClusterLinuxProfile>? linuxProfile,
    pulumi.Output<bool>? localAccountDisabled,
    pulumi.Output<String>? location,
    pulumi.Output<KubernetesClusterMaintenanceWindow>? maintenanceWindow,
    pulumi.Output<KubernetesClusterMaintenanceWindowAutoUpgrade>? maintenanceWindowAutoUpgrade,
    pulumi.Output<KubernetesClusterMaintenanceWindowNodeOs>? maintenanceWindowNodeOs,
    pulumi.Output<KubernetesClusterMicrosoftDefender>? microsoftDefender,
    pulumi.Output<KubernetesClusterMonitorMetrics>? monitorMetrics,
    pulumi.Output<String>? name,
    pulumi.Output<KubernetesClusterNetworkProfile>? networkProfile,
    pulumi.Output<String>? nodeOsUpgradeChannel,
    pulumi.Output<KubernetesClusterNodeProvisioningProfile>? nodeProvisioningProfile,
    pulumi.Output<String>? nodeResourceGroup,
    pulumi.Output<bool>? oidcIssuerEnabled,
    pulumi.Output<KubernetesClusterOmsAgent>? omsAgent,
    pulumi.Output<bool>? openServiceMeshEnabled,
    pulumi.Output<bool>? privateClusterEnabled,
    pulumi.Output<bool>? privateClusterPublicFqdnEnabled,
    pulumi.Output<String>? privateDnsZoneId,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<bool>? roleBasedAccessControlEnabled,
    pulumi.Output<bool>? runCommandEnabled,
    pulumi.Output<KubernetesClusterServiceMeshProfile>? serviceMeshProfile,
    pulumi.Output<KubernetesClusterServicePrincipal>? servicePrincipal,
    pulumi.Output<String>? skuTier,
    pulumi.Output<KubernetesClusterStorageProfile>? storageProfile,
    pulumi.Output<String>? supportPlan,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<KubernetesClusterUpgradeOverride>? upgradeOverride,
    pulumi.Output<KubernetesClusterWebAppRouting>? webAppRouting,
    pulumi.Output<KubernetesClusterWindowsProfile>? windowsProfile,
    pulumi.Output<KubernetesClusterWorkloadAutoscalerProfile>? workloadAutoscalerProfile,
    pulumi.Output<bool>? workloadIdentityEnabled,
  }) :
      aciConnectorLinux = pulumi.Input.asOptionalInput<KubernetesClusterAciConnectorLinux>(aciConnectorLinux),
      aiToolchainOperatorEnabled = pulumi.Input.asOptionalInput<bool>(aiToolchainOperatorEnabled),
      apiServerAccessProfile = pulumi.Input.asOptionalInput<KubernetesClusterApiServerAccessProfile>(apiServerAccessProfile),
      autoScalerProfile = pulumi.Input.asOptionalInput<KubernetesClusterAutoScalerProfile>(autoScalerProfile),
      automaticUpgradeChannel = pulumi.Input.asOptionalInput<String>(automaticUpgradeChannel),
      azureActiveDirectoryRoleBasedAccessControl = pulumi.Input.asOptionalInput<KubernetesClusterAzureActiveDirectoryRoleBasedAccessControl>(azureActiveDirectoryRoleBasedAccessControl),
      azurePolicyEnabled = pulumi.Input.asOptionalInput<bool>(azurePolicyEnabled),
      bootstrapProfile = pulumi.Input.asOptionalInput<KubernetesClusterBootstrapProfile>(bootstrapProfile),
      confidentialComputing = pulumi.Input.asOptionalInput<KubernetesClusterConfidentialComputing>(confidentialComputing),
      costAnalysisEnabled = pulumi.Input.asOptionalInput<bool>(costAnalysisEnabled),
      customCaTrustCertificatesBase64s = pulumi.Input.asOptionalInput<List<String>>(customCaTrustCertificatesBase64s),
      defaultNodePool = pulumi.Input.asInput<KubernetesClusterDefaultNodePool>(defaultNodePool),
      ...
      dnsPrefixPrivateCluster = pulumi.Input.asOptionalInput<String>(dnsPrefixPrivateCluster),
      edgeZone = pulumi.Input.asOptionalInput<String>(edgeZone),
      httpApplicationRoutingEnabled = pulumi.Input.asOptionalInput<bool>(httpApplicationRoutingEnabled),
      httpProxyConfig = pulumi.Input.asOptionalInput<KubernetesClusterHttpProxyConfig>(httpProxyConfig),
      identity = pulumi.Input.asOptionalInput<KubernetesClusterIdentity>(identity),
      imageCleanerEnabled = pulumi.Input.asOptionalInput<bool>(imageCleanerEnabled),
      imageCleanerIntervalHours = pulumi.Input.asOptionalInput<int>(imageCleanerIntervalHours),
      ingressApplicationGateway = pulumi.Input.asOptionalInput<KubernetesClusterIngressApplicationGateway>(ingressApplicationGateway),
      keyManagementService = pulumi.Input.asOptionalInput<KubernetesClusterKeyManagementService>(keyManagementService),
      keyVaultSecretsProvider = pulumi.Input.asOptionalInput<KubernetesClusterKeyVaultSecretsProvider>(keyVaultSecretsProvider),
      kubeletIdentity = pulumi.Input.asOptionalInput<KubernetesClusterKubeletIdentity>(kubeletIdentity),
      kubernetesVersion = pulumi.Input.asOptionalInput<String>(kubernetesVersion),
      linuxProfile = pulumi.Input.asOptionalInput<KubernetesClusterLinuxProfile>(linuxProfile),
      localAccountDisabled = pulumi.Input.asOptionalInput<bool>(localAccountDisabled),
      location = pulumi.Input.asOptionalInput<String>(location),
      maintenanceWindow = pulumi.Input.asOptionalInput<KubernetesClusterMaintenanceWindow>(maintenanceWindow),
      maintenanceWindowAutoUpgrade = pulumi.Input.asOptionalInput<KubernetesClusterMaintenanceWindowAutoUpgrade>(maintenanceWindowAutoUpgrade),
      maintenanceWindowNodeOs = pulumi.Input.asOptionalInput<KubernetesClusterMaintenanceWindowNodeOs>(maintenanceWindowNodeOs),
      microsoftDefender = pulumi.Input.asOptionalInput<KubernetesClusterMicrosoftDefender>(microsoftDefender),
      monitorMetrics = pulumi.Input.asOptionalInput<KubernetesClusterMonitorMetrics>(monitorMetrics),
      name = pulumi.Input.asOptionalInput<String>(name),
      networkProfile = pulumi.Input.asOptionalInput<KubernetesClusterNetworkProfile>(networkProfile),
      nodeOsUpgradeChannel = pulumi.Input.asOptionalInput<String>(nodeOsUpgradeChannel),
      nodeProvisioningProfile = pulumi.Input.asOptionalInput<KubernetesClusterNodeProvisioningProfile>(nodeProvisioningProfile),
      nodeResourceGroup = pulumi.Input.asOptionalInput<String>(nodeResourceGroup),
      oidcIssuerEnabled = pulumi.Input.asOptionalInput<bool>(oidcIssuerEnabled),
      omsAgent = pulumi.Input.asOptionalInput<KubernetesClusterOmsAgent>(omsAgent),
      openServiceMeshEnabled = pulumi.Input.asOptionalInput<bool>(openServiceMeshEnabled),
      privateClusterEnabled = pulumi.Input.asOptionalInput<bool>(privateClusterEnabled),
      privateClusterPublicFqdnEnabled = pulumi.Input.asOptionalInput<bool>(privateClusterPublicFqdnEnabled),
      privateDnsZoneId = pulumi.Input.asOptionalInput<String>(privateDnsZoneId),
      resourceGroupName = pulumi.Input.asInput<String>(resourceGroupName),
      roleBasedAccessControlEnabled = pulumi.Input.asOptionalInput<bool>(roleBasedAccessControlEnabled),
      runCommandEnabled = pulumi.Input.asOptionalInput<bool>(runCommandEnabled),
      serviceMeshProfile = pulumi.Input.asOptionalInput<KubernetesClusterServiceMeshProfile>(serviceMeshProfile),
      servicePrincipal = pulumi.Input.asOptionalInput<KubernetesClusterServicePrincipal>(servicePrincipal),
      skuTier = pulumi.Input.asOptionalInput<String>(skuTier),
      storageProfile = pulumi.Input.asOptionalInput<KubernetesClusterStorageProfile>(storageProfile),
      supportPlan = pulumi.Input.asOptionalInput<String>(supportPlan),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      upgradeOverride = pulumi.Input.asOptionalInput<KubernetesClusterUpgradeOverride>(upgradeOverride),
      webAppRouting = pulumi.Input.asOptionalInput<KubernetesClusterWebAppRouting>(webAppRouting),
      windowsProfile = pulumi.Input.asOptionalInput<KubernetesClusterWindowsProfile>(windowsProfile),
      workloadAutoscalerProfile = pulumi.Input.asOptionalInput<KubernetesClusterWorkloadAutoscalerProfile>(workloadAutoscalerProfile),
      workloadIdentityEnabled = pulumi.Input.asOptionalInput<bool>(workloadIdentityEnabled);
  ...
  factory KubernetesClusterArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterArgs(
      aciConnectorLinux: map['aciConnectorLinux'] == null ? null : pulumi.Output.create<KubernetesClusterAciConnectorLinux>(KubernetesClusterAciConnectorLinux.fromMap((map['aciConnectorLinux'] as Map).cast<String, dynamic>())),
      aiToolchainOperatorEnabled: map['aiToolchainOperatorEnabled'] == null ? null : pulumi.Output.create<bool>(map['aiToolchainOperatorEnabled'] as bool),
      apiServerAccessProfile: map['apiServerAccessProfile'] == null ? null : pulumi.Output.create<KubernetesClusterApiServerAccessProfile>(KubernetesClusterApiServerAccessProfile.fromMap((map['apiServerAccessProfile'] as Map).cast<String, dynamic>())),
      autoScalerProfile: map['autoScalerProfile'] == null ? null : pulumi.Output.create<KubernetesClusterAutoScalerProfile>(KubernetesClusterAutoScalerProfile.fromMap((map['autoScalerProfile'] as Map).cast<String, dynamic>())),
      ...
      azureActiveDirectoryRoleBasedAccessControl: map['azureActiveDirectoryRoleBasedAccessControl'] == null ? null : pulumi.Output.create<KubernetesClusterAzureActiveDirectoryRoleBasedAccessControl>(KubernetesClusterAzureActiveDirectoryRoleBasedAccessControl.fromMap((map['azureActiveDirectoryRoleBasedAccessControl'] as Map).cast<String, dynamic>())),
      azurePolicyEnabled: map['azurePolicyEnabled'] == null ? null : pulumi.Output.create<bool>(map['azurePolicyEnabled'] as bool),
      bootstrapProfile: map['bootstrapProfile'] == null ? null : pulumi.Output.create<KubernetesClusterBootstrapProfile>(KubernetesClusterBootstrapProfile.fromMap((map['bootstrapProfile'] as Map).cast<String, dynamic>())),
      confidentialComputing: map['confidentialComputing'] == null ? null : pulumi.Output.create<KubernetesClusterConfidentialComputing>(KubernetesClusterConfidentialComputing.fromMap((map['confidentialComputing'] as Map).cast<String, dynamic>())),
      costAnalysisEnabled: map['costAnalysisEnabled'] == null ? null : pulumi.Output.create<bool>(map['costAnalysisEnabled'] as bool),
      customCaTrustCertificatesBase64s: map['customCaTrustCertificatesBase64s'] == null ? null : pulumi.Output.create<List<String>>((map['customCaTrustCertificatesBase64s'] as List).cast<String>()),
      defaultNodePool: pulumi.Output.create<KubernetesClusterDefaultNodePool>(KubernetesClusterDefaultNodePool.fromMap((map['defaultNodePool'] as Map).cast<String, dynamic>())),
      ...
      dnsPrefixPrivateCluster: map['dnsPrefixPrivateCluster'] == null ? null : pulumi.Output.create<String>(map['dnsPrefixPrivateCluster'] as String),
      edgeZone: map['edgeZone'] == null ? null : pulumi.Output.create<String>(map['edgeZone'] as String),
      httpApplicationRoutingEnabled: map['httpApplicationRoutingEnabled'] == null ? null : pulumi.Output.create<bool>(map['httpApplicationRoutingEnabled'] as bool),
      httpProxyConfig: map['httpProxyConfig'] == null ? null : pulumi.Output.create<KubernetesClusterHttpProxyConfig>(KubernetesClusterHttpProxyConfig.fromMap((map['httpProxyConfig'] as Map).cast<String, dynamic>())),
      identity: map['identity'] == null ? null : pulumi.Output.create<KubernetesClusterIdentity>(KubernetesClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      imageCleanerEnabled: map['imageCleanerEnabled'] == null ? null : pulumi.Output.create<bool>(map['imageCleanerEnabled'] as bool),
      imageCleanerIntervalHours: map['imageCleanerIntervalHours'] == null ? null : pulumi.Output.create<int>(map['imageCleanerIntervalHours'] as int),
      ingressApplicationGateway: map['ingressApplicationGateway'] == null ? null : pulumi.Output.create<KubernetesClusterIngressApplicationGateway>(KubernetesClusterIngressApplicationGateway.fromMap((map['ingressApplicationGateway'] as Map).cast<String, dynamic>())),
      keyManagementService: map['keyManagementService'] == null ? null : pulumi.Output.create<KubernetesClusterKeyManagementService>(KubernetesClusterKeyManagementService.fromMap((map['keyManagementService'] as Map).cast<String, dynamic>())),
      keyVaultSecretsProvider: map['keyVaultSecretsProvider'] == null ? null : pulumi.Output.create<KubernetesClusterKeyVaultSecretsProvider>(KubernetesClusterKeyVaultSecretsProvider.fromMap((map['keyVaultSecretsProvider'] as Map).cast<String, dynamic>())),
      kubeletIdentity: map['kubeletIdentity'] == null ? null : pulumi.Output.create<KubernetesClusterKubeletIdentity>(KubernetesClusterKubeletIdentity.fromMap((map['kubeletIdentity'] as Map).cast<String, dynamic>())),
      kubernetesVersion: map['kubernetesVersion'] == null ? null : pulumi.Output.create<String>(map['kubernetesVersion'] as String),
      linuxProfile: map['linuxProfile'] == null ? null : pulumi.Output.create<KubernetesClusterLinuxProfile>(KubernetesClusterLinuxProfile.fromMap((map['linuxProfile'] as Map).cast<String, dynamic>())),
      localAccountDisabled: map['localAccountDisabled'] == null ? null : pulumi.Output.create<bool>(map['localAccountDisabled'] as bool),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : pulumi.Output.create<KubernetesClusterMaintenanceWindow>(KubernetesClusterMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())),
      maintenanceWindowAutoUpgrade: map['maintenanceWindowAutoUpgrade'] == null ? null : pulumi.Output.create<KubernetesClusterMaintenanceWindowAutoUpgrade>(KubernetesClusterMaintenanceWindowAutoUpgrade.fromMap((map['maintenanceWindowAutoUpgrade'] as Map).cast<String, dynamic>())),
      maintenanceWindowNodeOs: map['maintenanceWindowNodeOs'] == null ? null : pulumi.Output.create<KubernetesClusterMaintenanceWindowNodeOs>(KubernetesClusterMaintenanceWindowNodeOs.fromMap((map['maintenanceWindowNodeOs'] as Map).cast<String, dynamic>())),
      microsoftDefender: map['microsoftDefender'] == null ? null : pulumi.Output.create<KubernetesClusterMicrosoftDefender>(KubernetesClusterMicrosoftDefender.fromMap((map['microsoftDefender'] as Map).cast<String, dynamic>())),
      monitorMetrics: map['monitorMetrics'] == null ? null : pulumi.Output.create<KubernetesClusterMonitorMetrics>(KubernetesClusterMonitorMetrics.fromMap((map['monitorMetrics'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkProfile: map['networkProfile'] == null ? null : pulumi.Output.create<KubernetesClusterNetworkProfile>(KubernetesClusterNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>())),
      nodeOsUpgradeChannel: map['nodeOsUpgradeChannel'] == null ? null : pulumi.Output.create<String>(map['nodeOsUpgradeChannel'] as String),
      nodeProvisioningProfile: map['nodeProvisioningProfile'] == null ? null : pulumi.Output.create<KubernetesClusterNodeProvisioningProfile>(KubernetesClusterNodeProvisioningProfile.fromMap((map['nodeProvisioningProfile'] as Map).cast<String, dynamic>())),
      nodeResourceGroup: map['nodeResourceGroup'] == null ? null : pulumi.Output.create<String>(map['nodeResourceGroup'] as String),
      oidcIssuerEnabled: map['oidcIssuerEnabled'] == null ? null : pulumi.Output.create<bool>(map['oidcIssuerEnabled'] as bool),
      omsAgent: map['omsAgent'] == null ? null : pulumi.Output.create<KubernetesClusterOmsAgent>(KubernetesClusterOmsAgent.fromMap((map['omsAgent'] as Map).cast<String, dynamic>())),
      openServiceMeshEnabled: map['openServiceMeshEnabled'] == null ? null : pulumi.Output.create<bool>(map['openServiceMeshEnabled'] as bool),
      privateClusterEnabled: map['privateClusterEnabled'] == null ? null : pulumi.Output.create<bool>(map['privateClusterEnabled'] as bool),
      privateClusterPublicFqdnEnabled: map['privateClusterPublicFqdnEnabled'] == null ? null : pulumi.Output.create<bool>(map['privateClusterPublicFqdnEnabled'] as bool),
      ...
      roleBasedAccessControlEnabled: map['roleBasedAccessControlEnabled'] == null ? null : pulumi.Output.create<bool>(map['roleBasedAccessControlEnabled'] as bool),
      runCommandEnabled: map['runCommandEnabled'] == null ? null : pulumi.Output.create<bool>(map['runCommandEnabled'] as bool),
      serviceMeshProfile: map['serviceMeshProfile'] == null ? null : pulumi.Output.create<KubernetesClusterServiceMeshProfile>(KubernetesClusterServiceMeshProfile.fromMap((map['serviceMeshProfile'] as Map).cast<String, dynamic>())),
      servicePrincipal: map['servicePrincipal'] == null ? null : pulumi.Output.create<KubernetesClusterServicePrincipal>(KubernetesClusterServicePrincipal.fromMap((map['servicePrincipal'] as Map).cast<String, dynamic>())),
      skuTier: map['skuTier'] == null ? null : pulumi.Output.create<String>(map['skuTier'] as String),
      storageProfile: map['storageProfile'] == null ? null : pulumi.Output.create<KubernetesClusterStorageProfile>(KubernetesClusterStorageProfile.fromMap((map['storageProfile'] as Map).cast<String, dynamic>())),
      supportPlan: map['supportPlan'] == null ? null : pulumi.Output.create<String>(map['supportPlan'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      upgradeOverride: map['upgradeOverride'] == null ? null : pulumi.Output.create<KubernetesClusterUpgradeOverride>(KubernetesClusterUpgradeOverride.fromMap((map['upgradeOverride'] as Map).cast<String, dynamic>())),
      webAppRouting: map['webAppRouting'] == null ? null : pulumi.Output.create<KubernetesClusterWebAppRouting>(KubernetesClusterWebAppRouting.fromMap((map['webAppRouting'] as Map).cast<String, dynamic>())),
      windowsProfile: map['windowsProfile'] == null ? null : pulumi.Output.create<KubernetesClusterWindowsProfile>(KubernetesClusterWindowsProfile.fromMap((map['windowsProfile'] as Map).cast<String, dynamic>())),
      workloadAutoscalerProfile: map['workloadAutoscalerProfile'] == null ? null : pulumi.Output.create<KubernetesClusterWorkloadAutoscalerProfile>(KubernetesClusterWorkloadAutoscalerProfile.fromMap((map['workloadAutoscalerProfile'] as Map).cast<String, dynamic>())),
      workloadIdentityEnabled: map['workloadIdentityEnabled'] == null ? null : pulumi.Output.create<bool>(map['workloadIdentityEnabled'] as bool),
    );
  }
}
