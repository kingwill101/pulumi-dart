...
class RegistryTaskState {
  ...
  factory RegistryTaskState.fromMap(Map<String, dynamic> map) {
    return RegistryTaskState(
      ...
      agentSetting: (() { final guardedValue = map['agentSetting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskAgentSetting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      baseImageTrigger: (() { final guardedValue = map['baseImageTrigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskBaseImageTrigger.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dockerStep: (() { final guardedValue = map['dockerStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskDockerStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      encodedStep: (() { final guardedValue = map['encodedStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskEncodedStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fileStep: (() { final guardedValue = map['fileStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskFileStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      platform: (() { final guardedValue = map['platform']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryTaskPlatform.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
