...
class KubernetesClusterNodePoolState {
  ...
  final pulumi.Input<KubernetesClusterNodePoolNodeNetworkProfile>?
  nodeNetworkProfile;
    ...
    return KubernetesClusterNodePoolState(
      ...
      kubeletConfig: (() {
        ...
        return pulumi.Input.fromValue(
          KubernetesClusterNodePoolKubeletConfig.fromMap(
      ...
      linuxOsConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KubernetesClusterNodePoolLinuxOsConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      nodeNetworkProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KubernetesClusterNodePoolNodeNetworkProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      upgradeSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KubernetesClusterNodePoolUpgradeSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      windowsProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KubernetesClusterNodePoolWindowsProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
