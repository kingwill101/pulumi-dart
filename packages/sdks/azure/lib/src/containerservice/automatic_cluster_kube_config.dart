...
class AutomaticClusterKubeConfig {
  ...
  /// Creates a new [AutomaticClusterKubeConfig].
  ...
  const AutomaticClusterKubeConfig({
  ...
  factory AutomaticClusterKubeConfig.fromMap(Map<String, dynamic> map) {
    return AutomaticClusterKubeConfig(
