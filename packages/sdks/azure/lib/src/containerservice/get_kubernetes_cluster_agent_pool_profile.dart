...
class GetKubernetesClusterAgentPoolProfile {
  ...
  final pulumi.Input<List<GetKubernetesClusterAgentPoolProfileUpgradeSetting>>
  upgradeSettings;
    ...
    return <String, dynamic>{
      ...
      'upgradeSettings':
          pulumi.Input.mapInputValue<
            List<GetKubernetesClusterAgentPoolProfileUpgradeSetting>,
  ...
  factory GetKubernetesClusterAgentPoolProfile.fromMap(
    ...
    return GetKubernetesClusterAgentPoolProfile(
      ...
      nodeLabels: pulumi.Input.fromValue(
        (map['nodeLabels'] as Map).cast<String, String>(),
      ),
      nodePublicIpEnabled: pulumi.Input.fromValue(
        map['nodePublicIpEnabled'] as bool,
      ),
      nodePublicIpPrefixId: pulumi.Input.fromValue(
        map['nodePublicIpPrefixId'] as String,
      ),
      nodeTaints: pulumi.Input.fromValue(
        (map['nodeTaints'] as List).cast<String>(),
      ),
      orchestratorVersion: pulumi.Input.fromValue(
        map['orchestratorVersion'] as String,
      ),
      ...
      upgradeSettings: pulumi.Input.fromValue(
        ...
        >(
          map['upgradeSettings']!,
          (value) => GetKubernetesClusterAgentPoolProfileUpgradeSetting.fromMap(
