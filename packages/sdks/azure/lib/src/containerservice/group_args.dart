...
class GroupArgs {
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      containers: pulumi.Input.fromValue(pulumi.Input.decodeList<GroupContainer>(map['containers']!, (value) => GroupContainer.fromMap((value as Map).cast<String, dynamic>()))),
      diagnostics: (() { final guardedValue = map['diagnostics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GroupDiagnostics.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dnsConfig: (() { final guardedValue = map['dnsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GroupDnsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dnsNameLabelReusePolicy: (() { final guardedValue = map['dnsNameLabelReusePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      exposedPorts: (() { final guardedValue = map['exposedPorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupExposedPort>(guardedValue, (value) => GroupExposedPort.fromMap((value as Map).cast<String, dynamic>()))); })(),
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GroupIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageRegistryCredentials: (() { final guardedValue = map['imageRegistryCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupImageRegistryCredential>(guardedValue, (value) => GroupImageRegistryCredential.fromMap((value as Map).cast<String, dynamic>()))); })(),
      initContainers: (() { final guardedValue = map['initContainers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupInitContainer>(guardedValue, (value) => GroupInitContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      keyVaultUserAssignedIdentityId: (() { final guardedValue = map['keyVaultUserAssignedIdentityId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkProfileId: (() { final guardedValue = map['networkProfileId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
