...
class KubernetesClusterMaintenanceWindowAutoUpgrade {
  ...
  final pulumi.Input<
    List<KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowed>
  >?
  notAlloweds;
  ...
  factory KubernetesClusterMaintenanceWindowAutoUpgrade.fromMap(
      ...
      notAlloweds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowed.fromMap(
