...
class KubernetesClusterKeyVaultSecretsProvider {
  ...
  final pulumi.Input<
    List<KubernetesClusterKeyVaultSecretsProviderSecretIdentity>
  >?
  secretIdentities;
  ...
  factory KubernetesClusterKeyVaultSecretsProvider.fromMap(
    Map<String, dynamic> map,
  ) {
    return KubernetesClusterKeyVaultSecretsProvider(
      secretIdentities: (() {
        final guardedValue = map['secretIdentities'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                KubernetesClusterKeyVaultSecretsProviderSecretIdentity.fromMap(
      ...
      secretRotationEnabled: (() {
        final guardedValue = map['secretRotationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      secretRotationInterval: (() {
        final guardedValue = map['secretRotationInterval'];
        if (guardedValue == null) return null;
