...
class KubernetesClusterNodePool extends pulumi.CustomResource {
  ...
  late final pulumi.Output<KubernetesClusterNodePoolKubeletConfig?>
  kubeletConfig;
  ...
  late final pulumi.Output<KubernetesClusterNodePoolLinuxOsConfig?>
  linuxOsConfig;
  ...
  late final pulumi.Output<KubernetesClusterNodePoolNodeNetworkProfile?>
  nodeNetworkProfile;
  ...
  late final pulumi.Output<KubernetesClusterNodePoolUpgradeSettings?>
  upgradeSettings;
  ...
  late final pulumi.Output<KubernetesClusterNodePoolWindowsProfile?>
  windowsProfile;
  ...
  KubernetesClusterNodePool(
    ...
    temporaryNameForRotation = registerOutput<String?>(
