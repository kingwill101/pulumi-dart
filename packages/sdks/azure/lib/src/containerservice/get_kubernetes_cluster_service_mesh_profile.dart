...
class GetKubernetesClusterServiceMeshProfile {
  ...
  factory GetKubernetesClusterServiceMeshProfile.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterServiceMeshProfile(
      certificateAuthorities: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesClusterServiceMeshProfileCertificateAuthority>(map['certificateAuthorities']!, (value) => GetKubernetesClusterServiceMeshProfileCertificateAuthority.fromMap((value as Map).cast<String, dynamic>()))),
      externalIngressGatewayEnabled: pulumi.Input.fromValue(map['externalIngressGatewayEnabled'] as bool),
      internalIngressGatewayEnabled: pulumi.Input.fromValue(map['internalIngressGatewayEnabled'] as bool),
