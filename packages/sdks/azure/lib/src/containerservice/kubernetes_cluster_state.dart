...
class KubernetesClusterState {
  ...
  KubernetesClusterState({
    ...
    pulumi.Output<String>? currentKubernetesVersion,
    pulumi.Output<List<String>>? customCaTrustCertificatesBase64s,
    pulumi.Output<KubernetesClusterDefaultNodePool>? defaultNodePool,
    ...
    pulumi.Output<String>? httpApplicationRoutingZoneName,
    ...
    pulumi.Output<String>? kubeAdminConfigRaw,
    pulumi.Output<List<KubernetesClusterKubeAdminConfig>>? kubeAdminConfigs,
    pulumi.Output<String>? kubeConfigRaw,
    ...
    pulumi.Output<String>? privateFqdn,
    ...
    pulumi.Output<bool>? workloadIdentityEnabled,
      ...
      currentKubernetesVersion = pulumi.Input.asOptionalInput<String>(currentKubernetesVersion),
      customCaTrustCertificatesBase64s = pulumi.Input.asOptionalInput<List<String>>(customCaTrustCertificatesBase64s),
      defaultNodePool = pulumi.Input.asOptionalInput<KubernetesClusterDefaultNodePool>(defaultNodePool),
      ...
      httpApplicationRoutingZoneName = pulumi.Input.asOptionalInput<String>(httpApplicationRoutingZoneName),
      ...
      kubeAdminConfigRaw = pulumi.Input.asOptionalInput<String>(kubeAdminConfigRaw),
      kubeAdminConfigs = pulumi.Input.asOptionalInput<List<KubernetesClusterKubeAdminConfig>>(kubeAdminConfigs),
      kubeConfigRaw = pulumi.Input.asOptionalInput<String>(kubeConfigRaw),
      ...
      nodeResourceGroupId = pulumi.Input.asOptionalInput<String>(nodeResourceGroupId),
      oidcIssuerEnabled = pulumi.Input.asOptionalInput<bool>(oidcIssuerEnabled),
      oidcIssuerUrl = pulumi.Input.asOptionalInput<String>(oidcIssuerUrl),
      ...
      portalFqdn = pulumi.Input.asOptionalInput<String>(portalFqdn),
      ...
      privateFqdn = pulumi.Input.asOptionalInput<String>(privateFqdn),
  ...
  factory KubernetesClusterState.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterState(
      ...
      currentKubernetesVersion: map['currentKubernetesVersion'] == null ? null : pulumi.Output.create<String>(map['currentKubernetesVersion'] as String),
      ...
      defaultNodePool: map['defaultNodePool'] == null ? null : pulumi.Output.create<KubernetesClusterDefaultNodePool>(KubernetesClusterDefaultNodePool.fromMap((map['defaultNodePool'] as Map).cast<String, dynamic>())),
      ...
      httpApplicationRoutingZoneName: map['httpApplicationRoutingZoneName'] == null ? null : pulumi.Output.create<String>(map['httpApplicationRoutingZoneName'] as String),
      ...
      kubeAdminConfigRaw: map['kubeAdminConfigRaw'] == null ? null : pulumi.Output.create<String>(map['kubeAdminConfigRaw'] as String),
      kubeAdminConfigs: map['kubeAdminConfigs'] == null ? null : pulumi.Output.create<List<KubernetesClusterKubeAdminConfig>>(pulumi.Input.decodeList<KubernetesClusterKubeAdminConfig>(map['kubeAdminConfigs'], (value) => KubernetesClusterKubeAdminConfig.fromMap((value as Map).cast<String, dynamic>()))),
      kubeConfigRaw: map['kubeConfigRaw'] == null ? null : pulumi.Output.create<String>(map['kubeConfigRaw'] as String),
      ...
      nodeResourceGroupId: map['nodeResourceGroupId'] == null ? null : pulumi.Output.create<String>(map['nodeResourceGroupId'] as String),
      oidcIssuerEnabled: map['oidcIssuerEnabled'] == null ? null : pulumi.Output.create<bool>(map['oidcIssuerEnabled'] as bool),
      oidcIssuerUrl: map['oidcIssuerUrl'] == null ? null : pulumi.Output.create<String>(map['oidcIssuerUrl'] as String),
      ...
      portalFqdn: map['portalFqdn'] == null ? null : pulumi.Output.create<String>(map['portalFqdn'] as String),
      ...
      privateFqdn: map['privateFqdn'] == null ? null : pulumi.Output.create<String>(map['privateFqdn'] as String),
