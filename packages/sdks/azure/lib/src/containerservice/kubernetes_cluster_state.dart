...
class KubernetesClusterState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kubeAdminConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterKubeAdminConfig>,
      ...
      'kubeConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterKubeConfig>,
            List<Map<String, dynamic>>
          >(
            kubeConfigs,
            (value) =>
  ...
  factory KubernetesClusterState.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterState(
      ...
      currentKubernetesVersion: (() {
        final guardedValue = map['currentKubernetesVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      defaultNodePool: (() {
        final guardedValue = map['defaultNodePool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      httpApplicationRoutingZoneName: (() {
        final guardedValue = map['httpApplicationRoutingZoneName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      httpProxyConfig: (() {
      ...
      kubeAdminConfigRaw: (() {
        final guardedValue = map['kubeAdminConfigRaw'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kubeAdminConfigs: (() {
        final guardedValue = map['kubeAdminConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KubernetesClusterKubeAdminConfig>(
            guardedValue,
            (value) => KubernetesClusterKubeAdminConfig.fromMap(
      ...
      kubeConfigRaw: (() {
        final guardedValue = map['kubeConfigRaw'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kubeConfigs: (() {
        final guardedValue = map['kubeConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KubernetesClusterKubeConfig>(
            guardedValue,
            (value) => KubernetesClusterKubeConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      nodeResourceGroupId: (() {
        final guardedValue = map['nodeResourceGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      oidcIssuerEnabled: (() {
      ...
      oidcIssuerUrl: (() {
        final guardedValue = map['oidcIssuerUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      omsAgent: (() {
      ...
      privateFqdn: (() {
        final guardedValue = map['privateFqdn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceGroupName: (() {
