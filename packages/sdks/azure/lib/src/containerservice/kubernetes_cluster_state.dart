...
class KubernetesClusterState {
  ...
  /// [kubeAdminConfigs] A `kubeAdminConfig` block as defined below. This is only available when Role Based Access Control with Azure Active Directory is enabled and local accounts enabled.
  ...
  factory KubernetesClusterState.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterState(
      ...
      defaultNodePool: (() { final guardedValue = map['defaultNodePool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesClusterDefaultNodePool.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpApplicationRoutingZoneName: (() { final guardedValue = map['httpApplicationRoutingZoneName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      kubeAdminConfigRaw: (() { final guardedValue = map['kubeAdminConfigRaw']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kubeAdminConfigs: (() { final guardedValue = map['kubeAdminConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesClusterKubeAdminConfig>(guardedValue, (value) => KubernetesClusterKubeAdminConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      privateFqdn: (() { final guardedValue = map['privateFqdn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
