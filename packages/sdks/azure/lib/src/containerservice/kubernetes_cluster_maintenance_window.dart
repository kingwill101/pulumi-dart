...
class KubernetesClusterMaintenanceWindow {
  ...
  final pulumi.Input<List<KubernetesClusterMaintenanceWindowNotAllowed>>?
  notAlloweds;
  ...
  KubernetesClusterMaintenanceWindow({this.alloweds, this.notAlloweds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alloweds':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterMaintenanceWindowAllowed>,
      ...
      'notAlloweds':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterMaintenanceWindowNotAllowed>,
            List<Map<String, dynamic>>
          >(
            notAlloweds,
            (value) =>
  ...
  factory KubernetesClusterMaintenanceWindow.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterMaintenanceWindow(
      alloweds: (() {
        final guardedValue = map['alloweds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KubernetesClusterMaintenanceWindowAllowed>(
            guardedValue,
            (value) => KubernetesClusterMaintenanceWindowAllowed.fromMap(
      ...
      notAlloweds: (() {
        final guardedValue = map['notAlloweds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KubernetesClusterMaintenanceWindowNotAllowed>(
            guardedValue,
            (value) => KubernetesClusterMaintenanceWindowNotAllowed.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
