...
class KubernetesClusterWebAppRouting {
  ...
  final pulumi.Input<List<KubernetesClusterWebAppRoutingWebAppRoutingIdentity>>?
    ...
    return <String, dynamic>{
      ...
      'webAppRoutingIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterWebAppRoutingWebAppRoutingIdentity>,
  ...
  factory KubernetesClusterWebAppRouting.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterWebAppRouting(
      defaultNginxController: (() {
        final guardedValue = map['defaultNginxController'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dnsZoneIds: pulumi.Input.fromValue(
        (map['dnsZoneIds'] as List).cast<String>(),
      ),
      webAppRoutingIdentities: (() {
        final guardedValue = map['webAppRoutingIdentities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                KubernetesClusterWebAppRoutingWebAppRoutingIdentity.fromMap(
