...
class KubernetesClusterNetworkProfile {
  ...
  final pulumi.Input<KubernetesClusterNetworkProfileAdvancedNetworking>?
  advancedNetworking;
  ...
  final pulumi.Input<KubernetesClusterNetworkProfileLoadBalancerProfile>?
  loadBalancerProfile;
  ...
  final pulumi.Input<KubernetesClusterNetworkProfileNatGatewayProfile>?
  natGatewayProfile;
    ...
    return KubernetesClusterNetworkProfile(
      advancedNetworking: (() {
        ...
        return pulumi.Input.fromValue(
          KubernetesClusterNetworkProfileAdvancedNetworking.fromMap(
      ...
      ipVersions: (() {
        final guardedValue = map['ipVersions'];
        if (guardedValue == null) return null;
      ...
      loadBalancerProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KubernetesClusterNetworkProfileLoadBalancerProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      natGatewayProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KubernetesClusterNetworkProfileNatGatewayProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
