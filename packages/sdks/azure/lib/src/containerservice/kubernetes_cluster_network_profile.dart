...
class KubernetesClusterNetworkProfile {
  ...
  final KubernetesClusterNetworkProfileAdvancedNetworking? advancedNetworking;
  ...
  final KubernetesClusterNetworkProfileLoadBalancerProfile? loadBalancerProfile;
  ...
  final KubernetesClusterNetworkProfileNatGatewayProfile? natGatewayProfile;
  ...
  factory KubernetesClusterNetworkProfile.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterNetworkProfile(
      advancedNetworking: map['advancedNetworking'] == null ? null : KubernetesClusterNetworkProfileAdvancedNetworking.fromMap((map['advancedNetworking'] as Map).cast<String, dynamic>()),
      dnsServiceIp: map['dnsServiceIp'] == null ? null : map['dnsServiceIp'] as String,
      ipVersions: map['ipVersions'] == null ? null : (map['ipVersions'] as List).cast<String>(),
      loadBalancerProfile: map['loadBalancerProfile'] == null ? null : KubernetesClusterNetworkProfileLoadBalancerProfile.fromMap((map['loadBalancerProfile'] as Map).cast<String, dynamic>()),
      loadBalancerSku: map['loadBalancerSku'] == null ? null : map['loadBalancerSku'] as String,
      natGatewayProfile: map['natGatewayProfile'] == null ? null : KubernetesClusterNetworkProfileNatGatewayProfile.fromMap((map['natGatewayProfile'] as Map).cast<String, dynamic>()),
