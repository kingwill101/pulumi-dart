...
class GetKubernetesClusterResult {
  ...
  final List<GetKubernetesClusterAzureActiveDirectoryRoleBasedAccessControl>
  azureActiveDirectoryRoleBasedAccessControls;
  ...
  final List<GetKubernetesClusterIngressApplicationGateway>
  ...
  final List<GetKubernetesClusterKeyVaultSecretsProvider>
  keyVaultSecretsProviders;
    ...
    return <String, dynamic>{
      'aciConnectorLinuxes':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(aciConnectorLinuxes, (value) => value.toMap()),
      'agentPoolProfiles':
          pulumi.Input.encodeList<
            GetKubernetesClusterAgentPoolProfile,
            Map<String, dynamic>
          >(agentPoolProfiles, (value) => value.toMap()),
      ...
      'kubeletIdentities':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(kubeletIdentities, (value) => value.toMap()),
      'kubernetesVersion': kubernetesVersion,
      'linuxProfiles':
          pulumi.Input.encodeList<
            GetKubernetesClusterLinuxProfile,
            Map<String, dynamic>
          >(linuxProfiles, (value) => value.toMap()),
      'location': location,
      'microsoftDefenders':
          pulumi.Input.encodeList<
            GetKubernetesClusterMicrosoftDefender,
            Map<String, dynamic>
          >(microsoftDefenders, (value) => value.toMap()),
      'name': name,
      'networkProfiles':
          pulumi.Input.encodeList<
            GetKubernetesClusterNetworkProfile,
            Map<String, dynamic>
          >(networkProfiles, (value) => value.toMap()),
      ...
      'serviceMeshProfiles':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(serviceMeshProfiles, (value) => value.toMap()),
      'servicePrincipals':
          pulumi.Input.encodeList<
      ...
      'storageProfiles':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(storageProfiles, (value) => value.toMap()),
      'tags': tags,
      'windowsProfiles':
          pulumi.Input.encodeList<
            GetKubernetesClusterWindowsProfile,
            Map<String, dynamic>
          >(windowsProfiles, (value) => value.toMap()),
    };
  }
  ...
  factory GetKubernetesClusterResult.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterResult(
      aciConnectorLinuxes:
          pulumi.Input.decodeList<GetKubernetesClusterAciConnectorLinux>(
            map['aciConnectorLinuxes']!,
            (value) => GetKubernetesClusterAciConnectorLinux.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      agentPoolProfiles:
          pulumi.Input.decodeList<GetKubernetesClusterAgentPoolProfile>(
            map['agentPoolProfiles']!,
            (value) => GetKubernetesClusterAgentPoolProfile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      apiServerAuthorizedIpRanges: (map['apiServerAuthorizedIpRanges'] as List)
          .cast<String>(),
      azureActiveDirectoryRoleBasedAccessControls:
          pulumi.Input.decodeList<
            GetKubernetesClusterAzureActiveDirectoryRoleBasedAccessControl
          >(
            map['azureActiveDirectoryRoleBasedAccessControls']!,
            (value) =>
                GetKubernetesClusterAzureActiveDirectoryRoleBasedAccessControl.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      ...
      httpApplicationRoutingEnabled:
          map['httpApplicationRoutingEnabled'] as bool,
      httpApplicationRoutingZoneName:
          map['httpApplicationRoutingZoneName'] as String,
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetKubernetesClusterIdentity>(
        map['identities']!,
        (value) => GetKubernetesClusterIdentity.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ingressApplicationGateways:
          pulumi
              .Input.decodeList<GetKubernetesClusterIngressApplicationGateway>(
            map['ingressApplicationGateways']!,
            (value) => GetKubernetesClusterIngressApplicationGateway.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      keyManagementServices:
          pulumi.Input.decodeList<GetKubernetesClusterKeyManagementService>(
            map['keyManagementServices']!,
            (value) => GetKubernetesClusterKeyManagementService.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      keyVaultSecretsProviders:
          pulumi.Input.decodeList<GetKubernetesClusterKeyVaultSecretsProvider>(
            map['keyVaultSecretsProviders']!,
            (value) => GetKubernetesClusterKeyVaultSecretsProvider.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      kubeAdminConfigRaw: map['kubeAdminConfigRaw'] as String,
      kubeAdminConfigs:
          pulumi.Input.decodeList<GetKubernetesClusterKubeAdminConfig>(
            map['kubeAdminConfigs']!,
            (value) => GetKubernetesClusterKubeAdminConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      kubeletIdentities:
          pulumi.Input.decodeList<GetKubernetesClusterKubeletIdentity>(
            map['kubeletIdentities']!,
            (value) => GetKubernetesClusterKubeletIdentity.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      kubernetesVersion: map['kubernetesVersion'] as String,
      linuxProfiles: pulumi.Input.decodeList<GetKubernetesClusterLinuxProfile>(
        map['linuxProfiles']!,
        (value) => GetKubernetesClusterLinuxProfile.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      location: map['location'] as String,
      microsoftDefenders:
          pulumi.Input.decodeList<GetKubernetesClusterMicrosoftDefender>(
            map['microsoftDefenders']!,
            (value) => GetKubernetesClusterMicrosoftDefender.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      name: map['name'] as String,
      networkProfiles:
          pulumi.Input.decodeList<GetKubernetesClusterNetworkProfile>(
            map['networkProfiles']!,
            (value) => GetKubernetesClusterNetworkProfile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      omsAgents: pulumi.Input.decodeList<GetKubernetesClusterOmsAgent>(
        map['omsAgents']!,
        (value) => GetKubernetesClusterOmsAgent.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      roleBasedAccessControlEnabled:
          map['roleBasedAccessControlEnabled'] as bool,
      serviceMeshProfiles:
          pulumi.Input.decodeList<GetKubernetesClusterServiceMeshProfile>(
            map['serviceMeshProfiles']!,
            (value) => GetKubernetesClusterServiceMeshProfile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      servicePrincipals:
          pulumi.Input.decodeList<GetKubernetesClusterServicePrincipal>(
            map['servicePrincipals']!,
            (value) => GetKubernetesClusterServicePrincipal.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      storageProfiles:
          pulumi.Input.decodeList<GetKubernetesClusterStorageProfile>(
            map['storageProfiles']!,
            (value) => GetKubernetesClusterStorageProfile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      tags: (map['tags'] as Map).cast<String, String>(),
      windowsProfiles:
          pulumi.Input.decodeList<GetKubernetesClusterWindowsProfile>(
            map['windowsProfiles']!,
            (value) => GetKubernetesClusterWindowsProfile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
    );
