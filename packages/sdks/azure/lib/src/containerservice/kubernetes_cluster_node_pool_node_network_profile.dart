...
class KubernetesClusterNodePoolNodeNetworkProfile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedHostPorts': ?pulumi.Input.mapOptionalInputValue<List<KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort>, List<Map<String, dynamic>>>(allowedHostPorts, (value) => pulumi.Input.encodeList<KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory KubernetesClusterNodePoolNodeNetworkProfile.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterNodePoolNodeNetworkProfile(
      allowedHostPorts: (() { final guardedValue = map['allowedHostPorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort>(guardedValue, (value) => KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort.fromMap((value as Map).cast<String, dynamic>()))); })(),
