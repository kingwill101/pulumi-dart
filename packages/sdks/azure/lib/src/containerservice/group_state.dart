...
class GroupState {
  ...
  GroupState({
    pulumi.Output<List<GroupContainer>>? containers,
    ...
    pulumi.Output<List<String>>? zones,
      ...
      containers = pulumi.Input.asOptionalInput<List<GroupContainer>>(containers),
  ...
  factory GroupState.fromMap(Map<String, dynamic> map) {
    return GroupState(
      containers: map['containers'] == null ? null : pulumi.Output.create<List<GroupContainer>>(pulumi.Input.decodeList<GroupContainer>(map['containers'], (value) => GroupContainer.fromMap((value as Map).cast<String, dynamic>()))),
