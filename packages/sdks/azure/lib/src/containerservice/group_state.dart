...
class GroupState {
  ...
  factory GroupState.fromMap(Map<String, dynamic> map) {
    return GroupState(
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupContainer>(guardedValue, (value) => GroupContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
