...
class ConnectedRegistryArgs {
    ...
    return <String, dynamic>{
      ...
      'notifications':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConnectedRegistryNotification>,
  ...
  factory ConnectedRegistryArgs.fromMap(Map<String, dynamic> map) {
    return ConnectedRegistryArgs(
      auditLogEnabled: (() {
        final guardedValue = map['auditLogEnabled'];
      ...
      notifications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConnectedRegistryNotification>(
            guardedValue,
            (value) => ConnectedRegistryNotification.fromMap(
      ...
      parentRegistryId: (() {
        final guardedValue = map['parentRegistryId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      syncMessageTtl: (() {
        final guardedValue = map['syncMessageTtl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      syncSchedule: (() {
        final guardedValue = map['syncSchedule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      syncTokenId: pulumi.Input.fromValue(map['syncTokenId'] as String),
      syncWindow: (() {
