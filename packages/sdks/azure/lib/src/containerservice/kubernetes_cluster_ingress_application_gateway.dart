...
class KubernetesClusterIngressApplicationGateway {
  ...
  final String? effectiveGatewayId;
  ...
  final List<KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentity>? ingressApplicationGatewayIdentities;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ingressApplicationGatewayIdentities': ?ingressApplicationGatewayIdentities == null ? null : pulumi.Input.encodeList<KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentity, Map<String, dynamic>>(ingressApplicationGatewayIdentities!, (value) => value.toMap()),
