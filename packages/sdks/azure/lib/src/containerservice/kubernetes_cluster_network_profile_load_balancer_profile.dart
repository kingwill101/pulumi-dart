...
class KubernetesClusterNetworkProfileLoadBalancerProfile {
  ...
  factory KubernetesClusterNetworkProfileLoadBalancerProfile.fromMap(
    Map<String, dynamic> map,
  ) {
    return KubernetesClusterNetworkProfileLoadBalancerProfile(
      backendPoolType: (() {
        final guardedValue = map['backendPoolType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      effectiveOutboundIps: (() {
        final guardedValue = map['effectiveOutboundIps'];
        if (guardedValue == null) return null;
      ...
      managedOutboundIpCount: (() {
        final guardedValue = map['managedOutboundIpCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      managedOutboundIpv6Count: (() {
        final guardedValue = map['managedOutboundIpv6Count'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      outboundIpAddressIds: (() {
        final guardedValue = map['outboundIpAddressIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      outboundIpPrefixIds: (() {
        final guardedValue = map['outboundIpPrefixIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      outboundPortsAllocated: (() {
        final guardedValue = map['outboundPortsAllocated'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
