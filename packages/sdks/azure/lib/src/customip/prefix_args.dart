  ...
  factory PrefixArgs.fromMap(Map<String, dynamic> map) {
    return PrefixArgs(
      ...
      commissioningEnabled: (() {
        final guardedValue = map['commissioningEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      internetAdvertisingDisabled: (() {
        final guardedValue = map['internetAdvertisingDisabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      location: (() {
      ...
      parentCustomIpPrefixId: (() {
        final guardedValue = map['parentCustomIpPrefixId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      roaValidityEndDate: (() {
        final guardedValue = map['roaValidityEndDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
      ...
      wanValidationSignedMessage: (() {
        final guardedValue = map['wanValidationSignedMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      zones: (() {
