...
class DefinitionState {
  ...
  factory DefinitionState.fromMap(Map<String, dynamic> map) {
    return DefinitionState(
      ...
      roleDefinitionIds: (() { final guardedValue = map['roleDefinitionIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
