...
class PolicySetDefinitionState {
  ...
  final pulumi.Input<List<PolicySetDefinitionPolicyDefinitionGroup>>?
  policyDefinitionGroups;

  /// One or more `policy_definition_reference` blocks as defined below.
  final pulumi.Input<List<PolicySetDefinitionPolicyDefinitionReference>>?
    ...
    return <String, dynamic>{
      ...
      'policyDefinitionGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicySetDefinitionPolicyDefinitionGroup>,
      ...
      'policyDefinitionReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicySetDefinitionPolicyDefinitionReference>,
            List<Map<String, dynamic>>
          >(
            policyDefinitionReferences,
            (value) =>
    ...
    return PolicySetDefinitionState(
      ...
      policyDefinitionGroups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicySetDefinitionPolicyDefinitionGroup>(
            guardedValue,
            (value) => PolicySetDefinitionPolicyDefinitionGroup.fromMap(
      ...
      policyDefinitionReferences: (() {
        final guardedValue = map['policyDefinitionReferences'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicySetDefinitionPolicyDefinitionReference>(
            guardedValue,
            (value) => PolicySetDefinitionPolicyDefinitionReference.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
