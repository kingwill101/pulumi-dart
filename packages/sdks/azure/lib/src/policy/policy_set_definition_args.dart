...
class PolicySetDefinitionArgs {
  ...
  PolicySetDefinitionArgs({
    ...
    required pulumi.Output<List<PolicySetDefinitionPolicyDefinitionReference>> policyDefinitionReferences,
  ...
  factory PolicySetDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return PolicySetDefinitionArgs(
      ...
      policyDefinitionReferences: pulumi.Output.create<List<PolicySetDefinitionPolicyDefinitionReference>>(pulumi.Input.decodeList<PolicySetDefinitionPolicyDefinitionReference>(map['policyDefinitionReferences'], (value) => PolicySetDefinitionPolicyDefinitionReference.fromMap((value as Map).cast<String, dynamic>()))),
