...
class VirtualMachineConfigurationAssignmentState {
  ...
  final pulumi.Input<VirtualMachineConfigurationAssignmentConfiguration>?
  configuration;
  ...
  factory VirtualMachineConfigurationAssignmentState.fromMap(
    ...
    return VirtualMachineConfigurationAssignmentState(
      configuration: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachineConfigurationAssignmentConfiguration.fromMap(
