...
class FluxConfigurationArgs {
  ...
  factory FluxConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return FluxConfigurationArgs(
      ...
      kustomizations: pulumi.Input.fromValue(pulumi.Input.decodeList<FluxConfigurationKustomization>(map['kustomizations']!, (value) => FluxConfigurationKustomization.fromMap((value as Map).cast<String, dynamic>()))),
