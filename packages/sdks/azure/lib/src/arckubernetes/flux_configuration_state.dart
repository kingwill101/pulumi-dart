...
class FluxConfigurationState {
  ...
  factory FluxConfigurationState.fromMap(Map<String, dynamic> map) {
    return FluxConfigurationState(
      blobStorage: (() { final guardedValue = map['blobStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FluxConfigurationBlobStorage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      bucket: (() { final guardedValue = map['bucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FluxConfigurationBucket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      clusterId: (() { final guardedValue = map['clusterId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      continuousReconciliationEnabled: (() { final guardedValue = map['continuousReconciliationEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      gitRepository: (() { final guardedValue = map['gitRepository']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FluxConfigurationGitRepository.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kustomizations: (() { final guardedValue = map['kustomizations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FluxConfigurationKustomization>(guardedValue, (value) => FluxConfigurationKustomization.fromMap((value as Map).cast<String, dynamic>()))); })(),
