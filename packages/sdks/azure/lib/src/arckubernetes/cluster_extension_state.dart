...
class ClusterExtensionState {
  ...
  factory ClusterExtensionState.fromMap(Map<String, dynamic> map) {
    return ClusterExtensionState(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterExtensionIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
