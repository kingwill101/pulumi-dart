...
class FlexibleServerState {
  ...
  FlexibleServerState({
    ...
    pulumi.Output<String>? zone,
      ...
      replicaCapacity = pulumi.Input.asOptionalInput<int>(replicaCapacity),
  ...
  factory FlexibleServerState.fromMap(Map<String, dynamic> map) {
    return FlexibleServerState(
      ...
      replicaCapacity: map['replicaCapacity'] == null ? null : pulumi.Output.create<int>(map['replicaCapacity'] as int),
      ...
      storage: map['storage'] == null ? null : pulumi.Output.create<FlexibleServerStorage>(FlexibleServerStorage.fromMap((map['storage'] as Map).cast<String, dynamic>())),
