...
class GetDeploymentWebApplicationFirewallStatus {
  ...
  factory GetDeploymentWebApplicationFirewallStatus.fromMap(Map<String, dynamic> map) {
    return GetDeploymentWebApplicationFirewallStatus(
      attackSignaturesPackages: (pulumi.Input.decodeList<GetDeploymentWebApplicationFirewallStatusAttackSignaturesPackage>(map['attackSignaturesPackages'], (value) => GetDeploymentWebApplicationFirewallStatusAttackSignaturesPackage.fromMap((value as Map).cast<String, dynamic>()))).input(),
      botSignaturesPackages: (pulumi.Input.decodeList<GetDeploymentWebApplicationFirewallStatusBotSignaturesPackage>(map['botSignaturesPackages'], (value) => GetDeploymentWebApplicationFirewallStatusBotSignaturesPackage.fromMap((value as Map).cast<String, dynamic>()))).input(),
      componentVersions: (pulumi.Input.decodeList<GetDeploymentWebApplicationFirewallStatusComponentVersion>(map['componentVersions'], (value) => GetDeploymentWebApplicationFirewallStatusComponentVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
      threatCampaignsPackages: (pulumi.Input.decodeList<GetDeploymentWebApplicationFirewallStatusThreatCampaignsPackage>(map['threatCampaignsPackages'], (value) => GetDeploymentWebApplicationFirewallStatusThreatCampaignsPackage.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
