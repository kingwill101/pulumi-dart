...
class GetDeploymentWebApplicationFirewallStatus {
  ...
  final pulumi.Input<
    List<GetDeploymentWebApplicationFirewallStatusBotSignaturesPackage>
  >
  botSignaturesPackages;

  /// Indicates the version of the WAF Engine and Nginx WAF Module used by NGINX App Protect.
  final pulumi.Input<
    List<GetDeploymentWebApplicationFirewallStatusComponentVersion>
  >
  componentVersions;

  /// Indicates the version of the threat campaigns package used by NGINX App Protect.
  final pulumi.Input<
    List<GetDeploymentWebApplicationFirewallStatusThreatCampaignsPackage>
  >
  ...
  factory GetDeploymentWebApplicationFirewallStatus.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDeploymentWebApplicationFirewallStatus(
      attackSignaturesPackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDeploymentWebApplicationFirewallStatusAttackSignaturesPackage
        >(
          map['attackSignaturesPackages']!,
          (value) =>
              GetDeploymentWebApplicationFirewallStatusAttackSignaturesPackage.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      botSignaturesPackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDeploymentWebApplicationFirewallStatusBotSignaturesPackage
        >(
          map['botSignaturesPackages']!,
          (value) =>
              GetDeploymentWebApplicationFirewallStatusBotSignaturesPackage.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      componentVersions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDeploymentWebApplicationFirewallStatusComponentVersion
        >(
          map['componentVersions']!,
          (value) =>
              GetDeploymentWebApplicationFirewallStatusComponentVersion.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      threatCampaignsPackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDeploymentWebApplicationFirewallStatusThreatCampaignsPackage
        >(
          map['threatCampaignsPackages']!,
          (value) =>
              GetDeploymentWebApplicationFirewallStatusThreatCampaignsPackage.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
