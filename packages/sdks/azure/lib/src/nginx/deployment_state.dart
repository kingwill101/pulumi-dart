...
class DeploymentState {
  ...
  DeploymentState({
    ...
    pulumi.Output<String>? dataplaneApiEndpoint,
    ...
    pulumi.Output<String>? nginxVersion,
    ...
    pulumi.Output<DeploymentWebApplicationFirewall>? webApplicationFirewall,
      ...
      dataplaneApiEndpoint = pulumi.Input.asOptionalInput<String>(dataplaneApiEndpoint),
      ...
      nginxVersion = pulumi.Input.asOptionalInput<String>(nginxVersion),
  ...
  factory DeploymentState.fromMap(Map<String, dynamic> map) {
    return DeploymentState(
      ...
      dataplaneApiEndpoint: map['dataplaneApiEndpoint'] == null ? null : pulumi.Output.create<String>(map['dataplaneApiEndpoint'] as String),
      ...
      nginxVersion: map['nginxVersion'] == null ? null : pulumi.Output.create<String>(map['nginxVersion'] as String),
