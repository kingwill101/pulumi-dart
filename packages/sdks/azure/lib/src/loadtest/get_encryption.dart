...
class GetEncryption {
  ...
  GetEncryption({required this.identities, required this.keyUrl});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'identities':
          pulumi.Input.mapInputValue<
            List<GetEncryptionIdentity>,
  ...
  factory GetEncryption.fromMap(Map<String, dynamic> map) {
    return GetEncryption(
      identities: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetEncryptionIdentity>(
          map['identities']!,
          (value) => GetEncryptionIdentity.fromMap(
