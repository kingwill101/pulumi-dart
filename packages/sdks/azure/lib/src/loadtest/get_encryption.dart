...
class GetEncryption {
  ...
  factory GetEncryption.fromMap(Map<String, dynamic> map) {
    return GetEncryption(
      identities: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEncryptionIdentity>(map['identities']!, (value) => GetEncryptionIdentity.fromMap((value as Map).cast<String, dynamic>()))),
