...
class BudgetResourceGroupArgs {
  ...
  factory BudgetResourceGroupArgs.fromMap(Map<String, dynamic> map) {
    return BudgetResourceGroupArgs(
      ...
      notifications: pulumi.Input.fromValue(pulumi.Input.decodeList<BudgetResourceGroupNotification>(map['notifications']!, (value) => BudgetResourceGroupNotification.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      timePeriod: pulumi.Input.fromValue(BudgetResourceGroupTimePeriod.fromMap((map['timePeriod']! as Map).cast<String, dynamic>())),
    );
  }
}
