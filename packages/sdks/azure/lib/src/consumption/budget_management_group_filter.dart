...
class BudgetManagementGroupFilter {
  ...
  factory BudgetManagementGroupFilter.fromMap(Map<String, dynamic> map) {
    return BudgetManagementGroupFilter(
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BudgetManagementGroupFilterDimension>(guardedValue, (value) => BudgetManagementGroupFilterDimension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BudgetManagementGroupFilterTag>(guardedValue, (value) => BudgetManagementGroupFilterTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
