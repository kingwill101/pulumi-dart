...
class BudgetResourceGroupFilter {
  ...
  BudgetResourceGroupFilter({this.dimensions, this.tags});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dimensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<BudgetResourceGroupFilterDimension>,
      ...
      'tags':
          ?pulumi.Input.mapOptionalInputValue<
            List<BudgetResourceGroupFilterTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
    ...
    return BudgetResourceGroupFilter(
      dimensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BudgetResourceGroupFilterDimension>(
            guardedValue,
            (value) => BudgetResourceGroupFilterDimension.fromMap(
      ...
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BudgetResourceGroupFilterTag>(
            guardedValue,
            (value) => BudgetResourceGroupFilterTag.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
