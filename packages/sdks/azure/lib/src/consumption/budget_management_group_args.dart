...
class BudgetManagementGroupArgs {
  ...
  factory BudgetManagementGroupArgs.fromMap(Map<String, dynamic> map) {
    return BudgetManagementGroupArgs(
      ...
      notifications: pulumi.Input.fromValue(pulumi.Input.decodeList<BudgetManagementGroupNotification>(map['notifications']!, (value) => BudgetManagementGroupNotification.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      timePeriod: pulumi.Input.fromValue(BudgetManagementGroupTimePeriod.fromMap((map['timePeriod']! as Map).cast<String, dynamic>())),
    );
  }
}
