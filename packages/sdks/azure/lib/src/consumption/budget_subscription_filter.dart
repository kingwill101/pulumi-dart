...
class BudgetSubscriptionFilter {
  ...
  BudgetSubscriptionFilter({this.dimensions, this.tags});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dimensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<BudgetSubscriptionFilterDimension>,
      ...
      'tags':
          ?pulumi.Input.mapOptionalInputValue<
            List<BudgetSubscriptionFilterTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
    ...
    return BudgetSubscriptionFilter(
      dimensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BudgetSubscriptionFilterDimension>(
            guardedValue,
            (value) => BudgetSubscriptionFilterDimension.fromMap(
      ...
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BudgetSubscriptionFilterTag>(
            guardedValue,
            (value) => BudgetSubscriptionFilterTag.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
