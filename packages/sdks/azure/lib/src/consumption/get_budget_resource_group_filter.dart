    ...
    return <String, dynamic>{
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetBudgetResourceGroupFilterDimension>,
      ...
      'nots':
          pulumi.Input.mapInputValue<
            List<GetBudgetResourceGroupFilterNot>,
            List<Map<String, dynamic>>
          >(
            nots,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetBudgetResourceGroupFilterTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetBudgetResourceGroupFilter.fromMap(Map<String, dynamic> map) {
    return GetBudgetResourceGroupFilter(
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetResourceGroupFilterDimension>(
          map['dimensions']!,
          (value) => GetBudgetResourceGroupFilterDimension.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nots: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetResourceGroupFilterNot>(
          map['nots']!,
          (value) => GetBudgetResourceGroupFilterNot.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetResourceGroupFilterTag>(
          map['tags']!,
          (value) => GetBudgetResourceGroupFilterTag.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
