...
class GetBudgetSubscriptionFilterNot {
  ...
  factory GetBudgetSubscriptionFilterNot.fromMap(Map<String, dynamic> map) {
    return GetBudgetSubscriptionFilterNot(
      dimensions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBudgetSubscriptionFilterNotDimension>(map['dimensions']!, (value) => GetBudgetSubscriptionFilterNotDimension.fromMap((value as Map).cast<String, dynamic>()))),
      tags: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBudgetSubscriptionFilterNotTag>(map['tags']!, (value) => GetBudgetSubscriptionFilterNotTag.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
