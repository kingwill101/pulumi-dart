    ...
    return <String, dynamic>{
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetBudgetSubscriptionFilterNotDimension>,
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetBudgetSubscriptionFilterNotTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetBudgetSubscriptionFilterNot.fromMap(Map<String, dynamic> map) {
    return GetBudgetSubscriptionFilterNot(
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetSubscriptionFilterNotDimension>(
          map['dimensions']!,
          (value) => GetBudgetSubscriptionFilterNotDimension.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetSubscriptionFilterNotTag>(
          map['tags']!,
          (value) => GetBudgetSubscriptionFilterNotTag.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
