    ...
    return <String, dynamic>{
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetBudgetSubscriptionFilterDimension>,
      ...
      'nots':
          pulumi.Input.mapInputValue<
            List<GetBudgetSubscriptionFilterNot>,
            List<Map<String, dynamic>>
          >(
            nots,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetBudgetSubscriptionFilterTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetBudgetSubscriptionFilter.fromMap(Map<String, dynamic> map) {
    return GetBudgetSubscriptionFilter(
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetSubscriptionFilterDimension>(
          map['dimensions']!,
          (value) => GetBudgetSubscriptionFilterDimension.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nots: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetSubscriptionFilterNot>(
          map['nots']!,
          (value) => GetBudgetSubscriptionFilterNot.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBudgetSubscriptionFilterTag>(
          map['tags']!,
          (value) => GetBudgetSubscriptionFilterTag.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
