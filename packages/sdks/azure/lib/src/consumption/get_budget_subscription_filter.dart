...
class GetBudgetSubscriptionFilter {
  ...
  factory GetBudgetSubscriptionFilter.fromMap(Map<String, dynamic> map) {
    return GetBudgetSubscriptionFilter(
      dimensions: (pulumi.Input.decodeList<GetBudgetSubscriptionFilterDimension>(map['dimensions'], (value) => GetBudgetSubscriptionFilterDimension.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nots: (pulumi.Input.decodeList<GetBudgetSubscriptionFilterNot>(map['nots'], (value) => GetBudgetSubscriptionFilterNot.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tags: (pulumi.Input.decodeList<GetBudgetSubscriptionFilterTag>(map['tags'], (value) => GetBudgetSubscriptionFilterTag.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
