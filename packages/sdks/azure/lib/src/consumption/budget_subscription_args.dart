...
class BudgetSubscriptionArgs {
  ...
  factory BudgetSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return BudgetSubscriptionArgs(
      ...
      notifications: pulumi.Input.fromValue(pulumi.Input.decodeList<BudgetSubscriptionNotification>(map['notifications']!, (value) => BudgetSubscriptionNotification.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      timePeriod: pulumi.Input.fromValue(BudgetSubscriptionTimePeriod.fromMap((map['timePeriod']! as Map).cast<String, dynamic>())),
    );
  }
}
