...
import 'server_extended_auditing_policy_args.dart';
import 'server_extended_auditing_policy_state.dart';
...
///   account_replication_type = "LRS"
/// }
/// resource "azure_mssql_serverextendedauditingpolicy" "example" {
...
class ServerExtendedAuditingPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ServerExtendedAuditingPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServerExtendedAuditingPolicy]. {@macro pulumi_mssql_server_extended_auditing_policy_server_extended_auditing_policy_args_doc}
  ...
  /// Gets an existing [ServerExtendedAuditingPolicy] resource's state with the given [name] and [id].
  static ServerExtendedAuditingPolicy get(
    String name,
  ...
  ServerExtendedAuditingPolicy._get(
    String name, {
