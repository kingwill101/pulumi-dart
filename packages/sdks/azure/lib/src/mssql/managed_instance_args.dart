...
/// {@template pulumi_mssql_managed_instance_managed_instance_args_doc}
...
class ManagedInstanceArgs {
  ...
  ManagedInstanceArgs({
    ...
    pulumi.Output<ManagedInstanceAzureActiveDirectoryAdministrator>? azureActiveDirectoryAdministrator,
    pulumi.Output<String>? collation,
    pulumi.Output<String>? databaseFormat,
    pulumi.Output<String>? dnsZonePartnerId,
    pulumi.Output<String>? hybridSecondaryUsage,
    pulumi.Output<ManagedInstanceIdentity>? identity,
    ...
    pulumi.Output<bool>? zoneRedundantEnabled,
      ...
      azureActiveDirectoryAdministrator = pulumi.Input.asOptionalInput<ManagedInstanceAzureActiveDirectoryAdministrator>(azureActiveDirectoryAdministrator),
      collation = pulumi.Input.asOptionalInput<String>(collation),
      databaseFormat = pulumi.Input.asOptionalInput<String>(databaseFormat),
      dnsZonePartnerId = pulumi.Input.asOptionalInput<String>(dnsZonePartnerId),
      hybridSecondaryUsage = pulumi.Input.asOptionalInput<String>(hybridSecondaryUsage),
      identity = pulumi.Input.asOptionalInput<ManagedInstanceIdentity>(identity),
  ...
  factory ManagedInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstanceArgs(
      ...
      azureActiveDirectoryAdministrator: map['azureActiveDirectoryAdministrator'] == null ? null : pulumi.Output.create<ManagedInstanceAzureActiveDirectoryAdministrator>(ManagedInstanceAzureActiveDirectoryAdministrator.fromMap((map['azureActiveDirectoryAdministrator'] as Map).cast<String, dynamic>())),
      ...
      dnsZonePartnerId: map['dnsZonePartnerId'] == null ? null : pulumi.Output.create<String>(map['dnsZonePartnerId'] as String),
      hybridSecondaryUsage: map['hybridSecondaryUsage'] == null ? null : pulumi.Output.create<String>(map['hybridSecondaryUsage'] as String),
      identity: map['identity'] == null ? null : pulumi.Output.create<ManagedInstanceIdentity>(ManagedInstanceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      servicePrincipalType: map['servicePrincipalType'] == null ? null : pulumi.Output.create<String>(map['servicePrincipalType'] as String),
      ...
      storageSizeInGb: pulumi.Output.create<int>(map['storageSizeInGb'] as int),
      ...
      zoneRedundantEnabled: map['zoneRedundantEnabled'] == null ? null : pulumi.Output.create<bool>(map['zoneRedundantEnabled'] as bool),
    );
  }
}
