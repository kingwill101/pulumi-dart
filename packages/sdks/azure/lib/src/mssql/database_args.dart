...
class DatabaseArgs {
  ...
  DatabaseArgs({
    pulumi.Output<int>? autoPauseDelayInMinutes,
    pulumi.Output<String>? collation,
    pulumi.Output<String>? createMode,
    pulumi.Output<String>? creationSourceDatabaseId,
    pulumi.Output<String>? elasticPoolId,
    pulumi.Output<String>? enclaveType,
    pulumi.Output<bool>? geoBackupEnabled,
    pulumi.Output<DatabaseIdentity>? identity,
    pulumi.Output<DatabaseImport>? import,
    pulumi.Output<bool>? ledgerEnabled,
    pulumi.Output<String>? licenseType,
    pulumi.Output<DatabaseLongTermRetentionPolicy>? longTermRetentionPolicy,
    pulumi.Output<String>? maintenanceConfigurationName,
    pulumi.Output<double>? maxSizeGb,
    pulumi.Output<double>? minCapacity,
    pulumi.Output<String>? name,
    pulumi.Output<int>? readReplicaCount,
    pulumi.Output<bool>? readScale,
    pulumi.Output<String>? recoverDatabaseId,
    pulumi.Output<String>? recoveryPointId,
    pulumi.Output<String>? restoreDroppedDatabaseId,
    pulumi.Output<String>? restoreLongTermRetentionBackupId,
    pulumi.Output<String>? restorePointInTime,
    pulumi.Output<String>? sampleName,
    pulumi.Output<String>? secondaryType,
    required pulumi.Output<String> serverId,
    pulumi.Output<DatabaseShortTermRetentionPolicy>? shortTermRetentionPolicy,
    pulumi.Output<String>? skuName,
    pulumi.Output<String>? storageAccountType,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<DatabaseThreatDetectionPolicy>? threatDetectionPolicy,
    pulumi.Output<bool>? transparentDataEncryptionEnabled,
    pulumi.Output<bool>? transparentDataEncryptionKeyAutomaticRotationEnabled,
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      autoPauseDelayInMinutes: map['autoPauseDelayInMinutes'] == null ? null : pulumi.Output.create<int>(map['autoPauseDelayInMinutes'] as int),
      ...
      creationSourceDatabaseId: map['creationSourceDatabaseId'] == null ? null : pulumi.Output.create<String>(map['creationSourceDatabaseId'] as String),
      elasticPoolId: map['elasticPoolId'] == null ? null : pulumi.Output.create<String>(map['elasticPoolId'] as String),
      enclaveType: map['enclaveType'] == null ? null : pulumi.Output.create<String>(map['enclaveType'] as String),
      geoBackupEnabled: map['geoBackupEnabled'] == null ? null : pulumi.Output.create<bool>(map['geoBackupEnabled'] as bool),
      identity: map['identity'] == null ? null : pulumi.Output.create<DatabaseIdentity>(DatabaseIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      import: map['import'] == null ? null : pulumi.Output.create<DatabaseImport>(DatabaseImport.fromMap((map['import'] as Map).cast<String, dynamic>())),
      ledgerEnabled: map['ledgerEnabled'] == null ? null : pulumi.Output.create<bool>(map['ledgerEnabled'] as bool),
      licenseType: map['licenseType'] == null ? null : pulumi.Output.create<String>(map['licenseType'] as String),
      longTermRetentionPolicy: map['longTermRetentionPolicy'] == null ? null : pulumi.Output.create<DatabaseLongTermRetentionPolicy>(DatabaseLongTermRetentionPolicy.fromMap((map['longTermRetentionPolicy'] as Map).cast<String, dynamic>())),
      ...
      readReplicaCount: map['readReplicaCount'] == null ? null : pulumi.Output.create<int>(map['readReplicaCount'] as int),
      readScale: map['readScale'] == null ? null : pulumi.Output.create<bool>(map['readScale'] as bool),
      recoverDatabaseId: map['recoverDatabaseId'] == null ? null : pulumi.Output.create<String>(map['recoverDatabaseId'] as String),
      recoveryPointId: map['recoveryPointId'] == null ? null : pulumi.Output.create<String>(map['recoveryPointId'] as String),
      restoreDroppedDatabaseId: map['restoreDroppedDatabaseId'] == null ? null : pulumi.Output.create<String>(map['restoreDroppedDatabaseId'] as String),
      restoreLongTermRetentionBackupId: map['restoreLongTermRetentionBackupId'] == null ? null : pulumi.Output.create<String>(map['restoreLongTermRetentionBackupId'] as String),
      restorePointInTime: map['restorePointInTime'] == null ? null : pulumi.Output.create<String>(map['restorePointInTime'] as String),
      sampleName: map['sampleName'] == null ? null : pulumi.Output.create<String>(map['sampleName'] as String),
      ...
      shortTermRetentionPolicy: map['shortTermRetentionPolicy'] == null ? null : pulumi.Output.create<DatabaseShortTermRetentionPolicy>(DatabaseShortTermRetentionPolicy.fromMap((map['shortTermRetentionPolicy'] as Map).cast<String, dynamic>())),
      ...
      threatDetectionPolicy: map['threatDetectionPolicy'] == null ? null : pulumi.Output.create<DatabaseThreatDetectionPolicy>(DatabaseThreatDetectionPolicy.fromMap((map['threatDetectionPolicy'] as Map).cast<String, dynamic>())),
      transparentDataEncryptionEnabled: map['transparentDataEncryptionEnabled'] == null ? null : pulumi.Output.create<bool>(map['transparentDataEncryptionEnabled'] as bool),
      transparentDataEncryptionKeyAutomaticRotationEnabled: map['transparentDataEncryptionKeyAutomaticRotationEnabled'] == null ? null : pulumi.Output.create<bool>(map['transparentDataEncryptionKeyAutomaticRotationEnabled'] as bool),
