...
class FailoverGroupState {
  ...
  final pulumi.Input<FailoverGroupReadWriteEndpointFailoverPolicy>?
    ...
    return <String, dynamic>{
      ...
      'partnerServers':
          ?pulumi.Input.mapOptionalInputValue<
            List<FailoverGroupPartnerServer>,
  ...
  factory FailoverGroupState.fromMap(Map<String, dynamic> map) {
    return FailoverGroupState(
      ...
      partnerServers: (() {
        final guardedValue = map['partnerServers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FailoverGroupPartnerServer>(
            guardedValue,
            (value) => FailoverGroupPartnerServer.fromMap(
      ...
      readWriteEndpointFailoverPolicy: (() {
        final guardedValue = map['readWriteEndpointFailoverPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FailoverGroupReadWriteEndpointFailoverPolicy.fromMap(
