...
class VirtualMachineStorageConfiguration {
  ...
  factory VirtualMachineStorageConfiguration.fromMap(Map<String, dynamic> map) {
    return VirtualMachineStorageConfiguration(
      dataSettings: (() { final guardedValue = map['dataSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineStorageConfigurationDataSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      diskType: pulumi.Input.fromValue(map['diskType'] as String),
      logSettings: (() { final guardedValue = map['logSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineStorageConfigurationLogSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      storageWorkloadType: pulumi.Input.fromValue(map['storageWorkloadType'] as String),
      systemDbOnDataDiskEnabled: (() { final guardedValue = map['systemDbOnDataDiskEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tempDbSettings: (() { final guardedValue = map['tempDbSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineStorageConfigurationTempDbSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
