...
class VirtualMachineWsfcDomainCredential {
  ...
  factory VirtualMachineWsfcDomainCredential.fromMap(Map<String, dynamic> map) {
    return VirtualMachineWsfcDomainCredential(
      clusterBootstrapAccountPassword: pulumi.Input.fromValue(
        map['clusterBootstrapAccountPassword'] as String,
      ),
      clusterOperatorAccountPassword: pulumi.Input.fromValue(
        map['clusterOperatorAccountPassword'] as String,
      ),
      sqlServiceAccountPassword: pulumi.Input.fromValue(
        map['sqlServiceAccountPassword'] as String,
      ),
    );
  }
}
