...
class VirtualMachineAvailabilityGroupListenerState {
  ...
  VirtualMachineAvailabilityGroupListenerState({
    ...
    pulumi.Output<List<VirtualMachineAvailabilityGroupListenerReplica>>? replicas,
    pulumi.Output<String>? sqlVirtualMachineGroupId,
      ...
      replicas = pulumi.Input.asOptionalInput<List<VirtualMachineAvailabilityGroupListenerReplica>>(replicas),
  ...
  factory VirtualMachineAvailabilityGroupListenerState.fromMap(Map<String, dynamic> map) {
    return VirtualMachineAvailabilityGroupListenerState(
      ...
      replicas: map['replicas'] == null ? null : pulumi.Output.create<List<VirtualMachineAvailabilityGroupListenerReplica>>(pulumi.Input.decodeList<VirtualMachineAvailabilityGroupListenerReplica>(map['replicas'], (value) => VirtualMachineAvailabilityGroupListenerReplica.fromMap((value as Map).cast<String, dynamic>()))),
