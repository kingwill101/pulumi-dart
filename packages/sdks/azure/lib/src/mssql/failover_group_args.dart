...
class FailoverGroupArgs {
  ...
  factory FailoverGroupArgs.fromMap(Map<String, dynamic> map) {
    return FailoverGroupArgs(
      ...
      partnerServers: pulumi.Input.fromValue(pulumi.Input.decodeList<FailoverGroupPartnerServer>(map['partnerServers']!, (value) => FailoverGroupPartnerServer.fromMap((value as Map).cast<String, dynamic>()))),
      readWriteEndpointFailoverPolicy: pulumi.Input.fromValue(FailoverGroupReadWriteEndpointFailoverPolicy.fromMap((map['readWriteEndpointFailoverPolicy']! as Map).cast<String, dynamic>())),
