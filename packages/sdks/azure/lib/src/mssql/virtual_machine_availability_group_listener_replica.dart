...
class VirtualMachineAvailabilityGroupListenerReplica {
  ...
  factory VirtualMachineAvailabilityGroupListenerReplica.fromMap(
    ...
    return VirtualMachineAvailabilityGroupListenerReplica(
      ...
      readableSecondary: pulumi.Input.fromValue(
        map['readableSecondary'] as String,
      ),
      role: pulumi.Input.fromValue(map['role'] as String),
      sqlVirtualMachineId: pulumi.Input.fromValue(
        map['sqlVirtualMachineId'] as String,
      ),
    );
  }
}
