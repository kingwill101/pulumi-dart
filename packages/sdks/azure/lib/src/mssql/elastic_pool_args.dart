...
class ElasticPoolArgs {
  ...
  factory ElasticPoolArgs.fromMap(Map<String, dynamic> map) {
    return ElasticPoolArgs(
      ...
      maxSizeBytes: (() { final guardedValue = map['maxSizeBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      perDatabaseSettings: pulumi.Input.fromValue(ElasticPoolPerDatabaseSettings.fromMap((map['perDatabaseSettings']! as Map).cast<String, dynamic>())),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      serverName: pulumi.Input.fromValue(map['serverName'] as String),
      sku: pulumi.Input.fromValue(ElasticPoolSku.fromMap((map['sku']! as Map).cast<String, dynamic>())),
