...
class ElasticPoolArgs {
    ...
    return <String, dynamic>{
      ...
      'perDatabaseSettings':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(perDatabaseSettings, (value) => value.toMap()),
      'resourceGroupName': resourceGroupName,
      'serverName': serverName,
      'sku': pulumi.Input.mapInputValue<ElasticPoolSku, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
      'tags': ?tags,
  ...
  factory ElasticPoolArgs.fromMap(Map<String, dynamic> map) {
    return ElasticPoolArgs(
      enclaveType: (() {
        final guardedValue = map['enclaveType'];
      ...
      maxSizeGb: (() {
        final guardedValue = map['maxSizeGb'];
        if (guardedValue == null) return null;
      ...
      perDatabaseSettings: pulumi.Input.fromValue(
        ElasticPoolPerDatabaseSettings.fromMap(
          (map['perDatabaseSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      sku: pulumi.Input.fromValue(
        ElasticPoolSku.fromMap((map['sku']! as Map).cast<String, dynamic>()),
      ),
      tags: (() {
