...
class VirtualMachineAvailabilityGroupListenerArgs {
  ...
  final pulumi.Input<List<VirtualMachineAvailabilityGroupListenerReplica>>
  replicas;
    ...
    return <String, dynamic>{
      ...
      'loadBalancerConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            VirtualMachineAvailabilityGroupListenerLoadBalancerConfiguration,
            Map<String, dynamic>
          >(loadBalancerConfiguration, (value) => value.toMap()),
      'multiSubnetIpConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<
      ...
      'replicas':
          pulumi.Input.mapInputValue<
            List<VirtualMachineAvailabilityGroupListenerReplica>,
            List<Map<String, dynamic>>
          >(
            replicas,
            (value) =>
  ...
  factory VirtualMachineAvailabilityGroupListenerArgs.fromMap(
    ...
    return VirtualMachineAvailabilityGroupListenerArgs(
      ...
      loadBalancerConfiguration: (() {
        final guardedValue = map['loadBalancerConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineAvailabilityGroupListenerLoadBalancerConfiguration.fromMap(
      ...
      multiSubnetIpConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VirtualMachineAvailabilityGroupListenerMultiSubnetIpConfiguration.fromMap(
      ...
      replicas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VirtualMachineAvailabilityGroupListenerReplica>(
          map['replicas']!,
          (value) => VirtualMachineAvailabilityGroupListenerReplica.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      sqlVirtualMachineGroupId: pulumi.Input.fromValue(
        map['sqlVirtualMachineGroupId'] as String,
      ),
    );
  }
}
