...
class ServerState {
  ...
  ServerState({
    ...
    pulumi.Output<List<String>>? restorableDroppedDatabaseIds,
    ...
    pulumi.Output<String>? version,
      ...
      restorableDroppedDatabaseIds = pulumi.Input.asOptionalInput<List<String>>(restorableDroppedDatabaseIds),
  ...
  factory ServerState.fromMap(Map<String, dynamic> map) {
    return ServerState(
      ...
      restorableDroppedDatabaseIds: map['restorableDroppedDatabaseIds'] == null ? null : pulumi.Output.create<List<String>>((map['restorableDroppedDatabaseIds'] as List).cast<String>()),
