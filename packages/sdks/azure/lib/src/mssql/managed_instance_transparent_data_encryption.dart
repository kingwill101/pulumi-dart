...
import 'managed_instance_transparent_data_encryption_state.dart';
...
class ManagedInstanceTransparentDataEncryption extends pulumi.CustomResource {
  ...
  static ManagedInstanceTransparentDataEncryption get(
    String name,
  ...
  ManagedInstanceTransparentDataEncryption._get(
    String name, {
