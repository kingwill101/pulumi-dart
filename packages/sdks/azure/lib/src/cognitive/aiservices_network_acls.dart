...
class AIServicesNetworkAcls {
  ...
  final pulumi.Input<List<AIServicesNetworkAclsVirtualNetworkRule>>?
  virtualNetworkRules;
    ...
    return <String, dynamic>{
      ...
      'virtualNetworkRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AIServicesNetworkAclsVirtualNetworkRule>,
    ...
    return AIServicesNetworkAcls(
      ...
      virtualNetworkRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AIServicesNetworkAclsVirtualNetworkRule>(
            guardedValue,
            (value) => AIServicesNetworkAclsVirtualNetworkRule.fromMap(
