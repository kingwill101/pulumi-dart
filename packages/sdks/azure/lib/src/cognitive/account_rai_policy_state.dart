...
class AccountRaiPolicyState {
  ...
  factory AccountRaiPolicyState.fromMap(Map<String, dynamic> map) {
    return AccountRaiPolicyState(
      ...
      contentFilters: (() { final guardedValue = map['contentFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccountRaiPolicyContentFilter>(guardedValue, (value) => AccountRaiPolicyContentFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
