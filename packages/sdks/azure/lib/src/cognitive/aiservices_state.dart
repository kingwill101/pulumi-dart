    ...
    return AIServicesState(
      ...
      customerManagedKey: (() {
        ...
        return pulumi.Input.fromValue(
          AIServicesCustomerManagedKey.fromMap(
      ...
      storages: (() {
        final guardedValue = map['storages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AIServicesStorage>(
            guardedValue,
            (value) => AIServicesStorage.fromMap(
