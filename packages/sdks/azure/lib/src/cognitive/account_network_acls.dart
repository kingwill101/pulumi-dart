...
class AccountNetworkAcls {
  ...
  final pulumi.Input<List<AccountNetworkAclsVirtualNetworkRule>>?
  virtualNetworkRules;
    ...
    return <String, dynamic>{
      ...
      'virtualNetworkRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccountNetworkAclsVirtualNetworkRule>,
    ...
    return AccountNetworkAcls(
      ...
      virtualNetworkRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountNetworkAclsVirtualNetworkRule>(
            guardedValue,
            (value) => AccountNetworkAclsVirtualNetworkRule.fromMap(
