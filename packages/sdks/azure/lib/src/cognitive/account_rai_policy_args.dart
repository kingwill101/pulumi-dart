...
class AccountRaiPolicyArgs {
  ...
  factory AccountRaiPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AccountRaiPolicyArgs(
      ...
      contentFilters: pulumi.Input.fromValue(pulumi.Input.decodeList<AccountRaiPolicyContentFilter>(map['contentFilters']!, (value) => AccountRaiPolicyContentFilter.fromMap((value as Map).cast<String, dynamic>()))),
