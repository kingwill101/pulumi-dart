...
class AccountConnectionEntraIdState {
  ...
  /// Creates a new [AccountConnectionEntraIdState].
  ...
  const AccountConnectionEntraIdState({
    this.category,
  ...
  factory AccountConnectionEntraIdState.fromMap(Map<String, dynamic> map) {
    return AccountConnectionEntraIdState(
