...
class GetAccountNetworkAcl {
  ...
  final pulumi.Input<List<GetAccountNetworkAclVirtualNetworkRule>>
  virtualNetworkRules;
    ...
    return <String, dynamic>{
      ...
      'virtualNetworkRules':
          pulumi.Input.mapInputValue<
            List<GetAccountNetworkAclVirtualNetworkRule>,
  ...
  factory GetAccountNetworkAcl.fromMap(Map<String, dynamic> map) {
    return GetAccountNetworkAcl(
      ...
      virtualNetworkRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAccountNetworkAclVirtualNetworkRule>(
          map['virtualNetworkRules']!,
          (value) => GetAccountNetworkAclVirtualNetworkRule.fromMap(
