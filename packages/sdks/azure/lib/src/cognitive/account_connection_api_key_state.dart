...
class AccountConnectionApiKeyState {
  ...
  /// Creates a new [AccountConnectionApiKeyState].
  ...
  const AccountConnectionApiKeyState({
    this.apiKey,
    this.category,
  ...
  factory AccountConnectionApiKeyState.fromMap(Map<String, dynamic> map) {
    return AccountConnectionApiKeyState(
