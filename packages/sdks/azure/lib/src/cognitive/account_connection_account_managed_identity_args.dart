...
/// {@template pulumi_cognitive_account_connection_account_managed_identity_account_connection_account_managed_identity_args_doc}
/// The set of arguments for AccountConnectionAccountManagedIdentity.
/// {@endtemplate}
/// {@macro pulumi_cognitive_account_connection_account_managed_identity_account_connection_account_managed_identity_args_doc}
class AccountConnectionAccountManagedIdentityArgs {
  ...
  /// Creates a new [AccountConnectionAccountManagedIdentityArgs].
  /// [category] The category of the connection. Possible values are `AIServices`, `AzureKeyVault`, `AzureOpenAI`, and `AzureStorageAccount`. Changing this forces a new resource to be created.
  ...
  const AccountConnectionAccountManagedIdentityArgs({
  ...
  factory AccountConnectionAccountManagedIdentityArgs.fromMap(Map<String, dynamic> map) {
    return AccountConnectionAccountManagedIdentityArgs(
