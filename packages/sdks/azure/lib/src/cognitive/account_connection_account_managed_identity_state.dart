...
class AccountConnectionAccountManagedIdentityState {
  ...
  /// Creates a new [AccountConnectionAccountManagedIdentityState].
  ...
  const AccountConnectionAccountManagedIdentityState({
    this.category,
  ...
  factory AccountConnectionAccountManagedIdentityState.fromMap(Map<String, dynamic> map) {
    return AccountConnectionAccountManagedIdentityState(
