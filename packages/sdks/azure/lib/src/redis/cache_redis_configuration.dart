...
class CacheRedisConfiguration {
  ...
  factory CacheRedisConfiguration.fromMap(Map<String, dynamic> map) {
    return CacheRedisConfiguration(
      ...
      maxclients: (() { final guardedValue = map['maxclients']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxfragmentationmemoryReserved: (() { final guardedValue = map['maxfragmentationmemoryReserved']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxmemoryDelta: (() { final guardedValue = map['maxmemoryDelta']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      maxmemoryReserved: (() { final guardedValue = map['maxmemoryReserved']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      rdbBackupFrequency: (() { final guardedValue = map['rdbBackupFrequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      rdbBackupMaxSnapshotCount: (() { final guardedValue = map['rdbBackupMaxSnapshotCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
