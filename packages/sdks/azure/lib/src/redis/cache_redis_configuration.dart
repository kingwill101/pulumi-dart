...
class CacheRedisConfiguration {
  ...
  factory CacheRedisConfiguration.fromMap(Map<String, dynamic> map) {
    return CacheRedisConfiguration(
      activeDirectoryAuthenticationEnabled: (() {
        final guardedValue = map['activeDirectoryAuthenticationEnabled'];
      ...
      authenticationEnabled: (() {
        final guardedValue = map['authenticationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dataPersistenceAuthenticationMethod: (() {
        final guardedValue = map['dataPersistenceAuthenticationMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxclients: (() {
        final guardedValue = map['maxclients'];
        if (guardedValue == null) return null;
