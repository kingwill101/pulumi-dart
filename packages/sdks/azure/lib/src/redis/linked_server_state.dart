...
class LinkedServerState {
  ...
  factory LinkedServerState.fromMap(Map<String, dynamic> map) {
    return LinkedServerState(
      geoReplicatedPrimaryHostName: (() { final guardedValue = map['geoReplicatedPrimaryHostName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      linkedRedisCacheId: (() { final guardedValue = map['linkedRedisCacheId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      linkedRedisCacheLocation: (() { final guardedValue = map['linkedRedisCacheLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: (() { final guardedValue = map['resourceGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serverRole: (() { final guardedValue = map['serverRole']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      targetRedisCacheName: (() { final guardedValue = map['targetRedisCacheName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
