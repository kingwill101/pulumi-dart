...
class GetCacheResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'patchSchedules':
          pulumi.Input.encodeList<GetCachePatchSchedule, Map<String, dynamic>>(
            patchSchedules,
            (value) => value.toMap(),
          ),
      'port': port,
      ...
      'redisConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(redisConfigurations, (value) => value.toMap()),
  ...
  factory GetCacheResult.fromMap(Map<String, dynamic> map) {
    return GetCacheResult(
      ...
      patchSchedules: pulumi.Input.decodeList<GetCachePatchSchedule>(
        map['patchSchedules']!,
        (value) => GetCachePatchSchedule.fromMap(
      ...
      redisConfigurations: pulumi.Input.decodeList<GetCacheRedisConfiguration>(
        map['redisConfigurations']!,
        (value) => GetCacheRedisConfiguration.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
