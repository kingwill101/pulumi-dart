  ...
  factory EnterpriseDatabaseState.fromMap(Map<String, dynamic> map) {
    return EnterpriseDatabaseState(
      ...
      linkedDatabaseGroupNickname: (() {
        final guardedValue = map['linkedDatabaseGroupNickname'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      linkedDatabaseIds: (() {
        final guardedValue = map['linkedDatabaseIds'];
        if (guardedValue == null) return null;
      ...
      modules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnterpriseDatabaseModule>(
            guardedValue,
            (value) => EnterpriseDatabaseModule.fromMap(
