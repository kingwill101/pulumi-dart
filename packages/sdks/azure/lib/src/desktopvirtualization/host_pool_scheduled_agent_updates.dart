...
class HostPoolScheduledAgentUpdates {
  ...
  final List<HostPoolScheduledAgentUpdatesSchedule>? schedules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enabled': ?enabled,
      'schedules': ?schedules == null ? null : pulumi.Input.encodeList<HostPoolScheduledAgentUpdatesSchedule, Map<String, dynamic>>(schedules!, (value) => value.toMap()),
      'timezone': ?timezone,
  ...
  factory HostPoolScheduledAgentUpdates.fromMap(Map<String, dynamic> map) {
    return HostPoolScheduledAgentUpdates(
      ...
      schedules: map['schedules'] == null ? null : pulumi.Input.decodeList<HostPoolScheduledAgentUpdatesSchedule>(map['schedules'], (value) => HostPoolScheduledAgentUpdatesSchedule.fromMap((value as Map).cast<String, dynamic>())),
      timezone: map['timezone'] == null ? null : map['timezone'] as String,
      useSessionHostTimezone: map['useSessionHostTimezone'] == null ? null : map['useSessionHostTimezone'] as bool,
    );
  }
}
