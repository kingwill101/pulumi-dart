...
class HostPoolState {
  ...
  factory HostPoolState.fromMap(Map<String, dynamic> map) {
    return HostPoolState(
      ...
      maximumSessionsAllowed: (() { final guardedValue = map['maximumSessionsAllowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
