...
class HostPoolState {
  ...
  factory HostPoolState.fromMap(Map<String, dynamic> map) {
    return HostPoolState(
      customRdpProperties: (() { final guardedValue = map['customRdpProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      maximumSessionsAllowed: (() { final guardedValue = map['maximumSessionsAllowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      preferredAppGroupType: (() { final guardedValue = map['preferredAppGroupType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publicNetworkAccess: (() { final guardedValue = map['publicNetworkAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: (() { final guardedValue = map['resourceGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scheduledAgentUpdates: (() { final guardedValue = map['scheduledAgentUpdates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostPoolScheduledAgentUpdates.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      validateEnvironment: (() { final guardedValue = map['validateEnvironment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
