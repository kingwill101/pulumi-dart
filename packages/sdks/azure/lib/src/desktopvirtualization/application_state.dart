...
class ApplicationState {
  ...
  factory ApplicationState.fromMap(Map<String, dynamic> map) {
    return ApplicationState(
      ...
      commandLineArgumentPolicy: (() { final guardedValue = map['commandLineArgumentPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      iconIndex: (() { final guardedValue = map['iconIndex']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
