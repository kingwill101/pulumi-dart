...
class ScalingPlanSchedule {
  ...
  final int rampDownCapacityThresholdPercent;
  ...
  final int rampDownMinimumHostsPercent;
  ...
  final String rampDownStartTime;
  ...
  final int? rampUpCapacityThresholdPercent;
  ...
  final int? rampUpMinimumHostsPercent;
  ...
  factory ScalingPlanSchedule.fromMap(Map<String, dynamic> map) {
    return ScalingPlanSchedule(
      ...
      offPeakLoadBalancingAlgorithm: map['offPeakLoadBalancingAlgorithm'] as String,
      offPeakStartTime: map['offPeakStartTime'] as String,
      peakLoadBalancingAlgorithm: map['peakLoadBalancingAlgorithm'] as String,
      peakStartTime: map['peakStartTime'] as String,
      rampDownCapacityThresholdPercent: map['rampDownCapacityThresholdPercent'] as int,
      rampDownForceLogoffUsers: map['rampDownForceLogoffUsers'] as bool,
      rampDownLoadBalancingAlgorithm: map['rampDownLoadBalancingAlgorithm'] as String,
      rampDownMinimumHostsPercent: map['rampDownMinimumHostsPercent'] as int,
      rampDownNotificationMessage: map['rampDownNotificationMessage'] as String,
      rampDownStartTime: map['rampDownStartTime'] as String,
      rampDownStopHostsWhen: map['rampDownStopHostsWhen'] as String,
      rampDownWaitTimeMinutes: map['rampDownWaitTimeMinutes'] as int,
      rampUpCapacityThresholdPercent: map['rampUpCapacityThresholdPercent'] == null ? null : map['rampUpCapacityThresholdPercent'] as int,
      rampUpLoadBalancingAlgorithm: map['rampUpLoadBalancingAlgorithm'] as String,
      rampUpMinimumHostsPercent: map['rampUpMinimumHostsPercent'] == null ? null : map['rampUpMinimumHostsPercent'] as int,
      rampUpStartTime: map['rampUpStartTime'] as String,
    );
  }
}
