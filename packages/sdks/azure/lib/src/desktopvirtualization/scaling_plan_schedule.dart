...
class ScalingPlanSchedule {
  ...
  factory ScalingPlanSchedule.fromMap(Map<String, dynamic> map) {
    return ScalingPlanSchedule(
      ...
      offPeakLoadBalancingAlgorithm: (map['offPeakLoadBalancingAlgorithm'] as String).input(),
      offPeakStartTime: (map['offPeakStartTime'] as String).input(),
      peakLoadBalancingAlgorithm: (map['peakLoadBalancingAlgorithm'] as String).input(),
      peakStartTime: (map['peakStartTime'] as String).input(),
      rampDownCapacityThresholdPercent: (map['rampDownCapacityThresholdPercent'] as int).input(),
      rampDownForceLogoffUsers: (map['rampDownForceLogoffUsers'] as bool).input(),
      rampDownLoadBalancingAlgorithm: (map['rampDownLoadBalancingAlgorithm'] as String).input(),
      rampDownMinimumHostsPercent: (map['rampDownMinimumHostsPercent'] as int).input(),
      rampDownNotificationMessage: (map['rampDownNotificationMessage'] as String).input(),
