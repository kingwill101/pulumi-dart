...
class ScalingPlanSchedule {
  ...
  factory ScalingPlanSchedule.fromMap(Map<String, dynamic> map) {
    return ScalingPlanSchedule(
      ...
      offPeakLoadBalancingAlgorithm: pulumi.Input.fromValue(
        map['offPeakLoadBalancingAlgorithm'] as String,
      ),
      offPeakStartTime: pulumi.Input.fromValue(
        map['offPeakStartTime'] as String,
      ),
      peakLoadBalancingAlgorithm: pulumi.Input.fromValue(
        map['peakLoadBalancingAlgorithm'] as String,
      ),
      peakStartTime: pulumi.Input.fromValue(map['peakStartTime'] as String),
      rampDownCapacityThresholdPercent: pulumi.Input.fromValue(
        map['rampDownCapacityThresholdPercent'] as int,
      ),
      rampDownForceLogoffUsers: pulumi.Input.fromValue(
        map['rampDownForceLogoffUsers'] as bool,
      ),
      rampDownLoadBalancingAlgorithm: pulumi.Input.fromValue(
        map['rampDownLoadBalancingAlgorithm'] as String,
      ),
      rampDownMinimumHostsPercent: pulumi.Input.fromValue(
        map['rampDownMinimumHostsPercent'] as int,
      ),
      rampDownNotificationMessage: pulumi.Input.fromValue(
        map['rampDownNotificationMessage'] as String,
      ),
      rampDownStartTime: pulumi.Input.fromValue(
        map['rampDownStartTime'] as String,
      ),
      rampDownStopHostsWhen: pulumi.Input.fromValue(
        map['rampDownStopHostsWhen'] as String,
      ),
      rampDownWaitTimeMinutes: pulumi.Input.fromValue(
        map['rampDownWaitTimeMinutes'] as int,
      ),
      rampUpCapacityThresholdPercent: (() {
        final guardedValue = map['rampUpCapacityThresholdPercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      rampUpLoadBalancingAlgorithm: pulumi.Input.fromValue(
        map['rampUpLoadBalancingAlgorithm'] as String,
      ),
      rampUpMinimumHostsPercent: (() {
        final guardedValue = map['rampUpMinimumHostsPercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
