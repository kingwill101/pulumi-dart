...
class AccountState {
  ...
  factory AccountState.fromMap(Map<String, dynamic> map) {
    return AccountState(
      atlasKafkaEndpointPrimaryConnectionString: (() {
        final guardedValue = map['atlasKafkaEndpointPrimaryConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      atlasKafkaEndpointSecondaryConnectionString: (() {
        final guardedValue = map['atlasKafkaEndpointSecondaryConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      awsExternalId: (() {
        final guardedValue = map['awsExternalId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      catalogEndpoint: (() {
        final guardedValue = map['catalogEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      guardianEndpoint: (() {
        final guardedValue = map['guardianEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      identity: (() {
      ...
      managedResources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountManagedResource>(
            guardedValue,
            (value) => AccountManagedResource.fromMap(
      ...
      scanEndpoint: (() {
        final guardedValue = map['scanEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
