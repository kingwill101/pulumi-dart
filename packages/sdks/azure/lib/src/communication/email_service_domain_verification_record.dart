...
class EmailServiceDomainVerificationRecord {
    ...
    return <String, dynamic>{
      'dkim2s':
          ?pulumi.Input.mapOptionalInputValue<
            List<EmailServiceDomainVerificationRecordDkim2>,
      ...
      'dkims':
          ?pulumi.Input.mapOptionalInputValue<
            List<EmailServiceDomainVerificationRecordDkim>,
            List<Map<String, dynamic>>
          >(
            dkims,
            (value) =>
      ...
      'dmarcs':
          ?pulumi.Input.mapOptionalInputValue<
            List<EmailServiceDomainVerificationRecordDmarc>,
            List<Map<String, dynamic>>
          >(
            dmarcs,
            (value) =>
      ...
      'domains':
          ?pulumi.Input.mapOptionalInputValue<
            List<EmailServiceDomainVerificationRecordDomain>,
            List<Map<String, dynamic>>
          >(
            domains,
            (value) =>
      ...
      'spfs':
          ?pulumi.Input.mapOptionalInputValue<
            List<EmailServiceDomainVerificationRecordSpf>,
            List<Map<String, dynamic>>
          >(
            spfs,
            (value) =>
  ...
  factory EmailServiceDomainVerificationRecord.fromMap(
    Map<String, dynamic> map,
  ) {
    return EmailServiceDomainVerificationRecord(
      dkim2s: (() {
        final guardedValue = map['dkim2s'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EmailServiceDomainVerificationRecordDkim2>(
            guardedValue,
            (value) => EmailServiceDomainVerificationRecordDkim2.fromMap(
      ...
      dkims: (() {
        final guardedValue = map['dkims'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EmailServiceDomainVerificationRecordDkim>(
            guardedValue,
            (value) => EmailServiceDomainVerificationRecordDkim.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      dmarcs: (() {
        final guardedValue = map['dmarcs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EmailServiceDomainVerificationRecordDmarc>(
            guardedValue,
            (value) => EmailServiceDomainVerificationRecordDmarc.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      domains: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EmailServiceDomainVerificationRecordDomain>(
            guardedValue,
            (value) => EmailServiceDomainVerificationRecordDomain.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      spfs: (() {
        final guardedValue = map['spfs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EmailServiceDomainVerificationRecordSpf>(
            guardedValue,
            (value) => EmailServiceDomainVerificationRecordSpf.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
