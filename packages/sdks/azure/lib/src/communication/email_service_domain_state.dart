...
class EmailServiceDomainState {
  ...
  final pulumi.Input<List<EmailServiceDomainVerificationRecord>>?
  verificationRecords;
    ...
    return <String, dynamic>{
      ...
      'verificationRecords':
          ?pulumi.Input.mapOptionalInputValue<
            List<EmailServiceDomainVerificationRecord>,
  ...
  factory EmailServiceDomainState.fromMap(Map<String, dynamic> map) {
    return EmailServiceDomainState(
      domainManagement: (() {
        final guardedValue = map['domainManagement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emailServiceId: (() {
        final guardedValue = map['emailServiceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fromSenderDomain: (() {
        final guardedValue = map['fromSenderDomain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mailFromSenderDomain: (() {
        final guardedValue = map['mailFromSenderDomain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      verificationRecords: (() {
        final guardedValue = map['verificationRecords'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EmailServiceDomainVerificationRecord>(
            guardedValue,
            (value) => EmailServiceDomainVerificationRecord.fromMap(
