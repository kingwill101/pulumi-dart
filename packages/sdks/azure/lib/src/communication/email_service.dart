...
import 'email_service_state.dart';
...
class EmailService extends pulumi.CustomResource {
  ...
  /// Gets an existing [EmailService] resource's state with the given [name] and [id].
  static EmailService get(
    String name,
    pulumi.Input<String> id, {
    EmailServiceState? state,
  }) {
    return EmailService._get(
      name,
      state: state?.toMap(),
