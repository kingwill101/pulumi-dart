...
class ServicesCommunicationsGateway extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ServicesCommunicationsGatewayServiceLocation>> serviceLocations;
  ...
  ServicesCommunicationsGateway(
    ...
    this.microsoftTeamsVoicemailPilotNumber = registerOutput<String?>('microsoftTeamsVoicemailPilotNumber');
    ...
    this.serviceLocations = registerOutput<List<ServicesCommunicationsGatewayServiceLocation>>('serviceLocations');
