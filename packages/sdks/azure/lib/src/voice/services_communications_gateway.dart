...
class ServicesCommunicationsGateway extends pulumi.CustomResource {
  ...
  ServicesCommunicationsGateway(
    ...
    emergencyDialStrings = registerOutput<List<String>?>('emergencyDialStrings');
    location = registerOutput<String>('location');
    microsoftTeamsVoicemailPilotNumber = registerOutput<String?>('microsoftTeamsVoicemailPilotNumber');
    this.name = registerOutput<String>('name');
    onPremMcpEnabled = registerOutput<bool?>('onPremMcpEnabled');
    platforms = registerOutput<List<String>>('platforms');
    resourceGroupName = registerOutput<String>('resourceGroupName');
    serviceLocations = registerOutput<List<Map<String, dynamic>>>('serviceLocations');
