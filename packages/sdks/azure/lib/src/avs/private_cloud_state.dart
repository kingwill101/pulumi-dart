...
class PrivateCloudState {
  ...
  factory PrivateCloudState.fromMap(Map<String, dynamic> map) {
    return PrivateCloudState(
      circuits: (() {
        final guardedValue = map['circuits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateCloudCircuit>(
            guardedValue,
            (value) => PrivateCloudCircuit.fromMap(
      ...
      hcxCloudManagerEndpoint: (() {
        final guardedValue = map['hcxCloudManagerEndpoint'];
        if (guardedValue == null) return null;
      ...
      managementSubnetCidr: (() {
        final guardedValue = map['managementSubnetCidr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      networkSubnetCidr: (() {
        final guardedValue = map['networkSubnetCidr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nsxtCertificateThumbprint: (() {
        final guardedValue = map['nsxtCertificateThumbprint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nsxtManagerEndpoint: (() {
        final guardedValue = map['nsxtManagerEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nsxtPassword: (() {
      ...
      provisioningSubnetCidr: (() {
        final guardedValue = map['provisioningSubnetCidr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceGroupName: (() {
      ...
      vcenterCertificateThumbprint: (() {
        final guardedValue = map['vcenterCertificateThumbprint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vcenterPassword: (() {
      ...
      vcsaEndpoint: (() {
        final guardedValue = map['vcsaEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vmotionSubnetCidr: (() {
        final guardedValue = map['vmotionSubnetCidr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
