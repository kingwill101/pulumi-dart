...
class PrivateCloud extends pulumi.CustomResource {
  ...
  PrivateCloud(
    ...
    this.circuits = registerOutput<List<PrivateCloudCircuit>>('circuits');
    this.hcxCloudManagerEndpoint = registerOutput<String>('hcxCloudManagerEndpoint');
    this.internetConnectionEnabled = registerOutput<bool?>('internetConnectionEnabled');
    this.location = registerOutput<String>('location');
    this.managementCluster = registerOutput<PrivateCloudManagementCluster>('managementCluster');
    this.managementSubnetCidr = registerOutput<String>('managementSubnetCidr');
    this.name = registerOutput<String>('name');
    this.networkSubnetCidr = registerOutput<String>('networkSubnetCidr');
    this.nsxtCertificateThumbprint = registerOutput<String>('nsxtCertificateThumbprint');
    this.nsxtManagerEndpoint = registerOutput<String>('nsxtManagerEndpoint');
    this.nsxtPassword = registerOutput<String?>('nsxtPassword');
    this.provisioningSubnetCidr = registerOutput<String>('provisioningSubnetCidr');
    ...
    this.vcsaEndpoint = registerOutput<String>('vcsaEndpoint');
    this.vmotionSubnetCidr = registerOutput<String>('vmotionSubnetCidr');
  }
