...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      clusterNodeCount: (() { final guardedValue = map['clusterNodeCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      clusterNumber: (() { final guardedValue = map['clusterNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
