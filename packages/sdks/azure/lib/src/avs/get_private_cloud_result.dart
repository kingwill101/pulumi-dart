...
class GetPrivateCloudResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'circuits':
          pulumi.Input.encodeList<GetPrivateCloudCircuit, Map<String, dynamic>>(
            circuits,
            (value) => value.toMap(),
          ),
  ...
  factory GetPrivateCloudResult.fromMap(Map<String, dynamic> map) {
    return GetPrivateCloudResult(
      circuits: pulumi.Input.decodeList<GetPrivateCloudCircuit>(
        map['circuits']!,
        (value) => GetPrivateCloudCircuit.fromMap(
