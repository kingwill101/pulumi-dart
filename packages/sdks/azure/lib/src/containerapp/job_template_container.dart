...
class JobTemplateContainer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'livenessProbes':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateContainerLivenessProbe>,
            List<Map<String, dynamic>>
          >(
            livenessProbes,
            (value) =>
      ...
      'readinessProbes':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateContainerReadinessProbe>,
            List<Map<String, dynamic>>
          >(
            readinessProbes,
            (value) =>
      ...
      'startupProbes':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateContainerStartupProbe>,
            List<Map<String, dynamic>>
          >(
            startupProbes,
            (value) =>
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
    ...
    return JobTemplateContainer(
      ...
      envs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerEnv>(
            guardedValue,
            (value) => JobTemplateContainerEnv.fromMap(
      ...
      livenessProbes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerLivenessProbe>(
            guardedValue,
            (value) => JobTemplateContainerLivenessProbe.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      readinessProbes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerReadinessProbe>(
            guardedValue,
            (value) => JobTemplateContainerReadinessProbe.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      startupProbes: (() {
        final guardedValue = map['startupProbes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerStartupProbe>(
            guardedValue,
            (value) => JobTemplateContainerStartupProbe.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumeMounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerVolumeMount>(
            guardedValue,
            (value) => JobTemplateContainerVolumeMount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
