...
class GetAppIngress {
  ...
  final pulumi.Input<List<GetAppIngressIpSecurityRestriction>>
    ...
    return <String, dynamic>{
      ...
      'cors':
          pulumi.Input.mapInputValue<
            List<GetAppIngressCor>,
            List<Map<String, dynamic>>
          >(
            cors,
            (value) =>
                pulumi.Input.encodeList<GetAppIngressCor, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'customDomains':
          pulumi.Input.mapInputValue<
            List<GetAppIngressCustomDomain>,
            List<Map<String, dynamic>>
          >(
            customDomains,
            (value) =>
      ...
      'trafficWeights':
          pulumi.Input.mapInputValue<
            List<GetAppIngressTrafficWeight>,
            List<Map<String, dynamic>>
          >(
            trafficWeights,
            (value) =>
  ...
  factory GetAppIngress.fromMap(Map<String, dynamic> map) {
    return GetAppIngress(
      allowInsecureConnections: pulumi.Input.fromValue(
        map['allowInsecureConnections'] as bool,
      ),
      clientCertificateMode: pulumi.Input.fromValue(
        map['clientCertificateMode'] as String,
      ),
      cors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppIngressCor>(
          map['cors']!,
          (value) =>
              GetAppIngressCor.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      customDomains: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppIngressCustomDomain>(
          map['customDomains']!,
          (value) => GetAppIngressCustomDomain.fromMap(
      ...
      ipSecurityRestrictions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppIngressIpSecurityRestriction>(
          map['ipSecurityRestrictions']!,
          (value) => GetAppIngressIpSecurityRestriction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      trafficWeights: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppIngressTrafficWeight>(
          map['trafficWeights']!,
          (value) => GetAppIngressTrafficWeight.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
