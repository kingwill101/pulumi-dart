    ...
    return <String, dynamic>{
      ...
      'envs':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateInitContainerEnv>,
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateInitContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
    ...
    return JobTemplateInitContainer(
      ...
      envs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateInitContainerEnv>(
            guardedValue,
            (value) => JobTemplateInitContainerEnv.fromMap(
      ...
      volumeMounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateInitContainerVolumeMount>(
            guardedValue,
            (value) => JobTemplateInitContainerVolumeMount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
