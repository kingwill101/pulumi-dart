...
class JobTemplateInitContainer {
  ...
  factory JobTemplateInitContainer.fromMap(Map<String, dynamic> map) {
    return JobTemplateInitContainer(
      ...
      volumeMounts: (() { final guardedValue = map['volumeMounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JobTemplateInitContainerVolumeMount>(guardedValue, (value) => JobTemplateInitContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
