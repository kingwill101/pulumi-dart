...
class GetAppTemplateContainerStartupProbe {
  ...
  factory GetAppTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return GetAppTemplateContainerStartupProbe(
      ...
      headers: (pulumi.Input.decodeList<GetAppTemplateContainerStartupProbeHeader>(map['headers'], (value) => GetAppTemplateContainerStartupProbeHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
