...
class GetAppTemplateContainerStartupProbe {
    ...
    return <String, dynamic>{
      ...
      'headers':
          pulumi.Input.mapInputValue<
            List<GetAppTemplateContainerStartupProbeHeader>,
  ...
  factory GetAppTemplateContainerStartupProbe.fromMap(
    ...
    return GetAppTemplateContainerStartupProbe(
      ...
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppTemplateContainerStartupProbeHeader>(
          map['headers']!,
          (value) => GetAppTemplateContainerStartupProbeHeader.fromMap(
