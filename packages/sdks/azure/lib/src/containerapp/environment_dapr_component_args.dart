    ...
    return <String, dynamic>{
      ...
      'metadatas':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnvironmentDaprComponentMetadata>,
      ...
      'secrets':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnvironmentDaprComponentSecret>,
            List<Map<String, dynamic>>
          >(
            secrets,
            (value) =>
    ...
    return EnvironmentDaprComponentArgs(
      ...
      metadatas: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentDaprComponentMetadata>(
            guardedValue,
            (value) => EnvironmentDaprComponentMetadata.fromMap(
      ...
      secrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentDaprComponentSecret>(
            guardedValue,
            (value) => EnvironmentDaprComponentSecret.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
