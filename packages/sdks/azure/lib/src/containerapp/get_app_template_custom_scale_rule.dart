...
class GetAppTemplateCustomScaleRule {
  final pulumi.Input<List<GetAppTemplateCustomScaleRuleAuthentication>>
  authentications;
    ...
    return <String, dynamic>{
      'authentications':
          pulumi.Input.mapInputValue<
            List<GetAppTemplateCustomScaleRuleAuthentication>,
  ...
  factory GetAppTemplateCustomScaleRule.fromMap(Map<String, dynamic> map) {
    return GetAppTemplateCustomScaleRule(
      authentications: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppTemplateCustomScaleRuleAuthentication>(
          map['authentications']!,
          (value) => GetAppTemplateCustomScaleRuleAuthentication.fromMap(
