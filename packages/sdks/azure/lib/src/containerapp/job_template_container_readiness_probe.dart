    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateContainerReadinessProbeHeader>,
    ...
    return JobTemplateContainerReadinessProbe(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerReadinessProbeHeader>(
            guardedValue,
            (value) => JobTemplateContainerReadinessProbeHeader.fromMap(
