...
class AppTemplateCustomScaleRule {
  ...
  final pulumi.Input<List<AppTemplateCustomScaleRuleAuthentication>>?
  authentications;
    ...
    return <String, dynamic>{
      'authentications':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppTemplateCustomScaleRuleAuthentication>,
    ...
    return AppTemplateCustomScaleRule(
      authentications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppTemplateCustomScaleRuleAuthentication>(
            guardedValue,
            (value) => AppTemplateCustomScaleRuleAuthentication.fromMap(
