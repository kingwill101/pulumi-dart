    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateContainerStartupProbeHeader>,
    ...
    return JobTemplateContainerStartupProbe(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerStartupProbeHeader>(
            guardedValue,
            (value) => JobTemplateContainerStartupProbeHeader.fromMap(
