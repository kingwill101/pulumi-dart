...
class JobTemplateContainerStartupProbe {
  ...
  final List<JobTemplateContainerStartupProbeHeader>? headers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?headers == null ? null : pulumi.Input.encodeList<JobTemplateContainerStartupProbeHeader, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'host': ?host,
  ...
  factory JobTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return JobTemplateContainerStartupProbe(
      ...
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<JobTemplateContainerStartupProbeHeader>(map['headers'], (value) => JobTemplateContainerStartupProbeHeader.fromMap((value as Map).cast<String, dynamic>())),
