...
class AppTemplateContainer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'livenessProbes':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppTemplateContainerLivenessProbe>,
            List<Map<String, dynamic>>
          >(
            livenessProbes,
            (value) =>
      ...
      'readinessProbes':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppTemplateContainerReadinessProbe>,
            List<Map<String, dynamic>>
          >(
            readinessProbes,
            (value) =>
      ...
      'startupProbes':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppTemplateContainerStartupProbe>,
            List<Map<String, dynamic>>
          >(
            startupProbes,
            (value) =>
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppTemplateContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
    ...
    return AppTemplateContainer(
      ...
      envs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppTemplateContainerEnv>(
            guardedValue,
            (value) => AppTemplateContainerEnv.fromMap(
      ...
      livenessProbes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppTemplateContainerLivenessProbe>(
            guardedValue,
            (value) => AppTemplateContainerLivenessProbe.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      readinessProbes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppTemplateContainerReadinessProbe>(
            guardedValue,
            (value) => AppTemplateContainerReadinessProbe.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      startupProbes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppTemplateContainerStartupProbe>(
            guardedValue,
            (value) => AppTemplateContainerStartupProbe.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumeMounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppTemplateContainerVolumeMount>(
            guardedValue,
            (value) => AppTemplateContainerVolumeMount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
