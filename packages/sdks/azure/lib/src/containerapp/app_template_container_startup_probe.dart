    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppTemplateContainerStartupProbeHeader>,
    ...
    return AppTemplateContainerStartupProbe(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppTemplateContainerStartupProbeHeader>(
            guardedValue,
            (value) => AppTemplateContainerStartupProbeHeader.fromMap(
