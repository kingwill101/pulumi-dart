...
class AppTemplateContainerStartupProbe {
  ...
  final pulumi.Input<List<AppTemplateContainerStartupProbeHeader>>? headers;
  ...
  const AppTemplateContainerStartupProbe({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?pulumi.Input.mapOptionalInputValue<List<AppTemplateContainerStartupProbeHeader>, List<Map<String, dynamic>>>(headers, (value) => pulumi.Input.encodeList<AppTemplateContainerStartupProbeHeader, Map<String, dynamic>>(value, (value) => value.toMap())),
      'host': ?host,
  ...
  factory AppTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return AppTemplateContainerStartupProbe(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppTemplateContainerStartupProbeHeader>(guardedValue, (value) => AppTemplateContainerStartupProbeHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
