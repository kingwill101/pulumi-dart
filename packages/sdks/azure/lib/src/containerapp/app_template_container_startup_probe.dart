...
class AppTemplateContainerStartupProbe {
  ...
  factory AppTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return AppTemplateContainerStartupProbe(
      ...
      headers: map['headers'] == null ? null : (pulumi.Input.decodeList<AppTemplateContainerStartupProbeHeader>(map['headers']!, (value) => AppTemplateContainerStartupProbeHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
