...
class AppState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dapr':
          ?pulumi.Input.mapOptionalInputValue<AppDapr, Map<String, dynamic>>(
            dapr,
            (value) => value.toMap(),
          ),
      'identity':
      ...
      'ingress':
          ?pulumi.Input.mapOptionalInputValue<AppIngress, Map<String, dynamic>>(
            ingress,
            (value) => value.toMap(),
          ),
      ...
      'registries':
          ...
          >(
            registries,
            (value) =>
                pulumi.Input.encodeList<AppRegistry, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'secrets':
          ...
          >(
            secrets,
            (value) => pulumi.Input.encodeList<AppSecret, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return AppState(
      ...
      dapr: (() {
        ...
        return pulumi.Input.fromValue(
          AppDapr.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppIdentity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ingress: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppIngress.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      latestRevisionFqdn: (() {
        final guardedValue = map['latestRevisionFqdn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      latestRevisionName: (() {
        final guardedValue = map['latestRevisionName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      registries: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppRegistry>(
            guardedValue,
            (value) =>
                AppRegistry.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      resourceGroupName: (() {
      ...
      revisionMode: (() {
        final guardedValue = map['revisionMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      secrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSecret>(
            guardedValue,
            (value) =>
                AppSecret.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
      ...
      template: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppTemplate.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      workloadProfileName: (() {
