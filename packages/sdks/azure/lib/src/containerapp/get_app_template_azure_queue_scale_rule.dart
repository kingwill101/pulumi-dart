...
class GetAppTemplateAzureQueueScaleRule {
  final pulumi.Input<List<GetAppTemplateAzureQueueScaleRuleAuthentication>>
  authentications;
    ...
    return <String, dynamic>{
      'authentications':
          pulumi.Input.mapInputValue<
            List<GetAppTemplateAzureQueueScaleRuleAuthentication>,
  ...
  factory GetAppTemplateAzureQueueScaleRule.fromMap(Map<String, dynamic> map) {
    return GetAppTemplateAzureQueueScaleRule(
      authentications: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetAppTemplateAzureQueueScaleRuleAuthentication>(
          map['authentications']!,
          (value) => GetAppTemplateAzureQueueScaleRuleAuthentication.fromMap(
