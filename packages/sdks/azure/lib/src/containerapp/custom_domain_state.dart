...
class CustomDomainState {
  ...
  factory CustomDomainState.fromMap(Map<String, dynamic> map) {
    return CustomDomainState(
      ...
      containerAppEnvironmentCertificateId: (() {
        final guardedValue = map['containerAppEnvironmentCertificateId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      containerAppEnvironmentManagedCertificateId: (() {
        final guardedValue = map['containerAppEnvironmentManagedCertificateId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      containerAppId: (() {
        final guardedValue = map['containerAppId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
