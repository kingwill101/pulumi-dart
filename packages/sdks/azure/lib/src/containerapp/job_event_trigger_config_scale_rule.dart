...
class JobEventTriggerConfigScaleRule {
  ...
  final pulumi.Input<List<JobEventTriggerConfigScaleRuleAuthentication>>?
  authentications;
    ...
    return <String, dynamic>{
      'authentications':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobEventTriggerConfigScaleRuleAuthentication>,
    ...
    return JobEventTriggerConfigScaleRule(
      authentications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobEventTriggerConfigScaleRuleAuthentication>(
            guardedValue,
            (value) => JobEventTriggerConfigScaleRuleAuthentication.fromMap(
