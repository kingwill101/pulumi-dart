...
class AppTemplateAzureQueueScaleRule {
  ...
  final pulumi.Input<List<AppTemplateAzureQueueScaleRuleAuthentication>>
  authentications;
    ...
    return <String, dynamic>{
      'authentications':
          pulumi.Input.mapInputValue<
            List<AppTemplateAzureQueueScaleRuleAuthentication>,
  ...
  factory AppTemplateAzureQueueScaleRule.fromMap(Map<String, dynamic> map) {
    return AppTemplateAzureQueueScaleRule(
      authentications: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AppTemplateAzureQueueScaleRuleAuthentication>(
          map['authentications']!,
          (value) => AppTemplateAzureQueueScaleRuleAuthentication.fromMap(
