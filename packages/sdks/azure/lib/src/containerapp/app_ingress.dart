...
class AppIngress {
  ...
  factory AppIngress.fromMap(Map<String, dynamic> map) {
    return AppIngress(
      allowInsecureConnections: (() { final guardedValue = map['allowInsecureConnections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
