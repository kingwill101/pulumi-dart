...
class JobState {
  ...
  factory JobState.fromMap(Map<String, dynamic> map) {
    return JobState(
      ...
      replicaTimeoutInSeconds: (() { final guardedValue = map['replicaTimeoutInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
