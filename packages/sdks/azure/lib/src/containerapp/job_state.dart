...
class JobState {
  ...
  factory JobState.fromMap(Map<String, dynamic> map) {
    return JobState(
      ...
      eventStreamEndpoint: (() { final guardedValue = map['eventStreamEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eventTriggerConfig: (() { final guardedValue = map['eventTriggerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobEventTriggerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      manualTriggerConfig: (() { final guardedValue = map['manualTriggerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobManualTriggerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      registries: (() { final guardedValue = map['registries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JobRegistry>(guardedValue, (value) => JobRegistry.fromMap((value as Map).cast<String, dynamic>()))); })(),
      replicaRetryLimit: (() { final guardedValue = map['replicaRetryLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      replicaTimeoutInSeconds: (() { final guardedValue = map['replicaTimeoutInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      resourceGroupName: (() { final guardedValue = map['resourceGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scheduleTriggerConfig: (() { final guardedValue = map['scheduleTriggerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobScheduleTriggerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      secrets: (() { final guardedValue = map['secrets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JobSecret>(guardedValue, (value) => JobSecret.fromMap((value as Map).cast<String, dynamic>()))); })(),
