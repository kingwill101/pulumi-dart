    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateContainerLivenessProbeHeader>,
    ...
    return JobTemplateContainerLivenessProbe(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateContainerLivenessProbeHeader>(
            guardedValue,
            (value) => JobTemplateContainerLivenessProbeHeader.fromMap(
