...
class JobTemplate {
  ...
  JobTemplate({required this.containers, this.initContainers, this.volumes});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containers':
          pulumi.Input.mapInputValue<
            List<JobTemplateContainer>,
  ...
  factory JobTemplate.fromMap(Map<String, dynamic> map) {
    return JobTemplate(
      containers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<JobTemplateContainer>(
          map['containers']!,
          (value) => JobTemplateContainer.fromMap(
      ...
      initContainers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateInitContainer>(
            guardedValue,
            (value) => JobTemplateInitContainer.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateVolume>(
            guardedValue,
            (value) => JobTemplateVolume.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
