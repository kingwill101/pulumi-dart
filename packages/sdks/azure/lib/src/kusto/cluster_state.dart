...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      allowedFqdns: (() { final guardedValue = map['allowedFqdns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      allowedIpRanges: (() { final guardedValue = map['allowedIpRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      autoStopEnabled: (() { final guardedValue = map['autoStopEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      dataIngestionUri: (() { final guardedValue = map['dataIngestionUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      diskEncryptionEnabled: (() { final guardedValue = map['diskEncryptionEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      doubleEncryptionEnabled: (() { final guardedValue = map['doubleEncryptionEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      languageExtension: (() { final guardedValue = map['languageExtension']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterLanguageExtension>(guardedValue, (value) => ClusterLanguageExtension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      languageExtensions: (() { final guardedValue = map['languageExtensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterLanguageExtension>(guardedValue, (value) => ClusterLanguageExtension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      optimizedAutoScale: (() { final guardedValue = map['optimizedAutoScale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterOptimizedAutoScale.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      purgeEnabled: (() { final guardedValue = map['purgeEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      streamingIngestionEnabled: (() { final guardedValue = map['streamingIngestionEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      trustedExternalTenants: (() { final guardedValue = map['trustedExternalTenants']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      uri: (() { final guardedValue = map['uri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      virtualNetworkConfiguration: (() { final guardedValue = map['virtualNetworkConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterVirtualNetworkConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
