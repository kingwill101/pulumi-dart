...
class EventGridDataConnectionState {
  ...
  EventGridDataConnectionState({
    ...
    pulumi.Output<String>? eventgridEventSubscriptionId,
    pulumi.Output<String>? eventgridResourceId,
    ...
    pulumi.Output<bool>? skipFirstRecord,
  ...
  factory EventGridDataConnectionState.fromMap(Map<String, dynamic> map) {
    return EventGridDataConnectionState(
      ...
      eventgridEventSubscriptionId: map['eventgridEventSubscriptionId'] == null ? null : pulumi.Output.create<String>(map['eventgridEventSubscriptionId'] as String),
      eventgridResourceId: map['eventgridResourceId'] == null ? null : pulumi.Output.create<String>(map['eventgridResourceId'] as String),
      ...
      skipFirstRecord: map['skipFirstRecord'] == null ? null : pulumi.Output.create<bool>(map['skipFirstRecord'] as bool),
