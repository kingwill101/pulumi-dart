...
/// {@template pulumi_kusto_eventhub_data_connection_eventhub_data_connection_args_doc}
/// The set of arguments for EventhubDataConnection.
/// {@endtemplate}
/// {@macro pulumi_kusto_eventhub_data_connection_eventhub_data_connection_args_doc}
class EventhubDataConnectionArgs {
  ...
  EventhubDataConnectionArgs({
    ...
    required pulumi.Output<String> eventhubId,
  ...
  factory EventhubDataConnectionArgs.fromMap(Map<String, dynamic> map) {
    return EventhubDataConnectionArgs(
      ...
      eventhubId: pulumi.Output.create<String>(map['eventhubId'] as String),
