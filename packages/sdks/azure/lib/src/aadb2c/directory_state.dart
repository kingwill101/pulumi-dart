...
class DirectoryState {
  ...
  factory DirectoryState.fromMap(Map<String, dynamic> map) {
    return DirectoryState(
      ...
      dataResidencyLocation: (() { final guardedValue = map['dataResidencyLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      domainName: (() { final guardedValue = map['domainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      effectiveStartDate: (() { final guardedValue = map['effectiveStartDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
