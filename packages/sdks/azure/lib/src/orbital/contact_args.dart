...
class ContactArgs {
  ...
  factory ContactArgs.fromMap(Map<String, dynamic> map) {
    return ContactArgs(
      contactProfileId: pulumi.Input.fromValue(
        map['contactProfileId'] as String,
      ),
      ...
      reservationEndTime: pulumi.Input.fromValue(
        map['reservationEndTime'] as String,
      ),
      reservationStartTime: pulumi.Input.fromValue(
        map['reservationStartTime'] as String,
      ),
      spacecraftId: pulumi.Input.fromValue(map['spacecraftId'] as String),
    );
  }
}
