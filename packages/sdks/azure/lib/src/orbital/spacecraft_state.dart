...
class SpacecraftState {
  ...
  factory SpacecraftState.fromMap(Map<String, dynamic> map) {
    return SpacecraftState(
      links: (() { final guardedValue = map['links']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SpacecraftLink>(guardedValue, (value) => SpacecraftLink.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      titleLine: (() { final guardedValue = map['titleLine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      twoLineElements: (() { final guardedValue = map['twoLineElements']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
