...
class ContactProfileArgs {
  ...
  factory ContactProfileArgs.fromMap(Map<String, dynamic> map) {
    return ContactProfileArgs(
      ...
      minimumVariableContactDuration: pulumi.Input.fromValue(
        map['minimumVariableContactDuration'] as String,
      ),
      name: (() {
      ...
      networkConfigurationSubnetId: pulumi.Input.fromValue(
        map['networkConfigurationSubnetId'] as String,
      ),
