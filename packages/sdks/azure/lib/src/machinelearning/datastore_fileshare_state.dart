...
class DatastoreFileshareState {
  ...
  factory DatastoreFileshareState.fromMap(Map<String, dynamic> map) {
    return DatastoreFileshareState(
      ...
      storageFileshareId: (() { final guardedValue = map['storageFileshareId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
