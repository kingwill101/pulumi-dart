    ...
    return ComputeClusterState(
      ...
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          ComputeClusterIdentity.fromMap(
      ...
      nodePublicIpEnabled: (() {
        final guardedValue = map['nodePublicIpEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      scaleSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeClusterScaleSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ssh: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeClusterSsh.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sshPublicAccessEnabled: (() {
        final guardedValue = map['sshPublicAccessEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      subnetResourceId: (() {
