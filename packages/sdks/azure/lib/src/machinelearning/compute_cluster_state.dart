...
class ComputeClusterState {
  ...
  /// Creates a new [ComputeClusterState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scaleSettings': ?pulumi.Input.mapOptionalInputValue<ComputeClusterScaleSettings, Map<String, dynamic>>(scaleSettings, (value) => value.toMap()),
  ...
  factory ComputeClusterState.fromMap(Map<String, dynamic> map) {
    return ComputeClusterState(
      ...
      scaleSettings: (() { final guardedValue = map['scaleSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeClusterScaleSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
