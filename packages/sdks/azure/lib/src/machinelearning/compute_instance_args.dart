...
class ComputeInstanceArgs {
    ...
    return <String, dynamic>{
      'assignToUser':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(assignToUser, (value) => value.toMap()),
  ...
  factory ComputeInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ComputeInstanceArgs(
      assignToUser: (() {
        final guardedValue = map['assignToUser'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeInstanceAssignToUser.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeInstanceIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
