...
/// }
///
/// resource "azure_apimanagement_gatewayapi" "example" {
///   gateway_id = data.azure_apimanagement_getgateway.exampleGetGateway.id
///   api_id     = data.azure_apimanagement_getapi.exampleGetApi.id
/// }
/// ```
/// ```java
