...
class Diagnostic extends pulumi.CustomResource {
  ...
  Diagnostic(
    ...
    this.backendRequest = registerOutput<DiagnosticBackendRequest>('backendRequest');
    this.backendResponse = registerOutput<DiagnosticBackendResponse>('backendResponse');
    this.frontendRequest = registerOutput<DiagnosticFrontendRequest>('frontendRequest');
    this.frontendResponse = registerOutput<DiagnosticFrontendResponse>('frontendResponse');
