...
class ApiOperationResponseHeaderExample {
  ...
  /// Creates a new [ApiOperationResponseHeaderExample].
  ...
  const ApiOperationResponseHeaderExample({
    this.description,
    this.externalValue,
    required this.name,
    this.summary,
  ...
  factory ApiOperationResponseHeaderExample.fromMap(Map<String, dynamic> map) {
    return ApiOperationResponseHeaderExample(
