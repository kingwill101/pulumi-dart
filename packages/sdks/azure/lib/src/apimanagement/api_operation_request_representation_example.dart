...
class ApiOperationRequestRepresentationExample {
  ...
  /// Creates a new [ApiOperationRequestRepresentationExample].
  ...
  const ApiOperationRequestRepresentationExample({
    this.description,
    this.externalValue,
    required this.name,
    this.summary,
  ...
  factory ApiOperationRequestRepresentationExample.fromMap(Map<String, dynamic> map) {
    return ApiOperationRequestRepresentationExample(
