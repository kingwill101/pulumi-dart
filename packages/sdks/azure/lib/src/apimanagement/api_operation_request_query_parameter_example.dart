...
class ApiOperationRequestQueryParameterExample {
  ...
  /// Creates a new [ApiOperationRequestQueryParameterExample].
  ...
  const ApiOperationRequestQueryParameterExample({
    this.description,
    this.externalValue,
    required this.name,
    this.summary,
  ...
  factory ApiOperationRequestQueryParameterExample.fromMap(Map<String, dynamic> map) {
    return ApiOperationRequestQueryParameterExample(
