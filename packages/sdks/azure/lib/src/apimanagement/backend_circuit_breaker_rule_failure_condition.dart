...
class BackendCircuitBreakerRuleFailureCondition {
  ...
  final pulumi.Input<
    List<BackendCircuitBreakerRuleFailureConditionStatusCodeRange>
  >?
  statusCodeRanges;
  ...
  factory BackendCircuitBreakerRuleFailureCondition.fromMap(
    ...
    return BackendCircuitBreakerRuleFailureCondition(
      ...
      intervalDuration: pulumi.Input.fromValue(
        map['intervalDuration'] as String,
      ),
      percentage: (() {
      ...
      statusCodeRanges: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                BackendCircuitBreakerRuleFailureConditionStatusCodeRange.fromMap(
