...
class GetServiceResult {
    ...
    return <String, dynamic>{
      'additionalLocations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(additionalLocations, (value) => value.toMap()),
      ...
      'hostnameConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(hostnameConfigurations, (value) => value.toMap()),
      'id': id,
      'identities':
      ...
      'tags': ?tags,
      'tenantAccesses':
          pulumi.Input.encodeList<GetServiceTenantAccess, Map<String, dynamic>>(
            tenantAccesses,
            (value) => value.toMap(),
          ),
    };
  ...
  factory GetServiceResult.fromMap(Map<String, dynamic> map) {
    return GetServiceResult(
      additionalLocations:
          pulumi.Input.decodeList<GetServiceAdditionalLocation>(
            map['additionalLocations']!,
            (value) => GetServiceAdditionalLocation.fromMap(
      ...
      hostnameConfigurations:
          pulumi.Input.decodeList<GetServiceHostnameConfiguration>(
            map['hostnameConfigurations']!,
            (value) => GetServiceHostnameConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      id: map['id'] as String,
      ...
      tenantAccesses: pulumi.Input.decodeList<GetServiceTenantAccess>(
        map['tenantAccesses']!,
        (value) => GetServiceTenantAccess.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
    );
