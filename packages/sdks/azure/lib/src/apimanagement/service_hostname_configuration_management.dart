...
class ServiceHostnameConfigurationManagement {
  ...
  /// Creates a new [ServiceHostnameConfigurationManagement].
  ...
  const ServiceHostnameConfigurationManagement({
    this.certificate,
  ...
  factory ServiceHostnameConfigurationManagement.fromMap(Map<String, dynamic> map) {
    return ServiceHostnameConfigurationManagement(
