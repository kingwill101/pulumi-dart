...
class ApiOperationArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'templateParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationTemplateParameter>,
            List<Map<String, dynamic>>
          >(
            templateParameters,
            (value) =>
  ...
  factory ApiOperationArgs.fromMap(Map<String, dynamic> map) {
    return ApiOperationArgs(
      ...
      templateParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiOperationTemplateParameter>(
            guardedValue,
            (value) => ApiOperationTemplateParameter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
