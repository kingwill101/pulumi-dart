...
import 'api_operation_response_header_example.dart';
...
class ApiOperationResponseHeader {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'examples': ?pulumi.Input.mapOptionalInputValue<List<ApiOperationResponseHeaderExample>, List<Map<String, dynamic>>>(examples, (value) => pulumi.Input.encodeList<ApiOperationResponseHeaderExample, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
      'required': required,
      'schemaId': ?schemaId,
      'type': type,
  ...
  factory ApiOperationResponseHeader.fromMap(Map<String, dynamic> map) {
    return ApiOperationResponseHeader(
      ...
      examples: (() { final guardedValue = map['examples']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiOperationResponseHeaderExample>(guardedValue, (value) => ApiOperationResponseHeaderExample.fromMap((value as Map).cast<String, dynamic>()))); })(),
