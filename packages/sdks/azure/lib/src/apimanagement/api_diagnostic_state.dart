  ...
  factory ApiDiagnosticState.fromMap(Map<String, dynamic> map) {
    return ApiDiagnosticState(
      ...
      apiManagementLoggerId: (() {
        final guardedValue = map['apiManagementLoggerId'];
        if (guardedValue == null) return null;
      ...
      backendRequest: (() {
        ...
        return pulumi.Input.fromValue(
          ApiDiagnosticBackendRequest.fromMap(
      ...
      backendResponse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApiDiagnosticBackendResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      frontendRequest: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApiDiagnosticFrontendRequest.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      frontendResponse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApiDiagnosticFrontendResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
