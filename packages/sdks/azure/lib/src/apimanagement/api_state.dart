...
class ApiState {
  ...
  ApiState({
    ...
    pulumi.Output<ApiContact>? contact,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<ApiImport>? import,
    pulumi.Output<bool>? isCurrent,
    pulumi.Output<bool>? isOnline,
    pulumi.Output<ApiLicense>? license,
    pulumi.Output<String>? name,
    pulumi.Output<ApiOauth2Authorization>? oauth2Authorization,
    pulumi.Output<ApiOpenidAuthentication>? openidAuthentication,
    pulumi.Output<String>? path,
    pulumi.Output<List<String>>? protocols,
    pulumi.Output<String>? resourceGroupName,
    pulumi.Output<String>? revision,
    pulumi.Output<String>? revisionDescription,
    pulumi.Output<String>? serviceUrl,
    pulumi.Output<String>? sourceApiId,
    pulumi.Output<ApiSubscriptionKeyParameterNames>? subscriptionKeyParameterNames,
    ...
    pulumi.Output<String>? versionSetId,
      ...
      isOnline = pulumi.Input.asOptionalInput<bool>(isOnline),
  ...
  factory ApiState.fromMap(Map<String, dynamic> map) {
    return ApiState(
      ...
      contact: map['contact'] == null ? null : pulumi.Output.create<ApiContact>(ApiContact.fromMap((map['contact'] as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      displayName: map['displayName'] == null ? null : pulumi.Output.create<String>(map['displayName'] as String),
      import: map['import'] == null ? null : pulumi.Output.create<ApiImport>(ApiImport.fromMap((map['import'] as Map).cast<String, dynamic>())),
      isCurrent: map['isCurrent'] == null ? null : pulumi.Output.create<bool>(map['isCurrent'] as bool),
      isOnline: map['isOnline'] == null ? null : pulumi.Output.create<bool>(map['isOnline'] as bool),
      license: map['license'] == null ? null : pulumi.Output.create<ApiLicense>(ApiLicense.fromMap((map['license'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      oauth2Authorization: map['oauth2Authorization'] == null ? null : pulumi.Output.create<ApiOauth2Authorization>(ApiOauth2Authorization.fromMap((map['oauth2Authorization'] as Map).cast<String, dynamic>())),
      openidAuthentication: map['openidAuthentication'] == null ? null : pulumi.Output.create<ApiOpenidAuthentication>(ApiOpenidAuthentication.fromMap((map['openidAuthentication'] as Map).cast<String, dynamic>())),
      ...
      revisionDescription: map['revisionDescription'] == null ? null : pulumi.Output.create<String>(map['revisionDescription'] as String),
      ...
      subscriptionKeyParameterNames: map['subscriptionKeyParameterNames'] == null ? null : pulumi.Output.create<ApiSubscriptionKeyParameterNames>(ApiSubscriptionKeyParameterNames.fromMap((map['subscriptionKeyParameterNames'] as Map).cast<String, dynamic>())),
