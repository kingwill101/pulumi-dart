...
class ApiDiagnosticFrontendRequestDataMaskingQueryParam {
  ...
  /// Creates a new [ApiDiagnosticFrontendRequestDataMaskingQueryParam].
  ...
  const ApiDiagnosticFrontendRequestDataMaskingQueryParam({
    required this.mode,
    required this.value,
  });
  ...
  factory ApiDiagnosticFrontendRequestDataMaskingQueryParam.fromMap(Map<String, dynamic> map) {
    return ApiDiagnosticFrontendRequestDataMaskingQueryParam(
