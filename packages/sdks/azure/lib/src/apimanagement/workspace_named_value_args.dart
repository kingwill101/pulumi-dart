...
class WorkspaceNamedValueArgs {
  ...
  factory WorkspaceNamedValueArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceNamedValueArgs(
      ...
      valueFromKeyVault: (() { final guardedValue = map['valueFromKeyVault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceNamedValueValueFromKeyVault.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
