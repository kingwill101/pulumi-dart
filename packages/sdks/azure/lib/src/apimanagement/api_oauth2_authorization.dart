...
class ApiOauth2Authorization {
  ...
  ApiOauth2Authorization({required this.authorizationServerName, this.scope});
  ...
  factory ApiOauth2Authorization.fromMap(Map<String, dynamic> map) {
    return ApiOauth2Authorization(
      authorizationServerName: pulumi.Input.fromValue(
        map['authorizationServerName'] as String,
      ),
      scope: (() {
