...
class ApiDiagnosticBackendResponseDataMaskingHeader {
  ...
  /// Creates a new [ApiDiagnosticBackendResponseDataMaskingHeader].
  ...
  const ApiDiagnosticBackendResponseDataMaskingHeader({
    required this.mode,
    required this.value,
  });
  ...
  factory ApiDiagnosticBackendResponseDataMaskingHeader.fromMap(Map<String, dynamic> map) {
    return ApiDiagnosticBackendResponseDataMaskingHeader(
