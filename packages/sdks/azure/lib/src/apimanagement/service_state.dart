...
class ServiceState {
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      developerPortalUrl: map['developerPortalUrl'] == null ? null : (map['developerPortalUrl']! as String).input(),
      ...
      managementApiUrl: map['managementApiUrl'] == null ? null : (map['managementApiUrl']! as String).input(),
      ...
      publisherEmail: map['publisherEmail'] == null ? null : (map['publisherEmail']! as String).input(),
      publisherName: map['publisherName'] == null ? null : (map['publisherName']! as String).input(),
      resourceGroupName: map['resourceGroupName'] == null ? null : (map['resourceGroupName']! as String).input(),
      scmUrl: map['scmUrl'] == null ? null : (map['scmUrl']! as String).input(),
