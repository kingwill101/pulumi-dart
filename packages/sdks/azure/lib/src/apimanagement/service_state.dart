...
class ServiceState {
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      developerPortalUrl: (() { final guardedValue = map['developerPortalUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      gatewayUrl: (() { final guardedValue = map['gatewayUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      managementApiUrl: (() { final guardedValue = map['managementApiUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      publisherEmail: (() { final guardedValue = map['publisherEmail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      scmUrl: (() { final guardedValue = map['scmUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
