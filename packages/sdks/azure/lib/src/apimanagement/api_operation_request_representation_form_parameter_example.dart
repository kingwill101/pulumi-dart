...
class ApiOperationRequestRepresentationFormParameterExample {
  ...
  /// Creates a new [ApiOperationRequestRepresentationFormParameterExample].
  ...
  factory ApiOperationRequestRepresentationFormParameterExample.fromMap(Map<String, dynamic> map) {
    return ApiOperationRequestRepresentationFormParameterExample(
