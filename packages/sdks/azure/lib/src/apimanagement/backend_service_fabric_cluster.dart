...
class BackendServiceFabricCluster {
  ...
  final pulumi.Input<List<BackendServiceFabricClusterServerX509Name>>?
  serverX509Names;
    ...
    return <String, dynamic>{
      ...
      'serverX509Names':
          ?pulumi.Input.mapOptionalInputValue<
            List<BackendServiceFabricClusterServerX509Name>,
  ...
  factory BackendServiceFabricCluster.fromMap(Map<String, dynamic> map) {
    return BackendServiceFabricCluster(
      ...
      maxPartitionResolutionRetries: pulumi.Input.fromValue(
        map['maxPartitionResolutionRetries'] as int,
      ),
      ...
      serverX509Names: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BackendServiceFabricClusterServerX509Name>(
            guardedValue,
            (value) => BackendServiceFabricClusterServerX509Name.fromMap(
