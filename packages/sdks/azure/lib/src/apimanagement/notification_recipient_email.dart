...
import 'notification_recipient_email_state.dart';
...
class NotificationRecipientEmail extends pulumi.CustomResource {
  ...
  /// Gets an existing [NotificationRecipientEmail] resource's state with the given [name] and [id].
  static NotificationRecipientEmail get(
    String name,
    pulumi.Input<String> id, {
    NotificationRecipientEmailState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return NotificationRecipientEmail._get(
      name,
      state: state?.toMap(),
  ...
  NotificationRecipientEmail._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [NotificationRecipientEmail] resource.
  NotificationRecipientEmail.reference(String urn)
    : super(
        'azure:apimanagement/notificationRecipientEmail:NotificationRecipientEmail',
