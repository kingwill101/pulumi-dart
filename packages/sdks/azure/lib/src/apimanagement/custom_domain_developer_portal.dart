...
class CustomDomainDeveloperPortal {
  ...
  /// Creates a new [CustomDomainDeveloperPortal].
  ...
  /// [subject] Optional.
  /// [thumbprint] Optional.
  const CustomDomainDeveloperPortal({
    this.certificate,
  ...
  factory CustomDomainDeveloperPortal.fromMap(Map<String, dynamic> map) {
    return CustomDomainDeveloperPortal(
