...
class DiagnosticBackendResponseDataMasking {
  ...
  final pulumi.Input<List<DiagnosticBackendResponseDataMaskingQueryParam>>?
  queryParams;
  ...
  DiagnosticBackendResponseDataMasking({this.headers, this.queryParams});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiagnosticBackendResponseDataMaskingHeader>,
      ...
      'queryParams':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiagnosticBackendResponseDataMaskingQueryParam>,
            List<Map<String, dynamic>>
          >(
            queryParams,
            (value) =>
  ...
  factory DiagnosticBackendResponseDataMasking.fromMap(
    ...
    return DiagnosticBackendResponseDataMasking(
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiagnosticBackendResponseDataMaskingHeader>(
            guardedValue,
            (value) => DiagnosticBackendResponseDataMaskingHeader.fromMap(
      ...
      queryParams: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<DiagnosticBackendResponseDataMaskingQueryParam>(
            guardedValue,
            (value) => DiagnosticBackendResponseDataMaskingQueryParam.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
