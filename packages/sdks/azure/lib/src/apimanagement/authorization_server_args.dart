...
class AuthorizationServerArgs {
  ...
  final pulumi.Input<List<AuthorizationServerTokenBodyParameter>>?
  tokenBodyParameters;
    ...
    return <String, dynamic>{
      ...
      'tokenBodyParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthorizationServerTokenBodyParameter>,
  ...
  factory AuthorizationServerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationServerArgs(
      ...
      authorizationMethods: pulumi.Input.fromValue(
        (map['authorizationMethods'] as List).cast<String>(),
      ),
      ...
      clientAuthenticationMethods: (() {
        final guardedValue = map['clientAuthenticationMethods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ...
      tokenBodyParameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorizationServerTokenBodyParameter>(
            guardedValue,
            (value) => AuthorizationServerTokenBodyParameter.fromMap(
