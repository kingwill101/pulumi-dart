...
class AuthorizationServerArgs {
  ...
  AuthorizationServerArgs({
    ...
    required pulumi.Output<List<String>> authorizationMethods,
    ...
    pulumi.Output<String>? tokenEndpoint,
      ...
      authorizationMethods = pulumi.Input.asInput<List<String>>(authorizationMethods),
  ...
  factory AuthorizationServerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationServerArgs(
      ...
      authorizationMethods: pulumi.Output.create<List<String>>((map['authorizationMethods'] as List).cast<String>()),
