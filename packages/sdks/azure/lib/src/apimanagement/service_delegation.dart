...
class ServiceDelegation {
  ...
  factory ServiceDelegation.fromMap(Map<String, dynamic> map) {
    return ServiceDelegation(
      subscriptionsEnabled: (() { final guardedValue = map['subscriptionsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      url: (() { final guardedValue = map['url']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userRegistrationEnabled: (() { final guardedValue = map['userRegistrationEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
