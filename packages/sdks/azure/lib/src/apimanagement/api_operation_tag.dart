...
import 'api_operation_tag_state.dart';
...
///   }
/// }
/// resource "azure_apimanagement_apioperationtag" "example" {
///   name             = "example-Tag"
///   api_operation_id = azure_apimanagement_apioperation.example.id
///   display_name     = "example-Tag"
/// }
/// ```
/// ```java
...
class ApiOperationTag extends pulumi.CustomResource {
  ...
  /// Gets an existing [ApiOperationTag] resource's state with the given [name] and [id].
  static ApiOperationTag get(
    String name,
