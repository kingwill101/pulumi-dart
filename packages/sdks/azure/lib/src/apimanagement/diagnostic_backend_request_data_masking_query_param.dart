...
class DiagnosticBackendRequestDataMaskingQueryParam {
  ...
  /// Creates a new [DiagnosticBackendRequestDataMaskingQueryParam].
  ...
  const DiagnosticBackendRequestDataMaskingQueryParam({
    required this.mode,
    required this.value,
  });
  ...
  factory DiagnosticBackendRequestDataMaskingQueryParam.fromMap(Map<String, dynamic> map) {
    return DiagnosticBackendRequestDataMaskingQueryParam(
