...
class ApiDiagnosticFrontendRequestDataMasking {
  ...
  final pulumi.Input<List<ApiDiagnosticFrontendRequestDataMaskingHeader>>?
  headers;

  /// A `query_params` block as defined below.
  final pulumi.Input<List<ApiDiagnosticFrontendRequestDataMaskingQueryParam>>?
  queryParams;
  ...
  ApiDiagnosticFrontendRequestDataMasking({this.headers, this.queryParams});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiDiagnosticFrontendRequestDataMaskingHeader>,
      ...
      'queryParams':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiDiagnosticFrontendRequestDataMaskingQueryParam>,
            List<Map<String, dynamic>>
          >(
            queryParams,
            (value) =>
  ...
  factory ApiDiagnosticFrontendRequestDataMasking.fromMap(
    ...
    return ApiDiagnosticFrontendRequestDataMasking(
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ApiDiagnosticFrontendRequestDataMaskingHeader>(
            guardedValue,
            (value) => ApiDiagnosticFrontendRequestDataMaskingHeader.fromMap(
      ...
      queryParams: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ApiDiagnosticFrontendRequestDataMaskingQueryParam.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
