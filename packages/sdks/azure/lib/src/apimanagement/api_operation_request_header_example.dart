...
class ApiOperationRequestHeaderExample {
  ...
  /// Creates a new [ApiOperationRequestHeaderExample].
  ...
  const ApiOperationRequestHeaderExample({
    this.description,
    this.externalValue,
    required this.name,
    this.summary,
  ...
  factory ApiOperationRequestHeaderExample.fromMap(Map<String, dynamic> map) {
    return ApiOperationRequestHeaderExample(
