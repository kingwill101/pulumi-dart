...
class ApiDiagnosticBackendRequestDataMasking {
  ...
  final pulumi.Input<List<ApiDiagnosticBackendRequestDataMaskingHeader>>?
  headers;

  /// A `query_params` block as defined below.
  final pulumi.Input<List<ApiDiagnosticBackendRequestDataMaskingQueryParam>>?
  queryParams;
  ...
  ApiDiagnosticBackendRequestDataMasking({this.headers, this.queryParams});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiDiagnosticBackendRequestDataMaskingHeader>,
      ...
      'queryParams':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiDiagnosticBackendRequestDataMaskingQueryParam>,
            List<Map<String, dynamic>>
          >(
            queryParams,
            (value) =>
  ...
  factory ApiDiagnosticBackendRequestDataMasking.fromMap(
    ...
    return ApiDiagnosticBackendRequestDataMasking(
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiDiagnosticBackendRequestDataMaskingHeader>(
            guardedValue,
            (value) => ApiDiagnosticBackendRequestDataMaskingHeader.fromMap(
      ...
      queryParams: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ApiDiagnosticBackendRequestDataMaskingQueryParam.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
