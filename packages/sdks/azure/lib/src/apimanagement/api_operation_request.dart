    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationRequestHeader>,
      ...
      'queryParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationRequestQueryParameter>,
            List<Map<String, dynamic>>
          >(
            queryParameters,
            (value) =>
      ...
      'representations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationRequestRepresentation>,
            List<Map<String, dynamic>>
          >(
            representations,
            (value) =>
    ...
    return ApiOperationRequest(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiOperationRequestHeader>(
            guardedValue,
            (value) => ApiOperationRequestHeader.fromMap(
      ...
      queryParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiOperationRequestQueryParameter>(
            guardedValue,
            (value) => ApiOperationRequestQueryParameter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      representations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiOperationRequestRepresentation>(
            guardedValue,
            (value) => ApiOperationRequestRepresentation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
