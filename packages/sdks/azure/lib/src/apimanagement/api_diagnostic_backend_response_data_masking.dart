...
class ApiDiagnosticBackendResponseDataMasking {
  ...
  final pulumi.Input<List<ApiDiagnosticBackendResponseDataMaskingHeader>>?
  headers;

  /// A `query_params` block as defined below.
  final pulumi.Input<List<ApiDiagnosticBackendResponseDataMaskingQueryParam>>?
  queryParams;
  ...
  ApiDiagnosticBackendResponseDataMasking({this.headers, this.queryParams});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiDiagnosticBackendResponseDataMaskingHeader>,
      ...
      'queryParams':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiDiagnosticBackendResponseDataMaskingQueryParam>,
            List<Map<String, dynamic>>
          >(
            queryParams,
            (value) =>
  ...
  factory ApiDiagnosticBackendResponseDataMasking.fromMap(
    ...
    return ApiDiagnosticBackendResponseDataMasking(
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ApiDiagnosticBackendResponseDataMaskingHeader>(
            guardedValue,
            (value) => ApiDiagnosticBackendResponseDataMaskingHeader.fromMap(
      ...
      queryParams: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ApiDiagnosticBackendResponseDataMaskingQueryParam.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
