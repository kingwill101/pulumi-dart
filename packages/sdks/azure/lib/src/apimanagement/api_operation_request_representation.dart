...
class ApiOperationRequestRepresentation {
  ...
  final pulumi.Input<List<ApiOperationRequestRepresentationFormParameter>>?
  formParameters;
    ...
    return <String, dynamic>{
      ...
      'examples':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationRequestRepresentationExample>,
      ...
      'formParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationRequestRepresentationFormParameter>,
            List<Map<String, dynamic>>
          >(
            formParameters,
            (value) =>
    ...
    return ApiOperationRequestRepresentation(
      ...
      examples: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiOperationRequestRepresentationExample>(
            guardedValue,
            (value) => ApiOperationRequestRepresentationExample.fromMap(
      ...
      formParameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ApiOperationRequestRepresentationFormParameter>(
            guardedValue,
            (value) => ApiOperationRequestRepresentationFormParameter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
