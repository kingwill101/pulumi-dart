...
class ApiOperationTemplateParameter {
  ...
  const ApiOperationTemplateParameter({
    this.defaultValue,
    this.description,
    this.examples,
    required this.name,
  ...
  factory ApiOperationTemplateParameter.fromMap(Map<String, dynamic> map) {
    return ApiOperationTemplateParameter(
      ...
      examples: (() { final guardedValue = map['examples']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiOperationTemplateParameterExample>(guardedValue, (value) => ApiOperationTemplateParameterExample.fromMap((value as Map).cast<String, dynamic>()))); })(),
