...
class DiagnosticBackendRequestDataMaskingHeader {
  ...
  factory DiagnosticBackendRequestDataMaskingHeader.fromMap(Map<String, dynamic> map) {
    return DiagnosticBackendRequestDataMaskingHeader(
