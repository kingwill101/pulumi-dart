...
class DiagnosticBackendRequest {
  ...
  final DiagnosticBackendRequestDataMasking? dataMasking;
  ...
  factory DiagnosticBackendRequest.fromMap(Map<String, dynamic> map) {
    return DiagnosticBackendRequest(
      ...
      dataMasking: map['dataMasking'] == null ? null : DiagnosticBackendRequestDataMasking.fromMap((map['dataMasking'] as Map).cast<String, dynamic>()),
