...
class DiagnosticFrontendResponseDataMaskingHeader {
  ...
  /// Creates a new [DiagnosticFrontendResponseDataMaskingHeader].
  ...
  const DiagnosticFrontendResponseDataMaskingHeader({
    required this.mode,
    required this.value,
  });
  ...
  factory DiagnosticFrontendResponseDataMaskingHeader.fromMap(Map<String, dynamic> map) {
    return DiagnosticFrontendResponseDataMaskingHeader(
