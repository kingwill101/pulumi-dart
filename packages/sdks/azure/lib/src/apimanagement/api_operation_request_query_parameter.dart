    ...
    return <String, dynamic>{
      ...
      'examples':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationRequestQueryParameterExample>,
    ...
    return ApiOperationRequestQueryParameter(
      ...
      examples: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiOperationRequestQueryParameterExample>(
            guardedValue,
            (value) => ApiOperationRequestQueryParameterExample.fromMap(
