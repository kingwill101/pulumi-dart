...
class DiagnosticFrontendRequestDataMasking {
  ...
  factory DiagnosticFrontendRequestDataMasking.fromMap(Map<String, dynamic> map) {
    return DiagnosticFrontendRequestDataMasking(
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DiagnosticFrontendRequestDataMaskingHeader>(guardedValue, (value) => DiagnosticFrontendRequestDataMaskingHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      queryParams: (() { final guardedValue = map['queryParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DiagnosticFrontendRequestDataMaskingQueryParam>(guardedValue, (value) => DiagnosticFrontendRequestDataMaskingQueryParam.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
