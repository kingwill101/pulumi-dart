...
class GetGatewayResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'locationDatas':
          pulumi.Input.encodeList<GetGatewayLocationData, Map<String, dynamic>>(
            locationDatas,
            (value) => value.toMap(),
          ),
      'name': name,
  ...
  factory GetGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetGatewayResult(
      ...
      id: map['id'] as String,
      locationDatas: pulumi.Input.decodeList<GetGatewayLocationData>(
        map['locationDatas']!,
        (value) => GetGatewayLocationData.fromMap(
