...
class ApiDiagnosticBackendRequestDataMaskingQueryParam {
  ...
  /// Creates a new [ApiDiagnosticBackendRequestDataMaskingQueryParam].
  ...
  const ApiDiagnosticBackendRequestDataMaskingQueryParam({
    required this.mode,
    required this.value,
  });
  ...
  factory ApiDiagnosticBackendRequestDataMaskingQueryParam.fromMap(Map<String, dynamic> map) {
    return ApiDiagnosticBackendRequestDataMaskingQueryParam(
