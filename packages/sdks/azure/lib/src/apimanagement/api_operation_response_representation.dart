...
class ApiOperationResponseRepresentation {
  ...
  final pulumi.Input<List<ApiOperationResponseRepresentationFormParameter>>?
  formParameters;
    ...
    return <String, dynamic>{
      ...
      'examples':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationResponseRepresentationExample>,
      ...
      'formParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiOperationResponseRepresentationFormParameter>,
            List<Map<String, dynamic>>
          >(
            formParameters,
            (value) =>
    ...
    return ApiOperationResponseRepresentation(
      ...
      examples: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiOperationResponseRepresentationExample>(
            guardedValue,
            (value) => ApiOperationResponseRepresentationExample.fromMap(
      ...
      formParameters: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ApiOperationResponseRepresentationFormParameter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
