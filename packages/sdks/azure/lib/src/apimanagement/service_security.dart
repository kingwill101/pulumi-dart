...
class ServiceSecurity {
  ...
  factory ServiceSecurity.fromMap(Map<String, dynamic> map) {
    return ServiceSecurity(
      backendSsl30Enabled: (() { final guardedValue = map['backendSsl30Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      backendTls10Enabled: (() { final guardedValue = map['backendTls10Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      backendTls11Enabled: (() { final guardedValue = map['backendTls11Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableBackendSsl30: (() { final guardedValue = map['enableBackendSsl30']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableBackendTls10: (() { final guardedValue = map['enableBackendTls10']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableBackendTls11: (() { final guardedValue = map['enableBackendTls11']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableFrontendSsl30: (() { final guardedValue = map['enableFrontendSsl30']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableFrontendTls10: (() { final guardedValue = map['enableFrontendTls10']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableFrontendTls11: (() { final guardedValue = map['enableFrontendTls11']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      frontendSsl30Enabled: (() { final guardedValue = map['frontendSsl30Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      frontendTls10Enabled: (() { final guardedValue = map['frontendTls10Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      frontendTls11Enabled: (() { final guardedValue = map['frontendTls11Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsEcdheEcdsaWithAes128CbcShaCiphersEnabled: (() { final guardedValue = map['tlsEcdheEcdsaWithAes128CbcShaCiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsEcdheEcdsaWithAes256CbcShaCiphersEnabled: (() { final guardedValue = map['tlsEcdheEcdsaWithAes256CbcShaCiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsEcdheRsaWithAes128CbcShaCiphersEnabled: (() { final guardedValue = map['tlsEcdheRsaWithAes128CbcShaCiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsEcdheRsaWithAes256CbcShaCiphersEnabled: (() { final guardedValue = map['tlsEcdheRsaWithAes256CbcShaCiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsRsaWithAes128CbcSha256CiphersEnabled: (() { final guardedValue = map['tlsRsaWithAes128CbcSha256CiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsRsaWithAes128CbcShaCiphersEnabled: (() { final guardedValue = map['tlsRsaWithAes128CbcShaCiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsRsaWithAes128GcmSha256CiphersEnabled: (() { final guardedValue = map['tlsRsaWithAes128GcmSha256CiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsRsaWithAes256CbcSha256CiphersEnabled: (() { final guardedValue = map['tlsRsaWithAes256CbcSha256CiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsRsaWithAes256CbcShaCiphersEnabled: (() { final guardedValue = map['tlsRsaWithAes256CbcShaCiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tlsRsaWithAes256GcmSha384CiphersEnabled: (() { final guardedValue = map['tlsRsaWithAes256GcmSha384CiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tripleDesCiphersEnabled: (() { final guardedValue = map['tripleDesCiphersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
