...
///   sku_name            = "Developer_1"
/// }
/// resource "azure_apimanagement_identityprovidermicrosoft" "example" {
///   resource_group_name = azure_core_resourcegroup.example.name
...
class IdentityProviderMicrosoft extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [IdentityProviderMicrosoft] resource.
  IdentityProviderMicrosoft.reference(String urn)
    : super(
        'azure:apimanagement/identityProviderMicrosoft:IdentityProviderMicrosoft',
