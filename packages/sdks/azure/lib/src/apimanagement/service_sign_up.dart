...
class ServiceSignUp {
  ...
  ServiceSignUp({required this.enabled, required this.termsOfService});
  ...
  factory ServiceSignUp.fromMap(Map<String, dynamic> map) {
    return ServiceSignUp(
      ...
      termsOfService: pulumi.Input.fromValue(
        ServiceSignUpTermsOfService.fromMap(
          (map['termsOfService']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
