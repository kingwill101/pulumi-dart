...
class ApiOperationRequestRepresentationFormParameter {
  ...
  final pulumi.Input<List<ApiOperationRequestRepresentationFormParameterExample>>? examples;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'examples': ?pulumi.Input.mapOptionalInputValue<List<ApiOperationRequestRepresentationFormParameterExample>, List<Map<String, dynamic>>>(examples, (value) => pulumi.Input.encodeList<ApiOperationRequestRepresentationFormParameterExample, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
      'required': required,
      'schemaId': ?schemaId,
      'type': type,
  ...
  factory ApiOperationRequestRepresentationFormParameter.fromMap(Map<String, dynamic> map) {
    return ApiOperationRequestRepresentationFormParameter(
      ...
      examples: (() { final guardedValue = map['examples']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiOperationRequestRepresentationFormParameterExample>(guardedValue, (value) => ApiOperationRequestRepresentationFormParameterExample.fromMap((value as Map).cast<String, dynamic>()))); })(),
