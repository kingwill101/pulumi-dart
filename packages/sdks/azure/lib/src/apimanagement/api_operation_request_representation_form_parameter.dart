...
class ApiOperationRequestRepresentationFormParameter {
  ...
  factory ApiOperationRequestRepresentationFormParameter.fromMap(Map<String, dynamic> map) {
    return ApiOperationRequestRepresentationFormParameter(
      ...
      examples: map['examples'] == null ? null : (pulumi.Input.decodeList<ApiOperationRequestRepresentationFormParameterExample>(map['examples'], (value) => ApiOperationRequestRepresentationFormParameterExample.fromMap((value as Map).cast<String, dynamic>()))).input(),
