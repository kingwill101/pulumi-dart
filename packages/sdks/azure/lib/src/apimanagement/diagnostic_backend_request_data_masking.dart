...
class DiagnosticBackendRequestDataMasking {
  ...
  const DiagnosticBackendRequestDataMasking({
    this.headers,
    this.queryParams,
  });
  ...
  factory DiagnosticBackendRequestDataMasking.fromMap(Map<String, dynamic> map) {
    return DiagnosticBackendRequestDataMasking(
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DiagnosticBackendRequestDataMaskingHeader>(guardedValue, (value) => DiagnosticBackendRequestDataMaskingHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      queryParams: (() { final guardedValue = map['queryParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DiagnosticBackendRequestDataMaskingQueryParam>(guardedValue, (value) => DiagnosticBackendRequestDataMaskingQueryParam.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
