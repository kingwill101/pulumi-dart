...
class GatewayHostNameConfiguration extends pulumi.CustomResource {
  ...
  GatewayHostNameConfiguration(
    ...
    this.requestClientCertificateEnabled = registerOutput<bool?>('requestClientCertificateEnabled');
    this.tls10Enabled = registerOutput<bool?>('tls10Enabled');
    this.tls11Enabled = registerOutput<bool?>('tls11Enabled');
  }
