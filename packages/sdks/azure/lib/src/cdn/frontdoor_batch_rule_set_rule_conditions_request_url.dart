...
class FrontdoorBatchRuleSetRuleConditionsRequestUrl {
  ...
  /// Creates a new [FrontdoorBatchRuleSetRuleConditionsRequestUrl].
  ...
  /// [values] One or more values representing the request URL to match. A maximum of `25` values may be defined. If multiple values are specified, they are evaluated using `OR` logic.
  const FrontdoorBatchRuleSetRuleConditionsRequestUrl({
  ...
  factory FrontdoorBatchRuleSetRuleConditionsRequestUrl.fromMap(Map<String, dynamic> map) {
    return FrontdoorBatchRuleSetRuleConditionsRequestUrl(
