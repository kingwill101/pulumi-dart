...
class FrontdoorCustomDomainArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostName': hostName,
      'name': ?name,
      'tls': pulumi.Input.mapInputValue<FrontdoorCustomDomainTls, Map<String, dynamic>>(tls, (value) => value.toMap()),
    };
  }
  ...
  factory FrontdoorCustomDomainArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorCustomDomainArgs(
      ...
      tls: pulumi.Input.fromValue(FrontdoorCustomDomainTls.fromMap((map['tls']! as Map).cast<String, dynamic>())),
    );
  }
}
