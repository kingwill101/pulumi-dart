    ...
    return FrontdoorOriginGroupArgs(
      ...
      healthProbe: (() {
        ...
        return pulumi.Input.fromValue(
          FrontdoorOriginGroupHealthProbe.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      loadBalancing: pulumi.Input.fromValue(
        FrontdoorOriginGroupLoadBalancing.fromMap(
          (map['loadBalancing']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: (() {
      ...
      restoreTrafficTimeToHealedOrNewEndpointInMinutes: (() {
        final guardedValue =
            map['restoreTrafficTimeToHealedOrNewEndpointInMinutes'];
        if (guardedValue == null) return null;
