...
class FrontdoorOriginGroupLoadBalancing {
  ...
  factory FrontdoorOriginGroupLoadBalancing.fromMap(Map<String, dynamic> map) {
    return FrontdoorOriginGroupLoadBalancing(
      additionalLatencyInMilliseconds: (() { final guardedValue = map['additionalLatencyInMilliseconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
