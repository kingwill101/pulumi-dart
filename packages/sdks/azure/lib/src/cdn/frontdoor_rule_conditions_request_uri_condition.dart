...
class FrontdoorRuleConditionsRequestUriCondition {
  ...
  /// Creates a new [FrontdoorRuleConditionsRequestUriCondition].
  /// [matchValues] One or more string or integer values(e.g. "1") representing the value of the request URL to match. If multiple values are specified, they're evaluated using `OR` logic.
  ...
  const FrontdoorRuleConditionsRequestUriCondition({
    this.matchValues,
  ...
  factory FrontdoorRuleConditionsRequestUriCondition.fromMap(Map<String, dynamic> map) {
    return FrontdoorRuleConditionsRequestUriCondition(
