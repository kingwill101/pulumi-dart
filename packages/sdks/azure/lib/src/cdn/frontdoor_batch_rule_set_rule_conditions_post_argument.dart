...
class FrontdoorBatchRuleSetRuleConditionsPostArgument {
  ...
  /// Creates a new [FrontdoorBatchRuleSetRuleConditionsPostArgument].
  /// [name] A string value representing the name of the `POST` argument.
  ...
  /// [values] One or more values representing the `POST` argument value to match. A maximum of `25` values may be defined. If multiple values are specified, they are evaluated using `OR` logic.
  const FrontdoorBatchRuleSetRuleConditionsPostArgument({
    required this.name,
  ...
  factory FrontdoorBatchRuleSetRuleConditionsPostArgument.fromMap(Map<String, dynamic> map) {
    return FrontdoorBatchRuleSetRuleConditionsPostArgument(
