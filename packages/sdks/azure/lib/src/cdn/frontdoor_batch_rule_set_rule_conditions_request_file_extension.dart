...
class FrontdoorBatchRuleSetRuleConditionsRequestFileExtension {
  ...
  /// Creates a new [FrontdoorBatchRuleSetRuleConditionsRequestFileExtension].
  ...
  /// [values] One or more values representing the request file extension to match. A maximum of `25` values may be defined. If multiple values are specified, they are evaluated using `OR` logic.
  const FrontdoorBatchRuleSetRuleConditionsRequestFileExtension({
  ...
  factory FrontdoorBatchRuleSetRuleConditionsRequestFileExtension.fromMap(Map<String, dynamic> map) {
    return FrontdoorBatchRuleSetRuleConditionsRequestFileExtension(
