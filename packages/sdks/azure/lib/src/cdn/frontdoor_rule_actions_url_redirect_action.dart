...
class FrontdoorRuleActionsUrlRedirectAction {
  ...
  factory FrontdoorRuleActionsUrlRedirectAction.fromMap(
    Map<String, dynamic> map,
  ) {
    return FrontdoorRuleActionsUrlRedirectAction(
      destinationFragment: (() {
        final guardedValue = map['destinationFragment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      destinationHostname: pulumi.Input.fromValue(
        map['destinationHostname'] as String,
      ),
      destinationPath: (() {
        final guardedValue = map['destinationPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryString: (() {
      ...
      redirectProtocol: (() {
        final guardedValue = map['redirectProtocol'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
