...
class FrontdoorRuleActionsUrlRedirectAction {
  ...
  final String? destinationFragment;
  ...
  factory FrontdoorRuleActionsUrlRedirectAction.fromMap(Map<String, dynamic> map) {
    return FrontdoorRuleActionsUrlRedirectAction(
      destinationFragment: map['destinationFragment'] == null ? null : map['destinationFragment'] as String,
      destinationHostname: map['destinationHostname'] as String,
