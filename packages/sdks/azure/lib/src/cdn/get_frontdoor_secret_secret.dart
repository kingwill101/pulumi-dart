...
class GetFrontdoorSecretSecret {
  ...
  final pulumi.Input<List<GetFrontdoorSecretSecretCustomerCertificate>>
  ...
  GetFrontdoorSecretSecret({required this.customerCertificates});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customerCertificates':
          pulumi.Input.mapInputValue<
            List<GetFrontdoorSecretSecretCustomerCertificate>,
  ...
  factory GetFrontdoorSecretSecret.fromMap(Map<String, dynamic> map) {
    return GetFrontdoorSecretSecret(
      customerCertificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFrontdoorSecretSecretCustomerCertificate>(
          map['customerCertificates']!,
          (value) => GetFrontdoorSecretSecretCustomerCertificate.fromMap(
