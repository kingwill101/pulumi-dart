...
class GetFrontdoorSecretSecret {
  ...
  factory GetFrontdoorSecretSecret.fromMap(Map<String, dynamic> map) {
    return GetFrontdoorSecretSecret(
      customerCertificates: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFrontdoorSecretSecretCustomerCertificate>(map['customerCertificates']!, (value) => GetFrontdoorSecretSecretCustomerCertificate.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
