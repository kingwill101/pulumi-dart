...
class FrontdoorBatchRuleSetRuleActionsModifyRequestHeader {
  ...
  /// Creates a new [FrontdoorBatchRuleSetRuleActionsModifyRequestHeader].
  ...
  const FrontdoorBatchRuleSetRuleActionsModifyRequestHeader({
  ...
  factory FrontdoorBatchRuleSetRuleActionsModifyRequestHeader.fromMap(Map<String, dynamic> map) {
    return FrontdoorBatchRuleSetRuleActionsModifyRequestHeader(
