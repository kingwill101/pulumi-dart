...
class EndpointGlobalDeliveryRule {
  ...
  final pulumi.Input<EndpointGlobalDeliveryRuleCacheExpirationAction>?
  cacheExpirationAction;

  /// A `cache_key_query_string_action` block as defined above.
  final pulumi.Input<EndpointGlobalDeliveryRuleCacheKeyQueryStringAction>?
  cacheKeyQueryStringAction;

  /// A `modify_request_header_action` block as defined below.
  final pulumi.Input<List<EndpointGlobalDeliveryRuleModifyRequestHeaderAction>>?
  modifyRequestHeaderActions;

  /// A `modify_response_header_action` block as defined below.
  final pulumi.Input<
    List<EndpointGlobalDeliveryRuleModifyResponseHeaderAction>
  >?
  modifyResponseHeaderActions;

  /// A `url_redirect_action` block as defined below.
  final pulumi.Input<EndpointGlobalDeliveryRuleUrlRedirectAction>?
  urlRedirectAction;

  /// A `url_rewrite_action` block as defined below.
  final pulumi.Input<EndpointGlobalDeliveryRuleUrlRewriteAction>?
  urlRewriteAction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'modifyRequestHeaderActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointGlobalDeliveryRuleModifyRequestHeaderAction>,
    ...
    return EndpointGlobalDeliveryRule(
      cacheExpirationAction: (() {
        ...
        return pulumi.Input.fromValue(
          EndpointGlobalDeliveryRuleCacheExpirationAction.fromMap(
      ...
      cacheKeyQueryStringAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointGlobalDeliveryRuleCacheKeyQueryStringAction.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      modifyRequestHeaderActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EndpointGlobalDeliveryRuleModifyRequestHeaderAction.fromMap(
      ...
      modifyResponseHeaderActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EndpointGlobalDeliveryRuleModifyResponseHeaderAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      urlRedirectAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointGlobalDeliveryRuleUrlRedirectAction.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      urlRewriteAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointGlobalDeliveryRuleUrlRewriteAction.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
