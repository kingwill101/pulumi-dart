...
class FrontdoorOriginState {
  ...
  factory FrontdoorOriginState.fromMap(Map<String, dynamic> map) {
    return FrontdoorOriginState(
      ...
      certificateNameCheckEnabled: (() { final guardedValue = map['certificateNameCheckEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
