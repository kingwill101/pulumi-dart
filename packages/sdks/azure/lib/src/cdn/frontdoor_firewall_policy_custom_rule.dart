...
class FrontdoorFirewallPolicyCustomRule {
  ...
  final List<FrontdoorFirewallPolicyCustomRuleMatchCondition>? matchConditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action,
      'enabled': ?enabled,
      'matchConditions': ?matchConditions == null ? null : pulumi.Input.encodeList<FrontdoorFirewallPolicyCustomRuleMatchCondition, Map<String, dynamic>>(matchConditions!, (value) => value.toMap()),
      'name': name,
      'priority': ?priority,
  ...
  factory FrontdoorFirewallPolicyCustomRule.fromMap(Map<String, dynamic> map) {
    return FrontdoorFirewallPolicyCustomRule(
      ...
      matchConditions: map['matchConditions'] == null ? null : pulumi.Input.decodeList<FrontdoorFirewallPolicyCustomRuleMatchCondition>(map['matchConditions'], (value) => FrontdoorFirewallPolicyCustomRuleMatchCondition.fromMap((value as Map).cast<String, dynamic>())),
