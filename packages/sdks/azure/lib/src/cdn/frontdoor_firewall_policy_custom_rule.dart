...
class FrontdoorFirewallPolicyCustomRule {
  ...
  final pulumi.Input<List<FrontdoorFirewallPolicyCustomRuleMatchCondition>>?
  matchConditions;
    ...
    return <String, dynamic>{
      ...
      'matchConditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<FrontdoorFirewallPolicyCustomRuleMatchCondition>,
    ...
    return FrontdoorFirewallPolicyCustomRule(
      ...
      matchConditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => FrontdoorFirewallPolicyCustomRuleMatchCondition.fromMap(
