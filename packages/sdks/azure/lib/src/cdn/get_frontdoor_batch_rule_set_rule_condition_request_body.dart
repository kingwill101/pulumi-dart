...
class GetFrontdoorBatchRuleSetRuleConditionRequestBody {
  ...
  /// Creates a new [GetFrontdoorBatchRuleSetRuleConditionRequestBody].
  ...
  const GetFrontdoorBatchRuleSetRuleConditionRequestBody({
  ...
  factory GetFrontdoorBatchRuleSetRuleConditionRequestBody.fromMap(Map<String, dynamic> map) {
    return GetFrontdoorBatchRuleSetRuleConditionRequestBody(
