    ...
    return <String, dynamic>{
      ...
      'customRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<FrontdoorFirewallPolicyCustomRule>,
      ...
      'managedRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<FrontdoorFirewallPolicyManagedRule>,
            List<Map<String, dynamic>>
          >(
            managedRules,
            (value) =>
  ...
  factory FrontdoorFirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorFirewallPolicyArgs(
      captchaCookieExpirationInMinutes: (() {
        final guardedValue = map['captchaCookieExpirationInMinutes'];
      ...
      customRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FrontdoorFirewallPolicyCustomRule>(
            guardedValue,
            (value) => FrontdoorFirewallPolicyCustomRule.fromMap(
      ...
      logScrubbing: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FrontdoorFirewallPolicyLogScrubbing.fromMap(
      ...
      managedRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FrontdoorFirewallPolicyManagedRule>(
            guardedValue,
      ...
      requestBodyCheckEnabled: (() {
        final guardedValue = map['requestBodyCheckEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
