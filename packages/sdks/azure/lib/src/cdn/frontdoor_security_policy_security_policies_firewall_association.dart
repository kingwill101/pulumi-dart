...
class FrontdoorSecurityPolicySecurityPoliciesFirewallAssociation {
  ...
  factory FrontdoorSecurityPolicySecurityPoliciesFirewallAssociation.fromMap(Map<String, dynamic> map) {
    return FrontdoorSecurityPolicySecurityPoliciesFirewallAssociation(
      domains: (pulumi.Input.decodeList<FrontdoorSecurityPolicySecurityPoliciesFirewallAssociationDomain>(map['domains'], (value) => FrontdoorSecurityPolicySecurityPoliciesFirewallAssociationDomain.fromMap((value as Map).cast<String, dynamic>()))).input(),
      patternsToMatch: (map['patternsToMatch'] as String).input(),
    );
  }
}
