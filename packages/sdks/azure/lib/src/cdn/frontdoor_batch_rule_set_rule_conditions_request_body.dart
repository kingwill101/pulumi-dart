...
class FrontdoorBatchRuleSetRuleConditionsRequestBody {
  ...
  /// Creates a new [FrontdoorBatchRuleSetRuleConditionsRequestBody].
  ...
  /// [values] One or more values representing the request body text to match. A maximum of `25` values may be defined. If multiple values are specified, they are evaluated using `OR` logic.
  const FrontdoorBatchRuleSetRuleConditionsRequestBody({
  ...
  factory FrontdoorBatchRuleSetRuleConditionsRequestBody.fromMap(Map<String, dynamic> map) {
    return FrontdoorBatchRuleSetRuleConditionsRequestBody(
