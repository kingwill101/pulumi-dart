...
class GetFrontdoorBatchRuleSetRuleConditionPostArgument {
  ...
  /// Creates a new [GetFrontdoorBatchRuleSetRuleConditionPostArgument].
  ...
  const GetFrontdoorBatchRuleSetRuleConditionPostArgument({
    required this.name,
  ...
  factory GetFrontdoorBatchRuleSetRuleConditionPostArgument.fromMap(Map<String, dynamic> map) {
    return GetFrontdoorBatchRuleSetRuleConditionPostArgument(
