...
class FrontdoorBatchRuleSetState {
  ...
  /// Creates a new [FrontdoorBatchRuleSetState].
  ...
  const FrontdoorBatchRuleSetState({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'rules': ?pulumi.Input.mapOptionalInputValue<List<FrontdoorBatchRuleSetRule>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<FrontdoorBatchRuleSetRule, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory FrontdoorBatchRuleSetState.fromMap(Map<String, dynamic> map) {
    return FrontdoorBatchRuleSetState(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FrontdoorBatchRuleSetRule>(guardedValue, (value) => FrontdoorBatchRuleSetRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
