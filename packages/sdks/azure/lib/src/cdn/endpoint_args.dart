...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    required pulumi.Output<List<EndpointOrigin>> origins,
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      origins: pulumi.Output.create<List<EndpointOrigin>>(pulumi.Input.decodeList<EndpointOrigin>(map['origins'], (value) => EndpointOrigin.fromMap((value as Map).cast<String, dynamic>()))),
