...
class FrontdoorOriginGroupState {
  ...
  FrontdoorOriginGroupState({
    ...
    pulumi.Output<FrontdoorOriginGroupLoadBalancing>? loadBalancing,
    ...
    pulumi.Output<bool>? sessionAffinityEnabled,
      ...
      loadBalancing = pulumi.Input.asOptionalInput<FrontdoorOriginGroupLoadBalancing>(loadBalancing),
  ...
  factory FrontdoorOriginGroupState.fromMap(Map<String, dynamic> map) {
    return FrontdoorOriginGroupState(
      ...
      loadBalancing: map['loadBalancing'] == null ? null : pulumi.Output.create<FrontdoorOriginGroupLoadBalancing>(FrontdoorOriginGroupLoadBalancing.fromMap((map['loadBalancing'] as Map).cast<String, dynamic>())),
