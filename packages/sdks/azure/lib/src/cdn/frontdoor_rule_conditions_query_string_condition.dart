...
class FrontdoorRuleConditionsQueryStringCondition {
  ...
  /// Creates a new [FrontdoorRuleConditionsQueryStringCondition].
  /// [matchValues] One or more string or integer values(e.g. "1") representing the value of the query string to match. If multiple values are specified, they're evaluated using `OR` logic.
  ...
  const FrontdoorRuleConditionsQueryStringCondition({
    this.matchValues,
  ...
  factory FrontdoorRuleConditionsQueryStringCondition.fromMap(Map<String, dynamic> map) {
    return FrontdoorRuleConditionsQueryStringCondition(
