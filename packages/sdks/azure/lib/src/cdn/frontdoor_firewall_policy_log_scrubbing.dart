...
class FrontdoorFirewallPolicyLogScrubbing {
  ...
  final pulumi.Input<List<FrontdoorFirewallPolicyLogScrubbingScrubbingRule>>
  scrubbingRules;
    ...
    return <String, dynamic>{
      ...
      'scrubbingRules':
          pulumi.Input.mapInputValue<
            List<FrontdoorFirewallPolicyLogScrubbingScrubbingRule>,
  ...
  factory FrontdoorFirewallPolicyLogScrubbing.fromMap(
    ...
    return FrontdoorFirewallPolicyLogScrubbing(
      ...
      scrubbingRules: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<FrontdoorFirewallPolicyLogScrubbingScrubbingRule>(
          map['scrubbingRules']!,
          (value) => FrontdoorFirewallPolicyLogScrubbingScrubbingRule.fromMap(
