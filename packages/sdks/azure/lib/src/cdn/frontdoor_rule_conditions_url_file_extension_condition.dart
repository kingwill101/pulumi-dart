...
class FrontdoorRuleConditionsUrlFileExtensionCondition {
  ...
  /// Creates a new [FrontdoorRuleConditionsUrlFileExtensionCondition].
  ...
  factory FrontdoorRuleConditionsUrlFileExtensionCondition.fromMap(
