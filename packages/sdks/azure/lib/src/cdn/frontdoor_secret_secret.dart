...
class FrontdoorSecretSecret {
  ...
  final pulumi.Input<List<FrontdoorSecretSecretCustomerCertificate>>
  ...
  FrontdoorSecretSecret({required this.customerCertificates});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customerCertificates':
          pulumi.Input.mapInputValue<
            List<FrontdoorSecretSecretCustomerCertificate>,
  ...
  factory FrontdoorSecretSecret.fromMap(Map<String, dynamic> map) {
    return FrontdoorSecretSecret(
      customerCertificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FrontdoorSecretSecretCustomerCertificate>(
          map['customerCertificates']!,
          (value) => FrontdoorSecretSecretCustomerCertificate.fromMap(
