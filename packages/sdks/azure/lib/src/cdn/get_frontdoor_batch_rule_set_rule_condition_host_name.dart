...
class GetFrontdoorBatchRuleSetRuleConditionHostName {
  ...
  /// Creates a new [GetFrontdoorBatchRuleSetRuleConditionHostName].
  ...
  const GetFrontdoorBatchRuleSetRuleConditionHostName({
  ...
  factory GetFrontdoorBatchRuleSetRuleConditionHostName.fromMap(Map<String, dynamic> map) {
    return GetFrontdoorBatchRuleSetRuleConditionHostName(
