...
class GetPoolNetworkConfigurationEndpointConfiguration {
  ...
  factory GetPoolNetworkConfigurationEndpointConfiguration.fromMap(
    ...
    return GetPoolNetworkConfigurationEndpointConfiguration(
      ...
      networkSecurityGroupRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetPoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRule
        >(
          map['networkSecurityGroupRules']!,
          (value) =>
              GetPoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRule.fromMap(
