...
class GetPoolExtension {
  ...
  factory GetPoolExtension.fromMap(Map<String, dynamic> map) {
    return GetPoolExtension(
      autoUpgradeMinorVersion: pulumi.Input.fromValue(
        map['autoUpgradeMinorVersion'] as bool,
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      protectedSettings: pulumi.Input.fromValue(
        map['protectedSettings'] as String,
      ),
      provisionAfterExtensions: pulumi.Input.fromValue(
        (map['provisionAfterExtensions'] as List).cast<String>(),
      ),
