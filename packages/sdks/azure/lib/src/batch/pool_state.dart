    ...
    return <String, dynamic>{
      ...
      'certificates':
          ...
          >(
            certificates,
            (value) =>
                pulumi.Input.encodeList<PoolCertificate, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'dataDisks':
          ...
          >(
            dataDisks,
            (value) =>
                pulumi.Input.encodeList<PoolDataDisk, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'extensions':
          ...
          >(
            extensions,
            (value) =>
                pulumi.Input.encodeList<PoolExtension, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'mounts':
          ...
          >(
            mounts,
            (value) => pulumi.Input.encodeList<PoolMount, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'userAccounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<PoolUserAccount>,
            List<Map<String, dynamic>>
          >(
            userAccounts,
            (value) =>
                pulumi.Input.encodeList<PoolUserAccount, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'windows':
          ...
          >(
            windows,
            (value) =>
                pulumi.Input.encodeList<PoolWindow, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return PoolState(
      ...
      autoScale: (() {
        ...
        return pulumi.Input.fromValue(
          PoolAutoScale.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      certificates: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolCertificate>(
            guardedValue,
            (value) =>
                PoolCertificate.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      containerConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolContainerConfiguration.fromMap(
      ...
      dataDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolDataDisk>(
            guardedValue,
            (value) =>
                PoolDataDisk.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      diskEncryptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolDiskEncryption>(
            guardedValue,
            (value) => PoolDiskEncryption.fromMap(
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolExtension>(
            guardedValue,
            (value) =>
                PoolExtension.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      fixedScale: (() {
        final guardedValue = map['fixedScale'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolFixedScale.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolIdentity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      maxTasksPerNode: (() {
        final guardedValue = map['maxTasksPerNode'];
        if (guardedValue == null) return null;
      ...
      mounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolMount>(
            guardedValue,
            (value) =>
                PoolMount.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
      ...
      networkConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolNetworkConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      nodeAgentSkuId: (() {
        final guardedValue = map['nodeAgentSkuId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nodePlacements: (() {
        final guardedValue = map['nodePlacements'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolNodePlacement>(
            guardedValue,
            (value) => PoolNodePlacement.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      osDiskPlacement: (() {
        final guardedValue = map['osDiskPlacement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceGroupName: (() {
      ...
      startTask: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolStartTask.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      stopPendingResizeOperation: (() {
        final guardedValue = map['stopPendingResizeOperation'];
        if (guardedValue == null) return null;
      ...
      storageImageReference: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolStorageImageReference.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      taskSchedulingPolicies: (() {
        final guardedValue = map['taskSchedulingPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolTaskSchedulingPolicy>(
            guardedValue,
            (value) => PoolTaskSchedulingPolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      userAccounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolUserAccount>(
            guardedValue,
            (value) =>
                PoolUserAccount.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      vmSize: (() {
      ...
      windows: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolWindow>(
            guardedValue,
            (value) =>
                PoolWindow.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
