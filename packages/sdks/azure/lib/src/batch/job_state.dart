...
class JobState {
  ...
  JobState({
    pulumi.Output<String>? batchPoolId,
    ...
    pulumi.Output<int>? taskRetryMaximum,
      ...
      batchPoolId = pulumi.Input.asOptionalInput<String>(batchPoolId),
  ...
  factory JobState.fromMap(Map<String, dynamic> map) {
    return JobState(
      batchPoolId: map['batchPoolId'] == null ? null : pulumi.Output.create<String>(map['batchPoolId'] as String),
