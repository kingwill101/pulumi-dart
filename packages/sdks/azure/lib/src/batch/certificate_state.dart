...
class CertificateState {
  ...
  factory CertificateState.fromMap(Map<String, dynamic> map) {
    return CertificateState(
      ...
      publicData: (() { final guardedValue = map['publicData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      thumbprintAlgorithm: (() { final guardedValue = map['thumbprintAlgorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
