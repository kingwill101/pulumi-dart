...
class GetPoolStartTaskContainer {
  ...
  factory GetPoolStartTaskContainer.fromMap(Map<String, dynamic> map) {
    return GetPoolStartTaskContainer(
      ...
      registries: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPoolStartTaskContainerRegistry>(map['registries']!, (value) => GetPoolStartTaskContainerRegistry.fromMap((value as Map).cast<String, dynamic>()))),
