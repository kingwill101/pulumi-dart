...
class PoolNetworkConfigurationEndpointConfiguration {
  ...
  final pulumi.Input<
    List<PoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRule>
  >?
  ...
  factory PoolNetworkConfigurationEndpointConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return PoolNetworkConfigurationEndpointConfiguration(
      backendPort: pulumi.Input.fromValue(map['backendPort'] as int),
      frontendPortRange: pulumi.Input.fromValue(
        map['frontendPortRange'] as String,
      ),
      ...
      networkSecurityGroupRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRule.fromMap(
