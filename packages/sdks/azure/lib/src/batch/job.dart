...
class Job extends pulumi.CustomResource {
  ...
  Job(
    ...
    this.batchPoolId = registerOutput<String>('batchPoolId');
    this.commonEnvironmentProperties = registerOutput<Map<String, String>?>('commonEnvironmentProperties');
    this.displayName = registerOutput<String?>('displayName');
    this.name = registerOutput<String>('name');
    this.priority = registerOutput<int?>('priority');
    this.taskRetryMaximum = registerOutput<int?>('taskRetryMaximum');
  }
