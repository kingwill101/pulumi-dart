...
class PoolArgs {
  ...
  const PoolArgs({
    ...
    required this.storageImageReference,
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      storageImageReference: pulumi.Input.fromValue(PoolStorageImageReference.fromMap((map['storageImageReference']! as Map).cast<String, dynamic>())),
