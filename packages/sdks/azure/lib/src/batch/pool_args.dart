...
class PoolArgs {
  ...
  PoolArgs({
    ...
    required pulumi.Output<String> nodeAgentSkuId,
    ...
    required pulumi.Output<PoolStorageImageReference> storageImageReference,
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      nodeAgentSkuId: pulumi.Output.create<String>(map['nodeAgentSkuId'] as String),
      ...
      storageImageReference: pulumi.Output.create<PoolStorageImageReference>(PoolStorageImageReference.fromMap((map['storageImageReference'] as Map).cast<String, dynamic>())),
