...
class PoolUserAccount {
  ...
  final pulumi.Input<List<PoolUserAccountLinuxUserConfiguration>>?
  ...
  final pulumi.Input<List<PoolUserAccountWindowsUserConfiguration>>?
    ...
    return <String, dynamic>{
      ...
      'linuxUserConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<PoolUserAccountLinuxUserConfiguration>,
      ...
      'windowsUserConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<PoolUserAccountWindowsUserConfiguration>,
            List<Map<String, dynamic>>
          >(
            windowsUserConfigurations,
            (value) =>
  ...
  factory PoolUserAccount.fromMap(Map<String, dynamic> map) {
    return PoolUserAccount(
      ...
      linuxUserConfigurations: (() {
        final guardedValue = map['linuxUserConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolUserAccountLinuxUserConfiguration>(
            guardedValue,
            (value) => PoolUserAccountLinuxUserConfiguration.fromMap(
      ...
      windowsUserConfigurations: (() {
        final guardedValue = map['windowsUserConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolUserAccountWindowsUserConfiguration>(
            guardedValue,
            (value) => PoolUserAccountWindowsUserConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
