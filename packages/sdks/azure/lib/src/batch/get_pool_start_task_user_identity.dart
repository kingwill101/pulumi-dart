...
class GetPoolStartTaskUserIdentity {
    ...
    return <String, dynamic>{
      'autoUsers':
          pulumi.Input.mapInputValue<
            List<GetPoolStartTaskUserIdentityAutoUser>,
  ...
  factory GetPoolStartTaskUserIdentity.fromMap(Map<String, dynamic> map) {
    return GetPoolStartTaskUserIdentity(
      autoUsers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPoolStartTaskUserIdentityAutoUser>(
          map['autoUsers']!,
          (value) => GetPoolStartTaskUserIdentityAutoUser.fromMap(
