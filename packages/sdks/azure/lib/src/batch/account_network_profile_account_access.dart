...
class AccountNetworkProfileAccountAccess {
  ...
  factory AccountNetworkProfileAccountAccess.fromMap(Map<String, dynamic> map) {
    return AccountNetworkProfileAccountAccess(
      ...
      ipRules: (() { final guardedValue = map['ipRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccountNetworkProfileAccountAccessIpRule>(guardedValue, (value) => AccountNetworkProfileAccountAccessIpRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
