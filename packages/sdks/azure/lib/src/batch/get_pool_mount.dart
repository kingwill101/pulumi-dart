...
class GetPoolMount {
  ...
  /// [azureBlobFileSystems] A `azureBlobFileSystem` block defined as below.
  ...
  factory GetPoolMount.fromMap(Map<String, dynamic> map) {
    return GetPoolMount(
      azureBlobFileSystems: (() { final guardedValue = map['azureBlobFileSystems']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetPoolMountAzureBlobFileSystem>(guardedValue, (value) => GetPoolMountAzureBlobFileSystem.fromMap((value as Map).cast<String, dynamic>()))); })(),
      azureFileShares: (() { final guardedValue = map['azureFileShares']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetPoolMountAzureFileShare>(guardedValue, (value) => GetPoolMountAzureFileShare.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cifsMounts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPoolMountCifsMount>(map['cifsMounts']!, (value) => GetPoolMountCifsMount.fromMap((value as Map).cast<String, dynamic>()))),
      nfsMounts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPoolMountNfsMount>(map['nfsMounts']!, (value) => GetPoolMountNfsMount.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
