...
class GetPoolContainerConfiguration {
  ...
  final pulumi.Input<List<GetPoolContainerConfigurationContainerRegistry>>
  containerRegistries;
    ...
    return <String, dynamic>{
      ...
      'containerRegistries':
          pulumi.Input.mapInputValue<
            List<GetPoolContainerConfigurationContainerRegistry>,
  ...
  factory GetPoolContainerConfiguration.fromMap(Map<String, dynamic> map) {
    return GetPoolContainerConfiguration(
      containerImageNames: pulumi.Input.fromValue(
        (map['containerImageNames'] as List).cast<String>(),
      ),
      containerRegistries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPoolContainerConfigurationContainerRegistry>(
          map['containerRegistries']!,
          (value) => GetPoolContainerConfigurationContainerRegistry.fromMap(
