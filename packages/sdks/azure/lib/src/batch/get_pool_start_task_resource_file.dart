...
class GetPoolStartTaskResourceFile {
  ...
  factory GetPoolStartTaskResourceFile.fromMap(Map<String, dynamic> map) {
    return GetPoolStartTaskResourceFile(
      autoStorageContainerName: pulumi.Input.fromValue(map['autoStorageContainerName'] as String),
      ...
      storageContainerUrl: pulumi.Input.fromValue(map['storageContainerUrl'] as String),
