...
class AccountNetworkProfileNodeManagementAccess {
  ...
  final pulumi.Input<List<AccountNetworkProfileNodeManagementAccessIpRule>>?
  ipRules;
  ...
  AccountNetworkProfileNodeManagementAccess({this.defaultAction, this.ipRules});
    ...
    return <String, dynamic>{
      ...
      'ipRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccountNetworkProfileNodeManagementAccessIpRule>,
  ...
  factory AccountNetworkProfileNodeManagementAccess.fromMap(
    ...
    return AccountNetworkProfileNodeManagementAccess(
      ...
      ipRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => AccountNetworkProfileNodeManagementAccessIpRule.fromMap(
