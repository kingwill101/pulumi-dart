...
class PoolStartTaskContainer {
  ...
  final List<PoolStartTaskContainerRegistry>? registries;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'imageName': imageName,
      'registries': ?registries == null ? null : pulumi.Input.encodeList<PoolStartTaskContainerRegistry, Map<String, dynamic>>(registries!, (value) => value.toMap()),
  ...
  factory PoolStartTaskContainer.fromMap(Map<String, dynamic> map) {
    return PoolStartTaskContainer(
      ...
      registries: map['registries'] == null ? null : pulumi.Input.decodeList<PoolStartTaskContainerRegistry>(map['registries'], (value) => PoolStartTaskContainerRegistry.fromMap((value as Map).cast<String, dynamic>())),
      runOptions: map['runOptions'] == null ? null : map['runOptions'] as String,
