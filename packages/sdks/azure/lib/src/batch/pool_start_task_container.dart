    ...
    return <String, dynamic>{
      ...
      'registries':
          ?pulumi.Input.mapOptionalInputValue<
            List<PoolStartTaskContainerRegistry>,
    ...
    return PoolStartTaskContainer(
      ...
      registries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolStartTaskContainerRegistry>(
            guardedValue,
            (value) => PoolStartTaskContainerRegistry.fromMap(
      ...
      runOptions: (() {
        final guardedValue = map['runOptions'];
        if (guardedValue == null) return null;
