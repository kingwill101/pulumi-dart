...
class AccountNetworkProfile {
  ...
  final pulumi.Input<AccountNetworkProfileNodeManagementAccess>?
  ...
  AccountNetworkProfile({this.accountAccess, this.nodeManagementAccess});
    ...
    return AccountNetworkProfile(
      accountAccess: (() {
        ...
        return pulumi.Input.fromValue(
          AccountNetworkProfileAccountAccess.fromMap(
      ...
      nodeManagementAccess: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccountNetworkProfileNodeManagementAccess.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
