...
class PoolContainerConfiguration {
  ...
  /// [containerRegistries] One or more `containerRegistries` blocks as defined below. Additional container registries from which container images can be pulled by the pool's VMs. Changing this forces a new resource to be created.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containerRegistries': ?pulumi.Input.mapOptionalInputValue<List<PoolContainerConfigurationContainerRegistry>, List<Map<String, dynamic>>>(containerRegistries, (value) => pulumi.Input.encodeList<PoolContainerConfigurationContainerRegistry, Map<String, dynamic>>(value, (value) => value.toMap())),
      'type': ?type,
    };
  }
  ...
  factory PoolContainerConfiguration.fromMap(Map<String, dynamic> map) {
    return PoolContainerConfiguration(
      ...
      containerRegistries: (() { final guardedValue = map['containerRegistries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PoolContainerConfigurationContainerRegistry>(guardedValue, (value) => PoolContainerConfigurationContainerRegistry.fromMap((value as Map).cast<String, dynamic>()))); })(),
