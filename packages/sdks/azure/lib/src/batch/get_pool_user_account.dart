...
class GetPoolUserAccount {
  ...
  final pulumi.Input<List<GetPoolUserAccountLinuxUserConfiguration>>
  ...
  final pulumi.Input<List<GetPoolUserAccountWindowsUserConfiguration>>
    ...
    return <String, dynamic>{
      ...
      'linuxUserConfigurations':
          pulumi.Input.mapInputValue<
            List<GetPoolUserAccountLinuxUserConfiguration>,
      ...
      'windowsUserConfigurations':
          pulumi.Input.mapInputValue<
            List<GetPoolUserAccountWindowsUserConfiguration>,
            List<Map<String, dynamic>>
          >(
            windowsUserConfigurations,
            (value) =>
  ...
  factory GetPoolUserAccount.fromMap(Map<String, dynamic> map) {
    return GetPoolUserAccount(
      ...
      linuxUserConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPoolUserAccountLinuxUserConfiguration>(
          map['linuxUserConfigurations']!,
          (value) => GetPoolUserAccountLinuxUserConfiguration.fromMap(
      ...
      windowsUserConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPoolUserAccountWindowsUserConfiguration>(
          map['windowsUserConfigurations']!,
          (value) => GetPoolUserAccountWindowsUserConfiguration.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
