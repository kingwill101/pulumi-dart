...
class GetPoolResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'autoScales':
          pulumi.Input.encodeList<GetPoolAutoScale, Map<String, dynamic>>(
            autoScales,
            (value) => value.toMap(),
          ),
      'certificates':
          pulumi.Input.encodeList<GetPoolCertificate, Map<String, dynamic>>(
            certificates,
            (value) => value.toMap(),
          ),
      'containerConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(containerConfigurations, (value) => value.toMap()),
      'dataDisks':
          pulumi.Input.encodeList<GetPoolDataDisk, Map<String, dynamic>>(
            dataDisks,
            (value) => value.toMap(),
          ),
      'diskEncryptions':
          pulumi.Input.encodeList<GetPoolDiskEncryption, Map<String, dynamic>>(
            diskEncryptions,
            (value) => value.toMap(),
          ),
      'displayName': displayName,
      'extensions':
          pulumi.Input.encodeList<GetPoolExtension, Map<String, dynamic>>(
            extensions,
            (value) => value.toMap(),
          ),
      'fixedScales':
          pulumi.Input.encodeList<GetPoolFixedScale, Map<String, dynamic>>(
            fixedScales,
            (value) => value.toMap(),
          ),
      'id': id,
      ...
      'metadata': metadata,
      'mounts': pulumi.Input.encodeList<GetPoolMount, Map<String, dynamic>>(
        mounts,
        (value) => value.toMap(),
      ),
      'name': name,
      ...
      'nodePlacements':
          pulumi.Input.encodeList<GetPoolNodePlacement, Map<String, dynamic>>(
            nodePlacements,
            (value) => value.toMap(),
          ),
      ...
      'startTasks':
          pulumi.Input.encodeList<GetPoolStartTask, Map<String, dynamic>>(
            startTasks,
            (value) => value.toMap(),
          ),
      'storageImageReferences':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(storageImageReferences, (value) => value.toMap()),
      'taskSchedulingPolicies':
          pulumi.Input.encodeList<
            GetPoolTaskSchedulingPolicy,
            Map<String, dynamic>
          >(taskSchedulingPolicies, (value) => value.toMap()),
      'userAccounts':
          pulumi.Input.encodeList<GetPoolUserAccount, Map<String, dynamic>>(
            userAccounts,
            (value) => value.toMap(),
          ),
      'vmSize': vmSize,
      'windows': pulumi.Input.encodeList<GetPoolWindow, Map<String, dynamic>>(
        windows,
        (value) => value.toMap(),
      ),
    };
  ...
  factory GetPoolResult.fromMap(Map<String, dynamic> map) {
    return GetPoolResult(
      ...
      autoScales: pulumi.Input.decodeList<GetPoolAutoScale>(
        map['autoScales']!,
        (value) =>
            GetPoolAutoScale.fromMap((value as Map).cast<String, dynamic>()),
      ),
      certificates: pulumi.Input.decodeList<GetPoolCertificate>(
        map['certificates']!,
        (value) =>
            GetPoolCertificate.fromMap((value as Map).cast<String, dynamic>()),
      ),
      containerConfigurations:
          pulumi.Input.decodeList<GetPoolContainerConfiguration>(
            map['containerConfigurations']!,
            (value) => GetPoolContainerConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      dataDisks: pulumi.Input.decodeList<GetPoolDataDisk>(
        map['dataDisks']!,
        (value) =>
            GetPoolDataDisk.fromMap((value as Map).cast<String, dynamic>()),
      ),
      diskEncryptions: pulumi.Input.decodeList<GetPoolDiskEncryption>(
        map['diskEncryptions']!,
        (value) => GetPoolDiskEncryption.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      displayName: map['displayName'] as String,
      extensions: pulumi.Input.decodeList<GetPoolExtension>(
        map['extensions']!,
        (value) =>
            GetPoolExtension.fromMap((value as Map).cast<String, dynamic>()),
      ),
      fixedScales: pulumi.Input.decodeList<GetPoolFixedScale>(
        map['fixedScales']!,
        (value) =>
            GetPoolFixedScale.fromMap((value as Map).cast<String, dynamic>()),
      ),
      id: map['id'] as String,
      ...
      mounts: pulumi.Input.decodeList<GetPoolMount>(
        map['mounts']!,
        (value) => GetPoolMount.fromMap((value as Map).cast<String, dynamic>()),
      ),
      name: map['name'] as String,
      networkConfigurations:
          pulumi.Input.decodeList<GetPoolNetworkConfiguration>(
            map['networkConfigurations']!,
            (value) => GetPoolNetworkConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      nodeAgentSkuId: map['nodeAgentSkuId'] as String,
      nodePlacements: pulumi.Input.decodeList<GetPoolNodePlacement>(
        map['nodePlacements']!,
        (value) => GetPoolNodePlacement.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      osDiskPlacement: map['osDiskPlacement'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      startTasks: pulumi.Input.decodeList<GetPoolStartTask>(
        map['startTasks']!,
        (value) =>
            GetPoolStartTask.fromMap((value as Map).cast<String, dynamic>()),
      ),
      storageImageReferences:
          pulumi.Input.decodeList<GetPoolStorageImageReference>(
            map['storageImageReferences']!,
            (value) => GetPoolStorageImageReference.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      taskSchedulingPolicies:
          pulumi.Input.decodeList<GetPoolTaskSchedulingPolicy>(
            map['taskSchedulingPolicies']!,
            (value) => GetPoolTaskSchedulingPolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      userAccounts: pulumi.Input.decodeList<GetPoolUserAccount>(
        map['userAccounts']!,
        (value) =>
            GetPoolUserAccount.fromMap((value as Map).cast<String, dynamic>()),
      ),
      vmSize: map['vmSize'] as String,
      windows: pulumi.Input.decodeList<GetPoolWindow>(
        map['windows']!,
        (value) =>
            GetPoolWindow.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
