...
class PoolStartTask {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceFiles':
          ?pulumi.Input.mapOptionalInputValue<
            List<PoolStartTaskResourceFile>,
            List<Map<String, dynamic>>
          >(
            resourceFiles,
            (value) =>
  ...
  factory PoolStartTask.fromMap(Map<String, dynamic> map) {
    return PoolStartTask(
      ...
      containers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolStartTaskContainer>(
            guardedValue,
            (value) => PoolStartTaskContainer.fromMap(
      ...
      resourceFiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolStartTaskResourceFile>(
            guardedValue,
            (value) => PoolStartTaskResourceFile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      userIdentity: pulumi.Input.fromValue(
        PoolStartTaskUserIdentity.fromMap(
          (map['userIdentity']! as Map).cast<String, dynamic>(),
        ),
      ),
      waitForSuccess: (() {
