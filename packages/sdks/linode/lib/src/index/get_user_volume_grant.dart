...
class GetUserVolumeGrant {
  ...
  /// Creates a new [GetUserVolumeGrant].
  ...
  factory GetUserVolumeGrant.fromMap(Map<String, dynamic> map) {
    return GetUserVolumeGrant(
