...
class InterfaceVpcIpv4 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'assignedAddresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfaceVpcIpv4AssignedAddress>,
            List<Map<String, dynamic>>
          >(
            assignedAddresses,
            (value) =>
      ...
      'assignedRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfaceVpcIpv4AssignedRange>,
            List<Map<String, dynamic>>
          >(
            assignedRanges,
            (value) =>
    ...
    return InterfaceVpcIpv4(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv4Address>(
            guardedValue,
            (value) => InterfaceVpcIpv4Address.fromMap(
      ...
      assignedAddresses: (() {
        final guardedValue = map['assignedAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv4AssignedAddress>(
            guardedValue,
            (value) => InterfaceVpcIpv4AssignedAddress.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      assignedRanges: (() {
        final guardedValue = map['assignedRanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv4AssignedRange>(
            guardedValue,
            (value) => InterfaceVpcIpv4AssignedRange.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ranges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv4Range>(
            guardedValue,
            (value) => InterfaceVpcIpv4Range.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
