    ...
    return <String, dynamic>{
      'ranges':
          pulumi.Input.mapInputValue<
            List<GetInterfacePublicIpv6Range>,
      ...
      'shareds':
          pulumi.Input.mapInputValue<
            List<GetInterfacePublicIpv6Shared>,
            List<Map<String, dynamic>>
          >(
            shareds,
            (value) =>
      ...
      'slaacs':
          pulumi.Input.mapInputValue<
            List<GetInterfacePublicIpv6Slaac>,
            List<Map<String, dynamic>>
          >(
            slaacs,
            (value) =>
  ...
  factory GetInterfacePublicIpv6.fromMap(Map<String, dynamic> map) {
    return GetInterfacePublicIpv6(
      ranges: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInterfacePublicIpv6Range>(
          map['ranges']!,
          (value) => GetInterfacePublicIpv6Range.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      shareds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInterfacePublicIpv6Shared>(
          map['shareds']!,
          (value) => GetInterfacePublicIpv6Shared.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      slaacs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInterfacePublicIpv6Slaac>(
          map['slaacs']!,
          (value) => GetInterfacePublicIpv6Slaac.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
