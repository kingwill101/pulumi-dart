...
class GetInterfacePublicIpv6 {
  ...
  factory GetInterfacePublicIpv6.fromMap(Map<String, dynamic> map) {
    return GetInterfacePublicIpv6(
      ranges: (pulumi.Input.decodeList<GetInterfacePublicIpv6Range>(map['ranges'], (value) => GetInterfacePublicIpv6Range.fromMap((value as Map).cast<String, dynamic>()))).input(),
      shareds: (pulumi.Input.decodeList<GetInterfacePublicIpv6Shared>(map['shareds'], (value) => GetInterfacePublicIpv6Shared.fromMap((value as Map).cast<String, dynamic>()))).input(),
      slaacs: (pulumi.Input.decodeList<GetInterfacePublicIpv6Slaac>(map['slaacs'], (value) => GetInterfacePublicIpv6Slaac.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
