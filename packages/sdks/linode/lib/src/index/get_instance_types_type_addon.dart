...
class GetInstanceTypesTypeAddon {
  ...
  /// [backups] Required.
  const GetInstanceTypesTypeAddon({
  ...
  factory GetInstanceTypesTypeAddon.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypesTypeAddon(
      backups: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTypesTypeAddonBackup>(map['backups']!, (value) => GetInstanceTypesTypeAddonBackup.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
