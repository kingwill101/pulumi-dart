...
class GetProducerImageShareGroupImageSharesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'imageShares': ?(() {
        final guardedValue = imageShares;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetProducerImageShareGroupImageSharesResult.fromMap(
    ...
    return GetProducerImageShareGroupImageSharesResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<GetProducerImageShareGroupImageSharesFilter>(
          guardedValue,
      ...
      imageShares: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<GetProducerImageShareGroupImageSharesImageShare>(
          guardedValue,
