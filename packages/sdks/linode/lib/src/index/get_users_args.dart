...
class GetUsersArgs {
  ...
  factory GetUsersArgs.fromMap(Map<String, dynamic> map) {
    return GetUsersArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersFilter>(guardedValue, (value) => GetUsersFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
