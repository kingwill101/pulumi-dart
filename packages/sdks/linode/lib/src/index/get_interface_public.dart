...
class GetInterfacePublic {
  ...
  factory GetInterfacePublic.fromMap(Map<String, dynamic> map) {
    return GetInterfacePublic(
      ipv4: pulumi.Input.fromValue(GetInterfacePublicIpv4.fromMap((map['ipv4']! as Map).cast<String, dynamic>())),
      ipv6: pulumi.Input.fromValue(GetInterfacePublicIpv6.fromMap((map['ipv6']! as Map).cast<String, dynamic>())),
    );
  }
}
