...
class RdnsState {
  ...
  factory RdnsState.fromMap(Map<String, dynamic> map) {
    return RdnsState(
      ...
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RdnsTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      waitForAvailable: (() { final guardedValue = map['waitForAvailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
