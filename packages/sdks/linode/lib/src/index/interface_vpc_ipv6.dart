    ...
    return <String, dynamic>{
      'assignedRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfaceVpcIpv6AssignedRange>,
      ...
      'assignedSlaacs':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfaceVpcIpv6AssignedSlaac>,
            List<Map<String, dynamic>>
          >(
            assignedSlaacs,
            (value) =>
    ...
    return InterfaceVpcIpv6(
      assignedRanges: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv6AssignedRange>(
            guardedValue,
            (value) => InterfaceVpcIpv6AssignedRange.fromMap(
      ...
      assignedSlaacs: (() {
        final guardedValue = map['assignedSlaacs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv6AssignedSlaac>(
            guardedValue,
            (value) => InterfaceVpcIpv6AssignedSlaac.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ranges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv6Range>(
            guardedValue,
            (value) => InterfaceVpcIpv6Range.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      slaacs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfaceVpcIpv6Slaac>(
            guardedValue,
            (value) => InterfaceVpcIpv6Slaac.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
