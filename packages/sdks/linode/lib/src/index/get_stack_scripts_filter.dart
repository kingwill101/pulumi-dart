...
class GetStackScriptsFilter {
  ...
  /// Creates a new [GetStackScriptsFilter].
  ...
  factory GetStackScriptsFilter.fromMap(Map<String, dynamic> map) {
    return GetStackScriptsFilter(
