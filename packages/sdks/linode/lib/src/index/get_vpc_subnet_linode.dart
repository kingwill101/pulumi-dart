...
class GetVpcSubnetLinode {
  ...
  GetVpcSubnetLinode({required this.id, required this.interfaces});
    ...
    return <String, dynamic>{
      ...
      'interfaces':
          pulumi.Input.mapInputValue<
            List<GetVpcSubnetLinodeInterface>,
  ...
  factory GetVpcSubnetLinode.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetLinode(
      ...
      interfaces: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcSubnetLinodeInterface>(
          map['interfaces']!,
          (value) => GetVpcSubnetLinodeInterface.fromMap(
