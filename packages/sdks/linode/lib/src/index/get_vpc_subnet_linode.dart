...
class GetVpcSubnetLinode {
  ...
  factory GetVpcSubnetLinode.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetLinode(
      ...
      interfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVpcSubnetLinodeInterface>(map['interfaces']!, (value) => GetVpcSubnetLinodeInterface.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
