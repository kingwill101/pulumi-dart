...
class GetAccountLoginsFilter {
  ...
  /// Creates a new [GetAccountLoginsFilter].
  ...
  factory GetAccountLoginsFilter.fromMap(Map<String, dynamic> map) {
    return GetAccountLoginsFilter(
