...
class GetDatabaseBackupsArgs {
  ...
  factory GetDatabaseBackupsArgs.fromMap(Map<String, dynamic> map) {
    return GetDatabaseBackupsArgs(
      ...
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetDatabaseBackupsFilter>(guardedValue, (value) => GetDatabaseBackupsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
