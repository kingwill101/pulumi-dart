...
class GetInstancesInstanceConfigDevice {
  ...
  factory GetInstancesInstanceConfigDevice.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstanceConfigDevice(
      sdas: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSda>(map['sdas']!, (value) => GetInstancesInstanceConfigDeviceSda.fromMap((value as Map).cast<String, dynamic>()))),
      sdbs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSdb>(map['sdbs']!, (value) => GetInstancesInstanceConfigDeviceSdb.fromMap((value as Map).cast<String, dynamic>()))),
      sdcs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSdc>(map['sdcs']!, (value) => GetInstancesInstanceConfigDeviceSdc.fromMap((value as Map).cast<String, dynamic>()))),
      sdds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSdd>(map['sdds']!, (value) => GetInstancesInstanceConfigDeviceSdd.fromMap((value as Map).cast<String, dynamic>()))),
      sdes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSde>(map['sdes']!, (value) => GetInstancesInstanceConfigDeviceSde.fromMap((value as Map).cast<String, dynamic>()))),
      sdfs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSdf>(map['sdfs']!, (value) => GetInstancesInstanceConfigDeviceSdf.fromMap((value as Map).cast<String, dynamic>()))),
      sdgs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSdg>(map['sdgs']!, (value) => GetInstancesInstanceConfigDeviceSdg.fromMap((value as Map).cast<String, dynamic>()))),
      sdhs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDeviceSdh>(map['sdhs']!, (value) => GetInstancesInstanceConfigDeviceSdh.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
