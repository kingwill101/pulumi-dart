    ...
    return <String, dynamic>{
      ...
      'members':
          pulumi.Input.mapInputValue<
            List<GetPlacementGroupsPlacementGroupMember>,
  ...
  factory GetPlacementGroupsPlacementGroup.fromMap(Map<String, dynamic> map) {
    return GetPlacementGroupsPlacementGroup(
      ...
      members: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPlacementGroupsPlacementGroupMember>(
          map['members']!,
          (value) => GetPlacementGroupsPlacementGroupMember.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      migrations: pulumi.Input.fromValue(
        GetPlacementGroupsPlacementGroupMigrations.fromMap(
