...
class GetInstanceNetworkingIpv4SharedVpcNat11 {
  /// The address.
  ...
  /// Creates a new [GetInstanceNetworkingIpv4SharedVpcNat11].
  /// [address] The address.
  ...
  const GetInstanceNetworkingIpv4SharedVpcNat11({
  ...
  factory GetInstanceNetworkingIpv4SharedVpcNat11.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv4SharedVpcNat11(
