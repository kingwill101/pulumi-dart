...
class GetInstancesInstance {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'backups':
          pulumi.Input.mapInputValue<
            List<GetInstancesInstanceBackup>,
      ...
      'configs':
          pulumi.Input.mapInputValue<
            List<GetInstancesInstanceConfig>,
            List<Map<String, dynamic>>
          >(
            configs,
            (value) =>
      ...
      'placementGroups':
          pulumi.Input.mapInputValue<
            List<GetInstancesInstancePlacementGroup>,
            List<Map<String, dynamic>>
          >(
            placementGroups,
            (value) =>
  ...
  factory GetInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstance(
      alerts: pulumi.Input.fromValue(
        GetInstancesInstanceAlerts.fromMap(
          (map['alerts']! as Map).cast<String, dynamic>(),
        ),
      ),
      backups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstancesInstanceBackup>(
          map['backups']!,
          (value) => GetInstancesInstanceBackup.fromMap(
      ...
      configs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstancesInstanceConfig>(
          map['configs']!,
          (value) => GetInstancesInstanceConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      disks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstancesInstanceDisk>(
          map['disks']!,
          (value) => GetInstancesInstanceDisk.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      interfaceGeneration: pulumi.Input.fromValue(
        map['interfaceGeneration'] as String,
      ),
      ...
      maintenancePolicy: pulumi.Input.fromValue(
        map['maintenancePolicy'] as String,
      ),
      placementGroups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstancesInstancePlacementGroup>(
          map['placementGroups']!,
          (value) => GetInstancesInstancePlacementGroup.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      specs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstancesInstanceSpec>(
          map['specs']!,
          (value) => GetInstancesInstanceSpec.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
