...
class GetPlacementGroupsFilter {
  ...
  /// Creates a new [GetPlacementGroupsFilter].
  ...
  const GetPlacementGroupsFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetPlacementGroupsFilter.fromMap(Map<String, dynamic> map) {
    return GetPlacementGroupsFilter(
