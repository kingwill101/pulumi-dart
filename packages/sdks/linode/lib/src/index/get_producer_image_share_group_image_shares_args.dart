...
class GetProducerImageShareGroupImageSharesArgs {
  final pulumi.Input<List<GetProducerImageShareGroupImageSharesFilter>>?
  filters;
  final pulumi.Input<List<GetProducerImageShareGroupImageSharesImageShare>>?
  imageShares;
    ...
    return <String, dynamic>{
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetProducerImageShareGroupImageSharesFilter>,
      ...
      'imageShares':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetProducerImageShareGroupImageSharesImageShare>,
            List<Map<String, dynamic>>
          >(
            imageShares,
            (value) =>
  ...
  factory GetProducerImageShareGroupImageSharesArgs.fromMap(
    ...
    return GetProducerImageShareGroupImageSharesArgs(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetProducerImageShareGroupImageSharesFilter>(
            guardedValue,
            (value) => GetProducerImageShareGroupImageSharesFilter.fromMap(
      ...
      imageShares: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GetProducerImageShareGroupImageSharesImageShare.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
