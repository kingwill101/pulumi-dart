...
class GetInterfacePublicIpv4 {
  ...
  GetInterfacePublicIpv4({required this.addresses, required this.shareds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addresses':
          pulumi.Input.mapInputValue<
            List<GetInterfacePublicIpv4Address>,
      ...
      'shareds':
          pulumi.Input.mapInputValue<
            List<GetInterfacePublicIpv4Shared>,
            List<Map<String, dynamic>>
          >(
            shareds,
            (value) =>
  ...
  factory GetInterfacePublicIpv4.fromMap(Map<String, dynamic> map) {
    return GetInterfacePublicIpv4(
      addresses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInterfacePublicIpv4Address>(
          map['addresses']!,
          (value) => GetInterfacePublicIpv4Address.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      shareds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInterfacePublicIpv4Shared>(
          map['shareds']!,
          (value) => GetInterfacePublicIpv4Shared.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
