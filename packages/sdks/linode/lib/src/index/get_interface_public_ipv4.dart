...
class GetInterfacePublicIpv4 {
  ...
  factory GetInterfacePublicIpv4.fromMap(Map<String, dynamic> map) {
    return GetInterfacePublicIpv4(
      addresses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInterfacePublicIpv4Address>(map['addresses']!, (value) => GetInterfacePublicIpv4Address.fromMap((value as Map).cast<String, dynamic>()))),
      shareds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInterfacePublicIpv4Shared>(map['shareds']!, (value) => GetInterfacePublicIpv4Shared.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
