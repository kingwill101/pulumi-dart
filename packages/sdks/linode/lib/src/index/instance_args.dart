...
class InstanceArgs {
  ...
  InstanceArgs({
    pulumi.Output<InstanceAlerts>? alerts,
    ...
    pulumi.Output<String>? bootConfigLabel,
    pulumi.Output<bool>? booted,
    pulumi.Output<List<InstanceConfig>>? configs,
    pulumi.Output<String>? diskEncryption,
    pulumi.Output<List<InstanceDisk>>? disks,
    pulumi.Output<int>? firewallId,
    pulumi.Output<String>? group,
    pulumi.Output<String>? image,
    pulumi.Output<String>? interfaceGeneration,
    pulumi.Output<List<InstanceInterface>>? interfaces,
    pulumi.Output<List<String>>? ipv4s,
    pulumi.Output<String>? label,
    pulumi.Output<String>? maintenancePolicy,
    pulumi.Output<List<InstanceMetadata>>? metadatas,
    pulumi.Output<String>? migrationType,
    pulumi.Output<bool>? networkHelper,
    pulumi.Output<InstancePlacementGroup>? placementGroup,
    pulumi.Output<bool>? placementGroupExternallyManaged,
    pulumi.Output<bool>? privateIp,
    required pulumi.Output<String> region,
    pulumi.Output<bool>? resizeDisk,
    pulumi.Output<String>? rootPass,
    pulumi.Output<List<String>>? sharedIpv4s,
    pulumi.Output<Map<String, String>>? stackscriptData,
    pulumi.Output<int>? stackscriptId,
    pulumi.Output<int>? swapSize,
    pulumi.Output<List<String>>? tags,
    pulumi.Output<String>? type,
    pulumi.Output<bool>? watchdogEnabled,
  }) :
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      alerts: map['alerts'] == null ? null : pulumi.Output.create<InstanceAlerts>(InstanceAlerts.fromMap((map['alerts'] as Map).cast<String, dynamic>())),
      ...
      bootConfigLabel: map['bootConfigLabel'] == null ? null : pulumi.Output.create<String>(map['bootConfigLabel'] as String),
      booted: map['booted'] == null ? null : pulumi.Output.create<bool>(map['booted'] as bool),
      configs: map['configs'] == null ? null : pulumi.Output.create<List<InstanceConfig>>(pulumi.Input.decodeList<InstanceConfig>(map['configs'], (value) => InstanceConfig.fromMap((value as Map).cast<String, dynamic>()))),
      diskEncryption: map['diskEncryption'] == null ? null : pulumi.Output.create<String>(map['diskEncryption'] as String),
      disks: map['disks'] == null ? null : pulumi.Output.create<List<InstanceDisk>>(pulumi.Input.decodeList<InstanceDisk>(map['disks'], (value) => InstanceDisk.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      interfaceGeneration: map['interfaceGeneration'] == null ? null : pulumi.Output.create<String>(map['interfaceGeneration'] as String),
      interfaces: map['interfaces'] == null ? null : pulumi.Output.create<List<InstanceInterface>>(pulumi.Input.decodeList<InstanceInterface>(map['interfaces'], (value) => InstanceInterface.fromMap((value as Map).cast<String, dynamic>()))),
      ipv4s: map['ipv4s'] == null ? null : pulumi.Output.create<List<String>>((map['ipv4s'] as List).cast<String>()),
      ...
      metadatas: map['metadatas'] == null ? null : pulumi.Output.create<List<InstanceMetadata>>(pulumi.Input.decodeList<InstanceMetadata>(map['metadatas'], (value) => InstanceMetadata.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      placementGroup: map['placementGroup'] == null ? null : pulumi.Output.create<InstancePlacementGroup>(InstancePlacementGroup.fromMap((map['placementGroup'] as Map).cast<String, dynamic>())),
      placementGroupExternallyManaged: map['placementGroupExternallyManaged'] == null ? null : pulumi.Output.create<bool>(map['placementGroupExternallyManaged'] as bool),
      privateIp: map['privateIp'] == null ? null : pulumi.Output.create<bool>(map['privateIp'] as bool),
      ...
      sharedIpv4s: map['sharedIpv4s'] == null ? null : pulumi.Output.create<List<String>>((map['sharedIpv4s'] as List).cast<String>()),
      ...
      swapSize: map['swapSize'] == null ? null : pulumi.Output.create<int>(map['swapSize'] as int),
      tags: map['tags'] == null ? null : pulumi.Output.create<List<String>>((map['tags'] as List).cast<String>()),
      type: map['type'] == null ? null : pulumi.Output.create<String>(map['type'] as String),
      watchdogEnabled: map['watchdogEnabled'] == null ? null : pulumi.Output.create<bool>(map['watchdogEnabled'] as bool),
    );
  }
}
