...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      alerts: map['alerts'] == null ? null : (InstanceAlerts.fromMap((map['alerts'] as Map).cast<String, dynamic>())).input(),
      ...
      bootConfigLabel: map['bootConfigLabel'] == null ? null : (map['bootConfigLabel'] as String).input(),
      booted: map['booted'] == null ? null : (map['booted'] as bool).input(),
      configs: map['configs'] == null ? null : (pulumi.Input.decodeList<InstanceConfig>(map['configs'], (value) => InstanceConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      diskEncryption: map['diskEncryption'] == null ? null : (map['diskEncryption'] as String).input(),
      disks: map['disks'] == null ? null : (pulumi.Input.decodeList<InstanceDisk>(map['disks'], (value) => InstanceDisk.fromMap((value as Map).cast<String, dynamic>()))).input(),
      firewallId: map['firewallId'] == null ? null : (map['firewallId'] as int).input(),
      group: map['group'] == null ? null : (map['group'] as String).input(),
      image: map['image'] == null ? null : (map['image'] as String).input(),
      interfaceGeneration: map['interfaceGeneration'] == null ? null : (map['interfaceGeneration'] as String).input(),
      interfaces: map['interfaces'] == null ? null : (pulumi.Input.decodeList<InstanceInterface>(map['interfaces'], (value) => InstanceInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      metadatas: map['metadatas'] == null ? null : (pulumi.Input.decodeList<InstanceMetadata>(map['metadatas'], (value) => InstanceMetadata.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      placementGroup: map['placementGroup'] == null ? null : (InstancePlacementGroup.fromMap((map['placementGroup'] as Map).cast<String, dynamic>())).input(),
      placementGroupExternallyManaged: map['placementGroupExternallyManaged'] == null ? null : (map['placementGroupExternallyManaged'] as bool).input(),
      privateIp: map['privateIp'] == null ? null : (map['privateIp'] as bool).input(),
      ...
      sharedIpv4s: map['sharedIpv4s'] == null ? null : ((map['sharedIpv4s'] as List).cast<String>()).input(),
      ...
      swapSize: map['swapSize'] == null ? null : (map['swapSize'] as int).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as List).cast<String>()).input(),
      type: map['type'] == null ? null : (map['type'] as String).input(),
      watchdogEnabled: map['watchdogEnabled'] == null ? null : (map['watchdogEnabled'] as bool).input(),
    );
  }
}
