...
class GetImagesImageImageSharing {
  ...
  factory GetImagesImageImageSharing.fromMap(Map<String, dynamic> map) {
    return GetImagesImageImageSharing(
      sharedBy: (GetImagesImageImageSharingSharedBy.fromMap((map['sharedBy'] as Map).cast<String, dynamic>())).input(),
      sharedWith: (GetImagesImageImageSharingSharedWith.fromMap((map['sharedWith'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
