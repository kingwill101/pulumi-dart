  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() {
        ...
        return pulumi.Input.encodeList<GetVpcIpsFilter, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
      ...
      'ipv6': ?ipv6,
      'vpcId': ?vpcId,
      'vpcIps': pulumi.Input.encodeList<GetVpcIpsVpcIp, Map<String, dynamic>>(
        vpcIps,
        (value) => value.toMap(),
      ),
    };
  ...
  factory GetVpcIpsResult.fromMap(Map<String, dynamic> map) {
    return GetVpcIpsResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetVpcIpsFilter>(
          guardedValue,
          (value) =>
      ...
      vpcIps: pulumi.Input.decodeList<GetVpcIpsVpcIp>(
        map['vpcIps']!,
        (value) =>
            GetVpcIpsVpcIp.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
