...
class LkeNodePoolState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<LkeNodePoolNode>,
            List<Map<String, dynamic>>
          >(
            nodes,
            (value) =>
                pulumi.Input.encodeList<LkeNodePoolNode, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<LkeNodePoolTaint>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
                pulumi.Input.encodeList<LkeNodePoolTaint, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory LkeNodePoolState.fromMap(Map<String, dynamic> map) {
    return LkeNodePoolState(
      autoscaler: (() {
        final guardedValue = map['autoscaler'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LkeNodePoolAutoscaler.fromMap(
      ...
      nodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LkeNodePoolNode>(
            guardedValue,
            (value) =>
                LkeNodePoolNode.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LkeNodePoolTaint>(
            guardedValue,
            (value) => LkeNodePoolTaint.fromMap(
