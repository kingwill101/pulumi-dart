...
class GetNetworkingIpsArgs {
  ...
  GetNetworkingIpsArgs({
    pulumi.Output<List<GetNetworkingIpsFilter>>? filters,
  ...
  factory GetNetworkingIpsArgs.fromMap(Map<String, dynamic> map) {
    return GetNetworkingIpsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetNetworkingIpsFilter>>(pulumi.Input.decodeList<GetNetworkingIpsFilter>(map['filters'], (value) => GetNetworkingIpsFilter.fromMap((value as Map).cast<String, dynamic>()))),
